...
// filesystem, runs initdb, and runs a postmaster with its processes (see
// cluster.go).
package engine
...
// StartOptions configures a cluster (see cluster.go).
type StartOptions struct {
	User     string
	Database string
	Params   []string // extra postgres arguments
}
