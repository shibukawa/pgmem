				...
				if v29 != 0 {
					...
					if v32 != 0 {
						...
						if v35 != 0 {
							...
							v38 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_clear_attribute_stats[0])))
							if v38 == int32(1) {
								v43 = *(*int32)(unsafe.Add(mBase, _c_F_pg_clear_attribute_stats[1]))
								v44 = *(*int32)(unsafe.Add(mBase, uint32(v43)+316))
								v46 = base.B2i32(v44 != int32(2))
								*(*uint8)(unsafe.Add(mBase, _c_F_pg_clear_attribute_stats[0])) = uint8(v46)
								v48 = v46
							} else {
								v48 = int32(0)
							}
													...
													if v119 != 0 {
														...
														if v122 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v8))) = v62
															F_errmsg(m, int32(_a_F_pg_clear_attribute_stats_1), v8)
															mBase = m.M
															v126 = m.ExcPending
															if v126 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(_a_F_pg_clear_attribute_stats_2), int32(950), int32(_a_F_pg_clear_attribute_stats_3))
																mBase = m.M
																v131 = m.ExcPending
																if v131 != 0 {
																	return int32(0)
															...
															if v138 != 0 {
																...
																if v140 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v62
																	F_errmsg(m, int32(_a_F_pg_clear_attribute_stats_4), v8+int32(16))
																	mBase = m.M
																	v147 = m.ExcPending
																	if v147 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(_a_F_pg_clear_attribute_stats_2), int32(956), int32(_a_F_pg_clear_attribute_stats_3))
																		mBase = m.M
																		v152 = m.ExcPending
																		if v152 != 0 {
																			return int32(0)
									...
									if v102 != 0 {
										...
										if v106 != 0 {
											...
											if v110 != 0 {
												...
												F_errfinish(m, int32(_a_F_pg_clear_attribute_stats_2), int32(937), int32(_a_F_pg_clear_attribute_stats_3))
												mBase = m.M
												v115 = m.ExcPending
												if v115 != 0 {
													return int32(0)
