...
func F_pg_clear_attribute_stats(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+28)) = v2
	F_stats_check_required_arg(m, l0, int32(4159632), v2)
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return int32(0)
	} else {
		F_stats_check_required_arg(m, l0, int32(4159632), int32(1))
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return int32(0)
		} else {
			F_stats_check_required_arg(m, l0, int32(4159632), int32(2))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
			} else {
				F_stats_check_required_arg(m, l0, int32(4159632), int32(3))
				mBase = m.M
				v29 = m.ExcPending
				if v29 != 0 {
					return int32(0)
													...
													if v119 != 0 {
														...
														if v122 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v8))) = v62
															F_errmsg(m, int32(743132), v8)
															mBase = m.M
															v126 = m.ExcPending
															if v126 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(515419), int32(950), int32(133592))
																mBase = m.M
																v131 = m.ExcPending
																if v131 != 0 {
																	return int32(0)
															...
															if v138 != 0 {
																...
																if v140 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v62
																	F_errmsg(m, int32(77334), v8+int32(16))
																	mBase = m.M
																	v147 = m.ExcPending
																	if v147 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(515419), int32(956), int32(133592))
																		mBase = m.M
																		v152 = m.ExcPending
																		if v152 != 0 {
																			return int32(0)
								...
								if v99 != 0 {
									...
									if v102 != 0 {
										...
										if v106 != 0 {
											...
											F_errhint(m, int32(598745), int32(0))
											mBase = m.M
											v110 = m.ExcPending
											if v110 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(515419), int32(937), int32(133592))
												mBase = m.M
												v115 = m.ExcPending
												if v115 != 0 {
													return int32(0)
