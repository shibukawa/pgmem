			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
				...
				if v25 != 0 {
					...
					F_errfinish(m, int32(496792), int32(1078), int32(267351))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
...
L34:
	;
	F_errfinish(m, int32(496792), int32(463), int32(263428))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L6
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v82)+16)) = v138 + int32(4)
	F_errmsg(m, int32(266799), v82+int32(16))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L6
...
L41:
	;
	F_errfinish(m, int32(496792), int32(65), int32(263422))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L6
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v82)+48)) = v170 + int32(4)
	F_errmsg(m, int32(266799), v82+int32(48))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L6
...
L50:
	;
	F_errdetail(m, int32(600557), int32(0))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L6
...
L51:
	;
	F_errfinish(m, int32(496792), int32(81), int32(263422))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L6
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v82)+64)) = v195 + int32(4)
	F_errmsg(m, int32(266799), v82-int32(-64))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L6
...
L55:
	;
	F_errdetail(m, int32(601267), int32(0))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L6
...
L56:
	;
	F_errfinish(m, int32(496792), int32(87), int32(263422))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L6
...
L161:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v82)+32)) = v722 + int32(4)
	F_errmsg(m, int32(266799), v82+int32(32))
	mBase = m.M
	v730 = m.ExcPending
	if v730 != 0 {
		goto L6
...
L162:
	;
	F_errdetail(m, int32(600980), int32(0))
	mBase = m.M
	v734 = m.ExcPending
	if v734 != 0 {
		goto L6
...
L163:
	;
	F_errfinish(m, int32(496792), int32(73), int32(263422))
	mBase = m.M
	v739 = m.ExcPending
	if v739 != 0 {
		goto L6
