...
L3:
	...
	*(*int32)(unsafe.Add(mBase, _consts[778])) = int32(1)
	v42 = l1
	v43 = l2
	v53 = v34
	goto L6
...
L5:
	;
	v434 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[778])) = v434
...
L7:
	;
	v423 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[778])) = v423
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(318637)
	F_errmsg(m, int32(310039), v19)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L24
...
L27:
	;
	F_errfinish(m, int32(517084), int32(1492), int32(332560))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L24
...
L42:
	;
	v179 = *(*int32)(unsafe.Add(mBase, _consts[807]))
	goto L43
L43:
	;
...
L50:
	;
	v209 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[778])) = v209
...
L51:
	;
	F_errmsg_internal(m, int32(309768), int32(0))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L24
...
L52:
	;
	F_errfinish(m, int32(517084), int32(1970), int32(291059))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L24
...
L90:
	;
	F_errmsg_internal(m, int32(390212), int32(0))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L24
...
L91:
	;
	F_errfinish(m, int32(517084), int32(1980), int32(291059))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L24
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(235102)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(518375), int32(367), int32(72894))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
