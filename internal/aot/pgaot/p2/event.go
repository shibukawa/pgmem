...
L3:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[0]))
...
L5:
	;
	v434 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[1])) = v434
...
L7:
	;
	v423 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[1])) = v423
	v426 = *(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[0]))
...
L18:
	;
	v106 = *(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[2]))
	if v106 == int32(27) {
		goto L21
	} else {
		goto L22
...
L23:
	;
	v111 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[1])) = v111
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(_a_F_WaitEventSetWait_0)
	F_errmsg(m, int32(_a_F_WaitEventSetWait_1), v19)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L24
...
L42:
	;
	v179 = *(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[3]))
	goto L43
L43:
	;
...
L46:
	;
	v203 = *(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[2]))
	if v203 == int32(27) {
		goto L43
	} else {
		goto L49
...
L50:
	;
	v209 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_WaitEventSetWait[1])) = v209
...
L72:
	...
	if v291&int32(_a_F_WaitEventSetWait_6) == int32(0) {
		goto L71
	} else {
		goto L73
	}
...
func F_event_trigger_out(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_event_trigger_out_0)
			F_errmsg(m, int32(_a_F_event_trigger_out_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_event_trigger_out_2), int32(367), int32(_a_F_event_trigger_out_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
