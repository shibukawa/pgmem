...
L26:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(302109)
	F_errmsg(m, int32(293888), v19)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L24
...
L51:
	;
	F_errmsg_internal(m, int32(293617), int32(0))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L24
...
L90:
	;
	F_errmsg_internal(m, int32(369507), int32(0))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L24
