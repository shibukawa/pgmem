...
func F_EventTriggerAlterTableRelid(m *base.Module, l0 int32) {
	...
	var v8 int32
	_ = v8
	v4 = *(*int32)(unsafe.Add(mBase, _consts[385]))
	if v4 == int32(0) {
	} else {
...
L10:
	...
	v42 = *(*int32)(unsafe.Add(mBase, _consts[384]))
	if v42 == int32(1) {
		goto L14
	} else {
		goto L15
...
func F_EventTriggerUndoInhibitCommandCollection(m *base.Module) {
	...
	var v4 int32
	_ = v4
	v3 = *(*int32)(unsafe.Add(mBase, _consts[385]))
	if v3 != 0 {
		v4 = int32(0)
...
L3:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _consts[189]))
	*(*int32)(unsafe.Add(mBase, uint32(v36))) = l4
	*(*int32)(unsafe.Add(mBase, _consts[768])) = int32(1)
	v42 = l1
	v43 = l2
	v53 = v34
	goto L6
...
L5:
	;
	v434 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[768])) = v434
...
L7:
	;
	v423 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[768])) = v423
...
L23:
	;
	v111 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[768])) = v111
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(297253)
	F_errmsg(m, int32(289208), v19)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L24
...
L27:
	;
	F_errfinish(m, int32(482172), int32(1492), int32(309858))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L24
...
L42:
	;
	v179 = *(*int32)(unsafe.Add(mBase, _consts[797]))
	goto L43
L43:
	;
...
L46:
	;
	v203 = *(*int32)(unsafe.Add(mBase, _consts[155]))
	if v203 == int32(27) {
		goto L43
	} else {
		goto L49
...
L50:
	;
	v209 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[768])) = v209
...
L51:
	;
	F_errmsg_internal(m, int32(288937), int32(0))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L24
...
L52:
	;
	F_errfinish(m, int32(482172), int32(1970), int32(271778))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L24
...
L90:
	;
	F_errmsg_internal(m, int32(363523), int32(0))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L24
...
L91:
	;
	F_errfinish(m, int32(482172), int32(1980), int32(271778))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L24
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(219456)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(483037), int32(367), int32(65617))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
