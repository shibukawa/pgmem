...
L3:
	...
	*(*int32)(unsafe.Add(mBase, _consts[777])) = int32(1)
	v42 = l1
	v43 = l2
	v53 = v34
	goto L6
...
L5:
	;
	v434 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[777])) = v434
...
L7:
	;
	v423 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[777])) = v423
...
L23:
	;
	v111 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[777])) = v111
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(319340)
	F_errmsg(m, int32(310742), v19)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L24
...
L27:
	;
	F_errfinish(m, int32(518386), int32(1492), int32(333463))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L24
...
L50:
	;
	v209 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[777])) = v209
...
L51:
	;
	F_errmsg_internal(m, int32(310471), int32(0))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L24
...
L52:
	;
	F_errfinish(m, int32(518386), int32(1970), int32(291719))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L24
...
L90:
	;
	F_errmsg_internal(m, int32(391357), int32(0))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L24
...
L91:
	;
	F_errfinish(m, int32(518386), int32(1980), int32(291719))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L24
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(235624)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(519698), int32(367), int32(73013))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
