...
func F_CreatePortal(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if v53 != 0 {
			...
			v60 = F_AllocSetContextCreateInternal(m, v55, int32(61673), int32(0), int32(1024), int32(8192))
			mBase = m.M
			v61 = m.ExcPending
			if v61 != 0 {
				return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v52)+8)) = v60
				...
				v66 = F_ResourceOwnerCreate(m, v64, int32(305368))
				mBase = m.M
				v67 = m.ExcPending
				if v67 != 0 {
					return int32(0)
					...
					if v97 != 0 {
						...
						if v98 == int32(1) {
							...
							if v133 != 0 {
								...
								F_errmsg_internal(m, int32(375668), int32(0))
								mBase = m.M
								v137 = m.ExcPending
								if v137 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(489522), int32(222), int32(305322))
									mBase = m.M
									v142 = m.ExcPending
									if v142 != 0 {
										return int32(0)
						...
						if v115 != 0 {
							...
							if v118 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l0
								F_errmsg(m, int32(114458), v8+int32(16))
								mBase = m.M
								v124 = m.ExcPending
								if v124 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(489522), int32(187), int32(305322))
									mBase = m.M
									v129 = m.ExcPending
									if v129 != 0 {
										return int32(0)
								...
								if v29 == int32(0) {
									...
									if v35 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
										F_errmsg(m, int32(676306), v8)
										mBase = m.M
										v39 = m.ExcPending
										if v39 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(489522), int32(192), int32(305322))
											mBase = m.M
											v44 = m.ExcPending
											if v44 != 0 {
												return int32(0)
			...
			if v10&int32(4) != 0 {
				...
				if v41 != 0 {
					...
					if v44 != 0 {
						...
						F_errmsg(m, int32(415456), int32(0))
						mBase = m.M
						v48 = m.ExcPending
						if v48 != 0 {
							return
						} else {
							F_errhint(m, int32(596702), int32(0))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return
							} else {
								F_errfinish(m, int32(484839), int32(1685), int32(418951))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
	...
	if base.B2i32(v3 != int32(0)) == int32(0) {
		...
		if v9 == int32(0) {
			...
			if v25 != 0 {
				...
				F_errmsg_internal(m, int32(305245), int32(0))
				mBase = m.M
				v29 = m.ExcPending
				if v29 != 0 {
					return
				} else {
					F_errfinish(m, int32(484839), int32(1778), int32(115654))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return
...
func F_FillPortalStore(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(0)
	...
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(61924), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		return
					...
					if v55 == int32(3) {
						...
						if v73 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v74
							F_errmsg_internal(m, int32(473315), v8)
							mBase = m.M
							v78 = m.ExcPending
							if v78 != 0 {
								return
							} else {
								F_errfinish(m, int32(484839), int32(1032), int32(358858))
								mBase = m.M
								v83 = m.ExcPending
								if v83 != 0 {
									return
					...
					if v189 != 0 {
						...
						if v192 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
							F_errmsg(m, int32(146563), v12)
							mBase = m.M
							v197 = m.ExcPending
							if v197 != 0 {
								return
							} else {
								F_errfinish(m, int32(484839), int32(643), int32(110587))
								mBase = m.M
								v202 = m.ExcPending
								if v202 != 0 {
									return
