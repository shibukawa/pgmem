						...
						if v98 == int32(1) {
							...
							if v133 != 0 {
								...
								if v137 != 0 {
									...
									F_errfinish(m, int32(493977), int32(222), int32(308240))
									mBase = m.M
									v142 = m.ExcPending
									if v142 != 0 {
										return int32(0)
							...
							if v118 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l0
								...
								if v124 != 0 {
									...
									F_errfinish(m, int32(493977), int32(187), int32(308240))
									mBase = m.M
									v129 = m.ExcPending
									if v129 != 0 {
										return int32(0)
								...
								if v29 == int32(0) {
									...
									if v35 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
										F_errmsg(m, int32(681643), v8)
										mBase = m.M
										v39 = m.ExcPending
										if v39 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(493977), int32(192), int32(308240))
											mBase = m.M
											v44 = m.ExcPending
											if v44 != 0 {
												return int32(0)
			...
			if v10&int32(4) != 0 {
				...
				if v41 != 0 {
					...
					if v44 != 0 {
						...
						F_errmsg(m, int32(419254), int32(0))
						mBase = m.M
						v48 = m.ExcPending
						if v48 != 0 {
							return
						} else {
							F_errhint(m, int32(601931), int32(0))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return
							} else {
								F_errfinish(m, int32(489230), int32(1685), int32(422749))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
		...
		if v9 == int32(0) {
			...
			if v25 != 0 {
				...
				if v29 != 0 {
					...
					F_errfinish(m, int32(489230), int32(1778), int32(116850))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return
					...
					if v55 == int32(3) {
						...
						if v73 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v74
							F_errmsg_internal(m, int32(477497), v8)
							mBase = m.M
							v78 = m.ExcPending
							if v78 != 0 {
								return
							} else {
								F_errfinish(m, int32(489230), int32(1032), int32(362151))
								mBase = m.M
								v83 = m.ExcPending
								if v83 != 0 {
									return
						...
						if v192 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
							...
							if v197 != 0 {
								...
								F_errfinish(m, int32(489230), int32(643), int32(111691))
								mBase = m.M
								v202 = m.ExcPending
								if v202 != 0 {
									return
