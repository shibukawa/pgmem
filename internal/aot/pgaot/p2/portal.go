...
func F_CreatePortal(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	m.G0 = v8
	if l0 == int32(0) {
		v50 = *(*int32)(unsafe.Add(mBase, _consts[889]))
		...
		if v53 != 0 {
			...
			v55 = *(*int32)(unsafe.Add(mBase, _consts[889]))
			v60 = F_AllocSetContextCreateInternal(m, v55, int32(68033), int32(0), int32(1024), int32(8192))
			mBase = m.M
			v61 = m.ExcPending
			if v61 != 0 {
				return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v52)+8)) = v60
				...
				v66 = F_ResourceOwnerCreate(m, v64, int32(324356))
				mBase = m.M
				v67 = m.ExcPending
				if v67 != 0 {
					return int32(0)
					...
					*(*int64)(unsafe.Add(mBase, uint32(v52)+128)) = v89
					v92 = *(*int32)(unsafe.Add(mBase, _consts[1242]))
					...
					if v97 != 0 {
						...
						if v98 == int32(1) {
							...
							if v133 != 0 {
								...
								F_errmsg_internal(m, int32(399142), int32(0))
								mBase = m.M
								v137 = m.ExcPending
								if v137 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(520698), int32(222), int32(324310))
									mBase = m.M
									v142 = m.ExcPending
									if v142 != 0 {
										return int32(0)
		...
		v13 = *(*int32)(unsafe.Add(mBase, _consts[1242]))
		v14 = int32(0)
						...
						if v115 != 0 {
							...
							if v118 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l0
								F_errmsg(m, int32(123985), v8+int32(16))
								mBase = m.M
								v124 = m.ExcPending
								if v124 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(520698), int32(187), int32(324310))
									mBase = m.M
									v129 = m.ExcPending
									if v129 != 0 {
										return int32(0)
								...
								if v29 == int32(0) {
									...
									if v35 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
										F_errmsg(m, int32(732431), v8)
										mBase = m.M
										v39 = m.ExcPending
										if v39 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(520698), int32(192), int32(324310))
											mBase = m.M
											v44 = m.ExcPending
											if v44 != 0 {
												return int32(0)
			...
			if v10&int32(4) != 0 {
				...
				if v41 != 0 {
					...
					if v44 != 0 {
						...
						F_errmsg(m, int32(441510), int32(0))
						mBase = m.M
						v48 = m.ExcPending
						if v48 != 0 {
							return
						} else {
							F_errhint(m, int32(647537), int32(0))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return
							} else {
								F_errfinish(m, int32(514512), int32(1685), int32(445005))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
...
func F_EnsurePortalSnapshotExists(m *base.Module) {
	...
	if base.B2i32(v3 != int32(0)) == int32(0) {
		v9 = *(*int32)(unsafe.Add(mBase, _consts[887]))
		if v9 == int32(0) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				...
				F_errmsg_internal(m, int32(324233), int32(0))
				mBase = m.M
				v29 = m.ExcPending
				if v29 != 0 {
					return
				} else {
					F_errfinish(m, int32(514512), int32(1778), int32(125181))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return
...
func F_FillPortalStore(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(0)
	v17 = *(*int32)(unsafe.Add(mBase, _consts[889]))
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(68284), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		return
			...
			if v44 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v43)+20)) = v45
				...
				if base.Ui32(int32(2)) <= base.Ui32(v55-int32(1)) {
					if v55 == int32(3) {
						...
						if v73 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v74
							F_errmsg_internal(m, int32(502259), v8)
							mBase = m.M
							v78 = m.ExcPending
							if v78 != 0 {
								return
							} else {
								F_errfinish(m, int32(514512), int32(1032), int32(381685))
								mBase = m.M
								v83 = m.ExcPending
								if v83 != 0 {
									return
					...
					v86 = *(*int32)(unsafe.Add(mBase, _consts[888]))
...
func F_PortalHashTableDeleteAll(m *base.Module) {
	...
	v5 = v3 - int32(32)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1242]))
	if v8 == int32(0) {
		goto L1
	} else {
		goto L2
...
L13:
	;
	v37 = *(*int32)(unsafe.Add(mBase, _consts[1242]))
					...
					if v189 != 0 {
						...
						if v192 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
							F_errmsg(m, int32(157518), v12)
							mBase = m.M
							v197 = m.ExcPending
							if v197 != 0 {
								return
							} else {
								F_errfinish(m, int32(514512), int32(643), int32(119703))
								mBase = m.M
								v202 = m.ExcPending
								if v202 != 0 {
									return
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, _consts[887])) = v80
...
L5:
	...
	v67 = *(*int32)(unsafe.Add(mBase, _consts[887]))
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _consts[887])) = l0
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+12)) = v108
	v124 = *(*int32)(unsafe.Add(mBase, _consts[888]))
