...
L3:
	;
	v43 = int32(0)
	v48 = F__emscripten_memset_bulkmem(m, int32(4360168), base.I32_extend8_s(v43), int32(80))
	mBase = m.M
	goto L9
L4:
	;
...
L49:
	;
	F_errmsg_internal(m, int32(381691), int32(0))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L11
...
L50:
	;
	F_errfinish(m, int32(486905), int32(7019), int32(87433))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L11
...
L72:
	;
	F_XLogRegisterData(m, int32(4082340), int32(4))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L11
...
L75:
	...
	F_s_lock(m, v369+int32(440), int32(486905), int32(7113), int32(87433))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L11
...
L83:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = int32(86702)
	if v42 != 0 {
		goto L86
	} else {
		goto L87
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+4)) = v400
	v406 = F_pg_snprintf(m, v19+int32(112), int32(128), int32(171878), v19)
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L11
...
L166:
	...
	F_s_lock(m, v771+int32(440), int32(486905), int32(7312), int32(87433))
	mBase = m.M
	v778 = m.ExcPending
	if v778 != 0 {
		goto L11
...
L196:
	;
	F_errfinish(m, int32(488737), int32(243), int32(86713))
	mBase = m.M
	v896 = m.ExcPending
	if v896 != 0 {
		goto L11
...
L245:
	;
	F_errmsg_internal(m, int32(13988), int32(0))
	mBase = m.M
	v1186 = m.ExcPending
	if v1186 != 0 {
		goto L11
...
L246:
	;
	F_errfinish(m, int32(486905), int32(6954), int32(87433))
	mBase = m.M
	v1191 = m.ExcPending
	if v1191 != 0 {
		goto L11
...
L248:
	;
	F_errmsg(m, int32(238790), int32(0))
	mBase = m.M
	v1199 = m.ExcPending
	if v1199 != 0 {
		goto L11
...
L249:
	;
	F_errfinish(m, int32(486905), int32(7281), int32(87433))
	mBase = m.M
	v1204 = m.ExcPending
	if v1204 != 0 {
		goto L11
