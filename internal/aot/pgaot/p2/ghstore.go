...
func F_ghstore_in(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		if v15 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(_a_F_ghstore_in_0)
			F_errmsg(m, int32(_a_F_ghstore_in_1), v5)
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_ghstore_in_2), int32(102), int32(_a_F_ghstore_in_3))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v29))) = v64
				...
				if v68 != 0 {
					...
					if base.Ui32(int32(2)) <= base.Ui32(v59) {
						...
						for {
							...
							for {
								...
								v363 = v106 + int32(1)
								v365 = v363 & int32(_a_F_ghstore_picksplit_1)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v29)+4)) = v392
					...
					v399 = v57 + v397
					v401 = v25 + int32(4)
					v403 = int32(_a_F_ghstore_picksplit_1)
					...
					v415 = int32(4)
					v418 = *(*int32)(unsafe.Add(mBase, uint32(v401+v412&int32(_a_F_ghstore_picksplit_1)<<(uint(v415)%32))))
					...
					if v424 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v423))) = v422 << (uint(int32(2)) % 32)
						...
						v442 = int32(4)
						v445 = *(*int32)(unsafe.Add(mBase, uint32(v401+v439&int32(_a_F_ghstore_picksplit_1)<<(uint(v442)%32))))
						...
						if v451 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v450))) = v449 << (uint(int32(2)) % 32)
							...
							v464 = int32(_a_F_ghstore_picksplit_1)
							v465 = v26 + v464
							v467 = v465 & v464
							...
							if v471 != 0 {
								...
								if v26&int32(_a_F_ghstore_picksplit_1) == int32(1) {
									F_pg_qsort(m, v470, v467, int32(8), int32(_a_F_ghstore_picksplit_2))
									mBase = m.M
									v479 = m.ExcPending
									if v479 != 0 {
										return int32(0)
									...
									for {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v508-v512))) = v966 ^ v968 - v968
										v973 = v487 + int32(1)
										v974 = int32(_a_F_ghstore_picksplit_1)
										v975 = v973 & v974
									...
									if v982 != 0 {
										...
										for {
											...
											if v412&int32(_a_F_ghstore_picksplit_1) == v1025 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v29)+4)) = v1028 + int32(1)
												...
												if v439&int32(_a_F_ghstore_picksplit_1) == v1025 {
