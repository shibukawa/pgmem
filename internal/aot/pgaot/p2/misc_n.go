...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v58))) = int32(3)
	F_errmsg_internal(m, int32(456872), v58)
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L9
...
L48:
	;
	F_errfinish(m, int32(474971), int32(66), int32(146724))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L9
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v255))) = v271&int32(-262141) | v267<<(uint(int32(2))%32)&int32(262140)
	v417 = v255
	v419 = int32(4)
	goto L82
L97:
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v167)+48)) = v164
	F_errmsg_internal(m, int32(688398), v167+int32(48))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L9
...
L109:
	;
	F_errfinish(m, int32(474971), int32(118), int32(370463))
	mBase = m.M
	v309 = m.ExcPending
	if v309 != 0 {
		goto L9
...
L119:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v237))) = v330&int32(-262141) | v325<<(uint(v329)%32)&int32(262140)
	v417 = v237
	v419 = v329
	goto L82
L120:
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v167)+64)) = v164
	F_errmsg_internal(m, int32(688398), v167-int32(-64))
	mBase = m.M
	v348 = m.ExcPending
	if v348 != 0 {
		goto L9
...
L124:
	;
	F_errfinish(m, int32(474971), int32(133), int32(370463))
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L9
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v237))) = (v372+v368<<(uint(int32(2))%32))&int32(262140) | v372&int32(-262141)
	v417 = v237
	v419 = v246
	goto L82
L135:
	;
	v370 = F__emscripten_memcpy_bulkmem(m, v237+int32(base.Ui32(v360)>>(uint(int32(2))%32))&int32(65535)+int32(8), v242, v368)
	mBase = m.M
	goto L137
L136:
	;
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v167)+16)) = v164
	F_errmsg_internal(m, int32(688398), v167+int32(16))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L9
...
L140:
	;
	F_errfinish(m, int32(474971), int32(142), int32(370463))
	mBase = m.M
	v400 = m.ExcPending
	if v400 != 0 {
		goto L9
...
L142:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v167)+32)) = int32(3)
	F_errmsg_internal(m, int32(456911), v167+int32(32))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L9
...
L143:
	;
	F_errfinish(m, int32(474971), int32(145), int32(370463))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L9
...
L151:
	;
	v469 = (v454+int32(2))&int32(131070) | v454&int32(-131071)
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v167))) = v164
	F_errmsg_internal(m, int32(688398), v167)
	mBase = m.M
	v499 = m.ExcPending
	if v499 != 0 {
		goto L9
...
L155:
	;
	F_errfinish(m, int32(474971), int32(150), int32(370463))
	mBase = m.M
	v504 = m.ExcPending
	if v504 != 0 {
		goto L9
...
L379:
	;
	F_errfinish(m, int32(478126), int32(752), int32(25834))
	mBase = m.M
	v1273 = m.ExcPending
	if v1273 != 0 {
		goto L9
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v141
	F_errmsg_internal(m, int32(464116), v7)
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L17
...
L54:
	;
	F_errfinish(m, int32(478292), int32(195), int32(343710))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L17
...
L59:
	;
	v181 = *(*int32)(unsafe.Add(mBase, uint32(v174<<(uint(int32(2))%32))+uint32(_consts[509])))
...
L62:
	;
	F_errmsg_internal(m, int32(258427), int32(0))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L17
...
L63:
	;
	F_errfinish(m, int32(478292), int32(76), int32(343710))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L17
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v225
	F_errmsg_internal(m, int32(465343), v7+int32(16))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L17
...
L66:
	;
	F_errfinish(m, int32(478292), int32(250), int32(343710))
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L17
		...
		if v19 == int32(3552) {
			...
			if v31 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v13))) = v19
				F_errmsg_internal(m, int32(8957), v13)
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return int32(0)
...
L103:
	...
	switch v492&int32(65535) - int32(1) {
	case 0:
		goto L106
	case 1:
		goto L105
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v492
	F_errmsg_internal(m, int32(464696), v17)
	mBase = m.M
	v506 = m.ExcPending
	if v506 != 0 {
		goto L24
...
func F_nodeToString(m *base.Module, l0 int32) int32 {
	...
	m.G0 = v6
	v8 = int32(4357144)
	v9 = int32(*(*uint8)(unsafe.Add(mBase, _consts[479])))
	*(*uint8)(unsafe.Add(mBase, _consts[479])) = uint8(v2)
	...
	if v16 != 0 {
		...
		if v18 != 0 {
			...
			v21 = v9 & int32(1)
			*(*uint8)(unsafe.Add(mBase, _consts[479])) = uint8(v21)
