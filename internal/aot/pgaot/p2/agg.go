				...
				case 0:
					...
					if v67 != 0 {
						...
						if v70 != 0 {
							...
							F_errmsg(m, int32(150529), int32(0))
							mBase = m.M
							v74 = m.ExcPending
							if v74 != 0 {
								return int32(0)
								...
								if v78 != 0 {
									...
									F_errfinish(m, int32(490567), int32(821), int32(218525))
									mBase = m.M
									v83 = m.ExcPending
									if v83 != 0 {
										return int32(0)
					...
					if v113 != 0 {
						...
						if v125 != 0 {
							...
							if v128 != 0 {
								...
								F_errmsg(m, int32(150657), int32(0))
								mBase = m.M
								v132 = m.ExcPending
								if v132 != 0 {
									return int32(0)
									...
									if v136 != 0 {
										...
										if v140 != 0 {
											...
											F_errfinish(m, int32(490567), int32(815), int32(218525))
											mBase = m.M
											v145 = m.ExcPending
											if v145 != 0 {
												return int32(0)
