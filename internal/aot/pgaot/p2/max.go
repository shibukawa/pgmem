...
func F_check_max_stack_depth(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v12 = *(*int32)(unsafe.Add(mBase, _consts[1232]))
	if v12 == int32(0) {
		v15 = int32(16)
		v16 = v8 + v15
		v21 = m.G0
		...
		*(*int32)(unsafe.Add(mBase, _consts[1232])) = v86
		v88 = v86
	} else {
		v88 = v12
	}
	...
	if v88 <= int32(0) {
		...
		if v10<<(uint(int32(10))%32) <= v94 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v104
			v108 = F_format_elog_string(m, int32(635940), v8)
			mBase = m.M
			v111 = m.ExcPending
			if v111 != 0 {
				return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, _consts[250])) = v114
				v120 = F_format_elog_string(m, int32(556994), int32(0))
				mBase = m.M
				v121 = m.ExcPending
				if v121 != 0 {
					return int32(0)
