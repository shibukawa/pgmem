...
L4:
	;
	if base.Ui32(int32(_a_F_PageAddItemExtended_0)) <= base.Ui32(v22) {
		goto L1
	} else {
		goto L5
	}
...
L6:
	;
	v33 = int32(base.Ui32(v17+int32(_a_F_PageAddItemExtended_1)) >> (uint(int32(2)) % 32))
	goto L8
L7:
	;
	v33 = int32(0)
...
L8:
	...
	v34 = int32(1)
	v35 = v33 + v34
	if base.Ui32((l3-v34)&int32(_a_F_PageAddItemExtended_2)) <= base.Ui32(int32(2047)) {
		goto L12
	} else {
		goto L13
	}
L9:
	;
	m.G0 = v15 + int32(16)
	return v397 & int32(_a_F_PageAddItemExtended_2)
L10:
	;
	v188 = v178 & int32(_a_F_PageAddItemExtended_2)
...
L11:
	;
	v154 = int32(_a_F_PageAddItemExtended_2)
...
L15:
	;
	if base.Ui32(v33&int32(_a_F_PageAddItemExtended_2)) < base.Ui32(l3) {
		v145 = l3
		v149 = v6
		goto L11
	} else {
...
L17:
	;
	v145 = l3
	v149 = base.B2i32(base.Ui32(l3) <= base.Ui32(v33&int32(_a_F_PageAddItemExtended_2)))
	goto L11
L18:
	;
	v50 = *(*int32)(unsafe.Add(mBase, uint32(l3<<(uint(int32(2))%32)+l0)+20))
	if base.Ui32(v50) < base.Ui32(int32(_a_F_PageAddItemExtended_3)) {
		v145 = l3
		v149 = v6
		goto L11
	} else {
...
L25:
	;
	v80 = v33 & int32(_a_F_PageAddItemExtended_2)
	if v80 == int32(0) {
		goto L28
	} else {
		goto L29
...
L27:
	;
	v127 = v74 & int32(_a_F_PageAddItemExtended_7)
...
L31:
	;
	v106 = *(*int32)(unsafe.Add(mBase, uint32(v90&int32(_a_F_PageAddItemExtended_2)<<(uint(int32(2))%32)+(l0+int32(24))-int32(4))))
	if base.Ui32(v106) < base.Ui32(int32(_a_F_PageAddItemExtended_3)) {
		v132 = v90
		goto L26
	} else {
		goto L33
...
L33:
	;
	v110 = v90 + int32(1)
	if base.Ui32(v110&int32(_a_F_PageAddItemExtended_2)) <= base.Ui32(v80) {
		v90 = v110
		goto L31
	} else {
		goto L34
...
L40:
	;
	v213 = v17 + int32(4)
	v215 = v35 & int32(_a_F_PageAddItemExtended_2)
	if v188 == v215 {
		goto L47
	} else {
		goto L48
...
L56:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v229))) = v223&int32(_a_F_PageAddItemExtended_10) | l2<<(uint(int32(17))%32) | int32(_a_F_PageAddItemExtended_3)
	if l2 != 0 {
		goto L104
	} else {
		goto L105
...
L10:
	...
	v36 = m.T0[v35].(func(*base.Module, int32, int64, int32, int64, int32) int32)(m, l0, v31, int32(_a_F_ReadPageInternal_0), v33, v34)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L11
