...
func F_has_sequence_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v21 = F_convert_any_priv_string(m, v14, int32(1656656))
		mBase = m.M
		v22 = m.ExcPending
		if v22 != 0 {
			return int32(0)
							...
							if v40 != 0 {
								...
								if v42 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v41
									F_errmsg(m, int32(416568), v9)
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(497936), int32(2284), int32(437661))
										mBase = m.M
										v51 = m.ExcPending
										if v51 != 0 {
											return int32(0)
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v21 != 0 {
			...
			v23 = F_convert_any_priv_string(m, v14, int32(1656656))
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return int32(0)
									...
									if v44 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9))) = v43
										...
										if v48 != 0 {
											...
											F_errfinish(m, int32(497936), int32(2186), int32(436946))
											mBase = m.M
											v53 = m.ExcPending
											if v53 != 0 {
												return int32(0)
	...
	if v15 != 0 {
		...
		if v18 != 0 {
			...
			if v20 != 0 {
				...
				v22 = F_convert_any_priv_string(m, v17, int32(1656656))
				mBase = m.M
				v23 = m.ExcPending
				if v23 != 0 {
					return int32(0)
											...
											if v44 != 0 {
												...
												if v46 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v8))) = v45
													F_errmsg(m, int32(416568), v8)
													mBase = m.M
													v50 = m.ExcPending
													if v50 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(497936), int32(2123), int32(380196))
														mBase = m.M
														v55 = m.ExcPending
														if v55 != 0 {
															return int32(0)
...
func F_init_sequence(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = l0
	v13 = *(*int32)(unsafe.Add(mBase, _consts[406]))
	if v13 == int32(0) {
		*(*int64)(unsafe.Add(mBase, uint32(v9)+32)) = int64(171798691844)
		v24 = F_hash_create(m, int32(158565), int32(16), v7+int32(-48), int32(40))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return
		} else {
			*(*int32)(unsafe.Add(mBase, _consts[406])) = v24
			v27 = v24
			...
			if v34 != 0 {
				...
				if v48 != v51 {
					v53 = int32(4515764)
					v54 = *(*int32)(unsafe.Add(mBase, _consts[262]))
					v57 = *(*int32)(unsafe.Add(mBase, _consts[407]))
					*(*int32)(unsafe.Add(mBase, _consts[262])) = v57
					...
					if v62 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _consts[262])) = v54
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v23 + int32(4)
					...
					if v29 != 0 {
						...
						if v33 != 0 {
							...
							F_errfinish(m, int32(499953), int32(77), int32(425835))
							mBase = m.M
							v38 = m.ExcPending
							if v38 != 0 {
								return int32(0)
