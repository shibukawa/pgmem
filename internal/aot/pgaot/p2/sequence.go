							...
							if v40 != 0 {
								...
								if v42 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v41
									F_errmsg(m, int32(410052), v9)
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(489865), int32(2284), int32(430815))
										mBase = m.M
										v51 = m.ExcPending
										if v51 != 0 {
											return int32(0)
									...
									if v44 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9))) = v43
										...
										if v48 != 0 {
											...
											F_errfinish(m, int32(489865), int32(2186), int32(430100))
											mBase = m.M
											v53 = m.ExcPending
											if v53 != 0 {
												return int32(0)
											...
											if v44 != 0 {
												...
												if v46 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v8))) = v45
													F_errmsg(m, int32(410052), v8)
													mBase = m.M
													v50 = m.ExcPending
													if v50 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(489865), int32(2123), int32(373966))
														mBase = m.M
														v55 = m.ExcPending
														if v55 != 0 {
															return int32(0)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = l0
	...
	if v13 == int32(0) {
		*(*int64)(unsafe.Add(mBase, uint32(v9)+32)) = int64(171798691844)
		v24 = F_hash_create(m, int32(156170), int32(16), v7+int32(-48), int32(40))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v23 + int32(4)
					...
					if v29 != 0 {
						...
						if v33 != 0 {
							...
							F_errfinish(m, int32(491814), int32(77), int32(419054))
							mBase = m.M
							v38 = m.ExcPending
							if v38 != 0 {
								return int32(0)
