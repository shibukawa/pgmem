							...
							if v40 != 0 {
								...
								if v42 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v41
									F_errmsg(m, int32(416433), v9)
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(497801), int32(2284), int32(437526))
										mBase = m.M
										v51 = m.ExcPending
										if v51 != 0 {
											return int32(0)
									...
									if v44 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9))) = v43
										...
										if v48 != 0 {
											...
											F_errfinish(m, int32(497801), int32(2186), int32(436811))
											mBase = m.M
											v53 = m.ExcPending
											if v53 != 0 {
												return int32(0)
											...
											if v44 != 0 {
												...
												if v46 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v8))) = v45
													F_errmsg(m, int32(416433), v8)
													mBase = m.M
													v50 = m.ExcPending
													if v50 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(497801), int32(2123), int32(380061))
														mBase = m.M
														v55 = m.ExcPending
														if v55 != 0 {
															return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v23 + int32(4)
					...
					if v29 != 0 {
						...
						if v33 != 0 {
							...
							F_errfinish(m, int32(499800), int32(77), int32(425700))
							mBase = m.M
							v38 = m.ExcPending
							if v38 != 0 {
								return int32(0)
