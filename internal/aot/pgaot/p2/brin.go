	...
	if base.Ui32(v13) < base.Ui32(v14) {
		...
		if v66 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
			F_errmsg_internal(m, int32(48125), v8)
			mBase = m.M
			v70 = m.ExcPending
			if v70 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(497415), int32(471), int32(225947))
				mBase = m.M
				v75 = m.ExcPending
				if v75 != 0 {
					return int32(0)
...
L115:
	;
	F_errfinish(m, int32(497415), int32(586), int32(426887))
	mBase = m.M
	v568 = m.ExcPending
	if v568 != 0 {
		goto L10
...
func F_brin_bloom_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_real_reloption(m, v2, int32(402762), int32(403821), float64(-0.1), float64(-1), float64(2.147483647e+09), int32(8))
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		return int32(0)
	} else {
		F_add_local_real_reloption(m, v2, int32(355414), int32(132554), float64(0.01), float64(0.0001), float64(0.25), int32(16))
		mBase = m.M
		v24 = m.ExcPending
		if v24 != 0 {
			return int32(0)
...
L109:
	;
	F_errfinish(m, int32(495231), int32(362), int32(81896))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L5
...
L111:
	;
	F_errmsg_internal(m, int32(408716), int32(0))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L5
...
L112:
	;
	F_errfinish(m, int32(495231), int32(414), int32(81896))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L5
...
L54:
	...
	v201 = F_AllocSetContextCreateInternal(m, v196, int32(61326), v194, int32(8192), int32(8388608))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v42
	F_appendStringInfo(m, v11+int32(128), int32(483254), v11+int32(48))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v81
	F_appendStringInfo(m, v11+int32(76), int32(206290), v11+int32(32))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v127
	F_appendStringInfo(m, v11+int32(128), int32(201074), v11+int32(16))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v197
	F_appendStringInfo(m, v11+int32(128), int32(200960), v11)
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L1
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(17916)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(499163), int32(3121), int32(36498))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v33
				...
				if v39 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v21)+20)) = v38
					...
					v49 = F_AllocSetContextCreateInternal(m, v44, int32(384564), int32(0), int32(8192), int32(8388608))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return int32(0)
			...
			*(*uint16)(unsafe.Add(mBase, uint32(v39+v44)+6)) = uint16(v40)
			...
			if base.Ui32(v155) < base.Ui32(v156) {
				...
				if v272 != 0 {
					...
					F_errmsg_internal(m, int32(228819), int32(0))
					mBase = m.M
					v276 = m.ExcPending
					if v276 != 0 {
						return
					} else {
						F_errfinish(m, int32(499543), int32(88), int32(356943))
						mBase = m.M
						v281 = m.ExcPending
						if v281 != 0 {
							return
				...
				if v161 != 0 {
					...
					if v160 == int32(0) {
						...
						if v285 != 0 {
							...
							F_errmsg_internal(m, int32(385857), int32(0))
							mBase = m.M
							v289 = m.ExcPending
							if v289 != 0 {
								return
							} else {
								F_errfinish(m, int32(499543), int32(92), int32(356943))
								mBase = m.M
								v294 = m.ExcPending
								if v294 != 0 {
									return
