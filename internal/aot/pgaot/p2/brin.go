	...
	if base.Ui32(v13) < base.Ui32(v14) {
		...
		if v66 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
			F_errmsg_internal(m, int32(44861), v8)
			mBase = m.M
			v70 = m.ExcPending
			if v70 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(465519), int32(471), int32(212334))
				mBase = m.M
				v75 = m.ExcPending
				if v75 != 0 {
					return int32(0)
...
L115:
	;
	F_errfinish(m, int32(465519), int32(586), int32(399786))
	mBase = m.M
	v568 = m.ExcPending
	if v568 != 0 {
		goto L10
...
func F_brin_bloom_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_real_reloption(m, v2, int32(377528), int32(378567), float64(-0.1), float64(-1), float64(2.147483647e+09), int32(8))
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		return int32(0)
	} else {
		F_add_local_real_reloption(m, v2, int32(332646), int32(121530), float64(0.01), float64(0.0001), float64(0.25), int32(16))
		mBase = m.M
		v24 = m.ExcPending
		if v24 != 0 {
			return int32(0)
...
L109:
	;
	F_errfinish(m, int32(463472), int32(362), int32(76476))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L5
...
L111:
	;
	F_errmsg_internal(m, int32(383382), int32(0))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L5
...
L112:
	;
	F_errfinish(m, int32(463472), int32(414), int32(76476))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L5
...
L54:
	...
	v201 = F_AllocSetContextCreateInternal(m, v196, int32(57798), v194, int32(8192), int32(8388608))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v42
	F_appendStringInfo(m, v11+int32(128), int32(452643), v11+int32(48))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v81
	F_appendStringInfo(m, v11+int32(76), int32(193567), v11+int32(32))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v127
	F_appendStringInfo(m, v11+int32(128), int32(188457), v11+int32(16))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v197
	F_appendStringInfo(m, v11+int32(128), int32(188343), v11)
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L1
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(16573)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(467101), int32(3121), int32(33346))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v33
				...
				if v39 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v21)+20)) = v38
					...
					v49 = F_AllocSetContextCreateInternal(m, v44, int32(359676), int32(0), int32(8192), int32(8388608))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return int32(0)
			...
			*(*uint16)(unsafe.Add(mBase, uint32(v39+v44)+6)) = uint16(v40)
			...
			if base.Ui32(v155) < base.Ui32(v156) {
				...
				if v272 != 0 {
					...
					F_errmsg_internal(m, int32(214808), int32(0))
					mBase = m.M
					v276 = m.ExcPending
					if v276 != 0 {
						return
					} else {
						F_errfinish(m, int32(467442), int32(88), int32(334078))
						mBase = m.M
						v281 = m.ExcPending
						if v281 != 0 {
							return
				...
				if v161 != 0 {
					...
					if v160 == int32(0) {
						...
						if v285 != 0 {
							...
							F_errmsg_internal(m, int32(360969), int32(0))
							mBase = m.M
							v289 = m.ExcPending
							if v289 != 0 {
								return
							} else {
								F_errfinish(m, int32(467442), int32(92), int32(334078))
								mBase = m.M
								v294 = m.ExcPending
								if v294 != 0 {
									return
