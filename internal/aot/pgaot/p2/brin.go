	...
	if base.Ui32(v13) < base.Ui32(v14) {
		...
		if v66 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
			F_errmsg_internal(m, int32(47573), v8)
			mBase = m.M
			v70 = m.ExcPending
			if v70 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(490977), int32(471), int32(223640))
				mBase = m.M
				v75 = m.ExcPending
				if v75 != 0 {
					return int32(0)
...
L115:
	;
	F_errfinish(m, int32(490977), int32(586), int32(421364))
	mBase = m.M
	v568 = m.ExcPending
	if v568 != 0 {
		goto L10
...
func F_brin_bloom_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_real_reloption(m, v2, int32(397693), int32(398752), float64(-0.1), float64(-1), float64(2.147483647e+09), int32(8))
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		return int32(0)
	} else {
		F_add_local_real_reloption(m, v2, int32(350800), int32(130875), float64(0.01), float64(0.0001), float64(0.25), int32(16))
		mBase = m.M
		v24 = m.ExcPending
		if v24 != 0 {
			return int32(0)
...
L109:
	;
	F_errfinish(m, int32(488815), int32(362), int32(80997))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L5
...
L112:
	;
	F_errfinish(m, int32(488815), int32(414), int32(80997))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L5
...
L54:
	...
	v201 = F_AllocSetContextCreateInternal(m, v196, int32(60657), v194, int32(8192), int32(8388608))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v42
	F_appendStringInfo(m, v11+int32(128), int32(477011), v11+int32(48))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v81
	F_appendStringInfo(m, v11+int32(76), int32(204255), v11+int32(32))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v127
	F_appendStringInfo(m, v11+int32(128), int32(199039), v11+int32(16))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v197
	F_appendStringInfo(m, v11+int32(128), int32(198925), v11)
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L1
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(17841)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(492702), int32(3121), int32(35965))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v33
				...
				if v39 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v21)+20)) = v38
					...
					v49 = F_AllocSetContextCreateInternal(m, v44, int32(379593), int32(0), int32(8192), int32(8388608))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return int32(0)
			...
			*(*uint16)(unsafe.Add(mBase, uint32(v39+v44)+6)) = uint16(v40)
			...
			if base.Ui32(v155) < base.Ui32(v156) {
				...
				if v272 != 0 {
					...
					F_errmsg_internal(m, int32(226205), int32(0))
					mBase = m.M
					v276 = m.ExcPending
					if v276 != 0 {
						return
					} else {
						F_errfinish(m, int32(493082), int32(88), int32(352314))
						mBase = m.M
						v281 = m.ExcPending
						if v281 != 0 {
							return
				...
				if v161 != 0 {
					...
					if v160 == int32(0) {
						...
						if v285 != 0 {
							...
							F_errmsg_internal(m, int32(380886), int32(0))
							mBase = m.M
							v289 = m.ExcPending
							if v289 != 0 {
								return
							} else {
								F_errfinish(m, int32(493082), int32(92), int32(352314))
								mBase = m.M
								v294 = m.ExcPending
								if v294 != 0 {
									return
