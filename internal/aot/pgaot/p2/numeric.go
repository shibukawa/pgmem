			...
			if v45 == int32(0) {
				...
				if v81 != 0 {
					...
					if v85 != 0 {
						...
						F_errfinish(m, int32(476611), int32(4943), int32(336778))
						mBase = m.M
						v90 = m.ExcPending
						if v90 != 0 {
							return int32(0)
	...
	if v41 != 0 {
		...
		if v191 != 0 {
			...
			if v195 != 0 {
				...
				F_errfinish(m, int32(476611), int32(5259), int32(355964))
				mBase = m.M
				v200 = m.ExcPending
				if v200 != 0 {
					return int32(0)
...
L48:
	;
	F_errfinish(m, int32(476611), int32(3295), int32(201162))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L20
...
L72:
	;
	F_errfinish(m, int32(476611), int32(3318), int32(201162))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L20
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v295
	v364 = F_pg_snprintf(m, v359, v358, int32(443932), v11)
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L10
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+4)) = (v17<<(uint(v189)%32) - int32(8388608)) >> (uint(v189) % 32)
	F_errdetail(m, int32(588015), v15)
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L1
...
L48:
	;
	F_errmsg(m, int32(330192), int32(0))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L1
...
L49:
	;
	F_errfinish(m, int32(476611), int32(1108), int32(34302))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L1
...
L52:
	;
	F_errmsg(m, int32(330233), int32(0))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L1
...
L53:
	;
	F_errfinish(m, int32(476611), int32(1114), int32(34302))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L1
...
L56:
	;
	F_errmsg(m, int32(330150), int32(0))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L1
...
L57:
	;
	F_errfinish(m, int32(476611), int32(1123), int32(34302))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L1
		...
		*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v45
		...
		if v367 != 0 {
			...
			if v371 != 0 {
				...
				F_errfinish(m, int32(476611), int32(5442), int32(325336))
				mBase = m.M
				v376 = m.ExcPending
				if v376 != 0 {
					return int32(0)
