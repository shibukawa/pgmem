		...
		if v14 == int32(0) {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v31)
			...
			if v17+(v18+v19) != int64(0)-v23 {
				if int64(0) < v18 {
					v38 = F_make_result_opt_error(m, int32(1713132), int32(0))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
					...
					if v17 <= int64(0) {
						if int64(0) < v17 {
							v54 = F_make_result_opt_error(m, int32(1713156), int32(0))
							mBase = m.M
							v55 = m.ExcPending
							if v55 != 0 {
								return int32(0)
							...
							if int64(0) < v23 {
								v60 = F_make_result_opt_error(m, int32(1713180), int32(0))
								mBase = m.M
								v61 = m.ExcPending
								if v61 != 0 {
									return int32(0)
						...
						if v23 <= int64(0) {
							...
							v48 = F_make_result_opt_error(m, int32(1713132), int32(0))
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return int32(0)
			...
			if v45 == int32(0) {
				...
				if v81 != 0 {
					...
					if v85 != 0 {
						...
						F_errfinish(m, int32(491430), int32(4943), int32(347957))
						mBase = m.M
						v90 = m.ExcPending
						if v90 != 0 {
							return int32(0)
	...
	if v41 != 0 {
		...
		if v191 != 0 {
			...
			if v195 != 0 {
				...
				F_errfinish(m, int32(491430), int32(5259), int32(367498))
				mBase = m.M
				v200 = m.ExcPending
				if v200 != 0 {
					return int32(0)
...
L8:
	;
	v65 = F_make_result_opt_error(m, int32(1713132), int32(0))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L20
...
L22:
	;
	v191 = F_make_result_opt_error(m, int32(1713204), int32(0))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L20
...
L27:
	;
	v79 = F_make_result_opt_error(m, int32(1713132), int32(0))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L20
...
L31:
	;
	v129 = F_make_result_opt_error(m, int32(1713180), int32(0))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L20
...
L41:
	;
	v106 = F_make_result_opt_error(m, int32(1713156), int32(0))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L20
...
L48:
	;
	F_errfinish(m, int32(491430), int32(3295), int32(208508))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L20
...
L51:
	;
	v137 = F_make_result_opt_error(m, int32(1713132), int32(0))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L20
...
L55:
	;
	v187 = F_make_result_opt_error(m, int32(1713156), int32(0))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L20
...
L72:
	;
	F_errfinish(m, int32(491430), int32(3318), int32(208508))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L20
			...
			if base.Ui32(v21) <= base.Ui32(int32(49151)) {
				...
				if base.Ui32(v24) < base.Ui32(int32(49152)) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11)+40)) = v142
					...
					v30 = F_make_result_opt_error(m, int32(1713132), int32(0))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
	...
	if v15 != 0 {
		...
		if base.Ui32(int32(49152)) <= base.Ui32(v19) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v76
			v79 = v9 + int32(8)
			F_add_var(m, v79, int32(1713256), v79)
			mBase = m.M
			v84 = m.ExcPending
			if v84 != 0 {
				return int32(0)
			...
			if base.Ui32(v23) <= base.Ui32(int32(49151)) {
				...
				if base.Ui32(v26) < base.Ui32(int32(49152)) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v13)+52)) = v21 + v143
					...
					v32 = F_make_result_opt_error(m, int32(1713132), int32(0))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return int32(0)
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v295
	v364 = F_pg_snprintf(m, v359, v358, int32(457933), v11)
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L10
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+4)) = (v17<<(uint(v189)%32) - int32(8388608)) >> (uint(v189) % 32)
	F_errdetail(m, int32(603832), v15)
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L1
...
L48:
	;
	F_errmsg(m, int32(341318), int32(0))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L1
...
L49:
	;
	F_errfinish(m, int32(491430), int32(1108), int32(36143))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L1
...
L52:
	;
	F_errmsg(m, int32(341359), int32(0))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L1
...
L53:
	;
	F_errfinish(m, int32(491430), int32(1114), int32(36143))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L1
...
L56:
	;
	F_errmsg(m, int32(341276), int32(0))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L1
...
L57:
	;
	F_errfinish(m, int32(491430), int32(1123), int32(36143))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L1
		...
		*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v45
		...
		if v367 != 0 {
			...
			if v371 != 0 {
				...
				F_errfinish(m, int32(491430), int32(5442), int32(336429))
				mBase = m.M
				v376 = m.ExcPending
				if v376 != 0 {
					return int32(0)
