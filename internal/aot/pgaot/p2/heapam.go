...
L42:
	;
	v123 = int32(_a_F_heapam_index_build_range_scan_2)
	v125 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3]))
	v126 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3])) = v125 + v126
	...
	*(*int32)(unsafe.Add(mBase, uint32(v116))) = v137 + v126
	v143 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3])) = v143 - v126
	goto L40
L43:
	;
...
L51:
	;
	v193 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[4]))
	if v193 != 0 {
		goto L53
	} else {
		goto L54
...
L69:
	;
	v218 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[1]))
	if v218 == int32(0) {
		goto L71
	} else {
		goto L72
...
L72:
	;
	v222 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[2])))
	if v222 != int32(1) {
		goto L71
	} else {
		goto L73
...
L73:
	;
	v225 = int32(_a_F_heapam_index_build_range_scan_2)
	v227 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3]))
	v228 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3])) = v227 + v228
	...
	*(*int32)(unsafe.Add(mBase, uint32(v218))) = v239 + v228
	v245 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3])) = v245 - v228
	goto L71
L74:
	;
...
L78:
	;
	v259 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[5]))
...
L80:
	;
	v267 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[6]))
...
L114:
	;
	v363 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[7]))
	if v363 == v352 {
		goto L115
	} else {
		goto L116
...
L117:
	;
	v367 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[8]))
	if v367 <= int32(0) {
		goto L119
	} else {
		goto L120
...
L119:
	;
	v371 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[9]))
	if v371 == int32(0) {
		v464 = int32(0)
		goto L118
	} else {
...
L121:
	;
	v433 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[10]))
	v435 = int32(0)
	v437 = v367 - int32(1)
	goto L141
L122:
...
L160:
	;
	v503 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[4]))
	if v503 == int32(0) {
		goto L89
	} else {
		goto L161
...
L162:
	...
	if v507&int32(_a_F_heapam_index_build_range_scan_6) == int32(_a_F_heapam_index_build_range_scan_7) {
		goto L164
	} else {
		goto L165
	}
...
L171:
	;
	v526 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[7]))
	if v526 == v515 {
		goto L172
	} else {
		goto L173
...
L174:
	;
	v530 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[8]))
	if v530 <= int32(0) {
		goto L176
	} else {
		goto L177
...
L176:
	;
	v534 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[9]))
	if v534 == int32(0) {
		v627 = int32(0)
		goto L175
	} else {
...
L178:
	;
	v596 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[10]))
	v598 = int32(0)
	v600 = v530 - int32(1)
	goto L198
L179:
...
L224:
	;
	v682 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[4]))
	if v682 == int32(0) {
		goto L89
	} else {
		goto L225
...
L237:
	;
	v786 = int32(_a_F_heapam_index_build_range_scan_10)
	v787 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[11]))
	v789 = *(*int32)(unsafe.Add(mBase, uint32(v64)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[11])) = v789
...
L240:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[11])) = v787
	if v794 == int32(0) {
		v908 = v779
		goto L84
	} else {
...
L248:
	;
	if base.Ui32(int32(2048)) <= base.Ui32((v852-int32(1))&int32(_a_F_heapam_index_build_range_scan_11)) {
		goto L46
	} else {
		goto L256
	}
...
L250:
	;
	v825 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[5]))
...
L252:
	;
	v833 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[6]))
...
L266:
	...
	v951 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[1]))
	if v951 == int32(0) {
		goto L268
	} else {
		goto L269
...
L269:
	;
	v955 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[2])))
	if v955 != int32(1) {
		goto L268
	} else {
		goto L270
...
L270:
	;
	v958 = int32(_a_F_heapam_index_build_range_scan_2)
	v960 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3]))
	v961 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3])) = v960 + v961
	...
	*(*int32)(unsafe.Add(mBase, uint32(v951))) = v972 + v961
	v978 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_build_range_scan[3])) = v978 - v961
	goto L268
L271:
	;
	if v105 != 0 {
...
L13:
	;
	v57 = int32(_a_F_heapam_index_validate_scan_1)
	v59 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[2]))
	v60 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[2])) = v59 + v60
	...
	*(*int32)(unsafe.Add(mBase, uint32(v50))) = v71 + v60
	v77 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[2])) = v77 - v60
	goto L11
L14:
	;
	if v81 != 0 {
...
L18:
	;
	v103 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[3]))
	if v103 != 0 {
		goto L20
	} else {
		goto L21
...
L24:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[0]))
	if v121 == int32(0) {
		goto L28
	} else {
		goto L29
...
L29:
	;
	v125 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[1])))
	if v125 != int32(1) {
		goto L28
	} else {
		goto L30
...
L30:
	;
	v128 = int32(_a_F_heapam_index_validate_scan_1)
	v130 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[2]))
	v131 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[2])) = v130 + v131
	...
	*(*int32)(unsafe.Add(mBase, uint32(v121))) = v142 + v131
	v148 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[2])) = v148 - v131
	goto L28
L31:
	;
...
L35:
	;
	v159 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[4]))
...
L37:
	;
	v167 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[5]))
...
L43:
	;
	v489 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v216&int32(_a_F_heapam_index_validate_scan_2)+v20)+31)))
	if v489 != 0 {
		v541 = v478
		v547 = v484
		goto L42
...
L46:
	...
	if base.Ui32(int32(2048)) <= base.Ui32((v208-v205)&int32(_a_F_heapam_index_validate_scan_2)) {
		goto L45
	} else {
		goto L49
	}
...
L93:
	;
	v496 = int32(_a_F_heapam_index_validate_scan_6)
	v497 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[6]))
	v499 = *(*int32)(unsafe.Add(mBase, uint32(v29)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_heapam_index_validate_scan[6])) = v499
							...
							if base.Ui32(int32(2)) <= base.Ui32(v58-int32(1042)) {
								...
								default:
									if v58 != int32(1700) {
										...
										if int32(4) <= v59 {
											v94 = int32(base.Ui32(int32(base.Ui32(v59-int32(4))>>(uint(int32(16))%32))+int32(6))>>(uint(int32(1))%32))&int32(_a_F_heapam_relation_needs_toast_table_0) + int32(8)
										} else {
											v94 = int32(-1)
										}
										v103 = v94
...
L12:
	;
	v67 = v54&int32(_a_F_heapam_scan_analyze_next_tuple_1)<<(uint(int32(2))%32) + (v32 + int32(24)) - int32(4)
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l4)+64)) = v32 + v84&int32(_a_F_heapam_scan_analyze_next_tuple_2)
...
L18:
	...
	if v228&int32(_a_F_heapam_scan_analyze_next_tuple_3) == int32(_a_F_heapam_scan_analyze_next_tuple_4) {
		goto L67
	} else {
		goto L68
	}
...
L28:
	;
	v117 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_analyze_next_tuple[2]))
	if v117 == v106 {
		goto L29
	} else {
		goto L30
...
L31:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_analyze_next_tuple[3]))
	if v121 <= int32(0) {
		goto L33
	} else {
		goto L34
...
L33:
	;
	v125 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_analyze_next_tuple[4]))
	if v125 == int32(0) {
		v218 = int32(0)
		goto L32
	} else {
...
L35:
	;
	v187 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_analyze_next_tuple[5]))
	v189 = int32(0)
	v191 = v121 - int32(1)
	goto L55
L36:
...
L74:
	;
	v247 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_analyze_next_tuple[2]))
	if v247 == v236 {
		goto L75
	} else {
		goto L76
...
L77:
	;
	v251 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_analyze_next_tuple[3]))
	if v251 <= int32(0) {
		goto L79
	} else {
		goto L80
...
L79:
	;
	v255 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_analyze_next_tuple[4]))
	if v255 == int32(0) {
		v348 = int32(0)
		goto L78
	} else {
...
L81:
	;
	v317 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_analyze_next_tuple[5]))
	v319 = int32(0)
	v321 = v251 - int32(1)
	goto L101
L82:
...
L7:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_sample_next_tuple[0]))
...
L9:
	;
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_sample_next_tuple[1]))
...
L13:
	;
	v78 = int32(base.Ui32(v70+int32(_a_F_heapam_scan_sample_next_tuple_0)) >> (uint(int32(2)) % 32))
	goto L15
L14:
	;
	v78 = int32(0)
...
L16:
	;
	return base.B2i32(base.Ui32(v110&int32(_a_F_heapam_scan_sample_next_tuple_1)) < base.Ui32(int32(2048)))
L17:
	;
	v103 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_sample_next_tuple[2]))
	if v103 != 0 {
		goto L19
	} else {
		goto L20
...
L21:
	...
	v107 = m.T0[v106].(func(*base.Module, int32, int32, int32) int32)(m, l1, v22, v78&int32(_a_F_heapam_scan_sample_next_tuple_1))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L4
...
L26:
	;
	v110 = v107 - int32(1)
	if base.Ui32(v110&int32(_a_F_heapam_scan_sample_next_tuple_1)) <= base.Ui32(int32(2047)) {
		goto L27
	} else {
		goto L28
	}
L27:
	...
	if v120&int32(_a_F_heapam_scan_sample_next_tuple_2) != int32(_a_F_heapam_scan_sample_next_tuple_3) {
		goto L17
	} else {
		goto L30
	}
...
L30:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v53 + v120&int32(_a_F_heapam_scan_sample_next_tuple_4)
