...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v225
	F_errmsg_internal(m, int32(479715), v17)
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L70
...
L83:
	;
	F_errfinish(m, int32(490258), int32(2034), int32(310982))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L70
...
func F_ForgetPortalSnapshots(m *base.Module) {
	...
	v7 = v5 - int32(32)
	m.G0 = v7
	v12 = *(*int32)(unsafe.Add(mBase, _consts[1239]))
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v35
	F_errmsg_internal(m, int32(660535), v7)
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(494027), int32(1292), int32(118468))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L1
...
func F___funcs_on_exit(m *base.Module) {
	...
	var v44 int32
	_ = v44
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1422]))
	if v5 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v7 = *(*int32)(unsafe.Add(mBase, _consts[1423]))
	v8 = v5
	v10 = v7
	goto L4
L2:
...
L4:
	;
	v13 = v10 - int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[1423])) = v13
	if int32(0) < v10 {
		goto L6
	} else {
		goto L7
...
L8:
	...
	v44 = int32(32)
	*(*int32)(unsafe.Add(mBase, _consts[1423])) = v44
	*(*int32)(unsafe.Add(mBase, _consts[1422])) = v43
	if v43 != 0 {
		v8 = v43
		v10 = v44
		goto L4
...
L9:
	;
	v21 = *(*int32)(unsafe.Add(mBase, _consts[1422]))
...
L10:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _consts[1422]))
	v42 = v38
	goto L8
L11:
	;
...
L12:
	;
	v29 = int32(4663696)
	v31 = *(*int32)(unsafe.Add(mBase, _consts[1423]))
	v33 = v31 - int32(1)
...
L201:
	;
	F_errfinish(m, int32(490318), int32(2929), int32(281471))
	mBase = m.M
	v750 = m.ExcPending
	if v750 != 0 {
		goto L16
...
L239:
	;
	F_errmsg_internal(m, int32(221880), int32(0))
	mBase = m.M
	v895 = m.ExcPending
	if v895 != 0 {
		goto L16
...
L240:
	;
	F_errfinish(m, int32(490318), int32(2468), int32(281471))
	mBase = m.M
	v900 = m.ExcPending
	if v900 != 0 {
		goto L16
...
L242:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v347
	F_errmsg_internal(m, int32(476763), v16+int32(16))
	mBase = m.M
	v911 = m.ExcPending
	if v911 != 0 {
		goto L16
...
L243:
	;
	F_errfinish(m, int32(490318), int32(2636), int32(281471))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L16
...
L245:
	;
	F_errmsg_internal(m, int32(394097), int32(0))
	mBase = m.M
	v924 = m.ExcPending
	if v924 != 0 {
		goto L16
...
L246:
	;
	F_errfinish(m, int32(490318), int32(2978), int32(281471))
	mBase = m.M
	v929 = m.ExcPending
	if v929 != 0 {
		goto L16
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v148
	F_errmsg(m, int32(364905), v14+int32(32))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L1
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v148
	F_errmsg(m, int32(103218), v14+int32(16))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
...
L42:
	;
	F_errfinish(m, int32(491372), int32(7051), int32(167650))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L1
...
L44:
	;
	F_errfinish(m, int32(491372), int32(7058), int32(167650))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L1
...
L46:
	;
	F_errfinish(m, int32(491372), int32(7065), int32(167650))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L1
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+52)) = v246 + v247
	F_errmsg(m, int32(103218), v14+int32(48))
	mBase = m.M
	v258 = m.ExcPending
	if v258 != 0 {
		goto L1
...
L57:
	;
	F_errfinish(m, int32(491372), int32(7044), int32(167650))
	mBase = m.M
	v263 = m.ExcPending
	if v263 != 0 {
		goto L1
...
L63:
	;
	v175 = v172 - v166
	v177 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v175)+uint32(_consts[1275]))))
	if v177 != 0 {
		v207 = v167
		goto L64
	} else {
...
L65:
	;
	v179 = *(*int32)(unsafe.Add(mBase, _consts[1230]))
	if v179 == int32(0) {
		v207 = v167
		goto L64
	} else {
...
L138:
	;
	*(*int32)(unsafe.Add(mBase, _consts[155])) = v388
	goto L130
L139:
	;
	if v391 == int32(0) {
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l1
	F_errmsg_internal(m, int32(294994), v10+int32(16))
	mBase = m.M
	v410 = m.ExcPending
	if v410 != 0 {
		goto L56
...
L144:
	;
	F_errfinish(m, int32(496886), int32(218), int32(488441))
	mBase = m.M
	v415 = m.ExcPending
	if v415 != 0 {
		goto L56
...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	F_errmsg_internal(m, int32(346625), v10)
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L56
...
L150:
	;
	F_errfinish(m, int32(496886), int32(225), int32(488441))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L56
...
L155:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l1
	F_errmsg_internal(m, int32(294970), v10+int32(32))
	mBase = m.M
	v462 = m.ExcPending
	if v462 != 0 {
		goto L56
...
L156:
	;
	F_errfinish(m, int32(496886), int32(174), int32(488441))
	mBase = m.M
	v467 = m.ExcPending
	if v467 != 0 {
		goto L56
		...
		if v56 != 0 {
			...
			if v59 != 0 {
				...
				if v63 != 0 {
					...
					F_errfinish(m, int32(492756), int32(3573), int32(317949))
					mBase = m.M
					v68 = m.ExcPending
					if v68 != 0 {
						return
		...
		if v56 != 0 {
			...
			if v59 != 0 {
				...
				if v63 != 0 {
					...
					F_errfinish(m, int32(492756), int32(3517), int32(299446))
					mBase = m.M
					v68 = m.ExcPending
					if v68 != 0 {
						return
			...
			if v17 != 0 {
				...
				if v14 != 0 {
					...
					if v28 != 0 {
						...
						F_errmsg_internal(m, int32(116967), int32(0))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(490983), int32(3458), int32(208004))
							mBase = m.M
							v37 = m.ExcPending
							if v37 != 0 {
								return int32(0)
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
				...
				if v47 != 0 {
					...
					F_errfinish(m, int32(490827), int32(13652), int32(136263))
					mBase = m.M
					v52 = m.ExcPending
					if v52 != 0 {
						return int32(0)
	...
	if v19 != 0 {
		...
		if v20 != int32(1) {
			...
			if v135 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(285804)
				F_errmsg_internal(m, int32(26093), v13)
				mBase = m.M
				v142 = m.ExcPending
				if v142 != 0 {
					return int32(0)
		...
		if v30 != 0 {
			...
			if v33 != 0 {
				...
				if v37 != 0 {
					...
					F_errfinish(m, int32(490414), int32(1328), int32(549916))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return int32(0)
		...
		if v30 != 0 {
			...
			if v33 != 0 {
				...
				if v37 != 0 {
					...
					F_errfinish(m, int32(490414), int32(1303), int32(548407))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return int32(0)
		...
		if v34 != 0 {
			...
			if v37 != 0 {
				...
				if v41 != 0 {
					...
					F_errfinish(m, int32(497027), int32(1347), int32(545608))
					mBase = m.M
					v46 = m.ExcPending
					if v46 != 0 {
						return int32(0)
