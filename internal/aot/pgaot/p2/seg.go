	...
	if v4 == int32(0) {
		...
		if v9 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
			if v8 == int32(0) {
				F_yy_fatal_error_7(m, int32(_a_F_seg_yyensure_buffer_stack_0))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
			...
			if v18 == int32(0) {
				if v19 == int32(0) {
					...
					if v28 != 0 {
						...
						F_errmsg(m, int32(_a_F_seg_yyerror_0), int32(0))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l3
							...
							if v36 != 0 {
								...
								v56 = int32(82)
								F_errsave_finish(m, l1, int32(_a_F_seg_yyerror_2), v56, int32(_a_F_seg_yyerror_3))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return
	...
	if v4 != 0 {
		...
		if v9 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l0
			...
			F_yy_fatal_error_7(m, int32(_a_F_seg_yyset_lineno_0))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return
