	...
	if v4 == int32(0) {
		...
		if v9 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
			if v8 == int32(0) {
				F_yy_fatal_error_7(m, int32(684192))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
			...
			if v18 == int32(0) {
				if v19 == int32(0) {
					...
					if v27 != 0 {
						...
						F_errmsg(m, int32(259015), int32(0))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l3
							...
							if v38 != 0 {
								...
								v63 = int32(82)
								F_errsave_finish(m, l1, int32(314659), v63, int32(210217))
								mBase = m.M
								v70 = m.ExcPending
								if v70 != 0 {
									return
					...
					if v44 != 0 {
						...
						if v50 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l3
							F_errdetail(m, int32(702100), v9+int32(16))
							mBase = m.M
							v59 = m.ExcPending
							if v59 != 0 {
								return
	...
	if v4 != 0 {
		...
		if v9 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l0
			...
			F_yy_fatal_error_7(m, int32(225745))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return
