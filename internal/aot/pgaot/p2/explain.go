					...
					if v38 != 0 {
						...
						if l1 != 0 {
							...
							if v41 != 0 {
								...
								F_appendStringInfoString(m, v42, int32(703733))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v62))) = int32(1)
			...
			if l1 != 0 {
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
				F_appendStringInfo(m, v78, int32(703376), v8)
				mBase = m.M
				v82 = m.ExcPending
				if v82 != 0 {
					return
				...
				F_appendStringInfoString(m, v78, int32(703742))
				mBase = m.M
				v86 = m.ExcPending
				if v86 != 0 {
					return
...
func F_ExplainPropertyInteger(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8))) = l2
	v15 = F_pg_snprintf(m, v8+int32(16), int32(32), int32(409810), v8)
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		return
...
L53:
	...
	F_appendStringInfoString(m, v194, int32(530662))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L4
