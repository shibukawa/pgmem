...
func F_g_int_consistent(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v19)
		v22 = v18 & int32(_a_F_g_int_consistent_0)
						...
						if v46 != 0 {
							...
							*(*uint8)(unsafe.Add(mBase, uint32(v9)+14)) = uint8(v47)
							...
							if v63 != 0 {
								...
								switch v18&int32(_a_F_g_int_consistent_0) - int32(3) {
								case 0:
								...
								case 3:
									...
									if v76&int32(1) != 0 {
										v83 = F_DirectFunctionCall3Coll(m, int32(_a_F_g_int_consistent_4), int32(0), v72, v62, v9+int32(15))
										mBase = m.M
										v84 = m.ExcPending
										if v84 != 0 {
											return int32(0)
