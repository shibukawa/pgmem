				...
				if v34 != 0 {
					...
					if v37 != 0 {
						...
						if v41 != 0 {
							...
							F_errfinish(m, int32(492384), int32(2556), int32(133900))
							mBase = m.M
							v46 = m.ExcPending
							if v46 != 0 {
								return
...
L24:
	;
	F_errfinish(m, int32(492384), int32(2448), int32(133858))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L5
...
L25:
	;
	F_errfinish(m, int32(492384), int32(2949), int32(134082))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L5
...
L30:
	;
	F_errfinish(m, int32(493537), int32(2598), int32(313305))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L1
...
L76:
	;
	F_errfinish(m, int32(493537), int32(2607), int32(313305))
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L1
...
L79:
	;
	F_errfinish(m, int32(493537), int32(2617), int32(313305))
	mBase = m.M
	v286 = m.ExcPending
	if v286 != 0 {
		goto L1
...
L176:
	;
	F_errfinish(m, int32(495927), int32(2793), int32(354222))
	mBase = m.M
	v480 = m.ExcPending
	if v480 != 0 {
		goto L3
...
L179:
	;
	F_errfinish(m, int32(495927), int32(2803), int32(354222))
	mBase = m.M
	v493 = m.ExcPending
	if v493 != 0 {
		goto L3
...
L184:
	;
	F_errfinish(m, int32(495927), int32(2810), int32(354222))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L3
...
L189:
	;
	F_errfinish(m, int32(495927), int32(2826), int32(354222))
	mBase = m.M
	v533 = m.ExcPending
	if v533 != 0 {
		goto L3
...
L192:
	;
	F_errfinish(m, int32(495927), int32(2833), int32(354222))
	mBase = m.M
	v546 = m.ExcPending
	if v546 != 0 {
		goto L3
...
L218:
	...
	v663 = m.T0[v662].(func(*base.Module, int32, int32, int32, int32) int32)(m, v649, v21+int32(-32), int32(4154288), v643)
	mBase = m.M
	v664 = m.ExcPending
	if v664 != 0 {
		goto L3
...
L283:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = int32(535556)
...
L284:
	;
	F_errhint(m, int32(578009), int32(0))
	mBase = m.M
	v890 = m.ExcPending
	if v890 != 0 {
		goto L3
...
L285:
	;
	F_errfinish(m, int32(495927), int32(2790), int32(354222))
	mBase = m.M
	v895 = m.ExcPending
	if v895 != 0 {
		goto L3
...
L290:
	;
	F_errmsg_internal(m, int32(518108), int32(0))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L3
...
L291:
	;
	F_errfinish(m, int32(495927), int32(409), int32(389015))
	mBase = m.M
	v921 = m.ExcPending
	if v921 != 0 {
		goto L3
	...
	if v5 == int32(1599360) {
		...
		if v44 != 0 {
			...
			if v48 != 0 {
				...
				F_errfinish(m, int32(491057), int32(1620), int32(382564))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
...
func F_ExtendSUBTRANS(m *base.Module, l0 int32) {
	...
	if v8 == int32(0) {
		...
		if v24 != 0 {
			...
			v27 = F_SimpleLruZeroPage(m, int32(4381944), base.I64_extend_i32_u(v15))
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return
		...
		*(*int32)(unsafe.Add(mBase, _consts[1185])) = int32(-1)
		...
		if v13 != 0 {
			...
			if v17 != 0 {
				...
				F_errfinish(m, int32(494996), int32(859), int32(411089))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return
...
L27:
	;
	F_errfinish(m, int32(494996), int32(1393), int32(324998))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L4
...
L59:
	;
	F_FreeErrorDataContents(m, v17+int32(4479968))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L48
...
L78:
	;
	F_errfinish(m, int32(494996), int32(482), int32(320418))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L48
...
L22:
	;
	F_errfinish(m, int32(494996), int32(1324), int32(88775))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L4
...
func F_estonian_UTF_8_stem(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v6
	v10 = F_find_among(m, l0, int32(4242560), int32(290))
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
		goto L3
...
L10:
	;
	v127 = F_slice_from_s(m, l0, int32(5), int32(2173168))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L3
...
L11:
	;
	v121 = F_slice_from_s(m, l0, int32(4), int32(2173164))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L3
...
L12:
	;
	v115 = F_slice_from_s(m, l0, int32(4), int32(2173160))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L3
...
L13:
	;
	v109 = F_slice_from_s(m, l0, int32(5), int32(2173155))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L3
...
L14:
	;
	v103 = F_slice_from_s(m, l0, int32(4), int32(2173151))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L3
...
L15:
	;
	v97 = F_slice_from_s(m, l0, int32(7), int32(2173144))
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
		goto L3
...
L16:
	;
	v91 = F_slice_from_s(m, l0, int32(7), int32(2173137))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L3
...
L17:
	;
	v85 = F_slice_from_s(m, l0, int32(6), int32(2173131))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L3
...
L18:
	;
	v79 = F_slice_from_s(m, l0, int32(3), int32(2173128))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L3
...
L19:
	;
	v73 = F_slice_from_s(m, l0, int32(5), int32(2173123))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L3
...
L20:
	;
	v67 = F_slice_from_s(m, l0, int32(6), int32(2173117))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L3
...
L21:
	;
	v61 = F_slice_from_s(m, l0, int32(3), int32(2173114))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L3
...
L22:
	;
	v55 = F_slice_from_s(m, l0, int32(4), int32(2173110))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L3
...
L23:
	;
	v49 = F_slice_from_s(m, l0, int32(5), int32(2173105))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L3
...
L24:
	;
	v43 = F_slice_from_s(m, l0, int32(5), int32(2173100))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L3
...
L25:
	;
	v37 = F_slice_from_s(m, l0, int32(5), int32(2173095))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L3
...
L26:
	;
	v31 = F_slice_from_s(m, l0, int32(3), int32(2173092))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L3
...
L27:
	;
	v25 = F_slice_from_s(m, l0, int32(3), int32(2173089))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L3
...
L122:
	;
	v402 = F_find_among_b(m, l0, int32(4248368), int32(2))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L3
...
L172:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v599 + v464
	v604 = F_find_among_b(m, l0, int32(4248416), int32(9))
	mBase = m.M
	v605 = m.ExcPending
	if v605 != 0 {
		goto L3
...
L210:
	;
	v778 = F_find_among_b(m, l0, int32(4248608), int32(21))
	mBase = m.M
	v779 = m.ExcPending
	if v779 != 0 {
		goto L3
...
L214:
	;
	v793 = F_slice_from_s(m, l0, int32(1), int32(2175154))
	mBase = m.M
	v794 = m.ExcPending
	if v794 != 0 {
		goto L3
...
L252:
	;
	v962 = F_find_among_b(m, l0, int32(4249040), int32(12))
	mBase = m.M
	v963 = m.ExcPending
	if v963 != 0 {
		goto L3
...
L255:
	;
	v985 = F_slice_from_s(m, l0, int32(4), int32(2175250))
	mBase = m.M
	v986 = m.ExcPending
	if v986 != 0 {
		goto L3
...
L256:
	;
	v979 = F_slice_from_s(m, l0, int32(4), int32(2175246))
	mBase = m.M
	v980 = m.ExcPending
	if v980 != 0 {
		goto L3
...
L257:
	;
	v973 = F_slice_from_s(m, l0, int32(4), int32(2175242))
	mBase = m.M
	v974 = m.ExcPending
	if v974 != 0 {
		goto L3
...
L269:
	;
	v1019 = F_find_among_b(m, l0, int32(4249280), int32(10))
	mBase = m.M
	v1020 = m.ExcPending
	if v1020 != 0 {
		goto L3
...
L299:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v1160 + (v1024 - v1028)
	v1166 = F_find_among_b(m, l0, int32(4248416), int32(9))
	mBase = m.M
	v1167 = m.ExcPending
	if v1167 != 0 {
		goto L3
...
L329:
	;
	v1258 = F_find_among_b(m, l0, int32(4249488), int32(7))
	mBase = m.M
	v1259 = m.ExcPending
	if v1259 != 0 {
		goto L3
...
L334:
	...
	v1276 = F_find_among_b(m, l0, int32(4248416), int32(9))
	mBase = m.M
	v1277 = m.ExcPending
	if v1277 != 0 {
		goto L3
...
L335:
	;
	v1269 = F_slice_from_s(m, l0, int32(3), int32(2175326))
	mBase = m.M
	v1270 = m.ExcPending
	if v1270 != 0 {
		goto L3
...
L364:
	;
	v1376 = F_slice_from_s(m, l0, int32(1), int32(2175330))
	mBase = m.M
	v1377 = m.ExcPending
	if v1377 != 0 {
		goto L3
...
L367:
	;
	v1360 = F_find_among_b(m, l0, int32(4249632), int32(5))
	mBase = m.M
	v1361 = m.ExcPending
	if v1361 != 0 {
		goto L3
...
L368:
	;
	v1366 = F_slice_from_s(m, l0, int32(1), int32(2175329))
	mBase = m.M
	v1367 = m.ExcPending
	if v1367 != 0 {
		goto L3
...
L400:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v1510 + (v1263 - v1380)
	v1516 = F_find_among_b(m, l0, int32(4248416), int32(9))
	mBase = m.M
	v1517 = m.ExcPending
	if v1517 != 0 {
		goto L3
...
L412:
	;
	v1555 = F_find_among_b(m, l0, int32(4249744), int32(3))
	mBase = m.M
	v1556 = m.ExcPending
	if v1556 != 0 {
		goto L3
...
L450:
	;
	v1723 = F_find_among_b(m, l0, int32(4249808), int32(1))
	mBase = m.M
	v1724 = m.ExcPending
	if v1724 != 0 {
		goto L3
...
L483:
	;
	v1887 = F_find_among_b(m, l0, int32(4249840), int32(4))
	mBase = m.M
	v1888 = m.ExcPending
	if v1888 != 0 {
		goto L3
...
L517:
	;
	v2058 = F_find_among_b(m, l0, int32(4249920), int32(3))
	mBase = m.M
	v2059 = m.ExcPending
	if v2059 != 0 {
		goto L3
...
L520:
	;
	v2080 = F_slice_from_s(m, l0, int32(1), int32(2175379))
	mBase = m.M
	v2081 = m.ExcPending
	if v2081 != 0 {
		goto L3
...
L521:
	;
	v2074 = F_slice_from_s(m, l0, int32(1), int32(2175378))
	mBase = m.M
	v2075 = m.ExcPending
	if v2075 != 0 {
		goto L3
...
L522:
	;
	v2068 = F_slice_from_s(m, l0, int32(1), int32(2175377))
	mBase = m.M
	v2069 = m.ExcPending
	if v2069 != 0 {
		goto L3
							...
							if v103 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v104
								...
								if v108 != 0 {
									...
									F_errfinish(m, int32(490575), int32(642), int32(267633))
									mBase = m.M
									v113 = m.ExcPending
									if v113 != 0 {
										return int32(0)
...
L72:
	;
	F_errfinish(m, int32(491683), int32(5700), int32(393823))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L10
...
L94:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v313
	F_errmsg_internal(m, int32(705822), v16-int32(-64))
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L10
...
L95:
	;
	F_errfinish(m, int32(491683), int32(5795), int32(393823))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L10
...
L113:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v400
	F_errmsg_internal(m, int32(705981), v16+int32(16))
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L10
...
L114:
	;
	F_errfinish(m, int32(491683), int32(5813), int32(393823))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L10
...
L217:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v682
	F_errmsg_internal(m, int32(705848), v16+int32(48))
	mBase = m.M
	v688 = m.ExcPending
	if v688 != 0 {
		goto L10
...
L218:
	;
	F_errfinish(m, int32(491683), int32(5815), int32(393823))
	mBase = m.M
	v693 = m.ExcPending
	if v693 != 0 {
		goto L10
...
L220:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v698
	F_errmsg_internal(m, int32(705914), v16+int32(32))
	mBase = m.M
	v704 = m.ExcPending
	if v704 != 0 {
		goto L10
...
L221:
	;
	F_errfinish(m, int32(491683), int32(5818), int32(393823))
	mBase = m.M
	v709 = m.ExcPending
	if v709 != 0 {
		goto L10
...
L223:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v715
	F_errmsg_internal(m, int32(472121), v16)
	mBase = m.M
	v721 = m.ExcPending
	if v721 != 0 {
		goto L10
...
L224:
	;
	F_errfinish(m, int32(491683), int32(5857), int32(393823))
	mBase = m.M
	v726 = m.ExcPending
	if v726 != 0 {
		goto L10
...
L292:
	;
	F_errfinish(m, int32(491683), int32(5477), int32(393806))
	mBase = m.M
	v901 = m.ExcPending
	if v901 != 0 {
		goto L10
...
L302:
	;
	F_errfinish(m, int32(491683), int32(5440), int32(393806))
	mBase = m.M
	v941 = m.ExcPending
	if v941 != 0 {
		goto L10
...
L347:
	;
	F_errfinish(m, int32(490575), int32(2414), int32(460927))
	mBase = m.M
	v1150 = m.ExcPending
	if v1150 != 0 {
		goto L10
...
L350:
	;
	F_errfinish(m, int32(490575), int32(2421), int32(460927))
	mBase = m.M
	v1167 = m.ExcPending
	if v1167 != 0 {
		goto L10
							...
							if v113 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v109
								...
								if v121 != 0 {
									...
									F_errfinish(m, int32(496867), int32(5794), int32(109445))
									mBase = m.M
									v128 = m.ExcPending
									if v128 != 0 {
										return int32(0)
						...
						if v54 == int32(6) {
							...
							if v134 != 0 {
								...
								if v137 != 0 {
									...
									F_errmsg(m, int32(518376), int32(0))
									mBase = m.M
									v142 = m.ExcPending
									if v142 != 0 {
										return int32(0)
										...
										if v144 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v145
											...
											if v152 != 0 {
												...
												F_errfinish(m, int32(496867), int32(5814), int32(109445))
												mBase = m.M
												v159 = m.ExcPending
												if v159 != 0 {
													return int32(0)
							...
							if v65 != 0 {
								...
								if v68 != 0 {
									...
									F_errmsg(m, int32(518552), int32(0))
									mBase = m.M
									v73 = m.ExcPending
									if v73 != 0 {
										return int32(0)
										...
										if v75 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v10))) = v76
											...
											if v81 != 0 {
												...
												F_errfinish(m, int32(496867), int32(5819), int32(109445))
												mBase = m.M
												v88 = m.ExcPending
												if v88 != 0 {
													return int32(0)
...
L13:
	;
	v45 = F_substitute_path_macro(m, l0, int32(212337), int32(4483920))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L14
...
L25:
	;
	v61 = F_substitute_path_macro(m, v57, int32(212337), int32(4483920))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L14
...
L49:
	;
	F_errfinish(m, int32(489502), int32(504), int32(72842))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L21
