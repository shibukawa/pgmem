...
L22:
	;
	v80 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1227])))
...
L53:
	;
	v205 = *(*int32)(unsafe.Add(mBase, _consts[276]))
...
L59:
	;
	F_errfinish(m, int32(496606), int32(6767), int32(288958))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L44
...
L65:
	;
	v235 = *(*int32)(unsafe.Add(mBase, _consts[276]))
...
L73:
	;
	v252 = *(*int32)(unsafe.Add(mBase, _consts[276]))
	v253 = int32(0)
...
L2:
	;
	v17 = *(*int32)(unsafe.Add(mBase, _consts[575]))
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v18
	F_appendStringInfo(m, v6+int32(-24), int32(175893), v6+int32(-32))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L1
...
L8:
	...
	v42 = *(*int32)(unsafe.Add(mBase, _consts[647]))
...
L15:
	...
	v54 = F_MakeSingleTupleTableSlot(m, v52, int32(1599308))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L1
...
L50:
	;
	F_errhint(m, int32(556628), int32(0))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
...
L51:
	;
	F_errfinish(m, int32(496764), int32(989), int32(240500))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L1
...
L53:
	;
	F_errmsg_internal(m, int32(710402), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L1
...
L54:
	;
	F_errfinish(m, int32(496764), int32(994), int32(240500))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L1
...
L57:
	;
	F_errmsg(m, int32(213341), int32(0))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L1
...
L58:
	;
	F_errfinish(m, int32(496764), int32(1009), int32(240500))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L61:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = int32(376141)
	v166 = *(*int32)(unsafe.Add(mBase, _consts[575]))
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v166
	F_errmsg(m, int32(213138), v8)
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(496764), int32(1019), int32(240500))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
...
func F_varbittypmodin(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		v8 = F_anybit_typmodin(m, v3, int32(102613))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return int32(0)
...
L84:
	;
	F_errfinish(m, int32(493488), int32(135), int32(275484))
	mBase = m.M
	v690 = m.ExcPending
	if v690 != 0 {
		goto L1
...
L28:
	...
	v144 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v140&v43)+uint32(_consts[117]))))
	v145 = v137 + v144
	v147 = v133 + v138
	v149 = v135 + v138
	if v149 != v126 {
...
L32:
	...
	v173 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v169&v43)+uint32(_consts[117]))))
	v174 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v161)+2)))
	v178 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v174&v43)+uint32(_consts[117]))))
	v179 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v161)+1)))
	v183 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v179&v43)+uint32(_consts[117]))))
	v184 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v161))))
	v188 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v184&v43)+uint32(_consts[117]))))
...
L54:
	...
	v306 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v302&v205)+uint32(_consts[117]))))
	v307 = v299 + v306
	v309 = v295 + v300
	v311 = v297 + v300
	if v311 != v288 {
...
L58:
	...
	v335 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v331&v205)+uint32(_consts[117]))))
	v336 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v323)+2)))
	v340 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v336&v205)+uint32(_consts[117]))))
	v341 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v323)+1)))
	v345 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v341&v205)+uint32(_consts[117]))))
	v346 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v323))))
	v350 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v346&v205)+uint32(_consts[117]))))
