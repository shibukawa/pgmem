...
L22:
	;
	v80 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1230])))
...
L59:
	;
	F_errfinish(m, int32(501271), int32(6767), int32(291557))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L44
...
L2:
	;
	v17 = *(*int32)(unsafe.Add(mBase, _consts[578]))
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v18
	F_appendStringInfo(m, v6+int32(-24), int32(177261), v6+int32(-32))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L1
...
L15:
	...
	v54 = F_MakeSingleTupleTableSlot(m, v52, int32(1620044))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L1
...
L50:
	;
	F_errhint(m, int32(576989), int32(0))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
...
L51:
	;
	F_errfinish(m, int32(501429), int32(989), int32(242462))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L1
...
L53:
	;
	F_errmsg_internal(m, int32(731132), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L1
...
L54:
	;
	F_errfinish(m, int32(501429), int32(994), int32(242462))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L1
...
L57:
	;
	F_errmsg(m, int32(214814), int32(0))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L1
...
L58:
	;
	F_errfinish(m, int32(501429), int32(1009), int32(242462))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L61:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = int32(379657)
	v166 = *(*int32)(unsafe.Add(mBase, _consts[578]))
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v166
	F_errmsg(m, int32(214611), v8)
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(501429), int32(1019), int32(242462))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
...
func F_varbittypmodin(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		v8 = F_anybit_typmodin(m, v3, int32(103544))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return int32(0)
...
L84:
	;
	F_errfinish(m, int32(498087), int32(135), int32(277795))
	mBase = m.M
	v690 = m.ExcPending
	if v690 != 0 {
		goto L1
