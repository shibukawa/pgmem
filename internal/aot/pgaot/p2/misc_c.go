...
L223:
	;
	F_errfinish(m, int32(496066), int32(5867), int32(485520))
	mBase = m.M
	v1146 = m.ExcPending
	if v1146 != 0 {
		goto L24
...
L233:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+32)) = v1164 + int32(4)
	F_errmsg(m, int32(701868), v31+int32(32))
	mBase = m.M
	v1172 = m.ExcPending
	if v1172 != 0 {
		goto L24
...
L234:
	;
	F_errdetail(m, int32(574358), int32(0))
	mBase = m.M
	v1176 = m.ExcPending
	if v1176 != 0 {
		goto L24
...
L235:
	;
	F_errfinish(m, int32(493225), int32(823), int32(10823))
	mBase = m.M
	v1181 = m.ExcPending
	if v1181 != 0 {
		goto L24
...
L251:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = v1250 + int32(4)
	F_errmsg(m, int32(701868), v31-int32(-64))
	mBase = m.M
	v1258 = m.ExcPending
	if v1258 != 0 {
		goto L24
...
L252:
	;
	F_errdetail(m, int32(553192), int32(0))
	mBase = m.M
	v1262 = m.ExcPending
	if v1262 != 0 {
		goto L24
...
L253:
	;
	F_errfinish(m, int32(493225), int32(811), int32(10823))
	mBase = m.M
	v1267 = m.ExcPending
	if v1267 != 0 {
		goto L24
...
L256:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+48)) = v1275 + int32(4)
	F_errmsg(m, int32(701868), v31+int32(48))
	mBase = m.M
	v1283 = m.ExcPending
	if v1283 != 0 {
		goto L24
...
L257:
	;
	F_errdetail(m, int32(553119), int32(0))
	mBase = m.M
	v1287 = m.ExcPending
	if v1287 != 0 {
		goto L24
...
L258:
	;
	F_errfinish(m, int32(493225), int32(817), int32(10823))
	mBase = m.M
	v1292 = m.ExcPending
	if v1292 != 0 {
		goto L24
...
L261:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+112)) = v1300 + int32(4)
	F_errmsg(m, int32(701035), v31+int32(112))
	mBase = m.M
	v1308 = m.ExcPending
	if v1308 != 0 {
		goto L24
...
L263:
	;
	F_errfinish(m, int32(493225), int32(829), int32(10823))
	mBase = m.M
	v1317 = m.ExcPending
	if v1317 != 0 {
		goto L24
...
L266:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+96)) = v1325 + int32(4)
	F_errmsg(m, int32(701035), v31+int32(96))
	mBase = m.M
	v1333 = m.ExcPending
	if v1333 != 0 {
		goto L24
...
L268:
	;
	F_errfinish(m, int32(493225), int32(835), int32(10823))
	mBase = m.M
	v1342 = m.ExcPending
	if v1342 != 0 {
		goto L24
...
L271:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+80)) = v1350 + int32(4)
	F_errmsg(m, int32(701035), v31+int32(80))
	mBase = m.M
	v1358 = m.ExcPending
	if v1358 != 0 {
		goto L24
...
L273:
	;
	F_errfinish(m, int32(493225), int32(841), int32(10823))
	mBase = m.M
	v1367 = m.ExcPending
	if v1367 != 0 {
		goto L24
...
L277:
	;
	F_errhint(m, int32(640844), int32(0))
	mBase = m.M
	v1385 = m.ExcPending
	if v1385 != 0 {
		goto L24
...
L278:
	;
	F_errfinish(m, int32(493225), int32(861), int32(10823))
	mBase = m.M
	v1390 = m.ExcPending
	if v1390 != 0 {
		goto L24
...
L282:
	;
	F_errhint(m, int32(640769), int32(0))
	mBase = m.M
	v1410 = m.ExcPending
	if v1410 != 0 {
		goto L24
...
L283:
	;
	F_errfinish(m, int32(493225), int32(867), int32(10823))
	mBase = m.M
	v1415 = m.ExcPending
	if v1415 != 0 {
		goto L24
...
func F_ConditionVariableCancelSleep(m *base.Module) {
	...
	if v7 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(1)
		if v8 != 0 {
			F_s_lock(m, v7, int32(495906), int32(238), int32(236597))
			mBase = m.M
			v15 = m.ExcPending
			if v15 != 0 {
				return
...
L19:
	;
	F_s_lock(m, v20, int32(494462), int32(387), int32(62156))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L28:
	;
	F_s_lock(m, v20, int32(494462), int32(395), int32(62156))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L1
...
L35:
	;
	F_s_lock(m, v20, int32(494462), int32(430), int32(62156))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L1
...
L53:
	;
	F_errfinish(m, int32(494462), int32(358), int32(62156))
	mBase = m.M
	v200 = m.ExcPending
	if v200 != 0 {
		goto L1
...
L56:
	;
	F_errfinish(m, int32(494462), int32(361), int32(62156))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L1
...
L60:
	;
	F_errfinish(m, int32(494462), int32(367), int32(62156))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L64:
	;
	F_errfinish(m, int32(494462), int32(373), int32(62156))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L1
...
L68:
	;
	F_errfinish(m, int32(494462), int32(379), int32(62156))
	mBase = m.M
	v263 = m.ExcPending
	if v263 != 0 {
		goto L1
...
L10:
	;
	v48 = F_pg_snprintf(m, v8+int32(1104), int32(1024), int32(485695), int32(0))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L2
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = int32(550720)
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(485695)
		...
		if v34 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
			...
			if v39 != 0 {
				...
				F_errfinish(m, int32(496640), int32(410), int32(98961))
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return
	...
	if base.Ui32(l2-int32(20)) < base.Ui32(int32(2)) {
		...
		if l2 == int32(19) {
								...
								if v101 != 0 {
									...
									if v105 != 0 {
										...
										if v107 != 0 {
											...
											F_errfinish(m, int32(495519), int32(1965), int32(550016))
											mBase = m.M
											v112 = m.ExcPending
											if v112 != 0 {
												return
											...
											if v53 != 0 {
												...
												if v56 != 0 {
													...
													if v58 != 0 {
														...
														F_errfinish(m, int32(495519), int32(1974), int32(550016))
														mBase = m.M
														v63 = m.ExcPending
														if v63 != 0 {
															return
			...
			if v67 != 0 {
				...
				F_errmsg_internal(m, int32(549993), int32(0))
				mBase = m.M
				v71 = m.ExcPending
				if v71 != 0 {
					return
				} else {
					F_errfinish(m, int32(495519), int32(1983), int32(550016))
					mBase = m.M
					v76 = m.ExcPending
					if v76 != 0 {
						return
...
L31:
	;
	F_errfinish(m, int32(495105), int32(693), int32(120199))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L5
...
L88:
	;
	F_errfinish(m, int32(495105), int32(600), int32(118766))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L5
...
L100:
	;
	F_errfinish(m, int32(495105), int32(615), int32(118766))
	mBase = m.M
	v310 = m.ExcPending
	if v310 != 0 {
		goto L5
...
L103:
	;
	F_errmsg(m, int32(534958), int32(0))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L5
...
L104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v327
	F_errdetail(m, int32(604066), v15)
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L5
...
L106:
	;
	F_errfinish(m, int32(495105), int32(708), int32(120199))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L5
...
L112:
	;
	F_errfinish(m, int32(495105), int32(731), int32(120199))
	mBase = m.M
	v359 = m.ExcPending
	if v359 != 0 {
		goto L5
...
L118:
	;
	F_errfinish(m, int32(495105), int32(738), int32(120199))
	mBase = m.M
	v380 = m.ExcPending
	if v380 != 0 {
		goto L5
...
L122:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+48)) = v394
	F_errdetail(m, int32(604066), v15+int32(48))
	mBase = m.M
	v400 = m.ExcPending
	if v400 != 0 {
		goto L5
...
L124:
	;
	F_errfinish(m, int32(495105), int32(745), int32(120199))
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L5
...
L29:
	;
	F_errfinish(m, int32(495449), int32(163), int32(360650))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L1
...
func F_check_bonjour(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v4 == int32(1) {
		...
		*(*int32)(unsafe.Add(mBase, _consts[250])) = v8
		v14 = F_format_elog_string(m, int32(428073), int32(0))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v19
								...
								if v84 != 0 {
									...
									if v87 != 0 {
										...
										F_errfinish(m, int32(494098), int32(305), int32(220609))
										mBase = m.M
										v92 = m.ExcPending
										if v92 != 0 {
											return int32(0)
								...
								if v41 != 0 {
									...
									if v44 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v19
										F_errmsg(m, int32(464265), v9+int32(16))
										mBase = m.M
										v50 = m.ExcPending
										if v50 != 0 {
											return int32(0)
											...
											if v53 != 0 {
												...
												F_errfinish(m, int32(494098), int32(312), int32(220609))
												mBase = m.M
												v58 = m.ExcPending
												if v58 != 0 {
													return int32(0)
											...
											if v57 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v8))) = v22 + int32(12)
												...
												if v64 != 0 {
													...
													F_errhint(m, int32(630107), int32(0))
													mBase = m.M
													v68 = m.ExcPending
													if v68 != 0 {
														return
													} else {
														F_errfinish(m, int32(493941), int32(102), int32(357783))
														mBase = m.M
														v73 = m.ExcPending
														if v73 != 0 {
															return
	...
	if v5 != v4 {
		...
		if v10 != v8 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[250])) = v14
			v20 = F_format_elog_string(m, int32(609861), int32(0))
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
				return int32(0)
...
func F_clog_redo(m *base.Module, l0 int32) {
		...
		if v24 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v12
			...
			if v28 != 0 {
				...
				F_errfinish(m, int32(495003), int32(1142), int32(241410))
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return
	...
	case 16:
		...
		if v17 != 0 {
			...
			F_SimpleLruTruncate(m, int32(4381568), v14)
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = v43
									...
									if v48 != 0 {
										...
										if v52 != 0 {
											...
											F_errfinish(m, int32(492185), int32(475), int32(217230))
											mBase = m.M
											v57 = m.ExcPending
											if v57 != 0 {
												return int32(0)
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = base.I32_extend16_s(v107)
	F_errmsg_internal(m, int32(480247), v15)
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
						...
						if base.F64_gt(v94, v22) != 0 {
							...
							if v109 != 0 {
								...
								if v113 != 0 {
									...
									F_errfinish(m, int32(496685), int32(1256), int32(415239))
									mBase = m.M
									v118 = m.ExcPending
									if v118 != 0 {
										return float64(0)
							...
							if base.F64_gt(v49, v36) != 0 {
								...
								if v64 != 0 {
									...
									if v68 != 0 {
										...
										F_errfinish(m, int32(496685), int32(1245), int32(415239))
										mBase = m.M
										v73 = m.ExcPending
										if v73 != 0 {
											return float64(0)
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v64
	F_errmsg_internal(m, int32(469969), v12)
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L7
...
L37:
	;
	F_errfinish(m, int32(496212), int32(955), int32(502259))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L7
...
func F_connect(m *base.Module, l0 int32) int32 {
	...
	_ = v15
	v4 = int32(0)
	v7 = m.Env.X__syscall_connect(m, l0, int32(4085622), int32(12), v4, v4, v4)
	mBase = m.M
...
L60:
	;
	F_errfinish(m, int32(491991), int32(58), int32(212156))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		goto L5
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = int32(16384)
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15
				if v15 == int32(0) {
					F_yy_fatal_error_2(m, int32(665404))
					mBase = m.M
					v81 = m.ExcPending
					if v81 != 0 {
						return int32(0)
...
L97:
	;
	F_errfinish(m, int32(493584), int32(3138), int32(281368))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L13
						...
						if v68 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = v70 + int32(4)
							...
							if v76 != 0 {
								...
								F_errfinish(m, int32(496352), int32(887), int32(431937))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return int32(0)
					...
					if v46 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v48 + int32(4)
						...
						if v56 != 0 {
							...
							F_errfinish(m, int32(496352), int32(881), int32(431937))
							mBase = m.M
							v61 = m.ExcPending
							if v61 != 0 {
								return int32(0)
