...
func F_LogicalIncreaseRestartDecodingForSlot(m *base.Module, l0 int64, l1 int64) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(1)
	if v15 != 0 {
		F_s_lock(m, v14, int32(474525), int32(1757), int32(81743))
		mBase = m.M
		v22 = m.ExcPending
		if v22 != 0 {
			return
						...
						if v45 != 0 {
							...
							if v44 == int32(0) {
								...
								*(*uint32)(unsafe.Add(mBase, uint32(v11))) = uint32(v54)
								F_errmsg_internal(m, int32(490217), v11)
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return
								} else {
									F_errfinish(m, int32(474525), int32(1792), int32(81743))
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return
						...
						if v70 != 0 {
							...
							if v69 == int32(0) {
								...
								*(*uint32)(unsafe.Add(mBase, uint32(v11)+16)) = uint32(v91)
								F_errmsg_internal(m, int32(490894), v9+int32(-48))
								mBase = m.M
								v97 = m.ExcPending
								if v97 != 0 {
									return
								} else {
									F_errfinish(m, int32(474525), int32(1810), int32(81743))
									mBase = m.M
									v102 = m.ExcPending
									if v102 != 0 {
										return
...
L9:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v25)+uint32(_consts[1238]))) = int64(-1)
	goto L8
L10:
	;
...
L20:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v46)+uint32(_consts[1239]))) = v44
...
L21:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v55)+uint32(_consts[1238]))) = v58
...
L34:
	;
	F_errfinish(m, int32(475720), int32(797), int32(333294))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L4
	...
	if v24 != 0 {
		...
		if v25 == int32(0) {
			...
			if v36 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = int32(146509)
				v55 = F_pg_snprintf(m, v12+int32(48), int32(1024), int32(27646), v12+int32(16))
				mBase = m.M
				v56 = m.ExcPending
				if v56 != 0 {
					return
							...
							if v133 != 0 {
								...
								if v135 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v12))) = v12 + int32(48)
									F_errmsg(m, int32(284695), v12)
									mBase = m.M
									v141 = m.ExcPending
									if v141 != 0 {
										return
									} else {
										F_errfinish(m, int32(473089), int32(977), int32(317660))
										mBase = m.M
										v146 = m.ExcPending
										if v146 != 0 {
											return
