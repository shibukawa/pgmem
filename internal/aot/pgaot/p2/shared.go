...
L18:
	;
	F_s_lock(m, v18, int32(493521), int32(422), int32(167899))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L5
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = v80
	v99 = *(*int32)(unsafe.Add(mBase, uint32(v14)+uint32(_consts[795])))
	if v96 < v99 {
		goto L22
	} else {
		goto L23
...
L22:
	;
	v102 = *(*int32)(unsafe.Add(mBase, uint32(v14)+uint32(_consts[796])))
	v107 = int32(0)
	goto L25
L23:
	;
...
L25:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v14+int32(65570)+v117<<(uint(int32(4))%32)))) = uint8(v121)
	v124 = v107 + v121
	v125 = *(*int32)(unsafe.Add(mBase, uint32(v14)+uint32(_consts[795])))
	if v124 < v125 {
		v107 = v124
		goto L25
	} else {
...
func F_shared_buffer_readv_stage(m *base.Module, l0 int32, l1 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v10+int32(23)))) = uint8(v14)
	v17 = *(*int32)(unsafe.Add(mBase, _consts[746]))
...
L1:
	;
	v24 = v10 + int32(8)
	v26 = *(*int32)(unsafe.Add(mBase, _consts[746]))
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+44)) = int32(229337)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+36)) = int32(495274)
...
L10:
	;
	v98 = int32(4122092)
	v99 = *(*int32)(unsafe.Add(mBase, _consts[740]))
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v64))) = (v90 + int32(4194305)) & int32(-4194305)
	v130 = *(*int32)(unsafe.Add(mBase, _consts[262]))
	F_ResourceOwnerForget(m, v130, v47, int32(1628364))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L13
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, _consts[740])) = v116
	goto L17
L19:
	;
	if int32(999) < v99 {
