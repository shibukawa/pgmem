...
L18:
	;
	F_s_lock(m, v18, int32(504401), int32(422), int32(171784))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L5
...
L1:
	;
	v24 = v10 + int32(8)
	v26 = *(*int32)(unsafe.Add(mBase, _consts[745]))
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+44)) = int32(234095)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+36)) = int32(506700)
...
L10:
	;
	v98 = int32(4142620)
	v99 = *(*int32)(unsafe.Add(mBase, _consts[739]))
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v64))) = (v90 + int32(4194305)) & int32(-4194305)
	...
	F_ResourceOwnerForget(m, v130, v47, int32(1642572))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L13
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, _consts[739])) = v116
	goto L17
L19:
	;
	if int32(999) < v99 {
