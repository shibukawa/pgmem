...
L18:
	;
	F_s_lock(m, v18, int32(493780), int32(422), int32(167929))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L5
...
func F_shared_buffer_readv_stage(m *base.Module, l0 int32, l1 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v10+int32(23)))) = uint8(v14)
	v17 = *(*int32)(unsafe.Add(mBase, _consts[747]))
...
L1:
	;
	v24 = v10 + int32(8)
	v26 = *(*int32)(unsafe.Add(mBase, _consts[747]))
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+44)) = int32(229433)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+36)) = int32(495551)
...
L10:
	;
	v98 = int32(4122188)
	v99 = *(*int32)(unsafe.Add(mBase, _consts[741]))
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v64))) = (v90 + int32(4194305)) & int32(-4194305)
	...
	F_ResourceOwnerForget(m, v130, v47, int32(1628652))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L13
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, _consts[741])) = v116
	goto L17
L19:
	;
	if int32(999) < v99 {
