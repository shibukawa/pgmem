...
L13:
	;
	v63 = *(*int32)(unsafe.Add(mBase, uint32(v56<<(uint(int32(2))%32))+uint32(_consts[406])))
	v64 = v63
	goto L15
L14:
	;
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
	F_errmsg_internal(m, int32(41623), v12)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(505917), int32(12179), int32(137753))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = l1
	F_errmsg_internal(m, int32(41692), v12+int32(16))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L38:
	;
	F_errfinish(m, int32(505917), int32(12182), int32(137753))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L1
...
func F_has_foreign_data_wrapper_privilege_id(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v8)+15)) = uint8(v16)
		...
		v22 = F_convert_any_priv_string(m, v12, int32(1673440))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_has_foreign_data_wrapper_privilege_name(m *base.Module, l0 int32) int32 {
	...
	if v8 != 0 {
		...
		if v11 != 0 {
			...
			v13 = *(*int32)(unsafe.Add(mBase, _consts[279]))
			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					v21 = F_convert_any_priv_string(m, v10, int32(1673440))
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return int32(0)
			...
			if v14 != 0 {
				...
				if v17 != 0 {
					...
					if v20 != 0 {
						...
						v22 = F_convert_any_priv_string(m, v11, int32(1673440))
						mBase = m.M
						v23 = m.ExcPending
						if v23 != 0 {
							return int32(0)
