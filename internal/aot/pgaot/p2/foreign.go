...
L35:
	;
	F_errfinish(m, int32(493890), int32(12179), int32(134588))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
L38:
	;
	F_errfinish(m, int32(493890), int32(12182), int32(134588))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L1
