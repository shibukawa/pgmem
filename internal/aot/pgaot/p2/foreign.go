...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
	F_errmsg_internal(m, int32(40638), v12)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(494212), int32(12179), int32(134678))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = l1
	F_errmsg_internal(m, int32(40707), v12+int32(16))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L38:
	;
	F_errfinish(m, int32(494212), int32(12182), int32(134678))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L1
...
func F_has_foreign_data_wrapper_privilege_id(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v8)+15)) = uint8(v16)
		...
		v22 = F_convert_any_priv_string(m, v12, int32(1657056))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		...
		if v11 != 0 {
			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					v21 = F_convert_any_priv_string(m, v10, int32(1657056))
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return int32(0)
			...
			if v14 != 0 {
				...
				if v17 != 0 {
					...
					if v20 != 0 {
						...
						v22 = F_convert_any_priv_string(m, v11, int32(1657056))
						mBase = m.M
						v23 = m.ExcPending
						if v23 != 0 {
							return int32(0)
