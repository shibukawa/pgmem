...
func F_HnswLoadNeighborTids(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) int32 {
	...
	if v13 != 0 {
		...
		if v16 != 0 {
			...
			if v10 < int32(0) {
				v20 = *(*int32)(unsafe.Add(mBase, _c_F_HnswLoadNeighborTids[0]))
				v26 = *(*int32)(unsafe.Add(mBase, uint32(v20+(v10^int32(-1))<<(uint(int32(2))%32))))
				v34 = v26
			} else {
				v28 = *(*int32)(unsafe.Add(mBase, _c_F_HnswLoadNeighborTids[1]))
			...
			v42 = v39&int32(_a_F_HnswLoadNeighborTids_0) + v34
