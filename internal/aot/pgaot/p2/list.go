...
L16:
	;
	v101 = F_PageAddItemExtended(m, v36, v92, v95, v85&int32(_a_F_writeListPage_4), int32(0))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L20
...
L29:
	;
	v153 = *(*int32)(unsafe.Add(mBase, _c_F_writeListPage[3]))
	if v153 <= int32(0) {
		goto L30
	} else {
		goto L31
...
L44:
	;
	v192 = int32(_a_F_writeListPage_1)
	v194 = *(*int32)(unsafe.Add(mBase, _c_F_writeListPage[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_writeListPage[0])) = v194 - int32(1)
