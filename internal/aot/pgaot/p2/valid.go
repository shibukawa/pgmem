...
L21:
	;
	v66 = F_strstr(m, l0, int32(628398))
	mBase = m.M
	if v66 != 0 {
		goto L3
	} else {
...
L39:
	;
	F_errdetail(m, int32(530732), int32(0))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L36
...
L40:
	;
	F_errfinish(m, int32(473200), int32(419), int32(360152))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L36
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = l0
	F_errmsg(m, int32(684897), v4+int32(-16))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L36
...
L44:
	;
	F_errdetail(m, int32(628076), int32(0))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L36
...
L45:
	;
	F_errfinish(m, int32(473200), int32(428), int32(360152))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L36
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = l0
	F_errmsg(m, int32(684897), v4+int32(-48))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L36
...
L49:
	;
	F_errdetail(m, int32(628152), int32(0))
	mBase = m.M
	v149 = m.ExcPending
	if v149 != 0 {
		goto L36
...
L50:
	;
	F_errfinish(m, int32(473200), int32(437), int32(360152))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L36
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = l0
	F_errmsg(m, int32(684897), v4+int32(-32))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L36
...
L54:
	;
	F_errdetail(m, int32(547736), int32(0))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L36
...
L55:
	;
	F_errfinish(m, int32(473200), int32(447), int32(360152))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L36
