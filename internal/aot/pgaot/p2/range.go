...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+192)) = v292
	F_errmsg(m, int32(_a_F_RangeVarCallbackForAlterRelation_26), v11+int32(192))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L13
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+112)) = v311
	F_errmsg(m, int32(_a_F_RangeVarCallbackForAlterRelation_15), v11+int32(112))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L13
...
L97:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+96)) = int32(_a_F_RangeVarCallbackForAlterRelation_16)
	F_errhint(m, int32(_a_F_RangeVarCallbackForAlterRelation_17), v11+int32(96))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L13
...
L98:
	;
	F_errfinish(m, int32(_a_F_RangeVarCallbackForAlterRelation_2), int32(_a_F_RangeVarCallbackForAlterRelation_18), int32(_a_F_RangeVarCallbackForAlterRelation_4))
	mBase = m.M
	v329 = m.ExcPending
	if v329 != 0 {
		goto L13
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+128)) = v337
	F_errmsg(m, int32(_a_F_RangeVarCallbackForAlterRelation_19), v11+int32(128))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L13
...
L102:
	;
	F_errhint(m, int32(_a_F_RangeVarCallbackForAlterRelation_20), int32(0))
	mBase = m.M
	v347 = m.ExcPending
	if v347 != 0 {
		goto L13
...
L103:
	;
	F_errfinish(m, int32(_a_F_RangeVarCallbackForAlterRelation_2), int32(_a_F_RangeVarCallbackForAlterRelation_21), int32(_a_F_RangeVarCallbackForAlterRelation_4))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L13
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+160)) = v360
	F_errmsg(m, int32(_a_F_RangeVarCallbackForAlterRelation_22), v11+int32(160))
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L13
...
L107:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+144)) = int32(_a_F_RangeVarCallbackForAlterRelation_16)
	F_errhint(m, int32(_a_F_RangeVarCallbackForAlterRelation_17), v11+int32(144))
	mBase = m.M
	v373 = m.ExcPending
	if v373 != 0 {
		goto L13
...
L111:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+176)) = v386
	F_errmsg(m, int32(_a_F_RangeVarCallbackForAlterRelation_24), v11+int32(176))
	mBase = m.M
	v392 = m.ExcPending
	if v392 != 0 {
		goto L13
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v22
	F_errmsg_internal(m, int32(_a_F_range_cmp_0), v10)
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L1
...
func F_range_gist_consistent_leaf_multirange(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	default:
		...
		if v97 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
			F_errmsg_internal(m, int32(_a_F_range_gist_consistent_leaf_multirange_0), v8)
			mBase = m.M
			v101 = m.ExcPending
			if v101 != 0 {
				return int32(0)
...
func F_range_gist_single_sorting_split(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	v23 = (v19 - int32(1)) & int32(_a_F_range_gist_single_sorting_split_0)
...
L2:
	;
	v29 = v19 & int32(_a_F_range_gist_single_sorting_split_0)
	if v29 != int32(1) {
		goto L3
	} else {
		goto L4
...
L9:
	;
	v78 = (v40 + int32(1)) & int32(_a_F_range_gist_single_sorting_split_0)
