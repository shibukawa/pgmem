...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = l0
	F_errmsg_internal(m, int32(699988), v11+int32(16))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L10
...
L13:
	;
	F_errfinish(m, int32(520340), int32(602), int32(20979))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L10
...
L85:
	;
	F_errmsg_internal(m, int32(230303), int32(0))
	mBase = m.M
	v265 = m.ExcPending
	if v265 != 0 {
		goto L10
...
L86:
	;
	F_errfinish(m, int32(520340), int32(599), int32(20979))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L10
...
L90:
	;
	F_errfinish(m, int32(520340), int32(611), int32(20979))
	mBase = m.M
	v286 = m.ExcPending
	if v286 != 0 {
		goto L10
...
L93:
	;
	F_errmsg(m, int32(341863), int32(0))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L10
...
L94:
	;
	F_errfinish(m, int32(520340), int32(617), int32(20979))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L10
...
L97:
	;
	F_errmsg(m, int32(341766), int32(0))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L10
...
L98:
	;
	F_errfinish(m, int32(520340), int32(622), int32(20979))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L10
	...
	if v7 != int32(1) {
		...
		if v28 == int32(0) {
			...
			if v32 == int32(0) {
				...
				F_queue_listen(m, int32(2), int32(785340))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
		...
		if v13 != 0 {
			...
			if v12 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v4))) = v17
				F_errmsg_internal(m, int32(703915), v4)
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return
				} else {
					F_errfinish(m, int32(520340), int32(772), int32(317299))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return
...
func F_Async_UnlistenOnExit(m *base.Module, l0 int32, l1 int32) {
	...
	if v8 != int32(1) {
		m.Env.Pgmem_listen(m, int32(785340), int32(2))
		mBase = m.M
		...
		if v14 != 0 {
			...
			if v13 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = v18
				F_errmsg_internal(m, int32(703769), v5)
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return
				} else {
					F_errfinish(m, int32(520340), int32(1205), int32(106817))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
