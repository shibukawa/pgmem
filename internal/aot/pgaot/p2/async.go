...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = l0
	F_errmsg_internal(m, int32(624969), v11+int32(16))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L10
...
L13:
	;
	F_errfinish(m, int32(469278), int32(602), int32(19395))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L10
...
L119:
	;
	F_errmsg_internal(m, int32(207951), int32(0))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L10
...
L120:
	;
	F_errfinish(m, int32(469278), int32(599), int32(19395))
	mBase = m.M
	v382 = m.ExcPending
	if v382 != 0 {
		goto L10
...
L124:
	;
	F_errfinish(m, int32(469278), int32(611), int32(19395))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L10
...
L127:
	;
	F_errmsg(m, int32(307629), int32(0))
	mBase = m.M
	v409 = m.ExcPending
	if v409 != 0 {
		goto L10
...
L128:
	;
	F_errfinish(m, int32(469278), int32(617), int32(19395))
	mBase = m.M
	v414 = m.ExcPending
	if v414 != 0 {
		goto L10
...
L132:
	;
	F_errfinish(m, int32(469278), int32(622), int32(19395))
	mBase = m.M
	v430 = m.ExcPending
	if v430 != 0 {
		goto L10
	...
	if v7 != int32(1) {
		...
		if v28 == int32(0) {
			...
			if v32 == int32(0) {
				...
				F_queue_listen(m, int32(2), int32(706478))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
		...
		if v13 != 0 {
			...
			if v12 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v4))) = v17
				F_errmsg_internal(m, int32(628863), v4)
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return
				} else {
					F_errfinish(m, int32(469278), int32(772), int32(286697))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return
...
func F_Async_UnlistenOnExit(m *base.Module, l0 int32, l1 int32) {
	...
	if v8 != int32(1) {
		m.Env.Pgmem_listen(m, int32(706478), int32(2))
		mBase = m.M
		...
		if v14 != 0 {
			...
			if v13 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = v18
				F_errmsg_internal(m, int32(628717), v5)
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return
				} else {
					F_errfinish(m, int32(469278), int32(1205), int32(93498))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
