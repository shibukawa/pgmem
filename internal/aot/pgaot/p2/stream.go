...
func F_read_stream_begin_impl(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) int32 {
	...
	_ = v222
	v5 = l4
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[0]))
	if v19 == int32(0) {
		v33 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[1]))
		v51 = v33
		v53 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[2]))
		if l1 == int32(0) {
			v57 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[3]))
			v66 = v57
		} else {
		...
		v67 = int32(_a_F_read_stream_begin_impl_0)
		if v67 <= v51 {
			v70 = v67
		} else {
			v70 = v51
		...
		v73 = v53 * (v70 + int32(1))
		v75 = int32(16)
		v80 = (v53<<(uint(v75)%32) - int32(_a_F_read_stream_begin_impl_1)) >> (uint(v75) % 32)
		v81 = int32(_a_F_read_stream_begin_impl_2) - v80
		...
		if v93 != int32(-1) {
			v97 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[4]))
			v100 = v97
		} else {
			v99 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[5]))
			v100 = v99
		}
		...
		if v118 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v122)+64)) = v127
			...
			v136 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[6]))
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v122)+24)) = uint8(base.B2i32(v136 == int32(0)))
			if v136 != 0 {
				...
				v146 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[7])))
				if v146&int32(1) != 0 {
					if v51 != 0 {
						v158 = v70
					} else {
		...
		if l2 != 0 {
			...
			if base.Ui32(v23) < base.Ui32(int32(_a_F_read_stream_begin_impl_3)) {
				v33 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[1]))
				v51 = v33
				v53 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[2]))
				if l1 == int32(0) {
				...
				if base.B2i32(base.Ui32(v26) < base.Ui32(int32(_a_F_read_stream_begin_impl_3))) == int32(0) {
					if l0&int32(1) != 0 {
						...
						if v41 != 0 {
							...
							if v42 != 0 {
								...
								if int32(0) <= v43 {
									...
									v48 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[1]))
									v49 = v48
								}
							} else {
								v48 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_begin_impl[1]))
