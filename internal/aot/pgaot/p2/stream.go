...
func F_read_stream_begin_impl(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) int32 {
	...
	if v19 == int32(0) {
		...
		v51 = v33
		v53 = *(*int32)(unsafe.Add(mBase, _consts[428]))
		if l1 == int32(0) {
			v57 = *(*int32)(unsafe.Add(mBase, _consts[133]))
			v66 = v57
		} else {
		...
		if v93 != int32(-1) {
			...
			v99 = *(*int32)(unsafe.Add(mBase, _consts[734]))
			v100 = v99
		}
		...
		if v118 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v122)+64)) = v127
			...
			v136 = *(*int32)(unsafe.Add(mBase, _consts[735]))
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v122)+24)) = uint8(base.B2i32(v136 == int32(0)))
			if v136 != 0 {
				...
				v146 = int32(*(*uint8)(unsafe.Add(mBase, _consts[226])))
				if v146&int32(1) != 0 {
					if v51 != 0 {
						v158 = v70
					} else {
			...
			*(*uint16)(unsafe.Add(mBase, uint32(v122))) = uint16(v158)
			v162 = *(*int32)(unsafe.Add(mBase, _consts[428]))
						...
						if v41 != 0 {
							...
							if v42 != 0 {
								...
								if int32(0) <= v43 {
									...
									v48 = *(*int32)(unsafe.Add(mBase, _consts[732]))
									v49 = v48
								}
							} else {
								v48 = *(*int32)(unsafe.Add(mBase, _consts[732]))
