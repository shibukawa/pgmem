...
func F_read_stream_begin_impl(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) int32 {
	...
	if v19 == int32(0) {
		...
		v51 = v33
		v53 = *(*int32)(unsafe.Add(mBase, _consts[427]))
		if l1 == int32(0) {
		...
		if v93 != int32(-1) {
			v97 = *(*int32)(unsafe.Add(mBase, _consts[732]))
			v100 = v97
		} else {
			v99 = *(*int32)(unsafe.Add(mBase, _consts[733]))
			v100 = v99
		}
		...
		if v118 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v122)+64)) = v127
			...
			v136 = *(*int32)(unsafe.Add(mBase, _consts[734]))
			...
			*(*uint16)(unsafe.Add(mBase, uint32(v122))) = uint16(v158)
			v162 = *(*int32)(unsafe.Add(mBase, _consts[427]))
						...
						if v41 != 0 {
							...
							if v42 != 0 {
								...
								if int32(0) <= v43 {
									...
									v48 = *(*int32)(unsafe.Add(mBase, _consts[731]))
									v49 = v48
								}
							} else {
								v48 = *(*int32)(unsafe.Add(mBase, _consts[731]))
