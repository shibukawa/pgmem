...
func F_ExecStoreBufferHeapTuple(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(1652528) {
		...
		if v44 != 0 {
			...
			F_errmsg_internal(m, int32(92057), int32(0))
			mBase = m.M
			v48 = m.ExcPending
			if v48 != 0 {
				return
			} else {
				F_errfinish(m, int32(518407), int32(1594), int32(403807))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+44)) = int32(241106)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+36)) = int32(519599)
	v125 = int32(0)
...
L27:
	...
	F_ResourceOwnerForget(m, v229, v230+int32(1), int32(1662816))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L5
...
L30:
	;
	v183 = int32(4164444)
	v184 = *(*int32)(unsafe.Add(mBase, _consts[741]))
...
L37:
	;
	*(*int32)(unsafe.Add(mBase, _consts[741])) = v201
	goto L36
L38:
	;
	if int32(999) < v184 {
...
L60:
	...
	v340 = *(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[742])))
	*(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[742]))) = v340 + int64(1)
	v346 = *(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[743])))
	*(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[743]))) = v346
	v348 = int32(1)
...
L80:
	;
	v358 = int32(*(*uint8)(unsafe.Add(mBase, _consts[744])))
	if v358 != int32(1) {
		goto L59
	} else {
		goto L81
...
L81:
	;
	v361 = int32(4556800)
	v363 = *(*int32)(unsafe.Add(mBase, _consts[745]))
	v365 = *(*int32)(unsafe.Add(mBase, _consts[746]))
	*(*int32)(unsafe.Add(mBase, _consts[745])) = v363 + v365
	goto L59
L82:
	;
	m.G0 = v19 + int32(48)
...
L86:
	;
	v389 = *(*int32)(unsafe.Add(mBase, _consts[739]))
	if v389 != 0 {
		goto L87
	} else {
		goto L88
...
func F_UnpinBuffer(m *base.Module, l0 int32) {
	...
	F_ResourceOwnerForget(m, v3, v4+int32(1), int32(1662816))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
