...
func F_ExecStoreBufferHeapTuple(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(1618384) {
		...
		if v44 != 0 {
			...
			F_errmsg_internal(m, int32(85754), int32(0))
			mBase = m.M
			v48 = m.ExcPending
			if v48 != 0 {
				return
			} else {
				F_errfinish(m, int32(494583), int32(1594), int32(385282))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
...
L8:
	;
	v50 = *(*int32)(unsafe.Add(mBase, _consts[262]))
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+44)) = int32(229433)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+36)) = int32(495551)
	v125 = int32(0)
...
L27:
	...
	F_ResourceOwnerForget(m, v229, v230+int32(1), int32(1628672))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L5
...
L60:
	...
	*(*uint8)(unsafe.Add(mBase, _consts[246])) = uint8(v348)
	goto L80
L61:
	;
...
func F_UnpinBuffer(m *base.Module, l0 int32) {
	...
	F_ResourceOwnerForget(m, v3, v4+int32(1), int32(1628672))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
