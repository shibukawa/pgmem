...
func F_ExecStoreBufferHeapTuple(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(1655216) {
		...
		if v44 != 0 {
			...
			F_errmsg_internal(m, int32(92176), int32(0))
			mBase = m.M
			v48 = m.ExcPending
			if v48 != 0 {
				return
			} else {
				F_errfinish(m, int32(519730), int32(1594), int32(404952))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+44)) = int32(241628)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+36)) = int32(520922)
	v125 = int32(0)
...
L27:
	...
	F_ResourceOwnerForget(m, v229, v230+int32(1), int32(1665504))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L5
...
L37:
	;
	*(*int32)(unsafe.Add(mBase, _consts[740])) = v201
	goto L36
L38:
	;
	if int32(999) < v184 {
...
L60:
	...
	v340 = *(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[741])))
	*(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[741]))) = v340 + int64(1)
	v346 = *(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[742])))
	*(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[742]))) = v346
	v348 = int32(1)
...
L80:
	;
	v358 = int32(*(*uint8)(unsafe.Add(mBase, _consts[743])))
	if v358 != int32(1) {
		goto L59
	} else {
		goto L81
...
L86:
	;
	v389 = *(*int32)(unsafe.Add(mBase, _consts[738]))
	if v389 != 0 {
		goto L87
	} else {
		goto L88
...
func F_UnpinBuffer(m *base.Module, l0 int32) {
	...
	F_ResourceOwnerForget(m, v3, v4+int32(1), int32(1665504))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
