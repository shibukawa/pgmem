...
func F_ExecStoreBufferHeapTuple(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(1650800) {
		...
		if v44 != 0 {
			...
			F_errmsg_internal(m, int32(91981), int32(0))
			mBase = m.M
			v48 = m.ExcPending
			if v48 != 0 {
				return
			} else {
				F_errfinish(m, int32(516973), int32(1594), int32(402888))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+44)) = int32(240560)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+36)) = int32(518165)
	v125 = int32(0)
...
L27:
	...
	F_ResourceOwnerForget(m, v229, v230+int32(1), int32(1661088))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L5
...
func F_UnpinBuffer(m *base.Module, l0 int32) {
	...
	F_ResourceOwnerForget(m, v3, v4+int32(1), int32(1661088))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
