	...
	if v5 == int32(1650864) {
		...
		if v44 != 0 {
			...
			if v48 != 0 {
				...
				F_errfinish(m, int32(517025), int32(1594), int32(402918))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+36)) = int32(518217)
	v125 = int32(0)
...
L27:
	...
	F_ResourceOwnerForget(m, v229, v230+int32(1), int32(1661152))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L5
...
func F_UnpinBuffer(m *base.Module, l0 int32) {
	...
	F_ResourceOwnerForget(m, v3, v4+int32(1), int32(1661152))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
