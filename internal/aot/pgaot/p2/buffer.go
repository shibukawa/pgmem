...
func F_ExecStoreBufferHeapTuple(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(1650096) {
		...
		if v44 != 0 {
			...
			F_errmsg_internal(m, int32(91806), int32(0))
			mBase = m.M
			v48 = m.ExcPending
			if v48 != 0 {
				return
			} else {
				F_errfinish(m, int32(516327), int32(1594), int32(402304))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
...
L7:
	;
	v40 = int32(4452184)
	v42 = *(*int64)(unsafe.Add(mBase, _consts[107]))
	*(*int64)(unsafe.Add(mBase, _consts[107])) = v42 + int64(1)
	v269 = v32
	v270 = v21
	v273 = v37
	v276 = v36
...
L8:
	;
	v50 = *(*int32)(unsafe.Add(mBase, _consts[261]))
...
L13:
	;
	v257 = int32(4452152)
	v259 = *(*int64)(unsafe.Add(mBase, _consts[103]))
	*(*int64)(unsafe.Add(mBase, _consts[103])) = v259 + int64(1)
	v269 = v251
	v270 = int32(0)
	v273 = int32(1)
	v276 = v47
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+44)) = int32(240134)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+36)) = int32(517496)
	v125 = int32(0)
...
L27:
	;
	v229 = *(*int32)(unsafe.Add(mBase, _consts[261]))
	v230 = *(*int32)(unsafe.Add(mBase, uint32(v113)))
	F_ResourceOwnerForget(m, v229, v230+int32(1), int32(1660384))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L5
...
L30:
	;
	v183 = int32(4160012)
	v184 = *(*int32)(unsafe.Add(mBase, _consts[739]))
...
L37:
	;
	*(*int32)(unsafe.Add(mBase, _consts[739])) = v201
	goto L36
L38:
	;
	if int32(999) < v184 {
...
L60:
	...
	v340 = *(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[740])))
	*(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[740]))) = v340 + int64(1)
	v346 = *(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[741])))
	*(*int64)(unsafe.Add(mBase, uint32(v334)+uint32(_consts[741]))) = v346
	v348 = int32(1)
	F_pgstat_count_backend_io_op(m, v270, v276, int32(2), v348, int64(0))
	mBase = m.M
	*(*uint8)(unsafe.Add(mBase, _consts[244])) = uint8(v348)
	*(*uint8)(unsafe.Add(mBase, _consts[245])) = uint8(v348)
	goto L80
L61:
	;
...
L80:
	;
	v358 = int32(*(*uint8)(unsafe.Add(mBase, _consts[742])))
	if v358 != int32(1) {
		goto L59
	} else {
		goto L81
...
L81:
	;
	v361 = int32(4548608)
	v363 = *(*int32)(unsafe.Add(mBase, _consts[743]))
	v365 = *(*int32)(unsafe.Add(mBase, _consts[744]))
	*(*int32)(unsafe.Add(mBase, _consts[743])) = v363 + v365
	goto L59
L82:
	;
	m.G0 = v19 + int32(48)
...
L86:
	;
	v389 = *(*int32)(unsafe.Add(mBase, _consts[737]))
	if v389 != 0 {
		goto L87
	} else {
		goto L88
...
func F_UnpinBuffer(m *base.Module, l0 int32) {
	...
	var v11 int32
	_ = v11
	v3 = *(*int32)(unsafe.Add(mBase, _consts[261]))
	v4 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	F_ResourceOwnerForget(m, v3, v4+int32(1), int32(1660384))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
