				...
				if v27 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v28
					...
					if v34 != 0 {
						...
						F_errfinish(m, int32(523833), int32(197), int32(586232))
						mBase = m.M
						v39 = m.ExcPending
						if v39 != 0 {
							return int64(0)
			...
			if v52 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v53
				...
				if v57 != 0 {
					...
					F_errfinish(m, int32(523833), int32(179), int32(586232))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return int64(0)
				...
				if v51 != 0 {
					...
					if v54 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v55
						F_errmsg(m, int32(400296), v7+int32(16))
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(523833), int32(289), int32(400644))
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return int32(0)
			...
			if v37 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v38
				...
				if v42 != 0 {
					...
					F_errfinish(m, int32(523833), int32(277), int32(400644))
					mBase = m.M
					v47 = m.ExcPending
					if v47 != 0 {
						return int32(0)
