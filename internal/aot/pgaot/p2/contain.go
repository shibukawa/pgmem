					...
					if v25 != 0 {
						...
						if v32 != 0 {
							...
							if v31 == int32(0) {
								...
								v38 = F_expression_tree_walker_impl(m, l0, int32(567), l1)
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return int32(0)
...
func F_contain_placeholder_references_walker(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if v8 != int32(67) {
			if v8 != int32(319) {
				v37 = F_expression_tree_walker_impl(m, l0, int32(881), l1)
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(l1)+4)) = v23 + int32(1)
			v29 = F_query_tree_walker_impl(m, l0, int32(881), l1, int32(0))
			mBase = m.M
			v30 = m.ExcPending
			if v30 != 0 {
				return int32(0)
...
func F_contain_subplans_walker(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if base.Ui32(v7-int32(22)) < base.Ui32(int32(3)) {
			...
			v15 = F_expression_tree_walker_impl(m, l0, int32(857), l1)
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return int32(0)
...
func F_contain_vars_returning_old_or_new_walker(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 == v3 {
		...
		if v7 != int32(61) {
			if v7 != int32(6) {
				v24 = F_expression_tree_walker_impl(m, l0, int32(901), l1)
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return int32(0)
...
func F_contain_windowfuncs(m *base.Module, l0 int32) int32 {
	...
	_ = v8
	v3 = int32(0)
	v5 = F_query_or_expression_tree_walker_impl(m, l0, int32(1045), v3, v3)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
