...
L3:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1185])) = int32(-1)
...
L5:
	;
	v35 = *(*int32)(unsafe.Add(mBase, uint32(v25)+uint32(_consts[1198])))
...
L9:
	;
	v66 = *(*int32)(unsafe.Add(mBase, uint32(v25)+uint32(_consts[1199])))
	if v66 != 0 {
		goto L15
	} else {
		goto L16
...
L12:
	;
	v53 = *(*int32)(unsafe.Add(mBase, uint32(v25)+uint32(_consts[1198])))
...
L19:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v25)+uint32(_consts[1199]))) = v70
...
L22:
	;
	F_errfinish(m, int32(486926), int32(1210), int32(298895))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L4
