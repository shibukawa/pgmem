...
func F_RI_FKey_cascade_del(m *base.Module, l0 int32) int32 {
	...
	F_ri_CheckTrigger(m, l0, int32(292775), int32(3))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+36)) = v18 + int32(336)
	F_appendStringInfo(m, v18+int32(600), int32(165627), v18+int32(32))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L1
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v299
	v306 = F_pg_sprintf(m, v18+int32(176), int32(445309), v18+int32(16))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L1
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v240
	F_appendStringInfo(m, v18+int32(600), int32(696153), v18)
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L1
...
L76:
	;
	F_errfinish(m, int32(470650), int32(1003), int32(292775))
	mBase = m.M
	v393 = m.ExcPending
	if v393 != 0 {
		goto L1
...
func F_RI_FKey_cascade_upd(m *base.Module, l0 int32) int32 {
	...
	F_ri_CheckTrigger(m, l0, int32(401761), int32(2))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+52)) = v21 + int32(480)
	F_appendStringInfo(m, v21+int32(760), int32(497235), v21+int32(48))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L1
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+36)) = v21 + int32(336)
	F_appendStringInfo(m, v21+int32(760), int32(445301), v21+int32(32))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L1
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v334
	v341 = F_pg_sprintf(m, v21+int32(320), int32(445309), v21+int32(16))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L1
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v258
	F_appendStringInfo(m, v21+int32(744), int32(696153), v21)
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L1
...
L79:
	;
	F_errfinish(m, int32(470650), int32(1120), int32(401761))
	mBase = m.M
	v449 = m.ExcPending
	if v449 != 0 {
		goto L1
...
L6:
	...
	v39 = m.T0[v38].(func(*base.Module, int32, int32, int32) int32)(m, v25, v35, int32(4114264))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L1
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+96)) = v107 + int32(4)
	F_errmsg(m, int32(656822), v18+int32(96))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L1
...
L27:
	;
	F_errdetail(m, int32(555526), int32(0))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L1
...
L29:
	;
	F_errfinish(m, int32(470650), int32(319), int32(302546))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L1
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+84)) = v18 + int32(400)
	F_appendStringInfo(m, v18+int32(664), int32(27713), v18+int32(80))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L1
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+64)) = v18 + int32(256)
	F_appendStringInfo(m, v18+int32(664), int32(27671), v18-int32(-64))
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L1
...
L92:
	;
	F_appendStringInfoString(m, v18+int32(664), int32(27734))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
...
L99:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+48)) = v469
	v476 = F_pg_sprintf(m, v18+int32(240), int32(445309), v18+int32(48))
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L1
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+32)) = v413
	F_appendStringInfo(m, v18+int32(664), int32(696153), v18+int32(32))
	mBase = m.M
	v489 = m.ExcPending
	if v489 != 0 {
		goto L1
...
L114:
	;
	F_appendStringInfoString(m, v18+int32(664), int32(702557))
	mBase = m.M
	v539 = m.ExcPending
	if v539 != 0 {
		goto L1
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v540
	v547 = F_pg_sprintf(m, v18+int32(240), int32(445309), v18+int32(16))
	mBase = m.M
	v548 = m.ExcPending
	if v548 != 0 {
		goto L1
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = int32(715212)
	F_appendStringInfo(m, v18+int32(664), int32(696153), v18)
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L1
...
L117:
	;
	F_generate_operator_clause(m, v18+int32(664), v18+int32(240), v533, v549, int32(320949), int32(4537))
	mBase = m.M
	v564 = m.ExcPending
	if v564 != 0 {
		goto L1
...
L118:
	;
	F_appendStringInfoString(m, v18+int32(664), int32(634171))
	mBase = m.M
	v569 = m.ExcPending
	if v569 != 0 {
		goto L1
...
L127:
	;
	F_errfinish(m, int32(470650), int32(460), int32(302546))
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		goto L1
...
func F_RI_FKey_restrict_del(m *base.Module, l0 int32) int32 {
	...
	var v11 int32
	_ = v11
	F_ri_CheckTrigger(m, l0, int32(292713), int32(3))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_RI_FKey_restrict_upd(m *base.Module, l0 int32) int32 {
	...
	var v11 int32
	_ = v11
	F_ri_CheckTrigger(m, l0, int32(401681), int32(2))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
		...
		if v72 != 0 {
			...
			if v75 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				F_errmsg(m, int32(214430), v7)
				mBase = m.M
				v79 = m.ExcPending
				if v79 != 0 {
					return
				} else {
					F_errfinish(m, int32(470650), int32(2175), int32(213744))
					mBase = m.M
					v84 = m.ExcPending
					if v84 != 0 {
						return
				...
				if v88 != 0 {
					...
					if v91 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+64)) = l1
						F_errmsg(m, int32(492245), v7-int32(-64))
						mBase = m.M
						v97 = m.ExcPending
						if v97 != 0 {
							return
						} else {
							F_errfinish(m, int32(470650), int32(2184), int32(213744))
							mBase = m.M
							v102 = m.ExcPending
							if v102 != 0 {
								return
						...
						if v49 != 0 {
							...
							if v52 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = l1
								F_errmsg(m, int32(514496), v7+int32(32))
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return
								} else {
									F_errfinish(m, int32(470650), int32(2198), int32(213744))
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return
						...
						if v106 != 0 {
							...
							if v109 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = l1
								F_errmsg(m, int32(513965), v7+int32(48))
								mBase = m.M
								v115 = m.ExcPending
								if v115 != 0 {
									return
								} else {
									F_errfinish(m, int32(470650), int32(2204), int32(213744))
									mBase = m.M
									v120 = m.ExcPending
									if v120 != 0 {
										return
						...
						if v29 != 0 {
							...
							if v32 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l1
								F_errmsg(m, int32(493569), v7+int32(16))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return
								} else {
									F_errfinish(m, int32(470650), int32(2192), int32(213744))
									mBase = m.M
									v43 = m.ExcPending
									if v43 != 0 {
										return
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = int64(3023656976388)
	v20 = F_hash_create(m, int32(379989), int32(64), v10, int32(40))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L5
...
L7:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = int64(51539607560)
	v36 = F_hash_create(m, int32(379890), int32(256), v10, int32(40))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L5
...
L8:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = int64(292057776136)
	v45 = F_hash_create(m, int32(380303), int32(256), v10, int32(40))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L5
