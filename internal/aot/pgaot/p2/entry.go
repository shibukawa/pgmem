...
L31:
	...
	v252 = v157 + int32(1)
	if v252&int32(_a_F_entryBeginPlaceToPage_4) == v83 {
		goto L52
	} else {
		goto L53
	}
...
L34:
	;
	v159 = v157 & int32(_a_F_entryBeginPlaceToPage_4)
	if v159 == int32(0) {
		goto L35
	} else {
		goto L36
...
L38:
	;
	v186 = v178 & int32(_a_F_entryBeginPlaceToPage_4)
	if v83 == v186 {
		goto L40
	} else {
		goto L41
...
L40:
	...
	v195 = (v189&int32(_a_F_entryBeginPlaceToPage_2) + int32(7)) & int32(_a_F_entryBeginPlaceToPage_3)
	if v195 != 0 {
		goto L44
	} else {
		goto L45
...
L42:
	...
	v213 = v117 + v210&int32(_a_F_entryBeginPlaceToPage_1)
	v214 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v213)+6)))
	v220 = (v214&int32(_a_F_entryBeginPlaceToPage_2) + int32(7)) & int32(_a_F_entryBeginPlaceToPage_3)
	if v220 != 0 {
		goto L48
	} else {
		goto L49
...
L47:
	...
	v228 = v178 + int32(1)
	if base.Ui32(v228&int32(_a_F_entryBeginPlaceToPage_4)) <= base.Ui32(v159) {
		v169 = v226
		v177 = v223
		v178 = v228
		goto L38
...
L61:
	...
	v316 = v314 & int32(_a_F_entryBeginPlaceToPage_2)
...
L66:
	;
	v325 = v299
	v326 = v305 + (v316+int32(7))&int32(_a_F_entryBeginPlaceToPage_3) + int32(4)
	goto L63
L67:
	;
	if v329 == int32(0) {
...
L68:
	...
	v342 = v307 + int32(1)
	v343 = int32(_a_F_entryBeginPlaceToPage_4)
	if base.Ui32(v342&v343) <= base.Ui32(v252&v343) {
		v298 = v298 + (v333&int32(_a_F_entryBeginPlaceToPage_2)+int32(7))&int32(_a_F_entryBeginPlaceToPage_3)
		v299 = v325
		v305 = v326
		v307 = v342
		goto L61
...
func F_entry_alloc(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	v17 = v15 - int32(32)
	m.G0 = v17
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[0]))
...
L1:
	;
	v94 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[1]))
	if v94 <= v91 {
		goto L5
	} else {
		goto L6
...
L7:
	;
	v451 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[0]))
...
L8:
	;
	v110 = int32(_a_F_entry_alloc_0)
	v111 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[0]))
...
L15:
	;
	v189 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[0]))
...
L19:
	;
	F_pg_qsort(m, v183, int32(0), int32(4), int32(_a_F_entry_alloc_1))
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L14
...
L22:
	;
	v207 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[2]))
...
L24:
	;
	F_pg_qsort(m, v183, v240, int32(4), int32(_a_F_entry_alloc_1))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L14
...
L33:
	;
	v263 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[2]))
...
L44:
	;
	v303 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[0]))
	v304 = int32(2)
...
L48:
	;
	v332 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[2]))
...
L49:
	;
	v339 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[2]))
	F_s_lock(m, v339+int32(20), int32(_a_F_entry_alloc_2), int32(2205), int32(_a_F_entry_alloc_3))
	mBase = m.M
	v348 = m.ExcPending
	if v348 != 0 {
		goto L14
...
L51:
	;
	v353 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[2]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v353)+40)) = v356 + int64(1)
	v362 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[0]))
...
L53:
	;
	v434 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[1]))
	if v434 <= v431 {
		goto L8
	} else {
		goto L57
...
L63:
	;
	v468 = *(*int32)(unsafe.Add(mBase, _c_F_entry_alloc[2]))
...
func F_entry_reset(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) int64 {
	...
	v12 = v10 - int32(48)
	m.G0 = v12
	v17 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[0]))
	if v17 == int32(0) {
		goto L1
	} else {
		goto L2
...
L2:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
	if v22 == int32(0) {
		goto L1
	} else {
		goto L3
...
L5:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
...
L11:
	;
	v300 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[0]))
	if v296 == v101 {
		goto L66
	} else {
		goto L67
...
L12:
	;
	v195 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
...
L15:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+40)) = int64(0)
	v131 = int32(0)
	v133 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
...
L16:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v12)+40)) = uint8(v161)
	v164 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
	v167 = int32(0)
...
L21:
	;
	v154 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
...
L27:
	;
	v185 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
...
L52:
	;
	v242 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
...
L62:
	;
	v278 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[1]))
...
L69:
	;
	v308 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[0]))
	F_s_lock(m, v308+int32(20), int32(_a_F_entry_reset_0), int32(2749), int32(_a_F_entry_reset_1))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L4
...
L71:
	;
	v322 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[0]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v322)+20)) = int32(0)
	v332 = F_AllocateFile(m, int32(_a_F_entry_reset_2), int32(_a_F_entry_reset_3))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L4
...
L73:
	;
	v407 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[0]))
...
L99:
	;
	v416 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[0]))
	F_s_lock(m, v416+int32(20), int32(_a_F_entry_reset_0), int32(2780), int32(_a_F_entry_reset_1))
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L4
...
L101:
	;
	v428 = *(*int32)(unsafe.Add(mBase, _c_F_entry_reset[0]))
