...
L21:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1162])) = v56
	goto L8
L22:
	;
	v61 = v58
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1162])) = v97
	goto L8
L32:
	;
	v84 = *(*int32)(unsafe.Add(mBase, _consts[1164]))
...
func F_AtEOSubXact_RelationCache(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	*(*int32)(unsafe.Add(mBase, _consts[1177])) = v4
...
L4:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[1178]))
...
L6:
	;
	v29 = *(*int32)(unsafe.Add(mBase, _consts[1178]))
	v34 = int32(0)
	v36 = F_hash_search(m, v29, v25<<(uint(int32(2))%32)+int32(4550112), v34, v34)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L8
