...
L21:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1158])) = v56
	goto L8
L22:
	;
	v61 = v58
...
L25:
	;
	v65 = *(*int32)(unsafe.Add(mBase, _consts[1159]))
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1158])) = v97
	goto L8
L32:
	;
	v84 = *(*int32)(unsafe.Add(mBase, _consts[1160]))
...
func F_AtEOSubXact_RelationCache(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	*(*int32)(unsafe.Add(mBase, _consts[1173])) = v4
...
L4:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[1174]))
...
L6:
	...
	v34 = int32(0)
	v36 = F_hash_search(m, v29, v25<<(uint(int32(2))%32)+int32(4542256), v34, v34)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L8
					...
					if v31 != 0 {
						...
						if v30 == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v34 + int32(4)
							F_errmsg_internal(m, int32(93645), v9)
							mBase = m.M
							v40 = m.ExcPending
							if v40 != 0 {
								return
							} else {
								F_errfinish(m, int32(522810), int32(3475), int32(244018))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
