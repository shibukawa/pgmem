...
L21:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1154])) = v56
	goto L8
L22:
	;
	v61 = v58
...
L25:
	;
	v65 = *(*int32)(unsafe.Add(mBase, _consts[1155]))
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1154])) = v97
	goto L8
L32:
	;
	v84 = *(*int32)(unsafe.Add(mBase, _consts[1156]))
...
func F_AtEOSubXact_RelationCache(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	*(*int32)(unsafe.Add(mBase, _consts[1169])) = v4
...
L4:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[1170]))
...
L6:
	...
	v34 = int32(0)
	v36 = F_hash_search(m, v29, v25<<(uint(int32(2))%32)+int32(4477168), v34, v34)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L8
					...
					if v31 != 0 {
						...
						if v30 == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v34 + int32(4)
							F_errmsg_internal(m, int32(87112), v9)
							mBase = m.M
							v40 = m.ExcPending
							if v40 != 0 {
								return
							} else {
								F_errfinish(m, int32(497411), int32(3475), int32(232118))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
