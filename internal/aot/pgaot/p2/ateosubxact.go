...
L1:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1152])) = int32(0)
	goto L3
L2:
	;
	goto L3
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1153])) = v56
	goto L8
L22:
	;
	v61 = v58
...
L25:
	;
	v65 = *(*int32)(unsafe.Add(mBase, _consts[1154]))
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1153])) = v97
	goto L8
L32:
	;
	v84 = *(*int32)(unsafe.Add(mBase, _consts[1155]))
...
func F_AtEOSubXact_RelationCache(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	*(*int32)(unsafe.Add(mBase, _consts[1168])) = v4
	v15 = int32(*(*uint8)(unsafe.Add(mBase, _consts[285])))
	if v15 == v4 {
		goto L2
	} else {
		goto L3
...
L2:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[283]))
	if v19 <= int32(0) {
		goto L1
	} else {
		goto L5
...
L4:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[1169]))
...
L6:
	;
	v29 = *(*int32)(unsafe.Add(mBase, _consts[1169]))
	v34 = int32(0)
	v36 = F_hash_search(m, v29, v25<<(uint(int32(2))%32)+int32(4413296), v34, v34)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L8
...
L12:
	;
	v42 = v25 + int32(1)
	v44 = *(*int32)(unsafe.Add(mBase, _consts[283]))
	if v42 < v44 {
		v25 = v42
		goto L6
	} else {
					...
					if v31 != 0 {
						...
						if v30 == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v34 + int32(4)
							F_errmsg_internal(m, int32(81966), v9)
							mBase = m.M
							v40 = m.ExcPending
							if v40 != 0 {
								return
							} else {
								F_errfinish(m, int32(468564), int32(3475), int32(218591))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
