...
func F_LogLogicalInvalidations(m *base.Module) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1161]))
	if v10 == int32(0) {
		m.G0 = v7 + int32(16)
		return
	} else {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = v19
			...
			if v24 != 0 {
				...
				if v29 != 0 {
					...
					v32 = v30 - v31
					if int32(0) < v32 {
						v36 = *(*int32)(unsafe.Add(mBase, _consts[1162]))
						v37 = int32(4)
						...
						if v43 != 0 {
							...
							v46 = v44 - v45
							if int32(0) < v46 {
								v50 = *(*int32)(unsafe.Add(mBase, _consts[1163]))
								v51 = int32(4)
...
func F_log(m *base.Module, l0 float64) float64 {
	...
	if base.Ui64(v11-int64(4606619468846596096)) <= base.Ui64(int64(854320534781951)) {
		if v11 == int64(4607182418800017408) {
			...
			v32 = *(*float64)(unsafe.Add(mBase, _consts[1465]))
			v33 = base.F64_mul(base.F64_mul(v29, v29), v32)
			v34 = base.F64_add(v25, v33)
			v35 = base.F64_mul(v25, v25)
			v36 = base.F64_mul(v25, v35)
			v38 = *(*float64)(unsafe.Add(mBase, _consts[1466]))
			v41 = *(*float64)(unsafe.Add(mBase, _consts[1467]))
			v44 = *(*float64)(unsafe.Add(mBase, _consts[1468]))
			v47 = *(*float64)(unsafe.Add(mBase, _consts[1469]))
			v53 = *(*float64)(unsafe.Add(mBase, _consts[1470]))
			v56 = *(*float64)(unsafe.Add(mBase, _consts[1471]))
			v59 = *(*float64)(unsafe.Add(mBase, _consts[1472]))
			v65 = *(*float64)(unsafe.Add(mBase, _consts[1473]))
			v68 = *(*float64)(unsafe.Add(mBase, _consts[1474]))
			v71 = *(*float64)(unsafe.Add(mBase, _consts[1475]))
				...
				*(*float64)(unsafe.Add(mBase, uint32(v94-int32(16))+8)) = v92
				...
				if v11 == int64(9218868437227405312) {
					...
					if base.B2i32(v14&v104 != v104)&base.B2i32(base.Ui32(v14) <= base.Ui32(int32(32767))) == int32(0) {
						...
						v129 = *(*float64)(unsafe.Add(mBase, _consts[1476]))
						v137 = base.I32_wrap_i64(int64(base.Ui64(v123)>>(uint(int64(45))%64))) & int32(127) << (uint(int32(4)) % 32)
						v140 = *(*float64)(unsafe.Add(mBase, uint32(v137)+uint32(_consts[1477])))
						v141 = base.F64_add(base.F64_mul(v127, v129), v140)
						v144 = *(*float64)(unsafe.Add(mBase, uint32(v137)+uint32(_consts[1478])))
						v151 = *(*float64)(unsafe.Add(mBase, uint32(v137)+uint32(_consts[1479])))
						v155 = *(*float64)(unsafe.Add(mBase, uint32(v137)+uint32(_consts[1480])))
						...
						v162 = *(*float64)(unsafe.Add(mBase, _consts[1481]))
						v165 = *(*float64)(unsafe.Add(mBase, _consts[1482]))
						v169 = *(*float64)(unsafe.Add(mBase, _consts[1483]))
						v172 = *(*float64)(unsafe.Add(mBase, _consts[1484]))
						v177 = *(*float64)(unsafe.Add(mBase, _consts[1485]))
						v180 = *(*float64)(unsafe.Add(mBase, _consts[1486]))
...
func F_log_disconnections(m *base.Module, l0 int32, l1 int32) {
	...
	v17 = *(*int64)(unsafe.Add(mBase, _consts[885]))
	v21 = m.G0
	v22 = int32(16)
	v23 = v21 - v22
	m.G0 = v23
	...
	if v69 != 0 {
		...
		if v68 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12)+8)) = base.I32_extend16_s(v63 - v89*v88)
			F_errmsg(m, int32(184421), v12)
			mBase = m.M
			v99 = m.ExcPending
			if v99 != 0 {
				return
			} else {
				F_errfinish(m, int32(513611), int32(5432), int32(148912))
				mBase = m.M
				v104 = m.ExcPending
				if v104 != 0 {
					return
