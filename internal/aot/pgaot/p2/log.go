...
func F_log(m *base.Module, l0 float64) float64 {
	...
	if base.Ui64(v11-int64(4606619468846596096)) <= base.Ui64(int64(854320534781951)) {
		if v11 == int64(4607182418800017408) {
			...
			v32 = *(*float64)(unsafe.Add(mBase, _consts[1391]))
			v33 = base.F64_mul(base.F64_mul(v29, v29), v32)
			v34 = base.F64_add(v25, v33)
			v35 = base.F64_mul(v25, v25)
			v36 = base.F64_mul(v25, v35)
			v38 = *(*float64)(unsafe.Add(mBase, _consts[1392]))
			v41 = *(*float64)(unsafe.Add(mBase, _consts[1393]))
			v44 = *(*float64)(unsafe.Add(mBase, _consts[1394]))
			v47 = *(*float64)(unsafe.Add(mBase, _consts[1395]))
			v53 = *(*float64)(unsafe.Add(mBase, _consts[1396]))
			v56 = *(*float64)(unsafe.Add(mBase, _consts[1397]))
			v59 = *(*float64)(unsafe.Add(mBase, _consts[1398]))
			v65 = *(*float64)(unsafe.Add(mBase, _consts[1399]))
			v68 = *(*float64)(unsafe.Add(mBase, _consts[1400]))
			v71 = *(*float64)(unsafe.Add(mBase, _consts[1401]))
				...
				*(*float64)(unsafe.Add(mBase, uint32(v94-int32(16))+8)) = v92
				...
				if v11 == int64(9218868437227405312) {
					...
					if base.B2i32(v14&v104 != v104)&base.B2i32(base.Ui32(v14) <= base.Ui32(int32(32767))) == int32(0) {
						...
						v129 = *(*float64)(unsafe.Add(mBase, _consts[1402]))
						v137 = base.I32_wrap_i64(int64(base.Ui64(v123)>>(uint(int64(45))%64))) & int32(127) << (uint(int32(4)) % 32)
						v140 = *(*float64)(unsafe.Add(mBase, uint32(v137)+uint32(_consts[1403])))
						v141 = base.F64_add(base.F64_mul(v127, v129), v140)
						v144 = *(*float64)(unsafe.Add(mBase, uint32(v137)+uint32(_consts[1404])))
						v151 = *(*float64)(unsafe.Add(mBase, uint32(v137)+uint32(_consts[1405])))
						v155 = *(*float64)(unsafe.Add(mBase, uint32(v137)+uint32(_consts[1406])))
						...
						v162 = *(*float64)(unsafe.Add(mBase, _consts[1407]))
						v165 = *(*float64)(unsafe.Add(mBase, _consts[1408]))
						v169 = *(*float64)(unsafe.Add(mBase, _consts[1409]))
						v172 = *(*float64)(unsafe.Add(mBase, _consts[1410]))
						v177 = *(*float64)(unsafe.Add(mBase, _consts[1411]))
						v180 = *(*float64)(unsafe.Add(mBase, _consts[1412]))
	...
	if v69 != 0 {
		...
		if v68 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12)+8)) = base.I32_extend16_s(v63 - v89*v88)
			F_errmsg(m, int32(165418), v12)
			mBase = m.M
			v99 = m.ExcPending
			if v99 != 0 {
				return
			} else {
				F_errfinish(m, int32(471009), int32(5432), int32(131952))
				mBase = m.M
				v104 = m.ExcPending
				if v104 != 0 {
					return
