...
L6:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[265]))
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _consts[265])) = v45
...
L34:
	;
	v213 = *(*int32)(unsafe.Add(mBase, _consts[265]))
...
L41:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _consts[158]))
	v260 = *(*int32)(unsafe.Add(mBase, _consts[265]))
...
L43:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v178)+4)) = uint16(v291)
	v296 = *(*int32)(unsafe.Add(mBase, _consts[265]))
	v297 = int32(48)
	v299 = v296 + v164*v297
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v260)+12)) = v164
	...
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, _consts[158])) = v258
	return int32(-1)
L47:
	;
...
L49:
	;
	F_errfinish(m, int32(523612), int32(1613), int32(301655))
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L36
...
L53:
	;
	F_errfinish(m, int32(523612), int32(1452), int32(457877))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L36
...
func F_assign_search_path(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v4
	v4 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[291])) = uint8(v4)
	return
}
...
L26:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _consts[158]))
	if v87 != 0 {
		goto L27
	} else {
		goto L28
...
L54:
	;
	F_errsave_finish(m, l8, int32(516252), int32(336), int32(432923))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L28
...
L14:
	;
	F_errmsg(m, int32(363827), int32(0))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L1
...
L15:
	;
	F_errfinish(m, int32(516252), int32(1502), int32(37931))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L1
