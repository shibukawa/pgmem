...
L6:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[0]))
...
L9:
	;
	v35 = int32(32)
	v37 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[1]))
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v163)+12)) = v179
	v182 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[2]))
	if v182 <= int32(0) {
		goto L31
	} else {
		goto L32
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[0])) = v45
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[1])) = v42
	v163 = v45
	v164 = v37
	goto L11
L19:
...
L31:
	;
	v251 = l1 | int32(_a_F_PathNameOpenFilePerm_0)
...
L32:
	;
	v186 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[3]))
	v188 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[4]))
	v190 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[5]))
...
L34:
	;
	v213 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[0]))
...
L37:
	;
	v220 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[2]))
	if v220 <= int32(0) {
		goto L31
	} else {
		goto L38
...
L38:
	;
	v224 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[3]))
	v226 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[4]))
	v228 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[5]))
...
L41:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[6]))
	v260 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[0]))
...
L43:
	;
	v278 = int32(_a_F_PathNameOpenFilePerm_1)
	v280 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[2])) = v280 + int32(1)
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v178)+4)) = uint16(v291)
	v296 = *(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[0]))
	v297 = int32(48)
	v299 = v296 + v164*v297
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v260)+12)) = v164
	...
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, _c_F_PathNameOpenFilePerm[6])) = v258
	return int32(-1)
L47:
	;
...
L49:
	;
	F_errfinish(m, int32(_a_F_PathNameOpenFilePerm_4), int32(1613), int32(_a_F_PathNameOpenFilePerm_5))
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L36
...
L53:
	;
	F_errfinish(m, int32(_a_F_PathNameOpenFilePerm_4), int32(1452), int32(_a_F_PathNameOpenFilePerm_6))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L36
		...
		*(*int64)(unsafe.Add(mBase, uint32(v13))) = int64(1580547965224)
		...
		if v23 != 0 {
			...
			*(*float64)(unsafe.Add(mBase, uint32(v13)+32)) = v50
			v53 = *(*float64)(unsafe.Add(mBase, _c_F_create_gather_path[0]))
			v54 = *(*int32)(unsafe.Add(mBase, uint32(v13)+72))
			v55 = *(*float64)(unsafe.Add(mBase, uint32(v54)+56))
			v57 = *(*float64)(unsafe.Add(mBase, _c_F_create_gather_path[1]))
...
L54:
	;
	F_errsave_finish(m, l8, int32(_a_F_path_decode_1), int32(336), int32(_a_F_path_decode_2))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L28
...
L15:
	;
	F_errfinish(m, int32(_a_F_path_recv_1), int32(1502), int32(_a_F_path_recv_2))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L1
...
L3:
	;
	v160 = *(*int32)(unsafe.Add(mBase, uint32(v21+v20-int32(4))))
	if v160 == int32(16) {
		goto L27
	} else {
		goto L28
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21+(v35-l1)<<(uint(int32(2))%32)))) = v137
	v140 = v35 + int32(1)
	if v140 != l4 {
		v35 = v140
		goto L5
...
L11:
	;
	v82 = F_pushJsonbValue(m, l0, int32(4), int32(0))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+12)) = v68
	v72 = F_pushJsonbValue(m, l0, int32(6), int32(0))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L1
...
L14:
	;
	v62 = *(*int32)(unsafe.Add(mBase, _c_F_push_path[0]))
	if v62 == int32(0) {
		goto L11
	} else {
		goto L15
...
L16:
	;
	v77 = F_pushJsonbValue(m, l0, int32(1), v16+int32(8))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L1
...
L18:
	;
	v84 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v84
	if v84 < v53 {
		goto L19
	} else {
		goto L20
...
L22:
	;
	v104 = F_pushJsonbValue(m, l0, int32(3), v16+int32(28))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L1
...
L24:
	;
	v106 = int32(1)
	if base.Ui32(v106) < base.Ui32(v95) {
		v95 = v95 - v106
		goto L22
	} else {
		goto L25
...
L29:
	;
	v164 = F_pushJsonbValue(m, l0, v163, l5)
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L1
...
L33:
	;
	v183 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l3+v176))))
	if v183 != 0 {
		goto L31
	} else {
		goto L35
...
L35:
	;
	v190 = *(*int32)(unsafe.Add(mBase, uint32(v21+(v176-l1)<<(uint(int32(2))%32))))
	if v190 == int32(17) {
		goto L36
	} else {
		goto L37
...
L38:
	;
	v195 = F_pushJsonbValue(m, l0, v193, int32(0))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L1
