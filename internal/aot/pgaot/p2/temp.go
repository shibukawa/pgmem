...
L21:
	;
	v60 = int32(14)
	v61 = int32(_a_F_GetTempNamespaceProcNumber_1)
	goto L26
L22:
	;
	v107 = v12
...
func F_assign_temp_tablespaces(m *base.Module, l0 int32, l1 int32) {
	...
	if l1 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_assign_temp_tablespaces[1])) = l1 + int32(4)
		if int32(2) <= v5 {
			v19 = F_pg_prng_uint64_range(m, int32(_a_F_assign_temp_tablespaces_0), int64(0), base.I64_extend_i32_u(v5-int32(1)))
			mBase = m.M
		...
		*(*int32)(unsafe.Add(mBase, _c_F_assign_temp_tablespaces[2])) = v23
		return
	}
}
