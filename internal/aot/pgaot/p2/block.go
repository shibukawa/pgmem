...
L22:
	;
	v94 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableReaderNextRelation[0])))
...
L24:
	;
	v113 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableReaderNextRelation[1])))
	if v113 != 0 {
		goto L28
	} else {
		goto L29
...
L26:
	;
	v104 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableReaderNextRelation[2])))
	v105 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableReaderNextRelation[3])))
	v106 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableReaderNextRelation[4])))
	*(*int32)(unsafe.Add(mBase, uint32(v10)+8)) = v100
	*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = v102
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v106
	m.T0[v105].(func(*base.Module, int32, int32, int32))(m, v104, int32(_a_F_BlockRefTableReaderNextRelation_0), v10)
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L1
...
L32:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableReaderNextRelation[1]))) = v119
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableReaderNextRelation[6]))) = v127
...
L15:
	...
	v73 = v61 + (int32(_a_F_RestoreBlockImage_3) - v63)
	v74 = v51 + v59
...
L77:
	;
	v311 = F__emscripten_memcpy_bulkmem(m, l2, v306, int32(_a_F_RestoreBlockImage_3))
	mBase = m.M
	goto L79
L79:
	;
...
L84:
	...
	v348 = v346 + v347
	v352 = int32(_a_F_RestoreBlockImage_3) - v348
	if v352 != 0 {
		goto L95
	} else {
		goto L96
