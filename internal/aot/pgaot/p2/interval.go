...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = l1
	F_errmsg_internal(m, int32(483908), v12+int32(16))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L39
...
L41:
	;
	F_errfinish(m, int32(492706), int32(1489), int32(419723))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L39
...
L50:
	;
	F_errsave_finish(m, l2, int32(492706), int32(1498), int32(419723))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L39
...
L61:
	;
	F_errsave_finish(m, l2, int32(492706), int32(1507), int32(419723))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L39
...
L69:
	;
	F_errsave_finish(m, l2, int32(492706), int32(1517), int32(419723))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L39
						...
						if v69 != 0 {
							...
							if v72 != 0 {
								...
								if v76 != 0 {
									...
									F_errfinish(m, int32(492706), int32(4248), int32(324840))
									mBase = m.M
									v81 = m.ExcPending
									if v81 != 0 {
										return int32(0)
...
func F_interval_dist(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		v15 = F_DirectFunctionCall2Coll(m, int32(2460), v2, v9, int32(4055696))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
					...
					if v69 != 0 {
						...
						if v72 != 0 {
							...
							if v76 != 0 {
								...
								F_errfinish(m, int32(492706), int32(3081), int32(112828))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return int32(0)
					...
					if v76 != 0 {
						...
						if v79 != 0 {
							...
							if v83 != 0 {
								...
								F_errfinish(m, int32(492706), int32(3038), int32(130214))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return int32(0)
