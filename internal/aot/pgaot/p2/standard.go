...
L6:
	;
	v39 = int32(*(*uint8)(unsafe.Add(mBase, _consts[96])))
	if v39 != int32(1) {
		goto L5
	} else {
		goto L7
...
L10:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _consts[50]))
	if int32(0) <= v51 {
		goto L5
	} else {
		goto L11
...
L14:
	;
	v91 = *(*float64)(unsafe.Add(mBase, _consts[500]))
...
L54:
	;
	v237 = *(*int32)(unsafe.Add(mBase, _consts[498]))
	if v237 == int32(0) {
		goto L60
	} else {
		goto L61
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v249)+44)) = v253
	v265 = *(*int32)(unsafe.Add(mBase, _consts[498]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v249)+76)) = int32(-1)
	...
	v277 = *(*float64)(unsafe.Add(mBase, _consts[501]))
	*(*float64)(unsafe.Add(mBase, uint32(v249)+8)) = base.F64_add(v275, v277)
	v281 = *(*float64)(unsafe.Add(mBase, _consts[502]))
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v521)+96)) = v575
	v580 = int32(*(*uint8)(unsafe.Add(mBase, _consts[503])))
	if v580 != int32(1) {
		goto L116
	} else {
		goto L117
...
L117:
	;
	v584 = *(*float64)(unsafe.Add(mBase, _consts[504]))
...
L119:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v521)+32)) = v593
	v597 = *(*float64)(unsafe.Add(mBase, _consts[505]))
...
L120:
	;
	v611 = *(*float64)(unsafe.Add(mBase, _consts[506]))
...
L123:
	;
	v625 = int32(*(*uint8)(unsafe.Add(mBase, _consts[507])))
	if v625 == int32(1) {
		goto L126
	} else {
		goto L127
...
L128:
	;
	v633 = int32(*(*uint8)(unsafe.Add(mBase, _consts[508])))
	if v633 != int32(1) {
		goto L116
	} else {
		goto L129
