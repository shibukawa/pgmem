						...
						if v100 != 0 {
							...
							if v104 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7))) = v103
								F_errmsg(m, int32(_a_F_timestamp_izone_0), v7)
								mBase = m.M
								v108 = m.ExcPending
								if v108 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_timestamp_izone_1), int32(_a_F_timestamp_izone_2), int32(_a_F_timestamp_izone_3))
									mBase = m.M
									v113 = m.ExcPending
									if v113 != 0 {
										return int32(0)
								...
								if v41 != 0 {
									...
									if v45 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v44
										F_errmsg(m, int32(_a_F_timestamp_izone_4), v7+int32(16))
										mBase = m.M
										v51 = m.ExcPending
										if v51 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(_a_F_timestamp_izone_1), int32(_a_F_timestamp_izone_5), int32(_a_F_timestamp_izone_3))
											mBase = m.M
											v56 = m.ExcPending
											if v56 != 0 {
												return int32(0)
				...
				if base.Ui64(int64(-9011559254509551616)) <= base.Ui64(v64+int64(211813488000000000)) {
					...
					if v81 != 0 {
						...
						if v84 != 0 {
							...
							F_errmsg(m, int32(_a_F_timestamp_izone_6), int32(0))
							mBase = m.M
							v88 = m.ExcPending
							if v88 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(_a_F_timestamp_izone_1), int32(_a_F_timestamp_izone_7), int32(_a_F_timestamp_izone_3))
								mBase = m.M
								v93 = m.ExcPending
								if v93 != 0 {
									return int32(0)
...
func F_timestamp_sortsupport(m *base.Module, l0 int32) int32 {
	...
	_ = v2
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(1513)
	return int32(0)
}
