			...
			if v19 != 0 {
				...
				if v54 != 0 {
					...
					if v57 != 0 {
						...
						F_errmsg(m, int32(319236), int32(0))
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return int32(0)
						} else {
							*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(644304)
							F_errhint(m, int32(609748), v4)
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(473384), int32(561), int32(357892))
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return int32(0)
			...
			if v37 != 0 {
				...
				if v41 != 0 {
					...
					if v45 != 0 {
						...
						F_errfinish(m, int32(473384), int32(554), int32(357892))
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return int32(0)
...
L47:
	;
	F_errfinish(m, int32(473043), int32(95), int32(112933))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L1
