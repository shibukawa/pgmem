...
func F_pg_wal_replay_resume(m *base.Module, l0 int32) int32 {
	...
	v4 = v2 - int32(16)
	m.G0 = v4
	v8 = int32(*(*uint8)(unsafe.Add(mBase, _consts[182])))
	if v8 == int32(1) {
		v13 = *(*int32)(unsafe.Add(mBase, _consts[175]))
		v14 = *(*int32)(unsafe.Add(mBase, uint32(v13)+316))
		v16 = base.B2i32(v14 != int32(2))
		*(*uint8)(unsafe.Add(mBase, _consts[182])) = uint8(v16)
		v18 = v16
	} else {
		v18 = int32(0)
	}
			...
			if v19 != 0 {
				...
				if v54 != 0 {
					...
					if v57 != 0 {
						...
						F_errmsg(m, int32(327020), int32(0))
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return int32(0)
						} else {
							*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(655441)
							F_errhint(m, int32(620393), v4)
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(483750), int32(561), int32(366110))
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return int32(0)
			...
			if v37 != 0 {
				...
				if v41 != 0 {
					...
					if v45 != 0 {
						...
						F_errfinish(m, int32(483750), int32(554), int32(366110))
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return int32(0)
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+1072)) = v41
	v47 = *(*int32)(unsafe.Add(mBase, _consts[262]))
...
L47:
	;
	F_errfinish(m, int32(483409), int32(95), int32(117504))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L1
