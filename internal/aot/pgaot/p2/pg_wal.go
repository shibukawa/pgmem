...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+1072)) = v41
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_pg_wal_summary_contents[0]))
...
L13:
	;
	v70 = *(*int32)(unsafe.Add(mBase, _c_F_pg_wal_summary_contents[1]))
	if v70 != 0 {
		goto L15
	} else {
		goto L16
...
L25:
	;
	v107 = *(*int32)(unsafe.Add(mBase, _c_F_pg_wal_summary_contents[1]))
	if v107 != 0 {
		goto L27
	} else {
		goto L28
