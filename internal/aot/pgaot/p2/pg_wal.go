...
func F_pg_wal_replay_resume(m *base.Module, l0 int32) int32 {
	...
	v4 = v2 - int32(16)
	m.G0 = v4
	v8 = int32(*(*uint8)(unsafe.Add(mBase, _consts[185])))
	if v8 == int32(1) {
		v13 = *(*int32)(unsafe.Add(mBase, _consts[178]))
		v14 = *(*int32)(unsafe.Add(mBase, uint32(v13)+316))
		v16 = base.B2i32(v14 != int32(2))
		*(*uint8)(unsafe.Add(mBase, _consts[185])) = uint8(v16)
		v18 = v16
	} else {
		v18 = int32(0)
	}
			...
			if v19 != 0 {
				...
				if v54 != 0 {
					...
					if v57 != 0 {
						...
						F_errmsg(m, int32(335260), int32(0))
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return int32(0)
						} else {
							*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(685660)
							F_errhint(m, int32(650372), v4)
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(496030), int32(561), int32(375360))
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return int32(0)
			...
			if v37 != 0 {
				...
				if v41 != 0 {
					...
					if v45 != 0 {
						...
						F_errfinish(m, int32(496030), int32(554), int32(375360))
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return int32(0)
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+1072)) = v41
	v47 = *(*int32)(unsafe.Add(mBase, _consts[265]))
...
L47:
	;
	F_errfinish(m, int32(495673), int32(95), int32(120820))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L1
