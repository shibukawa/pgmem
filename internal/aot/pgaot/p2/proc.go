...
func F_EmitProcSignalBarrier(m *base.Module) int64 {
	...
	_ = v86
	v1 = int32(0)
	v7 = *(*int32)(unsafe.Add(mBase, _consts[786]))
	if v1 < v7+int32(38) {
		goto L1
	} else {
		goto L2
...
L3:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _consts[788]))
	v42 = *(*int64)(unsafe.Add(mBase, uint32(v41)))
	v44 = v42 + int64(1)
	*(*int64)(unsafe.Add(mBase, uint32(v41))) = v44
	v47 = *(*int32)(unsafe.Add(mBase, _consts[786]))
	v49 = v47 + int32(37)
	if int32(0) <= v49 {
		goto L7
	} else {
...
L10:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[788]))
...
L14:
	;
	F_s_lock(m, v71, int32(488642), int32(402), int32(218433))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L17
...
L4:
	;
	v46 = *(*int32)(unsafe.Add(mBase, _consts[139]))
...
L10:
	;
	v62 = *(*int32)(unsafe.Add(mBase, _consts[139]))
	if v60 == int32(0) {
		v72 = v62
		goto L6
	} else {
...
L19:
	;
	v94 = *(*int32)(unsafe.Add(mBase, _consts[193]))
...
L21:
	...
	v99 = v97 - int32(16)
	m.G0 = v99
	v102 = *(*int32)(unsafe.Add(mBase, _consts[193]))
...
L27:
	;
	F_errmsg_internal(m, int32(170705), int32(0))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L1
...
L30:
	;
	F_errfinish(m, int32(483637), int32(5045), int32(330965))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L1
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v99))) = v19
	F_errmsg_internal(m, int32(43749), v99)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(483637), int32(5051), int32(330965))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L1
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v102)+16)) = v234
	v247 = int32(0)
	v249 = *(*int32)(unsafe.Add(mBase, _consts[193]))
...
L38:
	;
	v135 = *(*int32)(unsafe.Add(mBase, _consts[770]))
	v137 = v131
	v140 = v135
	v145 = v2
	goto L41
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v102)+12)) = v191 - v189
	v195 = *(*int32)(unsafe.Add(mBase, _consts[770]))
	v198 = v131
	goto L54
L43:
	;
...
L45:
	;
	v155 = *(*int32)(unsafe.Add(mBase, _consts[771]))
	v156 = int32(2)
...
L51:
	;
	v175 = *(*int32)(unsafe.Add(mBase, _consts[770]))
	if v172 != 0 {
		v181 = v175
		v182 = v145
		goto L44
...
L60:
	;
	v256 = int32(1)
	v259 = *(*int32)(unsafe.Add(mBase, _consts[771]))
	v261 = *(*int32)(unsafe.Add(mBase, _consts[770]))
	if v251+v256 != v250 {
		goto L61
	} else {
		goto L62
...
L75:
	;
	*(*int64)(unsafe.Add(mBase, _consts[772])) = v385 + v384*int64(1000000) - int64(946684800000000)
	goto L23
L76:
	;
...
L80:
	...
	v442 = v440 - int32(32)
	m.G0 = v442
	v447 = *(*int32)(unsafe.Add(mBase, _consts[773]))
...
L85:
	;
	m.G0 = v442 + int32(32)
	v517 = *(*int32)(unsafe.Add(mBase, _consts[51]))
	switch v517 - int32(2) {
	case 0:
		goto L104
	case 1:
...
L96:
	;
	v489 = *(*int32)(unsafe.Add(mBase, _consts[773]))
...
L101:
	;
	F_errfinish(m, int32(483637), v964, int32(237972))
	mBase = m.M
	v967 = m.ExcPending
	if v967 != 0 {
		goto L1
...
L102:
	;
	v905 = *(*int32)(unsafe.Add(mBase, _consts[774]))
...
L107:
	;
	v525 = *(*int32)(unsafe.Add(mBase, _consts[193]))
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v647
	F_errmsg_internal(m, int32(242286), v17+int32(16))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L1
...
L139:
	;
	F_errfinish(m, int32(483637), int32(1217), int32(237972))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L1
...
L144:
	...
	v698 = int32(4387044)
	v699 = int32(3)
	v701 = *(*int32)(unsafe.Add(mBase, _consts[775]))
	v703 = v701 + int32(1)
...
L147:
	;
	*(*int32)(unsafe.Add(mBase, _consts[775])) = v706
...
L154:
	;
	v777 = *(*int32)(unsafe.Add(mBase, _consts[775]))
	v779 = v777
	goto L166
L155:
	;
	v736 = *(*int32)(unsafe.Add(mBase, _consts[775]))
...
L157:
	...
	v739 = int32(4387044)
	v740 = int32(3)
	v742 = *(*int32)(unsafe.Add(mBase, _consts[775]))
	v744 = v742 + int32(1)
...
L160:
	;
	*(*int32)(unsafe.Add(mBase, _consts[775])) = v747
...
L167:
	;
	*(*int32)(unsafe.Add(mBase, _consts[775])) = v793
...
L169:
	...
	v825 = *(*int32)(unsafe.Add(mBase, _consts[139]))
...
L170:
	;
	*(*int32)(unsafe.Add(mBase, _consts[774])) = v793
	*(*int32)(unsafe.Add(mBase, _consts[51])) = int32(2)
	v807 = *(*int32)(unsafe.Add(mBase, _consts[193]))
...
L172:
	;
	*(*int32)(unsafe.Add(mBase, _consts[51])) = int32(3)
	*(*int32)(unsafe.Add(mBase, _consts[774])) = int32(0)
	v816 = *(*int32)(unsafe.Add(mBase, _consts[193]))
	if v798 == int32(2) {
		goto L173
	} else {
		goto L174
...
L184:
	;
	v843 = *(*int32)(unsafe.Add(mBase, _consts[139]))
	v844 = v843
	goto L179
L185:
	;
...
L186:
	;
	v860 = *(*int32)(unsafe.Add(mBase, _consts[51]))
...
L191:
	;
	F_errmsg_internal(m, int32(447428), int32(0))
	mBase = m.M
	v872 = m.ExcPending
	if v872 != 0 {
		goto L1
...
L196:
	;
	F_errmsg_internal(m, int32(8614), int32(0))
	mBase = m.M
	v898 = m.ExcPending
	if v898 != 0 {
		goto L1
...
L197:
	;
	F_errfinish(m, int32(483637), int32(1192), int32(237972))
	mBase = m.M
	v903 = m.ExcPending
	if v903 != 0 {
		goto L1
...
L210:
	...
	v941 = *(*int32)(unsafe.Add(mBase, _consts[774]))
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v941
	*(*int32)(unsafe.Add(mBase, uint32(v17)+36)) = v939
	F_errmsg_internal(m, int32(645598), v17+int32(32))
	mBase = m.M
	v948 = m.ExcPending
	if v948 != 0 {
		goto L1
...
L1:
	;
	v11 = *(*int32)(unsafe.Add(mBase, _consts[193]))
...
L7:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _consts[153]))
	v30 = *(*int32)(unsafe.Add(mBase, _consts[194]))
	v33 = v3
	v36 = v22
	v37 = v28
	v38 = v30
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _consts[787])) = l0
	v93 = *(*int32)(unsafe.Add(mBase, _consts[185]))
...
L21:
	...
	v81 = *(*int32)(unsafe.Add(mBase, _consts[153]))
	v83 = v77
	v84 = v81
	v85 = v79
	goto L11
...
func F_ProcSignalInit(m *base.Module, l0 int32, l1 int32) {
	...
	v12 = v10 - int32(32)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[743]))
	if int32(0) <= v15 {
		v19 = *(*int32)(unsafe.Add(mBase, _consts[786]))
		if v19+int32(38) <= v15 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v149 = m.ExcPending
			if v149 != 0 {
				...
				v151 = *(*int32)(unsafe.Add(mBase, _consts[743]))
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = v154 + int32(38)
				F_errmsg_internal(m, int32(654363), v12+int32(16))
				mBase = m.M
				v162 = m.ExcPending
				if v162 != 0 {
					return
				} else {
					F_errfinish(m, int32(488642), int32(176), int32(98767))
					mBase = m.M
					v167 = m.ExcPending
					if v167 != 0 {
						return
			...
			v24 = *(*int32)(unsafe.Add(mBase, _consts[788]))
			...
			*(*int32)(unsafe.Add(mBase, uint32(v29))) = int32(1)
			v34 = v27 + int32(8)
			if v30 != 0 {
				F_s_lock(m, v29, int32(488642), int32(179), int32(98767))
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v34)+112)) = v83
					v86 = *(*int32)(unsafe.Add(mBase, _consts[788]))
						...
						if v107 != 0 {
							...
							if v106 == int32(0) {
								*(*int32)(unsafe.Add(mBase, _consts[789])) = v34
								...
								v111 = *(*int32)(unsafe.Add(mBase, _consts[350]))
								*(*int32)(unsafe.Add(mBase, uint32(v12))) = v111
								v114 = *(*int32)(unsafe.Add(mBase, _consts[743]))
								*(*int32)(unsafe.Add(mBase, uint32(v12)+4)) = v114
								F_errmsg_internal(m, int32(8674), v12)
								mBase = m.M
								v118 = m.ExcPending
								if v118 != 0 {
									return
								} else {
									F_errfinish(m, int32(488642), int32(213), int32(98767))
									mBase = m.M
									v123 = m.ExcPending
									if v123 != 0 {
										return
		...
		if v136 != 0 {
			...
			F_errmsg_internal(m, int32(104325), int32(0))
			mBase = m.M
			v140 = m.ExcPending
			if v140 != 0 {
				return
			} else {
				F_errfinish(m, int32(488642), int32(174), int32(98767))
				mBase = m.M
				v145 = m.ExcPending
				if v145 != 0 {
					return
