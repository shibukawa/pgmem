...
func F_EmitProcSignalBarrier(m *base.Module) int64 {
	...
	_ = v86
	v1 = int32(0)
	v7 = *(*int32)(unsafe.Add(mBase, _consts[787]))
	if v1 < v7+int32(38) {
		goto L1
	} else {
		goto L2
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v41))) = v44
	v47 = *(*int32)(unsafe.Add(mBase, _consts[787]))
	v49 = v47 + int32(37)
	if int32(0) <= v49 {
		goto L7
	} else {
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v24 | v25
	v29 = v12 + v25
	v31 = *(*int32)(unsafe.Add(mBase, _consts[787]))
	if v29 < v31+int32(38) {
		v12 = v29
		goto L4
	} else {
...
L10:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[789]))
...
L14:
	;
	F_s_lock(m, v71, int32(478339), int32(402), int32(212764))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L17
...
L27:
	;
	F_errmsg_internal(m, int32(165167), int32(0))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L1
...
L30:
	;
	F_errfinish(m, int32(473441), int32(5045), int32(323081))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L1
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v99))) = v19
	F_errmsg_internal(m, int32(42396), v99)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(473441), int32(5051), int32(323081))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L1
...
L38:
	;
	v135 = *(*int32)(unsafe.Add(mBase, _consts[771]))
	v137 = v131
	v140 = v135
	v145 = v2
	goto L41
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v102)+12)) = v191 - v189
	v195 = *(*int32)(unsafe.Add(mBase, _consts[771]))
	v198 = v131
	goto L54
L43:
	;
...
L45:
	;
	v155 = *(*int32)(unsafe.Add(mBase, _consts[772]))
	v156 = int32(2)
...
L51:
	;
	v175 = *(*int32)(unsafe.Add(mBase, _consts[771]))
	if v172 != 0 {
		v181 = v175
		v182 = v145
		goto L44
...
L60:
	;
	v256 = int32(1)
	v259 = *(*int32)(unsafe.Add(mBase, _consts[772]))
	v261 = *(*int32)(unsafe.Add(mBase, _consts[771]))
	if v251+v256 != v250 {
		goto L61
	} else {
		goto L62
...
L75:
	;
	*(*int64)(unsafe.Add(mBase, _consts[773])) = v385 + v384*int64(1000000) - int64(946684800000000)
	goto L23
L76:
	;
...
L80:
	...
	v442 = v440 - int32(32)
	m.G0 = v442
	v447 = *(*int32)(unsafe.Add(mBase, _consts[774]))
...
L96:
	;
	v489 = *(*int32)(unsafe.Add(mBase, _consts[774]))
...
L101:
	;
	F_errfinish(m, int32(473441), v964, int32(231709))
	mBase = m.M
	v967 = m.ExcPending
	if v967 != 0 {
		goto L1
...
L102:
	;
	v905 = *(*int32)(unsafe.Add(mBase, _consts[775]))
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v647
	F_errmsg_internal(m, int32(236023), v17+int32(16))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L1
...
L139:
	;
	F_errfinish(m, int32(473441), int32(1217), int32(231709))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L1
...
L144:
	...
	v698 = int32(4366164)
	v699 = int32(3)
	v701 = *(*int32)(unsafe.Add(mBase, _consts[776]))
	v703 = v701 + int32(1)
...
L147:
	;
	*(*int32)(unsafe.Add(mBase, _consts[776])) = v706
...
L154:
	;
	v777 = *(*int32)(unsafe.Add(mBase, _consts[776]))
	v779 = v777
	goto L166
L155:
	;
	v736 = *(*int32)(unsafe.Add(mBase, _consts[776]))
...
L157:
	...
	v739 = int32(4366164)
	v740 = int32(3)
	v742 = *(*int32)(unsafe.Add(mBase, _consts[776]))
	v744 = v742 + int32(1)
...
L160:
	;
	*(*int32)(unsafe.Add(mBase, _consts[776])) = v747
...
L167:
	;
	*(*int32)(unsafe.Add(mBase, _consts[776])) = v793
...
L172:
	...
	*(*int32)(unsafe.Add(mBase, _consts[775])) = int32(0)
...
L191:
	;
	F_errmsg_internal(m, int32(437776), int32(0))
	mBase = m.M
	v872 = m.ExcPending
	if v872 != 0 {
		goto L1
...
L197:
	;
	F_errfinish(m, int32(473441), int32(1192), int32(231709))
	mBase = m.M
	v903 = m.ExcPending
	if v903 != 0 {
		goto L1
...
L210:
	...
	v941 = *(*int32)(unsafe.Add(mBase, _consts[775]))
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v941
	*(*int32)(unsafe.Add(mBase, uint32(v17)+36)) = v939
	F_errmsg_internal(m, int32(634180), v17+int32(32))
	mBase = m.M
	v948 = m.ExcPending
	if v948 != 0 {
		goto L1
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _consts[788])) = l0
...
func F_ProcSignalInit(m *base.Module, l0 int32, l1 int32) {
	...
	v12 = v10 - int32(32)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[744]))
	if int32(0) <= v15 {
		v19 = *(*int32)(unsafe.Add(mBase, _consts[787]))
		if v19+int32(38) <= v15 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v149 = m.ExcPending
			if v149 != 0 {
				...
				v151 = *(*int32)(unsafe.Add(mBase, _consts[744]))
				*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v151
				v154 = *(*int32)(unsafe.Add(mBase, _consts[787]))
				*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = v154 + int32(38)
				F_errmsg_internal(m, int32(642762), v12+int32(16))
				mBase = m.M
				v162 = m.ExcPending
				if v162 != 0 {
					return
				} else {
					F_errfinish(m, int32(478339), int32(176), int32(95177))
					mBase = m.M
					v167 = m.ExcPending
					if v167 != 0 {
						return
			...
			v24 = *(*int32)(unsafe.Add(mBase, _consts[789]))
			...
			*(*int32)(unsafe.Add(mBase, uint32(v29))) = int32(1)
			v34 = v27 + int32(8)
			if v30 != 0 {
				F_s_lock(m, v29, int32(478339), int32(179), int32(95177))
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v34)+112)) = v83
					v86 = *(*int32)(unsafe.Add(mBase, _consts[789]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v34))) = v98
					if v40 == v99 {
						*(*int32)(unsafe.Add(mBase, _consts[790])) = v34
						...
						if v107 != 0 {
							...
							if v106 == int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v12))) = v111
								v114 = *(*int32)(unsafe.Add(mBase, _consts[744]))
								*(*int32)(unsafe.Add(mBase, uint32(v12)+4)) = v114
								...
								if v118 != 0 {
									...
									F_errfinish(m, int32(478339), int32(213), int32(95177))
									mBase = m.M
									v123 = m.ExcPending
									if v123 != 0 {
										return
		...
		if v136 != 0 {
			...
			F_errmsg_internal(m, int32(99845), int32(0))
			mBase = m.M
			v140 = m.ExcPending
			if v140 != 0 {
				return
			} else {
				F_errfinish(m, int32(478339), int32(174), int32(95177))
				mBase = m.M
				v145 = m.ExcPending
				if v145 != 0 {
					return
