...
L14:
	;
	F_s_lock(m, v71, int32(480720), int32(402), int32(214014))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L17
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v99))) = v19
	F_errmsg_internal(m, int32(42799), v99)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(475758), int32(5051), int32(324642))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L1
...
L101:
	;
	F_errfinish(m, int32(475758), v964, int32(233012))
	mBase = m.M
	v967 = m.ExcPending
	if v967 != 0 {
		goto L1
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v647
	F_errmsg_internal(m, int32(237326), v17+int32(16))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L1
...
L139:
	;
	F_errfinish(m, int32(475758), int32(1217), int32(233012))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L1
...
L191:
	;
	F_errmsg_internal(m, int32(439706), int32(0))
	mBase = m.M
	v872 = m.ExcPending
	if v872 != 0 {
		goto L1
...
L193:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+4)) = v876
	F_errmsg_internal(m, int32(636886), v17)
	mBase = m.M
	v883 = m.ExcPending
	if v883 != 0 {
		goto L1
...
L197:
	;
	F_errfinish(m, int32(475758), int32(1192), int32(233012))
	mBase = m.M
	v903 = m.ExcPending
	if v903 != 0 {
		goto L1
...
L210:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+36)) = v939
	F_errmsg_internal(m, int32(636886), v17+int32(32))
	mBase = m.M
	v948 = m.ExcPending
	if v948 != 0 {
		goto L1
...
func F_ProcSignalInit(m *base.Module, l0 int32, l1 int32) {
	...
	if int32(0) <= v15 {
		...
		if v19+int32(38) <= v15 {
			...
			if v149 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = v154 + int32(38)
				F_errmsg_internal(m, int32(645651), v12+int32(16))
				mBase = m.M
				v162 = m.ExcPending
				if v162 != 0 {
					return
				} else {
					F_errfinish(m, int32(480720), int32(176), int32(96040))
					mBase = m.M
					v167 = m.ExcPending
					if v167 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v29))) = int32(1)
			v34 = v27 + int32(8)
			if v30 != 0 {
				F_s_lock(m, v29, int32(480720), int32(179), int32(96040))
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return
							...
							if v106 == int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v12)+4)) = v114
								...
								if v118 != 0 {
									...
									F_errfinish(m, int32(480720), int32(213), int32(96040))
									mBase = m.M
									v123 = m.ExcPending
									if v123 != 0 {
										return
		...
		if v136 != 0 {
			...
			F_errmsg_internal(m, int32(100777), int32(0))
			mBase = m.M
			v140 = m.ExcPending
			if v140 != 0 {
				return
			} else {
				F_errfinish(m, int32(480720), int32(174), int32(96040))
				mBase = m.M
				v145 = m.ExcPending
				if v145 != 0 {
					return
