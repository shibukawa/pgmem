...
L14:
	;
	F_s_lock(m, v71, int32(494449), int32(402), int32(220825))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L17
...
L30:
	;
	F_errfinish(m, int32(489352), int32(5045), int32(334834))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(489352), int32(5051), int32(334834))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L1
...
L101:
	;
	F_errfinish(m, int32(489352), v964, int32(240750))
	mBase = m.M
	v967 = m.ExcPending
	if v967 != 0 {
		goto L1
...
L139:
	;
	F_errfinish(m, int32(489352), int32(1217), int32(240750))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L1
...
L191:
	;
	F_errmsg_internal(m, int32(452632), int32(0))
	mBase = m.M
	v872 = m.ExcPending
	if v872 != 0 {
		goto L1
...
L193:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+4)) = v876
	F_errmsg_internal(m, int32(652994), v17)
	mBase = m.M
	v883 = m.ExcPending
	if v883 != 0 {
		goto L1
...
L197:
	;
	F_errfinish(m, int32(489352), int32(1192), int32(240750))
	mBase = m.M
	v903 = m.ExcPending
	if v903 != 0 {
		goto L1
...
L210:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+36)) = v939
	F_errmsg_internal(m, int32(652994), v17+int32(32))
	mBase = m.M
	v948 = m.ExcPending
	if v948 != 0 {
		goto L1
	...
	if int32(0) <= v15 {
		...
		if v19+int32(38) <= v15 {
			...
			if v149 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = v154 + int32(38)
				F_errmsg_internal(m, int32(661819), v12+int32(16))
				mBase = m.M
				v162 = m.ExcPending
				if v162 != 0 {
					return
				} else {
					F_errfinish(m, int32(494449), int32(176), int32(99974))
					mBase = m.M
					v167 = m.ExcPending
					if v167 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v29))) = int32(1)
			v34 = v27 + int32(8)
			if v30 != 0 {
				F_s_lock(m, v29, int32(494449), int32(179), int32(99974))
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return
							...
							if v106 == int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v12)+4)) = v114
								...
								if v118 != 0 {
									...
									F_errfinish(m, int32(494449), int32(213), int32(99974))
									mBase = m.M
									v123 = m.ExcPending
									if v123 != 0 {
										return
		...
		if v136 != 0 {
			...
			if v140 != 0 {
				...
				F_errfinish(m, int32(494449), int32(174), int32(99974))
				mBase = m.M
				v145 = m.ExcPending
				if v145 != 0 {
					return
