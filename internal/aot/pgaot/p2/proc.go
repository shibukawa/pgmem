...
L3:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _c_F_EmitProcSignalBarrier[1]))
	v42 = int32(0)
	v43 = base.AtomicRmwAdd64(m, v40, v42, int64(1))
	v45 = *(*int32)(unsafe.Add(mBase, _c_F_EmitProcSignalBarrier[0]))
	v47 = v45 + int32(37)
	if v42 <= v47 {
		goto L7
	} else {
...
L4:
	...
	v24 = int32(1)
	v26 = base.AtomicRmwOr32(m, v18+v12<<(uint(int32(7))%32)+int32(120), int32(0), v24)
	v28 = v12 + v24
	v30 = *(*int32)(unsafe.Add(mBase, _c_F_EmitProcSignalBarrier[0]))
	if v28 < v30+int32(38) {
		v12 = v28
		goto L4
	} else {
...
L10:
	;
	v56 = *(*int32)(unsafe.Add(mBase, _c_F_EmitProcSignalBarrier[1]))
	v59 = v56 + v50<<(uint(int32(7))%32)
...
L13:
	...
	v64 = v59 + int32(8)
	v66 = v59 + int32(104)
	v69 = base.AtomicRmwXchg32(m, v64, int32(96), int32(1))
	if v69 != 0 {
		goto L14
	} else {
		goto L15
...
L14:
	;
	F_s_lock(m, v66, int32(_a_F_EmitProcSignalBarrier_0), int32(402), int32(_a_F_EmitProcSignalBarrier_1))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L17
...
L19:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v64)+56)) = int32(1)
	v80 = int32(0)
	atomic.StoreUint32((*uint32)(unsafe.Add(mBase, uint32(v64)+96)), uint32(v80))
	v84 = F_pgmem_kill(m, v77, int32(10))
	mBase = m.M
	goto L12
L20:
	;
...
L21:
	;
	v85 = int32(0)
	atomic.StoreUint32((*uint32)(unsafe.Add(mBase, uint32(v66))), uint32(v85))
	goto L12
L22:
	;
	goto L11
	...
	if int32(0) <= v12 {
		...
		if v16+int32(38) <= v12 {
			...
			if v128 != 0 {
				...
				v130 = *(*int32)(unsafe.Add(mBase, _c_F_ProcSignalInit[0]))
				*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v130
				v133 = *(*int32)(unsafe.Add(mBase, _c_F_ProcSignalInit[1]))
				*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = v133 + int32(38)
			...
			v24 = v21 + v12<<(uint(int32(7))%32)
			v26 = v24 + int32(8)
			v29 = base.AtomicRmwXchg32(m, v24, int32(104), int32(1))
			if v29 != 0 {
				F_s_lock(m, v24+int32(104), int32(_a_F_ProcSignalInit_1), int32(179), int32(_a_F_ProcSignalInit_2))
				mBase = m.M
				v36 = m.ExcPending
				if v36 != 0 {
					return
					...
					v38 = int64(0)
					*(*int64)(unsafe.Add(mBase, uint32(v24)+96)) = v38
					*(*int64)(unsafe.Add(mBase, uint32(v24)+88)) = v38
					*(*int64)(unsafe.Add(mBase, uint32(v24)+80)) = v38
					*(*int64)(unsafe.Add(mBase, uint32(v24)+72)) = v38
					*(*int64)(unsafe.Add(mBase, uint32(v24-int32(-64)))) = v38
					*(*int64)(unsafe.Add(mBase, uint32(v24)+56)) = v38
					*(*int64)(unsafe.Add(mBase, uint32(v24)+48)) = v38
					v54 = int32(0)
					*(*int32)(unsafe.Add(mBase, uint32(v26)+112)) = v54
					v57 = *(*int32)(unsafe.Add(mBase, _c_F_ProcSignalInit[2]))
					v61 = base.AtomicRmwCmpxchg64(m, v57, v54, v38, v38)
					v63 = base.AtomicRmwXchg64(m, v26, int32(104), v61)
					if base.B2i32(l1 == v54)|base.B2i32(l1 <= v54) == v54 {
						base.MemoryCopy(m, v24+int32(16), l0, l1)
					} else {
					}
					*(*int32)(unsafe.Add(mBase, uint32(v26)+4)) = l1
					v76 = *(*int32)(unsafe.Add(mBase, _c_F_ProcSignalInit[3]))
					*(*int32)(unsafe.Add(mBase, uint32(v26))) = v76
					v78 = int32(0)
					atomic.StoreUint32((*uint32)(unsafe.Add(mBase, uint32(v26)+96)), uint32(v78))
					if v37 == v78 {
						...
						if v86 != 0 {
							...
							if v85 == int32(0) {
								*(*int32)(unsafe.Add(mBase, _c_F_ProcSignalInit[4])) = v26
								...
								v90 = *(*int32)(unsafe.Add(mBase, _c_F_ProcSignalInit[3]))
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v90
								v93 = *(*int32)(unsafe.Add(mBase, _c_F_ProcSignalInit[0]))
								*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v93
								F_errmsg_internal(m, int32(_a_F_ProcSignalInit_3), v9)
								mBase = m.M
								v97 = m.ExcPending
								if v97 != 0 {
									return
