					...
					if v39 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10)+44)) = v40 + int32(4)
						...
						if v57 != 0 {
							...
							if v58&int32(_a_F__bt_check_third_page_7) == int32(0) {
								v86 = l4
							} else {
								v63 = int32(*(*uint16)(unsafe.Add(mBase, uint32(l4)+4)))
								if v63&int32(_a_F__bt_check_third_page_7) == int32(0) {
									v68 = int32(0)
									if v63&int32(_a_F__bt_check_third_page_8) == v68 {
										v84 = v68
										v86 = v84
									} else {
										v86 = l4 + v58&int32(_a_F__bt_check_third_page_0) - int32(6)
									}
								} else {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v87 | v88<<(uint(v95)%32)
							F_errdetail(m, int32(_a_F__bt_check_third_page_9), v10+v95)
							mBase = m.M
							v103 = m.ExcPending
							if v103 != 0 {
								return
...
L24:
	;
	v79 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[0]))
	if v79 != 0 {
		goto L27
	} else {
		goto L28
...
L35:
	;
	v104 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[0]))
	if v104 != 0 {
		goto L37
	} else {
		goto L38
...
L43:
	;
	v114 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[1]))
...
L45:
	;
	v122 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[2]))
...
L56:
	;
	v167 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[1]))
...
L58:
	;
	v175 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[2]))
...
L65:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[1]))
...
L67:
	;
	v222 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[2]))
...
L76:
	;
	v257 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[1]))
...
L78:
	;
	v265 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[2]))
...
L93:
	;
	v368 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[1]))
...
L95:
	;
	v376 = *(*int32)(unsafe.Add(mBase, _c_F__bt_readnextpage[2]))
...
L109:
	;
	v411 = int32(base.Ui32(v403+int32(_a_F__bt_readnextpage_4)) >> (uint(int32(2)) % 32))
	goto L111
L110:
	;
	v411 = int32(0)
...
L111:
	;
	v414 = F__bt_readpage(m, l0, l3, v411&int32(_a_F__bt_readnextpage_5), v60)
	mBase = m.M
	v415 = m.ExcPending
	if v415 != 0 {
		goto L20
