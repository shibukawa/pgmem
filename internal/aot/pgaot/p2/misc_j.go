...
func F_jsonpath_yy_create_buffer(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v11 != 0 {
		...
		if v8 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = int32(_a_F_jsonpath_yy_create_buffer_0)
			v15 = F_palloc(m, int32(_a_F_jsonpath_yy_create_buffer_1))
			mBase = m.M
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15
				if v15 == int32(0) {
					F_yy_fatal_error_5(m, int32(_a_F_jsonpath_yy_create_buffer_2))
					mBase = m.M
					v81 = m.ExcPending
					if v81 != 0 {
						return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = v20
					v23 = *(*int32)(unsafe.Add(mBase, _c_F_jsonpath_yy_create_buffer[0]))
					v24 = int32(0)
					...
					*(*int32)(unsafe.Add(mBase, _c_F_jsonpath_yy_create_buffer[0])) = v23
					return v8
				}
			}
		} else {
