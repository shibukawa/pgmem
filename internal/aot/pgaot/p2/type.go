...
L3:
	...
	v16 = F_CreateTemplateTupleDesc(m, v15)
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L13:
	;
	F_TupleDescInitEntry(m, v16, v28, int32(0), v35, v37, int32(0))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L4
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16+v44<<(uint(int32(4))%32)+v28*int32(100))+16)) = v42
	goto L16
L16:
	;
	v52 = int32(1)
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v103+v140<<(uint(int32(4))%32)+v126*int32(100))+16)) = v138
	goto L43
L43:
	;
	v150 = v117 + int32(1)
...
func F_TypeShellMake(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v15 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v10)+64)) = v17
		v27 = int32(0)
		base.MemoryFill(m, v10+int32(96), v27, int32(128))
		v31 = F_strncpy(m, v10, l1, int32(64))
		mBase = m.M
		*(*uint8)(unsafe.Add(mBase, uint32(v31)+63)) = uint8(v27)
		v34 = int64(0)
		*(*int64)(unsafe.Add(mBase, uint32(v10)+140)) = v34
		*(*int32)(unsafe.Add(mBase, uint32(v10)+136)) = int32(44)
		*(*int64)(unsafe.Add(mBase, uint32(v10)+128)) = v34
		...
		*(*int64)(unsafe.Add(mBase, uint32(v10)+148)) = v34
		*(*int64)(unsafe.Add(mBase, uint32(v10)+164)) = v34
		*(*int64)(unsafe.Add(mBase, uint32(v10)+156)) = int64(10303626545502)
		*(*int64)(unsafe.Add(mBase, uint32(v10)+172)) = v34
		v54 = int32(0)
		*(*int32)(unsafe.Add(mBase, uint32(v10)+180)) = v54
		*(*int32)(unsafe.Add(mBase, uint32(v10)+208)) = v54
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+100)) = v10
		v65 = int32(257)
		*(*uint16)(unsafe.Add(mBase, uint32(v10)+93)) = uint16(v65)
		v67 = int32(1)
		*(*uint8)(unsafe.Add(mBase, uint32(v10)+95)) = uint8(v67)
		v70 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_TypeShellMake[0])))
		if v70 == v67 {
			v74 = *(*int32)(unsafe.Add(mBase, _c_F_TypeShellMake[1]))
			if v74 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_TypeShellMake[1])) = int32(0)
				v84 = v74
				*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = v84
				v90 = F_heap_form_tuple(m, v16, v10+int32(96), v10-int32(-64))
				mBase = m.M
				v91 = m.ExcPending
				if v91 != 0 {
					return
				} else {
					F_CatalogTupleInsert(m, v14, v90)
					mBase = m.M
					v93 = m.ExcPending
					if v93 != 0 {
						return
					} else {
						v95 = *(*int32)(unsafe.Add(mBase, _c_F_TypeShellMake[2]))
						if v95 != 0 {
							v96 = int32(0)
							F_GenerateTypeDependencies(m, v90, v14, v96, v96, v96, v96, v96, int32(1), v96)
							mBase = m.M
							v104 = m.ExcPending
							if v104 != 0 {
								return
							} else {
								v106 = *(*int32)(unsafe.Add(mBase, _c_F_TypeShellMake[3]))
								if v106 != 0 {
									v108 = int32(0)
									F_RunObjectPostCreateHook(m, int32(1247), v84, v108, v108)
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return
			...
			v82 = F_GetNewOidWithIndex(m, v14, int32(2703), int32(1))
			mBase = m.M
			v83 = m.ExcPending
			if v83 != 0 {
				return
						...
						if v56 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = v55
							...
							if v60 != 0 {
								...
								F_errfinish(m, int32(_a_F_assign_record_type_identifier_1), int32(2148), int32(_a_F_assign_record_type_identifier_2))
								mBase = m.M
								v65 = m.ExcPending
								if v65 != 0 {
									return int64(0)
							...
							if v58 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = v57
								...
								if v66 != 0 {
									...
									F_errfinish(m, int32(_a_F_findTypeSubscriptingFunction_2), int32(2296), int32(_a_F_findTypeSubscriptingFunction_3))
									mBase = m.M
									v71 = m.ExcPending
									if v71 != 0 {
										return int32(0)
								...
								if v80 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v79
									...
									if v86 != 0 {
										...
										F_errfinish(m, int32(_a_F_findTypeSubscriptingFunction_2), int32(2306), int32(_a_F_findTypeSubscriptingFunction_3))
										mBase = m.M
										v91 = m.ExcPending
										if v91 != 0 {
											return int32(0)
					...
					if v40 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = v39
						...
						if v44 != 0 {
							...
							F_errfinish(m, int32(_a_F_findTypeSubscriptingFunction_2), int32(2290), int32(_a_F_findTypeSubscriptingFunction_3))
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return int32(0)
...
L17:
	;
	v37 = F_pstrdup(m, int32(_a_F_format_type_extended_0))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L8
...
L27:
	...
	if v58 != int32(_a_F_format_type_extended_14) {
		goto L28
	} else {
		goto L29
	}
...
L42:
	;
	v77 = F_pstrdup(m, int32(_a_F_format_type_extended_15))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L8
...
L56:
	;
	v201 = F_pstrdup(m, int32(_a_F_format_type_extended_16))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L8
...
L60:
	;
	v177 = F_pstrdup(m, int32(_a_F_format_type_extended_17))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L8
...
L61:
	;
	v174 = F_pstrdup(m, int32(_a_F_format_type_extended_8))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L8
...
L62:
	;
	v171 = F_pstrdup(m, int32(_a_F_format_type_extended_10))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L8
...
L63:
	;
	v168 = F_pstrdup(m, int32(_a_F_format_type_extended_9))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L8
...
L64:
	;
	v165 = F_pstrdup(m, int32(_a_F_format_type_extended_18))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L8
...
L65:
	;
	v162 = F_pstrdup(m, int32(_a_F_format_type_extended_12))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L8
...
L67:
	;
	v152 = F_pstrdup(m, int32(_a_F_format_type_extended_4))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L8
...
L81:
	...
	v130 = F_printTypmod(m, int32(_a_F_format_type_extended_19), l1, v129)
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L8
...
L87:
	...
	v142 = F_printTypmod(m, int32(_a_F_format_type_extended_17), l1, v141)
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L8
...
L89:
	...
	v146 = F_printTypmod(m, int32(_a_F_format_type_extended_20), l1, v145)
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L8
...
L93:
	;
	v149 = F_pstrdup(m, int32(_a_F_format_type_extended_20))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L8
...
L96:
	...
	v156 = F_printTypmod(m, int32(_a_F_format_type_extended_21), l1, v155)
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L8
...
L100:
	;
	v159 = F_pstrdup(m, int32(_a_F_format_type_extended_21))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L8
...
L108:
	...
	v181 = F_printTypmod(m, int32(_a_F_format_type_extended_22), l1, v180)
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L8
...
L110:
	;
	v184 = F_pstrdup(m, int32(_a_F_format_type_extended_22))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L8
...
L113:
	...
	v188 = F_printTypmod(m, int32(_a_F_format_type_extended_23), l1, v187)
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L8
...
L115:
	;
	v191 = F_pstrdup(m, int32(_a_F_format_type_extended_24))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L8
...
L118:
	...
	v195 = F_printTypmod(m, int32(_a_F_format_type_extended_23), l1, v194)
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L8
...
L120:
	;
	v198 = F_pstrdup(m, int32(_a_F_format_type_extended_25))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L8
...
L124:
	...
	v205 = F_printTypmod(m, int32(_a_F_format_type_extended_19), l1, v204)
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L8
...
L126:
	;
	v208 = F_pstrdup(m, int32(_a_F_format_type_extended_26))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L8
...
L129:
	...
	v212 = F_printTypmod(m, int32(_a_F_format_type_extended_27), l1, v211)
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L8
...
L131:
	;
	v215 = F_pstrdup(m, int32(_a_F_format_type_extended_27))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L8
...
L134:
	...
	v219 = F_printTypmod(m, int32(_a_F_format_type_extended_28), l1, v218)
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L8
...
L136:
	;
	v222 = F_pstrdup(m, int32(_a_F_format_type_extended_28))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L8
...
L139:
	;
	v227 = F_pstrdup(m, int32(_a_F_format_type_extended_11))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L8
...
L151:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v246
	v258 = F_psprintf(m, int32(_a_F_format_type_extended_6), v12+int32(32))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L8
...
L155:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v246
	v268 = F_psprintf(m, int32(_a_F_format_type_extended_7), v12+int32(48))
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L8
...
L157:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v270
	v276 = F_psprintf(m, int32(_a_F_format_type_extended_5), v12+int32(16))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L8
						...
						if v58 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v57
							...
							if v64 != 0 {
								...
								F_errfinish(m, int32(_a_F_getTypeBinaryOutputInfo_1), int32(3127), int32(_a_F_getTypeBinaryOutputInfo_2))
								mBase = m.M
								v69 = m.ExcPending
								if v69 != 0 {
									return
				...
				if v21 == int32(0) {
							...
							if v78 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v77
								...
								if v84 != 0 {
									...
									F_errfinish(m, int32(_a_F_getTypeBinaryOutputInfo_1), int32(3132), int32(_a_F_getTypeBinaryOutputInfo_2))
									mBase = m.M
									v89 = m.ExcPending
									if v89 != 0 {
										return
					...
					*(*int32)(unsafe.Add(mBase, uint32(l1))) = v21
					...
					if v25 != 0 {
						...
						v30 = base.B2i32(v27 == int32(_a_F_getTypeBinaryOutputInfo_4))
					}
			...
			if v40 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
				...
				if v44 != 0 {
					...
					F_errfinish(m, int32(_a_F_getTypeBinaryOutputInfo_1), int32(3120), int32(_a_F_getTypeBinaryOutputInfo_2))
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return
						...
						if v57 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v56
							...
							if v63 != 0 {
								...
								F_errfinish(m, int32(_a_F_getTypeInputInfo_1), int32(3028), int32(_a_F_getTypeInputInfo_2))
								mBase = m.M
								v68 = m.ExcPending
								if v68 != 0 {
									return
							...
							if v77 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v76
								...
								if v83 != 0 {
									...
									F_errfinish(m, int32(_a_F_getTypeInputInfo_1), int32(3033), int32(_a_F_getTypeInputInfo_2))
									mBase = m.M
									v88 = m.ExcPending
									if v88 != 0 {
										return
			...
			if v39 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
				...
				if v43 != 0 {
					...
					F_errfinish(m, int32(_a_F_getTypeInputInfo_1), int32(3021), int32(_a_F_getTypeInputInfo_2))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return
