							...
							if v124 != 0 {
								...
								if v127 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = v61
									F_errmsg(m, int32(35917), v10)
									mBase = m.M
									v133 = m.ExcPending
									if v133 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(482816), int32(979), int32(376277))
										mBase = m.M
										v138 = m.ExcPending
										if v138 != 0 {
											return int32(0)
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v272
	F_errmsg_internal(m, int32(473522), v19)
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L4
...
L58:
	;
	F_errfinish(m, int32(481595), int32(544), int32(26351))
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L4
...
L137:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v438
	F_errmsg_internal(m, int32(470027), v19+int32(16))
	mBase = m.M
	v659 = m.ExcPending
	if v659 != 0 {
		goto L4
...
L138:
	;
	F_errfinish(m, int32(481595), int32(691), int32(90301))
	mBase = m.M
	v664 = m.ExcPending
	if v664 != 0 {
		goto L4
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v62
	F_errmsg_internal(m, int32(473522), v10)
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L20
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v35
	F_errmsg_internal(m, int32(470027), v10+int32(16))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L20
...
L62:
	;
	F_errfinish(m, int32(481595), int32(831), int32(90778))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L20
...
func F_spg_kd_choose(m *base.Module, l0 int32) int32 {
	...
	if v7 == int32(1) {
		...
		if v15 != 0 {
			...
			F_errmsg_internal(m, int32(167501), int32(0))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(488629), int32(62), int32(352961))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L10:
	;
	F_errfinish(m, int32(488629), int32(173), int32(90277))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L8
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v164
	F_errmsg_internal(m, int32(471605), v15)
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L8
...
L48:
	;
	F_errfinish(m, int32(488629), int32(247), int32(90277))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L8
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v96
	F_errmsg_internal(m, int32(469995), v10)
	mBase = m.M
	v100 = m.ExcPending
	if v100 != 0 {
		goto L1
...
L47:
	;
	F_errfinish(m, int32(481575), int32(985), int32(90832))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L1
...
L104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v316
	F_errmsg_internal(m, int32(471605), v19)
	mBase = m.M
	v320 = m.ExcPending
	if v320 != 0 {
		goto L1
...
L105:
	;
	F_errfinish(m, int32(488594), int32(551), int32(90225))
	mBase = m.M
	v325 = m.ExcPending
	if v325 != 0 {
		goto L1
