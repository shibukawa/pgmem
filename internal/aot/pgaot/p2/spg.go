...
func F_spgFormNodeTuple(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l2 != 0 {
		v64 = int32(8)
		v66 = int32(_a_F_spgFormNodeTuple_0)
		v67 = F_palloc0(m, v64)
		mBase = m.M
		v70 = m.ExcPending
		if v70 != 0 {
			...
			if v16 <= int32(0) {
				...
				if v19 == int32(1) {
					...
					if v19&int32(1) == int32(0) {
						...
						if base.Ui32(int32(_a_F_spgFormNodeTuple_1)) <= base.Ui32(v55) {
							...
							if v124 != 0 {
								...
								if v127 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = int32(_a_F_spgFormNodeTuple_2)
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = v61
									F_errmsg(m, int32(_a_F_spgFormNodeTuple_3), v10)
									mBase = m.M
									v133 = m.ExcPending
									if v133 != 0 {
										return int32(0)
...
L66:
	;
	v342 = int32(_a_F_spg_box_quad_inner_consistent_3)
	v343 = *(*int32)(unsafe.Add(mBase, _c_F_spg_box_quad_inner_consistent[0]))
	v345 = *(*int32)(unsafe.Add(mBase, uint32(v22)+24))
	*(*int32)(unsafe.Add(mBase, _c_F_spg_box_quad_inner_consistent[0])) = v345
...
L70:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_spg_box_quad_inner_consistent[0])) = v343
	goto L6
L71:
	;
...
L13:
	;
	if int32(1)<<(uint(v35)%32)&int32(_a_F_spg_box_quad_leaf_consistent_0) != 0 {
		goto L14
	} else {
		goto L15
	}
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v62
	F_errmsg_internal(m, int32(_a_F_spg_box_quad_leaf_consistent_1), v10)
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L20
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v35
	F_errmsg_internal(m, int32(_a_F_spg_box_quad_leaf_consistent_4), v10+int32(16))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L20
...
L77:
	;
	switch v193&int32(_a_F_spg_text_inner_consistent_0) - int32(1) {
	case 0, 1:
		goto L100
	case 2:
		goto L96
