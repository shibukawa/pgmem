...
func F_call_bool_check_hook(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v14 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_call_bool_check_hook[0])) = int32(50856066)
		v21 = int32(0)
		*(*int32)(unsafe.Add(mBase, _c_F_call_bool_check_hook[1])) = v21
		*(*int32)(unsafe.Add(mBase, _c_F_call_bool_check_hook[2])) = v21
		*(*int32)(unsafe.Add(mBase, _c_F_call_bool_check_hook[3])) = v21
		...
		if v32 != 0 {
			...
			if v29 != 0 {
				...
				if v35 != 0 {
					...
					if v34 != 0 {
						v37 = *(*int32)(unsafe.Add(mBase, _c_F_call_bool_check_hook[0]))
						F_errcode(m, v37)
						mBase = m.M
						v39 = m.ExcPending
						if v39 != 0 {
							...
							v41 = *(*int32)(unsafe.Add(mBase, _c_F_call_bool_check_hook[1]))
							if v41 != 0 {
								*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v41
								F_errmsg_internal(m, int32(_a_F_call_bool_check_hook_0), v9+int32(-16))
								mBase = m.M
								v47 = m.ExcPending
								if v47 != 0 {
									return int32(0)
								} else {
									v59 = *(*int32)(unsafe.Add(mBase, _c_F_call_bool_check_hook[2]))
									if v59 != 0 {
										*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v59
										F_errdetail_internal(m, int32(_a_F_call_bool_check_hook_0), v9+int32(-48))
										mBase = m.M
										v65 = m.ExcPending
										if v65 != 0 {
											return int32(0)
										} else {
											v67 = *(*int32)(unsafe.Add(mBase, _c_F_call_bool_check_hook[3]))
											if v67 != 0 {
												*(*int32)(unsafe.Add(mBase, uint32(v11))) = v67
												F_errhint(m, int32(_a_F_call_bool_check_hook_0), v11)
												mBase = m.M
												v71 = m.ExcPending
												if v71 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(_a_F_call_bool_check_hook_1), int32(_a_F_call_bool_check_hook_2), int32(_a_F_call_bool_check_hook_3))
													mBase = m.M
													v76 = m.ExcPending
													if v76 != 0 {
														return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v48
								F_errmsg(m, int32(_a_F_call_bool_check_hook_4), v9+int32(-32))
								mBase = m.M
								v56 = m.ExcPending
								if v56 != 0 {
									return int32(0)
...
L28:
	;
	v75 = F_pg_strncasecmp(m, l0, int32(_a_F_parse_bool_0), v59)
	mBase = m.M
	if v75 != 0 {
		goto L23
	} else {
...
L29:
	;
	v71 = F_pg_strncasecmp(m, l0, int32(_a_F_parse_bool_1), v59)
	mBase = m.M
	if v71 == int32(0) {
		goto L22
	} else {
...
L30:
	;
	v67 = F_pg_strncasecmp(m, l0, int32(_a_F_parse_bool_2), v59)
	mBase = m.M
	if v67 != 0 {
		goto L23
	} else {
...
L31:
	;
	v65 = F_pg_strncasecmp(m, l0, int32(_a_F_parse_bool_3), v59)
	mBase = m.M
	if v65 != 0 {
		goto L23
	} else {
...
L40:
	;
	v83 = F_pg_strncasecmp(m, l0, int32(_a_F_parse_bool_4), v82)
	mBase = m.M
	if v83 == int32(0) {
		goto L22
	} else {
...
L41:
	;
	v87 = F_pg_strncasecmp(m, l0, int32(_a_F_parse_bool_5), v82)
	mBase = m.M
	if v87 != 0 {
		goto L23
	} else {
