...
func F_bool_accum_inv(m *base.Module, l0 int32) int32 {
	...
	if v3 != 0 {
		...
		if v26 != 0 {
			...
			F_errmsg_internal(m, int32(370027), int32(0))
			mBase = m.M
			v30 = m.ExcPending
			if v30 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(520825), int32(370), int32(34022))
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return int32(0)
						...
						if v39 != 0 {
							...
							if v41 != 0 {
											...
											if v67 != 0 {
												*(*int32)(unsafe.Add(mBase, uint32(v11))) = v67
												...
												if v71 != 0 {
													...
													F_errfinish(m, int32(523571), int32(6836), int32(329923))
													mBase = m.M
													v76 = m.ExcPending
													if v76 != 0 {
														return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v48
								F_errmsg(m, int32(509607), v9+int32(-32))
								mBase = m.M
								v56 = m.ExcPending
								if v56 != 0 {
									return int32(0)
...
func F_parse_bool(m *base.Module, l0 int32, l1 int32) int32 {
	...
	default:
		...
		v66 = v60
	case 22, 54:
		v11 = F_pg_strncasecmp(m, l0, int32(378570), v3)
		mBase = m.M
		if v11 != 0 {
			v47 = int32(0)
			if l1 != 0 {
	...
	case 30, 62:
		v19 = F_pg_strncasecmp(m, l0, int32(252653), v3)
		mBase = m.M
		if v19 != 0 {
			v47 = int32(0)
			if l1 != 0 {
	...
	case 31, 63:
		...
		v27 = F_pg_strncasecmp(m, l0, int32(285807), v26)
		mBase = m.M
		if v27 == int32(0) {
			v51 = int32(1)
			if l1 == int32(0) {
			...
			v31 = F_pg_strncasecmp(m, l0, int32(355204), v26)
			mBase = m.M
			if v31 != 0 {
				v47 = int32(0)
				if l1 != 0 {
	...
	case 36, 68:
		v9 = F_pg_strncasecmp(m, l0, int32(361051), v3)
		mBase = m.M
		if v9 != 0 {
			v47 = int32(0)
			if l1 != 0 {
