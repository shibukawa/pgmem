	...
	if v3 != 0 {
		...
		if v26 != 0 {
			...
			if v30 != 0 {
				...
				F_errfinish(m, int32(497170), int32(370), int32(32611))
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return int32(0)
						...
						if v39 != 0 {
							...
							if v41 != 0 {
											...
											if v67 != 0 {
												*(*int32)(unsafe.Add(mBase, uint32(v11))) = v67
												...
												if v71 != 0 {
													...
													F_errfinish(m, int32(499593), int32(6836), int32(315141))
													mBase = m.M
													v76 = m.ExcPending
													if v76 != 0 {
														return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v48
								F_errmsg(m, int32(487836), v9+int32(-32))
								mBase = m.M
								v56 = m.ExcPending
								if v56 != 0 {
									return int32(0)
...
func F_parse_bool(m *base.Module, l0 int32, l1 int32) int32 {
	...
	default:
		...
		v66 = v60
	case 22, 54:
		v11 = F_pg_strncasecmp(m, l0, int32(361203), v3)
		mBase = m.M
		if v11 != 0 {
			v47 = int32(0)
			if l1 != 0 {
	...
	case 30, 62:
		v19 = F_pg_strncasecmp(m, l0, int32(240899), v3)
		mBase = m.M
		if v19 != 0 {
			v47 = int32(0)
			if l1 != 0 {
	...
	case 31, 63:
		...
		v27 = F_pg_strncasecmp(m, l0, int32(272980), v26)
		mBase = m.M
		if v27 == int32(0) {
			v51 = int32(1)
			if l1 == int32(0) {
			...
			v31 = F_pg_strncasecmp(m, l0, int32(338833), v26)
			mBase = m.M
			if v31 != 0 {
				v47 = int32(0)
				if l1 != 0 {
	...
	case 36, 68:
		v9 = F_pg_strncasecmp(m, l0, int32(344187), v3)
		mBase = m.M
		if v9 != 0 {
			v47 = int32(0)
			if l1 != 0 {
		...
		v66 = v60
	case 41, 73:
		v15 = F_pg_strncasecmp(m, l0, int32(157205), v3)
		mBase = m.M
		if v15 == int32(0) {
			v51 = int32(1)
			if l1 == int32(0) {
