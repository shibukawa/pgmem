...
L71:
	;
	F_errfinish(m, int32(494457), int32(66), int32(409593))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L1
...
L74:
	;
	F_errmsg(m, int32(396559), int32(0))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(494457), int32(80), int32(409593))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L1
...
L78:
	;
	F_errfinish(m, int32(494457), int32(88), int32(409593))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L1
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(487931), int32(101), int32(429629))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
...
func F_binary_upgrade_set_next_multirange_pg_type_oid(m *base.Module, l0 int32) int32 {
	...
	if v3 == int32(0) {
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(487931), int32(79), int32(430562))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		v25 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
		*(*int32)(unsafe.Add(mBase, _consts[938])) = v25
		return int32(0)
	}
}
func F_binary_upgrade_set_next_pg_authid_oid(m *base.Module, l0 int32) int32 {
	...
	if v3 == int32(0) {
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(487931), int32(178), int32(430780))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		v25 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
		*(*int32)(unsafe.Add(mBase, _consts[1128])) = v25
		return int32(0)
	}
}
