						...
						if v40 != 0 {
							...
							if v39 == int32(0) {
								...
								if v89 != 0 {
									...
									if v92 != 0 {
										...
										if base.Ui32(l2) <= base.Ui32(int32(41)) {
											v101 = *(*int32)(unsafe.Add(mBase, uint32(l2<<(uint(int32(3))%32))+uint32(_c_F_pg_do_encoding_conversion[2])))
											v102 = v101
										} else {
											v102 = int32(_a_F_pg_do_encoding_conversion_3)
										}
										if base.Ui32(l3) <= base.Ui32(int32(41)) {
											v111 = *(*int32)(unsafe.Add(mBase, uint32(l3<<(uint(int32(3))%32))+uint32(_c_F_pg_do_encoding_conversion[2])))
											v112 = v111
										} else {
											v112 = int32(_a_F_pg_do_encoding_conversion_3)
										}
								...
								if base.Ui32(int32(536870911)) <= base.Ui32(l1) {
									...
									v46 = *(*int32)(unsafe.Add(mBase, _c_F_pg_do_encoding_conversion[3]))
