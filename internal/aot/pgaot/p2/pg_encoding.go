					...
					if base.B2i32(v34 == int32(2)) == int32(0) {
						...
						if v76 != 0 {
							...
							if v80 != 0 {
								...
								F_errfinish(m, int32(493901), int32(388), int32(270894))
								mBase = m.M
								v85 = m.ExcPending
								if v85 != 0 {
									return int32(0)
								...
								if v89 != 0 {
									...
									if v92 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9))) = v102
										F_errmsg(m, int32(71180), v9)
										mBase = m.M
										v117 = m.ExcPending
										if v117 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(493901), int32(396), int32(270894))
											mBase = m.M
											v122 = m.ExcPending
											if v122 != 0 {
												return int32(0)
											...
											if v133 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
												...
												if v139 != 0 {
													...
													F_errfinish(m, int32(493901), int32(412), int32(270894))
													mBase = m.M
													v144 = m.ExcPending
													if v144 != 0 {
														return int32(0)
														...
														if v151 != 0 {
															...
															if v155 != 0 {
																...
																*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l1
																F_errdetail(m, int32(617846), v9+int32(32))
																mBase = m.M
																v161 = m.ExcPending
																if v161 != 0 {
																	return int32(0)
																} else {
																	F_errfinish(m, int32(493901), int32(440), int32(270894))
																	mBase = m.M
																	v166 = m.ExcPending
																	if v166 != 0 {
																		return int32(0)
