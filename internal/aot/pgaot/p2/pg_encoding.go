	...
	if l3 == int32(0) {
		...
		if l1 <= int32(0) {
			...
			if l2 == l3 {
				...
				if l2 == int32(0) {
					v22 = *(*int32)(unsafe.Add(mBase, uint32(l3*int32(28))+uint32(_consts[1223])))
					...
					if base.B2i32(v34 == int32(2)) == int32(0) {
						...
						if v76 != 0 {
							...
							F_errmsg_internal(m, int32(255413), int32(0))
							mBase = m.M
							v80 = m.ExcPending
							if v80 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(488977), int32(388), int32(268587))
								mBase = m.M
								v85 = m.ExcPending
								if v85 != 0 {
									return int32(0)
								...
								if v89 != 0 {
									...
									if v92 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9))) = v102
										F_errmsg(m, int32(70687), v9)
										mBase = m.M
										v117 = m.ExcPending
										if v117 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(488977), int32(396), int32(268587))
											mBase = m.M
											v122 = m.ExcPending
											if v122 != 0 {
												return int32(0)
											...
											if v133 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
												...
												if v139 != 0 {
													...
													F_errfinish(m, int32(488977), int32(412), int32(268587))
													mBase = m.M
													v144 = m.ExcPending
													if v144 != 0 {
														return int32(0)
														...
														if v151 != 0 {
															...
															if v155 != 0 {
																...
																*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l1
																F_errdetail(m, int32(597369), v9+int32(32))
																mBase = m.M
																v161 = m.ExcPending
																if v161 != 0 {
																	return int32(0)
																} else {
																	F_errfinish(m, int32(488977), int32(440), int32(268587))
																	mBase = m.M
																	v166 = m.ExcPending
																	if v166 != 0 {
																		return int32(0)
