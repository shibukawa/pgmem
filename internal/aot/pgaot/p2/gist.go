								...
								if v57 != 0 {
									...
									if v103 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v11))) = v52
										F_errmsg_internal(m, int32(382775), v11)
										mBase = m.M
										v107 = m.ExcPending
										if v107 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(488344), int32(753), int32(313926))
											mBase = m.M
											v112 = m.ExcPending
											if v112 != 0 {
												return int32(0)
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v37))) = v73
	F_errmsg_internal(m, int32(382775), v37)
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L6
...
L28:
	;
	F_errfinish(m, int32(488344), int32(761), int32(313907))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L6
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+32)) = v109
	F_errmsg_internal(m, int32(158144), v27+int32(32))
	mBase = m.M
	v898 = m.ExcPending
	if v898 != 0 {
		goto L10
...
L168:
	;
	F_errfinish(m, int32(492573), int32(103), int32(417044))
	mBase = m.M
	v903 = m.ExcPending
	if v903 != 0 {
		goto L10
...
L170:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+16)) = v173
	F_errmsg_internal(m, int32(158144), v27+int32(16))
	mBase = m.M
	v913 = m.ExcPending
	if v913 != 0 {
		goto L10
...
L171:
	;
	F_errfinish(m, int32(492573), int32(139), int32(417044))
	mBase = m.M
	v918 = m.ExcPending
	if v918 != 0 {
		goto L10
...
L173:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27))) = v38
	F_errmsg_internal(m, int32(52018), v27)
	mBase = m.M
	v926 = m.ExcPending
	if v926 != 0 {
		goto L10
...
L174:
	;
	F_errfinish(m, int32(492573), int32(430), int32(240106))
	mBase = m.M
	v931 = m.ExcPending
	if v931 != 0 {
		goto L10
