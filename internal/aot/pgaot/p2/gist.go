								...
								if v57 != 0 {
									...
									if v103 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v11))) = v52
										F_errmsg_internal(m, int32(404420), v11)
										mBase = m.M
										v107 = m.ExcPending
										if v107 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(515520), int32(753), int32(331410))
											mBase = m.M
											v112 = m.ExcPending
											if v112 != 0 {
												return int32(0)
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v37))) = v73
	F_errmsg_internal(m, int32(404420), v37)
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L6
...
L28:
	;
	F_errfinish(m, int32(515520), int32(761), int32(331391))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L6
...
L30:
	;
	F_errmsg_internal(m, int32(466452), int32(0))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(516747), int32(255), int32(159611))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L1
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v81
	F_appendStringInfo(m, v19+int32(32), int32(715129), v19)
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(516747), int32(211), int32(159611))
	mBase = m.M
	v499 = m.ExcPending
	if v499 != 0 {
		goto L1
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+20)) = int32(540969)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v507 + int32(4)
	F_errmsg(m, int32(29092), v19+int32(16))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L1
...
L102:
	;
	F_errfinish(m, int32(516747), int32(222), int32(159611))
	mBase = m.M
	v522 = m.ExcPending
	if v522 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(516747), int32(152), int32(530687))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(516747), int32(141), int32(530687))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L1
...
L15:
	;
	v41 = F_cstring_to_text(m, int32(355517))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L19:
	;
	v50 = F_cstring_to_text(m, int32(466492))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L23:
	;
	v62 = F_cstring_to_text(m, int32(466339))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L27:
	;
	v74 = F_cstring_to_text(m, int32(111066))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L1
...
L31:
	;
	v86 = F_cstring_to_text(m, int32(426861))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L1
...
L47:
	;
	F_errfinish(m, int32(516747), int32(86), int32(253050))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L1
...
L50:
	;
	F_errfinish(m, int32(516747), int32(95), int32(253050))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+32)) = v109
	F_errmsg_internal(m, int32(168976), v27+int32(32))
	mBase = m.M
	v898 = m.ExcPending
	if v898 != 0 {
		goto L10
...
L168:
	;
	F_errfinish(m, int32(520842), int32(103), int32(440743))
	mBase = m.M
	v903 = m.ExcPending
	if v903 != 0 {
		goto L10
...
L170:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+16)) = v173
	F_errmsg_internal(m, int32(168976), v27+int32(16))
	mBase = m.M
	v913 = m.ExcPending
	if v913 != 0 {
		goto L10
...
L171:
	;
	F_errfinish(m, int32(520842), int32(139), int32(440743))
	mBase = m.M
	v918 = m.ExcPending
	if v918 != 0 {
		goto L10
...
L173:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27))) = v38
	F_errmsg_internal(m, int32(56989), v27)
	mBase = m.M
	v926 = m.ExcPending
	if v926 != 0 {
		goto L10
...
L174:
	;
	F_errfinish(m, int32(520842), int32(430), int32(254076))
	mBase = m.M
	v931 = m.ExcPending
	if v931 != 0 {
		goto L10
