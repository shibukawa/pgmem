		...
		if v16 == int32(0) {
			...
			if v22 != 0 {
				...
				if v31 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v24)+4)) = v37 + (v29+int32(7))&int32(_a_F_gistPopItupFromNodeBuffer_1)
					v44 = *(*int32)(unsafe.Add(mBase, uint32(l1)+12))
					v45 = *(*int32)(unsafe.Add(mBase, uint32(v44)+4))
					if v45 != int32(_a_F_gistPopItupFromNodeBuffer_2) {
						m.G0 = v11 + int32(16)
						return base.B2i32(int32(0) < v13)
					} else {
						...
						if v52 != int32(-1) {
							...
							if v58 != 0 {
								...
								if v57 != 0 {
									...
									F_BufFileReadExact(m, v55, v44, int32(_a_F_gistPopItupFromNodeBuffer_6))
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return int32(0)
...
L33:
	;
	v107 = v103 + int32(_a_F_gist_page_items_3)
	if v107&int32(_a_F_gist_page_items_4) == int32(0) {
		goto L25
	} else {
		goto L34
	}
...
L35:
	...
	v148 = v40 + v145&int32(_a_F_gist_page_items_5)
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+232)) = v161 & int32(_a_F_gist_page_items_6)
	v165 = *(*int32)(unsafe.Add(mBase, uint32(v144)))
	v166 = int32(_a_F_gist_page_items_7)
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v81
	F_appendStringInfo(m, v19+int32(32), int32(_a_F_gist_page_items_8), v19)
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L1
...
L48:
	;
	v230 = int32(_a_F_gist_page_items_9)
	goto L50
L49:
	;
...
L54:
	;
	v240 = int32(_a_F_gist_page_items_10)
	goto L56
L55:
	;
	if v193 == int32(0) {
...
L57:
	;
	v240 = int32(_a_F_gist_page_items_11)
	goto L56
L58:
	;
	goto L53
...
L93:
	;
	v440 = v135 + int32(1)
	v442 = v440 & int32(_a_F_gist_page_items_12)
	if base.Ui32(v442) <= base.Ui32(int32(base.Ui32(v107)>>(uint(int32(2))%32))&int32(_a_F_gist_page_items_12)) {
		v124 = v442
		v135 = v440
		goto L35
	} else {
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+20)) = int32(_a_F_gist_page_items_14)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v507 + int32(4)
	F_errmsg(m, int32(_a_F_gist_page_items_15), v19+int32(16))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L1
...
L20:
	;
	v62 = v58 + int32(_a_F_gist_page_items_bytea_3)
	if v62&int32(_a_F_gist_page_items_bytea_4) == int32(0) {
		goto L8
	} else {
		goto L21
	}
...
L22:
	...
	v94 = v27 + v91&int32(_a_F_gist_page_items_bytea_5)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v75
	v103 = v95 & int32(_a_F_gist_page_items_bytea_6)
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v107
	v118 = int32(_a_F_gist_page_items_bytea_7)
...
L29:
	;
	v132 = v81 + int32(1)
	v134 = v132 & int32(_a_F_gist_page_items_bytea_8)
	if base.Ui32(v134) <= base.Ui32(int32(base.Ui32(v62)>>(uint(int32(2))%32))&int32(_a_F_gist_page_items_bytea_8)) {
		v75 = v134
		v81 = v132
		goto L22
	} else {
...
L35:
	;
	v99 = F_DirectFunctionCall1Coll(m, int32(2914), int32(0), v93)
	mBase = m.M
	v100 = m.ExcPending
	if v100 != 0 {
		goto L1
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_gist_redo[0])) = v30
	v883 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[1]))
...
L7:
	;
	v340 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[2]))
...
L44:
	...
	v177 = F_PageAddItemExtended(m, v99, v148, v173, v150&int32(_a_F_gist_redo_3), int32(0))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L10
...
L66:
	;
	v294 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[3]))
...
L68:
	;
	v302 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[4]))
...
L69:
	...
	v316 = v314 & int32(_a_F_gist_redo_4)
...
L83:
	;
	v401 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[3]))
...
L85:
	;
	v409 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[4]))
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v451+v548<<(uint(int32(2))%32)))) = v546
	...
	v580 = v551 + v573
	if v580 != v456 {
		v546 = v546 + v575&int32(_a_F_gist_redo_1)
		v548 = v548 + v573
		v551 = v580
		goto L108
	} else {
...
L112:
	;
	F_PageInit(m, v629, int32(_a_F_gist_redo_5), int32(16))
	mBase = m.M
	v633 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v629)+16)))
	v634 = v629 + v633
	v635 = int32(_a_F_gist_redo_6)
...
L113:
	;
	v615 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[3]))
...
L115:
	;
	v623 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[4]))
...
L118:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v415+v654)+4)) = uint32(v656)
	...
	v662 = v660 & int32(_a_F_gist_redo_7)
...
L126:
	...
	v714 = v712 & int32(_a_F_gist_redo_7)
...
L146:
	;
	v778 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[3]))
...
L148:
	;
	v786 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[4]))
...
L155:
	;
	v823 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[3]))
...
L157:
	;
	v831 = *(*int32)(unsafe.Add(mBase, _c_F_gist_redo[4]))
