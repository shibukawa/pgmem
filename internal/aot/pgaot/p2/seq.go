...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v42+v84))) = int32(5911)
...
L9:
	;
	v69 = F___memset(m, v42, int32(0), int32(8192))
	mBase = m.M
	goto L8
L10:
	;
...
L33:
	;
	v149 = *(*int32)(unsafe.Add(mBase, _consts[10]))
	if int32(0) < v149 {
		goto L31
	} else {
		goto L34
...
L45:
	;
	F_errmsg_internal(m, int32(428345), int32(0))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L2
...
L46:
	;
	F_errfinish(m, int32(525413), int32(405), int32(530826))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L2
