...
func F_LWLockRegisterTranche(m *base.Module, l0 int32) {
	...
	_ = v48
	if int32(95) <= l0 {
		v9 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockRegisterTranche[0]))
		v11 = l0 - int32(95)
		v13 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockRegisterTranche[1]))
		if v13 <= v11 {
			v17 = int32(102)
			...
			if v9 == int32(0) {
				v35 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockRegisterTranche[2]))
				...
				if v37 != 0 {
					...
					v42 = v36
					*(*int32)(unsafe.Add(mBase, _c_F_LWLockRegisterTranche[1])) = v29
					*(*int32)(unsafe.Add(mBase, _c_F_LWLockRegisterTranche[0])) = v42
					v48 = v42
					*(*int32)(unsafe.Add(mBase, uint32(v48+v11<<(uint(int32(2))%32)))) = int32(_a_F_LWLockRegisterTranche_0)
					return
				}
			} else {
