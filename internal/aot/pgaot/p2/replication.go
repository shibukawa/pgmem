...
L34:
	;
	F_s_lock(m, v48, int32(462786), int32(632), int32(342572))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L1
...
L42:
	;
	F_s_lock(m, v48, int32(306255), int32(251), int32(390807))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v53
	F_errmsg(m, int32(450459), v12-int32(-64))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L1
...
L58:
	;
	F_errfinish(m, int32(462786), int32(665), int32(342572))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L1
...
L85:
	;
	F_errfinish(m, int32(462786), int32(705), int32(342572))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v53
	F_errmsg(m, int32(647472), v12+int32(48))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L1
...
L90:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v269
	F_errdetail(m, int32(616077), v12+int32(32))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L1
...
L94:
	;
	F_errfinish(m, int32(462786), int32(684), int32(342572))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(462786), int32(610), int32(342572))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L1
...
L13:
	;
	F_s_lock(m, v32, int32(462786), int32(820), int32(218864))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L1
...
func F_ReplicationSlotPersist(m *base.Module) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(1)
	if v10 != 0 {
		F_s_lock(m, v9, int32(462786), int32(1125), int32(69143))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v23))) = int32(1)
			if v24 != 0 {
				F_s_lock(m, v23, int32(462786), int32(1107), int32(8157))
				mBase = m.M
				v31 = m.ExcPending
				if v31 != 0 {
					return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(79331)
					v41 = *(*int32)(unsafe.Add(mBase, _consts[642]))
					*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v41 + int32(24)
					v48 = F_pg_sprintf(m, v6+int32(16), int32(165202), v6)
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	v75 = F_psprintf(m, int32(76028), v10)
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L24
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
	v132 = F_psprintf(m, int32(307455), v10+int32(16))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L24
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l0
	v115 = F_psprintf(m, int32(204473), v10+int32(32))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L24
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2))) = v115
	v120 = F_psprintf(m, int32(560189), int32(0))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L24
...
L49:
	;
	F_yy_fatal_error_3(m, int32(28648))
	mBase = m.M
	v1588 = m.ExcPending
	if v1588 != 0 {
		goto L18
...
L50:
	;
	F_yy_fatal_error_3(m, int32(633657))
	mBase = m.M
	v1583 = m.ExcPending
	if v1583 != 0 {
		goto L18
...
L55:
	;
	F_yy_fatal_error_3(m, int32(427091))
	mBase = m.M
	v1116 = m.ExcPending
	if v1116 != 0 {
		goto L18
...
L56:
	;
	F_yy_fatal_error_3(m, int32(423045))
	mBase = m.M
	v1113 = m.ExcPending
	if v1113 != 0 {
		goto L18
...
L57:
	;
	F_replication_yyerror(m, int32(249535))
	mBase = m.M
	v1110 = m.ExcPending
	if v1110 != 0 {
		goto L18
...
L63:
	;
	F_yy_fatal_error_3(m, int32(398252))
	mBase = m.M
	v1102 = m.ExcPending
	if v1102 != 0 {
		goto L18
...
L65:
	;
	F_yy_fatal_error_3(m, int32(426443))
	mBase = m.M
	v514 = m.ExcPending
	if v514 != 0 {
		goto L18
...
L67:
	;
	F_replication_yyerror(m, int32(309676))
	mBase = m.M
	v510 = m.ExcPending
	if v510 != 0 {
		goto L18
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v102))) = v102 + int32(12)
	v294 = F_sscanf(m, v286, int32(484269), v102)
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L18
