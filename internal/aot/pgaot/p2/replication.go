...
L34:
	;
	F_s_lock(m, v48, int32(492456), int32(632), int32(364294))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L1
...
L42:
	;
	F_s_lock(m, v48, int32(326117), int32(251), int32(415280))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v53
	F_errmsg(m, int32(479072), v12-int32(-64))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L1
...
L58:
	;
	F_errfinish(m, int32(492456), int32(665), int32(364294))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L1
...
L85:
	;
	F_errfinish(m, int32(492456), int32(705), int32(364294))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v53
	F_errmsg(m, int32(682037), v12+int32(48))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L1
...
L90:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v269
	F_errdetail(m, int32(650044), v12+int32(32))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L1
...
L94:
	;
	F_errfinish(m, int32(492456), int32(684), int32(364294))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(492456), int32(610), int32(364294))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L1
...
L13:
	;
	F_s_lock(m, v32, int32(492456), int32(820), int32(232673))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L1
...
func F_ReplicationSlotPersist(m *base.Module) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(1)
	if v10 != 0 {
		F_s_lock(m, v9, int32(492456), int32(1125), int32(73056))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v23))) = int32(1)
			if v24 != 0 {
				F_s_lock(m, v23, int32(492456), int32(1107), int32(8422))
				mBase = m.M
				v31 = m.ExcPending
				if v31 != 0 {
					return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(84574)
					v41 = *(*int32)(unsafe.Add(mBase, _consts[646]))
					*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v41 + int32(24)
					v48 = F_pg_sprintf(m, v6+int32(16), int32(176834), v6)
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	v19 = F_psprintf(m, int32(80929), v10)
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L7
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
	v76 = F_psprintf(m, int32(327518), v10+int32(16))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L7
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l0
	v59 = F_psprintf(m, int32(217081), v10+int32(32))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L7
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2))) = v59
	v64 = F_psprintf(m, int32(593462), int32(0))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L7
...
L50:
	;
	F_yy_fatal_error_3(m, int32(667921))
	mBase = m.M
	v1471 = m.ExcPending
	if v1471 != 0 {
		goto L18
...
L55:
	;
	F_yy_fatal_error_3(m, int32(453543))
	mBase = m.M
	v1004 = m.ExcPending
	if v1004 != 0 {
		goto L18
...
L56:
	;
	F_yy_fatal_error_3(m, int32(449306))
	mBase = m.M
	v1001 = m.ExcPending
	if v1001 != 0 {
		goto L18
...
L57:
	;
	F_replication_yyerror(m, int32(264851))
	mBase = m.M
	v998 = m.ExcPending
	if v998 != 0 {
		goto L18
...
L63:
	;
	F_yy_fatal_error_3(m, int32(423506))
	mBase = m.M
	v990 = m.ExcPending
	if v990 != 0 {
		goto L18
...
L65:
	;
	F_yy_fatal_error_3(m, int32(452895))
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L18
...
L67:
	;
	F_replication_yyerror(m, int32(330055))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L18
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v102))) = v102 + int32(12)
	v294 = F_sscanf(m, v286, int32(515288), v102)
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L18
