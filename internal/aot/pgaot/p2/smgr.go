				...
				if v23 != 0 {
					...
					if v21 != v22 {
						...
						*(*int32)(unsafe.Add(mBase, _consts[186])) = v35 + int32(1)
						...
						v44 = *(*int32)(unsafe.Add(mBase, uint32(v39*int32(80))+uint32(_consts[823])))
							...
							*(*int32)(unsafe.Add(mBase, _consts[186])) = v49 - int32(1)
							...
							if v56 != 0 {
								...
								if v55 == int32(0) {
									...
									F_errmsg_internal(m, int32(17744), int32(0))
									mBase = m.M
									v62 = m.ExcPending
									if v62 != 0 {
										return
									} else {
										F_errfinish(m, int32(479202), int32(214), int32(309414))
										mBase = m.M
										v67 = m.ExcPending
										if v67 != 0 {
											return
