		...
		if v13 != int32(-1) {
			...
			if v19 != 0 {
				...
				if base.Ui32((v16-int32(1))&int32(65535)) <= base.Ui32(int32(2047)) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v20
					F_errcontext_msg(m, int32(670754), v8+int32(16))
					mBase = m.M
					v36 = m.ExcPending
					if v36 != 0 {
						return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v20
					F_errcontext_msg(m, int32(670863), v8+int32(32))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return
			...
			if v47 != 0 {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v8))) = v48
				F_errcontext_msg(m, int32(670689), v8)
				mBase = m.M
				v52 = m.ExcPending
				if v52 != 0 {
					return
	...
	case 1:
		...
		if v97 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+96)) = v98
			F_errcontext_msg(m, int32(671001), v8+int32(96))
			mBase = m.M
			v108 = m.ExcPending
			if v108 != 0 {
				return
		...
		if v53 != int32(-1) {
			...
			if v59 != 0 {
				...
				if base.Ui32((v56-int32(1))&int32(65535)) <= base.Ui32(int32(2047)) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v60
					F_errcontext_msg(m, int32(670808), v8-int32(-64))
					mBase = m.M
					v76 = m.ExcPending
					if v76 != 0 {
						return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+80)) = v60
					F_errcontext_msg(m, int32(670907), v8+int32(80))
					mBase = m.M
					v84 = m.ExcPending
					if v84 != 0 {
						return
			...
			if v87 != 0 {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v8)+48)) = v88
				F_errcontext_msg(m, int32(670721), v8+int32(48))
				mBase = m.M
				v94 = m.ExcPending
				if v94 != 0 {
					return
	...
	case 3:
		...
		if v111 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+112)) = v112
			F_errcontext_msg(m, int32(670952), v8+int32(112))
			mBase = m.M
			v122 = m.ExcPending
			if v122 != 0 {
				return
		...
		if v123 == int32(-1) {
			...
			if v128 != 0 {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v8)+128)) = v129
				F_errcontext_msg(m, int32(152511), v8+int32(128))
				mBase = m.M
				v137 = m.ExcPending
				if v137 != 0 {
					return
