...
L2:
	;
	v102 = F__emscripten_memcpy_bulkmem(m, v84+int32(248), int32(4434536), int32(128))
	mBase = m.M
	goto L4
L4:
	;
...
L12:
	...
	v152 = F_AllocSetContextCreateInternal(m, v147, int32(347980), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L8
...
L20:
	;
	F_errfinish(m, int32(510345), v139, int32(313987))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L8
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84)+196)) = v1034 + int32(4)
	F_errmsg(m, int32(73052), v84+int32(192))
	mBase = m.M
	v1043 = m.ExcPending
	if v1043 != 0 {
		goto L8
...
L117:
	;
	F_errfinish(m, int32(510345), int32(389), int32(313987))
	mBase = m.M
	v1048 = m.ExcPending
	if v1048 != 0 {
		goto L8
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84)+212)) = v1056 + int32(4)
	F_errmsg(m, int32(423810), v84+int32(208))
	mBase = m.M
	v1065 = m.ExcPending
	if v1065 != 0 {
		goto L8
...
L121:
	;
	F_errfinish(m, int32(510345), int32(394), int32(313987))
	mBase = m.M
	v1070 = m.ExcPending
	if v1070 != 0 {
		goto L8
...
L124:
	;
	F_errfinish(m, int32(510345), int32(475), int32(313987))
	mBase = m.M
	v1087 = m.ExcPending
	if v1087 != 0 {
		goto L8
...
L191:
	...
	v2104 = F_AllocSetContextCreateInternal(m, v2099, int32(116693), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v2105 = m.ExcPending
	if v2105 != 0 {
		goto L8
...
L288:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84)+164)) = v3040 + int32(4)
	F_errmsg(m, int32(170140), v84+int32(160))
	mBase = m.M
	v3049 = m.ExcPending
	if v3049 != 0 {
		goto L8
...
L289:
	;
	F_errfinish(m, int32(510345), int32(1432), int32(116212))
	mBase = m.M
	v3054 = m.ExcPending
	if v3054 != 0 {
		goto L8
...
L389:
	...
	v4140 = F_AllocSetContextCreateInternal(m, v4135, int32(280622), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v4141 = m.ExcPending
	if v4141 != 0 {
		goto L8
...
L409:
	...
	v4353 = F_AllocSetContextCreateInternal(m, v4348, int32(30152), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v4354 = m.ExcPending
	if v4354 != 0 {
		goto L8
...
L423:
	...
	v4461 = F_MakeSingleTupleTableSlot(m, v4459, int32(1632200))
	mBase = m.M
	v4462 = m.ExcPending
	if v4462 != 0 {
		goto L8
...
L476:
	...
	v5383 = F_AllocSetContextCreateInternal(m, v5378, int32(178037), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v5384 = m.ExcPending
	if v5384 != 0 {
		goto L8
...
L511:
	;
	F_errfinish(m, int32(504712), int32(179), int32(178037))
	mBase = m.M
	v5717 = m.ExcPending
	if v5717 != 0 {
		goto L8
...
L662:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5604)+32)) = base.I32_extend16_s(v7350)
	F_errmsg_internal(m, int32(493552), v5604+int32(32))
	mBase = m.M
	v7366 = m.ExcPending
	if v7366 != 0 {
		goto L8
...
L687:
	...
	v7639 = F_MakeSingleTupleTableSlot(m, v7637, int32(1632200))
	mBase = m.M
	v7640 = m.ExcPending
	if v7640 != 0 {
		goto L8
...
L739:
	...
	v10357 = F_AllocSetContextCreateInternal(m, v10352, int32(65614), v10345, int32(8192), int32(8388608))
	mBase = m.M
	v10358 = m.ExcPending
	if v10358 != 0 {
		goto L8
...
L850:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8176))) = v9649
	F_errmsg_internal(m, int32(51301), v8176)
	mBase = m.M
	v10339 = m.ExcPending
	if v10339 != 0 {
		goto L8
...
L851:
	;
	F_errfinish(m, int32(504413), int32(477), int32(266836))
	mBase = m.M
	v10344 = m.ExcPending
	if v10344 != 0 {
		goto L8
...
L981:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10495))) = v12354
	F_errmsg_internal(m, int32(51301), v10495)
	mBase = m.M
	v12358 = m.ExcPending
	if v12358 != 0 {
		goto L8
...
L982:
	;
	F_errfinish(m, int32(505627), int32(272), int32(419284))
	mBase = m.M
	v12363 = m.ExcPending
	if v12363 != 0 {
		goto L8
...
L1115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12369))) = v14697
	F_errmsg_internal(m, int32(51301), v12369)
	mBase = m.M
	v14701 = m.ExcPending
	if v14701 != 0 {
		goto L8
...
L1116:
	;
	F_errfinish(m, int32(503272), int32(364), int32(129172))
	mBase = m.M
	v14706 = m.ExcPending
	if v14706 != 0 {
		goto L8
...
L1129:
	...
	v14908 = F_AllocSetContextCreateInternal(m, v14903, int32(275922), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v14909 = m.ExcPending
	if v14909 != 0 {
		goto L8
...
L1141:
	...
	v15016 = F_MakeSingleTupleTableSlot(m, v15014, int32(1632200))
	mBase = m.M
	v15017 = m.ExcPending
	if v15017 != 0 {
		goto L8
...
L1179:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8096)+16)) = int32(500695)
	F_errmsg(m, int32(378289), v8096+int32(16))
	mBase = m.M
	v15371 = m.ExcPending
	if v15371 != 0 {
		goto L8
...
L1180:
	;
	F_errfinish(m, int32(504712), int32(2287), int32(128549))
	mBase = m.M
	v15376 = m.ExcPending
	if v15376 != 0 {
		goto L8
...
L1311:
	;
	F_errmsg_internal(m, int32(148785), int32(0))
	mBase = m.M
	v18256 = m.ExcPending
	if v18256 != 0 {
		goto L8
...
L1312:
	;
	F_errfinish(m, int32(504712), int32(217), int32(178037))
	mBase = m.M
	v18261 = m.ExcPending
	if v18261 != 0 {
		goto L8
...
L1485:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19708))) = v21207
	F_errmsg_internal(m, int32(493552), v19708)
	mBase = m.M
	v21219 = m.ExcPending
	if v21219 != 0 {
		goto L8
...
L1486:
	;
	F_errfinish(m, int32(333866), int32(230), int32(315052))
	mBase = m.M
	v21224 = m.ExcPending
	if v21224 != 0 {
		goto L8
...
L1568:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84)+180)) = v22360 + int32(4)
	F_errmsg(m, int32(170236), v84+int32(176))
	mBase = m.M
	v22369 = m.ExcPending
	if v22369 != 0 {
		goto L8
...
L1569:
	;
	F_errfinish(m, int32(510345), int32(1530), int32(116212))
	mBase = m.M
	v22374 = m.ExcPending
	if v22374 != 0 {
		goto L8
...
L1642:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v22845)+128)) = base.F64_div(base.F64_convert_i64_s(v23396), float64(1e+06))
	F_appendStringInfo(m, v22845+int32(232), int32(761738), v22845+int32(128))
	mBase = m.M
	v23407 = m.ExcPending
	if v23407 != 0 {
		goto L8
...
L1646:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v22845)+120)) = base.F64_div(base.F64_convert_i64_s(v23421-v22913), v23417)
	F_appendStringInfo(m, v22845+int32(232), int32(761694), v22845+int32(112))
	mBase = m.M
	v23433 = m.ExcPending
	if v23433 != 0 {
		goto L8
...
L1648:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v22845)+96)) = v23358
	F_appendStringInfo(m, v22845+int32(232), int32(762101), v22845+int32(96))
	mBase = m.M
	v23442 = m.ExcPending
	if v23442 != 0 {
		goto L8
...
L1650:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22845)+64)) = v23319 + v23318
	F_appendStringInfo(m, v22845+int32(232), int32(765160), v22845-int32(-64))
	mBase = m.M
	v23452 = m.ExcPending
	if v23452 != 0 {
		goto L8
...
L1651:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22845)+40)) = v23459
	F_appendStringInfo(m, v22845+int32(232), int32(763554), v22845+int32(32))
	mBase = m.M
	v23467 = m.ExcPending
	if v23467 != 0 {
		goto L8
...
L1653:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22845)+16)) = v23470
	F_appendStringInfo(m, v22845+int32(232), int32(207735), v22845+int32(16))
	mBase = m.M
	v23479 = m.ExcPending
	if v23479 != 0 {
		goto L8
...
L1659:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22845))) = v23486
	F_errmsg_internal(m, int32(210227), v22845)
	mBase = m.M
	v23490 = m.ExcPending
	if v23490 != 0 {
		goto L8
...
L1662:
	;
	F_errfinish(m, int32(510345), int32(843), int32(313987))
	mBase = m.M
	v23495 = m.ExcPending
	if v23495 != 0 {
		goto L8
