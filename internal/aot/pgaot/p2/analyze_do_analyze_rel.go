...
L2:
	;
	v102 = F__emscripten_memcpy_bulkmem(m, v84+int32(248), int32(4353480), int32(128))
	mBase = m.M
	goto L4
L4:
	;
...
L12:
	...
	v152 = F_AllocSetContextCreateInternal(m, v147, int32(328064), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L8
...
L20:
	;
	F_errfinish(m, int32(481466), v139, int32(296562))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L8
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84)+196)) = v1034 + int32(4)
	F_errmsg(m, int32(69467), v84+int32(192))
	mBase = m.M
	v1043 = m.ExcPending
	if v1043 != 0 {
		goto L8
...
L117:
	;
	F_errfinish(m, int32(481466), int32(389), int32(296562))
	mBase = m.M
	v1048 = m.ExcPending
	if v1048 != 0 {
		goto L8
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84)+212)) = v1056 + int32(4)
	F_errmsg(m, int32(400488), v84+int32(208))
	mBase = m.M
	v1065 = m.ExcPending
	if v1065 != 0 {
		goto L8
...
L121:
	;
	F_errfinish(m, int32(481466), int32(394), int32(296562))
	mBase = m.M
	v1070 = m.ExcPending
	if v1070 != 0 {
		goto L8
...
L123:
	;
	F_errmsg_internal(m, int32(72330), int32(0))
	mBase = m.M
	v1082 = m.ExcPending
	if v1082 != 0 {
		goto L8
...
L124:
	;
	F_errfinish(m, int32(481466), int32(475), int32(296562))
	mBase = m.M
	v1087 = m.ExcPending
	if v1087 != 0 {
		goto L8
...
L191:
	...
	v2104 = F_AllocSetContextCreateInternal(m, v2099, int32(108344), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v2105 = m.ExcPending
	if v2105 != 0 {
		goto L8
...
L288:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84)+164)) = v3040 + int32(4)
	F_errmsg(m, int32(158991), v84+int32(160))
	mBase = m.M
	v3049 = m.ExcPending
	if v3049 != 0 {
		goto L8
...
L289:
	;
	F_errfinish(m, int32(481466), int32(1432), int32(107863))
	mBase = m.M
	v3054 = m.ExcPending
	if v3054 != 0 {
		goto L8
...
L389:
	...
	v4140 = F_AllocSetContextCreateInternal(m, v4135, int32(265022), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v4141 = m.ExcPending
	if v4141 != 0 {
		goto L8
...
L409:
	...
	v4353 = F_AllocSetContextCreateInternal(m, v4348, int32(28000), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v4354 = m.ExcPending
	if v4354 != 0 {
		goto L8
...
L423:
	...
	v4461 = F_MakeSingleTupleTableSlot(m, v4459, int32(1582984))
	mBase = m.M
	v4462 = m.ExcPending
	if v4462 != 0 {
		goto L8
...
L476:
	...
	v5383 = F_AllocSetContextCreateInternal(m, v5378, int32(166604), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v5384 = m.ExcPending
	if v5384 != 0 {
		goto L8
...
L511:
	;
	F_errfinish(m, int32(476930), int32(179), int32(166604))
	mBase = m.M
	v5717 = m.ExcPending
	if v5717 != 0 {
		goto L8
...
L662:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5604)+32)) = base.I32_extend16_s(v7350)
	F_errmsg_internal(m, int32(466883), v5604+int32(32))
	mBase = m.M
	v7366 = m.ExcPending
	if v7366 != 0 {
		goto L8
...
L687:
	...
	v7639 = F_MakeSingleTupleTableSlot(m, v7637, int32(1582984))
	mBase = m.M
	v7640 = m.ExcPending
	if v7640 != 0 {
		goto L8
...
L739:
	...
	v10357 = F_AllocSetContextCreateInternal(m, v10352, int32(62391), v10345, int32(8192), int32(8388608))
	mBase = m.M
	v10358 = m.ExcPending
	if v10358 != 0 {
		goto L8
...
L850:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8176))) = v9649
	F_errmsg_internal(m, int32(48723), v8176)
	mBase = m.M
	v10339 = m.ExcPending
	if v10339 != 0 {
		goto L8
...
L851:
	;
	F_errfinish(m, int32(476649), int32(477), int32(252277))
	mBase = m.M
	v10344 = m.ExcPending
	if v10344 != 0 {
		goto L8
...
L981:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10495))) = v12354
	F_errmsg_internal(m, int32(48723), v10495)
	mBase = m.M
	v12358 = m.ExcPending
	if v12358 != 0 {
		goto L8
...
L982:
	;
	F_errfinish(m, int32(477437), int32(272), int32(396001))
	mBase = m.M
	v12363 = m.ExcPending
	if v12363 != 0 {
		goto L8
...
L1115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12369))) = v14697
	F_errmsg_internal(m, int32(48723), v12369)
	mBase = m.M
	v14701 = m.ExcPending
	if v14701 != 0 {
		goto L8
...
L1116:
	;
	F_errfinish(m, int32(475848), int32(364), int32(120485))
	mBase = m.M
	v14706 = m.ExcPending
	if v14706 != 0 {
		goto L8
...
L1129:
	...
	v14908 = F_AllocSetContextCreateInternal(m, v14903, int32(261347), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v14909 = m.ExcPending
	if v14909 != 0 {
		goto L8
...
L1141:
	...
	v15016 = F_MakeSingleTupleTableSlot(m, v15014, int32(1582984))
	mBase = m.M
	v15017 = m.ExcPending
	if v15017 != 0 {
		goto L8
...
L1179:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8096)+16)) = int32(473836)
	F_errmsg(m, int32(357007), v8096+int32(16))
	mBase = m.M
	v15371 = m.ExcPending
	if v15371 != 0 {
		goto L8
...
L1180:
	;
	F_errfinish(m, int32(476930), int32(2287), int32(119862))
	mBase = m.M
	v15376 = m.ExcPending
	if v15376 != 0 {
		goto L8
...
L1311:
	;
	F_errmsg_internal(m, int32(138791), int32(0))
	mBase = m.M
	v18256 = m.ExcPending
	if v18256 != 0 {
		goto L8
...
L1312:
	;
	F_errfinish(m, int32(476930), int32(217), int32(166604))
	mBase = m.M
	v18261 = m.ExcPending
	if v18261 != 0 {
		goto L8
...
L1502:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19708))) = v21263
	F_errmsg_internal(m, int32(466883), v19708)
	mBase = m.M
	v21275 = m.ExcPending
	if v21275 != 0 {
		goto L8
...
L1503:
	;
	F_errfinish(m, int32(314613), int32(230), int32(297588))
	mBase = m.M
	v21280 = m.ExcPending
	if v21280 != 0 {
		goto L8
...
L1602:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84)+180)) = v22472 + int32(4)
	F_errmsg(m, int32(159087), v84+int32(176))
	mBase = m.M
	v22481 = m.ExcPending
	if v22481 != 0 {
		goto L8
...
L1603:
	;
	F_errfinish(m, int32(481466), int32(1530), int32(107863))
	mBase = m.M
	v22486 = m.ExcPending
	if v22486 != 0 {
		goto L8
...
L1676:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v22957)+128)) = base.F64_div(base.F64_convert_i64_s(v23508), float64(1e+06))
	F_appendStringInfo(m, v22957+int32(232), int32(712520), v22957+int32(128))
	mBase = m.M
	v23519 = m.ExcPending
	if v23519 != 0 {
		goto L8
...
L1680:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v22957)+120)) = base.F64_div(base.F64_convert_i64_s(v23533-v23025), v23529)
	F_appendStringInfo(m, v22957+int32(232), int32(712476), v22957+int32(112))
	mBase = m.M
	v23545 = m.ExcPending
	if v23545 != 0 {
		goto L8
...
L1682:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v22957)+96)) = v23470
	F_appendStringInfo(m, v22957+int32(232), int32(712883), v22957+int32(96))
	mBase = m.M
	v23554 = m.ExcPending
	if v23554 != 0 {
		goto L8
...
L1684:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22957)+64)) = v23431 + v23430
	F_appendStringInfo(m, v22957+int32(232), int32(715942), v22957-int32(-64))
	mBase = m.M
	v23564 = m.ExcPending
	if v23564 != 0 {
		goto L8
...
L1685:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22957)+40)) = v23571
	F_appendStringInfo(m, v22957+int32(232), int32(714336), v22957+int32(32))
	mBase = m.M
	v23579 = m.ExcPending
	if v23579 != 0 {
		goto L8
...
L1687:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22957)+16)) = v23582
	F_appendStringInfo(m, v22957+int32(232), int32(196039), v22957+int32(16))
	mBase = m.M
	v23591 = m.ExcPending
	if v23591 != 0 {
		goto L8
...
L1693:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22957))) = v23598
	F_errmsg_internal(m, int32(198531), v22957)
	mBase = m.M
	v23602 = m.ExcPending
	if v23602 != 0 {
		goto L8
...
L1696:
	;
	F_errfinish(m, int32(481466), int32(843), int32(296562))
	mBase = m.M
	v23607 = m.ExcPending
	if v23607 != 0 {
		goto L8
