...
L1039:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4076))) = v4068
	F_errmsg_internal(m, int32(_a_F_populate_joinrel_with_paths_0), v4076)
	mBase = m.M
	v8744 = m.ExcPending
	if v8744 != 0 {
		goto L18
...
L1442:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11343)+16)) = v11862
	F_errmsg_internal(m, int32(_a_F_populate_joinrel_with_paths_0), v11343+int32(16))
	mBase = m.M
	v11868 = m.ExcPending
	if v11868 != 0 {
		goto L18
...
L1494:
	;
	v12102 = *(*int32)(unsafe.Add(mBase, _c_F_populate_joinrel_with_paths[0]))
	if v12090 == v12102 {
		goto L1496
	} else {
		goto L1497
...
L1499:
	;
	v12111 = *(*int32)(unsafe.Add(mBase, _c_F_populate_joinrel_with_paths[0]))
...
L1535:
	;
	v12450 = int32(_a_F_populate_joinrel_with_paths_7)
	v12451 = *(*int32)(unsafe.Add(mBase, _c_F_populate_joinrel_with_paths[1]))
	v12453 = *(*int32)(unsafe.Add(mBase, uint32(v11313)+280))
	*(*int32)(unsafe.Add(mBase, _c_F_populate_joinrel_with_paths[1])) = v12453
	if v12409 == int32(0) {
		goto L1556
	} else {
		goto L1557
...
L1567:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_populate_joinrel_with_paths[1])) = v12451
	goto L1512
L1568:
	;
