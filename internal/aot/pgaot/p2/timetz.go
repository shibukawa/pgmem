					...
					if v29 != 0 {
						...
						if v32 != 0 {
							...
							if v36 != 0 {
								...
								F_errfinish(m, int32(519090), int32(2670), int32(321565))
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return int32(0)
	...
	if v16 != 0 {
		...
		if v22 != 0 {
			...
			if v30 != 0 {
				...
				case 1:
					v36 = *(*int64)(unsafe.Add(mBase, _consts[432]))
				...
				default:
					v46 = *(*int64)(unsafe.Add(mBase, _consts[432]))
							...
							if v98 != 0 {
								...
								if v101 != 0 {
									...
									if v105 != 0 {
										...
										F_errfinish(m, int32(519090), int32(3166), int32(387623))
										mBase = m.M
										v110 = m.ExcPending
										if v110 != 0 {
											return int32(0)
