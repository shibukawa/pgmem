...
L21:
	;
	v256 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[0])))
	if v256 == int32(0) {
		goto L82
	} else {
		goto L83
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+16)) = v67 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_0), v36+int32(16))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L31
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+224)) = v93 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_0), v36+int32(224))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L31
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+240)) = v124 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_4), v36+int32(240))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L31
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+256)) = v160 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_6), v36+int32(256))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L31
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+288)) = v186 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_8), v36+int32(288))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L31
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+304)) = v214 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_8), v36+int32(304))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L31
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36))) = v239 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_11), v36)
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L31
...
L82:
	...
	if base.Ui32(v261) < base.Ui32(int32(_a_F_CreateTriggerFiringOn_12)) {
		v270 = v260
		goto L86
	} else {
		goto L87
...
L99:
	...
	v290 = *(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[1]))
...
L113:
	;
	v316 = *(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[1]))
...
L143:
	;
	if v396&int32(_a_F_CreateTriggerFiringOn_13) != 0 {
		goto L6
	} else {
		goto L146
	}
...
L178:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+272)) = v510 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_6), v36+int32(272))
	mBase = m.M
	v518 = m.ExcPending
	if v518 != 0 {
		goto L31
...
L183:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+208)) = v535 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_15), v36+int32(208))
	mBase = m.M
	v543 = m.ExcPending
	if v543 != 0 {
		goto L31
...
L244:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+192)) = v975 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_6), v36+int32(192))
	mBase = m.M
	v983 = m.ExcPending
	if v983 != 0 {
		goto L31
...
L249:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+176)) = v1033 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_8), v36+int32(176))
	mBase = m.M
	v1041 = m.ExcPending
	if v1041 != 0 {
		goto L31
...
L290:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1222)+4)) = l2
	v1228 = F_makeAlias(m, int32(_a_F_CreateTriggerFiringOn_35), int32(0))
	mBase = m.M
	v1229 = m.ExcPending
	if v1229 != 0 {
		goto L31
...
L293:
	;
	v1242 = F_makeAlias(m, int32(_a_F_CreateTriggerFiringOn_36), int32(0))
	mBase = m.M
	v1243 = m.ExcPending
	if v1243 != 0 {
		goto L31
...
L297:
	;
	v1258 = F_transformWhereClause(m, v1222, v1254, int32(37), int32(_a_F_CreateTriggerFiringOn_37))
	mBase = m.M
	v1259 = m.ExcPending
	if v1259 != 0 {
		goto L31
...
L342:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+160)) = v1412 + v1413<<(uint(int32(4))%32) + v1417*int32(100) - int32(76)
	F_errdetail(m, int32(_a_F_CreateTriggerFiringOn_41), v36+int32(160))
	mBase = m.M
	v1428 = m.ExcPending
	if v1428 != 0 {
		goto L31
...
L358:
	;
	v1539 = *(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[1]))
...
L390:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+80)) = v1671
	v1680 = F_pg_snprintf(m, v36+int32(432), int32(64), int32(_a_F_CreateTriggerFiringOn_43), v36+int32(80))
	mBase = m.M
	v1681 = m.ExcPending
	if v1681 != 0 {
		goto L31
...
L397:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+372)) = int32(0)
	v2175 = int32(_a_F_CreateTriggerFiringOn_44)
	goto L273
L398:
	;
...
L431:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+148)) = int32(_a_F_CreateTriggerFiringOn_48)
	*(*int32)(unsafe.Add(mBase, uint32(v36)+144)) = v1895
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_49), v36+int32(144))
	mBase = m.M
	v1904 = m.ExcPending
	if v1904 != 0 {
		goto L31
...
L435:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+132)) = v1917 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_51), v36+int32(128))
	mBase = m.M
	v1927 = m.ExcPending
	if v1927 != 0 {
		goto L31
...
L439:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+116)) = v1940 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_52), v36+int32(112))
	mBase = m.M
	v1950 = m.ExcPending
	if v1950 != 0 {
		goto L31
...
L443:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+100)) = v1963 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_53), v36+int32(96))
	mBase = m.M
	v1973 = m.ExcPending
	if v1973 != 0 {
		goto L31
...
L449:
	;
	v2024 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[2])))
	v2026 = *(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[3]))
	v2044 = int32(0)
	goto L450
L450:
	;
...
L499:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+64)) = v2254
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_54), v36-int32(-64))
	mBase = m.M
	v2373 = m.ExcPending
	if v2373 != 0 {
		goto L31
...
L583:
	;
	v2688 = *(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[4]))
	if v2688 != 0 {
		goto L585
	} else {
		goto L586
...
L592:
	;
	v2697 = *(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[5]))
	v2702 = F_AllocSetContextCreateInternal(m, v2697, int32(_a_F_CreateTriggerFiringOn_55), int32(0), int32(1024), int32(_a_F_CreateTriggerFiringOn_56))
	mBase = m.M
	v2703 = m.ExcPending
	if v2703 != 0 {
		goto L31
...
L593:
	;
	v2704 = int32(_a_F_CreateTriggerFiringOn_57)
	v2705 = *(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[5]))
	*(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[5])) = v2702
...
L596:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_CreateTriggerFiringOn[5])) = v2705
...
L611:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+52)) = v2869 + int32(4)
	F_errmsg(m, int32(_a_F_CreateTriggerFiringOn_58), v36+int32(48))
	mBase = m.M
	v2878 = m.ExcPending
	if v2878 != 0 {
		goto L31
...
L614:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+32)) = v2888
	F_errmsg_internal(m, int32(_a_F_CreateTriggerFiringOn_59), v36+int32(32))
	mBase = m.M
	v2894 = m.ExcPending
	if v2894 != 0 {
		goto L31
...
func F_trigger_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_trigger_in_0)
			F_errmsg(m, int32(_a_F_trigger_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_trigger_in_2), int32(366), int32(_a_F_trigger_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
