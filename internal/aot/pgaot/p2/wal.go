				...
				if v42 != 0 {
					...
					if v44 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v8 + int32(48)
						F_errmsg(m, int32(299484), v8)
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(493782), int32(220), int32(390829))
							mBase = m.M
							v55 = m.ExcPending
							if v55 != 0 {
								return int32(0)
			...
			if v28 != 0 {
				...
				if v30 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v37
					F_errmsg(m, int32(300403), v9)
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(493782), int32(284), int32(18034))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v42
	F_errmsg_internal(m, int32(206666), v7)
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L1
...
L14:
	;
	F_errfinish(m, int32(493782), int32(340), int32(212961))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
func F_WALReadRaiseError(m *base.Module, l0 int32) {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v9)+40)) = uint32(v21)
	v29 = F_pg_snprintf(m, v9+int32(48), int32(64), int32(511599), v9+int32(32))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		return
				...
				if v64 != 0 {
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(48)
						F_errmsg(m, int32(476114), v9+int32(16))
						mBase = m.M
						v81 = m.ExcPending
						if v81 != 0 {
							return
						} else {
							F_errfinish(m, int32(495379), int32(1032), int32(213123))
							mBase = m.M
							v86 = m.ExcPending
							if v86 != 0 {
								return
			...
			if v45 != 0 {
				...
				if v47 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(48)
					F_errmsg(m, int32(296617), v9)
					mBase = m.M
					v55 = m.ExcPending
					if v55 != 0 {
						return
					} else {
						F_errfinish(m, int32(495379), int32(1024), int32(213123))
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return
...
func F_WalRcvForceReply(m *base.Module) {
	...
	var v35 int32
	_ = v35
	v4 = *(*int32)(unsafe.Add(mBase, _consts[691]))
	v5 = int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(v4)+1472)) = v5
	v7 = *(*int32)(unsafe.Add(mBase, uint32(v4)+1456))
	*(*int32)(unsafe.Add(mBase, uint32(v4)+1456)) = v5
	if v7 != 0 {
		v11 = *(*int32)(unsafe.Add(mBase, _consts[691]))
		F_s_lock(m, v11+int32(1456), int32(496642), int32(1356), int32(19470))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return
		} else {
			v20 = *(*int32)(unsafe.Add(mBase, _consts[691]))
...
func F_WalSndWait(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	...
	if v14 != 0 {
		...
		if l2 == int32(100663302) {
			v23 = int32(76)
			v25 = *(*int32)(unsafe.Add(mBase, _consts[685]))
			...
			if v28 != 0 {
				...
				v31 = *(*int32)(unsafe.Add(mBase, _consts[726]))
			...
			v20 = *(*int32)(unsafe.Add(mBase, _consts[687]))
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v58
	F_errmsg_internal(m, int32(489423), v8)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L18
...
L20:
	;
	F_errfinish(m, int32(499589), int32(8695), int32(103664))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L18
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l0
	F_errmsg_internal(m, int32(489423), v8+int32(16))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L18
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v8 + int32(48)
	F_errmsg(m, int32(300432), v8+int32(32))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L18
...
L34:
	;
	F_errfinish(m, int32(499589), int32(8728), int32(423777))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L18
...
L4:
	;
	F_ExplainPropertyInteger(m, int32(172523), int32(0), v10, l0)
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L10
...
L11:
	...
	F_appendStringInfoString(m, v27, int32(548946))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L10
...
L13:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+48)) = v31
	F_appendStringInfo(m, v34, int32(431162), v6+int32(-16))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L10
...
L17:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+32)) = v42
	F_appendStringInfo(m, v45, int32(431209), v6+int32(-32))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L10
...
L21:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+16)) = v53
	F_appendStringInfo(m, v56, int32(38098), v6+int32(-48))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L10
...
L25:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8))) = v64
	F_appendStringInfo(m, v67, int32(431190), v8)
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L10
...
L30:
	...
	F_ExplainPropertyInteger(m, int32(535882), int32(0), v83, l0)
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L10
...
L31:
	...
	F_ExplainPropertyUInteger(m, int32(160364), int32(0), v88, l0)
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L10
...
L32:
	...
	F_ExplainPropertyInteger(m, int32(304756), int32(0), v93, l0)
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L10
