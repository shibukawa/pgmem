...
func F_OpenWalSummaryFile(m *base.Module, l0 int32) int32 {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v8)+20)) = uint32(v20)
	v28 = F_pg_snprintf(m, v8+int32(48), int32(1024), int32(17956), v8+int32(16))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		return int32(0)
				...
				if v42 != 0 {
					...
					if v44 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v8 + int32(48)
						F_errmsg(m, int32(298472), v8)
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(492108), int32(220), int32(389371))
							mBase = m.M
							v55 = m.ExcPending
							if v55 != 0 {
								return int32(0)
		...
		if v19 < int32(0) {
			...
			if v28 != 0 {
				...
				if v30 != 0 {
					...
					v33 = *(*int32)(unsafe.Add(mBase, _consts[266]))
					v37 = *(*int32)(unsafe.Add(mBase, uint32(v33+v31*int32(48))+32))
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v37
					F_errmsg(m, int32(299391), v9)
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(492108), int32(284), int32(18018))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v42
	F_errmsg_internal(m, int32(206013), v7)
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L1
...
L14:
	;
	F_errfinish(m, int32(492108), int32(340), int32(212308))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L18:
	;
	v85 = *(*int32)(unsafe.Add(mBase, _consts[193]))
...
L24:
	...
	mBase = m.M
	v98 = *(*int32)(unsafe.Add(mBase, _consts[193]))
...
L28:
	;
	v219 = int32(4496744)
	v220 = *(*int64)(unsafe.Add(mBase, _consts[243]))
	*(*int64)(unsafe.Add(mBase, _consts[243])) = v220 + base.I64_extend_i32_u(v104)
	v225 = int32(4495784)
	v226 = *(*int64)(unsafe.Add(mBase, _consts[244]))
	*(*int64)(unsafe.Add(mBase, _consts[244])) = v226 + v105
	F_pgstat_count_backend_io_op(m, int32(2), int32(3), int32(6), v104, v105)
	mBase = m.M
	v231 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[245])) = uint8(v231)
	*(*uint8)(unsafe.Add(mBase, _consts[246])) = uint8(v231)
	m.G0 = v111 + int32(16)
	goto L25
L29:
	;
	v174 = int32(4497704)
	v175 = *(*int64)(unsafe.Add(mBase, _consts[247]))
	*(*int64)(unsafe.Add(mBase, _consts[247])) = v175 + v122
...
L41:
	;
	v197 = int32(4494600)
	v198 = *(*int64)(unsafe.Add(mBase, _consts[248]))
	*(*int64)(unsafe.Add(mBase, _consts[248])) = v198 + v122
	v202 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[245])) = uint8(v202)
	*(*uint8)(unsafe.Add(mBase, _consts[249])) = uint8(v202)
	goto L39
L42:
	;
	v242 = *(*int32)(unsafe.Add(mBase, _consts[159]))
...
func F_WALReadRaiseError(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v12
	v16 = int64(*(*int32)(unsafe.Add(mBase, _consts[180])))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v9)+40)) = uint32(v21)
	v29 = F_pg_snprintf(m, v9+int32(48), int32(64), int32(509810), v9+int32(32))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		return
		...
		if int32(0) <= v31 {
				...
				if v64 != 0 {
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(48)
						F_errmsg(m, int32(474468), v9+int32(16))
						mBase = m.M
						v81 = m.ExcPending
						if v81 != 0 {
							return
						} else {
							F_errfinish(m, int32(493655), int32(1032), int32(212470))
							mBase = m.M
							v86 = m.ExcPending
							if v86 != 0 {
								return
			...
			*(*int32)(unsafe.Add(mBase, _consts[159])) = v40
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v45 = m.ExcPending
			if v45 != 0 {
				...
				if v47 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(48)
					F_errmsg(m, int32(295605), v9)
					mBase = m.M
					v55 = m.ExcPending
					if v55 != 0 {
						return
					} else {
						F_errfinish(m, int32(493655), int32(1024), int32(212470))
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return
...
func F_WalRcvForceReply(m *base.Module) {
	...
	var v35 int32
	_ = v35
	v4 = *(*int32)(unsafe.Add(mBase, _consts[692]))
	v5 = int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(v4)+1472)) = v5
	v7 = *(*int32)(unsafe.Add(mBase, uint32(v4)+1456))
	*(*int32)(unsafe.Add(mBase, uint32(v4)+1456)) = v5
	if v7 != 0 {
		v11 = *(*int32)(unsafe.Add(mBase, _consts[692]))
		F_s_lock(m, v11+int32(1456), int32(494918), int32(1356), int32(19454))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v20)+1456)) = int32(0)
			...
			if v23 != int32(-1) {
				v27 = *(*int32)(unsafe.Add(mBase, _consts[157]))
...
func F_WalSndWait(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[727]))
	...
	if v14 != 0 {
		...
		if l2 == int32(100663302) {
			v23 = int32(76)
			v25 = *(*int32)(unsafe.Add(mBase, _consts[686]))
...
func F_assign_wal_consistency_checking(m *base.Module, l0 int32, l1 int32) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _consts[205])) = l1
	return
}
...
L1:
	;
	v107 = *(*int32)(unsafe.Add(mBase, _consts[159]))
	v111 = *(*int32)(unsafe.Add(mBase, _consts[227]))
	v113 = *(*int64)(unsafe.Add(mBase, _consts[228]))
	v115 = *(*int32)(unsafe.Add(mBase, _consts[180]))
...
L3:
	;
	v14 = *(*int32)(unsafe.Add(mBase, _consts[229]))
	if v14 < int32(0) {
		goto L2
	} else {
		goto L4
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = int32(167772239)
	v23 = int32(*(*uint8)(unsafe.Add(mBase, _consts[195])))
	if v23 != int32(1) {
		v37 = int32(0)
		goto L6
	} else {
...
L12:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[193]))
	*(*int32)(unsafe.Add(mBase, uint32(v39))) = int32(0)
	v43 = int32(*(*uint8)(unsafe.Add(mBase, _consts[195])))
	if v43 != int32(1) {
		goto L2
	} else {
		goto L13
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v58
	F_errmsg_internal(m, int32(487777), v8)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L18
...
L20:
	;
	F_errfinish(m, int32(497836), int32(8695), int32(103176))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L18
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l0
	F_errmsg_internal(m, int32(487777), v8+int32(16))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L18
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, _consts[159])) = v107
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v8 + int32(48)
	F_errmsg(m, int32(299420), v8+int32(32))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L18
...
L34:
	;
	F_errfinish(m, int32(497836), int32(8728), int32(422300))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L18
...
L4:
	;
	F_ExplainPropertyInteger(m, int32(171870), int32(0), v10, l0)
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L10
...
L11:
	...
	F_appendStringInfoString(m, v27, int32(547157))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L10
...
L13:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+48)) = v31
	F_appendStringInfo(m, v34, int32(429645), v6+int32(-16))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L10
...
L17:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+32)) = v42
	F_appendStringInfo(m, v45, int32(429692), v6+int32(-32))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L10
...
L21:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+16)) = v53
	F_appendStringInfo(m, v56, int32(37763), v6+int32(-48))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L10
...
L25:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8))) = v64
	F_appendStringInfo(m, v67, int32(429673), v8)
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L10
...
L30:
	...
	F_ExplainPropertyInteger(m, int32(534093), int32(0), v83, l0)
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L10
...
L31:
	...
	F_ExplainPropertyUInteger(m, int32(159723), int32(0), v88, l0)
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L10
...
L32:
	...
	F_ExplainPropertyInteger(m, int32(303689), int32(0), v93, l0)
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L10
