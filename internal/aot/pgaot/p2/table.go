	...
	if v13 != 0 {
		...
		if v15&int32(1) == int32(0) {
			...
			if v34 != 0 {
				...
				F_errmsg_internal(m, int32(336466), int32(0))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
				} else {
					F_errfinish(m, int32(497209), int32(247), int32(432994))
					mBase = m.M
					v43 = m.ExcPending
					if v43 != 0 {
						return
					...
					if v47 != 0 {
						...
						if v50 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v51 | v52<<(uint(int32(16))%32)
							F_errmsg(m, int32(704843), v8)
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return
							} else {
								F_errfinish(m, int32(497209), int32(259), int32(432994))
								mBase = m.M
								v70 = m.ExcPending
								if v70 != 0 {
									return
