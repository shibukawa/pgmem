...
func F_standby_redo(m *base.Module, l0 int32) {
	...
	v12 = v10 - int32(48)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[55]))
	if v15 == int32(0) {
		goto L1
	} else {
		goto L2
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v48))) = v44
	F_errmsg_internal(m, int32(51384), v48)
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L13
...
L21:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _consts[783]))
...
L22:
	;
	F_errfinish(m, int32(515956), int32(1000), int32(333220))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L13
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v48)+32)) = v87
	v90 = *(*int32)(unsafe.Add(mBase, _consts[804]))
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v21
	F_errmsg_internal(m, int32(57207), v12)
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L13
...
L34:
	;
	F_errfinish(m, int32(515956), int32(1219), int32(255098))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L13
