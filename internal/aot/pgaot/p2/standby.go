...
func F_StandbyDeadLockHandler(m *base.Module) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _c_F_StandbyDeadLockHandler[0])) = int32(1)
	return
}
func F_StandbyTimeoutHandler(m *base.Module) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _c_F_StandbyTimeoutHandler[0])) = int32(1)
	return
}
func F_standby_redo(m *base.Module, l0 int32) {
	...
	v12 = v10 - int32(48)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_standby_redo[0]))
	if v15 == int32(0) {
		goto L1
	} else {
		goto L2
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v48))) = v44
	F_errmsg_internal(m, int32(_a_F_standby_redo_0), v48)
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L13
...
L21:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _c_F_standby_redo[1]))
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v48)+32)) = v87
	v90 = *(*int32)(unsafe.Add(mBase, _c_F_standby_redo[2]))
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v21
	F_errmsg_internal(m, int32(_a_F_standby_redo_3), v12)
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L13
