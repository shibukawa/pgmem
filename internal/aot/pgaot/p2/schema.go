...
L19:
	;
	F_errfinish(m, int32(491199), int32(1851), int32(76123))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L9
...
func F_has_schema_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v22 = F_convert_any_priv_string(m, v14, int32(1640816))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					v20 = F_convert_any_priv_string(m, v11, int32(1640816))
					mBase = m.M
					v21 = m.ExcPending
					if v21 != 0 {
						return int32(0)
