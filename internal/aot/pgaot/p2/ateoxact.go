...
L12:
	;
	v17 = *(*int32)(unsafe.Add(mBase, _consts[1162]))
	v18 = v17
	goto L10
L13:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[1163]))
...
L17:
	;
	v45 = *(*int32)(unsafe.Add(mBase, _consts[1164]))
...
L19:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _consts[1162]))
...
L26:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[1163]))
...
L31:
	;
	v90 = *(*int32)(unsafe.Add(mBase, _consts[1164]))
...
func F_AtEOXact_LargeObject(m *base.Module, l0 int32) {
	...
	var v97 int32
	_ = v97
	v8 = int32(*(*uint8)(unsafe.Add(mBase, _consts[469])))
	if v8 != 0 {
		goto L1
	} else {
		goto L2
...
L4:
	;
	v52 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[467])) = v52
	*(*int32)(unsafe.Add(mBase, _consts[468])) = v52
	v58 = *(*int32)(unsafe.Add(mBase, _consts[470]))
	if v58 != 0 {
		goto L19
	} else {
		goto L20
...
L5:
	;
	v12 = *(*int32)(unsafe.Add(mBase, _consts[467]))
	if v12 <= int32(0) {
		goto L4
	} else {
		goto L6
...
L6:
	;
	v16 = *(*int32)(unsafe.Add(mBase, _consts[468]))
	v18 = v12
	v19 = int32(0)
	v20 = v16
	goto L7
...
L12:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[405]))
...
L17:
	...
	v39 = *(*int32)(unsafe.Add(mBase, _consts[467]))
	v40 = v39
	v41 = v37
	goto L11
L18:
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, _consts[470])) = int32(0)
	v65 = *(*int32)(unsafe.Add(mBase, _consts[471]))
	v67 = *(*int32)(unsafe.Add(mBase, _consts[472]))
	if v65|v67 != 0 {
		goto L23
	} else {
		goto L24
...
L25:
	;
	v97 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[469])) = uint8(v97)
	goto L3
L26:
	;
	v69 = int32(4562148)
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, _consts[471])) = v89
	goto L25
L29:
	;
...
L32:
	;
	v79 = *(*int32)(unsafe.Add(mBase, _consts[471]))
	v80 = v79
	goto L31
L33:
	;
