...
L4:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1155])) = int32(0)
	goto L3
L5:
	;
...
L12:
	;
	v17 = *(*int32)(unsafe.Add(mBase, _consts[1155]))
	v18 = v17
	goto L10
L13:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[1156]))
...
L19:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _consts[1155]))
...
L26:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[1156]))
