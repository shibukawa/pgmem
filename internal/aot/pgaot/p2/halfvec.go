	...
	if v13 != 0 {
		...
		if v16 != 0 {
			...
			if v17 != v18 {
				...
				if v23 != 0 {
					...
					if v26 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v27
						F_errmsg(m, int32(_a_F_halfvec_inner_product_0), v7)
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_halfvec_inner_product_1), int32(80), int32(_a_F_halfvec_inner_product_2))
							mBase = m.M
							v38 = m.ExcPending
							if v38 != 0 {
								return int32(0)
				...
				v40 = int32(8)
				v45 = *(*int32)(unsafe.Add(mBase, _c_F_halfvec_inner_product[0]))
...
L14:
	...
	v63 = int32(_a_F_halfvec_to_sparsevec_0)
	v65 = int32(0)
	...
	v87 = v45 + v86
	v89 = v47 + v86
	if v89 != v25&int32(_a_F_halfvec_to_sparsevec_1) {
		v45 = v87
		v46 = v85
		v47 = v89
		goto L14
...
L18:
	...
	v129 = v108 + base.B2i32(v124&int32(_a_F_halfvec_to_sparsevec_0) != int32(0))
	v133 = v110 + v121
	if v133 != v37 {
		v107 = v107 + v121
		v108 = v129
...
L31:
	...
	if v197&int32(_a_F_halfvec_to_sparsevec_0) != 0 {
		goto L33
	} else {
		goto L34
	}
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v24
	F_errmsg(m, int32(_a_F_halfvec_to_sparsevec_5), v17)
	mBase = m.M
	v347 = m.ExcPending
	if v347 != 0 {
		goto L1
