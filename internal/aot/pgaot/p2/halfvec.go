	...
	if v13 != 0 {
		...
		if v16 != 0 {
			...
			if v17 != v18 {
				...
				v40 = int32(8)
				v45 = *(*int32)(unsafe.Add(mBase, _consts[1469]))
...
L27:
	;
	F_errfinish(m, int32(526349), int32(390), int32(38316))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L1
...
L81:
	;
	F_errfinish(m, int32(526480), int32(676), int32(515828))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L1
