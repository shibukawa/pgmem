...
func F_btree_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0, 1:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v26
		F_appendStringInfo(m, l0, int32(454059), v12+int32(16))
		mBase = m.M
		v38 = m.ExcPending
		if v38 != 0 {
			return
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12))) = v21
		F_appendStringInfo(m, l0, int32(55497), v12)
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return
	...
	case 3:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v39
		F_appendStringInfo(m, l0, int32(54809), v12+int32(32))
		mBase = m.M
		v45 = m.ExcPending
		if v45 != 0 {
			return
	...
	case 4:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+76)) = v102
		F_appendStringInfo(m, l0, int32(471572), v12-int32(-64))
		mBase = m.M
		v108 = m.ExcPending
		if v108 != 0 {
			return
	...
	case 5, 6:
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v12)+124)) = uint32(v165)
		F_appendStringInfo(m, l0, int32(695094), v12+int32(112))
		mBase = m.M
		v171 = m.ExcPending
		if v171 != 0 {
			return
			...
			*(*int64)(unsafe.Add(mBase, uint32(v12)+96)) = v172
			F_appendStringInfo(m, l0, int32(54351), v12+int32(96))
			mBase = m.M
			v180 = m.ExcPending
			if v180 != 0 {
				return
	...
	case 7:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+144)) = v181
		F_appendStringInfo(m, l0, int32(55282), v12+int32(144))
		mBase = m.M
		v187 = m.ExcPending
		if v187 != 0 {
			return
	...
	case 8:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+80)) = v147
		F_appendStringInfo(m, l0, int32(54398), v12+int32(80))
		mBase = m.M
		v157 = m.ExcPending
		if v157 != 0 {
			return
	...
	case 9:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v46
		F_appendStringInfo(m, l0, int32(55844), v12+int32(48))
		mBase = m.M
		v54 = m.ExcPending
		if v54 != 0 {
			return
	...
	case 10:
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v12)+172)) = uint32(v200)
		F_appendStringInfo(m, l0, int32(471420), v12+int32(160))
		mBase = m.M
		v206 = m.ExcPending
		if v206 != 0 {
			return
	...
	case 11:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+192)) = v237
		F_appendStringInfo(m, l0, int32(54877), v12+int32(192))
		mBase = m.M
		v243 = m.ExcPending
		if v243 != 0 {
			return
