...
func F_GetDatabaseEncoding(m *base.Module) int32 {
	...
	var v3 int32
	_ = v3
	v2 = *(*int32)(unsafe.Add(mBase, _c_F_GetDatabaseEncoding[0]))
...
func F_SetDatabasePath(m *base.Module, l0 int32) {
	...
	var v6 int32
	_ = v6
	v4 = *(*int32)(unsafe.Add(mBase, _c_F_SetDatabasePath[0]))
	...
	if v6 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_SetDatabasePath[1])) = v5
		return
	}
}
...
L4:
	;
	F_appendStringInfoString(m, v17, int32(_a_F_database_to_xmlschema_0))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v11
	F_appendStringInfo(m, v17, int32(_a_F_database_to_xmlschema_1), v15)
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L8:
	;
	F_appendStringInfoString(m, v17, int32(_a_F_database_to_xmlschema_2))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L11:
	;
	v34 = F_query_to_oid_list(m, int32(_a_F_database_to_xmlschema_3))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L12:
	;
	v37 = F_query_to_oid_list(m, int32(_a_F_database_to_xmlschema_4))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L1
...
L25:
	...
	v81 = v79 - int32(16)
	m.G0 = v81
	v84 = *(*int32)(unsafe.Add(mBase, _c_F_database_to_xmlschema[0]))
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v22 != 0 {
			...
			v24 = F_convert_any_priv_string(m, v14, int32(_a_F_has_database_privilege_name_id_0))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
