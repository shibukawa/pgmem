...
L4:
	;
	F_appendStringInfoString(m, v17, int32(729755))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v11
	F_appendStringInfo(m, v17, int32(729343), v15)
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L8:
	;
	F_appendStringInfoString(m, v17, int32(757060))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L11:
	;
	v34 = F_query_to_oid_list(m, int32(546649))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L12:
	;
	v37 = F_query_to_oid_list(m, int32(546312))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L1
