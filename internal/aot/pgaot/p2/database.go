...
func F_SetDatabasePath(m *base.Module, l0 int32) {
	...
	if v6 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[1180])) = v5
		return
	}
}
...
L4:
	;
	F_appendStringInfoString(m, v17, int32(757826))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v11
	F_appendStringInfo(m, v17, int32(757414), v15)
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L8:
	;
	F_appendStringInfoString(m, v17, int32(785131))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L11:
	;
	v34 = F_query_to_oid_list(m, int32(567989))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L12:
	;
	v37 = F_query_to_oid_list(m, int32(567652))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L1
		...
		if v11 != 0 {
			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					v21 = F_convert_any_priv_string(m, v10, int32(1685584))
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return int32(0)
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v22 != 0 {
			...
			v24 = F_convert_any_priv_string(m, v14, int32(1685584))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
