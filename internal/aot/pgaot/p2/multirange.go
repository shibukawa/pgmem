	...
	if v13 != 0 {
		...
		if v15 != 0 {
			...
			if v16 == v10 {
				...
				v19 = F_lookup_type_cache(m, v10, int32(_a_F_multirange_constructor1_4))
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					return int32(0)
	...
	if v15 != 0 {
		...
		if v19 != 0 {
			...
			if v20 == v17 {
				...
				v23 = F_lookup_type_cache(m, v17, int32(_a_F_multirange_contains_elem_0))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L8:
	;
	v29 = F_lookup_type_cache(m, v23, int32(_a_F_multirange_intersect_0))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L1
