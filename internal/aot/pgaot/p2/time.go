...
L9:
	;
	v28 = F_RestoreArchivedFile(m, v6+int32(80), v6+int32(16), int32(476957), int64(0), int32(0))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L8
				...
				if v20 != int64(9223372036854775807) {
					...
					if v32 != 0 {
						...
						if v35 != 0 {
							...
							F_errmsg(m, int32(353035), int32(0))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(467998), int32(2126), int32(290140))
								mBase = m.M
								v44 = m.ExcPending
								if v44 != 0 {
									return int32(0)
