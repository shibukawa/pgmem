...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v9
	v19 = F_pg_snprintf(m, v6+int32(16), int32(64), int32(12864), v6)
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L8
...
L9:
	;
	v28 = F_RestoreArchivedFile(m, v6+int32(80), v6+int32(16), int32(508431), int64(0), int32(0))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L8
				...
				if v20 != int64(9223372036854775807) {
					...
					if v32 != 0 {
						...
						if v35 != 0 {
							...
							F_errmsg(m, int32(375588), int32(0))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(498487), int32(2126), int32(309069))
								mBase = m.M
								v44 = m.ExcPending
								if v44 != 0 {
									return int32(0)
...
func F_time_scale(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v7) <= base.Ui32(int32(6)) {
		...
		v14 = *(*int64)(unsafe.Add(mBase, uint32(v11)+uint32(_consts[438])))
		v17 = *(*int64)(unsafe.Add(mBase, uint32(v11)+uint32(_consts[439])))
		if int64(0) <= v6 {
			v20 = v6 + v17
