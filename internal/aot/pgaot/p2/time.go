...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v9
	v19 = F_pg_snprintf(m, v6+int32(16), int32(64), int32(12851), v6)
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L8
...
L9:
	;
	v28 = F_RestoreArchivedFile(m, v6+int32(80), v6+int32(16), int32(506735), int64(0), int32(0))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L8
				...
				if v20 != int64(9223372036854775807) {
					...
					if v32 != 0 {
						...
						if v35 != 0 {
							...
							F_errmsg(m, int32(374564), int32(0))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(496845), int32(2126), int32(308283))
								mBase = m.M
								v44 = m.ExcPending
								if v44 != 0 {
									return int32(0)
