...
L13:
	;
	v42 = int32(1)
	v47 = F_systable_beginscan(m, l0, l1, v42, int32(4114688), v42, v13+int32(48))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L10
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v58 + int32(4)
	F_errmsg(m, int32(664762), v13+int32(32))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L10
...
L24:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v13)+16)) = v25
	F_errdetail_plural(m, int32(541876), int32(541793), base.I32_wrap_i64(v25), v13+int32(16))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L10
...
L25:
	;
	F_errfinish(m, int32(475051), int32(509), int32(27111))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L10
...
L33:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v13)+8)) = v90
	F_errmsg_plural(m, int32(11594), int32(158026), base.I32_wrap_i64(v90), v13)
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L10
...
L34:
	;
	F_errfinish(m, int32(475051), int32(534), int32(27111))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L10
			...
			if v32 == int32(1) {
				...
				if v38 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = v39
					F_errmsg_internal(m, int32(508732), v5)
					mBase = m.M
					v43 = m.ExcPending
					if v43 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(472279), int32(1123), int32(289289))
						mBase = m.M
						v48 = m.ExcPending
						if v48 != 0 {
							return int32(0)
			...
			if v40 == int32(1) {
				...
				if v46 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v47
					F_errmsg_internal(m, int32(508732), v8)
					mBase = m.M
					v51 = m.ExcPending
					if v51 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(472279), int32(1165), int32(289247))
						mBase = m.M
						v56 = m.ExcPending
						if v56 != 0 {
							return int32(0)
