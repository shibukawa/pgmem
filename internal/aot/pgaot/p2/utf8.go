...
L145:
	;
	F_errfinish(m, int32(490308), int32(107), int32(63397))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L4
...
L149:
	;
	F_errfinish(m, int32(490308), int32(169), int32(63397))
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L4
...
L153:
	;
	F_errfinish(m, int32(490308), int32(237), int32(63397))
	mBase = m.M
	v487 = m.ExcPending
	if v487 != 0 {
		goto L4
...
func F_utf8_to_euc_jp(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_UtfToLocal(m, v6, v10, v5, int32(4356804), v18, v18, v18, int32(1), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
