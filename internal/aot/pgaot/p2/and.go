...
func F_SortAndUniqItems(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v16 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l1))) = v19
		...
		v54 = int32(2)
		v55 = (v47 - v13) >> (uint(v54) % 32)
		*(*int32)(unsafe.Add(mBase, uint32(l1))) = v55
		if v54 <= v55 {
			v63 = v22 + v9*int32(12)
			F_qsort_arg(m, v13, v55, int32(4), int32(1516), v63)
			mBase = m.M
			v65 = m.ExcPending
			if v65 != 0 {
				return int32(0)
				...
				if int32(2) <= v66 {
					...
					for {
						...
						if v118 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v73)+4)) = v119
							v123 = v73 + int32(4)
						} else {
							v123 = v73
						}
				...
				*(*int32)(unsafe.Add(mBase, uint32(l1))) = (v133 - v13 + int32(4)) >> (uint(int32(2)) % 32)
				return v13
			}
		} else {
			return v13
