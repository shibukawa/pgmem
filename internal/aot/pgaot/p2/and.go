							...
							if v46 != 0 {
								...
								if v50 != 0 {
									...
									if v53 != 0 {
										...
										F_errmsg(m, int32(420353), int32(0))
										mBase = m.M
										v57 = m.ExcPending
										if v57 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(477261), int32(84), int32(360682))
											mBase = m.M
											v62 = m.ExcPending
											if v62 != 0 {
												return int32(0)
					...
					if v79&int32(1) != 0 {
						...
						if v85 != 0 {
							...
							if v88 != 0 {
								...
								F_errmsg(m, int32(12294), int32(0))
								mBase = m.M
								v92 = m.ExcPending
								if v92 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(477261), int32(89), int32(360682))
									mBase = m.M
									v97 = m.ExcPending
									if v97 != 0 {
										return int32(0)
