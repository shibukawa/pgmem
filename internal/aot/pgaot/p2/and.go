...
func F_convert_and_check_filename(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		mBase = m.M
		v9 = *(*int32)(unsafe.Add(mBase, _consts[276]))
		...
		if v12 != 0 {
			...
			if v11 != 0 {
				...
				if v13 == int32(47) {
					v17 = *(*int32)(unsafe.Add(mBase, _consts[200]))
					v19 = F_strlen(m, v17)
					mBase = m.M
							...
							if v46 != 0 {
								...
								if v50 != 0 {
									...
									if v53 != 0 {
										...
										F_errmsg(m, int32(438297), int32(0))
										mBase = m.M
										v57 = m.ExcPending
										if v57 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(497167), int32(84), int32(376876))
											mBase = m.M
											v62 = m.ExcPending
											if v62 != 0 {
												return int32(0)
					...
					if v79&int32(1) != 0 {
						...
						if v85 != 0 {
							...
							if v88 != 0 {
								...
								F_errmsg(m, int32(13295), int32(0))
								mBase = m.M
								v92 = m.ExcPending
								if v92 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(497167), int32(89), int32(376876))
									mBase = m.M
									v97 = m.ExcPending
									if v97 != 0 {
										return int32(0)
