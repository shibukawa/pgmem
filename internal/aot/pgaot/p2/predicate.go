...
func F_CreatePredicateLock(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v10 = v8 - int32(32)
	m.G0 = v10
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_CreatePredicateLock[0]))
	...
	if v18 != 0 {
		...
		v25 = v13 + l1&int32(15)<<(uint(int32(7))%32) + int32(_a_F_CreatePredicateLock_0)
		v30 = *(*int32)(unsafe.Add(mBase, _c_F_CreatePredicateLock[1]))
		...
		if v33&int32(1) != 0 {
			...
			if v40 != 0 {
				...
				if v43 != 0 {
					...
					v45 = *(*int32)(unsafe.Add(mBase, _c_F_CreatePredicateLock[2]))
					...
					if v50 != 0 {
						...
						if v49 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = l2
							v62 = *(*int32)(unsafe.Add(mBase, _c_F_CreatePredicateLock[3]))
							...
							if v72 != 0 {
								...
								if v71 == int32(0) {
									...
									if v160 != 0 {
										...
										if v163 != 0 {
											...
											if v167 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(_a_F_CreatePredicateLock_3)
												F_errhint(m, int32(_a_F_CreatePredicateLock_4), v10+int32(16))
												mBase = m.M
												v174 = m.ExcPending
												if v174 != 0 {
													return
									...
									if v112 != 0 {
										...
										v117 = *(*int32)(unsafe.Add(mBase, _c_F_CreatePredicateLock[1]))
										...
										if v120&int32(1) != 0 {
											...
											if v126 != 0 {
												...
												v128 = *(*int32)(unsafe.Add(mBase, _c_F_CreatePredicateLock[0]))
							...
							if v139 != 0 {
								...
								if v142 != 0 {
									...
									if v146 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(_a_F_CreatePredicateLock_3)
										F_errhint(m, int32(_a_F_CreatePredicateLock_4), v10)
										mBase = m.M
										v151 = m.ExcPending
										if v151 != 0 {
											return
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[0])) = int32(0)
	goto L1
L3:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L4:
	;
	v46 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
	if v46 == int32(0) {
		goto L1
	} else {
		goto L13
...
L5:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[3]))
	if int32(0) <= v20 {
		goto L6
	} else {
		goto L7
...
L6:
	;
	v24 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[4])) = uint8(v24)
	*(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2])) = v24
	v30 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[0]))
	if v30 == v24 {
		goto L1
	} else {
		goto L9
...
L8:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[5]))
	if v36 == int32(0) {
		goto L4
	} else {
		goto L12
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2])) = v36
...
L15:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
...
L18:
	;
	v118 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[6]))
...
L19:
	;
	v68 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
	v115 = v68
	v116 = v3
	goto L18
L20:
...
L21:
	;
	v73 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[7]))
...
L22:
	;
	v80 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
...
L26:
	;
	v84 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[3]))
	if v84 < int32(0) {
		goto L27
	} else {
		goto L28
...
L27:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[5])) = v80
	goto L29
L28:
	;
	goto L29
...
L30:
	;
	v93 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L33:
	;
	v99 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[4])) = uint8(v99)
	*(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2])) = v99
	v105 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[0]))
	if v105 == v99 {
		goto L1
	} else {
		goto L34
...
L38:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v115)+16)) = v131
	v135 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[4])))
	if v135 != 0 {
		goto L36
	} else {
		goto L41
...
L43:
	;
	v152 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[8]))
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v189))) = v191
	v194 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[9]))
...
L50:
	;
	v207 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
	v210 = v207
	goto L42
L51:
	;
...
L62:
	;
	v321 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
	v324 = v321
	goto L58
L63:
	;
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v299))) = v301
	v304 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[9]))
...
L65:
	;
	v259 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
...
L74:
	...
	v286 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[8]))
...
L84:
	;
	v393 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
	v396 = v393
	goto L80
L85:
	;
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v372))) = v374
	v377 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[9]))
...
L99:
	;
	v558 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
	v561 = v558
	goto L94
L100:
	;
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v504))) = v506
	v509 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[9]))
...
L102:
	;
	v433 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[4])))
	if v433 == int32(0) {
		goto L101
	} else {
		goto L103
...
L103:
	;
	v437 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v480))) = v482
	v485 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[9]))
...
L126:
	;
	v771 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L129:
	...
	v583 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[8]))
...
L133:
	;
	v749 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
	F_LWLockRelease(m, v749+int32(_a_F_ReleasePredicateLocks_0))
	mBase = m.M
	v753 = m.ExcPending
	if v753 != 0 {
		goto L10
...
L134:
	;
	v697 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[10])))
	if v697 == int32(1) {
		goto L161
	} else {
		goto L162
...
L135:
	;
	v692 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[11]))
	*(*int64)(unsafe.Add(mBase, uint32(v692)+8)) = int64(0)
	goto L133
L136:
	;
	v605 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[12]))
	v606 = v592
	v608 = v583
	v609 = v605
	goto L142
...
L139:
	;
	v598 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
	v602 = F_LWLockAcquire(m, v598+int32(_a_F_ReleasePredicateLocks_0), int32(0))
	mBase = m.M
	v603 = m.ExcPending
	if v603 != 0 {
		goto L10
...
L143:
	...
	v671 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
	v675 = F_LWLockAcquire(m, v671+int32(_a_F_ReleasePredicateLocks_0), int32(0))
	mBase = m.M
	v676 = m.ExcPending
	if v676 != 0 {
		goto L10
...
L151:
	;
	v643 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[8]))
	v645 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[12]))
	if v641 == int32(0) {
		goto L147
	} else {
		goto L155
...
L160:
	;
	v709 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[11]))
	if v707 == int32(0) {
		v731 = v709
		goto L164
	} else {
...
L161:
	;
	v702 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[13]))
	v703 = *(*int32)(unsafe.Add(mBase, uint32(v702)+316))
	v705 = base.B2i32(v703 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[10])) = uint8(v705)
	v707 = v705
	goto L163
L162:
	;
...
L171:
	;
	v730 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[11]))
	v731 = v730
	goto L164
L172:
	;
...
L173:
	;
	v777 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L175:
	;
	v820 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L176:
	;
	v784 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
	v786 = v784 + int32(56)
	v788 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[14]))
...
L178:
	;
	v800 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2]))
	if l1 != 0 {
		goto L182
	} else {
		goto L183
...
L182:
	;
	v805 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[7]))
...
L191:
	;
	v826 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L193:
	;
	v1130 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[4])) = uint8(v1130)
	*(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[2])) = v1130
	v1136 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[0]))
	if v1136 == v1130 {
		goto L1
	} else {
		goto L248
...
L194:
	;
	v833 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L195:
	;
	v840 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[14]))
...
L196:
	;
	v959 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L199:
	...
	v863 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[8]))
...
L201:
	;
	v937 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L205:
	;
	v881 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L214:
	;
	v907 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L219:
	;
	v929 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[8]))
...
L222:
	;
	v965 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L223:
	;
	v972 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[12]))
...
L224:
	;
	v1104 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L227:
	...
	v995 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L229:
	...
	v1003 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[8]))
	v1004 = *(*int64)(unsafe.Add(mBase, uint32(v1003)+40))
	v1006 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
...
L231:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v17)+8)) = v1019
	v1022 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[15]))
...
L234:
	;
	v1028 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
	v1035 = v1028 + v1025&int32(15)<<(uint(int32(7))%32) + int32(_a_F_ReleasePredicateLocks_1)
...
L235:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1049))) = v1051
	v1054 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[16]))
...
L240:
	;
	v1074 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[15]))
...
L246:
	;
	v1110 = *(*int32)(unsafe.Add(mBase, _c_F_ReleasePredicateLocks[1]))
