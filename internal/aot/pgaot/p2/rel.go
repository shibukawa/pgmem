		...
		if int32(0) <= v17 {
			...
			if v23 != int32(1) {
				...
				default:
					...
					return v106
				case 36, 41:
					v90 = F_build_reloptions(m, v62, int32(0), int32(1), int32(128), int32(715520), int32(24))
					mBase = m.M
					v91 = m.ExcPending
					if v91 != 0 {
						return int32(0)
				...
				case 43:
					v75 = F_build_reloptions(m, v62, int32(0), int32(2), int32(128), int32(715520), int32(24))
					mBase = m.M
					v76 = m.ExcPending
					if v76 != 0 {
						return int32(0)
				...
				case 45:
					v97 = F_build_reloptions(m, v62, int32(0), int32(512), int32(12), int32(715904), int32(3))
					mBase = m.M
					v98 = m.ExcPending
					if v98 != 0 {
						return int32(0)
