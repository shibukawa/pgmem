	...
	if v4 == v2 {
		...
		if v8-int32(2) <= v7 {
			...
			if v16 != int32(114) {
				...
				v21 = F_find_among_b(m, l0, int32(4425968), int32(2))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L4:
	;
	v27 = F_find_among_b(m, l0, int32(4426592), int32(10))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L5
...
L29:
	;
	v140 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v134)>>(uint(int32(3))%32)))+uint32(_consts[1343]))))
...
L51:
	;
	v271 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v265)>>(uint(int32(3))%32)))+uint32(_consts[1336]))))
...
L74:
	;
	v410 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v404)>>(uint(int32(3))%32)))+uint32(_consts[1343]))))
...
L117:
	;
	v600 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v594)>>(uint(int32(3))%32)))+uint32(_consts[1336]))))
