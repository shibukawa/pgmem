...
func F_pg_advisory_xact_lock_shared_int4(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v9
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_pg_advisory_xact_lock_shared_int4[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v15
	v20 = F_LockAcquire(m, v6, int32(5), v2, v2)
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		return int32(0)
...
func F_pg_advisory_xact_lock_shared_int8(m *base.Module, l0 int32) int32 {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v6)+4)) = uint32(v14)
	v17 = *(*int32)(unsafe.Add(mBase, _c_F_pg_advisory_xact_lock_shared_int8[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v17
	v22 = F_LockAcquire(m, v6, int32(5), v2, v2)
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		return int32(0)
...
func F_pg_try_advisory_xact_lock_shared_int4(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+8)) = v8
	*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v9
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_pg_try_advisory_xact_lock_shared_int4[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v15
	v20 = F_LockAcquire(m, v6, int32(5), int32(0), int32(1))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		return int32(0)
...
func F_pg_try_advisory_xact_lock_shared_int8(m *base.Module, l0 int32) int32 {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v6)+8)) = uint32(v9)
	v14 = int64(base.Ui64(v9) >> (uint(int64(32)) % 64))
	*(*uint32)(unsafe.Add(mBase, uint32(v6)+4)) = uint32(v14)
	v17 = *(*int32)(unsafe.Add(mBase, _c_F_pg_try_advisory_xact_lock_shared_int8[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v17
	v22 = F_LockAcquire(m, v6, int32(5), int32(0), int32(1))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		return int32(0)
