		...
		if v5 != 0 {
			...
			if v6 != 0 {
				...
				if v8 != 0 {
					...
					if v9 == int32(1) {
						v13 = *(*int32)(unsafe.Add(mBase, _c_F_pa_free_worker_info[0]))
						...
						if v18 != 0 {
							...
							if v19 != 0 {
								...
								if v21 != 0 {
									...
									v22 = int32(_a_F_pa_free_worker_info_0)
									v24 = *(*int32)(unsafe.Add(mBase, _c_F_pa_free_worker_info[1]))
									...
									if v26 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, _c_F_pa_free_worker_info[1])) = v25
										F_pfree(m, l0)
										mBase = m.M
										v29 = m.ExcPending
										if v29 != 0 {
