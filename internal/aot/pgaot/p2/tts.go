		...
		if v6&int32(4) != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+44)) = v14
			...
			if v24 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_tts_buffer_heap_get_heap_tuple[0])) = v10
				v32 = v21
				return v32
			}
		}
			...
			*(*uint16)(unsafe.Add(mBase, uint32(l0)+6)) = uint16(v14)
			...
			if v24 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(l0)+40)) = v21
				...
				v28 = v26 | int32(4)
				*(*uint16)(unsafe.Add(mBase, uint32(l0)+4)) = uint16(v28)
				*(*int32)(unsafe.Add(mBase, _c_F_tts_heap_copy_heap_tuple[0])) = v10
				v32 = v21
				v34 = F_heap_copytuple(m, v32)
				mBase = m.M
				v35 = m.ExcPending
		...
		*(*uint16)(unsafe.Add(mBase, uint32(l0)+6)) = uint16(v14)
		...
		if v18 == v14 {
			...
			if v25 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_tts_heap_materialize[0])) = v10
				return
			}
		} else {
