...
func F_get_object_attnum_namespace(m *base.Module, l0 int32) int32 {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _c_F_get_object_attnum_namespace[0]))
	if v10 != 0 {
		goto L3
	} else {
		goto L4
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_get_object_attnum_namespace[0])) = v61
	v64 = v61
	goto L2
L8:
	;
	v19 = v16 * int32(40)
	v22 = *(*int32)(unsafe.Add(mBase, uint32(v19)+uint32(_c_F_get_object_attnum_namespace[1])))
	if l0 != v22 {
		goto L10
	} else {
		goto L11
...
L9:
	;
	v61 = v19 + int32(_a_F_get_object_attnum_namespace_0)
	goto L7
L10:
	;
	if v16 == int32(36) {
...
L13:
	...
	v32 = *(*int32)(unsafe.Add(mBase, uint32(v29)+uint32(_c_F_get_object_attnum_namespace[1])))
	if l0 == v32 {
		goto L14
	} else {
		goto L15
...
L14:
	;
	v61 = v29 + int32(_a_F_get_object_attnum_namespace_0)
	goto L7
L15:
	;
	goto L16
L16:
	...
	v42 = *(*int32)(unsafe.Add(mBase, uint32(v39)+uint32(_c_F_get_object_attnum_namespace[1])))
	if l0 == v42 {
		goto L17
	} else {
		goto L18
...
L17:
	;
	v61 = v39 + int32(_a_F_get_object_attnum_namespace_0)
	goto L7
L18:
	;
	goto L19
L19:
	...
	v52 = *(*int32)(unsafe.Add(mBase, uint32(v49)+uint32(_c_F_get_object_attnum_namespace[1])))
	if l0 == v52 {
		goto L20
	} else {
		goto L21
...
L20:
	;
	v61 = v49 + int32(_a_F_get_object_attnum_namespace_0)
	goto L7
L21:
	;
	v16 = v16 + int32(4)
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
	F_errmsg_internal(m, int32(_a_F_get_object_attnum_namespace_1), v7)
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L23
...
L25:
	;
	F_errfinish(m, int32(_a_F_get_object_attnum_namespace_2), int32(2777), int32(_a_F_get_object_attnum_namespace_3))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L23
...
func F_get_object_attnum_owner(m *base.Module, l0 int32) int32 {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _c_F_get_object_attnum_owner[0]))
	if v10 != 0 {
		goto L3
	} else {
		goto L4
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_get_object_attnum_owner[0])) = v61
	v64 = v61
	goto L2
L8:
	;
	v19 = v16 * int32(40)
	v22 = *(*int32)(unsafe.Add(mBase, uint32(v19)+uint32(_c_F_get_object_attnum_owner[1])))
	if l0 != v22 {
		goto L10
	} else {
		goto L11
...
L9:
	;
	v61 = v19 + int32(_a_F_get_object_attnum_owner_0)
	goto L7
L10:
	;
	if v16 == int32(36) {
...
L13:
	;
	v29 = (v16 | int32(1)) * int32(40)
	v32 = *(*int32)(unsafe.Add(mBase, uint32(v29)+uint32(_c_F_get_object_attnum_owner[1])))
	if l0 == v32 {
		goto L14
	} else {
		goto L15
...
L14:
	;
	v61 = v29 + int32(_a_F_get_object_attnum_owner_0)
	goto L7
L15:
	;
	goto L16
L16:
	;
	v39 = (v16 | int32(2)) * int32(40)
	v42 = *(*int32)(unsafe.Add(mBase, uint32(v39)+uint32(_c_F_get_object_attnum_owner[1])))
	if l0 == v42 {
		goto L17
	} else {
		goto L18
...
L17:
	;
	v61 = v39 + int32(_a_F_get_object_attnum_owner_0)
	goto L7
L18:
	;
	goto L19
L19:
	;
	v49 = (v16 | int32(3)) * int32(40)
	v52 = *(*int32)(unsafe.Add(mBase, uint32(v49)+uint32(_c_F_get_object_attnum_owner[1])))
	if l0 == v52 {
		goto L20
	} else {
		goto L21
...
L20:
	;
	v61 = v49 + int32(_a_F_get_object_attnum_owner_0)
	goto L7
L21:
	;
	v16 = v16 + int32(4)
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
	F_errmsg_internal(m, int32(_a_F_get_object_attnum_owner_1), v7)
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L23
...
L25:
	;
	F_errfinish(m, int32(_a_F_get_object_attnum_owner_2), int32(2777), int32(_a_F_get_object_attnum_owner_3))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L23
