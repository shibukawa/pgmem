...
L1:
	;
	v103 = *(*int32)(unsafe.Add(mBase, _consts[684]))
...
L8:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[686]))
...
L26:
	...
	v85 = int32(1)
	v88 = v30 + v85
	v90 = *(*int32)(unsafe.Add(mBase, _consts[686]))
...
L34:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[684]))
	F_s_lock(m, v110+int32(76), int32(494140), int32(456), int32(336475))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L37
...
L36:
	;
	v119 = *(*int32)(unsafe.Add(mBase, _consts[684]))
	v120 = int32(0)
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v99
	v131 = *(*int32)(unsafe.Add(mBase, _consts[687]))
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v131
	F_errmsg_internal(m, int32(465612), v7)
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L37
...
L41:
	;
	F_errfinish(m, int32(494140), int32(462), int32(336475))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L37
