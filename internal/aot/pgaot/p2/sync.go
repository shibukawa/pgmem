...
L1:
	;
	v159 = *(*int32)(unsafe.Add(mBase, _c_F_SyncRepInitConfig[1]))
...
L8:
	;
	v151 = *(*int32)(unsafe.Add(mBase, _c_F_SyncRepInitConfig[3]))
...
L28:
	...
	v141 = int32(1)
	v144 = v30 + v141
	v146 = *(*int32)(unsafe.Add(mBase, _c_F_SyncRepInitConfig[3]))
...
L51:
	;
	v166 = *(*int32)(unsafe.Add(mBase, _c_F_SyncRepInitConfig[1]))
	F_s_lock(m, v166+int32(76), int32(_a_F_SyncRepInitConfig_0), int32(456), int32(_a_F_SyncRepInitConfig_1))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L54
...
L53:
	;
	v175 = *(*int32)(unsafe.Add(mBase, _c_F_SyncRepInitConfig[1]))
	v176 = int32(0)
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v155
	v187 = *(*int32)(unsafe.Add(mBase, _c_F_SyncRepInitConfig[4]))
