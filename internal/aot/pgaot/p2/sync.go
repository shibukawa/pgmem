...
func F_SyncRepInitConfig(m *base.Module) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = int32(*(*uint8)(unsafe.Add(mBase, _consts[687])))
	if v10 != 0 {
		v99 = v1
		goto L1
	} else {
...
L1:
	;
	v103 = *(*int32)(unsafe.Add(mBase, _consts[688]))
...
L2:
	;
	v12 = *(*int32)(unsafe.Add(mBase, _consts[689]))
	if v12 == int32(0) {
		v99 = v1
		goto L1
	} else {
...
L4:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[690]))
	if v19 == int32(0) {
		v99 = v1
		goto L1
	} else {
...
L7:
	;
	v33 = *(*int32)(unsafe.Add(mBase, _consts[691]))
	v36 = v28
	v37 = v33
	goto L11
L8:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[690]))
...
L26:
	...
	v85 = int32(1)
	v88 = v30 + v85
	v90 = *(*int32)(unsafe.Add(mBase, _consts[690]))
...
L34:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[688]))
	F_s_lock(m, v110+int32(76), int32(521269), int32(456), int32(355244))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L37
...
L36:
	;
	v119 = *(*int32)(unsafe.Add(mBase, _consts[688]))
	v120 = int32(0)
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v99
	v131 = *(*int32)(unsafe.Add(mBase, _consts[691]))
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v131
	F_errmsg_internal(m, int32(489864), v7)
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L37
...
L41:
	;
	F_errfinish(m, int32(521269), int32(462), int32(355244))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L37
