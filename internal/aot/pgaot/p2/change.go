...
func F_ChangeToDataDir(m *base.Module) {
	...
	v4 = v2 - int32(16)
	m.G0 = v4
	v7 = *(*int32)(unsafe.Add(mBase, _consts[200]))
	v8 = m.Env.X__syscall_chdir(m, v7)
	mBase = m.M
	if base.Ui32(int32(-4095)) <= base.Ui32(v8) {
		*(*int32)(unsafe.Add(mBase, _consts[155])) = int32(0) - v8
		v16 = int32(-1)
	} else {
		v16 = v8
	}
		...
		if v22 != 0 {
			...
			if v24 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v4))) = v26
				F_errmsg(m, int32(292883), v4)
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return
				} else {
					F_errfinish(m, int32(485631), int32(468), int32(210918))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return
...
L35:
	;
	F_errfinish(m, int32(491924), int32(650), int32(281310))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
