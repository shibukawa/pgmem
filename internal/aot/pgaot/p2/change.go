		...
		if v22 != 0 {
			...
			if v24 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v4))) = v26
				F_errmsg(m, int32(312129), v4)
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return
				} else {
					F_errfinish(m, int32(517884), int32(468), int32(225137))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return
...
L35:
	;
	F_errfinish(m, int32(525530), int32(650), int32(299840))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
