...
L4:
	;
	v70 = *(*int32)(unsafe.Add(mBase, uint32(v31)+uint32(_consts[1241])))
	v71 = int32(0)
...
L8:
	...
	v34 = *(*int32)(unsafe.Add(mBase, uint32(v31)+uint32(_consts[1241])))
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v58 - int32(1)
	F_errmsg_internal(m, int32(467113), v8)
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L13
...
L20:
	;
	v83 = int32(2)
	v91 = *(*int32)(unsafe.Add(mBase, uint32(v78<<(uint(v83)%32))+uint32(_consts[1241])))
	*(*int32)(unsafe.Add(mBase, uint32(v79<<(uint(v83)%32))+uint32(_consts[1241]))) = v91
	v94 = v78 + int32(1)
