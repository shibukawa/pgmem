...
L9:
	;
	v34 = *(*int32)(unsafe.Add(mBase, _consts[734]))
	if v34 != 0 {
		goto L7
	} else {
		goto L12
...
L21:
	;
	v60 = *(*int32)(unsafe.Add(mBase, _consts[742]))
...
L26:
	...
	v83 = *(*int32)(unsafe.Add(mBase, _consts[743]))
	if v81 != v83 {
		goto L23
	} else {
		goto L27
...
L29:
	;
	v90 = int32(*(*uint8)(unsafe.Add(mBase, _consts[81])))
	v93 = m.G0
	v95 = v93 - int32(16)
	m.G0 = v95
	if v90 != 0 {
...
L38:
	...
	v227 = *(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_consts[744])))
	*(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_consts[744]))) = v227 + base.I64_extend_i32_u(v111)
	v233 = *(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_consts[745])))
	*(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_consts[745]))) = v233 + v112
	F_pgstat_count_backend_io_op(m, v24, v25, int32(6), v111, v112)
	mBase = m.M
	v238 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[241])) = uint8(v238)
	*(*uint8)(unsafe.Add(mBase, _consts[242])) = uint8(v238)
	m.G0 = v118 + int32(16)
	goto L35
L39:
	;
	v176 = v24*int32(320) + v25<<(uint(int32(6))%32)
	v182 = *(*int64)(unsafe.Add(mBase, uint32(v176)+uint32(_consts[746])))
	*(*int64)(unsafe.Add(mBase, uint32(v176)+uint32(_consts[746]))) = v182 + v129
	v186 = *(*int32)(unsafe.Add(mBase, _consts[80]))
...
L46:
	;
	v155 = int32(4405000)
	v157 = *(*int64)(unsafe.Add(mBase, _consts[83]))
	v159 = base.I64_div_s(v129, int64(1000))
	*(*int64)(unsafe.Add(mBase, _consts[83])) = v157 + v159
	switch v24 {
	case 0:
		goto L48
	case 1:
...
L47:
	;
	v167 = int32(4323640)
	v169 = *(*int64)(unsafe.Add(mBase, _consts[112]))
	*(*int64)(unsafe.Add(mBase, _consts[112])) = v169 + v129
	goto L39
L48:
	;
	v162 = int32(4323624)
	v164 = *(*int64)(unsafe.Add(mBase, _consts[110]))
	*(*int64)(unsafe.Add(mBase, _consts[110])) = v164 + v129
	goto L39
L49:
	;
	goto L38
...
L51:
	...
	v205 = *(*int64)(unsafe.Add(mBase, uint32(v199)+uint32(_consts[747])))
	*(*int64)(unsafe.Add(mBase, uint32(v199)+uint32(_consts[747]))) = v205 + v129
	v209 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[241])) = uint8(v209)
...
L63:
	;
	F_errmsg_internal(m, int32(11654), int32(0))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		goto L5
...
L64:
	;
	F_errfinish(m, int32(464766), int32(1620), int32(91171))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L5
...
L74:
	;
	F_errmsg_internal(m, int32(436136), int32(0))
	mBase = m.M
	v329 = m.ExcPending
	if v329 != 0 {
		goto L5
...
L75:
	;
	F_errfinish(m, int32(464766), int32(1661), int32(124703))
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L5
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	v47 = F_pg_snprintf(m, v10+int32(16), int32(2048), int32(165202), v10)
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
	...
	if l0 != 0 {
		if base.Ui32(v2) <= base.Ui32(int32(127)) {
			*(*uint8)(unsafe.Add(mBase, uint32(l0))) = uint8(v2)
			...
			v6 = *(*int32)(unsafe.Add(mBase, _consts[1357]))
		...
		if l0 != 0 {
			if base.Ui32(v2) <= base.Ui32(int32(127)) {
				*(*uint8)(unsafe.Add(mBase, uint32(l0))) = uint8(v2)
				...
				v10 = *(*int32)(unsafe.Add(mBase, _consts[1357]))
...
func F_win1250_to_mic(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_latin2mic_with_table(m, v6, v5, v10, int32(130), int32(29), int32(2172240), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_win866(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(23), int32(20), int32(2167584), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win866_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(20), int32(25), int32(2168224), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v19
			...
			if v24 != 0 {
				...
				if v26 != 0 {
					...
					F_errfinish(m, int32(24787), int32(2635), int32(372247))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return
...
func F_write_syslogger_file(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if l2&int32(8) != 0 {
		...
		if v9 != 0 {
			...
			v14 = *(*int32)(unsafe.Add(mBase, _consts[584]))
			if v12 != 0 {
				v15 = v12
			} else {
				v15 = v14
