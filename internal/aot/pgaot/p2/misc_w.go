...
L9:
	;
	v34 = *(*int32)(unsafe.Add(mBase, _consts[739]))
	if v34 != 0 {
		goto L7
	} else {
		goto L12
...
L21:
	;
	v60 = *(*int32)(unsafe.Add(mBase, _consts[747]))
...
L26:
	...
	v83 = *(*int32)(unsafe.Add(mBase, _consts[748]))
	if v81 != v83 {
		goto L23
	} else {
		goto L27
...
L38:
	...
	v227 = *(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_consts[749])))
	*(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_consts[749]))) = v227 + base.I64_extend_i32_u(v111)
	v233 = *(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_consts[750])))
	*(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_consts[750]))) = v233 + v112
	F_pgstat_count_backend_io_op(m, v24, v25, int32(6), v111, v112)
	mBase = m.M
	v238 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[244])) = uint8(v238)
...
L39:
	...
	v182 = *(*int64)(unsafe.Add(mBase, uint32(v176)+uint32(_consts[751])))
	*(*int64)(unsafe.Add(mBase, uint32(v176)+uint32(_consts[751]))) = v182 + v129
...
L51:
	...
	v205 = *(*int64)(unsafe.Add(mBase, uint32(v199)+uint32(_consts[752])))
	*(*int64)(unsafe.Add(mBase, uint32(v199)+uint32(_consts[752]))) = v205 + v129
	v209 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[244])) = uint8(v209)
	*(*uint8)(unsafe.Add(mBase, _consts[248])) = uint8(v209)
	goto L49
L52:
	;
...
L63:
	;
	F_errmsg_internal(m, int32(12902), int32(0))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		goto L5
...
L64:
	;
	F_errfinish(m, int32(519599), int32(1620), int32(104795))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L5
...
L74:
	;
	F_errmsg_internal(m, int32(485967), int32(0))
	mBase = m.M
	v329 = m.ExcPending
	if v329 != 0 {
		goto L5
...
L75:
	;
	F_errfinish(m, int32(519599), int32(1661), int32(144050))
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L5
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	v47 = F_pg_snprintf(m, v10+int32(16), int32(2048), int32(187744), v10)
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
	...
	if l0 != 0 {
		if base.Ui32(v2) <= base.Ui32(int32(127)) {
			*(*uint8)(unsafe.Add(mBase, uint32(l0))) = uint8(v2)
			...
			v6 = *(*int32)(unsafe.Add(mBase, _consts[1488]))
		...
		if l0 != 0 {
			if base.Ui32(v2) <= base.Ui32(int32(127)) {
				*(*uint8)(unsafe.Add(mBase, uint32(l0))) = uint8(v2)
				...
				v10 = *(*int32)(unsafe.Add(mBase, _consts[1488]))
...
func F_win1250_to_mic(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_latin2mic_with_table(m, v6, v5, v10, int32(130), int32(29), int32(2275952), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_win866(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(23), int32(20), int32(2271296), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win866_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(20), int32(25), int32(2271936), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_write_syslogger_file(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	_ = v30
	if l2&int32(8) != 0 {
		v9 = *(*int32)(unsafe.Add(mBase, _consts[587]))
		if v9 != 0 {
			v21 = v9
		} else {
			v12 = *(*int32)(unsafe.Add(mBase, _consts[588]))
