...
L15:
	...
	if v307 != v303&int32(_a_F_WaitReadBuffers_0) {
		goto L66
	} else {
		goto L67
	}
...
L26:
	...
	v83 = *(*int32)(unsafe.Add(mBase, _c_F_WaitReadBuffers[2]))
	if v81 != v83 {
		goto L23
	} else {
		goto L27
...
L29:
	;
	v90 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_WaitReadBuffers[3])))
	v93 = m.G0
	v95 = v93 - int32(16)
	m.G0 = v95
	if v90 != 0 {
...
L38:
	...
	v227 = *(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_c_F_WaitReadBuffers[4])))
	*(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_c_F_WaitReadBuffers[4]))) = v227 + base.I64_extend_i32_u(v111)
	v233 = *(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_c_F_WaitReadBuffers[5])))
	*(*int64)(unsafe.Add(mBase, uint32(v221)+uint32(_c_F_WaitReadBuffers[5]))) = v233 + v112
	F_pgstat_count_backend_io_op(m, v24, v25, int32(6), v111, v112)
	mBase = m.M
	v238 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_WaitReadBuffers[6])) = uint8(v238)
	*(*uint8)(unsafe.Add(mBase, _c_F_WaitReadBuffers[7])) = uint8(v238)
	m.G0 = v118 + int32(16)
	goto L35
L39:
	;
	v176 = v24*int32(320) + v25<<(uint(int32(6))%32)
	v182 = *(*int64)(unsafe.Add(mBase, uint32(v176)+uint32(_c_F_WaitReadBuffers[8])))
	*(*int64)(unsafe.Add(mBase, uint32(v176)+uint32(_c_F_WaitReadBuffers[8]))) = v182 + v129
	v186 = *(*int32)(unsafe.Add(mBase, _c_F_WaitReadBuffers[9]))
...
L46:
	;
	v155 = int32(_a_F_WaitReadBuffers_1)
	v157 = *(*int64)(unsafe.Add(mBase, _c_F_WaitReadBuffers[10]))
	v159 = base.I64_div_s(v129, int64(1000))
	*(*int64)(unsafe.Add(mBase, _c_F_WaitReadBuffers[10])) = v157 + v159
	switch v24 {
	case 0:
		goto L48
	case 1:
...
L47:
	;
	v167 = int32(_a_F_WaitReadBuffers_2)
	v169 = *(*int64)(unsafe.Add(mBase, _c_F_WaitReadBuffers[11]))
	*(*int64)(unsafe.Add(mBase, _c_F_WaitReadBuffers[11])) = v169 + v129
	goto L39
L48:
	;
	v162 = int32(_a_F_WaitReadBuffers_3)
	v164 = *(*int64)(unsafe.Add(mBase, _c_F_WaitReadBuffers[12]))
	*(*int64)(unsafe.Add(mBase, _c_F_WaitReadBuffers[12])) = v164 + v129
	goto L39
L49:
	;
	goto L38
L50:
	;
	if int32(1)<<(uint(v186)%32)&int32(_a_F_WaitReadBuffers_4) == int32(0) {
		goto L49
	} else {
		goto L51
	}
L51:
	...
	v205 = *(*int64)(unsafe.Add(mBase, uint32(v199)+uint32(_c_F_WaitReadBuffers[13])))
	*(*int64)(unsafe.Add(mBase, uint32(v199)+uint32(_c_F_WaitReadBuffers[13]))) = v205 + v129
	v209 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_WaitReadBuffers[6])) = uint8(v209)
	*(*uint8)(unsafe.Add(mBase, _c_F_WaitReadBuffers[14])) = uint8(v209)
	goto L49
L52:
	;
...
L66:
	;
	v312 = *(*int32)(unsafe.Add(mBase, _c_F_WaitReadBuffers[15]))
	if v312 != 0 {
		goto L69
	} else {
		goto L70
...
L7:
	;
	v24 = *(*int32)(unsafe.Add(mBase, _c_F_walkdir[0]))
	if v24 != 0 {
		goto L9
	} else {
		goto L10
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	v47 = F_pg_snprintf(m, v10+int32(16), int32(2048), int32(_a_F_walkdir_0), v10)
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
...
func F_win1250_to_mic(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_latin2mic_with_table(m, v6, v5, v10, int32(130), int32(29), int32(_a_F_win1250_to_mic_0), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_win866(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(23), int32(20), int32(_a_F_win1251_to_win866_0), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win866_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(20), int32(25), int32(_a_F_win866_to_iso_0), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
