...
L64:
	;
	F_errfinish(m, int32(495087), int32(1620), int32(98113))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L5
...
L74:
	;
	F_errmsg_internal(m, int32(464191), int32(0))
	mBase = m.M
	v329 = m.ExcPending
	if v329 != 0 {
		goto L5
...
L75:
	;
	F_errfinish(m, int32(495087), int32(1661), int32(135380))
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L5
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	v47 = F_pg_snprintf(m, v10+int32(16), int32(2048), int32(177024), v10)
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
...
func F_win1250_to_mic(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_latin2mic_with_table(m, v6, v5, v10, int32(130), int32(29), int32(2234688), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_win866(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(23), int32(20), int32(2230032), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win866_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(20), int32(25), int32(2230672), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
