...
func F_win1250_to_mic(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = Fn13929(m, l0, int32(_a_F_win1250_to_mic_0), int32(29), int32(130))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_win1251_to_win866(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = Fn13936(m, l0, int32(_a_F_win1251_to_win866_0), int32(20), int32(23))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_win866_to_iso(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = Fn13936(m, l0, int32(_a_F_win866_to_iso_0), int32(25), int32(20))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
