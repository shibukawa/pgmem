...
L2:
	;
	if l0 == int32(_a_F_freeJsonLexContext_0) {
		goto L1
	} else {
		goto L3
	}
...
func F_get_json_expr_options(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(1) {
		...
		if base.Ui32(v8) <= base.Ui32(int32(3)) {
			...
			v16 = *(*int32)(unsafe.Add(mBase, uint32(v8<<(uint(int32(2))%32))+uint32(_c_F_get_json_expr_options[0])))
			...
			if v18 != 0 {
				...
				if v22 != 0 {
					v23 = int32(_a_F_get_json_expr_options_0)
				} else {
					v23 = int32(_a_F_get_json_expr_options_1)
				}
					...
					if v27 == int32(0) {
						...
						if v35 == int32(0) {
							...
							if v38 == l2 {
								...
								F_get_json_behavior(m, v35, l1, int32(_a_F_get_json_expr_options_2))
								mBase = m.M
								v42 = m.ExcPending
								if v42 != 0 {
									return
						...
						if v30 == l2 {
							...
							F_get_json_behavior(m, v27, l1, int32(_a_F_get_json_expr_options_3))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return
				...
				if l2 != 0 {
					...
					if v24&v30 != 0 {
						...
						if v40 != 0 {
							...
							default:
								if v42 == int32(3) {
									v47 = int32(_a_F_get_json_returning_3)
								} else {
									v47 = int32(_a_F_get_json_returning_4)
								}
								v48 = v47
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v48
								F_appendStringInfo(m, l1, int32(_a_F_get_json_returning_5), v9)
								mBase = m.M
								v52 = m.ExcPending
								if v52 != 0 {
									return
							...
							case 2:
								v48 = int32(_a_F_get_json_returning_6)
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v48
								F_appendStringInfo(m, l1, int32(_a_F_get_json_returning_5), v9)
								mBase = m.M
								v52 = m.ExcPending
...
L23:
	;
	if int32(1)<<(uint(v88)%32)&int32(_a_F_json_lex_2) == int32(0) {
		goto L7
	} else {
		goto L24
	}
...
L247:
	...
	if v1049 != int32(_a_F_json_lex_3) {
		goto L251
	} else {
		goto L252
	}
...
L249:
	;
	v1105 = v628<<(uint(int32(10))%32)&int32(_a_F_json_lex_4) | v1042&int32(1023) + int32(_a_F_json_lex_5)
	goto L248
L250:
	;
	if v628 != int32(-1) {
...
L251:
	;
	if v1049 != int32(_a_F_json_lex_6) {
		goto L250
	} else {
		goto L254
	}
...
L328:
	;
	v1213 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_json_lex[0])))
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = int32(_a_F_json_manifest_object_end_0)
	m.T0[v654].(func(*base.Module, int32, int32, int32))(m, v653, int32(_a_F_json_manifest_object_end_1), v15)
	mBase = m.M
	v659 = m.ExcPending
	if v659 != 0 {
		goto L23
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+192)) = int32(_a_F_json_manifest_object_end_2)
	m.T0[v645].(func(*base.Module, int32, int32, int32))(m, v644, int32(_a_F_json_manifest_object_end_1), v15+int32(192))
	mBase = m.M
	v652 = m.ExcPending
	if v652 != 0 {
		goto L23
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+224)) = int32(_a_F_json_manifest_object_end_3)
	m.T0[v636].(func(*base.Module, int32, int32, int32))(m, v635, int32(_a_F_json_manifest_object_end_1), v15+int32(224))
	mBase = m.M
	v643 = m.ExcPending
	if v643 != 0 {
		goto L23
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+256)) = int32(_a_F_json_manifest_object_end_4)
	m.T0[v627].(func(*base.Module, int32, int32, int32))(m, v626, int32(_a_F_json_manifest_object_end_1), v15+int32(256))
	mBase = m.M
	v634 = m.ExcPending
	if v634 != 0 {
		goto L23
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+176)) = int32(_a_F_json_manifest_object_end_5)
	m.T0[v618].(func(*base.Module, int32, int32, int32))(m, v473, int32(_a_F_json_manifest_object_end_1), v15+int32(176))
	mBase = m.M
	v625 = m.ExcPending
	if v625 != 0 {
		goto L23
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+160)) = int32(_a_F_json_manifest_object_end_6)
	m.T0[v610].(func(*base.Module, int32, int32, int32))(m, v473, int32(_a_F_json_manifest_object_end_1), v15+int32(160))
	mBase = m.M
	v617 = m.ExcPending
	if v617 != 0 {
		goto L23
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+144)) = int32(_a_F_json_manifest_object_end_7)
	m.T0[v602].(func(*base.Module, int32, int32, int32))(m, v473, int32(_a_F_json_manifest_object_end_1), v15+int32(144))
	mBase = m.M
	v609 = m.ExcPending
	if v609 != 0 {
		goto L23
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+80)) = int32(_a_F_json_manifest_object_end_8)
	m.T0[v594].(func(*base.Module, int32, int32, int32))(m, v593, int32(_a_F_json_manifest_object_end_1), v15+int32(80))
	mBase = m.M
	v601 = m.ExcPending
	if v601 != 0 {
		goto L23
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+96)) = int32(_a_F_json_manifest_object_end_9)
	m.T0[v585].(func(*base.Module, int32, int32, int32))(m, v584, int32(_a_F_json_manifest_object_end_1), v15+int32(96))
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L23
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+112)) = int32(_a_F_json_manifest_object_end_10)
	m.T0[v564].(func(*base.Module, int32, int32, int32))(m, v21, int32(_a_F_json_manifest_object_end_1), v15+int32(112))
	mBase = m.M
	v571 = m.ExcPending
	if v571 != 0 {
		goto L23
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = int32(_a_F_json_manifest_object_end_11)
	m.T0[v556].(func(*base.Module, int32, int32, int32))(m, v21, int32(_a_F_json_manifest_object_end_1), v15+int32(32))
	mBase = m.M
	v563 = m.ExcPending
	if v563 != 0 {
		goto L23
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+128)) = int32(_a_F_json_manifest_object_end_12)
	m.T0[v548].(func(*base.Module, int32, int32, int32))(m, v21, int32(_a_F_json_manifest_object_end_1), v15+int32(128))
	mBase = m.M
	v555 = m.ExcPending
	if v555 != 0 {
		goto L23
...
L83:
	;
	v243 = v15 + int32(264)
	v245 = F_pg_strcasecmp(m, v237, int32(_a_F_json_manifest_object_end_14))
	mBase = m.M
	if v245 == int32(0) {
		goto L85
	} else {
...
L87:
	;
	v252 = F_pg_strcasecmp(m, v237, int32(_a_F_json_manifest_object_end_15))
	mBase = m.M
	if v252 == int32(0) {
		goto L88
	} else {
...
L90:
	;
	v259 = F_pg_strcasecmp(m, v237, int32(_a_F_json_manifest_object_end_16))
	mBase = m.M
	if v259 == int32(0) {
		goto L91
	} else {
...
L93:
	;
	v266 = F_pg_strcasecmp(m, v237, int32(_a_F_json_manifest_object_end_17))
	mBase = m.M
	if v266 == int32(0) {
		goto L94
	} else {
...
L96:
	;
	v273 = F_pg_strcasecmp(m, v237, int32(_a_F_json_manifest_object_end_18))
	mBase = m.M
	if v273 == int32(0) {
		goto L97
	} else {
...
L99:
	;
	v282 = F_pg_strcasecmp(m, v237, int32(_a_F_json_manifest_object_end_19))
	mBase = m.M
	if v282 != 0 {
		goto L100
	} else {
...
L103:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+64)) = v290
	m.T0[v289].(func(*base.Module, int32, int32, int32))(m, v21, int32(_a_F_json_manifest_object_end_20), v15-int32(-64))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L23
...
L127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+48)) = v465
	m.T0[v464].(func(*base.Module, int32, int32, int32))(m, v21, int32(_a_F_json_manifest_object_end_21), v15+int32(48))
	mBase = m.M
	v472 = m.ExcPending
	if v472 != 0 {
		goto L23
...
L156:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+244)) = v15 + int32(264)
	v501 = F_sscanf(m, v491, int32(_a_F_json_manifest_object_end_22), v15+int32(240))
	mBase = m.M
	v502 = m.ExcPending
	if v502 != 0 {
		goto L23
...
L158:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+212)) = v15 + int32(264)
	v517 = F_sscanf(m, v507, int32(_a_F_json_manifest_object_end_22), v15+int32(208))
	mBase = m.M
	v518 = m.ExcPending
	if v518 != 0 {
		goto L23
...
L56:
	;
	F_appendStringInfoString(m, v11+int32(16), int32(_a_F_json_object_7))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L8
...
L60:
	;
	F_appendStringInfoString(m, v11+int32(16), int32(_a_F_json_object_8))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L8
