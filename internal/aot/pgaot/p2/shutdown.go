...
func F_ShutdownRecoveryTransactionEnvironment(m *base.Module) {
	...
	var v127 int32
	_ = v127
	v7 = *(*int32)(unsafe.Add(mBase, _consts[804]))
	if v7 != 0 {
		...
		if v14 != 0 {
			...
			v16 = *(*int32)(unsafe.Add(mBase, _consts[196]))
					...
					if v24 != 0 {
						...
						if v29 != 0 {
							...
							*(*int64)(unsafe.Add(mBase, uint32(v35)+56)) = v60 + int64(1)
							v65 = *(*int32)(unsafe.Add(mBase, _consts[196]))
							*(*int32)(unsafe.Add(mBase, uint32(v65)+24)) = int32(0)
							...
							if v73 != 0 {
								...
								if v75 != 0 {
									...
									v77 = *(*int32)(unsafe.Add(mBase, _consts[804]))
									...
									if v79 != 0 {
										...
										v81 = *(*int32)(unsafe.Add(mBase, _consts[783]))
										...
										if v83 != 0 {
											...
											v85 = int32(0)
											*(*int32)(unsafe.Add(mBase, _consts[783])) = v85
											*(*int32)(unsafe.Add(mBase, _consts[804])) = v85
											v90 = m.G0
											v92 = v90 - int32(16)
											m.G0 = v92
											v95 = *(*int32)(unsafe.Add(mBase, _consts[188]))
											...
											if v100 != 0 {
												...
												v102 = *(*int32)(unsafe.Add(mBase, _consts[188]))
													...
													if v106 != 0 {
														...
														if v103 == int32(0) {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v92)+4)) = v103
															v119 = *(*int32)(unsafe.Add(mBase, _consts[748]))
															*(*int32)(unsafe.Add(mBase, uint32(v92))) = v119
															v123 = *(*int32)(unsafe.Add(mBase, _consts[188]))
															F_LockRefindAndRelease(m, int32(1663120), v123, v92, int32(7), int32(0))
															mBase = m.M
															v127 = m.ExcPending
															if v127 != 0 {
																return
