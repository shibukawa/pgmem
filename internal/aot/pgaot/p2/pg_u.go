...
L4:
	...
	v21 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_c_F_pg_u_isupper[0])))
...
L9:
	;
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_c_F_pg_u_isupper[1])))
...
L3:
	;
	v42 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_c_F_pg_u_prop_case_ignorable[0]))))
...
L4:
	;
	v43 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_c_F_pg_u_prop_cased[0]))))
...
L15:
	...
	v65 = *(*int32)(unsafe.Add(mBase, uint32(v62)+uint32(_c_F_pg_u_prop_cased[4])))
...
L20:
	;
	v71 = *(*int32)(unsafe.Add(mBase, uint32(v62)+uint32(_c_F_pg_u_prop_cased[5])))
...
L25:
	...
	v94 = *(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_c_F_pg_u_prop_cased[6])))
...
L30:
	;
	v100 = *(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_c_F_pg_u_prop_cased[7])))
