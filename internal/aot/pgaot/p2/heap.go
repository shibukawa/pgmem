		...
		*(*int32)(unsafe.Add(mBase, uint32(l1)+12)) = v45
		...
		if v70 != 0 {
			...
			if v73 != 0 {
				...
				F_errmsg(m, int32(210133), int32(0))
				mBase = m.M
				v77 = m.ExcPending
				if v77 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(474192), int32(2283), int32(77455))
					mBase = m.M
					v82 = m.ExcPending
					if v82 != 0 {
						return int32(0)
	...
	default:
		...
		if v152 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = v153
			F_errmsg_internal(m, int32(446713), v9)
			mBase = m.M
			v157 = m.ExcPending
			if v157 != 0 {
				return
			} else {
				F_errfinish(m, int32(473103), int32(1474), int32(298424))
				mBase = m.M
				v162 = m.ExcPending
				if v162 != 0 {
					return
...
L16:
	;
	F_s_lock(m, v39, int32(474209), int32(455), int32(94011))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L19
...
L122:
	;
	F_errmsg(m, int32(365705), int32(0))
	mBase = m.M
	v546 = m.ExcPending
	if v546 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(474192), int32(3480), int32(338914))
	mBase = m.M
	v551 = m.ExcPending
	if v551 != 0 {
		goto L1
...
L427:
	;
	F_errfinish(m, int32(474192), int32(3303), int32(338914))
	mBase = m.M
	v1950 = m.ExcPending
	if v1950 != 0 {
		goto L1
