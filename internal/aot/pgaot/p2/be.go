...
func F_be_lo_close(m *base.Module, l0 int32) int32 {
	...
	if v9 < int32(0) {
			...
			if v47 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v9
				...
				if v51 != 0 {
					...
					F_errfinish(m, int32(472126), int32(133), int32(343881))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
		...
		v13 = *(*int32)(unsafe.Add(mBase, _consts[464]))
		if v13 <= v9 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v44 = m.ExcPending
			...
			if v20 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(0)
				...
				if v25 != 0 {
					v27 = *(*int32)(unsafe.Add(mBase, _consts[402]))
			...
			if v30 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v9
				...
				if v34 != 0 {
					...
					F_errfinish(m, int32(472126), int32(241), int32(527398))
					mBase = m.M
					v39 = m.ExcPending
					if v39 != 0 {
						return int32(0)
