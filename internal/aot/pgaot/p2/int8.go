	...
	if v44 != 0 {
		...
		if v146 != 0 {
			...
			if v150 != 0 {
				...
				F_errfinish(m, int32(525301), int32(5946), int32(392293))
				mBase = m.M
				v155 = m.ExcPending
				if v155 != 0 {
					return int32(0)
		...
		if v25 != 0 {
			...
			if v28 != 0 {
				...
				if v34 != 0 {
					...
					F_errfinish(m, int32(525859), int32(107), int32(81907))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
...
L63:
	;
	v192 = F_DirectFunctionCall1Coll(m, int32(1318), int32(0), v190)
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L3
...
L64:
	;
	v194 = F_DirectFunctionCall2Coll(m, int32(1282), int32(0), v186, v192)
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L3
...
L66:
	;
	v207 = F_DirectFunctionCall1Coll(m, int32(1319), int32(0), v205)
	mBase = m.M
	v208 = m.ExcPending
	if v208 != 0 {
		goto L3
