...
func F_ProcessConfigFileInternal(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+152)) = v4
	v23 = int32(1)
	v25 = *(*int32)(unsafe.Add(mBase, _consts[1227]))
...
L9:
	;
	v143 = *(*int32)(unsafe.Add(mBase, _consts[1228]))
...
L19:
	...
	v63 = int32(13273)
	v66 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1229])))
...
L46:
	;
	v511 = int32(0)
	v515 = *(*int32)(unsafe.Add(mBase, _consts[1228]))
...
L121:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+112)) = v456
	F_errmsg(m, int32(477325), v17+int32(112))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L4
...
L122:
	;
	F_errfinish(m, int32(499593), int32(430), int32(312722))
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L4
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+64)) = v567
	v572 = F_psprintf(m, int32(214629), v17-int32(-64))
	mBase = m.M
	v573 = m.ExcPending
	if v573 != 0 {
		goto L4
...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+80)) = v555
	F_errmsg(m, int32(214629), v17+int32(80))
	mBase = m.M
	v561 = m.ExcPending
	if v561 != 0 {
		goto L4
...
L145:
	;
	F_errfinish(m, int32(499593), int32(469), int32(312722))
	mBase = m.M
	v566 = m.ExcPending
	if v566 != 0 {
		goto L4
...
L171:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+96)) = v673
	F_errmsg(m, int32(98425), v17+int32(96))
	mBase = m.M
	v679 = m.ExcPending
	if v679 != 0 {
		goto L4
...
L172:
	;
	F_errfinish(m, int32(499593), int32(505), int32(312722))
	mBase = m.M
	v684 = m.ExcPending
	if v684 != 0 {
		goto L4
...
L179:
	...
	v723 = int32(0)
	v725 = int32(1)
	v732 = F_set_config_with_handle(m, int32(143387), v723, int32(98568), v725, v725, int32(10), v723, v725, v723, v723)
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L4
...
L181:
	...
	v740 = int32(1)
	v742 = int32(0)
	v746 = F_set_config_with_handle(m, int32(335598), int32(0), v738, int32(4), v740, int32(10), v742, v740, v742, v742)
	mBase = m.M
	v747 = m.ExcPending
	if v747 != 0 {
		goto L4
...
L219:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v17)+48)) = v832
	F_errmsg(m, int32(701974), v17+int32(48))
	mBase = m.M
	v838 = m.ExcPending
	if v838 != 0 {
		goto L4
...
L220:
	;
	F_errfinish(m, int32(499593), int32(570), int32(312722))
	mBase = m.M
	v843 = m.ExcPending
	if v843 != 0 {
		goto L4
...
L239:
	;
	*(*int64)(unsafe.Add(mBase, _consts[1230])) = v920 + v919*int64(1000000) - int64(946684800000000)
	v934 = int32(1)
	v938 = v901
	v939 = v902
	goto L3
...
L248:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v939
	F_errmsg(m, int32(456338), v17+int32(16))
	mBase = m.M
	v966 = m.ExcPending
	if v966 != 0 {
		goto L4
...
L249:
	;
	F_errfinish(m, int32(499593), int32(617), int32(312722))
	mBase = m.M
	v971 = m.ExcPending
	if v971 != 0 {
		goto L4
...
L252:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v939
	F_errmsg(m, int32(456273), v17+int32(32))
	mBase = m.M
	v982 = m.ExcPending
	if v982 != 0 {
		goto L4
...
L253:
	;
	F_errfinish(m, int32(499593), int32(622), int32(312722))
	mBase = m.M
	v987 = m.ExcPending
	if v987 != 0 {
		goto L4
...
L257:
	;
	F_errfinish(m, int32(499593), int32(612), int32(312722))
	mBase = m.M
	v1022 = m.ExcPending
	if v1022 != 0 {
		goto L4
