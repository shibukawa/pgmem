...
func F_ProcessConfigFileInternal(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+152)) = v4
	v23 = int32(1)
	v25 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessConfigFileInternal[0]))
...
L8:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessConfigFileInternal[1]))
	if v41 == int32(0) {
		goto L10
	} else {
		goto L11
...
L9:
	;
	v143 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessConfigFileInternal[2]))
...
L12:
	;
	v112 = int32(_a_F_ProcessConfigFileInternal_0)
	v114 = int32(0)
...
L19:
	...
	v63 = int32(_a_F_ProcessConfigFileInternal_1)
...
L46:
	;
	v511 = int32(0)
	v515 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessConfigFileInternal[2]))
...
L120:
	;
	v475 = F_pstrdup(m, int32(_a_F_ProcessConfigFileInternal_3))
	mBase = m.M
	v476 = m.ExcPending
	if v476 != 0 {
		goto L4
...
L121:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+112)) = v456
	F_errmsg(m, int32(_a_F_ProcessConfigFileInternal_4), v17+int32(112))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L4
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+64)) = v567
	v572 = F_psprintf(m, int32(_a_F_ProcessConfigFileInternal_7), v17-int32(-64))
	mBase = m.M
	v573 = m.ExcPending
	if v573 != 0 {
		goto L4
...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+80)) = v555
	F_errmsg(m, int32(_a_F_ProcessConfigFileInternal_7), v17+int32(80))
	mBase = m.M
	v561 = m.ExcPending
	if v561 != 0 {
		goto L4
...
L171:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+96)) = v673
	F_errmsg(m, int32(_a_F_ProcessConfigFileInternal_8), v17+int32(96))
	mBase = m.M
	v679 = m.ExcPending
	if v679 != 0 {
		goto L4
...
L179:
	...
	v723 = int32(0)
	v725 = int32(1)
	v732 = F_set_config_with_handle(m, int32(_a_F_ProcessConfigFileInternal_9), v723, int32(_a_F_ProcessConfigFileInternal_10), v725, v725, int32(10), v723, v725, v723, v723)
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L4
...
L181:
	...
	v740 = int32(1)
	v742 = int32(0)
	v746 = F_set_config_with_handle(m, int32(_a_F_ProcessConfigFileInternal_11), int32(0), v738, int32(4), v740, int32(10), v742, v740, v742, v742)
	mBase = m.M
	v747 = m.ExcPending
	if v747 != 0 {
		goto L4
...
L195:
	;
	v775 = int32(_a_F_ProcessConfigFileInternal_12)
	goto L196
L196:
	;
...
L207:
	;
	v799 = int32(_a_F_ProcessConfigFileInternal_12)
	goto L208
L208:
	;
...
L219:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v17)+48)) = v832
	F_errmsg(m, int32(_a_F_ProcessConfigFileInternal_13), v17+int32(48))
	mBase = m.M
	v838 = m.ExcPending
	if v838 != 0 {
		goto L4
...
L222:
	;
	v845 = F_pstrdup(m, int32(_a_F_ProcessConfigFileInternal_14))
	mBase = m.M
	v846 = m.ExcPending
	if v846 != 0 {
		goto L4
...
L248:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v939
	F_errmsg(m, int32(_a_F_ProcessConfigFileInternal_15), v17+int32(16))
	mBase = m.M
	v966 = m.ExcPending
	if v966 != 0 {
		goto L4
...
L252:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v939
	F_errmsg(m, int32(_a_F_ProcessConfigFileInternal_16), v17+int32(32))
	mBase = m.M
	v982 = m.ExcPending
	if v982 != 0 {
		goto L4
...
L256:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v939
	F_errmsg(m, int32(_a_F_ProcessConfigFileInternal_17), v17)
	mBase = m.M
	v1017 = m.ExcPending
	if v1017 != 0 {
		goto L4
