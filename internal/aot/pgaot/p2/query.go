...
L3:
	;
	v19 = *(*int64)(unsafe.Add(mBase, _consts[458]))
	if v19 != int64(0) {
		goto L6
	} else {
		goto L7
...
L9:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _consts[459]))
...
L14:
	;
	v48 = v26 + int64(1)
	v50 = *(*int64)(unsafe.Add(mBase, _consts[458]))
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v65
	F_errmsg_internal(m, int32(172849), v8)
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(478114), int32(2794), int32(71348))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
