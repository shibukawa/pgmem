...
L3:
	;
	v19 = *(*int64)(unsafe.Add(mBase, _consts[460]))
	if v19 != int64(0) {
		goto L6
	} else {
		goto L7
...
L9:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _consts[461]))
...
L14:
	;
	v48 = v26 + int64(1)
	v50 = *(*int64)(unsafe.Add(mBase, _consts[460]))
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v65
	F_errmsg_internal(m, int32(181955), v8)
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(498823), int32(2794), int32(74417))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
