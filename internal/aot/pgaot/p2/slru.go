...
func F_SlruDeleteSegment(m *base.Module, l0 int64) {
	...
	_ = v102
	v2 = int32(0)
	v9 = *(*int32)(unsafe.Add(mBase, _consts[144]))
...
L4:
	;
	F_SlruInternalDeleteSegment(m, int32(4350004), l0)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L20:
	;
	F_SimpleLruWaitIO(m, int32(4350004), v28)
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L1
...
L23:
	;
	F_SlruInternalWritePage(m, int32(4350004), v28, int32(0))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L1
