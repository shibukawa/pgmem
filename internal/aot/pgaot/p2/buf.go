...
L3:
	;
	v45 = int32(_a_F_LockBufHdr_4)
	v46 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufHdr[0]))
...
L9:
	;
	m.G0 = v6 + int32(32)
	return v41 | int32(_a_F_LockBufHdr_3)
L10:
	;
	goto L9
L11:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_LockBufHdr[0])) = v63
	goto L10
L12:
	;
	if int32(999) < v46 {
