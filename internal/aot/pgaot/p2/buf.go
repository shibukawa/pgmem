...
func F_BufTableDelete(m *base.Module, l0 int32, l1 int32) {
	...
	var v23 int32
	_ = v23
	v4 = *(*int32)(unsafe.Add(mBase, _consts[736]))
	...
	if v8 != 0 {
		...
		if v7 == int32(0) {
			...
			if v14 != 0 {
				...
				F_errmsg_internal(m, int32(440670), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return
				} else {
					F_errfinish(m, int32(494032), int32(160), int32(347988))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return
...
func F_BufTableHashCode(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v3 = *(*int32)(unsafe.Add(mBase, _consts[736]))
...
L3:
	;
	v45 = int32(4095884)
	v46 = *(*int32)(unsafe.Add(mBase, _consts[737]))
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[737])) = v63
	goto L10
L12:
	;
	if int32(999) < v46 {
