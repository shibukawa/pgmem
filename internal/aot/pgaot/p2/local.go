...
func F_PinLocalBuffer(m *base.Module, l0 int32, l1 int32) {
	...
	v8 = *(*int32)(unsafe.Add(mBase, _consts[749]))
	...
	if v15 == int32(0) {
		...
		v21 = int32(1)
		*(*int32)(unsafe.Add(mBase, _consts[750])) = v20 + v21
		v27 = v6 + v21
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v37 + v38
	...
	F_ResourceOwnerRemember(m, v42, v43+v38, int32(1602544))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		return
...
L16:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _consts[799]))
...
L19:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[799]))
	F_s_lock(m, v48, int32(489150), int32(1495), int32(312310))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L9
...
L21:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _consts[799]))
...
L27:
	;
	F_errmsg_internal(m, int32(437763), int32(0))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L9
...
L28:
	;
	F_errfinish(m, int32(489150), int32(1505), int32(312310))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L9
