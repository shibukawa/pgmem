...
func F_PinLocalBuffer(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v37 + v38
	...
	F_ResourceOwnerRemember(m, v42, v43+v38, int32(1586128))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		return
...
L19:
	...
	F_s_lock(m, v48, int32(474337), int32(1495), int32(301988))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L9
...
L27:
	;
	F_errmsg_internal(m, int32(424012), int32(0))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L9
...
L28:
	;
	F_errfinish(m, int32(474337), int32(1505), int32(301988))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L9
