...
func F_MarkLocalBufferDirty(m *base.Module, l0 int32) {
	...
	if v12&int32(8388608) == int32(0) {
		v17 = int32(4460376)
		v19 = *(*int64)(unsafe.Add(mBase, _consts[109]))
		*(*int64)(unsafe.Add(mBase, _consts[109])) = v19 + int64(1)
	} else {
	}
...
func F_PinLocalBuffer(m *base.Module, l0 int32, l1 int32) {
	...
	v8 = *(*int32)(unsafe.Add(mBase, _consts[754]))
	...
	if v15 == int32(0) {
		...
		v21 = int32(1)
		*(*int32)(unsafe.Add(mBase, _consts[755])) = v20 + v21
		v27 = v6 + v21
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v37 + v38
	...
	F_ResourceOwnerRemember(m, v42, v43+v38, int32(1662816))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		return
...
L16:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _consts[809]))
...
L18:
	;
	v73 = *(*int32)(unsafe.Add(mBase, _consts[101]))
...
L19:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[809]))
	F_s_lock(m, v48, int32(522629), int32(1495), int32(333182))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L9
...
L21:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _consts[809]))
...
L27:
	;
	F_errmsg_internal(m, int32(466220), int32(0))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L9
...
L28:
	;
	F_errfinish(m, int32(522629), int32(1505), int32(333182))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L9
