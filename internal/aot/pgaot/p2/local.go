...
func F_MarkLocalBufferDirty(m *base.Module, l0 int32) {
	...
	if v12&int32(8388608) == int32(0) {
		v17 = int32(4347832)
		v19 = *(*int64)(unsafe.Add(mBase, _consts[106]))
		*(*int64)(unsafe.Add(mBase, _consts[106])) = v19 + int64(1)
	} else {
	}
...
func F_PinLocalBuffer(m *base.Module, l0 int32, l1 int32) {
	...
	v8 = *(*int32)(unsafe.Add(mBase, _consts[750]))
	v10 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v14 = v8 + (int32(-2)-v10)<<(uint(int32(2))%32)
	v15 = *(*int32)(unsafe.Add(mBase, uint32(v14)))
	if v15 == int32(0) {
		v18 = int32(4365464)
		v20 = *(*int32)(unsafe.Add(mBase, _consts[751]))
		v21 = int32(1)
		*(*int32)(unsafe.Add(mBase, _consts[751])) = v20 + v21
		v27 = v6 + v21
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v37 + v38
	...
	F_ResourceOwnerRemember(m, v42, v43+v38, int32(1590480))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		return
...
L16:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _consts[800]))
...
L18:
	;
	v73 = *(*int32)(unsafe.Add(mBase, _consts[98]))
...
L19:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[800]))
	F_s_lock(m, v48, int32(478432), int32(1495), int32(304724))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L9
...
L21:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _consts[800]))
...
L27:
	;
	F_errmsg_internal(m, int32(427756), int32(0))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L9
...
L28:
	;
	F_errfinish(m, int32(478432), int32(1505), int32(304724))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L9
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v87)+4)) = int32(4)
	*(*int32)(unsafe.Add(mBase, uint32(v87))) = v10
	v92 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v93 = F_lappend(m, v92, v87)
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
