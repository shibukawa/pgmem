...
func F_TransferPredicateLocksToNewTarget(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v23 = v21 - int32(16)
	m.G0 = v23
	v26 = *(*int32)(unsafe.Add(mBase, _consts[817]))
...
L2:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[817]))
...
L4:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[820]))
...
L7:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[817]))
	v51 = *(*int32)(unsafe.Add(mBase, _consts[821]))
	v55 = F_hash_search_with_hash_value(m, v48, int32(1604988), v51, int32(2), v23+int32(13))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L8:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[820]))
...
L10:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _consts[817]))
	v88 = int32(0)
...
L20:
	;
	v94 = *(*int32)(unsafe.Add(mBase, _consts[817]))
...
L40:
	;
	v181 = *(*int32)(unsafe.Add(mBase, _consts[818]))
	v182 = int32(4)
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v240))) = v242
	v245 = *(*int32)(unsafe.Add(mBase, _consts[818]))
	v248 = int32(4)
...
L60:
	;
	v292 = *(*int32)(unsafe.Add(mBase, _consts[817]))
...
L80:
	;
	v366 = *(*int32)(unsafe.Add(mBase, _consts[817]))
...
L90:
	;
	v426 = *(*int32)(unsafe.Add(mBase, _consts[820]))
...
L93:
	;
	v431 = *(*int32)(unsafe.Add(mBase, _consts[817]))
	v434 = *(*int32)(unsafe.Add(mBase, _consts[821]))
	v438 = F_hash_search_with_hash_value(m, v431, int32(1604988), v434, int32(1), v23+int32(15))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		goto L1
...
L94:
	;
	v441 = *(*int32)(unsafe.Add(mBase, _consts[820]))
...
func F_t_isalpha_cstr(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v13 != 0 {
			...
			if v12 != int32(1) {
				v17 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1002])))
				if v17 != int32(1) {
					...
					if v34 != 0 {
						...
						if base.Ui32(v35) <= base.Ui32(int32(131071)) {
							v46 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v35)>>(uint(int32(8))%32)))+uint32(_consts[598]))))
							v52 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v35)>>(uint(int32(3))%32))&int32(31)|v46<<(uint(int32(5))%32))+uint32(_consts[598]))))
...
func F_tblspc_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
		F_appendStringInfo(m, l0, int32(673763), v7)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return
	...
	case 16:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v22
		F_appendStringInfo(m, l0, int32(58964), v7+int32(16))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return
...
func F_test_lockmode_for_conflict(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l4))) = uint8(v6)
	v13 = *(*int32)(unsafe.Add(mBase, uint32(l2*int32(12))+uint32(_consts[69])))
...
L5:
	;
	v25 = *(*int32)(unsafe.Add(mBase, _consts[63]))
	if v25 == l1 {
		goto L6
	} else {
		goto L7
...
L8:
	;
	v29 = *(*int32)(unsafe.Add(mBase, _consts[64]))
	if v29 <= int32(0) {
		goto L10
	} else {
		goto L11
...
L45:
	;
	v140 = int32(2)
	v144 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(v140)%32))+uint32(_consts[67])))
	v145 = int32(12)
	v149 = *(*int32)(unsafe.Add(mBase, uint32(v144*v145)+uint32(_consts[62])))
	v154 = *(*int32)(unsafe.Add(mBase, uint32(v13<<(uint(v140)%32))+uint32(_consts[67])))
	v159 = *(*int32)(unsafe.Add(mBase, uint32(v154*v145)+uint32(_consts[62])))
	v164 = *(*int32)(unsafe.Add(mBase, uint32(v149<<(uint(v140)%32))+uint32(_consts[70])))
	goto L48
L46:
	;
	goto L47
...
L54:
	;
	v183 = int32(2)
	v187 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(v183)%32))+uint32(_consts[67])))
	v188 = int32(12)
	v192 = *(*int32)(unsafe.Add(mBase, uint32(v187*v188)+uint32(_consts[62])))
	v197 = *(*int32)(unsafe.Add(mBase, uint32(v13<<(uint(v183)%32))+uint32(_consts[67])))
	v202 = *(*int32)(unsafe.Add(mBase, uint32(v197*v188)+uint32(_consts[62])))
	v207 = *(*int32)(unsafe.Add(mBase, uint32(v192<<(uint(v183)%32))+uint32(_consts[70])))
	goto L55
L55:
	;
...
L8:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[96]))
...
func F_timeofday(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v5)+8)) = v10
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1060]))
	...
	if v23 != 0 {
		...
		v24 = F_pg_strftime(m, v5+int32(144), int32(128), int32(500288), v20)
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
				...
				if v158 != 0 {
					...
					if v161 != 0 {
						...
						if v165 != 0 {
							...
							F_errfinish(m, int32(488262), int32(6550), int32(233842))
							mBase = m.M
							v170 = m.ExcPending
							if v170 != 0 {
								return int64(0)
						...
						if v177 != 0 {
							...
							if v180 != 0 {
								...
								if v184 != 0 {
									...
									F_errfinish(m, int32(488262), int32(6554), int32(233842))
									mBase = m.M
									v189 = m.ExcPending
									if v189 != 0 {
										return int64(0)
...
func F_timetztypmodout(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	if int32(0) <= v7 {
		*(*int32)(unsafe.Add(mBase, uint32(v5)+4)) = int32(366926)
...
func F_tokenize_error_callback(m *base.Module, l0 int32) {
	...
	if v9 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v5))) = base.I64_rotl(v10, int64(32))
		F_errcontext_msg(m, int32(692211), v5)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
					...
					default:
						...
						if v28 != 0 {
							...
							if v31 != 0 {
								...
								F_errmsg(m, int32(342329), int32(0))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(490769), int32(74), int32(85347))
									mBase = m.M
									v40 = m.ExcPending
									if v40 != 0 {
										return int32(0)
...
L100:
	;
	F_errmsg(m, int32(144342), int32(0))
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L6
...
L124:
	;
	F_errmsg_internal(m, int32(333953), int32(0))
	mBase = m.M
	v593 = m.ExcPending
	if v593 != 0 {
		goto L6
...
L125:
	;
	F_errfinish(m, int32(490981), int32(3187), int32(261476))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L6
...
L127:
	;
	F_errfinish(m, int32(490981), int32(3120), int32(354308))
	mBase = m.M
	v605 = m.ExcPending
	if v605 != 0 {
		goto L6
...
L132:
	;
	F_errfinish(m, int32(490981), int32(3149), int32(354308))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L6
...
func F_truncate_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if v15 != 0 {
		*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = int32(351970)
		...
		*(*int64)(unsafe.Add(mBase, uint32(v12)+24)) = v19
		v23 = int32(4463656)
		v24 = *(*int32)(unsafe.Add(mBase, _consts[84]))
		*(*int32)(unsafe.Add(mBase, _consts[84])) = v12 + int32(4)
		...
		*(*int64)(unsafe.Add(mBase, uint32(v14)+152)) = v37
		...
		if v42 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[84])) = v44
			m.G0 = v12 + int32(32)
			return
		}
	} else {
...
L20:
	...
	v100 = *(*float64)(unsafe.Add(mBase, _consts[481]))
	if l4 != 0 {
		goto L37
	} else {
		goto L38
...
L39:
	...
	v110 = float64(0)
	v113 = *(*float64)(unsafe.Add(mBase, _consts[485]))
...
L42:
	...
	v143 = int32(*(*uint8)(unsafe.Add(mBase, _consts[486])))
...
L49:
	;
	v161 = *(*float64)(unsafe.Add(mBase, _consts[482]))
...
L1:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[155]))
	return v48
L2:
	;
	goto L3
...
L6:
	...
	v60 = v58 - int32(1056)
	m.G0 = v60
	v63 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1252])))
	if v63 == int32(0) {
		goto L7
	} else {
		goto L8
...
L29:
	;
	v249 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1252])) = uint8(v249)
	goto L9
L30:
	;
...
L49:
	;
	v179 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1253])))
	if v179 == int32(0) {
		v207 = v131
		v208 = v130
		v209 = v139
...
L81:
	;
	v301 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1254])))
	if v301 == int32(0) {
		v329 = v254
		v330 = v253
		v331 = v261
...
L317:
	;
	v1283 = F_read(m, v1243, v44, int32(54968))
	mBase = m.M
	if v1283 <= int32(43) {
		goto L318
	} else {
...
L321:
	;
	v1290 = *(*int32)(unsafe.Add(mBase, _consts[155]))
	v1291 = v1290
	goto L323
L322:
	;
...
L324:
	;
	v1299 = l2 + int32(22632)
	v1301 = l2 + int32(22120)
	v1303 = l2 + int32(18024)
	v1305 = l2 + int32(24)
	v1307 = l2 + int32(16024)
	v1309 = v44 + int32(44)
	v1354 = int32(4)
	v1366 = v1283
	goto L328
...
L326:
	;
	v4431 = *(*int32)(unsafe.Add(mBase, _consts[155]))
	F_emscripten_builtin_free(m, v44)
	mBase = m.M
	return v4431
L327:
...
L515:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v2692))) = uint8(v2700)
	v2708 = F_tzparse(m, v44+int32(1), v44+int32(54968), v2700)
	mBase = m.M
	if v2708 == v2700 {
		goto L511
	} else {
...
L516:
	...
	v2712 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1255])))
	if int32(0) < v2712 {
		goto L517
	} else {
		goto L518
...
L520:
	;
	v2764 = v44 + int32(73000) + v2724<<(uint(int32(4))%32)
	v2765 = *(*int32)(unsafe.Add(mBase, uint32(v2764)))
	v2766 = v44 + int32(77088) + v2765
	v2767 = int32(0)
	if v2767 < v2723 {
		goto L524
	} else {
...
L582:
	;
	v3257 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1256])))
	v3258 = int32(0)
	if v3218 == v3258 {
		v3385 = v3258
		goto L589
...
L592:
	;
	v3317 = *(*int64)(unsafe.Add(mBase, uint32(v44+int32(54992)+v3279<<(uint(int32(3))%32))))
	v3318 = v3271
	goto L595
L593:
	;
...
L604:
	...
	v3470 = int32(3)
	v3476 = *(*int64)(unsafe.Add(mBase, uint32(v44+int32(54992)+v3432<<(uint(v3470)%32))))
	v3477 = v3469
	goto L606
L605:
	;
	*(*int64)(unsafe.Add(mBase, uint32(v1305+v3428<<(uint(v3470)%32)))) = v3476 + v3531
	...
	v3537 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v44+int32(70992)+v3432))))
...
L621:
	;
	v3822 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l2)+uint32(_consts[1257]))))
...
L663:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l2)+uint32(_consts[1258]))) = v4343
	v4412 = v4092
	goto L327
L664:
	;
...
L667:
	;
	v4143 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l2)+uint32(_consts[1257]))))
...
L681:
	;
	v4294 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l2+int32(18028)+v4249<<(uint(int32(4))%32)))))
	if v4294 != int32(1) {
		v4343 = v4249
		goto L663
	} else {
