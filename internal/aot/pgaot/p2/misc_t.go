...
func F_TransferPredicateLocksToNewTarget(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v23 = v21 - int32(16)
	m.G0 = v23
	v26 = *(*int32)(unsafe.Add(mBase, _consts[824]))
...
L2:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[824]))
...
L4:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[827]))
...
L7:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[824]))
	v51 = *(*int32)(unsafe.Add(mBase, _consts[828]))
	v55 = F_hash_search_with_hash_value(m, v48, int32(1657404), v51, int32(2), v23+int32(13))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L8:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[827]))
...
L10:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _consts[824]))
	v88 = int32(0)
...
L20:
	;
	v94 = *(*int32)(unsafe.Add(mBase, _consts[824]))
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v160))) = v162
	v165 = *(*int32)(unsafe.Add(mBase, _consts[825]))
...
L40:
	;
	v181 = *(*int32)(unsafe.Add(mBase, _consts[825]))
	v182 = int32(4)
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v240))) = v242
	v245 = *(*int32)(unsafe.Add(mBase, _consts[825]))
	v248 = int32(4)
...
L60:
	;
	v292 = *(*int32)(unsafe.Add(mBase, _consts[824]))
...
L80:
	;
	v366 = *(*int32)(unsafe.Add(mBase, _consts[824]))
...
L90:
	;
	v426 = *(*int32)(unsafe.Add(mBase, _consts[827]))
...
L93:
	;
	v431 = *(*int32)(unsafe.Add(mBase, _consts[824]))
	v434 = *(*int32)(unsafe.Add(mBase, _consts[828]))
	v438 = F_hash_search_with_hash_value(m, v431, int32(1657404), v434, int32(1), v23+int32(15))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		goto L1
...
L94:
	;
	v441 = *(*int32)(unsafe.Add(mBase, _consts[827]))
...
func F_t_isalpha_cstr(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v13 != 0 {
			...
			if v12 != int32(1) {
				v17 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1008])))
				if v17 != int32(1) {
					...
					if v34 != 0 {
						...
						if base.Ui32(v35) <= base.Ui32(int32(131071)) {
							v46 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v35)>>(uint(int32(8))%32)))+uint32(_consts[601]))))
							v52 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v35)>>(uint(int32(3))%32))&int32(31)|v46<<(uint(int32(5))%32))+uint32(_consts[601]))))
...
func F_tblspc_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
		F_appendStringInfo(m, l0, int32(725557), v7)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return
	...
	case 16:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v22
		F_appendStringInfo(m, l0, int32(64331), v7+int32(16))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return
...
L8:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[99]))
...
L12:
	;
	v50 = *(*int32)(unsafe.Add(mBase, _consts[99]))
...
func F_timeofday(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v5)+8)) = v10
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1066]))
	...
	if v23 != 0 {
		...
		v24 = F_pg_strftime(m, v5+int32(144), int32(128), int32(529456), v20)
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
				...
				if v158 != 0 {
					...
					if v161 != 0 {
						...
						if v165 != 0 {
							...
							F_errfinish(m, int32(515856), int32(6550), int32(247200))
							mBase = m.M
							v170 = m.ExcPending
							if v170 != 0 {
								return int64(0)
						...
						if v177 != 0 {
							...
							if v180 != 0 {
								...
								if v184 != 0 {
									...
									F_errfinish(m, int32(515856), int32(6554), int32(247200))
									mBase = m.M
									v189 = m.ExcPending
									if v189 != 0 {
										return int64(0)
...
func F_timetztypmodout(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	if int32(0) <= v7 {
		*(*int32)(unsafe.Add(mBase, uint32(v5)+4)) = int32(387878)
...
func F_tokenize_error_callback(m *base.Module, l0 int32) {
	...
	if v9 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v5))) = base.I64_rotl(v10, int64(32))
		F_errcontext_msg(m, int32(744181), v5)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
					...
					default:
						...
						if v28 != 0 {
							...
							if v31 != 0 {
								...
								F_errmsg(m, int32(362348), int32(0))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(518884), int32(74), int32(92003))
									mBase = m.M
									v40 = m.ExcPending
									if v40 != 0 {
										return int32(0)
...
L100:
	;
	F_errmsg(m, int32(154105), int32(0))
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L6
...
L124:
	;
	F_errmsg_internal(m, int32(353303), int32(0))
	mBase = m.M
	v593 = m.ExcPending
	if v593 != 0 {
		goto L6
...
L125:
	;
	F_errfinish(m, int32(519109), int32(3187), int32(275874))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L6
...
L127:
	;
	F_errfinish(m, int32(519109), int32(3120), int32(374873))
	mBase = m.M
	v605 = m.ExcPending
	if v605 != 0 {
		goto L6
...
L132:
	;
	F_errfinish(m, int32(519109), int32(3149), int32(374873))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L6
...
func F_truncate_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if v15 != 0 {
		*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = int32(372515)
...
L20:
	...
	v100 = *(*float64)(unsafe.Add(mBase, _consts[484]))
	if l4 != 0 {
		goto L37
	} else {
		goto L38
...
L39:
	...
	v110 = float64(0)
	v113 = *(*float64)(unsafe.Add(mBase, _consts[488]))
...
L42:
	...
	v143 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
...
L49:
	;
	v161 = *(*float64)(unsafe.Add(mBase, _consts[485]))
...
L1:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[158]))
	return v48
L2:
	;
	goto L3
...
L6:
	...
	v60 = v58 - int32(1056)
	m.G0 = v60
	v63 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1258])))
	if v63 == int32(0) {
		goto L7
	} else {
		goto L8
...
L12:
	;
	v193 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1258])) = uint8(v193)
	goto L9
L13:
	;
...
L32:
	;
	v123 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1259])))
	if v123 == int32(0) {
		v151 = v75
		v152 = v74
		v153 = v83
...
L64:
	;
	v245 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1260])))
	if v245 == int32(0) {
		v273 = v198
		v274 = v197
		v275 = v205
...
L219:
	;
	v954 = *(*int32)(unsafe.Add(mBase, _consts[158]))
	v955 = v954
	goto L221
L220:
	;
...
L224:
	;
	v4039 = *(*int32)(unsafe.Add(mBase, _consts[158]))
	F_emscripten_builtin_free(m, v44)
	mBase = m.M
	return v4039
L225:
...
L414:
	...
	v2376 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1261])))
	if int32(0) < v2376 {
		goto L415
	} else {
		goto L416
...
L463:
	;
	v2865 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1262])))
	v2866 = int32(0)
	if v2826 == v2866 {
		v2993 = v2866
		goto L470
...
L502:
	;
	v3430 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l2)+uint32(_consts[1263]))))
...
L544:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l2)+uint32(_consts[1264]))) = v3951
	v4020 = v3700
	goto L225
L545:
	;
...
L548:
	;
	v3751 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l2)+uint32(_consts[1263]))))
