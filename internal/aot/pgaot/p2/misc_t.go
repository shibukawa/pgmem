...
L7:
	...
	v55 = F_hash_search_with_hash_value(m, v48, int32(1628652), v51, int32(2), v23+int32(13))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L93:
	...
	v438 = F_hash_search_with_hash_value(m, v431, int32(1628652), v434, int32(1), v23+int32(15))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		goto L1
...
func F_tblspc_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
		F_appendStringInfo(m, l0, int32(697207), v7)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return
	...
	case 16:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v22
		F_appendStringInfo(m, l0, int32(59399), v7+int32(16))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return
...
func F_timeofday(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v5)+8)) = v10
	...
	if v23 != 0 {
		...
		v24 = F_pg_strftime(m, v5+int32(144), int32(128), int32(507917), v20)
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
				...
				if v158 != 0 {
					...
					if v161 != 0 {
						...
						if v165 != 0 {
							...
							F_errfinish(m, int32(495596), int32(6550), int32(236981))
							mBase = m.M
							v170 = m.ExcPending
							if v170 != 0 {
								return int64(0)
						...
						if v177 != 0 {
							...
							if v180 != 0 {
								...
								if v184 != 0 {
									...
									F_errfinish(m, int32(495596), int32(6554), int32(236981))
									mBase = m.M
									v189 = m.ExcPending
									if v189 != 0 {
										return int64(0)
...
func F_timetztypmodout(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	if int32(0) <= v7 {
		*(*int32)(unsafe.Add(mBase, uint32(v5)+4)) = int32(372342)
...
func F_tokenize_error_callback(m *base.Module, l0 int32) {
	...
	if v9 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v5))) = base.I64_rotl(v10, int64(32))
		F_errcontext_msg(m, int32(715655), v5)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
					...
					default:
						...
						if v28 != 0 {
							...
							if v31 != 0 {
								...
								F_errmsg(m, int32(347416), int32(0))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(498174), int32(74), int32(86195))
									mBase = m.M
									v40 = m.ExcPending
									if v40 != 0 {
										return int32(0)
...
L100:
	;
	F_errmsg(m, int32(146420), int32(0))
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L6
...
L124:
	;
	F_errmsg_internal(m, int32(338941), int32(0))
	mBase = m.M
	v593 = m.ExcPending
	if v593 != 0 {
		goto L6
...
L125:
	;
	F_errfinish(m, int32(498399), int32(3187), int32(264935))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L6
...
L127:
	;
	F_errfinish(m, int32(498399), int32(3120), int32(359545))
	mBase = m.M
	v605 = m.ExcPending
	if v605 != 0 {
		goto L6
...
L132:
	;
	F_errfinish(m, int32(498399), int32(3149), int32(359545))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L6
...
func F_truncate_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if v15 != 0 {
		*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = int32(357207)
...
L32:
	;
	v123 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1256])))
	if v123 == int32(0) {
		v151 = v75
		v152 = v74
		v153 = v83
