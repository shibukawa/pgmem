...
func F_TransferPredicateLocksToNewTarget(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v23 = v21 - int32(16)
	m.G0 = v23
	v26 = *(*int32)(unsafe.Add(mBase, _consts[822]))
...
L7:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[822]))
	v51 = *(*int32)(unsafe.Add(mBase, _consts[826]))
	v55 = F_hash_search_with_hash_value(m, v48, int32(1629468), v51, int32(2), v23+int32(13))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L8:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[825]))
...
L10:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _consts[822]))
	v88 = int32(0)
...
L20:
	;
	v94 = *(*int32)(unsafe.Add(mBase, _consts[822]))
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v160))) = v162
	v165 = *(*int32)(unsafe.Add(mBase, _consts[823]))
...
L40:
	;
	v181 = *(*int32)(unsafe.Add(mBase, _consts[823]))
	v182 = int32(4)
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v240))) = v242
	v245 = *(*int32)(unsafe.Add(mBase, _consts[823]))
	v248 = int32(4)
...
L60:
	;
	v292 = *(*int32)(unsafe.Add(mBase, _consts[822]))
...
L80:
	;
	v366 = *(*int32)(unsafe.Add(mBase, _consts[822]))
...
L90:
	;
	v426 = *(*int32)(unsafe.Add(mBase, _consts[825]))
...
L93:
	;
	v431 = *(*int32)(unsafe.Add(mBase, _consts[822]))
	v434 = *(*int32)(unsafe.Add(mBase, _consts[826]))
	v438 = F_hash_search_with_hash_value(m, v431, int32(1629468), v434, int32(1), v23+int32(15))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		goto L1
...
L94:
	;
	v441 = *(*int32)(unsafe.Add(mBase, _consts[825]))
...
func F_t_isalpha_cstr(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v13 != 0 {
			...
			if v12 != int32(1) {
				v17 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1006])))
				if v17 != int32(1) {
...
func F_tblspc_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
		F_appendStringInfo(m, l0, int32(697956), v7)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return
...
func F_timeofday(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v5)+8)) = v10
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1064]))
	...
	if v23 != 0 {
		...
		v24 = F_pg_strftime(m, v5+int32(144), int32(128), int32(508638), v20)
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
				...
				if v158 != 0 {
					...
					if v161 != 0 {
						...
						if v165 != 0 {
							...
							F_errfinish(m, int32(496282), int32(6550), int32(237274))
							mBase = m.M
							v170 = m.ExcPending
							if v170 != 0 {
								return int64(0)
						...
						if v177 != 0 {
							...
							if v180 != 0 {
								...
								if v184 != 0 {
									...
									F_errfinish(m, int32(496282), int32(6554), int32(237274))
									mBase = m.M
									v189 = m.ExcPending
									if v189 != 0 {
										return int64(0)
...
func F_timetztypmodout(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	if int32(0) <= v7 {
		*(*int32)(unsafe.Add(mBase, uint32(v5)+4)) = int32(372950)
...
func F_tokenize_error_callback(m *base.Module, l0 int32) {
	...
	if v9 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v5))) = base.I64_rotl(v10, int64(32))
		F_errcontext_msg(m, int32(716404), v5)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
					...
					default:
						...
						if v28 != 0 {
							...
							if v31 != 0 {
								...
								F_errmsg(m, int32(348024), int32(0))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(498877), int32(74), int32(86268))
									mBase = m.M
									v40 = m.ExcPending
									if v40 != 0 {
										return int32(0)
...
L100:
	;
	F_errmsg(m, int32(146589), int32(0))
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L6
...
L124:
	;
	F_errmsg_internal(m, int32(339425), int32(0))
	mBase = m.M
	v593 = m.ExcPending
	if v593 != 0 {
		goto L6
...
L125:
	;
	F_errfinish(m, int32(499102), int32(3187), int32(265319))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L6
...
L127:
	;
	F_errfinish(m, int32(499102), int32(3120), int32(360153))
	mBase = m.M
	v605 = m.ExcPending
	if v605 != 0 {
		goto L6
...
L132:
	;
	F_errfinish(m, int32(499102), int32(3149), int32(360153))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L6
...
func F_truncate_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if v15 != 0 {
		*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = int32(357815)
...
L20:
	...
	v100 = *(*float64)(unsafe.Add(mBase, _consts[486]))
	if l4 != 0 {
		goto L37
	} else {
		goto L38
...
L39:
	...
	v110 = float64(0)
	v113 = *(*float64)(unsafe.Add(mBase, _consts[490]))
...
L42:
	...
	v143 = int32(*(*uint8)(unsafe.Add(mBase, _consts[491])))
...
L49:
	;
	v161 = *(*float64)(unsafe.Add(mBase, _consts[487]))
...
L6:
	...
	v60 = v58 - int32(1056)
	m.G0 = v60
	v63 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1257])))
	if v63 == int32(0) {
		goto L7
	} else {
		goto L8
...
L12:
	;
	v193 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1257])) = uint8(v193)
	goto L9
L13:
	;
...
L32:
	;
	v123 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1258])))
	if v123 == int32(0) {
		v151 = v75
		v152 = v74
		v153 = v83
