...
L33:
	;
	v102 = int32(_a_F_plpgsql_dumptree_14)
	goto L35
L34:
	;
	v102 = int32(_a_F_plpgsql_dumptree_15)
	goto L35
L35:
	;
...
L50:
	;
	v154 = int32(_a_F_plpgsql_dumptree_14)
	goto L52
L51:
	;
	v154 = int32(_a_F_plpgsql_dumptree_15)
	goto L52
L52:
	;
...
L81:
	;
	v281 = int32(_a_F_plpgsql_dumptree_14)
	goto L83
L82:
	;
	v281 = int32(_a_F_plpgsql_dumptree_15)
	goto L83
L83:
	;
...
L92:
	;
	v357 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_dumptree[1]))
...
func F_plpgsql_estate_setup(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+72)) = v54
	...
	if v58 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v69)+16)) = int32(_a_F_plpgsql_estate_setup_2)
		v72 = int32(0)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v74)+28)) = v77
		...
		if v80 == v72 {
			*(*int64)(unsafe.Add(mBase, uint32(v11)+16)) = int64(103079215120)
			v92 = F_hash_create(m, int32(_a_F_plpgsql_estate_setup_3), int32(16), v11, int32(40))
			mBase = m.M
			v93 = m.ExcPending
			if v93 != 0 {
				return
			} else {
				*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[2])) = v92
				if l3 != 0 {
					*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = l3
					*(*int64)(unsafe.Add(mBase, uint32(v11)+16)) = int64(137438953488)
					v100 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[1]))
					*(*int32)(unsafe.Add(mBase, uint32(v11)+40)) = v100
					v105 = F_hash_create(m, int32(_a_F_plpgsql_estate_setup_4), int32(16), v11, int32(1064))
					mBase = m.M
					v106 = m.ExcPending
					if v106 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(l0)+92)) = v127
						v130 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[3]))
						v131 = int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(l0)+84)) = v135
						v138 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[1]))
						v139 = int64(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(l0)+136)) = v141
						...
						if v151 != 0 {
							...
							v153 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[4]))
							v154 = *(*int32)(unsafe.Add(mBase, uint32(v153)))
							if v154 == int32(0) {
								m.G0 = v11 + int32(48)
								return
							} else {
								*(*int32)(unsafe.Add(mBase, uint32(v154)+36)) = int32(_a_F_plpgsql_estate_setup_5)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+32)) = int32(_a_F_plpgsql_estate_setup_6)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+28)) = int32(_a_F_plpgsql_estate_setup_7)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+24)) = int32(_a_F_plpgsql_estate_setup_8)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+20)) = int32(_a_F_plpgsql_estate_setup_9)
					...
					v110 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[5]))
					*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v110
					v114 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[6]))
					if v114 != 0 {
						v127 = v114
						*(*int32)(unsafe.Add(mBase, uint32(l0)+92)) = v127
						v130 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[3]))
						...
						*(*int64)(unsafe.Add(mBase, uint32(v11)+16)) = int64(137438953488)
						v124 = F_hash_create(m, int32(_a_F_plpgsql_estate_setup_10), int32(16), v11, int32(40))
						mBase = m.M
						v125 = m.ExcPending
						if v125 != 0 {
							return
						} else {
							*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[6])) = v124
							v127 = v124
							*(*int32)(unsafe.Add(mBase, uint32(l0)+92)) = v127
							v130 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_estate_setup[3]))
							v131 = int32(0)
	...
	default:
		...
		if v64 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v11))) = v65
			F_errmsg_internal(m, int32(_a_F_plpgsql_exec_get_datum_type_info_1), v11)
			mBase = m.M
			v70 = m.ExcPending
			if v70 != 0 {
				return
							...
							if v98 != 0 {
								...
								if v101 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v102
									F_errmsg(m, int32(_a_F_plpgsql_exec_get_datum_type_info_5), v11+int32(16))
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return
...
L36:
	;
	v184 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[1]))
	if v184 == int32(0) {
		goto L30
	} else {
		goto L37
...
L54:
	;
	v228 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[1]))
...
L56:
	;
	v235 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[1]))
...
L62:
	;
	v265 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[1]))
	if v265 == int32(0) {
		goto L30
	} else {
		goto L63
...
L80:
	;
	v309 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[1]))
...
L82:
	;
	v316 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[1]))
...
L84:
	;
	v344 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[2]))
...
L85:
	;
	v384 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[3]))
	if v384 != 0 {
		goto L97
	} else {
		goto L98
...
L93:
	;
	v364 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[2]))
...
L101:
	;
	v392 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[2]))
...
L111:
	;
	v493 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[2]))
...
L123:
	;
	v442 = F_convert_tuples_by_position(m, v437, v439, int32(_a_F_plpgsql_exec_trigger_9))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L1
...
L131:
	...
	v476 = F_convert_tuples_by_position(m, v471, v474, int32(_a_F_plpgsql_exec_trigger_9))
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L1
...
L142:
	;
	v506 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[4]))
...
L146:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[4])) = v507
...
L148:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_trigger[0])) = v533
	m.G0 = v11 + int32(176)
	return v489
L149:
	;
...
L2:
	;
	v8 = int32(_a_F_plpgsql_ns_push_0)
	goto L3
L3:
	;
	v9 = F_strlen(m, v8)
					...
					if v42 != 0 {
						...
						if v45 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v40
							F_errmsg(m, int32(_a_F_plpgsql_param_eval_generic_1), v8)
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return
