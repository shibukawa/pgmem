...
func F_plpgsql_dumptree(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+272)) = v13
	F_pg_printf(m, int32(786923), v11+int32(272))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L2:
	;
	F_pg_printf(m, int32(787064), int32(0))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L6:
	;
	F_pg_printf(m, int32(786844), int32(0))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+256)) = v36
	F_pg_printf(m, int32(778480), v11+int32(256))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v49
	F_pg_printf(m, int32(783972), v11+int32(32))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L1
...
L12:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11)+240)) = v295
	F_pg_printf(m, int32(784174), v11+int32(240))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+224)) = v230
	F_pg_printf(m, int32(779363), v11+int32(224))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L1
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+144)) = v50
	F_pg_printf(m, int32(783998), v11+int32(144))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L1
...
L17:
	;
	F_pg_printf(m, int32(784802), int32(0))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L21:
	;
	F_pg_printf(m, int32(784925), int32(0))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L1
...
L25:
	;
	F_pg_printf(m, int32(776853), int32(0))
	mBase = m.M
	v82 = m.ExcPending
	if v82 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+128)) = v84
	F_pg_printf(m, int32(717071), v11+int32(128))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+96)) = v120
	F_pg_printf(m, int32(783877), v11+int32(96))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L1
...
L43:
	;
	F_pg_printf(m, int32(777016), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L1
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v171
	F_pg_printf(m, int32(784075), v11+int32(48))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L1
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+160)) = v203
	F_pg_printf(m, int32(492993), v11+int32(160))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L1
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+208)) = v263
	F_pg_printf(m, int32(717071), v11+int32(208))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v339
	F_pg_printf(m, int32(572698), v11+int32(16))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L1
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v350
	F_pg_printf(m, int32(789709), v11)
	mBase = m.M
	v355 = m.ExcPending
	if v355 != 0 {
		goto L1
...
func F_plpgsql_estate_setup(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+72)) = v54
	...
	if v58 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v57))) = int32(7312)
		v64 = *(*int32)(unsafe.Add(mBase, uint32(l0)+76))
		*(*int32)(unsafe.Add(mBase, uint32(v64)+8)) = int32(7313)
				...
				*(*int32)(unsafe.Add(mBase, _consts[1305])) = v92
				if l3 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11)+40)) = v100
					v105 = F_hash_create(m, int32(417337), int32(16), v11, int32(1064))
					mBase = m.M
					v106 = m.ExcPending
					if v106 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(l0)+136)) = v141
						...
						if v151 != 0 {
							...
							if v154 == int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v154)+36)) = int32(7314)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+32)) = int32(7315)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+28)) = int32(7316)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+24)) = int32(7317)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+20)) = int32(7311)
					...
					*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v110
					...
					if v114 != 0 {
						...
						*(*int64)(unsafe.Add(mBase, uint32(v11)+16)) = int64(137438953488)
						v124 = F_hash_create(m, int32(417364), int32(16), v11, int32(40))
						mBase = m.M
						v125 = m.ExcPending
						if v125 != 0 {
							return
		...
		if v64 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v11))) = v65
			...
			if v70 != 0 {
				...
				F_errfinish(m, int32(523832), int32(5601), int32(253686))
				mBase = m.M
				v77 = m.ExcPending
				if v77 != 0 {
					return
							...
							if v98 != 0 {
								...
								if v101 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v102
									F_errmsg(m, int32(755522), v11+int32(16))
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return
									} else {
										F_errfinish(m, int32(523832), int32(5590), int32(253686))
										mBase = m.M
										v118 = m.ExcPending
										if v118 != 0 {
											return
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+24)) = int32(7311)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+36)) = l1
	*(*int32)(unsafe.Add(mBase, uint32(v11)+164)) = int32(369579)
	v27 = int32(4547032)
...
L26:
	;
	F_errmsg_internal(m, int32(563541), int32(0))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(523832), int32(1030), int32(234673))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L1
...
L123:
	;
	v442 = F_convert_tuples_by_position(m, v437, v439, int32(412102))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L1
...
L131:
	...
	v476 = F_convert_tuples_by_position(m, v471, v474, int32(412102))
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L1
...
L155:
	;
	F_errfinish(m, int32(523832), int32(1059), int32(234673))
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L1
...
L159:
	;
	F_errfinish(m, int32(523832), int32(1067), int32(234673))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L1
						...
						if v45 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v40
							...
							if v52 != 0 {
								...
								F_errfinish(m, int32(523832), int32(6843), int32(512126))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return
...
L55:
	;
	F_errfinish(m, int32(518898), int32(2141), int32(262840))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L52
