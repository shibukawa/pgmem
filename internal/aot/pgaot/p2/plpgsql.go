...
func F_plpgsql_dumptree(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+272)) = v13
	F_pg_printf(m, int32(735444), v11+int32(272))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L2:
	;
	F_pg_printf(m, int32(735585), int32(0))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L6:
	;
	F_pg_printf(m, int32(735365), int32(0))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+256)) = v36
	F_pg_printf(m, int32(727032), v11+int32(256))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v49
	F_pg_printf(m, int32(732519), v11+int32(32))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L1
...
L12:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11)+240)) = v295
	F_pg_printf(m, int32(732721), v11+int32(240))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+224)) = v230
	F_pg_printf(m, int32(727910), v11+int32(224))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L1
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+144)) = v50
	F_pg_printf(m, int32(732545), v11+int32(144))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L1
...
L17:
	;
	F_pg_printf(m, int32(733323), int32(0))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L21:
	;
	F_pg_printf(m, int32(733446), int32(0))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L1
...
L25:
	;
	F_pg_printf(m, int32(725405), int32(0))
	mBase = m.M
	v82 = m.ExcPending
	if v82 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+128)) = v84
	F_pg_printf(m, int32(668604), v11+int32(128))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+96)) = v120
	F_pg_printf(m, int32(732424), v11+int32(96))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L1
...
L43:
	;
	F_pg_printf(m, int32(725568), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L1
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v171
	F_pg_printf(m, int32(732622), v11+int32(48))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L1
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+160)) = v203
	F_pg_printf(m, int32(469071), v11+int32(160))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L1
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+208)) = v263
	F_pg_printf(m, int32(668604), v11+int32(208))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v339
	F_pg_printf(m, int32(543997), v11+int32(16))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L1
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v350
	F_pg_printf(m, int32(738230), v11)
	mBase = m.M
	v355 = m.ExcPending
	if v355 != 0 {
		goto L1
...
func F_plpgsql_estate_setup(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+72)) = v54
	...
	if v58 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v57))) = int32(6635)
		v64 = *(*int32)(unsafe.Add(mBase, uint32(l0)+76))
		*(*int32)(unsafe.Add(mBase, uint32(v64)+8)) = int32(6636)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v74)+28)) = v77
		v80 = *(*int32)(unsafe.Add(mBase, _consts[1304]))
		if v80 == v72 {
			*(*int64)(unsafe.Add(mBase, uint32(v11)+16)) = int64(103079215120)
			...
			if v93 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[1304])) = v92
				if l3 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11)+40)) = v100
					...
					if v106 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(l0)+92)) = v127
						v130 = *(*int32)(unsafe.Add(mBase, _consts[1305]))
						v131 = int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(l0)+136)) = v141
						...
						if v151 != 0 {
							...
							v153 = *(*int32)(unsafe.Add(mBase, _consts[1306]))
							v154 = *(*int32)(unsafe.Add(mBase, uint32(v153)))
							if v154 == int32(0) {
								m.G0 = v11 + int32(48)
								return
							} else {
								*(*int32)(unsafe.Add(mBase, uint32(v154)+36)) = int32(6637)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+32)) = int32(6638)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+28)) = int32(6639)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+24)) = int32(6640)
								*(*int32)(unsafe.Add(mBase, uint32(v154)+20)) = int32(6634)
					...
					v110 = *(*int32)(unsafe.Add(mBase, _consts[1307]))
					*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v110
					v114 = *(*int32)(unsafe.Add(mBase, _consts[1308]))
					if v114 != 0 {
						v127 = v114
						*(*int32)(unsafe.Add(mBase, uint32(l0)+92)) = v127
						v130 = *(*int32)(unsafe.Add(mBase, _consts[1305]))
						...
						*(*int64)(unsafe.Add(mBase, uint32(v11)+16)) = int64(137438953488)
						...
						if v125 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[1308])) = v124
							v127 = v124
							*(*int32)(unsafe.Add(mBase, uint32(l0)+92)) = v127
							v130 = *(*int32)(unsafe.Add(mBase, _consts[1305]))
							v131 = int32(0)
		...
		if v64 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v11))) = v65
			...
			if v70 != 0 {
				...
				F_errfinish(m, int32(496817), int32(5601), int32(240658))
				mBase = m.M
				v77 = m.ExcPending
				if v77 != 0 {
					return
							...
							if v98 != 0 {
								...
								if v101 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v102
									F_errmsg(m, int32(704450), v11+int32(16))
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return
									} else {
										F_errfinish(m, int32(496817), int32(5590), int32(240658))
										mBase = m.M
										v118 = m.ExcPending
										if v118 != 0 {
											return
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+24)) = int32(6634)
...
L26:
	;
	F_errmsg_internal(m, int32(535393), int32(0))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(496817), int32(1030), int32(222724))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L1
...
L84:
	;
	v344 = *(*int32)(unsafe.Add(mBase, _consts[1306]))
...
L93:
	;
	v364 = *(*int32)(unsafe.Add(mBase, _consts[1306]))
...
L101:
	;
	v392 = *(*int32)(unsafe.Add(mBase, _consts[1306]))
...
L111:
	;
	v493 = *(*int32)(unsafe.Add(mBase, _consts[1306]))
...
L142:
	;
	v506 = *(*int32)(unsafe.Add(mBase, _consts[1309]))
...
L146:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1309])) = v507
...
L155:
	;
	F_errfinish(m, int32(496817), int32(1059), int32(222724))
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L1
...
L159:
	;
	F_errfinish(m, int32(496817), int32(1067), int32(222724))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L1
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
	v12 = int32(4580164)
	v13 = *(*int32)(unsafe.Add(mBase, _consts[1310]))
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1310])) = v8
	return
L4:
	;
	goto L3
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(0)
	v17 = int32(4580164)
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1310]))
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1310])) = v12
	return
L7:
	;
	goto L6
						...
						if v45 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v40
							...
							if v52 != 0 {
								...
								F_errfinish(m, int32(496817), int32(6843), int32(487330))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return
...
L3:
	...
	v138 = int32(0)
	v139 = int32(348562)
	v143 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1300])))
...
L5:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v21))) = v22
	v30 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1301])))
	if v30 == int32(0) {
		goto L7
	} else {
		goto L8
...
L9:
	;
	v34 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1302])))
	if v34 == int32(0) {
		goto L10
	} else {
		goto L11
...
L40:
	...
	v181 = *(*int32)(unsafe.Add(mBase, uint32(v178)+uint32(_consts[1303])))
	if v181 == int32(0) {
		goto L1
	} else {
		goto L42
...
L55:
	;
	F_errfinish(m, int32(492696), int32(2141), int32(249307))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L52
