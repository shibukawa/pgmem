...
L10:
	;
	v180 = *(*int32)(unsafe.Add(mBase, _c_F_AbsoluteConfigLocation[0]))
	v181 = v180
	goto L7
L11:
	;
...
L94:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v190)+64)) = v185
	F_errmsg(m, int32(_a_F_AcquireRewriteLocks_0), v190-int32(-64))
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
		goto L16
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v190)+80)) = v185
	F_errmsg(m, int32(_a_F_AcquireRewriteLocks_0), v190+int32(80))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L16
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v190))) = v385
	F_errmsg_internal(m, int32(_a_F_AcquireRewriteLocks_3), v190)
	mBase = m.M
	v389 = m.ExcPending
	if v389 != 0 {
		goto L16
...
L104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v190)+16)) = v185
	F_errmsg_internal(m, int32(_a_F_AcquireRewriteLocks_4), v190+int32(16))
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L16
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v190)+32)) = v185
	F_errmsg_internal(m, int32(_a_F_AcquireRewriteLocks_5), v190+int32(32))
	mBase = m.M
	v422 = m.ExcPending
	if v422 != 0 {
		goto L16
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v190)+48)) = v185
	F_errmsg_internal(m, int32(_a_F_AcquireRewriteLocks_5), v190+int32(48))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L16
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v171
	F_errmsg_internal(m, int32(_a_F_AcquireRewriteLocks_6), v26)
	mBase = m.M
	v555 = m.ExcPending
	if v555 != 0 {
		goto L16
...
L20:
	;
	v173 = *(*int32)(unsafe.Add(mBase, _c_F_AlterObjectOwner_internal[0]))
	if v173 != 0 {
		goto L62
	} else {
		goto L63
...
L26:
	;
	v53 = *(*int32)(unsafe.Add(mBase, _c_F_AlterObjectOwner_internal[1]))
...
L30:
	;
	v82 = *(*int32)(unsafe.Add(mBase, _c_F_AlterObjectOwner_internal[1]))
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = l1
	v70 = F_pg_snprintf(m, v15+int32(32), int32(64), int32(_a_F_AlterObjectOwner_internal_0), v15+int32(16))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L4
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+4)) = v189 + int32(4)
	F_errmsg_internal(m, int32(_a_F_AlterObjectOwner_internal_1), v15)
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L4
					...
					*(*int32)(unsafe.Add(mBase, uint32(v38)+4)) = v66
					...
					if v72 != 0 {
						...
						*(*uint16)(unsafe.Add(mBase, uint32(v94+v76)+2)) = uint16(v98)
						...
						v103 = v74 + int32(1)
						*(*int32)(unsafe.Add(mBase, _c_F_addWrd[1])) = v103
...
func F_anycompatible_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_anycompatible_in_0)
			F_errmsg(m, int32(_a_F_anycompatible_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_anycompatible_in_2), int32(376), int32(_a_F_anycompatible_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
func F_anycompatiblenonarray_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_anycompatiblenonarray_in_0)
			F_errmsg(m, int32(_a_F_anycompatiblenonarray_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_anycompatiblenonarray_in_2), int32(377), int32(_a_F_anycompatiblenonarray_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
func F_anyelement_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_anyelement_in_0)
			F_errmsg(m, int32(_a_F_anyelement_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_anyelement_in_2), int32(374), int32(_a_F_anyelement_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
func F_anymultirange_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_anymultirange_in_0)
			F_errmsg(m, int32(_a_F_anymultirange_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_anymultirange_in_2), int32(233), int32(_a_F_anymultirange_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
func F_anynonarray_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_anynonarray_in_0)
			F_errmsg(m, int32(_a_F_anynonarray_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_anynonarray_in_2), int32(375), int32(_a_F_anynonarray_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L1:
	;
	v53 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[1]))
	if v53 < int32(0) {
		goto L14
	} else {
		goto L15
...
L10:
	;
	v36 = *(*int64)(unsafe.Add(mBase, _c_F_apply_spooled_messages[3]))
...
L13:
	;
	v60 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[4]))
...
L14:
	...
	mBase = m.M
	*(*int64)(unsafe.Add(mBase, _c_F_apply_spooled_messages[5])) = v57
	goto L16
L15:
	;
	goto L16
...
L24:
	;
	v76 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[6]))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[7])) = v76
	v79 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[0]))
	v80 = *(*int32)(unsafe.Add(mBase, uint32(v79)+32))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+96)) = v80
	*(*int32)(unsafe.Add(mBase, uint32(v11)+100)) = l1
	v84 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[8]))
	v91 = F_pg_snprintf(m, v11+int32(160), int32(1024), int32(_a_F_apply_spooled_messages_4), v11+int32(96))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L8
...
L29:
	;
	v110 = int32(_a_F_apply_spooled_messages_6)
	v111 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[9]))
	v114 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[10]))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[9])) = v114
	v118 = int32(0)
...
L32:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[9])) = v111
	*(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[11])) = v120
	v127 = F_palloc(m, int32(_a_F_apply_spooled_messages_8))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L8
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[7])) = v84
	v134 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_apply_spooled_messages[13])) = uint8(v134)
...
L37:
	;
	v153 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[14]))
	if v153 != 0 {
		goto L39
	} else {
		goto L40
...
L41:
	;
	v157 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[11]))
...
L48:
	;
	v288 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[11]))
	if v288 != 0 {
		goto L77
	} else {
		goto L78
...
L50:
	;
	v170 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[11]))
...
L51:
	;
	v175 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[11]))
...
L52:
	;
	v186 = int32(_a_F_apply_spooled_messages_9)
	v187 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[7]))
	v190 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[8]))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[7])) = v190
...
L53:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[8]))
...
L54:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[7])) = v187
	v208 = v149 + int32(1)
	v210 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[11]))
	if v210 != 0 {
		goto L44
	} else {
		goto L55
...
L55:
	...
	v214 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[1]))
	if v214 < int32(0) {
		goto L57
	} else {
		goto L58
...
L56:
	;
	v221 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[4]))
...
L57:
	...
	mBase = m.M
	*(*int64)(unsafe.Add(mBase, _c_F_apply_spooled_messages[5])) = v218
	goto L59
L58:
	;
	goto L59
...
L67:
	;
	v237 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[8]))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[7])) = v237
	v240 = *(*int32)(unsafe.Add(mBase, _c_F_apply_spooled_messages[0]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+52)) = l1
	v250 = F_pg_snprintf(m, v11+int32(1200), int32(1024), int32(_a_F_apply_spooled_messages_4), v11+int32(48))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L8
...
L3:
	;
	F_errfinish(m, int32(_a_F_assignable_custom_variable_name_0), v343, int32(_a_F_assignable_custom_variable_name_1))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L55
...
L11:
	;
	v217 = *(*int32)(unsafe.Add(mBase, _c_F_assignable_custom_variable_name[0]))
	if v217 == int32(0) {
		goto L61
	} else {
		goto L62
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = l0
	F_errmsg(m, int32(_a_F_assignable_custom_variable_name_3), v13+int32(-48))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L55
...
L90:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+48)) = l0
	F_errmsg(m, int32(_a_F_assignable_custom_variable_name_3), v13+int32(-16))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L55
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v246
	F_errdetail(m, int32(_a_F_assignable_custom_variable_name_5), v13+int32(-32))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L55
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = l0
	F_errmsg(m, int32(_a_F_assignable_custom_variable_name_6), v15)
	mBase = m.M
	v329 = m.ExcPending
	if v329 != 0 {
		goto L55
