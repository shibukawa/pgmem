...
func F_statext_is_kind_built(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if base.Ui32(int32(10)) <= base.Ui32(v13) {
		...
		if int32(base.Ui32(int32(519))>>(uint(v13)%32))&int32(1) == int32(0) {
			...
			v28 = *(*int32)(unsafe.Add(mBase, uint32(v11&int32(255)<<(uint(int32(2))%32))+uint32(_c_F_statext_is_kind_built[0])))
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v87
	F_errmsg_internal(m, int32(_a_F_statext_mcv_deserialize_0), v23)
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L23
...
L52:
	;
	if base.Ui32(int32(_a_F_statext_mcv_deserialize_3)) <= base.Ui32(v118) {
		goto L1
	} else {
		goto L53
	}
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+48)) = v207
	F_errmsg_internal(m, int32(_a_F_statext_mcv_deserialize_4), v23+int32(48))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L23
...
L131:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+80)) = v425
	F_errmsg_internal(m, int32(_a_F_statext_mcv_deserialize_4), v23+int32(80))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L23
...
L152:
	...
	v492 = (v120 + v484) & v491
	v493 = v492 * v118
	v499 = (v118*v491 + int32(55)) & int32(_a_F_statext_mcv_deserialize_5)
...
L177:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+64)) = v574
	F_errmsg_internal(m, int32(_a_F_statext_mcv_deserialize_6), v23-int32(-64))
	mBase = m.M
	v590 = m.ExcPending
	if v590 != 0 {
		goto L23
...
L247:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+112)) = v1011
	F_errmsg_internal(m, int32(_a_F_statext_mcv_deserialize_9), v23+int32(112))
	mBase = m.M
	v1019 = m.ExcPending
	if v1019 != 0 {
		goto L23
...
L250:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+96)) = v1029
	F_errmsg_internal(m, int32(_a_F_statext_mcv_deserialize_10), v23+int32(96))
	mBase = m.M
	v1037 = m.ExcPending
	if v1037 != 0 {
		goto L23
...
L256:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v1060
	F_errmsg_internal(m, int32(_a_F_statext_mcv_deserialize_12), v23+int32(16))
	mBase = m.M
	v1066 = m.ExcPending
	if v1066 != 0 {
		goto L23
...
L262:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+32)) = v1089
	F_errmsg_internal(m, int32(_a_F_statext_mcv_deserialize_14), v23+int32(32))
	mBase = m.M
	v1095 = m.ExcPending
	if v1095 != 0 {
		goto L23
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v82
	F_errmsg_internal(m, int32(_a_F_statext_ndistinct_deserialize_0), v12)
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L17
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v181
	F_errmsg_internal(m, int32(_a_F_statext_ndistinct_deserialize_0), v10+int32(-48))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L17
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v100
	F_errmsg_internal(m, int32(_a_F_statext_ndistinct_deserialize_3), v10+int32(-16))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L17
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v108
	F_errmsg_internal(m, int32(_a_F_statext_ndistinct_deserialize_4), v10+int32(-32))
	mBase = m.M
	v283 = m.ExcPending
	if v283 != 0 {
		goto L17
