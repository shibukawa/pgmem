...
func F_compute_tsvector_stats(m *base.Module, l0 int32, l1 int32, l2 int32, l3 float64) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+84)) = v35
	...
	v45 = v27 * int32(10)
	v49 = F_hash_create(m, int32(373966), v45, v25+int32(44), int32(1224))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L1
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25))) = v45
	F_errmsg_internal(m, int32(458005), v25)
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(475252), int32(343), int32(117777))
	mBase = m.M
	v561 = m.ExcPending
	if v561 != 0 {
		goto L1
...
L115:
	;
	F_errfinish(m, int32(475252), int32(467), int32(372989))
	mBase = m.M
	v714 = m.ExcPending
	if v714 != 0 {
		goto L1
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25))) = base.I32_extend8_s(v32)
	F_errmsg_internal(m, int32(478906), v25)
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L10:
	;
	F_errfinish(m, int32(472897), int32(308), int32(205090))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
