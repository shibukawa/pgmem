...
L485:
	...
	if base.Ui32(int32(_a_F__jumbleNode_0)) < base.Ui32(v734) {
		goto L486
	} else {
		goto L487
	}
...
L750:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1394))) = v1614
	F_errmsg_internal(m, int32(_a_F__jumbleNode_1), v1394)
	mBase = m.M
	v1618 = m.ExcPending
	if v1618 != 0 {
		goto L7
...
L3446:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10212))) = v10292
	F_errmsg_internal(m, int32(_a_F__jumbleNode_4), v10212)
	mBase = m.M
	v10296 = m.ExcPending
	if v10296 != 0 {
		goto L7
