...
func F_sql_compile_callback(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+36)) = v20
	...
	v35 = F_AllocSetContextCreateInternal(m, v30, int32(250271), v6, int32(1024), int32(8192))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L1
...
L2:
	;
	v41 = F_AllocSetContextCreateInternal(m, v35, int32(168390), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L46:
	;
	F_errfinish(m, int32(485377), int32(1187), int32(313370))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L1
		...
		if v8 == int32(0) {
			...
			if v14 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = v15
				F_errcontext_msg(m, int32(678390), v5)
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return
