	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v8
	...
	if v14 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v19
		v25 = F_AllocSetContextCreateInternal(m, v19, int32(59952), int32(0), int32(8192), int32(8388608))
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return int32(0)
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v41)+28)) = v70 + v69
	F_ResourceOwnerRemember(m, v46, v41, int32(1702316))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L4
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v285
	F_errcontext_msg(m, int32(190283), v16)
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L4
...
L98:
	;
	F_errfinish(m, int32(480716), int32(5734), int32(198226))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		goto L4
...
L102:
	;
	F_errmsg(m, int32(485205), int32(0))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L4
...
L104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v328
	F_errcontext_msg(m, int32(190283), v14+int32(-16))
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L4
...
L105:
	;
	F_errfinish(m, int32(480716), int32(5697), int32(198226))
	mBase = m.M
	v339 = m.ExcPending
	if v339 != 0 {
		goto L4
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v349
	F_errmsg_plural(m, int32(263378), int32(140869), v349, v14+int32(-32))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L4
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v360
	F_errcontext_msg(m, int32(190283), v14+int32(-48))
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L4
...
L111:
	;
	F_errfinish(m, int32(480716), int32(5709), int32(198226))
	mBase = m.M
	v371 = m.ExcPending
	if v371 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v69
	F_errmsg_internal(m, int32(467381), v6)
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L45
...
L47:
	;
	F_errfinish(m, int32(475864), int32(1062), int32(252344))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L45
...
L49:
	;
	F_errmsg_internal(m, int32(302824), int32(0))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L45
...
L50:
	;
	F_errfinish(m, int32(475864), int32(889), int32(252344))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L45
...
L15:
	;
	F_errfinish(m, int32(475864), int32(1306), int32(252327))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L13
...
L115:
	;
	F_errfinish(m, int32(475864), int32(350), int32(405451))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		goto L43
