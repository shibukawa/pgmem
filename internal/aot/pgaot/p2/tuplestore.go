		...
		if v9 == int32(0) {
			...
			if v12|l1 != v12 {
				...
				if v60 != 0 {
					...
					F_errmsg_internal(m, int32(156263), int32(0))
					mBase = m.M
					v64 = m.ExcPending
					if v64 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(498160), int32(401), int32(215149))
						mBase = m.M
						v69 = m.ExcPending
						if v69 != 0 {
							return int32(0)
		...
		if base.Ui32(v158) < base.Ui32(int32(2)) {
			...
			if v158 != int32(2) {
				...
				if v243 != 0 {
					...
					F_errmsg_internal(m, int32(352413), int32(0))
					mBase = m.M
					v247 = m.ExcPending
					if v247 != 0 {
						return
					} else {
						F_errfinish(m, int32(498160), int32(1394), int32(215089))
						mBase = m.M
						v252 = m.ExcPending
						if v252 != 0 {
							return
							...
							if v172 == int32(0) {
								...
								if v179 != 0 {
									...
									if v181 != 0 {
										...
										F_errmsg(m, int32(386544), int32(0))
										mBase = m.M
										v185 = m.ExcPending
										if v185 != 0 {
											return
										} else {
											F_errfinish(m, int32(498160), int32(1373), int32(215089))
											mBase = m.M
											v190 = m.ExcPending
											if v190 != 0 {
												return
								...
								if v201 != 0 {
									...
									if v203 != 0 {
										...
										if v207 != 0 {
											...
											F_errfinish(m, int32(498160), int32(1382), int32(215089))
											mBase = m.M
											v212 = m.ExcPending
											if v212 != 0 {
												return
						...
						if v215 != 0 {
							...
							if v217 != 0 {
								...
								if v221 != 0 {
									...
									F_errfinish(m, int32(498160), int32(1025), int32(382802))
									mBase = m.M
									v226 = m.ExcPending
									if v226 != 0 {
										return int32(0)
													...
													if v230 != 0 {
														...
														if v232 != 0 {
															...
															if v236 != 0 {
																...
																F_errfinish(m, int32(498160), int32(1106), int32(382802))
																mBase = m.M
																v241 = m.ExcPending
																if v241 != 0 {
																	return int32(0)
															...
															if v153 != 0 {
																...
																if v155 != 0 {
																	...
																	if v159 != 0 {
																		...
																		F_errfinish(m, int32(498160), int32(1089), int32(382802))
																		mBase = m.M
																		v164 = m.ExcPending
																		if v164 != 0 {
																			return int32(0)
	...
	default:
		...
		if v191 != 0 {
			...
			if v195 != 0 {
				...
				F_errfinish(m, int32(498160), int32(1111), int32(382802))
				mBase = m.M
				v200 = m.ExcPending
				if v200 != 0 {
					return int32(0)
