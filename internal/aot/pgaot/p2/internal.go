						...
						*(*int32)(unsafe.Add(mBase, _consts[0])) = v82
						...
						if v53 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v64
							F_errmsg_internal(m, int32(184495), v8)
							mBase = m.M
							v68 = m.ExcPending
							if v68 != 0 {
								return
							} else {
								F_errfinish(m, int32(485028), int32(3114), int32(422034))
								mBase = m.M
								v73 = m.ExcPending
								if v73 != 0 {
									return
		...
		if int32(1)<<(uint(v17)%32)&int32(5242) == int32(0) {
			...
			if v90 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v101
				F_errmsg_internal(m, int32(184315), v8+int32(16))
				mBase = m.M
				v107 = m.ExcPending
				if v107 != 0 {
					return
				} else {
					F_errfinish(m, int32(485028), int32(4750), int32(254256))
					mBase = m.M
					v112 = m.ExcPending
					if v112 != 0 {
						return
				...
				if v116 != 0 {
					...
					if v119 != 0 {
						...
						if v123 != 0 {
							...
							F_errfinish(m, int32(489090), int32(1951), int32(296180))
							mBase = m.M
							v128 = m.ExcPending
							if v128 != 0 {
								return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(307286)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(485687), int32(373), int32(66232))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L4:
	;
	v13 = *(*int32)(unsafe.Add(mBase, _consts[473]))
...
L9:
	;
	v24 = *(*int32)(unsafe.Add(mBase, _consts[471]))
	if v24 == int32(0) {
		goto L2
	} else {
		goto L12
...
L12:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v24)+4)) = uint8(v27)
	v31 = *(*int32)(unsafe.Add(mBase, _consts[475]))
	v34 = F_internal_flush_buffer(m, v31, int32(4369480), int32(4369484))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L13
...
L15:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[473]))
	v41 = *(*int32)(unsafe.Add(mBase, _consts[474]))
	v42 = v41
	v43 = v39
	goto L11
L16:
...
L17:
	;
	v69 = *(*int32)(unsafe.Add(mBase, _consts[475]))
	v71 = v43 - v42
...
L18:
	;
	v46 = *(*int32)(unsafe.Add(mBase, _consts[476]))
	if v46 != v42 {
		goto L17
	} else {
		goto L19
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = v48
	v51 = *(*int32)(unsafe.Add(mBase, _consts[471]))
	if v51 == v48 {
		goto L1
	} else {
		goto L20
...
L22:
	;
	v64 = *(*int32)(unsafe.Add(mBase, _consts[474]))
	v66 = *(*int32)(unsafe.Add(mBase, _consts[473]))
...
L26:
	;
	v76 = int32(4369484)
	v78 = *(*int32)(unsafe.Add(mBase, _consts[474]))
	v79 = v78 + v73
	*(*int32)(unsafe.Add(mBase, _consts[474])) = v79
	v81 = v17 - v73
