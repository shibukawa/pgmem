						...
						*(*int32)(unsafe.Add(mBase, _consts[0])) = v82
						...
						if v53 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v64
							F_errmsg_internal(m, int32(187374), v8)
							mBase = m.M
							v68 = m.ExcPending
							if v68 != 0 {
								return
							} else {
								F_errfinish(m, int32(493418), int32(3114), int32(429092))
								mBase = m.M
								v73 = m.ExcPending
								if v73 != 0 {
									return
		...
		if int32(1)<<(uint(v17)%32)&int32(5242) == int32(0) {
			...
			if v90 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v101
				F_errmsg_internal(m, int32(187194), v8+int32(16))
				mBase = m.M
				v107 = m.ExcPending
				if v107 != 0 {
					return
				} else {
					F_errfinish(m, int32(493418), int32(4750), int32(258147))
					mBase = m.M
					v112 = m.ExcPending
					if v112 != 0 {
						return
				...
				if v116 != 0 {
					...
					if v119 != 0 {
						...
						if v123 != 0 {
							...
							F_errfinish(m, int32(497562), int32(1951), int32(300980))
							mBase = m.M
							v128 = m.ExcPending
							if v128 != 0 {
								return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(312425)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(494087), int32(373), int32(67155))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L12:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v24)+4)) = uint8(v27)
	...
	v34 = F_internal_flush_buffer(m, v31, int32(4414312), int32(4414316))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L13
