		...
		if v38 != 0 {
			...
			if base.Ui32(int32(19)) < base.Ui32(v41) {
				*(*uint8)(unsafe.Add(mBase, _c_F_BeginInternalSubTransaction[0])) = uint8(v11)
				v82 = *(*int32)(unsafe.Add(mBase, _c_F_BeginInternalSubTransaction[2]))
				*(*int32)(unsafe.Add(mBase, _c_F_BeginInternalSubTransaction[3])) = v82
				m.G0 = v8 + int32(32)
				return
			} else {
				if v41 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _c_F_BeginInternalSubTransaction[3])) = v82
						...
						if v53 != 0 {
							...
							if base.Ui32(v54) <= base.Ui32(int32(19)) {
								v63 = *(*int32)(unsafe.Add(mBase, uint32(v54<<(uint(int32(2))%32))+uint32(_c_F_BeginInternalSubTransaction[4])))
								v64 = v63
							} else {
								v64 = int32(_a_F_BeginInternalSubTransaction_2)
							}
		...
		if int32(1)<<(uint(v17)%32)&int32(_a_F_BeginInternalSubTransaction_6) == int32(0) {
			...
			if v90 != 0 {
				...
				if base.Ui32(v91) <= base.Ui32(int32(19)) {
					v100 = *(*int32)(unsafe.Add(mBase, uint32(v91<<(uint(int32(2))%32))+uint32(_c_F_BeginInternalSubTransaction[4])))
					v101 = v100
				} else {
					v101 = int32(_a_F_BeginInternalSubTransaction_2)
				}
...
func F_internal_out(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_internal_out_0)
			F_errmsg(m, int32(_a_F_internal_out_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_internal_out_2), int32(373), int32(_a_F_internal_out_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L17:
	;
	v69 = *(*int32)(unsafe.Add(mBase, _c_F_internal_putbytes[3]))
	v71 = v43 - v42
...
L26:
	;
	v76 = int32(_a_F_internal_putbytes_1)
	v78 = *(*int32)(unsafe.Add(mBase, _c_F_internal_putbytes[1]))
	v79 = v78 + v73
	*(*int32)(unsafe.Add(mBase, _c_F_internal_putbytes[1])) = v79
	v81 = v17 - v73
