						...
						if v108 != v45 {
							...
							if v142 != 0 {
								...
								*(*uint32)(unsafe.Add(mBase, uint32(v13))) = uint32(v145)
								F_errmsg_internal(m, int32(508422), v13)
								mBase = m.M
								v149 = m.ExcPending
								if v149 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(492645), int32(1712), int32(224387))
									mBase = m.M
									v154 = m.ExcPending
									if v154 != 0 {
										return int32(0)
...
func F_XLogArchiveCleanup(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5)+20)) = int32(368609)
	v16 = F_pg_snprintf(m, v5+int32(32), int32(1024), int32(173996), v5+int32(16))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
		...
		v20 = F_unlink(m, v19)
		mBase = m.M
		*(*int32)(unsafe.Add(mBase, uint32(v5)+4)) = int32(22809)
		*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
		v28 = F_pg_snprintf(m, v19, int32(1024), int32(173996), v5)
		mBase = m.M
		v29 = m.ExcPending
		if v29 != 0 {
			return
...
L19:
	...
	F_s_lock(m, v86+int32(440), int32(492645), int32(2843), int32(318869))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L12
...
L71:
	;
	F_errfinish(m, int32(492206), int32(1425), int32(102614))
	mBase = m.M
	v291 = m.ExcPending
	if v291 != 0 {
		goto L12
...
L107:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v16)+8)) = uint32(v527)
	F_errmsg_internal(m, int32(508660), v16)
	mBase = m.M
	v531 = m.ExcPending
	if v531 != 0 {
		goto L12
...
L108:
	;
	F_errfinish(m, int32(492645), int32(2942), int32(318869))
	mBase = m.M
	v536 = m.ExcPending
	if v536 != 0 {
		goto L12
								...
								if v69 != 0 {
									...
									if v68 == int32(0) {
										...
										*(*uint32)(unsafe.Add(mBase, uint32(v11)+4)) = uint32(v77)
										F_errmsg_internal(m, int32(509510), v11)
										mBase = m.M
										v81 = m.ExcPending
										if v81 != 0 {
											return
										} else {
											F_errfinish(m, int32(488501), int32(800), int32(369354))
											mBase = m.M
											v86 = m.ExcPending
											if v86 != 0 {
												return
	...
	if v16 != 0 {
			...
			if v65 != 0 {
				...
				if v69 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = v74
					F_errdetail_internal(m, int32(610714), v9+int32(16))
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return
					} else {
						F_errfinish(m, int32(487602), int32(428), int32(499770))
						mBase = m.M
						v85 = m.ExcPending
						if v85 != 0 {
							return
				...
				if v89 != 0 {
					...
					if v93 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(65535)
						F_errdetail_internal(m, int32(575410), v9)
						mBase = m.M
						v102 = m.ExcPending
						if v102 != 0 {
							return
						} else {
							F_errfinish(m, int32(487602), int32(433), int32(499770))
							mBase = m.M
							v107 = m.ExcPending
							if v107 != 0 {
								return
		...
		if v50 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l0
			F_errmsg_internal(m, int32(243966), v9+int32(32))
			mBase = m.M
			v56 = m.ExcPending
			if v56 != 0 {
				return
			} else {
				F_errfinish(m, int32(487602), int32(416), int32(499770))
				mBase = m.M
				v61 = m.ExcPending
				if v61 != 0 {
					return
