...
L20:
	;
	F_errfinish(m, int32(469488), int32(107), int32(501074))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L1
...
L22:
	;
	F_errmsg(m, int32(217184), int32(0))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L1
...
L23:
	;
	F_errfinish(m, int32(469488), int32(100), int32(501074))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
func F_px_find_cipher(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v7 = int32(469160)
	v9 = int32(4334560)
	v12 = *(*int32)(unsafe.Add(mBase, _consts[1375]))
	if v12 != 0 {
		goto L4
	} else {
		goto L5
...
L3:
	...
	v34 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1376])))
	if v34 == int32(0) {
		v53 = v33
		v54 = v34
		goto L14
...
L23:
	...
	v66 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1377])))
	if v66 == int32(0) {
		v85 = v65
		v86 = v66
		goto L25
...
L34:
	...
	v98 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1378])))
	if v98 == int32(0) {
		v117 = v97
		v118 = v98
		goto L36
...
L45:
	...
	v130 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1379])))
	if v130 == int32(0) {
		v149 = v129
		v150 = v130
		goto L47
...
L56:
	...
	v162 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1380])))
	if v162 == int32(0) {
		v181 = v161
		v182 = v162
		goto L58
...
L67:
	...
	v194 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1381])))
	if v194 == int32(0) {
		v213 = v193
		v214 = v194
		goto L69
...
L78:
	...
	v226 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1382])))
	if v226 == int32(0) {
		v245 = v225
		v246 = v226
		goto L80
...
L89:
	...
	v258 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1383])))
	if v258 == int32(0) {
		v277 = v257
		v278 = v258
		goto L91
...
L100:
	...
	v290 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1384])))
	if v290 == int32(0) {
		v309 = v289
		v310 = v290
		goto L102
...
L111:
	...
	v322 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1385])))
	if v322 == int32(0) {
		v341 = v321
		v342 = v322
		goto L113
...
L122:
	...
	v354 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1386])))
	if v354 == int32(0) {
		v373 = v353
		v374 = v354
		goto L124
...
L133:
	...
	v387 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1387])))
	if v387 == int32(0) {
		v406 = v386
		v407 = v387
		goto L135
...
L145:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v422)+96)) = v426
	F_ResourceOwnerRemember(m, v426, v422, int32(4335052))
	mBase = m.M
	v430 = m.ExcPending
	if v430 != 0 {
		goto L143
...
L147:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v433)+24)) = int32(5375)
	*(*int32)(unsafe.Add(mBase, uint32(v433)+8)) = int32(5376)
	*(*int32)(unsafe.Add(mBase, uint32(v433)+4)) = int32(5377)
	*(*int32)(unsafe.Add(mBase, uint32(v433))) = int32(5378)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v433)+20)) = int32(5379)
	*(*int32)(unsafe.Add(mBase, uint32(v433)+16)) = int32(5380)
