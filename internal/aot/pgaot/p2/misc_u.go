...
func F_UpdateMinRecoveryPoint(m *base.Module, l0 int64, l1 int32) {
	...
	if v10 != 0 {
		...
		if base.B2i32(l1 == int32(0))&base.B2i32(base.Ui64(v1) <= base.Ui64(v14)) != 0 {
			...
			if v14 != int64(0) {
				v27 = *(*int32)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[2]))
				...
				if v32 != 0 {
					...
					v35 = *(*int32)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[3]))
					v36 = *(*int64)(unsafe.Add(mBase, uint32(v35)+136))
					*(*int64)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[1])) = v36
					if v36 == int64(0) {
						v41 = int32(1)
						*(*uint8)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[0])) = uint8(v41)
						v112 = *(*int32)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[2]))
						...
						if base.B2i32(l1 == int32(0))&base.B2i32(base.Ui64(v1) <= base.Ui64(v36)) != 0 {
							...
							if v50 != 0 {
								...
								if l1 != 0 {
									v77 = *(*int32)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[3]))
									...
									if base.Ui64(v49) <= base.Ui64(v78) {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v77)+144)) = v81
										v84 = *(*int32)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[4]))
										...
										if v86 != 0 {
											...
											*(*int64)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[1])) = v49
				...
				if v20 != int32(1) {
					...
					v24 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _c_F_UpdateMinRecoveryPoint[0])) = uint8(v24)
					m.G0 = v7 + int32(48)
					return
				}
			}
...
func F_uhc_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(_a_F_uhc_to_utf8_0), v18, v18, v18, int32(38), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
L33:
	;
	v99 = F__emscripten_memcpy_bulkmem(m, v94, int32(_a_F_update_node_0), int32(84))
	mBase = m.M
	goto L35
L35:
	;
...
L37:
	;
	v125 = *(*int32)(unsafe.Add(mBase, _c_F_update_node[0]))
