											...
											if v92 != 0 {
												...
												if v91 == int32(0) {
													...
													*(*uint32)(unsafe.Add(mBase, uint32(v7))) = uint32(v99)
													F_errmsg_internal(m, int32(48649), v7)
													mBase = m.M
													v103 = m.ExcPending
													if v103 != 0 {
														return
													} else {
														F_errfinish(m, int32(474748), int32(2769), int32(84569))
														mBase = m.M
														v108 = m.ExcPending
														if v108 != 0 {
															return
										...
										if v55 != 0 {
											...
											if v54 == int32(0) {
												...
												*(*uint32)(unsafe.Add(mBase, uint32(v7)+16)) = uint32(v64)
												F_errmsg_internal(m, int32(487437), v7+int32(16))
												mBase = m.M
												v70 = m.ExcPending
												if v70 != 0 {
													return
												} else {
													F_errfinish(m, int32(474748), int32(2755), int32(84569))
													mBase = m.M
													v75 = m.ExcPending
													if v75 != 0 {
														return
...
func F_uhc_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4332924), v18, v18, v18, int32(38), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
