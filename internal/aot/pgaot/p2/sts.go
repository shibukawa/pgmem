...
func F_sts_end_write(m *base.Module, l0 int32) {
	...
	if v3 != 0 {
		...
		if v7 != 0 {
			...
			v12 = F__emscripten_memset_bulkmem(m, v8, base.I32_extend8_s(int32(0)), int32(_a_F_sts_end_write_0))
			mBase = m.M
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v16 + int32(12)
	v26 = F_pg_snprintf(m, v11+int32(16), int32(1024), int32(_a_F_sts_puttuple_0), v11)
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L4
...
L14:
	...
	v62 = F_MemoryContextAllocZero(m, v60, int32(_a_F_sts_puttuple_2))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L4
...
L16:
	...
	F_BufFileWrite(m, v74, v57, int32(_a_F_sts_puttuple_2))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L4
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62))) = int32(0)
	...
	v69 = v67 + int32(_a_F_sts_puttuple_2)
...
L18:
	...
	v82 = F__emscripten_memset_bulkmem(m, v78, base.I32_extend8_s(int32(0)), int32(_a_F_sts_puttuple_2))
	mBase = m.M
	goto L19
L19:
	;
...
L33:
	...
	F_BufFileWrite(m, v138, v139, int32(_a_F_sts_puttuple_2))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L4
...
L35:
	...
	v147 = F__emscripten_memset_bulkmem(m, v143, base.I32_extend8_s(int32(0)), int32(_a_F_sts_puttuple_2))
	mBase = m.M
	goto L36
L36:
	;
	...
	*(*int32)(unsafe.Add(mBase, uint32(v158))) = v159 + int32(4)
	...
	v167 = base.I32_div_u_s(v133+int32(_a_F_sts_puttuple_3), int32(_a_F_sts_puttuple_4))
