									...
									if v52 != 0 {
										...
										if v55 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
											F_errmsg(m, int32(437879), v8)
											mBase = m.M
											v59 = m.ExcPending
											if v59 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(498617), int32(3330), int32(381969))
												mBase = m.M
												v64 = m.ExcPending
												if v64 != 0 {
													return int32(0)
...
L43:
	;
	v119 = *(*int32)(unsafe.Add(mBase, _consts[159]))
	*(*int32)(unsafe.Add(mBase, _consts[254])) = v119
	goto L46
L44:
	;
	goto L45
...
L46:
	;
	v125 = F_format_elog_string(m, int32(622290), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L30
...
L47:
	;
	*(*int32)(unsafe.Add(mBase, _consts[255])) = v125
	F_pfree(m, v113)
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
...
L49:
	;
	v134 = *(*int32)(unsafe.Add(mBase, _consts[159]))
	*(*int32)(unsafe.Add(mBase, _consts[254])) = v134
	goto L50
L50:
	;
	v140 = F_format_elog_string(m, int32(622247), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L30
...
L51:
	;
	*(*int32)(unsafe.Add(mBase, _consts[255])) = v140
	F_pfree(m, v113)
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
...
L67:
	;
	v173 = *(*int32)(unsafe.Add(mBase, _consts[159]))
	*(*int32)(unsafe.Add(mBase, _consts[254])) = v173
	goto L68
L68:
	;
	v176 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v176
	v180 = F_format_elog_string(m, int32(172513), v10)
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L30
...
L69:
	;
	*(*int32)(unsafe.Add(mBase, _consts[426])) = v180
	v184 = *(*int32)(unsafe.Add(mBase, _consts[159]))
	*(*int32)(unsafe.Add(mBase, _consts[254])) = v184
	goto L70
L70:
	;
	v190 = F_format_elog_string(m, int32(602089), int32(0))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		goto L30
...
L71:
	;
	*(*int32)(unsafe.Add(mBase, _consts[255])) = v190
	v238 = int32(0)
	goto L17
L72:
	;
...
L74:
	;
	v210 = *(*int32)(unsafe.Add(mBase, _consts[159]))
	*(*int32)(unsafe.Add(mBase, _consts[254])) = v210
	goto L75
L75:
	;
	v216 = F_format_elog_string(m, int32(641450), int32(0))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L30
...
L76:
	;
	*(*int32)(unsafe.Add(mBase, _consts[255])) = v216
	v238 = int32(0)
	goto L17
L77:
	;
