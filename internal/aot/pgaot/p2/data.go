...
func F_CreateDataDirLockFile(m *base.Module, l0 int32) {
	...
	F_CreateLockFile(m, int32(433770), l0, int32(757756), int32(1), v6)
	mBase = m.M
	v8 = m.ExcPending
	if v8 != 0 {
		return
...
L98:
	;
	F_XLogRegisterBufData(m, int32(0), int32(4410180), int32(12))
	mBase = m.M
	v360 = m.ExcPending
	if v360 != 0 {
		goto L28
...
L12:
	;
	F_px_debug(m, int32(492309), int32(0))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L9
...
L22:
	;
	v73 = F_pullf_create(m, v15+int32(36), int32(4394916), l0, l2)
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L9
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v56))) = v36
	v63 = F_pullf_create(m, v15+int32(36), int32(4394880), v56, l2)
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L9
...
L40:
	;
	F_px_debug(m, int32(338837), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L9
...
L48:
	;
	v130 = int32(0)
	F_px_debug(m, int32(270897), v130)
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L9
...
L52:
	;
	v135 = int32(0)
	F_px_debug(m, int32(440221), v135)
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L9
...
L58:
	;
	F_px_debug(m, int32(368475), int32(0))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L9
...
L59:
	;
	F_px_debug(m, int32(441876), int32(0))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L9
...
L73:
	;
	v201 = int32(0)
	F_px_debug(m, int32(544965), v201)
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L9
...
L88:
	;
	F_px_debug(m, int32(492372), int32(0))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L9
...
L90:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v220
	F_px_debug(m, int32(466600), v15+int32(32))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L9
...
L114:
	;
	F_px_debug(m, int32(454755), int32(0))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L9
...
L122:
	;
	F_px_debug(m, int32(505008), int32(0))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L9
...
L129:
	;
	F_px_debug(m, int32(492346), int32(0))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L9
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v91
	F_px_debug(m, int32(500736), v15+int32(16))
	mBase = m.M
	v417 = m.ExcPending
	if v417 != 0 {
		goto L9
...
L184:
	;
	v555 = F_mbuf_append(m, l1, int32(746700), int32(1))
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L9
