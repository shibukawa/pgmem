...
L55:
	;
	v187 = v32 + int32(4)
	v189 = v162 & int32(_a_F_tuple_data_split_0)
	v194 = int32(0)
	v196 = v194
	v198 = v194
	v203 = v146
...
L59:
	...
	v403 = int32(0)
	v408 = v146
	v413 = v162 & int32(_a_F_tuple_data_split_0)
	goto L54
L60:
	;
...
L67:
	;
	v380 = v378 + v308
	v384 = *(*int32)(unsafe.Add(mBase, _c_F_tuple_data_split[0]))
...
L69:
	;
	v372 = *(*int32)(unsafe.Add(mBase, _c_F_tuple_data_split[0]))
...
L73:
	...
	v231 = base.B2i32(v229 != int32(_a_F_tuple_data_split_0))
	if v231 == int32(0) {
		goto L76
	} else {
		goto L77
...
L135:
	;
	v424 = *(*int32)(unsafe.Add(mBase, _c_F_tuple_data_split[0]))
