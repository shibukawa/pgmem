...
L5:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(1), int32(426500), int32(26))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L6:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(2), int32(261052), int32(25))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L7:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(3), int32(335638), int32(20))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L1
...
L8:
	;
	v54 = F_begin_tup_output_tupdesc(m, v33, v36, int32(1592100))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L1
				...
				if v20 < int32(0) {
					...
					if v68 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v75
						F_errmsg(m, int32(294384), v9)
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return
						} else {
							F_errhint(m, int32(619173), int32(0))
							mBase = m.M
							v83 = m.ExcPending
							if v83 != 0 {
								return
							} else {
								F_errfinish(m, int32(486704), int32(268), int32(118416))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v38
						...
						if v48 != 0 {
							...
							if v52 != 0 {
								...
								F_errfinish(m, int32(486704), int32(275), int32(118416))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
