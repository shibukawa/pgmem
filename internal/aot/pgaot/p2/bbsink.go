...
L5:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(1), int32(434708), int32(26))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L6:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(2), int32(265727), int32(25))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L7:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(3), int32(342287), int32(20))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L1
...
L8:
	;
	v54 = F_begin_tup_output_tupdesc(m, v33, v36, int32(1619316))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L1
...
func F_bbsink_copystream_manifest_contents(m *base.Module, l0 int32, l1 int32) {
	...
	if v3 == int32(1) {
		...
		v11 = *(*int32)(unsafe.Add(mBase, _consts[268]))
...
func F_bbsink_progress_begin_backup(m *base.Module, l0 int32) {
	...
	v7 = v5 - int32(48)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[269]))
	*(*int32)(unsafe.Add(mBase, uint32(v7)+40)) = v10
	v13 = *(*int64)(unsafe.Add(mBase, _consts[270]))
				...
				if v20 < int32(0) {
					...
					if v68 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v75
						F_errmsg(m, int32(299924), v9)
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return
						} else {
							F_errhint(m, int32(645774), int32(0))
							mBase = m.M
							v83 = m.ExcPending
							if v83 != 0 {
								return
							} else {
								F_errfinish(m, int32(496334), int32(268), int32(120844))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return
					...
					if v31 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v38
						F_errmsg(m, int32(41519), v9+int32(16))
						mBase = m.M
						v48 = m.ExcPending
						if v48 != 0 {
							return
							...
							if v52 != 0 {
								...
								F_errfinish(m, int32(496334), int32(275), int32(120844))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
