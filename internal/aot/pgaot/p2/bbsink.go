...
L5:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(1), int32(412843), int32(26))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L6:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(2), int32(252455), int32(25))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L7:
	;
	F_TupleDescInitBuiltinEntry(m, v36, int32(3), int32(324545), int32(20))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L1
...
L8:
	;
	v54 = F_begin_tup_output_tupdesc(m, v33, v36, int32(1575684))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L1
				...
				if v20 < int32(0) {
					...
					if v68 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v75
						F_errmsg(m, int32(284447), v9)
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return
						} else {
							F_errhint(m, int32(603356), int32(0))
							mBase = m.M
							v83 = m.ExcPending
							if v83 != 0 {
								return
							} else {
								F_errfinish(m, int32(472034), int32(268), int32(112471))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return
					...
					if v31 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v38
						F_errmsg(m, int32(38825), v9+int32(16))
						mBase = m.M
						v48 = m.ExcPending
						if v48 != 0 {
							return
							...
							if v52 != 0 {
								...
								F_errfinish(m, int32(472034), int32(275), int32(112471))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
