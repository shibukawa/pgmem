...
func F_ProcessStartupProcInterrupts(m *base.Module) {
	...
	_ = v160
	v1 = int32(0)
	v9 = *(*int32)(unsafe.Add(mBase, _consts[576]))
	if v9 == v1 {
		goto L1
	} else {
		goto L2
...
L4:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _consts[578]))
	v21 = F_pstrdup(m, v20)
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
...
L5:
	;
	v24 = int32(*(*uint8)(unsafe.Add(mBase, _consts[579])))
...
L6:
	;
	v29 = *(*int32)(unsafe.Add(mBase, _consts[577]))
...
L7:
	;
	v56 = *(*int32)(unsafe.Add(mBase, _consts[578]))
...
L25:
	;
	v84 = int32(*(*uint8)(unsafe.Add(mBase, _consts[579])))
...
L28:
	;
	v96 = *(*int32)(unsafe.Add(mBase, _consts[580]))
	if v96 != int32(3) {
		goto L29
	} else {
		goto L30
...
L34:
	;
	F_errmsg(m, int32(458648), int32(0))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L3
...
L36:
	;
	v117 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[581])) = uint8(v117)
	goto L29
L37:
	;
	F_errfinish(m, int32(511477), int32(4422), int32(87835))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L3
...
L43:
	;
	v148 = *(*int32)(unsafe.Add(mBase, _consts[520]))
	if v148 != 0 {
		goto L48
	} else {
		goto L49
...
L44:
	;
	v134 = int32(4457764)
	v136 = *(*int32)(unsafe.Add(mBase, _consts[582]))
	*(*int32)(unsafe.Add(mBase, _consts[582])) = v136 + int32(1)
...
L50:
	;
	v152 = *(*int32)(unsafe.Add(mBase, _consts[523]))
	if v152 != 0 {
		goto L52
	} else {
		goto L53
...
func F_disable_startup_progress_timeout(m *base.Module) {
	...
	var v5 int32
	_ = v5
	v2 = *(*int32)(unsafe.Add(mBase, _consts[584]))
	if v2 != 0 {
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28))) = int32(170169)
	v35 = v13 + int32(12)
...
func F_startup_progress_timeout_handler(m *base.Module) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _consts[583])) = int32(1)
	return
}
