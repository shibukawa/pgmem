...
L1:
	;
	v127 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[1]))
	if v127 == int32(0) {
		goto L40
	} else {
		goto L41
...
L7:
	;
	v56 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[3]))
...
L25:
	;
	v84 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[4])))
...
L28:
	;
	v96 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[5]))
	if v96 != int32(3) {
		goto L29
	} else {
		goto L30
...
L36:
	;
	v117 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[6])) = uint8(v117)
	goto L29
L37:
	;
...
L40:
	;
	v131 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[7])))
	if v131 != int32(1) {
		goto L43
	} else {
		goto L44
...
L43:
	;
	v148 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[8]))
	if v148 != 0 {
		goto L48
	} else {
		goto L49
...
L44:
	;
	v134 = int32(_a_F_ProcessStartupProcInterrupts_4)
	v136 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[9]))
	*(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[9])) = v136 + int32(1)
...
L50:
	;
	v152 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupProcInterrupts[10]))
	if v152 != 0 {
		goto L52
	} else {
		goto L53
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84))) = int32(_a_F_process_startup_options_0)
	v91 = v13 + int32(12)
