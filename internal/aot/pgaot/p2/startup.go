...
L1:
	;
	v127 = *(*int32)(unsafe.Add(mBase, _consts[234]))
	if v127 == int32(0) {
		goto L40
	} else {
		goto L41
...
L34:
	;
	F_errmsg(m, int32(441053), int32(0))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L3
...
L37:
	;
	F_errfinish(m, int32(492170), int32(4422), int32(82059))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L3
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28))) = int32(161637)
	v35 = v13 + int32(12)
