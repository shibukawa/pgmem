...
L2:
	...
	v50 = F_AllocSetContextCreateInternal(m, v45, int32(530008), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L182:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v22)+112)) = int32(553220)
	*(*int32)(unsafe.Add(mBase, uint32(v22)+116)) = v73 + v126<<(uint(int32(4))%32) + v125*int32(100) + int32(24)
	F_errmsg(m, int32(529722), v22+int32(112))
	mBase = m.M
	v729 = m.ExcPending
	if v729 != 0 {
		goto L1
...
L183:
	;
	F_errfinish(m, int32(517184), int32(1612), int32(299793))
	mBase = m.M
	v734 = m.ExcPending
	if v734 != 0 {
		goto L1
...
L187:
	;
	F_errfinish(m, int32(517184), int32(1655), int32(299793))
	mBase = m.M
	v762 = m.ExcPending
	if v762 != 0 {
		goto L1
...
L190:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+80)) = v73 + v374<<(uint(int32(4))%32) + v373*int32(100) + int32(24)
	F_errmsg_internal(m, int32(529760), v22+int32(80))
	mBase = m.M
	v783 = m.ExcPending
	if v783 != 0 {
		goto L1
...
L191:
	;
	F_errfinish(m, int32(517184), int32(1679), int32(299793))
	mBase = m.M
	v788 = m.ExcPending
	if v788 != 0 {
		goto L1
...
L200:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v806
	F_errmsg(m, int32(76509), v22-int32(-64))
	mBase = m.M
	v826 = m.ExcPending
	if v826 != 0 {
		goto L1
...
L204:
	;
	F_errfinish(m, int32(517184), int32(1709), int32(299793))
	mBase = m.M
	v831 = m.ExcPending
	if v831 != 0 {
		goto L1
...
L251:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22)+232)) = int64(2)
	v1066 = F_OpenPipeStream(m, v1057, int32(240546))
	mBase = m.M
	v1067 = m.ExcPending
	if v1067 != 0 {
		goto L1
...
L253:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22)+232)) = int64(1)
	v1088 = F_AllocateFile(m, v1057, int32(240546))
	mBase = m.M
	v1089 = m.ExcPending
	if v1089 != 0 {
		goto L1
...
L258:
	;
	F_errfinish(m, int32(517184), int32(1864), int32(299793))
	mBase = m.M
	v1084 = m.ExcPending
	if v1084 != 0 {
		goto L1
...
L265:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v1101
	F_errmsg(m, int32(305868), v22+int32(16))
	mBase = m.M
	v1107 = m.ExcPending
	if v1107 != 0 {
		goto L1
...
L267:
	;
	F_errhint(m, int32(596440), int32(0))
	mBase = m.M
	v1118 = m.ExcPending
	if v1118 != 0 {
		goto L1
...
L269:
	;
	F_errfinish(m, int32(517184), int32(1883), int32(299793))
	mBase = m.M
	v1123 = m.ExcPending
	if v1123 != 0 {
		goto L1
...
L283:
	;
	v1145 = F___fstatat(m, v1136, int32(785340), v22+int32(128), int32(4096))
	mBase = m.M
	v1146 = v1145
	goto L280
L284:
...
L305:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v1367
	F_errmsg(m, int32(309368), v22+int32(48))
	mBase = m.M
	v1373 = m.ExcPending
	if v1373 != 0 {
		goto L1
...
L306:
	;
	F_errfinish(m, int32(517184), int32(1890), int32(299793))
	mBase = m.M
	v1378 = m.ExcPending
	if v1378 != 0 {
		goto L1
...
L310:
	;
	F_errfinish(m, int32(517184), int32(1895), int32(299793))
	mBase = m.M
	v1397 = m.ExcPending
	if v1397 != 0 {
		goto L1
...
L82:
	;
	F_errmsg(m, int32(526035), int32(0))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L21
...
L83:
	;
	F_errfinish(m, int32(518774), int32(2023), int32(363458))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L21
...
L123:
	;
	F_errfinish(m, int32(518774), int32(1130), int32(33059))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L21
...
L126:
	;
	F_errmsg(m, int32(355672), int32(0))
	mBase = m.M
	v583 = m.ExcPending
	if v583 != 0 {
		goto L21
...
L127:
	;
	F_errfinish(m, int32(518774), int32(2032), int32(363458))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L21
...
L131:
	;
	F_errfinish(m, int32(518774), int32(2042), int32(363458))
	mBase = m.M
	v604 = m.ExcPending
	if v604 != 0 {
		goto L21
...
L134:
	;
	F_errmsg(m, int32(118943), int32(0))
	mBase = m.M
	v615 = m.ExcPending
	if v615 != 0 {
		goto L21
...
L135:
	;
	F_errfinish(m, int32(518774), int32(2055), int32(363458))
	mBase = m.M
	v620 = m.ExcPending
	if v620 != 0 {
		goto L21
...
L138:
	;
	F_errmsg(m, int32(230689), int32(0))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L21
...
L139:
	;
	F_errfinish(m, int32(518774), int32(1122), int32(33059))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L21
	...
	if v11 == int32(1) {
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = v17
			F_errcontext_msg(m, int32(206695), v9)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return
			...
			if v28 != 0 {
				...
				if v22 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v30
					F_errcontext_msg(m, int32(193481), v9+int32(32))
					mBase = m.M
					v39 = m.ExcPending
					if v39 != 0 {
						return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v30
					F_errcontext_msg(m, int32(39410), v9+int32(16))
					mBase = m.M
					v46 = m.ExcPending
					if v46 != 0 {
						return
				...
				if v47 != 0 {
						...
						if v52 != 0 {
							...
							if v69 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+144)) = v70
								F_errcontext_msg(m, int32(752829), v9+int32(144))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return
					...
					if v86 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+112)) = v87
						F_errcontext_msg(m, int32(70025), v9+int32(112))
						mBase = m.M
						v97 = m.ExcPending
						if v97 != 0 {
							return
				...
				if v98 == int32(1) {
						...
						if v106 != 0 {
							...
							if v123 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = v124
								F_errcontext_msg(m, int32(752557), v9-int32(-64))
								mBase = m.M
								v133 = m.ExcPending
								if v133 != 0 {
									return
					...
					if v138 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+96)) = v139
						F_errcontext_msg(m, int32(39410), v9+int32(96))
						mBase = m.M
						v147 = m.ExcPending
						if v147 != 0 {
							return
