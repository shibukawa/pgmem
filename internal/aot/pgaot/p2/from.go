...
func F_BeginCopyFrom(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32) int32 {
	...
	v22 = v20 - int32(272)
	m.G0 = v22
	v25 = *(*int32)(unsafe.Add(mBase, _consts[356]))
	*(*int32)(unsafe.Add(mBase, uint32(v22)+264)) = v25
	v28 = *(*int64)(unsafe.Add(mBase, _consts[357]))
	*(*int64)(unsafe.Add(mBase, uint32(v22)+256)) = v28
	v31 = *(*int64)(unsafe.Add(mBase, _consts[358]))
	*(*int64)(unsafe.Add(mBase, uint32(v22)+240)) = v31
	v34 = *(*int64)(unsafe.Add(mBase, _consts[359]))
	*(*int64)(unsafe.Add(mBase, uint32(v22)+232)) = v34
	v37 = *(*int64)(unsafe.Add(mBase, _consts[360]))
...
L2:
	...
	v50 = F_AllocSetContextCreateInternal(m, v45, int32(509387), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L100:
	;
	v448 = *(*int32)(unsafe.Add(mBase, _consts[361]))
...
L102:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+20)) = v450
	v453 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L105:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v40)+24)) = uint8(v464)
	...
	v468 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L109:
	;
	v460 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L182:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v22)+112)) = int32(532590)
	*(*int32)(unsafe.Add(mBase, uint32(v22)+116)) = v73 + v126<<(uint(int32(4))%32) + v125*int32(100) + int32(24)
	F_errmsg(m, int32(509101), v22+int32(112))
	mBase = m.M
	v729 = m.ExcPending
	if v729 != 0 {
		goto L1
...
L183:
	;
	F_errfinish(m, int32(497399), int32(1612), int32(288629))
	mBase = m.M
	v734 = m.ExcPending
	if v734 != 0 {
		goto L1
...
L187:
	;
	F_errfinish(m, int32(497399), int32(1655), int32(288629))
	mBase = m.M
	v762 = m.ExcPending
	if v762 != 0 {
		goto L1
...
L190:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+80)) = v73 + v374<<(uint(int32(4))%32) + v373*int32(100) + int32(24)
	F_errmsg_internal(m, int32(509139), v22+int32(80))
	mBase = m.M
	v783 = m.ExcPending
	if v783 != 0 {
		goto L1
...
L191:
	;
	F_errfinish(m, int32(497399), int32(1679), int32(288629))
	mBase = m.M
	v788 = m.ExcPending
	if v788 != 0 {
		goto L1
...
L195:
	;
	v808 = *(*int32)(unsafe.Add(mBase, _consts[362]))
	v809 = *(*int32)(unsafe.Add(mBase, uint32(v808)+4))
	goto L199
L196:
	;
	v805 = *(*int32)(unsafe.Add(mBase, uint32(v796<<(uint(int32(3))%32))+uint32(_consts[363])))
	v806 = v805
	goto L198
L197:
	;
...
L200:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v806
	F_errmsg(m, int32(71206), v22-int32(-64))
	mBase = m.M
	v826 = m.ExcPending
	if v826 != 0 {
		goto L1
...
L201:
	;
	v818 = *(*int32)(unsafe.Add(mBase, uint32(v809<<(uint(int32(3))%32))+uint32(_consts[363])))
	v819 = v818
	goto L203
L202:
	;
...
L204:
	;
	F_errfinish(m, int32(497399), int32(1709), int32(288629))
	mBase = m.M
	v831 = m.ExcPending
	if v831 != 0 {
		goto L1
...
L228:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22)+232)) = int64(3)
	v941 = *(*int32)(unsafe.Add(mBase, _consts[364]))
	if v941 == int32(2) {
		goto L231
	} else {
		goto L232
...
L233:
	;
	v1055 = *(*int32)(unsafe.Add(mBase, _consts[365]))
...
L248:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+12)) = v1043
	v1047 = *(*int32)(unsafe.Add(mBase, _consts[269]))
...
L251:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22)+232)) = int64(2)
	v1066 = F_OpenPipeStream(m, v1057, int32(230944))
	mBase = m.M
	v1067 = m.ExcPending
	if v1067 != 0 {
		goto L1
...
L253:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22)+232)) = int64(1)
	v1088 = F_AllocateFile(m, v1057, int32(230944))
	mBase = m.M
	v1089 = m.ExcPending
	if v1089 != 0 {
		goto L1
...
L258:
	;
	F_errfinish(m, int32(497399), int32(1864), int32(288629))
	mBase = m.M
	v1084 = m.ExcPending
	if v1084 != 0 {
		goto L1
...
L261:
	;
	v1094 = *(*int32)(unsafe.Add(mBase, _consts[159]))
	F_errstart_cold(m, int32(21), int32(0))
	mBase = m.M
	v1098 = m.ExcPending
	if v1098 != 0 {
...
L265:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v1101
	F_errmsg(m, int32(294460), v22+int32(16))
	mBase = m.M
	v1107 = m.ExcPending
	if v1107 != 0 {
		goto L1
...
L267:
	;
	F_errhint(m, int32(574645), int32(0))
	mBase = m.M
	v1118 = m.ExcPending
	if v1118 != 0 {
		goto L1
...
L269:
	;
	F_errfinish(m, int32(497399), int32(1883), int32(288629))
	mBase = m.M
	v1123 = m.ExcPending
	if v1123 != 0 {
		goto L1
...
L277:
	;
	*(*int32)(unsafe.Add(mBase, _consts[159])) = int32(8)
	v1136 = int32(-1)
	goto L279
L278:
	;
...
L283:
	;
	v1145 = F___fstatat(m, v1136, int32(757603), v22+int32(128), int32(4096))
	mBase = m.M
	v1146 = v1145
	goto L280
L284:
...
L305:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v1367
	F_errmsg(m, int32(297960), v22+int32(48))
	mBase = m.M
	v1373 = m.ExcPending
	if v1373 != 0 {
		goto L1
...
L306:
	;
	F_errfinish(m, int32(497399), int32(1890), int32(288629))
	mBase = m.M
	v1378 = m.ExcPending
	if v1378 != 0 {
		goto L1
...
L310:
	;
	F_errfinish(m, int32(497399), int32(1895), int32(288629))
	mBase = m.M
	v1397 = m.ExcPending
	if v1397 != 0 {
		goto L1
...
L82:
	;
	F_errmsg(m, int32(505418), int32(0))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L21
...
L83:
	;
	F_errfinish(m, int32(498982), int32(2023), int32(349299))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L21
...
L123:
	;
	F_errfinish(m, int32(498982), int32(1130), int32(32019))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L21
...
L126:
	;
	F_errmsg(m, int32(341701), int32(0))
	mBase = m.M
	v583 = m.ExcPending
	if v583 != 0 {
		goto L21
...
L127:
	;
	F_errfinish(m, int32(498982), int32(2032), int32(349299))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L21
...
L131:
	;
	F_errfinish(m, int32(498982), int32(2042), int32(349299))
	mBase = m.M
	v604 = m.ExcPending
	if v604 != 0 {
		goto L21
...
L134:
	;
	F_errmsg(m, int32(112322), int32(0))
	mBase = m.M
	v615 = m.ExcPending
	if v615 != 0 {
		goto L21
...
L135:
	;
	F_errfinish(m, int32(498982), int32(2055), int32(349299))
	mBase = m.M
	v620 = m.ExcPending
	if v620 != 0 {
		goto L21
...
L138:
	;
	F_errmsg(m, int32(221369), int32(0))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L21
...
L139:
	;
	F_errfinish(m, int32(498982), int32(1122), int32(32019))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L21
	...
	if v11 == int32(1) {
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = v17
			F_errcontext_msg(m, int32(197879), v9)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return
			...
			if v28 != 0 {
				...
				if v22 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v30
					F_errcontext_msg(m, int32(184665), v9+int32(32))
					mBase = m.M
					v39 = m.ExcPending
					if v39 != 0 {
						return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v30
					F_errcontext_msg(m, int32(38303), v9+int32(16))
					mBase = m.M
					v46 = m.ExcPending
					if v46 != 0 {
						return
				...
				if v47 != 0 {
						...
						if v52 != 0 {
							...
							if v69 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+144)) = v70
								F_errcontext_msg(m, int32(725249), v9+int32(144))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return
					...
					if v86 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+112)) = v87
						F_errcontext_msg(m, int32(64815), v9+int32(112))
						mBase = m.M
						v97 = m.ExcPending
						if v97 != 0 {
							return
				...
				if v98 == int32(1) {
						...
						if v106 != 0 {
							...
							if v123 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = v124
								F_errcontext_msg(m, int32(724977), v9-int32(-64))
								mBase = m.M
								v133 = m.ExcPending
								if v133 != 0 {
									return
					...
					if v138 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+96)) = v139
						F_errcontext_msg(m, int32(38303), v9+int32(96))
						mBase = m.M
						v147 = m.ExcPending
						if v147 != 0 {
							return
...
func F_RemoveFromWaitQueue(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+92)) = int64(0)
	v52 = *(*int32)(unsafe.Add(mBase, uint32(v11<<(uint(v44)%32))+uint32(_consts[101])))
