	...
	if l0 == int32(0) {
		...
		if v36 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v37
			F_errmsg_internal(m, int32(52075), v7)
			mBase = m.M
			v43 = m.ExcPending
			if v43 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(473085), int32(4016), int32(229992))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return int32(0)
				...
				if v23 != v24 {
					...
					if v52 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v53
						F_errmsg_internal(m, int32(629631), v7+int32(16))
						mBase = m.M
						v63 = m.ExcPending
						if v63 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(473085), int32(4021), int32(229992))
							mBase = m.M
							v68 = m.ExcPending
							if v68 != 0 {
								return int32(0)
