...
L2:
	...
	v46 = F_AllocSetContextCreateInternal(m, v41, int32(58042), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L11:
	...
	v88 = int32(370520)
	v91 = int32(*(*uint8)(unsafe.Add(mBase, _consts[991])))
...
L25:
	;
	v775 = int32(370630)
	v778 = int32(*(*uint8)(unsafe.Add(mBase, _consts[992])))
...
L27:
	;
	v119 = F_get_tsearch_config_filename(m, v116, int32(103278))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L188:
	;
	F_errfinish(m, int32(478126), int32(529), int32(16516))
	mBase = m.M
	v773 = m.ExcPending
	if v773 != 0 {
		goto L1
...
L200:
	;
	v4169 = int32(163521)
	v4172 = int32(*(*uint8)(unsafe.Add(mBase, _consts[993])))
...
L202:
	;
	v806 = F_get_tsearch_config_filename(m, v803, int32(25828))
	mBase = m.M
	v807 = m.ExcPending
	if v807 != 0 {
		goto L1
...
L417:
	;
	F_errmsg(m, int32(203230), int32(0))
	mBase = m.M
	v1547 = m.ExcPending
	if v1547 != 0 {
		goto L1
...
L418:
	;
	F_errfinish(m, int32(478126), int32(963), int32(11155))
	mBase = m.M
	v1552 = m.ExcPending
	if v1552 != 0 {
		goto L1
...
L435:
	;
	F_errfinish(m, int32(478126), int32(979), int32(11155))
	mBase = m.M
	v1587 = m.ExcPending
	if v1587 != 0 {
		goto L1
...
L450:
	;
	F_errfinish(m, int32(478126), int32(995), int32(11155))
	mBase = m.M
	v1617 = m.ExcPending
	if v1617 != 0 {
		goto L1
...
L467:
	;
	F_errfinish(m, int32(478126), int32(1011), int32(11155))
	mBase = m.M
	v1649 = m.ExcPending
	if v1649 != 0 {
		goto L1
...
L483:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v818)+96)) = v806
	F_errmsg(m, int32(285539), v818+int32(96))
	mBase = m.M
	v1824 = m.ExcPending
	if v1824 != 0 {
		goto L1
...
L484:
	;
	F_errfinish(m, int32(478126), int32(1442), int32(149103))
	mBase = m.M
	v1829 = m.ExcPending
	if v1829 != 0 {
		goto L1
...
L702:
	;
	F_errmsg(m, int32(150160), int32(0))
	mBase = m.M
	v2534 = m.ExcPending
	if v2534 != 0 {
		goto L1
...
L703:
	;
	F_errfinish(m, int32(478126), int32(1277), int32(149119))
	mBase = m.M
	v2539 = m.ExcPending
	if v2539 != 0 {
		goto L1
...
L722:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v818)+64)) = v806
	F_errmsg(m, int32(285539), v818-int32(-64))
	mBase = m.M
	v2636 = m.ExcPending
	if v2636 != 0 {
		goto L1
...
L723:
	;
	F_errfinish(m, int32(478126), int32(1293), int32(149119))
	mBase = m.M
	v2641 = m.ExcPending
	if v2641 != 0 {
		goto L1
...
L728:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[998]))) = uint8(v2671)
...
L849:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v818)+48)) = v2689
	F_errmsg_internal(m, int32(461917), v818+int32(48))
	mBase = m.M
	v3122 = m.ExcPending
	if v3122 != 0 {
		goto L1
...
L850:
	;
	F_errfinish(m, int32(478126), int32(893), int32(11138))
	mBase = m.M
	v3127 = m.ExcPending
	if v3127 != 0 {
		goto L1
...
L859:
	;
	v3181 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[998]))))
	if v3181 == int32(0) {
		goto L860
	} else {
		goto L861
...
L898:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3303+v2662<<(uint(int32(2))%32)))) = int32(719562)
	v4021 = v2653
	v4022 = v3232
	v4030 = v2662 + int32(1)
	v4031 = v3300
...
L906:
	;
	v3325 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[997]))))
	if v3325 == int32(0) {
		goto L907
	} else {
		goto L908
...
L932:
	;
	v3408 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[997]))))
	v3455 = v3402
	v3456 = v3408
	v3457 = v3398
	goto L931
...
L952:
	;
	F_errfinish(m, int32(478126), int32(1343), int32(149119))
	mBase = m.M
	v3501 = m.ExcPending
	if v3501 != 0 {
		goto L1
...
L965:
	;
	v3530 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[997]))))
	if v3530 == int32(0) {
		goto L966
	} else {
		goto L967
...
L985:
	;
	v3594 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[996]))))
	v4021 = v3520
	v4022 = v3232
	v4030 = v2662
	v4031 = v2663
...
L1003:
	;
	v3631 = *(*int32)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[999])))
	if v3615 == v3631 {
		goto L208
	} else {
		goto L1004
...
L1013:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[1000]))) = v3648
	v3656 = int32(0)
...
L1022:
	;
	v3711 = *(*int32)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[1000])))
...
L1027:
	;
	v3783 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[994]))))
	if v3783 == int32(0) {
		goto L1028
	} else {
		goto L1029
...
L1052:
	;
	v3865 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[996]))))
	if v3865 == int32(0) {
		goto L1053
	} else {
		goto L1054
...
L1070:
	;
	v3932 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[995]))))
	if v3932 == int32(0) {
		goto L1071
	} else {
		goto L1072
...
L1084:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v3850
	v3987 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[996]))))
	if v3987 == int32(48) {
		goto L1085
	} else {
		goto L1086
...
L1087:
	;
	v3992 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v818)+uint32(_consts[994]))))
	if v3992 == int32(48) {
		goto L1088
	} else {
		goto L1089
...
L1103:
	;
	F_errfinish(m, int32(478126), int32(1319), int32(149119))
	mBase = m.M
	v4097 = m.ExcPending
	if v4097 != 0 {
		goto L1
...
L1106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v818)+16)) = v3615
	F_errmsg(m, int32(662372), v818+int32(16))
	mBase = m.M
	v4110 = m.ExcPending
	if v4110 != 0 {
		goto L1
...
L1107:
	;
	F_errfinish(m, int32(478126), int32(1168), int32(102008))
	mBase = m.M
	v4115 = m.ExcPending
	if v4115 != 0 {
		goto L1
...
L1110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v818)+32)) = v3615
	F_errmsg(m, int32(662372), v818+int32(32))
	mBase = m.M
	v4128 = m.ExcPending
	if v4128 != 0 {
		goto L1
...
L1111:
	;
	F_errfinish(m, int32(478126), int32(1180), int32(102008))
	mBase = m.M
	v4133 = m.ExcPending
	if v4133 != 0 {
		goto L1
...
L1114:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v818)+80)) = v806
	F_errmsg(m, int32(285539), v818+int32(80))
	mBase = m.M
	v4146 = m.ExcPending
	if v4146 != 0 {
		goto L1
...
L1115:
	;
	F_errfinish(m, int32(478126), int32(1222), int32(149119))
	mBase = m.M
	v4151 = m.ExcPending
	if v4151 != 0 {
		goto L1
...
L1118:
	;
	F_errmsg(m, int32(164681), int32(0))
	mBase = m.M
	v4162 = m.ExcPending
	if v4162 != 0 {
		goto L1
...
L1119:
	;
	F_errfinish(m, int32(478126), int32(1556), int32(149103))
	mBase = m.M
	v4167 = m.ExcPending
	if v4167 != 0 {
		goto L1
...
L1136:
	;
	F_errfinish(m, int32(478120), int32(53), int32(94827))
	mBase = m.M
	v4247 = m.ExcPending
	if v4247 != 0 {
		goto L1
...
L1139:
	;
	F_errmsg(m, int32(124662), int32(0))
	mBase = m.M
	v4258 = m.ExcPending
	if v4258 != 0 {
		goto L1
...
L1140:
	;
	F_errfinish(m, int32(478120), int32(64), int32(94827))
	mBase = m.M
	v4263 = m.ExcPending
	if v4263 != 0 {
		goto L1
...
L1144:
	;
	F_errfinish(m, int32(478120), int32(75), int32(94827))
	mBase = m.M
	v4279 = m.ExcPending
	if v4279 != 0 {
		goto L1
...
L1148:
	;
	F_errfinish(m, int32(478120), int32(84), int32(94827))
	mBase = m.M
	v4296 = m.ExcPending
	if v4296 != 0 {
		goto L1
...
L1360:
	;
	F_errfinish(m, int32(478126), int32(1745), int32(16535))
	mBase = m.M
	v5234 = m.ExcPending
	if v5234 != 0 {
		goto L1
...
L1363:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4332)+16)) = v5247
	F_errmsg(m, int32(662372), v4332+int32(16))
	mBase = m.M
	v5253 = m.ExcPending
	if v5253 != 0 {
		goto L1
...
L1364:
	;
	F_errfinish(m, int32(478126), int32(1750), int32(16535))
	mBase = m.M
	v5258 = m.ExcPending
	if v5258 != 0 {
		goto L1
...
L1367:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4332)+32)) = v5271
	F_errmsg(m, int32(662372), v4332+int32(32))
	mBase = m.M
	v5277 = m.ExcPending
	if v5277 != 0 {
		goto L1
...
L1368:
	;
	F_errfinish(m, int32(478126), int32(1755), int32(16535))
	mBase = m.M
	v5282 = m.ExcPending
	if v5282 != 0 {
		goto L1
...
L1474:
	;
	F_errfinish(m, int32(478120), int32(103), int32(94827))
	mBase = m.M
	v5877 = m.ExcPending
	if v5877 != 0 {
		goto L1
...
L1477:
	;
	F_errmsg(m, int32(207699), int32(0))
	mBase = m.M
	v5915 = m.ExcPending
	if v5915 != 0 {
		goto L1
...
L1478:
	;
	F_errfinish(m, int32(478120), int32(97), int32(94827))
	mBase = m.M
	v5920 = m.ExcPending
	if v5920 != 0 {
		goto L1
