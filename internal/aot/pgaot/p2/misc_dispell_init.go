...
L25:
	;
	v607 = int32(_a_F_dispell_init_4)
	v610 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dispell_init[2])))
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v57)+76)) = int32(_a_F_dispell_init_8)
	...
	v332 = F_MemoryContextAlloc(m, v330, int32(_a_F_dispell_init_9))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L1
...
L97:
	;
	v536 = int32(_a_F_dispell_init_6)
	goto L98
L98:
	;
...
L107:
	;
	v445 = int32(_a_F_dispell_init_1)
...
L149:
	;
	v3609 = int32(_a_F_dispell_init_13)
	v3612 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dispell_init[4])))
...
L175:
	;
	v702 = int32(_a_F_dispell_init_16)
	goto L179
L176:
	;
	v896 = int32(_a_F_dispell_init_17)
	goto L216
L177:
	;
	if v739-v740 != 0 {
...
L230:
	;
	v947 = int32(_a_F_dispell_init_18)
	goto L233
L231:
	;
...
L247:
	;
	v998 = int32(_a_F_dispell_init_19)
	goto L250
L248:
	;
...
L264:
	;
	v1114 = int32(_a_F_dispell_init_20)
	goto L279
L265:
	;
...
L291:
	;
	v1162 = int32(_a_F_dispell_init_21)
	goto L294
L292:
	;
...
L419:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v57)+44)) = uint8(v1639)
	v1647 = F_tsearch_readline_begin(m, v650+int32(_a_F_dispell_init_26), v638)
	mBase = m.M
	v1648 = m.ExcPending
	if v1648 != 0 {
		goto L1
...
L421:
	;
	v1653 = F_tsearch_readline(m, v650+int32(_a_F_dispell_init_26))
	mBase = m.M
	v1654 = m.ExcPending
	if v1654 != 0 {
		goto L1
...
L429:
	;
	v1683 = int32(_a_F_dispell_init_20)
	goto L432
L430:
	;
...
L446:
	;
	v1736 = int32(_a_F_dispell_init_27)
	goto L450
L447:
	;
	goto L428
...
L464:
	;
	v1789 = int32(_a_F_dispell_init_28)
	goto L468
L465:
	;
	goto L428
...
L482:
	;
	v1842 = int32(_a_F_dispell_init_29)
	goto L486
L483:
	;
	goto L428
...
L500:
	;
	v1895 = int32(_a_F_dispell_init_30)
	goto L504
L501:
	;
	goto L428
...
L518:
	;
	v1948 = int32(_a_F_dispell_init_31)
	goto L522
L519:
	;
	goto L428
...
L536:
	;
	v2001 = int32(_a_F_dispell_init_32)
	goto L540
L537:
	;
	goto L428
...
L554:
	;
	v2054 = int32(_a_F_dispell_init_33)
	goto L558
L555:
	;
	goto L428
...
L572:
	;
	v2107 = int32(_a_F_dispell_init_34)
	goto L576
L573:
	;
	goto L428
...
L590:
	;
	v2192 = int32(_a_F_dispell_init_35)
	goto L599
L591:
	;
	goto L590
...
L614:
	;
	v2252 = int32(_a_F_dispell_init_36)
	goto L620
L615:
	;
...
L637:
	;
	v2347 = F_tsearch_readline(m, v650+int32(_a_F_dispell_init_26))
	mBase = m.M
	v2348 = m.ExcPending
	if v2348 != 0 {
		goto L1
...
L643:
	;
	v2390 = F_tsearch_readline_begin(m, v650+int32(_a_F_dispell_init_26), v638)
	mBase = m.M
	v2391 = m.ExcPending
	if v2391 != 0 {
		goto L1
...
L647:
	;
	v2394 = F_tsearch_readline(m, v650+int32(_a_F_dispell_init_26))
	mBase = m.M
	v2395 = m.ExcPending
	if v2395 != 0 {
		goto L1
...
L660:
	;
	v2447 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[5]))) = uint8(v2447)
	*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[6]))) = uint8(v2447)
	*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[7]))) = uint8(v2447)
	*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[8]))) = uint8(v2447)
	*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[9]))) = uint8(v2447)
...
L667:
	...
	v2827 = v2465
	v2828 = v2499
	v2842 = v650 + int32(_a_F_dispell_init_39)
	goto L759
L668:
	;
	goto L667
...
L670:
	...
	v2725 = v2499
	v2734 = v2500
	v2737 = v650 + int32(_a_F_dispell_init_40)
	goto L737
L671:
	;
	v2649 = v2463
	v2652 = v2499
	v2657 = v2500
	v2662 = v650 + int32(_a_F_dispell_init_41)
	goto L716
L672:
	;
	v2576 = v2463
	v2579 = v2499
	v2582 = v2500
	v2590 = v650 + int32(_a_F_dispell_init_42)
	goto L695
L673:
	;
	v2505 = v2463
	v2508 = v2499
	v2510 = v2500
	v2521 = v650 + int32(_a_F_dispell_init_43)
	goto L674
L674:
	;
...
L686:
	;
	if int32(1)<<(uint(v2546)%32)&int32(_a_F_dispell_init_44) == int32(0) {
		goto L685
	} else {
		goto L687
	}
...
L707:
	;
	if int32(1)<<(uint(v2617)%32)&int32(_a_F_dispell_init_44) == int32(0) {
		goto L706
	} else {
		goto L708
	}
...
L728:
	;
	if int32(1)<<(uint(v2690)%32)&int32(_a_F_dispell_init_44) == int32(0) {
		goto L727
	} else {
		goto L729
	}
...
L749:
	;
	if int32(1)<<(uint(v2763)%32)&int32(_a_F_dispell_init_44) == int32(0) {
		goto L748
	} else {
		goto L750
	}
...
L766:
	;
	v2866 = v2853 - int32(9)
	if int32(1)<<(uint(v2866)%32)&int32(_a_F_dispell_init_44) != 0 {
		goto L770
	} else {
		goto L771
	}
...
L781:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+48)) = v2465
	F_errmsg_internal(m, int32(_a_F_dispell_init_45), v650+int32(48))
	mBase = m.M
	v2898 = m.ExcPending
	if v2898 != 0 {
		goto L1
...
L786:
	;
	v2941 = int32(_a_F_dispell_init_7)
	v2942 = *(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3]))
	v2944 = *(*int32)(unsafe.Add(mBase, uint32(v57)+64))
	*(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3])) = v2944
	v2947 = v650 + int32(_a_F_dispell_init_43)
...
L788:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3])) = v2942
...
L793:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v57)+36)) = uint8(v2965)
	v2972 = v650 + int32(_a_F_dispell_init_42)
	goto L797
L794:
	;
	goto L795
...
L813:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3023+v2438<<(uint(int32(2))%32)))) = int32(_a_F_dispell_init_6)
	v3461 = v2429
	v3462 = v2952
	v3470 = v2438 + int32(1)
	v3471 = v3020
...
L814:
	;
	v3038 = F_strlen(m, v650+int32(_a_F_dispell_init_42))
	mBase = m.M
	v3040 = v3038 + int32(1)
...
L817:
	;
	v3066 = v650 + int32(_a_F_dispell_init_42)
...
L825:
	;
	v3052 = int32(_a_F_dispell_init_1)
...
L830:
	;
	v3072 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[8]))))
	v3119 = v3066
	v3120 = v3072
	v3121 = v3062
	goto L829
...
L849:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650))) = v2439 - int32(1)
	F_errmsg(m, int32(_a_F_dispell_init_47), v650)
	mBase = m.M
	v3160 = m.ExcPending
	if v3160 != 0 {
		goto L1
...
L853:
	;
	v3187 = F_strlen(m, v650+int32(_a_F_dispell_init_42))
	mBase = m.M
	if v3187 == int32(0) {
		v3461 = v2429
		v3462 = v2952
...
L866:
	;
	v3202 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[7]))))
	v3461 = v3184
	v3462 = v2952
	v3470 = v2438
	v3471 = v2439
...
L868:
	;
	v3211 = int32(47)
	v3212 = F___strchrnul(m, v650+int32(_a_F_dispell_init_40), v3211)
	mBase = m.M
...
L869:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3])) = v3378
	v3381 = v650 + int32(_a_F_dispell_init_40)
...
L883:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_dispell_init[10])) = int32(0)
	v3237 = F_strtox_2(m, v3223, v650+int32(_a_F_dispell_init_48), int32(10), int64(2147483648))
	mBase = m.M
	v3238 = base.I32_wrap_i64(v3237)
	goto L884
L884:
	;
	v3239 = *(*int32)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[11])))
	if v3223 == v3239 {
		goto L157
	} else {
		goto L885
...
L885:
	;
	v3242 = *(*int32)(unsafe.Add(mBase, _c_F_dispell_init[10]))
	if v3242 == int32(68) {
		goto L157
	} else {
		goto L886
...
L890:
	;
	v3256 = int32(_a_F_dispell_init_6)
	goto L877
L891:
	;
	v3349 = *(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3]))
	v3351 = v3349
	v3354 = v3325
	goto L869
L892:
...
L894:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[12]))) = v3256
	v3264 = int32(0)
...
L896:
	;
	F_getNextFlagFromString(m, v57, v650+int32(_a_F_dispell_init_49), v650+int32(_a_F_dispell_init_48))
	mBase = m.M
	v3300 = m.ExcPending
	if v3300 != 0 {
		goto L1
...
L898:
	;
	F_setCompoundAffixFlagValue(m, v57, v650+int32(_a_F_dispell_init_50), v650+int32(_a_F_dispell_init_48), int32(0))
	mBase = m.M
	v3307 = m.ExcPending
	if v3307 != 0 {
		goto L1
...
L903:
	;
	v3319 = *(*int32)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[12])))
...
L905:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3])) = v3351
	v3390 = int32(47)
...
L910:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v3397))) = uint8(v3398)
	v3401 = *(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3]))
	v3402 = v3401
	goto L912
L911:
	;
...
L912:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3])) = v3404
	v3407 = v650 + int32(_a_F_dispell_init_41)
...
L913:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3])) = v3415
	v3418 = v650 + int32(_a_F_dispell_init_39)
...
L914:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_dispell_init[3])) = v3402
	v3427 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[7]))))
	if v3427 == int32(48) {
		goto L915
	} else {
		goto L916
...
L917:
	;
	v3432 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_c_F_dispell_init[5]))))
	if v3432 == int32(48) {
		goto L918
	} else {
		goto L919
...
L920:
	;
	F_NIAddAffix(m, v57, v650+int32(_a_F_dispell_init_42), base.I32_extend8_s(v3354|v2444), v3423, v3412, v3386, v2429&int32(1))
	mBase = m.M
	v3444 = m.ExcPending
	if v3444 != 0 {
		goto L1
...
L925:
	;
	v3482 = F_tsearch_readline(m, v650+int32(_a_F_dispell_init_26))
	mBase = m.M
	v3483 = m.ExcPending
	if v3483 != 0 {
		goto L1
...
L936:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+16)) = v3223
	F_errmsg(m, int32(_a_F_dispell_init_52), v650+int32(16))
	mBase = m.M
	v3550 = m.ExcPending
	if v3550 != 0 {
		goto L1
...
L940:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+32)) = v3223
	F_errmsg(m, int32(_a_F_dispell_init_52), v650+int32(32))
	mBase = m.M
	v3568 = m.ExcPending
	if v3568 != 0 {
		goto L1
...
L997:
	;
	v3837 = *(*int32)(unsafe.Add(mBase, _c_F_dispell_init[10]))
	if v3837 == int32(68) {
		goto L986
	} else {
		goto L998
...
L1031:
	;
	v4006 = int32(_a_F_dispell_init_1)
...
L1077:
	;
	v4189 = int32(_a_F_dispell_init_1)
...
L1104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3772))) = v4385
	F_errmsg(m, int32(_a_F_dispell_init_52), v3772)
	mBase = m.M
	v4389 = m.ExcPending
	if v4389 != 0 {
		goto L1
...
L1108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3772)+16)) = v4407
	F_errmsg(m, int32(_a_F_dispell_init_52), v3772+int32(16))
	mBase = m.M
	v4413 = m.ExcPending
	if v4413 != 0 {
		goto L1
...
L1112:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3772)+32)) = v4431
	F_errmsg(m, int32(_a_F_dispell_init_52), v3772+int32(32))
	mBase = m.M
	v4437 = m.ExcPending
	if v4437 != 0 {
		goto L1
...
L1135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4473)+4)) = int32(base.Ui32(v4770)>>(uint(int32(10))%32)) & int32(_a_F_dispell_init_62)
