...
L2:
	...
	v46 = F_AllocSetContextCreateInternal(m, v41, int32(61464), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L11:
	...
	v88 = int32(394848)
	v91 = int32(*(*uint8)(unsafe.Add(mBase, _consts[996])))
...
L25:
	;
	v607 = int32(394958)
	v610 = int32(*(*uint8)(unsafe.Add(mBase, _consts[997])))
...
L27:
	;
	v119 = F_get_tsearch_config_filename(m, v116, int32(112226))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L137:
	;
	F_errfinish(m, int32(509343), int32(529), int32(17776))
	mBase = m.M
	v605 = m.ExcPending
	if v605 != 0 {
		goto L1
...
L149:
	;
	v3609 = int32(175904)
	v3612 = int32(*(*uint8)(unsafe.Add(mBase, _consts[998])))
...
L151:
	;
	v638 = F_get_tsearch_config_filename(m, v635, int32(27529))
	mBase = m.M
	v639 = m.ExcPending
	if v639 != 0 {
		goto L1
...
L350:
	;
	F_errfinish(m, int32(509343), int32(963), int32(12186))
	mBase = m.M
	v1328 = m.ExcPending
	if v1328 != 0 {
		goto L1
...
L367:
	;
	F_errfinish(m, int32(509343), int32(979), int32(12186))
	mBase = m.M
	v1363 = m.ExcPending
	if v1363 != 0 {
		goto L1
...
L382:
	;
	F_errfinish(m, int32(509343), int32(995), int32(12186))
	mBase = m.M
	v1393 = m.ExcPending
	if v1393 != 0 {
		goto L1
...
L399:
	;
	F_errfinish(m, int32(509343), int32(1011), int32(12186))
	mBase = m.M
	v1425 = m.ExcPending
	if v1425 != 0 {
		goto L1
...
L415:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+96)) = v638
	F_errmsg(m, int32(303842), v650+int32(96))
	mBase = m.M
	v1600 = m.ExcPending
	if v1600 != 0 {
		goto L1
...
L416:
	;
	F_errfinish(m, int32(509343), int32(1442), int32(160892))
	mBase = m.M
	v1605 = m.ExcPending
	if v1605 != 0 {
		goto L1
...
L634:
	;
	F_errmsg(m, int32(162037), int32(0))
	mBase = m.M
	v2310 = m.ExcPending
	if v2310 != 0 {
		goto L1
...
L635:
	;
	F_errfinish(m, int32(509343), int32(1277), int32(160908))
	mBase = m.M
	v2315 = m.ExcPending
	if v2315 != 0 {
		goto L1
...
L654:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+64)) = v638
	F_errmsg(m, int32(303842), v650-int32(-64))
	mBase = m.M
	v2412 = m.ExcPending
	if v2412 != 0 {
		goto L1
...
L655:
	;
	F_errfinish(m, int32(509343), int32(1293), int32(160908))
	mBase = m.M
	v2417 = m.ExcPending
	if v2417 != 0 {
		goto L1
...
L781:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+48)) = v2465
	F_errmsg_internal(m, int32(490637), v650+int32(48))
	mBase = m.M
	v2898 = m.ExcPending
	if v2898 != 0 {
		goto L1
...
L782:
	;
	F_errfinish(m, int32(509343), int32(893), int32(12169))
	mBase = m.M
	v2903 = m.ExcPending
	if v2903 != 0 {
		goto L1
...
L813:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3023+v2438<<(uint(int32(2))%32)))) = int32(771673)
	v3461 = v2429
	v3462 = v2952
	v3470 = v2438 + int32(1)
	v3471 = v3020
...
L830:
	;
	v3072 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_consts[1002]))))
	v3119 = v3066
	v3120 = v3072
	v3121 = v3062
	goto L829
...
L850:
	;
	F_errfinish(m, int32(509343), int32(1343), int32(160908))
	mBase = m.M
	v3165 = m.ExcPending
	if v3165 != 0 {
		goto L1
...
L866:
	;
	v3202 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_consts[1001]))))
	v3461 = v3184
	v3462 = v2952
	v3470 = v2438
	v3471 = v2439
...
L884:
	;
	v3239 = *(*int32)(unsafe.Add(mBase, uint32(v650)+uint32(_consts[1004])))
	if v3223 == v3239 {
		goto L157
	} else {
		goto L885
...
L894:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v650)+uint32(_consts[1005]))) = v3256
	v3264 = int32(0)
...
L903:
	;
	v3319 = *(*int32)(unsafe.Add(mBase, uint32(v650)+uint32(_consts[1005])))
...
L914:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v3402
	v3427 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_consts[1001]))))
	if v3427 == int32(48) {
		goto L915
	} else {
		goto L916
...
L917:
	;
	v3432 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v650)+uint32(_consts[999]))))
	if v3432 == int32(48) {
		goto L918
	} else {
		goto L919
...
L932:
	;
	F_errmsg(m, int32(165018), int32(0))
	mBase = m.M
	v3532 = m.ExcPending
	if v3532 != 0 {
		goto L1
...
L933:
	;
	F_errfinish(m, int32(509343), int32(1319), int32(160908))
	mBase = m.M
	v3537 = m.ExcPending
	if v3537 != 0 {
		goto L1
...
L936:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+16)) = v3223
	F_errmsg(m, int32(713911), v650+int32(16))
	mBase = m.M
	v3550 = m.ExcPending
	if v3550 != 0 {
		goto L1
...
L937:
	;
	F_errfinish(m, int32(509343), int32(1168), int32(110715))
	mBase = m.M
	v3555 = m.ExcPending
	if v3555 != 0 {
		goto L1
...
L940:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+32)) = v3223
	F_errmsg(m, int32(713911), v650+int32(32))
	mBase = m.M
	v3568 = m.ExcPending
	if v3568 != 0 {
		goto L1
...
L941:
	;
	F_errfinish(m, int32(509343), int32(1180), int32(110715))
	mBase = m.M
	v3573 = m.ExcPending
	if v3573 != 0 {
		goto L1
...
L944:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v650)+80)) = v638
	F_errmsg(m, int32(303842), v650+int32(80))
	mBase = m.M
	v3586 = m.ExcPending
	if v3586 != 0 {
		goto L1
...
L945:
	;
	F_errfinish(m, int32(509343), int32(1222), int32(160908))
	mBase = m.M
	v3591 = m.ExcPending
	if v3591 != 0 {
		goto L1
...
L948:
	;
	F_errmsg(m, int32(177145), int32(0))
	mBase = m.M
	v3602 = m.ExcPending
	if v3602 != 0 {
		goto L1
...
L949:
	;
	F_errfinish(m, int32(509343), int32(1556), int32(160892))
	mBase = m.M
	v3607 = m.ExcPending
	if v3607 != 0 {
		goto L1
...
L966:
	;
	F_errfinish(m, int32(509337), int32(53), int32(102091))
	mBase = m.M
	v3687 = m.ExcPending
	if v3687 != 0 {
		goto L1
...
L969:
	;
	F_errmsg(m, int32(135518), int32(0))
	mBase = m.M
	v3698 = m.ExcPending
	if v3698 != 0 {
		goto L1
...
L970:
	;
	F_errfinish(m, int32(509337), int32(64), int32(102091))
	mBase = m.M
	v3703 = m.ExcPending
	if v3703 != 0 {
		goto L1
...
L974:
	;
	F_errfinish(m, int32(509337), int32(75), int32(102091))
	mBase = m.M
	v3719 = m.ExcPending
	if v3719 != 0 {
		goto L1
...
L978:
	;
	F_errfinish(m, int32(509337), int32(84), int32(102091))
	mBase = m.M
	v3736 = m.ExcPending
	if v3736 != 0 {
		goto L1
...
L1105:
	;
	F_errfinish(m, int32(509343), int32(1745), int32(17795))
	mBase = m.M
	v4394 = m.ExcPending
	if v4394 != 0 {
		goto L1
...
L1108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3772)+16)) = v4407
	F_errmsg(m, int32(713911), v3772+int32(16))
	mBase = m.M
	v4413 = m.ExcPending
	if v4413 != 0 {
		goto L1
...
L1109:
	;
	F_errfinish(m, int32(509343), int32(1750), int32(17795))
	mBase = m.M
	v4418 = m.ExcPending
	if v4418 != 0 {
		goto L1
...
L1112:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3772)+32)) = v4431
	F_errmsg(m, int32(713911), v3772+int32(32))
	mBase = m.M
	v4437 = m.ExcPending
	if v4437 != 0 {
		goto L1
...
L1113:
	;
	F_errfinish(m, int32(509343), int32(1755), int32(17795))
	mBase = m.M
	v4442 = m.ExcPending
	if v4442 != 0 {
		goto L1
...
L1185:
	;
	F_errfinish(m, int32(509337), int32(103), int32(102091))
	mBase = m.M
	v4925 = m.ExcPending
	if v4925 != 0 {
		goto L1
...
L1188:
	;
	F_errmsg(m, int32(221188), int32(0))
	mBase = m.M
	v4963 = m.ExcPending
	if v4963 != 0 {
		goto L1
...
L1189:
	;
	F_errfinish(m, int32(509337), int32(97), int32(102091))
	mBase = m.M
	v4968 = m.ExcPending
	if v4968 != 0 {
		goto L1
