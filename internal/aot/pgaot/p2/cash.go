						...
						if v55 != 0 {
							...
							if v58 != 0 {
								...
								if v62 != 0 {
									...
									F_errfinish(m, int32(521472), int32(137), int32(580369))
									v67 = m.ExcPending
									if v67 != 0 {
										return int64(0)
									} else {
		...
		if v18 != 0 {
			...
			if v21 != 0 {
				...
				if v25 != 0 {
					...
					F_errfinish(m, int32(521472), int32(111), int32(338826))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
		...
		case 0:
			...
			if v89 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v20)+80)) = v84
				v161 = F_psprintf(m, int32(704332), v20+int32(80))
				mBase = m.M
				v162 = m.ExcPending
				if v162 != 0 {
					return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v20)+64)) = v132
				v169 = F_psprintf(m, int32(704332), v20-int32(-64))
				mBase = m.M
				v170 = m.ExcPending
				if v170 != 0 {
					return int32(0)
		...
		if v18 != 0 {
			...
			if v21 != 0 {
				...
				if v25 != 0 {
					...
					F_errfinish(m, int32(521472), int32(98), int32(338813))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
