...
L63:
	...
	v254 = int32(*(*uint8)(unsafe.Add(mBase, _consts[493])))
	if v254 != int32(1) {
		goto L66
	} else {
		goto L67
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v343)+44)) = v347
	...
	v350 = int32(4121593)
	v351 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
	...
	*(*float64)(unsafe.Add(mBase, uint32(v367)+32)) = v369
	v386 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v448)+44)) = v452
	...
	v455 = int32(4121593)
	v456 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
	...
	*(*float64)(unsafe.Add(mBase, uint32(v472)+32)) = v474
	v491 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
...
L86:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v534)+37)) = uint8(v557)
	v560 = *(*float64)(unsafe.Add(mBase, _consts[486]))
...
L134:
	;
	F_errfinish(m, int32(497133), int32(4735), int32(283247))
	mBase = m.M
	v705 = m.ExcPending
	if v705 != 0 {
		goto L1
...
L137:
	;
	F_errfinish(m, int32(497133), int32(4740), int32(283247))
	mBase = m.M
	v718 = m.ExcPending
	if v718 != 0 {
		goto L1
...
L162:
	;
	F_errfinish(m, int32(497133), int32(4784), int32(283247))
	mBase = m.M
	v1047 = m.ExcPending
	if v1047 != 0 {
		goto L1
...
L164:
	;
	F_errmsg_internal(m, int32(275856), int32(0))
	mBase = m.M
	v1055 = m.ExcPending
	if v1055 != 0 {
		goto L1
...
L165:
	;
	F_errfinish(m, int32(497133), int32(4803), int32(283247))
	mBase = m.M
	v1060 = m.ExcPending
	if v1060 != 0 {
		goto L1
...
L168:
	;
	F_errfinish(m, int32(497133), int32(4807), int32(283247))
	mBase = m.M
	v1073 = m.ExcPending
	if v1073 != 0 {
		goto L1
...
L170:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v47))) = v1078
	F_errmsg_internal(m, int32(486382), v47)
	mBase = m.M
	v1082 = m.ExcPending
	if v1082 != 0 {
		goto L1
...
L171:
	;
	F_errfinish(m, int32(497133), int32(546), int32(360833))
	mBase = m.M
	v1087 = m.ExcPending
	if v1087 != 0 {
		goto L1
...
L260:
	;
	F_errmsg(m, int32(443811), int32(0))
	mBase = m.M
	v1752 = m.ExcPending
	if v1752 != 0 {
		goto L1
...
L261:
	;
	F_errfinish(m, int32(493931), int32(776), int32(157402))
	mBase = m.M
	v1757 = m.ExcPending
	if v1757 != 0 {
		goto L1
...
L269:
	;
	F_errfinish(m, int32(493931), int32(793), int32(157402))
	mBase = m.M
	v1822 = m.ExcPending
	if v1822 != 0 {
		goto L1
...
L382:
	;
	F_errmsg(m, int32(268185), int32(0))
	mBase = m.M
	v2482 = m.ExcPending
	if v2482 != 0 {
		goto L1
...
L383:
	;
	F_errfinish(m, int32(493931), int32(960), int32(157402))
	mBase = m.M
	v2487 = m.ExcPending
	if v2487 != 0 {
		goto L1
...
L387:
	;
	F_errfinish(m, int32(493931), int32(843), int32(157402))
	mBase = m.M
	v2503 = m.ExcPending
	if v2503 != 0 {
		goto L1
...
L410:
	;
	v2708 = int32(*(*uint8)(unsafe.Add(mBase, _consts[494])))
	if v2708&int32(2) != 0 {
		goto L400
	} else {
		goto L411
...
L422:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2560)+16)) = v2741
	F_errmsg(m, int32(706180), v2560+int32(16))
	mBase = m.M
	v2748 = m.ExcPending
	if v2748 != 0 {
		goto L1
...
L424:
	;
	F_errfinish(m, int32(497133), int32(7323), int32(391806))
	mBase = m.M
	v2756 = m.ExcPending
	if v2756 != 0 {
		goto L1
...
L455:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2774))) = v1499
	F_errmsg_internal(m, int32(486728), v2774)
	mBase = m.M
	v2831 = m.ExcPending
	if v2831 != 0 {
		goto L1
...
L456:
	;
	F_errfinish(m, int32(493931), int32(2312), int32(134470))
	mBase = m.M
	v2836 = m.ExcPending
	if v2836 != 0 {
		goto L1
...
L515:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2913))) = v1499
	F_errmsg_internal(m, int32(486728), v2913)
	mBase = m.M
	v2974 = m.ExcPending
	if v2974 != 0 {
		goto L1
...
L516:
	;
	F_errfinish(m, int32(493931), int32(2366), int32(165314))
	mBase = m.M
	v2979 = m.ExcPending
	if v2979 != 0 {
		goto L1
...
L526:
	;
	F_errfinish(m, int32(497133), int32(7299), int32(391806))
	mBase = m.M
	v3041 = m.ExcPending
	if v3041 != 0 {
		goto L1
...
L770:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5085)+44)) = v5089
	...
	v5093 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
...
L774:
	;
	F_errfinish(m, int32(497133), int32(6626), int32(151806))
	mBase = m.M
	v5176 = m.ExcPending
	if v5176 != 0 {
		goto L1
...
L916:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6211)+44)) = v6215
	...
	v6219 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
...
L962:
	;
	F_errfinish(m, int32(497133), int32(6931), int32(112755))
	mBase = m.M
	v6532 = m.ExcPending
	if v6532 != 0 {
		goto L1
...
L977:
	;
	F_errfinish(m, int32(497133), int32(6972), int32(112755))
	mBase = m.M
	v6753 = m.ExcPending
	if v6753 != 0 {
		goto L1
...
L980:
	;
	F_errfinish(m, int32(497133), int32(6959), int32(112755))
	mBase = m.M
	v6810 = m.ExcPending
	if v6810 != 0 {
		goto L1
...
L1127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7844)+44)) = v7848
	...
	v7851 = int32(4121593)
	v7852 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
	...
	*(*float64)(unsafe.Add(mBase, uint32(v7868)+32)) = v7872
	v7889 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
...
L1183:
	;
	F_errfinish(m, int32(497133), int32(1809), int32(283386))
	mBase = m.M
	v8466 = m.ExcPending
	if v8466 != 0 {
		goto L1
...
L1186:
	;
	F_errfinish(m, int32(497133), int32(1834), int32(283386))
	mBase = m.M
	v8479 = m.ExcPending
	if v8479 != 0 {
		goto L1
...
L1189:
	;
	F_errfinish(m, int32(497133), int32(1875), int32(283386))
	mBase = m.M
	v8494 = m.ExcPending
	if v8494 != 0 {
		goto L1
...
L1192:
	;
	F_errfinish(m, int32(497133), int32(1886), int32(283386))
	mBase = m.M
	v8509 = m.ExcPending
	if v8509 != 0 {
		goto L1
...
L1314:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9348)+16)) = v9377
	v9383 = F_psprintf(m, int32(473990), v9348+int32(16))
	mBase = m.M
	v9384 = m.ExcPending
	if v9384 != 0 {
		goto L1
...
L1383:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9793)+100)) = int32(-1)
	v10357 = int32(*(*uint8)(unsafe.Add(mBase, _consts[495])))
	if v10357 == int32(0) {
		goto L1439
	} else {
		goto L1440
...
L1432:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10216)+44)) = v10220
	...
	v10223 = int32(4121593)
	v10224 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
	...
	*(*float64)(unsafe.Add(mBase, uint32(v10240)+32)) = v10242
	v10259 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
...
L1436:
	;
	F_errmsg_internal(m, int32(427192), int32(0))
	mBase = m.M
	v10304 = m.ExcPending
	if v10304 != 0 {
		goto L1
...
L1437:
	;
	F_errfinish(m, int32(497133), int32(1519), int32(283472))
	mBase = m.M
	v10309 = m.ExcPending
	if v10309 != 0 {
		goto L1
...
L1472:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10611)+88)) = int32(-1)
	v11007 = int32(*(*uint8)(unsafe.Add(mBase, _consts[495])))
	if v11007 == int32(0) {
		goto L1544
	} else {
		goto L1545
...
L1476:
	;
	v10643 = int32(1)
	v10645 = int32(*(*uint8)(unsafe.Add(mBase, _consts[496])))
	if v10645 != v10643 {
		v10657 = v4
		v10658 = v10643
		goto L1473
...
L1533:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10860)+44)) = v10864
	...
	v10867 = int32(4121593)
	v10868 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
	...
	*(*float64)(unsafe.Add(mBase, uint32(v10884)+32)) = v10886
	v10903 = int32(*(*uint8)(unsafe.Add(mBase, _consts[489])))
...
L1541:
	;
	F_errmsg_internal(m, int32(427249), int32(0))
	mBase = m.M
	v10954 = m.ExcPending
	if v10954 != 0 {
		goto L1
...
L1542:
	;
	F_errfinish(m, int32(497133), int32(1347), int32(283453))
	mBase = m.M
	v10959 = m.ExcPending
	if v10959 != 0 {
		goto L1
