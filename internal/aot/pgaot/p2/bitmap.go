...
L4:
	;
	v703 = *(*int32)(unsafe.Add(mBase, _consts[125]))
	if v703 != 0 {
		goto L125
	} else {
		goto L126
...
L19:
	;
	F_errfinish(m, int32(496952), int32(74), int32(232507))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L12
...
L23:
	;
	F_s_lock(m, v68, int32(496952), int32(426), int32(354290))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L12
...
L97:
	;
	F_s_lock(m, v68, int32(496952), int32(183), int32(354256))
	mBase = m.M
	v551 = m.ExcPending
	if v551 != 0 {
		goto L12
...
L125:
	;
	v705 = int32(*(*uint8)(unsafe.Add(mBase, _consts[126])))
...
L148:
	;
	v791 = *(*int32)(unsafe.Add(mBase, _consts[125]))
	if v791 == int32(0) {
		goto L129
	} else {
		goto L149
...
L149:
	;
	v795 = int32(*(*uint8)(unsafe.Add(mBase, _consts[126])))
	if v795&int32(1) != 0 {
		goto L129
	} else {
		goto L150
...
L151:
	;
	F_errmsg_internal(m, int32(336432), int32(0))
	mBase = m.M
	v833 = m.ExcPending
	if v833 != 0 {
		goto L12
...
L152:
	;
	F_errfinish(m, int32(326737), int32(1944), int32(383497))
	mBase = m.M
	v838 = m.ExcPending
	if v838 != 0 {
		goto L12
...
L156:
	;
	F_errfinish(m, int32(496952), int32(84), int32(232507))
	mBase = m.M
	v861 = m.ExcPending
	if v861 != 0 {
		goto L12
