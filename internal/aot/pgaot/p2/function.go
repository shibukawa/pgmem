			...
			if v61 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14))) = v62
				...
				if v66 != 0 {
					...
					F_errfinish(m, int32(472279), int32(1348), int32(289115))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return int32(0)
					...
					if base.F64_lt(v43, float64(0))|base.F64_gt(v43, float64(1)) == int32(0) {
						...
						if v54 != 0 {
							...
							*(*float64)(unsafe.Add(mBase, uint32(v14))) = v55
							F_errmsg_internal(m, int32(323420), v14)
							mBase = m.M
							v59 = m.ExcPending
							if v59 != 0 {
								return float64(0)
							} else {
								F_errfinish(m, int32(470707), int32(2106), int32(8847))
								mBase = m.M
								v64 = m.ExcPending
								if v64 != 0 {
									return float64(0)
...
L44:
	;
	F_errfinish(m, int32(471101), int32(13278), int32(360187))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L3
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v155
	F_appendStringInfo(m, v15-int32(-64), int32(566180), v15+int32(16))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L3
...
func F_print_function_rettype(m *base.Module, l0 int32, l1 int32) {
	...
	if v13 != 0 {
		...
		if v15 == int32(1) {
			F_appendStringInfoString(m, v8, int32(644246))
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return
					...
					if int32(0) < v23 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v31
						if v23 != 0 {
							...
							if v37&int32(1) != 0 {
								F_appendStringInfoString(m, v8, int32(702900))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
