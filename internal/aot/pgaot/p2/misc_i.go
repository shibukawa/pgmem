	...
	if v14 != 0 {
		...
		if v11 == int32(0) {
			...
			if v20 != 0 {
				...
				F_errmsg_internal(m, int32(_a_F_icregexnesel_0), int32(0))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_icregexnesel_1), int32(773), int32(_a_F_icregexnesel_2))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v35))) = v333
	F_errmsg_internal(m, int32(_a_F_ineq_histogram_selectivity_0), v35)
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L13
...
L101:
	...
	switch v486 - int32(_a_F_ineq_histogram_selectivity_4) {
	case 0:
		goto L102
	default:
		goto L99
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = v519
	...
	v528 = *(*int32)(unsafe.Add(mBase, uint32(v222<<(uint(int32(2))%32))+uint32(_c_F_infix_1[2])))
...
L55:
	;
	v275 = F_pg_sprintf(m, v264, int32(_a_F_infix_1_0), int32(0))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L1
...
L89:
	;
	v455 = F_pg_sprintf(m, v444, int32(_a_F_infix_1_1), int32(0))
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L1
...
L117:
	;
	v576 = F_pg_sprintf(m, v565, int32(_a_F_infix_1_0), int32(0))
	mBase = m.M
	v577 = m.ExcPending
	if v577 != 0 {
		goto L1
...
L151:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v717
	v765 = F_pg_sprintf(m, v716, int32(_a_F_infix_1_2), v16+int32(16))
	mBase = m.M
	v766 = m.ExcPending
	if v766 != 0 {
		goto L1
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v717
	v731 = F_pg_sprintf(m, v716, int32(_a_F_infix_1_3), v16+int32(32))
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L1
...
L156:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v517
	v740 = F_pg_sprintf(m, v716, int32(_a_F_infix_1_4), v16-int32(-64))
	mBase = m.M
	v741 = m.ExcPending
	if v741 != 0 {
		goto L1
...
L158:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v717
	v746 = F_pg_sprintf(m, v716, int32(_a_F_infix_1_5), v16+int32(48))
	mBase = m.M
	v747 = m.ExcPending
	if v747 != 0 {
		goto L1
...
L186:
	;
	v877 = F_pg_sprintf(m, v866, int32(_a_F_infix_1_1), int32(0))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L1
...
L2:
	;
	v33 = *(*int32)(unsafe.Add(mBase, _c_F_initGISTstate[0]))
	v38 = F_AllocSetContextCreateInternal(m, v33, int32(_a_F_initGISTstate_0), int32(0), int32(_a_F_initGISTstate_1), int32(_a_F_initGISTstate_2))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L5
...
L6:
	;
	v42 = int32(_a_F_initGISTstate_3)
	v43 = *(*int32)(unsafe.Add(mBase, _c_F_initGISTstate[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_initGISTstate[0])) = v38
	v47 = F_palloc(m, int32(_a_F_initGISTstate_4))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L5
...
L31:
	;
	v246 = v114 + (v47 + int32(_a_F_initGISTstate_5))
...
L33:
	;
	v264 = v114 + (v47 + int32(_a_F_initGISTstate_6))
...
L38:
	;
	v298 = v114 + (v47 + int32(_a_F_initGISTstate_7))
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v114+(v47+int32(_a_F_initGISTstate_8))))) = int32(0)
	goto L36
L41:
	;
	v304 = v298 + int32(16)
...
L45:
	;
	v335 = v114 + (v47 + int32(_a_F_initGISTstate_9))
...
L47:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v114+(v47+int32(_a_F_initGISTstate_10))))) = int32(0)
	goto L43
L48:
	;
	v341 = v335 + int32(16)
...
L52:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v47+int32(_a_F_initGISTstate_11)+v357))) = v363
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v373
	F_errmsg_internal(m, int32(_a_F_initGISTstate_12), v26)
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L5
...
L55:
	;
	F_errfinish(m, int32(_a_F_initGISTstate_13), int32(1547), int32(_a_F_initGISTstate_14))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L5
...
L59:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_initGISTstate[0])) = v43
	m.G0 = v26 + int32(16)
	return v47
L60:
	;
	...
	*(*int32)(unsafe.Add(mBase, uint32(v455+(v47+int32(_a_F_initGISTstate_15))))) = v457
	*(*int32)(unsafe.Add(mBase, uint32(v455+(v47+int32(_a_F_initGISTstate_16))))) = v457
	*(*int32)(unsafe.Add(mBase, uint32(v455+(v47+int32(_a_F_initGISTstate_8))))) = v457
	*(*int32)(unsafe.Add(mBase, uint32(v455+(v47+int32(_a_F_initGISTstate_10))))) = v457
	*(*int32)(unsafe.Add(mBase, uint32(v47+int32(_a_F_initGISTstate_11)+v436<<(uint(int32(2))%32)))) = v457
	v489 = v436 + int32(1)
...
L2:
	;
	F_errsave_finish(m, v11, int32(_a_F_int2in_0), v400, int32(_a_F_int2in_1))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L81
...
L10:
	;
	if base.Ui32(int32(3276)) < base.Ui32(v38&int32(_a_F_int2in_2)) {
		goto L4
	} else {
		goto L12
	}
...
L15:
	;
	if base.Ui32(v65&int32(_a_F_int2in_2)-int32(_a_F_int2in_3)) < base.Ui32(int32(-65536)) {
		goto L4
	} else {
		goto L18
	}
...
L36:
	;
	if base.Ui32(int32(2048)) < base.Ui32(v130&int32(_a_F_int2in_2)) {
		goto L4
	} else {
		goto L39
	}
...
L46:
	;
	if base.Ui32(int32(_a_F_int2in_4)) < base.Ui32(v184&int32(_a_F_int2in_2)) {
		goto L4
	} else {
		goto L49
	}
...
L54:
	;
	if base.Ui32(int32(_a_F_int2in_5)) < base.Ui32(v225&int32(_a_F_int2in_2)) {
		goto L4
	} else {
		goto L57
	}
...
L62:
	;
	if base.Ui32(int32(3276)) < base.Ui32(v264&int32(_a_F_int2in_2)) {
		goto L4
	} else {
		goto L65
	}
...
L76:
	;
	if base.Ui32(v301&int32(_a_F_int2in_2)-int32(_a_F_int2in_3)) < base.Ui32(int32(-65536)) {
		goto L4
	} else {
		goto L79
	}
...
func F_interpret_func_volatility(m *base.Module, l0 int32) int32 {
	...
	v13 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_interpret_func_volatility[0])))
...
L11:
	;
	v39 = int32(_a_F_interpret_func_volatility_1)
	v42 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_interpret_func_volatility[1])))
...
L20:
	;
	v67 = int32(_a_F_interpret_func_volatility_2)
	v70 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_interpret_func_volatility[2])))
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v611
	v616 = F_find_among_b(m, l0, int32(_a_F_irish_UTF_8_stem_13), int32(25))
	mBase = m.M
	v617 = m.ExcPending
	if v617 != 0 {
		goto L3
...
L153:
	;
	v657 = F_slice_from_s(m, l0, int32(4), int32(_a_F_irish_UTF_8_stem_14))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L3
...
L154:
	;
	v651 = F_slice_from_s(m, l0, int32(5), int32(_a_F_irish_UTF_8_stem_15))
	mBase = m.M
	v652 = m.ExcPending
	if v652 != 0 {
		goto L3
...
L155:
	;
	v645 = F_slice_from_s(m, l0, int32(4), int32(_a_F_irish_UTF_8_stem_16))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L3
...
L156:
	;
	v639 = F_slice_from_s(m, l0, int32(3), int32(_a_F_irish_UTF_8_stem_17))
	mBase = m.M
	v640 = m.ExcPending
	if v640 != 0 {
		goto L3
...
L157:
	;
	v633 = F_slice_from_s(m, l0, int32(3), int32(_a_F_irish_UTF_8_stem_18))
	mBase = m.M
	v634 = m.ExcPending
	if v634 != 0 {
		goto L3
...
L174:
	;
	if int32(1)<<(uint(v674)%32)&int32(_a_F_irish_UTF_8_stem_19) == int32(0) {
		goto L172
	} else {
		goto L175
	}
