			...
			if v16 != 0 {
				...
				if v15 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = l1
					F_errmsg_internal(m, int32(301780), v5)
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
					} else {
						F_errfinish(m, int32(509161), int32(302), int32(359430))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = l1
	F_errmsg_internal(m, int32(301735), v5)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L15:
	;
	F_errfinish(m, int32(509161), int32(290), int32(333266))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L12
	...
	if base.Ui32(v2-int32(128)) <= base.Ui32(int32(-257)) {
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				F_errmsg(m, int32(411369), int32(0))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(507146), int32(197), int32(234857))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return int32(0)
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				if v19 != 0 {
					...
					F_errfinish(m, int32(512859), int32(1360), int32(443279))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return int32(0)
						...
						if v20 != 0 {
							...
							if v23 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v24
								F_errcontext_msg(m, int32(733504), v6)
								mBase = m.M
								v28 = m.ExcPending
								if v28 != 0 {
									return
				...
				if v138 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = l3
					...
					if v146 != 0 {
						...
						F_errfinish(m, int32(507970), int32(648), int32(246606))
						mBase = m.M
						v151 = m.ExcPending
						if v151 != 0 {
							return int32(0)
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v35))) = v333
	F_errmsg_internal(m, int32(345873), v35)
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L13
...
L55:
	;
	v275 = F_pg_sprintf(m, v264, int32(760500), int32(0))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L1
...
L72:
	;
	v399 = F_pg_sprintf(m, v388, int32(699424), int32(0))
	mBase = m.M
	v400 = m.ExcPending
	if v400 != 0 {
		goto L1
...
L83:
	;
	v464 = F_pg_sprintf(m, v453, int32(760500), int32(0))
	mBase = m.M
	v465 = m.ExcPending
	if v465 != 0 {
		goto L1
...
L100:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v549
	v597 = F_pg_sprintf(m, v548, int32(181396), v16+int32(16))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L1
...
L103:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v549
	v563 = F_pg_sprintf(m, v548, int32(210218), v16+int32(32))
	mBase = m.M
	v564 = m.ExcPending
	if v564 != 0 {
		goto L1
...
L105:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v405
	v572 = F_pg_sprintf(m, v548, int32(202444), v16-int32(-64))
	mBase = m.M
	v573 = m.ExcPending
	if v573 != 0 {
		goto L1
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v549
	v578 = F_pg_sprintf(m, v548, int32(202521), v16+int32(48))
	mBase = m.M
	v579 = m.ExcPending
	if v579 != 0 {
		goto L1
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v222
	F_errmsg_internal(m, int32(495201), v16)
	mBase = m.M
	v587 = m.ExcPending
	if v587 != 0 {
		goto L1
...
L111:
	;
	F_errfinish(m, int32(503079), int32(1130), int32(27512))
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L1
...
L118:
	;
	v653 = F_pg_sprintf(m, v642, int32(699424), int32(0))
	mBase = m.M
	v654 = m.ExcPending
	if v654 != 0 {
		goto L1
...
L2:
	...
	v38 = F_AllocSetContextCreateInternal(m, v33, int32(62122), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L5
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v373
	F_errmsg_internal(m, int32(490254), v26)
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L5
...
L55:
	;
	F_errfinish(m, int32(503494), int32(1547), int32(360000))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L5
	...
	if base.Ui32(int32(242)) < base.Ui32((v2-int32(17))&int32(255)) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v15
		...
		if v37 != 0 {
			...
			F_errmsg_internal(m, int32(351625), int32(0))
			mBase = m.M
			v41 = m.ExcPending
			if v41 != 0 {
				return
			} else {
				F_errfinish(m, int32(510104), int32(71), int32(334919))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return
...
L2:
	;
	F_errsave_finish(m, v11, int32(505196), v400, int32(418609))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L81
...
L84:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = int32(90918)
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v10
	F_errmsg(m, int32(194005), v14)
	mBase = m.M
	v363 = m.ExcPending
	if v363 != 0 {
		goto L81
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(90918)
	F_errmsg(m, int32(739236), v14+int32(16))
	mBase = m.M
	v389 = m.ExcPending
	if v389 != 0 {
		goto L81
		...
		if v8 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(512295), int32(6953), int32(292574))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					if v23 != 0 {
						...
						F_errfinish(m, int32(512859), int32(1084), int32(36487))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
			...
			if v45 != 0 {
				...
				if v48 != 0 {
					...
					if v52 != 0 {
						...
						F_errfinish(m, int32(512859), int32(1100), int32(36487))
						mBase = m.M
						v57 = m.ExcPending
						if v57 != 0 {
							return int32(0)
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					if v28 != 0 {
						...
						F_errfinish(m, int32(512859), int32(514), int32(36385))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
				...
				if v48 != 0 {
					...
					if v51 != 0 {
						...
						if v55 != 0 {
							...
							F_errfinish(m, int32(512859), int32(530), int32(36385))
							mBase = m.M
							v60 = m.ExcPending
							if v60 != 0 {
								return int32(0)
					...
					if v147 != 0 {
						...
						if v150 != 0 {
							...
							if v156 != 0 {
								...
								F_errfinish(m, int32(507357), int32(359), int32(297715))
								mBase = m.M
								v163 = m.ExcPending
								if v163 != 0 {
									return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[1191])) = int32(-1)
		...
		if v31 != 0 {
			...
			if v35 != 0 {
				...
				F_errfinish(m, int32(510118), int32(1509), int32(15413))
				mBase = m.M
				v40 = m.ExcPending
				if v40 != 0 {
					return int32(0)
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = v9
	F_errmsg_internal(m, int32(706135), v5)
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L30
...
L32:
	;
	F_errfinish(m, int32(505763), int32(629), int32(11508))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L30
...
func F_irish_UTF_8_stem(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v4
	v8 = F_find_among(m, l0, int32(4321088), int32(24))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		goto L3
...
L6:
	;
	v72 = F_slice_from_s(m, l0, int32(1), int32(2224287))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L3
...
L7:
	;
	v66 = F_slice_from_s(m, l0, int32(1), int32(2224286))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L3
...
L8:
	;
	v60 = F_slice_from_s(m, l0, int32(1), int32(2224285))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L3
...
L9:
	;
	v54 = F_slice_from_s(m, l0, int32(1), int32(2224284))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L3
...
L10:
	;
	v48 = F_slice_from_s(m, l0, int32(1), int32(2224283))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L3
...
L11:
	;
	v42 = F_slice_from_s(m, l0, int32(1), int32(2224282))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L3
...
L12:
	;
	v36 = F_slice_from_s(m, l0, int32(1), int32(2224281))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L3
...
L13:
	;
	v30 = F_slice_from_s(m, l0, int32(1), int32(2224280))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L3
...
L14:
	;
	v24 = F_slice_from_s(m, l0, int32(1), int32(2224279))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L3
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v582
	v587 = F_find_among_b(m, l0, int32(4321568), int32(16))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L3
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v611
	v616 = F_find_among_b(m, l0, int32(4321888), int32(25))
	mBase = m.M
	v617 = m.ExcPending
	if v617 != 0 {
		goto L3
...
L153:
	;
	v657 = F_slice_from_s(m, l0, int32(4), int32(2224459))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L3
...
L154:
	;
	v651 = F_slice_from_s(m, l0, int32(5), int32(2224454))
	mBase = m.M
	v652 = m.ExcPending
	if v652 != 0 {
		goto L3
...
L155:
	;
	v645 = F_slice_from_s(m, l0, int32(4), int32(2224450))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L3
...
L156:
	;
	v639 = F_slice_from_s(m, l0, int32(3), int32(2224447))
	mBase = m.M
	v640 = m.ExcPending
	if v640 != 0 {
		goto L3
...
L157:
	;
	v633 = F_slice_from_s(m, l0, int32(3), int32(2224444))
	mBase = m.M
	v634 = m.ExcPending
	if v634 != 0 {
		goto L3
...
L175:
	;
	v687 = F_find_among_b(m, l0, int32(4322400), int32(12))
	mBase = m.M
	v688 = m.ExcPending
	if v688 != 0 {
		goto L3
...
func F_ivfflatbeginscan(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v12 = v10 - int32(32)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[1410]))
	...
	if v19 != 0 {
		...
		if v25 != 0 {
			...
			v27 = *(*int32)(unsafe.Add(mBase, _consts[1411]))
			v29 = *(*int32)(unsafe.Add(mBase, _consts[1412]))
						...
						*(*int32)(unsafe.Add(mBase, uint32(v32)+48)) = v54
						...
						if v59 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v32)+56)) = v62
							...
							v70 = F_AllocSetContextCreateInternal(m, v65, int32(60925), int32(0), int32(8192), int32(8388608))
							mBase = m.M
							v71 = m.ExcPending
							if v71 != 0 {
								return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, _consts[0])) = v70
								...
								if v79 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v32)+32)) = v78
									F_TupleDescInitEntry(m, v78, int32(1), int32(427213), int32(701), int32(-1), int32(0))
									mBase = m.M
									v87 = m.ExcPending
									if v87 != 0 {
										return int32(0)
										...
										F_TupleDescInitEntry(m, v88, int32(2), int32(442663), int32(27), int32(-1), int32(0))
										mBase = m.M
										v95 = m.ExcPending
										if v95 != 0 {
											return int32(0)
											...
											*(*uint8)(unsafe.Add(mBase, uint32(v12)+19)) = uint8(v101)
											...
											if v119 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v32)+28)) = v118
												...
												v123 = F_MakeSingleTupleTableSlot(m, v121, int32(1632148))
												mBase = m.M
												v124 = m.ExcPending
												if v124 != 0 {
													return int32(0)
													...
													*(*int32)(unsafe.Add(mBase, uint32(v32)+36)) = v123
													...
													v128 = F_MakeSingleTupleTableSlot(m, v126, int32(1632252))
													mBase = m.M
													v129 = m.ExcPending
													if v129 != 0 {
														return int32(0)
														...
														*(*int32)(unsafe.Add(mBase, uint32(v32)+40)) = v128
														...
														if v133 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v32)+44)) = v132
															v136 = F_pairingheap_allocate(m, int32(7553), v16)
															mBase = m.M
															v137 = m.ExcPending
															if v137 != 0 {
																return int32(0)
...
func F_ivfflathandler(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v3)+108)) = int32(6986)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+104)) = v7
		*(*int32)(unsafe.Add(mBase, uint32(v3)+100)) = int32(6987)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+96)) = int32(6990)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+92)) = int32(6982)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v3)+56)) = int32(6991)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+52)) = int32(6985)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+48)) = v7
		*(*int32)(unsafe.Add(mBase, uint32(v3)+44)) = int32(6989)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+40)) = int32(6984)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+36)) = int32(6983)
...
func F_ivfflatoptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v8 = F_build_reloptions(m, l0, l1, v4, int32(8), int32(4098880), int32(1))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
