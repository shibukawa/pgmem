			...
			if v16 != 0 {
				...
				if v15 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = l1
					F_errmsg_internal(m, int32(281021), v5)
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
					} else {
						F_errfinish(m, int32(474134), int32(302), int32(334414))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = l1
	F_errmsg_internal(m, int32(280976), v5)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L15:
	;
	F_errfinish(m, int32(474134), int32(290), int32(310246))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L12
	...
	if base.Ui32(v2-int32(128)) <= base.Ui32(int32(-257)) {
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				F_errmsg(m, int32(383567), int32(0))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(472715), int32(197), int32(218741))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return int32(0)
	...
	if base.Ui64(int64(4294967296)) <= base.Ui64(v4) {
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				F_errmsg(m, int32(383514), int32(0))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(477043), int32(1360), int32(413056))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return int32(0)
						...
						if v20 != 0 {
							...
							if v23 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v24
								F_errcontext_msg(m, int32(677792), v6)
								mBase = m.M
								v28 = m.ExcPending
								if v28 != 0 {
									return
				...
				if v138 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = l3
					...
					if v146 != 0 {
						...
						F_errfinish(m, int32(473405), int32(648), int32(229205))
						mBase = m.M
						v151 = m.ExcPending
						if v151 != 0 {
							return int32(0)
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v35))) = v333
	F_errmsg_internal(m, int32(321790), v35)
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L13
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v373
	F_errmsg_internal(m, int32(457858), v26)
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L5
...
L55:
	;
	F_errfinish(m, int32(469965), int32(1547), int32(334888))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L5
	...
	if base.Ui32(int32(242)) < base.Ui32((v2-int32(17))&int32(255)) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v15
		...
		if v37 != 0 {
			...
			F_errmsg_internal(m, int32(326885), int32(0))
			mBase = m.M
			v41 = m.ExcPending
			if v41 != 0 {
				return
			} else {
				F_errfinish(m, int32(475023), int32(71), int32(311195))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return
...
L2:
	;
	F_errsave_finish(m, v11, int32(471067), v400, int32(390449))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L81
...
L84:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = int32(84717)
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v10
	F_errmsg(m, int32(179782), v14)
	mBase = m.M
	v363 = m.ExcPending
	if v363 != 0 {
		goto L81
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(84717)
	F_errmsg(m, int32(683524), v14+int32(16))
	mBase = m.M
	v389 = m.ExcPending
	if v389 != 0 {
		goto L81
		...
		if v8 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(476879), int32(6953), int32(272647))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					if v23 != 0 {
						...
						F_errfinish(m, int32(477043), int32(1084), int32(33270))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
			...
			if v45 != 0 {
				...
				if v48 != 0 {
					...
					if v52 != 0 {
						...
						F_errfinish(m, int32(477043), int32(1100), int32(33270))
						mBase = m.M
						v57 = m.ExcPending
						if v57 != 0 {
							return int32(0)
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					if v28 != 0 {
						...
						F_errfinish(m, int32(477043), int32(514), int32(33168))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
				...
				if v48 != 0 {
					...
					if v51 != 0 {
						...
						if v55 != 0 {
							...
							F_errfinish(m, int32(477043), int32(530), int32(33168))
							mBase = m.M
							v60 = m.ExcPending
							if v60 != 0 {
								return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[1184])) = int32(-1)
		...
		if v31 != 0 {
			...
			if v35 != 0 {
				...
				F_errfinish(m, int32(475037), int32(1509), int32(14223))
				mBase = m.M
				v40 = m.ExcPending
				if v40 != 0 {
					return int32(0)
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = v9
	F_errmsg_internal(m, int32(650514), v5)
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L30
...
L32:
	;
	F_errfinish(m, int32(471492), int32(629), int32(10352))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L30
...
func F_irish_UTF_8_stem(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v4
	v8 = F_find_among(m, l0, int32(4241360), int32(24))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		goto L3
...
L6:
	;
	v72 = F_slice_from_s(m, l0, int32(1), int32(2151887))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L3
...
L7:
	;
	v66 = F_slice_from_s(m, l0, int32(1), int32(2151886))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L3
...
L8:
	;
	v60 = F_slice_from_s(m, l0, int32(1), int32(2151885))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L3
...
L9:
	;
	v54 = F_slice_from_s(m, l0, int32(1), int32(2151884))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L3
...
L10:
	;
	v48 = F_slice_from_s(m, l0, int32(1), int32(2151883))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L3
...
L11:
	;
	v42 = F_slice_from_s(m, l0, int32(1), int32(2151882))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L3
...
L12:
	;
	v36 = F_slice_from_s(m, l0, int32(1), int32(2151881))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L3
...
L13:
	;
	v30 = F_slice_from_s(m, l0, int32(1), int32(2151880))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L3
...
L14:
	;
	v24 = F_slice_from_s(m, l0, int32(1), int32(2151879))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L3
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v582
	v587 = F_find_among_b(m, l0, int32(4241840), int32(16))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L3
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v611
	v616 = F_find_among_b(m, l0, int32(4242160), int32(25))
	mBase = m.M
	v617 = m.ExcPending
	if v617 != 0 {
		goto L3
...
L153:
	;
	v657 = F_slice_from_s(m, l0, int32(4), int32(2152059))
	mBase = m.M
	v658 = m.ExcPending
	if v658 != 0 {
		goto L3
...
L154:
	;
	v651 = F_slice_from_s(m, l0, int32(5), int32(2152054))
	mBase = m.M
	v652 = m.ExcPending
	if v652 != 0 {
		goto L3
...
L155:
	;
	v645 = F_slice_from_s(m, l0, int32(4), int32(2152050))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L3
...
L156:
	;
	v639 = F_slice_from_s(m, l0, int32(3), int32(2152047))
	mBase = m.M
	v640 = m.ExcPending
	if v640 != 0 {
		goto L3
...
L157:
	;
	v633 = F_slice_from_s(m, l0, int32(3), int32(2152044))
	mBase = m.M
	v634 = m.ExcPending
	if v634 != 0 {
		goto L3
...
L175:
	;
	v687 = F_find_among_b(m, l0, int32(4242672), int32(12))
	mBase = m.M
	v688 = m.ExcPending
	if v688 != 0 {
		goto L3
