					...
					*(*int64)(unsafe.Add(mBase, uint32(v72)+8)) = v77 + base.I64_extend16_s(v4)
					...
					if v55 != 0 {
						...
						if v59 != 0 {
							...
							F_errfinish(m, int32(496807), int32(6794), int32(285740))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return int32(0)
					...
					*(*int64)(unsafe.Add(mBase, uint32(v72)+8)) = v77 - base.I64_extend16_s(v4)
					...
					if v55 != 0 {
						...
						if v59 != 0 {
							...
							F_errfinish(m, int32(496807), int32(6881), int32(32583))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return int32(0)
...
func F_int2_dist(m *base.Module, l0 int32) int32 {
	...
	if base.B2i32(v6 == v5)&base.B2i32(v5&int32(65535) != int32(32768)) == int32(0) {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			...
			if v23 != 0 {
				...
				if v29 != 0 {
					...
					F_errfinish(m, int32(497021), int32(107), int32(75657))
					mBase = m.M
					v36 = m.ExcPending
					if v36 != 0 {
						return int32(0)
