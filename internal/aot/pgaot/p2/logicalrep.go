...
func F_logicalrep_partmap_invalidate_cb(m *base.Module, l0 int32, l1 int32) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[649]))
	if v9 == int32(0) {
		goto L1
	} else {
		goto L2
...
L3:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[642]))
	if int32(0) < v19 {
		goto L6
	} else {
		goto L7
...
L18:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[642]))
	v50 = *(*int32)(unsafe.Add(mBase, _consts[643]))
	v51 = v45
	v53 = v48
	v54 = v50
	goto L11
