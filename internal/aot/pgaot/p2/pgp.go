...
L74:
	;
	F_errfinish(m, int32(480439), int32(937), int32(128736))
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L6
...
func F_pgp_expect_packet_end(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		if int32(0) < v10 {
			F_px_debug(m, int32(487291), int32(0))
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
...
L136:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v431))) = uint8(v432)
	v435 = F_strstr(m, v419, int32(710976))
	mBase = m.M
	if v435 == v432 {
		v486 = v16
		goto L3
...
L149:
	;
	F_errfinish(m, int32(478318), int32(473), int32(128701))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L117
...
L152:
	;
	F_errfinish(m, int32(478318), int32(484), int32(128701))
	mBase = m.M
	v525 = m.ExcPending
	if v525 != 0 {
		goto L117
