					...
					if v33 != int32(1) {
						...
						if v157 != 0 {
							...
							if v163 != 0 {
								...
								F_errfinish(m, int32(517357), int32(937), int32(143049))
								mBase = m.M
								v170 = m.ExcPending
								if v170 != 0 {
									return int32(0)
...
func F_pgp_expect_packet_end(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		if int32(0) < v10 {
			F_px_debug(m, int32(525179), int32(0))
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
...
L13:
	;
	v38 = int32(*(*int8)(unsafe.Add(mBase, _consts[1397])))
	v42 = l0
	goto L14
L14:
	;
...
L53:
	;
	v152 = int32(*(*int8)(unsafe.Add(mBase, _consts[1398])))
	v156 = v131
	goto L54
L54:
	;
...
L136:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v431))) = uint8(v432)
	v435 = F_strstr(m, v419, int32(773855))
	mBase = m.M
	if v435 == v432 {
		v486 = v16
		goto L3
...
L148:
	;
	F_errmsg_internal(m, int32(171360), int32(0))
	mBase = m.M
	v501 = m.ExcPending
	if v501 != 0 {
		goto L117
...
L149:
	;
	F_errfinish(m, int32(514717), int32(473), int32(143014))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L117
...
L152:
	;
	F_errfinish(m, int32(514717), int32(484), int32(143014))
	mBase = m.M
	v525 = m.ExcPending
	if v525 != 0 {
		goto L117
...
func F_pgp_get_cipher_key_size(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(int32(8)) < base.Ui32(v4) {
		...
		if int32(base.Ui32(int32(487))>>(uint(v4)%32))&int32(1) == int32(0) {
			...
			v17 = *(*int32)(unsafe.Add(mBase, uint32(v4<<(uint(int32(2))%32))+uint32(_consts[1399])))
