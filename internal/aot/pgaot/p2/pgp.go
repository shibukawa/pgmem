					...
					if v33 != int32(1) {
						...
						if v157 != 0 {
							...
							if v163 != 0 {
								...
								F_errfinish(m, int32(498450), int32(937), int32(136009))
								mBase = m.M
								v170 = m.ExcPending
								if v170 != 0 {
									return int32(0)
...
func F_pgp_expect_packet_end(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		if int32(0) < v10 {
			F_px_debug(m, int32(505556), int32(0))
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
...
L136:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v431))) = uint8(v432)
	v435 = F_strstr(m, v419, int32(747356))
	mBase = m.M
	if v435 == v432 {
		v486 = v16
		goto L3
...
L148:
	;
	F_errmsg_internal(m, int32(163419), int32(0))
	mBase = m.M
	v501 = m.ExcPending
	if v501 != 0 {
		goto L117
...
L149:
	;
	F_errfinish(m, int32(496255), int32(473), int32(135974))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L117
...
L152:
	;
	F_errfinish(m, int32(496255), int32(484), int32(135974))
	mBase = m.M
	v525 = m.ExcPending
	if v525 != 0 {
		goto L117
