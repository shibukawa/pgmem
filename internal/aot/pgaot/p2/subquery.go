...
L96:
	;
	F_errfinish(m, int32(476818), int32(1080), int32(106948))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L19
...
L109:
	;
	F_errmsg_internal(m, int32(160320), int32(0))
	mBase = m.M
	v363 = m.ExcPending
	if v363 != 0 {
		goto L20
...
L110:
	;
	F_errfinish(m, int32(477310), int32(3862), int32(154611))
	mBase = m.M
	v368 = m.ExcPending
	if v368 != 0 {
		goto L20
...
L113:
	;
	F_errfinish(m, int32(477310), int32(3868), int32(154611))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L20
