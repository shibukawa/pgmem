...
L5:
	;
	v107 = F_AllocateFile(m, int32(_a_F_pg_current_logfile_0), int32(_a_F_pg_current_logfile_1))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L8
...
L10:
	;
	v22 = int32(_a_F_pg_current_logfile_2)
	v25 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_current_logfile[0])))
...
L19:
	;
	v50 = int32(_a_F_pg_current_logfile_3)
	v53 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_current_logfile[1])))
...
L28:
	;
	v78 = int32(_a_F_pg_current_logfile_4)
	v81 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_current_logfile[2])))
...
L44:
	;
	v182 = *(*int32)(unsafe.Add(mBase, _c_F_pg_current_logfile[3]))
	if v182 != int32(44) {
		goto L3
	} else {
		goto L73
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = v20
	F_errmsg(m, int32(_a_F_pg_current_logfile_5), v9+int32(48))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L8
...
L81:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(_a_F_pg_current_logfile_0)
	F_errmsg(m, int32(_a_F_pg_current_logfile_9), v9)
	mBase = m.M
	v241 = m.ExcPending
	if v241 != 0 {
		goto L8
...
L84:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(_a_F_pg_current_logfile_0)
	F_errmsg_internal(m, int32(_a_F_pg_current_logfile_10), v9+int32(16))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L8
...
L87:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = int32(_a_F_pg_current_logfile_0)
	F_errmsg_internal(m, int32(_a_F_pg_current_logfile_11), v9+int32(32))
	mBase = m.M
	v273 = m.ExcPending
	if v273 != 0 {
		goto L8
