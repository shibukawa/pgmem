...
func F_GetRecoveryPauseState(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4)+96)) = int32(1)
	if v5 != 0 {
		...
		F_s_lock(m, v9+int32(96), int32(489255), int32(3096), int32(351852))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
...
func F_check_recovery_target_name(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v11 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(376258)
		v24 = F_format_elog_string(m, int32(642318), v6)
		mBase = m.M
		v27 = m.ExcPending
		if v27 != 0 {
			return int32(0)
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8
	v266 = F_format_elog_string(m, int32(649482), v6)
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L42
...
L8:
	;
	v14 = F_strstr(m, l0, int32(552377))
	mBase = m.M
	if v14 == int32(0) {
		goto L3
	} else {
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = l0
	F_errmsg_internal(m, int32(198028), v6+int32(32))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L16
...
L21:
	;
	F_errfinish(m, int32(491122), int32(3298), int32(212345))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L16
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
	F_errmsg_internal(m, int32(198059), v6)
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L16
...
L53:
	;
	F_errfinish(m, int32(491122), int32(3291), int32(212345))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L16
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = l0
	F_errmsg(m, int32(673836), v6+int32(48))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L16
...
L56:
	;
	F_errfinish(m, int32(491122), int32(3295), int32(212345))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L16
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = l0
	F_errmsg(m, int32(294732), v6+int32(16))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L16
...
L59:
	;
	F_errfinish(m, int32(491122), int32(3302), int32(212345))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L16
