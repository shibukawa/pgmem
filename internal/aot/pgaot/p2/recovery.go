...
func F_GetRecoveryPauseState(m *base.Module) int32 {
	...
	var v23 int32
	_ = v23
	v4 = *(*int32)(unsafe.Add(mBase, _consts[251]))
	v5 = *(*int32)(unsafe.Add(mBase, uint32(v4)+96))
	*(*int32)(unsafe.Add(mBase, uint32(v4)+96)) = int32(1)
	if v5 != 0 {
		v9 = *(*int32)(unsafe.Add(mBase, _consts[251]))
		F_s_lock(m, v9+int32(96), int32(517171), int32(3096), int32(372893))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
		} else {
			v20 = *(*int32)(unsafe.Add(mBase, _consts[251]))
...
func F_check_recovery_target_name(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v11 == int32(0) {
		v15 = *(*int32)(unsafe.Add(mBase, _consts[158]))
		*(*int32)(unsafe.Add(mBase, _consts[253])) = v15
		*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = int32(63)
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(398279)
		v24 = F_format_elog_string(m, int32(693620), v6)
		mBase = m.M
		v27 = m.ExcPending
		if v27 != 0 {
			return int32(0)
		} else {
			*(*int32)(unsafe.Add(mBase, _consts[254])) = v24
			m.G0 = v6 + int32(16)
			return v11
		}
	} else {
...
L4:
	...
	v13 = int32(0)
	v14 = int32(32659)
	v17 = int32(*(*uint8)(unsafe.Add(mBase, _consts[256])))
...
L13:
	;
	v42 = int32(27495)
	v45 = int32(*(*uint8)(unsafe.Add(mBase, _consts[257])))
...
L22:
	;
	v70 = int32(31505)
	v73 = int32(*(*uint8)(unsafe.Add(mBase, _consts[258])))
...
L31:
	;
	v98 = int32(27485)
	v101 = int32(*(*uint8)(unsafe.Add(mBase, _consts[259])))
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, _consts[253])) = v260
	goto L69
L69:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8
	v266 = F_format_elog_string(m, int32(701024), v6)
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L42
...
L70:
	;
	*(*int32)(unsafe.Add(mBase, _consts[254])) = v266
	v269 = v13
	goto L1
}
...
L8:
	;
	v14 = F_strstr(m, l0, int32(600071))
	mBase = m.M
	if v14 == int32(0) {
		goto L3
	} else {
...
L10:
	;
	v18 = int32(*(*uint8)(unsafe.Add(mBase, _consts[157])))
	if v18 != int32(1) {
		goto L12
	} else {
		goto L13
...
L13:
	;
	v23 = int32(*(*uint8)(unsafe.Add(mBase, _consts[385])))
	if v23 == int32(0) {
		goto L2
	} else {
		goto L15
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = l0
	F_errmsg_internal(m, int32(210131), v6+int32(32))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L16
...
L20:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[386]))
	v48 = m.G0
	v50 = v48 - int32(96)
	m.G0 = v50
...
L21:
	;
	F_errfinish(m, int32(519818), int32(3298), int32(224992))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L16
...
L45:
	;
	*(*int32)(unsafe.Add(mBase, _consts[158])) = v90
	v111 = int32(-1)
	goto L24
L46:
	;
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
	F_errmsg_internal(m, int32(210162), v6)
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L16
...
L53:
	;
	F_errfinish(m, int32(519818), int32(3291), int32(224992))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L16
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = l0
	F_errmsg(m, int32(726605), v6+int32(48))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L16
...
L56:
	;
	F_errfinish(m, int32(519818), int32(3295), int32(224992))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L16
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = l0
	F_errmsg(m, int32(311586), v6+int32(16))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L16
...
L59:
	;
	F_errfinish(m, int32(519818), int32(3302), int32(224992))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L16
