...
L36:
	;
	*(*int32)(unsafe.Add(mBase, _consts[155])) = int32(37)
	return int32(0)
L37:
	;
	v144 = v113 + int32(1)
...
L38:
	;
	v139 = F__emscripten_memcpy_bulkmem(m, l1, int32(537077), int32(9))
	mBase = m.M
	goto L40
L40:
	;
...
L28:
	;
	F_s_lock(m, v25, int32(478839), int32(246), int32(207289))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L25
...
L38:
	;
	v115 = *(*int32)(unsafe.Add(mBase, _consts[96]))
...
L39:
	;
	v122 = *(*int32)(unsafe.Add(mBase, _consts[96]))
