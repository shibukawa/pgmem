...
L38:
	;
	v139 = F__emscripten_memcpy_bulkmem(m, l1, int32(_a_F___shm_mapname_0), int32(9))
	mBase = m.M
	goto L40
L40:
	;
...
L28:
	;
	F_s_lock(m, v25, int32(_a_F_shm_mq_send_bytes_0), int32(246), int32(_a_F_shm_mq_send_bytes_1))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L25
...
L38:
	;
	v115 = *(*int32)(unsafe.Add(mBase, _c_F_shm_mq_send_bytes[0]))
...
L39:
	;
	v122 = *(*int32)(unsafe.Add(mBase, _c_F_shm_mq_send_bytes[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v122))) = int32(0)
	goto L40
L40:
	;
	v126 = *(*int32)(unsafe.Add(mBase, _c_F_shm_mq_send_bytes[1]))
	if v126 == int32(0) {
		v151 = v40
		goto L9
	} else {
