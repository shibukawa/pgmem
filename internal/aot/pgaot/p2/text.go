...
L97:
	;
	F_errfinish(m, int32(527120), int32(4531), int32(243987))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L12
...
L103:
	;
	v379 = *(*int32)(unsafe.Add(mBase, _consts[361]))
	v380 = *(*int32)(unsafe.Add(mBase, uint32(v379)+4))
	v385 = *(*int32)(unsafe.Add(mBase, uint32(v380*int32(28))+uint32(_consts[1014])))
	goto L106
L104:
	;
	v449 = v314
...
L115:
	...
	v958 = v957 - v450
	v960 = *(*int32)(unsafe.Add(mBase, _consts[361]))
	v961 = *(*int32)(unsafe.Add(mBase, uint32(v960)+4))
	v966 = *(*int32)(unsafe.Add(mBase, uint32(v961*int32(28))+uint32(_consts[1014])))
	goto L228
L116:
	;
	if v471 != 0 {
...
L188:
	;
	v691 = v685 - v450
	v693 = *(*int32)(unsafe.Add(mBase, _consts[361]))
	v694 = *(*int32)(unsafe.Add(mBase, uint32(v693)+4))
	v699 = *(*int32)(unsafe.Add(mBase, uint32(v694*int32(28))+uint32(_consts[1014])))
	goto L189
L189:
	;
	if v699 != int32(1) {
...
L192:
	...
	v781 = v688 - v685
	v784 = v449 + v765
	v786 = *(*int32)(unsafe.Add(mBase, _consts[361]))
	v787 = *(*int32)(unsafe.Add(mBase, uint32(v786)+4))
	v792 = *(*int32)(unsafe.Add(mBase, uint32(v787*int32(28))+uint32(_consts[1014])))
	goto L200
L193:
	;
	v711 = v691
...
L43:
	;
	v108 = F_DirectFunctionCall2Coll(m, int32(1563), v19, v21, v39)
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L3
...
L83:
	;
	v206 = F_DirectFunctionCall2Coll(m, int32(1563), v19, v196, v39)
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L3
...
L120:
	;
	v312 = F_DirectFunctionCall2Coll(m, int32(1563), v19, v302, v39)
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L3
...
L16:
	;
	F_errfinish(m, int32(527120), int32(6191), int32(132092))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L12
...
L19:
	;
	F_errmsg(m, int32(422619), int32(0))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L12
...
L20:
	;
	F_errfinish(m, int32(527120), int32(6190), int32(132092))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L12
			...
			if v48 != 0 {
				...
				if v51 != 0 {
					...
					if v55 != 0 {
						...
						F_errfinish(m, int32(527120), int32(1186), int32(27034))
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(527120), int32(1182), int32(27034))
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
					} else {
