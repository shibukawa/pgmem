...
L103:
	;
	v379 = *(*int32)(unsafe.Add(mBase, _c_F_replace_text_regexp[1]))
	v380 = *(*int32)(unsafe.Add(mBase, uint32(v379)+4))
	v385 = *(*int32)(unsafe.Add(mBase, uint32(v380*int32(28))+uint32(_c_F_replace_text_regexp[2])))
	goto L106
L104:
	;
	v449 = v314
...
L115:
	...
	v958 = v957 - v450
	v960 = *(*int32)(unsafe.Add(mBase, _c_F_replace_text_regexp[1]))
	v961 = *(*int32)(unsafe.Add(mBase, uint32(v960)+4))
	v966 = *(*int32)(unsafe.Add(mBase, uint32(v961*int32(28))+uint32(_c_F_replace_text_regexp[2])))
	goto L228
L116:
	;
	if v471 != 0 {
...
L188:
	;
	v691 = v685 - v450
	v693 = *(*int32)(unsafe.Add(mBase, _c_F_replace_text_regexp[1]))
	v694 = *(*int32)(unsafe.Add(mBase, uint32(v693)+4))
	v699 = *(*int32)(unsafe.Add(mBase, uint32(v694*int32(28))+uint32(_c_F_replace_text_regexp[2])))
	goto L189
L189:
	;
	if v699 != int32(1) {
...
L192:
	...
	v781 = v688 - v685
	v784 = v449 + v765
	v786 = *(*int32)(unsafe.Add(mBase, _c_F_replace_text_regexp[1]))
	v787 = *(*int32)(unsafe.Add(mBase, uint32(v786)+4))
	v792 = *(*int32)(unsafe.Add(mBase, uint32(v787*int32(28))+uint32(_c_F_replace_text_regexp[2])))
	goto L200
L193:
	;
	v711 = v691
...
L13:
	...
	v344 = *(*int32)(unsafe.Add(mBase, _c_F_split_text[0]))
...
L53:
	;
	v151 = *(*int32)(unsafe.Add(mBase, _c_F_split_text[1]))
	if v151 != 0 {
		goto L55
	} else {
		goto L56
...
L90:
	...
	v225 = *(*int32)(unsafe.Add(mBase, _c_F_split_text[0]))
...
L110:
	;
	v297 = *(*int32)(unsafe.Add(mBase, _c_F_split_text[1]))
	if v297 != 0 {
		goto L111
	} else {
		goto L112
...
L127:
	...
	v331 = *(*int32)(unsafe.Add(mBase, _c_F_split_text[0]))
