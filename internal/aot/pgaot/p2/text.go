...
L97:
	;
	F_errfinish(m, int32(499834), int32(4531), int32(231430))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L12
...
L16:
	;
	F_errfinish(m, int32(499834), int32(6191), int32(123516))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L12
...
L20:
	;
	F_errfinish(m, int32(499834), int32(6190), int32(123516))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L12
			...
			if v48 != 0 {
				...
				if v51 != 0 {
					...
					if v55 != 0 {
						...
						F_errfinish(m, int32(499834), int32(1186), int32(26415))
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(499834), int32(1182), int32(26415))
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
					} else {
