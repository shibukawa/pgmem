...
L97:
	;
	F_errfinish(m, int32(488865), int32(4531), int32(226612))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L12
...
L16:
	;
	F_errfinish(m, int32(488865), int32(6191), int32(120630))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L12
...
L19:
	;
	F_errmsg(m, int32(393262), int32(0))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L12
...
L20:
	;
	F_errfinish(m, int32(488865), int32(6190), int32(120630))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L12
			...
			if v48 != 0 {
				...
				if v51 != 0 {
					...
					if v55 != 0 {
						...
						F_errfinish(m, int32(488865), int32(1186), int32(25717))
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(488865), int32(1182), int32(25717))
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
					} else {
