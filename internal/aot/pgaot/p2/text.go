...
L97:
	;
	F_errfinish(m, int32(480803), int32(4531), int32(221687))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L12
...
L103:
	...
	v385 = *(*int32)(unsafe.Add(mBase, uint32(v380*int32(28))+uint32(_consts[1004])))
	goto L106
L104:
	;
	v449 = v314
...
L115:
	...
	v966 = *(*int32)(unsafe.Add(mBase, uint32(v961*int32(28))+uint32(_consts[1004])))
	goto L228
L116:
	;
	if v471 != 0 {
...
L188:
	...
	v699 = *(*int32)(unsafe.Add(mBase, uint32(v694*int32(28))+uint32(_consts[1004])))
	goto L189
L189:
	;
	if v699 != int32(1) {
...
L192:
	...
	v792 = *(*int32)(unsafe.Add(mBase, uint32(v787*int32(28))+uint32(_consts[1004])))
	goto L200
L193:
	;
	v711 = v691
...
L16:
	;
	F_errfinish(m, int32(480803), int32(6191), int32(116818))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L12
...
L19:
	;
	F_errmsg(m, int32(386343), int32(0))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L12
...
L20:
	;
	F_errfinish(m, int32(480803), int32(6190), int32(116818))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L12
			...
			if v48 != 0 {
				...
				if v51 != 0 {
					...
					if v55 != 0 {
						...
						F_errfinish(m, int32(480803), int32(1186), int32(25002))
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(480803), int32(1182), int32(25002))
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
					} else {
