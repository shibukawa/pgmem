...
L97:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v377)+16)) = uint8(v384)
	v387 = int32(-1)
	F_CreateSchemaCommand(m, v377, int32(706992), v387, v387)
	mBase = m.M
	v390 = m.ExcPending
	if v390 != 0 {
		goto L1
...
L125:
	;
	F_errmsg(m, int32(478684), int32(0))
	mBase = m.M
	v493 = m.ExcPending
	if v493 != 0 {
		goto L1
...
L126:
	;
	F_errfinish(m, int32(519584), int32(1822), int32(327238))
	mBase = m.M
	v498 = m.ExcPending
	if v498 != 0 {
		goto L1
...
L129:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+16)) = v527
	F_errmsg(m, int32(742031), v24+int32(16))
	mBase = m.M
	v534 = m.ExcPending
	if v534 != 0 {
		goto L1
...
L130:
	;
	F_errfinish(m, int32(519584), int32(1860), int32(327238))
	mBase = m.M
	v539 = m.ExcPending
	if v539 != 0 {
		goto L1
...
L134:
	;
	F_errfinish(m, int32(519584), int32(1895), int32(327238))
	mBase = m.M
	v558 = m.ExcPending
	if v558 != 0 {
		goto L1
...
L138:
	;
	F_errfinish(m, int32(519584), int32(1933), int32(327238))
	mBase = m.M
	v574 = m.ExcPending
	if v574 != 0 {
		goto L1
...
L142:
	;
	F_errfinish(m, int32(519584), int32(1939), int32(327238))
	mBase = m.M
	v590 = m.ExcPending
	if v590 != 0 {
		goto L1
			...
			if v36 != 0 {
				...
				if l1 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v33
					v46 = F_pg_snprintf(m, v35, int32(1024), int32(314795), v9+int32(16))
					mBase = m.M
					v47 = m.ExcPending
					if v47 != 0 {
						return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v33
					v53 = F_pg_snprintf(m, v35, int32(1024), int32(314781), v9)
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
