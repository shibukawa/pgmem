...
func F__int_contained(m *base.Module, l0 int32) int32 {
	...
	v6 = F_DirectFunctionCall2Coll(m, int32(6360), int32(0), v4, v5)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
			...
			if l2 != 0 {
				...
				if v24 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v18)+24)) = l3
					...
					v42 = *(*int32)(unsafe.Add(mBase, _consts[13]))
					if v40 < v42 {
						v45 = *(*int32)(unsafe.Add(mBase, _consts[14]))
						v77 = v45
						v78 = v40
						*(*int32)(unsafe.Add(mBase, _consts[12])) = v78 + int32(1)
						*(*int32)(unsafe.Add(mBase, uint32(v77+v78<<(uint(int32(2))%32)))) = v18
						v88 = int32(0)
						*(*uint8)(unsafe.Add(mBase, _consts[15])) = uint8(v88)
						return
					} else {
						v46 = int32(4562096)
						v47 = *(*int32)(unsafe.Add(mBase, _consts[0]))
						v50 = *(*int32)(unsafe.Add(mBase, _consts[11]))
						*(*int32)(unsafe.Add(mBase, _consts[0])) = v50
						if v42 == int32(0) {
							*(*int32)(unsafe.Add(mBase, _consts[13])) = int32(8)
							...
							if v59 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, _consts[14])) = v70
							...
							*(*int32)(unsafe.Add(mBase, _consts[13])) = v42 << (uint(int32(1)) % 32)
...
L40:
	;
	F_errfinish(m, int32(520576), int32(696), int32(161987))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L10
