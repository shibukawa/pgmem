...
func F_ExecutorFinish(m *base.Module, l0 int32) {
	...
	var v87 int32
	_ = v87
	v9 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorFinish[0]))
	if v9 != 0 {
		goto L1
	} else {
		goto L2
...
L3:
	;
	v12 = int32(_a_F_ExecutorFinish_0)
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorFinish[1]))
	v15 = *(*int32)(unsafe.Add(mBase, uint32(l0)+40))
	v16 = *(*int32)(unsafe.Add(mBase, uint32(v15)+100))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorFinish[1])) = v16
...
L37:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorFinish[1])) = v13
	v87 = int32(1)
