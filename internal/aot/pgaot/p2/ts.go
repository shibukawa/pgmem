...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	F_errmsg_internal(m, int32(_a_F_TSConfigIsVisibleExt_0), v11)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L2
...
L11:
	;
	F_errfinish(m, int32(_a_F_TSConfigIsVisibleExt_1), int32(3241), int32(_a_F_TSConfigIsVisibleExt_2))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
L15:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_TSConfigIsVisibleExt[0]))
	v45 = int32(0)
	if v44 == v45 {
		goto L19
	} else {
...
L17:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _c_F_TSConfigIsVisibleExt[0]))
	if v87 == int32(0) {
		v138 = v3
		goto L14
	} else {
...
L36:
	...
	v110 = *(*int32)(unsafe.Add(mBase, _c_F_TSConfigIsVisibleExt[1]))
	if v108 != v110 {
		goto L38
	} else {
		goto L39
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	F_errmsg_internal(m, int32(_a_F_TSTemplateIsVisibleExt_0), v11)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L2
...
L11:
	;
	F_errfinish(m, int32(_a_F_TSTemplateIsVisibleExt_1), int32(3095), int32(_a_F_TSTemplateIsVisibleExt_2))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
L15:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_TSTemplateIsVisibleExt[0]))
	v45 = int32(0)
	if v44 == v45 {
		goto L19
	} else {
...
L17:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _c_F_TSTemplateIsVisibleExt[0]))
	if v87 == int32(0) {
		v138 = v3
		goto L14
	} else {
...
L36:
	...
	v104 = *(*int32)(unsafe.Add(mBase, uint32(v87)+12))
	v108 = *(*int32)(unsafe.Add(mBase, uint32(v104+v96<<(uint(int32(2))%32))))
	v110 = *(*int32)(unsafe.Add(mBase, _c_F_TSTemplateIsVisibleExt[1]))
	if v108 != v110 {
		goto L38
	} else {
		goto L39
...
L57:
	...
	v217 = v190 & int32(_a_F_TS_execute_locations_recurse_0)
	goto L53
L58:
	;
	v221 = v213
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_lookup_ts_dictionary_cache[1])) = v200
	v209 = v200
	goto L13
L19:
	;
...
L51:
	;
	v160 = int32(_a_F_lookup_ts_dictionary_cache_8)
	v161 = *(*int32)(unsafe.Add(mBase, _c_F_lookup_ts_dictionary_cache[3]))
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_lookup_ts_dictionary_cache[3])) = v161
	goto L53
L60:
	;
...
func F_ts_rankcd_tt(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank_cd(m, int32(_a_F_ts_rankcd_tt_0), v8, v14, int32(0))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
...
func F_ts_rankcd_ttf(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank_cd(m, int32(_a_F_ts_rankcd_ttf_0), v8, v14, v15)
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
