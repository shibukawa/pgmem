				...
				if v38 != 0 {
					...
					if v40 != 0 {
						...
						*(*int64)(unsafe.Add(mBase, uint32(v12)+uint32(_consts[33]))) = v47
						...
						v71 = F_AllocSetContextCreateInternal(m, v66, int32(58831), v43, int32(8192), int32(8388608))
						mBase = m.M
						v72 = m.ExcPending
						if v72 != 0 {
							return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12)+uint32(_consts[34]))) = v71
							...
							v80 = F_AllocSetContextCreateInternal(m, v75, int32(248449), int32(0), int32(8192), int32(8388608))
							mBase = m.M
							v81 = m.ExcPending
							if v81 != 0 {
								return
								...
								if v87 != 0 {
									...
									if v91 != 0 {
										...
										if v93 != 0 {
											...
											v97 = F___memcpy(m, int32(4362920), int32(4362760), int32(128))
											mBase = m.M
											...
											if v120 != 0 {
												...
												if v124 != 0 {
													...
													if v128 != 0 {
														...
														mBase = m.M
														F_BufferUsageAccumDiff(m, v141, int32(4362920))
														mBase = m.M
														v145 = v136 + int32(24)
														v146 = int64(0)
...
L135:
	;
	F_s_lock(m, l1+int32(28), int32(481902), int32(2086), int32(421180))
	mBase = m.M
	v535 = m.ExcPending
	if v535 != 0 {
		goto L1
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v40 + int32(4)
	F_errmsg_internal(m, int32(664490), v9)
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L8
			...
			if v35 != 0 {
				...
				if (v56^v26)&int32(3) != 0 {
					...
					if v63 != 0 {
						...
						F_errmsg_internal(m, int32(359671), int32(0))
						mBase = m.M
						v67 = m.ExcPending
						if v67 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(488189), int32(192), int32(102146))
							mBase = m.M
							v72 = m.ExcPending
							if v72 != 0 {
								return int32(0)
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v15
	F_errmsg_internal(m, int32(471605), v10)
	mBase = m.M
	v82 = m.ExcPending
	if v82 != 0 {
		goto L24
...
L27:
	;
	F_errfinish(m, int32(485439), int32(1007), int32(491392))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L24
			...
			if v50 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = v12
				...
				if v54 != 0 {
					...
					F_errfinish(m, int32(485439), int32(1212), int32(314203))
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return int32(0)
