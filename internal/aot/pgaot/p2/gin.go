				...
				if v38 != 0 {
					...
					if v40 != 0 {
						...
						*(*int64)(unsafe.Add(mBase, uint32(v12)+uint32(_consts[37]))) = v47
						...
						v71 = F_AllocSetContextCreateInternal(m, v66, int32(65769), v43, int32(8192), int32(8388608))
						mBase = m.M
						v72 = m.ExcPending
						if v72 != 0 {
							return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12)+uint32(_consts[38]))) = v71
							...
							v80 = F_AllocSetContextCreateInternal(m, v75, int32(267442), int32(0), int32(8192), int32(8388608))
							mBase = m.M
							v81 = m.ExcPending
							if v81 != 0 {
								return
...
L135:
	;
	F_s_lock(m, l1+int32(28), int32(517950), int32(2086), int32(452693))
	mBase = m.M
	v535 = m.ExcPending
	if v535 != 0 {
		goto L1
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v40 + int32(4)
	F_errmsg_internal(m, int32(728118), v9)
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L8
			...
			if v35 != 0 {
				...
				if (v56^v26)&int32(3) != 0 {
					...
					if v63 != 0 {
						...
						F_errmsg_internal(m, int32(387331), int32(0))
						mBase = m.M
						v67 = m.ExcPending
						if v67 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(525750), int32(192), int32(111736))
							mBase = m.M
							v72 = m.ExcPending
							if v72 != 0 {
								return int32(0)
...
L27:
	;
	F_errfinish(m, int32(522455), int32(1007), int32(529742))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L24
			...
			if v50 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = v12
				...
				if v54 != 0 {
					...
					F_errfinish(m, int32(522455), int32(1212), int32(338261))
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return int32(0)
						...
						if (v24<<(uint(v25)%32)-v27)&int32(65535) != v25 {
							...
							if v123 != 0 {
								...
								if v126 != 0 {
									...
									F_errmsg(m, int32(427468), int32(0))
									mBase = m.M
									v132 = m.ExcPending
									if v132 != 0 {
										return int32(0)
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = (v134<<(uint(v135)%32) - v133) & int32(65535)
										...
										if v148 != 0 {
											...
											F_errfinish(m, int32(520313), int32(55), int32(254999))
											mBase = m.M
											v155 = m.ExcPending
											if v155 != 0 {
												return int32(0)
							...
							if v34 != int32(8) {
								...
								if v159 != 0 {
									...
									if v162 != 0 {
										...
										F_errmsg(m, int32(427507), int32(0))
										mBase = m.M
										v168 = m.ExcPending
										if v168 != 0 {
											return int32(0)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v7))) = v169
											F_errdetail(m, int32(537694), v7)
											mBase = m.M
											v176 = m.ExcPending
											if v176 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(520313), int32(64), int32(254999))
												mBase = m.M
												v183 = m.ExcPending
												if v183 != 0 {
													return int32(0)
									...
									if v40 != int32(1) {
										...
										if v187 != 0 {
											...
											if v193 != 0 {
												...
												F_errfinish(m, int32(520313), int32(68), int32(254999))
												mBase = m.M
												v200 = m.ExcPending
												if v200 != 0 {
													return int32(0)
				...
				if v103 != 0 {
					...
					if v106 != 0 {
						...
						if v112 != 0 {
							...
							F_errfinish(m, int32(520313), int32(42), int32(254999))
							mBase = m.M
							v119 = m.ExcPending
							if v119 != 0 {
								return int32(0)
