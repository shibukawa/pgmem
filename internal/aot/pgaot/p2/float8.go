...
func F_float8_numeric(m *base.Module, l0 int32) int32 {
	...
	if base.Ui64(int64(9218868437227405313)) <= base.Ui64(base.I64_reinterpret_f64(v10)&int64(9223372036854775807)) {
		v18 = F_make_result_opt_error(m, int32(1696748), int32(0))
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return int32(0)
		...
		if base.F64_eq(base.F64_abs(v10), math.Float64frombits(uint64(0x7ff0000000000000))) != 0 {
			if base.F64_lt(v10, float64(0)) != 0 {
				v29 = F_make_result_opt_error(m, int32(1696796), int32(0))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
				...
				v33 = F_make_result_opt_error(m, int32(1696772), int32(0))
				mBase = m.M
				v34 = m.ExcPending
				if v34 != 0 {
					return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(15)
			v42 = F_pg_snprintf(m, v7+int32(32), int32(115), int32(321290), v7)
			mBase = m.M
			v43 = m.ExcPending
			if v43 != 0 {
				return int32(0)
	...
	if v14 != 0 {
		...
		if v15 != int32(1) {
			...
			if v57 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(79770)
	...
	if v15 != 0 {
		...
		if v16 != int32(1) {
			...
			if v63 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(528141)
				F_errmsg_internal(m, int32(24299), v9)
				mBase = m.M
				v70 = m.ExcPending
				if v70 != 0 {
					return int32(0)
	...
	if v13 != 0 {
		...
		if v14 != int32(1) {
			...
			if v44 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(225174)
