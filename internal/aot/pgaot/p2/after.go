...
L16:
	;
	v155 = *(*int32)(unsafe.Add(mBase, _consts[419]))
...
L18:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[420]))
	if v67 == int32(0) {
		goto L19
	} else {
		goto L20
...
L48:
	;
	F_errmsg(m, int32(261025), int32(0))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L34
...
L49:
	;
	F_errfinish(m, int32(495910), int32(4671), int32(120517))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L34
