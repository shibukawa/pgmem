...
L16:
	;
	v155 = *(*int32)(unsafe.Add(mBase, _consts[418]))
...
L18:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[419]))
	if v67 == int32(0) {
		goto L19
	} else {
		goto L20
...
L44:
	;
	v253 = int32(*(*uint8)(unsafe.Add(mBase, _consts[281])))
	goto L45
L45:
	;
...
L48:
	;
	F_errmsg(m, int32(260687), int32(0))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L34
...
L49:
	;
	F_errfinish(m, int32(495331), int32(4671), int32(120394))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L34
