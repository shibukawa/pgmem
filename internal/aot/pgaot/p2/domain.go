...
func F_domainAddCheckConstraint(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32) int32 {
	...
	if v14 != 0 {
						...
						if v57 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v47)+104)) = int32(582)
							...
							if v67 != 0 {
								...
								v69 = F_coerce_to_boolean(m, v47, v66, int32(535300))
								mBase = m.M
								v70 = m.ExcPending
								if v70 != 0 {
									return int32(0)
										...
										if v73 != 0 {
											...
											if v125 != 0 {
												...
												if v128 != 0 {
													...
													F_errmsg(m, int32(90327), int32(0))
													mBase = m.M
													v132 = m.ExcPending
													if v132 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(495637), int32(3578), int32(91017))
														mBase = m.M
														v137 = m.ExcPending
														if v137 != 0 {
															return int32(0)
				...
				if v25 != 0 {
					...
					if v28 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12))) = v29
						F_errmsg(m, int32(117140), v12)
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(495637), int32(3528), int32(91017))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int32(0)
		...
		v40 = int32(0)
		v43 = F_ChooseConstraintName(m, l5, v40, int32(319045), l1, v40)
		mBase = m.M
		v44 = m.ExcPending
		if v44 != 0 {
			return int32(0)
											...
											if v64 != 0 {
												...
												if v66 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v11))) = l1
													F_errmsg(m, int32(70219), v11)
													mBase = m.M
													v71 = m.ExcPending
													if v71 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(494200), int32(1428), int32(434861))
														mBase = m.M
														v76 = m.ExcPending
														if v76 != 0 {
															return int32(0)
