							...
							if v69 == int32(1) {
								...
								if v201 != 0 {
									...
									if v204 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(683441)
										F_errmsg(m, int32(246601), v13+int32(16))
										mBase = m.M
										v211 = m.ExcPending
										if v211 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(495461), int32(1257), int32(206307))
											mBase = m.M
											v216 = m.ExcPending
											if v216 != 0 {
												return int32(0)
							...
							if v123 != 0 {
								...
								if v126 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(82834)
									F_errmsg(m, int32(487836), v13)
									mBase = m.M
									v132 = m.ExcPending
									if v132 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(495461), int32(1219), int32(206307))
										mBase = m.M
										v137 = m.ExcPending
										if v137 != 0 {
											return int32(0)
								...
								if v44 <= int32(0) {
									...
									if v141 != 0 {
										...
										if v144 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = int32(285552)
											F_errmsg(m, int32(487836), v13+int32(32))
											mBase = m.M
											v152 = m.ExcPending
											if v152 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(495461), int32(1228), int32(206307))
												mBase = m.M
												v157 = m.ExcPending
												if v157 != 0 {
													return int32(0)
										...
										if base.Ui32(int32(2)) <= base.Ui32(v51) {
											...
											if v161 != 0 {
												...
												if v164 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = int32(246467)
													F_errmsg(m, int32(487836), v13+int32(48))
													mBase = m.M
													v172 = m.ExcPending
													if v172 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(495461), int32(1237), int32(206307))
														mBase = m.M
														v177 = m.ExcPending
														if v177 != 0 {
															return int32(0)
												...
												if v58 < int32(0) {
													...
													if v181 != 0 {
														...
														if v184 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v13)+64)) = int32(206820)
															F_errmsg(m, int32(487836), v13-int32(-64))
															mBase = m.M
															v192 = m.ExcPending
															if v192 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(495461), int32(1246), int32(206307))
																mBase = m.M
																v197 = m.ExcPending
																if v197 != 0 {
																	return int32(0)
