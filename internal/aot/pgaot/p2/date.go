								...
								if v142 == int32(0) {
									...
									if v148 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v14
										F_errmsg(m, int32(708828), v11+int32(16))
										mBase = m.M
										v154 = m.ExcPending
										if v154 != 0 {
											return int32(0)
										} else {
											F_errsave_finish(m, v13, int32(495500), int32(168), int32(278047))
											mBase = m.M
											v159 = m.ExcPending
											if v159 != 0 {
												return int32(0)
										...
										if v195 == int32(0) {
											...
											if v201 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v11))) = v14
												F_errmsg(m, int32(708828), v11)
												mBase = m.M
												v205 = m.ExcPending
												if v205 != 0 {
													return int32(0)
												} else {
													F_errsave_finish(m, v13, int32(495500), int32(176), int32(278047))
													mBase = m.M
													v210 = m.ExcPending
													if v210 != 0 {
														return int32(0)
						...
						if v81 == int32(0) {
							...
							if v88 != 0 {
								...
								if v92 != 0 {
									...
									F_errfinish(m, int32(492756), int32(2176), int32(373706))
									mBase = m.M
									v97 = m.ExcPending
									if v97 != 0 {
										return int32(0)
