	...
	if v24 == int32(0) {
		...
		if v45 != 0 {
			...
			if v42 == int32(0) {
								...
								if v142 == int32(0) {
									...
									if v148 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v14
										F_errmsg(m, int32(755347), v11+int32(16))
										mBase = m.M
										v154 = m.ExcPending
										if v154 != 0 {
											return int32(0)
										} else {
											F_errsave_finish(m, v13, int32(518740), int32(168), int32(290593))
											mBase = m.M
											v159 = m.ExcPending
											if v159 != 0 {
												return int32(0)
										...
										if v195 == int32(0) {
											...
											if v201 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v11))) = v14
												F_errmsg(m, int32(755347), v11)
												mBase = m.M
												v205 = m.ExcPending
												if v205 != 0 {
													return int32(0)
												} else {
													F_errsave_finish(m, v13, int32(518740), int32(176), int32(290593))
													mBase = m.M
													v210 = m.ExcPending
													if v210 != 0 {
														return int32(0)
				...
				default:
					F_DateTimeParseError(m, int32(-1), v11+int32(24), v14, int32(372021), v13)
					mBase = m.M
					v67 = m.ExcPending
					if v67 != 0 {
						return int32(0)
					...
					if v82 != 0 {
						...
						if v81 == int32(0) {
							...
							if v88 != 0 {
								...
								F_errmsg_internal(m, int32(305436), int32(0))
								mBase = m.M
								v92 = m.ExcPending
								if v92 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(515506), int32(2176), int32(391174))
									mBase = m.M
									v97 = m.ExcPending
									if v97 != 0 {
										return int32(0)
				...
				v48 = v42
				F_DateTimeParseError(m, v48, v11+int32(24), v14, int32(372021), v13)
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return int32(0)
