...
func F_tuplesort_begin_common(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v11 == int32(0) {
		...
		v20 = F_AllocSetContextCreateInternal(m, v15, int32(278391), int32(0), int32(8192), int32(8388608))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
			...
			if v29 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[0])) = v20
				...
				if v36 != 0 {
					...
					v38 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1098])))
					if v38 == int32(1) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v35)+236)) = v74
							if v73 == int32(1) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v74))) = int32(1)
								if v78 != 0 {
									F_s_lock(m, v74, int32(492969), int32(2988), int32(222145))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
		...
		if v108 != 0 {
			...
			if v112 != 0 {
				...
				F_errfinish(m, int32(492969), int32(651), int32(245768))
				mBase = m.M
				v117 = m.ExcPending
				if v117 != 0 {
					return int32(0)
	...
	if v19 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[0])) = v23
		...
		if v27 != 0 {
			...
			v29 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1098])))
			if v29 != int32(1) {
				...
				if v35 != 0 {
					...
					if v34 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v13)+4)) = v43
						F_errmsg_internal(m, int32(501949), v13)
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(493745), int32(686), int32(286455))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
...
L24:
	;
	F_errfinish(m, int32(493745), int32(647), int32(277105))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
...
func F_tuplesort_method_name(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(8)) {
		v10 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1247])))
		v11 = v10
	} else {
		v11 = int32(243738)
	}
...
L77:
	;
	F_errfinish(m, int32(492969), int32(1312), int32(245941))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L7
...
L87:
	;
	F_errfinish(m, int32(492969), int32(1156), int32(164142))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L7
...
L93:
	;
	v353 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1098])))
	if v353 != int32(1) {
		v379 = v339
		goto L97
	} else {
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v360
	F_errmsg_internal(m, int32(200531), v19)
	mBase = m.M
	v371 = m.ExcPending
	if v371 != 0 {
		goto L7
...
L102:
	;
	F_errfinish(m, int32(492969), int32(1248), int32(245941))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L7
