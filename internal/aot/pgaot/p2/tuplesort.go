...
func F_tuplesort_begin_common(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v11 == int32(0) {
		...
		v20 = F_AllocSetContextCreateInternal(m, v15, int32(273860), int32(0), int32(8192), int32(8388608))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		} else {
			v28 = F_AllocSetContextCreateInternal(m, v20, int32(77445), int32(0), int32(8192), int32(8388608))
			mBase = m.M
			v29 = m.ExcPending
			if v29 != 0 {
				return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v35)+236)) = v74
							if v73 == int32(1) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v74))) = int32(1)
								if v78 != 0 {
									F_s_lock(m, v74, int32(484414), int32(2988), int32(218859))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
		...
		if v108 != 0 {
			...
			F_errmsg_internal(m, int32(77533), int32(0))
			mBase = m.M
			v112 = m.ExcPending
			if v112 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(484414), int32(651), int32(241763))
				mBase = m.M
				v117 = m.ExcPending
				if v117 != 0 {
					return int32(0)
				...
				if v35 != 0 {
					...
					if v34 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v13)+4)) = v43
						F_errmsg_internal(m, int32(493162), v13)
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(485168), int32(686), int32(281657))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
...
L24:
	;
	F_errfinish(m, int32(485168), int32(647), int32(272614))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
...
L77:
	;
	F_errfinish(m, int32(484414), int32(1312), int32(241936))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L7
...
L86:
	;
	F_errmsg_internal(m, int32(77302), int32(0))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L7
...
L87:
	;
	F_errfinish(m, int32(484414), int32(1156), int32(161433))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L7
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v360
	F_errmsg_internal(m, int32(197447), v19)
	mBase = m.M
	v371 = m.ExcPending
	if v371 != 0 {
		goto L7
...
L102:
	;
	F_errfinish(m, int32(484414), int32(1248), int32(241936))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L7
