	...
	if v11 == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v35)+236)) = v74
							if v73 == int32(1) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v74))) = int32(1)
								if v78 != 0 {
									F_s_lock(m, v74, int32(489752), int32(2988), int32(221091))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
		...
		if v108 != 0 {
			...
			if v112 != 0 {
				...
				F_errfinish(m, int32(489752), int32(651), int32(244371))
				mBase = m.M
				v117 = m.ExcPending
				if v117 != 0 {
					return int32(0)
				...
				if v35 != 0 {
					...
					if v34 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v13)+4)) = v43
						F_errmsg_internal(m, int32(498589), v13)
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(490506), int32(686), int32(284608))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
...
L24:
	;
	F_errfinish(m, int32(490506), int32(647), int32(275434))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
...
L77:
	;
	F_errfinish(m, int32(489752), int32(1312), int32(244544))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L7
...
L87:
	;
	F_errfinish(m, int32(489752), int32(1156), int32(163270))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L7
...
L102:
	;
	F_errfinish(m, int32(489752), int32(1248), int32(244544))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L7
