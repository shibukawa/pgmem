...
L7:
	;
	v28 = int32(*(*uint16)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_c_F_fmgr_info_cxt_security[1]))))
	if v28 == int32(_a_F_fmgr_info_cxt_security_0) {
		goto L6
	} else {
		goto L8
	}
L8:
	...
	if v32+int32(_a_F_fmgr_info_cxt_security_1) == int32(0) {
		goto L6
	} else {
		goto L9
	}
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1)+4)) = l0
	v40 = *(*int32)(unsafe.Add(mBase, uint32(v32)+uint32(_c_F_fmgr_info_cxt_security[2])))
	*(*int32)(unsafe.Add(mBase, uint32(l1)+8)) = v40
	v42 = *(*int32)(unsafe.Add(mBase, uint32(v32)+uint32(_c_F_fmgr_info_cxt_security[3])))
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1))) = int32(1630)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+4)) = l0
	goto L13
L17:
	;
...
L19:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_info_cxt_security[4]))
	if v67 == int32(0) {
		goto L14
	} else {
		goto L20
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l1))) = int32(1631)
	v296 = int32(1)
	goto L23
L26:
	;
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+60)) = v151
	v154 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_info_cxt_security[5]))
	if v154 == int32(0) {
		goto L48
	} else {
		goto L49
...
L29:
	;
	v92 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_info_cxt_security[6]))
	if v92 <= int32(0) {
		goto L1
	} else {
		goto L30
...
L31:
	;
	v108 = *(*int32)(unsafe.Add(mBase, uint32(v97<<(uint(int32(4))%32))+uint32(_c_F_fmgr_info_cxt_security[7])))
...
L32:
	...
	if v138+int32(_a_F_fmgr_info_cxt_security_1) == int32(0) {
		goto L1
	} else {
		goto L45
	}
...
L46:
	;
	v145 = *(*int32)(unsafe.Add(mBase, uint32(v138)+uint32(_c_F_fmgr_info_cxt_security[3])))
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+108)) = v218
	v221 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_info_cxt_security[5]))
	if v221 == int32(0) {
		goto L66
	} else {
		goto L67
...
L66:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+76)) = int64(103079215108)
	v232 = F_hash_create(m, int32(_a_F_fmgr_info_cxt_security_2), int32(100), v12+int32(60), int32(40))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L10
...
L69:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_info_cxt_security[5])) = v232
	v235 = v232
	goto L68
L70:
	;
...
L75:
	...
	v286 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_info_cxt_security[8]))
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = l0
	F_errmsg_internal(m, int32(_a_F_fmgr_info_cxt_security_3), v12)
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L10
...
L80:
	;
	F_errfinish(m, int32(_a_F_fmgr_info_cxt_security_4), int32(183), int32(_a_F_fmgr_info_cxt_security_5))
	mBase = m.M
	v340 = m.ExcPending
	if v340 != 0 {
		goto L10
...
L83:
	;
	F_errfinish(m, int32(_a_F_fmgr_info_cxt_security_4), int32(408), int32(_a_F_fmgr_info_cxt_security_7))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L10
...
L86:
	;
	F_errfinish(m, int32(_a_F_fmgr_info_cxt_security_4), int32(428), int32(_a_F_fmgr_info_cxt_security_9))
	mBase = m.M
	v371 = m.ExcPending
	if v371 != 0 {
		goto L10
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v89
	F_errmsg(m, int32(_a_F_fmgr_info_cxt_security_10), v12+int32(32))
	mBase = m.M
	v393 = m.ExcPending
	if v393 != 0 {
		goto L10
...
L90:
	;
	F_errfinish(m, int32(_a_F_fmgr_info_cxt_security_4), int32(237), int32(_a_F_fmgr_info_cxt_security_5))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L10
...
L16:
	;
	if base.Ui32(v37-int32(_a_F_fmgr_sql_validator_0)) < base.Ui32(int32(4)) {
		goto L11
	} else {
		goto L20
	}
...
L20:
	;
	if base.Ui32(v37-int32(_a_F_fmgr_sql_validator_1)) < base.Ui32(int32(2)) {
		goto L11
	} else {
		goto L21
	}
...
L25:
	;
	v122 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_fmgr_sql_validator[0])))
	if v122 == int32(1) {
		goto L41
	} else {
		goto L42
...
L33:
	;
	if base.Ui32(v84-int32(_a_F_fmgr_sql_validator_0)) < base.Ui32(int32(4)) {
		v104 = v83
		goto L28
	} else {
		goto L37
...
L37:
	;
	if base.Ui32(v84-int32(_a_F_fmgr_sql_validator_1)) < base.Ui32(int32(2)) {
		v104 = v83
		goto L28
	} else {
		goto L38
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+60)) = int32(473)
	v137 = int32(_a_F_fmgr_sql_validator_2)
	v138 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql_validator[1]))
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql_validator[1])) = v407
	goto L43
L48:
	;
	v275 = int32(0)
