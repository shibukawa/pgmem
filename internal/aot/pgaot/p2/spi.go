...
L72:
	;
	F_errfinish(m, int32(494584), int32(1745), int32(309612))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L27
...
L83:
	;
	F_errmsg_internal(m, int32(444869), int32(0))
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
		goto L27
...
L84:
	;
	F_errfinish(m, int32(494584), int32(1620), int32(309612))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L27
...
L87:
	;
	F_errmsg(m, int32(440162), int32(0))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L27
...
L89:
	;
	F_errfinish(m, int32(494584), int32(1719), int32(309612))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L27
...
L98:
	;
	F_errfinish(m, int32(494584), int32(1612), int32(309612))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L27
...
L102:
	;
	F_errfinish(m, int32(494584), int32(1602), int32(309612))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L27
...
func F_SPI_palloc(m *base.Module, l0 int32) int32 {
	...
	if v4 == int32(0) {
		...
		if v12 != 0 {
			...
			F_errmsg_internal(m, int32(531025), int32(0))
			mBase = m.M
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(494584), int32(1341), int32(485804))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
...
func F_SPI_result_code_string(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(int32(33)) <= base.Ui32(v9) {
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		v26 = int32(4385664)
		v29 = F_pg_sprintf(m, v26, int32(474788), v6)
		mBase = m.M
		v32 = m.ExcPending
		if v32 != 0 {
			return int32(0)
	...
	if l1 != 0 {
		*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(30790)
		...
		if v15 != 0 {
			...
			F_appendStringInfoString(m, l0, int32(710547))
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return
				...
				if v19 != 0 {
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l2
					F_appendStringInfo(m, l0, int32(673597), v7+int32(16))
					mBase = m.M
					v25 = m.ExcPending
					if v25 != 0 {
						return
					} else {
						F_appendStringInfoString(m, l0, int32(735409))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return
							...
							if int32(0) < v32 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(30790)
								F_appendStringInfo(m, l0, int32(733965), v7)
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return
		...
		F_appendStringInfoString(m, l0, int32(733938))
		mBase = m.M
		v45 = m.ExcPending
		if v45 != 0 {
			return
			...
			if int32(0) < v49 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[459])) = v61
				...
				F_appendStringInfoString(m, l0, int32(738320))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return
	...
	if l0 != 0 {
		...
		if v9 == int32(0) {
			...
			if v74 != 0 {
				...
				F_errmsg_internal(m, int32(444821), int32(0))
				mBase = m.M
				v78 = m.ExcPending
				if v78 != 0 {
					return
				} else {
					F_errfinish(m, int32(494584), int32(3018), int32(257987))
					mBase = m.M
					v83 = m.ExcPending
					if v83 != 0 {
						return
					...
					if v36 == int32(0) {
						...
						if v87 != 0 {
							...
							if v91 != 0 {
								...
								F_errfinish(m, int32(494584), int32(3043), int32(257987))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return
		...
		if v61 != 0 {
			...
			if v65 != 0 {
				...
				F_errfinish(m, int32(494584), int32(3014), int32(257987))
				mBase = m.M
				v70 = m.ExcPending
				if v70 != 0 {
					return
