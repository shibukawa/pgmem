...
L3:
	...
	v35 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[463])) = v35
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _consts[463])) = int32(-6)
...
L15:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _consts[460]))
	if v41 != 0 {
		goto L17
	} else {
		goto L18
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+36)) = v13 + int32(40)
	v94 = *(*int32)(unsafe.Add(mBase, _consts[460]))
...
L49:
	;
	v182 = *(*int32)(unsafe.Add(mBase, _consts[460]))
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v219
	F_errmsg(m, int32(264204), v13+int32(16))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L27
...
L72:
	;
	F_errfinish(m, int32(517790), int32(1745), int32(323662))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L27
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, _consts[88])) = v276
	v280 = *(*int32)(unsafe.Add(mBase, _consts[460]))
...
L83:
	;
	F_errmsg_internal(m, int32(464657), int32(0))
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
		goto L27
...
L84:
	;
	F_errfinish(m, int32(517790), int32(1620), int32(323662))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L27
...
L87:
	;
	F_errmsg(m, int32(459841), int32(0))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L27
...
L89:
	;
	F_errfinish(m, int32(517790), int32(1719), int32(323662))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L27
...
L92:
	;
	v341 = *(*int32)(unsafe.Add(mBase, uint32(v334<<(uint(int32(3))%32))+uint32(_consts[466])))
	goto L95
L93:
	;
	v342 = int32(547804)
...
L98:
	;
	F_errfinish(m, int32(517790), int32(1612), int32(323662))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L27
...
L101:
	;
	F_errmsg(m, int32(219306), int32(0))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L27
...
L102:
	;
	F_errfinish(m, int32(517790), int32(1602), int32(323662))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L27
...
func F_SPI_finish(m *base.Module) int32 {
	...
	var v51 int32
	_ = v51
	v3 = *(*int32)(unsafe.Add(mBase, _consts[460]))
	if v3 == int32(0) {
		return int32(-4)
	} else {
		...
		if v15 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v17)+24)) = int32(0)
			...
			if v22 != 0 {
				...
				v23 = int32(4447376)
				v24 = *(*int32)(unsafe.Add(mBase, _consts[460]))
				v25 = int32(0)
				*(*int32)(unsafe.Add(mBase, uint32(v24)+20)) = v25
				v28 = *(*int64)(unsafe.Add(mBase, uint32(v24)+48))
				*(*int64)(unsafe.Add(mBase, _consts[461])) = v28
				v31 = *(*int32)(unsafe.Add(mBase, uint32(v24)+56))
				*(*int32)(unsafe.Add(mBase, _consts[462])) = v31
				v34 = *(*int32)(unsafe.Add(mBase, uint32(v24)+60))
				*(*int32)(unsafe.Add(mBase, _consts[463])) = v34
				v36 = int32(4154324)
				v38 = *(*int32)(unsafe.Add(mBase, _consts[464]))
				v40 = v38 - int32(1)
				*(*int32)(unsafe.Add(mBase, _consts[464])) = v40
				v44 = *(*int32)(unsafe.Add(mBase, _consts[465]))
				if v25 <= v40 {
					v51 = v44 + v40<<(uint(int32(6))%32)
				} else {
					v51 = v25
				}
				*(*int32)(unsafe.Add(mBase, _consts[460])) = v51
				return int32(2)
			}
		}
	}
...
func F_SPI_palloc(m *base.Module, l0 int32) int32 {
	...
	if v4 == int32(0) {
		...
		if v12 != 0 {
			...
			F_errmsg_internal(m, int32(555240), int32(0))
			mBase = m.M
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(517790), int32(1341), int32(507184))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
...
func F_SPI_result_code_string(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(int32(33)) <= base.Ui32(v9) {
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		v26 = int32(4447392)
		v29 = F_pg_sprintf(m, v26, int32(495817), v6)
		mBase = m.M
		v32 = m.ExcPending
		if v32 != 0 {
			return int32(0)
		...
		if base.I32_wrap_i64(int64(base.Ui64(int64(8589926143))>>(uint(base.I64_extend_i32_u(v9))%64)))&int32(1) == int32(0) {
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
			...
			v24 = *(*int32)(unsafe.Add(mBase, uint32(v9<<(uint(int32(2))%32))+uint32(_consts[467])))
			v33 = v24
			m.G0 = v6 + int32(16)
			return v33
		}
...
func F_SPI_sql_row_to_xmlelement(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	m.G0 = v7
	if l1 != 0 {
		*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(31976)
		F_appendStringInfo(m, l0, int32(185786), v7+int32(32))
		mBase = m.M
		v15 = m.ExcPending
		if v15 != 0 {
			return
		} else {
			F_appendStringInfoString(m, l0, int32(757156))
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return
				...
				if v19 != 0 {
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l2
					F_appendStringInfo(m, l0, int32(717403), v7+int32(16))
					mBase = m.M
					v25 = m.ExcPending
					if v25 != 0 {
						return
					} else {
						F_appendStringInfoString(m, l0, int32(782018))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return
						} else {
							v30 = *(*int32)(unsafe.Add(mBase, _consts[462]))
							v31 = *(*int32)(unsafe.Add(mBase, uint32(v30)))
							v32 = *(*int32)(unsafe.Add(mBase, uint32(v31)))
							if int32(0) < v32 {
								v59 = v31
								v61 = int32(0)
								*(*int32)(unsafe.Add(mBase, _consts[463])) = v61
								v63 = *(*int32)(unsafe.Add(mBase, uint32(v59)))
								if v63 <= v61 {
									*(*int32)(unsafe.Add(mBase, _consts[463])) = int32(-9)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(31976)
								F_appendStringInfo(m, l0, int32(780574), v7)
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return
		...
		F_appendStringInfoString(m, l0, int32(780547))
		mBase = m.M
		v45 = m.ExcPending
		if v45 != 0 {
			return
		} else {
			v47 = *(*int32)(unsafe.Add(mBase, _consts[462]))
			...
			if int32(0) < v49 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[463])) = v61
				...
				F_appendStringInfoString(m, l0, int32(784929))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return
...
func F__SPI_cursor_operation(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	_ = v96
	if l0 != 0 {
		v9 = *(*int32)(unsafe.Add(mBase, _consts[460]))
		if v9 == int32(0) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v74 = m.ExcPending
			if v74 != 0 {
				...
				F_errmsg_internal(m, int32(464609), int32(0))
				mBase = m.M
				v78 = m.ExcPending
				if v78 != 0 {
					return
				} else {
					F_errfinish(m, int32(517790), int32(3018), int32(269935))
					mBase = m.M
					v83 = m.ExcPending
					if v83 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v16)+12)) = v14
			...
			v20 = int64(0)
			*(*int64)(unsafe.Add(mBase, _consts[461])) = v20
			*(*int32)(unsafe.Add(mBase, _consts[0])) = v18
			v25 = int32(0)
			*(*int32)(unsafe.Add(mBase, _consts[462])) = v25
					...
					if v36 == int32(0) {
						...
						if v87 != 0 {
							...
							if v91 != 0 {
								...
								F_errfinish(m, int32(517790), int32(3043), int32(269935))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return
						...
						if v31 != v42 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[462])) = v36
							*(*int64)(unsafe.Add(mBase, _consts[461])) = v31
							v48 = int32(0)
		...
		if v61 != 0 {
			...
			if v65 != 0 {
				...
				F_errfinish(m, int32(517790), int32(3014), int32(269935))
				mBase = m.M
				v70 = m.ExcPending
				if v70 != 0 {
					return
