...
L26:
	;
	v40 = *(*int32)(unsafe.Add(mBase, uint32(v31<<(uint(int32(2))%32))+uint32(_c_F_EndTransactionBlock[1])))
	v41 = v40
	goto L28
L27:
	;
	v41 = int32(_a_F_EndTransactionBlock_1)
	goto L28
L28:
	;
	goto L25
...
L36:
	;
	v87 = *(*int32)(unsafe.Add(mBase, uint32(v78<<(uint(int32(2))%32))+uint32(_c_F_EndTransactionBlock[1])))
	v88 = v87
	goto L38
L37:
	;
	v88 = int32(_a_F_EndTransactionBlock_1)
	goto L38
L38:
	;
	goto L35
...
L53:
	;
	v148 = *(*int32)(unsafe.Add(mBase, uint32(v139<<(uint(int32(2))%32))+uint32(_c_F_EndTransactionBlock[1])))
	v149 = v148
	goto L55
L54:
	;
	v149 = int32(_a_F_EndTransactionBlock_1)
	goto L55
L55:
	;
	goto L52
...
L85:
	;
	v263 = *(*int32)(unsafe.Add(mBase, uint32(v254<<(uint(int32(2))%32))+uint32(_c_F_EndTransactionBlock[1])))
	v264 = v263
	goto L87
L86:
	;
	v264 = int32(_a_F_EndTransactionBlock_1)
	goto L87
L87:
	;
	goto L84
...
L92:
	;
	v300 = *(*int32)(unsafe.Add(mBase, uint32(v291<<(uint(int32(2))%32))+uint32(_c_F_EndTransactionBlock[1])))
	v301 = v300
	goto L94
L93:
	;
	v301 = int32(_a_F_EndTransactionBlock_1)
	goto L94
L94:
	;
	goto L91
...
func F_SetTransactionIdLimit(m *base.Module, l0 int32, l1 int32) {
	...
	v9 = v7 - int32(48)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _c_F_SetTransactionIdLimit[0]))
	v14 = *(*int32)(unsafe.Add(mBase, _c_F_SetTransactionIdLimit[1]))
	...
	if v19 != 0 {
		...
		v21 = *(*int32)(unsafe.Add(mBase, _c_F_SetTransactionIdLimit[2]))
		...
		*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = l0
		v42 = v29 - int32(_a_F_SetTransactionIdLimit_0)
		if base.Ui32(v42) < base.Ui32(int32(3)) {
			v45 = v29 - int32(_a_F_SetTransactionIdLimit_1)
		} else {
			v45 = v42
		}
		...
		*(*int32)(unsafe.Add(mBase, uint32(v21)+24)) = v53
		...
		v57 = *(*int32)(unsafe.Add(mBase, _c_F_SetTransactionIdLimit[1]))
			...
			if v65 != 0 {
				...
				if v64 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v29
					F_errmsg_internal(m, int32(_a_F_SetTransactionIdLimit_2), v9+int32(32))
					mBase = m.M
					v72 = m.ExcPending
					if v72 != 0 {
						return
							...
							if v89 == int32(0) {
								...
								if v112 == int32(0) {
									...
									if v116 != 0 {
										...
										v118 = *(*int32)(unsafe.Add(mBase, _c_F_SetTransactionIdLimit[4]))
											...
											if v147 != 0 {
												...
												if v146 == int32(0) {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v29 - v55
													F_errmsg(m, int32(_a_F_SetTransactionIdLimit_5), v9)
													mBase = m.M
													v155 = m.ExcPending
													if v155 != 0 {
														return
														...
														if v162 != 0 {
															...
															F_errfinish(m, int32(_a_F_SetTransactionIdLimit_3), v158, int32(_a_F_SetTransactionIdLimit_4))
															mBase = m.M
															v166 = m.ExcPending
															if v166 != 0 {
																return
													...
													if v131 != 0 {
														...
														if v130 == int32(0) {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = v29 - v55
															F_errmsg(m, int32(_a_F_SetTransactionIdLimit_7), v9+int32(16))
															mBase = m.M
															v141 = m.ExcPending
															if v141 != 0 {
																return
								...
								v93 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SetTransactionIdLimit[5])))
								if v93 != int32(1) {
									if base.B2i32(base.Ui32(int32(2)) < base.Ui32(v53))&base.B2i32(base.Ui32(int32(3)) <= base.Ui32(v55)) == int32(0) {
										v112 = base.B2i32(base.Ui32(v53) <= base.Ui32(v55))
									} else {
									...
									v97 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SetTransactionIdLimit[3])))
									if v97 != 0 {
										if base.B2i32(base.Ui32(int32(2)) < base.Ui32(v53))&base.B2i32(base.Ui32(int32(3)) <= base.Ui32(v55)) == int32(0) {
											v112 = base.B2i32(base.Ui32(v53) <= base.Ui32(v55))
										} else {
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v66
	F_appendStringInfo(m, v12+int32(96), int32(_a_F_ShowTransactionStateRec_4), v12-int32(-64))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L7
...
L23:
	...
	v118 = int32(_a_F_ShowTransactionStateRec_6)
...
L26:
	;
	v127 = *(*int32)(unsafe.Add(mBase, uint32(v120<<(uint(int32(2))%32))+uint32(_c_F_ShowTransactionStateRec[2])))
	v128 = v127
	goto L28
L27:
	;
...
L30:
	;
	v130 = int32(_a_F_ShowTransactionStateRec_7)
	goto L31
L31:
	;
...
L32:
	;
	v139 = *(*int32)(unsafe.Add(mBase, uint32(v132<<(uint(int32(2))%32))+uint32(_c_F_ShowTransactionStateRec[3])))
	v140 = v139
	goto L34
L33:
	;
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = v141
	v147 = *(*int32)(unsafe.Add(mBase, _c_F_ShowTransactionStateRec[4]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+36)) = v149
	v154 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ShowTransactionStateRec[5])))
	if v154 != 0 {
		goto L35
	} else {
		goto L36
...
L35:
	;
	v155 = int32(_a_F_ShowTransactionStateRec_8)
	goto L37
L36:
	;
	v155 = int32(_a_F_ShowTransactionStateRec_9)
	goto L37
L37:
	;
...
L16:
	;
	v109 = F_SimpleLruReadPage(m, int32(_a_F_TransactionTreeSetCommitTsData_1), base.I64_extend_i32_u(v48), int32(1), v38)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L15
