			...
			if v56 != 0 {
				...
				if v60 != 0 {
					...
					if v64 != 0 {
						...
						F_errfinish(m, int32(519478), int32(142), int32(299433))
						mBase = m.M
						v69 = m.ExcPending
						if v69 != 0 {
							return int32(0)
	...
	default:
		...
		if v73 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = base.I32_extend8_s(v43)
			F_errmsg_internal(m, int32(525796), v9)
			mBase = m.M
			v78 = m.ExcPending
			if v78 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(516845), int32(75), int32(299412))
				mBase = m.M
				v83 = m.ExcPending
				if v83 != 0 {
					return int32(0)
	...
	if v7 != int32(1) {
		...
		if v50 != 0 {
			...
			if v54 != 0 {
				...
				F_errfinish(m, int32(514913), int32(351), int32(299504))
				mBase = m.M
				v59 = m.ExcPending
				if v59 != 0 {
					return int32(0)
