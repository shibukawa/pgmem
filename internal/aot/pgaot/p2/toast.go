			...
			if v56 != 0 {
				...
				if v60 != 0 {
					...
					if v64 != 0 {
						...
						F_errfinish(m, int32(519548), int32(142), int32(299463))
						mBase = m.M
						v69 = m.ExcPending
						if v69 != 0 {
							return int32(0)
	...
	default:
		...
		if v73 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = base.I32_extend8_s(v43)
			F_errmsg_internal(m, int32(525866), v9)
			mBase = m.M
			v78 = m.ExcPending
			if v78 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(516897), int32(75), int32(299442))
				mBase = m.M
				v83 = m.ExcPending
				if v83 != 0 {
					return int32(0)
...
func F_toast_fetch_datum(m *base.Module, l0 int32) int32 {
	...
	if v7 != int32(1) {
		...
		if v50 != 0 {
			...
			F_errmsg_internal(m, int32(159533), int32(0))
			mBase = m.M
			v54 = m.ExcPending
			if v54 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(514965), int32(351), int32(299534))
				mBase = m.M
				v59 = m.ExcPending
				if v59 != 0 {
					return int32(0)
