			...
			if v56 != 0 {
				...
				if v60 != 0 {
					...
					if v64 != 0 {
						...
						F_errfinish(m, int32(496133), int32(142), int32(286127))
						mBase = m.M
						v69 = m.ExcPending
						if v69 != 0 {
							return int32(0)
	...
	default:
		...
		if v73 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = base.I32_extend8_s(v43)
			F_errmsg_internal(m, int32(501317), v9)
			mBase = m.M
			v78 = m.ExcPending
			if v78 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(493769), int32(75), int32(286106))
				mBase = m.M
				v83 = m.ExcPending
				if v83 != 0 {
					return int32(0)
...
func F_toast_fetch_datum(m *base.Module, l0 int32) int32 {
	...
	if v7 != int32(1) {
		...
		if v50 != 0 {
			...
			F_errmsg_internal(m, int32(150372), int32(0))
			mBase = m.M
			v54 = m.ExcPending
			if v54 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(492531), int32(351), int32(286198))
				mBase = m.M
				v59 = m.ExcPending
				if v59 != 0 {
					return int32(0)
