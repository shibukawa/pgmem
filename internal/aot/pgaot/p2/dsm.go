...
func F_dsm_postmaster_shutdown(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v3
	v18 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_postmaster_shutdown[0]))
...
L3:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_postmaster_shutdown[1]))
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v49
	F_errmsg_internal(m, int32(_a_F_dsm_postmaster_shutdown_0), v9+int32(16))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L15
...
L25:
	;
	v96 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_postmaster_shutdown[2]))
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v96
	F_errmsg_internal(m, int32(_a_F_dsm_postmaster_shutdown_3), v9)
	mBase = m.M
	v100 = m.ExcPending
	if v100 != 0 {
		goto L15
