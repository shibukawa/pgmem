...
L20:
	;
	F_errfinish(m, int32(520567), int32(398), int32(255642))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L15
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+44)) = v107
	...
	v118 = F_dsm_impl_op(m, int32(3), v111, int32(0), int32(4470184), v9+int32(44), int32(4470188), int32(15))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L15
...
L28:
	;
	F_errfinish(m, int32(520567), int32(408), int32(255642))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L15
...
L33:
	;
	F_errfinish(m, int32(520567), int32(379), int32(255642))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L15
