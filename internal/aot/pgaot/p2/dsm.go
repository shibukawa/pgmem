...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v49
	F_errmsg_internal(m, int32(55225), v9+int32(16))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L15
...
L20:
	;
	F_errfinish(m, int32(480254), int32(398), int32(234650))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L15
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v96
	F_errmsg_internal(m, int32(55279), v9)
	mBase = m.M
	v100 = m.ExcPending
	if v100 != 0 {
		goto L15
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+44)) = v107
	...
	v118 = F_dsm_impl_op(m, int32(3), v111, int32(0), int32(4371272), v9+int32(44), int32(4371276), int32(15))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L15
...
L28:
	;
	F_errfinish(m, int32(480254), int32(408), int32(234650))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L15
...
L32:
	;
	F_errmsg(m, int32(80328), int32(0))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L15
...
L33:
	;
	F_errfinish(m, int32(480254), int32(379), int32(234650))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L15
