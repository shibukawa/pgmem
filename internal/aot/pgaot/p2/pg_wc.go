...
func F_pg_wc_islower(m *base.Module, l0 int32) int32 {
	...
	var v74 int32
	_ = v74
	v3 = *(*int32)(unsafe.Add(mBase, _consts[589]))
	switch v3 - int32(1) {
	case 0:
		goto L3
	case 1:
...
L9:
	...
	v30 = *(*int32)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[603])))
...
L14:
	;
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[604])))
...
func F_pg_wc_toupper(m *base.Module, l0 int32) int32 {
	...
	case 0:
		if base.Ui32(l0) <= base.Ui32(int32(127)) {
			v126 = l0<<(uint(int32(2))%32) + int32(1900676)
		} else {
			v27 = int32(0)
			if base.Ui32(l0) < base.Ui32(int32(1416)) {
				v114 = l0
				v119 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v114<<(uint(int32(1))%32))+uint32(_consts[607]))))
				v121 = v119
			} else {
			...
			v126 = v121<<(uint(int32(2))%32) + int32(1900672)
		}
		...
		return v128
	case 1:
		v131 = *(*int32)(unsafe.Add(mBase, _consts[590]))
		if base.Ui32(int32(127)) < base.Ui32(l0) {
	...
	case 2:
		v156 = *(*int32)(unsafe.Add(mBase, _consts[590]))
		if base.Ui32(int32(127)) < base.Ui32(l0) {
