...
L9:
	...
	v30 = *(*int32)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[604])))
...
L14:
	;
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[605])))
...
func F_pg_wc_toupper(m *base.Module, l0 int32) int32 {
	...
	case 0:
		if base.Ui32(l0) <= base.Ui32(int32(127)) {
			...
			if base.Ui32(l0) < base.Ui32(int32(1416)) {
				v114 = l0
				v119 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v114<<(uint(int32(1))%32))+uint32(_consts[608]))))
				v121 = v119
			} else {
		...
		return v128
	case 1:
		v131 = *(*int32)(unsafe.Add(mBase, _consts[591]))
		if base.Ui32(int32(127)) < base.Ui32(l0) {
	...
	case 2:
		v156 = *(*int32)(unsafe.Add(mBase, _consts[591]))
		if base.Ui32(int32(127)) < base.Ui32(l0) {
