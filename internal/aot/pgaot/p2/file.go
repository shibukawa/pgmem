...
func F_FileSetCreate(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v805
	v7 = m.G0
	v9 = v7 - int32(_a_F_FileSetCreate_0)
	m.G0 = v9
	v14 = l0 + int32(12)
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = int32(_a_F_FileSetCreate_1)
	*(*int64)(unsafe.Add(mBase, uint32(v9)+40)) = v346
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v9 + int32(3120)
	v359 = F_pg_snprintf(m, v9+int32(2096), int32(1024), int32(_a_F_FileSetCreate_2), v9+int32(32))
	mBase = m.M
	v360 = m.ExcPending
	if v360 != 0 {
		goto L58
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(2096)
	v371 = F_pg_snprintf(m, v9+int32(1072), int32(1024), int32(_a_F_FileSetCreate_3), v9+int32(16))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L58
...
L65:
	;
	m.G0 = v9 + int32(_a_F_FileSetCreate_0)
	return v805
L66:
	;
...
L124:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(_a_F_FileSetCreate_1)
	*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v715
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(3120)
	v726 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(_a_F_FileSetCreate_2), v9)
	mBase = m.M
	v727 = m.ExcPending
	if v727 != 0 {
		goto L58
...
L125:
	...
	m.G0 = v732
	v735 = v9 + int32(48)
	v737 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetCreate[0]))
...
L130:
	;
	v742 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetCreate[1]))
	if v742 == int32(20) {
		goto L129
	} else {
		goto L131
...
L131:
	;
	v746 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetCreate[0]))
...
L132:
	;
	v751 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetCreate[1]))
	if v751 != int32(20) {
		goto L128
	} else {
		goto L135
...
L134:
	;
	v755 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetCreate[0]))
...
L136:
	;
	v760 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetCreate[1]))
	if v760 != int32(20) {
		goto L127
	} else {
		goto L137
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v732)+16)) = v729
	F_errmsg(m, int32(_a_F_FileSetCreate_4), v732+int32(16))
	mBase = m.M
	v777 = m.ExcPending
	if v777 != 0 {
		goto L58
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v732))) = v735
	F_errmsg(m, int32(_a_F_FileSetCreate_7), v732)
	mBase = m.M
	v792 = m.ExcPending
	if v792 != 0 {
		goto L58
...
func F_FileSetInit(m *base.Module, l0 int32) {
	...
	_ = v181
	v2 = int32(0)
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetInit[0]))
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = v13
	v15 = int32(_a_F_FileSetInit_0)
	v16 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetInit[1]))
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v16
	v22 = base.I32_rem_u_s(v16+int32(1), int32(2147483647))
	*(*int32)(unsafe.Add(mBase, _c_F_FileSetInit[1])) = v22
	...
	if v25 != 0 {
		...
		v27 = l0 + int32(12)
		v28 = int32(8)
		v30 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetInit[2]))
		if v28 < v30 {
			v33 = v28
		} else {
			v33 = v30
		...
		if int32(0) < v33 {
			v37 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetInit[3]))
		...
		if v140 != 0 {
			if int32(0) < v140 {
				...
				for {
					...
					if v158 == int32(0) {
						v162 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetInit[4]))
			...
			v181 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetInit[4]))
