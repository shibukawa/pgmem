...
func F_FileSetCreate(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v289 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = int32(245252)
		*(*int64)(unsafe.Add(mBase, uint32(v9)+40)) = v290
		*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v9 + int32(3120)
		v303 = F_pg_snprintf(m, v9+int32(2096), int32(1024), int32(112217), v9+int32(32))
		mBase = m.M
		v304 = m.ExcPending
		if v304 != 0 {
			return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(2096)
			v315 = F_pg_snprintf(m, v9+int32(1072), int32(1024), int32(185927), v9+int32(16))
			mBase = m.M
			v316 = m.ExcPending
			if v316 != 0 {
				return int32(0)
					...
					if v320 <= int32(0) {
						...
						if v598 != 0 {
							...
							if v602 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(245252)
								*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v603
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(3120)
								v614 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(112217), v9)
								mBase = m.M
								v615 = m.ExcPending
								if v615 != 0 {
									return int32(0)
													...
													if v657 != 0 {
														...
														if v659 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v620)+16)) = v617
															F_errmsg(m, int32(307845), v620+int32(16))
															mBase = m.M
															v665 = m.ExcPending
															if v665 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(520130), int32(1685), int32(222683))
																mBase = m.M
																v670 = m.ExcPending
																if v670 != 0 {
																	return int32(0)
															...
															if v674 != 0 {
																...
																if v676 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v620))) = v623
																	F_errmsg(m, int32(307799), v620)
																	mBase = m.M
																	v680 = m.ExcPending
																	if v680 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(520130), int32(1692), int32(222683))
																		mBase = m.M
																		v685 = m.ExcPending
																		if v685 != 0 {
																			return int32(0)
