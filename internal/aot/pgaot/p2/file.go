...
func F_FileSetCreate(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v289 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = int32(233316)
		*(*int64)(unsafe.Add(mBase, uint32(v9)+40)) = v290
		*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v9 + int32(3120)
		v303 = F_pg_snprintf(m, v9+int32(2096), int32(1024), int32(104968), v9+int32(32))
		mBase = m.M
		v304 = m.ExcPending
		if v304 != 0 {
			return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(2096)
			v315 = F_pg_snprintf(m, v9+int32(1072), int32(1024), int32(175616), v9+int32(16))
			mBase = m.M
			v316 = m.ExcPending
			if v316 != 0 {
				return int32(0)
					...
					if v320 <= int32(0) {
						...
						if v598 != 0 {
							...
							if v602 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(233316)
								*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v603
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(3120)
								v614 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(104968), v9)
								mBase = m.M
								v615 = m.ExcPending
								if v615 != 0 {
									return int32(0)
									...
									m.G0 = v620
									v623 = v9 + int32(48)
									v625 = *(*int32)(unsafe.Add(mBase, _consts[383]))
									...
									if int32(0) <= v626 {
										...
										v630 = *(*int32)(unsafe.Add(mBase, _consts[155]))
										if v630 == int32(20) {
											m.G0 = v620 + int32(32)
											v689 = F_PathNameCreateTemporaryFile(m, v9+int32(1072), int32(1))
											mBase = m.M
											...
											v634 = *(*int32)(unsafe.Add(mBase, _consts[383]))
											v635 = F_mkdir(m, v617, v634)
											mBase = m.M
											if v635 < int32(0) {
												v639 = *(*int32)(unsafe.Add(mBase, _consts[155]))
												if v639 != int32(20) {
													...
													if v657 != 0 {
														...
														if v659 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v620)+16)) = v617
															F_errmsg(m, int32(293362), v620+int32(16))
															mBase = m.M
															v665 = m.ExcPending
															if v665 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(494708), int32(1685), int32(211838))
																mBase = m.M
																v670 = m.ExcPending
																if v670 != 0 {
																	return int32(0)
													...
													v643 = *(*int32)(unsafe.Add(mBase, _consts[383]))
													...
													if int32(0) <= v644 {
														...
														v648 = *(*int32)(unsafe.Add(mBase, _consts[155]))
														if v648 != int32(20) {
															F_errstart_cold(m, int32(21), int32(0))
															mBase = m.M
															v674 = m.ExcPending
															if v674 != 0 {
																...
																if v676 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v620))) = v623
																	F_errmsg(m, int32(293316), v620)
																	mBase = m.M
																	v680 = m.ExcPending
																	if v680 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(494708), int32(1692), int32(211838))
																		mBase = m.M
																		v685 = m.ExcPending
																		if v685 != 0 {
																			return int32(0)
...
func F_FileSetInit(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[761])) = v22
	...
	if v25 != 0 {
		...
		v27 = l0 + int32(12)
		v28 = int32(8)
		v30 = *(*int32)(unsafe.Add(mBase, _consts[406]))
		if v28 < v30 {
			v33 = v28
		} else {
			v33 = v30
		...
		if int32(0) < v33 {
			v37 = *(*int32)(unsafe.Add(mBase, _consts[407]))
