...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = int32(223358)
	*(*int64)(unsafe.Add(mBase, uint32(v9)+40)) = v346
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v9 + int32(3120)
	v359 = F_pg_snprintf(m, v9+int32(2096), int32(1024), int32(98479), v9+int32(32))
	mBase = m.M
	v360 = m.ExcPending
	if v360 != 0 {
		goto L58
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(2096)
	v371 = F_pg_snprintf(m, v9+int32(1072), int32(1024), int32(166924), v9+int32(16))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L58
...
L124:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(223358)
	*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v715
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(3120)
	v726 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(98479), v9)
	mBase = m.M
	v727 = m.ExcPending
	if v727 != 0 {
		goto L58
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v732)+16)) = v729
	F_errmsg(m, int32(281479), v732+int32(16))
	mBase = m.M
	v777 = m.ExcPending
	if v777 != 0 {
		goto L58
...
L140:
	;
	F_errfinish(m, int32(476343), int32(1685), int32(202877))
	mBase = m.M
	v782 = m.ExcPending
	if v782 != 0 {
		goto L58
...
L144:
	;
	F_errfinish(m, int32(476343), int32(1692), int32(202877))
	mBase = m.M
	v797 = m.ExcPending
	if v797 != 0 {
		goto L58
