			...
			*(*uint8)(unsafe.Add(mBase, uint32(l0)+4)) = uint8(v15)
			...
			if v61 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				F_errmsg_internal(m, int32(38655), v7)
				mBase = m.M
				v65 = m.ExcPending
				if v65 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(514040), int32(1254), int32(481470))
					mBase = m.M
					v70 = m.ExcPending
					if v70 != 0 {
						return int32(0)
				...
				if v22 != 0 {
					...
					if v25 != 0 {
						...
						if v29 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
							F_errdetail(m, int32(693034), v7)
							mBase = m.M
							v35 = m.ExcPending
							if v35 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(514040), int32(1164), int32(380280))
								mBase = m.M
								v40 = m.ExcPending
								if v40 != 0 {
									return int32(0)
