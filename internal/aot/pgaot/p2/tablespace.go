									...
									if v49 != 0 {
										...
										if v52 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
											F_errmsg(m, int32(72660), v9)
											mBase = m.M
											v56 = m.ExcPending
											if v56 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(499979), int32(1461), int32(435385))
												mBase = m.M
												v61 = m.ExcPending
												if v61 != 0 {
													return int32(0)
		...
		if l1 != 0 {
			...
			if v8 != 0 {
				...
				if base.F64_lt(v9, float64(0)) == int32(0) {
					...
					v16 = *(*float64)(unsafe.Add(mBase, _consts[488]))
					v17 = v16
				}
			} else {
				v16 = *(*float64)(unsafe.Add(mBase, _consts[488]))
		...
		if l2 != 0 {
			...
			if v21 != 0 {
				...
				if base.F64_lt(v22, float64(0)) == int32(0) {
					...
					v29 = *(*float64)(unsafe.Add(mBase, _consts[487]))
					v30 = v29
				}
			} else {
				v29 = *(*float64)(unsafe.Add(mBase, _consts[487]))
