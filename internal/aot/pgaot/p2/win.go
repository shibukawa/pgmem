...
func F_WinGetFuncArgInFrame(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	case 0:
		...
		if v26 != 0 {
			...
			F_errmsg_internal(m, int32(396796), int32(0))
			mBase = m.M
			v30 = m.ExcPending
			if v30 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(524101), int32(3482), int32(396837))
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return int32(0)
				...
				default:
					...
					if v77 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v78
						F_errmsg_internal(m, int32(31164), v16+int32(16))
						mBase = m.M
						v84 = m.ExcPending
						if v84 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(524101), int32(3542), int32(396837))
							mBase = m.M
							v89 = m.ExcPending
							if v89 != 0 {
								return int32(0)
				...
				default:
					...
					if v150 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v151
						F_errmsg_internal(m, int32(31164), v16+int32(32))
						mBase = m.M
						v157 = m.ExcPending
						if v157 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(524101), int32(3612), int32(396837))
							mBase = m.M
							v162 = m.ExcPending
							if v162 != 0 {
								return int32(0)
	...
	default:
		...
		if v166 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v16))) = l2
			F_errmsg_internal(m, int32(509345), v16)
			mBase = m.M
			v170 = m.ExcPending
			if v170 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(524101), int32(3618), int32(396837))
				mBase = m.M
				v175 = m.ExcPending
				if v175 != 0 {
					return int32(0)
...
func F_WinSetMarkPosition(m *base.Module, l0 int32, l1 int64) {
	...
	if v5 <= l1 {
		...
		if v35 != 0 {
			...
			F_errmsg_internal(m, int32(443247), int32(0))
			mBase = m.M
			v39 = m.ExcPending
			if v39 != 0 {
				return
			} else {
				F_errfinish(m, int32(524101), int32(3292), int32(262903))
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return
