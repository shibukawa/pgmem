...
func F_IvfflatInit(m *base.Module) {
	...
	if v4 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_IvfflatInit[0])) = v3
		F_add_int_reloption(m, v3, int32(_a_F_IvfflatInit_0), int32(_a_F_IvfflatInit_1), int32(100), int32(1), int32(_a_F_IvfflatInit_2))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return
...
func F_IvfflatParallelBuildMain(m *base.Module, l0 int32, l1 int32) {
	...
	if v14 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_IvfflatParallelBuildMain[0])) = v13
						...
						if v43 != 0 {
							...
							if v45 != 0 {
								...
								if v49 != 0 {
									...
									v51 = *(*int32)(unsafe.Add(mBase, _c_F_IvfflatParallelBuildMain[1]))
