...
func F_pgaio_io_get_op_name(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v3) <= base.Ui32(int32(2)) {
		v10 = *(*int32)(unsafe.Add(mBase, uint32(v3<<(uint(int32(2))%32))+uint32(_consts[732])))
		v11 = v10
	} else {
		v11 = int32(0)
	}
...
func F_pgaio_io_get_state_name(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v3) <= base.Ui32(int32(7)) {
		v10 = *(*int32)(unsafe.Add(mBase, uint32(v3<<(uint(int32(2))%32))+uint32(_consts[731])))
		v11 = v10
	} else {
		v11 = int32(0)
	}
...
func F_pgaio_submit_staged(m *base.Module) {
	...
	v6 = v4 - int32(16)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[729]))
	...
	if v10 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, _consts[7])) = v15 + int32(1)
		v22 = *(*int32)(unsafe.Add(mBase, _consts[730]))
		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[7])) = v28 - int32(1)
			v33 = *(*int32)(unsafe.Add(mBase, _consts[729]))
			v34 = int32(0)
					...
					if v43 != 0 {
						...
						if v45 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = v24
							F_errmsg_internal(m, int32(174702), v6)
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return
							} else {
								F_errfinish(m, int32(495818), int32(1147), int32(459665))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return
...
func F_pgaio_worker_die(m *base.Module, l0 int32, l1 int32) {
	...
	if v9 != 0 {
		...
		v11 = *(*int32)(unsafe.Add(mBase, _consts[733]))
		v12 = *(*int64)(unsafe.Add(mBase, uint32(v11)))
		v15 = *(*int32)(unsafe.Add(mBase, _consts[734]))
