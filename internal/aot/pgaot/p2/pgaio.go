						...
						if v45 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = v24
							...
							if v49 != 0 {
								...
								F_errfinish(m, int32(_a_F_pgaio_submit_staged_2), int32(1147), int32(_a_F_pgaio_submit_staged_3))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return
...
func F_pgaio_worker_die(m *base.Module, l0 int32, l1 int32) {
	...
	var v32 int32
	_ = v32
	v4 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_worker_die[0]))
	v8 = F_LWLockAcquire(m, v4+int32(_a_F_pgaio_worker_die_0), int32(0))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
	} else {
		v11 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_worker_die[1]))
		v12 = *(*int64)(unsafe.Add(mBase, uint32(v11)))
		v15 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_worker_die[2]))
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v22)+12)) = uint8(v23)
		...
		F_LWLockRelease(m, v28+int32(_a_F_pgaio_worker_die_0))
		mBase = m.M
		v32 = m.ExcPending
		if v32 != 0 {
			return
