								...
								if v189 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(100)
									...
									if v195 != 0 {
										...
										F_errfinish(m, int32(499390), int32(230), int32(555569))
										mBase = m.M
										v202 = m.ExcPending
										if v202 != 0 {
											return int32(0)
				...
				if v160 != 0 {
					...
					if v163 != 0 {
						...
						if v169 != 0 {
							...
							F_errfinish(m, int32(499390), int32(222), int32(555569))
							mBase = m.M
							v176 = m.ExcPending
							if v176 != 0 {
								return int32(0)
				...
				if v359 != 0 {
					...
					if v365 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(100)
						F_errdetail(m, int32(591865), v19)
						mBase = m.M
						v371 = m.ExcPending
						if v371 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(499390), int32(1835), int32(555550))
							mBase = m.M
							v378 = m.ExcPending
							if v378 != 0 {
								return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = l1
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15
				if v15 == int32(0) {
					F_yy_fatal_error_6(m, int32(683596))
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return int32(0)
					...
					if v27 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = l4
						...
						if v32 != 0 {
							...
							v57 = int32(85)
							F_errsave_finish(m, l2, int32(314427), v57, int32(210118))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return
	...
	if v4 != 0 {
		...
		if v9 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l0
			...
			F_yy_fatal_error_6(m, int32(225594))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return
