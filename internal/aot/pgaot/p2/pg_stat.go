...
L46:
	;
	v178 = F_DirectFunctionCall1Coll(m, int32(1485), int32(0), v11)
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L2
...
L4:
	;
	if int32(base.Ui32(int32(_a_F_pg_stat_get_io_0))>>(uint(v18)%32))&base.B2i32(base.Ui32(v18) < base.Ui32(int32(17))) != 0 {
		goto L6
	} else {
		goto L7
	}
...
L6:
	;
	v29 = *(*int64)(unsafe.Add(mBase, _c_F_pg_stat_get_io[0]))
	F_pg_stat_io_build_tuples(m, v10, int32(_a_F_pg_stat_get_io_1)+v18*int32(2880), v18, v29)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
...
func F_pg_stat_get_wal(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		v13 = int32(_a_F_pg_stat_get_wal_0)
		...
		*(*int64)(unsafe.Add(mBase, uint32(v6)+24)) = v15
		v17 = *(*int64)(unsafe.Add(mBase, _c_F_pg_stat_get_wal[2]))
		*(*int64)(unsafe.Add(mBase, uint32(v6)+16)) = v17
		v19 = *(*int64)(unsafe.Add(mBase, _c_F_pg_stat_get_wal[3]))
		*(*int64)(unsafe.Add(mBase, uint32(v6)+8)) = v19
		v21 = *(*int64)(unsafe.Add(mBase, _c_F_pg_stat_get_wal[4]))
...
L2:
	;
	v172 = *(*int32)(unsafe.Add(mBase, uint32(l2<<(uint(int32(2))%32))+uint32(_c_F_pg_stat_io_build_tuples[0])))
	v173 = v172
	goto L4
L3:
	;
	v173 = int32(_a_F_pg_stat_io_build_tuples_0)
	goto L4
L4:
	;
	goto L1
...
L11:
	;
	v258 = *(*int32)(unsafe.Add(mBase, uint32(v186<<(uint(int32(2))%32))+uint32(_c_F_pg_stat_io_build_tuples[1])))
	m.G0 = v237 + int32(16)
	v263 = v186 * int32(320)
	v271 = int32(0)
	goto L15
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v237))) = v186
	F_errmsg_internal(m, int32(_a_F_pg_stat_io_build_tuples_1), v237)
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L5
...
L19:
	;
	v348 = *(*int32)(unsafe.Add(mBase, uint32(v271<<(uint(int32(2))%32))+uint32(_c_F_pg_stat_io_build_tuples[2])))
	m.G0 = v327 + int32(16)
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v327))) = v271
	F_errmsg_internal(m, int32(_a_F_pg_stat_io_build_tuples_4), v327)
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L5
...
L21:
	;
	F_errfinish(m, int32(_a_F_pg_stat_io_build_tuples_2), int32(256), int32(_a_F_pg_stat_io_build_tuples_5))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L5
...
L25:
	;
	if int32(1)<<(uint(l2)%32)&int32(_a_F_pg_stat_io_build_tuples_6) == int32(0) {
		v428 = v358
		goto L24
	} else {
		goto L26
...
L30:
	;
	if int32(1)<<(uint(l2)%32)&int32(_a_F_pg_stat_io_build_tuples_7) == int32(0) {
		goto L29
	} else {
		goto L31
	}
...
L105:
	;
	if int32(base.Ui32(int32(_a_F_pg_stat_io_build_tuples_8))>>(uint(v631)%32))&int32(1) != 0 {
		goto L72
	} else {
		goto L116
	}
...
L134:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v62))) = v729
	v735 = F_pg_snprintf(m, v62+int32(16), int32(256), int32(_a_F_pg_stat_io_build_tuples_9), v62)
	mBase = m.M
	v736 = m.ExcPending
	if v736 != 0 {
		goto L5
...
func F_pg_stat_reset(m *base.Module, l0 int32) int32 {
	...
	F_pgstat_reset_matching_entries(m, int32(1217), v23, v12+v11*int64(1000000)-int64(946684800000000))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		return int32(0)
...
func F_pg_stat_reset_single_table_counters(m *base.Module, l0 int32) int32 {
	...
	if v3 <= int32(3591) {
		...
		if v3 <= int32(_a_F_pg_stat_reset_single_table_counters_0) {
			v30 = v3 - int32(_a_F_pg_stat_reset_single_table_counters_1)
			...
			default:
				if base.Ui32(v3-int32(_a_F_pg_stat_reset_single_table_counters_3)) < base.Ui32(int32(3)) {
					...
					v46 = v3 - int32(_a_F_pg_stat_reset_single_table_counters_4)
					if base.Ui32(int32(15)) < base.Ui32(v46) {
						v74 = int32(0)
					} else {
						if int32(1)<<(uint(v46)%32)&int32(_a_F_pg_stat_reset_single_table_counters_5) != 0 {
							v74 = v6
						} else {
							v74 = int32(0)
						}
	...
	v78 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_reset_single_table_counters[0]))
	if v74 != 0 {
		v79 = int32(0)
	} else {
		v79 = v78
