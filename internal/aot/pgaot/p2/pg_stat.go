...
L6:
	;
	v23 = *(*int32)(unsafe.Add(mBase, _consts[276]))
...
L9:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _consts[276]))
...
L6:
	;
	v29 = *(*int64)(unsafe.Add(mBase, _consts[1129]))
	F_pg_stat_io_build_tuples(m, v10, int32(4373720)+v18*int32(2880), v18, v29)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
...
func F_pg_stat_get_wal(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		v13 = int32(4426072)
		v14 = *(*int64)(unsafe.Add(mBase, _consts[1133]))
		v15 = *(*int64)(unsafe.Add(mBase, _consts[1134]))
		*(*int64)(unsafe.Add(mBase, uint32(v6)+24)) = v15
		v17 = *(*int64)(unsafe.Add(mBase, _consts[1135]))
		*(*int64)(unsafe.Add(mBase, uint32(v6)+16)) = v17
		v19 = *(*int64)(unsafe.Add(mBase, _consts[1136]))
		*(*int64)(unsafe.Add(mBase, uint32(v6)+8)) = v19
		v21 = *(*int64)(unsafe.Add(mBase, _consts[1137]))
...
L2:
	;
	v172 = *(*int32)(unsafe.Add(mBase, uint32(l2<<(uint(int32(2))%32))+uint32(_consts[1130])))
	v173 = v172
	goto L4
L3:
	;
...
L11:
	;
	v258 = *(*int32)(unsafe.Add(mBase, uint32(v186<<(uint(int32(2))%32))+uint32(_consts[1131])))
	m.G0 = v237 + int32(16)
	v263 = v186 * int32(320)
	v271 = int32(0)
	goto L15
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v237))) = v186
	F_errmsg_internal(m, int32(465071), v237)
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L5
...
L13:
	;
	F_errfinish(m, int32(476958), int32(273), int32(363137))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L5
...
L19:
	;
	v348 = *(*int32)(unsafe.Add(mBase, uint32(v271<<(uint(int32(2))%32))+uint32(_consts[1132])))
	m.G0 = v327 + int32(16)
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v327))) = v271
	F_errmsg_internal(m, int32(465038), v327)
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L5
...
L21:
	;
	F_errfinish(m, int32(476958), int32(256), int32(362952))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L5
...
L134:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v62))) = v729
	v735 = F_pg_snprintf(m, v62+int32(16), int32(256), int32(413554), v62)
	mBase = m.M
	v736 = m.ExcPending
	if v736 != 0 {
		goto L5
