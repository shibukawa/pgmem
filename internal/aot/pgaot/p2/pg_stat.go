...
L6:
	...
	F_pg_stat_io_build_tuples(m, v10, int32(4439448)+v18*int32(2880), v18, v29)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v237))) = v186
	F_errmsg_internal(m, int32(483511), v237)
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L5
...
L13:
	;
	F_errfinish(m, int32(495946), int32(273), int32(378480))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L5
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v327))) = v271
	F_errmsg_internal(m, int32(483478), v327)
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L5
...
L21:
	;
	F_errfinish(m, int32(495946), int32(256), int32(378295))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L5
...
L134:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v62))) = v729
	v735 = F_pg_snprintf(m, v62+int32(16), int32(256), int32(430313), v62)
	mBase = m.M
	v736 = m.ExcPending
	if v736 != 0 {
		goto L5
