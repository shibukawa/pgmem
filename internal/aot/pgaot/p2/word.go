...
L53:
	;
	v429 = int32(_a_F_calc_word_similarity_1)
	goto L55
L54:
	;
	v429 = int32(_a_F_calc_word_similarity_2)
	goto L55
L55:
	;
...
L65:
	;
	v478 = *(*int32)(unsafe.Add(mBase, _c_F_calc_word_similarity[1]))
	if v478 != 0 {
		goto L67
	} else {
		goto L68
	...
	if v15 != 0 {
		...
		if v18 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v19
			F_errmsg(m, int32(_a_F_word_is_not_variable_1), v8)
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return
