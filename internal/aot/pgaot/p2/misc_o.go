...
L21:
	;
	F_errfinish(m, int32(488500), int32(2720), int32(281999))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L1
...
func F_oidout(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8
		v17 = F_pg_snprintf(m, v10, int32(12), int32(58411), v6)
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
	...
	if v8 == int32(0) {
		...
		if v16 != 0 {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(110049)
				...
				if v24 != 0 {
					...
					F_errfinish(m, int32(483564), int32(818), int32(80559))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
	...
	if v9 == int32(0) {
		...
		if v17 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(110049)
				...
				if v25 != 0 {
					...
					F_errfinish(m, int32(483564), int32(833), int32(224773))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
...
func F_open_auth_file(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	if int32(11) <= l2 {
			...
			if v14 != 0 {
				...
				if v19 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
					F_errmsg(m, int32(452277), v7+int32(-48))
					mBase = m.M
					v25 = m.ExcPending
					if v25 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(488897), int32(612), int32(377771))
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return int32(0)
							...
							if l3 == int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
								v35 = F_psprintf(m, int32(452277), v9)
								mBase = m.M
								v36 = m.ExcPending
								if v36 != 0 {
									return int32(0)
		...
		v39 = F_AllocateFile(m, l0, int32(225897))
		mBase = m.M
		v40 = m.ExcPending
		if v40 != 0 {
			return int32(0)
			...
			if v39 == int32(0) {
						...
						if v49 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = l0
							...
							if v55 != 0 {
								...
								F_errfinish(m, int32(488897), int32(627), int32(377771))
								mBase = m.M
								v60 = m.ExcPending
								if v60 != 0 {
									return int32(0)
									...
									if l3 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l0
										v67 = F_psprintf(m, int32(292150), v7+int32(-32))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
				...
				if l2 != 0 {
					...
					v80 = F_AllocSetContextCreateInternal(m, v75, int32(58504), int32(0), int32(1024), int32(8388608))
					mBase = m.M
					v81 = m.ExcPending
					if v81 != 0 {
						return int32(0)
