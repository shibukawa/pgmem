...
L3:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[752]))
	if v15 <= int32(0) {
		goto L6
	} else {
		goto L7
...
L7:
	...
	v21 = *(*int32)(unsafe.Add(mBase, _consts[754]))
	v23 = *(*int32)(unsafe.Add(mBase, _consts[755]))
	if v21+(v23+v15) < v19 {
		goto L6
	} else {
		goto L8
...
L11:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _consts[752]))
	if v38 <= int32(0) {
		goto L6
	} else {
		goto L12
...
L12:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[753]))
	v44 = *(*int32)(unsafe.Add(mBase, _consts[754]))
...
L15:
	;
	v60 = *(*int32)(unsafe.Add(mBase, _consts[756]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v65))) = int32(3)
	v70 = *(*int32)(unsafe.Add(mBase, _consts[61]))
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v65)+4)) = v71
	v73 = int32(4365544)
	v75 = *(*int32)(unsafe.Add(mBase, _consts[755]))
	*(*int32)(unsafe.Add(mBase, _consts[755])) = v75 + int32(1)
	goto L17
L19:
	;
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = l0
	v93 = *(*int32)(unsafe.Add(mBase, _consts[757]))
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v93
	F_errmsg(m, int32(679110), v8)
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L1
...
L21:
	;
	F_errfinish(m, int32(480438), int32(2720), int32(276337))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L1
...
func F_oidout(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8
		v17 = F_pg_snprintf(m, v10, int32(12), int32(57422), v6)
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
...
L29:
	;
	v109 = int32(*(*uint16)(unsafe.Add(mBase, _consts[1085])))
	v111 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1086])))
	v113 = v99
	v114 = v97 - v89
	v115 = int32(1)
	v117 = v98
	...
	if v8 == int32(0) {
		...
		if v16 != 0 {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(106237)
				...
				if v24 != 0 {
					...
					F_errfinish(m, int32(475576), int32(818), int32(78513))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
	...
	if v9 == int32(0) {
		...
		if v17 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(106237)
				...
				if v25 != 0 {
					...
					F_errfinish(m, int32(475576), int32(833), int32(219882))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
...
func F_open(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v7))) = v22
	...
	if base.Ui32(int32(-4095)) <= base.Ui32(v27) {
		*(*int32)(unsafe.Add(mBase, _consts[155])) = int32(0) - v27
		v35 = int32(-1)
	} else {
		v35 = v27
	}
...
func F_open_auth_file(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	if int32(11) <= l2 {
			...
			if v14 != 0 {
				...
				if v19 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
					F_errmsg(m, int32(444725), v7+int32(-48))
					mBase = m.M
					v25 = m.ExcPending
					if v25 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(480835), int32(612), int32(370914))
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return int32(0)
							...
							if l3 == int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
								v35 = F_psprintf(m, int32(444725), v9)
								mBase = m.M
								v36 = m.ExcPending
								if v36 != 0 {
									return int32(0)
		...
		v39 = F_AllocateFile(m, l0, int32(221006))
		mBase = m.M
		v40 = m.ExcPending
		if v40 != 0 {
			return int32(0)
			...
			if v39 == int32(0) {
				v44 = *(*int32)(unsafe.Add(mBase, _consts[155]))
						...
						if v49 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = l0
							...
							if v55 != 0 {
								...
								F_errfinish(m, int32(480835), int32(627), int32(370914))
								mBase = m.M
								v60 = m.ExcPending
								if v60 != 0 {
									return int32(0)
									...
									if l3 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l0
										v67 = F_psprintf(m, int32(286472), v7+int32(-32))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
				...
				if l2 != 0 {
					...
					v80 = F_AllocSetContextCreateInternal(m, v75, int32(57515), int32(0), int32(1024), int32(8388608))
					mBase = m.M
					v81 = m.ExcPending
					if v81 != 0 {
						return int32(0)
					} else {
						*(*int32)(unsafe.Add(mBase, _consts[471])) = v80
						v83 = v39
						m.G0 = v9 - int32(-64)
						return v83
					}
