...
func F_systable_beginscan_ordered(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	v23 = *(*int32)(unsafe.Add(mBase, _consts[121]))
	if v23 != v19 {
		goto L2
	} else {
		goto L3
...
L2:
	;
	v26 = *(*int32)(unsafe.Add(mBase, _consts[122]))
...
L5:
	;
	v32 = int32(*(*uint8)(unsafe.Add(mBase, _consts[123])))
	if v32 != int32(1) {
		goto L8
	} else {
		goto L9
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v43 + int32(4)
	F_errmsg_internal(m, int32(161235), v17+int32(16))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L10
...
L13:
	;
	F_errfinish(m, int32(509228), int32(668), int32(461043))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L10
...
L41:
	;
	F_errfinish(m, int32(509228), int32(707), int32(461043))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L10
...
L45:
	;
	v221 = *(*int32)(unsafe.Add(mBase, _consts[124]))
	if v221 != 0 {
		goto L46
	} else {
		goto L47
...
L46:
	;
	v223 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[125])) = uint8(v223)
	goto L48
L47:
	;
	goto L48
...
L51:
	;
	F_errfinish(m, int32(509228), int32(664), int32(461043))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L10
