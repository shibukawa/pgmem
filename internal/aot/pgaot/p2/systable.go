...
L13:
	;
	F_errfinish(m, int32(494121), int32(668), int32(448612))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L10
...
L41:
	;
	F_errfinish(m, int32(494121), int32(707), int32(448612))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L10
...
L51:
	;
	F_errfinish(m, int32(494121), int32(664), int32(448612))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L10
