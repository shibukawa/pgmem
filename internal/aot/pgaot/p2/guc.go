...
L17:
	...
	v59 = int32(0)
	v60 = int32(1)
	v67 = F_set_config_with_handle(m, int32(80791), v59, v57, v60, int32(2), int32(10), v59, v60, v59, v59)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L20
...
L38:
	...
	v119 = int32(0)
	v120 = int32(1)
	v127 = F_set_config_with_handle(m, int32(381301), v119, v117, v120, int32(2), int32(10), v119, v120, v119, v119)
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L20
...
L58:
	...
	v179 = int32(0)
	v180 = int32(1)
	v187 = F_set_config_with_handle(m, int32(334762), v179, v177, v180, int32(2), int32(10), v179, v180, v179, v179)
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L20
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v282
	v284 = int32(16)
	v288 = F_pg_snprintf(m, v7+v284, v284, int32(486504), v7)
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L20
...
L100:
	;
	v299 = int32(0)
	v303 = F_set_config_with_handle(m, int32(319480), int32(0), v7+int32(16), v294, v297, int32(10), v299, int32(1), v299, v299)
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L20
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v163
	v166 = *(*int32)(unsafe.Add(mBase, _consts[1233]))
	v167 = F_pstrdup(m, l0)
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v88
	F_errmsg(m, int32(103843), v8+int32(16))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(497951), int32(5314), int32(438818))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L1
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1233])) = v169
	m.G0 = v8 + int32(48)
	return
}
