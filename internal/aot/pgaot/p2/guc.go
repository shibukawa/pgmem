...
L64:
	;
	m.G0 = v191 + int32(16)
	if int32(_a_F_InitializeGUCOptionsFromEnvironment_6) <= v268 {
		goto L91
	} else {
		goto L92
	}
...
L70:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _c_F_InitializeGUCOptionsFromEnvironment[5]))
	if v214 != int32(52) {
		v251 = v210
		goto L69
	} else {
...
L90:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_InitializeGUCOptionsFromEnvironment[4])) = v266
	v268 = v266
	goto L64
L91:
	;
	v281 = base.B2i32(base.Ui32(v268) < base.Ui32(int32(_a_F_InitializeGUCOptionsFromEnvironment_7)))
	if base.Ui32(v268) < base.Ui32(int32(_a_F_InitializeGUCOptionsFromEnvironment_7)) {
		goto L94
	} else {
		goto L95
	}
...
L94:
	;
	v282 = int32(base.Ui32(v268-int32(_a_F_InitializeGUCOptionsFromEnvironment_8)) >> (uint(int32(10)) % 32))
	goto L96
L95:
	;
	v282 = int32(2048)
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v282
	v284 = int32(16)
	v288 = F_pg_snprintf(m, v7+v284, v284, int32(_a_F_InitializeGUCOptionsFromEnvironment_9), v7)
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L20
...
L100:
	;
	v299 = int32(0)
	v303 = F_set_config_with_handle(m, int32(_a_F_InitializeGUCOptionsFromEnvironment_10), int32(0), v7+int32(16), v294, v297, int32(10), v299, int32(1), v299, v299)
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L20
...
L1:
	;
	v70 = *(*int32)(unsafe.Add(mBase, _c_F_MarkGUCPrefixReserved[0]))
	F_hash_seq_init(m, v8+int32(28), v70)
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L18
...
L19:
	;
	v75 = F_hash_seq_search(m, v8+int32(28))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L18
...
L23:
	;
	v215 = int32(_a_F_MarkGUCPrefixReserved_0)
	v216 = *(*int32)(unsafe.Add(mBase, _c_F_MarkGUCPrefixReserved[1]))
	v219 = *(*int32)(unsafe.Add(mBase, _c_F_MarkGUCPrefixReserved[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_MarkGUCPrefixReserved[1])) = v219
	v222 = *(*int32)(unsafe.Add(mBase, _c_F_MarkGUCPrefixReserved[3]))
	v223 = F_pstrdup(m, l0)
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
...
L24:
	...
	v83 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v82)+21)))
...
L26:
	;
	v208 = F_hash_seq_search(m, v8+int32(28))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L18
...
L42:
	;
	v134 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v66+v88))))
	if v134 != int32(46) {
		goto L26
	} else {
		goto L43
...
L47:
	;
	v161 = *(*int32)(unsafe.Add(mBase, _c_F_MarkGUCPrefixReserved[0]))
	v164 = F_hash_search(m, v161, v82, int32(2), int32(0))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L18
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v144
...
L52:
	;
	v166 = *(*int32)(unsafe.Add(mBase, uint32(v82)+32))
	if v166 != 0 {
		goto L53
	} else {
		goto L54
...
L53:
	;
	v167 = *(*int32)(unsafe.Add(mBase, uint32(v82)+64))
	v168 = *(*int32)(unsafe.Add(mBase, uint32(v82)+68))
	*(*int32)(unsafe.Add(mBase, uint32(v167)+4)) = v168
	v170 = *(*int32)(unsafe.Add(mBase, uint32(v82)+64))
...
L55:
	;
	v173 = *(*int32)(unsafe.Add(mBase, uint32(v82)+56))
	if v173 != 0 {
		goto L56
	} else {
		goto L57
...
L56:
	;
	v178 = int32(_a_F_MarkGUCPrefixReserved_6)
	goto L61
L57:
	;
	goto L58
L58:
	;
	v187 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v82)+28)))
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v178))) = v185
	goto L60
L63:
	;
	if v181 != v82+int32(72) {
		v178 = v181
		goto L61
	} else {
		goto L64
...
L65:
	;
	v196 = int32(_a_F_MarkGUCPrefixReserved_7)
	goto L68
L66:
	;
	goto L26
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v196))) = v203
	goto L67
L70:
	;
	if v199 != v82+int32(76) {
		v196 = v199
		goto L68
	} else {
		goto L71
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_MarkGUCPrefixReserved[1])) = v216
	*(*int32)(unsafe.Add(mBase, _c_F_MarkGUCPrefixReserved[3])) = v225
	m.G0 = v8 + int32(48)
	return
}
