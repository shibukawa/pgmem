...
L4:
	;
	v18 = v15 - v9
	v20 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v18)+uint32(_consts[1231]))))
	if v20 != 0 {
		v50 = v1
		goto L5
	} else {
...
L6:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1232]))
	if v22 == int32(0) {
		v50 = v1
		goto L5
	} else {
...
L17:
	...
	v59 = int32(0)
	v60 = int32(1)
	v67 = F_set_config_with_handle(m, int32(81031), v59, v57, v60, int32(2), int32(10), v59, v60, v59, v59)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L20
...
L25:
	;
	v78 = v75 - v69
	v80 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v78)+uint32(_consts[1233]))))
	if v80 != 0 {
		v110 = v70
		goto L26
	} else {
...
L27:
	;
	v82 = *(*int32)(unsafe.Add(mBase, _consts[1232]))
	if v82 == int32(0) {
		v110 = v70
		goto L26
	} else {
...
L38:
	...
	v119 = int32(0)
	v120 = int32(1)
	v127 = F_set_config_with_handle(m, int32(382608), v119, v117, v120, int32(2), int32(10), v119, v120, v119, v119)
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L20
...
L45:
	;
	v138 = v135 - v129
	v140 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v138)+uint32(_consts[1234]))))
	if v140 != 0 {
		v170 = v130
		goto L46
	} else {
...
L47:
	;
	v142 = *(*int32)(unsafe.Add(mBase, _consts[1232]))
	if v142 == int32(0) {
		v170 = v130
		goto L46
	} else {
...
L58:
	...
	v179 = int32(0)
	v180 = int32(1)
	v187 = F_set_config_with_handle(m, int32(335840), v179, v177, v180, int32(2), int32(10), v179, v180, v179, v179)
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L20
...
L60:
	...
	v191 = v189 - int32(16)
	m.G0 = v191
	v194 = *(*int32)(unsafe.Add(mBase, _consts[1235]))
	if v194 == int32(0) {
		goto L62
	} else {
		goto L63
...
L70:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _consts[159]))
	if v214 != int32(52) {
		v251 = v210
		goto L69
	} else {
...
L90:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1235])) = v266
	v268 = v266
	goto L64
L91:
	;
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v282
	v284 = int32(16)
	v288 = F_pg_snprintf(m, v7+v284, v284, int32(488382), v7)
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L20
...
L100:
	;
	v299 = int32(0)
	v303 = F_set_config_with_handle(m, int32(320536), int32(0), v7+int32(16), v294, v297, int32(10), v299, int32(1), v299, v299)
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L20
...
func F_MarkGUCPrefixReserved(m *base.Module, l0 int32) {
	...
	v10 = F_strlen(m, l0)
	mBase = m.M
	v14 = *(*int32)(unsafe.Add(mBase, _consts[1228]))
...
L6:
	...
	v163 = *(*int32)(unsafe.Add(mBase, _consts[1237]))
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v163
	v166 = *(*int32)(unsafe.Add(mBase, _consts[1236]))
	v167 = F_pstrdup(m, l0)
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
...
L30:
	;
	v105 = *(*int32)(unsafe.Add(mBase, _consts[1228]))
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v88
	F_errmsg(m, int32(104158), v8+int32(16))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(499912), int32(5314), int32(440318))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L1
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1236])) = v169
	m.G0 = v8 + int32(48)
	return
}
