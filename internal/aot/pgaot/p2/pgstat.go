...
func F_pgstat_bestart_final(m *base.Module) {
	...
	var v130 int32
	_ = v130
	v5 = *(*int32)(unsafe.Add(mBase, _consts[26]))
	...
	if base.Ui32(int32(6)) < base.Ui32(v8) {
		...
		if int32(1)<<(uint(v8)%32)&int32(98) == v11 {
			...
			v19 = *(*int32)(unsafe.Add(mBase, _consts[1007]))
			v20 = v19
		}
	}
	v21 = int32(4510260)
	...
	*(*int32)(unsafe.Add(mBase, _consts[7])) = v43 - v24
	...
	if int32(base.Ui32(int32(115186))>>(uint(v48)%32))&base.B2i32(base.Ui32(v48) < base.Ui32(int32(17))) != 0 {
		v55 = int32(0)
		v57 = int64(*(*int32)(unsafe.Add(mBase, _consts[747])))
		...
		if v60 != 0 {
			...
			if v69 != 0 {
				...
				v74 = F__emscripten_memset_bulkmem(m, int32(4492280), base.I32_extend8_s(int32(0)), int32(2880))
				mBase = m.M
				v77 = *(*int64)(unsafe.Add(mBase, _consts[47]))
				*(*int64)(unsafe.Add(mBase, _consts[1008])) = v77
				v81 = *(*int64)(unsafe.Add(mBase, _consts[45]))
				*(*int64)(unsafe.Add(mBase, _consts[1009])) = v81
				v85 = *(*int64)(unsafe.Add(mBase, _consts[43]))
				*(*int64)(unsafe.Add(mBase, _consts[1010])) = v85
				v89 = *(*int64)(unsafe.Add(mBase, _consts[41]))
				*(*int64)(unsafe.Add(mBase, _consts[1011])) = v89
				v92 = int32(0)
				*(*uint8)(unsafe.Add(mBase, _consts[249])) = uint8(v92)
				v96 = *(*int32)(unsafe.Add(mBase, _consts[691]))
				if v96 == int32(0) {
					return
				} else {
					v100 = *(*int32)(unsafe.Add(mBase, _consts[26]))
					if v100 == int32(0) {
						return
					} else {
						v103 = F_strlen(m, v96)
						...
						if v106 != 0 {
							...
							v107 = int32(4510260)
							v109 = *(*int32)(unsafe.Add(mBase, _consts[7]))
							v110 = int32(1)
							*(*int32)(unsafe.Add(mBase, _consts[7])) = v109 + v110
							...
							*(*int32)(unsafe.Add(mBase, _consts[7])) = v130 - v125
							return
						}
					}
				}
...
func F_pgstat_checkpointer_snapshot_cb(m *base.Module) {
	...
	var v110 int64
	_ = v110
	v16 = *(*int32)(unsafe.Add(mBase, _consts[1013]))
	goto L1
L1:
	;
...
L9:
	;
	v40 = F__emscripten_memcpy_bulkmem(m, int32(4439704), v16+int32(432), int32(88))
	mBase = m.M
	goto L11
L11:
	;
...
L15:
	;
	v63 = int32(4439704)
	v65 = *(*int64)(unsafe.Add(mBase, _consts[1036]))
	*(*int64)(unsafe.Add(mBase, _consts[1036])) = v65 - v60
	v68 = int32(4439712)
	v70 = *(*int64)(unsafe.Add(mBase, _consts[1037]))
	*(*int64)(unsafe.Add(mBase, _consts[1037])) = v70 - v59
	v73 = int32(4439720)
	v75 = *(*int64)(unsafe.Add(mBase, _consts[1038]))
	*(*int64)(unsafe.Add(mBase, _consts[1038])) = v75 - v58
	v78 = int32(4439728)
	v80 = *(*int64)(unsafe.Add(mBase, _consts[1039]))
	*(*int64)(unsafe.Add(mBase, _consts[1039])) = v80 - v57
	v83 = int32(4439736)
	v85 = *(*int64)(unsafe.Add(mBase, _consts[1040]))
	*(*int64)(unsafe.Add(mBase, _consts[1040])) = v85 - v56
	v88 = int32(4439744)
	v90 = *(*int64)(unsafe.Add(mBase, _consts[1041]))
	*(*int64)(unsafe.Add(mBase, _consts[1041])) = v90 - v55
	v93 = int32(4439752)
	v95 = *(*int64)(unsafe.Add(mBase, _consts[1042]))
	*(*int64)(unsafe.Add(mBase, _consts[1042])) = v95 - v54
	v98 = int32(4439760)
	v100 = *(*int64)(unsafe.Add(mBase, _consts[1043]))
	*(*int64)(unsafe.Add(mBase, _consts[1043])) = v100 - v53
	v103 = int32(4439768)
	v105 = *(*int64)(unsafe.Add(mBase, _consts[1044]))
	*(*int64)(unsafe.Add(mBase, _consts[1044])) = v105 - v52
	v108 = int32(4439776)
	v110 = *(*int64)(unsafe.Add(mBase, _consts[1045]))
	*(*int64)(unsafe.Add(mBase, _consts[1045])) = v110 - v51
	return
}
...
func F_pgstat_count_slru_page_hit(m *base.Module, l0 int32) {
	...
	_ = v12
	v3 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[245])) = uint8(v3)
	*(*uint8)(unsafe.Add(mBase, _consts[1056])) = uint8(v3)
	v9 = l0 << (uint(int32(6)) % 32)
	v12 = *(*int64)(unsafe.Add(mBase, uint32(v9)+uint32(_consts[1057])))
	*(*int64)(unsafe.Add(mBase, uint32(v9)+uint32(_consts[1057]))) = v12 + int64(1)
	return
}
			...
			if v17 != 0 {
				...
				if v16 != 0 {
					if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
						v46 = l0*int32(72) + int32(1651040)
					} else {
						if base.Ui32(int32(8)) < base.Ui32(l0-int32(24)) {
							v44 = int32(0)
						} else {
							v32 = int32(0)
							v34 = *(*int32)(unsafe.Add(mBase, _consts[1012]))
							if v34 == v32 {
								v44 = v32
							} else {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v47
					F_errmsg(m, int32(37817), v8)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return
					} else {
						F_errfinish(m, int32(493722), int32(368), int32(313172))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return
...
func F_pgstat_drop_all_entries(m *base.Module) {
	...
	m.G0 = v12
	v15 = v10 + int32(-44)
	v17 = *(*int32)(unsafe.Add(mBase, _consts[1047]))
	v18 = int32(1)
...
L12:
	;
	v50 = *(*int32)(unsafe.Add(mBase, _consts[1046]))
	if v50 == int32(0) {
		goto L15
	} else {
		goto L16
...
L50:
	;
	v233 = *(*int32)(unsafe.Add(mBase, _consts[1013]))
...
func F_pgstat_drop_entry(m *base.Module, l0 int32, l1 int32, l2 int64) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = l0
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1046]))
	if v22 == int32(0) {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v182 = int32(1)
	v184 = *(*int32)(unsafe.Add(mBase, _consts[1047]))
...
L35:
	...
	v200 = *(*int32)(unsafe.Add(mBase, _consts[1046]))
	if v200 == int32(0) {
		goto L36
	} else {
		goto L37
...
L36:
	;
	v319 = v16 + int32(52)
	v321 = *(*int32)(unsafe.Add(mBase, _consts[1047]))
	v322 = int32(1)
	v323 = int64(0)
...
L52:
	;
	v304 = *(*int32)(unsafe.Add(mBase, _consts[1046]))
	v247 = v304
	v248 = v285
	v253 = v282
	goto L44
...
L70:
	;
	v379 = *(*int32)(unsafe.Add(mBase, _consts[1013]))
...
func F_pgstat_end_function_usage(m *base.Module, l0 int32, l1 int32) {
	...
	if v13 != 0 {
		...
		mBase = m.M
		v16 = int32(4495376)
		v17 = *(*int64)(unsafe.Add(mBase, _consts[432]))
		...
		*(*int64)(unsafe.Add(mBase, _consts[432])) = v19 + v26
...
L8:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[1013]))
...
func F_pgstat_get_slru_index(m *base.Module, l0 int32) int32 {
	...
	v6 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1049])))
	if v6 == int32(0) {
		v25 = v5
		v26 = v6
		goto L2
...
L11:
	...
	v36 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1050])))
	if v36 == int32(0) {
		v55 = v35
		v56 = v36
		goto L13
...
L22:
	...
	v66 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1051])))
	if v66 == int32(0) {
		v85 = v65
		v86 = v66
		goto L24
...
L33:
	...
	v96 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1052])))
	if v96 == int32(0) {
		v115 = v95
		v116 = v96
		goto L35
...
L44:
	...
	v126 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1053])))
	if v126 == int32(0) {
		v145 = v125
		v146 = v126
		goto L46
...
L55:
	...
	v156 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1054])))
	if v156 == int32(0) {
		v175 = v155
		v176 = v156
		goto L57
...
L66:
	...
	v188 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1055])))
	if v188 == int32(0) {
		v207 = v187
		v208 = v188
		goto L68
...
func F_pgstat_io_reset_all_cb(m *base.Module, l0 int64) {
	...
	var v50 int32
	_ = v50
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1013]))
	v8 = v6 + int32(608)
...
L2:
	;
	v13 = *(*int32)(unsafe.Add(mBase, _consts[1013]))
...
L5:
	;
	v29 = *(*int32)(unsafe.Add(mBase, _consts[1013]))
...
func F_pgstat_progress_start_command(m *base.Module, l0 int32, l1 int32) {
	...
	if v5 == int32(0) {
		...
		v9 = int32(*(*uint8)(unsafe.Add(mBase, _consts[28])))
		if v9 != int32(1) {
		} else {
			v12 = int32(4510260)
...
func F_pgstat_report_checkpointer(m *base.Module) {
	...
	var v141 int32
	_ = v141
	v3 = *(*int32)(unsafe.Add(mBase, _consts[1013]))
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1014]))
	v7 = *(*int32)(unsafe.Add(mBase, _consts[1015]))
	v9 = *(*int32)(unsafe.Add(mBase, _consts[1016]))
	v11 = *(*int32)(unsafe.Add(mBase, _consts[1017]))
	v13 = *(*int32)(unsafe.Add(mBase, _consts[1018]))
	v15 = *(*int32)(unsafe.Add(mBase, _consts[1019]))
	v17 = *(*int32)(unsafe.Add(mBase, _consts[1020]))
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1021]))
	if v5|(v7|(v9|(v11|(v13|(v15|(v17|v19)))))) != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[7])) = v130 - v67
		...
		v28 = *(*int32)(unsafe.Add(mBase, _consts[1028]))
		v30 = *(*int32)(unsafe.Add(mBase, _consts[1025]))
		v32 = *(*int32)(unsafe.Add(mBase, _consts[1029]))
		v34 = *(*int32)(unsafe.Add(mBase, _consts[1024]))
		v36 = *(*int32)(unsafe.Add(mBase, _consts[1030]))
		v38 = *(*int32)(unsafe.Add(mBase, _consts[1023]))
		v40 = *(*int32)(unsafe.Add(mBase, _consts[1031]))
		v42 = *(*int32)(unsafe.Add(mBase, _consts[1022]))
		if v28|(v30|(v32|(v34|(v36|(v38|(v40|v42)))))) != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[7])) = v130 - v67
			...
			v51 = *(*int32)(unsafe.Add(mBase, _consts[1026]))
			if v51 != 0 {
				v64 = int32(4510260)
				v66 = *(*int32)(unsafe.Add(mBase, _consts[7]))
				v67 = int32(1)
				...
				*(*int32)(unsafe.Add(mBase, _consts[7])) = v130 - v67
				...
				v53 = *(*int32)(unsafe.Add(mBase, _consts[1032]))
				if v53 != 0 {
					v64 = int32(4510260)
					v66 = *(*int32)(unsafe.Add(mBase, _consts[7]))
					v67 = int32(1)
					...
					*(*int32)(unsafe.Add(mBase, _consts[7])) = v130 - v67
					...
					v55 = *(*int32)(unsafe.Add(mBase, _consts[1027]))
					if v55 != 0 {
						v64 = int32(4510260)
						v66 = *(*int32)(unsafe.Add(mBase, _consts[7]))
						v67 = int32(1)
						...
						*(*int32)(unsafe.Add(mBase, _consts[7])) = v130 - v67
						...
						v57 = *(*int32)(unsafe.Add(mBase, _consts[1033]))
						if v57 != 0 {
							v64 = int32(4510260)
							v66 = *(*int32)(unsafe.Add(mBase, _consts[7]))
							v67 = int32(1)
							...
							*(*int32)(unsafe.Add(mBase, _consts[7])) = v130 - v67
							...
							v59 = *(*int32)(unsafe.Add(mBase, _consts[1034]))
							if v59 != 0 {
								v64 = int32(4510260)
								v66 = *(*int32)(unsafe.Add(mBase, _consts[7]))
								v67 = int32(1)
								...
								*(*int32)(unsafe.Add(mBase, _consts[7])) = v130 - v67
								...
								v61 = *(*int32)(unsafe.Add(mBase, _consts[1035]))
								if v61 == int32(0) {
									return
								} else {
									v64 = int32(4510260)
...
func F_pgstat_reset_matching_entries(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	m.G0 = v11
	v14 = v11 + int32(4)
	v16 = *(*int32)(unsafe.Add(mBase, _consts[1047]))
	v18 = int64(0)
...
L12:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _consts[1048]))
...
L16:
	;
	v82 = v53*int32(72) + int32(1651040)
	goto L15
L17:
	;
	goto L18
...
L20:
	;
	v68 = int32(0)
	v70 = *(*int32)(unsafe.Add(mBase, _consts[1012]))
	if v70 == v68 {
		v80 = v68
		goto L19
	} else {
...
L23:
	;
	v111 = v53*int32(72) + int32(1651040)
	goto L22
L24:
	;
	goto L25
...
L27:
	;
	v97 = int32(0)
	v99 = *(*int32)(unsafe.Add(mBase, _consts[1012]))
	if v99 == v97 {
		v109 = v97
		goto L26
	} else {
...
L30:
	;
	v143 = v53*int32(72) + int32(1651040)
	goto L29
L31:
	;
	goto L32
...
L34:
	;
	v129 = int32(0)
	v131 = *(*int32)(unsafe.Add(mBase, _consts[1012]))
	if v131 == v129 {
		v141 = v129
		goto L33
	} else {
...
func F_pgstat_reset_of_kind(m *base.Module, l0 int32) {
	...
	_ = v56
	if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
		v29 = l0*int32(72) + int32(1651040)
	} else {
		if base.Ui32(int32(8)) < base.Ui32(l0-int32(24)) {
			v29 = int32(0)
		} else {
			v17 = int32(0)
			v19 = *(*int32)(unsafe.Add(mBase, _consts[1012]))
			if v19 == v17 {
				v29 = v17
			} else {
...
L59:
	;
	F_errfinish(m, int32(326866), int32(327), int32(341266))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L23
...
L114:
	;
	F_errfinish(m, int32(326866), int32(630), int32(311841))
	mBase = m.M
	v698 = m.ExcPending
	if v698 != 0 {
		goto L23
...
func F_pgstat_wal_init_backend_cb(m *base.Module) {
	...
	var v15 int64
	_ = v15
	v3 = *(*int64)(unsafe.Add(mBase, _consts[47]))
	*(*int64)(unsafe.Add(mBase, _consts[1058])) = v3
	v7 = *(*int64)(unsafe.Add(mBase, _consts[41]))
	*(*int64)(unsafe.Add(mBase, _consts[1059])) = v7
	v11 = *(*int64)(unsafe.Add(mBase, _consts[43]))
	*(*int64)(unsafe.Add(mBase, _consts[1060])) = v11
	v15 = *(*int64)(unsafe.Add(mBase, _consts[45]))
	*(*int64)(unsafe.Add(mBase, _consts[1061])) = v15
	return
}
