...
func F_pgstat_bestart_final(m *base.Module) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[7])) = v43 - v24
	...
	if int32(base.Ui32(int32(115186))>>(uint(v48)%32))&base.B2i32(base.Ui32(v48) < base.Ui32(int32(17))) != 0 {
		v55 = int32(0)
		v57 = int64(*(*int32)(unsafe.Add(mBase, _consts[746])))
		...
		if v60 != 0 {
			...
			if v69 != 0 {
				...
				v74 = F__emscripten_memset_bulkmem(m, int32(4496952), base.I32_extend8_s(int32(0)), int32(2880))
				mBase = m.M
				...
				*(*int64)(unsafe.Add(mBase, _consts[1011])) = v89
				v92 = int32(0)
				*(*uint8)(unsafe.Add(mBase, _consts[248])) = uint8(v92)
				v96 = *(*int32)(unsafe.Add(mBase, _consts[690]))
				if v96 == int32(0) {
					return
				} else {
...
L9:
	;
	v40 = F__emscripten_memcpy_bulkmem(m, int32(4444376), v16+int32(432), int32(88))
	mBase = m.M
	goto L11
L11:
	;
...
func F_pgstat_count_slru_page_hit(m *base.Module, l0 int32) {
	...
	_ = v12
	v3 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[244])) = uint8(v3)
			...
			if v17 != 0 {
				...
				if v16 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v47
					F_errmsg(m, int32(38041), v8)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return
					} else {
						F_errfinish(m, int32(494607), int32(368), int32(313739))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return
...
func F_pgstat_end_function_usage(m *base.Module, l0 int32, l1 int32) {
	...
	if v13 != 0 {
		...
		mBase = m.M
		v16 = int32(4500048)
		v17 = *(*int64)(unsafe.Add(mBase, _consts[431]))
		...
		*(*int64)(unsafe.Add(mBase, _consts[431])) = v19 + v26
...
L16:
	;
	v82 = v53*int32(72) + int32(1655136)
	goto L15
L17:
	;
	goto L18
...
L23:
	;
	v111 = v53*int32(72) + int32(1655136)
	goto L22
L24:
	;
	goto L25
...
L30:
	;
	v143 = v53*int32(72) + int32(1655136)
	goto L29
L31:
	;
	goto L32
...
L59:
	;
	F_errfinish(m, int32(327433), int32(327), int32(341838))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L23
...
L114:
	;
	F_errfinish(m, int32(327433), int32(630), int32(312408))
	mBase = m.M
	v698 = m.ExcPending
	if v698 != 0 {
		goto L23
