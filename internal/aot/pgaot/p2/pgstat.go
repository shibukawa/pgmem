...
L11:
	;
	v74 = F__emscripten_memset_bulkmem(m, int32(4419672), base.I32_extend8_s(int32(0)), int32(2880))
	mBase = m.M
	goto L12
L12:
	;
...
L9:
	;
	v40 = F__emscripten_memcpy_bulkmem(m, int32(4367096), v16+int32(432), int32(88))
	mBase = m.M
	goto L11
L11:
	;
			...
			if v17 != 0 {
				...
				if v16 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v47
					F_errmsg(m, int32(35347), v8)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return
					} else {
						F_errfinish(m, int32(470649), int32(368), int32(297606))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return
...
L16:
	;
	v82 = v53*int32(72) + int32(1610080)
	goto L15
L17:
	;
	goto L18
...
L23:
	;
	v111 = v53*int32(72) + int32(1610080)
	goto L22
L24:
	;
	goto L25
...
L30:
	;
	v143 = v53*int32(72) + int32(1610080)
	goto L29
L31:
	;
	goto L32
...
L59:
	;
	F_errfinish(m, int32(310477), int32(327), int32(324303))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L23
...
L114:
	;
	F_errfinish(m, int32(310477), int32(630), int32(296275))
	mBase = m.M
	v698 = m.ExcPending
	if v698 != 0 {
		goto L23
