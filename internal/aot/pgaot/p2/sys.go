...
func F_GetSysCacheHashValue(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(84)) {
		v18 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1184])))
		if v18 != 0 {
			v35 = m.G0
			v37 = v35 - int32(16)
			m.G0 = v37
					...
					default:
						...
						if v79 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v37))) = v44
							F_errmsg_internal(m, int32(491960), v37)
							mBase = m.M
							v83 = m.ExcPending
							if v83 != 0 {
								return int32(0)
			...
			if v25 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
				...
				if v29 != 0 {
					...
					F_errfinish(m, int32(511205), int32(669), int32(355481))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return int32(0)
...
func F_SearchSysCache3(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v15 int32
	_ = v15
	v9 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1184])))
