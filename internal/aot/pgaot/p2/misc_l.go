...
L7:
	;
	v35 = *(*int32)(unsafe.Add(mBase, uint32(v22<<(uint(int32(2))%32))+uint32(_consts[101])))
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+104)) = l1
	v43 = int32(0)
	v45 = *(*int32)(unsafe.Add(mBase, _consts[102]))
...
L10:
	;
	v81 = *(*int32)(unsafe.Add(mBase, _consts[262]))
	if l2 != 0 {
		goto L21
	} else {
		goto L22
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v67
	F_errmsg_internal(m, int32(192471), v20+int32(32))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L11
...
L19:
	;
	F_errfinish(m, int32(498091), int32(2111), int32(361868))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L11
...
L46:
	;
	v170 = *(*int32)(unsafe.Add(mBase, _consts[189]))
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v187)+uint32(_consts[807]))) = v177
	v197 = *(*int32)(unsafe.Add(mBase, _consts[189]))
...
L49:
	;
	v272 = *(*int32)(unsafe.Add(mBase, _consts[189]))
...
L54:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v230))) = v231 & (v238 ^ int64(-1))
	v247 = *(*int32)(unsafe.Add(mBase, _consts[189]))
	v249 = v247
	v250 = int32(1)
	v252 = v234
	goto L50
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+64)) = v322
	F_errmsg_internal(m, int32(192471), v20-int32(-64))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L11
...
L65:
	;
	F_errfinish(m, int32(498091), int32(2150), int32(361868))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L11
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+80)) = v339
	v346 = *(*int32)(unsafe.Add(mBase, _consts[189]))
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+48)) = v378
	F_errmsg_internal(m, int32(192471), v20+int32(48))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L11
...
L79:
	;
	F_errfinish(m, int32(498091), int32(2246), int32(361868))
	mBase = m.M
	v389 = m.ExcPending
	if v389 != 0 {
		goto L11
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v22
	F_errmsg_internal(m, int32(487504), v20)
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L11
...
L89:
	;
	F_errfinish(m, int32(498091), int32(2082), int32(361868))
	mBase = m.M
	v490 = m.ExcPending
	if v490 != 0 {
		goto L11
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = l1
	F_errmsg_internal(m, int32(487050), v20+int32(16))
	mBase = m.M
	v501 = m.ExcPending
	if v501 != 0 {
		goto L11
...
L92:
	;
	F_errfinish(m, int32(498091), int32(2085), int32(361868))
	mBase = m.M
	v506 = m.ExcPending
	if v506 != 0 {
		goto L11
...
L95:
	;
	F_errfinish(m, int32(498091), int32(2221), int32(361868))
	mBase = m.M
	v519 = m.ExcPending
	if v519 != 0 {
		goto L11
...
L98:
	;
	F_errfinish(m, int32(498091), int32(2231), int32(361868))
	mBase = m.M
	v532 = m.ExcPending
	if v532 != 0 {
		goto L11
...
func F_LruDelete(m *base.Module, l0 int32) {
	...
	m.G0 = v7
	v10 = l0 * int32(48)
	v12 = *(*int32)(unsafe.Add(mBase, _consts[266]))
	v13 = v10 + v12
	...
	if v16 != 0 {
		...
		if v18 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, _consts[756])) = v52 - int32(1)
			v57 = *(*int32)(unsafe.Add(mBase, _consts[266]))
			v58 = v57 + v10
			...
			if v35 != 0 {
				...
				if v34 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = v38
					F_errmsg_internal(m, int32(299662), v7)
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return
					} else {
						F_errfinish(m, int32(500178), int32(1313), int32(351718))
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return
...
func F_launcher_determine_sleep(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	m.G0 = v10
	if l0 == v4 {
		v70 = int64(*(*int32)(unsafe.Add(mBase, _consts[519])))
		*(*int32)(unsafe.Add(mBase, uint32(l2)+8)) = v4
		*(*int64)(unsafe.Add(mBase, uint32(l2))) = v70
		v73 = v4
		v75 = v70
	} else {
		v15 = *(*int32)(unsafe.Add(mBase, _consts[520]))
		if v15 == int32(0) {
			v70 = int64(*(*int32)(unsafe.Add(mBase, _consts[519])))
			*(*int32)(unsafe.Add(mBase, uint32(l2)+8)) = v4
			*(*int64)(unsafe.Add(mBase, uint32(l2))) = v70
			...
			if v15 == int32(4121632) {
				...
				*(*int64)(unsafe.Add(mBase, uint32(l2))) = v70
				...
				m.G0 = v25 + v24
				v39 = *(*int32)(unsafe.Add(mBase, _consts[521]))
				v40 = int32(12)
...
L5:
	;
	v25 = *(*int32)(unsafe.Add(mBase, _consts[302]))
	if v25 != 0 {
		goto L6
	} else {
		goto L7
...
L7:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+160)) = int64(601295421576)
	v34 = F_hash_create(m, int32(399608), int32(256), v12+int32(144), int32(40))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L3
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, _consts[302])) = v34
...
L36:
	;
	v127 = *(*int32)(unsafe.Add(mBase, _consts[302]))
...
L71:
	;
	F_sub_var(m, v11+int32(72), int32(1737832), l1)
	mBase = m.M
	v483 = m.ExcPending
	if v483 != 0 {
		goto L7
...
L121:
	;
	F_mul_var(m, v11, int32(1737880), v11, int32(0))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L7
...
L125:
	;
	F_add_var(m, v11+int32(72), int32(1737832), v11+int32(24))
	mBase = m.M
	v490 = m.ExcPending
	if v490 != 0 {
		goto L7
...
L170:
	;
	F_errfinish(m, int32(500458), int32(11130), int32(229557))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L7
...
L174:
	;
	F_errfinish(m, int32(500458), int32(11126), int32(229557))
	mBase = m.M
	v647 = m.ExcPending
	if v647 != 0 {
		goto L7
...
L1:
	;
	v49 = F_AllocateFile(m, v19+int32(80), int32(230977))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L5
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+48)) = int32(100399)
	v29 = F_pg_snprintf(m, v19+int32(80), int32(1024), int32(177142), v19+int32(48))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L5
...
L4:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+68)) = int32(100399)
	v36 = *(*int32)(unsafe.Add(mBase, _consts[1177]))
	*(*int32)(unsafe.Add(mBase, uint32(v19)+64)) = v36
	v44 = F_pg_snprintf(m, v19+int32(80), int32(1024), int32(177111), v19-int32(-64))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L5
...
L31:
	;
	F_errfinish(m, int32(499667), int32(6529), int32(386833))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L5
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v133)+192)) = v306 + v307
	v311 = *(*int32)(unsafe.Add(mBase, _consts[405]))
	v316 = F_AllocSetContextCreateInternal(m, v311, int32(242173), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L5
...
L146:
	;
	F_errfinish(m, int32(499667), int32(6543), int32(386833))
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L5
...
L166:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v704 + int32(4)
	F_errmsg_internal(m, int32(700572), v19+int32(16))
	mBase = m.M
	v712 = m.ExcPending
	if v712 != 0 {
		goto L5
...
L167:
	;
	F_errfinish(m, int32(499667), int32(6556), int32(386833))
	mBase = m.M
	v717 = m.ExcPending
	if v717 != 0 {
		goto L5
...
L10:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+16)) = v124
	...
	v131 = *(*int64)(unsafe.Add(mBase, uint32(v40)+uint32(_consts[1245])))
	if int64(0) <= v131 {
		goto L29
	} else {
		goto L30
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+56)) = v137
	v139 = *(*int64)(unsafe.Add(mBase, uint32(v40)+uint32(_consts[1245])))
	if v139 < int64(0) {
		goto L32
	} else {
		goto L33
