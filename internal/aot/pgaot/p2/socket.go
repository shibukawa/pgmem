...
func F_socket_close(m *base.Module, l0 int32, l1 int32) {
	...
	var v6 int32
	_ = v6
	v4 = *(*int32)(unsafe.Add(mBase, _consts[472]))
	if v4 != 0 {
		v6 = *(*int32)(unsafe.Add(mBase, _consts[472]))
...
func F_socket_flush(m *base.Module) int32 {
	...
	_ = v43
	v1 = int32(0)
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _consts[478])))
	if v3 == v1 {
		v7 = int32(1)
		*(*uint8)(unsafe.Add(mBase, _consts[478])) = uint8(v7)
		v10 = *(*int32)(unsafe.Add(mBase, _consts[472]))
		if v10 == int32(0) {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v10)+4)) = uint8(v13)
			v16 = *(*int32)(unsafe.Add(mBase, _consts[476]))
			v19 = F_internal_flush_buffer(m, v16, int32(4348440), int32(4348444))
			mBase = m.M
			v22 = m.ExcPending
			if v22 != 0 {
				return int32(0)
				...
				v24 = int32(0)
				*(*uint8)(unsafe.Add(mBase, _consts[478])) = uint8(v24)
				v26 = v19
				return v26
			}
		}
...
func F_socket_putmessage(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v7)+15)) = uint8(v1)
	v12 = int32(*(*uint8)(unsafe.Add(mBase, _consts[478])))
	if v12 == v4 {
		v16 = int32(1)
		*(*uint8)(unsafe.Add(mBase, _consts[478])) = uint8(v16)
		...
		if v24 != 0 {
			...
			if v21 != 0 {
				v54 = int32(-1)
				v56 = int32(0)
				*(*uint8)(unsafe.Add(mBase, _consts[478])) = uint8(v56)
				v58 = v54
				m.G0 = v7 + int32(16)
				return v58
			} else {
