		...
		if v13 != 0 {
			...
			if v46 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v47 + int32(4)
				F_errmsg_internal(m, int32(_a_F_build_generation_expression_0), v9)
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_build_generation_expression_1), int32(_a_F_build_generation_expression_2), int32(_a_F_build_generation_expression_3))
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return int32(0)
