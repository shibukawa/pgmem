...
L53:
	...
	if v256 < v177 {
		v177 = v177 - v256
		v179 = v179 + (v258+int32(7))&int32(_a_F__ltree_consistent_0)
		goto L51
	} else {
		goto L61
	}
...
L58:
	...
	v227 = int32(1)
	if v227 < v198 {
		v197 = v197 + (v219+int32(7))&int32(_a_F__ltree_consistent_0) + int32(8)
		v198 = v198 - v227
		goto L56
	} else {
		goto L59
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+8)) = v51 + v311
	v320 = F_ltree_execute(m, v19+v311, v15+v311, int32(0), int32(_a_F__ltree_consistent_7))
	mBase = m.M
	v321 = m.ExcPending
	if v321 != 0 {
		goto L1
...
L76:
	...
	if v402 < v338 {
		v337 = v337 + (v404+int32(7))&int32(_a_F__ltree_consistent_0)
		v338 = v338 - v402
		goto L74
	} else {
		goto L83
...
L81:
	...
	v385 = int32(1)
	if v385 < v356 {
		v355 = v355 + (v377+int32(7))&int32(_a_F__ltree_consistent_0) + int32(8)
		v356 = v356 - v385
		goto L79
	} else {
		goto L82
...
func F__ltree_extract_isparent(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		if v19 != 0 {
			...
			v22 = F_array_iterator(m, v12, int32(_a_F__ltree_extract_isparent_0), v18, v9+int32(12))
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
				return int32(0)
...
func F__ltree_extract_risparent(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		if v19 != 0 {
			...
			v22 = F_array_iterator(m, v12, int32(_a_F__ltree_extract_risparent_0), v18, v9+int32(12))
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
				return int32(0)
...
L58:
	;
	v117 = int32(9)
	v119 = int32(_a_F_ltree_gist_alloc_0)
	v127 = int32(1)
	if v127 < v86 {
...
L31:
	;
	v930 = (v174 + int32(1)) & int32(_a_F_ltree_picksplit_0)
...
L61:
	;
	v274 = int32(9)
	v276 = int32(_a_F_ltree_picksplit_2)
	v284 = int32(1)
	if v284 < v243 {
...
L77:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v376))) = uint8(v382)
	...
	if base.Ui32(v378) < base.Ui32(v347) {
		v346 = v346 + (v384+int32(9))&int32(_a_F_ltree_picksplit_2)
		v347 = v347 - v378
		goto L75
	} else {
		goto L78
...
L121:
	;
	v633 = int32(9)
	v635 = int32(_a_F_ltree_picksplit_2)
	v643 = int32(1)
	if v643 < v602 {
...
L137:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v735))) = uint8(v741)
	...
	if base.Ui32(v737) < base.Ui32(v706) {
		v705 = v705 + (v743+int32(9))&int32(_a_F_ltree_picksplit_2)
		v706 = v706 - v737
		goto L135
	} else {
		goto L138
...
L172:
	;
	v1093 = *(*int32)(unsafe.Add(mBase, uint32(v80+v61<<(uint(int32(2))%32)&int32(_a_F_ltree_picksplit_3))+8))
