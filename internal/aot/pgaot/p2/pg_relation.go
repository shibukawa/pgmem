...
L8:
	...
	v28 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1073])))
	if v28 == int32(0) {
		v47 = v27
		v48 = v28
		goto L10
...
L26:
	...
	v86 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1075])))
	if v86 == int32(0) {
		v105 = v85
		v106 = v86
		goto L28
...
L35:
	...
	v115 = int32(*(*uint8)(unsafe.Add(mBase, _consts[985])))
	if v115 == int32(0) {
		v134 = v114
		v135 = v115
		goto L37
...
L46:
	;
	F_errmsg(m, int32(381920), int32(0))
	mBase = m.M
	v149 = m.ExcPending
	if v149 != 0 {
		goto L1
...
L47:
	;
	F_errhint(m, int32(663662), int32(0))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L48:
	;
	F_errfinish(m, int32(498280), int32(63), int32(228247))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
