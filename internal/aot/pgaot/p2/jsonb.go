		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				if v43 != 0 {
					...
					F_errfinish(m, int32(491074), int32(1025), int32(493779))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v176
	...
	v182 = F_pg_snprintf(m, v174, v178+int32(1), int32(202950), v10)
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L23
...
L65:
	;
	F_errfinish(m, int32(491074), int32(1612), int32(216702))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L23
...
L68:
	;
	F_errfinish(m, int32(491074), int32(1518), int32(216702))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L23
...
L72:
	;
	F_errfinish(m, int32(491074), int32(1530), int32(216702))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L23
...
L68:
	;
	F_errfinish(m, int32(485799), int32(4680), int32(345120))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
...
L27:
	;
	F_errsave_finish(m, v72, int32(491074), int32(284), int32(277754))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L22
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(482110))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
L13:
	;
	F_errfinish(m, int32(491074), int32(1304), int32(108533))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(491074), int32(1311), int32(108533))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L1
...
L22:
	;
	F_errfinish(m, int32(491074), int32(1317), int32(108533))
	mBase = m.M
	v82 = m.ExcPending
	if v82 != 0 {
		goto L1
...
L79:
	;
	F_errfinish(m, int32(491074), int32(1333), int32(108533))
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L1
...
func F_jsonb_populate_record_valid(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v5))) = v11
	v16 = F_populate_record_worker(m, l0, int32(413183), int32(0), int32(1), v5)
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		return int32(0)
...
func F_jsonb_put_escaped_value(m *base.Module, l0 int32, l1 int32) {
	...
	switch v3 {
	case 0:
		F_appendBinaryStringInfo(m, l0, int32(298338), int32(4))
		mBase = m.M
		v42 = m.ExcPending
		if v42 != 0 {
			return
	...
	case 3:
		...
		if v15 == int32(1) {
			F_appendBinaryStringInfo(m, l0, int32(338217), int32(4))
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return
			...
			F_appendBinaryStringInfo(m, l0, int32(355036), int32(5))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return
	...
	default:
		...
		if v29 != 0 {
			...
			F_errmsg_internal(m, int32(361934), int32(0))
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return
			} else {
				F_errfinish(m, int32(491074), int32(371), int32(339167))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
