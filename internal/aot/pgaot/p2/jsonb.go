		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				if v43 != 0 {
					...
					F_errfinish(m, int32(500222), int32(1025), int32(502981))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v176
	...
	v182 = F_pg_snprintf(m, v174, v178+int32(1), int32(206170), v10)
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L23
...
L65:
	;
	F_errfinish(m, int32(500222), int32(1612), int32(220148))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L23
...
L68:
	;
	F_errfinish(m, int32(500222), int32(1518), int32(220148))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L23
...
L72:
	;
	F_errfinish(m, int32(500222), int32(1530), int32(220148))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L23
...
L68:
	;
	F_errfinish(m, int32(494801), int32(4680), int32(351408))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
...
func F_jsonb_each_text(m *base.Module, l0 int32) int32 {
	var v7 int32
	_ = v7
	F_each_worker_jsonb(m, l0, int32(63194), int32(1))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
					...
					if v29 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(268435455)
						...
						if v34 != 0 {
							...
							F_errsave_finish(m, v16, int32(500222), int32(284), int32(282680))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int32(0)
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(491022))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
L13:
	;
	F_errfinish(m, int32(500222), int32(1304), int32(110587))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(500222), int32(1311), int32(110587))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L1
...
L22:
	;
	F_errfinish(m, int32(500222), int32(1317), int32(110587))
	mBase = m.M
	v82 = m.ExcPending
	if v82 != 0 {
		goto L1
...
L45:
	;
	F_errfinish(m, int32(500222), int32(1333), int32(110587))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L1
	...
	case 4:
		...
		if int32(126) <= v22 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v11))) = v284 ^ v276 - base.I32_rotl(v284, int32(24))
			v294 = F_pg_snprintf(m, v11+int32(22), int32(10), int32(29625), v11)
			mBase = m.M
			v297 = m.ExcPending
			if v297 != 0 {
				return int32(0)
...
func F_jsonb_populate_record_valid(m *base.Module, l0 int32) int32 {
	...
	v5 = v3 - int32(16)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1094]))
	*(*int32)(unsafe.Add(mBase, uint32(v5)+8)) = v8
	v11 = *(*int64)(unsafe.Add(mBase, _consts[1095]))
	*(*int64)(unsafe.Add(mBase, uint32(v5))) = v11
	v16 = F_populate_record_worker(m, l0, int32(420724), int32(0), int32(1), v5)
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		return int32(0)
...
func F_jsonb_put_escaped_value(m *base.Module, l0 int32, l1 int32) {
	...
	switch v3 {
	case 0:
		F_appendBinaryStringInfo(m, l0, int32(303555), int32(4))
		mBase = m.M
		v42 = m.ExcPending
		if v42 != 0 {
			return
	...
	case 3:
		...
		if v15 == int32(1) {
			F_appendBinaryStringInfo(m, l0, int32(344470), int32(4))
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return
			...
			F_appendBinaryStringInfo(m, l0, int32(361486), int32(5))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return
	...
	default:
		...
		if v29 != 0 {
			...
			F_errmsg_internal(m, int32(368507), int32(0))
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return
			} else {
				F_errfinish(m, int32(500222), int32(371), int32(345432))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
