...
L46:
	;
	v180 = *(*int32)(unsafe.Add(mBase, _c_F_RelationBuildRowSecurity[1]))
...
L2:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_RelationParseRelOptions[0]))
	if v19 == int32(0) {
		goto L4
	} else {
		goto L5
...
L4:
	;
	v22 = int32(_a_F_RelationParseRelOptions_0)
	v23 = *(*int32)(unsafe.Add(mBase, _c_F_RelationParseRelOptions[1]))
	v26 = *(*int32)(unsafe.Add(mBase, _c_F_RelationParseRelOptions[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_RelationParseRelOptions[1])) = v26
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_RelationParseRelOptions[0])) = v29
	*(*int32)(unsafe.Add(mBase, _c_F_RelationParseRelOptions[1])) = v23
	v69 = v29
	goto L6
L11:
	;
...
L12:
	;
	v53 = F__emscripten_memcpy_bulkmem(m, v44+(v29+int32(20)+v45<<(uint(int32(4))%32)), v44+int32(_a_F_RelationParseRelOptions_1), v43)
	mBase = m.M
	goto L14
L14:
	;
...
L18:
	;
	v80 = *(*int32)(unsafe.Add(mBase, _c_F_RelationParseRelOptions[2]))
...
L15:
	;
	v64 = F_pstrdup(m, int32(_a_F_buildRelationAliases_0))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L18
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v129
	F_errmsg(m, int32(_a_F_buildRelationAliases_2), v17)
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L18
...
L80:
	;
	v276 = int32(_a_F_relation_has_unique_index_ext_0)
	v277 = *(*int32)(unsafe.Add(mBase, _c_F_relation_has_unique_index_ext[0]))
	v279 = *(*int32)(unsafe.Add(mBase, uint32(l0)+280))
	*(*int32)(unsafe.Add(mBase, _c_F_relation_has_unique_index_ext[0])) = v279
	if l5 != 0 {
		goto L81
	} else {
		goto L82
...
L83:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_relation_has_unique_index_ext[0])) = v277
	v370 = v283
	goto L32
L84:
	;
