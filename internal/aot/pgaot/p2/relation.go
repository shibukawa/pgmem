				...
				if v20 != 0 {
					...
					if v23 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v24 + int32(4)
						F_errmsg(m, int32(447972), v7)
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return int32(0)
						} else {
							F_errhint(m, int32(645862), int32(0))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(493968), int32(760), int32(264133))
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return int32(0)
...
func F_RelationBuildRowSecurity(m *base.Module, l0 int32) {
	...
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(207699), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L1
...
L64:
	;
	F_errmsg_internal(m, int32(164746), int32(0))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L1
...
L65:
	;
	F_errfinish(m, int32(492363), int32(265), int32(11084))
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L1
...
L7:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26))) = v27
	v35 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1179])))
	if v35 == int32(0) {
		goto L10
	} else {
		goto L11
...
L12:
	;
	v39 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1180])))
	if v39 == int32(0) {
		goto L13
	} else {
		goto L14
...
L30:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = int32(100342)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v19
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
	v114 = F_pg_snprintf(m, v7+int32(16), int32(2048), int32(176976), v7)
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1168])) = v16
	goto L7
L9:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _consts[1168]))
	v25 = v20
	goto L8
L10:
	;
...
L11:
	;
	v22 = int32(4438872)
	*(*int32)(unsafe.Add(mBase, _consts[1167])) = v22
	v25 = v22
	goto L8
L12:
	;
...
L23:
	;
	v53 = int32(0)
	v55 = *(*int32)(unsafe.Add(mBase, _consts[1169]))
	if v55 == v53 {
		goto L27
	} else {
		goto L28
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1170])) = v91 + int32(1)
...
L29:
	;
	v75 = *(*int32)(unsafe.Add(mBase, _consts[1171]))
	v77 = *(*int32)(unsafe.Add(mBase, _consts[1170]))
	if v77 < v75 {
		v91 = v77
		v92 = v55
		goto L26
...
L30:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1171])) = int32(16)
	*(*int32)(unsafe.Add(mBase, _consts[1169])) = v65
...
L32:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1171])) = v75 << (uint(int32(1)) % 32)
	*(*int32)(unsafe.Add(mBase, _consts[1169])) = v81
	v90 = *(*int32)(unsafe.Add(mBase, _consts[1170]))
	v91 = v90
	v92 = v81
	goto L26
L33:
...
L2:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1166]))
	if v19 == int32(0) {
		goto L4
	} else {
		goto L5
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1166])) = v29
...
L11:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[1175]))
	if v39 == int32(0) {
		goto L3
	} else {
		goto L14
...
L12:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[1174]))
	if v32 == int32(0) {
		goto L4
	} else {
		goto L13
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v110 + int32(4)
	F_errmsg_internal(m, int32(405474), v13+int32(16))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L9
...
L33:
	;
	F_errfinish(m, int32(499180), int32(3890), int32(228008))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L9
...
L61:
	;
	F_errfinish(m, int32(499180), int32(3795), int32(228008))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L9
...
L64:
	;
	F_errmsg(m, int32(412618), int32(0))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L9
...
L65:
	;
	F_errfinish(m, int32(499180), int32(3805), int32(228008))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L9
...
L68:
	;
	F_errmsg(m, int32(412430), int32(0))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L9
...
L69:
	;
	F_errfinish(m, int32(499180), int32(3813), int32(228008))
	mBase = m.M
	v258 = m.ExcPending
	if v258 != 0 {
		goto L9
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v263
	F_errmsg_internal(m, int32(46154), v13)
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L9
...
L72:
	;
	F_errfinish(m, int32(499180), int32(3824), int32(228008))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L9
...
L41:
	;
	F_errfinish(m, int32(496288), int32(1252), int32(161328))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L18
					...
					if v23 != 0 {
						...
						if v15 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v25
							F_errmsg(m, int32(690893), v7+int32(16))
							mBase = m.M
							v45 = m.ExcPending
							if v45 != 0 {
								return
							} else {
								F_errfinish(m, int32(495381), int32(2527), int32(391978))
								mBase = m.M
								v50 = m.ExcPending
								if v50 != 0 {
									return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = v25
							F_errmsg(m, int32(533147), v7)
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return
							} else {
								F_errfinish(m, int32(495381), int32(2536), int32(391978))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return
