	...
	if v11 != 0 {
		...
		if v10 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v13
			F_errmsg(m, int32(_a_F_pa_switch_to_partial_serialize_0), v6)
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
				...
				if v22 != 0 {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(l0)+12)) = uint8(v23)
					...
					if v29 != 0 {
						...
						if l1 == int32(0) {
							v33 = *(*int32)(unsafe.Add(mBase, _c_F_pa_switch_to_partial_serialize[0]))
...
func F_pa_unlock_transaction(m *base.Module, l0 int32) {
	...
	var v8 int32
	_ = v8
	v3 = *(*int32)(unsafe.Add(mBase, _c_F_pa_unlock_transaction[0]))
