...
func F_pa_set_fileset_state(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(495805), int32(1508), int32(351862))
		mBase = m.M
		v10 = m.ExcPending
		if v10 != 0 {
			return
	...
	if v11 != 0 {
		...
		if v10 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v13
			F_errmsg(m, int32(389380), v6)
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
			} else {
				F_errfinish(m, int32(495805), int32(1223), int32(342415))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return
						...
						if l1 == int32(0) {
							...
							if v40 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v41))) = int32(1)
								if v42 != 0 {
									F_s_lock(m, v41, int32(495805), int32(1508), int32(351862))
									mBase = m.M
									v49 = m.ExcPending
									if v49 != 0 {
										return
