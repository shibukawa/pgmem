...
func F_ginBeginBAScan(m *base.Module, l0 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v10)+12)) = uint8(base.B2i32(v14 == int32(4121416)))
		...
		if v6 < int32(0) {
			...
			if v83 != 0 {
				...
				if v86 != 0 {
					...
					F_errmsg(m, int32(327904), int32(0))
					mBase = m.M
					v90 = m.ExcPending
					if v90 != 0 {
						return
					} else {
						F_errhint(m, int32(668403), int32(0))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return
						} else {
							F_errfinish(m, int32(497915), int32(45), int32(505695))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return
				...
				if v82 != 0 {
								...
								if v161 != 0 {
									...
									if v160 == int32(0) {
										...
										if v182 != 0 {
											...
											F_errmsg_internal(m, int32(407858), int32(0))
											mBase = m.M
											v186 = m.ExcPending
											if v186 != 0 {
												return
											} else {
												F_errfinish(m, int32(499593), int32(736), int32(84488))
												mBase = m.M
												v191 = m.ExcPending
												if v191 != 0 {
													return
					...
					if v169 != 0 {
						...
						if v173 != 0 {
							...
							F_errfinish(m, int32(499593), int32(731), int32(84488))
							mBase = m.M
							v178 = m.ExcPending
							if v178 != 0 {
								return
...
L52:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v265)+12)) = uint8(base.B2i32(v269 == int32(4121416)))
...
L72:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v410)+12)) = uint8(base.B2i32(v414 == int32(4121416)))
...
L209:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v96
	F_errmsg_internal(m, int32(487398), v18)
	mBase = m.M
	v817 = m.ExcPending
	if v817 != 0 {
		goto L5
...
L210:
	;
	F_errfinish(m, int32(499707), int32(650), int32(409241))
	mBase = m.M
	v822 = m.ExcPending
	if v822 != 0 {
		goto L5
			...
			if v48 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v49
				...
				if v53 != 0 {
					...
					F_errfinish(m, int32(496878), int32(166), int32(27323))
					mBase = m.M
					v58 = m.ExcPending
					if v58 != 0 {
						return int32(0)
	...
	if v2 <= int32(2) {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				F_errfinish(m, int32(492741), int32(307), int32(155553))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
