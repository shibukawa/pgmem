...
func F_ginBeginBAScan(m *base.Module, l0 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v10)+12)) = uint8(base.B2i32(v14 == int32(4046520)))
		...
		if v6 < int32(0) {
			...
			if v83 != 0 {
				...
				if v86 != 0 {
					...
					F_errmsg(m, int32(307248), int32(0))
					mBase = m.M
					v90 = m.ExcPending
					if v90 != 0 {
						return
					} else {
						F_errhint(m, int32(618403), int32(0))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return
						} else {
							F_errfinish(m, int32(467038), int32(45), int32(474157))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return
				...
				if v82 != 0 {
								...
								if v161 != 0 {
									...
									if v160 == int32(0) {
										...
										if v182 != 0 {
											...
											F_errmsg_internal(m, int32(383479), int32(0))
											mBase = m.M
											v186 = m.ExcPending
											if v186 != 0 {
												return
											} else {
												F_errfinish(m, int32(468643), int32(736), int32(79109))
												mBase = m.M
												v191 = m.ExcPending
												if v191 != 0 {
													return
					...
					if v169 != 0 {
						...
						if v173 != 0 {
							...
							F_errfinish(m, int32(468643), int32(731), int32(79109))
							mBase = m.M
							v178 = m.ExcPending
							if v178 != 0 {
								return
...
L33:
	...
	v158 = F_AllocSetContextCreateInternal(m, v153, int32(56650), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L6
...
L52:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v265)+12)) = uint8(base.B2i32(v269 == int32(4046520)))
...
L72:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v410)+12)) = uint8(base.B2i32(v414 == int32(4046520)))
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+52)) = v39
	...
	v51 = F_AllocSetContextCreateInternal(m, v46, int32(56776), v39, int32(8192), int32(8388608))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L5
...
L209:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v96
	F_errmsg_internal(m, int32(457719), v18)
	mBase = m.M
	v817 = m.ExcPending
	if v817 != 0 {
		goto L5
...
L210:
	;
	F_errfinish(m, int32(468757), int32(650), int32(384829))
	mBase = m.M
	v822 = m.ExcPending
	if v822 != 0 {
		goto L5
...
func F_gin_extract_tsvector_2args(m *base.Module, l0 int32) int32 {
	...
	if v2 <= int32(2) {
		...
		if v10 != 0 {
			...
			F_errmsg_internal(m, int32(112553), int32(0))
			mBase = m.M
			v14 = m.ExcPending
			if v14 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(462318), int32(307), int32(144254))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
