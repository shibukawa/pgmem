...
func F_ginBeginBAScan(m *base.Module, l0 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v10)+12)) = uint8(base.B2i32(v14 == int32(4163976)))
		...
		if v6 < int32(0) {
			...
			if v83 != 0 {
				...
				if v86 != 0 {
					...
					F_errmsg(m, int32(345260), int32(0))
					mBase = m.M
					v90 = m.ExcPending
					if v90 != 0 {
						return
					} else {
						F_errhint(m, int32(700318), int32(0))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return
						} else {
							F_errfinish(m, int32(523470), int32(45), int32(532256))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return
				...
				if v82 != 0 {
									...
									if v160 == int32(0) {
										...
										if v182 != 0 {
											...
											if v186 != 0 {
												...
												F_errfinish(m, int32(525180), int32(736), int32(90899))
												mBase = m.M
												v191 = m.ExcPending
												if v191 != 0 {
													return
					...
					if v169 != 0 {
						...
						if v173 != 0 {
							...
							F_errfinish(m, int32(525180), int32(731), int32(90899))
							mBase = m.M
							v178 = m.ExcPending
							if v178 != 0 {
								return
...
L52:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v251)+12)) = uint8(base.B2i32(v255 == int32(4163976)))
...
L72:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v396)+12)) = uint8(base.B2i32(v400 == int32(4163976)))
...
L209:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v96
	F_errmsg_internal(m, int32(511009), v18)
	mBase = m.M
	v817 = m.ExcPending
	if v817 != 0 {
		goto L5
...
L210:
	;
	F_errfinish(m, int32(525304), int32(650), int32(429626))
	mBase = m.M
	v822 = m.ExcPending
	if v822 != 0 {
		goto L5
			...
			if v48 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v49
				...
				if v53 != 0 {
					...
					F_errfinish(m, int32(522002), int32(166), int32(27954))
					mBase = m.M
					v58 = m.ExcPending
					if v58 != 0 {
						return int32(0)
	...
	if v2 <= int32(2) {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				F_errfinish(m, int32(516896), int32(307), int32(165710))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
										...
										if v311 != 0 {
											...
											if v317 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v15)+20)) = (v319<<(uint(v320)%32) - v318) & int32(65535)
												F_errdetail(m, int32(683604), v15+int32(16))
												mBase = m.M
												v333 = m.ExcPending
												if v333 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(519872), int32(214), int32(160524))
													mBase = m.M
													v340 = m.ExcPending
													if v340 != 0 {
														return int32(0)
									...
									if v53 != int32(131) {
										...
										if v344 != 0 {
											...
											if v347 != 0 {
												...
												F_errmsg(m, int32(428590), int32(0))
												mBase = m.M
												v353 = m.ExcPending
												if v353 != 0 {
													return int32(0)
													...
													*(*int32)(unsafe.Add(mBase, uint32(v15))) = v354
													F_errdetail(m, int32(537248), v15)
													mBase = m.M
													v361 = m.ExcPending
													if v361 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(519872), int32(223), int32(160524))
														mBase = m.M
														v368 = m.ExcPending
														if v368 != 0 {
															return int32(0)
												...
												if v62 != int32(1) {
													...
													if v372 != 0 {
														...
														if v378 != 0 {
															...
															F_errfinish(m, int32(519872), int32(229), int32(160524))
															mBase = m.M
															v385 = m.ExcPending
															if v385 != 0 {
																return int32(0)
				...
				if v288 != 0 {
					...
					if v291 != 0 {
						...
						if v297 != 0 {
							...
							F_errfinish(m, int32(519872), int32(188), int32(160524))
							mBase = m.M
							v304 = m.ExcPending
							if v304 != 0 {
								return int32(0)
...
L17:
	;
	v54 = F_cstring_to_text(m, int32(532020))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L1
...
L21:
	;
	v63 = F_cstring_to_text(m, int32(357664))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L1
...
L25:
	;
	v77 = F_cstring_to_text(m, int32(468986))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L1
...
L29:
	;
	v91 = F_cstring_to_text(m, int32(530519))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L1
...
L33:
	;
	v105 = F_cstring_to_text(m, int32(81755))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L1
...
L41:
	;
	v133 = F_cstring_to_text(m, int32(109340))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L1
...
L45:
	;
	v147 = F_cstring_to_text(m, int32(472217))
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L1
...
L59:
	;
	F_errfinish(m, int32(519872), int32(112), int32(254534))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L1
...
L64:
	;
	F_errfinish(m, int32(519872), int32(125), int32(254534))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L1
...
L67:
	;
	F_errfinish(m, int32(519872), int32(131), int32(254534))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L1
