...
L4:
	;
	v170 = int32(*(*uint8)(unsafe.Add(mBase, _consts[113])))
	if v170 == int32(1) {
		goto L59
	} else {
		goto L60
...
L10:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[38]))
	if v30 == v19 {
		goto L11
	} else {
		goto L12
...
L15:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _consts[40]))
	if v38 == int32(0) {
		v131 = int32(0)
		goto L14
	} else {
...
L17:
	;
	v100 = *(*int32)(unsafe.Add(mBase, _consts[41]))
	v102 = int32(0)
	v104 = v34 - int32(1)
	goto L37
L18:
...
L59:
	;
	v175 = *(*int32)(unsafe.Add(mBase, _consts[114]))
	v176 = *(*int32)(unsafe.Add(mBase, uint32(v175)+316))
	v178 = base.B2i32(v176 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _consts[113])) = uint8(v178)
	v180 = v178
	goto L61
L60:
	;
...
L66:
	;
	F_errmsg_internal(m, int32(167245), int32(0))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L55
...
L67:
	;
	F_errfinish(m, int32(523428), int32(1449), int32(93240))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L55
