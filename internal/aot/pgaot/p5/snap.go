...
L4:
	;
	v170 = int32(*(*uint8)(unsafe.Add(mBase, _consts[111])))
	if v170 == int32(1) {
		goto L59
	} else {
		goto L60
...
L59:
	;
	v175 = *(*int32)(unsafe.Add(mBase, _consts[112]))
	v176 = *(*int32)(unsafe.Add(mBase, uint32(v175)+316))
	v178 = base.B2i32(v176 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _consts[111])) = uint8(v178)
	v180 = v178
	goto L61
L60:
	;
...
L66:
	;
	F_errmsg_internal(m, int32(168157), int32(0))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L55
...
L67:
	;
	F_errfinish(m, int32(526165), int32(1449), int32(93435))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L55
