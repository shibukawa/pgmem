	...
	if v35 != 0 {
		...
		if v34 != 0 {
			...
			if v39 != 0 {
				...
				F_errfinish(m, int32(490049), int32(1198), int32(164311))
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+20)) = int32(491975)
				...
				if v31 != 0 {
					...
					if v19|base.B2i32(v33 <= v34) == v34 {
						...
						if v40 != 0 {
							...
							F_XLogRegisterData(m, int32(4101564), int32(1))
							mBase = m.M
							v44 = m.ExcPending
							if v44 != 0 {
								return
...
L25:
	;
	F_errfinish(m, int32(491168), int32(2393), int32(485424))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L9
