...
func F_UnlinkLockFiles(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v44
	v3 = int32(0)
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1222]))
	if v5 == v3 {
	} else {
	...
	*(*int32)(unsafe.Add(mBase, _consts[1222])) = int32(0)
	v31 = int32(*(*uint8)(unsafe.Add(mBase, _consts[812])))
	if v31 != 0 {
		v32 = int32(15)
	} else {
		v32 = int32(18)
	...
	if v35 != 0 {
		...
		if v34 != 0 {
			F_errmsg(m, int32(231715), int32(0))
			mBase = m.M
			v39 = m.ExcPending
			if v39 != 0 {
				return
			} else {
				F_errfinish(m, int32(470389), int32(1198), int32(155273))
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return
...
func F_UnlockBuffers(m *base.Module) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[635]))
	if v9 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v6)+28)) = int32(218082)
	*(*int32)(unsafe.Add(mBase, uint32(v6)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v6)+20)) = int32(472269)
...
L6:
	;
	v45 = int32(4062892)
	v46 = *(*int32)(unsafe.Add(mBase, _consts[606]))
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, _consts[606])) = v63
	goto L13
L15:
	;
	if int32(999) < v46 {
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, _consts[635])) = int32(0)
	goto L3
L26:
	;
				...
				if v31 != 0 {
					...
					if v19|base.B2i32(v33 <= v34) == v34 {
						...
						if v40 != 0 {
							...
							F_XLogRegisterData(m, int32(4062012), int32(1))
							mBase = m.M
							v44 = m.ExcPending
							if v44 != 0 {
								return
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v80
	F_errmsg_internal(m, int32(47328), v15)
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L9
...
L25:
	;
	F_errfinish(m, int32(471492), int32(2393), int32(466196))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L9
...
L61:
	;
	F_TupleDescInitEntry(m, v177, int32(1), int32(363284), int32(25), int32(-1), int32(0))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L9
...
L62:
	;
	F_TupleDescInitEntry(m, v177, int32(2), int32(312398), int32(25), int32(-1), int32(0))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L9
...
L63:
	;
	F_TupleDescInitEntry(m, v177, int32(3), int32(234450), int32(25), int32(-1), int32(0))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L9
