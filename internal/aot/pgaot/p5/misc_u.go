...
func F_UnlinkLockFiles(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v44
	v3 = int32(0)
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1218]))
	if v5 == v3 {
	} else {
	...
	*(*int32)(unsafe.Add(mBase, _consts[1218])) = int32(0)
	v31 = int32(*(*uint8)(unsafe.Add(mBase, _consts[810])))
	if v31 != 0 {
		v32 = int32(15)
	} else {
		v32 = int32(18)
	...
	if v35 != 0 {
		...
		if v34 != 0 {
			F_errmsg(m, int32(240546), int32(0))
			mBase = m.M
			v39 = m.ExcPending
			if v39 != 0 {
				return
			} else {
				F_errfinish(m, int32(485631), int32(1198), int32(162687))
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return
...
func F_UnlockBuffers(m *base.Module) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[633]))
	if v9 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v6)+28)) = int32(226116)
	*(*int32)(unsafe.Add(mBase, uint32(v6)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v6)+20)) = int32(487541)
...
L6:
	;
	v45 = int32(4089276)
	v46 = *(*int32)(unsafe.Add(mBase, _consts[604]))
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, _consts[604])) = v63
	goto L13
L15:
	;
	if int32(999) < v46 {
...
L23:
	...
	v71 = *(*int32)(unsafe.Add(mBase, _consts[72]))
	if v69 == v71 {
		goto L26
	} else {
		goto L27
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, _consts[633])) = int32(0)
	goto L3
L26:
	;
...
func F_UpdateFullPageWrites(m *base.Module) {
	...
	var v61 int32
	_ = v61
	v5 = int32(*(*uint8)(unsafe.Add(mBase, _consts[130])))
	v7 = *(*int32)(unsafe.Add(mBase, _consts[113]))
	v8 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v7)+160)))
	if v5 != v8 {
		v11 = int32(*(*uint8)(unsafe.Add(mBase, _consts[112])))
		if v11 == int32(1) {
		...
		v20 = int32(4465412)
		v22 = *(*int32)(unsafe.Add(mBase, _consts[13]))
		*(*int32)(unsafe.Add(mBase, _consts[13])) = v22 + int32(1)
		if v5 != 0 {
			...
			if v27 != 0 {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v7)+160)) = uint8(v28)
				...
				if v31 != 0 {
					...
					v33 = *(*int32)(unsafe.Add(mBase, _consts[14]))
					v34 = int32(0)
					if v19|base.B2i32(v33 <= v34) == v34 {
						...
						if v40 != 0 {
							...
							F_XLogRegisterData(m, int32(4088396), int32(1))
							mBase = m.M
							v44 = m.ExcPending
							if v44 != 0 {
								return
								...
								if v48 != 0 {
									...
									v50 = int32(*(*uint8)(unsafe.Add(mBase, _consts[130])))
									if v50 == int32(0) {
										F_WALInsertLockAcquireExclusive(m)
										mBase = m.M
										v54 = m.ExcPending
										if v54 != 0 {
											...
											*(*uint8)(unsafe.Add(mBase, uint32(v7)+160)) = uint8(v55)
											...
											if v58 != 0 {
												...
												v59 = int32(4465412)
												v61 = *(*int32)(unsafe.Add(mBase, _consts[13]))
												*(*int32)(unsafe.Add(mBase, _consts[13])) = v61 - int32(1)
												return
											}
										}
									} else {
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v80
	F_errmsg_internal(m, int32(49358), v15)
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L9
...
L25:
	;
	F_errfinish(m, int32(486750), int32(2393), int32(481087))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L9
...
L61:
	;
	F_TupleDescInitEntry(m, v177, int32(1), int32(376156), int32(25), int32(-1), int32(0))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L9
...
L62:
	;
	F_TupleDescInitEntry(m, v177, int32(2), int32(323731), int32(25), int32(-1), int32(0))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L9
...
L63:
	;
	F_TupleDescInitEntry(m, v177, int32(3), int32(243305), int32(25), int32(-1), int32(0))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L9
...
func F_unlink(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(int32(-4095)) <= base.Ui32(v4) {
		*(*int32)(unsafe.Add(mBase, _consts[86])) = int32(0) - v4
		v12 = int32(-1)
	} else {
		v12 = v4
	}
