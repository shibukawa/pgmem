...
func F_CheckForSerializableConflictIn(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v9 = v7 - int32(16)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _consts[777]))
	if v12 == int32(0) {
		m.G0 = v9 + int32(16)
		return
	} else {
		...
		if base.Ui32(v15) < base.Ui32(int32(12000)) {
			...
			if v19 == int32(116) {
				...
				if v22&int32(8) != 0 {
					...
					if v74 != 0 {
						...
						if v77 != 0 {
							...
							if v81 != 0 {
								...
								F_errdetail_internal(m, int32(657796), int32(0))
								mBase = m.M
								v85 = m.ExcPending
								if v85 != 0 {
									return
									...
									if v89 != 0 {
										...
										F_errfinish(m, int32(524510), int32(4349), int32(299899))
										mBase = m.M
										v94 = m.ExcPending
										if v94 != 0 {
											return
					...
					v26 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _consts[781])) = uint8(v26)
					if l1 != 0 {
...
func F_CheckForSerializableConflictOutNeeded(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v56
	v3 = int32(0)
	v6 = *(*int32)(unsafe.Add(mBase, _consts[777]))
	if v6 == v3 {
		v56 = v3
		return v56
	} else {
							...
							if v34 != 0 {
								...
								if v37 != 0 {
									...
									if v41 != 0 {
										...
										F_errdetail_internal(m, int32(657714), int32(0))
										mBase = m.M
										v45 = m.ExcPending
										if v45 != 0 {
											return int32(0)
											...
											if v49 != 0 {
												...
												F_errfinish(m, int32(524510), int32(4003), int32(485239))
												mBase = m.M
												v54 = m.ExcPending
												if v54 != 0 {
													return int32(0)
...
L63:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _consts[704]))
	*(*int32)(unsafe.Add(mBase, uint32(v12)+56)) = v258
	v261 = *(*int64)(unsafe.Add(mBase, _consts[705]))
...
L16:
	;
	F_errmsg(m, int32(270438), int32(0))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L10
...
L17:
	;
	F_errfinish(m, int32(523306), int32(940), int32(106457))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L10
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+32)) = l0
	F_errmsg_internal(m, int32(39961), v9+int32(32))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L1
...
L5:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[656]))
	v29 = v27 + int32(37)
	if int32(0) <= v29 {
		goto L8
	} else {
...
L6:
	;
	F_errfinish(m, int32(523418), int32(431), int32(233628))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L11:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[676]))
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v70
	F_errmsg(m, int32(233653), v9+int32(16))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
L23:
	;
	F_errfinish(m, int32(523418), int32(452), int32(233628))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L1
...
L29:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9))) = l0
	F_errmsg_internal(m, int32(39952), v9)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(523418), int32(461), int32(233628))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
