...
func F_CheckForSerializableConflictIn(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v9 = v7 - int32(16)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _consts[778]))
	if v12 == int32(0) {
		m.G0 = v9 + int32(16)
		return
	} else {
		...
		if base.Ui32(v15) < base.Ui32(int32(12000)) {
			...
			if v19 == int32(116) {
				...
				if v22&int32(8) != 0 {
					...
					if v74 != 0 {
						...
						if v77 != 0 {
							...
							if v81 != 0 {
								...
								F_errdetail_internal(m, int32(654763), int32(0))
								mBase = m.M
								v85 = m.ExcPending
								if v85 != 0 {
									return
									...
									if v89 != 0 {
										...
										F_errfinish(m, int32(522149), int32(4349), int32(298766))
										mBase = m.M
										v94 = m.ExcPending
										if v94 != 0 {
											return
					...
					v26 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _consts[782])) = uint8(v26)
					if l1 != 0 {
							...
							if v34 != 0 {
								...
								if v37 != 0 {
									...
									if v41 != 0 {
										...
										F_errdetail_internal(m, int32(654681), int32(0))
										mBase = m.M
										v45 = m.ExcPending
										if v45 != 0 {
											return int32(0)
											...
											if v49 != 0 {
												...
												F_errfinish(m, int32(522149), int32(4003), int32(483283))
												mBase = m.M
												v54 = m.ExcPending
												if v54 != 0 {
													return int32(0)
...
L20:
	;
	v62 = *(*int32)(unsafe.Add(mBase, _consts[49]))
	if v62 == int32(0) {
		goto L24
	} else {
		goto L25
...
L25:
	;
	v66 = int32(*(*uint8)(unsafe.Add(mBase, _consts[50])))
	if v66 != int32(1) {
		goto L24
	} else {
		goto L26
...
L26:
	...
	v72 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v71 + v72
	...
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v89 - v72
	goto L24
L27:
	;
	if l2 != 0 {
...
L43:
	;
	v131 = *(*int32)(unsafe.Add(mBase, _consts[102]))
...
L48:
	...
	v148 = *(*int32)(unsafe.Add(mBase, _consts[49]))
	if v148 == int32(0) {
		goto L52
	} else {
		goto L53
...
L53:
	;
	v152 = int32(*(*uint8)(unsafe.Add(mBase, _consts[50])))
	if v152 != int32(1) {
		goto L52
	} else {
		goto L54
...
L54:
	;
	v155 = int32(4548788)
	v157 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	v158 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v157 + v158
	...
	*(*int32)(unsafe.Add(mBase, uint32(v148))) = v169 + v158
	v175 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v175 - v158
	goto L52
L55:
	;
	v186 = v121 + int32(1)
	v190 = *(*int32)(unsafe.Add(mBase, _consts[49]))
	if v190 == int32(0) {
		goto L57
	} else {
		goto L58
...
L58:
	;
	v194 = int32(*(*uint8)(unsafe.Add(mBase, _consts[50])))
	if v194 != int32(1) {
		goto L57
	} else {
		goto L59
...
L59:
	;
	v197 = int32(4548788)
	v199 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	v200 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v199 + v200
	...
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v217 - v200
	goto L57
L60:
	;
	v229 = v121
...
L63:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _consts[705]))
	*(*int32)(unsafe.Add(mBase, uint32(v12)+56)) = v258
	v261 = *(*int64)(unsafe.Add(mBase, _consts[706]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+16)) = v263
	v274 = int32(0)
	v281 = *(*int32)(unsafe.Add(mBase, _consts[49]))
	if v281 == v274 {
		goto L67
	} else {
		goto L68
...
L69:
	;
	v287 = int32(*(*uint8)(unsafe.Add(mBase, _consts[50])))
...
L70:
	...
	v295 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v294 + v295
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v281))) = v428 + v429
	v432 = int32(4548788)
	v434 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v434 - v429
	goto L67
L72:
	;
	goto L74
...
L10:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[45]))
	if v32 != 0 {
		goto L13
	} else {
		goto L14
...
L15:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _consts[83]))
...
L26:
	;
	v74 = *(*int32)(unsafe.Add(mBase, _consts[84]))
...
L34:
	;
	F_errmsg(m, int32(269391), int32(0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L16
...
L35:
	;
	F_errfinish(m, int32(520945), int32(940), int32(106187))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L16
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+32)) = l0
	F_errmsg_internal(m, int32(39777), v9+int32(32))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L1
...
L5:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[657]))
	v29 = v27 + int32(37)
	if int32(0) <= v29 {
		goto L8
	} else {
...
L6:
	;
	F_errfinish(m, int32(521057), int32(431), int32(232771))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L11:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[677]))
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v70
	F_errmsg(m, int32(232796), v9+int32(16))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
L23:
	;
	F_errfinish(m, int32(521057), int32(452), int32(232771))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L1
...
L29:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9))) = l0
	F_errmsg_internal(m, int32(39768), v9)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(521057), int32(461), int32(232771))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
