...
func F_CheckForSerializableConflictIn(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v9 = v7 - int32(16)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _consts[779]))
	if v12 == int32(0) {
		m.G0 = v9 + int32(16)
		return
	} else {
		...
		if base.Ui32(v15) < base.Ui32(int32(12000)) {
			...
			if v19 == int32(116) {
				...
				if v22&int32(8) != 0 {
					...
					if v74 != 0 {
						...
						if v77 != 0 {
							...
							if v81 != 0 {
								...
								F_errdetail_internal(m, int32(654094), int32(0))
								mBase = m.M
								v85 = m.ExcPending
								if v85 != 0 {
									return
									...
									if v89 != 0 {
										...
										F_errfinish(m, int32(521480), int32(4349), int32(298301))
										mBase = m.M
										v94 = m.ExcPending
										if v94 != 0 {
											return
					...
					v26 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _consts[783])) = uint8(v26)
					if l1 != 0 {
...
func F_CheckForSerializableConflictOutNeeded(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v56
	v3 = int32(0)
	v6 = *(*int32)(unsafe.Add(mBase, _consts[779]))
	if v6 == v3 {
		v56 = v3
		return v56
	} else {
							...
							if v34 != 0 {
								...
								if v37 != 0 {
									...
									if v41 != 0 {
										...
										F_errdetail_internal(m, int32(654012), int32(0))
										mBase = m.M
										v45 = m.ExcPending
										if v45 != 0 {
											return int32(0)
											...
											if v49 != 0 {
												...
												F_errfinish(m, int32(521480), int32(4003), int32(482637))
												mBase = m.M
												v54 = m.ExcPending
												if v54 != 0 {
													return int32(0)
...
L63:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _consts[706]))
	*(*int32)(unsafe.Add(mBase, uint32(v12)+56)) = v258
	v261 = *(*int64)(unsafe.Add(mBase, _consts[707]))
...
L34:
	;
	F_errmsg(m, int32(268965), int32(0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L16
...
L35:
	;
	F_errfinish(m, int32(520276), int32(940), int32(106000))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L16
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+32)) = l0
	F_errmsg_internal(m, int32(39602), v9+int32(32))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L1
...
L5:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[658]))
	v29 = v27 + int32(37)
	if int32(0) <= v29 {
		goto L8
	} else {
...
L6:
	;
	F_errfinish(m, int32(520388), int32(431), int32(232374))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L11:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[678]))
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v70
	F_errmsg(m, int32(232399), v9+int32(16))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
L23:
	;
	F_errfinish(m, int32(520388), int32(452), int32(232374))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L1
...
L29:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9))) = l0
	F_errmsg_internal(m, int32(39593), v9)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(520388), int32(461), int32(232374))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
