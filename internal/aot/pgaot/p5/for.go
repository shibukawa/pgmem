		...
		if base.Ui32(v15) < base.Ui32(int32(12000)) {
			...
			if v19 == int32(116) {
				...
				if v22&int32(8) != 0 {
					...
					if v74 != 0 {
						...
						if v77 != 0 {
							...
							if v81 != 0 {
								...
								F_errdetail_internal(m, int32(586654), int32(0))
								mBase = m.M
								v85 = m.ExcPending
								if v85 != 0 {
									return
									...
									if v89 != 0 {
										...
										F_errfinish(m, int32(475548), int32(4349), int32(271611))
										mBase = m.M
										v94 = m.ExcPending
										if v94 != 0 {
											return
					...
					v26 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _consts[794])) = uint8(v26)
					if l1 != 0 {
...
func F_CheckForSerializableConflictOutNeeded(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v56
	v3 = int32(0)
	v6 = *(*int32)(unsafe.Add(mBase, _consts[790]))
	if v6 == v3 {
		v56 = v3
		return v56
	} else {
							...
							if v34 != 0 {
								...
								if v37 != 0 {
									...
									if v41 != 0 {
										...
										F_errdetail_internal(m, int32(586572), int32(0))
										mBase = m.M
										v45 = m.ExcPending
										if v45 != 0 {
											return int32(0)
											...
											if v49 != 0 {
												...
												F_errfinish(m, int32(475548), int32(4003), int32(441484))
												mBase = m.M
												v54 = m.ExcPending
												if v54 != 0 {
													return int32(0)
...
L63:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _consts[717]))
	*(*int32)(unsafe.Add(mBase, uint32(v12)+56)) = v258
	v261 = *(*int64)(unsafe.Add(mBase, _consts[718]))
...
L34:
	;
	F_errmsg(m, int32(244662), int32(0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L16
...
L35:
	;
	F_errfinish(m, int32(474400), int32(940), int32(93578))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L16
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+32)) = l0
	F_errmsg_internal(m, int32(35763), v9+int32(32))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L1
...
L5:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[661]))
	v29 = v27 + int32(37)
	if int32(0) <= v29 {
		goto L8
	} else {
...
L6:
	;
	F_errfinish(m, int32(474512), int32(431), int32(211196))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L11:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[681]))
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v70
	F_errmsg(m, int32(211221), v9+int32(16))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
L23:
	;
	F_errfinish(m, int32(474512), int32(452), int32(211196))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L1
...
L29:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9))) = l0
	F_errmsg_internal(m, int32(35754), v9)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(474512), int32(461), int32(211196))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
