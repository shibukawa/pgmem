...
func F_pgp_compress_filter(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_pushf_create(m, l0, int32(4432880), l1, l2)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v56))) = v49
	v63 = F_pullf_create(m, v14+int32(24), int32(4432928), v56, v53)
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L3
...
L58:
	;
	F_px_debug(m, int32(529624), int32(0))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L3
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v189))) = v244
	F_px_debug(m, int32(486959), v189)
	mBase = m.M
	v268 = m.ExcPending
	if v268 != 0 {
		goto L3
...
L89:
	...
	v325 = F_pullf_create(m, v14+int32(76), int32(4432940), v324, v304)
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L3
...
L91:
	...
	v333 = F_pullf_create(m, v14+int32(72), int32(4432952), l0, v332)
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L3
...
L109:
	;
	F_px_debug(m, int32(461992), int32(0))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L3
...
L115:
	;
	F_px_debug(m, int32(588649), int32(0))
	mBase = m.M
	v394 = m.ExcPending
	if v394 != 0 {
		goto L3
...
L121:
	...
	v410 = F_pullf_create(m, v14+int32(76), int32(4432940), v409, v372)
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L3
...
L123:
	...
	v418 = F_pullf_create(m, v14+int32(68), int32(4432976), l0, v417)
	mBase = m.M
	v419 = m.ExcPending
	if v419 != 0 {
		goto L3
...
L125:
	...
	v426 = F_pullf_create(m, v14+int32(72), int32(4432952), l0, v425)
	mBase = m.M
	v427 = m.ExcPending
	if v427 != 0 {
		goto L3
...
L2:
	;
	F_px_debug(m, int32(570807), int32(0))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L5
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v38
	F_px_debug(m, int32(487114), v19+int32(16))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L5
...
L17:
	;
	F_px_debug(m, int32(340570), int32(0))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L5
...
L44:
	;
	F_px_debug(m, int32(475010), int32(0))
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L5
...
L77:
	;
	F_px_debug(m, int32(474813), int32(0))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L5
