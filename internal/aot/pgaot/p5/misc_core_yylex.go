...
L42:
	;
	F_yy_fatal_error_2(m, int32(30808))
	mBase = m.M
	v3159 = m.ExcPending
	if v3159 != 0 {
		goto L18
...
L48:
	;
	F_yy_fatal_error_2(m, int32(658275))
	mBase = m.M
	v2999 = m.ExcPending
	if v2999 != 0 {
		goto L18
...
L53:
	;
	F_yy_fatal_error_2(m, int32(446807))
	mBase = m.M
	v2650 = m.ExcPending
	if v2650 != 0 {
		goto L18
...
L54:
	;
	F_yy_fatal_error_2(m, int32(442672))
	mBase = m.M
	v2647 = m.ExcPending
	if v2647 != 0 {
		goto L18
...
L56:
	;
	F_scanner_yyerror(m, int32(393936), l2)
	mBase = m.M
	v2644 = m.ExcPending
	if v2644 != 0 {
		goto L18
...
L57:
	;
	F_scanner_yyerror(m, int32(219002), l2)
	mBase = m.M
	v2641 = m.ExcPending
	if v2641 != 0 {
		goto L18
...
L60:
	;
	F_scanner_yyerror(m, int32(210262), l2)
	mBase = m.M
	v2611 = m.ExcPending
	if v2611 != 0 {
		goto L18
...
L67:
	;
	F_yy_fatal_error_2(m, int32(417002))
	mBase = m.M
	v2540 = m.ExcPending
	if v2540 != 0 {
		goto L18
...
L69:
	;
	F_yy_fatal_error_2(m, int32(446159))
	mBase = m.M
	v2101 = m.ExcPending
	if v2101 != 0 {
		goto L18
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2039))) = v2040 - v2042
	F_scanner_yyerror(m, int32(305374), l2)
	mBase = m.M
	v2047 = m.ExcPending
	if v2047 != 0 {
		goto L18
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1939))) = v1940 - v1942
	F_scanner_yyerror(m, int32(221320), l2)
	mBase = m.M
	v1947 = m.ExcPending
	if v1947 != 0 {
		goto L18
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1930))) = v1931 - v1933
	F_scanner_yyerror(m, int32(221614), l2)
	mBase = m.M
	v1938 = m.ExcPending
	if v1938 != 0 {
		goto L18
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1921))) = v1922 - v1924
	F_scanner_yyerror(m, int32(221636), l2)
	mBase = m.M
	v1929 = m.ExcPending
	if v1929 != 0 {
		goto L18
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1808))) = v1809 - v1811
	F_scanner_yyerror(m, int32(213424), l2)
	mBase = m.M
	v1816 = m.ExcPending
	if v1816 != 0 {
		goto L18
...
L89:
	...
	v1530 = F_strstr(m, v1528, int32(644626))
	mBase = m.M
	v1532 = F_strstr(m, v1528, int32(644527))
	mBase = m.M
...
L99:
	;
	F_scanner_yyerror(m, int32(218971), l2)
	mBase = m.M
	v1444 = m.ExcPending
	if v1444 != 0 {
		goto L18
...
L106:
	;
	F_scanner_yyerror(m, int32(324852), l2)
	mBase = m.M
	v1306 = m.ExcPending
	if v1306 != 0 {
		goto L18
...
L113:
	;
	F_scanner_yyerror(m, int32(324886), l2)
	mBase = m.M
	v1057 = m.ExcPending
	if v1057 != 0 {
		goto L18
...
L131:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2)+36)) = v395
	...
	v407 = F_ScanKeywordLookup(m, int32(226475), v406)
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L18
...
L132:
	;
	F_scanner_yyerror(m, int32(305115), l2)
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L18
...
L134:
	;
	F_scanner_yyerror(m, int32(305083), l2)
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L18
...
L137:
	;
	F_scanner_yyerror(m, int32(93556), l2)
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L18
...
L175:
	;
	F_scanner_yyerror(m, int32(133830), l2)
	mBase = m.M
	v587 = m.ExcPending
	if v587 != 0 {
		goto L18
...
L242:
	;
	F_errhint(m, int32(630768), int32(0))
	mBase = m.M
	v789 = m.ExcPending
	if v789 != 0 {
		goto L18
...
L244:
	;
	F_errfinish(m, int32(309330), int32(704), int32(27195))
	mBase = m.M
	v798 = m.ExcPending
	if v798 != 0 {
		goto L18
...
L264:
	;
	F_errmsg(m, int32(305332), int32(0))
	mBase = m.M
	v840 = m.ExcPending
	if v840 != 0 {
		goto L18
...
L265:
	;
	F_errhint(m, int32(637432), int32(0))
	mBase = m.M
	v844 = m.ExcPending
	if v844 != 0 {
		goto L18
...
L269:
	;
	F_errfinish(m, int32(309330), int32(1433), int32(329064))
	mBase = m.M
	v861 = m.ExcPending
	if v861 != 0 {
		goto L18
...
L278:
	;
	F_errmsg(m, int32(305253), int32(0))
	mBase = m.M
	v885 = m.ExcPending
	if v885 != 0 {
		goto L18
...
L279:
	;
	F_errhint(m, int32(637566), int32(0))
	mBase = m.M
	v889 = m.ExcPending
	if v889 != 0 {
		goto L18
...
L283:
	;
	F_errfinish(m, int32(309330), int32(1443), int32(329064))
	mBase = m.M
	v906 = m.ExcPending
	if v906 != 0 {
		goto L18
...
L441:
	;
	F_scanner_yyerror(m, int32(322457), l2)
	mBase = m.M
	v1670 = m.ExcPending
	if v1670 != 0 {
		goto L18
...
L613:
	;
	F_errmsg(m, int32(160071), int32(0))
	mBase = m.M
	v2588 = m.ExcPending
	if v2588 != 0 {
		goto L18
...
L614:
	;
	F_errdetail(m, int32(602698), int32(0))
	mBase = m.M
	v2592 = m.ExcPending
	if v2592 != 0 {
		goto L18
...
L616:
	;
	F_errfinish(m, int32(309330), int32(569), int32(27195))
	mBase = m.M
	v2601 = m.ExcPending
	if v2601 != 0 {
		goto L18
...
L621:
	;
	F_errmsg(m, int32(305295), int32(0))
	mBase = m.M
	v2622 = m.ExcPending
	if v2622 != 0 {
		goto L18
...
L622:
	;
	F_errhint(m, int32(570910), int32(0))
	mBase = m.M
	v2626 = m.ExcPending
	if v2626 != 0 {
		goto L18
...
L624:
	;
	F_errfinish(m, int32(309330), int32(716), int32(27195))
	mBase = m.M
	v2635 = m.ExcPending
	if v2635 != 0 {
		goto L18
