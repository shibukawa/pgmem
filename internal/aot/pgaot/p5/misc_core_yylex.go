...
L42:
	;
	F_yy_fatal_error_2(m, int32(_a_F_core_yylex_0))
	mBase = m.M
	v3159 = m.ExcPending
	if v3159 != 0 {
		goto L18
...
L48:
	;
	F_yy_fatal_error_2(m, int32(_a_F_core_yylex_1))
	mBase = m.M
	v2999 = m.ExcPending
	if v2999 != 0 {
		goto L18
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2)+36)) = v2951
	...
	v2958 = *(*int32)(unsafe.Add(mBase, uint32(v2953<<(uint(int32(2))%32))+uint32(_c_F_core_yylex[2])))
...
L56:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_4), l2)
	mBase = m.M
	v2644 = m.ExcPending
	if v2644 != 0 {
		goto L18
...
L57:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_5), l2)
	mBase = m.M
	v2641 = m.ExcPending
	if v2641 != 0 {
		goto L18
...
L60:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_6), l2)
	mBase = m.M
	v2611 = m.ExcPending
	if v2611 != 0 {
		goto L18
...
L67:
	;
	F_yy_fatal_error_2(m, int32(_a_F_core_yylex_7))
	mBase = m.M
	v2540 = m.ExcPending
	if v2540 != 0 {
		goto L18
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2039))) = v2040 - v2042
	F_scanner_yyerror(m, int32(_a_F_core_yylex_9), l2)
	mBase = m.M
	v2047 = m.ExcPending
	if v2047 != 0 {
		goto L18
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1974))) = v1975 - v1977
	...
	v1983 = *(*int32)(unsafe.Add(mBase, _c_F_core_yylex[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v1983
	v1986 = *(*int64)(unsafe.Add(mBase, _c_F_core_yylex[4]))
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1939))) = v1940 - v1942
	F_scanner_yyerror(m, int32(_a_F_core_yylex_10), l2)
	mBase = m.M
	v1947 = m.ExcPending
	if v1947 != 0 {
		goto L18
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1930))) = v1931 - v1933
	F_scanner_yyerror(m, int32(_a_F_core_yylex_11), l2)
	mBase = m.M
	v1938 = m.ExcPending
	if v1938 != 0 {
		goto L18
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1921))) = v1922 - v1924
	F_scanner_yyerror(m, int32(_a_F_core_yylex_12), l2)
	mBase = m.M
	v1929 = m.ExcPending
	if v1929 != 0 {
		goto L18
...
L83:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1895))) = v1896 - v1898
	...
	v1904 = *(*int32)(unsafe.Add(mBase, _c_F_core_yylex[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v1904
	v1907 = *(*int64)(unsafe.Add(mBase, _c_F_core_yylex[4]))
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1869))) = v1870 - v1872
	...
	v1878 = *(*int32)(unsafe.Add(mBase, _c_F_core_yylex[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v1878
	v1881 = *(*int64)(unsafe.Add(mBase, _c_F_core_yylex[4]))
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1843))) = v1844 - v1846
	...
	v1852 = *(*int32)(unsafe.Add(mBase, _c_F_core_yylex[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v1852
	v1855 = *(*int64)(unsafe.Add(mBase, _c_F_core_yylex[4]))
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1817))) = v1818 - v1820
	...
	v1826 = *(*int32)(unsafe.Add(mBase, _c_F_core_yylex[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v1826
	v1829 = *(*int64)(unsafe.Add(mBase, _c_F_core_yylex[4]))
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1808))) = v1809 - v1811
	F_scanner_yyerror(m, int32(_a_F_core_yylex_13), l2)
	mBase = m.M
	v1816 = m.ExcPending
	if v1816 != 0 {
		goto L18
...
L88:
	;
	v1786 = *(*int32)(unsafe.Add(mBase, _c_F_core_yylex[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v1786
	v1789 = *(*int64)(unsafe.Add(mBase, _c_F_core_yylex[4]))
...
L89:
	...
	v1530 = F_strstr(m, v1528, int32(_a_F_core_yylex_14))
	mBase = m.M
	v1532 = F_strstr(m, v1528, int32(_a_F_core_yylex_15))
	mBase = m.M
...
L99:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_16), l2)
	mBase = m.M
	v1444 = m.ExcPending
	if v1444 != 0 {
		goto L18
...
L106:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_17), l2)
	mBase = m.M
	v1306 = m.ExcPending
	if v1306 != 0 {
		goto L18
...
L113:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_18), l2)
	mBase = m.M
	v1057 = m.ExcPending
	if v1057 != 0 {
		goto L18
...
L132:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_20), l2)
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L18
...
L134:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_21), l2)
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L18
...
L137:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_22), l2)
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L18
...
L175:
	;
	F_scanner_yyerror(m, int32(_a_F_core_yylex_24), l2)
	mBase = m.M
	v587 = m.ExcPending
	if v587 != 0 {
		goto L18
...
L232:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v705))) = v706 - v708
	...
	if v712 == int32(_a_F_core_yylex_25) {
		goto L62
	} else {
		goto L233
	}
L233:
	;
	if v712 == int32(_a_F_core_yylex_26) {
		goto L61
	} else {
		goto L234
	}
...
L236:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v731))) = v732 - v734
	if v726&int32(-1024) != int32(_a_F_core_yylex_26) {
		goto L60
	} else {
		goto L237
	}
L237:
	...
	F_addunicode(m, v742<<(uint(int32(10))%32)&int32(_a_F_core_yylex_27)|v726&int32(1023)+int32(_a_F_core_yylex_28), l2)
	mBase = m.M
	v753 = m.ExcPending
	if v753 != 0 {
		goto L18
...
L248:
	;
	v806 = *(*int32)(unsafe.Add(mBase, _c_F_core_yylex[5]))
...
L250:
	;
	v811 = *(*int32)(unsafe.Add(mBase, _c_F_core_yylex[5]))
...
L289:
	;
	v930 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v919)+uint32(_c_F_core_yylex[6]))))
	v3303 = v930
	goto L24
L290:
	;
...
L517:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2)+36)) = v2145
	...
	v2152 = *(*int32)(unsafe.Add(mBase, uint32(v2147<<(uint(int32(2))%32))+uint32(_c_F_core_yylex[2])))
...
L554:
	;
	v2395 = int32(_a_F_core_yylex_40)
...
L667:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2)+36)) = v2889
	...
	v2896 = *(*int32)(unsafe.Add(mBase, uint32(v2891<<(uint(int32(2))%32))+uint32(_c_F_core_yylex[2])))
