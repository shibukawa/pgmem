...
L42:
	;
	F_yy_fatal_error_2(m, int32(31348))
	mBase = m.M
	v3159 = m.ExcPending
	if v3159 != 0 {
		goto L18
...
L48:
	;
	F_yy_fatal_error_2(m, int32(683508))
	mBase = m.M
	v2999 = m.ExcPending
	if v2999 != 0 {
		goto L18
...
L53:
	;
	F_yy_fatal_error_2(m, int32(453961))
	mBase = m.M
	v2650 = m.ExcPending
	if v2650 != 0 {
		goto L18
...
L54:
	;
	F_yy_fatal_error_2(m, int32(449724))
	mBase = m.M
	v2647 = m.ExcPending
	if v2647 != 0 {
		goto L18
...
L56:
	;
	F_scanner_yyerror(m, int32(400405), l2)
	mBase = m.M
	v2644 = m.ExcPending
	if v2644 != 0 {
		goto L18
...
L57:
	;
	F_scanner_yyerror(m, int32(222177), l2)
	mBase = m.M
	v2641 = m.ExcPending
	if v2641 != 0 {
		goto L18
...
L60:
	;
	F_scanner_yyerror(m, int32(213285), l2)
	mBase = m.M
	v2611 = m.ExcPending
	if v2611 != 0 {
		goto L18
...
L67:
	;
	F_yy_fatal_error_2(m, int32(423886))
	mBase = m.M
	v2540 = m.ExcPending
	if v2540 != 0 {
		goto L18
...
L69:
	;
	F_yy_fatal_error_2(m, int32(453313))
	mBase = m.M
	v2101 = m.ExcPending
	if v2101 != 0 {
		goto L18
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2039))) = v2040 - v2042
	F_scanner_yyerror(m, int32(310439), l2)
	mBase = m.M
	v2047 = m.ExcPending
	if v2047 != 0 {
		goto L18
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1939))) = v1940 - v1942
	F_scanner_yyerror(m, int32(224495), l2)
	mBase = m.M
	v1947 = m.ExcPending
	if v1947 != 0 {
		goto L18
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1930))) = v1931 - v1933
	F_scanner_yyerror(m, int32(224789), l2)
	mBase = m.M
	v1938 = m.ExcPending
	if v1938 != 0 {
		goto L18
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1921))) = v1922 - v1924
	F_scanner_yyerror(m, int32(224811), l2)
	mBase = m.M
	v1929 = m.ExcPending
	if v1929 != 0 {
		goto L18
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1808))) = v1809 - v1811
	F_scanner_yyerror(m, int32(216561), l2)
	mBase = m.M
	v1816 = m.ExcPending
	if v1816 != 0 {
		goto L18
...
L89:
	...
	v1530 = F_strstr(m, v1528, int32(669799))
	mBase = m.M
	v1532 = F_strstr(m, v1528, int32(669700))
	mBase = m.M
...
L99:
	;
	F_scanner_yyerror(m, int32(222146), l2)
	mBase = m.M
	v1444 = m.ExcPending
	if v1444 != 0 {
		goto L18
...
L106:
	;
	F_scanner_yyerror(m, int32(330337), l2)
	mBase = m.M
	v1306 = m.ExcPending
	if v1306 != 0 {
		goto L18
...
L113:
	;
	F_scanner_yyerror(m, int32(330371), l2)
	mBase = m.M
	v1057 = m.ExcPending
	if v1057 != 0 {
		goto L18
...
L131:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2)+36)) = v395
	...
	v407 = F_ScanKeywordLookup(m, int32(229957), v406)
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L18
...
L132:
	;
	F_scanner_yyerror(m, int32(310180), l2)
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L18
...
L134:
	;
	F_scanner_yyerror(m, int32(310148), l2)
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L18
...
L137:
	;
	F_scanner_yyerror(m, int32(94990), l2)
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L18
...
L175:
	;
	F_scanner_yyerror(m, int32(136108), l2)
	mBase = m.M
	v587 = m.ExcPending
	if v587 != 0 {
		goto L18
...
L242:
	;
	F_errhint(m, int32(655881), int32(0))
	mBase = m.M
	v789 = m.ExcPending
	if v789 != 0 {
		goto L18
...
L244:
	;
	F_errfinish(m, int32(314447), int32(704), int32(27587))
	mBase = m.M
	v798 = m.ExcPending
	if v798 != 0 {
		goto L18
...
L264:
	;
	F_errmsg(m, int32(310397), int32(0))
	mBase = m.M
	v840 = m.ExcPending
	if v840 != 0 {
		goto L18
...
L269:
	;
	F_errfinish(m, int32(314447), int32(1433), int32(334549))
	mBase = m.M
	v861 = m.ExcPending
	if v861 != 0 {
		goto L18
...
L278:
	;
	F_errmsg(m, int32(310318), int32(0))
	mBase = m.M
	v885 = m.ExcPending
	if v885 != 0 {
		goto L18
...
L279:
	;
	F_errhint(m, int32(662724), int32(0))
	mBase = m.M
	v889 = m.ExcPending
	if v889 != 0 {
		goto L18
...
L283:
	;
	F_errfinish(m, int32(314447), int32(1443), int32(334549))
	mBase = m.M
	v906 = m.ExcPending
	if v906 != 0 {
		goto L18
...
L441:
	;
	F_scanner_yyerror(m, int32(327862), l2)
	mBase = m.M
	v1670 = m.ExcPending
	if v1670 != 0 {
		goto L18
...
L613:
	;
	F_errmsg(m, int32(162669), int32(0))
	mBase = m.M
	v2588 = m.ExcPending
	if v2588 != 0 {
		goto L18
...
L614:
	;
	F_errdetail(m, int32(627554), int32(0))
	mBase = m.M
	v2592 = m.ExcPending
	if v2592 != 0 {
		goto L18
...
L616:
	;
	F_errfinish(m, int32(314447), int32(569), int32(27587))
	mBase = m.M
	v2601 = m.ExcPending
	if v2601 != 0 {
		goto L18
...
L621:
	;
	F_errmsg(m, int32(310360), int32(0))
	mBase = m.M
	v2622 = m.ExcPending
	if v2622 != 0 {
		goto L18
...
L622:
	;
	F_errhint(m, int32(595353), int32(0))
	mBase = m.M
	v2626 = m.ExcPending
	if v2626 != 0 {
		goto L18
...
L624:
	;
	F_errfinish(m, int32(314447), int32(716), int32(27587))
	mBase = m.M
	v2635 = m.ExcPending
	if v2635 != 0 {
		goto L18
