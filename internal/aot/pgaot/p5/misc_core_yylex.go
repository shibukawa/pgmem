...
L48:
	;
	F_yy_fatal_error_2(m, int32(665316))
	mBase = m.M
	v2999 = m.ExcPending
	if v2999 != 0 {
		goto L18
...
L53:
	;
	F_yy_fatal_error_2(m, int32(451520))
	mBase = m.M
	v2650 = m.ExcPending
	if v2650 != 0 {
		goto L18
...
L54:
	;
	F_yy_fatal_error_2(m, int32(447306))
	mBase = m.M
	v2647 = m.ExcPending
	if v2647 != 0 {
		goto L18
...
L67:
	;
	F_yy_fatal_error_2(m, int32(421533))
	mBase = m.M
	v2540 = m.ExcPending
	if v2540 != 0 {
		goto L18
...
L69:
	;
	F_yy_fatal_error_2(m, int32(450872))
	mBase = m.M
	v2101 = m.ExcPending
	if v2101 != 0 {
		goto L18
...
L89:
	...
	v1530 = F_strstr(m, v1528, int32(651607))
	mBase = m.M
	v1532 = F_strstr(m, v1528, int32(651508))
	mBase = m.M
...
L242:
	;
	F_errhint(m, int32(637704), int32(0))
	mBase = m.M
	v789 = m.ExcPending
	if v789 != 0 {
		goto L18
...
L279:
	;
	F_errhint(m, int32(644547), int32(0))
	mBase = m.M
	v889 = m.ExcPending
	if v889 != 0 {
		goto L18
...
L614:
	;
	F_errdetail(m, int32(609377), int32(0))
	mBase = m.M
	v2592 = m.ExcPending
	if v2592 != 0 {
		goto L18
...
L622:
	;
	F_errhint(m, int32(577176), int32(0))
	mBase = m.M
	v2626 = m.ExcPending
	if v2626 != 0 {
		goto L18
