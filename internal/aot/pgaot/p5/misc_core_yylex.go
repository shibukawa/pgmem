...
L42:
	;
	F_yy_fatal_error_2(m, int32(29858))
	mBase = m.M
	v3159 = m.ExcPending
	if v3159 != 0 {
		goto L18
...
L48:
	;
	F_yy_fatal_error_2(m, int32(649148))
	mBase = m.M
	v2999 = m.ExcPending
	if v2999 != 0 {
		goto L18
...
L53:
	;
	F_yy_fatal_error_2(m, int32(438681))
	mBase = m.M
	v2650 = m.ExcPending
	if v2650 != 0 {
		goto L18
...
L54:
	;
	F_yy_fatal_error_2(m, int32(434546))
	mBase = m.M
	v2647 = m.ExcPending
	if v2647 != 0 {
		goto L18
...
L56:
	;
	F_scanner_yyerror(m, int32(386430), l2)
	mBase = m.M
	v2644 = m.ExcPending
	if v2644 != 0 {
		goto L18
...
L57:
	;
	F_scanner_yyerror(m, int32(214423), l2)
	mBase = m.M
	v2641 = m.ExcPending
	if v2641 != 0 {
		goto L18
...
L60:
	;
	F_scanner_yyerror(m, int32(205707), l2)
	mBase = m.M
	v2611 = m.ExcPending
	if v2611 != 0 {
		goto L18
...
L67:
	;
	F_yy_fatal_error_2(m, int32(409116))
	mBase = m.M
	v2540 = m.ExcPending
	if v2540 != 0 {
		goto L18
...
L69:
	;
	F_yy_fatal_error_2(m, int32(438033))
	mBase = m.M
	v2101 = m.ExcPending
	if v2101 != 0 {
		goto L18
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2039))) = v2040 - v2042
	F_scanner_yyerror(m, int32(299268), l2)
	mBase = m.M
	v2047 = m.ExcPending
	if v2047 != 0 {
		goto L18
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1939))) = v1940 - v1942
	F_scanner_yyerror(m, int32(216741), l2)
	mBase = m.M
	v1947 = m.ExcPending
	if v1947 != 0 {
		goto L18
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1930))) = v1931 - v1933
	F_scanner_yyerror(m, int32(217035), l2)
	mBase = m.M
	v1938 = m.ExcPending
	if v1938 != 0 {
		goto L18
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1921))) = v1922 - v1924
	F_scanner_yyerror(m, int32(217057), l2)
	mBase = m.M
	v1929 = m.ExcPending
	if v1929 != 0 {
		goto L18
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1808))) = v1809 - v1811
	F_scanner_yyerror(m, int32(208845), l2)
	mBase = m.M
	v1816 = m.ExcPending
	if v1816 != 0 {
		goto L18
...
L89:
	...
	v1530 = F_strstr(m, v1528, int32(635499))
	mBase = m.M
	v1532 = F_strstr(m, v1528, int32(635400))
	mBase = m.M
...
L99:
	;
	F_scanner_yyerror(m, int32(214392), l2)
	mBase = m.M
	v1444 = m.ExcPending
	if v1444 != 0 {
		goto L18
...
L106:
	;
	F_scanner_yyerror(m, int32(318321), l2)
	mBase = m.M
	v1306 = m.ExcPending
	if v1306 != 0 {
		goto L18
...
L113:
	;
	F_scanner_yyerror(m, int32(318355), l2)
	mBase = m.M
	v1057 = m.ExcPending
	if v1057 != 0 {
		goto L18
...
L131:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2)+36)) = v395
	...
	v407 = F_ScanKeywordLookup(m, int32(221590), v406)
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L18
...
L132:
	;
	F_scanner_yyerror(m, int32(299009), l2)
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L18
...
L134:
	;
	F_scanner_yyerror(m, int32(298977), l2)
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L18
...
L137:
	;
	F_scanner_yyerror(m, int32(90783), l2)
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L18
...
L175:
	;
	F_scanner_yyerror(m, int32(129275), l2)
	mBase = m.M
	v587 = m.ExcPending
	if v587 != 0 {
		goto L18
...
L242:
	;
	F_errhint(m, int32(621641), int32(0))
	mBase = m.M
	v789 = m.ExcPending
	if v789 != 0 {
		goto L18
...
L244:
	;
	F_errfinish(m, int32(303224), int32(704), int32(26245))
	mBase = m.M
	v798 = m.ExcPending
	if v798 != 0 {
		goto L18
...
L264:
	;
	F_errmsg(m, int32(299226), int32(0))
	mBase = m.M
	v840 = m.ExcPending
	if v840 != 0 {
		goto L18
...
L265:
	;
	F_errhint(m, int32(628305), int32(0))
	mBase = m.M
	v844 = m.ExcPending
	if v844 != 0 {
		goto L18
...
L269:
	;
	F_errfinish(m, int32(303224), int32(1433), int32(322533))
	mBase = m.M
	v861 = m.ExcPending
	if v861 != 0 {
		goto L18
...
L278:
	;
	F_errmsg(m, int32(299147), int32(0))
	mBase = m.M
	v885 = m.ExcPending
	if v885 != 0 {
		goto L18
...
L279:
	;
	F_errhint(m, int32(628439), int32(0))
	mBase = m.M
	v889 = m.ExcPending
	if v889 != 0 {
		goto L18
...
L283:
	;
	F_errfinish(m, int32(303224), int32(1443), int32(322533))
	mBase = m.M
	v906 = m.ExcPending
	if v906 != 0 {
		goto L18
...
L441:
	;
	F_scanner_yyerror(m, int32(315926), l2)
	mBase = m.M
	v1670 = m.ExcPending
	if v1670 != 0 {
		goto L18
...
L613:
	;
	F_errmsg(m, int32(155516), int32(0))
	mBase = m.M
	v2588 = m.ExcPending
	if v2588 != 0 {
		goto L18
...
L614:
	;
	F_errdetail(m, int32(593571), int32(0))
	mBase = m.M
	v2592 = m.ExcPending
	if v2592 != 0 {
		goto L18
...
L616:
	;
	F_errfinish(m, int32(303224), int32(569), int32(26245))
	mBase = m.M
	v2601 = m.ExcPending
	if v2601 != 0 {
		goto L18
...
L621:
	;
	F_errmsg(m, int32(299189), int32(0))
	mBase = m.M
	v2622 = m.ExcPending
	if v2622 != 0 {
		goto L18
...
L622:
	;
	F_errhint(m, int32(561783), int32(0))
	mBase = m.M
	v2626 = m.ExcPending
	if v2626 != 0 {
		goto L18
...
L624:
	;
	F_errfinish(m, int32(303224), int32(716), int32(26245))
	mBase = m.M
	v2635 = m.ExcPending
	if v2635 != 0 {
		goto L18
