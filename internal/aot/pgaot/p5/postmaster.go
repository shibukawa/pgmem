			...
			if v103 < v106 {
				...
				for {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(v119)+16)) = uint8(v125)
					...
					if v129 == v125 {
						*(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[443]))) = v95
						*(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[445]))) = v91 + int32(4363368)
					} else {
					}
...
func F_ReleasePostmasterChildSlot(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v13
	...
	if v21 != 0 {
		...
		if v15 == int32(2) {
			if v18 != 0 {
				F_errmsg_internal(m, int32(412138), int32(0))
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(482779), int32(241), int32(83211))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v36
				F_errmsg_internal(m, int32(451907), v8+int32(16))
				mBase = m.M
				v42 = m.ExcPending
				if v42 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(482779), int32(249), int32(83211))
					mBase = m.M
					v47 = m.ExcPending
					if v47 != 0 {
						return int32(0)
						...
						if v50 == int32(6) {
							...
							v57 = v50<<(uint(int32(4))%32) + int32(4363360)
						}
						...
						if v48 < v58 {
							...
							if v101 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v102
								F_errmsg_internal(m, int32(80412), v8)
								mBase = m.M
								v106 = m.ExcPending
								if v106 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(482779), int32(262), int32(83211))
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return int32(0)
...
func F_postmaster_child_launch(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v39 != 0 {
		...
		F_sigprocmask(m, int32(4362568), v33+int32(16))
		mBase = m.M
		v44 = m.ExcPending
		if v44 != 0 {
			return int32(0)
