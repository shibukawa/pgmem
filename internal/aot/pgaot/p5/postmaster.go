			...
			if v103 < v106 {
				...
				for {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(v119)+16)) = uint8(v125)
					...
					if v129 == v125 {
						*(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[441]))) = v95
						*(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[443]))) = v91 + int32(4470216)
					} else {
					}
...
func F_ReleasePostmasterChildSlot(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v13
	...
	if v21 != 0 {
		...
		if v15 == int32(2) {
			if v18 != 0 {
				F_errmsg_internal(m, int32(447818), int32(0))
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(524981), int32(241), int32(92646))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v36
				F_errmsg_internal(m, int32(489799), v8+int32(16))
				mBase = m.M
				v42 = m.ExcPending
				if v42 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(524981), int32(249), int32(92646))
					mBase = m.M
					v47 = m.ExcPending
					if v47 != 0 {
						return int32(0)
						...
						if v48 < v58 {
							...
							if v101 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v102
								F_errmsg_internal(m, int32(89847), v8)
								mBase = m.M
								v106 = m.ExcPending
								if v106 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(524981), int32(262), int32(92646))
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return int32(0)
