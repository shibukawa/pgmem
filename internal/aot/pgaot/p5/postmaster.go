...
func F_InitPostmasterChildSlots(m *base.Module) {
	...
	var v160 int32
	_ = v160
	*(*int32)(unsafe.Add(mBase, _consts[420])) = int32(32)
	v13 = int32(1)
	...
	*(*int32)(unsafe.Add(mBase, _consts[430])) = v13
	v44 = *(*int32)(unsafe.Add(mBase, _consts[431]))
	*(*int32)(unsafe.Add(mBase, _consts[432])) = v44
	v48 = *(*int32)(unsafe.Add(mBase, _consts[433]))
	*(*int32)(unsafe.Add(mBase, _consts[434])) = v48
	v52 = *(*int32)(unsafe.Add(mBase, _consts[435]))
	v54 = *(*int32)(unsafe.Add(mBase, _consts[436]))
	v57 = (v52 + v54) << (uint(v13) % 32)
	*(*int32)(unsafe.Add(mBase, _consts[437])) = v57
	v61 = *(*int32)(unsafe.Add(mBase, _consts[438]))
	v63 = *(*int32)(unsafe.Add(mBase, _consts[439]))
	v65 = *(*int32)(unsafe.Add(mBase, _consts[440]))
	v67 = *(*int32)(unsafe.Add(mBase, _consts[441]))
	v75 = v61 + (v63 + (v48 + (v44 + (v65 + (v67 + v57))))) + int32(42)
	*(*int32)(unsafe.Add(mBase, _consts[442])) = v75
	...
	if v80 != 0 {
		...
		for {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[445]))) = v95
			v103 = int32(0)
			v106 = *(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[441])))
			if v103 < v106 {
				v111 = v84
				v114 = v103
				for {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(v119)+16)) = uint8(v125)
					...
					if v129 == v125 {
						*(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[443]))) = v95
						*(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[445]))) = v91 + int32(4395080)
					} else {
					}
					*(*int32)(unsafe.Add(mBase, uint32(v119)+24)) = v95
					v137 = *(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[445])))
					*(*int32)(unsafe.Add(mBase, uint32(v119)+20)) = v137
					v140 = v119 + int32(20)
					*(*int32)(unsafe.Add(mBase, uint32(v137)+4)) = v140
					*(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[445]))) = v140
					v144 = v114 + int32(1)
					v145 = *(*int32)(unsafe.Add(mBase, uint32(v91)+uint32(_consts[441])))
					if v144 < v145 {
						v111 = v123
						v114 = v144
						continue
...
func F_ReleasePostmasterChildSlot(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v13
	...
	if v21 != 0 {
		...
		if v15 == int32(2) {
			if v18 != 0 {
				F_errmsg_internal(m, int32(424524), int32(0))
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496487), int32(241), int32(85947))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v36
				F_errmsg_internal(m, int32(465034), v8+int32(16))
				mBase = m.M
				v42 = m.ExcPending
				if v42 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496487), int32(249), int32(85947))
					mBase = m.M
					v47 = m.ExcPending
					if v47 != 0 {
						return int32(0)
						...
						if v50 == int32(6) {
							...
							v57 = v50<<(uint(int32(4))%32) + int32(4395072)
						}
						...
						if v48 < v58 {
							...
							if v101 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v102
								F_errmsg_internal(m, int32(83148), v8)
								mBase = m.M
								v106 = m.ExcPending
								if v106 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(496487), int32(262), int32(85947))
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return int32(0)
...
func F_postmaster_child_launch(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v39 != 0 {
		...
		F_sigprocmask(m, int32(4394280), v33+int32(16))
		mBase = m.M
		v44 = m.ExcPending
		if v44 != 0 {
			return int32(0)
