...
L96:
	...
	*(*int32)(unsafe.Add(mBase, _consts[86])) = int32(0)
	...
	mBase = m.M
	v365 = *(*int32)(unsafe.Add(mBase, _consts[86]))
	if v365 != int32(68) {
		v377 = v347
		v378 = v329
		v380 = v363
...
L139:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v529))) = v530
	v538 = int32(*(*uint8)(unsafe.Add(mBase, _consts[180])))
	if v538 == int32(0) {
		goto L141
	} else {
		goto L142
...
L143:
	;
	v542 = int32(*(*uint8)(unsafe.Add(mBase, _consts[181])))
	if v542 == int32(0) {
		goto L144
	} else {
		goto L145
...
L163:
	;
	v619 = *(*int32)(unsafe.Add(mBase, _consts[86]))
	if v619 != 0 {
		goto L135
	} else {
		goto L164
...
L206:
	...
	v763 = *(*int32)(unsafe.Add(mBase, uint32(v104)+uint32(_consts[1042])))
	if v763 != 0 {
		goto L211
	} else {
		goto L212
...
L210:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v104)+uint32(_consts[1042]))) = v927
...
L317:
	...
	v1413 = *(*int32)(unsafe.Add(mBase, uint32(v1404*int32(52)+v1407<<(uint(int32(2))%32))+uint32(_consts[1043])))
	if v1392 <= v1413 {
		goto L315
	} else {
		goto L320
...
L348:
	;
	v1483 = *(*int32)(unsafe.Add(mBase, uint32(v1240)+uint32(_consts[1044])))
...
L383:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1229)+8)) = v1637
	v1642 = *(*int32)(unsafe.Add(mBase, _consts[330]))
...
L8:
	;
	v69 = F_AllocateFile(m, v12+int32(1264), int32(231353))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L5
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+128)) = l0
	v45 = F_pg_snprintf(m, v12+int32(1200), int32(64), int32(12864), v12+int32(128))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L5
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+144)) = l0
	v63 = F_pg_snprintf(m, v12+int32(1264), int32(1024), int32(12857), v12+int32(144))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L5
...
L12:
	;
	v54 = F_RestoreArchivedFile(m, v12+int32(1264), v12+int32(1200), int32(509809), int64(0), int32(0))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L5
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+112)) = v12 + int32(156)
	v146 = F_sscanf(m, v12+int32(160), int32(517152), v12+int32(112))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L5
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v12 + int32(160)
	F_errmsg(m, int32(203999), v12-int32(-64))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L5
...
L52:
	;
	F_errhint(m, int32(660962), int32(0))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L5
...
L53:
	;
	F_errfinish(m, int32(500034), int32(164), int32(13239))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L5
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+96)) = v12 + int32(160)
	F_errmsg(m, int32(203999), v12+int32(96))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L5
...
L56:
	;
	F_errhint(m, int32(618423), int32(0))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L5
...
L57:
	;
	F_errfinish(m, int32(500034), int32(169), int32(13239))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L5
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+80)) = v12 + int32(160)
	F_errmsg(m, int32(204032), v12+int32(80))
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L5
...
L60:
	;
	F_errhint(m, int32(645216), int32(0))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L5
...
L61:
	;
	F_errfinish(m, int32(500034), int32(174), int32(13239))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L5
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v12 + int32(1264)
	F_errmsg(m, int32(299339), v12+int32(16))
	mBase = m.M
	v268 = m.ExcPending
	if v268 != 0 {
		goto L5
...
L65:
	;
	F_errfinish(m, int32(500034), int32(111), int32(13239))
	mBase = m.M
	v273 = m.ExcPending
	if v273 != 0 {
		goto L5
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v12 + int32(1264)
	F_errmsg(m, int32(716956), v12+int32(32))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L5
...
L80:
	;
	F_errhint(m, int32(660910), int32(0))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L5
...
L81:
	;
	F_errfinish(m, int32(500034), int32(195), int32(13239))
	mBase = m.M
	v320 = m.ExcPending
	if v320 != 0 {
		goto L5
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v12 + int32(1264)
	F_errmsg(m, int32(300258), v12+int32(48))
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L5
...
L85:
	;
	F_errfinish(m, int32(500034), int32(143), int32(13239))
	mBase = m.M
	v339 = m.ExcPending
	if v339 != 0 {
		goto L5
...
func F_time_timetz(m *base.Module, l0 int32) int32 {
	...
	if v18 != 0 {
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v9)+4)) = uint32(v34)
		v39 = *(*int32)(unsafe.Add(mBase, _consts[330]))
		v41 = m.G0
		v42 = int32(16)
		v43 = v41 - v42
		m.G0 = v43
