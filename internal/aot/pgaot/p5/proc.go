...
L6:
	;
	v81 = *(*int32)(unsafe.Add(mBase, _consts[102]))
...
L7:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _consts[69]))
	if v42 != 0 {
		goto L11
	} else {
		goto L12
...
L60:
	;
	v396 = *(*int32)(unsafe.Add(mBase, _consts[102]))
...
L106:
	;
	v551 = *(*int32)(unsafe.Add(mBase, _consts[102]))
...
L198:
	;
	v713 = *(*int32)(unsafe.Add(mBase, _consts[514]))
	v714 = v26
	goto L201
L199:
	;
...
L200:
	;
	v745 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L204:
	;
	v751 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
func F_ProcNumberGetProc(m *base.Module, l0 int32) int32 {
	...
	if l0 < v2 {
		...
		v8 = *(*int32)(unsafe.Add(mBase, _consts[102]))
...
func F_proc_exit(m *base.Module, l0 int32) {
	...
	v5 = v3 - int32(16)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _consts[448]))
	if v8 == int32(42) {
			...
			if v16 != 0 {
				...
				if v15 != 0 {
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
					F_errmsg_internal(m, int32(703760), v5)
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
					} else {
						F_errfinish(m, int32(520193), int32(155), int32(105428))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
		...
		if v31 != 0 {
			...
			F_errmsg_internal(m, int32(137279), int32(0))
			mBase = m.M
			v35 = m.ExcPending
			if v35 != 0 {
				return
			} else {
				F_errfinish(m, int32(520193), int32(109), int32(105428))
				mBase = m.M
				v40 = m.ExcPending
				if v40 != 0 {
					return
