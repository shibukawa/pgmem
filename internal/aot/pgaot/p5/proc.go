...
func F_proc_exit(m *base.Module, l0 int32) {
	...
	if v8 == int32(42) {
			...
			if v16 != 0 {
				...
				if v15 != 0 {
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
					F_errmsg_internal(m, int32(657852), v5)
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
					} else {
						F_errfinish(m, int32(494771), int32(155), int32(98702))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
		...
		if v31 != 0 {
			...
			F_errmsg_internal(m, int32(128798), int32(0))
			mBase = m.M
			v35 = m.ExcPending
			if v35 != 0 {
				return
			} else {
				F_errfinish(m, int32(494771), int32(109), int32(98702))
				mBase = m.M
				v40 = m.ExcPending
				if v40 != 0 {
					return
