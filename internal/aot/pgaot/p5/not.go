...
func F_ReportNotNullViolationError(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v20 != 0 {
		...
		if v25 != 0 {
			...
			if v24 != 0 {
				v27 = F_MakeTupleTableSlot(m, v22, int32(1650644))
				mBase = m.M
				v28 = m.ExcPending
				if v28 != 0 {
					return
										...
										if v56 != 0 {
											...
											if v59 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = v60 + int32(4)
												F_errmsg(m, int32(96125), v12+int32(16))
												mBase = m.M
												v74 = m.ExcPending
												if v74 != 0 {
													return
													...
													if v51 != 0 {
														*(*int32)(unsafe.Add(mBase, uint32(v12))) = v51
														F_errdetail(m, int32(630851), v12)
														mBase = m.M
														v78 = m.ExcPending
														if v78 != 0 {
															return
															...
															if v80 != 0 {
																...
																F_errfinish(m, int32(519741), int32(2219), int32(223303))
																mBase = m.M
																v85 = m.ExcPending
																if v85 != 0 {
																	return
