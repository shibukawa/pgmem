...
L106:
	;
	F_errsave_finish(m, l4, int32(476611), int32(7320), int32(196129))
	mBase = m.M
	v554 = m.ExcPending
	if v554 != 0 {
		goto L24
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = int32(468051)
	F_errmsg(m, int32(683256), v18)
	mBase = m.M
	v583 = m.ExcPending
	if v583 != 0 {
		goto L24
...
L111:
	;
	F_errsave_finish(m, l4, int32(476611), int32(7326), int32(196129))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L24
