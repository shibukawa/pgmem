...
func F_hstore_exec_setup(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l2)+8)) = int32(7434)
	*(*int32)(unsafe.Add(mBase, uint32(l2)+4)) = int32(7435)
	return
}
...
L52:
	;
	F_errfinish(m, int32(519177), int32(633), int32(120779))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L13
...
L56:
	;
	F_errfinish(m, int32(519177), int32(642), int32(120779))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L13
...
L60:
	;
	F_errfinish(m, int32(519177), int32(662), int32(120779))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		goto L13
...
L63:
	;
	F_errmsg(m, int32(182624), int32(0))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L13
...
L64:
	;
	F_errfinish(m, int32(519177), int32(670), int32(120779))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L13
...
L68:
	;
	F_errfinish(m, int32(519177), int32(684), int32(120779))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L13
