...
func F_WalSndKill(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v18
	v3 = int32(4472476)
	v4 = *(*int32)(unsafe.Add(mBase, _consts[211]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4)+76)) = int32(1)
	if v8 != 0 {
		F_s_lock(m, v4+int32(76), int32(521307), int32(3023), int32(319701))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
...
func F_WalSndLastCycleHandler(m *base.Module, l0 int32) {
	...
	var v8 int32
	_ = v8
	*(*int32)(unsafe.Add(mBase, _consts[586])) = int32(1)
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, _consts[86])) = v34
	goto L9
L7:
	;
	goto L8
...
L9:
	;
	v40 = F_format_elog_string(m, int32(677746), int32(0))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L3
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, _consts[87])) = v40
	F_pfree(m, v22)
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
...
L13:
	;
	v278 = *(*int32)(unsafe.Add(mBase, _consts[85]))
	*(*int32)(unsafe.Add(mBase, _consts[86])) = v278
	goto L75
L14:
	;
	F_pfree(m, v22)
...
L36:
	...
	v129 = *(*int32)(unsafe.Add(mBase, uint32(v126)+uint32(_consts[120])))
	if v129 == int32(0) {
		goto L38
	} else {
		goto L39
...
L38:
	...
	v146 = *(*int32)(unsafe.Add(mBase, uint32(v143)+uint32(_consts[120])))
	if v146 == int32(0) {
		goto L41
	} else {
		goto L42
...
L39:
	;
	v132 = *(*int32)(unsafe.Add(mBase, uint32(v126)+uint32(_consts[121])))
	if v132 == int32(0) {
		goto L38
	} else {
		goto L40
...
L42:
	;
	v149 = *(*int32)(unsafe.Add(mBase, uint32(v143)+uint32(_consts[121])))
	if v149 == int32(0) {
		goto L41
	} else {
		goto L43
...
L45:
	...
	v175 = *(*int32)(unsafe.Add(mBase, uint32(v172)+uint32(_consts[120])))
	if v175 == int32(0) {
		goto L47
	} else {
		goto L48
...
L46:
	;
	v232 = int32(*(*uint8)(unsafe.Add(mBase, _consts[122])))
	if v232 != 0 {
		goto L13
	} else {
		goto L65
...
L48:
	;
	v178 = *(*int32)(unsafe.Add(mBase, uint32(v172)+uint32(_consts[121])))
	if v178 == int32(0) {
		goto L47
	} else {
		goto L49
...
L65:
	;
	v234 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[123])) = uint8(v234)
	goto L19
L66:
	;
	goto L18
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v70
	v284 = F_format_elog_string(m, int32(701054), v13)
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L3
...
L76:
	;
	*(*int32)(unsafe.Add(mBase, _consts[87])) = v284
	F_pfree(m, v22)
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
...
func F_check_wal_segment_size(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v14 == v12 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[86])) = v18
		v24 = F_format_elog_string(m, int32(692428), int32(0))
		mBase = m.M
		v27 = m.ExcPending
		if v27 != 0 {
			return int32(0)
	...
	if v28 != 0 {
		...
		if v33 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+1168)) = v32
			if v32 < int32(0) {
				v38 = *(*int32)(unsafe.Add(mBase, _consts[85]))
					...
					if v44 != 0 {
						...
						if v38 == int32(44) {
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(48)
							F_errmsg(m, int32(462805), v9)
							mBase = m.M
							v68 = m.ExcPending
							if v68 != 0 {
								return
							} else {
								F_errfinish(m, int32(519356), int32(821), int32(295918))
								mBase = m.M
								v73 = m.ExcPending
								if v73 != 0 {
									return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(48)
							...
							if v54 != 0 {
								...
								F_errfinish(m, int32(519356), int32(826), int32(295918))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return
