...
func F_WalSndKill(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4)+76)) = int32(1)
	if v8 != 0 {
		F_s_lock(m, v4+int32(76), int32(517881), int32(3023), int32(317651))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
...
L9:
	;
	v40 = F_format_elog_string(m, int32(673063), int32(0))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L3
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v70
	v284 = F_format_elog_string(m, int32(696156), v13)
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L3
...
func F_check_wal_segment_size(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v14 == v12 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[88])) = v18
		v24 = F_format_elog_string(m, int32(687631), int32(0))
		mBase = m.M
		v27 = m.ExcPending
		if v27 != 0 {
			return int32(0)
					...
					if v44 != 0 {
						...
						if v38 == int32(44) {
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(48)
							F_errmsg(m, int32(459870), v9)
							mBase = m.M
							v68 = m.ExcPending
							if v68 != 0 {
								return
							} else {
								F_errfinish(m, int32(515953), int32(821), int32(294055))
								mBase = m.M
								v73 = m.ExcPending
								if v73 != 0 {
									return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(48)
							...
							if v54 != 0 {
								...
								F_errfinish(m, int32(515953), int32(826), int32(294055))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return
