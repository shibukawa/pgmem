...
func F_px_find_digest(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v155 int32
	_ = v155
	v10 = int32(_a_F_px_find_digest_0)
	v11 = l0
	goto L3
L1:
	;
	v114 = *(*int32)(unsafe.Add(mBase, _c_F_px_find_digest[0]))
...
L15:
	;
	v112 = int32(_a_F_px_find_digest_1)
	goto L1
L16:
	;
	goto L17
...
L19:
	;
	v112 = v64 + int32(_a_F_px_find_digest_1)
	goto L1
L20:
	;
	return int32(-2)
...
L22:
	...
	v67 = *(*int32)(unsafe.Add(mBase, uint32(v64)+uint32(_c_F_px_find_digest[1])))
	v70 = v67
	v71 = l0
	goto L24
L23:
...
L38:
	...
	v121 = *(*int32)(unsafe.Add(mBase, _c_F_px_find_digest[2]))
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v123)+4)) = v132 & int32(_a_F_px_find_digest_2)
	v148 = *(*int32)(unsafe.Add(mBase, _c_F_px_find_digest[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v123)+12)) = v148
	F_ResourceOwnerRemember(m, v148, v123, int32(_a_F_px_find_digest_3))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L37
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v154)+20)) = int32(_a_F_px_find_digest_4)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+16)) = int32(_a_F_px_find_digest_5)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+12)) = int32(_a_F_px_find_digest_6)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+8)) = int32(_a_F_px_find_digest_7)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+4)) = int32(_a_F_px_find_digest_8)
	*(*int32)(unsafe.Add(mBase, uint32(v154))) = int32(_a_F_px_find_digest_9)
