...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v123)+12)) = v148
	F_ResourceOwnerRemember(m, v148, v123, int32(4361304))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L37
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v154)+20)) = int32(6379)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+16)) = int32(6380)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+12)) = int32(6381)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+8)) = int32(6382)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+4)) = int32(6383)
	*(*int32)(unsafe.Add(mBase, uint32(v154))) = int32(6384)
