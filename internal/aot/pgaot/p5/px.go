...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v123)+12)) = v148
	F_ResourceOwnerRemember(m, v148, v123, int32(4394232))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L37
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v154)+20)) = int32(6835)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+16)) = int32(6836)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+12)) = int32(6837)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+8)) = int32(6838)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+4)) = int32(6839)
	*(*int32)(unsafe.Add(mBase, uint32(v154))) = int32(6840)
