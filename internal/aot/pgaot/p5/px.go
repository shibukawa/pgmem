...
L1:
	;
	v114 = *(*int32)(unsafe.Add(mBase, _consts[11]))
...
L22:
	...
	v67 = *(*int32)(unsafe.Add(mBase, uint32(v64)+uint32(_consts[1456])))
	v70 = v67
	v71 = l0
	goto L24
L23:
...
L38:
	...
	v121 = *(*int32)(unsafe.Add(mBase, _consts[147]))
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v123)+4)) = v132 & int32(65535)
	v148 = *(*int32)(unsafe.Add(mBase, _consts[11]))
	*(*int32)(unsafe.Add(mBase, uint32(v123)+12)) = v148
	F_ResourceOwnerRemember(m, v148, v123, int32(4427304))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L37
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v154)+20)) = int32(7251)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+16)) = int32(7252)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+12)) = int32(7253)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+8)) = int32(7254)
	*(*int32)(unsafe.Add(mBase, uint32(v154)+4)) = int32(7255)
	*(*int32)(unsafe.Add(mBase, uint32(v154))) = int32(7256)
