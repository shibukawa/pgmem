...
L21:
	;
	F_errfinish(m, int32(507443), int32(3125), int32(315546))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L18
...
L28:
	;
	F_errfinish(m, int32(507443), int32(3134), int32(315546))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L18
...
L56:
	;
	v298 = *(*int32)(unsafe.Add(mBase, uint32(v290*int32(52)+int32(1674576)+v289<<(uint(int32(2))%32))))
...
L60:
	...
	v261 = v240 - int32(1)
	v265 = *(*int32)(unsafe.Add(mBase, uint32(base.B2i32(v253 == int32(0))*int32(52)+int32(1674576)+v261<<(uint(int32(2))%32))))
	if v243 <= v265 {
		v300 = v243
		goto L55
	} else {
...
L142:
	;
	F_errfinish(m, int32(507443), int32(3151), int32(315546))
	mBase = m.M
	v821 = m.ExcPending
	if v821 != 0 {
		goto L18
...
L146:
	;
	F_errfinish(m, int32(507443), int32(3156), int32(315546))
	mBase = m.M
	v837 = m.ExcPending
	if v837 != 0 {
		goto L18
...
L150:
	;
	F_errfinish(m, int32(507443), int32(3188), int32(315546))
	mBase = m.M
	v853 = m.ExcPending
	if v853 != 0 {
		goto L18
...
L154:
	;
	F_errfinish(m, int32(507443), int32(3199), int32(315546))
	mBase = m.M
	v869 = m.ExcPending
	if v869 != 0 {
		goto L18
...
L158:
	;
	F_errfinish(m, int32(507443), int32(3211), int32(315546))
	mBase = m.M
	v885 = m.ExcPending
	if v885 != 0 {
		goto L18
...
L162:
	;
	F_errfinish(m, int32(507443), int32(3216), int32(315546))
	mBase = m.M
	v901 = m.ExcPending
	if v901 != 0 {
		goto L18
...
L166:
	;
	F_errfinish(m, int32(507443), int32(3205), int32(315546))
	mBase = m.M
	v920 = m.ExcPending
	if v920 != 0 {
		goto L18
...
L170:
	;
	F_errfinish(m, int32(507443), int32(3175), int32(315546))
	mBase = m.M
	v938 = m.ExcPending
	if v938 != 0 {
		goto L18
					...
					if v190 != 0 {
						...
						if v193 != 0 {
							...
							if v197 != 0 {
								...
								F_errfinish(m, int32(510157), int32(4017), int32(234976))
								mBase = m.M
								v202 = m.ExcPending
								if v202 != 0 {
									return int32(0)
							...
							if v561 != 0 {
								...
								if v564 != 0 {
									...
									if v568 != 0 {
										...
										F_errfinish(m, int32(507443), int32(6382), int32(380833))
										mBase = m.M
										v573 = m.ExcPending
										if v573 != 0 {
											return int32(0)
							...
							if v529 != 0 {
								...
								if v532 != 0 {
									...
									if v536 != 0 {
										...
										F_errfinish(m, int32(507443), int32(6361), int32(380833))
										mBase = m.M
										v541 = m.ExcPending
										if v541 != 0 {
											return int32(0)
							...
							if v545 != 0 {
								...
								if v548 != 0 {
									...
									if v552 != 0 {
										...
										F_errfinish(m, int32(507443), int32(6371), int32(380833))
										mBase = m.M
										v557 = m.ExcPending
										if v557 != 0 {
											return int32(0)
									...
									if v486 != 0 {
										...
										if v489 != 0 {
											...
											if v493 != 0 {
												...
												F_errfinish(m, int32(507443), int32(6376), int32(380833))
												mBase = m.M
												v498 = m.ExcPending
												if v498 != 0 {
													return int32(0)
