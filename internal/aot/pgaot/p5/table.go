			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v25 + int32(4)
					F_errmsg(m, int32(_a_F_table_openrv_0), v6)
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
						...
						if v35 != 0 {
							...
							F_errfinish(m, int32(_a_F_table_openrv_1), int32(147), int32(_a_F_table_openrv_2))
							mBase = m.M
							v40 = m.ExcPending
							if v40 != 0 {
								return int32(0)
				...
				if v24 != 0 {
					...
					if v27 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v28 + int32(4)
						F_errmsg(m, int32(_a_F_table_openrv_extended_0), v7)
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return int32(0)
							...
							if v38 != 0 {
								...
								F_errfinish(m, int32(_a_F_table_openrv_extended_1), int32(147), int32(_a_F_table_openrv_extended_2))
								mBase = m.M
								v43 = m.ExcPending
								if v43 != 0 {
									return int32(0)
				...
				if v23 != 0 {
					...
					if v26 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = v27 + int32(4)
						F_errmsg(m, int32(_a_F_try_table_open_0), v6)
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
							...
							if v37 != 0 {
								...
								F_errfinish(m, int32(_a_F_try_table_open_1), int32(147), int32(_a_F_try_table_open_2))
								mBase = m.M
								v42 = m.ExcPending
								if v42 != 0 {
									return int32(0)
