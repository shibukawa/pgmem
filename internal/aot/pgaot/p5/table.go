	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v21 != 0 {
			...
			v23 = F_convert_any_priv_string(m, v14, int32(1672768))
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return int32(0)
				...
				if v16 != 0 {
					...
					if v18 != 0 {
						...
						if v24 != 0 {
							...
							v26 = F_convert_any_priv_string(m, v11, int32(1672768))
							mBase = m.M
							v27 = m.ExcPending
							if v27 != 0 {
								return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v25 + int32(4)
					...
					if v31 != 0 {
						...
						if v35 != 0 {
							...
							F_errfinish(m, int32(511071), int32(147), int32(434904))
							mBase = m.M
							v40 = m.ExcPending
							if v40 != 0 {
								return int32(0)
						...
						if v34 != 0 {
							...
							if v38 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v37
								F_appendStringInfo(m, v9+int32(16), int32(202175), v9)
								mBase = m.M
								v44 = m.ExcPending
								if v44 != 0 {
									return int32(0)
