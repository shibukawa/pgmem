...
L15:
	;
	F_errfinish(m, int32(520836), int32(104), int32(373645))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L2
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = l0
	F_errmsg(m, int32(350287), v20+int32(32))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L2
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+48)) = l0
	F_errmsg(m, int32(350462), v20+int32(48))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L2
...
L21:
	;
	v62 = *(*int32)(unsafe.Add(mBase, uint32(l5<<(uint(int32(3))%32))+uint32(_consts[253])))
	v63 = v62
	goto L23
L22:
	;
...
L28:
	;
	F_errfinish(m, int32(520836), int32(114), int32(373645))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L2
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+64)) = l0
	F_errmsg(m, int32(124309), v20-int32(-64))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L2
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+80)) = l0
	F_errmsg(m, int32(124692), v20+int32(80))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L2
...
L34:
	;
	v99 = *(*int32)(unsafe.Add(mBase, uint32(l5<<(uint(int32(3))%32))+uint32(_consts[253])))
	v100 = v99
	goto L36
L35:
	;
...
L40:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _consts[247]))
...
L60:
	;
	F_errfinish(m, int32(520836), int32(160), int32(373645))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L2
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = l0
	F_errmsg(m, int32(124309), v20+int32(16))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L2
...
L64:
	;
	F_errfinish(m, int32(520836), int32(167), int32(373645))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L2
...
L97:
	;
	v262 = *(*int32)(unsafe.Add(mBase, _consts[229]))
	if v262 != 0 {
		goto L98
	} else {
		goto L99
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
	F_errmsg_internal(m, int32(49700), v9)
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L7:
	;
	F_errfinish(m, int32(524545), int32(2434), int32(70283))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L1
...
L11:
	;
	v39 = int32(0)
	v41 = *(*int32)(unsafe.Add(mBase, _consts[246]))
	if v41 == v39 {
		goto L15
	} else {
		goto L16
...
func F_get_collation_oid(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v12 = v10 - int32(16)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[247]))
...
L31:
	;
	v70 = int32(0)
	v72 = *(*int32)(unsafe.Add(mBase, _consts[246]))
	if v72 == v70 {
		goto L32
	} else {
		goto L33
...
L35:
	...
	v94 = *(*int32)(unsafe.Add(mBase, _consts[245]))
	if v92 == v94 {
		goto L37
	} else {
		goto L38
...
L58:
	;
	v180 = *(*int32)(unsafe.Add(mBase, _consts[247]))
...
L60:
	;
	F_errfinish(m, int32(524545), int32(4020), int32(455279))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		goto L2
