...
func F_replorigin_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v8)+4)) = uint32(v22)
		F_appendStringInfo(m, l0, int32(488089), v8)
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
	...
	case 16:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v27
		F_appendStringInfo(m, l0, int32(44398), v8+int32(16))
		mBase = m.M
		v33 = m.ExcPending
		if v33 != 0 {
			return
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v88
	F_errmsg(m, int32(480601), v12+int32(16))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(497719), int32(395), int32(230976))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v19
	F_errmsg_internal(m, int32(481074), v12)
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
...
L48:
	;
	F_errfinish(m, int32(497719), int32(460), int32(379195))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L1
