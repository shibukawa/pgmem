...
func F_replorigin_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v8)+4)) = uint32(v22)
		F_appendStringInfo(m, l0, int32(464651), v8)
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
	...
	case 16:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v27
		F_appendStringInfo(m, l0, int32(41704), v8+int32(16))
		mBase = m.M
		v33 = m.ExcPending
		if v33 != 0 {
			return
...
L14:
	;
	v46 = *(*int32)(unsafe.Add(mBase, _consts[520]))
	if v46 <= int32(0) {
		goto L15
	} else {
		goto L16
...
L17:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _consts[521]))
	v62 = int32(0)
	goto L19
L18:
	;
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v88
	F_errmsg(m, int32(457331), v12+int32(16))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(473565), int32(395), int32(219039))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L39:
	;
	v139 = *(*int32)(unsafe.Add(mBase, _consts[520]))
	if int32(0) < v139 {
		v56 = v139
		goto L17
	} else {
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v19
	F_errmsg_internal(m, int32(457804), v12)
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
...
L48:
	;
	F_errfinish(m, int32(473565), int32(460), int32(359648))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L1
...
func F_replorigin_reset(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int64)(unsafe.Add(mBase, _consts[111])) = v4
	v10 = int32(0)
	*(*uint16)(unsafe.Add(mBase, _consts[107])) = uint16(v10)
	return
}
func F_replorigin_session_advance(m *base.Module, l0 int64, l1 int64) {
	...
	var v22 int32
	_ = v22
	v5 = *(*int32)(unsafe.Add(mBase, _consts[522]))
	...
	if v10 != 0 {
		...
		v12 = *(*int32)(unsafe.Add(mBase, _consts[522]))
...
func F_replorigin_session_get_progress(m *base.Module) int64 {
	...
	var v19 int32
	_ = v19
	v4 = *(*int32)(unsafe.Add(mBase, _consts[522]))
	...
	if v11 != 0 {
		...
		v13 = *(*int32)(unsafe.Add(mBase, _consts[522]))
