...
func F_replorigin_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v8)+4)) = uint32(v22)
		F_appendStringInfo(m, l0, int32(505612), v8)
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
	...
	case 16:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v27
		F_appendStringInfo(m, l0, int32(47385), v8+int32(16))
		mBase = m.M
		v33 = m.ExcPending
		if v33 != 0 {
			return
...
L14:
	;
	v46 = *(*int32)(unsafe.Add(mBase, _consts[516]))
	if v46 <= int32(0) {
		goto L15
	} else {
		goto L16
...
L17:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _consts[517]))
	v62 = int32(0)
	goto L19
L18:
	;
...
L25:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v88
	F_errmsg(m, int32(498124), v12+int32(16))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(516559), int32(395), int32(240276))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L38:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v19
	F_errmsg_internal(m, int32(498597), v12)
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
...
L48:
	;
	F_errfinish(m, int32(516559), int32(460), int32(393693))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L1
...
func F_replorigin_reset(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int64)(unsafe.Add(mBase, _consts[112])) = v4
	v10 = int32(0)
	*(*uint16)(unsafe.Add(mBase, _consts[110])) = uint16(v10)
	return
}
func F_replorigin_session_advance(m *base.Module, l0 int64, l1 int64) {
	...
	var v22 int32
	_ = v22
	v5 = *(*int32)(unsafe.Add(mBase, _consts[518]))
	...
	if v10 != 0 {
		...
		v12 = *(*int32)(unsafe.Add(mBase, _consts[518]))
...
func F_replorigin_session_get_progress(m *base.Module) int64 {
	...
	if v11 != 0 {
		...
		v13 = *(*int32)(unsafe.Add(mBase, _consts[518]))
