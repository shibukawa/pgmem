...
func F_ValidateSlotSyncParams(m *base.Module, l0 int32) int32 {
	...
	if v11 <= int32(1) {
		...
		if v18 != 0 {
			...
			if v15 == int32(0) {
				...
				if v23 != 0 {
					...
					F_errmsg(m, int32(702574), int32(0))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
						...
						v90 = v2
						v92 = int32(1070)
						F_errfinish(m, int32(490934), v92, int32(148409))
						mBase = m.M
						v95 = m.ExcPending
						if v95 != 0 {
							return int32(0)
		...
		v30 = *(*int32)(unsafe.Add(mBase, _consts[524]))
		if v30 != 0 {
			v31 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v30))))
			if v31 != 0 {
				v47 = int32(0)
				v49 = int32(*(*uint8)(unsafe.Add(mBase, _consts[525])))
				if v49 == v47 {
					...
					if v54 != 0 {
						...
						if v53 == int32(0) {
							...
							if v59 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(313920)
								F_errmsg(m, int32(447898), v7+int32(32))
								mBase = m.M
								v66 = m.ExcPending
								if v66 != 0 {
									return int32(0)
					...
					v69 = *(*int32)(unsafe.Add(mBase, _consts[526]))
					if v69 != 0 {
							...
							if v76 != 0 {
								...
								if v75 == int32(0) {
									...
									if v81 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(237253)
										F_errmsg(m, int32(104801), v7+int32(16))
										mBase = m.M
										v88 = m.ExcPending
										if v88 != 0 {
											return int32(0)
				...
				if v35 != 0 {
					...
					if v34 == int32(0) {
						...
						if v40 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(371762)
							F_errmsg(m, int32(104801), v7)
							mBase = m.M
							v45 = m.ExcPending
							if v45 != 0 {
								return int32(0)
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, _consts[537])) = v45
...
L25:
	;
	F_errfinish(m, int32(486550), int32(847), int32(495060))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L1
