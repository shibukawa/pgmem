		...
		if v18 != 0 {
			...
			if v15 == int32(0) {
				...
				if v23 != 0 {
					...
					F_errmsg(m, int32(761539), int32(0))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
						...
						v90 = v2
						v92 = int32(1070)
						F_errfinish(m, int32(523799), v92, int32(160432))
						mBase = m.M
						v95 = m.ExcPending
						if v95 != 0 {
							return int32(0)
					...
					if v54 != 0 {
						...
						if v53 == int32(0) {
							...
							if v59 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(334499)
								F_errmsg(m, int32(476336), v7+int32(32))
								mBase = m.M
								v66 = m.ExcPending
								if v66 != 0 {
									return int32(0)
							...
							if v76 != 0 {
								...
								if v75 == int32(0) {
									...
									if v81 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(253002)
										F_errmsg(m, int32(113738), v7+int32(16))
										mBase = m.M
										v88 = m.ExcPending
										if v88 != 0 {
											return int32(0)
				...
				if v35 != 0 {
					...
					if v34 == int32(0) {
						...
						if v40 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(396128)
							F_errmsg(m, int32(113738), v7)
							mBase = m.M
							v45 = m.ExcPending
							if v45 != 0 {
								return int32(0)
...
L25:
	;
	F_errfinish(m, int32(518511), int32(847), int32(528559))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L1
