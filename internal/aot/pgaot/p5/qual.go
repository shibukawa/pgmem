...
L10:
	;
	v240 = *(*float64)(unsafe.Add(mBase, _consts[383]))
...
L14:
	;
	v146 = *(*float64)(unsafe.Add(mBase, _consts[383]))
...
L55:
	;
	F_errmsg_internal(m, int32(117754), int32(0))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L25
...
L56:
	;
	F_errfinish(m, int32(524663), int32(5006), int32(233616))
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L25
