...
func F_call_int_check_hook(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v14 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_call_int_check_hook[0])) = int32(50856066)
		v21 = int32(0)
		*(*int32)(unsafe.Add(mBase, _c_F_call_int_check_hook[1])) = v21
		*(*int32)(unsafe.Add(mBase, _c_F_call_int_check_hook[2])) = v21
		*(*int32)(unsafe.Add(mBase, _c_F_call_int_check_hook[3])) = v21
		...
		if v32 != 0 {
			...
			if v29 != 0 {
				...
				if v35 != 0 {
					...
					if v34 != 0 {
						v37 = *(*int32)(unsafe.Add(mBase, _c_F_call_int_check_hook[0]))
						F_errcode(m, v37)
						mBase = m.M
						v39 = m.ExcPending
						if v39 != 0 {
							...
							v41 = *(*int32)(unsafe.Add(mBase, _c_F_call_int_check_hook[1]))
							if v41 != 0 {
								*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v41
								F_errmsg_internal(m, int32(_a_F_call_int_check_hook_0), v9+int32(-16))
								mBase = m.M
								v47 = m.ExcPending
								if v47 != 0 {
									return int32(0)
								} else {
									v59 = *(*int32)(unsafe.Add(mBase, _c_F_call_int_check_hook[2]))
									if v59 != 0 {
										*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v59
										F_errdetail_internal(m, int32(_a_F_call_int_check_hook_0), v9+int32(-48))
										mBase = m.M
										v65 = m.ExcPending
										if v65 != 0 {
											return int32(0)
										} else {
											v67 = *(*int32)(unsafe.Add(mBase, _c_F_call_int_check_hook[3]))
											if v67 != 0 {
												*(*int32)(unsafe.Add(mBase, uint32(v11))) = v67
												F_errhint(m, int32(_a_F_call_int_check_hook_0), v11)
												mBase = m.M
												v71 = m.ExcPending
												if v71 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(_a_F_call_int_check_hook_1), int32(_a_F_call_int_check_hook_2), int32(_a_F_call_int_check_hook_3))
													mBase = m.M
													v76 = m.ExcPending
													if v76 != 0 {
														return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v48
								F_errmsg(m, int32(_a_F_call_int_check_hook_4), v9+int32(-32))
								mBase = m.M
								v56 = m.ExcPending
								if v56 != 0 {
									return int32(0)
...
L139:
	...
	v412 = int32(_a_F_checkcondition_str_0)
	v413 = v411 & v412
