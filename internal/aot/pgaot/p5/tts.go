...
L6:
	;
	F_errmsg(m, int32(60200), int32(0))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L7:
	;
	F_errfinish(m, int32(492396), int32(796), int32(382279))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L4
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = base.I32_extend16_s(v258)
	F_errmsg_internal(m, int32(481560), v19+int32(32))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L43
	...
	if v6 == int32(0) {
		...
		if v14 != 0 {
			...
			if v17 != 0 {
				...
				F_errmsg(m, int32(60090), int32(0))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(492396), int32(369), int32(205812))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return int32(0)
