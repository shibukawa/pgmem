...
L6:
	;
	F_errmsg(m, int32(59585), int32(0))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L7:
	;
	F_errfinish(m, int32(485719), int32(796), int32(376932))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L4
	...
	if v6 == int32(0) {
		...
		if v14 != 0 {
			...
			if v17 != 0 {
				...
				F_errmsg(m, int32(59475), int32(0))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(485719), int32(369), int32(203175))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return int32(0)
