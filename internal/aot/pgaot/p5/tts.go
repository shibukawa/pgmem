...
L6:
	;
	F_errmsg(m, int32(60346), int32(0))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L7:
	;
	F_errfinish(m, int32(494583), int32(796), int32(383845))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L4
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = base.I32_extend16_s(v258)
	F_errmsg_internal(m, int32(483697), v19+int32(32))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L43
	...
	if v6 == int32(0) {
		...
		if v14 != 0 {
			...
			if v17 != 0 {
				...
				F_errmsg(m, int32(60236), int32(0))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(494583), int32(369), int32(206314))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return int32(0)
