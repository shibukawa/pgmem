...
L6:
	;
	F_errmsg(m, int32(_a_F_tts_buffer_is_current_xact_tuple_0), int32(0))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L7:
	;
	F_errfinish(m, int32(_a_F_tts_buffer_is_current_xact_tuple_1), int32(796), int32(_a_F_tts_buffer_is_current_xact_tuple_2))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L4
...
L12:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_tts_buffer_is_current_xact_tuple[0]))
	if v35 == v24 {
		goto L13
	} else {
		goto L14
...
L15:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _c_F_tts_buffer_is_current_xact_tuple[1]))
	if v39 <= int32(0) {
		goto L17
	} else {
		goto L18
...
L17:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _c_F_tts_buffer_is_current_xact_tuple[2]))
	if v43 == int32(0) {
		v136 = int32(0)
		goto L16
	} else {
...
L19:
	;
	v105 = *(*int32)(unsafe.Add(mBase, _c_F_tts_buffer_is_current_xact_tuple[3]))
	v107 = int32(0)
	v109 = v39 - int32(1)
	goto L39
L20:
...
L14:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(l0)+6)) = uint16(v27)
	...
	v341 = v339 & int32(_a_F_tts_heap_getsomeattrs_0)
...
L24:
	...
	if v83 == int32(_a_F_tts_heap_getsomeattrs_1) {
		goto L26
	} else {
		goto L27
	}
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = base.I32_extend16_s(v104)
	F_errmsg_internal(m, int32(_a_F_tts_heap_getsomeattrs_2), v19)
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L43
...
L45:
	;
	F_errfinish(m, int32(_a_F_tts_heap_getsomeattrs_3), int32(70), int32(_a_F_tts_heap_getsomeattrs_4))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L43
...
L78:
	...
	if v238 == int32(_a_F_tts_heap_getsomeattrs_1) {
		goto L79
	} else {
		goto L80
	}
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = base.I32_extend16_s(v258)
	F_errmsg_internal(m, int32(_a_F_tts_heap_getsomeattrs_2), v19+int32(32))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L43
...
L126:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v382+v379))) = uint8(v417)
	...
	v423 = int32(_a_F_tts_heap_getsomeattrs_1)
	v424 = v422 & v423
	if v424 == v423 {
		goto L130
	} else {
...
L142:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v422
	F_errmsg_internal(m, int32(_a_F_tts_heap_getsomeattrs_2), v19+int32(16))
	mBase = m.M
	v459 = m.ExcPending
	if v459 != 0 {
		goto L43
	...
	if v6 == int32(0) {
		...
		if v14 != 0 {
			...
			if v17 != 0 {
				...
				F_errmsg(m, int32(_a_F_tts_heap_getsysattr_0), int32(0))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_tts_heap_getsysattr_1), int32(369), int32(_a_F_tts_heap_getsysattr_2))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return int32(0)
			...
			*(*uint16)(unsafe.Add(mBase, uint32(l0)+4)) = uint16(v26)
			...
			if v29 <= v30 {
				...
				*(*uint16)(unsafe.Add(mBase, uint32(l0)+6)) = uint16(v171)
				...
				v176 = v174 & int32(_a_F_tts_virtual_copyslot_0)
