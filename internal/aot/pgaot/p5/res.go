...
func F_ResOwnerPrintBufferPin(m *base.Module, l0 int32) int32 {
	...
	if l0 < v2 {
		...
		v16 = l0 ^ int32(-1)
		v21 = *(*int32)(unsafe.Add(mBase, _consts[613]))
		...
		if v101 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v9 + int32(36)
			v116 = F_psprintf(m, int32(654479), v9)
			mBase = m.M
			v117 = m.ExcPending
			if v117 != 0 {
				return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v9)+108)) = l0
		...
		if l0 == v37 {
			...
			v41 = *(*int32)(unsafe.Add(mBase, _consts[615]))
			if l0 == v41 {
				v84 = int32(4386248)
				v85 = *(*int32)(unsafe.Add(mBase, uint32(v84)+4))
				v87 = v85
				...
				v45 = *(*int32)(unsafe.Add(mBase, _consts[616]))
				if l0 == v45 {
					v84 = int32(4386256)
					v85 = *(*int32)(unsafe.Add(mBase, uint32(v84)+4))
					v87 = v85
					...
					v49 = *(*int32)(unsafe.Add(mBase, _consts[617]))
					if l0 == v49 {
						v84 = int32(4386264)
						v85 = *(*int32)(unsafe.Add(mBase, uint32(v84)+4))
						v87 = v85
						...
						v53 = *(*int32)(unsafe.Add(mBase, _consts[618]))
						if l0 == v53 {
							v84 = int32(4386272)
							v85 = *(*int32)(unsafe.Add(mBase, uint32(v84)+4))
							v87 = v85
							...
							v57 = *(*int32)(unsafe.Add(mBase, _consts[619]))
							if l0 == v57 {
								v84 = int32(4386280)
								v85 = *(*int32)(unsafe.Add(mBase, uint32(v84)+4))
								v87 = v85
								...
								v61 = *(*int32)(unsafe.Add(mBase, _consts[620]))
								if l0 == v61 {
									v84 = int32(4386288)
									v85 = *(*int32)(unsafe.Add(mBase, uint32(v84)+4))
									v87 = v85
									...
									if l0 == v65 {
										...
										v69 = *(*int32)(unsafe.Add(mBase, _consts[605]))
										if v69 == int32(0) {
											v87 = v2
											v90 = v29 + l0<<(uint(int32(6))%32) + int32(-64)
											v91 = v87
											...
											v73 = *(*int32)(unsafe.Add(mBase, _consts[622]))
											v76 = int32(0)
