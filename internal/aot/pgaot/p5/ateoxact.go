...
func F_AtEOXact_GUC(m *base.Module, l0 int32, l1 int32) {
	...
	var v1341 int32
	_ = v1341
	v37 = *(*int32)(unsafe.Add(mBase, _consts[1295]))
	if v37 != 0 {
		goto L1
	} else {
		goto L2
...
L275:
	;
	v1184 = *(*int32)(unsafe.Add(mBase, _consts[1290]))
	if v1184 != 0 {
		goto L277
	} else {
		goto L278
...
L276:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1291])) = v95
	goto L271
L277:
	;
	v1186 = *(*int32)(unsafe.Add(mBase, _consts[1291]))
	v1191 = v1186
	goto L276
L278:
	;
...
L279:
	;
	v1188 = int32(4441020)
	*(*int32)(unsafe.Add(mBase, _consts[1290])) = v1188
	v1191 = v1188
	goto L276
L280:
	;
...
L290:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v85))) = v1258 | int32(4)
	v1264 = int32(4441028)
	v1265 = *(*int32)(unsafe.Add(mBase, _consts[1293]))
	*(*int32)(unsafe.Add(mBase, uint32(v83))) = v1265
	*(*int32)(unsafe.Add(mBase, _consts[1293])) = v83
	v1288 = v1252
	goto L13
L291:
	;
