...
func F_CopyErrorData(m *base.Module) int32 {
	...
	var v106 int32
	_ = v106
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1149]))
	if int32(0) <= v4 {
		goto L1
	} else {
		goto L2
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1149])) = int32(-1)
...
L7:
	;
	v17 = F__emscripten_memcpy_bulkmem(m, v8, v4*v12+int32(4418208), v12)
	mBase = m.M
	goto L9
L9:
	;
...
L76:
	;
	v88 = *(*int32)(unsafe.Add(mBase, _consts[9]))
...
L79:
	;
	F_errfinish(m, int32(467494), int32(1760), int32(473995))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L4
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v87
	F_errmsg(m, int32(191874), v11+int32(16))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L17
...
L34:
	;
	F_errfinish(m, int32(468032), int32(318), int32(473942))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L17
...
L38:
	;
	F_errfinish(m, int32(468032), int32(303), int32(473942))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L17
...
L45:
	;
	F_errfinish(m, int32(468032), int32(278), int32(473942))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L17
...
L49:
	;
	F_errfinish(m, int32(468032), int32(295), int32(473942))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L17
...
L67:
	;
	F_errmsg(m, int32(276866), int32(0))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L17
...
L68:
	;
	F_errfinish(m, int32(468032), int32(256), int32(473942))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L17
...
func F_checkDataDir(m *base.Module) {
	...
	v6 = v4 - int32(144)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[132]))
	v14 = F___fstatat(m, int32(-100), v9, v6+int32(48), int32(0))
	mBase = m.M
	if v14 != 0 {
		v16 = *(*int32)(unsafe.Add(mBase, _consts[86]))
		...
		if v20 != 0 {
			...
			if v22 != 0 {
				...
				v24 = *(*int32)(unsafe.Add(mBase, _consts[132]))
				if v16 == int32(44) {
					*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v24
					F_errmsg(m, int32(66426), v6+int32(16))
					mBase = m.M
					v55 = m.ExcPending
					if v55 != 0 {
						return
					} else {
						F_errfinish(m, int32(462910), int32(359), int32(201095))
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = v24
					F_errmsg(m, int32(278434), v6+int32(32))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return
					} else {
						F_errfinish(m, int32(462910), int32(364), int32(201095))
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return
		...
		if v38&int32(61440) != int32(16384) {
			...
			if v64 != 0 {
				...
				if v67 != 0 {
					...
					v69 = *(*int32)(unsafe.Add(mBase, _consts[132]))
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v69
					F_errmsg(m, int32(12420), v6)
					mBase = m.M
					v73 = m.ExcPending
					if v73 != 0 {
						return
					} else {
						F_errfinish(m, int32(462910), int32(372), int32(201095))
						mBase = m.M
						v78 = m.ExcPending
						if v78 != 0 {
							return
			...
			v44 = *(*int32)(unsafe.Add(mBase, _consts[132]))
...
func F_dataPrepareDownlink(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v8 != 0 {
		...
		if l1 < int32(0) {
			...
			v20 = *(*int32)(unsafe.Add(mBase, _consts[12]))
		...
		if l1 < int32(0) {
			...
			v38 = *(*int32)(unsafe.Add(mBase, _consts[16]))
