...
func F_CopyErrorData(m *base.Module) int32 {
	...
	var v106 int32
	_ = v106
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1135]))
	if int32(0) <= v4 {
		goto L1
	} else {
		goto L2
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1135])) = int32(-1)
...
L7:
	;
	v17 = F__emscripten_memcpy_bulkmem(m, v8, v4*v12+int32(4555024), v12)
	mBase = m.M
	goto L9
L9:
	;
...
L79:
	;
	F_errfinish(m, int32(523980), int32(1760), int32(532094))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L4
...
L15:
	;
	v37 = int32(4556752)
	v39 = *(*int32)(unsafe.Add(mBase, _consts[281]))
	*(*int32)(unsafe.Add(mBase, _consts[281])) = v39 + int32(1)
	F_pq_startmsgread(m)
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
...
L27:
	;
	v67 = int32(4556752)
	v69 = *(*int32)(unsafe.Add(mBase, _consts[281]))
	*(*int32)(unsafe.Add(mBase, _consts[281])) = v69 - int32(1)
	switch v50 {
	case 0, 11:
		goto L15
	default:
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v87
	F_errmsg(m, int32(215074), v11+int32(16))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L17
...
L34:
	;
	F_errfinish(m, int32(524537), int32(318), int32(532041))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L17
...
L38:
	;
	F_errfinish(m, int32(524537), int32(303), int32(532041))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L17
...
L45:
	;
	F_errfinish(m, int32(524537), int32(278), int32(532041))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L17
...
L49:
	;
	F_errfinish(m, int32(524537), int32(295), int32(532041))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L17
...
L67:
	;
	F_errmsg(m, int32(309797), int32(0))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L17
...
L68:
	;
	F_errfinish(m, int32(524537), int32(256), int32(532041))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L17
...
func F_checkDataDir(m *base.Module) {
	...
	v6 = v4 - int32(144)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[134]))
	v14 = F___fstatat(m, int32(-100), v9, v6+int32(48), int32(0))
	mBase = m.M
	if v14 != 0 {
		v16 = *(*int32)(unsafe.Add(mBase, _consts[85]))
		...
		if v20 != 0 {
			...
			if v22 != 0 {
				...
				v24 = *(*int32)(unsafe.Add(mBase, _consts[134]))
				if v16 == int32(44) {
					*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v24
					F_errmsg(m, int32(76509), v6+int32(16))
					mBase = m.M
					v55 = m.ExcPending
					if v55 != 0 {
						return
					} else {
						F_errfinish(m, int32(517884), int32(359), int32(225153))
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = v24
					F_errmsg(m, int32(311365), v6+int32(32))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return
					} else {
						F_errfinish(m, int32(517884), int32(364), int32(225153))
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return
		...
		if v38&int32(61440) != int32(16384) {
			...
			if v64 != 0 {
				...
				if v67 != 0 {
					...
					v69 = *(*int32)(unsafe.Add(mBase, _consts[134]))
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v69
					F_errmsg(m, int32(13701), v6)
					mBase = m.M
					v73 = m.ExcPending
					if v73 != 0 {
						return
					} else {
						F_errfinish(m, int32(517884), int32(372), int32(225153))
						mBase = m.M
						v78 = m.ExcPending
						if v78 != 0 {
							return
			...
			v44 = *(*int32)(unsafe.Add(mBase, _consts[134]))
