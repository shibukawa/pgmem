...
func F_check_slru_buffers(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v10 = v8 & int32(15)
	if v10 != 0 {
		v12 = *(*int32)(unsafe.Add(mBase, _c_F_check_slru_buffers[0]))
		*(*int32)(unsafe.Add(mBase, _c_F_check_slru_buffers[1])) = v12
		*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = int32(16)
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		v20 = F_format_elog_string(m, int32(_a_F_check_slru_buffers_0), v6)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		} else {
			*(*int32)(unsafe.Add(mBase, _c_F_check_slru_buffers[2])) = v20
			m.G0 = v6 + int32(16)
