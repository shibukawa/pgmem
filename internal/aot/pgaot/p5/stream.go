...
L86:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v207)+60)) = int32(225704)
	*(*int32)(unsafe.Add(mBase, uint32(v207)+56)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v207)+52)) = int32(486671)
...
L88:
	...
	F_ResourceOwnerForget(m, v481, v482+int32(1), int32(1602544))
	mBase = m.M
	v487 = m.ExcPending
	if v487 != 0 {
		goto L66
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v207))) = v203
	F_errmsg_internal(m, int32(43628), v207)
	mBase = m.M
	v746 = m.ExcPending
	if v746 != 0 {
		goto L66
...
L157:
	;
	F_errfinish(m, int32(486671), int32(1382), int32(296307))
	mBase = m.M
	v751 = m.ExcPending
	if v751 != 0 {
		goto L66
...
func F_stream_cleanup_files(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+20)) = l1
	v16 = F_pg_snprintf(m, v6+int32(32), int32(1024), int32(166777), v6+int32(16))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
			v32 = F_pg_snprintf(m, v6+int32(32), int32(1024), int32(123490), v6)
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return
						...
						*(*int32)(unsafe.Add(mBase, _consts[9])) = v34
						...
						if v38 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = l0
							v66 = F_pg_snprintf(m, v8+int32(32), int32(1024), int32(166777), v8+int32(16))
							mBase = m.M
							v67 = m.ExcPending
							if v67 != 0 {
								return
								...
								if v71 != 0 {
									...
									if v70 != 0 {
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v8 + int32(32)
										F_errmsg_internal(m, int32(166997), v8)
										mBase = m.M
										v77 = m.ExcPending
										if v77 != 0 {
											return
										} else {
											F_errfinish(m, int32(486965), int32(4339), int32(379996))
											mBase = m.M
											v82 = m.ExcPending
											if v82 != 0 {
												return
...
func F_stream_stop_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(230526)
	...
	if v34 == v4 {
		...
		if v40 != 0 {
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(494837)
				F_errmsg(m, int32(313536), v8)
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
				} else {
					F_errfinish(m, int32(489070), int32(1358), int32(214732))
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return
