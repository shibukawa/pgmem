...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v28
	F_errmsg_internal(m, int32(480879), v7)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L6
...
L8:
	;
	F_errfinish(m, int32(495087), int32(5653), int32(417805))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L6
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v149
	F_errmsg_internal(m, int32(480879), v7+v151)
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L6
...
L70:
	;
	F_errfinish(m, int32(495087), int32(5659), int32(417805))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L6
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8)+28)) = int32(456100)
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(0)
	F_errmsg_internal(m, int32(487748), v8)
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L22
...
L45:
	;
	F_errfinish(m, int32(495087), int32(2954), int32(8406))
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L22
...
func F_ReleaseBuffer(m *base.Module, l0 int32) {
	...
	if l0 != 0 {
		if l0 < int32(0) {
			...
			F_ResourceOwnerForget(m, v12, v20+int32(1), int32(1628192))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return
		...
		if v37 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(0)
			F_errmsg_internal(m, int32(487748), v5)
			mBase = m.M
			v42 = m.ExcPending
			if v42 != 0 {
				return
			} else {
				F_errfinish(m, int32(495087), int32(5369), int32(226653))
				mBase = m.M
				v47 = m.ExcPending
				if v47 != 0 {
					return
