...
L24:
	;
	v399 = int32(_a_F_DecodeNumberField_1)
	if l2&v399 == v399 {
		v671 = v16
		goto L1
	} else {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v17))) = uint8(v19)
			if base.Ui32(v12) <= base.Ui32(int32(155)) {
				...
				if v31 != 0 {
					...
					F_parse_format(m, v30, v8, int32(_a_F_datetime_to_char_body_0), int32(_a_F_datetime_to_char_body_1), int32(_a_F_datetime_to_char_body_2), int32(1), int32(0))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return int32(0)
...
L287:
	;
	v680 = v200 + v679
	v685 = F_snprintf(m, v33+int32(320), int32(64), int32(_a_F_dopr_1), v33)
	mBase = m.M
	v686 = m.ExcPending
	if v686 != 0 {
		goto L33
...
L309:
	;
	v739 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dopr[1])))
	*(*uint8)(unsafe.Add(mBase, uint32(v33)+328)) = uint8(v739)
	v742 = *(*int64)(unsafe.Add(mBase, _c_F_dopr[2]))
...
L9:
	...
	v47 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dxsyn_init[0])))
...
L23:
	;
	v75 = int32(_a_F_dxsyn_init_1)
	v78 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dxsyn_init[1])))
...
L35:
	;
	v106 = int32(_a_F_dxsyn_init_2)
	v109 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dxsyn_init[2])))
...
L47:
	;
	v137 = int32(_a_F_dxsyn_init_3)
	v140 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dxsyn_init[3])))
...
L59:
	;
	v168 = int32(_a_F_dxsyn_init_4)
	v171 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dxsyn_init[4])))
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v208
	F_errmsg(m, int32(_a_F_dxsyn_init_5), v12+int32(16))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L1
...
L74:
	;
	F_errfinish(m, int32(_a_F_dxsyn_init_6), int32(191), int32(_a_F_dxsyn_init_7))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L1
...
L76:
	;
	v238 = F_get_tsearch_config_filename(m, v230, int32(_a_F_dxsyn_init_4))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L1
...
L122:
	...
	F_pg_qsort(m, v349, v332, int32(8), int32(_a_F_dxsyn_init_8))
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L1
...
L126:
	;
	F_errfinish(m, int32(_a_F_dxsyn_init_6), int32(89), int32(_a_F_dxsyn_init_10))
	mBase = m.M
	v373 = m.ExcPending
	if v373 != 0 {
		goto L1
