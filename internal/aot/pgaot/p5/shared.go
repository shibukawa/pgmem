...
func F_ReceiveSharedInvalidMessages(m *base.Module) {
	...
	v12 = v10 - int32(16)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[686]))
	v17 = *(*int32)(unsafe.Add(mBase, _consts[687]))
	if v15 < v17 {
		goto L1
	} else {
		goto L2
...
L7:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _consts[686]))
	v57 = *(*int32)(unsafe.Add(mBase, _consts[687]))
	if v55 < v57 {
		goto L4
	} else {
		goto L8
...
L9:
	;
	v80 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[687])) = v80
	*(*int32)(unsafe.Add(mBase, _consts[686])) = v80
	v87 = *(*int32)(unsafe.Add(mBase, _consts[691]))
	v89 = *(*int32)(unsafe.Add(mBase, _consts[72]))
	v92 = v87 + v89<<(uint(int32(4))%32)
	v95 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[692]))))
	if v95 == int32(1) {
		goto L12
	} else {
		goto L13
...
L10:
	;
	v291 = *(*int32)(unsafe.Add(mBase, _consts[693]))
	if v291 != 0 {
		goto L52
	} else {
		goto L53
...
L15:
	;
	v107 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[692]))) = uint8(v107)
...
L16:
	;
	F_s_lock(m, v87+int32(12), int32(484529), int32(511), int32(165074))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L6
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v87)+12)) = v119
	...
	v122 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[694]))))
	if v122 == v119 {
		goto L22
	} else {
		goto L23
...
L22:
	;
	v125 = *(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[695])))
	goto L21
L23:
	;
	goto L24
L24:
	;
	v126 = int32(0)
	*(*uint16)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[694]))) = uint16(v126)
	*(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[695]))) = v121
	v174 = int32(-1)
	goto L20
L25:
	;
...
L28:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v144)+uint32(_consts[689]))) = v152
	v154 = *(*int64)(unsafe.Add(mBase, uint32(v151)+8))
	*(*int64)(unsafe.Add(mBase, uint32(v144)+uint32(_consts[688]))) = v154
	v156 = *(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[695])))
	v157 = int32(1)
	v158 = v156 + v157
	*(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[695]))) = v158
	v161 = v134 + v157
	if v161 != int32(32) {
		v134 = v161
		v136 = v158
...
L30:
	;
	v169 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[696]))) = uint8(v169)
	v174 = v165
	goto L20
L31:
	;
...
L32:
	;
	v171 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[692]))) = uint8(v171)
	v174 = v165
	goto L20
L33:
	;
...
L38:
	;
	F_errmsg_internal(m, int32(103972), int32(0))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L6
...
L41:
	;
	F_errfinish(m, int32(488586), int32(103), int32(167526))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L6
...
L46:
	;
	v278 = *(*int32)(unsafe.Add(mBase, _consts[687]))
	if v278 == int32(32) {
		goto L9
	} else {
		goto L51
...
L49:
	;
	v264 = *(*int32)(unsafe.Add(mBase, _consts[686]))
	v266 = *(*int32)(unsafe.Add(mBase, _consts[687]))
	if v264 < v266 {
		goto L47
	} else {
		goto L50
...
L52:
	;
	v293 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[693])) = v293
...
L56:
	;
	F_errmsg_internal(m, int32(341897), int32(0))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L6
...
L59:
	;
	F_errfinish(m, int32(488586), int32(138), int32(167526))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L6
...
func F_SharedFileSetOnDetach(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1)+44)) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l1+int32(44), int32(484452), int32(101), int32(320765))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return
...
L1:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v28+int32(23)))) = uint8(v44)
	v47 = *(*int32)(unsafe.Add(mBase, _consts[594]))
		...
		if v10 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v6 + int32(8)
				F_errcontext_msg(m, int32(681689), v6)
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return
