...
L4:
	;
	v30 = int32(_a_F_ReceiveSharedInvalidMessages_0)
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0])) = v32 + int32(1)
	v37 = v32 << (uint(int32(4)) % 32)
	v40 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_ReceiveSharedInvalidMessages[2])))
	*(*int64)(unsafe.Add(mBase, uint32(v12+int32(8)))) = v40
	v44 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_ReceiveSharedInvalidMessages[3])))
	v45 = int32(_a_F_ReceiveSharedInvalidMessages_1)
	v47 = *(*int64)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[4]))
	*(*int64)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[4])) = v47 + int64(1)
...
L7:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0]))
	v57 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[1]))
	if v55 < v57 {
		goto L4
	} else {
		goto L8
...
L9:
	;
	v80 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[1])) = v80
	*(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0])) = v80
	v87 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[5]))
	v89 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[6]))
	v92 = v87 + v89<<(uint(int32(4))%32)
	v95 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[7]))))
	if v95 == int32(1) {
		goto L12
	} else {
		goto L13
...
L10:
	;
	v291 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[8]))
	if v291 != 0 {
		goto L52
	} else {
		goto L53
...
L12:
	;
	v99 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[9]))
...
L15:
	;
	v107 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[7]))) = uint8(v107)
...
L16:
	;
	F_s_lock(m, v87+int32(12), int32(_a_F_ReceiveSharedInvalidMessages_2), int32(511), int32(_a_F_ReceiveSharedInvalidMessages_3))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L6
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v87)+12)) = v119
	...
	v122 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[10]))))
	if v122 == v119 {
		goto L22
	} else {
		goto L23
...
L20:
	;
	v183 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[9]))
...
L22:
	;
	v125 = *(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[11])))
	goto L21
L23:
	;
	goto L24
L24:
	;
	v126 = int32(0)
	*(*uint16)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[10]))) = uint16(v126)
	*(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[11]))) = v121
	v174 = int32(-1)
	goto L20
L25:
	;
...
L28:
	...
	v148 = base.I32_rem_s(v136, int32(_a_F_ReceiveSharedInvalidMessages_4))
	v151 = v87 + int32(16) + v148<<(uint(v143)%32)
	v152 = *(*int64)(unsafe.Add(mBase, uint32(v151)))
	*(*int64)(unsafe.Add(mBase, uint32(v144)+uint32(_c_F_ReceiveSharedInvalidMessages[3]))) = v152
	v154 = *(*int64)(unsafe.Add(mBase, uint32(v151)+8))
	*(*int64)(unsafe.Add(mBase, uint32(v144)+uint32(_c_F_ReceiveSharedInvalidMessages[2]))) = v154
	v156 = *(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[11])))
	v157 = int32(1)
	v158 = v156 + v157
	*(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[11]))) = v158
	v161 = v134 + v157
	if v161 != int32(32) {
		v134 = v161
		v136 = v158
...
L30:
	;
	v169 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[12]))) = uint8(v169)
	v174 = v165
	goto L20
L31:
	;
...
L32:
	;
	v171 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v92)+uint32(_c_F_ReceiveSharedInvalidMessages[7]))) = uint8(v171)
	v174 = v165
	goto L20
L33:
	;
...
L36:
	;
	v220 = int32(_a_F_ReceiveSharedInvalidMessages_0)
	*(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0])) = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[1])) = v189
	v226 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0]))
	if v226 < v189 {
		goto L44
	} else {
		goto L45
...
L40:
	;
	v212 = int32(_a_F_ReceiveSharedInvalidMessages_1)
	v214 = *(*int64)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[4]))
	*(*int64)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[4])) = v214 + int64(1)
...
L46:
	;
	v278 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[1]))
	if v278 == int32(32) {
		goto L9
	} else {
		goto L51
...
L47:
	;
	v239 = int32(_a_F_ReceiveSharedInvalidMessages_0)
	v241 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0])) = v241 + int32(1)
	v246 = v241 << (uint(int32(4)) % 32)
	v249 = *(*int64)(unsafe.Add(mBase, uint32(v246)+uint32(_c_F_ReceiveSharedInvalidMessages[2])))
	*(*int64)(unsafe.Add(mBase, uint32(v12+int32(8)))) = v249
	v253 = *(*int64)(unsafe.Add(mBase, uint32(v246)+uint32(_c_F_ReceiveSharedInvalidMessages[3])))
	v254 = int32(_a_F_ReceiveSharedInvalidMessages_1)
	v256 = *(*int64)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[4]))
	*(*int64)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[4])) = v256 + int64(1)
...
L49:
	;
	v264 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[0]))
	v266 = *(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[1]))
	if v264 < v266 {
		goto L47
	} else {
		goto L50
...
L52:
	;
	v293 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_ReceiveSharedInvalidMessages[8])) = v293
...
L1:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v28+int32(23)))) = uint8(v44)
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_shared_buffer_readv_complete[0]))
...
L27:
	;
	v147 = int32(0)
	v151 = F__emscripten_memset_bulkmem(m, v124, base.I32_extend8_s(v147), int32(_a_F_shared_buffer_readv_complete_0))
	mBase = m.M
	goto L28
L28:
	;
		...
		if v10 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v6 + int32(8)
				F_errcontext_msg(m, int32(_a_F_shared_buffer_write_error_callback_0), v6)
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return
