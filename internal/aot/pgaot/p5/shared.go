...
L16:
	;
	F_s_lock(m, v87+int32(12), int32(493521), int32(511), int32(167919))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L6
...
L41:
	;
	F_errfinish(m, int32(497665), int32(103), int32(170381))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L6
...
L56:
	;
	F_errmsg_internal(m, int32(348172), int32(0))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L6
...
L59:
	;
	F_errfinish(m, int32(497665), int32(138), int32(170381))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L6
...
func F_SharedFileSetOnDetach(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1)+44)) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l1+int32(44), int32(493444), int32(101), int32(326525))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return
		...
		if v10 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v6 + int32(8)
				F_errcontext_msg(m, int32(707659), v6)
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return
