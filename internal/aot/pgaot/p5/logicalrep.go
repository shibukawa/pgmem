...
L32:
	;
	F_errfinish(m, int32(473359), int32(330), int32(373189))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L2
...
func F_logicalrep_worker_onexit(m *base.Module, l0 int32, l1 int32) {
	...
	var v198 int32
	_ = v198
	v8 = *(*int32)(unsafe.Add(mBase, _consts[512]))
	if v8 != 0 {
		goto L1
	} else {
		goto L2
...
L19:
	;
	v61 = *(*int32)(unsafe.Add(mBase, _consts[514]))
	if v61 <= int32(0) {
		goto L20
	} else {
		goto L21
...
L21:
	;
	v65 = *(*int32)(unsafe.Add(mBase, _consts[511]))
	v66 = *(*int32)(unsafe.Add(mBase, uint32(v65)+32))
	v68 = *(*int32)(unsafe.Add(mBase, _consts[515]))
	v70 = int32(0)
	v72 = v61
	v73 = int32(0)
	v74 = v68
...
L28:
	...
	v94 = *(*int32)(unsafe.Add(mBase, _consts[515]))
	v96 = v92
	v97 = v89
	v98 = v94
	goto L24
...
L40:
	;
	v159 = *(*int32)(unsafe.Add(mBase, _consts[511]))
	v160 = int64(0)
...
L41:
	;
	v181 = *(*int32)(unsafe.Add(mBase, _consts[511]))
...
L44:
	;
	v186 = int32(*(*uint8)(unsafe.Add(mBase, _consts[516])))
	if v186 == int32(0) {
		goto L46
	} else {
		goto L47
...
L48:
	;
	v194 = *(*int32)(unsafe.Add(mBase, _consts[515]))
