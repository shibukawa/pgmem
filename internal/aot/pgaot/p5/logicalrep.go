...
L32:
	;
	F_errfinish(m, int32(521739), int32(330), int32(411773))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L2
...
func F_logicalrep_worker_onexit(m *base.Module, l0 int32, l1 int32) {
	...
	var v198 int32
	_ = v198
	v8 = *(*int32)(unsafe.Add(mBase, _consts[507]))
	if v8 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v10 = *(*int32)(unsafe.Add(mBase, _consts[298]))
...
L8:
	;
	v152 = *(*int32)(unsafe.Add(mBase, _consts[8]))
	v156 = F_LWLockAcquire(m, v152+int32(5504), int32(0))
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L4
...
L9:
	...
	v58 = F_LWLockAcquire(m, v54+int32(5504), int32(1))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L4
...
L19:
	;
	v61 = *(*int32)(unsafe.Add(mBase, _consts[509]))
	if v61 <= int32(0) {
		goto L20
	} else {
		goto L21
...
L20:
	;
	v140 = *(*int32)(unsafe.Add(mBase, _consts[8]))
	F_LWLockRelease(m, v140+int32(5504))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L4
...
L21:
	;
	v65 = *(*int32)(unsafe.Add(mBase, _consts[506]))
	v66 = *(*int32)(unsafe.Add(mBase, uint32(v65)+32))
	v68 = *(*int32)(unsafe.Add(mBase, _consts[510]))
	v70 = int32(0)
	v72 = v61
	v73 = int32(0)
	v74 = v68
...
L28:
	;
	v92 = *(*int32)(unsafe.Add(mBase, _consts[509]))
...
L40:
	;
	v159 = *(*int32)(unsafe.Add(mBase, _consts[506]))
	v160 = int64(0)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v159)+36)) = v162
	v175 = *(*int32)(unsafe.Add(mBase, _consts[8]))
	F_LWLockRelease(m, v175+int32(5504))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L4
...
L41:
	;
	v181 = *(*int32)(unsafe.Add(mBase, _consts[506]))
...
L44:
	;
	v186 = int32(*(*uint8)(unsafe.Add(mBase, _consts[511])))
	if v186 == int32(0) {
		goto L46
	} else {
		goto L47
...
L48:
	;
	v194 = *(*int32)(unsafe.Add(mBase, _consts[510]))
