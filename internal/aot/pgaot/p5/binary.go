					...
					if v47 != 0 {
						...
						if v21 == int32(0) {
							...
							if v52 != int32(6) {
								...
								if v55 != int32(_a_F_IsBinaryTidClause_0) {
									v84 = v51
									return v84
								} else {
...
func F_binary_upgrade_logical_slot_has_caught_up(m *base.Module, l0 int32) int32 {
	...
	_ = v297
	v2 = int32(0)
	v16 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[0])))
	if v16 == v2 {
		goto L1
	} else {
		goto L2
...
L9:
	;
	v45 = int32(_a_F_binary_upgrade_logical_slot_has_caught_up_3)
	...
	*(*int64)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[2])) = v47
	v52 = *(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[1]))
	v53 = *(*int64)(unsafe.Add(mBase, uint32(v52)+272))
	*(*int64)(unsafe.Add(mBase, uint32(v52)+272)) = v53
	*(*int64)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[3])) = v53
	goto L13
L10:
	;
...
L17:
	...
	v98 = v95 - v85
	m.G0 = v98
	v102 = *(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[4]))
	v104 = *(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[5]))
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[5])) = v116
...
L27:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[4])) = v117
	*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[5])) = v118
...
L28:
	...
	v139 = *(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[6]))
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v66))) = v171
	F_errmsg_internal(m, int32(_a_F_binary_upgrade_logical_slot_has_caught_up_4), v66)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L24
...
L45:
	...
	v186 = *(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[7]))
	if v186 != 0 {
		goto L47
	} else {
		goto L48
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[4])) = v111
	v208 = int32(0)
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_logical_slot_has_caught_up[4])) = v215
	goto L54
L56:
	;
...
func F_binary_upgrade_set_next_toast_pg_class_oid(m *base.Module, l0 int32) int32 {
	...
	var v25 int32
	_ = v25
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_toast_pg_class_oid[0])))
	if v3 == int32(0) {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				F_errmsg(m, int32(_a_F_binary_upgrade_set_next_toast_pg_class_oid_0), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_binary_upgrade_set_next_toast_pg_class_oid_1), int32(145), int32(_a_F_binary_upgrade_set_next_toast_pg_class_oid_2))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_toast_pg_class_oid[1])) = v25
		return int32(0)
	}
}
