...
L6:
	;
	F_errmsg(m, int32(430923), int32(0))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L4
...
L7:
	;
	F_errfinish(m, int32(514348), int32(290), int32(244898))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L9:
	...
	*(*int64)(unsafe.Add(mBase, _consts[119])) = v47
	v52 = *(*int32)(unsafe.Add(mBase, _consts[114]))
	v53 = *(*int64)(unsafe.Add(mBase, uint32(v52)+272))
	*(*int64)(unsafe.Add(mBase, uint32(v52)+272)) = v53
	*(*int64)(unsafe.Add(mBase, _consts[118])) = v53
	goto L13
L10:
	;
...
L14:
	;
	v62 = *(*int64)(unsafe.Add(mBase, _consts[119]))
	goto L11
L15:
	;
	if v70 != int32(1) {
...
L17:
	...
	v98 = v95 - v85
	m.G0 = v98
	v102 = *(*int32)(unsafe.Add(mBase, _consts[142]))
	v104 = *(*int32)(unsafe.Add(mBase, _consts[143]))
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, _consts[143])) = v116
...
L27:
	;
	*(*int32)(unsafe.Add(mBase, _consts[142])) = v117
	*(*int32)(unsafe.Add(mBase, _consts[143])) = v118
...
L28:
	...
	v139 = *(*int32)(unsafe.Add(mBase, _consts[516]))
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v66))) = v171
	F_errmsg_internal(m, int32(212756), v66)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L24
...
L41:
	;
	F_errfinish(m, int32(520401), int32(2042), int32(328399))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L24
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v112)+4)) = int32(255471)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v111)+4)) = int32(993)
	v203 = int32(4546792)
	v204 = *(*int32)(unsafe.Add(mBase, _consts[142]))
	*(*int32)(unsafe.Add(mBase, uint32(v111))) = v204
	*(*int32)(unsafe.Add(mBase, _consts[142])) = v111
	v208 = int32(0)
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, _consts[142])) = v215
	goto L54
L56:
	;
	...
	if v10 != 0 {
		...
		if v11 == int32(1) {
			...
			if v80 != 0 {
				...
				F_errmsg_internal(m, int32(458682), int32(0))
				mBase = m.M
				v84 = m.ExcPending
				if v84 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(514348), int32(384), int32(435575))
					mBase = m.M
					v89 = m.ExcPending
					if v89 != 0 {
						return int32(0)
		...
		if v64 != 0 {
			...
			if v67 != 0 {
				...
				if v71 != 0 {
					...
					F_errfinish(m, int32(514348), int32(377), int32(435575))
					mBase = m.M
					v76 = m.ExcPending
					if v76 != 0 {
						return int32(0)
...
func F_binary_upgrade_set_next_toast_pg_class_oid(m *base.Module, l0 int32) int32 {
	...
	if v3 == int32(0) {
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(514348), int32(145), int32(453151))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[259])) = v25
		return int32(0)
	}
}
