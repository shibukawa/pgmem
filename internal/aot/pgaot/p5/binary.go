...
func F_binary_upgrade_logical_slot_has_caught_up(m *base.Module, l0 int32) int32 {
	...
	_ = v297
	v2 = int32(0)
	v16 = int32(*(*uint8)(unsafe.Add(mBase, _consts[79])))
	if v16 == v2 {
		goto L1
	} else {
		goto L2
...
L6:
	;
	F_errmsg(m, int32(405256), int32(0))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L4
...
L7:
	;
	F_errfinish(m, int32(484051), int32(290), int32(230091))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L9:
	...
	*(*int64)(unsafe.Add(mBase, _consts[118])) = v47
	v52 = *(*int32)(unsafe.Add(mBase, _consts[113]))
	v53 = *(*int64)(unsafe.Add(mBase, uint32(v52)+272))
	*(*int64)(unsafe.Add(mBase, uint32(v52)+272)) = v53
	*(*int64)(unsafe.Add(mBase, _consts[117])) = v53
	goto L13
L10:
	;
...
L14:
	;
	v62 = *(*int64)(unsafe.Add(mBase, _consts[118]))
	goto L11
L15:
	;
	if v70 != int32(1) {
...
L17:
	...
	v98 = v95 - v85
	m.G0 = v98
	v102 = *(*int32)(unsafe.Add(mBase, _consts[141]))
	v104 = *(*int32)(unsafe.Add(mBase, _consts[142]))
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, _consts[142])) = v116
...
L27:
	;
	*(*int32)(unsafe.Add(mBase, _consts[141])) = v117
	*(*int32)(unsafe.Add(mBase, _consts[142])) = v118
...
L28:
	...
	v139 = *(*int32)(unsafe.Add(mBase, _consts[519]))
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v66))) = v171
	F_errmsg_internal(m, int32(199694), v66)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L24
...
L41:
	;
	F_errfinish(m, int32(488655), int32(2042), int32(308984))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L24
...
L45:
	...
	v186 = *(*int32)(unsafe.Add(mBase, _consts[44]))
	if v186 != 0 {
		goto L47
	} else {
		goto L48
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v112)+4)) = int32(239865)
...
func F_binary_upgrade_replorigin_advance(m *base.Module, l0 int32) int32 {
	...
	v7 = v5 + int32(-64)
	m.G0 = v7
	v10 = int32(*(*uint8)(unsafe.Add(mBase, _consts[79])))
	if v10 != 0 {
		...
		if v11 == int32(1) {
			...
			if v80 != 0 {
				...
				F_errmsg_internal(m, int32(431627), int32(0))
				mBase = m.M
				v84 = m.ExcPending
				if v84 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(484051), int32(384), int32(409888))
					mBase = m.M
					v89 = m.ExcPending
					if v89 != 0 {
						return int32(0)
		...
		if v64 != 0 {
			...
			if v67 != 0 {
				...
				if v71 != 0 {
					...
					F_errfinish(m, int32(484051), int32(377), int32(409888))
					mBase = m.M
					v76 = m.ExcPending
					if v76 != 0 {
						return int32(0)
...
func F_binary_upgrade_set_next_toast_pg_class_oid(m *base.Module, l0 int32) int32 {
	...
	var v25 int32
	_ = v25
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _consts[79])))
	if v3 == int32(0) {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(484051), int32(145), int32(426409))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[261])) = v25
		return int32(0)
	}
}
