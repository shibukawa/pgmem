...
L7:
	;
	F_errfinish(m, int32(469826), int32(290), int32(222270))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v66))) = v171
	F_errmsg_internal(m, int32(192528), v66)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L24
...
L41:
	;
	F_errfinish(m, int32(474257), int32(2042), int32(298870))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L24
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v112)+4)) = int32(231462)
	...
	if v10 != 0 {
		...
		if v11 == int32(1) {
			...
			if v80 != 0 {
				...
				F_errmsg_internal(m, int32(418231), int32(0))
				mBase = m.M
				v84 = m.ExcPending
				if v84 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(469826), int32(384), int32(397368))
					mBase = m.M
					v89 = m.ExcPending
					if v89 != 0 {
						return int32(0)
		...
		if v64 != 0 {
			...
			if v67 != 0 {
				...
				if v71 != 0 {
					...
					F_errfinish(m, int32(469826), int32(377), int32(397368))
					mBase = m.M
					v76 = m.ExcPending
					if v76 != 0 {
						return int32(0)
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(469826), int32(145), int32(413044))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
