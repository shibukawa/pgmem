...
func F_GetCurrentCommandId(m *base.Module, l0 int32) int32 {
	...
	_ = v29
	if l0 != 0 {
		v3 = *(*int32)(unsafe.Add(mBase, _consts[103]))
		if int32(0) <= v3 {
			...
			if v17 != 0 {
				...
				if v20 != 0 {
					...
					F_errmsg(m, int32(220723), int32(0))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(493196), int32(843), int32(465352))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return int32(0)
			...
			v7 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _consts[104])) = uint8(v7)
			v10 = *(*int32)(unsafe.Add(mBase, _consts[105]))
			return v10
		}
	} else {
		v10 = *(*int32)(unsafe.Add(mBase, _consts[105]))
