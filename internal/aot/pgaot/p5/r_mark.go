...
L16:
	;
	v107 = v81<<(uint(int32(12))%32)&int32(_a_F_r_mark_sU_0) | v77
	v108 = int32(3)
	goto L10
L17:
	;
...
L18:
	...
	v107 = v81<<(uint(int32(12))%32)&int32(_a_F_r_mark_sU_1) | v99&int32(7)<<(uint(int32(18))%32) | v77
	v108 = int32(4)
	goto L10
L19:
	;
...
L48:
	;
	v250 = v224<<(uint(int32(12))%32)&int32(_a_F_r_mark_sU_0) | v220
	v251 = int32(3)
	goto L42
L49:
	;
...
L50:
	...
	v250 = v224<<(uint(int32(12))%32)&int32(_a_F_r_mark_sU_1) | v242&int32(7)<<(uint(int32(18))%32) | v220
	v251 = int32(4)
	goto L42
L51:
	;
...
L98:
	;
	v451 = v425<<(uint(int32(12))%32)&int32(_a_F_r_mark_sU_0) | v421
	v452 = int32(3)
	goto L92
L99:
	;
...
L100:
	...
	v451 = v425<<(uint(int32(12))%32)&int32(_a_F_r_mark_sU_1) | v443&int32(7)<<(uint(int32(18))%32) | v421
	v452 = int32(4)
	goto L92
L101:
	;
...
L106:
	;
	v462 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v456)>>(uint(int32(3))%32)))+uint32(_c_F_r_mark_sU[1]))))
	...
	if v4 == v2 {
		...
		if v8-int32(2) <= v7 {
			...
			if v16 != int32(110) {
				...
				v21 = F_find_among_b(m, l0, int32(_a_F_r_mark_sUn_0), int32(4))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L20:
	;
	v116 = v90<<(uint(int32(12))%32)&int32(_a_F_r_mark_suffix_with_optional_n_consonant_0) | v86
	v117 = int32(3)
	goto L14
L21:
	;
...
L22:
	...
	v116 = v90<<(uint(int32(12))%32)&int32(_a_F_r_mark_suffix_with_optional_n_consonant_1) | v108&int32(7)<<(uint(int32(18))%32) | v86
	v117 = int32(4)
	goto L14
L23:
	;
...
L28:
	;
	v127 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v121)>>(uint(int32(3))%32)))+uint32(_c_F_r_mark_suffix_with_optional_n_consonant[0]))))
...
L70:
	;
	v320 = v294<<(uint(int32(12))%32)&int32(_a_F_r_mark_suffix_with_optional_n_consonant_0) | v290
	v321 = int32(3)
	goto L64
L71:
	;
...
L72:
	...
	v320 = v294<<(uint(int32(12))%32)&int32(_a_F_r_mark_suffix_with_optional_n_consonant_1) | v312&int32(7)<<(uint(int32(18))%32) | v290
	v321 = int32(4)
	goto L64
L73:
	;
...
L78:
	;
	v331 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v325)>>(uint(int32(3))%32)))+uint32(_c_F_r_mark_suffix_with_optional_n_consonant[0]))))
	...
	if v4 == v2 {
		...
		if v9 <= v10 {
			...
			if v14 != int32(122) {
				...
				v19 = F_find_among_b(m, l0, int32(_a_F_r_mark_yUz_0), int32(4))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v59
								...
								if v66 == int32(121) {
									...
									if v72 < v70 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v72
										v80 = F_in_grouping_b_U(m, l0, int32(_a_F_r_mark_yUz_1), int32(97), int32(305), int32(0))
										mBase = m.M
										if v80 != 0 {
											v95 = v70
										} else {
							...
							if v39 != int32(121) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v43
								v48 = int32(0)
								v49 = F_in_grouping_b_U(m, l0, int32(_a_F_r_mark_yUz_1), int32(97), int32(305), v48)
								mBase = m.M
