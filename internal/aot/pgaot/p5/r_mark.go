...
func F_r_mark_lArI(m *base.Module, l0 int32) int32 {
	...
	if v5-int32(3) <= v4 {
		...
		if base.B2i32(v13 != int32(177))&base.B2i32(v13 != int32(105)) != 0 {
			...
			v21 = F_find_among_b(m, l0, int32(4336688), int32(2))
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return int32(0)
	...
	if v4 == v2 {
		...
		if v8-int32(2) <= v7 {
			...
			if v16 != int32(110) {
				...
				v21 = F_find_among_b(m, l0, int32(4336240), int32(4))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
	...
	if v4 == v2 {
		...
		if v9 <= v10 {
			...
			if v14 != int32(122) {
				...
				v19 = F_find_among_b(m, l0, int32(4336320), int32(4))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v59
								...
								if v66 == int32(121) {
									...
									if v72 < v70 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v72
										v80 = F_in_grouping_b_U(m, l0, int32(2185344), int32(97), int32(305), int32(0))
										mBase = m.M
										if v80 != 0 {
											v95 = v70
										} else {
							...
							if v39 != int32(121) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v43
								v48 = int32(0)
								v49 = F_in_grouping_b_U(m, l0, int32(2185344), int32(97), int32(305), v48)
								mBase = m.M
