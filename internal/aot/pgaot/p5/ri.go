...
func F_RI_FKey_setdefault_upd(m *base.Module, l0 int32) int32 {
	...
	var v12 int32
	_ = v12
	F_ri_CheckTrigger(m, l0, int32(414959), int32(2))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_RI_FKey_setnull_del(m *base.Module, l0 int32) int32 {
	...
	var v12 int32
	_ = v12
	F_ri_CheckTrigger(m, l0, int32(302912), int32(3))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_RI_FKey_trigger_type(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v4) <= base.Ui32(int32(11)) {
		v11 = *(*int32)(unsafe.Add(mBase, uint32(v4<<(uint(int32(2))%32))+uint32(_consts[321])))
		v12 = v11
	} else {
		v12 = int32(0)
	}
