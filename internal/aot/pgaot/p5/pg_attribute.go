...
func F_pg_restore_attribute_stats(m *base.Module, l0 int32) int32 {
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v36)+226)) = uint16(v44)
	v49 = F_stats_fill_fcinfo_from_arg_pairs(m, l0, v36+int32(208), int32(_a_F_pg_restore_attribute_stats_0))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L1
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v36)+384)) = v71
	F_stats_check_required_arg(m, v36+int32(208), int32(_a_F_pg_restore_attribute_stats_0), int32(0))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L1
...
L4:
	;
	F_stats_check_required_arg(m, v36+int32(208), int32(_a_F_pg_restore_attribute_stats_0), int32(1))
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
		goto L1
...
L7:
	;
	v107 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_restore_attribute_stats[0])))
	if v107 == int32(1) {
		goto L18
	} else {
		goto L19
...
L18:
	;
	v112 = *(*int32)(unsafe.Add(mBase, _c_F_pg_restore_attribute_stats[1]))
	v113 = *(*int32)(unsafe.Add(mBase, uint32(v112)+316))
	v115 = base.B2i32(v113 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _c_F_pg_restore_attribute_stats[0])) = uint8(v115)
	v117 = v115
	goto L20
L19:
	;
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+176)) = v139
	F_errmsg(m, int32(_a_F_pg_restore_attribute_stats_13), v36+int32(176))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L1
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36))) = int32(_a_F_pg_restore_attribute_stats_2)
	F_errmsg(m, int32(_a_F_pg_restore_attribute_stats_14), v36)
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L1
...
L55:
	;
	F_stats_check_required_arg(m, v36+int32(208), int32(_a_F_pg_restore_attribute_stats_0), int32(4))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L1
...
L94:
	;
	F_errmsg(m, int32(_a_F_pg_restore_attribute_stats_15), int32(0))
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L1
...
L95:
	;
	F_errhint(m, int32(_a_F_pg_restore_attribute_stats_16), int32(0))
	mBase = m.M
	v390 = m.ExcPending
	if v390 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(_a_F_pg_restore_attribute_stats_4), int32(569), int32(_a_F_pg_restore_attribute_stats_18))
	mBase = m.M
	v575 = m.ExcPending
	if v575 != 0 {
		goto L1
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+160)) = v213
	F_errmsg(m, int32(_a_F_pg_restore_attribute_stats_19), v36+int32(160))
	mBase = m.M
	v724 = m.ExcPending
	if v724 != 0 {
		goto L1
...
L157:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+148)) = int32(_a_F_pg_restore_attribute_stats_20)
	*(*int32)(unsafe.Add(mBase, uint32(v36)+144)) = int32(_a_F_pg_restore_attribute_stats_21)
	F_errdetail(m, int32(_a_F_pg_restore_attribute_stats_22), v36+int32(144))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L170:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+128)) = v213
	F_errmsg(m, int32(_a_F_pg_restore_attribute_stats_23), v36+int32(128))
	mBase = m.M
	v776 = m.ExcPending
	if v776 != 0 {
		goto L1
...
L171:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+116)) = int32(_a_F_pg_restore_attribute_stats_24)
	*(*int32)(unsafe.Add(mBase, uint32(v36)+112)) = int32(_a_F_pg_restore_attribute_stats_25)
	F_errdetail(m, int32(_a_F_pg_restore_attribute_stats_22), v36+int32(112))
	mBase = m.M
	v785 = m.ExcPending
	if v785 != 0 {
		goto L1
...
L187:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+96)) = v213
	F_errmsg(m, int32(_a_F_pg_restore_attribute_stats_26), v36+int32(96))
	mBase = m.M
	v825 = m.ExcPending
	if v825 != 0 {
		goto L1
...
L188:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+84)) = int32(_a_F_pg_restore_attribute_stats_27)
	*(*int32)(unsafe.Add(mBase, uint32(v36)+80)) = int32(_a_F_pg_restore_attribute_stats_28)
	F_errdetail(m, int32(_a_F_pg_restore_attribute_stats_22), v36+int32(80))
	mBase = m.M
	v834 = m.ExcPending
	if v834 != 0 {
		goto L1
...
L212:
	...
	v960 = F_text_to_stavalues(m, int32(_a_F_pg_restore_attribute_stats_29), v36+int32(576), v957, v672, v631, v36+int32(380))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L1
...
L217:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v36)+380)) = uint8(v982)
	...
	v991 = F_text_to_stavalues(m, int32(_a_F_pg_restore_attribute_stats_9), v36+int32(576), v988, v672, v631, v36+int32(380))
	mBase = m.M
	v992 = m.ExcPending
	if v992 != 0 {
		goto L1
...
L229:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v36)+380)) = uint8(v1035)
	...
	v1044 = F_text_to_stavalues(m, int32(_a_F_pg_restore_attribute_stats_10), v36+int32(576), v1041, v749, v631, v36+int32(380))
	mBase = m.M
	v1045 = m.ExcPending
	if v1045 != 0 {
		goto L1
...
L240:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v36)+380)) = uint8(v1081)
	...
	v1090 = F_text_to_stavalues(m, int32(_a_F_pg_restore_attribute_stats_11), v36+int32(576), v1087, v672, v631, v36+int32(380))
	mBase = m.M
	v1091 = m.ExcPending
	if v1091 != 0 {
		goto L1
...
L250:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v36)+379)) = uint8(v1121)
	...
	v1132 = F_text_to_stavalues(m, int32(_a_F_pg_restore_attribute_stats_12), v36+int32(576), v1127, int32(701), v1121, v36+int32(379))
	mBase = m.M
	v1133 = m.ExcPending
	if v1133 != 0 {
		goto L1
