...
L12:
	;
	F_errfinish(m, int32(521119), int32(3949), int32(69368))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L2
...
func F_pg_restore_attribute_stats(m *base.Module, l0 int32) int32 {
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v36)+226)) = uint16(v44)
	v49 = F_stats_fill_fcinfo_from_arg_pairs(m, l0, v36+int32(208), int32(4159856))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L1
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v36)+384)) = v71
	F_stats_check_required_arg(m, v36+int32(208), int32(4159856), int32(0))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L1
...
L4:
	;
	F_stats_check_required_arg(m, v36+int32(208), int32(4159856), int32(1))
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
		goto L1
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+176)) = v139
	F_errmsg(m, int32(77509), v36+int32(176))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L1
...
L36:
	;
	F_errfinish(m, int32(516065), int32(213), int32(373003))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L1
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+16)) = v167
	F_errmsg(m, int32(77356), v36+int32(16))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L1
...
L49:
	;
	F_errfinish(m, int32(516065), int32(225), int32(373003))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		goto L1
...
L52:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+4)) = int32(300285)
	*(*int32)(unsafe.Add(mBase, uint32(v36))) = int32(395256)
	F_errmsg(m, int32(732741), v36)
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L1
...
L53:
	;
	F_errfinish(m, int32(516065), int32(231), int32(373003))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L1
...
L55:
	;
	F_stats_check_required_arg(m, v36+int32(208), int32(4159856), int32(4))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L1
...
L96:
	;
	F_errfinish(m, int32(516065), int32(192), int32(373003))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L1
...
L99:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+196)) = int32(300285)
	*(*int32)(unsafe.Add(mBase, uint32(v36)+192)) = int32(395256)
	F_errmsg(m, int32(755439), v36+int32(192))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L1
...
L100:
	;
	F_errfinish(m, int32(516065), int32(205), int32(373003))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L1
...
L103:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+32)) = v213
	F_errmsg(m, int32(743784), v36+int32(32))
	mBase = m.M
	v429 = m.ExcPending
	if v429 != 0 {
		goto L1
...
L104:
	;
	F_errfinish(m, int32(516065), int32(240), int32(373003))
	mBase = m.M
	v434 = m.ExcPending
	if v434 != 0 {
		goto L1
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+52)) = v442 + int32(4)
	F_errmsg(m, int32(77356), v36+int32(48))
	mBase = m.M
	v451 = m.ExcPending
	if v451 != 0 {
		goto L1
...
L108:
	;
	F_errfinish(m, int32(516065), int32(597), int32(383805))
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L1
...
L111:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+68)) = v464 + int32(4)
	F_errmsg(m, int32(77356), v36-int32(-64))
	mBase = m.M
	v473 = m.ExcPending
	if v473 != 0 {
		goto L1
...
L112:
	;
	F_errfinish(m, int32(516065), int32(605), int32(383805))
	mBase = m.M
	v478 = m.ExcPending
	if v478 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(516065), int32(569), int32(217302))
	mBase = m.M
	v575 = m.ExcPending
	if v575 != 0 {
		goto L1
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+160)) = v213
	F_errmsg(m, int32(744056), v36+int32(160))
	mBase = m.M
	v724 = m.ExcPending
	if v724 != 0 {
		goto L1
...
L157:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+148)) = int32(541688)
	*(*int32)(unsafe.Add(mBase, uint32(v36)+144)) = int32(556478)
	F_errdetail(m, int32(631327), v36+int32(144))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L158:
	;
	F_errfinish(m, int32(516065), int32(305), int32(373003))
	mBase = m.M
	v738 = m.ExcPending
	if v738 != 0 {
		goto L1
...
L170:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+128)) = v213
	F_errmsg(m, int32(742706), v36+int32(128))
	mBase = m.M
	v776 = m.ExcPending
	if v776 != 0 {
		goto L1
...
L171:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+116)) = int32(554148)
	*(*int32)(unsafe.Add(mBase, uint32(v36)+112)) = int32(556577)
	F_errdetail(m, int32(631327), v36+int32(112))
	mBase = m.M
	v785 = m.ExcPending
	if v785 != 0 {
		goto L1
...
L172:
	;
	F_errfinish(m, int32(516065), int32(322), int32(373003))
	mBase = m.M
	v790 = m.ExcPending
	if v790 != 0 {
		goto L1
...
L187:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+96)) = v213
	F_errmsg(m, int32(387917), v36+int32(96))
	mBase = m.M
	v825 = m.ExcPending
	if v825 != 0 {
		goto L1
...
L188:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+84)) = int32(556507)
	*(*int32)(unsafe.Add(mBase, uint32(v36)+80)) = int32(556539)
	F_errdetail(m, int32(631327), v36+int32(80))
	mBase = m.M
	v834 = m.ExcPending
	if v834 != 0 {
		goto L1
...
L189:
	;
	F_errfinish(m, int32(516065), int32(337), int32(373003))
	mBase = m.M
	v839 = m.ExcPending
	if v839 != 0 {
		goto L1
...
L212:
	...
	v960 = F_text_to_stavalues(m, int32(162784), v36+int32(576), v957, v672, v631, v36+int32(380))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L1
...
L217:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v36)+380)) = uint8(v982)
	...
	v991 = F_text_to_stavalues(m, int32(182377), v36+int32(576), v988, v672, v631, v36+int32(380))
	mBase = m.M
	v992 = m.ExcPending
	if v992 != 0 {
		goto L1
...
L229:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v36)+380)) = uint8(v1035)
	...
	v1044 = F_text_to_stavalues(m, int32(160220), v36+int32(576), v1041, v749, v631, v36+int32(380))
	mBase = m.M
	v1045 = m.ExcPending
	if v1045 != 0 {
		goto L1
...
L240:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v36)+380)) = uint8(v1081)
	...
	v1090 = F_text_to_stavalues(m, int32(305293), v36+int32(576), v1087, v672, v631, v36+int32(380))
	mBase = m.M
	v1091 = m.ExcPending
	if v1091 != 0 {
		goto L1
...
L250:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v36)+379)) = uint8(v1121)
	...
	v1132 = F_text_to_stavalues(m, int32(305316), v36+int32(576), v1127, int32(701), v1121, v36+int32(379))
	mBase = m.M
	v1133 = m.ExcPending
	if v1133 != 0 {
		goto L1
