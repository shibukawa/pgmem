...
func F__int_contains_joinsel(m *base.Module, l0 int32) int32 {
	...
	v9 = F_DirectFunctionCall5Coll(m, int32(4010), int32(0), v4, int32(2751), v6, v7, v8)
	mBase = m.M
	v12 = m.ExcPending
	if v12 != 0 {
		return int32(0)
...
func F__int_contains_sel(m *base.Module, l0 int32) int32 {
	...
	v6 = *(*int32)(unsafe.Add(mBase, uint32(l0)+36))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)+44))
	v8 = F_DirectFunctionCall4Coll(m, int32(4009), int32(0), v4, int32(2751), v6, v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
							...
							if v41 != 0 {
								*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v41
								...
								if v47 != 0 {
									...
									v59 = *(*int32)(unsafe.Add(mBase, _consts[89]))
									if v59 != 0 {
										*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v59
										...
										if v65 != 0 {
											...
											v67 = *(*int32)(unsafe.Add(mBase, _consts[1289]))
											if v67 != 0 {
												*(*int32)(unsafe.Add(mBase, uint32(v11))) = v67
												...
												if v71 != 0 {
													...
													F_errfinish(m, int32(520159), int32(6870), int32(327676))
													mBase = m.M
													v76 = m.ExcPending
													if v76 != 0 {
														return int32(0)
