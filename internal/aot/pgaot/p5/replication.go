...
func F_ReplicationSlotDropPtr(m *base.Module, l0 int32) {
	...
	if v15 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = int32(80283)
		v26 = F_pg_sprintf(m, v7+int32(1088), int32(166924), v7+int32(48))
		mBase = m.M
		v27 = m.ExcPending
		if v27 != 0 {
			return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(80283)
			v36 = F_pg_sprintf(m, v7-int32(-64), int32(223473), v7+int32(32))
			mBase = m.M
			v37 = m.ExcPending
			if v37 != 0 {
				return
				...
				if v42 == int32(0) {
														...
														if v144 != 0 {
															...
															if v143 == int32(0) {
																...
																*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 - int32(-64)
																F_errmsg(m, int32(650445), v7)
																mBase = m.M
																v152 = m.ExcPending
																if v152 != 0 {
																	return
																} else {
																	F_errfinish(m, int32(469981), int32(1060), int32(196211))
																	mBase = m.M
																	v157 = m.ExcPending
																	if v157 != 0 {
																		return
					...
					*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
					...
					if v66 != 0 {
						F_s_lock(m, l0, int32(469981), int32(1018), int32(196211))
						mBase = m.M
						v74 = m.ExcPending
						if v74 != 0 {
							return
									...
									if v87 == int32(0) {
										...
										if v92 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v7 + int32(1088)
											F_errmsg(m, int32(282611), v7+int32(16))
											mBase = m.M
											v103 = m.ExcPending
											if v103 != 0 {
												return
											} else {
												F_errfinish(m, int32(469981), int32(1028), int32(196211))
												mBase = m.M
												v108 = m.ExcPending
												if v108 != 0 {
													return
...
func F_ReplicationSlotMarkDirty(m *base.Module) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(1)
	if v5 != 0 {
		F_s_lock(m, v4, int32(469981), int32(1107), int32(8157))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return
				...
				if v23 != 0 {
					...
					if v27 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v28
						F_errmsg_internal(m, int32(195784), v6+int32(16))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return int32(0)
							...
							if v35 != 0 {
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v35
								F_errhint_internal(m, int32(195784), v6)
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(469981), int32(282), int32(363187))
									mBase = m.M
									v44 = m.ExcPending
									if v44 != 0 {
										return int32(0)
