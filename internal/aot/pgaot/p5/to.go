			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(492166), int32(13488), int32(238766))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
				...
				if v35 != 0 {
					...
					if v39 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v34
						F_appendStringInfo(m, l0, int32(176828), v8+int32(16))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return
...
L34:
	;
	F_errfinish(m, int32(495984), int32(128), int32(376980))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L1
