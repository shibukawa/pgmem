...
L7:
	;
	if v16 == int32(_a_F_make_result_opt_error_0) {
		goto L10
	} else {
		goto L11
	}
...
L11:
	;
	if v16 == int32(_a_F_make_result_opt_error_1) {
		goto L10
	} else {
		goto L12
	}
L12:
	;
	if v16 != int32(_a_F_make_result_opt_error_2) {
		goto L5
	} else {
		goto L13
	}
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v119))) = v118 << (uint(int32(2)) % 32)
	if v105 == int32(_a_F_make_result_opt_error_3) {
		goto L41
	} else {
		goto L42
	}
L41:
	;
	v134 = int32(_a_F_make_result_opt_error_4)
	goto L43
L42:
	;
	v134 = int32(_a_F_make_result_opt_error_5)
	goto L43
L43:
	;
...
L44:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v143)+6)) = uint16(v107)
	v153 = v143
	v155 = v148&int32(_a_F_make_result_opt_error_6) | v105
	goto L36
L45:
	;
	if v183 == v107 {
...
L62:
	;
	v194 = v169 & int32(_a_F_make_result_opt_error_6)
	goto L64
L63:
	;
