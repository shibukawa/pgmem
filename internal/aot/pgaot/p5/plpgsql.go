			...
			*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(0)
			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14)+8)) = v20
				v32 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[0]))
				v35 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[1]))
				v38 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[2]))
				if v35 == v38 {
					*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[2])) = v35 << (uint(int32(1)) % 32)
					...
					if v51 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[0])) = v50
						v55 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[1]))
						v56 = v55
						v57 = v50
						*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = v56
						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[1])) = v56 + int32(1)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v74))) = int32(2)
			...
			if v79 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v74)+8)) = v78
				v89 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[0]))
				v92 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[1]))
				v95 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[2]))
				if v92 == v95 {
					*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[2])) = v92 << (uint(int32(1)) % 32)
					...
					if v108 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[0])) = v107
						v112 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[1]))
						v113 = v107
						v114 = v112
						*(*int32)(unsafe.Add(mBase, uint32(v74)+4)) = v114
						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_variable[1])) = v114 + int32(1)
...
L47:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_cwordtype[3]))
...
L51:
	;
	v189 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_cwordtype[3]))
...
L62:
	;
	v255 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_cwordtype[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_cwordtype[0])) = v255
...
L42:
	;
	v165 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_tripword[2]))
											...
											*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
											...
											if v230 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
												...
												v233 = F_ScanKeywordLookup(m, v231, int32(_a_F_plpgsql_yylex_4))
												mBase = m.M
												v234 = m.ExcPending
												if v234 != 0 {
													return int32(0)
													...
													if v233 < int32(0) {
														...
														v245 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v241)+uint32(_c_F_plpgsql_yylex[0]))))
														*(*int32)(unsafe.Add(mBase, uint32(v12)+104)) = int32(_a_F_plpgsql_yylex_5) + v245
														v251 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v241)+uint32(_c_F_plpgsql_yylex[1]))))
														v331 = v251
													}
													v336 = *(*int64)(unsafe.Add(mBase, uint32(v12)+104))
													*(*int64)(unsafe.Add(mBase, uint32(l0))) = v336
								...
								*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
								...
								if v309 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
									...
									v312 = F_ScanKeywordLookup(m, v310, int32(_a_F_plpgsql_yylex_4))
									mBase = m.M
									v313 = m.ExcPending
									if v313 != 0 {
										return int32(0)
										...
										if v312 < int32(0) {
											...
											v324 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v320)+uint32(_c_F_plpgsql_yylex[0]))))
											*(*int32)(unsafe.Add(mBase, uint32(v12)+104)) = int32(_a_F_plpgsql_yylex_5) + v324
											v330 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v320)+uint32(_c_F_plpgsql_yylex[1]))))
											v331 = v330
										}
										v336 = *(*int64)(unsafe.Add(mBase, uint32(v12)+104))
										*(*int64)(unsafe.Add(mBase, uint32(l0))) = v336
