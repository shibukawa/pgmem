			...
			*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(0)
			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14)+8)) = v20
				v32 = *(*int32)(unsafe.Add(mBase, _consts[1346]))
				v35 = *(*int32)(unsafe.Add(mBase, _consts[1347]))
				v38 = *(*int32)(unsafe.Add(mBase, _consts[1348]))
				if v35 == v38 {
					*(*int32)(unsafe.Add(mBase, _consts[1348])) = v35 << (uint(int32(1)) % 32)
					...
					if v51 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _consts[1346])) = v50
						v55 = *(*int32)(unsafe.Add(mBase, _consts[1347]))
						v56 = v55
						v57 = v50
						*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = v56
						*(*int32)(unsafe.Add(mBase, _consts[1347])) = v56 + int32(1)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v74))) = int32(2)
			...
			if v79 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v74)+8)) = v78
				v89 = *(*int32)(unsafe.Add(mBase, _consts[1346]))
				v92 = *(*int32)(unsafe.Add(mBase, _consts[1347]))
				v95 = *(*int32)(unsafe.Add(mBase, _consts[1348]))
				if v92 == v95 {
					*(*int32)(unsafe.Add(mBase, _consts[1348])) = v92 << (uint(int32(1)) % 32)
					...
					if v108 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _consts[1346])) = v107
						v112 = *(*int32)(unsafe.Add(mBase, _consts[1347]))
						v113 = v107
						v114 = v112
						*(*int32)(unsafe.Add(mBase, uint32(v74)+4)) = v114
						*(*int32)(unsafe.Add(mBase, _consts[1347])) = v114 + int32(1)
			...
			if v147 != 0 {
				...
				if v150 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
					F_errmsg(m, int32(188210), v10+int32(16))
					mBase = m.M
					v158 = m.ExcPending
					if v158 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(495693), int32(1795), int32(396097))
						mBase = m.M
						v165 = m.ExcPending
						if v165 != 0 {
							return int32(0)
	...
	default:
		...
		if v171 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = v172
			F_errmsg_internal(m, int32(483843), v10)
			mBase = m.M
			v177 = m.ExcPending
			if v177 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(495693), int32(1799), int32(396097))
				mBase = m.M
				v184 = m.ExcPending
				if v184 != 0 {
					return int32(0)
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v88
	F_errmsg(m, int32(722692), v9+int32(16))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L4
...
L22:
	;
	F_errfinish(m, int32(499854), int32(6787), int32(431327))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L4
...
L28:
	;
	F_errfinish(m, int32(499854), int32(6803), int32(431327))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L4
...
func F_plpgsql_parse_cwordrowtype(m *base.Module, l0 int32) int32 {
	...
	v14 = *(*int32)(unsafe.Add(mBase, _consts[1351]))
					...
					if v50 != 0 {
						...
						if v53 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v54
							F_errmsg(m, int32(369776), v8)
							mBase = m.M
							v58 = m.ExcPending
							if v58 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(495693), int32(1729), int32(365370))
								mBase = m.M
								v63 = m.ExcPending
								if v63 != 0 {
									return int32(0)
...
L7:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1350]))
...
L47:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[1346]))
...
L51:
	;
	v189 = *(*int32)(unsafe.Add(mBase, _consts[1346]))
...
L62:
	;
	v255 = *(*int32)(unsafe.Add(mBase, _consts[1351]))
	*(*int32)(unsafe.Add(mBase, _consts[9])) = v255
...
L67:
	;
	F_errfinish(m, int32(495693), int32(1631), int32(365881))
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L52
...
L70:
	;
	F_errfinish(m, int32(495693), int32(1637), int32(365881))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		goto L52
...
func F_plpgsql_parse_tripword(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	v10 = v8 - int32(80)
	m.G0 = v10
	v13 = *(*int32)(unsafe.Add(mBase, _consts[1349]))
	if v13 == int32(1) {
		goto L2
	} else {
		goto L3
...
L3:
	;
	v17 = *(*int32)(unsafe.Add(mBase, _consts[1350]))
	v20 = v10 + int32(76)
	if v17 == int32(0) {
		goto L8
	} else {
...
L42:
	;
	v165 = *(*int32)(unsafe.Add(mBase, _consts[1346]))
...
func F_plpgsql_parser_setup(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+112)) = int32(6792)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+108)) = int32(6793)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+104)) = int32(6794)
	return
}
											...
											*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
											...
											if v230 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
												...
												v233 = F_ScanKeywordLookup(m, v231, int32(4176320))
												mBase = m.M
												v234 = m.ExcPending
												if v234 != 0 {
													return int32(0)
													...
													if v233 < int32(0) {
														...
														v245 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v241)+uint32(_consts[1430]))))
														*(*int32)(unsafe.Add(mBase, uint32(v12)+104)) = int32(2171264) + v245
														v251 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v241)+uint32(_consts[1373]))))
														v331 = v251
													}
													v336 = *(*int64)(unsafe.Add(mBase, uint32(v12)+104))
													*(*int64)(unsafe.Add(mBase, uint32(l0))) = v336
								...
								*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
								...
								if v309 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
									...
									v312 = F_ScanKeywordLookup(m, v310, int32(4176320))
									mBase = m.M
									v313 = m.ExcPending
									if v313 != 0 {
										return int32(0)
										...
										if v312 < int32(0) {
											...
											v324 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v320)+uint32(_consts[1430]))))
											*(*int32)(unsafe.Add(mBase, uint32(v12)+104)) = int32(2171264) + v324
											v330 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v320)+uint32(_consts[1373]))))
											v331 = v330
										}
										v336 = *(*int64)(unsafe.Add(mBase, uint32(v12)+104))
										*(*int64)(unsafe.Add(mBase, uint32(l0))) = v336
