			...
			if v147 != 0 {
				...
				if v150 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
					F_errmsg(m, int32(178675), v10+int32(16))
					mBase = m.M
					v158 = m.ExcPending
					if v158 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(474316), int32(1795), int32(378630))
						mBase = m.M
						v165 = m.ExcPending
						if v165 != 0 {
							return int32(0)
	...
	default:
		...
		if v171 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = v172
			F_errmsg_internal(m, int32(463055), v10)
			mBase = m.M
			v177 = m.ExcPending
			if v177 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(474316), int32(1799), int32(378630))
				mBase = m.M
				v184 = m.ExcPending
				if v184 != 0 {
					return int32(0)
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v88
	F_errmsg(m, int32(682937), v9+int32(16))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L4
...
L22:
	;
	F_errfinish(m, int32(478287), int32(6787), int32(412414))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L4
...
L28:
	;
	F_errfinish(m, int32(478287), int32(6803), int32(412414))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L4
					...
					if v50 != 0 {
						...
						if v53 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v54
							F_errmsg(m, int32(353502), v8)
							mBase = m.M
							v58 = m.ExcPending
							if v58 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(474316), int32(1729), int32(349227))
								mBase = m.M
								v63 = m.ExcPending
								if v63 != 0 {
									return int32(0)
...
L67:
	;
	F_errfinish(m, int32(474316), int32(1631), int32(349705))
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L52
...
L70:
	;
	F_errfinish(m, int32(474316), int32(1637), int32(349705))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		goto L52
...
func F_plpgsql_parser_setup(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+112)) = int32(5435)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+108)) = int32(5436)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+104)) = int32(5437)
	return
}
											...
											*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
											...
											if v230 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
												...
												v233 = F_ScanKeywordLookup(m, v231, int32(4118000))
												mBase = m.M
												v234 = m.ExcPending
												if v234 != 0 {
													return int32(0)
													...
													if v233 < int32(0) {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v12)+104)) = int32(2119216) + v245
								...
								*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
								...
								if v309 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v343)+64)) = v342
									...
									v312 = F_ScanKeywordLookup(m, v310, int32(4118000))
									mBase = m.M
									v313 = m.ExcPending
									if v313 != 0 {
										return int32(0)
										...
										if v312 < int32(0) {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v12)+104)) = int32(2119216) + v324
