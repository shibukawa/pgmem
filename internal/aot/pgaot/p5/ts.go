...
func F_commit_ts_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8))) = v15
		F_appendStringInfo(m, l0, int32(404327), v8)
		mBase = m.M
		v19 = m.ExcPending
		if v19 != 0 {
			return
	...
	case 16:
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8)+16)) = v20
		F_appendStringInfo(m, l0, int32(51794), v8+int32(16))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return
...
L2:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+76)) = int64(601295421444)
	v22 = F_hash_create(m, int32(375246), int32(4), v9+int32(60), int32(40))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L3
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v175
	F_errmsg_internal(m, int32(40739), v9)
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L3
...
L51:
	;
	F_errfinish(m, int32(468598), int32(156), int32(375000))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L3
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v189
	F_errmsg_internal(m, int32(396809), v9+int32(16))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L3
...
L54:
	;
	F_errfinish(m, int32(468598), int32(163), int32(375000))
	mBase = m.M
	v200 = m.ExcPending
	if v200 != 0 {
		goto L3
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v205
	F_errmsg_internal(m, int32(397014), v9+int32(32))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L3
...
L57:
	;
	F_errfinish(m, int32(468598), int32(165), int32(375000))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L3
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = v221
	F_errmsg_internal(m, int32(397104), v9+int32(48))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L3
...
L60:
	;
	F_errfinish(m, int32(468598), int32(167), int32(375000))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L3
