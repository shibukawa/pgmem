				...
				if v10 != v58 {
					...
					if v67 != 0 {
						...
						*(*uint8)(unsafe.Add(mBase, uint32(v62)+4)) = uint8(v65)
						v70 = *(*int32)(unsafe.Add(mBase, _consts[106]))
							...
							if v81 != 0 {
								...
								if v84 != 0 {
									...
									if v86 != 0 {
										...
										v88 = int32(4457908)
										v90 = int32(*(*uint8)(unsafe.Add(mBase, _consts[44])))
										v91 = v90 | int32(1)
										*(*uint8)(unsafe.Add(mBase, _consts[44])) = uint8(v91)
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v104
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v101
	F_errfinish(m, int32(519152), int32(123), int32(123280))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		v1547 = v107
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v104
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v101
	F_errmsg(m, int32(317510), int32(0))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		v1547 = v107
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v104
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v101
	F_errfinish(m, int32(519152), int32(139), int32(123280))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		v1547 = v107
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, _consts[10])) = v359
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v104
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v101
	F_errfinish(m, int32(519152), int32(156), int32(123280))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		v1547 = v107
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v104
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v101
	F_errfinish(m, int32(519152), int32(162), int32(123280))
	mBase = m.M
	v532 = m.ExcPending
	if v532 != 0 {
		v1547 = v107
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v104
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v101
	v772 = int32(*(*uint8)(unsafe.Add(mBase, _consts[111])))
	if v772 == int32(1) {
		goto L68
	} else {
		goto L69
...
L68:
	;
	v777 = *(*int32)(unsafe.Add(mBase, _consts[112]))
	v778 = *(*int32)(unsafe.Add(mBase, uint32(v777)+316))
	v780 = base.B2i32(v778 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _consts[111])) = uint8(v780)
	v782 = v780
	goto L70
L69:
	;
...
L75:
	;
	v818 = *(*int64)(unsafe.Add(mBase, _consts[117]))
	goto L72
L76:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v40)+36)) = v65
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v104
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v101
	F_errfinish(m, int32(519152), int32(177), int32(123280))
	mBase = m.M
	v894 = m.ExcPending
	if v894 != 0 {
		v1547 = v107
...
L81:
	;
	v937 = *(*int32)(unsafe.Add(mBase, _consts[140]))
	v939 = *(*int32)(unsafe.Add(mBase, _consts[141]))
	goto L82
L82:
	;
...
L86:
	;
	*(*int32)(unsafe.Add(mBase, _consts[141])) = v953
...
L88:
	;
	*(*int32)(unsafe.Add(mBase, _consts[140])) = v954
	*(*int32)(unsafe.Add(mBase, _consts[141])) = v955
	*(*int32)(unsafe.Add(mBase, uint32(v40)+32)) = v954
	*(*int32)(unsafe.Add(mBase, uint32(v40)+36)) = v955
	*(*int64)(unsafe.Add(mBase, uint32(v40)+40)) = v977
	*(*int64)(unsafe.Add(mBase, uint32(v40)+48)) = v978
...
L89:
	;
	*(*int32)(unsafe.Add(mBase, _consts[10])) = v956
	if v3 != 0 {
		goto L90
	} else {
		goto L91
...
L94:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v950
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v953
	v1074 = *(*int32)(unsafe.Add(mBase, _consts[516]))
...
L95:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+16)) = v1074 + int32(137)
	F_errmsg(m, int32(530709), v40+int32(16))
	mBase = m.M
	v1100 = m.ExcPending
	if v1100 != 0 {
		v1547 = v964
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v950
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v953
	F_errfinish(m, int32(519152), int32(226), int32(123280))
	mBase = m.M
	v1120 = m.ExcPending
	if v1120 != 0 {
		v1547 = v964
...
L104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1012)+140)) = v951
	...
	v1146 = *(*int32)(unsafe.Add(mBase, _consts[516]))
...
L107:
	;
	*(*int32)(unsafe.Add(mBase, _consts[11])) = v958
	if l1 == int32(0) {
		goto L134
	} else {
		goto L135
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40))) = v1262
	F_errmsg_internal(m, int32(213577), v40)
	mBase = m.M
	v1281 = m.ExcPending
	if v1281 != 0 {
		v1547 = v964
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40)+104)) = v950
	*(*int32)(unsafe.Add(mBase, uint32(v40)+108)) = v953
	F_errfinish(m, int32(519152), int32(259), int32(123280))
	mBase = m.M
	v1301 = m.ExcPending
	if v1301 != 0 {
		v1547 = v964
...
L126:
	;
	v1334 = *(*int32)(unsafe.Add(mBase, _consts[45]))
	if v1334 != 0 {
		goto L129
	} else {
		goto L130
