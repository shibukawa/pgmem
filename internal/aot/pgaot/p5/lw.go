...
func F_LWLockRelease(m *base.Module, l0 int32) {
	...
	if v3 != 0 {
		...
		if v5 != 0 {
			...
			v6 = int32(4556732)
			v8 = *(*int32)(unsafe.Add(mBase, _consts[411]))
			*(*int32)(unsafe.Add(mBase, _consts[411])) = v8 - int32(1)
			return
		}
	}
}
...
L2:
	;
	v15 = v10 & int32(3)
	v17 = *(*int32)(unsafe.Add(mBase, _consts[776]))
...
L18:
	;
	v126 = *(*int32)(unsafe.Add(mBase, _consts[775]))
...
L20:
	;
	v133 = *(*int32)(unsafe.Add(mBase, _consts[775]))
	if int32(0) < v133 {
		goto L21
	} else {
		goto L22
...
L24:
	;
	v145 = *(*int32)(unsafe.Add(mBase, _consts[776]))
...
L26:
	;
	v155 = v140 + int32(1)
	v157 = *(*int32)(unsafe.Add(mBase, _consts[775]))
	if v155 < v157 {
		v136 = v152
		v140 = v155
		goto L24
