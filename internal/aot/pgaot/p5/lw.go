...
func F_LWLockShmemSize(m *base.Module) int32 {
	...
	_ = v159
	v1 = int32(0)
	v10 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockShmemSize[0]))
	if v10 <= v1 {
		goto L1
	} else {
		goto L2
...
L2:
	;
	v15 = v10 & int32(3)
	v17 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockShmemSize[1]))
...
L18:
	;
	v126 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockShmemSize[0]))
...
L20:
	;
	v133 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockShmemSize[0]))
	if int32(0) < v133 {
		goto L21
	} else {
		goto L22
...
L24:
	;
	v145 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockShmemSize[1]))
...
L26:
	;
	v155 = v140 + int32(1)
	v157 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockShmemSize[0]))
	if v155 < v157 {
		v136 = v152
		v140 = v155
		goto L24
