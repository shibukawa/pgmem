...
L6:
	;
	v16 = v13 - v7
	v18 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v16)+uint32(_consts[1465]))))
	if v18 != 0 {
		v48 = v8
		goto L7
	} else {
...
L46:
	;
	v119 = v116 - v110
	v121 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v119)+uint32(_consts[1466]))))
	if v121 != 0 {
		v151 = v111
		goto L47
	} else {
...
L71:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _consts[1467]))
	if v258 != 0 {
		goto L101
	} else {
		goto L102
...
L73:
	;
	v193 = int32(540135)
	v196 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1468])))
...
L116:
	;
	v302 = *(*int64)(unsafe.Add(mBase, _consts[1469]))
...
L119:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v305+v179))) = uint8(v309)
	v311 = int32(4634624)
	v312 = *(*int32)(unsafe.Add(mBase, _consts[1467]))
	*(*int32)(unsafe.Add(mBase, uint32(v300)+32)) = v312
	*(*int32)(unsafe.Add(mBase, _consts[1467])) = v300
	goto L118
L120:
	;
