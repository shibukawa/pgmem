	...
	if v10 != int32(1) {
		...
		if int32(0) <= v14 {
			...
			if v20 != 0 {
				...
				if v21 == int32(0) {
					v36 = int32(_a_F_AppendStringToManifest_0)
				} else {
					v28 = *(*int32)(unsafe.Add(mBase, uint32(v21)+4))
					if v28 == int32(1) {
						v31 = int32(_a_F_AppendStringToManifest_1)
					} else {
						v31 = int32(_a_F_AppendStringToManifest_2)
					}
					if v28 == int32(2) {
						v34 = int32(_a_F_AppendStringToManifest_0)
					} else {
						v34 = v31
					}
					v36 = v34
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v36
				F_errmsg_internal(m, int32(_a_F_AppendStringToManifest_3), v7)
				mBase = m.M
				v40 = m.ExcPending
				if v40 != 0 {
					return
