...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v92
	F_errmsg_internal(m, int32(_a_F_AppendStringToManifest_0), v7)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L21
...
L24:
	;
	v92 = int32(_a_F_AppendStringToManifest_1)
	goto L23
L25:
	;
	goto L26
...
L27:
	;
	v87 = int32(_a_F_AppendStringToManifest_2)
	goto L29
L28:
	;
	v87 = int32(_a_F_AppendStringToManifest_3)
	goto L29
L29:
	;
	if v84 == int32(2) {
...
L30:
	;
	v90 = int32(_a_F_AppendStringToManifest_1)
	goto L32
L31:
	;
	v90 = v87
...
L33:
	;
	F_errfinish(m, int32(_a_F_AppendStringToManifest_4), int32(393), int32(_a_F_AppendStringToManifest_5))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L21
		...
		if v47 == int32(0) {
			...
			if v50 != 0 {
				if v46 == int32(0) {
					...
					v58 = *(*int32)(unsafe.Add(mBase, _c_F_string_agg_combine[0]))
					v60 = *(*int32)(unsafe.Add(mBase, uint32(v8)+8))
					*(*int32)(unsafe.Add(mBase, _c_F_string_agg_combine[0])) = v60
					v63 = v8 + int32(12)
					v64 = int32(0)
					...
					if v93 == int32(0) {
						...
						v96 = int32(_a_F_string_agg_combine_0)
						v97 = *(*int32)(unsafe.Add(mBase, _c_F_string_agg_combine[0]))
						v99 = *(*int32)(unsafe.Add(mBase, uint32(v8)+12))
						*(*int32)(unsafe.Add(mBase, _c_F_string_agg_combine[0])) = v99
