...
func F_get_foreign_data_wrapper_oid(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v12 int32
	_ = v12
	v9 = Fn13921(m, l0, l1, int32(_a_F_get_foreign_data_wrapper_oid_0), int32(693), int32(_a_F_get_foreign_data_wrapper_oid_1), int32(_a_F_get_foreign_data_wrapper_oid_2), int32(67137668), int32(29))
	v12 = m.ExcPending
	if v12 != 0 {
		return int32(0)
	} else {
