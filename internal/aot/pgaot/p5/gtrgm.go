...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v25
	F_errmsg_internal(m, int32(482775), v16)
	mBase = m.M
	v286 = m.ExcPending
	if v286 != 0 {
		goto L1
...
L68:
	;
	F_errfinish(m, int32(493064), int32(525), int32(417757))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L1
...
func F_gtrgm_in(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		if v15 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(289265)
			...
			if v23 != 0 {
				...
				F_errfinish(m, int32(493064), int32(61), int32(279772))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
