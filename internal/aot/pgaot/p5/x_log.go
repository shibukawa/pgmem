...
func F_XLogCheckBufferNeedsBackup(m *base.Module, l0 int32) int32 {
	...
	v6 = v4 - int32(16)
	m.G0 = v6
	v13 = *(*int64)(unsafe.Add(mBase, _consts[116]))
...
func F_XLogCheckpointNeeded(m *base.Module, l0 int64) int32 {
	...
	var v11 int64
	_ = v11
	v3 = *(*int32)(unsafe.Add(mBase, _consts[115]))
	v8 = *(*int64)(unsafe.Add(mBase, _consts[116]))
	v10 = int64(*(*int32)(unsafe.Add(mBase, _consts[117])))
	...
	if v12 < l1 {
		...
		if v37 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
			F_errmsg_internal(m, int32(441077), v9)
			mBase = m.M
			v41 = m.ExcPending
			if v41 != 0 {
				return
			} else {
				F_errfinish(m, int32(518576), int32(2000), int32(354113))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return
...
func F_XLogRegisterData(m *base.Module, l0 int32, l1 int32) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[151]))
	v12 = *(*int32)(unsafe.Add(mBase, _consts[152]))
	if v12 <= v10 {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			...
			if v21 != 0 {
				...
				v23 = *(*int32)(unsafe.Add(mBase, _consts[151]))
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v23
				v26 = *(*int32)(unsafe.Add(mBase, _consts[152]))
				*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v26
				F_errdetail_internal(m, int32(659666), v7)
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return
				} else {
					F_errfinish(m, int32(515262), int32(374), int32(529747))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return
		...
		*(*int32)(unsafe.Add(mBase, _consts[151])) = v10 + int32(1)
		v41 = *(*int32)(unsafe.Add(mBase, _consts[153]))
		v44 = v41 + v10*int32(12)
		*(*int32)(unsafe.Add(mBase, uint32(v44)+8)) = l1
		*(*int32)(unsafe.Add(mBase, uint32(v44)+4)) = l0
		v47 = int32(4159356)
		v48 = *(*int32)(unsafe.Add(mBase, _consts[154]))
		*(*int32)(unsafe.Add(mBase, uint32(v48))) = v44
		*(*int32)(unsafe.Add(mBase, _consts[154])) = v44
		v52 = int32(4449960)
		v54 = *(*int64)(unsafe.Add(mBase, _consts[155]))
		*(*int64)(unsafe.Add(mBase, _consts[155])) = v54 + base.I64_extend_i32_u(l1)
		m.G0 = v7 + int32(16)
		return
	}
}
func F_XLogWalRcvClose(m *base.Module, l0 int32) {
	...
	if v12 != 0 {
		...
		v14 = *(*int32)(unsafe.Add(mBase, _consts[565]))
		*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v14
		v17 = *(*int64)(unsafe.Add(mBase, _consts[566]))
		v20 = int64(*(*int32)(unsafe.Add(mBase, _consts[117])))
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v8)+24)) = uint32(v25)
		v33 = F_pg_snprintf(m, v8+int32(32), int32(64), int32(534669), v8+int32(16))
		mBase = m.M
		v34 = m.ExcPending
		if v34 != 0 {
			return
		} else {
			v36 = *(*int32)(unsafe.Add(mBase, _consts[567]))
			v37 = F_close(m, v36)
			mBase = m.M
			if v37 == int32(0) {
				v41 = *(*int32)(unsafe.Add(mBase, _consts[568]))
				if v41 != int32(2) {
				...
				if v61 != 0 {
					...
					if v63 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v8 + int32(32)
						F_errmsg(m, int32(307192), v8)
						mBase = m.M
						v69 = m.ExcPending
						if v69 != 0 {
							return
						} else {
							F_errfinish(m, int32(518218), int32(1064), int32(378393))
							mBase = m.M
							v74 = m.ExcPending
							if v74 != 0 {
								return
