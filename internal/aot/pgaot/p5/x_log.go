...
func F_XLogCheckBufferNeedsBackup(m *base.Module, l0 int32) int32 {
	...
	v6 = v4 - int32(16)
	m.G0 = v6
	v13 = *(*int64)(unsafe.Add(mBase, _consts[114]))
	*(*int64)(unsafe.Add(mBase, uint32(v6+int32(8)))) = v13
	v16 = int32(*(*uint8)(unsafe.Add(mBase, _consts[130])))
...
func F_XLogCheckpointNeeded(m *base.Module, l0 int64) int32 {
	...
	v8 = *(*int64)(unsafe.Add(mBase, _consts[114]))
	v10 = int64(*(*int32)(unsafe.Add(mBase, _consts[115])))
	...
	if v12 < l1 {
		...
		if v37 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
			F_errmsg_internal(m, int32(442018), v9)
			mBase = m.M
			v41 = m.ExcPending
			if v41 != 0 {
				return
			} else {
				F_errfinish(m, int32(520010), int32(2000), int32(355011))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return
...
func F_XLogRegisterData(m *base.Module, l0 int32, l1 int32) {
	...
	if v12 <= v10 {
		...
		if v17 != 0 {
			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v26
				F_errdetail_internal(m, int32(661176), v7)
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return
				} else {
					F_errfinish(m, int32(516696), int32(374), int32(531226))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return
		...
		*(*int32)(unsafe.Add(mBase, _consts[149])) = v10 + int32(1)
		v41 = *(*int32)(unsafe.Add(mBase, _consts[151]))
		v44 = v41 + v10*int32(12)
		*(*int32)(unsafe.Add(mBase, uint32(v44)+8)) = l1
		*(*int32)(unsafe.Add(mBase, uint32(v44)+4)) = l0
		v47 = int32(4163612)
		v48 = *(*int32)(unsafe.Add(mBase, _consts[152]))
		*(*int32)(unsafe.Add(mBase, uint32(v48))) = v44
		*(*int32)(unsafe.Add(mBase, _consts[152])) = v44
		v52 = int32(4457896)
		v54 = *(*int64)(unsafe.Add(mBase, _consts[153]))
		*(*int64)(unsafe.Add(mBase, _consts[153])) = v54 + base.I64_extend_i32_u(l1)
		m.G0 = v7 + int32(16)
		return
	}
}
func F_XLogWalRcvClose(m *base.Module, l0 int32) {
	...
	if v12 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v14
		...
		v20 = int64(*(*int32)(unsafe.Add(mBase, _consts[115])))
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v8)+24)) = uint32(v25)
		v33 = F_pg_snprintf(m, v8+int32(32), int32(64), int32(536148), v8+int32(16))
		mBase = m.M
		v34 = m.ExcPending
		if v34 != 0 {
			return
				...
				if v61 != 0 {
					...
					if v63 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v8 + int32(32)
						F_errmsg(m, int32(307975), v8)
						mBase = m.M
						v69 = m.ExcPending
						if v69 != 0 {
							return
						} else {
							F_errfinish(m, int32(519652), int32(1064), int32(379291))
							mBase = m.M
							v74 = m.ExcPending
							if v74 != 0 {
								return
