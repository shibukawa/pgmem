				...
				if v30 != 0 {
					...
					if v33 != 0 {
						...
						if v37 != 0 {
							...
							F_errfinish(m, int32(497754), int32(1199), int32(35721))
							mBase = m.M
							v42 = m.ExcPending
							if v42 != 0 {
								return int32(0)
...
L27:
	;
	v149 = v144 + v142<<(uint(int32(3))%32)
	goto L26
L28:
	;
	v130 = v121
...
L39:
	;
	if int32(base.Ui32(v123^v124)>>(uint(int32(8)-v130)%32)) != 0 {
		v130 = v130 - int32(1)
		goto L39
	} else {
		goto L41
		...
		if base.Ui32(v30) <= base.Ui32(v29) {
			...
			if v34 != 0 {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v55)+1)) = uint8(v30)
				if v30 == int32(0) {
					...
					v59 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v33))))
					if v59&int32(1) != 0 {
						v62 = v52
					} else {
						v62 = v54
					...
					v65 = int32(1)
					v69 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v15))))
					if v69&v65 != 0 {
						v72 = v15 + v65
					} else {
						v72 = v15 + int32(4)
					}
					v80 = int32(base.Ui32((v30+int32(7))&int32(248)) >> (uint(int32(3)) % 32))
					if v80 != 0 {
						v81 = F__emscripten_memcpy_bulkmem(m, v62+int32(2), v72+int32(2), v80)
						mBase = m.M
					} else {
					}
					v84 = v30 & int32(7)
					if v84 == int32(0) {
						...
						v89 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v33))))
						if v89&int32(1) != 0 {
							v92 = v52
						} else {
							v92 = v54
						}
						v95 = int32(base.Ui32(v30)>>(uint(int32(3))%32)) + v92 + int32(2)
						v96 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v95))))
						v99 = v96 & (int32(-256) >> (uint(v84) % 32))
				...
				v112 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v33+v110))))
				if v112 == int32(2) {
					v115 = int32(40)
				} else {
					v115 = int32(88)
				}
				*(*int32)(unsafe.Add(mBase, uint32(v33))) = v115
				m.G0 = v10 + int32(16)
				return v33
			}
		} else {
			...
			if v124 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = v30
				F_errmsg_internal(m, int32(483410), v10)
				mBase = m.M
				v128 = m.ExcPending
				if v128 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(497754), int32(316), int32(228892))
					mBase = m.M
					v133 = m.ExcPending
					if v133 != 0 {
						return int32(0)
