...
func F_be_lo_put(m *base.Module, l0 int32) int32 {
	...
	if v14 != 0 {
		...
		F_PreventCommandIfReadOnly(m, int32(708552))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
			...
			v19 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _consts[368])) = uint8(v19)
...
func F_be_lo_tell64(m *base.Module, l0 int32) int32 {
	...
	if v8 < int32(0) {
		...
		if v26 != 0 {
			...
			if v29 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8
				F_errmsg(m, int32(500258), v6)
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(514476), int32(306), int32(580589))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return int32(0)
		...
		v12 = *(*int32)(unsafe.Add(mBase, _consts[366]))
		if v12 <= v8 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v26 = m.ExcPending
			...
			v15 = *(*int32)(unsafe.Add(mBase, _consts[367]))
