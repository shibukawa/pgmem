...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(491975)
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v114))) = v121
	...
	F_ResourceOwnerRemember(m, v124, v121, int32(1609600))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L1
...
L32:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v143
	...
	F_ResourceOwnerForget(m, v146, v147+int32(1), int32(1609600))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L1
...
L45:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v8))) = uint32(v142)
	v147 = F_pg_sprintf(m, v8+int32(16), int32(510920), v8)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L5
...
L62:
	;
	F_errmsg(m, int32(425818), int32(0))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L5
...
L63:
	;
	F_errdetail(m, int32(557645), int32(0))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L5
...
L64:
	;
	F_errfinish(m, int32(492751), int32(305), int32(524707))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L5
...
L76:
	;
	F_errfinish(m, int32(492751), int32(322), int32(524707))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L5
