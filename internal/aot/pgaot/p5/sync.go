...
L3:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v9)+28)) = int32(241628)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(520922)
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v114))) = v121
	...
	F_ResourceOwnerRemember(m, v124, v121, int32(1665504))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L1
...
L32:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v143
	...
	F_ResourceOwnerForget(m, v146, v147+int32(1), int32(1665504))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L1
...
L45:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v8))) = uint32(v142)
	v147 = F_pg_sprintf(m, v8+int32(16), int32(541649), v8)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L5
...
L51:
	;
	v155 = *(*int32)(unsafe.Add(mBase, _consts[416]))
...
L57:
	;
	v209 = *(*int32)(unsafe.Add(mBase, _consts[411]))
	if v209 != 0 {
		goto L68
	} else {
		goto L69
...
L62:
	;
	F_errmsg(m, int32(450344), int32(0))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L5
...
L63:
	;
	F_errdetail(m, int32(605401), int32(0))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L5
...
L64:
	;
	F_errfinish(m, int32(521710), int32(305), int32(555456))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L5
...
L68:
	;
	v211 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[411])) = v211
...
L72:
	;
	F_errmsg(m, int32(82909), int32(0))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L5
...
L76:
	;
	F_errfinish(m, int32(521710), int32(322), int32(555456))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L5
