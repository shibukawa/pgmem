...
func F_RegisterSyncRequest(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v39 int32
	_ = v39
	v6 = *(*int32)(unsafe.Add(mBase, _consts[806]))
	if v6 == int32(0) {
		goto L3
	} else {
		goto L4
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v9)+28)) = int32(229899)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(496589)
...
L6:
	...
	v67 = int32(4126908)
	v68 = *(*int32)(unsafe.Add(mBase, _consts[605]))
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _consts[605])) = v85
	goto L12
L14:
	;
	if int32(999) < v68 {
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+24)) = (v106 + v107) & int32(-4194305)
	...
	v113 = int32(4436472)
	v114 = *(*int32)(unsafe.Add(mBase, _consts[622]))
	*(*int32)(unsafe.Add(mBase, _consts[622])) = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v114)+4)) = v107
	v121 = v112 + v107
	*(*int32)(unsafe.Add(mBase, uint32(v114))) = v121
	v124 = *(*int32)(unsafe.Add(mBase, _consts[10]))
	F_ResourceOwnerRemember(m, v124, v121, int32(1630384))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L1
...
L32:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v143
	...
	F_ResourceOwnerForget(m, v146, v147+int32(1), int32(1630384))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L1
...
L34:
	;
	v156 = int32(*(*uint8)(unsafe.Add(mBase, _consts[625])))
	if v156&int32(1) != 0 {
		goto L35
	} else {
		goto L36
...
L36:
	;
	v160 = int32(*(*uint8)(unsafe.Add(mBase, _consts[626])))
	if v160 != int32(1) {
		goto L35
	} else {
		goto L37
...
func F_SyncRepUpdateSyncStandbysDefined(m *base.Module) {
	...
	var v169 int32
	_ = v169
	v6 = *(*int32)(unsafe.Add(mBase, _consts[566]))
	if v6 == int32(0) {
		goto L6
	} else {
		goto L7
...
L4:
	;
	v141 = *(*int32)(unsafe.Add(mBase, _consts[564]))
	*(*uint8)(unsafe.Add(mBase, uint32(v141)+48)) = uint8(v139)
	goto L2
L5:
	;
	v46 = *(*int32)(unsafe.Add(mBase, _consts[564]))
...
L6:
	;
	v10 = *(*int32)(unsafe.Add(mBase, _consts[564]))
...
L8:
	...
	v24 = int32(0)
	v27 = *(*int32)(unsafe.Add(mBase, _consts[564]))
...
L19:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _consts[564]))
	v75 = v72
	goto L15
L20:
	;
...
L26:
	;
	v104 = *(*int32)(unsafe.Add(mBase, _consts[564]))
	v107 = v104
	goto L22
L27:
	;
...
L36:
	;
	v155 = *(*int32)(unsafe.Add(mBase, _consts[564]))
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[563]))
	if v15 < int32(2) {
		goto L1
	} else {
		goto L3
...
L3:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[564]))
...
L45:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v8))) = uint32(v142)
	v147 = F_pg_sprintf(m, v8+int32(16), int32(515746), v8)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L5
...
L52:
	;
	*(*int32)(unsafe.Add(mBase, _consts[567])) = int32(1)
	v265 = int32(0)
...
L54:
	;
	v164 = *(*int32)(unsafe.Add(mBase, _consts[567]))
	if v164 != 0 {
		goto L55
	} else {
		goto L56
...
L57:
	;
	v209 = *(*int32)(unsafe.Add(mBase, _consts[416]))
	if v209 != 0 {
		goto L68
	} else {
		goto L69
...
L62:
	;
	F_errmsg(m, int32(429661), int32(0))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L5
...
L63:
	;
	F_errdetail(m, int32(578056), int32(0))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L5
...
L64:
	;
	F_errfinish(m, int32(497377), int32(305), int32(529553))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L5
...
L68:
	;
	v211 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[416])) = v211
...
L72:
	;
	F_errmsg(m, int32(77164), int32(0))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L5
...
L76:
	;
	F_errfinish(m, int32(497377), int32(322), int32(529553))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L5
