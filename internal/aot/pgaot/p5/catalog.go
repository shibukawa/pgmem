...
L2:
	...
	v28 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v77+(l0+int32(32))))) = v170
	...
	v182 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L18:
	;
	F_errmsg_internal(m, int32(180065), int32(0))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(525501), int32(1178), int32(420300))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L40:
	;
	F_errfinish(m, int32(525501), int32(330), int32(184977))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L1
