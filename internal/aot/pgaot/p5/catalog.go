...
L2:
	;
	v24 = int32(_a_F_CatalogCacheInitializeCache_0)
	v25 = *(*int32)(unsafe.Add(mBase, _c_F_CatalogCacheInitializeCache[0]))
	v28 = *(*int32)(unsafe.Add(mBase, _c_F_CatalogCacheInitializeCache[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_CatalogCacheInitializeCache[0])) = v28
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_CatalogCacheInitializeCache[0])) = v25
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v77+(l0+int32(32))))) = v170
	...
	v182 = *(*int32)(unsafe.Add(mBase, _c_F_CatalogCacheInitializeCache[1]))
...
L37:
	;
	if v104 == int32(_a_F_CatalogCacheInitializeCache_4) {
		goto L13
	} else {
		goto L38
	}
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v104
	F_errmsg_internal(m, int32(_a_F_CatalogCacheInitializeCache_5), v18)
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
