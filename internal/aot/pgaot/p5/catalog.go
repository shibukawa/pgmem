...
L2:
	...
	v28 = *(*int32)(unsafe.Add(mBase, _consts[361]))
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v77+(l0+int32(32))))) = v170
	...
	v182 = *(*int32)(unsafe.Add(mBase, _consts[361]))
...
L18:
	;
	F_errmsg_internal(m, int32(179901), int32(0))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(525055), int32(1178), int32(419879))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v104
	F_errmsg_internal(m, int32(22856), v18)
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L40:
	;
	F_errfinish(m, int32(525055), int32(330), int32(184813))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L1
