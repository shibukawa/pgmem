...
L18:
	;
	F_errmsg_internal(m, int32(166371), int32(0))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(490197), int32(1178), int32(393006))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v104
	F_errmsg_internal(m, int32(22105), v18)
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L40:
	;
	F_errfinish(m, int32(490197), int32(330), int32(170910))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L1
