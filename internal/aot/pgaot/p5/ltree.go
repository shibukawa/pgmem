...
L5:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1459])) = v17
	v22 = v17
	goto L3
L6:
	;
...
L29:
	;
	v81 = *(*int32)(unsafe.Add(mBase, _consts[1459]))
...
L33:
	;
	v99 = *(*int32)(unsafe.Add(mBase, _consts[1459]))
...
L34:
	;
	v92 = *(*int32)(unsafe.Add(mBase, _consts[1459]))
...
L40:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[1459]))
