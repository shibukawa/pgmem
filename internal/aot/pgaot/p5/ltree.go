...
func F_ltree_prefix_eq_ci(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v173 int32
	_ = v173
	v12 = *(*int32)(unsafe.Add(mBase, _consts[1454]))
	if v12 == int32(0) {
		goto L1
	} else {
		goto L2
...
L5:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1454])) = v17
	v22 = v17
	goto L3
L6:
	;
...
L29:
	;
	v81 = *(*int32)(unsafe.Add(mBase, _consts[1454]))
...
L33:
	;
	v99 = *(*int32)(unsafe.Add(mBase, _consts[1454]))
...
L34:
	;
	v92 = *(*int32)(unsafe.Add(mBase, _consts[1454]))
...
L40:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[1454]))
