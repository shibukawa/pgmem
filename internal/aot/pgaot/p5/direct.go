			...
			if v37 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
				...
				if v41 != 0 {
					...
					F_errfinish(m, int32(_a_F_DirectFunctionCall2Coll_1), int32(828), int32(_a_F_DirectFunctionCall2Coll_2))
					mBase = m.M
					v46 = m.ExcPending
					if v46 != 0 {
						return int32(0)
			...
			if v45 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
				...
				if v49 != 0 {
					...
					F_errfinish(m, int32(_a_F_DirectFunctionCall4Coll_1), int32(880), int32(_a_F_DirectFunctionCall4Coll_2))
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
