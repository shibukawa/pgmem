...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v82
	F_errmsg(m, int32(_a_F_parse_tsquery_0), v13)
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L16
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v175
	F_errmsg_internal(m, int32(_a_F_parse_tsquery_4), v13+int32(16))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L16
...
L29:
	;
	v233 = *(*int32)(unsafe.Add(mBase, _c_F_tsquery_rewrite_query[1]))
...
L32:
	...
	v114 = *(*int32)(unsafe.Add(mBase, _c_F_tsquery_rewrite_query[1]))
...
L35:
	;
	v205 = *(*int32)(unsafe.Add(mBase, _c_F_tsquery_rewrite_query[1]))
...
L36:
	;
	v194 = v109 + int64(1)
	v196 = *(*int64)(unsafe.Add(mBase, _c_F_tsquery_rewrite_query[2]))
...
L37:
	;
	v126 = *(*int32)(unsafe.Add(mBase, _c_F_tsquery_rewrite_query[1]))
...
L46:
	;
	v162 = int32(_a_F_tsquery_rewrite_query_0)
	v163 = *(*int32)(unsafe.Add(mBase, _c_F_tsquery_rewrite_query[0]))
...
L48:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_tsquery_rewrite_query[0])) = v163
	F_QTNFree(m, v145)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
...
L57:
	...
	v214 = *(*int64)(unsafe.Add(mBase, _c_F_tsquery_rewrite_query[2]))
	if v214 == int64(0) {
		v219 = v212
		v220 = v199
		goto L29
