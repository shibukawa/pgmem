						...
						if v44 != 0 {
							...
							if v47 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v48 + int32(4)
								F_errmsg(m, int32(743683), v9)
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(520068), int32(3714), int32(361219))
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
							...
							if v63 != 0 {
								...
								if v66 != 0 {
									...
									if v70 != 0 {
										...
										F_errfinish(m, int32(520068), int32(3720), int32(361219))
										mBase = m.M
										v75 = m.ExcPending
										if v75 != 0 {
											return int32(0)
								...
								if v31 == int32(0) {
									...
									if v79 != 0 {
										...
										if v82 != 0 {
											...
											F_errmsg(m, int32(153343), int32(0))
											mBase = m.M
											v86 = m.ExcPending
											if v86 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(520068), int32(3729), int32(361219))
												mBase = m.M
												v91 = m.ExcPending
												if v91 != 0 {
													return int32(0)
		...
		if l4 == int32(-1) {
			if l5 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+184)) = v40
				v45 = F_pg_sprintf(m, l0, int32(187095), v10+int32(176))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return
			...
			if l5 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+220)) = v61
				v66 = F_pg_sprintf(m, l0, int32(187059), v10+int32(208))
				mBase = m.M
				v67 = m.ExcPending
				if v67 != 0 {
					return
	...
	case 1:
		if l5 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+148)) = v19
			v24 = F_pg_sprintf(m, l0, int32(187109), v10+int32(144))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return
	...
	default:
		if l4 == int32(-1) {
			if l5 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+40)) = int32(590654)
				*(*int32)(unsafe.Add(mBase, uint32(v10)+36)) = l2
				*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = int32(513062)
				v94 = F_pg_sprintf(m, l0, int32(187077), v10+int32(32))
				mBase = m.M
				v95 = m.ExcPending
				if v95 != 0 {
					return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+8)) = int32(590654)
				*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = l2
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(513062)
			...
			if l5 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+104)) = int32(590654)
				*(*int32)(unsafe.Add(mBase, uint32(v10)+100)) = l2
				*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = int32(513062)
				v123 = F_pg_sprintf(m, l0, int32(187037), v10+int32(96))
				mBase = m.M
				v124 = m.ExcPending
				if v124 != 0 {
					return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+72)) = int32(590654)
				*(*int32)(unsafe.Add(mBase, uint32(v10)+68)) = l2
				*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = int32(513062)
...
L14:
	...
	v90 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v160
	F_errmsg_internal(m, int32(529528), v22)
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L4
...
L42:
	;
	F_errfinish(m, int32(525547), int32(1197), int32(512988))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v184)+8)) = int32(-1)
	v189 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L82:
	;
	v321 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L90:
	...
	v351 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L110:
	;
	v412 = int32(0)
	v414 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+116)) = v472 + int32(4)
	F_errmsg_internal(m, int32(744784), v22+int32(112))
	mBase = m.M
	v482 = m.ExcPending
	if v482 != 0 {
		goto L4
...
L127:
	;
	F_errfinish(m, int32(525547), int32(4529), int32(341517))
	mBase = m.M
	v487 = m.ExcPending
	if v487 != 0 {
		goto L4
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+100)) = v503 + int32(4)
	F_errmsg_internal(m, int32(744676), v22+int32(96))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L4
...
L136:
	;
	F_errfinish(m, int32(525547), int32(4538), int32(341517))
	mBase = m.M
	v518 = m.ExcPending
	if v518 != 0 {
		goto L4
...
L138:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v523))) = uint16(v524)
	v527 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L148:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+84)) = v571 + int32(4)
	F_errmsg_internal(m, int32(741478), v22+int32(80))
	mBase = m.M
	v581 = m.ExcPending
	if v581 != 0 {
		goto L4
...
L149:
	;
	F_errfinish(m, int32(525547), int32(4556), int32(341517))
	mBase = m.M
	v586 = m.ExcPending
	if v586 != 0 {
		goto L4
...
L160:
	;
	v631 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L179:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v719)+10)) = uint8(v724)
	v727 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L181:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v703 + int32(4)
	F_errmsg_internal(m, int32(741684), v22-int32(-64))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L4
...
L182:
	;
	F_errfinish(m, int32(525547), int32(4657), int32(341494))
	mBase = m.M
	v716 = m.ExcPending
	if v716 != 0 {
		goto L4
...
L190:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v748 + int32(4)
	F_errmsg_internal(m, int32(741395), v22+int32(48))
	mBase = m.M
	v756 = m.ExcPending
	if v756 != 0 {
		goto L4
...
L191:
	;
	F_errfinish(m, int32(525547), int32(4673), int32(341494))
	mBase = m.M
	v761 = m.ExcPending
	if v761 != 0 {
		goto L4
...
L193:
	;
	v765 = *(*int32)(unsafe.Add(mBase, _consts[362]))
...
L203:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+36)) = v809 + int32(4)
	F_errmsg_internal(m, int32(741425), v22+int32(32))
	mBase = m.M
	v819 = m.ExcPending
	if v819 != 0 {
		goto L4
...
L204:
	;
	F_errfinish(m, int32(525547), int32(4690), int32(341494))
	mBase = m.M
	v824 = m.ExcPending
	if v824 != 0 {
		goto L4
...
L263:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v1091 + int32(4)
	F_errmsg_internal(m, int32(736828), v22+int32(16))
	mBase = m.M
	v1099 = m.ExcPending
	if v1099 != 0 {
		goto L4
...
L264:
	;
	F_errfinish(m, int32(525547), int32(1314), int32(512988))
	mBase = m.M
	v1104 = m.ExcPending
	if v1104 != 0 {
		goto L4
...
L266:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+148)) = v1137 + int32(4)
	F_errmsg_internal(m, int32(741822), v22+int32(144))
	mBase = m.M
	v1147 = m.ExcPending
	if v1147 != 0 {
		goto L4
...
L267:
	;
	F_errfinish(m, int32(525547), int32(585), int32(512956))
	mBase = m.M
	v1152 = m.ExcPending
	if v1152 != 0 {
		goto L4
...
L270:
	;
	F_errfinish(m, int32(525547), int32(667), int32(512956))
	mBase = m.M
	v1169 = m.ExcPending
	if v1169 != 0 {
		goto L4
...
L1:
	;
	F_read_relmap_file(m, int32(4550892), int32(330543), int32(0), int32(22))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L4
...
L22:
	;
	F_errfinish(m, int32(521852), int32(1999), int32(347281))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L2
				...
				if v22 != 0 {
					...
					if v83 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = v84
						F_errmsg_internal(m, int32(296100), v6)
						mBase = m.M
						v88 = m.ExcPending
						if v88 != 0 {
							return
						} else {
							F_errfinish(m, int32(525547), int32(2903), int32(277758))
							mBase = m.M
							v93 = m.ExcPending
							if v93 != 0 {
								return
...
L11:
	;
	F_errfinish(m, int32(525873), int32(940), int32(70424))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
func F_relation_needs_vacanalyze(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32) {
	...
	if l1 != 0 {
		...
		v49 = *(*int32)(unsafe.Add(mBase, _consts[398]))
		...
		v56 = *(*float64)(unsafe.Add(mBase, _consts[399]))
		...
		v68 = *(*float64)(unsafe.Add(mBase, _consts[401]))
		...
		v74 = *(*int32)(unsafe.Add(mBase, _consts[402]))
		if int32(-2) < v72 {
			v77 = v72
		} else {
			v77 = v74
		}
		v79 = *(*int32)(unsafe.Add(mBase, _consts[403]))
		...
		v86 = *(*float64)(unsafe.Add(mBase, _consts[404]))
		...
		v94 = *(*int32)(unsafe.Add(mBase, _consts[398]))
		v96 = *(*float64)(unsafe.Add(mBase, _consts[399]))
		v98 = *(*int32)(unsafe.Add(mBase, _consts[400]))
		v100 = *(*float64)(unsafe.Add(mBase, _consts[401]))
		v102 = *(*int32)(unsafe.Add(mBase, _consts[402]))
		v104 = *(*int32)(unsafe.Add(mBase, _consts[403]))
		v106 = *(*float64)(unsafe.Add(mBase, _consts[404]))
		v108 = l4
		v110 = v92
		v111 = v98
		v112 = v102
	...
	if base.Ui32(v119) < base.Ui32(int32(3)) {
		...
		if v148 != 0 {
			v151 = *(*int32)(unsafe.Add(mBase, _consts[405]))
			if v108 == v151 {
				v154 = int32(-1)
			} else {
				v154 = v151 - v108
		...
		*(*uint8)(unsafe.Add(mBase, uint32(l7))) = uint8(v160)
		if (v160|v118)&int32(1) != 0 {
			...
			if l3 == int32(0) {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(l6))) = uint8(v311)
				...
				v174 = int32(*(*uint8)(unsafe.Add(mBase, _consts[406])))
				if v174 != int32(1) {
					*(*uint8)(unsafe.Add(mBase, uint32(l5))) = uint8(v169)
					v307 = int32(0)
					if l0 != int32(2619) {
							...
							if int32(0) <= v111 {
								if v233 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v32))) = l2 + int32(4)
									F_errmsg_internal(m, int32(710351), v32)
									mBase = m.M
									v257 = m.ExcPending
									if v257 != 0 {
										return
										...
										v278 = int32(3138)
										F_errfinish(m, int32(523274), v278, int32(358537))
										mBase = m.M
										v281 = m.ExcPending
										if v281 != 0 {
											return
								...
								if v233 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v32)+64)) = l2 + int32(4)
									F_errmsg_internal(m, int32(710438), v32-int32(-64))
									mBase = m.M
									v276 = m.ExcPending
									if v276 != 0 {
										return
		...
		v123 = *(*int32)(unsafe.Add(mBase, _consts[407]))
		v124 = v123 - v110
		v125 = int32(3)
					...
					if v54 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
						...
						if v58 != 0 {
							...
							F_errfinish(m, int32(522180), int32(61), int32(295965))
							mBase = m.M
							v63 = m.ExcPending
							if v63 != 0 {
								return int32(0)
