						...
						if v44 != 0 {
							...
							if v47 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v48 + int32(4)
								F_errmsg(m, int32(734887), v9)
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(514330), int32(3714), int32(357175))
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
							...
							if v63 != 0 {
								...
								if v66 != 0 {
									...
									if v70 != 0 {
										...
										F_errfinish(m, int32(514330), int32(3720), int32(357175))
										mBase = m.M
										v75 = m.ExcPending
										if v75 != 0 {
											return int32(0)
								...
								if v31 == int32(0) {
									...
									if v79 != 0 {
										...
										if v82 != 0 {
											...
											F_errmsg(m, int32(151650), int32(0))
											mBase = m.M
											v86 = m.ExcPending
											if v86 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(514330), int32(3729), int32(357175))
												mBase = m.M
												v91 = m.ExcPending
												if v91 != 0 {
													return int32(0)
		...
		if l4 == int32(-1) {
			if l5 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+184)) = v40
				v45 = F_pg_sprintf(m, l0, int32(184870), v10+int32(176))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+160)) = l1
				v52 = F_pg_sprintf(m, l0, int32(41157), v10+int32(160))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
			...
			if l5 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+220)) = v61
				v66 = F_pg_sprintf(m, l0, int32(184834), v10+int32(208))
				mBase = m.M
				v67 = m.ExcPending
				if v67 != 0 {
					return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+192)) = l1
				v74 = F_pg_sprintf(m, l0, int32(39761), v10+int32(192))
				mBase = m.M
				v75 = m.ExcPending
				if v75 != 0 {
					return
	...
	case 1:
		if l5 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+148)) = v19
			v24 = F_pg_sprintf(m, l0, int32(184884), v10+int32(144))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+128)) = l3
			v30 = F_pg_sprintf(m, l0, int32(41473), v10+int32(128))
			mBase = m.M
			v31 = m.ExcPending
			if v31 != 0 {
				return
	...
	default:
		if l4 == int32(-1) {
			if l5 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+40)) = int32(583804)
				*(*int32)(unsafe.Add(mBase, uint32(v10)+36)) = l2
				*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = int32(507397)
				v94 = F_pg_sprintf(m, l0, int32(184852), v10+int32(32))
				mBase = m.M
				v95 = m.ExcPending
				if v95 != 0 {
					return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+8)) = int32(583804)
				*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = l2
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(507397)
				v104 = F_pg_sprintf(m, l0, int32(41142), v10)
				mBase = m.M
				v105 = m.ExcPending
				if v105 != 0 {
					return
			...
			if l5 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+104)) = int32(583804)
				*(*int32)(unsafe.Add(mBase, uint32(v10)+100)) = l2
				*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = int32(507397)
				v123 = F_pg_sprintf(m, l0, int32(184812), v10+int32(96))
				mBase = m.M
				v124 = m.ExcPending
				if v124 != 0 {
					return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+72)) = int32(583804)
				*(*int32)(unsafe.Add(mBase, uint32(v10)+68)) = l2
				*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = int32(507397)
				v136 = F_pg_sprintf(m, l0, int32(39742), v10-int32(-64))
				mBase = m.M
				v137 = m.ExcPending
				if v137 != 0 {
					return
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v160
	F_errmsg_internal(m, int32(523659), v22)
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L4
...
L42:
	;
	F_errfinish(m, int32(519688), int32(1197), int32(507323))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L4
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+116)) = v472 + int32(4)
	F_errmsg_internal(m, int32(735988), v22+int32(112))
	mBase = m.M
	v482 = m.ExcPending
	if v482 != 0 {
		goto L4
...
L127:
	;
	F_errfinish(m, int32(519688), int32(4529), int32(337713))
	mBase = m.M
	v487 = m.ExcPending
	if v487 != 0 {
		goto L4
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+100)) = v503 + int32(4)
	F_errmsg_internal(m, int32(735880), v22+int32(96))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L4
...
L136:
	;
	F_errfinish(m, int32(519688), int32(4538), int32(337713))
	mBase = m.M
	v518 = m.ExcPending
	if v518 != 0 {
		goto L4
...
L148:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+84)) = v571 + int32(4)
	F_errmsg_internal(m, int32(732823), v22+int32(80))
	mBase = m.M
	v581 = m.ExcPending
	if v581 != 0 {
		goto L4
...
L149:
	;
	F_errfinish(m, int32(519688), int32(4556), int32(337713))
	mBase = m.M
	v586 = m.ExcPending
	if v586 != 0 {
		goto L4
...
L181:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v703 + int32(4)
	F_errmsg_internal(m, int32(732927), v22-int32(-64))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L4
...
L182:
	;
	F_errfinish(m, int32(519688), int32(4657), int32(337690))
	mBase = m.M
	v716 = m.ExcPending
	if v716 != 0 {
		goto L4
...
L190:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v748 + int32(4)
	F_errmsg_internal(m, int32(732740), v22+int32(48))
	mBase = m.M
	v756 = m.ExcPending
	if v756 != 0 {
		goto L4
...
L191:
	;
	F_errfinish(m, int32(519688), int32(4673), int32(337690))
	mBase = m.M
	v761 = m.ExcPending
	if v761 != 0 {
		goto L4
...
L203:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+36)) = v809 + int32(4)
	F_errmsg_internal(m, int32(732770), v22+int32(32))
	mBase = m.M
	v819 = m.ExcPending
	if v819 != 0 {
		goto L4
...
L204:
	;
	F_errfinish(m, int32(519688), int32(4690), int32(337690))
	mBase = m.M
	v824 = m.ExcPending
	if v824 != 0 {
		goto L4
...
L263:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v1091 + int32(4)
	F_errmsg_internal(m, int32(728173), v22+int32(16))
	mBase = m.M
	v1099 = m.ExcPending
	if v1099 != 0 {
		goto L4
...
L264:
	;
	F_errfinish(m, int32(519688), int32(1314), int32(507323))
	mBase = m.M
	v1104 = m.ExcPending
	if v1104 != 0 {
		goto L4
...
L266:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+148)) = v1137 + int32(4)
	F_errmsg_internal(m, int32(733065), v22+int32(144))
	mBase = m.M
	v1147 = m.ExcPending
	if v1147 != 0 {
		goto L4
...
L267:
	;
	F_errfinish(m, int32(519688), int32(585), int32(507291))
	mBase = m.M
	v1152 = m.ExcPending
	if v1152 != 0 {
		goto L4
...
L269:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+128)) = v380
	F_errmsg_internal(m, int32(60658), v22+int32(128))
	mBase = m.M
	v1164 = m.ExcPending
	if v1164 != 0 {
		goto L4
...
L270:
	;
	F_errfinish(m, int32(519688), int32(667), int32(507291))
	mBase = m.M
	v1169 = m.ExcPending
	if v1169 != 0 {
		goto L4
...
L1:
	;
	F_read_relmap_file(m, int32(4537820), int32(326987), int32(0), int32(22))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L4
...
L6:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _consts[1111]))
	F_read_relmap_file(m, int32(4538868), v28, int32(0), int32(22))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L4
...
L40:
	;
	v87 = v77 + int32(76)
	v89 = *(*int32)(unsafe.Add(mBase, _consts[788]))
	if v89 != 0 {
		goto L44
	} else {
		goto L45
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, _consts[789])) = v87
	goto L42
L44:
	;
...
L46:
	;
	v93 = int32(4472504)
	*(*int32)(unsafe.Add(mBase, _consts[788])) = v93
	v96 = v93
	goto L43
L47:
	;
...
L80:
	;
	v182 = v172 + int32(76)
	v184 = *(*int32)(unsafe.Add(mBase, _consts[788]))
	if v184 != 0 {
		goto L84
	} else {
		goto L85
...
L83:
	...
	*(*int32)(unsafe.Add(mBase, _consts[789])) = v182
	goto L82
L84:
	;
	v186 = *(*int32)(unsafe.Add(mBase, _consts[789]))
	v191 = v186
	goto L83
L85:
	;
...
L86:
	;
	v188 = int32(4472504)
	*(*int32)(unsafe.Add(mBase, _consts[788])) = v188
	v191 = v188
	goto L83
L87:
	;
...
L115:
	;
	v280 = v270 + int32(76)
	v282 = *(*int32)(unsafe.Add(mBase, _consts[788]))
	if v282 != 0 {
		goto L119
	} else {
		goto L120
...
L118:
	...
	*(*int32)(unsafe.Add(mBase, _consts[789])) = v280
	goto L117
L119:
	;
	v284 = *(*int32)(unsafe.Add(mBase, _consts[789]))
	v289 = v284
	goto L118
L120:
	;
...
L121:
	;
	v286 = int32(4472504)
	*(*int32)(unsafe.Add(mBase, _consts[788])) = v286
	v289 = v286
	goto L118
L122:
	;
...
L22:
	;
	F_errfinish(m, int32(516025), int32(1999), int32(343380))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L2
				...
				if v22 != 0 {
					...
					if v83 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = v84
						F_errmsg_internal(m, int32(293009), v6)
						mBase = m.M
						v88 = m.ExcPending
						if v88 != 0 {
							return
						} else {
							F_errfinish(m, int32(519688), int32(2903), int32(274753))
							mBase = m.M
							v93 = m.ExcPending
							if v93 != 0 {
								return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v19)+44)) = v31
							...
							if v33 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v33)+72)) = v38
								if v38 == int32(0) {
									v43 = v33 + int32(76)
									v45 = *(*int32)(unsafe.Add(mBase, _consts[788]))
									if v45 != 0 {
										v47 = *(*int32)(unsafe.Add(mBase, _consts[789]))
										v52 = v47
									} else {
										v49 = int32(4472504)
										*(*int32)(unsafe.Add(mBase, _consts[788])) = v49
										v52 = v49
									}
									...
									*(*int32)(unsafe.Add(mBase, _consts[789])) = v43
								} else {
								}
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	F_errmsg_internal(m, int32(49502), v11)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L2
...
L11:
	;
	F_errfinish(m, int32(520004), int32(940), int32(69737))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
func F_RelationMapInvalidate(m *base.Module, l0 int32) {
	...
	if l0 != 0 {
		...
		if v13 != int32(5842711) {
			...
			F_read_relmap_file(m, int32(4538868), v18, int32(0), int32(22))
			mBase = m.M
			v22 = m.ExcPending
			if v22 != 0 {
				return
							...
							if int32(0) <= v111 {
								if v233 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v32))) = l2 + int32(4)
									F_errmsg_internal(m, int32(701877), v32)
									mBase = m.M
									v257 = m.ExcPending
									if v257 != 0 {
										return
										...
										v278 = int32(3138)
										F_errfinish(m, int32(517442), v278, int32(354536))
										mBase = m.M
										v281 = m.ExcPending
										if v281 != 0 {
											return
								...
								if v233 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v32)+64)) = l2 + int32(4)
									F_errmsg_internal(m, int32(701964), v32-int32(-64))
									mBase = m.M
									v276 = m.ExcPending
									if v276 != 0 {
										return
				...
				if v12 != 0 {
					...
					if v54 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
						F_errmsg_internal(m, int32(60771), v6)
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(516353), int32(61), int32(292874))
							mBase = m.M
							v63 = m.ExcPending
							if v63 != 0 {
								return int32(0)
						...
						if v18 == int32(0) {
							...
							if v63 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v16
								F_errmsg_internal(m, int32(60771), v8)
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return int32(0)
