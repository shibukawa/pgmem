...
L26:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = int32(334434)
	F_errmsg(m, int32(198191), v12+int32(32))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = v39 + v78
	F_errdetail(m, int32(654947), v12+int32(16))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L44:
	;
	F_errsave_finish(m, l4, int32(27401), int32(680), int32(165243))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L1
