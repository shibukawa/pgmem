...
func F_SimpleLruDoesPhysicalPageExist(m *base.Module, l0 int32, l1 int64) int32 {
	...
	v16 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[88])) = uint8(v16)
	*(*uint8)(unsafe.Add(mBase, _consts[89])) = uint8(v16)
	v22 = v14 << (uint(int32(6)) % 32)
	v25 = *(*int64)(unsafe.Add(mBase, uint32(v22)+uint32(_consts[91])))
	*(*int64)(unsafe.Add(mBase, uint32(v22)+uint32(_consts[91]))) = v25 + int64(1)
	v30 = l0 + int32(16)
	...
	if v33 == v16 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v11))) = v30
		v42 = F_pg_snprintf(m, v11+int32(32), int32(1024), int32(535964), v11)
		mBase = m.M
		v45 = m.ExcPending
		if v45 != 0 {
			return int32(0)
			...
			if v61 != 0 {
				...
				if v60 < int32(0) {
					v65 = *(*int32)(unsafe.Add(mBase, _consts[85]))
					if v65 == int32(44) {
						v111 = v56
						m.G0 = v11 + int32(1056)
						return v111
					} else {
						*(*int32)(unsafe.Add(mBase, _consts[92])) = v65
						v71 = int32(0)
						*(*int32)(unsafe.Add(mBase, _consts[93])) = v71
						...
						if v75 != 0 {
							...
							mBase = m.M
							if v79 < v77 {
								*(*int32)(unsafe.Add(mBase, _consts[93])) = int32(1)
								v87 = *(*int32)(unsafe.Add(mBase, _consts[85]))
								*(*int32)(unsafe.Add(mBase, _consts[92])) = v87
								...
								if v91 != 0 {
									...
									if v93 != 0 {
										...
										if v92 != 0 {
											*(*int32)(unsafe.Add(mBase, _consts[93])) = int32(5)
											v99 = *(*int32)(unsafe.Add(mBase, _consts[85]))
											*(*int32)(unsafe.Add(mBase, _consts[92])) = v99
											v111 = v56
										} else {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v30
		v54 = F_pg_snprintf(m, v11+int32(32), int32(1024), int32(536358), v11+int32(16))
		mBase = m.M
		v55 = m.ExcPending
		if v55 != 0 {
			return int32(0)
