	...
	if v9 != int32(-1) {
		...
		if v59 != 0 {
			...
			if v61 != 0 {
				...
				v64 = *(*int32)(unsafe.Add(mBase, _consts[128]))
				...
				if v66 != 0 {
					...
					if v68 != 0 {
						...
						if v71 != 0 {
							...
							v74 = *(*int32)(unsafe.Add(mBase, _consts[128]))
		...
		v18 = *(*int32)(unsafe.Add(mBase, _consts[115]))
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = v25
		v31 = F_pg_snprintf(m, v6+int32(16), int32(32), int32(512117), v6)
		mBase = m.M
		v34 = m.ExcPending
		if v34 != 0 {
			return int32(0)
			...
			v38 = int32(1)
			F_SetConfigOption(m, int32(144045), v6+int32(16), v38, v38)
			mBase = m.M
			v41 = m.ExcPending
			if v41 != 0 {
				return int32(0)
			} else {
				v43 = *(*int32)(unsafe.Add(mBase, _consts[128]))
				if v43 != int32(-1) {
					v58 = F_mul_size(m, int32(128), int32(9))
					mBase = m.M
					v59 = m.ExcPending
					...
					F_SetConfigOption(m, int32(144045), v6+int32(16), int32(1), int32(10))
					mBase = m.M
					v52 = m.ExcPending
					if v52 != 0 {
						return int32(0)
