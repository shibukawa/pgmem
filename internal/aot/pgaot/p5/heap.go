...
L9:
	;
	v23 = *(*int32)(unsafe.Add(mBase, _consts[38]))
	if v23 <= int32(0) {
		goto L11
	} else {
		goto L12
...
L11:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[39]))
	if v27 == int32(0) {
		v120 = int32(0)
		goto L10
	} else {
...
L13:
	;
	v89 = *(*int32)(unsafe.Add(mBase, _consts[40]))
	v91 = int32(0)
	v93 = v23 - int32(1)
	goto L33
L14:
...
L44:
	;
	v136 = *(*int32)(unsafe.Add(mBase, _consts[1302]))
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v62
				...
				if v14 == v64 {
					...
					if v73 == int32(0) {
						...
						if v76 != int32(65534) {
							...
							if v240 != 0 {
								...
								F_errmsg_internal(m, int32(368669), int32(0))
								mBase = m.M
								v244 = m.ExcPending
								if v244 != 0 {
									return
								} else {
									F_errfinish(m, int32(478019), int32(6224), int32(329117))
									mBase = m.M
									v249 = m.ExcPending
									if v249 != 0 {
										return
							...
							v80 = v12 + int32(16)
							v81 = int32(4444180)
							v83 = *(*int32)(unsafe.Add(mBase, _consts[13]))
							*(*int32)(unsafe.Add(mBase, _consts[13])) = v83 + int32(1)
							...
							v104 = *(*int32)(unsafe.Add(mBase, _consts[42]))
							if v102 != 0 {
								v105 = v90
							} else {
								v105 = v104
							...
							*(*uint16)(unsafe.Add(mBase, uint32(v58)+16)) = uint16(v134)
							...
							if v137 != 0 {
								...
								if v139 != int32(112) {
									v200 = int32(4444180)
									v202 = *(*int32)(unsafe.Add(mBase, _consts[13]))
									*(*int32)(unsafe.Add(mBase, _consts[13])) = v202 - int32(1)
									...
									v143 = *(*int32)(unsafe.Add(mBase, _consts[14]))
									if v143 <= int32(0) {
					...
					if v227 != 0 {
						...
						F_errmsg_internal(m, int32(246414), int32(0))
						mBase = m.M
						v231 = m.ExcPending
						if v231 != 0 {
							return
						} else {
							F_errfinish(m, int32(478019), int32(6222), int32(329117))
							mBase = m.M
							v236 = m.ExcPending
							if v236 != 0 {
								return
...
func F_heap_fetch(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v18 != 0 {
		...
		if v21 != 0 {
			...
			if v15 < int32(0) {
				v25 = *(*int32)(unsafe.Add(mBase, _consts[11]))
...
L7:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[11]))
		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
			...
			if v29 != 0 {
				...
				F_errfinish(m, int32(479636), int32(761), int32(197525))
				mBase = m.M
				v34 = m.ExcPending
				if v34 != 0 {
					return int32(0)
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+80)) = v96
	F_errmsg_internal(m, int32(46795), v26+int32(80))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L44
...
L77:
	;
	F_errfinish(m, int32(478019), int32(6789), int32(447417))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L44
...
L115:
	;
	v380 = *(*int32)(unsafe.Add(mBase, _consts[37]))
	if v380 == v366 {
		goto L116
	} else {
		goto L117
...
L120:
	;
	v388 = *(*int32)(unsafe.Add(mBase, _consts[39]))
	if v388 == int32(0) {
		v481 = int32(0)
		goto L119
	} else {
...
L122:
	;
	v450 = *(*int32)(unsafe.Add(mBase, _consts[40]))
	v452 = int32(0)
	v454 = v384 - int32(1)
	goto L142
L123:
...
L163:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+144)) = v96
	F_errmsg_internal(m, int32(46719), v26+int32(144))
	mBase = m.M
	v527 = m.ExcPending
	if v527 != 0 {
		goto L44
...
L164:
	;
	F_errfinish(m, int32(478019), int32(6910), int32(447417))
	mBase = m.M
	v532 = m.ExcPending
	if v532 != 0 {
		goto L44
...
L171:
	;
	v543 = *(*int32)(unsafe.Add(mBase, _consts[37]))
	if v543 == v366 {
		goto L172
	} else {
		goto L173
...
L174:
	;
	v547 = *(*int32)(unsafe.Add(mBase, _consts[38]))
	if v547 <= int32(0) {
		goto L176
	} else {
		goto L177
...
L176:
	;
	v551 = *(*int32)(unsafe.Add(mBase, _consts[39]))
	if v551 == int32(0) {
		v644 = int32(0)
		goto L175
	} else {
...
L178:
	;
	v613 = *(*int32)(unsafe.Add(mBase, _consts[40]))
	v615 = int32(0)
	v617 = v547 - int32(1)
	goto L198
L179:
...
L240:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+16)) = v96
	F_errmsg_internal(m, int32(306794), v26+int32(16))
	mBase = m.M
	v779 = m.ExcPending
	if v779 != 0 {
		goto L44
...
L241:
	;
	F_errfinish(m, int32(478019), int32(7258), int32(368063))
	mBase = m.M
	v784 = m.ExcPending
	if v784 != 0 {
		goto L44
...
L244:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+160)) = v42
	F_errmsg_internal(m, int32(51417), v26+int32(160))
	mBase = m.M
	v799 = m.ExcPending
	if v799 != 0 {
		goto L44
...
L245:
	;
	F_errfinish(m, int32(478019), int32(7096), int32(368063))
	mBase = m.M
	v804 = m.ExcPending
	if v804 != 0 {
		goto L44
...
L248:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+32)) = v96
	F_errmsg_internal(m, int32(51523), v26+int32(32))
	mBase = m.M
	v819 = m.ExcPending
	if v819 != 0 {
		goto L44
...
L249:
	;
	F_errfinish(m, int32(478019), int32(6744), int32(447417))
	mBase = m.M
	v824 = m.ExcPending
	if v824 != 0 {
		goto L44
...
L252:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+48)) = v96
	F_errmsg_internal(m, int32(321234), v26+int32(48))
	mBase = m.M
	v839 = m.ExcPending
	if v839 != 0 {
		goto L44
...
L253:
	;
	F_errfinish(m, int32(478019), int32(6760), int32(447417))
	mBase = m.M
	v844 = m.ExcPending
	if v844 != 0 {
		goto L44
...
L256:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+64)) = v96
	F_errmsg_internal(m, int32(51459), v26-int32(-64))
	mBase = m.M
	v860 = m.ExcPending
	if v860 != 0 {
		goto L44
...
L257:
	;
	F_errfinish(m, int32(478019), int32(6776), int32(447417))
	mBase = m.M
	v865 = m.ExcPending
	if v865 != 0 {
		goto L44
...
L260:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+128)) = v96
	F_errmsg_internal(m, int32(128011), v26+int32(128))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L44
...
L261:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+112)) = v349
	F_errdetail_internal(m, int32(541257), v26+int32(112))
	mBase = m.M
	v885 = m.ExcPending
	if v885 != 0 {
		goto L44
...
L262:
	;
	F_errfinish(m, int32(478019), int32(6935), int32(447417))
	mBase = m.M
	v890 = m.ExcPending
	if v890 != 0 {
		goto L44
...
L265:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+96)) = v96
	F_errmsg_internal(m, int32(46795), v26+int32(96))
	mBase = m.M
	v906 = m.ExcPending
	if v906 != 0 {
		goto L44
...
L266:
	;
	F_errfinish(m, int32(478019), int32(6972), int32(447417))
	mBase = m.M
	v911 = m.ExcPending
	if v911 != 0 {
		goto L44
...
L269:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v96
	F_errmsg_internal(m, int32(51375), v26)
	mBase = m.M
	v924 = m.ExcPending
	if v924 != 0 {
		goto L44
...
L270:
	;
	F_errfinish(m, int32(478019), int32(7235), int32(368063))
	mBase = m.M
	v929 = m.ExcPending
	if v929 != 0 {
		goto L44
...
L303:
	...
	v1064 = *(*int32)(unsafe.Add(mBase, uint32(v1059<<(uint(int32(2))%32))+uint32(_consts[36])))
...
L308:
	...
	v1082 = *(*int32)(unsafe.Add(mBase, uint32(v1077<<(uint(int32(2))%32))+uint32(_consts[36])))
...
L321:
	...
	v1133 = *(*int32)(unsafe.Add(mBase, uint32(v1128<<(uint(int32(2))%32))+uint32(_consts[36])))
