...
L17:
	;
	v83 = int32(_a_F_ExecCallTriggerFunc_0)
	v84 = *(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[0]))
...
L19:
	;
	v105 = int32(_a_F_ExecCallTriggerFunc_1)
	v107 = *(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[1])) = v107 + int32(1)
	v112 = *(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[2]))
	v114 = *(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[3]))
	goto L20
L20:
	;
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[3])) = v124
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[2])) = v123
	v133 = int32(_a_F_ExecCallTriggerFunc_1)
	v135 = *(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[1]))
	v136 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[1])) = v135 - v136
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[2])) = v121
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[2])) = v123
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[3])) = v124
	v169 = int32(_a_F_ExecCallTriggerFunc_1)
	v171 = *(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[1])) = v171 - int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+20)) = v124
	*(*int32)(unsafe.Add(mBase, uint32(v19)+24)) = v123
	*(*int32)(unsafe.Add(mBase, uint32(v19)+28)) = v126
	*(*int32)(unsafe.Add(mBase, uint32(v19)+36)) = v121
...
L29:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[0])) = v126
...
L30:
	...
	mBase = m.M
	v196 = int32(_a_F_ExecCallTriggerFunc_2)
	v197 = *(*int64)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[4]))
	...
	*(*int64)(unsafe.Add(mBase, _c_F_ExecCallTriggerFunc[4])) = v199 + v206
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v255
	F_errmsg(m, int32(_a_F_ExecCallTriggerFunc_3), v19)
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		v297 = v128
