		...
		if v14 != 0 {
			...
			if v24 != 0 {
				...
				if v21 == int32(0) {
					...
					v28 = int32(-1)
					v29 = int32(0)
					v33 = F_DirectFunctionCall1Coll(m, int32(1465), v29, v15)
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return int32(0)
								...
								if v48 != 0 {
									...
									if v53 != 0 {
										...
										if v52 == int32(0) {
											...
											v57 = int32(-1)
											v58 = int32(0)
											v64 = F_DirectFunctionCall1Coll(m, int32(1467), v58, v15)
											mBase = m.M
											v65 = m.ExcPending
											if v65 != 0 {
												return int32(0)
											} else {
												v67 = F_DirectFunctionCall2Coll(m, int32(1466), v58, v64, int32(-1))
												mBase = m.M
												v68 = m.ExcPending
												if v68 != 0 {
													return int32(0)
			...
			if l1 == int32(0) {
				...
				if v44 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v52
					v60 = F_pg_snprintf(m, v47+(v9+int32(16)), int32(50)-v47, int32(_a_F_network_out_0), v9)
					mBase = m.M
					v61 = m.ExcPending
					if v61 != 0 {
						return int32(0)
