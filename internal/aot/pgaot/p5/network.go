		...
		if v14 != 0 {
			...
			if v24 != 0 {
				...
				if v21 == int32(0) {
					...
					v28 = int32(-1)
					v29 = int32(0)
					v33 = F_DirectFunctionCall1Coll(m, int32(1446), v29, v15)
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return int32(0)
								...
								if v48 != 0 {
									...
									if v53 != 0 {
										...
										if v52 == int32(0) {
											...
											v57 = int32(-1)
											v58 = int32(0)
											v64 = F_DirectFunctionCall1Coll(m, int32(1448), v58, v15)
											mBase = m.M
											v65 = m.ExcPending
											if v65 != 0 {
												return int32(0)
											} else {
												v67 = F_DirectFunctionCall2Coll(m, int32(1447), v58, v64, int32(-1))
												mBase = m.M
												v68 = m.ExcPending
												if v68 != 0 {
													return int32(0)
...
func F_network_abbrev_convert(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v12 != 0 {
		...
		if v24 == int32(0) {
			...
			v27 = *(*int32)(unsafe.Add(mBase, uint32(v19)+2))
			v28 = int32(16711935)
			v36 = base.I32_rotr(v27&v28, int32(8)) | base.I32_rotr(v27, int32(24))&v28
			if base.Ui32(int32(31)) < base.Ui32(v24) {
				v45 = v36
			} else {
				v45 = int32(-1) << (uint(int32(0)-v24) % 32) & v36
			}
		}
		v46 = *(*int64)(unsafe.Add(mBase, uint32(v6)))
		*(*int64)(unsafe.Add(mBase, uint32(v6))) = v46 + int64(1)
		v50 = int32(1)
		v52 = int32(base.Ui32(v45)>>(uint(v50)%32)) | v23
		v53 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v6)+8)))
		if v53 == v50 {
			v56 = int32(16)
			v57 = v6 + v56
			v62 = int32(711645284)
			v65 = v52 - int32(1636608428) ^ v62 - int32(1455628627)
			v70 = v65 ^ int32(-1636608428) - base.I32_rotl(v65, int32(25))
			v75 = v70 ^ v62 - base.I32_rotl(v70, v56)
			v79 = v75 ^ v65 - base.I32_rotl(v75, int32(4))
			v83 = v79 ^ v70 - base.I32_rotl(v79, int32(14))
			v87 = v83 ^ v75 - base.I32_rotl(v83, int32(24))
			v90 = *(*int32)(unsafe.Add(mBase, uint32(v57)+16))
			v92 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v57))))
			v93 = int32(32) - v92
			v95 = v90 + int32(base.Ui32(v87)>>(uint(v93)%32))
			v96 = v87 << (uint(v92) % 32)
			if v96 != 0 {
				v103 = int32(32) - (base.I32_clz(v96) ^ int32(31))
				v104 = int32(255)
				if base.Ui32(v93&v104) < base.Ui32(v103&v104) {
					v109 = v93 + int32(1)
				} else {
					v109 = v103
				}
			...
			v115 = v113 & int32(255)
			v116 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v95))))
			if base.Ui32(v116) < base.Ui32(v115) {
				v118 = v115
			} else {
				v118 = v116
			}
			*(*uint8)(unsafe.Add(mBase, uint32(v95))) = uint8(v118)
		} else {
		}
		return v52
	}
...
func F_network_out(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v28 = v9 + int32(16)
	v29 = F_pg_inet_net_ntop(m, v18, v23+int32(2), v26, v28)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		return int32(0)
			...
			if l1 == int32(0) {
				...
				if v42 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v48
					v54 = F_pg_snprintf(m, v43+v28, int32(50)-v43, int32(_a_F_network_out_0), v9)
					mBase = m.M
					v55 = m.ExcPending
					if v55 != 0 {
						return int32(0)
			...
			if v68 != 0 {
				...
				if v71 != 0 {
					...
					if v75 != 0 {
						...
						F_errfinish(m, int32(_a_F_network_out_2), int32(152), int32(_a_F_network_out_3))
						mBase = m.M
						v80 = m.ExcPending
						if v80 != 0 {
							return int32(0)
...
L62:
	;
	F_errdetail(m, int32(_a_F_network_recv_1), int32(0))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L1
...
L63:
	;
	F_errfinish(m, int32(_a_F_network_recv_2), int32(241), int32(_a_F_network_recv_3))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L1
...
L67:
	;
	v182 = int32(_a_F_network_recv_4)
	goto L69
L68:
	;
	v182 = int32(_a_F_network_recv_5)
	goto L69
L69:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v182
	F_errmsg(m, int32(_a_F_network_recv_6), v13+int32(32))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
...
L70:
	;
	F_errfinish(m, int32(_a_F_network_recv_2), int32(210), int32(_a_F_network_recv_3))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L1
...
L74:
	;
	v204 = int32(_a_F_network_recv_4)
	goto L76
L75:
	;
	v204 = int32(_a_F_network_recv_5)
	goto L76
L76:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v204
	F_errmsg(m, int32(_a_F_network_recv_7), v13)
	mBase = m.M
	v208 = m.ExcPending
	if v208 != 0 {
		goto L1
...
L77:
	;
	F_errfinish(m, int32(_a_F_network_recv_2), int32(217), int32(_a_F_network_recv_3))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L1
...
L81:
	;
	v223 = int32(_a_F_network_recv_4)
	goto L83
L82:
	;
	v223 = int32(_a_F_network_recv_5)
	goto L83
L83:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v223
	F_errmsg(m, int32(_a_F_network_recv_8), v13+int32(16))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L84:
	;
	F_errfinish(m, int32(_a_F_network_recv_2), int32(226), int32(_a_F_network_recv_3))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
...
L11:
	;
	v30 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v19)+1)))
