			...
			if v74 != 0 {
				...
				if v77 != 0 {
					...
					if v81 != 0 {
						...
						F_errfinish(m, int32(494432), int32(152), int32(66888))
						mBase = m.M
						v86 = m.ExcPending
						if v86 != 0 {
							return int32(0)
...
L63:
	;
	F_errfinish(m, int32(494432), int32(241), int32(36378))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L1
...
L70:
	;
	F_errfinish(m, int32(494432), int32(210), int32(36378))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L1
...
L77:
	;
	F_errfinish(m, int32(494432), int32(217), int32(36378))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L1
...
L84:
	;
	F_errfinish(m, int32(494432), int32(226), int32(36378))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
