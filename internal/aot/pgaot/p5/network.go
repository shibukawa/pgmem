...
func F_network_abbrev_convert(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v9 != 0 {
		...
		if v23 == v22 {
			...
			v27 = int32(24)
			v29 = int32(_a_F_network_abbrev_convert_0)
			v31 = int32(8)
...
L22:
	;
	v54 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v46))))
	if v54 == int32(0) {
		goto L23
	} else {
		goto L24
...
L38:
	;
	v108 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v107)+1)))
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v108
	v116 = F_pg_snprintf(m, v103+(v9+int32(16)), int32(50)-v103, int32(_a_F_network_out_0), v9)
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L7
