...
L10:
	...
	v59 = *(*int32)(unsafe.Add(mBase, _consts[412]))
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, _consts[412])) = v87
	v89 = int32(4470752)
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+24)) = v75
	*(*int32)(unsafe.Add(mBase, uint32(v20)+28)) = v69
	F_errmsg_internal(m, int32(20410), int32(0))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		v405 = v76
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+24)) = v75
	*(*int32)(unsafe.Add(mBase, uint32(v20)+28)) = v69
	F_errfinish(m, int32(484839), int32(1434), int32(319620))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		v405 = v76
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _consts[412])) = v73
	m.G0 = v20 + int32(32)
	return v353
L32:
	;
...
L34:
	;
	v331 = int32(1)
	v335 = *(*int32)(unsafe.Add(mBase, _consts[921]))
...
L51:
	;
	v169 = *(*int32)(unsafe.Add(mBase, _consts[921]))
...
L53:
	;
	v181 = *(*int32)(unsafe.Add(mBase, _consts[921]))
...
L57:
	;
	v192 = *(*int32)(unsafe.Add(mBase, _consts[921]))
...
L60:
	;
	v205 = *(*int32)(unsafe.Add(mBase, _consts[921]))
...
L64:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _consts[921]))
...
L83:
	;
	v246 = int32(1)
	v250 = *(*int32)(unsafe.Add(mBase, _consts[921]))
...
L89:
	;
	v265 = *(*int32)(unsafe.Add(mBase, _consts[921]))
...
L94:
	;
	F_errmsg_internal(m, int32(251280), int32(0))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		v405 = v76
...
L95:
	;
	F_errfinish(m, int32(484839), int32(1605), int32(319618))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		v405 = v76
