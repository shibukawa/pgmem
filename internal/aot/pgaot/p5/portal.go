...
L10:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _consts[142]))
	v57 = *(*int32)(unsafe.Add(mBase, _consts[143]))
	v59 = *(*int32)(unsafe.Add(mBase, _consts[410]))
	v61 = *(*int32)(unsafe.Add(mBase, _consts[11]))
	v63 = *(*int32)(unsafe.Add(mBase, _consts[257]))
	goto L11
L11:
	;
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _consts[257])) = l0
	*(*int32)(unsafe.Add(mBase, _consts[143])) = v69
...
L17:
	;
	*(*int32)(unsafe.Add(mBase, _consts[142])) = v72
	*(*int32)(unsafe.Add(mBase, _consts[143])) = v71
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, _consts[410])) = v87
	v89 = int32(4548768)
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+24)) = v75
	*(*int32)(unsafe.Add(mBase, uint32(v20)+28)) = v69
	F_errmsg_internal(m, int32(20714), int32(0))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		v405 = v76
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+24)) = v75
	*(*int32)(unsafe.Add(mBase, uint32(v20)+28)) = v69
	F_errfinish(m, int32(511152), int32(1434), int32(337462))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		v405 = v76
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _consts[257])) = v75
	*(*int32)(unsafe.Add(mBase, _consts[410])) = v73
	m.G0 = v20 + int32(32)
	return v353
L32:
	;
...
L34:
	;
	v331 = int32(1)
	v335 = *(*int32)(unsafe.Add(mBase, _consts[919]))
...
L51:
	;
	v169 = *(*int32)(unsafe.Add(mBase, _consts[919]))
...
L53:
	;
	v181 = *(*int32)(unsafe.Add(mBase, _consts[919]))
...
L57:
	;
	v192 = *(*int32)(unsafe.Add(mBase, _consts[919]))
...
L60:
	;
	v205 = *(*int32)(unsafe.Add(mBase, _consts[919]))
...
L64:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _consts[919]))
...
L83:
	;
	v246 = int32(1)
	v250 = *(*int32)(unsafe.Add(mBase, _consts[919]))
...
L89:
	;
	v265 = *(*int32)(unsafe.Add(mBase, _consts[919]))
...
L94:
	;
	F_errmsg_internal(m, int32(265303), int32(0))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		v405 = v76
...
L95:
	;
	F_errfinish(m, int32(511152), int32(1605), int32(337460))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		v405 = v76
