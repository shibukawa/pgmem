...
func F_euc_cn_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4389508), v18, v18, v18, int32(2), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
func F_euc_kr_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4389828), v18, v18, v18, int32(3), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
