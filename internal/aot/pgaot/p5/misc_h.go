...
func F_HoldPortal(m *base.Module, l0 int32) {
	...
	v10 = F_AllocSetContextCreateInternal(m, v5, int32(61924), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return
		...
		if v14 != 0 {
							...
							if v883 != 0 {
								...
								if base.Ui32(v876) < base.Ui32(v882) {
									...
									if v1184 != 0 {
										...
										F_errmsg_internal(m, int32(96818), int32(0))
										mBase = m.M
										v1188 = m.ExcPending
										if v1188 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(492276), int32(306), int32(62061))
											mBase = m.M
											v1193 = m.ExcPending
											if v1193 != 0 {
												return int32(0)
			...
			if v1164 != 0 {
				...
				if v1167 != 0 {
					...
					F_errmsg(m, int32(330547), int32(0))
					mBase = m.M
					v1171 = m.ExcPending
					if v1171 != 0 {
						return int32(0)
						...
						if v1175 != 0 {
							...
							F_errfinish(m, int32(492276), int32(281), int32(62061))
							mBase = m.M
							v1180 = m.ExcPending
							if v1180 != 0 {
								return int32(0)
...
L15:
	;
	F_errmsg_internal(m, int32(248377), int32(0))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L12
...
L16:
	;
	F_errfinish(m, int32(486498), int32(1159), int32(159298))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L12
...
L19:
	;
	F_errfinish(m, int32(486498), int32(1151), int32(159298))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L12
...
L42:
	;
	F_errmsg_internal(m, int32(248322), int32(0))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L7
...
L43:
	;
	F_errfinish(m, int32(486498), int32(1194), int32(242262))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L7
