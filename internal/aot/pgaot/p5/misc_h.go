...
func F_HoldPortal(m *base.Module, l0 int32) {
	...
	var v38 int32
	_ = v38
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1232]))
	v10 = F_AllocSetContextCreateInternal(m, v5, int32(67706), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return
...
func F_has_largeobject_privilege_id(m *base.Module, l0 int32) int32 {
	...
	var v38 int32
	_ = v38
	v7 = *(*int32)(unsafe.Add(mBase, _consts[237]))
	...
	if v13 != 0 {
		...
		v15 = F_convert_any_priv_string(m, v10, int32(1686176))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
			...
			if v15&int64(4) == int64(0) {
				v22 = *(*int32)(unsafe.Add(mBase, _consts[291]))
			...
			if v26 != 0 {
				...
				if v25 != 0 {
					v29 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1031])))
					if v29 != 0 {
						v38 = int32(1)
						return v38
					} else {
		...
		if v14 != 0 {
							...
							if v883 != 0 {
								...
								if base.Ui32(v876) < base.Ui32(v882) {
									...
									if v1184 != 0 {
										...
										F_errmsg_internal(m, int32(103985), int32(0))
										mBase = m.M
										v1188 = m.ExcPending
										if v1188 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(520374), int32(306), int32(67843))
											mBase = m.M
											v1193 = m.ExcPending
											if v1193 != 0 {
												return int32(0)
			...
			if v1164 != 0 {
				...
				if v1167 != 0 {
					...
					F_errmsg(m, int32(349479), int32(0))
					mBase = m.M
					v1171 = m.ExcPending
					if v1171 != 0 {
						return int32(0)
						...
						if v1175 != 0 {
							...
							F_errfinish(m, int32(520374), int32(281), int32(67843))
							mBase = m.M
							v1180 = m.ExcPending
							if v1180 != 0 {
								return int32(0)
...
func F_have_createdb_privilege(m *base.Module) int32 {
	...
	if v7 != 0 {
		...
		if v4 == int32(0) {
			v12 = *(*int32)(unsafe.Add(mBase, _consts[237]))
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+72)) = v53
	...
	v62 = F_AllocSetContextCreateInternal(m, v57, int32(64756), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L4
...
L305:
	;
	F_errmsg_internal(m, int32(468028), int32(0))
	mBase = m.M
	v1807 = m.ExcPending
	if v1807 != 0 {
		goto L4
...
L306:
	;
	F_errfinish(m, int32(516945), int32(578), int32(468052))
	mBase = m.M
	v1812 = m.ExcPending
	if v1812 != 0 {
		goto L4
				...
				if v52 != 0 {
					...
					if v55 != 0 {
						...
						if base.F64_gt(v58, float64(0)) != 0 {
							v61 = F_log(m, v58)
							mBase = m.M
							v63 = *(*int32)(unsafe.Add(mBase, _consts[1489]))
...
L15:
	;
	F_errmsg_internal(m, int32(262400), int32(0))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L12
...
L16:
	;
	F_errfinish(m, int32(513574), int32(1159), int32(170129))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L12
...
L19:
	;
	F_errfinish(m, int32(513574), int32(1151), int32(170129))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L12
...
L42:
	;
	F_errmsg_internal(m, int32(262345), int32(0))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L7
...
L43:
	;
	F_errfinish(m, int32(513574), int32(1194), int32(256087))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L7
