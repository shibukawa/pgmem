...
func F_HoldPortal(m *base.Module, l0 int32) {
	...
	var v38 int32
	_ = v38
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1238]))
	v10 = F_AllocSetContextCreateInternal(m, v5, int32(59862), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return
...
func F_has_largeobject_privilege_id(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		v15 = F_convert_any_priv_string(m, v10, int32(1616544))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
			...
			if v15&int64(4) == int64(0) {
				v22 = *(*int32)(unsafe.Add(mBase, _consts[294]))
			...
			if v26 != 0 {
				...
				if v25 != 0 {
					v29 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1035])))
					if v29 != 0 {
						v38 = int32(1)
						return v38
					} else {
		...
		if v14 != 0 {
							...
							if v883 != 0 {
								...
								if base.Ui32(v876) < base.Ui32(v882) {
									...
									if v1184 != 0 {
										...
										F_errmsg_internal(m, int32(92100), int32(0))
										mBase = m.M
										v1188 = m.ExcPending
										if v1188 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(476587), int32(306), int32(59978))
											mBase = m.M
											v1193 = m.ExcPending
											if v1193 != 0 {
												return int32(0)
			...
			if v1164 != 0 {
				...
				if v1167 != 0 {
					...
					F_errmsg(m, int32(318990), int32(0))
					mBase = m.M
					v1171 = m.ExcPending
					if v1171 != 0 {
						return int32(0)
						...
						if v1175 != 0 {
							...
							F_errfinish(m, int32(476587), int32(281), int32(59978))
							mBase = m.M
							v1180 = m.ExcPending
							if v1180 != 0 {
								return int32(0)
...
L15:
	;
	F_errmsg_internal(m, int32(239368), int32(0))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L12
...
L16:
	;
	F_errfinish(m, int32(470972), int32(1159), int32(151819))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L12
...
L19:
	;
	F_errfinish(m, int32(470972), int32(1151), int32(151819))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L12
...
L43:
	;
	F_errfinish(m, int32(470972), int32(1194), int32(233253))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L7
