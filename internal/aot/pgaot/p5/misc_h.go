		...
		if v14 != 0 {
								...
								if base.Ui32(v876) < base.Ui32(v882) {
									...
									if v1184 != 0 {
										...
										if v1188 != 0 {
											...
											F_errfinish(m, int32(523856), int32(306), int32(68421))
											mBase = m.M
											v1193 = m.ExcPending
											if v1193 != 0 {
												return int32(0)
			...
			if v1164 != 0 {
				...
				if v1167 != 0 {
					...
					F_errmsg(m, int32(351859), int32(0))
					mBase = m.M
					v1171 = m.ExcPending
					if v1171 != 0 {
						return int32(0)
						...
						if v1175 != 0 {
							...
							F_errfinish(m, int32(523856), int32(281), int32(68421))
							mBase = m.M
							v1180 = m.ExcPending
							if v1180 != 0 {
								return int32(0)
...
L305:
	;
	F_errmsg_internal(m, int32(471310), int32(0))
	mBase = m.M
	v1807 = m.ExcPending
	if v1807 != 0 {
		goto L4
...
L306:
	;
	F_errfinish(m, int32(520417), int32(578), int32(471334))
	mBase = m.M
	v1812 = m.ExcPending
	if v1812 != 0 {
		goto L4
				...
				if v52 != 0 {
					...
					if v55 != 0 {
						...
						if base.F64_gt(v58, float64(0)) != 0 {
							v61 = F_log(m, v58)
							mBase = m.M
							v63 = *(*int32)(unsafe.Add(mBase, _consts[1481]))
...
L15:
	;
	F_errmsg_internal(m, int32(264260), int32(0))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L12
...
L16:
	;
	F_errfinish(m, int32(516934), int32(1159), int32(171376))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L12
...
L19:
	;
	F_errfinish(m, int32(516934), int32(1151), int32(171376))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L12
...
L42:
	;
	F_errmsg_internal(m, int32(264205), int32(0))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L7
...
L43:
	;
	F_errfinish(m, int32(516934), int32(1194), int32(257947))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L7
