								...
								if base.Ui32(v876) < base.Ui32(v882) {
									...
									if v1184 != 0 {
										...
										if v1188 != 0 {
											...
											F_errfinish(m, int32(496821), int32(306), int32(62426))
											mBase = m.M
											v1193 = m.ExcPending
											if v1193 != 0 {
												return int32(0)
				...
				if v1167 != 0 {
					...
					if v1171 != 0 {
						...
						if v1175 != 0 {
							...
							F_errfinish(m, int32(496821), int32(281), int32(62426))
							mBase = m.M
							v1180 = m.ExcPending
							if v1180 != 0 {
								return int32(0)
...
L16:
	;
	F_errfinish(m, int32(490966), int32(1159), int32(160922))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L12
...
L19:
	;
	F_errfinish(m, int32(490966), int32(1151), int32(160922))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L12
...
L43:
	;
	F_errfinish(m, int32(490966), int32(1194), int32(244458))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L7
