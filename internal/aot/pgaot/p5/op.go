			...
			if l2 != 0 {
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
					F_errmsg_internal(m, int32(42499), v10)
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
					} else {
						F_errfinish(m, int32(518869), int32(4190), int32(260231))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return
				...
				if v35 == int32(0) {
					...
					if v77 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v78
						F_errmsg_internal(m, int32(58256), v10+int32(16))
						mBase = m.M
						v84 = m.ExcPending
						if v84 != 0 {
							return
						} else {
							F_errfinish(m, int32(518869), int32(4198), int32(260231))
							mBase = m.M
							v89 = m.ExcPending
							if v89 != 0 {
								return
						...
						if v43 != 0 {
							...
							if v53 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v52
								F_appendStringInfo(m, l0, int32(207329), v10+int32(32))
								mBase = m.M
								v62 = m.ExcPending
								if v62 != 0 {
									return
			...
			if l3 != 0 {
				...
				if v23 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v13))) = l1
					F_errmsg_internal(m, int32(42499), v13)
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
					} else {
						F_errfinish(m, int32(518869), int32(6066), int32(10846))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return
				...
				if v38 == int32(0) {
					...
					if v101 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v102
						F_errmsg_internal(m, int32(58256), v11+int32(-48))
						mBase = m.M
						v108 = m.ExcPending
						if v108 != 0 {
							return
						} else {
							F_errfinish(m, int32(518869), int32(6074), int32(10846))
							mBase = m.M
							v113 = m.ExcPending
							if v113 != 0 {
								return
					...
					if v46 != 0 {
						...
						if v50 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v49
							F_appendStringInfo(m, l0, int32(209345), v11+int32(-32))
							mBase = m.M
							v60 = m.ExcPending
							if v60 != 0 {
								return
