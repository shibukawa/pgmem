			...
			if v19 != 0 {
				...
				if v18 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v23 + int32(4)
					F_errmsg(m, int32(_a_F_vac_cleanup_one_index_0), v6+int32(-32))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return int32(0)
...
L165:
	...
	if base.Ui32(v1811-int32(_a_F_vfscanf_0)) <= base.Ui32(int32(2045)) {
		goto L423
	} else {
		goto L424
	}
L166:
	...
	if base.Ui32(v1662-int32(_a_F_vfscanf_1)) <= base.Ui32(int32(253)) {
		goto L378
	} else {
		goto L379
	}
...
L238:
	;
	v1513 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1489)+uint32(_c_F_vfscanf[1]))))
...
L252:
	;
	v975 = int32(16)
	v978 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v974)+uint32(_c_F_vfscanf[1]))))
...
L268:
	;
	v1012 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v942)+uint32(_c_F_vfscanf[1]))))
...
L303:
	;
	v1191 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1185)+uint32(_c_F_vfscanf[1]))))
...
L305:
	;
	v1361 = int32(*(*int8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v1184*int32(23))>>(uint(int32(5))%32))&int32(7))+uint32(_c_F_vfscanf[2]))))
	v1364 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1185)+uint32(_c_F_vfscanf[1]))))
...
L311:
	...
	v1234 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1227)+uint32(_c_F_vfscanf[1]))))
...
L321:
	;
	v1307 = v1290 + v1293
	v1310 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1306)+uint32(_c_F_vfscanf[1]))))
...
L334:
	...
	v1402 = v1370 | v1401
	v1407 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1400)+uint32(_c_F_vfscanf[1]))))
...
L344:
	...
	v1483 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1478)+uint32(_c_F_vfscanf[1]))))
...
L354:
	;
	v1552 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1549)+uint32(_c_F_vfscanf[1]))))
...
L381:
	;
	v1694 = base.B2i32(base.Ui32(int32(_a_F_vfscanf_2)) < base.Ui32(v1691))
	if base.Ui32(int32(_a_F_vfscanf_2)) < base.Ui32(v1691) {
		goto L389
	} else {
		goto L390
	}
...
L395:
	;
	if base.Ui32(int32(_a_F_vfscanf_3)) < base.Ui32(v1662) {
		goto L398
	} else {
		goto L399
	}
...
L397:
	;
	v1775 = base.I32_wrap_i64(int64(base.Ui64(v1657)>>(uint(int64(25))%64))) | int32(_a_F_vfscanf_4)
	v1776 = int32(255)
	goto L377
L398:
	;
...
L401:
	;
	v1718 = int32(_a_F_vfscanf_5)
	goto L403
L402:
	;
	v1718 = int32(_a_F_vfscanf_1)
	goto L403
L403:
	;
	v1719 = v1718 - v1662
...
L410:
	;
	v1772 = base.B2i32(base.Ui32(int32(_a_F_vfscanf_2)) < base.Ui32(v1768))
	if base.Ui32(int32(_a_F_vfscanf_2)) < base.Ui32(v1768) {
		goto L418
	} else {
		goto L419
	}
...
L418:
	;
	v1773 = v1768 ^ int32(_a_F_vfscanf_6)
	goto L420
L419:
	;
	v1773 = v1768
...
L433:
	;
	v1912 = v1839
	v1919 = base.I64_extend_i32_u(v1838) + base.I64_extend_i32_u(v1811-int32(_a_F_vfscanf_7))
	goto L422
L434:
	;
	if base.Ui32(int32(_a_F_vfscanf_8)) < base.Ui32(v1811) {
		goto L437
	} else {
		goto L438
	}
...
L440:
	;
	v1863 = int32(_a_F_vfscanf_7)
	goto L442
L441:
	;
	v1863 = int32(_a_F_vfscanf_0)
	goto L442
L442:
	;
	v1864 = v1863 - v1811
...
L497:
	;
	v2061 = *(*int32)(unsafe.Add(mBase, _c_F_vfscanf[3]))
...
L504:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v2041))) = v2054 & int32(_a_F_vfscanf_10)
	v2257 = int32(1)
	goto L480
L505:
	;
	v2080 = *(*int32)(unsafe.Add(mBase, uint32(v2073<<(uint(int32(2))%32))+uint32(_c_F_vfscanf[4])))
	v2209 = v2080
	goto L484
L507:
	;
