...
L32:
	;
	F_errfinish(m, int32(496744), int32(640), int32(230407))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L1
...
func F_vfprintf(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F___vfprintf_internal(m, l0, l1, l2, int32(7183), int32(7184))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_view_reloptions(m *base.Module, l0 int32) {
	...
	var v8 int32
	_ = v8
	v7 = F_build_reloptions(m, l0, int32(1), int32(512), int32(12), int32(759264), int32(3))
	v8 = m.ExcPending
	if v8 != 0 {
		return
	} else {
