			...
			if v19 != 0 {
				...
				if v18 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v23 + int32(4)
					F_errmsg(m, int32(169088), v6+int32(-32))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return int32(0)
						...
						*(*float64)(unsafe.Add(mBase, uint32(v8))) = v36
						F_errdetail(m, int32(618802), v8)
						mBase = m.M
						v44 = m.ExcPending
						if v44 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(491607), int32(2687), int32(28069))
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return int32(0)
...
L32:
	;
	F_errfinish(m, int32(490154), int32(640), int32(227645))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L1
...
func F_vfprintf(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F___vfprintf_internal(m, l0, l1, l2, int32(6804), int32(6805))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_view_reloptions(m *base.Module, l0 int32) {
	...
	var v8 int32
	_ = v8
	v7 = F_build_reloptions(m, l0, int32(1), int32(512), int32(12), int32(736016), int32(3))
	v8 = m.ExcPending
	if v8 != 0 {
		return
	} else {
