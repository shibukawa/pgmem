			...
			if v19 != 0 {
				...
				if v18 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v23 + int32(4)
					F_errmsg(m, int32(170542), v6+int32(-32))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return int32(0)
						...
						*(*float64)(unsafe.Add(mBase, uint32(v8))) = v36
						F_errdetail(m, int32(639915), v8)
						mBase = m.M
						v44 = m.ExcPending
						if v44 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(496767), int32(2687), int32(28226))
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return int32(0)
...
L32:
	;
	F_errfinish(m, int32(495308), int32(640), int32(229738))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L1
...
func F_vfprintf(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F___vfprintf_internal(m, l0, l1, l2, int32(7113), int32(7114))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
L238:
	;
	v1513 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1489)+uint32(_consts[1478]))))
...
L252:
	;
	v975 = int32(16)
	v978 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v974)+uint32(_consts[1478]))))
...
L268:
	;
	v1012 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v942)+uint32(_consts[1478]))))
...
L303:
	;
	v1191 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1185)+uint32(_consts[1478]))))
...
L305:
	;
	v1361 = int32(*(*int8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v1184*int32(23))>>(uint(int32(5))%32))&int32(7))+uint32(_consts[1479]))))
	v1364 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1185)+uint32(_consts[1478]))))
...
L311:
	...
	v1234 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1227)+uint32(_consts[1478]))))
...
L321:
	;
	v1307 = v1290 + v1293
	v1310 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1306)+uint32(_consts[1478]))))
...
L334:
	...
	v1402 = v1370 | v1401
	v1407 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1400)+uint32(_consts[1478]))))
...
L344:
	...
	v1483 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1478)+uint32(_consts[1478]))))
...
L354:
	;
	v1552 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1549)+uint32(_consts[1478]))))
...
L505:
	;
	v2080 = *(*int32)(unsafe.Add(mBase, uint32(v2073<<(uint(int32(2))%32))+uint32(_consts[1480])))
	v2209 = v2080
	goto L484
L507:
	;
...
func F_view_reloptions(m *base.Module, l0 int32) {
	...
	var v8 int32
	_ = v8
	v7 = F_build_reloptions(m, l0, int32(1), int32(512), int32(12), int32(757360), int32(3))
	v8 = m.ExcPending
	if v8 != 0 {
		return
	} else {
