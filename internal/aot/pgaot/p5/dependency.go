...
func F_recordDependencyOnCurrentExtension(m *base.Module, l0 int32, l1 int32) {
	...
	v6 = v4 - int32(48)
	m.G0 = v6
	v9 = int32(*(*uint8)(unsafe.Add(mBase, _consts[254])))
	if v9 != int32(1) {
		m.G0 = v6 + int32(48)
		return
	} else {
		if l1 != 0 {
								...
								if v28 != 0 {
									...
									if v30 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v27
										F_errmsg(m, int32(746498), v6+int32(16))
										mBase = m.M
										v37 = m.ExcPending
										if v37 != 0 {
											return
										} else {
											F_errfinish(m, int32(525976), int32(227), int32(285531))
											mBase = m.M
											v42 = m.ExcPending
											if v42 != 0 {
												return
					...
					if v46 != 0 {
						...
						if v49 != 0 {
							...
							if v52 != 0 {
								...
								v54 = *(*int32)(unsafe.Add(mBase, _consts[220]))
								...
								if v56 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6))) = v51
									F_errmsg(m, int32(746539), v6)
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return
									} else {
										F_errdetail(m, int32(643335), int32(0))
										mBase = m.M
										v65 = m.ExcPending
										if v65 != 0 {
											return
										} else {
											F_errfinish(m, int32(525976), int32(235), int32(285531))
											mBase = m.M
											v70 = m.ExcPending
											if v70 != 0 {
												return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+44)) = int32(0)
			v76 = *(*int32)(unsafe.Add(mBase, _consts[220]))
