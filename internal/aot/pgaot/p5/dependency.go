								...
								if v28 != 0 {
									...
									if v30 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v27
										F_errmsg(m, int32(659217), v6+int32(16))
										mBase = m.M
										v37 = m.ExcPending
										if v37 != 0 {
											return
										} else {
											F_errfinish(m, int32(468960), int32(227), int32(255941))
											mBase = m.M
											v42 = m.ExcPending
											if v42 != 0 {
												return
							...
							if v52 != 0 {
								...
								if v56 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6))) = v51
									F_errmsg(m, int32(659258), v6)
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return
									} else {
										F_errdetail(m, int32(563663), int32(0))
										mBase = m.M
										v65 = m.ExcPending
										if v65 != 0 {
											return
										} else {
											F_errfinish(m, int32(468960), int32(235), int32(255941))
											mBase = m.M
											v70 = m.ExcPending
											if v70 != 0 {
												return
