...
L4:
	;
	v156 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v154)+20)))
	if v156 != int32(1) {
		v204 = v4
		goto L1
	} else {
...
L16:
	;
	v42 = *(*int32)(unsafe.Add(mBase, uint32(v16+int32(8)+v33<<(uint(int32(2))%32))))
	if v42 != 0 {
		goto L19
	} else {
		goto L20
...
L22:
	;
	v44 = int32(1)
	if base.Ui32(v44) < base.Ui32(base.I32_popcnt(v42)) {
		v54 = v43
		goto L18
	} else {
		goto L23
...
L29:
	;
	v106 = *(*int32)(unsafe.Add(mBase, uint32(v70)+4))
	switch v106 - int32(1) {
	case 0:
		goto L43
	case 1:
...
L30:
	;
	v74 = *(*int32)(unsafe.Add(mBase, uint32(v70)+28))
	if v74 == int32(0) {
		v204 = v4
		goto L1
	} else {
...
L32:
	;
	v80 = *(*int32)(unsafe.Add(mBase, uint32(v74)+12))
	v81 = *(*int32)(unsafe.Add(mBase, uint32(v80)+4))
	v82 = F_is_pseudo_constant_clause(m, v81)
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L33
...
L34:
	;
	v86 = *(*int32)(unsafe.Add(mBase, uint32(v70)+28))
...
L35:
	...
	v91 = F_is_pseudo_constant_clause(m, v90)
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L33
...
L39:
	;
	v95 = *(*int32)(unsafe.Add(mBase, uint32(v70)+28))
...
L42:
	;
	v151 = *(*int32)(unsafe.Add(mBase, uint32(v70)+8))
...
L43:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(l2))) = uint16(v109)
	v112 = int32(1)
	v113 = *(*int32)(unsafe.Add(mBase, uint32(v70)+8))
	if v113 == v109 {
		v204 = v112
		goto L1
	} else {
...
L46:
	...
	v133 = F_dependency_is_compatible_clause(m, v130, l1, v10+int32(14))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L33
...
L50:
	;
	v137 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v10)+14)))
	v138 = int32(*(*uint16)(unsafe.Add(mBase, uint32(l2))))
	if v138 == int32(0) {
		goto L52
	} else {
		goto L53
...
L51:
	...
	v143 = int32(1)
	v145 = v122 + v143
	v146 = *(*int32)(unsafe.Add(mBase, uint32(v113)+4))
	if v145 < v146 {
		v122 = v145
		goto L46
	} else {
...
L52:
	;
	*(*uint16)(unsafe.Add(mBase, uint32(l2))) = uint16(v137)
	goto L51
L53:
	;
	goto L54
...
L57:
	;
	v159 = *(*int32)(unsafe.Add(mBase, uint32(v154)+28))
	if v159 == int32(0) {
		v204 = v4
		goto L1
	} else {
...
L59:
	;
	v165 = *(*int32)(unsafe.Add(mBase, uint32(v159)+12))
	v166 = *(*int32)(unsafe.Add(mBase, uint32(v165)+4))
	v167 = F_is_pseudo_constant_clause(m, v166)
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L33
...
L68:
	;
	v194 = *(*int32)(unsafe.Add(mBase, uint32(v188)+28))
	if v194 != 0 {
		v204 = v4
		goto L1
	} else {
...
L69:
	;
	v195 = int32(*(*int16)(unsafe.Add(mBase, uint32(v188)+8)))
	if v195 <= int32(0) {
		v204 = v4
		goto L1
	} else {
...
L70:
	;
	*(*uint16)(unsafe.Add(mBase, uint32(l2))) = uint16(v195)
	v204 = int32(1)
	goto L1
}
...
func F_recordDependencyOnCurrentExtension(m *base.Module, l0 int32, l1 int32) {
	...
	v6 = v4 - int32(48)
	m.G0 = v6
	v9 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_recordDependencyOnCurrentExtension[0])))
	if v9 != int32(1) {
		m.G0 = v6 + int32(48)
		return
	} else {
		if l1 != 0 {
			...
			if v15 != 0 {
				...
				if v14 != 0 {
					v17 = *(*int32)(unsafe.Add(mBase, _c_F_recordDependencyOnCurrentExtension[1]))
					if v14 == v17 {
						m.G0 = v6 + int32(48)
						return
					} else {
								...
								if v28 != 0 {
									...
									if v30 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v27
										F_errmsg(m, int32(_a_F_recordDependencyOnCurrentExtension_0), v6+int32(16))
										mBase = m.M
										v37 = m.ExcPending
										if v37 != 0 {
											return
					...
					if v46 != 0 {
						...
						if v49 != 0 {
							...
							if v52 != 0 {
								...
								v54 = *(*int32)(unsafe.Add(mBase, _c_F_recordDependencyOnCurrentExtension[1]))
								...
								if v56 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6))) = v51
									F_errmsg(m, int32(_a_F_recordDependencyOnCurrentExtension_3), v6)
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+44)) = int32(0)
			v76 = *(*int32)(unsafe.Add(mBase, _c_F_recordDependencyOnCurrentExtension[1]))
