...
func F_TransferPredicateLocksToHeapRelation(m *base.Module, l0 int32) {
	...
	v19 = v17 - int32(48)
	m.G0 = v19
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[0]))
...
L2:
	...
	if base.Ui32(v26) < base.Ui32(int32(_a_F_TransferPredicateLocksToHeapRelation_0)) {
		goto L1
	} else {
		goto L3
	}
...
L7:
	...
	v38 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
...
L9:
	;
	v45 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v49 = F_LWLockAcquire(m, v45+int32(_a_F_TransferPredicateLocksToHeapRelation_1), int32(0))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L8
...
L10:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v56 = F_LWLockAcquire(m, v52+int32(_a_F_TransferPredicateLocksToHeapRelation_2), int32(0))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L8
...
L11:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v63 = F_LWLockAcquire(m, v59+int32(_a_F_TransferPredicateLocksToHeapRelation_3), int32(0))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L8
...
L12:
	;
	v66 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v70 = F_LWLockAcquire(m, v66+int32(_a_F_TransferPredicateLocksToHeapRelation_4), int32(0))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L8
...
L13:
	;
	v73 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v77 = F_LWLockAcquire(m, v73+int32(_a_F_TransferPredicateLocksToHeapRelation_5), int32(0))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L8
...
L14:
	;
	v80 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v84 = F_LWLockAcquire(m, v80+int32(_a_F_TransferPredicateLocksToHeapRelation_6), int32(0))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L8
...
L15:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v91 = F_LWLockAcquire(m, v87+int32(_a_F_TransferPredicateLocksToHeapRelation_7), int32(0))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L8
...
L16:
	;
	v94 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v98 = F_LWLockAcquire(m, v94+int32(_a_F_TransferPredicateLocksToHeapRelation_8), int32(0))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L8
...
L17:
	;
	v101 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v105 = F_LWLockAcquire(m, v101+int32(_a_F_TransferPredicateLocksToHeapRelation_9), int32(0))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L8
...
L18:
	;
	v108 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v112 = F_LWLockAcquire(m, v108+int32(_a_F_TransferPredicateLocksToHeapRelation_10), int32(0))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L8
...
L19:
	;
	v115 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v119 = F_LWLockAcquire(m, v115+int32(_a_F_TransferPredicateLocksToHeapRelation_11), int32(0))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L8
...
L20:
	;
	v122 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v126 = F_LWLockAcquire(m, v122+int32(_a_F_TransferPredicateLocksToHeapRelation_12), int32(0))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L8
...
L21:
	;
	v129 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v133 = F_LWLockAcquire(m, v129+int32(_a_F_TransferPredicateLocksToHeapRelation_13), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L8
...
L22:
	;
	v136 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v140 = F_LWLockAcquire(m, v136+int32(_a_F_TransferPredicateLocksToHeapRelation_14), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L8
...
L23:
	;
	v143 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v147 = F_LWLockAcquire(m, v143+int32(_a_F_TransferPredicateLocksToHeapRelation_15), int32(0))
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L8
...
L24:
	;
	v150 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	v154 = F_LWLockAcquire(m, v150+int32(_a_F_TransferPredicateLocksToHeapRelation_16), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L8
...
L25:
	;
	v157 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
...
L26:
	;
	v164 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[2]))
	v167 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[3]))
	v171 = F_hash_search_with_hash_value(m, v164, int32(_a_F_TransferPredicateLocksToHeapRelation_17), v167, int32(2), v19+int32(28))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L8
...
L27:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[2]))
...
L32:
	;
	v393 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[2]))
	v396 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[3]))
	v400 = F_hash_search_with_hash_value(m, v393, int32(_a_F_TransferPredicateLocksToHeapRelation_17), v396, int32(1), v19+int32(8))
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L8
...
L44:
	;
	v218 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[2]))
...
L47:
	;
	v350 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[2]))
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = v232
	v282 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[4]))
...
L71:
	...
	F_LWLockRelease(m, v409+int32(_a_F_TransferPredicateLocksToHeapRelation_16))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L8
...
L72:
	...
	F_LWLockRelease(m, v415+int32(_a_F_TransferPredicateLocksToHeapRelation_15))
	mBase = m.M
	v419 = m.ExcPending
	if v419 != 0 {
		goto L8
...
L73:
	...
	F_LWLockRelease(m, v421+int32(_a_F_TransferPredicateLocksToHeapRelation_14))
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L8
...
L74:
	...
	F_LWLockRelease(m, v427+int32(_a_F_TransferPredicateLocksToHeapRelation_13))
	mBase = m.M
	v431 = m.ExcPending
	if v431 != 0 {
		goto L8
...
L75:
	...
	F_LWLockRelease(m, v433+int32(_a_F_TransferPredicateLocksToHeapRelation_12))
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L8
...
L76:
	...
	F_LWLockRelease(m, v439+int32(_a_F_TransferPredicateLocksToHeapRelation_11))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L8
...
L77:
	...
	F_LWLockRelease(m, v445+int32(_a_F_TransferPredicateLocksToHeapRelation_10))
	mBase = m.M
	v449 = m.ExcPending
	if v449 != 0 {
		goto L8
...
L78:
	...
	F_LWLockRelease(m, v451+int32(_a_F_TransferPredicateLocksToHeapRelation_9))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L8
...
L79:
	...
	F_LWLockRelease(m, v457+int32(_a_F_TransferPredicateLocksToHeapRelation_8))
	mBase = m.M
	v461 = m.ExcPending
	if v461 != 0 {
		goto L8
...
L80:
	...
	F_LWLockRelease(m, v463+int32(_a_F_TransferPredicateLocksToHeapRelation_7))
	mBase = m.M
	v467 = m.ExcPending
	if v467 != 0 {
		goto L8
...
L81:
	...
	F_LWLockRelease(m, v469+int32(_a_F_TransferPredicateLocksToHeapRelation_6))
	mBase = m.M
	v473 = m.ExcPending
	if v473 != 0 {
		goto L8
...
L82:
	...
	F_LWLockRelease(m, v475+int32(_a_F_TransferPredicateLocksToHeapRelation_5))
	mBase = m.M
	v479 = m.ExcPending
	if v479 != 0 {
		goto L8
...
L83:
	...
	F_LWLockRelease(m, v481+int32(_a_F_TransferPredicateLocksToHeapRelation_4))
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L8
...
L84:
	...
	F_LWLockRelease(m, v487+int32(_a_F_TransferPredicateLocksToHeapRelation_3))
	mBase = m.M
	v491 = m.ExcPending
	if v491 != 0 {
		goto L8
...
L85:
	;
	v493 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	F_LWLockRelease(m, v493+int32(_a_F_TransferPredicateLocksToHeapRelation_2))
	mBase = m.M
	v497 = m.ExcPending
	if v497 != 0 {
		goto L8
...
L86:
	;
	v499 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
	F_LWLockRelease(m, v499+int32(_a_F_TransferPredicateLocksToHeapRelation_1))
	mBase = m.M
	v503 = m.ExcPending
	if v503 != 0 {
		goto L8
...
L87:
	;
	v505 = *(*int32)(unsafe.Add(mBase, _c_F_TransferPredicateLocksToHeapRelation[1]))
...
func F___trunctfsf2(m *base.Module, l0 int64, l1 int64) float32 {
	...
	if base.Ui32(v20-int32(_a_F___trunctfsf2_0)) <= base.Ui32(int32(253)) {
		...
		if l0|v15 == int64(0) {
			if base.Ui32(int32(_a_F___trunctfsf2_2)) < base.Ui32(v20) {
				v177 = int32(0)
				v178 = int32(255)
			} else {
				v75 = base.B2i32(v19 == int64(0))
				if v19 == int64(0) {
					v76 = int32(_a_F___trunctfsf2_3)
				} else {
					v76 = int32(_a_F___trunctfsf2_0)
				}
				v77 = v76 - v20
				if int32(112) < v77 {
					v80 = int32(0)
					...
					*(*int64)(unsafe.Add(mBase, uint32(v12)+8)) = v131
					...
					v174 = base.B2i32(base.Ui32(int32(_a_F___trunctfsf2_1)) < base.Ui32(v170))
					if base.Ui32(int32(_a_F___trunctfsf2_1)) < base.Ui32(v170) {
						v175 = v170 ^ int32(_a_F___trunctfsf2_4)
					} else {
						v175 = v170
					}
					v177 = v175
			...
			if v19 != int64(32767) {
				...
				v177 = base.I32_wrap_i64(int64(base.Ui64(v15)>>(uint(int64(25))%64))) | int32(_a_F___trunctfsf2_5)
				v178 = int32(255)
			}
		}
	}
			...
			if v16 != int32(1) {
				...
				if v22 != 0 {
					...
					if v25 != 0 {
						...
						F_errmsg(m, int32(_a_F_timetypmodin_0), int32(0))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_timetypmodin_1), int32(65), int32(_a_F_timetypmodin_2))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
...
func F_transformAExprOp(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v9 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformAExprOp[0])))
	if v9 != int32(1) {
		goto L3
	} else {
		goto L4
...
L6:
	...
	v237 = v33 * int32(_a_F_transtime_0)
	goto L4
L7:
	;
	v24 = *(*int32)(unsafe.Add(mBase, uint32(l1)+4))
	v25 = int32(_a_F_transtime_0)
	v26 = v24 * v25
	v28 = v26 - v25
	if int32(59) < v24 {
		goto L8
...
L20:
	;
	v134 = v122 * int32(_a_F_transtime_0)
	if v128 <= int32(0) {
		v237 = v134
		goto L4
	} else {
...
L23:
	...
	v91 = int32(1)
	v92 = v37 - v91
	v98 = *(*int32)(unsafe.Add(mBase, uint32(v22*int32(48)+v92<<(uint(int32(2))%32))+uint32(_c_F_transtime[0])))
	v99 = int32(7)
	v105 = v83
	v108 = v91
	goto L24
...
L33:
	...
	v167 = *(*int32)(unsafe.Add(mBase, uint32(v164)+uint32(_c_F_transtime[1])))
	v168 = int32(_a_F_transtime_0)
	v172 = *(*int32)(unsafe.Add(mBase, uint32(v164)+uint32(_c_F_transtime[0])))
	v178 = *(*int32)(unsafe.Add(mBase, uint32(v164)+uint32(_c_F_transtime[2])))
	v184 = *(*int32)(unsafe.Add(mBase, uint32(v164)+uint32(_c_F_transtime[3])))
...
L37:
	;
	v225 = *(*int32)(unsafe.Add(mBase, uint32(v22*int32(48)+v209<<(uint(int32(2))%32))+uint32(_c_F_transtime[0])))
	v228 = v225*int32(_a_F_transtime_0) + v212
	v229 = int32(1)
	v232 = v216 + v229
	if v232 != v138 {
		v209 = v209 + v229
...
func F_tsm_handler_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_tsm_handler_in_0)
			F_errmsg(m, int32(_a_F_tsm_handler_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_tsm_handler_in_2), int32(372), int32(_a_F_tsm_handler_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
	...
	if v12 != 0 {
		...
		if v9 == int32(0) {
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
				F_errmsg_internal(m, int32(_a_F_typeidTypeRelid_0), v6)
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_typeidTypeRelid_1), int32(676), int32(_a_F_typeidTypeRelid_2))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
