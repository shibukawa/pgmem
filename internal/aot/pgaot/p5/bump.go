...
func F_BumpContextCreate(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v10 = v8 - int32(16)
	m.G0 = v10
	v13 = F_emscripten_builtin_malloc(m, int32(_a_F_BumpContextCreate_0))
	mBase = m.M
	if v13 != 0 {
		v14 = int32(_a_F_BumpContextCreate_0)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = int32(_a_F_BumpContextCreate_1)
		if l0 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13)+8)) = int32(_a_F_BumpContextCreate_0)
		m.G0 = v10 + int32(16)
		return v13
	} else {
		v88 = *(*int32)(unsafe.Add(mBase, _c_F_BumpContextCreate[0]))
		...
		if v92 != 0 {
			...
			if v96 != 0 {
				...
				F_errcode(m, int32(_a_F_BumpContextCreate_2))
				mBase = m.M
				v99 = m.ExcPending
				if v99 != 0 {
					return int32(0)
				} else {
					F_errmsg(m, int32(_a_F_BumpContextCreate_3), int32(0))
					mBase = m.M
					v103 = m.ExcPending
					if v103 != 0 {
						return int32(0)
