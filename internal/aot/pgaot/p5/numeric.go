							...
							if v32 != 0 {
								...
								if v36 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = (v16<<(uint(v42)%32) - int32(8388608)) >> (uint(v42) % 32)
									F_errdetail(m, int32(629302), v9)
									mBase = m.M
									v51 = m.ExcPending
									if v51 != 0 {
										return int32(0)
									} else {
										F_errsave_finish(m, int32(0), int32(500458), int32(8138), int32(314268))
										mBase = m.M
										v57 = m.ExcPending
										if v57 != 0 {
											return int32(0)
...
L4:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(244907)
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(244907)
...
L11:
	;
	F_errfinish(m, int32(500458), int32(4884), int32(244842))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(500458), int32(4880), int32(244842))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L1
...
L79:
	;
	F_errmsg(m, int32(402830), int32(0))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L1
...
L80:
	;
	F_errfinish(m, int32(500458), int32(4893), int32(244842))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L1
		...
		*(*int64)(unsafe.Add(mBase, uint32(v17)+80)) = int64(0)
		...
		if v139 != 0 {
			...
			if v143 != 0 {
				...
				F_errfinish(m, int32(500458), int32(5809), int32(342338))
				mBase = m.M
				v148 = m.ExcPending
				if v148 != 0 {
					return int32(0)
...
L643:
	;
	F_errfinish(m, int32(500458), int32(4101), int32(213837))
	mBase = m.M
	v1944 = m.ExcPending
	if v1944 != 0 {
		goto L1
...
L647:
	;
	F_errfinish(m, int32(500458), int32(4105), int32(213837))
	mBase = m.M
	v1960 = m.ExcPending
	if v1960 != 0 {
		goto L1
...
L651:
	;
	F_errfinish(m, int32(500458), int32(4213), int32(213837))
	mBase = m.M
	v1976 = m.ExcPending
	if v1976 != 0 {
		goto L1
...
L655:
	;
	F_errfinish(m, int32(500458), int32(11498), int32(91056))
	mBase = m.M
	v1992 = m.ExcPending
	if v1992 != 0 {
		goto L1
...
L659:
	;
	F_errfinish(m, int32(500458), int32(11551), int32(91056))
	mBase = m.M
	v2008 = m.ExcPending
	if v2008 != 0 {
		goto L1
...
L663:
	;
	F_errfinish(m, int32(500458), int32(11633), int32(91056))
	mBase = m.M
	v2024 = m.ExcPending
	if v2024 != 0 {
		goto L1
...
L667:
	;
	F_errfinish(m, int32(500458), int32(11346), int32(229539))
	mBase = m.M
	v2040 = m.ExcPending
	if v2040 != 0 {
		goto L1
...
L671:
	;
	F_errfinish(m, int32(500458), int32(11404), int32(229539))
	mBase = m.M
	v2056 = m.ExcPending
	if v2056 != 0 {
		goto L1
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v47))) = v41
	v53 = F_open(m, int32(288751), v41, v47)
	mBase = m.M
	if v53 != int32(-1) {
		goto L9
	} else {
...
L35:
	;
	F_errmsg(m, int32(528147), int32(0))
	mBase = m.M
	v1450 = m.ExcPending
	if v1450 != 0 {
		goto L1
...
L42:
	;
	F_errfinish(m, int32(500458), int32(4364), int32(491059))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L1
...
L44:
	;
	F_errmsg(m, int32(528199), int32(0))
	mBase = m.M
	v1441 = m.ExcPending
	if v1441 != 0 {
		goto L1
...
L51:
	;
	F_errfinish(m, int32(500458), int32(4375), int32(491059))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L1
...
L273:
	;
	F_errfinish(m, int32(500458), int32(11702), int32(229564))
	mBase = m.M
	v1437 = m.ExcPending
	if v1437 != 0 {
		goto L1
...
L275:
	;
	F_errfinish(m, int32(500458), int32(4371), int32(491059))
	mBase = m.M
	v1446 = m.ExcPending
	if v1446 != 0 {
		goto L1
...
L277:
	;
	F_errfinish(m, int32(500458), int32(4360), int32(491059))
	mBase = m.M
	v1455 = m.ExcPending
	if v1455 != 0 {
		goto L1
