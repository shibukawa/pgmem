							...
							if v32 != 0 {
								...
								if v36 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = (v16<<(uint(v42)%32) - int32(8388608)) >> (uint(v42) % 32)
									F_errdetail(m, int32(600454), v9)
									mBase = m.M
									v51 = m.ExcPending
									if v51 != 0 {
										return int32(0)
									} else {
										F_errsave_finish(m, int32(0), int32(488768), int32(8138), int32(306923))
										mBase = m.M
										v57 = m.ExcPending
										if v57 != 0 {
											return int32(0)
	...
	if base.Ui32(v14) <= base.Ui32(int32(49151)) {
		...
		if base.Ui32(int32(49151)) < base.Ui32(v18) {
			...
			if v46&int32(65535) != int32(49152) {
				if v14 != int32(61440) {
					if v14 != int32(53248) {
						...
						if v46&int32(65535) == int32(53248) {
							if v131 == int32(49152) {
								v164 = F_make_result_opt_error(m, int32(1709084), int32(0))
								mBase = m.M
								v165 = m.ExcPending
								if v165 != 0 {
									return int32(0)
								...
								if base.Ui32(int32(base.Ui32(v138)>>(uint(int32(2))%32))+v145) < base.Ui32(int32(2)) {
									v408 = F_make_result_opt_error(m, int32(1709036), int32(0))
									mBase = m.M
									v409 = m.ExcPending
									if v409 != 0 {
										return int32(0)
									...
									if v155 == int32(16384) {
										...
										v160 = F_make_result_opt_error(m, int32(1709060), int32(0))
										mBase = m.M
										v161 = m.ExcPending
										if v161 != 0 {
											return int32(0)
							...
							if v131 == int32(49152) {
								v194 = F_make_result_opt_error(m, int32(1709060), int32(0))
								mBase = m.M
								v195 = m.ExcPending
								if v195 != 0 {
									return int32(0)
								...
								if base.Ui32(int32(base.Ui32(v168)>>(uint(int32(2))%32))+v175) < base.Ui32(int32(2)) {
									v412 = F_make_result_opt_error(m, int32(1709036), int32(0))
									mBase = m.M
									v413 = m.ExcPending
									if v413 != 0 {
										return int32(0)
									...
									if v185 == int32(16384) {
										...
										v190 = F_make_result_opt_error(m, int32(1709084), int32(0))
										mBase = m.M
										v191 = m.ExcPending
										if v191 != 0 {
											return int32(0)
						...
						if v67 == v66 {
							if v65 == int32(53248) {
								v95 = F_make_result_opt_error(m, int32(1709060), int32(0))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return int32(0)
								...
								v420 = F_make_result_opt_error(m, int32(1709084), int32(0))
								mBase = m.M
								v421 = m.ExcPending
								if v421 != 0 {
									return int32(0)
							...
							if base.Ui32(int32(base.Ui32(v72)>>(uint(int32(2))%32))+v80) < base.Ui32(int32(2)) {
								v400 = F_make_result_opt_error(m, int32(1709036), int32(0))
								mBase = m.M
								v401 = m.ExcPending
								if v401 != 0 {
									return int32(0)
					...
					if v100 == v99 {
						if v98 == int32(53248) {
							v128 = F_make_result_opt_error(m, int32(1709084), int32(0))
							mBase = m.M
							v129 = m.ExcPending
							if v129 != 0 {
								return int32(0)
							...
							v416 = F_make_result_opt_error(m, int32(1709060), int32(0))
							mBase = m.M
							v417 = m.ExcPending
							if v417 != 0 {
								return int32(0)
						...
						if base.Ui32(int32(base.Ui32(v105)>>(uint(int32(2))%32))+v113) < base.Ui32(int32(2)) {
							v404 = F_make_result_opt_error(m, int32(1709036), int32(0))
							mBase = m.M
							v405 = m.ExcPending
							if v405 != 0 {
								return int32(0)
				...
				v56 = F_make_result_opt_error(m, int32(1709036), int32(0))
				mBase = m.M
				v59 = m.ExcPending
				if v59 != 0 {
					return int32(0)
...
L4:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(239356)
	F_errmsg(m, int32(179386), v13)
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
		goto L1
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(239356)
	F_errmsg(m, int32(178709), v13+int32(16))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L11:
	;
	F_errfinish(m, int32(488768), int32(4884), int32(239291))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(488768), int32(4880), int32(239291))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L1
...
L79:
	;
	F_errmsg(m, int32(393526), int32(0))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L1
...
L80:
	;
	F_errfinish(m, int32(488768), int32(4893), int32(239291))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L1
		...
		*(*int64)(unsafe.Add(mBase, uint32(v17)+80)) = int64(0)
		...
		if v139 != 0 {
			...
			if v143 != 0 {
				...
				F_errfinish(m, int32(488768), int32(5809), int32(334320))
				mBase = m.M
				v148 = m.ExcPending
				if v148 != 0 {
					return int32(0)
...
L5:
	;
	v2215 = F_make_result_opt_error(m, int32(1709036), int32(0))
	mBase = m.M
	v2216 = m.ExcPending
	if v2216 != 0 {
		goto L1
...
L31:
	;
	v81 = F_make_result_opt_error(m, int32(1709036), int32(0))
	mBase = m.M
	v82 = m.ExcPending
	if v82 != 0 {
		goto L1
...
L36:
	;
	v77 = F_make_result_opt_error(m, int32(1709160), int32(0))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L1
...
L94:
	;
	v281 = F_make_result_opt_error(m, int32(1709160), int32(0))
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L1
...
L212:
	;
	v641 = F_make_result_opt_error(m, int32(1709160), int32(0))
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		goto L1
...
L214:
	;
	v652 = F_make_result_opt_error(m, int32(1709160), int32(0))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L1
...
L218:
	;
	v659 = F_make_result_opt_error(m, int32(1709108), int32(0))
	mBase = m.M
	v660 = m.ExcPending
	if v660 != 0 {
		goto L1
...
L272:
	;
	v791 = F_make_result_opt_error(m, int32(1709160), int32(0))
	mBase = m.M
	v792 = m.ExcPending
	if v792 != 0 {
		goto L1
...
L301:
	;
	v851 = F_make_result_opt_error(m, int32(1709060), int32(0))
	mBase = m.M
	v852 = m.ExcPending
	if v852 != 0 {
		goto L1
...
L303:
	;
	v855 = F_make_result_opt_error(m, int32(1709108), int32(0))
	mBase = m.M
	v856 = m.ExcPending
	if v856 != 0 {
		goto L1
...
L309:
	;
	v863 = F_make_result_opt_error(m, int32(1709060), int32(0))
	mBase = m.M
	v864 = m.ExcPending
	if v864 != 0 {
		goto L1
...
L311:
	;
	v867 = F_make_result_opt_error(m, int32(1709108), int32(0))
	mBase = m.M
	v868 = m.ExcPending
	if v868 != 0 {
		goto L1
...
L314:
	;
	v871 = F_make_result_opt_error(m, int32(1709108), int32(0))
	mBase = m.M
	v872 = m.ExcPending
	if v872 != 0 {
		goto L1
...
L337:
	;
	v968 = F_make_result_opt_error(m, int32(1709060), int32(0))
	mBase = m.M
	v969 = m.ExcPending
	if v969 != 0 {
		goto L1
...
L340:
	;
	v964 = F_make_result_opt_error(m, int32(1709084), int32(0))
	mBase = m.M
	v965 = m.ExcPending
	if v965 != 0 {
		goto L1
...
L446:
	;
	v1544 = int32(1)
	F_div_var(m, int32(1709160), v19+int32(48), v19, v1369, v1544, v1544)
	mBase = m.M
	v1547 = m.ExcPending
	if v1547 != 0 {
		goto L1
...
L566:
	;
	F_div_var(m, int32(1709160), v19, v19, v1369, int32(1), int32(0))
	mBase = m.M
	v1736 = m.ExcPending
	if v1736 != 0 {
		goto L1
...
L643:
	;
	F_errfinish(m, int32(488768), int32(4101), int32(209759))
	mBase = m.M
	v1944 = m.ExcPending
	if v1944 != 0 {
		goto L1
...
L647:
	;
	F_errfinish(m, int32(488768), int32(4105), int32(209759))
	mBase = m.M
	v1960 = m.ExcPending
	if v1960 != 0 {
		goto L1
...
L651:
	;
	F_errfinish(m, int32(488768), int32(4213), int32(209759))
	mBase = m.M
	v1976 = m.ExcPending
	if v1976 != 0 {
		goto L1
...
L655:
	;
	F_errfinish(m, int32(488768), int32(11498), int32(89343))
	mBase = m.M
	v1992 = m.ExcPending
	if v1992 != 0 {
		goto L1
...
L659:
	;
	F_errfinish(m, int32(488768), int32(11551), int32(89343))
	mBase = m.M
	v2008 = m.ExcPending
	if v2008 != 0 {
		goto L1
...
L663:
	;
	F_errfinish(m, int32(488768), int32(11633), int32(89343))
	mBase = m.M
	v2024 = m.ExcPending
	if v2024 != 0 {
		goto L1
...
L667:
	;
	F_errfinish(m, int32(488768), int32(11346), int32(224669))
	mBase = m.M
	v2040 = m.ExcPending
	if v2040 != 0 {
		goto L1
...
L671:
	;
	F_errfinish(m, int32(488768), int32(11404), int32(224669))
	mBase = m.M
	v2056 = m.ExcPending
	if v2056 != 0 {
		goto L1
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v47))) = v41
	v53 = F_open(m, int32(282155), v41, v47)
	mBase = m.M
	if v53 != int32(-1) {
		goto L9
	} else {
...
L35:
	;
	F_errmsg(m, int32(515965), int32(0))
	mBase = m.M
	v1450 = m.ExcPending
	if v1450 != 0 {
		goto L1
...
L41:
	;
	F_errmsg(m, int32(11055), int32(0))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		goto L1
...
L42:
	;
	F_errfinish(m, int32(488768), int32(4364), int32(479688))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L1
...
L44:
	;
	F_errmsg(m, int32(516017), int32(0))
	mBase = m.M
	v1441 = m.ExcPending
	if v1441 != 0 {
		goto L1
...
L50:
	;
	F_errmsg(m, int32(11086), int32(0))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L1
...
L51:
	;
	F_errfinish(m, int32(488768), int32(4375), int32(479688))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L1
...
L273:
	;
	F_errfinish(m, int32(488768), int32(11702), int32(224694))
	mBase = m.M
	v1437 = m.ExcPending
	if v1437 != 0 {
		goto L1
...
L275:
	;
	F_errfinish(m, int32(488768), int32(4371), int32(479688))
	mBase = m.M
	v1446 = m.ExcPending
	if v1446 != 0 {
		goto L1
...
L277:
	;
	F_errfinish(m, int32(488768), int32(4360), int32(479688))
	mBase = m.M
	v1455 = m.ExcPending
	if v1455 != 0 {
		goto L1
				...
				if v14 != int32(61440) {
					if v14 != int32(53248) {
						if v47&int32(65535) == int32(53248) {
							v94 = F_make_result_opt_error(m, int32(1709084), int32(0))
							mBase = m.M
							v95 = m.ExcPending
							if v95 != 0 {
								return int32(0)
							...
							v98 = F_make_result_opt_error(m, int32(1709060), int32(0))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return int32(0)
						...
						if v47&int32(65535) == int32(53248) {
							v70 = F_make_result_opt_error(m, int32(1709036), int32(0))
							mBase = m.M
							v71 = m.ExcPending
							if v71 != 0 {
								return int32(0)
							...
							v74 = F_make_result_opt_error(m, int32(1709060), int32(0))
							mBase = m.M
							v75 = m.ExcPending
							if v75 != 0 {
								return int32(0)
					...
					if v47&int32(65535) == int32(61440) {
						v82 = F_make_result_opt_error(m, int32(1709036), int32(0))
						mBase = m.M
						v83 = m.ExcPending
						if v83 != 0 {
							return int32(0)
						...
						v86 = F_make_result_opt_error(m, int32(1709084), int32(0))
						mBase = m.M
						v87 = m.ExcPending
						if v87 != 0 {
							return int32(0)
