...
func F_in_range_int2_int2(m *base.Module, l0 int32) int32 {
	...
	v9 = F_DirectFunctionCall5Coll(m, int32(1322), int32(0), v4, v5, v6, v7, v8)
	mBase = m.M
	v12 = m.ExcPending
	if v12 != 0 {
		return int32(0)
...
func F_in_range_int4_int2(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)+44))
	v8 = *(*int32)(unsafe.Add(mBase, uint32(l0)+52))
	v9 = F_DirectFunctionCall5Coll(m, int32(1321), int32(0), v4, v5, v6, v7, v8)
	mBase = m.M
	v12 = m.ExcPending
	if v12 != 0 {
		return int32(0)
...
func F_show_in_hot_standby(m *base.Module) int32 {
	...
	var v18 int32
	_ = v18
	v4 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_show_in_hot_standby[0])))
	if v4 == int32(1) {
		v9 = *(*int32)(unsafe.Add(mBase, _c_F_show_in_hot_standby[1]))
		v10 = *(*int32)(unsafe.Add(mBase, uint32(v9)+316))
		v12 = base.B2i32(v10 != int32(2))
		*(*uint8)(unsafe.Add(mBase, _c_F_show_in_hot_standby[0])) = uint8(v12)
		if v10 != int32(2) {
			v16 = int32(_a_F_show_in_hot_standby_0)
		} else {
			v16 = int32(_a_F_show_in_hot_standby_1)
		}
		v18 = v16
	} else {
