		...
		if v71 != 0 {
			...
			if v74 != 0 {
				...
				if v78 != 0 {
					...
					F_errfinish(m, int32(517338), int32(1043), int32(581926))
					mBase = m.M
					v83 = m.ExcPending
					if v83 != 0 {
						return int32(0)
		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				if v43 != 0 {
					...
					F_errfinish(m, int32(516897), int32(664), int32(585533))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
		...
		if v37 != 0 {
			...
			if v40 != 0 {
				...
				if v44 != 0 {
					...
					F_errfinish(m, int32(516897), int32(711), int32(581632))
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
		...
		if v255 != 0 {
			...
			if v258 != 0 {
				...
				if v262 != 0 {
					...
					F_errfinish(m, int32(520342), int32(3947), int32(324304))
					mBase = m.M
					v267 = m.ExcPending
					if v267 != 0 {
						return int32(0)
