...
func F_create_tablespace_directories(m *base.Module, l0 int32, l1 int32) {
	...
	v8 = v6 - int32(272)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, uint32(v8)+160)) = int32(481294)
	*(*int32)(unsafe.Add(mBase, uint32(v8)+164)) = l1
	v16 = F_psprintf(m, int32(38723), v8+int32(160))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
		...
		if v18 == int32(0) {
			...
			if v23 < int32(0) {
				...
				if v27 != int32(20) {
					...
					if v97 != 0 {
						...
						if v99 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+96)) = v16
							F_errmsg(m, int32(292204), v8+int32(96))
							mBase = m.M
							v105 = m.ExcPending
							if v105 != 0 {
								return
							} else {
								F_errfinish(m, int32(491840), int32(594), int32(165557))
								mBase = m.M
								v110 = m.ExcPending
								if v110 != 0 {
									return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+84)) = int32(545587)
					*(*int32)(unsafe.Add(mBase, uint32(v8)+80)) = v16
					v36 = F_psprintf(m, int32(174483), v8+int32(80))
					mBase = m.M
					v37 = m.ExcPending
					if v37 != 0 {
						return
								...
								if v171 != 0 {
									...
									if v173 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v111
										F_errmsg(m, int32(291833), v8+int32(32))
										mBase = m.M
										v179 = m.ExcPending
										if v179 != 0 {
											return
										} else {
											F_errfinish(m, int32(491840), int32(634), int32(165557))
											mBase = m.M
											v184 = m.ExcPending
											if v184 != 0 {
												return
													...
													if v224 != 0 {
														...
														if v226 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v16
															F_errmsg(m, int32(293001), v8+int32(16))
															mBase = m.M
															v232 = m.ExcPending
															if v232 != 0 {
																return
															} else {
																F_errfinish(m, int32(491840), int32(665), int32(165557))
																mBase = m.M
																v237 = m.ExcPending
																if v237 != 0 {
																	return
									...
									if v131 != 0 {
										...
										if v133 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8))) = v111
											F_errmsg(m, int32(292204), v8)
											mBase = m.M
											v137 = m.ExcPending
											if v137 != 0 {
												return
											} else {
												F_errfinish(m, int32(491840), int32(639), int32(165557))
												mBase = m.M
												v142 = m.ExcPending
												if v142 != 0 {
													return
									...
									if v191 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v111
										...
										if v197 != 0 {
											...
											F_errfinish(m, int32(491840), int32(645), int32(165557))
											mBase = m.M
											v202 = m.ExcPending
											if v202 != 0 {
												return
									...
									if v206 != 0 {
										...
										if v209 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v111
											F_errmsg(m, int32(412922), v8+int32(48))
											mBase = m.M
											v215 = m.ExcPending
											if v215 != 0 {
												return
											} else {
												F_errfinish(m, int32(491840), int32(650), int32(165557))
												mBase = m.M
												v220 = m.ExcPending
												if v220 != 0 {
													return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+148)) = int32(545587)
			*(*int32)(unsafe.Add(mBase, uint32(v8)+144)) = l0
			v44 = F_psprintf(m, int32(174483), v8+int32(144))
			mBase = m.M
			v45 = m.ExcPending
			if v45 != 0 {
				return
						...
						if v52 == int32(44) {
							...
							if v61 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+112)) = l0
								F_errmsg(m, int32(69660), v8+int32(112))
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return
									...
									if v69 == int32(1) {
										F_errhint(m, int32(585208), int32(0))
										mBase = m.M
										v75 = m.ExcPending
										if v75 != 0 {
											return
										} else {
											F_errfinish(m, int32(491840), int32(613), int32(165557))
											mBase = m.M
											v80 = m.ExcPending
											if v80 != 0 {
												return
							...
							if v82 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+128)) = l0
								F_errmsg(m, int32(291993), v8+int32(128))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return
								} else {
									F_errfinish(m, int32(491840), int32(618), int32(165557))
									mBase = m.M
									v93 = m.ExcPending
									if v93 != 0 {
										return
...
func F_destroy_tablespace_directories(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v12 = v10 - int32(208)
	m.G0 = v12
	*(*int32)(unsafe.Add(mBase, uint32(v12)+96)) = int32(481294)
	*(*int32)(unsafe.Add(mBase, uint32(v12)+100)) = l0
	*(*int32)(unsafe.Add(mBase, uint32(v12)+104)) = int32(545587)
	v22 = F_psprintf(m, int32(174357), v12+int32(96))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L4
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v22
	F_errmsg(m, int32(292041), v12+int32(16))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L4
...
L15:
	;
	F_errfinish(m, int32(491840), int32(729), int32(165526))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v22
	F_errmsg(m, int32(292041), v12+int32(32))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L4
...
L23:
	;
	F_errfinish(m, int32(491840), int32(739), int32(165526))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L4
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+80)) = v22
	v105 = F_psprintf(m, int32(174483), v12+int32(80))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L4
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v105
	F_errmsg(m, int32(292168), v12-int32(-64))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L4
...
L64:
	;
	F_errfinish(m, int32(491840), int32(768), int32(165526))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L4
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v22
	F_errmsg(m, int32(292168), v12+int32(48))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L4
...
L79:
	;
	F_errfinish(m, int32(491840), int32(781), int32(165526))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L4
...
L153:
	;
	F_errfinish(m, int32(491840), v373, int32(165526))
	mBase = m.M
	v380 = m.ExcPending
	if v380 != 0 {
		goto L4
