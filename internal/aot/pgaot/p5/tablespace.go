...
func F_create_tablespace_directories(m *base.Module, l0 int32, l1 int32) {
	...
	v8 = v6 - int32(272)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, uint32(v8)+160)) = int32(485695)
		...
		if v18 == int32(0) {
			...
			if v23 < int32(0) {
				...
				if v27 != int32(20) {
						...
						if v99 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+96)) = v16
							...
							if v105 != 0 {
								...
								F_errfinish(m, int32(496378), int32(594), int32(167181))
								mBase = m.M
								v110 = m.ExcPending
								if v110 != 0 {
									return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+84)) = int32(550720)
									...
									if v173 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v111
										...
										if v179 != 0 {
											...
											F_errfinish(m, int32(496378), int32(634), int32(167181))
											mBase = m.M
											v184 = m.ExcPending
											if v184 != 0 {
												return
														...
														if v226 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v16
															...
															if v232 != 0 {
																...
																F_errfinish(m, int32(496378), int32(665), int32(167181))
																mBase = m.M
																v237 = m.ExcPending
																if v237 != 0 {
																	return
										...
										if v133 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8))) = v111
											...
											if v137 != 0 {
												...
												F_errfinish(m, int32(496378), int32(639), int32(167181))
												mBase = m.M
												v142 = m.ExcPending
												if v142 != 0 {
													return
									...
									if v191 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v111
										...
										if v197 != 0 {
											...
											F_errfinish(m, int32(496378), int32(645), int32(167181))
											mBase = m.M
											v202 = m.ExcPending
											if v202 != 0 {
												return
									...
									if v206 != 0 {
										...
										if v209 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v111
											F_errmsg(m, int32(416642), v8+int32(48))
											mBase = m.M
											v215 = m.ExcPending
											if v215 != 0 {
												return
											} else {
												F_errfinish(m, int32(496378), int32(650), int32(167181))
												mBase = m.M
												v220 = m.ExcPending
												if v220 != 0 {
													return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+148)) = int32(550720)
							...
							if v61 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+112)) = l0
								...
								if v67 != 0 {
									...
									if v69 == int32(1) {
										F_errhint(m, int32(590487), int32(0))
										mBase = m.M
										v75 = m.ExcPending
										if v75 != 0 {
											return
										} else {
											F_errfinish(m, int32(496378), int32(613), int32(167181))
											mBase = m.M
											v80 = m.ExcPending
											if v80 != 0 {
												return
							...
							if v82 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+128)) = l0
								...
								if v88 != 0 {
									...
									F_errfinish(m, int32(496378), int32(618), int32(167181))
									mBase = m.M
									v93 = m.ExcPending
									if v93 != 0 {
										return
...
func F_destroy_tablespace_directories(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v12 = v10 - int32(208)
	m.G0 = v12
	*(*int32)(unsafe.Add(mBase, uint32(v12)+96)) = int32(485695)
	*(*int32)(unsafe.Add(mBase, uint32(v12)+100)) = l0
	*(*int32)(unsafe.Add(mBase, uint32(v12)+104)) = int32(550720)
...
L15:
	;
	F_errfinish(m, int32(496378), int32(729), int32(167150))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L23:
	;
	F_errfinish(m, int32(496378), int32(739), int32(167150))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L4
...
L64:
	;
	F_errfinish(m, int32(496378), int32(768), int32(167150))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L4
...
L79:
	;
	F_errfinish(m, int32(496378), int32(781), int32(167150))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L4
...
L153:
	;
	F_errfinish(m, int32(496378), v373, int32(167150))
	mBase = m.M
	v380 = m.ExcPending
	if v380 != 0 {
		goto L4
