...
L72:
	;
	v157 = int32(_a_F_ExecMergeJoin_0)
	v158 = *(*int32)(unsafe.Add(mBase, _c_F_ExecMergeJoin[1]))
	v160 = *(*int32)(unsafe.Add(mBase, uint32(v34)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecMergeJoin[1])) = v160
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecMergeJoin[1])) = v158
	if v165 == int32(0) {
		goto L71
	} else {
		goto L76
...
L196:
	;
	v592 = int32(0)
	v593 = int32(_a_F_ExecMergeJoin_0)
	v594 = *(*int32)(unsafe.Add(mBase, _c_F_ExecMergeJoin[1]))
	v596 = *(*int32)(unsafe.Add(mBase, uint32(v588)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecMergeJoin[1])) = v596
...
L236:
	;
	v809 = int32(0)
	v810 = int32(_a_F_ExecMergeJoin_0)
	v811 = *(*int32)(unsafe.Add(mBase, _c_F_ExecMergeJoin[1]))
	v813 = *(*int32)(unsafe.Add(mBase, uint32(v805)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecMergeJoin[1])) = v813
...
L18:
	;
	v64 = int32(0)
	v65 = int32(_a_F_create_join_clause_0)
	v66 = *(*int32)(unsafe.Add(mBase, _c_F_create_join_clause[0]))
	v68 = *(*int32)(unsafe.Add(mBase, uint32(l0)+280))
	*(*int32)(unsafe.Add(mBase, _c_F_create_join_clause[0])) = v68
...
L47:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_create_join_clause[0])) = v66
	v131 = v91
	goto L1
L48:
	;
