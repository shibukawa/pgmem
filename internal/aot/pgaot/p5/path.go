...
func F_PathNameCreateTemporaryFile(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v14 != 0 {
		...
		v17 = *(*int32)(unsafe.Add(mBase, _consts[646]))
		...
		if v19 != 0 {
			...
			if v18 <= int32(0) {
					...
					if v27 != 0 {
						...
						if v29 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg(m, int32(292577), v7)
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(490747), int32(1889), int32(382707))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
				...
				v40 = v18 * int32(48)
				v42 = *(*int32)(unsafe.Add(mBase, _consts[553]))
				v44 = int32(4)
				v45 = v40 + v42 + v44
				...
				*(*uint16)(unsafe.Add(mBase, uint32(v45))) = uint16(v48)
				...
				F_ResourceOwnerRemember(m, v51, v18, int32(1602144))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return int32(0)
				} else {
					v56 = *(*int32)(unsafe.Add(mBase, _consts[553]))
					v57 = v56 + v40
					...
					*(*uint16)(unsafe.Add(mBase, uint32(v62))) = uint16(v65)
					v68 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _consts[647])) = uint8(v68)
					m.G0 = v7 + int32(16)
					return v18
				}
			}
...
L70:
	;
	v274 = F_format_elog_string(m, int32(620576), int32(0))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L5
...
L28:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v17)+32)) = v105
	v108 = *(*float64)(unsafe.Add(mBase, _consts[399]))
	v110 = *(*float64)(unsafe.Add(mBase, _consts[400]))
	v112 = *(*float64)(unsafe.Add(mBase, _consts[389]))
	v114 = int32(*(*uint8)(unsafe.Add(mBase, _consts[401])))
...
L34:
	;
	F_errfinish(m, int32(490457), int32(2118), int32(316135))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
...
func F_create_sort_path(m *base.Module, l0 int32, l1 int32, l2 int32, l3 float64) int32 {
	...
	if v11 != 0 {
		...
		*(*float64)(unsafe.Add(mBase, uint32(v8)+32)) = v36
		v53 = int32(*(*uint8)(unsafe.Add(mBase, _consts[402])))
