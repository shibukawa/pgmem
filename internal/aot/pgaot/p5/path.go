		...
		if v19 != 0 {
			...
			if v18 <= int32(0) {
					...
					if v27 != 0 {
						...
						if v29 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg(m, int32(309214), v7)
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(520130), int32(1889), int32(405160))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
				...
				*(*uint16)(unsafe.Add(mBase, uint32(v45))) = uint16(v48)
				...
				F_ResourceOwnerRemember(m, v51, v18, int32(1656320))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return int32(0)
...
func F_check_search_path(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v15 = *(*int32)(unsafe.Add(mBase, _consts[250]))
	if v15 == v4 {
		v253 = v4
		goto L3
	} else {
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _consts[251])) = v204
	v295 = int32(1)
	goto L1
L3:
	;
...
L7:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11))) = v59
	v62 = *(*int32)(unsafe.Add(mBase, _consts[252]))
...
L67:
	;
	v268 = *(*int32)(unsafe.Add(mBase, _consts[87]))
	*(*int32)(unsafe.Add(mBase, _consts[88])) = v268
	goto L70
L68:
	;
	goto L69
...
L70:
	;
	v274 = F_format_elog_string(m, int32(669324), int32(0))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L5
...
L71:
	;
	*(*int32)(unsafe.Add(mBase, _consts[89])) = v274
	F_pfree(m, v257)
	mBase = m.M
	v278 = m.ExcPending
	if v278 != 0 {
...
L33:
	;
	F_errmsg_internal(m, int32(458533), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L34:
	;
	F_errfinish(m, int32(519568), int32(2118), int32(334496))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
