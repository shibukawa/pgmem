		...
		if v19 != 0 {
			...
			if v18 <= int32(0) {
					...
					if v27 != 0 {
						...
						if v29 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg(m, int32(295816), v7)
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(496527), int32(1889), int32(387223))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
				...
				*(*uint16)(unsafe.Add(mBase, uint32(v45))) = uint16(v48)
				...
				F_ResourceOwnerRemember(m, v51, v18, int32(1609664))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return int32(0)
...
L70:
	;
	v274 = F_format_elog_string(m, int32(627757), int32(0))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L5
...
L33:
	;
	F_errmsg_internal(m, int32(438804), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L34:
	;
	F_errfinish(m, int32(496230), int32(2118), int32(319796))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
