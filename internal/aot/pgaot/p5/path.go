		...
		if v19 != 0 {
			...
			if v18 <= int32(0) {
					...
					if v27 != 0 {
						...
						if v29 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg(m, int32(312670), v7)
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(526349), int32(1889), int32(409692))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
				...
				*(*uint16)(unsafe.Add(mBase, uint32(v45))) = uint16(v48)
				...
				F_ResourceOwnerRemember(m, v51, v18, int32(1665568))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return int32(0)
...
L70:
	;
	v274 = F_format_elog_string(m, int32(677746), int32(0))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L5
...
L28:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v17)+32)) = v105
	v108 = *(*float64)(unsafe.Add(mBase, _consts[393]))
	v110 = *(*float64)(unsafe.Add(mBase, _consts[394]))
	v112 = *(*float64)(unsafe.Add(mBase, _consts[383]))
	v114 = int32(*(*uint8)(unsafe.Add(mBase, _consts[395])))
...
L33:
	;
	F_errmsg_internal(m, int32(463959), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L34:
	;
	F_errfinish(m, int32(525787), int32(2118), int32(338546))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
...
func F_create_sort_path(m *base.Module, l0 int32, l1 int32, l2 int32, l3 float64) int32 {
	...
	if v11 != 0 {
		...
		*(*float64)(unsafe.Add(mBase, uint32(v8)+32)) = v36
		v53 = int32(*(*uint8)(unsafe.Add(mBase, _consts[396])))
