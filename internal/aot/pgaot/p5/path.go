...
func F_PathNameCreateTemporaryFile(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[11]))
	...
	if v14 != 0 {
		...
		v17 = *(*int32)(unsafe.Add(mBase, _consts[641]))
		...
		if v19 != 0 {
			...
			if v18 <= int32(0) {
					...
					if v27 != 0 {
						...
						if v29 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg(m, int32(312405), v7)
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(525903), int32(1889), int32(409271))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
				...
				v40 = v18 * int32(48)
				v42 = *(*int32)(unsafe.Add(mBase, _consts[548]))
				v44 = int32(4)
				v45 = v40 + v42 + v44
				...
				*(*uint16)(unsafe.Add(mBase, uint32(v45))) = uint16(v48)
				...
				F_ResourceOwnerRemember(m, v51, v18, int32(1664528))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return int32(0)
				} else {
					v56 = *(*int32)(unsafe.Add(mBase, _consts[548]))
					v57 = v56 + v40
					...
					*(*uint16)(unsafe.Add(mBase, uint32(v62))) = uint16(v65)
					v68 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _consts[642])) = uint8(v68)
					m.G0 = v7 + int32(16)
					return v18
				}
			}
...
func F_add_path(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v685
	v3 = int32(0)
	v14 = *(*int32)(unsafe.Add(mBase, _consts[45]))
	if v14 != 0 {
		goto L1
	} else {
		goto L2
...
func F_check_search_path(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v15 = *(*int32)(unsafe.Add(mBase, _consts[248]))
	if v15 == v4 {
		v253 = v4
		goto L3
	} else {
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _consts[249])) = v204
	v295 = int32(1)
	goto L1
L3:
	;
...
L6:
	;
	v23 = *(*int32)(unsafe.Add(mBase, _consts[235]))
...
L7:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11))) = v59
	v62 = *(*int32)(unsafe.Add(mBase, _consts[250]))
...
L67:
	;
	v268 = *(*int32)(unsafe.Add(mBase, _consts[85]))
	*(*int32)(unsafe.Add(mBase, _consts[86])) = v268
	goto L70
L68:
	;
	goto L69
...
L70:
	;
	v274 = F_format_elog_string(m, int32(676765), int32(0))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L5
...
L71:
	;
	*(*int32)(unsafe.Add(mBase, _consts[87])) = v274
	F_pfree(m, v257)
	mBase = m.M
	v278 = m.ExcPending
	if v278 != 0 {
...
L28:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v17)+32)) = v105
	v108 = *(*float64)(unsafe.Add(mBase, _consts[392]))
	v110 = *(*float64)(unsafe.Add(mBase, _consts[393]))
	v112 = *(*float64)(unsafe.Add(mBase, _consts[382]))
	v114 = int32(*(*uint8)(unsafe.Add(mBase, _consts[394])))
...
L33:
	;
	F_errmsg_internal(m, int32(463518), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L34:
	;
	F_errfinish(m, int32(525341), int32(2118), int32(338224))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
...
func F_create_sort_path(m *base.Module, l0 int32, l1 int32, l2 int32, l3 float64) int32 {
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+24)) = v30
		...
		v41 = *(*int32)(unsafe.Add(mBase, _consts[21]))
		v43 = m.G0
		v44 = int32(16)
		v45 = v43 - v44
		m.G0 = v45
		...
		*(*float64)(unsafe.Add(mBase, uint32(v8)+32)) = v36
		v53 = int32(*(*uint8)(unsafe.Add(mBase, _consts[395])))
