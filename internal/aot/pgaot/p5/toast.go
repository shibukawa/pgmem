									...
									if v39 != 0 {
										...
										if v50 != 0 {
											...
											if v337 != 0 {
												...
												F_errmsg_internal(m, int32(599225), int32(0))
												mBase = m.M
												v341 = m.ExcPending
												if v341 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(475089), int32(193), int32(373242))
													mBase = m.M
													v346 = m.ExcPending
													if v346 != 0 {
														return int32(0)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v15)+48)) = v19
											v58 = F_pg_snprintf(m, v15+int32(224), int32(64), int32(36044), v15+int32(48))
											mBase = m.M
											v59 = m.ExcPending
											if v59 != 0 {
												return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v19
												v67 = F_pg_snprintf(m, v15+int32(160), int32(64), int32(25906), v15+int32(32))
												mBase = m.M
												v68 = m.ExcPending
												if v68 != 0 {
													return int32(0)
													...
													if v72 != 0 {
														...
														F_TupleDescInitEntry(m, v71, int32(1), int32(415567), int32(26), int32(-1), int32(0))
														mBase = m.M
														v79 = m.ExcPending
														if v79 != 0 {
															return int32(0)
														} else {
															F_TupleDescInitEntry(m, v71, int32(2), int32(219507), int32(23), int32(-1), int32(0))
															mBase = m.M
															v86 = m.ExcPending
															if v86 != 0 {
																return int32(0)
															} else {
																F_TupleDescInitEntry(m, v71, int32(3), int32(480841), int32(17), int32(-1), int32(0))
																mBase = m.M
																v93 = m.ExcPending
																if v93 != 0 {
																	return int32(0)
																												...
																												if v252 == int32(0) {
																													...
																													if v350 != 0 {
																														...
																														*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v19
																														F_errmsg_internal(m, int32(43821), v15+int32(16))
																														mBase = m.M
																														v356 = m.ExcPending
																														if v356 != 0 {
																															return int32(0)
																														} else {
																															F_errfinish(m, int32(475089), int32(342), int32(373242))
																															mBase = m.M
																															v361 = m.ExcPending
																															if v361 != 0 {
																																return int32(0)
																													...
																													if v281 == int32(0) {
																														...
																														if v365 != 0 {
																															...
																															*(*int32)(unsafe.Add(mBase, uint32(v15))) = v19
																															F_errmsg_internal(m, int32(43821), v15)
																															mBase = m.M
																															v369 = m.ExcPending
																															if v369 != 0 {
																																return int32(0)
																															} else {
																																F_errfinish(m, int32(475089), int32(362), int32(373242))
																																mBase = m.M
																																v374 = m.ExcPending
																																if v374 != 0 {
																																	return int32(0)
...
func F_toast_fetch_datum_slice(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v9 != int32(1) {
		...
		if v69 != 0 {
			...
			F_errmsg_internal(m, int32(140949), int32(0))
			mBase = m.M
			v73 = m.ExcPending
			if v73 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(470013), int32(405), int32(398367))
				mBase = m.M
				v78 = m.ExcPending
				if v78 != 0 {
					return int32(0)
