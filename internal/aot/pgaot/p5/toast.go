									...
									if v39 != 0 {
										...
										if v50 != 0 {
											...
											if v337 != 0 {
												...
												F_errmsg_internal(m, int32(639632), int32(0))
												mBase = m.M
												v341 = m.ExcPending
												if v341 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(497909), int32(193), int32(391845))
													mBase = m.M
													v346 = m.ExcPending
													if v346 != 0 {
														return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v19
												...
												if v68 != 0 {
													...
													if v72 != 0 {
														...
														F_TupleDescInitEntry(m, v71, int32(1), int32(435973), int32(26), int32(-1), int32(0))
														mBase = m.M
														v79 = m.ExcPending
														if v79 != 0 {
															return int32(0)
														} else {
															F_TupleDescInitEntry(m, v71, int32(2), int32(230789), int32(23), int32(-1), int32(0))
															mBase = m.M
															v86 = m.ExcPending
															if v86 != 0 {
																return int32(0)
															} else {
																F_TupleDescInitEntry(m, v71, int32(3), int32(503845), int32(17), int32(-1), int32(0))
																mBase = m.M
																v93 = m.ExcPending
																if v93 != 0 {
																	return int32(0)
																													...
																													if v350 != 0 {
																														...
																														*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v19
																														...
																														if v356 != 0 {
																															...
																															F_errfinish(m, int32(497909), int32(342), int32(391845))
																															mBase = m.M
																															v361 = m.ExcPending
																															if v361 != 0 {
																																return int32(0)
																														...
																														if v365 != 0 {
																															...
																															*(*int32)(unsafe.Add(mBase, uint32(v15))) = v19
																															...
																															if v369 != 0 {
																																...
																																F_errfinish(m, int32(497909), int32(362), int32(391845))
																																mBase = m.M
																																v374 = m.ExcPending
																																if v374 != 0 {
																																	return int32(0)
...
func F_toast_fetch_datum_slice(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v9 != int32(1) {
		...
		if v69 != 0 {
			...
			F_errmsg_internal(m, int32(150432), int32(0))
			mBase = m.M
			v73 = m.ExcPending
			if v73 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(492531), int32(405), int32(418030))
				mBase = m.M
				v78 = m.ExcPending
				if v78 != 0 {
					return int32(0)
