...
func F_create_toast_table(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32) int32 {
	...
	if v18 != 0 {
		...
		if v21 == int32(0) {
				...
				if v27 == int32(1) {
					...
					if v31 != 0 {
						...
						if base.Ui32(v32) < base.Ui32(int32(12000)) {
							v36 = *(*int32)(unsafe.Add(mBase, _consts[232]))
							if v36 != 0 {
								v326 = v8
								m.G0 = v15 + int32(304)
								return v326
									...
									if v39 != 0 {
										...
										if v50 != 0 {
											...
											if v337 != 0 {
												...
												F_errmsg_internal(m, int32(666846), int32(0))
												mBase = m.M
												v341 = m.ExcPending
												if v341 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(521002), int32(193), int32(409583))
													mBase = m.M
													v346 = m.ExcPending
													if v346 != 0 {
														return int32(0)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v15)+48)) = v19
											v58 = F_pg_snprintf(m, v15+int32(224), int32(64), int32(39883), v15+int32(48))
											mBase = m.M
											v59 = m.ExcPending
											if v59 != 0 {
												return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v19
												v67 = F_pg_snprintf(m, v15+int32(160), int32(64), int32(28609), v15+int32(32))
												mBase = m.M
												v68 = m.ExcPending
												if v68 != 0 {
													return int32(0)
													...
													if v72 != 0 {
														...
														F_TupleDescInitEntry(m, v71, int32(1), int32(455765), int32(26), int32(-1), int32(0))
														mBase = m.M
														v79 = m.ExcPending
														if v79 != 0 {
															return int32(0)
														} else {
															F_TupleDescInitEntry(m, v71, int32(2), int32(241791), int32(23), int32(-1), int32(0))
															mBase = m.M
															v86 = m.ExcPending
															if v86 != 0 {
																return int32(0)
															} else {
																F_TupleDescInitEntry(m, v71, int32(3), int32(527785), int32(17), int32(-1), int32(0))
																mBase = m.M
																v93 = m.ExcPending
																if v93 != 0 {
																	return int32(0)
																	...
																	*(*uint8)(unsafe.Add(mBase, uint32(v107)+105)) = uint8(v108)
																	...
																	v120 = *(*int32)(unsafe.Add(mBase, _consts[247]))
																	if v120 != 0 {
																		v121 = int32(1)
																		if v116 == v120 {
																			v128 = v121
																		} else {
																			v124 = *(*int32)(unsafe.Add(mBase, _consts[221]))
																			if v124 == v116 {
																				v128 = v121
																			} else {
																				v128 = int32(0)
																	...
																	if v128 != 0 {
																		v130 = *(*int32)(unsafe.Add(mBase, _consts[221]))
																		v131 = v130
																	} else {
																		v131 = int32(99)
																	}
																							...
																							if v240 != 0 {
																								...
																								if v243 != 0 {
																									...
																									if v247 != 0 {
																										...
																										v249 = *(*int32)(unsafe.Add(mBase, _consts[232]))
																										if v249 != 0 {
																												...
																												if v252 == int32(0) {
																													...
																													if v350 != 0 {
																														...
																														*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v19
																														F_errmsg_internal(m, int32(49777), v15+int32(16))
																														mBase = m.M
																														v356 = m.ExcPending
																														if v356 != 0 {
																															return int32(0)
																														} else {
																															F_errfinish(m, int32(521002), int32(342), int32(409583))
																															mBase = m.M
																															v361 = m.ExcPending
																															if v361 != 0 {
																																return int32(0)
																													...
																													if v264 != 0 {
																														...
																														if v296 != 0 {
																															...
																															if v299 != 0 {
																																...
																																v301 = *(*int32)(unsafe.Add(mBase, _consts[232]))
																																if v301 != 0 {
																																	v302 = int32(0)
																													...
																													if v281 == int32(0) {
																														...
																														if v365 != 0 {
																															...
																															*(*int32)(unsafe.Add(mBase, uint32(v15))) = v19
																															F_errmsg_internal(m, int32(49777), v15)
																															mBase = m.M
																															v369 = m.ExcPending
																															if v369 != 0 {
																																return int32(0)
																															} else {
																																F_errfinish(m, int32(521002), int32(362), int32(409583))
																																mBase = m.M
																																v374 = m.ExcPending
																																if v374 != 0 {
																																	return int32(0)
			...
			v44 = *(*int32)(unsafe.Add(mBase, _consts[259]))
			if v44 == int32(0) {
				v326 = v8
				m.G0 = v15 + int32(304)
				return v326
...
func F_toast_fetch_datum_slice(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v9 != int32(1) {
		...
		if v69 != 0 {
			...
			F_errmsg_internal(m, int32(159278), int32(0))
			mBase = m.M
			v73 = m.ExcPending
			if v73 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(514267), int32(405), int32(437290))
				mBase = m.M
				v78 = m.ExcPending
				if v78 != 0 {
					return int32(0)
