				...
				*(*int32)(unsafe.Add(mBase, uint32(v32))) = v31
				...
				if v35 != int32(1) {
					...
					if v41 != 0 {
						...
						F_errmsg_internal(m, int32(92021), int32(0))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return
						} else {
							F_errfinish(m, int32(520199), int32(5608), int32(242340))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return
			...
			if v25 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
				...
				if v29 != 0 {
					...
					F_errfinish(m, int32(524185), int32(683), int32(82427))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v37
	v43 = F_pg_snprintf(m, v34, int32(1024), int32(598374), v14+int32(16))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L18:
	;
	v62 = F_logfile_open(m, v34, int32(533464), int32(0))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L21:
	...
	v75 = F_logfile_getname(m, v73, int32(34061))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
L24:
	;
	v79 = F_logfile_open(m, v75, int32(533464), int32(0))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L1
...
L27:
	...
	v94 = F_logfile_getname(m, v92, int32(258117))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
...
L30:
	;
	v98 = F_logfile_open(m, v94, int32(533464), int32(0))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L1
...
L39:
	;
	F_errmsg(m, int32(308156), int32(0))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L1
...
L40:
	;
	F_errfinish(m, int32(519940), int32(711), int32(89311))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L1
...
L50:
	;
	F_errfinish(m, int32(519940), int32(732), int32(89311))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L1
...
L66:
	;
	F_errmsg(m, int32(308500), int32(0))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L1
...
L67:
	;
	F_errfinish(m, int32(519940), int32(626), int32(89311))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L1
...
L70:
	;
	F_errmsg(m, int32(306858), int32(0))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L71:
	;
	F_errfinish(m, int32(519940), int32(739), int32(89311))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(519940), int32(744), int32(89311))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L1
...
L81:
	;
	F_errmsg_internal(m, int32(235025), int32(0))
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L1
...
L82:
	;
	F_errfinish(m, int32(519676), int32(4012), int32(235074))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L1
