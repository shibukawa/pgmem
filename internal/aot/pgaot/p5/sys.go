				...
				*(*int32)(unsafe.Add(mBase, uint32(v32))) = v31
				...
				if v35 != int32(1) {
					...
					if v41 != 0 {
						...
						F_errmsg_internal(m, int32(80339), int32(0))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return
						} else {
							F_errfinish(m, int32(465349), int32(5608), int32(216586))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return
			...
			if v25 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
				...
				if v29 != 0 {
					...
					F_errfinish(m, int32(468530), int32(683), int32(72109))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v37
	v43 = F_pg_snprintf(m, v34, int32(1024), int32(522299), v14+int32(16))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L35:
	;
	v118 = F_logfile_open(m, v34, int32(475808), int32(0))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L1
...
L38:
	...
	v131 = F_logfile_getname(m, v129, int32(29852))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L1
...
L41:
	;
	v135 = F_logfile_open(m, v131, int32(475808), int32(0))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L44:
	...
	v150 = F_logfile_getname(m, v148, int32(229911))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L1
...
L47:
	;
	v154 = F_logfile_open(m, v150, int32(475808), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L56:
	;
	F_errmsg(m, int32(275663), int32(0))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L1
...
L57:
	;
	F_errfinish(m, int32(465107), int32(711), int32(77931))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L63:
	;
	F_errmsg(m, int32(118265), int32(0))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L1
...
L67:
	;
	F_errfinish(m, int32(465107), int32(732), int32(77931))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L1
...
L83:
	;
	F_errmsg(m, int32(276007), int32(0))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L84:
	;
	F_errfinish(m, int32(465107), int32(626), int32(77931))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L1
...
L87:
	;
	F_errmsg(m, int32(274365), int32(0))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L1
...
L88:
	;
	F_errfinish(m, int32(465107), int32(739), int32(77931))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L1
...
L91:
	;
	F_errmsg(m, int32(275517), int32(0))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L1
...
L92:
	;
	F_errfinish(m, int32(465107), int32(744), int32(77931))
	mBase = m.M
	v305 = m.ExcPending
	if v305 != 0 {
		goto L1
...
L98:
	;
	F_errmsg_internal(m, int32(210592), int32(0))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(464843), int32(4012), int32(210641))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L1
