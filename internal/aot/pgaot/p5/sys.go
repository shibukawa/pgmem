				...
				*(*int32)(unsafe.Add(mBase, uint32(v32))) = v31
				...
				if v35 != int32(1) {
					...
					if v41 != 0 {
						...
						F_errmsg_internal(m, int32(81291), int32(0))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return
						} else {
							F_errfinish(m, int32(472584), int32(5608), int32(219011))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return
...
func F_GetSysCacheOid(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	v16 = *(*int32)(unsafe.Add(mBase, uint32(v13)+uint32(_consts[1144])))
	...
	if v20 != 0 {
		...
		if v17 == int32(0) {
			...
			v25 = *(*int32)(unsafe.Add(mBase, uint32(v13)+uint32(_consts[1144])))
...
func F_SearchSysCacheList(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(84)) {
		v18 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1144])))
		if v18 != 0 {
			...
			if v25 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
				...
				if v29 != 0 {
					...
					F_errfinish(m, int32(475805), int32(683), int32(72774))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return int32(0)
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _consts[457])) = v8
	if v8 != 0 {
		goto L3
	} else {
		goto L4
...
L6:
	;
	v307 = *(*int32)(unsafe.Add(mBase, _consts[457]))
...
L14:
	...
	v30 = F___time(m)
	mBase = m.M
	*(*int64)(unsafe.Add(mBase, _consts[460])) = v30
...
L15:
	;
	v37 = *(*int32)(unsafe.Add(mBase, _consts[459]))
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v37
	v43 = F_pg_snprintf(m, v34, int32(1024), int32(530505), v14+int32(16))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L17:
	;
	v106 = *(*int32)(unsafe.Add(mBase, _consts[461]))
...
L35:
	;
	v118 = F_logfile_open(m, v34, int32(483649), int32(0))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L1
...
L36:
	;
	*(*int32)(unsafe.Add(mBase, _consts[462])) = v118
	F_pfree(m, v34)
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
...
L37:
	;
	v124 = *(*int32)(unsafe.Add(mBase, _consts[463]))
	if v124&int32(8) != 0 {
		goto L38
	} else {
		goto L39
...
L38:
	;
	v129 = *(*int64)(unsafe.Add(mBase, _consts[460]))
	v131 = F_logfile_getname(m, v129, int32(30275))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L1
...
L41:
	;
	v135 = F_logfile_open(m, v131, int32(483649), int32(0))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _consts[464])) = v135
	F_pfree(m, v131)
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
...
L43:
	;
	v141 = *(*int32)(unsafe.Add(mBase, _consts[463]))
	v143 = v141
	goto L40
L44:
	;
	v148 = *(*int64)(unsafe.Add(mBase, _consts[460]))
	v150 = F_logfile_getname(m, v148, int32(232844))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L1
...
L47:
	;
	v154 = F_logfile_open(m, v150, int32(483649), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L48:
	;
	*(*int32)(unsafe.Add(mBase, _consts[465])) = v154
	F_pfree(m, v150)
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
...
L54:
	;
	v185 = int32(*(*uint8)(unsafe.Add(mBase, _consts[466])))
	if v185 == int32(0) {
		goto L59
	} else {
		goto L60
...
L56:
	;
	F_errmsg(m, int32(279037), int32(0))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L1
...
L57:
	;
	F_errfinish(m, int32(472342), int32(711), int32(78646))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L61:
	;
	v237 = *(*int32)(unsafe.Add(mBase, _consts[462]))
...
L63:
	;
	F_errmsg(m, int32(119555), int32(0))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L1
...
L66:
	;
	v197 = *(*int32)(unsafe.Add(mBase, _consts[459]))
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v197
	F_errhint(m, int32(623000), v14)
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L1
...
L67:
	;
	F_errfinish(m, int32(472342), int32(732), int32(78646))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L1
...
L69:
	;
	v212 = *(*int32)(unsafe.Add(mBase, _consts[467]))
...
L70:
	;
	v218 = *(*int32)(unsafe.Add(mBase, _consts[468]))
...
L71:
	;
	v222 = *(*int32)(unsafe.Add(mBase, _consts[467]))
...
L72:
	;
	v227 = int32(4062080)
	v228 = *(*int32)(unsafe.Add(mBase, _consts[467]))
	v229 = F_close(m, v228)
	mBase = m.M
	v231 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[466])) = uint8(v231)
	*(*int32)(unsafe.Add(mBase, _consts[467])) = int32(-1)
	goto L61
L73:
	;
	*(*int32)(unsafe.Add(mBase, _consts[462])) = int32(0)
	v244 = *(*int32)(unsafe.Add(mBase, _consts[464]))
	if v244 != 0 {
		goto L74
	} else {
		goto L75
...
L76:
	;
	v251 = *(*int32)(unsafe.Add(mBase, _consts[465]))
	if v251 != 0 {
		goto L78
	} else {
		goto L79
...
L83:
	;
	F_errmsg(m, int32(279381), int32(0))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L84:
	;
	F_errfinish(m, int32(472342), int32(626), int32(78646))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L1
...
L87:
	;
	F_errmsg(m, int32(277739), int32(0))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L1
...
L88:
	;
	F_errfinish(m, int32(472342), int32(739), int32(78646))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L1
...
L91:
	;
	F_errmsg(m, int32(278891), int32(0))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L1
...
L92:
	;
	F_errfinish(m, int32(472342), int32(744), int32(78646))
	mBase = m.M
	v305 = m.ExcPending
	if v305 != 0 {
		goto L1
...
L98:
	;
	F_errmsg_internal(m, int32(212811), int32(0))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(472078), int32(4012), int32(212860))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L1
