				...
				*(*int32)(unsafe.Add(mBase, uint32(v32))) = v31
				...
				if v35 != int32(1) {
					...
					if v41 != 0 {
						...
						F_errmsg_internal(m, int32(84077), int32(0))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return
						} else {
							F_errfinish(m, int32(484609), int32(5608), int32(225579))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return
...
func F_GetSysCacheOid(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	v16 = *(*int32)(unsafe.Add(mBase, uint32(v13)+uint32(_consts[1141])))
	...
	if v20 != 0 {
		...
		if v17 == int32(0) {
			...
			v25 = *(*int32)(unsafe.Add(mBase, uint32(v13)+uint32(_consts[1141])))
...
func F_SearchSysCacheCopyAttNum(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v22
	v3 = int32(0)
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1142]))
...
func F_SearchSysCacheList(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(84)) {
		v18 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1141])))
		if v18 != 0 {
			...
			if v25 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
				...
				if v29 != 0 {
					...
					F_errfinish(m, int32(487962), int32(683), int32(74869))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v37
	v43 = F_pg_snprintf(m, v34, int32(1024), int32(542799), v14+int32(16))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L35:
	;
	v118 = F_logfile_open(m, v34, int32(495881), int32(0))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L1
...
L38:
	...
	v131 = F_logfile_getname(m, v129, int32(31670))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L1
...
L41:
	;
	v135 = F_logfile_open(m, v131, int32(495881), int32(0))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L44:
	...
	v150 = F_logfile_getname(m, v148, int32(239952))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L1
...
L47:
	;
	v154 = F_logfile_open(m, v150, int32(495881), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L56:
	;
	F_errmsg(m, int32(287325), int32(0))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L1
...
L57:
	;
	F_errfinish(m, int32(484362), int32(711), int32(81399))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L63:
	;
	F_errmsg(m, int32(125565), int32(0))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L1
...
L67:
	;
	F_errfinish(m, int32(484362), int32(732), int32(81399))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L1
...
L83:
	;
	F_errmsg(m, int32(287669), int32(0))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L84:
	;
	F_errfinish(m, int32(484362), int32(626), int32(81399))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L1
...
L87:
	;
	F_errmsg(m, int32(286027), int32(0))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L1
...
L88:
	;
	F_errfinish(m, int32(484362), int32(739), int32(81399))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L1
...
L91:
	;
	F_errmsg(m, int32(287179), int32(0))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L1
...
L92:
	;
	F_errfinish(m, int32(484362), int32(744), int32(81399))
	mBase = m.M
	v305 = m.ExcPending
	if v305 != 0 {
		goto L1
...
L98:
	;
	F_errmsg_internal(m, int32(219379), int32(0))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(484098), int32(4012), int32(219428))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L1
