...
L6:
	;
	v307 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[0]))
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v37
	v43 = F_pg_snprintf(m, v34, int32(1024), int32(_a_F_StartSysLogger_1), v14+int32(16))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L17:
	;
	v106 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[5]))
	v110 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[6]))
...
L35:
	;
	v118 = F_logfile_open(m, v34, int32(_a_F_StartSysLogger_2), int32(0))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L1
...
L36:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[7])) = v118
	F_pfree(m, v34)
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
...
L37:
	;
	v124 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[8]))
	if v124&int32(8) != 0 {
		goto L38
	} else {
		goto L39
...
L38:
	;
	v129 = *(*int64)(unsafe.Add(mBase, _c_F_StartSysLogger[4]))
	v131 = F_logfile_getname(m, v129, int32(_a_F_StartSysLogger_3))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L1
...
L41:
	;
	v135 = F_logfile_open(m, v131, int32(_a_F_StartSysLogger_2), int32(0))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[9])) = v135
	F_pfree(m, v131)
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
...
L43:
	;
	v141 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[8]))
	v143 = v141
	goto L40
L44:
	;
	v148 = *(*int64)(unsafe.Add(mBase, _c_F_StartSysLogger[4]))
	v150 = F_logfile_getname(m, v148, int32(_a_F_StartSysLogger_4))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L1
...
L47:
	;
	v154 = F_logfile_open(m, v150, int32(_a_F_StartSysLogger_2), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L48:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[10])) = v154
	F_pfree(m, v150)
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
...
L54:
	;
	v185 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_StartSysLogger[11])))
	if v185 == int32(0) {
		goto L59
	} else {
		goto L60
...
L56:
	;
	F_errmsg(m, int32(_a_F_StartSysLogger_5), int32(0))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L1
...
L57:
	;
	F_errfinish(m, int32(_a_F_StartSysLogger_6), int32(711), int32(_a_F_StartSysLogger_7))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L61:
	;
	v237 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[7]))
...
L65:
	;
	v208 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[12]))
...
L66:
	;
	v197 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[2]))
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v197
	F_errhint(m, int32(_a_F_StartSysLogger_9), v14)
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L1
...
L67:
	;
	F_errfinish(m, int32(_a_F_StartSysLogger_6), int32(732), int32(_a_F_StartSysLogger_7))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L1
...
L69:
	;
	v212 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[13]))
...
L70:
	;
	v218 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[14]))
...
L71:
	;
	v222 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[13]))
...
L72:
	;
	v227 = int32(_a_F_StartSysLogger_10)
	v228 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[13]))
	v229 = F_close(m, v228)
	mBase = m.M
	v231 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_StartSysLogger[11])) = uint8(v231)
	*(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[13])) = int32(-1)
	goto L61
L73:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[7])) = int32(0)
	v244 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[9]))
	if v244 != 0 {
		goto L74
	} else {
		goto L75
...
L76:
	;
	v251 = *(*int32)(unsafe.Add(mBase, _c_F_StartSysLogger[10]))
	if v251 != 0 {
		goto L78
	} else {
		goto L79
...
L84:
	;
	F_errfinish(m, int32(_a_F_StartSysLogger_6), int32(626), int32(_a_F_StartSysLogger_7))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L1
...
L88:
	;
	F_errfinish(m, int32(_a_F_StartSysLogger_6), int32(739), int32(_a_F_StartSysLogger_7))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L1
...
L91:
	;
	F_errmsg(m, int32(_a_F_StartSysLogger_13), int32(0))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L1
...
L92:
	;
	F_errfinish(m, int32(_a_F_StartSysLogger_6), int32(744), int32(_a_F_StartSysLogger_7))
	mBase = m.M
	v305 = m.ExcPending
	if v305 != 0 {
		goto L1
