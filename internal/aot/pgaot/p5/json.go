					...
					if l2 == int32(1114) {
									...
									if v458 != 0 {
										...
										if v461 != 0 {
											...
											if v465 != 0 {
												...
												F_errfinish(m, int32(474626), int32(375), int32(359364))
												mBase = m.M
												v470 = m.ExcPending
												if v470 != 0 {
													return int32(0)
						...
						if v210 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = l2
							F_errmsg_internal(m, int32(51715), v10)
							mBase = m.M
							v214 = m.ExcPending
							if v214 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(474626), int32(418), int32(359364))
								mBase = m.M
								v219 = m.ExcPending
								if v219 != 0 {
									return int32(0)
								...
								if v192 != 0 {
									...
									if v195 != 0 {
										...
										if v199 != 0 {
											...
											F_errfinish(m, int32(474626), int32(414), int32(359364))
											mBase = m.M
											v204 = m.ExcPending
											if v204 != 0 {
												return int32(0)
...
func F_JsonTableSetDocument(m *base.Module, l0 int32, l1 int32) {
	...
	var v8 int32
	_ = v8
	v4 = F_GetJsonTableExecContext(m, l0, int32(89179))
	mBase = m.M
	v5 = m.ExcPending
	if v5 != 0 {
		return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16)+4)) = v18
				...
				case 2:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v160 - v161
					F_appendStringInfo(m, v159, int32(607022), v9+int32(32))
					mBase = m.M
					v169 = m.ExcPending
					if v169 != 0 {
						return int32(0)
						...
						if v174 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
							F_appendStringInfo(m, v173, int32(464028), v9)
							mBase = m.M
							v178 = m.ExcPending
							if v178 != 0 {
								return int32(0)
				...
				case 3:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = v38
					F_appendStringInfo(m, v36, int32(610198), v9+int32(48))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
				...
				case 4:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+80)) = v57 - v58
					F_appendStringInfo(m, v56, int32(624494), v9+int32(80))
					mBase = m.M
					v66 = m.ExcPending
					if v66 != 0 {
						return int32(0)
				...
				case 5:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+96)) = v68 - v69
					F_appendStringInfo(m, v67, int32(624543), v9+int32(96))
					mBase = m.M
					v77 = m.ExcPending
					if v77 != 0 {
						return int32(0)
				...
				case 6:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+112)) = v79 - v80
					F_appendStringInfo(m, v78, int32(624582), v9+int32(112))
					mBase = m.M
					v88 = m.ExcPending
					if v88 != 0 {
						return int32(0)
				...
				case 7:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = v46 - v47
					F_appendStringInfo(m, v45, int32(624298), v9-int32(-64))
					mBase = m.M
					v55 = m.ExcPending
					if v55 != 0 {
						return int32(0)
				...
				case 8:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+128)) = v90 - v91
					F_appendStringInfo(m, v89, int32(624374), v9+int32(128))
					mBase = m.M
					v99 = m.ExcPending
					if v99 != 0 {
						return int32(0)
				...
				case 10:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+144)) = v102 - v103
					F_appendStringInfo(m, v101, int32(624413), v9+int32(144))
					mBase = m.M
					v111 = m.ExcPending
					if v111 != 0 {
						return int32(0)
				...
				case 11:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+160)) = v113 - v114
					F_appendStringInfo(m, v112, int32(624455), v9+int32(160))
					mBase = m.M
					v122 = m.ExcPending
					if v122 != 0 {
						return int32(0)
				...
				case 12:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+176)) = v124 - v125
					F_appendStringInfo(m, v123, int32(624339), v9+int32(176))
					mBase = m.M
					v133 = m.ExcPending
					if v133 != 0 {
						return int32(0)
				...
				case 13:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+192)) = v135 - v136
					F_appendStringInfo(m, v134, int32(607058), v9+int32(192))
					mBase = m.M
					v144 = m.ExcPending
					if v144 != 0 {
						return int32(0)
				...
				case 18:
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v150
					v155 = F_psprintf(m, int32(566506), v9+int32(16))
					mBase = m.M
					v156 = m.ExcPending
					if v156 != 0 {
						return int32(0)
...
func F_json_manifest_array_start(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(78480)
		m.T0[v13].(func(*base.Module, int32, int32, int32))(m, v12, int32(189661), v6)
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int32(0)
...
func F_json_manifest_object_start(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(78538)
		m.T0[v24].(func(*base.Module, int32, int32, int32))(m, v23, int32(189661), v6)
		mBase = m.M
		v31 = m.ExcPending
		if v31 != 0 {
			return int32(0)
	...
	if v26 != 0 {
		...
		if l1 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7)+172)) = int32(1321)
			v62 = F_hash_create(m, int32(374245), int32(32), v7+int32(144), int32(1224))
			mBase = m.M
			v63 = m.ExcPending
			if v63 != 0 {
				return int32(0)
								...
								if v102 != 0 {
									...
									if v105 != 0 {
										...
										if v109 != 0 {
											...
											F_errfinish(m, int32(474626), int32(1850), int32(340854))
											mBase = m.M
											v114 = m.ExcPending
											if v114 != 0 {
												return int32(0)
								...
								if v75 != 0 {
									...
									if v78 != 0 {
										...
										if v81 != 0 {
											...
											F_errmsg(m, int32(152777), int32(0))
											mBase = m.M
											v85 = m.ExcPending
											if v85 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(473546), int32(4102), int32(312086))
												mBase = m.M
												v90 = m.ExcPending
												if v90 != 0 {
													return int32(0)
