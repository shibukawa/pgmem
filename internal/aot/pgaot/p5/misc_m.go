...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v54))) = v51
	F_errmsg_internal(m, int32(504861), v54)
	mBase = m.M
	v881 = m.ExcPending
	if v881 != 0 {
		goto L101
...
L150:
	;
	F_errfinish(m, int32(520601), int32(372), int32(338330))
	mBase = m.M
	v886 = m.ExcPending
	if v886 != 0 {
		goto L101
	...
	if v10 == int32(16) {
		...
		default:
			...
			if v18 != 0 {
				...
				F_errmsg_internal(m, int32(97519), int32(0))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return
				} else {
					F_errfinish(m, int32(515702), int32(680), int32(97710))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
		...
		if l2 == v10 {
							...
							if v44 != v46 {
								...
								if v106 != 0 {
									...
									if v110 != 0 {
										...
										F_errfinish(m, int32(515702), int32(704), int32(97710))
										mBase = m.M
										v115 = m.ExcPending
										if v115 != 0 {
											return
			...
			if v10&int32(1) != 0 {
				...
				if v93 != 0 {
					...
					F_errmsg_internal(m, int32(97556), int32(0))
					mBase = m.M
					v97 = m.ExcPending
					if v97 != 0 {
						return
					} else {
						F_errfinish(m, int32(515702), int32(696), int32(97710))
						mBase = m.M
						v102 = m.ExcPending
						if v102 != 0 {
							return
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v5)+5)) = uint8(v45)
				...
				if v18 != 0 {
					...
					if v21 != 0 {
						...
						F_errmsg(m, int32(240420), int32(0))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return int32(0)
						} else {
							F_errhint(m, int32(637914), int32(0))
							mBase = m.M
							v29 = m.ExcPending
							if v29 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(524463), int32(559), int32(240249))
								mBase = m.M
								v34 = m.ExcPending
								if v34 != 0 {
									return int32(0)
		...
		if v16 == int32(16) {
			...
			if v19 == int32(1) {
				...
				if v52 != 0 {
					...
					if v55 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(556354)
						F_errmsg(m, int32(113934), v9)
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
							...
							if v62 != 0 {
								...
								F_errfinish(m, int32(517992), int32(3103), int32(246530))
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return int32(0)
			...
			if v31 != 0 {
				...
				if v34 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(556354)
					F_errmsg(m, int32(297079), v9+int32(16))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
						...
						if v43 != 0 {
							...
							F_errfinish(m, int32(517992), int32(3097), int32(246530))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return int32(0)
...
L42:
	;
	v84 = int32(1)
	v87 = F_varstr_cmp(m, v83, v84, int32(27607), v84, l2)
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L10
...
L46:
	;
	v92 = int32(1)
	v95 = F_varstr_cmp(m, v91, v92, int32(579625), v92, l2)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L10
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v68
	F_errmsg_internal(m, int32(219942), v20)
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L8
...
L40:
	;
	F_errfinish(m, int32(516005), int32(273), int32(245719))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L8
...
L45:
	;
	F_errmsg(m, int32(534418), int32(0))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L35
...
L46:
	;
	F_errdetail(m, int32(625289), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L35
...
L47:
	;
	F_errfinish(m, int32(518401), int32(6323), int32(33194))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L35
...
L50:
	;
	F_errmsg(m, int32(534318), int32(0))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L35
...
L51:
	;
	F_errdetail(m, int32(625234), int32(0))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L35
...
L52:
	;
	F_errfinish(m, int32(518401), int32(6328), int32(33194))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L35
					...
					if v26 == int32(0) {
						...
						if v128 != 0 {
							...
							if v131 != 0 {
								...
								F_errmsg(m, int32(433432), int32(0))
								mBase = m.M
								v135 = m.ExcPending
								if v135 != 0 {
									return int32(0)
									...
									if v137 != 0 {
										...
										F_errfinish(m, int32(518377), int32(804), int32(246415))
										mBase = m.M
										v142 = m.ExcPending
										if v142 != 0 {
											return int32(0)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v15))) = v152
											...
											if v157 != 0 {
												...
												if v159 != 0 {
													...
													F_errfinish(m, int32(518377), int32(819), int32(246415))
													mBase = m.M
													v164 = m.ExcPending
													if v164 != 0 {
														return int32(0)
										...
										if v63 != int32(16) {
											...
											if v168 != 0 {
												...
												if v171 != 0 {
													...
													F_errmsg(m, int32(297025), int32(0))
													mBase = m.M
													v175 = m.ExcPending
													if v175 != 0 {
														return int32(0)
														...
														if v177 != 0 {
															...
															F_errfinish(m, int32(518377), int32(845), int32(246415))
															mBase = m.M
															v182 = m.ExcPending
															if v182 != 0 {
																return int32(0)
														...
														if v189 != 0 {
															...
															if v193 != 0 {
																...
																if v195 != 0 {
																	...
																	F_errfinish(m, int32(518377), int32(850), int32(246415))
																	mBase = m.M
																	v200 = m.ExcPending
																	if v200 != 0 {
																		return int32(0)
																		...
																		if v207 != 0 {
																			...
																			if v210 != 0 {
																				...
																				*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v209
																				F_errmsg(m, int32(203636), v13+int32(-48))
																				mBase = m.M
																				v216 = m.ExcPending
																				if v216 != 0 {
																					return int32(0)
																					...
																					if v218 != 0 {
																						...
																						F_errfinish(m, int32(518377), int32(871), int32(246415))
																						mBase = m.M
																						v223 = m.ExcPending
																						if v223 != 0 {
																							return int32(0)
						...
						if v31 < int32(0) {
							...
							if v107 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v114
								F_errmsg(m, int32(313154), v11+int32(16))
								mBase = m.M
								v120 = m.ExcPending
								if v120 != 0 {
									return
									...
									if v124 != 0 {
										...
										F_errfinish(m, int32(523278), int32(519), int32(445373))
										mBase = m.M
										v129 = m.ExcPending
										if v129 != 0 {
											return
							...
							if v43 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v50
								F_errmsg(m, int32(51698), v11+int32(32))
								mBase = m.M
								v60 = m.ExcPending
								if v60 != 0 {
									return
									...
									if v64 != 0 {
										...
										F_errfinish(m, int32(523278), int32(526), int32(445373))
										mBase = m.M
										v69 = m.ExcPending
										if v69 != 0 {
											return
			...
			if v84 != 0 {
				...
				if v92 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(48)
					F_errmsg(m, int32(163297), v11)
					mBase = m.M
					v100 = m.ExcPending
					if v100 != 0 {
						return
					} else {
						F_errfinish(m, int32(523278), int32(504), int32(445373))
						mBase = m.M
						v105 = m.ExcPending
						if v105 != 0 {
							return
...
func F_mdinit(m *base.Module) {
	...
	v8 = F_AllocSetContextCreateInternal(m, v3, int32(224446), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
...
L20:
	;
	F_errfinish(m, int32(523278), int32(1255), int32(163118))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
							...
							if v54 != 0 {
								...
								if v56 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(8)
									F_errmsg(m, int32(312266), v9)
									mBase = m.M
									v62 = m.ExcPending
									if v62 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(523278), int32(686), int32(329686))
										mBase = m.M
										v67 = m.ExcPending
										if v67 != 0 {
											return int32(0)
...
L29:
	;
	F_errmsg(m, int32(174784), int32(0))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L27
...
L30:
	;
	F_errfinish(m, int32(521189), int32(211), int32(103406))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L27
...
L349:
	;
	F_errmsg_internal(m, int32(596758), int32(0))
	mBase = m.M
	v940 = m.ExcPending
	if v940 != 0 {
		goto L6
...
L350:
	;
	F_errfinish(m, int32(521490), int32(368), int32(390208))
	mBase = m.M
	v945 = m.ExcPending
	if v945 != 0 {
		goto L6
...
L353:
	;
	F_errmsg(m, int32(346203), int32(0))
	mBase = m.M
	v956 = m.ExcPending
	if v956 != 0 {
		goto L6
...
L354:
	;
	F_errfinish(m, int32(521490), int32(287), int32(390209))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L6
...
L357:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(255)
	F_errmsg(m, int32(168978), v13+int32(16))
	mBase = m.M
	v975 = m.ExcPending
	if v975 != 0 {
		goto L6
...
L358:
	;
	F_errfinish(m, int32(521490), int32(282), int32(390209))
	mBase = m.M
	v980 = m.ExcPending
	if v980 != 0 {
		goto L6
...
L362:
	;
	F_errfinish(m, int32(521490), int32(275), int32(390209))
	mBase = m.M
	v997 = m.ExcPending
	if v997 != 0 {
		goto L6
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v309
	v315 = F_pg_sprintf(m, v304, int32(187537), v21)
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L28
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v345
	v353 = F_pg_sprintf(m, v340, int32(186074), v21+int32(16))
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
		goto L28
...
func F_multixactmemberssyncfiletag(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_SlruSyncFileTag(m, int32(4449028), l0, l1)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
