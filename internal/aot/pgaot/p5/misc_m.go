...
L4:
	;
	v27 = int32(4562080)
	v28 = *(*int32)(unsafe.Add(mBase, _consts[10]))
...
L27:
	;
	v101 = int32(4562080)
	v102 = *(*int32)(unsafe.Add(mBase, _consts[10]))
	v104 = *(*int32)(unsafe.Add(mBase, uint32(v15)+20))
	*(*int32)(unsafe.Add(mBase, _consts[10])) = v104
...
L28:
	;
	*(*int32)(unsafe.Add(mBase, _consts[10])) = v102
...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v54))) = v51
	F_errmsg_internal(m, int32(506228), v54)
	mBase = m.M
	v881 = m.ExcPending
	if v881 != 0 {
		goto L101
...
L150:
	;
	F_errfinish(m, int32(521983), int32(372), int32(339172))
	mBase = m.M
	v886 = m.ExcPending
	if v886 != 0 {
		goto L101
	...
	if v10 == int32(16) {
		...
		default:
			...
			if v18 != 0 {
				...
				F_errmsg_internal(m, int32(97595), int32(0))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return
				} else {
					F_errfinish(m, int32(517084), int32(680), int32(97786))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
		...
		if l2 == v10 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = l2
					...
					if l2 == v41 {
						if l3 != 0 {
							...
							v46 = *(*int32)(unsafe.Add(mBase, _consts[449]))
							if v44 != v46 {
								F_errstart_cold(m, int32(21), int32(0))
								mBase = m.M
								v106 = m.ExcPending
								if v106 != 0 {
									...
									F_errmsg_internal(m, int32(137770), int32(0))
									mBase = m.M
									v110 = m.ExcPending
									if v110 != 0 {
										return
									} else {
										F_errfinish(m, int32(517084), int32(704), int32(97786))
										mBase = m.M
										v115 = m.ExcPending
										if v115 != 0 {
											return
			...
			if v10&int32(1) != 0 {
				...
				if v93 != 0 {
					...
					F_errmsg_internal(m, int32(97632), int32(0))
					mBase = m.M
					v97 = m.ExcPending
					if v97 != 0 {
						return
					} else {
						F_errfinish(m, int32(517084), int32(696), int32(97786))
						mBase = m.M
						v102 = m.ExcPending
						if v102 != 0 {
							return
	...
	if base.Ui32(int32(2147483647)) <= base.Ui32(l0) {
		*(*int32)(unsafe.Add(mBase, _consts[85])) = int32(48)
		...
		if l1&int32(32) != 0 {
			...
			if v191 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v220)+4)) = l0
				v228 = int32(4735240)
				v229 = *(*int32)(unsafe.Add(mBase, _consts[1501]))
				*(*int32)(unsafe.Add(mBase, uint32(v220)+36)) = v229
				*(*int32)(unsafe.Add(mBase, _consts[1501])) = v220
		...
		if base.Ui32(int32(-4095)) <= base.Ui32(v244) {
			*(*int32)(unsafe.Add(mBase, _consts[85])) = int32(0) - v244
			v252 = int32(-1)
		} else {
			v252 = v244
		}
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v5)+5)) = uint8(v45)
				...
				if v18 != 0 {
					...
					if v21 != 0 {
						...
						F_errmsg(m, int32(240966), int32(0))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return int32(0)
						} else {
							F_errhint(m, int32(639354), int32(0))
							mBase = m.M
							v29 = m.ExcPending
							if v29 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(525872), int32(559), int32(240795))
								mBase = m.M
								v34 = m.ExcPending
								if v34 != 0 {
									return int32(0)
		...
		if v16 == int32(16) {
			...
			if v19 == int32(1) {
				...
				if v52 != 0 {
					...
					if v55 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(557763)
						F_errmsg(m, int32(114096), v9)
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
							...
							if v62 != 0 {
								...
								F_errfinish(m, int32(519374), int32(3103), int32(247076))
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return int32(0)
			...
			if v31 != 0 {
				...
				if v34 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(557763)
					F_errmsg(m, int32(297744), v9+int32(16))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
						...
						if v43 != 0 {
							...
							F_errfinish(m, int32(519374), int32(3097), int32(247076))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return int32(0)
...
L2:
	;
	v168 = *(*int32)(unsafe.Add(mBase, _consts[247]))
...
L22:
	;
	v68 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1069])))
	if v68 != 0 {
		goto L35
	} else {
		goto L36
...
L35:
	;
	v70 = *(*int32)(unsafe.Add(mBase, _consts[1070]))
	if v70 == l2 {
		goto L34
	} else {
		goto L38
...
L42:
	;
	v84 = int32(1)
	v87 = F_varstr_cmp(m, v83, v84, int32(27640), v84, l2)
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L10
...
L46:
	;
	v92 = int32(1)
	v95 = F_varstr_cmp(m, v91, v92, int32(581034), v92, l2)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L10
...
L47:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1070])) = l2
...
L50:
	;
	*(*uint8)(unsafe.Add(mBase, _consts[1069])) = uint8(v104)
	goto L34
L51:
	;
...
L53:
	;
	v117 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1069])))
	v118 = v115 + v59
	v119 = int32(0)
...
L66:
	;
	v155 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1069])))
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v68
	F_errmsg_internal(m, int32(220366), v20)
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L8
...
L40:
	;
	F_errfinish(m, int32(517387), int32(273), int32(246265))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L8
...
L45:
	;
	F_errmsg(m, int32(535827), int32(0))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L35
...
L46:
	;
	F_errdetail(m, int32(626698), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L35
...
L47:
	;
	F_errfinish(m, int32(519783), int32(6323), int32(33270))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L35
...
L50:
	;
	F_errmsg(m, int32(535727), int32(0))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L35
...
L51:
	;
	F_errdetail(m, int32(626643), int32(0))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L35
...
L52:
	;
	F_errfinish(m, int32(519783), int32(6328), int32(33270))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L35
					...
					if v26 == int32(0) {
						...
						if v128 != 0 {
							...
							if v131 != 0 {
								...
								F_errmsg(m, int32(434321), int32(0))
								mBase = m.M
								v135 = m.ExcPending
								if v135 != 0 {
									return int32(0)
									...
									if v137 != 0 {
										...
										F_errfinish(m, int32(519759), int32(804), int32(246961))
										mBase = m.M
										v142 = m.ExcPending
										if v142 != 0 {
											return int32(0)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v15))) = v152
											...
											if v157 != 0 {
												...
												if v159 != 0 {
													...
													F_errfinish(m, int32(519759), int32(819), int32(246961))
													mBase = m.M
													v164 = m.ExcPending
													if v164 != 0 {
														return int32(0)
										...
										if v63 != int32(16) {
											...
											if v168 != 0 {
												...
												if v171 != 0 {
													...
													F_errmsg(m, int32(297690), int32(0))
													mBase = m.M
													v175 = m.ExcPending
													if v175 != 0 {
														return int32(0)
														...
														if v177 != 0 {
															...
															F_errfinish(m, int32(519759), int32(845), int32(246961))
															mBase = m.M
															v182 = m.ExcPending
															if v182 != 0 {
																return int32(0)
												...
												if v68 != 0 {
													...
													if v186 != 0 {
														...
														if v189 != 0 {
															...
															F_errmsg(m, int32(114344), int32(0))
															mBase = m.M
															v193 = m.ExcPending
															if v193 != 0 {
																return int32(0)
																...
																if v195 != 0 {
																	...
																	F_errfinish(m, int32(519759), int32(850), int32(246961))
																	mBase = m.M
																	v200 = m.ExcPending
																	if v200 != 0 {
																		return int32(0)
																		...
																		if v207 != 0 {
																			...
																			if v210 != 0 {
																				...
																				*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v209
																				F_errmsg(m, int32(204060), v13+int32(-48))
																				mBase = m.M
																				v216 = m.ExcPending
																				if v216 != 0 {
																					return int32(0)
																					...
																					if v218 != 0 {
																						...
																						F_errfinish(m, int32(519759), int32(871), int32(246961))
																						mBase = m.M
																						v223 = m.ExcPending
																						if v223 != 0 {
																							return int32(0)
					...
					if v38 != 0 {
						...
						if v31 < int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v114
								...
								if v120 != 0 {
									...
									if v124 != 0 {
										...
										F_errfinish(m, int32(524687), int32(519), int32(446262))
										mBase = m.M
										v129 = m.ExcPending
										if v129 != 0 {
											return
							...
							if v43 != 0 {
								...
								v46 = *(*int32)(unsafe.Add(mBase, _consts[550]))
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v50
								F_errmsg(m, int32(51774), v11+int32(32))
								mBase = m.M
								v60 = m.ExcPending
								if v60 != 0 {
									return
									...
									if v64 != 0 {
										...
										F_errfinish(m, int32(524687), int32(526), int32(446262))
										mBase = m.M
										v69 = m.ExcPending
										if v69 != 0 {
											return
			...
			if v84 != 0 {
				...
				if v92 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(48)
					F_errmsg(m, int32(163618), v11)
					mBase = m.M
					v100 = m.ExcPending
					if v100 != 0 {
						return
					} else {
						F_errfinish(m, int32(524687), int32(504), int32(446262))
						mBase = m.M
						v105 = m.ExcPending
						if v105 != 0 {
							return
			...
			*(*int32)(unsafe.Add(mBase, uint32(l3))) = l2 << (uint(int32(13)) % 32) & int32(1073733632)
			...
			if v21 != 0 {
				...
				if v20 < int32(0) {
					...
					v26 = *(*int32)(unsafe.Add(mBase, _consts[550]))
...
func F_mdinit(m *base.Module) {
	...
	var v9 int32
	_ = v9
	v3 = *(*int32)(unsafe.Add(mBase, _consts[145]))
	v8 = F_AllocSetContextCreateInternal(m, v3, int32(224870), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
	} else {
		*(*int32)(unsafe.Add(mBase, _consts[786])) = v8
		return
	}
}
...
L20:
	;
	F_errfinish(m, int32(524687), int32(1255), int32(163420))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
...
func F_mdopenfork(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if int32(0) < v16 {
		...
		if v29 != 0 {
			...
			v35 = *(*int32)(unsafe.Add(mBase, _consts[623]))
			if v35&int32(1) != 0 {
				v38 = int32(16386)
			} else {
				v38 = int32(2)
			...
			if v40 != 0 {
				...
				if v39 < int32(0) {
					if l2&int32(2) != 0 {
						v47 = *(*int32)(unsafe.Add(mBase, _consts[85]))
						if v47 == int32(44) {
							v99 = int32(0)
							m.G0 = v9 + int32(80)
							return v99
							...
							if v54 != 0 {
								...
								if v56 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(8)
									F_errmsg(m, int32(313019), v9)
									mBase = m.M
									v62 = m.ExcPending
									if v62 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(524687), int32(686), int32(330528))
										mBase = m.M
										v67 = m.ExcPending
										if v67 != 0 {
											return int32(0)
					...
					if v68 == int32(0) {
						v75 = *(*int32)(unsafe.Add(mBase, _consts[786]))
...
L24:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _consts[786]))
...
L29:
	;
	F_errmsg(m, int32(175208), int32(0))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L27
...
L30:
	;
	F_errfinish(m, int32(522598), int32(211), int32(103568))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L27
...
L66:
	;
	v172 = int32(*(*int8)(unsafe.Add(mBase, uint32(v167)+uint32(_consts[1456]))))
	v174 = v172
	goto L60
L67:
	;
...
L349:
	;
	F_errmsg_internal(m, int32(598167), int32(0))
	mBase = m.M
	v940 = m.ExcPending
	if v940 != 0 {
		goto L6
...
L350:
	;
	F_errfinish(m, int32(522899), int32(368), int32(391097))
	mBase = m.M
	v945 = m.ExcPending
	if v945 != 0 {
		goto L6
...
L353:
	;
	F_errmsg(m, int32(347071), int32(0))
	mBase = m.M
	v956 = m.ExcPending
	if v956 != 0 {
		goto L6
...
L354:
	;
	F_errfinish(m, int32(522899), int32(287), int32(391098))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L6
...
L357:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(255)
	F_errmsg(m, int32(169402), v13+int32(16))
	mBase = m.M
	v975 = m.ExcPending
	if v975 != 0 {
		goto L6
...
L358:
	;
	F_errfinish(m, int32(522899), int32(282), int32(391098))
	mBase = m.M
	v980 = m.ExcPending
	if v980 != 0 {
		goto L6
...
L362:
	;
	F_errfinish(m, int32(522899), int32(275), int32(391098))
	mBase = m.M
	v997 = m.ExcPending
	if v997 != 0 {
		goto L6
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v309
	v315 = F_pg_sprintf(m, v304, int32(187961), v21)
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L28
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v345
	v353 = F_pg_sprintf(m, v340, int32(186498), v21+int32(16))
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
		goto L28
...
L37:
	;
	v197 = *(*int32)(unsafe.Add(mBase, _consts[45]))
	if v197 != 0 {
		goto L74
	} else {
		goto L75
...
func F_multixactmemberssyncfiletag(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_SlruSyncFileTag(m, int32(4456852), l0, l1)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
