...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v54))) = v51
	F_errmsg_internal(m, int32(480149), v54)
	mBase = m.M
	v881 = m.ExcPending
	if v881 != 0 {
		goto L101
...
L150:
	;
	F_errfinish(m, int32(493930), int32(372), int32(321210))
	mBase = m.M
	v886 = m.ExcPending
	if v886 != 0 {
		goto L101
		...
		default:
			...
			if v18 != 0 {
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(490160), int32(680), int32(90977))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
							...
							if v44 != v46 {
								...
								if v106 != 0 {
									...
									if v110 != 0 {
										...
										F_errfinish(m, int32(490160), int32(704), int32(90977))
										mBase = m.M
										v115 = m.ExcPending
										if v115 != 0 {
											return
			...
			if v10&int32(1) != 0 {
				...
				if v93 != 0 {
					...
					if v97 != 0 {
						...
						F_errfinish(m, int32(490160), int32(696), int32(90977))
						mBase = m.M
						v102 = m.ExcPending
						if v102 != 0 {
							return
		...
		if l1&int32(32) != 0 {
			...
			if v191 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v220)+4)) = l0
				v228 = int32(4651256)
				v229 = *(*int32)(unsafe.Add(mBase, _consts[1470]))
				*(*int32)(unsafe.Add(mBase, uint32(v220)+36)) = v229
				*(*int32)(unsafe.Add(mBase, _consts[1470])) = v220
					...
					if v21 != 0 {
						...
						if v25 != 0 {
							...
							if v29 != 0 {
								...
								F_errfinish(m, int32(497034), int32(559), int32(227805))
								mBase = m.M
								v34 = m.ExcPending
								if v34 != 0 {
									return int32(0)
		...
		if v16 == int32(16) {
			...
			if v19 == int32(1) {
				...
				if v52 != 0 {
					...
					if v55 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(528342)
						...
						if v60 != 0 {
							...
							if v62 != 0 {
								...
								F_errfinish(m, int32(491930), int32(3103), int32(233876))
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return int32(0)
			...
			if v31 != 0 {
				...
				if v34 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(528342)
					...
					if v41 != 0 {
						...
						if v43 != 0 {
							...
							F_errfinish(m, int32(491930), int32(3097), int32(233876))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return int32(0)
...
L46:
	;
	v92 = int32(1)
	v95 = F_varstr_cmp(m, v91, v92, int32(544439), v92, l2)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L10
...
L40:
	;
	F_errfinish(m, int32(490463), int32(273), int32(233065))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L8
...
L45:
	;
	F_errmsg(m, int32(506509), int32(0))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L35
...
L46:
	;
	F_errdetail(m, int32(580081), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L35
...
L47:
	;
	F_errfinish(m, int32(492209), int32(6323), int32(31697))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L35
...
L50:
	;
	F_errmsg(m, int32(506409), int32(0))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L35
...
L51:
	;
	F_errdetail(m, int32(580026), int32(0))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L35
...
L52:
	;
	F_errfinish(m, int32(492209), int32(6328), int32(31697))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L35
							...
							if v131 != 0 {
								...
								if v135 != 0 {
									...
									if v137 != 0 {
										...
										F_errfinish(m, int32(492185), int32(804), int32(233761))
										mBase = m.M
										v142 = m.ExcPending
										if v142 != 0 {
											return int32(0)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v15))) = v152
											...
											if v157 != 0 {
												...
												if v159 != 0 {
													...
													F_errfinish(m, int32(492185), int32(819), int32(233761))
													mBase = m.M
													v164 = m.ExcPending
													if v164 != 0 {
														return int32(0)
												...
												if v171 != 0 {
													...
													if v175 != 0 {
														...
														if v177 != 0 {
															...
															F_errfinish(m, int32(492185), int32(845), int32(233761))
															mBase = m.M
															v182 = m.ExcPending
															if v182 != 0 {
																return int32(0)
														...
														if v189 != 0 {
															...
															if v193 != 0 {
																...
																if v195 != 0 {
																	...
																	F_errfinish(m, int32(492185), int32(850), int32(233761))
																	mBase = m.M
																	v200 = m.ExcPending
																	if v200 != 0 {
																		return int32(0)
																				...
																				*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v209
																				...
																				if v216 != 0 {
																					...
																					if v218 != 0 {
																						...
																						F_errfinish(m, int32(492185), int32(871), int32(233761))
																						mBase = m.M
																						v223 = m.ExcPending
																						if v223 != 0 {
																							return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v114
								...
								if v120 != 0 {
									...
									if v124 != 0 {
										...
										F_errfinish(m, int32(496508), int32(519), int32(423085))
										mBase = m.M
										v129 = m.ExcPending
										if v129 != 0 {
											return
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v50
								...
								if v60 != 0 {
									...
									if v64 != 0 {
										...
										F_errfinish(m, int32(496508), int32(526), int32(423085))
										mBase = m.M
										v69 = m.ExcPending
										if v69 != 0 {
											return
				...
				if v92 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(48)
					...
					if v100 != 0 {
						...
						F_errfinish(m, int32(496508), int32(504), int32(423085))
						mBase = m.M
						v105 = m.ExcPending
						if v105 != 0 {
							return
...
L20:
	;
	F_errfinish(m, int32(496508), int32(1255), int32(152904))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
								...
								if v56 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(8)
									...
									if v62 != 0 {
										...
										F_errfinish(m, int32(496508), int32(686), int32(313235))
										mBase = m.M
										v67 = m.ExcPending
										if v67 != 0 {
											return int32(0)
...
L30:
	;
	F_errfinish(m, int32(494511), int32(211), int32(96476))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L27
...
L66:
	;
	v172 = int32(*(*int8)(unsafe.Add(mBase, uint32(v167)+uint32(_consts[1460]))))
	v174 = v172
	goto L60
L67:
	;
...
L349:
	;
	F_errmsg_internal(m, int32(552105), int32(0))
	mBase = m.M
	v940 = m.ExcPending
	if v940 != 0 {
		goto L6
...
L350:
	;
	F_errfinish(m, int32(494812), int32(368), int32(370392))
	mBase = m.M
	v945 = m.ExcPending
	if v945 != 0 {
		goto L6
...
L354:
	;
	F_errfinish(m, int32(494812), int32(287), int32(370393))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L6
...
L358:
	;
	F_errfinish(m, int32(494812), int32(282), int32(370393))
	mBase = m.M
	v980 = m.ExcPending
	if v980 != 0 {
		goto L6
...
L362:
	;
	F_errfinish(m, int32(494812), int32(275), int32(370393))
	mBase = m.M
	v997 = m.ExcPending
	if v997 != 0 {
		goto L6
...
func F_multixactmemberssyncfiletag(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_SlruSyncFileTag(m, int32(4381828), l0, l1)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
