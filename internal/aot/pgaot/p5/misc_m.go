...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v54))) = v51
	F_errmsg_internal(m, int32(474962), v54)
	mBase = m.M
	v881 = m.ExcPending
	if v881 != 0 {
		goto L101
...
L150:
	;
	F_errfinish(m, int32(488555), int32(372), int32(317716))
	mBase = m.M
	v886 = m.ExcPending
	if v886 != 0 {
		goto L101
	...
	if v10 == int32(16) {
		...
		default:
			...
			if v18 != 0 {
				...
				F_errmsg_internal(m, int32(89980), int32(0))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return
				} else {
					F_errfinish(m, int32(484822), int32(680), int32(90171))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
		...
		if l2 == v10 {
						...
						if l3 != 0 {
							...
							if v44 != v46 {
								...
								if v106 != 0 {
									...
									F_errmsg_internal(m, int32(127095), int32(0))
									mBase = m.M
									v110 = m.ExcPending
									if v110 != 0 {
										return
									} else {
										F_errfinish(m, int32(484822), int32(704), int32(90171))
										mBase = m.M
										v115 = m.ExcPending
										if v115 != 0 {
											return
			...
			if v10&int32(1) != 0 {
				...
				if v93 != 0 {
					...
					F_errmsg_internal(m, int32(90017), int32(0))
					mBase = m.M
					v97 = m.ExcPending
					if v97 != 0 {
						return
					} else {
						F_errfinish(m, int32(484822), int32(696), int32(90171))
						mBase = m.M
						v102 = m.ExcPending
						if v102 != 0 {
							return
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v5)+5)) = uint8(v45)
				...
				if v18 != 0 {
					...
					if v21 != 0 {
						...
						F_errmsg(m, int32(225564), int32(0))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return int32(0)
						} else {
							F_errhint(m, int32(585909), int32(0))
							mBase = m.M
							v29 = m.ExcPending
							if v29 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(491607), int32(559), int32(225393))
								mBase = m.M
								v34 = m.ExcPending
								if v34 != 0 {
									return int32(0)
		...
		if v16 == int32(16) {
			...
			if v19 == int32(1) {
				...
				if v52 != 0 {
					...
					if v55 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(522630)
						F_errmsg(m, int32(105089), v9)
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
							...
							if v62 != 0 {
								...
								F_errfinish(m, int32(486576), int32(3103), int32(231400))
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return int32(0)
			...
			if v31 != 0 {
				...
				if v34 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(522630)
					F_errmsg(m, int32(279481), v9+int32(16))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
						...
						if v43 != 0 {
							...
							F_errfinish(m, int32(486576), int32(3097), int32(231400))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return int32(0)
...
L22:
	;
	v124 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1078])))
	if v124 != 0 {
		goto L52
	} else {
		goto L53
...
L52:
	;
	v126 = *(*int32)(unsafe.Add(mBase, _consts[1079]))
	if v126 == l2 {
		goto L51
	} else {
		goto L55
...
L63:
	;
	v148 = int32(1)
	v151 = F_varstr_cmp(m, v147, v148, int32(538552), v148, l2)
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L10
...
L67:
	;
	*(*uint8)(unsafe.Add(mBase, _consts[1078])) = uint8(v160)
	goto L51
L68:
	;
...
L70:
	;
	v173 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1078])))
	v174 = v171 + v115
	v175 = int32(0)
...
L83:
	;
	v211 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1078])))
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v68
	F_errmsg_internal(m, int32(206090), v20)
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L8
...
L40:
	;
	F_errfinish(m, int32(485125), int32(273), int32(230622))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L8
...
L45:
	;
	F_errmsg(m, int32(500944), int32(0))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L35
...
L46:
	;
	F_errdetail(m, int32(573815), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L35
...
L47:
	;
	F_errfinish(m, int32(486855), int32(6323), int32(31261))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L35
...
L50:
	;
	F_errmsg(m, int32(500844), int32(0))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L35
...
L51:
	;
	F_errdetail(m, int32(573760), int32(0))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L35
...
L52:
	;
	F_errfinish(m, int32(486855), int32(6328), int32(31261))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L35
					...
					if v26 == int32(0) {
						...
						if v128 != 0 {
							...
							if v131 != 0 {
								...
								F_errmsg(m, int32(407467), int32(0))
								mBase = m.M
								v135 = m.ExcPending
								if v135 != 0 {
									return int32(0)
									...
									if v137 != 0 {
										...
										F_errfinish(m, int32(486831), int32(804), int32(231285))
										mBase = m.M
										v142 = m.ExcPending
										if v142 != 0 {
											return int32(0)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v15))) = v152
											...
											if v157 != 0 {
												...
												if v159 != 0 {
													...
													F_errfinish(m, int32(486831), int32(819), int32(231285))
													mBase = m.M
													v164 = m.ExcPending
													if v164 != 0 {
														return int32(0)
										...
										if v63 != int32(16) {
											...
											if v168 != 0 {
												...
												if v171 != 0 {
													...
													F_errmsg(m, int32(279427), int32(0))
													mBase = m.M
													v175 = m.ExcPending
													if v175 != 0 {
														return int32(0)
														...
														if v177 != 0 {
															...
															F_errfinish(m, int32(486831), int32(845), int32(231285))
															mBase = m.M
															v182 = m.ExcPending
															if v182 != 0 {
																return int32(0)
												...
												if v68 != 0 {
													...
													if v186 != 0 {
														...
														if v189 != 0 {
															...
															F_errmsg(m, int32(105337), int32(0))
															mBase = m.M
															v193 = m.ExcPending
															if v193 != 0 {
																return int32(0)
																...
																if v195 != 0 {
																	...
																	F_errfinish(m, int32(486831), int32(850), int32(231285))
																	mBase = m.M
																	v200 = m.ExcPending
																	if v200 != 0 {
																		return int32(0)
																		...
																		if v207 != 0 {
																			...
																			if v210 != 0 {
																				...
																				*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v209
																				F_errmsg(m, int32(190461), v13+int32(-48))
																				mBase = m.M
																				v216 = m.ExcPending
																				if v216 != 0 {
																					return int32(0)
																					...
																					if v218 != 0 {
																						...
																						F_errfinish(m, int32(486831), int32(871), int32(231285))
																						mBase = m.M
																						v223 = m.ExcPending
																						if v223 != 0 {
																							return int32(0)
						...
						if v31 < int32(0) {
							...
							if v107 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v114
								F_errmsg(m, int32(294687), v11+int32(16))
								mBase = m.M
								v120 = m.ExcPending
								if v120 != 0 {
									return
									...
									if v124 != 0 {
										...
										F_errfinish(m, int32(491093), int32(519), int32(418554))
										mBase = m.M
										v129 = m.ExcPending
										if v129 != 0 {
											return
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v50
								...
								if v60 != 0 {
									...
									if v64 != 0 {
										...
										F_errfinish(m, int32(491093), int32(526), int32(418554))
										mBase = m.M
										v69 = m.ExcPending
										if v69 != 0 {
											return
			...
			if v84 != 0 {
				...
				if v92 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(48)
					F_errmsg(m, int32(151385), v11)
					mBase = m.M
					v100 = m.ExcPending
					if v100 != 0 {
						return
					} else {
						F_errfinish(m, int32(491093), int32(504), int32(418554))
						mBase = m.M
						v105 = m.ExcPending
						if v105 != 0 {
							return
...
func F_mdinit(m *base.Module) {
	...
	v8 = F_AllocSetContextCreateInternal(m, v3, int32(210569), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
...
L20:
	;
	F_errfinish(m, int32(491093), int32(1255), int32(151206))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
							...
							if v54 != 0 {
								...
								if v56 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(8)
									F_errmsg(m, int32(293799), v9)
									mBase = m.M
									v62 = m.ExcPending
									if v62 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(491093), int32(686), int32(309822))
										mBase = m.M
										v67 = m.ExcPending
										if v67 != 0 {
											return int32(0)
...
L29:
	;
	F_errmsg(m, int32(162138), int32(0))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L27
...
L30:
	;
	F_errfinish(m, int32(489119), int32(211), int32(95436))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L27
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v421
	v427 = F_pg_sprintf(m, v416, int32(174436), v21)
	mBase = m.M
	v428 = m.ExcPending
	if v428 != 0 {
		goto L28
...
L109:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v457
	v465 = F_pg_sprintf(m, v452, int32(172973), v21+int32(16))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L28
...
func F_multixactmemberssyncfiletag(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_SlruSyncFileTag(m, int32(4365348), l0, l1)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
