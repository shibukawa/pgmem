...
L18:
	...
	v62 = *(*int32)(unsafe.Add(mBase, uint32(v57<<(uint(int32(2))%32))+uint32(_c_F_makepol[0])))
	v67 = v33
	goto L19
L19:
	;
	...
	v83 = *(*int32)(unsafe.Add(mBase, uint32(v78<<(uint(v75)%32))+uint32(_c_F_makepol[0])))
	if v57 != int32(1) {
		goto L22
	} else {
		goto L23
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v166
	F_errmsg(m, int32(_a_F_makepol_0), v15)
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L1
...
L50:
	;
	F_errsave_finish(m, v152, int32(_a_F_makepol_1), int32(714), int32(_a_F_makepol_2))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
...
L63:
	;
	F_errmsg_internal(m, int32(_a_F_makepol_3), int32(0))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L64:
	;
	F_errfinish(m, int32(_a_F_makepol_1), int32(639), int32(_a_F_makepol_4))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
