...
L3:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v9)+44)) = int32(241106)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = int32(519599)
...
L6:
	;
	v74 = int32(4164444)
	v75 = *(*int32)(unsafe.Add(mBase, _consts[603]))
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _consts[603])) = v92
	goto L12
L14:
	;
	if int32(999) < v75 {
