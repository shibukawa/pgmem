...
L3:
	...
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v22<<(uint(int32(2))%32))+uint32(_consts[709])))
	goto L4
L4:
	;
...
L5:
	;
	v258 = int32(0)
	v260 = *(*int32)(unsafe.Add(mBase, _consts[710]))
	if v258 < v260 {
		goto L65
	} else {
		goto L66
...
L28:
	;
	v101 = int32(0)
	v103 = *(*int32)(unsafe.Add(mBase, _consts[711]))
	v105 = *(*int32)(unsafe.Add(mBase, _consts[712]))
	if v101 < v105 {
		goto L29
	} else {
		goto L30
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, _consts[712])) = v105 + int32(1)
...
L39:
	;
	*(*int32)(unsafe.Add(mBase, _consts[713])) = v42
	v200 = int32(1)
	goto L25
L40:
	;
...
L56:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _consts[714]))
...
L60:
	;
	*(*int32)(unsafe.Add(mBase, _consts[715])) = v60
	goto L10
L61:
	;
	goto L9
...
L63:
	;
	v666 = *(*int32)(unsafe.Add(mBase, _consts[714]))
...
L65:
	;
	v264 = *(*int32)(unsafe.Add(mBase, _consts[716]))
	v270 = v258
	goto L68
L66:
	;
...
L96:
	;
	v384 = int32(0)
	v386 = *(*int32)(unsafe.Add(mBase, _consts[711]))
	v388 = *(*int32)(unsafe.Add(mBase, _consts[712]))
	if v384 < v388 {
		goto L97
	} else {
		goto L98
...
L99:
	;
	*(*int32)(unsafe.Add(mBase, _consts[712])) = v388 + int32(1)
...
L107:
	;
	*(*int32)(unsafe.Add(mBase, _consts[713])) = v353
	v483 = int32(1)
	goto L93
L108:
	;
...
L130:
	;
	v632 = *(*int32)(unsafe.Add(mBase, _consts[714]))
...
L142:
	;
	v528 = int32(0)
	v530 = *(*int32)(unsafe.Add(mBase, _consts[711]))
	v532 = *(*int32)(unsafe.Add(mBase, _consts[712]))
	if v528 < v532 {
		goto L143
	} else {
		goto L144
...
L145:
	;
	*(*int32)(unsafe.Add(mBase, _consts[712])) = v532 + int32(1)
...
L153:
	;
	*(*int32)(unsafe.Add(mBase, _consts[713])) = v494
	v627 = int32(1)
	goto L139
L154:
	;
...
func F_FloatExceptionHandler(m *base.Module, l0 int32) {
	...
	if v5 != 0 {
		...
		if v8 != 0 {
			...
			F_errmsg(m, int32(235415), int32(0))
			v12 = m.ExcPending
			if v12 != 0 {
				return
			} else {
				F_errdetail(m, int32(571664), int32(0))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
					F_errfinish(m, int32(471277), int32(3188), int32(209202))
					v21 = m.ExcPending
					if v21 != 0 {
						return
					} else {
	...
	if v29 != 0 {
		...
		if v28 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
			F_errmsg_internal(m, int32(660303), v7)
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return
...
func F_FreeDesc(m *base.Module, l0 int32) int32 {
	...
	case 0:
		...
		if v35 != 0 {
			...
			v41 = v39 - int32(1)
			*(*int32)(unsafe.Add(mBase, _consts[649])) = v41
			v44 = *(*int32)(unsafe.Add(mBase, _consts[650]))
	...
	default:
		...
		if v23 != 0 {
			...
			F_errmsg_internal(m, int32(417013), int32(0))
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(476611), int32(2829), int32(466307))
				mBase = m.M
				v32 = m.ExcPending
				if v32 != 0 {
					return int32(0)
...
func F_FreeSpaceMapVacuum(m *base.Module, l0 int32) {
	...
	v5 = v3 - int32(16)
	m.G0 = v5
	v8 = *(*int64)(unsafe.Add(mBase, _consts[655]))
...
L110:
	;
	F_errfinish(m, int32(476407), int32(1289), int32(150739))
	mBase = m.M
	v644 = m.ExcPending
	if v644 != 0 {
		goto L1
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(208651)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(471299), int32(369), int32(63840))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v38
	F_errmsg_internal(m, int32(458546), v10)
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L4
...
L23:
	;
	F_errfinish(m, int32(476378), int32(3196), int32(22394))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v66
	F_errmsg_internal(m, int32(464732), v10+int32(16))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L33:
	;
	F_errfinish(m, int32(476378), int32(3218), int32(22394))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L4
...
func F_find_option(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+8)) = l0
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1287]))
...
L2:
	;
	v477 = *(*int32)(unsafe.Add(mBase, uint32(v463<<(uint(int32(2))%32))+uint32(_consts[1288])))
...
L136:
	...
	v370 = *(*int32)(unsafe.Add(mBase, _consts[1289]))
...
L164:
	;
	F_errfinish(m, int32(476640), int32(1279), int32(234230))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L8
...
L21:
	;
	F_errhint(m, int32(572000), int32(0))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L22:
	;
	F_errfinish(m, int32(471646), int32(7120), int32(158645))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L44:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v14)+40)) = base.F64_promote_f32(v60)
	v139 = int32(0)
	v143 = F_psprintf(m, int32(399921), v14+int32(32))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L3
...
L53:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v14)+16)) = base.F64_abs(v163)
	v169 = F_psprintf(m, int32(323410), v14+int32(16))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L3
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v238
	v242 = F_psprintf(m, int32(323415), v14)
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L3
...
L16:
	;
	F_errsave_finish(m, l4, int32(470688), int32(414), int32(296037))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L12
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v469
	F_errmsg(m, int32(259265), v13+int32(-48))
	mBase = m.M
	v488 = m.ExcPending
	if v488 != 0 {
		goto L12
...
L155:
	;
	F_errsave_finish(m, l4, int32(470688), int32(490), int32(296037))
	mBase = m.M
	v493 = m.ExcPending
	if v493 != 0 {
		goto L12
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = l2
	F_errmsg(m, int32(683524), v13+int32(-32))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L12
...
L160:
	;
	F_errsave_finish(m, l4, int32(470688), int32(497), int32(296037))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L12
...
L176:
	;
	F_errsave_finish(m, l4, int32(470688), int32(511), int32(296037))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L12
...
L7:
	;
	v13 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1327])))
	if v13 != 0 {
		goto L8
	} else {
		goto L9
...
L24:
	;
	v64 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1328])))
	if v64 != 0 {
		goto L25
	} else {
		goto L26
...
L39:
	;
	v113 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1329])))
	if v113 != 0 {
		goto L40
	} else {
		goto L41
		...
		if v25 != 0 {
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(1664)
				F_errmsg(m, int32(157792), v6)
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return
				} else {
					F_errfinish(m, int32(476347), int32(83), int32(334544))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return
...
func F_fsm_get_avail(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v6 int32
	_ = v6
	v6 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+l1)+uint32(_consts[656]))))
	return v6
}
...
L47:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v14)+8)) = v172
	F_errmsg_internal(m, int32(36263), v14)
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L45
...
L50:
	;
	F_errfinish(m, int32(476211), int32(277), int32(290650))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L45
...
func F_fsync_fname(m *base.Module, l0 int32, l1 int32) {
	...
	var v10 int32
	_ = v10
	v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[648])))
	if v7 != 0 {
		v8 = int32(21)
	} else {
		v8 = int32(23)
