...
L3:
	...
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v22<<(uint(int32(2))%32))+uint32(_consts[707])))
	goto L4
L4:
	;
...
L5:
	;
	v258 = int32(0)
	v260 = *(*int32)(unsafe.Add(mBase, _consts[708]))
	if v258 < v260 {
		goto L65
	} else {
		goto L66
...
L28:
	;
	v101 = int32(0)
	v103 = *(*int32)(unsafe.Add(mBase, _consts[709]))
	v105 = *(*int32)(unsafe.Add(mBase, _consts[710]))
	if v101 < v105 {
		goto L29
	} else {
		goto L30
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, _consts[710])) = v105 + int32(1)
...
L39:
	;
	*(*int32)(unsafe.Add(mBase, _consts[711])) = v42
	v200 = int32(1)
	goto L25
L40:
	;
...
L56:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _consts[712]))
...
L58:
	;
	v217 = *(*int32)(unsafe.Add(mBase, _consts[295]))
	if l0 != v217 {
		goto L10
	} else {
		goto L59
...
L60:
	;
	*(*int32)(unsafe.Add(mBase, _consts[713])) = v60
	goto L10
L61:
	;
	goto L9
...
L63:
	;
	v666 = *(*int32)(unsafe.Add(mBase, _consts[712]))
...
L65:
	;
	v264 = *(*int32)(unsafe.Add(mBase, _consts[714]))
	v270 = v258
	goto L68
L66:
	;
...
L96:
	;
	v384 = int32(0)
	v386 = *(*int32)(unsafe.Add(mBase, _consts[709]))
	v388 = *(*int32)(unsafe.Add(mBase, _consts[710]))
	if v384 < v388 {
		goto L97
	} else {
		goto L98
...
L99:
	;
	*(*int32)(unsafe.Add(mBase, _consts[710])) = v388 + int32(1)
...
L107:
	;
	*(*int32)(unsafe.Add(mBase, _consts[711])) = v353
	v483 = int32(1)
	goto L93
L108:
	;
...
L130:
	;
	v632 = *(*int32)(unsafe.Add(mBase, _consts[712]))
...
L142:
	;
	v528 = int32(0)
	v530 = *(*int32)(unsafe.Add(mBase, _consts[709]))
	v532 = *(*int32)(unsafe.Add(mBase, _consts[710]))
	if v528 < v532 {
		goto L143
	} else {
		goto L144
...
L145:
	;
	*(*int32)(unsafe.Add(mBase, _consts[710])) = v532 + int32(1)
...
L153:
	;
	*(*int32)(unsafe.Add(mBase, _consts[711])) = v494
	v627 = int32(1)
	goto L139
L154:
	;
...
func F_FloatExceptionHandler(m *base.Module, l0 int32) {
	...
	if v5 != 0 {
		...
		if v8 != 0 {
			...
			F_errmsg(m, int32(247863), int32(0))
			v12 = m.ExcPending
			if v12 != 0 {
				return
			} else {
				F_errdetail(m, int32(612354), int32(0))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
					F_errfinish(m, int32(494252), int32(3188), int32(219907))
					v21 = m.ExcPending
					if v21 != 0 {
						return
					} else {
	...
	if v29 != 0 {
		...
		if v28 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
			F_errmsg_internal(m, int32(701960), v7)
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return
			} else {
				F_errfinish(m, int32(495550), int32(449), int32(221207))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
...
func F_FreeDesc(m *base.Module, l0 int32) int32 {
	...
	case 0:
		...
		if v35 != 0 {
			...
			v41 = v39 - int32(1)
			*(*int32)(unsafe.Add(mBase, _consts[647])) = v41
			v44 = *(*int32)(unsafe.Add(mBase, _consts[648]))
	...
	default:
		...
		if v23 != 0 {
			...
			F_errmsg_internal(m, int32(437817), int32(0))
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(499883), int32(2829), int32(488803))
				mBase = m.M
				v32 = m.ExcPending
				if v32 != 0 {
					return int32(0)
...
func F_FreeSpaceMapVacuum(m *base.Module, l0 int32) {
	...
	v5 = v3 - int32(16)
	m.G0 = v5
	v8 = *(*int64)(unsafe.Add(mBase, _consts[653]))
...
L110:
	;
	F_errfinish(m, int32(499672), int32(1289), int32(160649))
	mBase = m.M
	v644 = m.ExcPending
	if v644 != 0 {
		goto L1
...
func F_fdw_handler_out(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(219322)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(494274), int32(369), int32(66915))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v38
	F_errmsg_internal(m, int32(480828), v10)
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L4
...
L23:
	;
	F_errfinish(m, int32(499643), int32(3196), int32(24054))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v66
	F_errmsg_internal(m, int32(487182), v10+int32(16))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L33:
	;
	F_errfinish(m, int32(499643), int32(3218), int32(24054))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L4
...
func F_find_option(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+8)) = l0
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1284]))
...
L2:
	;
	v477 = *(*int32)(unsafe.Add(mBase, uint32(v463<<(uint(int32(2))%32))+uint32(_consts[1285])))
...
L136:
	...
	v370 = *(*int32)(unsafe.Add(mBase, _consts[1286]))
...
L164:
	;
	F_errfinish(m, int32(499912), int32(1279), int32(246678))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L8
...
L21:
	;
	F_errhint(m, int32(612690), int32(0))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L22:
	;
	F_errfinish(m, int32(494621), int32(7120), int32(168555))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
						...
						if v73&int32(16384) != 0 {
							if base.B2i32(base.Ui32(v16&int32(2147483647)) <= base.Ui32(int32(2139095040)))&base.F32_ne(base.F32_abs(v60), math.Float32frombits(uint32(0x7f800000))) == int32(0) {
								...
								*(*float64)(unsafe.Add(mBase, uint32(v14)+40)) = base.F64_promote_f32(v60)
								v139 = int32(0)
								v143 = F_psprintf(m, int32(420044), v14+int32(32))
								mBase = m.M
								v144 = m.ExcPending
								if v144 != 0 {
									return int32(0)
							...
							*(*float64)(unsafe.Add(mBase, uint32(v14)+16)) = base.F64_abs(v163)
							v169 = F_psprintf(m, int32(340165), v14+int32(16))
							mBase = m.M
							v170 = m.ExcPending
							if v170 != 0 {
								return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v14))) = v182
								v186 = F_psprintf(m, int32(340170), v14)
								mBase = m.M
								v187 = m.ExcPending
								if v187 != 0 {
									return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = l1
	F_errmsg(m, int32(725181), v11+int32(-16))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L12
...
L16:
	;
	F_errsave_finish(m, l3, int32(493653), int32(208), int32(311530))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L12
...
L199:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v623
	F_errmsg(m, int32(314137), v11+int32(-48))
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		goto L12
...
L200:
	;
	F_errsave_finish(m, l3, int32(493653), int32(288), int32(311530))
	mBase = m.M
	v647 = m.ExcPending
	if v647 != 0 {
		goto L12
...
L205:
	;
	F_errsave_finish(m, l3, int32(493653), int32(295), int32(311530))
	mBase = m.M
	v667 = m.ExcPending
	if v667 != 0 {
		goto L12
...
L217:
	;
	F_errsave_finish(m, l3, int32(493653), int32(309), int32(311530))
	mBase = m.M
	v714 = m.ExcPending
	if v714 != 0 {
		goto L12
...
L16:
	;
	F_errsave_finish(m, l4, int32(493653), int32(414), int32(311512))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L12
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v469
	F_errmsg(m, int32(271900), v13+int32(-48))
	mBase = m.M
	v488 = m.ExcPending
	if v488 != 0 {
		goto L12
...
L155:
	;
	F_errsave_finish(m, l4, int32(493653), int32(490), int32(311512))
	mBase = m.M
	v493 = m.ExcPending
	if v493 != 0 {
		goto L12
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = l2
	F_errmsg(m, int32(725181), v13+int32(-32))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L12
...
L160:
	;
	F_errsave_finish(m, l4, int32(493653), int32(497), int32(311512))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L12
...
L176:
	;
	F_errsave_finish(m, l4, int32(493653), int32(511), int32(311512))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L12
...
L7:
	;
	v13 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1324])))
	if v13 != 0 {
		goto L8
	} else {
		goto L9
...
L24:
	;
	v64 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1325])))
	if v64 != 0 {
		goto L25
	} else {
		goto L26
...
L39:
	;
	v113 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1326])))
	if v113 != 0 {
		goto L40
	} else {
		goto L41
		...
		if v25 != 0 {
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(1664)
				F_errmsg(m, int32(167702), v6)
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return
				} else {
					F_errfinish(m, int32(499612), int32(83), int32(351603))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return
...
func F_fsm_get_avail(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v6 int32
	_ = v6
	v6 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0+l1)+uint32(_consts[654]))))
	return v6
}
...
L47:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v14)+8)) = v172
	F_errmsg_internal(m, int32(38733), v14)
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L45
...
L50:
	;
	F_errfinish(m, int32(499476), int32(277), int32(305622))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L45
...
func F_fsync_fname(m *base.Module, l0 int32, l1 int32) {
	...
	var v10 int32
	_ = v10
	v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[646])))
	if v7 != 0 {
		v8 = int32(21)
	} else {
		v8 = int32(23)
