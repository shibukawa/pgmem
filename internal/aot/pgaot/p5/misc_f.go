...
L3:
	...
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v22<<(uint(int32(2))%32))+uint32(_consts[697])))
	goto L4
L4:
	;
...
L5:
	;
	v258 = int32(0)
	v260 = *(*int32)(unsafe.Add(mBase, _consts[698]))
	if v258 < v260 {
		goto L65
	} else {
		goto L66
...
L28:
	;
	v101 = int32(0)
	v103 = *(*int32)(unsafe.Add(mBase, _consts[699]))
	v105 = *(*int32)(unsafe.Add(mBase, _consts[700]))
	if v101 < v105 {
		goto L29
	} else {
		goto L30
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, _consts[700])) = v105 + int32(1)
...
L39:
	;
	*(*int32)(unsafe.Add(mBase, _consts[701])) = v42
	v200 = int32(1)
	goto L25
L40:
	;
...
L56:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _consts[702]))
...
L60:
	;
	*(*int32)(unsafe.Add(mBase, _consts[703])) = v60
	goto L10
L61:
	;
	goto L9
...
L63:
	;
	v666 = *(*int32)(unsafe.Add(mBase, _consts[702]))
...
L65:
	;
	v264 = *(*int32)(unsafe.Add(mBase, _consts[704]))
	v270 = v258
	goto L68
L66:
	;
...
L96:
	;
	v384 = int32(0)
	v386 = *(*int32)(unsafe.Add(mBase, _consts[699]))
	v388 = *(*int32)(unsafe.Add(mBase, _consts[700]))
	if v384 < v388 {
		goto L97
	} else {
		goto L98
...
L99:
	;
	*(*int32)(unsafe.Add(mBase, _consts[700])) = v388 + int32(1)
...
L107:
	;
	*(*int32)(unsafe.Add(mBase, _consts[701])) = v353
	v483 = int32(1)
	goto L93
L108:
	;
...
L130:
	;
	v632 = *(*int32)(unsafe.Add(mBase, _consts[702]))
...
L142:
	;
	v528 = int32(0)
	v530 = *(*int32)(unsafe.Add(mBase, _consts[699]))
	v532 = *(*int32)(unsafe.Add(mBase, _consts[700]))
	if v528 < v532 {
		goto L143
	} else {
		goto L144
...
L145:
	;
	*(*int32)(unsafe.Add(mBase, _consts[700])) = v532 + int32(1)
...
L153:
	;
	*(*int32)(unsafe.Add(mBase, _consts[701])) = v494
	v627 = int32(1)
	goto L139
L154:
	;
	...
	if v29 != 0 {
		...
		if v28 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
			F_errmsg_internal(m, int32(734187), v7)
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return
			} else {
				F_errfinish(m, int32(518493), int32(449), int32(232077))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
...
func F_FreeDesc(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		if v23 != 0 {
			...
			F_errmsg_internal(m, int32(457924), int32(0))
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(523612), int32(2829), int32(510324))
				mBase = m.M
				v32 = m.ExcPending
				if v32 != 0 {
					return int32(0)
...
L110:
	;
	F_errfinish(m, int32(523136), int32(1289), int32(170185))
	mBase = m.M
	v644 = m.ExcPending
	if v644 != 0 {
		goto L1
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(230126)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(516993), int32(369), int32(72723))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L23:
	;
	F_errfinish(m, int32(523107), int32(3196), int32(24501))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v66
	F_errmsg_internal(m, int32(508703), v10+int32(16))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L33:
	;
	F_errfinish(m, int32(523107), int32(3218), int32(24501))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L4
...
L148:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v397)+12)) = int32(414719)
...
L156:
	;
	F_errfinish(m, int32(523641), int32(1060), int32(414432))
	mBase = m.M
	v433 = m.ExcPending
	if v433 != 0 {
		goto L8
...
L164:
	;
	F_errfinish(m, int32(523641), int32(1279), int32(258770))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L8
...
L21:
	;
	F_errhint(m, int32(639554), int32(0))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L22:
	;
	F_errfinish(m, int32(517363), int32(7120), int32(178492))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
						...
						if v73&int32(16384) != 0 {
							if base.B2i32(base.Ui32(v16&int32(2147483647)) <= base.Ui32(int32(2139095040)))&base.F32_ne(base.F32_abs(v60), math.Float32frombits(uint32(0x7f800000))) == int32(0) {
								...
								*(*float64)(unsafe.Add(mBase, uint32(v14)+40)) = base.F64_promote_f32(v60)
								v139 = int32(0)
								v143 = F_psprintf(m, int32(439595), v14+int32(32))
								mBase = m.M
								v144 = m.ExcPending
								if v144 != 0 {
									return int32(0)
							...
							*(*float64)(unsafe.Add(mBase, uint32(v14)+16)) = base.F64_abs(v163)
							v169 = F_psprintf(m, int32(356334), v14+int32(16))
							mBase = m.M
							v170 = m.ExcPending
							if v170 != 0 {
								return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v14))) = v182
								v186 = F_psprintf(m, int32(356339), v14)
								mBase = m.M
								v187 = m.ExcPending
								if v187 != 0 {
									return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = l1
	F_errmsg(m, int32(757762), v11+int32(-16))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L12
...
L16:
	;
	F_errsave_finish(m, l3, int32(515956), int32(208), int32(325808))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L12
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v465
	F_errmsg(m, int32(328577), v11+int32(-48))
	mBase = m.M
	v484 = m.ExcPending
	if v484 != 0 {
		goto L12
...
L155:
	;
	F_errsave_finish(m, l3, int32(515956), int32(288), int32(325808))
	mBase = m.M
	v489 = m.ExcPending
	if v489 != 0 {
		goto L12
...
L160:
	;
	F_errsave_finish(m, l3, int32(515956), int32(295), int32(325808))
	mBase = m.M
	v509 = m.ExcPending
	if v509 != 0 {
		goto L12
...
L172:
	;
	F_errsave_finish(m, l3, int32(515956), int32(309), int32(325808))
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L12
...
L16:
	;
	F_errsave_finish(m, l4, int32(515956), int32(414), int32(325790))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L12
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v469
	F_errmsg(m, int32(284515), v13+int32(-48))
	mBase = m.M
	v488 = m.ExcPending
	if v488 != 0 {
		goto L12
...
L155:
	;
	F_errsave_finish(m, l4, int32(515956), int32(490), int32(325790))
	mBase = m.M
	v493 = m.ExcPending
	if v493 != 0 {
		goto L12
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = l2
	F_errmsg(m, int32(757762), v13+int32(-32))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L12
...
L160:
	;
	F_errsave_finish(m, l4, int32(515956), int32(497), int32(325790))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L12
...
L176:
	;
	F_errsave_finish(m, l4, int32(515956), int32(511), int32(325790))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L12
		...
		if v25 != 0 {
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(1664)
				F_errmsg(m, int32(177639), v6)
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return
				} else {
					F_errfinish(m, int32(523076), int32(83), int32(368369))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return
...
L47:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v14)+8)) = v172
	F_errmsg_internal(m, int32(41433), v14)
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L45
...
L50:
	;
	F_errfinish(m, int32(522924), int32(277), int32(319493))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L45
