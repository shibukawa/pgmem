...
func F_FloatExceptionHandler(m *base.Module, l0 int32) {
	...
	if v5 != 0 {
		...
		if v8 != 0 {
			...
			F_errmsg(m, int32(236292), int32(0))
			v12 = m.ExcPending
			if v12 != 0 {
				return
			} else {
				F_errdetail(m, int32(573220), int32(0))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
					F_errfinish(m, int32(472649), int32(3188), int32(209722))
					v21 = m.ExcPending
					if v21 != 0 {
						return
					} else {
	...
	if v29 != 0 {
		...
		if v28 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
			F_errmsg_internal(m, int32(661886), v7)
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return
...
func F_FreeDesc(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		if v23 != 0 {
			...
			F_errmsg_internal(m, int32(418373), int32(0))
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(478009), int32(2829), int32(467667))
				mBase = m.M
				v32 = m.ExcPending
				if v32 != 0 {
					return int32(0)
...
L110:
	;
	F_errfinish(m, int32(477805), int32(1289), int32(151259))
	mBase = m.M
	v644 = m.ExcPending
	if v644 != 0 {
		goto L1
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(209171)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(472671), int32(369), int32(64032))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v38
	F_errmsg_internal(m, int32(459906), v10)
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L4
...
L23:
	;
	F_errfinish(m, int32(477776), int32(3196), int32(22512))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v66
	F_errmsg_internal(m, int32(466092), v10+int32(16))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L33:
	;
	F_errfinish(m, int32(477776), int32(3218), int32(22512))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L4
...
L148:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v397)+12)) = int32(378940)
...
L164:
	;
	F_errfinish(m, int32(478038), int32(1279), int32(235107))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L8
...
L21:
	;
	F_errhint(m, int32(573556), int32(0))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L22:
	;
	F_errfinish(m, int32(473018), int32(7120), int32(159165))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L44:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v14)+40)) = base.F64_promote_f32(v60)
	v139 = int32(0)
	v143 = F_psprintf(m, int32(401177), v14+int32(32))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L3
...
L53:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v14)+16)) = base.F64_abs(v163)
	v169 = F_psprintf(m, int32(324611), v14+int32(16))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L3
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v238
	v242 = F_psprintf(m, int32(324616), v14)
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L3
...
L16:
	;
	F_errsave_finish(m, l4, int32(472060), int32(414), int32(297219))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L12
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v469
	F_errmsg(m, int32(260142), v13+int32(-48))
	mBase = m.M
	v488 = m.ExcPending
	if v488 != 0 {
		goto L12
...
L155:
	;
	F_errsave_finish(m, l4, int32(472060), int32(490), int32(297219))
	mBase = m.M
	v493 = m.ExcPending
	if v493 != 0 {
		goto L12
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = l2
	F_errmsg(m, int32(685107), v13+int32(-32))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L12
...
L160:
	;
	F_errsave_finish(m, l4, int32(472060), int32(497), int32(297219))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L12
...
L176:
	;
	F_errsave_finish(m, l4, int32(472060), int32(511), int32(297219))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L12
		...
		if v25 != 0 {
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(1664)
				F_errmsg(m, int32(158312), v6)
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return
				} else {
					F_errfinish(m, int32(477745), int32(83), int32(335745))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return
...
L47:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v14)+8)) = v172
	F_errmsg_internal(m, int32(36423), v14)
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L45
...
L50:
	;
	F_errfinish(m, int32(477609), int32(277), int32(291832))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L45
