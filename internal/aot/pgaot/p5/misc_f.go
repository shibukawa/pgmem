	...
	if v29 != 0 {
		...
		if v28 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
			F_errmsg_internal(m, int32(735824), v7)
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return
...
func F_FreeDesc(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		if v23 != 0 {
			...
			F_errmsg_internal(m, int32(458909), int32(0))
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(525021), int32(2829), int32(511691))
				mBase = m.M
				v32 = m.ExcPending
				if v32 != 0 {
					return int32(0)
...
L110:
	;
	F_errfinish(m, int32(524545), int32(1289), int32(170609))
	mBase = m.M
	v644 = m.ExcPending
	if v644 != 0 {
		goto L1
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(230550)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(518375), int32(369), int32(72799))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v38
	F_errmsg_internal(m, int32(503716), v10)
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L4
...
L23:
	;
	F_errfinish(m, int32(524516), int32(3196), int32(24534))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v66
	F_errmsg_internal(m, int32(510070), v10+int32(16))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L33:
	;
	F_errfinish(m, int32(524516), int32(3218), int32(24534))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L4
...
L156:
	;
	F_errfinish(m, int32(525050), int32(1060), int32(415321))
	mBase = m.M
	v433 = m.ExcPending
	if v433 != 0 {
		goto L8
...
L164:
	;
	F_errfinish(m, int32(525050), int32(1279), int32(259349))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L8
...
L21:
	;
	F_errhint(m, int32(640994), int32(0))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L22:
	;
	F_errfinish(m, int32(518745), int32(7120), int32(178916))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
						...
						if v73&int32(16384) != 0 {
							if base.B2i32(base.Ui32(v16&int32(2147483647)) <= base.Ui32(int32(2139095040)))&base.F32_ne(base.F32_abs(v60), math.Float32frombits(uint32(0x7f800000))) == int32(0) {
								...
								*(*float64)(unsafe.Add(mBase, uint32(v14)+40)) = base.F64_promote_f32(v60)
								v139 = int32(0)
								v143 = F_psprintf(m, int32(440484), v14+int32(32))
								mBase = m.M
								v144 = m.ExcPending
								if v144 != 0 {
									return int32(0)
							...
							*(*float64)(unsafe.Add(mBase, uint32(v14)+16)) = base.F64_abs(v163)
							v169 = F_psprintf(m, int32(357202), v14+int32(16))
							mBase = m.M
							v170 = m.ExcPending
							if v170 != 0 {
								return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v14))) = v182
								v186 = F_psprintf(m, int32(357207), v14)
								mBase = m.M
								v187 = m.ExcPending
								if v187 != 0 {
									return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = l1
	F_errmsg(m, int32(759399), v11+int32(-16))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L12
...
L16:
	;
	F_errsave_finish(m, l3, int32(517338), int32(208), int32(326650))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L12
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v465
	F_errmsg(m, int32(329419), v11+int32(-48))
	mBase = m.M
	v484 = m.ExcPending
	if v484 != 0 {
		goto L12
...
L155:
	;
	F_errsave_finish(m, l3, int32(517338), int32(288), int32(326650))
	mBase = m.M
	v489 = m.ExcPending
	if v489 != 0 {
		goto L12
...
L160:
	;
	F_errsave_finish(m, l3, int32(517338), int32(295), int32(326650))
	mBase = m.M
	v509 = m.ExcPending
	if v509 != 0 {
		goto L12
...
L172:
	;
	F_errsave_finish(m, l3, int32(517338), int32(309), int32(326650))
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L12
...
L16:
	;
	F_errsave_finish(m, l4, int32(517338), int32(414), int32(326632))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L12
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v469
	F_errmsg(m, int32(285137), v13+int32(-48))
	mBase = m.M
	v488 = m.ExcPending
	if v488 != 0 {
		goto L12
...
L155:
	;
	F_errsave_finish(m, l4, int32(517338), int32(490), int32(326632))
	mBase = m.M
	v493 = m.ExcPending
	if v493 != 0 {
		goto L12
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = l2
	F_errmsg(m, int32(759399), v13+int32(-32))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L12
...
L160:
	;
	F_errsave_finish(m, l4, int32(517338), int32(497), int32(326632))
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L12
...
L176:
	;
	F_errsave_finish(m, l4, int32(517338), int32(511), int32(326632))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L12
		...
		if v25 != 0 {
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(1664)
				F_errmsg(m, int32(178063), v6)
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return
				} else {
					F_errfinish(m, int32(524485), int32(83), int32(369237))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return
...
L47:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v14)+8)) = v172
	F_errmsg_internal(m, int32(41509), v14)
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L45
...
L50:
	;
	F_errfinish(m, int32(524333), int32(277), int32(320303))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L45
