...
func F_pgl_getMyProcPort(m *base.Module) int32 {
	...
	var v2 int32
	_ = v2
	v2 = *(*int32)(unsafe.Add(mBase, _consts[376]))
	return v2
}
func F_pgl_getPGliteExitStatus(m *base.Module) int32 {
	...
	var v2 int32
	_ = v2
	v2 = *(*int32)(unsafe.Add(mBase, _consts[848]))
	return v2
}
...
func F_pgl_startPGlite(m *base.Module) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = int32(16777343)
	...
	if v55 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[376])) = v54
		*(*int32)(unsafe.Add(mBase, _consts[278])) = int32(2)
		v64 = int32(1)
		*(*int32)(unsafe.Add(mBase, _consts[20])) = v64
		*(*uint8)(unsafe.Add(mBase, _consts[800])) = uint8(v64)
		*(*uint8)(unsafe.Add(mBase, _consts[183])) = uint8(v64)
		v73 = int32(0)
		*(*uint8)(unsafe.Add(mBase, _consts[801])) = uint8(v73)
		v75 = F_load_hba(m)
		mBase = m.M
		v76 = m.ExcPending
		if v76 != 0 {
			...
			if v75 == int32(0) {
				...
				if v82 != 0 {
					...
					v84 = *(*int32)(unsafe.Add(mBase, _consts[802]))
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v84
					F_errmsg(m, int32(208372), v6)
					mBase = m.M
					v88 = m.ExcPending
					if v88 != 0 {
						return
					} else {
						F_errfinish(m, int32(519676), int32(260), int32(369232))
						mBase = m.M
						v93 = m.ExcPending
						if v93 != 0 {
							return
