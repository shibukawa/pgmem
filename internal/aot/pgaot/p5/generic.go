...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v46 & int32(_a_F_generic_desc_0)
	F_appendStringInfo(m, l0, int32(_a_F_generic_desc_1), v9)
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L9
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v25 & int32(_a_F_generic_desc_0)
	F_appendStringInfo(m, l0, int32(_a_F_generic_desc_2), v9+int32(16))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L9
