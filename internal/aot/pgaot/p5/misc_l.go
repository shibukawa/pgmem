					...
					*(*int32)(unsafe.Add(mBase, uint32(v16)+12)) = l1
						...
						if v51 == int32(0) {
							...
							if v191 != 0 {
								...
								if v195 != 0 {
									...
									F_errfinish(m, int32(497956), int32(3296), int32(361775))
									mBase = m.M
									v200 = m.ExcPending
									if v200 != 0 {
										return
									...
									if v66 != 0 {
										...
										if v65 == int32(0) {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v16))) = v73
											F_errmsg_internal(m, int32(192471), v16)
											mBase = m.M
											v77 = m.ExcPending
											if v77 != 0 {
												return
											} else {
												F_errfinish(m, int32(497956), int32(3307), int32(361775))
												mBase = m.M
												v82 = m.ExcPending
												if v82 != 0 {
													return
														...
														if v135 == int32(0) {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v139))) = int32(1)
															if v140 != 0 {
																...
																F_s_lock(m, v146, int32(497956), int32(3330), int32(361775))
																mBase = m.M
																v151 = m.ExcPending
																if v151 != 0 {
																	return
					...
					if v178 != 0 {
						...
						if v182 != 0 {
							...
							F_errfinish(m, int32(497956), int32(3280), int32(361775))
							mBase = m.M
							v187 = m.ExcPending
							if v187 != 0 {
								return
...
L33:
	;
	F_errfinish(m, int32(499814), int32(3547), int32(435209))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L15
...
L33:
	;
	F_errfinish(m, int32(496107), int32(146), int32(27923))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(496107), int32(150), int32(27923))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
			...
			if v17 == int32(0) {
				...
				if v87 != 0 {
					...
					if v90 != 0 {
						...
						F_errmsg(m, int32(268578), int32(0))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(499800), int32(911), int32(308900))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return int32(0)
									...
									if v103 != 0 {
										...
										if v106 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8))) = v107 + int32(4)
											F_errmsg(m, int32(195819), v8)
											mBase = m.M
											v113 = m.ExcPending
											if v113 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(499800), int32(923), int32(308900))
												mBase = m.M
												v118 = m.ExcPending
												if v118 != 0 {
													return int32(0)
		...
		if v71 != 0 {
			...
			if v74 != 0 {
				...
				if v78 != 0 {
					...
					F_errfinish(m, int32(499800), int32(905), int32(308900))
					mBase = m.M
					v83 = m.ExcPending
					if v83 != 0 {
						return int32(0)
					...
					if v290 != 0 {
						...
						if v289 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12)+8)) = v291
							F_errmsg(m, int32(150318), v12)
							mBase = m.M
							v299 = m.ExcPending
							if v299 != 0 {
								return int32(0)
							} else {
								F_errdetail(m, int32(578869), int32(0))
								mBase = m.M
								v303 = m.ExcPending
								if v303 != 0 {
									return int32(0)
								} else {
									F_errhint(m, int32(603027), int32(0))
									mBase = m.M
									v307 = m.ExcPending
									if v307 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(492559), int32(2987), int32(409842))
										mBase = m.M
										v312 = m.ExcPending
										if v312 != 0 {
											return int32(0)
...
func F_leftmostvalue_text(m *base.Module) int32 {
	...
	var v6 int32
	_ = v6
	v3 = F_cstring_to_text_with_len(m, int32(757603), int32(0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
L97:
	;
	F_errmsg(m, int32(507421), int32(0))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L12
...
L98:
	;
	F_errfinish(m, int32(493119), int32(1009), int32(27403))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L12
...
L103:
	;
	F_errfinish(m, int32(493119), int32(1020), int32(27403))
	mBase = m.M
	v392 = m.ExcPending
	if v392 != 0 {
		goto L12
				...
				if v32 < int64(1073741820) {
					...
					if v38 != 0 {
						...
						if v41 != 0 {
							...
							F_errmsg(m, int32(400524), int32(0))
							mBase = m.M
							v45 = m.ExcPending
							if v45 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(495259), int32(779), int32(311097))
								mBase = m.M
								v50 = m.ExcPending
								if v50 != 0 {
									return int32(0)
						...
						if v26 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							...
							if v30 != 0 {
								...
								F_errfinish(m, int32(499514), int32(4408), int32(28173))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v17
			...
			if v21 != 0 {
				...
				F_errfinish(m, int32(499491), int32(975), int32(488619))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return
...
L43:
	;
	F_errmsg(m, int32(677199), int32(0))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L7
...
L46:
	;
	F_errfinish(m, int32(495757), int32(1337), int32(77865))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L7
						...
						if v35 != 0 {
							...
							if v37 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v36
								F_errmsg(m, int32(349489), v6)
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(499491), int32(2001), int32(277930))
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return int32(0)
