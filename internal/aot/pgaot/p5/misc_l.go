					...
					*(*int32)(unsafe.Add(mBase, uint32(v16)+12)) = l1
						...
						if v51 == int32(0) {
							...
							if v191 != 0 {
								...
								if v195 != 0 {
									...
									F_errfinish(m, int32(494492), int32(3296), int32(359303))
									mBase = m.M
									v200 = m.ExcPending
									if v200 != 0 {
										return
										...
										if v65 == int32(0) {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v16))) = v73
											...
											if v77 != 0 {
												...
												F_errfinish(m, int32(494492), int32(3307), int32(359303))
												mBase = m.M
												v82 = m.ExcPending
												if v82 != 0 {
													return
														...
														if v135 == int32(0) {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v139))) = int32(1)
															if v140 != 0 {
																...
																F_s_lock(m, v146, int32(494492), int32(3330), int32(359303))
																mBase = m.M
																v151 = m.ExcPending
																if v151 != 0 {
																	return
					...
					if v178 != 0 {
						...
						if v182 != 0 {
							...
							F_errfinish(m, int32(494492), int32(3280), int32(359303))
							mBase = m.M
							v187 = m.ExcPending
							if v187 != 0 {
								return
...
L33:
	;
	F_errfinish(m, int32(492666), int32(146), int32(27833))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(492666), int32(150), int32(27833))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
				...
				if v87 != 0 {
					...
					if v90 != 0 {
						...
						if v94 != 0 {
							...
							F_errfinish(m, int32(496302), int32(911), int32(306910))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return int32(0)
										...
										if v106 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8))) = v107 + int32(4)
											...
											if v113 != 0 {
												...
												F_errfinish(m, int32(496302), int32(923), int32(306910))
												mBase = m.M
												v118 = m.ExcPending
												if v118 != 0 {
													return int32(0)
		...
		if v71 != 0 {
			...
			if v74 != 0 {
				...
				if v78 != 0 {
					...
					F_errfinish(m, int32(496302), int32(905), int32(306910))
					mBase = m.M
					v83 = m.ExcPending
					if v83 != 0 {
						return int32(0)
						...
						if v289 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12)+8)) = v291
							...
							if v299 != 0 {
								...
								F_errdetail(m, int32(560225), int32(0))
								mBase = m.M
								v303 = m.ExcPending
								if v303 != 0 {
									return int32(0)
								} else {
									F_errhint(m, int32(584339), int32(0))
									mBase = m.M
									v307 = m.ExcPending
									if v307 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(489168), int32(2987), int32(407074))
										mBase = m.M
										v312 = m.ExcPending
										if v312 != 0 {
											return int32(0)
...
func F_leftmostvalue_text(m *base.Module) int32 {
	...
	var v6 int32
	_ = v6
	v3 = F_cstring_to_text_with_len(m, int32(738681), int32(0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
L97:
	;
	F_errmsg(m, int32(503816), int32(0))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L12
...
L98:
	;
	F_errfinish(m, int32(489728), int32(1009), int32(27323))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L12
...
L101:
	;
	F_errmsg(m, int32(537788), int32(0))
	mBase = m.M
	v383 = m.ExcPending
	if v383 != 0 {
		goto L12
...
L103:
	;
	F_errfinish(m, int32(489728), int32(1020), int32(27323))
	mBase = m.M
	v392 = m.ExcPending
	if v392 != 0 {
		goto L12
					...
					if v38 != 0 {
						...
						if v41 != 0 {
							...
							if v45 != 0 {
								...
								F_errfinish(m, int32(491818), int32(779), int32(309070))
								mBase = m.M
								v50 = m.ExcPending
								if v50 != 0 {
									return int32(0)
						...
						if v26 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							...
							if v30 != 0 {
								...
								F_errfinish(m, int32(496016), int32(4408), int32(28083))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v17
			...
			if v21 != 0 {
				...
				F_errfinish(m, int32(495993), int32(975), int32(485254))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return
...
L43:
	;
	F_errmsg(m, int32(658496), int32(0))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L7
...
L46:
	;
	F_errfinish(m, int32(492316), int32(1337), int32(77492))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L7
							...
							if v37 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v36
								...
								if v41 != 0 {
									...
									F_errfinish(m, int32(495993), int32(2001), int32(276196))
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return int32(0)
