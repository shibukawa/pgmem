				...
				if v38 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v16)+12)) = l1
					...
					if v52 != 0 {
						...
						if v51 == int32(0) {
							...
							if v191 != 0 {
								...
								F_errmsg_internal(m, int32(110035), int32(0))
								mBase = m.M
								v195 = m.ExcPending
								if v195 != 0 {
									return
								} else {
									F_errfinish(m, int32(492228), int32(3296), int32(357540))
									mBase = m.M
									v200 = m.ExcPending
									if v200 != 0 {
										return
									...
									if v66 != 0 {
										...
										if v65 == int32(0) {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v16))) = v73
											F_errmsg_internal(m, int32(190664), v16)
											mBase = m.M
											v77 = m.ExcPending
											if v77 != 0 {
												return
											} else {
												F_errfinish(m, int32(492228), int32(3307), int32(357540))
												mBase = m.M
												v82 = m.ExcPending
												if v82 != 0 {
													return
														...
														if v135 == int32(0) {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v139))) = int32(1)
															if v140 != 0 {
																...
																F_s_lock(m, v146, int32(492228), int32(3330), int32(357540))
																mBase = m.M
																v151 = m.ExcPending
																if v151 != 0 {
																	return
					...
					if v178 != 0 {
						...
						F_errmsg_internal(m, int32(110076), int32(0))
						mBase = m.M
						v182 = m.ExcPending
						if v182 != 0 {
							return
						} else {
							F_errfinish(m, int32(492228), int32(3280), int32(357540))
							mBase = m.M
							v187 = m.ExcPending
							if v187 != 0 {
								return
...
L33:
	;
	F_errfinish(m, int32(494036), int32(3547), int32(430202))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L15
...
L32:
	;
	F_errmsg(m, int32(309771), int32(0))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(490402), int32(146), int32(27767))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(490402), int32(150), int32(27767))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
			...
			if v17 == int32(0) {
				...
				if v87 != 0 {
					...
					if v90 != 0 {
						...
						F_errmsg(m, int32(265802), int32(0))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(494022), int32(911), int32(305547))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return int32(0)
									...
									if v103 != 0 {
										...
										if v106 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8))) = v107 + int32(4)
											F_errmsg(m, int32(194012), v8)
											mBase = m.M
											v113 = m.ExcPending
											if v113 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(494022), int32(923), int32(305547))
												mBase = m.M
												v118 = m.ExcPending
												if v118 != 0 {
													return int32(0)
		...
		if v71 != 0 {
			...
			if v74 != 0 {
				...
				if v78 != 0 {
					...
					F_errfinish(m, int32(494022), int32(905), int32(305547))
					mBase = m.M
					v83 = m.ExcPending
					if v83 != 0 {
						return int32(0)
					...
					if v290 != 0 {
						...
						if v289 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12)+8)) = v291
							F_errmsg(m, int32(148826), v12)
							mBase = m.M
							v299 = m.ExcPending
							if v299 != 0 {
								return int32(0)
							} else {
								F_errdetail(m, int32(557248), int32(0))
								mBase = m.M
								v303 = m.ExcPending
								if v303 != 0 {
									return int32(0)
								} else {
									F_errhint(m, int32(581318), int32(0))
									mBase = m.M
									v307 = m.ExcPending
									if v307 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(486904), int32(2987), int32(405150))
										mBase = m.M
										v312 = m.ExcPending
										if v312 != 0 {
											return int32(0)
...
func F_leftmostvalue_text(m *base.Module) int32 {
	...
	var v6 int32
	_ = v6
	v3 = F_cstring_to_text_with_len(m, int32(735586), int32(0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
L114:
	;
	F_errmsg(m, int32(501447), int32(0))
	mBase = m.M
	v423 = m.ExcPending
	if v423 != 0 {
		goto L12
...
L115:
	;
	F_errfinish(m, int32(487464), int32(1009), int32(27268))
	mBase = m.M
	v428 = m.ExcPending
	if v428 != 0 {
		goto L12
...
L118:
	;
	F_errmsg(m, int32(535125), int32(0))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		goto L12
...
L120:
	;
	F_errfinish(m, int32(487464), int32(1020), int32(27268))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L12
				...
				if v32 < int64(1073741820) {
					...
					if v38 != 0 {
						...
						if v41 != 0 {
							...
							F_errmsg(m, int32(396006), int32(0))
							mBase = m.M
							v45 = m.ExcPending
							if v45 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(489554), int32(779), int32(307643))
								mBase = m.M
								v50 = m.ExcPending
								if v50 != 0 {
									return int32(0)
					...
					if v23 != 0 {
						...
						if v26 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg_internal(m, int32(39933), v7)
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return
							} else {
								F_errfinish(m, int32(493736), int32(4408), int32(28000))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return
	...
	if v10 == int32(0) {
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v17
			F_errmsg_internal(m, int32(50112), v8)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return
			} else {
				F_errfinish(m, int32(493713), int32(975), int32(483010))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return
...
L43:
	;
	F_errmsg(m, int32(655430), int32(0))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L7
...
L46:
	;
	F_errfinish(m, int32(490052), int32(1337), int32(77264))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L7
						...
						if v35 != 0 {
							...
							if v37 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v36
								F_errmsg(m, int32(345429), v6)
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(493713), int32(2001), int32(274896))
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return int32(0)
...
L24:
	;
	v90 = *(*int32)(unsafe.Add(mBase, uint32(v6)))
	v91 = *(*int32)(unsafe.Add(mBase, uint32(v6)+4))
	*(*int32)(unsafe.Add(mBase, uint32(v90))) = v91 << (uint(int32(2)) % 32)
	goto L25
L25:
	;
	m.G0 = v6 + int32(16)
