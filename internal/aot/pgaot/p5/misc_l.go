				...
				if v38 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v16)+12)) = l1
					...
					if v52 != 0 {
						...
						if v51 == int32(0) {
							...
							if v191 != 0 {
								...
								F_errmsg_internal(m, int32(110997), int32(0))
								mBase = m.M
								v195 = m.ExcPending
								if v195 != 0 {
									return
								} else {
									F_errfinish(m, int32(497060), int32(3296), int32(361027))
									mBase = m.M
									v200 = m.ExcPending
									if v200 != 0 {
										return
									...
									if v66 != 0 {
										...
										if v65 == int32(0) {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v16))) = v73
											F_errmsg_internal(m, int32(192194), v16)
											mBase = m.M
											v77 = m.ExcPending
											if v77 != 0 {
												return
											} else {
												F_errfinish(m, int32(497060), int32(3307), int32(361027))
												mBase = m.M
												v82 = m.ExcPending
												if v82 != 0 {
													return
														...
														if v135 == int32(0) {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v139))) = int32(1)
															if v140 != 0 {
																...
																F_s_lock(m, v146, int32(497060), int32(3330), int32(361027))
																mBase = m.M
																v151 = m.ExcPending
																if v151 != 0 {
																	return
					...
					if v178 != 0 {
						...
						F_errmsg_internal(m, int32(111038), int32(0))
						mBase = m.M
						v182 = m.ExcPending
						if v182 != 0 {
							return
						} else {
							F_errfinish(m, int32(497060), int32(3280), int32(361027))
							mBase = m.M
							v187 = m.ExcPending
							if v187 != 0 {
								return
...
L33:
	;
	F_errfinish(m, int32(495234), int32(146), int32(27907))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(495234), int32(150), int32(27907))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
			...
			if v17 == int32(0) {
				...
				if v87 != 0 {
					...
					if v90 != 0 {
						...
						F_errmsg(m, int32(268098), int32(0))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(498904), int32(911), int32(308289))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return int32(0)
									...
									if v103 != 0 {
										...
										if v106 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8))) = v107 + int32(4)
											F_errmsg(m, int32(195542), v8)
											mBase = m.M
											v113 = m.ExcPending
											if v113 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(498904), int32(923), int32(308289))
												mBase = m.M
												v118 = m.ExcPending
												if v118 != 0 {
													return int32(0)
		...
		if v71 != 0 {
			...
			if v74 != 0 {
				...
				if v78 != 0 {
					...
					F_errfinish(m, int32(498904), int32(905), int32(308289))
					mBase = m.M
					v83 = m.ExcPending
					if v83 != 0 {
						return int32(0)
					...
					if v290 != 0 {
						...
						if v289 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12)+8)) = v291
							F_errmsg(m, int32(150059), v12)
							mBase = m.M
							v299 = m.ExcPending
							if v299 != 0 {
								return int32(0)
							} else {
								F_errdetail(m, int32(562880), int32(0))
								mBase = m.M
								v303 = m.ExcPending
								if v303 != 0 {
									return int32(0)
								} else {
									F_errhint(m, int32(586994), int32(0))
									mBase = m.M
									v307 = m.ExcPending
									if v307 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(491715), int32(2987), int32(409036))
										mBase = m.M
										v312 = m.ExcPending
										if v312 != 0 {
											return int32(0)
...
func F_leftmostvalue_text(m *base.Module) int32 {
	...
	var v6 int32
	_ = v6
	v3 = F_cstring_to_text_with_len(m, int32(741336), int32(0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
L97:
	;
	F_errmsg(m, int32(506471), int32(0))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L12
...
L98:
	;
	F_errfinish(m, int32(492275), int32(1009), int32(27387))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L12
...
L101:
	;
	F_errmsg(m, int32(540443), int32(0))
	mBase = m.M
	v383 = m.ExcPending
	if v383 != 0 {
		goto L12
...
L103:
	;
	F_errfinish(m, int32(492275), int32(1020), int32(27387))
	mBase = m.M
	v392 = m.ExcPending
	if v392 != 0 {
		goto L12
				...
				if v32 < int64(1073741820) {
					...
					if v38 != 0 {
						...
						if v41 != 0 {
							...
							F_errmsg(m, int32(399737), int32(0))
							mBase = m.M
							v45 = m.ExcPending
							if v45 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(494386), int32(779), int32(310479))
								mBase = m.M
								v50 = m.ExcPending
								if v50 != 0 {
									return int32(0)
						...
						if v26 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							...
							if v30 != 0 {
								...
								F_errfinish(m, int32(498618), int32(4408), int32(28157))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v17
			...
			if v21 != 0 {
				...
				F_errfinish(m, int32(498595), int32(975), int32(487775))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return
...
L9:
	;
	v32 = F_tzload(m, int32(1815552), int32(0), v25)
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L10
...
L12:
	;
	v40 = F_tzparse(m, int32(1815552), v25, int32(1))
	mBase = m.M
	goto L5
L13:
	;
...
L107:
	...
	v480 = v468 - v471
	v482 = v472 + int32(1)
	v486 = *(*int32)(unsafe.Add(mBase, uint32(v463+int32(1815456)+v482<<(uint(int32(2))%32))))
	if v486 <= v480 {
		v468 = v480
		v471 = v486
		v472 = v482
...
L244:
	...
	v1138 = v1126 - v1129
	v1140 = v1130 + int32(1)
	v1144 = *(*int32)(unsafe.Add(mBase, uint32(v1121+int32(1815456)+v1140<<(uint(int32(2))%32))))
	if v1144 <= v1138 {
		v1126 = v1138
		v1129 = v1144
		v1130 = v1140
...
L43:
	;
	F_errmsg(m, int32(661151), int32(0))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L7
...
L46:
	;
	F_errfinish(m, int32(494884), int32(1337), int32(77729))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L7
						...
						if v35 != 0 {
							...
							if v37 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v36
								F_errmsg(m, int32(348741), v6)
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(498595), int32(2001), int32(277450))
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return int32(0)
