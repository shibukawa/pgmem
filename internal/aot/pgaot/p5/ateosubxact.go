...
func F_AtEOSubXact_Files(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v37 int32
	_ = v37
	v9 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_Files[0]))
	if v9 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_Files[1]))
	v15 = int32(0)
	v16 = v9
	v17 = v11
	goto L4
...
L12:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_Files[0]))
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_Files[1]))
	v33 = v15 - int32(1)
	v34 = v30
	v35 = v32
	goto L6
