...
func F_AtEOSubXact_Files(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v37 int32
	_ = v37
	v9 = *(*int32)(unsafe.Add(mBase, _consts[644]))
	if v9 != 0 {
		goto L1
	} else {
		goto L2
...
L12:
	...
	v32 = *(*int32)(unsafe.Add(mBase, _consts[645]))
	v33 = v15 - int32(1)
	v34 = v30
	v35 = v32
	goto L6
...
func F_AtEOSubXact_on_commit_actions(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	_ = v48
	v4 = int32(0)
	v10 = *(*int32)(unsafe.Add(mBase, _consts[222]))
	if v10 == v4 {
		goto L1
	} else {
		goto L2
...
L12:
	;
	v32 = int32(4459104)
	v34 = *(*int32)(unsafe.Add(mBase, _consts[222]))
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, _consts[222])) = v35
	F_pfree(m, v29)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
