...
L15:
	;
	v51 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v40&int32(_a_F_PageGetHeapFreeSpace_1)<<(uint(int32(2))%32)+(l0+int32(24))-int32(3)))))
...
L17:
	;
	v57 = v40 + int32(1)
	v58 = int32(_a_F_PageGetHeapFreeSpace_1)
