...
func F_InitializeLogRepWorker(m *base.Module) {
	...
	v6 = v4 + int32(-64)
	m.G0 = v6
	F_SetConfigOption(m, int32(385332), int32(507239), int32(5), int32(10))
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
		return
		...
		if v20 != 0 {
			...
			if v26 != 0 {
				...
				v34 = F_AllocSetContextCreateInternal(m, v29, int32(61976), int32(0), int32(8192), int32(8388608))
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return
								...
								if v57 == int32(0) {
									...
									if v65 != 0 {
										...
										if v64 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v6))) = v68
											F_errmsg(m, int32(231743), v6)
											mBase = m.M
											v72 = m.ExcPending
											if v72 != 0 {
												return
											} else {
												F_errfinish(m, int32(495381), int32(4697), int32(221084))
												mBase = m.M
												v77 = m.ExcPending
												if v77 != 0 {
													return
									...
									*(*uint8)(unsafe.Add(mBase, _consts[558])) = uint8(v92)
									...
									if v96 != 0 {
										...
										F_SetConfigOption(m, int32(100591), v128, int32(4), int32(10))
										mBase = m.M
										v132 = m.ExcPending
										if v132 != 0 {
											return
														...
														if v184 != 0 {
															...
															if v183 == int32(0) {
																...
																*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = v189
																F_errmsg(m, int32(444366), v4+int32(-32))
																mBase = m.M
																v195 = m.ExcPending
																if v195 != 0 {
																	return
																	...
																	v198 = int32(4742)
																	F_errfinish(m, int32(495381), v198, int32(221084))
																	mBase = m.M
																	v201 = m.ExcPending
																	if v201 != 0 {
																		return
																...
																if v153 == int32(0) {
																	...
																	if v164 != 0 {
																		...
																		*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v159
																		F_errmsg(m, int32(444433), v4+int32(-48))
																		mBase = m.M
																		v171 = m.ExcPending
																		if v171 != 0 {
																			return
										...
										if v100 != 0 {
											...
											if v99 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = v103
												F_errmsg(m, int32(231918), v4+int32(-16))
												mBase = m.M
												v109 = m.ExcPending
												if v109 != 0 {
													return
												} else {
													F_errfinish(m, int32(495381), int32(4713), int32(221084))
													mBase = m.M
													v114 = m.ExcPending
													if v114 != 0 {
														return
...
L30:
	;
	F_errfinish(m, int32(492372), v181, int32(109754))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L24
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v122
	F_errmsg(m, int32(200314), v14+int32(16))
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L24
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v152
	F_errdetail_log_plural(m, int32(606204), int32(606229), v117, v14)
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L24
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v122
	F_errmsg(m, int32(200359), v14+int32(32))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L24
...
L111:
	;
	F_errfinish(m, int32(492382), int32(2727), int32(505257))
	mBase = m.M
	v627 = m.ExcPending
	if v627 != 0 {
		goto L1
...
L127:
	;
	F_errfinish(m, int32(492372), v729, int32(125613))
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L1
...
L131:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v18)+4)) = uint32(v699)
	F_errmsg_internal(m, int32(671603), v18)
	mBase = m.M
	v703 = m.ExcPending
	if v703 != 0 {
		goto L1
...
L133:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v18)+40)) = uint32(v717)
	F_errmsg_internal(m, int32(671504), v18+int32(32))
	mBase = m.M
	v723 = m.ExcPending
	if v723 != 0 {
		goto L1
	...
	if v5 != v4 {
		...
		if v9 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[87])) = v18
			v24 = F_format_elog_string(m, int32(628225), int32(0))
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v123
	F_appendStringInfo(m, l0, int32(175330), v11)
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L13
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(16))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L13
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(32))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L13
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(48))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L13
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+84)) = v11 + int32(544)
	F_appendStringInfo(m, l0, int32(175330), v11+int32(80))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L13
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+128)) = v123
	F_appendStringInfo(m, l0, int32(465794), v11+int32(128))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L13
...
L122:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+112)) = v294
	F_appendStringInfo(m, l0, int32(488195), v11+int32(112))
	mBase = m.M
	v309 = m.ExcPending
	if v309 != 0 {
		goto L13
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+160)) = v123
	F_appendStringInfo(m, l0, int32(465794), v11+int32(160))
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L13
...
L136:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+144)) = v315
	F_appendStringInfo(m, l0, int32(488195), v11+int32(144))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L13
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+192)) = v123
	F_appendStringInfo(m, l0, int32(431988), v11+int32(192))
	mBase = m.M
	v363 = m.ExcPending
	if v363 != 0 {
		goto L13
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+176)) = v356
	F_appendStringInfo(m, l0, int32(432143), v11+int32(176))
	mBase = m.M
	v371 = m.ExcPending
	if v371 != 0 {
		goto L13
...
L149:
	;
	v398 = F_pg_strftime(m, int32(4508832), int32(128), int32(508202), v396)
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L13
...
L150:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+224)) = v403
	v410 = F_pg_sprintf(m, v11+int32(544), int32(465659), v11+int32(224))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L13
...
L152:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+212)) = int32(4508832)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+208)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(208))
	mBase = m.M
	v422 = m.ExcPending
	if v422 != 0 {
		goto L13
...
L154:
	;
	F_appendStringInfoString(m, l0, int32(4508832))
	mBase = m.M
	v427 = m.ExcPending
	if v427 != 0 {
		goto L13
...
L157:
	;
	v442 = F_pg_strftime(m, v11+int32(544), int32(128), int32(508181), v440)
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L13
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+244)) = v11 + int32(544)
	F_appendStringInfo(m, l0, int32(175330), v11+int32(240))
	mBase = m.M
	v452 = m.ExcPending
	if v452 != 0 {
		goto L13
...
L166:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+276)) = v476
	v484 = F_pg_snprintf(m, v11+int32(544), int32(128), int32(465656), v11+int32(272))
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L13
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+260)) = v11 + int32(544)
	F_appendStringInfo(m, l0, int32(175330), v11+int32(256))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L13
...
L176:
	;
	v519 = F_pg_strftime(m, int32(4508992), int32(128), int32(508181), v517)
	mBase = m.M
	v520 = m.ExcPending
	if v520 != 0 {
		goto L13
...
L178:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+292)) = int32(4508992)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+288)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(288))
	mBase = m.M
	v528 = m.ExcPending
	if v528 != 0 {
		goto L13
...
L180:
	;
	F_appendStringInfoString(m, l0, int32(4508992))
	mBase = m.M
	v533 = m.ExcPending
	if v533 != 0 {
		goto L13
...
L187:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+304)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(304))
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L13
...
L201:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+320)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(320))
	mBase = m.M
	v594 = m.ExcPending
	if v594 != 0 {
		goto L13
...
L212:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+352)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(352))
	mBase = m.M
	v638 = m.ExcPending
	if v638 != 0 {
		goto L13
...
L214:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+384)) = v605
	v619 = F_psprintf(m, int32(674667), v11+int32(384))
	mBase = m.M
	v620 = m.ExcPending
	if v620 != 0 {
		goto L13
...
L215:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+368)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(368))
	mBase = m.M
	v627 = m.ExcPending
	if v627 != 0 {
		goto L13
...
L221:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+336)) = v645
	F_appendStringInfo(m, l0, int32(675539), v11+int32(336))
	mBase = m.M
	v656 = m.ExcPending
	if v656 != 0 {
		goto L13
...
L228:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+400)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(400))
	mBase = m.M
	v683 = m.ExcPending
	if v683 != 0 {
		goto L13
...
L238:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+448)) = v705
	v717 = F_pg_snprintf(m, v11+int32(544), int32(127), int32(39181), v11+int32(448))
	mBase = m.M
	v718 = m.ExcPending
	if v718 != 0 {
		goto L13
...
L240:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+416)) = v705
	F_appendStringInfo(m, l0, int32(39181), v11+int32(416))
	mBase = m.M
	v737 = m.ExcPending
	if v737 != 0 {
		goto L13
...
L241:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+436)) = v11 + int32(544)
	F_appendStringInfo(m, l0, int32(175330), v11+int32(432))
	mBase = m.M
	v727 = m.ExcPending
	if v727 != 0 {
		goto L13
...
L246:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+480)) = v123
	F_appendStringInfo(m, l0, int32(38421), v11+int32(480))
	mBase = m.M
	v759 = m.ExcPending
	if v759 != 0 {
		goto L13
...
L248:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+464)) = v752
	F_appendStringInfo(m, l0, int32(59415), v11+int32(464))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L13
...
L251:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+500)) = int32(4509128)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+496)) = v123
	F_appendStringInfo(m, l0, int32(175330), v11+int32(496))
	mBase = m.M
	v819 = m.ExcPending
	if v819 != 0 {
		goto L13
...
L253:
	;
	F_appendStringInfoString(m, l0, int32(4509128))
	mBase = m.M
	v824 = m.ExcPending
	if v824 != 0 {
		goto L13
...
L260:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+528)) = v123
	F_appendStringInfo(m, l0, int32(429820), v11+int32(528))
	mBase = m.M
	v841 = m.ExcPending
	if v841 != 0 {
		goto L13
...
L262:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11)+512)) = v834
	F_appendStringInfo(m, l0, int32(430428), v11+int32(512))
	mBase = m.M
	v849 = m.ExcPending
	if v849 != 0 {
		goto L13
