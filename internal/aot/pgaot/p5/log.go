...
L22:
	;
	v213 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[1]))
...
L25:
	;
	v252 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v252+int32(_a_F_LogStandbySnapshot_15))
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L1
...
L33:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v258+int32(_a_F_LogStandbySnapshot_14))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L1
...
L34:
	;
	v264 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v264+int32(_a_F_LogStandbySnapshot_13))
	mBase = m.M
	v268 = m.ExcPending
	if v268 != 0 {
		goto L1
...
L35:
	;
	v270 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v270+int32(_a_F_LogStandbySnapshot_12))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L1
...
L36:
	;
	v276 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v276+int32(_a_F_LogStandbySnapshot_11))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L1
...
L37:
	;
	v282 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v282+int32(_a_F_LogStandbySnapshot_10))
	mBase = m.M
	v286 = m.ExcPending
	if v286 != 0 {
		goto L1
...
L38:
	;
	v288 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v288+int32(_a_F_LogStandbySnapshot_9))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		goto L1
...
L39:
	;
	v294 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v294+int32(_a_F_LogStandbySnapshot_8))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L1
...
L40:
	;
	v300 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v300+int32(_a_F_LogStandbySnapshot_7))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L1
...
L41:
	;
	v306 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v306+int32(_a_F_LogStandbySnapshot_6))
	mBase = m.M
	v310 = m.ExcPending
	if v310 != 0 {
		goto L1
...
L42:
	;
	v312 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v312+int32(_a_F_LogStandbySnapshot_5))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L1
...
L43:
	;
	v318 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v318+int32(_a_F_LogStandbySnapshot_4))
	mBase = m.M
	v322 = m.ExcPending
	if v322 != 0 {
		goto L1
...
L44:
	;
	v324 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v324+int32(_a_F_LogStandbySnapshot_3))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L1
...
L45:
	;
	v330 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v330+int32(_a_F_LogStandbySnapshot_2))
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L1
...
L46:
	;
	v336 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v336+int32(_a_F_LogStandbySnapshot_1))
	mBase = m.M
	v340 = m.ExcPending
	if v340 != 0 {
		goto L1
...
L47:
	;
	v342 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
	F_LWLockRelease(m, v342+int32(_a_F_LogStandbySnapshot_0))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L1
...
L54:
	;
	v367 = int32(_a_F_LogStandbySnapshot_16)
	v369 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[2])))
	v370 = v369 | int32(2)
	*(*uint8)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[2])) = uint8(v370)
	goto L55
L55:
	;
...
L58:
	;
	v381 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[3]))
	if v381 <= int32(1) {
		goto L59
	} else {
		goto L60
...
L59:
	;
	v385 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
...
L63:
	;
	v407 = int32(_a_F_LogStandbySnapshot_16)
	v409 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[2])))
	v410 = v409 | int32(2)
	*(*uint8)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[2])) = uint8(v410)
	goto L64
L64:
	;
...
L73:
	;
	F_errfinish(m, int32(_a_F_LogStandbySnapshot_17), v481, int32(_a_F_LogStandbySnapshot_18))
	mBase = m.M
	v484 = m.ExcPending
	if v484 != 0 {
		goto L1
...
L82:
	;
	v492 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[3]))
	if int32(2) <= v492 {
		goto L83
	} else {
		goto L84
...
L83:
	;
	v496 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
...
L85:
	;
	v502 = *(*int32)(unsafe.Add(mBase, _c_F_LogStandbySnapshot[0]))
