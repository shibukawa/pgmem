		...
		if v18 != 0 {
			...
			if v22 != 0 {
				...
				if v21 != 0 {
					...
					F_seg_yyerror(m, v11, v23, v24, int32(_a_F_seg_in_0))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
		...
		if v11 != 0 {
			...
			if v15 != 0 {
				...
				if v20 != 0 {
					...
					if v17 == int32(0) {
						F_yy_fatal_error_7(m, int32(_a_F_seg_yy_scan_buffer_0))
						mBase = m.M
						v82 = m.ExcPending
						if v82 != 0 {
							return int32(0)
...
func F_seg_yyrestart(m *base.Module, l0 int32, l1 int32) {
	...
	if v8 != 0 {
		...
		if v13 != 0 {
			v27 = v13
			v29 = *(*int32)(unsafe.Add(mBase, _c_F_seg_yyrestart[0]))
			v30 = int32(0)
			...
			*(*int32)(unsafe.Add(mBase, _c_F_seg_yyrestart[0])) = v29
			...
			*(*uint8)(unsafe.Add(mBase, uint32(l1)+24)) = uint8(v86)
			...
			if v16 != 0 {
				...
				v19 = F_seg_yy_create_buffer(m, v17, int32(_a_F_seg_yyrestart_0), l1)
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					return
	...
	if v4 != 0 {
		...
		if v9 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = l0
			...
			F_yy_fatal_error_7(m, int32(_a_F_seg_yyset_column_0))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return
