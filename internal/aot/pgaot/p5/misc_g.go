	...
	default:
		...
		if v17 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
			F_errmsg_internal(m, int32(502064), v8)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(514715), int32(611), int32(20949))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return int32(0)
...
L30:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = int32(398625)
	v308 = v6
	goto L1
L31:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = l0
	F_errmsg(m, int32(759537), v14)
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L26
...
L32:
	;
	F_errfinish(m, int32(516986), int32(89), int32(224220))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L26
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v121
	v147 = F_psprintf(m, int32(722155), v14+int32(16))
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L26
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v121
	F_errmsg(m, int32(309970), v14+int32(32))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L26
...
L45:
	;
	F_errfinish(m, int32(516986), int32(101), int32(224220))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L26
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = v14 - int32(-64)
	v224 = F_psprintf(m, int32(748178), v14+int32(48))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L26
	...
	if v9&int32(2) == int32(0) {
				...
				if v46 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
					...
					if v50 != 0 {
						...
						F_errfinish(m, int32(519766), int32(345), int32(390721))
						mBase = m.M
						v55 = m.ExcPending
						if v55 != 0 {
							return int32(0)
		...
		if v30 != 0 {
			...
			if v33 != 0 {
				...
				F_errmsg(m, int32(467161), int32(0))
				mBase = m.M
				v37 = m.ExcPending
				if v37 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(519766), int32(337), int32(390721))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return int32(0)
...
func F_GetInsertRecPtr(m *base.Module) int64 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4)+440)) = int32(1)
	if v5 != 0 {
		...
		F_s_lock(m, v9+int32(440), int32(521598), int32(6526), int32(217009))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int64(0)
...
func F_GetLatestSnapshot(m *base.Module) int32 {
	...
	if v9&int32(1) == int32(0) {
		...
		if v15 == int32(0) {
			...
			v25 = F_GetSnapshotData(m, int32(4554328))
			mBase = m.M
			v26 = m.ExcPending
			if v26 != 0 {
				return int32(0)
		...
		if v32 != 0 {
			...
			F_errmsg_internal(m, int32(272244), int32(0))
			mBase = m.M
			v36 = m.ExcPending
			if v36 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(518155), int32(361), int32(93183))
				mBase = m.M
				v41 = m.ExcPending
				if v41 != 0 {
					return int32(0)
...
func F___getopt_msg(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v9 != 0 {
		...
		if v8 < int32(0) {
			...
			v12 = F_strlen(m, l1)
			v15 = F_fwrite(m, l1, v12, int32(1), int32(4448048))
			v16 = m.ExcPending
			if v16 != 0 {
				return
			} else {
				if v15 == int32(0) {
					...
					v21 = F_fwrite(m, l2, int32(1), l3, int32(4448048))
					v22 = m.ExcPending
					if v22 != 0 {
						return
					} else {
						if v21 != l3 {
							...
							F_fputc(m, int32(10), int32(4448048))
							v27 = m.ExcPending
							if v27 != 0 {
								return
							} else {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v228))) = v227 << (uint(int32(2)) % 32)
							...
							if v249 != 0 {
								...
								if v55&int32(65535) == int32(1) {
									F_pg_qsort(m, v248, v245, int32(8), int32(7622))
									mBase = m.M
									v257 = m.ExcPending
									if v257 != 0 {
										return int32(0)
...
func F_gb18030_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4428148), v18, v18, int32(7347), int32(39), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
L54:
	;
	F_errfinish(m, int32(518846), int32(115), int32(24857))
	mBase = m.M
	v200 = m.ExcPending
	if v200 != 0 {
		goto L4
...
L70:
	;
	v260 = v253 + int32(5)
	F_pg_qsort(m, v260, v254, int32(3), int32(7426))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L6
...
L19:
	;
	v1013 = F_slice_from_s(m, l0, int32(1), int32(2215893))
	mBase = m.M
	v1014 = m.ExcPending
	if v1014 != 0 {
		goto L62
...
L21:
	;
	v210 = F_slice_from_s(m, l0, int32(1), int32(2215892))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L62
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v218
	v225 = F_find_among(m, l0, int32(4243888), int32(6))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L62
...
L71:
	;
	v251 = F_slice_from_s(m, l0, int32(1), int32(2215898))
	mBase = m.M
	v252 = m.ExcPending
	if v252 != 0 {
		goto L62
...
L72:
	;
	v245 = F_slice_from_s(m, l0, int32(1), int32(2215897))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L62
...
L73:
	;
	v239 = F_slice_from_s(m, l0, int32(1), int32(2215896))
	mBase = m.M
	v240 = m.ExcPending
	if v240 != 0 {
		goto L62
...
L74:
	;
	v233 = F_slice_from_s(m, l0, int32(2), int32(2215894))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L62
...
L154:
	;
	v527 = F_find_among_b(m, l0, int32(4244016), int32(11))
	mBase = m.M
	v528 = m.ExcPending
	if v528 != 0 {
		goto L62
...
L158:
	;
	v667 = F_slice_from_s(m, l0, int32(1), int32(2215918))
	mBase = m.M
	v668 = m.ExcPending
	if v668 != 0 {
		goto L62
...
L165:
	...
	v550 = F_memcmp(m, v547+v543-v539, int32(2215908), v539)
	mBase = m.M
	if v550 != 0 {
		v554 = v541
		goto L164
...
L178:
	...
	v597 = F_memcmp(m, v594+v583-v586, int32(2215912), v586)
	mBase = m.M
	if v597 != 0 {
		v601 = v588
		goto L177
...
L202:
	;
	v696 = F_find_among_b(m, l0, int32(4244240), int32(4))
	mBase = m.M
	v697 = m.ExcPending
	if v697 != 0 {
		goto L62
...
L228:
	;
	v798 = F_find_among_b(m, l0, int32(4244320), int32(8))
	mBase = m.M
	v799 = m.ExcPending
	if v799 != 0 {
		goto L62
...
L240:
	...
	v826 = F_memcmp(m, v823+v813-v815, int32(2215922), v815)
	mBase = m.M
	if v826 != 0 {
		v830 = v817
		goto L239
...
L260:
	...
	v882 = F_memcmp(m, v879+v868-v871, int32(2215924), v871)
	mBase = m.M
	if v882 != 0 {
		v886 = v873
		goto L259
...
L267:
	...
	v904 = F_memcmp(m, v901+v891-v893, int32(2215926), v893)
	mBase = m.M
	if v904 != 0 {
		v908 = v895
		goto L266
...
L276:
	...
	v942 = F_find_among_b(m, l0, int32(4244480), int32(2))
	mBase = m.M
	v943 = m.ExcPending
	if v943 != 0 {
		goto L62
...
L284:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v965
	v972 = F_find_among(m, l0, int32(4244528), int32(6))
	mBase = m.M
	v973 = m.ExcPending
	if v973 != 0 {
		goto L62
...
L290:
	;
	v998 = F_slice_from_s(m, l0, int32(1), int32(2216001))
	mBase = m.M
	v999 = m.ExcPending
	if v999 != 0 {
		goto L62
...
L291:
	;
	v992 = F_slice_from_s(m, l0, int32(1), int32(2216000))
	mBase = m.M
	v993 = m.ExcPending
	if v993 != 0 {
		goto L62
...
L292:
	;
	v986 = F_slice_from_s(m, l0, int32(1), int32(2215999))
	mBase = m.M
	v987 = m.ExcPending
	if v987 != 0 {
		goto L62
...
L293:
	;
	v980 = F_slice_from_s(m, l0, int32(1), int32(2215998))
	mBase = m.M
	v981 = m.ExcPending
	if v981 != 0 {
		goto L62
...
L42:
	;
	F_errfinish(m, int32(520915), int32(479), int32(229635))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L7
				...
				if v58 != 0 {
					...
					if v61 != 0 {
						...
						if v65 != 0 {
							...
							F_errfinish(m, int32(521100), int32(420), int32(131972))
							mBase = m.M
							v70 = m.ExcPending
							if v70 != 0 {
								return
						...
						if v74 != 0 {
							...
							if v77 != 0 {
								...
								if v81 != 0 {
									...
									F_errfinish(m, int32(521100), int32(425), int32(131972))
									mBase = m.M
									v86 = m.ExcPending
									if v86 != 0 {
										return
											...
											if v121 != 0 {
												...
												if v124 != 0 {
													...
													if v128 != 0 {
														...
														F_errfinish(m, int32(521100), int32(434), int32(131972))
														mBase = m.M
														v133 = m.ExcPending
														if v133 != 0 {
															return
		...
		if v42 != 0 {
			...
			if v45 != 0 {
				...
				if v49 != 0 {
					...
					F_errfinish(m, int32(521100), int32(415), int32(131972))
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return
				...
				if v28 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
					...
					if v33 != 0 {
						...
						F_errfinish(m, int32(522705), int32(937), int32(395252))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
...
func F_get_doc_path(m *base.Module, l0 int32) {
	var v5 int32
	_ = v5
	F_make_relative_path(m, l0, int32(314542), int32(4549984))
	v5 = m.ExcPending
	if v5 != 0 {
		return
	} else {
...
func F_get_etc_path(m *base.Module, l0 int32, l1 int32) {
	var v5 int32
	_ = v5
	F_make_relative_path(m, l1, int32(314300), l0)
	v5 = m.ExcPending
	if v5 != 0 {
		return
	} else {
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v64
	F_errmsg_internal(m, int32(507592), v7)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L12
...
L24:
	;
	F_errfinish(m, int32(521856), int32(1003), int32(180390))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L12
	...
	case 4:
		...
		if v42 != 0 {
			...
			if v45 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(513076)
				...
				if v52 != 0 {
					...
					F_errfinish(m, int32(520995), int32(5610), int32(455050))
					mBase = m.M
					v57 = m.ExcPending
					if v57 != 0 {
						return int32(0)
	...
	default:
		...
		if v61 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v62
			F_errmsg_internal(m, int32(497705), v7)
			mBase = m.M
			v66 = m.ExcPending
			if v66 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(520995), int32(5615), int32(455050))
				mBase = m.M
				v71 = m.ExcPending
				if v71 != 0 {
					return int32(0)
	...
	if v11 != 0 {
		...
		if v16 == int32(0) {
			...
			if v51 != 0 {
				...
				F_errmsg_internal(m, int32(480540), int32(0))
				mBase = m.M
				v55 = m.ExcPending
				if v55 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(524307), int32(1781), int32(28695))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return int32(0)
				...
				if v24 == int32(0) {
					...
					if v64 != 0 {
						...
						if v68 != 0 {
							...
							F_errfinish(m, int32(524307), int32(1788), int32(28695))
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return int32(0)
...
L39:
	;
	F_errmsg_internal(m, int32(375275), int32(0))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L27
...
L40:
	;
	F_errfinish(m, int32(516909), int32(2156), int32(217473))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L27
...
L43:
	;
	F_errfinish(m, int32(516909), int32(2162), int32(217473))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L27
...
func F_get_values_def(m *base.Module, l0 int32, l1 int32) {
	...
	F_appendStringInfoString(m, v8, int32(777061))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		goto L1
...
L8:
	;
	F_appendStringInfoString(m, v8, int32(778892))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L1
...
L15:
	;
	F_errmsg_internal(m, int32(280153), int32(0))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L14
...
L16:
	;
	F_errfinish(m, int32(518402), int32(2498), int32(15839))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L14
...
L19:
	;
	F_errfinish(m, int32(518402), int32(2504), int32(15839))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L14
...
L127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v35))) = v770 + int32(4)
	F_errmsg_internal(m, int32(744597), v35)
	mBase = m.M
	v776 = m.ExcPending
	if v776 != 0 {
		goto L1
...
L128:
	;
	F_errfinish(m, int32(520507), int32(552), int32(427782))
	mBase = m.M
	v781 = m.ExcPending
	if v781 != 0 {
		goto L1
...
L267:
	;
	F_errfinish(m, int32(522896), int32(782), int32(356119))
	mBase = m.M
	v1578 = m.ExcPending
	if v1578 != 0 {
		goto L1
...
L21:
	;
	F_errfinish(m, int32(522035), int32(349), int32(144015))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L18
...
L106:
	;
	F_errfinish(m, int32(514865), int32(768), int32(87639))
	mBase = m.M
	v434 = m.ExcPending
	if v434 != 0 {
		goto L10
...
L112:
	;
	F_errfinish(m, int32(514865), int32(1209), int32(107937))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L10
