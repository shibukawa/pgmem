...
func F_HnswSearchLayer(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32, l9 int32, l10 int32, l11 int32, l12 int32, l13 int32) int32 {
	...
	v38 = v36 - int32(1232)
	m.G0 = v38
	v42 = F_pairingheap_allocate(m, int32(7541), v15)
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L1
...
L2:
	;
	v48 = F_pairingheap_allocate(m, int32(7542), int32(0))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L21:
	;
	v90 = F_pairingheap_allocate(m, int32(7543), int32(0))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
