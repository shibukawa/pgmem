...
func F_smgrDoPendingDeletes(m *base.Module, l0 int32) {
	...
	v13 = v11 - int32(16)
	m.G0 = v13
	v16 = *(*int32)(unsafe.Add(mBase, _c_F_smgrDoPendingDeletes[0]))
	v17 = *(*int32)(unsafe.Add(mBase, uint32(v16)+28))
	goto L1
L1:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_smgrDoPendingDeletes[1]))
	if v19 == int32(0) {
		goto L2
	} else {
		goto L3
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_smgrDoPendingDeletes[1])) = v32
	goto L10
L14:
	;
