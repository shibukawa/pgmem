...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v25 + int32(4)
	F_errmsg_internal(m, int32(119734), v13+int32(16))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L2
...
L12:
	;
	F_errfinish(m, int32(492711), int32(20190), int32(264182))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L2
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v41 + int32(4)
	F_errmsg_internal(m, int32(119643), v13)
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L2
...
L15:
	;
	F_errfinish(m, int32(492711), int32(20194), int32(264182))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L2
