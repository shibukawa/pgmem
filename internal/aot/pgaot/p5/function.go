		...
		if v35 == int32(1) {
			...
			if v41 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = v42
				F_errmsg_internal(m, int32(553407), v9)
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(514773), int32(1190), int32(315987))
					mBase = m.M
					v51 = m.ExcPending
					if v51 != 0 {
						return int32(0)
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	F_errmsg_internal(m, int32(47843), v10)
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L2
...
L11:
	;
	F_errfinish(m, int32(519654), int32(1723), int32(69608))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L2
...
L15:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[248]))
	v44 = int32(0)
	if v43 == v44 {
		goto L19
	} else {
					...
					if v37&int32(1) != 0 {
						...
						if v45 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v46
							F_errmsg_internal(m, int32(553282), v9)
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(514773), int32(1722), int32(317068))
								mBase = m.M
								v55 = m.ExcPending
								if v55 != 0 {
									return int32(0)
					...
					if v37&int32(1) == int32(0) {
						...
						if v63 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v64
							F_errmsg_internal(m, int32(553399), v7+int32(-48))
							mBase = m.M
							v70 = m.ExcPending
							if v70 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(514773), int32(1728), int32(317068))
								mBase = m.M
								v75 = m.ExcPending
								if v75 != 0 {
									return int32(0)
...
func F_RunFunctionExecuteHook(m *base.Module, l0 int32) {
	...
	_ = v9
	v4 = int32(0)
	v7 = *(*int32)(unsafe.Add(mBase, _consts[231]))
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v123
	v126 = F_psprintf(m, int32(483460), v15)
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L7
...
L53:
	;
	F_errmsg_internal(m, int32(160321), int32(0))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L7
...
L54:
	;
	F_errfinish(m, int32(517809), int32(1784), int32(482438))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L7
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v30
	F_errmsg_internal(m, int32(160506), v15+int32(32))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L7
...
L57:
	;
	F_errfinish(m, int32(517809), int32(1792), int32(482438))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L7
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v30
	F_errmsg_internal(m, int32(160436), v15+int32(16))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L7
...
L60:
	;
	F_errfinish(m, int32(517809), int32(1802), int32(482438))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L7
...
L14:
	;
	v51 = v39 + int32(1)
	v52 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v39+v32))))
	switch v52 - int32(36) {
	case 0:
		goto L19
	default:
...
L17:
	;
	v221 = F_pg_mbstrlen_with_len(m, v32, v51)
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L2
...
L34:
	;
	v101 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v55+v31))))
	if v101 != int32(36) {
		v227 = v40
		goto L16
	} else {
...
L46:
	;
	v140 = v109 + int32(1)
	v141 = v112 + base.B2i32(int32(0) < v121)
	goto L42
L47:
	;
	v140 = v133
...
L52:
	;
	v149 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v113))))
	if v149 != 0 {
		goto L53
	} else {
		goto L54
...
L61:
	...
	v163 = int32(1)
	v164 = v151 + v163
	v165 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v150)+1)))
	if v165 != 0 {
		v150 = v150 + v163
		v151 = v164
		v152 = v160
...
L65:
	;
	v206 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v192)+1)))
	if v206 == int32(39) {
		v227 = v40
		goto L16
	} else {
...
L72:
	;
	v271 = F_internalerrquery(m, v266)
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L2
...
func F_has_function_privilege_name(m *base.Module, l0 int32) int32 {
	...
	if v14 != 0 {
		...
		if v17 != 0 {
			...
			v19 = *(*int32)(unsafe.Add(mBase, _consts[237]))
			...
			if v23 != 0 {
				...
				v24 = F_DirectFunctionCall1Coll(m, int32(1253), int32(0), v22)
				mBase = m.M
				v25 = m.ExcPending
				if v25 != 0 {
					return int32(0)
					...
					if v24 == int32(0) {
							...
							if v34 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v22
								...
								if v38 != 0 {
									...
									F_errfinish(m, int32(517593), int32(3565), int32(393973))
									mBase = m.M
									v43 = m.ExcPending
									if v43 != 0 {
										return int32(0)
						...
						v46 = F_convert_any_priv_string(m, v16, int32(1685776))
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return int32(0)
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+48)) = base.I32_extend8_s(v148)
	F_errmsg_internal(m, int32(715085), v27+int32(48))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L2
...
L42:
	;
	F_errfinish(m, int32(513435), int32(3396), int32(127675))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L2
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+32)) = v221
	F_appendStringInfo(m, l0, int32(766256), v27+int32(32))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L2
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+16)) = v266
	F_appendStringInfo(m, l0, int32(206823), v27+int32(16))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L2
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27))) = v339
	F_errmsg_internal(m, int32(53476), v27)
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L2
...
L77:
	;
	F_errfinish(m, int32(513435), int32(3348), int32(127675))
	mBase = m.M
	v348 = m.ExcPending
	if v348 != 0 {
		goto L2
...
L9:
	...
	F_appendStringInfoString(m, l0, int32(780244))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L2
...
L13:
	;
	F_appendStringInfoString(m, l0, int32(563662))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L2
