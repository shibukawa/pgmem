...
L57:
	...
	v248 = v246 & int32(_a_F_FunctionNext_0)
					...
					if v37&int32(1) != 0 {
						...
						if v45 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v46
							F_errmsg_internal(m, int32(_a_F_ReceiveFunctionCall_0), v9)
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(_a_F_ReceiveFunctionCall_1), int32(1722), int32(_a_F_ReceiveFunctionCall_2))
								mBase = m.M
								v55 = m.ExcPending
								if v55 != 0 {
									return int32(0)
					...
					if v37&int32(1) == int32(0) {
						...
						if v63 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v64
							F_errmsg_internal(m, int32(_a_F_ReceiveFunctionCall_3), v7+int32(-48))
							mBase = m.M
							v70 = m.ExcPending
							if v70 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(_a_F_ReceiveFunctionCall_1), int32(1728), int32(_a_F_ReceiveFunctionCall_2))
								mBase = m.M
								v75 = m.ExcPending
								if v75 != 0 {
									return int32(0)
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v123
	v126 = F_psprintf(m, int32(_a_F_build_function_result_tupdesc_d_0), v15)
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L7
...
func F_has_function_privilege_name(m *base.Module, l0 int32) int32 {
	...
	if v14 != 0 {
		...
		if v17 != 0 {
			...
			v19 = *(*int32)(unsafe.Add(mBase, _c_F_has_function_privilege_name[0]))
			...
			if v23 != 0 {
				...
				v24 = F_DirectFunctionCall1Coll(m, int32(1256), int32(0), v22)
				mBase = m.M
				v25 = m.ExcPending
				if v25 != 0 {
					return int32(0)
					...
					if v24 == int32(0) {
						...
						if v31 != 0 {
							...
							if v34 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v22
								F_errmsg(m, int32(_a_F_has_function_privilege_name_0), v8)
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_has_function_privilege_name_1), int32(3565), int32(_a_F_has_function_privilege_name_2))
									mBase = m.M
									v43 = m.ExcPending
									if v43 != 0 {
										return int32(0)
						...
						v46 = F_convert_any_priv_string(m, v16, int32(_a_F_has_function_privilege_name_3))
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return int32(0)
...
L38:
	...
	case 0:
		v178 = int32(_a_F_print_function_arguments_0)
		goto L36
	default:
		goto L39
	case 7:
		goto L37
	case 13:
		v186 = int32(_a_F_print_function_arguments_1)
		v187 = v145
		v189 = v124
		goto L35
	case 18:
...
L40:
	;
	v178 = int32(_a_F_print_function_arguments_2)
	goto L36
L41:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v27)+48)) = base.I32_extend8_s(v148)
	F_errmsg_internal(m, int32(_a_F_print_function_arguments_3), v27+int32(48))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L2
...
L44:
	;
	v177 = int32(_a_F_print_function_arguments_6)
	goto L46
L45:
	;
	v177 = int32(_a_F_print_function_arguments_7)
	goto L46
L46:
	;
	v178 = v177
...
L48:
	;
	v196 = int32(_a_F_print_function_arguments_7)
	v197 = v145
	v199 = v124
	goto L33
L49:
...
L51:
	;
	v201 = int32(_a_F_print_function_arguments_8)
	if v93 == int32(0) {
		v210 = v201
		goto L50
	} else {
...
L56:
	;
	v210 = int32(_a_F_print_function_arguments_9)
	goto L50
L57:
	;
	goto L49
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+32)) = v221
	F_appendStringInfo(m, l0, int32(_a_F_print_function_arguments_10), v27+int32(32))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L2
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+16)) = v266
	F_appendStringInfo(m, l0, int32(_a_F_print_function_arguments_11), v27+int32(16))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L2
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27))) = v339
	F_errmsg_internal(m, int32(_a_F_print_function_arguments_12), v27)
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L2
