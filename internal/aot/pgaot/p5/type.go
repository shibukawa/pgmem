					...
					if v77 != 0 {
						...
						if v80 != 0 {
							...
							if v82 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6)+36)) = int32(_a_F_findTypeTypmodinFunction_0)
								*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = v81
								F_errmsg(m, int32(_a_F_findTypeTypmodinFunction_1), v6+int32(32))
								mBase = m.M
								v90 = m.ExcPending
								if v90 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_findTypeTypmodinFunction_2), int32(2199), int32(_a_F_findTypeTypmodinFunction_3))
									mBase = m.M
									v95 = m.ExcPending
									if v95 != 0 {
										return int32(0)
									...
									if v34 != 0 {
										...
										if v36 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v35
											F_errmsg(m, int32(_a_F_findTypeTypmodinFunction_4), v6+int32(16))
											mBase = m.M
											v42 = m.ExcPending
											if v42 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(_a_F_findTypeTypmodinFunction_2), int32(2206), int32(_a_F_findTypeTypmodinFunction_3))
												mBase = m.M
												v47 = m.ExcPending
												if v47 != 0 {
													return int32(0)
				...
				if v58 != 0 {
					...
					if v64 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = v63
						F_errmsg(m, int32(_a_F_findTypeTypmodinFunction_5), v6)
						mBase = m.M
						v68 = m.ExcPending
						if v68 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_findTypeTypmodinFunction_2), int32(2193), int32(_a_F_findTypeTypmodinFunction_3))
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return int32(0)
...
func F_has_type_privilege_id(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v8)+15)) = uint8(v16)
		v20 = *(*int32)(unsafe.Add(mBase, _c_F_has_type_privilege_id[0]))
		v22 = F_convert_any_priv_string(m, v12, int32(_a_F_has_type_privilege_id_0))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_has_type_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v22 = F_convert_any_priv_string(m, v14, int32(_a_F_has_type_privilege_id_id_0))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
			...
			if v22 != 0 {
				...
				if v24 != 0 {
					...
					if v23 == int32(0) {
						...
						if v30 != 0 {
							...
							if v33 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v21
								F_errmsg(m, int32(_a_F_has_type_privilege_id_name_0), v8)
								mBase = m.M
								v37 = m.ExcPending
								if v37 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_has_type_privilege_id_name_1), int32(_a_F_has_type_privilege_id_name_2), int32(_a_F_has_type_privilege_id_name_3))
									mBase = m.M
									v42 = m.ExcPending
									if v42 != 0 {
										return int32(0)
						...
						v45 = F_convert_any_priv_string(m, v17, int32(_a_F_has_type_privilege_id_name_4))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v22 != 0 {
			...
			v24 = F_convert_any_priv_string(m, v14, int32(_a_F_has_type_privilege_name_id_0))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
				...
				if v24 != 0 {
					...
					if v26 != 0 {
						...
						if v25 == int32(0) {
							...
							if v32 != 0 {
								...
								if v35 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v23
									F_errmsg(m, int32(_a_F_has_type_privilege_name_name_0), v8)
									mBase = m.M
									v39 = m.ExcPending
									if v39 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(_a_F_has_type_privilege_name_name_1), int32(_a_F_has_type_privilege_name_name_2), int32(_a_F_has_type_privilege_name_name_3))
										mBase = m.M
										v44 = m.ExcPending
										if v44 != 0 {
											return int32(0)
							...
							v47 = F_convert_any_priv_string(m, v17, int32(_a_F_has_type_privilege_name_name_4))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return int32(0)
		...
		if base.Ui32(int32(2)) <= base.Ui32(l0-int32(1042)) {
			...
			default:
				if l0 != int32(1700) {
					...
					if int32(4) <= l1 {
						v49 = int32(base.Ui32(int32(base.Ui32(l1-int32(4))>>(uint(int32(16))%32))+int32(6))>>(uint(int32(1))%32))&int32(_a_F_type_maximum_size_0) + int32(8)
					} else {
						v49 = int32(-1)
					}
					return v49
			...
			if base.Ui32(v15) <= base.Ui32(int32(41)) {
				v24 = *(*int32)(unsafe.Add(mBase, uint32(v15*int32(28))+uint32(_c_F_type_maximum_size[1])))
				v25 = v24
			} else {
				v25 = int32(1)
			}
