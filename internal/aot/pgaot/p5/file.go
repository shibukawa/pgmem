...
func F_FileSetDelete(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v285 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = int32(235401)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v7 + int32(1056)
		...
		if v300 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(32)
			v309 = F_pg_snprintf(m, v7+int32(1056), int32(1024), int32(177081), v7)
			mBase = m.M
			v310 = m.ExcPending
			if v310 != 0 {
				return int32(0)
...
L39:
	;
	F_errfinish(m, int32(499883), int32(2295), int32(516563))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L3
