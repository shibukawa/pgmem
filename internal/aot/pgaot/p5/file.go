...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = int32(223464)
	*(*int64)(unsafe.Add(mBase, uint32(v7)+24)) = v342
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v7 + int32(1056)
	v355 = F_pg_snprintf(m, v7+int32(32), int32(1024), int32(98544), v7+int32(16))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L58
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(32)
	v365 = F_pg_snprintf(m, v7+int32(1056), int32(1024), int32(166989), v7)
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L58
...
L39:
	;
	F_errfinish(m, int32(476611), int32(2295), int32(492859))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L3
