			...
			if v15 == v16 {
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						F_errmsg(m, int32(157538), int32(0))
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(494399), int32(1261), int32(430303))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
			...
			if v15 == v16 {
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						F_errmsg(m, int32(157497), int32(0))
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(494399), int32(1302), int32(213386))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
