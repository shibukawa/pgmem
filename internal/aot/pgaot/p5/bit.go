			...
			if v15 == v16 {
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						F_errmsg(m, int32(167042), int32(0))
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(517075), int32(1261), int32(449993))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
			...
			if v15 == v16 {
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						F_errmsg(m, int32(167001), int32(0))
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(517075), int32(1302), int32(224147))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
