...
func F_BitJaccardDistanceDefault(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int64, l4 int64, l5 int64) float64 {
	...
	if v92 != 0 {
		...
		for {
			...
			v120 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v114&v116)+uint32(_consts[1104]))))
			v121 = v103 + v120
			v124 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v114)+uint32(_consts[1104]))))
			v125 = v105 + v124
			v128 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v116)+uint32(_consts[1104]))))
			v129 = v104 + v128
			v131 = v100 + int32(1)
			if v131 != v92 {
				v100 = v131
			...
			if v15 == v16 {
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						F_errmsg(m, int32(167366), int32(0))
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(517936), int32(1261), int32(450804))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
			...
			if v15 == v16 {
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						F_errmsg(m, int32(167325), int32(0))
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(517936), int32(1302), int32(224477))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
