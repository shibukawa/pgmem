...
L3:
	;
	v10 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1278])))
	if v10 == int32(0) {
		v112 = v2
		goto L1
	} else {
...
L5:
	;
	v16 = *(*int32)(unsafe.Add(mBase, _consts[251]))
...
L11:
	;
	v73 = *(*int32)(unsafe.Add(mBase, _consts[1279]))
	if v73 == int32(0) {
		goto L2
	} else {
		goto L21
...
L16:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _consts[146]))
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v40))) = v17
	v47 = *(*int32)(unsafe.Add(mBase, _consts[146]))
...
L19:
	...
	v60 = *(*int32)(unsafe.Add(mBase, _consts[146]))
	*(*int32)(unsafe.Add(mBase, _consts[9])) = v60
	v63 = *(*int32)(unsafe.Add(mBase, _consts[1279]))
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1279])) = v64
	return int32(0)
L21:
	;
