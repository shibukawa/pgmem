...
L3:
	;
	v10 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1267])))
	if v10 == int32(0) {
		v112 = v2
		goto L1
	} else {
...
L11:
	;
	v73 = *(*int32)(unsafe.Add(mBase, _consts[1268]))
	if v73 == int32(0) {
		goto L2
	} else {
		goto L21
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, _consts[10])) = v60
	v63 = *(*int32)(unsafe.Add(mBase, _consts[1268]))
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1268])) = v64
	return int32(0)
L21:
	;
