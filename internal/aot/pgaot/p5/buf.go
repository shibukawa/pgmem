...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62)+16)) = v62 + int32(1056)
	v410 = F_pg_snprintf(m, v62+int32(32), int32(1024), int32(_a_F_BufFileOpenFileSet_2), v62+int32(16))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L1
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62))) = v62 + int32(32)
	v420 = F_pg_snprintf(m, v62+int32(1056), int32(1024), int32(_a_F_BufFileOpenFileSet_3), v62)
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L69:
	...
	v426 = v424 - int32(16)
	m.G0 = v426
	v429 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[0]))
...
L70:
	;
	v433 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[1]))
...
L73:
	;
	v439 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[2]))
	if v439 == int32(44) {
		goto L71
	} else {
		goto L76
...
L75:
	;
	v458 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[0]))
	F_ResourceOwnerRemember(m, v458, v434, int32(_a_F_BufFileOpenFileSet_4))
	mBase = m.M
	v461 = m.ExcPending
	if v461 != 0 {
		goto L1
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v426))) = v423
	F_errmsg(m, int32(_a_F_BufFileOpenFileSet_5), v426)
	mBase = m.M
	v451 = m.ExcPending
	if v451 != 0 {
		goto L1
...
L81:
	;
	v463 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[3]))
	v466 = v463 + v434*int32(48)
	v468 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[0]))
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v471))) = uint16(v474)
	v477 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[4])) = uint8(v477)
	goto L71
L82:
	;
	v493 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[5]))
	if v493 == int32(0) {
		v29 = v48
		v34 = v40
		v35 = v49
...
L90:
	;
	v522 = F_palloc(m, int32(_a_F_BufFileOpenFileSet_8))
	mBase = m.M
	v523 = m.ExcPending
	if v523 != 0 {
		goto L1
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v522))) = v34
	v528 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileOpenFileSet[0]))
	v529 = int64(0)
