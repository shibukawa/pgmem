		...
		if v10 != 0 {
			...
			if v13 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(1)
				v19 = *(*int32)(unsafe.Add(mBase, _consts[11]))
				v20 = int64(0)
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+20)) = v34
	v58 = F_pg_snprintf(m, v17+int32(32), int32(1024), int32(489453), v17+int32(16))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62)+20)) = int32(247713)
	*(*int64)(unsafe.Add(mBase, uint32(v62)+24)) = v341
	*(*int32)(unsafe.Add(mBase, uint32(v62)+16)) = v62 + int32(1056)
	v354 = F_pg_snprintf(m, v62+int32(32), int32(1024), int32(113179), v62+int32(16))
	mBase = m.M
	v355 = m.ExcPending
	if v355 != 0 {
		goto L1
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62))) = v62 + int32(32)
	v364 = F_pg_snprintf(m, v62+int32(1056), int32(1024), int32(188074), v62)
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L1
...
L52:
	...
	v370 = v368 - int32(16)
	m.G0 = v370
	v373 = *(*int32)(unsafe.Add(mBase, _consts[11]))
...
L53:
	;
	v377 = *(*int32)(unsafe.Add(mBase, _consts[641]))
...
L56:
	;
	v383 = *(*int32)(unsafe.Add(mBase, _consts[85]))
	if v383 == int32(44) {
		goto L54
	} else {
		goto L59
...
L58:
	;
	v402 = *(*int32)(unsafe.Add(mBase, _consts[11]))
	F_ResourceOwnerRemember(m, v402, v378, int32(1664528))
	mBase = m.M
	v405 = m.ExcPending
	if v405 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(525903), int32(1925), int32(409217))
	mBase = m.M
	v400 = m.ExcPending
	if v400 != 0 {
		goto L1
...
L64:
	;
	v407 = *(*int32)(unsafe.Add(mBase, _consts[548]))
	v410 = v407 + v378*int32(48)
	v412 = *(*int32)(unsafe.Add(mBase, _consts[11]))
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v415))) = uint16(v418)
	v421 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[642])) = uint8(v421)
	goto L54
L65:
	;
	v437 = *(*int32)(unsafe.Add(mBase, _consts[45]))
	if v437 == int32(0) {
		v29 = v48
		v34 = v40
		v35 = v49
...
L78:
	;
	F_errfinish(m, int32(524867), int32(339), int32(116000))
	mBase = m.M
	v464 = m.ExcPending
	if v464 != 0 {
		goto L1
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v466))) = v34
	v472 = *(*int32)(unsafe.Add(mBase, _consts[11]))
	v473 = int64(0)
