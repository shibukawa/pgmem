...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+20)) = v34
	v58 = F_pg_snprintf(m, v17+int32(32), int32(1024), int32(450777), v17+int32(16))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62)+20)) = int32(226696)
	*(*int64)(unsafe.Add(mBase, uint32(v62)+24)) = v397
	*(*int32)(unsafe.Add(mBase, uint32(v62)+16)) = v62 + int32(1056)
	v410 = F_pg_snprintf(m, v62+int32(32), int32(1024), int32(100473), v62+int32(16))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L1
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62))) = v62 + int32(32)
	v420 = F_pg_snprintf(m, v62+int32(1056), int32(1024), int32(169664), v62)
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L70:
	;
	v433 = *(*int32)(unsafe.Add(mBase, _consts[645]))
...
L75:
	...
	F_ResourceOwnerRemember(m, v458, v434, int32(1593440))
	mBase = m.M
	v461 = m.ExcPending
	if v461 != 0 {
		goto L1
...
L79:
	;
	F_errfinish(m, int32(482819), int32(1925), int32(375523))
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L1
...
L81:
	;
	v463 = *(*int32)(unsafe.Add(mBase, _consts[552]))
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v471))) = uint16(v474)
	v477 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[646])) = uint8(v477)
	goto L71
L82:
	;
...
L95:
	;
	F_errfinish(m, int32(482081), int32(339), int32(102998))
	mBase = m.M
	v520 = m.ExcPending
	if v520 != 0 {
		goto L1
