...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+20)) = v34
	v58 = F_pg_snprintf(m, v17+int32(32), int32(1024), int32(466506), v17+int32(16))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62)+20)) = int32(235250)
	*(*int64)(unsafe.Add(mBase, uint32(v62)+24)) = v341
	*(*int32)(unsafe.Add(mBase, uint32(v62)+16)) = v62 + int32(1056)
	v354 = F_pg_snprintf(m, v62+int32(32), int32(1024), int32(105943), v62+int32(16))
	mBase = m.M
	v355 = m.ExcPending
	if v355 != 0 {
		goto L1
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v62))) = v62 + int32(32)
	v364 = F_pg_snprintf(m, v62+int32(1056), int32(1024), int32(176970), v62)
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L1
...
L58:
	...
	F_ResourceOwnerRemember(m, v402, v378, int32(1628096))
	mBase = m.M
	v405 = m.ExcPending
	if v405 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(499564), int32(1925), int32(389385))
	mBase = m.M
	v400 = m.ExcPending
	if v400 != 0 {
		goto L1
...
L78:
	;
	F_errfinish(m, int32(498819), int32(339), int32(108586))
	mBase = m.M
	v464 = m.ExcPending
	if v464 != 0 {
		goto L1
