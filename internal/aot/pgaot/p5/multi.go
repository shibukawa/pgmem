	...
	if v16 != 0 {
		...
		if v29 != 0 {
			...
			if v23 != int32(1) {
				...
				v32 = v22 - v19
				if int32(0) <= v32 {
					v36 = *(*int32)(unsafe.Add(mBase, _consts[54]))
					return v36
				} else {
					v43 = v20 - v21
					...
					if base.Ui32(v43) < base.Ui32(v53) {
						...
						v55 = v43 - v53
						v57 = *(*int32)(unsafe.Add(mBase, _consts[54]))
						if v55 < v57 {
							v59 = v55
						} else {
							v59 = v57
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13))) = l0
		...
		if v21 != 0 {
			...
			v23 = int32(*(*uint8)(unsafe.Add(mBase, _consts[80])))
			if v23 == int32(1) {
				...
				if v42 != 0 {
					...
					v45 = F_SimpleLruDoesPhysicalPageExist(m, int32(4443732), v44)
					mBase = m.M
					v46 = m.ExcPending
					if v46 != 0 {
						return
