...
func F_TransactionIdDidCommit(m *base.Module, l0 int32) int32 {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[98]))
	if v10 == l0 {
		v13 = *(*int32)(unsafe.Add(mBase, _consts[99]))
		v34 = v13
		v35 = int32(1)
		switch v34 - v35 {
		case 0:
		...
		case 2:
			v38 = int32(0)
			v40 = *(*int32)(unsafe.Add(mBase, _consts[43]))
								...
								if v56 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
									...
									if v63 != 0 {
										...
										F_errfinish(m, int32(520007), int32(162), int32(107264))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
		...
		if base.Ui32(l0) <= base.Ui32(int32(2)) {
			...
			if v26 != 0 {
				...
				case 0, 3:
					v34 = v23
				default:
					*(*int32)(unsafe.Add(mBase, _consts[99])) = v23
					*(*int32)(unsafe.Add(mBase, _consts[98])) = l0
					v32 = *(*int64)(unsafe.Add(mBase, uint32(v7)+8))
					*(*int64)(unsafe.Add(mBase, _consts[100])) = v32
					v34 = v23
				}
				v35 = int32(1)
				switch v34 - v35 {
				...
				if v30 == int32(0) {
					...
					if l0 == v33 {
						...
						*(*int64)(unsafe.Add(mBase, uint32(l1))) = v35
						...
						v48 = int32(0)
						v50 = *(*int32)(unsafe.Add(mBase, _consts[69]))
								...
								*(*int64)(unsafe.Add(mBase, uint32(l1))) = int64(0)
								...
								if v72 != 0 {
									*(*int64)(unsafe.Add(mBase, uint32(l1))) = int64(0)
									...
									if v84 == int32(0) {
										v98 = F_SimpleLruReadPage_ReadOnly(m, int32(4448500), base.I64_extend_i32_u(v14), l0)
										mBase = m.M
										v99 = m.ExcPending
										if v99 != 0 {
											return int32(0)
										} else {
											v101 = *(*int32)(unsafe.Add(mBase, _consts[70]))
											...
											*(*int64)(unsafe.Add(mBase, uint32(l1))) = v114
											...
											v118 = *(*int32)(unsafe.Add(mBase, _consts[70]))
											v119 = *(*int32)(unsafe.Add(mBase, uint32(v118)+28))
											v121 = int32(*(*uint16)(unsafe.Add(mBase, _consts[71])))
		...
		if v142 != 0 {
			...
			if v145 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(0)
				F_errmsg(m, int32(48489), v11)
				mBase = m.M
				v150 = m.ExcPending
				if v150 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(515454), int32(287), int32(529035))
					mBase = m.M
					v155 = m.ExcPending
					if v155 != 0 {
						return int32(0)
