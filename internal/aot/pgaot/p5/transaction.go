...
func F_TransactionIdDidCommit(m *base.Module, l0 int32) int32 {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[96]))
	if v10 == l0 {
		v13 = *(*int32)(unsafe.Add(mBase, _consts[97]))
		v34 = v13
		v35 = int32(1)
		switch v34 - v35 {
		case 0:
								...
								if v56 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
									...
									if v63 != 0 {
										...
										F_errfinish(m, int32(522155), int32(162), int32(107613))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
		...
		if base.Ui32(l0) <= base.Ui32(int32(2)) {
			...
			if v26 != 0 {
				...
				case 0, 3:
					v34 = v23
				default:
					*(*int32)(unsafe.Add(mBase, _consts[97])) = v23
					*(*int32)(unsafe.Add(mBase, _consts[96])) = l0
					v32 = *(*int64)(unsafe.Add(mBase, uint32(v7)+8))
					*(*int64)(unsafe.Add(mBase, _consts[98])) = v32
					v34 = v23
				}
				v35 = int32(1)
				switch v34 - v35 {
								...
								*(*int64)(unsafe.Add(mBase, uint32(l1))) = int64(0)
								...
								if v72 != 0 {
									*(*int64)(unsafe.Add(mBase, uint32(l1))) = int64(0)
									...
									if v84 == int32(0) {
										v98 = F_SimpleLruReadPage_ReadOnly(m, int32(4456676), base.I64_extend_i32_u(v14), l0)
										mBase = m.M
										v99 = m.ExcPending
										if v99 != 0 {
											return int32(0)
		...
		if v142 != 0 {
			...
			if v145 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(0)
				F_errmsg(m, int32(48740), v11)
				mBase = m.M
				v150 = m.ExcPending
				if v150 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(517534), int32(287), int32(531183))
					mBase = m.M
					v155 = m.ExcPending
					if v155 != 0 {
						return int32(0)
