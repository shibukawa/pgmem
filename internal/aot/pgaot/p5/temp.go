...
func F_check_temp_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l2 == int32(12) {
		...
		v8 = *(*int32)(unsafe.Add(mBase, _c_F_check_temp_buffers[0]))
		if v8 == int32(0) {
			v26 = v4
			return v26
		} else {
			...
			if v8 == v11 {
				...
				v15 = *(*int32)(unsafe.Add(mBase, _c_F_check_temp_buffers[1]))
				*(*int32)(unsafe.Add(mBase, _c_F_check_temp_buffers[2])) = v15
				v21 = F_format_elog_string(m, int32(_a_F_check_temp_buffers_0), int32(0))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				} else {
					*(*int32)(unsafe.Add(mBase, _c_F_check_temp_buffers[3])) = v21
					v26 = int32(0)
					return v26
				}
			}
...
L6:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_check_temp_tablespaces[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_check_temp_tablespaces[1])) = v32
	goto L9
L7:
	;
	goto L8
L8:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _c_F_check_temp_tablespaces[2]))
	v43 = *(*int32)(unsafe.Add(mBase, uint32(v42)+20))
	goto L11
L9:
	;
	v38 = F_format_elog_string(m, int32(_a_F_check_temp_tablespaces_0), int32(0))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L3
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_check_temp_tablespaces[3])) = v38
	goto L2
L11:
	;
...
L12:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _c_F_check_temp_tablespaces[4]))
	if v49 == int32(0) {
		goto L2
	} else {
		goto L13
...
L31:
	;
	v123 = *(*int32)(unsafe.Add(mBase, _c_F_check_temp_tablespaces[5]))
	if v123 == v100 {
		goto L38
	} else {
		goto L39
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v91
	F_errmsg(m, int32(_a_F_check_temp_tablespaces_1), v17)
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L3
...
L40:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _c_F_check_temp_tablespaces[6]))
