...
func F_check_temp_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l2 == int32(12) {
		...
		v8 = *(*int32)(unsafe.Add(mBase, _consts[637]))
		if v8 == int32(0) {
			v26 = v4
			return v26
		} else {
			...
			if v8 == v11 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[88])) = v15
				v21 = F_format_elog_string(m, int32(640348), int32(0))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				} else {
					*(*int32)(unsafe.Add(mBase, _consts[89])) = v21
					v26 = int32(0)
					return v26
				}
			}
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, _consts[88])) = v32
	goto L9
L7:
	;
	goto L8
...
L9:
	;
	v38 = F_format_elog_string(m, int32(669324), int32(0))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L3
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, _consts[89])) = v38
	goto L2
L11:
	;
...
L12:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[108]))
	if v49 == int32(0) {
		goto L2
	} else {
		goto L13
...
L31:
	;
	v123 = *(*int32)(unsafe.Add(mBase, _consts[109]))
	if v123 == v100 {
		goto L38
	} else {
		goto L39
...
L36:
	;
	F_errfinish(m, int32(519666), int32(1258), int32(180453))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L3
...
L40:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _consts[237]))
