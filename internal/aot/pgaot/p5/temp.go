		...
		if v8 == int32(0) {
			...
			if v8 == v11 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[87])) = v15
				v21 = F_format_elog_string(m, int32(583498), int32(0))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L9:
	;
	v38 = F_format_elog_string(m, int32(611864), int32(0))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L3
...
L36:
	;
	F_errfinish(m, int32(482627), int32(1258), int32(164488))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L3
