...
func F_check_temp_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l2 == int32(12) {
		...
		v8 = *(*int32)(unsafe.Add(mBase, _consts[639]))
		if v8 == int32(0) {
			v26 = v4
			return v26
		} else {
			...
			if v8 == v11 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[87])) = v15
				v21 = F_format_elog_string(m, int32(593991), int32(0))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L9:
	;
	v38 = F_format_elog_string(m, int32(622528), int32(0))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L3
...
L36:
	;
	F_errfinish(m, int32(491840), int32(1258), int32(169256))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L3
