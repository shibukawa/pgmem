		...
		if v8 == int32(0) {
			...
			if v8 == v11 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[86])) = v15
				v21 = F_format_elog_string(m, int32(648388), int32(0))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L6:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[85]))
	*(*int32)(unsafe.Add(mBase, _consts[86])) = v32
	goto L9
L7:
	;
	goto L8
...
L9:
	;
	v38 = F_format_elog_string(m, int32(677746), int32(0))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L3
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, _consts[87])) = v38
	goto L2
L11:
	;
...
L12:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[106]))
	if v49 == int32(0) {
		goto L2
	} else {
		goto L13
...
L31:
	;
	v123 = *(*int32)(unsafe.Add(mBase, _consts[107]))
	if v123 == v100 {
		goto L38
	} else {
		goto L39
...
L36:
	;
	F_errfinish(m, int32(525885), int32(1258), int32(182721))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L3
...
L40:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _consts[235]))
