...
func F_pgaio_io_reclaim(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[416])) = v36 + int32(1)
...
L6:
	...
	v115 = *(*int32)(unsafe.Add(mBase, uint32(v112)+uint32(_consts[593])))
...
L17:
	;
	v128 = *(*int32)(unsafe.Add(mBase, _consts[594]))
...
L19:
	...
	v148 = *(*int32)(unsafe.Add(mBase, uint32(v143<<(uint(int32(2))%32))+uint32(_consts[595])))
	v149 = *(*int32)(unsafe.Add(mBase, uint32(v148)+8))
	goto L23
L20:
	;
	v141 = *(*int32)(unsafe.Add(mBase, uint32(v134<<(uint(int32(2))%32))+uint32(_consts[596])))
	v142 = v141
	goto L22
L21:
	;
...
L25:
	;
	v158 = *(*int32)(unsafe.Add(mBase, uint32(v151<<(uint(int32(2))%32))+uint32(_consts[597])))
	v159 = v158
	goto L27
L26:
	;
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45+int32(76)))) = v118
	v179 = *(*int32)(unsafe.Add(mBase, uint32(v112)+uint32(_consts[598])))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45)+48)) = (l0 - v129) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(460088), v45+int32(48))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L11
...
L29:
	;
	v172 = *(*int32)(unsafe.Add(mBase, uint32(v164<<(uint(int32(2))%32))+uint32(_consts[599])))
	v173 = v172
	goto L31
L30:
	;
...
L32:
	;
	F_errfinish(m, int32(488742), int32(311), int32(308682))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L11
...
L41:
	;
	v268 = *(*int32)(unsafe.Add(mBase, _consts[594]))
...
L43:
	...
	v288 = *(*int32)(unsafe.Add(mBase, uint32(v283<<(uint(int32(2))%32))+uint32(_consts[595])))
	v289 = *(*int32)(unsafe.Add(mBase, uint32(v288)+8))
	goto L47
L44:
	;
	v281 = *(*int32)(unsafe.Add(mBase, uint32(v274<<(uint(int32(2))%32))+uint32(_consts[596])))
	v282 = v281
	goto L46
L45:
	;
...
L49:
	;
	v298 = *(*int32)(unsafe.Add(mBase, uint32(v291<<(uint(int32(2))%32))+uint32(_consts[597])))
	v299 = v298
	goto L51
L50:
	;
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45))) = (l0 - v269) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(472450), v45)
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L11
...
L53:
	;
	v312 = *(*int32)(unsafe.Add(mBase, uint32(v304<<(uint(int32(2))%32))+uint32(_consts[599])))
	v313 = v312
	goto L55
L54:
	;
...
L56:
	;
	F_errfinish(m, int32(488742), int32(328), int32(308682))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L11
...
L65:
	;
	v407 = *(*int32)(unsafe.Add(mBase, _consts[594]))
...
L66:
	...
	v425 = *(*int32)(unsafe.Add(mBase, uint32(v420<<(uint(int32(2))%32))+uint32(_consts[595])))
	v426 = *(*int32)(unsafe.Add(mBase, uint32(v425)+8))
	goto L70
L67:
	;
	v418 = *(*int32)(unsafe.Add(mBase, uint32(v411<<(uint(int32(2))%32))+uint32(_consts[596])))
	v419 = v418
	goto L69
L68:
	;
...
L71:
	;
	v434 = *(*int32)(unsafe.Add(mBase, uint32(v427<<(uint(int32(2))%32))+uint32(_consts[597])))
	v435 = v434
	goto L73
L72:
	;
...
L74:
	;
	v449 = *(*int32)(unsafe.Add(mBase, uint32(v442<<(uint(int32(2))%32))+uint32(_consts[599])))
	v450 = v449
	goto L76
L75:
	;
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v32))) = (l0 - v408) >> (uint(v436) % 32)
	F_errmsg_internal(m, int32(472732), v32)
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L11
...
L77:
	;
	F_errfinish(m, int32(487199), int32(708), int32(283762))
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L11
...
L79:
	;
	v483 = *(*int32)(unsafe.Add(mBase, _consts[600]))
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+68)) = v521 & int32(-449)
	v526 = *(*int32)(unsafe.Add(mBase, _consts[600]))
	v528 = v526 + int32(4)
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v526)+12)) = v544 + v545
	v548 = int32(4465052)
	v550 = *(*int32)(unsafe.Add(mBase, _consts[416]))
	*(*int32)(unsafe.Add(mBase, _consts[416])) = v550 - v545
	m.G0 = v32 + int32(48)
	return
}
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v33 & int32(255)
	F_errmsg_internal(m, int32(475189), v10+int32(16))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L13
...
L15:
	;
	F_errfinish(m, int32(487199), int32(610), int32(101752))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L13
...
L33:
	;
	v130 = *(*int32)(unsafe.Add(mBase, _consts[594]))
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = (l0 - v131) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(199893), v10)
	mBase = m.M
	v149 = m.ExcPending
	if v149 != 0 {
		goto L13
...
L35:
	;
	v140 = *(*int32)(unsafe.Add(mBase, uint32(v133<<(uint(int32(2))%32))+uint32(_consts[597])))
	v141 = v140
	goto L37
L36:
	;
...
L38:
	;
	F_errfinish(m, int32(487199), int32(597), int32(101752))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L13
...
func F_pgaio_result_report(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v19 = *(*int32)(unsafe.Add(mBase, uint32(v16)+uint32(_consts[593])))
	...
	if v20 == int32(0) {
		...
		if v26 != 0 {
			...
			v27 = *(*int32)(unsafe.Add(mBase, uint32(v16)+uint32(_consts[598])))
			*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = v27
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = v14
			F_errmsg_internal(m, int32(313183), v10)
			mBase = m.M
			v32 = m.ExcPending
			if v32 != 0 {
				return
			} else {
				F_errfinish(m, int32(488742), int32(183), int32(79765))
				mBase = m.M
				v37 = m.ExcPending
				if v37 != 0 {
					return
...
func F_pgaio_result_status_string(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(4)) {
		v9 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[599])))
		v10 = v9
	} else {
		v10 = int32(0)
	}
...
func F_pgaio_wref_wait(m *base.Module, l0 int32) {
	...
	var v15 int32
	_ = v15
	v3 = *(*int32)(unsafe.Add(mBase, _consts[594]))
