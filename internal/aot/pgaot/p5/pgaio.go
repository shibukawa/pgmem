...
func F_pgaio_io_reclaim(m *base.Module, l0 int32) {
	...
	v32 = v30 - int32(48)
	m.G0 = v32
	v34 = int32(_a_F_pgaio_io_reclaim_0)
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[0])) = v36 + int32(1)
...
L2:
	...
	v45 = v43 - int32(112)
	m.G0 = v45
	v47 = int32(_a_F_pgaio_io_reclaim_1)
	v49 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[1])) = v49 + int32(1)
	v54 = v32 + int32(40)
...
L6:
	...
	v115 = *(*int32)(unsafe.Add(mBase, uint32(v112)+uint32(_c_F_pgaio_io_reclaim[2])))
...
L17:
	;
	v128 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[3]))
...
L19:
	...
	v148 = *(*int32)(unsafe.Add(mBase, uint32(v143<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[4])))
	v149 = *(*int32)(unsafe.Add(mBase, uint32(v148)+8))
	goto L23
L20:
	;
	v141 = *(*int32)(unsafe.Add(mBase, uint32(v134<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[5])))
	v142 = v141
	goto L22
L21:
	;
...
L25:
	;
	v158 = *(*int32)(unsafe.Add(mBase, uint32(v151<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[6])))
	v159 = v158
	goto L27
L26:
	;
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45+int32(76)))) = v118
	v179 = *(*int32)(unsafe.Add(mBase, uint32(v112)+uint32(_c_F_pgaio_io_reclaim[7])))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45)+48)) = (l0 - v129) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(_a_F_pgaio_io_reclaim_2), v45+int32(48))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L11
...
L29:
	;
	v172 = *(*int32)(unsafe.Add(mBase, uint32(v164<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[8])))
	v173 = v172
	goto L31
L30:
	;
...
L39:
	;
	v345 = int32(_a_F_pgaio_io_reclaim_1)
	v347 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[1])) = v347 - int32(1)
	m.G0 = v45 + int32(112)
...
L43:
	...
	v288 = *(*int32)(unsafe.Add(mBase, uint32(v283<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[4])))
	v289 = *(*int32)(unsafe.Add(mBase, uint32(v288)+8))
	goto L47
L44:
	;
	v281 = *(*int32)(unsafe.Add(mBase, uint32(v274<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[5])))
	v282 = v281
	goto L46
L45:
	;
...
L49:
	;
	v298 = *(*int32)(unsafe.Add(mBase, uint32(v291<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[6])))
	v299 = v298
	goto L51
L50:
	;
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45))) = (l0 - v269) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(_a_F_pgaio_io_reclaim_5), v45)
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L11
...
L53:
	;
	v312 = *(*int32)(unsafe.Add(mBase, uint32(v304<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[8])))
	v313 = v312
	goto L55
L54:
	;
...
L65:
	;
	v407 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[3]))
...
L66:
	...
	v425 = *(*int32)(unsafe.Add(mBase, uint32(v420<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[4])))
	v426 = *(*int32)(unsafe.Add(mBase, uint32(v425)+8))
	goto L70
L67:
	;
	v418 = *(*int32)(unsafe.Add(mBase, uint32(v411<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[5])))
	v419 = v418
	goto L69
L68:
	;
...
L71:
	;
	v434 = *(*int32)(unsafe.Add(mBase, uint32(v427<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[6])))
	v435 = v434
	goto L73
L72:
	;
...
L74:
	;
	v449 = *(*int32)(unsafe.Add(mBase, uint32(v442<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_reclaim[8])))
	v450 = v449
	goto L76
L75:
	;
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v32))) = (l0 - v408) >> (uint(v436) % 32)
	F_errmsg_internal(m, int32(_a_F_pgaio_io_reclaim_6), v32)
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L11
...
L79:
	;
	v483 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[9]))
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+68)) = v521 & int32(-449)
	v526 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[9]))
	v528 = v526 + int32(4)
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v526)+12)) = v544 + v545
	v548 = int32(_a_F_pgaio_io_reclaim_0)
	v550 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_reclaim[0])) = v550 - v545
	m.G0 = v32 + int32(48)
	return
}
...
L11:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_wait[1]))
...
L33:
	;
	v130 = *(*int32)(unsafe.Add(mBase, _c_F_pgaio_io_wait[2]))
...
L35:
	;
	v140 = *(*int32)(unsafe.Add(mBase, uint32(v133<<(uint(int32(2))%32))+uint32(_c_F_pgaio_io_wait[3])))
	v141 = v140
	goto L37
L36:
	;
...
func F_pgaio_result_report(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v19 = *(*int32)(unsafe.Add(mBase, uint32(v16)+uint32(_c_F_pgaio_result_report[0])))
...
func F_pgaio_result_status_string(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(4)) {
		v9 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_c_F_pgaio_result_status_string[0])))
		v10 = v9
	} else {
		v10 = int32(0)
	}
