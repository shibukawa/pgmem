	...
	if v6 == int32(0) {
		...
		if v10 != int32(-1) {
			...
			if v134 != 0 {
				...
				F_errmsg_internal(m, int32(440080), int32(0))
				mBase = m.M
				v138 = m.ExcPending
				if v138 != 0 {
					return
				} else {
					F_errfinish(m, int32(492270), int32(108), int32(63146))
					mBase = m.M
					v143 = m.ExcPending
					if v143 != 0 {
						return
			...
			if v14 != 0 {
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v70)+60)) = v88
					...
					v98 = F_AllocSetContextCreateInternal(m, v93, int32(483471), int32(0), int32(8192), int32(8388608))
					mBase = m.M
					v99 = m.ExcPending
					if v99 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v101)+20)) = v98
						...
						v111 = F_AllocSetContextCreateInternal(m, v106, int32(486210), int32(0), int32(8192), int32(8388608))
						mBase = m.M
						v112 = m.ExcPending
						if v112 != 0 {
							return
		...
		if v22 <= int32(0) {
			...
			if v148 != 0 {
				...
				if v152 != 0 {
					...
					F_errfinish(m, int32(492270), int32(118), int32(63146))
					mBase = m.M
					v157 = m.ExcPending
					if v157 != 0 {
						return
	...
	if v6 != 0 {
		...
		if v7 != 0 {
			...
			if v68 != 0 {
				...
				F_errmsg_internal(m, int32(229387), int32(0))
				mBase = m.M
				v72 = m.ExcPending
				if v72 != 0 {
					return
				} else {
					F_errfinish(m, int32(492270), int32(2133), int32(229404))
					mBase = m.M
					v77 = m.ExcPending
					if v77 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, _consts[9])) = v11
			v18 = F_AllocSetContextCreateInternal(m, v11, int32(392910), int32(0), int32(8192), int32(8388608))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return
		...
		if v55 != 0 {
			...
			F_errmsg_internal(m, int32(528331), int32(0))
			mBase = m.M
			v59 = m.ExcPending
			if v59 != 0 {
				return
			} else {
				F_errfinish(m, int32(492270), int32(2130), int32(229404))
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return
