...
func F_SPI_connect_ext(m *base.Module, l0 int32) {
	...
	var v157 int32
	_ = v157
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[0]))
	if v6 == int32(0) {
		v10 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[1]))
		if v10 != int32(-1) {
			...
			if v134 != 0 {
				...
				F_errmsg_internal(m, int32(_a_F_SPI_connect_ext_0), int32(0))
				mBase = m.M
				v138 = m.ExcPending
				if v138 != 0 {
					return
			...
			v14 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[2]))
			if v14 != 0 {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v134 = m.ExcPending
				...
				v17 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[3]))
				...
				if v20 != 0 {
					...
					v38 = int32(16)
					v39 = v19
					*(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[2])) = v38
					*(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[0])) = v39
					v44 = v39
					v47 = int32(_a_F_SPI_connect_ext_3)
					v49 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[1]))
					v51 = v49 + int32(1)
					*(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[1])) = v51
					v56 = v44 + v51<<(uint(int32(6))%32)
					*(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[4])) = v56
					...
					*(*int64)(unsafe.Add(mBase, uint32(v56))) = v60
					v67 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[5]))
					v68 = *(*int32)(unsafe.Add(mBase, uint32(v67)+8))
					v70 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[4]))
					v71 = int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v70)+32)) = v68
					v82 = *(*int64)(unsafe.Add(mBase, _c_F_SPI_connect_ext[6]))
					*(*int64)(unsafe.Add(mBase, uint32(v70)+48)) = v82
					v85 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[7]))
					*(*int32)(unsafe.Add(mBase, uint32(v70)+56)) = v85
					v88 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[8]))
					*(*int32)(unsafe.Add(mBase, uint32(v70)+60)) = v88
					if v74 != 0 {
						v92 = int32(_a_F_SPI_connect_ext_4)
					} else {
						v92 = int32(_a_F_SPI_connect_ext_5)
					}
					v93 = *(*int32)(unsafe.Add(mBase, uint32(v92)))
					v98 = F_AllocSetContextCreateInternal(m, v93, int32(_a_F_SPI_connect_ext_6), int32(0), int32(_a_F_SPI_connect_ext_7), int32(_a_F_SPI_connect_ext_8))
					mBase = m.M
					v99 = m.ExcPending
					if v99 != 0 {
						return
					} else {
						v101 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[4]))
						*(*int32)(unsafe.Add(mBase, uint32(v101)+20)) = v98
						v104 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[9]))
						...
						v111 = F_AllocSetContextCreateInternal(m, v106, int32(_a_F_SPI_connect_ext_9), int32(0), int32(_a_F_SPI_connect_ext_7), int32(_a_F_SPI_connect_ext_8))
						mBase = m.M
						v112 = m.ExcPending
						if v112 != 0 {
							return
						} else {
							v114 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[4]))
							*(*int32)(unsafe.Add(mBase, uint32(v114)+24)) = v111
							v116 = int32(_a_F_SPI_connect_ext_10)
							v117 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[10]))
							v119 = *(*int32)(unsafe.Add(mBase, uint32(v114)+20))
							*(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[10])) = v119
							*(*int32)(unsafe.Add(mBase, uint32(v114)+28)) = v117
							*(*int64)(unsafe.Add(mBase, _c_F_SPI_connect_ext[6])) = int64(0)
							v126 = int32(0)
							*(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[7])) = v126
							*(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[8])) = v126
							return
						}
					}
				}
		...
		v22 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[2]))
		if v22 <= int32(0) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v148 = m.ExcPending
			...
			v26 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_connect_ext[1]))
			if v22 <= v26 {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v148 = m.ExcPending
...
L5:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+4)) = uint8(v10)
	...
	v14 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_keepplan[0]))
...
func F_spi_dest_startup(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v6 != 0 {
		...
		if v7 != 0 {
			...
			v8 = int32(_a_F_spi_dest_startup_3)
			v9 = *(*int32)(unsafe.Add(mBase, _c_F_spi_dest_startup[1]))
			v11 = *(*int32)(unsafe.Add(mBase, uint32(v6)+20))
			*(*int32)(unsafe.Add(mBase, _c_F_spi_dest_startup[1])) = v11
			v18 = F_AllocSetContextCreateInternal(m, v11, int32(_a_F_spi_dest_startup_4), int32(0), int32(_a_F_spi_dest_startup_5), int32(_a_F_spi_dest_startup_6))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return
			} else {
				*(*int32)(unsafe.Add(mBase, _c_F_spi_dest_startup[1])) = v18
