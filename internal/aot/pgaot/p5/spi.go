...
func F_SPI_connect_ext(m *base.Module, l0 int32) {
	...
	if v6 == int32(0) {
		v10 = *(*int32)(unsafe.Add(mBase, _consts[359]))
		if v10 != int32(-1) {
			...
			if v134 != 0 {
				...
				F_errmsg_internal(m, int32(464484), int32(0))
				mBase = m.M
				v138 = m.ExcPending
				if v138 != 0 {
					return
				} else {
					F_errfinish(m, int32(520523), int32(108), int32(69161))
					mBase = m.M
					v143 = m.ExcPending
					if v143 != 0 {
						return
			...
			v14 = *(*int32)(unsafe.Add(mBase, _consts[360]))
			if v14 != 0 {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v134 = m.ExcPending
				...
				if v20 != 0 {
					...
					v38 = int32(16)
					v39 = v19
					*(*int32)(unsafe.Add(mBase, _consts[360])) = v38
					*(*int32)(unsafe.Add(mBase, _consts[358])) = v39
					v44 = v39
					v47 = int32(4159284)
					v49 = *(*int32)(unsafe.Add(mBase, _consts[359]))
					v51 = v49 + int32(1)
					*(*int32)(unsafe.Add(mBase, _consts[359])) = v51
					v56 = v44 + v51<<(uint(int32(6))%32)
					*(*int32)(unsafe.Add(mBase, _consts[361])) = v56
					...
					*(*int64)(unsafe.Add(mBase, uint32(v56))) = v60
					...
					v70 = *(*int32)(unsafe.Add(mBase, _consts[361]))
					v71 = int32(0)
					...
					*(*int64)(unsafe.Add(mBase, uint32(v70)+48)) = v82
					v85 = *(*int32)(unsafe.Add(mBase, _consts[363]))
					*(*int32)(unsafe.Add(mBase, uint32(v70)+56)) = v85
					v88 = *(*int32)(unsafe.Add(mBase, _consts[364]))
					*(*int32)(unsafe.Add(mBase, uint32(v70)+60)) = v88
					...
					v98 = F_AllocSetContextCreateInternal(m, v93, int32(509779), int32(0), int32(8192), int32(8388608))
					mBase = m.M
					v99 = m.ExcPending
					if v99 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v101)+20)) = v98
						v104 = *(*int32)(unsafe.Add(mBase, _consts[317]))
						...
						v111 = F_AllocSetContextCreateInternal(m, v106, int32(512624), int32(0), int32(8192), int32(8388608))
						mBase = m.M
						v112 = m.ExcPending
						if v112 != 0 {
							return
						} else {
							v114 = *(*int32)(unsafe.Add(mBase, _consts[361]))
							...
							*(*int64)(unsafe.Add(mBase, _consts[362])) = int64(0)
							v126 = int32(0)
		...
		v22 = *(*int32)(unsafe.Add(mBase, _consts[360]))
		if v22 <= int32(0) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v148 = m.ExcPending
			if v148 != 0 {
				...
				if v152 != 0 {
					...
					F_errfinish(m, int32(520523), int32(118), int32(69161))
					mBase = m.M
					v157 = m.ExcPending
					if v157 != 0 {
						return
			...
			v26 = *(*int32)(unsafe.Add(mBase, _consts[359]))
			if v22 <= v26 {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v148 = m.ExcPending
...
L5:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+4)) = uint8(v10)
	...
	v14 = *(*int32)(unsafe.Add(mBase, _consts[365]))
...
func F_spi_dest_startup(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v77 int32
	_ = v77
	v6 = *(*int32)(unsafe.Add(mBase, _consts[361]))
	if v6 != 0 {
		...
		if v7 != 0 {
			...
			if v68 != 0 {
				...
				F_errmsg_internal(m, int32(242560), int32(0))
				mBase = m.M
				v72 = m.ExcPending
				if v72 != 0 {
					return
				} else {
					F_errfinish(m, int32(520523), int32(2133), int32(242577))
					mBase = m.M
					v77 = m.ExcPending
					if v77 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, _consts[10])) = v11
			v18 = F_AllocSetContextCreateInternal(m, v11, int32(414664), int32(0), int32(8192), int32(8388608))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return
		...
		if v55 != 0 {
			...
			F_errmsg_internal(m, int32(558374), int32(0))
			mBase = m.M
			v59 = m.ExcPending
			if v59 != 0 {
				return
			} else {
				F_errfinish(m, int32(520523), int32(2130), int32(242577))
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return
