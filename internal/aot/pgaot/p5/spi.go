...
func F_SPI_connect_ext(m *base.Module, l0 int32) {
	...
	var v157 int32
	_ = v157
	v6 = *(*int32)(unsafe.Add(mBase, _consts[356]))
	if v6 == int32(0) {
		v10 = *(*int32)(unsafe.Add(mBase, _consts[357]))
		if v10 != int32(-1) {
			...
			if v134 != 0 {
				...
				F_errmsg_internal(m, int32(466167), int32(0))
				mBase = m.M
				v138 = m.ExcPending
				if v138 != 0 {
					return
				} else {
					F_errfinish(m, int32(522671), int32(108), int32(69412))
					mBase = m.M
					v143 = m.ExcPending
					if v143 != 0 {
						return
			...
			if v14 != 0 {
				...
				if v20 != 0 {
					...
					v38 = int32(16)
					v39 = v19
					*(*int32)(unsafe.Add(mBase, _consts[358])) = v38
					*(*int32)(unsafe.Add(mBase, _consts[356])) = v39
					v44 = v39
					v47 = int32(4163716)
					v49 = *(*int32)(unsafe.Add(mBase, _consts[357]))
					v51 = v49 + int32(1)
					*(*int32)(unsafe.Add(mBase, _consts[357])) = v51
					v56 = v44 + v51<<(uint(int32(6))%32)
					*(*int32)(unsafe.Add(mBase, _consts[359])) = v56
					...
					*(*int64)(unsafe.Add(mBase, uint32(v56))) = v60
					...
					v70 = *(*int32)(unsafe.Add(mBase, _consts[359]))
					v71 = int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v70)+32)) = v68
					v82 = *(*int64)(unsafe.Add(mBase, _consts[360]))
					*(*int64)(unsafe.Add(mBase, uint32(v70)+48)) = v82
					v85 = *(*int32)(unsafe.Add(mBase, _consts[361]))
					*(*int32)(unsafe.Add(mBase, uint32(v70)+56)) = v85
					v88 = *(*int32)(unsafe.Add(mBase, _consts[362]))
					*(*int32)(unsafe.Add(mBase, uint32(v70)+60)) = v88
					...
					v98 = F_AllocSetContextCreateInternal(m, v93, int32(511844), int32(0), int32(8192), int32(8388608))
					mBase = m.M
					v99 = m.ExcPending
					if v99 != 0 {
						return
					} else {
						v101 = *(*int32)(unsafe.Add(mBase, _consts[359]))
						*(*int32)(unsafe.Add(mBase, uint32(v101)+20)) = v98
						...
						v111 = F_AllocSetContextCreateInternal(m, v106, int32(514689), int32(0), int32(8192), int32(8388608))
						mBase = m.M
						v112 = m.ExcPending
						if v112 != 0 {
							return
						} else {
							v114 = *(*int32)(unsafe.Add(mBase, _consts[359]))
							...
							*(*int64)(unsafe.Add(mBase, _consts[360])) = int64(0)
							v126 = int32(0)
							*(*int32)(unsafe.Add(mBase, _consts[361])) = v126
							*(*int32)(unsafe.Add(mBase, _consts[362])) = v126
							return
						}
					}
				}
		...
		v22 = *(*int32)(unsafe.Add(mBase, _consts[358]))
		if v22 <= int32(0) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v148 = m.ExcPending
			if v148 != 0 {
				...
				if v152 != 0 {
					...
					F_errfinish(m, int32(522671), int32(118), int32(69412))
					mBase = m.M
					v157 = m.ExcPending
					if v157 != 0 {
						return
...
L5:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+4)) = uint8(v10)
	...
	v14 = *(*int32)(unsafe.Add(mBase, _consts[363]))
	...
	if v6 != 0 {
		...
		if v7 != 0 {
			...
			if v68 != 0 {
				...
				F_errmsg_internal(m, int32(243532), int32(0))
				mBase = m.M
				v72 = m.ExcPending
				if v72 != 0 {
					return
				} else {
					F_errfinish(m, int32(522671), int32(2133), int32(243549))
					mBase = m.M
					v77 = m.ExcPending
					if v77 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, _consts[10])) = v11
			v18 = F_AllocSetContextCreateInternal(m, v11, int32(416167), int32(0), int32(8192), int32(8388608))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, _consts[10])) = v18
				...
				if v23 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v22)+32)) = v30
					v33 = *(*int32)(unsafe.Add(mBase, _consts[359]))
		...
		if v55 != 0 {
			...
			F_errmsg_internal(m, int32(560522), int32(0))
			mBase = m.M
			v59 = m.ExcPending
			if v59 != 0 {
				return
			} else {
				F_errfinish(m, int32(522671), int32(2130), int32(243549))
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return
