	...
	if v6 == int32(0) {
		...
		if v10 != int32(-1) {
			...
			if v134 != 0 {
				...
				F_errmsg_internal(m, int32(424197), int32(0))
				mBase = m.M
				v138 = m.ExcPending
				if v138 != 0 {
					return
				} else {
					F_errfinish(m, int32(474647), int32(108), int32(60656))
					mBase = m.M
					v143 = m.ExcPending
					if v143 != 0 {
						return
			...
			if v14 != 0 {
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _consts[363])) = v56
					...
					*(*int64)(unsafe.Add(mBase, uint32(v56))) = v60
					...
					v70 = *(*int32)(unsafe.Add(mBase, _consts[363]))
					v71 = int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v70)+32)) = v68
					v82 = *(*int64)(unsafe.Add(mBase, _consts[364]))
					*(*int64)(unsafe.Add(mBase, uint32(v70)+48)) = v82
					v85 = *(*int32)(unsafe.Add(mBase, _consts[365]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v70)+60)) = v88
					...
					v98 = F_AllocSetContextCreateInternal(m, v93, int32(466446), int32(0), int32(8192), int32(8388608))
					mBase = m.M
					v99 = m.ExcPending
					if v99 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v101)+20)) = v98
						v104 = *(*int32)(unsafe.Add(mBase, _consts[319]))
						...
						v111 = F_AllocSetContextCreateInternal(m, v106, int32(468925), int32(0), int32(8192), int32(8388608))
						mBase = m.M
						v112 = m.ExcPending
						if v112 != 0 {
							return
							...
							*(*int64)(unsafe.Add(mBase, _consts[364])) = int64(0)
							v126 = int32(0)
							*(*int32)(unsafe.Add(mBase, _consts[365])) = v126
							*(*int32)(unsafe.Add(mBase, _consts[366])) = v126
							return
						}
					}
				}
		...
		v22 = *(*int32)(unsafe.Add(mBase, _consts[362]))
		if v22 <= int32(0) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v148 = m.ExcPending
			if v148 != 0 {
				...
				if v152 != 0 {
					...
					F_errfinish(m, int32(474647), int32(118), int32(60656))
					mBase = m.M
					v157 = m.ExcPending
					if v157 != 0 {
						return
			...
			v26 = *(*int32)(unsafe.Add(mBase, _consts[361]))
			if v22 <= v26 {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v148 = m.ExcPending
...
L5:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+4)) = uint8(v10)
	...
	v14 = *(*int32)(unsafe.Add(mBase, _consts[367]))
...
func F_spi_dest_startup(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v77 int32
	_ = v77
	v6 = *(*int32)(unsafe.Add(mBase, _consts[363]))
	if v6 != 0 {
		...
		if v7 != 0 {
			...
			if v68 != 0 {
				...
				F_errmsg_internal(m, int32(220145), int32(0))
				mBase = m.M
				v72 = m.ExcPending
				if v72 != 0 {
					return
				} else {
					F_errfinish(m, int32(474647), int32(2133), int32(220162))
					mBase = m.M
					v77 = m.ExcPending
					if v77 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, _consts[9])) = v11
			v18 = F_AllocSetContextCreateInternal(m, v11, int32(378246), int32(0), int32(8192), int32(8388608))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, _consts[9])) = v18
				...
				if v23 != 0 {
					...
					v25 = *(*int32)(unsafe.Add(mBase, _consts[363]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v22)+32)) = v30
					v33 = *(*int32)(unsafe.Add(mBase, _consts[363]))
		...
		if v55 != 0 {
			...
			F_errmsg_internal(m, int32(510497), int32(0))
			mBase = m.M
			v59 = m.ExcPending
			if v59 != 0 {
				return
			} else {
				F_errfinish(m, int32(474647), int32(2130), int32(220162))
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return
