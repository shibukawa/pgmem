...
func F_pgmem_init(m *base.Module) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _consts[1341])) = int32(4732)
	*(*int32)(unsafe.Add(mBase, _consts[1342])) = int32(4731)
	*(*int32)(unsafe.Add(mBase, _consts[1343])) = int32(4733)
	*(*int32)(unsafe.Add(mBase, _consts[1344])) = int32(4734)
	*(*int32)(unsafe.Add(mBase, _consts[1345])) = int32(4735)
	return
}
