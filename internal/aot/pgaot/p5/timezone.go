	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0))) = uint8(v11)
	...
	if v28 != 0 {
		...
		if base.Ui32(int32(99)) < base.Ui32(v18) {
			...
			v39 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v18<<(uint(int32(1))%32))+uint32(_c_F_EncodeTimezone[0]))))
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v54))) = uint8(v55)
		...
		if base.Ui32(int32(99)) < base.Ui32(v23) {
			...
			v69 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v23<<(uint(int32(1))%32))+uint32(_c_F_EncodeTimezone[0]))))
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v115))) = uint8(v117)
		...
		if base.Ui32(int32(99)) < base.Ui32(v116) {
			...
			v131 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v116<<(uint(int32(1))%32))+uint32(_c_F_EncodeTimezone[0]))))
		...
		if base.Ui32(int32(99)) < base.Ui32(v18) {
			...
			v95 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v18<<(uint(int32(1))%32))+uint32(_c_F_EncodeTimezone[0]))))
...
func F_assign_timezone(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _c_F_assign_timezone[0])) = v4
	v10 = F__emscripten_memset_bulkmem(m, int32(_a_F_assign_timezone_0), base.I32_extend8_s(int32(0)), int32(500))
	mBase = m.M
	return
}
