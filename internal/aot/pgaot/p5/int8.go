...
func F_int8_accum_inv(m *base.Module, l0 int32) int32 {
	...
	if v14 != 0 {
		...
		if v111 != 0 {
			...
			F_errmsg_internal(m, int32(353290), int32(0))
			mBase = m.M
			v115 = m.ExcPending
			if v115 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(499971), int32(6151), int32(32740))
				mBase = m.M
				v120 = m.ExcPending
				if v120 != 0 {
					return int32(0)
							...
							if v91 != 0 {
								...
								if v90 == int32(0) {
									...
									if v124 != 0 {
										...
										F_errmsg_internal(m, int32(20432), int32(0))
										mBase = m.M
										v128 = m.ExcPending
										if v128 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(499971), int32(6157), int32(32740))
											mBase = m.M
											v133 = m.ExcPending
											if v133 != 0 {
												return int32(0)
