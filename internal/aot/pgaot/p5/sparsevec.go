			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(1000)
				...
				if v21 != 0 {
					...
					F_errfinish(m, int32(516475), int32(1369), int32(364183))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return
...
L33:
	;
	F_errfinish(m, int32(524189), int32(551), int32(38206))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L1
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v14
	F_errmsg(m, int32(488679), v12+int32(16))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L1
...
L41:
	;
	F_errfinish(m, int32(524189), int32(531), int32(38206))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
