			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(1000)
				...
				if v21 != 0 {
					...
					F_errfinish(m, int32(513465), int32(1369), int32(362055))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return
...
L32:
	;
	F_errmsg(m, int32(166296), int32(0))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(521057), int32(551), int32(37963))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L1
...
L41:
	;
	F_errfinish(m, int32(521057), int32(531), int32(37963))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
