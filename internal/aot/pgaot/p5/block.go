...
L31:
	;
	v171 = v4 & int32(_a_F_BlockRefTableMarkBlockModified_1)
	v172 = *(*int32)(unsafe.Add(mBase, uint32(v38)+32))
	v174 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v172+v144))))
	if v174 != int32(_a_F_BlockRefTableMarkBlockModified_2) {
		goto L36
	} else {
		goto L37
	}
...
L38:
	...
	v196 = v191 + int32(base.Ui32(v171)>>(uint(int32(3))%32))&int32(_a_F_BlockRefTableMarkBlockModified_3)
...
L40:
	...
	if v220 == v4&int32(_a_F_BlockRefTableMarkBlockModified_1) {
		goto L33
	} else {
		goto L42
	}
...
L44:
	;
	v228 = F_palloc0(m, int32(_a_F_BlockRefTableMarkBlockModified_4))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L48:
	;
	v293 = v228 + int32(base.Ui32(v171)>>(uint(int32(3))%32))&int32(_a_F_BlockRefTableMarkBlockModified_3)
...
L49:
	...
	v262 = v228 + int32(base.Ui32(v257)>>(uint(int32(3))%32))&int32(_a_F_BlockRefTableMarkBlockModified_3)
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v308+v302))) = v228
	...
	v313 = int32(_a_F_BlockRefTableMarkBlockModified_2)
