...
func F_ExecHash(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		F_errmsg_internal(m, int32(258505), int32(0))
		v11 = m.ExcPending
		if v11 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(518007), int32(93), int32(336769))
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
			} else {
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1212])) = v44
	v46 = F_strlen(m, l0)
	mBase = m.M
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1212])) = v33
	v39 = F_AllocSetContextCreateInternal(m, v33, int32(335716), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L8
...
L41:
	;
	v166 = *(*int32)(unsafe.Add(mBase, _consts[1212]))
...
L82:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v49))) = int64(0)
	v244 = *(*int32)(unsafe.Add(mBase, _consts[1212]))
	v245 = int32(0)
...
L133:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1212])) = v463
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1212])) = v493
...
L177:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1212])) = v629
...
L199:
	;
	F_s_lock(m, v751, int32(517983), int32(1742), int32(507337))
	mBase = m.M
	v761 = m.ExcPending
	if v761 != 0 {
		goto L8
...
L208:
	;
	F_errfinish(m, int32(517983), int32(517), int32(370126))
	mBase = m.M
	v833 = m.ExcPending
	if v833 != 0 {
		goto L8
...
L212:
	;
	F_errfinish(m, int32(517983), int32(617), int32(370126))
	mBase = m.M
	v853 = m.ExcPending
	if v853 != 0 {
		goto L8
...
L214:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v876
	F_errmsg_internal(m, int32(747342), v19)
	mBase = m.M
	v880 = m.ExcPending
	if v880 != 0 {
		goto L8
...
L215:
	;
	F_errfinish(m, int32(517983), int32(569), int32(370126))
	mBase = m.M
	v885 = m.ExcPending
	if v885 != 0 {
		goto L8
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v24
	F_errmsg_internal(m, int32(385310), v16)
	mBase = m.M
	v244 = m.ExcPending
	if v244 != 0 {
		goto L1
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v258
	F_errmsg(m, int32(198571), v16+int32(16))
	mBase = m.M
	v265 = m.ExcPending
	if v265 != 0 {
		goto L1
...
L50:
	;
	F_errfinish(m, int32(513647), int32(2879), int32(478331))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L629:
	;
	F_errmsg_internal(m, int32(302695), int32(0))
	mBase = m.M
	v2359 = m.ExcPending
	if v2359 != 0 {
		goto L20
...
L630:
	;
	F_errfinish(m, int32(518176), int32(142), int32(87318))
	mBase = m.M
	v2364 = m.ExcPending
	if v2364 != 0 {
		goto L20
...
L632:
	;
	F_errmsg_internal(m, int32(424321), int32(0))
	mBase = m.M
	v2372 = m.ExcPending
	if v2372 != 0 {
		goto L20
...
L633:
	;
	F_errfinish(m, int32(518176), int32(433), int32(422832))
	mBase = m.M
	v2377 = m.ExcPending
	if v2377 != 0 {
		goto L20
...
L635:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v1370
	F_errmsg_internal(m, int32(167884), v15+int32(16))
	mBase = m.M
	v2387 = m.ExcPending
	if v2387 != 0 {
		goto L20
...
L636:
	;
	F_errfinish(m, int32(518176), int32(563), int32(127523))
	mBase = m.M
	v2392 = m.ExcPending
	if v2392 != 0 {
		goto L20
...
L638:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v1617
	F_errmsg_internal(m, int32(167967), v15+int32(32))
	mBase = m.M
	v2402 = m.ExcPending
	if v2402 != 0 {
		goto L20
...
L639:
	;
	F_errfinish(m, int32(518176), int32(695), int32(422932))
	mBase = m.M
	v2407 = m.ExcPending
	if v2407 != 0 {
		goto L20
...
L641:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v20
	F_errmsg_internal(m, int32(56885), v15)
	mBase = m.M
	v2415 = m.ExcPending
	if v2415 != 0 {
		goto L20
...
L642:
	;
	F_errfinish(m, int32(518176), int32(1113), int32(252769))
	mBase = m.M
	v2420 = m.ExcPending
	if v2420 != 0 {
		goto L20
...
L5:
	;
	v34 = *(*int32)(unsafe.Add(mBase, _consts[1213]))
	if int32(0) < v34 {
		goto L6
	} else {
		goto L7
...
L9:
	;
	v61 = *(*int32)(unsafe.Add(mBase, uint32(v42<<(uint(int32(2))%32))+uint32(_consts[1214])))
	if v61 == l0 {
		goto L1
	} else {
		goto L11
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1212])) = v156
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1212])) = v100
...
L103:
	;
	F_s_lock(m, v420, int32(517983), int32(1050), int32(359511))
	mBase = m.M
	v430 = m.ExcPending
	if v430 != 0 {
		goto L21
...
L118:
	;
	F_s_lock(m, v458, int32(517983), int32(1268), int32(12223))
	mBase = m.M
	v491 = m.ExcPending
	if v491 != 0 {
		goto L21
...
L131:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1212])) = v504
...
L139:
	;
	F_s_lock(m, v551, int32(517983), int32(1306), int32(12223))
	mBase = m.M
	v559 = m.ExcPending
	if v559 != 0 {
		goto L21
...
L146:
	;
	F_s_lock(m, v458, int32(517983), int32(1315), int32(12223))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L21
...
L159:
	;
	F_errfinish(m, int32(517983), int32(1100), int32(359511))
	mBase = m.M
	v625 = m.ExcPending
	if v625 != 0 {
		goto L21
...
L161:
	;
	F_errfinish(m, int32(517983), int32(1096), int32(359511))
	mBase = m.M
	v634 = m.ExcPending
	if v634 != 0 {
		goto L21
...
L181:
	;
	F_s_lock(m, v816, int32(517983), int32(1742), int32(507337))
	mBase = m.M
	v826 = m.ExcPending
	if v826 != 0 {
		goto L21
...
L184:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v842
	F_errmsg_internal(m, int32(745118), v23+int32(16))
	mBase = m.M
	v848 = m.ExcPending
	if v848 != 0 {
		goto L21
...
L185:
	;
	F_errfinish(m, int32(517983), int32(1084), int32(359511))
	mBase = m.M
	v853 = m.ExcPending
	if v853 != 0 {
		goto L21
...
L191:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = l3
	F_errmsg_internal(m, int32(505095), v23)
	mBase = m.M
	v891 = m.ExcPending
	if v891 != 0 {
		goto L21
...
L192:
	;
	F_errfinish(m, int32(517983), int32(1121), int32(359511))
	mBase = m.M
	v896 = m.ExcPending
	if v896 != 0 {
		goto L21
...
func F_hash_seq_init(m *base.Module, l0 int32, l1 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+12)) = uint8(v3)
	...
	if v13 == v3 {
		v17 = *(*int32)(unsafe.Add(mBase, _consts[1213]))
		if int32(100) <= v17 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v47 = m.ExcPending
			if v47 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v48
				F_errmsg_internal(m, int32(737595), v6)
				mBase = m.M
				v52 = m.ExcPending
				if v52 != 0 {
					return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v17<<(uint(int32(2))%32))+uint32(_consts[1214]))) = l1
			v26 = *(*int32)(unsafe.Add(mBase, _consts[40]))
			v27 = *(*int32)(unsafe.Add(mBase, uint32(v26)+28))
			v28 = int32(4542560)
			v29 = *(*int32)(unsafe.Add(mBase, _consts[1213]))
			*(*int32)(unsafe.Add(mBase, uint32(v29<<(uint(int32(2))%32))+uint32(_consts[1215]))) = v27
			*(*int32)(unsafe.Add(mBase, _consts[1213])) = v29 + int32(1)
			m.G0 = v6 + int32(16)
			return
		}
	} else {
