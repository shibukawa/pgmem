...
L58:
	;
	v222 = *(*int32)(unsafe.Add(mBase, _c_F_hash_create[0]))
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v105)+4)) = v278 + int32(432)
	if l3&int32(_a_F_hash_create_4) == v281 {
		goto L96
	} else {
		goto L100
	}
...
L99:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v105))) = int64(0)
	v300 = *(*int32)(unsafe.Add(mBase, _c_F_hash_create[0]))
	v301 = int32(0)
...
L150:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_hash_create[0])) = v519
...
L158:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_hash_create[0])) = v549
...
L194:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_hash_create[0])) = v685
...
L216:
	;
	F_s_lock(m, v807, int32(_a_F_hash_create_5), int32(1742), int32(_a_F_hash_create_6))
	mBase = m.M
	v817 = m.ExcPending
	if v817 != 0 {
		goto L8
