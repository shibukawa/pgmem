...
func F_ExecHash(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		if v11 != 0 {
			...
			F_errfinish(m, int32(494751), int32(93), int32(321916))
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
			} else {
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1216])) = v44
	v46 = F_strlen(m, l0)
	mBase = m.M
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1216])) = v33
...
L41:
	;
	v166 = *(*int32)(unsafe.Add(mBase, _consts[1216]))
...
L82:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v49))) = int64(0)
	v244 = *(*int32)(unsafe.Add(mBase, _consts[1216]))
	v245 = int32(0)
...
L133:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1216])) = v463
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1216])) = v493
...
L177:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1216])) = v629
...
L199:
	;
	F_s_lock(m, v751, int32(494727), int32(1742), int32(485893))
	mBase = m.M
	v761 = m.ExcPending
	if v761 != 0 {
		goto L8
...
L208:
	;
	F_errfinish(m, int32(494727), int32(517), int32(353213))
	mBase = m.M
	v833 = m.ExcPending
	if v833 != 0 {
		goto L8
...
L212:
	;
	F_errfinish(m, int32(494727), int32(617), int32(353213))
	mBase = m.M
	v853 = m.ExcPending
	if v853 != 0 {
		goto L8
...
L214:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v876
	F_errmsg_internal(m, int32(701059), v19)
	mBase = m.M
	v880 = m.ExcPending
	if v880 != 0 {
		goto L8
...
L215:
	;
	F_errfinish(m, int32(494727), int32(569), int32(353213))
	mBase = m.M
	v885 = m.ExcPending
	if v885 != 0 {
		goto L8
...
L50:
	;
	F_errfinish(m, int32(490989), int32(2879), int32(458329))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L630:
	;
	F_errfinish(m, int32(494920), int32(142), int32(81345))
	mBase = m.M
	v2364 = m.ExcPending
	if v2364 != 0 {
		goto L20
...
L633:
	;
	F_errfinish(m, int32(494920), int32(433), int32(404605))
	mBase = m.M
	v2377 = m.ExcPending
	if v2377 != 0 {
		goto L20
...
L636:
	;
	F_errfinish(m, int32(494920), int32(563), int32(119921))
	mBase = m.M
	v2392 = m.ExcPending
	if v2392 != 0 {
		goto L20
...
L639:
	;
	F_errfinish(m, int32(494920), int32(695), int32(404705))
	mBase = m.M
	v2407 = m.ExcPending
	if v2407 != 0 {
		goto L20
...
L642:
	;
	F_errfinish(m, int32(494920), int32(1113), int32(241365))
	mBase = m.M
	v2420 = m.ExcPending
	if v2420 != 0 {
		goto L20
...
L5:
	;
	v34 = *(*int32)(unsafe.Add(mBase, _consts[1217]))
	if int32(0) < v34 {
		goto L6
	} else {
		goto L7
...
L9:
	;
	v61 = *(*int32)(unsafe.Add(mBase, uint32(v42<<(uint(int32(2))%32))+uint32(_consts[1218])))
	if v61 == l0 {
		goto L1
	} else {
		goto L11
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1216])) = v156
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1216])) = v100
...
L103:
	;
	F_s_lock(m, v420, int32(494727), int32(1050), int32(343073))
	mBase = m.M
	v430 = m.ExcPending
	if v430 != 0 {
		goto L21
...
L118:
	;
	F_s_lock(m, v458, int32(494727), int32(1268), int32(12146))
	mBase = m.M
	v491 = m.ExcPending
	if v491 != 0 {
		goto L21
...
L139:
	;
	F_s_lock(m, v551, int32(494727), int32(1306), int32(12146))
	mBase = m.M
	v559 = m.ExcPending
	if v559 != 0 {
		goto L21
...
L146:
	;
	F_s_lock(m, v458, int32(494727), int32(1315), int32(12146))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L21
...
L159:
	;
	F_errfinish(m, int32(494727), int32(1100), int32(343073))
	mBase = m.M
	v625 = m.ExcPending
	if v625 != 0 {
		goto L21
...
L161:
	;
	F_errfinish(m, int32(494727), int32(1096), int32(343073))
	mBase = m.M
	v634 = m.ExcPending
	if v634 != 0 {
		goto L21
...
L181:
	;
	F_s_lock(m, v816, int32(494727), int32(1742), int32(485893))
	mBase = m.M
	v826 = m.ExcPending
	if v826 != 0 {
		goto L21
...
L184:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v842
	F_errmsg_internal(m, int32(698835), v23+int32(16))
	mBase = m.M
	v848 = m.ExcPending
	if v848 != 0 {
		goto L21
...
L185:
	;
	F_errfinish(m, int32(494727), int32(1084), int32(343073))
	mBase = m.M
	v853 = m.ExcPending
	if v853 != 0 {
		goto L21
...
L191:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = l3
	F_errmsg_internal(m, int32(483677), v23)
	mBase = m.M
	v891 = m.ExcPending
	if v891 != 0 {
		goto L21
...
L192:
	;
	F_errfinish(m, int32(494727), int32(1121), int32(343073))
	mBase = m.M
	v896 = m.ExcPending
	if v896 != 0 {
		goto L21
...
func F_hash_seq_init(m *base.Module, l0 int32, l1 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+12)) = uint8(v3)
	...
	if v13 == v3 {
		v17 = *(*int32)(unsafe.Add(mBase, _consts[1217]))
		if int32(100) <= v17 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v47 = m.ExcPending
			if v47 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v48
				F_errmsg_internal(m, int32(691370), v6)
				mBase = m.M
				v52 = m.ExcPending
				if v52 != 0 {
					return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v17<<(uint(int32(2))%32))+uint32(_consts[1218]))) = l1
			v26 = *(*int32)(unsafe.Add(mBase, _consts[39]))
			v27 = *(*int32)(unsafe.Add(mBase, uint32(v26)+28))
			v28 = int32(4480720)
			v29 = *(*int32)(unsafe.Add(mBase, _consts[1217]))
			*(*int32)(unsafe.Add(mBase, uint32(v29<<(uint(int32(2))%32))+uint32(_consts[1219]))) = v27
			*(*int32)(unsafe.Add(mBase, _consts[1217])) = v29 + int32(1)
			m.G0 = v6 + int32(16)
			return
		}
	} else {
