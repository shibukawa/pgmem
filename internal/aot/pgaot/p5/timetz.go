						...
						if v67 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v66
							...
							if v71 != 0 {
								...
								F_errfinish(m, int32(_a_F_timetz_izone_1), int32(3206), int32(_a_F_timetz_izone_2))
								mBase = m.M
								v76 = m.ExcPending
								if v76 != 0 {
									return int32(0)
								...
								if v42 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v41
									...
									if v48 != 0 {
										...
										F_errfinish(m, int32(_a_F_timetz_izone_1), int32(3199), int32(_a_F_timetz_izone_2))
										mBase = m.M
										v53 = m.ExcPending
										if v53 != 0 {
											return int32(0)
