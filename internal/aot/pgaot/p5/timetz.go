	...
	if v26 == int32(0) {
		...
		if v47 != 0 {
			...
			if v44 == int32(0) {
				...
				v50 = v44
				F_DateTimeParseError(m, v50, v12+int32(8), v16, int32(373480), v15)
				mBase = m.M
				v55 = m.ExcPending
				if v55 != 0 {
					return int32(0)
					...
					if v63 != 0 {
						...
						if v67 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v66
							F_errmsg(m, int32(113812), v10)
							mBase = m.M
							v71 = m.ExcPending
							if v71 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(499833), int32(3206), int32(373111))
								mBase = m.M
								v76 = m.ExcPending
								if v76 != 0 {
									return int32(0)
							...
							if v38 != 0 {
								...
								if v42 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v41
									F_errmsg(m, int32(351312), v10+int32(16))
									mBase = m.M
									v48 = m.ExcPending
									if v48 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(499833), int32(3199), int32(373111))
										mBase = m.M
										v53 = m.ExcPending
										if v53 != 0 {
											return int32(0)
