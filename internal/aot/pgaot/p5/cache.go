...
L1:
	;
	v215 = *(*int32)(unsafe.Add(mBase, _c_F_PlanCacheRelCallback[1]))
	if v215 == int32(0) {
		goto L72
	} else {
		goto L73
...
L2:
	;
	if v8 == int32(_a_F_PlanCacheRelCallback_0) {
		goto L1
	} else {
		goto L3
	}
...
L6:
	...
	if v205 != int32(_a_F_PlanCacheRelCallback_0) {
		v13 = v205
		goto L4
	} else {
		goto L71
...
L73:
	;
	if v215 == int32(_a_F_PlanCacheRelCallback_1) {
		goto L72
	} else {
		goto L74
	}
...
L77:
	...
	if v280 != int32(_a_F_PlanCacheRelCallback_1) {
		v220 = v280
		goto L75
	} else {
		goto L98
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+312)) = v124 | int32(_a_F_cache_record_field_properties_0)
	return
L2:
	;
	v11 = *(*int32)(unsafe.Add(mBase, uint32(l0)+312))
	*(*int32)(unsafe.Add(mBase, uint32(l0)+312)) = v11 | int32(_a_F_cache_record_field_properties_1)
	goto L1
L3:
	;
	goto L4
...
L12:
	;
	v27 = int32(_a_F_cache_record_field_properties_2)
...
L17:
	...
	v54 = F_lookup_type_cache(m, v52, int32(_a_F_cache_record_field_properties_3))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L10
...
L40:
	;
	v103 = F_lookup_type_cache(m, v101, int32(_a_F_cache_record_field_properties_3))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L10
...
L43:
	...
	v110 = v108 | int32(_a_F_cache_record_field_properties_4)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+312)) = v110
	v112 = *(*int32)(unsafe.Add(mBase, uint32(v103)+312))
	*(*int32)(unsafe.Add(mBase, uint32(l0)+312)) = v112&int32(_a_F_cache_record_field_properties_2) | v110
	goto L1
}
