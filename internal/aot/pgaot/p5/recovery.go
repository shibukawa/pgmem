...
func F_CheckRecoveryConsistency(m *base.Module) {
	...
	v11 = v9 - int32(1120)
	m.G0 = v11
	v14 = *(*int64)(unsafe.Add(mBase, _consts[170]))
	if v14 == int64(0) {
		goto L1
	} else {
		goto L2
...
L2:
	...
	v21 = *(*int64)(unsafe.Add(mBase, _consts[173]))
...
L3:
	;
	v107 = int32(*(*uint8)(unsafe.Add(mBase, _consts[174])))
	if v107 != 0 {
		goto L22
	} else {
		goto L23
...
L4:
	...
	v27 = *(*int64)(unsafe.Add(mBase, _consts[175]))
...
L7:
	;
	F_errmsg_internal(m, int32(481109), int32(0))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L5
...
L10:
	;
	F_errfinish(m, int32(515869), int32(2226), int32(23619))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L5
...
L15:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v49)+160)) = v54
	v61 = *(*int32)(unsafe.Add(mBase, _consts[134]))
...
L17:
	;
	v71 = int64(0)
	*(*int64)(unsafe.Add(mBase, _consts[173])) = v71
	*(*int64)(unsafe.Add(mBase, _consts[175])) = v71
	v77 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[176])) = uint8(v77)
...
L19:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v11)+64)) = uint32(v91)
	F_errmsg(m, int32(541789), v11-int32(-64))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L5
...
L20:
	;
	F_errfinish(m, int32(515869), int32(2240), int32(23619))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L5
...
L23:
	;
	v109 = int32(*(*uint8)(unsafe.Add(mBase, _consts[176])))
	if v109 != 0 {
		goto L22
	} else {
		goto L24
...
L24:
	;
	v111 = *(*int64)(unsafe.Add(mBase, _consts[170]))
...
L25:
	...
	v115 = v113 - int32(112)
	m.G0 = v115
	v118 = *(*int32)(unsafe.Add(mBase, _consts[177]))
	if v118 != 0 {
		goto L26
	} else {
		goto L27
...
L28:
	;
	m.G0 = v115 + int32(112)
	v221 = F_AllocateDir(m, int32(511774))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L5
...
L30:
	;
	v203 = *(*int32)(unsafe.Add(mBase, _consts[177]))
...
L34:
	;
	v178 = int32(*(*uint8)(unsafe.Add(mBase, _consts[178])))
	if v178 != 0 {
		goto L50
	} else {
		goto L51
...
L46:
	;
	F_errfinish(m, int32(518033), v166, int32(426658))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L5
...
L54:
	;
	F_errmsg_internal(m, int32(181356), int32(0))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L5
...
L55:
	;
	F_errfinish(m, int32(518033), int32(258), int32(181558))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L5
...
L57:
	;
	*(*int32)(unsafe.Add(mBase, _consts[177])) = int32(0)
	goto L28
L58:
	;
	v224 = F_ReadDir(m, v221, int32(511774))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L5
...
L62:
	;
	v390 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[174])) = uint8(v390)
...
L63:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v242))) = v243
	v251 = int32(*(*uint8)(unsafe.Add(mBase, _consts[179])))
	if v251 == int32(0) {
		goto L67
	} else {
		goto L68
...
L65:
	;
	v379 = F_ReadDir(m, v221, int32(511774))
	mBase = m.M
	v380 = m.ExcPending
	if v380 != 0 {
		goto L5
...
L69:
	;
	v255 = int32(*(*uint8)(unsafe.Add(mBase, _consts[180])))
	if v255 == int32(0) {
		goto L70
	} else {
		goto L71
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = int32(511774)
	v331 = F_pg_snprintf(m, v11+int32(80), int32(1034), int32(187744), v11+int32(48))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L5
...
L90:
	;
	v344 = int32(*(*uint8)(unsafe.Add(mBase, _consts[181])))
	if v344 != 0 {
		goto L91
	} else {
		goto L92
...
L96:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+36)) = int32(511774)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v235
	F_errmsg(m, int32(195842), v11+int32(32))
	mBase = m.M
	v361 = m.ExcPending
	if v361 != 0 {
		goto L5
...
L97:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(511774)
	F_errdetail(m, int32(622802), v11+int32(16))
	mBase = m.M
	v368 = m.ExcPending
	if v368 != 0 {
		goto L5
...
L98:
	;
	F_errhint(m, int32(659279), int32(0))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L5
...
L99:
	;
	F_errfinish(m, int32(515869), int32(2186), int32(13755))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L5
...
L106:
	;
	F_errfinish(m, int32(515869), int32(2270), int32(23619))
	mBase = m.M
	v412 = m.ExcPending
	if v412 != 0 {
		goto L5
...
L108:
	;
	v426 = int32(*(*uint8)(unsafe.Add(mBase, _consts[182])))
	if v426 != 0 {
		goto L1
	} else {
		goto L109
...
L109:
	;
	v428 = int32(*(*uint8)(unsafe.Add(mBase, _consts[174])))
	if v428 != int32(1) {
		goto L1
	} else {
		goto L110
...
L110:
	;
	v432 = int32(*(*uint8)(unsafe.Add(mBase, _consts[183])))
	if v432 != int32(1) {
		goto L1
	} else {
		goto L111
...
L111:
	;
	v436 = *(*int32)(unsafe.Add(mBase, _consts[172]))
...
L112:
	;
	v441 = *(*int32)(unsafe.Add(mBase, _consts[172]))
	F_s_lock(m, v441+int32(96), int32(515869), int32(2283), int32(23619))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L5
...
func F_RecoveryInProgress(m *base.Module) int32 {
	...
	var v13 int32
	_ = v13
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _consts[111])))
	if v3 == int32(1) {
		v8 = *(*int32)(unsafe.Add(mBase, _consts[112]))
		v9 = *(*int32)(unsafe.Add(mBase, uint32(v8)+316))
		v11 = base.B2i32(v9 != int32(2))
		*(*uint8)(unsafe.Add(mBase, _consts[111])) = uint8(v11)
		v13 = v11
	} else {
		v13 = int32(0)
	}
...
func F_SetRecoveryPause(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5)+96)) = int32(1)
	if v6 != 0 {
		v10 = *(*int32)(unsafe.Add(mBase, _consts[172]))
		F_s_lock(m, v10+int32(96), int32(515869), int32(3114), int32(378057))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
		} else {
			v19 = *(*int32)(unsafe.Add(mBase, _consts[172]))
			if l0 != 0 {
...
func F_assign_recovery_prefetch(m *base.Module, l0 int32, l1 int32) {
	...
	var v11 int32
	_ = v11
	*(*int32)(unsafe.Add(mBase, _consts[154])) = l0
	v6 = *(*int32)(unsafe.Add(mBase, _consts[20]))
	if v6 == int32(13) {
		v9 = int32(4457936)
		v11 = *(*int32)(unsafe.Add(mBase, _consts[155]))
		*(*int32)(unsafe.Add(mBase, _consts[155])) = v11 + int32(1)
	} else {
	}
	return
}
func F_assign_recovery_target_name(m *base.Module, l0 int32, l1 int32) {
	...
	var v9 int32
	_ = v9
	v4 = *(*int32)(unsafe.Add(mBase, _consts[185]))
	switch v4 {
	case 0, 3:
		if l0 == int32(0) {
			*(*int32)(unsafe.Add(mBase, _consts[185])) = int32(0)
			...
			if v9 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, _consts[186])) = l0
				*(*int32)(unsafe.Add(mBase, _consts[185])) = int32(3)
				return
			}
		}
	default:
