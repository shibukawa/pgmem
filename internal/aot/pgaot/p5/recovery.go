...
L7:
	;
	F_errmsg_internal(m, int32(449485), int32(0))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L5
...
L10:
	;
	F_errfinish(m, int32(481305), int32(2226), int32(22481))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L5
...
L19:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v11)+64)) = uint32(v91)
	F_errmsg(m, int32(504111), v11-int32(-64))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L5
...
L20:
	;
	F_errfinish(m, int32(481305), int32(2240), int32(22481))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L5
...
L28:
	;
	m.G0 = v115 + int32(112)
	v221 = F_AllocateDir(m, int32(477915))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L5
...
L46:
	;
	F_errfinish(m, int32(482827), v166, int32(398236))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L5
...
L54:
	;
	F_errmsg_internal(m, int32(167285), int32(0))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L5
...
L55:
	;
	F_errfinish(m, int32(482827), int32(258), int32(167454))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L5
...
L58:
	;
	v224 = F_ReadDir(m, v221, int32(477915))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L5
...
L65:
	;
	v435 = F_ReadDir(m, v221, int32(477915))
	mBase = m.M
	v436 = m.ExcPending
	if v436 != 0 {
		goto L5
...
L104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = int32(477915)
	v387 = F_pg_snprintf(m, v11+int32(80), int32(1034), int32(173305), v11+int32(48))
	mBase = m.M
	v388 = m.ExcPending
	if v388 != 0 {
		goto L5
...
L113:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+36)) = int32(477915)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v235
	F_errmsg(m, int32(181329), v11+int32(32))
	mBase = m.M
	v417 = m.ExcPending
	if v417 != 0 {
		goto L5
...
L114:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(477915)
	F_errdetail(m, int32(566541), v11+int32(16))
	mBase = m.M
	v424 = m.ExcPending
	if v424 != 0 {
		goto L5
...
L115:
	;
	F_errhint(m, int32(601694), int32(0))
	mBase = m.M
	v428 = m.ExcPending
	if v428 != 0 {
		goto L5
...
L116:
	;
	F_errfinish(m, int32(481305), int32(2186), int32(13292))
	mBase = m.M
	v433 = m.ExcPending
	if v433 != 0 {
		goto L5
...
L123:
	;
	F_errfinish(m, int32(481305), int32(2270), int32(22481))
	mBase = m.M
	v468 = m.ExcPending
	if v468 != 0 {
		goto L5
...
L129:
	...
	F_s_lock(m, v497+int32(96), int32(481305), int32(2283), int32(22481))
	mBase = m.M
	v504 = m.ExcPending
	if v504 != 0 {
		goto L5
...
func F_SetRecoveryPause(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5)+96)) = int32(1)
	if v6 != 0 {
		...
		F_s_lock(m, v10+int32(96), int32(481305), int32(3114), int32(351919))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
