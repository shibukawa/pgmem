...
func F_CheckRecoveryConsistency(m *base.Module) {
	...
	v11 = v9 - int32(1120)
	m.G0 = v11
	v14 = *(*int64)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[0]))
	if v14 == int64(0) {
		goto L1
	} else {
		goto L2
...
L2:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[1]))
	v19 = *(*int64)(unsafe.Add(mBase, uint32(v18)+32))
	v21 = *(*int64)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[2]))
...
L3:
	;
	v107 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[3])))
	if v107 != 0 {
		goto L22
	} else {
		goto L23
...
L4:
	...
	v27 = *(*int64)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[4]))
...
L9:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[5]))
...
L12:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[6]))
...
L15:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v49)+160)) = v54
	v61 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[7]))
...
L16:
	;
	v65 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[5]))
...
L17:
	;
	v71 = int64(0)
	*(*int64)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[2])) = v71
	*(*int64)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[4])) = v71
	v77 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[8])) = uint8(v77)
...
L19:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v11)+64)) = uint32(v91)
	F_errmsg(m, int32(_a_F_CheckRecoveryConsistency_3), v11-int32(-64))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L5
...
L22:
	;
	v422 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[9]))
	if v422 != int32(3) {
		goto L1
	} else {
		goto L108
...
L23:
	;
	v109 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[8])))
	if v109 != 0 {
		goto L22
	} else {
		goto L24
...
L24:
	;
	v111 = *(*int64)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[0]))
...
L25:
	...
	v115 = v113 - int32(112)
	m.G0 = v115
	v118 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[10]))
	if v118 != 0 {
		goto L26
	} else {
		goto L27
...
L28:
	;
	m.G0 = v115 + int32(112)
	v221 = F_AllocateDir(m, int32(_a_F_CheckRecoveryConsistency_4))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L5
...
L30:
	;
	v203 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[10]))
...
L58:
	;
	v224 = F_ReadDir(m, v221, int32(_a_F_CheckRecoveryConsistency_4))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L5
...
L62:
	;
	v390 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[3])) = uint8(v390)
...
L63:
	;
	v235 = v227 + int32(19)
	v236 = int32(_a_F_CheckRecoveryConsistency_11)
	v240 = m.G0
	v242 = v240 - int32(32)
	v243 = int64(0)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v242))) = v243
	v251 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[12])))
	if v251 == int32(0) {
		goto L67
	} else {
		goto L68
...
L65:
	;
	v379 = F_ReadDir(m, v221, int32(_a_F_CheckRecoveryConsistency_4))
	mBase = m.M
	v380 = m.ExcPending
	if v380 != 0 {
		goto L5
...
L69:
	;
	v255 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[13])))
	if v255 == int32(0) {
		goto L70
	} else {
		goto L71
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = int32(_a_F_CheckRecoveryConsistency_4)
	v331 = F_pg_snprintf(m, v11+int32(80), int32(1034), int32(_a_F_CheckRecoveryConsistency_12), v11+int32(48))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L5
...
L90:
	;
	v344 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[14])))
	if v344 != 0 {
		goto L91
	} else {
		goto L92
...
L96:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+36)) = int32(_a_F_CheckRecoveryConsistency_4)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v235
	F_errmsg(m, int32(_a_F_CheckRecoveryConsistency_13), v11+int32(32))
	mBase = m.M
	v361 = m.ExcPending
	if v361 != 0 {
		goto L5
...
L97:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(_a_F_CheckRecoveryConsistency_4)
	F_errdetail(m, int32(_a_F_CheckRecoveryConsistency_14), v11+int32(16))
	mBase = m.M
	v368 = m.ExcPending
	if v368 != 0 {
		goto L5
...
L105:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v11))) = uint32(v403)
	F_errmsg(m, int32(_a_F_CheckRecoveryConsistency_17), v11)
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L5
...
L108:
	;
	v426 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[15])))
	if v426 != 0 {
		goto L1
	} else {
		goto L109
...
L109:
	;
	v428 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[3])))
	if v428 != int32(1) {
		goto L1
	} else {
		goto L110
...
L110:
	;
	v432 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[16])))
	if v432 != int32(1) {
		goto L1
	} else {
		goto L111
...
L111:
	;
	v436 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[1]))
...
L112:
	;
	v441 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[1]))
	F_s_lock(m, v441+int32(96), int32(_a_F_CheckRecoveryConsistency_1), int32(2283), int32(_a_F_CheckRecoveryConsistency_2))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L5
...
L114:
	;
	v450 = *(*int32)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v450)+96)) = int32(0)
	v453 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v450))) = uint8(v453)
	*(*uint8)(unsafe.Add(mBase, _c_F_CheckRecoveryConsistency[15])) = uint8(v453)
