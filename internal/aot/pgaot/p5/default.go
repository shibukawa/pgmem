...
func F_GetDefaultTablespace(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 == int32(116) {
		...
		if v10 != 0 {
			...
			v12 = *(*int32)(unsafe.Add(mBase, _consts[311]))
			if int32(0) < v12 {
				v15 = int32(4405184)
				v17 = *(*int32)(unsafe.Add(mBase, _consts[312]))
				v19 = v17 + int32(1)
				if v19 < v12 {
					v22 = v19
				} else {
				...
				*(*int32)(unsafe.Add(mBase, _consts[312])) = v22
				v25 = *(*int32)(unsafe.Add(mBase, _consts[313]))
		...
		v33 = int32(0)
		v35 = *(*int32)(unsafe.Add(mBase, _consts[314]))
		if v35 == v33 {
			v68 = v33
			return v68
		} else {
							...
							if v55 != 0 {
								...
								if v58 != 0 {
									...
									if v62 != 0 {
										...
										F_errfinish(m, int32(497723), int32(1178), int32(418014))
										mBase = m.M
										v67 = m.ExcPending
										if v67 != 0 {
											return int32(0)
