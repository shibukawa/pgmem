...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = base.I32_extend16_s(v95)
	F_errmsg_internal(m, int32(501949), v16)
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L36
...
L4:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L6:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L22:
	;
	v131 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L24:
	;
	v139 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L66:
	;
	v499 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L68:
	;
	v507 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L105:
	;
	v809 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L107:
	;
	v817 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L111:
	;
	v853 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L113:
	;
	v861 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L232:
	;
	v1801 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L234:
	;
	v1809 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L327:
	;
	v2252 = int32(4543684)
	v2254 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v2254 + int32(1)
...
L330:
	;
	v2300 = int32(4543684)
	v2302 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v2302 - int32(1)
...
L331:
	;
	v2267 = *(*int32)(unsafe.Add(mBase, _consts[15]))
	if v2267 <= int32(0) {
		goto L332
	} else {
		goto L333
...
L344:
	;
	F_errmsg_internal(m, int32(21356), int32(0))
	mBase = m.M
	v2322 = m.ExcPending
	if v2322 != 0 {
		goto L25
...
L345:
	;
	F_errfinish(m, int32(515690), int32(130), int32(137795))
	mBase = m.M
	v2327 = m.ExcPending
	if v2327 != 0 {
		goto L25
...
L33:
	;
	v122 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L35:
	;
	v130 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L37:
	;
	v145 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L39:
	;
	v153 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L205:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v167))) = v1110 + int32(4)
	F_errmsg_internal(m, int32(718782), v167)
	mBase = m.M
	v1116 = m.ExcPending
	if v1116 != 0 {
		goto L21
...
L206:
	;
	F_errfinish(m, int32(520653), int32(261), int32(507476))
	mBase = m.M
	v1121 = m.ExcPending
	if v1121 != 0 {
		goto L21
...
L380:
	;
	v2223 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L382:
	;
	v2231 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L383:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2143)+4)) = v2256
	v2261 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L384:
	;
	v2241 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L386:
	;
	v2249 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L387:
	;
	v2267 = int32(0)
	v2269 = *(*int32)(unsafe.Add(mBase, _consts[57]))
...
L388:
	;
	v2383 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L451:
	;
	v2688 = int32(4543684)
	v2690 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v2690 + int32(1)
...
L457:
	;
	v2659 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L459:
	;
	v2667 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L473:
	;
	v2708 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L475:
	;
	v2716 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L477:
	;
	v2861 = int32(4543684)
	v2863 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v2863 - int32(1)
	if v139 != 0 {
		goto L529
	} else {
		goto L530
...
L478:
	;
	v2737 = *(*int32)(unsafe.Add(mBase, _consts[15]))
	if v2737 <= int32(0) {
		goto L479
	} else {
		goto L480
...
L526:
	;
	v2838 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L528:
	;
	v2846 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L540:
	;
	v2880 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L542:
	;
	v2888 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L544:
	;
	v2899 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L546:
	;
	v2907 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L549:
	;
	v2958 = int32(4543684)
	v2960 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v2960 + int32(1)
	if v10 != 0 {
		goto L558
	} else {
		goto L559
...
L553:
	;
	v2932 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L555:
	;
	v2940 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L576:
	;
	v3002 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L578:
	;
	v3010 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L584:
	;
	v3028 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L586:
	;
	v3036 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L588:
	;
	v3174 = int32(4543684)
	v3176 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v3176 - int32(1)
	if v2955 != 0 {
		goto L631
	} else {
		goto L632
...
L589:
	;
	v3057 = *(*int32)(unsafe.Add(mBase, _consts[15]))
	if v3057 <= int32(0) {
		goto L590
	} else {
		goto L591
...
L628:
	;
	v3147 = *(*int32)(unsafe.Add(mBase, _consts[12]))
...
L630:
	;
	v3155 = *(*int32)(unsafe.Add(mBase, _consts[13]))
...
L645:
	;
	v3194 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L647:
	;
	v3202 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L667:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+160)) = v3306 | v3307<<(uint(int32(16))%32)
	F_errmsg_internal(m, int32(720283), v49+int32(160))
	mBase = m.M
	v3343 = m.ExcPending
	if v3343 != 0 {
		goto L21
...
L668:
	;
	v3312 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L670:
	;
	v3320 = *(*int32)(unsafe.Add(mBase, _consts[17]))
	v3326 = *(*int32)(unsafe.Add(mBase, uint32(v3320+l3<<(uint(int32(6))%32)+int32(-64))+16))
	v3327 = v3326
	goto L667
L671:
	;
	F_errfinish(m, int32(512230), int32(1191), int32(341165))
	mBase = m.M
	v3348 = m.ExcPending
	if v3348 != 0 {
		goto L21
...
L673:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+4)) = v3353 + int32(4)
	F_errmsg_internal(m, int32(723657), v49)
	mBase = m.M
	v3360 = m.ExcPending
	if v3360 != 0 {
		goto L21
...
L674:
	;
	F_errfinish(m, int32(512230), int32(1704), int32(108522))
	mBase = m.M
	v3365 = m.ExcPending
	if v3365 != 0 {
		goto L21
...
L677:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+116)) = v3374 + int32(4)
	F_errmsg_internal(m, int32(723408), v49+int32(112))
	mBase = m.M
	v3383 = m.ExcPending
	if v3383 != 0 {
		goto L21
...
L678:
	;
	F_errfinish(m, int32(512230), int32(1773), int32(108522))
	mBase = m.M
	v3388 = m.ExcPending
	if v3388 != 0 {
		goto L21
...
L681:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+84)) = v3397 + int32(4)
	F_errmsg_internal(m, int32(723739), v49+int32(80))
	mBase = m.M
	v3406 = m.ExcPending
	if v3406 != 0 {
		goto L21
...
L682:
	;
	F_errfinish(m, int32(512230), int32(1821), int32(108522))
	mBase = m.M
	v3411 = m.ExcPending
	if v3411 != 0 {
		goto L21
...
L685:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+100)) = v3420 + int32(4)
	F_errmsg_internal(m, int32(723491), v49+int32(96))
	mBase = m.M
	v3429 = m.ExcPending
	if v3429 != 0 {
		goto L21
...
L686:
	;
	F_errfinish(m, int32(512230), int32(1834), int32(108522))
	mBase = m.M
	v3434 = m.ExcPending
	if v3434 != 0 {
		goto L21
...
L689:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+52)) = v3443 + int32(4)
	F_errmsg_internal(m, int32(723821), v49+int32(48))
	mBase = m.M
	v3452 = m.ExcPending
	if v3452 != 0 {
		goto L21
...
L690:
	;
	F_errfinish(m, int32(512230), int32(1848), int32(108522))
	mBase = m.M
	v3457 = m.ExcPending
	if v3457 != 0 {
		goto L21
...
L693:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+68)) = v3466 + int32(4)
	F_errmsg_internal(m, int32(723574), v49-int32(-64))
	mBase = m.M
	v3475 = m.ExcPending
	if v3475 != 0 {
		goto L21
...
L694:
	;
	F_errfinish(m, int32(512230), int32(1860), int32(108522))
	mBase = m.M
	v3480 = m.ExcPending
	if v3480 != 0 {
		goto L21
...
L697:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+36)) = v3489 + int32(4)
	F_errmsg_internal(m, int32(723491), v49+int32(32))
	mBase = m.M
	v3498 = m.ExcPending
	if v3498 != 0 {
		goto L21
...
L698:
	;
	F_errfinish(m, int32(512230), int32(1881), int32(108522))
	mBase = m.M
	v3503 = m.ExcPending
	if v3503 != 0 {
		goto L21
...
L702:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+28)) = v3515 + int32(4)
	F_errmsg_internal(m, int32(720722), v49+int32(16))
	mBase = m.M
	v3528 = m.ExcPending
	if v3528 != 0 {
		goto L21
...
L703:
	;
	F_errfinish(m, int32(512230), int32(1904), int32(108522))
	mBase = m.M
	v3533 = m.ExcPending
	if v3533 != 0 {
		goto L21
...
L706:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+132)) = v3557 + int32(4)
	F_errmsg_internal(m, int32(719831), v49+int32(128))
	mBase = m.M
	v3566 = m.ExcPending
	if v3566 != 0 {
		goto L21
...
L707:
	;
	v3541 = *(*int32)(unsafe.Add(mBase, _consts[16]))
...
L709:
	;
	v3549 = *(*int32)(unsafe.Add(mBase, _consts[17]))
	v3555 = *(*int32)(unsafe.Add(mBase, uint32(v3549+l3<<(uint(int32(6))%32)+int32(-64))+16))
	v3556 = v3555
	goto L706
L710:
	;
	F_errfinish(m, int32(512230), int32(1283), int32(341165))
	mBase = m.M
	v3571 = m.ExcPending
	if v3571 != 0 {
		goto L21
...
func F__bt_sort_dedup_finish_pending(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v6 == int32(1) {
		...
		if v15 != 0 {
			...
			F__bt_buildadd(m, l0, l1, v14, v16&int32(8191)-(v19|v20<<(uint(int32(16))%32)))
			mBase = m.M
			v26 = m.ExcPending
			if v26 != 0 {
				return
			...
			if v14 < int32(0) {
				...
				if v19 != 0 {
					...
					if v21 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6)+uint32(_consts[60]))) = v36
						*(*int32)(unsafe.Add(mBase, uint32(v6)+52)) = int32(-1)
						...
						if v40 != int32(1) {
							...
							if v43 == int32(1) {
								v46 = int32(1)
								*(*uint8)(unsafe.Add(mBase, uint32(v6)+uint32(_consts[61]))) = uint8(v46)
							} else {
								v48 = int32(1)
								*(*uint8)(unsafe.Add(mBase, uint32(v6)+uint32(_consts[62]))) = uint8(v48)
							}
						}
						v52 = *(*int32)(unsafe.Add(mBase, uint32(v6)+56))
						if v52 != 0 {
	...
	if v14 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13))) = v17
		...
		if v20 != 0 {
			...
			v25 = F_bloom_lacks_element(m, v21, v19, v22&int32(8191))
			mBase = m.M
			v26 = m.ExcPending
			if v26 != 0 {
				return
						...
						if v33 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v34 | v35<<(uint(int32(16))%32)
							...
							if v54 != 0 {
								...
								if v55 == int32(0) {
									F_errhint(m, int32(630092), int32(0))
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return
									} else {
										F_errfinish(m, int32(519892), int32(2808), int32(331622))
										mBase = m.M
										v69 = m.ExcPending
										if v69 != 0 {
											return
