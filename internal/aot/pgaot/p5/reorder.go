...
func F_ReorderBufferRestoreCleanup(m *base.Module, l0 int32) {
	...
	v14 = int64(*(*int32)(unsafe.Add(mBase, _consts[115])))
...
L5:
	...
	v30 = int64(*(*int32)(unsafe.Add(mBase, _consts[115])))
	v31 = v26 * v30
	*(*uint32)(unsafe.Add(mBase, uint32(v10+int32(32)))) = uint32(v31)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(91132)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v10)+28)) = uint32(v42)
	v50 = F_pg_snprintf(m, v10+int32(48), int32(1024), int32(319584), v10+int32(16))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L7
...
L16:
	;
	F_errfinish(m, int32(521291), int32(4841), int32(245422))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L7
...
L3:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v24)+64)) = uint32(v31)
	F_errmsg_internal(m, int32(330773), v24-int32(-64))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L6:
	;
	F_errfinish(m, int32(521291), int32(3973), int32(555227))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L15:
	;
	v591 = *(*int32)(unsafe.Add(mBase, _consts[85]))
...
L23:
	...
	v138 = int64(*(*int32)(unsafe.Add(mBase, _consts[115])))
...
L25:
	...
	v146 = int64(*(*int32)(unsafe.Add(mBase, _consts[115])))
	v147 = base.I64_div_u_s(v144, v146)
	v148 = v147 * v146
	*(*uint32)(unsafe.Add(mBase, uint32(v24+int32(48)))) = uint32(v148)
	*(*int32)(unsafe.Add(mBase, uint32(v24)+32)) = int32(91132)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v24)+44)) = uint32(v159)
	v167 = F_pg_snprintf(m, v24+int32(80), int32(1024), int32(319584), v24+int32(32))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L1
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, _consts[85])) = int32(0)
	v457 = *(*int32)(unsafe.Add(mBase, _consts[95]))
...
L136:
	;
	v466 = *(*int32)(unsafe.Add(mBase, _consts[95]))
...
L160:
	;
	F_errfinish(m, int32(521291), int32(4019), int32(555227))
	mBase = m.M
	v589 = m.ExcPending
	if v589 != 0 {
		goto L1
...
L165:
	;
	*(*int32)(unsafe.Add(mBase, _consts[85])) = v596
	F_errstart_cold(m, int32(21), int32(0))
	mBase = m.M
	v601 = m.ExcPending
	if v601 != 0 {
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+16)) = v604
	F_errmsg(m, int32(307517), v24+int32(16))
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		goto L1
...
L168:
	;
	F_errfinish(m, int32(521291), int32(4253), int32(423629))
	mBase = m.M
	v615 = m.ExcPending
	if v615 != 0 {
		goto L1
