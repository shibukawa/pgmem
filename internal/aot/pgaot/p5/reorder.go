...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(84653)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v10)+28)) = uint32(v42)
	v50 = F_pg_snprintf(m, v10+int32(48), int32(1024), int32(304084), v10+int32(16))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L7
...
L16:
	;
	F_errfinish(m, int32(495456), int32(4841), int32(232907))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L7
...
L3:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v24)+64)) = uint32(v31)
	F_errmsg_internal(m, int32(314548), v24-int32(-64))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L6:
	;
	F_errfinish(m, int32(495456), int32(3973), int32(527769))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+32)) = int32(84653)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v24)+44)) = uint32(v159)
	v167 = F_pg_snprintf(m, v24+int32(80), int32(1024), int32(304084), v24+int32(32))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L1
...
L160:
	;
	F_errfinish(m, int32(495456), int32(4019), int32(527769))
	mBase = m.M
	v589 = m.ExcPending
	if v589 != 0 {
		goto L1
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+16)) = v604
	F_errmsg(m, int32(292394), v24+int32(16))
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		goto L1
...
L168:
	;
	F_errfinish(m, int32(495456), int32(4253), int32(403115))
	mBase = m.M
	v615 = m.ExcPending
	if v615 != 0 {
		goto L1
