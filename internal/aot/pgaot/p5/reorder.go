...
L16:
	...
	v58 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferAbort[0]))
...
L5:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v10)+28)) = uint32(v42)
	v50 = F_pg_snprintf(m, v10+int32(48), int32(1024), int32(_a_F_ReorderBufferRestoreCleanup_1), v10+int32(16))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L7
...
L9:
	;
	v56 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferRestoreCleanup[2]))
	if v56 != int32(44) {
		goto L1
	} else {
		goto L12
...
L3:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v24)+64)) = uint32(v31)
	F_errmsg_internal(m, int32(_a_F_ReorderBufferSerializeTXN_0), v24-int32(-64))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L15:
	;
	v591 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[0]))
...
L23:
	...
	v138 = int64(*(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[1])))
...
L25:
	...
	v146 = int64(*(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[1])))
	v147 = base.I64_div_u_s(v144, v146)
	v148 = v147 * v146
	*(*uint32)(unsafe.Add(mBase, uint32(v24+int32(48)))) = uint32(v148)
	*(*int32)(unsafe.Add(mBase, uint32(v24)+32)) = int32(_a_F_ReorderBufferSerializeTXN_3)
	*(*int32)(unsafe.Add(mBase, uint32(v24)+40)) = v143
	v154 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[2]))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v24)+44)) = uint32(v159)
	v167 = F_pg_snprintf(m, v24+int32(80), int32(1024), int32(_a_F_ReorderBufferSerializeTXN_4), v24+int32(32))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L1
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[0])) = int32(0)
	v457 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[3]))
...
L136:
	;
	v466 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[3]))
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24))) = v24 + int32(80)
	F_errmsg(m, int32(_a_F_ReorderBufferSerializeTXN_5), v24)
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L1
...
L165:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[0])) = v596
	F_errstart_cold(m, int32(21), int32(0))
	mBase = m.M
	v601 = m.ExcPending
	if v601 != 0 {
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+16)) = v604
	F_errmsg(m, int32(_a_F_ReorderBufferSerializeTXN_6), v24+int32(16))
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		goto L1
