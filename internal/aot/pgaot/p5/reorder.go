...
L15:
	;
	v647 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[0]))
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[0])) = int32(0)
	v513 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[3]))
...
L153:
	;
	v522 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[3]))
...
L182:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferSerializeTXN[0])) = v652
	F_errstart_cold(m, int32(21), int32(0))
	mBase = m.M
	v657 = m.ExcPending
	if v657 != 0 {
