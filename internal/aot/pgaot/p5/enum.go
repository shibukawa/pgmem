...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+64)) = v41
	F_errmsg_internal(m, int32(206113), v11-int32(-64))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v86
	F_errdetail_internal(m, int32(206113), v11+int32(32))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L4
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v94
	F_errhint(m, int32(206113), v11+int32(16))
	mBase = m.M
	v100 = m.ExcPending
	if v100 != 0 {
		goto L4
...
L32:
	;
	F_errfinish(m, int32(499720), int32(6989), int32(315194))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L4
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v48
	F_errmsg_internal(m, int32(181639), v11)
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L4
				...
				if v26 != 0 {
					...
					if v28 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v27
						F_errmsg(m, int32(724951), v9)
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
						} else {
							F_errsave_finish(m, v12, int32(497021), int32(123), int32(279491))
							mBase = m.M
							v38 = m.ExcPending
							if v38 != 0 {
								return int32(0)
						...
						if v51 != 0 {
							...
							if v53 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v52
								F_errmsg(m, int32(724951), v9+int32(16))
								mBase = m.M
								v60 = m.ExcPending
								if v60 != 0 {
									return int32(0)
								} else {
									F_errsave_finish(m, v12, int32(497021), int32(133), int32(279491))
									mBase = m.M
									v65 = m.ExcPending
									if v65 != 0 {
										return int32(0)
			...
			if v13 != 0 {
				...
				if v16 != 0 {
					...
					if v20 != 0 {
						...
						F_errfinish(m, int32(497021), int32(540), int32(305033))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return int32(0)
