...
func F_ATAddCheckNNConstraint(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) {
	...
	v17 = v15 - int32(32)
	m.G0 = v17
	v20 = *(*int64)(unsafe.Add(mBase, _c_F_ATAddCheckNNConstraint[0]))
	*(*int64)(unsafe.Add(mBase, uint32(l0))) = v20
	v23 = *(*int32)(unsafe.Add(mBase, _c_F_ATAddCheckNNConstraint[1]))
...
L39:
	;
	v123 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecAddColumn[0]))
	*(*int32)(unsafe.Add(mBase, uint32(l0)+8)) = v123
	v126 = *(*int64)(unsafe.Add(mBase, _c_F_ATExecAddColumn[1]))
...
L44:
	;
	v140 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecAddColumn[0]))
	*(*int32)(unsafe.Add(mBase, uint32(l0)+8)) = v140
	v143 = *(*int64)(unsafe.Add(mBase, _c_F_ATExecAddColumn[1]))
...
L66:
	;
	v233 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecAddColumn[2]))
	if v233 != 0 {
		goto L67
	} else {
		goto L68
...
L129:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v389))) = v386
	F_errmsg_internal(m, int32(_a_F_ATExecAddColumn_6), v389)
	mBase = m.M
	v435 = m.ExcPending
	if v435 != 0 {
		goto L1
...
L25:
	;
	v105 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecAlterConstrDeferrability[0]))
	if v105 != 0 {
		goto L26
	} else {
		goto L27
...
L4:
	;
	v611 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecChangeOwner[0]))
	if v611 != 0 {
		goto L166
	} else {
		goto L167
...
L7:
	;
	if int32(1)<<(uint(v378)%32)&int32(_a_F_ATExecChangeOwner_0) != 0 {
		goto L5
	} else {
		goto L118
	}
...
L59:
	...
	v173 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecChangeOwner[1]))
...
L63:
	;
	v199 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecChangeOwner[1]))
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+112)) = v387 + int32(4)
	F_errmsg_internal(m, int32(_a_F_ATRewriteTable_5), v29+int32(112))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L1
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+96)) = v405 + int32(4)
	F_errmsg_internal(m, int32(_a_F_ATRewriteTable_7), v29+int32(96))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L1
...
L110:
	;
	v535 = int32(_a_F_ATRewriteTable_4)
	v536 = *(*int32)(unsafe.Add(mBase, _c_F_ATRewriteTable[0]))
	v538 = *(*int32)(unsafe.Add(mBase, uint32(v534)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ATRewriteTable[0])) = v538
	...
	*(*int32)(unsafe.Add(mBase, uint32(v440)+36)) = v541
	v544 = *(*int32)(unsafe.Add(mBase, _c_F_ATRewriteTable[1]))
	if v544 != 0 {
		goto L114
	} else {
		goto L115
...
L114:
	;
	v546 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ATRewriteTable[2])))
...
L126:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ATRewriteTable[0])) = v536
...
L151:
	...
	v788 = v786 & int32(_a_F_ATRewriteTable_9)
...
L185:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+80)) = v35 + v936<<(uint(v945)%32) + v920*int32(100) - int32(76)
	F_errmsg(m, int32(_a_F_ATRewriteTable_10), v29+int32(80))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L1
...
L187:
	;
	F_errfinish(m, int32(_a_F_ATRewriteTable_1), int32(_a_F_ATRewriteTable_11), int32(_a_F_ATRewriteTable_3))
	mBase = m.M
	v968 = m.ExcPending
	if v968 != 0 {
		goto L1
...
L194:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+64)) = v35 + v999<<(uint(v1008)%32) + v995*int32(100) - int32(76)
	F_errmsg(m, int32(_a_F_ATRewriteTable_10), v29-int32(-64))
	mBase = m.M
	v1024 = m.ExcPending
	if v1024 != 0 {
		goto L1
...
L209:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+52)) = v1084 + int32(4)
	F_errmsg(m, int32(_a_F_ATRewriteTable_13), v29+int32(48))
	mBase = m.M
	v1094 = m.ExcPending
	if v1094 != 0 {
		goto L1
...
L211:
	;
	F_errfinish(m, int32(_a_F_ATRewriteTable_1), int32(_a_F_ATRewriteTable_14), int32(_a_F_ATRewriteTable_3))
	mBase = m.M
	v1102 = m.ExcPending
	if v1102 != 0 {
		goto L1
...
L226:
	;
	v1163 = *(*int32)(unsafe.Add(mBase, _c_F_ATRewriteTable[3]))
	if v1163 != 0 {
		goto L227
	} else {
		goto L228
...
L229:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v440)+36)) = v1167
	v1170 = *(*int32)(unsafe.Add(mBase, _c_F_ATRewriteTable[1]))
	if v1170 == int32(0) {
		goto L118
	} else {
		goto L231
...
L231:
	;
	v1174 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ATRewriteTable[2])))
	if v1174&int32(1) != 0 {
		goto L118
	} else {
		goto L232
...
L233:
	;
	F_errmsg_internal(m, int32(_a_F_ATRewriteTable_16), int32(0))
	mBase = m.M
	v1210 = m.ExcPending
	if v1210 != 0 {
		goto L1
...
L234:
	;
	F_errfinish(m, int32(_a_F_ATRewriteTable_17), int32(1034), int32(_a_F_ATRewriteTable_18))
	mBase = m.M
	v1215 = m.ExcPending
	if v1215 != 0 {
		goto L1
...
L238:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = v1226
	F_errmsg(m, int32(_a_F_ATRewriteTable_19), v29+int32(16))
	mBase = m.M
	v1234 = m.ExcPending
	if v1234 != 0 {
		goto L1
...
L240:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = v1226
	F_errmsg(m, int32(_a_F_ATRewriteTable_20), v29)
	mBase = m.M
	v1245 = m.ExcPending
	if v1245 != 0 {
		goto L1
...
L242:
	;
	F_errfinish(m, int32(_a_F_ATRewriteTable_1), int32(_a_F_ATRewriteTable_21), int32(_a_F_ATRewriteTable_3))
	mBase = m.M
	v1241 = m.ExcPending
	if v1241 != 0 {
		goto L1
