...
L11:
	;
	if v26&int32(_a_F_halfvec_accum_0) != 0 {
		goto L14
	} else {
		goto L15
	}
...
L14:
	;
	v40 = int32(_a_F_halfvec_accum_0)
	if v35&v40 != v33&v40 {
		goto L5
	} else {
		goto L17
			...
			if v16 == int32(1) {
				...
				if v19 <= int32(0) {
					...
					if v47 != 0 {
						...
						if v50 != 0 {
							...
							F_errmsg(m, int32(_a_F_halfvec_typmod_in_0), int32(0))
							mBase = m.M
							v54 = m.ExcPending
							if v54 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(_a_F_halfvec_typmod_in_1), int32(358), int32(_a_F_halfvec_typmod_in_2))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return int32(0)
					...
					if base.Ui32(int32(_a_F_halfvec_typmod_in_3)) <= base.Ui32(v19) {
						F_errstart_cold(m, int32(21), int32(0))
						mBase = m.M
						v63 = m.ExcPending
						if v63 != 0 {
							...
							if v66 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(_a_F_halfvec_typmod_in_4)
								F_errmsg(m, int32(_a_F_halfvec_typmod_in_5), v5)
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_halfvec_typmod_in_1), int32(363), int32(_a_F_halfvec_typmod_in_2))
									mBase = m.M
									v76 = m.ExcPending
									if v76 != 0 {
										return int32(0)
				...
				if v31 != 0 {
					...
					if v34 != 0 {
						...
						F_errmsg(m, int32(_a_F_halfvec_typmod_in_6), int32(0))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_halfvec_typmod_in_1), int32(353), int32(_a_F_halfvec_typmod_in_2))
							mBase = m.M
							v43 = m.ExcPending
							if v43 != 0 {
								return int32(0)
