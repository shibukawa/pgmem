...
L36:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(300576)
...
L37:
	;
	F_errfinish(m, int32(518027), int32(169), int32(26817))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L1
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(391328)
...
L58:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(391328)
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v126
	F_errmsg(m, int32(488679), v13+int32(32))
	mBase = m.M
	v252 = m.ExcPending
	if v252 != 0 {
		goto L1
