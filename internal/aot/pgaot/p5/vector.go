...
L36:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(301241)
	F_errmsg_internal(m, int32(26359), v12)
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(519409), int32(169), int32(26850))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L1
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v34
	F_errmsg(m, int32(489736), v12+int32(16))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L1
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(392217)
...
L58:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(392217)
	F_errmsg_internal(m, int32(26359), v13+int32(16))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v126
	F_errmsg(m, int32(489736), v13+int32(32))
	mBase = m.M
	v252 = m.ExcPending
	if v252 != 0 {
		goto L1
