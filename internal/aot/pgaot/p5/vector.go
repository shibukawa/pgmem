...
func F_vector(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = Fn13912(m, l0, int32(88), int32(_a_F_vector_0))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
L36:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(_a_F_vector_accum_0)
	F_errmsg_internal(m, int32(_a_F_vector_accum_1), v12)
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L1
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v34
	F_errmsg(m, int32(_a_F_vector_accum_4), v12+int32(16))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L1
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(_a_F_vector_combine_0)
	F_errmsg_internal(m, int32(_a_F_vector_combine_1), v13)
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L1
...
L58:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(_a_F_vector_combine_0)
	F_errmsg_internal(m, int32(_a_F_vector_combine_1), v13+int32(16))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v126
	F_errmsg(m, int32(_a_F_vector_combine_4), v13+int32(32))
	mBase = m.M
	v252 = m.ExcPending
	if v252 != 0 {
		goto L1
