...
func F_mic_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_mic2latin_with_table(m, v6, v5, v10, int32(139), int32(25), int32(2211488), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
L54:
	...
	v151 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1451]))))
	if v151 == int32(65535) {
		goto L56
	} else {
		goto L57
