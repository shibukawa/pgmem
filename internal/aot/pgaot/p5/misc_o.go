...
func F_oidvectorhashfast(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_DirectFunctionCall1Coll(m, int32(1587), int32(0), l0)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
func F_operationPriority(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v5) <= base.Ui32(int32(37)) {
		v12 = *(*int32)(unsafe.Add(mBase, uint32(v5<<(uint(int32(2))%32))+uint32(_consts[1075])))
		v13 = v12
	} else {
		v13 = int32(6)
	}
...
func F_overlaps_timestamp(m *base.Module, l0 int32) int32 {
	...
	if v18 == v11 {
			...
			if v13&int32(1) != 0 {
				if v12&int32(1) != 0 {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v107)
					...
					v48 = F_DirectFunctionCall2Coll(m, int32(1512), int32(0), v39, v15)
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
						...
						if v48 != 0 {
							...
							*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v107)
							...
							v68 = v15
							v69 = int32(1)
							v73 = F_DirectFunctionCall2Coll(m, int32(1513), int32(0), v39, v68)
							mBase = m.M
							v74 = m.ExcPending
							if v74 != 0 {
								return int32(0)
								...
								if v73 != 0 {
									if v40 != 0 {
										...
										*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v107)
										...
										v77 = F_DirectFunctionCall2Coll(m, int32(1513), int32(0), v68, v37)
										mBase = m.M
										v78 = m.ExcPending
										if v78 != 0 {
											return int32(0)
				...
				if v12&int32(1) != 0 {
					v55 = F_DirectFunctionCall2Coll(m, int32(1512), int32(0), v39, v16)
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
					...
					if v64 != 0 {
						...
						if v67 != 0 {
							...
							if v66 != 0 {
								...
								v92 = F_DirectFunctionCall2Coll(m, int32(1513), int32(0), v39, v91)
								mBase = m.M
								v93 = m.ExcPending
								if v93 != 0 {
									return int32(0)
		...
		if v14&int32(1) != 0 {
			...
			v28 = int32(0)
			v31 = F_DirectFunctionCall2Coll(m, int32(1512), v28, v25, v17)
			mBase = m.M
			v34 = m.ExcPending
			if v34 != 0 {
				return int32(0)
