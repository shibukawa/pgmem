...
func F_gbt_bit_picksplit(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13902(m, l0, int32(_a_F_gbt_bit_picksplit_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_bool_same(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13905(m, l0, int32(_a_F_gbt_bool_same_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_bpchar_consistent(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = Fn13915(m, l0, int32(_a_F_gbt_bpchar_consistent_0), int32(_a_F_gbt_bpchar_consistent_1))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
func F_gbt_bpchar_ssup_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = Fn13916(m, l0, l1, l2, int32(2407))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gbt_date_consistent(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13910(m, l0, int32(_a_F_gbt_date_consistent_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_enum_union(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = Fn13906(m, l0, int32(_a_F_gbt_enum_union_0), int32(8))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
func F_gbt_float8_same(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13905(m, l0, int32(_a_F_gbt_float8_same_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_inet_same(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13905(m, l0, int32(_a_F_gbt_inet_same_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_int8_distance(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13909(m, l0, int32(_a_F_gbt_int8_distance_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_macad_same(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13905(m, l0, int32(_a_F_gbt_macad_same_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_oid_same(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13905(m, l0, int32(_a_F_gbt_oid_same_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_tskey_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = Fn13913(m, l0, l1, l2, int32(8), int32(1430))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
