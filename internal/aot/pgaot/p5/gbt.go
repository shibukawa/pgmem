...
func F_gbt_bit_picksplit(m *base.Module, l0 int32) int32 {
	...
	v8 = F_gbt_var_picksplit(m, v3, v4, v5, int32(4396160), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_bool_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v16
	...
	v38 = F_gbt_num_consistent(m, v7+int32(4), v7+int32(15), v7+int32(12), v33&v20, int32(4396200), v37)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		return int32(0)
...
func F_gbt_bool_same(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(4396200), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_bpchar_consistent(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v18))) = uint8(v42)
		...
		v71 = F_gbt_var_consistent(m, v9+int32(8), v13, v17&int32(65535), v62, v66&int32(1), int32(4396944), v70)
		mBase = m.M
		v72 = m.ExcPending
		if v72 != 0 {
			return int32(0)
...
func F_gbt_bytea_penalty(m *base.Module, l0 int32) int32 {
	...
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)+12))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_var_penalty(m, v2, v3, v4, v5, int32(4396240), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_bytea_union(m *base.Module, l0 int32) int32 {
	...
	v7 = F_gbt_var_union(m, v2, v3, v4, int32(4396240), v6)
	mBase = m.M
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
...
func F_gbt_cash_picksplit(m *base.Module, l0 int32) int32 {
	...
	v6 = F_gbt_num_picksplit(m, v2, v3, int32(4396280), v5)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
...
func F_gbt_enum_sortsupport(m *base.Module, l0 int32) int32 {
	...
	_ = v15
	v3 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	*(*int32)(unsafe.Add(mBase, uint32(v3)+16)) = int32(6971)
...
func F_gbt_enum_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(8)
		...
		v15 = F_gbt_num_union(m, v6, v4, int32(4396360), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_float4_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4396400))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_float8_same(m *base.Module, l0 int32) int32 {
	...
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(4396440), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_inet_same(m *base.Module, l0 int32) int32 {
	...
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(4396544), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_int8_distance(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v13
	...
	v28 = F_gbt_num_distance(m, v7, v7+v14, v23&int32(1), int32(4396664), v27)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		return int32(0)
...
func F_gbt_macad8_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4396784))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_macad8_fetch(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_fetch(m, v2, int32(4396784))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_macad_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4396744))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_macad_same(m *base.Module, l0 int32) int32 {
	...
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(4396744), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_oid_same(m *base.Module, l0 int32) int32 {
	...
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(4396864), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_time_sortsupport(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(7076)
	return v3
}
