			...
			if base.Ui32(v16) < base.Ui32(v15) {
				...
				if v49 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v50
					F_errmsg_internal(m, int32(_a_F_find_window_functions_walker_0), v8)
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
...
func F_window_gettupleslot(m *base.Module, l0 int32, l1 int64, l2 int32) int32 {
	...
	v10 = *(*int32)(unsafe.Add(mBase, _c_F_window_gettupleslot[0]))
	if v10 != 0 {
			...
			if l1 < int64(0) {
				...
				if v18 != 0 {
					...
					if v19 <= l1 {
						...
						if v21 <= l1 {
							v23 = int32(_a_F_window_gettupleslot_0)
							v24 = *(*int32)(unsafe.Add(mBase, _c_F_window_gettupleslot[1]))
							v26 = *(*int32)(unsafe.Add(mBase, uint32(v8)+64))
							v27 = *(*int32)(unsafe.Add(mBase, uint32(v26)+16))
							*(*int32)(unsafe.Add(mBase, _c_F_window_gettupleslot[1])) = v27
									...
									if v41 != 0 {
										...
										if v40 == int32(0) {
											...
											if v103 != 0 {
												...
												F_errmsg_internal(m, int32(_a_F_window_gettupleslot_1), int32(0))
												mBase = m.M
												v107 = m.ExcPending
												if v107 != 0 {
													return int32(0)
											...
											*(*int64)(unsafe.Add(mBase, uint32(l0)+32)) = v34
											...
											if v132 != 0 {
												...
												if v131 == int32(0) {
													...
													*(*int32)(unsafe.Add(mBase, _c_F_window_gettupleslot[1])) = v24
													v145 = int32(1)
													return v145
												}
											}
							...
							if v90 != 0 {
								...
								F_errmsg_internal(m, int32(_a_F_window_gettupleslot_4), int32(0))
								mBase = m.M
								v94 = m.ExcPending
								if v94 != 0 {
									return int32(0)
