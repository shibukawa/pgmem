			...
			if base.Ui32(v16) < base.Ui32(v15) {
				...
				if v49 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v50
					F_errmsg_internal(m, int32(46700), v8)
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(472639), int32(252), int32(211301))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
						...
						if v21 <= l1 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[9])) = v27
										...
										if v40 == int32(0) {
											...
											if v103 != 0 {
												...
												if v107 != 0 {
													...
													F_errfinish(m, int32(476556), int32(3165), int32(80588))
													mBase = m.M
													v112 = m.ExcPending
													if v112 != 0 {
														return int32(0)
												...
												if v131 == int32(0) {
													...
													if v152 != 0 {
														...
														if v156 != 0 {
															...
															F_errfinish(m, int32(476556), int32(3206), int32(80588))
															mBase = m.M
															v161 = m.ExcPending
															if v161 != 0 {
																return int32(0)
											...
											if v51 == int32(0) {
												...
												if v116 != 0 {
													...
													if v120 != 0 {
														...
														F_errfinish(m, int32(476556), int32(3173), int32(80588))
														mBase = m.M
														v125 = m.ExcPending
														if v125 != 0 {
															return int32(0)
														...
														*(*int32)(unsafe.Add(mBase, _consts[9])) = v24
														...
														if v77 != 0 {
															...
															if v81 != 0 {
																...
																F_errfinish(m, int32(476556), int32(3200), int32(80588))
																mBase = m.M
																v86 = m.ExcPending
																if v86 != 0 {
																	return int32(0)
							...
							if v90 != 0 {
								...
								F_errmsg_internal(m, int32(238009), int32(0))
								mBase = m.M
								v94 = m.ExcPending
								if v94 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(476556), int32(3151), int32(80588))
									mBase = m.M
									v99 = m.ExcPending
									if v99 != 0 {
										return int32(0)
