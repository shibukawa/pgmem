	...
	if base.Ui32(v25) <= base.Ui32(v15) {
					...
					if v131 != 0 {
						...
						if v135 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = l1
							F_errdetail(m, int32(623602), v12+int32(16))
							mBase = m.M
							v141 = m.ExcPending
							if v141 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(476946), int32(372), int32(338505))
								mBase = m.M
								v146 = m.ExcPending
								if v146 != 0 {
									return int32(0)
		...
		if v110 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = l2
			F_errmsg_internal(m, int32(143961), v12)
			mBase = m.M
			v115 = m.ExcPending
			if v115 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(476946), int32(360), int32(338505))
				mBase = m.M
				v120 = m.ExcPending
				if v120 != 0 {
					return int32(0)
