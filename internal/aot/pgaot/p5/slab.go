...
func F_SlabContextCreate(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	if base.Ui32(v25) <= base.Ui32(v15) {
		...
		mBase = m.M
		if v29 == int32(0) {
			v122 = *(*int32)(unsafe.Add(mBase, _c_F_SlabContextCreate[0]))
			...
			if v124 != 0 {
				...
				if v128 != 0 {
					...
					F_errcode(m, int32(_a_F_SlabContextCreate_0))
					mBase = m.M
					v131 = m.ExcPending
					if v131 != 0 {
						return int32(0)
					} else {
						F_errmsg(m, int32(_a_F_SlabContextCreate_1), int32(0))
						mBase = m.M
						v135 = m.ExcPending
						if v135 != 0 {
							return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = l1
							...
							if v141 != 0 {
								...
								F_errfinish(m, int32(_a_F_SlabContextCreate_3), int32(372), int32(_a_F_SlabContextCreate_4))
								mBase = m.M
								v146 = m.ExcPending
								if v146 != 0 {
									return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v29)+12)) = int32(_a_F_SlabContextCreate_5)
			if l0 != 0 {
		...
		if v110 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = l2
			F_errmsg_internal(m, int32(_a_F_SlabContextCreate_6), v12)
			mBase = m.M
			v115 = m.ExcPending
			if v115 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_SlabContextCreate_3), int32(360), int32(_a_F_SlabContextCreate_4))
				mBase = m.M
				v120 = m.ExcPending
				if v120 != 0 {
					return int32(0)
