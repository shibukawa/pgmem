	...
	default:
		...
		if v219 != 0 {
			...
			if v223 != 0 {
				...
				F_errfinish(m, int32(523276), int32(1876), int32(242012))
				mBase = m.M
				v228 = m.ExcPending
				if v228 != 0 {
					return
				...
				if v38 != 0 {
					...
					if v41 != 0 {
						...
						if v45 != 0 {
							...
							F_errfinish(m, int32(519831), int32(1889), int32(337184))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return int32(0)
			...
			if v22 != 0 {
				...
				if v25 != 0 {
					...
					if v29 != 0 {
						...
						F_errfinish(m, int32(519831), int32(1885), int32(337184))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return int32(0)
...
L67:
	;
	v385 = F_DirectFunctionCall2Coll(m, int32(1349), int32(0), v382, v383)
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L1
...
L72:
	;
	v395 = F_DirectFunctionCall2Coll(m, int32(1350), int32(0), v388, v393)
	mBase = m.M
	v396 = m.ExcPending
	if v396 != 0 {
		goto L1
...
L78:
	;
	F_errfinish(m, int32(523276), int32(1402), int32(483975))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L1
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v45
	F_errmsg_internal(m, int32(511557), v10)
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L1
...
L81:
	;
	F_errfinish(m, int32(521196), int32(329), int32(483454))
	mBase = m.M
	v442 = m.ExcPending
	if v442 != 0 {
		goto L1
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(120844)
	F_errmsg(m, int32(241890), v10+int32(16))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L8
...
L22:
	;
	F_errfinish(m, int32(519831), int32(586), int32(120844))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L8
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(120844)
	F_errmsg(m, int32(26025), v10)
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L8
...
L26:
	;
	F_errfinish(m, int32(519831), int32(591), int32(120844))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L8
		...
		if v14 != 0 {
			...
			if v15 == int32(4) {
				...
				if v20 != 0 {
					...
					v29 = F_executeJsonPath(m, v13, v24, int32(1413), int32(1414), v8, v25, int32(0), l1)
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
			...
			if v28 != 0 {
				...
				if v31 != 0 {
					...
					if v34 != 0 {
						...
						v42 = F_executeJsonPath(m, v30, v33, int32(1413), int32(1414), v27, base.B2i32(v37 == int32(0)), v9+int32(16), l1)
						mBase = m.M
						v43 = m.ExcPending
						if v43 != 0 {
							return int32(0)
		...
		if v12 == int32(1) {
			...
			if v24 != 0 {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v8)+40)) = v33
				v40 = *(*int32)(unsafe.Add(mBase, _consts[247]))
				...
				if v44 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+28)) = int32(1329)
					*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(1330)
					*(*int32)(unsafe.Add(mBase, uint32(v8)+52)) = int32(1331)
					*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = int32(1332)
					*(*int32)(unsafe.Add(mBase, uint32(v8)+24)) = int32(1333)
					*(*int32)(unsafe.Add(mBase, uint32(v8)+36)) = int32(1334)
			...
			if v82 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = v12
				F_errmsg_internal(m, int32(494779), v8)
				mBase = m.M
				v86 = m.ExcPending
				if v86 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(526636), int32(99), int32(38353))
					mBase = m.M
					v91 = m.ExcPending
					if v91 != 0 {
						return int32(0)
...
L17:
	;
	v28 = int32(260912)
	v31 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1056])))
...
L26:
	;
	v56 = int32(317086)
	v59 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1057])))
...
L35:
	;
	v87 = F_DirectFunctionCall1Coll(m, int32(486), int32(0), int32(318622))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L14
...
L37:
	;
	v95 = int32(21777)
	v98 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1058])))
...
L50:
	;
	v126 = int32(115538)
	v129 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1059])))
...
L63:
	;
	F_errmsg(m, int32(764327), int32(0))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L14
...
L64:
	;
	F_errfinish(m, int32(519831), int32(4933), int32(30721))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L14
...
L67:
	;
	F_errmsg(m, int32(318439), int32(0))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L14
...
L68:
	;
	F_errdetail(m, int32(700176), int32(0))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L14
...
L69:
	;
	F_errhint(m, int32(679144), int32(0))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L14
...
L70:
	;
	F_errfinish(m, int32(519831), int32(4948), int32(30721))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L14
...
L74:
	;
	F_errfinish(m, int32(519831), int32(4975), int32(30721))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L14
