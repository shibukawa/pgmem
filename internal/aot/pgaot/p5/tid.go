...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+160)) = v248
	F_errmsg(m, int32(674507), v243+int32(160))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		goto L4
...
L74:
	;
	F_errfinish(m, int32(492822), int32(283), int32(344850))
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
		goto L4
...
L78:
	;
	F_errfinish(m, int32(492822), int32(292), int32(344850))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L4
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+16)) = v238
	F_errmsg_internal(m, int32(46249), v243+int32(16))
	mBase = m.M
	v562 = m.ExcPending
	if v562 != 0 {
		goto L4
...
L169:
	;
	F_errfinish(m, int32(492822), int32(63), int32(339696))
	mBase = m.M
	v567 = m.ExcPending
	if v567 != 0 {
		goto L4
...
L172:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+32)) = v324
	F_errmsg(m, int32(70818), v243+int32(32))
	mBase = m.M
	v580 = m.ExcPending
	if v580 != 0 {
		goto L4
...
L173:
	;
	F_errfinish(m, int32(492822), int32(70), int32(339696))
	mBase = m.M
	v585 = m.ExcPending
	if v585 != 0 {
		goto L4
...
L176:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+144)) = v324
	F_errmsg(m, int32(16945), v243+int32(144))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L4
...
L177:
	;
	F_errfinish(m, int32(492822), int32(80), int32(339696))
	mBase = m.M
	v603 = m.ExcPending
	if v603 != 0 {
		goto L4
...
L180:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+48)) = v324
	F_errmsg(m, int32(256502), v243+int32(48))
	mBase = m.M
	v617 = m.ExcPending
	if v617 != 0 {
		goto L4
...
L181:
	;
	F_errfinish(m, int32(492822), int32(86), int32(339696))
	mBase = m.M
	v622 = m.ExcPending
	if v622 != 0 {
		goto L4
...
L184:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+128)) = v324
	F_errmsg(m, int32(718092), v243+int32(128))
	mBase = m.M
	v636 = m.ExcPending
	if v636 != 0 {
		goto L4
...
L185:
	;
	F_errfinish(m, int32(492822), int32(119), int32(339696))
	mBase = m.M
	v641 = m.ExcPending
	if v641 != 0 {
		goto L4
...
L188:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+96)) = v324
	F_errmsg(m, int32(718200), v243+int32(96))
	mBase = m.M
	v675 = m.ExcPending
	if v675 != 0 {
		goto L4
...
L189:
	;
	F_errfinish(m, int32(492822), int32(128), int32(339696))
	mBase = m.M
	v680 = m.ExcPending
	if v680 != 0 {
		goto L4
...
L192:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+112)) = v324
	F_errmsg(m, int32(30794), v243+int32(112))
	mBase = m.M
	v693 = m.ExcPending
	if v693 != 0 {
		goto L4
...
L193:
	;
	F_errfinish(m, int32(492822), int32(138), int32(339696))
	mBase = m.M
	v698 = m.ExcPending
	if v698 != 0 {
		goto L4
...
L196:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+64)) = v324
	F_errmsg(m, int32(719245), v243-int32(-64))
	mBase = m.M
	v712 = m.ExcPending
	if v712 != 0 {
		goto L4
...
L197:
	;
	F_errfinish(m, int32(492822), int32(170), int32(339696))
	mBase = m.M
	v717 = m.ExcPending
	if v717 != 0 {
		goto L4
...
L200:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v243)+80)) = v324
	F_errmsg(m, int32(30794), v243+int32(80))
	mBase = m.M
	v730 = m.ExcPending
	if v730 != 0 {
		goto L4
...
L201:
	;
	F_errfinish(m, int32(492822), int32(183), int32(339696))
	mBase = m.M
	v735 = m.ExcPending
	if v735 != 0 {
		goto L4
...
func F_TidStoreCreateLocal(m *base.Module, l0 int32) int32 {
	...
	if v10 != 0 {
		...
		v27 = F_BumpContextCreate(m, v21, int32(406456), v26)
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return int32(0)
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v31))) = v34
					v40 = F_SlabContextCreate(m, v27, int32(558185), int32(8192), int32(24))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v31)+4)) = v40
						v46 = F_SlabContextCreate(m, v27, int32(240856), int32(8192), int32(100))
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v31)+8)) = v46
							v52 = F_SlabContextCreate(m, v27, int32(319889), int32(8192), int32(164))
							mBase = m.M
							v53 = m.ExcPending
							if v53 != 0 {
								return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v31)+12)) = v52
								v58 = F_SlabContextCreate(m, v27, int32(555869), int32(32768), int32(524))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return int32(0)
									...
									*(*int32)(unsafe.Add(mBase, uint32(v31)+16)) = v58
									v64 = F_SlabContextCreate(m, v27, int32(556438), int32(65536), int32(1060))
									mBase = m.M
									v65 = m.ExcPending
									if v65 != 0 {
										return int32(0)
