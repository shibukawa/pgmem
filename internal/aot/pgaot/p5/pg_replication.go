...
func F_pg_replication_origin_progress(m *base.Module, l0 int32) int32 {
	...
	var v44 int32
	_ = v44
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_pg_replication_origin_progress[0]))
	if v6 != 0 {
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(_a_F_pg_replication_origin_progress_1), int32(195), int32(_a_F_pg_replication_origin_progress_2))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
