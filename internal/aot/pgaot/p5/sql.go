...
L87:
	;
	if int32(1)<<(uint(v298)%32)&int32(_a_F_check_sql_stmt_retval_0) == int32(0) {
		goto L84
	} else {
		goto L88
	}
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+112)) = v326
	F_errmsg(m, int32(_a_F_check_sql_stmt_retval_1), v24+int32(112))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L85
...
L99:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+96)) = v337
	F_errdetail(m, int32(_a_F_check_sql_stmt_retval_2), v24+int32(96))
	mBase = m.M
	v344 = m.ExcPending
	if v344 != 0 {
		goto L85
...
L142:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+128)) = v553
	F_errmsg(m, int32(_a_F_check_sql_stmt_retval_1), v24+int32(128))
	mBase = m.M
	v560 = m.ExcPending
	if v560 != 0 {
		goto L85
...
L148:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+32)) = v577
	F_errmsg(m, int32(_a_F_check_sql_stmt_retval_1), v24+int32(32))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L85
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+64)) = v601
	F_errmsg(m, int32(_a_F_check_sql_stmt_retval_1), v24-int32(-64))
	mBase = m.M
	v608 = m.ExcPending
	if v608 != 0 {
		goto L85
...
L158:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+48)) = v612
	F_errdetail(m, int32(_a_F_check_sql_stmt_retval_7), v24+int32(48))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L85
...
L163:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+80)) = v637
	F_errmsg(m, int32(_a_F_check_sql_stmt_retval_8), v24+int32(80))
	mBase = m.M
	v644 = m.ExcPending
	if v644 != 0 {
		goto L85
...
L193:
	;
	v832 = int32(_a_F_check_sql_stmt_retval_9)
	goto L194
L194:
	;
...
L198:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v865))) = int32(101)
	v873 = F_makeAlias(m, int32(_a_F_check_sql_stmt_retval_10), v853)
	mBase = m.M
	v874 = m.ExcPending
	if v874 != 0 {
		goto L85
...
L206:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+16)) = v940
	F_errmsg(m, int32(_a_F_check_sql_stmt_retval_1), v24+int32(16))
	mBase = m.M
	v947 = m.ExcPending
	if v947 != 0 {
		goto L85
...
L207:
	;
	F_errdetail(m, int32(_a_F_check_sql_stmt_retval_11), int32(0))
	mBase = m.M
	v951 = m.ExcPending
	if v951 != 0 {
		goto L85
...
L212:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24))) = v985
	F_errmsg(m, int32(_a_F_check_sql_stmt_retval_1), v24)
	mBase = m.M
	v990 = m.ExcPending
	if v990 != 0 {
		goto L85
...
L6:
	;
	F_appendStringInfoString(m, v8+int32(96), int32(_a_F_map_sql_table_to_xmlschema_0))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = l3
	F_appendStringInfo(m, v8+int32(96), int32(_a_F_map_sql_table_to_xmlschema_1), v8-int32(-64))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L1
...
L13:
	;
	F_appendStringInfoString(m, v8+int32(96), int32(_a_F_map_sql_table_to_xmlschema_2))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = int32(_a_F_map_sql_table_to_xmlschema_3)
	F_appendStringInfo(m, v8+int32(96), int32(_a_F_map_sql_table_to_xmlschema_4), v8+int32(48))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L20:
	;
	F_appendStringInfoString(m, v8+int32(96), int32(_a_F_map_sql_table_to_xmlschema_5))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = int32(_a_F_map_sql_table_to_xmlschema_7)
	F_appendStringInfo(m, v8+int32(96), int32(_a_F_map_sql_table_to_xmlschema_8), v8+int32(32))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L1
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = int32(_a_F_map_sql_table_to_xmlschema_11)
	F_appendStringInfo(m, v8+int32(96), int32(_a_F_map_sql_table_to_xmlschema_10), v8+int32(16))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L42:
	;
	if v165 == int32(142) {
		v329 = int32(_a_F_map_sql_typecoll_to_xmlschema_types_0)
		goto L43
	} else {
		goto L44
	}
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+128)) = v167
	F_appendStringInfo(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_1), v12+int32(128))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L19
...
L45:
	;
	v184 = int32(_a_F_map_sql_typecoll_to_xmlschema_types_2)
	if v165 <= int32(1041) {
		goto L57
	} else {
		goto L58
...
L46:
	;
	F_appendStringInfoString(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_3))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L19
...
L48:
	;
	F_appendStringInfoString(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_4))
	mBase = m.M
	v310 = m.ExcPending
	if v310 != 0 {
		goto L19
...
L49:
	;
	F_appendStringInfoString(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_5))
	mBase = m.M
	v305 = m.ExcPending
	if v305 != 0 {
		goto L19
...
L50:
	;
	F_appendStringInfoString(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_6))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L19
...
L51:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+80)) = int64(9223372036854775807)
	F_appendStringInfo(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_7), v12+int32(80))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L19
...
L52:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+64)) = int64(-9223372034707292161)
	F_appendStringInfo(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_8), v12-int32(-64))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L19
...
L53:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+48)) = int64(-140737488322561)
	F_appendStringInfo(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_9), v12+int32(48))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L19
...
L54:
	;
	v257 = *(*int32)(unsafe.Add(mBase, _c_F_map_sql_typecoll_to_xmlschema_types[0]))
	if v257 != 0 {
		goto L82
	} else {
		goto L83
...
L55:
	;
	F_appendStringInfoString(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_10))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L19
...
L69:
	;
	v210 = int32(_a_F_map_sql_typecoll_to_xmlschema_types_11)
	goto L71
L70:
	;
	v210 = int32(_a_F_map_sql_typecoll_to_xmlschema_types_12)
	goto L71
L71:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+112)) = v210
	F_appendStringInfo(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_13), v12+int32(112))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L19
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v234
	F_appendStringInfo(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_14), v12+int32(16))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L19
...
L80:
	;
	F_appendStringInfoString(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_15))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L19
...
L82:
	;
	v258 = int32(_a_F_map_sql_typecoll_to_xmlschema_types_16)
	goto L84
L83:
	;
	v258 = int32(_a_F_map_sql_typecoll_to_xmlschema_types_17)
	goto L84
L84:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v258
	F_appendStringInfo(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_18), v12+int32(32))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L19
...
L92:
	;
	v315 = int32(_a_F_map_sql_typecoll_to_xmlschema_types_11)
	goto L94
L93:
	;
	v315 = int32(_a_F_map_sql_typecoll_to_xmlschema_types_12)
	goto L94
L94:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+96)) = v315
	F_appendStringInfo(m, v12+int32(160), int32(_a_F_map_sql_typecoll_to_xmlschema_types_19), v12+int32(96))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L19
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v334
	F_appendStringInfo(m, v12+int32(140), int32(_a_F_map_sql_typecoll_to_xmlschema_types_20), v12)
	mBase = m.M
	v340 = m.ExcPending
	if v340 != 0 {
		goto L19
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = l3
	F_errmsg(m, int32(_a_F_read_sql_construct_2), v21)
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L1
...
L5:
	;
	F_plpgsql_yyerror(m, l10, int32(0), l11, int32(_a_F_read_sql_construct_3))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L1
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v127))) = v129
	v134 = *(*int32)(unsafe.Add(mBase, _c_F_read_sql_construct[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v127)+8)) = v134
	v137 = *(*int32)(unsafe.Add(mBase, _c_F_read_sql_construct[2]))
	v138 = int32(0)
...
L53:
	;
	v149 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_read_sql_construct[3])))
	if v149 != int32(1) {
		goto L52
	} else {
		goto L54
...
L54:
	...
	v154 = int32(_a_F_read_sql_construct_9)
	v155 = *(*int32)(unsafe.Add(mBase, _c_F_read_sql_construct[4]))
	v158 = *(*int32)(unsafe.Add(mBase, _c_F_read_sql_construct[5]))
	*(*int32)(unsafe.Add(mBase, _c_F_read_sql_construct[4])) = v158
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+48)) = int32(_a_F_read_sql_construct_10)
	v164 = int32(_a_F_read_sql_construct_11)
	v165 = *(*int32)(unsafe.Add(mBase, _c_F_read_sql_construct[6]))
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_read_sql_construct[4])) = v155
	v179 = *(*int32)(unsafe.Add(mBase, uint32(v21)+44))
	*(*int32)(unsafe.Add(mBase, _c_F_read_sql_construct[6])) = v179
	goto L52
L56:
	;
	base.Wasm_trap_unreachable()
