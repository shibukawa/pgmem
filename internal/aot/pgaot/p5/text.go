...
L152:
	;
	v567 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_text_format[0])))
...
L216:
	;
	F_text_format_append_string(m, v23+int32(88), int32(_a_F_text_format_16), v517, v696)
	mBase = m.M
	v764 = m.ExcPending
	if v764 != 0 {
		goto L22
...
L218:
	;
	F_text_format_append_string(m, v23+int32(88), int32(_a_F_text_format_17), v517, v696)
	mBase = m.M
	v759 = m.ExcPending
	if v759 != 0 {
		goto L22
...
L240:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v816
	F_errmsg(m, int32(_a_F_text_format_21), v23+int32(16))
	mBase = m.M
	v824 = m.ExcPending
	if v824 != 0 {
		goto L22
...
L261:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v930
	F_errmsg(m, int32(_a_F_text_format_21), v23)
	mBase = m.M
	v936 = m.ExcPending
	if v936 != 0 {
		goto L22
