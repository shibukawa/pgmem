...
L44:
	;
	F_errdetail(m, int32(661781), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L5
...
L45:
	;
	F_errhint(m, int32(628666), int32(0))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L5
...
L46:
	;
	F_errfinish(m, int32(522544), int32(542), int32(402117))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L5
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v159)+88)) = v173
	v176 = v159 + int32(92)
	v178 = *(*int32)(unsafe.Add(mBase, _consts[1483]))
...
L114:
	;
	F_s_lock(m, v266, int32(522544), int32(372), int32(14234))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L5
...
L168:
	;
	F_s_lock(m, v34, int32(522544), int32(601), int32(333866))
	mBase = m.M
	v630 = m.ExcPending
	if v630 != 0 {
		goto L5
...
L17:
	;
	F_errfinish(m, int32(513935), int32(2705), int32(253482))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
func F_begin_prepare_cb_wrapper(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(382166)
	...
	if v36 == v3 {
		...
		if v42 != 0 {
			...
			if v45 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(527076)
				F_errmsg(m, int32(333327), v8)
				mBase = m.M
				v50 = m.ExcPending
				if v50 != 0 {
					return
				} else {
					F_errfinish(m, int32(520401), int32(941), int32(228384))
					mBase = m.M
					v55 = m.ExcPending
					if v55 != 0 {
						return
...
L30:
	;
	v87 = F_BinarySearchRange(m, int32(2271008), int32(46), v53)
	mBase = m.M
	if v87 == int32(0) {
		goto L21
	} else {
...
L39:
	;
	v66 = F_BinarySearchRange(m, int32(2270864), int32(23), v53)
	mBase = m.M
	if v66 != 0 {
		v82 = v66
		goto L31
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = int32(16384)
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15
				if v15 == int32(0) {
					F_yy_fatal_error_1(m, int32(713078))
					mBase = m.M
					v81 = m.ExcPending
					if v81 != 0 {
						return int32(0)
	...
	if v4 == int32(0) {
		...
		if v9 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
			if v8 == int32(0) {
				F_yy_fatal_error_1(m, int32(713355))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
	...
	if v13 != 0 {
		...
		if int32(5) <= v8 {
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8 - int32(4)
			v21 = F_pg_snprintf(m, v10, int32(64), int32(709291), v6)
			mBase = m.M
			v22 = m.ExcPending
			if v22 != 0 {
				return int32(0)
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+180)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+176)) = v31
	F_errmsg(m, int32(491971), v19+int32(176))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L2
...
L35:
	;
	F_errfinish(m, int32(521464), int32(114), int32(373161))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L2
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+196)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+192)) = v31
	F_errmsg(m, int32(491796), v19+int32(192))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L2
...
L43:
	;
	F_errfinish(m, int32(521464), int32(130), int32(373161))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L2
...
L47:
	;
	F_errfinish(m, int32(521464), int32(58), int32(373161))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L2
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+164)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+160)) = v31
	F_errmsg(m, int32(491590), v19+int32(160))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L2
...
L62:
	;
	F_errfinish(m, int32(521464), int32(152), int32(373161))
	mBase = m.M
	v309 = m.ExcPending
	if v309 != 0 {
		goto L2
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+148)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+144)) = v31
	F_errmsg(m, int32(190776), v19+int32(144))
	mBase = m.M
	v347 = m.ExcPending
	if v347 != 0 {
		goto L2
...
L74:
	;
	F_errfinish(m, int32(521464), int32(180), int32(373161))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L2
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+132)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+128)) = v31
	F_errmsg(m, int32(379646), v19+int32(128))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L2
...
L83:
	;
	F_errfinish(m, int32(521464), int32(193), int32(373161))
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L2
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+116)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+112)) = v31
	F_errmsg(m, int32(206308), v19+int32(112))
	mBase = m.M
	v480 = m.ExcPending
	if v480 != 0 {
		goto L2
...
L124:
	;
	F_errfinish(m, int32(521464), int32(232), int32(373161))
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L2
...
L131:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+100)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+96)) = v31
	F_errmsg(m, int32(206392), v19+int32(96))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L2
...
L132:
	;
	F_errfinish(m, int32(521464), int32(242), int32(373161))
	mBase = m.M
	v520 = m.ExcPending
	if v520 != 0 {
		goto L2
...
L143:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+84)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+80)) = v409
	F_errmsg(m, int32(703455), v19+int32(80))
	mBase = m.M
	v579 = m.ExcPending
	if v579 != 0 {
		goto L2
...
L144:
	;
	F_errfinish(m, int32(521464), int32(253), int32(373161))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L2
...
L157:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+68)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+64)) = v409
	F_errmsg(m, int32(493098), v19-int32(-64))
	mBase = m.M
	v654 = m.ExcPending
	if v654 != 0 {
		goto L2
...
L158:
	;
	F_errfinish(m, int32(521464), int32(264), int32(373161))
	mBase = m.M
	v659 = m.ExcPending
	if v659 != 0 {
		goto L2
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+52)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v19)+48)) = v409
	F_errmsg(m, int32(493098), v19+int32(48))
	mBase = m.M
	v716 = m.ExcPending
	if v716 != 0 {
		goto L2
...
L177:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v749)+36)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v749)+32)) = v757
	F_errmsg(m, int32(493098), v749+int32(32))
	mBase = m.M
	v782 = m.ExcPending
	if v782 != 0 {
		goto L2
...
L184:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v808)+20)) = int32(287726)
	*(*int32)(unsafe.Add(mBase, uint32(v808)+16)) = v816
	F_errmsg(m, int32(493098), v808+int32(16))
	mBase = m.M
	v842 = m.ExcPending
	if v842 != 0 {
		goto L2
...
L131:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v79)+16)) = v651
	F_errmsg_internal(m, int32(506337), v79+int32(16))
	mBase = m.M
	v657 = m.ExcPending
	if v657 != 0 {
		goto L25
...
L132:
	;
	F_errfinish(m, int32(517011), int32(7640), int32(370986))
	mBase = m.M
	v662 = m.ExcPending
	if v662 != 0 {
		goto L25
...
L173:
	;
	v993 = *(*float64)(unsafe.Add(mBase, _consts[386]))
...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v44)+16)) = v643 + int32(4)
	F_errmsg_internal(m, int32(727935), v44+int32(16))
	mBase = m.M
	v651 = m.ExcPending
	if v651 != 0 {
		goto L1
...
L145:
	;
	F_errfinish(m, int32(514542), int32(743), int32(360514))
	mBase = m.M
	v656 = m.ExcPending
	if v656 != 0 {
		goto L1
...
L163:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v44)+272)) = v694
	v700 = F_table_index_fetch_tuple_check(m, l4, v44+int32(272), int32(4211736), int32(0))
	mBase = m.M
	v701 = m.ExcPending
	if v701 != 0 {
		goto L1
...
L186:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v44)+48)) = v756 + int32(4)
	F_errmsg(m, int32(730627), v44+int32(48))
	mBase = m.M
	v764 = m.ExcPending
	if v764 != 0 {
		goto L1
...
L188:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v44)+32)) = v747
	F_errdetail(m, int32(609521), v44+int32(32))
	mBase = m.M
	v770 = m.ExcPending
	if v770 != 0 {
		goto L1
...
L192:
	;
	F_errfinish(m, int32(514542), int32(673), int32(360514))
	mBase = m.M
	v780 = m.ExcPending
	if v780 != 0 {
		goto L1
...
L199:
	;
	F_errhint(m, int32(644100), int32(0))
	mBase = m.M
	v827 = m.ExcPending
	if v827 != 0 {
		goto L1
...
L201:
	;
	F_errfinish(m, int32(514542), int32(766), int32(360514))
	mBase = m.M
	v837 = m.ExcPending
	if v837 != 0 {
		goto L1
...
func F_build_backup_content(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v15 != 0 {
		...
		if v25 != 0 {
			...
			v26 = F_pg_strftime(m, v10+int32(400), int32(128), int32(532110), v24)
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
				...
				*(*uint32)(unsafe.Add(mBase, uint32(v10)+200)) = uint32(v39)
				v47 = F_pg_snprintf(m, v10+int32(336), int32(64), int32(534000), v10+int32(192))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+184)) = v10 + int32(336)
					F_appendStringInfo(m, v12, int32(788014), v10+int32(176))
					mBase = m.M
					v61 = m.ExcPending
					if v61 != 0 {
						return int32(0)
						...
						if l1 != 0 {
							...
							*(*uint32)(unsafe.Add(mBase, uint32(v10)+168)) = uint32(v73)
							v81 = F_pg_snprintf(m, v10+int32(208), int32(64), int32(534000), v10+int32(160))
							mBase = m.M
							v82 = m.ExcPending
							if v82 != 0 {
								return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+152)) = v10 + int32(208)
								F_appendStringInfo(m, v12, int32(788051), v10+int32(144))
								mBase = m.M
								v95 = m.ExcPending
								if v95 != 0 {
									return int32(0)
									...
									*(*uint32)(unsafe.Add(mBase, uint32(v10)+128)) = uint32(v102)
									F_appendStringInfo(m, v12, int32(784075), v10+int32(128))
									mBase = m.M
									v108 = m.ExcPending
									if v108 != 0 {
										return int32(0)
									} else {
										F_appendStringInfoString(m, v12, int32(782897))
										mBase = m.M
										v111 = m.ExcPending
										if v111 != 0 {
											return int32(0)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v10)+112)) = v115
											F_appendStringInfo(m, v12, int32(780243), v10+int32(112))
											mBase = m.M
											v121 = m.ExcPending
											if v121 != 0 {
												return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = v10 + int32(400)
												F_appendStringInfo(m, v12, int32(780271), v10+int32(96))
												mBase = m.M
												v129 = m.ExcPending
												if v129 != 0 {
													return int32(0)
													...
													*(*int32)(unsafe.Add(mBase, uint32(v10)+80)) = l0
													F_appendStringInfo(m, v12, int32(780260), v10+int32(80))
													mBase = m.M
													v135 = m.ExcPending
													if v135 != 0 {
														return int32(0)
														...
														*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = v136
														F_appendStringInfo(m, v12, int32(778711), v10-int32(-64))
														mBase = m.M
														v142 = m.ExcPending
														if v142 != 0 {
															return int32(0)
															...
															if l1 != 0 {
																...
																if v152 != 0 {
																	...
																	v153 = F_pg_strftime(m, v10+int32(208), int32(128), int32(532110), v151)
																	mBase = m.M
																	v154 = m.ExcPending
																	if v154 != 0 {
																		return int32(0)
																		...
																		*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = v10 + int32(208)
																		F_appendStringInfo(m, v12, int32(780287), v10+int32(48))
																		mBase = m.M
																		v162 = m.ExcPending
																		if v162 != 0 {
																			return int32(0)
																			...
																			*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v163
																			F_appendStringInfo(m, v12, int32(778731), v10+int32(32))
																			mBase = m.M
																			v169 = m.ExcPending
																			if v169 != 0 {
																				return int32(0)
																				...
																				if v170 != int64(0) {
																					...
																					*(*uint32)(unsafe.Add(mBase, uint32(v10)+16)) = uint32(v175)
																					F_appendStringInfo(m, v12, int32(784046), v10+int32(16))
																					mBase = m.M
																					v181 = m.ExcPending
																					if v181 != 0 {
																						return int32(0)
																						...
																						*(*int32)(unsafe.Add(mBase, uint32(v10))) = v182
																						F_appendStringInfo(m, v12, int32(778685), v10)
																						mBase = m.M
																						v186 = m.ExcPending
																						if v186 != 0 {
																							return int32(0)
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v45
	F_errmsg_internal(m, int32(505014), v11)
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L5
...
L19:
	;
	F_errfinish(m, int32(518229), int32(2015), int32(382954))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L5
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v15 + int32(4)
	F_errmsg(m, int32(317755), v11+int32(32))
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L5
...
L50:
	;
	F_errfinish(m, int32(518229), int32(1984), int32(382954))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L5
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v175
	F_errmsg(m, int32(365444), v11+int32(16))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L5
...
L55:
	;
	F_errfinish(m, int32(518229), int32(2066), int32(382954))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L5
	...
	if v7 == int32(0) {
		...
		if v11 != 0 {
			...
			if v13 == int32(0) {
				...
				v21 = F_AllocSetContextCreateInternal(m, v16, int32(66316), int32(0), int32(1024), int32(8192))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return
						...
						if v28 == v26 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v66)+92)) = v85
							...
							if v36 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v40)+4)) = int32(1694320)
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+196)) = v278
	v282 = F_ExecInitExtraTupleSlot(m, l2, v278, int32(1650044))
	mBase = m.M
	v283 = m.ExcPending
	if v283 != 0 {
		goto L7
...
L55:
	...
	v303 = F_ExecInitExtraTupleSlot(m, l2, v301, int32(1650044))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L7
