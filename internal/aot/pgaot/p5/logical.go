...
L18:
	...
	v106 = *(*int32)(unsafe.Add(mBase, _consts[514]))
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v141
	F_errmsg_internal(m, int32(210491), v20)
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L13
...
L31:
	;
	F_errfinish(m, int32(523431), int32(2138), int32(372159))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L13
...
L47:
	;
	v195 = *(*int32)(unsafe.Add(mBase, _consts[514]))
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v77)+4)) = int32(256944)
	...
	if v3 == int32(0) {
		...
		if v6 != int32(-1) {
			...
			if v14 != 0 {
				...
				F_errmsg_internal(m, int32(138503), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(524682), int32(690), int32(374461))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
...
func F_logical_read_xlog_page(m *base.Module, l0 int32, l1 int64, l2 int32, l3 int64, l4 int32) int32 {
	...
	v21 = *(*int64)(unsafe.Add(mBase, _consts[568]))
	if v21 == v10 {
		v46 = int32(0)
		goto L3
	} else {
...
L2:
	;
	v363 = *(*int64)(unsafe.Add(mBase, _consts[568]))
...
L5:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[569]))
	v29 = *(*int32)(unsafe.Add(mBase, _consts[570]))
	if v29 == int32(0) {
		goto L2
	} else {
		goto L6
...
L6:
	;
	v33 = *(*int32)(unsafe.Add(mBase, _consts[514]))
...
L14:
	;
	v60 = *(*int32)(unsafe.Add(mBase, _consts[415]))
...
L19:
	;
	v68 = *(*int32)(unsafe.Add(mBase, _consts[571]))
	if v68 != 0 {
		goto L21
	} else {
		goto L22
...
L26:
	;
	v80 = *(*int32)(unsafe.Add(mBase, _consts[569]))
	if v80 != 0 {
		goto L27
	} else {
		goto L28
...
L33:
	;
	v128 = *(*int32)(unsafe.Add(mBase, _consts[569]))
	if v128 != 0 {
		goto L48
	} else {
		goto L49
...
L34:
	;
	*(*int64)(unsafe.Add(mBase, _consts[568])) = v125
	goto L33
L35:
	;
	if v98 == int32(0) {
...
L48:
	;
	v130 = *(*int32)(unsafe.Add(mBase, _consts[569]))
	v132 = *(*int64)(unsafe.Add(mBase, _consts[568]))
	v134 = *(*int32)(unsafe.Add(mBase, _consts[570]))
	if v134 == int32(0) {
		goto L47
	} else {
		goto L51
...
L50:
	;
	v152 = *(*int64)(unsafe.Add(mBase, _consts[572]))
...
L51:
	;
	v138 = *(*int32)(unsafe.Add(mBase, _consts[514]))
...
L60:
	;
	v160 = int32(*(*uint8)(unsafe.Add(mBase, _consts[573])))
	if v160 != 0 {
		goto L58
	} else {
		goto L61
...
L63:
	;
	v189 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[574])) = uint8(v189)
...
L64:
	;
	v166 = *(*int64)(unsafe.Add(mBase, _consts[568]))
...
L67:
	;
	v170 = *(*int32)(unsafe.Add(mBase, _consts[569]))
	v172 = *(*int32)(unsafe.Add(mBase, _consts[570]))
	if v172 == int32(0) {
		goto L47
	} else {
		goto L68
...
L68:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[514]))
...
L76:
	;
	v197 = int32(*(*uint8)(unsafe.Add(mBase, _consts[575])))
	if v197 == int32(0) {
		goto L77
	} else {
		goto L78
...
L77:
	;
	v212 = *(*int64)(unsafe.Add(mBase, _consts[576]))
	if v212 <= int64(0) {
		goto L82
	} else {
		goto L83
...
L78:
	;
	v201 = int32(*(*uint8)(unsafe.Add(mBase, _consts[577])))
	if v201 == int32(0) {
		goto L77
	} else {
		goto L79
...
L83:
	;
	v216 = *(*int32)(unsafe.Add(mBase, _consts[578]))
	if v216 <= int32(0) {
		goto L82
	} else {
		goto L84
...
L84:
	;
	v220 = *(*int64)(unsafe.Add(mBase, _consts[579]))
...
L87:
	;
	v242 = int32(*(*uint8)(unsafe.Add(mBase, _consts[573])))
	if v242 != 0 {
		goto L82
	} else {
		goto L92
...
L97:
	;
	v279 = int32(10000)
	v281 = *(*int32)(unsafe.Add(mBase, _consts[578]))
	if v281 <= int32(0) {
		v316 = v279
		goto L98
	} else {
...
L99:
	;
	v285 = *(*int64)(unsafe.Add(mBase, _consts[576]))
	if v285 <= int64(0) {
		v316 = v279
		goto L98
	} else {
...
L100:
	;
	v289 = int32(*(*uint8)(unsafe.Add(mBase, _consts[573])))
...
L121:
	;
	*(*uint8)(unsafe.Add(mBase, _consts[580])) = uint8(v378)
	if v378 != 0 {
		goto L126
	} else {
		goto L127
...
L131:
	...
	*(*int32)(unsafe.Add(mBase, _consts[581])) = v393
	v396 = *(*int32)(unsafe.Add(mBase, uint32(v15)+4))
	*(*uint8)(unsafe.Add(mBase, _consts[582])) = uint8(base.B2i32(v393 != v396))
	v400 = *(*int64)(unsafe.Add(mBase, uint32(l0)+1232))
	*(*int64)(unsafe.Add(mBase, _consts[583])) = v400
	v403 = *(*int32)(unsafe.Add(mBase, uint32(l0)+1240))
	*(*int32)(unsafe.Add(mBase, _consts[584])) = v403
