...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v141
	F_errmsg_internal(m, int32(199498), v20)
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L13
...
L31:
	;
	F_errfinish(m, int32(497734), int32(2138), int32(353799))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L13
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v77)+4)) = int32(244001)
	...
	if v3 == int32(0) {
		...
		if v6 != int32(-1) {
			...
			if v14 != 0 {
				...
				F_errmsg_internal(m, int32(129875), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(498985), int32(690), int32(355906))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
