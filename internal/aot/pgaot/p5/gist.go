					...
					if v25 != 0 {
						...
						if v94 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v23
							F_errmsg_internal(m, int32(386831), v9)
							mBase = m.M
							v98 = m.ExcPending
							if v98 != 0 {
								return
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+16)) = base.I32_extend16_s(v118)
	F_errmsg_internal(m, int32(483136), v33+int32(16))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L1
...
L76:
	;
	F_errfinish(m, int32(493070), int32(448), int32(102331))
	mBase = m.M
	v467 = m.ExcPending
	if v467 != 0 {
		goto L1
...
func F_gist_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v11)+56)) = v46
		F_appendStringInfo(m, l0, int32(500516), v11+int32(48))
		mBase = m.M
		v52 = m.ExcPending
		if v52 != 0 {
			return
	...
	case 1:
		...
		*(*int64)(unsafe.Add(mBase, uint32(v11)+16)) = v20
		F_appendStringInfo(m, l0, int32(500391), v11+int32(16))
		mBase = m.M
		v38 = m.ExcPending
		if v38 != 0 {
			return
	...
	case 2:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v11)+64)) = v53
		F_appendStringInfo(m, l0, int32(170945), v11-int32(-64))
		mBase = m.M
		v59 = m.ExcPending
		if v59 != 0 {
			return
