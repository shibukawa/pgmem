...
func F_ExecutorStart(m *base.Module, l0 int32, l1 int32) {
	...
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[0]))
	if v36 == v3 {
		goto L2
	} else {
		goto L3
...
L1:
	;
	v71 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[1]))
	if v71 != 0 {
		goto L6
	} else {
		goto L7
...
L3:
	;
	v40 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ExecutorStart[2])))
	if v40 != int32(1) {
		goto L2
	} else {
		goto L4
...
L5:
	;
	v49 = int32(_a_F_ExecutorStart_0)
	v51 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[3]))
	v52 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[3])) = v51 + v52
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36))) = v55 + int32(2)
	v66 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[3])) = v66 - v52
	goto L2
L6:
	;
...
L8:
	...
	v76 = v74 - int32(128)
	m.G0 = v76
	v79 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ExecutorStart[4])))
	if v79 == int32(0) {
		goto L13
	} else {
		goto L14
...
L13:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[5]))
...
L30:
	;
	v150 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[6]))
	goto L31
L31:
	;
...
L33:
	;
	v161 = *(*int32)(unsafe.Add(mBase, uint32(v155<<(uint(int32(3))%32))+uint32(_c_F_ExecutorStart[7])))
	goto L34
L34:
	;
...
L41:
	;
	v210 = *(*int32)(unsafe.Add(mBase, uint32(v204<<(uint(int32(3))%32))+uint32(_c_F_ExecutorStart[7])))
	goto L42
L42:
	;
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+40)) = v243
	v246 = int32(_a_F_ExecutorStart_1)
	v247 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[8]))
	v249 = *(*int32)(unsafe.Add(mBase, uint32(v243)+100))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[8])) = v249
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v76))) = v285
	F_errmsg_internal(m, int32(_a_F_ExecutorStart_2), v76)
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L9
...
L60:
	;
	F_errfinish(m, int32(_a_F_ExecutorStart_3), int32(238), int32(_a_F_ExecutorStart_4))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		goto L9
...
L68:
	;
	v326 = int32(_a_F_ExecutorStart_5)
	v328 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[9]))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[9])) = v328 + int32(1)
	goto L71
L69:
	;
	goto L70
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v416)+8)) = v422
	v429 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[8]))
	v434 = F_AllocSetContextCreateInternal(m, v429, int32(_a_F_ExecutorStart_6), v425, int32(_a_F_ExecutorStart_7), int32(_a_F_ExecutorStart_8))
	mBase = m.M
	v435 = m.ExcPending
	if v435 != 0 {
		goto L9
...
L214:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorStart[8])) = v1285
...
L237:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1269)+16)) = v1373
	F_errmsg_internal(m, int32(_a_F_ExecutorStart_9), v1269+int32(16))
	mBase = m.M
	v1379 = m.ExcPending
	if v1379 != 0 {
		goto L9
...
L238:
	;
	F_errfinish(m, int32(_a_F_ExecutorStart_3), int32(918), int32(_a_F_ExecutorStart_10))
	mBase = m.M
	v1384 = m.ExcPending
	if v1384 != 0 {
		goto L9
...
L249:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1269)+48)) = v1402 + int32(4)
	F_errmsg(m, int32(_a_F_ExecutorStart_11), v1269+int32(48))
	mBase = m.M
	v1410 = m.ExcPending
	if v1410 != 0 {
		goto L9
...
L250:
	;
	F_errfinish(m, int32(_a_F_ExecutorStart_3), int32(1197), int32(_a_F_ExecutorStart_12))
	mBase = m.M
	v1415 = m.ExcPending
	if v1415 != 0 {
		goto L9
...
L253:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1269)+64)) = v1423 + int32(4)
	F_errmsg(m, int32(_a_F_ExecutorStart_13), v1269-int32(-64))
	mBase = m.M
	v1431 = m.ExcPending
	if v1431 != 0 {
		goto L9
...
L254:
	;
	F_errfinish(m, int32(_a_F_ExecutorStart_3), int32(1204), int32(_a_F_ExecutorStart_12))
	mBase = m.M
	v1436 = m.ExcPending
	if v1436 != 0 {
		goto L9
...
L257:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1269)+80)) = v1444 + int32(4)
	F_errmsg(m, int32(_a_F_ExecutorStart_14), v1269+int32(80))
	mBase = m.M
	v1452 = m.ExcPending
	if v1452 != 0 {
		goto L9
...
L258:
	;
	F_errfinish(m, int32(_a_F_ExecutorStart_3), int32(1211), int32(_a_F_ExecutorStart_12))
	mBase = m.M
	v1457 = m.ExcPending
	if v1457 != 0 {
		goto L9
...
L262:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1269)+96)) = v1468 + int32(4)
	F_errmsg(m, int32(_a_F_ExecutorStart_15), v1269+int32(96))
	mBase = m.M
	v1476 = m.ExcPending
	if v1476 != 0 {
		goto L9
...
L263:
	;
	F_errfinish(m, int32(_a_F_ExecutorStart_3), int32(1219), int32(_a_F_ExecutorStart_12))
	mBase = m.M
	v1481 = m.ExcPending
	if v1481 != 0 {
		goto L9
...
L286:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1269)+112)) = v1677 + int32(4)
	F_errmsg(m, int32(_a_F_ExecutorStart_16), v1269+int32(112))
	mBase = m.M
	v1685 = m.ExcPending
	if v1685 != 0 {
		goto L9
...
L287:
	;
	F_errfinish(m, int32(_a_F_ExecutorStart_3), int32(1228), int32(_a_F_ExecutorStart_12))
	mBase = m.M
	v1690 = m.ExcPending
	if v1690 != 0 {
		goto L9
...
L290:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1269)+32)) = v1698 + int32(4)
	F_errmsg(m, int32(_a_F_ExecutorStart_17), v1269+int32(32))
	mBase = m.M
	v1706 = m.ExcPending
	if v1706 != 0 {
		goto L9
...
L291:
	;
	F_errfinish(m, int32(_a_F_ExecutorStart_3), int32(1234), int32(_a_F_ExecutorStart_12))
	mBase = m.M
	v1711 = m.ExcPending
	if v1711 != 0 {
		goto L9
...
L294:
	;
	v1754 = F_ExecInitExtraTupleSlot(m, v1262, int32(0), int32(_a_F_ExecutorStart_18))
	mBase = m.M
	v1755 = m.ExcPending
	if v1755 != 0 {
		goto L9
