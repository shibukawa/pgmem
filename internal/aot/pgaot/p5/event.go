...
func F_EventTriggerCollectAlterOpFam(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	var v42 int32
	_ = v42
	v9 = *(*int32)(unsafe.Add(mBase, _consts[286]))
	if v9 == int32(0) {
		return
	} else {
				...
				if v34 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = v33
					...
					if v40 != 0 {
						...
						v42 = *(*int32)(unsafe.Add(mBase, _consts[286]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v19)+28)) = l3
					...
					if v40 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = v39
						v43 = *(*int32)(unsafe.Add(mBase, _consts[286]))
						...
						if v46 != 0 {
							...
							v48 = *(*int32)(unsafe.Add(mBase, _consts[286]))
