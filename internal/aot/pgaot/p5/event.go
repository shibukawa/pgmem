...
func F_EventTriggerCollectAlterOpFam(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	var v42 int32
	_ = v42
	v9 = *(*int32)(unsafe.Add(mBase, _consts[285]))
	if v9 == int32(0) {
		return
	} else {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v19)+4)) = uint8(v24)
				...
				if v34 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = v33
					v37 = *(*int32)(unsafe.Add(mBase, _consts[285]))
					...
					if v40 != 0 {
						...
						v42 = *(*int32)(unsafe.Add(mBase, _consts[285]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v19)+28)) = l3
					...
					if v40 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = v39
						v43 = *(*int32)(unsafe.Add(mBase, _consts[285]))
						...
						if v46 != 0 {
							...
							v48 = *(*int32)(unsafe.Add(mBase, _consts[285]))
