...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+36)) = l0 + int32(44)
	v216 = int32(0)
	v218 = *(*int32)(unsafe.Add(mBase, _c_F_populate_record_field[0]))
...
L79:
	;
	v156 = int32(_a_F_populate_record_field_0)
	goto L81
L80:
	;
	v156 = int32(_a_F_populate_record_field_1)
	goto L81
L81:
	;
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v175
	F_errmsg_internal(m, int32(_a_F_populate_record_field_2), v18+int32(16))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L1
...
L86:
	;
	F_errfinish(m, int32(_a_F_populate_record_field_3), int32(3199), int32(_a_F_populate_record_field_4))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L1
...
L105:
	;
	v299 = *(*int32)(unsafe.Add(mBase, _c_F_populate_record_field[1]))
...
L156:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v74
	F_errmsg_internal(m, int32(_a_F_populate_record_field_5), v18)
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L1
...
L157:
	;
	F_errfinish(m, int32(_a_F_populate_record_field_3), int32(3470), int32(_a_F_populate_record_field_6))
	mBase = m.M
	v482 = m.ExcPending
	if v482 != 0 {
		goto L1
...
L48:
	;
	v117 = int32(_a_F_populate_recordset_worker_0)
	v118 = *(*int32)(unsafe.Add(mBase, _c_F_populate_recordset_worker[0]))
	v120 = *(*int32)(unsafe.Add(mBase, uint32(v18)+4))
	v121 = *(*int32)(unsafe.Add(mBase, uint32(v120)+16))
	*(*int32)(unsafe.Add(mBase, _c_F_populate_recordset_worker[0])) = v121
	v123 = *(*int32)(unsafe.Add(mBase, uint32(v18)+12))
	v130 = *(*int32)(unsafe.Add(mBase, _c_F_populate_recordset_worker[1]))
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_populate_recordset_worker[0])) = v118
...
L59:
	;
	v186 = *(*int32)(unsafe.Add(mBase, _c_F_populate_recordset_worker[2]))
