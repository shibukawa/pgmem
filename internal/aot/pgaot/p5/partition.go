...
L1:
	...
	v17 = *(*int32)(unsafe.Add(mBase, _consts[322]))
...
L18:
	;
	v67 = F_MakeSingleTupleTableSlot(m, v59, int32(1566948))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L4
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v696
	F_errmsg_internal(m, int32(164413), v20)
	mBase = m.M
	v705 = m.ExcPending
	if v705 != 0 {
		goto L20
...
L135:
	;
	F_errfinish(m, int32(465777), int32(1898), int32(313719))
	mBase = m.M
	v710 = m.ExcPending
	if v710 != 0 {
		goto L20
				...
				if v131 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v132
					...
					if v136 != 0 {
						...
						F_errfinish(m, int32(465605), int32(4069), int32(399179))
						mBase = m.M
						v141 = m.ExcPending
						if v141 != 0 {
							return
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v26
	F_errmsg_internal(m, int32(71109), v10)
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L14
...
L16:
	;
	F_errfinish(m, int32(465777), int32(1739), int32(223655))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L14
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = l2
	F_errmsg_internal(m, int32(36680), v13)
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L4
...
L24:
	;
	F_errfinish(m, int32(463892), int32(3848), int32(196815))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L4
