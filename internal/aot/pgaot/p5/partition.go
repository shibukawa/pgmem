...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v696
	F_errmsg_internal(m, int32(_a_F_ExecInitPartitionExecPruning_0), v20)
	mBase = m.M
	v705 = m.ExcPending
	if v705 != 0 {
		goto L20
				...
				*(*int64)(unsafe.Add(mBase, uint32(v10)+24)) = v29
				...
				if v131 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v132
					F_errmsg_internal(m, int32(_a_F_StorePartitionBound_0), v10)
					mBase = m.M
					v136 = m.ExcPending
					if v136 != 0 {
						return
...
L14:
	;
	if base.Ui32(v33-int32(_a_F_make_partition_op_expr_0)) < base.Ui32(int32(4)) {
		goto L9
	} else {
		goto L18
	}
...
L18:
	;
	if base.Ui32(v33-int32(_a_F_make_partition_op_expr_1)) < base.Ui32(int32(2)) {
		goto L9
	} else {
		goto L19
	}
