...
L18:
	;
	v67 = F_MakeSingleTupleTableSlot(m, v59, int32(1599204))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L4
...
L135:
	;
	F_errfinish(m, int32(493146), int32(1898), int32(332590))
	mBase = m.M
	v710 = m.ExcPending
	if v710 != 0 {
		goto L20
				...
				if v131 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v132
					...
					if v136 != 0 {
						...
						F_errfinish(m, int32(492925), int32(4069), int32(422487))
						mBase = m.M
						v141 = m.ExcPending
						if v141 != 0 {
							return
...
L16:
	;
	F_errfinish(m, int32(493146), int32(1739), int32(237129))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L14
...
L24:
	;
	F_errfinish(m, int32(491109), int32(3848), int32(208136))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L4
