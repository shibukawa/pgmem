...
func F_set_max_safe_fds(m *base.Module) {
	...
	v11 = v9 + int32(-64)
	m.G0 = v11
	v14 = *(*int32)(unsafe.Add(mBase, _consts[648]))
...
L9:
	;
	v37 = *(*int32)(unsafe.Add(mBase, _consts[85]))
	if v37 != int32(52) {
		v74 = v33
		goto L8
	} else {
...
L26:
	;
	F_errmsg(m, int32(309727), int32(0))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(525021), int32(988), int32(184313))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
...
L43:
	;
	*(*int32)(unsafe.Add(mBase, _consts[85])) = int32(0) - v117
	v125 = int32(-1)
	goto L45
L44:
	;
...
L46:
	;
	v129 = *(*int32)(unsafe.Add(mBase, _consts[85]))
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v103
	F_errmsg_internal(m, int32(307666), v9+int32(-32))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L1
...
L50:
	;
	F_errfinish(m, int32(525021), int32(1011), int32(184313))
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L1
...
L64:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _consts[648]))
	if v192 < v202 {
		goto L65
	} else {
		goto L66
...
L67:
	;
	v206 = v204 - int32(10)
	*(*int32)(unsafe.Add(mBase, _consts[649])) = v206
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+24)) = v210
	v220 = *(*int32)(unsafe.Add(mBase, _consts[649]))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v220
	F_errmsg_internal(m, int32(503357), v9+int32(-48))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(525021), int32(1086), int32(184330))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
...
L78:
	;
	F_errmsg(m, int32(137203), int32(0))
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L1
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+8)) = v210
	v250 = *(*int32)(unsafe.Add(mBase, _consts[649]))
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v250 + int32(10)
	F_errdetail(m, int32(648551), v11)
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L1
...
L80:
	;
	F_errfinish(m, int32(525021), int32(1083), int32(184330))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L1
