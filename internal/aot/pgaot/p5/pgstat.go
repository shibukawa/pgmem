...
L9:
	;
	v30 = F__emscripten_memcpy_bulkmem(m, int32(4477824), v10+int32(48), int32(136))
	mBase = m.M
	goto L11
L11:
	;
...
func F_pgstat_get_xact_stack_level(m *base.Module, l0 int32) int32 {
	...
	if v4 != 0 {
		...
		if v5 == l0 {
			...
			v8 = *(*int32)(unsafe.Add(mBase, _consts[317]))
...
L4:
	;
	v24 = *(*int32)(unsafe.Add(mBase, _consts[147]))
	v29 = F_AllocSetContextCreateInternal(m, v24, int32(93381), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L7
...
L97:
	;
	v371 = *(*int32)(unsafe.Add(mBase, _consts[102]))
				...
				if v24 != 0 {
					...
					if v23 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
						F_errmsg_internal(m, int32(53874), v7)
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return
						} else {
							F_errfinish(m, int32(521545), int32(194), int32(526777))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return
...
func F_pgstat_slru_flush_cb(m *base.Module, l0 int32) int32 {
	...
	_ = v97
	v2 = int32(0)
	v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[91])))
	if v7 == v2 {
		v97 = v2
		return v97
	} else {
			...
			if v20 != 0 {
				...
				for {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v38))) = v39 + v42
					...
					v48 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_consts[92])))
					...
					*(*int64)(unsafe.Add(mBase, uint32(v38)+24)) = v57 + v60
					...
					v66 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_consts[93])))
				...
				v85 = int32(0)
				v90 = F__emscripten_memset_bulkmem(m, int32(4536576), base.I32_extend8_s(v85), int32(512))
				mBase = m.M
				...
				if v92 != 0 {
					...
					v94 = int32(0)
					*(*uint8)(unsafe.Add(mBase, _consts[91])) = uint8(v94)
					v97 = v85
					return v97
				}
			}
...
func F_pgstat_slru_snapshot_cb(m *base.Module) {
	...
	if v9 != 0 {
		...
		v14 = F__emscripten_memcpy_bulkmem(m, int32(4529928), v4+int32(52760), int32(512))
		mBase = m.M
