...
func F_pgstat_archiver_snapshot_cb(m *base.Module) {
	...
	var v62 int32
	_ = v62
	v10 = *(*int32)(unsafe.Add(mBase, _consts[558]))
	v14 = v10 + int32(24)
	goto L1
L1:
	;
...
L15:
	;
	v44 = *(*int64)(unsafe.Add(mBase, _consts[1005]))
	if v44 == v40 {
		goto L16
	} else {
		goto L17
...
L16:
	;
	*(*int64)(unsafe.Add(mBase, _consts[1006])) = int64(0)
	v50 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[1007])) = uint8(v50)
	goto L18
L17:
	;
	goto L18
L18:
	;
	*(*int64)(unsafe.Add(mBase, _consts[1005])) = v44 - v40
	v56 = *(*int64)(unsafe.Add(mBase, _consts[1008]))
	if v39 == v56 {
		goto L19
	} else {
		goto L20
...
L19:
	;
	*(*int64)(unsafe.Add(mBase, _consts[1009])) = int64(0)
	v62 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[1010])) = uint8(v62)
	goto L21
L20:
	;
	goto L21
L21:
	;
	*(*int64)(unsafe.Add(mBase, _consts[1008])) = v56 - v39
	return
}
...
func F_pgstat_clear_backend_activity_snapshot(m *base.Module) {
	...
	var v10 int32
	_ = v10
	v3 = *(*int32)(unsafe.Add(mBase, _consts[1001]))
	if v3 != 0 {
		...
		if v5 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[1001])) = int32(0)
			v10 = int32(0)
...
func F_pgstat_get_local_beentry_by_index(m *base.Module, l0 int32) int32 {
	...
	if v5 != 0 {
		...
		v7 = *(*int32)(unsafe.Add(mBase, _consts[1003]))
		v8 = int32(432)
		v15 = *(*int32)(unsafe.Add(mBase, _consts[1002]))
		if l0 <= v15 {
			v17 = v7 + l0*v8 - v8
		} else {
			v17 = int32(0)
...
func F_pgstat_get_xact_stack_level(m *base.Module, l0 int32) int32 {
	...
	var v29 int32
	_ = v29
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1017]))
	if v4 != 0 {
		...
		if v5 == l0 {
			...
			v8 = *(*int32)(unsafe.Add(mBase, _consts[314]))
			...
			if v13 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+8)) = v18
				v21 = int32(4545328)
				v22 = *(*int32)(unsafe.Add(mBase, _consts[1017]))
...
L1:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[1001]))
	if v19 == int32(0) {
		goto L4
	} else {
		goto L5
...
L4:
	...
	v29 = F_AllocSetContextCreateInternal(m, v24, int32(93740), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L7
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1001])) = v29
	v32 = v29
	goto L6
L9:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[1001]))
	v44 = *(*int32)(unsafe.Add(mBase, _consts[656]))
...
L10:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _consts[1001]))
	v54 = *(*int32)(unsafe.Add(mBase, _consts[656]))
...
L11:
	;
	v62 = *(*int32)(unsafe.Add(mBase, _consts[1001]))
	v64 = *(*int32)(unsafe.Add(mBase, _consts[667]))
	v66 = *(*int32)(unsafe.Add(mBase, _consts[656]))
...
L12:
	;
	v73 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1002])) = v73
	v76 = *(*int32)(unsafe.Add(mBase, _consts[656]))
	if v73 < v76+int32(38) {
		goto L13
	} else {
		goto L14
...
L13:
	;
	v82 = *(*int32)(unsafe.Add(mBase, _consts[1004]))
	v83 = v82
	v85 = v39
	v87 = v49
	v88 = v59
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1003])) = v39
	goto L3
L16:
	;
...
L95:
	;
	v430 = v90 + int32(1)
	v432 = *(*int32)(unsafe.Add(mBase, _consts[656]))
...
L96:
	;
	v402 = int32(4485976)
	v404 = *(*int32)(unsafe.Add(mBase, _consts[1002]))
	*(*int32)(unsafe.Add(mBase, _consts[1002])) = v404 + int32(1)
	v408 = int32(-64)
	v413 = *(*int32)(unsafe.Add(mBase, _consts[667]))
	v418 = v85 + int32(432)
	v420 = v87 - v408
	v421 = v88 - v408
	v422 = v89 + v413
...
func F_pgstat_replslot_from_serialized_name_cb(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v8 != 0 {
		...
		if v5 == int32(0) {
			...
			v12 = *(*int32)(unsafe.Add(mBase, _consts[557]))
					...
					if v23 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
						...
						if v31 != 0 {
							...
							F_errfinish(m, int32(524575), int32(194), int32(529807))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return
...
func F_pgstat_report_connect(m *base.Module) {
	...
	if v3 == int32(1) {
		v8 = *(*int64)(unsafe.Add(mBase, _consts[445]))
		*(*int64)(unsafe.Add(mBase, _consts[1011])) = v8
...
func F_pgstat_slru_flush_cb(m *base.Module, l0 int32) int32 {
	...
	if v7 == v2 {
		...
		v11 = *(*int32)(unsafe.Add(mBase, _consts[558]))
		v13 = v11 + int32(52744)
		if l0 == int32(0) {
			...
			if v20 != 0 {
				...
				for {
					...
					v42 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_consts[1012])))
					...
					*(*int64)(unsafe.Add(mBase, uint32(v38)+8)) = v45 + v48
					...
					v54 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_consts[1013])))
					*(*int64)(unsafe.Add(mBase, uint32(v38)+16)) = v51 + v54
					v57 = *(*int64)(unsafe.Add(mBase, uint32(v38)+24))
					v60 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_consts[1014])))
					...
					*(*int64)(unsafe.Add(mBase, uint32(v38)+32)) = v63 + v66
					...
					v72 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_consts[1015])))
					*(*int64)(unsafe.Add(mBase, uint32(v38)+40)) = v69 + v72
					v75 = *(*int64)(unsafe.Add(mBase, uint32(v38)+48))
					v78 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_consts[1016])))
...
func F_pgstat_slru_snapshot_cb(m *base.Module) {
	...
	var v17 int32
	_ = v17
	v4 = *(*int32)(unsafe.Add(mBase, _consts[558]))
	v6 = v4 + int32(52744)
