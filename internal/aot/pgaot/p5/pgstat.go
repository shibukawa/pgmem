...
func F_pgstat_archiver_snapshot_cb(m *base.Module) {
	...
	var v62 int32
	_ = v62
	v10 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[0]))
	v14 = v10 + int32(24)
	goto L1
L1:
	;
	v24 = *(*int32)(unsafe.Add(mBase, uint32(v10)+40))
	v26 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[1]))
	if v26 != 0 {
		goto L3
	} else {
		goto L4
...
L9:
	;
	v30 = F__emscripten_memcpy_bulkmem(m, int32(_a_F_pgstat_archiver_snapshot_cb_0), v10+int32(48), int32(136))
	mBase = m.M
	goto L11
L11:
	;
...
L15:
	;
	v44 = *(*int64)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[2]))
	if v44 == v40 {
		goto L16
	} else {
		goto L17
...
L16:
	...
	*(*int64)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[3])) = int64(0)
	v50 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[4])) = uint8(v50)
	goto L18
L17:
	;
	goto L18
L18:
	;
	*(*int64)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[2])) = v44 - v40
	v56 = *(*int64)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[5]))
	if v39 == v56 {
		goto L19
	} else {
		goto L20
...
L19:
	...
	*(*int64)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[6])) = int64(0)
	v62 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[7])) = uint8(v62)
	goto L21
L20:
	;
	goto L21
L21:
	;
	*(*int64)(unsafe.Add(mBase, _c_F_pgstat_archiver_snapshot_cb[5])) = v56 - v39
	return
}
...
func F_pgstat_progress_update_multi_param(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	_ = v164
	v4 = int32(0)
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_progress_update_multi_param[0]))
	if v11 == v4 {
	} else {
		if l0 == int32(0) {
		} else {
...
func F_pgstat_read_current_status(m *base.Module) {
	...
	_ = v432
	v1 = int32(0)
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[0]))
	if v15 == v1 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[1]))
	if v19 == int32(0) {
		goto L4
	} else {
		goto L5
...
L4:
	;
	v24 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[2]))
	v29 = F_AllocSetContextCreateInternal(m, v24, int32(_a_F_pgstat_read_current_status_0), int32(0), int32(1024), int32(_a_F_pgstat_read_current_status_1))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L7
...
L6:
	;
	v34 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[3]))
	v39 = F_MemoryContextAlloc(m, v32, v34*int32(432)+int32(_a_F_pgstat_read_current_status_2))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L7
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[1])) = v29
	v32 = v29
	goto L6
L9:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[1]))
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[3]))
...
L10:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[1]))
	v54 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[3]))
...
L11:
	;
	v62 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[1]))
	v64 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[4]))
	v66 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[3]))
...
L12:
	;
	v73 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[5])) = v73
	v76 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[3]))
	if v73 < v76+int32(38) {
		goto L13
	} else {
		goto L14
...
L13:
	;
	v82 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[6]))
	v83 = v82
	v85 = v39
	v87 = v49
	v88 = v59
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[0])) = v39
	goto L3
L16:
	;
...
L88:
	;
	v343 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[7]))
	if v343 == int32(0) {
		goto L16
	} else {
		goto L91
...
L95:
	;
	v430 = v90 + int32(1)
	v432 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[3]))
...
L96:
	;
	v402 = int32(_a_F_pgstat_read_current_status_3)
	v404 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[5]))
	*(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[5])) = v404 + int32(1)
	v408 = int32(-64)
	v413 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[4]))
	v418 = v85 + int32(432)
	v420 = v87 - v408
	v421 = v88 - v408
	v422 = v89 + v413
...
L97:
	;
	v371 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[8]))
...
L98:
	...
	v376 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[9]))
...
L102:
	;
	v395 = *(*int32)(unsafe.Add(mBase, _c_F_pgstat_read_current_status[9]))
		...
		if l0 == int32(0) {
			...
			if v20 != 0 {
				...
				for {
					...
					v42 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_pgstat_slru_flush_cb[2])))
					*(*int64)(unsafe.Add(mBase, uint32(v38))) = v39 + v42
					v45 = *(*int64)(unsafe.Add(mBase, uint32(v38)+8))
					v48 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_pgstat_slru_flush_cb[3])))
					*(*int64)(unsafe.Add(mBase, uint32(v38)+8)) = v45 + v48
					v51 = *(*int64)(unsafe.Add(mBase, uint32(v38)+16))
					v54 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_pgstat_slru_flush_cb[4])))
					*(*int64)(unsafe.Add(mBase, uint32(v38)+16)) = v51 + v54
					v57 = *(*int64)(unsafe.Add(mBase, uint32(v38)+24))
					v60 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_pgstat_slru_flush_cb[5])))
					*(*int64)(unsafe.Add(mBase, uint32(v38)+24)) = v57 + v60
					v63 = *(*int64)(unsafe.Add(mBase, uint32(v38)+32))
					v66 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_pgstat_slru_flush_cb[6])))
					*(*int64)(unsafe.Add(mBase, uint32(v38)+32)) = v63 + v66
					v69 = *(*int64)(unsafe.Add(mBase, uint32(v38)+40))
					v72 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_pgstat_slru_flush_cb[7])))
					*(*int64)(unsafe.Add(mBase, uint32(v38)+40)) = v69 + v72
					v75 = *(*int64)(unsafe.Add(mBase, uint32(v38)+48))
					v78 = *(*int64)(unsafe.Add(mBase, uint32(v37)+uint32(_c_F_pgstat_slru_flush_cb[8])))
				...
				v85 = int32(0)
				v90 = F__emscripten_memset_bulkmem(m, int32(_a_F_pgstat_slru_flush_cb_2), base.I32_extend8_s(v85), int32(512))
				mBase = m.M
				...
				if v92 != 0 {
					...
					v94 = int32(0)
					*(*uint8)(unsafe.Add(mBase, _c_F_pgstat_slru_flush_cb[0])) = uint8(v94)
					v97 = v85
					return v97
				}
			}
...
func F_pgstat_slru_snapshot_cb(m *base.Module) {
	...
	if v9 != 0 {
		...
		v14 = F__emscripten_memcpy_bulkmem(m, int32(_a_F_pgstat_slru_snapshot_cb_1), v4+int32(_a_F_pgstat_slru_snapshot_cb_2), int32(512))
		mBase = m.M
