...
L8:
	;
	v342 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[376])) = uint8(v342)
	v352 = v342
	goto L7
L9:
	;
...
L13:
	...
	v69 = *(*int32)(unsafe.Add(mBase, _consts[378]))
	if v67 <= v69 {
		goto L15
	} else {
		goto L16
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v38
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v35
	F_errmsg(m, int32(439335), int32(0))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		v482 = v38
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v38
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v35
	F_errfinish(m, int32(519941), int32(1217), int32(421676))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		v482 = v38
...
L28:
	;
	*(*int32)(unsafe.Add(mBase, _consts[378])) = v123 + v69
	v130 = v64 - v123
	if v130 != 0 {
		v63 = v123 + v125
		v64 = v130
...
L29:
	;
	v124 = F__emscripten_memcpy_bulkmem(m, v63, v69+int32(4452832), v123)
	mBase = m.M
	v125 = v124
	goto L31
L30:
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v38
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v35
	F_errmsg(m, int32(335556), int32(0))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		v482 = v38
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v38
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v35
	F_errfinish(m, int32(519941), int32(1227), int32(421676))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		v482 = v38
...
L51:
	;
	v247 = *(*int32)(unsafe.Add(mBase, _consts[377]))
	v249 = *(*int32)(unsafe.Add(mBase, _consts[378]))
	if v247 <= v249 {
		goto L53
	} else {
		goto L54
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v211
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v213
	F_errmsg(m, int32(102828), int32(0))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		v482 = v218
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v211
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v213
	F_errfinish(m, int32(519941), int32(1262), int32(421676))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		v482 = v218
...
L66:
	;
	*(*int32)(unsafe.Add(mBase, _consts[378])) = v303 + v249
	v310 = v244 - v303
	if v310 != 0 {
		v243 = v303 + v305
		v244 = v310
...
L67:
	;
	v304 = F__emscripten_memcpy_bulkmem(m, v243, v249+int32(4452832), v303)
	mBase = m.M
	v305 = v304
	goto L69
L68:
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+12)) = v215
	v462 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[376])) = uint8(v462)
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v214
	*(*int32)(unsafe.Add(mBase, uint32(v16)+20)) = v209
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v211
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v213
...
L74:
	;
	v389 = *(*int32)(unsafe.Add(mBase, _consts[377]))
	v391 = *(*int32)(unsafe.Add(mBase, _consts[378]))
	if v389 <= v391 {
		goto L76
	} else {
		goto L77
...
L83:
	;
	*(*int32)(unsafe.Add(mBase, _consts[378])) = v401 + v391
	v404 = v386 - v401
	if v404 != 0 {
		v386 = v404
		goto L74
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v211
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v213
	F_errfinish(m, int32(519941), int32(1249), int32(421676))
	mBase = m.M
	v459 = m.ExcPending
	if v459 != 0 {
		v482 = v218
...
func F_pq_puttextmessage(m *base.Module) {
	...
	if v8 != 0 {
		...
		if v7 != int32(546108) {
			...
			v26 = m.T0[v11].(func(*base.Module, int32, int32, int32) int32)(m, int32(67), int32(546108), v6+int32(1))
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return
...
func F_pq_startmsgread(m *base.Module) {
	...
	var v20 int32
	_ = v20
	v2 = int32(*(*uint8)(unsafe.Add(mBase, _consts[376])))
	if v2 != 0 {
		...
		if v6 != 0 {
			...
			if v9 != 0 {
				...
				if v13 != 0 {
					...
					F_errfinish(m, int32(519941), int32(1151), int32(484087))
					mBase = m.M
					v18 = m.ExcPending
					if v18 != 0 {
						return
		...
		v20 = int32(1)
		*(*uint8)(unsafe.Add(mBase, _consts[376])) = uint8(v20)
		return
	}
}
