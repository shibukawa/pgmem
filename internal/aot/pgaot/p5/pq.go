...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v38
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v35
	F_errfinish(m, int32(497423), int32(1217), int32(404195))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		v482 = v38
...
L29:
	;
	v124 = F__emscripten_memcpy_bulkmem(m, v63, v69+int32(4414544), v123)
	mBase = m.M
	v125 = v124
	goto L31
L30:
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v38
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v35
	F_errmsg(m, int32(321256), int32(0))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		v482 = v38
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v38
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v35
	F_errfinish(m, int32(497423), int32(1227), int32(404195))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		v482 = v38
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v211
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v213
	F_errfinish(m, int32(497423), int32(1262), int32(404195))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		v482 = v218
...
L67:
	;
	v304 = F__emscripten_memcpy_bulkmem(m, v243, v249+int32(4414544), v303)
	mBase = m.M
	v305 = v304
	goto L69
L68:
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v211
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v213
	F_errfinish(m, int32(497423), int32(1249), int32(404195))
	mBase = m.M
	v459 = m.ExcPending
	if v459 != 0 {
		v482 = v218
...
func F_pq_puttextmessage(m *base.Module) {
	...
	if v8 != 0 {
		...
		if v7 != int32(522460) {
			...
			v26 = m.T0[v11].(func(*base.Module, int32, int32, int32) int32)(m, int32(67), int32(522460), v6+int32(1))
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return
		...
		if v6 != 0 {
			...
			if v9 != 0 {
				...
				if v13 != 0 {
					...
					F_errfinish(m, int32(497423), int32(1151), int32(464377))
					mBase = m.M
					v18 = m.ExcPending
					if v18 != 0 {
						return
