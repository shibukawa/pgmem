...
func F_IvfflatKmeans(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	v53 = F_AllocSetContextCreateInternal(m, v48, int32(65178), v6, int32(8192), int32(8388608))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L35:
	...
	v334 = F_AllocSetContextCreateInternal(m, v329, int32(65393), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L1
...
L377:
	...
	v3512 = F_AllocSetContextCreateInternal(m, v3507, int32(65393), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v3513 = m.ExcPending
	if v3513 != 0 {
		goto L1
...
L474:
	;
	F_errmsg_internal(m, int32(652695), int32(0))
	mBase = m.M
	v4432 = m.ExcPending
	if v4432 != 0 {
		goto L1
...
L475:
	;
	F_errfinish(m, int32(516323), int32(509), int32(131183))
	mBase = m.M
	v4437 = m.ExcPending
	if v4437 != 0 {
		goto L1
...
L491:
	;
	F_errmsg_internal(m, int32(652654), int32(0))
	mBase = m.M
	v4616 = m.ExcPending
	if v4616 != 0 {
		goto L1
...
L492:
	;
	F_errfinish(m, int32(516323), int32(532), int32(159750))
	mBase = m.M
	v4621 = m.ExcPending
	if v4621 != 0 {
		goto L1
...
L495:
	;
	F_errmsg_internal(m, int32(652564), int32(0))
	mBase = m.M
	v4679 = m.ExcPending
	if v4679 != 0 {
		goto L1
...
L496:
	;
	F_errfinish(m, int32(516323), int32(543), int32(140395))
	mBase = m.M
	v4684 = m.ExcPending
	if v4684 != 0 {
		goto L1
...
L501:
	;
	F_errmsg_internal(m, int32(652741), int32(0))
	mBase = m.M
	v4705 = m.ExcPending
	if v4705 != 0 {
		goto L1
...
L502:
	;
	F_errfinish(m, int32(516323), int32(506), int32(131183))
	mBase = m.M
	v4710 = m.ExcPending
	if v4710 != 0 {
		goto L1
...
L519:
	;
	F_errmsg_internal(m, int32(652605), int32(0))
	mBase = m.M
	v4783 = m.ExcPending
	if v4783 != 0 {
		goto L1
...
L520:
	;
	F_errfinish(m, int32(516323), int32(294), int32(158769))
	mBase = m.M
	v4788 = m.ExcPending
	if v4788 != 0 {
		goto L1
