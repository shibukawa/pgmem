...
func F_int84mul(m *base.Module, l0 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = Fn13861(m, l0, int32(_a_F_int84mul_0), int32(927), int32(_a_F_int84mul_1), int32(_a_F_int84mul_2))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_int8mul(m *base.Module, l0 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = Fn13862(m, l0, int32(_a_F_int8mul_0), int32(499), int32(_a_F_int8mul_1), int32(_a_F_int8mul_2))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
