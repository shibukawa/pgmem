...
L3:
	;
	v42 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[465])) = v42
	v46 = *(*int32)(unsafe.Add(mBase, _consts[466]))
	if v46 == v42 {
		goto L14
	} else {
		goto L15
...
L4:
	;
	v11 = *(*int32)(unsafe.Add(mBase, _consts[467]))
...
L10:
	;
	F_errmsg_internal(m, int32(307858), int32(0))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L8
...
L11:
	;
	F_errfinish(m, int32(520999), int32(1428), int32(126015))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L8
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, _consts[466])) = int32(0)
	return
L15:
	;
