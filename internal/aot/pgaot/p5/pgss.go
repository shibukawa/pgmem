...
L3:
	;
	v23 = *(*int32)(unsafe.Add(mBase, _c_F_pgss_shmem_shutdown[1]))
	if v23 == int32(0) {
		goto L1
	} else {
		goto L4
...
L4:
	;
	v27 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pgss_shmem_shutdown[2])))
	if v27 != int32(1) {
		goto L1
	} else {
		goto L5
...
L5:
	;
	v35 = F_AllocateFile(m, int32(_a_F_pgss_shmem_shutdown_0), int32(_a_F_pgss_shmem_shutdown_1))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L8
...
L6:
	;
	v276 = F_unlink(m, int32(_a_F_pgss_shmem_shutdown_2))
	mBase = m.M
	goto L1
L7:
	;
...
L10:
	;
	v42 = F_fwrite(m, int32(_a_F_pgss_shmem_shutdown_3), int32(4), int32(1), v35)
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L8
...
L14:
	;
	v49 = F_fwrite(m, int32(_a_F_pgss_shmem_shutdown_4), int32(4), int32(1), v35)
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L8
...
L16:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _c_F_pgss_shmem_shutdown[1]))
...
L24:
	;
	v142 = *(*int32)(unsafe.Add(mBase, _c_F_pgss_shmem_shutdown[1]))
...
L29:
	;
	v200 = *(*int32)(unsafe.Add(mBase, _c_F_pgss_shmem_shutdown[0]))
...
L48:
	;
	v220 = F_durable_rename(m, int32(_a_F_pgss_shmem_shutdown_0), int32(_a_F_pgss_shmem_shutdown_5), int32(15))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L8
...
L59:
	;
	v266 = F_unlink(m, int32(_a_F_pgss_shmem_shutdown_0))
	mBase = m.M
	goto L6
L60:
	;
