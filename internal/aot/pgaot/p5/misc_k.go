...
L11:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _c_F_KnownAssignedXidsDisplay[1]))
	v55 = v27 + int32(1)
	v56 = v52
	goto L10
L12:
...
L18:
	;
	v62 = int32(1)
	v65 = *(*int32)(unsafe.Add(mBase, _c_F_KnownAssignedXidsRemoveTree[2]))
...
L33:
	;
	*(*int64)(unsafe.Add(mBase, _c_F_KnownAssignedXidsRemoveTree[4])) = v176 + v175*int64(1000000) - int64(946684800000000)
	goto L13
}
func F_koi8r_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(_a_F_koi8r_to_utf8_0), v18, v18, v18, int32(22), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
func F_koi8r_to_win1251(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(22), int32(23), int32(_a_F_koi8r_to_win1251_0), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
