...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+36)) = v41
	F_appendStringInfo(m, v9+int32(-16), int32(745628), v9+int32(-32))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L1
...
L14:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11)+8)) = v71
	F_errmsg_internal(m, int32(210169), v11)
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L1
...
L17:
	;
	F_errfinish(m, int32(503161), int32(5246), int32(26709))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L1
...
func F_koi8r_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4409572), v18, v18, v18, int32(22), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
func F_koi8r_to_win1251(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(22), int32(23), int32(2249200), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
