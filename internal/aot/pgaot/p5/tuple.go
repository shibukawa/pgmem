...
func F_ExecCheckTupleVisible(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[318]))
	if v10 < int32(2) {
		goto L2
	} else {
		goto L3
...
L51:
	;
	F_errfinish(m, int32(524962), int32(389), int32(411094))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L4
...
func F_GetTupleForTrigger(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32, l9 int32) int32 {
	...
	if l7 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l7))) = v18
		...
		v24 = *(*int32)(unsafe.Add(mBase, _consts[318]))
		...
		if v36 != 0 {
			...
			case 1:
				...
				if v133 != 0 {
					...
					if v137 != 0 {
						...
						F_errfinish(m, int32(520840), int32(3457), int32(236269))
						mBase = m.M
						v142 = m.ExcPending
						if v142 != 0 {
							return int32(0)
						...
						if v54 != 0 {
							...
							if v58 != 0 {
								...
								if v62 != 0 {
									...
									F_errfinish(m, int32(520840), int32(3402), int32(236269))
									mBase = m.M
									v67 = m.ExcPending
									if v67 != 0 {
										return int32(0)
			...
			case 3:
				v90 = *(*int32)(unsafe.Add(mBase, _consts[318]))
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v94 = m.ExcPending
				if v94 != 0 {
					...
					if int32(2) <= v90 {
						...
						if v185 != 0 {
							...
							if v189 != 0 {
								...
								F_errfinish(m, int32(520840), int32(3444), int32(236269))
								mBase = m.M
								v194 = m.ExcPending
								if v194 != 0 {
									return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = int32(3)
						F_errmsg_internal(m, int32(63072), v15+int32(16))
						mBase = m.M
						v103 = m.ExcPending
						if v103 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(520840), int32(3445), int32(236269))
							mBase = m.M
							v108 = m.ExcPending
							if v108 != 0 {
								return int32(0)
			...
			case 4:
				v111 = *(*int32)(unsafe.Add(mBase, _consts[318]))
				if v111 < int32(2) {
					v209 = int32(0)
					m.G0 = v15 + int32(48)
					return v209
					...
					if v117 != 0 {
						...
						if v120 != 0 {
							...
							if v124 != 0 {
								...
								F_errfinish(m, int32(520840), int32(3452), int32(236269))
								mBase = m.M
								v129 = m.ExcPending
								if v129 != 0 {
									return int32(0)
			...
			default:
				...
				if v146 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v15))) = v33
					F_errmsg_internal(m, int32(63031), v15)
					mBase = m.M
					v150 = m.ExcPending
					if v150 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(520840), int32(3461), int32(236269))
						mBase = m.M
						v155 = m.ExcPending
						if v155 != 0 {
							return int32(0)
		...
		v157 = *(*int32)(unsafe.Add(mBase, _consts[242]))
		if v157 != 0 {
			v159 = int32(*(*uint8)(unsafe.Add(mBase, _consts[243])))
			if v159&int32(1) == int32(0) {
				...
				v168 = m.T0[v167].(func(*base.Module, int32, int32, int32, int32) int32)(m, v17, l3, int32(4216496), l5)
				mBase = m.M
				v169 = m.ExcPending
				if v169 != 0 {
					return int32(0)
					...
					if v168 != 0 {
						...
						if v173 != 0 {
							...
							F_errmsg_internal(m, int32(235722), int32(0))
							mBase = m.M
							v177 = m.ExcPending
							if v177 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(520840), int32(3473), int32(236269))
								mBase = m.M
								v182 = m.ExcPending
								if v182 != 0 {
									return int32(0)
