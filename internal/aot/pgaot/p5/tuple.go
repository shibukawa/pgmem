...
L51:
	;
	F_errfinish(m, int32(498914), int32(389), int32(391209))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L4
		...
		*(*int32)(unsafe.Add(mBase, uint32(l7))) = v18
			...
			case 1:
				...
				if v133 != 0 {
					...
					if v137 != 0 {
						...
						F_errfinish(m, int32(495331), int32(3457), int32(224406))
						mBase = m.M
						v142 = m.ExcPending
						if v142 != 0 {
							return int32(0)
						...
						if v54 != 0 {
							...
							if v58 != 0 {
								...
								if v62 != 0 {
									...
									F_errfinish(m, int32(495331), int32(3402), int32(224406))
									mBase = m.M
									v67 = m.ExcPending
									if v67 != 0 {
										return int32(0)
					...
					if int32(2) <= v90 {
						...
						if v185 != 0 {
							...
							if v189 != 0 {
								...
								F_errfinish(m, int32(495331), int32(3444), int32(224406))
								mBase = m.M
								v194 = m.ExcPending
								if v194 != 0 {
									return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = int32(3)
						F_errmsg_internal(m, int32(57556), v15+int32(16))
						mBase = m.M
						v103 = m.ExcPending
						if v103 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(495331), int32(3445), int32(224406))
							mBase = m.M
							v108 = m.ExcPending
							if v108 != 0 {
								return int32(0)
					...
					if v117 != 0 {
						...
						if v120 != 0 {
							...
							if v124 != 0 {
								...
								F_errfinish(m, int32(495331), int32(3452), int32(224406))
								mBase = m.M
								v129 = m.ExcPending
								if v129 != 0 {
									return int32(0)
			...
			default:
				...
				if v146 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v15))) = v33
					F_errmsg_internal(m, int32(57515), v15)
					mBase = m.M
					v150 = m.ExcPending
					if v150 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(495331), int32(3461), int32(224406))
						mBase = m.M
						v155 = m.ExcPending
						if v155 != 0 {
							return int32(0)
		...
		if v157 != 0 {
			...
			if v159&int32(1) == int32(0) {
				...
				v168 = m.T0[v167].(func(*base.Module, int32, int32, int32, int32) int32)(m, v17, l3, int32(4173776), l5)
				mBase = m.M
				v169 = m.ExcPending
				if v169 != 0 {
					return int32(0)
					...
					if v168 != 0 {
						...
						if v173 != 0 {
							...
							F_errmsg_internal(m, int32(223859), int32(0))
							mBase = m.M
							v177 = m.ExcPending
							if v177 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(495331), int32(3473), int32(224406))
								mBase = m.M
								v182 = m.ExcPending
								if v182 != 0 {
									return int32(0)
