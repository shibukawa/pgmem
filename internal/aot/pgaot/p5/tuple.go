...
func F_GetTupleForTrigger(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32, l9 int32) int32 {
	...
	if l7 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l7))) = v18
		...
		v24 = *(*int32)(unsafe.Add(mBase, _c_F_GetTupleForTrigger[0]))
		...
		if v36 != 0 {
			...
			case 3:
				v90 = *(*int32)(unsafe.Add(mBase, _c_F_GetTupleForTrigger[0]))
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v94 = m.ExcPending
				if v94 != 0 {
			...
			case 4:
				v111 = *(*int32)(unsafe.Add(mBase, _c_F_GetTupleForTrigger[0]))
				if v111 < int32(2) {
					v209 = int32(0)
					m.G0 = v15 + int32(48)
					return v209
		...
		v157 = *(*int32)(unsafe.Add(mBase, _c_F_GetTupleForTrigger[1]))
		if v157 != 0 {
			v159 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_GetTupleForTrigger[2])))
			if v159&int32(1) == int32(0) {
				...
				v168 = m.T0[v167].(func(*base.Module, int32, int32, int32, int32) int32)(m, v17, l3, int32(_a_F_GetTupleForTrigger_12), l5)
				mBase = m.M
				v169 = m.ExcPending
				if v169 != 0 {
					return int32(0)
