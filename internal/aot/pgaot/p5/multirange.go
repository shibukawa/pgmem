						...
						if v90 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
							...
							if v94 != 0 {
								...
								F_errfinish(m, int32(518389), int32(432), int32(529854))
								mBase = m.M
								v99 = m.ExcPending
								if v99 != 0 {
									return int32(0)
											...
											if l2 == int32(2) {
												*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v57
												...
												if v105 != 0 {
													...
													F_errfinish(m, int32(518389), int32(451), int32(529854))
													mBase = m.M
													v110 = m.ExcPending
													if v110 != 0 {
														return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v57
												...
												if v66 != 0 {
													...
													F_errfinish(m, int32(518389), int32(456), int32(529854))
													mBase = m.M
													v71 = m.ExcPending
													if v71 != 0 {
														return int32(0)
...
L52:
	;
	F_errfinish(m, int32(518389), int32(2589), int32(248085))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L1
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v23
	F_errmsg_internal(m, int32(388681), v13)
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L1
