						...
						if v90 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
							...
							if v94 != 0 {
								...
								F_errfinish(m, int32(513647), int32(432), int32(524874))
								mBase = m.M
								v99 = m.ExcPending
								if v99 != 0 {
									return int32(0)
										...
										if v58 != 0 {
											...
											if l2 == int32(2) {
												*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v57
												F_errmsg(m, int32(198707), v9+int32(16))
												mBase = m.M
												v105 = m.ExcPending
												if v105 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(513647), int32(451), int32(524874))
													mBase = m.M
													v110 = m.ExcPending
													if v110 != 0 {
														return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v57
												F_errmsg(m, int32(198618), v9+int32(32))
												mBase = m.M
												v66 = m.ExcPending
												if v66 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(513647), int32(456), int32(524874))
													mBase = m.M
													v71 = m.ExcPending
													if v71 != 0 {
														return int32(0)
...
L52:
	;
	F_errfinish(m, int32(513647), int32(2589), int32(245973))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L1
