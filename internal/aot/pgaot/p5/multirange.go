...
L11:
	;
	v31 = F_lookup_type_cache(m, v23, int32(_a_F_multirange_cmp_0))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L1
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v23
	F_errmsg_internal(m, int32(_a_F_multirange_cmp_4), v13)
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L1
...
L6:
	...
	v29 = int32(24)
	v31 = int32(_a_F_multirange_send_0)
	v33 = int32(8)
...
L18:
	...
	v103 = int32(24)
	v105 = int32(_a_F_multirange_send_0)
	v107 = int32(8)
