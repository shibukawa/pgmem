...
L16:
	;
	v74 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_XactLogAbortRecord[0])))
	if v74 != 0 {
		goto L21
	} else {
		goto L22
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+52)) = v57
	v60 = *(*int32)(unsafe.Add(mBase, _c_F_XactLogAbortRecord[1]))
	if v60 < int32(2) {
		v72 = v57
		goto L16
	} else {
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+52)) = v64
	v67 = *(*int32)(unsafe.Add(mBase, _c_F_XactLogAbortRecord[2]))
	*(*int32)(unsafe.Add(mBase, uint32(v15)+28)) = v67
	v70 = *(*int32)(unsafe.Add(mBase, _c_F_XactLogAbortRecord[3]))
...
L27:
	;
	v239 = int32(_a_F_XactLogAbortRecord_0)
	v241 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_XactLogAbortRecord[6])))
	v242 = v241 | int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_XactLogAbortRecord[6])) = uint8(v242)
	goto L73
L28:
	;
...
L53:
	;
	F_XLogRegisterData(m, l9, v221+int32(1))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L24
...
L56:
	;
	v172 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l9))))
	if v172 == int32(0) {
		goto L57
	} else {
		goto L58
...
L70:
	;
	v226 = *(*int32)(unsafe.Add(mBase, uint32(v15)+52))
	v227 = v226
	goto L49
L71:
	;
...
L76:
	;
	v248 = F_XLogInsert(m, int32(1), v247)
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L24
...
L238:
	;
	v919 = int32(_a_F_xact_decode_10)
	v920 = *(*int32)(unsafe.Add(mBase, _c_F_xact_decode[0]))
	v922 = *(*int32)(unsafe.Add(mBase, uint32(v914)+120))
	*(*int32)(unsafe.Add(mBase, _c_F_xact_decode[0])) = v922
...
L242:
	...
	if v926&int32(_a_F_xact_decode_11) != 0 {
		goto L239
	} else {
		goto L243
	}
L243:
	...
	v930 = v929 + v905
	if base.Ui32(int32(_a_F_xact_decode_12)) <= base.Ui32(v930) {
		goto L244
	} else {
		goto L245
	}
L244:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v925))) = v926 | int32(_a_F_xact_decode_11)
...
L268:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_xact_decode[0])) = v920
	goto L213
L269:
	;
	goto L212
...
L281:
	;
	v1076 = F_filter_by_origin_cb_wrapper(m, l0, v201&int32(_a_F_xact_decode_15))
	mBase = m.M
	v1077 = m.ExcPending
	if v1077 != 0 {
		goto L38
...
L299:
	...
	F_ReorderBufferFinishPrepared(m, v1157, v171, v1156, v1155, v1161, v198, v201&int32(_a_F_xact_decode_15), v1154, v29+int32(72), int32(1))
	mBase = m.M
	v1168 = m.ExcPending
	if v1168 != 0 {
		goto L38
...
L311:
	;
	F_ReorderBufferReplay(m, v1279, v1157, v1156, v1155, v198, v201&int32(_a_F_xact_decode_15), v1154)
	mBase = m.M
	v1282 = m.ExcPending
	if v1282 != 0 {
		goto L38
...
L357:
	;
	v1444 = F_filter_by_origin_cb_wrapper(m, l0, v1432&int32(_a_F_xact_decode_15))
	mBase = m.M
	v1445 = m.ExcPending
	if v1445 != 0 {
		goto L38
...
L381:
	;
	v1543 = int32(_a_F_xact_decode_10)
	v1544 = *(*int32)(unsafe.Add(mBase, _c_F_xact_decode[0]))
	v1546 = *(*int32)(unsafe.Add(mBase, uint32(v31)+120))
	*(*int32)(unsafe.Add(mBase, _c_F_xact_decode[0])) = v1546
...
L405:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_xact_decode[0])) = v1544
	goto L380
L406:
	;
	goto L1
L407:
	...
	v1636 = int32(0)
	v1638 = *(*int32)(unsafe.Add(mBase, _c_F_xact_decode[1]))
...
L409:
	;
	F_BeginInternalSubTransaction(m, int32(_a_F_xact_decode_16))
	mBase = m.M
	v1644 = m.ExcPending
	if v1644 != 0 {
		goto L38
...
L426:
	...
	v1856 = int32(7)
	v1860 = v1745 + (v1855+v1856)&int32(_a_F_xact_decode_17)
...
L530:
	...
	v2189 = *(*int32)(unsafe.Add(mBase, _c_F_xact_decode[1]))
...
L545:
	;
	F_ReorderBufferFinishPrepared(m, v2266, v1402, v2267, v2268, v2269, v1429, v1432&int32(_a_F_xact_decode_15), v2273, v29-int32(-64), int32(0))
	mBase = m.M
	v2278 = m.ExcPending
	if v2278 != 0 {
		goto L38
...
L548:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = v40
	F_errmsg_internal(m, int32(_a_F_xact_decode_18), v29)
	mBase = m.M
	v2288 = m.ExcPending
	if v2288 != 0 {
		goto L38
...
L549:
	;
	F_errfinish(m, int32(_a_F_xact_decode_19), int32(351), int32(_a_F_xact_decode_20))
	mBase = m.M
	v2293 = m.ExcPending
	if v2293 != 0 {
		goto L38
