				...
				if v47 != 0 {
										...
										if v167 != 0 {
											...
											if v169 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v25 + int32(4)
												F_errmsg(m, int32(191330), v14+int32(16))
												mBase = m.M
												v179 = m.ExcPending
												if v179 != 0 {
													return int32(0)
													...
													if v183 != 0 {
														...
														F_errfinish(m, int32(492212), int32(1293), int32(97829))
														mBase = m.M
														v188 = m.ExcPending
														if v188 != 0 {
															return int32(0)
					...
					if v52 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = v53 + int32(4)
						F_errmsg_internal(m, int32(689350), v14)
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(492212), int32(1257), int32(97829))
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return int32(0)
					...
					if v73 != 0 {
						...
						if v132 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v70))) = v42
							F_errmsg_internal(m, int32(50210), v70)
							mBase = m.M
							v136 = m.ExcPending
							if v136 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(495981), int32(2598), int32(97803))
								mBase = m.M
								v141 = m.ExcPending
								if v141 != 0 {
									return int32(0)
...
func F_has_column_privilege_id_id_attnum(m *base.Module, l0 int32) int32 {
	...
	if v18 != 0 {
		...
		v20 = F_convert_any_priv_string(m, v15, int32(1640384))
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return int32(0)
			...
			if v24 != 0 {
				...
				if v26 != 0 {
					...
					if v32 != 0 {
						...
						v34 = F_convert_any_priv_string(m, v19, int32(1640384))
						mBase = m.M
						v35 = m.ExcPending
						if v35 != 0 {
							return int32(0)
				...
				if v25 != 0 {
					...
					if v27 != 0 {
						...
						if v33 != 0 {
							...
							v35 = F_convert_any_priv_string(m, v20, int32(1640384))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
			...
			if v93 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
				...
				if v97 != 0 {
					...
					F_errfinish(m, int32(491502), int32(3265), int32(396590))
					mBase = m.M
					v102 = m.ExcPending
					if v102 != 0 {
						return
...
L54:
	...
	v344 = int32(4486928)
	v345 = *(*int32)(unsafe.Add(mBase, _consts[9]))
	v346 = *(*int32)(unsafe.Add(mBase, uint32(v336)+48))
	*(*int32)(unsafe.Add(mBase, _consts[9])) = v346
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v304
	F_errmsg_internal(m, int32(480975), v18)
	mBase = m.M
	v309 = m.ExcPending
	if v309 != 0 {
		goto L74
...
L76:
	;
	F_errfinish(m, int32(492696), int32(1229), int32(337294))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L74
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, _consts[9])) = v345
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v81
	F_errmsg(m, int32(704450), v18+int32(16))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L74
...
L86:
	;
	F_errfinish(m, int32(492696), int32(1225), int32(337294))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L74
