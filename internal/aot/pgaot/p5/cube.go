			...
			if v43 != 0 {
				...
				if v46 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
					F_errmsg(m, int32(171584), v7)
					mBase = m.M
					v52 = m.ExcPending
					if v52 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496353), int32(1615), int32(417865))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
...
L43:
	;
	F_yy_fatal_error_6(m, int32(31244))
	mBase = m.M
	v1182 = m.ExcPending
	if v1182 != 0 {
		goto L19
...
L44:
	;
	F_yy_fatal_error_6(m, int32(665266))
	mBase = m.M
	v1177 = m.ExcPending
	if v1177 != 0 {
		goto L19
...
L45:
	;
	F_yy_fatal_error_6(m, int32(451470))
	mBase = m.M
	v1174 = m.ExcPending
	if v1174 != 0 {
		goto L19
...
L46:
	;
	F_yy_fatal_error_6(m, int32(447256))
	mBase = m.M
	v1171 = m.ExcPending
	if v1171 != 0 {
		goto L19
...
L50:
	;
	F_yy_fatal_error_6(m, int32(421483))
	mBase = m.M
	v1162 = m.ExcPending
	if v1162 != 0 {
		goto L19
...
L54:
	;
	F_yy_fatal_error_6(m, int32(450822))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L19
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v260))) = int32(651469)
	return int32(263)
L57:
	;
	v255 = *(*int32)(unsafe.Add(mBase, uint32(v86)+92))
	*(*int32)(unsafe.Add(mBase, uint32(v255))) = int32(666900)
	return int32(260)
L58:
	;
	v250 = *(*int32)(unsafe.Add(mBase, uint32(v86)+92))
	*(*int32)(unsafe.Add(mBase, uint32(v250))) = int32(668383)
	return int32(259)
L59:
	;
	v245 = *(*int32)(unsafe.Add(mBase, uint32(v86)+92))
	*(*int32)(unsafe.Add(mBase, uint32(v245))) = int32(666900)
	return int32(262)
L60:
	;
	v240 = *(*int32)(unsafe.Add(mBase, uint32(v86)+92))
	*(*int32)(unsafe.Add(mBase, uint32(v240))) = int32(668383)
	return int32(261)
L61:
	;
