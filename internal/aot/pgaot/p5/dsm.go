...
func F_dsm_pin_mapping(m *base.Module, l0 int32) {
	...
	if v3 != 0 {
		F_ResourceOwnerForget(m, v3, l0, int32(1656700))
		mBase = m.M
		v6 = m.ExcPending
		if v6 != 0 {
			return
...
L2:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _consts[653]))
...
L14:
	;
	F_errmsg_internal(m, int32(406106), int32(0))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L15:
	;
	F_errfinish(m, int32(517515), int32(1016), int32(100920))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L1
...
L21:
	;
	v69 = *(*int32)(unsafe.Add(mBase, _consts[653]))
	v70 = v69
	goto L22
L22:
	;
	...
	*(*int32)(unsafe.Add(mBase, uint32(v75))) = v78
	v81 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L26:
	;
	v136 = *(*int32)(unsafe.Add(mBase, _consts[653]))
	*(*int32)(unsafe.Add(mBase, uint32(v136+v63)+16)) = int32(0)
	v141 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L29:
	;
	v117 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L31:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[8]))
...
L33:
	;
	v124 = *(*int32)(unsafe.Add(mBase, _consts[654]))
	v126 = *(*int32)(unsafe.Add(mBase, _consts[653]))
...
L36:
	;
	F_errmsg_internal(m, int32(469997), int32(0))
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(517515), int32(1018), int32(100920))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
