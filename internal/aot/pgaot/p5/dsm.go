...
func F_dsm_unpin_segment(m *base.Module, l0 int32) {
	...
	v10 = v8 - int32(16)
	m.G0 = v10
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_unpin_segment[0]))
	v17 = F_LWLockAcquire(m, v13+int32(_a_F_dsm_unpin_segment_0), v2)
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L2:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_unpin_segment[1]))
...
L14:
	;
	F_errmsg_internal(m, int32(_a_F_dsm_unpin_segment_1), int32(0))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L21:
	;
	v69 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_unpin_segment[1]))
	v70 = v69
	goto L22
L22:
	;
...
L29:
	;
	v117 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_unpin_segment[0]))
	v121 = F_LWLockAcquire(m, v117+int32(_a_F_dsm_unpin_segment_0), int32(0))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L1
...
L31:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_unpin_segment[0]))
	v114 = F_LWLockAcquire(m, v110+int32(_a_F_dsm_unpin_segment_0), int32(0))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
L33:
	;
	v124 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_unpin_segment[2]))
	v126 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_unpin_segment[1]))
