...
func F_ExplainPrintJIT(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if l2 == int32(0) {
		...
		if v18 == int32(0) {
			...
			v25 = int32(_a_F_ExplainPrintJIT_0)
			...
			if v29 != 0 {
				...
				if v33 == int32(0) {
					...
					if v37 != 0 {
						...
						F_appendStringInfoString(m, v38, int32(_a_F_ExplainPrintJIT_1))
						mBase = m.M
						v41 = m.ExcPending
						if v41 != 0 {
							return
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+24)) = v42 + int32(1)
							...
							F_ExplainPropertyInteger(m, int32(_a_F_ExplainPrintJIT_2), int32(0), v48, l0)
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return
												...
												*(*int32)(unsafe.Add(mBase, uint32(l0)+24)) = v164 - int32(1)
												...
												if v98 != 0 {
													...
													*(*float64)(unsafe.Add(mBase, uint32(v14)+8)) = base.F64_mul(base.F64_div(base.F64_convert_i64_s(v100), v118), v120)
													F_appendStringInfo(m, v99, int32(_a_F_ExplainPrintJIT_14), v14)
													mBase = m.M
													v157 = m.ExcPending
													if v157 != 0 {
														return
					...
					F_ExplainPropertyInteger(m, int32(_a_F_ExplainPrintJIT_2), int32(0), v170, l0)
					mBase = m.M
					v172 = m.ExcPending
					if v172 != 0 {
						return
					} else {
						v173 = int32(_a_F_ExplainPrintJIT_15)
											...
											if v209 != 0 {
												...
												if v210 != int32(1) {
													...
													if v213 != int32(1) {
														...
														v216 = int32(_a_F_ExplainPrintJIT_16)
														...
														if v220 != 0 {
															...
															v221 = int32(_a_F_ExplainPrintJIT_13)
															...
															if v225 != 0 {
																...
																F_ExplainPropertyFloat(m, int32(_a_F_ExplainPrintJIT_12), int32(_a_F_ExplainPrintJIT_17), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v228), float64(1e+09)), float64(1000)), int32(3), l0)
																mBase = m.M
																v236 = m.ExcPending
																if v236 != 0 {
																	return
																	...
																	F_ExplainPropertyFloat(m, int32(_a_F_ExplainPrintJIT_10), int32(_a_F_ExplainPrintJIT_17), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v239), float64(1e+09)), float64(1000)), int32(3), l0)
																	mBase = m.M
																	v247 = m.ExcPending
																	if v247 != 0 {
																		return
																		...
																		if v251 != 0 {
																			...
																			F_ExplainPropertyFloat(m, int32(_a_F_ExplainPrintJIT_8), int32(_a_F_ExplainPrintJIT_17), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v254), float64(1e+09)), float64(1000)), int32(3), l0)
																			mBase = m.M
																			v262 = m.ExcPending
																			if v262 != 0 {
																				return
																				...
																				F_ExplainPropertyFloat(m, int32(_a_F_ExplainPrintJIT_7), int32(_a_F_ExplainPrintJIT_17), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v265), float64(1e+09)), float64(1000)), int32(3), l0)
																				mBase = m.M
																				v273 = m.ExcPending
																				if v273 != 0 {
																					return
																					...
																					F_ExplainPropertyFloat(m, int32(_a_F_ExplainPrintJIT_11), int32(_a_F_ExplainPrintJIT_17), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v276), float64(1e+09)), float64(1000)), int32(3), l0)
																					mBase = m.M
																					v284 = m.ExcPending
																					if v284 != 0 {
																						return
																					} else {
																						F_ExplainPropertyFloat(m, int32(_a_F_ExplainPrintJIT_10), int32(_a_F_ExplainPrintJIT_17), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v32), float64(1e+09)), float64(1000)), int32(3), l0)
																						mBase = m.M
																						v294 = m.ExcPending
																						if v294 != 0 {
																							return
...
L6:
	...
	v27 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ExplainResultDesc[0])))
...
L19:
	;
	v54 = int32(_a_F_ExplainResultDesc_1)
	v57 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ExplainResultDesc[1])))
...
L30:
	;
	v85 = int32(_a_F_ExplainResultDesc_2)
	v88 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ExplainResultDesc[2])))
...
L43:
	;
	F_TupleDescInitEntry(m, v123, int32(1), int32(_a_F_ExplainResultDesc_3), v119, int32(-1), int32(0))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L18
...
func F_explain_ExecutorStart(m *base.Module, l0 int32, l1 int32) {
	...
	var v141 int32
	_ = v141
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[0]))
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[1]))
	if v11 != 0 {
		v59 = v8
	} else {
		if v8 < int32(0) {
			v57 = int32(0)
			*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[2])) = uint8(v57)
			v59 = v8
		} else {
			v15 = *(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[3]))
			if int32(0) <= v15 {
				v57 = int32(0)
				*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[2])) = uint8(v57)
				v59 = v8
			} else {
				v21 = int32(_a_F_explain_ExecutorStart_0)
				v24 = *(*int64)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[4]))
				v25 = *(*int64)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[5]))
				v26 = v24 ^ v25
				*(*int64)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[5])) = base.I64_rotl(v26, int64(37))
				*(*int64)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[4])) = v26<<(uint(int64(16))%64) ^ base.I64_rotl(v24, int64(24)) ^ v26
				v47 = F_ldexp(m, base.F64_convert_i64_u(int64(base.Ui64(base.I64_rotl(v24*int64(5), int64(7))*int64(9))>>(uint(int64(12))%64))), int32(-52))
				mBase = m.M
				v50 = *(*float64)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[6]))
				v51 = base.F64_lt(v47, v50)
				*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[2])) = uint8(v51)
				v55 = *(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[0]))
				v59 = v55
			}
		}
	}
	if v59 < int32(0) {
		...
		v64 = *(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[1]))
		if v64 != 0 {
			v66 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[7])))
			if v66 != int32(1) {
			} else {
				v70 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[2])))
				if v70 != int32(1) {
				} else {
					if l1&int32(1) != 0 {
					} else {
						...
						if v78&int32(1) == int32(0) {
							...
							v89 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[9])))
							if v89 != 0 {
								v90 = int32(1)
							} else {
								v90 = int32(4)
							...
							v91 = v83 | v90
							*(*int32)(unsafe.Add(mBase, uint32(l0)+32)) = v91
							v95 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[10])))
							if v95 == int32(1) {
								v99 = v91 | int32(2)
							...
							v103 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[11])))
							if v103 != int32(1) {
							} else {
								*(*int32)(unsafe.Add(mBase, uint32(l0)+32)) = v101 | int32(8)
							}
						}
					}
				}
	...
	v112 = *(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[12]))
	if v112 != 0 {
		m.T0[v112].(func(*base.Module, int32, int32))(m, l0, l1)
		mBase = m.M
		v114 = m.ExcPending
		if v114 != 0 {
			return
		} else {
			v118 = *(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[0]))
			if v118 < int32(0) {
				return
			} else {
				v122 = *(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[1]))
				if v122 != 0 {
					v124 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[7])))
					if v124 != int32(1) {
						return
					} else {
						v128 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[2])))
						if v128 != int32(1) {
							return
						} else {
							...
							if v131 != 0 {
								...
								v135 = *(*int32)(unsafe.Add(mBase, uint32(v134)+100))
								*(*int32)(unsafe.Add(mBase, _c_F_explain_ExecutorStart[13])) = v135
								v140 = F_InstrAlloc(m, int32(1), int32(2147483647), int32(0))
								mBase = m.M
								v141 = m.ExcPending
								if v141 != 0 {
									return
