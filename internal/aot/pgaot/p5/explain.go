			...
			if v29 != 0 {
				...
				if v33 == int32(0) {
					...
					if v37 != 0 {
						...
						F_appendStringInfoString(m, v38, int32(754531))
						mBase = m.M
						v41 = m.ExcPending
						if v41 != 0 {
							return
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+24)) = v42 + int32(1)
							...
							if v50 != 0 {
								...
								if v52 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v14)+120)) = int32(335555)
									if l1&int32(8) != 0 {
										v66 = int32(344594)
									} else {
										v66 = int32(361610)
									...
									*(*int32)(unsafe.Add(mBase, uint32(v14)+104)) = int32(258878)
									if l1&int32(4) != 0 {
										v82 = int32(344594)
									} else {
										v82 = int32(361610)
									...
									*(*int32)(unsafe.Add(mBase, uint32(v14)+96)) = int32(335331)
									F_appendStringInfo(m, v53, int32(748220), v14+int32(96))
									mBase = m.M
									v90 = m.ExcPending
									if v90 != 0 {
										return
										...
										if v91 != int32(1) {
											...
											*(*int32)(unsafe.Add(mBase, uint32(l0)+24)) = v164 - int32(1)
											F_ExplainCloseGroup(m, int32(521235), int32(1), l0)
											mBase = m.M
											v309 = m.ExcPending
											if v309 != 0 {
												return
											...
											if v94 != int32(1) {
												...
												*(*int32)(unsafe.Add(mBase, uint32(l0)+24)) = v164 - int32(1)
												...
												if v98 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = int32(310320)
													*(*int32)(unsafe.Add(mBase, uint32(v14-int32(-64)))) = int32(268337)
													*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = int32(258878)
													*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(335331)
													*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(288205)
													v118 = float64(1e+09)
													v120 = float64(1000)
					...
					if v172 != 0 {
						...
						if v177 != 0 {
							...
							F_ExplainPropertyBool(m, int32(335331), int32(base.Ui32(l1&int32(4))>>(uint(int32(2))%32)), l0)
							mBase = m.M
							v184 = m.ExcPending
							if v184 != 0 {
								return
							} else {
								F_ExplainPropertyBool(m, int32(258878), int32(base.Ui32(l1&int32(2))>>(uint(int32(1))%32)), l0)
								mBase = m.M
								v191 = m.ExcPending
								if v191 != 0 {
									return
									...
									if v198 != 0 {
										...
										F_ExplainPropertyBool(m, int32(335555), int32(base.Ui32(l1&int32(16))>>(uint(int32(4))%32)), l0)
										mBase = m.M
										v205 = m.ExcPending
										if v205 != 0 {
											return
													...
													if v213 != int32(1) {
														...
														if v220 != 0 {
															...
															if v225 != 0 {
																...
																F_ExplainPropertyFloat(m, int32(288205), int32(151766), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v228), float64(1e+09)), float64(1000)), int32(3), l0)
																mBase = m.M
																v236 = m.ExcPending
																if v236 != 0 {
																	return
																	...
																	F_ExplainPropertyFloat(m, int32(310320), int32(151766), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v239), float64(1e+09)), float64(1000)), int32(3), l0)
																	mBase = m.M
																	v247 = m.ExcPending
																	if v247 != 0 {
																		return
																	} else {
																		F_ExplainCloseGroup(m, int32(261349), int32(1), l0)
																		mBase = m.M
																		v251 = m.ExcPending
																		if v251 != 0 {
																			return
																			...
																			F_ExplainPropertyFloat(m, int32(335331), int32(151766), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v254), float64(1e+09)), float64(1000)), int32(3), l0)
																			mBase = m.M
																			v262 = m.ExcPending
																			if v262 != 0 {
																				return
																				...
																				F_ExplainPropertyFloat(m, int32(258878), int32(151766), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v265), float64(1e+09)), float64(1000)), int32(3), l0)
																				mBase = m.M
																				v273 = m.ExcPending
																				if v273 != 0 {
																					return
																					...
																					F_ExplainPropertyFloat(m, int32(268337), int32(151766), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v276), float64(1e+09)), float64(1000)), int32(3), l0)
																					mBase = m.M
																					v284 = m.ExcPending
																					if v284 != 0 {
																						return
																					} else {
																						F_ExplainPropertyFloat(m, int32(310320), int32(151766), base.F64_mul(base.F64_div(base.F64_convert_i64_s(v32), float64(1e+09)), float64(1000)), int32(3), l0)
																						mBase = m.M
																						v294 = m.ExcPending
																						if v294 != 0 {
																							return
																						} else {
																							F_ExplainCloseGroup(m, int32(335625), int32(1), l0)
																							mBase = m.M
																							v298 = m.ExcPending
																							if v298 != 0 {
																								return
...
L43:
	;
	F_TupleDescInitEntry(m, v123, int32(1), int32(531168), v119, int32(-1), int32(0))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L18
