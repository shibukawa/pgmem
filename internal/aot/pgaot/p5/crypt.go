			...
			if l0 != 0 {
				if l0&int32(-16777215) != int32(1) {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(l3))) = uint8(v20)
					v26 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v19)>>(uint(int32(18))%32)))+uint32(_consts[1453]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+4)) = uint8(v26)
					v28 = int32(63)
					v31 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v19&v28)+uint32(_consts[1453]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+1)) = uint8(v31)
					v33 = int32(12)
					v38 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v19)>>(uint(v33)%32))&v28)+uint32(_consts[1453]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+3)) = uint8(v38)
					v40 = int32(6)
					v45 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v19)>>(uint(v40)%32))&v28)+uint32(_consts[1453]))))
					...
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+9)) = uint8(v50)
					v55 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v49)>>(uint(int32(2))%32)))+uint32(_consts[1453]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+8)) = uint8(v55)
					v60 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v48&v28)+uint32(_consts[1453]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+5)) = uint8(v60)
					v65 = v47 << (uint(int32(8)) % 32)
					v72 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v49<<(uint(int32(16))%32)|v65)>>(uint(v33)%32))&v28)+uint32(_consts[1453]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+7)) = uint8(v72)
					v80 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v48|v65)>>(uint(v40)%32))&v28)+uint32(_consts[1453]))))
