...
L6:
	;
	v11 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[496]))))
	v12 = int32(1)
...
L10:
	;
	v51 = int32(1)
	v55 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(v51)%32))+uint32(_consts[498]))))
	v63 = v55 & v51
	goto L7
L11:
	;
	...
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v33)+uint32(_consts[499])))
...
L16:
	;
	v42 = *(*int32)(unsafe.Add(mBase, uint32(v33)+uint32(_consts[500])))
...
L22:
	;
	v78 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(8))%32)))+uint32(_consts[504]))))
	v84 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(3))%32))&int32(31)|v78<<(uint(int32(5))%32))+uint32(_consts[504]))))
...
func F_pg_wc_isgraph(m *base.Module, l0 int32) int32 {
	...
	var v137 int32
	_ = v137
	v3 = *(*int32)(unsafe.Add(mBase, _consts[493]))
	switch v3 - int32(1) {
	case 0:
		goto L3
	case 1:
...
L9:
	;
	v61 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[501]))))
	v64 = v61
	goto L8
L10:
	;
...
L12:
	...
	v44 = int32(1)
	v47 = l0 << (uint(v44) % 32)
	v50 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[497]))))
...
L13:
	...
	v27 = v25 * int32(12)
	v30 = *(*int32)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[502])))
...
L18:
	;
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[503])))
	if base.Ui32(v36) <= base.Ui32(l0) {
		goto L9
	} else {
		goto L19
...
L21:
	;
	v56 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[498]))))
...
L24:
	...
	v83 = *(*int32)(unsafe.Add(mBase, uint32(v80)+uint32(_consts[505])))
...
L29:
	;
	v89 = *(*int32)(unsafe.Add(mBase, uint32(v80)+uint32(_consts[506])))
...
L2:
	;
	v6 = int32(0)
	v8 = *(*int32)(unsafe.Add(mBase, _consts[493]))
	switch v8 - int32(1) {
	case 0:
		goto L5
	case 1:
...
L5:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[495]))
...
L7:
	;
	v15 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[496]))))
...
L11:
	;
	v116 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_consts[497]))))
	v123 = v116
	goto L10
L12:
	;
...
L15:
	;
	v92 = int32(1)
	v97 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(v92)%32))+uint32(_consts[498]))))
	if v97&v92 != 0 {
		v134 = v92
		goto L9
	} else {
...
L16:
	...
	v48 = *(*int32)(unsafe.Add(mBase, uint32(v45)+uint32(_consts[499])))
...
L21:
	;
	v54 = *(*int32)(unsafe.Add(mBase, uint32(v45)+uint32(_consts[500])))
...
L27:
	;
	v91 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v74)+uint32(_consts[501]))))
	v123 = v91
	goto L10
L28:
	;
	...
	v74 = v72 * int32(12)
	v77 = *(*int32)(unsafe.Add(mBase, uint32(v74)+uint32(_consts[502])))
...
L33:
	;
	v83 = *(*int32)(unsafe.Add(mBase, uint32(v74)+uint32(_consts[503])))
	if base.Ui32(v83) <= base.Ui32(l0) {
		goto L27
	} else {
		goto L34
...
func F_pg_wc_tolower(m *base.Module, l0 int32) int32 {
	...
	case 0:
		if base.Ui32(l0) <= base.Ui32(int32(127)) {
			v124 = l0<<(uint(int32(2))%32) + int32(1903428)
		} else {
			v25 = int32(0)
			if base.Ui32(l0) < base.Ui32(int32(1416)) {
				v112 = l0
				v117 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v112<<(uint(int32(1))%32))+uint32(_consts[494]))))
				v119 = v117
			} else {
			...
			v124 = v119<<(uint(int32(2))%32) + int32(1903424)
		}
		...
		return v126
	case 1:
		v129 = *(*int32)(unsafe.Add(mBase, _consts[495]))
		if base.Ui32(int32(127)) < base.Ui32(l0) {
	...
	case 2:
		v152 = *(*int32)(unsafe.Add(mBase, _consts[495]))
		if base.Ui32(int32(127)) < base.Ui32(l0) {
			if base.Ui32(int32(255)) < base.Ui32(l0) {
				v180 = l0
			} else {
