...
L20:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _consts[1035]))
	if int32(0) < v35 {
		goto L23
	} else {
		goto L24
...
L22:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _consts[1036]))
	if int32(0) < v63 {
		goto L31
	} else {
		goto L32
...
L25:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[1037]))
	if v58 <= int32(0) {
		v128 = v29
		goto L17
	} else {
...
L26:
	...
	v47 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1038])))
	if v7 == v47 {
		v119 = v44 + int32(4543216)
		goto L18
	} else {
		goto L28
	}
...
L33:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _consts[1039]))
	if v86 <= int32(0) {
		v128 = v29
		goto L17
	} else {
...
L34:
	...
	v75 = *(*int32)(unsafe.Add(mBase, uint32(v72)+uint32(_consts[1040])))
	if v7 == v75 {
		v119 = v72 + int32(4542168)
		goto L18
	} else {
		goto L36
	}
...
L39:
	...
	v99 = *(*int32)(unsafe.Add(mBase, uint32(v96)+uint32(_consts[1041])))
	if v7 == v99 {
		v119 = v96 + int32(4542692)
		goto L18
	} else {
		goto L41
	}
...
L43:
	...
	v113 = *(*int32)(unsafe.Add(mBase, uint32(v110)+uint32(_consts[1042])))
	if v7 == v113 {
		v119 = v110 + int32(4543740)
		goto L18
	} else {
		goto L45
	}
