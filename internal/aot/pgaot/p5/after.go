...
L79:
	;
	F_errfinish(m, int32(472628), int32(6194), int32(86906))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L18
...
L40:
	...
	v180 = F_MakeSingleTupleTableSlot(m, v178, int32(1576060))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L4
...
L41:
	...
	v184 = F_MakeSingleTupleTableSlot(m, v182, int32(1576060))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L4
...
L85:
	...
	v394 = m.T0[v393].(func(*base.Module, int32, int32, int32, int32) int32)(m, v214, v115+int32(4), int32(4114688), v379)
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L4
...
L106:
	...
	v455 = m.T0[v454].(func(*base.Module, int32, int32, int32, int32) int32)(m, v213, v115+int32(10), int32(4114688), v440)
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L4
...
L187:
	;
	F_errmsg_internal(m, int32(213449), int32(0))
	mBase = m.M
	v802 = m.ExcPending
	if v802 != 0 {
		goto L4
...
L188:
	;
	F_errfinish(m, int32(472628), int32(4388), int32(331886))
	mBase = m.M
	v807 = m.ExcPending
	if v807 != 0 {
		goto L4
...
L190:
	;
	F_errmsg_internal(m, int32(213408), int32(0))
	mBase = m.M
	v815 = m.ExcPending
	if v815 != 0 {
		goto L4
...
L191:
	;
	F_errfinish(m, int32(472628), int32(4394), int32(331886))
	mBase = m.M
	v820 = m.ExcPending
	if v820 != 0 {
		goto L4
...
L197:
	;
	F_errfinish(m, int32(472628), int32(4435), int32(331886))
	mBase = m.M
	v846 = m.ExcPending
	if v846 != 0 {
		goto L4
...
L203:
	;
	F_errfinish(m, int32(472628), int32(4477), int32(331886))
	mBase = m.M
	v872 = m.ExcPending
	if v872 != 0 {
		goto L4
