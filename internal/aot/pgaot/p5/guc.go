...
L15:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v13))) = v124
	v131 = F_pg_snprintf(m, v13-int32(-64), int32(256), int32(186516), v13)
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L9
...
L48:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v13)+16)) = v225
	v236 = F_pg_snprintf(m, v13-int32(-64), int32(256), int32(186511), v13+int32(16))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L9
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v251
	F_errmsg_internal(m, int32(192359), v13+int32(32))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L9
