			...
			if base.Ui32(int32(8145)) <= base.Ui32(v92) {
				...
				if v396 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v21))) = v92
					F_errmsg_internal(m, int32(673120), v21)
					mBase = m.M
					v402 = m.ExcPending
					if v402 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(498595), int32(344), int32(100493))
						mBase = m.M
						v407 = m.ExcPending
						if v407 != 0 {
							return int32(0)
		...
		default:
			...
			if v137 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14))) = v138
				F_errmsg_internal(m, int32(472756), v14)
				mBase = m.M
				v142 = m.ExcPending
				if v142 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(497859), int32(462), int32(92576))
					mBase = m.M
					v147 = m.ExcPending
					if v147 != 0 {
						return int32(0)
