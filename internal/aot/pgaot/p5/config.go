...
L49:
	;
	F_errfinish(m, int32(299015), int32(194), int32(370927))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L43
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = l0
	F_errmsg(m, int32(440761), v14+int32(16))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L43
...
L69:
	;
	F_errfinish(m, int32(299015), int32(211), int32(370927))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L43
...
L82:
	;
	v322 = F_AllocateFile(m, v248, int32(219329))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L43
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = l2
	F_errmsg(m, int32(670110), v14+int32(80))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L43
...
L98:
	;
	F_errfinish(m, int32(299015), int32(231), int32(370927))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L43
...
L119:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v248
	v347 = F_psprintf(m, int32(674735), v14+int32(32))
	mBase = m.M
	v348 = m.ExcPending
	if v348 != 0 {
		goto L43
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = v248
	F_errmsg(m, int32(283639), v14+int32(48))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L43
...
L121:
	;
	F_errfinish(m, int32(299015), int32(247), int32(370927))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L43
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+64)) = v248
	F_errmsg(m, int32(674143), v14-int32(-64))
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L43
...
L136:
	;
	F_errfinish(m, int32(299015), int32(258), int32(370927))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L43
	...
	if v5 != int32(1) {
		...
		if v46 != 0 {
			...
			if v49 != 0 {
				...
				F_errmsg(m, int32(362480), int32(0))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(471822), int32(342), int32(359555))
					mBase = m.M
					v58 = m.ExcPending
					if v58 != 0 {
						return int32(0)
...
L30:
	;
	F_errfinish(m, int32(476372), int32(3465), int32(371157))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L15
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+176)) = v99
	F_errmsg(m, int32(438364), v20+int32(176))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L15
...
L46:
	;
	F_errfinish(m, int32(476372), int32(3481), int32(371157))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L15
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+192)) = v123
	F_errmsg(m, int32(204171), v20+int32(192))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L15
...
L52:
	;
	F_errfinish(m, int32(476372), int32(3504), int32(371157))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L15
...
L58:
	;
	F_errfinish(m, int32(476372), int32(3514), int32(371157))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L15
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+240)) = v177
	F_errmsg(m, int32(658841), v20+int32(240))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L15
...
L66:
	;
	F_errfinish(m, int32(476372), int32(3541), int32(371157))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L15
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+224)) = v219
	F_errmsg(m, int32(78426), v20+int32(224))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L15
...
L80:
	;
	F_errfinish(m, int32(476372), int32(3583), int32(371157))
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L15
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+256)) = v250
	F_errmsg(m, int32(658841), v20+int32(256))
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L15
...
L88:
	;
	F_errfinish(m, int32(476372), int32(3603), int32(371157))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L15
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+144)) = v281
	F_errmsg(m, int32(239652), v20+int32(144))
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L15
...
L102:
	;
	F_errfinish(m, int32(476372), int32(3642), int32(371157))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		goto L15
...
L109:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+160)) = v312
	F_errmsg(m, int32(248376), v20+int32(160))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L15
...
L110:
	;
	F_errfinish(m, int32(476372), int32(3650), int32(371157))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L15
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+112)) = v335
	F_errmsg(m, int32(98448), v20+int32(112))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L15
...
L118:
	;
	F_errfinish(m, int32(476372), int32(3662), int32(371157))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L15
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+128)) = v358
	F_errmsg(m, int32(131475), v20+int32(128))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L15
...
L124:
	;
	F_errfinish(m, int32(476372), int32(3670), int32(371157))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L15
...
L134:
	;
	F_errfinish(m, int32(476372), int32(3696), int32(371157))
	mBase = m.M
	v404 = m.ExcPending
	if v404 != 0 {
		goto L15
...
L185:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v493
	F_errmsg(m, int32(204171), v20+int32(16))
	mBase = m.M
	v499 = m.ExcPending
	if v499 != 0 {
		goto L15
...
L186:
	;
	F_errfinish(m, int32(476372), int32(3748), int32(371157))
	mBase = m.M
	v504 = m.ExcPending
	if v504 != 0 {
		goto L15
...
L312:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v827
	F_errmsg(m, int32(204171), v20+int32(32))
	mBase = m.M
	v833 = m.ExcPending
	if v833 != 0 {
		goto L15
...
L313:
	;
	F_errfinish(m, int32(476372), int32(3846), int32(371157))
	mBase = m.M
	v838 = m.ExcPending
	if v838 != 0 {
		goto L15
...
L439:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+48)) = v1159
	F_errmsg(m, int32(204171), v20+int32(48))
	mBase = m.M
	v1165 = m.ExcPending
	if v1165 != 0 {
		goto L15
...
L440:
	;
	F_errfinish(m, int32(476372), int32(3944), int32(371157))
	mBase = m.M
	v1170 = m.ExcPending
	if v1170 != 0 {
		goto L15
...
L600:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+64)) = v1566
	F_errmsg(m, int32(204171), v20-int32(-64))
	mBase = m.M
	v1572 = m.ExcPending
	if v1572 != 0 {
		goto L15
...
L601:
	;
	F_errfinish(m, int32(476372), int32(4071), int32(371157))
	mBase = m.M
	v1577 = m.ExcPending
	if v1577 != 0 {
		goto L15
...
L641:
	;
	v1677 = F_set_config_with_handle(m, int32(366619), v1667, v1670, l3, v1674, l5, l6, int32(1), v36, int32(0))
	mBase = m.M
	v1678 = m.ExcPending
	if v1678 != 0 {
		goto L15
...
L772:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+80)) = v2026
	F_errmsg(m, int32(204171), v20+int32(80))
	mBase = m.M
	v2032 = m.ExcPending
	if v2032 != 0 {
		goto L15
...
L773:
	;
	F_errfinish(m, int32(476372), int32(4212), int32(371157))
	mBase = m.M
	v2037 = m.ExcPending
	if v2037 != 0 {
		goto L15
