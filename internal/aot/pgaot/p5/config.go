...
L32:
	;
	F_errfinish(m, int32(315561), int32(194), int32(391182))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L26
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = l0
	F_errmsg(m, int32(463637), v14+int32(16))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L26
...
L52:
	;
	F_errfinish(m, int32(315561), int32(211), int32(391182))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L26
...
L65:
	;
	v266 = F_AllocateFile(m, v192, int32(231443))
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L26
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = l2
	F_errmsg(m, int32(714035), v14+int32(80))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L26
...
L81:
	;
	F_errfinish(m, int32(315561), int32(231), int32(391182))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L26
...
L102:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v192
	v291 = F_psprintf(m, int32(718660), v14+int32(32))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		goto L26
...
L103:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = v192
	F_errmsg(m, int32(299261), v14+int32(48))
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L26
...
L104:
	;
	F_errfinish(m, int32(315561), int32(247), int32(391182))
	mBase = m.M
	v286 = m.ExcPending
	if v286 != 0 {
		goto L26
...
L118:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+64)) = v192
	F_errmsg(m, int32(718068), v14-int32(-64))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L26
...
L119:
	;
	F_errfinish(m, int32(315561), int32(258), int32(391182))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L26
	...
	if v5 != int32(1) {
		...
		if v46 != 0 {
			...
			if v49 != 0 {
				...
				F_errmsg(m, int32(382549), int32(0))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496396), int32(342), int32(379535))
					mBase = m.M
					v58 = m.ExcPending
					if v58 != 0 {
						return int32(0)
...
L30:
	;
	F_errfinish(m, int32(501271), int32(3465), int32(391412))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L15
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+176)) = v99
	F_errmsg(m, int32(461044), v20+int32(176))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L15
...
L46:
	;
	F_errfinish(m, int32(501271), int32(3481), int32(391412))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L15
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+192)) = v123
	F_errmsg(m, int32(215236), v20+int32(192))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L15
...
L52:
	;
	F_errfinish(m, int32(501271), int32(3504), int32(391412))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L15
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+208)) = v148
	F_errmsg(m, int32(31436), v20+int32(208))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L15
...
L58:
	;
	F_errfinish(m, int32(501271), int32(3514), int32(391412))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L15
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+240)) = v177
	F_errmsg(m, int32(702675), v20+int32(240))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L15
...
L66:
	;
	F_errfinish(m, int32(501271), int32(3541), int32(391412))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L15
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+224)) = v219
	F_errmsg(m, int32(83169), v20+int32(224))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L15
...
L80:
	;
	F_errfinish(m, int32(501271), int32(3583), int32(391412))
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L15
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+256)) = v250
	F_errmsg(m, int32(702675), v20+int32(256))
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L15
...
L88:
	;
	F_errfinish(m, int32(501271), int32(3603), int32(391412))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L15
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+144)) = v281
	F_errmsg(m, int32(252932), v20+int32(144))
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L15
...
L102:
	;
	F_errfinish(m, int32(501271), int32(3642), int32(391412))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		goto L15
...
L109:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+160)) = v312
	F_errmsg(m, int32(261756), v20+int32(160))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L15
...
L110:
	;
	F_errfinish(m, int32(501271), int32(3650), int32(391412))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L15
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+112)) = v335
	F_errmsg(m, int32(106354), v20+int32(112))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L15
...
L118:
	;
	F_errfinish(m, int32(501271), int32(3662), int32(391412))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L15
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+128)) = v358
	F_errmsg(m, int32(141417), v20+int32(128))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L15
...
L124:
	;
	F_errfinish(m, int32(501271), int32(3670), int32(391412))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L15
...
L134:
	;
	F_errfinish(m, int32(501271), int32(3696), int32(391412))
	mBase = m.M
	v404 = m.ExcPending
	if v404 != 0 {
		goto L15
...
L185:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v493
	F_errmsg(m, int32(215236), v20+int32(16))
	mBase = m.M
	v499 = m.ExcPending
	if v499 != 0 {
		goto L15
...
L186:
	;
	F_errfinish(m, int32(501271), int32(3748), int32(391412))
	mBase = m.M
	v504 = m.ExcPending
	if v504 != 0 {
		goto L15
...
L312:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v827
	F_errmsg(m, int32(215236), v20+int32(32))
	mBase = m.M
	v833 = m.ExcPending
	if v833 != 0 {
		goto L15
...
L313:
	;
	F_errfinish(m, int32(501271), int32(3846), int32(391412))
	mBase = m.M
	v838 = m.ExcPending
	if v838 != 0 {
		goto L15
...
L439:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+48)) = v1159
	F_errmsg(m, int32(215236), v20+int32(48))
	mBase = m.M
	v1165 = m.ExcPending
	if v1165 != 0 {
		goto L15
...
L440:
	;
	F_errfinish(m, int32(501271), int32(3944), int32(391412))
	mBase = m.M
	v1170 = m.ExcPending
	if v1170 != 0 {
		goto L15
...
L600:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+64)) = v1566
	F_errmsg(m, int32(215236), v20-int32(-64))
	mBase = m.M
	v1572 = m.ExcPending
	if v1572 != 0 {
		goto L15
...
L601:
	;
	F_errfinish(m, int32(501271), int32(4071), int32(391412))
	mBase = m.M
	v1577 = m.ExcPending
	if v1577 != 0 {
		goto L15
...
L641:
	;
	v1677 = F_set_config_with_handle(m, int32(386863), v1667, v1670, l3, v1674, l5, l6, int32(1), v36, int32(0))
	mBase = m.M
	v1678 = m.ExcPending
	if v1678 != 0 {
		goto L15
...
L772:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+80)) = v2026
	F_errmsg(m, int32(215236), v20+int32(80))
	mBase = m.M
	v2032 = m.ExcPending
	if v2032 != 0 {
		goto L15
...
L773:
	;
	F_errfinish(m, int32(501271), int32(4212), int32(391412))
	mBase = m.M
	v2037 = m.ExcPending
	if v2037 != 0 {
		goto L15
