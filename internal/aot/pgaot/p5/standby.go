...
L3:
	;
	F_errmsg_internal(m, int32(164067), int32(0))
	mBase = m.M
	v14 = m.ExcPending
	if v14 != 0 {
		goto L1
...
L5:
	;
	v23 = *(*int32)(unsafe.Add(mBase, _consts[695]))
...
L6:
	;
	F_errfinish(m, int32(515956), int32(1111), int32(164284))
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		goto L1
...
L15:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _consts[695]))
...
func F_StandbyTransactionIdIsPrepared(m *base.Module, l0 int32) int32 {
	...
	_ = v19
	v2 = int32(0)
	v5 = *(*int32)(unsafe.Add(mBase, _consts[101]))
	if v5 <= v2 {
		v19 = v2
		return v19
	} else {
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+112)) = l3
	F_appendStringInfo(m, l0, int32(58946), v10+int32(112))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L7
...
L6:
	;
	F_appendStringInfoString(m, l0, int32(573986))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L7
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v35
	F_appendStringInfo(m, l0, int32(500085), v10)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L7
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v35
	F_appendStringInfo(m, l0, int32(501620), v10+int32(16))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L7
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = v77
	F_appendStringInfo(m, l0, int32(60561), v10+int32(96))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L7
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+80)) = v70
	F_appendStringInfo(m, l0, int32(43271), v10+int32(80))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L7
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = v63
	F_appendStringInfo(m, l0, int32(60680), v10-int32(-64))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L7
...
L21:
	;
	F_appendStringInfoString(m, l0, int32(224864))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L7
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = v53
	F_appendStringInfo(m, l0, int32(56860), v10+int32(48))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L7
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v46
	F_appendStringInfo(m, l0, int32(52897), v10+int32(32))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L7
