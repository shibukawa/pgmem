...
L3:
	;
	F_errmsg_internal(m, int32(_a_F_StandbyReleaseAllLocks_0), int32(0))
	mBase = m.M
	v14 = m.ExcPending
	if v14 != 0 {
		goto L1
...
L5:
	;
	v21 = v5 + int32(12)
	v23 = *(*int32)(unsafe.Add(mBase, _c_F_StandbyReleaseAllLocks[0]))
	F_hash_seq_init(m, v21, v23)
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L13:
	;
	F_StandbyReleaseXidEntryLocks(m, v28)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
...
L15:
	;
	v33 = *(*int32)(unsafe.Add(mBase, _c_F_StandbyReleaseAllLocks[0]))
	v36 = F_hash_search(m, v33, v28, int32(2), int32(0))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L1
...
L16:
	;
	v40 = F_hash_seq_search(m, v5+int32(12))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+112)) = l3
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_invalidations_0), v10+int32(112))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L7
...
L6:
	;
	F_appendStringInfoString(m, l0, int32(_a_F_standby_desc_invalidations_1))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L7
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v35
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_invalidations_2), v10)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L7
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v35
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_invalidations_3), v10+int32(16))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L7
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = v77
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_invalidations_4), v10+int32(96))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L7
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+80)) = v70
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_invalidations_5), v10+int32(80))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L7
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = v63
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_invalidations_6), v10-int32(-64))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L7
...
L21:
	;
	F_appendStringInfoString(m, l0, int32(_a_F_standby_desc_invalidations_7))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L7
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = v53
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_invalidations_8), v10+int32(48))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L7
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v46
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_invalidations_9), v10+int32(32))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L7
