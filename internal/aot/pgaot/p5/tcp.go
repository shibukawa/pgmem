...
func F_show_tcp_keepalives_interval(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v28
	v36 = F_pg_snprintf(m, int32(4377904), int32(16), int32(480823), v4)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		return int32(0)
...
func F_show_tcp_user_timeout(m *base.Module) int32 {
	...
	m.G0 = v12 + int32(16)
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v28
	v36 = F_pg_snprintf(m, int32(4377936), int32(16), int32(480823), v4)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		return int32(0)
