...
func F_show_tcp_keepalives_interval(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v27
	v35 = F_pg_snprintf(m, int32(_a_F_show_tcp_keepalives_interval_0), int32(16), int32(_a_F_show_tcp_keepalives_interval_1), v4)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		return int32(0)
...
func F_show_tcp_user_timeout(m *base.Module) int32 {
	...
	m.G0 = v12 + int32(16)
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v27
	v35 = F_pg_snprintf(m, int32(_a_F_show_tcp_user_timeout_0), int32(16), int32(_a_F_show_tcp_user_timeout_1), v4)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		return int32(0)
