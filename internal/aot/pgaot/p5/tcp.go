...
func F_assign_tcp_keepalives_interval(m *base.Module, l0 int32, l1 int32) {
	...
	var v29 int32
	_ = v29
	v4 = *(*int32)(unsafe.Add(mBase, _consts[379]))
	v6 = m.G0
	v8 = v6 - int32(16)
	m.G0 = v8
...
func F_show_tcp_keepalives_interval(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v28
	v36 = F_pg_snprintf(m, int32(4461040), int32(16), int32(509205), v4)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		return int32(0)
...
func F_show_tcp_user_timeout(m *base.Module) int32 {
	...
	m.G0 = v12 + int32(16)
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v28
	v36 = F_pg_snprintf(m, int32(4461072), int32(16), int32(509205), v4)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		return int32(0)
