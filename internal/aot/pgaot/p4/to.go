...
L1:
	...
	v20 = int32(1)
	v21 = v14 - v20
	v27 = int32(*(*uint8)(unsafe.Add(mBase, uint32(base.I32_wrap_i64(v15)&v20)+uint32(_consts[1344]))))
							...
							if v111 != 0 {
								...
								if v113 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v112
									F_errmsg(m, int32(706607), v7+int32(16))
									mBase = m.M
									v119 = m.ExcPending
									if v119 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(493173), int32(4173), int32(353478))
										mBase = m.M
										v124 = m.ExcPending
										if v124 != 0 {
											return int32(0)
									...
									if v92 != 0 {
										...
										if v94 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v7))) = v93
											F_errmsg(m, int32(706607), v7)
											mBase = m.M
											v98 = m.ExcPending
											if v98 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(493173), int32(4182), int32(353478))
												mBase = m.M
												v103 = m.ExcPending
												if v103 != 0 {
													return int32(0)
...
func F_to_regoper(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		if v15 != 0 {
			...
			v17 = *(*int32)(unsafe.Add(mBase, _consts[1323]))
			*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = v17
			v20 = *(*int64)(unsafe.Add(mBase, _consts[1324]))
