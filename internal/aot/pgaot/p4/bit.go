	...
	if v95 == int32(0) {
		...
		if v95 == v106 {
			...
			for {
				...
				v133 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v127^v129)+uint32(_consts[811]))))
				v135 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v115+v97))))
				v137 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v115+v96))))
				v141 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v135^v137)+uint32(_consts[811]))))
				v143 = v133 + (v118 + v141)
				v144 = int32(2)
				v145 = v115 + v144
				v147 = v119 + v144
		...
		if v95&v106 == int32(0) {
			...
			v167 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v161^v163)+uint32(_consts[811]))))
			v172 = v152 + v167
		}
	}
	return v172
