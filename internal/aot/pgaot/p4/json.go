...
L111:
	;
	F_errfinish(m, int32(520780), int32(3124), int32(297892))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L30
...
func F_JsonTableFetchRow(m *base.Module, l0 int32) int32 {
	...
	var v9 int32
	_ = v9
	v3 = F_GetJsonTableExecContext(m, l0, int32(33093))
	mBase = m.M
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
...
L9:
	;
	F_appendStringInfoString(m, v10+int32(16), int32(543546))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v63
	F_errmsg_internal(m, int32(504532), v10)
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L1
...
L23:
	;
	F_errfinish(m, int32(513785), int32(11786), int32(216992))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L1
...
L16:
	;
	v60 = int32(0)
	F_appendContextKeyword(m, l2, int32(772995), v60, v60, v60)
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L6
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v73
	F_appendStringInfo(m, v70, int32(206989), v9)
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L6
...
func F_json_array_elements(m *base.Module, l0 int32) int32 {
	var v7 int32
	_ = v7
	F_elements_worker(m, l0, int32(130046), int32(0))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
func F_json_array_elements_text(m *base.Module, l0 int32) int32 {
	var v7 int32
	_ = v7
	F_elements_worker(m, l0, int32(68309), int32(1))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
func F_json_build_array_noargs(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_cstring_to_text_with_len(m, int32(528975), int32(2))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
func F_json_in(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		if v18 != 0 {
			...
			v23 = F_pg_parse_json_or_errsave(m, v7+int32(12), int32(1884160), v22)
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return int32(0)
...
func F_json_manifest_array_end(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(444238)
		m.T0[v19].(func(*base.Module, int32, int32, int32))(m, v18, int32(208394), v6)
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return int32(0)
...
func F_json_to_record(m *base.Module, l0 int32) int32 {
	...
	_ = v9
	v4 = int32(0)
	v6 = F_populate_record_worker(m, l0, int32(437312), int32(1), v4, v4)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_json_to_recordset(m *base.Module, l0 int32) int32 {
	var v8 int32
	_ = v8
	F_populate_recordset_worker(m, l0, int32(112323), int32(1), int32(0))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
						...
						if base.Ui32(int32(11)) <= base.Ui32(v28) {
							...
							if v51 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v5))) = v52
								F_errmsg_internal(m, int32(501767), v5)
								mBase = m.M
								v56 = m.ExcPending
								if v56 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(516217), int32(1909), int32(352642))
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return int32(0)
