			...
			if v47 == int32(0) {
				...
				if v88 != 0 {
					...
					if v92 != 0 {
						...
						F_errfinish(m, int32(519801), int32(576), int32(294647))
						mBase = m.M
						v97 = m.ExcPending
						if v97 != 0 {
							return int32(0)
			...
			if v72 != 0 {
				...
				if v75 != 0 {
					...
					if v79 != 0 {
						...
						F_errfinish(m, int32(519801), int32(565), int32(294647))
						mBase = m.M
						v84 = m.ExcPending
						if v84 != 0 {
							return int32(0)
...
L74:
	;
	F_errmsg(m, int32(121351), int32(0))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L8
...
L75:
	;
	F_errdetail(m, int32(646346), int32(0))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L8
...
L76:
	;
	F_errfinish(m, int32(519801), int32(478), int32(120373))
	mBase = m.M
	v255 = m.ExcPending
	if v255 != 0 {
		goto L8
...
L101:
	;
	F_errfinish(m, int32(519801), int32(506), int32(120373))
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L8
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+16)) = v348
	F_errdetail(m, int32(646486), v30+int32(16))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L8
...
L108:
	;
	F_errfinish(m, int32(519801), int32(375), int32(120373))
	mBase = m.M
	v363 = m.ExcPending
	if v363 != 0 {
		goto L8
...
L112:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30))) = v61
	F_errdetail(m, int32(646417), v30)
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L8
...
L113:
	;
	F_errfinish(m, int32(519801), int32(413), int32(120373))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L8
...
L117:
	;
	F_errdetail(m, int32(646267), int32(0))
	mBase = m.M
	v400 = m.ExcPending
	if v400 != 0 {
		goto L8
...
L118:
	;
	F_errfinish(m, int32(519801), int32(449), int32(120373))
	mBase = m.M
	v405 = m.ExcPending
	if v405 != 0 {
		goto L8
...
L133:
	;
	F_errmsg(m, int32(172707), int32(0))
	mBase = m.M
	v478 = m.ExcPending
	if v478 != 0 {
		goto L1
...
L134:
	;
	F_errfinish(m, int32(519682), int32(3846), int32(243226))
	mBase = m.M
	v483 = m.ExcPending
	if v483 != 0 {
		goto L1
...
L139:
	;
	F_errfinish(m, int32(519682), int32(3871), int32(243226))
	mBase = m.M
	v501 = m.ExcPending
	if v501 != 0 {
		goto L1
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+4)) = v604 + v602 - int32(1)
	v611 = F_pg_sprintf(m, v579, int32(534573), v23)
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L1
				...
				if v33 != 0 {
					...
					if v36 != 0 {
						...
						if v40 != 0 {
							...
							F_errfinish(m, int32(519801), int32(249), int32(448431))
							mBase = m.M
							v45 = m.ExcPending
							if v45 != 0 {
								return int32(0)
		...
		default:
			...
			if v49 != 0 {
				...
				if v52 != 0 {
					...
					F_errmsg(m, int32(26211), int32(0))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(519801), int32(259), int32(448431))
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return int32(0)
			...
			if v46 != 0 {
				...
				if v49 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v21
					F_errmsg(m, int32(502123), v9)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(519801), int32(1750), int32(404892))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return int32(0)
...
L81:
	;
	F_errmsg(m, int32(467212), int32(0))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L11
...
L82:
	;
	F_errfinish(m, int32(519682), int32(2855), int32(439485))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L11
...
L85:
	;
	F_errmsg(m, int32(179039), int32(0))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L11
...
L86:
	;
	F_errdetail(m, int32(681217), int32(0))
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L11
...
L87:
	;
	F_errfinish(m, int32(519682), int32(2888), int32(439485))
	mBase = m.M
	v371 = m.ExcPending
	if v371 != 0 {
		goto L11
...
L91:
	;
	F_errfinish(m, int32(519682), int32(2896), int32(439485))
	mBase = m.M
	v389 = m.ExcPending
	if v389 != 0 {
		goto L11
...
L94:
	;
	F_errmsg(m, int32(319750), int32(0))
	mBase = m.M
	v400 = m.ExcPending
	if v400 != 0 {
		goto L11
...
L95:
	;
	F_errfinish(m, int32(519682), int32(2905), int32(439485))
	mBase = m.M
	v405 = m.ExcPending
	if v405 != 0 {
		goto L11
...
L99:
	;
	F_errfinish(m, int32(519682), int32(2915), int32(439485))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L11
...
L103:
	;
	F_errfinish(m, int32(519682), int32(2985), int32(439485))
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L11
...
L107:
	;
	F_errfinish(m, int32(519682), int32(2990), int32(439485))
	mBase = m.M
	v453 = m.ExcPending
	if v453 != 0 {
		goto L11
...
L117:
	;
	F_errfinish(m, int32(519682), int32(3000), int32(439485))
	mBase = m.M
	v558 = m.ExcPending
	if v558 != 0 {
		goto L11
...
L173:
	;
	F_errfinish(m, int32(519682), int32(2940), int32(439485))
	mBase = m.M
	v842 = m.ExcPending
	if v842 != 0 {
		goto L11
...
L176:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v75)+16)) = int32(268435455)
	F_errmsg(m, int32(712607), v75+int32(16))
	mBase = m.M
	v858 = m.ExcPending
	if v858 != 0 {
		goto L11
...
L177:
	;
	F_errfinish(m, int32(519682), int32(2950), int32(439485))
	mBase = m.M
	v863 = m.ExcPending
	if v863 != 0 {
		goto L11
...
L180:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v75)+32)) = int32(268435455)
	F_errmsg(m, int32(712607), v75+int32(32))
	mBase = m.M
	v879 = m.ExcPending
	if v879 != 0 {
		goto L11
...
L181:
	;
	F_errfinish(m, int32(519682), int32(2965), int32(439485))
	mBase = m.M
	v884 = m.ExcPending
	if v884 != 0 {
		goto L11
...
L185:
	;
	F_errfinish(m, int32(519682), int32(3017), int32(439485))
	mBase = m.M
	v900 = m.ExcPending
	if v900 != 0 {
		goto L11
...
L24:
	;
	F_errmsg(m, int32(236849), int32(0))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L18
...
L26:
	;
	F_errfinish(m, int32(520207), int32(95), int32(302316))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L18
...
L45:
	;
	F_errfinish(m, int32(520207), int32(132), int32(302316))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L18
...
L51:
	;
	F_errfinish(m, int32(520207), int32(152), int32(302316))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L18
		...
		*(*int32)(unsafe.Add(mBase, uint32(v14)+24)) = int32(0)
		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v14)+28)) = v24
			if v24 <= int32(0) {
				F_appendStringInfoString(m, l1, int32(534629))
				mBase = m.M
				v31 = m.ExcPending
				if v31 != 0 {
					return
...
L68:
	;
	F_errfinish(m, int32(526480), int32(753), int32(515771))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L4
...
L72:
	;
	F_errfinish(m, int32(526480), int32(709), int32(515771))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L4
...
L76:
	;
	F_errfinish(m, int32(526480), int32(714), int32(515771))
	mBase = m.M
	v419 = m.ExcPending
	if v419 != 0 {
		goto L4
...
L145:
	;
	F_errmsg_internal(m, int32(476733), int32(0))
	mBase = m.M
	v745 = m.ExcPending
	if v745 != 0 {
		goto L4
...
L146:
	;
	F_errfinish(m, int32(526480), int32(810), int32(515771))
	mBase = m.M
	v750 = m.ExcPending
	if v750 != 0 {
		goto L4
...
L149:
	;
	F_errfinish(m, int32(526480), int32(776), int32(515771))
	mBase = m.M
	v763 = m.ExcPending
	if v763 != 0 {
		goto L4
...
L152:
	;
	F_errfinish(m, int32(526480), int32(781), int32(515771))
	mBase = m.M
	v776 = m.ExcPending
	if v776 != 0 {
		goto L4
...
L155:
	;
	F_errfinish(m, int32(526480), int32(786), int32(515771))
	mBase = m.M
	v789 = m.ExcPending
	if v789 != 0 {
		goto L4
...
L158:
	;
	F_errfinish(m, int32(526480), int32(791), int32(515771))
	mBase = m.M
	v802 = m.ExcPending
	if v802 != 0 {
		goto L4
...
L162:
	;
	F_errfinish(m, int32(526480), int32(797), int32(515771))
	mBase = m.M
	v818 = m.ExcPending
	if v818 != 0 {
		goto L4
...
L7:
	;
	v136 = F_select_common_type(m, l0, v90, int32(536767), int32(0))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L1
...
L35:
	;
	F_errmsg(m, int32(25303), int32(0))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
...
L36:
	;
	F_errhint(m, int32(686461), int32(0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L38:
	;
	F_errfinish(m, int32(520256), int32(2107), int32(218173))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L1
...
L52:
	;
	F_errfinish(m, int32(520256), int32(2121), int32(218173))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L1
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v173
	F_errmsg(m, int32(204390), v17+int32(32))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(520256), int32(2132), int32(218173))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
...
L76:
	;
	v256 = F_coerce_to_common_type(m, l0, v219, v194, int32(536767))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L1
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v236
	F_errmsg(m, int32(194008), v17+int32(16))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L1
...
L86:
	;
	F_errfinish(m, int32(520256), int32(2167), int32(218173))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L1
			...
			if v78 != 0 {
				...
				if v81 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v22
					F_errmsg(m, int32(502071), v10)
					mBase = m.M
					v85 = m.ExcPending
					if v85 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(519682), int32(6947), int32(24912))
						mBase = m.M
						v90 = m.ExcPending
						if v90 != 0 {
							return int32(0)
