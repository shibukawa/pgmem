...
L67:
	;
	F_errmsg(m, int32(_a_F_array_to_sparsevec_0), int32(0))
	mBase = m.M
	v382 = m.ExcPending
	if v382 != 0 {
		goto L4
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v29
	F_errmsg(m, int32(_a_F_array_to_sparsevec_5), v19)
	mBase = m.M
	v431 = m.ExcPending
	if v431 != 0 {
		goto L4
...
L145:
	;
	F_errmsg_internal(m, int32(_a_F_array_to_sparsevec_7), int32(0))
	mBase = m.M
	v745 = m.ExcPending
	if v745 != 0 {
		goto L4
