...
L3:
	...
	v29 = int32(24)
	v31 = int32(_a_F_array_agg_serialize_0)
	v33 = int32(8)
...
L27:
	...
	v217 = int32(24)
	v219 = int32(_a_F_array_agg_serialize_0)
	v221 = int32(8)
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+16)) = v348
	F_errdetail(m, int32(_a_F_array_cat_4), v30+int32(16))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L8
...
L112:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30))) = v61
	F_errdetail(m, int32(_a_F_array_cat_5), v30)
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L8
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+4)) = v604 + v602 - int32(1)
	v611 = F_pg_sprintf(m, v579, int32(_a_F_array_out_2), v23)
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L1
...
L90:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v75))) = int32(268435455)
	F_errmsg(m, int32(_a_F_array_subscript_assign_slice_5), v75)
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L11
...
L176:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v75)+16)) = int32(268435455)
	F_errmsg(m, int32(_a_F_array_subscript_assign_slice_5), v75+int32(16))
	mBase = m.M
	v858 = m.ExcPending
	if v858 != 0 {
		goto L11
...
L180:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v75)+32)) = int32(268435455)
	F_errmsg(m, int32(_a_F_array_subscript_assign_slice_5), v75+int32(32))
	mBase = m.M
	v879 = m.ExcPending
	if v879 != 0 {
		goto L11
...
L7:
	;
	v136 = F_select_common_type(m, l0, v90, int32(_a_F_transformArrayExpr_0), int32(0))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L1
...
L35:
	;
	F_errmsg(m, int32(_a_F_transformArrayExpr_1), int32(0))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
...
L36:
	;
	F_errhint(m, int32(_a_F_transformArrayExpr_2), int32(0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L38:
	;
	F_errfinish(m, int32(_a_F_transformArrayExpr_3), int32(2107), int32(_a_F_transformArrayExpr_4))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L1
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v150
	F_errmsg(m, int32(_a_F_transformArrayExpr_5), v17)
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L52:
	;
	F_errfinish(m, int32(_a_F_transformArrayExpr_3), int32(2121), int32(_a_F_transformArrayExpr_4))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L1
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v173
	F_errmsg(m, int32(_a_F_transformArrayExpr_6), v17+int32(32))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(_a_F_transformArrayExpr_3), int32(2132), int32(_a_F_transformArrayExpr_4))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
...
L76:
	;
	v256 = F_coerce_to_common_type(m, l0, v219, v194, int32(_a_F_transformArrayExpr_0))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L1
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v236
	F_errmsg(m, int32(_a_F_transformArrayExpr_7), v17+int32(16))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L1
...
L86:
	;
	F_errfinish(m, int32(_a_F_transformArrayExpr_3), int32(2167), int32(_a_F_transformArrayExpr_4))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L1
			...
			if v78 != 0 {
				...
				if v81 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v22
					F_errmsg(m, int32(_a_F_trim_array_0), v10)
					mBase = m.M
					v85 = m.ExcPending
					if v85 != 0 {
						return int32(0)
