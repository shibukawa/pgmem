		...
		if v15 <= int32(0) {
			...
			if v61 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = v62
				F_errmsg_internal(m, int32(487770), v8)
				mBase = m.M
				v66 = m.ExcPending
				if v66 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(493930), int32(2135), int32(410866))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return int32(0)
					...
					if v24 == int32(0) {
						...
						if v76 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v77
							F_errmsg_internal(m, int32(487770), v8+int32(16))
							mBase = m.M
							v83 = m.ExcPending
							if v83 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(493930), int32(2138), int32(410866))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return int32(0)
