...
func F_InitializeClientEncoding(m *base.Module) {
	...
	m.G0 = v5
	v8 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1423])) = uint8(v8)
	v11 = *(*int32)(unsafe.Add(mBase, _consts[1424]))
	...
	if v13 != 0 {
		...
		if v12 < int32(0) {
			...
			if v48 != 0 {
				...
				if v51 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5)+4)) = v54
					v57 = *(*int32)(unsafe.Add(mBase, _consts[1424]))
					v62 = *(*int32)(unsafe.Add(mBase, uint32(v57<<(uint(int32(3))%32))+uint32(_consts[494])))
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = v62
					F_errmsg(m, int32(459750), v5)
					mBase = m.M
					v66 = m.ExcPending
					if v66 != 0 {
						return
					} else {
						F_errfinish(m, int32(513797), int32(308), int32(350037))
						mBase = m.M
						v71 = m.ExcPending
						if v71 != 0 {
							return
			...
			v17 = *(*int32)(unsafe.Add(mBase, _consts[1424]))
							...
							if v26 == int32(0) {
								...
								if v34 != 0 {
									...
									if v38 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, _consts[1429])) = v33
										m.G0 = v5 + int32(16)
										return
									}
								}
...
L2:
	;
	v11 = int32(0)
	v13 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1423])))
	if v13 == v11 {
		goto L3
	} else {
		goto L4
...
L6:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _consts[1425]))
	if v41 == int32(0) {
		v106 = int32(-1)
		goto L1
	} else {
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1426])) = l0<<(uint(int32(3))%32) + int32(1871168)
	v32 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1427])) = v32
	*(*int32)(unsafe.Add(mBase, _consts[1428])) = v32
	return v32
L8:
	;
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1426])) = l0<<(uint(int32(3))%32) + int32(1871168)
	*(*int32)(unsafe.Add(mBase, _consts[1427])) = v62 + int32(8)
	*(*int32)(unsafe.Add(mBase, _consts[1428])) = v62 + int32(36)
	v91 = v50
	v92 = v51
	goto L20
L22:
...
L23:
	;
	v79 = int32(4547020)
	v81 = *(*int32)(unsafe.Add(mBase, _consts[1425]))
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1425])) = v82
	F_pfree(m, v62)
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
...
L42:
	;
	v138 = F_format_elog_string(m, int32(638934), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L43
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v120
	v165 = F_format_elog_string(m, int32(670903), v9)
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L43
...
L56:
	;
	v173 = F_format_elog_string(m, int32(599412), int32(0))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L43
