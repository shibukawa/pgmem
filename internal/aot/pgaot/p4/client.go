...
func F_InitializeClientEncoding(m *base.Module) {
	...
	m.G0 = v5
	v8 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1417])) = uint8(v8)
	v11 = *(*int32)(unsafe.Add(mBase, _consts[1418]))
	...
	if v13 != 0 {
		...
		if v12 < int32(0) {
			...
			v17 = *(*int32)(unsafe.Add(mBase, _consts[1418]))
							...
							if v26 == int32(0) {
								...
								if v34 != 0 {
									...
									if v38 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, _consts[1423])) = v33
										m.G0 = v5 + int32(16)
										return
									}
								}
...
func F_ProcessClientWriteInterrupt(m *base.Module, l0 int32) {
	...
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1197]))
	if v6 == int32(0) {
...
L2:
	;
	v11 = int32(0)
	v13 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1417])))
	if v13 == v11 {
		goto L3
	} else {
		goto L4
...
L6:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _consts[1419]))
	if v41 == int32(0) {
		v106 = int32(-1)
		goto L1
	} else {
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1420])) = l0<<(uint(int32(3))%32) + int32(1793344)
	v32 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1421])) = v32
	*(*int32)(unsafe.Add(mBase, _consts[1422])) = v32
	return v32
L8:
	;
	v21 = *(*int32)(unsafe.Add(mBase, _consts[485]))
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1420])) = l0<<(uint(int32(3))%32) + int32(1793344)
	*(*int32)(unsafe.Add(mBase, _consts[1421])) = v62 + int32(8)
	*(*int32)(unsafe.Add(mBase, _consts[1422])) = v62 + int32(36)
	v91 = v50
	v92 = v51
	goto L20
L22:
...
L23:
	;
	v79 = int32(4423276)
	v81 = *(*int32)(unsafe.Add(mBase, _consts[1419]))
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1419])) = v82
	F_pfree(m, v62)
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
...
L33:
	;
	v119 = *(*int32)(unsafe.Add(mBase, uint32(v108<<(uint(int32(3))%32))+uint32(_consts[484])))
	v120 = v119
	goto L35
L34:
	;
...
L37:
	;
	v126 = int32(*(*uint8)(unsafe.Add(mBase, _consts[480])))
	if v126 != 0 {
		goto L36
	} else {
		goto L40
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, _consts[482])) = int32(322)
	goto L41
L41:
	;
...
L42:
	;
	v138 = F_format_elog_string(m, int32(566952), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L43
...
L53:
	;
	v160 = *(*int32)(unsafe.Add(mBase, _consts[485]))
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v120
	v165 = F_format_elog_string(m, int32(598147), v9)
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L43
...
L56:
	;
	v173 = F_format_elog_string(m, int32(528618), int32(0))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L43
