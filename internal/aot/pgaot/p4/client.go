			...
			if v48 != 0 {
				...
				if v51 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = v62
					F_errmsg(m, int32(461907), v5)
					mBase = m.M
					v66 = m.ExcPending
					if v66 != 0 {
						return
					} else {
						F_errfinish(m, int32(516109), int32(308), int32(351545))
						mBase = m.M
						v71 = m.ExcPending
						if v71 != 0 {
							return
...
L42:
	;
	v138 = F_format_elog_string(m, int32(642241), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L43
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v120
	v165 = F_format_elog_string(m, int32(674292), v9)
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L43
...
L56:
	;
	v173 = F_format_elog_string(m, int32(602679), int32(0))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L43
