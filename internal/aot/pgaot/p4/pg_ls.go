		...
		if v14 != 0 {
			...
			if v17 != 0 {
				...
				if v16 == int32(0) {
						...
						if v26 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = v13
							...
							if v30 != 0 {
								...
								F_errfinish(m, int32(510995), int32(740), int32(217528))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = int32(86448)
					v45 = F_pg_snprintf(m, v6+int32(32), int32(1024), int32(181138), v6+int32(16))
					mBase = m.M
					v46 = m.ExcPending
					if v46 != 0 {
						return int32(0)
