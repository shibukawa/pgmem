		...
		if v14 != 0 {
			...
			if v17 != 0 {
				...
				if v16 == int32(0) {
					...
					if v23 != 0 {
						...
						if v26 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = v13
							F_errmsg(m, int32(67324), v6)
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(475863), int32(740), int32(202637))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = int32(80304)
					v45 = F_pg_snprintf(m, v6+int32(32), int32(1024), int32(166989), v6+int32(16))
					mBase = m.M
					v46 = m.ExcPending
					if v46 != 0 {
						return int32(0)
