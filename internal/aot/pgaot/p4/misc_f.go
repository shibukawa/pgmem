								...
								if v88 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v89
									...
									if v93 != 0 {
										...
										F_errfinish(m, int32(489963), int32(1720), int32(132948))
										mBase = m.M
										v98 = m.ExcPending
										if v98 != 0 {
											return
					...
					if v29 != 0 {
						...
						if v32 != 0 {
							...
							if v36 != 0 {
								...
								F_errdetail(m, int32(629351), int32(0))
								mBase = m.M
								v40 = m.ExcPending
								if v40 != 0 {
									return
								} else {
									F_errfinish(m, int32(489963), int32(1682), int32(132948))
									mBase = m.M
									v45 = m.ExcPending
									if v45 != 0 {
										return
			...
			if v49 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
				...
				if v55 != 0 {
					...
					F_errfinish(m, int32(489963), int32(1686), int32(132948))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return
...
L37:
	;
	F_errhint(m, int32(563168), int32(0))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L4
...
L38:
	;
	F_errfinish(m, int32(495561), int32(599), int32(111292))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L4
...
L44:
	;
	F_errfinish(m, int32(495561), int32(615), int32(111292))
	mBase = m.M
	v208 = m.ExcPending
	if v208 != 0 {
		goto L4
...
L169:
	;
	F_errfinish(m, int32(495561), int32(581), int32(111292))
	mBase = m.M
	v832 = m.ExcPending
	if v832 != 0 {
		goto L4
...
L173:
	;
	F_errhint(m, int32(595978), int32(0))
	mBase = m.M
	v847 = m.ExcPending
	if v847 != 0 {
		goto L4
...
L174:
	;
	F_errfinish(m, int32(495561), int32(587), int32(111292))
	mBase = m.M
	v852 = m.ExcPending
	if v852 != 0 {
		goto L4
...
L176:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+16)) = v224
	F_errmsg_internal(m, int32(438199), v26+int32(-48))
	mBase = m.M
	v862 = m.ExcPending
	if v862 != 0 {
		goto L4
...
L177:
	;
	F_errfinish(m, int32(495561), int32(2419), int32(448716))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		goto L4
...
func F_FreeSpaceMapVacuumRange(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if base.Ui32(l1) < base.Ui32(l2) {
		v11 = *(*int64)(unsafe.Add(mBase, _consts[950]))
...
func F___fstat(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 < int32(0) {
		*(*int32)(unsafe.Add(mBase, _consts[140])) = int32(8)
		...
		v17 = F___fstatat(m, l0, int32(738731), l1, int32(4096))
		mBase = m.M
		return v17
	}
}
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(218268)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(491025), int32(369), int32(277723))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L39:
	;
	F_errfinish(m, int32(493056), int32(778), int32(172508))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L14
...
L28:
	;
	F_errfinish(m, int32(494687), int32(2192), int32(152634))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L10
...
L43:
	;
	F_errfinish(m, int32(490526), int32(167), int32(458046))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L1
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v115
	F_errmsg_internal(m, int32(479667), v10)
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L22
...
L57:
	;
	F_errfinish(m, int32(490993), int32(1572), int32(220486))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L22
...
L51:
	;
	F_errfinish(m, int32(492422), int32(104), int32(240428))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L8
...
L39:
	;
	F_errfinish(m, int32(492422), int32(248), int32(358136))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L12
...
L18:
	;
	F_errmsg_internal(m, int32(421367), int32(0))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(489270), int32(732), int32(358369))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L1
...
L24:
	;
	v110 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v104)>>(uint(int32(3))%32)))+uint32(_consts[1475]))))
...
L49:
	;
	v229 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v223)>>(uint(int32(3))%32)))+uint32(_consts[1475]))))
...
L75:
	;
	v354 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v348)>>(uint(int32(3))%32)))+uint32(_consts[1475]))))
...
L100:
	;
	v473 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v467)>>(uint(int32(3))%32)))+uint32(_consts[1475]))))
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v508
	v514 = F_find_among_b(m, l0, int32(4249984), int32(10))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L107
...
L134:
	;
	v631 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v625)>>(uint(int32(3))%32)))+uint32(_consts[1476]))))
...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v669
	v676 = F_find_among_b(m, l0, int32(4250192), int32(9))
	mBase = m.M
	v677 = m.ExcPending
	if v677 != 0 {
		goto L107
...
L165:
	...
	v715 = F_memcmp(m, v712+v702-v704, int32(2175476), v704)
	mBase = m.M
	if v715 != 0 {
		v719 = v706
		goto L164
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v722
	v726 = F_slice_from_s(m, l0, int32(3), int32(2175479))
	mBase = m.M
	v727 = m.ExcPending
	if v727 != 0 {
		goto L107
...
L173:
	;
	v744 = F_find_among_b(m, l0, int32(4250384), int32(6))
	mBase = m.M
	v745 = m.ExcPending
	if v745 != 0 {
		goto L107
...
L179:
	;
	v764 = F_find_among_b(m, l0, int32(4250512), int32(6))
	mBase = m.M
	v765 = m.ExcPending
	if v765 != 0 {
		goto L107
...
L185:
	;
	v784 = F_find_among_b(m, l0, int32(4250640), int32(2))
	mBase = m.M
	v785 = m.ExcPending
	if v785 != 0 {
		goto L107
...
L191:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v798
	v805 = F_find_among_b(m, l0, int32(4250688), int32(30))
	mBase = m.M
	v806 = m.ExcPending
	if v806 != 0 {
		goto L107
...
L198:
	...
	v892 = v891 - v811
	v895 = F_find_among_b(m, l0, int32(4251296), int32(7))
	mBase = m.M
	v896 = m.ExcPending
	if v896 != 0 {
		goto L107
...
L215:
	...
	v870 = F_memcmp(m, v867+v863-v859, int32(2175550), v859)
	mBase = m.M
	if v870 != 0 {
		v874 = v861
		goto L214
...
L220:
	...
	v886 = F_memcmp(m, v883+v879-v875, int32(2175552), v875)
	mBase = m.M
	if v886 != 0 {
		v890 = v877
		goto L219
...
L228:
	...
	v911 = F_memcmp(m, v908+v898-v900, int32(2175554), v900)
	mBase = m.M
	if v911 != 0 {
		v915 = v902
		goto L227
...
L273:
	;
	v1087 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v1081)>>(uint(int32(3))%32)))+uint32(_consts[1475]))))
...
L298:
	;
	v1216 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v1210)>>(uint(int32(3))%32)))+uint32(_consts[1477]))))
...
L307:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v1255
	v1262 = F_find_among_b(m, l0, int32(4251440), int32(14))
	mBase = m.M
	v1263 = m.ExcPending
	if v1263 != 0 {
		goto L107
...
L317:
	...
	v1284 = F_memcmp(m, v1281+v1277-v1273, int32(2175701), v1273)
	mBase = m.M
	if v1284 != 0 {
		v1288 = v1275
		goto L316
...
L329:
	;
	v1324 = F_find_among_b(m, l0, int32(4251728), int32(2))
	mBase = m.M
	v1325 = m.ExcPending
	if v1325 != 0 {
		goto L107
...
L356:
	;
	v1456 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v1450)>>(uint(int32(3))%32)))+uint32(_consts[1475]))))
...
L366:
	;
	v1507 = F_find_among_b(m, l0, int32(4251776), int32(2))
	mBase = m.M
	v1508 = m.ExcPending
	if v1508 != 0 {
		goto L107
...
L374:
	...
	v1528 = F_memcmp(m, v1525+v1521-v1517, int32(2175758), v1517)
	mBase = m.M
	if v1528 != 0 {
		v1532 = v1519
		goto L373
...
L380:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v1552
	v1558 = F_find_among_b(m, l0, int32(4251296), int32(7))
	mBase = m.M
	v1559 = m.ExcPending
	if v1559 != 0 {
		goto L107
...
L427:
	;
	v1735 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v1729)>>(uint(int32(3))%32)))+uint32(_consts[1478]))))
...
L452:
	;
	v1866 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v1860)>>(uint(int32(3))%32)))+uint32(_consts[1477]))))
...
L493:
	;
	v2068 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v2062)>>(uint(int32(3))%32)))+uint32(_consts[1475]))))
...
L518:
	;
	v2201 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v2195)>>(uint(int32(3))%32)))+uint32(_consts[1477]))))
...
L2:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _consts[1260]))
	if int32(0) < v28 {
		goto L3
	} else {
		goto L4
...
L13:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+2)) = uint8(v46)
	v49 = int32(*(*uint16)(unsafe.Add(mBase, _consts[1262])))
...
L42:
	...
	v117 = *(*int64)(unsafe.Add(mBase, uint32(v112<<(uint(int32(3))%32))+uint32(_consts[1263])))
...
L48:
	;
	v192 = v112 - int32(1)
	v197 = *(*int64)(unsafe.Add(mBase, uint32(v192<<(uint(int32(3))%32))+uint32(_consts[1263])))
	v201 = int64(32)
...
L69:
	;
	v407 = int32(1) - v331
	v412 = *(*int64)(unsafe.Add(mBase, uint32(v407<<(uint(int32(3))%32))+uint32(_consts[1264])))
	v416 = int64(32)
...
L122:
	...
	v846 = int32(1)
	v850 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v845<<(uint(v846)%32))+uint32(_consts[1265]))))
	*(*uint16)(unsafe.Add(mBase, uint32(v836-int32(3)))) = uint16(v850)
	v861 = int32(*(*uint16)(unsafe.Add(mBase, uint32((v843-v845*v844)<<(uint(v846)%32))+uint32(_consts[1265]))))
...
L128:
	...
	v907 = int32(*(*uint16)(unsafe.Add(mBase, uint32((v870-v897*v896)&v894<<(uint(int32(1))%32))+uint32(_consts[1265]))))
...
L130:
	...
	v922 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v919)+uint32(_consts[1266]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v23+(v744+v799-v911)))) = uint8(v922)
	v926 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v919)+uint32(_consts[1265]))))
	v930 = v926
	goto L129
L131:
	;
...
L141:
	;
	v960 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v955<<(uint(int32(1))%32))+uint32(_consts[1265]))))
...
L146:
	...
	v1004 = int32(1)
	v1008 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v1003<<(uint(v1004)%32))+uint32(_consts[1265]))))
	*(*uint16)(unsafe.Add(mBase, uint32(v994-v995))) = uint16(v1008)
	v1019 = int32(*(*uint16)(unsafe.Add(mBase, uint32((v1001-v1003*v1002)<<(uint(v1004)%32))+uint32(_consts[1265]))))
...
L152:
	...
	v1065 = int32(*(*uint16)(unsafe.Add(mBase, uint32((v1028-v1055*v1054)&v1052<<(uint(int32(1))%32))+uint32(_consts[1265]))))
...
L154:
	;
	v1082 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v1069<<(uint(int32(1))%32))+uint32(_consts[1265]))))
...
func F_float8out_internal(m *base.Module, l0 float64) int32 {
	...
	if v8 != 0 {
		...
		v10 = *(*int32)(unsafe.Add(mBase, _consts[1260]))
		if int32(0) < v10 {
	...
	if v4 != 0 {
		...
		if v7 != 0 {
			...
			if v11 != 0 {
				...
				F_errfinish(m, int32(490414), int32(90), int32(210609))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
	...
	if v4 != 0 {
		...
		if v7 != 0 {
			...
			if v11 != 0 {
				...
				F_errfinish(m, int32(490414), int32(106), int32(211079))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
...
L288:
	;
	F_out(m, l0, int32(651483), int32(1))
	mBase = m.M
	v1555 = m.ExcPending
	if v1555 != 0 {
		goto L15
...
L400:
	;
	v2243 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v2240)+uint32(_consts[1616]))))
...
func F_fopen(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v13 = F___strchrnul(m, int32(500693), v12)
	mBase = m.M
	...
	if v19 == int32(0) {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v9))) = int64(438)
		...
		if v74 < int32(0) {
			...
			v83 = F___strchrnul(m, int32(500693), v82)
			mBase = m.M
			...
			if v89 == int32(0) {
				*(*int32)(unsafe.Add(mBase, _consts[140])) = int32(28)
				...
				if v96 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v96)+40)) = int32(6949)
					*(*int32)(unsafe.Add(mBase, uint32(v96)+36)) = int32(6950)
					*(*int32)(unsafe.Add(mBase, uint32(v96)+32)) = int32(6951)
					*(*int32)(unsafe.Add(mBase, uint32(v96)+12)) = int32(6952)
					v171 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1569])))
					if v171 == int32(0) {
						*(*int32)(unsafe.Add(mBase, uint32(v96)+76)) = int32(-1)
					} else {
					}
					v177 = *(*int32)(unsafe.Add(mBase, _consts[1570]))
					*(*int32)(unsafe.Add(mBase, uint32(v96)+56)) = v177
					if v177 != 0 {
						*(*int32)(unsafe.Add(mBase, uint32(v177)+52)) = v96
					} else {
					}
					*(*int32)(unsafe.Add(mBase, _consts[1570])) = v96
					v185 = v96
				} else {
					v185 = int32(0)
				}
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+4)) = v11 + int32(20)
	F_errmsg_internal(m, int32(449147), v11)
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L4
...
L21:
	;
	F_errfinish(m, int32(490815), int32(184), int32(169670))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L28:
	;
	F_errfinish(m, int32(490815), int32(189), int32(169670))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L4
	...
	if int32(0) <= v6 {
		if v6 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v31))) = v34
			...
			v12 = *(*int32)(unsafe.Add(mBase, _consts[1571]))
