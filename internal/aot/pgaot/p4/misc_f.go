		...
		if v19 != 0 {
							...
							if v74 != int32(4537) {
								...
								if v88 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v89
									F_errmsg_internal(m, int32(56994), v9)
									mBase = m.M
									v93 = m.ExcPending
									if v93 != 0 {
										return
									} else {
										F_errfinish(m, int32(476329), int32(1720), int32(126826))
										mBase = m.M
										v98 = m.ExcPending
										if v98 != 0 {
											return
				...
				if v21 == int32(4537) {
					...
					if v29 != 0 {
						...
						if v32 != 0 {
							...
							F_errmsg(m, int32(20787), int32(0))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return
							} else {
								F_errdetail(m, int32(613408), int32(0))
								mBase = m.M
								v40 = m.ExcPending
								if v40 != 0 {
									return
								} else {
									F_errfinish(m, int32(476329), int32(1682), int32(126826))
									mBase = m.M
									v45 = m.ExcPending
									if v45 != 0 {
										return
			...
			if v49 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
				F_errmsg_internal(m, int32(40727), v9+int32(16))
				mBase = m.M
				v55 = m.ExcPending
				if v55 != 0 {
					return
				} else {
					F_errfinish(m, int32(476329), int32(1686), int32(126826))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return
...
L36:
	;
	F_errmsg(m, int32(349154), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L37:
	;
	F_errhint(m, int32(547906), int32(0))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L4
...
L38:
	;
	F_errfinish(m, int32(481810), int32(599), int32(106220))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L4
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+48)) = l0
	F_errmsg(m, int32(68928), v26+int32(-16))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L4
...
L44:
	;
	F_errfinish(m, int32(481810), int32(615), int32(106220))
	mBase = m.M
	v208 = m.ExcPending
	if v208 != 0 {
		goto L4
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+32)) = l0
	F_errmsg(m, int32(10998), v26+int32(-32))
	mBase = m.M
	v827 = m.ExcPending
	if v827 != 0 {
		goto L4
...
L169:
	;
	F_errfinish(m, int32(481810), int32(581), int32(106220))
	mBase = m.M
	v832 = m.ExcPending
	if v832 != 0 {
		goto L4
...
L173:
	;
	F_errhint(m, int32(580206), int32(0))
	mBase = m.M
	v847 = m.ExcPending
	if v847 != 0 {
		goto L4
...
L174:
	;
	F_errfinish(m, int32(481810), int32(587), int32(106220))
	mBase = m.M
	v852 = m.ExcPending
	if v852 != 0 {
		goto L4
...
L176:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+16)) = v224
	F_errmsg_internal(m, int32(425551), v26+int32(-48))
	mBase = m.M
	v862 = m.ExcPending
	if v862 != 0 {
		goto L4
...
L177:
	;
	F_errfinish(m, int32(481810), int32(2419), int32(435956))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		goto L4
...
L179:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28))) = v86
	F_errmsg_internal(m, int32(23865), v28)
	mBase = m.M
	v900 = m.ExcPending
	if v900 != 0 {
		goto L4
...
func F___fstat(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 < int32(0) {
		*(*int32)(unsafe.Add(mBase, _consts[140])) = int32(8)
		...
		v17 = F___fstatat(m, l0, int32(722455), l1, int32(4096))
		mBase = m.M
		return v17
	}
}
func F_fdw_handler_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(211457)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(477380), int32(369), int32(269066))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L39:
	;
	F_errfinish(m, int32(479385), int32(778), int32(166055))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L14
...
L28:
	;
	F_errfinish(m, int32(480958), int32(2192), int32(146381))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L10
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = l0
	F_errmsg_internal(m, int32(54990), v17+int32(16))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L1
...
L43:
	;
	F_errfinish(m, int32(476881), int32(167), int32(445120))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L1
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v115
	F_errmsg_internal(m, int32(466303), v10)
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L22
...
L57:
	;
	F_errfinish(m, int32(477348), int32(1572), int32(213675))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L22
...
L50:
	;
	F_errmsg_internal(m, int32(233314), int32(0))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L8
...
L51:
	;
	F_errfinish(m, int32(478761), int32(104), int32(232690))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L8
...
L39:
	;
	F_errfinish(m, int32(478761), int32(248), int32(347627))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L12
...
L18:
	;
	F_errmsg_internal(m, int32(408950), int32(0))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(475676), int32(732), int32(347860))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L1
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v508
	v514 = F_find_among_b(m, l0, int32(4222368), int32(10))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L107
...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v669
	v676 = F_find_among_b(m, l0, int32(4222576), int32(9))
	mBase = m.M
	v677 = m.ExcPending
	if v677 != 0 {
		goto L107
...
L165:
	...
	v715 = F_memcmp(m, v712+v702-v704, int32(2151780), v704)
	mBase = m.M
	if v715 != 0 {
		v719 = v706
		goto L164
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v722
	v726 = F_slice_from_s(m, l0, int32(3), int32(2151783))
	mBase = m.M
	v727 = m.ExcPending
	if v727 != 0 {
		goto L107
...
L173:
	;
	v744 = F_find_among_b(m, l0, int32(4222768), int32(6))
	mBase = m.M
	v745 = m.ExcPending
	if v745 != 0 {
		goto L107
...
L179:
	;
	v764 = F_find_among_b(m, l0, int32(4222896), int32(6))
	mBase = m.M
	v765 = m.ExcPending
	if v765 != 0 {
		goto L107
...
L185:
	;
	v784 = F_find_among_b(m, l0, int32(4223024), int32(2))
	mBase = m.M
	v785 = m.ExcPending
	if v785 != 0 {
		goto L107
...
L191:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v798
	v805 = F_find_among_b(m, l0, int32(4223072), int32(30))
	mBase = m.M
	v806 = m.ExcPending
	if v806 != 0 {
		goto L107
...
L198:
	...
	v892 = v891 - v811
	v895 = F_find_among_b(m, l0, int32(4223680), int32(7))
	mBase = m.M
	v896 = m.ExcPending
	if v896 != 0 {
		goto L107
...
L215:
	...
	v870 = F_memcmp(m, v867+v863-v859, int32(2151854), v859)
	mBase = m.M
	if v870 != 0 {
		v874 = v861
		goto L214
...
L220:
	...
	v886 = F_memcmp(m, v883+v879-v875, int32(2151856), v875)
	mBase = m.M
	if v886 != 0 {
		v890 = v877
		goto L219
...
L228:
	...
	v911 = F_memcmp(m, v908+v898-v900, int32(2151858), v900)
	mBase = m.M
	if v911 != 0 {
		v915 = v902
		goto L227
...
L307:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v1255
	v1262 = F_find_among_b(m, l0, int32(4223824), int32(14))
	mBase = m.M
	v1263 = m.ExcPending
	if v1263 != 0 {
		goto L107
...
L317:
	...
	v1284 = F_memcmp(m, v1281+v1277-v1273, int32(2152005), v1273)
	mBase = m.M
	if v1284 != 0 {
		v1288 = v1275
		goto L316
...
L329:
	;
	v1324 = F_find_among_b(m, l0, int32(4224112), int32(2))
	mBase = m.M
	v1325 = m.ExcPending
	if v1325 != 0 {
		goto L107
...
L366:
	;
	v1507 = F_find_among_b(m, l0, int32(4224160), int32(2))
	mBase = m.M
	v1508 = m.ExcPending
	if v1508 != 0 {
		goto L107
...
L374:
	...
	v1528 = F_memcmp(m, v1525+v1521-v1517, int32(2152062), v1517)
	mBase = m.M
	if v1528 != 0 {
		v1532 = v1519
		goto L373
...
L380:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v1552
	v1558 = F_find_among_b(m, l0, int32(4223680), int32(7))
	mBase = m.M
	v1559 = m.ExcPending
	if v1559 != 0 {
		goto L107
...
L44:
	...
	v331 = v330 + v106
	v335 = *(*int64)(unsafe.Add(mBase, uint32(int32(1810976)-v331<<(uint(int32(3))%32))))
...
func F_float_overflow_error(m *base.Module) {
	...
	if v4 != 0 {
		...
		if v7 != 0 {
			...
			F_errmsg(m, int32(30006), int32(0))
			v11 = m.ExcPending
			if v11 != 0 {
				return
			} else {
				F_errfinish(m, int32(476769), int32(90), int32(203878))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
	...
	if v4 != 0 {
		...
		if v7 != 0 {
			...
			if v11 != 0 {
				...
				F_errfinish(m, int32(476769), int32(106), int32(204348))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
...
L288:
	;
	F_out(m, l0, int32(635375), int32(1))
	mBase = m.M
	v1555 = m.ExcPending
	if v1555 != 0 {
		goto L15
...
L400:
	;
	v2243 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v2240)+uint32(_consts[1609]))))
...
func F_fopen(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v13 = F___strchrnul(m, int32(486847), v12)
	mBase = m.M
	...
	if v19 == int32(0) {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v9))) = int64(438)
		...
		if v74 < int32(0) {
			...
			v83 = F___strchrnul(m, int32(486847), v82)
			mBase = m.M
			...
			if v89 == int32(0) {
				*(*int32)(unsafe.Add(mBase, _consts[140])) = int32(28)
				...
				if v96 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v96)+40)) = int32(5873)
					*(*int32)(unsafe.Add(mBase, uint32(v96)+36)) = int32(5874)
					*(*int32)(unsafe.Add(mBase, uint32(v96)+32)) = int32(5875)
					*(*int32)(unsafe.Add(mBase, uint32(v96)+12)) = int32(5876)
					v171 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1562])))
					if v171 == int32(0) {
						*(*int32)(unsafe.Add(mBase, uint32(v96)+76)) = int32(-1)
					} else {
					}
					v177 = *(*int32)(unsafe.Add(mBase, _consts[1563]))
					*(*int32)(unsafe.Add(mBase, uint32(v96)+56)) = v177
					if v177 != 0 {
						*(*int32)(unsafe.Add(mBase, uint32(v177)+52)) = v96
					} else {
					}
					*(*int32)(unsafe.Add(mBase, _consts[1563])) = v96
					v185 = v96
				} else {
					v185 = int32(0)
				}
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+4)) = v11 + int32(20)
	F_errmsg_internal(m, int32(436387), v11)
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L4
...
L21:
	;
	F_errfinish(m, int32(477170), int32(184), int32(163268))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L28:
	;
	F_errfinish(m, int32(477170), int32(189), int32(163268))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L4
	...
	if int32(0) <= v6 {
		if v6 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v31))) = v34
			...
			v12 = *(*int32)(unsafe.Add(mBase, _consts[1564]))
