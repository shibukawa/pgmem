...
func F_ExecAppendAsyncEventWait(m *base.Module, l0 int32) {
	...
	v16 = *(*int32)(unsafe.Add(mBase, _c_F_ExecAppendAsyncEventWait[0]))
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v107))) = v136
	F_errmsg_internal(m, int32(_a_F_ExecAppendAsyncEventWait_0), v107)
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L1
...
L54:
	;
	v231 = *(*int32)(unsafe.Add(mBase, _c_F_ExecAppendAsyncEventWait[1]))
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v276))) = v320
	F_errmsg_internal(m, int32(_a_F_ExecAppendAsyncEventWait_0), v276)
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L1
...
L94:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v276)+16)) = v335
	F_errmsg_internal(m, int32(_a_F_ExecAppendAsyncEventWait_0), v276+int32(16))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L1
