...
func F_UnregisterSnapshot(m *base.Module, l0 int32) {
	...
	_ = v8
	if l0 != 0 {
		v3 = *(*int32)(unsafe.Add(mBase, _consts[182]))
		F_ResourceOwnerForget(m, v3, l0, int32(1773380))
		mBase = m.M
		v6 = m.ExcPending
		if v6 != 0 {
			return
...
func F_UnregisterSnapshotNoOwner(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+48)) = v5
	if v5 != 0 {
		...
		F_pairingheap_remove(m, int32(4178632), l0+int32(52))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return
			...
			if v12 != 0 {
				...
				if v13 != 0 {
					...
					if v15 != 0 {
						...
						v18 = *(*int32)(unsafe.Add(mBase, _consts[263]))
						if v18 != 0 {
						} else {
							v20 = *(*int32)(unsafe.Add(mBase, _consts[264]))
							if v20 != 0 {
								v22 = *(*int32)(unsafe.Add(mBase, _consts[120]))
								v23 = *(*int32)(unsafe.Add(mBase, uint32(v22)+40))
								v25 = *(*int32)(unsafe.Add(mBase, _consts[264]))
								v27 = v25 - int32(48)
...
func F_unaccent_dict(m *base.Module, l0 int32) int32 {
	...
	if v12 == v11 {
		...
		if v23 != 0 {
			...
			v24 = int32(0)
			v26 = F_GetSysCacheOid(m, int32(75), int32(97129), v20, v24, v24)
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
					...
					if v31 != 0 {
						...
						if v34 != 0 {
							...
							if v37 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(97129)
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v36
								F_errmsg(m, int32(70619), v9)
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(494277), int32(464), int32(110180))
									mBase = m.M
									v52 = m.ExcPending
									if v52 != 0 {
										return int32(0)
...
L10:
	...
	v28 = int32(164450)
	v31 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1570])))
...
L30:
	;
	F_errfinish(m, int32(494277), int32(363), int32(100158))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L24
...
L33:
	;
	F_errmsg(m, int32(132825), int32(0))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L24
...
L34:
	;
	F_errfinish(m, int32(494277), int32(354), int32(100158))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L24
...
L38:
	;
	F_errmsg(m, int32(217014), int32(0))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L24
...
L39:
	;
	F_errfinish(m, int32(494277), int32(371), int32(100158))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L24
					...
					if v17 == int32(0) {
						...
						if v22 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg(m, int32(297296), v7)
							mBase = m.M
							v26 = m.ExcPending
							if v26 != 0 {
								return
							} else {
								F_errfinish(m, int32(500942), int32(3849), int32(378776))
								mBase = m.M
								v31 = m.ExcPending
								if v31 != 0 {
									return
				...
				if v16 == int32(0) {
					...
					if v21 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
						F_errmsg(m, int32(300151), v6)
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
						} else {
							F_errfinish(m, int32(500431), int32(6966), int32(387154))
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return
...
func F_update_progress_txn_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	m.G0 = v9
	v11 = int32(4513176)
	v12 = *(*int32)(unsafe.Add(mBase, _consts[394]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(244086)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+160)) = v30
	...
	if v36 != 0 {
		...
		if v39 != 0 {
			...
			v41 = v40
			*(*int32)(unsafe.Add(mBase, _consts[394])) = v41
			m.G0 = v9 + int32(32)
			return
		}
	} else {
