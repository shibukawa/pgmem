...
func F_UnregisterSnapshot(m *base.Module, l0 int32) {
	...
	if l0 != 0 {
		...
		F_ResourceOwnerForget(m, v3, l0, int32(1769284))
		mBase = m.M
		v6 = m.ExcPending
		if v6 != 0 {
			return
...
func F_UnregisterSnapshotNoOwner(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+48)) = v5
	if v5 != 0 {
		...
		F_pairingheap_remove(m, int32(4174008), l0+int32(52))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return
...
func F_unaccent_dict(m *base.Module, l0 int32) int32 {
	...
	if v12 == v11 {
		...
		if v23 != 0 {
			...
			v24 = int32(0)
			v26 = F_GetSysCacheOid(m, int32(75), int32(96792), v20, v24, v24)
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return int32(0)
					...
					if v31 != 0 {
						...
						if v34 != 0 {
							...
							if v37 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(96792)
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v36
								F_errmsg(m, int32(70313), v9)
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(493081), int32(464), int32(109843))
									mBase = m.M
									v52 = m.ExcPending
									if v52 != 0 {
										return int32(0)
...
L10:
	...
	v28 = int32(163999)
	v31 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1569])))
...
L30:
	;
	F_errfinish(m, int32(493081), int32(363), int32(99821))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L24
...
L33:
	;
	F_errmsg(m, int32(132421), int32(0))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L24
...
L34:
	;
	F_errfinish(m, int32(493081), int32(354), int32(99821))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L24
...
L38:
	;
	F_errmsg(m, int32(216551), int32(0))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L24
...
L39:
	;
	F_errfinish(m, int32(493081), int32(371), int32(99821))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L24
					...
					if v17 == int32(0) {
						...
						if v22 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg(m, int32(296556), v7)
							mBase = m.M
							v26 = m.ExcPending
							if v26 != 0 {
								return
							} else {
								F_errfinish(m, int32(499691), int32(3849), int32(377815))
								mBase = m.M
								v31 = m.ExcPending
								if v31 != 0 {
									return
				...
				if v16 == int32(0) {
					...
					if v21 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
						F_errmsg(m, int32(299411), v6)
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
						} else {
							F_errfinish(m, int32(499180), int32(6966), int32(386146))
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return
...
func F_update_progress_txn_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(243472)
