...
func F_UnregisterSnapshotNoOwner(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+48)) = v5
	if v5 != 0 {
		...
		F_pairingheap_remove(m, int32(4154440), l0+int32(52))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return
							...
							if v37 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v36
								...
								if v45 != 0 {
									...
									F_errfinish(m, int32(490029), int32(464), int32(109218))
									mBase = m.M
									v52 = m.ExcPending
									if v52 != 0 {
										return int32(0)
...
L10:
	...
	v28 = int32(163184)
	v31 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1561])))
...
L30:
	;
	F_errfinish(m, int32(490029), int32(363), int32(99380))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L24
...
L34:
	;
	F_errfinish(m, int32(490029), int32(354), int32(99380))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L24
...
L39:
	;
	F_errfinish(m, int32(490029), int32(371), int32(99380))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L24
						...
						if v22 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							...
							if v26 != 0 {
								...
								F_errfinish(m, int32(496577), int32(3849), int32(375499))
								mBase = m.M
								v31 = m.ExcPending
								if v31 != 0 {
									return
					...
					if v21 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
						...
						if v25 != 0 {
							...
							F_errfinish(m, int32(496066), int32(6966), int32(383815))
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return
