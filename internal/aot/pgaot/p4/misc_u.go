...
func F_UnregisterSnapshotNoOwner(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+48)) = v5
	if v5 != 0 {
		...
		F_pairingheap_remove(m, int32(4174088), l0+int32(52))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return
							...
							if v37 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v36
								...
								if v45 != 0 {
									...
									F_errfinish(m, int32(493392), int32(464), int32(109900))
									mBase = m.M
									v52 = m.ExcPending
									if v52 != 0 {
										return int32(0)
...
L30:
	;
	F_errfinish(m, int32(493392), int32(363), int32(99878))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L24
...
L33:
	;
	F_errmsg(m, int32(132508), int32(0))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L24
...
L34:
	;
	F_errfinish(m, int32(493392), int32(354), int32(99878))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L24
...
L38:
	;
	F_errmsg(m, int32(216638), int32(0))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L24
...
L39:
	;
	F_errfinish(m, int32(493392), int32(371), int32(99878))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L24
					...
					if v17 == int32(0) {
						...
						if v22 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
							F_errmsg(m, int32(296815), v7)
							mBase = m.M
							v26 = m.ExcPending
							if v26 != 0 {
								return
							} else {
								F_errfinish(m, int32(500025), int32(3849), int32(378107))
								mBase = m.M
								v31 = m.ExcPending
								if v31 != 0 {
									return
				...
				if v16 == int32(0) {
					...
					if v21 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
						F_errmsg(m, int32(299670), v6)
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
						} else {
							F_errfinish(m, int32(499514), int32(6966), int32(386438))
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return
...
func F_update_progress_txn_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(243649)
