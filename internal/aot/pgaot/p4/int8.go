		...
		if v20 != 0 {
			...
			if v185 != 0 {
				...
				if v189 != 0 {
					...
					F_errfinish(m, int32(478277), int32(6928), int32(311761))
					mBase = m.M
					v194 = m.ExcPending
					if v194 != 0 {
						return int32(0)
									...
									*(*int32)(unsafe.Add(mBase, uint32(v13)+8)) = v146
									...
									if v160 != 0 {
										...
										if v162 != 0 {
											...
											v165 = F_DirectFunctionCall2Coll(m, int32(1275), int32(0), v159, v90)
											mBase = m.M
											v166 = m.ExcPending
											if v166 != 0 {
												return int32(0)
...
func F_int8_avg_accum_inv(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v108 != 0 {
			...
			F_errmsg_internal(m, int32(337421), int32(0))
			mBase = m.M
			v112 = m.ExcPending
			if v112 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(478277), int32(6172), int32(30510))
				mBase = m.M
				v117 = m.ExcPending
				if v117 != 0 {
					return int32(0)
