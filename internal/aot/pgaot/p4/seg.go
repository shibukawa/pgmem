...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v17
	v26 = F_pg_sprintf(m, v13, int32(500702), v9+int32(16))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L1
...
L15:
	;
	v57 = F_pg_sprintf(m, v54, int32(643502), int32(0))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L1
...
L16:
	;
	v48 = v46 + v29
	v51 = F_pg_sprintf(m, v48, int32(729068), int32(0))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L1
...
L19:
	;
	v62 = v54 + v57
	v65 = F_pg_sprintf(m, v62, int32(729068), int32(0))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L1
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = base.I32_extend8_s(v68)
	v77 = F_pg_sprintf(m, v67, int32(500702), v9)
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L1
