...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v50 ^ v110 - v110
	v117 = F_pg_sprintf(m, v10+int32(20), int32(475749), v10)
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L15
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v49
	v72 = F_pg_sprintf(m, v10+int32(20), int32(475749), v10+int32(16))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L15
	...
	if v10 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
		...
		if v14 != 0 {
			...
			F_errfinish(m, int32(321143), int32(51), int32(82460))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return
