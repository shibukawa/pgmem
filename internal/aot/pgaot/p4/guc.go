...
func F_GUC_yyensure_buffer_stack(m *base.Module, l0 int32) {
	...
	if v4 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
		if v8 == int32(0) {
			F_GUC_flex_fatal(m, int32(665631))
			mBase = m.M
			v46 = m.ExcPending
			if v46 != 0 {
				return
...
L84:
	;
	F_errfinish(m, int32(496556), int32(6444), int32(26255))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L6
				...
				if v18 == int32(0) {
					...
					if v24 != 0 {
						...
						if v28 != 0 {
							...
							F_errfinish(m, int32(496556), int32(647), int32(485765))
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
