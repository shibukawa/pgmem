...
func F_GUC_yyensure_buffer_stack(m *base.Module, l0 int32) {
	...
	if v4 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
		if v8 == int32(0) {
			F_GUC_flex_fatal(m, int32(655262))
			mBase = m.M
			v46 = m.ExcPending
			if v46 != 0 {
				return
...
L12:
	...
	v53 = v51 - int32(32)
	m.G0 = v53
	v55 = int32(*(*int8)(unsafe.Add(mBase, _consts[1436])))
	if v55 != 0 {
		goto L16
	} else {
		goto L17
...
L15:
	...
	mBase = m.M
	v61 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1436])))
	if v61 != 0 {
		goto L20
	} else {
		goto L21
...
L16:
	;
	v56 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1437])))
	if v56 != 0 {
		goto L15
	} else {
		goto L19
...
L84:
	;
	F_errfinish(m, int32(488529), int32(6444), int32(25610))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L6
...
func F_build_guc_variables(m *base.Module) {
	...
	v17 = F_AllocSetContextCreateInternal(m, v12, int32(60860), v1, int32(8192), int32(8388608))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1426])) = v17
	v21 = *(*int32)(unsafe.Add(mBase, _consts[1427]))
	if v21 != 0 {
		goto L3
	} else {
		goto L4
...
L5:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[1428]))
	if v43 != 0 {
		goto L9
	} else {
		goto L10
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+24)) = int32(0)
	v31 = v23 + int32(1)
	v33 = v31 * int32(120)
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v33)+uint32(_consts[1427])))
	if v36 != 0 {
		v23 = v31
		v25 = v33 + int32(4083600)
		goto L6
	} else {
		goto L8
	}
...
L11:
	;
	v68 = *(*int32)(unsafe.Add(mBase, _consts[1429]))
	if v68 != 0 {
		goto L15
	} else {
		goto L16
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v47)+24)) = v50
	...
	v60 = *(*int32)(unsafe.Add(mBase, uint32(v57)+uint32(_consts[1428])))
	if v60 != 0 {
		v45 = v53
		v46 = v55
		v47 = v57 + int32(4097520)
		goto L12
	} else {
		goto L14
	}
...
L17:
	;
	v93 = *(*int32)(unsafe.Add(mBase, _consts[1430]))
	if v93 != 0 {
		goto L21
	} else {
		goto L22
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v72)+24)) = int32(2)
	...
	v80 = v71 + v77
	v82 = v80 * int32(152)
	v85 = *(*int32)(unsafe.Add(mBase, uint32(v82)+uint32(_consts[1429])))
	if v85 != 0 {
		v70 = v78
		v71 = v80
		v72 = v82 + int32(4116464)
		goto L18
	} else {
		goto L20
	}
...
L23:
	;
	v118 = *(*int32)(unsafe.Add(mBase, _consts[1431]))
	if v118 != 0 {
		goto L27
	} else {
		goto L28
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v97)+24)) = int32(3)
	...
	v105 = v96 + v102
	v107 = v105 * int32(120)
	v110 = *(*int32)(unsafe.Add(mBase, uint32(v107)+uint32(_consts[1430])))
	if v110 != 0 {
		v95 = v103
		v96 = v105
		v97 = v107 + int32(4120576)
		goto L24
	} else {
		goto L26
	}
...
L29:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+32)) = int64(34359738372)
	...
	v157 = F_hash_create(m, int32(385034), v152+v136, v6+int32(-48), int32(1224))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v122)+24)) = int32(4)
	...
	v130 = v121 + v127
	v132 = v130 * int32(124)
	v135 = *(*int32)(unsafe.Add(mBase, uint32(v132)+uint32(_consts[1431])))
	if v135 != 0 {
		v120 = v128
		v121 = v130
		v122 = v132 + int32(4129712)
		goto L30
	} else {
		goto L32
	}
...
L33:
	;
	*(*int32)(unsafe.Add(mBase, _consts[422])) = v157
	v161 = *(*int32)(unsafe.Add(mBase, _consts[1427]))
	if v161 != 0 {
		goto L34
	} else {
		goto L35
...
L36:
	;
	v190 = *(*int32)(unsafe.Add(mBase, _consts[1428]))
	if v190 != 0 {
		goto L41
	} else {
		goto L42
...
L37:
	;
	v169 = *(*int32)(unsafe.Add(mBase, _consts[422]))
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v173)+4)) = v163
	v177 = v164 + int32(1)
	v179 = v177 * int32(120)
	v182 = *(*int32)(unsafe.Add(mBase, uint32(v179)+uint32(_consts[1427])))
	if v182 != 0 {
		v163 = v179 + int32(4083600)
		v164 = v177
		goto L37
	} else {
		goto L40
...
L43:
	;
	v219 = *(*int32)(unsafe.Add(mBase, _consts[1429]))
	if v219 != 0 {
		goto L48
	} else {
		goto L49
...
L44:
	;
	v198 = *(*int32)(unsafe.Add(mBase, _consts[422]))
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v202)+4)) = v192
	...
	v211 = *(*int32)(unsafe.Add(mBase, uint32(v208)+uint32(_consts[1428])))
	if v211 != 0 {
		v192 = v208 + int32(4097520)
		v193 = v206
		goto L44
	} else {
		goto L47
...
L50:
	;
	v248 = *(*int32)(unsafe.Add(mBase, _consts[1430]))
	if v248 != 0 {
		goto L55
	} else {
		goto L56
...
L51:
	;
	v227 = *(*int32)(unsafe.Add(mBase, _consts[422]))
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v231)+4)) = v221
	v235 = v222 + int32(1)
	v237 = v235 * int32(152)
	v240 = *(*int32)(unsafe.Add(mBase, uint32(v237)+uint32(_consts[1429])))
	if v240 != 0 {
		v221 = v237 + int32(4116464)
		v222 = v235
		goto L51
	} else {
		goto L54
...
L57:
	;
	v277 = *(*int32)(unsafe.Add(mBase, _consts[1431]))
	if v277 != 0 {
		goto L62
	} else {
		goto L63
...
L58:
	;
	v256 = *(*int32)(unsafe.Add(mBase, _consts[422]))
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v260)+4)) = v250
	v264 = v251 + int32(1)
	v266 = v264 * int32(120)
	v269 = *(*int32)(unsafe.Add(mBase, uint32(v266)+uint32(_consts[1430])))
	if v269 != 0 {
		v250 = v266 + int32(4120576)
		v251 = v264
		goto L58
	} else {
		goto L61
...
L65:
	;
	v285 = *(*int32)(unsafe.Add(mBase, _consts[422]))
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v289)+4)) = v279
	v293 = v280 + int32(1)
	v295 = v293 * int32(124)
	v298 = *(*int32)(unsafe.Add(mBase, uint32(v295)+uint32(_consts[1431])))
	if v298 != 0 {
		v279 = v295 + int32(4129712)
		v280 = v293
		goto L65
	} else {
		goto L68
...
L2:
	;
	v339 = *(*int32)(unsafe.Add(mBase, uint32(v334<<(uint(int32(2))%32))+uint32(_consts[1432])))
	v340 = v339
	goto L1
L3:
	;
...
func F_guc_strdup(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v91 int32
	_ = v91
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1426]))
...
L27:
	;
	F_errfinish(m, int32(488529), int32(647), int32(478022))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L19
