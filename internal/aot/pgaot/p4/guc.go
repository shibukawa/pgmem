...
func F_GUC_yyensure_buffer_stack(m *base.Module, l0 int32) {
	...
	if v4 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
		if v8 == int32(0) {
			F_GUC_flex_fatal(m, int32(658640))
			mBase = m.M
			v46 = m.ExcPending
			if v46 != 0 {
				return
...
L84:
	;
	F_errfinish(m, int32(491191), int32(6444), int32(25949))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L6
...
func F_build_guc_variables(m *base.Module) {
	...
	v17 = F_AllocSetContextCreateInternal(m, v12, int32(61224), v1, int32(8192), int32(8388608))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L29:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+32)) = int64(34359738372)
	...
	v157 = F_hash_create(m, int32(387318), v152+v136, v6+int32(-48), int32(1224))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(491191), int32(647), int32(480555))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L19
