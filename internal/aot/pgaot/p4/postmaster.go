...
func F_PostmasterIsAliveInternal(m *base.Module) int32 {
	...
	v5 = v3 - int32(16)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_PostmasterIsAliveInternal[0]))
	v12 = F_read(m, v8, v5+int32(15), int32(1))
	mBase = m.M
	if v12 < int32(0) {
		v16 = *(*int32)(unsafe.Add(mBase, _c_F_PostmasterIsAliveInternal[1]))
		if v16 == int32(6) {
			m.G0 = v5 + int32(16)
			...
			if v24 != 0 {
				...
				F_errmsg_internal(m, int32(_a_F_PostmasterIsAliveInternal_0), int32(0))
				mBase = m.M
				v28 = m.ExcPending
				if v28 != 0 {
					return int32(0)
		...
		if v12 == int32(0) {
			...
			if v39 != 0 {
				...
				F_errmsg_internal(m, int32(_a_F_PostmasterIsAliveInternal_3), int32(0))
				mBase = m.M
				v43 = m.ExcPending
				if v43 != 0 {
					return int32(0)
