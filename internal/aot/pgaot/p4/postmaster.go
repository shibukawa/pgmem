	...
	if v12 < int32(0) {
		...
		if v16 == int32(6) {
			...
			if v24 != 0 {
				...
				F_errmsg_internal(m, int32(308509), int32(0))
				mBase = m.M
				v28 = m.ExcPending
				if v28 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(520377), int32(382), int32(326691))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return int32(0)
		...
		if v12 == int32(0) {
			...
			if v39 != 0 {
				...
				F_errmsg_internal(m, int32(388737), int32(0))
				mBase = m.M
				v43 = m.ExcPending
				if v43 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(520377), int32(384), int32(326691))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
