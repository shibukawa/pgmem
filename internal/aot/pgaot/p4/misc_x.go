				...
				if v57 != 0 {
					...
					if v56 == int32(0) {
						...
						if v62 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = int32(555540)
							*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v7
							...
							if v70 != 0 {
								...
								F_errsave_finish(m, v8, int32(493623), int32(1010), int32(229151))
								mBase = m.M
								v75 = m.ExcPending
								if v75 != 0 {
									return int32(0)
					...
					if v93 != 0 {
						...
						if v92 == int32(0) {
							...
							if v98 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = int32(555540)
								...
								if v106 != 0 {
									...
									F_errsave_finish(m, v8, int32(493623), int32(1026), int32(229151))
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return int32(0)
			...
			if v36 != 0 {
				...
				if v33 == int32(0) {
					...
					if v41 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(555540)
						...
						if v47 != 0 {
							...
							F_errsave_finish(m, v8, int32(493623), int32(1004), int32(229151))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
...
func F_xmlparse(m *base.Module) int32 {
	...
	if v6 != 0 {
		...
		if v9 != 0 {
			...
			F_errmsg(m, int32(362890), int32(0))
			v13 = m.ExcPending
			if v13 != 0 {
				return int32(0)
			} else {
				F_errdetail(m, int32(578475), int32(0))
				v17 = m.ExcPending
				if v17 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(497070), int32(1004), int32(360605))
					v22 = m.ExcPending
					if v22 != 0 {
						return int32(0)
					} else {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(497070), int32(542), int32(62562))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(497070), int32(4579), int32(115561))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
