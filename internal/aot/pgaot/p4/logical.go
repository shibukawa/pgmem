		...
		if int32(1) < v4 {
			...
			if v8 == int32(0) {
				...
				if v48 != 0 {
					...
					if v51 != 0 {
						...
						F_errmsg(m, int32(267647), int32(0))
						mBase = m.M
						v55 = m.ExcPending
						if v55 != 0 {
							return
						} else {
							F_errfinish(m, int32(521140), int32(128), int32(130752))
							mBase = m.M
							v60 = m.ExcPending
							if v60 != 0 {
								return
						...
						if v64 != 0 {
							...
							if v67 != 0 {
								...
								if v71 != 0 {
									...
									F_errfinish(m, int32(521140), int32(143), int32(130752))
									mBase = m.M
									v76 = m.ExcPending
									if v76 != 0 {
										return
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					F_errmsg(m, int32(761606), int32(0))
					mBase = m.M
					v39 = m.ExcPending
					if v39 != 0 {
						return
					} else {
						F_errfinish(m, int32(521140), int32(123), int32(130752))
						mBase = m.M
						v44 = m.ExcPending
						if v44 != 0 {
							return
...
L9:
	;
	F_errfinish(m, int32(519128), int32(820), int32(165616))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L4
...
L41:
	;
	F_errfinish(m, int32(519128), int32(886), int32(165616))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L4
