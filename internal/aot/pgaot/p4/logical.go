		...
		if int32(1) < v4 {
			...
			if v8 == int32(0) {
				...
				if v48 != 0 {
					...
					if v51 != 0 {
						...
						F_errmsg(m, int32(255911), int32(0))
						mBase = m.M
						v55 = m.ExcPending
						if v55 != 0 {
							return
						} else {
							F_errfinish(m, int32(498761), int32(128), int32(123335))
							mBase = m.M
							v60 = m.ExcPending
							if v60 != 0 {
								return
						...
						if v64 != 0 {
							...
							if v67 != 0 {
								...
								if v71 != 0 {
									...
									F_errfinish(m, int32(498761), int32(143), int32(123335))
									mBase = m.M
									v76 = m.ExcPending
									if v76 != 0 {
										return
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					F_errmsg(m, int32(730248), int32(0))
					mBase = m.M
					v39 = m.ExcPending
					if v39 != 0 {
						return
					} else {
						F_errfinish(m, int32(498761), int32(123), int32(123335))
						mBase = m.M
						v44 = m.ExcPending
						if v44 != 0 {
							return
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v24
	F_errmsg_internal(m, int32(168052), v15+int32(16))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L4
...
L9:
	;
	F_errfinish(m, int32(497182), int32(820), int32(156571))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L4
...
L41:
	;
	F_errfinish(m, int32(497182), int32(886), int32(156571))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L4
