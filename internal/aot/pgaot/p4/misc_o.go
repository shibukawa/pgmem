...
L7:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[941]))
	v21 = *(*int32)(unsafe.Add(mBase, _consts[263]))
	v23 = *(*int32)(unsafe.Add(mBase, _consts[942]))
	if v21+(v23+v15) < v19 {
		goto L6
	} else {
		goto L8
...
L9:
	;
	v33 = *(*int32)(unsafe.Add(mBase, _consts[943]))
...
L12:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[941]))
	v44 = *(*int32)(unsafe.Add(mBase, _consts[263]))
	v46 = *(*int32)(unsafe.Add(mBase, _consts[942]))
	if v42 <= v44+(v46+v38) {
		goto L9
	} else {
		goto L13
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _consts[646])) = v64
	v78 = int32(4729)
	goto L19
L22:
	;
...
L28:
	;
	v101 = F___memcpy(m, int32(4610588), v90, int32(140))
	mBase = m.M
	goto L30
L29:
	;
...
L34:
	;
	*(*int32)(unsafe.Add(mBase, _consts[646])) = v113
	v127 = int32(4729)
	goto L33
L36:
	;
...
L42:
	;
	v150 = F___memcpy(m, int32(4610588), v139, int32(140))
	mBase = m.M
	goto L44
L43:
	;
...
L45:
	;
	v157 = *(*int32)(unsafe.Add(mBase, _consts[944]))
	v159 = *(*int32)(unsafe.Add(mBase, _consts[942]))
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v162)+4)) = v168
	v170 = int32(4359880)
	v172 = *(*int32)(unsafe.Add(mBase, _consts[942]))
	*(*int32)(unsafe.Add(mBase, _consts[942])) = v172 + int32(1)
...
L53:
	;
	v197 = *(*int32)(unsafe.Add(mBase, _consts[940]))
	if int32(0) < v197 {
		goto L57
	} else {
		goto L58
...
L55:
	;
	F_errfinish(m, int32(478009), int32(2793), int32(278665))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L1
...
L57:
	;
	v201 = *(*int32)(unsafe.Add(mBase, _consts[943]))
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = l0
	v222 = *(*int32)(unsafe.Add(mBase, _consts[945]))
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v222
	F_errmsg(m, int32(682520), v8)
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L1
...
L63:
	;
	F_errfinish(m, int32(478009), int32(2765), int32(278665))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
...
func F_OpenTemporaryFileInTablespace(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v13 == int32(0) {
		*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = int32(224323)
		v24 = F_pg_snprintf(m, v6+int32(1088), int32(1024), int32(167550), v6+int32(48))
		mBase = m.M
		v27 = m.ExcPending
		if v27 != 0 {
			return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, _consts[939])) = v45 + int32(1)
			*(*int32)(unsafe.Add(mBase, uint32(v6)+20)) = int32(224323)
			v52 = *(*int32)(unsafe.Add(mBase, _consts[702]))
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v6 + int32(1088)
			v64 = F_pg_snprintf(m, v6-int32(-64), int32(1024), int32(412965), v6+int32(16))
			mBase = m.M
			v65 = m.ExcPending
			if v65 != 0 {
				return int32(0)
			} else {
				v70 = *(*int32)(unsafe.Add(mBase, _consts[937]))
				...
				if v72 != 0 {
					...
					if int32(0) < v71 {
						...
						v78 = *(*int32)(unsafe.Add(mBase, _consts[798]))
						v79 = F_mkdir(m, v6+int32(1088), v78)
						mBase = m.M
						v84 = *(*int32)(unsafe.Add(mBase, _consts[937]))
								...
								if int32(0) < v85 {
									...
									if v94 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v6))) = v6 - int32(-64)
										F_errmsg_internal(m, int32(284176), v6)
										mBase = m.M
										v100 = m.ExcPending
										if v100 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(478009), int32(1850), int32(400692))
											mBase = m.M
											v105 = m.ExcPending
											if v105 != 0 {
												return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6)+44)) = int32(224323)
		*(*int32)(unsafe.Add(mBase, uint32(v6)+40)) = int32(530717)
		*(*int32)(unsafe.Add(mBase, uint32(v6)+36)) = l0
		*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = int32(467736)
		v41 = F_pg_snprintf(m, v6+int32(1088), int32(1024), int32(167446), v6+int32(32))
		mBase = m.M
		v42 = m.ExcPending
		if v42 != 0 {
			return int32(0)
...
func F_oauth_init(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	m.G0 = v7
	v9 = int32(503323)
	v12 = int32(*(*uint8)(unsafe.Add(mBase, _consts[503])))
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v38)+12)) = v49
	...
	v56 = F_load_external_function(m, v52, int32(94406), v43, v43)
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L15
...
L19:
	;
	*(*int32)(unsafe.Add(mBase, _consts[504])) = v61
...
L22:
	;
	*(*int32)(unsafe.Add(mBase, _consts[505])) = v72
	*(*int32)(unsafe.Add(mBase, uint32(v72))) = int32(180003)
	v78 = *(*int32)(unsafe.Add(mBase, _consts[504]))
...
L31:
	;
	F_errfinish(m, int32(476121), int32(109), int32(94384))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L15
...
L33:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = int32(94406)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v52
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(199802)
	F_errmsg(m, int32(175982), v7)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L15
...
L34:
	;
	F_errfinish(m, int32(476121), int32(761), int32(16328))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L15
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = int32(199802)
	F_errmsg(m, int32(309710), v5+int32(-16))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L15
...
L37:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _consts[504]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+36)) = v145
	F_errdetail(m, int32(616734), v5+int32(-32))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L15
...
L38:
	;
	F_errfinish(m, int32(476121), int32(776), int32(16328))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L15
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+24)) = int32(481651)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = v52
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(199802)
	F_errmsg(m, int32(304707), v5+int32(-48))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L15
...
L41:
	;
	F_errfinish(m, int32(476121), int32(785), int32(16328))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L15
