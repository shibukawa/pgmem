...
L59:
	...
	if base.F32_eq(v262, math.Float32frombits(uint32(0x7f800000))) != 0 {
		v341 = v258 & int32(_a_F_halfvec_mul_0)
		goto L102
	} else {
		goto L103
	}
...
L103:
	;
	v266 = v256 & int32(_a_F_halfvec_mul_1)
	if base.Ui32(int32(2139095041)) <= base.Ui32(base.I32_reinterpret_f32(v262)) {
		v341 = v258&int32(_a_F_halfvec_mul_2) | int32(base.Ui32(v266)>>(uint(int32(13))%32)) | int32(_a_F_halfvec_mul_3)
		goto L102
	} else {
		goto L104
	}
L104:
	;
	v278 = v258 & int32(_a_F_halfvec_mul_2)
...
L117:
	...
	v322 = v321 + v282
	if int32(16) <= v322 {
		v341 = v278 | int32(_a_F_halfvec_mul_4)
		goto L102
	} else {
		goto L118
	}
...
L119:
	;
	v332 = v322<<(uint(int32(10))%32) + int32(_a_F_halfvec_mul_5) | v278
	goto L121
L120:
	;
	v332 = v278
...
L131:
	...
	v388 = v386 & int32(_a_F_halfvec_mul_9)
	if v388 != 0 {
		goto L134
	} else {
		goto L135
...
L134:
	;
	if v388 != int32(_a_F_halfvec_mul_4) {
		goto L133
	} else {
		goto L137
	}
...
L136:
	...
	if v394&int32(_a_F_halfvec_mul_9) == int32(0) {
		goto L133
	} else {
		goto L139
	}
...
L139:
	...
	if v400&int32(_a_F_halfvec_mul_9) != 0 {
		goto L4
	} else {
		goto L140
	}
...
L58:
	...
	v262 = base.F32_abs(v255)
	if base.F32_eq(v262, math.Float32frombits(uint32(0x7f800000))) != 0 {
		v341 = v258 & int32(_a_F_halfvec_sub_0)
		goto L101
	} else {
		goto L102
	}
...
L102:
	;
	v266 = v256 & int32(_a_F_halfvec_sub_1)
	if base.Ui32(int32(2139095041)) <= base.Ui32(base.I32_reinterpret_f32(v262)) {
		v341 = v258&int32(_a_F_halfvec_sub_2) | int32(base.Ui32(v266)>>(uint(int32(13))%32)) | int32(_a_F_halfvec_sub_3)
		goto L101
	} else {
		goto L103
	}
L103:
	;
	v278 = v258 & int32(_a_F_halfvec_sub_2)
	v282 = int32(base.Ui32(v256)>>(uint(int32(23))%32)) & int32(255)
	if base.Ui32(v282) < base.Ui32(int32(99)) {
		v341 = v278
		goto L101
...
L116:
	...
	v322 = v321 + v282
	if int32(16) <= v322 {
		v341 = v278 | int32(_a_F_halfvec_sub_4)
		goto L101
	} else {
		goto L117
	}
...
L118:
	;
	v332 = v322<<(uint(int32(10))%32) + int32(_a_F_halfvec_sub_5) | v278
	goto L120
L119:
	;
	v332 = v278
...
L130:
	...
	if v386&int32(_a_F_halfvec_sub_9) != int32(_a_F_halfvec_sub_4) {
		goto L132
	} else {
		goto L133
	}
