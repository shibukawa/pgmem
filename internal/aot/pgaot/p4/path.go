						...
						if v38 == int32(0) {
							...
							if v45 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
								F_errmsg(m, int32(303720), v9)
								mBase = m.M
								v49 = m.ExcPending
								if v49 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(512015), int32(1966), int32(398212))
									mBase = m.M
									v54 = m.ExcPending
									if v54 != 0 {
										return int32(0)
						...
						if v60 == int32(0) {
							...
							if v65 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l0
								F_errmsg(m, int32(303915), v9+int32(32))
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(512015), int32(1977), int32(398212))
									mBase = m.M
									v76 = m.ExcPending
									if v76 != 0 {
										return int32(0)
								...
								if v93 != 0 {
									...
									if v92 == int32(0) {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
										F_errmsg(m, int32(39306), v9+int32(16))
										mBase = m.M
										v102 = m.ExcPending
										if v102 != 0 {
											return int32(0)
