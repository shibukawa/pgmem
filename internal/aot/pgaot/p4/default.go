...
L37:
	;
	F_errfinish(m, int32(477490), int32(2421), int32(124071))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L1
...
L5:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(407524)
	v22 = F_format_elog_string(m, int32(537255), v7)
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L6
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(407524)
	v99 = F_format_elog_string(m, int32(626255), v5+int32(-48))
	mBase = m.M
	v100 = m.ExcPending
	if v100 != 0 {
		goto L6
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v129
	F_errmsg(m, int32(70499), v5+int32(-32))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L6
...
L41:
	;
	F_errfinish(m, int32(480861), int32(137), int32(407518))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L6
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = v146
	v152 = F_format_elog_string(m, int32(544758), v5+int32(-16))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L6
