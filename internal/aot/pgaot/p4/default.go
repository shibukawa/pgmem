...
L37:
	;
	F_errfinish(m, int32(486667), int32(2421), int32(128813))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L1
...
L5:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(416093)
	v22 = F_format_elog_string(m, int32(547282), v7)
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L6
...
L25:
	;
	v88 = *(*int32)(unsafe.Add(mBase, _consts[140]))
	*(*int32)(unsafe.Add(mBase, _consts[141])) = v88
	goto L28
L26:
	;
	goto L27
L27:
	;
	v102 = int32(1)
	v104 = *(*int32)(unsafe.Add(mBase, _consts[25]))
	v105 = *(*int32)(unsafe.Add(mBase, uint32(v104)+20))
	goto L30
L28:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = int32(63)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(416093)
	v99 = F_format_elog_string(m, int32(637039), v5+int32(-48))
	mBase = m.M
	v100 = m.ExcPending
	if v100 != 0 {
		goto L6
...
L29:
	;
	*(*int32)(unsafe.Add(mBase, _consts[142])) = v99
	v155 = int32(0)
	goto L1
L30:
	;
...
L31:
	;
	v111 = *(*int32)(unsafe.Add(mBase, _consts[100]))
	if v111 == int32(0) {
		v155 = v102
		goto L1
	} else {
...
L37:
	;
	v143 = *(*int32)(unsafe.Add(mBase, _consts[140]))
	*(*int32)(unsafe.Add(mBase, _consts[141])) = v143
	goto L43
L38:
	;
	if v122 == int32(0) {
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v129
	F_errmsg(m, int32(71828), v5+int32(-32))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L6
...
L41:
	;
	F_errfinish(m, int32(490068), int32(137), int32(416087))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L6
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = v146
	v152 = F_format_elog_string(m, int32(554785), v5+int32(-16))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L6
...
L44:
	;
	*(*int32)(unsafe.Add(mBase, _consts[142])) = v152
	v155 = int32(0)
	goto L1
}
