...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = l2
	v245 = F_pg_snprintf(m, v17+int32(192), int32(64), int32(466977), v17)
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L1
...
func F_RelationCacheInitFilePreInvalidate(m *base.Module) {
	...
	if v8 != 0 {
		*(*int32)(unsafe.Add(mBase, uint32(v5)+20)) = int32(100679)
		*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v8
		v18 = F_pg_snprintf(m, v5+int32(1056), int32(1024), int32(177487), v5+int32(16))
		mBase = m.M
		v19 = m.ExcPending
		if v19 != 0 {
			return
		} else {
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(100679)
			v26 = F_pg_snprintf(m, v5+int32(32), int32(1024), int32(177518), v5)
			mBase = m.M
			v27 = m.ExcPending
			if v27 != 0 {
				return
...
func F_RelationClose(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v5
	...
	if v8 != 0 {
		...
		F_ResourceOwnerForget(m, v10, l0, int32(1743296))
		mBase = m.M
		v13 = m.ExcPending
		if v13 != 0 {
			return
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = l1
	F_errmsg_internal(m, int32(53579), v22)
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L11
...
L17:
	;
	F_errfinish(m, int32(500431), int32(5333), int32(238726))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L11
...
L42:
	;
	v169 = F__emscripten_memcpy_bulkmem(m, v160+(v139+v161<<(uint(int32(4))%32)), v160+int32(1761376), v159)
	mBase = m.M
	goto L44
L44:
	;
...
L65:
	;
	v276 = F__emscripten_memcpy_bulkmem(m, v267+(v246+v268<<(uint(int32(4))%32)), v267+int32(1761376), v266)
	mBase = m.M
	goto L67
L67:
	;
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = l1
	F_errmsg_internal(m, int32(53579), v22+int32(16))
	mBase = m.M
	v567 = m.ExcPending
	if v567 != 0 {
		goto L11
...
L136:
	;
	F_errfinish(m, int32(500431), int32(5555), int32(238726))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L11
...
L16:
	...
	v72 = F_AllocSetContextCreateInternal(m, v67, int32(242577), v65, int32(1024), int32(8192))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L6
...
L44:
	;
	v176 = F__emscripten_memcpy_bulkmem(m, v167+(v140+int32(20)+v168<<(uint(int32(4))%32)), v167+int32(1761376), v166)
	mBase = m.M
	goto L46
L46:
	;
...
L61:
	;
	v267 = F__emscripten_memcpy_bulkmem(m, v258+(v232+int32(20)+v259<<(uint(int32(4))%32)), v258+int32(1761376), v257)
	mBase = m.M
	goto L63
L63:
	;
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+284)) = v341
	v346 = *(*int32)(unsafe.Add(mBase, _consts[1381]))
	if v346 == int32(0) {
		goto L73
	} else {
		goto L74
...
L78:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v22)+96)) = int64(85899345924)
	v363 = F_hash_create(m, int32(400147), int32(64), v22+int32(80), int32(40))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L6
...
L80:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1381])) = v363
	v366 = v363
	goto L75
L81:
	;
...
L88:
	...
	v402 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1367])))
	if v402 == int32(0) {
		goto L92
	} else {
		goto L93
...
L135:
	;
	v642 = F__emscripten_memcpy_bulkmem(m, v633+(v606+int32(20)+v634<<(uint(int32(4))%32)), v633+int32(1761376), v632)
	mBase = m.M
	goto L137
L137:
	;
...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v703
	F_errmsg_internal(m, int32(40367), v22)
	mBase = m.M
	v707 = m.ExcPending
	if v707 != 0 {
		goto L6
...
L147:
	;
	F_errfinish(m, int32(500431), int32(1471), int32(242844))
	mBase = m.M
	v712 = m.ExcPending
	if v712 != 0 {
		goto L6
...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v718
	F_errmsg_internal(m, int32(53482), v22+int32(16))
	mBase = m.M
	v724 = m.ExcPending
	if v724 != 0 {
		goto L6
...
L150:
	;
	F_errfinish(m, int32(500431), int32(1485), int32(242844))
	mBase = m.M
	v729 = m.ExcPending
	if v729 != 0 {
		goto L6
...
L152:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v734
	F_errmsg_internal(m, int32(40278), v22-int32(-64))
	mBase = m.M
	v740 = m.ExcPending
	if v740 != 0 {
		goto L6
...
L153:
	;
	F_errfinish(m, int32(500431), int32(1493), int32(242844))
	mBase = m.M
	v745 = m.ExcPending
	if v745 != 0 {
		goto L6
...
L155:
	;
	F_errmsg_internal(m, int32(384797), int32(0))
	mBase = m.M
	v753 = m.ExcPending
	if v753 != 0 {
		goto L6
...
L156:
	;
	F_errfinish(m, int32(500431), int32(1630), int32(342492))
	mBase = m.M
	v758 = m.ExcPending
	if v758 != 0 {
		goto L6
...
L158:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+32)) = v763
	F_errmsg_internal(m, int32(42494), v22+int32(32))
	mBase = m.M
	v769 = m.ExcPending
	if v769 != 0 {
		goto L6
...
L159:
	;
	F_errfinish(m, int32(500431), int32(1766), int32(242872))
	mBase = m.M
	v774 = m.ExcPending
	if v774 != 0 {
		goto L6
...
L161:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+52)) = v782
	F_errmsg_internal(m, int32(42565), v22+int32(48))
	mBase = m.M
	v788 = m.ExcPending
	if v788 != 0 {
		goto L6
...
L162:
	;
	F_errfinish(m, int32(500431), int32(1800), int32(242872))
	mBase = m.M
	v793 = m.ExcPending
	if v793 != 0 {
		goto L6
...
L5:
	;
	v55 = int32(0)
	v57 = *(*int32)(unsafe.Add(mBase, _consts[1261]))
	if v55 < v57 {
		goto L24
	} else {
		goto L25
...
L8:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _consts[1262]))
	if v35 <= int32(0) {
		v113 = v3
		goto L1
	} else {
...
L9:
	...
	v22 = *(*int32)(unsafe.Add(mBase, uint32(v19)+uint32(_consts[1390])))
	if v22 == l0 {
		goto L11
	} else {
		goto L12
...
L16:
	...
	v48 = *(*int32)(unsafe.Add(mBase, uint32(v45)+uint32(_consts[1391])))
	if v48 != l0 {
		goto L18
	} else {
		goto L19
...
L26:
	;
	v80 = *(*int32)(unsafe.Add(mBase, _consts[1263]))
	if v80 <= int32(0) {
		v113 = v3
		goto L1
	} else {
...
L27:
	...
	v69 = *(*int32)(unsafe.Add(mBase, uint32(v66)+uint32(_consts[1392])))
	if l0 == v69 {
		goto L23
	} else {
		goto L29
...
L32:
	...
	v95 = *(*int32)(unsafe.Add(mBase, uint32(v92)+uint32(_consts[1393])))
	if v95 != l0 {
		goto L34
	} else {
		goto L35
...
L6:
	;
	v37 = *(*int32)(unsafe.Add(mBase, _consts[1261]))
	if int32(0) < v37 {
		goto L15
	} else {
		goto L16
...
L9:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[1262]))
	if v32 <= int32(0) {
		v102 = v3
		goto L1
	} else {
...
L17:
	;
	v60 = *(*int32)(unsafe.Add(mBase, _consts[1263]))
	if v60 <= int32(0) {
		v102 = v3
		goto L1
	} else {
...
L18:
	...
	v49 = *(*int32)(unsafe.Add(mBase, uint32(v46)+uint32(_consts[1264])))
	if l0 == v49 {
		v93 = v46 + int32(4508552)
		goto L2
	} else {
		goto L20
	}
...
L23:
	...
	v73 = *(*int32)(unsafe.Add(mBase, uint32(v70)+uint32(_consts[1265])))
	if l0 == v73 {
		v93 = v70 + int32(4509076)
		goto L2
	} else {
		goto L25
	}
...
L27:
	...
	v87 = *(*int32)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1266])))
	if l0 == v87 {
		v93 = v84 + int32(4510124)
		goto L2
	} else {
		goto L29
	}
...
L24:
	;
	v131 = F__emscripten_memcpy_bulkmem(m, v122+(v97+int32(20)+v123<<(uint(int32(4))%32)), v122+int32(1761376), v121)
	mBase = m.M
	goto L26
L26:
	;
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v55))) = v58
	F_errmsg_internal(m, int32(40400), v55)
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L2
...
L66:
	;
	F_errfinish(m, int32(493606), int32(2499), int32(242615))
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L2
				...
				if v86 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = v13
					...
					if v90 != 0 {
						...
						F_errfinish(m, int32(495648), int32(3767), int32(420551))
						mBase = m.M
						v95 = m.ExcPending
						if v95 != 0 {
							return
...
L39:
	;
	F_errfinish(m, int32(495103), int32(13165), int32(379832))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L3
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v175
	F_appendStringInfo(m, v14+int32(32), int32(608027), v14+int32(16))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L3
				...
				if v19 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
					...
					if v23 != 0 {
						...
						F_errfinish(m, int32(494870), int32(4115), int32(247477))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return
				...
				if v59 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
					...
					if v63 != 0 {
						...
						F_errfinish(m, int32(494870), int32(6109), int32(10820))
						mBase = m.M
						v68 = m.ExcPending
						if v68 != 0 {
							return
											...
											if v64 != 0 {
												...
												if v66 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v11))) = l1
													F_errmsg(m, int32(72708), v11)
													mBase = m.M
													v71 = m.ExcPending
													if v71 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(494200), int32(1235), int32(434833))
														mBase = m.M
														v76 = m.ExcPending
														if v76 != 0 {
															return int32(0)
...
L7:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[643]))
	switch v67 {
	case 0:
		v385 = int32(0)
		goto L4
...
func F_relation_statistics_update(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+24)) = v2
	F_stats_check_required_arg(m, l0, int32(4126512), v2)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		return int32(0)
	} else {
		F_stats_check_required_arg(m, l0, int32(4126512), int32(1))
		mBase = m.M
		v42 = m.ExcPending
		if v42 != 0 {
			return int32(0)
											...
											if v128 == int32(0) {
												...
												if v254 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v19))) = v72
													F_errmsg_internal(m, int32(424809), v19)
													mBase = m.M
													v258 = m.ExcPending
													if v258 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(494806), int32(144), int32(356760))
														mBase = m.M
														v263 = m.ExcPending
														if v263 != 0 {
															return int32(0)
										...
										if v91 != 0 {
											...
											if v90 != 0 {
												...
												if v94 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = int32(164774)
													F_errmsg(m, int32(570888), v17+int32(-48))
													mBase = m.M
													v101 = m.ExcPending
													if v101 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(494806), int32(117), int32(356760))
														mBase = m.M
														v106 = m.ExcPending
														if v106 != 0 {
															return int32(0)
							...
							if v237 != 0 {
								...
								if v241 != 0 {
									...
									if v245 != 0 {
										...
										F_errfinish(m, int32(494806), int32(98), int32(356760))
										mBase = m.M
										v250 = m.ExcPending
										if v250 != 0 {
											return int32(0)
