...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+592)) = v3753 + v3750
	v3760 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_0), v15+int32(592))
	mBase = m.M
	v3761 = m.ExcPending
	if v3761 != 0 {
		goto L1
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+416)) = (v2923 ^ int32(-1)) << (uint(v2925) % 32) & int32(2)
	v2942 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(416))
	mBase = m.M
	v2943 = m.ExcPending
	if v2943 != 0 {
		goto L1
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+368)) = (v2845 ^ int32(-1)) << (uint(int32(1)) % 32) & int32(2)
	v2858 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(368))
	mBase = m.M
	v2859 = m.ExcPending
	if v2859 != 0 {
		goto L1
...
L286:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+192)) = base.I32_extend16_s(v696)
	v702 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_8), v15+int32(192))
	mBase = m.M
	v703 = m.ExcPending
	if v703 != 0 {
		goto L1
...
L291:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+232)) = v724
	v729 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_21), v15+int32(224))
	mBase = m.M
	v730 = m.ExcPending
	if v730 != 0 {
		goto L1
...
L293:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+208)) = base.I32_extend16_s(v744)
	v750 = F_pg_sprintf(m, v732, int32(_a_F_DCH_to_char_22), v15+int32(208))
	mBase = m.M
	v751 = m.ExcPending
	if v751 != 0 {
		goto L1
...
L296:
	;
	v757 = int32(_a_F_DCH_to_char_23)
	goto L298
L297:
	;
	v757 = int32(_a_F_DCH_to_char_24)
	goto L298
L298:
	;
...
L300:
	;
	v767 = int32(_a_F_DCH_to_char_25)
	goto L302
L301:
	;
	v767 = int32(_a_F_DCH_to_char_26)
	goto L302
L302:
	;
...
L304:
	;
	v777 = int32(_a_F_DCH_to_char_27)
	goto L306
L305:
	;
	v777 = int32(_a_F_DCH_to_char_28)
	goto L306
L306:
	;
...
L308:
	;
	v787 = int32(_a_F_DCH_to_char_29)
	goto L310
L309:
	;
	v787 = int32(_a_F_DCH_to_char_30)
	goto L310
L310:
	;
...
L313:
	;
	v802 = *(*int32)(unsafe.Add(mBase, uint32(v792<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[0])))
...
L348:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+240)) = v909
	v973 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_34), v15+int32(240))
	mBase = m.M
	v974 = m.ExcPending
	if v974 != 0 {
		goto L1
...
L349:
	;
	v920 = *(*int32)(unsafe.Add(mBase, uint32(v911<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[1])))
...
L362:
	;
	v985 = *(*int32)(unsafe.Add(mBase, uint32(v975<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[0])))
...
L396:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+256)) = v1091
	v1097 = *(*int32)(unsafe.Add(mBase, uint32(v975<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[2])))
	*(*int32)(unsafe.Add(mBase, uint32(v15)+260)) = v1097
	v1102 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_34), v15+int32(256))
	mBase = m.M
	v1103 = m.ExcPending
	if v1103 != 0 {
		goto L1
...
L400:
	;
	v1114 = *(*int32)(unsafe.Add(mBase, uint32(v1104<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[0])))
...
L435:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+272)) = v1221
	v1283 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_34), v15+int32(272))
	mBase = m.M
	v1284 = m.ExcPending
	if v1284 != 0 {
		goto L1
...
L436:
	;
	v1232 = *(*int32)(unsafe.Add(mBase, uint32(v1223<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[1])))
...
L450:
	;
	v1297 = *(*int32)(unsafe.Add(mBase, uint32(v1289<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[3])))
...
L452:
	;
	v1329 = *(*int32)(unsafe.Add(mBase, uint32(v1289<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[4])))
...
L492:
	;
	v1463 = *(*int32)(unsafe.Add(mBase, uint32(v1455<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[3])))
...
L494:
	;
	v1495 = *(*int32)(unsafe.Add(mBase, uint32(v1455<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[4])))
	v1496 = v1495
	goto L491
L495:
	;
...
L525:
	;
	v1583 = *(*int32)(unsafe.Add(mBase, uint32(v1575<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[3])))
...
L527:
	;
	v1615 = *(*int32)(unsafe.Add(mBase, uint32(v1575<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[4])))
...
L566:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+288)) = v1747
	v1754 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(288))
	mBase = m.M
	v1755 = m.ExcPending
	if v1755 != 0 {
		goto L1
...
L578:
	...
	v1779 = *(*int32)(unsafe.Add(mBase, uint32(v1774<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[5])))
...
L612:
	...
	v1892 = *(*int32)(unsafe.Add(mBase, uint32(v1887<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[6])))
	if v1892 == int32(0) {
		v1938 = v1881
		goto L613
	} else {
...
L613:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+304)) = v1886
	v1947 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_34), v15+int32(304))
	mBase = m.M
	v1948 = m.ExcPending
	if v1948 != 0 {
		goto L1
...
L626:
	...
	v1957 = *(*int32)(unsafe.Add(mBase, uint32(v1952<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[5])))
...
L660:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+320)) = v2064
	v2070 = *(*int32)(unsafe.Add(mBase, uint32(v2059<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[6])))
	*(*int32)(unsafe.Add(mBase, uint32(v15)+324)) = v2070
	v2075 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_34), v15+int32(320))
	mBase = m.M
	v2076 = m.ExcPending
	if v2076 != 0 {
		goto L1
...
L663:
	...
	v2085 = *(*int32)(unsafe.Add(mBase, uint32(v2080<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[5])))
...
L697:
	...
	v2198 = *(*int32)(unsafe.Add(mBase, uint32(v2193<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[6])))
	if v2198 == int32(0) {
		v2242 = v2187
		goto L698
	} else {
...
L698:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+336)) = v2192
	v2251 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_34), v15+int32(336))
	mBase = m.M
	v2252 = m.ExcPending
	if v2252 != 0 {
		goto L1
...
L712:
	;
	v2261 = *(*int32)(unsafe.Add(mBase, uint32(v2253<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[7])))
...
L714:
	;
	v2293 = *(*int32)(unsafe.Add(mBase, uint32(v2253<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[8])))
...
L753:
	;
	v2423 = *(*int32)(unsafe.Add(mBase, uint32(v2415<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[7])))
...
L755:
	;
	v2455 = *(*int32)(unsafe.Add(mBase, uint32(v2415<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[8])))
	v2456 = v2455
	goto L752
L756:
	;
...
L785:
	;
	v2539 = *(*int32)(unsafe.Add(mBase, uint32(v2531<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[7])))
...
L787:
	;
	v2571 = *(*int32)(unsafe.Add(mBase, uint32(v2531<<(uint(int32(2))%32))+uint32(_c_F_DCH_to_char[8])))
...
L827:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+352)) = v2696
	v2828 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(352))
	mBase = m.M
	v2829 = m.ExcPending
	if v2829 != 0 {
		goto L1
...
L832:
	;
	v2708 = int32(_a_F_DCH_to_char_35)
	goto L834
L833:
	;
	v2708 = int32(_a_F_DCH_to_char_36)
	goto L834
L834:
	;
	v2709 = v2708 + v2700
...
L837:
	;
	v2729 = base.I32_div_s((v2724+v2701)*int32(_a_F_DCH_to_char_37), int32(256))
	goto L831
L838:
	;
	goto L850
...
L851:
	;
	v2780 = int32(_a_F_DCH_to_char_36) + v2771
...
L854:
	;
	v2800 = base.I32_div_s(int32(_a_F_DCH_to_char_38), int32(256))
	v2803 = int32(4) + v2780*int32(365) + v2785 + v2788 + v2791 + v2800 - int32(_a_F_DCH_to_char_39)
	goto L848
L855:
	;
	v2822 = v2702 + v2709*int32(365) + v2714 + v2717 + v2720 + v2729 - int32(_a_F_DCH_to_char_39) - v2803 + v2815 + int32(1)
	goto L827
L856:
	;
	v2815 = v2810 + v2809
...
L873:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+384)) = v2875 + int32(1)
	v2882 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_0), v15+int32(384))
	mBase = m.M
	v2883 = m.ExcPending
	if v2883 != 0 {
		goto L1
...
L884:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+400)) = v2901
	v2906 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_0), v15+int32(400))
	mBase = m.M
	v2907 = m.ExcPending
	if v2907 != 0 {
		goto L1
...
L899:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+432)) = (v2959 ^ int32(-1)) << (uint(int32(1)) % 32) & int32(2)
	v3016 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(432))
	mBase = m.M
	v3017 = m.ExcPending
	if v3017 != 0 {
		goto L1
...
L916:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+448)) = v3039 + v3036
	v3046 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_0), v15+int32(448))
	mBase = m.M
	v3047 = m.ExcPending
	if v3047 != 0 {
		goto L1
...
L930:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+480)) = v3080
	v3106 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_0), v15+int32(480))
	mBase = m.M
	v3107 = m.ExcPending
	if v3107 != 0 {
		goto L1
...
L936:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+464)) = v3095
	v3100 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(464))
	mBase = m.M
	v3101 = m.ExcPending
	if v3101 != 0 {
		goto L1
...
L950:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+500)) = v3132*int32(-1000) + v3130
	v3141 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_40), v15+int32(496))
	mBase = m.M
	v3142 = m.ExcPending
	if v3142 != 0 {
		goto L1
...
L970:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+512)) = v3177
	v3281 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(512))
	mBase = m.M
	v3282 = m.ExcPending
	if v3282 != 0 {
		goto L1
...
L1021:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+532)) = v3418
	v3423 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(528))
	mBase = m.M
	v3424 = m.ExcPending
	if v3424 != 0 {
		goto L1
...
L1072:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+548)) = v3560
	v3565 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_1), v15+int32(544))
	mBase = m.M
	v3566 = m.ExcPending
	if v3566 != 0 {
		goto L1
...
L1111:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+560)) = v3681
	v3686 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_41), v15+int32(560))
	mBase = m.M
	v3687 = m.ExcPending
	if v3687 != 0 {
		goto L1
...
L1155:
	;
	v3713 = int32(_a_F_DCH_to_char_42)
	goto L1157
L1156:
	;
	v3713 = int32(_a_F_DCH_to_char_43)
	goto L1157
L1157:
	;
	v3729 = v3713
...
L1158:
	;
	v3722 = int32(_a_F_DCH_to_char_42)
	goto L1160
L1159:
	;
	v3722 = int32(_a_F_DCH_to_char_43)
	goto L1160
L1160:
	;
	if v3703 < int32(0) {
...
L1164:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+576)) = v3742
	v3747 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_34), v15+int32(576))
	mBase = m.M
	v3748 = m.ExcPending
	if v3748 != 0 {
		goto L1
...
L1173:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v15)+608)) = v3779 + v3786*int32(365) + v3791 + v3794 + v3797 + v3806 - int32(_a_F_DCH_to_char_39)
	v3814 = F_pg_sprintf(m, v22, int32(_a_F_DCH_to_char_0), v15+int32(608))
	mBase = m.M
	v3815 = m.ExcPending
	if v3815 != 0 {
		goto L1
...
L1174:
	;
	v3785 = int32(_a_F_DCH_to_char_35)
	goto L1176
L1175:
	;
	v3785 = int32(_a_F_DCH_to_char_36)
	goto L1176
L1176:
	;
	v3786 = v3785 + v3777
...
L1179:
	;
	v3806 = base.I32_div_s((v3801+v3778)*int32(_a_F_DCH_to_char_37), int32(256))
	goto L1173
L1180:
	;
