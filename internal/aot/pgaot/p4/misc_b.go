...
L20:
	;
	v107 = F___memcpy(m, int32(4680732), v96, int32(140))
	mBase = m.M
	goto L22
L21:
	;
...
L33:
	;
	v152 = F___memcpy(m, int32(4680872), v141, int32(140))
	mBase = m.M
	goto L35
L34:
	;
...
L46:
	;
	v197 = F___memcpy(m, int32(4682692), v186, int32(140))
	mBase = m.M
	goto L48
L47:
	;
...
L59:
	;
	v242 = F___memcpy(m, int32(4682552), v231, int32(140))
	mBase = m.M
	goto L61
L60:
	;
...
L85:
	;
	v332 = F___memcpy(m, int32(4681992), v321, int32(140))
	mBase = m.M
	goto L87
L86:
	;
...
L98:
	;
	v377 = F___memcpy(m, int32(4682272), v366, int32(140))
	mBase = m.M
	goto L100
L99:
	;
...
L111:
	;
	v422 = F___memcpy(m, int32(4682972), v411, int32(140))
	mBase = m.M
	goto L113
L112:
	;
...
L114:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+12)) = v53
	...
	v459 = F_AllocSetContextCreateInternal(m, v454, int32(215930), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v460 = m.ExcPending
	if v460 != 0 {
		v1192 = v56
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v56))) = int32(4430908)
	goto L116
L116:
	;
	goto L117
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v473))) = int32(4430908)
	goto L135
L135:
	;
	v557 = int32(4509772)
...
L142:
	...
	F_s_lock(m, v635, int32(492333), int32(399), int32(82949))
	mBase = m.M
	v640 = m.ExcPending
	if v640 != 0 {
		v1192 = v476
...
L220:
	...
	F_s_lock(m, v1048+int32(4), int32(494955), int32(1404), int32(88316))
	mBase = m.M
	v1055 = m.ExcPending
	if v1055 != 0 {
		v1192 = v476
...
func F_BarrierAttach(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(495168), int32(242), int32(326087))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
...
func F_BogusGetChunkContext(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
		F_errmsg_internal(m, int32(669775), v5)
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(492304), int32(307), int32(62239))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
...
func F_BogusRealloc(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		F_errmsg_internal(m, int32(669973), v6)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(492304), int32(299), int32(488676))
			mBase = m.M
			v26 = m.ExcPending
			if v26 != 0 {
				return int32(0)
...
L218:
	;
	v759 = F_find_among_b(m, l0, int32(4177376), int32(109))
	mBase = m.M
	v762 = m.ExcPending
	if v762 != 0 {
		goto L219
...
L223:
	;
	v797 = F_slice_from_s(m, l0, int32(6), int32(2172669))
	mBase = m.M
	v798 = m.ExcPending
	if v798 != 0 {
		goto L219
...
L224:
	;
	v791 = F_slice_from_s(m, l0, int32(7), int32(2172662))
	mBase = m.M
	v792 = m.ExcPending
	if v792 != 0 {
		goto L219
...
L225:
	;
	v785 = F_slice_from_s(m, l0, int32(7), int32(2172655))
	mBase = m.M
	v786 = m.ExcPending
	if v786 != 0 {
		goto L219
...
L246:
	;
	v843 = F_find_among_b(m, l0, int32(4179568), int32(295))
	mBase = m.M
	v844 = m.ExcPending
	if v844 != 0 {
		goto L219
...
L250:
	;
	v910 = F_slice_from_s(m, l0, int32(5), int32(2173169))
	mBase = m.M
	v911 = m.ExcPending
	if v911 != 0 {
		goto L219
...
L251:
	;
	v904 = F_slice_from_s(m, l0, int32(5), int32(2173164))
	mBase = m.M
	v905 = m.ExcPending
	if v905 != 0 {
		goto L219
...
L252:
	;
	v898 = F_slice_from_s(m, l0, int32(5), int32(2173159))
	mBase = m.M
	v899 = m.ExcPending
	if v899 != 0 {
		goto L219
...
L253:
	;
	v892 = F_slice_from_s(m, l0, int32(5), int32(2173154))
	mBase = m.M
	v893 = m.ExcPending
	if v893 != 0 {
		goto L219
...
L254:
	;
	v886 = F_slice_from_s(m, l0, int32(6), int32(2173148))
	mBase = m.M
	v887 = m.ExcPending
	if v887 != 0 {
		goto L219
...
L255:
	;
	v880 = F_slice_from_s(m, l0, int32(3), int32(2173145))
	mBase = m.M
	v881 = m.ExcPending
	if v881 != 0 {
		goto L219
...
L257:
	;
	v867 = F_slice_from_s(m, l0, int32(3), int32(2173142))
	mBase = m.M
	v868 = m.ExcPending
	if v868 != 0 {
		goto L219
...
L287:
	;
	v949 = F_find_among_b(m, l0, int32(4185472), int32(19))
	mBase = m.M
	v950 = m.ExcPending
	if v950 != 0 {
		goto L219
...
L290:
	;
	v966 = F_slice_from_s(m, l0, int32(1), int32(2174361))
	mBase = m.M
	v967 = m.ExcPending
	if v967 != 0 {
		goto L219
	...
	if v5 <= v4 {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				F_errfinish(m, int32(495733), int32(123), int32(450884))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return
			...
			if v206 != 0 {
				...
				if v209 != 0 {
					...
					if v213 != 0 {
						...
						F_errfinish(m, int32(492981), int32(1081), int32(329535))
						mBase = m.M
						v218 = m.ExcPending
						if v218 != 0 {
							return int32(0)
...
func F_btoptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = F_build_reloptions(m, l0, l1, int32(4), int32(24), int32(758096), int32(3))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
				...
				if v147 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = l2
					...
					if v153 != 0 {
						...
						F_errfinish(m, int32(499217), int32(853), int32(268849))
						mBase = m.M
						v158 = m.ExcPending
						if v158 != 0 {
							return int32(0)
					...
					default:
						...
						if v117 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v14))) = l1
							F_errmsg_internal(m, int32(268822), v14)
							mBase = m.M
							v121 = m.ExcPending
							if v121 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(499217), int32(996), int32(268849))
								mBase = m.M
								v126 = m.ExcPending
								if v126 != 0 {
									return int32(0)
													...
													if v103 != 0 {
														...
														if v102 == int32(0) {
															...
															if v162 != 0 {
																...
																F_errmsg_internal(m, int32(447048), int32(0))
																mBase = m.M
																v166 = m.ExcPending
																if v166 != 0 {
																	return int32(0)
																} else {
																	F_errfinish(m, int32(499217), int32(961), int32(268849))
																	mBase = m.M
																	v171 = m.ExcPending
																	if v171 != 0 {
																		return int32(0)
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(506901)
...
L26:
	;
	F_errsave_finish(m, v13, int32(499834), int32(342), int32(278213))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L5
...
L44:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(506901)
	F_errmsg(m, int32(189102), v11)
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L5
...
L45:
	;
	F_errsave_finish(m, v13, int32(499834), int32(383), int32(278213))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L5
