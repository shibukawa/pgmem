...
L20:
	;
	v107 = F___memcpy(m, int32(4635804), v96, int32(140))
	mBase = m.M
	goto L22
L21:
	;
...
L33:
	;
	v152 = F___memcpy(m, int32(4635944), v141, int32(140))
	mBase = m.M
	goto L35
L34:
	;
...
L46:
	;
	v197 = F___memcpy(m, int32(4637764), v186, int32(140))
	mBase = m.M
	goto L48
L47:
	;
...
L59:
	;
	v242 = F___memcpy(m, int32(4637624), v231, int32(140))
	mBase = m.M
	goto L61
L60:
	;
...
L85:
	;
	v332 = F___memcpy(m, int32(4637064), v321, int32(140))
	mBase = m.M
	goto L87
L86:
	;
...
L98:
	;
	v377 = F___memcpy(m, int32(4637344), v366, int32(140))
	mBase = m.M
	goto L100
L99:
	;
...
L111:
	;
	v422 = F___memcpy(m, int32(4638044), v411, int32(140))
	mBase = m.M
	goto L113
L112:
	;
...
L114:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+12)) = v53
	...
	v459 = F_AllocSetContextCreateInternal(m, v454, int32(213251), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v460 = m.ExcPending
	if v460 != 0 {
		v1192 = v56
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v56))) = int32(4386540)
	goto L116
L116:
	;
	goto L117
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v473))) = int32(4386540)
	goto L135
L135:
	;
	v557 = int32(4465404)
...
L142:
	...
	F_s_lock(m, v635, int32(485073), int32(399), int32(82101))
	mBase = m.M
	v640 = m.ExcPending
	if v640 != 0 {
		v1192 = v476
...
L220:
	...
	F_s_lock(m, v1048+int32(4), int32(487631), int32(1404), int32(87452))
	mBase = m.M
	v1055 = m.ExcPending
	if v1055 != 0 {
		v1192 = v476
...
func F_BarrierAttach(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(487844), int32(242), int32(321379))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
...
func F_BogusGetChunkContext(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
		F_errmsg_internal(m, int32(646394), v5)
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(485044), int32(307), int32(61709))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
...
func F_BogusRealloc(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		F_errmsg_internal(m, int32(646592), v6)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(485044), int32(299), int32(481436))
			mBase = m.M
			v26 = m.ExcPending
			if v26 != 0 {
				return int32(0)
...
L218:
	;
	v759 = F_find_among_b(m, l0, int32(4144736), int32(109))
	mBase = m.M
	v762 = m.ExcPending
	if v762 != 0 {
		goto L219
...
L223:
	;
	v797 = F_slice_from_s(m, l0, int32(6), int32(2144525))
	mBase = m.M
	v798 = m.ExcPending
	if v798 != 0 {
		goto L219
...
L224:
	;
	v791 = F_slice_from_s(m, l0, int32(7), int32(2144518))
	mBase = m.M
	v792 = m.ExcPending
	if v792 != 0 {
		goto L219
...
L225:
	;
	v785 = F_slice_from_s(m, l0, int32(7), int32(2144511))
	mBase = m.M
	v786 = m.ExcPending
	if v786 != 0 {
		goto L219
...
L246:
	;
	v843 = F_find_among_b(m, l0, int32(4146928), int32(295))
	mBase = m.M
	v844 = m.ExcPending
	if v844 != 0 {
		goto L219
...
L250:
	;
	v910 = F_slice_from_s(m, l0, int32(5), int32(2145025))
	mBase = m.M
	v911 = m.ExcPending
	if v911 != 0 {
		goto L219
...
L251:
	;
	v904 = F_slice_from_s(m, l0, int32(5), int32(2145020))
	mBase = m.M
	v905 = m.ExcPending
	if v905 != 0 {
		goto L219
...
L252:
	;
	v898 = F_slice_from_s(m, l0, int32(5), int32(2145015))
	mBase = m.M
	v899 = m.ExcPending
	if v899 != 0 {
		goto L219
...
L253:
	;
	v892 = F_slice_from_s(m, l0, int32(5), int32(2145010))
	mBase = m.M
	v893 = m.ExcPending
	if v893 != 0 {
		goto L219
...
L254:
	;
	v886 = F_slice_from_s(m, l0, int32(6), int32(2145004))
	mBase = m.M
	v887 = m.ExcPending
	if v887 != 0 {
		goto L219
...
L255:
	;
	v880 = F_slice_from_s(m, l0, int32(3), int32(2145001))
	mBase = m.M
	v881 = m.ExcPending
	if v881 != 0 {
		goto L219
...
L257:
	;
	v867 = F_slice_from_s(m, l0, int32(3), int32(2144998))
	mBase = m.M
	v868 = m.ExcPending
	if v868 != 0 {
		goto L219
...
L287:
	;
	v949 = F_find_among_b(m, l0, int32(4152832), int32(19))
	mBase = m.M
	v950 = m.ExcPending
	if v950 != 0 {
		goto L219
...
L290:
	;
	v966 = F_slice_from_s(m, l0, int32(1), int32(2146217))
	mBase = m.M
	v967 = m.ExcPending
	if v967 != 0 {
		goto L219
	...
	if v5 <= v4 {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				F_errfinish(m, int32(488399), int32(123), int32(444660))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return
			...
			if v206 != 0 {
				...
				if v209 != 0 {
					...
					if v213 != 0 {
						...
						F_errfinish(m, int32(485683), int32(1081), int32(324743))
						mBase = m.M
						v218 = m.ExcPending
						if v218 != 0 {
							return int32(0)
...
func F_btoptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = F_build_reloptions(m, l0, l1, int32(4), int32(24), int32(734432), int32(3))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
			...
			if v17 == int32(0) {
				...
				if v147 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = l2
					F_errmsg_internal(m, int32(44278), v14+int32(16))
					mBase = m.M
					v153 = m.ExcPending
					if v153 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(491799), int32(853), int32(265390))
						mBase = m.M
						v158 = m.ExcPending
						if v158 != 0 {
							return int32(0)
					...
					default:
						...
						if v117 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v14))) = l1
							F_errmsg_internal(m, int32(265363), v14)
							mBase = m.M
							v121 = m.ExcPending
							if v121 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(491799), int32(996), int32(265390))
								mBase = m.M
								v126 = m.ExcPending
								if v126 != 0 {
									return int32(0)
													...
													if v103 != 0 {
														...
														if v102 == int32(0) {
															...
															if v162 != 0 {
																...
																F_errmsg_internal(m, int32(440824), int32(0))
																mBase = m.M
																v166 = m.ExcPending
																if v166 != 0 {
																	return int32(0)
																} else {
																	F_errfinish(m, int32(491799), int32(961), int32(265390))
																	mBase = m.M
																	v171 = m.ExcPending
																	if v171 != 0 {
																		return int32(0)
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(499287)
...
L43:
	;
	F_errsave_finish(m, v13, int32(492409), int32(342), int32(274382))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L22
...
L62:
	;
	F_errsave_finish(m, v13, int32(492409), int32(383), int32(274382))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L22
