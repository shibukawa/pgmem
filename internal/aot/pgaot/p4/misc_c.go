		...
		if v8 == int32(0) {
			...
			if v57 != 0 {
				...
				if v60 != 0 {
					...
					F_errmsg(m, int32(329979), int32(0))
					mBase = m.M
					v64 = m.ExcPending
					if v64 != 0 {
						return
					} else {
						F_errdetail(m, int32(591814), int32(0))
						mBase = m.M
						v68 = m.ExcPending
						if v68 != 0 {
							return
						} else {
							F_errhint(m, int32(651365), int32(0))
							mBase = m.M
							v72 = m.ExcPending
							if v72 != 0 {
								return
							} else {
								F_errfinish(m, int32(496314), int32(5437), int32(158301))
								mBase = m.M
								v77 = m.ExcPending
								if v77 != 0 {
									return
			...
			if v12 != int32(1) {
				...
				F_RecoveryRequiresIntParameter(m, int32(141138), v17, v18)
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					return
					...
					F_RecoveryRequiresIntParameter(m, int32(160764), v23, v26)
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return
						...
						F_RecoveryRequiresIntParameter(m, int32(135155), v31, v34)
						mBase = m.M
						v36 = m.ExcPending
						if v36 != 0 {
							return
							...
							F_RecoveryRequiresIntParameter(m, int32(141579), v39, v42)
							mBase = m.M
							v44 = m.ExcPending
							if v44 != 0 {
								return
								...
								F_RecoveryRequiresIntParameter(m, int32(255348), v47, v50)
								mBase = m.M
								v52 = m.ExcPending
								if v52 != 0 {
									return
...
L20:
	;
	v103 = F___memcpy(m, int32(4654204), v92, int32(140))
	mBase = m.M
	goto L22
L21:
	;
...
L33:
	;
	v149 = F___memcpy(m, int32(4654344), v138, int32(140))
	mBase = m.M
	goto L35
L34:
	;
...
L46:
	;
	v195 = F___memcpy(m, int32(4656164), v184, int32(140))
	mBase = m.M
	goto L48
L47:
	;
...
L59:
	;
	v241 = F___memcpy(m, int32(4656024), v230, int32(140))
	mBase = m.M
	goto L61
L60:
	;
...
L72:
	;
	v287 = F___memcpy(m, int32(4655884), v276, int32(140))
	mBase = m.M
	goto L74
L73:
	;
...
L85:
	;
	v333 = F___memcpy(m, int32(4655464), v322, int32(140))
	mBase = m.M
	goto L87
L86:
	;
...
L98:
	;
	v379 = F___memcpy(m, int32(4655744), v368, int32(140))
	mBase = m.M
	goto L100
L99:
	;
...
L111:
	;
	v425 = F___memcpy(m, int32(4656444), v414, int32(140))
	mBase = m.M
	goto L113
L112:
	;
...
L114:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+39)) = uint8(v50)
	...
	v456 = F_AllocSetContextCreateInternal(m, v451, int32(214819), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		v1295 = v41
...
L135:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+39)) = uint8(v487)
	...
	F_s_lock(m, v562+int32(4), int32(493454), int32(294), int32(277809))
	mBase = m.M
	v569 = m.ExcPending
	if v569 != 0 {
		v1295 = v470
...
L147:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+39)) = uint8(v632)
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+38)) = uint8(v629)
	F_errmsg_internal(m, int32(157612), int32(0))
	mBase = m.M
	v665 = m.ExcPending
	if v665 != 0 {
		v1295 = v470
...
L150:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+39)) = uint8(v632)
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+38)) = uint8(v629)
	F_errfinish(m, int32(493454), int32(1390), int32(336431))
	mBase = m.M
	v674 = m.ExcPending
	if v674 != 0 {
		v1295 = v470
...
L167:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+39)) = uint8(v724)
	...
	F_s_lock(m, v767+int32(4), int32(493454), int32(414), int32(277809))
	mBase = m.M
	v774 = m.ExcPending
	if v774 != 0 {
		v1295 = v470
...
L188:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v735
	F_errmsg_plural(m, int32(655292), int32(655232), v735, v19+int32(16))
	mBase = m.M
	v855 = m.ExcPending
	if v855 != 0 {
		v1295 = v470
...
L189:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+39)) = uint8(v724)
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+38)) = uint8(v727)
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(339886)
	F_errhint(m, int32(648232), v19)
	mBase = m.M
	v864 = m.ExcPending
	if v864 != 0 {
		v1295 = v470
...
L190:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+39)) = uint8(v724)
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+38)) = uint8(v727)
	F_errfinish(m, int32(493454), int32(462), int32(277809))
	mBase = m.M
	v873 = m.ExcPending
	if v873 != 0 {
		v1295 = v470
...
L201:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v19)+39)) = uint8(v928)
	...
	F_s_lock(m, v945+int32(4), int32(493454), int32(495), int32(277809))
	mBase = m.M
	v952 = m.ExcPending
	if v952 != 0 {
		v1295 = v470
...
L13:
	;
	F_errmsg_internal(m, int32(291130), int32(0))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L9
...
L16:
	;
	F_errfinish(m, int32(497922), int32(3076), int32(291198))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L9
...
L18:
	;
	F_errfinish(m, int32(491358), int32(61), int32(111218))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L10
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v96 + int32(4)
	F_errmsg(m, int32(688406), v11+int32(16))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L10
...
L27:
	;
	F_errfinish(m, int32(491358), int32(103), int32(111218))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L10
...
L7:
	;
	v57 = F_AllocSetContextCreateInternal(m, v15, int32(17140), int32(0), int32(1024), int32(8388608))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L25
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v110
	v113 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1368])))
...
L9:
	;
	F_errmsg(m, int32(273605), int32(0))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L7
...
L10:
	;
	F_errfinish(m, int32(496879), int32(1837), int32(514559))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L7
...
L98:
	;
	F_errmsg(m, int32(503222), int32(0))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L7
...
L99:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v357 + v358<<(uint(int32(4))%32) + v336*int32(100) + int32(24)
	F_errdetail(m, int32(611578), v19)
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L7
...
L100:
	;
	F_errfinish(m, int32(496879), int32(1990), int32(514559))
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L7
...
L103:
	;
	F_errmsg(m, int32(430523), int32(0))
	mBase = m.M
	v452 = m.ExcPending
	if v452 != 0 {
		goto L7
...
L104:
	;
	F_errfinish(m, int32(496879), int32(1921), int32(514559))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L7
...
func F_CreateAuxProcessResourceOwner(m *base.Module) {
	...
	if v7 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6)+12)) = int32(129799)
		v11 = v6 + int32(352)
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+128)) = v142
	F_errmsg(m, int32(273973), v22+int32(128))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L1
...
L54:
	;
	F_errfinish(m, int32(492711), int32(17563), int32(327874))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L1
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+160)) = v142
	F_errmsg(m, int32(424145), v22+int32(160))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L1
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+144)) = v226
	F_errdetail(m, int32(587216), v22+int32(144))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L1
...
L66:
	;
	F_errfinish(m, int32(492711), int32(17575), int32(327874))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L1
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v342 + int32(4)
	F_errmsg(m, int32(682017), v22+int32(16))
	mBase = m.M
	v510 = m.ExcPending
	if v510 != 0 {
		goto L1
...
L139:
	;
	F_errfinish(m, int32(492711), int32(17811), int32(327845))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
L141:
	;
	F_errmsg_internal(m, int32(148062), int32(0))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
...
L142:
	;
	F_errfinish(m, int32(492711), int32(17723), int32(327845))
	mBase = m.M
	v529 = m.ExcPending
	if v529 != 0 {
		goto L1
...
L146:
	;
	F_errfinish(m, int32(492711), int32(17806), int32(327845))
	mBase = m.M
	v547 = m.ExcPending
	if v547 != 0 {
		goto L1
...
L194:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+80)) = v733 + int32(4)
	F_errmsg(m, int32(681949), v22+int32(80))
	mBase = m.M
	v742 = m.ExcPending
	if v742 != 0 {
		goto L1
...
L195:
	;
	F_errfinish(m, int32(492711), int32(17731), int32(327845))
	mBase = m.M
	v747 = m.ExcPending
	if v747 != 0 {
		goto L1
...
L198:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+36)) = v755 + v756
	F_errmsg(m, int32(703291), v22+int32(32))
	mBase = m.M
	v766 = m.ExcPending
	if v766 != 0 {
		goto L1
...
L199:
	;
	F_errfinish(m, int32(492711), int32(17740), int32(327845))
	mBase = m.M
	v771 = m.ExcPending
	if v771 != 0 {
		goto L1
...
L202:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+68)) = v779 + v780
	F_errmsg(m, int32(703367), v22-int32(-64))
	mBase = m.M
	v790 = m.ExcPending
	if v790 != 0 {
		goto L1
...
L203:
	;
	F_errfinish(m, int32(492711), int32(17751), int32(327845))
	mBase = m.M
	v795 = m.ExcPending
	if v795 != 0 {
		goto L1
...
L206:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+52)) = v803 + v804
	F_errmsg(m, int32(703439), v22+int32(48))
	mBase = m.M
	v814 = m.ExcPending
	if v814 != 0 {
		goto L1
...
L207:
	;
	F_errfinish(m, int32(492711), int32(17762), int32(327845))
	mBase = m.M
	v819 = m.ExcPending
	if v819 != 0 {
		goto L1
...
L210:
	;
	F_errmsg(m, int32(120342), int32(0))
	mBase = m.M
	v830 = m.ExcPending
	if v830 != 0 {
		goto L1
...
L211:
	;
	F_errfinish(m, int32(492711), int32(17775), int32(327845))
	mBase = m.M
	v835 = m.ExcPending
	if v835 != 0 {
		goto L1
...
L214:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+96)) = v142
	F_errmsg(m, int32(694381), v22+int32(96))
	mBase = m.M
	v848 = m.ExcPending
	if v848 != 0 {
		goto L1
...
L215:
	;
	F_errfinish(m, int32(492711), int32(17613), int32(327874))
	mBase = m.M
	v853 = m.ExcPending
	if v853 != 0 {
		goto L1
...
L219:
	;
	F_errfinish(m, int32(492711), int32(17593), int32(327874))
	mBase = m.M
	v869 = m.ExcPending
	if v869 != 0 {
		goto L1
...
L222:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+180)) = v877 + int32(4)
	F_errmsg(m, int32(530927), v22+int32(176))
	mBase = m.M
	v886 = m.ExcPending
	if v886 != 0 {
		goto L1
...
L223:
	;
	F_errfinish(m, int32(492711), int32(17554), int32(327874))
	mBase = m.M
	v891 = m.ExcPending
	if v891 != 0 {
		goto L1
...
L226:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+192)) = v899 + int32(4)
	F_errmsg(m, int32(693268), v22+int32(192))
	mBase = m.M
	v908 = m.ExcPending
	if v908 != 0 {
		goto L1
...
L227:
	;
	F_errfinish(m, int32(492711), int32(17535), int32(327874))
	mBase = m.M
	v913 = m.ExcPending
	if v913 != 0 {
		goto L1
...
L230:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+208)) = v921 + int32(4)
	F_errmsg(m, int32(693325), v22+int32(208))
	mBase = m.M
	v930 = m.ExcPending
	if v930 != 0 {
		goto L1
...
L231:
	;
	F_errfinish(m, int32(492711), int32(17529), int32(327874))
	mBase = m.M
	v935 = m.ExcPending
	if v935 != 0 {
		goto L1
...
L234:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+224)) = v943 + int32(4)
	F_errmsg(m, int32(413701), v22+int32(224))
	mBase = m.M
	v951 = m.ExcPending
	if v951 != 0 {
		goto L1
...
L235:
	;
	F_errfinish(m, int32(492711), int32(17411), int32(416518))
	mBase = m.M
	v956 = m.ExcPending
	if v956 != 0 {
		goto L1
...
L238:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+112)) = v142
	F_errmsg(m, int32(274027), v22+int32(112))
	mBase = m.M
	v969 = m.ExcPending
	if v969 != 0 {
		goto L1
...
L239:
	;
	F_errfinish(m, int32(492711), int32(17567), int32(327874))
	mBase = m.M
	v974 = m.ExcPending
	if v974 != 0 {
		goto L1
...
func F_call_real_check_hook(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v14 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, _consts[1433])) = v21
						...
						if v39 != 0 {
							...
							if v41 != 0 {
								*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v41
								F_errmsg_internal(m, int32(205698), v9+int32(-16))
								mBase = m.M
								v47 = m.ExcPending
								if v47 != 0 {
									return int32(0)
									...
									if v59 != 0 {
										*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v59
										F_errdetail_internal(m, int32(205698), v9+int32(-48))
										mBase = m.M
										v65 = m.ExcPending
										if v65 != 0 {
											return int32(0)
										} else {
											v67 = *(*int32)(unsafe.Add(mBase, _consts[1433]))
											if v67 != 0 {
												*(*int32)(unsafe.Add(mBase, uint32(v11))) = v67
												F_errhint(m, int32(205698), v11)
												mBase = m.M
												v71 = m.ExcPending
												if v71 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(497951), int32(6904), int32(314376))
													mBase = m.M
													v76 = m.ExcPending
													if v76 != 0 {
														return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v48
								F_errmsg(m, int32(337155), v9+int32(-32))
								mBase = m.M
								v56 = m.ExcPending
								if v56 != 0 {
									return int32(0)
...
func F_check_assignable(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _consts[1458]))
	v13 = l0
	for {
			...
			if v30 != 0 {
				...
				if v33 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v34
					F_errmsg(m, int32(516479), v9+int32(16))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return
						...
						if v43 != 0 {
							...
							F_errfinish(m, int32(26946), int32(3569), int32(394186))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return
	...
	default:
		...
		if v61 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = v62
			F_errmsg_internal(m, int32(482532), v9)
			mBase = m.M
			v67 = m.ExcPending
			if v67 != 0 {
				return
			} else {
				F_errfinish(m, int32(26946), int32(3580), int32(394186))
				mBase = m.M
				v74 = m.ExcPending
				if v74 != 0 {
					return
...
L8:
	;
	v46 = F_format_elog_string(m, int32(629205), int32(0))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L2
...
L203:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+4)) = v649
	...
	v655 = v653 - int32(80)
	m.G0 = v655
	v661 = F_find_option(m, int32(381301), v649, v649, int32(21))
	mBase = m.M
	v662 = m.ExcPending
	if v662 != 0 {
		goto L2
...
L214:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v655)+16)) = v674
	v676 = int32(4487472)
	v682 = F_pg_snprintf(m, v676, int32(256), int32(337189), v655+int32(16))
	mBase = m.M
	v683 = m.ExcPending
	if v683 != 0 {
		goto L2
...
L215:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v655))) = v666
	v668 = int32(4487472)
	v672 = F_pg_snprintf(m, v668, int32(256), int32(486504), v655)
	mBase = m.M
	v673 = m.ExcPending
	if v673 != 0 {
		goto L2
...
L228:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v655)+32)) = v687
	F_errmsg_internal(m, int32(181224), v655+int32(32))
	mBase = m.M
	v745 = m.ExcPending
	if v745 != 0 {
		goto L2
...
L229:
	;
	F_errfinish(m, int32(497951), int32(3036), int32(343857))
	mBase = m.M
	v750 = m.ExcPending
	if v750 != 0 {
		goto L2
...
L235:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v655)+64)) = int32(381301)
	F_errmsg(m, int32(697446), v655-int32(-64))
	mBase = m.M
	v789 = m.ExcPending
	if v789 != 0 {
		goto L2
...
L236:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v655)+48)) = int32(155310)
	F_errdetail(m, int32(592094), v655+int32(48))
	mBase = m.M
	v796 = m.ExcPending
	if v796 != 0 {
		goto L2
...
L237:
	;
	F_errfinish(m, int32(497951), int32(4419), int32(329701))
	mBase = m.M
	v801 = m.ExcPending
	if v801 != 0 {
		goto L2
...
L261:
	;
	v903 = F_format_elog_string(m, int32(574683), int32(0))
	mBase = m.M
	v904 = m.ExcPending
	if v904 != 0 {
		goto L2
...
L271:
	;
	v944 = int32(*(*uint16)(unsafe.Add(mBase, _consts[474])))
	*(*uint16)(unsafe.Add(mBase, uint32(v930)+4)) = uint16(v944)
	v947 = *(*int32)(unsafe.Add(mBase, _consts[475]))
	*(*int32)(unsafe.Add(mBase, uint32(v930))) = v947
	goto L270
L272:
	;
	v938 = int32(*(*uint16)(unsafe.Add(mBase, _consts[476])))
	*(*uint16)(unsafe.Add(mBase, uint32(v930)+4)) = uint16(v938)
	v941 = *(*int32)(unsafe.Add(mBase, _consts[477]))
	*(*int32)(unsafe.Add(mBase, uint32(v930))) = v941
	goto L270
L273:
	;
	v932 = int32(*(*uint16)(unsafe.Add(mBase, _consts[478])))
	*(*uint16)(unsafe.Add(mBase, uint32(v930)+4)) = uint16(v932)
	v935 = *(*int32)(unsafe.Add(mBase, _consts[479]))
...
L277:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v84
	v969 = F_format_elog_string(m, int32(650910), v21)
	mBase = m.M
	v970 = m.ExcPending
	if v970 != 0 {
		goto L2
...
L8:
	;
	v31 = F_format_elog_string(m, int32(629205), int32(0))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L2
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v57
	v177 = F_format_elog_string(m, int32(650910), v10)
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L2
				...
				if v12 != 0 {
					...
					if v27 != 0 {
						...
						if v30 != 0 {
							...
							F_errmsg(m, int32(253237), int32(0))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
							} else {
								F_errdetail(m, int32(630537), int32(0))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
									...
									if v41 != 0 {
										...
										F_errfinish(m, int32(494264), int32(3282), int32(220868))
										mBase = m.M
										v46 = m.ExcPending
										if v46 != 0 {
											return int32(0)
						...
						if base.Ui32(int32(12000)) <= base.Ui32(v16) {
							...
							if v50 != 0 {
								...
								if v53 != 0 {
									...
									F_errmsg(m, int32(369399), int32(0))
									mBase = m.M
									v57 = m.ExcPending
									if v57 != 0 {
										return int32(0)
									} else {
										F_errdetail(m, int32(630626), int32(0))
										mBase = m.M
										v61 = m.ExcPending
										if v61 != 0 {
											return int32(0)
											...
											if v64 != 0 {
												...
												F_errfinish(m, int32(494264), int32(3298), int32(220868))
												mBase = m.M
												v69 = m.ExcPending
												if v69 != 0 {
													return int32(0)
...
func F_clogsyncfiletag(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_SlruSyncFileTag(m, int32(4383680), l0, l1)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
L6:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[1554]))
...
L185:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = l0
	F_errmsg_internal(m, int32(42128), v19+int32(16))
	mBase = m.M
	v623 = m.ExcPending
	if v623 != 0 {
		goto L12
...
L186:
	;
	F_errfinish(m, int32(495451), int32(5499), int32(314075))
	mBase = m.M
	v628 = m.ExcPending
	if v628 != 0 {
		goto L12
...
L300:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+64)) = l4
	F_errmsg_internal(m, int32(176732), v19-int32(-64))
	mBase = m.M
	v962 = m.ExcPending
	if v962 != 0 {
		goto L12
...
L301:
	;
	F_errfinish(m, int32(495451), int32(4538), int32(315943))
	mBase = m.M
	v967 = m.ExcPending
	if v967 != 0 {
		goto L12
...
L306:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+48)) = l4
	F_errmsg_internal(m, int32(176732), v19+int32(48))
	mBase = m.M
	v981 = m.ExcPending
	if v981 != 0 {
		goto L12
...
L312:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = l4
	F_errmsg_internal(m, int32(176732), v19)
	mBase = m.M
	v998 = m.ExcPending
	if v998 != 0 {
		goto L12
...
L318:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = l4
	F_errmsg_internal(m, int32(176732), v19+int32(32))
	mBase = m.M
	v1017 = m.ExcPending
	if v1017 != 0 {
		goto L12
...
L328:
	;
	F_errmsg_internal(m, int32(410981), int32(0))
	mBase = m.M
	v1057 = m.ExcPending
	if v1057 != 0 {
		goto L12
...
L329:
	;
	F_errfinish(m, int32(495451), int32(5381), int32(314075))
	mBase = m.M
	v1062 = m.ExcPending
	if v1062 != 0 {
		goto L12
...
L51:
	;
	F_errmsg_internal(m, int32(64956), int32(0))
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L12
...
L52:
	;
	F_errfinish(m, int32(498299), int32(5662), int32(397686))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L12
				...
				if v18 <= int32(0) {
					...
					if v51 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v52
						F_errmsg_internal(m, int32(486228), v7)
						mBase = m.M
						v56 = m.ExcPending
						if v56 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(491657), int32(669), int32(208430))
							mBase = m.M
							v61 = m.ExcPending
							if v61 != 0 {
								return int32(0)
	...
	if v4 == int32(0) {
		...
		if v9 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
			if v8 == int32(0) {
				F_yy_fatal_error_2(m, int32(667079))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
		...
		if v4&int32(32) != 0 {
			...
			if v12 != 0 {
				...
				if v15 != 0 {
					...
					F_errmsg(m, int32(110497), int32(0))
					mBase = m.M
					v19 = m.ExcPending
					if v19 != 0 {
						return int32(0)
					} else {
						F_errdetail(m, int32(565693), int32(0))
						mBase = m.M
						v23 = m.ExcPending
						if v23 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(498222), int32(3211), int32(500976))
							mBase = m.M
							v28 = m.ExcPending
							if v28 != 0 {
								return int32(0)
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v89
	F_errmsg_internal(m, int32(150416), v17)
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
...
L61:
	;
	F_errfinish(m, int32(497557), int32(1865), int32(409288))
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L1
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = v36
		...
		if v45 != 0 {
			...
			if v47 != 0 {
				...
				v56 = F_transformRelOptions(m, v49, v50, int32(77796), v10+int32(8), int32(1), v49)
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
...
L581:
	;
	F_errmsg(m, int32(507878), int32(0))
	mBase = m.M
	v2381 = m.ExcPending
	if v2381 != 0 {
		goto L21
...
L583:
	;
	F_errfinish(m, int32(493548), int32(4145), int32(154651))
	mBase = m.M
	v2390 = m.ExcPending
	if v2390 != 0 {
		goto L21
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v85))) = v309
	F_errmsg_internal(m, int32(73270), v85)
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L8
...
L93:
	;
	F_errfinish(m, int32(491772), int32(1903), int32(73297))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L8
...
L182:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v609
	F_errmsg_internal(m, int32(484245), v19+int32(16))
	mBase = m.M
	v615 = m.ExcPending
	if v615 != 0 {
		goto L8
...
L183:
	;
	F_errfinish(m, int32(494923), int32(5625), int32(449988))
	mBase = m.M
	v620 = m.ExcPending
	if v620 != 0 {
		goto L8
...
L365:
	;
	F_errmsg_internal(m, int32(215944), int32(0))
	mBase = m.M
	v1296 = m.ExcPending
	if v1296 != 0 {
		goto L8
...
L366:
	;
	F_errfinish(m, int32(494887), int32(597), int32(150602))
	mBase = m.M
	v1301 = m.ExcPending
	if v1301 != 0 {
		goto L8
...
L372:
	;
	F_errmsg_internal(m, int32(15425), int32(0))
	mBase = m.M
	v1359 = m.ExcPending
	if v1359 != 0 {
		goto L8
...
L373:
	;
	F_errfinish(m, int32(494887), int32(543), int32(150602))
	mBase = m.M
	v1364 = m.ExcPending
	if v1364 != 0 {
		goto L8
...
L376:
	;
	F_errfinish(m, int32(494887), int32(574), int32(150602))
	mBase = m.M
	v1377 = m.ExcPending
	if v1377 != 0 {
		goto L8
...
L425:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+96)) = v1649
	F_errmsg_internal(m, int32(707220), v19+int32(96))
	mBase = m.M
	v1655 = m.ExcPending
	if v1655 != 0 {
		goto L8
...
L426:
	;
	F_errfinish(m, int32(494923), int32(3912), int32(282268))
	mBase = m.M
	v1660 = m.ExcPending
	if v1660 != 0 {
		goto L8
...
L444:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = v1742
	F_errmsg_internal(m, int32(707379), v19+int32(32))
	mBase = m.M
	v1748 = m.ExcPending
	if v1748 != 0 {
		goto L8
...
L445:
	;
	F_errfinish(m, int32(494923), int32(3930), int32(282268))
	mBase = m.M
	v1753 = m.ExcPending
	if v1753 != 0 {
		goto L8
...
L495:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+144)) = v1969
	F_errmsg_internal(m, int32(707220), v19+int32(144))
	mBase = m.M
	v1975 = m.ExcPending
	if v1975 != 0 {
		goto L8
...
L496:
	;
	F_errfinish(m, int32(494923), int32(4083), int32(282288))
	mBase = m.M
	v1980 = m.ExcPending
	if v1980 != 0 {
		goto L8
...
L566:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v2244
	F_errmsg_internal(m, int32(484245), v19)
	mBase = m.M
	v2248 = m.ExcPending
	if v2248 != 0 {
		goto L8
...
L567:
	;
	F_errfinish(m, int32(494923), int32(802), int32(282314))
	mBase = m.M
	v2253 = m.ExcPending
	if v2253 != 0 {
		goto L8
...
L570:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+80)) = v2261
	F_errmsg_internal(m, int32(707246), v19+int32(80))
	mBase = m.M
	v2267 = m.ExcPending
	if v2267 != 0 {
		goto L8
...
L571:
	;
	F_errfinish(m, int32(494923), int32(3932), int32(282268))
	mBase = m.M
	v2272 = m.ExcPending
	if v2272 != 0 {
		goto L8
...
L573:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+48)) = v2277
	F_errmsg_internal(m, int32(707312), v19+int32(48))
	mBase = m.M
	v2283 = m.ExcPending
	if v2283 != 0 {
		goto L8
...
L574:
	;
	F_errfinish(m, int32(494923), int32(3935), int32(282268))
	mBase = m.M
	v2288 = m.ExcPending
	if v2288 != 0 {
		goto L8
...
L576:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+64)) = v2309
	F_errmsg_internal(m, int32(707246), v19-int32(-64))
	mBase = m.M
	v2315 = m.ExcPending
	if v2315 != 0 {
		goto L8
...
L577:
	;
	F_errfinish(m, int32(494923), int32(3943), int32(282268))
	mBase = m.M
	v2320 = m.ExcPending
	if v2320 != 0 {
		goto L8
...
L579:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+112)) = v2325
	F_errmsg_internal(m, int32(707220), v19+int32(112))
	mBase = m.M
	v2331 = m.ExcPending
	if v2331 != 0 {
		goto L8
...
L580:
	;
	F_errfinish(m, int32(494923), int32(4076), int32(282288))
	mBase = m.M
	v2336 = m.ExcPending
	if v2336 != 0 {
		goto L8
...
L582:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+128)) = v2341
	F_errmsg_internal(m, int32(707342), v19+int32(128))
	mBase = m.M
	v2347 = m.ExcPending
	if v2347 != 0 {
		goto L8
...
L583:
	;
	F_errfinish(m, int32(494923), int32(4086), int32(282288))
	mBase = m.M
	v2352 = m.ExcPending
	if v2352 != 0 {
		goto L8
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v114
	F_errmsg_internal(m, int32(43167), v22+int32(16))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L10
...
L99:
	;
	F_errfinish(m, int32(497625), int32(1841), int32(320637))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L10
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v113
	F_errmsg_internal(m, int32(42761), v22)
	mBase = m.M
	v340 = m.ExcPending
	if v340 != 0 {
		goto L10
...
L102:
	;
	F_errfinish(m, int32(497625), int32(1878), int32(320637))
	mBase = m.M
	v345 = m.ExcPending
	if v345 != 0 {
		goto L10
...
L22:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v33)+64)) = int64(292057776192)
	v80 = F_hash_create(m, int32(322438), int32(64), v33+int32(48), int32(1048))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L1
...
L34:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v33)+96)) = v161
	v184 = F_pg_snprintf(m, v33+int32(96), int32(63), int32(205698), v33+int32(32))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L1
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33))) = v597
	v622 = F_pg_snprintf(m, v33+int32(96), int32(63), int32(205698), v33)
	mBase = m.M
	v623 = m.ExcPending
	if v623 != 0 {
		goto L1
...
L112:
	;
	F_errmsg(m, int32(106579), int32(0))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L1
...
L113:
	;
	F_errfinish(m, int32(498177), int32(650), int32(322194))
	mBase = m.M
	v716 = m.ExcPending
	if v716 != 0 {
		goto L1
...
L116:
	;
	F_errmsg(m, int32(60290), int32(0))
	mBase = m.M
	v728 = m.ExcPending
	if v728 != 0 {
		goto L1
...
L117:
	;
	F_errfinish(m, int32(498177), int32(655), int32(322194))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L120:
	;
	F_errmsg(m, int32(367417), int32(0))
	mBase = m.M
	v744 = m.ExcPending
	if v744 != 0 {
		goto L1
...
L121:
	;
	F_errdetail(m, int32(575479), int32(0))
	mBase = m.M
	v748 = m.ExcPending
	if v748 != 0 {
		goto L1
...
L122:
	;
	F_errfinish(m, int32(498177), int32(674), int32(322194))
	mBase = m.M
	v753 = m.ExcPending
	if v753 != 0 {
		goto L1
...
L125:
	;
	F_errmsg(m, int32(16343), int32(0))
	mBase = m.M
	v764 = m.ExcPending
	if v764 != 0 {
		goto L1
...
L126:
	;
	F_errdetail(m, int32(602042), int32(0))
	mBase = m.M
	v768 = m.ExcPending
	if v768 != 0 {
		goto L1
...
L127:
	;
	F_errfinish(m, int32(498177), int32(749), int32(322020))
	mBase = m.M
	v773 = m.ExcPending
	if v773 != 0 {
		goto L1
...
L130:
	;
	F_errmsg(m, int32(302310), int32(0))
	mBase = m.M
	v784 = m.ExcPending
	if v784 != 0 {
		goto L1
...
L131:
	;
	F_errfinish(m, int32(498177), int32(765), int32(322020))
	mBase = m.M
	v789 = m.ExcPending
	if v789 != 0 {
		goto L1
...
L134:
	;
	F_errmsg(m, int32(379880), int32(0))
	mBase = m.M
	v800 = m.ExcPending
	if v800 != 0 {
		goto L1
...
L135:
	;
	F_errfinish(m, int32(498177), int32(774), int32(322020))
	mBase = m.M
	v805 = m.ExcPending
	if v805 != 0 {
		goto L1
...
L137:
	;
	F_errmsg_internal(m, int32(453147), int32(0))
	mBase = m.M
	v813 = m.ExcPending
	if v813 != 0 {
		goto L1
...
L138:
	;
	F_errfinish(m, int32(498177), int32(782), int32(322020))
	mBase = m.M
	v818 = m.ExcPending
	if v818 != 0 {
		goto L1
...
L141:
	;
	F_errmsg(m, int32(30362), int32(0))
	mBase = m.M
	v829 = m.ExcPending
	if v829 != 0 {
		goto L1
...
L142:
	;
	F_errfinish(m, int32(498177), int32(832), int32(363107))
	mBase = m.M
	v834 = m.ExcPending
	if v834 != 0 {
		goto L1
...
L145:
	;
	F_errmsg(m, int32(16897), int32(0))
	mBase = m.M
	v845 = m.ExcPending
	if v845 != 0 {
		goto L1
...
L146:
	;
	F_errdetail(m, int32(611976), int32(0))
	mBase = m.M
	v849 = m.ExcPending
	if v849 != 0 {
		goto L1
...
L147:
	;
	F_errfinish(m, int32(498177), int32(852), int32(363107))
	mBase = m.M
	v854 = m.ExcPending
	if v854 != 0 {
		goto L1
...
L151:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+16)) = v342
	F_errdetail(m, int32(635873), v33+int32(16))
	mBase = m.M
	v873 = m.ExcPending
	if v873 != 0 {
		goto L1
...
L152:
	;
	F_errfinish(m, int32(498177), int32(862), int32(363107))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L1
...
L154:
	;
	F_errmsg_internal(m, int32(453189), int32(0))
	mBase = m.M
	v886 = m.ExcPending
	if v886 != 0 {
		goto L1
...
L155:
	;
	F_errfinish(m, int32(498177), int32(932), int32(363107))
	mBase = m.M
	v891 = m.ExcPending
	if v891 != 0 {
		goto L1
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = int32(394039)
	F_appendStringInfo(m, v10-int32(-64), int32(176542), v10+int32(48))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L1
...
L10:
	;
	F_appendStringInfoString(m, v10-int32(-64), int32(711945))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v24
	F_appendStringInfo(m, v10-int32(-64), int32(674995), v10+int32(32))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L14:
	;
	F_appendStringInfoString(m, v10-int32(-64), int32(736807))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
L32:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(394039)
	F_appendStringInfo(m, v10-int32(-64), int32(735363), v10+int32(16))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L1
...
L39:
	;
	F_errfinish(m, int32(495563), int32(2937), int32(300984))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L1
