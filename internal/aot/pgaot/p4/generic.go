								...
								if v31 == l1 {
									...
									if v40 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(4)
										F_errmsg_internal(m, int32(482719), v9)
										mBase = m.M
										v45 = m.ExcPending
										if v45 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(521590), int32(327), int32(237429))
											mBase = m.M
											v50 = m.ExcPending
											if v50 != 0 {
												return int32(0)
			...
			if v14 == int32(0) {
				...
				if v227 != 0 {
					...
					if v230 != 0 {
						...
						F_errmsg(m, int32(566005), int32(0))
						mBase = m.M
						v234 = m.ExcPending
						if v234 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(522650), int32(202), int32(416821))
							mBase = m.M
							v239 = m.ExcPending
							if v239 != 0 {
								return int32(0)
			...
			if v210 != 0 {
				...
				if v214 != 0 {
					...
					if v218 != 0 {
						...
						F_errfinish(m, int32(522650), int32(194), int32(416821))
						mBase = m.M
						v223 = m.ExcPending
						if v223 != 0 {
							return int32(0)
