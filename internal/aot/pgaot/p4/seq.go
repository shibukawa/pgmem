...
L4:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_ExecSeqScanWithQual[0]))
	if v22 != 0 {
		goto L7
	} else {
		goto L8
...
L12:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_ExecSeqScanWithQual[0]))
	if v35 != 0 {
		goto L14
	} else {
		goto L15
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+4)) = v38
	v47 = int32(_a_F_ExecSeqScanWithQual_0)
	v48 = *(*int32)(unsafe.Add(mBase, _c_F_ExecSeqScanWithQual[1]))
	v50 = *(*int32)(unsafe.Add(mBase, uint32(v13)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecSeqScanWithQual[1])) = v50
...
L23:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecSeqScanWithQual[1])) = v48
	if v55 != 0 {
		v68 = v38
		goto L3
	} else {
