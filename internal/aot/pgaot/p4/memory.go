...
L2:
	...
	v50 = F_strlen(m, v20)
	mBase = m.M
	v52 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1445])))
	*(*uint8)(unsafe.Add(mBase, uint32(v16)+34)) = uint8(v52)
	v55 = int32(*(*uint16)(unsafe.Add(mBase, _consts[1446])))
...
L3:
	;
	v21 = int32(320997)
	v24 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1297])))
...
L50:
	;
	v210 = *(*int32)(unsafe.Add(mBase, _consts[1412]))
	if int32(2) <= v19 {
		goto L53
	} else {
		goto L54
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v16 + int32(32)
	v253 = F_pg_fprintf(m, v210, int32(729219), v16)
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L18
...
L56:
	;
	v229 = F_pg_fprintf(m, v210, int32(727665), int32(0))
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L18
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v16 + int32(32)
	F_errmsg_internal(m, int32(174941), v16+int32(16))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L18
...
L65:
	;
	F_errfinish(m, int32(489485), int32(1044), int32(87555))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L18
