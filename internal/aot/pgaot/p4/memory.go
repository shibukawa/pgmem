...
L15:
	;
	v108 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1444])))
	*(*uint8)(unsafe.Add(mBase, uint32(v16)+34)) = uint8(v108)
	v111 = int32(*(*uint16)(unsafe.Add(mBase, _consts[1445])))
...
L101:
	;
	v378 = *(*int32)(unsafe.Add(mBase, _consts[1411]))
	if int32(2) <= v19 {
		goto L104
	} else {
		goto L105
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v16 + int32(32)
	v421 = F_pg_fprintf(m, v378, int32(726074), v16)
	mBase = m.M
	v422 = m.ExcPending
	if v422 != 0 {
		goto L52
...
L107:
	;
	v397 = F_pg_fprintf(m, v378, int32(724520), int32(0))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L52
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v16 + int32(32)
	F_errmsg_internal(m, int32(174110), v16+int32(16))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L52
...
L116:
	;
	F_errfinish(m, int32(487171), int32(1044), int32(87312))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L52
