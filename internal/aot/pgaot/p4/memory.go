...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v16 + int32(32)
	v421 = F_pg_fprintf(m, v378, int32(705968), v16)
	mBase = m.M
	v422 = m.ExcPending
	if v422 != 0 {
		goto L52
...
L107:
	;
	v397 = F_pg_fprintf(m, v378, int32(704414), int32(0))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L52
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v16 + int32(32)
	F_errmsg_internal(m, int32(165721), v16+int32(16))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L52
...
L116:
	;
	F_errfinish(m, int32(469866), int32(1044), int32(83529))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L52
