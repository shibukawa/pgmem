...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v16 + int32(32)
	v253 = F_pg_fprintf(m, v210, int32(776178), v16)
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L18
...
L56:
	;
	v229 = F_pg_fprintf(m, v210, int32(774624), int32(0))
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L18
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+28)) = v16 + int32(32)
	F_errmsg_internal(m, int32(184745), v16+int32(16))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L18
...
L65:
	;
	F_errfinish(m, int32(511728), int32(1044), int32(93743))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L18
