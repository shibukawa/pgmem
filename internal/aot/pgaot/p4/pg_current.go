			...
			if v23 != 0 {
				...
				if v27 != 0 {
					...
					if v31 != 0 {
						...
						F_errfinish(m, int32(495280), int32(282), int32(244764))
						mBase = m.M
						v36 = m.ExcPending
						if v36 != 0 {
							return int32(0)
