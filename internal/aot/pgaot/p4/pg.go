...
L33:
	;
	v123 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v31))))
	if v123 == int32(0) {
		goto L34
	} else {
		goto L35
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = l0
	v182 = F_pg_snprintf(m, v13+int32(48), int32(2048), int32(_a_F_RemovePgTempRelationFiles_2), v13+int32(32))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L49:
	;
	v415 = F_ReadDirExtended(m, v15, l0, int32(15))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L1
...
L50:
	;
	v186 = F_AllocateDir(m, v13+int32(48))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L1
...
L51:
	;
	v191 = F_ReadDirExtended(m, v186, v13+int32(48), int32(15))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L1
...
L56:
	;
	v203 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v194)+19)))
	if v203 != int32(116) {
		goto L58
	} else {
		goto L59
...
L58:
	;
	v390 = F_ReadDirExtended(m, v186, v13+int32(48), int32(15))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L1
...
L60:
	;
	v220 = v210 + int32(1)
	v222 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v210+v207))))
	if base.Ui32((v222-int32(48))&int32(255)) < base.Ui32(int32(10)) {
		v210 = v220
		goto L60
	} else {
		goto L62
...
L65:
	...
	if base.Ui32((v248-int32(48))&int32(255)) < base.Ui32(int32(10)) {
		v238 = v246
		goto L65
	} else {
		goto L67
...
L69:
	...
	v259 = v247 + int32(1)
	v263 = int32(3)
	v266 = F_strncmp(m, int32(_a_F_RemovePgTempRelationFiles_3), v259, v263)
	mBase = m.M
	if v266 == int32(0) {
		goto L76
	} else {
...
L78:
	;
	v270 = int32(2)
	v274 = F_strncmp(m, int32(_a_F_RemovePgTempRelationFiles_4), v259, v270)
	mBase = m.M
	if v274 == int32(0) {
		v288 = v270
		goto L75
...
L79:
	;
	v277 = int32(4)
	v280 = F_strncmp(m, int32(_a_F_RemovePgTempRelationFiles_5), v259, v277)
	mBase = m.M
	if v280 == int32(0) {
		goto L80
	} else {
...
L86:
	;
	v299 = v295 + v246
	v301 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v207+v299))))
	v303 = v299
	v304 = v301
	goto L71
L87:
...
L90:
	;
	v322 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v310+(v303+v207)))))
...
L94:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+20)) = v207
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v13 + int32(48)
	v351 = F_pg_snprintf(m, v13+int32(2096), int32(2048), int32(_a_F_RemovePgTempRelationFiles_2), v13+int32(16))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L1
...
L95:
	;
	v355 = F_unlink(m, v13+int32(2096))
	mBase = m.M
	if int32(0) <= v355 {
		goto L58
	} else {
...
L14:
	;
	if base.Ui32(int32(64)) <= base.Ui32(v91) {
		goto L3
	} else {
		goto L31
	}
...
L32:
	;
	*(*int64)(unsafe.Add(mBase, uint32(v96)+24)) = v107 + v106*int64(1000000) - int64(946684800000000)
	v118 = v96 + int32(32)
	goto L36
L33:
	;
...
L58:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v172))) = v176
	v184 = int32(4)
	v185 = v172 + v184
	v187 = v171 + v184
	v189 = v173 - v184
...
L65:
	;
	F_XLogRegisterData(m, v96+int32(24), int32(72))
	mBase = m.M
	v240 = m.ExcPending
	if v240 != 0 {
		goto L1
...
L66:
	;
	v243 = F_XLogInsert(m, int32(0), int32(112))
	mBase = m.M
	v244 = m.ExcPending
	if v244 != 0 {
		goto L1
...
L69:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v96))) = v33
	*(*uint32)(unsafe.Add(mBase, uint32(v96)+8)) = uint32(v243)
	v252 = int64(base.Ui64(v243) >> (uint(int64(32)) % 64))
	*(*uint32)(unsafe.Add(mBase, uint32(v96)+4)) = uint32(v252)
	F_errmsg(m, int32(_a_F_pg_create_restore_point_0), v96)
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L1
...
L40:
	;
	v316 = *(*int32)(unsafe.Add(mBase, uint32(v94)))
	v318 = v316 - int32(474)
	if base.Ui32(v318) <= base.Ui32(int32(3)) {
		goto L70
	} else {
		goto L71
	}
...
L43:
	;
	v312 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v20)+1105)) = uint8(v312)
	goto L40
L44:
	;
	if int32(1024) <= v291 {
...
L47:
	;
	v242 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v233))))
	if v242 == int32(0) {
		goto L48
	} else {
		goto L49
...
L61:
	;
	v295 = F_pg_mbcliplen(m, v233, v291, int32(1023))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L1
...
L65:
	...
	v303 = v20 - int32(-64)
	v305 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v303+v297))) = uint8(v305)
	v309 = F_cstring_to_text(m, v303)
	mBase = m.M
	v310 = m.ExcPending
	if v310 != 0 {
		goto L1
...
L66:
	;
	v300 = F__emscripten_memcpy_bulkmem(m, v20-int32(-64), v233, v297)
	mBase = m.M
	goto L68
L67:
	;
...
L69:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1124)) = v309
	goto L40
L70:
	;
	v325 = *(*int32)(unsafe.Add(mBase, uint32(v318<<(uint(int32(2))%32))+uint32(_c_F_pg_get_backend_memory_contexts[3])))
	v326 = v325
	goto L72
L71:
	;
	v326 = int32(_a_F_pg_get_backend_memory_contexts_5)
	goto L72
L72:
	;
	v327 = F_cstring_to_text(m, v326)
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L1
...
L73:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1128)) = v327
	if v145 == int32(0) {
		goto L75
	} else {
		goto L76
...
L74:
	;
	v394 = F_construct_array_builtin(m, v379, v381, int32(23))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L1
...
L75:
	;
	v332 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1132)) = v332
	v336 = F_palloc(m, v332)
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L77:
	;
	v338 = *(*int32)(unsafe.Add(mBase, uint32(v145)+4))
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1132)) = v338
	v342 = F_palloc(m, v338<<(uint(int32(2))%32))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L1
...
L79:
	;
	v344 = int32(0)
	v345 = *(*int32)(unsafe.Add(mBase, uint32(v145)+4))
	if v345 <= v344 {
		v379 = v342
		v381 = v338
		goto L74
...
L81:
	;
	v366 = v350 << (uint(int32(2)) % 32)
	v368 = *(*int32)(unsafe.Add(mBase, uint32(v145)+12))
	v370 = *(*int32)(unsafe.Add(mBase, uint32(v368+v366)))
	*(*int32)(unsafe.Add(mBase, uint32(v342+v366))) = v370
	v373 = v350 + int32(1)
	v374 = *(*int32)(unsafe.Add(mBase, uint32(v145)+4))
	if v373 < v374 {
		v350 = v373
		goto L81
	} else {
...
L84:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1136)) = v394
	v397 = int64(*(*uint32)(unsafe.Add(mBase, uint32(v20)+1096)))
	v398 = F_Int64GetDatum(m, v397)
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L1
...
L85:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1140)) = v398
	v401 = int64(*(*uint32)(unsafe.Add(mBase, uint32(v20)+1088)))
	v402 = F_Int64GetDatum(m, v401)
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L1
...
L86:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1144)) = v402
	v405 = int64(*(*uint32)(unsafe.Add(mBase, uint32(v20)+1100)))
	v406 = F_Int64GetDatum(m, v405)
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L1
...
L87:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1148)) = v406
	v409 = int64(*(*uint32)(unsafe.Add(mBase, uint32(v20)+1092)))
	v410 = F_Int64GetDatum(m, v409)
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L1
...
L88:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1152)) = v410
	v413 = *(*int32)(unsafe.Add(mBase, uint32(v20)+1096))
	v414 = *(*int32)(unsafe.Add(mBase, uint32(v20)+1100))
	v417 = F_Int64GetDatum(m, base.I64_extend_i32_u(v413-v414))
	mBase = m.M
	v418 = m.ExcPending
	if v418 != 0 {
		goto L1
...
L89:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+1156)) = v417
...
L91:
	;
	v428 = *(*int32)(unsafe.Add(mBase, uint32(v20)+8))
...
L94:
	...
	v467 = int32(1)
	v470 = v68 + v467
	v471 = *(*int32)(unsafe.Add(mBase, uint32(v46)+4))
	if v470 < v471 {
		v68 = v470
		v70 = v70 + v467
		v72 = v461
...
L97:
	;
	v449 = *(*int32)(unsafe.Add(mBase, uint32(v430)+28))
	if v449 != 0 {
		v430 = v449
		v441 = v447
		goto L95
...
L176:
	;
	v516 = *(*int32)(unsafe.Add(mBase, uint32(v15+int32(192)+v355<<(uint(int32(2))%32))))
	*(*int32)(unsafe.Add(mBase, uint32(v15)+160)) = v516
	v521 = F_pg_sprintf(m, v377, int32(_a_F_pg_inet_net_ntop_2), v15+int32(160))
	mBase = m.M
	v522 = m.ExcPending
	if v522 != 0 {
		goto L9
...
L201:
	;
	v460 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v377))))
	if v460 == int32(0) {
		goto L202
	} else {
		goto L203
...
L219:
	;
	v536 = int32(58)
	*(*uint8)(unsafe.Add(mBase, uint32(v530))) = uint8(v536)
	v540 = v530 + int32(1)
	goto L217
L220:
	;
	if base.Ui32(int32(50)) < base.Ui32(v554-(v15+int32(224))) {
		goto L224
	} else {
		goto L225
	}
...
L222:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+80)) = l2
	v551 = F_pg_sprintf(m, v540, int32(_a_F_pg_inet_net_ntop_1), v15+int32(80))
	mBase = m.M
	v552 = m.ExcPending
	if v552 != 0 {
		goto L9
...
L235:
	...
	v595 = int32(-2139062144)
	if (int32(16843008)-v592|v592)&v595 != v595 {
		v617 = v588
		v618 = v592
		v619 = v590
		goto L229
...
L236:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v576))) = uint8(v577)
	if v577 == int32(0) {
		goto L228
	} else {
		goto L238
...
L241:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v602))) = v601
	v604 = int32(4)
	v605 = v602 + v604
	v606 = *(*int32)(unsafe.Add(mBase, uint32(v600)+4))
	v608 = v600 + v604
	v612 = int32(-2139062144)
	if (v606|(int32(16843008)-v606))&v612 == v612 {
		v600 = v608
		v601 = v606
		v602 = v605
		goto L241
...
L245:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v628)+1)) = uint8(v629)
	v631 = int32(1)
	if v629 != 0 {
		v626 = v626 + v631
		v628 = v628 + v631
