...
L1:
	;
	v15 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v7)+uint32(_consts[1565]))) = uint8(v15)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+uint32(_consts[1566]))) = l1
	v18 = int32(769)
	*(*uint16)(unsafe.Add(mBase, uint32(v7)+uint32(_consts[1567]))) = uint16(v18)
	*(*uint16)(unsafe.Add(mBase, uint32(v7)+uint32(_consts[1568]))) = uint16(v3)
	v21 = int32(20)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+uint32(_consts[912]))) = v21
...
func F_nepali_UTF_8_stem(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v8
	v13 = F_find_among_b(m, l0, int32(4258880), int32(17))
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		goto L3
...
L12:
	...
	v40 = F_memcmp(m, v37+v33-v29, int32(2160194), v29)
	mBase = m.M
	if v40 != 0 {
		v44 = v31
		goto L11
...
L17:
	...
	v60 = F_memcmp(m, v57+v47-v49, int32(2160197), v49)
	mBase = m.M
	if v60 != 0 {
		v64 = v51
		goto L16
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v254
	v259 = F_find_among_b(m, l0, int32(4259360), int32(91))
	mBase = m.M
	v260 = m.ExcPending
	if v260 != 0 {
		goto L3
...
L27:
	;
	v108 = F_find_among_b(m, l0, int32(4259232), int32(3))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L3
...
L32:
	;
	v139 = F_find_among_b(m, l0, int32(4259296), int32(3))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L3
...
L40:
	...
	v159 = F_memcmp(m, v156+v152-v148, int32(2160378), v148)
	mBase = m.M
	if v159 != 0 {
		v163 = v150
		goto L39
...
L45:
	...
	v179 = F_memcmp(m, v176+v166-v168, int32(2160384), v168)
	mBase = m.M
	if v179 != 0 {
		v183 = v170
		goto L44
...
L50:
	...
	v198 = F_memcmp(m, v195+v185-v187, int32(2160390), v187)
	mBase = m.M
	if v198 != 0 {
		v202 = v189
		goto L49
...
L55:
	...
	v217 = F_memcmp(m, v214+v204-v206, int32(2160396), v206)
	mBase = m.M
	if v217 != 0 {
		v221 = v208
		goto L54
...
L62:
	...
	v240 = F_memcmp(m, v237+v233-v229, int32(2160402), v229)
	mBase = m.M
	if v240 != 0 {
		v244 = v231
		goto L61
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31))) = v37
	F_errmsg_internal(m, int32(8957), v31)
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L8
...
L10:
	;
	F_errfinish(m, int32(475683), int32(870), int32(275308))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L8
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+16)) = v244
	F_errmsg_internal(m, int32(466576), v31+int32(16))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L8
...
L46:
	;
	F_errfinish(m, int32(475683), int32(257), int32(294557))
	mBase = m.M
	v255 = m.ExcPending
	if v255 != 0 {
		goto L8
...
L6:
	...
	v40 = *(*int32)(unsafe.Add(mBase, _consts[159]))
...
L11:
	;
	F_PreventCommandIfReadOnly(m, int32(646593))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L1
...
L13:
	;
	F_PreventCommandIfParallelMode(m, int32(646593))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L1
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _consts[445])) = v54
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+16)) = v195 + int32(4)
	F_errmsg(m, int32(640149), v27+int32(16))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L1
...
L61:
	;
	F_errfinish(m, int32(480220), int32(750), int32(298787))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L1
...
L105:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+48)) = v395 + int32(4)
	F_errmsg(m, int32(187179), v27+int32(48))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L1
...
L106:
	;
	F_errfinish(m, int32(480220), int32(655), int32(298787))
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L1
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27))) = l0
	F_errmsg_internal(m, int32(50788), v27)
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L1
...
L109:
	;
	F_errfinish(m, int32(480220), int32(680), int32(298787))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L112:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+32)) = v429 + int32(4)
	F_errmsg(m, int32(640204), v27+int32(32))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L1
...
L113:
	;
	F_errfinish(m, int32(480220), int32(769), int32(298787))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L1
...
L2:
	;
	v515 = *(*int32)(unsafe.Add(mBase, uint32(v503)))
	v517 = v515
	goto L1
L3:
	;
	v475 = v466 + v472
	v478 = l2 + v19<<(uint(int32(4))%32)
	v479 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v478)+26)))
	if v479 != int32(1) {
		v517 = v475
		goto L1
	} else {
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v105
	F_errmsg_internal(m, int32(464696), v16+int32(16))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L21
...
L63:
	;
	v458 = *(*int32)(unsafe.Add(mBase, uint32(l0)+16))
	v459 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v458)+20)))
	v284 = v284 + int32(1)
...
L80:
	;
	v452 = int32(base.Ui32(v367) >> (uint(int32(1)) % 32))
	goto L63
L81:
	;
	goto L82
L82:
	...
	v452 = int32(base.Ui32(v390) >> (uint(int32(2)) % 32))
	goto L63
L83:
	;
	v452 = v449 + int32(1)
...
L86:
	;
	v400 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v364))))
	if v400 == int32(0) {
		goto L87
	} else {
		goto L88
...
L100:
	;
	v482 = int32(*(*int16)(unsafe.Add(mBase, uint32(v478)+24)))
	switch v482&int32(65535) - int32(1) {
	case 0:
		goto L103
	case 1:
		goto L102
...
L102:
	;
	v488 = int32(*(*int16)(unsafe.Add(mBase, uint32(v475))))
	v517 = v488
	goto L1
L103:
	;
	v487 = int32(*(*int8)(unsafe.Add(mBase, uint32(v475))))
	v517 = v487
	goto L1
L104:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v482
...
func F_now(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v3 = *(*int64)(unsafe.Add(mBase, _consts[207]))
	...
	if v13 != 0 {
		...
		if int32(4) <= v8 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = (v8<<(uint(v21)%32) - int32(8388608)) >> (uint(v21) % 32)
			v30 = F_pg_snprintf(m, v10, int32(64), int32(641248), v6)
			mBase = m.M
			v31 = m.ExcPending
			if v31 != 0 {
				return int32(0)
