...
func F_nepali_UTF_8_stem(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v8
	v13 = F_find_among_b(m, l0, int32(4316320), int32(17))
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		goto L3
...
L12:
	...
	v40 = F_memcmp(m, v37+v33-v29, int32(2211554), v29)
	mBase = m.M
	if v40 != 0 {
		v44 = v31
		goto L11
...
L17:
	...
	v60 = F_memcmp(m, v57+v47-v49, int32(2211557), v49)
	mBase = m.M
	if v60 != 0 {
		v64 = v51
		goto L16
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v254
	v259 = F_find_among_b(m, l0, int32(4316800), int32(91))
	mBase = m.M
	v260 = m.ExcPending
	if v260 != 0 {
		goto L3
...
L27:
	;
	v108 = F_find_among_b(m, l0, int32(4316672), int32(3))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L3
...
L32:
	;
	v139 = F_find_among_b(m, l0, int32(4316736), int32(3))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L3
...
L40:
	...
	v159 = F_memcmp(m, v156+v152-v148, int32(2211738), v148)
	mBase = m.M
	if v159 != 0 {
		v163 = v150
		goto L39
...
L45:
	...
	v179 = F_memcmp(m, v176+v166-v168, int32(2211744), v168)
	mBase = m.M
	if v179 != 0 {
		v183 = v170
		goto L44
...
L50:
	...
	v198 = F_memcmp(m, v195+v185-v187, int32(2211750), v187)
	mBase = m.M
	if v198 != 0 {
		v202 = v189
		goto L49
...
L55:
	...
	v217 = F_memcmp(m, v214+v204-v206, int32(2211756), v206)
	mBase = m.M
	if v217 != 0 {
		v221 = v208
		goto L54
...
L62:
	...
	v240 = F_memcmp(m, v237+v233-v229, int32(2211762), v229)
	mBase = m.M
	if v240 != 0 {
		v244 = v231
		goto L61
...
L10:
	;
	F_errfinish(m, int32(495951), int32(870), int32(287951))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L8
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+16)) = v244
	F_errmsg_internal(m, int32(486306), v31+int32(16))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L8
...
L46:
	;
	F_errfinish(m, int32(495951), int32(257), int32(307636))
	mBase = m.M
	v255 = m.ExcPending
	if v255 != 0 {
		goto L8
...
L11:
	;
	F_PreventCommandIfReadOnly(m, int32(685450))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L1
...
L13:
	;
	F_PreventCommandIfParallelMode(m, int32(685450))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L1
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+16)) = v195 + int32(4)
	F_errmsg(m, int32(678763), v27+int32(16))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L1
...
L61:
	;
	F_errfinish(m, int32(500717), int32(750), int32(312338))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L1
...
L105:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+48)) = v395 + int32(4)
	F_errmsg(m, int32(196195), v27+int32(48))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L1
...
L106:
	;
	F_errfinish(m, int32(500717), int32(655), int32(312338))
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L1
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27))) = l0
	F_errmsg_internal(m, int32(53050), v27)
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L1
...
L109:
	;
	F_errfinish(m, int32(500717), int32(680), int32(312338))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L112:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+32)) = v429 + int32(4)
	F_errmsg(m, int32(678818), v27+int32(32))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L1
...
L113:
	;
	F_errfinish(m, int32(500717), int32(769), int32(312338))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L1
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v105
	F_errmsg_internal(m, int32(484426), v16+int32(16))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L21
	...
	if v13 != 0 {
		...
		if int32(4) <= v8 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = (v8<<(uint(v21)%32) - int32(8388608)) >> (uint(v21) % 32)
			v30 = F_pg_snprintf(m, v10, int32(64), int32(679862), v6)
			mBase = m.M
			v31 = m.ExcPending
			if v31 != 0 {
				return int32(0)
