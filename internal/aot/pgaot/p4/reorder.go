...
L39:
	;
	v218 = *(*int32)(unsafe.Add(mBase, _consts[834]))
	if v218 == int32(0) {
		goto L66
	} else {
		goto L67
...
L66:
	...
	v223 = *(*int32)(unsafe.Add(mBase, _consts[835]))
...
L70:
	...
	v240 = *(*int32)(unsafe.Add(mBase, _consts[835]))
...
L75:
	;
	v247 = *(*int32)(unsafe.Add(mBase, _consts[834]))
	if v247 != int32(1) {
		goto L1
	} else {
		goto L76
