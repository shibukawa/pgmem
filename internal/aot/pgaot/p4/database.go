...
func F_rebuild_database_list(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+76)) = l0
	...
	v28 = F_AllocSetContextCreateInternal(m, v23, int32(74434), v2, int32(8192), int32(8388608))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L2:
	;
	v34 = F_AllocSetContextCreateInternal(m, v28, int32(649892), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v19)+44)) = int64(137438953476)
	v48 = F_hash_create(m, int32(317757), int32(20), v19+int32(28), int32(1064))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v335)+20)) = int32(4088496)
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v360)+20)) = int32(4088496)
...
L72:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v401)+20)) = int32(4088496)
