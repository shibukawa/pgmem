...
L2:
	;
	v34 = F_AllocSetContextCreateInternal(m, v28, int32(675941), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v19)+44)) = int64(137438953476)
	v48 = F_hash_create(m, int32(323566), int32(20), v19+int32(28), int32(1064))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v335)+20)) = int32(4121584)
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v360)+20)) = int32(4121584)
...
L72:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v401)+20)) = int32(4121584)
