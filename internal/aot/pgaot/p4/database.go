...
func F_GetDatabasePath(m *base.Module, l0 int32, l1 int32) int32 {
	...
	case 0:
		*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = l0
		v19 = F_psprintf(m, int32(36869), v6+int32(16))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int32(0)
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(467736)
		v28 = F_psprintf(m, int32(36835), v6)
		mBase = m.M
		v29 = m.ExcPending
		if v29 != 0 {
			return int32(0)
...
func F_rebuild_database_list(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+76)) = l0
	...
	v28 = F_AllocSetContextCreateInternal(m, v23, int32(72404), v2, int32(8192), int32(8388608))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L2:
	;
	v34 = F_AllocSetContextCreateInternal(m, v28, int32(636029), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v19)+44)) = int64(137438953476)
	v48 = F_hash_create(m, int32(308880), int32(20), v19+int32(28), int32(1064))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v335)+20)) = int32(4063104)
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v360)+20)) = int32(4063104)
...
L72:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v401)+20)) = int32(4063104)
