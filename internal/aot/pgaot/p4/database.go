...
func F_GetDatabasePath(m *base.Module, l0 int32, l1 int32) int32 {
	...
	case 0:
		*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = l0
		v19 = F_psprintf(m, int32(42063), v6+int32(16))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int32(0)
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(513062)
		v28 = F_psprintf(m, int32(42029), v6)
		mBase = m.M
		v29 = m.ExcPending
		if v29 != 0 {
			return int32(0)
...
func F_has_database_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v22 = F_convert_any_priv_string(m, v14, int32(1693776))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					v20 = F_convert_any_priv_string(m, v11, int32(1693776))
					mBase = m.M
					v21 = m.ExcPending
					if v21 != 0 {
						return int32(0)
			...
			if v14 != 0 {
				...
				if v17 != 0 {
					...
					if v20 != 0 {
						...
						v22 = F_convert_any_priv_string(m, v11, int32(1693776))
						mBase = m.M
						v23 = m.ExcPending
						if v23 != 0 {
							return int32(0)
...
func F_rebuild_database_list(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+76)) = l0
	v23 = *(*int32)(unsafe.Add(mBase, _consts[658]))
	v28 = F_AllocSetContextCreateInternal(m, v23, int32(81632), v2, int32(8192), int32(8388608))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L2:
	;
	v34 = F_AllocSetContextCreateInternal(m, v28, int32(709769), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v19)+44)) = int64(137438953476)
	v48 = F_hash_create(m, int32(340409), int32(20), v19+int32(28), int32(1064))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L5:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[704]))
	if v67 == int32(0) {
		v111 = v65
		goto L10
	} else {
...
L21:
	;
	v191 = int32(4164176)
	*(*int32)(unsafe.Add(mBase, _consts[704])) = v191
	*(*int32)(unsafe.Add(mBase, _consts[705])) = v191
...
L33:
	;
	v438 = *(*int32)(unsafe.Add(mBase, _consts[706]))
	if v438 != 0 {
		goto L73
	} else {
		goto L74
...
L45:
	;
	v266 = int32(0)
	v269 = *(*int32)(unsafe.Add(mBase, _consts[717]))
...
L60:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v335)+8)) = v286 + v330
	v339 = v335 + int32(20)
	v341 = *(*int32)(unsafe.Add(mBase, _consts[704]))
	if v341 == int32(0) {
		goto L62
	} else {
		goto L63
...
L62:
	;
	v344 = int32(4164176)
	*(*int32)(unsafe.Add(mBase, _consts[705])) = v344
	v348 = v344
	goto L64
L63:
	;
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v335)+20)) = int32(4164176)
	*(*int32)(unsafe.Add(mBase, uint32(v335)+24)) = v348
	*(*int32)(unsafe.Add(mBase, uint32(v348))) = v339
	v353 = int32(4164180)
	*(*int32)(unsafe.Add(mBase, _consts[704])) = v339
	v355 = v330 + (v286 + v286)
	*(*int64)(unsafe.Add(mBase, uint32(v335)+40)) = v355
	v358 = v335 + int32(52)
	v360 = v335 + int32(32)
	v362 = *(*int32)(unsafe.Add(mBase, _consts[704]))
	if v362 == int32(0) {
		goto L65
	} else {
		goto L66
...
L65:
	;
	v365 = int32(4164176)
	*(*int32)(unsafe.Add(mBase, _consts[705])) = v365
	v369 = v365
	goto L67
L66:
	;
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v360)+20)) = int32(4164176)
	*(*int32)(unsafe.Add(mBase, uint32(v360)+24)) = v369
	*(*int32)(unsafe.Add(mBase, uint32(v369))) = v358
	*(*int32)(unsafe.Add(mBase, _consts[704])) = v358
	v376 = int32(2)
	v377 = v320 + v376
	v379 = v322 + v376
...
L69:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v401)+8)) = v286 + v394
	v405 = v401 + int32(20)
	v407 = *(*int32)(unsafe.Add(mBase, _consts[704]))
	if v407 == int32(0) {
		goto L70
	} else {
		goto L71
...
L70:
	;
	v410 = int32(4164176)
	*(*int32)(unsafe.Add(mBase, _consts[705])) = v410
	v414 = v410
	goto L72
L71:
	;
...
L72:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v401)+20)) = int32(4164176)
	*(*int32)(unsafe.Add(mBase, uint32(v401)+24)) = v414
	*(*int32)(unsafe.Add(mBase, uint32(v414))) = v405
	*(*int32)(unsafe.Add(mBase, _consts[704])) = v405
	goto L33
L73:
	;
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, _consts[706])) = v28
	m.G0 = v19 + int32(80)
	return
}
