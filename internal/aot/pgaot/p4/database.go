...
func F_rebuild_database_list(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+76)) = l0
	...
	v28 = F_AllocSetContextCreateInternal(m, v23, int32(81621), v2, int32(8192), int32(8388608))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L2:
	;
	v34 = F_AllocSetContextCreateInternal(m, v28, int32(708722), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v19)+44)) = int64(137438953476)
	v48 = F_hash_create(m, int32(340087), int32(20), v19+int32(28), int32(1064))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L5:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[708]))
	if v67 == int32(0) {
		v111 = v65
		goto L10
	} else {
...
L33:
	;
	v438 = *(*int32)(unsafe.Add(mBase, _consts[710]))
	if v438 != 0 {
		goto L73
	} else {
		goto L74
...
L45:
	;
	v266 = int32(0)
	v269 = *(*int32)(unsafe.Add(mBase, _consts[721]))
...
L60:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v335)+8)) = v286 + v330
	v339 = v335 + int32(20)
	v341 = *(*int32)(unsafe.Add(mBase, _consts[708]))
	if v341 == int32(0) {
		goto L62
	} else {
		goto L63
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v335)+20)) = int32(4164144)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v335)+40)) = v355
	v358 = v335 + int32(52)
	v360 = v335 + int32(32)
	v362 = *(*int32)(unsafe.Add(mBase, _consts[708]))
	if v362 == int32(0) {
		goto L65
	} else {
		goto L66
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v360)+20)) = int32(4164144)
...
L69:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v401)+8)) = v286 + v394
	v405 = v401 + int32(20)
	v407 = *(*int32)(unsafe.Add(mBase, _consts[708]))
	if v407 == int32(0) {
		goto L70
	} else {
		goto L71
...
L72:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v401)+20)) = int32(4164144)
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, _consts[710])) = v28
	m.G0 = v19 + int32(80)
	return
}
