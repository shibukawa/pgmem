...
L11:
	...
	*(*int32)(unsafe.Add(mBase, _consts[231])) = int32(4416112)
	v190 = int32(0)
...
L41:
	...
	F_ShowTransactionStateRec(m, int32(258692), v249)
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L1
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v270
	F_errmsg_internal(m, int32(353247), v10)
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L1
...
L52:
	;
	F_errfinish(m, int32(494614), int32(5283), int32(258692))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L1
...
L15:
	...
	F_ShowTransactionStateRec(m, int32(258793), v50)
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L18
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v71
	F_errmsg_internal(m, int32(353362), v8)
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L18
...
L27:
	;
	F_errfinish(m, int32(494614), int32(5391), int32(258793))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L18
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v85))) = v115
	F_errmsg_internal(m, int32(713906), v85)
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L18
...
L49:
	;
	F_errfinish(m, int32(498326), int32(1120), int32(153972))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L18
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v44)+44)) = v46
	...
	v55 = F_AllocSetContextCreateInternal(m, v50, int32(62461), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L3
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v30
	F_errmsg_internal(m, int32(353285), v8)
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L3
...
L9:
	;
	F_errfinish(m, int32(494614), int32(5073), int32(258712))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L3
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, _consts[28])) = v55
	...
	v66 = F_ResourceOwnerCreate(m, v64, int32(258828))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L3
...
L48:
	...
	F_ShowTransactionStateRec(m, int32(258712), v201)
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L3
...
L13:
	...
	v37 = F_SimpleLruReadPage_ReadOnly(m, int32(4415176), base.I64_extend_i32_u(v35), v12)
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L16
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v12
	F_errmsg_internal(m, int32(53843), v8)
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L16
...
L31:
	;
	F_errfinish(m, int32(495018), int32(185), int32(258501))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L16
...
func F_SubTransSetParent(m *base.Module, l0 int32, l1 int32) {
	...
	if v18 != 0 {
		...
		v22 = F_SimpleLruReadPage(m, int32(4415176), base.I64_extend_i32_u(v9), int32(1), l0)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
