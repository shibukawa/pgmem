...
L7:
	;
	v45 = int32(_a_F_AbortSubTransaction_1)
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[8]))
	v48 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[8])) = v47 + v48
	...
	*(*int32)(unsafe.Add(mBase, uint32(v35))) = v51 + int32(2)
	v65 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[8]))
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[8])) = v65 - v48
	goto L4
L8:
	;
	F_UnlockBuffers(m)
...
L9:
	;
	v73 = int32(0)
	v79 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[9]))
	if v79 <= v73 {
		goto L11
	} else {
		goto L12
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[11])) = int32(_a_F_AbortSubTransaction_2)
	v190 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[9])) = v190
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[12])) = v190
	*(*uint8)(unsafe.Add(mBase, _c_F_AbortSubTransaction[13])) = uint8(v190)
	*(*uint8)(unsafe.Add(mBase, _c_F_AbortSubTransaction[14])) = uint8(v190)
	goto L10
L12:
	;
	v83 = v79 & int32(7)
	v85 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[15]))
...
L16:
	;
	v96 = int32(_a_F_AbortSubTransaction_3)
	v99 = int32(0)
...
L20:
	;
	v171 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v85+v163*int32(_a_F_AbortSubTransaction_3)))) = uint8(v171)
	v173 = int32(1)
	v176 = v164 + v173
	if v176 != v83 {
		v163 = v163 + v173
...
L29:
	;
	v218 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[16]))
	goto L32
L30:
	;
	v230 = int32(0)
...
L38:
	;
	v234 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[17]))
	if v234 != int32(2) {
		v245 = v230
		goto L28
	} else {
...
L39:
	;
	v238 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_AbortSubTransaction[18])))
	if v238 != 0 {
		v245 = v230
		goto L28
	} else {
...
L40:
	;
	v242 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[19]))
	v245 = int32(0) | base.B2i32(v242 <= v211)
	goto L28
L41:
	;
	v249 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[3]))
	F_ShowTransactionStateRec(m, int32(_a_F_AbortSubTransaction_5), v249)
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L1
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[20])) = v284
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[21])) = v283
	goto L54
L46:
	;
...
L49:
	;
	v268 = *(*int32)(unsafe.Add(mBase, uint32(v261<<(uint(int32(2))%32))+uint32(_c_F_AbortSubTransaction[22])))
	v270 = v268
	goto L51
L50:
	;
	v270 = int32(_a_F_AbortSubTransaction_6)
	goto L51
L51:
	;
...
L54:
	...
	v291 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[23]))
	if v289 <= v291 {
		goto L56
	} else {
		goto L57
...
L55:
	;
	v306 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_AbortSubTransaction[24])) = uint8(v306)
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[25])) = v306
	goto L59
L56:
	;
	v294 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[26])) = v294
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[27])) = v294
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[28])) = v294
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[23])) = v294
	goto L58
L57:
	;
	goto L58
...
L63:
	...
	*(*uint8)(unsafe.Add(mBase, _c_F_AbortSubTransaction[29])) = uint8(v597)
	v599 = int32(_a_F_AbortSubTransaction_0)
	v601 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[2])) = v601 - int32(1)
	m.G0 = v10 + int32(16)
	return
L64:
	;
...
L66:
	;
	v335 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[3]))
...
L68:
	;
	v345 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[30]))
	if v345 == int32(0) {
		goto L70
	} else {
		goto L71
...
L69:
	;
	v356 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[31]))
	if v356 == int32(0) {
		goto L74
	} else {
		goto L75
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[30])) = v351
	F_pfree(m, v345)
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[31])) = v369
	F_pfree(m, v360)
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
...
L79:
	;
	v374 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[31]))
	if v374 != 0 {
		v360 = v374
		goto L76
	} else {
...
L82:
	;
	v387 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[3]))
...
L84:
	;
	v398 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[32]))
	if v398 != 0 {
		goto L89
	} else {
		goto L90
...
L106:
	...
	v475 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[33]))
	if v471 == v475 {
		goto L108
	} else {
		goto L109
...
L113:
	;
	v480 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_AbortSubTransaction[34])) = uint8(v480)
	v483 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[35])) = v483
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[33])) = v483
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[36])) = v483
	*(*uint8)(unsafe.Add(mBase, _c_F_AbortSubTransaction[37])) = uint8(v483)
	v495 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[38]))
...
L116:
	...
	v515 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[39]))
	if v515 != 0 {
		goto L118
	} else {
		goto L119
...
L120:
	;
	v551 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[40]))
	if v551 != 0 {
		goto L130
	} else {
		goto L131
...
L127:
	;
	v537 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[39]))
	v538 = v537
	goto L124
L128:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[39])) = v525
	if v525 != 0 {
		v518 = v525
		goto L121
	} else {
...
L130:
	;
	v553 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[38]))
	v554 = *(*int32)(unsafe.Add(mBase, uint32(v553)+40))
	v556 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[40]))
	v558 = v556 - int32(48)
...
L132:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[41])) = v576
	v580 = *(*int32)(unsafe.Add(mBase, _c_F_AbortSubTransaction[38]))
...
L12:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[2]))
	if v35 != int32(2) {
		v46 = v31
		goto L2
	} else {
...
L13:
	;
	v39 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[3])))
	if v39 != 0 {
		v46 = v31
		goto L2
	} else {
...
L14:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[4]))
	v46 = int32(0) | base.B2i32(v43 <= v12)
	goto L2
L15:
	;
	v50 = *(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[0]))
	F_ShowTransactionStateRec(m, int32(_a_F_CleanupSubTransaction_0), v50)
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L18
...
L20:
	...
	v85 = v83 - int32(32)
	m.G0 = v85
	v90 = *(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[5]))
...
L24:
	;
	v69 = *(*int32)(unsafe.Add(mBase, uint32(v62<<(uint(int32(2))%32))+uint32(_c_F_CleanupSubTransaction[6])))
	v71 = v69
	goto L26
L25:
	;
	v71 = int32(_a_F_CleanupSubTransaction_1)
	goto L26
L26:
	;
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[7])) = v144
	*(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[8])) = v144
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v85))) = v115
	F_errmsg_internal(m, int32(_a_F_CleanupSubTransaction_5), v85)
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L18
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+40)) = int32(0)
	v155 = *(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[0]))
	v156 = *(*int32)(unsafe.Add(mBase, uint32(v155)+44))
	*(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[9])) = v156
	v159 = *(*int32)(unsafe.Add(mBase, uint32(v155)+80))
	v160 = *(*int32)(unsafe.Add(mBase, uint32(v159)+36))
	*(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[10])) = v160
	v163 = *(*int32)(unsafe.Add(mBase, _c_F_CleanupSubTransaction[11]))
	if v163 != 0 {
		goto L58
	} else {
		goto L59
...
func F_StartSubTransaction(m *base.Module) {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[0]))
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = int32(1)
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[0]))
	v46 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v44)+44)) = v46
	v48 = int32(_a_F_StartSubTransaction_0)
	v50 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[2]))
	v55 = F_AllocSetContextCreateInternal(m, v50, int32(_a_F_StartSubTransaction_1), int32(0), int32(_a_F_StartSubTransaction_2), int32(_a_F_StartSubTransaction_3))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L3
...
L6:
	;
	v28 = *(*int32)(unsafe.Add(mBase, uint32(v21<<(uint(int32(2))%32))+uint32(_c_F_StartSubTransaction[3])))
	v30 = v28
	goto L8
L7:
	;
	v30 = int32(_a_F_StartSubTransaction_4)
	goto L8
L8:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v30
	F_errmsg_internal(m, int32(_a_F_StartSubTransaction_5), v8)
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L3
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[2])) = v55
	*(*int32)(unsafe.Add(mBase, uint32(v44)+36)) = v55
	*(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[1])) = v55
	v62 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[0]))
	v63 = *(*int32)(unsafe.Add(mBase, uint32(v62)+80))
	v64 = *(*int32)(unsafe.Add(mBase, uint32(v63)+40))
	v66 = F_ResourceOwnerCreate(m, v64, int32(_a_F_StartSubTransaction_9))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L3
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[4])) = v66
	*(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[5])) = v66
	v74 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[0]))
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v110+v115))) = int32(0)
	v119 = int32(_a_F_StartSubTransaction_10)
	v120 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[6]))
	v121 = v120 + v115
	v123 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[7]))
	*(*int32)(unsafe.Add(mBase, uint32(v121)+12)) = v123
	v126 = *(*int64)(unsafe.Add(mBase, _c_F_StartSubTransaction[8]))
	*(*int64)(unsafe.Add(mBase, uint32(v121)+4)) = v126
	v129 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[6]))
	v132 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[9]))
	*(*int32)(unsafe.Add(mBase, uint32(v129+v115)+16)) = v132
	v135 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[6]))
	v138 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[10]))
	*(*int32)(unsafe.Add(mBase, uint32(v135+v115)+20)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = int32(2)
	v143 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[11]))
	if v143 != 0 {
		goto L27
	} else {
		goto L28
...
L14:
	;
	v77 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[12]))
	if v77 <= v75 {
		goto L15
	} else {
		goto L16
...
L36:
	;
	v170 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[14]))
	goto L39
L37:
	;
	v182 = int32(0)
...
L45:
	;
	v186 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[15]))
	if v186 != int32(2) {
		v197 = v182
		goto L35
	} else {
...
L46:
	;
	v190 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_StartSubTransaction[16])))
	if v190 != 0 {
		v197 = v182
		goto L35
	} else {
...
L47:
	;
	v194 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[17]))
	v197 = int32(0) | base.B2i32(v194 <= v163)
	goto L35
L48:
	;
	v201 = *(*int32)(unsafe.Add(mBase, _c_F_StartSubTransaction[0]))
	F_ShowTransactionStateRec(m, int32(_a_F_StartSubTransaction_8), v201)
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L3
