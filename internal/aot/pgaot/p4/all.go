...
func F_ResetAllOptions(m *base.Module) {
	...
	var v395 int32
	_ = v395
	v12 = *(*int32)(unsafe.Add(mBase, _c_F_ResetAllOptions[0]))
	if v12 == int32(0) {
		goto L1
	} else {
		goto L2
...
L2:
	;
	if v12 == int32(_a_F_ResetAllOptions_0) {
		goto L1
	} else {
		goto L3
	}
...
L6:
	;
	if v29 != int32(_a_F_ResetAllOptions_0) {
		v24 = v29
		goto L4
	} else {
		goto L141
...
L133:
	;
	v345 = *(*int32)(unsafe.Add(mBase, _c_F_ResetAllOptions[0]))
	if v345 != 0 {
		goto L135
	} else {
		goto L136
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24))) = v352
	v354 = int32(_a_F_ResetAllOptions_0)
	*(*int32)(unsafe.Add(mBase, uint32(v28))) = v354
	*(*int32)(unsafe.Add(mBase, uint32(v352)+4)) = v24
	*(*int32)(unsafe.Add(mBase, _c_F_ResetAllOptions[1])) = v24
	goto L129
L135:
	;
	v347 = *(*int32)(unsafe.Add(mBase, _c_F_ResetAllOptions[1]))
	v352 = v347
	goto L134
L136:
	;
...
L137:
	;
	v349 = int32(_a_F_ResetAllOptions_0)
	*(*int32)(unsafe.Add(mBase, _c_F_ResetAllOptions[0])) = v349
	v352 = v349
	goto L134
L138:
	;
...
L140:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v385))) = v386 | int32(4)
	v393 = v24 + int32(12)
	v394 = int32(_a_F_ResetAllOptions_1)
	v395 = *(*int32)(unsafe.Add(mBase, _c_F_ResetAllOptions[2]))
	*(*int32)(unsafe.Add(mBase, uint32(v393))) = v395
	*(*int32)(unsafe.Add(mBase, _c_F_ResetAllOptions[2])) = v393
	goto L6
L141:
	;
	goto L5
