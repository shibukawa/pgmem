...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+192)) = l0
	F_appendStringInfo(m, v28+int32(304), int32(209389), v28+int32(192))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L7
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+144)) = l0
	F_appendStringInfo(m, v28+int32(304), int32(208860), v28+int32(144))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L7
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+128)) = v86
	v96 = F_pg_sprintf(m, v28+int32(292), int32(512117), v28+int32(128))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L7
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+112)) = v102
	v112 = F_pg_sprintf(m, v28+int32(280), int32(512117), v28+int32(112))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L7
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+64)) = l4
	F_appendStringInfo(m, v28+int32(248), int32(186679), v28-int32(-64))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L7
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+48)) = v128
	v242 = F_pg_sprintf(m, v28+int32(292), int32(512117), v28+int32(48))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L7
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+32)) = l4
	F_appendStringInfo(m, v28+int32(232), int32(186679), v28+int32(32))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L7
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+16)) = l4
	F_appendStringInfo(m, v28+int32(264), int32(186822), v28+int32(16))
	mBase = m.M
	v265 = m.ExcPending
	if v265 != 0 {
		goto L7
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28))) = v275
	v283 = F_pg_sprintf(m, v28+int32(280), int32(512117), v28)
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L7
...
L96:
	;
	F_errmsg(m, int32(17075), int32(0))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L7
...
L97:
	;
	F_errdetail(m, int32(622177), int32(0))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L7
...
L98:
	;
	F_errfinish(m, int32(526158), int32(1481), int32(184747))
	mBase = m.M
	v396 = m.ExcPending
	if v396 != 0 {
		goto L7
...
L104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+96)) = v408
	F_errdetail(m, int32(635169), v28+int32(96))
	mBase = m.M
	v418 = m.ExcPending
	if v418 != 0 {
		goto L7
...
L105:
	;
	F_errfinish(m, int32(526158), int32(1498), int32(184747))
	mBase = m.M
	v423 = m.ExcPending
	if v423 != 0 {
		goto L7
...
L111:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+80)) = v435
	F_errdetail(m, int32(635101), v28+int32(80))
	mBase = m.M
	v445 = m.ExcPending
	if v445 != 0 {
		goto L7
...
L112:
	;
	F_errfinish(m, int32(526158), int32(1511), int32(184747))
	mBase = m.M
	v450 = m.ExcPending
	if v450 != 0 {
		goto L7
...
L115:
	;
	F_errmsg(m, int32(469140), int32(0))
	mBase = m.M
	v461 = m.ExcPending
	if v461 != 0 {
		goto L7
...
L116:
	;
	F_errfinish(m, int32(526158), int32(1340), int32(20660))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L7
...
func F_tuplestore_begin_heap(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v10 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v7)+24)) = v26
		...
		v35 = F_GenerationContextCreate(m, v30, int32(175230), v20, int32(8192), int32(8388608))
		mBase = m.M
		v36 = m.ExcPending
		if v36 != 0 {
			return int32(0)
				...
				if v28 != 0 {
					...
					if v30 != 0 {
						...
						if v34 != 0 {
							...
							F_errfinish(m, int32(524611), int32(1308), int32(298643))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return
	...
	default:
		...
		if v43 != 0 {
			...
			if v47 != 0 {
				...
				F_errfinish(m, int32(524611), int32(1311), int32(298643))
				mBase = m.M
				v52 = m.ExcPending
				if v52 != 0 {
					return
