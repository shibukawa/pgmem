...
func F_ShmemAllocNoError(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(1)
	if v7 != 0 {
		...
		F_s_lock(m, v15, int32(473869), int32(208), int32(30225))
		mBase = m.M
		v22 = m.ExcPending
		if v22 != 0 {
			return int32(0)
...
func F_s_lock_stuck(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v12 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = v16
		F_errmsg_internal(m, int32(444718), v7)
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return
		} else {
			F_errfinish(m, int32(474335), int32(90), int32(300454))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return
...
L59:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v12)+4)) = uint32(v412)
	F_errmsg_internal(m, int32(491450), v12)
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L23
...
L62:
	;
	F_errfinish(m, int32(472295), int32(3910), int32(303827))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L23
...
L62:
	;
	F_errfinish(m, int32(474031), int32(1041), int32(330462))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L32
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = l2
	F_errmsg(m, int32(383073), v11+int32(16))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L32
...
L66:
	;
	F_errfinish(m, int32(474031), int32(1045), int32(330462))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L32
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+72)) = v24
	...
	v31 = F_hash_create(m, int32(153419), v27, v16+int32(32), int32(1048))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L4
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v258
	v264 = F_pg_sprintf(m, v242+v257, int32(444263), v16+int32(16))
	mBase = m.M
	v265 = m.ExcPending
	if v265 != 0 {
		goto L4
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v344
	v348 = F_pg_sprintf(m, v340+v343, int32(444263), v16)
	mBase = m.M
	v349 = m.ExcPending
	if v349 != 0 {
		goto L4
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v127
	F_errmsg_internal(m, int32(463944), v21+int32(16))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L15
...
L22:
	;
	F_errfinish(m, int32(470833), int32(5080), int32(137857))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L15
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+32)) = v153
	F_errmsg_internal(m, int32(463944), v21+int32(32))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L15
...
L28:
	;
	F_errfinish(m, int32(470833), int32(5087), int32(137857))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L15
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v193
	F_errmsg_internal(m, int32(463405), v21)
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L15
...
L38:
	;
	F_errfinish(m, int32(470833), int32(4364), int32(153363))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L15
...
func F_shell_archive_shutdown(m *base.Module, l0 int32) {
	...
	if v5 != 0 {
		...
		if v4 != 0 {
			F_errmsg_internal(m, int32(231675), int32(0))
			v9 = m.ExcPending
			if v9 != 0 {
				return
			} else {
				F_errfinish(m, int32(475064), int32(141), int32(231276))
				v14 = m.ExcPending
				if v14 != 0 {
					return
				} else {
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+64)) = l1
	F_appendStringInfo(m, v98, int32(402814), v15-int32(-64))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L8
...
L44:
	...
	F_appendStringInfoString(m, v109, int32(703733))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L8
...
L56:
	...
	F_appendStringInfoString(m, v150, int32(703976))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L8
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v176
	F_appendStringInfo(m, v179, int32(520540), v15+int32(32))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L8
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v202
	F_appendStringInfo(m, v204, int32(520540), v15)
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L8
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+112)) = l1
	F_appendStringInfo(m, v15+int32(144), int32(127018), v15+int32(112))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L8
...
L76:
	...
	F_ExplainOpenGroup(m, int32(126994), v227, int32(1), l3)
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L8
...
L77:
	...
	F_ExplainPropertyInteger(m, int32(83441), int32(0), v233, l3)
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L8
...
L78:
	;
	F_ExplainPropertyList(m, int32(428997), v88, l3)
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L8
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+96)) = int32(13029)
	F_appendStringInfo(m, v15+int32(128), int32(185722), v15+int32(96))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L8
...
L88:
	...
	F_ExplainOpenGroup(m, int32(399490), v261, int32(1), l3)
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L8
...
L89:
	...
	F_ExplainPropertyInteger(m, int32(429036), int32(520677), v267, l3)
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L8
...
L90:
	...
	F_ExplainPropertyInteger(m, int32(429015), int32(520677), v272, l3)
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L8
...
L91:
	;
	F_ExplainCloseGroup(m, int32(399490), int32(1), l3)
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L8
...
L95:
	;
	F_ExplainCloseGroup(m, int32(126994), int32(1), l3)
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L8
...
L100:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v15)+80)) = int32(299320)
	F_appendStringInfo(m, v15+int32(128), int32(185722), v15+int32(80))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L8
...
L101:
	...
	F_ExplainOpenGroup(m, int32(399490), v306, int32(1), l3)
	mBase = m.M
	v309 = m.ExcPending
	if v309 != 0 {
		goto L8
...
L102:
	...
	F_ExplainPropertyInteger(m, int32(429036), int32(520677), v312, l3)
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L8
...
L103:
	...
	F_ExplainPropertyInteger(m, int32(429015), int32(520677), v317, l3)
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L8
			...
			if v9 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(1)
				if v12 != 0 {
					...
					F_s_lock(m, v16+int32(16), int32(476530), int32(1231), int32(93279))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return
...
L15:
	;
	F_errmsg_internal(m, int32(423979), int32(0))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L7
...
L16:
	;
	F_errfinish(m, int32(471977), int32(339), int32(17059))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L7
		...
		if v14 == int32(0) {
			...
			if v234 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = v235 + int32(4)
				F_errmsg_internal(m, int32(480899), v11)
				mBase = m.M
				v241 = m.ExcPending
				if v241 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(469937), int32(84), int32(409862))
					mBase = m.M
					v246 = m.ExcPending
					if v246 != 0 {
						return int32(0)
...
L33:
	;
	F_errmsg_internal(m, int32(242287), int32(0))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L12
...
L34:
	;
	F_errfinish(m, int32(473578), int32(1031), int32(364303))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L12
		...
		if l2 == int32(0) {
			...
			if v77 != 0 {
				...
				if v80 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(641882)
					...
					if v85 != 0 {
						...
						if v89 != 0 {
							...
							F_errfinish(m, int32(474808), int32(1655), int32(203283))
							mBase = m.M
							v94 = m.ExcPending
							if v94 != 0 {
								return int32(0)
...
L115:
	;
	F_errfinish(m, int32(469996), int32(1499), int32(127274))
	mBase = m.M
	v512 = m.ExcPending
	if v512 != 0 {
		goto L20
...
L118:
	;
	F_errfinish(m, int32(469996), int32(1506), int32(127274))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L20
...
L157:
	;
	F_errdetail(m, int32(552472), int32(0))
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L20
...
L161:
	;
	F_errfinish(m, int32(474878), int32(1556), int32(198426))
	mBase = m.M
	v741 = m.ExcPending
	if v741 != 0 {
		goto L20
...
L164:
	;
	F_errfinish(m, int32(474878), int32(1562), int32(198426))
	mBase = m.M
	v757 = m.ExcPending
	if v757 != 0 {
		goto L20
...
L10:
	...
	v67 = F_MakeSingleTupleTableSlot(m, v65, int32(1575788))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L5
...
L176:
	;
	F_s_lock(m, v520, int32(476530), int32(395), int32(429329))
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L5
...
L185:
	;
	F_s_lock(m, v520, int32(476530), int32(461), int32(110541))
	mBase = m.M
	v635 = m.ExcPending
	if v635 != 0 {
		goto L5
...
L199:
	;
	F_errfinish(m, int32(476530), int32(477), int32(110541))
	mBase = m.M
	v681 = m.ExcPending
	if v681 != 0 {
		goto L5
...
L234:
	;
	F_errfinish(m, int32(476530), int32(649), int32(80660))
	mBase = m.M
	v846 = m.ExcPending
	if v846 != 0 {
		goto L5
...
L240:
	;
	F_s_lock(m, v849, int32(476530), int32(659), int32(80660))
	mBase = m.M
	v858 = m.ExcPending
	if v858 != 0 {
		goto L5
...
L251:
	;
	F_s_lock(m, v849, int32(476530), int32(698), int32(80660))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L5
...
L272:
	;
	F_s_lock(m, v922, int32(476530), int32(773), int32(80660))
	mBase = m.M
	v937 = m.ExcPending
	if v937 != 0 {
		goto L5
...
L278:
	...
	F_s_lock(m, v975+int32(440), int32(474748), int32(2685), int32(504117))
	mBase = m.M
	v982 = m.ExcPending
	if v982 != 0 {
		goto L5
...
L288:
	;
	F_s_lock(m, v959, int32(476530), int32(539), int32(80621))
	mBase = m.M
	v1000 = m.ExcPending
	if v1000 != 0 {
		goto L5
...
L302:
	;
	F_s_lock(m, v922, int32(476530), int32(783), int32(80660))
	mBase = m.M
	v1045 = m.ExcPending
	if v1045 != 0 {
		goto L5
...
L317:
	;
	F_errfinish(m, int32(476530), int32(669), int32(80660))
	mBase = m.M
	v1131 = m.ExcPending
	if v1131 != 0 {
		goto L5
...
L319:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+80)) = v1136
	F_errmsg_internal(m, int32(656578), v25+int32(80))
	mBase = m.M
	v1142 = m.ExcPending
	if v1142 != 0 {
		goto L5
...
L320:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v25)+64)) = uint32(v1151)
	F_errdetail_internal(m, int32(620820), v25-int32(-64))
	mBase = m.M
	v1157 = m.ExcPending
	if v1157 != 0 {
		goto L5
...
L321:
	;
	F_errfinish(m, int32(476530), int32(739), int32(80660))
	mBase = m.M
	v1162 = m.ExcPending
	if v1162 != 0 {
		goto L5
...
L324:
	;
	F_errfinish(m, int32(476530), int32(548), int32(80621))
	mBase = m.M
	v1179 = m.ExcPending
	if v1179 != 0 {
		goto L5
...
L326:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+112)) = v1184
	F_errmsg(m, int32(190651), v25+int32(112))
	mBase = m.M
	v1190 = m.ExcPending
	if v1190 != 0 {
		goto L5
...
L327:
	;
	F_errfinish(m, int32(476530), int32(839), int32(110523))
	mBase = m.M
	v1195 = m.ExcPending
	if v1195 != 0 {
		goto L5
