...
func F_ShmemAllocNoError(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(1)
	if v7 != 0 {
		...
		F_s_lock(m, v15, int32(496903), int32(208), int32(32524))
		mBase = m.M
		v22 = m.ExcPending
		if v22 != 0 {
			return int32(0)
...
func F_s_lock_stuck(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v12 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = v16
		F_errmsg_internal(m, int32(466226), v7)
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return
		} else {
			F_errfinish(m, int32(497386), int32(90), int32(315833))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return
...
L59:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v12)+4)) = uint32(v412)
	F_errmsg_internal(m, int32(514996), v12)
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L23
...
L62:
	;
	F_errfinish(m, int32(495159), int32(3910), int32(319225))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L23
...
L45:
	;
	F_errfinish(m, int32(497082), int32(1041), int32(347251))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L15
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = l2
	F_errmsg(m, int32(402065), v11+int32(16))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L15
...
L49:
	;
	F_errfinish(m, int32(497082), int32(1045), int32(347251))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L15
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+72)) = v24
	...
	v31 = F_hash_create(m, int32(163237), v27, v16+int32(32), int32(1048))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L4
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v202
	v208 = F_pg_sprintf(m, v186+v201, int32(465771), v16+int32(16))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L4
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v232
	v236 = F_pg_sprintf(m, v228+v231, int32(465771), v16)
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L4
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v127
	F_errmsg_internal(m, int32(486264), v21+int32(16))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L15
...
L22:
	;
	F_errfinish(m, int32(493667), int32(5080), int32(147255))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L15
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+32)) = v153
	F_errmsg_internal(m, int32(486264), v21+int32(32))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L15
...
L28:
	;
	F_errfinish(m, int32(493667), int32(5087), int32(147255))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L15
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v193
	F_errmsg_internal(m, int32(485725), v21)
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L15
...
L38:
	;
	F_errfinish(m, int32(493667), int32(4364), int32(163181))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L15
...
func F_shell_archive_shutdown(m *base.Module, l0 int32) {
	...
	if v5 != 0 {
		...
		if v4 != 0 {
			F_errmsg_internal(m, int32(243980), int32(0))
			v9 = m.ExcPending
			if v9 != 0 {
				return
			} else {
				F_errfinish(m, int32(498158), int32(141), int32(243581))
				v14 = m.ExcPending
				if v14 != 0 {
					return
				} else {
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+64)) = l1
	F_appendStringInfo(m, v98, int32(422903), v15-int32(-64))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L8
...
L44:
	...
	F_appendStringInfoString(m, v109, int32(745451))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L8
...
L56:
	...
	F_appendStringInfoString(m, v150, int32(745694))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L8
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v176
	F_appendStringInfo(m, v179, int32(544410), v15+int32(32))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L8
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v202
	F_appendStringInfo(m, v204, int32(544410), v15)
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L8
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+112)) = l1
	F_appendStringInfo(m, v15+int32(144), int32(136223), v15+int32(112))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L8
...
L76:
	...
	F_ExplainOpenGroup(m, int32(136199), v227, int32(1), l3)
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L8
...
L78:
	;
	F_ExplainPropertyList(m, int32(449753), v88, l3)
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L8
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+96)) = int32(14143)
	F_appendStringInfo(m, v15+int32(128), int32(195796), v15+int32(96))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L8
...
L88:
	...
	F_ExplainOpenGroup(m, int32(419391), v261, int32(1), l3)
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L8
...
L89:
	...
	F_ExplainPropertyInteger(m, int32(449792), int32(544547), v267, l3)
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L8
...
L90:
	...
	F_ExplainPropertyInteger(m, int32(449771), int32(544547), v272, l3)
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L8
...
L91:
	;
	F_ExplainCloseGroup(m, int32(419391), int32(1), l3)
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L8
...
L95:
	;
	F_ExplainCloseGroup(m, int32(136199), int32(1), l3)
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L8
...
L100:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v15)+80)) = int32(314699)
	F_appendStringInfo(m, v15+int32(128), int32(195796), v15+int32(80))
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L8
...
L101:
	...
	F_ExplainOpenGroup(m, int32(419391), v306, int32(1), l3)
	mBase = m.M
	v309 = m.ExcPending
	if v309 != 0 {
		goto L8
...
L102:
	...
	F_ExplainPropertyInteger(m, int32(449792), int32(544547), v312, l3)
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L8
...
L103:
	...
	F_ExplainPropertyInteger(m, int32(449771), int32(544547), v317, l3)
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L8
			...
			if v9 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(1)
				if v12 != 0 {
					...
					F_s_lock(m, v16+int32(16), int32(499644), int32(1231), int32(99311))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return
...
L15:
	;
	F_errmsg_internal(m, int32(444623), int32(0))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L7
...
L16:
	;
	F_errfinish(m, int32(494841), int32(339), int32(18403))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L7
						...
						if v148 != 0 {
							...
							if v151 != 0 {
								...
								if v157 != 0 {
									...
									F_errfinish(m, int32(495510), int32(206), int32(78804))
									mBase = m.M
									v164 = m.ExcPending
									if v164 != 0 {
										return int32(0)
										...
										if v84|int32(32) != int32(97) {
											...
											if v169 != 0 {
												...
												if v172 != 0 {
													...
													F_errmsg(m, int32(729960), int32(0))
													mBase = m.M
													v178 = m.ExcPending
													if v178 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(495510), int32(224), int32(78804))
														mBase = m.M
														v185 = m.ExcPending
														if v185 != 0 {
															return int32(0)
		...
		if v14 == int32(0) {
			...
			if v234 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = v235 + int32(4)
				F_errmsg_internal(m, int32(504171), v11)
				mBase = m.M
				v241 = m.ExcPending
				if v241 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(492734), int32(84), int32(430277))
					mBase = m.M
					v246 = m.ExcPending
					if v246 != 0 {
						return int32(0)
...
L33:
	;
	F_errmsg_internal(m, int32(254655), int32(0))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L12
...
L34:
	;
	F_errfinish(m, int32(496594), int32(1031), int32(383074))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L12
		...
		if l2 == int32(0) {
			...
			if v77 != 0 {
				...
				if v80 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(683346)
					...
					if v85 != 0 {
						...
						if v89 != 0 {
							...
							F_errfinish(m, int32(497896), int32(1655), int32(213676))
							mBase = m.M
							v94 = m.ExcPending
							if v94 != 0 {
								return int32(0)
...
L115:
	;
	F_errfinish(m, int32(492793), int32(1499), int32(136479))
	mBase = m.M
	v512 = m.ExcPending
	if v512 != 0 {
		goto L20
...
L118:
	;
	F_errfinish(m, int32(492793), int32(1506), int32(136479))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L20
...
L157:
	;
	F_errdetail(m, int32(592465), int32(0))
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L20
...
L161:
	;
	F_errfinish(m, int32(497966), int32(1556), int32(208680))
	mBase = m.M
	v741 = m.ExcPending
	if v741 != 0 {
		goto L20
...
L164:
	;
	F_errfinish(m, int32(497966), int32(1562), int32(208680))
	mBase = m.M
	v757 = m.ExcPending
	if v757 != 0 {
		goto L20
...
L10:
	...
	v67 = F_MakeSingleTupleTableSlot(m, v65, int32(1617516))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L5
...
L176:
	;
	F_s_lock(m, v520, int32(499644), int32(395), int32(450085))
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L5
...
L185:
	;
	F_s_lock(m, v520, int32(499644), int32(461), int32(118465))
	mBase = m.M
	v635 = m.ExcPending
	if v635 != 0 {
		goto L5
...
L199:
	;
	F_errfinish(m, int32(499644), int32(477), int32(118465))
	mBase = m.M
	v681 = m.ExcPending
	if v681 != 0 {
		goto L5
...
L234:
	;
	F_errfinish(m, int32(499644), int32(649), int32(85014))
	mBase = m.M
	v846 = m.ExcPending
	if v846 != 0 {
		goto L5
...
L240:
	;
	F_s_lock(m, v849, int32(499644), int32(659), int32(85014))
	mBase = m.M
	v858 = m.ExcPending
	if v858 != 0 {
		goto L5
...
L251:
	;
	F_s_lock(m, v849, int32(499644), int32(698), int32(85014))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L5
...
L272:
	;
	F_s_lock(m, v922, int32(499644), int32(773), int32(85014))
	mBase = m.M
	v937 = m.ExcPending
	if v937 != 0 {
		goto L5
...
L278:
	...
	F_s_lock(m, v975+int32(440), int32(497836), int32(2685), int32(527815))
	mBase = m.M
	v982 = m.ExcPending
	if v982 != 0 {
		goto L5
...
L288:
	;
	F_s_lock(m, v959, int32(499644), int32(539), int32(84975))
	mBase = m.M
	v1000 = m.ExcPending
	if v1000 != 0 {
		goto L5
...
L302:
	;
	F_s_lock(m, v922, int32(499644), int32(783), int32(85014))
	mBase = m.M
	v1045 = m.ExcPending
	if v1045 != 0 {
		goto L5
...
L317:
	;
	F_errfinish(m, int32(499644), int32(669), int32(85014))
	mBase = m.M
	v1131 = m.ExcPending
	if v1131 != 0 {
		goto L5
...
L319:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+80)) = v1136
	F_errmsg_internal(m, int32(698049), v25+int32(80))
	mBase = m.M
	v1142 = m.ExcPending
	if v1142 != 0 {
		goto L5
...
L320:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v25)+64)) = uint32(v1151)
	F_errdetail_internal(m, int32(661972), v25-int32(-64))
	mBase = m.M
	v1157 = m.ExcPending
	if v1157 != 0 {
		goto L5
...
L321:
	;
	F_errfinish(m, int32(499644), int32(739), int32(85014))
	mBase = m.M
	v1162 = m.ExcPending
	if v1162 != 0 {
		goto L5
...
L324:
	;
	F_errfinish(m, int32(499644), int32(548), int32(84975))
	mBase = m.M
	v1179 = m.ExcPending
	if v1179 != 0 {
		goto L5
...
L326:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+112)) = v1184
	F_errmsg(m, int32(200880), v25+int32(112))
	mBase = m.M
	v1190 = m.ExcPending
	if v1190 != 0 {
		goto L5
...
L327:
	;
	F_errfinish(m, int32(499644), int32(839), int32(118447))
	mBase = m.M
	v1195 = m.ExcPending
	if v1195 != 0 {
		goto L5
