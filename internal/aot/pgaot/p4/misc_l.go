...
L134:
	...
	F_s_lock(m, v688, int32(488735), int32(1837), int32(358455))
	mBase = m.M
	v693 = m.ExcPending
	if v693 != 0 {
		goto L24
...
L190:
	...
	F_s_lock(m, v1111, int32(488735), int32(1869), int32(358432))
	mBase = m.M
	v1116 = m.ExcPending
	if v1116 != 0 {
		goto L24
...
L214:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v32)+80)) = int32(251830)
	F_errhint(m, int32(640942), v32+int32(80))
	mBase = m.M
	v1183 = m.ExcPending
	if v1183 != 0 {
		goto L24
...
L215:
	;
	F_errfinish(m, int32(488735), int32(1042), int32(453662))
	mBase = m.M
	v1188 = m.ExcPending
	if v1188 != 0 {
		goto L24
...
L219:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v32)+32)) = int32(251830)
	F_errhint(m, int32(640942), v32+int32(32))
	mBase = m.M
	v1206 = m.ExcPending
	if v1206 != 0 {
		goto L24
...
L220:
	;
	F_errfinish(m, int32(488735), int32(1080), int32(453662))
	mBase = m.M
	v1211 = m.ExcPending
	if v1211 != 0 {
		goto L24
...
L283:
	...
	F_s_lock(m, v1578, int32(488735), int32(1869), int32(358432))
	mBase = m.M
	v1583 = m.ExcPending
	if v1583 != 0 {
		goto L24
...
L315:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1692))) = v1739
	F_appendStringInfo(m, v1689, int32(479600), v1692)
	mBase = m.M
	v1747 = m.ExcPending
	if v1747 != 0 {
		goto L24
...
L317:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1692)+16)) = v1739
	F_appendStringInfo(m, v1689, int32(479586), v1692+int32(16))
	mBase = m.M
	v1754 = m.ExcPending
	if v1754 != 0 {
		goto L24
...
L327:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v32)+64)) = v1815
	F_errmsg(m, int32(181404), v32-int32(-64))
	mBase = m.M
	v1821 = m.ExcPending
	if v1821 != 0 {
		goto L24
...
L330:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v32)+52)) = v1824
	...
	F_errdetail_log_plural(m, int32(580986), int32(581032), v1828, v32+int32(48))
	mBase = m.M
	v1832 = m.ExcPending
	if v1832 != 0 {
		goto L24
...
L331:
	;
	F_errfinish(m, int32(488735), int32(1192), int32(453662))
	mBase = m.M
	v1837 = m.ExcPending
	if v1837 != 0 {
		goto L24
...
L350:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1894)+72)) = v1951
	F_appendStringInfo(m, v1894+int32(112), int32(627507), v1894-int32(-64))
	mBase = m.M
	v1959 = m.ExcPending
	if v1959 != 0 {
		goto L24
...
L361:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1894)+56)) = v2042
	F_appendStringInfo(m, v1894+int32(112), int32(627507), v1894+int32(48))
	mBase = m.M
	v2050 = m.ExcPending
	if v2050 != 0 {
		goto L24
...
L371:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1894)+32)) = v2134
	F_appendStringInfo(m, v1894+int32(96), int32(201042), v1894+int32(32))
	mBase = m.M
	v2403 = m.ExcPending
	if v2403 != 0 {
		goto L24
...
L419:
	;
	F_errmsg(m, int32(439363), int32(0))
	mBase = m.M
	v2465 = m.ExcPending
	if v2465 != 0 {
		goto L24
...
L420:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1894)+16)) = v2466
	F_errdetail_internal(m, int32(202950), v1894+int32(16))
	mBase = m.M
	v2472 = m.ExcPending
	if v2472 != 0 {
		goto L24
...
L421:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1894))) = v2473
	F_errdetail_log(m, int32(202950), v1894)
	mBase = m.M
	v2477 = m.ExcPending
	if v2477 != 0 {
		goto L24
...
L422:
	;
	F_errhint(m, int32(569363), int32(0))
	mBase = m.M
	v2481 = m.ExcPending
	if v2481 != 0 {
		goto L24
...
L423:
	;
	F_errfinish(m, int32(488722), int32(1138), int32(79801))
	mBase = m.M
	v2486 = m.ExcPending
	if v2486 != 0 {
		goto L24
...
L425:
	;
	F_errmsg_internal(m, int32(437434), int32(0))
	mBase = m.M
	v2494 = m.ExcPending
	if v2494 != 0 {
		goto L24
...
L426:
	;
	F_errfinish(m, int32(488735), int32(1140), int32(453662))
	mBase = m.M
	v2499 = m.ExcPending
	if v2499 != 0 {
		goto L24
...
L428:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v32)+16)) = l1
	F_errmsg_internal(m, int32(478009), v32+int32(16))
	mBase = m.M
	v2510 = m.ExcPending
	if v2510 != 0 {
		goto L24
...
L429:
	;
	F_errfinish(m, int32(488735), int32(861), int32(453662))
	mBase = m.M
	v2515 = m.ExcPending
	if v2515 != 0 {
		goto L24
...
L431:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v32))) = v34
	F_errmsg_internal(m, int32(478463), v32)
	mBase = m.M
	v2523 = m.ExcPending
	if v2523 != 0 {
		goto L24
...
L432:
	;
	F_errfinish(m, int32(488735), int32(858), int32(453662))
	mBase = m.M
	v2528 = m.ExcPending
	if v2528 != 0 {
		goto L24
...
L461:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v32)+96)) = v2816
	F_errmsg(m, int32(125568), v32+int32(96))
	mBase = m.M
	v2822 = m.ExcPending
	if v2822 != 0 {
		goto L24
...
L462:
	;
	F_errhint(m, int32(547769), int32(0))
	mBase = m.M
	v2826 = m.ExcPending
	if v2826 != 0 {
		goto L24
...
L463:
	;
	F_errfinish(m, int32(488735), int32(871), int32(453662))
	mBase = m.M
	v2831 = m.ExcPending
	if v2831 != 0 {
		goto L24
...
L203:
	;
	F_errmsg_internal(m, int32(96405), int32(0))
	mBase = m.M
	v1492 = m.ExcPending
	if v1492 != 0 {
		goto L8
...
L204:
	;
	F_errfinish(m, int32(483503), int32(3708), int32(384452))
	mBase = m.M
	v1497 = m.ExcPending
	if v1497 != 0 {
		goto L8
...
L287:
	;
	F_errfinish(m, int32(483503), int32(2823), int32(302229))
	mBase = m.M
	v1834 = m.ExcPending
	if v1834 != 0 {
		goto L8
...
func F_leftmostvalue_inet(m *base.Module) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_DirectFunctionCall1Coll(m, int32(1481), int32(0), int32(545229))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
L95:
	;
	F_errfinish(m, int32(488806), int32(770), int32(351098))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L24
...
L98:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v39)+16)) = l1
	F_errmsg_internal(m, int32(422904), v39+int32(16))
	mBase = m.M
	v383 = m.ExcPending
	if v383 != 0 {
		goto L24
...
L99:
	;
	F_errfinish(m, int32(488806), int32(780), int32(351098))
	mBase = m.M
	v388 = m.ExcPending
	if v388 != 0 {
		goto L24
...
L102:
	;
	F_errfinish(m, int32(488806), int32(810), int32(351098))
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L24
...
L105:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v39)+32)) = v409
	F_errmsg(m, int32(466594), v39+int32(32))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L24
...
L110:
	;
	F_errfinish(m, int32(486099), int32(565), int32(306771))
	mBase = m.M
	v441 = m.ExcPending
	if v441 != 0 {
		goto L24
...
L113:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = l0
	F_errmsg(m, int32(323252), v17+int32(16))
	mBase = m.M
	v454 = m.ExcPending
	if v454 != 0 {
		goto L24
...
L114:
	;
	F_errfinish(m, int32(486099), int32(573), int32(306771))
	mBase = m.M
	v459 = m.ExcPending
	if v459 != 0 {
		goto L24
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = v62 + v158
	F_errmsg_internal(m, int32(272888), v19+int32(32))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L4
...
L49:
	;
	F_errfinish(m, int32(490220), int32(1172), int32(237814))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L4
...
L55:
	...
	v187 = F_AllocSetContextCreateInternal(m, v182, int32(117400), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L4
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v323
	F_errmsg_internal(m, int32(49727), v19)
	mBase = m.M
	v344 = m.ExcPending
	if v344 != 0 {
		goto L4
...
L85:
	;
	F_errfinish(m, int32(490220), int32(1131), int32(237814))
	mBase = m.M
	v349 = m.ExcPending
	if v349 != 0 {
		goto L4
...
L97:
	...
	v364 = F_AllocSetContextCreateInternal(m, v359, int32(117400), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L4
...
L5:
	...
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(59800), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L2
...
L33:
	;
	F_errfinish(m, int32(491144), int32(2708), int32(498094))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L2
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l1
	F_errmsg(m, int32(674921), v10+int32(32))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L4
...
L15:
	;
	F_errfinish(m, int32(484346), int32(1872), int32(165448))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L4
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v65
	v86 = F_psprintf(m, int32(174001), v10+int32(16))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L4
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v88
	F_errmsg_internal(m, int32(666537), v10)
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L4
...
L42:
	;
	F_errfinish(m, int32(484346), int32(1890), int32(165448))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L4
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v17
	v21 = F_pg_snprintf(m, v12, int32(1024), int32(545762), v8)
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L1
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+36)) = v24
	F_appendStringInfo(m, l0, int32(719585), v8+int32(32))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L6
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = int32(731167)
	F_appendStringInfo(m, l0, int32(501187), v8+int32(16))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L6
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(720106)
	F_appendStringInfo(m, l0, int32(501187), v8)
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L6
