...
func F_change_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(423201)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+24)) = v16
	v20 = int32(4555000)
	v21 = *(*int32)(unsafe.Add(mBase, _consts[394]))
	*(*int32)(unsafe.Add(mBase, _consts[394])) = v10 + int32(4)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+152)) = v34
	...
	if v40 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[394])) = v42
		m.G0 = v10 + int32(32)
		return
	}
}
