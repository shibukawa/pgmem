															...
															if v118 != 0 {
																...
																if v123 != 0 {
																	...
																	if v125 != 0 {
																		...
																		v127 = *(*int32)(unsafe.Add(mBase, _c_F_DisableSubscriptionAndExit[1]))
																		...
																		if v128 == int32(2) {
																			...
																			if v133 != 0 {
																				...
																				if v137 != 0 {
																					...
																					if v136 != 0 {
																						v139 = *(*int32)(unsafe.Add(mBase, _c_F_DisableSubscriptionAndExit[2]))
			...
			if l1 != 0 {
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg_internal(m, int32(_a_F_get_subscription_name_0), v8)
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(_a_F_get_subscription_name_1), int32(3846), int32(_a_F_get_subscription_name_2))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return int32(0)
