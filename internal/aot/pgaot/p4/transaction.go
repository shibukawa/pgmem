...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v238
	F_errmsg_internal(m, int32(366734), v7)
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L4
...
L41:
	;
	F_errfinish(m, int32(512548), int32(2877), int32(268428))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L4
...
L47:
	...
	F_XLogRegisterData(m, int32(4444000), v230<<(uint(int32(2))%32))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L9
...
L51:
	;
	F_errmsg(m, int32(271111), int32(0))
	mBase = m.M
	v260 = m.ExcPending
	if v260 != 0 {
		goto L9
...
L52:
	;
	F_errfinish(m, int32(512548), int32(652), int32(482971))
	mBase = m.M
	v265 = m.ExcPending
	if v265 != 0 {
		goto L9
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v50
	F_errmsg_internal(m, int32(740248), v16)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L4
...
L26:
	;
	F_errfinish(m, int32(517226), int32(901), int32(161683))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L4
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v151
	F_errmsg_internal(m, int32(195996), v7)
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L4
...
L48:
	;
	F_errfinish(m, int32(512548), int32(3018), int32(268505))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L4
					...
					if v25 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
						...
						if v29 != 0 {
							...
							F_errfinish(m, int32(512548), int32(3749), int32(329645))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return
...
L13:
	...
	v143 = int32(32768)
	v146 = F_AllocSetContextCreateInternal(m, v141, int32(67225), v143, v143, v143)
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L16
...
L18:
	...
	v160 = F_AllocSetContextCreateInternal(m, v155, int32(67413), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L16
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, _consts[28])) = v163
	...
	v173 = F_ResourceOwnerCreate(m, int32(0), int32(268524))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L16
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v290))) = v303
	F_errmsg_internal(m, int32(88489), v290)
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L16
...
L48:
	;
	F_errfinish(m, int32(520159), int32(2224), int32(565418))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L16
...
L69:
	...
	F_ShowTransactionStateRec(m, int32(268445), v375)
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L16
						...
						if v5 != int32(3) {
							...
							if v51 == int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, _consts[141])) = v58
								v64 = F_format_elog_string(m, int32(23719), int32(0))
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return int32(0)
