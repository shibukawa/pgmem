...
L18:
	...
	*(*int32)(unsafe.Add(mBase, _consts[222])) = int32(4376144)
	v198 = int32(0)
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v238
	F_errmsg_internal(m, int32(348714), v7)
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L4
...
L41:
	;
	F_errfinish(m, int32(488504), int32(2877), int32(255656))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L4
...
L42:
	;
	F_AssignTransactionId(m, int32(4375448))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L9
...
L47:
	...
	F_XLogRegisterData(m, int32(4375536), v230<<(uint(int32(2))%32))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L9
...
L51:
	;
	F_errmsg(m, int32(258239), int32(0))
	mBase = m.M
	v260 = m.ExcPending
	if v260 != 0 {
		goto L9
...
L52:
	;
	F_errfinish(m, int32(488504), int32(652), int32(460858))
	mBase = m.M
	v265 = m.ExcPending
	if v265 != 0 {
		goto L9
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v50
	F_errmsg_internal(m, int32(691794), v16)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L4
...
L26:
	;
	F_errfinish(m, int32(492165), int32(901), int32(152224))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L4
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v151
	F_errmsg_internal(m, int32(185611), v7)
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L4
...
L48:
	;
	F_errfinish(m, int32(488504), int32(3018), int32(255733))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L4
					...
					if v25 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
						...
						if v29 != 0 {
							...
							F_errfinish(m, int32(488504), int32(3749), int32(314161))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return
...
L13:
	...
	v143 = int32(32768)
	v146 = F_AllocSetContextCreateInternal(m, v141, int32(61695), v143, v143, v143)
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L16
...
L18:
	...
	v160 = F_AllocSetContextCreateInternal(m, v155, int32(61883), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L16
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, _consts[28])) = v163
	...
	v173 = F_ResourceOwnerCreate(m, int32(0), int32(255752))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L16
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v290))) = v303
	F_errmsg_internal(m, int32(82284), v290)
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L16
...
L48:
	;
	F_errfinish(m, int32(494737), int32(2224), int32(538933))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L16
...
L69:
	...
	F_ShowTransactionStateRec(m, int32(255673), v375)
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L16
...
func F_check_transaction_deferrable(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	_ = v34
	v4 = int32(1)
	v6 = int32(*(*uint8)(unsafe.Add(mBase, _consts[481])))
	if v6 != 0 {
		v34 = v4
		return v34
	} else {
		...
		if int32(1) < v9 {
			v18 = int32(253412)
			*(*int32)(unsafe.Add(mBase, _consts[483])) = int32(16777538)
			...
			*(*int32)(unsafe.Add(mBase, _consts[141])) = v24
			...
			if v32 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[484])) = v29
				v34 = int32(0)
				return v34
			}
		} else {
			v14 = int32(*(*uint8)(unsafe.Add(mBase, _consts[482])))
			if v14 != int32(1) {
				v34 = v4
				return v34
			} else {
...
func F_check_transaction_isolation(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v5 == v7 {
		...
		if base.B2i32(v11 == int32(2)) == int32(0) {
			...
			v17 = int32(*(*uint8)(unsafe.Add(mBase, _consts[481])))
			if v17 != 0 {
				v83 = v4
				return v83
			} else {
				v19 = int32(*(*uint8)(unsafe.Add(mBase, _consts[482])))
				if v19 == int32(1) {
					*(*int32)(unsafe.Add(mBase, _consts[483])) = int32(16777538)
					v71 = int32(16125)
					v72 = int32(4478888)
						...
						*(*int32)(unsafe.Add(mBase, _consts[141])) = v75
						...
						if v5 != int32(3) {
							...
							if v51 == int32(0) {
								...
								*(*int32)(unsafe.Add(mBase, _consts[483])) = int32(1088)
								v58 = *(*int32)(unsafe.Add(mBase, _consts[140]))
								*(*int32)(unsafe.Add(mBase, _consts[141])) = v58
								v64 = F_format_elog_string(m, int32(23367), int32(0))
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return int32(0)
								} else {
									*(*int32)(unsafe.Add(mBase, _consts[484])) = v64
									v71 = int32(631889)
									v72 = int32(4478896)
									v75 = *(*int32)(unsafe.Add(mBase, _consts[140]))
									*(*int32)(unsafe.Add(mBase, _consts[141])) = v75
