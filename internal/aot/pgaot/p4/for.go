					...
					if v64 != 0 {
						...
						if v67 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
							F_errmsg(m, int32(365904), v9)
							mBase = m.M
							v71 = m.ExcPending
							if v71 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(475396), int32(7674), int32(261243))
								mBase = m.M
								v76 = m.ExcPending
								if v76 != 0 {
									return int32(0)
						...
						if v80 != 0 {
							...
							if v83 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = v84 + int32(4)
								F_errmsg(m, int32(109875), v9+int32(32))
								mBase = m.M
								v93 = m.ExcPending
								if v93 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(475396), int32(7689), int32(261243))
									mBase = m.M
									v98 = m.ExcPending
									if v98 != 0 {
										return int32(0)
							...
							if v31 == int32(0) {
								...
								if v37 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = v38 + int32(4)
									F_errmsg(m, int32(319513), v9+int32(16))
									mBase = m.M
									v47 = m.ExcPending
									if v47 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(475396), int32(7682), int32(261243))
										mBase = m.M
										v52 = m.ExcPending
										if v52 != 0 {
											return int32(0)
...
L5:
	;
	F_errmsg_internal(m, int32(435099), int32(0))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L4
...
L6:
	;
	F_errfinish(m, int32(477934), int32(374), int32(297273))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L4
...
L115:
	;
	F_errmsg_internal(m, int32(435187), int32(0))
	mBase = m.M
	v409 = m.ExcPending
	if v409 != 0 {
		goto L4
...
L116:
	;
	F_errfinish(m, int32(477934), int32(383), int32(297261))
	mBase = m.M
	v414 = m.ExcPending
	if v414 != 0 {
		goto L4
