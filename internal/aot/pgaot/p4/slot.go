		...
		if v8 == int32(0) {
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					F_errmsg(m, int32(115929), int32(0))
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return
					} else {
						*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(517855)
						F_errdetail(m, int32(556291), v4)
						mBase = m.M
						v27 = m.ExcPending
						if v27 != 0 {
							return
						} else {
							F_errfinish(m, int32(481971), int32(1553), int32(140339))
							mBase = m.M
							v32 = m.ExcPending
							if v32 != 0 {
								return
...
L37:
	;
	F_errfinish(m, int32(484315), int32(962), int32(492660))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
