			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					if v22 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(529892)
						F_errdetail(m, int32(584398), v4)
						mBase = m.M
						v27 = m.ExcPending
						if v27 != 0 {
							return
						} else {
							F_errfinish(m, int32(493300), int32(1553), int32(143713))
							mBase = m.M
							v32 = m.ExcPending
							if v32 != 0 {
								return
...
L37:
	;
	F_errfinish(m, int32(495710), int32(962), int32(504295))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
