		...
		if v8 == int32(0) {
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					F_errmsg(m, int32(127030), int32(0))
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return
					} else {
						*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(557016)
						F_errdetail(m, int32(614072), v4)
						mBase = m.M
						v27 = m.ExcPending
						if v27 != 0 {
							return
						} else {
							F_errfinish(m, int32(518163), int32(1553), int32(152922))
							mBase = m.M
							v32 = m.ExcPending
							if v32 != 0 {
								return
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, _consts[853])) = v55
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, _consts[853])) = int32(-1)
	goto L21
L25:
	;
...
L37:
	;
	F_errfinish(m, int32(521216), int32(962), int32(531117))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
