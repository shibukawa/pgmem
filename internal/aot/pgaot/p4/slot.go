			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					if v22 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(526267)
						F_errdetail(m, int32(565754), v4)
						mBase = m.M
						v27 = m.ExcPending
						if v27 != 0 {
							return
						} else {
							F_errfinish(m, int32(489898), int32(1553), int32(142869))
							mBase = m.M
							v32 = m.ExcPending
							if v32 != 0 {
								return
...
L37:
	;
	F_errfinish(m, int32(492269), int32(962), int32(500743))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
