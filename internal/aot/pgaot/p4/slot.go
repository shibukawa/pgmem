		...
		if v8 == int32(0) {
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					F_errmsg(m, int32(117819), int32(0))
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return
					} else {
						*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(524366)
						F_errdetail(m, int32(563675), v4)
						mBase = m.M
						v27 = m.ExcPending
						if v27 != 0 {
							return
						} else {
							F_errfinish(m, int32(488086), int32(1553), int32(142410))
							mBase = m.M
							v32 = m.ExcPending
							if v32 != 0 {
								return
...
L37:
	;
	F_errfinish(m, int32(490457), int32(962), int32(498898))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
