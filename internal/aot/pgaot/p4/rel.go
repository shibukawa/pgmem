...
L1:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewRelFileNumber[0]))
	v41 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewRelFileNumber[1]))
	if l0 != 0 {
		goto L11
	} else {
		goto L12
...
L17:
	;
	v53 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewRelFileNumber[4]))
	if v53 != 0 {
		goto L19
	} else {
		goto L20
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v42))) = v107
	F_errmsg_internal(m, int32(_a_F_make_rel_from_joinlist_0), v42)
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L13
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+188)) = v120
	v132 = *(*int32)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[0]))
	if v132 != 0 {
		goto L24
	} else {
		goto L25
...
L26:
	;
	v136 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[1])))
	if v136 != int32(1) {
		goto L28
	} else {
		goto L29
...
L29:
	;
	v140 = *(*int32)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[2]))
	if v46 < v140 {
		goto L28
	} else {
		goto L30
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v144)+8)) = v120
	...
	v152 = v150 + v146
	v154 = *(*float64)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[3]))
...
L31:
	;
	v206 = *(*int32)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[4]))
	if int32(1) < v206 {
		v400 = v206
		goto L39
	} else {
...
L39:
	;
	v408 = *(*int32)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[5]))
...
L40:
	;
	v210 = *(*int32)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[6]))
...
L47:
	;
	v273 = *(*float64)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[7]))
	v274 = base.F64_add(v213, v273)
	v276 = base.F64_sub(v213, base.F64_sub(v274, v273))
	v277 = base.F64_mul(v276, v276)
	v280 = *(*float64)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[8]))
	v283 = *(*float64)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[9]))
	v287 = *(*float64)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[10]))
	v290 = *(*float64)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[11]))
	v294 = *(*float64)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[12]))
	v296 = base.I64_reinterpret_f64(v274)
	v301 = base.I32_wrap_i64(v296) << (uint(int32(4)) % 32) & int32(2032)
	v304 = *(*float64)(unsafe.Add(mBase, uint32(v301)+uint32(_c_F_make_rel_from_joinlist[13])))
	...
	v310 = *(*int64)(unsafe.Add(mBase, uint32(v301)+uint32(_c_F_make_rel_from_joinlist[14])))
...
L115:
	;
	if int32(_a_F_make_rel_from_joinlist_3) <= v687 {
		goto L94
	} else {
		goto L116
	}
...
L131:
	;
	v811 = *(*float64)(unsafe.Add(mBase, _c_F_make_rel_from_joinlist[15]))
...
L342:
	;
	v3030 = int32(422)
	v3067 = int32(_a_F_make_rel_from_joinlist_7)
	goto L328
L343:
	;
	v2902 = int32(1)
...
L351:
	;
	v3030 = int32(461)
	v3067 = int32(_a_F_make_rel_from_joinlist_8)
	goto L328
L352:
	;
	v2967 = v2816
...
L361:
	;
	v3030 = int32(443)
	v3067 = int32(_a_F_make_rel_from_joinlist_9)
	goto L328
L362:
	;
	F_errfinish(m, int32(_a_F_make_rel_from_joinlist_10), v3030, int32(_a_F_make_rel_from_joinlist_11))
	mBase = m.M
	v3074 = m.ExcPending
	if v3074 != 0 {
		goto L13
...
L643:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3829))) = v3789
	F_errmsg_internal(m, int32(_a_F_make_rel_from_joinlist_18), v3829)
	mBase = m.M
	v5022 = m.ExcPending
	if v5022 != 0 {
		goto L13
...
L674:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v3774))) = v46
	F_errmsg_internal(m, int32(_a_F_make_rel_from_joinlist_18), v3774)
	mBase = m.M
	v5285 = m.ExcPending
	if v5285 != 0 {
		goto L13
...
L1:
	;
	v2624 = *(*int32)(unsafe.Add(mBase, _c_F_set_rel_pathlist[0]))
	if v2624 != 0 {
		goto L415
	} else {
		goto L416
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v317)+16)) = int32(412)
	F_errmsg_internal(m, int32(_a_F_set_rel_pathlist_0), v317+int32(16))
	mBase = m.M
	v360 = m.ExcPending
	if v360 != 0 {
		goto L19
...
L123:
	...
	v572 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_pathlist[1]))
...
L145:
	...
	v779 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_pathlist[1]))
...
L159:
	...
	v958 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_pathlist[1]))
...
L160:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v807)+32)) = v829
	...
	v832 = int32(0)
	v834 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_pathlist[2]))
	v835 = int64(0)
...
L162:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v807)+32)) = v922
	...
	v926 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_pathlist[2]))
...
L174:
	;
	v1007 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_set_rel_pathlist[3])))
	if v1004 != 0 {
		goto L179
	} else {
		goto L180
...
L216:
	...
	v1343 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_pathlist[1]))
...
L246:
	;
	v1468 = *(*int32)(unsafe.Add(mBase, _c_F_set_rel_pathlist[4]))
...
L248:
	...
	v1476 = *(*int32)(unsafe.Add(mBase, _c_F_set_rel_pathlist[5]))
...
L344:
	;
	v2146 = *(*int32)(unsafe.Add(mBase, _c_F_set_rel_pathlist[4]))
...
L350:
	;
	v2156 = *(*int32)(unsafe.Add(mBase, _c_F_set_rel_pathlist[5]))
...
L352:
	;
	v2164 = int32(1)
	v2166 = *(*int32)(unsafe.Add(mBase, _c_F_set_rel_pathlist[5]))
	if v2166 <= v2164 {
		goto L353
	} else {
		goto L354
...
L303:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31))) = v1432
	F_errmsg_internal(m, int32(_a_F_set_rel_size_0), v31)
	mBase = m.M
	v1436 = m.ExcPending
	if v1436 != 0 {
		goto L4
...
L304:
	;
	F_errfinish(m, int32(_a_F_set_rel_size_1), int32(453), int32(_a_F_set_rel_size_2))
	mBase = m.M
	v1441 = m.ExcPending
	if v1441 != 0 {
		goto L4
...
L322:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v1496)+32)) = v1519
	...
	v1522 = int32(0)
	v1524 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_size[1]))
	v1525 = int64(0)
...
L324:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v1496)+32)) = v1613
	...
	v1617 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_size[1]))
...
L329:
	...
	v1579 = *(*float64)(unsafe.Add(mBase, _c_F_set_rel_size[1]))
	v1603 = v1577
	v1604 = v1576
	v1608 = v1579
	goto L325
...
L345:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+112)) = v1707
	F_errmsg_internal(m, int32(_a_F_set_rel_size_3), v31+int32(112))
	mBase = m.M
	v1713 = m.ExcPending
	if v1713 != 0 {
		goto L4
...
L346:
	;
	F_errfinish(m, int32(_a_F_set_rel_size_1), int32(2929), int32(_a_F_set_rel_size_4))
	mBase = m.M
	v1718 = m.ExcPending
	if v1718 != 0 {
		goto L4
...
L354:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+48)) = v1758
	F_errmsg_internal(m, int32(_a_F_set_rel_size_3), v31+int32(48))
	mBase = m.M
	v1764 = m.ExcPending
	if v1764 != 0 {
		goto L4
...
L355:
	;
	F_errfinish(m, int32(_a_F_set_rel_size_1), int32(3061), int32(_a_F_set_rel_size_5))
	mBase = m.M
	v1769 = m.ExcPending
	if v1769 != 0 {
		goto L4
...
L379:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = v1905
	F_errmsg_internal(m, int32(_a_F_set_rel_size_6), v31-int32(-64))
	mBase = m.M
	v1911 = m.ExcPending
	if v1911 != 0 {
		goto L4
...
L380:
	;
	F_errfinish(m, int32(_a_F_set_rel_size_1), int32(2947), int32(_a_F_set_rel_size_4))
	mBase = m.M
	v1916 = m.ExcPending
	if v1916 != 0 {
		goto L4
...
L393:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+16)) = v1976
	F_errmsg_internal(m, int32(_a_F_set_rel_size_3), v31+int32(16))
	mBase = m.M
	v1982 = m.ExcPending
	if v1982 != 0 {
		goto L4
...
L394:
	;
	F_errfinish(m, int32(_a_F_set_rel_size_1), int32(3054), int32(_a_F_set_rel_size_5))
	mBase = m.M
	v1987 = m.ExcPending
	if v1987 != 0 {
		goto L4
...
L397:
	;
	F_errfinish(m, int32(_a_F_set_rel_size_1), int32(3065), int32(_a_F_set_rel_size_5))
	mBase = m.M
	v2003 = m.ExcPending
	if v2003 != 0 {
		goto L4
...
L399:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+96)) = v2008
	F_errmsg_internal(m, int32(_a_F_set_rel_size_8), v31+int32(96))
	mBase = m.M
	v2014 = m.ExcPending
	if v2014 != 0 {
		goto L4
...
L400:
	;
	F_errfinish(m, int32(_a_F_set_rel_size_1), int32(2949), int32(_a_F_set_rel_size_4))
	mBase = m.M
	v2019 = m.ExcPending
	if v2019 != 0 {
		goto L4
...
L402:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+80)) = v2024
	F_errmsg_internal(m, int32(_a_F_set_rel_size_9), v31+int32(80))
	mBase = m.M
	v2030 = m.ExcPending
	if v2030 != 0 {
		goto L4
...
L403:
	;
	F_errfinish(m, int32(_a_F_set_rel_size_1), int32(2952), int32(_a_F_set_rel_size_4))
	mBase = m.M
	v2035 = m.ExcPending
	if v2035 != 0 {
		goto L4
