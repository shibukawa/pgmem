										...
										if v69 != 0 {
											...
											if v72 != 0 {
												...
												if v76 != 0 {
													...
													F_errfinish(m, int32(495449), int32(379), int32(209809))
													mBase = m.M
													v81 = m.ExcPending
													if v81 != 0 {
														return int32(0)
								...
								if v106 != 0 {
									...
									if v108 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7))) = v107
										F_errmsg(m, int32(191471), v7)
										mBase = m.M
										v114 = m.ExcPending
										if v114 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(495449), int32(371), int32(209809))
											mBase = m.M
											v119 = m.ExcPending
											if v119 != 0 {
												return int32(0)
						...
						if v37 != 0 {
							...
							if v39 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v38
								F_errmsg(m, int32(169229), v5+int32(-48))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(495449), int32(356), int32(209809))
									mBase = m.M
									v50 = m.ExcPending
									if v50 != 0 {
										return int32(0)
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+56)) = v30
	v37 = F_hash_create(m, int32(398203), int32(256), v9+int32(-48), int32(1224))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L8
					...
					if v64 == int32(1) {
						...
						if v70 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v25))) = v71
							F_errmsg_internal(m, int32(533694), v25)
							mBase = m.M
							v75 = m.ExcPending
							if v75 != 0 {
								return float64(0)
							} else {
								F_errfinish(m, int32(496311), int32(1246), int32(304726))
								mBase = m.M
								v80 = m.ExcPending
								if v80 != 0 {
									return float64(0)
						...
						if base.F64_lt(v84, float64(0))|base.F64_gt(v84, float64(1)) == int32(0) {
							...
							if v95 != 0 {
								...
								*(*float64)(unsafe.Add(mBase, uint32(v13))) = v84
								F_errmsg_internal(m, int32(340907), v13)
								mBase = m.M
								v99 = m.ExcPending
								if v99 != 0 {
									return float64(0)
								} else {
									F_errfinish(m, int32(494681), int32(2048), int32(9929))
									mBase = m.M
									v104 = m.ExcPending
									if v104 != 0 {
										return float64(0)
