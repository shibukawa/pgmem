...
L20:
	...
	v77 = v75 - int32(1)
	v84 = *(*int32)(unsafe.Add(mBase, uint32(l0+int32(5548)+v77<<(uint(int32(2))%32))))
	...
	v90 = F_FunctionCall4Coll(m, l0+int32(4620)+v77*int32(28), v84, v85, v87, v88, v89)
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L9
