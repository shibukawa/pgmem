...
L82:
	...
	v125 = F_ExecInitExtraTupleSlot(m, v122, int32(0), int32(_a_F_ExecInitExprRec_0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L1
...
L305:
	;
	v1044 = *(*int32)(unsafe.Add(mBase, _c_F_ExecInitExprRec[0]))
...
L309:
	;
	v1054 = *(*int32)(unsafe.Add(mBase, _c_F_ExecInitExprRec[1]))
	if v1054 != 0 {
		goto L312
	} else {
		goto L313
...
L317:
	;
	v1062 = *(*int32)(unsafe.Add(mBase, _c_F_ExecInitExprRec[0]))
...
L321:
	;
	v1073 = *(*int32)(unsafe.Add(mBase, _c_F_ExecInitExprRec[1]))
	if v1073 == int32(0) {
		goto L316
	} else {
		goto L324
...
L1090:
	;
	v4566 = *(*int32)(unsafe.Add(mBase, uint32(v4559<<(uint(int32(2))%32))+uint32(_c_F_ExecInitExprRec[2])))
...
L1102:
	...
	v4621 = *(*int32)(unsafe.Add(mBase, _c_F_ExecInitExprRec[3]))
