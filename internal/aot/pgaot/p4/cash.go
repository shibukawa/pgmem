...
func F_cash_dist(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = Fn13860(m, l0, int32(_a_F_cash_dist_0), int32(_a_F_cash_dist_1), int32(_a_F_cash_dist_2))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_cash_mul_int4(m *base.Module, l0 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = Fn13863(m, l0, int32(_a_F_cash_mul_int4_0), int32(150), int32(_a_F_cash_mul_int4_1), int32(_a_F_cash_mul_int4_2))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
