	...
	if base.B2i32(base.B2i32(int64(0) < v5)^base.B2i32(v10 < v9) == v13)&base.B2i32(v10 != int64(-9223372036854775807-1)) == v13 {
		...
		if v25 != 0 {
			...
			if v28 != 0 {
				...
				F_errmsg(m, int32(_a_F_cash_dist_0), int32(0))
				mBase = m.M
				v34 = m.ExcPending
				if v34 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_cash_dist_1), int32(107), int32(_a_F_cash_dist_2))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
	...
	if v51 != v52>>(uint(int64(63))%64) {
		...
		if v61 != 0 {
			...
			if v64 != 0 {
				...
				F_errmsg(m, int32(_a_F_cash_mul_int4_0), int32(0))
				mBase = m.M
				v68 = m.ExcPending
				if v68 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_cash_mul_int4_1), int32(150), int32(_a_F_cash_mul_int4_2))
					mBase = m.M
					v73 = m.ExcPending
					if v73 != 0 {
						return int32(0)
