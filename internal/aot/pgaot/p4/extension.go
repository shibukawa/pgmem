...
L2:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v11 + int32(32)
	v25 = F_psprintf(m, int32(267343), v11+int32(16))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L83:
	;
	v265 = F_substitute_path_macro(m, v120, int32(284571), v25)
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L1
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v120
	v269 = F_psprintf(m, int32(267343), v11)
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+208)) = v56
	v77 = F_psprintf(m, int32(296561), v14+int32(208))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L12
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+192)) = v31
	v37 = F_psprintf(m, int32(174219), v14+int32(192))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+176)) = v40
	v52 = F_pg_snprintf(m, v42, int32(1024), int32(296554), v14+int32(176))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L12
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+224)) = v57
	v65 = F_psprintf(m, int32(296540), v14+int32(224))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L12
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v84))) = v107
	v116 = F_psprintf(m, int32(174219), v84)
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L12
...
L45:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v84)+16)) = int32(316231)
	F_errmsg(m, int32(316476), v84+int32(16))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L12
...
L46:
	;
	F_errfinish(m, int32(487959), int32(4047), int32(152455))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L12
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v260
	v264 = F_AllocateFile(m, v195, int32(227248))
	mBase = m.M
	v265 = m.ExcPending
	if v265 != 0 {
		goto L12
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v195
	F_errmsg(m, int32(293899), v14+int32(16))
	mBase = m.M
	v283 = m.ExcPending
	if v283 != 0 {
		goto L12
...
L85:
	;
	F_errfinish(m, int32(487959), int32(696), int32(380026))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L12
...
L173:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+64)) = v520
	F_errmsg(m, int32(339918), v14-int32(-64))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L12
...
L174:
	;
	F_errfinish(m, int32(487959), int32(751), int32(380026))
	mBase = m.M
	v531 = m.ExcPending
	if v531 != 0 {
		goto L12
...
L190:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v570
	F_errmsg(m, int32(339918), v14+int32(80))
	mBase = m.M
	v576 = m.ExcPending
	if v576 != 0 {
		goto L12
...
L191:
	;
	F_errfinish(m, int32(487959), int32(759), int32(380026))
	mBase = m.M
	v581 = m.ExcPending
	if v581 != 0 {
		goto L12
...
L207:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+96)) = v620
	F_errmsg(m, int32(339918), v14+int32(96))
	mBase = m.M
	v626 = m.ExcPending
	if v626 != 0 {
		goto L12
...
L208:
	;
	F_errfinish(m, int32(487959), int32(767), int32(380026))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L12
...
L227:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+112)) = v676
	F_errmsg(m, int32(375143), v14+int32(112))
	mBase = m.M
	v682 = m.ExcPending
	if v682 != 0 {
		goto L12
...
L228:
	;
	F_errfinish(m, int32(487959), int32(776), int32(380026))
	mBase = m.M
	v687 = m.ExcPending
	if v687 != 0 {
		goto L12
...
L245:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+128)) = v729
	F_errmsg(m, int32(160751), v14+int32(128))
	mBase = m.M
	v735 = m.ExcPending
	if v735 != 0 {
		goto L12
...
L246:
	;
	F_errfinish(m, int32(487959), int32(790), int32(380026))
	mBase = m.M
	v740 = m.ExcPending
	if v740 != 0 {
		goto L12
...
L263:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+144)) = v782
	F_errmsg(m, int32(160751), v14+int32(144))
	mBase = m.M
	v788 = m.ExcPending
	if v788 != 0 {
		goto L12
...
L264:
	;
	F_errfinish(m, int32(487959), int32(805), int32(380026))
	mBase = m.M
	v793 = m.ExcPending
	if v793 != 0 {
		goto L12
...
L267:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+160)) = v801
	F_errmsg(m, int32(691022), v14+int32(160))
	mBase = m.M
	v808 = m.ExcPending
	if v808 != 0 {
		goto L12
...
L268:
	;
	F_errfinish(m, int32(487959), int32(812), int32(380026))
	mBase = m.M
	v813 = m.ExcPending
	if v813 != 0 {
		goto L12
...
L271:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v821
	F_errmsg(m, int32(381409), v14+int32(32))
	mBase = m.M
	v827 = m.ExcPending
	if v827 != 0 {
		goto L12
...
L272:
	;
	F_errfinish(m, int32(487959), int32(719), int32(380026))
	mBase = m.M
	v832 = m.ExcPending
	if v832 != 0 {
		goto L12
...
L275:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = v840
	F_errmsg(m, int32(381409), v14+int32(48))
	mBase = m.M
	v846 = m.ExcPending
	if v846 != 0 {
		goto L12
...
L276:
	;
	F_errfinish(m, int32(487959), int32(729), int32(380026))
	mBase = m.M
	v851 = m.ExcPending
	if v851 != 0 {
		goto L12
...
L284:
	;
	F_errfinish(m, int32(487959), int32(820), int32(380026))
	mBase = m.M
	v891 = m.ExcPending
	if v891 != 0 {
		goto L12
...
L289:
	;
	F_errhint(m, int32(601876), int32(0))
	mBase = m.M
	v934 = m.ExcPending
	if v934 != 0 {
		goto L12
...
L290:
	;
	F_errfinish(m, int32(487959), int32(673), int32(380026))
	mBase = m.M
	v939 = m.ExcPending
	if v939 != 0 {
		goto L12
