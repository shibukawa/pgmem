...
func F_SPI_cursor_close(m *base.Module, l0 int32) {
	...
	if l0 == int32(0) {
		...
		if v7 != 0 {
			...
			F_errmsg_internal(m, int32(259789), int32(0))
			v11 = m.ExcPending
			if v11 != 0 {
				return
			} else {
				F_errfinish(m, int32(497998), int32(1865), int32(361367))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
...
L4:
	;
	v53 = F_strcmp(m, int32(765612), l1)
	mBase = m.M
	if v53 == int32(0) {
		goto L23
	} else {
...
L25:
	;
	v58 = F_strcmp(m, int32(765712), l1)
	mBase = m.M
	if v58 == int32(0) {
		goto L26
	} else {
...
L28:
	;
	v63 = F_strcmp(m, int32(765812), l1)
	mBase = m.M
	if v63 == int32(0) {
		goto L29
	} else {
...
L31:
	;
	v68 = F_strcmp(m, int32(765912), l1)
	mBase = m.M
	if v68 == int32(0) {
		goto L32
	} else {
...
L34:
	;
	v73 = F_strcmp(m, int32(766012), l1)
	mBase = m.M
	if v73 == int32(0) {
		goto L35
	} else {
...
L37:
	;
	v80 = F_strcmp(m, int32(766112), l1)
	mBase = m.M
	if v80 != 0 {
		goto L38
	} else {
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
	F_errmsg_internal(m, int32(239295), v9)
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L20
...
L24:
	;
	F_errfinish(m, int32(497998), int32(1424), int32(391852))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L20
				...
				case 0:
					...
					if v28 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v9
						F_errcontext_msg(m, int32(709662), v7+int32(16))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return
				...
				case 1, 2, 3:
					...
					if v37 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v9
						F_errcontext_msg(m, int32(699506), v7+int32(32))
						mBase = m.M
						v43 = m.ExcPending
						if v43 != 0 {
							return
				...
				default:
					...
					if v46 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v9
						F_errcontext_msg(m, int32(699621), v7)
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return
