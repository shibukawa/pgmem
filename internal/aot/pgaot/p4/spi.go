...
func F_SPI_cursor_close(m *base.Module, l0 int32) {
	...
	if l0 == int32(0) {
		...
		if v7 != 0 {
			...
			F_errmsg_internal(m, int32(257251), int32(0))
			v11 = m.ExcPending
			if v11 != 0 {
				return
			} else {
				F_errfinish(m, int32(492722), int32(1865), int32(357525))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
...
func F_SPI_execute(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if l2 < int32(0) {
			...
			v17 = *(*int32)(unsafe.Add(mBase, _consts[208]))
			if v17 == int32(0) {
				v77 = int32(-4)
				m.G0 = v9 - int32(-64)
				return v77
				...
				v25 = *(*int32)(unsafe.Add(mBase, _consts[208]))
				...
				if v51 != 0 {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(v9)+4)) = uint8(v2)
					...
					if v65 != 0 {
						...
						v68 = *(*int32)(unsafe.Add(mBase, _consts[208]))
...
func F_SPI_execute_plan(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l0 == v4 {
		...
		if v20 != int32(569278163) {
			...
			if l1 != 0 {
				v28 = *(*int32)(unsafe.Add(mBase, _consts[208]))
				if v28 == int32(0) {
					v130 = int32(-4)
					m.G0 = v15 + int32(32)
					return v130
					...
					v36 = *(*int32)(unsafe.Add(mBase, _consts[208]))
						...
						if v54 != 0 {
							...
							*(*int64)(unsafe.Add(mBase, uint32(v15)+16)) = int64(0)
							...
							if v116 != 0 {
								...
								v119 = *(*int32)(unsafe.Add(mBase, _consts[208]))
...
L4:
	;
	v53 = F_strcmp(m, int32(744508), l1)
	mBase = m.M
	if v53 == int32(0) {
		goto L23
	} else {
...
L25:
	;
	v58 = F_strcmp(m, int32(744608), l1)
	mBase = m.M
	if v58 == int32(0) {
		goto L26
	} else {
...
L28:
	;
	v63 = F_strcmp(m, int32(744708), l1)
	mBase = m.M
	if v63 == int32(0) {
		goto L29
	} else {
...
L31:
	;
	v68 = F_strcmp(m, int32(744808), l1)
	mBase = m.M
	if v68 == int32(0) {
		goto L32
	} else {
...
L34:
	;
	v73 = F_strcmp(m, int32(744908), l1)
	mBase = m.M
	if v73 == int32(0) {
		goto L35
	} else {
...
L37:
	;
	v80 = F_strcmp(m, int32(745008), l1)
	mBase = m.M
	if v80 != 0 {
		goto L38
	} else {
...
L2:
	;
	v14 = *(*int32)(unsafe.Add(mBase, _consts[208]))
	if v14 == int32(0) {
		goto L3
	} else {
		goto L4
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v43))) = v42
	v46 = *(*int32)(unsafe.Add(mBase, _consts[208]))
...
L16:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _consts[502]))
	if v52 == l0 {
		goto L17
	} else {
		goto L18
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
	F_errmsg_internal(m, int32(237057), v9)
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L20
...
L24:
	;
	F_errfinish(m, int32(492722), int32(1424), int32(387821))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L20
...
func F_SPI_getvalue(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, _consts[503])) = v4
	if l2 < int32(-6) {
		*(*int32)(unsafe.Add(mBase, _consts[503])) = int32(-9)
		v55 = v4
		m.G0 = v8 + int32(16)
		return v55
	} else {
		...
		if v10 == int32(0) {
			...
			if v13 != int32(1) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = v20
				v24 = int32(4473208)
				v25 = *(*int32)(unsafe.Add(mBase, _consts[385]))
				*(*int32)(unsafe.Add(mBase, _consts[385])) = v7 + int32(12)
				*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = v25
				*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = v7 + int32(24)
				v34 = int32(0)
				v36 = *(*int32)(unsafe.Add(mBase, _consts[173]))
				...
				v41 = *(*int32)(unsafe.Add(mBase, _consts[208]))
				...
				if v46 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _consts[385])) = v48
					v51 = v43
					m.G0 = v7 + int32(32)
					return v51
				}
...
func F_SPI_prepare(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	m.G0 = v9
	if l0 == int32(0) {
		*(*int32)(unsafe.Add(mBase, _consts[503])) = int32(-6)
		v72 = int32(0)
		m.G0 = v9 + int32(48)
		return v72
	} else {
		if l1 < int32(0) {
			*(*int32)(unsafe.Add(mBase, _consts[503])) = int32(-6)
			...
			if l1 == int32(0) {
				v22 = *(*int32)(unsafe.Add(mBase, _consts[208]))
				if v22 != 0 {
					v24 = *(*int32)(unsafe.Add(mBase, _consts[25]))
					v25 = *(*int32)(unsafe.Add(mBase, uint32(v24)+8))
					v27 = *(*int32)(unsafe.Add(mBase, _consts[208]))
					...
					*(*int64)(unsafe.Add(mBase, uint32(v9)+20)) = v32
					v35 = int32(0)
					*(*int32)(unsafe.Add(mBase, _consts[503])) = v35
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = int32(569278163)
					...
					if v52 != 0 {
						...
						if v56 != 0 {
							...
							v59 = *(*int32)(unsafe.Add(mBase, _consts[208]))
					...
					*(*int32)(unsafe.Add(mBase, _consts[503])) = int32(-4)
					v72 = int32(0)
					m.G0 = v9 + int32(48)
					return v72
				}
				...
				case 0:
					...
					if v28 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v9
						F_errcontext_msg(m, int32(688788), v7+int32(16))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return
				...
				case 1, 2, 3:
					...
					if v37 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v9
						F_errcontext_msg(m, int32(678632), v7+int32(32))
						mBase = m.M
						v43 = m.ExcPending
						if v43 != 0 {
							return
				...
				default:
					...
					if v46 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v9
						F_errcontext_msg(m, int32(678747), v7)
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return
...
func F__SPI_prepare_oneshot_plan(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+28)) = v14
	v18 = int32(4473208)
	v19 = *(*int32)(unsafe.Add(mBase, _consts[385]))
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, _consts[385])) = v117
	m.G0 = v11 + int32(32)
	return
L2:
	;
