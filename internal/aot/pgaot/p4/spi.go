	...
	if l0 == int32(0) {
		...
		if v7 != 0 {
			...
			if v11 != 0 {
				...
				F_errfinish(m, int32(494584), int32(1865), int32(358895))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
...
L4:
	;
	v53 = F_strcmp(m, int32(746732), l1)
	mBase = m.M
	if v53 == int32(0) {
		goto L23
	} else {
...
L25:
	;
	v58 = F_strcmp(m, int32(746832), l1)
	mBase = m.M
	if v58 == int32(0) {
		goto L26
	} else {
...
L28:
	;
	v63 = F_strcmp(m, int32(746932), l1)
	mBase = m.M
	if v63 == int32(0) {
		goto L29
	} else {
...
L31:
	;
	v68 = F_strcmp(m, int32(747032), l1)
	mBase = m.M
	if v68 == int32(0) {
		goto L32
	} else {
...
L34:
	;
	v73 = F_strcmp(m, int32(747132), l1)
	mBase = m.M
	if v73 == int32(0) {
		goto L35
	} else {
...
L37:
	;
	v80 = F_strcmp(m, int32(747232), l1)
	mBase = m.M
	if v80 != 0 {
		goto L38
	} else {
...
L16:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _consts[503]))
	if v52 == l0 {
		goto L17
	} else {
		goto L18
...
L24:
	;
	F_errfinish(m, int32(494584), int32(1424), int32(389229))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L20
...
func F_SPI_getvalue(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, _consts[504])) = v4
	if l2 < int32(-6) {
			...
			if l1 == int32(0) {
				...
				if v22 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v9)+20)) = v32
					v35 = int32(0)
					*(*int32)(unsafe.Add(mBase, _consts[504])) = v35
				...
				case 0:
					...
					if v28 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v9
						F_errcontext_msg(m, int32(691009), v7+int32(16))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return
				...
				case 1, 2, 3:
					...
					if v37 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v9
						F_errcontext_msg(m, int32(680853), v7+int32(32))
						mBase = m.M
						v43 = m.ExcPending
						if v43 != 0 {
							return
				...
				default:
					...
					if v46 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v9
						F_errcontext_msg(m, int32(680968), v7)
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return
