...
func F_SPI_execute(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if l2 < int32(0) {
			...
			v17 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute[0]))
			if v17 == int32(0) {
				v77 = int32(-4)
				m.G0 = v9 - int32(-64)
				return v77
			} else {
				v22 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute[1]))
				v23 = *(*int32)(unsafe.Add(mBase, uint32(v22)+8))
				v25 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute[0]))
				*(*int32)(unsafe.Add(mBase, uint32(v25)+12)) = v23
				v27 = *(*int32)(unsafe.Add(mBase, uint32(v25)+24))
				v29 = v7 + int32(-20)
				v30 = int64(0)
				*(*int64)(unsafe.Add(mBase, uint32(v29))) = v30
				*(*int32)(unsafe.Add(mBase, _c_F_SPI_execute[2])) = v27
				...
				if v51 != 0 {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(v9)+4)) = uint8(v2)
					...
					if v65 != 0 {
						...
						v68 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute[0]))
						v69 = *(*int32)(unsafe.Add(mBase, uint32(v68)+20))
						*(*int32)(unsafe.Add(mBase, _c_F_SPI_execute[2])) = v69
...
L4:
	;
	v53 = F_strcmp(m, int32(_a_F_SPI_fnumber_0), l1)
	mBase = m.M
	if v53 == int32(0) {
		goto L23
	} else {
...
L25:
	;
	v58 = F_strcmp(m, int32(_a_F_SPI_fnumber_2), l1)
	mBase = m.M
	if v58 == int32(0) {
		goto L26
	} else {
...
L28:
	;
	v63 = F_strcmp(m, int32(_a_F_SPI_fnumber_4), l1)
	mBase = m.M
	if v63 == int32(0) {
		goto L29
	} else {
...
L31:
	;
	v68 = F_strcmp(m, int32(_a_F_SPI_fnumber_6), l1)
	mBase = m.M
	if v68 == int32(0) {
		goto L32
	} else {
...
L34:
	;
	v73 = F_strcmp(m, int32(_a_F_SPI_fnumber_8), l1)
	mBase = m.M
	if v73 == int32(0) {
		goto L35
	} else {
...
L37:
	;
	v80 = F_strcmp(m, int32(_a_F_SPI_fnumber_10), l1)
	mBase = m.M
	if v80 != 0 {
		goto L38
	} else {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[0])) = int32(-6)
		...
		if l1 < int32(0) {
			*(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[0])) = int32(-6)
			...
			if l1 == int32(0) {
				v22 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[1]))
				if v22 != 0 {
					v24 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[2]))
					v25 = *(*int32)(unsafe.Add(mBase, uint32(v24)+8))
					v27 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[1]))
					*(*int32)(unsafe.Add(mBase, uint32(v27)+12)) = v25
					v30 = *(*int32)(unsafe.Add(mBase, uint32(v27)+24))
					*(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[3])) = v30
					v32 = int64(0)
					*(*int64)(unsafe.Add(mBase, uint32(v9)+20)) = v32
					v35 = int32(0)
					*(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[0])) = v35
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = int32(569278163)
					...
					if v52 != 0 {
						...
						if v56 != 0 {
							...
							v59 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[1]))
							v60 = *(*int32)(unsafe.Add(mBase, uint32(v59)+20))
							*(*int32)(unsafe.Add(mBase, _c_F_SPI_prepare[3])) = v60
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_prepare_oneshot_plan[0])) = v117
	m.G0 = v11 + int32(32)
	return
L2:
	;
...
L9:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v53)+41)) = v64
	v73 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_prepare_oneshot_plan[1]))
