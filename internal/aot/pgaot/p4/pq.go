			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					if v23 != 0 {
						...
						F_errfinish(m, int32(488560), int32(515), int32(157408))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
		...
		if v17 != 0 {
			...
			if v20 != 0 {
				...
				if v24 != 0 {
					...
					F_errfinish(m, int32(488560), int32(595), int32(326548))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
		...
		if v38 != 0 {
			...
			if v41 != 0 {
				...
				if v45 != 0 {
					...
					F_errfinish(m, int32(488560), int32(554), int32(62322))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return int32(0)
	...
	if v12 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v9)+272)) = v22
		...
		if v28 != int32(1) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+60)) = v31
			v38 = *(*int32)(unsafe.Add(mBase, _consts[576]))
			v40 = m.G0
			v42 = v40 - int32(16)
			m.G0 = v42
			*(*int32)(unsafe.Add(mBase, uint32(v42)+12)) = v38
			...
			m.G0 = v42 + int32(16)
			v69 = *(*int32)(unsafe.Add(mBase, _consts[577]))
			v71 = m.G0
			v73 = v71 - int32(16)
			m.G0 = v73
			...
			*(*int32)(unsafe.Add(mBase, uint32(v104)+12)) = v100
			...
			m.G0 = v104 + int32(16)
			v131 = *(*int32)(unsafe.Add(mBase, _consts[579]))
			v133 = m.G0
			v135 = v133 - int32(16)
			m.G0 = v135
		...
		v162 = int32(8192)
		*(*int32)(unsafe.Add(mBase, _consts[580])) = v162
		...
		if v169 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[581])) = v168
			v172 = int32(0)
			...
			if v191 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = int32(1)
				...
				if v218 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _consts[588])) = v217
					...
					if v224 != 0 {
						...
						v226 = *(*int32)(unsafe.Add(mBase, _consts[588]))
						v230 = *(*int32)(unsafe.Add(mBase, _consts[497]))
						...
						if v232 != 0 {
							...
							v234 = *(*int32)(unsafe.Add(mBase, _consts[588]))
...
L38:
	;
	v59 = int32(530806)
	v62 = int32(*(*uint8)(unsafe.Add(mBase, _consts[592])))
...
L49:
	;
	v89 = int32(530922)
	v92 = int32(*(*uint8)(unsafe.Add(mBase, _consts[593])))
...
L60:
	;
	v119 = int32(522332)
	v122 = int32(*(*uint8)(unsafe.Add(mBase, _consts[594])))
...
L71:
	;
	v149 = int32(536994)
	v152 = int32(*(*uint8)(unsafe.Add(mBase, _consts[595])))
...
L82:
	;
	v179 = int32(531262)
	v182 = int32(*(*uint8)(unsafe.Add(mBase, _consts[596])))
...
L93:
	;
	v209 = int32(519761)
	v212 = int32(*(*uint8)(unsafe.Add(mBase, _consts[597])))
...
L104:
	;
	v239 = int32(528675)
	v242 = int32(*(*uint8)(unsafe.Add(mBase, _consts[598])))
...
L115:
	;
	v269 = int32(539114)
	v272 = int32(*(*uint8)(unsafe.Add(mBase, _consts[599])))
...
L127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v53
	F_errmsg_internal(m, int32(703855), v8+int32(16))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L12
...
L128:
	;
	F_errfinish(m, int32(490631), int32(272), int32(413916))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L12
...
L145:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v56
	F_errmsg_internal(m, int32(481951), v8)
	mBase = m.M
	v404 = m.ExcPending
	if v404 != 0 {
		goto L12
...
L146:
	;
	F_errfinish(m, int32(490631), int32(326), int32(413916))
	mBase = m.M
	v409 = m.ExcPending
	if v409 != 0 {
		goto L12
...
L152:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v53
	F_errmsg_internal(m, int32(706902), v8+int32(32))
	mBase = m.M
	v436 = m.ExcPending
	if v436 != 0 {
		goto L12
...
L153:
	;
	F_errfinish(m, int32(490631), int32(276), int32(413916))
	mBase = m.M
	v441 = m.ExcPending
	if v441 != 0 {
		goto L12
...
func F_pq_redirect_to_shm_mq(m *base.Module, l0 int32, l1 int32) {
	...
	var v17 int32
	_ = v17
	*(*int32)(unsafe.Add(mBase, _consts[590])) = l1
	*(*int32)(unsafe.Add(mBase, _consts[314])) = int32(1597624)
	*(*int32)(unsafe.Add(mBase, _consts[216])) = int32(2)
	*(*int32)(unsafe.Add(mBase, _consts[591])) = int32(196610)
