			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					if v23 != 0 {
						...
						F_errfinish(m, int32(493920), int32(515), int32(158774))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
	...
	if v10 <= v9 {
		...
		if v17 != 0 {
			...
			if v20 != 0 {
				...
				F_errmsg(m, int32(404957), int32(0))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(493920), int32(595), int32(329976))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
		...
		if v38 != 0 {
			...
			if v41 != 0 {
				...
				if v45 != 0 {
					...
					F_errfinish(m, int32(493920), int32(554), int32(62642))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return int32(0)
...
L127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v53
	F_errmsg_internal(m, int32(724882), v8+int32(16))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L12
...
L128:
	;
	F_errfinish(m, int32(496019), int32(272), int32(418432))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L12
...
L145:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v56
	F_errmsg_internal(m, int32(487243), v8)
	mBase = m.M
	v404 = m.ExcPending
	if v404 != 0 {
		goto L12
...
L146:
	;
	F_errfinish(m, int32(496019), int32(326), int32(418432))
	mBase = m.M
	v409 = m.ExcPending
	if v409 != 0 {
		goto L12
...
L152:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v53
	F_errmsg_internal(m, int32(728148), v8+int32(32))
	mBase = m.M
	v436 = m.ExcPending
	if v436 != 0 {
		goto L12
...
L153:
	;
	F_errfinish(m, int32(496019), int32(276), int32(418432))
	mBase = m.M
	v441 = m.ExcPending
	if v441 != 0 {
		goto L12
...
func F_pq_redirect_to_shm_mq(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[323])) = int32(1618872)
