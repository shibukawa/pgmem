			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					if v23 != 0 {
						...
						F_errfinish(m, int32(470696), int32(515), int32(148991))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
...
L23:
	;
	F_errmsg(m, int32(385543), int32(0))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L21
...
L24:
	;
	F_errfinish(m, int32(470696), int32(595), int32(313386))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L21
...
L33:
	;
	F_errfinish(m, int32(470696), int32(554), int32(60008))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L4
...
L127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v53
	F_errmsg_internal(m, int32(682930), v8+int32(16))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L12
...
L128:
	;
	F_errfinish(m, int32(472737), int32(272), int32(398112))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L12
...
L162:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v56
	F_errmsg_internal(m, int32(464534), v8)
	mBase = m.M
	v460 = m.ExcPending
	if v460 != 0 {
		goto L12
...
L163:
	;
	F_errfinish(m, int32(472737), int32(326), int32(398112))
	mBase = m.M
	v465 = m.ExcPending
	if v465 != 0 {
		goto L12
...
L169:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v53
	F_errmsg_internal(m, int32(685939), v8+int32(32))
	mBase = m.M
	v492 = m.ExcPending
	if v492 != 0 {
		goto L12
...
L170:
	;
	F_errfinish(m, int32(472737), int32(276), int32(398112))
	mBase = m.M
	v497 = m.ExcPending
	if v497 != 0 {
		goto L12
...
func F_pq_redirect_to_shm_mq(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[314])) = int32(1576600)
