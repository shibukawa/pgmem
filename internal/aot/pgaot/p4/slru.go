...
func F_SlruReportIOError(m *base.Module, l0 int32, l1 int64, l2 int32) {
	...
	if v16 == int32(1) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+256)) = v13
		v27 = F_pg_snprintf(m, v10+int32(288), int32(1024), int32(501081), v10+int32(256))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = l2
							...
							if v89 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v10 + int32(288)
								F_errdetail(m, int32(596739), v10+int32(32))
								mBase = m.M
								v98 = m.ExcPending
								if v98 != 0 {
									return
								} else {
									F_errfinish(m, int32(484137), int32(1070), int32(209511))
									mBase = m.M
									v103 = m.ExcPending
									if v103 != 0 {
										return
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+112)) = l2
								...
								if v216 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = v10 + int32(288)
									F_errdetail(m, int32(596691), v10+int32(96))
									mBase = m.M
									v225 = m.ExcPending
									if v225 != 0 {
										return
									} else {
										F_errfinish(m, int32(484137), int32(1078), int32(209511))
										mBase = m.M
										v230 = m.ExcPending
										if v230 != 0 {
											return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+80)) = l2
							...
							if v113 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = v10 + int32(288)
								F_errdetail(m, int32(572089), v10-int32(-64))
								mBase = m.M
								v122 = m.ExcPending
								if v122 != 0 {
									return
								} else {
									F_errfinish(m, int32(484137), int32(1082), int32(209511))
									mBase = m.M
									v127 = m.ExcPending
									if v127 != 0 {
										return
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+176)) = l2
								...
								if v238 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10)+160)) = v10 + int32(288)
									F_errdetail(m, int32(596644), v10+int32(160))
									mBase = m.M
									v247 = m.ExcPending
									if v247 != 0 {
										return
									} else {
										F_errfinish(m, int32(484137), int32(1090), int32(209511))
										mBase = m.M
										v252 = m.ExcPending
										if v252 != 0 {
											return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+144)) = l2
							...
							if v137 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+128)) = v10 + int32(288)
								F_errdetail(m, int32(572025), v10+int32(128))
								mBase = m.M
								v146 = m.ExcPending
								if v146 != 0 {
									return
								} else {
									F_errfinish(m, int32(484137), int32(1095), int32(209511))
									mBase = m.M
									v151 = m.ExcPending
									if v151 != 0 {
										return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+240)) = l2
							...
							if v195 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+224)) = v10 + int32(288)
								F_errdetail(m, int32(596855), v10+int32(224))
								mBase = m.M
								v203 = m.ExcPending
								if v203 != 0 {
									return
								} else {
									F_errfinish(m, int32(484137), int32(1109), int32(209511))
									mBase = m.M
									v208 = m.ExcPending
									if v208 != 0 {
										return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l2
							...
							if v66 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10))) = v10 + int32(288)
								F_errdetail(m, int32(596825), v10)
								mBase = m.M
								v72 = m.ExcPending
								if v72 != 0 {
									return
								} else {
									F_errfinish(m, int32(484137), int32(1063), int32(209511))
									mBase = m.M
									v77 = m.ExcPending
									if v77 != 0 {
										return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+208)) = l2
							...
							if v167 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+192)) = v10 + int32(288)
								F_errdetail(m, int32(596886), v10+int32(192))
								mBase = m.M
								v175 = m.ExcPending
								if v175 != 0 {
									return
								} else {
									F_errfinish(m, int32(484137), int32(1102), int32(209511))
									mBase = m.M
									v180 = m.ExcPending
									if v180 != 0 {
										return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+272)) = v13
		v37 = F_pg_snprintf(m, v10+int32(288), int32(1024), int32(501468), v10+int32(272))
		mBase = m.M
		v38 = m.ExcPending
		if v38 != 0 {
			return
