...
L25:
	...
	v93 = int32(*(*uint8)(unsafe.Add(mBase, _c_F__int_matchsel[1])))
	if v93 == int32(0) {
		v112 = v92
		v113 = v93
		goto L29
...
L57:
	...
	v240 = int32(_a_F__int_matchsel_0)
	v243 = int32(*(*uint8)(unsafe.Add(mBase, _c_F__int_matchsel[1])))
...
L73:
	;
	v323 = *(*int32)(unsafe.Add(mBase, _c_F__int_matchsel[0]))
	if v323 == int32(0) {
		goto L76
	} else {
		goto L77
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v341)+8)) = int32(_a_F__int_matchsel_0)
...
L78:
	;
	v332 = *(*int32)(unsafe.Add(mBase, _c_F__int_matchsel[2]))
...
L80:
	;
	v336 = int32(_a_F__int_matchsel_1)
	v337 = *(*int32)(unsafe.Add(mBase, _c_F__int_matchsel[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v334))) = v337
	*(*int32)(unsafe.Add(mBase, _c_F__int_matchsel[0])) = v334
	v341 = v334
	goto L75
L81:
	;
