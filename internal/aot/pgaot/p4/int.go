...
L73:
	;
	v323 = *(*int32)(unsafe.Add(mBase, _consts[437]))
	if v323 == int32(0) {
		goto L76
	} else {
		goto L77
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v341)+8)) = int32(97480)
...
L80:
	;
	v336 = int32(4459076)
	v337 = *(*int32)(unsafe.Add(mBase, _consts[437]))
	*(*int32)(unsafe.Add(mBase, uint32(v334))) = v337
	*(*int32)(unsafe.Add(mBase, _consts[437])) = v334
	v341 = v334
	goto L75
L81:
	;
						...
						if v91 != 0 {
							...
							if v94 != 0 {
								...
								if v100 != 0 {
									...
									F_errfinish(m, int32(521579), int32(108), int32(251446))
									mBase = m.M
									v107 = m.ExcPending
									if v107 != 0 {
										return int32(0)
									...
									if v111 != 0 {
										...
										if v114 != 0 {
											...
											if v120 != 0 {
												...
												F_errfinish(m, int32(521579), int32(109), int32(251446))
												mBase = m.M
												v127 = m.ExcPending
												if v127 != 0 {
													return int32(0)
