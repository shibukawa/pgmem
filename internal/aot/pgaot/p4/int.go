...
L25:
	...
	v93 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1567])))
	if v93 == int32(0) {
		v112 = v92
		v113 = v93
		goto L29
...
L57:
	...
	v240 = int32(97469)
	v243 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1567])))
...
L73:
	;
	v323 = *(*int32)(unsafe.Add(mBase, _consts[441]))
	if v323 == int32(0) {
		goto L76
	} else {
		goto L77
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v341)+8)) = int32(97469)
...
L80:
	;
	v336 = int32(4459076)
	v337 = *(*int32)(unsafe.Add(mBase, _consts[441]))
	*(*int32)(unsafe.Add(mBase, uint32(v334))) = v337
	*(*int32)(unsafe.Add(mBase, _consts[441])) = v334
	v341 = v334
	goto L75
L81:
	;
						...
						if v91 != 0 {
							...
							if v94 != 0 {
								...
								if v100 != 0 {
									...
									F_errfinish(m, int32(521138), int32(108), int32(251254))
									mBase = m.M
									v107 = m.ExcPending
									if v107 != 0 {
										return int32(0)
									...
									if v111 != 0 {
										...
										if v114 != 0 {
											...
											if v120 != 0 {
												...
												F_errfinish(m, int32(521138), int32(109), int32(251254))
												mBase = m.M
												v127 = m.ExcPending
												if v127 != 0 {
													return int32(0)
