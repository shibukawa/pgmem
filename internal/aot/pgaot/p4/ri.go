...
func F_RI_FKey_check_upd(m *base.Module, l0 int32) int32 {
	...
	var v10 int32
	_ = v10
	F_ri_CheckTrigger(m, l0, int32(423070), int32(2))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
L33:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v20)+48)) = int64(3023656976388)
	v126 = F_hash_create(m, int32(400127), int32(64), v20+int32(32), int32(40))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L12
...
L37:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v20)+48)) = int64(51539607560)
	v142 = F_hash_create(m, int32(400028), int32(256), v20+int32(32), int32(40))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L12
...
L38:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v20)+48)) = int64(292057776136)
	v153 = F_hash_create(m, int32(400441), int32(256), v20+int32(32), int32(40))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L12
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v278
	F_errmsg_internal(m, int32(183198), v20)
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L12
...
L72:
	;
	F_errfinish(m, int32(494910), int32(3190), int32(239567))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		goto L12
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+52)) = v20 + int32(352)
	F_appendStringInfo(m, v20+int32(616), int32(522287), v20+int32(48))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L1
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+36)) = v20 + int32(208)
	F_appendStringInfo(m, v20+int32(616), int32(198907), v20+int32(32))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L1
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v367
	v374 = F_pg_sprintf(m, v20+int32(192), int32(468203), v20+int32(16))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L1
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v305
	F_appendStringInfo(m, v20+int32(616), int32(739756), v20)
	mBase = m.M
	v385 = m.ExcPending
	if v385 != 0 {
		goto L1
...
L96:
	;
	F_errfinish(m, int32(494910), int32(1348), int32(106602))
	mBase = m.M
	v476 = m.ExcPending
	if v476 != 0 {
		goto L1
