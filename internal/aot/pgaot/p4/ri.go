...
L47:
	;
	v187 = int32(_a_F_ri_set_3)
	goto L49
L48:
	;
	v187 = int32(_a_F_ri_set_4)
	goto L49
L49:
	;
	v196 = int32(0)
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v367
	v374 = F_pg_sprintf(m, v20+int32(192), int32(_a_F_ri_set_8), v20+int32(16))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L1
