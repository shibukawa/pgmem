			...
			if v21 == int32(0) {
				...
				if v84 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v11)+16)) = l1
					F_errmsg_internal(m, int32(450117), v11+int32(16))
					mBase = m.M
					v90 = m.ExcPending
					if v90 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(521740), int32(3344), int32(143820))
						mBase = m.M
						v95 = m.ExcPending
						if v95 != 0 {
							return int32(0)
					...
					if v27 == int32(0) {
						...
						if v99 != 0 {
							...
							*(*int64)(unsafe.Add(mBase, uint32(v11))) = l2
							F_errmsg_internal(m, int32(450117), v11)
							mBase = m.M
							v103 = m.ExcPending
							if v103 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(521740), int32(3347), int32(143820))
								mBase = m.M
								v108 = m.ExcPending
								if v108 != 0 {
									return int32(0)
				...
				if v57 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v15
					...
					if v63 != 0 {
						...
						F_errfinish(m, int32(519538), int32(114), int32(580902))
						mBase = m.M
						v70 = m.ExcPending
						if v70 != 0 {
							return int32(0)
