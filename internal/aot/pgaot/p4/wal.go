...
func F_GetWalSummaries(m *base.Module, l0 int32, l1 int64, l2 int64) int32 {
	...
	v19 = v17 + int32(-64)
	m.G0 = v19
	v22 = F_AllocateDir(m, int32(179022))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L2
...
L3:
	;
	v27 = F_ReadDir(m, v22, int32(179022))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L2
...
L10:
	;
	v224 = F_ReadDir(m, v22, int32(179022))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L2
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v17 + int32(-32)
	v187 = F_sscanf(m, v64, int32(537002), v19)
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L2
...
L3:
	;
	F_s_lock(m, v35, int32(520534), int32(188), int32(292331))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L1
...
L13:
	;
	F_errmsg_internal(m, int32(370401), int32(0))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L1
...
L14:
	;
	F_errfinish(m, int32(520534), int32(213), int32(292331))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L1
...
L92:
	;
	v390 = F___memcpy(m, int32(4736124), v379, int32(140))
	mBase = m.M
	goto L94
L93:
	;
...
L105:
	;
	v432 = F___memcpy(m, int32(4736264), v421, int32(140))
	mBase = m.M
	goto L107
L106:
	;
...
L118:
	;
	v474 = F___memcpy(m, int32(4738084), v463, int32(140))
	mBase = m.M
	goto L120
L119:
	;
...
L131:
	;
	v516 = F___memcpy(m, int32(4737944), v505, int32(140))
	mBase = m.M
	goto L133
L132:
	;
...
L144:
	;
	v558 = F___memcpy(m, int32(4737804), v547, int32(140))
	mBase = m.M
	goto L146
L145:
	;
...
L157:
	;
	v600 = F___memcpy(m, int32(4737384), v589, int32(140))
	mBase = m.M
	goto L159
L158:
	;
...
L170:
	;
	v642 = F___memcpy(m, int32(4737664), v631, int32(140))
	mBase = m.M
	goto L172
L171:
	;
...
L173:
	;
	F_load_file(m, int32(226473), int32(0))
	mBase = m.M
	v691 = m.ExcPending
	if v691 != 0 {
		goto L1
...
L183:
	;
	v684 = F___memcpy(m, int32(4738364), v673, int32(140))
	mBase = m.M
	goto L185
L184:
	;
...
L200:
	;
	F_s_lock(m, v35, int32(520534), int32(286), int32(292331))
	mBase = m.M
	v740 = m.ExcPending
	if v740 != 0 {
		goto L1
...
L285:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v18)+208)) = v1004
	v1012 = F_pg_snprintf(m, v18+int32(272), int32(32), int32(40068), v18+int32(208))
	mBase = m.M
	v1013 = m.ExcPending
	if v1013 != 0 {
		goto L1
...
L311:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v18)+192)) = base.I64_extend_i32_s(v1071)
	v1081 = F_pg_snprintf(m, v18+int32(336), int32(64), int32(451394), v18+int32(192))
	mBase = m.M
	v1082 = m.ExcPending
	if v1082 != 0 {
		goto L1
...
L314:
	;
	F_s_lock(m, v35, int32(520534), int32(364), int32(292331))
	mBase = m.M
	v1104 = m.ExcPending
	if v1104 != 0 {
		goto L1
...
L365:
	;
	F_errfinish(m, int32(520534), v1269, int32(292331))
	mBase = m.M
	v1272 = m.ExcPending
	if v1272 != 0 {
		goto L1
...
L367:
	...
	*(*int64)(unsafe.Add(mBase, _consts[872])) = v1276
	F_initStringInfo(m, int32(4472368))
	mBase = m.M
	v1283 = m.ExcPending
	if v1283 != 0 {
		goto L1
...
L493:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+144)) = v18 + int32(1440)
	F_errmsg(m, int32(307089), v18+int32(144))
	mBase = m.M
	v1836 = m.ExcPending
	if v1836 != 0 {
		goto L1
...
L494:
	;
	F_errfinish(m, int32(520534), int32(953), int32(368249))
	mBase = m.M
	v1841 = m.ExcPending
	if v1841 != 0 {
		goto L1
...
L505:
	;
	F_errmsg_internal(m, int32(18365), int32(0))
	mBase = m.M
	v1884 = m.ExcPending
	if v1884 != 0 {
		goto L1
...
L506:
	;
	F_errfinish(m, int32(520534), int32(837), int32(344414))
	mBase = m.M
	v1889 = m.ExcPending
	if v1889 != 0 {
		goto L1
...
L509:
	;
	F_errmsg_internal(m, int32(18317), int32(0))
	mBase = m.M
	v1902 = m.ExcPending
	if v1902 != 0 {
		goto L1
...
L510:
	;
	F_errfinish(m, int32(520534), int32(861), int32(344414))
	mBase = m.M
	v1907 = m.ExcPending
	if v1907 != 0 {
		goto L1
...
L513:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+32)) = v1538
	F_errmsg_internal(m, int32(499777), v18+int32(32))
	mBase = m.M
	v1920 = m.ExcPending
	if v1920 != 0 {
		goto L1
...
L514:
	;
	F_errfinish(m, int32(520534), int32(882), int32(344414))
	mBase = m.M
	v1925 = m.ExcPending
	if v1925 != 0 {
		goto L1
...
L523:
	;
	F_errmsg(m, int32(225587), int32(0))
	mBase = m.M
	v2008 = m.ExcPending
	if v2008 != 0 {
		goto L1
...
L526:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v18)+132)) = uint32(v2015)
	F_errdetail(m, int32(688077), v18+int32(128))
	mBase = m.M
	v2021 = m.ExcPending
	if v2021 != 0 {
		goto L1
...
L527:
	;
	F_errfinish(m, int32(520534), int32(475), int32(292331))
	mBase = m.M
	v2026 = m.ExcPending
	if v2026 != 0 {
		goto L1
...
L577:
	;
	F_errmsg(m, int32(484149), int32(0))
	mBase = m.M
	v2230 = m.ExcPending
	if v2230 != 0 {
		goto L1
...
L578:
	;
	F_errfinish(m, int32(520534), int32(428), int32(292331))
	mBase = m.M
	v2235 = m.ExcPending
	if v2235 != 0 {
		goto L1
...
L581:
	;
	F_errmsg(m, int32(71768), int32(0))
	mBase = m.M
	v2246 = m.ExcPending
	if v2246 != 0 {
		goto L1
...
L582:
	;
	F_errfinish(m, int32(520534), int32(573), int32(292331))
	mBase = m.M
	v2251 = m.ExcPending
	if v2251 != 0 {
		goto L1
...
L585:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+20)) = v2261
	F_errmsg(m, int32(55615), v18+int32(16))
	mBase = m.M
	v2267 = m.ExcPending
	if v2267 != 0 {
		goto L1
...
L586:
	;
	F_errfinish(m, int32(520534), int32(337), int32(292331))
	mBase = m.M
	v2272 = m.ExcPending
	if v2272 != 0 {
		goto L1
...
L588:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+176)) = v2275
	F_errmsg(m, int32(56557), v18+int32(176))
	mBase = m.M
	v2281 = m.ExcPending
	if v2281 != 0 {
		goto L1
...
L589:
	;
	F_errfinish(m, int32(520534), int32(606), int32(292331))
	mBase = m.M
	v2286 = m.ExcPending
	if v2286 != 0 {
		goto L1
...
L593:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v18)+120)) = uint32(v2322)
	v2330 = F_pg_snprintf(m, v18+int32(1440), int32(64), int32(537030), v18+int32(112))
	mBase = m.M
	v2331 = m.ExcPending
	if v2331 != 0 {
		goto L1
...
L602:
	;
	F_errmsg_internal(m, int32(149547), int32(0))
	mBase = m.M
	v2360 = m.ExcPending
	if v2360 != 0 {
		goto L1
...
L605:
	;
	F_errfinish(m, int32(520534), int32(635), int32(292331))
	mBase = m.M
	v2365 = m.ExcPending
	if v2365 != 0 {
		goto L1
...
L607:
	;
	F_s_lock(m, v2372, int32(520534), int32(650), int32(262876))
	mBase = m.M
	v2377 = m.ExcPending
	if v2377 != 0 {
		goto L1
...
L615:
	;
	F_errmsg_internal(m, int32(371026), int32(0))
	mBase = m.M
	v2392 = m.ExcPending
	if v2392 != 0 {
		goto L1
...
L616:
	;
	F_errfinish(m, int32(520534), int32(658), int32(262876))
	mBase = m.M
	v2397 = m.ExcPending
	if v2397 != 0 {
		goto L1
...
L626:
	;
	F_s_lock(m, v2372, int32(520534), int32(678), int32(262876))
	mBase = m.M
	v2438 = m.ExcPending
	if v2438 != 0 {
		goto L1
...
L635:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v18)+80)) = uint32(v2467)
	v2475 = F_pg_snprintf(m, v18+int32(1440), int32(50), int32(539720), v18+int32(80))
	mBase = m.M
	v2476 = m.ExcPending
	if v2476 != 0 {
		goto L1
...
L640:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v18)+64)) = v2491
	v2499 = F_pg_snprintf(m, v18+int32(272), int32(32), int32(40068), v18-int32(-64))
	mBase = m.M
	v2500 = m.ExcPending
	if v2500 != 0 {
		goto L1
...
L652:
	;
	F_errmsg(m, int32(24390), int32(0))
	mBase = m.M
	v2555 = m.ExcPending
	if v2555 != 0 {
		goto L1
...
L653:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+52)) = v18 + int32(272)
	F_errdetail(m, int32(633878), v18+int32(48))
	mBase = m.M
	v2564 = m.ExcPending
	if v2564 != 0 {
		goto L1
...
L654:
	;
	F_errfinish(m, int32(520534), int32(326), int32(292331))
	mBase = m.M
	v2569 = m.ExcPending
	if v2569 != 0 {
		goto L1
...
L657:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+96)) = v18 + int32(1440)
	F_errmsg(m, int32(308413), v18+int32(96))
	mBase = m.M
	v2583 = m.ExcPending
	if v2583 != 0 {
		goto L1
...
L658:
	;
	F_errfinish(m, int32(520534), int32(622), int32(292331))
	mBase = m.M
	v2588 = m.ExcPending
	if v2588 != 0 {
		goto L1
...
L663:
	;
	F_errfinish(m, int32(520534), int32(277), int32(292331))
	mBase = m.M
	v2609 = m.ExcPending
	if v2609 != 0 {
		goto L1
...
L665:
	;
	F_errmsg_internal(m, int32(19551), int32(0))
	mBase = m.M
	v2617 = m.ExcPending
	if v2617 != 0 {
		goto L1
...
L666:
	;
	F_errfinish(m, int32(520534), int32(265), int32(292331))
	mBase = m.M
	v2622 = m.ExcPending
	if v2622 != 0 {
		goto L1
...
func F_WalSndSegmentOpen(m *base.Module, l0 int32, l1 int64, l2 int32) {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v10)+40)) = uint32(v35)
	v43 = F_pg_snprintf(m, v10+int32(112), int32(1024), int32(537023), v10+int32(32))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		return
						...
						if v92 != 0 {
							...
							if v94 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10))) = v10 + int32(48)
								F_errmsg(m, int32(462364), v10)
								mBase = m.M
								v100 = m.ExcPending
								if v100 != 0 {
									return
								} else {
									F_errfinish(m, int32(520866), int32(3089), int32(295861))
									mBase = m.M
									v105 = m.ExcPending
									if v105 != 0 {
										return
					...
					if v60 != 0 {
						...
						if v62 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v10 + int32(112)
							F_errmsg(m, int32(313457), v10+int32(16))
							mBase = m.M
							v70 = m.ExcPending
							if v70 != 0 {
								return
							} else {
								F_errfinish(m, int32(520866), int32(3095), int32(295861))
								mBase = m.M
								v75 = m.ExcPending
								if v75 != 0 {
									return
...
func F_WalSndWriteData(m *base.Module, l0 int32, l1 int64, l2 int32, l3 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[896])) = v7
	...
	F_enlargeStringInfo(m, int32(4472544), int32(8))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		return
...
L20:
	;
	v74 = F___memcpy(m, int32(4736124), v63, int32(140))
	mBase = m.M
	goto L22
L21:
	;
...
L33:
	;
	v118 = F___memcpy(m, int32(4736264), v107, int32(140))
	mBase = m.M
	goto L35
L34:
	;
...
L46:
	;
	v162 = F___memcpy(m, int32(4738084), v151, int32(140))
	mBase = m.M
	goto L48
L47:
	;
...
L59:
	;
	v206 = F___memcpy(m, int32(4737944), v195, int32(140))
	mBase = m.M
	goto L61
L60:
	;
...
L72:
	;
	v250 = F___memcpy(m, int32(4737804), v239, int32(140))
	mBase = m.M
	goto L74
L73:
	;
...
L85:
	;
	v294 = F___memcpy(m, int32(4737384), v283, int32(140))
	mBase = m.M
	goto L87
L86:
	;
...
L98:
	;
	v338 = F___memcpy(m, int32(4737664), v327, int32(140))
	mBase = m.M
	goto L100
L99:
	;
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+12)) = v25
	...
	v394 = F_AllocSetContextCreateInternal(m, v389, int32(227572), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		v568 = v25
...
L111:
	;
	v382 = F___memcpy(m, int32(4738364), v371, int32(140))
	mBase = m.M
	goto L113
L112:
	;
