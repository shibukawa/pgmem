...
L19:
	;
	v60 = int32(_a_F_domain_check_input_0)
	v61 = *(*int32)(unsafe.Add(mBase, _c_F_domain_check_input[0]))
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v192
	F_errmsg(m, int32(_a_F_domain_check_input_1), v17+int32(16))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L4
...
L48:
	;
	v210 = int32(_a_F_domain_check_input_0)
	v211 = *(*int32)(unsafe.Add(mBase, _c_F_domain_check_input[0]))
	v213 = *(*int32)(unsafe.Add(mBase, uint32(l2)+80))
	*(*int32)(unsafe.Add(mBase, _c_F_domain_check_input[0])) = v213
...
L51:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_domain_check_input[0])) = v211
...
L53:
	...
	if v223 != int32(_a_F_domain_check_input_4) {
		v236 = l0
		goto L52
	} else {
		goto L54
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v250
	F_errmsg(m, int32(_a_F_domain_check_input_5), v17+int32(32))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L4
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v276
	F_errmsg_internal(m, int32(_a_F_domain_check_input_6), v17)
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L4
