...
func F_InvalidateCatalogSnapshot(m *base.Module) {
	...
	if v3 == int32(0) {
		...
		F_pairingheap_remove(m, int32(4121192), v3+int32(52))
		mBase = m.M
		v10 = m.ExcPending
		if v10 != 0 {
			return
					...
					if v60 != 0 {
						...
						if v71 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v8 + int32(24)
							F_errmsg_internal(m, int32(643324), v8)
							mBase = m.M
							v83 = m.ExcPending
							if v83 != 0 {
								return
							} else {
								F_errfinish(m, int32(479011), int32(637), int32(217167))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return
						...
						if v41 == int32(0) {
							...
							if v92 != 0 {
								...
								if v96 != 0 {
									...
									F_errfinish(m, int32(479011), int32(643), int32(217167))
									mBase = m.M
									v101 = m.ExcPending
									if v101 != 0 {
										return
