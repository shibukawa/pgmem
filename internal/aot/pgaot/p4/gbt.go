...
func F_gbt_float4_union(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = Fn13884(m, l0, int32(_a_F_gbt_float4_union_0), int32(8))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
func F_gbt_numeric_consistent(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13885(m, l0, int32(_a_F_gbt_numeric_consistent_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_numeric_ssup_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = Fn13882(m, l0, l1, l2, int32(1327))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gbt_oid_distance(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13889(m, l0, int32(_a_F_gbt_oid_distance_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
func F_gbt_text_ssup_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = Fn13894(m, l0, l1, l2, int32(2104))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gbt_uuid_same(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = Fn13883(m, l0, int32(_a_F_gbt_uuid_same_0))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
