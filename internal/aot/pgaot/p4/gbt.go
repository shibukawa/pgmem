	...
	if v18 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v20))) = uint8(v44)
		...
		if v49&int32(1) != 0 {
			...
			v60 = F_gbt_var_consistent(m, v11+int32(8), v15, v19&int32(_a_F_gbt_bit_consistent_0), v56, int32(1), int32(_a_F_gbt_bit_consistent_1), v59)
			mBase = m.M
			v61 = m.ExcPending
			if v61 != 0 {
				return int32(0)
			...
			if v70 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v69))) = v68 << (uint(v81) % 32)
				...
				v103 = F_gbt_var_consistent(m, v11+int32(8), v69, v19&int32(_a_F_gbt_bit_consistent_0), v99, int32(0), int32(_a_F_gbt_bit_consistent_1), v102)
				mBase = m.M
				v104 = m.ExcPending
				if v104 != 0 {
					return int32(0)
...
func F_gbt_float4_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(8)
		...
		v15 = F_gbt_num_union(m, v6, v4, int32(_a_F_gbt_float4_union_0), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_float8_sortsupport(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_float8_sortsupport_0)
	return v3
}
...
func F_gbt_inet_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_inet_sortsupport_0)
	return v3
}
...
func F_gbt_macad8_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_macad8_sortsupport_0)
	return v3
}
...
func F_gbt_macaddr_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_macaddr_sortsupport_0)
	return v3
}
...
func F_gbt_num_picksplit(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	v17 = (v13 - int32(1)) & int32(_a_F_gbt_num_picksplit_0)
...
L4:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l1)+4)) = v36
	if v13&int32(_a_F_gbt_num_picksplit_0) == int32(1) {
		goto L5
	} else {
		goto L6
	}
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v72)+4)) = v69
	v78 = (v54 + int32(1)) & int32(_a_F_gbt_num_picksplit_0)
...
L15:
	;
	v198 = (v89 + int32(1)) & int32(_a_F_gbt_num_picksplit_0)
...
func F_gbt_numeric_consistent(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v18))) = uint8(v42)
		...
		v55 = F_gbt_var_consistent(m, v9+int32(8), v13, v17, v46, v50&int32(1), int32(_a_F_gbt_numeric_consistent_0), v54)
		mBase = m.M
		v56 = m.ExcPending
		if v56 != 0 {
			return int32(0)
...
func F_gbt_oid_distance(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v12
	...
	v29 = F_gbt_num_distance(m, v7+v13, v7+int32(12), v24&int32(1), int32(_a_F_gbt_oid_distance_0), v28)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		return int32(0)
...
func F_gbt_uuid_same(m *base.Module, l0 int32) int32 {
	...
	v8 = F_gbt_num_same(m, v4, v5, int32(_a_F_gbt_uuid_same_0), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
