...
func F_gbt_bit_compress(m *base.Module, l0 int32) int32 {
	...
	v4 = F_gbt_var_compress(m, v2, int32(4376544))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	...
	if v18 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v20))) = uint8(v44)
		...
		if v49&int32(1) != 0 {
			...
			v60 = F_gbt_var_consistent(m, v11+int32(8), v15, v19&int32(65535), v56, int32(1), int32(4376544), v59)
			mBase = m.M
			v61 = m.ExcPending
			if v61 != 0 {
				return int32(0)
			...
			if v70 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v69))) = v68 << (uint(v81) % 32)
				...
				v103 = F_gbt_var_consistent(m, v11+int32(8), v69, v19&int32(65535), v99, int32(0), int32(4376544), v102)
				mBase = m.M
				v104 = m.ExcPending
				if v104 != 0 {
					return int32(0)
...
func F_gbt_bytea_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_var_compress(m, v2, int32(4376624))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_cash_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4376664))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_enum_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4376744))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_float4_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(8)
		...
		v15 = F_gbt_num_union(m, v6, v4, int32(4376784), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_float8_sortsupport(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6820)
	return v3
}
...
func F_gbt_inet_picksplit(m *base.Module, l0 int32) int32 {
	...
	v6 = F_gbt_num_picksplit(m, v2, v3, int32(4376928), v5)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
...
func F_gbt_inet_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6828)
	return v3
}
func F_gbt_int2_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4376968))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_int2_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v14
	...
	v36 = F_gbt_num_consistent(m, v7+int32(4), v7+int32(14), v7+int32(12), v31&int32(1), int32(4376968), v35)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		return int32(0)
...
func F_gbt_int2_fetch(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_fetch(m, v2, int32(4376968))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_int4_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4377008))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_int4_fetch(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_fetch(m, v2, int32(4377008))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_int8_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4377048))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_int8_fetch(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_fetch(m, v2, int32(4377048))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_intv_fetch(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_fetch(m, v2, int32(4377088))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_macad8_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6874)
	return v3
}
...
func F_gbt_numeric_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_var_compress(m, v2, int32(4377208))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_numeric_consistent(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v18))) = uint8(v42)
		...
		v55 = F_gbt_var_consistent(m, v9+int32(8), v13, v17, v46, v50&int32(1), int32(4377208), v54)
		mBase = m.M
		v56 = m.ExcPending
		if v56 != 0 {
			return int32(0)
...
func F_gbt_oid_distance(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v12
	...
	v29 = F_gbt_num_distance(m, v7+v13, v7+int32(12), v24&int32(1), int32(4377248), v28)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		return int32(0)
...
func F_gbt_oid_picksplit(m *base.Module, l0 int32) int32 {
	...
	v3 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v6 = F_gbt_num_picksplit(m, v2, v3, int32(4377248), v5)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
...
func F_gbt_text_compress(m *base.Module, l0 int32) int32 {
	...
	v18 = F_gbt_var_compress(m, v2, int32(4377288))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		return int32(0)
...
func F_gbt_time_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4377368))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_time_fetch(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_fetch(m, v2, int32(4377368))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_uuid_same(m *base.Module, l0 int32) int32 {
	...
	v8 = F_gbt_num_same(m, v4, v5, int32(4377448), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
