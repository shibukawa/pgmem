...
L13:
	;
	v52 = int32(343326)
	v55 = int32(*(*uint8)(unsafe.Add(mBase, _consts[462])))
...
L30:
	;
	v88 = int32(360278)
	v91 = int32(*(*uint8)(unsafe.Add(mBase, _consts[463])))
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v25
					F_errmsg(m, int32(345642), v7+int32(16))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return float64(0)
					} else {
						F_errfinish(m, int32(497057), int32(85), int32(489152))
						mBase = m.M
						v36 = m.ExcPending
						if v36 != 0 {
							return float64(0)
		...
		if v47 != 0 {
			...
			if v50 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v51
				F_errmsg(m, int32(345642), v7)
				mBase = m.M
				v55 = m.ExcPending
				if v55 != 0 {
					return float64(0)
				} else {
					F_errfinish(m, int32(497057), int32(74), int32(489152))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return float64(0)
					...
					if v23 != 0 {
						...
						if v26 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v27
							F_errmsg(m, int32(380795), v7+int32(16))
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(497057), int32(259), int32(381085))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
		...
		if v54 != 0 {
			...
			if v57 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v58
				F_errmsg(m, int32(216347), v7)
				mBase = m.M
				v62 = m.ExcPending
				if v62 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(497057), int32(245), int32(381085))
					mBase = m.M
					v67 = m.ExcPending
					if v67 != 0 {
						return int32(0)
	...
	if v9 != 0 {
		...
		case 0:
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v47
			v52 = F_psprintf(m, int32(430868), v7+int32(32))
			mBase = m.M
			v53 = m.ExcPending
			if v53 != 0 {
				return int32(0)
			...
			case 1, 2, 3, 4, 5, 6, 7, 8:
				...
				if v33 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v35
					F_errmsg_internal(m, int32(484245), v7+int32(16))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(497057), int32(59), int32(329728))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
			...
			if v60 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v61
				...
				if v65 != 0 {
					...
					F_errfinish(m, int32(497057), int32(41), int32(329728))
					mBase = m.M
					v70 = m.ExcPending
					if v70 != 0 {
						return int32(0)
