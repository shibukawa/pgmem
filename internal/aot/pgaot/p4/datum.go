...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = l2
	F_errmsg_internal(m, int32(462231), v7)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L42
...
L44:
	;
	F_errfinish(m, int32(475426), int32(108), int32(326771))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L42
...
L47:
	;
	F_errmsg(m, int32(205442), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L42
...
L48:
	;
	F_errfinish(m, int32(475426), int32(90), int32(326771))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L42
...
L52:
	;
	F_errfinish(m, int32(475426), int32(102), int32(326771))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L42
...
func F_datum_to_json_internal(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) {
	...
	if v13 != 0 {
		...
		if l1 != 0 {
			F_appendBinaryStringInfo(m, l2, int32(289792), int32(4))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
			...
			if l5 != 0 {
				...
				case 0:
					...
					if v46 != 0 {
						...
						if l0 != 0 {
							F_appendBinaryStringInfo(m, l2, int32(328733), int32(4))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return
							...
							F_appendBinaryStringInfo(m, l2, int32(345308), int32(5))
							mBase = m.M
							v54 = m.ExcPending
							if v54 != 0 {
								return
				...
				case 5, 7, 8, 9:
					...
					if v23 != 0 {
						...
						if v26 != 0 {
							...
							F_errmsg(m, int32(233881), int32(0))
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return
							} else {
								F_errfinish(m, int32(474626), int32(204), int32(297175))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return
	...
	case 1:
		...
		if v26 == int32(0) {
			...
			if v171 != 0 {
				...
				F_errmsg_internal(m, int32(467427), int32(0))
				mBase = m.M
				v176 = m.ExcPending
				if v176 != 0 {
					return
				} else {
					F_errfinish(m, int32(478287), int32(5323), int32(273249))
					mBase = m.M
					v183 = m.ExcPending
					if v183 != 0 {
						return
				...
				if v38 != 0 {
					...
					if v37 == int32(0) {
						...
						if v189 != 0 {
							...
							F_errmsg_internal(m, int32(467455), int32(0))
							mBase = m.M
							v194 = m.ExcPending
							if v194 != 0 {
								return
							} else {
								F_errfinish(m, int32(478287), int32(5329), int32(273249))
								mBase = m.M
								v201 = m.ExcPending
								if v201 != 0 {
									return
							...
							if v207 != 0 {
								...
								if v210 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v211
									F_errmsg(m, int32(682937), v12+int32(16))
									mBase = m.M
									v220 = m.ExcPending
									if v220 != 0 {
										return
									} else {
										F_errfinish(m, int32(478287), int32(5412), int32(273249))
										mBase = m.M
										v227 = m.ExcPending
										if v227 != 0 {
											return
		...
		if v141 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v142
			...
			if v147 != 0 {
				...
				F_errfinish(m, int32(478287), int32(5428), int32(273249))
				mBase = m.M
				v154 = m.ExcPending
				if v154 != 0 {
					return
