...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = l2
	F_errmsg_internal(m, int32(_a_F_datumGetSize_0), v7)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L42
...
L47:
	;
	F_errmsg(m, int32(_a_F_datumGetSize_3), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L42
		...
		if l2 != int32(-1) {
			...
			if v6 != int32(1) {
				...
				if v9 != int32(3) {
					...
					v13 = *(*int32)(unsafe.Add(mBase, _c_F_datumTransfer[0]))
			...
			if l5 != 0 {
				...
				case 2:
					if base.Ui32(l0-int32(2147483647)) <= base.Ui32(int32(1)) {
						...
						v115 = l0 + int32(_a_F_datum_to_json_internal_3)
						v116 = int32(_a_F_datum_to_json_internal_4)
						v117 = base.I32_div_u_s(v115, v116)
						v118 = int32(3)
						v124 = int32(2)
						v129 = base.I32_div_u_s((v117*int32(1073595727)+v115)<<(uint(v124)%32)|v118, v116)
						v132 = l0 + int32(_a_F_datum_to_json_internal_5) + v117*v118 + v129 + int32(_a_F_datum_to_json_internal_6)
						v133 = int32(1461)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10+int32(152)))) = v152 + v134<<(uint(int32(2))%32) - int32(_a_F_datum_to_json_internal_7)
						v160 = v150 + int32(123)
						v164 = int32(base.Ui32(v160*int32(2141)) >> (uint(int32(16)) % 32))
						*(*int32)(unsafe.Add(mBase, uint32(v10+int32(144)))) = v160 - int32(base.Ui32(v164*int32(_a_F_datum_to_json_internal_8))>>(uint(int32(8))%32))
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10+int32(148)))) = v174 + int32(1)
						...
						case 0, 3:
							...
							*(*uint8)(unsafe.Add(mBase, uint32(v197))) = uint8(v191)
							...
							v297 = v204
						case 1:
							v208 = *(*int32)(unsafe.Add(mBase, _c_F_datum_to_json_internal[0]))
						...
						case 2:
							...
							*(*uint8)(unsafe.Add(mBase, uint32(v248))) = uint8(v242)
							...
							v297 = v260
						default:
							v264 = *(*int32)(unsafe.Add(mBase, _c_F_datum_to_json_internal[0]))
						...
						if v298 <= int32(0) {
							v302 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_datum_to_json_internal[1])))
							*(*uint8)(unsafe.Add(mBase, uint32(v297)+2)) = uint8(v302)
							v305 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_datum_to_json_internal[2])))
	...
	case 1:
		...
		if v26 == int32(0) {
			...
			if v30 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_exec_eval_datum[0])) = v34
