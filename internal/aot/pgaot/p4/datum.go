				...
				if l0 == int32(0) {
					...
					if v87 != 0 {
						...
						if v90 != 0 {
							...
							F_errmsg(m, int32(215269), int32(0))
							mBase = m.M
							v94 = m.ExcPending
							if v94 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(496776), int32(102), int32(342095))
								mBase = m.M
								v99 = m.ExcPending
								if v99 != 0 {
									return int32(0)
					...
					if v71 != 0 {
						...
						if v74 != 0 {
							...
							if v78 != 0 {
								...
								F_errfinish(m, int32(496776), int32(90), int32(342095))
								mBase = m.M
								v83 = m.ExcPending
								if v83 != 0 {
									return int32(0)
			...
			default:
				...
				if v50 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = l2
					F_errmsg_internal(m, int32(482923), v7)
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496776), int32(108), int32(342095))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
...
func F_datum_to_json_internal(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) {
	...
	if v13 != 0 {
		...
		if l1 != 0 {
			F_appendBinaryStringInfo(m, l2, int32(303260), int32(4))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
			...
			if l5 != 0 {
				...
				case 0:
					...
					if v46 != 0 {
						...
						if l0 != 0 {
							F_appendBinaryStringInfo(m, l2, int32(344091), int32(4))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return
							...
							F_appendBinaryStringInfo(m, l2, int32(361107), int32(5))
							mBase = m.M
							v54 = m.ExcPending
							if v54 != 0 {
								return
					...
					if v23 != 0 {
						...
						if v26 != 0 {
							...
							if v30 != 0 {
								...
								F_errfinish(m, int32(495940), int32(204), int32(311166))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return
	...
	case 1:
		...
		if v26 == int32(0) {
			...
			if v171 != 0 {
				...
				F_errmsg_internal(m, int32(488119), int32(0))
				mBase = m.M
				v176 = m.ExcPending
				if v176 != 0 {
					return
				} else {
					F_errfinish(m, int32(499747), int32(5323), int32(286182))
					mBase = m.M
					v183 = m.ExcPending
					if v183 != 0 {
						return
				...
				if v38 != 0 {
					...
					if v37 == int32(0) {
						...
						if v189 != 0 {
							...
							F_errmsg_internal(m, int32(488147), int32(0))
							mBase = m.M
							v194 = m.ExcPending
							if v194 != 0 {
								return
							} else {
								F_errfinish(m, int32(499747), int32(5329), int32(286182))
								mBase = m.M
								v201 = m.ExcPending
								if v201 != 0 {
									return
							...
							if v207 != 0 {
								...
								if v210 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v211
									F_errmsg(m, int32(722557), v12+int32(16))
									mBase = m.M
									v220 = m.ExcPending
									if v220 != 0 {
										return
									} else {
										F_errfinish(m, int32(499747), int32(5412), int32(286182))
										mBase = m.M
										v227 = m.ExcPending
										if v227 != 0 {
											return
		...
		if v141 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v142
			...
			if v147 != 0 {
				...
				F_errfinish(m, int32(499747), int32(5428), int32(286182))
				mBase = m.M
				v154 = m.ExcPending
				if v154 != 0 {
					return
