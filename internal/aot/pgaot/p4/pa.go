...
func F_pa_find_worker(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+12)) = l0
	if l0 == v2 {
		...
		v12 = *(*int32)(unsafe.Add(mBase, _consts[826]))
		if v12 == int32(0) {
			v32 = v2
			m.G0 = v6 + int32(16)
			return v32
		} else {
			v16 = *(*int32)(unsafe.Add(mBase, _consts[827]))
			if v16 != 0 {
				v32 = v16
				m.G0 = v6 + int32(16)
				return v32
...
func F_pa_lock_stream(m *base.Module, l0 int32) {
	...
	var v8 int32
	_ = v8
	v3 = *(*int32)(unsafe.Add(mBase, _consts[828]))
...
L4:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _consts[828]))
...
L5:
	;
	F_s_lock(m, v22, int32(517750), int32(1330), int32(367857))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L1
...
L12:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _consts[506]))
...
L16:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _consts[828]))
...
L18:
	;
	F_s_lock(m, v71, int32(517750), int32(1330), int32(367857))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L1
...
L28:
	;
	v92 = *(*int32)(unsafe.Add(mBase, _consts[826]))
...
L33:
	;
	v106 = *(*int32)(unsafe.Add(mBase, _consts[829]))
	if v106 != 0 {
		goto L36
	} else {
		goto L37
...
L40:
	...
	F_s_lock(m, v120, int32(517826), int32(649), int32(245140))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L48:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _consts[831]))
...
L57:
	;
	F_errfinish(m, int32(517750), int32(1307), int32(336807))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L1
...
L60:
	;
	F_errfinish(m, int32(517750), int32(563), int32(230866))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L1
