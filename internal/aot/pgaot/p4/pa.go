...
func F_pa_xact_finish(m *base.Module, l0 int32, l1 int64) {
	...
	var v199 int32
	_ = v199
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[0]))
...
L4:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[0]))
...
L5:
	;
	F_s_lock(m, v22, int32(_a_F_pa_xact_finish_0), int32(1330), int32(_a_F_pa_xact_finish_1))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L1
...
L9:
	;
	v37 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[1]))
...
L12:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v44))) = int32(0)
	goto L13
L13:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[2]))
	if v48 == int32(0) {
		goto L3
	} else {
		goto L14
...
L16:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[0]))
...
L18:
	;
	F_s_lock(m, v71, int32(_a_F_pa_xact_finish_0), int32(1330), int32(_a_F_pa_xact_finish_1))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L1
...
L46:
	;
	v137 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[6]))
	v141 = F_LWLockAcquire(m, v137+int32(_a_F_pa_xact_finish_4), int32(1))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L1
...
L48:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[7]))
	v147 = v144 + v129*int32(112)
	v148 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v147)+34)))
	if v148 != v130&int32(_a_F_pa_xact_finish_5) {
		goto L49
	} else {
		goto L50
	}
L49:
	;
	v162 = *(*int32)(unsafe.Add(mBase, _c_F_pa_xact_finish[6]))
	F_LWLockRelease(m, v162+int32(_a_F_pa_xact_finish_4))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L1
