...
L5:
	;
	F_s_lock(m, v22, int32(486510), int32(1330), int32(345405))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L1
...
L18:
	;
	F_s_lock(m, v71, int32(486510), int32(1330), int32(345405))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L1
...
L40:
	...
	F_s_lock(m, v120, int32(486586), int32(649), int32(230299))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L57:
	;
	F_errfinish(m, int32(486510), int32(1307), int32(316781))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L1
...
L60:
	;
	F_errfinish(m, int32(486510), int32(563), int32(216947))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L1
