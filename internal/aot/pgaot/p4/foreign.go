			...
			if l1&int32(1) != 0 {
				...
				if v23 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
					F_errmsg_internal(m, int32(_a_F_GetForeignDataWrapperExtended_0), v9)
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(_a_F_GetForeignDataWrapperExtended_1), int32(63), int32(_a_F_GetForeignDataWrapperExtended_2))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return int32(0)
