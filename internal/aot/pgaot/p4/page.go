...
L511:
	;
	F_errmsg_internal(m, int32(89931), int32(0))
	mBase = m.M
	v1936 = m.ExcPending
	if v1936 != 0 {
		goto L510
...
L512:
	;
	F_errfinish(m, int32(525692), int32(1534), int32(328659))
	mBase = m.M
	v1941 = m.ExcPending
	if v1941 != 0 {
		goto L510
...
L515:
	;
	F_errfinish(m, int32(525692), int32(1689), int32(328659))
	mBase = m.M
	v1954 = m.ExcPending
	if v1954 != 0 {
		goto L510
...
L81:
	;
	F_errfinish(m, int32(525682), int32(1314), int32(119474))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L78
...
L84:
	;
	F_errfinish(m, int32(525682), int32(1318), int32(119474))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L78
...
L88:
	;
	F_errfinish(m, int32(525682), int32(1330), int32(119474))
	mBase = m.M
	v347 = m.ExcPending
	if v347 != 0 {
		goto L78
	...
	if v8 == int32(1) {
		...
		if v46 != 0 {
			...
			if v49 != 0 {
				...
				F_errmsg(m, int32(359968), int32(0))
				mBase = m.M
				v55 = m.ExcPending
				if v55 != 0 {
					return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(8192)
					F_errdetail(m, int32(684624), v6)
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(525641), int32(230), int32(34049))
						mBase = m.M
						v69 = m.ExcPending
						if v69 != 0 {
							return int32(0)
