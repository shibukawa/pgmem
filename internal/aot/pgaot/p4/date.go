...
L105:
	...
	v534 = int32(_a_F_ParseDateTime_0)
	v535 = int32(_a_F_ParseDateTime_1)
	goto L108
L107:
	;
	v634 = int32(0)
...
L162:
	;
	if int32(1)<<(uint(v773)%32)&int32(_a_F_ParseDateTime_2) == int32(0) {
		v866 = v748
		v872 = v754
		goto L13
	} else {
...
L17:
	;
	v62 = v12 + int32(76)
	v69 = *(*int32)(unsafe.Add(mBase, _c_F_extract_date[0]))
	if v69 != 0 {
		goto L20
	} else {
		goto L21
...
L19:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_extract_date[0])) = v113
...
L22:
	...
	v80 = int32(_a_F_extract_date_0)
	v82 = int32(_a_F_extract_date_1)
	goto L24
L23:
	;
	goto L22
...
L37:
	;
	v134 = v12 + int32(76)
	v141 = *(*int32)(unsafe.Add(mBase, _c_F_extract_date[1]))
	if v141 != 0 {
		goto L42
	} else {
		goto L43
...
L41:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_extract_date[1])) = v185
...
L44:
	...
	v152 = int32(_a_F_extract_date_2)
	v154 = int32(_a_F_extract_date_3)
	goto L46
L45:
	;
	goto L44
...
L73:
	;
	v229 = int32(0)
	v233 = F_DirectFunctionCall3Coll(m, int32(408), v229, int32(_a_F_extract_date_4), v229, int32(-1))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
...
L75:
	;
	v238 = int32(0)
	v242 = F_DirectFunctionCall3Coll(m, int32(408), v238, int32(_a_F_extract_date_5), v238, int32(-1))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L1
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v59
	F_errmsg(m, int32(_a_F_extract_date_6), v12+int32(16))
	mBase = m.M
	v263 = m.ExcPending
	if v263 != 0 {
		goto L1
...
L86:
	;
	v270 = v57 + int32(_a_F_extract_date_9)
	v280 = v57 + int32(_a_F_extract_date_10)
	v281 = int32(_a_F_extract_date_11)
	v282 = base.I32_div_u_s(v280, v281)
	v283 = int32(3)
	v289 = int32(2)
	v294 = base.I32_div_u_s((v282*int32(1073595727)+v280)<<(uint(v289)%32)|v283, v281)
	v297 = v270 + v282*v283 + v294 + int32(_a_F_extract_date_12)
	v298 = int32(1461)
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12+int32(72)))) = v317 + v299<<(uint(int32(2))%32) - int32(_a_F_extract_date_13)
	v325 = v315 + int32(123)
	v329 = int32(base.Ui32(v325*int32(2141)) >> (uint(int32(16)) % 32))
	*(*int32)(unsafe.Add(mBase, uint32(v12-int32(-64)))) = v325 - int32(base.Ui32(v329*int32(_a_F_extract_date_14))>>(uint(int32(8))%32))
...
L94:
	;
	v495 = int32(7)
	v496 = base.I32_rem_s(v57+int32(_a_F_extract_date_15), v495)
	if v496 < int32(0) {
		goto L137
	} else {
		goto L138
...
L147:
	;
	v517 = int32(_a_F_extract_date_13)
	goto L149
L148:
	;
	v517 = int32(_a_F_extract_date_16)
	goto L149
L149:
	;
	v518 = v517 + v509
...
L152:
	;
	v538 = base.I32_div_s((v533+v510)*int32(_a_F_extract_date_14), int32(256))
	goto L146
L153:
	;
	v654 = base.I64_extend_i32_s(v511 + v518*int32(365) + v523 + v526 + v529 + v538 - int32(_a_F_extract_date_17) - (int32(1) + v551*int32(365) + v556 + v559 + v562 + v571 - int32(_a_F_extract_date_17)) + int32(1))
	goto L60
L155:
	;
	goto L156
L156:
	;
	v551 = int32(_a_F_extract_date_16) + v542
...
L159:
	;
	v571 = base.I32_div_s(int32(_a_F_extract_date_18), int32(256))
	goto L153
L160:
	;
	F_errcode(m, int32(1088))
...
L162:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v59
	F_errmsg(m, int32(_a_F_extract_date_6), v12+int32(32))
	mBase = m.M
	v595 = m.ExcPending
	if v595 != 0 {
		goto L1
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v59
	F_errmsg(m, int32(_a_F_extract_date_6), v12+int32(48))
	mBase = m.M
	v625 = m.ExcPending
	if v625 != 0 {
		goto L1
...
L173:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v59
	F_errmsg(m, int32(_a_F_extract_date_19), v12)
	mBase = m.M
	v645 = m.ExcPending
	if v645 != 0 {
		goto L1
