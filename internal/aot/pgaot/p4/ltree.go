...
func F__ltree_isparent(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		if v13 != 0 {
			...
			v15 = F_array_iterator(m, v6, int32(_a_F__ltree_isparent_0), v12, int32(0))
			mBase = m.M
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
...
L23:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _c_F_ltree_crc32_sz[0]))
...
L26:
	...
	v112 = *(*int32)(unsafe.Add(mBase, uint32((v79^v104)&int32(255)<<(uint(int32(2))%32))+uint32(_c_F_ltree_crc32_sz[1])))
...
L30:
	...
	v136 = int32(255)
	v138 = int32(2)
	v141 = *(*int32)(unsafe.Add(mBase, uint32((v134^v125)&v136<<(uint(v138)%32))+uint32(_c_F_ltree_crc32_sz[1])))
	v142 = int32(8)
	v144 = v141 ^ int32(base.Ui32(v125)>>(uint(v142)%32))
	v145 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v126)+1)))
	v152 = *(*int32)(unsafe.Add(mBase, uint32((v144^v145)&v136<<(uint(v138)%32))+uint32(_c_F_ltree_crc32_sz[1])))
...
L35:
	;
	v113 = int32(9)
	v115 = int32(_a_F_ltree_penalty_0)
	v123 = int32(1)
	if v123 < v82 {
...
L66:
	;
	v238 = int32(9)
	v240 = int32(_a_F_ltree_penalty_0)
	v248 = int32(1)
	if v248 < v207 {
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v247))) = v246 << (uint(int32(2)) % 32)
	if v249&int32(_a_F_parse_ltree_7) != 0 {
		goto L66
	} else {
		goto L67
	}
...
L71:
	...
	if (v286-v80)>>(uint(int32(4))%32) < v284 {
		v260 = v286
		v262 = v262 + (v270&int32(_a_F_parse_ltree_0)+int32(9))&int32(_a_F_parse_ltree_8)
		goto L69
	} else {
		goto L75
	}
