										...
										if v269 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v13))) = v268
											...
											if v274 != 0 {
												...
												F_errfinish(m, int32(488704), int32(3107), int32(62794))
												mBase = m.M
												v279 = m.ExcPending
												if v279 != 0 {
													return int64(0)
										...
										if v56 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = l1
											...
											if v62 != 0 {
												...
												F_errfinish(m, int32(488704), int32(3667), int32(62879))
												mBase = m.M
												v67 = m.ExcPending
												if v67 != 0 {
													return int64(0)
								...
								if v131 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = l1
									...
									if v137 != 0 {
										...
										F_errfinish(m, int32(488704), int32(3742), int32(62859))
										mBase = m.M
										v142 = m.ExcPending
										if v142 != 0 {
											return int64(0)
														...
														if v207 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = v189
															...
															if v213 != 0 {
																...
																F_errfinish(m, int32(488704), int32(3798), int32(62859))
																mBase = m.M
																v218 = m.ExcPending
																if v218 != 0 {
																	return int64(0)
													...
													if v168 != 0 {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v13)+64)) = v146
														...
														if v174 != 0 {
															...
															F_errfinish(m, int32(488704), int32(3769), int32(62859))
															mBase = m.M
															v179 = m.ExcPending
															if v179 != 0 {
																return int64(0)
					...
					if base.Ui32(int32(2)) <= base.Ui32(l1) {
						if l1 != int32(2) {
							...
							if v73 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
								F_errmsg_internal(m, int32(476160), v8)
								mBase = m.M
								v77 = m.ExcPending
								if v77 != 0 {
									return
								} else {
									F_errfinish(m, int32(490625), int32(1322), int32(242779))
									mBase = m.M
									v82 = m.ExcPending
									if v82 != 0 {
										return
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+112)) = int32(0)
							F_appendStringInfo(m, l0, int32(182090), v8+int32(112))
							mBase = m.M
							v28 = m.ExcPending
							if v28 != 0 {
								return
						...
						case 0:
							*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v11
							F_appendStringInfo(m, l0, int32(178369), v8+int32(48))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return
						...
						default:
							...
							if v58 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l3
								F_errmsg_internal(m, int32(475785), v8+int32(16))
								mBase = m.M
								v64 = m.ExcPending
								if v64 != 0 {
									return
								} else {
									F_errfinish(m, int32(490625), int32(1310), int32(242779))
									mBase = m.M
									v69 = m.ExcPending
									if v69 != 0 {
										return
						...
						case 8:
							*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v11
							F_appendStringInfo(m, l0, int32(178361), v8-int32(-64))
							mBase = m.M
							v42 = m.ExcPending
							if v42 != 0 {
								return
						...
						case 14:
							*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v11
							F_appendStringInfo(m, l0, int32(183605), v8+int32(32))
							mBase = m.M
							v88 = m.ExcPending
							if v88 != 0 {
								return
						...
						case 17:
							*(*int32)(unsafe.Add(mBase, uint32(v8)+80)) = v11
							F_appendStringInfo(m, l0, int32(183576), v8+int32(80))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return
						...
						case 19:
							*(*int32)(unsafe.Add(mBase, uint32(v8)+96)) = v11
							F_appendStringInfo(m, l0, int32(178533), v8+int32(96))
							mBase = m.M
							v54 = m.ExcPending
							if v54 != 0 {
								return
