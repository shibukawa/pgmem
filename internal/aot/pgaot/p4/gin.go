	...
	if v13 != 0 {
		...
		if v12 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15 + int32(4)
			F_errmsg_internal(m, int32(727071), v8)
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
				return
					...
					*(*int32)(unsafe.Add(mBase, uint32(l1))) = v19
					...
					if v33 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v35
						F_errmsg_internal(m, int32(482806), v9)
						mBase = m.M
						v39 = m.ExcPending
						if v39 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(525180), int32(177), int32(404842))
							mBase = m.M
							v44 = m.ExcPending
							if v44 != 0 {
								return int32(0)
...
func F_gin_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = v30
		F_appendStringInfo(m, l0, int32(529019), v10-int32(-64))
		mBase = m.M
		v36 = m.ExcPending
		if v36 != 0 {
			return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = v42 | v43<<(uint(v46)%32)
				...
				if v58 != 0 {
					...
					if v62 == int32(1) {
						...
						if v65 == int32(1) {
							F_appendStringInfoString(m, l0, int32(710104))
							mBase = m.M
							v70 = m.ExcPending
							if v70 != 0 {
								return
							...
							F_appendStringInfoString(m, l0, int32(709011))
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return
						...
						if v104&int32(1) == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v112
							F_appendStringInfo(m, l0, int32(529068), v10+int32(16))
							mBase = m.M
							v118 = m.ExcPending
							if v118 != 0 {
								return
	...
	case 1:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = v147
		F_appendStringInfo(m, l0, int32(528674), v10+int32(96))
		mBase = m.M
		v153 = m.ExcPending
		if v153 != 0 {
			return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+80)) = v165
			F_appendStringInfo(m, l0, int32(529018), v10+int32(80))
			mBase = m.M
			v171 = m.ExcPending
			if v171 != 0 {
				return
	...
	case 6:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = v216
		F_appendStringInfo(m, l0, int32(511496), v10)
		mBase = m.M
		v220 = m.ExcPending
		if v220 != 0 {
			return
...
func F_gin_extract_query_bpchar(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(1), int32(7656), int32(2426))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gin_extract_query_inet(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(1), int32(7655), int32(2347))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
			...
			if v295 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v15))) = v22
				...
				if v301 != 0 {
					...
					F_errfinish(m, int32(521978), int32(139), int32(303591))
					mBase = m.M
					v308 = m.ExcPending
					if v308 != 0 {
						return int32(0)
...
L65:
	;
	F_errfinish(m, int32(521978), int32(254), int32(98856))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L41
