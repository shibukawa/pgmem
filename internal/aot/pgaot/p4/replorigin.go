...
L5:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[836]))
	if v27 <= int32(0) {
		v88 = v6
		v90 = v6
		goto L6
...
L7:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[837]))
	v39 = v6
	v40 = v6
	goto L8
L8:
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v64
	F_errmsg(m, int32(503417), v15+int32(16))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L19:
	;
	F_errfinish(m, int32(521945), int32(969), int32(437920))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L4
...
L49:
	;
	F_errfinish(m, int32(521945), int32(980), int32(437920))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L4:
	;
	v15 = int32(0)
	v17 = *(*int32)(unsafe.Add(mBase, _consts[836]))
	if v17 <= v15 {
		goto L1
	} else {
		goto L5
...
L5:
	;
	v21 = *(*int32)(unsafe.Add(mBase, _consts[837]))
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v14
	F_errmsg_internal(m, int32(57569), v9)
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L12
...
L14:
	;
	F_errfinish(m, int32(521945), int32(891), int32(255610))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L12
