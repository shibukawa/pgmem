...
L1:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _consts[86]))
	v24 = F_LWLockAcquire(m, v20+int32(5120), int32(0))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L4
...
L5:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[826]))
	if v27 <= int32(0) {
		v88 = v6
		v90 = v6
		goto L6
...
L7:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[827]))
	v39 = v6
	v40 = v6
	goto L8
L8:
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v64
	F_errmsg(m, int32(476492), v15+int32(16))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L4
...
L19:
	;
	F_errfinish(m, int32(493370), int32(969), int32(414563))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L4
...
L49:
	;
	F_errfinish(m, int32(493370), int32(980), int32(414563))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L52:
	;
	v157 = *(*int32)(unsafe.Add(mBase, _consts[86]))
	F_LWLockRelease(m, v157+int32(5120))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L4
...
L4:
	;
	v15 = int32(0)
	v17 = *(*int32)(unsafe.Add(mBase, _consts[826]))
	if v17 <= v15 {
		goto L1
	} else {
		goto L5
...
L5:
	;
	v21 = *(*int32)(unsafe.Add(mBase, _consts[827]))
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v14
	F_errmsg_internal(m, int32(52369), v9)
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L12
...
L14:
	;
	F_errfinish(m, int32(493370), int32(891), int32(241349))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L12
