...
L12:
	;
	v39 = int32(*(*int8)(unsafe.Add(mBase, _consts[1540])))
	v43 = l0
	goto L13
L13:
	;
...
L52:
	;
	v153 = int32(*(*int8)(unsafe.Add(mBase, _consts[1541])))
	v157 = v132
	goto L53
L53:
	;
...
L246:
	;
	F_errfinish(m, int32(496255), int32(370), int32(414709))
	mBase = m.M
	v911 = m.ExcPending
	if v911 != 0 {
		goto L168
...
L3:
	;
	F_appendStringInfoString(m, l2, int32(757113))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L31
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v129
	F_appendStringInfo(m, l2, int32(749641), v15)
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L31
...
L47:
	;
	v198 = int32(63)
	v201 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v192&v198)+uint32(_consts[1539]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v182)+3)) = uint8(v201)
	v208 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v192)>>(uint(int32(6))%32))&v198)+uint32(_consts[1539]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v182)+2)) = uint8(v208)
	v215 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v192)>>(uint(int32(12))%32))&v198)+uint32(_consts[1539]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v182)+1)) = uint8(v215)
	v222 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v192)>>(uint(int32(18))%32))&v198)+uint32(_consts[1539]))))
...
L53:
	;
	v249 = int32(63)
	v252 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v229)>>(uint(int32(12))%32))&v249)+uint32(_consts[1539]))))
	*(*uint8)(unsafe.Add(mBase, uint32(v240)+1)) = uint8(v252)
	v259 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v229)>>(uint(int32(18))%32))&v249)+uint32(_consts[1539]))))
...
L54:
	;
	v270 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v229)>>(uint(int32(6))%32))&int32(63))+uint32(_consts[1539]))))
	v271 = v270
	goto L56
L55:
	;
...
L64:
	;
	v313 = int32(*(*int8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v104)>>(uint(int32(18))%32)))+uint32(_consts[1539]))))
...
L65:
	;
	v321 = int32(*(*int8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v104)>>(uint(int32(12))%32))&int32(63))+uint32(_consts[1539]))))
...
L66:
	;
	v329 = int32(*(*int8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v104)>>(uint(int32(6))%32))&int32(63))+uint32(_consts[1539]))))
...
L67:
	;
	v335 = int32(*(*int8)(unsafe.Add(mBase, uint32(v104&int32(63))+uint32(_consts[1539]))))
...
L68:
	;
	F_appendStringInfoString(m, l2, int32(757142))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L31
...
L70:
	;
	F_errmsg_internal(m, int32(305410), int32(0))
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
		goto L31
...
L71:
	;
	F_errfinish(m, int32(496255), int32(227), int32(414606))
	mBase = m.M
	v361 = m.ExcPending
	if v361 != 0 {
		goto L31
...
func F_pgp_create_pkt_writer(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v7)+15)) = uint8(v10)
	...
	if v18 != 0 {
		...
		if int32(0) <= v15 {
			v23 = F_pushf_create(m, l2, int32(4399436), int32(0), l0)
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return int32(0)
...
func F_pgp_decompress_filter(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_pullf_create(m, l0, int32(4399344), l1, l2)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_pgp_get_cipher_block_size(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(int32(8)) < base.Ui32(v4) {
		...
		if int32(base.Ui32(int32(487))>>(uint(v4)%32))&int32(1) == int32(0) {
			...
			v17 = *(*int32)(unsafe.Add(mBase, uint32(v4<<(uint(int32(2))%32))+uint32(_consts[1564])))
...
func F_pgp_load_cipher(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if base.Ui32(int32(8)) < base.Ui32(v6) {
		...
		if int32(base.Ui32(int32(487))>>(uint(v6)%32))&int32(1) == int32(0) {
			...
			v21 = *(*int32)(unsafe.Add(mBase, uint32(v6<<(uint(int32(2))%32))+uint32(_consts[1564])))
	...
	if v18 != 0 {
		...
		if v15 < int32(0) {
			...
			if v15 == int32(0) {
				...
				if int32(0) <= v25 {
					F_px_debug(m, int32(229427), int32(0))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
															...
															if v91 < int32(0) {
																...
																if base.Ui32(v104) < base.Ui32(int32(16777217)) {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(l2))) = v116
																	...
																	F_px_debug(m, int32(321874), int32(0))
																	mBase = m.M
																	v110 = m.ExcPending
																	if v110 != 0 {
																		return int32(0)
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v81))) = v75
	v87 = F_open(m, int32(289171), v75, v81)
	mBase = m.M
	if v87 != int32(-1) {
		goto L24
	} else {
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v15
	v32 = F_open(m, int32(289171), v15, v26)
	mBase = m.M
	if v32 != int32(-1) {
		goto L8
	} else {
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v136))) = v130
	v142 = F_open(m, int32(289171), v130, v136)
	mBase = m.M
	if v142 != int32(-1) {
		goto L38
	} else {
...
func F_pgp_set_cipher_algo(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v79 int32
	_ = v79
	v8 = F_pg_strcasecmp(m, int32(171784), l1)
	mBase = m.M
	if v8 == int32(0) {
		v77 = int32(4399568)
		...
		v16 = F_pg_strcasecmp(m, int32(558200), l1)
		mBase = m.M
		if v16 == int32(0) {
			v77 = int32(4399588)
			v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
			...
			v24 = F_pg_strcasecmp(m, int32(340615), l1)
			mBase = m.M
			if v24 == int32(0) {
				v77 = int32(4399608)
				v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
				...
				v32 = F_pg_strcasecmp(m, int32(323438), l1)
				mBase = m.M
				if v32 == int32(0) {
					v77 = int32(4399628)
					v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
					...
					v40 = F_pg_strcasecmp(m, int32(172284), l1)
					mBase = m.M
					if v40 == int32(0) {
						v77 = int32(4399648)
						v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
						...
						v48 = F_pg_strcasecmp(m, int32(557395), l1)
						mBase = m.M
						if v48 == int32(0) {
							v77 = int32(4399668)
							v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
							...
							v56 = F_pg_strcasecmp(m, int32(562200), l1)
							mBase = m.M
							if v56 == int32(0) {
								v77 = int32(4399688)
								v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
								...
								v64 = F_pg_strcasecmp(m, int32(557916), l1)
								mBase = m.M
								if v64 == int32(0) {
									v77 = int32(4399708)
									v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
									...
									v73 = F_pg_strcasecmp(m, int32(323447), l1)
									mBase = m.M
									if v73 != 0 {
										v79 = int32(-103)
									} else {
