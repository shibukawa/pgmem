...
L246:
	;
	F_errfinish(m, int32(515067), int32(370), int32(430110))
	mBase = m.M
	v911 = m.ExcPending
	if v911 != 0 {
		goto L168
...
L3:
	;
	F_appendStringInfoString(m, l2, int32(783962))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L31
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v129
	F_appendStringInfo(m, l2, int32(776490), v15)
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L31
...
L68:
	;
	F_appendStringInfoString(m, l2, int32(783991))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L31
...
L71:
	;
	F_errfinish(m, int32(515067), int32(227), int32(430007))
	mBase = m.M
	v361 = m.ExcPending
	if v361 != 0 {
		goto L31
...
func F_pgp_create_pkt_writer(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v7)+15)) = uint8(v10)
	...
	if v18 != 0 {
		...
		if int32(0) <= v15 {
			v23 = F_pushf_create(m, l2, int32(4427996), int32(0), l0)
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return int32(0)
...
func F_pgp_decompress_filter(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_pullf_create(m, l0, int32(4427904), l1, l2)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
	...
	if v18 != 0 {
		...
		if v15 < int32(0) {
			...
			if v15 == int32(0) {
				...
				if int32(0) <= v25 {
					F_px_debug(m, int32(238727), int32(0))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
															...
															if v91 < int32(0) {
																...
																if base.Ui32(v104) < base.Ui32(int32(16777217)) {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(l2))) = v116
																	...
																	F_px_debug(m, int32(334212), int32(0))
																	mBase = m.M
																	v110 = m.ExcPending
																	if v110 != 0 {
																		return int32(0)
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v81))) = v75
	v87 = F_open(m, int32(300066), v75, v81)
	mBase = m.M
	if v87 != int32(-1) {
		goto L24
	} else {
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v15
	v32 = F_open(m, int32(300066), v15, v26)
	mBase = m.M
	if v32 != int32(-1) {
		goto L8
	} else {
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v136))) = v130
	v142 = F_open(m, int32(300066), v130, v136)
	mBase = m.M
	if v142 != int32(-1) {
		goto L38
	} else {
...
func F_pgp_set_cipher_algo(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v79 int32
	_ = v79
	v8 = F_pg_strcasecmp(m, int32(180155), l1)
	mBase = m.M
	if v8 == int32(0) {
		v77 = int32(4428128)
		...
		v16 = F_pg_strcasecmp(m, int32(578819), l1)
		mBase = m.M
		if v16 == int32(0) {
			v77 = int32(4428148)
			v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
			...
			v24 = F_pg_strcasecmp(m, int32(353987), l1)
			mBase = m.M
			if v24 == int32(0) {
				v77 = int32(4428168)
				v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
				...
				v32 = F_pg_strcasecmp(m, int32(335776), l1)
				mBase = m.M
				if v32 == int32(0) {
					v77 = int32(4428188)
					v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
					...
					v40 = F_pg_strcasecmp(m, int32(180715), l1)
					mBase = m.M
					if v40 == int32(0) {
						v77 = int32(4428208)
						v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
						...
						v48 = F_pg_strcasecmp(m, int32(577982), l1)
						mBase = m.M
						if v48 == int32(0) {
							v77 = int32(4428228)
							v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
							...
							v56 = F_pg_strcasecmp(m, int32(582924), l1)
							mBase = m.M
							if v56 == int32(0) {
								v77 = int32(4428248)
								v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
								...
								v64 = F_pg_strcasecmp(m, int32(578503), l1)
								mBase = m.M
								if v64 == int32(0) {
									v77 = int32(4428268)
									v78 = *(*int32)(unsafe.Add(mBase, uint32(v77)+4))
									...
									v73 = F_pg_strcasecmp(m, int32(335785), l1)
									mBase = m.M
									if v73 != 0 {
										v79 = int32(-103)
									} else {
