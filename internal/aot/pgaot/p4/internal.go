...
func F_create_internal(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32) int32 {
	...
	if base.Ui32(int32(4095)) < base.Ui32(l1) {
		...
		*(*int64)(unsafe.Add(mBase, uint32(l0)+216)) = v26
		v55 = int32(base.Ui32(l1)>>(uint(int32(10))%32)) & int32(_a_F_create_internal_0)
		v57 = v55 + int32(2048)
		v59 = v57 & int32(4092)
		if v59 != 0 {
			v63 = v55 - v59 + int32(_a_F_create_internal_1)
		} else {
			v63 = v57
		}
		v64 = l1 - v63
		...
		*(*int32)(unsafe.Add(mBase, uint32(l0)+1460)) = int32(1)
		...
		if v75 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v72))) = l0
			v78 = *(*int32)(unsafe.Add(mBase, _c_F_create_internal[0]))
			...
			*(*int32)(unsafe.Add(mBase, uint32(v129))) = v145
			...
			mBase = m.M
			v153 = base.B2i32(base.Ui32(v64) < base.Ui32(int32(_a_F_create_internal_2)))
			if v153 == int32(0) {
				...
				if v160 != 0 {
					...
					if base.Ui32(v64) < base.Ui32(int32(_a_F_create_internal_2)) {
						v169 = int32(0)
					} else {
						v169 = v168
					}
		...
		if v184 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(_a_F_create_internal_2)
			F_errmsg_internal(m, int32(_a_F_create_internal_3), v13)
			mBase = m.M
			v190 = m.ExcPending
			if v190 != 0 {
				return int32(0)
