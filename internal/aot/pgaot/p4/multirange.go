				...
				if v24 == int32(0) {
					...
					if v29 != 0 {
						...
						if v30 == v27 {
							...
							v33 = F_lookup_type_cache(m, v27, int32(_a_F_multirange_adjacent_multirange_0))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
								...
								if v35 == int32(0) {
									...
									if v118 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v11))) = v27
										F_errmsg_internal(m, int32(_a_F_multirange_adjacent_multirange_1), v11)
										mBase = m.M
										v122 = m.ExcPending
										if v122 != 0 {
											return int32(0)
...
L8:
	;
	v29 = F_lookup_type_cache(m, v23, int32(_a_F_multirange_overlaps_multirange_0))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L1
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v23
	F_errmsg_internal(m, int32(_a_F_multirange_overlaps_multirange_1), v13)
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L1
