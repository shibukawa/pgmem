...
func F_CheckTargetForConflictsIn(m *base.Module, l0 int32) {
	...
	v18 = v16 - int32(16)
	m.G0 = v18
	v21 = *(*int32)(unsafe.Add(mBase, _consts[1115]))
...
L3:
	;
	v37 = *(*int32)(unsafe.Add(mBase, _consts[1115]))
	v38 = int32(0)
...
L87:
	;
	v375 = *(*int32)(unsafe.Add(mBase, _consts[1118]))
	v378 = v316 ^ v22
	v379 = int32(0)
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v389))) = v391
	v394 = *(*int32)(unsafe.Add(mBase, _consts[1118]))
...
L96:
	;
	v408 = *(*int32)(unsafe.Add(mBase, _consts[1115]))
...
L111:
	;
	v448 = *(*int32)(unsafe.Add(mBase, _consts[1190]))
