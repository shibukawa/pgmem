...
L11:
	;
	v330 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[1]))
...
L48:
	;
	v284 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[1]))
...
L52:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[2]))
	if v212&int32(8) != 0 {
		goto L59
	} else {
		goto L60
...
L71:
	;
	v290 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[1]))
...
L76:
	;
	v339 = int32(1)
	v341 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[1]))
...
L77:
	;
	v351 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[3]))
...
L82:
	;
	v358 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[2]))
...
L86:
	;
	v368 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[1]))
...
L87:
	;
	v375 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[4]))
	v378 = v316 ^ v22
	v379 = int32(0)
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v389))) = v391
	v394 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[4]))
...
L101:
	;
	v429 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[3]))
...
L106:
	;
	v436 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[2]))
...
L108:
	;
	v442 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[1]))
...
L111:
	;
	v448 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTargetForConflictsIn[5]))
