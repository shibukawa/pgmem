		...
		if v21 != 0 {
			...
			if v27 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(l1)+4)) = v50
				...
				v53 = int32(_a_F_set_var_from_num_0)
				v54 = v52 & v53
				if v54 != v53 {
					if v54 != int32(_a_F_set_var_from_num_1) {
						v65 = v54
					} else {
						v65 = v52 << (uint(int32(1)) % 32) & int32(_a_F_set_var_from_num_2)
					}
				} else {
					v65 = v52 & int32(_a_F_set_var_from_num_3)
				}
