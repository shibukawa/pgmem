...
func F_AtEOSubXact_SPI(m *base.Module, l0 int32, l1 int32) {
	...
	var v189 int32
	_ = v189
	v8 = *(*int32)(unsafe.Add(mBase, _consts[509]))
	if v8 < int32(0) {
		goto L1
	} else {
		goto L2
...
L2:
	;
	v12 = *(*int32)(unsafe.Add(mBase, _consts[510]))
...
L12:
	...
	*(*int64)(unsafe.Add(mBase, _consts[511])) = v30
	v33 = *(*int32)(unsafe.Add(mBase, uint32(v15)+56))
	*(*int32)(unsafe.Add(mBase, _consts[512])) = v33
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v15)+60))
	*(*int32)(unsafe.Add(mBase, _consts[513])) = v36
	v38 = int32(4126180)
	v40 = *(*int32)(unsafe.Add(mBase, _consts[509]))
	v42 = v40 - int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[509])) = v42
	v45 = int32(0)
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _consts[217])) = v53
	if v42 < v45 {
		goto L17
	} else {
		goto L18
...
L29:
	...
	*(*int64)(unsafe.Add(mBase, _consts[511])) = v78
	v81 = *(*int32)(unsafe.Add(mBase, uint32(v63)+56))
	*(*int32)(unsafe.Add(mBase, _consts[512])) = v81
	v84 = *(*int32)(unsafe.Add(mBase, uint32(v63)+60))
	*(*int32)(unsafe.Add(mBase, _consts[513])) = v84
	v86 = int32(4126180)
	v88 = *(*int32)(unsafe.Add(mBase, _consts[509]))
	v90 = v88 - int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[509])) = v90
	v94 = *(*int32)(unsafe.Add(mBase, _consts[510]))
	v98 = int32(0)
	if v98 <= v90 {
		goto L31
	} else {
...
L33:
	;
	*(*int32)(unsafe.Add(mBase, _consts[217])) = v101
	if int32(0) <= v90 {
		v57 = v90
		v58 = v94
		goto L19
...
L38:
	;
	F_errmsg(m, int32(319416), int32(0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L8
...
L39:
	;
	F_errhint(m, int32(596411), int32(0))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L8
...
L40:
	;
	F_errfinish(m, int32(499183), int32(532), int32(535652))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L8
...
L43:
	;
	v142 = *(*int32)(unsafe.Add(mBase, _consts[217]))
	if v142 == int32(0) {
		goto L42
	} else {
		goto L44
...
L48:
	;
	v153 = *(*int32)(unsafe.Add(mBase, _consts[217]))
	v154 = v153
	goto L47
L49:
	;
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v160))) = v166
	v171 = v162 - int32(28)
	v173 = *(*int32)(unsafe.Add(mBase, _consts[217]))
...
L58:
	;
	v179 = *(*int32)(unsafe.Add(mBase, _consts[512]))
	if v179 == v171 {
		goto L59
	} else {
		goto L60
