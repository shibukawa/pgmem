...
func F_AtEOSubXact_SPI(m *base.Module, l0 int32, l1 int32) {
	...
	var v189 int32
	_ = v189
	v8 = *(*int32)(unsafe.Add(mBase, _consts[505]))
	if v8 < int32(0) {
		goto L1
	} else {
		goto L2
...
L2:
	;
	v12 = *(*int32)(unsafe.Add(mBase, _consts[506]))
...
L12:
	...
	*(*int64)(unsafe.Add(mBase, _consts[507])) = v30
	v33 = *(*int32)(unsafe.Add(mBase, uint32(v15)+56))
	*(*int32)(unsafe.Add(mBase, _consts[508])) = v33
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v15)+60))
	*(*int32)(unsafe.Add(mBase, _consts[509])) = v36
	v38 = int32(4164004)
	v40 = *(*int32)(unsafe.Add(mBase, _consts[505]))
	v42 = v40 - int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[505])) = v42
	v45 = int32(0)
	v47 = *(*int32)(unsafe.Add(mBase, _consts[506]))
...
L29:
	...
	*(*int64)(unsafe.Add(mBase, _consts[507])) = v78
	v81 = *(*int32)(unsafe.Add(mBase, uint32(v63)+56))
	*(*int32)(unsafe.Add(mBase, _consts[508])) = v81
	v84 = *(*int32)(unsafe.Add(mBase, uint32(v63)+60))
	*(*int32)(unsafe.Add(mBase, _consts[509])) = v84
	v86 = int32(4164004)
	v88 = *(*int32)(unsafe.Add(mBase, _consts[505]))
	v90 = v88 - int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[505])) = v90
	v94 = *(*int32)(unsafe.Add(mBase, _consts[506]))
	v98 = int32(0)
	if v98 <= v90 {
		goto L31
	} else {
...
L38:
	;
	F_errmsg(m, int32(335239), int32(0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L8
...
L40:
	;
	F_errfinish(m, int32(523999), int32(532), int32(561722))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L8
...
L58:
	;
	v179 = *(*int32)(unsafe.Add(mBase, _consts[508]))
	if v179 == v171 {
		goto L59
	} else {
		goto L60
