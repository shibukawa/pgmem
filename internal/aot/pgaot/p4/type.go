...
func F_assign_record_type_typmod(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+60)) = l0
	v14 = *(*int32)(unsafe.Add(mBase, _consts[1388]))
	if v14 != 0 {
		v36 = v14
		goto L1
	} else {
...
L2:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+28)) = int64(17179869188)
	v27 = F_hash_create(m, int32(375449), int32(64), v8+int32(-52), int32(200))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L3
...
L4:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1388])) = v27
...
L6:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _consts[1388]))
	v36 = v35
	goto L1
L7:
	;
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v159+v162<<(uint(v163)%32))+8)) = v158
	v167 = int32(4047424)
	v169 = *(*int64)(unsafe.Add(mBase, _consts[1392]))
	v171 = v169 + int64(1)
	*(*int64)(unsafe.Add(mBase, _consts[1392])) = v171
	v173 = *(*int32)(unsafe.Add(mBase, uint32(v158)+8))
	*(*int64)(unsafe.Add(mBase, uint32(v159+v173<<(uint(v163)%32)))) = v171
	v179 = *(*int32)(unsafe.Add(mBase, _consts[1388]))
...
L14:
	...
	v68 = *(*int32)(unsafe.Add(mBase, _consts[1390]))
	if v68 != 0 {
		goto L18
	} else {
		goto L19
...
L16:
	...
	v122 = *(*int32)(unsafe.Add(mBase, _consts[1390]))
	if v122 != 0 {
		goto L31
	} else {
		goto L32
...
L18:
	;
	v70 = *(*int32)(unsafe.Add(mBase, _consts[1391]))
	v82 = v70
	v83 = v68
	goto L17
L19:
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1391])) = int32(64)
	*(*int32)(unsafe.Add(mBase, _consts[1390])) = v75
	v82 = int32(64)
	v83 = v75
	goto L17
L22:
...
L28:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1391])) = v95
	*(*int32)(unsafe.Add(mBase, _consts[1390])) = v98
	goto L24
L29:
	;
	v109 = int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(v107)+12)) = v109
	v111 = int32(4418164)
	v113 = *(*int32)(unsafe.Add(mBase, _consts[1389]))
	*(*int32)(unsafe.Add(mBase, _consts[1389])) = v113 + v109
	*(*int32)(unsafe.Add(mBase, uint32(v107)+8)) = v113
	v119 = *(*int32)(unsafe.Add(mBase, _consts[1390]))
	v158 = v107
	v159 = v119
	goto L12
L30:
...
L31:
	;
	v124 = *(*int32)(unsafe.Add(mBase, _consts[1391]))
	v136 = v122
	v137 = v124
	goto L30
L32:
...
L34:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1391])) = int32(64)
	*(*int32)(unsafe.Add(mBase, _consts[1390])) = v129
	v136 = v129
	v137 = int32(64)
	goto L30
L35:
...
L39:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1391])) = v149
	*(*int32)(unsafe.Add(mBase, _consts[1390])) = v152
	v158 = v61
	v159 = v152
	goto L12
L40:
					...
					if v77 != 0 {
						...
						if v80 != 0 {
							...
							if v82 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6)+36)) = int32(309176)
								*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = v81
								F_errmsg(m, int32(178975), v6+int32(32))
								mBase = m.M
								v90 = m.ExcPending
								if v90 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(464144), int32(2233), int32(238850))
									mBase = m.M
									v95 = m.ExcPending
									if v95 != 0 {
										return int32(0)
									...
									if v34 != 0 {
										...
										if v36 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v35
											F_errmsg(m, int32(362112), v6+int32(16))
											mBase = m.M
											v42 = m.ExcPending
											if v42 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(464144), int32(2240), int32(238850))
												mBase = m.M
												v47 = m.ExcPending
												if v47 != 0 {
													return int32(0)
				...
				if v58 != 0 {
					...
					if v64 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = v63
						F_errmsg(m, int32(65793), v6)
						mBase = m.M
						v68 = m.ExcPending
						if v68 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(464144), int32(2227), int32(238850))
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return int32(0)
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(468529), int32(2857), int32(423362))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
