	...
	if base.Ui32(v160) < base.Ui32(int32(8157)) {
		if int32(8191) < l3 {
			...
			if v362 != 0 {
				...
				F_errmsg_internal(m, int32(318495), int32(0))
				mBase = m.M
				v366 = m.ExcPending
				if v366 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(516588), int32(1048), int32(402849))
					mBase = m.M
					v371 = m.ExcPending
					if v371 != 0 {
						return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v17))) = v171
				...
				if v349 != 0 {
					...
					if v353 != 0 {
						...
						F_errfinish(m, int32(516588), int32(1039), int32(402849))
						mBase = m.M
						v358 = m.ExcPending
						if v358 != 0 {
							return int32(0)
...
L50:
	;
	F_errfinish(m, int32(516588), int32(160), int32(388917))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L6
...
L53:
	;
	F_errfinish(m, int32(516588), int32(154), int32(388917))
	mBase = m.M
	v149 = m.ExcPending
	if v149 != 0 {
		goto L6
...
L85:
	;
	F_errfinish(m, int32(516588), int32(251), int32(418110))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L6
...
L88:
	;
	F_errfinish(m, int32(516588), int32(280), int32(418110))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L6
		...
		if l5 != 0 {
			...
			if v42 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v43 & int32(3)
				F_errmsg_internal(m, int32(505493), v16+int32(16))
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(520084), int32(798), int32(403075))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
...
L27:
	;
	F_errfinish(m, int32(523687), int32(457), int32(99033))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L15
...
L113:
	;
	F_errfinish(m, int32(523636), int32(691), int32(98931))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L2
