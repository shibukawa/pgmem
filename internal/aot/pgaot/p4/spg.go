...
func F_spgFormInnerTuple(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if l3 <= int32(0) {
		...
		if base.Ui32(l3) < base.Ui32(int32(4)) {
			...
			for {
				...
				v88 = int32(_a_F_spgFormInnerTuple_0)
		...
		if v62 == int32(0) {
			...
			for {
				...
				v148 = v133 + v145&int32(_a_F_spgFormInnerTuple_0)
				v149 = int32(1)
				v152 = v137 + v149
				if v152 != v62 {
					v132 = v132 + v149
	...
	if base.Ui32(v160) < base.Ui32(int32(_a_F_spgFormInnerTuple_1)) {
		if int32(_a_F_spgFormInnerTuple_0) < l3 {
			...
			if v362 != 0 {
				...
				F_errmsg_internal(m, int32(_a_F_spgFormInnerTuple_2), int32(0))
				mBase = m.M
				v366 = m.ExcPending
				if v366 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_spgFormInnerTuple_3), int32(1048), int32(_a_F_spgFormInnerTuple_4))
					mBase = m.M
					v371 = m.ExcPending
					if v371 != 0 {
						return int32(0)
			...
			if base.Ui32(int32(_a_F_spgFormInnerTuple_5)) <= base.Ui32(v56) {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v362 = m.ExcPending
				if v362 != 0 {
				...
				if v181 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v178))) = l3<<(uint(int32(3))%32)&int32(_a_F_spgFormInnerTuple_6) | v187&int32(7) | v56<<(uint(int32(16))%32)
					if l1 == int32(0) {
					} else {
						if v56 != 0 {
							v200 = v178 + int32(8)
					...
					if l3 <= int32(0) {
						...
						if l3 != v241 {
							...
							for {
								...
								v276 = int32(_a_F_spgFormInnerTuple_0)
								v278 = v274 + v275&v276
								...
								v288 = v284 + v285&int32(_a_F_spgFormInnerTuple_0)
								v289 = int32(2)
								v290 = v257 + v289
								v292 = v262 + v289
						...
						if l3&v241 == int32(0) {
							...
							v316 = v314 & int32(_a_F_spgFormInnerTuple_0)
							if v316 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v17))) = v171
				...
				if v349 != 0 {
					...
					if v353 != 0 {
						...
						F_errfinish(m, int32(_a_F_spgFormInnerTuple_3), int32(1039), int32(_a_F_spgFormInnerTuple_4))
						mBase = m.M
						v358 = m.ExcPending
						if v358 != 0 {
							return int32(0)
...
L17:
	;
	v82 = v66 | int32(_a_F_spgFormLeafTuple_0)
...
L12:
	;
	if base.Ui32(v22-int32(_a_F_spgGetCache_0)) < base.Ui32(int32(4)) {
		goto L9
	} else {
		goto L16
	}
...
L16:
	;
	if base.Ui32(v22-int32(_a_F_spgGetCache_1)) < base.Ui32(int32(2)) {
		goto L9
	} else {
		goto L17
	}
...
L78:
	;
	v237 = *(*int32)(unsafe.Add(mBase, _c_F_spgGetCache[0]))
...
L80:
	;
	v245 = *(*int32)(unsafe.Add(mBase, _c_F_spgGetCache[1]))
							...
							*(*uint8)(unsafe.Add(mBase, uint32(v221)+36)) = uint8(v232)
							...
							if v236 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, _c_F_spgTestLeafTuple[0])) = v128
								...
								v252 = v249 & int32(_a_F_spgTestLeafTuple_5)
								m.G0 = v16 + int32(80)
								return v252
							}
						} else {
...
L18:
	...
	if v100 <= v96 {
		v263 = v96
		v268 = int32(_a_F_spg_text_choose_0)
		goto L17
	} else {
		goto L80
	}
...
L30:
	;
	if int32(1)<<(uint(v81)%32)&int32(_a_F_spg_text_leaf_consistent_0) == int32(0) {
		v139 = v67
		v142 = v73
		goto L14
	} else {
...
L51:
	;
	v202 = v166 & int32(_a_F_spg_text_leaf_consistent_1)
	if v202 == int32(28) {
		goto L64
	} else {
		goto L65
...
L70:
	;
	switch v299&int32(_a_F_spg_text_leaf_consistent_1) - int32(1) {
	case 0:
		goto L104
	case 1:
		goto L108
