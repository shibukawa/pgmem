	...
	if base.Ui32(v160) < base.Ui32(int32(8157)) {
		if int32(8191) < l3 {
			...
			if v362 != 0 {
				...
				F_errmsg_internal(m, int32(310923), int32(0))
				mBase = m.M
				v366 = m.ExcPending
				if v366 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(505217), int32(1048), int32(393477))
					mBase = m.M
					v371 = m.ExcPending
					if v371 != 0 {
						return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v17))) = v171
				...
				if v349 != 0 {
					...
					if v353 != 0 {
						...
						F_errfinish(m, int32(505217), int32(1039), int32(393477))
						mBase = m.M
						v358 = m.ExcPending
						if v358 != 0 {
							return int32(0)
...
L50:
	;
	F_errfinish(m, int32(505217), int32(160), int32(379808))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L6
...
L53:
	;
	F_errfinish(m, int32(505217), int32(154), int32(379808))
	mBase = m.M
	v149 = m.ExcPending
	if v149 != 0 {
		goto L6
...
L84:
	;
	F_errmsg(m, int32(375904), int32(0))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L6
...
L85:
	;
	F_errfinish(m, int32(505217), int32(251), int32(408600))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L6
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v305 + int32(4)
	F_errmsg_internal(m, int32(29649), v10)
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L6
...
L88:
	;
	F_errfinish(m, int32(505217), int32(280), int32(408600))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L6
		...
		if l5 != 0 {
			...
			if v42 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v43 & int32(3)
				F_errmsg_internal(m, int32(494138), v16+int32(16))
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(508590), int32(798), int32(393703))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v72
	F_errmsg_internal(m, int32(492630), v10)
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L15
...
L27:
	;
	F_errfinish(m, int32(512160), int32(457), int32(94475))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L15
...
L113:
	;
	F_errfinish(m, int32(512109), int32(691), int32(94373))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L2
