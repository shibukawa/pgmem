...
func F_pgl_pq_flush(m *base.Module) {
	...
	var v5 int32
	_ = v5
	v2 = *(*int32)(unsafe.Add(mBase, _consts[314]))
...
func F_pgl_sendConnData(m *base.Module) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	*(*uint8)(unsafe.Add(mBase, _consts[217])) = uint8(v1)
				...
				if v29 != 0 {
					...
					if v33 != 0 {
						...
						if v36 != 0 {
							...
							v38 = *(*int32)(unsafe.Add(mBase, _consts[704]))
							F_enlargeStringInfo(m, v7, int32(4))
							mBase = m.M
							v41 = m.ExcPending
							if v41 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v42 + v61
								...
								if v66 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v67+v68))) = int32(543376384)
...
func F_pgl_shmdt(m *base.Module, l0 int32) int32 {
	...
	var v11 int32
	_ = v11
	v4 = *(*int32)(unsafe.Add(mBase, _consts[636]))
	if v4 == int32(0) {
		goto L1
	} else {
		goto L2
