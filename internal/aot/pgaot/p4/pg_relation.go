...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v178
	F_errmsg_internal(m, int32(523659), v12)
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L2
...
L60:
	;
	F_errfinish(m, int32(518815), int32(1036), int32(334443))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L2
