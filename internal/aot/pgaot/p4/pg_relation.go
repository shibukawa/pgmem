...
L17:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _consts[1250]))
	if int32(0) < v72 {
		goto L26
	} else {
		goto L27
...
L20:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[1251]))
	if v67 <= int32(0) {
		v137 = v38
		goto L12
	} else {
...
L28:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[1252]))
	if v95 <= int32(0) {
		v137 = v38
		goto L12
	} else {
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v178
	F_errmsg_internal(m, int32(494763), v12)
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L2
...
L60:
	;
	F_errfinish(m, int32(490700), int32(1036), int32(316504))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L2
