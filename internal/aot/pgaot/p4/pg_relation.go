...
L15:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_pg_relation_filepath[2]))
	if int32(0) < v44 {
		goto L18
	} else {
		goto L19
...
L17:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _c_F_pg_relation_filepath[3]))
	if int32(0) < v72 {
		goto L26
	} else {
		goto L27
...
L20:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _c_F_pg_relation_filepath[4]))
	if v67 <= int32(0) {
		v137 = v38
		goto L12
	} else {
...
L21:
	...
	v56 = *(*int32)(unsafe.Add(mBase, uint32(v53)+uint32(_c_F_pg_relation_filepath[5])))
	if v15 == v56 {
		v128 = v53 + int32(_a_F_pg_relation_filepath_0)
		goto L13
	} else {
		goto L23
	}
...
L28:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _c_F_pg_relation_filepath[6]))
	if v95 <= int32(0) {
		v137 = v38
		goto L12
	} else {
...
L29:
	...
	v84 = *(*int32)(unsafe.Add(mBase, uint32(v81)+uint32(_c_F_pg_relation_filepath[7])))
	if v15 == v84 {
		v128 = v81 + int32(_a_F_pg_relation_filepath_1)
		goto L13
	} else {
		goto L31
	}
...
L34:
	...
	v108 = *(*int32)(unsafe.Add(mBase, uint32(v105)+uint32(_c_F_pg_relation_filepath[8])))
	if v15 == v108 {
		v128 = v105 + int32(_a_F_pg_relation_filepath_2)
		goto L13
	} else {
		goto L36
	}
...
L38:
	...
	v122 = *(*int32)(unsafe.Add(mBase, uint32(v119)+uint32(_c_F_pg_relation_filepath[9])))
	if v15 == v122 {
		v128 = v119 + int32(_a_F_pg_relation_filepath_3)
		goto L13
	} else {
		goto L40
	}
...
L47:
	...
	v156 = *(*int32)(unsafe.Add(mBase, _c_F_pg_relation_filepath[10]))
	if v156 != 0 {
		goto L50
	} else {
		goto L51
...
L53:
	;
	v160 = *(*int32)(unsafe.Add(mBase, _c_F_pg_relation_filepath[11]))
	if v160 == v152 {
		v164 = v157
		goto L49
	} else {
...
L55:
	;
	v168 = *(*int32)(unsafe.Add(mBase, _c_F_pg_relation_filepath[12]))
	v170 = *(*int32)(unsafe.Add(mBase, _c_F_pg_relation_filepath[13]))
	if v170 == int32(-1) {
		goto L56
	} else {
		goto L57
