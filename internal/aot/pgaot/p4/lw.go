...
L53:
	;
	F_errmsg_internal(m, int32(296029), int32(0))
	mBase = m.M
	v200 = m.ExcPending
	if v200 != 0 {
		goto L25
...
L54:
	;
	F_errfinish(m, int32(522607), int32(1212), int32(383006))
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L25
		...
		*(*int32)(unsafe.Add(mBase, _consts[171])) = v13 + int32(1)
		...
		if v80 != 0 {
			...
			if v84 != 0 {
				...
				F_errfinish(m, int32(522607), int32(1361), int32(382935))
				mBase = m.M
				v89 = m.ExcPending
				if v89 != 0 {
					return int32(0)
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v17)+28)) = int32(333111)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+24)) = int32(888)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+20)) = int32(522607)
