		...
		if base.Ui64(v19-int64(9223372036854775807)) <= base.Ui64(int64(1)) {
			...
			if v148 != 0 {
				...
				if v151 != 0 {
					...
					F_errmsg(m, int32(402715), int32(0))
					mBase = m.M
					v155 = m.ExcPending
					if v155 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496147), int32(4858), int32(277696))
						mBase = m.M
						v160 = m.ExcPending
						if v160 != 0 {
							return int32(0)
					...
					if v25 != int32(-2147483648) {
						...
						if v47 != 0 {
							...
							if v50 != 0 {
								...
								F_errmsg(m, int32(136161), int32(0))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(496147), int32(4868), int32(277696))
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
							...
							if v33 != int64(-9223372036854775807-1) {
								...
								if v229 != 0 {
									...
									if v232 != 0 {
										...
										F_errmsg(m, int32(153381), int32(0))
										mBase = m.M
										v236 = m.ExcPending
										if v236 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(496147), int32(4863), int32(277696))
											mBase = m.M
											v241 = m.ExcPending
											if v241 != 0 {
												return int32(0)
					...
					if v165 != 0 {
						...
						if v168 != 0 {
							...
							if v172 != 0 {
								...
								F_errfinish(m, int32(496147), int32(4874), int32(277696))
								mBase = m.M
								v177 = m.ExcPending
								if v177 != 0 {
									return int32(0)
						...
						if v109 <= int64(0) {
							...
							if v181 != 0 {
								...
								if v184 != 0 {
									...
									F_errmsg(m, int32(240082), int32(0))
									mBase = m.M
									v188 = m.ExcPending
									if v188 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(496147), int32(4879), int32(277696))
										mBase = m.M
										v193 = m.ExcPending
										if v193 != 0 {
											return int32(0)
								...
								if v197 != 0 {
									...
									if v200 != 0 {
										...
										if v204 != 0 {
											...
											F_errfinish(m, int32(496147), int32(4884), int32(277696))
											mBase = m.M
											v209 = m.ExcPending
											if v209 != 0 {
												return int32(0)
										...
										if v213 != 0 {
											...
											if v216 != 0 {
												...
												if v220 != 0 {
													...
													F_errfinish(m, int32(496147), int32(4902), int32(277696))
													mBase = m.M
													v225 = m.ExcPending
													if v225 != 0 {
														return int32(0)
	...
	if v25 == int32(0) {
		...
		if v46 != 0 {
			...
			if v43 == int32(0) {
								...
								if v195 == int32(0) {
									...
									if v201 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v15
										F_errmsg(m, int32(727590), v11+int32(16))
										mBase = m.M
										v207 = m.ExcPending
										if v207 != 0 {
											return int32(0)
										} else {
											F_errsave_finish(m, v14, int32(496147), int32(457), int32(279069))
											mBase = m.M
											v212 = m.ExcPending
											if v212 != 0 {
												return int32(0)
				...
				default:
					...
					if v217 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v11))) = v219
						F_errmsg_internal(m, int32(692262), v11)
						mBase = m.M
						v223 = m.ExcPending
						if v223 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(496147), int32(474), int32(279069))
							mBase = m.M
							v228 = m.ExcPending
							if v228 != 0 {
								return int32(0)
				...
				v49 = v43
				F_DateTimeParseError(m, v49, v11+int32(40), v15, int32(372816), v14)
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return int32(0)
						...
						if v100 != 0 {
							...
							if v104 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7))) = v103
								F_errmsg(m, int32(113532), v7)
								mBase = m.M
								v108 = m.ExcPending
								if v108 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(496147), int32(6650), int32(372454))
									mBase = m.M
									v113 = m.ExcPending
									if v113 != 0 {
										return int32(0)
								...
								if v41 != 0 {
									...
									if v45 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v44
										F_errmsg(m, int32(350696), v7+int32(16))
										mBase = m.M
										v51 = m.ExcPending
										if v51 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(496147), int32(6643), int32(372454))
											mBase = m.M
											v56 = m.ExcPending
											if v56 != 0 {
												return int32(0)
					...
					if v81 != 0 {
						...
						if v84 != 0 {
							...
							if v88 != 0 {
								...
								F_errfinish(m, int32(496147), int32(6659), int32(372454))
								mBase = m.M
								v93 = m.ExcPending
								if v93 != 0 {
									return int32(0)
...
L196:
	;
	F_errfinish(m, int32(496147), int32(5961), int32(245689))
	mBase = m.M
	v682 = m.ExcPending
	if v682 != 0 {
		goto L1
...
L222:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v60
	F_errmsg(m, int32(190121), v14+int32(32))
	mBase = m.M
	v742 = m.ExcPending
	if v742 != 0 {
		goto L1
...
L223:
	;
	F_errfinish(m, int32(496147), int32(6008), int32(245689))
	mBase = m.M
	v747 = m.ExcPending
	if v747 != 0 {
		goto L1
...
L228:
	;
	F_errfinish(m, int32(496147), int32(6017), int32(245689))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L1
...
L237:
	;
	F_errfinish(m, int32(496147), int32(5827), int32(245689))
	mBase = m.M
	v805 = m.ExcPending
	if v805 != 0 {
		goto L1
	...
	if base.Ui64(l0-int64(9223372036854775807)) <= base.Ui64(int64(1)) {
		...
		if v41 != 0 {
			...
			if v38 == int32(0) {
				...
				F_EncodeDateTime(m, v3+int32(-48), v46, v47, v48, v49, v47, int32(4502208))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return int32(0)
