...
func F_get_publication_oid(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v12 int32
	_ = v12
	v9 = Fn13899(m, l0, l1, int32(_a_F_get_publication_oid_0), int32(3774), int32(_a_F_get_publication_oid_1), int32(_a_F_get_publication_oid_2), int32(67137668), int32(48))
	v12 = m.ExcPending
	if v12 != 0 {
		return int32(0)
	} else {
