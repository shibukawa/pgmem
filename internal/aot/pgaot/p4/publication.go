...
L18:
	;
	F_errfinish(m, int32(517240), int32(1921), int32(177093))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L10
...
L24:
	;
	F_errmsg(m, int32(551326), int32(0))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L10
...
L25:
	;
	F_errfinish(m, int32(517240), int32(1908), int32(177093))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L10
...
L28:
	;
	F_errmsg(m, int32(279256), int32(0))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L10
...
L29:
	;
	F_errfinish(m, int32(517240), int32(1927), int32(177093))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L10
					...
					if v23 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
						...
						if v27 != 0 {
							...
							F_errfinish(m, int32(522775), int32(3774), int32(454312))
							mBase = m.M
							v32 = m.ExcPending
							if v32 != 0 {
								return int32(0)
