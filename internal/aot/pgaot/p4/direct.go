		...
		if v27 == int32(1) {
			...
			if v33 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
				F_errmsg_internal(m, int32(515015), v7)
				mBase = m.M
				v37 = m.ExcPending
				if v37 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(478374), int32(806), int32(293217))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return int32(0)
		...
		if v35 == int32(1) {
			...
			if v41 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
				F_errmsg_internal(m, int32(515015), v9)
				mBase = m.M
				v45 = m.ExcPending
				if v45 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(478374), int32(853), int32(293169))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return int32(0)
