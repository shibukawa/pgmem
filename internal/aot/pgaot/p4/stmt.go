...
L35:
	;
	v220 = *(*int64)(unsafe.Add(mBase, _c_F_exec_stmt_execsql[2]))
	*(*int64)(unsafe.Add(mBase, uint32(l0)+112)) = v220
	v223 = *(*int32)(unsafe.Add(mBase, _c_F_exec_stmt_execsql[3]))
...
L36:
	...
	v212 = *(*int64)(unsafe.Add(mBase, _c_F_exec_stmt_execsql[2]))
	v215 = int32(0)
...
L41:
	...
	v138 = *(*int64)(unsafe.Add(mBase, _c_F_exec_stmt_execsql[2]))
	v141 = int32(0)
...
L87:
	;
	v312 = F_errstart(m, v310, int32(_a_F_exec_stmt_execsql_0))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L4
...
L121:
	;
	v358 = *(*int32)(unsafe.Add(mBase, _c_F_exec_stmt_execsql[3]))
