			...
			if v103 != 0 {
				...
				if v106 != 0 {
					...
					*(*float64)(unsafe.Add(mBase, uint32(v9))) = v18
					F_errmsg(m, int32(536015), v9)
					mBase = m.M
					v110 = m.ExcPending
					if v110 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(477321), int32(447), int32(302128))
						mBase = m.M
						v115 = m.ExcPending
						if v115 != 0 {
							return int32(0)
										...
										if v69 != 0 {
											...
											if v68 == int32(0) {
												...
												if v119 != 0 {
													...
													F_errmsg_internal(m, int32(471841), int32(0))
													mBase = m.M
													v123 = m.ExcPending
													if v123 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(477321), int32(480), int32(302128))
														mBase = m.M
														v128 = m.ExcPending
														if v128 != 0 {
															return int32(0)
													...
													if v80 == int32(0) {
														...
														if v132 != 0 {
															...
															if v136 != 0 {
																...
																F_errfinish(m, int32(477321), int32(485), int32(302128))
																mBase = m.M
																v141 = m.ExcPending
																if v141 != 0 {
																	return int32(0)
...
L51:
	;
	F_errfinish(m, int32(477321), int32(819), int32(302054))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L13
...
L54:
	;
	F_errfinish(m, int32(477321), int32(823), int32(302054))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L13
