...
L369:
	;
	F_errfinish(m, int32(521756), int32(3131), int32(484792))
	mBase = m.M
	v1773 = m.ExcPending
	if v1773 != 0 {
		goto L4
...
L450:
	;
	F_errfinish(m, int32(521756), int32(3140), int32(484792))
	mBase = m.M
	v2125 = m.ExcPending
	if v2125 != 0 {
		goto L4
...
L454:
	;
	F_errfinish(m, int32(521756), int32(3152), int32(484792))
	mBase = m.M
	v2147 = m.ExcPending
	if v2147 != 0 {
		goto L4
