...
L368:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1075))) = v1740
	F_errmsg_internal(m, int32(159497), v1075)
	mBase = m.M
	v1762 = m.ExcPending
	if v1762 != 0 {
		goto L4
...
L369:
	;
	F_errfinish(m, int32(499447), int32(3131), int32(465300))
	mBase = m.M
	v1767 = m.ExcPending
	if v1767 != 0 {
		goto L4
...
L449:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1075)+32)) = v1740
	F_errmsg_internal(m, int32(159497), v1075+int32(32))
	mBase = m.M
	v2111 = m.ExcPending
	if v2111 != 0 {
		goto L4
...
L450:
	;
	F_errfinish(m, int32(499447), int32(3140), int32(465300))
	mBase = m.M
	v2116 = m.ExcPending
	if v2116 != 0 {
		goto L4
...
L453:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1075)+20)) = v2125 - int32(4)
	F_errmsg_internal(m, int32(159497), v1075+int32(16))
	mBase = m.M
	v2133 = m.ExcPending
	if v2133 != 0 {
		goto L4
...
L454:
	;
	F_errfinish(m, int32(499447), int32(3152), int32(465300))
	mBase = m.M
	v2138 = m.ExcPending
	if v2138 != 0 {
		goto L4
