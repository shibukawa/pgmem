...
L368:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1081))) = v1746
	F_errmsg_internal(m, int32(168639), v1081)
	mBase = m.M
	v1768 = m.ExcPending
	if v1768 != 0 {
		goto L4
...
L369:
	;
	F_errfinish(m, int32(521826), int32(3131), int32(484844))
	mBase = m.M
	v1773 = m.ExcPending
	if v1773 != 0 {
		goto L4
...
L449:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1081)+32)) = v1746
	F_errmsg_internal(m, int32(168639), v1081+int32(32))
	mBase = m.M
	v2120 = m.ExcPending
	if v2120 != 0 {
		goto L4
...
L450:
	;
	F_errfinish(m, int32(521826), int32(3140), int32(484844))
	mBase = m.M
	v2125 = m.ExcPending
	if v2125 != 0 {
		goto L4
...
L453:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1081)+20)) = v2134 - int32(4)
	F_errmsg_internal(m, int32(168639), v1081+int32(16))
	mBase = m.M
	v2142 = m.ExcPending
	if v2142 != 0 {
		goto L4
...
L454:
	;
	F_errfinish(m, int32(521826), int32(3152), int32(484844))
	mBase = m.M
	v2147 = m.ExcPending
	if v2147 != 0 {
		goto L4
