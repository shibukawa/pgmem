...
func F_bpchar_sortsupport(m *base.Module, l0 int32) int32 {
	...
	var v15 int32
	_ = v15
	v4 = int32(_a_F_bpchar_sortsupport_0)
	v5 = *(*int32)(unsafe.Add(mBase, _c_F_bpchar_sortsupport[0]))
	v6 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(v6)+4))
	v9 = *(*int32)(unsafe.Add(mBase, uint32(v6)))
	*(*int32)(unsafe.Add(mBase, _c_F_bpchar_sortsupport[0])) = v9
	...
	if v15 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_bpchar_sortsupport[0])) = v5
		return int32(0)
	}
}
