...
L2:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _c_F_BufferGetLSNAtomic[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = int32(_a_F_BufferGetLSNAtomic_0)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+24)) = int32(_a_F_BufferGetLSNAtomic_1)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(_a_F_BufferGetLSNAtomic_2)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+8)) = int64(0)
	...
	v68 = int32(_a_F_BufferGetLSNAtomic_3)
...
L4:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_BufferGetLSNAtomic[1]))
...
L6:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _c_F_BufferGetLSNAtomic[2]))
	v31 = v28 + l0<<(uint(int32(13))%32)
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_BufferGetLSNAtomic[3]))
...
L9:
	;
	v40 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_BufferGetLSNAtomic[4])))
	if v40&int32(1) != 0 {
		goto L2
	} else {
		goto L10
...
L13:
	;
	v102 = int32(_a_F_BufferGetLSNAtomic_4)
	v103 = *(*int32)(unsafe.Add(mBase, _c_F_BufferGetLSNAtomic[5]))
...
L17:
	...
	v87 = int32(_a_F_BufferGetLSNAtomic_3)
...
L19:
	;
	v124 = int64(*(*uint32)(unsafe.Add(mBase, uint32(v31-int32(_a_F_BufferGetLSNAtomic_5)))))
	v125 = int64(*(*uint32)(unsafe.Add(mBase, uint32(v31)+uint32(_c_F_BufferGetLSNAtomic[6]))))
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BufferGetLSNAtomic[5])) = v120
	goto L20
L22:
	;
	if int32(999) < v103 {
...
L37:
	;
	v119 = int32(_a_F_IsBufferCleanupOK_12)
	v120 = *(*int32)(unsafe.Add(mBase, _c_F_IsBufferCleanupOK[12]))
...
L42:
	;
	if v111&int32(_a_F_IsBufferCleanupOK_13) == int32(1) {
		goto L53
	} else {
		goto L54
	}
...
L44:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_IsBufferCleanupOK[12])) = v137
	goto L43
L45:
	;
	if int32(999) < v120 {
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+24)) = v84&int32(-541065217) | int32(536870912)
	v164 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[0]))
...
L37:
	;
	v171 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[4]))
...
L38:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v14)+8)) = int64(0)
	...
	v529 = int32(_a_F_LockBufferForCleanup_3)
...
L46:
	;
	v201 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[6]))
	goto L47
L47:
	;
...
L50:
	;
	v219 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[7])))
...
L67:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v322))) = int64(4)
	v329 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[6]))
...
L72:
	;
	v340 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[13]))
	if v340 != 0 {
		goto L74
	} else {
		goto L75
...
L73:
	;
	v352 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[14])) = v352
	*(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[15])) = v352
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[16])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[17])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[18])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[19])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[20])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[21])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[22])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[23])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[24])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[25])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[26])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[27])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[28])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[29])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[30])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[31])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[32])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[33])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[34])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[35])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[36])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[37])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[38])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[39])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[40])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[41])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[42])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[43])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[44])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[45])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[46])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[47])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[48])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[49])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[50])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[51])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[52])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[53])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[54])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[55])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[56])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[57])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[58])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[59])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[60])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[61])) = uint8(v352)
	goto L79
L74:
	;
	v347 = int32(12)
...
L75:
	;
	v343 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[12]))
	if v343 == int32(0) {
		goto L73
	} else {
		goto L77
...
L79:
	;
	v496 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[13])) = v496
	*(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[12])) = v496
	m.G0 = v251 - int32(-64)
	v506 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[5]))
...
L84:
	;
	v569 = int32(_a_F_LockBufferForCleanup_4)
	v570 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[1]))
...
L87:
	...
	v550 = int32(_a_F_LockBufferForCleanup_3)
...
L91:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[1])) = v587
	goto L90
L92:
	;
	if int32(999) < v570 {
...
L100:
	...
	v595 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[2]))
	if v593 == v595 {
		goto L103
	} else {
		goto L104
...
L102:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[3])) = int32(0)
	v606 = *(*int32)(unsafe.Add(mBase, _c_F_LockBufferForCleanup[0]))
	v28 = v606
	v32 = v513
	v35 = v515
	goto L5
...
L2:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _c_F_MarkBufferDirtyHint[0]))
	v60 = *(*int32)(unsafe.Add(mBase, _c_F_MarkBufferDirtyHint[1]))
...
L5:
	...
	if v43&int32(_a_F_MarkBufferDirtyHint_0) == int32(0) {
		goto L12
	} else {
		goto L13
	}
...
L12:
	;
	v48 = int32(_a_F_MarkBufferDirtyHint_5)
	v50 = *(*int64)(unsafe.Add(mBase, _c_F_MarkBufferDirtyHint[3]))
	*(*int64)(unsafe.Add(mBase, _c_F_MarkBufferDirtyHint[3])) = v50 + int64(1)
	goto L14
L13:
	;
	goto L14
L14:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v42))) = v43 | int32(_a_F_MarkBufferDirtyHint_0)
	goto L11
L15:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _c_F_MarkBufferDirtyHint[4]))
...
L16:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v15)+40)) = int64(0)
	...
	v287 = int32(_a_F_MarkBufferDirtyHint_8)
...
L44:
	;
	v164 = int32(_a_F_MarkBufferDirtyHint_10) - v153
	if v164 != 0 {
		goto L49
	} else {
		goto L50
...
L53:
	;
	v171 = F__emscripten_memcpy_bulkmem(m, v126+int32(32), v167, int32(_a_F_MarkBufferDirtyHint_10))
	mBase = m.M
	goto L55
L55:
	;
...
L75:
	;
	v329 = int32(_a_F_MarkBufferDirtyHint_14)
	v330 = *(*int32)(unsafe.Add(mBase, _c_F_MarkBufferDirtyHint[13]))
...
L78:
	...
	v309 = int32(_a_F_MarkBufferDirtyHint_8)
...
L80:
	;
	v350 = v315 & int32(_a_F_MarkBufferDirtyHint_0)
	if v350 != 0 {
		goto L91
	} else {
		goto L92
...
L82:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_MarkBufferDirtyHint[13])) = v347
	goto L81
L83:
	;
	if int32(999) < v330 {
...
L93:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v355-int32(_a_F_MarkBufferDirtyHint_15)))) = uint32(v275)
	goto L91
L94:
	;
