...
L9:
	;
	v40 = int32(*(*uint8)(unsafe.Add(mBase, _consts[326])))
	if v40&int32(1) != 0 {
		goto L2
	} else {
		goto L10
...
L13:
	;
	v102 = int32(4062540)
	v103 = *(*int32)(unsafe.Add(mBase, _consts[414]))
...
L19:
	...
	v125 = int64(*(*uint32)(unsafe.Add(mBase, uint32(v31)+uint32(_consts[912]))))
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[414])) = v120
	goto L20
L22:
	;
	if int32(999) < v103 {
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = l0
	v23 = *(*int32)(unsafe.Add(mBase, _consts[921]))
	if l0 == v23 {
		goto L6
	} else {
		goto L7
...
L8:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[922]))
	if l0 == v27 {
		goto L9
	} else {
		goto L10
...
L11:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[923]))
	if l0 == v31 {
		goto L12
	} else {
		goto L13
...
L14:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _consts[924]))
	if l0 == v35 {
		goto L15
	} else {
		goto L16
...
L17:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[925]))
	if l0 == v39 {
		goto L18
	} else {
		goto L19
...
L20:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[926]))
	if l0 == v43 {
		goto L21
	} else {
		goto L22
...
L23:
	;
	v47 = *(*int32)(unsafe.Add(mBase, _consts[927]))
	if l0 == v47 {
		goto L24
	} else {
		goto L25
...
L26:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _consts[928]))
	if l0 == v51 {
		goto L27
	} else {
		goto L28
...
L29:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _consts[929]))
	if v55 == int32(0) {
		v153 = v2
		goto L1
	} else {
...
L30:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _consts[930]))
	v62 = int32(0)
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = int32(217995)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = int32(472001)
...
L37:
	;
	v119 = int32(4062540)
	v120 = *(*int32)(unsafe.Add(mBase, _consts[414]))
...
L44:
	;
	*(*int32)(unsafe.Add(mBase, _consts[414])) = v137
	goto L43
L45:
	;
	if int32(999) < v120 {
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+28)) = int32(217995)
	*(*int32)(unsafe.Add(mBase, uint32(v14)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v14)+20)) = int32(472001)
...
L10:
	;
	v97 = int32(4062540)
	v98 = *(*int32)(unsafe.Add(mBase, _consts[414]))
...
L17:
	;
	*(*int32)(unsafe.Add(mBase, _consts[414])) = v115
	goto L16
L18:
	;
	if int32(999) < v98 {
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, _consts[914])) = v26
...
L37:
	;
	v171 = *(*int32)(unsafe.Add(mBase, _consts[257]))
...
L42:
	;
	v247 = *(*int32)(unsafe.Add(mBase, _consts[156]))
...
L46:
	;
	v201 = *(*int32)(unsafe.Add(mBase, _consts[915]))
	goto L47
L47:
	;
...
L50:
	;
	v219 = int32(*(*uint8)(unsafe.Add(mBase, _consts[916])))
...
L53:
	...
	v251 = v249 + int32(-64)
	m.G0 = v251
	v256 = *(*int64)(unsafe.Add(mBase, _consts[299]))
	*(*int64)(unsafe.Add(mBase, uint32(v251))) = v256
	v259 = *(*int32)(unsafe.Add(mBase, _consts[297]))
...
L56:
	;
	v268 = *(*int32)(unsafe.Add(mBase, _consts[917]))
	if v268 < int32(0) {
		v287 = int64(0)
		goto L55
	} else {
...
L58:
	;
	v278 = *(*int32)(unsafe.Add(mBase, _consts[918]))
	if v278 < int32(0) {
		v287 = int64(0)
		goto L55
	} else {
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, _consts[919])) = int32(0)
	*(*int64)(unsafe.Add(mBase, uint32(v322))) = int64(4)
	v329 = *(*int32)(unsafe.Add(mBase, _consts[915]))
...
L72:
	;
	v340 = *(*int32)(unsafe.Add(mBase, _consts[920]))
	if v340 != 0 {
		goto L74
	} else {
		goto L75
...
L73:
	;
	v352 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[636])) = v352
	*(*int32)(unsafe.Add(mBase, _consts[637])) = v352
	*(*uint8)(unsafe.Add(mBase, _consts[638])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _consts[644])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _consts[652])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _consts[653])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _consts[654])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _consts[655])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _consts[656])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _consts[657])) = uint8(v352)
	*(*uint8)(unsafe.Add(mBase, _consts[658])) = uint8(v352)
...
L75:
	;
	v343 = *(*int32)(unsafe.Add(mBase, _consts[919]))
	if v343 == int32(0) {
		goto L73
	} else {
		goto L77
...
L79:
	;
	v496 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[920])) = v496
	*(*int32)(unsafe.Add(mBase, _consts[919])) = v496
	m.G0 = v251 - int32(-64)
...
L84:
	;
	v569 = int32(4062540)
	v570 = *(*int32)(unsafe.Add(mBase, _consts[414]))
...
L91:
	;
	*(*int32)(unsafe.Add(mBase, _consts[414])) = v587
	goto L90
L92:
	;
	if int32(999) < v570 {
...
L100:
	...
	v595 = *(*int32)(unsafe.Add(mBase, _consts[157]))
	if v593 == v595 {
		goto L103
	} else {
		goto L104
...
L107:
	;
	F_errmsg_internal(m, int32(529332), int32(0))
	mBase = m.M
	v620 = m.ExcPending
	if v620 != 0 {
		goto L1
...
L108:
	;
	F_errfinish(m, int32(472001), int32(5742), int32(221312))
	mBase = m.M
	v625 = m.ExcPending
	if v625 != 0 {
		goto L1
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = int32(0)
	F_errmsg_internal(m, int32(465217), v15)
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L7
...
L9:
	;
	F_errfinish(m, int32(472001), int32(5436), int32(86599))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L7
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v15)+60)) = int32(217995)
	*(*int32)(unsafe.Add(mBase, uint32(v15)+56)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v15)+52)) = int32(472001)
...
L19:
	;
	v77 = int32(*(*uint8)(unsafe.Add(mBase, _consts[326])))
	if v77 == int32(1) {
		goto L17
	} else {
		goto L20
...
L21:
	;
	v87 = int32(*(*uint8)(unsafe.Add(mBase, _consts[189])))
	if v87 == int32(1) {
		goto L23
	} else {
		goto L24
...
L23:
	;
	v92 = *(*int32)(unsafe.Add(mBase, _consts[190]))
	v93 = *(*int32)(unsafe.Add(mBase, uint32(v92)+316))
	v95 = base.B2i32(v93 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _consts[189])) = uint8(v95)
	v97 = v95
	goto L25
L24:
	;
...
L75:
	;
	v329 = int32(4062540)
	v330 = *(*int32)(unsafe.Add(mBase, _consts[414]))
...
L82:
	;
	*(*int32)(unsafe.Add(mBase, _consts[414])) = v347
	goto L81
L83:
	;
	if int32(999) < v330 {
...
L93:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v355)+uint32(_consts[912]))) = uint32(v359)
...
L97:
	...
	*(*int64)(unsafe.Add(mBase, _consts[7])) = v379 + int64(1)
	v384 = int32(*(*uint8)(unsafe.Add(mBase, _consts[719])))
	if v384 != int32(1) {
		goto L1
	} else {
		goto L98
...
L98:
	;
	v387 = int32(4437296)
	v389 = *(*int32)(unsafe.Add(mBase, _consts[464]))
	v391 = *(*int32)(unsafe.Add(mBase, _consts[913]))
	*(*int32)(unsafe.Add(mBase, _consts[464])) = v389 + v391
	goto L1
}
...
func F_StartBufferIO(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v8 = v6 - int32(32)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[173]))
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+24)) = v55&int32(-71303169) | int32(67108864)
	v100 = int32(1)
	v102 = *(*int32)(unsafe.Add(mBase, _consts[173]))
	v103 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	F_ResourceOwnerRemember(m, v102, v103+v100, int32(1586108))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L1
...
L17:
	;
	*(*int32)(unsafe.Add(mBase, _consts[414])) = v78
	goto L16
L18:
	;
	if int32(999) < v61 {
