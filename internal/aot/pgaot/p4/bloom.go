...
func F_bloomBuildCallback(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[28])) = v10
	...
	if v15 != 0 {
		...
		if base.Ui32(v21) <= base.Ui32(v26) {
			v43 = *(*int32)(unsafe.Add(mBase, uint32(l5)+uint32(_consts[1570])))
			*(*int32)(unsafe.Add(mBase, uint32(l5)+uint32(_consts[1570]))) = v43 + int32(1)
							...
							if v60 != 0 {
								...
								if v62 != 0 {
									...
									if v64 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(l5)+uint32(_consts[1570]))) = int32(0)
										...
										if base.B2i32(base.Ui32(v81) <= base.Ui32(v86)) == int32(0) {
											...
											if v123 != 0 {
												...
												if v129 != 0 {
													...
													F_errfinish(m, int32(517521), int32(104), int32(335924))
													mBase = m.M
													v136 = m.ExcPending
													if v136 != 0 {
														return
											...
											v105 = *(*int32)(unsafe.Add(mBase, uint32(l5)+uint32(_consts[1570])))
											*(*int32)(unsafe.Add(mBase, uint32(l5)+uint32(_consts[1570]))) = v105 + int32(1)
											v111 = *(*int64)(unsafe.Add(mBase, uint32(l5)+1168))
											*(*int64)(unsafe.Add(mBase, uint32(l5)+1168)) = v111 + int64(1)
											*(*int32)(unsafe.Add(mBase, _consts[28])) = v9
											v117 = *(*int32)(unsafe.Add(mBase, uint32(l5)+1176))
