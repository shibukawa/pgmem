...
L9:
	;
	F_errdetail(m, int32(553248), int32(0))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L5
...
L10:
	;
	F_errsave_finish(m, l1, int32(309113), int32(585), int32(226637))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L5
...
L23:
	;
	F_errmsg(m, int32(330014), int32(0))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L5
...
L24:
	;
	F_errsave_finish(m, l1, int32(309113), int32(602), int32(226637))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L5
