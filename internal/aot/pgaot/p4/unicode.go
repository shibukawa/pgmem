			...
			if v15 == int32(0) {
				...
				if v23 != 0 {
					...
					if v27 != 0 {
						...
						F_errdetail(m, int32(578545), int32(0))
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return int32(0)
						} else {
							F_errsave_finish(m, l1, int32(314832), int32(585), int32(230526))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
						...
						if v45 != 0 {
							...
							if v44 == int32(0) {
								...
								if v50 != 0 {
									...
									F_errmsg(m, int32(336101), int32(0))
									mBase = m.M
									v54 = m.ExcPending
									if v54 != 0 {
										return int32(0)
									} else {
										F_errsave_finish(m, l1, int32(314832), int32(602), int32(230526))
										mBase = m.M
										v59 = m.ExcPending
										if v59 != 0 {
											return int32(0)
...
L81:
	...
	v310 = int32(1)
	v314 = int32(*(*int16)(unsafe.Add(mBase, uint32(v309<<(uint(v310)%32))+uint32(_consts[1355]))))
	v315 = int32(257)
	v323 = ((v296*v315+v294)*v315+v288)*v315 + v282
	v325 = base.I32_rem_u_s(v323, v308)
	v330 = int32(*(*int16)(unsafe.Add(mBase, uint32(v325<<(uint(v310)%32))+uint32(_consts[1355]))))
	v331 = v314 + v330
...
L84:
	...
	v338 = *(*int32)(unsafe.Add(mBase, uint32(v335)+uint32(_consts[1356])))
	if v271 != v338 {
		v347 = v280
		goto L83
	} else {
...
L85:
	;
	v340 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v335)+uint32(_consts[1357]))))
...
L92:
	...
	v378 = int32(1)
	v382 = int32(*(*int16)(unsafe.Add(mBase, uint32(v377<<(uint(v378)%32))+uint32(_consts[1358]))))
	v384 = base.I32_rem_u_s(v323, v376)
	v389 = int32(*(*int16)(unsafe.Add(mBase, uint32(v384<<(uint(v378)%32))+uint32(_consts[1358]))))
	v390 = v382 + v389
...
L93:
	...
	v351 = int32(1)
	v355 = int32(*(*int16)(unsafe.Add(mBase, uint32(v350<<(uint(v351)%32))+uint32(_consts[1359]))))
	v357 = base.I32_rem_u_s(v323, v349)
	v362 = int32(*(*int16)(unsafe.Add(mBase, uint32(v357<<(uint(v351)%32))+uint32(_consts[1359]))))
	v363 = v355 + v362
...
L94:
	;
	v370 = *(*int32)(unsafe.Add(mBase, uint32(v363<<(uint(int32(2))%32))+uint32(_consts[1360])))
...
L96:
	;
	v397 = *(*int32)(unsafe.Add(mBase, uint32(v390<<(uint(int32(2))%32))+uint32(_consts[1361])))
