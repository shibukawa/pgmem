			...
			if v15 == int32(0) {
				...
				if v23 != 0 {
					...
					if v27 != 0 {
						...
						F_errdetail(m, int32(606306), int32(0))
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return int32(0)
						} else {
							F_errsave_finish(m, l1, int32(329962), int32(585), int32(242207))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
						...
						if v45 != 0 {
							...
							if v44 == int32(0) {
								...
								if v50 != 0 {
									...
									F_errmsg(m, int32(352944), int32(0))
									mBase = m.M
									v54 = m.ExcPending
									if v54 != 0 {
										return int32(0)
									} else {
										F_errsave_finish(m, l1, int32(329962), int32(602), int32(242207))
										mBase = m.M
										v59 = m.ExcPending
										if v59 != 0 {
											return int32(0)
