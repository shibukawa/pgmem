...
func F_ExecTidRangeScan(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_ExecScan(m, l0, int32(764), int32(765))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
L6:
	...
	v46 = int32(_a_F_TidRangeEval_1)
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_TidRangeEval[0]))
	v49 = *(*int32)(unsafe.Add(mBase, uint32(v15)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_TidRangeEval[0])) = v49
...
L14:
	...
	if v78 == int32(_a_F_TidRangeEval_0) {
		goto L18
	} else {
		goto L19
	}
