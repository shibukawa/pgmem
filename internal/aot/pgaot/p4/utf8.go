...
func F_utf8_to_gbk(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_UtfToLocal(m, v6, v10, v5, int32(4390228), v18, v18, v18, int32(37), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
func F_utf8_to_shift_jis_2004(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v17 = int32(0)
		v27 = F_UtfToLocal(m, v6, v10, v5, int32(4392332), int32(3751056), int32(25), v17, int32(41), base.B2i32(v7 != v17))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return int32(0)
...
func F_utf8_to_uhc(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_UtfToLocal(m, v6, v10, v5, int32(4392492), v18, v18, v18, int32(38), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
			...
			if v54 != 0 {
				...
				if v57 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v16
					F_errmsg(m, int32(124142), v10)
					mBase = m.M
					v63 = m.ExcPending
					if v63 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496427), int32(150), int32(275111))
						mBase = m.M
						v70 = m.ExcPending
						if v70 != 0 {
							return int32(0)
