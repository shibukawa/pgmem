...
func F_PrepareTempTablespaces(m *base.Module) {
	...
	v11 = v9 - int32(16)
	m.G0 = v11
	v14 = *(*int32)(unsafe.Add(mBase, _consts[454]))
...
L4:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[455]))
	v28 = F_pstrdup(m, v27)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
...
L9:
	;
	v37 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[454])) = v37
	*(*int32)(unsafe.Add(mBase, _consts[456])) = v37
	goto L14
L10:
	;
	goto L11
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _consts[454])) = v119
	*(*int32)(unsafe.Add(mBase, _consts[456])) = v64
	if int32(2) <= v119 {
		goto L40
	} else {
		goto L41
...
L40:
	;
	v140 = F_pg_prng_uint64_range(m, int32(4554256), int64(0), base.I64_extend_i32_u(v119-int32(1)))
	mBase = m.M
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _consts[457])) = v142
	goto L39
L43:
	;
