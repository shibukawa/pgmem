...
L4:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[457]))
	v28 = F_pstrdup(m, v27)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _consts[459])) = v37
	goto L12
L16:
	;
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _consts[456])) = v119
	*(*int32)(unsafe.Add(mBase, _consts[458])) = v64
	if int32(2) <= v119 {
		goto L40
	} else {
		goto L41
...
L40:
	;
	v140 = F_pg_prng_uint64_range(m, int32(4570544), int64(0), base.I64_extend_i32_u(v119-int32(1)))
	mBase = m.M
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _consts[459])) = v142
	goto L39
L43:
	;
