	...
	if v26 == int32(0) {
		...
		if v47 != 0 {
			...
			if v44 == int32(0) {
								...
								if v190 == int32(0) {
									...
									if v196 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v16
										F_errmsg(m, int32(701221), v12+int32(16))
										mBase = m.M
										v202 = m.ExcPending
										if v202 != 0 {
											return int32(0)
										} else {
											F_errsave_finish(m, v15, int32(486977), int32(204), int32(274791))
											mBase = m.M
											v207 = m.ExcPending
											if v207 != 0 {
												return int32(0)
				...
				default:
					...
					if v212 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12))) = v214
						F_errmsg_internal(m, int32(676169), v12)
						mBase = m.M
						v218 = m.ExcPending
						if v218 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(486977), int32(221), int32(274791))
							mBase = m.M
							v223 = m.ExcPending
							if v223 != 0 {
								return int32(0)
				...
				v50 = v44
				F_DateTimeParseError(m, v50, v12+int32(40), v16, int32(233384), v15)
				mBase = m.M
				v55 = m.ExcPending
				if v55 != 0 {
					return int32(0)
...
L201:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v61
	F_errmsg(m, int32(187019), v15+int32(16))
	mBase = m.M
	v765 = m.ExcPending
	if v765 != 0 {
		goto L1
...
L202:
	;
	F_errfinish(m, int32(486977), int32(5690), int32(241494))
	mBase = m.M
	v770 = m.ExcPending
	if v770 != 0 {
		goto L1
...
L228:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v61
	F_errmsg(m, int32(187019), v15+int32(32))
	mBase = m.M
	v830 = m.ExcPending
	if v830 != 0 {
		goto L1
...
L229:
	;
	F_errfinish(m, int32(486977), int32(5737), int32(241494))
	mBase = m.M
	v835 = m.ExcPending
	if v835 != 0 {
		goto L1
...
L234:
	;
	F_errfinish(m, int32(486977), int32(5746), int32(241494))
	mBase = m.M
	v855 = m.ExcPending
	if v855 != 0 {
		goto L1
...
L243:
	;
	F_errfinish(m, int32(486977), int32(5553), int32(241494))
	mBase = m.M
	v895 = m.ExcPending
	if v895 != 0 {
		goto L1
