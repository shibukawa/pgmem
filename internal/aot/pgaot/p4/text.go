...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v51))) = v50 << (uint(int32(2)) % 32)
	v56 = v50 + v51
	v57 = v20 + v48
	v59 = *(*int32)(unsafe.Add(mBase, _consts[485]))
	v60 = *(*int32)(unsafe.Add(mBase, uint32(v59)+4))
	v65 = *(*int32)(unsafe.Add(mBase, uint32(v60*int32(28))+uint32(_consts[1294])))
	goto L19
L18:
	;
	return v51
...
func F_text_to_stavalues(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+24)) = v14
	v17 = *(*int64)(unsafe.Add(mBase, _consts[891]))
										...
										*(*uint8)(unsafe.Add(mBase, uint32(l5))) = uint8(v92)
										...
										if v77 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
											F_errmsg(m, int32(149073), v11)
											mBase = m.M
											v81 = m.ExcPending
											if v81 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(472203), int32(738), int32(148560))
												mBase = m.M
												v86 = m.ExcPending
												if v86 != 0 {
													return int32(0)
