...
func F_SearchSysCacheCopyAttName(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v22
	v3 = int32(0)
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1385]))
	...
	if v15 != 0 {
		...
		if v16 == int32(1) {
			...
			if v22 != 0 {
				...
				v27 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(5))%32))+uint32(_consts[1386])))
				...
				if v29 != 0 {
					...
					v34 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1387])))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v35 + v36<<(uint(int32(4))%32) + l2*int32(100) - int32(76)
					...
					if v49 != 0 {
						...
						F_errfinish(m, int32(496032), int32(644), int32(302011))
						mBase = m.M
						v54 = m.ExcPending
						if v54 != 0 {
							return int32(0)
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, _consts[264])) = int32(17)
	v39 = *(*int64)(unsafe.Add(mBase, _consts[785]))
	goto L7
L4:
	;
	return
...
L6:
	;
	v47 = int32(*(*uint8)(unsafe.Add(mBase, _consts[786])))
	if v47 != int32(1) {
		goto L10
	} else {
		goto L11
...
L10:
	;
	v70 = *(*int32)(unsafe.Add(mBase, _consts[787]))
	if int32(0) <= v70 {
		goto L13
	} else {
		goto L14
...
L26:
	;
	v115 = F___memcpy(m, int32(4652092), v104, int32(140))
	mBase = m.M
	goto L28
L27:
	;
...
L39:
	;
	v157 = F___memcpy(m, int32(4652232), v146, int32(140))
	mBase = m.M
	goto L41
L40:
	;
...
L52:
	;
	v199 = F___memcpy(m, int32(4654052), v188, int32(140))
	mBase = m.M
	goto L54
L53:
	;
...
L65:
	;
	v241 = F___memcpy(m, int32(4652372), v230, int32(140))
	mBase = m.M
	goto L67
L66:
	;
...
L70:
	;
	*(*int32)(unsafe.Add(mBase, _consts[726])) = v246
	v260 = int32(4730)
	goto L69
L72:
	;
...
L78:
	;
	v283 = F___memcpy(m, int32(4653912), v272, int32(140))
	mBase = m.M
	goto L80
L79:
	;
...
L83:
	;
	*(*int32)(unsafe.Add(mBase, _consts[648])) = v288
	v302 = int32(4730)
	goto L82
L85:
	;
...
L91:
	;
	v325 = F___memcpy(m, int32(4653772), v314, int32(140))
	mBase = m.M
	goto L93
L92:
	;
...
L96:
	;
	*(*int32)(unsafe.Add(mBase, _consts[649])) = v330
	v344 = int32(4730)
	goto L95
L98:
	;
...
L104:
	;
	v367 = F___memcpy(m, int32(4653352), v356, int32(140))
	mBase = m.M
	goto L106
L105:
	;
...
L109:
	;
	*(*int32)(unsafe.Add(mBase, _consts[650])) = v372
	v386 = int32(4730)
	goto L108
L111:
	;
...
L117:
	;
	v409 = F___memcpy(m, int32(4653632), v398, int32(140))
	mBase = m.M
	goto L119
L118:
	;
...
L122:
	;
	*(*int32)(unsafe.Add(mBase, _consts[652])) = v414
	v428 = int32(4730)
	goto L121
L123:
	;
...
L130:
	;
	v451 = F___memcpy(m, int32(4654332), v440, int32(140))
	mBase = m.M
	goto L132
L131:
	;
...
L133:
	;
	v460 = *(*int64)(unsafe.Add(mBase, _consts[788]))
...
L134:
	;
	v466 = *(*int32)(unsafe.Add(mBase, _consts[789]))
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v466
	v470 = F_pg_snprintf(m, v463, int32(1024), int32(552312), v26)
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L4
...
L135:
	...
	mBase = m.M
	v477 = *(*int32)(unsafe.Add(mBase, _consts[790]))
	v481 = *(*int32)(unsafe.Add(mBase, _consts[481]))
...
L137:
	;
	*(*int32)(unsafe.Add(mBase, _consts[791])) = v463
	v489 = *(*int32)(unsafe.Add(mBase, _consts[792]))
	if v489 != 0 {
		goto L138
	} else {
		goto L139
...
L138:
	;
	v492 = *(*int64)(unsafe.Add(mBase, _consts[788]))
...
L140:
	;
	v498 = *(*int32)(unsafe.Add(mBase, _consts[793]))
	if v498 != 0 {
		goto L142
	} else {
		goto L143
...
L141:
	;
	*(*int32)(unsafe.Add(mBase, _consts[794])) = v494
	goto L140
L142:
	;
	v501 = *(*int64)(unsafe.Add(mBase, _consts[788]))
...
L144:
	;
	v507 = *(*int32)(unsafe.Add(mBase, _consts[789]))
...
L145:
	;
	*(*int32)(unsafe.Add(mBase, _consts[795])) = v503
	goto L144
L146:
	;
	v511 = *(*int32)(unsafe.Add(mBase, _consts[790]))
...
L147:
	;
	v515 = *(*int32)(unsafe.Add(mBase, _consts[796]))
	if int32(0) < v515 {
		goto L148
	} else {
		goto L149
...
L148:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+48)) = v518
	v523 = *(*int32)(unsafe.Add(mBase, _consts[481]))
...
L151:
	...
	*(*int64)(unsafe.Add(mBase, _consts[797])) = v527 + v530 - v534
	goto L150
L152:
	;
	v543 = int32(0)
...
L153:
	;
	v552 = *(*int32)(unsafe.Add(mBase, _consts[498]))
...
L154:
	;
	v557 = *(*int32)(unsafe.Add(mBase, _consts[798]))
...
L156:
	;
	v586 = *(*int32)(unsafe.Add(mBase, _consts[498]))
...
L158:
	;
	v590 = *(*int32)(unsafe.Add(mBase, _consts[707]))
	if v590 != 0 {
		goto L159
	} else {
		goto L160
...
L161:
	;
	v754 = int32(0)
	v756 = *(*int32)(unsafe.Add(mBase, _consts[796]))
	if v756 <= v754 {
		goto L208
	} else {
		goto L209
...
L173:
	;
	v640 = *(*int32)(unsafe.Add(mBase, _consts[790]))
...
L174:
	;
	v627 = *(*int32)(unsafe.Add(mBase, _consts[789]))
...
L175:
	...
	*(*int32)(unsafe.Add(mBase, _consts[799])) = int32(1)
	v634 = *(*int32)(unsafe.Add(mBase, _consts[789]))
	v636 = *(*int32)(unsafe.Add(mBase, _consts[800]))
...
L187:
	;
	v677 = *(*int32)(unsafe.Add(mBase, _consts[801]))
	v680 = int32(0)
	v683 = *(*int32)(unsafe.Add(mBase, _consts[792]))
...
L188:
	;
	v669 = *(*int32)(unsafe.Add(mBase, _consts[790]))
...
L192:
	;
	v694 = int32(0)
	v697 = *(*int32)(unsafe.Add(mBase, _consts[793]))
...
L195:
	;
	v707 = *(*int32)(unsafe.Add(mBase, _consts[796]))
	if v707 != v572 {
		goto L196
	} else {
		goto L197
...
L198:
	;
	v738 = int32(*(*uint8)(unsafe.Add(mBase, _consts[802])))
	if v738 != 0 {
		goto L203
	} else {
		goto L204
...
L199:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+32)) = v711
	v716 = *(*int32)(unsafe.Add(mBase, _consts[481]))
...
L202:
	...
	*(*int64)(unsafe.Add(mBase, _consts[797])) = v720 + v723 - v727
	goto L201
L203:
	;
	*(*int32)(unsafe.Add(mBase, _consts[799])) = int32(1)
	v743 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[802])) = uint8(v743)
	goto L205
L204:
	;
	goto L205
...
L207:
	;
	v774 = *(*int32)(unsafe.Add(mBase, _consts[803]))
	v776 = *(*int32)(unsafe.Add(mBase, _consts[799]))
	if v776 != 0 {
		v841 = v754
		goto L213
	} else {
...
L210:
	;
	v760 = int32(0)
	v762 = int32(*(*uint8)(unsafe.Add(mBase, _consts[802])))
	if v762 != 0 {
		v771 = v760
		v772 = v584
		goto L207
...
L211:
	...
	v763 = F___time(m)
	mBase = m.M
	v765 = *(*int64)(unsafe.Add(mBase, _consts[797]))
	if v763 < v765 {
		v771 = v760
		v772 = v763
		goto L207
...
L212:
	;
	v767 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[799])) = v767
	v771 = v767
	v772 = v763
	goto L207
L213:
	;
	v843 = *(*int32)(unsafe.Add(mBase, _consts[799]))
	if v843 == int32(0) {
		goto L237
	} else {
		goto L238
...
L215:
	;
	v780 = int32(*(*uint8)(unsafe.Add(mBase, _consts[802])))
	if v780 != 0 {
		v841 = v754
		goto L213
	} else {
...
L216:
	;
	v782 = *(*int32)(unsafe.Add(mBase, _consts[804]))
...
L217:
	;
	v790 = int64(*(*int32)(unsafe.Add(mBase, _consts[803])))
...
L221:
	;
	v795 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[799])) = v795
	v798 = v795
	goto L223
L222:
	;
...
L223:
	;
	v800 = *(*int32)(unsafe.Add(mBase, _consts[792]))
	if v800 == int32(0) {
		v819 = v798
		goto L224
	} else {
...
L224:
	;
	v821 = *(*int32)(unsafe.Add(mBase, _consts[793]))
	if v821 == int32(0) {
		v841 = v819
		goto L213
	} else {
...
L226:
	;
	v810 = int64(*(*int32)(unsafe.Add(mBase, _consts[803])))
...
L232:
	;
	v831 = int64(*(*int32)(unsafe.Add(mBase, _consts[803])))
...
L237:
	;
	v906 = int32(-1)
	v908 = *(*int32)(unsafe.Add(mBase, _consts[796]))
	if v908 <= int32(0) {
		v927 = v906
		goto L258
	} else {
...
L245:
	;
	v859 = F_logfile_rotate_dest(m, v771, v851, v855, int32(1), int32(4395840), int32(4395880))
	mBase = m.M
	v860 = m.ExcPending
	if v860 != 0 {
		goto L4
...
L246:
	;
	v853 = *(*int64)(unsafe.Add(mBase, _consts[797]))
	v855 = v853
	goto L245
L247:
	;
...
L250:
	;
	v866 = F_logfile_rotate_dest(m, v771, v851, v855, int32(8), int32(4395848), int32(4395844))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		goto L4
...
L252:
	;
	v873 = F_logfile_rotate_dest(m, v771, v851, v855, int32(16), int32(4395856), int32(4395852))
	mBase = m.M
	v874 = m.ExcPending
	if v874 != 0 {
		goto L4
...
L255:
	;
	v880 = *(*int32)(unsafe.Add(mBase, _consts[796]))
	if v880 <= int32(0) {
		goto L237
	} else {
		goto L256
...
L256:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+32)) = v883
	v888 = *(*int32)(unsafe.Add(mBase, _consts[481]))
...
L257:
	...
	*(*int64)(unsafe.Add(mBase, _consts[797])) = v892 + v895 - v899
	goto L237
L258:
	;
...
L259:
	;
	v912 = int32(*(*uint8)(unsafe.Add(mBase, _consts[802])))
	if v912 != 0 {
		v927 = v906
		goto L258
	} else {
...
L260:
	;
	v913 = int64(2147483)
	v915 = *(*int64)(unsafe.Add(mBase, _consts[797]))
	v916 = v915 - v772
	if v913 <= v916 {
		goto L261
	} else {
...
L267:
	;
	v1642 = int32(*(*uint8)(unsafe.Add(mBase, _consts[805])))
	if v1642 == int32(0) {
		v562 = v1618
		v572 = v749
		v574 = v750
...
L274:
	;
	v941 = *(*int32)(unsafe.Add(mBase, _consts[798]))
...
L286:
	;
	F_errfinish(m, int32(492366), int32(527), int32(277250))
	mBase = m.M
	v970 = m.ExcPending
	if v970 != 0 {
		goto L4
...
L290:
	;
	v1489 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[805])) = uint8(v1489)
	v1497 = int32(0)
	goto L427
L291:
	;
...
L296:
	;
	F_write_stderr(m, int32(730249), int32(0))
	mBase = m.M
	v1285 = m.ExcPending
	if v1285 != 0 {
		goto L4
...
L301:
	...
	v1017 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1012&int32(112))+uint32(_consts[806]))))
	if v1017 != int32(1) {
		goto L297
	} else {
		goto L302
...
L304:
	...
	v1041 = *(*int32)(unsafe.Add(mBase, uint32(v1038)+uint32(_consts[807])))
	if v1041 != 0 {
		goto L311
	} else {
		goto L312
...
L333:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v1038)+uint32(_consts[807]))) = v1144
	v1147 = v1142
	goto L331
L334:
	;
...
L341:
	;
	v1168 = *(*int32)(unsafe.Add(mBase, _consts[792]))
	if v1168 != 0 {
		v1180 = v1168
		goto L340
	} else {
...
L343:
	;
	v1171 = *(*int32)(unsafe.Add(mBase, _consts[793]))
	v1173 = *(*int32)(unsafe.Add(mBase, _consts[804]))
	if v1171 != 0 {
		goto L345
	} else {
		goto L346
...
L358:
	;
	v1198 = *(*int32)(unsafe.Add(mBase, _consts[792]))
	if v1198 != 0 {
		v1210 = v1198
		goto L357
	} else {
...
L360:
	;
	v1201 = *(*int32)(unsafe.Add(mBase, _consts[793]))
	v1203 = *(*int32)(unsafe.Add(mBase, _consts[804]))
	if v1201 != 0 {
		goto L362
	} else {
		goto L363
...
L370:
	;
	v1255 = *(*int32)(unsafe.Add(mBase, _consts[804]))
...
L427:
	;
	v1518 = *(*int32)(unsafe.Add(mBase, uint32(v1497<<(uint(int32(2))%32))+uint32(_consts[807])))
	if v1518 == int32(0) {
		goto L429
	} else {
		goto L430
...
L434:
	...
	v1558 = *(*int32)(unsafe.Add(mBase, _consts[804]))
...
L445:
	;
	v1610 = *(*int32)(unsafe.Add(mBase, _consts[804]))
...
L454:
	;
	F_errfinish(m, int32(492366), int32(575), int32(277250))
	mBase = m.M
	v1657 = m.ExcPending
	if v1657 != 0 {
		goto L4
