			...
			if v22 != 0 {
				...
				if v29 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v35 + v36<<(uint(int32(4))%32) + l2*int32(100) - int32(76)
					F_errmsg_internal(m, int32(184483), v8)
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(499146), int32(644), int32(303742))
						mBase = m.M
						v54 = m.ExcPending
						if v54 != 0 {
							return int32(0)
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+16)) = int32(0)
	v53 = int32(1)
	v56 = F_open(m, int32(302052), v53, v26+int32(16))
	mBase = m.M
	v58 = F_close(m, v53)
	mBase = m.M
...
L26:
	;
	v115 = F___memcpy(m, int32(4681004), v104, int32(140))
	mBase = m.M
	goto L28
L27:
	;
...
L39:
	;
	v157 = F___memcpy(m, int32(4681144), v146, int32(140))
	mBase = m.M
	goto L41
L40:
	;
...
L52:
	;
	v199 = F___memcpy(m, int32(4682964), v188, int32(140))
	mBase = m.M
	goto L54
L53:
	;
...
L65:
	;
	v241 = F___memcpy(m, int32(4681284), v230, int32(140))
	mBase = m.M
	goto L67
L66:
	;
...
L78:
	;
	v283 = F___memcpy(m, int32(4682824), v272, int32(140))
	mBase = m.M
	goto L80
L79:
	;
...
L91:
	;
	v325 = F___memcpy(m, int32(4682684), v314, int32(140))
	mBase = m.M
	goto L93
L92:
	;
...
L104:
	;
	v367 = F___memcpy(m, int32(4682264), v356, int32(140))
	mBase = m.M
	goto L106
L105:
	;
...
L117:
	;
	v409 = F___memcpy(m, int32(4682544), v398, int32(140))
	mBase = m.M
	goto L119
L118:
	;
...
L130:
	;
	v451 = F___memcpy(m, int32(4683244), v440, int32(140))
	mBase = m.M
	goto L132
L131:
	;
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v466
	v470 = F_pg_snprintf(m, v463, int32(1024), int32(570572), v26)
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L4
...
L138:
	...
	v494 = F_logfile_getname(m, v492, int32(32590))
	mBase = m.M
	v495 = m.ExcPending
	if v495 != 0 {
		goto L4
...
L142:
	...
	v503 = F_logfile_getname(m, v501, int32(245332))
	mBase = m.M
	v504 = m.ExcPending
	if v504 != 0 {
		goto L4
...
L245:
	;
	v859 = F_logfile_rotate_dest(m, v771, v851, v855, int32(1), int32(4424192), int32(4424232))
	mBase = m.M
	v860 = m.ExcPending
	if v860 != 0 {
		goto L4
...
L250:
	;
	v866 = F_logfile_rotate_dest(m, v771, v851, v855, int32(8), int32(4424200), int32(4424196))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		goto L4
...
L252:
	;
	v873 = F_logfile_rotate_dest(m, v771, v851, v855, int32(16), int32(4424208), int32(4424204))
	mBase = m.M
	v874 = m.ExcPending
	if v874 != 0 {
		goto L4
...
L285:
	;
	F_errmsg(m, int32(294638), int32(0))
	mBase = m.M
	v965 = m.ExcPending
	if v965 != 0 {
		goto L4
...
L286:
	;
	F_errfinish(m, int32(495428), int32(527), int32(278753))
	mBase = m.M
	v970 = m.ExcPending
	if v970 != 0 {
		goto L4
...
L296:
	;
	F_write_stderr(m, int32(748787), int32(0))
	mBase = m.M
	v1285 = m.ExcPending
	if v1285 != 0 {
		goto L4
...
L451:
	;
	F_errmsg_internal(m, int32(244349), int32(0))
	mBase = m.M
	v1652 = m.ExcPending
	if v1652 != 0 {
		goto L4
...
L454:
	;
	F_errfinish(m, int32(495428), int32(575), int32(278753))
	mBase = m.M
	v1657 = m.ExcPending
	if v1657 != 0 {
		goto L4
