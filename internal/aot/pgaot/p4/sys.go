			...
			if v22 != 0 {
				...
				if v29 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v35 + v36<<(uint(int32(4))%32) + l2*int32(100) - int32(76)
					F_errmsg_internal(m, int32(181604), v8)
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(490624), int32(644), int32(298901))
						mBase = m.M
						v54 = m.ExcPending
						if v54 != 0 {
							return int32(0)
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+16)) = int32(0)
	v53 = int32(1)
	v56 = F_open(m, int32(297252), v53, v26+int32(16))
	mBase = m.M
	v58 = F_close(m, v53)
	mBase = m.M
...
L26:
	;
	v115 = F___memcpy(m, int32(4635612), v104, int32(140))
	mBase = m.M
	goto L28
L27:
	;
...
L39:
	;
	v157 = F___memcpy(m, int32(4635752), v146, int32(140))
	mBase = m.M
	goto L41
L40:
	;
...
L52:
	;
	v199 = F___memcpy(m, int32(4637572), v188, int32(140))
	mBase = m.M
	goto L54
L53:
	;
...
L65:
	;
	v241 = F___memcpy(m, int32(4635892), v230, int32(140))
	mBase = m.M
	goto L67
L66:
	;
...
L78:
	;
	v283 = F___memcpy(m, int32(4637432), v272, int32(140))
	mBase = m.M
	goto L80
L79:
	;
...
L91:
	;
	v325 = F___memcpy(m, int32(4637292), v314, int32(140))
	mBase = m.M
	goto L93
L92:
	;
...
L104:
	;
	v367 = F___memcpy(m, int32(4636872), v356, int32(140))
	mBase = m.M
	goto L106
L105:
	;
...
L117:
	;
	v409 = F___memcpy(m, int32(4637152), v398, int32(140))
	mBase = m.M
	goto L119
L118:
	;
...
L130:
	;
	v451 = F___memcpy(m, int32(4637852), v440, int32(140))
	mBase = m.M
	goto L132
L131:
	;
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v466
	v470 = F_pg_snprintf(m, v463, int32(1024), int32(546177), v26)
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L4
...
L159:
	...
	v559 = F_logfile_getname(m, v557, int32(241441))
	mBase = m.M
	v560 = m.ExcPending
	if v560 != 0 {
		goto L4
...
L262:
	;
	v915 = F_logfile_rotate_dest(m, v827, v907, v911, int32(1), int32(4379360), int32(4379400))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L4
...
L267:
	;
	v922 = F_logfile_rotate_dest(m, v827, v907, v911, int32(8), int32(4379368), int32(4379364))
	mBase = m.M
	v923 = m.ExcPending
	if v923 != 0 {
		goto L4
...
L269:
	;
	v929 = F_logfile_rotate_dest(m, v827, v907, v911, int32(16), int32(4379376), int32(4379372))
	mBase = m.M
	v930 = m.ExcPending
	if v930 != 0 {
		goto L4
...
L302:
	;
	F_errmsg(m, int32(289838), int32(0))
	mBase = m.M
	v1021 = m.ExcPending
	if v1021 != 0 {
		goto L4
...
L303:
	;
	F_errfinish(m, int32(487012), int32(527), int32(274390))
	mBase = m.M
	v1026 = m.ExcPending
	if v1026 != 0 {
		goto L4
...
L313:
	;
	F_write_stderr(m, int32(723138), int32(0))
	mBase = m.M
	v1341 = m.ExcPending
	if v1341 != 0 {
		goto L4
...
L468:
	;
	F_errmsg_internal(m, int32(240497), int32(0))
	mBase = m.M
	v1708 = m.ExcPending
	if v1708 != 0 {
		goto L4
...
L471:
	;
	F_errfinish(m, int32(487012), int32(575), int32(274390))
	mBase = m.M
	v1713 = m.ExcPending
	if v1713 != 0 {
		goto L4
