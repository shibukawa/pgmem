...
L26:
	;
	v115 = F___memcpy(m, int32(_a_F_SysLoggerMain_3), v104, int32(140))
	mBase = m.M
	goto L28
L27:
	;
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[6])) = v120
	v134 = int32(_a_F_SysLoggerMain_2)
	goto L30
L33:
	;
	goto L34
...
L39:
	;
	v157 = F___memcpy(m, int32(_a_F_SysLoggerMain_4), v146, int32(140))
	mBase = m.M
	goto L41
L40:
	;
...
L44:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[7])) = v162
	v176 = int32(_a_F_SysLoggerMain_2)
	goto L43
L46:
	;
	goto L47
...
L52:
	;
	v199 = F___memcpy(m, int32(_a_F_SysLoggerMain_5), v188, int32(140))
	mBase = m.M
	goto L54
L53:
	;
...
L57:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[8])) = v204
	v218 = int32(_a_F_SysLoggerMain_2)
	goto L56
L59:
	;
	goto L60
...
L65:
	;
	v241 = F___memcpy(m, int32(_a_F_SysLoggerMain_6), v230, int32(140))
	mBase = m.M
	goto L67
L66:
	;
...
L70:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[9])) = v246
	v260 = int32(_a_F_SysLoggerMain_2)
	goto L69
L72:
	;
	goto L73
...
L78:
	;
	v283 = F___memcpy(m, int32(_a_F_SysLoggerMain_7), v272, int32(140))
	mBase = m.M
	goto L80
L79:
	;
...
L83:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[10])) = v288
	v302 = int32(_a_F_SysLoggerMain_2)
	goto L82
L85:
	;
	goto L86
...
L91:
	;
	v325 = F___memcpy(m, int32(_a_F_SysLoggerMain_8), v314, int32(140))
	mBase = m.M
	goto L93
L92:
	;
...
L96:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[11])) = v330
	v344 = int32(_a_F_SysLoggerMain_2)
	goto L95
L98:
	;
	goto L99
...
L104:
	;
	v367 = F___memcpy(m, int32(_a_F_SysLoggerMain_9), v356, int32(140))
	mBase = m.M
	goto L106
L105:
	;
...
L109:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[12])) = v372
	v386 = int32(_a_F_SysLoggerMain_2)
	goto L108
L111:
	;
	goto L112
...
L117:
	;
	v409 = F___memcpy(m, int32(_a_F_SysLoggerMain_10), v398, int32(140))
	mBase = m.M
	goto L119
L118:
	;
...
L120:
	;
	F_sigprocmask(m, int32(_a_F_SysLoggerMain_11), int32(0))
	mBase = m.M
	v458 = m.ExcPending
	if v458 != 0 {
		goto L4
...
L122:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[13])) = v414
	v428 = int32(_a_F_SysLoggerMain_2)
	goto L121
L123:
	;
	goto L125
...
L130:
	;
	v451 = F___memcpy(m, int32(_a_F_SysLoggerMain_12), v440, int32(140))
	mBase = m.M
	goto L132
L131:
	;
...
L133:
	;
	v460 = *(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[14]))
...
L134:
	;
	v466 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[15]))
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v466
	v470 = F_pg_snprintf(m, v463, int32(1024), int32(_a_F_SysLoggerMain_13), v26)
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L4
...
L136:
	;
	v533 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[16]))
	v537 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[17]))
...
L154:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[18])) = v463
	v545 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[19]))
	if v545 != 0 {
		goto L155
	} else {
		goto L156
...
L155:
	;
	v548 = *(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[14]))
	v550 = F_logfile_getname(m, v548, int32(_a_F_SysLoggerMain_14))
	mBase = m.M
	v551 = m.ExcPending
	if v551 != 0 {
		goto L4
...
L157:
	;
	v554 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[20]))
	if v554 != 0 {
		goto L159
	} else {
		goto L160
...
L158:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[21])) = v550
	goto L157
L159:
	;
	v557 = *(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[14]))
	v559 = F_logfile_getname(m, v557, int32(_a_F_SysLoggerMain_15))
	mBase = m.M
	v560 = m.ExcPending
	if v560 != 0 {
		goto L4
...
L161:
	;
	v563 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[15]))
...
L162:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[22])) = v559
	goto L161
L163:
	;
	v567 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[16]))
...
L164:
	;
	v571 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[23]))
	if int32(0) < v571 {
		goto L165
	} else {
		goto L166
...
L165:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+48)) = v574
	v579 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[17]))
...
L168:
	...
	*(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[24])) = v583 + v586 - v590
	goto L167
L169:
	;
	v599 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[25])) = v599
...
L170:
	;
	v608 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[26]))
...
L171:
	;
	v613 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[27]))
...
L173:
	;
	v642 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[26]))
...
L175:
	;
	v646 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[28]))
	if v646 != 0 {
		goto L176
	} else {
		goto L177
...
L176:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[28])) = int32(0)
...
L178:
	;
	v810 = int32(0)
	v812 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[23]))
	if v812 <= v810 {
		goto L225
	} else {
		goto L226
...
L179:
	;
	v654 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[15]))
...
L190:
	;
	v696 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[16]))
...
L191:
	;
	v683 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[15]))
...
L192:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[29])) = int32(1)
	v690 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[15]))
	v692 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[30]))
...
L204:
	;
	v733 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[31]))
	v736 = int32(0)
	v739 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[19]))
...
L205:
	;
	v725 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[16]))
...
L209:
	;
	v750 = int32(0)
	v753 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[20]))
...
L212:
	;
	v763 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[23]))
	if v763 != v628 {
		goto L213
	} else {
		goto L214
...
L215:
	;
	v794 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SysLoggerMain[32])))
	if v794 != 0 {
		goto L220
	} else {
		goto L221
...
L216:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+32)) = v767
	v772 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[17]))
...
L219:
	...
	*(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[24])) = v776 + v779 - v783
	goto L218
L220:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[29])) = int32(1)
	v799 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_SysLoggerMain[32])) = uint8(v799)
	goto L222
L221:
	;
	goto L222
...
L224:
	;
	v830 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[33]))
	v832 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[29]))
	if v832 != 0 {
		v897 = v810
		goto L230
	} else {
...
L227:
	;
	v816 = int32(0)
	v818 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SysLoggerMain[32])))
	if v818 != 0 {
		v827 = v816
		v828 = v640
		goto L224
...
L228:
	...
	v819 = F___time(m)
	mBase = m.M
	v821 = *(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[24]))
	if v819 < v821 {
		v827 = v816
		v828 = v819
		goto L224
...
L229:
	;
	v823 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[29])) = v823
	v827 = v823
	v828 = v819
	goto L224
L230:
	;
	v899 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[29]))
	if v899 == int32(0) {
		goto L254
	} else {
		goto L255
...
L232:
	;
	v836 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SysLoggerMain[32])))
	if v836 != 0 {
		v897 = v810
		goto L230
	} else {
...
L233:
	;
	v838 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[34]))
...
L234:
	;
	v846 = int64(*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[33])))
...
L238:
	;
	v851 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[29])) = v851
	v854 = v851
	goto L240
L239:
	;
...
L240:
	;
	v856 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[19]))
	if v856 == int32(0) {
		v875 = v854
		goto L241
	} else {
...
L241:
	;
	v877 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[20]))
	if v877 == int32(0) {
		v897 = v875
		goto L230
	} else {
...
L243:
	;
	v866 = int64(*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[33])))
...
L249:
	;
	v887 = int64(*(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[33])))
...
L254:
	;
	v962 = int32(-1)
	v964 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[23]))
	if v964 <= int32(0) {
		v983 = v962
		goto L275
	} else {
...
L262:
	;
	v915 = F_logfile_rotate_dest(m, v827, v907, v911, int32(1), int32(_a_F_SysLoggerMain_16), int32(_a_F_SysLoggerMain_17))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L4
...
L263:
	;
	v909 = *(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[24]))
	v911 = v909
	goto L262
L264:
	;
...
L267:
	;
	v922 = F_logfile_rotate_dest(m, v827, v907, v911, int32(8), int32(_a_F_SysLoggerMain_18), int32(_a_F_SysLoggerMain_19))
	mBase = m.M
	v923 = m.ExcPending
	if v923 != 0 {
		goto L4
...
L269:
	;
	v929 = F_logfile_rotate_dest(m, v827, v907, v911, int32(16), int32(_a_F_SysLoggerMain_20), int32(_a_F_SysLoggerMain_21))
	mBase = m.M
	v930 = m.ExcPending
	if v930 != 0 {
		goto L4
...
L272:
	;
	v936 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[23]))
	if v936 <= int32(0) {
		goto L254
	} else {
		goto L273
...
L273:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+32)) = v939
	v944 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[17]))
...
L274:
	...
	*(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[24])) = v948 + v951 - v955
	goto L254
L275:
	;
...
L276:
	;
	v968 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SysLoggerMain[32])))
	if v968 != 0 {
		v983 = v962
		goto L275
	} else {
...
L277:
	;
	v969 = int64(2147483)
	v971 = *(*int64)(unsafe.Add(mBase, _c_F_SysLoggerMain[24]))
	v972 = v971 - v828
	if v969 <= v972 {
		goto L278
	} else {
...
L284:
	;
	v1698 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SysLoggerMain[35])))
	if v1698 == int32(0) {
		v618 = v1674
		v628 = v805
		v630 = v806
...
L291:
	;
	v997 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[27]))
	v1003 = F_read(m, v997, v26+int32(48)+v618, int32(_a_F_SysLoggerMain_22)-v618)
	mBase = m.M
	if v1003 < int32(0) {
		goto L292
	} else {
...
L292:
	;
	v1007 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[36]))
	if v1007 == int32(27) {
		goto L295
	} else {
		goto L296
...
L302:
	;
	F_errmsg(m, int32(_a_F_SysLoggerMain_23), int32(0))
	mBase = m.M
	v1021 = m.ExcPending
	if v1021 != 0 {
		goto L4
...
L303:
	;
	F_errfinish(m, int32(_a_F_SysLoggerMain_24), int32(527), int32(_a_F_SysLoggerMain_25))
	mBase = m.M
	v1026 = m.ExcPending
	if v1026 != 0 {
		goto L4
...
L307:
	;
	v1545 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_SysLoggerMain[35])) = uint8(v1545)
	v1553 = int32(0)
	goto L444
L308:
	;
...
L313:
	;
	F_write_stderr(m, int32(_a_F_SysLoggerMain_26), int32(0))
	mBase = m.M
	v1341 = m.ExcPending
	if v1341 != 0 {
		goto L4
...
L316:
	...
	if base.Ui32(int32(4086)) < base.Ui32((v1058-int32(1))&int32(_a_F_SysLoggerMain_27)) {
		goto L314
	} else {
		goto L317
	}
...
L318:
	...
	v1073 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v1068&int32(112))+uint32(_c_F_SysLoggerMain[37]))))
	if v1073 != int32(1) {
		goto L314
	} else {
		goto L319
...
L321:
	...
	v1097 = *(*int32)(unsafe.Add(mBase, uint32(v1094)+uint32(_c_F_SysLoggerMain[38])))
	if v1097 != 0 {
		goto L328
	} else {
		goto L329
...
L350:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v1094)+uint32(_c_F_SysLoggerMain[38]))) = v1200
	v1203 = v1198
	goto L348
L351:
	;
...
L358:
	;
	v1224 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[19]))
	if v1224 != 0 {
		v1236 = v1224
		goto L357
	} else {
...
L360:
	;
	v1227 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[20]))
	v1229 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[34]))
	if v1227 != 0 {
		goto L362
	} else {
		goto L363
...
L375:
	;
	v1254 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[19]))
	if v1254 != 0 {
		v1266 = v1254
		goto L374
	} else {
...
L377:
	;
	v1257 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[20]))
	v1259 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[34]))
	if v1257 != 0 {
		goto L379
	} else {
		goto L380
...
L387:
	;
	v1311 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[34]))
...
L444:
	;
	v1574 = *(*int32)(unsafe.Add(mBase, uint32(v1553<<(uint(int32(2))%32))+uint32(_c_F_SysLoggerMain[38])))
	if v1574 == int32(0) {
		goto L446
	} else {
		goto L447
...
L451:
	...
	v1614 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[34]))
...
L462:
	;
	v1666 = *(*int32)(unsafe.Add(mBase, _c_F_SysLoggerMain[34]))
...
L468:
	;
	F_errmsg_internal(m, int32(_a_F_SysLoggerMain_28), int32(0))
	mBase = m.M
	v1708 = m.ExcPending
	if v1708 != 0 {
		goto L4
...
L471:
	;
	F_errfinish(m, int32(_a_F_SysLoggerMain_24), int32(575), int32(_a_F_SysLoggerMain_25))
	mBase = m.M
	v1713 = m.ExcPending
	if v1713 != 0 {
		goto L4
