			...
			if v22 != 0 {
				...
				if v29 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v35 + v36<<(uint(int32(4))%32) + l2*int32(100) - int32(76)
					F_errmsg_internal(m, int32(184383), v8)
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(498912), int32(644), int32(303615))
						mBase = m.M
						v54 = m.ExcPending
						if v54 != 0 {
							return int32(0)
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+16)) = int32(0)
	v53 = int32(1)
	v56 = F_open(m, int32(301925), v53, v26+int32(16))
	mBase = m.M
	v58 = F_close(m, v53)
	mBase = m.M
...
L26:
	;
	v115 = F___memcpy(m, int32(4680732), v104, int32(140))
	mBase = m.M
	goto L28
L27:
	;
...
L39:
	;
	v157 = F___memcpy(m, int32(4680872), v146, int32(140))
	mBase = m.M
	goto L41
L40:
	;
...
L52:
	;
	v199 = F___memcpy(m, int32(4682692), v188, int32(140))
	mBase = m.M
	goto L54
L53:
	;
...
L65:
	;
	v241 = F___memcpy(m, int32(4681012), v230, int32(140))
	mBase = m.M
	goto L67
L66:
	;
...
L78:
	;
	v283 = F___memcpy(m, int32(4682552), v272, int32(140))
	mBase = m.M
	goto L80
L79:
	;
...
L91:
	;
	v325 = F___memcpy(m, int32(4682412), v314, int32(140))
	mBase = m.M
	goto L93
L92:
	;
...
L104:
	;
	v367 = F___memcpy(m, int32(4681992), v356, int32(140))
	mBase = m.M
	goto L106
L105:
	;
...
L117:
	;
	v409 = F___memcpy(m, int32(4682272), v398, int32(140))
	mBase = m.M
	goto L119
L118:
	;
...
L130:
	;
	v451 = F___memcpy(m, int32(4682972), v440, int32(140))
	mBase = m.M
	goto L132
L131:
	;
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v466
	v470 = F_pg_snprintf(m, v463, int32(1024), int32(570310), v26)
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L4
...
L142:
	...
	v503 = F_logfile_getname(m, v501, int32(245212))
	mBase = m.M
	v504 = m.ExcPending
	if v504 != 0 {
		goto L4
...
L245:
	;
	v859 = F_logfile_rotate_dest(m, v771, v851, v855, int32(1), int32(4423920), int32(4423960))
	mBase = m.M
	v860 = m.ExcPending
	if v860 != 0 {
		goto L4
...
L250:
	;
	v866 = F_logfile_rotate_dest(m, v771, v851, v855, int32(8), int32(4423928), int32(4423924))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		goto L4
...
L252:
	;
	v873 = F_logfile_rotate_dest(m, v771, v851, v855, int32(16), int32(4423936), int32(4423932))
	mBase = m.M
	v874 = m.ExcPending
	if v874 != 0 {
		goto L4
...
L285:
	;
	F_errmsg(m, int32(294511), int32(0))
	mBase = m.M
	v965 = m.ExcPending
	if v965 != 0 {
		goto L4
...
L286:
	;
	F_errfinish(m, int32(495206), int32(527), int32(278633))
	mBase = m.M
	v970 = m.ExcPending
	if v970 != 0 {
		goto L4
...
L296:
	;
	F_write_stderr(m, int32(748454), int32(0))
	mBase = m.M
	v1285 = m.ExcPending
	if v1285 != 0 {
		goto L4
...
L451:
	;
	F_errmsg_internal(m, int32(244229), int32(0))
	mBase = m.M
	v1652 = m.ExcPending
	if v1652 != 0 {
		goto L4
...
L454:
	;
	F_errfinish(m, int32(495206), int32(575), int32(278633))
	mBase = m.M
	v1657 = m.ExcPending
	if v1657 != 0 {
		goto L4
