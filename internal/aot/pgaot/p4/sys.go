...
func F_SearchSysCacheCopyAttName(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v22
	v3 = int32(0)
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1382]))
	...
	if v15 != 0 {
		...
		if v16 == int32(1) {
			...
			if v22 != 0 {
				...
				v27 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(5))%32))+uint32(_consts[1383])))
				...
				if v29 != 0 {
					...
					v34 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1384])))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v35 + v36<<(uint(int32(4))%32) + l2*int32(100) - int32(76)
					F_errmsg_internal(m, int32(172587), v8)
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(468530), int32(644), int32(285182))
						mBase = m.M
						v54 = m.ExcPending
						if v54 != 0 {
							return int32(0)
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+16)) = int32(0)
	v53 = int32(1)
	v56 = F_open(m, int32(283581), v53, v26+int32(16))
	mBase = m.M
	v58 = F_close(m, v53)
	mBase = m.M
...
L26:
	;
	v115 = F___memcpy(m, int32(4519580), v104, int32(140))
	mBase = m.M
	goto L28
L27:
	;
...
L39:
	;
	v157 = F___memcpy(m, int32(4519720), v146, int32(140))
	mBase = m.M
	goto L41
L40:
	;
...
L52:
	;
	v199 = F___memcpy(m, int32(4521540), v188, int32(140))
	mBase = m.M
	goto L54
L53:
	;
...
L65:
	;
	v241 = F___memcpy(m, int32(4519860), v230, int32(140))
	mBase = m.M
	goto L67
L66:
	;
...
L78:
	;
	v283 = F___memcpy(m, int32(4521400), v272, int32(140))
	mBase = m.M
	goto L80
L79:
	;
...
L91:
	;
	v325 = F___memcpy(m, int32(4521260), v314, int32(140))
	mBase = m.M
	goto L93
L92:
	;
...
L104:
	;
	v367 = F___memcpy(m, int32(4520840), v356, int32(140))
	mBase = m.M
	goto L106
L105:
	;
...
L117:
	;
	v409 = F___memcpy(m, int32(4521120), v398, int32(140))
	mBase = m.M
	goto L119
L118:
	;
...
L130:
	;
	v451 = F___memcpy(m, int32(4521820), v440, int32(140))
	mBase = m.M
	goto L132
L131:
	;
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26))) = v466
	v470 = F_pg_snprintf(m, v463, int32(1024), int32(522299), v26)
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L4
...
L155:
	...
	v550 = F_logfile_getname(m, v548, int32(29852))
	mBase = m.M
	v551 = m.ExcPending
	if v551 != 0 {
		goto L4
...
L159:
	...
	v559 = F_logfile_getname(m, v557, int32(229911))
	mBase = m.M
	v560 = m.ExcPending
	if v560 != 0 {
		goto L4
...
L262:
	;
	v915 = F_logfile_rotate_dest(m, v827, v907, v911, int32(1), int32(4334080), int32(4334120))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L4
...
L267:
	;
	v922 = F_logfile_rotate_dest(m, v827, v907, v911, int32(8), int32(4334088), int32(4334084))
	mBase = m.M
	v923 = m.ExcPending
	if v923 != 0 {
		goto L4
...
L269:
	;
	v929 = F_logfile_rotate_dest(m, v827, v907, v911, int32(16), int32(4334096), int32(4334092))
	mBase = m.M
	v930 = m.ExcPending
	if v930 != 0 {
		goto L4
...
L302:
	;
	F_errmsg(m, int32(276565), int32(0))
	mBase = m.M
	v1021 = m.ExcPending
	if v1021 != 0 {
		goto L4
...
L303:
	;
	F_errfinish(m, int32(465107), int32(527), int32(262034))
	mBase = m.M
	v1026 = m.ExcPending
	if v1026 != 0 {
		goto L4
...
L313:
	;
	F_write_stderr(m, int32(698065), int32(0))
	mBase = m.M
	v1341 = m.ExcPending
	if v1341 != 0 {
		goto L4
...
L468:
	;
	F_errmsg_internal(m, int32(229166), int32(0))
	mBase = m.M
	v1708 = m.ExcPending
	if v1708 != 0 {
		goto L4
...
L471:
	;
	F_errfinish(m, int32(465107), int32(575), int32(262034))
	mBase = m.M
	v1713 = m.ExcPending
	if v1713 != 0 {
		goto L4
