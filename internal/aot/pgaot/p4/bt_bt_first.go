...
L26:
	...
	v433 = v374 + v432
	v435 = v372 + v432
	if (v322+v331-v323)&int32(_a_F__bt_first_0) != v435&int32(_a_F__bt_first_0) {
		v372 = v435
		v374 = v433
		goto L22
	} else {
...
L44:
	;
	v612 = int32(_a_F__bt_first_1)
	v613 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[0]))
	*(*int32)(unsafe.Add(mBase, _c_F__bt_first[0])) = v611
...
L45:
	;
	v600 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[0]))
	v605 = F_AllocSetContextCreateInternal(m, v600, int32(_a_F__bt_first_2), int32(0), int32(1024), int32(_a_F__bt_first_3))
	mBase = m.M
	v606 = m.ExcPending
	if v606 != 0 {
		goto L24
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, _c_F__bt_first[0])) = v613
...
L73:
	;
	v764 = int32(0)
	F_ScanKeyEntryInitialize(m, v698, int32(_a_F__bt_first_4), v736, int32(3), v764, v753, v760, v764)
	mBase = m.M
	v770 = m.ExcPending
	if v770 != 0 {
		goto L24
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v53))) = v1086
	F_errmsg_internal(m, int32(_a_F__bt_first_5), v53)
	mBase = m.M
	v1090 = m.ExcPending
	if v1090 != 0 {
		goto L24
...
L164:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v53)+16)) = v746
	F_errmsg_internal(m, int32(_a_F__bt_first_8), v53+int32(16))
	mBase = m.M
	v1475 = m.ExcPending
	if v1475 != 0 {
		goto L24
...
L245:
	...
	if v2022 == v1884&int32(_a_F__bt_first_0) {
		v2414 = v1881
		v2415 = v1882
		v2417 = v1884
		v2418 = v1885
...
L392:
	;
	if v2604&int32(_a_F__bt_first_11) != int32(_a_F__bt_first_12) {
		v3022 = v2563
		goto L390
	} else {
		goto L395
...
L457:
	;
	v2869 = int32(_a_F__bt_first_1)
	v2870 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[0]))
	v2872 = *(*int32)(unsafe.Add(mBase, uint32(l0)+36))
	v2873 = *(*int32)(unsafe.Add(mBase, uint32(v2872)+28))
	*(*int32)(unsafe.Add(mBase, _c_F__bt_first[0])) = v2873
...
L477:
	;
	*(*int32)(unsafe.Add(mBase, _c_F__bt_first[0])) = v2870
	goto L406
L478:
	;
...
L501:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2545))) = v3115
	F_errmsg_internal(m, int32(_a_F__bt_first_13), v2545)
	mBase = m.M
	v3121 = m.ExcPending
	if v3121 != 0 {
		goto L24
...
L510:
	...
	if v3291 == v3250&int32(_a_F__bt_first_0) {
		goto L515
	} else {
		goto L516
	}
...
L521:
	...
	v3496 = int32(1)
	v3497 = int32(0)
	if (base.B2i32(v3303&int32(_a_F__bt_first_12) == v3497)|v3302)&v3496 == v3497 {
		goto L548
	} else {
		goto L549
	}
...
L550:
	;
	v3507 = int32(0)
	if (v3299|base.B2i32(v3303&int32(_a_F__bt_first_16) == v3507))&int32(1) != 0 {
		v3516 = v3299
		v3518 = v3302
		v3519 = v3298
		v3521 = v3300
...
L660:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45+int32(1600)+v4376<<(uint(int32(2))%32)))) = v4561
	...
	if v4586&int32(_a_F__bt_first_17) == v4584 {
		v4712 = v4586
		v4734 = v4585
		goto L652
	} else {
...
L725:
	;
	switch v4712&int32(_a_F__bt_first_0) - int32(2) {
	case 0:
		goto L717
	default:
		v4983 = v4850
...
L727:
	;
	switch v4712&int32(_a_F__bt_first_0) - int32(1) {
	case 0:
		goto L715
	default:
		v4983 = v4850
...
L728:
	;
	if v4865&int32(_a_F__bt_first_15) != 0 {
		goto L729
	} else {
		goto L730
	}
...
L739:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4912))) = v4913
	v4928 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[0]))
...
L745:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v45)+1730)) = uint8(v5005)
	v5010 = v4712 & int32(_a_F__bt_first_0)
...
L751:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45)+16)) = v5010
	F_errmsg_internal(m, int32(_a_F__bt_first_18), v45+int32(16))
	mBase = m.M
	v5254 = m.ExcPending
	if v5254 != 0 {
		goto L24
...
L756:
	;
	v5318 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[1]))
	if v5318 != int32(3) {
		goto L618
	} else {
		goto L759
...
L764:
	;
	v5493 = F__bt_readfirstpage(m, l0, v5451&int32(_a_F__bt_first_0), l1)
	mBase = m.M
	v5494 = m.ExcPending
	if v5494 != 0 {
		goto L24
...
L766:
	;
	v5340 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[2]))
...
L768:
	;
	v5348 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[3]))
	v5354 = v5348 + v5335<<(uint(int32(13))%32) + int32(-8192)
	goto L765
L769:
	;
	v5363 = int32(base.Ui32(v5355+int32(_a_F__bt_first_21)) >> (uint(int32(2)) % 32))
	goto L771
L770:
	;
	v5363 = int32(0)
...
L774:
	;
	if base.Ui32(v5363&int32(_a_F__bt_first_0)) < base.Ui32(v5371) {
		v5451 = v5371
		goto L764
	} else {
		goto L775
...
L776:
	;
	v5425 = int32(base.Ui32((v5381-v5380)&int32(_a_F__bt_first_22))>>(uint(int32(1))%32)) + v5380
	v5430 = F__bt_compare(m, v47, v45+int32(1728), v5354, v5425&int32(_a_F__bt_first_0))
	mBase = m.M
	v5431 = m.ExcPending
	if v5431 != 0 {
		goto L24
...
L784:
	;
	if base.Ui32(v5438&int32(_a_F__bt_first_0)) < base.Ui32(v5433&int32(_a_F__bt_first_0)) {
		v5380 = v5438
		v5381 = v5433
		goto L776
	} else {
...
L792:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45)+32)) = int32(1)
	F_errmsg_internal(m, int32(_a_F__bt_first_23), v45+int32(32))
	mBase = m.M
	v5540 = m.ExcPending
	if v5540 != 0 {
		goto L24
...
L802:
	;
	v5607 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[2]))
...
L804:
	;
	v5615 = *(*int32)(unsafe.Add(mBase, _c_F__bt_first[3]))
...
L806:
	;
	v5645 = F__bt_readfirstpage(m, l0, v5642&int32(_a_F__bt_first_0), l1)
	mBase = m.M
	v5646 = m.ExcPending
	if v5646 != 0 {
		goto L24
...
L814:
	;
	v5640 = int32(base.Ui32(v5632+int32(_a_F__bt_first_21)) >> (uint(int32(2)) % 32))
	goto L816
L815:
	;
	v5640 = int32(0)
...
L820:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45))) = l1
	F_errmsg_internal(m, int32(_a_F__bt_first_24), v45)
	mBase = m.M
	v5675 = m.ExcPending
	if v5675 != 0 {
		goto L24
...
L821:
	;
	F_errfinish(m, int32(_a_F__bt_first_19), int32(2744), int32(_a_F__bt_first_25))
	mBase = m.M
	v5680 = m.ExcPending
	if v5680 != 0 {
		goto L24
