...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = int32(111318)
	F_errmsg_internal(m, int32(697206), v12-int32(-64))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L9:
	;
	F_errfinish(m, int32(490323), int32(1587), int32(383840))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(490323), int32(1598), int32(383840))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L71:
	;
	F_errfinish(m, int32(490323), int32(1667), int32(383840))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L1
...
L111:
	;
	F_errfinish(m, int32(490323), int32(1719), int32(383840))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(490323), int32(1728), int32(383840))
	mBase = m.M
	v417 = m.ExcPending
	if v417 != 0 {
		goto L1
...
func F_pgstat_progress_parallel_incr_param(m *base.Module, l0 int32, l1 int64) {
	...
	if int32(0) <= v5 {
		F_initStringInfo(m, int32(4410756))
		mBase = m.M
		v10 = m.ExcPending
		if v10 != 0 {
			return
		} else {
			F_pq_beginmessage(m, int32(4410756), int32(80))
			mBase = m.M
			v14 = m.ExcPending
			if v14 != 0 {
				return
			} else {
				F_enlargeStringInfo(m, int32(4410756), int32(4))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return
