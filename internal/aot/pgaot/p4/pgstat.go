...
L4:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v18)+8)) = uint8(v19)
	v22 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1229])) = v22
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = int32(112280)
	F_errmsg_internal(m, int32(717147), v12-int32(-64))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L8:
	;
	v42 = F_AllocateFile(m, int32(235948), int32(32824))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L1
...
L9:
	;
	F_errfinish(m, int32(494621), int32(1587), int32(387179))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L17:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(235948)
	F_errmsg(m, int32(298631), v12)
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(494621), int32(1598), int32(387179))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L22:
	;
	v196 = v12 + int32(144)
	v198 = *(*int32)(unsafe.Add(mBase, _consts[1230]))
	v199 = int32(0)
	v200 = int64(0)
...
L25:
	;
	v107 = v75*int32(72) + int32(1655136)
	goto L26
L26:
	;
	if v107 == int32(0) {
...
L32:
	;
	v147 = v143 + v144
	v149 = *(*int32)(unsafe.Add(mBase, _consts[1229]))
	if v149 == int32(0) {
		goto L40
	} else {
		goto L41
...
L33:
	...
	v143 = v75
	v144 = int32(4444192)
	v146 = v75*int32(72) + int32(1655136)
	goto L32
L34:
	;
	goto L35
...
L48:
	;
	v169 = *(*int32)(unsafe.Add(mBase, uint32(v75<<(uint(int32(2))%32))+uint32(_consts[1231])))
	v170 = v169
	goto L45
L49:
	;
...
L66:
	;
	v256 = *(*int32)(unsafe.Add(mBase, _consts[1232]))
...
L70:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+48)) = v241
	F_errmsg_internal(m, int32(38100), v12+int32(48))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L1
...
L71:
	;
	F_errfinish(m, int32(494621), int32(1667), int32(387179))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L1
...
L75:
	;
	v277 = v260*int32(72) + int32(1655136)
	goto L74
L76:
	;
	goto L77
...
L90:
	;
	v316 = v310 * int32(72)
	v331 = v316 + int32(1655136)
	v333 = v316 + int32(1655152)
	goto L89
L91:
	;
	goto L92
...
L110:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = int32(235948)
	F_errmsg(m, int32(298681), v12+int32(32))
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L1
...
L111:
	;
	F_errfinish(m, int32(494621), int32(1719), int32(387179))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L1
...
L117:
	;
	v423 = F_durable_rename(m, int32(235948), int32(112280), int32(15))
	mBase = m.M
	v424 = m.ExcPending
	if v424 != 0 {
		goto L1
...
L121:
	;
	v419 = F_unlink(m, int32(235948))
	mBase = m.M
	goto L3
L122:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = int32(235948)
	F_errmsg(m, int32(298732), v12+int32(16))
	mBase = m.M
	v412 = m.ExcPending
	if v412 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(494621), int32(1728), int32(387179))
	mBase = m.M
	v417 = m.ExcPending
	if v417 != 0 {
		goto L1
	...
	if l3 != int64(0) {
		...
		if l0 == int32(2) {
			...
			if l2&int32(-3) == int32(5) {
				v30 = int32(4500000)
				v32 = *(*int64)(unsafe.Add(mBase, _consts[1245]))
				v34 = base.I64_div_s(v23, int64(1000))
				*(*int64)(unsafe.Add(mBase, _consts[1245])) = v32 + v34
				switch l0 {
				case 0:
					v37 = int32(4418624)
				...
				if l2 != int32(6) {
					...
					v49 = int32(4499992)
					v51 = *(*int64)(unsafe.Add(mBase, _consts[1246]))
					v53 = base.I64_div_s(v23, int64(1000))
					*(*int64)(unsafe.Add(mBase, _consts[1246])) = v51 + v53
					switch l0 {
					case 0:
						v56 = int32(4418616)
		...
		v76 = *(*int64)(unsafe.Add(mBase, uint32(v73)+uint32(_consts[1247])))
		*(*int64)(unsafe.Add(mBase, uint32(v73)+uint32(_consts[1247]))) = v76 + v23
		...
		if base.Ui32(int32(16)) < base.Ui32(v80) {
			...
			if int32(1)<<(uint(v80)%32)&int32(115186) == int32(0) {
				...
				v99 = *(*int64)(unsafe.Add(mBase, uint32(v96)+uint32(_consts[1248])))
				*(*int64)(unsafe.Add(mBase, uint32(v96)+uint32(_consts[1248]))) = v99 + v23
				v103 = int32(1)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v118)+uint32(_consts[922]))) = v127 + l5
	...
	if base.Ui32(int32(16)) < base.Ui32(v132) {
		...
		if int32(1)<<(uint(v132)%32)&int32(115186) == int32(0) {
			...
			v151 = *(*int64)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1249])))
			*(*int64)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1249]))) = v151 + base.I64_extend_i32_u(l4)
			v157 = *(*int64)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1250])))
			*(*int64)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1250]))) = v157 + l5
			v161 = int32(1)
...
func F_pgstat_get_wait_event_type(m *base.Module, l0 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if base.Ui32(int32(184549375)) < base.Ui32(v7) {
			...
			v18 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(v7)>>(uint(int32(22))%32))&int32(1020))+uint32(_consts[1256])))
			return v18
		}
	}
}
...
func F_pgstat_prep_pending_entry(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) int32 {
	...
	var v62 int32
	_ = v62
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1244]))
	if v6 == int32(0) {
		v11 = *(*int32)(unsafe.Add(mBase, _consts[36]))
		v16 = F_AllocSetContextCreateInternal(m, v11, int32(337441), int32(0), int32(1024), int32(8192))
		mBase = m.M
		v19 = m.ExcPending
		if v19 != 0 {
			return int32(0)
		} else {
			*(*int32)(unsafe.Add(mBase, _consts[1244])) = v16
			...
			if v23 != 0 {
				...
				if v24 == int32(0) {
					v28 = *(*int32)(unsafe.Add(mBase, _consts[1244]))
					if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
						v45 = l0*int32(72) + int32(1655136)
					} else {
					...
					if v48 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v22)+12)) = v47
						v51 = v22 + int32(16)
						v53 = *(*int32)(unsafe.Add(mBase, _consts[1233]))
						if v53 != 0 {
							v55 = *(*int32)(unsafe.Add(mBase, _consts[1234]))
							v60 = v55
						} else {
							v57 = int32(4126752)
							*(*int32)(unsafe.Add(mBase, _consts[1233])) = v57
							v60 = v57
						}
						...
						*(*int32)(unsafe.Add(mBase, _consts[1234])) = v51
						return v22
					}
				} else {
					return v22
...
func F_pgstat_prep_snapshot(m *base.Module) {
	...
	var v66 int32
	_ = v66
	v4 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1236])))
	if v4 != 0 {
		v6 = int64(0)
		...
		*(*int64)(unsafe.Add(mBase, _consts[1239])) = v6
		v15 = int32(0)
		*(*uint8)(unsafe.Add(mBase, _consts[1240])) = uint8(v15)
		*(*int32)(unsafe.Add(mBase, _consts[1241])) = v15
		*(*int32)(unsafe.Add(mBase, _consts[1242])) = v15
		v24 = *(*int32)(unsafe.Add(mBase, _consts[1243]))
		if v24 != 0 {
			...
			if v26 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[1243])) = int32(0)
				...
				if v31 != 0 {
					...
					v33 = int32(0)
					*(*uint8)(unsafe.Add(mBase, _consts[1236])) = uint8(v33)
					v37 = *(*int32)(unsafe.Add(mBase, _consts[1229]))
					if v37 == int32(0) {
						return
					} else {
						v41 = *(*int32)(unsafe.Add(mBase, _consts[1241]))
						if v41 != 0 {
							return
						} else {
							v43 = *(*int32)(unsafe.Add(mBase, _consts[1243]))
							if v43 == int32(0) {
								v48 = *(*int32)(unsafe.Add(mBase, _consts[36]))
								v53 = F_AllocSetContextCreateInternal(m, v48, int32(87536), int32(0), int32(1024), int32(8192))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return
								} else {
									*(*int32)(unsafe.Add(mBase, _consts[1243])) = v53
									v56 = v53
									...
									if v59 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v58)+24)) = v56
										...
										if v66 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, _consts[1241])) = v58
											return
										}
									}
								}
...
func F_pgstat_progress_parallel_incr_param(m *base.Module, l0 int32, l1 int64) {
	...
	if int32(0) <= v5 {
		F_initStringInfo(m, int32(4444100))
		mBase = m.M
		v10 = m.ExcPending
		if v10 != 0 {
			return
		} else {
			F_pq_beginmessage(m, int32(4444100), int32(80))
			mBase = m.M
			v14 = m.ExcPending
			if v14 != 0 {
				return
			} else {
				F_enlargeStringInfo(m, int32(4444100), int32(4))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return
					...
					v19 = int32(4444100)
					v20 = *(*int32)(unsafe.Add(mBase, _consts[1227]))
					v21 = int32(4444104)
					v22 = *(*int32)(unsafe.Add(mBase, _consts[1228]))
					v24 = int32(24)
					v26 = int32(65280)
					v28 = int32(8)
					*(*int32)(unsafe.Add(mBase, uint32(v20+v22))) = l0<<(uint(v24)%32) | l0&v26<<(uint(v28)%32) | (int32(base.Ui32(l0)>>(uint(v28)%32))&v26 | int32(base.Ui32(l0)>>(uint(v24)%32)))
					v42 = *(*int32)(unsafe.Add(mBase, _consts[1228]))
					*(*int32)(unsafe.Add(mBase, _consts[1228])) = v42 + int32(4)
					...
					if v49 != 0 {
						...
						v50 = int32(4444100)
						v51 = *(*int32)(unsafe.Add(mBase, _consts[1227]))
						v52 = int32(4444104)
						v53 = *(*int32)(unsafe.Add(mBase, _consts[1228]))
						v55 = int64(56)
						v57 = int64(65280)
						v59 = int64(40)
						v62 = int64(16711680)
						...
						*(*int64)(unsafe.Add(mBase, uint32(v51+v53))) = l1<<(uint(v55)%64) | l1&v57<<(uint(v59)%64) | (l1&v62<<(uint(v64)%64) | l1&v66<<(uint(v68)%64)) | (int64(base.Ui64(l1)>>(uint(v68)%64))&v66 | int64(base.Ui64(l1)>>(uint(v64)%64))&v62 | (int64(base.Ui64(l1)>>(uint(v59)%64))&v57 | int64(base.Ui64(l1)>>(uint(v55)%64))))
						v93 = *(*int32)(unsafe.Add(mBase, _consts[1228]))
						*(*int32)(unsafe.Add(mBase, _consts[1228])) = v93 + int32(8)
		...
		if v9 == int32(0) {
			...
			if v14 != 0 {
				...
				if v20 != 0 {
					...
					if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
						v111 = l0*int32(72) + int32(1655136)
					} else {
						if base.Ui32(int32(8)) < base.Ui32(l0-int32(24)) {
							v109 = int32(0)
						} else {
...
L7:
	;
	v26 = *(*int32)(unsafe.Add(mBase, _consts[1222]))
	v27 = int32(2)
	v28 = v26 - v27
...
L13:
	...
	v69 = v67 - int32(16)
	m.G0 = v69
	v72 = *(*int32)(unsafe.Add(mBase, _consts[1235]))
	if v72 != 0 {
		goto L15
	} else {
		goto L16
...
L17:
	;
	v189 = *(*int32)(unsafe.Add(mBase, _consts[1230]))
	F_pfree(m, v189)
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
...
L35:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1230])) = int32(0)
	v196 = *(*int32)(unsafe.Add(mBase, _consts[1232]))
	F_dsa_detach(m, v196)
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
...
func F_pgstat_wal_reset_all_cb(m *base.Module, l0 int64) {
	...
	if v10 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v5)+uint32(_consts[1255]))) = l0
