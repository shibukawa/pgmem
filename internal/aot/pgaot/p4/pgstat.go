...
L4:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[747]))
	v19 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v18)+8)) = uint8(v19)
	v22 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1220])) = v22
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = int32(111318)
	F_errmsg_internal(m, int32(697256), v12-int32(-64))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L8:
	;
	v42 = F_AllocateFile(m, int32(234239), int32(32454))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L1
...
L9:
	;
	F_errfinish(m, int32(490373), int32(1587), int32(383840))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L17:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(234239)
	F_errmsg(m, int32(296160), v12)
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(490373), int32(1598), int32(383840))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L22:
	;
	v196 = v12 + int32(144)
	v198 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
	v199 = int32(0)
	v200 = int64(0)
...
L27:
	;
	v93 = *(*int32)(unsafe.Add(mBase, _consts[1143]))
	if v93 == int32(0) {
		v185 = v75
		goto L23
	} else {
...
L32:
	;
	v147 = v143 + v144
	v149 = *(*int32)(unsafe.Add(mBase, _consts[1220]))
	if v149 == int32(0) {
		goto L40
	} else {
		goto L41
...
L36:
	;
	v132 = int32(0)
	v134 = *(*int32)(unsafe.Add(mBase, _consts[1143]))
	if v134 == v132 {
		v143 = v129
		v144 = v126
		v146 = v132
...
L48:
	;
	v169 = *(*int32)(unsafe.Add(mBase, uint32(v75<<(uint(int32(2))%32))+uint32(_consts[1222])))
	v170 = v169
	goto L45
L49:
	;
...
L66:
	;
	v256 = *(*int32)(unsafe.Add(mBase, _consts[1223]))
...
L70:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+48)) = v241
	F_errmsg_internal(m, int32(37730), v12+int32(48))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L1
...
L71:
	;
	F_errfinish(m, int32(490373), int32(1667), int32(383840))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L1
...
L77:
	;
	v270 = *(*int32)(unsafe.Add(mBase, _consts[1143]))
...
L92:
	;
	v322 = *(*int32)(unsafe.Add(mBase, _consts[1143]))
...
L110:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = int32(234239)
	F_errmsg(m, int32(296210), v12+int32(32))
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L1
...
L111:
	;
	F_errfinish(m, int32(490373), int32(1719), int32(383840))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L1
...
L117:
	;
	v423 = F_durable_rename(m, int32(234239), int32(111318), int32(15))
	mBase = m.M
	v424 = m.ExcPending
	if v424 != 0 {
		goto L1
...
L121:
	;
	v419 = F_unlink(m, int32(234239))
	mBase = m.M
	goto L3
L122:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = int32(234239)
	F_errmsg(m, int32(296261), v12+int32(16))
	mBase = m.M
	v412 = m.ExcPending
	if v412 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(490373), int32(1728), int32(383840))
	mBase = m.M
	v417 = m.ExcPending
	if v417 != 0 {
		goto L1
...
func F_pgstat_bgwriter_reset_all_cb(m *base.Module, l0 int64) {
	...
	var v43 int32
	_ = v43
	v8 = *(*int32)(unsafe.Add(mBase, _consts[747]))
	v10 = v8 + int32(320)
...
func F_pgstat_clip_activity(m *base.Module, l0 int32) int32 {
	...
	var v18 int32
	_ = v18
	v3 = *(*int32)(unsafe.Add(mBase, _consts[774]))
	...
	if v9 != 0 {
		...
		v10 = F_strlen(m, v6)
		mBase = m.M
		v12 = *(*int32)(unsafe.Add(mBase, _consts[774]))
	...
	if l3 != int64(0) {
		...
		if l0 == int32(2) {
			...
			if l2&int32(-3) == int32(5) {
				v30 = int32(4466768)
				v32 = *(*int64)(unsafe.Add(mBase, _consts[1236]))
				v34 = base.I64_div_s(v23, int64(1000))
				*(*int64)(unsafe.Add(mBase, _consts[1236])) = v32 + v34
				switch l0 {
				case 0:
					v37 = int32(4385392)
				...
				if l2 != int32(6) {
					...
					v49 = int32(4466760)
					v51 = *(*int64)(unsafe.Add(mBase, _consts[1237]))
					v53 = base.I64_div_s(v23, int64(1000))
					*(*int64)(unsafe.Add(mBase, _consts[1237])) = v51 + v53
					switch l0 {
					case 0:
						v56 = int32(4385384)
		...
		v76 = *(*int64)(unsafe.Add(mBase, uint32(v73)+uint32(_consts[1238])))
		*(*int64)(unsafe.Add(mBase, uint32(v73)+uint32(_consts[1238]))) = v76 + v23
		...
		if base.Ui32(int32(16)) < base.Ui32(v80) {
			...
			if int32(1)<<(uint(v80)%32)&int32(115186) == int32(0) {
				...
				v99 = *(*int64)(unsafe.Add(mBase, uint32(v96)+uint32(_consts[1239])))
				*(*int64)(unsafe.Add(mBase, uint32(v96)+uint32(_consts[1239]))) = v99 + v23
				v103 = int32(1)
				*(*uint8)(unsafe.Add(mBase, _consts[145])) = uint8(v103)
				*(*uint8)(unsafe.Add(mBase, _consts[878])) = uint8(v103)
			}
		}
	} else {
	}
	v118 = l0*int32(320) + l1<<(uint(int32(6))%32) + l2<<(uint(int32(3))%32)
	v121 = *(*int64)(unsafe.Add(mBase, uint32(v118)+uint32(_consts[912])))
	*(*int64)(unsafe.Add(mBase, uint32(v118)+uint32(_consts[912]))) = v121 + base.I64_extend_i32_u(l4)
	v127 = *(*int64)(unsafe.Add(mBase, uint32(v118)+uint32(_consts[913])))
	*(*int64)(unsafe.Add(mBase, uint32(v118)+uint32(_consts[913]))) = v127 + l5
	...
	if base.Ui32(int32(16)) < base.Ui32(v132) {
		...
		if int32(1)<<(uint(v132)%32)&int32(115186) == int32(0) {
			...
			v151 = *(*int64)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1240])))
			*(*int64)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1240]))) = v151 + base.I64_extend_i32_u(l4)
			v157 = *(*int64)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1241])))
			*(*int64)(unsafe.Add(mBase, uint32(v148)+uint32(_consts[1241]))) = v157 + l5
			v161 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _consts[145])) = uint8(v161)
			*(*uint8)(unsafe.Add(mBase, _consts[878])) = uint8(v161)
		}
	}
	v169 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[145])) = uint8(v169)
	*(*uint8)(unsafe.Add(mBase, _consts[875])) = uint8(v169)
	m.G0 = v12 + int32(16)
	return
}
...
func F_pgstat_get_wait_event_type(m *base.Module, l0 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if base.Ui32(int32(184549375)) < base.Ui32(v7) {
			...
			v18 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(v7)>>(uint(int32(22))%32))&int32(1020))+uint32(_consts[1247])))
			return v18
		}
	}
}
...
func F_pgstat_prep_pending_entry(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) int32 {
	...
	var v62 int32
	_ = v62
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1235]))
	if v6 == int32(0) {
		v11 = *(*int32)(unsafe.Add(mBase, _consts[36]))
		v16 = F_AllocSetContextCreateInternal(m, v11, int32(334717), int32(0), int32(1024), int32(8192))
		mBase = m.M
		v19 = m.ExcPending
		if v19 != 0 {
			return int32(0)
		} else {
			*(*int32)(unsafe.Add(mBase, _consts[1235])) = v16
			...
			if v23 != 0 {
				...
				if v24 == int32(0) {
					v28 = *(*int32)(unsafe.Add(mBase, _consts[1235]))
					if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
						v45 = l0*int32(72) + int32(1634656)
					} else {
						v38 = *(*int32)(unsafe.Add(mBase, _consts[1143]))
					...
					if v48 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v22)+12)) = v47
						v51 = v22 + int32(16)
						v53 = *(*int32)(unsafe.Add(mBase, _consts[1224]))
						if v53 != 0 {
							v55 = *(*int32)(unsafe.Add(mBase, _consts[1225]))
							v60 = v55
						} else {
							v57 = int32(4102560)
							*(*int32)(unsafe.Add(mBase, _consts[1224])) = v57
							v60 = v57
						}
						...
						*(*int32)(unsafe.Add(mBase, _consts[1225])) = v51
						return v22
					}
				} else {
					return v22
...
func F_pgstat_prep_snapshot(m *base.Module) {
	...
	var v66 int32
	_ = v66
	v4 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1227])))
	if v4 != 0 {
		v6 = int64(0)
		*(*int64)(unsafe.Add(mBase, _consts[1228])) = v6
		*(*int64)(unsafe.Add(mBase, _consts[1229])) = v6
		*(*int64)(unsafe.Add(mBase, _consts[1230])) = v6
		v15 = int32(0)
		*(*uint8)(unsafe.Add(mBase, _consts[1231])) = uint8(v15)
		*(*int32)(unsafe.Add(mBase, _consts[1232])) = v15
		*(*int32)(unsafe.Add(mBase, _consts[1233])) = v15
		v24 = *(*int32)(unsafe.Add(mBase, _consts[1234]))
		if v24 != 0 {
			...
			if v26 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[1234])) = int32(0)
				...
				if v31 != 0 {
					...
					v33 = int32(0)
					*(*uint8)(unsafe.Add(mBase, _consts[1227])) = uint8(v33)
					v37 = *(*int32)(unsafe.Add(mBase, _consts[1220]))
					if v37 == int32(0) {
						return
					} else {
						v41 = *(*int32)(unsafe.Add(mBase, _consts[1232]))
						if v41 != 0 {
							return
						} else {
							v43 = *(*int32)(unsafe.Add(mBase, _consts[1234]))
							if v43 == int32(0) {
								v48 = *(*int32)(unsafe.Add(mBase, _consts[36]))
								v53 = F_AllocSetContextCreateInternal(m, v48, int32(86860), int32(0), int32(1024), int32(8192))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return
								} else {
									*(*int32)(unsafe.Add(mBase, _consts[1234])) = v53
									v56 = v53
									...
									if v59 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v58)+24)) = v56
										...
										if v66 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, _consts[1232])) = v58
											return
										}
									}
								}
...
func F_pgstat_progress_parallel_incr_param(m *base.Module, l0 int32, l1 int64) {
	...
	if int32(0) <= v5 {
		F_initStringInfo(m, int32(4410868))
		mBase = m.M
		v10 = m.ExcPending
		if v10 != 0 {
			return
		} else {
			F_pq_beginmessage(m, int32(4410868), int32(80))
			mBase = m.M
			v14 = m.ExcPending
			if v14 != 0 {
				return
			} else {
				F_enlargeStringInfo(m, int32(4410868), int32(4))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return
					...
					v19 = int32(4410868)
					v20 = *(*int32)(unsafe.Add(mBase, _consts[1218]))
					v21 = int32(4410872)
					v22 = *(*int32)(unsafe.Add(mBase, _consts[1219]))
					v24 = int32(24)
					v26 = int32(65280)
					v28 = int32(8)
					*(*int32)(unsafe.Add(mBase, uint32(v20+v22))) = l0<<(uint(v24)%32) | l0&v26<<(uint(v28)%32) | (int32(base.Ui32(l0)>>(uint(v28)%32))&v26 | int32(base.Ui32(l0)>>(uint(v24)%32)))
					v42 = *(*int32)(unsafe.Add(mBase, _consts[1219]))
					*(*int32)(unsafe.Add(mBase, _consts[1219])) = v42 + int32(4)
					...
					if v49 != 0 {
						...
						v50 = int32(4410868)
						v51 = *(*int32)(unsafe.Add(mBase, _consts[1218]))
						v52 = int32(4410872)
						v53 = *(*int32)(unsafe.Add(mBase, _consts[1219]))
						v55 = int64(56)
						v57 = int64(65280)
						v59 = int64(40)
						v62 = int64(16711680)
						...
						*(*int64)(unsafe.Add(mBase, uint32(v51+v53))) = l1<<(uint(v55)%64) | l1&v57<<(uint(v59)%64) | (l1&v62<<(uint(v64)%64) | l1&v66<<(uint(v68)%64)) | (int64(base.Ui64(l1)>>(uint(v68)%64))&v66 | int64(base.Ui64(l1)>>(uint(v64)%64))&v62 | (int64(base.Ui64(l1)>>(uint(v59)%64))&v57 | int64(base.Ui64(l1)>>(uint(v55)%64))))
						v93 = *(*int32)(unsafe.Add(mBase, _consts[1219]))
						*(*int32)(unsafe.Add(mBase, _consts[1219])) = v93 + int32(8)
	...
	if v14 == int32(0) {
		...
		if v18 == int32(0) {
			...
			if l1 != 0 {
				v55 = F_strlen(m, l1)
				mBase = m.M
				v57 = *(*int32)(unsafe.Add(mBase, _consts[774]))
				v59 = v57 - int32(1)
				...
				if v20 != 0 {
					...
					if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
						...
						if base.Ui32(int32(8)) < base.Ui32(l0-int32(24)) {
							...
							v65 = int32(0)
							v67 = *(*int32)(unsafe.Add(mBase, _consts[1143]))
							if v67 == v65 {
								v77 = v65
							} else {
					...
					if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
						...
						if base.Ui32(int32(8)) < base.Ui32(l0-int32(24)) {
							...
							v97 = int32(0)
							v99 = *(*int32)(unsafe.Add(mBase, _consts[1143]))
							if v99 == v97 {
								v109 = v97
							} else {
...
L7:
	;
	v26 = *(*int32)(unsafe.Add(mBase, _consts[1213]))
	v27 = int32(2)
	v28 = v26 - v27
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1225])) = v47
...
L11:
	;
	v62 = *(*int32)(unsafe.Add(mBase, _consts[747]))
...
L13:
	...
	v69 = v67 - int32(16)
	m.G0 = v69
	v72 = *(*int32)(unsafe.Add(mBase, _consts[1226]))
	if v72 != 0 {
		goto L15
	} else {
		goto L16
...
L17:
	;
	v189 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
	F_pfree(m, v189)
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
...
L32:
	;
	v163 = *(*int32)(unsafe.Add(mBase, _consts[1226]))
	v112 = v147
	v115 = v163
	v118 = v144
	goto L24
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1221])) = int32(0)
	v196 = *(*int32)(unsafe.Add(mBase, _consts[1223]))
	F_dsa_detach(m, v196)
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
...
L36:
	;
	v199 = int32(0)
	v201 = *(*int32)(unsafe.Add(mBase, _consts[747]))
...
L48:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1223])) = int32(0)
	m.G0 = v69 + int32(16)
	return
}
func F_pgstat_wal_reset_all_cb(m *base.Module, l0 int64) {
	...
	var v27 int32
	_ = v27
	v5 = *(*int32)(unsafe.Add(mBase, _consts[747]))
	v7 = v5 + int32(53272)
	...
	if v10 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v5)+uint32(_consts[1245]))) = v13
		*(*int64)(unsafe.Add(mBase, uint32(v5)+uint32(_consts[1246]))) = l0
