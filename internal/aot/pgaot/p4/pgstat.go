...
L6:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = int32(104738)
	F_errmsg_internal(m, int32(675693), v12-int32(-64))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L8:
	;
	v42 = F_AllocateFile(m, int32(224398), int32(30419))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L1
...
L9:
	;
	F_errfinish(m, int32(472035), int32(1587), int32(368589))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L17:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(224398)
	F_errmsg(m, int32(284482), v12)
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(472035), int32(1598), int32(368589))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L25:
	;
	v107 = v75*int32(72) + int32(1610080)
	goto L26
L26:
	;
	if v107 == int32(0) {
...
L33:
	...
	v143 = v75
	v144 = int32(4367776)
	v146 = v75*int32(72) + int32(1610080)
	goto L32
L34:
	;
	goto L35
...
L70:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+48)) = v241
	F_errmsg_internal(m, int32(35566), v12+int32(48))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L1
...
L71:
	;
	F_errfinish(m, int32(472035), int32(1667), int32(368589))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L1
...
L75:
	;
	v277 = v260*int32(72) + int32(1610080)
	goto L74
L76:
	;
	goto L77
...
L90:
	;
	v316 = v310 * int32(72)
	v331 = v316 + int32(1610080)
	v333 = v316 + int32(1610096)
	goto L89
L91:
	;
	goto L92
...
L110:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = int32(224398)
	F_errmsg(m, int32(284532), v12+int32(32))
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L1
...
L111:
	;
	F_errfinish(m, int32(472035), int32(1719), int32(368589))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L1
...
L117:
	;
	v423 = F_durable_rename(m, int32(224398), int32(104738), int32(15))
	mBase = m.M
	v424 = m.ExcPending
	if v424 != 0 {
		goto L1
...
L121:
	;
	v419 = F_unlink(m, int32(224398))
	mBase = m.M
	goto L3
L122:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = int32(224398)
	F_errmsg(m, int32(284583), v12+int32(16))
	mBase = m.M
	v412 = m.ExcPending
	if v412 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(472035), int32(1728), int32(368589))
	mBase = m.M
	v417 = m.ExcPending
	if v417 != 0 {
		goto L1
...
func F_pgstat_prep_pending_entry(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) int32 {
	...
	if v6 == int32(0) {
		...
		v16 = F_AllocSetContextCreateInternal(m, v11, int32(321417), int32(0), int32(1024), int32(8192))
		mBase = m.M
		v19 = m.ExcPending
		if v19 != 0 {
			return int32(0)
					...
					if v37 == int32(0) {
						...
						if v41 != 0 {
							...
							if v43 == int32(0) {
								...
								v53 = F_AllocSetContextCreateInternal(m, v48, int32(83086), int32(0), int32(1024), int32(8192))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return
...
func F_pgstat_progress_parallel_incr_param(m *base.Module, l0 int32, l1 int64) {
	...
	if int32(0) <= v5 {
		F_initStringInfo(m, int32(4367684))
		mBase = m.M
		v10 = m.ExcPending
		if v10 != 0 {
			return
		} else {
			F_pq_beginmessage(m, int32(4367684), int32(80))
			mBase = m.M
			v14 = m.ExcPending
			if v14 != 0 {
				return
			} else {
				F_enlargeStringInfo(m, int32(4367684), int32(4))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return
		...
		if v9 == int32(0) {
			...
			if v14 != 0 {
				...
				if v20 != 0 {
					...
					if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
						v111 = l0*int32(72) + int32(1610080)
					} else {
						if base.Ui32(int32(8)) < base.Ui32(l0-int32(24)) {
							v109 = int32(0)
						} else {
