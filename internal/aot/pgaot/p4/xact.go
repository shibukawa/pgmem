...
func F_xactGetCommittedInvalidationMessages(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v115
	v3 = int32(0)
	v7 = *(*int32)(unsafe.Add(mBase, _consts[1374]))
	if v7 == v3 {
		v10 = int32(0)
		...
		*(*uint8)(unsafe.Add(mBase, uint32(l1))) = uint8(v16)
		...
		if v40 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0))) = v37
			...
			if int32(0) < v61 {
				v64 = int32(4)
				v68 = *(*int32)(unsafe.Add(mBase, _consts[121]))
				v73 = v61 << (uint(v64) % 32)
				if v73 != 0 {
			...
			if int32(0) < v80 {
				v83 = int32(4)
				v87 = *(*int32)(unsafe.Add(mBase, _consts[122]))
				v92 = v80 << (uint(v83) % 32)
				if v92 != 0 {
			...
			if int32(0) < v99 {
				v102 = int32(4)
				v106 = *(*int32)(unsafe.Add(mBase, _consts[122]))
