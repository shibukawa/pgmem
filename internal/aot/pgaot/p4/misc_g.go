...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v32
	F_errmsg_internal(m, int32(705772), v10+int32(16))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L6
...
L8:
	;
	F_errfinish(m, int32(493158), int32(576), int32(534555))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L6
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v112
	F_errmsg_internal(m, int32(705931), v10)
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L6
...
L31:
	;
	F_errfinish(m, int32(493158), int32(586), int32(534555))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L6
	...
	if v23 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v47)+440)) = int32(1)
		if v48 != 0 {
			...
			F_s_lock(m, v52+int32(440), int32(494925), int32(6580), int32(107955))
			mBase = m.M
			v61 = m.ExcPending
			if v61 != 0 {
				return int64(0)
...
L85:
	;
	F_errmsg_internal(m, int32(421450), int32(0))
	mBase = m.M
	v534 = m.ExcPending
	if v534 != 0 {
		goto L13
...
L86:
	;
	F_errfinish(m, int32(494492), int32(3233), int32(124274))
	mBase = m.M
	v539 = m.ExcPending
	if v539 != 0 {
		goto L13
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = l1
	F_errmsg_internal(m, int32(483550), v22+int32(16))
	mBase = m.M
	v550 = m.ExcPending
	if v550 != 0 {
		goto L13
...
L89:
	;
	F_errfinish(m, int32(494492), int32(3055), int32(124274))
	mBase = m.M
	v555 = m.ExcPending
	if v555 != 0 {
		goto L13
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v24
	F_errmsg_internal(m, int32(484004), v22)
	mBase = m.M
	v563 = m.ExcPending
	if v563 != 0 {
		goto L13
...
L92:
	;
	F_errfinish(m, int32(494492), int32(3052), int32(124274))
	mBase = m.M
	v568 = m.ExcPending
	if v568 != 0 {
		goto L13
...
func F_GetRedoRecPtr(m *base.Module) int64 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+440)) = int32(1)
	if v7 != 0 {
		v11 = *(*int32)(unsafe.Add(mBase, _consts[190]))
		F_s_lock(m, v11+int32(440), int32(494925), int32(6487), int32(205799))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int64(0)
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
					...
					if v24 != 0 {
						...
						F_errfinish(m, int32(495758), int32(37), int32(370949))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return int32(0)
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v346))) = v353
	...
	F_ResourceOwnerRemember(m, v356, v353, int32(1609600))
	mBase = m.M
	v359 = m.ExcPending
	if v359 != 0 {
		goto L1
...
L27:
	...
	F_s_lock(m, v131, int32(489464), int32(273), int32(225194))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L48:
	...
	F_s_lock(m, v228, int32(489464), int32(151), int32(315903))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L1
...
L72:
	;
	F_errfinish(m, int32(489464), int32(353), int32(225194))
	mBase = m.M
	v322 = m.ExcPending
	if v322 != 0 {
		goto L1
...
L76:
	...
	F_ResourceOwnerForget(m, v752, v753+int32(1), int32(1609600))
	mBase = m.M
	v758 = m.ExcPending
	if v758 != 0 {
		goto L1
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+20)) = int32(491975)
...
L116:
	;
	F_IssuePendingWritebacks(m, int32(4397576), l1)
	mBase = m.M
	v558 = m.ExcPending
	if v558 != 0 {
		goto L1
...
L127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v617)+36)) = int32(491975)
...
func F___gmtime_r(m *base.Module, l0 int32, l1 int32) int32 {
	...
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, uint32(l1)+40)) = int32(516931)
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = v19
				...
				if v26 != 0 {
					...
					F_errfinish(m, int32(489608), int32(34), int32(277454))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return int32(0)
...
L288:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+48)) = v941
	F_errmsg_internal(m, int32(498819), v30+int32(48))
	mBase = m.M
	v947 = m.ExcPending
	if v947 != 0 {
		goto L4
...
L289:
	;
	F_errfinish(m, int32(495639), int32(2138), int32(21180))
	mBase = m.M
	v952 = m.ExcPending
	if v952 != 0 {
		goto L4
...
L374:
	;
	F_errfinish(m, int32(495639), int32(1480), int32(135470))
	mBase = m.M
	v1488 = m.ExcPending
	if v1488 != 0 {
		goto L4
...
L376:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+32)) = v1493
	F_errmsg_internal(m, int32(498819), v30+int32(32))
	mBase = m.M
	v1499 = m.ExcPending
	if v1499 != 0 {
		goto L4
...
L377:
	;
	F_errfinish(m, int32(495639), int32(1487), int32(135470))
	mBase = m.M
	v1504 = m.ExcPending
	if v1504 != 0 {
		goto L4
...
L486:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+16)) = v2343
	F_errmsg_internal(m, int32(498819), v30+int32(16))
	mBase = m.M
	v2349 = m.ExcPending
	if v2349 != 0 {
		goto L4
...
L487:
	;
	F_errfinish(m, int32(495639), int32(1768), int32(135470))
	mBase = m.M
	v2354 = m.ExcPending
	if v2354 != 0 {
		goto L4
...
L33:
	;
	v120 = F_coerce_to_common_type(m, int32(0), v114, v88, int32(514427))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L27
			...
			if v45 != 0 {
				...
				if v48 != 0 {
					...
					if v52 != 0 {
						...
						F_errfinish(m, int32(496497), int32(638), int32(546535))
						mBase = m.M
						v57 = m.ExcPending
						if v57 != 0 {
							return int32(0)
...
L37:
	;
	F_errfinish(m, int32(496672), int32(77), int32(96519))
	v89 = m.ExcPending
	if v89 != 0 {
		goto L4
	} else {
...
L36:
	;
	F_errfinish(m, int32(491633), int32(6894), int32(88105))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L2
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v152 + int32(4)
	F_errmsg_internal(m, int32(675879), v19)
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L2
...
L39:
	;
	F_errfinish(m, int32(491633), int32(6910), int32(88105))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L2
			...
			if v38 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				...
				if v43 != 0 {
					...
					F_errfinish(m, int32(495981), int32(1075), int32(136212))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
								...
								if v98 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v27)+32)) = v24
									...
									if v104 != 0 {
										...
										F_errfinish(m, int32(490836), int32(108), int32(319571))
										mBase = m.M
										v109 = m.ExcPending
										if v109 != 0 {
											return int32(0)
								...
								if v49 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v27)+48)) = v24
									...
									if v58 != 0 {
										...
										F_errfinish(m, int32(490836), int32(117), int32(319571))
										mBase = m.M
										v63 = m.ExcPending
										if v63 != 0 {
											return int32(0)
									...
									if v115 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v27)+16)) = v24
										...
										if v121 != 0 {
											...
											F_errfinish(m, int32(490836), int32(129), int32(319571))
											mBase = m.M
											v126 = m.ExcPending
											if v126 != 0 {
												return int32(0)
								...
								if v78 != 0 {
									...
									if v130 != 0 {
										...
										if v134 != 0 {
											...
											F_errfinish(m, int32(490836), int32(168), int32(319571))
											mBase = m.M
											v139 = m.ExcPending
											if v139 != 0 {
												return int32(0)
						...
						if v87 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v27))) = v24
							...
							if v91 != 0 {
								...
								F_errfinish(m, int32(490836), int32(94), int32(319571))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return int32(0)
...
L220:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+48)) = v561
	F_errmsg_internal(m, int32(468533), v23+int32(48))
	mBase = m.M
	v876 = m.ExcPending
	if v876 != 0 {
		goto L7
...
L221:
	;
	F_errfinish(m, int32(495639), int32(3318), int32(171452))
	mBase = m.M
	v881 = m.ExcPending
	if v881 != 0 {
		goto L7
...
L231:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v959
	F_errmsg_internal(m, int32(477430), v23+int32(16))
	mBase = m.M
	v965 = m.ExcPending
	if v965 != 0 {
		goto L7
...
L232:
	;
	F_errfinish(m, int32(495639), int32(3575), int32(236501))
	mBase = m.M
	v970 = m.ExcPending
	if v970 != 0 {
		goto L7
...
L234:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+32)) = v433
	F_errmsg_internal(m, int32(468533), v23+int32(32))
	mBase = m.M
	v980 = m.ExcPending
	if v980 != 0 {
		goto L7
...
L235:
	;
	F_errfinish(m, int32(495639), int32(2941), int32(171325))
	mBase = m.M
	v985 = m.ExcPending
	if v985 != 0 {
		goto L7
...
L237:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v990
	F_errmsg_internal(m, int32(481980), v23)
	mBase = m.M
	v994 = m.ExcPending
	if v994 != 0 {
		goto L7
...
L238:
	;
	F_errfinish(m, int32(495639), int32(893), int32(138014))
	mBase = m.M
	v999 = m.ExcPending
	if v999 != 0 {
		goto L7
...
L276:
	;
	F_errfinish(m, int32(495639), int32(3630), int32(236527))
	mBase = m.M
	v1191 = m.ExcPending
	if v1191 != 0 {
		goto L7
...
L279:
	;
	F_errfinish(m, int32(495639), int32(3654), int32(236527))
	mBase = m.M
	v1224 = m.ExcPending
	if v1224 != 0 {
		goto L7
...
L31:
	;
	v76 = F_strspn(m, v66, int32(542962))
	mBase = m.M
	if v76 != v70 {
		v123 = v67
		goto L30
...
L32:
	;
	v79 = F_strstr(m, v66, int32(651557))
	mBase = m.M
	if v79 != 0 {
		v123 = v67
		goto L30
...
L33:
	;
	v81 = F_strstr(m, v66, int32(651458))
	mBase = m.M
	if v81 != 0 {
		v123 = v67
		goto L30
...
L38:
	...
	v100 = F_memchr(m, int32(671383), v98, int32(11))
	mBase = m.M
	if v100 != 0 {
		goto L35
	} else {
...
L63:
	;
	F_errfinish(m, int32(491915), int32(214), int32(396409))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L3
...
func F_get_pkglib_path(m *base.Module, l0 int32) {
	var v5 int32
	_ = v5
	F_make_relative_path(m, l0, int32(298887), int32(4482784))
	v5 = m.ExcPending
	if v5 != 0 {
		return
	} else {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
				...
				if v23 != 0 {
					...
					F_errfinish(m, int32(495981), int32(2419), int32(278717))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return
...
L29:
	;
	F_errsave_finish(m, v52, int32(492970), int32(71), int32(209284))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L1
...
L60:
	;
	F_errsave_finish(m, v168, int32(492970), int32(83), int32(336458))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L1
...
L72:
	;
	F_errsave_finish(m, v216, int32(492970), int32(83), int32(336458))
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L1
...
L82:
	;
	F_errsave_finish(m, v263, int32(492970), int32(83), int32(336458))
	mBase = m.M
	v283 = m.ExcPending
	if v283 != 0 {
		goto L1
...
L103:
	;
	F_s_lock(m, v490, int32(489829), int32(1141), int32(282701))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L1
...
L260:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[71]))) = uint8(base.B2i32(v1263 == int32(4101720)))
...
L289:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v1404 + int32(4)
	F_errmsg_internal(m, int32(501187), v21)
	mBase = m.M
	v1410 = m.ExcPending
	if v1410 != 0 {
		goto L1
...
L290:
	;
	F_errfinish(m, int32(489829), int32(625), int32(427924))
	mBase = m.M
	v1415 = m.ExcPending
	if v1415 != 0 {
		goto L1
				...
				if v165 != 0 {
					...
					if v168 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(3)
						F_errmsg_internal(m, int32(677947), v12)
						mBase = m.M
						v177 = m.ExcPending
						if v177 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(491633), int32(8020), int32(243763))
							mBase = m.M
							v182 = m.ExcPending
							if v182 != 0 {
								return int32(0)
...
func F_ginoptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = F_build_reloptions(m, l0, l1, int32(16), int32(12), int32(739296), int32(2))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
