...
func F_ReindexIsProcessingIndex(m *base.Module, l0 int32) int32 {
	...
	var v48 int32
	_ = v48
	v5 = *(*int32)(unsafe.Add(mBase, _c_F_ReindexIsProcessingIndex[0]))
	if v5 != l0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_ReindexIsProcessingIndex[1]))
	v9 = int32(0)
	if v8 == v9 {
		goto L5
	} else {
...
L22:
	;
	v45 = *(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[1]))
...
L28:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[0])) = v52
	v57 = *(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[1]))
	v58 = *(*int32)(unsafe.Add(mBase, uint32(v57)+28))
	goto L29
L29:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[2])) = v58
...
L63:
	;
	v163 = *(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[1]))
...
L75:
	;
	v190 = int32(_a_F_reindex_relation_4)
	v192 = *(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[5]))
	v193 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[5])) = v192 + v193
	...
	*(*int32)(unsafe.Add(mBase, uint32(v183))) = v204 + v193
	v210 = *(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[5]))
	*(*int32)(unsafe.Add(mBase, _c_F_reindex_relation[5])) = v210 - v193
	goto L73
L76:
	;
	goto L43
