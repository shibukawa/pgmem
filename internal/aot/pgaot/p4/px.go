...
L4:
	;
	v93 = F_px_find_digest(m, int32(570180), v13+int32(12))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L28
...
L30:
	;
	v100 = F_px_find_digest(m, int32(570180), v13+int32(8))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L28
...
L35:
	...
	m.T0[v112].(func(*base.Module, int32, int32, int32))(m, v109, int32(703972), int32(3))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L28
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v318))) = v312
	v324 = F_open(m, int32(294531), v312, v318)
	mBase = m.M
	if v324 != int32(-1) {
		goto L108
	} else {
