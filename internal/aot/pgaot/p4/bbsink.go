			...
			if v48 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v49 + int32(8)
				...
				if v92 != 0 {
					...
					v94 = *(*int32)(unsafe.Add(mBase, _c_F_bbsink_copystream_end_archive[0]))
...
func F_bbsink_progress_end_archive(m *base.Module, l0 int32) {
	...
	if v5 < v9 {
		v17 = *(*int32)(unsafe.Add(mBase, _c_F_bbsink_progress_end_archive[0]))
		if v17 == int32(0) {
		} else {
...
func F_bbsink_server_begin_archive(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v10
	v16 = F_psprintf(m, int32(_a_F_bbsink_server_begin_archive_0), v8+int32(16))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
				...
				if v27 != 0 {
					...
					if v29 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v16
						F_errmsg(m, int32(_a_F_bbsink_server_begin_archive_1), v8)
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return
						} else {
							F_errfinish(m, int32(_a_F_bbsink_server_begin_archive_2), int32(149), int32(_a_F_bbsink_server_begin_archive_3))
							mBase = m.M
							v38 = m.ExcPending
							if v38 != 0 {
								return
