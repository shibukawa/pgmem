				...
				if v117 != 0 {
					...
					if v120 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12))) = v123
						F_errmsg(m, int32(679503), v12)
						mBase = m.M
						v129 = m.ExcPending
						if v129 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(495766), int32(102), int32(131749))
							mBase = m.M
							v136 = m.ExcPending
							if v136 != 0 {
								return int32(0)
...
L69:
	;
	F_errfinish(m, int32(496082), int32(413), int32(282476))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L5
...
L72:
	;
	F_errmsg(m, int32(346018), int32(0))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L5
...
L73:
	;
	F_errfinish(m, int32(496082), int32(433), int32(282494))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L5
...
L32:
	;
	F_errfinish(m, int32(496082), int32(525), int32(36577))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L6
...
L36:
	;
	F_errfinish(m, int32(496082), int32(536), int32(36577))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L6
...
L16:
	;
	F_appendStringInfoString(m, v10, int32(745784))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L2
...
L19:
	;
	F_appendStringInfoString(m, v10, int32(303387))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L2
...
L28:
	;
	F_appendStringInfoString(m, v10, int32(746027))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L2
