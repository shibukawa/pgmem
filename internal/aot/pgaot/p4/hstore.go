...
func F_hstore_out(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		if v20 != 0 {
			...
			v483 = F_pstrdup(m, int32(_a_F_hstore_out_2))
			mBase = m.M
			v484 = m.ExcPending
			if v484 != 0 {
				return int32(0)
...
L4:
	;
	v24 = F_cstring_to_text_with_len(m, int32(_a_F_hstore_to_json_0), int32(2))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L2
...
L16:
	;
	F_appendStringInfoString(m, v10, int32(_a_F_hstore_to_json_1))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L2
...
L19:
	;
	F_appendStringInfoString(m, v10, int32(_a_F_hstore_to_json_2))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L2
...
L28:
	;
	F_appendStringInfoString(m, v10, int32(_a_F_hstore_to_json_3))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L2
