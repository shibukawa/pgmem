				...
				if v117 != 0 {
					...
					if v120 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12))) = v123
						F_errmsg(m, int32(679695), v12)
						mBase = m.M
						v129 = m.ExcPending
						if v129 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(495953), int32(102), int32(131806))
							mBase = m.M
							v136 = m.ExcPending
							if v136 != 0 {
								return int32(0)
...
L40:
	;
	v242 = F_hstoreUniquePairs(m, v103, v231, v17+int32(28))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L5
...
L46:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v163)+8)) = v167
	if v127 != 0 {
		goto L49
	} else {
		goto L50
...
L47:
	;
	v213 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v163)+17)) = uint8(v213)
	*(*uint8)(unsafe.Add(mBase, uint32(v163)+16)) = uint8(v211)
	*(*int32)(unsafe.Add(mBase, uint32(v163)+12)) = v212
	v222 = v141 + int32(1)
	goto L45
L48:
	;
	v181 = v58 + int32(16) + v137*int32(40)
...
L49:
	;
	v172 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v137+v127))))
	if v172 != int32(1) {
		goto L48
	} else {
		goto L52
...
L53:
	;
	F_getTypeOutputInfo(m, v160, v181+int32(4), v17+int32(28))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L5
...
L55:
	;
	v203 = *(*int32)(unsafe.Add(mBase, uint32(v128+v137<<(uint(int32(2))%32))))
	v204 = F_OutputFunctionCall(m, v181+int32(12), v203)
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L5
...
L56:
	...
	F_fmgr_info_cxt(m, v190, v181+int32(12), v194)
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L5
...
L57:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v181))) = v160
	goto L55
L58:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v163)+4)) = v204
	v208 = F_strlen(m, v204)
	mBase = m.M
	if base.Ui32(int32(1073741824)) <= base.Ui32(v208) {
		goto L36
	} else {
		goto L59
	}
...
L61:
	;
	v244 = *(*int32)(unsafe.Add(mBase, uint32(v17)+28))
	v245 = F_hstorePairs(m, v103, v242, v244)
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L5
...
L62:
	;
	v247 = *(*int32)(unsafe.Add(mBase, uint32(v37)+12))
	if int32(0) <= v247 {
		goto L63
	} else {
		goto L64
...
L68:
	;
	F_errmsg(m, int32(22355), int32(0))
	mBase = m.M
	v268 = m.ExcPending
	if v268 != 0 {
		goto L5
...
L69:
	;
	F_errfinish(m, int32(496274), int32(413), int32(282644))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L5
...
L72:
	;
	F_errmsg(m, int32(346186), int32(0))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L5
...
L73:
	;
	F_errfinish(m, int32(496274), int32(433), int32(282662))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L5
...
L32:
	;
	F_errfinish(m, int32(496274), int32(525), int32(36603))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L6
...
L35:
	;
	F_errmsg(m, int32(22386), int32(0))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L6
...
L36:
	;
	F_errfinish(m, int32(496274), int32(536), int32(36603))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L6
...
L16:
	;
	F_appendStringInfoString(m, v10, int32(745976))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L2
...
L19:
	;
	F_appendStringInfoString(m, v10, int32(303555))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L2
...
L28:
	;
	F_appendStringInfoString(m, v10, int32(746219))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L2
