				...
				if v117 != 0 {
					...
					if v120 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12))) = v123
						F_errmsg(m, int32(653788), v12)
						mBase = m.M
						v129 = m.ExcPending
						if v129 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(486925), int32(102), int32(129325))
							mBase = m.M
							v136 = m.ExcPending
							if v136 != 0 {
								return int32(0)
...
L103:
	;
	F_errfinish(m, int32(487241), int32(413), int32(277718))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L5
...
L107:
	;
	F_errfinish(m, int32(487241), int32(433), int32(277736))
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L5
...
L32:
	;
	F_errfinish(m, int32(487241), int32(525), int32(35993))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L6
...
L36:
	;
	F_errfinish(m, int32(487241), int32(536), int32(35993))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L6
...
L16:
	;
	F_appendStringInfoString(m, v10, int32(719688))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L2
...
L19:
	;
	F_appendStringInfoString(m, v10, int32(298338))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L2
...
L28:
	;
	F_appendStringInfoString(m, v10, int32(719931))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L2
