...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v29
	F_errmsg_internal(m, int32(479275), v20)
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L53:
	;
	F_errfinish(m, int32(489538), int32(271), int32(91913))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L1
...
L192:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v29
	F_errmsg_internal(m, int32(479275), v20+int32(16))
	mBase = m.M
	v957 = m.ExcPending
	if v957 != 0 {
		goto L1
...
L193:
	;
	F_errfinish(m, int32(489538), int32(443), int32(91913))
	mBase = m.M
	v964 = m.ExcPending
	if v964 != 0 {
		goto L1
		...
		if v15 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(287231)
			...
			if v23 != 0 {
				...
				F_errfinish(m, int32(489538), int32(71), int32(66834))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
