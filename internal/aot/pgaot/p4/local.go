		...
		*(*int32)(unsafe.Add(mBase, _consts[941])) = v108
			...
			if v192 != 0 {
				...
				if v195 != 0 {
					...
					if v199 != 0 {
						...
						F_errfinish(m, int32(521103), int32(745), int32(143416))
						mBase = m.M
						v204 = m.ExcPending
						if v204 != 0 {
							return
			...
			if v73 == int32(0) {
				...
				if v108 == int32(0) {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v8)+16)) = int64(103079215124)
					v163 = F_hash_create(m, int32(414877), v16, v8, int32(40))
					mBase = m.M
					v164 = m.ExcPending
					if v164 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, _consts[944])) = v163
						if v163 == int32(0) {
							...
							if v208 != 0 {
								...
								F_errmsg_internal(m, int32(410778), int32(0))
								mBase = m.M
								v212 = m.ExcPending
								if v212 != 0 {
									return
								} else {
									F_errfinish(m, int32(521103), int32(782), int32(143416))
									mBase = m.M
									v217 = m.ExcPending
									if v217 != 0 {
										return
		...
		if v176 != 0 {
			...
			if v179 != 0 {
				...
				F_errmsg(m, int32(272290), int32(0))
				mBase = m.M
				v183 = m.ExcPending
				if v183 != 0 {
					return
				} else {
					F_errfinish(m, int32(521103), int32(736), int32(143416))
					mBase = m.M
					v188 = m.ExcPending
					if v188 != 0 {
						return
