...
func F_j2date(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1))) = v45 + v27<<(uint(int32(2))%32) - int32(_a_F_j2date_3)
	v53 = v43 + int32(123)
	v57 = int32(base.Ui32(v53*int32(2141)) >> (uint(int32(16)) % 32))
	*(*int32)(unsafe.Add(mBase, uint32(l3))) = v53 - int32(base.Ui32(v57*int32(_a_F_j2date_4))>>(uint(int32(8))%32))
	...
	if v4 == int32(0) {
		...
		if v9 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
			if v8 == int32(0) {
				F_yy_fatal_error_5(m, int32(_a_F_jsonpath_yyensure_buffer_stack_0))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
				...
				if v19 == int32(0) {
					...
					if v28 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = l2
						F_errmsg(m, int32(_a_F_jsonpath_yyerror_0), v9)
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return
							...
							v48 = int32(378)
							F_errsave_finish(m, l0, int32(_a_F_jsonpath_yyerror_1), v48, int32(_a_F_jsonpath_yyerror_2))
							mBase = m.M
							v51 = m.ExcPending
							if v51 != 0 {
								return
				...
				if v19 == int32(0) {
					...
					if v38 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l2
						F_errmsg(m, int32(_a_F_jsonpath_yyerror_3), v9+int32(16))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return
