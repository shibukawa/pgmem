...
func F_uuid_out(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		for {
			...
			v32 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v27&int32(15))+uint32(_consts[1349]))))
			*(*uint8)(unsafe.Add(mBase, uint32(v25)+1)) = uint8(v32)
			v38 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v27)>>(uint(int32(4))%32)))+uint32(_consts[1349]))))
