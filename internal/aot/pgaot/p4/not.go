...
L17:
	;
	v96 = int32(_a_F_ExecMergeNotMatched_0)
	v97 = *(*int32)(unsafe.Add(mBase, _c_F_ExecMergeNotMatched[0]))
	v99 = *(*int32)(unsafe.Add(mBase, uint32(v90)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecMergeNotMatched[0])) = v99
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecMergeNotMatched[0])) = v97
	v109 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v91)+4)))
	v111 = v109 & int32(_a_F_ExecMergeNotMatched_4)
