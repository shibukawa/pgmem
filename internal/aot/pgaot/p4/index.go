			...
			if v12 == int32(438) {
				...
				if v18 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
					F_errmsg_internal(m, int32(116331), v6)
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return int32(0)
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
				...
				if v23 != 0 {
					...
					F_errfinish(m, int32(524038), int32(613), int32(299782))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
...
L1:
	;
	v409 = int32(*(*uint8)(unsafe.Add(mBase, _consts[630])))
...
L173:
	...
	v652 = *(*int32)(unsafe.Add(mBase, _consts[612]))
...
L180:
	;
	v663 = *(*int32)(unsafe.Add(mBase, _consts[613]))
...
L184:
	;
	v672 = *(*int32)(unsafe.Add(mBase, _consts[631]))
...
L187:
	;
	v680 = int32(1)
	v682 = *(*int32)(unsafe.Add(mBase, _consts[613]))
	if v682 <= v680 {
		goto L188
	} else {
		goto L189
...
L195:
	;
	v713 = int32(1)
	v715 = *(*int32)(unsafe.Add(mBase, _consts[631]))
	if v715 <= v713 {
		goto L196
	} else {
		goto L197
...
L215:
	...
	v855 = *(*float64)(unsafe.Add(mBase, _consts[608]))
...
L222:
	...
	v869 = int32(*(*uint8)(unsafe.Add(mBase, _consts[632])))
	if v869 == int32(1) {
		goto L225
	} else {
		goto L226
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(231255)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(519698), int32(371), int32(293499))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L21:
	;
	F_errfinish(m, int32(522100), int32(190), int32(261740))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L4
...
func F_index_markpos(m *base.Module, l0 int32) {
	...
	if v10 == int32(0) {
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(145593)
			*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v18 + int32(4)
			F_errmsg_internal(m, int32(727844), v6)
			mBase = m.M
			v26 = m.ExcPending
			if v26 != 0 {
				return
			} else {
				F_errfinish(m, int32(523473), int32(415), int32(145603))
				mBase = m.M
				v31 = m.ExcPending
				if v31 != 0 {
					return
			...
			if v69 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = v70 + int32(4)
				...
				if v76 != 0 {
					...
					F_errfinish(m, int32(523473), int32(469), int32(373616))
					mBase = m.M
					v81 = m.ExcPending
					if v81 != 0 {
						return int32(0)
...
L24:
	;
	F_errmsg_internal(m, int32(12113), int32(0))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L15
...
L25:
	;
	F_errfinish(m, int32(523473), int32(1030), int32(182615))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L15
...
L49:
	;
	F_errfinish(m, int32(517317), int32(2918), int32(134515))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L14
...
L60:
	;
	F_errfinish(m, int32(524102), int32(4468), int32(449406))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L14
...
L63:
	;
	F_errfinish(m, int32(524102), int32(4473), int32(449406))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L14
