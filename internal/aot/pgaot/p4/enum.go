						...
						if v45 != 0 {
							...
							if v47 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v46
								F_errmsg(m, int32(157736), v6)
								mBase = m.M
								v51 = m.ExcPending
								if v51 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(496459), int32(460), int32(67837))
									mBase = m.M
									v56 = m.ExcPending
									if v56 != 0 {
										return int32(0)
			...
			if v26 != 0 {
				...
				if v29 != 0 {
					...
					if v33 != 0 {
						...
						F_errfinish(m, int32(496459), int32(451), int32(67837))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
							...
							if v47 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v46
								...
								if v51 != 0 {
									...
									F_errfinish(m, int32(496459), int32(489), int32(77917))
									mBase = m.M
									v56 = m.ExcPending
									if v56 != 0 {
										return int32(0)
			...
			if v26 != 0 {
				...
				if v29 != 0 {
					...
					if v33 != 0 {
						...
						F_errfinish(m, int32(496459), int32(480), int32(77917))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
...
L73:
	;
	F_errfinish(m, int32(498595), int32(2758), int32(503530))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L4
