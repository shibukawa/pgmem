		...
		if v10 != 0 {
						...
						if v45 != 0 {
							...
							if v47 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v46
								F_errmsg(m, int32(168267), v6)
								mBase = m.M
								v51 = m.ExcPending
								if v51 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(522876), int32(460), int32(73978))
									mBase = m.M
									v56 = m.ExcPending
									if v56 != 0 {
										return int32(0)
			...
			if v26 != 0 {
				...
				if v29 != 0 {
					...
					F_errmsg(m, int32(388112), int32(0))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(522876), int32(451), int32(73978))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
							...
							if v47 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6))) = v46
								...
								if v51 != 0 {
									...
									F_errfinish(m, int32(522876), int32(489), int32(84136))
									mBase = m.M
									v56 = m.ExcPending
									if v56 != 0 {
										return int32(0)
			...
			if v26 != 0 {
				...
				if v29 != 0 {
					...
					if v33 != 0 {
						...
						F_errfinish(m, int32(522876), int32(480), int32(84136))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
...
L73:
	;
	F_errfinish(m, int32(525078), int32(2758), int32(530882))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L4
