...
func F_table_am_handler_in(m *base.Module, l0 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = Fn13852(m, l0, int32(_a_F_table_am_handler_in_0), int32(370), int32(_a_F_table_am_handler_in_1), int32(_a_F_table_am_handler_in_2), int32(_a_F_table_am_handler_in_3))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
