...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+56)) = int32(22)
	v55 = int32(_a_F_fetch_table_list_1)
	goto L6
L8:
	;
	goto L9
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+56)) = int32(1003)
	F_appendStringInfoString(m, v11-int32(-64), int32(_a_F_fetch_table_list_2))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L1
...
L11:
	;
	F_appendStringInfoString(m, v11-int32(-64), int32(_a_F_fetch_table_list_5))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L17:
	;
	v76 = *(*int32)(unsafe.Add(mBase, _c_F_fetch_table_list[2]))
...
L21:
	...
	v88 = F_MakeSingleTupleTableSlot(m, v86, int32(_a_F_fetch_table_list_7))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L1
...
func F_table_am_handler_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_table_am_handler_in_0)
			F_errmsg(m, int32(_a_F_table_am_handler_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_table_am_handler_in_2), int32(370), int32(_a_F_table_am_handler_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
			...
			if v21 != 0 {
				...
				if v25 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = v24
					F_appendStringInfo(m, v7+int32(16), int32(_a_F_table_to_xml_0), v7)
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
