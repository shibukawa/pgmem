...
func F_pg_wc_isprint(m *base.Module, l0 int32) int32 {
	...
	var v255 int32
	_ = v255
	v3 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	switch v3 - int32(1) {
	case 0:
		goto L3
	case 1:
...
L11:
	;
	v54 = l0<<(uint(int32(1))%32) + int32(1951600)
	goto L7
L12:
	;
	v25 = base.I32_div_s(v19+v20, int32(2))
	v27 = v25 * int32(12)
	v30 = *(*int32)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[816])))
...
L17:
	;
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[817])))
...
L25:
	;
	v108 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v77)+uint32(_consts[818]))))
	v119 = v108
	goto L23
L26:
	;
...
L28:
	;
	v94 = int32(1)
	v100 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(v94)%32))+uint32(_consts[819]))))
...
L29:
	...
	v77 = v75 * int32(12)
	v80 = *(*int32)(unsafe.Add(mBase, uint32(v77)+uint32(_consts[816])))
...
L34:
	;
	v86 = *(*int32)(unsafe.Add(mBase, uint32(v77)+uint32(_consts[817])))
...
L39:
	;
	v115 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_consts[820]))))
	if v115&int32(32) != 0 {
		v187 = v100
		goto L22
	} else {
...
L43:
	...
	v138 = *(*int32)(unsafe.Add(mBase, uint32(v135)+uint32(_consts[821])))
...
L48:
	;
	v144 = *(*int32)(unsafe.Add(mBase, uint32(v135)+uint32(_consts[822])))
...
L51:
	;
	v185 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v168)+uint32(_consts[818]))))
	v187 = v185
	goto L22
L52:
	;
	...
	v168 = v166 * int32(12)
	v171 = *(*int32)(unsafe.Add(mBase, uint32(v168)+uint32(_consts[816])))
...
L57:
	;
	v177 = *(*int32)(unsafe.Add(mBase, uint32(v168)+uint32(_consts[817])))
