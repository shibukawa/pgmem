		...
		if v16 == int32(1597032) {
			...
			if v53 != 0 {
				...
				if v57 != 0 {
					...
					F_errfinish(m, int32(489195), int32(1553), int32(381187))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
func F_tts_minimal_is_current_xact_tuple(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			F_errmsg(m, int32(380514), int32(0))
			v14 = m.ExcPending
			if v14 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(489195), int32(581), int32(379792))
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
...
func F_tts_virtual_getsomeattrs(m *base.Module, l0 int32, l1 int32) {
	...
	if v6 != 0 {
		...
		F_errmsg_internal(m, int32(85405), int32(0))
		v10 = m.ExcPending
		if v10 != 0 {
			return
		} else {
			F_errfinish(m, int32(489195), int32(132), int32(129778))
			v15 = m.ExcPending
			if v15 != 0 {
				return
			} else {
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				F_errfinish(m, int32(489195), int32(163), int32(379758))
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
