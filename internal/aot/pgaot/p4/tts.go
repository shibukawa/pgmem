		...
		*(*int32)(unsafe.Add(mBase, _consts[28])) = v6
		...
		if v16 == int32(1619368) {
			...
			if v53 != 0 {
				...
				F_errmsg_internal(m, int32(86096), int32(0))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(495333), int32(1553), int32(385919))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
func F_tts_minimal_is_current_xact_tuple(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			F_errmsg(m, int32(385246), int32(0))
			v14 = m.ExcPending
			if v14 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(495333), int32(581), int32(384524))
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
...
func F_tts_virtual_getsomeattrs(m *base.Module, l0 int32, l1 int32) {
	...
	if v6 != 0 {
		...
		F_errmsg_internal(m, int32(86273), int32(0))
		v10 = m.ExcPending
		if v10 != 0 {
			return
		} else {
			F_errfinish(m, int32(495333), int32(132), int32(131388))
			v15 = m.ExcPending
			if v15 != 0 {
				return
			} else {
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				F_errfinish(m, int32(495333), int32(163), int32(384490))
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
