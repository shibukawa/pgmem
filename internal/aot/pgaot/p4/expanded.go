		...
		if v12 != 0 {
			...
			if v19 != 0 {
				...
				if v26 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v30)+4)) = int32(_a_F_make_expanded_record_from_exprecord_3)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v30)+28)) = v62 & int32(64)
					...
					if int32(0) <= v66 {
						*(*int32)(unsafe.Add(mBase, uint32(v30)+108)) = int32(1311)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v81 + int32(1)
						...
						if v86&int32(32) != 0 {
							v89 = int32(_a_F_make_expanded_record_from_exprecord_4)
							v90 = *(*int32)(unsafe.Add(mBase, _c_F_make_expanded_record_from_exprecord[0]))
							*(*int32)(unsafe.Add(mBase, _c_F_make_expanded_record_from_exprecord[0])) = v18
							...
							if v94 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, _c_F_make_expanded_record_from_exprecord[0])) = v90
								return v30
							}
						} else {
							*(*int32)(unsafe.Add(mBase, uint32(v30)+44)) = v13
