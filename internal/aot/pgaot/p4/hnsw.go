...
func F_HnswGetTypeInfo(m *base.Module, l0 int32) int32 {
	...
	var v34 int32
	_ = v34
	v3 = int32(_a_F_HnswGetTypeInfo_0)
...
func F_HnswUpdateNeighborsOnDisk(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) {
	...
	v27 = v25 - int32(1216)
	m.G0 = v27
	v30 = *(*int32)(unsafe.Add(mBase, _c_F_HnswUpdateNeighborsOnDisk[0]))
	v32 = int32(_a_F_HnswUpdateNeighborsOnDisk_0)
	v35 = F_GenerationContextCreate(m, v30, int32(_a_F_HnswUpdateNeighborsOnDisk_1), v32, v32, v32)
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L1
...
L8:
	...
	v105 = int32(_a_F_HnswUpdateNeighborsOnDisk_2)
	v106 = *(*int32)(unsafe.Add(mBase, _c_F_HnswUpdateNeighborsOnDisk[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_HnswUpdateNeighborsOnDisk[0])) = v55
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_HnswUpdateNeighborsOnDisk[0])) = v106
...
L41:
	...
	v359 = v349 + v356&int32(_a_F_HnswUpdateNeighborsOnDisk_3)
	if v42 == int32(0) {
		goto L55
	} else {
		goto L56
...
L45:
	;
	v328 = *(*int32)(unsafe.Add(mBase, _c_F_HnswUpdateNeighborsOnDisk[1]))
...
L47:
	;
	v337 = *(*int32)(unsafe.Add(mBase, _c_F_HnswUpdateNeighborsOnDisk[2]))
	v348 = int32(0)
