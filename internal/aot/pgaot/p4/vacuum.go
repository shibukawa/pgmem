...
func F_VacuumUpdateCosts(m *base.Module) {
	...
	v8 = v6 - int32(32)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[711]))
	if v11 != 0 {
		v13 = *(*float64)(unsafe.Add(mBase, _consts[712]))
		if base.F64_ge(v13, float64(0)) != 0 {
			v22 = v13
		} else {
			v17 = *(*float64)(unsafe.Add(mBase, _consts[713]))
			if base.F64_ge(v17, float64(0)) != 0 {
				v22 = v17
			} else {
				v21 = *(*float64)(unsafe.Add(mBase, _consts[714]))
				v22 = v21
			}
		}
		*(*float64)(unsafe.Add(mBase, _consts[715])) = v22
		v26 = *(*int32)(unsafe.Add(mBase, _consts[716]))
		if int32(0) < v26 {
			v57 = v26
			v59 = v22
			*(*int32)(unsafe.Add(mBase, _consts[717])) = v57
			v64 = v59
			v66 = int32(*(*uint8)(unsafe.Add(mBase, _consts[718])))
			if v66 != 0 {
			} else {
				if base.F64_gt(v64, float64(0)) != 0 {
					v70 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _consts[719])) = uint8(v70)
				} else {
					v73 = int32(0)
					*(*int32)(unsafe.Add(mBase, _consts[464])) = v73
					*(*uint8)(unsafe.Add(mBase, _consts[719])) = uint8(v73)
				}
			}
			if v11 == int32(0) {
				m.G0 = v8 + int32(32)
				...
				if v114 == int32(0) {
					...
					if v124 != 0 {
						...
						v126 = *(*int32)(unsafe.Add(mBase, _consts[711]))
						...
						if v134 != 0 {
							...
							if v138 != 0 {
								...
								if v137 == int32(0) {
									...
									v142 = *(*int32)(unsafe.Add(mBase, _consts[711]))
									v143 = *(*int32)(unsafe.Add(mBase, uint32(v142)+32))
									v145 = *(*float64)(unsafe.Add(mBase, _consts[715]))
									*(*float64)(unsafe.Add(mBase, uint32(v8)+16)) = v145
									v150 = int32(*(*uint8)(unsafe.Add(mBase, _consts[718])))
									if v150 != 0 {
										v151 = int32(153850)
									} else {
										v151 = int32(235632)
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = v163
									v166 = *(*int32)(unsafe.Add(mBase, _consts[717]))
									*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = v166
									F_errmsg_internal(m, int32(645862), v8)
									mBase = m.M
									v170 = m.ExcPending
									if v170 != 0 {
										return
									} else {
										F_errfinish(m, int32(485856), int32(1710), int32(112618))
										mBase = m.M
										v175 = m.ExcPending
										if v175 != 0 {
											return
			...
			v33 = *(*int32)(unsafe.Add(mBase, _consts[721]))
			if int32(0) < v31 {
				v36 = v31
			} else {
				v36 = v33
			...
			*(*int32)(unsafe.Add(mBase, _consts[717])) = v36
			...
			if v38 == int32(0) {
				...
				v42 = *(*int32)(unsafe.Add(mBase, _consts[701]))
				v43 = *(*int32)(unsafe.Add(mBase, uint32(v42)+uint32(_consts[709])))
				if v43 <= int32(0) {
					...
					if v186 != 0 {
						...
						F_errmsg_internal(m, int32(542635), int32(0))
						mBase = m.M
						v190 = m.ExcPending
						if v190 != 0 {
							return
						} else {
							F_errfinish(m, int32(485856), int32(1754), int32(98963))
							mBase = m.M
							v195 = m.ExcPending
							if v195 != 0 {
								return
		...
		v53 = *(*float64)(unsafe.Add(mBase, _consts[714]))
		*(*float64)(unsafe.Add(mBase, _consts[715])) = v53
		v56 = *(*int32)(unsafe.Add(mBase, _consts[721]))
		v57 = v56
		v59 = v53
		*(*int32)(unsafe.Add(mBase, _consts[717])) = v57
		v64 = v59
								...
								if v37 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1 + int32(4)
									...
									if v62 != 0 {
										...
										F_errfinish(m, int32(485884), v56, int32(257559))
										mBase = m.M
										v66 = m.ExcPending
										if v66 != 0 {
											return int32(0)
