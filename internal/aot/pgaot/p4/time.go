	...
	if v9 != 0 {
		...
		if base.Ui64(v6) < base.Ui64(int64(86400000001)) {
			if base.Ui32(v4) <= base.Ui32(int32(6)) {
				...
				v18 = *(*int64)(unsafe.Add(mBase, uint32(v15)+uint32(_consts[1260])))
				v19 = v18 + v6
				v22 = *(*int64)(unsafe.Add(mBase, uint32(v15)+uint32(_consts[1261])))
			...
			if v34 != 0 {
				...
				if v37 != 0 {
					...
					F_errmsg(m, int32(422576), int32(0))
					mBase = m.M
					v41 = m.ExcPending
					if v41 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(524503), int32(1601), int32(38147))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
