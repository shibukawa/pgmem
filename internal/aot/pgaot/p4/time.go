...
L21:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v81))) = v82
	v90 = int32(*(*uint8)(unsafe.Add(mBase, _consts[947])))
	if v90 == int32(0) {
		goto L25
	} else {
		goto L26
...
L27:
	;
	v94 = int32(*(*uint8)(unsafe.Add(mBase, _consts[948])))
	if v94 == int32(0) {
		goto L28
	} else {
		goto L29
...
L65:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v236))) = v237
	v245 = int32(*(*uint8)(unsafe.Add(mBase, _consts[947])))
	if v245 == int32(0) {
		goto L68
	} else {
		goto L69
...
L70:
	;
	v249 = int32(*(*uint8)(unsafe.Add(mBase, _consts[948])))
	if v249 == int32(0) {
		goto L71
	} else {
		goto L72
	...
	if v9 != 0 {
		...
		if base.Ui64(v6) < base.Ui64(int64(86400000001)) {
			if base.Ui32(v4) <= base.Ui32(int32(6)) {
				...
				v18 = *(*int64)(unsafe.Add(mBase, uint32(v15)+uint32(_consts[1249])))
				v19 = v18 + v6
				v22 = *(*int64)(unsafe.Add(mBase, uint32(v15)+uint32(_consts[1250])))
			...
			if v34 != 0 {
				...
				if v37 != 0 {
					...
					if v41 != 0 {
						...
						F_errfinish(m, int32(495450), int32(1601), int32(36479))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
