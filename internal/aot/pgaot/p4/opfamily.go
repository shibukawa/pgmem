...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = l0
	F_errmsg_internal(m, int32(_a_F_OpfamilyIsVisibleExt_0), v13)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L2
...
L11:
	;
	F_errfinish(m, int32(_a_F_OpfamilyIsVisibleExt_1), int32(2283), int32(_a_F_OpfamilyIsVisibleExt_2))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L2
...
L15:
	;
	v46 = int32(0)
	v48 = *(*int32)(unsafe.Add(mBase, _c_F_OpfamilyIsVisibleExt[0]))
	if v48 == v46 {
		goto L19
	} else {
		goto L20
...
L32:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _c_F_OpfamilyIsVisibleExt[0]))
	if v95 == int32(0) {
		v138 = v3
		goto L33
	} else {
...
L35:
	;
	v104 = *(*int32)(unsafe.Add(mBase, _c_F_OpfamilyIsVisibleExt[1]))
	v107 = int32(0)
	v109 = v104
	v113 = v98
	goto L36
...
L42:
	...
	v128 = *(*int32)(unsafe.Add(mBase, _c_F_OpfamilyIsVisibleExt[1]))
	v129 = v128
	v130 = v126
	goto L40
L43:
