...
func F_sendTablespace(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) int64 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = int32(529025)
	v22 = F_pg_snprintf(m, v11+int32(128), int32(1024), int32(166924), v11+int32(16))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L7:
	;
	F__tarWriteHeader(m, l0, int32(529025), int32(0), v11+int32(32), l3)
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
L11:
	;
	F_errfinish(m, int32(472560), int32(1160), int32(399228))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L1
...
func F_tablespace_reloptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = F_build_reloptions(m, l0, l1, int32(128), int32(32), int32(715712), int32(4))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
