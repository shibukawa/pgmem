...
func F_ResOwnerPrintCatCache(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v13
	v30 = F_psprintf(m, int32(485947), v10)
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		return int32(0)
...
func F_ResOwnerPrintDSM(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = v7
	v10 = F_psprintf(m, int32(43524), v5)
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
		return int32(0)
...
func F_ResOwnerReleaseBufferIO(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+36)) = int32(239109)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = int32(515113)
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+108)) = int32(239109)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+104)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+100)) = int32(515113)
...
L29:
	;
	F_errdetail(m, int32(603022), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L6
...
L30:
	;
	F_errfinish(m, int32(515113), int32(6182), int32(548343))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L6
