...
func F_ResOwnerPrintCatCache(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v13
	v30 = F_psprintf(m, int32(469079), v10)
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		return int32(0)
...
func F_ResOwnerPrintDSM(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = v7
	v10 = F_psprintf(m, int32(41444), v5)
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
		return int32(0)
...
func F_ResOwnerReleaseBufferIO(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+36)) = int32(229809)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = int32(496301)
...
L3:
	;
	v53 = int32(4126684)
	v54 = *(*int32)(unsafe.Add(mBase, _consts[424]))
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[424])) = v71
	goto L10
L12:
	;
	if int32(999) < v54 {
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+108)) = int32(229809)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+104)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+100)) = int32(496301)
...
L29:
	;
	F_errdetail(m, int32(581670), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L6
...
L30:
	;
	F_errfinish(m, int32(496301), int32(6182), int32(528289))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L6
...
L34:
	;
	v170 = int32(4126684)
	v171 = *(*int32)(unsafe.Add(mBase, _consts[424]))
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25))) = v165&int32(-205520897) | int32(134217728)
	v196 = *(*int32)(unsafe.Add(mBase, _consts[915]))
...
L41:
	;
	*(*int32)(unsafe.Add(mBase, _consts[424])) = v188
	goto L40
L42:
	;
	if int32(999) < v171 {
