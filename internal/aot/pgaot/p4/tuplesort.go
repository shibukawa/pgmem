...
L2:
	;
	v20 = int32(_a_F_tuplesort_begin_index_btree_0)
	v21 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_index_btree[0]))
	v23 = *(*int32)(unsafe.Add(mBase, uint32(v16)+24))
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_index_btree[0])) = v23
...
L3:
	;
	v29 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_tuplesort_begin_index_btree[1])))
	if v29 != int32(1) {
		goto L4
	} else {
		goto L5
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+8)) = int32(102)
	F_errmsg_internal(m, int32(_a_F_tuplesort_begin_index_btree_1), v13)
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L16:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_index_btree[0]))
...
L23:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_index_btree[0])) = v21
	m.G0 = v13 + int32(16)
	return v16
}
		...
		if v28 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = v27
			...
			if v30&int32(2) == int32(0) {
				...
				v44 = (v35&int32(_a_F_tuplesort_putindextuplevalues_0) + int32(7)) & int32(_a_F_tuplesort_putindextuplevalues_1)
				v45 = int32(0)
