...
L6:
	;
	F_errmsg(m, int32(243112), int32(0))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L4
...
L9:
	;
	F_errfinish(m, int32(494975), int32(6655), int32(532823))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L4
...
L16:
	;
	F_s_lock(m, v41, int32(492410), int32(3805), int32(329273))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L4
...
L29:
	;
	F_s_lock(m, v83, int32(492410), int32(3833), int32(329292))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L4
