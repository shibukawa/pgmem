...
L9:
	;
	F_errfinish(m, int32(494925), int32(6655), int32(532773))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L4
...
L16:
	;
	F_s_lock(m, v41, int32(492360), int32(3805), int32(329273))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L4
...
L29:
	;
	F_s_lock(m, v83, int32(492360), int32(3833), int32(329292))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L4
