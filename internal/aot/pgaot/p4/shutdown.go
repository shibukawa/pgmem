...
L6:
	;
	F_errmsg(m, int32(232962), int32(0))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L4
...
L9:
	;
	F_errfinish(m, int32(476414), int32(6655), int32(513699))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L4
...
L16:
	;
	F_s_lock(m, v41, int32(474026), int32(3805), int32(315973))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L4
...
L29:
	;
	F_s_lock(m, v83, int32(474026), int32(3833), int32(315992))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L4
