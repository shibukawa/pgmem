...
L6:
	;
	F_errmsg(m, int32(232085), int32(0))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L4
...
L9:
	;
	F_errfinish(m, int32(475016), int32(6655), int32(512301))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L4
...
L16:
	;
	F_s_lock(m, v41, int32(472654), int32(3805), int32(314772))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L4
...
L29:
	;
	F_s_lock(m, v83, int32(472654), int32(3833), int32(314791))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L4
