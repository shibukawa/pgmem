...
func F_XmlTableDestroyOpaque(m *base.Module, l0 int32) {
	...
	if v5 != 0 {
		...
		if v8 != 0 {
			...
			F_errmsg(m, int32(_a_F_XmlTableDestroyOpaque_0), int32(0))
			v12 = m.ExcPending
			if v12 != 0 {
				return
			} else {
				F_errdetail(m, int32(_a_F_XmlTableDestroyOpaque_1), int32(0))
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
					F_errfinish(m, int32(_a_F_XmlTableDestroyOpaque_2), int32(_a_F_XmlTableDestroyOpaque_3), int32(_a_F_XmlTableDestroyOpaque_4))
					v21 = m.ExcPending
					if v21 != 0 {
						return
					} else {
