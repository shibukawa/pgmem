...
L10:
	;
	v57 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[516])) = uint8(v57)
	*(*int32)(unsafe.Add(mBase, uint32(v16)+52)) = v26
	*(*int32)(unsafe.Add(mBase, uint32(v16)+56)) = v25
	*(*int32)(unsafe.Add(mBase, uint32(v16)+60)) = v28
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v29
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+76)) = v37
	v90 = int32(4409004)
	v91 = *(*int32)(unsafe.Add(mBase, _consts[520]))
	*(*int32)(unsafe.Add(mBase, _consts[520])) = int32(18)
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+76)) = v105
	v127 = int32(4409004)
	v128 = *(*int32)(unsafe.Add(mBase, _consts[520]))
	*(*int32)(unsafe.Add(mBase, _consts[520])) = v110
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+76)) = v105
	v166 = int32(4409004)
	v167 = *(*int32)(unsafe.Add(mBase, _consts[520]))
	*(*int32)(unsafe.Add(mBase, _consts[520])) = v110
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+72)) = v106
	*(*int32)(unsafe.Add(mBase, uint32(v16)+76)) = v105
	F_errfinish(m, int32(494815), int32(527), int32(78809))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		v373 = v114
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v106
	F_errmsg(m, int32(298097), v16+int32(16))
	mBase = m.M
	v286 = m.ExcPending
	if v286 != 0 {
		v373 = v114
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+72)) = v106
	*(*int32)(unsafe.Add(mBase, uint32(v16)+76)) = v105
	F_errfinish(m, int32(494815), int32(539), int32(78809))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		v373 = v114
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v106
	F_errmsg(m, int32(299268), v16+int32(32))
	mBase = m.M
	v340 = m.ExcPending
	if v340 != 0 {
		v373 = v114
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+72)) = v106
	*(*int32)(unsafe.Add(mBase, uint32(v16)+76)) = v105
	F_errfinish(m, int32(494815), int32(546), int32(78809))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		v373 = v114
...
L1:
	;
	F_PreventCommandIfReadOnly(m, int32(682011))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		goto L4
...
L3:
	;
	v17 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[516])) = uint8(v17)
...
L6:
	...
	v30 = F_AllocSetContextCreateInternal(m, v25, int32(289116), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L4
...
L8:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _consts[518]))
	if int32(0) < v35 {
		goto L12
	} else {
		goto L13
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, _consts[517])) = v30
	v33 = v30
	goto L8
L10:
	;
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[518])) = v69
	*(*int32)(unsafe.Add(mBase, _consts[519])) = v75
	v81 = *(*int32)(unsafe.Add(mBase, _consts[517]))
	v83 = v70
	v85 = v81
	goto L10
L12:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _consts[519]))
	v41 = int32(0)
	goto L15
L13:
	;
...
L27:
	;
	v101 = *(*int32)(unsafe.Add(mBase, _consts[519]))
...
func F_be_lowrite(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		F_PreventCommandIfReadOnly(m, int32(683978))
		mBase = m.M
		v14 = m.ExcPending
		if v14 != 0 {
			return int32(0)
			...
			if v6 < int32(0) {
				...
				if v83 != 0 {
					...
					if v86 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v54))) = v6
						F_errmsg(m, int32(481779), v54)
						mBase = m.M
						v90 = m.ExcPending
						if v90 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(494815), int32(190), int32(349512))
							mBase = m.M
							v95 = m.ExcPending
							if v95 != 0 {
								return int32(0)
				...
				v59 = *(*int32)(unsafe.Add(mBase, _consts[518]))
				if v59 <= v6 {
					F_errstart_cold(m, int32(21), int32(0))
					mBase = m.M
					v83 = m.ExcPending
					...
					v62 = *(*int32)(unsafe.Add(mBase, _consts[519]))
							...
							if v99 != 0 {
								...
								if v102 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v54)+16)) = v6
									F_errmsg(m, int32(328865), v54+int32(16))
									mBase = m.M
									v108 = m.ExcPending
									if v108 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(494815), int32(198), int32(349512))
										mBase = m.M
										v113 = m.ExcPending
										if v113 != 0 {
											return int32(0)
