...
func F_pg_encoding_verifymbchar(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(41)) {
		v12 = *(*int32)(unsafe.Add(mBase, uint32(l0*int32(28))+uint32(_consts[1452])))
...
L26:
	;
	v100 = *(*int32)(unsafe.Add(mBase, _consts[1453]))
	goto L23
L28:
	;
	v105 = v100 + int32(8)
...
L87:
	;
	v314 = int32(0)
	v316 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1307])))
	if v316 == v314 {
		goto L88
	} else {
		goto L89
...
L91:
	;
	v330 = F___get_locale(m, v322, int32(740129))
	mBase = m.M
...
L92:
	;
	v337 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1307])) = uint8(v337)
	v341 = *(*int32)(unsafe.Add(mBase, _consts[1308]))
	*(*int32)(unsafe.Add(mBase, _consts[1309])) = v341
	goto L90
L93:
	;
	goto L92
...
L159:
	...
	v533 = *(*int32)(unsafe.Add(mBase, uint32(v530)+uint32(_consts[1454])))
	if v533 == int32(0) {
		goto L142
	} else {
		goto L161
...
L181:
	;
	F_errfinish(m, int32(497290), int32(377), int32(396485))
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		goto L178
