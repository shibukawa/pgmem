...
func F_PG_encoding_to_char(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v4) <= base.Ui32(int32(41)) {
		v13 = *(*int32)(unsafe.Add(mBase, uint32(v4<<(uint(int32(3))%32))+uint32(_c_F_PG_encoding_to_char[0])))
		v14 = v13
	} else {
		v14 = int32(_a_F_PG_encoding_to_char_0)
	}
...
func F_pg_encoding_verifymbchar(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(41)) {
		v12 = *(*int32)(unsafe.Add(mBase, uint32(l0*int32(28))+uint32(_c_F_pg_encoding_verifymbchar[0])))
...
L3:
	;
	v169 = v165
	v170 = int32(_a_F_pg_get_encoding_from_locale_0)
	goto L42
L4:
	;
	v165 = v105
...
L26:
	;
	v100 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_encoding_from_locale[0]))
	goto L23
L28:
	;
	v105 = v100 + int32(8)
...
L29:
	;
	v105 = int32(_a_F_pg_get_encoding_from_locale_0)
	goto L30
L30:
	;
	goto L5
...
L54:
	;
	v213 = v165
	v214 = int32(_a_F_pg_get_encoding_from_locale_1)
	goto L56
L55:
	;
	if v251 == int32(0) {
...
L79:
	;
	v285 = int32(_a_F_pg_get_encoding_from_locale_2)
	goto L80
L80:
	;
...
L83:
	;
	v298 = int32(_a_F_pg_get_encoding_from_locale_3)
...
L86:
	;
	v306 = int32(_a_F_pg_get_encoding_from_locale_4)
...
L87:
	;
	v314 = int32(0)
	v316 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_get_encoding_from_locale[1])))
	if v316 == v314 {
		goto L88
	} else {
		goto L89
...
L90:
	;
	v349 = int32(_a_F_pg_get_encoding_from_locale_5)
...
L91:
	;
	v330 = F___get_locale(m, v322, int32(_a_F_pg_get_encoding_from_locale_2))
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, uint32(v322<<(uint(int32(2))%32))+uint32(_c_F_pg_get_encoding_from_locale[2]))) = v330
	v333 = v322 + int32(1)
	if v333 != int32(6) {
		v322 = v333
		goto L91
...
L92:
	;
	v337 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_pg_get_encoding_from_locale[1])) = uint8(v337)
	v341 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_encoding_from_locale[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_pg_get_encoding_from_locale[3])) = v341
	goto L90
L93:
	;
	goto L92
L94:
	;
	v357 = int32(_a_F_pg_get_encoding_from_locale_6)
...
L102:
	;
	v407 = int32(_a_F_pg_get_encoding_from_locale_7)
	goto L104
L103:
	;
	v407 = int32(_a_F_pg_get_encoding_from_locale_8)
	goto L104
L104:
	;
	goto L98
...
L141:
	;
	v479 = v471
	v480 = int32(_a_F_pg_get_encoding_from_locale_9)
	goto L144
L142:
	;
	if l1 == int32(0) {
...
L157:
	;
	v588 = int32(_a_F_pg_get_encoding_from_locale_10)
	goto L158
L158:
	;
...
L159:
	...
	v533 = *(*int32)(unsafe.Add(mBase, uint32(v530)+uint32(_c_F_pg_get_encoding_from_locale[4])))
	if v533 == int32(0) {
		goto L142
	} else {
		goto L161
...
L160:
	;
	v588 = v530 + int32(_a_F_pg_get_encoding_from_locale_10)
	goto L158
L161:
	;
	v538 = v471
...
L180:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v165
	F_errmsg(m, int32(_a_F_pg_get_encoding_from_locale_11), v11)
	mBase = m.M
	v605 = m.ExcPending
	if v605 != 0 {
		goto L178
...
L181:
	;
	F_errfinish(m, int32(_a_F_pg_get_encoding_from_locale_12), int32(377), int32(_a_F_pg_get_encoding_from_locale_13))
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		goto L178
