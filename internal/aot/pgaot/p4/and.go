...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+36)) = int32(492025)
...
L15:
	;
	v112 = int32(4102492)
	v113 = *(*int32)(unsafe.Add(mBase, _consts[415]))
...
L22:
	;
	*(*int32)(unsafe.Add(mBase, _consts[415])) = v130
	goto L21
L23:
	;
	if int32(999) < v113 {
	...
	if l0 == int32(0) {
		...
		if l0 < int32(0) {
			...
			if v44 != l2 {
				...
				F_ResourceOwnerForget(m, v65, v68+int32(1), int32(1609648))
				mBase = m.M
				v73 = m.ExcPending
				if v73 != 0 {
					return int32(0)
...
func F_check_and_set_sync_info(m *base.Module, l0 int32) {
	...
	var v69 int32
	_ = v69
	v5 = *(*int32)(unsafe.Add(mBase, _consts[831]))
	v6 = *(*int32)(unsafe.Add(mBase, uint32(v5)+16))
	*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = int32(1)
	if v6 != 0 {
		v10 = *(*int32)(unsafe.Add(mBase, _consts[831]))
		F_s_lock(m, v10+int32(16), int32(496764), int32(1295), int32(240715))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
			...
			if v20 != int32(1) {
				...
				if v23 == int32(1) {
					...
					if v57 != 0 {
						...
						if v60 != 0 {
							...
							if v64 != 0 {
								...
								F_errfinish(m, int32(496764), int32(1317), int32(240715))
								mBase = m.M
								v69 = m.ExcPending
								if v69 != 0 {
									return
					...
					*(*uint8)(unsafe.Add(mBase, _consts[832])) = uint8(v29)
					return
				}
			} else {
				v34 = int32(0)
				...
				if v39 != 0 {
					...
					if v42 != 0 {
						...
						if v46 != 0 {
							...
							F_errfinish(m, int32(496764), int32(1309), int32(240715))
							mBase = m.M
							v51 = m.ExcPending
							if v51 != 0 {
								return
...
L16:
	;
	F_errfinish(m, int32(496606), int32(3147), int32(343162))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L12
...
L21:
	;
	F_errfinish(m, int32(496606), v122, int32(343162))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L12
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+80)) = v63
	F_errmsg(m, int32(709146), v16+int32(80))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L12
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v97
	F_errmsg(m, int32(656149), v16+int32(16))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L12
...
L51:
	;
	F_errfinish(m, int32(496606), v214, int32(343162))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L12
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+176)) = v151
	F_errmsg(m, int32(709146), v16+int32(176))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L12
...
L75:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v16)+96)) = v189
	F_errmsg(m, int32(656077), v16+int32(96))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L12
...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = int32(0)
	v330 = F_config_enum_get_options(m, l0, int32(726844), int32(651483), int32(727489))
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L12
...
L118:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+208)) = v338
	F_errmsg(m, int32(709146), v16+int32(208))
	mBase = m.M
	v345 = m.ExcPending
	if v345 != 0 {
		goto L12
...
L122:
	;
	F_errfinish(m, int32(496606), int32(3284), int32(343162))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L12
				...
				if v33 != 0 {
					...
					if v32 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v36
						F_errmsg(m, int32(679755), v9+int32(32))
						mBase = m.M
						v42 = m.ExcPending
						if v42 != 0 {
							return int32(0)
							...
							*(*uint32)(unsafe.Add(mBase, uint32(v9)+16)) = uint32(v46)
							F_errdetail(m, int32(638460), v9+int32(16))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
								...
								v71 = int32(598)
								F_errfinish(m, int32(496764), v71, int32(84712))
								mBase = m.M
								v74 = m.ExcPending
								if v74 != 0 {
									return int32(0)
