...
L7:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _c_F_FindAndDropRelationBuffers[0]))
	v46 = v39 + v36&int32(127)<<(uint(int32(7))%32) + int32(_a_F_FindAndDropRelationBuffers_0)
...
L8:
	;
	v50 = F_BufTableLookup(m, v35, v36)
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L6
...
L12:
	;
	v57 = *(*int32)(unsafe.Add(mBase, _c_F_FindAndDropRelationBuffers[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v13)+44)) = int32(_a_F_FindAndDropRelationBuffers_1)
	*(*int32)(unsafe.Add(mBase, uint32(v13)+40)) = int32(_a_F_FindAndDropRelationBuffers_2)
	*(*int32)(unsafe.Add(mBase, uint32(v13)+36)) = int32(_a_F_FindAndDropRelationBuffers_3)
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = int32(0)
	*(*int64)(unsafe.Add(mBase, uint32(v13)+24)) = int64(0)
	v70 = v57 + v50<<(uint(int32(6))%32)
	v71 = int32(_a_F_FindAndDropRelationBuffers_4)
	v73 = base.AtomicRmwOr32(m, v70, int32(24), v71)
	if v73&v71 != 0 {
		goto L13
	} else {
		goto L14
...
L15:
	;
	v108 = int32(_a_F_FindAndDropRelationBuffers_5)
	v109 = *(*int32)(unsafe.Add(mBase, _c_F_FindAndDropRelationBuffers[2]))
	v111 = *(*int32)(unsafe.Add(mBase, uint32(v13+int32(24))+8))
	if v111 == int32(0) {
		goto L23
	} else {
		goto L24
...
L18:
	;
	v90 = int32(_a_F_FindAndDropRelationBuffers_4)
	v92 = base.AtomicRmwOr32(m, v70, int32(24), v90)
	if v92&v90 != 0 {
		goto L16
	} else {
		goto L19
...
L20:
	;
	v128 = *(*int32)(unsafe.Add(mBase, uint32(v70)))
...
L22:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_FindAndDropRelationBuffers[2])) = v126
	goto L21
L23:
	;
	if int32(999) < v109 {
...
L32:
	;
	v131 = *(*int32)(unsafe.Add(mBase, uint32(v70)+4))
...
L33:
	;
	v134 = *(*int32)(unsafe.Add(mBase, uint32(v70)+8))
...
L34:
	;
	v137 = *(*int32)(unsafe.Add(mBase, uint32(v70)+12))
	if v137 != l1 {
		goto L31
	} else {
		goto L35
...
L35:
	;
	v139 = *(*int32)(unsafe.Add(mBase, uint32(v70)+16))
	if base.Ui32(v139) < base.Ui32(l3) {
		goto L31
	} else {
		goto L36
	}
...
func F_ReleaseAndReadBuffer(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if l0 < int32(0) {
			v11 = *(*int32)(unsafe.Add(mBase, _c_F_ReleaseAndReadBuffer[0]))
			...
			v36 = *(*int32)(unsafe.Add(mBase, _c_F_ReleaseAndReadBuffer[1]))
			v39 = v36 + l0<<(uint(int32(6))%32)
			v41 = v39 + int32(-64)
			v44 = *(*int32)(unsafe.Add(mBase, uint32(v39-int32(48))))
			if v44 != l2 {
				v65 = *(*int32)(unsafe.Add(mBase, _c_F_ReleaseAndReadBuffer[2]))
				v68 = *(*int32)(unsafe.Add(mBase, uint32(v39-int32(44))))
				F_ResourceOwnerForget(m, v65, v68+int32(1), int32(_a_F_ReleaseAndReadBuffer_0))
				mBase = m.M
				v73 = m.ExcPending
				if v73 != 0 {
					return int32(0)
...
func F_check_and_set_sync_info(m *base.Module, l0 int32) {
	...
	if v7 != 0 {
		v9 = *(*int32)(unsafe.Add(mBase, _c_F_check_and_set_sync_info[0]))
		F_s_lock(m, v9+int32(16), int32(_a_F_check_and_set_sync_info_0), int32(1295), int32(_a_F_check_and_set_sync_info_1))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
		} else {
			v18 = *(*int32)(unsafe.Add(mBase, _c_F_check_and_set_sync_info[0]))
			v19 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v18)+4)))
			if v19 != int32(1) {
				v22 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v18)+5)))
				if v22 == int32(1) {
					v53 = int32(0)
					atomic.StoreUint32((*uint32)(unsafe.Add(mBase, uint32(v18)+16)), uint32(v53))
					F_errstart_cold(m, int32(21), v53)
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return
						...
						if v62 != 0 {
							...
							F_errmsg(m, int32(_a_F_check_and_set_sync_info_2), int32(0))
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return
							} else {
								F_errfinish(m, int32(_a_F_check_and_set_sync_info_0), int32(1317), int32(_a_F_check_and_set_sync_info_1))
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v18))) = l0
					v26 = int32(1)
					*(*uint8)(unsafe.Add(mBase, uint32(v18)+5)) = uint8(v26)
					v28 = int32(0)
					atomic.StoreUint32((*uint32)(unsafe.Add(mBase, uint32(v18)+16)), uint32(v28))
					*(*uint8)(unsafe.Add(mBase, _c_F_check_and_set_sync_info[1])) = uint8(v26)
					return
				}
			} else {
				v34 = int32(0)
				atomic.StoreUint32((*uint32)(unsafe.Add(mBase, uint32(v18)+16)), uint32(v34))
				...
				if v40 != 0 {
					...
					if v43 != 0 {
						...
						F_errmsg(m, int32(_a_F_check_and_set_sync_info_3), int32(0))
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return
						} else {
							F_errfinish(m, int32(_a_F_check_and_set_sync_info_0), int32(1309), int32(_a_F_check_and_set_sync_info_1))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v34
	F_errmsg(m, int32(_a_F_parse_and_validate_value_0), v16)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L16:
	;
	F_errfinish(m, int32(_a_F_parse_and_validate_value_1), int32(3147), int32(_a_F_parse_and_validate_value_2))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L12
...
L21:
	;
	F_errfinish(m, int32(_a_F_parse_and_validate_value_1), v122, int32(_a_F_parse_and_validate_value_2))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L12
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+80)) = v63
	F_errmsg(m, int32(_a_F_parse_and_validate_value_3), v16+int32(80))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L12
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v72
	F_errhint(m, int32(_a_F_parse_and_validate_value_4), v16-int32(-64))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L12
...
L43:
	;
	v106 = int32(_a_F_parse_and_validate_value_6)
	goto L45
L44:
	;
	v106 = int32(_a_F_parse_and_validate_value_5)
	goto L45
L45:
	;
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v97
	F_errmsg(m, int32(_a_F_parse_and_validate_value_7), v16+int32(16))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L12
...
L51:
	;
	F_errfinish(m, int32(_a_F_parse_and_validate_value_1), v214, int32(_a_F_parse_and_validate_value_2))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L12
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+176)) = v151
	F_errmsg(m, int32(_a_F_parse_and_validate_value_3), v16+int32(176))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L12
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+160)) = v160
	F_errhint(m, int32(_a_F_parse_and_validate_value_4), v16+int32(160))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L12
...
L73:
	;
	v198 = int32(_a_F_parse_and_validate_value_6)
	goto L75
L74:
	;
	v198 = int32(_a_F_parse_and_validate_value_5)
	goto L75
L75:
	;
	...
	*(*float64)(unsafe.Add(mBase, uint32(v16)+96)) = v189
	F_errmsg(m, int32(_a_F_parse_and_validate_value_8), v16+int32(96))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L12
...
L92:
	;
	v363 = *(*int32)(unsafe.Add(mBase, uint32(v261)+4))
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = v363
	v365 = F_call_enum_check_hook(m, l0, l4, l5, l2, l3)
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L12
...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = int32(0)
	v331 = F_config_enum_get_options(m, l0, int32(_a_F_parse_and_validate_value_9), int32(_a_F_parse_and_validate_value_10), int32(_a_F_parse_and_validate_value_11))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L12
...
L94:
	;
	v251 = *(*int32)(unsafe.Add(mBase, uint32(v248)))
	if v251 == int32(0) {
		goto L93
	} else {
		goto L95
...
L111:
	;
	v310 = *(*int32)(unsafe.Add(mBase, uint32(v261)+12))
	if v310 != 0 {
		v261 = v261 + int32(12)
		v263 = v310
		goto L96
...
L118:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+208)) = v339
	F_errmsg(m, int32(_a_F_parse_and_validate_value_3), v16+int32(208))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L12
...
L120:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v16)+192)) = v331
	F_errhint(m, int32(_a_F_parse_and_validate_value_4), v16+int32(192))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L12
...
L122:
	;
	F_errfinish(m, int32(_a_F_parse_and_validate_value_1), int32(3284), int32(_a_F_parse_and_validate_value_2))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L12
				...
				if v33 != 0 {
					...
					if v32 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v36
						F_errmsg(m, int32(_a_F_update_and_persist_local_synced_slot_0), v9+int32(32))
						mBase = m.M
						v42 = m.ExcPending
						if v42 != 0 {
							return int32(0)
							...
							*(*uint32)(unsafe.Add(mBase, uint32(v9)+16)) = uint32(v46)
							F_errdetail(m, int32(_a_F_update_and_persist_local_synced_slot_1), v9+int32(16))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
								...
								v71 = int32(598)
								F_errfinish(m, int32(_a_F_update_and_persist_local_synced_slot_2), v71, int32(_a_F_update_and_persist_local_synced_slot_3))
								mBase = m.M
								v74 = m.ExcPending
								if v74 != 0 {
									return int32(0)
