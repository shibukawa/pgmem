...
L12:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v13)+24)) = int64(0)
	...
	v74 = int32(_a_F_FindAndDropRelationBuffers_4)
...
L15:
	;
	v112 = int32(_a_F_FindAndDropRelationBuffers_5)
	v113 = *(*int32)(unsafe.Add(mBase, _c_F_FindAndDropRelationBuffers[2]))
...
L18:
	...
	v94 = int32(_a_F_FindAndDropRelationBuffers_4)
...
L22:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_FindAndDropRelationBuffers[2])) = v130
	goto L21
L23:
	;
	if int32(999) < v113 {
...
L3:
	;
	v304 = *(*int32)(unsafe.Add(mBase, uint32(l0)+100))
	if v304 == int32(0) {
		goto L110
	} else {
		goto L111
...
L84:
	;
	v296 = F_call_string_check_hook(m, l0, l4, l5, l2, l3)
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L12
...
L85:
	;
	F_truncate_identifier(m, v228, v292, int32(1))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L12
...
L88:
	;
	v243 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v228))))
	if v243 == int32(0) {
		goto L89
	} else {
		goto L90
...
L107:
	;
	v301 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = v301
	v444 = v301
	goto L1
L108:
	;
...
L109:
	;
	v418 = *(*int32)(unsafe.Add(mBase, uint32(v314)+4))
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = v418
	v420 = F_call_enum_check_hook(m, l0, l4, l5, l2, l3)
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L12
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = int32(0)
	v386 = F_config_enum_get_options(m, l0, int32(_a_F_parse_and_validate_value_9), int32(_a_F_parse_and_validate_value_10), int32(_a_F_parse_and_validate_value_11))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L12
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+208)) = v394
...
L137:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v16)+192)) = v386
