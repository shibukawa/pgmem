...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+44)) = int32(215570)
	*(*int32)(unsafe.Add(mBase, uint32(v13)+40)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v13)+36)) = int32(464766)
	...
	if l0 == int32(0) {
		...
		if l0 < int32(0) {
			...
			if v44 != l2 {
				...
				F_ResourceOwnerForget(m, v65, v68+int32(1), int32(1577392))
				mBase = m.M
				v73 = m.ExcPending
				if v73 != 0 {
					return int32(0)
...
func F_check_and_set_sync_info(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = int32(1)
	if v6 != 0 {
		...
		F_s_lock(m, v10+int32(16), int32(469255), int32(1295), int32(226892))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
					...
					if v57 != 0 {
						...
						if v60 != 0 {
							...
							if v64 != 0 {
								...
								F_errfinish(m, int32(469255), int32(1317), int32(226892))
								mBase = m.M
								v69 = m.ExcPending
								if v69 != 0 {
									return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v34
				...
				if v39 != 0 {
					...
					if v42 != 0 {
						...
						F_errmsg(m, int32(313623), int32(0))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return
						} else {
							F_errfinish(m, int32(469255), int32(1309), int32(226892))
							mBase = m.M
							v51 = m.ExcPending
							if v51 != 0 {
								return
...
L16:
	;
	F_errfinish(m, int32(469097), int32(3147), int32(323874))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L12
...
L21:
	;
	F_errfinish(m, int32(469097), v122, int32(323874))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L12
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+80)) = v63
	F_errmsg(m, int32(677148), v16+int32(80))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L12
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v72
	F_errhint(m, int32(193943), v16-int32(-64))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L12
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v97
	F_errmsg(m, int32(624787), v16+int32(16))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L12
...
L51:
	;
	F_errfinish(m, int32(469097), v214, int32(323874))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L12
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+176)) = v151
	F_errmsg(m, int32(677148), v16+int32(176))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L12
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+160)) = v160
	F_errhint(m, int32(193943), v16+int32(160))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L12
...
L75:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v16)+96)) = v189
	F_errmsg(m, int32(624715), v16+int32(96))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L12
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = int32(0)
	v386 = F_config_enum_get_options(m, l0, int32(694666), int32(620121), int32(695311))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L12
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+208)) = v394
	F_errmsg(m, int32(677148), v16+int32(208))
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L12
...
L137:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+192)) = v386
	F_errhint(m, int32(193943), v16+int32(192))
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L12
...
L139:
	;
	F_errfinish(m, int32(469097), int32(3284), int32(323874))
	mBase = m.M
	v412 = m.ExcPending
	if v412 != 0 {
		goto L12
				...
				if v33 != 0 {
					...
					if v32 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v36
						F_errmsg(m, int32(647795), v9+int32(32))
						mBase = m.M
						v42 = m.ExcPending
						if v42 != 0 {
							return int32(0)
							...
							*(*uint32)(unsafe.Add(mBase, uint32(v9)+16)) = uint32(v46)
							F_errdetail(m, int32(607170), v9+int32(16))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
								...
								v71 = int32(598)
								F_errfinish(m, int32(469255), v71, int32(79729))
								mBase = m.M
								v74 = m.ExcPending
								if v74 != 0 {
									return int32(0)
