...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l4))) = int32(0)
	v330 = F_config_enum_get_options(m, l0, int32(_a_F_parse_and_validate_value_9), int32(_a_F_parse_and_validate_value_10), int32(_a_F_parse_and_validate_value_11))
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L12
