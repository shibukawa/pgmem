...
func F_SaveCachedPlan(m *base.Module, l0 int32) {
	...
	if v4 != int32(1) {
		...
		if v7 == int32(0) {
			...
			v60 = *(*int32)(unsafe.Add(mBase, _consts[470]))
			if v60 != 0 {
				v62 = *(*int32)(unsafe.Add(mBase, _consts[1380]))
				v67 = v62
			} else {
				v64 = int32(4127072)
				*(*int32)(unsafe.Add(mBase, _consts[470])) = v64
				v67 = v64
			}
			...
			*(*int32)(unsafe.Add(mBase, _consts[1380])) = v72
			v76 = int32(1)
		...
		if v81 != 0 {
			...
			F_errmsg_internal(m, int32(284127), int32(0))
			mBase = m.M
			v85 = m.ExcPending
			if v85 != 0 {
				return
			} else {
				F_errfinish(m, int32(500719), int32(539), int32(284408))
				mBase = m.M
				v90 = m.ExcPending
				if v90 != 0 {
					return
							...
							if v80 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10))) = v79
								...
								if v84 != 0 {
									...
									F_errfinish(m, int32(497189), int32(2504), int32(366666))
									mBase = m.M
									v89 = m.ExcPending
									if v89 != 0 {
										return int32(0)
