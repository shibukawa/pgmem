...
func F_xlog_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0, 1:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v20)+96)) = base.I32_wrap_i64(int64(base.Ui64(v33) >> (uint(int64(32)) % 64)))
		F_appendStringInfo(m, l0, int32(195540), v20+int32(96))
		mBase = m.M
		v81 = m.ExcPending
		if v81 != 0 {
			return
		...
		if v93&int32(-32) == int32(-96) {
			...
			case 0:
				...
				*(*uint32)(unsafe.Add(mBase, uint32(v20)+48)) = uint32(v103)
				F_appendStringInfo(m, l0, int32(506703), v20+int32(48))
				mBase = m.M
				v109 = m.ExcPending
				if v109 != 0 {
					return
				...
				if v93 <= int32(-113) {
					...
					case 0:
						...
						if v189 != 0 {
							...
							*(*uint32)(unsafe.Add(mBase, uint32(v20)+16)) = uint32(v193)
							F_appendStringInfo(m, l0, int32(191058), v20+int32(16))
							mBase = m.M
							v199 = m.ExcPending
							if v199 != 0 {
								return
					...
					case 16:
						...
						*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v209
						F_appendStringInfo(m, l0, int32(182834), v20+int32(32))
						mBase = m.M
						v215 = m.ExcPending
						if v215 != 0 {
							return
						...
						if v25 != int32(144) {
							...
							if v170 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v20))) = v166
								F_appendStringInfo(m, l0, int32(182804), v20)
								mBase = m.M
								v185 = m.ExcPending
								if v185 != 0 {
									return
			...
			case 16:
				...
				*(*int32)(unsafe.Add(mBase, uint32(v20)+64)) = v116
				F_appendStringInfo(m, l0, int32(173498), v20-int32(-64))
				mBase = m.M
				v149 = m.ExcPending
				if v149 != 0 {
					return
