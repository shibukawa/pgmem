...
L11:
	;
	F_errfinish(m, int32(490543), int32(2950), int32(63474))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
func F_check_commit_ts_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_check_slru_buffers(m, int32(132620), l0)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
			...
			if v13 != 0 {
				...
				if v30 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = int64(85899345924)
					v37 = F_hash_create(m, int32(392423), int32(16), v5, int32(40))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return int32(0)
				...
				if v19 != 0 {
					...
					F_errmsg_internal(m, int32(104410), int32(0))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(490277), int32(568), int32(331568))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
...
L31:
	;
	F_errfinish(m, int32(490543), int32(2910), int32(426324))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
							...
							if v42 != 0 {
								...
								if v45 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = v41
									F_errmsg(m, int32(188492), v7)
									mBase = m.M
									v50 = m.ExcPending
									if v50 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(485578), int32(643), int32(481185))
										mBase = m.M
										v55 = m.ExcPending
										if v55 != 0 {
											return int32(0)
...
L65:
	;
	F_errfinish(m, int32(486376), int32(471), int32(82678))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(486376), int32(394), int32(82725))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L1
