...
L11:
	;
	F_errfinish(m, int32(525427), int32(2950), int32(70262))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
func F_check_commit_ts_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_check_slru_buffers(m, int32(143997), l0)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_getTSCurrentConfig(m *base.Module) int32 {
	...
	v5 = v3 - int32(48)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1393]))
	if v8 == int32(0) {
		v12 = *(*int32)(unsafe.Add(mBase, _consts[1394]))
		if v12 != 0 {
			v13 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v12))))
			if v13 != 0 {
				v30 = *(*int32)(unsafe.Add(mBase, _consts[1395]))
				if v30 != 0 {
					v57 = *(*int32)(unsafe.Add(mBase, _consts[1394]))
					...
					if v60 != 0 {
						...
						if v63 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[1393])) = v62
							v65 = v62
							m.G0 = v5 + int32(48)
							return v65
						}
					...
					*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = int64(85899345924)
					v37 = F_hash_create(m, int32(419296), int32(16), v5, int32(40))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return int32(0)
					} else {
						*(*int32)(unsafe.Add(mBase, _consts[1395])) = v37
						F_CacheRegisterSyscacheCallback(m, int32(74), int32(1616), v37)
						mBase = m.M
						v43 = m.ExcPending
						if v43 != 0 {
							return int32(0)
						} else {
							v47 = *(*int32)(unsafe.Add(mBase, _consts[1395]))
							F_CacheRegisterSyscacheCallback(m, int32(72), int32(1616), v47)
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return int32(0)
				...
				if v19 != 0 {
					...
					F_errmsg_internal(m, int32(113663), int32(0))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(525135), int32(568), int32(355225))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
...
L31:
	;
	F_errfinish(m, int32(525427), int32(2910), int32(455560))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
							...
							if v42 != 0 {
								...
								if v45 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = v41
									F_errmsg(m, int32(202557), v7)
									mBase = m.M
									v50 = m.ExcPending
									if v50 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(519586), int32(643), int32(513878))
										mBase = m.M
										v55 = m.ExcPending
										if v55 != 0 {
											return int32(0)
...
func F_ts_dist(m *base.Module, l0 int32) int32 {
	...
	if base.Ui64(int64(2)) <= base.Ui64(v4-int64(9223372036854775807)) {
		...
		if base.Ui64(int64(1)) < base.Ui64(v10-int64(9223372036854775807)) {
			v28 = F_DirectFunctionCall2Coll(m, int32(1520), int32(0), v3, v9)
			mBase = m.M
			v29 = m.ExcPending
			if v29 != 0 {
				return int32(0)
...
func F_ts_headline_json_byid(m *base.Module, l0 int32) int32 {
	...
	v7 = F_DirectFunctionCall3Coll(m, int32(1193), int32(0), v4, v5, v6)
	mBase = m.M
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
...
L24:
	;
	v123 = *(*int32)(unsafe.Add(mBase, _consts[496]))
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v80)+8)) = int32(1191)
	*(*int32)(unsafe.Add(mBase, uint32(v80)+4)) = v129
	*(*int32)(unsafe.Add(mBase, uint32(v77)+36)) = int32(1399)
	*(*int32)(unsafe.Add(mBase, uint32(v77)+16)) = int32(1400)
	*(*int32)(unsafe.Add(mBase, uint32(v77)+12)) = int32(1401)
	*(*int32)(unsafe.Add(mBase, uint32(v77)+8)) = int32(1402)
	*(*int32)(unsafe.Add(mBase, uint32(v77)+4)) = int32(1403)
	*(*int32)(unsafe.Add(mBase, uint32(v77))) = v80
	*(*int32)(unsafe.Add(mBase, uint32(v77)+28)) = int32(1404)
	*(*int32)(unsafe.Add(mBase, uint32(v77)+20)) = int32(1405)
...
L65:
	;
	F_errfinish(m, int32(520601), int32(471), int32(90269))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L1
...
func F_ts_headline_jsonb_byid(m *base.Module, l0 int32) int32 {
	...
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v6 = *(*int32)(unsafe.Add(mBase, uint32(l0)+36))
	v7 = F_DirectFunctionCall3Coll(m, int32(1192), int32(0), v4, v5, v6)
	mBase = m.M
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
...
L75:
	;
	F_errfinish(m, int32(520601), int32(394), int32(90316))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L1
