...
L11:
	;
	F_errfinish(m, int32(498918), int32(2950), int32(64248))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
func F_check_commit_ts_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_check_slru_buffers(m, int32(134898), l0)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_getTSCurrentConfig(m *base.Module) int32 {
	...
	v5 = v3 - int32(48)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1396]))
	if v8 == int32(0) {
		v12 = *(*int32)(unsafe.Add(mBase, _consts[1397]))
		if v12 != 0 {
			v13 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v12))))
			if v13 != 0 {
				v30 = *(*int32)(unsafe.Add(mBase, _consts[1398]))
				if v30 != 0 {
					v57 = *(*int32)(unsafe.Add(mBase, _consts[1397]))
					...
					if v60 != 0 {
						...
						if v63 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[1396])) = v62
							v65 = v62
							m.G0 = v5 + int32(48)
							return v65
						}
					...
					*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = int64(85899345924)
					v37 = F_hash_create(m, int32(398817), int32(16), v5, int32(40))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return int32(0)
					} else {
						*(*int32)(unsafe.Add(mBase, _consts[1398])) = v37
						...
						if v43 != 0 {
							...
							v47 = *(*int32)(unsafe.Add(mBase, _consts[1398]))
				...
				if v19 != 0 {
					...
					F_errmsg_internal(m, int32(106244), int32(0))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(498652), int32(568), int32(336976))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
...
L31:
	;
	F_errfinish(m, int32(498918), int32(2910), int32(433250))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
							...
							if v42 != 0 {
								...
								if v45 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = v41
									F_errmsg(m, int32(191317), v7)
									mBase = m.M
									v50 = m.ExcPending
									if v50 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(493849), int32(643), int32(489377))
										mBase = m.M
										v55 = m.ExcPending
										if v55 != 0 {
											return int32(0)
...
L65:
	;
	F_errfinish(m, int32(494663), int32(471), int32(83722))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(494663), int32(394), int32(83769))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L1
