...
L11:
	;
	F_errfinish(m, int32(491828), int32(2950), int32(63687))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
L15:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _consts[379]))
	v45 = int32(0)
	if v44 == v45 {
		goto L19
	} else {
...
L17:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _consts[379]))
	if v87 == int32(0) {
		v138 = v3
		goto L14
	} else {
...
L36:
	...
	v110 = *(*int32)(unsafe.Add(mBase, _consts[251]))
	if v108 != v110 {
		goto L38
	} else {
		goto L39
...
func F_check_commit_ts_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_check_slru_buffers(m, int32(132969), l0)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_getTSCurrentConfig(m *base.Module) int32 {
	...
	v5 = v3 - int32(48)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1386]))
	if v8 == int32(0) {
		v12 = *(*int32)(unsafe.Add(mBase, _consts[1387]))
		if v12 != 0 {
			v13 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v12))))
			if v13 != 0 {
				v30 = *(*int32)(unsafe.Add(mBase, _consts[1388]))
				if v30 != 0 {
					v57 = *(*int32)(unsafe.Add(mBase, _consts[1387]))
					...
					if v60 != 0 {
						...
						if v63 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[1386])) = v62
							v65 = v62
							m.G0 = v5 + int32(48)
							return v65
						}
					...
					*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = int64(85899345924)
					v37 = F_hash_create(m, int32(393461), int32(16), v5, int32(40))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return int32(0)
					} else {
						*(*int32)(unsafe.Add(mBase, _consts[1388])) = v37
						...
						if v43 != 0 {
							...
							v47 = *(*int32)(unsafe.Add(mBase, _consts[1388]))
							...
							if v49 != 0 {
								...
								v51 = *(*int32)(unsafe.Add(mBase, _consts[373]))
								if v51 != 0 {
									v57 = *(*int32)(unsafe.Add(mBase, _consts[1387]))
									v59 = F_stringToQualifiedNameList(m, v57, int32(0))
									mBase = m.M
				...
				if v19 != 0 {
					...
					F_errmsg_internal(m, int32(104715), int32(0))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(491562), int32(568), int32(332318))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
...
L15:
	;
	v33 = int32(0)
	v35 = *(*int32)(unsafe.Add(mBase, _consts[379]))
	if v35 == v33 {
		v83 = v33
		goto L4
	} else {
...
L31:
	;
	F_errfinish(m, int32(491828), int32(2910), int32(427383))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
							...
							if v42 != 0 {
								...
								if v45 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = v41
									F_errmsg(m, int32(188892), v7)
									mBase = m.M
									v50 = m.ExcPending
									if v50 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(486863), int32(643), int32(482459))
										mBase = m.M
										v55 = m.ExcPending
										if v55 != 0 {
											return int32(0)
...
L24:
	;
	v123 = *(*int32)(unsafe.Add(mBase, _consts[485]))
...
L65:
	;
	F_errfinish(m, int32(487661), int32(471), int32(82937))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(487661), int32(394), int32(82984))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L1
