...
L11:
	;
	F_errfinish(m, int32(525873), int32(2950), int32(70273))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
func F_check_commit_ts_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_check_slru_buffers(m, int32(144110), l0)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_getTSCurrentConfig(m *base.Module) int32 {
	...
	v5 = v3 - int32(48)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1389]))
	if v8 == int32(0) {
		v12 = *(*int32)(unsafe.Add(mBase, _consts[1390]))
		if v12 != 0 {
			v13 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v12))))
			if v13 != 0 {
				v30 = *(*int32)(unsafe.Add(mBase, _consts[1391]))
				if v30 != 0 {
					v57 = *(*int32)(unsafe.Add(mBase, _consts[1390]))
					...
					if v60 != 0 {
						...
						if v63 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[1389])) = v62
							v65 = v62
							m.G0 = v5 + int32(48)
							return v65
						}
					...
					*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = int64(85899345924)
					v37 = F_hash_create(m, int32(419717), int32(16), v5, int32(40))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, _consts[1391])) = v37
						...
						if v43 != 0 {
							...
							v47 = *(*int32)(unsafe.Add(mBase, _consts[1391]))
				...
				if v19 != 0 {
					...
					F_errmsg_internal(m, int32(113674), int32(0))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(525581), int32(568), int32(355571))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return int32(0)
...
L31:
	;
	F_errfinish(m, int32(525873), int32(2910), int32(456001))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
							...
							if v42 != 0 {
								...
								if v45 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = v41
									F_errmsg(m, int32(202721), v7)
									mBase = m.M
									v50 = m.ExcPending
									if v50 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(520027), int32(643), int32(514319))
										mBase = m.M
										v55 = m.ExcPending
										if v55 != 0 {
											return int32(0)
...
L24:
	;
	v123 = *(*int32)(unsafe.Add(mBase, _consts[492]))
...
L65:
	;
	F_errfinish(m, int32(521042), int32(471), int32(90280))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(521042), int32(394), int32(90327))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L1
