...
L58:
	;
	v242 = base.F64_sub(v218, base.F64_convert_i32_s(v231*int32(_a_F_interval_mul_3)))
	v244 = v232
	goto L46
L59:
	;
...
L20:
	;
	v65 = v14 + int32(44)
	v72 = *(*int32)(unsafe.Add(mBase, _c_F_interval_trunc[0]))
	if v72 != 0 {
		goto L23
	} else {
		goto L24
...
L22:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_interval_trunc[0])) = v116
...
L25:
	...
	v83 = int32(_a_F_interval_trunc_0)
	v85 = int32(_a_F_interval_trunc_1)
	goto L27
L26:
	;
	goto L25
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v62
	F_errmsg(m, int32(_a_F_interval_trunc_2), v14+int32(16))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
...
L60:
	;
	F_errdetail(m, int32(_a_F_interval_trunc_3), int32(0))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L1
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v62
	F_errmsg(m, int32(_a_F_interval_trunc_7), v14+int32(32))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L1
...
L68:
	;
	F_errfinish(m, int32(_a_F_interval_trunc_4), int32(_a_F_interval_trunc_8), int32(_a_F_interval_trunc_6))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L1
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v62
	F_errmsg(m, int32(_a_F_interval_trunc_2), v14)
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
		goto L1
...
L107:
	;
	F_errmsg(m, int32(_a_F_interval_trunc_10), int32(0))
	mBase = m.M
	v390 = m.ExcPending
	if v390 != 0 {
		goto L1
...
L108:
	;
	F_errfinish(m, int32(_a_F_interval_trunc_4), int32(_a_F_interval_trunc_11), int32(_a_F_interval_trunc_6))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L1
