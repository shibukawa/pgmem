			...
			if v45 == int32(0) {
				...
				if v106 != 0 {
					...
					if v110 != 0 {
						...
						F_errfinish(m, int32(479085), int32(3992), int32(341361))
						mBase = m.M
						v115 = m.ExcPending
						if v115 != 0 {
							return int32(0)
...
func F_interval_avg_accum_inv(m *base.Module, l0 int32) int32 {
	...
	if v5 != 0 {
		...
		if v65 != 0 {
			...
			F_errmsg_internal(m, int32(340622), int32(0))
			mBase = m.M
			v69 = m.ExcPending
			if v69 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(479085), int32(4216), int32(31136))
				mBase = m.M
				v74 = m.ExcPending
				if v74 != 0 {
					return int32(0)
	...
	if v40 != 0 {
		...
		if v118 != 0 {
			...
			if v122 != 0 {
				...
				F_errfinish(m, int32(479085), int32(4172), int32(329509))
				mBase = m.M
				v127 = m.ExcPending
				if v127 != 0 {
					return int32(0)
...
L50:
	;
	F_errfinish(m, int32(479085), int32(2964), int32(297792))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L1
...
L54:
	;
	F_errfinish(m, int32(479085), int32(2981), int32(297792))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L1
...
L77:
	;
	F_errfinish(m, int32(479085), int32(3740), int32(289203))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L1
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v62
	F_errmsg(m, int32(182600), v14+int32(16))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
...
L60:
	;
	F_errdetail(m, int32(560847), int32(0))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(479085), int32(5181), int32(473192))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L1
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v62
	F_errmsg(m, int32(182563), v14+int32(32))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L1
...
L68:
	;
	F_errfinish(m, int32(479085), int32(5246), int32(473192))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L1
...
L90:
	;
	F_errfinish(m, int32(479085), int32(5233), int32(473192))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L1
...
L108:
	;
	F_errfinish(m, int32(479085), int32(5239), int32(473192))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L1
...
L28:
	;
	F_errfinish(m, int32(479085), int32(3459), int32(300185))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L25
