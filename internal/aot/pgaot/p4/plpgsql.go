...
func F_plpgsql_add_initdatums(m *base.Module, l0 int32) int32 {
	...
	_ = v212
	v2 = int32(0)
	v17 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[0]))
	v20 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[1]))
	if v17 < v20 {
		v22 = v20 - v17
		v24 = v22 & int32(3)
		v26 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[2]))
		...
		if l0 == int32(0) {
			v208 = v124
			v212 = v20
			*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[0])) = v212
			return v208
		} else {
			if v124 <= int32(0) {
				v193 = v124
				...
				*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[0])) = v212
				...
				if v145 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(l0))) = v142
					v147 = int32(0)
					v151 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[0]))
					v154 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[1]))
					if v154 <= v151 {
						v208 = v147
						v212 = v154
					} else {
						v157 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[2]))
						v159 = v147
						v160 = v151
						v163 = v154
						for {
							...
							case 0, 2:
								...
								*(*int32)(unsafe.Add(mBase, uint32(v142+v159<<(uint(int32(2))%32)))) = v179
								v184 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_add_initdatums[1]))
								v185 = v159 + int32(1)
								v186 = v184
							default:
								v185 = v159
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(2)
		...
		if v15 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = v14
			v25 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_record[0]))
			v28 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_record[1]))
			v31 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_record[2]))
			if v28 == v31 {
				*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_record[2])) = v28 << (uint(int32(1)) % 32)
				...
				if v44 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_record[0])) = v43
					v48 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_record[1]))
					v49 = v48
					v50 = v43
					*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v49
					*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_build_record[1])) = v49 + int32(1)
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_fulfill_promise[0])) = v16
	switch v13 - int32(1) {
	case 0:
		goto L28
	case 1:
...
L43:
	;
	v74 = F_cstring_to_text(m, int32(_a_F_plpgsql_fulfill_promise_8))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L30
...
L45:
	;
	v81 = F_cstring_to_text(m, int32(_a_F_plpgsql_fulfill_promise_9))
	mBase = m.M
	v82 = m.ExcPending
	if v82 != 0 {
		goto L30
...
L84:
	...
	if v214 != int32(_a_F_plpgsql_fulfill_promise_14) {
		goto L83
	} else {
		goto L85
	}
...
L93:
	...
	v255 = *(*int32)(unsafe.Add(mBase, uint32(v250<<(uint(int32(3))%32))+uint32(_c_F_plpgsql_fulfill_promise[1])))
	goto L94
L94:
	;
					...
					if v63 != 0 {
						...
						if v66 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v61
							F_errmsg(m, int32(_a_F_plpgsql_param_eval_generic_ro_1), v8)
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return
					...
					*(*uint16)(unsafe.Add(mBase, uint32(l3)+6)) = uint16(v73)
					...
					case 0:
						...
						if v76 == int32(0) {
							...
							if v80 == int32(_a_F_plpgsql_param_fetch_0) {
...
L4:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_dblword[0]))
	if v30 == int32(1) {
		goto L6
	} else {
		goto L7
...
L7:
	;
	v34 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_dblword[1]))
	v38 = v10 + int32(28)
	if v34 == int32(0) {
		goto L12
	} else {
...
L46:
	;
	v197 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_dblword[2]))
...
L47:
	;
	v183 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_dblword[2]))
...
L43:
	;
	v168 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_word[2]))
...
L1:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_parse_wordtype[1]))
