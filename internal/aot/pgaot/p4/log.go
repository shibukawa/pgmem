...
L2:
	;
	F_errfinish(m, int32(_a_F_LogChildExit_0), v240, int32(_a_F_LogChildExit_1))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L39
...
L57:
	;
	v199 = int32(_a_F_LogChildExit_7)
	goto L58
L58:
	;
	goto L49
...
func F_log_heap_prune_and_freeze(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32, l9 int32, l10 int32, l11 int32, l12 int32) {
	...
	v14 = int32(0)
	v21 = m.G0
	v23 = v21 - int32(_a_F_log_heap_prune_and_freeze_0)
	m.G0 = v23
	*(*int32)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[0]))) = l2
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))) = uint8(v14)
	F_XLogBeginInsert(m)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
...
L4:
	;
	v36 = int32(16)
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))) = uint8(v36)
...
L22:
	;
	v182 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))))
	v184 = v182 | int32(32)
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))) = uint8(v184)
...
L27:
	;
	v200 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))))
	v202 = v200 | int32(64)
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))) = uint8(v202)
...
L32:
	;
	v218 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))))
	v220 = v218 | int32(128)
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))) = uint8(v220)
...
L39:
	;
	v244 = *(*int32)(unsafe.Add(mBase, _c_F_log_heap_prune_and_freeze[2]))
	if v244 < int32(2) {
		goto L41
	} else {
		goto L42
...
L41:
	;
	v272 = *(*int32)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[0])))
	if v272 != 0 {
		goto L51
	} else {
		goto L52
...
L44:
	;
	if base.B2i32(base.Ui32(v251) < base.Ui32(int32(_a_F_log_heap_prune_and_freeze_1))) == int32(0) {
		goto L45
	} else {
		goto L46
	}
...
L47:
	;
	v267 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))))
	v269 = v267 | int32(2)
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))) = uint8(v269)
	goto L41
L48:
	;
...
L51:
	;
	v273 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))))
	v275 = v273 | int32(8)
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))) = uint8(v275)
	goto L53
L52:
	;
	goto L53
...
L54:
	;
	v277 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))))
	v279 = v277 | int32(4)
	*(*uint8)(unsafe.Add(mBase, uint32(v23)+uint32(_c_F_log_heap_prune_and_freeze[1]))) = uint8(v279)
	goto L56
L55:
	;
	goto L56
L56:
	;
	F_XLogRegisterData(m, v23+int32(_a_F_log_heap_prune_and_freeze_2), int32(2))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L1
...
L58:
	;
	F_XLogRegisterData(m, v23+int32(_a_F_log_heap_prune_and_freeze_3), int32(4))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L1
...
L66:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v319))) = base.I64_rotr(v300, int64(32))
	m.G0 = v23 + int32(_a_F_log_heap_prune_and_freeze_0)
	return
L67:
	;
	v305 = *(*int32)(unsafe.Add(mBase, _c_F_log_heap_prune_and_freeze[3]))
...
L69:
	;
	v313 = *(*int32)(unsafe.Add(mBase, _c_F_log_heap_prune_and_freeze[4]))
	v319 = v313 + l1<<(uint(int32(13))%32) + int32(-8192)
	goto L66
L70:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = l4
	F_errmsg_internal(m, int32(_a_F_log_heap_prune_and_freeze_4), v23)
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L1
...
func F_log_invalid_page(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v12 != int32(1) {
		v64 = int32(14)
		v71 = *(*int32)(unsafe.Add(mBase, _c_F_log_invalid_page[1]))
		if v71 == int32(15) {
			v83 = int32(0)
			...
			if v87 != int32(2) {
				...
				if v91 != 0 {
					...
					v95 = *(*int32)(unsafe.Add(mBase, _c_F_log_invalid_page[4]))
		...
		if v98 == int32(0) {
			v133 = *(*int32)(unsafe.Add(mBase, _c_F_log_invalid_page[5]))
			if v133 == int32(0) {
				*(*int64)(unsafe.Add(mBase, uint32(v9)+56)) = int64(103079215124)
				v141 = int32(40)
				v144 = F_hash_create(m, int32(_a_F_log_invalid_page_0), int32(100), v9+v141, v141)
				mBase = m.M
				v145 = m.ExcPending
				if v145 != 0 {
					return
				} else {
					*(*int32)(unsafe.Add(mBase, _c_F_log_invalid_page[5])) = v144
					v147 = v144
			...
			if v26 != 0 {
				...
				if v25 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = v9 + int32(40)
					if v4 != 0 {
						v33 = int32(_a_F_log_invalid_page_1)
					} else {
						v33 = int32(_a_F_log_invalid_page_2)
					}
					...
					if v37 != 0 {
						...
						F_errfinish(m, int32(_a_F_log_invalid_page_3), v41, int32(_a_F_log_invalid_page_4))
						mBase = m.M
						v44 = m.ExcPending
						if v44 != 0 {
							return
						} else {
							v48 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_log_invalid_page[6])))
							if v48 != 0 {
								v49 = int32(19)
							} else {
								v49 = int32(23)
