...
L2:
	;
	F_errfinish(m, int32(506777), v240, int32(101628))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L39
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v228
	F_errdetail(m, int32(206909), v13)
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L39
...
L5:
	;
	v16 = v13 - int32(-64)
	v18 = *(*int32)(unsafe.Add(mBase, _consts[778]))
	if v18 == int32(0) {
		goto L9
	} else {
		goto L10
...
L11:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[780]))
	if v27 <= int32(0) {
		goto L9
	} else {
		goto L12
...
L18:
	;
	v45 = *(*int32)(unsafe.Add(mBase, _consts[781]))
	v48 = *(*int32)(unsafe.Add(mBase, _consts[782]))
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = int32(base.Ui32(l3)>>(uint(int32(8))%32)) & int32(255)
	F_errmsg(m, int32(487695), v13+int32(16))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L39
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = l1
	F_errmsg(m, int32(208514), v13+int32(32))
	mBase = m.M
	v208 = m.ExcPending
	if v208 != 0 {
		goto L39
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = l1
	F_errmsg(m, int32(478989), v13+int32(48))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L39
...
func F_assign_log_connections(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[1204])) = v4
	return
}
func F_assign_log_timezone(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v4
	v4 = *(*int32)(unsafe.Add(mBase, uint32(l1)))
	*(*int32)(unsafe.Add(mBase, _consts[489])) = v4
	return
}
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = l4
	F_errmsg_internal(m, int32(493125), v23)
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L1
...
L71:
	;
	F_errfinish(m, int32(507607), int32(2166), int32(350245))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L1
...
func F_log_invalid_page(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	v9 = v7 - int32(112)
	m.G0 = v9
	v12 = int32(*(*uint8)(unsafe.Add(mBase, _consts[314])))
	if v12 != int32(1) {
		v64 = int32(14)
		v71 = *(*int32)(unsafe.Add(mBase, _consts[224]))
		if v71 == int32(15) {
			v83 = int32(0)
			v87 = *(*int32)(unsafe.Add(mBase, _consts[225]))
			if v87 != int32(2) {
				v98 = v83
			} else {
				v91 = int32(*(*uint8)(unsafe.Add(mBase, _consts[226])))
				if v91 != 0 {
					v98 = v83
				} else {
					v95 = *(*int32)(unsafe.Add(mBase, _consts[227]))
		...
		if v98 == int32(0) {
			v133 = *(*int32)(unsafe.Add(mBase, _consts[299]))
			if v133 == int32(0) {
				*(*int64)(unsafe.Add(mBase, uint32(v9)+56)) = int64(103079215124)
				v141 = int32(40)
				v144 = F_hash_create(m, int32(402846), int32(100), v9+v141, v141)
				mBase = m.M
				v145 = m.ExcPending
				if v145 != 0 {
					return
				} else {
					*(*int32)(unsafe.Add(mBase, _consts[299])) = v144
					v147 = v144
					...
					if v112 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v9 + int32(40)
						...
						if v124 != 0 {
							...
							F_errfinish(m, int32(505228), v128, int32(415988))
							mBase = m.M
							v131 = m.ExcPending
							if v131 != 0 {
								return
				...
				if v25 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = v9 + int32(40)
					...
					if v37 != 0 {
						...
						F_errfinish(m, int32(505228), v41, int32(415988))
						mBase = m.M
						v44 = m.ExcPending
						if v44 != 0 {
							return
						} else {
							v48 = int32(*(*uint8)(unsafe.Add(mBase, _consts[315])))
							if v48 != 0 {
								v49 = int32(19)
							} else {
								v49 = int32(23)
							...
							if v52 != 0 {
								...
								if v51 == int32(0) {
									...
									if v58 != 0 {
										...
										F_errfinish(m, int32(505228), int32(120), int32(416008))
										mBase = m.M
										v63 = m.ExcPending
										if v63 != 0 {
											return
