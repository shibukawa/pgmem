	...
	if v12 != 0 {
		...
		if base.Ui32(l2) < base.Ui32(int32(_a_F_SpGistGetBuffer_0)) {
			...
			if v15 != 0 {
				...
				v22 = base.I32_div_s(int32(_a_F_SpGistGetBuffer_1)-v17<<(uint(int32(13))%32), int32(100))
				v24 = v22
			} else {
				v24 = int32(1638)
			}
			...
			if v32 == int32(-1) {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(l3))) = uint8(v35)
				...
				v40 = int32(_a_F_SpGistGetBuffer_2)
				v41 = l2 + v24
					...
					if v48 != 0 {
						...
						if v50 != 0 {
							...
							if v49 == int32(0) {
								...
								if v47 < int32(0) {
									v63 = *(*int32)(unsafe.Add(mBase, _c_F_SpGistGetBuffer[0]))
									v69 = *(*int32)(unsafe.Add(mBase, uint32(v63+(v47^int32(-1))<<(uint(int32(2))%32))))
									v77 = v69
								} else {
									v71 = *(*int32)(unsafe.Add(mBase, _c_F_SpGistGetBuffer[1]))
								...
								if v78 == int32(0) {
									...
									if v47 < int32(0) {
										v104 = *(*int32)(unsafe.Add(mBase, _c_F_SpGistGetBuffer[0]))
										v110 = *(*int32)(unsafe.Add(mBase, uint32(v104+(v47^int32(-1))<<(uint(int32(2))%32))))
										v118 = v110
									} else {
										v112 = *(*int32)(unsafe.Add(mBase, _c_F_SpGistGetBuffer[1]))
										v118 = v112 + v47<<(uint(int32(13))%32) + int32(-8192)
									}
									if v118&int32(3) != 0 {
									} else {
									}
									v145 = F___memset(m, v118, int32(0), int32(_a_F_SpGistGetBuffer_3))
									mBase = m.M
									*(*int32)(unsafe.Add(mBase, uint32(v118)+10)) = int32(_a_F_SpGistGetBuffer_4)
									v151 = int32(_a_F_SpGistGetBuffer_5)
									*(*uint16)(unsafe.Add(mBase, uint32(v118)+18)) = uint16(v151)
									v157 = int32(_a_F_SpGistGetBuffer_6)
									...
									*(*uint16)(unsafe.Add(mBase, uint32(v118)+14)) = uint16(v157)
									...
									v161 = v118 + v160
									v162 = int32(_a_F_SpGistGetBuffer_7)
