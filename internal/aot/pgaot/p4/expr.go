	...
	*(*int32)(unsafe.Add(mBase, _consts[28])) = v9
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v18
		v24 = F_AllocSetContextCreateInternal(m, v18, int32(61859), int32(0), int32(8192), int32(8388608))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return
		...
		if base.Ui32(int32(9)) < base.Ui32(v9) {
			...
			if int32(base.Ui32(int32(977))>>(uint(v9)%32))&int32(1) == int32(0) {
				...
				if l1 < int32(0) {
					...
					v24 = *(*int32)(unsafe.Add(mBase, uint32(v9<<(uint(int32(2))%32))+uint32(_consts[1354])))
