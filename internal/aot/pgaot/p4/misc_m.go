					...
					if v27 != 0 {
						...
						if v30 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12))) = v29
							F_errmsg(m, int32(369680), v12)
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(494637), int32(155), int32(230350))
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return int32(0)
						...
						if v49 != 0 {
							...
							if v52 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v51
								F_errmsg(m, int32(369680), v12+int32(16))
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(494637), int32(181), int32(230350))
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
...
L23:
	;
	F_errfinish(m, int32(497590), int32(829), int32(321410))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L20
...
L25:
	;
	F_errmsg_internal(m, int32(291956), int32(0))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L20
...
L26:
	;
	F_errfinish(m, int32(497590), int32(851), int32(321410))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L20
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v18
	v79 = F_pg_sprintf(m, v73, int32(176924), v8)
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L20
...
L37:
	;
	F_errfinish(m, int32(497590), int32(866), int32(321410))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L20
...
L41:
	;
	F_errfinish(m, int32(497590), int32(883), int32(321410))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L20
...
L25:
	;
	F_errmsg_internal(m, int32(112642), int32(0))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L22
...
L26:
	;
	F_errfinish(m, int32(493293), int32(66), int32(21072))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L22
...
L62:
	;
	F_errfinish(m, int32(495534), int32(134), int32(24410))
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L10
...
L20:
	;
	F_errfinish(m, int32(495159), int32(3991), int32(247017))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L10
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = v72
	F_errmsg(m, int32(454785), v9-int32(-64))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L10
...
L33:
	;
	F_errfinish(m, int32(495159), int32(4005), int32(247017))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L10
...
L94:
	;
	F_errfinish(m, int32(495159), v254, int32(247017))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L10
...
L114:
	;
	F_errfinish(m, int32(495159), v319, int32(247017))
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L10
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, _consts[832])) = v34
	...
	F_SetConfigOption(m, int32(100509), v368, int32(4), int32(10))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L10
...
L138:
	;
	F_errfinish(m, int32(495159), int32(4067), int32(247017))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L10
			...
			if v57 == int32(0) {
				...
				if v64 != 0 {
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(556916)
						v70 = *(*int32)(unsafe.Add(mBase, uint32(v7)+12))
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						F_errmsg(m, int32(202627), v7)
						mBase = m.M
						v74 = m.ExcPending
						if v74 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(494576), int32(49), int32(63326))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
