...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(93)
	v30 = F_pg_sprintf(m, v11+int32(10), int32(39028), v11)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
...
L46:
	;
	v159 = *(*int32)(unsafe.Add(mBase, _consts[1185]))
					...
					if v27 != 0 {
						...
						if v30 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12))) = v29
							F_errmsg(m, int32(365849), v12)
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(489483), int32(155), int32(228257))
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return int32(0)
						...
						if v49 != 0 {
							...
							if v52 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v51
								F_errmsg(m, int32(365849), v12+int32(16))
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(489483), int32(181), int32(228257))
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
...
L23:
	;
	F_errfinish(m, int32(492430), int32(829), int32(318260))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L20
...
L25:
	;
	F_errmsg_internal(m, int32(288989), int32(0))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L20
...
L26:
	;
	F_errfinish(m, int32(492430), int32(851), int32(318260))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L20
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v18
	v191 = F_pg_sprintf(m, v185, int32(175378), v8)
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L20
...
L71:
	;
	F_errfinish(m, int32(492430), int32(866), int32(318260))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L20
...
L75:
	;
	F_errfinish(m, int32(492430), int32(883), int32(318260))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L20
...
L25:
	;
	F_errmsg_internal(m, int32(111617), int32(0))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L22
...
L26:
	;
	F_errfinish(m, int32(488149), int32(66), int32(20976))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L22
...
L5:
	...
	v45 = *(*int32)(unsafe.Add(mBase, _consts[486]))
	v46 = *(*int32)(unsafe.Add(mBase, uint32(v45)+4))
	goto L13
L6:
	;
...
L15:
	;
	v55 = *(*int32)(unsafe.Add(mBase, uint32(v46*int32(28))+uint32(_consts[1295])))
	v56 = v55
	goto L17
L16:
	;
...
L54:
	...
	v294 = *(*int32)(unsafe.Add(mBase, uint32((v286^v267&int32(255))<<(uint(int32(2))%32))+uint32(_consts[1342])))
...
L62:
	;
	F_errfinish(m, int32(490380), int32(134), int32(24314))
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L10
...
func F_maybe_reread_subscription(m *base.Module) {
	...
	v9 = v7 - int32(80)
	m.G0 = v9
	v12 = int32(*(*uint8)(unsafe.Add(mBase, _consts[845])))
	if v12 == int32(0) {
		goto L3
	} else {
		goto L4
...
L9:
	...
	v28 = *(*int32)(unsafe.Add(mBase, _consts[846]))
	*(*int32)(unsafe.Add(mBase, _consts[28])) = v28
	v31 = *(*int32)(unsafe.Add(mBase, _consts[819]))
...
L19:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _consts[819]))
...
L20:
	;
	F_errfinish(m, int32(490005), int32(3991), int32(244692))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L10
...
L33:
	;
	F_errfinish(m, int32(490005), int32(4005), int32(244692))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L10
...
L41:
	;
	v289 = *(*int32)(unsafe.Add(mBase, _consts[823]))
...
L42:
	;
	v230 = *(*int32)(unsafe.Add(mBase, _consts[819]))
...
L85:
	;
	v270 = *(*int32)(unsafe.Add(mBase, _consts[819]))
...
L86:
	;
	v256 = *(*int32)(unsafe.Add(mBase, _consts[823]))
...
L94:
	;
	F_errfinish(m, int32(490005), v254, int32(244692))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L10
...
L104:
	;
	v295 = *(*int32)(unsafe.Add(mBase, _consts[819]))
...
L105:
	;
	v335 = *(*int32)(unsafe.Add(mBase, _consts[819]))
...
L106:
	;
	v321 = *(*int32)(unsafe.Add(mBase, _consts[823]))
...
L114:
	;
	F_errfinish(m, int32(490005), v319, int32(244692))
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L10
...
L117:
	;
	v343 = *(*int32)(unsafe.Add(mBase, _consts[823]))
	v344 = v343
	goto L102
L118:
	;
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, _consts[823])) = v34
	v368 = *(*int32)(unsafe.Add(mBase, uint32(v34)+44))
	F_SetConfigOption(m, int32(99672), v368, int32(4), int32(10))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L10
...
L130:
	;
	v378 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[845])) = uint8(v378)
	goto L5
L131:
	;
	goto L130
...
L137:
	;
	v401 = *(*int32)(unsafe.Add(mBase, _consts[819]))
	v402 = *(*int32)(unsafe.Add(mBase, uint32(v401)+32))
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v402
	F_errmsg_internal(m, int32(20359), v9+int32(16))
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L10
...
L138:
	;
	F_errfinish(m, int32(490005), int32(4067), int32(244692))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L10
			...
			if v57 == int32(0) {
				...
				if v64 != 0 {
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(544445)
						v70 = *(*int32)(unsafe.Add(mBase, uint32(v7)+12))
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						F_errmsg(m, int32(201007), v7)
						mBase = m.M
						v74 = m.ExcPending
						if v74 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(489422), int32(49), int32(62966))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
...
L4:
	;
	v392 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1186])))
	v395 = m.G0
	v397 = v395 - int32(16)
	m.G0 = v397
	if v392 != 0 {
...
L5:
	...
	v38 = *(*int32)(unsafe.Add(mBase, _consts[944]))
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(109)
	v174 = F_pg_sprintf(m, v11+int32(26), int32(39028), v11)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
...
L121:
	;
	v536 = int32(4457088)
	v537 = *(*int64)(unsafe.Add(mBase, _consts[1187]))
	*(*int64)(unsafe.Add(mBase, _consts[1187])) = v537 + base.I64_extend_i32_u(v420)
	v542 = int32(4456128)
	v543 = *(*int64)(unsafe.Add(mBase, _consts[1188]))
	*(*int64)(unsafe.Add(mBase, _consts[1188])) = v543 + v422
	F_pgstat_count_backend_io_op(m, int32(0), int32(3), v420, v420, v422)
	mBase = m.M
	v548 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[145])) = uint8(v548)
	*(*uint8)(unsafe.Add(mBase, _consts[874])) = uint8(v548)
	m.G0 = v428 + int32(16)
	goto L118
L122:
	;
	v491 = int32(4458048)
	v492 = *(*int64)(unsafe.Add(mBase, _consts[1189]))
	*(*int64)(unsafe.Add(mBase, _consts[1189])) = v492 + v439
...
L134:
	;
	v514 = int32(4454944)
	v515 = *(*int64)(unsafe.Add(mBase, _consts[1190]))
	*(*int64)(unsafe.Add(mBase, _consts[1190])) = v515 + v439
	v519 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[145])) = uint8(v519)
	*(*uint8)(unsafe.Add(mBase, _consts[877])) = uint8(v519)
	goto L132
}
...
L202:
	...
	v2403 = int32(2)
	v2407 = *(*int32)(unsafe.Add(mBase, uint32(v2379<<(uint(v2403)%32))+uint32(_consts[1300])))
