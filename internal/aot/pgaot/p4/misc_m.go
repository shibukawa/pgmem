...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(93)
	v30 = F_pg_sprintf(m, v11+int32(10), int32(36333), v11)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
					...
					if v27 != 0 {
						...
						if v30 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12))) = v29
							F_errmsg(m, int32(347526), v12)
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(464564), int32(155), int32(216570))
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return int32(0)
						...
						if v49 != 0 {
							...
							if v52 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v51
								F_errmsg(m, int32(347526), v12+int32(16))
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(464564), int32(181), int32(216570))
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
...
L23:
	;
	F_errfinish(m, int32(467281), int32(829), int32(302074))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L20
...
L25:
	;
	F_errmsg_internal(m, int32(274010), int32(0))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L20
...
L26:
	;
	F_errfinish(m, int32(467281), int32(851), int32(302074))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L20
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v18
	v191 = F_pg_sprintf(m, v185, int32(165202), v8)
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L20
...
L71:
	;
	F_errfinish(m, int32(467281), int32(866), int32(302074))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L20
...
L75:
	;
	F_errfinish(m, int32(467281), int32(883), int32(302074))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L20
...
L25:
	;
	F_errmsg_internal(m, int32(103769), int32(0))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L22
...
L26:
	;
	F_errfinish(m, int32(463258), int32(66), int32(19476))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L22
...
L20:
	;
	F_errfinish(m, int32(465060), int32(3991), int32(231701))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L10
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = v72
	F_errmsg(m, int32(427627), v9-int32(-64))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L10
...
L33:
	;
	F_errfinish(m, int32(465060), int32(4005), int32(231701))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L10
...
L94:
	;
	F_errfinish(m, int32(465060), v254, int32(231701))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L10
...
L114:
	;
	F_errfinish(m, int32(465060), v319, int32(231701))
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L10
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, _consts[822])) = v34
	...
	F_SetConfigOption(m, int32(93323), v368, int32(4), int32(10))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L10
...
L137:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v402
	F_errmsg_internal(m, int32(19018), v9+int32(16))
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L10
...
L138:
	;
	F_errfinish(m, int32(465060), int32(4067), int32(231701))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L10
			...
			if v57 == int32(0) {
				...
				if v64 != 0 {
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(517951)
						v70 = *(*int32)(unsafe.Add(mBase, uint32(v7)+12))
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						F_errmsg(m, int32(190585), v7)
						mBase = m.M
						v74 = m.ExcPending
						if v74 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(464503), int32(49), int32(59847))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(109)
	v174 = F_pg_sprintf(m, v11+int32(26), int32(36333), v11)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
...
L202:
	...
	v2403 = int32(2)
	v2407 = *(*int32)(unsafe.Add(mBase, uint32(v2379<<(uint(v2403)%32))+uint32(_consts[1298])))
