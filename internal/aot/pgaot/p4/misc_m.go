...
func F_MarkAsPreparingGuts(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int64, l4 int32, l5 int32) {
	...
	var v245 int32
	_ = v245
	v24 = *(*int32)(unsafe.Add(mBase, _c_F_MarkAsPreparingGuts[0]))
...
L1:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v29))) = int64(0)
	v71 = *(*int32)(unsafe.Add(mBase, _c_F_MarkAsPreparingGuts[1]))
...
L11:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+8)) = l3
	v171 = *(*int32)(unsafe.Add(mBase, _c_F_MarkAsPreparingGuts[2]))
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+56)) = v72
	v75 = *(*int32)(unsafe.Add(mBase, _c_F_MarkAsPreparingGuts[2]))
	v78 = v75
	goto L11
L13:
	;
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(93)
	v30 = F_pg_sprintf(m, v11+int32(10), int32(_a_F__mdfd_openseg_0), v11)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
...
L29:
	;
	v122 = *(*int32)(unsafe.Add(mBase, _c_F__mdfd_openseg[0]))
	if v122&int32(1) != 0 {
		goto L33
	} else {
		goto L34
...
L33:
	;
	v125 = int32(_a_F__mdfd_openseg_1)
	goto L35
L34:
	;
	v125 = int32(2)
...
L46:
	;
	v159 = *(*int32)(unsafe.Add(mBase, _c_F__mdfd_openseg[1]))
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v166)+16)) = v166
	v172 = int32(_a_F_make_oper_cache_key_0)
	v173 = *(*int32)(unsafe.Add(mBase, _c_F_make_oper_cache_key[0]))
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_make_oper_cache_key[0])) = v187
	goto L51
L51:
	;
	goto L45
L52:
	;
	v197 = *(*int32)(unsafe.Add(mBase, _c_F_make_oper_cache_key[1]))
	if v197 == int32(0) {
		v232 = v189
		goto L53
	} else {
...
L55:
	;
	v204 = *(*int32)(unsafe.Add(mBase, _c_F_make_oper_cache_key[2]))
	v205 = v189
	v208 = v189
	goto L56
L56:
...
L15:
	;
	v55 = *(*int32)(unsafe.Add(mBase, uint32(v46*int32(28))+uint32(_c_F_make_trigrams[1])))
	v56 = v55
	goto L17
L16:
	;
...
L54:
	...
	v294 = *(*int32)(unsafe.Add(mBase, uint32((v286^v267&int32(255))<<(uint(int32(2))%32))+uint32(_c_F_make_trigrams[2])))
	v295 = v270<<(uint(v274)%32)&int32(_a_F_make_trigrams_0) | v271<<(uint(v278)%32)&int32(16711680) | v272<<(uint(v283)%32) ^ v294
	v302 = int32(1)
	v305 = v264 - v302
	if v305 != 0 {
		v260 = v260 + v302
...
L13:
	...
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_makesearch[0]))
	if v35 != 0 {
		goto L14
	} else {
		goto L15
...
L18:
	...
	v104 = *(*int32)(unsafe.Add(mBase, _c_F_makesearch[0]))
	if v104 != 0 {
		goto L40
	} else {
		goto L41
...
L27:
	...
	if v56 != v33&int32(_a_F_makesearch_0) {
		goto L26
	} else {
		goto L28
	}
...
L35:
	...
	if v77 != v33&int32(_a_F_makesearch_0) {
		goto L34
	} else {
		goto L36
	}
...
L53:
	...
	if v125 != v102&int32(_a_F_makesearch_0) {
		goto L52
	} else {
		goto L54
	}
...
L61:
	...
	if v146 != v102&int32(_a_F_makesearch_0) {
		goto L60
	} else {
		goto L62
	}
...
L108:
	;
	if int32(1)<<(uint(v290)%32)&int32(_a_F_makesearch_1) == int32(0) {
		goto L106
	} else {
		goto L109
	}
...
L27:
	...
	v105 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[5]))
...
L41:
	;
	v289 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[5]))
...
L42:
	;
	v230 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[4]))
...
L85:
	;
	v270 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[4]))
...
L86:
	;
	v256 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[5]))
...
L91:
	;
	v253 = int32(_a_F_maybe_reread_subscription_5)
	v254 = int32(4036)
	goto L86
L92:
	;
...
L93:
	;
	v253 = int32(_a_F_maybe_reread_subscription_6)
	v254 = int32(4040)
	goto L86
L94:
	;
	F_errfinish(m, int32(_a_F_maybe_reread_subscription_2), v254, int32(_a_F_maybe_reread_subscription_3))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L10
...
L104:
	;
	v295 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[4]))
...
L105:
	;
	v335 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[4]))
...
L106:
	;
	v321 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[5]))
...
L111:
	;
	v318 = int32(_a_F_maybe_reread_subscription_7)
	v319 = int32(4054)
	goto L106
L112:
	;
...
L113:
	;
	v318 = int32(_a_F_maybe_reread_subscription_8)
	v319 = int32(4058)
	goto L106
L114:
	;
	F_errfinish(m, int32(_a_F_maybe_reread_subscription_2), v319, int32(_a_F_maybe_reread_subscription_3))
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L10
...
L117:
	;
	v343 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[5]))
	v344 = v343
	goto L102
L118:
	;
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[5])) = v34
	...
	F_SetConfigOption(m, int32(_a_F_maybe_reread_subscription_9), v368, int32(4), int32(10))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L10
...
L130:
	;
	v378 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[0])) = uint8(v378)
	goto L5
L131:
	;
	goto L130
...
L137:
	;
	v401 = *(*int32)(unsafe.Add(mBase, _c_F_maybe_reread_subscription[4]))
			...
			if v57 == int32(0) {
				...
				if v64 != 0 {
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(_a_F_md5_text_0)
						v70 = *(*int32)(unsafe.Add(mBase, uint32(v7)+12))
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						F_errmsg(m, int32(_a_F_md5_text_1), v7)
						mBase = m.M
						v74 = m.ExcPending
						if v74 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_md5_text_2), int32(49), int32(_a_F_md5_text_3))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
...
func F_mdcbuf_free(m *base.Module, l0 int32) {
	...
	if v7 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+116)) = v9
		v13 = F___memset(m, l0, v9, int32(_a_F_mdcbuf_free_0))
		mBase = m.M
		F_pfree(m, l0)
		mBase = m.M
		v15 = m.ExcPending
...
L4:
	;
	v392 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_mdsyncfiletag[0])))
	v395 = m.G0
	v397 = v395 - int32(16)
	m.G0 = v397
	if v392 != 0 {
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v11 + int32(109)
	v174 = F_pg_sprintf(m, v11+int32(26), int32(_a_F_mdsyncfiletag_0), v11)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
...
L72:
	;
	v381 = *(*int32)(unsafe.Add(mBase, _c_F_mdsyncfiletag[2]))
	if v381&int32(1) != 0 {
		goto L104
	} else {
		goto L105
...
L104:
	;
	v384 = int32(_a_F_mdsyncfiletag_1)
	goto L106
L105:
	;
	v384 = int32(2)
...
L113:
	;
	v414 = *(*int32)(unsafe.Add(mBase, _c_F_mdsyncfiletag[3]))
...
L118:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_mdsyncfiletag[3])) = v414
	v559 = v411
	goto L3
L119:
	;
...
L121:
	;
	v536 = int32(_a_F_mdsyncfiletag_2)
	v537 = *(*int64)(unsafe.Add(mBase, _c_F_mdsyncfiletag[4]))
	*(*int64)(unsafe.Add(mBase, _c_F_mdsyncfiletag[4])) = v537 + base.I64_extend_i32_u(v420)
	v542 = int32(_a_F_mdsyncfiletag_3)
	v543 = *(*int64)(unsafe.Add(mBase, _c_F_mdsyncfiletag[5]))
	*(*int64)(unsafe.Add(mBase, _c_F_mdsyncfiletag[5])) = v543 + v422
	F_pgstat_count_backend_io_op(m, int32(0), int32(3), v420, v420, v422)
	mBase = m.M
	v548 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_mdsyncfiletag[6])) = uint8(v548)
	*(*uint8)(unsafe.Add(mBase, _c_F_mdsyncfiletag[7])) = uint8(v548)
	m.G0 = v428 + int32(16)
	goto L118
L122:
	;
	v491 = int32(_a_F_mdsyncfiletag_4)
	v492 = *(*int64)(unsafe.Add(mBase, _c_F_mdsyncfiletag[8]))
	*(*int64)(unsafe.Add(mBase, _c_F_mdsyncfiletag[8])) = v492 + v439
	v496 = *(*int32)(unsafe.Add(mBase, _c_F_mdsyncfiletag[9]))
...
L133:
	;
	if int32(1)<<(uint(v496)%32)&int32(_a_F_mdsyncfiletag_5) == int32(0) {
		goto L132
	} else {
		goto L134
	}
L134:
	;
	v514 = int32(_a_F_mdsyncfiletag_6)
	v515 = *(*int64)(unsafe.Add(mBase, _c_F_mdsyncfiletag[10]))
	*(*int64)(unsafe.Add(mBase, _c_F_mdsyncfiletag[10])) = v515 + v439
	v519 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_mdsyncfiletag[6])) = uint8(v519)
	*(*uint8)(unsafe.Add(mBase, _c_F_mdsyncfiletag[11])) = uint8(v519)
	goto L132
}
...
L22:
	...
	v173 = v156 & v172
	if base.B2i32(v173 != int32(_a_F_miss_1))|base.B2i32(v102&int32(2) != int32(0)) != 0 {
		goto L24
	} else {
		goto L25
	}
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1406+v1510))) = v1513*int32(_a_F_mul_var_0) + v1516
	v1529 = v1408
	goto L97
L108:
	;
...
L110:
	...
	v1556 = v1554 * int32(_a_F_mul_var_0)
	v1558 = int32(1)
...
L136:
	...
	v1856 = v1852*int32(_a_F_mul_var_0) + v1855
	if v1856 == int32(0) {
		v2197 = v1845
		goto L138
	} else {
...
L202:
	...
	v2403 = int32(2)
	v2407 = *(*int32)(unsafe.Add(mBase, uint32(v2379<<(uint(v2403)%32))+uint32(_c_F_mul_var[0])))
...
L211:
	;
	v2420 = v2415 + int32(_a_F_mul_var_3)
	goto L213
L212:
	;
	v2420 = v2415
...
L215:
	...
	v2445 = base.B2i32(int32(_a_F_mul_var_4) < v2443)
	if int32(_a_F_mul_var_4) < v2443 {
		goto L217
	} else {
		goto L218
	}
