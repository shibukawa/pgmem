					...
					if v27 != 0 {
						...
						if v30 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v12))) = v29
							F_errmsg(m, int32(370288), v12)
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(495323), int32(155), int32(230643))
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return int32(0)
						...
						if v49 != 0 {
							...
							if v52 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v51
								F_errmsg(m, int32(370288), v12+int32(16))
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(495323), int32(181), int32(230643))
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
...
L23:
	;
	F_errfinish(m, int32(498293), int32(829), int32(321864))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L20
...
L25:
	;
	F_errmsg_internal(m, int32(292403), int32(0))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L20
...
L26:
	;
	F_errfinish(m, int32(498293), int32(851), int32(321864))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L20
...
L37:
	;
	F_errfinish(m, int32(498293), int32(866), int32(321864))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L20
...
L41:
	;
	F_errfinish(m, int32(498293), int32(883), int32(321864))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L20
...
L26:
	;
	F_errfinish(m, int32(493961), int32(66), int32(21088))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L22
...
L62:
	;
	F_errfinish(m, int32(496220), int32(134), int32(24426))
	mBase = m.M
	v407 = m.ExcPending
	if v407 != 0 {
		goto L10
...
L20:
	;
	F_errfinish(m, int32(495845), int32(3991), int32(247347))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L10
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = v72
	F_errmsg(m, int32(455442), v9-int32(-64))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L10
...
L33:
	;
	F_errfinish(m, int32(495845), int32(4005), int32(247347))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L10
...
L94:
	;
	F_errfinish(m, int32(495845), v254, int32(247347))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L10
...
L114:
	;
	F_errfinish(m, int32(495845), v319, int32(247347))
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L10
...
L138:
	;
	F_errfinish(m, int32(495845), int32(4067), int32(247347))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L10
			...
			if v57 == int32(0) {
				...
				if v64 != 0 {
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(557637)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						...
						if v74 != 0 {
							...
							F_errfinish(m, int32(495262), int32(49), int32(63368))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
