										...
										if v139 != 0 {
											...
											if v142 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v141
												F_errmsg(m, int32(189668), v9+int32(16))
												mBase = m.M
												v148 = m.ExcPending
												if v148 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(494106), int32(1426), int32(401569))
													mBase = m.M
													v153 = m.ExcPending
													if v153 != 0 {
														return int32(0)
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v21
	F_errmsg_internal(m, int32(370382), v11)
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L1
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v211
	F_errmsg(m, int32(189668), v11+int32(16))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L1
...
L40:
	;
	F_errfinish(m, int32(494106), int32(1490), int32(460960))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L1
...
L53:
	;
	F_errfinish(m, int32(494076), int32(1894), int32(420472))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+84)) = int32(1617852)
	goto L48
L47:
	;
	goto L48
