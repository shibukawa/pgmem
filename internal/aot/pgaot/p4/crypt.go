			...
			if l0 != 0 {
				if base.Ui32(l0-int32(32)) < base.Ui32(int32(-28)) {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+5)) = uint8(v35)
					...
					v39 = int32(2)
					v42 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v38)>>(uint(v39)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+7)) = uint8(v42)
					v44 = int32(4)
					v48 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+1)))
					v53 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v38<<(uint(v44)%32)&v28|int32(base.Ui32(v48)>>(uint(v44)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+8)) = uint8(v53)
					v55 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+2)))
					v56 = int32(63)
					v59 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v55&v56)+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+10)) = uint8(v59)
					v63 = int32(60)
					v65 = int32(6)
					v69 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v48<<(uint(v39)%32)&v63|int32(base.Ui32(v55)>>(uint(v65)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+9)) = uint8(v69)
					v71 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+3)))
					v75 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v71)>>(uint(v39)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+11)) = uint8(v75)
					v81 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+4)))
					v86 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v71<<(uint(v44)%32)&v28|int32(base.Ui32(v81)>>(uint(v44)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+12)) = uint8(v86)
					v88 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+5)))
					v92 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v88&v56)+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+14)) = uint8(v92)
					v102 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v81<<(uint(v39)%32)&v63|int32(base.Ui32(v88)>>(uint(v65)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+13)) = uint8(v102)
					v104 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+6)))
					v108 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v104)>>(uint(v39)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+15)) = uint8(v108)
					v114 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+7)))
					v119 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v104<<(uint(v44)%32)&v28|int32(base.Ui32(v114)>>(uint(v44)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+16)) = uint8(v119)
					v121 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+8)))
					v125 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v121&v56)+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+18)) = uint8(v125)
					v135 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v114<<(uint(v39)%32)&v63|int32(base.Ui32(v121)>>(uint(v65)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+17)) = uint8(v135)
					v137 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+9)))
					v141 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v137)>>(uint(v39)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+19)) = uint8(v141)
					v147 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+10)))
					v152 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v137<<(uint(v44)%32)&v28|int32(base.Ui32(v147)>>(uint(v44)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+20)) = uint8(v152)
					v154 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+11)))
					v158 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v154&v56)+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+22)) = uint8(v158)
					v168 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v147<<(uint(v39)%32)&v63|int32(base.Ui32(v154)>>(uint(v65)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+21)) = uint8(v168)
					v170 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+12)))
					v174 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v170)>>(uint(v39)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+23)) = uint8(v174)
					v180 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+13)))
					v185 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v170<<(uint(v44)%32)&v28|int32(base.Ui32(v180)>>(uint(v44)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+24)) = uint8(v185)
					v187 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+14)))
					v191 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v187&v56)+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+26)) = uint8(v191)
					v201 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v180<<(uint(v39)%32)&v63|int32(base.Ui32(v187)>>(uint(v65)%32)))+uint32(_consts[1536]))))
					...
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+29)) = uint8(v204)
					v209 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v203)>>(uint(v39)%32)))+uint32(_consts[1536]))))
					*(*uint8)(unsafe.Add(mBase, uint32(l3)+27)) = uint8(v209)
					v216 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v203<<(uint(v44)%32)&v28)+uint32(_consts[1536]))))
		...
		if l4 < int32(8) {
			...
			if l0 == int32(0) {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(l3)+7)) = uint8(v28)
				v34 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v27)>>(uint(int32(2))%32)))+uint32(_consts[1535]))))
				*(*uint8)(unsafe.Add(mBase, uint32(l3)+6)) = uint8(v34)
				v36 = int32(63)
				v39 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v26&v36)+uint32(_consts[1535]))))
				*(*uint8)(unsafe.Add(mBase, uint32(l3)+3)) = uint8(v39)
				v44 = v25 << (uint(int32(8)) % 32)
				v51 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v27<<(uint(int32(16))%32)|v44)>>(uint(int32(12))%32))&v36)+uint32(_consts[1535]))))
				*(*uint8)(unsafe.Add(mBase, uint32(l3)+5)) = uint8(v51)
				v54 = int32(6)
				v59 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v44|v26)>>(uint(v54)%32))&v36)+uint32(_consts[1535]))))
				...
				if base.Ui32(l2) < base.Ui32(v54) {
					...
					if base.Ui32(l4) < base.Ui32(int32(12)) {
						...
						*(*uint8)(unsafe.Add(mBase, uint32(l3)+11)) = uint8(v68)
						v74 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v67)>>(uint(int32(2))%32)))+uint32(_consts[1535]))))
						*(*uint8)(unsafe.Add(mBase, uint32(l3)+10)) = uint8(v74)
						v76 = int32(63)
						v79 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v66&v76)+uint32(_consts[1535]))))
						*(*uint8)(unsafe.Add(mBase, uint32(l3)+7)) = uint8(v79)
						v84 = v65 << (uint(int32(8)) % 32)
						v91 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v67<<(uint(int32(16))%32)|v84)>>(uint(int32(12))%32))&v76)+uint32(_consts[1535]))))
						*(*uint8)(unsafe.Add(mBase, uint32(l3)+9)) = uint8(v91)
						v99 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v84|v66)>>(uint(int32(6))%32))&v76)+uint32(_consts[1535]))))
