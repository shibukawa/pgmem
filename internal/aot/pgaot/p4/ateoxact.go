...
func F_AtEOXact_RelationCache(m *base.Module, l0 int32) {
	...
	v8 = v6 - int32(48)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, _consts[1370])) = v2
	v14 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1371])))
	if v14 == v2 {
		goto L2
	} else {
		goto L3
...
L1:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _consts[1372]))
	if int32(0) < v144 {
		goto L45
	} else {
		goto L46
...
L2:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[1373]))
	if v18 <= int32(0) {
		goto L1
	} else {
		goto L5
...
L4:
	;
	v85 = *(*int32)(unsafe.Add(mBase, _consts[1374]))
...
L9:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[1374]))
	v35 = int32(0)
	v37 = F_hash_search(m, v30, v25<<(uint(int32(2))%32)+int32(4413296), v35, v35)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L11:
	;
	v78 = v25 + int32(1)
	v80 = *(*int32)(unsafe.Add(mBase, _consts[1373]))
	if v78 < v80 {
		v25 = v78
		goto L9
	} else {
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v61 + int32(4)
	F_errmsg_internal(m, int32(81966), v8+int32(16))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L12
...
L22:
	;
	F_errfinish(m, int32(468564), int32(3365), int32(218611))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L12
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v122 + int32(4)
	F_errmsg_internal(m, int32(81966), v8)
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L12
...
L45:
	;
	v148 = *(*int32)(unsafe.Add(mBase, _consts[1375]))
	if int32(0) < v148 {
		goto L48
	} else {
		goto L49
...
L47:
	;
	v188 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[1371])) = uint8(v188)
...
L50:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[1376]))
	F_pfree(m, v176)
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
...
L51:
	;
	v158 = *(*int32)(unsafe.Add(mBase, _consts[1376]))
...
L53:
	;
	v166 = v153 + int32(1)
	v168 = *(*int32)(unsafe.Add(mBase, _consts[1375]))
	if v166 < v168 {
		v153 = v166
		goto L51
	} else {
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1376])) = int32(0)
	goto L47
}
func F_AtEOXact_Snapshot(m *base.Module, l0 int32, l1 int32) {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _consts[1447]))
	if v12 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	F_pairingheap_remove(m, int32(4099192), v12+int32(52))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1447])) = int32(0)
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1448]))
	if v22 != 0 {
		goto L6
	} else {
		goto L7
...
L8:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _consts[1446]))
	if v86 == int32(0) {
		goto L22
	} else {
		goto L23
...
L14:
	...
	F_pairingheap_remove(m, int32(4099192), v61+int32(52))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L4
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v48
	F_errmsg_internal(m, int32(280635), v9+int32(16))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L4
...
L18:
	;
	F_errfinish(m, int32(464756), int32(1057), int32(81859))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L4
...
L23:
	;
	F_pairingheap_remove(m, int32(4099192), v86+int32(52))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L4
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1446])) = int32(0)
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1449])) = v184
...
L39:
	;
	F_errmsg_internal(m, int32(218727), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L40:
	;
	F_errfinish(m, int32(464756), int32(1075), int32(81859))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v159
	F_errmsg_internal(m, int32(321680), v9)
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L4
...
L49:
	;
	F_errfinish(m, int32(464756), int32(1079), int32(81859))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L4
...
func F_AtEOXact_TypeCache(m *base.Module) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1393]))
	if v1 < v10 {
		goto L1
	} else {
		goto L2
...
L4:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[1394]))
	v20 = *(*int32)(unsafe.Add(mBase, _consts[1395]))
	v24 = int32(0)
...
L6:
	;
	v56 = v14 + int32(1)
	v58 = *(*int32)(unsafe.Add(mBase, _consts[1393]))
	if v56 < v58 {
		v14 = v56
		goto L4
	} else {
...
L13:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[1396]))
