...
func F_AtEOXact_RelationCache(m *base.Module, l0 int32) {
	...
	v8 = v6 - int32(48)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, _consts[1382])) = v2
	v14 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1383])))
	if v14 == v2 {
		goto L2
	} else {
		goto L3
...
L1:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _consts[1384]))
	if int32(0) < v144 {
		goto L45
	} else {
		goto L46
...
L2:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[1385]))
	if v18 <= int32(0) {
		goto L1
	} else {
		goto L5
...
L4:
	;
	v85 = *(*int32)(unsafe.Add(mBase, _consts[1386]))
...
L9:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[1386]))
	v35 = int32(0)
	v37 = F_hash_search(m, v30, v25<<(uint(int32(2))%32)+int32(4503728), v35, v35)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L11:
	;
	v78 = v25 + int32(1)
	v80 = *(*int32)(unsafe.Add(mBase, _consts[1385]))
	if v78 < v80 {
		v25 = v78
		goto L9
	} else {
...
L22:
	;
	F_errfinish(m, int32(499667), int32(3365), int32(232803))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L12
...
L45:
	;
	v148 = *(*int32)(unsafe.Add(mBase, _consts[1387]))
	if int32(0) < v148 {
		goto L48
	} else {
		goto L49
...
L47:
	;
	v188 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[1383])) = uint8(v188)
	*(*int32)(unsafe.Add(mBase, _consts[1385])) = v188
	*(*int32)(unsafe.Add(mBase, _consts[1387])) = v188
...
L50:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[1388]))
	F_pfree(m, v176)
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
...
L51:
	;
	v158 = *(*int32)(unsafe.Add(mBase, _consts[1388]))
...
L53:
	;
	v166 = v153 + int32(1)
	v168 = *(*int32)(unsafe.Add(mBase, _consts[1387]))
	if v166 < v168 {
		v153 = v166
		goto L51
	} else {
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1388])) = int32(0)
	goto L47
}
...
L1:
	;
	F_pairingheap_remove(m, int32(4174136), v12+int32(52))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L8:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _consts[1458]))
	if v86 == int32(0) {
		goto L22
	} else {
		goto L23
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1460])) = int32(0)
	goto L8
L12:
	;
...
L14:
	...
	F_pairingheap_remove(m, int32(4174136), v61+int32(52))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L4
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v48
	F_errmsg_internal(m, int32(299066), v9+int32(16))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L4
...
L18:
	;
	F_errfinish(m, int32(495541), int32(1057), int32(87238))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L4
...
L23:
	;
	F_pairingheap_remove(m, int32(4174136), v86+int32(52))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L4
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1462])) = v184
	*(*uint8)(unsafe.Add(mBase, _consts[492])) = uint8(v184)
	if l1 != 0 {
		goto L52
	} else {
		goto L53
...
L39:
	;
	F_errmsg_internal(m, int32(232919), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L40:
	;
	F_errfinish(m, int32(495541), int32(1075), int32(87238))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v159
	F_errmsg_internal(m, int32(343299), v9)
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L4
...
L49:
	;
	F_errfinish(m, int32(495541), int32(1079), int32(87238))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L4
...
func F_AtEOXact_TypeCache(m *base.Module) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1405]))
	if v1 < v10 {
		goto L1
	} else {
		goto L2
...
L4:
	...
	v20 = *(*int32)(unsafe.Add(mBase, _consts[1407]))
	v24 = int32(0)
...
L6:
	;
	v56 = v14 + int32(1)
	v58 = *(*int32)(unsafe.Add(mBase, _consts[1405]))
	if v56 < v58 {
		v14 = v56
		goto L4
	} else {
...
L13:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[1408]))
