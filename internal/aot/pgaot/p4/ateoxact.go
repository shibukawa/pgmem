...
func F_AtEOXact_RelationCache(m *base.Module, l0 int32) {
	...
	v8 = v6 - int32(48)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, _consts[1373])) = v2
	v14 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1374])))
	if v14 == v2 {
		goto L2
	} else {
		goto L3
...
L1:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _consts[1375]))
	if int32(0) < v144 {
		goto L45
	} else {
		goto L46
...
L2:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[1376]))
	if v18 <= int32(0) {
		goto L1
	} else {
		goto L5
...
L4:
	;
	v85 = *(*int32)(unsafe.Add(mBase, _consts[1377]))
...
L9:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[1377]))
	v35 = int32(0)
	v37 = F_hash_search(m, v30, v25<<(uint(int32(2))%32)+int32(4475056), v35, v35)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L11:
	;
	v78 = v25 + int32(1)
	v80 = *(*int32)(unsafe.Add(mBase, _consts[1376]))
	if v78 < v80 {
		v25 = v78
		goto L9
	} else {
...
L22:
	;
	F_errfinish(m, int32(496066), int32(3365), int32(231470))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L12
...
L45:
	;
	v148 = *(*int32)(unsafe.Add(mBase, _consts[1378]))
	if int32(0) < v148 {
		goto L48
	} else {
		goto L49
...
L47:
	;
	v188 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[1374])) = uint8(v188)
...
L50:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[1379]))
	F_pfree(m, v176)
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
...
L51:
	;
	v158 = *(*int32)(unsafe.Add(mBase, _consts[1379]))
...
L53:
	;
	v166 = v153 + int32(1)
	v168 = *(*int32)(unsafe.Add(mBase, _consts[1378]))
	if v166 < v168 {
		v153 = v166
		goto L51
	} else {
...
func F_AtEOXact_Snapshot(m *base.Module, l0 int32, l1 int32) {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _consts[1450]))
	if v12 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	F_pairingheap_remove(m, int32(4154440), v12+int32(52))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1450])) = int32(0)
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1451]))
	if v22 != 0 {
		goto L6
	} else {
		goto L7
...
L8:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _consts[1449]))
	if v86 == int32(0) {
		goto L22
	} else {
		goto L23
...
L14:
	...
	F_pairingheap_remove(m, int32(4154440), v61+int32(52))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L4
...
L18:
	;
	F_errfinish(m, int32(492015), int32(1057), int32(86842))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L4
...
L23:
	;
	F_pairingheap_remove(m, int32(4154440), v86+int32(52))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L4
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1453])) = v184
	*(*uint8)(unsafe.Add(mBase, _consts[483])) = uint8(v184)
	if l1 != 0 {
		goto L52
	} else {
		goto L53
...
L40:
	;
	F_errfinish(m, int32(492015), int32(1075), int32(86842))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L4
...
L49:
	;
	F_errfinish(m, int32(492015), int32(1079), int32(86842))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L4
...
func F_AtEOXact_TypeCache(m *base.Module) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1396]))
	if v1 < v10 {
		goto L1
	} else {
		goto L2
...
L4:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[1397]))
...
L6:
	;
	v56 = v14 + int32(1)
	v58 = *(*int32)(unsafe.Add(mBase, _consts[1396]))
	if v56 < v58 {
		v14 = v56
		goto L4
	} else {
...
L13:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[1399]))
