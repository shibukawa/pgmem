...
func F_AtEOXact_RelationCache(m *base.Module, l0 int32) {
	...
	v8 = v6 - int32(48)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, _consts[1378])) = v2
	v14 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1379])))
	if v14 == v2 {
		goto L2
	} else {
		goto L3
...
L1:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _consts[1380]))
	if int32(0) < v144 {
		goto L45
	} else {
		goto L46
...
L4:
	;
	v85 = *(*int32)(unsafe.Add(mBase, _consts[1382]))
...
L9:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[1382]))
	v35 = int32(0)
	v37 = F_hash_search(m, v30, v25<<(uint(int32(2))%32)+int32(4550112), v35, v35)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L11:
	;
	v78 = v25 + int32(1)
	v80 = *(*int32)(unsafe.Add(mBase, _consts[1381]))
	if v78 < v80 {
		v25 = v78
		goto L9
	} else {
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v61 + int32(4)
	F_errmsg_internal(m, int32(93829), v8+int32(16))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L12
...
L22:
	;
	F_errfinish(m, int32(525101), int32(3365), int32(244933))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L12
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v122 + int32(4)
	F_errmsg_internal(m, int32(93829), v8)
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L12
...
L45:
	;
	v148 = *(*int32)(unsafe.Add(mBase, _consts[1383]))
	if int32(0) < v148 {
		goto L48
	} else {
		goto L49
...
L47:
	;
	v188 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[1379])) = uint8(v188)
	*(*int32)(unsafe.Add(mBase, _consts[1381])) = v188
	*(*int32)(unsafe.Add(mBase, _consts[1383])) = v188
	*(*int32)(unsafe.Add(mBase, _consts[1380])) = v188
	m.G0 = v8 + int32(48)
	return
L48:
	;
...
L50:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[1384]))
	F_pfree(m, v176)
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
...
L51:
	;
	v158 = *(*int32)(unsafe.Add(mBase, _consts[1384]))
...
L53:
	;
	v166 = v153 + int32(1)
	v168 = *(*int32)(unsafe.Add(mBase, _consts[1383]))
	if v166 < v168 {
		v153 = v166
		goto L51
	} else {
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1384])) = int32(0)
	goto L47
}
func F_AtEOXact_Snapshot(m *base.Module, l0 int32, l1 int32) {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _consts[1455]))
	if v12 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	F_pairingheap_remove(m, int32(4216648), v12+int32(52))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1455])) = int32(0)
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1456]))
	if v22 != 0 {
		goto L6
	} else {
		goto L7
...
L8:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _consts[1454]))
	if v86 == int32(0) {
		goto L22
	} else {
		goto L23
...
L14:
	...
	F_pairingheap_remove(m, int32(4216648), v61+int32(52))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L4
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v48
	F_errmsg_internal(m, int32(313604), v9+int32(16))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L4
...
L18:
	;
	F_errfinish(m, int32(520471), int32(1057), int32(93706))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L4
...
L23:
	;
	F_pairingheap_remove(m, int32(4216648), v86+int32(52))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L4
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1457])) = v184
	*(*int32)(unsafe.Add(mBase, _consts[1458])) = v184
...
L39:
	;
	F_errmsg_internal(m, int32(245049), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L40:
	;
	F_errfinish(m, int32(520471), int32(1075), int32(93706))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v159
	F_errmsg_internal(m, int32(361226), v9)
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L4
...
L49:
	;
	F_errfinish(m, int32(520471), int32(1079), int32(93706))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L4
...
func F_AtEOXact_TypeCache(m *base.Module) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1401]))
	if v1 < v10 {
		goto L1
	} else {
		goto L2
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1401])) = int32(0)
	m.G0 = v7 + int32(16)
	return
L4:
	;
...
L6:
	;
	v56 = v14 + int32(1)
	v58 = *(*int32)(unsafe.Add(mBase, _consts[1401]))
	if v56 < v58 {
		v14 = v56
		goto L4
	} else {
...
L13:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[1404]))
