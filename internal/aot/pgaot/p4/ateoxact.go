...
func F_AtEOXact_RelationCache(m *base.Module, l0 int32) {
	...
	v8 = v6 - int32(48)
	m.G0 = v8
	*(*int32)(unsafe.Add(mBase, _consts[1381])) = v2
	v14 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1382])))
	if v14 == v2 {
		goto L2
	} else {
		goto L3
...
L1:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _consts[1383]))
	if int32(0) < v144 {
		goto L45
	} else {
		goto L46
...
L2:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[1384]))
	if v18 <= int32(0) {
		goto L1
	} else {
		goto L5
...
L4:
	;
	v85 = *(*int32)(unsafe.Add(mBase, _consts[1385]))
...
L9:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[1385]))
	v35 = int32(0)
	v37 = F_hash_search(m, v30, v25<<(uint(int32(2))%32)+int32(4503408), v35, v35)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L12
...
L11:
	;
	v78 = v25 + int32(1)
	v80 = *(*int32)(unsafe.Add(mBase, _consts[1384]))
	if v78 < v80 {
		v25 = v78
		goto L9
	} else {
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v61 + int32(4)
	F_errmsg_internal(m, int32(87304), v8+int32(16))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L12
...
L22:
	;
	F_errfinish(m, int32(499180), int32(3365), int32(232610))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L12
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v122 + int32(4)
	F_errmsg_internal(m, int32(87304), v8)
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L12
...
L45:
	;
	v148 = *(*int32)(unsafe.Add(mBase, _consts[1386]))
	if int32(0) < v148 {
		goto L48
	} else {
		goto L49
...
L47:
	;
	v188 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[1382])) = uint8(v188)
	*(*int32)(unsafe.Add(mBase, _consts[1384])) = v188
	*(*int32)(unsafe.Add(mBase, _consts[1386])) = v188
	*(*int32)(unsafe.Add(mBase, _consts[1383])) = v188
	m.G0 = v8 + int32(48)
	return
L48:
	;
...
L50:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[1387]))
	F_pfree(m, v176)
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
...
L51:
	;
	v158 = *(*int32)(unsafe.Add(mBase, _consts[1387]))
...
L53:
	;
	v166 = v153 + int32(1)
	v168 = *(*int32)(unsafe.Add(mBase, _consts[1386]))
	if v166 < v168 {
		v153 = v166
		goto L51
	} else {
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1387])) = int32(0)
	goto L47
}
...
L1:
	;
	F_pairingheap_remove(m, int32(4174008), v12+int32(52))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1458])) = int32(0)
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1459]))
	if v22 != 0 {
		goto L6
	} else {
		goto L7
...
L8:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _consts[1457]))
	if v86 == int32(0) {
		goto L22
	} else {
		goto L23
...
L14:
	...
	F_pairingheap_remove(m, int32(4174008), v61+int32(52))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L4
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v48
	F_errmsg_internal(m, int32(298746), v9+int32(16))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L4
...
L18:
	;
	F_errfinish(m, int32(495077), int32(1057), int32(87181))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L4
...
L23:
	;
	F_pairingheap_remove(m, int32(4174008), v86+int32(52))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L4
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1457])) = int32(0)
	v98 = *(*int32)(unsafe.Add(mBase, _consts[263]))
	if v98 != 0 {
		goto L22
	} else {
		goto L25
...
L25:
	;
	v101 = *(*int32)(unsafe.Add(mBase, _consts[264]))
	if v101 != 0 {
		goto L26
	} else {
		goto L27
...
L26:
	...
	v106 = *(*int32)(unsafe.Add(mBase, _consts[264]))
	v108 = v106 - int32(48)
...
L34:
	;
	v184 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[264])) = v184
	*(*int32)(unsafe.Add(mBase, _consts[263])) = v184
	*(*int32)(unsafe.Add(mBase, _consts[1460])) = v184
	*(*int32)(unsafe.Add(mBase, _consts[1461])) = v184
	*(*uint8)(unsafe.Add(mBase, _consts[491])) = uint8(v184)
	if l1 != 0 {
		goto L52
	} else {
		goto L53
...
L35:
	;
	v135 = *(*int32)(unsafe.Add(mBase, _consts[264]))
	if v135 == int32(0) {
		goto L36
	} else {
		goto L37
...
L36:
	;
	v154 = *(*int32)(unsafe.Add(mBase, _consts[263]))
	if v154 == int32(0) {
		goto L34
	} else {
		goto L42
...
L39:
	;
	F_errmsg_internal(m, int32(232726), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L40:
	;
	F_errfinish(m, int32(495077), int32(1075), int32(87181))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v159
	F_errmsg_internal(m, int32(342979), v9)
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L4
...
L49:
	;
	F_errfinish(m, int32(495077), int32(1079), int32(87181))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L4
...
func F_AtEOXact_TypeCache(m *base.Module) {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1404]))
	if v1 < v10 {
		goto L1
	} else {
		goto L2
...
L4:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[1405]))
	v20 = *(*int32)(unsafe.Add(mBase, _consts[1406]))
	v24 = int32(0)
...
L6:
	;
	v56 = v14 + int32(1)
	v58 = *(*int32)(unsafe.Add(mBase, _consts[1404]))
	if v56 < v58 {
		v14 = v56
		goto L4
	} else {
...
L13:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[1407]))
