...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v121
	F_errmsg_internal(m, int32(182002), v13+int32(16))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L27
...
L29:
	;
	F_errfinish(m, int32(495145), int32(622), int32(108039))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L27
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v151
	F_errmsg_internal(m, int32(444526), v13)
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L27
...
L32:
	;
	F_errfinish(m, int32(495145), int32(572), int32(108039))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L27
...
func F_ResourceOwnerRemember(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if base.Ui32(int32(32)) <= base.Ui32(v6) {
		...
		if v12 != 0 {
			...
			F_errmsg_internal(m, int32(303521), int32(0))
			mBase = m.M
			v16 = m.ExcPending
			if v16 != 0 {
				return
			} else {
				F_errfinish(m, int32(495145), int32(542), int32(228398))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return
