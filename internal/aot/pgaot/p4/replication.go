...
func F_ReplicationOriginNameForLogicalRep(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if l1 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l0
		v15 = F_pg_snprintf(m, l2, int32(64), int32(38346), v7+int32(16))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
		v20 = F_pg_snprintf(m, l2, int32(64), int32(38397), v7)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return
...
func F_ReplicationSlotIndex(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = *(*int32)(unsafe.Add(mBase, _consts[845]))
...
func F_ReplicationSlotReserveWal(m *base.Module) {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[833]))
		...
		if v19 == int32(0) {
			...
			if v23 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
				if v43 != 0 {
					F_s_lock(m, v11, int32(489948), int32(1611), int32(312630))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return
						...
						*(*int64)(unsafe.Add(mBase, uint32(v11)+104)) = v42
						...
						if v55 != 0 {
							...
							v57 = int64(*(*int32)(unsafe.Add(mBase, _consts[262])))
							...
							if v60 != 0 {
								...
								if base.Ui64(v59) < base.Ui64(v61) {
									...
									if v68 != 0 {
										...
										v71 = int32(*(*uint8)(unsafe.Add(mBase, _consts[189])))
										if v71 == int32(1) {
											v76 = *(*int32)(unsafe.Add(mBase, _consts[190]))
											v77 = *(*int32)(unsafe.Add(mBase, uint32(v76)+316))
											v79 = base.B2i32(v77 != int32(2))
											*(*uint8)(unsafe.Add(mBase, _consts[189])) = uint8(v79)
											v81 = v79
										} else {
											v81 = int32(0)
										}
									...
									if v95 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v11 + int32(24)
										F_errmsg_internal(m, int32(18847), v8)
										mBase = m.M
										v101 = m.ExcPending
										if v101 != 0 {
											return
										} else {
											F_errfinish(m, int32(489948), int32(1622), int32(312630))
											mBase = m.M
											v106 = m.ExcPending
											if v106 != 0 {
												return
			...
			v26 = int32(*(*uint8)(unsafe.Add(mBase, _consts[189])))
			if v26 == int32(1) {
				v31 = *(*int32)(unsafe.Add(mBase, _consts[190]))
				v32 = *(*int32)(unsafe.Add(mBase, uint32(v31)+316))
				v34 = base.B2i32(v32 != int32(2))
				*(*uint8)(unsafe.Add(mBase, _consts[189])) = uint8(v34)
				v36 = v34
			} else {
				v36 = int32(0)
			}
...
func F_ReplicationSlotShmemExit(m *base.Module, l0 int32, l1 int32) {
	...
	var v9 int32
	_ = v9
	v4 = *(*int32)(unsafe.Add(mBase, _consts[833]))
	if v4 != 0 {
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[844]))
	if int32(0) < v15 {
		goto L3
	} else {
		goto L4
...
L3:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[845]))
	v21 = v19
	v22 = int32(0)
	v24 = v4
	goto L6
...
L8:
	;
	v65 = v22 + int32(1)
	v67 = *(*int32)(unsafe.Add(mBase, _consts[844]))
	if v65 < v67 {
		v21 = v60
		v22 = v65
		v24 = v62
...
L10:
	;
	F_s_lock(m, v28, int32(489948), int32(1244), int32(524866))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28))) = int32(0)
	v43 = *(*int32)(unsafe.Add(mBase, _consts[845]))
...
L29:
	;
	v82 = *(*int32)(unsafe.Add(mBase, _consts[190]))
...
L30:
	...
	F_s_lock(m, v87+int32(440), int32(494975), int32(2670), int32(524775))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
...
L32:
	;
	v96 = *(*int32)(unsafe.Add(mBase, _consts[190]))
