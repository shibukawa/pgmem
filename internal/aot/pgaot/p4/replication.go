...
func F_ReplicationOriginNameForLogicalRep(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if l1 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l0
		v15 = F_pg_snprintf(m, l2, int32(64), int32(36182), v7+int32(16))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
		v20 = F_pg_snprintf(m, l2, int32(64), int32(36233), v7)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return
		...
		if v19 == int32(0) {
			...
			if v23 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
				if v43 != 0 {
					F_s_lock(m, v11, int32(471621), int32(1611), int32(300242))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return
								...
								if base.Ui64(v59) < base.Ui64(v61) {
									...
									if v95 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v11 + int32(24)
										F_errmsg_internal(m, int32(17592), v8)
										mBase = m.M
										v101 = m.ExcPending
										if v101 != 0 {
											return
										} else {
											F_errfinish(m, int32(471621), int32(1622), int32(300242))
											mBase = m.M
											v106 = m.ExcPending
											if v106 != 0 {
												return
...
L10:
	;
	F_s_lock(m, v28, int32(471621), int32(1244), int32(505841))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L30:
	...
	F_s_lock(m, v87+int32(440), int32(476414), int32(2670), int32(505750))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
