		...
		if v19 == int32(0) {
			...
			if v23 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
				if v43 != 0 {
					F_s_lock(m, v11, int32(493300), int32(1611), int32(314657))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return
									...
									if v95 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v11 + int32(24)
										...
										if v101 != 0 {
											...
											F_errfinish(m, int32(493300), int32(1622), int32(314657))
											mBase = m.M
											v106 = m.ExcPending
											if v106 != 0 {
												return
...
L10:
	;
	F_s_lock(m, v28, int32(493300), int32(1244), int32(528441))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L30:
	...
	F_s_lock(m, v87+int32(440), int32(498404), int32(2670), int32(528350))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
