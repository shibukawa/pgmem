...
func F_ReplicationSlotReserveWal(m *base.Module) {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotReserveWal[0]))
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotReserveWal[1]))
	v17 = F_LWLockAcquire(m, v13+int32(_a_F_ReplicationSlotReserveWal_0), int32(0))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		return
		...
		if v19 == int32(0) {
			...
			if v23 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
				if v43 != 0 {
					F_s_lock(m, v11, int32(_a_F_ReplicationSlotReserveWal_1), int32(1611), int32(_a_F_ReplicationSlotReserveWal_2))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return
								...
								if base.Ui64(v59) < base.Ui64(v61) {
									...
									if v95 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v11 + int32(24)
										F_errmsg_internal(m, int32(_a_F_ReplicationSlotReserveWal_3), v8)
										mBase = m.M
										v101 = m.ExcPending
										if v101 != 0 {
											return
			...
			v26 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ReplicationSlotReserveWal[3])))
			if v26 == int32(1) {
				v31 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotReserveWal[4]))
				v32 = *(*int32)(unsafe.Add(mBase, uint32(v31)+316))
				v34 = base.B2i32(v32 != int32(2))
				*(*uint8)(unsafe.Add(mBase, _c_F_ReplicationSlotReserveWal[3])) = uint8(v34)
				v36 = v34
			} else {
				v36 = int32(0)
			}
...
func F_ReplicationSlotsComputeRequiredLSN(m *base.Module) {
	...
	_ = v96
	v4 = int64(0)
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsComputeRequiredLSN[0]))
	v12 = F_LWLockAcquire(m, v8+int32(_a_F_ReplicationSlotsComputeRequiredLSN_0), int32(1))
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
		goto L1
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsComputeRequiredLSN[1]))
	if int32(0) < v15 {
		goto L3
	} else {
		goto L4
...
L5:
	;
	v76 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsComputeRequiredLSN[0]))
	F_LWLockRelease(m, v76+int32(_a_F_ReplicationSlotsComputeRequiredLSN_0))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L1
...
L8:
	;
	v65 = v22 + int32(1)
	v67 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsComputeRequiredLSN[1]))
	if v65 < v67 {
		v21 = v60
		v22 = v65
		v24 = v62
...
L10:
	;
	F_s_lock(m, v28, int32(_a_F_ReplicationSlotsComputeRequiredLSN_1), int32(1244), int32(_a_F_ReplicationSlotsComputeRequiredLSN_2))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28))) = int32(0)
	v43 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsComputeRequiredLSN[2]))
...
L29:
	;
	v82 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsComputeRequiredLSN[3]))
...
L30:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsComputeRequiredLSN[3]))
	F_s_lock(m, v87+int32(440), int32(_a_F_ReplicationSlotsComputeRequiredLSN_3), int32(2670), int32(_a_F_ReplicationSlotsComputeRequiredLSN_4))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
...
L32:
	;
	v96 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsComputeRequiredLSN[3]))
