...
func F_ReplicationSlotIndex(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = *(*int32)(unsafe.Add(mBase, _consts[844]))
...
func F_ReplicationSlotReserveWal(m *base.Module) {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[832]))
		...
		if v19 == int32(0) {
			...
			if v23 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
				if v43 != 0 {
					F_s_lock(m, v11, int32(489898), int32(1611), int32(312630))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return
									...
									if v95 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v11 + int32(24)
										...
										if v101 != 0 {
											...
											F_errfinish(m, int32(489898), int32(1622), int32(312630))
											mBase = m.M
											v106 = m.ExcPending
											if v106 != 0 {
												return
...
func F_ReplicationSlotShmemExit(m *base.Module, l0 int32, l1 int32) {
	...
	var v9 int32
	_ = v9
	v4 = *(*int32)(unsafe.Add(mBase, _consts[832]))
	if v4 != 0 {
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[843]))
	if int32(0) < v15 {
		goto L3
	} else {
		goto L4
...
L3:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[844]))
	v21 = v19
	v22 = int32(0)
	v24 = v4
	goto L6
...
L8:
	;
	v65 = v22 + int32(1)
	v67 = *(*int32)(unsafe.Add(mBase, _consts[843]))
	if v65 < v67 {
		v21 = v60
		v22 = v65
		v24 = v62
...
L10:
	;
	F_s_lock(m, v28, int32(489898), int32(1244), int32(524816))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L30:
	...
	F_s_lock(m, v87+int32(440), int32(494925), int32(2670), int32(524725))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
