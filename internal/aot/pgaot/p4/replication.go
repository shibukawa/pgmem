...
func F_ReplicationOriginNameForLogicalRep(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if l1 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l0
		v15 = F_pg_snprintf(m, l2, int32(64), int32(36022), v7+int32(16))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
		v20 = F_pg_snprintf(m, l2, int32(64), int32(36073), v7)
		mBase = m.M
		v21 = m.ExcPending
		if v21 != 0 {
			return
...
func F_ReplicationSlotIndex(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = *(*int32)(unsafe.Add(mBase, _consts[843]))
...
func F_ReplicationSlotReserveWal(m *base.Module) {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[831]))
		...
		if v19 == int32(0) {
			...
			if v23 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
				if v43 != 0 {
					F_s_lock(m, v11, int32(469981), int32(1611), int32(298906))
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return
								...
								if base.Ui64(v59) < base.Ui64(v61) {
									...
									if v95 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v11 + int32(24)
										F_errmsg_internal(m, int32(17492), v8)
										mBase = m.M
										v101 = m.ExcPending
										if v101 != 0 {
											return
										} else {
											F_errfinish(m, int32(469981), int32(1622), int32(298906))
											mBase = m.M
											v106 = m.ExcPending
											if v106 != 0 {
												return
...
func F_ReplicationSlotShmemExit(m *base.Module, l0 int32, l1 int32) {
	...
	var v9 int32
	_ = v9
	v4 = *(*int32)(unsafe.Add(mBase, _consts[831]))
	if v4 != 0 {
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[842]))
	if int32(0) < v15 {
		goto L3
	} else {
		goto L4
...
L3:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[843]))
	v21 = v19
	v22 = int32(0)
	v24 = v4
	goto L6
...
L8:
	;
	v65 = v22 + int32(1)
	v67 = *(*int32)(unsafe.Add(mBase, _consts[842]))
	if v65 < v67 {
		v21 = v60
		v22 = v65
		v24 = v62
...
L10:
	;
	F_s_lock(m, v28, int32(469981), int32(1244), int32(504175))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L30:
	...
	F_s_lock(m, v87+int32(440), int32(474748), int32(2670), int32(504084))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
