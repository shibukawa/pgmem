...
L3:
	;
	v92 = F_pair_decode(m, v79, v18, v18+int32(8), v13+int32(44), int32(381813), v16, v15)
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L1
...
L21:
	;
	v110 = F_float8in_internal(m, v106, v13+int32(44), int32(381813), v16, v15)
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L1
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = int32(381813)
...
L38:
	;
	F_errsave_finish(m, v15, int32(482704), int32(4666), int32(273671))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L1
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(381813)
...
L43:
	;
	F_errsave_finish(m, v15, int32(482704), int32(4651), int32(273671))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L1
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(381813)
...
L53:
	;
	F_errsave_finish(m, v15, int32(482704), int32(4673), int32(273671))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L1
