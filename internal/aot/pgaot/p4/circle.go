...
L38:
	;
	F_errsave_finish(m, v15, int32(490642), int32(4666), int32(278110))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L1
...
L43:
	;
	F_errsave_finish(m, v15, int32(490642), int32(4651), int32(278110))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L1
...
L53:
	;
	F_errsave_finish(m, v15, int32(490642), int32(4673), int32(278110))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L1
