...
L32:
	;
	F_errdetail_internal(m, int32(545525), int32(0))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L6
...
L34:
	;
	F_errfinish(m, int32(481756), int32(4727), int32(350759))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L6
...
L39:
	;
	F_errdetail_internal(m, int32(545779), int32(0))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L6
...
L41:
	;
	F_errfinish(m, int32(481756), int32(4763), int32(350759))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L6
...
L39:
	;
	F_errmsg_internal(m, int32(437135), int32(0))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L1
...
L40:
	;
	F_errfinish(m, int32(480315), int32(695), int32(146435))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L1
...
L43:
	;
	F_errmsg(m, int32(525183), int32(0))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L1
...
L44:
	;
	F_errfinish(m, int32(480315), int32(738), int32(146435))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L1
			...
			if v47 != 0 {
				...
				if v50 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l1
					F_errmsg(m, int32(246832), v7+int32(16))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return
					} else {
						F_errfinish(m, int32(476721), int32(3668), int32(305744))
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return
				...
				if v65 != 0 {
					...
					if v68 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = l1
						F_errmsg(m, int32(245015), v7+int32(32))
						mBase = m.M
						v74 = m.ExcPending
						if v74 != 0 {
							return
						} else {
							F_errfinish(m, int32(476721), int32(3677), int32(305744))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return
		...
		if v31 != 0 {
			...
			if v34 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				F_errmsg(m, int32(305344), v7)
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
				} else {
					F_errfinish(m, int32(476721), int32(3658), int32(305744))
					mBase = m.M
					v43 = m.ExcPending
					if v43 != 0 {
						return
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+320)) = v86
	F_errmsg(m, int32(422512), v20+int32(320))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L4
...
L82:
	;
	F_errfinish(m, int32(475708), int32(576), int32(131431))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L4
...
L271:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+368)) = v718
	F_errmsg(m, int32(156245), v20+int32(368))
	mBase = m.M
	v724 = m.ExcPending
	if v724 != 0 {
		goto L4
...
L273:
	;
	F_errfinish(m, int32(475708), int32(635), int32(131431))
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L4
...
L295:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+384)) = v784
	F_errmsg(m, int32(156245), v20+int32(384))
	mBase = m.M
	v790 = m.ExcPending
	if v790 != 0 {
		goto L4
...
L297:
	;
	F_errfinish(m, int32(475708), int32(650), int32(131431))
	mBase = m.M
	v798 = m.ExcPending
	if v798 != 0 {
		goto L4
...
L319:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+400)) = v850
	F_errmsg(m, int32(156245), v20+int32(400))
	mBase = m.M
	v856 = m.ExcPending
	if v856 != 0 {
		goto L4
...
L321:
	;
	F_errfinish(m, int32(475708), int32(665), int32(131431))
	mBase = m.M
	v864 = m.ExcPending
	if v864 != 0 {
		goto L4
...
L341:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+416)) = v910
	F_errmsg(m, int32(156245), v20+int32(416))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L4
...
L343:
	;
	F_errfinish(m, int32(475708), int32(684), int32(131431))
	mBase = m.M
	v924 = m.ExcPending
	if v924 != 0 {
		goto L4
...
L386:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+432)) = v1060
	F_errmsg(m, int32(367814), v20+int32(432))
	mBase = m.M
	v1066 = m.ExcPending
	if v1066 != 0 {
		goto L4
...
L388:
	;
	F_errfinish(m, int32(475708), int32(696), int32(131431))
	mBase = m.M
	v1074 = m.ExcPending
	if v1074 != 0 {
		goto L4
...
L493:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1226))) = int32(491129)
	F_errmsg(m, int32(422544), v1226)
	mBase = m.M
	v1379 = m.ExcPending
	if v1379 != 0 {
		goto L4
...
L495:
	;
	F_errfinish(m, int32(475708), int32(514), int32(403250))
	mBase = m.M
	v1387 = m.ExcPending
	if v1387 != 0 {
		goto L4
...
L518:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+512)) = v1442
	F_errmsg(m, int32(422728), v20+int32(512))
	mBase = m.M
	v1448 = m.ExcPending
	if v1448 != 0 {
		goto L4
...
L520:
	;
	F_errfinish(m, int32(475708), int32(724), int32(131431))
	mBase = m.M
	v1456 = m.ExcPending
	if v1456 != 0 {
		goto L4
...
L534:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+272)) = int32(503234)
	F_errmsg(m, int32(398986), v20+int32(272))
	mBase = m.M
	v1510 = m.ExcPending
	if v1510 != 0 {
		goto L4
...
L535:
	;
	F_errfinish(m, int32(475708), int32(745), int32(131431))
	mBase = m.M
	v1515 = m.ExcPending
	if v1515 != 0 {
		goto L4
...
L691:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+224)) = int32(520370)
	F_errmsg(m, int32(399064), v20+int32(224))
	mBase = m.M
	v1915 = m.ExcPending
	if v1915 != 0 {
		goto L4
...
L692:
	;
	F_errfinish(m, int32(475708), int32(822), int32(131431))
	mBase = m.M
	v1920 = m.ExcPending
	if v1920 != 0 {
		goto L4
...
L714:
	;
	F_errmsg(m, int32(89232), int32(0))
	mBase = m.M
	v1993 = m.ExcPending
	if v1993 != 0 {
		goto L4
...
L715:
	;
	F_errfinish(m, int32(475708), int32(832), int32(131431))
	mBase = m.M
	v1998 = m.ExcPending
	if v1998 != 0 {
		goto L4
...
L719:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+208)) = int32(522129)
	F_errmsg(m, int32(399064), v20+int32(208))
	mBase = m.M
	v2015 = m.ExcPending
	if v2015 != 0 {
		goto L4
...
L720:
	;
	F_errfinish(m, int32(475708), int32(839), int32(131431))
	mBase = m.M
	v2020 = m.ExcPending
	if v2020 != 0 {
		goto L4
...
L741:
	;
	F_errmsg(m, int32(209372), int32(0))
	mBase = m.M
	v2091 = m.ExcPending
	if v2091 != 0 {
		goto L4
...
L742:
	;
	F_errfinish(m, int32(475708), int32(844), int32(131431))
	mBase = m.M
	v2096 = m.ExcPending
	if v2096 != 0 {
		goto L4
...
L749:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+160)) = int32(520364)
	F_errmsg(m, int32(399064), v20+int32(160))
	mBase = m.M
	v2116 = m.ExcPending
	if v2116 != 0 {
		goto L4
...
L750:
	;
	F_errfinish(m, int32(475708), int32(851), int32(131431))
	mBase = m.M
	v2121 = m.ExcPending
	if v2121 != 0 {
		goto L4
...
L768:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+176)) = int32(514796)
	F_errmsg(m, int32(399064), v20+int32(176))
	mBase = m.M
	v2151 = m.ExcPending
	if v2151 != 0 {
		goto L4
...
L769:
	;
	F_errfinish(m, int32(475708), int32(866), int32(131431))
	mBase = m.M
	v2156 = m.ExcPending
	if v2156 != 0 {
		goto L4
...
L787:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+192)) = int32(514811)
	F_errmsg(m, int32(399064), v20+int32(192))
	mBase = m.M
	v2190 = m.ExcPending
	if v2190 != 0 {
		goto L4
...
L788:
	;
	F_errfinish(m, int32(475708), int32(882), int32(131431))
	mBase = m.M
	v2195 = m.ExcPending
	if v2195 != 0 {
		goto L4
...
L793:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+352)) = v373
	F_errmsg(m, int32(509497), v20+int32(352))
	mBase = m.M
	v2213 = m.ExcPending
	if v2213 != 0 {
		goto L4
...
L794:
	;
	F_errfinish(m, int32(475708), int32(415), int32(403303))
	mBase = m.M
	v2218 = m.ExcPending
	if v2218 != 0 {
		goto L4
...
L797:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+468)) = int32(509566)
	*(*int32)(unsafe.Add(mBase, uint32(v20)+464)) = int32(507608)
	F_errmsg(m, int32(178869), v20+int32(464))
	mBase = m.M
	v2234 = m.ExcPending
	if v2234 != 0 {
		goto L4
...
L799:
	;
	F_errfinish(m, int32(475708), int32(442), int32(403279))
	mBase = m.M
	v2242 = m.ExcPending
	if v2242 != 0 {
		goto L4
...
L802:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+448)) = int32(507608)
	F_errmsg(m, int32(422544), v20+int32(448))
	mBase = m.M
	v2257 = m.ExcPending
	if v2257 != 0 {
		goto L4
...
L804:
	;
	F_errfinish(m, int32(475708), int32(456), int32(403279))
	mBase = m.M
	v2265 = m.ExcPending
	if v2265 != 0 {
		goto L4
...
L807:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+480)) = v2273
	F_errmsg(m, int32(334198), v20+int32(480))
	mBase = m.M
	v2279 = m.ExcPending
	if v2279 != 0 {
		goto L4
...
L808:
	;
	F_errfinish(m, int32(475708), int32(476), int32(238753))
	mBase = m.M
	v2284 = m.ExcPending
	if v2284 != 0 {
		goto L4
...
L811:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v20)+496)) = v1430
	F_errmsg(m, int32(231063), v20+int32(496))
	mBase = m.M
	v2297 = m.ExcPending
	if v2297 != 0 {
		goto L4
...
L812:
	;
	F_errfinish(m, int32(475708), int32(486), int32(238753))
	mBase = m.M
	v2302 = m.ExcPending
	if v2302 != 0 {
		goto L4
...
L815:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+304)) = int32(507978)
	F_errmsg(m, int32(398986), v20+int32(304))
	mBase = m.M
	v2316 = m.ExcPending
	if v2316 != 0 {
		goto L4
...
L816:
	;
	F_errfinish(m, int32(475708), int32(735), int32(131431))
	mBase = m.M
	v2321 = m.ExcPending
	if v2321 != 0 {
		goto L4
...
L819:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+288)) = int32(515621)
	F_errmsg(m, int32(398986), v20+int32(288))
	mBase = m.M
	v2335 = m.ExcPending
	if v2335 != 0 {
		goto L4
...
L820:
	;
	F_errfinish(m, int32(475708), int32(740), int32(131431))
	mBase = m.M
	v2340 = m.ExcPending
	if v2340 != 0 {
		goto L4
...
L823:
	;
	F_errmsg(m, int32(209274), int32(0))
	mBase = m.M
	v2351 = m.ExcPending
	if v2351 != 0 {
		goto L4
...
L824:
	;
	F_errfinish(m, int32(475708), int32(767), int32(131431))
	mBase = m.M
	v2356 = m.ExcPending
	if v2356 != 0 {
		goto L4
...
L827:
	;
	F_errmsg(m, int32(235953), int32(0))
	mBase = m.M
	v2367 = m.ExcPending
	if v2367 != 0 {
		goto L4
...
L828:
	;
	F_errfinish(m, int32(475708), int32(774), int32(131431))
	mBase = m.M
	v2372 = m.ExcPending
	if v2372 != 0 {
		goto L4
...
L831:
	;
	F_errmsg(m, int32(235890), int32(0))
	mBase = m.M
	v2383 = m.ExcPending
	if v2383 != 0 {
		goto L4
...
L832:
	;
	F_errfinish(m, int32(475708), int32(780), int32(131431))
	mBase = m.M
	v2388 = m.ExcPending
	if v2388 != 0 {
		goto L4
...
L835:
	;
	F_errmsg(m, int32(235824), int32(0))
	mBase = m.M
	v2399 = m.ExcPending
	if v2399 != 0 {
		goto L4
...
L836:
	;
	F_errfinish(m, int32(475708), int32(790), int32(131431))
	mBase = m.M
	v2404 = m.ExcPending
	if v2404 != 0 {
		goto L4
...
L839:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+256)) = v2412
	F_errmsg(m, int32(687449), v20+int32(256))
	mBase = m.M
	v2418 = m.ExcPending
	if v2418 != 0 {
		goto L4
...
L840:
	;
	F_errfinish(m, int32(475708), int32(808), int32(131431))
	mBase = m.M
	v2423 = m.ExcPending
	if v2423 != 0 {
		goto L4
...
L843:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+240)) = int32(508564)
	F_errmsg(m, int32(398986), v20+int32(240))
	mBase = m.M
	v2437 = m.ExcPending
	if v2437 != 0 {
		goto L4
...
L844:
	;
	F_errfinish(m, int32(475708), int32(815), int32(131431))
	mBase = m.M
	v2442 = m.ExcPending
	if v2442 != 0 {
		goto L4
...
L847:
	;
	F_errmsg(m, int32(209325), int32(0))
	mBase = m.M
	v2453 = m.ExcPending
	if v2453 != 0 {
		goto L4
...
L848:
	;
	F_errfinish(m, int32(475708), int32(827), int32(131431))
	mBase = m.M
	v2458 = m.ExcPending
	if v2458 != 0 {
		goto L4
...
L851:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+4)) = int32(514145)
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = int32(520364)
	F_errmsg(m, int32(178869), v20)
	mBase = m.M
	v2472 = m.ExcPending
	if v2472 != 0 {
		goto L4
...
L852:
	;
	F_errfinish(m, int32(475708), int32(858), int32(131431))
	mBase = m.M
	v2477 = m.ExcPending
	if v2477 != 0 {
		goto L4
...
L857:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+132)) = int32(509566)
	*(*int32)(unsafe.Add(mBase, uint32(v20)+128)) = int32(514811)
	F_errmsg(m, int32(178869), v20+int32(128))
	mBase = m.M
	v2500 = m.ExcPending
	if v2500 != 0 {
		goto L4
...
L858:
	;
	F_errfinish(m, int32(475708), int32(891), int32(131431))
	mBase = m.M
	v2505 = m.ExcPending
	if v2505 != 0 {
		goto L4
...
L928:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+112)) = int32(515621)
	F_errmsg(m, int32(258347), v20+int32(112))
	mBase = m.M
	v2620 = m.ExcPending
	if v2620 != 0 {
		goto L4
...
L929:
	;
	F_errfinish(m, int32(475708), int32(899), int32(131431))
	mBase = m.M
	v2625 = m.ExcPending
	if v2625 != 0 {
		goto L4
...
L932:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+96)) = int32(515621)
	F_errmsg(m, int32(258412), v20+int32(96))
	mBase = m.M
	v2639 = m.ExcPending
	if v2639 != 0 {
		goto L4
...
L933:
	;
	F_errfinish(m, int32(475708), int32(908), int32(131431))
	mBase = m.M
	v2644 = m.ExcPending
	if v2644 != 0 {
		goto L4
...
L936:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+84)) = int32(509566)
	*(*int32)(unsafe.Add(mBase, uint32(v20)+80)) = int32(519858)
	F_errmsg(m, int32(178869), v20+int32(80))
	mBase = m.M
	v2660 = m.ExcPending
	if v2660 != 0 {
		goto L4
...
L937:
	;
	F_errfinish(m, int32(475708), int32(917), int32(131431))
	mBase = m.M
	v2665 = m.ExcPending
	if v2665 != 0 {
		goto L4
...
L940:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+68)) = int32(509566)
	*(*int32)(unsafe.Add(mBase, uint32(v20)+64)) = int32(503234)
	F_errmsg(m, int32(178869), v20-int32(-64))
	mBase = m.M
	v2681 = m.ExcPending
	if v2681 != 0 {
		goto L4
...
L941:
	;
	F_errfinish(m, int32(475708), int32(927), int32(131431))
	mBase = m.M
	v2686 = m.ExcPending
	if v2686 != 0 {
		goto L4
...
L944:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+48)) = int32(503234)
	F_errmsg(m, int32(258347), v20+int32(48))
	mBase = m.M
	v2700 = m.ExcPending
	if v2700 != 0 {
		goto L4
...
L945:
	;
	F_errfinish(m, int32(475708), int32(935), int32(131431))
	mBase = m.M
	v2705 = m.ExcPending
	if v2705 != 0 {
		goto L4
...
L948:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = int32(503234)
	F_errmsg(m, int32(258412), v20+int32(32))
	mBase = m.M
	v2719 = m.ExcPending
	if v2719 != 0 {
		goto L4
...
L949:
	;
	F_errfinish(m, int32(475708), int32(944), int32(131431))
	mBase = m.M
	v2724 = m.ExcPending
	if v2724 != 0 {
		goto L4
...
L952:
	;
	F_errmsg(m, int32(363667), int32(0))
	mBase = m.M
	v2735 = m.ExcPending
	if v2735 != 0 {
		goto L4
...
L953:
	;
	F_errfinish(m, int32(475708), int32(952), int32(131431))
	mBase = m.M
	v2740 = m.ExcPending
	if v2740 != 0 {
		goto L4
...
L956:
	;
	F_errmsg(m, int32(399019), int32(0))
	mBase = m.M
	v2751 = m.ExcPending
	if v2751 != 0 {
		goto L4
...
L957:
	;
	F_errfinish(m, int32(475708), int32(958), int32(131431))
	mBase = m.M
	v2756 = m.ExcPending
	if v2756 != 0 {
		goto L4
...
L960:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+24)) = int32(521908)
	*(*int32)(unsafe.Add(mBase, uint32(v20)+20)) = int32(507608)
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = int32(503592)
	F_errmsg(m, int32(175201), v20+int32(16))
	mBase = m.M
	v2774 = m.ExcPending
	if v2774 != 0 {
		goto L4
...
L961:
	;
	F_errfinish(m, int32(475708), int32(966), int32(131431))
	mBase = m.M
	v2779 = m.ExcPending
	if v2779 != 0 {
		goto L4
...
L964:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v20)+148)) = int32(509566)
	*(*int32)(unsafe.Add(mBase, uint32(v20)+144)) = int32(514796)
	F_errmsg(m, int32(178869), v20+int32(144))
	mBase = m.M
	v2795 = m.ExcPending
	if v2795 != 0 {
		goto L4
...
L965:
	;
	F_errfinish(m, int32(475708), int32(874), int32(131431))
	mBase = m.M
	v2800 = m.ExcPending
	if v2800 != 0 {
		goto L4
...
L968:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+336)) = v2811
	F_errmsg(m, int32(694046), v20+int32(336))
	mBase = m.M
	v2817 = m.ExcPending
	if v2817 != 0 {
		goto L4
...
L969:
	;
	F_errfinish(m, int32(475708), int32(424), int32(403303))
	mBase = m.M
	v2822 = m.ExcPending
	if v2822 != 0 {
		goto L4
				...
				if v35 == int32(0) {
					...
					if v42 != int32(95) {
						*(*int32)(unsafe.Add(mBase, uint32(v12)+12)) = int32(0)
						...
						v50 = v12 + int32(12)
						v53 = int32(3)
						v56 = F_strncmp(m, int32(277139), v48, v53)
						mBase = m.M
						if v56 == int32(0) {
							v78 = v53
							v79 = int32(1)
							...
							v60 = int32(2)
							v64 = F_strncmp(m, int32(275251), v48, v60)
							mBase = m.M
							if v64 == int32(0) {
								v78 = v60
								v79 = v60
								...
								v67 = int32(4)
								v70 = F_strncmp(m, int32(95975), v48, v67)
								mBase = m.M
								if v70 == int32(0) {
									if v50 != 0 {
										v82 = v67
						...
						if v30 < int32(0) {
							...
							if base.Ui32(v87) < base.Ui32(int32(16777217)) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l1))) = v98
								...
								F_px_debug(m, int32(309655), int32(0))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return int32(0)
...
L16:
	;
	F_errfinish(m, int32(481799), int32(389), int32(60947))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
func F_pgsql_version(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v3 = F_cstring_to_text(m, int32(97929))
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
	} else {
...
L9:
	;
	v24 = F_find_among(m, l0, int32(4167648), int32(3))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L10
...
L12:
	;
	v41 = F_slice_from_s(m, l0, int32(2), int32(2139348))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L10
...
L13:
	;
	v35 = F_slice_from_s(m, l0, int32(2), int32(2139346))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L10
...
L229:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v1130
	v1135 = F_find_among_b(m, l0, int32(4171376), int32(4))
	mBase = m.M
	v1136 = m.ExcPending
	if v1136 != 0 {
		goto L10
...
L234:
	;
	v805 = F_find_among_b(m, l0, int32(4167712), int32(45))
	mBase = m.M
	v806 = m.ExcPending
	if v806 != 0 {
		goto L10
...
L249:
	;
	v825 = F_slice_from_s(m, l0, int32(3), int32(2139380))
	mBase = m.M
	v826 = m.ExcPending
	if v826 != 0 {
		goto L10
...
L252:
	;
	v834 = F_slice_from_s(m, l0, int32(1), int32(2139383))
	mBase = m.M
	v835 = m.ExcPending
	if v835 != 0 {
		goto L10
...
L255:
	;
	v843 = F_slice_from_s(m, l0, int32(4), int32(2139384))
	mBase = m.M
	v844 = m.ExcPending
	if v844 != 0 {
		goto L10
...
L263:
	;
	v875 = F_find_among_b(m, l0, int32(4168624), int32(4))
	mBase = m.M
	v876 = m.ExcPending
	if v876 != 0 {
		goto L10
...
L272:
	...
	v903 = F_memcmp(m, v900+v890-v892, int32(2139388), v892)
	mBase = m.M
	if v903 != 0 {
		v907 = v894
		goto L271
...
L282:
	;
	v941 = F_find_among_b(m, l0, int32(4168704), int32(3))
	mBase = m.M
	v942 = m.ExcPending
	if v942 != 0 {
		goto L10
...
L293:
	;
	v982 = F_find_among_b(m, l0, int32(4168768), int32(3))
	mBase = m.M
	v983 = m.ExcPending
	if v983 != 0 {
		goto L10
...
L304:
	...
	v1015 = F_memcmp(m, v1012+v1002-v1004, int32(2139390), v1004)
	mBase = m.M
	if v1015 != 0 {
		v1019 = v1006
		goto L303
...
L312:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v809 - int32(1)
	v1048 = F_slice_from_s(m, l0, int32(2), int32(2139392))
	mBase = m.M
	v1049 = m.ExcPending
	if v1049 != 0 {
		goto L10
...
L316:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v1057
	v1064 = F_find_among_b(m, l0, int32(4168832), int32(120))
	mBase = m.M
	v1065 = m.ExcPending
	if v1065 != 0 {
		goto L10
...
L318:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v1068
	v1074 = F_find_among_b(m, l0, int32(4171232), int32(7))
	mBase = m.M
	v1075 = m.ExcPending
	if v1075 != 0 {
		goto L10
...
L338:
	;
	v1197 = F_slice_from_s(m, l0, int32(1), int32(2140154))
	mBase = m.M
	v1198 = m.ExcPending
	if v1198 != 0 {
		goto L10
...
L362:
	;
	v1227 = F_find_among(m, l0, int32(4171456), int32(3))
	mBase = m.M
	v1228 = m.ExcPending
	if v1228 != 0 {
		goto L10
...
L369:
	;
	v1241 = F_slice_from_s(m, l0, int32(1), int32(2140160))
	mBase = m.M
	v1242 = m.ExcPending
	if v1242 != 0 {
		goto L10
...
L370:
	;
	v1235 = F_slice_from_s(m, l0, int32(1), int32(2140159))
	mBase = m.M
	v1236 = m.ExcPending
	if v1236 != 0 {
		goto L10
...
func F_pow(m *base.Module, l0 float64, l1 float64) float64 {
	...
	if base.B2i32(base.Ui32(int32(-129)) < base.Ui32(v32))&base.B2i32(base.Ui32(int32(-2046)) <= base.Ui32(v24-v29)) != 0 {
		...
		v257 = *(*float64)(unsafe.Add(mBase, _consts[1573]))
		v261 = *(*float64)(unsafe.Add(mBase, uint32(v233)+uint32(_consts[1574])))
		v262 = base.F64_add(base.F64_mul(v223, v257), v261)
		v263 = base.F64_add(v255, v262)
		v268 = *(*float64)(unsafe.Add(mBase, _consts[1575]))
		...
		v282 = *(*float64)(unsafe.Add(mBase, _consts[1576]))
		v285 = *(*float64)(unsafe.Add(mBase, _consts[1577]))
		v289 = *(*float64)(unsafe.Add(mBase, _consts[1578]))
		v292 = *(*float64)(unsafe.Add(mBase, _consts[1579]))
		v297 = *(*float64)(unsafe.Add(mBase, _consts[1580]))
		v300 = *(*float64)(unsafe.Add(mBase, _consts[1581]))
		...
		*(*float64)(unsafe.Add(mBase, uint32(v19)+8)) = v307
		...
		if base.Ui32(v326-v331) < base.Ui32(base.I32_wrap_i64(int64(base.Ui64(base.I64_reinterpret_f64(float64(512)))>>(uint(int64(52))%64)))-v331) {
			v360 = v326
			v362 = *(*float64)(unsafe.Add(mBase, _consts[1582]))
			v365 = *(*float64)(unsafe.Add(mBase, _consts[1583]))
			v366 = base.F64_add(base.F64_mul(v313, v362), v365)
			v367 = base.F64_sub(v366, v365)
			v369 = *(*float64)(unsafe.Add(mBase, _consts[1584]))
			v372 = *(*float64)(unsafe.Add(mBase, _consts[1585]))
			...
			v380 = *(*float64)(unsafe.Add(mBase, _consts[1586]))
			v383 = *(*float64)(unsafe.Add(mBase, _consts[1587]))
			v387 = *(*float64)(unsafe.Add(mBase, _consts[1588]))
			v390 = *(*float64)(unsafe.Add(mBase, _consts[1589]))
...
L25:
	;
	F_errfinish(m, int32(478862), int32(292), int32(232809))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L9
...
func F_printtup_startup(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v9 != 0 {
		...
		v16 = F_AllocSetContextCreateInternal(m, v11, int32(223029), int32(0), int32(8192), int32(8388608))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v106
	F_errmsg_internal(m, int32(468763), v11+int32(16))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(482475), int32(613), int32(347826))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L1
...
L43:
	;
	F_errfinish(m, int32(482475), int32(632), int32(347826))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v328))) = int32(101)
	v336 = F_makeAlias(m, int32(635430), int32(0))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L114:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v473
	F_errmsg_internal(m, int32(469568), v16)
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L1
...
L115:
	;
	F_errfinish(m, int32(482475), int32(1255), int32(347732))
	mBase = m.M
	v482 = m.ExcPending
	if v482 != 0 {
		goto L1
...
L118:
	;
	F_errfinish(m, int32(482475), int32(2222), int32(294124))
	mBase = m.M
	v495 = m.ExcPending
	if v495 != 0 {
		goto L1
...
L125:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v501
	F_errmsg_internal(m, int32(468763), v16+int32(16))
	mBase = m.M
	v507 = m.ExcPending
	if v507 != 0 {
		goto L1
...
L126:
	;
	F_errfinish(m, int32(482475), int32(1249), int32(347732))
	mBase = m.M
	v512 = m.ExcPending
	if v512 != 0 {
		goto L1
...
func F_push_into_mbuf(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	if int32(0) < l3 {
		...
		if v9 == int32(1) {
			F_px_debug(m, int32(337175), int32(0))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return int32(0)
...
func F_puts(m *base.Module, l0 int32) {
	...
	if v6 != 0 {
		...
		if v5 < int32(0) {
			...
			v10 = *(*int32)(unsafe.Add(mBase, _consts[1590]))
			if v10 == int32(10) {
				F___overflow(m, int32(4349432), int32(10))
				mBase = m.M
				v28 = m.ExcPending
				if v28 != 0 {
					return
				...
				v14 = *(*int32)(unsafe.Add(mBase, _consts[1591]))
				v16 = *(*int32)(unsafe.Add(mBase, _consts[1592]))
				if v14 == v16 {
					F___overflow(m, int32(4349432), int32(10))
					mBase = m.M
					v28 = m.ExcPending
					...
					*(*int32)(unsafe.Add(mBase, _consts[1591])) = v14 + int32(1)
					v22 = int32(10)
		...
		if int32(0) <= v10 {
					...
					if v42 != 0 {
						...
						if v45 != 0 {
							...
							if v49 != 0 {
								...
								F_errfinish(m, int32(481403), int32(140), int32(326045))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return int32(0)
			...
			if v29 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = l2
				F_errmsg_internal(m, int32(678005), v8)
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(481403), int32(113), int32(326045))
					mBase = m.M
					v38 = m.ExcPending
					if v38 != 0 {
						return int32(0)
