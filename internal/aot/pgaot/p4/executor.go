...
func F_ExecutorEnd(m *base.Module, l0 int32) {
	...
	var v127 int32
	_ = v127
	v10 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorEnd[0]))
	if v10 != 0 {
		goto L1
	} else {
		goto L2
...
L6:
	...
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorEnd[1]))
	if v19 != 0 {
		goto L9
	} else {
		goto L10
...
L8:
	;
	v39 = int32(_a_F_ExecutorEnd_0)
	v40 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorEnd[2]))
	v42 = *(*int32)(unsafe.Add(mBase, uint32(v13)+100))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorEnd[2])) = v42
...
L34:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorEnd[2])) = v40
...
func F_ExecutorRewind(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorRewind[0])) = v7
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_ExecutorRewind[0])) = v4
		return
	}
}
