	...
	if v87 != 0 {
		...
		if v91 != 0 {
			...
			if v90 == int32(0) {
				...
				*(*uint32)(unsafe.Add(mBase, uint32(v9))) = uint32(v97)
				F_errmsg_internal(m, int32(161039), v9)
				mBase = m.M
				v101 = m.ExcPending
				if v101 != 0 {
					return
				} else {
					F_errfinish(m, int32(475016), int32(7606), int32(84613))
					mBase = m.M
					v106 = m.ExcPending
					if v106 != 0 {
						return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v108)+440)) = int32(1)
		if v109 != 0 {
			...
			F_s_lock(m, v113+int32(440), int32(475016), int32(7614), int32(84613))
			mBase = m.M
			v120 = m.ExcPending
			if v120 != 0 {
				return
...
L4:
	;
	v26 = int32(*(*uint8)(unsafe.Add(mBase, _consts[916])))
	if v26 == int32(0) {
		goto L5
	} else {
		goto L6
...
L5:
	;
	v30 = int32(*(*uint8)(unsafe.Add(mBase, _consts[877])))
	if v30 != int32(1) {
		v54 = v14
		goto L3
	} else {
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1157])) = int32(1000)
...
L26:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v18)+16)) = v174
	...
	v181 = *(*int32)(unsafe.Add(mBase, _consts[1121]))
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v154))) = l2
	v157 = *(*int32)(unsafe.Add(mBase, _consts[1157]))
	F_pg_usleep(m, v157)
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
...
L29:
	;
	v117 = *(*int32)(unsafe.Add(mBase, _consts[917]))
	if int32(0) <= v117 {
		v124 = v117
		goto L28
	} else {
...
L31:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _consts[918]))
	if v121 < int32(0) {
		goto L27
	} else {
		goto L33
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1157])) = v172
	goto L25
L41:
	;
	v189 = int32(0)
...
L43:
	;
	v196 = *(*int32)(unsafe.Add(mBase, _consts[1122]))
	v204 = v189
	goto L44
L44:
	;
...
L62:
	;
	v293 = int32(*(*uint8)(unsafe.Add(mBase, _consts[877])))
	v294 = v293 & v280
	v296 = int32(*(*uint8)(unsafe.Add(mBase, _consts[916])))
...
L74:
	;
	v343 = *(*int32)(unsafe.Add(mBase, _consts[915]))
	goto L75
L75:
	;
...
L12:
	;
	v45 = F_format_elog_string(m, int32(627439), int32(0))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L13
...
L31:
	;
	v98 = F_format_elog_string(m, int32(570201), int32(0))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L26
