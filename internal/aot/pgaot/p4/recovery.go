	...
	if v87 != 0 {
		...
		if v91 != 0 {
			...
			if v90 == int32(0) {
				...
				*(*uint32)(unsafe.Add(mBase, uint32(v9))) = uint32(v97)
				F_errmsg_internal(m, int32(168104), v9)
				mBase = m.M
				v101 = m.ExcPending
				if v101 != 0 {
					return
				} else {
					F_errfinish(m, int32(489152), int32(7606), int32(87839))
					mBase = m.M
					v106 = m.ExcPending
					if v106 != 0 {
						return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v108)+440)) = int32(1)
		if v109 != 0 {
			...
			F_s_lock(m, v113+int32(440), int32(489152), int32(7614), int32(87839))
			mBase = m.M
			v120 = m.ExcPending
			if v120 != 0 {
				return
...
L12:
	;
	v45 = F_format_elog_string(m, int32(642885), int32(0))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L13
...
L31:
	;
	v98 = F_format_elog_string(m, int32(585335), int32(0))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L26
