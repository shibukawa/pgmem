	...
	if v87 != 0 {
		...
		if v91 != 0 {
			...
			if v90 == int32(0) {
				...
				*(*uint32)(unsafe.Add(mBase, uint32(v9))) = uint32(v97)
				F_errmsg_internal(m, int32(181721), v9)
				mBase = m.M
				v101 = m.ExcPending
				if v101 != 0 {
					return
				} else {
					F_errfinish(m, int32(523959), int32(7606), int32(95556))
					mBase = m.M
					v106 = m.ExcPending
					if v106 != 0 {
						return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v108)+440)) = int32(1)
		if v109 != 0 {
			...
			F_s_lock(m, v113+int32(440), int32(523959), int32(7614), int32(95556))
			mBase = m.M
			v120 = m.ExcPending
			if v120 != 0 {
				return
...
L4:
	;
	v26 = int32(*(*uint8)(unsafe.Add(mBase, _consts[927])))
	if v26 == int32(0) {
		goto L5
	} else {
		goto L6
...
L5:
	;
	v30 = int32(*(*uint8)(unsafe.Add(mBase, _consts[888])))
	if v30 != int32(1) {
		v54 = v14
		goto L3
	} else {
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1168])) = int32(1000)
...
L26:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v18)+16)) = v174
	...
	v181 = *(*int32)(unsafe.Add(mBase, _consts[1132]))
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v154))) = l2
	v157 = *(*int32)(unsafe.Add(mBase, _consts[1168]))
	F_pg_usleep(m, v157)
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
...
L31:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _consts[929]))
	if v121 < int32(0) {
		goto L27
	} else {
		goto L33
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v161))) = int32(0)
	v164 = int32(4164684)
	v165 = int32(1000000)
	v167 = *(*int32)(unsafe.Add(mBase, _consts[1168]))
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1168])) = v172
	goto L25
L41:
	;
	v189 = int32(0)
...
L43:
	;
	v196 = *(*int32)(unsafe.Add(mBase, _consts[1133]))
	v204 = v189
	goto L44
L44:
	;
...
L62:
	;
	v293 = int32(*(*uint8)(unsafe.Add(mBase, _consts[888])))
	v294 = v293 & v280
	v296 = int32(*(*uint8)(unsafe.Add(mBase, _consts[927])))
...
L12:
	;
	v45 = F_format_elog_string(m, int32(700834), int32(0))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L13
...
L31:
	;
	v98 = F_format_elog_string(m, int32(640718), int32(0))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L26
