...
L80:
	;
	F_errfinish(m, int32(489508), int32(180), int32(126187))
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L10
...
L85:
	;
	F_errfinish(m, int32(489508), int32(187), int32(126187))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L10
...
L89:
	;
	F_errfinish(m, int32(489508), int32(202), int32(126187))
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L10
...
L233:
	;
	F_errmsg(m, int32(461036), int32(0))
	mBase = m.M
	v870 = m.ExcPending
	if v870 != 0 {
		goto L10
...
L234:
	;
	F_errfinish(m, int32(489508), int32(276), int32(126187))
	mBase = m.M
	v877 = m.ExcPending
	if v877 != 0 {
		goto L10
