...
L80:
	;
	F_errfinish(m, int32(487696), int32(180), int32(125753))
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L10
...
L85:
	;
	F_errfinish(m, int32(487696), int32(187), int32(125753))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L10
...
L89:
	;
	F_errfinish(m, int32(487696), int32(202), int32(125753))
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L10
...
L233:
	;
	F_errmsg(m, int32(459282), int32(0))
	mBase = m.M
	v870 = m.ExcPending
	if v870 != 0 {
		goto L10
...
L234:
	;
	F_errfinish(m, int32(487696), int32(276), int32(125753))
	mBase = m.M
	v877 = m.ExcPending
	if v877 != 0 {
		goto L10
...
func F_g_int_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_int_reloption(m, v2, int32(167893), int32(268293), int32(100), int32(1), int32(252))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		return int32(0)
