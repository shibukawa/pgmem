						...
						if v115 != 0 {
							...
							if v118 != 0 {
								...
								if v122 != 0 {
									...
									F_errfinish(m, int32(496857), int32(4646), int32(210750))
									mBase = m.M
									v127 = m.ExcPending
									if v127 != 0 {
										return int64(0)
					...
					if v14 == int32(49152) {
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(88951)
						...
						if v141 != 0 {
							...
							F_errfinish(m, int32(496857), int32(4624), int32(210750))
							mBase = m.M
							v146 = m.ExcPending
							if v146 != 0 {
								return int64(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(88951)
						...
						if v34 != 0 {
							...
							F_errfinish(m, int32(496857), int32(4628), int32(210750))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int64(0)
							...
							if v349 != 0 {
								...
								if v352 != 0 {
									...
									if v356 != 0 {
										...
										F_errfinish(m, int32(496857), int32(4008), int32(325474))
										mBase = m.M
										v361 = m.ExcPending
										if v361 != 0 {
											return int32(0)
									...
									if v365 != 0 {
										...
										if v368 != 0 {
											...
											if v372 != 0 {
												...
												F_errfinish(m, int32(496857), int32(4013), int32(325474))
												mBase = m.M
												v377 = m.ExcPending
												if v377 != 0 {
													return int32(0)
						...
						if v67 == int32(0) {
							...
							if v72 != v71 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v13)+8)) = v71
								...
								v91 = int32(2)
								v95 = *(*int32)(unsafe.Add(mBase, uint32(v67<<(uint(v91)%32))+uint32(_consts[1301])))
				...
				if v125 != 0 {
					...
					if v128 != 0 {
						...
						if v132 != 0 {
							...
							F_errfinish(m, int32(496857), int32(3813), int32(77945))
							mBase = m.M
							v137 = m.ExcPending
							if v137 != 0 {
								return int32(0)
...
L36:
	...
	v191 = v14 + int32(24)
	v192 = int32(1721396)
	v199 = *(*int32)(unsafe.Add(mBase, _consts[1303]))
	v200 = *(*int32)(unsafe.Add(mBase, _consts[1304]))
...
L50:
	;
	v218 = *(*int32)(unsafe.Add(mBase, _consts[1305]))
	v219 = *(*int32)(unsafe.Add(mBase, _consts[1306]))
...
L16:
	;
	v58 = F_cstring_to_text(m, int32(738731))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
L36:
	;
	v90 = int32(524498)
	v93 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1262])))
...
L45:
	;
	v118 = int32(11422)
	v121 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1291])))
...
L54:
	;
	v146 = int32(11411)
	v149 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1292])))
					...
					if v63 < v62 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = v62
						...
						if v67 == int32(0) {
							...
							v81 = *(*int32)(unsafe.Add(mBase, uint32(v67<<(uint(v74)%32))+uint32(_consts[1301])))
