			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+60)) = l0 + v98
						...
						if v115 != 0 {
							...
							if v118 != 0 {
								...
								if v122 != 0 {
									...
									F_errfinish(m, int32(525301), int32(4646), int32(222875))
									mBase = m.M
									v127 = m.ExcPending
									if v127 != 0 {
										return int64(0)
			...
			if v22 != 0 {
				...
				if v25 != 0 {
					...
					if v14 == int32(49152) {
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(95737)
						F_errmsg(m, int32(193899), v10)
						mBase = m.M
						v141 = m.ExcPending
						if v141 != 0 {
							return int64(0)
						} else {
							F_errfinish(m, int32(525301), int32(4624), int32(222875))
							mBase = m.M
							v146 = m.ExcPending
							if v146 != 0 {
								return int64(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(95737)
						F_errmsg(m, int32(193222), v8+int32(-48))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return int64(0)
						} else {
							F_errfinish(m, int32(525301), int32(4628), int32(222875))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int64(0)
							...
							if v349 != 0 {
								...
								if v352 != 0 {
									...
									if v356 != 0 {
										...
										F_errfinish(m, int32(525301), int32(4008), int32(344232))
										mBase = m.M
										v361 = m.ExcPending
										if v361 != 0 {
											return int32(0)
									...
									if v365 != 0 {
										...
										if v368 != 0 {
											...
											if v372 != 0 {
												...
												F_errfinish(m, int32(525301), int32(4013), int32(344232))
												mBase = m.M
												v377 = m.ExcPending
												if v377 != 0 {
													return int32(0)
				...
				if v125 != 0 {
					...
					if v128 != 0 {
						...
						if v132 != 0 {
							...
							F_errfinish(m, int32(525301), int32(3813), int32(84293))
							mBase = m.M
							v137 = m.ExcPending
							if v137 != 0 {
								return int32(0)
...
L16:
	;
	v58 = F_cstring_to_text(m, int32(791891))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
