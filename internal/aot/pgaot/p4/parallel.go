...
L304:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+16)) = v1557
	F_errmsg_internal(m, int32(472314), v25+int32(16))
	mBase = m.M
	v1563 = m.ExcPending
	if v1563 != 0 {
		goto L1
...
L305:
	;
	F_errfinish(m, int32(493389), int32(1392), int32(323992))
	mBase = m.M
	v1568 = m.ExcPending
	if v1568 != 0 {
		goto L1
...
L310:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25))) = v1588
	F_errmsg_internal(m, int32(480715), v25)
	mBase = m.M
	v1592 = m.ExcPending
	if v1592 != 0 {
		goto L1
...
L12:
	;
	F_errfinish(m, int32(494348), int32(1312), int32(257564))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L1
...
L38:
	;
	v337 = F___memcpy(m, int32(4385464), int32(4385304), int32(128))
	mBase = m.M
	v340 = *(*int64)(unsafe.Add(mBase, _consts[24]))
	*(*int64)(unsafe.Add(mBase, _consts[493])) = v340
	v344 = *(*int64)(unsafe.Add(mBase, _consts[21]))
	*(*int64)(unsafe.Add(mBase, _consts[494])) = v344
	v348 = *(*int64)(unsafe.Add(mBase, _consts[23]))
	*(*int64)(unsafe.Add(mBase, _consts[495])) = v348
	v352 = *(*int64)(unsafe.Add(mBase, _consts[22]))
	*(*int64)(unsafe.Add(mBase, _consts[496])) = v352
	goto L65
L39:
	;
	goto L38
...
L72:
	...
	mBase = m.M
	F_BufferUsageAccumDiff(m, v384, int32(4385464))
	mBase = m.M
	v388 = v379 + int32(24)
	v389 = int64(0)
...
L22:
	;
	v438 = *(*int32)(unsafe.Add(mBase, _consts[465]))
	if v438 != 0 {
		goto L87
	} else {
		goto L88
...
L25:
	...
	v99 = *(*int32)(unsafe.Add(mBase, _consts[466]))
...
L32:
	;
	v117 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[467])) = v117
	*(*int32)(unsafe.Add(mBase, _consts[466])) = v117
	v123 = *(*int32)(unsafe.Add(mBase, uint32(l0)+16))
	*(*int32)(unsafe.Add(mBase, _consts[465])) = v123 + int32(40)
	*(*int32)(unsafe.Add(mBase, _consts[468])) = v123 + int32(36)
	goto L34
L33:
	;
	goto L34
...
L36:
	;
	v177 = *(*int32)(unsafe.Add(mBase, _consts[465]))
	if v177 != 0 {
		goto L52
	} else {
		goto L53
...
L37:
	;
	F_errfinish(m, int32(494331), v171, int32(156581))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L26
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v222))) = v225 - int32(1)
	v230 = *(*int32)(unsafe.Add(mBase, _consts[465]))
	if v230 == int32(0) {
		goto L65
	} else {
		goto L67
...
L70:
	;
	v283 = *(*int32)(unsafe.Add(mBase, _consts[465]))
	if v283 != 0 {
		goto L78
	} else {
		goto L79
...
L92:
	;
	v483 = *(*int32)(unsafe.Add(mBase, _consts[465]))
	if v483 == int32(0) {
		goto L100
	} else {
		goto L101
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v483))) = v486 - int32(1)
	v491 = *(*int32)(unsafe.Add(mBase, _consts[465]))
	if v491 == int32(0) {
		goto L100
	} else {
		goto L102
...
L105:
	;
	v544 = *(*int32)(unsafe.Add(mBase, _consts[465]))
	if v544 == int32(0) {
		goto L19
	} else {
		goto L113
...
L117:
	;
	v593 = *(*int32)(unsafe.Add(mBase, _consts[468]))
	if v593 != 0 {
		goto L122
	} else {
		goto L123
...
L122:
	...
	*(*int32)(unsafe.Add(mBase, _consts[466])) = v595
	v598 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[468])) = v598
	*(*int32)(unsafe.Add(mBase, _consts[465])) = v598
	goto L124
L123:
	;
	goto L124
...
L125:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v615 + int32(4)
	F_errmsg_internal(m, int32(444009), v11)
	mBase = m.M
	v621 = m.ExcPending
	if v621 != 0 {
		goto L26
...
L126:
	;
	F_errfinish(m, int32(494331), int32(753), int32(156581))
	mBase = m.M
	v626 = m.ExcPending
	if v626 != 0 {
		goto L26
