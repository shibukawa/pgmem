...
func F_pgaio_error_cleanup(m *base.Module) {
	...
	var v10 int32
	_ = v10
	v3 = *(*int32)(unsafe.Add(mBase, _consts[902]))
...
func F_pgaio_io_get_handle_data(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l1))) = uint8(v3)
	v6 = *(*int32)(unsafe.Add(mBase, _consts[895]))
...
func F_pgaio_io_get_id(m *base.Module, l0 int32) int32 {
	...
	var v4 int32
	_ = v4
	v3 = *(*int32)(unsafe.Add(mBase, _consts[895]))
...
func F_pgaio_io_get_target_name(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(v2<<(uint(int32(2))%32))+uint32(_consts[897])))
...
L6:
	...
	v96 = *(*int32)(unsafe.Add(mBase, uint32(v93)+uint32(_consts[896])))
...
L16:
	;
	v109 = *(*int32)(unsafe.Add(mBase, _consts[895]))
...
L18:
	...
	v129 = *(*int32)(unsafe.Add(mBase, uint32(v124<<(uint(int32(2))%32))+uint32(_consts[897])))
	v130 = *(*int32)(unsafe.Add(mBase, uint32(v129)+8))
	goto L22
L19:
	;
	v122 = *(*int32)(unsafe.Add(mBase, uint32(v115<<(uint(int32(2))%32))+uint32(_consts[898])))
	v123 = v122
	goto L21
L20:
	;
...
L24:
	;
	v139 = *(*int32)(unsafe.Add(mBase, uint32(v132<<(uint(int32(2))%32))+uint32(_consts[899])))
	v140 = v139
	goto L26
L25:
	;
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31+int32(68)))) = v91
	v157 = *(*int32)(unsafe.Add(mBase, uint32(v93)+uint32(_consts[900])))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+60)) = v140
	F_errmsg_internal(m, int32(662049), v31+int32(48))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L1
...
L28:
	;
	v153 = *(*int32)(unsafe.Add(mBase, uint32(v145<<(uint(int32(2))%32))+uint32(_consts[901])))
	v154 = v153
	goto L30
L29:
	;
...
L31:
	;
	F_errfinish(m, int32(494549), int32(257), int32(448795))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L40:
	;
	v246 = *(*int32)(unsafe.Add(mBase, _consts[895]))
...
L42:
	...
	v266 = *(*int32)(unsafe.Add(mBase, uint32(v261<<(uint(int32(2))%32))+uint32(_consts[897])))
	v267 = *(*int32)(unsafe.Add(mBase, uint32(v266)+8))
	goto L46
L43:
	;
	v259 = *(*int32)(unsafe.Add(mBase, uint32(v252<<(uint(int32(2))%32))+uint32(_consts[898])))
	v260 = v259
	goto L45
L44:
	;
...
L48:
	;
	v276 = *(*int32)(unsafe.Add(mBase, uint32(v269<<(uint(int32(2))%32))+uint32(_consts[899])))
	v277 = v276
	goto L50
L49:
	;
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+12)) = v277
	F_errmsg_internal(m, int32(478040), v31)
	mBase = m.M
	v310 = m.ExcPending
	if v310 != 0 {
		goto L1
...
L52:
	;
	v290 = *(*int32)(unsafe.Add(mBase, uint32(v282<<(uint(int32(2))%32))+uint32(_consts[901])))
	v291 = v290
	goto L54
L53:
	;
...
L55:
	;
	F_errfinish(m, int32(494549), int32(270), int32(448795))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L1
...
func F_pgaio_io_register_callbacks(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if base.Ui32(v2) < base.Ui32(int32(4)) {
		...
		v20 = *(*int32)(unsafe.Add(mBase, uint32(v17)+uint32(_consts[896])))
			...
			if v24 == int32(0) {
				...
				if v125 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v2
					F_errmsg_internal(m, int32(317148), v12+int32(16))
					mBase = m.M
					v131 = m.ExcPending
					if v131 != 0 {
						return
					} else {
						F_errfinish(m, int32(494549), int32(96), int32(153778))
						mBase = m.M
						v136 = m.ExcPending
						if v136 != 0 {
							return
				...
				if base.Ui32(int32(4)) <= base.Ui32(v27) {
					...
					if v140 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = int32(4)
						F_errmsg_internal(m, int32(467252), v12+int32(32))
						mBase = m.M
						v147 = m.ExcPending
						if v147 != 0 {
							return
						} else {
							F_errfinish(m, int32(494549), int32(99), int32(153778))
							mBase = m.M
							v152 = m.ExcPending
							if v152 != 0 {
								return
							...
							if v38 != 0 {
								...
								if v40 != 0 {
									...
									if base.Ui32(v48) <= base.Ui32(int32(2)) {
										v55 = *(*int32)(unsafe.Add(mBase, uint32(v48<<(uint(int32(2))%32))+uint32(_consts[898])))
										v56 = v55
									} else {
										v56 = int32(0)
									}
									v57 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+1)))
									v62 = *(*int32)(unsafe.Add(mBase, uint32(v57<<(uint(int32(2))%32))+uint32(_consts[897])))
									v63 = *(*int32)(unsafe.Add(mBase, uint32(v62)+8))
									v65 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0))))
									if base.Ui32(v65) <= base.Ui32(int32(7)) {
										v72 = *(*int32)(unsafe.Add(mBase, uint32(v65<<(uint(int32(2))%32))+uint32(_consts[899])))
										v73 = v72
									} else {
										v73 = int32(0)
									}
									v74 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+4)))
									v75 = *(*int32)(unsafe.Add(mBase, uint32(v17)+uint32(_consts[900])))
									...
									*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = (l0 - v43) >> (uint(int32(7)) % 32)
									F_errmsg_internal(m, int32(176288), v12+int32(48))
									mBase = m.M
									v91 = m.ExcPending
									if v91 != 0 {
										return
									} else {
										F_errfinish(m, int32(494549), int32(106), int32(153778))
										mBase = m.M
										v96 = m.ExcPending
										if v96 != 0 {
											return
		...
		if v112 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v2
			F_errmsg_internal(m, int32(399863), v12)
			mBase = m.M
			v116 = m.ExcPending
			if v116 != 0 {
				return
			} else {
				F_errfinish(m, int32(494549), int32(93), int32(153778))
				mBase = m.M
				v121 = m.ExcPending
				if v121 != 0 {
					return
	...
	if l0 != 0 {
		...
		if v17 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = v14
			F_errcontext_msg(m, int32(466551), v5)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return
