...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+60)) = v140
	F_errmsg_internal(m, int32(680241), v31+int32(48))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(497502), int32(257), int32(451213))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+12)) = v277
	F_errmsg_internal(m, int32(480929), v31)
	mBase = m.M
	v310 = m.ExcPending
	if v310 != 0 {
		goto L1
...
L55:
	;
	F_errfinish(m, int32(497502), int32(270), int32(451213))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L1
	...
	if base.Ui32(v2) < base.Ui32(int32(4)) {
			...
			if v24 == int32(0) {
				...
				if v125 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v2
					F_errmsg_internal(m, int32(318852), v12+int32(16))
					mBase = m.M
					v131 = m.ExcPending
					if v131 != 0 {
						return
					} else {
						F_errfinish(m, int32(497502), int32(96), int32(154521))
						mBase = m.M
						v136 = m.ExcPending
						if v136 != 0 {
							return
				...
				if base.Ui32(int32(4)) <= base.Ui32(v27) {
					...
					if v140 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = int32(4)
						F_errmsg_internal(m, int32(469804), v12+int32(32))
						mBase = m.M
						v147 = m.ExcPending
						if v147 != 0 {
							return
						} else {
							F_errfinish(m, int32(497502), int32(99), int32(154521))
							mBase = m.M
							v152 = m.ExcPending
							if v152 != 0 {
								return
							...
							if v38 != 0 {
								...
								if v40 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = (l0 - v43) >> (uint(int32(7)) % 32)
									F_errmsg_internal(m, int32(177049), v12+int32(48))
									mBase = m.M
									v91 = m.ExcPending
									if v91 != 0 {
										return
									} else {
										F_errfinish(m, int32(497502), int32(106), int32(154521))
										mBase = m.M
										v96 = m.ExcPending
										if v96 != 0 {
											return
		...
		if v112 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v2
			F_errmsg_internal(m, int32(402095), v12)
			mBase = m.M
			v116 = m.ExcPending
			if v116 != 0 {
				return
			} else {
				F_errfinish(m, int32(497502), int32(93), int32(154521))
				mBase = m.M
				v121 = m.ExcPending
				if v121 != 0 {
					return
	...
	if l0 != 0 {
		...
		if v17 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = v14
			F_errcontext_msg(m, int32(469103), v5)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return
