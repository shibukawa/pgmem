...
func F_tsvector_delete_by_indices(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if int32(2) <= l2 {
		F_pg_qsort(m, l1, l2, int32(4), int32(1540))
		mBase = m.M
		v24 = m.ExcPending
		if v24 != 0 {
			return int32(0)
						...
						if v66 <= v113 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v143))) = v152&int32(4094) | v107<<(uint(int32(12))%32) | v146
							...
							if v160&v145 != 0 {
								...
								v174 = int32(2)
								v184 = v92 + v173<<(uint(v174)%32) + (int32(base.Ui32(v160)>>(uint(int32(12))%32))+v164+v168)&int32(_a_F_tsvector_delete_by_indices_0)
...
L21:
	...
	v108 = int32(2)
	v111 = int32(1)
	v122 = v85 + v107<<(uint(v108)%32) + (int32(base.Ui32(v104)>>(uint(v111)%32))&int32(2047)+int32(base.Ui32(v104)>>(uint(int32(12))%32))+v111)&int32(_a_F_tsvector_unnest_4)
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v126+v149))) = v154 & int32(_a_F_tsvector_unnest_5)
