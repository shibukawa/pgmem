...
L7:
	;
	v103 = *(*int32)(unsafe.Add(mBase, _c_F_CheckValidResultRel[0]))
	if int32(0) < v103 {
		goto L1
	} else {
		goto L37
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v62 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_0), v9+int32(16))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L20
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v83 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_3), v9+int32(32))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L20
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = v113 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_4), v9+int32(48))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L20
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+96)) = v147 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_5), v9+int32(96))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L20
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+128)) = v178 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_6), v9+int32(128))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L20
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+160)) = v209 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_7), v9+int32(160))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L20
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = l1
	F_errmsg_internal(m, int32(_a_F_CheckValidResultRel_8), v9-int32(-64))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L20
...
L74:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v245 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_9), v9)
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L20
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+80)) = v264 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_10), v9+int32(80))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L20
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+112)) = v285 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_11), v9+int32(112))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L20
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+144)) = v306 + int32(4)
	F_errmsg(m, int32(_a_F_CheckValidResultRel_12), v9+int32(144))
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L20
...
func F_ValidXLogRecordHeader(m *base.Module, l0 int32, l1 int64, l2 int64, l3 int32, l4 int32) int32 {
	...
	if base.Ui32(v13) <= base.Ui32(int32(23)) {
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v11))) = uint32(v21)
		F_report_invalid_record(m, l0, int32(_a_F_ValidXLogRecordHeader_0), v11)
		mBase = m.M
		v27 = m.ExcPending
		if v27 != 0 {
			return int32(0)
		...
		if int32(22) <= v28 {
			...
			*(*uint32)(unsafe.Add(mBase, uint32(v11)+52)) = uint32(v34)
			F_report_invalid_record(m, l0, int32(_a_F_ValidXLogRecordHeader_1), v9+int32(-16))
			mBase = m.M
			v40 = m.ExcPending
			if v40 != 0 {
				return int32(0)
			...
			if l4 != 0 {
				if base.Ui64(v41) < base.Ui64(v2) {
					...
					*(*uint32)(unsafe.Add(mBase, uint32(v11)+16)) = uint32(v50)
					F_report_invalid_record(m, l0, int32(_a_F_ValidXLogRecordHeader_2), v9+int32(-48))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
				...
				if l2 == v41 {
					...
					*(*uint32)(unsafe.Add(mBase, uint32(v11)+32)) = uint32(v65)
					F_report_invalid_record(m, l0, int32(_a_F_ValidXLogRecordHeader_2), v9+int32(-32))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return int32(0)
...
L1:
	;
	return base.I32_extend8_s(v149)
L2:
	;
	v14 = l0 + v13
...
L6:
	;
	v77 = int32(*(*int8)(unsafe.Add(mBase, uint32(v14))))
	if int32(0) <= v77 {
		goto L20
	} else {
		goto L21
...
L14:
	...
	v66 = int32(2)
	v67 = v17<<(uint(int32(12))%32)&int32(_a_F_read_valid_char_0) | v38&int32(63)<<(uint(int32(6))%32)
	goto L10
L15:
	;
	goto L16
...
L17:
	...
	v66 = int32(3)
	v67 = v17<<(uint(int32(18))%32)&int32(_a_F_read_valid_char_1) | v54&v55<<(uint(int32(12))%32) | v60&v55<<(uint(int32(6))%32)
	goto L10
L18:
	;
	v130 = int32(0)
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1))) = v103
	v105 = int32(26)
	if base.Ui32(v76-int32(91)) < base.Ui32(int32(3)) {
		v130 = v105
		v133 = v103
		goto L5
	} else {
...
L32:
	;
	if base.Ui32(v76) <= base.Ui32(int32(95)) {
		goto L33
	} else {
		goto L34
	}
...
L35:
	;
	if base.Ui32(v76) <= base.Ui32(int32(255)) {
		goto L36
	} else {
		goto L37
	}
L36:
	;
	v116 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v76)+uint32(_c_F_read_valid_char[0]))))
	v130 = v116
	v133 = v103
	goto L5
L37:
...
L39:
	;
	v123 = int32(2)
	if base.B2i32(base.Ui32(v76-int32(354)) < base.Ui32(v123))|base.B2i32(base.Ui32(v76-int32(538)) < base.Ui32(v123)) != 0 {
		v149 = int32(93)
		goto L1
	} else {
		goto L40
...
L41:
	;
	return base.I32_extend8_s(v130)
L42:
	;
	goto L43
L43:
	;
	if base.Ui32(int32(28)) < base.Ui32((v130-int32(65))&int32(255)) {
		v13 = v133
		goto L2
	} else {
		goto L44
