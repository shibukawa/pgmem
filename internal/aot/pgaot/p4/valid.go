...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v62 + int32(4)
	F_errmsg(m, int32(696277), v9+int32(16))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L20
...
L28:
	;
	F_errfinish(m, int32(488162), int32(1090), int32(303250))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L20
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v83 + int32(4)
	F_errmsg(m, int32(683564), v9+int32(32))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L20
...
L32:
	;
	F_errfinish(m, int32(488162), int32(1096), int32(303250))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L20
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = v113 + int32(4)
	F_errmsg(m, int32(672017), v9+int32(48))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L20
...
L40:
	;
	F_errfinish(m, int32(488162), int32(1115), int32(303250))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L20
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+96)) = v147 + int32(4)
	F_errmsg(m, int32(115862), v9+int32(96))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L20
...
L52:
	;
	F_errfinish(m, int32(488162), int32(1133), int32(303250))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L20
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+128)) = v178 + int32(4)
	F_errmsg(m, int32(157785), v9+int32(128))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L20
...
L60:
	;
	F_errfinish(m, int32(488162), int32(1146), int32(303250))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		goto L20
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+160)) = v209 + int32(4)
	F_errmsg(m, int32(157402), v9+int32(160))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L20
...
L68:
	;
	F_errfinish(m, int32(488162), int32(1159), int32(303250))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L20
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = l1
	F_errmsg_internal(m, int32(478091), v9-int32(-64))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L20
...
L71:
	;
	F_errfinish(m, int32(488162), int32(1162), int32(303250))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L20
...
L75:
	;
	F_errfinish(m, int32(488162), int32(1170), int32(303250))
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L20
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+80)) = v264 + int32(4)
	F_errmsg(m, int32(693743), v9+int32(80))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L20
...
L79:
	;
	F_errfinish(m, int32(488162), int32(1127), int32(303250))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L20
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+112)) = v285 + int32(4)
	F_errmsg(m, int32(693923), v9+int32(112))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L20
...
L83:
	;
	F_errfinish(m, int32(488162), int32(1140), int32(303250))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L20
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+144)) = v306 + int32(4)
	F_errmsg(m, int32(693856), v9+int32(144))
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L20
...
L87:
	;
	F_errfinish(m, int32(488162), int32(1153), int32(303250))
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L20
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v11))) = uint32(v21)
		...
		if int32(22) <= v28 {
			...
			*(*uint32)(unsafe.Add(mBase, uint32(v11)+52)) = uint32(v34)
			F_report_invalid_record(m, l0, int32(503095), v9+int32(-16))
			mBase = m.M
			v40 = m.ExcPending
			if v40 != 0 {
				return int32(0)
			...
			if l4 != 0 {
				if base.Ui64(v41) < base.Ui64(v2) {
					...
					*(*uint32)(unsafe.Add(mBase, uint32(v11)+16)) = uint32(v50)
					F_report_invalid_record(m, l0, int32(504978), v9+int32(-48))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
				...
				if l2 == v41 {
					...
					*(*uint32)(unsafe.Add(mBase, uint32(v11)+32)) = uint32(v65)
					F_report_invalid_record(m, l0, int32(504978), v9+int32(-32))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return int32(0)
