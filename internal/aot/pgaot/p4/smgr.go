...
func F_smgr_aio_describe_identity(m *base.Module, l0 int32) int32 {
	...
	v14 = *(*int32)(unsafe.Add(mBase, _c_F_smgr_aio_describe_identity[0]))
	...
	if v24 != 0 {
		...
		case 0:
			*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v6 + int32(40)
			v32 = F_psprintf(m, int32(_a_F_smgr_aio_describe_identity_0), v6+int32(16))
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return int32(0)
		...
		case 1:
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+36)) = v6 + int32(40)
			v42 = F_psprintf(m, int32(_a_F_smgr_aio_describe_identity_1), v6+int32(32))
			mBase = m.M
			v43 = m.ExcPending
			if v43 != 0 {
				return int32(0)
		...
		default:
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+8)) = v6 + int32(40)
			v54 = F_psprintf(m, int32(_a_F_smgr_aio_describe_identity_2), v6)
			mBase = m.M
			v55 = m.ExcPending
			if v55 != 0 {
				return int32(0)
