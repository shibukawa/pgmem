			...
			if v61 != 0 {
				...
				if v64 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v9))) = v17
					F_errmsg(m, int32(451947), v9)
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(527120), int32(3356), int32(110701))
						mBase = m.M
						v76 = m.ExcPending
						if v76 != 0 {
							return int32(0)
	...
	if int32(0) < l2 {
			...
			if v52 != 0 {
				...
				if v55 != 0 {
					...
					if v59 != 0 {
						...
						F_errfinish(m, int32(527120), int32(3240), int32(27059))
						v64 = m.ExcPending
						if v64 != 0 {
							return int32(0)
						} else {
		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				F_errmsg(m, int32(462103), int32(0))
				v43 = m.ExcPending
				if v43 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(527120), int32(3236), int32(27059))
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
					} else {
