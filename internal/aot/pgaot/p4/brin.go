...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v434
	F_errmsg_internal(m, int32(483438), v21)
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L5
				...
				if v175 != 0 {
					...
					if v174 == int32(0) {
						...
						if v435 != 0 {
							...
							F_errmsg_internal(m, int32(384697), int32(0))
							mBase = m.M
							v439 = m.ExcPending
							if v439 != 0 {
								return
							} else {
								F_errfinish(m, int32(498216), int32(193), int32(356154))
								mBase = m.M
								v444 = m.ExcPending
								if v444 != 0 {
									return
	...
	default:
		...
		if v411 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = v14
			F_errmsg_internal(m, int32(52485), v9)
			mBase = m.M
			v415 = m.ExcPending
			if v415 != 0 {
				return
			} else {
				F_errfinish(m, int32(498216), int32(334), int32(242677))
				mBase = m.M
				v420 = m.ExcPending
				if v420 != 0 {
					return
