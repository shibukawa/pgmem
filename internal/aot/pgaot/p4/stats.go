...
func F_AllocSetStats(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if l1 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v18)+12)) = v115
		v175 = F_pg_snprintf(m, v18+int32(32), int32(200), int32(448998), v18)
		mBase = m.M
		v176 = m.ExcPending
		if v176 != 0 {
			return
			...
			if v38 != 0 {
				...
				if v35 == int32(0) {
					...
					if v43 != 0 {
						...
						v49 = *(*int32)(unsafe.Add(mBase, uint32(v44<<(uint(int32(3))%32))+uint32(_consts[902])))
						if v21 != 0 {
							v50 = l2
						} else {
							v50 = l1
						}
						v55 = *(*int32)(unsafe.Add(mBase, uint32(v50<<(uint(int32(3))%32))+uint32(_consts[902])))
						*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v55
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v49
						F_errmsg(m, int32(457378), v9)
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(493796), int32(116), int32(213264))
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return int32(0)
