...
L126:
	;
	F_errfinish(m, int32(477856), int32(280), int32(232644))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L1
...
L1:
	...
	F_s_lock(m, v27+int32(1456), int32(478417), int32(1416), int32(207309))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L183:
	;
	F_errfinish(m, int32(478417), int32(1451), int32(207309))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L4
							...
							if v56 != 0 {
								...
								if v59 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v21))) = v17
									F_errmsg(m, int32(68495), v21)
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(476303), int32(57), int32(81556))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(0)
					F_errmsg(m, int32(54314), v5)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(477856), int32(2039), int32(119960))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
