...
L126:
	;
	F_errfinish(m, int32(491501), int32(280), int32(240382))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L1
...
L5:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _consts[1315]))
	goto L7
L7:
	;
	goto L4
...
L11:
	...
	v86 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1316])))
	v87 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1317])))
	v88 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1318])))
	v89 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1319])))
	v90 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1320])))
	v91 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1321])))
	v92 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1322])))
	v93 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1323])))
...
L24:
	;
	v150 = *(*int32)(unsafe.Add(mBase, uint32(v142<<(uint(int32(2))%32))+uint32(_consts[1315])))
	v151 = v150
	goto L26
L25:
	;
...
func F_pg_stat_get_wal_receiver(m *base.Module, l0 int32) int32 {
	...
	v19 = v17 - int32(1360)
	m.G0 = v19
	v22 = *(*int32)(unsafe.Add(mBase, _consts[858]))
...
L1:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[858]))
	F_s_lock(m, v27+int32(1456), int32(492078), int32(1416), int32(214040))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L3:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _consts[858]))
...
L6:
	;
	v170 = v19 + int32(1088)
	v172 = *(*int32)(unsafe.Add(mBase, _consts[858]))
...
L38:
	;
	v291 = *(*int32)(unsafe.Add(mBase, _consts[858]))
...
L70:
	;
	v411 = *(*int32)(unsafe.Add(mBase, _consts[858]))
	v412 = int32(0)
...
L123:
	;
	v469 = *(*int32)(unsafe.Add(mBase, uint32(v47<<(uint(int32(2))%32))+uint32(_consts[880])))
	v471 = v469
	goto L125
L124:
	;
...
L183:
	;
	F_errfinish(m, int32(492078), int32(1451), int32(214040))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L4
				...
				if v29 != 0 {
					...
					if v32 != 0 {
						...
						if v31 != 0 {
							...
							if v33 != 0 {
								v37 = *(*int32)(unsafe.Add(mBase, _consts[845]))
							...
							if v56 != 0 {
								...
								if v59 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v21))) = v17
									F_errmsg(m, int32(70314), v21)
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(489937), int32(57), int32(84292))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(0)
					F_errmsg(m, int32(55747), v5)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(491501), int32(2039), int32(125124))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
