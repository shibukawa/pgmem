...
L126:
	;
	F_errfinish(m, int32(496065), int32(280), int32(242344))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L1
...
L1:
	...
	F_s_lock(m, v27+int32(1456), int32(496642), int32(1416), int32(215513))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L183:
	;
	F_errfinish(m, int32(496642), int32(1451), int32(215513))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L4
							...
							if v56 != 0 {
								...
								if v59 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v21))) = v17
									F_errmsg(m, int32(71005), v21)
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(494462), int32(57), int32(85037))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(0)
					F_errmsg(m, int32(56242), v5)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496065), int32(2039), int32(126296))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
