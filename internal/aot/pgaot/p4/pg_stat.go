...
L126:
	;
	F_errfinish(m, int32(492840), int32(280), int32(241122))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L1
...
L5:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _consts[1313]))
	goto L7
L7:
	;
	goto L4
...
L11:
	...
	v86 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1314])))
	v87 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1315])))
	v88 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1316])))
	v89 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1317])))
	v90 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1318])))
	v91 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1319])))
	v92 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1320])))
	v93 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1321])))
...
L24:
	;
	v150 = *(*int32)(unsafe.Add(mBase, uint32(v142<<(uint(int32(2))%32))+uint32(_consts[1313])))
	v151 = v150
	goto L26
L25:
	;
...
L1:
	...
	F_s_lock(m, v27+int32(1456), int32(493417), int32(1416), int32(214545))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L183:
	;
	F_errfinish(m, int32(493417), int32(1451), int32(214545))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L4
							...
							if v56 != 0 {
								...
								if v59 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v21))) = v17
									F_errmsg(m, int32(70447), v21)
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(491276), int32(57), int32(84439))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(0)
					F_errmsg(m, int32(55808), v5)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(492840), int32(2039), int32(125510))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
