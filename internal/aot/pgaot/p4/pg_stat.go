...
L126:
	;
	F_errfinish(m, int32(483513), int32(280), int32(236285))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L1
...
L1:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[856]))
	F_s_lock(m, v27+int32(1456), int32(484074), int32(1416), int32(210950))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L3:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _consts[856]))
...
L6:
	;
	v170 = v19 + int32(1088)
	v172 = *(*int32)(unsafe.Add(mBase, _consts[856]))
...
L38:
	;
	v291 = *(*int32)(unsafe.Add(mBase, _consts[856]))
...
L70:
	;
	v411 = *(*int32)(unsafe.Add(mBase, _consts[856]))
	v412 = int32(0)
...
L123:
	;
	v469 = *(*int32)(unsafe.Add(mBase, uint32(v47<<(uint(int32(2))%32))+uint32(_consts[878])))
	v471 = v469
	goto L125
L124:
	;
...
L183:
	;
	F_errfinish(m, int32(484074), int32(1451), int32(210950))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L4
				...
				if v29 != 0 {
					...
					if v32 != 0 {
						...
						if v31 != 0 {
							...
							if v33 != 0 {
								v37 = *(*int32)(unsafe.Add(mBase, _consts[843]))
							...
							if v56 != 0 {
								...
								if v59 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v21))) = v17
									F_errmsg(m, int32(69104), v21)
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(481960), int32(57), int32(83047))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(0)
					F_errmsg(m, int32(54900), v5)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(483513), int32(2039), int32(122827))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
