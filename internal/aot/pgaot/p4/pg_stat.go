...
L126:
	;
	F_errfinish(m, int32(514109), int32(280), int32(251663))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L1
...
L5:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _consts[1318]))
	goto L7
L7:
	;
	goto L4
...
L11:
	...
	v86 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1319])))
	v87 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1320])))
	v88 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1321])))
	v89 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1322])))
	v90 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1323])))
	v91 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1324])))
	v92 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1325])))
	v93 = *(*int64)(unsafe.Add(mBase, uint32(v84)+uint32(_consts[1326])))
...
L24:
	;
	v150 = *(*int32)(unsafe.Add(mBase, uint32(v142<<(uint(int32(2))%32))+uint32(_consts[1318])))
	v151 = v150
	goto L26
L25:
	;
...
L1:
	...
	F_s_lock(m, v27+int32(1456), int32(514816), int32(1416), int32(224289))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L183:
	;
	F_errfinish(m, int32(514816), int32(1451), int32(224289))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L4
							...
							if v56 != 0 {
								...
								if v59 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v21))) = v17
									F_errmsg(m, int32(75959), v21)
									mBase = m.M
									v63 = m.ExcPending
									if v63 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(512108), int32(57), int32(90337))
										mBase = m.M
										v68 = m.ExcPending
										if v68 != 0 {
											return int32(0)
			...
			if v32 != 0 {
				...
				if v35 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(0)
					F_errmsg(m, int32(60511), v5)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(514109), int32(2039), int32(132927))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
