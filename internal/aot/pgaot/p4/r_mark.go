...
L20:
	;
	v116 = v90<<(uint(int32(12))%32)&int32(_a_F_r_mark_suffix_with_optional_y_consonant_0) | v86
	v117 = int32(3)
	goto L14
L21:
	;
...
L22:
	...
	v116 = v90<<(uint(int32(12))%32)&int32(_a_F_r_mark_suffix_with_optional_y_consonant_1) | v108&int32(7)<<(uint(int32(18))%32) | v86
	v117 = int32(4)
	goto L14
L23:
	;
...
L28:
	;
	v127 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v121)>>(uint(int32(3))%32)))+uint32(_c_F_r_mark_suffix_with_optional_y_consonant[0]))))
...
L70:
	;
	v320 = v294<<(uint(int32(12))%32)&int32(_a_F_r_mark_suffix_with_optional_y_consonant_0) | v290
	v321 = int32(3)
	goto L64
L71:
	;
...
L72:
	...
	v320 = v294<<(uint(int32(12))%32)&int32(_a_F_r_mark_suffix_with_optional_y_consonant_1) | v312&int32(7)<<(uint(int32(18))%32) | v290
	v321 = int32(4)
	goto L64
L73:
	;
...
L78:
	;
	v331 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v325)>>(uint(int32(3))%32)))+uint32(_c_F_r_mark_suffix_with_optional_y_consonant[0]))))
	...
	if v4 == v2 {
		...
		if v9 <= v10 {
			...
			if v14 != int32(109) {
				...
				v19 = F_find_among_b(m, l0, int32(_a_F_r_mark_yUm_0), int32(4))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v59
								...
								if v66 == int32(121) {
									...
									if v72 < v70 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v72
										v80 = F_in_grouping_b_U(m, l0, int32(_a_F_r_mark_yUm_1), int32(97), int32(305), int32(0))
										mBase = m.M
										if v80 != 0 {
											v95 = v70
										} else {
							...
							if v39 != int32(121) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v43
								v48 = int32(0)
								v49 = F_in_grouping_b_U(m, l0, int32(_a_F_r_mark_yUm_1), int32(97), int32(305), v48)
								mBase = m.M
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v61
								...
								if v68 == int32(121) {
									...
									if v74 < v72 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v74
										v82 = F_in_grouping_b_U(m, l0, int32(_a_F_r_mark_ymUs__1), int32(97), int32(305), int32(0))
										mBase = m.M
										if v82 != 0 {
											v97 = v72
										} else {
							...
							if v41 != int32(121) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v45
								v50 = int32(0)
								v51 = F_in_grouping_b_U(m, l0, int32(_a_F_r_mark_ymUs__1), int32(97), int32(305), v50)
								mBase = m.M
...
func F_r_mark_ysA(m *base.Module, l0 int32) int32 {
	...
	if v6 <= v7 {
		...
		if v11&int32(224) != int32(96) {
			...
			if int32(1)<<(uint(v11)%32)&int32(_a_F_r_mark_ysA_0) == int32(0) {
				v106 = v2
				return v106
			} else {
				v24 = F_find_among_b(m, l0, int32(_a_F_r_mark_ysA_1), int32(8))
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v64
								...
								if v71 == int32(121) {
									...
									if v77 < v75 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v77
										v85 = F_in_grouping_b_U(m, l0, int32(_a_F_r_mark_ysA_2), int32(97), int32(305), int32(0))
										mBase = m.M
										if v85 != 0 {
											v100 = v75
										} else {
							...
							if v44 != int32(121) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v48
								v53 = int32(0)
								v54 = F_in_grouping_b_U(m, l0, int32(_a_F_r_mark_ysA_2), int32(97), int32(305), v53)
								mBase = m.M
