	...
	if v4 == v2 {
		...
		if v9 <= v10 {
			...
			if v14 != int32(109) {
				...
				v19 = F_find_among_b(m, l0, int32(4416528), int32(4))
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return int32(0)
	...
	if v4 == v2 {
		...
		if v8-int32(3) <= v7 {
			...
			if v16 != int32(159) {
				...
				v21 = F_find_among_b(m, l0, int32(4415472), int32(4))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v61
								...
								if v68 == int32(121) {
									...
									if v74 < v72 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v74
										v82 = F_in_grouping_b_U(m, l0, int32(2259056), int32(97), int32(305), int32(0))
										mBase = m.M
										if v82 != 0 {
											v97 = v72
										} else {
							...
							if v41 != int32(121) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v45
								v50 = int32(0)
								v51 = F_in_grouping_b_U(m, l0, int32(2259056), int32(97), int32(305), v50)
								mBase = m.M
	...
	if v6 <= v7 {
		...
		if v11&int32(224) != int32(96) {
			...
			if int32(1)<<(uint(v11)%32)&int32(26658) == int32(0) {
				...
				v24 = F_find_among_b(m, l0, int32(4416192), int32(8))
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v64
								...
								if v71 == int32(121) {
									...
									if v77 < v75 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v77
										v85 = F_in_grouping_b_U(m, l0, int32(2259056), int32(97), int32(305), int32(0))
										mBase = m.M
										if v85 != 0 {
											v100 = v75
										} else {
							...
							if v44 != int32(121) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v48
								v53 = int32(0)
								v54 = F_in_grouping_b_U(m, l0, int32(2259056), int32(97), int32(305), v53)
								mBase = m.M
