...
L71:
	;
	F_errfinish(m, int32(491781), int32(114), int32(407571))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L1
...
L74:
	;
	F_errmsg(m, int32(394523), int32(0))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L1
...
L75:
	;
	F_errfinish(m, int32(491781), int32(128), int32(407571))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L1
...
L77:
	;
	F_errmsg_internal(m, int32(300285), int32(0))
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L1
...
L78:
	;
	F_errfinish(m, int32(491781), int32(136), int32(407571))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L1
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(485325), int32(112), int32(404793))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(485325), int32(123), int32(427425))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
...
func F_binary_upgrade_set_next_multirange_array_pg_type_oid(m *base.Module, l0 int32) int32 {
	...
	if v3 == int32(0) {
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(485325), int32(90), int32(428355))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		v25 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
		*(*int32)(unsafe.Add(mBase, _consts[1310])) = v25
		return int32(0)
	}
}
											...
											if v70 != 0 {
												...
												if v73 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v10))) = v72
													F_errmsg(m, int32(341202), v10)
													mBase = m.M
													v77 = m.ExcPending
													if v77 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(492332), int32(2137), int32(204558))
														mBase = m.M
														v82 = m.ExcPending
														if v82 != 0 {
															return int32(0)
															...
															if v109 != 0 {
																...
																if v112 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v111
																	F_errmsg(m, int32(341134), v10+int32(16))
																	mBase = m.M
																	v118 = m.ExcPending
																	if v118 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(492332), int32(2144), int32(204558))
																		mBase = m.M
																		v123 = m.ExcPending
																		if v123 != 0 {
																			return int32(0)
