...
L1:
	;
	return v130 & int32(_a_F_BinarySearchRange_0)
L2:
	;
...
L20:
	...
	v130 = v60 - v62*v61 + v26&int32(_a_F_BinarySearchRange_1) + v62<<(uint(int32(8))%32) + v59
	goto L1
L21:
	;
...
L26:
	;
	v130 = v98 + v26&int32(_a_F_BinarySearchRange_1) + v95<<(uint(int32(8))%32) + v110
	goto L1
L27:
	;
	v114 = v15
...
L8:
	;
	if v63 == int32(0) {
		v154 = int32(_a_F_binary_decode_1)
		goto L6
	} else {
		goto L21
	}
...
L22:
	;
	if v108 == int32(0) {
		v154 = int32(_a_F_binary_decode_3)
		goto L6
	} else {
		goto L35
	}
...
L35:
	;
	v114 = int32(_a_F_binary_decode_4)
	v115 = v21
	goto L37
L36:
	;
...
L49:
	;
	v154 = int32(_a_F_binary_decode_5)
	goto L6
L50:
	;
	v162 = v156
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v21
	F_errmsg(m, int32(_a_F_binary_decode_6), v11)
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L1
...
func F_binary_upgrade_set_next_heap_relfilenode(m *base.Module, l0 int32) int32 {
	...
	var v25 int32
	_ = v25
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_heap_relfilenode[0])))
	if v3 == int32(0) {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				F_errmsg(m, int32(_a_F_binary_upgrade_set_next_heap_relfilenode_0), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_binary_upgrade_set_next_heap_relfilenode_1), int32(112), int32(_a_F_binary_upgrade_set_next_heap_relfilenode_2))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_heap_relfilenode[1])) = v25
		return int32(0)
	}
}
func F_binary_upgrade_set_next_index_pg_class_oid(m *base.Module, l0 int32) int32 {
	...
	var v25 int32
	_ = v25
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_index_pg_class_oid[0])))
	if v3 == int32(0) {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				F_errmsg(m, int32(_a_F_binary_upgrade_set_next_index_pg_class_oid_0), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_binary_upgrade_set_next_index_pg_class_oid_1), int32(123), int32(_a_F_binary_upgrade_set_next_index_pg_class_oid_2))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		v25 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
		*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_index_pg_class_oid[1])) = v25
		return int32(0)
	}
}
func F_binary_upgrade_set_next_multirange_array_pg_type_oid(m *base.Module, l0 int32) int32 {
	...
	var v25 int32
	_ = v25
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_multirange_array_pg_type_oid[0])))
	if v3 == int32(0) {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				F_errmsg(m, int32(_a_F_binary_upgrade_set_next_multirange_array_pg_type_oid_0), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_binary_upgrade_set_next_multirange_array_pg_type_oid_1), int32(90), int32(_a_F_binary_upgrade_set_next_multirange_array_pg_type_oid_2))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		v25 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
		*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_multirange_array_pg_type_oid[1])) = v25
		return int32(0)
	}
}
											...
											if v70 != 0 {
												...
												if v73 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v10))) = v72
													F_errmsg(m, int32(_a_F_executeBinaryArithmExpr_0), v10)
													mBase = m.M
													v77 = m.ExcPending
													if v77 != 0 {
														return int32(0)
															...
															if v109 != 0 {
																...
																if v112 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v111
																	F_errmsg(m, int32(_a_F_executeBinaryArithmExpr_3), v10+int32(16))
																	mBase = m.M
																	v118 = m.ExcPending
																	if v118 != 0 {
																		return int32(0)
