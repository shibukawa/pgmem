...
L78:
	;
	F_errfinish(m, int32(477907), int32(4734), int32(23292))
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L1
...
L82:
	;
	F_errfinish(m, int32(477907), int32(4739), int32(23292))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L1
...
L70:
	;
	F_errfinish(m, int32(477907), int32(1614), int32(91894))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L12
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(217295))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
func F_jsonb_to_recordset(m *base.Module, l0 int32) int32 {
	...
	_ = v8
	v3 = int32(0)
	F_populate_recordset_worker(m, l0, int32(100511), v3, v3)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
