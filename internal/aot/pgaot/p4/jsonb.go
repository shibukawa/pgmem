...
L78:
	;
	F_errfinish(m, int32(494943), int32(4734), int32(24592))
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L1
...
L82:
	;
	F_errfinish(m, int32(494943), int32(4739), int32(24592))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L1
...
L70:
	;
	F_errfinish(m, int32(494943), int32(1614), int32(96174))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L12
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(225223))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
