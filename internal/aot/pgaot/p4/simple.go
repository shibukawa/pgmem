...
L15:
	...
	v80 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[0])) = uint8(v80)
	*(*uint8)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[1])) = uint8(v80)
	v86 = v78 << (uint(int32(6)) % 32)
	v89 = *(*int64)(unsafe.Add(mBase, uint32(v86)+uint32(_c_F_SimpleLruReadPage[2])))
	*(*int64)(unsafe.Add(mBase, uint32(v86)+uint32(_c_F_SimpleLruReadPage[2]))) = v89 + int64(1)
	goto L16
L16:
	;
	v377 = v39
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v145
	v160 = F_pg_snprintf(m, v17+int32(48), int32(1024), int32(_a_F_SimpleLruReadPage_0), v17+int32(16))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L1
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v145
	v170 = F_pg_snprintf(m, v17+int32(48), int32(1024), int32(_a_F_SimpleLruReadPage_1), v17+int32(32))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L1
...
L30:
	;
	v180 = *(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[3]))
	if v180 == int32(44) {
		goto L34
	} else {
		goto L35
...
L32:
	;
	v217 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[3])) = v217
	v219 = int32(_a_F_SimpleLruReadPage_2)
	v220 = *(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[4]))
...
L34:
	;
	v184 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[5])))
	if v184 != 0 {
		goto L33
	} else {
		goto L37
...
L36:
	;
	v185 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[6])) = v180
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[7])) = v185
	v267 = v185
	goto L28
L37:
	;
...
L41:
	...
	v214 = F__emscripten_memset_bulkmem(m, v210, base.I32_extend8_s(int32(0)), int32(_a_F_SimpleLruReadPage_3))
	mBase = m.M
	goto L44
L42:
	;
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[7])) = int32(2)
	v249 = *(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[6])) = v249
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[7])) = int32(5)
	v264 = *(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[6])) = v264
	v267 = int32(0)
	goto L28
L53:
	;
...
L74:
	...
	v359 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[0])) = uint8(v359)
	*(*uint8)(unsafe.Add(mBase, _c_F_SimpleLruReadPage[1])) = uint8(v359)
	v365 = v357 << (uint(int32(6)) % 32)
	v368 = *(*int64)(unsafe.Add(mBase, uint32(v365)+uint32(_c_F_SimpleLruReadPage[8])))
	*(*int64)(unsafe.Add(mBase, uint32(v365)+uint32(_c_F_SimpleLruReadPage[8]))) = v368 + int64(1)
	v377 = v107
	goto L3
}
