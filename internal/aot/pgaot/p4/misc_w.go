...
func F_win866_to_win1251(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(20), int32(23), int32(2212128), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_wrapper_handler(m *base.Module, l0 int32) {
	...
	v6 = *(*int32)(unsafe.Add(mBase, _consts[704]))
	if v6 != int32(42) {
		v9 = int32(0)
		v11 = m.G0
		v13 = v11 - int32(144)
		...
		case 0, 2:
			v23 = v9
		default:
			*(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1457]))) = v9
			v23 = int32(4730)
		}
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13)+136)) = v32
		...
		if base.Ui32(int32(65)) <= base.Ui32(l0) {
			*(*int32)(unsafe.Add(mBase, _consts[140])) = int32(28)
			...
			if v35 != 0 {
				v41 = int32(140)
				v46 = F___memcpy(m, l0*v41+int32(4651952), v35, v41)
				mBase = m.M
			} else {
			}
		}
		...
		v56 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1457])))
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+84)) = int32(237201)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+80)) = l6
	v35 = F_pg_snprintf(m, v11+int32(1136), int32(1024), int32(176209), v11+int32(80))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L6
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+68)) = int32(234289)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+64)) = l6
	v46 = F_pg_snprintf(m, v11+int32(112), int32(1024), int32(176209), v11-int32(-64))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L6
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v11 + int32(112)
	F_errmsg(m, int32(297453), v11+int32(48))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L6
...
L19:
	;
	F_errfinish(m, int32(492173), int32(948), int32(384131))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L6
...
L46:
	;
	F_errmsg_internal(m, int32(332202), int32(0))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L6
...
L47:
	;
	F_errfinish(m, int32(492173), int32(910), int32(384131))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L6
...
L51:
	;
	F_errfinish(m, int32(492173), int32(936), int32(384131))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L6
...
L55:
	;
	F_errfinish(m, int32(492173), int32(957), int32(384131))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L6
