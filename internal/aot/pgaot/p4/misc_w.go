...
func F_win866_to_win1251(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(20), int32(23), int32(2249584), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13)+136)) = v32
		...
		if base.Ui32(int32(65)) <= base.Ui32(l0) {
			*(*int32)(unsafe.Add(mBase, _consts[140])) = int32(28)
			...
			if v35 != 0 {
				v41 = int32(140)
				v46 = F___memcpy(m, l0*v41+int32(4701840), v35, v41)
				mBase = m.M
			} else {
			}
		}
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+84)) = int32(243475)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+80)) = l6
	v35 = F_pg_snprintf(m, v11+int32(1136), int32(1024), int32(181138), v11+int32(80))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L6
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+68)) = int32(240470)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+64)) = l6
	v46 = F_pg_snprintf(m, v11+int32(112), int32(1024), int32(181138), v11-int32(-64))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L6
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v11 + int32(112)
	F_errmsg(m, int32(305398), v11+int32(48))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L6
...
L19:
	;
	F_errfinish(m, int32(506848), int32(948), int32(395148))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L6
...
L46:
	;
	F_errmsg_internal(m, int32(341628), int32(0))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L6
...
L47:
	;
	F_errfinish(m, int32(506848), int32(910), int32(395148))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L6
...
L51:
	;
	F_errfinish(m, int32(506848), int32(936), int32(395148))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L6
...
L55:
	;
	F_errfinish(m, int32(506848), int32(957), int32(395148))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L6
