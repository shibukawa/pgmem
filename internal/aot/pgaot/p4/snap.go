...
L3:
	...
	v24 = v22 - int32(1120)
	m.G0 = v24
	*(*int32)(unsafe.Add(mBase, uint32(v24)+80)) = int32(121712)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v24)+84)) = uint32(v30)
	v37 = F_pg_sprintf(m, v24+int32(96), int32(243148), v24+int32(80))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L5
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+64)) = v24 + int32(96)
	F_errmsg(m, int32(304813), v24-int32(-64))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L5
...
L19:
	;
	F_errfinish(m, int32(511831), int32(1763), int32(88882))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L5
...
L21:
	;
	F_fsync_fname(m, int32(121712), int32(1))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L5
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+48)) = v24 + int32(96)
	F_errmsg(m, int32(49565), v24+int32(48))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L5
...
L42:
	;
	F_errfinish(m, int32(511831), int32(1784), int32(88882))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L5
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+32)) = v24 + int32(96)
	F_errmsg(m, int32(49632), v24+int32(32))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L5
...
L46:
	;
	F_errfinish(m, int32(511831), int32(1790), int32(88882))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L5
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+16)) = v24 + int32(96)
	F_errmsg(m, int32(305556), v24+int32(16))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L5
...
L50:
	;
	F_errfinish(m, int32(511831), int32(1822), int32(88882))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L5
...
L54:
	;
	F_errfinish(m, int32(511831), int32(1831), int32(88882))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L5
...
L86:
	;
	F_errdetail(m, int32(593157), int32(0))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L5
...
L87:
	;
	F_errfinish(m, int32(511831), int32(1918), int32(372704))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L5
...
L95:
	;
	F_errmsg_internal(m, int32(88607), int32(0))
	mBase = m.M
	v396 = m.ExcPending
	if v396 != 0 {
		goto L5
...
L96:
	;
	F_errfinish(m, int32(511831), int32(344), int32(89169))
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L5
					...
					if v57 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = l3
						...
						if v61 != 0 {
							...
							F_errfinish(m, int32(511831), int32(1951), int32(123272))
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return
				...
				if v30 != 0 {
					...
					if v33 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l3
						F_errmsg(m, int32(38192), v9+int32(16))
						mBase = m.M
						v41 = m.ExcPending
						if v41 != 0 {
							return
						} else {
							F_errfinish(m, int32(511831), int32(1957), int32(123272))
							mBase = m.M
							v46 = m.ExcPending
							if v46 != 0 {
								return
