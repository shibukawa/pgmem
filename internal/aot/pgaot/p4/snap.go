...
L3:
	...
	v24 = v22 - int32(1120)
	m.G0 = v24
	*(*int32)(unsafe.Add(mBase, uint32(v24)+80)) = int32(_a_F_SnapBuildRestore_0)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v24)+84)) = uint32(v30)
	v37 = F_pg_sprintf(m, v24+int32(96), int32(_a_F_SnapBuildRestore_1), v24+int32(80))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L5
...
L13:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildRestore[0]))
	if v49 == int32(44) {
		goto L11
	} else {
		goto L16
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+64)) = v24 + int32(96)
	F_errmsg(m, int32(_a_F_SnapBuildRestore_8), v24-int32(-64))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L5
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+48)) = v24 + int32(96)
	F_errmsg(m, int32(_a_F_SnapBuildRestore_10), v24+int32(48))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L5
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+32)) = v24 + int32(96)
	F_errmsg(m, int32(_a_F_SnapBuildRestore_11), v24+int32(32))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L5
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+16)) = v24 + int32(96)
	F_errmsg(m, int32(_a_F_SnapBuildRestore_12), v24+int32(16))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L5
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24))) = v24 + int32(96)
	F_errmsg(m, int32(_a_F_SnapBuildRestore_13), v24)
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L5
...
L85:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v14))) = uint32(v354)
	F_errmsg(m, int32(_a_F_SnapBuildRestore_2), v14)
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L5
