								...
								if v41 != 0 {
									...
									if v45 != 0 {
										...
										if v49 != 0 {
											...
											F_errfinish(m, int32(522074), int32(232), int32(274855))
											mBase = m.M
											v54 = m.ExcPending
											if v54 != 0 {
												return int32(0)
...
L37:
	;
	F_errfinish(m, int32(523107), int32(1536), int32(183494))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L12
