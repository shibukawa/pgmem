								...
								if v41 != 0 {
									...
									if v45 != 0 {
										...
										if v49 != 0 {
											...
											F_errfinish(m, int32(499995), int32(232), int32(263222))
											mBase = m.M
											v54 = m.ExcPending
											if v54 != 0 {
												return int32(0)
...
L37:
	;
	F_errfinish(m, int32(501002), int32(1536), int32(173829))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L12
