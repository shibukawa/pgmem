								...
								if v41 != 0 {
									...
									if v45 != 0 {
										...
										if v49 != 0 {
											...
											F_errfinish(m, int32(487305), int32(232), int32(256950))
											mBase = m.M
											v54 = m.ExcPending
											if v54 != 0 {
												return int32(0)
...
L37:
	;
	F_errfinish(m, int32(488267), int32(1536), int32(169649))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L12
