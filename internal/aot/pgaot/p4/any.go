...
func F_any_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_any_in_0)
			F_errmsg(m, int32(_a_F_any_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_any_in_2), int32(365), int32(_a_F_any_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
func F_has_any_column_privilege_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v10)+15)) = uint8(v18)
		v21 = *(*int32)(unsafe.Add(mBase, _c_F_has_any_column_privilege_id[0]))
		v23 = F_convert_any_priv_string(m, v14, int32(_a_F_has_any_column_privilege_id_0))
		mBase = m.M
		v24 = m.ExcPending
		if v24 != 0 {
			return int32(0)
...
func F_has_any_column_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v18 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v10)+15)) = uint8(v19)
		v22 = F_convert_any_priv_string(m, v15, int32(_a_F_has_any_column_privilege_id_id_0))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
	...
	if v18 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v10)+15)) = uint8(v19)
		...
		if v22 != 0 {
			...
			v24 = F_convert_any_priv_string(m, v15, int32(_a_F_has_any_column_privilege_name_id_0))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
