						...
						if v28 != 0 {
							...
							if v31 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v30
								F_appendStringInfo(m, v29, int32(186506), v8+int32(16))
								mBase = m.M
								v37 = m.ExcPending
								if v37 != 0 {
									return
...
L150:
	;
	F_ExplainCloseGroup(m, int32(156099), int32(1), l2)
	mBase = m.M
	v694 = m.ExcPending
	if v694 != 0 {
		goto L9
...
L159:
	...
	F_ExplainPropertyText(m, int32(156099), v812, l2)
	mBase = m.M
	v814 = m.ExcPending
	if v814 != 0 {
		goto L9
...
L267:
	;
	F_ExplainCloseGroup(m, int32(135024), int32(0), l2)
	mBase = m.M
	v1280 = m.ExcPending
	if v1280 != 0 {
		goto L9
