...
L21:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(342090)
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v12
	F_errmsg(m, int32(487981), v10+int32(16))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(517306), int32(393), int32(37656))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
L39:
	;
	F_errfinish(m, int32(523450), int32(632), int32(512873))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L1
