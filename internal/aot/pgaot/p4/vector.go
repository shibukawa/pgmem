...
L21:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(342662)
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v12
	F_errmsg(m, int32(488627), v10+int32(16))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(517975), int32(393), int32(37777))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
L39:
	;
	F_errfinish(m, int32(524119), int32(632), int32(513519))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L1
