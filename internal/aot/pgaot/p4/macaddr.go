...
func F_macaddr_in(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+236)) = v7 + int32(272)
	v35 = F_sscanf(m, v10, int32(179396), v7+int32(224))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L3
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+192)) = v7 + int32(284)
	v65 = F_sscanf(m, v10, int32(179417), v7+int32(192))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L3
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+160)) = v7 + int32(284)
	v93 = F_sscanf(m, v10, int32(179302), v7+int32(160))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L3
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+128)) = v7 + int32(284)
	v121 = F_sscanf(m, v10, int32(179325), v7+int32(128))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L3
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+96)) = v7 + int32(284)
	v149 = F_sscanf(m, v10, int32(179348), v7+int32(96))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L3
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+64)) = v7 + int32(284)
	v177 = F_sscanf(m, v10, int32(179372), v7-int32(-64))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L3
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v7 + int32(284)
	v205 = F_sscanf(m, v10, int32(179280), v7+int32(32))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L3
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(233996)
	F_errmsg(m, int32(739236), v7+int32(16))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L3
...
L21:
	;
	F_errsave_finish(m, v9, int32(512742), int32(95), int32(285005))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L3
...
L34:
	;
	F_errsave_finish(m, v9, int32(512742), int32(102), int32(285005))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L3
