...
func F_AlterObjectTypeCommandTag(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v4) <= base.Ui32(int32(50)) {
		v11 = *(*int32)(unsafe.Add(mBase, uint32(v4<<(uint(int32(2))%32))+uint32(_c_F_AlterObjectTypeCommandTag[0])))
		v12 = v11
	} else {
		v12 = int32(0)
	}
...
L35:
	;
	v127 = *(*int32)(unsafe.Add(mBase, _c_F_AlterRelationNamespaceInternal[0]))
	if v127 == int32(0) {
		goto L33
	} else {
		goto L36
...
L42:
	;
	v163 = *(*int32)(unsafe.Add(mBase, _c_F_AlterTypeNamespaceInternal[0]))
	if v163 != 0 {
		goto L62
	} else {
		goto L63
