...
func F_AlterObjectTypeCommandTag(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v4) <= base.Ui32(int32(50)) {
		v11 = *(*int32)(unsafe.Add(mBase, uint32(v4<<(uint(int32(2))%32))+uint32(_consts[1215])))
		v12 = v11
	} else {
		v12 = int32(0)
	}
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v79
	F_errmsg_internal(m, int32(683729), v12+int32(-48))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L2
...
L30:
	;
	F_errfinish(m, int32(489510), int32(19110), int32(309937))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L2
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = l1
	F_errmsg_internal(m, int32(46032), v14)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L2
...
L40:
	;
	F_errfinish(m, int32(489510), int32(19067), int32(309937))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L2
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v79
	F_errmsg(m, int32(703157), v12+int32(-32))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L2
...
L45:
	;
	F_errfinish(m, int32(489510), int32(19093), int32(309937))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L2
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = l0
	F_errmsg_internal(m, int32(50097), v18)
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L18
...
L72:
	;
	F_errfinish(m, int32(489499), int32(4183), int32(309968))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L18
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+64)) = v95
	F_errmsg(m, int32(703366), v18-int32(-64))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L18
...
L77:
	;
	F_errfinish(m, int32(489499), int32(4203), int32(309968))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L18
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+48)) = v239
	F_errmsg(m, int32(363608), v18+int32(48))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L18
...
L82:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v18)+32)) = int32(535498)
	F_errhint(m, int32(631176), v18+int32(32))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L18
...
L83:
	;
	F_errfinish(m, int32(489499), int32(4225), int32(309968))
	mBase = m.M
	v258 = m.ExcPending
	if v258 != 0 {
		goto L18
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v263
	F_errmsg_internal(m, int32(693325), v18+int32(16))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L18
...
L87:
	;
	F_errfinish(m, int32(489499), int32(4281), int32(309968))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L18
