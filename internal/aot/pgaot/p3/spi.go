...
L29:
	;
	F_errmsg(m, int32(152874), int32(0))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L10
...
L30:
	;
	F_errfinish(m, int32(467121), int32(2496), int32(265929))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L10
...
L67:
	;
	F_errfinish(m, int32(467121), int32(2570), int32(265929))
	mBase = m.M
	v208 = m.ExcPending
	if v208 != 0 {
		goto L10
...
L202:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = v553
	F_errmsg(m, int32(238195), v27+int32(-48))
	mBase = m.M
	v560 = m.ExcPending
	if v560 != 0 {
		goto L10
...
L203:
	;
	F_errfinish(m, int32(467121), int32(2658), int32(265929))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L10
...
L205:
	;
	F_errmsg_internal(m, int32(427047), int32(0))
	mBase = m.M
	v573 = m.ExcPending
	if v573 != 0 {
		goto L10
...
L206:
	;
	F_errfinish(m, int32(467121), int32(2940), int32(14240))
	mBase = m.M
	v578 = m.ExcPending
	if v578 != 0 {
		goto L10
	...
	if v7 != 0 {
		...
		if v8 == int32(0) {
			...
			if v66 != 0 {
				...
				F_errmsg_internal(m, int32(217584), int32(0))
				mBase = m.M
				v70 = m.ExcPending
				if v70 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(467121), int32(2181), int32(217601))
					mBase = m.M
					v75 = m.ExcPending
					if v75 != 0 {
						return int32(0)
		...
		if v53 != 0 {
			...
			F_errmsg_internal(m, int32(502278), int32(0))
			mBase = m.M
			v57 = m.ExcPending
			if v57 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(467121), int32(2177), int32(217601))
				mBase = m.M
				v62 = m.ExcPending
				if v62 != 0 {
					return int32(0)
