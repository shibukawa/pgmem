	...
	if l0 == v8 {
		...
		if l6 < int32(0) {
			...
			if v26 != int32(569278163) {
				...
				if l1 != 0 {
					v34 = *(*int32)(unsafe.Add(mBase, _consts[544]))
					if v34 == int32(0) {
						v145 = int32(-4)
						m.G0 = v19 + int32(32)
						return v145
						...
						v42 = *(*int32)(unsafe.Add(mBase, _consts[544]))
							...
							if v60 != 0 {
								...
								*(*int64)(unsafe.Add(mBase, uint32(v19)+16)) = base.I64_extend_i32_u(l6)
								...
								if v127 != 0 {
									...
									v130 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
func F_SPI_getbinval(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v24 int32
	_ = v24
	*(*int32)(unsafe.Add(mBase, _consts[508])) = int32(0)
	if l2 < int32(-6) {
		*(*int32)(unsafe.Add(mBase, _consts[508])) = int32(-9)
		v17 = int32(1)
...
func F_SPI_returntuple(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v6 == int32(0) {
		*(*int32)(unsafe.Add(mBase, _consts[508])) = int32(-6)
		...
		v15 = *(*int32)(unsafe.Add(mBase, _consts[544]))
		if v15 == int32(0) {
...
L2:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L29:
	;
	F_errmsg(m, int32(174862), int32(0))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L10
...
L30:
	;
	F_errfinish(m, int32(523553), int32(2496), int32(297254))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L10
...
L52:
	...
	v155 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L54:
	...
	v162 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L58:
	...
	v211 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L61:
	;
	v191 = *(*int32)(unsafe.Add(mBase, uint32(v184<<(uint(int32(3))%32))+uint32(_consts[545])))
	goto L64
L62:
	;
	v192 = int32(553861)
...
L67:
	;
	F_errfinish(m, int32(523553), int32(2570), int32(297254))
	mBase = m.M
	v208 = m.ExcPending
	if v208 != 0 {
		goto L10
...
L94:
	...
	v294 = *(*int32)(unsafe.Add(mBase, _consts[544]))
	v295 = int32(0)
...
L119:
	;
	v482 = *(*int32)(unsafe.Add(mBase, _consts[544]))
	if v331 != 0 {
		goto L184
	} else {
		goto L185
...
L126:
	...
	v356 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L156:
	;
	v405 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L168:
	...
	v445 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L169:
	;
	v452 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L187:
	;
	v487 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L188:
	;
	v493 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L202:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = v553
	F_errmsg(m, int32(267081), v27+int32(-48))
	mBase = m.M
	v560 = m.ExcPending
	if v560 != 0 {
		goto L10
...
L203:
	;
	F_errfinish(m, int32(523553), int32(2658), int32(297254))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L10
...
L205:
	;
	F_errmsg_internal(m, int32(476497), int32(0))
	mBase = m.M
	v573 = m.ExcPending
	if v573 != 0 {
		goto L10
...
L206:
	;
	F_errfinish(m, int32(523553), int32(2940), int32(15555))
	mBase = m.M
	v578 = m.ExcPending
	if v578 != 0 {
		goto L10
...
L212:
	...
	*(*int64)(unsafe.Add(mBase, _consts[506])) = v660
	*(*int32)(unsafe.Add(mBase, _consts[507])) = v650
	v671 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L13:
	...
	v59 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
L15:
	...
	v66 = *(*int32)(unsafe.Add(mBase, _consts[544]))
...
func F_spi_printtup(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v75 int32
	_ = v75
	v7 = *(*int32)(unsafe.Add(mBase, _consts[544]))
	if v7 != 0 {
		...
		if v8 == int32(0) {
			...
			if v66 != 0 {
				...
				F_errmsg_internal(m, int32(243832), int32(0))
				mBase = m.M
				v70 = m.ExcPending
				if v70 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(523553), int32(2181), int32(243849))
					mBase = m.M
					v75 = m.ExcPending
					if v75 != 0 {
						return int32(0)
		...
		if v53 != 0 {
			...
			F_errmsg_internal(m, int32(561357), int32(0))
			mBase = m.M
			v57 = m.ExcPending
			if v57 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(523553), int32(2177), int32(243849))
				mBase = m.M
				v62 = m.ExcPending
				if v62 != 0 {
					return int32(0)
