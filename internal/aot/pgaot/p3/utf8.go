...
func F_utf8_to_big5(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_UtfToLocal(m, v6, v10, v5, int32(4329684), v18, v18, v18, int32(36), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
func F_utf8_to_euc_jis_2004(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v17 = int32(0)
		v27 = F_UtfToLocal(m, v6, v10, v5, int32(4330100), int32(2301488), int32(25), v17, int32(5), base.B2i32(v7 != v17))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return int32(0)
...
func F_utf8_to_euc_kr(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_UtfToLocal(m, v6, v10, v5, int32(4330580), v18, v18, v18, int32(3), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
				...
				if v57 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v16
					...
					if v63 != 0 {
						...
						F_errfinish(m, int32(477024), int32(169), int32(523674))
						mBase = m.M
						v70 = m.ExcPending
						if v70 != 0 {
							return int32(0)
...
func F_utf8_to_koi8r(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_UtfToLocal(m, v6, v10, v5, int32(4329796), v18, v18, v18, int32(22), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
