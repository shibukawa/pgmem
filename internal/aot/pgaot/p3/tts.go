...
func F_tts_buffer_heap_copyslot(m *base.Module, l0 int32, l1 int32) {
	...
	if v5 != v6 {
		...
		if v15 != 0 {
			...
			v18 = v16 & int32(_a_F_tts_buffer_heap_copyslot_0)
			...
			*(*int32)(unsafe.Add(mBase, _c_F_tts_buffer_heap_copyslot[0])) = v23
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_tts_buffer_heap_copyslot[0])) = v21
				return
			}
		}
	} else {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l0)+44)) = v14
		...
		if v18 == v14 {
			...
			if v25 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_tts_buffer_heap_materialize[0])) = v10
				return
			}
		} else {
		...
		if v6&int32(4) != 0 {
			...
			*(*uint16)(unsafe.Add(mBase, uint32(l0)+6)) = uint16(v14)
			...
			if v24 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_tts_heap_get_heap_tuple[0])) = v10
				v32 = v21
				return v32
			}
		}
