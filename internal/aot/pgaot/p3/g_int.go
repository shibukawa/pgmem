							...
							if v252 != 0 {
								...
								if v255 != 0 {
									...
									if v261 != 0 {
										...
										F_errfinish(m, int32(492473), int32(304), int32(126386))
										mBase = m.M
										v268 = m.ExcPending
										if v268 != 0 {
											return int32(0)
											...
											if base.Ui32(int32(134217725)) <= base.Ui32(v127) {
												...
												if v272 != 0 {
													...
													if v275 != 0 {
														...
														F_errmsg(m, int32(463551), int32(0))
														mBase = m.M
														v281 = m.ExcPending
														if v281 != 0 {
															return int32(0)
														} else {
															F_errfinish(m, int32(492473), int32(338), int32(126386))
															mBase = m.M
															v288 = m.ExcPending
															if v288 != 0 {
																return int32(0)
...
L41:
	;
	F_errfinish(m, int32(492473), int32(136), int32(271931))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L11
