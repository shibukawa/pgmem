...
L11:
	;
	v23 = F_cstring_to_text(m, int32(571596))
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L2
	...
	if v14 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8)+144)) = v15
		...
		if v31 != 0 {
			...
			F_TupleDescInitEntry(m, v30, int32(1), int32(396136), int32(25), int32(-1), int32(0))
			mBase = m.M
			v38 = m.ExcPending
			if v38 != 0 {
				return int32(0)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+80)) = v5
	...
	if v33 != 0 {
		...
		if v36 != 0 {
			...
			F_TupleDescInitEntry(m, v35, int32(1), int32(456350), int32(26), int32(-1), int32(0))
			mBase = m.M
			v43 = m.ExcPending
			if v43 != 0 {
				return int32(0)
						...
						if v64 != 0 {
							...
							if v71 != 0 {
								...
								if v78 != 0 {
									...
									F_TupleDescInitEntry(m, v35, int32(7), int32(345412), int32(20), int32(-1), int32(0))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
										...
										if v92 != 0 {
											...
											F_TupleDescInitEntry(m, v35, int32(9), int32(345391), int32(20), int32(-1), int32(0))
											mBase = m.M
											v99 = m.ExcPending
											if v99 != 0 {
												return int32(0)
...
L9:
	;
	F_s_lock(m, v75, int32(518602), int32(3950), int32(143852))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L1
...
L368:
	;
	F_errfinish(m, int32(515915), int32(1426), int32(216857))
	mBase = m.M
	v1022 = m.ExcPending
	if v1022 != 0 {
		goto L1
