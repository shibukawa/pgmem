...
func F_pg_stat_get_backend_subxact(m *base.Module, l0 int32) int32 {
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v6)+6)) = uint16(v2)
	...
	if v17 != 0 {
		...
		F_TupleDescInitEntry(m, v14, int32(1), int32(87440), int32(23), int32(-1), int32(0))
		mBase = m.M
		v24 = m.ExcPending
		if v24 != 0 {
			return int32(0)
		} else {
			F_TupleDescInitEntry(m, v14, int32(2), int32(31231), int32(16), int32(-1), int32(0))
			mBase = m.M
			v31 = m.ExcPending
			if v31 != 0 {
				return int32(0)
...
L11:
	;
	v23 = F_cstring_to_text(m, int32(545896))
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L2
...
L21:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[616]))
	v41 = v32
	goto L23
L22:
	;
...
func F_pg_stat_get_recovery_prefetch(m *base.Module, l0 int32) int32 {
	...
	if v14 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v7))) = int64(0)
		v20 = *(*int32)(unsafe.Add(mBase, _consts[241]))
		...
		*(*int64)(unsafe.Add(mBase, uint32(v20))) = v21
		...
		if v24 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v23
			v27 = *(*int32)(unsafe.Add(mBase, _consts[241]))
			...
			*(*int64)(unsafe.Add(mBase, uint32(v27)+8)) = v28
			...
			if v31 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = v30
				v34 = *(*int32)(unsafe.Add(mBase, _consts[241]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v34)+16)) = v35
				...
				if v38 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+24)) = v37
					v41 = *(*int32)(unsafe.Add(mBase, _consts[241]))
					...
					*(*int64)(unsafe.Add(mBase, uint32(v41)+24)) = v42
					...
					if v45 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = v44
						v48 = *(*int32)(unsafe.Add(mBase, _consts[241]))
						...
						*(*int64)(unsafe.Add(mBase, uint32(v48)+32)) = v49
						...
						if v52 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v51
							v55 = *(*int32)(unsafe.Add(mBase, _consts[241]))
							...
							*(*int64)(unsafe.Add(mBase, uint32(v55)+40)) = v56
							...
							if v59 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+36)) = v58
								v62 = *(*int32)(unsafe.Add(mBase, _consts[241]))
								...
								*(*int64)(unsafe.Add(mBase, uint32(v62)+48)) = v63
								...
								if v66 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7)+40)) = v65
									v69 = *(*int32)(unsafe.Add(mBase, _consts[241]))
	...
	if v14 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8)+144)) = v15
		...
		if v31 != 0 {
			...
			F_TupleDescInitEntry(m, v30, int32(1), int32(378254), int32(25), int32(-1), int32(0))
			mBase = m.M
			v38 = m.ExcPending
			if v38 != 0 {
				return int32(0)
			} else {
				F_TupleDescInitEntry(m, v30, int32(2), int32(136796), int32(20), int32(-1), int32(0))
				mBase = m.M
				v45 = m.ExcPending
				if v45 != 0 {
					return int32(0)
				} else {
					F_TupleDescInitEntry(m, v30, int32(3), int32(87590), int32(20), int32(-1), int32(0))
					mBase = m.M
					v52 = m.ExcPending
					if v52 != 0 {
						return int32(0)
					} else {
						F_TupleDescInitEntry(m, v30, int32(4), int32(158703), int32(20), int32(-1), int32(0))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
						} else {
							F_TupleDescInitEntry(m, v30, int32(5), int32(136784), int32(20), int32(-1), int32(0))
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return int32(0)
							} else {
								F_TupleDescInitEntry(m, v30, int32(6), int32(87577), int32(20), int32(-1), int32(0))
								mBase = m.M
								v73 = m.ExcPending
								if v73 != 0 {
									return int32(0)
								} else {
									F_TupleDescInitEntry(m, v30, int32(7), int32(158690), int32(20), int32(-1), int32(0))
									mBase = m.M
									v80 = m.ExcPending
									if v80 != 0 {
										return int32(0)
									} else {
										F_TupleDescInitEntry(m, v30, int32(8), int32(136807), int32(20), int32(-1), int32(0))
										mBase = m.M
										v87 = m.ExcPending
										if v87 != 0 {
											return int32(0)
										} else {
											F_TupleDescInitEntry(m, v30, int32(9), int32(158725), int32(20), int32(-1), int32(0))
											mBase = m.M
											v94 = m.ExcPending
											if v94 != 0 {
												return int32(0)
											} else {
												F_TupleDescInitEntry(m, v30, int32(10), int32(105775), int32(1184), int32(-1), int32(0))
												mBase = m.M
												v101 = m.ExcPending
												if v101 != 0 {
													return int32(0)
															...
															if v138 != 0 {
																...
																if v141 != 0 {
																	...
																	if v140 == int32(0) {
																		...
																		v145 = *(*int32)(unsafe.Add(mBase, _consts[268]))
...
func F_pg_stat_get_snapshot_timestamp(m *base.Module, l0 int32) int32 {
	...
	m.G0 = v8
	v11 = v8 + int32(15)
	v13 = int32(*(*uint8)(unsafe.Add(mBase, _consts[908])))
	if v13 != 0 {
		v15 = int64(0)
		*(*int64)(unsafe.Add(mBase, _consts[909])) = v15
		*(*int64)(unsafe.Add(mBase, _consts[910])) = v15
		*(*int64)(unsafe.Add(mBase, _consts[911])) = v15
		v24 = int32(0)
		*(*uint8)(unsafe.Add(mBase, _consts[912])) = uint8(v24)
		*(*int32)(unsafe.Add(mBase, _consts[913])) = v24
		*(*int32)(unsafe.Add(mBase, _consts[914])) = v24
		v33 = *(*int32)(unsafe.Add(mBase, _consts[915]))
		if v33 != 0 {
			...
			if v37 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[915])) = int32(0)
				...
				if v42 != 0 {
					...
					v44 = int32(0)
					*(*uint8)(unsafe.Add(mBase, _consts[908])) = uint8(v44)
					v48 = *(*int32)(unsafe.Add(mBase, _consts[914]))
					if v48 == int32(2) {
						v51 = int32(1)
						*(*uint8)(unsafe.Add(mBase, uint32(v11))) = uint8(v51)
						v54 = *(*int64)(unsafe.Add(mBase, _consts[1029]))
						v58 = v54
					} else {
						v55 = int32(0)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+80)) = v5
	...
	if v33 != 0 {
		...
		if v36 != 0 {
			...
			F_TupleDescInitEntry(m, v35, int32(1), int32(435860), int32(26), int32(-1), int32(0))
			mBase = m.M
			v43 = m.ExcPending
			if v43 != 0 {
				return int32(0)
			} else {
				F_TupleDescInitEntry(m, v35, int32(2), int32(87475), int32(20), int32(-1), int32(0))
				mBase = m.M
				v50 = m.ExcPending
				if v50 != 0 {
					return int32(0)
				} else {
					F_TupleDescInitEntry(m, v35, int32(3), int32(87493), int32(20), int32(-1), int32(0))
					mBase = m.M
					v57 = m.ExcPending
					if v57 != 0 {
						return int32(0)
					} else {
						F_TupleDescInitEntry(m, v35, int32(4), int32(115513), int32(20), int32(-1), int32(0))
						mBase = m.M
						v64 = m.ExcPending
						if v64 != 0 {
							return int32(0)
						} else {
							F_TupleDescInitEntry(m, v35, int32(5), int32(135342), int32(20), int32(-1), int32(0))
							mBase = m.M
							v71 = m.ExcPending
							if v71 != 0 {
								return int32(0)
							} else {
								F_TupleDescInitEntry(m, v35, int32(6), int32(115610), int32(20), int32(-1), int32(0))
								mBase = m.M
								v78 = m.ExcPending
								if v78 != 0 {
									return int32(0)
								} else {
									F_TupleDescInitEntry(m, v35, int32(7), int32(329137), int32(20), int32(-1), int32(0))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
									} else {
										F_TupleDescInitEntry(m, v35, int32(8), int32(135314), int32(20), int32(-1), int32(0))
										mBase = m.M
										v92 = m.ExcPending
										if v92 != 0 {
											return int32(0)
										} else {
											F_TupleDescInitEntry(m, v35, int32(9), int32(329116), int32(20), int32(-1), int32(0))
											mBase = m.M
											v99 = m.ExcPending
											if v99 != 0 {
												return int32(0)
											} else {
												F_TupleDescInitEntry(m, v35, int32(10), int32(124859), int32(20), int32(-1), int32(0))
												mBase = m.M
												v106 = m.ExcPending
												if v106 != 0 {
													return int32(0)
												} else {
													F_TupleDescInitEntry(m, v35, int32(11), int32(105775), int32(1184), int32(-1), int32(0))
													mBase = m.M
													v113 = m.ExcPending
													if v113 != 0 {
														return int32(0)
...
L3:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _consts[308]))
	if int32(0) < v36 {
		goto L4
	} else {
		goto L5
...
L7:
	;
	v66 = *(*int32)(unsafe.Add(mBase, _consts[361]))
...
L9:
	;
	F_s_lock(m, v75, int32(495250), int32(3950), int32(135402))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L1
...
L13:
	;
	v306 = v50 + int32(1)
	v308 = *(*int32)(unsafe.Add(mBase, _consts[308]))
	if v306 < v308 {
		v50 = v306
		goto L7
	} else {
...
L30:
	;
	v178 = *(*int32)(unsafe.Add(mBase, uint32(v158<<(uint(int32(2))%32))+uint32(_consts[773])))
	v180 = v178
	goto L32
L31:
	;
...
L69:
	;
	v262 = *(*int32)(unsafe.Add(mBase, _consts[714]))
...
L196:
	;
	v562 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	if v562 == int32(0) {
		goto L197
	} else {
		goto L198
...
L217:
	;
	v612 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	v613 = v612
	goto L201
L218:
	;
...
L236:
	;
	v661 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	v662 = v661
	goto L220
L237:
	;
...
L255:
	;
	v710 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	v711 = v710
	goto L239
L256:
	;
...
L274:
	;
	v759 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	v760 = v759
	goto L258
L275:
	;
...
L293:
	;
	v808 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	v809 = v808
	goto L277
L294:
	;
...
L312:
	;
	v857 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	v858 = v857
	goto L296
L313:
	;
...
L331:
	;
	v906 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	v907 = v906
	goto L315
L332:
	;
...
L350:
	;
	v955 = *(*int32)(unsafe.Add(mBase, _consts[277]))
	v956 = v955
	goto L334
L351:
	;
...
L368:
	;
	F_errfinish(m, int32(493203), int32(1426), int32(206400))
	mBase = m.M
	v1022 = m.ExcPending
	if v1022 != 0 {
		goto L1
...
L370:
	;
	v1044 = v1023*int32(72) + int32(1651040)
	goto L372
L371:
	;
	v1037 = *(*int32)(unsafe.Add(mBase, _consts[277]))
