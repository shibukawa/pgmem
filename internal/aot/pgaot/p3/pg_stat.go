...
func F_pg_stat_get_backend_subxact(m *base.Module, l0 int32) int32 {
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v6)+6)) = uint16(v2)
	...
	if v17 != 0 {
		...
		F_TupleDescInitEntry(m, v14, int32(1), int32(93622), int32(23), int32(-1), int32(0))
		mBase = m.M
		v24 = m.ExcPending
		if v24 != 0 {
			return int32(0)
		} else {
			F_TupleDescInitEntry(m, v14, int32(2), int32(32503), int32(16), int32(-1), int32(0))
			mBase = m.M
			v31 = m.ExcPending
			if v31 != 0 {
				return int32(0)
...
L11:
	;
	v23 = F_cstring_to_text(m, int32(570857))
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L2
	...
	if v14 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8)+144)) = v15
		...
		if v31 != 0 {
			...
			F_TupleDescInitEntry(m, v30, int32(1), int32(395522), int32(25), int32(-1), int32(0))
			mBase = m.M
			v38 = m.ExcPending
			if v38 != 0 {
				return int32(0)
			} else {
				F_TupleDescInitEntry(m, v30, int32(2), int32(144931), int32(20), int32(-1), int32(0))
				mBase = m.M
				v45 = m.ExcPending
				if v45 != 0 {
					return int32(0)
				} else {
					F_TupleDescInitEntry(m, v30, int32(3), int32(93772), int32(20), int32(-1), int32(0))
					mBase = m.M
					v52 = m.ExcPending
					if v52 != 0 {
						return int32(0)
					} else {
						F_TupleDescInitEntry(m, v30, int32(4), int32(168081), int32(20), int32(-1), int32(0))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
						} else {
							F_TupleDescInitEntry(m, v30, int32(5), int32(144919), int32(20), int32(-1), int32(0))
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return int32(0)
							} else {
								F_TupleDescInitEntry(m, v30, int32(6), int32(93759), int32(20), int32(-1), int32(0))
								mBase = m.M
								v73 = m.ExcPending
								if v73 != 0 {
									return int32(0)
								} else {
									F_TupleDescInitEntry(m, v30, int32(7), int32(168068), int32(20), int32(-1), int32(0))
									mBase = m.M
									v80 = m.ExcPending
									if v80 != 0 {
										return int32(0)
									} else {
										F_TupleDescInitEntry(m, v30, int32(8), int32(144942), int32(20), int32(-1), int32(0))
										mBase = m.M
										v87 = m.ExcPending
										if v87 != 0 {
											return int32(0)
										} else {
											F_TupleDescInitEntry(m, v30, int32(9), int32(168103), int32(20), int32(-1), int32(0))
											mBase = m.M
											v94 = m.ExcPending
											if v94 != 0 {
												return int32(0)
											} else {
												F_TupleDescInitEntry(m, v30, int32(10), int32(112505), int32(1184), int32(-1), int32(0))
												mBase = m.M
												v101 = m.ExcPending
												if v101 != 0 {
													return int32(0)
...
func F_pg_stat_get_snapshot_timestamp(m *base.Module, l0 int32) int32 {
	...
	m.G0 = v8
	v11 = v8 + int32(15)
	v13 = int32(*(*uint8)(unsafe.Add(mBase, _consts[918])))
	if v13 != 0 {
		v15 = int64(0)
		*(*int64)(unsafe.Add(mBase, _consts[919])) = v15
		*(*int64)(unsafe.Add(mBase, _consts[920])) = v15
		*(*int64)(unsafe.Add(mBase, _consts[921])) = v15
		v24 = int32(0)
		*(*uint8)(unsafe.Add(mBase, _consts[922])) = uint8(v24)
		*(*int32)(unsafe.Add(mBase, _consts[923])) = v24
			...
			if v37 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[925])) = int32(0)
				...
				if v42 != 0 {
					...
					v44 = int32(0)
					*(*uint8)(unsafe.Add(mBase, _consts[918])) = uint8(v44)
					v48 = *(*int32)(unsafe.Add(mBase, _consts[924]))
					if v48 == int32(2) {
						v51 = int32(1)
						*(*uint8)(unsafe.Add(mBase, uint32(v11))) = uint8(v51)
						v54 = *(*int64)(unsafe.Add(mBase, _consts[1039]))
						v58 = v54
					} else {
						v55 = int32(0)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+80)) = v5
	...
	if v33 != 0 {
		...
		if v36 != 0 {
			...
			F_TupleDescInitEntry(m, v35, int32(1), int32(455652), int32(26), int32(-1), int32(0))
			mBase = m.M
			v43 = m.ExcPending
			if v43 != 0 {
				return int32(0)
			} else {
				F_TupleDescInitEntry(m, v35, int32(2), int32(93657), int32(20), int32(-1), int32(0))
				mBase = m.M
				v50 = m.ExcPending
				if v50 != 0 {
					return int32(0)
				} else {
					F_TupleDescInitEntry(m, v35, int32(3), int32(93675), int32(20), int32(-1), int32(0))
					mBase = m.M
					v57 = m.ExcPending
					if v57 != 0 {
						return int32(0)
					} else {
						F_TupleDescInitEntry(m, v35, int32(4), int32(122996), int32(20), int32(-1), int32(0))
						mBase = m.M
						v64 = m.ExcPending
						if v64 != 0 {
							return int32(0)
						} else {
							F_TupleDescInitEntry(m, v35, int32(5), int32(143477), int32(20), int32(-1), int32(0))
							mBase = m.M
							v71 = m.ExcPending
							if v71 != 0 {
								return int32(0)
							} else {
								F_TupleDescInitEntry(m, v35, int32(6), int32(123093), int32(20), int32(-1), int32(0))
								mBase = m.M
								v78 = m.ExcPending
								if v78 != 0 {
									return int32(0)
								} else {
									F_TupleDescInitEntry(m, v35, int32(7), int32(344810), int32(20), int32(-1), int32(0))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
									} else {
										F_TupleDescInitEntry(m, v35, int32(8), int32(143449), int32(20), int32(-1), int32(0))
										mBase = m.M
										v92 = m.ExcPending
										if v92 != 0 {
											return int32(0)
										} else {
											F_TupleDescInitEntry(m, v35, int32(9), int32(344789), int32(20), int32(-1), int32(0))
											mBase = m.M
											v99 = m.ExcPending
											if v99 != 0 {
												return int32(0)
											} else {
												F_TupleDescInitEntry(m, v35, int32(10), int32(132577), int32(20), int32(-1), int32(0))
												mBase = m.M
												v106 = m.ExcPending
												if v106 != 0 {
													return int32(0)
												} else {
													F_TupleDescInitEntry(m, v35, int32(11), int32(112505), int32(1184), int32(-1), int32(0))
													mBase = m.M
													v113 = m.ExcPending
													if v113 != 0 {
														return int32(0)
...
L9:
	;
	F_s_lock(m, v75, int32(517881), int32(3950), int32(143537))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L1
...
L368:
	;
	F_errfinish(m, int32(515217), int32(1426), int32(216460))
	mBase = m.M
	v1022 = m.ExcPending
	if v1022 != 0 {
		goto L1
...
L370:
	;
	v1044 = v1023*int32(72) + int32(1683808)
	goto L372
L371:
	;
