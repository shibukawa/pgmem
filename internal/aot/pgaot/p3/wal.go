...
func F_ProcessWalSndrMessage(m *base.Module, l0 int64, l1 int64) {
	...
	v11 = v9 - int32(32)
	m.G0 = v11
	v14 = *(*int32)(unsafe.Add(mBase, _consts[400]))
	v18 = m.G0
	v19 = int32(16)
	v20 = v18 - v19
	m.G0 = v20
...
L2:
	;
	F_s_lock(m, v14+int32(1456), int32(519652), int32(1263), int32(424591))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L5
...
L12:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[172]))
	goto L15
L13:
	;
	v70 = int32(0)
...
L21:
	;
	v74 = *(*int32)(unsafe.Add(mBase, _consts[173]))
	if v74 != int32(2) {
		v85 = v70
		goto L11
	} else {
...
L22:
	;
	v78 = int32(*(*uint8)(unsafe.Add(mBase, _consts[174])))
	if v78 != 0 {
		v85 = v70
		goto L11
	} else {
...
L23:
	;
	v82 = *(*int32)(unsafe.Add(mBase, _consts[175]))
...
L30:
	;
	v96 = *(*int32)(unsafe.Add(mBase, _consts[400]))
...
L32:
	;
	F_s_lock(m, v96+int32(1456), int32(518900), int32(372), int32(27312))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L5
...
L37:
	;
	v115 = *(*int32)(unsafe.Add(mBase, _consts[240]))
...
L40:
	;
	v120 = *(*int32)(unsafe.Add(mBase, _consts[240]))
	F_s_lock(m, v120+int32(96), int32(515869), int32(4672), int32(394489))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L5
...
L42:
	;
	v129 = *(*int32)(unsafe.Add(mBase, _consts[240]))
...
L53:
	;
	F_errfinish(m, int32(519652), v212, int32(424591))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L5
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v89
	F_errmsg_internal(m, int32(161296), v11)
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L5
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v89
	F_errmsg_internal(m, int32(161216), v11+int32(16))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L5
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v13
	F_errmsg(m, int32(225371), v10+int32(32))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L9
...
L16:
	;
	F_errfinish(m, int32(519652), int32(741), int32(175464))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L9
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v13
	v59 = F_pg_snprintf(m, v10+int32(48), int32(64), int32(12998), v10+int32(16))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L9
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v93)+80)) = int32(42)
	v103 = F_pg_snprintf(m, v93+int32(96), int32(1024), int32(488612), v93+int32(80))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L9
...
L30:
	...
	v267 = *(*int32)(unsafe.Add(mBase, _consts[204]))
	if v267 != int32(2) {
		goto L76
	} else {
		goto L77
...
L37:
	;
	v124 = int32(4164524)
	v125 = *(*int32)(unsafe.Add(mBase, _consts[42]))
	v126 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v125))) = v126
	v129 = *(*int32)(unsafe.Add(mBase, _consts[42]))
	*(*int32)(unsafe.Add(mBase, uint32(v129))) = int32(167772217)
	v134 = int32(*(*uint8)(unsafe.Add(mBase, _consts[44])))
	if v134 != int32(1) {
		v148 = v126
		goto L40
	} else {
...
L38:
	;
	v177 = *(*int32)(unsafe.Add(mBase, _consts[42]))
...
L46:
	;
	v154 = int32(*(*uint8)(unsafe.Add(mBase, _consts[45])))
	if v154 != 0 {
		goto L48
	} else {
		goto L49
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v93)+48)) = v93 + int32(96)
	F_errmsg(m, int32(313967), v93+int32(48))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L9
...
L54:
	;
	F_errfinish(m, int32(523822), int32(506), int32(408452))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L9
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v93)+16)) = v13
	v189 = F_pg_snprintf(m, v93+int32(1120), int32(1024), int32(12991), v93+int32(16))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L9
...
L62:
	;
	F_errfinish(m, int32(523822), int32(481), int32(408452))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L9
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v93)+64)) = v93 + int32(96)
	F_errmsg(m, int32(312702), v93-int32(-64))
	mBase = m.M
	v240 = m.ExcPending
	if v240 != 0 {
		goto L9
...
L69:
	;
	F_errfinish(m, int32(523822), int32(498), int32(408452))
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L9
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v93)+32)) = v93 + int32(96)
	F_errmsg(m, int32(313762), v93+int32(32))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L9
...
L73:
	;
	F_errfinish(m, int32(523822), int32(512), int32(408452))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L9
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v13
	F_errmsg_internal(m, int32(56254), v10)
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L9
...
L86:
	;
	F_errfinish(m, int32(519652), int32(755), int32(175464))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L9
...
func F_WalSummarizerShutdown(m *base.Module, l0 int32, l1 int32) {
	...
	var v19 int32
	_ = v19
	v4 = *(*int32)(unsafe.Add(mBase, _consts[47]))
	...
	if v9 != 0 {
		...
		v11 = *(*int32)(unsafe.Add(mBase, _consts[425]))
...
func F_WalUsageAccumDiff(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+8)) = v17 + (v19 - v20)
	...
	v26 = *(*int64)(unsafe.Add(mBase, _consts[74]))
		...
		if int32(0) <= v19 {
			if v19 != l2 {
				...
				if v59 != 0 {
					...
					if v61 != 0 {
						...
						v64 = *(*int32)(unsafe.Add(mBase, _consts[424]))
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v68
						...
						if v78 != 0 {
							...
							if v82 != 0 {
								...
								F_errfinish(m, int32(515903), int32(312), int32(18253))
								mBase = m.M
								v87 = m.ExcPending
								if v87 != 0 {
									return int32(0)
			...
			if v37 != 0 {
				...
				if v39 != 0 {
					...
					v42 = *(*int32)(unsafe.Add(mBase, _consts[424]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v46
					...
					if v50 != 0 {
						...
						F_errfinish(m, int32(515903), int32(305), int32(18253))
						mBase = m.M
						v55 = m.ExcPending
						if v55 != 0 {
							return int32(0)
...
func F_check_wal_buffers(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v4 == int32(-1) {
		v8 = *(*int32)(unsafe.Add(mBase, _consts[218]))
		if v8 == int32(-1) {
		} else {
