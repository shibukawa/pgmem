...
L182:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v1013
	F_errmsg_plural(m, int32(_a_F_func_select_candidate_0), int32(_a_F_func_select_candidate_1), v1013, v19)
	mBase = m.M
	v1019 = m.ExcPending
	if v1019 != 0 {
		goto L13
...
L7:
	...
	v47 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_parse_func_options[0])))
...
L20:
	;
	v92 = int32(_a_F_parse_func_options_1)
	v95 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_parse_func_options[1])))
