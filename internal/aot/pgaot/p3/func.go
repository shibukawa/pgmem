...
L8:
	;
	F_scanner_yyerror(m, int32(212565), l1)
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L13
...
L182:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v1013
	F_errmsg_plural(m, int32(254572), int32(254620), v1013, v19)
	mBase = m.M
	v1019 = m.ExcPending
	if v1019 != 0 {
		goto L13
...
L183:
	;
	F_errfinish(m, int32(501209), int32(1036), int32(357603))
	mBase = m.M
	v1024 = m.ExcPending
	if v1024 != 0 {
		goto L13
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(500396), int32(1927), int32(386722))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(500396), int32(1870), int32(366951))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
...
L47:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+4)) = int32(219728)
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v164
	F_errmsg(m, int32(191813), v13)
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L25
...
L48:
	;
	F_errfinish(m, int32(495560), int32(501), int32(491015))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L25
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v181
	F_errmsg_internal(m, int32(439051), v13+int32(16))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L25
...
L51:
	;
	F_errfinish(m, int32(495560), int32(561), int32(137899))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L25
