...
L22:
	...
	v58 = *(*int32)(unsafe.Add(mBase, uint32(v53<<(uint(int32(3))%32))+uint32(_c_F_TParserGet[1])))
	v59 = v58
	goto L19
L23:
	;
...
L39:
	;
	v111 = v102 & int32(_a_F_TParserGet_0)
	if v111&int32(4) != 0 {
		goto L41
	} else {
		goto L42
...
L14:
	;
	v61 = (v50 | int32(_a_F_TerminateBufferIO_3)) & v60
...
L37:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+8)) = int64(0)
	...
	v129 = int32(_a_F_TerminateBufferIO_3)
...
L40:
	;
	v161 = int32(_a_F_TerminateBufferIO_4)
	v162 = *(*int32)(unsafe.Add(mBase, _c_F_TerminateBufferIO[0]))
...
L43:
	...
	v146 = int32(_a_F_TerminateBufferIO_3)
...
L47:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_TerminateBufferIO[0])) = v179
	goto L46
L48:
	;
	if int32(999) < v162 {
	...
	default:
		...
		if v63 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v11
			F_errmsg_internal(m, int32(_a_F_tblspc_redo_0), v6)
			mBase = m.M
			v67 = m.ExcPending
			if v67 != 0 {
				return
			} else {
				F_errfinish(m, int32(_a_F_tblspc_redo_1), int32(1568), int32(_a_F_tblspc_redo_2))
				mBase = m.M
				v72 = m.ExcPending
				if v72 != 0 {
					return
											...
											if v37 == int32(0) {
												...
												if v43 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v44
													F_errmsg(m, int32(_a_F_tblspc_redo_3), v6+int32(16))
													mBase = m.M
													v50 = m.ExcPending
													if v50 != 0 {
														return
													} else {
														F_errhint(m, int32(_a_F_tblspc_redo_4), int32(0))
														mBase = m.M
														v54 = m.ExcPending
														if v54 != 0 {
															return
														} else {
															F_errfinish(m, int32(_a_F_tblspc_redo_1), int32(1564), int32(_a_F_tblspc_redo_2))
															mBase = m.M
															v59 = m.ExcPending
															if v59 != 0 {
																return
							...
							if v74 != 0 {
								...
								if v71 == int32(0) {
									...
									*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v77)
									...
									v82 = *(*int32)(unsafe.Add(mBase, _c_F_textregexsubstr[0]))
									if v82 != 0 {
										v83 = v10 | int32(8)
									} else {
										v83 = v10
...
L7:
	...
	v99 = int32(_a_F_tfuncFetchRows_0)
	v100 = *(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[0]))
	v102 = *(*int32)(unsafe.Add(mBase, uint32(l1)+16))
	*(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[0])) = v102
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v87
	v116 = int32(0)
	v119 = *(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[1]))
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[0])) = v125
	v128 = *(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[2]))
	v130 = *(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[3]))
	goto L11
L11:
	;
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[2])) = v141
...
L17:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[3])) = v142
	*(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[2])) = v143
...
L59:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+168)) = int64(1)
	v749 = int32(_a_F_tfuncFetchRows_0)
	v750 = *(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[0]))
	...
	*(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[0])) = v760
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+16)) = v559 + int32(4)
	F_errdetail(m, int32(_a_F_tfuncFetchRows_6), v39+int32(16))
	mBase = m.M
	v649 = m.ExcPending
	if v649 != 0 {
		v1326 = v148
...
L86:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[0])) = v750
	v1203 = v726
	goto L22
L87:
	;
...
L91:
	;
	v824 = *(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[4]))
	if v824 != 0 {
		goto L92
	} else {
		goto L93
...
L122:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39))) = v909 + int32(4)
	F_errmsg(m, int32(_a_F_tfuncFetchRows_7), v39)
	mBase = m.M
	v1034 = m.ExcPending
	if v1034 != 0 {
		v1326 = v148
...
L135:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_tfuncFetchRows[0])) = v145
			...
			if v16 != int32(1) {
				...
				if v22 != 0 {
					...
					if v25 != 0 {
						...
						F_errmsg(m, int32(_a_F_timetztypmodin_0), int32(0))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_timetztypmodin_1), int32(65), int32(_a_F_timetztypmodin_2))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
...
L19:
	;
	v50 = int32(_a_F_transformDistinctClause_1)
	goto L21
L20:
	;
	v50 = int32(_a_F_transformDistinctClause_2)
	goto L21
L21:
	;
...
L40:
	;
	v122 = int32(_a_F_transformDistinctClause_5)
	goto L42
L41:
	;
	v122 = int32(_a_F_transformDistinctClause_6)
	goto L42
L42:
	;
...
L28:
	;
	v115 = *(*int32)(unsafe.Add(mBase, uint32(v108<<(uint(int32(2))%32))+uint32(_c_F_truncate_useless_pathkeys[0])))
	v117 = v115
	goto L30
L29:
	;
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = v16
		...
		if v24 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = int32(_a_F_tsm_system_time_handler_0)
			*(*int32)(unsafe.Add(mBase, uint32(v10)+24)) = int32(_a_F_tsm_system_time_handler_1)
			*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(_a_F_tsm_system_time_handler_2)
			*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(_a_F_tsm_system_time_handler_3)
			*(*int32)(unsafe.Add(mBase, uint32(v10)+12)) = int32(_a_F_tsm_system_time_handler_4)
...
L28:
	;
	if int32(_a_F_tsqueryrecv_0) < v53 {
		goto L5
	} else {
		goto L29
	}
...
L36:
	...
	v113 = int32(24)
	v116 = int32(2)
	v120 = *(*int32)(unsafe.Add(mBase, uint32((v112^int32(base.Ui32(v94)>>(uint(v113)%32)))<<(uint(v116)%32))+uint32(_c_F_tsqueryrecv[0])))
	v121 = int32(8)
	v123 = v120 ^ v94<<(uint(v121)%32)
	v131 = *(*int32)(unsafe.Add(mBase, uint32((v111^int32(base.Ui32(v123)>>(uint(v113)%32)))<<(uint(v116)%32))+uint32(_c_F_tsqueryrecv[0])))
...
L39:
	...
	v168 = *(*int32)(unsafe.Add(mBase, uint32((v160^int32(base.Ui32(v141)>>(uint(int32(24))%32)))<<(uint(int32(2))%32))+uint32(_c_F_tsqueryrecv[0])))
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v217 >> (uint(int32(24)) % 32)
	F_errmsg_internal(m, int32(_a_F_tsqueryrecv_7), v21+int32(16))
	mBase = m.M
	v429 = m.ExcPending
	if v429 != 0 {
		goto L8
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v452
	F_errmsg_internal(m, int32(_a_F_tsqueryrecv_9), v21)
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L8
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v116
	F_errmsg_internal(m, int32(_a_F_tsquerysend_1), v11)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(_a_F_tsquerysend_2), int32(1215), int32(_a_F_tsquerysend_3))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v85
	F_errdetail_plural(m, int32(_a_F_tupledesc_match_1), int32(_a_F_tupledesc_match_2), v85, v12+int32(32))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L11
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v112
	F_errdetail(m, int32(_a_F_tupledesc_match_5), v12+int32(16))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L11
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v27 + int32(1)
	F_errdetail(m, int32(_a_F_tupledesc_match_6), v12)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L11
...
L66:
	;
	v1648 = *(*int64)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[0])))
	*(*int64)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[1]))) = v1648
	v1650 = *(*int64)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[2])))
	*(*int64)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[3]))) = v1650
	*(*int32)(unsafe.Add(mBase, uint32(l1)+8)) = int32(1)
	goto L64
L67:
	;
	v986 = l1 + int32(_a_F_tzparse_1)
	v988 = l1 + int32(24)
	v995 = v981
	v996 = v982
	v999 = v4
...
L71:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l1)+4)) = int64(4294967296)
	...
	v956 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[4]))) = v956
	*(*uint16)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[5]))) = uint16(v956)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[3]))) = v956
	*(*uint8)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[6]))) = uint8(v956)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+12)) = v351
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[1]))) = v956 - v955
	v969 = l1 + int32(_a_F_tzparse_0)
	if v332 != 0 {
		goto L172
	} else {
		goto L173
...
L130:
	;
	v923 = int32(0)
	*(*uint16)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[5]))) = uint16(v923)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[3]))) = v923
	*(*uint8)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[6]))) = uint8(v923)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[1]))) = v923 - v907
	v932 = *(*int32)(unsafe.Add(mBase, uint32(v31)+40))
	*(*uint16)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[7]))) = uint16(v923)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[2]))) = v351
	v942 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[8]))) = uint8(v942)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[4]))) = v923
	*(*int32)(unsafe.Add(mBase, uint32(l1)+8)) = int32(2)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[0]))) = v923 - v932
	goto L64
L131:
	;
	v782 = v656
...
L142:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1)+8)) = int32(2)
	...
	v680 = int32(0)
	*(*uint16)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[5]))) = uint16(v680)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[3]))) = v680
	*(*uint8)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[6]))) = uint8(v680)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[1]))) = v680 - v679
	v689 = *(*int32)(unsafe.Add(mBase, uint32(v31)+40))
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[4]))) = v680
	*(*uint16)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[7]))) = uint16(v680)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[2]))) = v351
	v701 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[8]))) = uint8(v701)
	*(*int32)(unsafe.Add(mBase, uint32(l1)+uint32(_c_F_tzparse[0]))) = v680 - v689
	v720 = int32(1970)
	v737 = int64(0)
	goto L143
L143:
...
L146:
	;
	v756 = *(*int32)(unsafe.Add(mBase, uint32(v751<<(uint(int32(2))%32))+uint32(_c_F_tzparse[9])))
...
L157:
	;
	v808 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v782+(l1+int32(_a_F_tzparse_1))))))
	v811 = l1 + int32(_a_F_tzparse_3) + v808<<(uint(int32(4))%32)
...
L161:
	;
	v860 = v835 + (l1 + int32(_a_F_tzparse_1))
	v861 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v860))))
	v864 = l1 + int32(_a_F_tzparse_3) + v861<<(uint(int32(4))%32)
...
L184:
	...
	v1255 = v1051 * int32(_a_F_tzparse_4)
	goto L182
L185:
	;
	v1042 = *(*int32)(unsafe.Add(mBase, uint32(v1021)+4))
	v1043 = int32(_a_F_tzparse_4)
	v1044 = v1042 * v1043
	v1046 = v1044 - v1043
	if int32(59) < v1042 {
		goto L186
...
L198:
	;
	v1152 = v1140 * int32(_a_F_tzparse_4)
	if v1146 <= int32(0) {
		v1255 = v1152
		goto L182
	} else {
...
L201:
	...
	v1109 = int32(1)
	v1110 = v1055 - v1109
	v1116 = *(*int32)(unsafe.Add(mBase, uint32(v1040*int32(48)+v1110<<(uint(int32(2))%32))+uint32(_c_F_tzparse[10])))
	v1117 = int32(7)
	v1123 = v1101
	v1126 = v1109
	goto L202
...
L211:
	...
	v1185 = *(*int32)(unsafe.Add(mBase, uint32(v1182)+uint32(_c_F_tzparse[11])))
	v1186 = int32(_a_F_tzparse_4)
	v1190 = *(*int32)(unsafe.Add(mBase, uint32(v1182)+uint32(_c_F_tzparse[10])))
	v1196 = *(*int32)(unsafe.Add(mBase, uint32(v1182)+uint32(_c_F_tzparse[12])))
	v1202 = *(*int32)(unsafe.Add(mBase, uint32(v1182)+uint32(_c_F_tzparse[13])))
...
L215:
	;
	v1243 = *(*int32)(unsafe.Add(mBase, uint32(v1040*int32(48)+v1227<<(uint(int32(2))%32))+uint32(_c_F_tzparse[10])))
	v1246 = v1243*int32(_a_F_tzparse_4) + v1230
	v1247 = int32(1)
	v1250 = v1234 + v1247
	if v1250 != v1156 {
		v1227 = v1227 + v1247
...
L224:
	...
	v1499 = v1295 * int32(_a_F_tzparse_4)
	goto L222
L225:
	;
	v1286 = *(*int32)(unsafe.Add(mBase, uint32(v31)+4))
	v1287 = int32(_a_F_tzparse_4)
	v1288 = v1286 * v1287
	v1290 = v1288 - v1287
	if int32(59) < v1286 {
		goto L226
...
L238:
	;
	v1396 = v1384 * int32(_a_F_tzparse_4)
	if v1390 <= int32(0) {
		v1499 = v1396
		goto L222
	} else {
...
L241:
	...
	v1353 = int32(1)
	v1354 = v1299 - v1353
	v1360 = *(*int32)(unsafe.Add(mBase, uint32(v1284*int32(48)+v1354<<(uint(int32(2))%32))+uint32(_c_F_tzparse[10])))
	v1361 = int32(7)
	v1367 = v1345
	v1370 = v1353
	goto L242
...
L251:
	...
	v1429 = *(*int32)(unsafe.Add(mBase, uint32(v1426)+uint32(_c_F_tzparse[11])))
	v1430 = int32(_a_F_tzparse_4)
	v1434 = *(*int32)(unsafe.Add(mBase, uint32(v1426)+uint32(_c_F_tzparse[10])))
	v1440 = *(*int32)(unsafe.Add(mBase, uint32(v1426)+uint32(_c_F_tzparse[12])))
	v1446 = *(*int32)(unsafe.Add(mBase, uint32(v1426)+uint32(_c_F_tzparse[13])))
...
L255:
	;
	v1487 = *(*int32)(unsafe.Add(mBase, uint32(v1284*int32(48)+v1471<<(uint(int32(2))%32))+uint32(_c_F_tzparse[10])))
	v1490 = v1487*int32(_a_F_tzparse_4) + v1474
	v1491 = int32(1)
	v1494 = v1478 + v1491
	if v1494 != v1400 {
		v1471 = v1471 + v1491
...
L258:
	;
	v1525 = *(*int32)(unsafe.Add(mBase, uint32(v1520<<(uint(int32(2))%32))+uint32(_c_F_tzparse[9])))
	v1527 = v1525 * int32(_a_F_tzparse_4)
