...
func F_TerminateBufferIO(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	v10 = v8 - int32(32)
	m.G0 = v10
	*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = int32(227047)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(489711)
...
L30:
	...
	F_ResourceOwnerForget(m, v97, v98+int32(1), int32(1606492))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L6
	...
	default:
		...
		if v63 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v11
			F_errmsg_internal(m, int32(52462), v6)
			mBase = m.M
			v67 = m.ExcPending
			if v67 != 0 {
				return
			} else {
				F_errfinish(m, int32(494048), int32(1568), int32(240280))
				mBase = m.M
				v72 = m.ExcPending
				if v72 != 0 {
					return
											...
											if v37 == int32(0) {
												...
												if v43 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v44
													F_errmsg(m, int32(435590), v6+int32(16))
													mBase = m.M
													v50 = m.ExcPending
													if v50 != 0 {
														return
													} else {
														F_errhint(m, int32(552812), int32(0))
														mBase = m.M
														v54 = m.ExcPending
														if v54 != 0 {
															return
														} else {
															F_errfinish(m, int32(494048), int32(1564), int32(240280))
															mBase = m.M
															v59 = m.ExcPending
															if v59 != 0 {
																return
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errmsg(m, int32(299952), int32(0))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		v1326 = v148
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errfinish(m, int32(491520), int32(389), int32(337944))
	mBase = m.M
	v355 = m.ExcPending
	if v355 != 0 {
		v1326 = v148
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errmsg(m, int32(300193), int32(0))
	mBase = m.M
	v422 = m.ExcPending
	if v422 != 0 {
		v1326 = v148
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errfinish(m, int32(491520), int32(370), int32(337944))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		v1326 = v148
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errmsg(m, int32(299991), int32(0))
	mBase = m.M
	v629 = m.ExcPending
	if v629 != 0 {
		v1326 = v148
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+16)) = v559 + int32(4)
	F_errdetail(m, int32(600525), v39+int32(16))
	mBase = m.M
	v649 = m.ExcPending
	if v649 != 0 {
		v1326 = v148
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errfinish(m, int32(491520), int32(418), int32(337944))
	mBase = m.M
	v666 = m.ExcPending
	if v666 != 0 {
		v1326 = v148
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errfinish(m, int32(491520), int32(508), int32(112995))
	mBase = m.M
	v1051 = m.ExcPending
	if v1051 != 0 {
		v1326 = v148
			...
			if v185 != 0 {
				...
				if v188 != 0 {
					...
					if v192 != 0 {
						...
						F_errfinish(m, int32(490442), int32(6509), int32(30951))
						mBase = m.M
						v197 = m.ExcPending
						if v197 != 0 {
							return int64(0)
				...
				if v22 != 0 {
					...
					if v25 != 0 {
						...
						if v29 != 0 {
							...
							F_errfinish(m, int32(493170), int32(65), int32(274550))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
...
L16:
	;
	F_errmsg_internal(m, int32(113563), int32(0))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L15
...
L17:
	;
	F_errfinish(m, int32(493371), int32(561), int32(13097))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L15
...
L23:
	;
	F_errfinish(m, int32(493189), int32(3019), int32(355792))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L9
...
L43:
	;
	F_errfinish(m, int32(493189), int32(3050), int32(355792))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L9
...
L31:
	;
	v75 = int32(0)
	v79 = F_refnameNamespaceItem(m, l0, v75, int32(425121), int32(-1), v75)
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L22
...
L36:
	;
	v88 = int32(0)
	v92 = F_refnameNamespaceItem(m, l0, v88, int32(31964), int32(-1), v88)
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L22
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = int32(536887)
	F_errmsg(m, int32(161548), v11+int32(-32))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L22
...
L57:
	;
	F_errfinish(m, int32(492887), int32(2669), int32(355884))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L22
...
L60:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = int32(510535)
	F_errmsg(m, int32(161548), v11+int32(-16))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L22
...
L62:
	;
	F_errfinish(m, int32(492887), int32(2679), int32(355884))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L22
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v190
	F_errmsg_internal(m, int32(477556), v13)
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L22
...
L65:
	;
	F_errfinish(m, int32(492887), int32(2684), int32(355884))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L22
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v207
	F_errmsg(m, int32(411144), v11+int32(-48))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L22
...
L70:
	;
	F_errfinish(m, int32(492887), int32(2692), int32(355884))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L22
...
L73:
	;
	F_errmsg(m, int32(271262), int32(0))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L22
...
L75:
	;
	F_errfinish(m, int32(492887), int32(2740), int32(355884))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L22
	...
	if v13 != 0 {
		...
		if v10 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v15
			F_errcontext_msg(m, int32(706378), v8+int32(16))
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v15
			F_errcontext_msg(m, int32(694479), v8)
			mBase = m.M
			v29 = m.ExcPending
			if v29 != 0 {
				return
...
L86:
	;
	F_errfinish(m, int32(486956), int32(1241), int32(35556))
	mBase = m.M
	v434 = m.ExcPending
	if v434 != 0 {
		goto L8
...
L88:
	;
	F_errmsg_internal(m, int32(235845), int32(0))
	mBase = m.M
	v442 = m.ExcPending
	if v442 != 0 {
		goto L8
...
L89:
	;
	F_errfinish(m, int32(486956), int32(1274), int32(35556))
	mBase = m.M
	v447 = m.ExcPending
	if v447 != 0 {
		goto L8
...
L91:
	;
	F_errmsg_internal(m, int32(324678), int32(0))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L8
...
L92:
	;
	F_errfinish(m, int32(486956), int32(1277), int32(35556))
	mBase = m.M
	v460 = m.ExcPending
	if v460 != 0 {
		goto L8
...
L94:
	;
	F_errmsg_internal(m, int32(457511), int32(0))
	mBase = m.M
	v468 = m.ExcPending
	if v468 != 0 {
		goto L8
...
L95:
	;
	F_errfinish(m, int32(486956), int32(1280), int32(35556))
	mBase = m.M
	v473 = m.ExcPending
	if v473 != 0 {
		goto L8
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v273 >> (uint(int32(24)) % 32)
	F_errmsg_internal(m, int32(470900), v21+int32(16))
	mBase = m.M
	v485 = m.ExcPending
	if v485 != 0 {
		goto L8
...
L98:
	;
	F_errfinish(m, int32(486956), int32(1309), int32(35556))
	mBase = m.M
	v490 = m.ExcPending
	if v490 != 0 {
		goto L8
...
L100:
	;
	F_errmsg_internal(m, int32(422774), int32(0))
	mBase = m.M
	v498 = m.ExcPending
	if v498 != 0 {
		goto L8
...
L101:
	;
	F_errfinish(m, int32(486956), int32(1311), int32(35556))
	mBase = m.M
	v503 = m.ExcPending
	if v503 != 0 {
		goto L8
...
L103:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v508
	F_errmsg_internal(m, int32(480335), v21)
	mBase = m.M
	v512 = m.ExcPending
	if v512 != 0 {
		goto L8
...
L104:
	;
	F_errfinish(m, int32(486956), int32(1318), int32(35556))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L8
...
L106:
	;
	F_errmsg_internal(m, int32(169666), int32(0))
	mBase = m.M
	v525 = m.ExcPending
	if v525 != 0 {
		goto L8
...
L107:
	;
	F_errfinish(m, int32(486956), int32(793), int32(420325))
	mBase = m.M
	v530 = m.ExcPending
	if v530 != 0 {
		goto L8
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v116
	F_errmsg_internal(m, int32(480335), v11)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(486956), int32(1215), int32(420950))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
				...
				*(*int64)(unsafe.Add(mBase, uint32(v28)+8)) = int64(16)
				...
				if v34 == v38 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11+v24))) = v60
					m.G0 = v28 + int32(16)
					if v61 == int32(0) {
						v69 = F_cstring_to_text(m, int32(516515))
						mBase = m.M
						v70 = m.ExcPending
						if v70 != 0 {
							return int32(0)
...
L21:
	;
	F_errmsg(m, int32(321982), int32(0))
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L11
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v85
	F_errdetail_plural(m, int32(631650), int32(631536), v85, v12+int32(32))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L11
...
L23:
	;
	F_errfinish(m, int32(494655), int32(954), int32(321673))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L11
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v112
	F_errdetail(m, int32(582483), v12+int32(16))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L11
...
L30:
	;
	F_errfinish(m, int32(494655), int32(970), int32(321673))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L11
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v27 + int32(1)
	F_errdetail(m, int32(632396), v12)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L11
...
L35:
	;
	F_errfinish(m, int32(494655), int32(978), int32(321673))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L11
