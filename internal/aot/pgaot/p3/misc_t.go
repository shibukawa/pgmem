...
func F_TeardownHistoricSnapshot(m *base.Module) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[1195])) = v2
	return
}
func F_TerminateBufferIO(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	v10 = v8 - int32(32)
	m.G0 = v10
	*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = int32(229240)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(495087)
...
L30:
	...
	F_ResourceOwnerForget(m, v97, v98+int32(1), int32(1628172))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L6
	...
	default:
		...
		if v63 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v11
			F_errmsg_internal(m, int32(52712), v6)
			mBase = m.M
			v67 = m.ExcPending
			if v67 != 0 {
				return
			} else {
				F_errfinish(m, int32(499492), int32(1568), int32(242666))
				mBase = m.M
				v72 = m.ExcPending
				if v72 != 0 {
					return
											...
											if v37 == int32(0) {
												...
												if v43 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v44
													F_errmsg(m, int32(440324), v6+int32(16))
													mBase = m.M
													v50 = m.ExcPending
													if v50 != 0 {
														return
													} else {
														F_errhint(m, int32(574099), int32(0))
														mBase = m.M
														v54 = m.ExcPending
														if v54 != 0 {
															return
														} else {
															F_errfinish(m, int32(499492), int32(1564), int32(242666))
															mBase = m.M
															v59 = m.ExcPending
															if v59 != 0 {
																return
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errmsg(m, int32(303046), int32(0))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		v1326 = v148
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errfinish(m, int32(496914), int32(389), int32(341702))
	mBase = m.M
	v355 = m.ExcPending
	if v355 != 0 {
		v1326 = v148
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errmsg(m, int32(303287), int32(0))
	mBase = m.M
	v422 = m.ExcPending
	if v422 != 0 {
		v1326 = v148
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errfinish(m, int32(496914), int32(370), int32(341702))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		v1326 = v148
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errmsg(m, int32(303085), int32(0))
	mBase = m.M
	v629 = m.ExcPending
	if v629 != 0 {
		v1326 = v148
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+16)) = v559 + int32(4)
	F_errdetail(m, int32(621900), v39+int32(16))
	mBase = m.M
	v649 = m.ExcPending
	if v649 != 0 {
		v1326 = v148
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errfinish(m, int32(496914), int32(418), int32(341702))
	mBase = m.M
	v666 = m.ExcPending
	if v666 != 0 {
		v1326 = v148
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39)+72)) = v138
	*(*int32)(unsafe.Add(mBase, uint32(v39)+76)) = v137
	F_errfinish(m, int32(496914), int32(508), int32(114102))
	mBase = m.M
	v1051 = m.ExcPending
	if v1051 != 0 {
		v1326 = v148
			...
			if v185 != 0 {
				...
				if v188 != 0 {
					...
					if v192 != 0 {
						...
						F_errfinish(m, int32(495818), int32(6509), int32(31154))
						mBase = m.M
						v197 = m.ExcPending
						if v197 != 0 {
							return int64(0)
				...
				if v22 != 0 {
					...
					if v25 != 0 {
						...
						if v29 != 0 {
							...
							F_errfinish(m, int32(498614), int32(65), int32(277353))
							mBase = m.M
							v34 = m.ExcPending
							if v34 != 0 {
								return int32(0)
...
L16:
	;
	F_errmsg_internal(m, int32(114697), int32(0))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L15
...
L17:
	;
	F_errfinish(m, int32(498815), int32(561), int32(13156))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L15
...
L3:
	...
	v21 = int32(2)
	v25 = *(*int32)(unsafe.Add(mBase, uint32((l0-v15*v14)&v12<<(uint(v21)%32))+uint32(_consts[1394])))
	v26 = int32(8)
	v27 = int32(base.Ui32(l0) >> (uint(v26) % 32))
	v30 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[1395]))))
	v36 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v30*int32(86)+v15)+uint32(_consts[1395]))))
	v41 = base.I32_rem_u_s(int32(base.Ui32(v25*v36)>>(uint(int32(11))%32)), int32(6))
	v44 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v27)+uint32(_consts[1396]))))
	v50 = *(*int32)(unsafe.Add(mBase, uint32((v41+v44)<<(uint(v21)%32))+uint32(_consts[1397])))
	v52 = v50 >> (uint(v26) % 32)
	v54 = v50 & v12
...
L8:
	...
	v79 = v78 + v71
	v81 = v79 << (uint(v77) % 32)
	v84 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v81)+uint32(_consts[1398]))))
	if v84 == v13 {
		goto L10
	} else {
		goto L11
...
L10:
	;
	v86 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v81)+uint32(_consts[1399]))))
	v91 = *(*int32)(unsafe.Add(mBase, uint32(v86<<(uint(int32(2))%32))+uint32(_consts[1397])))
	v93 = v91 & int32(255)
...
L23:
	;
	F_errfinish(m, int32(498633), int32(3019), int32(359710))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L9
...
L43:
	;
	F_errfinish(m, int32(498633), int32(3050), int32(359710))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L9
...
L31:
	;
	v75 = int32(0)
	v79 = F_refnameNamespaceItem(m, l0, v75, int32(429809), int32(-1), v75)
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L22
...
L36:
	;
	v88 = int32(0)
	v92 = F_refnameNamespaceItem(m, l0, v88, int32(32167), int32(-1), v88)
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L22
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = int32(542866)
	F_errmsg(m, int32(163102), v11+int32(-32))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L22
...
L57:
	;
	F_errfinish(m, int32(498318), int32(2669), int32(359802))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L22
...
L60:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = int32(516213)
	F_errmsg(m, int32(163102), v11+int32(-16))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L22
...
L62:
	;
	F_errfinish(m, int32(498318), int32(2679), int32(359802))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L22
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v190
	F_errmsg_internal(m, int32(482854), v13)
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L22
...
L65:
	;
	F_errfinish(m, int32(498318), int32(2684), int32(359802))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L22
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v207
	F_errmsg(m, int32(415548), v11+int32(-48))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L22
...
L70:
	;
	F_errfinish(m, int32(498318), int32(2692), int32(359802))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L22
...
L73:
	;
	F_errmsg(m, int32(274025), int32(0))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L22
...
L75:
	;
	F_errfinish(m, int32(498318), int32(2740), int32(359802))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L22
	...
	if v13 != 0 {
		...
		if v10 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v15
			F_errcontext_msg(m, int32(728035), v8+int32(16))
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v15
			F_errcontext_msg(m, int32(715917), v8)
			mBase = m.M
			v29 = m.ExcPending
			if v29 != 0 {
				return
...
L69:
	;
	F_errfinish(m, int32(492300), int32(1241), int32(35787))
	mBase = m.M
	v378 = m.ExcPending
	if v378 != 0 {
		goto L8
...
L71:
	;
	F_errmsg_internal(m, int32(238118), int32(0))
	mBase = m.M
	v386 = m.ExcPending
	if v386 != 0 {
		goto L8
...
L72:
	;
	F_errfinish(m, int32(492300), int32(1274), int32(35787))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L8
...
L74:
	;
	F_errmsg_internal(m, int32(328124), int32(0))
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L8
...
L75:
	;
	F_errfinish(m, int32(492300), int32(1277), int32(35787))
	mBase = m.M
	v404 = m.ExcPending
	if v404 != 0 {
		goto L8
...
L77:
	;
	F_errmsg_internal(m, int32(462430), int32(0))
	mBase = m.M
	v412 = m.ExcPending
	if v412 != 0 {
		goto L8
...
L78:
	;
	F_errfinish(m, int32(492300), int32(1280), int32(35787))
	mBase = m.M
	v417 = m.ExcPending
	if v417 != 0 {
		goto L8
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v217 >> (uint(int32(24)) % 32)
	F_errmsg_internal(m, int32(476094), v21+int32(16))
	mBase = m.M
	v429 = m.ExcPending
	if v429 != 0 {
		goto L8
...
L81:
	;
	F_errfinish(m, int32(492300), int32(1309), int32(35787))
	mBase = m.M
	v434 = m.ExcPending
	if v434 != 0 {
		goto L8
...
L83:
	;
	F_errmsg_internal(m, int32(427462), int32(0))
	mBase = m.M
	v442 = m.ExcPending
	if v442 != 0 {
		goto L8
...
L84:
	;
	F_errfinish(m, int32(492300), int32(1311), int32(35787))
	mBase = m.M
	v447 = m.ExcPending
	if v447 != 0 {
		goto L8
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v452
	F_errmsg_internal(m, int32(485633), v21)
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L8
...
L87:
	;
	F_errfinish(m, int32(492300), int32(1318), int32(35787))
	mBase = m.M
	v461 = m.ExcPending
	if v461 != 0 {
		goto L8
...
L89:
	;
	F_errmsg_internal(m, int32(171220), int32(0))
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L8
...
L90:
	;
	F_errfinish(m, int32(492300), int32(793), int32(424975))
	mBase = m.M
	v474 = m.ExcPending
	if v474 != 0 {
		goto L8
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v116
	F_errmsg_internal(m, int32(485633), v11)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(492300), int32(1215), int32(425619))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
				...
				*(*int64)(unsafe.Add(mBase, uint32(v28)+8)) = int64(16)
				...
				if v34 == v38 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11+v24))) = v60
					m.G0 = v28 + int32(16)
					if v61 == int32(0) {
						v69 = F_cstring_to_text(m, int32(522217))
						mBase = m.M
						v70 = m.ExcPending
						if v70 != 0 {
							return int32(0)
...
L21:
	;
	F_errmsg(m, int32(325333), int32(0))
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L11
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v85
	F_errdetail_plural(m, int32(653025), int32(652911), v85, v12+int32(32))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L11
...
L23:
	;
	F_errfinish(m, int32(500106), int32(954), int32(325024))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L11
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v112
	F_errdetail(m, int32(603858), v12+int32(16))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L11
...
L30:
	;
	F_errfinish(m, int32(500106), int32(970), int32(325024))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L11
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v27 + int32(1)
	F_errdetail(m, int32(653771), v12)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L11
...
L35:
	;
	F_errfinish(m, int32(500106), int32(978), int32(325024))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L11
