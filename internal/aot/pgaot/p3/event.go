							...
							*(*int32)(unsafe.Add(mBase, uint32(v22)+20)) = v185
							...
							if v190 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v22)+24)) = v189
								v193 = *(*int32)(unsafe.Add(mBase, _c_F_EventTriggerSQLDropAddObject[0]))
...
func F_event_trigger_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_event_trigger_in_0)
			F_errmsg(m, int32(_a_F_event_trigger_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_event_trigger_in_2), int32(367), int32(_a_F_event_trigger_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
