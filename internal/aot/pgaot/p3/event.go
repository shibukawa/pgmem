...
func F_EventTriggerSQLDropAddObject(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v10 = v8 + int32(-64)
	m.G0 = v10
	v13 = *(*int32)(unsafe.Add(mBase, _consts[428]))
	if v13 == int32(0) {
		m.G0 = v10 - int32(-64)
		return
	} else {
		...
		if v23 != 0 {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v22)+36)) = uint8(v2)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v22)+20)) = v185
							...
							if v190 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v22)+24)) = v189
								v193 = *(*int32)(unsafe.Add(mBase, _consts[428]))
			...
			case 11:
				...
				v36 = *(*int32)(unsafe.Add(mBase, _consts[135]))
...
func F_event_trigger_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(223569)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(493972), int32(367), int32(279268))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
