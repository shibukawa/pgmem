...
L4:
	;
	F_s_lock(m, v16, int32(507175), int32(886), int32(318596))
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L7
...
func F_shm_mq_detach_callback(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l1, int32(507175), int32(886), int32(318596))
		mBase = m.M
		v10 = m.ExcPending
		if v10 != 0 {
			return
...
L4:
	;
	F_s_lock(m, l0, int32(507175), int32(1228), int32(317410))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L7
...
func F_shm_toc_insert(m *base.Module, l0 int32, l1 int64, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+8)) = int32(1)
	v11 = l0 + int32(8)
	if v7 != 0 {
		F_s_lock(m, v11, int32(512084), int32(184), int32(83577))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return
				...
				if v37 != 0 {
					...
					if v40 != 0 {
						...
						if v44 != 0 {
							...
							F_errfinish(m, int32(512084), int32(200), int32(83577))
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return
