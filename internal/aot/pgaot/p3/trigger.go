...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v72 + int32(12)
	F_errmsg(m, int32(223513), v19+int32(16))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(493723), int32(1778), int32(224094))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L1
...
L66:
	;
	F_errfinish(m, int32(493723), int32(1839), int32(224094))
	mBase = m.M
	v268 = m.ExcPending
	if v268 != 0 {
		goto L1
