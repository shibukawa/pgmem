								...
								if v39 == int32(0) {
									...
									if v57 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9))) = v31
										F_errmsg_internal(m, int32(385580), v9)
										mBase = m.M
										v61 = m.ExcPending
										if v61 != 0 {
											return int32(0)
...
L54:
	;
	F_errmsg_internal(m, int32(66806), int32(0))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L20
...
L55:
	;
	F_errfinish(m, int32(513997), int32(1422), int32(291963))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L20
...
L57:
	;
	F_errmsg_internal(m, int32(417308), int32(0))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L20
...
L58:
	;
	F_errfinish(m, int32(513997), int32(1426), int32(291963))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L20
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v47
	F_errmsg_internal(m, int32(385580), v11)
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L20
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v15
	F_errmsg_internal(m, int32(385580), v12)
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L1
...
L40:
	;
	F_errmsg_internal(m, int32(143384), int32(0))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L1
...
L41:
	;
	F_errfinish(m, int32(513997), int32(974), int32(582600))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L44:
	;
	F_errmsg(m, int32(120283), int32(0))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L1
...
L45:
	;
	F_errfinish(m, int32(513997), int32(982), int32(582600))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L1
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v49
	F_errmsg_internal(m, int32(383445), v12+int32(16))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L1
...
L48:
	;
	F_errfinish(m, int32(513997), int32(986), int32(582600))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L1
...
L51:
	;
	F_errmsg(m, int32(143384), int32(0))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L1
...
L52:
	;
	F_errfinish(m, int32(513997), int32(1008), int32(582600))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L1
...
L21:
	;
	F_errmsg_internal(m, int32(338742), int32(0))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L13
...
L22:
	;
	F_errfinish(m, int32(513997), int32(1879), int32(323767))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L13
...
L12:
	;
	v233 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(l3)+6)) = uint8(v233)
	*(*int32)(unsafe.Add(mBase, uint32(l3))) = v231
	v239 = int32(base.Ui32(v65)>>(uint(v233)%32)) & v233
	*(*uint8)(unsafe.Add(mBase, uint32(l3)+5)) = uint8(v239)
	v244 = int32(base.Ui32(v65)>>(uint(int32(3))%32)) & v233
	*(*uint8)(unsafe.Add(mBase, uint32(l3)+4)) = uint8(v244)
	v246 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(l4)+6)) = uint8(v246)
	v251 = int32(base.Ui32(v65)>>(uint(int32(2))%32)) & v233
	*(*uint8)(unsafe.Add(mBase, uint32(l4)+5)) = uint8(v251)
	v256 = int32(base.Ui32(v65)>>(uint(int32(4))%32)) & v233
	*(*uint8)(unsafe.Add(mBase, uint32(l4)+4)) = uint8(v256)
...
L19:
	...
	v168 = int32(base.Ui32(v164) >> (uint(int32(2)) % 32))
	goto L18
L20:
	;
	if v65&int32(81) != 0 {
...
L53:
	;
	v168 = int32(base.Ui32(v129) >> (uint(int32(1)) % 32))
	goto L18
L54:
	;
	if v67 == int32(-1) {
...
L61:
	;
	v197 = (v177 + int32(1)) & int32(-2)
	v198 = v178
	v199 = v179
	goto L14
L62:
	;
	v197 = (v177 + int32(7)) & int32(-8)
	v198 = v178
	v199 = v179
	goto L14
L63:
...
L66:
	;
	v223 = int32(*(*int8)(unsafe.Add(mBase, uint32(v197))))
	v225 = v198
	v227 = v223
	goto L13
L67:
...
L69:
	;
	v206 = int32(*(*int16)(unsafe.Add(mBase, uint32(v197))))
	v225 = v198
	v227 = v206
	goto L13
L70:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v199
	F_errmsg_internal(m, int32(501949), v15+int32(16))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L31
				...
				if v18 == int32(0) {
					...
					if v31 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
						F_errmsg_internal(m, int32(385580), v7)
						mBase = m.M
						v35 = m.ExcPending
						if v35 != 0 {
							return int32(0)
...
L132:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v32
	F_errmsg_internal(m, int32(385580), v22)
	mBase = m.M
	v577 = m.ExcPending
	if v577 != 0 {
		goto L1
								...
								if v34 == int32(0) {
									...
									if v80 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v10))) = v26
										F_errmsg_internal(m, int32(385580), v10)
										mBase = m.M
										v84 = m.ExcPending
										if v84 != 0 {
											return int32(0)
