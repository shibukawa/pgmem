...
L11:
	;
	v24 = F_lookup_type_cache(m, v15, int32(_a_F_multirange_constructor2_0))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v15
	F_errmsg_internal(m, int32(_a_F_multirange_constructor2_1), v12)
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L1
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v49
	F_errmsg_internal(m, int32(_a_F_multirange_constructor2_7), v12+int32(16))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L1
