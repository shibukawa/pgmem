...
func F_RI_FKey_noaction_upd(m *base.Module, l0 int32) int32 {
	...
	var v11 int32
	_ = v11
	F_ri_CheckTrigger(m, l0, int32(438609), int32(2))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_RI_FKey_setnull_upd(m *base.Module, l0 int32) int32 {
	...
	var v12 int32
	_ = v12
	F_ri_CheckTrigger(m, l0, int32(438630), int32(2))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
			...
			if v13 == int32(0) {
				...
				if v116 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
					F_errmsg_internal(m, int32(49088), v10)
					mBase = m.M
					v120 = m.ExcPending
					if v120 != 0 {
						return
					} else {
						F_errfinish(m, int32(512844), int32(2108), int32(273362))
						mBase = m.M
						v125 = m.ExcPending
						if v125 != 0 {
							return
				...
				if v22 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v10 + int32(48)
					F_appendStringInfo(m, l0, int32(207150), v10+int32(32))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v10 + int32(48)
						F_appendStringInfo(m, l0, int32(186131), v10+int32(16))
						mBase = m.M
						v100 = m.ExcPending
						if v100 != 0 {
							return
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v348
	F_errmsg_internal(m, int32(205847), v23)
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L16
...
L76:
	;
	F_errfinish(m, int32(512844), int32(2594), int32(331128))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L16
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v366 + v371
	F_errmsg(m, int32(103897), v23+int32(16))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L16
...
L80:
	;
	F_errhint(m, int32(595687), int32(0))
	mBase = m.M
	v385 = m.ExcPending
	if v385 != 0 {
		goto L16
...
L81:
	;
	F_errfinish(m, int32(512844), int32(2603), int32(331128))
	mBase = m.M
	v390 = m.ExcPending
	if v390 != 0 {
		goto L16
		...
		if v36 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[3])) = v40
			...
			if v47 != 0 {
				...
				v49 = *(*int32)(unsafe.Add(mBase, _consts[1036]))
				if v49 != 0 {
					v90 = v49
					...
					*(*int64)(unsafe.Add(mBase, uint32(v11)+32)) = int64(3023656976388)
					v58 = F_hash_create(m, int32(414874), int32(64), v9+int32(-48), int32(40))
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return int32(0)
					} else {
						*(*int32)(unsafe.Add(mBase, _consts[1037])) = v58
						...
						if v65 != 0 {
							...
							*(*int64)(unsafe.Add(mBase, uint32(v11)+32)) = int64(51539607560)
							v74 = F_hash_create(m, int32(414775), int32(256), v9+int32(-48), int32(40))
							mBase = m.M
							v75 = m.ExcPending
							if v75 != 0 {
								return int32(0)
							} else {
								*(*int32)(unsafe.Add(mBase, _consts[1036])) = v74
								*(*int64)(unsafe.Add(mBase, uint32(v11)+32)) = int64(292057776136)
								v85 = F_hash_create(m, int32(415188), int32(256), v9+int32(-48), int32(40))
								mBase = m.M
								v86 = m.ExcPending
								if v86 != 0 {
									return int32(0)
								} else {
									*(*int32)(unsafe.Add(mBase, _consts[1038])) = v85
									v89 = *(*int32)(unsafe.Add(mBase, _consts[1036]))
									v90 = v89
									v94 = F_hash_search(m, v90, l3, int32(1), v9+int32(-48))
									mBase = m.M
									v95 = m.ExcPending
			...
			if v104 != 0 {
				...
				if v108 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = v107
					F_errmsg_internal(m, int32(190336), v11)
					mBase = m.M
					v113 = m.ExcPending
					if v113 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(512844), int32(2468), int32(331115))
						mBase = m.M
						v118 = m.ExcPending
						if v118 != 0 {
							return int32(0)
...
L51:
	;
	F_appendStringInfoString(m, v18+int32(208), int32(774098))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L13
...
L54:
	;
	F_appendStringInfoString(m, v18+int32(192), int32(774098))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L13
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+64)) = v284 + int32(4)
	F_errmsg(m, int32(726293), v18-int32(-64))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L13
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v296 + int32(4)
	F_errdetail(m, int32(691700), v18+int32(32))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L13
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+48)) = v309 + int32(4)
	F_errdetail(m, int32(691666), v18+int32(48))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L13
...
L72:
	;
	F_errfinish(m, int32(512844), int32(2783), int32(272923))
	mBase = m.M
	v325 = m.ExcPending
	if v325 != 0 {
		goto L13
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+112)) = v331 + v334
	F_errmsg(m, int32(746527), v18+int32(112))
	mBase = m.M
	v344 = m.ExcPending
	if v344 != 0 {
		goto L13
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+88)) = v345 + int32(4)
	F_errdetail(m, int32(691779), v18+int32(80))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L13
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+96)) = v358 + int32(4)
	F_errdetail(m, int32(691744), v18+int32(96))
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L13
...
L85:
	;
	F_errfinish(m, int32(512844), int32(2797), int32(272923))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L13
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+160)) = v378 + v381
	F_errmsg(m, int32(746445), v18+int32(160))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L13
...
L90:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+136)) = v392 + int32(4)
	F_errdetail(m, int32(691865), v18+int32(128))
	mBase = m.M
	v404 = m.ExcPending
	if v404 != 0 {
		goto L13
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+144)) = v405 + int32(4)
	F_errdetail(m, int32(691824), v18+int32(144))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L13
...
L95:
	;
	F_errfinish(m, int32(512844), int32(2811), int32(272923))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L13
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v429 + int32(4)
	F_errmsg(m, int32(726232), v18+int32(16))
	mBase = m.M
	v440 = m.ExcPending
	if v440 != 0 {
		goto L13
...
L99:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+8)) = v441 + int32(4)
	F_errdetail(m, int32(691865), v18)
	mBase = m.M
	v451 = m.ExcPending
	if v451 != 0 {
		goto L13
...
L101:
	;
	F_errfinish(m, int32(512844), int32(2770), int32(272923))
	mBase = m.M
	v458 = m.ExcPending
	if v458 != 0 {
		goto L13
