...
L4:
	;
	v25 = v22 - v16
	v27 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v25)+uint32(_consts[1125]))))
	if v27 != 0 {
		v57 = v6
		goto L5
	} else {
...
L47:
	;
	v480 = *(*int32)(unsafe.Add(mBase, _consts[1127]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+52)) = v484
	v487 = *(*int64)(unsafe.Add(mBase, _consts[1128]))
...
L65:
	;
	F_errfinish(m, int32(517023), int32(1300), int32(408833))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L62
...
L105:
	;
	F_errfinish(m, int32(517023), int32(1372), int32(408833))
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
		goto L62
...
L144:
	;
	v406 = *(*int32)(unsafe.Add(mBase, _consts[1129]))
	if v406 == int32(0) {
		goto L146
	} else {
		goto L147
...
L183:
	;
	v563 = *(*int32)(unsafe.Add(mBase, _consts[1130]))
	if v563 == int32(0) {
		goto L184
	} else {
		goto L185
...
L188:
	;
	v573 = *(*int32)(unsafe.Add(mBase, _consts[1130]))
...
L189:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1130])) = v574
	m.G0 = v14 + int32(2608)
	return
L190:
	;
...
L192:
	;
	F_errfinish(m, int32(517023), int32(1307), int32(408833))
	mBase = m.M
	v596 = m.ExcPending
	if v596 != 0 {
		goto L62
...
L197:
	;
	F_errfinish(m, int32(517023), int32(1316), int32(408833))
	mBase = m.M
	v618 = m.ExcPending
	if v618 != 0 {
		goto L62
...
L200:
	;
	F_errfinish(m, int32(517023), int32(1327), int32(408833))
	mBase = m.M
	v636 = m.ExcPending
	if v636 != 0 {
		goto L62
...
L205:
	;
	F_errfinish(m, int32(517023), int32(1410), int32(408833))
	mBase = m.M
	v663 = m.ExcPending
	if v663 != 0 {
		goto L62
...
L210:
	;
	F_errfinish(m, int32(517023), int32(1426), int32(408833))
	mBase = m.M
	v684 = m.ExcPending
	if v684 != 0 {
		goto L62
...
L217:
	;
	F_errfinish(m, int32(517023), int32(1461), int32(408833))
	mBase = m.M
	v709 = m.ExcPending
	if v709 != 0 {
		goto L62
...
L221:
	;
	F_errfinish(m, int32(517023), int32(1475), int32(408833))
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L62
...
L225:
	;
	F_errfinish(m, int32(517023), int32(1486), int32(408833))
	mBase = m.M
	v752 = m.ExcPending
	if v752 != 0 {
		goto L62
...
L229:
	;
	F_errfinish(m, int32(517023), int32(1286), int32(408833))
	mBase = m.M
	v769 = m.ExcPending
	if v769 != 0 {
		goto L62
