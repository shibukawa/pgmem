...
func F_pg_prng_uint32(m *base.Module) int32 {
	...
	var v8 int64
	_ = v8
	v3 = int32(_a_F_pg_prng_uint32_0)
	v4 = int32(_a_F_pg_prng_uint32_1)
	v5 = *(*int64)(unsafe.Add(mBase, _c_F_pg_prng_uint32[0]))
	v7 = *(*int64)(unsafe.Add(mBase, _c_F_pg_prng_uint32[1]))
	v8 = v5 ^ v7
	*(*int64)(unsafe.Add(mBase, _c_F_pg_prng_uint32[1])) = base.I64_rotl(v8, int64(37))
	*(*int64)(unsafe.Add(mBase, _c_F_pg_prng_uint32[0])) = v8<<(uint(int64(16))%64) ^ base.I64_rotl(v5, int64(24)) ^ v8
