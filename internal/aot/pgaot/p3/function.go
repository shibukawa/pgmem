			...
			if v49 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11))) = v50
				...
				if v54 != 0 {
					...
					F_errfinish(m, int32(_a_F_FunctionCall5Coll_1), int32(1246), int32(_a_F_FunctionCall5Coll_2))
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return int32(0)
			...
			if v57 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v13))) = v58
				...
				if v62 != 0 {
					...
					F_errfinish(m, int32(_a_F_FunctionCall7Coll_1), int32(1312), int32(_a_F_FunctionCall7Coll_2))
					mBase = m.M
					v67 = m.ExcPending
					if v67 != 0 {
						return int32(0)
...
func F_coerce_function_result_tuple(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != int32(1) {
		...
		if v61 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = int32(base.Ui32(v62) >> (uint(int32(2)) % 32))
			...
			if v76 != 0 {
				...
				v78 = F_convert_tuples_by_position(m, v75, l1, int32(_a_F_coerce_function_result_tuple_0))
				mBase = m.M
				v79 = m.ExcPending
				if v79 != 0 {
					return
		...
		if v14&int32(254) != int32(2) {
			...
			if v20 != 0 {
				v23 = v20
				v25 = F_convert_tuples_by_position(m, v23, l1, int32(_a_F_coerce_function_result_tuple_0))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return
			...
			if v22 != 0 {
				...
				if v24 != 0 {
					...
					if v23 == int32(0) {
						...
						if v30 != 0 {
							...
							if v33 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v21
								F_errmsg(m, int32(_a_F_has_function_privilege_id_name_0), v8)
								mBase = m.M
								v37 = m.ExcPending
								if v37 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_has_function_privilege_id_name_1), int32(3565), int32(_a_F_has_function_privilege_id_name_2))
									mBase = m.M
									v42 = m.ExcPending
									if v42 != 0 {
										return int32(0)
						...
						v45 = F_convert_any_priv_string(m, v17, int32(_a_F_has_function_privilege_id_name_3))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v22 != 0 {
			...
			v24 = F_convert_any_priv_string(m, v14, int32(_a_F_has_function_privilege_name_id_0))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
