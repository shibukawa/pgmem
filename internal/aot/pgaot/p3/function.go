		...
		if v51 == int32(1) {
			...
			if v57 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v13))) = v58
				F_errmsg_internal(m, int32(556509), v13)
				mBase = m.M
				v62 = m.ExcPending
				if v62 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(517506), int32(1312), int32(317360))
					mBase = m.M
					v67 = m.ExcPending
					if v67 != 0 {
						return int32(0)
...
func F_coerce_function_result_tuple(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != int32(1) {
		...
		if v61 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = int32(base.Ui32(v62) >> (uint(int32(2)) % 32))
			...
			if v76 != 0 {
				...
				v78 = F_convert_tuples_by_position(m, v75, l1, int32(387383))
				mBase = m.M
				v79 = m.ExcPending
				if v79 != 0 {
					return
		...
		if v14&int32(254) != int32(2) {
			...
			if v20 != 0 {
				v23 = v20
				v25 = F_convert_tuples_by_position(m, v23, l1, int32(387383))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return
