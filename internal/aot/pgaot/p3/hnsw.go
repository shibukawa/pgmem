...
L278:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v34)+48)) = v1107 + int32(4)
	F_errmsg_internal(m, int32(716224), v34+int32(48))
	mBase = m.M
	v1115 = m.ExcPending
	if v1115 != 0 {
		goto L5
...
L279:
	;
	F_errfinish(m, int32(503683), int32(325), int32(321427))
	mBase = m.M
	v1120 = m.ExcPending
	if v1120 != 0 {
		goto L5
...
L285:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v34))) = v1142 + int32(4)
	F_errmsg_internal(m, int32(716224), v34)
	mBase = m.M
	v1148 = m.ExcPending
	if v1148 != 0 {
		goto L5
...
L286:
	;
	F_errfinish(m, int32(503683), int32(320), int32(321427))
	mBase = m.M
	v1153 = m.ExcPending
	if v1153 != 0 {
		goto L5
...
L317:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v34)+16)) = v1239 + int32(4)
	F_errmsg_internal(m, int32(716224), v34+int32(16))
	mBase = m.M
	v1247 = m.ExcPending
	if v1247 != 0 {
		goto L5
...
L318:
	;
	F_errfinish(m, int32(503683), int32(317), int32(321427))
	mBase = m.M
	v1252 = m.ExcPending
	if v1252 != 0 {
		goto L5
...
L320:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v34)+32)) = v1257 + int32(4)
	F_errmsg_internal(m, int32(716224), v34+int32(32))
	mBase = m.M
	v1265 = m.ExcPending
	if v1265 != 0 {
		goto L5
...
L321:
	;
	F_errfinish(m, int32(503683), int32(328), int32(321427))
	mBase = m.M
	v1270 = m.ExcPending
	if v1270 != 0 {
		goto L5
...
func F_HnswSharedMemoryAlloc(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if base.Ui32(v8) < base.Ui32(int32(1048577)) {
		...
		if v16 != 0 {
			...
			if base.Ui32(v18) < base.Ui32(v13) {
				...
				if v41 != 0 {
					...
					F_errmsg_internal(m, int32(13946), int32(0))
					mBase = m.M
					v45 = m.ExcPending
					if v45 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(511686), int32(673), int32(499341))
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return int32(0)
		...
		if v28 != 0 {
			...
			F_errmsg_internal(m, int32(409314), int32(0))
			mBase = m.M
			v32 = m.ExcPending
			if v32 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(511686), int32(669), int32(499341))
				mBase = m.M
				v37 = m.ExcPending
				if v37 != 0 {
					return int32(0)
