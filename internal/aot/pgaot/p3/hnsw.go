...
func F_HnswBuildAppendPage(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v7 != 0 {
		...
		if v6 < int32(0) {
			...
			v19 = *(*int32)(unsafe.Add(mBase, _consts[7]))
		...
		if v33 != 0 {
			...
			if v36 != 0 {
				...
				if v39 != 0 {
					...
					v41 = *(*int32)(unsafe.Add(mBase, _consts[8]))
					if v41 != 0 {
						...
						if v43 != 0 {
							...
							if v46 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(l1))) = v6
								if v6 < int32(0) {
									v51 = *(*int32)(unsafe.Add(mBase, _consts[9]))
								...
								*(*int32)(unsafe.Add(mBase, uint32(l2))) = v65
								F_PageInit(m, v65, int32(8192), int32(8))
								mBase = m.M
...
L41:
	;
	v170 = *(*int32)(unsafe.Add(mBase, _consts[10]))
	v181 = int32(0)
...
L87:
	;
	v295 = *(*int32)(unsafe.Add(mBase, _consts[9]))
...
L89:
	;
	v303 = *(*int32)(unsafe.Add(mBase, _consts[10]))
...
L147:
	;
	v568 = *(*int32)(unsafe.Add(mBase, _consts[9]))
...
L149:
	;
	v577 = *(*int32)(unsafe.Add(mBase, _consts[10]))
	v588 = int32(0)
...
L169:
	;
	if base.Ui32(v524) < base.Ui32(int32(8157)) {
		goto L167
	} else {
		goto L210
	}
L170:
	;
	v623 = int32(base.Ui32(v615+int32(262120))>>(uint(int32(2))%32)) & int32(65535)
	if v623 == int32(0) {
		v795 = v604
		goto L169
	} else {
...
L172:
	;
	v666 = v634&int32(65535)<<(uint(int32(2))%32) + (v589 + int32(24)) - int32(4)
	v667 = *(*int32)(unsafe.Add(mBase, uint32(v666)))
	v670 = v589 + v667&int32(32767)
...
L174:
	;
	v778 = v634 + int32(1)
	if base.Ui32(v778&int32(65535)) <= base.Ui32(v623) {
		v634 = v778
		v642 = v772
		goto L172
	} else {
...
L178:
	;
	v680 = *(*int32)(unsafe.Add(mBase, _consts[6]))
...
L180:
	;
	v688 = *(*int32)(unsafe.Add(mBase, _consts[7]))
...
L187:
	;
	v713 = *(*int32)(unsafe.Add(mBase, _consts[9]))
...
L189:
	;
	v721 = *(*int32)(unsafe.Add(mBase, _consts[10]))
	v727 = v704
...
L225:
	;
	v839 = *(*int32)(unsafe.Add(mBase, _consts[9]))
...
L227:
	;
	v847 = *(*int32)(unsafe.Add(mBase, _consts[10]))
...
L258:
	;
	v1030 = *(*int32)(unsafe.Add(mBase, _consts[6]))
...
L260:
	;
	v1038 = *(*int32)(unsafe.Add(mBase, _consts[7]))
...
L261:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v70)+84)) = v1066
	if base.Ui32(int32(2048)) <= base.Ui32((v1001-int32(1))&int32(65535)) {
		goto L267
	} else {
		goto L268
	}
L262:
	;
	v1051 = *(*int32)(unsafe.Add(mBase, _consts[6]))
...
L264:
	;
	v1059 = *(*int32)(unsafe.Add(mBase, _consts[7]))
...
L269:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v373)+64)) = uint16(v1126)
	v1130 = F_PageIndexTupleOverwrite(m, v999, v1001&int32(65535), v373, v372)
	mBase = m.M
	v1131 = m.ExcPending
	if v1131 != 0 {
		goto L5
...
L270:
	;
	v1082 = int32(base.Ui32(v1074+int32(262120)) >> (uint(int32(2)) % 32))
	goto L272
L271:
	;
	v1082 = int32(0)
...
L278:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v34)+48)) = v1107 + int32(4)
	F_errmsg_internal(m, int32(736124), v34+int32(48))
	mBase = m.M
	v1115 = m.ExcPending
	if v1115 != 0 {
		goto L5
...
L279:
	;
	F_errfinish(m, int32(516488), int32(325), int32(330246))
	mBase = m.M
	v1120 = m.ExcPending
	if v1120 != 0 {
		goto L5
...
L285:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v34))) = v1142 + int32(4)
	F_errmsg_internal(m, int32(736124), v34)
	mBase = m.M
	v1148 = m.ExcPending
	if v1148 != 0 {
		goto L5
...
L286:
	;
	F_errfinish(m, int32(516488), int32(320), int32(330246))
	mBase = m.M
	v1153 = m.ExcPending
	if v1153 != 0 {
		goto L5
...
L317:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v34)+16)) = v1239 + int32(4)
	F_errmsg_internal(m, int32(736124), v34+int32(16))
	mBase = m.M
	v1247 = m.ExcPending
	if v1247 != 0 {
		goto L5
...
L318:
	;
	F_errfinish(m, int32(516488), int32(317), int32(330246))
	mBase = m.M
	v1252 = m.ExcPending
	if v1252 != 0 {
		goto L5
...
L320:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v34)+32)) = v1257 + int32(4)
	F_errmsg_internal(m, int32(736124), v34+int32(32))
	mBase = m.M
	v1265 = m.ExcPending
	if v1265 != 0 {
		goto L5
...
L321:
	;
	F_errfinish(m, int32(516488), int32(328), int32(330246))
	mBase = m.M
	v1270 = m.ExcPending
	if v1270 != 0 {
		goto L5
...
func F_HnswSharedMemoryAlloc(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if base.Ui32(v8) < base.Ui32(int32(1048577)) {
		...
		if v16 != 0 {
			...
			if base.Ui32(v18) < base.Ui32(v13) {
				...
				if v41 != 0 {
					...
					F_errmsg_internal(m, int32(14038), int32(0))
					mBase = m.M
					v45 = m.ExcPending
					if v45 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(524692), int32(673), int32(512115))
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return int32(0)
		...
		if v28 != 0 {
			...
			F_errmsg_internal(m, int32(419743), int32(0))
			mBase = m.M
			v32 = m.ExcPending
			if v32 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(524692), int32(669), int32(512115))
				mBase = m.M
				v37 = m.ExcPending
				if v37 != 0 {
					return int32(0)
