...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v119
	F_errmsg_internal(m, int32(437182), v10)
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L13
...
L27:
	;
	F_errfinish(m, int32(486429), int32(822), int32(418156))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L13
...
L6:
	;
	F_TupleDescInitEntry(m, v28, int32(1), int32(375240), int32(25), int32(-1), int32(0))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
L7:
	;
	F_TupleDescInitEntry(m, v28, int32(2), int32(322981), int32(25), int32(-1), int32(0))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L4
...
L8:
	;
	F_TupleDescInitEntry(m, v28, int32(3), int32(98189), int32(25), int32(-1), int32(0))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L10:
	;
	F_TupleDescInitEntry(m, v28, int32(5), int32(479842), int32(25), int32(-1), int32(0))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L4
...
L11:
	;
	F_TupleDescInitEntry(m, v28, int32(6), int32(479853), int32(25), int32(-1), int32(0))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L4
...
L13:
	;
	F_TupleDescInitEntry(m, v28, int32(8), int32(359529), int32(25), int32(-1), int32(0))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L4
...
L14:
	;
	F_TupleDescInitEntry(m, v28, int32(9), int32(407332), int32(25), int32(-1), int32(0))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L4
...
L15:
	;
	F_TupleDescInitEntry(m, v28, int32(10), int32(304414), int32(25), int32(-1), int32(0))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L4
...
L16:
	;
	F_TupleDescInitEntry(m, v28, int32(11), int32(304387), int32(25), int32(-1), int32(0))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L4
...
L17:
	;
	F_TupleDescInitEntry(m, v28, int32(12), int32(150715), int32(1009), int32(-1), int32(0))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L4
...
L18:
	;
	F_TupleDescInitEntry(m, v28, int32(13), int32(304395), int32(25), int32(-1), int32(0))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L4
...
L19:
	;
	F_TupleDescInitEntry(m, v28, int32(14), int32(304404), int32(25), int32(-1), int32(0))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L4
...
L20:
	;
	F_TupleDescInitEntry(m, v28, int32(15), int32(379433), int32(25), int32(-1), int32(0))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L4
...
L21:
	;
	F_TupleDescInitEntry(m, v28, int32(16), int32(366903), int32(23), int32(-1), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L4
...
L22:
	;
	F_TupleDescInitEntry(m, v28, int32(17), int32(80861), int32(16), int32(-1), int32(0))
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L4
...
L46:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+180)) = int64(0)
	v428 = F_config_enum_get_options(m, v184, int32(664053), int32(6887), int32(704332))
	mBase = m.M
	v429 = m.ExcPending
	if v429 != 0 {
		goto L4
...
L48:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v12)+128)) = v343
	v351 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(332241), v12+int32(128))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L4
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v281
	v289 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(479600), v12-int32(-64))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L4
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v296
	v304 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(479600), v12+int32(48))
	mBase = m.M
	v305 = m.ExcPending
	if v305 != 0 {
		goto L4
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v313
	v321 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(479600), v12+int32(32))
	mBase = m.M
	v322 = m.ExcPending
	if v322 != 0 {
		goto L4
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v328
	v336 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(479600), v12+int32(16))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L4
...
L68:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v12)+112)) = v358
	v366 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(332241), v12+int32(112))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L4
...
L70:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v12)+96)) = v375
	v383 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(332241), v12+int32(96))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L4
...
L72:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v12)+80)) = v390
	v398 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(332241), v12+int32(80))
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L4
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v462
	v468 = F_pg_snprintf(m, v12+int32(224), int32(256), int32(479600), v12)
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L4
