	...
	if v13 != 0 {
		...
		if v14 != int32(1) {
			...
			if v42 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(344565)
				F_errmsg_internal(m, int32(26727), v7)
				mBase = m.M
				v49 = m.ExcPending
				if v49 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(518640), int32(2938), int32(25215))
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = int32(393377)
	F_errmsg_internal(m, int32(26727), v22+int32(16))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L1
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = int32(393377)
	F_errmsg_internal(m, int32(26727), v22)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
	...
	if v12 != 0 {
		...
		if v13 != int32(1) {
			...
			if v40 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(27675)
				F_errmsg_internal(m, int32(26727), v6)
				mBase = m.M
				v47 = m.ExcPending
				if v47 != 0 {
					return int32(0)
	...
	if v13 != 0 {
		...
		if v14 != int32(1) {
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = int32(3)
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(247023)
				F_errmsg_internal(m, int32(26727), v7)
				mBase = m.M
				v50 = m.ExcPending
				if v50 != 0 {
	...
	if v13 != 0 {
		...
		if v14 != int32(1) {
			...
			if v45 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = int32(3)
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(250005)
				F_errmsg_internal(m, int32(26727), v7)
				mBase = m.M
				v52 = m.ExcPending
				if v52 != 0 {
...
func F_float8_to_char(m *base.Module, l0 int32) int32 {
	...
	if v22 != 0 {
		...
		if base.Ui32(int32(268435454)) <= base.Ui32(v53-int32(1)) {
			v59 = F_cstring_to_text(m, int32(794587))
			mBase = m.M
			v60 = m.ExcPending
			if v60 != 0 {
				return int32(0)
						...
						if v73&int32(16384) != 0 {
							...
							if base.B2i32(base.Ui64(base.I64_reinterpret_f64(v102)) <= base.Ui64(int64(9218868437227405312)))&base.F64_ne(v102, math.Float64frombits(uint64(0x7ff0000000000000))) == int32(0) {
								...
								*(*float64)(unsafe.Add(mBase, uint32(v14)+40)) = v17
								v138 = F_psprintf(m, int32(441716), v14+int32(32))
								mBase = m.M
								v139 = m.ExcPending
								if v139 != 0 {
									return int32(0)
							...
							*(*float64)(unsafe.Add(mBase, uint32(v14)+16)) = base.F64_abs(v156)
							v162 = F_psprintf(m, int32(358225), v14+int32(16))
							mBase = m.M
							v163 = m.ExcPending
							if v163 != 0 {
								return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v14))) = v175
								v179 = F_psprintf(m, int32(358230), v14)
								mBase = m.M
								v180 = m.ExcPending
								if v180 != 0 {
									return int32(0)
