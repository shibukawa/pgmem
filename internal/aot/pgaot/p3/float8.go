	...
	if v13 != 0 {
		...
		if v14 != int32(1) {
			...
			if v42 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(306469)
				F_errmsg_internal(m, int32(23974), v7)
				mBase = m.M
				v49 = m.ExcPending
				if v49 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(463209), int32(2938), int32(22514))
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = int32(351284)
	F_errmsg_internal(m, int32(23974), v22+int32(16))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L1
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = int32(351284)
	F_errmsg_internal(m, int32(23974), v22)
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
	...
	if v12 != 0 {
		...
		if v13 != int32(1) {
			...
			if v40 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(24861)
				F_errmsg_internal(m, int32(23974), v6)
				mBase = m.M
				v47 = m.ExcPending
				if v47 != 0 {
					return int32(0)
	...
	if v13 != 0 {
		...
		if v14 != int32(1) {
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = int32(3)
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(220423)
				F_errmsg_internal(m, int32(23974), v7)
				mBase = m.M
				v50 = m.ExcPending
				if v50 != 0 {
	...
	if v13 != 0 {
		...
		if v14 != int32(1) {
			...
			if v45 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = int32(3)
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(222673)
				F_errmsg_internal(m, int32(23974), v7)
				mBase = m.M
				v52 = m.ExcPending
				if v52 != 0 {
...
L44:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v14)+40)) = v17
	v138 = F_psprintf(m, int32(394343), v14+int32(32))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L3
...
L53:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v14)+16)) = base.F64_abs(v156)
	v162 = F_psprintf(m, int32(318907), v14+int32(16))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L3
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v231
	v235 = F_psprintf(m, int32(318912), v14)
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L3
