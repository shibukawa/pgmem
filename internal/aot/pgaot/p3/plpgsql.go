...
L16:
	;
	v130 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_call_handler[0]))
	v132 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_call_handler[1]))
	goto L20
L17:
	;
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+60)) = v43
	*(*uint8)(unsafe.Add(mBase, uint32(v20)+51)) = uint8(v75)
	v125 = F_ResourceOwnerCreate(m, int32(0), int32(_a_F_plpgsql_call_handler_0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		v376 = v46
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_call_handler[0])) = v144
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_call_handler[1])) = v143
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_call_handler[1])) = v140
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v324
	F_errmsg_internal(m, int32(_a_F_plpgsql_call_handler_2), v20)
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		v376 = v152
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+400)) = int32(_a_F_plpgsql_compile_callback_0)
	v66 = int32(_a_F_plpgsql_compile_callback_1)
	v67 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[3]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+404)) = v22 + int32(408)
	v77 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[4]))
	v82 = F_AllocSetContextCreateInternal(m, v77, int32(_a_F_plpgsql_compile_callback_2), int32(0), int32(_a_F_plpgsql_compile_callback_3), int32(_a_F_plpgsql_compile_callback_4))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L10
...
L18:
	;
	v85 = int32(_a_F_plpgsql_compile_callback_5)
	v86 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[5])) = v86
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[4])) = v82
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l3)+44)) = v99
	v105 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[6]))
	*(*int32)(unsafe.Add(mBase, uint32(l3)+488)) = v105
	v108 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[7])))
	*(*uint8)(unsafe.Add(mBase, uint32(l3)+492)) = uint8(v108)
	v111 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[8]))
	if v5 != 0 {
		goto L21
	} else {
		goto L22
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l3)+496)) = v113
	v116 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[9]))
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[10])) = v122
	goto L27
L27:
	;
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[11])) = int32(128)
	v137 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[12])) = uint8(v137)
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13])) = v137
	v143 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[5]))
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[15])) = v145
...
L30:
	;
	F_errstart_cold(m, int32(21), int32(_a_F_plpgsql_compile_callback_6))
	mBase = m.M
	v1727 = m.ExcPending
	if v1727 != 0 {
		goto L10
...
L53:
	;
	switch v489 - int32(_a_F_plpgsql_compile_callback_7) {
	case 0:
		v1208 = v509
		goto L35
	default:
...
L59:
	;
	v155 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[5]))
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[4])) = v155
...
L60:
	...
	v170 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[0]))
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+144)) = v216
	v224 = F_pg_snprintf(m, v22+int32(352), int32(32), int32(_a_F_plpgsql_compile_callback_8), v22+int32(144))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L10
...
L86:
	;
	if int32(1)<<(uint(v255)%32)&int32(_a_F_plpgsql_compile_callback_9) == int32(0) {
		v271 = v196
		goto L85
	} else {
		goto L87
...
L92:
	;
	if int32(1)<<(uint(v255)%32)&int32(_a_F_plpgsql_compile_callback_10) == int32(0) {
		v289 = v194
		goto L91
	} else {
		goto L93
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v318)+8)) = int32(_a_F_plpgsql_compile_callback_11)
...
L112:
	;
	v419 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[15]))
	v421 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13]))
	v423 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[11]))
	if v421 == v423 {
		goto L123
	} else {
		goto L124
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v371
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_12), v22+int32(48))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L10
...
L118:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(1879), int32(_a_F_plpgsql_compile_callback_14))
	mBase = m.M
	v382 = m.ExcPending
	if v382 != 0 {
		goto L10
...
L123:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[11])) = v421 << (uint(int32(1)) % 32)
...
L125:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13])) = v437 + int32(1)
...
L126:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[15])) = v432
	v436 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13]))
	v437 = v436
	v438 = v432
	goto L125
L127:
...
L130:
	;
	if base.Ui32(v489-int32(_a_F_plpgsql_compile_callback_15)) < base.Ui32(int32(4)) {
		goto L127
	} else {
		goto L134
	}
...
L134:
	;
	if base.Ui32(v489-int32(_a_F_plpgsql_compile_callback_16)) < base.Ui32(int32(2)) {
		goto L127
	} else {
		goto L135
	}
...
L137:
	;
	v509 = int32(1007)
	if int32(_a_F_plpgsql_compile_callback_15) < v489 {
		goto L53
	} else {
		goto L140
	}
...
L142:
	;
	if v489 != int32(_a_F_plpgsql_compile_callback_16) {
		goto L36
	} else {
		goto L143
	}
L143:
	;
	v1208 = int32(_a_F_plpgsql_compile_callback_17)
	goto L35
L144:
	;
	if v520 != 0 {
...
L147:
	;
	v530 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v22)+128)) = v530
	F_errmsg(m, int32(_a_F_plpgsql_compile_callback_18), v22+int32(128))
	mBase = m.M
	v536 = m.ExcPending
	if v536 != 0 {
		goto L10
...
L148:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(423), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v541 = m.ExcPending
	if v541 != 0 {
		goto L10
...
L151:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v548))) = int32(2)
	v553 = F_pstrdup(m, int32(_a_F_plpgsql_compile_callback_20))
	mBase = m.M
	v554 = m.ExcPending
	if v554 != 0 {
		goto L10
...
L152:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v548)+8)) = v553
	v563 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[15]))
	v565 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13]))
	v567 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[11]))
	if v565 == v567 {
		goto L153
	} else {
		goto L154
...
L153:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[11])) = v565 << (uint(int32(1)) % 32)
...
L155:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13])) = v582 + int32(1)
	v590 = int32(2)
...
L156:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[15])) = v576
	v579 = *(*int32)(unsafe.Add(mBase, uint32(v548)+8))
	v581 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13]))
	v582 = v581
	v583 = v579
	v584 = v576
	goto L155
...
L158:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v600))) = int32(2)
	v605 = F_pstrdup(m, int32(_a_F_plpgsql_compile_callback_21))
	mBase = m.M
	v606 = m.ExcPending
	if v606 != 0 {
		goto L10
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v600)+8)) = v605
	v615 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[15]))
	v617 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13]))
	v619 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[11]))
	if v617 == v619 {
		goto L160
	} else {
		goto L161
...
L160:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[11])) = v617 << (uint(int32(1)) % 32)
...
L162:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13])) = v634 + int32(1)
	v642 = int32(2)
...
L163:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[15])) = v628
	v631 = *(*int32)(unsafe.Add(mBase, uint32(v600)+8))
	v633 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13]))
	v634 = v633
	v635 = v631
	v636 = v628
	goto L162
...
L168:
	;
	v667 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_22), int32(0), v660, int32(1))
	mBase = m.M
	v668 = m.ExcPending
	if v668 != 0 {
		goto L10
...
L173:
	;
	v689 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_23), int32(0), v682, int32(1))
	mBase = m.M
	v690 = m.ExcPending
	if v690 != 0 {
		goto L10
...
L178:
	;
	v711 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_24), int32(0), v704, int32(1))
	mBase = m.M
	v712 = m.ExcPending
	if v712 != 0 {
		goto L10
...
L183:
	;
	v733 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_25), int32(0), v726, int32(1))
	mBase = m.M
	v734 = m.ExcPending
	if v734 != 0 {
		goto L10
...
L188:
	;
	v755 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_26), int32(0), v748, int32(1))
	mBase = m.M
	v756 = m.ExcPending
	if v756 != 0 {
		goto L10
...
L193:
	;
	v777 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_27), int32(0), v770, int32(1))
	mBase = m.M
	v778 = m.ExcPending
	if v778 != 0 {
		goto L10
...
L198:
	;
	v799 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_28), int32(0), v792, int32(1))
	mBase = m.M
	v800 = m.ExcPending
	if v800 != 0 {
		goto L10
...
L203:
	;
	v821 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_29), int32(0), v814, int32(1))
	mBase = m.M
	v822 = m.ExcPending
	if v822 != 0 {
		goto L10
...
L208:
	;
	v844 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_30), int32(0), v837, int32(1))
	mBase = m.M
	v845 = m.ExcPending
	if v845 != 0 {
		goto L10
...
L213:
	;
	v866 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_31), int32(0), v859, int32(1))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		goto L10
...
L219:
	;
	v893 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_32), int32(0), v886, int32(1))
	mBase = m.M
	v894 = m.ExcPending
	if v894 != 0 {
		goto L10
...
L224:
	;
	v915 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_33), int32(0), v908, int32(1))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L10
...
L226:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v209
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(16))
	mBase = m.M
	v936 = m.ExcPending
	if v936 != 0 {
		goto L10
...
L227:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(1960), int32(_a_F_plpgsql_compile_callback_35))
	mBase = m.M
	v941 = m.ExcPending
	if v941 != 0 {
		goto L10
...
L232:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(330), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L10
...
L237:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(496), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v983 = m.ExcPending
	if v983 != 0 {
		goto L10
...
L239:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+160)) = int32(19)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(160))
	mBase = m.M
	v994 = m.ExcPending
	if v994 != 0 {
		goto L10
...
L242:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+176)) = int32(25)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(176))
	mBase = m.M
	v1010 = m.ExcPending
	if v1010 != 0 {
		goto L10
...
L245:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+192)) = int32(25)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(192))
	mBase = m.M
	v1026 = m.ExcPending
	if v1026 != 0 {
		goto L10
...
L248:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+208)) = int32(25)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(208))
	mBase = m.M
	v1042 = m.ExcPending
	if v1042 != 0 {
		goto L10
...
L251:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+224)) = int32(26)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(224))
	mBase = m.M
	v1058 = m.ExcPending
	if v1058 != 0 {
		goto L10
...
L254:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+240)) = int32(19)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(240))
	mBase = m.M
	v1074 = m.ExcPending
	if v1074 != 0 {
		goto L10
...
L257:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+256)) = int32(19)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(256))
	mBase = m.M
	v1090 = m.ExcPending
	if v1090 != 0 {
		goto L10
...
L260:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+272)) = int32(19)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(272))
	mBase = m.M
	v1106 = m.ExcPending
	if v1106 != 0 {
		goto L10
...
L263:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+288)) = int32(23)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(288))
	mBase = m.M
	v1122 = m.ExcPending
	if v1122 != 0 {
		goto L10
...
L266:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+304)) = int32(1009)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(304))
	mBase = m.M
	v1138 = m.ExcPending
	if v1138 != 0 {
		goto L10
...
L271:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(629), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v1159 = m.ExcPending
	if v1159 != 0 {
		goto L10
...
L273:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+320)) = int32(25)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(320))
	mBase = m.M
	v1170 = m.ExcPending
	if v1170 != 0 {
		goto L10
...
L276:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+336)) = int32(25)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(336))
	mBase = m.M
	v1186 = m.ExcPending
	if v1186 != 0 {
		goto L10
...
L280:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(657), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v1205 = m.ExcPending
	if v1205 != 0 {
		goto L10
...
L292:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(456), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v1248 = m.ExcPending
	if v1248 != 0 {
		goto L10
...
L297:
	;
	if v1260 != int32(_a_F_plpgsql_compile_callback_42) {
		goto L295
	} else {
		goto L307
	}
...
L300:
	;
	if base.Ui32(v1260-int32(_a_F_plpgsql_compile_callback_15)) < base.Ui32(int32(4)) {
		goto L296
	} else {
		goto L304
	}
...
L305:
	;
	if v1260 == int32(_a_F_plpgsql_compile_callback_16) {
		goto L296
	} else {
		goto L306
	}
...
L309:
	;
	v1287 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_43), v1280, v1284, int32(1))
	mBase = m.M
	v1288 = m.ExcPending
	if v1288 != 0 {
		goto L10
...
L315:
	;
	v1333 = F_plpgsql_build_variable(m, int32(_a_F_plpgsql_compile_callback_44), int32(0), v1326, int32(1))
	mBase = m.M
	v1334 = m.ExcPending
	if v1334 != 0 {
		goto L10
...
L327:
	;
	v1487 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13]))
...
L332:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1360+v1406))) = v1409
	v1412 = v1370 + v1393
	v1414 = v1377 + v1393
	if v1414 != v1353&int32(_a_F_plpgsql_compile_callback_45) {
		v1370 = v1412
		v1377 = v1414
		goto L332
	} else {
...
L339:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l3)+508)) = v1491
	v1495 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[13]))
	if v1495 <= int32(0) {
		goto L341
	} else {
		goto L342
...
L343:
	;
	v1499 = int32(1)
	v1502 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[15]))
	if v1495 == v1499 {
		goto L345
	} else {
		goto L346
...
L362:
	;
	v1618 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[12])))
	if v1618 == int32(1) {
		goto L364
	} else {
		goto L365
...
L366:
	;
	v1624 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[16]))
...
L368:
	;
	v1659 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[0])) = v1659
	*(*uint8)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[1])) = uint8(v1659)
	v1665 = *(*int32)(unsafe.Add(mBase, uint32(v22)+396))
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[3])) = v1665
	v1667 = int32(_a_F_plpgsql_compile_callback_46)
	v1668 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[5]))
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[5])) = v1659
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_callback[4])) = v1668
	m.G0 = v22 + int32(416)
	return
L369:
	;
...
L385:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v1208
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22-int32(-64))
	mBase = m.M
	v1686 = m.ExcPending
	if v1686 != 0 {
		goto L10
...
L386:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(438), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v1691 = m.ExcPending
	if v1691 != 0 {
		goto L10
...
L390:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(451), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v1707 = m.ExcPending
	if v1707 != 0 {
		goto L10
...
L392:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+96)) = int32(16)
	F_errmsg_internal(m, int32(_a_F_plpgsql_compile_callback_34), v22+int32(96))
	mBase = m.M
	v1718 = m.ExcPending
	if v1718 != 0 {
		goto L10
...
L396:
	;
	F_errfinish(m, int32(_a_F_plpgsql_compile_callback_13), int32(680), int32(_a_F_plpgsql_compile_callback_19))
	mBase = m.M
	v1738 = m.ExcPending
	if v1738 != 0 {
		goto L10
																	...
																	if v151 != 0 {
																		...
																		*(*int32)(unsafe.Add(mBase, uint32(v43)+508)) = v150
																		...
																		if v154 <= int32(0) {
																			...
																			v157 = int32(1)
																			v160 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_inline[14]))
																			if v154 == v157 {
																				v209 = int32(0)
																				v210 = v142
																			} else {
																		...
																		*(*int32)(unsafe.Add(mBase, uint32(v43)+512)) = v234
																		...
																		if v243 == int32(1) {
																			...
																			if v247 != 0 {
																				...
																				v249 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_plpgsql_compile_inline[11])))
																				if v249 == int32(1) {
																					...
																					if v253 != 0 {
																						...
																						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_inline[3])) = v255
																						v258 = int32(0)
																						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_inline[0])) = v258
																						*(*uint8)(unsafe.Add(mBase, _c_F_plpgsql_compile_inline[2])) = uint8(v258)
																						v263 = int32(_a_F_plpgsql_compile_inline_13)
																						v264 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_inline[6]))
																						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_inline[6])) = v258
																						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_inline[5])) = v264
																						m.G0 = v14 + int32(48)
																						return v43
																					}
																				} else {
...
func F_plpgsql_param_ref(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v15
	v21 = F_pg_snprintf(m, v12+int32(16), int32(32), int32(_a_F_plpgsql_param_ref_0), v12)
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L1
...
L40:
	...
	v180 = int32(_a_F_plpgsql_param_ref_1)
	v181 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_param_ref[0]))
	v182 = *(*int32)(unsafe.Add(mBase, uint32(v171)+48))
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_param_ref[0])) = v182
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_param_ref[0])) = v181
...
func F_plpgsql_parse_err_condition(m *base.Module, l0 int32) int32 {
	...
	v9 = v7 - int32(16)
	m.G0 = v9
	v12 = int32(_a_F_plpgsql_parse_err_condition_0)
	v16 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_plpgsql_parse_err_condition[0])))
...
L10:
	;
	v44 = int32(_a_F_plpgsql_parse_err_condition_1)
	v45 = v2
	v47 = int32(_a_F_plpgsql_parse_err_condition_2)
	v48 = v2
	goto L13
L11:
	;
...
L25:
	...
	v93 = *(*int32)(unsafe.Add(mBase, uint32(v90)+uint32(_c_F_plpgsql_parse_err_condition[1])))
	if v93 != 0 {
		v44 = v93
		v45 = v86
		v47 = v90 + int32(_a_F_plpgsql_parse_err_condition_2)
		v48 = v88
		goto L13
	} else {
		goto L28
...
L29:
	;
	F_errstart_cold(m, int32(21), int32(_a_F_plpgsql_parse_err_condition_3))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L26
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
	F_errmsg(m, int32(_a_F_plpgsql_parse_err_condition_4), v9)
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L26
...
L32:
	;
	F_errfinish(m, int32(_a_F_plpgsql_parse_err_condition_5), int32(2190), int32(_a_F_plpgsql_parse_err_condition_6))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L26
