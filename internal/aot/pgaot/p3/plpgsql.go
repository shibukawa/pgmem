			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
				...
				if v25 != 0 {
					...
					F_errfinish(m, int32(515496), int32(1960), int32(381126))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+60)) = v43
	*(*uint8)(unsafe.Add(mBase, uint32(v20)+51)) = uint8(v75)
	v125 = F_ResourceOwnerCreate(m, int32(0), int32(180097))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		v376 = v46
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v324
	F_errmsg_internal(m, int32(212954), v20)
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		v376 = v152
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+60)) = v139
	*(*uint8)(unsafe.Add(mBase, uint32(v20)+51)) = uint8(v290)
	F_errfinish(m, int32(514987), int32(302), int32(228865))
	mBase = m.M
	v361 = m.ExcPending
	if v361 != 0 {
		v376 = v152
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+400)) = int32(7207)
	v66 = int32(4541672)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+404)) = v22 + int32(408)
	...
	v82 = F_AllocSetContextCreateInternal(m, v77, int32(264618), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L10
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+144)) = v216
	v224 = F_pg_snprintf(m, v22+int32(352), int32(32), int32(484674), v22+int32(144))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L10
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v318)+8)) = int32(695218)
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v371
	F_errmsg_internal(m, int32(502587), v22+int32(48))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L10
...
L118:
	;
	F_errfinish(m, int32(515496), int32(1879), int32(143498))
	mBase = m.M
	v382 = m.ExcPending
	if v382 != 0 {
		goto L10
...
L147:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+128)) = v530
	F_errmsg(m, int32(731422), v22+int32(128))
	mBase = m.M
	v536 = m.ExcPending
	if v536 != 0 {
		goto L10
...
L148:
	;
	F_errfinish(m, int32(515496), int32(423), int32(331451))
	mBase = m.M
	v541 = m.ExcPending
	if v541 != 0 {
		goto L10
...
L168:
	;
	v667 = F_plpgsql_build_variable(m, int32(394306), int32(0), v660, int32(1))
	mBase = m.M
	v668 = m.ExcPending
	if v668 != 0 {
		goto L10
...
L173:
	;
	v689 = F_plpgsql_build_variable(m, int32(293452), int32(0), v682, int32(1))
	mBase = m.M
	v690 = m.ExcPending
	if v690 != 0 {
		goto L10
...
L178:
	;
	v711 = F_plpgsql_build_variable(m, int32(317992), int32(0), v704, int32(1))
	mBase = m.M
	v712 = m.ExcPending
	if v712 != 0 {
		goto L10
...
L183:
	;
	v733 = F_plpgsql_build_variable(m, int32(245196), int32(0), v726, int32(1))
	mBase = m.M
	v734 = m.ExcPending
	if v734 != 0 {
		goto L10
...
L188:
	;
	v755 = F_plpgsql_build_variable(m, int32(452005), int32(0), v748, int32(1))
	mBase = m.M
	v756 = m.ExcPending
	if v756 != 0 {
		goto L10
...
L193:
	;
	v777 = F_plpgsql_build_variable(m, int32(392932), int32(0), v770, int32(1))
	mBase = m.M
	v778 = m.ExcPending
	if v778 != 0 {
		goto L10
...
L198:
	;
	v799 = F_plpgsql_build_variable(m, int32(395146), int32(0), v792, int32(1))
	mBase = m.M
	v800 = m.ExcPending
	if v800 != 0 {
		goto L10
...
L203:
	;
	v821 = F_plpgsql_build_variable(m, int32(527102), int32(0), v814, int32(1))
	mBase = m.M
	v822 = m.ExcPending
	if v822 != 0 {
		goto L10
...
L208:
	;
	v844 = F_plpgsql_build_variable(m, int32(163474), int32(0), v837, int32(1))
	mBase = m.M
	v845 = m.ExcPending
	if v845 != 0 {
		goto L10
...
L213:
	;
	v866 = F_plpgsql_build_variable(m, int32(36744), int32(0), v859, int32(1))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		goto L10
...
L219:
	;
	v893 = F_plpgsql_build_variable(m, int32(96901), int32(0), v886, int32(1))
	mBase = m.M
	v894 = m.ExcPending
	if v894 != 0 {
		goto L10
...
L224:
	;
	v915 = F_plpgsql_build_variable(m, int32(351612), int32(0), v908, int32(1))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L10
...
L226:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v209
	F_errmsg_internal(m, int32(54588), v22+int32(16))
	mBase = m.M
	v936 = m.ExcPending
	if v936 != 0 {
		goto L10
...
L231:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+32)) = v949
	F_errmsg(m, int32(197490), v22+int32(32))
	mBase = m.M
	v956 = m.ExcPending
	if v956 != 0 {
		goto L10
...
L232:
	;
	F_errfinish(m, int32(515496), int32(330), int32(331451))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L10
...
L235:
	;
	F_errmsg(m, int32(129023), int32(0))
	mBase = m.M
	v974 = m.ExcPending
	if v974 != 0 {
		goto L10
...
L236:
	;
	F_errhint(m, int32(675368), int32(0))
	mBase = m.M
	v978 = m.ExcPending
	if v978 != 0 {
		goto L10
...
L237:
	;
	F_errfinish(m, int32(515496), int32(496), int32(331451))
	mBase = m.M
	v983 = m.ExcPending
	if v983 != 0 {
		goto L10
...
L239:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+160)) = int32(19)
	F_errmsg_internal(m, int32(54588), v22+int32(160))
	mBase = m.M
	v994 = m.ExcPending
	if v994 != 0 {
		goto L10
...
L242:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+176)) = int32(25)
	F_errmsg_internal(m, int32(54588), v22+int32(176))
	mBase = m.M
	v1010 = m.ExcPending
	if v1010 != 0 {
		goto L10
...
L245:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+192)) = int32(25)
	F_errmsg_internal(m, int32(54588), v22+int32(192))
	mBase = m.M
	v1026 = m.ExcPending
	if v1026 != 0 {
		goto L10
...
L248:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+208)) = int32(25)
	F_errmsg_internal(m, int32(54588), v22+int32(208))
	mBase = m.M
	v1042 = m.ExcPending
	if v1042 != 0 {
		goto L10
...
L251:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+224)) = int32(26)
	F_errmsg_internal(m, int32(54588), v22+int32(224))
	mBase = m.M
	v1058 = m.ExcPending
	if v1058 != 0 {
		goto L10
...
L254:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+240)) = int32(19)
	F_errmsg_internal(m, int32(54588), v22+int32(240))
	mBase = m.M
	v1074 = m.ExcPending
	if v1074 != 0 {
		goto L10
...
L257:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+256)) = int32(19)
	F_errmsg_internal(m, int32(54588), v22+int32(256))
	mBase = m.M
	v1090 = m.ExcPending
	if v1090 != 0 {
		goto L10
...
L260:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+272)) = int32(19)
	F_errmsg_internal(m, int32(54588), v22+int32(272))
	mBase = m.M
	v1106 = m.ExcPending
	if v1106 != 0 {
		goto L10
...
L263:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+288)) = int32(23)
	F_errmsg_internal(m, int32(54588), v22+int32(288))
	mBase = m.M
	v1122 = m.ExcPending
	if v1122 != 0 {
		goto L10
...
L266:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+304)) = int32(1009)
	F_errmsg_internal(m, int32(54588), v22+int32(304))
	mBase = m.M
	v1138 = m.ExcPending
	if v1138 != 0 {
		goto L10
...
L270:
	;
	F_errmsg(m, int32(129017), int32(0))
	mBase = m.M
	v1154 = m.ExcPending
	if v1154 != 0 {
		goto L10
...
L271:
	;
	F_errfinish(m, int32(515496), int32(629), int32(331451))
	mBase = m.M
	v1159 = m.ExcPending
	if v1159 != 0 {
		goto L10
...
L273:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+320)) = int32(25)
	F_errmsg_internal(m, int32(54588), v22+int32(320))
	mBase = m.M
	v1170 = m.ExcPending
	if v1170 != 0 {
		goto L10
...
L276:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+336)) = int32(25)
	F_errmsg_internal(m, int32(54588), v22+int32(336))
	mBase = m.M
	v1186 = m.ExcPending
	if v1186 != 0 {
		goto L10
...
L279:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v1196
	F_errmsg_internal(m, int32(504995), v22)
	mBase = m.M
	v1200 = m.ExcPending
	if v1200 != 0 {
		goto L10
...
L280:
	;
	F_errfinish(m, int32(515496), int32(657), int32(331451))
	mBase = m.M
	v1205 = m.ExcPending
	if v1205 != 0 {
		goto L10
...
L291:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+80)) = v1236
	F_errmsg(m, int32(200285), v22+int32(80))
	mBase = m.M
	v1243 = m.ExcPending
	if v1243 != 0 {
		goto L10
...
L292:
	;
	F_errfinish(m, int32(515496), int32(456), int32(331451))
	mBase = m.M
	v1248 = m.ExcPending
	if v1248 != 0 {
		goto L10
...
L309:
	;
	v1287 = F_plpgsql_build_variable(m, int32(592150), v1280, v1284, int32(1))
	mBase = m.M
	v1288 = m.ExcPending
	if v1288 != 0 {
		goto L10
...
L315:
	;
	v1333 = F_plpgsql_build_variable(m, int32(440953), int32(0), v1326, int32(1))
	mBase = m.M
	v1334 = m.ExcPending
	if v1334 != 0 {
		goto L10
...
L385:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v1208
	F_errmsg_internal(m, int32(54588), v22-int32(-64))
	mBase = m.M
	v1686 = m.ExcPending
	if v1686 != 0 {
		goto L10
...
L386:
	;
	F_errfinish(m, int32(515496), int32(438), int32(331451))
	mBase = m.M
	v1691 = m.ExcPending
	if v1691 != 0 {
		goto L10
...
L389:
	;
	F_errmsg(m, int32(141965), int32(0))
	mBase = m.M
	v1702 = m.ExcPending
	if v1702 != 0 {
		goto L10
...
L390:
	;
	F_errfinish(m, int32(515496), int32(451), int32(331451))
	mBase = m.M
	v1707 = m.ExcPending
	if v1707 != 0 {
		goto L10
...
L392:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+96)) = int32(16)
	F_errmsg_internal(m, int32(54588), v22+int32(96))
	mBase = m.M
	v1718 = m.ExcPending
	if v1718 != 0 {
		goto L10
...
L395:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+112)) = v1339
	F_errmsg_internal(m, int32(497343), v22+int32(112))
	mBase = m.M
	v1733 = m.ExcPending
	if v1733 != 0 {
		goto L10
...
L396:
	;
	F_errfinish(m, int32(515496), int32(680), int32(331451))
	mBase = m.M
	v1738 = m.ExcPending
	if v1738 != 0 {
		goto L10
...
func F_plpgsql_compile_inline(m *base.Module, l0 int32) int32 {
	...
	if v19 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[1246])) = int32(329037)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(7207)
		v31 = int32(4541672)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v14)+36)) = v14 + int32(40)
		...
		if v44 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[1248])) = v43
			...
			v52 = F_AllocSetContextCreateInternal(m, v47, int32(67032), int32(0), int32(8192), int32(8388608))
			mBase = m.M
			v53 = m.ExcPending
			if v53 != 0 {
				return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, _consts[0])) = v52
				...
				if v62 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _consts[1254])) = v74
					F_plpgsql_ns_push(m, int32(329037), int32(0))
					mBase = m.M
					v87 = m.ExcPending
					if v87 != 0 {
						return int32(0)
								...
								if v115 != 0 {
									...
									if v121 != 0 {
										...
										if v123 != 0 {
											...
											v127 = F_plpgsql_build_variable(m, int32(440953), int32(0), v120, int32(1))
											mBase = m.M
											v128 = m.ExcPending
											if v128 != 0 {
												return int32(0)
													...
													if v133 != 0 {
														...
														if v291 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v133
															F_errmsg_internal(m, int32(497343), v14+int32(16))
															mBase = m.M
															v297 = m.ExcPending
															if v297 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(515496), int32(840), int32(388405))
																mBase = m.M
																v302 = m.ExcPending
																if v302 != 0 {
																	return int32(0)
	...
	default:
		...
		if v54 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v55
			F_errmsg_internal(m, int32(502587), v8)
			mBase = m.M
			v60 = m.ExcPending
			if v60 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(520420), int32(5508), int32(381517))
				mBase = m.M
				v67 = m.ExcPending
				if v67 != 0 {
					return int32(0)
							...
							if v85 != 0 {
								...
								if v88 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v89
									F_errmsg(m, int32(750733), v8+int32(16))
									mBase = m.M
									v98 = m.ExcPending
									if v98 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(520420), int32(5499), int32(381517))
										mBase = m.M
										v105 = m.ExcPending
										if v105 != 0 {
											return int32(0)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+8)) = int32(54)
	...
	case 0:
		...
		if v30 == int32(65535) {
			...
			if v18 != v33 {
				*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(7219)
			} else {
				v35 = *(*int32)(unsafe.Add(mBase, uint32(v23)+32))
				if v35 == int32(0) {
					*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(7219)
				} else {
					*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(7218)
				}
			}
		} else {
			*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(7220)
		}
	default:
		*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(7223)
	case 2:
		*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(7222)
	case 3:
		*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(7221)
	case 4:
...
func F_plpgsql_param_ref(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v15
	v21 = F_pg_snprintf(m, v12+int32(16), int32(32), int32(484674), v12)
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(515496), int32(2190), int32(261042))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L26
	...
	if v15 != 0 {
		...
		if int32(4) <= v17 {
			...
			if v25 != 0 {
				...
				F_errmsg_internal(m, int32(332292), int32(0))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(514957), int32(388), int32(293257))
					mBase = m.M
					v37 = m.ExcPending
					if v37 != 0 {
						return int32(0)
							...
							if v39 != 0 {
								...
								if v42 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = v41
									F_errmsg(m, int32(121792), v10)
									mBase = m.M
									v47 = m.ExcPending
									if v47 != 0 {
										return int32(0)
									} else {
										F_errdetail(m, int32(641756), int32(0))
										mBase = m.M
										v52 = m.ExcPending
										if v52 != 0 {
											return int32(0)
											...
											if v55 != 0 {
												...
												F_errfinish(m, int32(515496), int32(1046), int32(353190))
												mBase = m.M
												v62 = m.ExcPending
												if v62 != 0 {
													return int32(0)
...
L284:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v996
	F_errmsg_internal(m, int32(502676), v11)
	mBase = m.M
	v1001 = m.ExcPending
	if v1001 != 0 {
		goto L32
...
L285:
	;
	F_errfinish(m, int32(514429), int32(595), int32(312892))
	mBase = m.M
	v1008 = m.ExcPending
	if v1008 != 0 {
		goto L32
