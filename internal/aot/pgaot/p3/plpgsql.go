			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
				...
				if v25 != 0 {
					...
					F_errfinish(m, int32(472929), int32(1960), int32(348625))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+60)) = v43
	*(*uint8)(unsafe.Add(mBase, uint32(v20)+51)) = uint8(v75)
	v125 = F_ResourceOwnerCreate(m, int32(0), int32(161486))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		v376 = v46
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v324
	F_errmsg_internal(m, int32(193787), v20)
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		v376 = v152
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+60)) = v139
	*(*uint8)(unsafe.Add(mBase, uint32(v20)+51)) = uint8(v290)
	F_errfinish(m, int32(472493), int32(302), int32(208810))
	mBase = m.M
	v361 = m.ExcPending
	if v361 != 0 {
		v376 = v152
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+400)) = int32(5358)
	v66 = int32(4435896)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+404)) = v22 + int32(408)
	...
	v82 = F_AllocSetContextCreateInternal(m, v77, int32(241740), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L10
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+144)) = v216
	v224 = F_pg_snprintf(m, v22+int32(352), int32(32), int32(445577), v22+int32(144))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L10
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v318)+8)) = int32(629437)
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v371
	F_errmsg_internal(m, int32(461960), v22+int32(48))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L10
...
L118:
	;
	F_errfinish(m, int32(472929), int32(1879), int32(126832))
	mBase = m.M
	v382 = m.ExcPending
	if v382 != 0 {
		goto L10
...
L147:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+128)) = v530
	F_errmsg(m, int32(662219), v22+int32(128))
	mBase = m.M
	v536 = m.ExcPending
	if v536 != 0 {
		goto L10
...
L148:
	;
	F_errfinish(m, int32(472929), int32(423), int32(303198))
	mBase = m.M
	v541 = m.ExcPending
	if v541 != 0 {
		goto L10
...
L168:
	;
	v667 = F_plpgsql_build_variable(m, int32(360498), int32(0), v660, int32(1))
	mBase = m.M
	v668 = m.ExcPending
	if v668 != 0 {
		goto L10
...
L173:
	;
	v689 = F_plpgsql_build_variable(m, int32(268479), int32(0), v682, int32(1))
	mBase = m.M
	v690 = m.ExcPending
	if v690 != 0 {
		goto L10
...
L178:
	;
	v711 = F_plpgsql_build_variable(m, int32(291146), int32(0), v704, int32(1))
	mBase = m.M
	v712 = m.ExcPending
	if v712 != 0 {
		goto L10
...
L183:
	;
	v733 = F_plpgsql_build_variable(m, int32(223408), int32(0), v726, int32(1))
	mBase = m.M
	v734 = m.ExcPending
	if v734 != 0 {
		goto L10
...
L188:
	;
	v755 = F_plpgsql_build_variable(m, int32(414575), int32(0), v748, int32(1))
	mBase = m.M
	v756 = m.ExcPending
	if v756 != 0 {
		goto L10
...
L193:
	;
	v777 = F_plpgsql_build_variable(m, int32(359189), int32(0), v770, int32(1))
	mBase = m.M
	v778 = m.ExcPending
	if v778 != 0 {
		goto L10
...
L198:
	;
	v799 = F_plpgsql_build_variable(m, int32(361306), int32(0), v792, int32(1))
	mBase = m.M
	v800 = m.ExcPending
	if v800 != 0 {
		goto L10
...
L203:
	;
	v821 = F_plpgsql_build_variable(m, int32(482804), int32(0), v814, int32(1))
	mBase = m.M
	v822 = m.ExcPending
	if v822 != 0 {
		goto L10
...
L208:
	;
	v844 = F_plpgsql_build_variable(m, int32(145520), int32(0), v837, int32(1))
	mBase = m.M
	v845 = m.ExcPending
	if v845 != 0 {
		goto L10
...
L219:
	;
	v893 = F_plpgsql_build_variable(m, int32(86671), int32(0), v886, int32(1))
	mBase = m.M
	v894 = m.ExcPending
	if v894 != 0 {
		goto L10
...
L224:
	;
	v915 = F_plpgsql_build_variable(m, int32(321213), int32(0), v908, int32(1))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L10
...
L231:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+32)) = v949
	F_errmsg(m, int32(178478), v22+int32(32))
	mBase = m.M
	v956 = m.ExcPending
	if v956 != 0 {
		goto L10
...
L232:
	;
	F_errfinish(m, int32(472929), int32(330), int32(303198))
	mBase = m.M
	v961 = m.ExcPending
	if v961 != 0 {
		goto L10
...
L235:
	;
	F_errmsg(m, int32(114095), int32(0))
	mBase = m.M
	v974 = m.ExcPending
	if v974 != 0 {
		goto L10
...
L236:
	;
	F_errhint(m, int32(611436), int32(0))
	mBase = m.M
	v978 = m.ExcPending
	if v978 != 0 {
		goto L10
...
L237:
	;
	F_errfinish(m, int32(472929), int32(496), int32(303198))
	mBase = m.M
	v983 = m.ExcPending
	if v983 != 0 {
		goto L10
...
L270:
	;
	F_errmsg(m, int32(114089), int32(0))
	mBase = m.M
	v1154 = m.ExcPending
	if v1154 != 0 {
		goto L10
...
L271:
	;
	F_errfinish(m, int32(472929), int32(629), int32(303198))
	mBase = m.M
	v1159 = m.ExcPending
	if v1159 != 0 {
		goto L10
...
L279:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v1196
	F_errmsg_internal(m, int32(464368), v22)
	mBase = m.M
	v1200 = m.ExcPending
	if v1200 != 0 {
		goto L10
...
L280:
	;
	F_errfinish(m, int32(472929), int32(657), int32(303198))
	mBase = m.M
	v1205 = m.ExcPending
	if v1205 != 0 {
		goto L10
...
L291:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+80)) = v1236
	F_errmsg(m, int32(181273), v22+int32(80))
	mBase = m.M
	v1243 = m.ExcPending
	if v1243 != 0 {
		goto L10
...
L292:
	;
	F_errfinish(m, int32(472929), int32(456), int32(303198))
	mBase = m.M
	v1248 = m.ExcPending
	if v1248 != 0 {
		goto L10
...
L309:
	;
	v1287 = F_plpgsql_build_variable(m, int32(530307), v1280, v1284, int32(1))
	mBase = m.M
	v1288 = m.ExcPending
	if v1288 != 0 {
		goto L10
...
L315:
	;
	v1333 = F_plpgsql_build_variable(m, int32(404257), int32(0), v1326, int32(1))
	mBase = m.M
	v1334 = m.ExcPending
	if v1334 != 0 {
		goto L10
...
L386:
	;
	F_errfinish(m, int32(472929), int32(438), int32(303198))
	mBase = m.M
	v1691 = m.ExcPending
	if v1691 != 0 {
		goto L10
...
L389:
	;
	F_errmsg(m, int32(125299), int32(0))
	mBase = m.M
	v1702 = m.ExcPending
	if v1702 != 0 {
		goto L10
...
L390:
	;
	F_errfinish(m, int32(472929), int32(451), int32(303198))
	mBase = m.M
	v1707 = m.ExcPending
	if v1707 != 0 {
		goto L10
...
L395:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+112)) = v1339
	F_errmsg_internal(m, int32(457086), v22+int32(112))
	mBase = m.M
	v1733 = m.ExcPending
	if v1733 != 0 {
		goto L10
...
L396:
	;
	F_errfinish(m, int32(472929), int32(680), int32(303198))
	mBase = m.M
	v1738 = m.ExcPending
	if v1738 != 0 {
		goto L10
...
func F_plpgsql_compile_inline(m *base.Module, l0 int32) int32 {
	...
	if v19 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[1236])) = int32(301100)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(5358)
		v31 = int32(4435896)
				...
				*(*int32)(unsafe.Add(mBase, _consts[0])) = v52
				...
				if v62 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _consts[1244])) = v74
					F_plpgsql_ns_push(m, int32(301100), int32(0))
					mBase = m.M
					v87 = m.ExcPending
					if v87 != 0 {
						return int32(0)
								...
								if v115 != 0 {
									...
									if v121 != 0 {
										...
										if v123 != 0 {
											...
											v127 = F_plpgsql_build_variable(m, int32(404257), int32(0), v120, int32(1))
											mBase = m.M
											v128 = m.ExcPending
											if v128 != 0 {
												return int32(0)
													...
													if v133 != 0 {
														...
														if v291 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v133
															F_errmsg_internal(m, int32(457086), v14+int32(16))
															mBase = m.M
															v297 = m.ExcPending
															if v297 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(472929), int32(840), int32(355666))
																mBase = m.M
																v302 = m.ExcPending
																if v302 != 0 {
																	return int32(0)
	...
	default:
		...
		if v54 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v55
			F_errmsg_internal(m, int32(461960), v8)
			mBase = m.M
			v60 = m.ExcPending
			if v60 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(476889), int32(5508), int32(349016))
				mBase = m.M
				v67 = m.ExcPending
				if v67 != 0 {
					return int32(0)
							...
							if v85 != 0 {
								...
								if v88 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v89
									F_errmsg(m, int32(681354), v8+int32(16))
									mBase = m.M
									v98 = m.ExcPending
									if v98 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(476889), int32(5499), int32(349016))
										mBase = m.M
										v105 = m.ExcPending
										if v105 != 0 {
											return int32(0)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+8)) = int32(54)
	...
	case 0:
		...
		if v30 == int32(65535) {
			...
			if v18 != v33 {
				*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5370)
			} else {
				v35 = *(*int32)(unsafe.Add(mBase, uint32(v23)+32))
				if v35 == int32(0) {
					*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5370)
				} else {
					*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5369)
				}
			}
		} else {
			*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5371)
		}
	default:
		*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5374)
	case 2:
		*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5373)
	case 3:
		*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5372)
	case 4:
...
func F_plpgsql_param_ref(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v15
	v21 = F_pg_snprintf(m, v12+int32(16), int32(32), int32(445577), v12)
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L1
...
L32:
	;
	F_errfinish(m, int32(472929), int32(2190), int32(238288))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L26
	...
	if v15 != 0 {
		...
		if int32(4) <= v17 {
			...
			if v25 != 0 {
				...
				F_errmsg_internal(m, int32(304020), int32(0))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(472463), int32(388), int32(268284))
					mBase = m.M
					v37 = m.ExcPending
					if v37 != 0 {
						return int32(0)
							...
							if v39 != 0 {
								...
								if v42 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = v41
									F_errmsg(m, int32(107050), v10)
									mBase = m.M
									v47 = m.ExcPending
									if v47 != 0 {
										return int32(0)
									} else {
										F_errdetail(m, int32(578450), int32(0))
										mBase = m.M
										v52 = m.ExcPending
										if v52 != 0 {
											return int32(0)
											...
											if v55 != 0 {
												...
												F_errfinish(m, int32(472929), int32(1046), int32(322675))
												mBase = m.M
												v62 = m.ExcPending
												if v62 != 0 {
													return int32(0)
...
L284:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v996
	F_errmsg_internal(m, int32(462049), v11)
	mBase = m.M
	v1001 = m.ExcPending
	if v1001 != 0 {
		goto L32
...
L285:
	;
	F_errfinish(m, int32(472079), int32(595), int32(286442))
	mBase = m.M
	v1008 = m.ExcPending
	if v1008 != 0 {
		goto L32
