...
L121:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+32)) = v392
	F_errmsg_internal(m, int32(_a_F_parseRelOptionsInternal_8), v18+int32(32))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L1
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v433
	F_errmsg(m, int32(_a_F_parseRelOptionsInternal_9), v18)
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L1
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v469
	F_errmsg(m, int32(_a_F_parseRelOptionsInternal_11), v18+int32(16))
	mBase = m.M
	v475 = m.ExcPending
	if v475 != 0 {
		goto L1
...
L16:
	;
	v262 = *(*int32)(unsafe.Add(mBase, _c_F_transformRelOptions[0]))
...
L119:
	;
	v454 = int32(_a_F_transformRelOptions_3)
	goto L120
L120:
	;
	v455 = int32(61)
...
L129:
	;
	v466 = int32(_a_F_transformRelOptions_4)
	v469 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformRelOptions[1])))
...
L179:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v449
	v641 = F_pg_sprintf(m, v629+int32(4), int32(_a_F_transformRelOptions_6), v20)
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		goto L7
...
L180:
	;
	v646 = *(*int32)(unsafe.Add(mBase, _c_F_transformRelOptions[0]))
...
L193:
	;
	v745 = *(*int32)(unsafe.Add(mBase, _c_F_transformRelOptions[0]))
