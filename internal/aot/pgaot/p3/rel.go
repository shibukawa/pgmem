...
L16:
	;
	v206 = *(*int32)(unsafe.Add(mBase, _c_F_transformRelOptions[0]))
...
L102:
	;
	v398 = int32(_a_F_transformRelOptions_3)
	goto L103
L103:
	;
	v399 = int32(61)
...
L112:
	;
	v410 = int32(_a_F_transformRelOptions_4)
	v413 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformRelOptions[1])))
...
L128:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v393
	v473 = F_pg_sprintf(m, v461+int32(4), int32(_a_F_transformRelOptions_6), v20)
	mBase = m.M
	v474 = m.ExcPending
	if v474 != 0 {
		goto L7
...
L129:
	;
	v478 = *(*int32)(unsafe.Add(mBase, _c_F_transformRelOptions[0]))
...
L142:
	;
	v577 = *(*int32)(unsafe.Add(mBase, _c_F_transformRelOptions[0]))
