...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v56)+36)) = v59
	v62 = *(*int32)(unsafe.Add(mBase, _c_F_validateDomainNotNullConstraint[0]))
	if v62 != 0 {
		goto L13
	} else {
		goto L14
...
L13:
	;
	v64 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_validateDomainNotNullConstraint[1])))
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v56)+36)) = v183
	v186 = *(*int32)(unsafe.Add(mBase, _c_F_validateDomainNotNullConstraint[0]))
	if v186 == int32(0) {
		goto L17
	} else {
		goto L45
...
L38:
	;
	F_errfinish(m, int32(_a_F_validateDomainNotNullConstraint_1), int32(3178), int32(_a_F_validateDomainNotNullConstraint_2))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L3
...
L45:
	;
	v190 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_validateDomainNotNullConstraint[1])))
	if v190&int32(1) != 0 {
		goto L17
	} else {
		goto L46
...
L48:
	;
	F_errfinish(m, int32(_a_F_validateDomainNotNullConstraint_4), int32(1034), int32(_a_F_validateDomainNotNullConstraint_5))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L3
