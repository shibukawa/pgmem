...
func F___vfprintf_internal(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	v11 = v9 - int32(208)
	m.G0 = v11
	*(*int32)(unsafe.Add(mBase, uint32(v11)+204)) = l2
	v15 = v11 + int32(160)
	base.MemoryFill(m, v15, v6, int32(40))
	v19 = *(*int32)(unsafe.Add(mBase, uint32(v11)+204))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+200)) = v19
	v26 = F_printf_core(m, v6, l1, v11+int32(200), v11+int32(80), v15, l3, l4)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		return int32(0)
		...
		if v26 < int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0))) = v33 & int32(-33)
			...
			if v37 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(l0)+44)) = v11
				v49 = v46
				v52 = *(*int32)(unsafe.Add(mBase, uint32(l0)+72))
				*(*int32)(unsafe.Add(mBase, uint32(l0)+72)) = v52 - int32(1) | v52
				v57 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
				if v57&int32(8) != 0 {
					*(*int32)(unsafe.Add(mBase, uint32(l0))) = v57 | int32(32)
					v74 = int32(-1)
				} else {
					*(*int64)(unsafe.Add(mBase, uint32(l0)+4)) = int64(0)
					v66 = *(*int32)(unsafe.Add(mBase, uint32(l0)+44))
					*(*int32)(unsafe.Add(mBase, uint32(l0)+28)) = v66
					*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v66
					v69 = *(*int32)(unsafe.Add(mBase, uint32(l0)+48))
					*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v66 + v69
					v74 = int32(0)
				}
				if v74 != 0 {
					v85 = int32(-1)
					...
					if v86 != 0 {
						...
						v90 = m.T0[v89].(func(*base.Module, int32, int32, int32) int32)(m, l0, v87, v87)
						mBase = m.M
						v91 = m.ExcPending
						if v91 != 0 {
							return int32(0)
							...
							v92 = int32(0)
							*(*int32)(unsafe.Add(mBase, uint32(l0)+48)) = v92
							...
							*(*int64)(unsafe.Add(mBase, uint32(l0)+16)) = int64(0)
							...
							v105 = int32(32)
							*(*int32)(unsafe.Add(mBase, uint32(l0))) = v104 | v33&v105
							if v104&v105 != 0 {
								v112 = int32(-1)
							} else {
								v112 = v103
					...
					v76 = v49
					v83 = F_printf_core(m, l0, l1, v11+int32(200), v11+int32(80), v11+int32(160), l3, l4)
					mBase = m.M
					v84 = m.ExcPending
					if v84 != 0 {
						return int32(0)
