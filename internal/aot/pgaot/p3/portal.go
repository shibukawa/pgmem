		...
		if v13 != 0 {
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = v17
				F_errmsg(m, int32(257790), v5)
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return
				} else {
					F_errfinish(m, int32(523435), int32(401), int32(361639))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return
...
L15:
	;
	F_errmsg_internal(m, int32(75764), int32(0))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L9
...
L16:
	;
	F_errfinish(m, int32(523435), int32(515), int32(246969))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L9
...
L51:
	;
	F_errfinish(m, int32(523435), int32(479), int32(246969))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L9
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v135
	F_errmsg(m, int32(749427), v8+int32(16))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L9
...
L55:
	;
	F_errfinish(m, int32(523435), int32(487), int32(246969))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L9
				...
				if v131 != 0 {
					...
					if v135 != 0 {
						...
						if v139 != 0 {
							...
							F_errfinish(m, int32(517196), int32(941), int32(117789))
							mBase = m.M
							v144 = m.ExcPending
							if v144 != 0 {
								return int64(0)
