...
func F_MarkPortalActive(m *base.Module, l0 int32) {
	...
	if v7 != int32(2) {
		...
		if v13 != 0 {
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = v17
				F_errmsg(m, int32(_a_F_MarkPortalActive_0), v5)
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return
		...
		*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = int32(3)
		v30 = *(*int32)(unsafe.Add(mBase, _c_F_MarkPortalActive[0]))
...
L8:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_PortalDrop[0]))
...
L15:
	;
	F_errmsg_internal(m, int32(_a_F_PortalDrop_4), int32(0))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L9
		...
		if v61&int32(4) != 0 {
			...
			if v128 != 0 {
				...
				if v131 != 0 {
					...
					F_errmsg(m, int32(_a_F_PortalRunSelect_0), int32(0))
					mBase = m.M
					v135 = m.ExcPending
					if v135 != 0 {
						return int64(0)
					} else {
						F_errhint(m, int32(_a_F_PortalRunSelect_1), int32(0))
						mBase = m.M
						v139 = m.ExcPending
						if v139 != 0 {
							return int64(0)
