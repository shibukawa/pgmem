...
L28:
	;
	F_errfinish(m, int32(499246), int32(3525), int32(418279))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L13:
	;
	F_errsave_finish(m, l1, int32(495824), int32(367), int32(274958))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L1
...
L21:
	;
	F_errsave_finish(m, l1, int32(495824), int32(372), int32(274958))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L1
