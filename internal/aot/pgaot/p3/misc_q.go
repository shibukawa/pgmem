...
L5:
	;
	v15 = int32(246608)
	v18 = int32(*(*uint8)(unsafe.Add(mBase, _consts[440])))
...
L23:
	;
	v68 = int32(*(*uint8)(unsafe.Add(mBase, _consts[441])))
	if v68 != 0 {
		goto L4
	} else {
		goto L24
...
L24:
	;
	v70 = *(*int32)(unsafe.Add(mBase, _consts[442]))
	if v70 != 0 {
		v93 = v70
		goto L3
	} else {
...
L28:
	;
	F_errfinish(m, int32(522397), int32(3525), int32(437539))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L12:
	;
	F_errdetail(m, int32(598924), int32(0))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L13:
	;
	F_errsave_finish(m, l1, int32(518472), int32(367), int32(287366))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L1
...
L20:
	;
	F_errmsg(m, int32(417852), int32(0))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L1
...
L21:
	;
	F_errsave_finish(m, l1, int32(518472), int32(372), int32(287366))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L1
