...
func F_pgstat_count_backend_io_op(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int64) {
	...
	if base.Ui32(int32(16)) < base.Ui32(v8) {
		...
		if int32(1)<<(uint(v8)%32)&int32(115186) == int32(0) {
			...
			v27 = *(*int64)(unsafe.Add(mBase, uint32(v24)+uint32(_consts[908])))
			*(*int64)(unsafe.Add(mBase, uint32(v24)+uint32(_consts[908]))) = v27 + base.I64_extend_i32_u(l3)
			v33 = *(*int64)(unsafe.Add(mBase, uint32(v24)+uint32(_consts[909])))
			*(*int64)(unsafe.Add(mBase, uint32(v24)+uint32(_consts[909]))) = v33 + l4
			v37 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _consts[143])) = uint8(v37)
			*(*uint8)(unsafe.Add(mBase, _consts[191])) = uint8(v37)
		}
	}
	return
}
...
func F_pgstat_get_beentry_by_proc_number(m *base.Module, l0 int32) int32 {
	...
	if v10 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v5)+408)) = l0
		v13 = *(*int32)(unsafe.Add(mBase, _consts[897]))
		v15 = *(*int32)(unsafe.Add(mBase, _consts[898]))
...
func F_pgstat_get_entry_ref(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32, l4 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+64)) = l0
	v29 = *(*int32)(unsafe.Add(mBase, _consts[912]))
	if v29 == v6 {
		goto L1
	} else {
		goto L2
...
L1:
	...
	v39 = F_AllocSetContextCreateInternal(m, v34, int32(322985), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L4
...
L3:
	;
	v45 = *(*int32)(unsafe.Add(mBase, _consts[913]))
	if v45 == int32(0) {
		goto L6
	} else {
		goto L7
...
L5:
	;
	*(*int32)(unsafe.Add(mBase, _consts[912])) = v39
	goto L3
L6:
	;
	v50 = *(*int32)(unsafe.Add(mBase, _consts[12]))
	v55 = F_AllocSetContextCreateInternal(m, v50, int32(307952), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L4
...
L8:
	;
	v60 = *(*int32)(unsafe.Add(mBase, _consts[914]))
	if v60 == int32(0) {
		goto L10
	} else {
		goto L11
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, _consts[913])) = v55
	v58 = v55
	goto L8
L10:
	;
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, _consts[914])) = v64
	v81 = *(*int32)(unsafe.Add(mBase, _consts[267]))
	v82 = *(*int64)(unsafe.Add(mBase, uint32(v81)+16))
	*(*int64)(unsafe.Add(mBase, uint32(v81)+16)) = v82
	*(*uint32)(unsafe.Add(mBase, _consts[915])) = uint32(v82)
	goto L12
L15:
	;
	v89 = int32(0)
...
L17:
	;
	v92 = *(*int32)(unsafe.Add(mBase, _consts[914]))
	if v92 == int32(0) {
		v260 = v6
		goto L18
	} else {
...
L19:
	;
	v96 = *(*int32)(unsafe.Add(mBase, _consts[267]))
	v97 = *(*int64)(unsafe.Add(mBase, uint32(v96)+16))
	*(*int64)(unsafe.Add(mBase, uint32(v96)+16)) = v97
	v100 = int64(*(*int32)(unsafe.Add(mBase, _consts[915])))
	if v100 == v97 {
		goto L20
	} else {
		goto L21
...
L20:
	;
	v103 = *(*int32)(unsafe.Add(mBase, _consts[914]))
	v260 = v103
	goto L18
L21:
	;
...
L30:
	;
	*(*uint32)(unsafe.Add(mBase, _consts[915])) = uint32(v106)
	v260 = v172
	goto L18
L31:
	;
...
L42:
	;
	v246 = *(*int32)(unsafe.Add(mBase, _consts[914]))
	v168 = v219
	v172 = v246
	v174 = v216
	goto L29
...
L46:
	;
	v1325 = *(*int32)(unsafe.Add(mBase, _consts[269]))
...
L48:
	;
	v1063 = *(*int32)(unsafe.Add(mBase, _consts[269]))
...
L49:
	;
	v1032 = *(*int32)(unsafe.Add(mBase, _consts[912]))
...
L102:
	;
	F_errfinish(m, int32(310302), int32(327), int32(324244))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L4
...
L161:
	;
	F_errfinish(m, int32(310302), int32(630), int32(296277))
	mBase = m.M
	v982 = m.ExcPending
	if v982 != 0 {
		goto L4
...
L167:
	;
	v1072 = *(*int32)(unsafe.Add(mBase, _consts[269]))
...
L169:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1077)+24)) = v1082
	v1087 = *(*int32)(unsafe.Add(mBase, _consts[270]))
...
L171:
	;
	v1116 = l0*int32(72) + int32(1610080)
	goto L170
L172:
	;
	goto L173
...
L175:
	;
	v1102 = int32(0)
	v1104 = *(*int32)(unsafe.Add(mBase, _consts[268]))
	if v1104 == v1102 {
		v1114 = v1102
		goto L174
	} else {
...
L178:
	;
	v1124 = *(*int32)(unsafe.Add(mBase, _consts[270]))
...
L180:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1077)+20)) = v1138 + int32(1)
	v1143 = *(*int32)(unsafe.Add(mBase, _consts[269]))
...
L189:
	;
	v1173 = *(*int32)(unsafe.Add(mBase, _consts[270]))
...
L192:
	;
	v1215 = l0*int32(72) + int32(1610080)
	goto L191
L193:
	;
	goto L194
...
L196:
	;
	v1201 = int32(0)
	v1203 = *(*int32)(unsafe.Add(mBase, _consts[268]))
	if v1203 == v1201 {
		v1213 = v1201
		goto L195
	} else {
...
L199:
	;
	v1247 = l0*int32(72) + int32(1610080)
	goto L198
L200:
	;
	goto L201
...
L203:
	;
	v1233 = int32(0)
	v1235 = *(*int32)(unsafe.Add(mBase, _consts[268]))
	if v1235 == v1233 {
		v1245 = v1233
		goto L202
	} else {
...
L205:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1154)+20)) = v1251 + int32(1)
	v1256 = *(*int32)(unsafe.Add(mBase, _consts[269]))
...
L208:
	;
	v1270 = *(*int32)(unsafe.Add(mBase, _consts[269]))
...
L210:
	;
	v1284 = *(*int32)(unsafe.Add(mBase, _consts[270]))
...
L213:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1154)+20)) = v1288 + int32(1)
	v1293 = *(*int32)(unsafe.Add(mBase, _consts[269]))
...
L218:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v23)+40)) = v1341
	F_errdetail(m, int32(537078), v23+int32(32))
	mBase = m.M
	v1347 = m.ExcPending
	if v1347 != 0 {
		goto L4
...
L219:
	;
	F_errfinish(m, int32(473851), int32(537), int32(322454))
	mBase = m.M
	v1352 = m.ExcPending
	if v1352 != 0 {
		goto L4
...
func F_pgstat_get_slru_name(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(7)) {
		v9 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[916])))
		v10 = v9
	} else {
		v10 = int32(0)
	}
...
func F_pgstat_get_transactional_drops(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v64
	v3 = int32(0)
	v9 = *(*int32)(unsafe.Add(mBase, _consts[927]))
	if v9 == v3 {
		v64 = v3
		return v64
	} else {
	...
	if l0 == v2 {
		...
		case 0:
			...
			if base.Ui32(v16) <= base.Ui32(int32(94)) {
				v23 = *(*int32)(unsafe.Add(mBase, uint32(v16<<(uint(int32(2))%32))+uint32(_consts[928])))
				v43 = v23
			} else {
				v27 = (v16 - int32(95)) & int32(65535)
				v29 = *(*int32)(unsafe.Add(mBase, _consts[929]))
				if v27 < v29 {
					v32 = *(*int32)(unsafe.Add(mBase, _consts[930]))
		...
		case 2:
			...
			if base.Ui32(v45) <= base.Ui32(int32(11)) {
				v52 = *(*int32)(unsafe.Add(mBase, uint32(v45<<(uint(int32(2))%32))+uint32(_consts[931])))
				v54 = v52
			} else {
				v54 = int32(521570)
			}
		...
		case 4:
			...
			if base.Ui32(int32(18)) <= base.Ui32(v93) {
				...
				v100 = *(*int32)(unsafe.Add(mBase, uint32(v93<<(uint(int32(2))%32))+uint32(_consts[932])))
				v138 = v100
			}
			m.G0 = v6 + int32(16)
			return v138
		case 5:
			...
			if base.Ui32(int32(9)) <= base.Ui32(v102) {
				...
				v109 = *(*int32)(unsafe.Add(mBase, uint32(v102<<(uint(int32(2))%32))+uint32(_consts[933])))
				v138 = v109
			}
			m.G0 = v6 + int32(16)
			return v138
		case 6, 10:
			*(*int32)(unsafe.Add(mBase, uint32(v6)+12)) = l0
			if l0 == int32(117440512) {
				...
				v60 = *(*int32)(unsafe.Add(mBase, _consts[44]))
				...
				if v67 != 0 {
					...
					v69 = *(*int32)(unsafe.Add(mBase, _consts[934]))
							...
							if v75 == int32(0) {
								...
								if v146 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6))) = v147
									F_errmsg_internal(m, int32(43377), v6)
									mBase = m.M
									v151 = m.ExcPending
									if v151 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(470012), int32(295), int32(211593))
										mBase = m.M
										v156 = m.ExcPending
										if v156 != 0 {
											return int32(0)
		...
		case 7:
			...
			if base.Ui32(int32(57)) <= base.Ui32(v111) {
				...
				v118 = *(*int32)(unsafe.Add(mBase, uint32(v111<<(uint(int32(2))%32))+uint32(_consts[935])))
				v138 = v118
			}
			m.G0 = v6 + int32(16)
			return v138
		case 8:
			...
			if base.Ui32(int32(10)) <= base.Ui32(v120) {
				...
				v127 = *(*int32)(unsafe.Add(mBase, uint32(v120<<(uint(int32(2))%32))+uint32(_consts[936])))
				v138 = v127
			}
			m.G0 = v6 + int32(16)
			return v138
		case 9:
			...
			if base.Ui32(int32(81)) <= base.Ui32(v129) {
				...
				v136 = *(*int32)(unsafe.Add(mBase, uint32(v129<<(uint(int32(2))%32))+uint32(_consts[937])))
				v138 = v136
			}
			m.G0 = v6 + int32(16)
			return v138
...
func F_pgstat_io_snapshot_cb(m *base.Module) {
	...
	var v53 int32
	_ = v53
	v6 = *(*int32)(unsafe.Add(mBase, _consts[267]))
	v8 = v6 + int32(608)
...
L2:
	;
	v14 = *(*int32)(unsafe.Add(mBase, _consts[267]))
...
L4:
	;
	v21 = F__emscripten_memcpy_bulkmem(m, int32(4366776), v6+int32(904), int32(2880))
	mBase = m.M
	goto L6
L6:
	;
...
L8:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[267]))
...
L12:
	;
	v48 = F__emscripten_memcpy_bulkmem(m, v41+int32(4366776), v31+v41+int32(904), v40)
	mBase = m.M
	goto L14
L14:
	;
...
func F_pgstat_progress_update_param(m *base.Module, l0 int32, l1 int64) {
	...
	if v5 == int32(0) {
		...
		v9 = int32(*(*uint8)(unsafe.Add(mBase, _consts[455])))
		if v9 != int32(1) {
		} else {
			v12 = int32(4437236)
			v14 = *(*int32)(unsafe.Add(mBase, _consts[14]))
			v15 = int32(1)
			*(*int32)(unsafe.Add(mBase, _consts[14])) = v14 + v15
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = v26 + v15
			v32 = *(*int32)(unsafe.Add(mBase, _consts[14]))
			*(*int32)(unsafe.Add(mBase, _consts[14])) = v32 - v15
		}
	}
	return
}
func F_pgstat_report_archiver(m *base.Module, l0 int32, l1 int32) {
	...
	var v71 int32
	_ = v71
	v7 = *(*int32)(unsafe.Add(mBase, _consts[267]))
	v11 = m.G0
	v12 = int32(16)
	v13 = v11 - v12
	m.G0 = v13
	...
	m.G0 = v13 + v12
	v26 = int32(4437236)
	v28 = *(*int32)(unsafe.Add(mBase, _consts[14]))
	v29 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v28 + v29
	...
	*(*int32)(unsafe.Add(mBase, _consts[14])) = v71 - v66
	return
}
...
func F_pgstat_report_tempfile(m *base.Module, l0 int32) {
	...
	var v19 int64
	_ = v19
	v4 = int32(*(*uint8)(unsafe.Add(mBase, _consts[910])))
	if v4 == int32(1) {
		v9 = *(*int32)(unsafe.Add(mBase, _consts[119]))
...
func F_pgstat_snapshot_fixed(m *base.Module, l0 int32) {
	...
	var v86 int32
	_ = v86
	v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[899])))
	if v7 != 0 {
		v9 = int64(0)
		*(*int64)(unsafe.Add(mBase, _consts[900])) = v9
		*(*int64)(unsafe.Add(mBase, _consts[901])) = v9
		*(*int64)(unsafe.Add(mBase, _consts[902])) = v9
		v18 = int32(0)
		*(*uint8)(unsafe.Add(mBase, _consts[903])) = uint8(v18)
		*(*int32)(unsafe.Add(mBase, _consts[904])) = v18
		*(*int32)(unsafe.Add(mBase, _consts[905])) = v18
		v27 = *(*int32)(unsafe.Add(mBase, _consts[906]))
		if v27 != 0 {
			...
			if v29 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[906])) = int32(0)
				...
				if v34 != 0 {
					...
					v36 = int32(0)
					*(*uint8)(unsafe.Add(mBase, _consts[899])) = uint8(v36)
					v40 = *(*int32)(unsafe.Add(mBase, _consts[907]))
					if v40 == int32(2) {
...
func F_pgstat_twophase_postcommit(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	var v62 int64
	_ = v62
	v10 = *(*int32)(unsafe.Add(mBase, _consts[119]))
...
func F_pgstat_wal_snapshot_cb(m *base.Module) {
	...
	var v34 int32
	_ = v34
	v4 = *(*int32)(unsafe.Add(mBase, _consts[267]))
	v6 = v4 + int32(53272)
	...
	if v9 != 0 {
		...
		v13 = *(*int64)(unsafe.Add(mBase, uint32(v4)+uint32(_consts[917])))
		*(*int64)(unsafe.Add(mBase, _consts[918])) = v13
		v18 = *(*int64)(unsafe.Add(mBase, uint32(v4)+uint32(_consts[919])))
		*(*int64)(unsafe.Add(mBase, _consts[920])) = v18
		v23 = *(*int64)(unsafe.Add(mBase, uint32(v4)+uint32(_consts[921])))
		*(*int64)(unsafe.Add(mBase, _consts[922])) = v23
		v28 = *(*int64)(unsafe.Add(mBase, uint32(v4)+uint32(_consts[923])))
		*(*int64)(unsafe.Add(mBase, _consts[924])) = v28
		v31 = *(*int64)(unsafe.Add(mBase, uint32(v4)+uint32(_consts[925])))
		*(*int64)(unsafe.Add(mBase, _consts[926])) = v31
