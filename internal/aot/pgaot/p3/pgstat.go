...
L1:
	...
	v39 = F_AllocSetContextCreateInternal(m, v34, int32(318660), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L4
...
L6:
	...
	v55 = F_AllocSetContextCreateInternal(m, v50, int32(304085), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L4
...
L102:
	;
	F_errfinish(m, int32(306377), int32(327), int32(319856))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L4
...
L161:
	;
	F_errfinish(m, int32(306377), int32(630), int32(292562))
	mBase = m.M
	v982 = m.ExcPending
	if v982 != 0 {
		goto L4
...
L171:
	;
	v1116 = l0*int32(72) + int32(1601888)
	goto L170
L172:
	;
	goto L173
...
L192:
	;
	v1215 = l0*int32(72) + int32(1601888)
	goto L191
L193:
	;
	goto L194
...
L199:
	;
	v1247 = l0*int32(72) + int32(1601888)
	goto L198
L200:
	;
	goto L201
...
L218:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v23)+40)) = v1341
	F_errdetail(m, int32(528872), v23+int32(32))
	mBase = m.M
	v1347 = m.ExcPending
	if v1347 != 0 {
		goto L4
...
L219:
	;
	F_errfinish(m, int32(466605), int32(537), int32(318129))
	mBase = m.M
	v1352 = m.ExcPending
	if v1352 != 0 {
		goto L4
							...
							if v75 == int32(0) {
								...
								if v146 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6))) = v147
									F_errmsg_internal(m, int32(42876), v6)
									mBase = m.M
									v151 = m.ExcPending
									if v151 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(462817), int32(295), int32(209405))
										mBase = m.M
										v156 = m.ExcPending
										if v156 != 0 {
											return int32(0)
...
L4:
	;
	v21 = F__emscripten_memcpy_bulkmem(m, int32(4349480), v6+int32(904), int32(2880))
	mBase = m.M
	goto L6
L6:
	;
...
L12:
	;
	v48 = F__emscripten_memcpy_bulkmem(m, v41+int32(4349480), v31+v41+int32(904), v40)
	mBase = m.M
	goto L14
L14:
	;
