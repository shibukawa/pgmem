...
L59:
	;
	F_errfinish(m, int32(524196), int32(2253), int32(107158))
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L1
...
L119:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v457))) = v534
	F_errmsg_internal(m, int32(192359), v457)
	mBase = m.M
	v755 = m.ExcPending
	if v755 != 0 {
		goto L1
...
L265:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+96)) = v1617
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(216894), v1560+int32(96))
	mBase = m.M
	v1627 = m.ExcPending
	if v1627 != 0 {
		goto L1
...
L273:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+32)) = int32(17)
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(440490), v1560+int32(32))
	mBase = m.M
	v1668 = m.ExcPending
	if v1668 != 0 {
		goto L1
...
L274:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+16)) = v1644
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(511270), v1560+int32(16))
	mBase = m.M
	v1654 = m.ExcPending
	if v1654 != 0 {
		goto L1
...
L284:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+48)) = v1672
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(216894), v1560+int32(48))
	mBase = m.M
	v1682 = m.ExcPending
	if v1682 != 0 {
		goto L1
...
L288:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+80)) = v1719
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(216894), v1560+int32(80))
	mBase = m.M
	v1737 = m.ExcPending
	if v1737 != 0 {
		goto L1
...
L297:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560))) = v1773
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(216894), v1560)
	mBase = m.M
	v1781 = m.ExcPending
	if v1781 != 0 {
		goto L1
...
L303:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+64)) = v1684
	F_errmsg_internal(m, int32(192359), v1560-int32(-64))
	mBase = m.M
	v1827 = m.ExcPending
	if v1827 != 0 {
		goto L1
...
L312:
	;
	F_errfinish(m, int32(525050), int32(6020), int32(17951))
	mBase = m.M
	v1954 = m.ExcPending
	if v1954 != 0 {
		goto L1
...
L336:
	;
	F_errmsg_internal(m, int32(371206), int32(0))
	mBase = m.M
	v2025 = m.ExcPending
	if v2025 != 0 {
		goto L1
...
L337:
	;
	F_errfinish(m, int32(525010), int32(327), int32(372012))
	mBase = m.M
	v2030 = m.ExcPending
	if v2030 != 0 {
		goto L1
...
L419:
	;
	v2441 = F_hash_create(m, int32(140081), v2437, v2359+int32(32), int32(1064))
	mBase = m.M
	v2442 = m.ExcPending
	if v2442 != 0 {
		goto L1
...
L478:
	;
	v2876 = F__emscripten_memcpy_bulkmem(m, v2872, int32(4550352), int32(524))
	mBase = m.M
	goto L480
L480:
	;
...
L482:
	;
	v2882 = F__emscripten_memcpy_bulkmem(m, v2876+v2878, int32(4551400), v2878)
	mBase = m.M
	goto L484
L484:
	;
		...
		default:
			...
			if v48 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = v49 + int32(4)
				F_errmsg_internal(m, int32(725201), v10)
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(522418), int32(904), int32(28876))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
