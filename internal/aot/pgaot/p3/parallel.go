...
L30:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v145
	v148 = F_dshash_create(m, v129, int32(1745740), v129)
	mBase = m.M
	v149 = m.ExcPending
	if v149 != 0 {
		goto L1
...
L31:
	;
	v152 = F_dshash_create(m, v129, int32(1745764), int32(0))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L59:
	;
	F_errfinish(m, int32(495993), int32(2253), int32(99914))
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L1
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v54))) = v452
	...
	m.G0 = v457
	v459 = int32(4)
	v461 = *(*int32)(unsafe.Add(mBase, _consts[112]))
	if v461 == int32(0) {
		v697 = v459
		goto L78
	} else {
...
L119:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v457))) = v534
	F_errmsg_internal(m, int32(180750), v457)
	mBase = m.M
	v755 = m.ExcPending
	if v755 != 0 {
		goto L1
...
L122:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v54))) = v766
	v772 = *(*int32)(unsafe.Add(mBase, _consts[113]))
...
L125:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v54))) = v782
	v786 = *(*int32)(unsafe.Add(mBase, _consts[114]))
	if int32(2) <= v786 {
		goto L126
	} else {
		goto L127
...
L147:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+36)) = v899
	v903 = *(*int32)(unsafe.Add(mBase, _consts[115]))
	if v903 != 0 {
		goto L148
	} else {
		goto L149
...
L162:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+36)) = v1009
	v1014 = *(*int32)(unsafe.Add(mBase, _consts[116]))
	if v1014 != 0 {
		goto L163
	} else {
		goto L164
...
L165:
	;
	v1086 = *(*int32)(unsafe.Add(mBase, _consts[117]))
	if v1086 != 0 {
		goto L170
	} else {
		goto L171
...
L178:
	;
	v1175 = *(*int32)(unsafe.Add(mBase, _consts[118]))
	if v1175 != 0 {
		goto L179
	} else {
		goto L180
...
L202:
	;
	v1295 = *(*int32)(unsafe.Add(mBase, _consts[119]))
	*(*int32)(unsafe.Add(mBase, uint32(v1292))) = v1295
	v1298 = *(*int32)(unsafe.Add(mBase, _consts[120]))
	*(*int32)(unsafe.Add(mBase, uint32(v1292)+4)) = v1298
	v1301 = *(*int32)(unsafe.Add(mBase, _consts[121]))
	*(*int32)(unsafe.Add(mBase, uint32(v1292)+8)) = v1301
	v1304 = *(*int32)(unsafe.Add(mBase, _consts[122]))
	v1307 = int32(*(*uint8)(unsafe.Add(mBase, _consts[123])))
	if v1307 != 0 {
		goto L204
	} else {
		goto L205
...
L207:
	;
	v1321 = int32(*(*uint8)(unsafe.Add(mBase, _consts[124])))
	*(*uint8)(unsafe.Add(mBase, uint32(v1292)+32)) = uint8(v1321)
	v1324 = int32(*(*uint8)(unsafe.Add(mBase, _consts[125])))
	*(*uint8)(unsafe.Add(mBase, uint32(v1292)+33)) = uint8(v1324)
	v1327 = *(*int32)(unsafe.Add(mBase, _consts[126]))
	*(*int32)(unsafe.Add(mBase, uint32(v1292)+20)) = v1327
	v1330 = *(*int32)(unsafe.Add(mBase, _consts[127]))
	*(*int32)(unsafe.Add(mBase, uint32(v1292)+24)) = v1330
	v1333 = *(*int32)(unsafe.Add(mBase, _consts[128]))
	*(*int32)(unsafe.Add(mBase, uint32(v1292)+36)) = v1333
	v1336 = *(*int32)(unsafe.Add(mBase, _consts[129]))
	*(*int32)(unsafe.Add(mBase, uint32(v1292)+40)) = v1336
	v1339 = *(*int32)(unsafe.Add(mBase, _consts[100]))
	*(*int32)(unsafe.Add(mBase, uint32(v1292)+44)) = v1339
	v1342 = *(*int64)(unsafe.Add(mBase, _consts[130]))
	*(*int64)(unsafe.Add(mBase, uint32(v1292)+48)) = v1342
	v1345 = *(*int64)(unsafe.Add(mBase, _consts[131]))
	*(*int64)(unsafe.Add(mBase, uint32(v1292)+56)) = v1345
	v1348 = *(*int32)(unsafe.Add(mBase, _consts[132]))
...
L212:
	;
	v1365 = *(*int32)(unsafe.Add(mBase, _consts[111]))
	if v1365 != 0 {
		goto L213
	} else {
		goto L214
...
L252:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+104)) = v1566
	v1569 = *(*int32)(unsafe.Add(mBase, _consts[112]))
	if v1569 == int32(0) {
		v1910 = v1566
		goto L258
	} else {
...
L265:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+96)) = v1617
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(205224), v1560+int32(96))
	mBase = m.M
	v1627 = m.ExcPending
	if v1627 != 0 {
		goto L1
...
L273:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+32)) = int32(17)
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(417345), v1560+int32(32))
	mBase = m.M
	v1668 = m.ExcPending
	if v1668 != 0 {
		goto L1
...
L274:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+16)) = v1644
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(485141), v1560+int32(16))
	mBase = m.M
	v1654 = m.ExcPending
	if v1654 != 0 {
		goto L1
...
L284:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+48)) = v1672
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(205224), v1560+int32(48))
	mBase = m.M
	v1682 = m.ExcPending
	if v1682 != 0 {
		goto L1
...
L288:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+80)) = v1719
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(205224), v1560+int32(80))
	mBase = m.M
	v1737 = m.ExcPending
	if v1737 != 0 {
		goto L1
...
L297:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560))) = v1773
	F_do_serialize(m, v1560+int32(108), v1560+int32(104), int32(205224), v1560)
	mBase = m.M
	v1781 = m.ExcPending
	if v1781 != 0 {
		goto L1
...
L303:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1560)+64)) = v1684
	F_errmsg_internal(m, int32(180750), v1560-int32(-64))
	mBase = m.M
	v1827 = m.ExcPending
	if v1827 != 0 {
		goto L1
...
L312:
	;
	F_errfinish(m, int32(496556), int32(6020), int32(17732))
	mBase = m.M
	v1954 = m.ExcPending
	if v1954 != 0 {
		goto L1
...
L324:
	;
	v2002 = *(*int32)(unsafe.Add(mBase, _consts[113]))
...
L329:
	;
	v2015 = *(*int32)(unsafe.Add(mBase, _consts[133]))
	if v2007 != 0 {
		goto L333
	} else {
		goto L334
...
L336:
	;
	F_errmsg_internal(m, int32(351277), int32(0))
	mBase = m.M
	v2025 = m.ExcPending
	if v2025 != 0 {
		goto L1
...
L337:
	;
	F_errfinish(m, int32(496516), int32(327), int32(352028))
	mBase = m.M
	v2030 = m.ExcPending
	if v2030 != 0 {
		goto L1
...
L339:
	;
	v2036 = *(*int32)(unsafe.Add(mBase, _consts[114]))
	if int32(2) <= v2036 {
		goto L340
	} else {
		goto L341
...
L375:
	;
	v2148 = int32(0)
	v2150 = *(*int32)(unsafe.Add(mBase, _consts[114]))
	*(*int32)(unsafe.Add(mBase, uint32(v2146))) = v2150
	v2153 = int32(*(*uint8)(unsafe.Add(mBase, _consts[134])))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2146)+16)) = v2160
	v2163 = *(*int32)(unsafe.Add(mBase, _consts[135]))
	*(*int32)(unsafe.Add(mBase, uint32(v2146)+24)) = v2163
	v2166 = *(*int32)(unsafe.Add(mBase, _consts[136]))
	if v2148 < v2166 {
		goto L377
	} else {
		goto L378
...
L377:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2146)+28)) = v2166
	v2173 = *(*int32)(unsafe.Add(mBase, _consts[137]))
...
L415:
	...
	m.G0 = v2359
	v2362 = *(*int32)(unsafe.Add(mBase, _consts[115]))
	if v2362 != 0 {
		goto L416
	} else {
		goto L417
...
L419:
	;
	v2441 = F_hash_create(m, int32(130828), v2437, v2359+int32(32), int32(1064))
	mBase = m.M
	v2442 = m.ExcPending
	if v2442 != 0 {
		goto L1
...
L423:
	;
	v2446 = *(*int32)(unsafe.Add(mBase, _consts[115]))
...
L428:
	;
	v2524 = *(*int32)(unsafe.Add(mBase, _consts[138]))
	if v2524 != 0 {
		goto L434
	} else {
		goto L435
...
L464:
	;
	v2743 = int32(0)
	v2745 = *(*int32)(unsafe.Add(mBase, _consts[139]))
...
L478:
	;
	v2876 = F__emscripten_memcpy_bulkmem(m, v2872, int32(4475200), int32(524))
	mBase = m.M
	goto L480
L480:
	;
...
L482:
	;
	v2882 = F__emscripten_memcpy_bulkmem(m, v2876+v2878, int32(4476248), v2878)
	mBase = m.M
	goto L484
L484:
	;
...
L486:
	...
	m.G0 = v2893
	v2896 = *(*int32)(unsafe.Add(mBase, _consts[116]))
	if v2896 == int32(0) {
		v2949 = v2889
		goto L487
	} else {
...
L487:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2949))) = v2979
	v2982 = v2949 + int32(4)
	v2984 = *(*int32)(unsafe.Add(mBase, _consts[117]))
	if v2984 == v2979 {
		v3037 = v2982
		goto L496
	} else {
...
L506:
	;
	v3080 = *(*int32)(unsafe.Add(mBase, _consts[140]))
	v3082 = *(*int32)(unsafe.Add(mBase, _consts[118]))
	if v3082 == int32(0) {
		goto L508
	} else {
		goto L509
...
L511:
	;
	v3096 = *(*int32)(unsafe.Add(mBase, _consts[118]))
	v3098 = v3088 + int32(1)
	if v3098 != 0 {
		goto L515
	} else {
...
L527:
	;
	v3174 = *(*int32)(unsafe.Add(mBase, _consts[128]))
		...
		default:
			...
			if v48 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = v49 + int32(4)
				F_errmsg_internal(m, int32(674712), v10)
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(494281), int32(904), int32(28118))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
