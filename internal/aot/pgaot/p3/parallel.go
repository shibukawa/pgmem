...
L30:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v145
	v148 = F_dshash_create(m, v129, int32(1725260), v129)
	mBase = m.M
	v149 = m.ExcPending
	if v149 != 0 {
		goto L1
...
L31:
	;
	v152 = F_dshash_create(m, v129, int32(1725284), int32(0))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L59:
	;
	F_errfinish(m, int32(479911), int32(2253), int32(95117))
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L1
...
L204:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v513))) = v702
	F_errmsg_internal(m, int32(173086), v513)
	mBase = m.M
	v1035 = m.ExcPending
	if v1035 != 0 {
		goto L1
...
L401:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2008)+96)) = v2065
	F_do_serialize(m, v2008+int32(108), v2008+int32(104), int32(197405), v2008+int32(96))
	mBase = m.M
	v2075 = m.ExcPending
	if v2075 != 0 {
		goto L1
...
L409:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2008)+32)) = int32(17)
	F_do_serialize(m, v2008+int32(108), v2008+int32(104), int32(403175), v2008+int32(32))
	mBase = m.M
	v2116 = m.ExcPending
	if v2116 != 0 {
		goto L1
...
L410:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2008)+16)) = v2092
	F_do_serialize(m, v2008+int32(108), v2008+int32(104), int32(469640), v2008+int32(16))
	mBase = m.M
	v2102 = m.ExcPending
	if v2102 != 0 {
		goto L1
...
L420:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2008)+48)) = v2120
	F_do_serialize(m, v2008+int32(108), v2008+int32(104), int32(197405), v2008+int32(48))
	mBase = m.M
	v2130 = m.ExcPending
	if v2130 != 0 {
		goto L1
...
L424:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2008)+80)) = v2167
	F_do_serialize(m, v2008+int32(108), v2008+int32(104), int32(197405), v2008+int32(80))
	mBase = m.M
	v2185 = m.ExcPending
	if v2185 != 0 {
		goto L1
...
L433:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2008))) = v2221
	F_do_serialize(m, v2008+int32(108), v2008+int32(104), int32(197405), v2008)
	mBase = m.M
	v2229 = m.ExcPending
	if v2229 != 0 {
		goto L1
...
L439:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2008)+64)) = v2132
	F_errmsg_internal(m, int32(173086), v2008-int32(-64))
	mBase = m.M
	v2275 = m.ExcPending
	if v2275 != 0 {
		goto L1
...
L448:
	;
	F_errfinish(m, int32(480467), int32(6020), int32(16599))
	mBase = m.M
	v2402 = m.ExcPending
	if v2402 != 0 {
		goto L1
...
L473:
	;
	F_errfinish(m, int32(480427), int32(327), int32(340024))
	mBase = m.M
	v2478 = m.ExcPending
	if v2478 != 0 {
		goto L1
...
L555:
	;
	v2889 = F_hash_create(m, int32(123712), v2885, v2807+int32(32), int32(1064))
	mBase = m.M
	v2890 = m.ExcPending
	if v2890 != 0 {
		goto L1
...
L614:
	;
	v3324 = F__emscripten_memcpy_bulkmem(m, v3320, int32(4437792), int32(524))
	mBase = m.M
	goto L616
L616:
	;
...
L618:
	;
	v3330 = F__emscripten_memcpy_bulkmem(m, v3324+v3326, int32(4438840), v3326)
	mBase = m.M
	goto L620
L620:
	;
		...
		default:
			...
			if v48 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = v49 + int32(4)
				F_errmsg_internal(m, int32(655698), v10)
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(478221), int32(904), int32(26479))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
