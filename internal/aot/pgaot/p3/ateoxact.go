		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v13 == int32(0) {
					...
					F_errmsg_internal(m, int32(256492), int32(0))
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
					} else {
						F_errfinish(m, int32(496232), int32(1206), int32(241138))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
...
L11:
	;
	F_errfinish(m, int32(497609), int32(1290), int32(308023))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L8
