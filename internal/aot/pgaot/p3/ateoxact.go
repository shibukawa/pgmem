		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v13 == int32(0) {
					...
					F_errmsg_internal(m, int32(246000), int32(0))
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
					} else {
						F_errfinish(m, int32(476952), int32(1206), int32(230759))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
...
L10:
	;
	F_errmsg_internal(m, int32(58839), int32(0))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L8
...
L11:
	;
	F_errfinish(m, int32(478227), int32(1290), int32(295353))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L8
