		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v13 == int32(0) {
					...
					F_errmsg_internal(m, int32(268719), int32(0))
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
					} else {
						F_errfinish(m, int32(519135), int32(1206), int32(252741))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
...
L10:
	;
	F_errmsg_internal(m, int32(66612), int32(0))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L8
...
L11:
	;
	F_errfinish(m, int32(520945), int32(1290), int32(322127))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L8
...
L3:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[946]))
	if v22 == int32(0) {
		goto L7
	} else {
		goto L8
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, _consts[946])) = int32(0)
