		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v13 == int32(0) {
					...
					F_errmsg_internal(m, int32(254117), int32(0))
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
					} else {
						F_errfinish(m, int32(491116), int32(1206), int32(238876))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
...
L10:
	;
	F_errmsg_internal(m, int32(60633), int32(0))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L8
...
L11:
	;
	F_errfinish(m, int32(492475), int32(1290), int32(305039))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L8
