		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v13 == int32(0) {
					...
					F_errmsg_internal(m, int32(269328), int32(0))
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
					} else {
						F_errfinish(m, int32(520587), int32(1206), int32(253350))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
...
L11:
	;
	F_errfinish(m, int32(522424), int32(1290), int32(322967))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L8
