...
func F_AtEOXact_Aio(m *base.Module) {
	...
	var v25 int32
	_ = v25
	v3 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Aio[0]))
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v13 == int32(0) {
					...
					F_errmsg_internal(m, int32(_a_F_AtEOXact_Aio_0), int32(0))
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
...
func F_AtEOXact_Enum(m *base.Module) {
	...
	_ = v2
	v2 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Enum[0])) = v2
	*(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Enum[1])) = v2
	return
}
func F_AtEOXact_Namespace(m *base.Module, l0 int32, l1 int32) {
	...
	if l1 != 0 {
		...
		v4 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Namespace[0]))
		if v4 == int32(0) {
			return
		} else {
			if l0 != 0 {
				...
				v12 = int32(1)
				*(*uint8)(unsafe.Add(mBase, _c_F_AtEOXact_Namespace[1])) = uint8(v12)
				v15 = int32(0)
				*(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Namespace[2])) = v15
...
L3:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_PgStat[0]))
	if v22 == int32(0) {
		goto L7
	} else {
		goto L8
...
L4:
	;
	v15 = int32(_a_F_AtEOXact_PgStat_0)
	goto L6
L5:
	;
	v15 = int32(_a_F_AtEOXact_PgStat_1)
	goto L6
L6:
	;
...
func F_AtEOXact_on_commit_actions(m *base.Module, l0 int32) {
	...
	_ = v31
	v2 = int32(0)
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_on_commit_actions[0]))
	if v6 == v2 {
		goto L1
	} else {
		goto L2
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_on_commit_actions[0])) = v27
	F_pfree(m, v19)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
