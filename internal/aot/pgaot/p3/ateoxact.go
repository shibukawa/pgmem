		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v13 == int32(0) {
					...
					F_errmsg_internal(m, int32(256204), int32(0))
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
					} else {
						F_errfinish(m, int32(495818), int32(1206), int32(240924))
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
...
L11:
	;
	F_errfinish(m, int32(497183), int32(1290), int32(307728))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L8
