...
L28:
	;
	v138 = v136 & int32(_a_F_mic_to_big5_1)
	goto L27
L29:
	;
...
L31:
	;
	v133 = int32(_a_F_mic_to_big5_3)
	goto L29
L32:
	;
	v133 = int32(_a_F_mic_to_big5_4)
	goto L29
L33:
	;
	v127 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_mic_to_big5[0])))
	v136 = v127
	goto L28
L34:
	;
	v125 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_mic_to_big5[1])))
	v136 = v125
	goto L28
L35:
	;
	v123 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_mic_to_big5[2])))
	v136 = v123
	goto L28
L36:
	;
	v121 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_mic_to_big5[3])))
	v136 = v121
	goto L28
L37:
	;
	v119 = F_BinarySearchRange(m, int32(_a_F_mic_to_big5_5), int32(47), v80)
	mBase = m.M
	v136 = v119
	goto L28
L38:
	;
	v116 = F_BinarySearchRange(m, int32(_a_F_mic_to_big5_6), int32(24), v80)
	mBase = m.M
	v136 = v116
	goto L28
L39:
...
L40:
	;
	if v80 <= int32(_a_F_mic_to_big5_7) {
		goto L42
	} else {
		goto L43
	}
...
L44:
	;
	if v80 <= int32(_a_F_mic_to_big5_11) {
		goto L48
	} else {
		goto L49
	}
...
L47:
	;
	v99 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_mic_to_big5[4])))
	v136 = v99
	goto L28
L48:
	;
...
L52:
	;
	v107 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_mic_to_big5[5])))
	v136 = v107
	goto L28
L53:
	;
...
L54:
	;
	v113 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_mic_to_big5[6])))
	v136 = v113
	goto L28
L55:
	;
	v133 = int32(_a_F_mic_to_big5_18)
	goto L29
L56:
	;
	if v11 != 0 {
