...
L1:
	;
	return v124 & int32(_a_F_entryFindChildPtr_0)
L2:
	;
	if v70&int32(_a_F_entryFindChildPtr_0) != 0 {
		goto L14
	} else {
		goto L15
	}
...
L6:
	...
	v34 = l1 + v31&int32(_a_F_entryFindChildPtr_2)
...
L8:
	;
	v49 = v44 + int32(1)
	v50 = int32(_a_F_entryFindChildPtr_0)
	v51 = v49 & v50
...
L12:
	...
	v63 = l1 + v60&int32(_a_F_entryFindChildPtr_2)
...
L17:
	;
	v96 = *(*int32)(unsafe.Add(mBase, uint32(v85&int32(_a_F_entryFindChildPtr_0)<<(uint(int32(2))%32)+(l1+int32(24))-int32(4))))
	v99 = l1 + v96&int32(_a_F_entryFindChildPtr_2)
...
L19:
	;
	v107 = v85 + int32(1)
	v108 = int32(_a_F_entryFindChildPtr_0)
...
func F_entryPrepareDownlink(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if base.Ui32(v44) < base.Ui32(int32(25)) {
		...
		v55 = int32(base.Ui32(v44+int32(_a_F_entryPrepareDownlink_0))>>(uint(int32(2))%32))&int32(_a_F_entryPrepareDownlink_1) - int32(1)
	}
	v59 = *(*int32)(unsafe.Add(mBase, uint32(v23+v55<<(uint(int32(2))%32))+24))
	v62 = v23 + v59&int32(_a_F_entryPrepareDownlink_2)
	...
	if v67 != 0 {
		...
		if v70&int32(2) == int32(0) {
			...
			v101 = F_palloc(m, v98&int32(_a_F_entryPrepareDownlink_3))
			mBase = m.M
			v102 = m.ExcPending
			if v102 != 0 {
				return int32(0)
				...
				v105 = v103 & int32(_a_F_entryPrepareDownlink_3)
				if v105 != 0 {
			...
			if v75 == int32(_a_F_entryPrepareDownlink_1) {
				v98 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v62)+6)))
				v101 = F_palloc(m, v98&int32(_a_F_entryPrepareDownlink_3))
				mBase = m.M
				v102 = m.ExcPending
				...
				if v90 != 0 {
					...
					v96 = v93&int32(_a_F_entryPrepareDownlink_4) | v88
