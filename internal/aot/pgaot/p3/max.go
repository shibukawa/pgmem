...
func F_InitializeMaxBackends(m *base.Module) {
	...
	v5 = v3 - int32(32)
	m.G0 = v5
	v9 = *(*int32)(unsafe.Add(mBase, _c_F_InitializeMaxBackends[0]))
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_InitializeMaxBackends[1]))
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_InitializeMaxBackends[2]))
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_InitializeMaxBackends[3]))
	v20 = v9 + (v11 + (v13 + v15)) + int32(2)
	*(*int32)(unsafe.Add(mBase, _c_F_InitializeMaxBackends[4])) = v20
	if base.Ui32(int32(_a_F_InitializeMaxBackends_0)) <= base.Ui32(v20) {
		...
		if v27 != 0 {
			...
			if v30 != 0 {
				...
				F_errmsg(m, int32(_a_F_InitializeMaxBackends_1), int32(0))
				mBase = m.M
				v34 = m.ExcPending
				if v34 != 0 {
					return
				} else {
					*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = int32(_a_F_InitializeMaxBackends_2)
					v38 = *(*int32)(unsafe.Add(mBase, _c_F_InitializeMaxBackends[2]))
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = v38
					v41 = *(*int32)(unsafe.Add(mBase, _c_F_InitializeMaxBackends[3]))
					*(*int32)(unsafe.Add(mBase, uint32(v5)+4)) = v41
					v44 = *(*int32)(unsafe.Add(mBase, _c_F_InitializeMaxBackends[1]))
