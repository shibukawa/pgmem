	...
	if base.Ui32(int32(262144)) <= base.Ui32(v20) {
		...
		if v27 != 0 {
			...
			if v30 != 0 {
				...
				F_errmsg(m, int32(472893), int32(0))
				mBase = m.M
				v34 = m.ExcPending
				if v34 != 0 {
					return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5)+12)) = v47
					F_errdetail(m, int32(685932), v5)
					mBase = m.M
					v51 = m.ExcPending
					if v51 != 0 {
						return
					} else {
						F_errfinish(m, int32(518305), int32(570), int32(183975))
						mBase = m.M
						v56 = m.ExcPending
						if v56 != 0 {
							return
...
func F_MaxLivePostmasterChildren(m *base.Module) int32 {
	...
	if v3 == int32(0) {
		...
		if v11 != 0 {
			...
			F_errmsg_internal(m, int32(112561), int32(0))
			mBase = m.M
			v15 = m.ExcPending
			if v15 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(526309), int32(73), int32(295857))
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					return int32(0)
