	...
	*(*uint16)(unsafe.Add(mBase, uint32(v8)+22)) = uint16(v3)
	...
	if v14 != 0 {
		...
		if v17 != 0 {
			...
			F_TupleDescInitBuiltinEntry(m, v16, int32(1), int32(216902), int32(25))
			mBase = m.M
			v22 = m.ExcPending
			if v22 != 0 {
				return
			} else {
				F_TupleDescInitBuiltinEntry(m, v16, int32(2), int32(335075), int32(20))
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return
				} else {
					v29 = F_begin_tup_output_tupdesc(m, v13, v16, int32(1650708))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return
						...
						*(*uint32)(unsafe.Add(mBase, uint32(v8))) = uint32(v33)
						v36 = F_psprintf(m, int32(540625), v8)
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return
