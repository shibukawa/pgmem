...
func F__emscripten_timeout(m *base.Module, l0 int32, l1 float64) {
	...
	v14 = *(*float64)(unsafe.Add(mBase, uint32(v9)+uint32(_c_F__emscripten_timeout[0])))
	if base.F64_ne(v14, v3) != 0 {
		v17 = *(*float64)(unsafe.Add(mBase, uint32(v9)+uint32(_c_F__emscripten_timeout[1])))
		...
		*(*float64)(unsafe.Add(mBase, uint32(v9)+uint32(_c_F__emscripten_timeout[1]))) = v41
		v48 = base.F64_sub(v41, v18)
	} else {
		*(*int64)(unsafe.Add(mBase, uint32(v9)+uint32(_c_F__emscripten_timeout[1]))) = int64(0)
		v48 = v3
	}
...
L23:
	;
	v507 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[2]))
	if v507 == v55 {
		goto L136
	} else {
		goto L137
...
L52:
	...
	v174 = *(*int32)(unsafe.Add(mBase, uint32(v171)+uint32(_c_F_emscripten_builtin_realloc[6])))
	if v174 == v91 {
		goto L54
	} else {
		goto L55
...
L54:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v171)+uint32(_c_F_emscripten_builtin_realloc[6]))) = v160
	if v160 != 0 {
		goto L53
	} else {
		goto L57
...
L98:
	...
	v326 = *(*int32)(unsafe.Add(mBase, uint32(v323)+uint32(_c_F_emscripten_builtin_realloc[6])))
	if v326 == v81 {
		goto L100
	} else {
		goto L101
...
L100:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v323)+uint32(_c_F_emscripten_builtin_realloc[6]))) = v312
	if v312 != 0 {
		goto L99
	} else {
		goto L103
...
L123:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v199)+16)) = int64(0)
	...
	v426 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7]))
...
L126:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7])) = v428 | v426
	*(*int32)(unsafe.Add(mBase, uint32(v422)+uint32(_c_F_emscripten_builtin_realloc[6]))) = v199
	*(*int32)(unsafe.Add(mBase, uint32(v199)+24)) = v422 + int32(_a_F_emscripten_builtin_realloc_5)
	goto L125
L127:
	;
	goto L128
...
L131:
	;
	v446 = *(*int32)(unsafe.Add(mBase, uint32(v422)+uint32(_c_F_emscripten_builtin_realloc[6])))
...
L136:
	;
	v510 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[8]))
	v511 = v510 + v37
...
L138:
	;
	v529 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[3]))
	if v529 == v55 {
		goto L140
	} else {
		goto L141
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[8])) = v520
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[2])) = v519
	goto L20
L140:
	;
	v532 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[5]))
	v533 = v532 + v37
...
L144:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[3])) = v568
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[5])) = v569
	goto L20
L145:
	;
	v538 = int32(1)
...
L154:
	;
	v587 = int32(_a_F_emscripten_builtin_realloc_0)
	v589 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[4])) = v589 & base.I32_rotl(int32(-2), int32(base.Ui32(v574)>>(uint(int32(3))%32)))
	goto L150
L155:
	;
	goto L156
...
L170:
	...
	v655 = *(*int32)(unsafe.Add(mBase, uint32(v652)+uint32(_c_F_emscripten_builtin_realloc[6])))
	if v655 == v55 {
		goto L172
	} else {
		goto L173
...
L172:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v652)+uint32(_c_F_emscripten_builtin_realloc[6]))) = v637
	if v637 != 0 {
		goto L171
	} else {
		goto L175
...
L175:
	;
	v658 = int32(_a_F_emscripten_builtin_realloc_1)
	v660 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7]))
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7])) = v660 & base.I32_rotl(int32(-2), v650)
	goto L150
L176:
	;
	if v637 == int32(0) {
...
L192:
	...
	v737 = v736 + v581
	v738 = v712 - v736
	v740 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[3]))
	if v738 != v740 {
		goto L196
	} else {
		goto L197
...
L202:
	;
	v747 = int32(_a_F_emscripten_builtin_realloc_0)
	v749 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[4])) = v749 & base.I32_rotl(int32(-2), int32(base.Ui32(v736)>>(uint(int32(3))%32)))
	v846 = v738
	v847 = v737
	goto L190
L203:
...
L214:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[5])) = v737
...
L215:
	...
	v821 = *(*int32)(unsafe.Add(mBase, uint32(v818)+uint32(_c_F_emscripten_builtin_realloc[6])))
	if v821 == v738 {
		goto L217
	} else {
		goto L218
...
L217:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v818)+uint32(_c_F_emscripten_builtin_realloc[6]))) = v807
	if v807 != 0 {
		goto L216
	} else {
		goto L220
...
L220:
	;
	v824 = int32(_a_F_emscripten_builtin_realloc_1)
	v826 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7]))
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7])) = v826 & base.I32_rotl(int32(-2), v816)
	v846 = v738
	v847 = v737
	goto L190
L221:
...
L234:
	;
	v861 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[2]))
	if v861 == v728 {
		goto L237
	} else {
		goto L238
...
L237:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[2])) = v846
	v865 = int32(_a_F_emscripten_builtin_realloc_2)
	v867 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[8]))
	v868 = v867 + v847
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[8])) = v868
	*(*int32)(unsafe.Add(mBase, uint32(v846)+4)) = v868 | int32(1)
	v874 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[3]))
	if v846 != v874 {
		goto L189
	} else {
		goto L240
...
L239:
	;
	v883 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[3]))
	if v883 == v728 {
		goto L241
	} else {
		goto L242
...
L240:
	;
	v877 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[5])) = v877
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[3])) = v877
	goto L188
L241:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[3])) = v846
	v887 = int32(_a_F_emscripten_builtin_realloc_3)
	v889 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[5]))
	v890 = v889 + v847
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[5])) = v890
...
L247:
	;
	v905 = int32(_a_F_emscripten_builtin_realloc_0)
	v907 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[4])) = v907 & base.I32_rotl(int32(-2), int32(base.Ui32(v855)>>(uint(int32(3))%32)))
	goto L231
L248:
	;
	goto L249
...
L261:
	...
	v973 = *(*int32)(unsafe.Add(mBase, uint32(v970)+uint32(_c_F_emscripten_builtin_realloc[6])))
	if v973 == v728 {
		goto L263
	} else {
		goto L264
...
L263:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v970)+uint32(_c_F_emscripten_builtin_realloc[6]))) = v959
	if v959 != 0 {
		goto L262
	} else {
		goto L266
...
L266:
	;
	v976 = int32(_a_F_emscripten_builtin_realloc_1)
	v978 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7]))
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7])) = v978 & base.I32_rotl(int32(-2), v968)
	goto L231
L267:
	;
	if v959 == int32(0) {
...
L276:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[5])) = v899
	goto L188
L277:
	;
	v1027 = v1016 & int32(-8)
	v1029 = v1027 + int32(_a_F_emscripten_builtin_realloc_4)
	v1031 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[4]))
...
L280:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v1027)+uint32(_c_F_emscripten_builtin_realloc[9]))) = v846
...
L281:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[4])) = v1035 | v1031
	v1043 = v1029
	goto L280
L282:
	;
...
L283:
	;
	v1042 = *(*int32)(unsafe.Add(mBase, uint32(v1027)+uint32(_c_F_emscripten_builtin_realloc[9])))
	v1043 = v1042
	goto L280
L284:
	;
...
L286:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v846)+16)) = int64(0)
	...
	v1073 = *(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7]))
...
L289:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_emscripten_builtin_realloc[7])) = v1075 | v1073
	*(*int32)(unsafe.Add(mBase, uint32(v1069)+uint32(_c_F_emscripten_builtin_realloc[6]))) = v846
	*(*int32)(unsafe.Add(mBase, uint32(v846)+24)) = v1069 + int32(_a_F_emscripten_builtin_realloc_5)
	goto L288
L290:
	;
	goto L291
...
L294:
	;
	v1093 = *(*int32)(unsafe.Add(mBase, uint32(v1069)+uint32(_c_F_emscripten_builtin_realloc[6])))
