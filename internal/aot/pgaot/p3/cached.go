...
func F_CreateCachedPlan(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v13 = F_AllocSetContextCreateInternal(m, v8, int32(396289), int32(0), int32(1024), int32(8388608))
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		return int32(0)
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30))) = v75
	F_errmsg_internal(m, int32(42408), v30)
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		v924 = v72
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+60)) = v63
	*(*uint8)(unsafe.Add(mBase, uint32(v30)+31)) = uint8(v81)
	F_errfinish(m, int32(477527), int32(501), int32(368483))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		v924 = v72
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+60)) = v63
	*(*uint8)(unsafe.Add(mBase, uint32(v30)+31)) = uint8(v81)
	F_errmsg_internal(m, int32(66567), int32(0))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		v924 = v72
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+60)) = v63
	*(*uint8)(unsafe.Add(mBase, uint32(v30)+31)) = uint8(v81)
	F_errfinish(m, int32(477527), int32(229), int32(335504))
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		v924 = v72
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+56)) = v653
	*(*int32)(unsafe.Add(mBase, uint32(v30)+60)) = v650
	v721 = F_hash_create(m, int32(308741), int32(128), v650, int32(200))
	mBase = m.M
	v722 = m.ExcPending
	if v722 != 0 {
		v924 = v661
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+60)) = v650
	*(*uint8)(unsafe.Add(mBase, uint32(v30)+31)) = uint8(v678)
	F_errmsg_internal(m, int32(108372), int32(0))
	mBase = m.M
	v780 = m.ExcPending
	if v780 != 0 {
		v924 = v661
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+60)) = v650
	*(*uint8)(unsafe.Add(mBase, uint32(v30)+31)) = uint8(v678)
	F_errfinish(m, int32(477527), int32(181), int32(77711))
	mBase = m.M
	v798 = m.ExcPending
	if v798 != 0 {
		v924 = v661
