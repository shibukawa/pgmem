...
func F_stream_abort_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	v8 = v6 - int32(32)
	m.G0 = v8
	v10 = int32(_a_F_stream_abort_cb_wrapper_0)
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_stream_abort_cb_wrapper[0]))
	v12 = *(*int32)(unsafe.Add(mBase, uint32(l0)+112))
	*(*int32)(unsafe.Add(mBase, _c_F_stream_abort_cb_wrapper[0])) = v8 + int32(4)
	...
	if v34 == int32(0) {
		...
		if v40 != 0 {
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(_a_F_stream_abort_cb_wrapper_2)
				F_errmsg(m, int32(_a_F_stream_abort_cb_wrapper_3), v8)
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
		...
		if v55 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _c_F_stream_abort_cb_wrapper[0])) = v57
			m.G0 = v8 + int32(32)
			return
		}
	}
...
func F_stream_start_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	v8 = v6 - int32(32)
	m.G0 = v8
	v10 = int32(_a_F_stream_start_cb_wrapper_0)
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_stream_start_cb_wrapper[0]))
	v12 = *(*int32)(unsafe.Add(mBase, uint32(l0)+112))
	*(*int32)(unsafe.Add(mBase, _c_F_stream_start_cb_wrapper[0])) = v8 + int32(4)
	*(*int64)(unsafe.Add(mBase, uint32(v8)+24)) = l2
	...
	if v34 == v4 {
		...
		if v40 != 0 {
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(_a_F_stream_start_cb_wrapper_2)
				F_errmsg(m, int32(_a_F_stream_start_cb_wrapper_3), v8)
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
		...
		if v55 != 0 {
			...
			v57 = *(*int32)(unsafe.Add(mBase, uint32(v8)+4))
			*(*int32)(unsafe.Add(mBase, _c_F_stream_start_cb_wrapper[0])) = v57
			m.G0 = v8 + int32(32)
			return
		}
	}
