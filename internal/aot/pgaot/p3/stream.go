...
func F_stream_abort_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(86750)
	...
	if v34 == int32(0) {
		...
		if v40 != 0 {
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(524222)
				...
				if v48 != 0 {
					...
					F_errfinish(m, int32(517668), int32(1399), int32(227198))
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return
...
func F_stream_start_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[52])) = v8 + int32(4)
	*(*int64)(unsafe.Add(mBase, uint32(v8)+24)) = l2
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(88145)
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v12
	*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = int32(993)
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v11
	*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = v8 + int32(16)
	...
	if v34 == v4 {
		...
		if v40 != 0 {
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(524238)
				F_errmsg(m, int32(331621), v8)
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					...
					F_errfinish(m, int32(517668), int32(1309), int32(227222))
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return
