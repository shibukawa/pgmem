		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+8)) = v15
			...
			v25 = *(*int32)(unsafe.Add(mBase, uint32(v20*int32(28))+uint32(_consts[980])))
...
L109:
	;
	F_errfinish(m, int32(511181), int32(194), int32(217169))
	mBase = m.M
	v614 = m.ExcPending
	if v614 != 0 {
		goto L10
...
L19:
	;
	F_errfinish(m, int32(515430), int32(869), int32(225032))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L1
...
L101:
	;
	F_errmsg(m, int32(160648), int32(0))
	mBase = m.M
	v551 = m.ExcPending
	if v551 != 0 {
		goto L1
...
L102:
	;
	F_errfinish(m, int32(515430), int32(845), int32(225032))
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L1
