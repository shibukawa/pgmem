...
L9:
	;
	F_pg_qsort(m, v24, v21, int32(16), int32(1170))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L10
...
L11:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v31))) = uint16(v36)
	...
	v40 = int32(_a_F_make_tsvector_0)
...
L16:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v55))) = uint16(v58)
	...
	v61 = int32(_a_F_make_tsvector_0)
...
L42:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v145))) = uint16(v148)
	...
	v151 = int32(_a_F_make_tsvector_0)
...
L47:
	...
	if v167 == int32(_a_F_make_tsvector_0) {
		v230 = v69
		goto L22
	} else {
		goto L48
...
L48:
	;
	v170 = int32(_a_F_make_tsvector_0)
	v172 = v75 + int32(24)
...
L53:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v69)+6)) = uint16(v183)
	v189 = F_repalloc(m, v160, v178<<(uint(int32(2))%32)&int32(_a_F_make_tsvector_1))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L10
...
L55:
	;
	v198 = v196 & int32(_a_F_make_tsvector_2)
	if v198 == int32(0) {
		goto L58
	} else {
		goto L59
...
L58:
	;
	v201 = int32(_a_F_make_tsvector_0)
	v203 = v194 & int32(_a_F_make_tsvector_2)
...
L60:
	;
	v208 = int32(_a_F_make_tsvector_0)
	v210 = v194 & int32(_a_F_make_tsvector_2)
...
L71:
	;
	if int32(_a_F_make_tsvector_3) <= v303 {
		goto L1
	} else {
		goto L76
	}
...
L93:
	...
	v416 = int32(1)
	v427 = v340 + v409<<(uint(v410)%32) + (int32(base.Ui32(v413)>>(uint(int32(12))%32))+int32(base.Ui32(v413)>>(uint(v416)%32))&int32(2047)+v416)&int32(_a_F_make_tsvector_4) + v410
	v428 = int32(0)
	if v396 != v416 {
		goto L94
	} else {
...
L97:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v467))) = uint16(v482)
	v485 = v437 + v457
	if v485 != v396&int32(_a_F_make_tsvector_5) {
		v435 = v476
		v437 = v485
		goto L97
	} else {
...
L100:
	...
	v511 = int32(_a_F_make_tsvector_0)
	v512 = v510 & v511
...
L108:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v19)+4)) = int32(_a_F_make_tsvector_6)
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v303
	F_errmsg(m, int32(_a_F_make_tsvector_7), v19)
	mBase = m.M
	v609 = m.ExcPending
	if v609 != 0 {
		goto L10
...
L30:
	...
	v198 = v150 + v156<<(uint(int32(2))%32) + (v192+int32(base.Ui32(v179)>>(uint(int32(12))%32)))&int32(_a_F_tsvector_filter_3)
...
L36:
	;
	v253 = v213 + int32(1)
	if base.Ui32(v253) < base.Ui32(v251&int32(_a_F_tsvector_filter_4)) {
		v213 = v253
		v214 = v250
		v216 = v251
		goto L32
...
L43:
	...
	v304 = int32(2)
	v307 = int32(1)
	v319 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v143+v303<<(uint(v304)%32)+(int32(base.Ui32(v300)>>(uint(v307)%32))&int32(2047)+int32(base.Ui32(v300)>>(uint(int32(12))%32))+v307)&int32(_a_F_tsvector_filter_5)))))
