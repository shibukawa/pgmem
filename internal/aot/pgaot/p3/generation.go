...
func F_GenerationContextCreate(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v18 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v18)+12)) = int32(1744240)
		if l0 != 0 {
				...
				if v112 != 0 {
					...
					if v116 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v11))) = l1
						F_errdetail(m, int32(641120), v11)
						mBase = m.M
						v120 = m.ExcPending
						if v120 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(488686), int32(217), int32(350061))
							mBase = m.M
							v125 = m.ExcPending
							if v125 != 0 {
								return int32(0)
...
func F_GenerationStats(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if l1 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v16)+8)) = v64
		v77 = F_pg_snprintf(m, v16+int32(32), int32(200), int32(442735), v16)
		mBase = m.M
		v78 = m.ExcPending
		if v78 != 0 {
			return
