		...
		if v39 != 0 {
			...
			if v42 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v9
				F_errmsg(m, int32(483069), v7)
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496144), int32(283), int32(305004))
					mBase = m.M
					v51 = m.ExcPending
					if v51 != 0 {
						return int32(0)
					...
					if v55 != 0 {
						...
						if v58 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v9
							F_errmsg(m, int32(471671), v7+int32(16))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(496144), int32(292), int32(305004))
								mBase = m.M
								v69 = m.ExcPending
								if v69 != 0 {
									return int32(0)
...
func F_be_lo_unlink(m *base.Module, l0 int32) int32 {
	...
	F_PreventCommandIfReadOnly(m, int32(685469))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L1
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v12
	F_errmsg(m, int32(69046), v10+int32(16))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(496144), int32(323), int32(316373))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(496144), int32(334), int32(316373))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L1
			...
			if v52 != 0 {
				...
				if v55 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v23))) = v7
					F_errmsg(m, int32(483069), v23)
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496144), int32(162), int32(465266))
						mBase = m.M
						v64 = m.ExcPending
						if v64 != 0 {
							return int32(0)
						...
						if v68 != 0 {
							...
							if v71 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v7
								F_errmsg(m, int32(337646), v23+int32(16))
								mBase = m.M
								v77 = m.ExcPending
								if v77 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(496144), int32(174), int32(465266))
									mBase = m.M
									v82 = m.ExcPending
									if v82 != 0 {
										return int32(0)
