...
func F_be_lo_tell(m *base.Module, l0 int32) int32 {
	...
	if v9 < int32(0) {
		...
		v13 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_tell[0]))
		if v13 <= v9 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v39 = m.ExcPending
			...
			v16 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_tell[1]))
...
L5:
	;
	v21 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_be_lo_unlink[0])))
	if v21 == int32(0) {
		goto L8
	} else {
		goto L9
...
L8:
	;
	v26 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_unlink[1]))
...
L10:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_unlink[2]))
	if v32 == int32(0) {
		goto L13
	} else {
		goto L14
...
L14:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_unlink[3]))
	if v36 <= int32(0) {
		goto L13
	} else {
		goto L15
...
L15:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_unlink[4]))
	v42 = int32(0)
	v45 = v36
	v47 = v40
	goto L16
...
L21:
	;
	v61 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_unlink[5]))
...
L25:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_unlink[3]))
	v69 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_unlink[4]))
	v70 = v67
	v71 = v69
	goto L18
L26:
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v12
	F_errmsg(m, int32(_a_F_be_lo_unlink_1), v10+int32(16))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(_a_F_be_lo_unlink_2), int32(323), int32(_a_F_be_lo_unlink_3))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L1
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v12
	F_errmsg(m, int32(_a_F_be_lo_unlink_4), v10)
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(_a_F_be_lo_unlink_2), int32(334), int32(_a_F_be_lo_unlink_3))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L1
...
func F_be_loread(m *base.Module, l0 int32) int32 {
	...
	if v18 != 0 {
		...
		if v7 < int32(0) {
			...
			v28 = *(*int32)(unsafe.Add(mBase, _c_F_be_loread[0]))
			if v28 <= v7 {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v52 = m.ExcPending
				...
				v31 = *(*int32)(unsafe.Add(mBase, _c_F_be_loread[1]))
