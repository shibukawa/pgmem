...
func F_be_lo_tell(m *base.Module, l0 int32) int32 {
	...
	if v9 < int32(0) {
		...
		if v39 != 0 {
			...
			if v42 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v9
				F_errmsg(m, int32(481361), v7)
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(494386), int32(283), int32(303878))
					mBase = m.M
					v51 = m.ExcPending
					if v51 != 0 {
						return int32(0)
		...
		v13 = *(*int32)(unsafe.Add(mBase, _consts[564]))
		if v13 <= v9 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v39 = m.ExcPending
			...
			v16 = *(*int32)(unsafe.Add(mBase, _consts[565]))
					...
					if v55 != 0 {
						...
						if v58 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v9
							F_errmsg(m, int32(469963), v7+int32(16))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(494386), int32(292), int32(303878))
								mBase = m.M
								v69 = m.ExcPending
								if v69 != 0 {
									return int32(0)
...
func F_be_lo_unlink(m *base.Module, l0 int32) int32 {
	...
	F_PreventCommandIfReadOnly(m, int32(668274))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L1
...
L5:
	;
	v21 = int32(*(*uint8)(unsafe.Add(mBase, _consts[566])))
	if v21 == int32(0) {
		goto L8
	} else {
		goto L9
...
L21:
	;
	v61 = *(*int32)(unsafe.Add(mBase, _consts[568]))
...
L25:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[564]))
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v12
	F_errmsg(m, int32(68661), v10+int32(16))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(494386), int32(323), int32(315188))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(494386), int32(334), int32(315188))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L1
	...
	if v18 != 0 {
		...
		if v7 < int32(0) {
			...
			if v52 != 0 {
				...
				if v55 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v23))) = v7
					F_errmsg(m, int32(481361), v23)
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(494386), int32(162), int32(463558))
						mBase = m.M
						v64 = m.ExcPending
						if v64 != 0 {
							return int32(0)
			...
			if v28 <= v7 {
				...
				v31 = *(*int32)(unsafe.Add(mBase, _consts[565]))
						...
						if v68 != 0 {
							...
							if v71 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v7
								F_errmsg(m, int32(336430), v23+int32(16))
								mBase = m.M
								v77 = m.ExcPending
								if v77 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(494386), int32(174), int32(463558))
									mBase = m.M
									v82 = m.ExcPending
									if v82 != 0 {
										return int32(0)
