...
L5:
	;
	v628 = int32(_a_F_DefineQueryRewrite_0)
	v631 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_DefineQueryRewrite[0])))
...
L13:
	;
	v34 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_DefineQueryRewrite[1])))
	if v34 == int32(0) {
		goto L14
	} else {
		goto L15
...
L14:
	...
	if base.Ui32(v39) < base.Ui32(int32(_a_F_DefineQueryRewrite_1)) {
		v48 = v38
		goto L18
	} else {
		goto L19
...
L16:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _c_F_DefineQueryRewrite[2]))
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v176 + int32(4)
	F_errmsg(m, int32(_a_F_DefineQueryRewrite_8), v16)
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L10
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+96)) = v199 + int32(4)
	F_errmsg(m, int32(_a_F_DefineQueryRewrite_9), v16+int32(96))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L10
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v237 + int32(4)
	F_errmsg(m, int32(_a_F_DefineQueryRewrite_10), v16+int32(16))
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L10
...
L91:
	;
	v340 = int32(105)
	v341 = int32(_a_F_DefineQueryRewrite_0)
	v344 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_DefineQueryRewrite[0])))
...
L102:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v313 + int32(4)
	F_errmsg(m, int32(_a_F_DefineQueryRewrite_11), v16-int32(-64))
	mBase = m.M
	v321 = m.ExcPending
	if v321 != 0 {
		goto L10
...
L113:
	;
	v369 = int32(_a_F_DefineQueryRewrite_12)
	goto L116
L114:
	;
	if v406-v407 != 0 {
...
L143:
	;
	v466 = F_pstrdup(m, int32(_a_F_DefineQueryRewrite_0))
	mBase = m.M
	v467 = m.ExcPending
	if v467 != 0 {
		goto L10
...
L167:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+52)) = int32(_a_F_DefineQueryRewrite_0)
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v560 + int32(4)
	F_errmsg(m, int32(_a_F_DefineQueryRewrite_19), v16+int32(48))
	mBase = m.M
	v570 = m.ExcPending
	if v570 != 0 {
		goto L10
...
L191:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+84)) = int32(_a_F_DefineQueryRewrite_0)
	*(*int32)(unsafe.Add(mBase, uint32(v16)+80)) = v661 + int32(4)
	F_errmsg(m, int32(_a_F_DefineQueryRewrite_20), v16+int32(80))
	mBase = m.M
	v671 = m.ExcPending
	if v671 != 0 {
		goto L10
...
L226:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v726
	F_errmsg(m, int32(_a_F_DefineQueryRewrite_25), v16+int32(32))
	mBase = m.M
	v800 = m.ExcPending
	if v800 != 0 {
		goto L10
...
L242:
	;
	v881 = *(*int32)(unsafe.Add(mBase, _c_F_DefineQueryRewrite[3]))
	if v881 != 0 {
		goto L245
	} else {
		goto L246
...
L264:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v892))) = l2
	F_errmsg_internal(m, int32(_a_F_DefineQueryRewrite_27), v892)
	mBase = m.M
	v931 = m.ExcPending
	if v931 != 0 {
		goto L10
