							...
							if v122 != 0 {
								...
								if v127 != 0 {
									...
									if v131 != 0 {
										...
										F_errfinish(m, int32(494492), int32(1358), int32(394818))
										mBase = m.M
										v136 = m.ExcPending
										if v136 != 0 {
											return int32(0)
					...
					if int32(base.Ui32(v196)>>(uint(l4)%32))&v184 == int32(0) {
						...
						if v205 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v14))) = v208
							F_errmsg_internal(m, int32(429326), v14)
							mBase = m.M
							v216 = m.ExcPending
							if v216 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(494492), int32(1449), int32(394818))
								mBase = m.M
								v221 = m.ExcPending
								if v221 != 0 {
									return int32(0)
...
L24:
	;
	v165 = F_substitute_path_macro(m, v45, int32(212337), int32(4483808))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L22
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(319662)
	F_errmsg_internal(m, int32(694110), v9+int32(-48))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L22
...
L66:
	;
	F_errfinish(m, int32(491984), int32(631), int32(319662))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L22
...
L74:
	;
	F_errfinish(m, int32(491984), int32(606), int32(319662))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L22
...
L78:
	;
	F_errfinish(m, int32(491984), int32(625), int32(319662))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L22
		...
		if v39 != 0 {
			...
			if v42 != 0 {
				...
				if v46 != 0 {
					...
					F_errfinish(m, int32(496977), int32(413), int32(544968))
					mBase = m.M
					v51 = m.ExcPending
					if v51 != 0 {
						return int32(0)
					...
					if v366 != 0 {
						...
						if v369 != 0 {
							...
							if v373 != 0 {
								...
								F_errfinish(m, int32(496807), int32(2699), int32(487655))
								mBase = m.M
								v378 = m.ExcPending
								if v378 != 0 {
									return int32(0)
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(495450), int32(2180), int32(307640))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(495450), int32(2732), int32(307030))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
