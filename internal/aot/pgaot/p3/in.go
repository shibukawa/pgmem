							...
							if v122 != 0 {
								...
								if v127 != 0 {
									...
									if v131 != 0 {
										...
										F_errfinish(m, int32(474337), int32(1358), int32(378120))
										mBase = m.M
										v136 = m.ExcPending
										if v136 != 0 {
											return int32(0)
					...
					if int32(base.Ui32(v196)>>(uint(l4)%32))&v184 == int32(0) {
						...
						if v205 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v14))) = v208
							F_errmsg_internal(m, int32(411245), v14)
							mBase = m.M
							v216 = m.ExcPending
							if v216 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(474337), int32(1449), int32(378120))
								mBase = m.M
								v221 = m.ExcPending
								if v221 != 0 {
									return int32(0)
...
L58:
	;
	v277 = F_substitute_path_macro(m, v157, int32(202745), int32(4439456))
	mBase = m.M
	v278 = m.ExcPending
	if v278 != 0 {
		goto L56
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v277
	v350 = F_pg_sprintf(m, v343, int32(166924), v9+int32(-32))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L56
...
L114:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(305809)
	F_errmsg_internal(m, int32(670746), v9+int32(-48))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L56
...
L117:
	;
	F_errfinish(m, int32(472010), int32(631), int32(305809))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L56
...
L124:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(305687)
	F_errmsg(m, int32(659004), v11)
	mBase = m.M
	v410 = m.ExcPending
	if v410 != 0 {
		goto L56
...
L125:
	;
	F_errfinish(m, int32(472010), int32(606), int32(305809))
	mBase = m.M
	v415 = m.ExcPending
	if v415 != 0 {
		goto L56
...
L128:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = int32(305687)
	F_errmsg(m, int32(306076), v9+int32(-16))
	mBase = m.M
	v429 = m.ExcPending
	if v429 != 0 {
		goto L56
...
L129:
	;
	F_errfinish(m, int32(472010), int32(625), int32(305809))
	mBase = m.M
	v434 = m.ExcPending
	if v434 != 0 {
		goto L56
		...
		if v39 != 0 {
			...
			if v42 != 0 {
				...
				if v46 != 0 {
					...
					F_errfinish(m, int32(476775), int32(413), int32(524003))
					mBase = m.M
					v51 = m.ExcPending
					if v51 != 0 {
						return int32(0)
					...
					if v366 != 0 {
						...
						if v369 != 0 {
							...
							if v373 != 0 {
								...
								F_errfinish(m, int32(476611), int32(2699), int32(467951))
								mBase = m.M
								v378 = m.ExcPending
								if v378 != 0 {
									return int32(0)
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(475273), int32(2180), int32(294054))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(475273), int32(2732), int32(293566))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
