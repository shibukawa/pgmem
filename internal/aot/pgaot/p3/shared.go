	...
	if int32(0) <= v13 {
		...
		if v17+int32(38) <= v13 {
			...
			if v90 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = v95 + int32(38)
				F_errmsg_internal(m, int32(680192), v10+int32(16))
				mBase = m.M
				v103 = m.ExcPending
				if v103 != 0 {
					return
				} else {
					F_errfinish(m, int32(493334), int32(282), int32(100516))
					mBase = m.M
					v108 = m.ExcPending
					if v108 != 0 {
						return
					...
					if v114 != 0 {
						...
						if v118 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v121
							F_errmsg_internal(m, int32(469060), v10)
							mBase = m.M
							v125 = m.ExcPending
							if v125 != 0 {
								return
							} else {
								F_errfinish(m, int32(493334), int32(297), int32(100516))
								mBase = m.M
								v130 = m.ExcPending
								if v130 != 0 {
									return
		...
		if v77 != 0 {
			...
			if v81 != 0 {
				...
				F_errfinish(m, int32(493334), int32(279), int32(100516))
				mBase = m.M
				v86 = m.ExcPending
				if v86 != 0 {
					return
...
func F_process_shared_preload_libraries(m *base.Module) {
	...
	*(*uint8)(unsafe.Add(mBase, _consts[1120])) = uint8(v2)
	...
	F_load_libraries(m, v5, int32(168226), int32(0))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
