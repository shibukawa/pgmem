	...
	if int32(0) <= v13 {
		...
		if v17+int32(38) <= v13 {
			...
			if v90 != 0 {
				...
				v92 = *(*int32)(unsafe.Add(mBase, _c_F_SharedInvalBackendInit[0]))
				*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v92
				v95 = *(*int32)(unsafe.Add(mBase, _c_F_SharedInvalBackendInit[1]))
				*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = v95 + int32(38)
				...
				if v103 != 0 {
					...
					F_errfinish(m, int32(_a_F_SharedInvalBackendInit_1), int32(282), int32(_a_F_SharedInvalBackendInit_2))
					mBase = m.M
					v108 = m.ExcPending
					if v108 != 0 {
						return
				...
				if v33 != 0 {
						...
						if v118 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v121
							...
							if v125 != 0 {
								...
								F_errfinish(m, int32(_a_F_SharedInvalBackendInit_1), int32(297), int32(_a_F_SharedInvalBackendInit_2))
								mBase = m.M
								v130 = m.ExcPending
								if v130 != 0 {
									return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v32)+uint32(_c_F_SharedInvalBackendInit[13]))) = v55
					...
					if v67 != 0 {
						...
						F_on_shmem_exit(m, int32(1109), v22)
						mBase = m.M
						v70 = m.ExcPending
						if v70 != 0 {
							return
		...
		if v77 != 0 {
			...
			if v81 != 0 {
				...
				F_errfinish(m, int32(_a_F_SharedInvalBackendInit_1), int32(279), int32(_a_F_SharedInvalBackendInit_2))
				mBase = m.M
				v86 = m.ExcPending
				if v86 != 0 {
					return
...
func F_shared_record_typmod_registry_detach(m *base.Module, l0 int32, l1 int32) {
	...
	var v20 int32
	_ = v20
	v4 = *(*int32)(unsafe.Add(mBase, _c_F_shared_record_typmod_registry_detach[0]))
	...
	if v5 != 0 {
		...
		if v7 != 0 {
			...
			v9 = *(*int32)(unsafe.Add(mBase, _c_F_shared_record_typmod_registry_detach[0]))
			*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = int32(0)
			...
			if v13 != 0 {
				...
				if v15 != 0 {
					...
					v17 = *(*int32)(unsafe.Add(mBase, _c_F_shared_record_typmod_registry_detach[0]))
