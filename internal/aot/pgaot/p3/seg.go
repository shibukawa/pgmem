...
L47:
	;
	F_yy_fatal_error_7(m, int32(683373))
	mBase = m.M
	v1218 = m.ExcPending
	if v1218 != 0 {
		goto L19
...
L48:
	;
	F_yy_fatal_error_7(m, int32(453865))
	mBase = m.M
	v1215 = m.ExcPending
	if v1215 != 0 {
		goto L19
...
L49:
	;
	F_yy_fatal_error_7(m, int32(449628))
	mBase = m.M
	v1212 = m.ExcPending
	if v1212 != 0 {
		goto L19
...
L52:
	;
	F_yy_fatal_error_7(m, int32(423790))
	mBase = m.M
	v1203 = m.ExcPending
	if v1203 != 0 {
		goto L19
...
L56:
	;
	F_yy_fatal_error_7(m, int32(453217))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L19
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v262))) = int32(546002)
	return int32(261)
L60:
	;
	v257 = *(*int32)(unsafe.Add(mBase, uint32(v86)+92))
	*(*int32)(unsafe.Add(mBase, uint32(v257))) = int32(546060)
	return int32(261)
L61:
	;
...
L2:
	;
	F_seg_yyerror(m, l0, l1, l2, int32(440648))
	mBase = m.M
	v942 = m.ExcPending
	if v942 != 0 {
		goto L12
...
L4:
	;
	F_seg_yyerror(m, l0, l1, l2, int32(212002))
	mBase = m.M
	v936 = m.ExcPending
	if v936 != 0 {
		goto L12
...
L52:
	...
	v782 = F_float4in_internal(m, v780, int32(337529), v780, l1)
	mBase = m.M
	v783 = m.ExcPending
	if v783 != 0 {
		goto L12
...
L53:
	...
	v695 = F_float4in_internal(m, v693, int32(337529), v693, l1)
	mBase = m.M
	v696 = m.ExcPending
	if v696 != 0 {
		goto L12
...
L54:
	...
	v612 = F_float4in_internal(m, v610, int32(337529), v610, l1)
	mBase = m.M
	v613 = m.ExcPending
	if v613 != 0 {
		goto L12
...
L59:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v24)+16)) = base.F64_promote_f32(v196)
	v210 = F_pg_snprintf(m, v24+int32(48), int32(25), int32(337954), v24+v192)
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L12
...
L93:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v24))) = base.F64_promote_f32(v364)
	v371 = F_pg_snprintf(m, v24+int32(48), int32(25), int32(337954), v24)
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L12
...
L187:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v24)+32)) = base.F64_promote_f32(v539)
	F_errmsg(m, int32(337860), v24+int32(32))
	mBase = m.M
	v551 = m.ExcPending
	if v551 != 0 {
		goto L12
...
L188:
	;
	F_errsave_finish(m, l1, int32(26997), int32(86), int32(360567))
	mBase = m.M
	v558 = m.ExcPending
	if v558 != 0 {
		goto L12
