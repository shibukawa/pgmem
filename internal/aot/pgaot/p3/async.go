...
func F_asyncQueueUnregister(m *base.Module) {
	...
	var v84 int32
	_ = v84
	v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[459])))
	if v7 != 0 {
		goto L1
	} else {
		goto L2
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v48))) = v54
	v57 = *(*int32)(unsafe.Add(mBase, _consts[112]))
	v65 = v57
	goto L6
L12:
	;
...
L16:
	;
	v84 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[459])) = uint8(v84)
	goto L3
}
