...
func F_asyncQueueUnregister(m *base.Module) {
	...
	var v84 int32
	_ = v84
	v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[457])))
	if v7 != 0 {
		goto L1
	} else {
		goto L2
...
L5:
	;
	v16 = *(*int32)(unsafe.Add(mBase, _consts[458]))
	v18 = v16 + int32(56)
	v19 = int32(4122192)
	v20 = *(*int32)(unsafe.Add(mBase, _consts[109]))
	v21 = int32(5)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16+v27<<(uint(v21)%32))+60)) = int32(0)
	...
	v35 = *(*int32)(unsafe.Add(mBase, _consts[109]))
	if v33 != v35 {
		goto L7
	} else {
		goto L8
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v48))) = v54
	v57 = *(*int32)(unsafe.Add(mBase, _consts[109]))
	v65 = v57
	goto L6
L12:
	;
...
L16:
	;
	v84 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[457])) = uint8(v84)
	goto L3
}
