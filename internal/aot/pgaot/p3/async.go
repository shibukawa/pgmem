...
L5:
	...
	v18 = v16 + int32(56)
	v19 = int32(_a_F_asyncQueueUnregister_0)
	v20 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueUnregister[3]))
	v21 = int32(5)
	*(*int32)(unsafe.Add(mBase, uint32(v18+v20<<(uint(v21)%32)))) = int32(-1)
	v27 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueUnregister[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v16+v27<<(uint(v21)%32))+60)) = int32(0)
	v33 = *(*int32)(unsafe.Add(mBase, uint32(v16)+40))
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueUnregister[3]))
	if v33 != v35 {
		goto L7
	} else {
		goto L8
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16+v65<<(uint(int32(5))%32)-int32(-64)))) = int32(-1)
	v78 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueUnregister[1]))
...
L16:
	;
	v84 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_asyncQueueUnregister[0])) = uint8(v84)
	goto L3
}
