				...
				if v49 != 0 {
					...
					if v51 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v14))) = v50
						F_errmsg(m, int32(179917), v14)
						mBase = m.M
						v55 = m.ExcPending
						if v55 != 0 {
							return
						} else {
							F_errhint(m, int32(535115), int32(0))
							mBase = m.M
							v59 = m.ExcPending
							if v59 != 0 {
								return
							} else {
								F_errfinish(m, int32(473801), int32(217), int32(122665))
								mBase = m.M
								v64 = m.ExcPending
								if v64 != 0 {
									return
						...
						if v71 != 0 {
							...
							if v73 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v72
								F_errmsg(m, int32(179758), v14+int32(16))
								mBase = m.M
								v79 = m.ExcPending
								if v79 != 0 {
									return
								} else {
									F_errfinish(m, int32(473801), int32(222), int32(122665))
									mBase = m.M
									v84 = m.ExcPending
									if v84 != 0 {
										return
