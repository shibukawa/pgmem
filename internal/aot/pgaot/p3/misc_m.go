		...
		*(*int32)(unsafe.Add(mBase, _consts[0])) = v11
		...
		if v17 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v22
			v28 = F_AllocSetContextCreateInternal(m, v22, int32(67679), int32(0), int32(8192), int32(8388608))
			mBase = m.M
			v29 = m.ExcPending
			if v29 != 0 {
				return int32(0)
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v8 + int32(8)
	v23 = F_pg_sprintf(m, l0, int32(41829), v8)
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L1
...
L14:
	;
	F_plpgsql_yyerror(m, l4, int32(0), l5, int32(433797))
	mBase = m.M
	v489 = m.ExcPending
	if v489 != 0 {
		goto L1
...
L82:
	;
	F_plpgsql_yyerror(m, l4, int32(0), l5, int32(262175))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L1
...
L104:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+32)) = int32(7311)
	v396 = int32(4546792)
...
L16:
	;
	F_errmsg_internal(m, int32(299057), int32(0))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
L17:
	;
	F_errfinish(m, int32(516379), int32(3456), int32(443401))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L1
...
L50:
	;
	F_errsave_finish(m, v152, int32(513804), int32(714), int32(314823))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
...
L63:
	;
	F_errmsg_internal(m, int32(318062), int32(0))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L64:
	;
	F_errfinish(m, int32(513804), int32(639), int32(332932))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
...
func F_manifest_process_system_identifier(m *base.Module, l0 int32, l1 int64) {
	...
	if v12 != l1 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8))) = l1
		m.T0[v14].(func(*base.Module, int32, int32, int32))(m, l0, int32(39373), v8)
		mBase = m.M
		v19 = m.ExcPending
		if v19 != 0 {
			return
				...
				if v34 == int32(0) {
					...
					if v39 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8)+40)) = v8 + int32(56)
						F_errmsg(m, int32(311651), v8+int32(32))
						mBase = m.M
						v54 = m.ExcPending
						if v54 != 0 {
							return
							...
							v88 = int32(2064)
							F_errfinish(m, int32(522539), v88, int32(86781))
							mBase = m.M
							v91 = m.ExcPending
							if v91 != 0 {
								return
	...
	if v7 == int32(0) {
		...
		if v10 == int32(0) {
			...
			if v19 != 0 {
				...
				if int32(0) <= v18 {
					if v18 == int32(0) {
						F_px_debug(m, int32(354185), int32(0))
						mBase = m.M
						v27 = m.ExcPending
						if v27 != 0 {
							return int32(0)
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+32)) = v27
	F_errmsg(m, int32(309351), v23+int32(32))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L15
...
L67:
	;
	F_errfinish(m, int32(522409), int32(184), int32(438439))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L15
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v27
	F_errmsg(m, int32(309722), v23+int32(16))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		goto L15
...
L73:
	;
	F_errfinish(m, int32(522409), int32(158), int32(438439))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L15
...
L77:
	;
	F_errfinish(m, int32(522409), int32(174), int32(438439))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L15
...
L81:
	;
	F_errfinish(m, int32(522409), int32(194), int32(438439))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L15
...
L108:
	;
	F_errfinish(m, int32(522539), int32(252), int32(371724))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L15
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v290))) = (l0 - v352) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(699700), v290)
	mBase = m.M
	v394 = m.ExcPending
	if v394 != 0 {
		goto L1
...
L65:
	;
	F_errfinish(m, int32(520488), int32(215), int32(421281))
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L1
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v268)+12)) = v498
	F_errmsg_internal(m, int32(710587), v268)
	mBase = m.M
	v510 = m.ExcPending
	if v510 != 0 {
		goto L1
...
L88:
	;
	F_errfinish(m, int32(518466), int32(459), int32(421266))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
L103:
	;
	F_errfinish(m, int32(522539), int32(1009), int32(37034))
	mBase = m.M
	v619 = m.ExcPending
	if v619 != 0 {
		goto L1
...
L108:
	;
	F_errfinish(m, int32(522539), int32(1037), int32(37034))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L1
...
func F_message_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32, l4 int32, l5 int32, l6 int32) {
	...
	if v16 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13)+20)) = int32(422951)
