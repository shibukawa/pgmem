...
func F_check_default_tablespace(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	m.G0 = v8
	v10 = int32(1)
	v12 = *(*int32)(unsafe.Add(mBase, _c_F_check_default_tablespace[0]))
	...
	if base.B2i32(v13 == int32(2)) == int32(0) {
		...
		v19 = *(*int32)(unsafe.Add(mBase, _c_F_check_default_tablespace[1]))
		if v19 == int32(0) {
			v66 = v10
			m.G0 = v8 + int32(32)
			return v66
				...
				if v30 != 0 {
					...
					if v27 != 0 {
						...
						if l2 == int32(12) {
								...
								if v35 == int32(0) {
									...
									if v41 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v42
										F_errmsg(m, int32(_a_F_check_default_tablespace_0), v8)
										mBase = m.M
										v46 = m.ExcPending
										if v46 != 0 {
											return int32(0)
							...
							v54 = *(*int32)(unsafe.Add(mBase, _c_F_check_default_tablespace[2]))
							*(*int32)(unsafe.Add(mBase, _c_F_check_default_tablespace[3])) = v54
							v57 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
							*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v57
							v63 = F_format_elog_string(m, int32(_a_F_check_default_tablespace_3), v8+int32(16))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return int32(0)
							} else {
								*(*int32)(unsafe.Add(mBase, _c_F_check_default_tablespace[4])) = v63
								v66 = int32(0)
								m.G0 = v8 + int32(32)
								return v66
							}
