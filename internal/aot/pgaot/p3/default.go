					...
					if v27 != 0 {
						...
						if l2 == int32(12) {
								...
								if v35 == int32(0) {
									...
									if v41 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v42
										F_errmsg(m, int32(78366), v8)
										mBase = m.M
										v46 = m.ExcPending
										if v46 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(522409), int32(1112), int32(437804))
											mBase = m.M
											v51 = m.ExcPending
											if v51 != 0 {
												return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v57
							v63 = F_format_elog_string(m, int32(604348), v8+int32(16))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return int32(0)
			...
			if v16 == int32(0) {
				...
				if v23 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg_internal(m, int32(49813), v8)
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
					} else {
						F_errfinish(m, int32(518656), int32(352), int32(453567))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return
