					...
					if v27 != 0 {
						...
						if l2 == int32(12) {
								...
								if v35 == int32(0) {
									...
									if v41 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8))) = v42
										F_errmsg(m, int32(72110), v8)
										mBase = m.M
										v46 = m.ExcPending
										if v46 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(494516), int32(1112), int32(414685))
											mBase = m.M
											v51 = m.ExcPending
											if v51 != 0 {
												return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v57
							v63 = F_format_elog_string(m, int32(557859), v8+int32(16))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return int32(0)
			...
			if v16 == int32(0) {
				...
				if v23 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg_internal(m, int32(46068), v8)
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
					} else {
						F_errfinish(m, int32(491272), int32(352), int32(429981))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return
