	...
	if l2 != v8 {
		...
		if v131 != 0 {
			...
			if v134 != 0 {
				...
				F_errmsg(m, int32(236213), int32(0))
				mBase = m.M
				v140 = m.ExcPending
				if v140 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(514897), int32(213), int32(530452))
					mBase = m.M
					v147 = m.ExcPending
					if v147 != 0 {
						return int32(0)
		...
		if l4 <= int32(15) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
			v17 = l3 + int32(3)
			v20 = F_pg_snprintf(m, v17, int32(18), int32(719171), v9)
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
				return int32(0)
				...
				if v20 <= int32(0) {
					...
					if v151 != 0 {
						...
						if v154 != 0 {
							...
							F_errmsg(m, int32(345631), int32(0))
							mBase = m.M
							v160 = m.ExcPending
							if v160 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(514897), int32(220), int32(530452))
								mBase = m.M
								v167 = m.ExcPending
								if v167 != 0 {
									return int32(0)
