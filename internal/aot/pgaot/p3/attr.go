				...
				*(*int32)(unsafe.Add(mBase, uint32(v12)+212)) = v49
				...
				if v53 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v12)+220)) = v52
					...
					v59 = F_heap_form_tuple(m, v55, v12+int32(208), int32(4433084))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return int32(0)
														...
														*(*int32)(unsafe.Add(mBase, uint32(v12)+144)) = v90
																		...
																		*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = v114
																		...
																		if v125 != 0 {
																			...
																			if v132 != 0 {
																				...
																				v134 = *(*int32)(unsafe.Add(mBase, _consts[442]))
																				if v134 != 0 {
														...
														if v146 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
															F_errmsg_internal(m, int32(47422), v12)
															mBase = m.M
															v152 = m.ExcPending
															if v152 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(510293), int32(95), int32(100429))
																mBase = m.M
																v157 = m.ExcPending
																if v157 != 0 {
																	return int32(0)
