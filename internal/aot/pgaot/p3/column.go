...
L11:
	...
	F_appendStringInfoString(m, v13, int32(704244))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L4
...
func F_has_column_privilege_name_id_attnum(m *base.Module, l0 int32) int32 {
	...
	if v19 != 0 {
		...
		if v21 != 0 {
			...
			v23 = F_convert_any_priv_string(m, v16, int32(1615808))
			mBase = m.M
			v24 = m.ExcPending
			if v24 != 0 {
				return int32(0)
		...
		if v22 != 0 {
			...
			if v24 != 0 {
				...
				if v26 != 0 {
					...
					v28 = F_convert_any_priv_string(m, v21, int32(1615808))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
						...
						if v30 != 0 {
							...
							if v36 != 0 {
								...
								if v38 != 0 {
									...
									v40 = F_convert_any_priv_string(m, v23, int32(1615808))
									mBase = m.M
									v41 = m.ExcPending
									if v41 != 0 {
										return int32(0)
...
L3:
	;
	F_scanner_yyerror(m, int32(688649), l3)
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L1
