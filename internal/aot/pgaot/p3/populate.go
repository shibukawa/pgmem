		...
		*(*uint8)(unsafe.Add(mBase, uint32(v25)+12)) = uint8(v69)
		...
		if v74 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v11))) = v75
			F_errmsg_internal(m, int32(529041), v11)
			mBase = m.M
			v79 = m.ExcPending
			if v79 != 0 {
				return
			} else {
				F_errfinish(m, int32(525956), int32(105), int32(327937))
				mBase = m.M
				v84 = m.ExcPending
				if v84 != 0 {
					return
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v19
				...
				if v23 != 0 {
					...
					F_errfinish(m, int32(519831), int32(4298), int32(241628))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
...
L10:
	;
	v34 = int32(4458568)
	v36 = *(*int32)(unsafe.Add(mBase, _consts[427]))
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[427])) = v37
	v40 = v29 + v30
