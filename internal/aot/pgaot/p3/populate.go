		...
		*(*uint8)(unsafe.Add(mBase, uint32(v25)+12)) = uint8(v69)
		...
		if v74 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v11))) = v75
			F_errmsg_internal(m, int32(497398), v11)
			mBase = m.M
			v79 = m.ExcPending
			if v79 != 0 {
				return
			} else {
				F_errfinish(m, int32(494761), int32(105), int32(309181))
				mBase = m.M
				v84 = m.ExcPending
				if v84 != 0 {
					return
		...
		if v15 != 0 {
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v19
				F_errmsg(m, int32(227731), v6)
				mBase = m.M
				v23 = m.ExcPending
				if v23 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(489690), int32(4298), int32(227469))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
