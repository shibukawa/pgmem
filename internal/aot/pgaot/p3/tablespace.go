...
func F_remove_tablespace_symlink(m *base.Module, l0 int32) {
	...
	mBase = m.M
	if v12 < int32(0) {
		v16 = *(*int32)(unsafe.Add(mBase, _c_F_remove_tablespace_symlink[0]))
		if v16 == int32(44) {
			m.G0 = v6 + int32(160)
			return
		} else {
			...
			if v22 != 0 {
				...
				if v24 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
					F_errmsg(m, int32(_a_F_remove_tablespace_symlink_0), v6)
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return
		...
		v36 = v34 & int32(_a_F_remove_tablespace_symlink_3)
		if v36 != int32(_a_F_remove_tablespace_symlink_4) {
			if v36 != int32(_a_F_remove_tablespace_symlink_5) {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v92 = m.ExcPending
				if v92 != 0 {
					...
					if v95 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = l0
						F_errmsg(m, int32(_a_F_remove_tablespace_symlink_6), v6+int32(16))
						mBase = m.M
						v101 = m.ExcPending
						if v101 != 0 {
							return
				...
				if int32(0) <= v41 {
					...
					v45 = *(*int32)(unsafe.Add(mBase, _c_F_remove_tablespace_symlink[0]))
					if v45 == int32(44) {
						m.G0 = v6 + int32(160)
						return
					} else {
						...
						if v51 != 0 {
							...
							if v53 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = l0
								F_errmsg(m, int32(_a_F_remove_tablespace_symlink_7), v6+int32(32))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return
			...
			if int32(0) <= v65 {
				...
				v69 = *(*int32)(unsafe.Add(mBase, _c_F_remove_tablespace_symlink[0]))
				if v69 == int32(44) {
					m.G0 = v6 + int32(160)
					return
				} else {
					...
					if v75 != 0 {
						...
						if v77 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = l0
							F_errmsg(m, int32(_a_F_remove_tablespace_symlink_8), v6+int32(48))
							mBase = m.M
							v83 = m.ExcPending
							if v83 != 0 {
								return
