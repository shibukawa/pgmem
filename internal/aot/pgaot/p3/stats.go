...
L4:
	;
	v30 = int32(3)
	v32 = l1 + int32(20) + v24<<(uint(v30)%32)
	v33 = int32(1)
...
L17:
	...
	v87 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v85+v75))))
	if v87 == int32(1) {
		goto L13
	} else {
		goto L19
...
L24:
	;
	v109 = v104
	v110 = int32(_a_F_stats_fill_fcinfo_from_arg_pairs_0)
	goto L26
L25:
	;
	if v147 == int32(0) {
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v104
	F_errmsg(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_1), v14+int32(16))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L7
...
L62:
	;
	F_errfinish(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_2), int32(260), int32(_a_F_stats_fill_fcinfo_from_arg_pairs_3))
	mBase = m.M
	v240 = m.ExcPending
	if v240 != 0 {
		goto L7
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v104
	F_errmsg(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_4), v14+int32(32))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L7
...
L72:
	;
	F_errfinish(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_2), int32(276), int32(_a_F_stats_fill_fcinfo_from_arg_pairs_5))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L7
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v75 | int32(1)
	F_errmsg(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_6), v14)
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L7
...
L76:
	;
	F_errfinish(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_2), int32(330), int32(_a_F_stats_fill_fcinfo_from_arg_pairs_7))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L7
...
L78:
	...
	v350 = *(*int32)(unsafe.Add(mBase, uint32(v346+v75<<(uint(int32(2))%32))))
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = v75 | int32(1)
	F_errmsg(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_8), v14+int32(48))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L7
...
L81:
	;
	F_errfinish(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_2), int32(336), int32(_a_F_stats_fill_fcinfo_from_arg_pairs_7))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L7
...
L85:
	;
	F_errfinish(m, int32(_a_F_stats_fill_fcinfo_from_arg_pairs_2), int32(316), int32(_a_F_stats_fill_fcinfo_from_arg_pairs_7))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L7
