...
L6:
	;
	if base.Ui32(int32(_a_F_PageRepairFragmentation_0)) < base.Ui32(v22) {
		goto L3
	} else {
		goto L7
	}
L7:
	;
	if (v22+int32(7))&int32(_a_F_PageRepairFragmentation_1) != v22 {
		goto L3
	} else {
		goto L8
	}
...
L9:
	;
	v152 = int32(_a_F_PageRepairFragmentation_2)
	v153 = v145 & v152
	if v153 != v43&v152 {
		goto L35
	} else {
...
L10:
	;
	v43 = int32(base.Ui32(v24+int32(_a_F_PageRepairFragmentation_3)) >> (uint(int32(2)) % 32))
	goto L12
L11:
	;
	v43 = int32(0)
...
L12:
	;
	v45 = v43 & int32(_a_F_PageRepairFragmentation_2)
	if v45 == int32(0) {
		goto L13
	} else {
		goto L14
...
L16:
	...
	if v77&int32(_a_F_PageRepairFragmentation_4) != 0 {
		goto L19
	} else {
		goto L20
	}
...
L19:
	;
	if base.Ui32(v77) < base.Ui32(int32(_a_F_PageRepairFragmentation_5)) {
		goto L22
	} else {
		goto L23
	}
...
L24:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v60))) = uint16(v83)
	...
	v87 = v85 & int32(_a_F_PageRepairFragmentation_6)
...
L26:
	...
	v97 = (int32(base.Ui32(v91)>>(uint(int32(17))%32)) + int32(7)) & int32(_a_F_PageRepairFragmentation_7)
...
L37:
	...
	v171 = v166&int32(_a_F_PageRepairFragmentation_8) | base.B2i32(int32(0) < v165)
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v24
	F_errmsg(m, int32(_a_F_PageRepairFragmentation_9), v20)
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L38
...
L41:
	;
	F_errfinish(m, int32(_a_F_PageRepairFragmentation_10), int32(730), int32(_a_F_PageRepairFragmentation_11))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L38
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v201
	F_errmsg(m, int32(_a_F_PageRepairFragmentation_12), v20+int32(32))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L38
...
L45:
	;
	F_errfinish(m, int32(_a_F_PageRepairFragmentation_10), int32(759), int32(_a_F_PageRepairFragmentation_11))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L38
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v116
	F_errmsg(m, int32(_a_F_PageRepairFragmentation_13), v20+int32(16))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L38
...
L49:
	;
	F_errfinish(m, int32(_a_F_PageRepairFragmentation_10), int32(789), int32(_a_F_PageRepairFragmentation_11))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L38
					...
					if v20 != 0 {
						...
						if v21 == int32(0) {
							...
							*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v24)
							...
							v29 = F_pg_checksum_page(m, v19, base.I32_wrap_i64(v14))
							mBase = m.M
							return base.I32_extend16_s(v29)
						}
					}
				}
			} else {
						...
						if v22 != int32(1) {
							...
							if v33 == int32(25) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v26
								v42 = F_pg_snprintf(m, v8+int32(16), int32(64), int32(_a_F_page_header_3), v8)
								mBase = m.M
								v43 = m.ExcPending
								if v43 != 0 {
									return int32(0)
								} else {
									v46 = F_cstring_to_text(m, v8+int32(16))
									mBase = m.M
									v47 = m.ExcPending
									if v47 != 0 {
										return int32(0)
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v55
										v57 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v17)+8)))
										*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = v57
										v59 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v17)+10)))
										*(*int32)(unsafe.Add(mBase, uint32(v8)+24)) = v59
										v61 = *(*int32)(unsafe.Add(mBase, uint32(v8)+92))
										v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)))
										v66 = *(*int32)(unsafe.Add(mBase, uint32(v61+v62<<(uint(int32(4))%32))+388))
										switch v66 - int32(21) {
										case 0, 2:
											v86 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v17)+12)))
											*(*int32)(unsafe.Add(mBase, uint32(v8)+28)) = v86
											v88 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v17)+14)))
											*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v88
											v90 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v17)+16)))
											*(*int32)(unsafe.Add(mBase, uint32(v8)+36)) = v90
											v92 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v17)+18)))
											*(*int32)(unsafe.Add(mBase, uint32(v8)+44)) = v92 & int32(255)
											*(*int32)(unsafe.Add(mBase, uint32(v8)+40)) = v92 & int32(_a_F_page_header_4)
											v99 = *(*int32)(unsafe.Add(mBase, uint32(v17)+20))
											v100 = int32(0)
											*(*uint8)(unsafe.Add(mBase, uint32(v8)+88)) = uint8(v100)
											*(*int64)(unsafe.Add(mBase, uint32(v8)+80)) = int64(0)
											*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v99
											v109 = F_heap_form_tuple(m, v61, v8+int32(16), v8+int32(80))
											mBase = m.M
											v110 = m.ExcPending
											if v110 != 0 {
												return int32(0)
								...
								v53 = F_Int64GetDatum(m, base.I64_extend_i32_u(v26)|base.I64_extend_i32_u(v27)<<(uint(int64(32))%64))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return int32(0)
