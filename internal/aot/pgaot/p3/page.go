...
L41:
	;
	F_errfinish(m, int32(522206), int32(730), int32(270909))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L38
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v201
	F_errmsg(m, int32(63051), v20+int32(32))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L38
...
L45:
	;
	F_errfinish(m, int32(522206), int32(759), int32(270909))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L38
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v116
	F_errmsg(m, int32(57595), v20+int32(16))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L38
...
L49:
	;
	F_errfinish(m, int32(522206), int32(789), int32(270909))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L38
					...
					if v55 != 0 {
						...
						if v58 != 0 {
							...
							if v64 != 0 {
								...
								F_errfinish(m, int32(522165), int32(356), int32(325305))
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return int32(0)
				...
				if v35 != 0 {
					...
					if v38 != 0 {
						...
						if v44 != 0 {
							...
							F_errfinish(m, int32(522165), int32(351), int32(325305))
							mBase = m.M
							v51 = m.ExcPending
							if v51 != 0 {
								return int32(0)
						...
						if v22 != int32(1) {
							...
							if v141 != 0 {
								...
								if v147 != 0 {
									...
									F_errfinish(m, int32(522165), int32(274), int32(238463))
									mBase = m.M
									v154 = m.ExcPending
									if v154 != 0 {
										return int32(0)
							...
							if v33 == int32(25) {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v26
								v42 = F_pg_snprintf(m, v8+int32(16), int32(64), int32(539886), v8)
								mBase = m.M
								v43 = m.ExcPending
								if v43 != 0 {
									return int32(0)
										...
										default:
											...
											if v72 != 0 {
												...
												if v78 != 0 {
													...
													F_errfinish(m, int32(522165), int32(315), int32(238463))
													mBase = m.M
													v85 = m.ExcPending
													if v85 != 0 {
														return int32(0)
				...
				if v121 != 0 {
					...
					if v124 != 0 {
						...
						if v130 != 0 {
							...
							F_errfinish(m, int32(522165), int32(267), int32(238463))
							mBase = m.M
							v137 = m.ExcPending
							if v137 != 0 {
								return int32(0)
