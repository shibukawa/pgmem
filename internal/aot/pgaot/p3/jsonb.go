...
L82:
	;
	F_errmsg_internal(m, int32(350564), int32(0))
	mBase = m.M
	v291 = m.ExcPending
	if v291 != 0 {
		goto L1
...
L83:
	;
	F_errfinish(m, int32(474102), int32(1314), int32(139806))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L1
	...
	default:
		...
		if v18 != 0 {
			...
			if v22 != 0 {
				...
				F_errfinish(m, int32(474102), int32(1353), int32(330310))
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return
...
L35:
	;
	F_appendBinaryStringInfo(m, v23, int32(703976), v26)
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L4
...
L87:
	;
	F_appendBinaryStringInfo(m, v23, int32(703733), int32(2))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L4
...
L132:
	;
	F_errfinish(m, int32(476670), int32(603), int32(210383))
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L4
	...
	default:
		...
		if v68 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v69
			F_errmsg_internal(m, int32(462961), v7)
			mBase = m.M
			v73 = m.ExcPending
			if v73 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(476670), int32(217), int32(363297))
				mBase = m.M
				v78 = m.ExcPending
				if v78 != 0 {
					return int32(0)
				...
				if v34 == int32(1114) {
					...
					if v52 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v53
						F_errmsg_internal(m, int32(463025), v5+int32(-32))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(476670), int32(213), int32(363297))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return int32(0)
...
L48:
	;
	F_errmsg_internal(m, int32(328427), int32(0))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L49:
	;
	F_errfinish(m, int32(474102), int32(264), int32(124426))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L51:
	;
	F_errmsg_internal(m, int32(329186), int32(0))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L1
...
L52:
	;
	F_errfinish(m, int32(474102), int32(267), int32(124426))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L1
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(270013))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v33
	F_errmsg_internal(m, int32(465104), v7)
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L17:
	;
	F_errfinish(m, int32(472643), int32(286), int32(307301))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L1
						...
						if v106 != 0 {
							...
							if v109 != 0 {
								...
								if v113 != 0 {
									...
									F_errfinish(m, int32(471558), int32(4892), int32(98751))
									mBase = m.M
									v118 = m.ExcPending
									if v118 != 0 {
										return int32(0)
					...
					if v90 != 0 {
						...
						if v93 != 0 {
							...
							if v97 != 0 {
								...
								F_errfinish(m, int32(471558), int32(4887), int32(98751))
								mBase = m.M
								v102 = m.ExcPending
								if v102 != 0 {
									return int32(0)
...
L34:
	;
	F_errfinish(m, int32(474102), int32(720), int32(218542))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L7
...
L89:
	;
	F_errmsg_internal(m, int32(268240), int32(0))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L12
...
L90:
	;
	F_errfinish(m, int32(474102), int32(725), int32(218542))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L12
...
L96:
	;
	F_errfinish(m, int32(474102), int32(761), int32(21085))
	mBase = m.M
	v424 = m.ExcPending
	if v424 != 0 {
		goto L12
...
L99:
	;
	F_errmsg(m, int32(328454), int32(0))
	mBase = m.M
	v435 = m.ExcPending
	if v435 != 0 {
		goto L12
...
L100:
	;
	F_errfinish(m, int32(474102), int32(1969), int32(103910))
	mBase = m.M
	v440 = m.ExcPending
	if v440 != 0 {
		goto L12
