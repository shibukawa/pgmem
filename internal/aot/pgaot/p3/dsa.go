	...
	if v9 != 0 {
		...
		if v11 != 0 {
			...
			if v15 != 0 {
				...
				F_on_dsm_detach(m, v6, int32(1785), v17)
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
...
L10:
	...
	v53 = *(*int32)(unsafe.Add(mBase, uint32(v47+int32(base.Ui32(v15)>>(uint(int32(10))%32))&int32(_a_F_dsa_free_0))))
	if v53 != 0 {
		goto L11
	} else {
		goto L12
...
L53:
	...
	F_FreePageManagerPut(m, v161, int32(base.Ui32(v162)>>(uint(int32(12))%32))&int32(_a_F_dsa_free_1), v167)
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L6
...
L60:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v151))) = uint16(v199)
	v202 = int32(1)
	v206 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v152<<(uint(v202)%32))+uint32(_c_F_dsa_free[0]))))
...
L62:
	...
	if v298 != v211&int32(_a_F_dsa_free_2) {
		goto L61
	} else {
		goto L92
	}
...
L122:
	...
	F_FreePageManagerPut(m, v408, int32(base.Ui32(v409)>>(uint(int32(12))%32))&int32(_a_F_dsa_free_1), v414)
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L6
