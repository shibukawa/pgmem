...
L1:
	;
	F_s_lock(m, l0, int32(514781), int32(2328), int32(336528))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L4
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+96)) = l1
	v45 = F_pg_sprintf(m, v11+int32(1328), int32(246562), v11+int32(96))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L4
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+80)) = l1
	v53 = F_pg_sprintf(m, v11+int32(304), int32(368221), v11+int32(80))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L4
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _consts[43])) = v63
...
L20:
	;
	F_errfinish(m, int32(514781), int32(2361), int32(336528))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L4
...
L22:
	;
	F_s_lock(m, l0, int32(514781), int32(2370), int32(336528))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L4
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, _consts[43])) = v107
	v119 = *(*int32)(unsafe.Add(mBase, _consts[42]))
...
L30:
	;
	v129 = *(*int32)(unsafe.Add(mBase, _consts[43]))
	v131 = *(*int32)(unsafe.Add(mBase, _consts[42]))
...
L32:
	;
	v165 = int32(4160092)
	v166 = *(*int32)(unsafe.Add(mBase, _consts[42]))
	v167 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v166))) = v167
	v170 = *(*int32)(unsafe.Add(mBase, _consts[42]))
	*(*int32)(unsafe.Add(mBase, uint32(v170))) = int32(167772208)
	v175 = int32(*(*uint8)(unsafe.Add(mBase, _consts[44])))
	if v175 != int32(1) {
		v189 = v167
		goto L44
	} else {
...
L37:
	;
	*(*int32)(unsafe.Add(mBase, _consts[43])) = v143
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+64)) = v11 + int32(1328)
	F_errmsg(m, int32(311412), v11-int32(-64))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L4
...
L41:
	;
	F_errfinish(m, int32(514781), int32(2397), int32(336528))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L4
...
L48:
	;
	v184 = *(*int32)(unsafe.Add(mBase, _consts[43]))
	if v184 == int32(27) {
		goto L46
	} else {
		goto L49
...
L50:
	;
	v191 = *(*int32)(unsafe.Add(mBase, _consts[43]))
	v193 = *(*int32)(unsafe.Add(mBase, _consts[42]))
...
L52:
	;
	v226 = *(*int32)(unsafe.Add(mBase, _consts[42]))
...
L54:
	;
	*(*int32)(unsafe.Add(mBase, _consts[43])) = v191
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v11 + int32(1328)
	F_errmsg(m, int32(312677), v11+int32(48))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L4
...
L58:
	;
	F_errfinish(m, int32(514781), int32(2417), int32(336528))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L4
...
L61:
	;
	v232 = *(*int32)(unsafe.Add(mBase, _consts[43]))
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, _consts[43])) = v232
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v11 + int32(1328)
	F_errmsg(m, int32(312472), v11+int32(32))
	mBase = m.M
	v254 = m.ExcPending
	if v254 != 0 {
		goto L4
...
L68:
	;
	F_errfinish(m, int32(514781), int32(2433), int32(336528))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L4
...
L70:
	;
	v266 = *(*int32)(unsafe.Add(mBase, _consts[43]))
...
L72:
	;
	v297 = int32(4548548)
	v299 = *(*int32)(unsafe.Add(mBase, _consts[17]))
	*(*int32)(unsafe.Add(mBase, _consts[17])) = v299 + int32(1)
...
L73:
	;
	*(*int32)(unsafe.Add(mBase, _consts[43])) = v266
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v11 + int32(1328)
	F_errmsg(m, int32(310440), v11+int32(16))
	mBase = m.M
	v291 = m.ExcPending
	if v291 != 0 {
		goto L4
...
L77:
	;
	F_errfinish(m, int32(514781), int32(2449), int32(336528))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L4
...
L80:
	;
	F_fsync_fname(m, int32(90762), int32(1))
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L4
...
L81:
	...
	v318 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[17])) = v317 - v318
...
L82:
	;
	F_s_lock(m, l0, int32(514781), int32(2468), int32(336528))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L4
		...
		if v126 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v2
			...
			if v130 != 0 {
				...
				F_errfinish(m, int32(516327), int32(2098), int32(97149))
				mBase = m.M
				v135 = m.ExcPending
				if v135 != 0 {
					return
