...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+96)) = l1
	v45 = F_pg_sprintf(m, v11+int32(1328), int32(_a_F_SaveSlotToPath_2), v11+int32(96))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L4
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+80)) = l1
	v53 = F_pg_sprintf(m, v11+int32(304), int32(_a_F_SaveSlotToPath_3), v11+int32(80))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L4
...
L13:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0]))
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0])) = v63
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0])) = v107
	v119 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[1]))
...
L30:
	;
	v129 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0]))
	v131 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[1]))
...
L32:
	;
	v165 = int32(_a_F_SaveSlotToPath_5)
	v166 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[1]))
	v167 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v166))) = v167
	v170 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v170))) = int32(167772208)
	v175 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SaveSlotToPath[2])))
	if v175 != int32(1) {
		v189 = v167
		goto L44
	} else {
...
L37:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0])) = v143
...
L50:
	;
	v191 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0]))
	v193 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[1]))
...
L52:
	;
	v226 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[1]))
...
L54:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0])) = v191
...
L61:
	;
	v232 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0]))
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0])) = v232
...
L70:
	;
	v266 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0]))
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[3])) = v299 + int32(1)
...
L73:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[0])) = v266
...
L81:
	;
	v315 = int32(_a_F_SaveSlotToPath_9)
	v317 = *(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[3]))
	v318 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_SaveSlotToPath[3])) = v317 - v318
