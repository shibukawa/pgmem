									...
									if v79 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v10))) = v80
										...
										if v83 != 0 {
											...
											F_errfinish(m, int32(_a_F_vacuum_open_relation_2), v75, int32(_a_F_vacuum_open_relation_3))
											mBase = m.M
											v87 = m.ExcPending
											if v87 != 0 {
												return int32(0)
							...
							if l2&int32(2) == int32(0) {
								...
								if v63 != 0 {
									...
									if v62 == int32(0) {
										...
										if v27 != 0 {
											v71 = int32(_a_F_vacuum_open_relation_4)
										} else {
											v71 = int32(_a_F_vacuum_open_relation_5)
										}
										if v27 != 0 {
											v74 = int32(16908420)
										} else {
