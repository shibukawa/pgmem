				...
				*(*uint8)(unsafe.Add(mBase, uint32(v9+int32(31)))) = uint8(v23)
				if v14 != 0 {
					...
					if v25 == int32(0) {
							...
							if v69 != 0 {
								...
								if v71 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v70
									F_errmsg(m, int32(_a_F_ValidateOperatorReference_0), v9+int32(16))
									mBase = m.M
									v77 = m.ExcPending
									if v77 != 0 {
										return int32(0)
						...
						v30 = *(*int32)(unsafe.Add(mBase, _c_F_ValidateOperatorReference[0]))
						...
						if v51 != 0 {
							...
							if v53 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v52
								F_errmsg(m, int32(_a_F_ValidateOperatorReference_3), v9)
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return int32(0)
																				...
																				if v155 != 0 {
																					...
																					if v160 == int32(0) {
																						...
																						if v164 != 0 {
																							...
																							v165 = int32(_a_F_operator_predicate_proof_0)
																							v166 = *(*int32)(unsafe.Add(mBase, _c_F_operator_predicate_proof[0]))
																							v168 = *(*int32)(unsafe.Add(mBase, uint32(v163)+100))
																							*(*int32)(unsafe.Add(mBase, _c_F_operator_predicate_proof[0])) = v168
																									...
																									if v176 != 0 {
																										...
																										if v177 == int32(0) {
																											...
																											if v181 != 0 {
																												...
																												*(*int32)(unsafe.Add(mBase, _c_F_operator_predicate_proof[0])) = v184
																												...
																												if v190 != 0 {
																													...
																													*(*int32)(unsafe.Add(mBase, _c_F_operator_predicate_proof[0])) = v166
