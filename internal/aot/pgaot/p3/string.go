...
func F_string_agg_deserialize(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+12)) = v24
		...
		if v88 != 0 {
			v89 = int32(_a_F_string_agg_deserialize_0)
			v90 = *(*int32)(unsafe.Add(mBase, _c_F_string_agg_deserialize[0]))
			v92 = *(*int32)(unsafe.Add(mBase, uint32(v10)+28))
			*(*int32)(unsafe.Add(mBase, _c_F_string_agg_deserialize[0])) = v92
			...
			if v95 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_string_agg_deserialize[0])) = v90
