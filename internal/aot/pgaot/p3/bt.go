...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v278 | v279<<(uint(int32(16))%32)
	F_errmsg_internal(m, int32(726325), v18)
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L26
...
L65:
	;
	F_errfinish(m, int32(522965), int32(575), int32(87936))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L26
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v121 + int32(4)
	F_errmsg_internal(m, int32(730341), v16)
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L19
...
L39:
	;
	F_errfinish(m, int32(522965), int32(323), int32(111380))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L19
...
func F_bt_index_parent_check(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = int32(1)
	...
	F_amcheck_lock_relation_and_check(m, v9, int32(403), int32(7657), int32(5), v7+int32(12))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		return int32(0)
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = base.I32_extend16_s(v81)
	F_errmsg_internal(m, int32(506326), v18+int32(16))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L20
...
L65:
	;
	F_errfinish(m, int32(524433), int32(2892), int32(402326))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L20
									...
									if (v45<<(uint(int32(8))%32)-v48)&int32(65535) != int32(16) {
										...
										if v219 != 0 {
											...
											if v222 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(430177)
												F_errmsg(m, int32(427382), v11+int32(16))
												mBase = m.M
												v232 = m.ExcPending
												if v232 != 0 {
													return int32(0)
													...
													*(*int32)(unsafe.Add(mBase, uint32(v11)+4)) = (v235<<(uint(int32(8))%32) - v234) & int32(65535)
													F_errdetail(m, int32(682081), v11)
													mBase = m.M
													v247 = m.ExcPending
													if v247 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(519240), int32(773), int32(532866))
														mBase = m.M
														v254 = m.ExcPending
														if v254 != 0 {
															return int32(0)
											...
											if v258 != 0 {
												...
												if v261 != 0 {
													...
													if v267 != 0 {
														...
														F_errfinish(m, int32(519240), int32(780), int32(532866))
														mBase = m.M
														v274 = m.ExcPending
														if v274 != 0 {
															return int32(0)
												...
												if v60 != 0 {
													...
													if v278 != 0 {
														...
														if v281 != 0 {
															...
															F_errmsg(m, int32(427720), int32(0))
															mBase = m.M
															v287 = m.ExcPending
															if v287 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(519240), int32(785), int32(532866))
																mBase = m.M
																v294 = m.ExcPending
																if v294 != 0 {
																	return int32(0)
														...
														if v85&int32(4) == int32(0) {
															...
															*(*uint8)(unsafe.Add(mBase, uint32(v31)+7)) = uint8(base.B2i32(v129 == v130))
																...
																if v136 != int32(1) {
																	...
																	if v298 != 0 {
																		...
																		if v304 != 0 {
																			...
																			F_errfinish(m, int32(519240), int32(803), int32(532866))
																			mBase = m.M
																			v311 = m.ExcPending
																			if v311 != 0 {
																				return int32(0)
															...
															if v106 != 0 {
																...
																if v105 != 0 {
																	F_errmsg_internal(m, int32(468108), int32(0))
																	mBase = m.M
																	v112 = m.ExcPending
																	if v112 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(519240), int32(795), int32(532866))
																		mBase = m.M
																		v119 = m.ExcPending
																		if v119 != 0 {
																			return int32(0)
														...
														if v68 != 0 {
															...
															if v67 == int32(0) {
																...
																if v76 != 0 {
																	...
																	F_errfinish(m, int32(519240), int32(788), int32(532866))
																	mBase = m.M
																	v83 = m.ExcPending
																	if v83 != 0 {
																		return int32(0)
				...
				if v199 != 0 {
					...
					if v202 != 0 {
						...
						if v208 != 0 {
							...
							F_errfinish(m, int32(519240), int32(743), int32(532866))
							mBase = m.M
							v215 = m.ExcPending
							if v215 != 0 {
								return int32(0)
																		...
																		if v139 != int32(1) {
																			...
																			if v213 != 0 {
																				...
																				if v219 != 0 {
																					...
																					F_errfinish(m, int32(519240), int32(687), int32(326300))
																					mBase = m.M
																					v226 = m.ExcPending
																					if v226 != 0 {
																						return int32(0)
																	...
																	if v108 != 0 {
																		...
																		if v107 != 0 {
																			*(*int64)(unsafe.Add(mBase, uint32(v12))) = v22
																			F_errmsg_internal(m, int32(468151), v12)
																			mBase = m.M
																			v114 = m.ExcPending
																			if v114 != 0 {
																				return int32(0)
																			} else {
																				F_errfinish(m, int32(519240), int32(679), int32(326300))
																				mBase = m.M
																				v121 = m.ExcPending
																				if v121 != 0 {
																					return int32(0)
				...
				if v193 != 0 {
					...
					if v196 != 0 {
						...
						if v202 != 0 {
							...
							F_errfinish(m, int32(519240), int32(635), int32(326300))
							mBase = m.M
							v209 = m.ExcPending
							if v209 != 0 {
								return int32(0)
