...
L11:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[439]))
	if v30 <= int32(0) {
		v83 = v2
		goto L12
	} else {
...
L14:
	;
	v43 = *(*int32)(unsafe.Add(mBase, uint32(v34<<(uint(int32(4))%32))+uint32(_consts[440])))
...
L28:
	;
	v78 = *(*int32)(unsafe.Add(mBase, uint32(v73)+uint32(_consts[441])))
	v83 = v78
	goto L12
L29:
	;
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v13
	F_errmsg_internal(m, int32(43725), v9)
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L3
...
L32:
	;
	F_errfinish(m, int32(488663), int32(763), int32(205586))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L3
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v27
	F_errmsg(m, int32(694300), v9+int32(16))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L3
...
L36:
	;
	F_errfinish(m, int32(488663), int32(772), int32(205586))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L3
...
L85:
	;
	v350 = F_AllocSetContextCreateInternal(m, v344, int32(240652), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L17
...
L91:
	...
	v407 = *(*int32)(unsafe.Add(mBase, _consts[104]))
	v408 = *(*int32)(unsafe.Add(mBase, uint32(v407)))
	goto L104
L92:
	;
	v400 = *(*int32)(unsafe.Add(mBase, _consts[522]))
	v401 = v400
	goto L91
L93:
	;
...
L99:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v366
	...
	v371 = *(*int32)(unsafe.Add(mBase, _consts[523]))
...
L194:
	;
	F_errfinish(m, int32(482727), int32(1604), int32(294463))
	mBase = m.M
	v717 = m.ExcPending
	if v717 != 0 {
		goto L17
