...
L11:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_internal_validator[0]))
	if v30 <= int32(0) {
		v83 = v2
		goto L12
	} else {
...
L14:
	;
	v43 = *(*int32)(unsafe.Add(mBase, uint32(v34<<(uint(int32(4))%32))+uint32(_c_F_fmgr_internal_validator[1])))
...
L15:
	...
	if v73+int32(_a_F_fmgr_internal_validator_0) == int32(0) {
		v83 = v2
		goto L12
	} else {
		goto L28
...
L28:
	;
	v78 = *(*int32)(unsafe.Add(mBase, uint32(v73)+uint32(_c_F_fmgr_internal_validator[2])))
	v83 = v78
	goto L12
L29:
	;
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v13
	F_errmsg_internal(m, int32(_a_F_fmgr_internal_validator_1), v9)
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L3
...
L32:
	;
	F_errfinish(m, int32(_a_F_fmgr_internal_validator_2), int32(763), int32(_a_F_fmgr_internal_validator_3))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L3
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v27
	F_errmsg(m, int32(_a_F_fmgr_internal_validator_4), v9+int32(16))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L3
...
L36:
	;
	F_errfinish(m, int32(_a_F_fmgr_internal_validator_2), int32(772), int32(_a_F_fmgr_internal_validator_3))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L3
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[0])) = v843
	m.G0 = v19 + int32(16)
	return v827
L2:
	;
...
L69:
	;
	v449 = int32(_a_F_fmgr_sql_1)
	v450 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1]))
	v452 = *(*int32)(unsafe.Add(mBase, uint32(v75)+68))
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1])) = v452
...
L75:
	;
	v329 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1]))
...
L85:
	;
	v350 = F_AllocSetContextCreateInternal(m, v344, int32(_a_F_fmgr_sql_3), int32(0), int32(_a_F_fmgr_sql_4), int32(_a_F_fmgr_sql_5))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L17
...
L91:
	...
	v407 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[2]))
	v408 = *(*int32)(unsafe.Add(mBase, uint32(v407)))
	goto L104
L92:
	;
	v400 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[3]))
	v401 = v400
	goto L91
L93:
	;
...
L95:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1])) = v354
	goto L92
L96:
	;
...
L99:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1])) = v366
	v368 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v75)+8)))
	v371 = *(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[4]))
...
L100:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1])) = v377
	if v375&int32(1) != 0 {
		goto L96
	} else {
		goto L101
...
L111:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1])) = v329
	v445 = v327
	goto L69
L112:
	;
...
L121:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1])) = v490
...
L129:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_fmgr_sql[1])) = v450
	if v480 == int64(0) {
		v487 = v478
		goto L121
	} else {
