...
L6:
	;
	v45 = l0<<(uint(int32(1))%32) + int32(1877872)
	goto L2
L7:
	;
	v16 = base.I32_div_s(v10+v11, int32(2))
	v18 = v16 * int32(12)
	v21 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_consts[1223])))
...
L12:
	;
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_consts[1224])))
...
L20:
	;
	v100 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v69)+uint32(_consts[1225]))))
	v111 = v100
	goto L18
L21:
	;
...
L23:
	;
	v86 = int32(1)
	v92 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(v86)%32))+uint32(_consts[1226]))))
...
L24:
	...
	v69 = v67 * int32(12)
	v72 = *(*int32)(unsafe.Add(mBase, uint32(v69)+uint32(_consts[1223])))
...
L29:
	;
	v78 = *(*int32)(unsafe.Add(mBase, uint32(v69)+uint32(_consts[1224])))
...
L46:
	;
	v178 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v161)+uint32(_consts[1225]))))
	v180 = v178
	goto L17
L47:
	;
	...
	v161 = v159 * int32(12)
	v164 = *(*int32)(unsafe.Add(mBase, uint32(v161)+uint32(_consts[1223])))
...
L52:
	;
	v170 = *(*int32)(unsafe.Add(mBase, uint32(v161)+uint32(_consts[1224])))
