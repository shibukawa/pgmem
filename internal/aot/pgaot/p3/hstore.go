...
L4:
	;
	F_pg_qsort(m, l0, l1, int32(20), int32(6756))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L9
...
L83:
	;
	F_errfinish(m, int32(490332), int32(312), int32(411935))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L98:
	;
	F_errmsg_internal(m, int32(421534), int32(0))
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(490332), int32(274), int32(411935))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L1
						...
						if v42 != int32(1) {
							...
							if v165 != 0 {
								...
								if v171 != 0 {
									...
									F_errfinish(m, int32(492654), int32(869), int32(303021))
									mBase = m.M
									v178 = m.ExcPending
									if v178 != 0 {
										return int32(0)
...
L162:
	;
	F_errfinish(m, int32(491855), int32(156), int32(278505))
	mBase = m.M
	v649 = m.ExcPending
	if v649 != 0 {
		goto L4
