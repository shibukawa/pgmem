...
L4:
	;
	F_pg_qsort(m, l0, l1, int32(20), int32(6461))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L9
...
L83:
	;
	F_errfinish(m, int32(484629), int32(312), int32(407295))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L98:
	;
	F_errmsg_internal(m, int32(416698), int32(0))
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(484629), int32(274), int32(407295))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L1
						...
						if v42 != int32(1) {
							...
							if v165 != 0 {
								...
								if v171 != 0 {
									...
									F_errfinish(m, int32(486925), int32(869), int32(299703))
									mBase = m.M
									v178 = m.ExcPending
									if v178 != 0 {
										return int32(0)
...
L161:
	;
	F_errmsg(m, int32(297833), int32(0))
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		goto L4
...
L162:
	;
	F_errfinish(m, int32(486136), int32(156), int32(275392))
	mBase = m.M
	v649 = m.ExcPending
	if v649 != 0 {
		goto L4
