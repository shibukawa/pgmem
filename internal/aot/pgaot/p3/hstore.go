...
L4:
	;
	F_pg_qsort(m, l0, l1, int32(20), int32(6925))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L9
...
L82:
	;
	F_errmsg_internal(m, int32(429954), int32(0))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L1
...
L83:
	;
	F_errfinish(m, int32(493621), int32(312), int32(414590))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(493621), int32(274), int32(414590))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L1
						...
						if v42 != int32(1) {
							...
							if v165 != 0 {
								...
								if v171 != 0 {
									...
									F_errfinish(m, int32(495953), int32(869), int32(304920))
									mBase = m.M
									v178 = m.ExcPending
									if v178 != 0 {
										return int32(0)
...
L161:
	;
	F_errmsg(m, int32(303009), int32(0))
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		goto L4
...
L162:
	;
	F_errfinish(m, int32(495154), int32(156), int32(280303))
	mBase = m.M
	v649 = m.ExcPending
	if v649 != 0 {
		goto L4
