...
func F_SimpleLruWriteAll(m *base.Module, l0 int32) {
	...
	v15 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_SimpleLruWriteAll[0])) = uint8(v15)
	*(*uint8)(unsafe.Add(mBase, _c_F_SimpleLruWriteAll[1])) = uint8(v15)
	v21 = v13 << (uint(int32(6)) % 32)
	v24 = *(*int64)(unsafe.Add(mBase, uint32(v21)+uint32(_c_F_SimpleLruWriteAll[2])))
	*(*int64)(unsafe.Add(mBase, uint32(v21)+uint32(_c_F_SimpleLruWriteAll[2]))) = v24 + int64(1)
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruWriteAll[3])) = int32(5)
	v116 = *(*int32)(unsafe.Add(mBase, _c_F_SimpleLruWriteAll[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_SimpleLruWriteAll[5])) = v116
...
L2:
	...
	case 0:
		goto L5
	default:
		v130 = int32(_a_F_check_simple_rowfilter_expr_walker_0)
		goto L1
	case 5:
		goto L10
...
L11:
	;
	v130 = int32(_a_F_check_simple_rowfilter_expr_walker_2)
	goto L1
L12:
	;
	v130 = int32(_a_F_check_simple_rowfilter_expr_walker_3)
	goto L1
L13:
	;
	v130 = int32(_a_F_check_simple_rowfilter_expr_walker_3)
...
L27:
	;
	v130 = int32(_a_F_check_simple_rowfilter_expr_walker_4)
	goto L1
L28:
	;
	goto L29
...
L31:
	;
	v130 = int32(_a_F_check_simple_rowfilter_expr_walker_5)
	goto L1
L32:
	;
	goto L33
...
L36:
	;
	if base.Ui32(int32(_a_F_check_simple_rowfilter_expr_walker_7)) <= base.Ui32(v103) {
		v130 = v72
		goto L1
	} else {
		goto L46
