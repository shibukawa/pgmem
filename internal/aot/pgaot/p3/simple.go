...
func F_SimpleLruTruncate(m *base.Module, l0 int32, l1 int64) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+8)) = l1
	...
	v16 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[154])) = uint8(v16)
	*(*uint8)(unsafe.Add(mBase, _consts[155])) = uint8(v16)
	v22 = v14 << (uint(int32(6)) % 32)
	v25 = *(*int64)(unsafe.Add(mBase, uint32(v22)+uint32(_consts[162])))
	*(*int64)(unsafe.Add(mBase, uint32(v22)+uint32(_consts[162]))) = v25 + int64(1)
...
L36:
	;
	F_errfinish(m, int32(514003), int32(1435), int32(374074))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L7
...
func F_SimpleLruWriteAll(m *base.Module, l0 int32) {
	...
	v15 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[154])) = uint8(v15)
	*(*uint8)(unsafe.Add(mBase, _consts[155])) = uint8(v15)
	v21 = v13 << (uint(int32(6)) % 32)
	v24 = *(*int64)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[161])))
	*(*int64)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[161]))) = v24 + int64(1)
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, _consts[157])) = int32(5)
	v116 = *(*int32)(unsafe.Add(mBase, _consts[43]))
	*(*int32)(unsafe.Add(mBase, _consts[158])) = v116
...
L49:
	;
	F_errmsg(m, int32(282330), int32(0))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L25
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v130
	F_errdetail_internal(m, int32(216073), v9)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L25
...
L52:
	;
	F_errfinish(m, int32(516519), int32(680), int32(232070))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L25
...
L25:
	;
	F_errmsg_internal(m, int32(123504), int32(0))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L4
...
L26:
	;
	F_errfinish(m, int32(522301), int32(147), int32(120581))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L4
