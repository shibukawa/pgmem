...
L36:
	;
	F_errfinish(m, int32(492789), int32(1435), int32(357719))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L7
...
L49:
	;
	F_errmsg(m, int32(270466), int32(0))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L25
...
L52:
	;
	F_errfinish(m, int32(494640), int32(680), int32(221660))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L25
...
L26:
	;
	F_errfinish(m, int32(499718), int32(147), int32(113267))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L4
