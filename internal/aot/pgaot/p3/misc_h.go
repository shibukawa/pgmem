...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v153)+20)) = v46
	v208 = F_pg_snprintf(m, v153+int32(32), int32(64), int32(38704), v153+int32(16))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L6
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v153))) = v153 + int32(32)
	F_errmsg_internal(m, int32(221029), v153)
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L6
...
L64:
	;
	F_errfinish(m, int32(496555), int32(1380), int32(150284))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L6
...
L82:
	;
	F_errfinish(m, int32(496595), int32(584), int32(256845))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L6
...
func F_has_largeobject_privilege_name_id(m *base.Module, l0 int32) int32 {
	...
	if v10 != 0 {
		...
		if v14 != 0 {
			...
			v16 = F_convert_any_priv_string(m, v13, int32(1661600))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return int32(0)
...
L62:
	;
	F_errmsg_internal(m, int32(466758), int32(0))
	mBase = m.M
	v320 = m.ExcPending
	if v320 != 0 {
		goto L1
...
L63:
	;
	F_errfinish(m, int32(500890), int32(716), int32(438663))
	mBase = m.M
	v325 = m.ExcPending
	if v325 != 0 {
		goto L1
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1821)+80)) = int32(156630)
	v1836 = int64(base.Ui64(v1828) >> (uint(int64(32)) % 64))
	*(*uint32)(unsafe.Add(mBase, uint32(v1821)+92)) = uint32(v1836)
	v1844 = F_pg_snprintf(m, v1821+int32(112), int32(1024), int32(30130), v1821+int32(80))
	mBase = m.M
	v1845 = m.ExcPending
	if v1845 != 0 {
		goto L11
...
L372:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1821)+48)) = v1821 + int32(112)
	F_errmsg(m, int32(299022), v1821+int32(48))
	mBase = m.M
	v1900 = m.ExcPending
	if v1900 != 0 {
		goto L11
...
L373:
	;
	F_errfinish(m, int32(497182), int32(1122), int32(350216))
	mBase = m.M
	v1905 = m.ExcPending
	if v1905 != 0 {
		goto L11
...
L390:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1821)+32)) = v1821 + int32(112)
	F_errmsg(m, int32(300287), v1821+int32(32))
	mBase = m.M
	v1952 = m.ExcPending
	if v1952 != 0 {
		goto L11
...
L391:
	;
	F_errfinish(m, int32(497182), int32(1135), int32(350216))
	mBase = m.M
	v1957 = m.ExcPending
	if v1957 != 0 {
		goto L11
...
L397:
	;
	F_errfinish(m, int32(497182), int32(1094), int32(350216))
	mBase = m.M
	v1983 = m.ExcPending
	if v1983 != 0 {
		goto L11
...
L400:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1821)+64)) = v1821 + int32(112)
	F_errmsg(m, int32(293095), v1821-int32(-64))
	mBase = m.M
	v1999 = m.ExcPending
	if v1999 != 0 {
		goto L11
...
L401:
	;
	F_errfinish(m, int32(497182), int32(1105), int32(350216))
	mBase = m.M
	v2004 = m.ExcPending
	if v2004 != 0 {
		goto L11
...
L404:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1821)+16)) = v1821 + int32(112)
	F_errmsg(m, int32(300082), v1821+int32(16))
	mBase = m.M
	v2018 = m.ExcPending
	if v2018 != 0 {
		goto L11
...
L405:
	;
	F_errfinish(m, int32(497182), int32(1141), int32(350216))
	mBase = m.M
	v2023 = m.ExcPending
	if v2023 != 0 {
		goto L11
...
L407:
	;
	F_errmsg_internal(m, int32(228754), int32(0))
	mBase = m.M
	v2054 = m.ExcPending
	if v2054 != 0 {
		goto L11
...
L408:
	;
	F_errfinish(m, int32(499255), int32(619), int32(81948))
	mBase = m.M
	v2059 = m.ExcPending
	if v2059 != 0 {
		goto L11
...
L410:
	;
	F_errmsg_internal(m, int32(385643), int32(0))
	mBase = m.M
	v2067 = m.ExcPending
	if v2067 != 0 {
		goto L11
...
L411:
	;
	F_errfinish(m, int32(499255), int32(645), int32(81948))
	mBase = m.M
	v2072 = m.ExcPending
	if v2072 != 0 {
		goto L11
...
L413:
	;
	F_errmsg_internal(m, int32(325651), int32(0))
	mBase = m.M
	v2080 = m.ExcPending
	if v2080 != 0 {
		goto L11
...
L414:
	;
	F_errfinish(m, int32(499255), int32(648), int32(81948))
	mBase = m.M
	v2085 = m.ExcPending
	if v2085 != 0 {
		goto L11
...
L416:
	;
	F_errmsg_internal(m, int32(238000), int32(0))
	mBase = m.M
	v2094 = m.ExcPending
	if v2094 != 0 {
		goto L11
...
L417:
	;
	F_errfinish(m, int32(499255), int32(1113), int32(449552))
	mBase = m.M
	v2099 = m.ExcPending
	if v2099 != 0 {
		goto L11
