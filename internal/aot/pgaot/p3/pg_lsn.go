...
func F_pg_lsn_in(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v17))) = v18
	v26 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1025])))
	if v26 == int32(0) {
		goto L5
	} else {
		goto L6
...
L7:
	;
	v30 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1026])))
	if v30 == int32(0) {
		goto L8
	} else {
		goto L9
...
L26:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v111))) = v112
	v120 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1025])))
	if v120 == int32(0) {
		goto L28
	} else {
		goto L29
...
L30:
	;
	v124 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1026])))
	if v124 == int32(0) {
		goto L31
	} else {
		goto L32
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(255043)
	F_errmsg(m, int32(752903), v8)
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L50
...
L54:
	;
	F_errsave_finish(m, v200, int32(515836), int32(74), int32(290376))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L50
		...
		if v15 == int32(49152) {
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					F_errmsg(m, int32(255018), int32(0))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(515836), int32(296), int32(332865))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
			...
			*(*int64)(unsafe.Add(mBase, uint32(v6))) = v9
			v39 = F_pg_snprintf(m, v6+int32(16), int32(32), int32(39447), v6)
			mBase = m.M
			v40 = m.ExcPending
			if v40 != 0 {
				return int32(0)
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					if v28 != 0 {
						...
						F_errfinish(m, int32(515836), int32(262), int32(332812))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
