...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(244811)
	F_errmsg(m, int32(725181), v8)
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L50
...
L54:
	;
	F_errsave_finish(m, v200, int32(496335), int32(74), int32(279594))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L50
		...
		if v15 == int32(49152) {
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					F_errmsg(m, int32(244786), int32(0))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496335), int32(296), int32(320139))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
		...
		if v15 == int32(49152) {
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					F_errmsg(m, int32(244761), int32(0))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496335), int32(262), int32(320086))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
