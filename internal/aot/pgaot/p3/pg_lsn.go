...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(257482)
	F_errmsg(m, int32(759399), v8)
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L50
...
L54:
	;
	F_errsave_finish(m, v200, int32(520690), int32(74), int32(292940))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L50
		...
		if v15 == int32(49152) {
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					F_errmsg(m, int32(257457), int32(0))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(520690), int32(296), int32(335974))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
			...
			*(*int64)(unsafe.Add(mBase, uint32(v6))) = v9
			v39 = F_pg_snprintf(m, v6+int32(16), int32(32), int32(39960), v6)
			mBase = m.M
			v40 = m.ExcPending
			if v40 != 0 {
				return int32(0)
		...
		if v15 == int32(49152) {
			...
			if v21 != 0 {
				...
				if v24 != 0 {
					...
					F_errmsg(m, int32(257432), int32(0))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(520690), int32(262), int32(335921))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
