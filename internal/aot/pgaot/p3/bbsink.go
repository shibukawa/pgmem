			...
			if v26 != 0 {
				...
				if v20 < int32(0) {
					...
					if v68 != 0 {
						...
						v71 = *(*int32)(unsafe.Add(mBase, _c_F_bbsink_server_archive_contents[0]))
						v75 = *(*int32)(unsafe.Add(mBase, uint32(v71+v69*int32(48))+32))
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v75
						F_errmsg(m, int32(_a_F_bbsink_server_archive_contents_0), v9)
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return
						} else {
							F_errhint(m, int32(_a_F_bbsink_server_archive_contents_1), int32(0))
							mBase = m.M
							v83 = m.ExcPending
							if v83 != 0 {
								return
							} else {
								F_errfinish(m, int32(_a_F_bbsink_server_archive_contents_2), int32(175), int32(_a_F_bbsink_server_archive_contents_3))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return
					...
					F_errcode(m, int32(_a_F_bbsink_server_archive_contents_4))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v38
						F_errmsg(m, int32(_a_F_bbsink_server_archive_contents_5), v9+int32(16))
						mBase = m.M
						v48 = m.ExcPending
						if v48 != 0 {
							return
							...
							if v52 != 0 {
								...
								F_errfinish(m, int32(_a_F_bbsink_server_archive_contents_2), int32(182), int32(_a_F_bbsink_server_archive_contents_3))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
...
func F_bbsink_server_begin_manifest(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v9
	v14 = F_psprintf(m, int32(_a_F_bbsink_server_begin_manifest_0), v7+int32(16))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return
				...
				if v25 != 0 {
					...
					if v27 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
						F_errmsg(m, int32(_a_F_bbsink_server_begin_manifest_1), v7)
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return
						} else {
							F_errfinish(m, int32(_a_F_bbsink_server_begin_manifest_2), int32(242), int32(_a_F_bbsink_server_begin_manifest_3))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return
