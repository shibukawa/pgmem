						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v75
						...
						if v79 != 0 {
							...
							if v83 != 0 {
								...
								F_errfinish(m, int32(494898), int32(175), int32(120460))
								mBase = m.M
								v88 = m.ExcPending
								if v88 != 0 {
									return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v38
						...
						if v48 != 0 {
							...
							if v52 != 0 {
								...
								F_errfinish(m, int32(494898), int32(182), int32(120460))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
...
func F_bbsink_server_begin_manifest(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v9
	v14 = F_psprintf(m, int32(235219), v7+int32(16))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return
				...
				if v25 != 0 {
					...
					if v27 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
						F_errmsg(m, int32(299151), v7)
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return
						} else {
							F_errfinish(m, int32(494898), int32(242), int32(77464))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return
