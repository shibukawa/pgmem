...
func F_pgaio_io_acquire_nb(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if base.Ui32(int32(32)) <= base.Ui32(v10) {
		...
		if v16 != 0 {
			...
			if v20 == int32(0) {
				v23 = int32(4556732)
				v25 = *(*int32)(unsafe.Add(mBase, _consts[117]))
				*(*int32)(unsafe.Add(mBase, _consts[117])) = v25 + int32(1)
				v29 = *(*int32)(unsafe.Add(mBase, uint32(v19)+12))
				if v29 == int32(0) {
					v78 = int32(0)
					v80 = int32(4556732)
					v82 = *(*int32)(unsafe.Add(mBase, _consts[117]))
					*(*int32)(unsafe.Add(mBase, _consts[117])) = v82 - int32(1)
					return v78
				} else {
				...
				if v90 != 0 {
					...
					F_errmsg_internal(m, int32(73613), int32(0))
					mBase = m.M
					v94 = m.ExcPending
					if v94 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(520587), int32(199), int32(528588))
						mBase = m.M
						v99 = m.ExcPending
						if v99 != 0 {
							return int32(0)
...
func F_pgaio_sync_submit(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v8 != 0 {
		...
		F_errmsg_internal(m, int32(19629), int32(0))
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(525239), int32(44), int32(108064))
			v17 = m.ExcPending
			if v17 != 0 {
				return int32(0)
			} else {
...
func F_pgaio_worker_shmem_init(m *base.Module, l0 int32) {
	...
	v9 = v7 - int32(16)
	m.G0 = v9
	v16 = F_ShmemInitStruct(m, int32(366095), int32(272), v9+int32(15))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
		...
		*(*int32)(unsafe.Add(mBase, _consts[782])) = v16
		...
		v31 = F_ShmemInitStruct(m, int32(316062), int32(264), v9+int32(15))
		mBase = m.M
		v32 = m.ExcPending
		if v32 != 0 {
			return
