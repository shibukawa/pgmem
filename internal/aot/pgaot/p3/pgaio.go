			...
			if v20 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, _consts[117])) = v25 + int32(1)
				...
				if v90 != 0 {
					...
					F_errmsg_internal(m, int32(72959), int32(0))
					mBase = m.M
					v94 = m.ExcPending
					if v94 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(515733), int32(199), int32(523697))
						mBase = m.M
						v99 = m.ExcPending
						if v99 != 0 {
							return int32(0)
...
func F_pgaio_sync_submit(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v8 != 0 {
		...
		if v12 != 0 {
			...
			F_errfinish(m, int32(520348), int32(44), int32(107312))
			v17 = m.ExcPending
			if v17 != 0 {
				return int32(0)
			} else {
...
func F_pgaio_worker_shmem_init(m *base.Module, l0 int32) {
	...
	v9 = v7 - int32(16)
	m.G0 = v9
	v16 = F_ShmemInitStruct(m, int32(362829), int32(272), v9+int32(15))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
		...
		*(*int32)(unsafe.Add(mBase, _consts[778])) = v16
		...
		v31 = F_ShmemInitStruct(m, int32(313309), int32(264), v9+int32(15))
		mBase = m.M
		v32 = m.ExcPending
		if v32 != 0 {
			return
