...
func F_UnreservedPLKeywords_hash_func(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l1 == v3 {
		...
		if l1 == v13 {
			...
			v59 = l1
			v60 = v13
			v61 = int32(_a_F_UnreservedPLKeywords_hash_func_0)
			v66 = int32(0)
		} else {
			v23 = l0
			v24 = int32(0)
			...
			for {
				...
				v36 = v34 | v32
				v37 = int32(_a_F_UnreservedPLKeywords_hash_func_0)
			...
			v59 = v48
			v60 = v42
			v61 = v42 * int32(_a_F_UnreservedPLKeywords_hash_func_0)
			v66 = v48 * int32(257)
		}
		if l1&v13 != 0 {
	...
	v89 = int32(1)
	v92 = int32(*(*int16)(unsafe.Add(mBase, uint32(v81<<(uint(v89)%32))+uint32(_c_F_UnreservedPLKeywords_hash_func[0]))))
	v96 = int32(*(*int16)(unsafe.Add(mBase, uint32(v87<<(uint(v89)%32))+uint32(_c_F_UnreservedPLKeywords_hash_func[0]))))
	return v92 + v96
}
		...
		if v37 != 0 {
			...
			if v36 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v22))) = v24
				F_errmsg_internal(m, int32(_a_F_UpdateDecodingStats_0), v22)
				mBase = m.M
				v59 = m.ExcPending
				if v59 != 0 {
					return
					...
					if v64 != 0 {
						...
						*(*int64)(unsafe.Add(mBase, uint32(v22)+128)) = v100
						...
						v108 = *(*int32)(unsafe.Add(mBase, _c_F_UpdateDecodingStats[0]))
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(_a_F_unique_key_recheck_0)
	F_errmsg(m, int32(_a_F_unique_key_recheck_8), v10+int32(16))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L10
...
L16:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v10)+80)) = uint8(v70)
	v73 = *(*int32)(unsafe.Add(mBase, _c_F_unique_key_recheck[0]))
	if v73 != 0 {
		goto L17
	} else {
		goto L18
...
L17:
	;
	v75 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_unique_key_recheck[1])))
...
L19:
	...
	v89 = m.T0[v88].(func(*base.Module, int32, int32, int32, int32, int32, int32) int32)(m, v68, v10+int32(208), int32(_a_F_unique_key_recheck_7), v59, v10+int32(80), int32(0))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L10
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(_a_F_unique_key_recheck_0)
	F_errmsg(m, int32(_a_F_unique_key_recheck_1), v10)
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L10
...
L59:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = int32(_a_F_unique_key_recheck_0)
	F_errmsg(m, int32(_a_F_unique_key_recheck_3), v10+int32(32))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L10
...
L132:
	...
	if base.Ui32(int32(_a_F_unistr_0)) <= base.Ui32(v602-int32(1)) {
		goto L21
	} else {
		goto L138
	}
...
L139:
	;
	if v622&int32(-1024) == int32(_a_F_unistr_2) {
		goto L145
	} else {
		goto L146
	}
...
L143:
	;
	v622 = v84<<(uint(int32(10))%32)&int32(_a_F_unistr_4) | v602&int32(1023) + int32(_a_F_unistr_5)
	goto L139
L144:
	;
	v622 = v602
...
L194:
	...
	if base.Ui32(int32(_a_F_unistr_0)) <= base.Ui32(v922-int32(1)) {
		goto L19
	} else {
		goto L200
	}
...
L201:
	;
	if v942&int32(-1024) == int32(_a_F_unistr_2) {
		goto L207
	} else {
		goto L208
	}
...
L205:
	;
	v942 = v84<<(uint(int32(10))%32)&int32(_a_F_unistr_4) | v922&int32(1023) + int32(_a_F_unistr_5)
	goto L201
L206:
	;
	v942 = v922
...
L225:
	;
	F_errmsg_internal(m, int32(_a_F_unistr_13), int32(0))
	mBase = m.M
	v1090 = m.ExcPending
	if v1090 != 0 {
		goto L1
...
L226:
	;
	F_errfinish(m, int32(_a_F_unistr_8), int32(_a_F_unistr_14), int32(_a_F_unistr_15))
	mBase = m.M
	v1095 = m.ExcPending
	if v1095 != 0 {
		goto L1
...
L229:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v336
	F_errmsg(m, int32(_a_F_unistr_16), v23)
	mBase = m.M
	v1106 = m.ExcPending
	if v1106 != 0 {
		goto L1
...
L230:
	;
	F_errfinish(m, int32(_a_F_unistr_8), int32(_a_F_unistr_17), int32(_a_F_unistr_10))
	mBase = m.M
	v1111 = m.ExcPending
	if v1111 != 0 {
		goto L1
...
L236:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v602
	F_errmsg(m, int32(_a_F_unistr_16), v23+int32(16))
	mBase = m.M
	v1148 = m.ExcPending
	if v1148 != 0 {
		goto L1
...
L237:
	;
	F_errfinish(m, int32(_a_F_unistr_8), int32(_a_F_unistr_18), int32(_a_F_unistr_10))
	mBase = m.M
	v1153 = m.ExcPending
	if v1153 != 0 {
		goto L1
...
L243:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+32)) = v922
	F_errmsg(m, int32(_a_F_unistr_16), v23+int32(32))
	mBase = m.M
	v1194 = m.ExcPending
	if v1194 != 0 {
		goto L1
...
L244:
	;
	F_errfinish(m, int32(_a_F_unistr_8), int32(_a_F_unistr_19), int32(_a_F_unistr_10))
	mBase = m.M
	v1199 = m.ExcPending
	if v1199 != 0 {
		goto L1
...
L6:
	;
	if base.Ui32(int32(255)) < base.Ui32(v73) {
		goto L1
	} else {
		goto L23
	}
...
L24:
	;
	if base.Ui32(int32(255)) < base.Ui32(v132) {
		goto L1
	} else {
		goto L41
	}
...
L41:
	...
	v136 = F_varstr_levenshtein_less_equal(m, v6, v73, l1, v132, v135)
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L42
...
L45:
	;
	if base.Ui32(int32(base.Ui32(v197)>>(uint(int32(1))%32))) < base.Ui32(v136) {
		goto L1
	} else {
		goto L62
	}
...
L48:
	;
	v148 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v140))))
	if v148 == int32(0) {
		goto L49
	} else {
		goto L50
...
L62:
	...
	if base.B2i32(v201 != int32(-1))&base.B2i32(v201 <= v136) != 0 {
		goto L1
	} else {
		goto L63
	}
...
func F_update_controlfile(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v174
	v5 = m.G0
	v7 = v5 - int32(_a_F_update_controlfile_0)
	m.G0 = v7
	v9 = F___time(m)
	mBase = m.M
	v10 = int32(-1)
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1)+292)) = v15 ^ v10
	v24 = F__emscripten_memset_bulkmem(m, v7+int32(1400), base.I32_extend8_s(int32(0)), int32(_a_F_update_controlfile_1))
	mBase = m.M
	goto L1
L1:
	;
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+68)) = int32(_a_F_update_controlfile_2)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+64)) = l0
	v39 = F_pg_snprintf(m, v7+int32(80), int32(1024), int32(_a_F_update_controlfile_3), v7-int32(-64))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L6
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_update_controlfile[0])) = int32(0)
	v52 = *(*int32)(unsafe.Add(mBase, _c_F_update_controlfile[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v52))) = int32(167772173)
	v57 = int32(_a_F_update_controlfile_4)
...
L14:
	;
	v62 = *(*int32)(unsafe.Add(mBase, _c_F_update_controlfile[0]))
	if v62 == int32(0) {
		goto L17
	} else {
		goto L18
...
L16:
	;
	v87 = int32(_a_F_update_controlfile_5)
	v88 = *(*int32)(unsafe.Add(mBase, _c_F_update_controlfile[1]))
	v89 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v88))) = v89
	v92 = *(*int32)(unsafe.Add(mBase, _c_F_update_controlfile[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v92))) = int32(167772171)
	v97 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_update_controlfile[2])))
	if v97 != int32(1) {
		v111 = v89
		goto L25
	} else {
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = v7 + int32(80)
	F_errmsg(m, int32(_a_F_update_controlfile_6), v7+int32(48))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L6
...
L29:
	;
	v106 = *(*int32)(unsafe.Add(mBase, _c_F_update_controlfile[0]))
	if v106 == int32(27) {
		goto L27
	} else {
		goto L30
...
L31:
	;
	v113 = *(*int32)(unsafe.Add(mBase, _c_F_update_controlfile[1]))
...
L32:
	;
	m.G0 = v7 + int32(_a_F_update_controlfile_0)
	return
L33:
	;
	F_errcode_for_file_access(m)
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(80)
	F_errmsg(m, int32(_a_F_update_controlfile_9), v7)
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L6
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v7 + int32(80)
	F_errmsg(m, int32(_a_F_update_controlfile_10), v7+int32(32))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L6
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v7 + int32(80)
	F_errmsg(m, int32(_a_F_update_controlfile_11), v7+int32(16))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L6
