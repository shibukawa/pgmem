		...
		if v37 != 0 {
			...
			if v36 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v22))) = v24
				F_errmsg_internal(m, int32(427575), v22)
				mBase = m.M
				v59 = m.ExcPending
				if v59 != 0 {
					return
				} else {
					F_errfinish(m, int32(494412), int32(1972), int32(125508))
					mBase = m.M
					v64 = m.ExcPending
					if v64 != 0 {
						return
						...
						if v62 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = l0
							...
							if v69 != 0 {
								...
								F_errsave_finish(m, l3, int32(490743), int32(924), int32(228141))
								mBase = m.M
								v74 = m.ExcPending
								if v74 != 0 {
									return int32(0)
								...
								if v101 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = l2
									...
									if v108 != 0 {
										...
										F_errsave_finish(m, l3, int32(490743), int32(940), int32(228141))
										mBase = m.M
										v113 = m.ExcPending
										if v113 != 0 {
											return int32(0)
					...
					if v42 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v11))) = l2
						...
						if v47 != 0 {
							...
							F_errsave_finish(m, l3, int32(490743), int32(918), int32(228141))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
...
func F_umask(m *base.Module, l0 int32) int32 {
	...
	_ = v14
	v3 = int32(4380696)
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1360]))
	*(*int32)(unsafe.Add(mBase, _consts[1360])) = l0
...
func F_union_tuples(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v21 = F_AllocSetContextCreateInternal(m, v16, int32(271450), v4, int32(8192), int32(8388608))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L1
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(315936)
	F_errmsg(m, int32(535344), v10+int32(16))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L10
...
L13:
	;
	F_errfinish(m, int32(489916), int32(83), int32(315936))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L10
...
L19:
	...
	v89 = m.T0[v88].(func(*base.Module, int32, int32, int32, int32, int32, int32) int32)(m, v68, v10+int32(208), int32(4154168), v59, v10+int32(80), int32(0))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L10
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(315936)
	F_errmsg(m, int32(224168), v10)
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L10
...
L56:
	;
	F_errfinish(m, int32(489916), int32(62), int32(315936))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L10
...
L59:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = int32(315936)
	F_errmsg(m, int32(512754), v10+int32(32))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L10
...
L60:
	;
	F_errfinish(m, int32(489916), int32(69), int32(315936))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L10
...
L62:
	;
	F_errmsg_internal(m, int32(334504), int32(0))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L10
...
L63:
	;
	F_errfinish(m, int32(324744), int32(1218), int32(381350))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L10
...
L214:
	;
	F_errhint(m, int32(637700), int32(0))
	mBase = m.M
	v997 = m.ExcPending
	if v997 != 0 {
		goto L1
...
L215:
	;
	F_errfinish(m, int32(496904), int32(6902), int32(205485))
	mBase = m.M
	v1002 = m.ExcPending
	if v1002 != 0 {
		goto L1
...
L223:
	;
	F_errfinish(m, int32(496904), int32(6926), int32(205485))
	mBase = m.M
	v1075 = m.ExcPending
	if v1075 != 0 {
		goto L1
...
L226:
	;
	F_errfinish(m, int32(496904), int32(6741), int32(306895))
	mBase = m.M
	v1095 = m.ExcPending
	if v1095 != 0 {
		goto L1
...
L230:
	;
	F_errfinish(m, int32(496904), int32(6802), int32(205485))
	mBase = m.M
	v1111 = m.ExcPending
	if v1111 != 0 {
		goto L1
...
L236:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v602
	F_errmsg(m, int32(506991), v23+int32(16))
	mBase = m.M
	v1148 = m.ExcPending
	if v1148 != 0 {
		goto L1
...
L237:
	;
	F_errfinish(m, int32(496904), int32(6837), int32(205485))
	mBase = m.M
	v1153 = m.ExcPending
	if v1153 != 0 {
		goto L1
...
L243:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+32)) = v922
	F_errmsg(m, int32(506991), v23+int32(32))
	mBase = m.M
	v1194 = m.ExcPending
	if v1194 != 0 {
		goto L1
...
L244:
	;
	F_errfinish(m, int32(496904), int32(6872), int32(205485))
	mBase = m.M
	v1199 = m.ExcPending
	if v1199 != 0 {
		goto L1
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+68)) = int32(299591)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+64)) = l0
	v39 = F_pg_snprintf(m, v7+int32(80), int32(1024), int32(176209), v7-int32(-64))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L6
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = v7 + int32(80)
	F_errmsg(m, int32(297453), v7+int32(48))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L6
...
L22:
	;
	F_errfinish(m, int32(490836), int32(247), int32(383885))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L6
...
L35:
	;
	F_errfinish(m, int32(490836), int32(226), int32(383885))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L6
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v7 + int32(80)
	F_errmsg(m, int32(297816), v7+int32(32))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L6
...
L39:
	;
	F_errfinish(m, int32(490836), int32(264), int32(383885))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L6
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v7 + int32(80)
	F_errmsg(m, int32(297611), v7+int32(16))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L6
...
L43:
	;
	F_errfinish(m, int32(490836), int32(278), int32(383885))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L6
