...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(6743)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(6744)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = int32(6745)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = int32(6746)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(6747)
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(6748)
	F_pfree(m, v13)
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
...
L32:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v56))) = uint8(v60)
	v62 = int32(460823)
	v65 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1308])))
...
L47:
	;
	v100 = int32(173012)
	v103 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1309])))
...
L56:
	;
	v128 = int32(370343)
	v131 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1310])))
