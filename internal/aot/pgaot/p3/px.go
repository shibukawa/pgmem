...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(7461)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(7462)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = int32(7463)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = int32(7464)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(7465)
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(7466)
	F_pfree(m, v13)
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
...
L32:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v56))) = uint8(v60)
	v62 = int32(486550)
	v65 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1328])))
...
L47:
	;
	v100 = int32(184994)
	v103 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1329])))
...
L56:
	;
	v128 = int32(392193)
	v131 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1330])))
