...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(6840)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(6841)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = int32(6842)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = int32(6843)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = int32(6844)
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(6845)
	F_pfree(m, v13)
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
