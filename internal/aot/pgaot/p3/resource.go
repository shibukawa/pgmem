...
func F_ResourceOwnerEnlarge(m *base.Module, l0 int32) {
	...
	if v12 != int32(1) {
		...
		if v258 != 0 {
			...
			F_errmsg_internal(m, int32(443384), int32(0))
			mBase = m.M
			v262 = m.ExcPending
			if v262 != 0 {
				return
			} else {
				F_errfinish(m, int32(493537), int32(459), int32(398981))
				mBase = m.M
				v267 = m.ExcPending
				if v267 != 0 {
					return
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
	F_errmsg_internal(m, int32(181681), v10)
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L9
...
L11:
	;
	F_errfinish(m, int32(493537), int32(1100), int32(316589))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L9
...
L53:
	;
	F_errmsg_internal(m, int32(445590), int32(0))
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L6
...
L54:
	;
	F_errfinish(m, int32(494317), int32(284), int32(217836))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L6
...
L60:
	;
	F_errmsg_internal(m, int32(389163), int32(0))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L6
...
L61:
	;
	F_errfinish(m, int32(494317), int32(293), int32(217836))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L6
...
L67:
	;
	F_errmsg_internal(m, int32(439488), int32(0))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L6
...
L68:
	;
	F_errfinish(m, int32(494317), int32(301), int32(217836))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L6
