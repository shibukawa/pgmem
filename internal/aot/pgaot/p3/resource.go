...
func F_ResourceOwnerEnlarge(m *base.Module, l0 int32) {
	...
	if v12 != int32(1) {
		...
		if v258 != 0 {
			...
			F_errmsg_internal(m, int32(424080), int32(0))
			mBase = m.M
			v262 = m.ExcPending
			if v262 != 0 {
				return
			} else {
				F_errfinish(m, int32(472442), int32(459), int32(381199))
				mBase = m.M
				v267 = m.ExcPending
				if v267 != 0 {
					return
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
	F_errmsg_internal(m, int32(171987), v10)
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L9
...
L11:
	;
	F_errfinish(m, int32(472442), int32(1100), int32(302090))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L9
...
L14:
	;
	v270 = int32(4443044)
	v271 = *(*int32)(unsafe.Add(mBase, _consts[170]))
	*(*int32)(unsafe.Add(mBase, _consts[170])) = l0
	switch l1 - int32(1) {
	case 0:
		goto L42
	case 1:
...
L15:
	;
	F_pg_qsort(m, v241, v223, int32(8), int32(1832))
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L6
...
L39:
	;
	v999 = *(*int32)(unsafe.Add(mBase, _consts[1182]))
	if v999 != 0 {
		goto L235
	} else {
		goto L236
...
L46:
	;
	v309 = int32(4437644)
	v311 = *(*int32)(unsafe.Add(mBase, _consts[106]))
	*(*int32)(unsafe.Add(mBase, _consts[106])) = v311 + int32(1)
...
L51:
	;
	v343 = *(*int32)(unsafe.Add(mBase, _consts[767]))
...
L53:
	;
	F_errmsg_internal(m, int32(426223), int32(0))
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L6
...
L54:
	;
	F_errfinish(m, int32(473161), int32(284), int32(207666))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L6
...
L60:
	;
	F_errmsg_internal(m, int32(371503), int32(0))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L6
...
L61:
	;
	F_errfinish(m, int32(473161), int32(293), int32(207666))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L6
...
L67:
	;
	F_errmsg_internal(m, int32(420184), int32(0))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L6
...
L68:
	;
	F_errfinish(m, int32(473161), int32(301), int32(207666))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L6
...
L73:
	;
	v388 = int32(4437644)
	v390 = *(*int32)(unsafe.Add(mBase, _consts[106]))
	*(*int32)(unsafe.Add(mBase, _consts[106])) = v390 - int32(1)
...
L76:
	;
	v399 = *(*int32)(unsafe.Add(mBase, _consts[559]))
	if l0 != v399 {
		goto L39
	} else {
		goto L79
...
L93:
	...
	v428 = v426 - int32(32)
	m.G0 = v428
	v431 = *(*int32)(unsafe.Add(mBase, _consts[170]))
...
L99:
	;
	v639 = *(*int32)(unsafe.Add(mBase, _consts[1183]))
...
L104:
	...
	v472 = *(*int32)(unsafe.Add(mBase, _consts[170]))
	if v465 == int32(0) {
		goto L106
	} else {
		goto L107
...
L143:
	;
	v607 = *(*int32)(unsafe.Add(mBase, _consts[170]))
...
L163:
	...
	v679 = *(*int32)(unsafe.Add(mBase, _consts[170]))
	if v672 == int32(0) {
		goto L165
	} else {
		goto L166
...
L202:
	;
	v814 = *(*int32)(unsafe.Add(mBase, _consts[170]))
...
L220:
	;
	v910 = *(*int32)(unsafe.Add(mBase, _consts[1183]))
...
L237:
	;
	*(*int32)(unsafe.Add(mBase, _consts[170])) = v271
	return
L238:
	;
