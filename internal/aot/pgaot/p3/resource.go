...
func F_ResourceOwnerEnlarge(m *base.Module, l0 int32) {
	...
	if v12 != int32(1) {
		...
		if v258 != 0 {
			...
			F_errmsg_internal(m, int32(444697), int32(0))
			mBase = m.M
			v262 = m.ExcPending
			if v262 != 0 {
				return
			} else {
				F_errfinish(m, int32(495260), int32(459), int32(400135))
				mBase = m.M
				v267 = m.ExcPending
				if v267 != 0 {
					return
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
	F_errmsg_internal(m, int32(182096), v10)
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L9
...
L11:
	;
	F_errfinish(m, int32(495260), int32(1100), int32(317449))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L9
...
L53:
	;
	F_errmsg_internal(m, int32(446903), int32(0))
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L6
...
L54:
	;
	F_errfinish(m, int32(496040), int32(284), int32(218251))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L6
...
L60:
	;
	F_errmsg_internal(m, int32(390317), int32(0))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L6
...
L61:
	;
	F_errfinish(m, int32(496040), int32(293), int32(218251))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L6
...
L67:
	;
	F_errmsg_internal(m, int32(440801), int32(0))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L6
...
L68:
	;
	F_errfinish(m, int32(496040), int32(301), int32(218251))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L6
