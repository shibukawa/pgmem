...
func F_ResourceOwnerEnlarge(m *base.Module, l0 int32) {
	...
	if v12 != int32(1) {
		...
		if v258 != 0 {
			...
			F_errmsg_internal(m, int32(446132), int32(0))
			mBase = m.M
			v262 = m.ExcPending
			if v262 != 0 {
				return
			} else {
				F_errfinish(m, int32(496762), int32(459), int32(401382))
				mBase = m.M
				v267 = m.ExcPending
				if v267 != 0 {
					return
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
	F_errmsg_internal(m, int32(182649), v10)
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L9
...
L11:
	;
	F_errfinish(m, int32(496762), int32(1100), int32(318482))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L9
...
L14:
	;
	v270 = int32(4520612)
	v271 = *(*int32)(unsafe.Add(mBase, _consts[179]))
	*(*int32)(unsafe.Add(mBase, _consts[179])) = l0
	switch l1 - int32(1) {
	case 0:
		goto L42
	case 1:
...
L39:
	;
	v999 = *(*int32)(unsafe.Add(mBase, _consts[1193]))
	if v999 != 0 {
		goto L235
	} else {
		goto L236
...
L46:
	;
	v309 = int32(4515212)
	v311 = *(*int32)(unsafe.Add(mBase, _consts[115]))
	*(*int32)(unsafe.Add(mBase, _consts[115])) = v311 + int32(1)
...
L51:
	;
	v343 = *(*int32)(unsafe.Add(mBase, _consts[776]))
...
L53:
	;
	F_errmsg_internal(m, int32(448338), int32(0))
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L6
...
L54:
	;
	F_errfinish(m, int32(497559), int32(284), int32(218804))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L6
...
L60:
	;
	F_errmsg_internal(m, int32(391564), int32(0))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L6
...
L61:
	;
	F_errfinish(m, int32(497559), int32(293), int32(218804))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L6
...
L67:
	;
	F_errmsg_internal(m, int32(442203), int32(0))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L6
...
L68:
	;
	F_errfinish(m, int32(497559), int32(301), int32(218804))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L6
...
L73:
	;
	v388 = int32(4515212)
	v390 = *(*int32)(unsafe.Add(mBase, _consts[115]))
	*(*int32)(unsafe.Add(mBase, _consts[115])) = v390 - int32(1)
...
L76:
	;
	v399 = *(*int32)(unsafe.Add(mBase, _consts[568]))
	if l0 != v399 {
		goto L39
	} else {
		goto L79
...
L93:
	...
	v428 = v426 - int32(32)
	m.G0 = v428
	v431 = *(*int32)(unsafe.Add(mBase, _consts[179]))
...
L99:
	;
	v639 = *(*int32)(unsafe.Add(mBase, _consts[1194]))
...
L104:
	...
	v472 = *(*int32)(unsafe.Add(mBase, _consts[179]))
	if v465 == int32(0) {
		goto L106
	} else {
		goto L107
...
L143:
	;
	v607 = *(*int32)(unsafe.Add(mBase, _consts[179]))
...
L163:
	...
	v679 = *(*int32)(unsafe.Add(mBase, _consts[179]))
	if v672 == int32(0) {
		goto L165
	} else {
		goto L166
...
L202:
	;
	v814 = *(*int32)(unsafe.Add(mBase, _consts[179]))
...
L220:
	;
	v910 = *(*int32)(unsafe.Add(mBase, _consts[1194]))
...
L237:
	;
	*(*int32)(unsafe.Add(mBase, _consts[179])) = v271
	return
L238:
	;
