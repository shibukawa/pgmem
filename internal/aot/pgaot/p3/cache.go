...
L2:
	...
	v18 = *(*int32)(unsafe.Add(mBase, _consts[1082]))
...
L6:
	;
	v53 = *(*int32)(unsafe.Add(mBase, _consts[1083]))
	if v53 <= v20 {
		goto L15
	} else {
		goto L16
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1083])) = v69
	*(*int32)(unsafe.Add(mBase, _consts[1082])) = v70
	v75 = v70
	goto L17
L19:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _consts[116]))
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(523363), int32(1697), int32(456999))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
...
func F_CacheRegisterRelcacheCallback(m *base.Module, l0 int32) {
	...
	var v22 int32
	_ = v22
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1091]))
	if int32(10) <= v5 {
		...
		if v11 != 0 {
			...
			F_errmsg_internal(m, int32(126726), int32(0))
			mBase = m.M
			v15 = m.ExcPending
			if v15 != 0 {
				return
			} else {
				F_errfinish(m, int32(523363), int32(1862), int32(335830))
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v22)+uint32(_consts[1092]))) = int32(0)
		*(*int32)(unsafe.Add(mBase, uint32(v22)+uint32(_consts[1093]))) = l0
		*(*int32)(unsafe.Add(mBase, _consts[1091])) = v5 + int32(1)
		return
	}
}
func F_CacheRegisterSyscacheCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if base.Ui32(v1) < base.Ui32(int32(85)) {
		v15 = *(*int32)(unsafe.Add(mBase, _consts[1084]))
		if int32(64) <= v15 {
			F_errstart_cold(m, int32(22), int32(0))
			mBase = m.M
			v90 = m.ExcPending
			if v90 != 0 {
				...
				F_errmsg_internal(m, int32(126690), int32(0))
				mBase = m.M
				v94 = m.ExcPending
				if v94 != 0 {
					return
				} else {
					F_errfinish(m, int32(523363), int32(1823), int32(335800))
					mBase = m.M
					v99 = m.ExcPending
					if v99 != 0 {
						return
			...
			v22 = int32(*(*int16)(unsafe.Add(mBase, uint32(v19)+uint32(_consts[1085]))))
			if v22 == int32(0) {
				v26 = v15 + int32(1)
				*(*uint16)(unsafe.Add(mBase, uint32(v19)+uint32(_consts[1085]))) = uint16(v26)
			} else {
				v31 = v22
				for {
					v36 = v31 * int32(12)
					v39 = int32(*(*int16)(unsafe.Add(mBase, uint32(v36)+uint32(_consts[1086]))))
					if int32(0) < v39 {
						v31 = v39
						continue
					} else {
				...
				v43 = v15 + int32(1)
				*(*uint16)(unsafe.Add(mBase, uint32(v36)+uint32(_consts[1086]))) = uint16(v43)
			}
			v53 = v15 * int32(12)
			*(*int32)(unsafe.Add(mBase, uint32(v53)+uint32(_consts[1087]))) = l2
			*(*int32)(unsafe.Add(mBase, uint32(v53)+uint32(_consts[1088]))) = l1
			v62 = int32(0)
			*(*uint16)(unsafe.Add(mBase, uint32(v53)+uint32(_consts[1089]))) = uint16(v62)
			*(*uint16)(unsafe.Add(mBase, uint32(v53)+uint32(_consts[1090]))) = uint16(v1)
			*(*int32)(unsafe.Add(mBase, _consts[1084])) = v15 + int32(1)
			m.G0 = v10 + int32(16)
			return
		}
	} else {
		...
		if v77 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = v1
			F_errmsg_internal(m, int32(511755), v10)
			mBase = m.M
			v81 = m.ExcPending
			if v81 != 0 {
				return
			} else {
				F_errfinish(m, int32(523363), int32(1821), int32(335800))
				mBase = m.M
				v86 = m.ExcPending
				if v86 != 0 {
					return
