...
L2:
	;
	v16 = *(*int32)(unsafe.Add(mBase, _c_F_CacheInvalidateRelSync[0]))
	v18 = *(*int32)(unsafe.Add(mBase, _c_F_CacheInvalidateRelSync[1]))
...
L6:
	;
	v53 = *(*int32)(unsafe.Add(mBase, _c_F_CacheInvalidateRelSync[2]))
	if v53 <= v20 {
		goto L15
	} else {
		goto L16
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_CacheInvalidateRelSync[2])) = v69
	*(*int32)(unsafe.Add(mBase, _c_F_CacheInvalidateRelSync[1])) = v70
	v75 = v70
	goto L17
L19:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _c_F_CacheInvalidateRelSync[3]))
...
func F_CacheRegisterSyscacheCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if base.Ui32(v1) < base.Ui32(int32(85)) {
		...
		if int32(64) <= v15 {
			...
			v22 = int32(*(*int16)(unsafe.Add(mBase, uint32(v19)+uint32(_c_F_CacheRegisterSyscacheCallback[1]))))
			if v22 == int32(0) {
				v26 = v15 + int32(1)
...
func F_cache_store_tuple(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v113 int32
	_ = v113
	v8 = int32(_a_F_cache_store_tuple_0)
	v9 = *(*int32)(unsafe.Add(mBase, _c_F_cache_store_tuple[0]))
	v10 = *(*int32)(unsafe.Add(mBase, uint32(l0)+192))
	v12 = *(*int32)(unsafe.Add(mBase, uint32(l0)+176))
	*(*int32)(unsafe.Add(mBase, _c_F_cache_store_tuple[0])) = v12
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_cache_store_tuple[0])) = v9
