			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(498993), int32(1697), int32(436565))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return
...
func F_CacheRegisterRelcacheCallback(m *base.Module, l0 int32) {
	...
	if int32(10) <= v5 {
		...
		if v11 != 0 {
			...
			F_errmsg_internal(m, int32(119045), int32(0))
			mBase = m.M
			v15 = m.ExcPending
			if v15 != 0 {
				return
			} else {
				F_errfinish(m, int32(498993), int32(1862), int32(320241))
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					return
	...
	if base.Ui32(v1) < base.Ui32(int32(85)) {
		...
		if int32(64) <= v15 {
			...
			if v90 != 0 {
				...
				F_errmsg_internal(m, int32(119009), int32(0))
				mBase = m.M
				v94 = m.ExcPending
				if v94 != 0 {
					return
				} else {
					F_errfinish(m, int32(498993), int32(1823), int32(320211))
					mBase = m.M
					v99 = m.ExcPending
					if v99 != 0 {
						return
		...
		if v77 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = v1
			F_errmsg_internal(m, int32(489268), v10)
			mBase = m.M
			v81 = m.ExcPending
			if v81 != 0 {
				return
			} else {
				F_errfinish(m, int32(498993), int32(1821), int32(320211))
				mBase = m.M
				v86 = m.ExcPending
				if v86 != 0 {
					return
