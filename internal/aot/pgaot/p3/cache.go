...
L6:
	;
	v53 = *(*int32)(unsafe.Add(mBase, _consts[1079]))
	if v53 <= v20 {
		goto L15
	} else {
		goto L16
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1079])) = v69
	*(*int32)(unsafe.Add(mBase, _consts[1078])) = v70
	v75 = v70
	goto L17
L19:
	;
...
func F_CacheRegisterRelcacheCallback(m *base.Module, l0 int32) {
	...
	var v22 int32
	_ = v22
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1087]))
	if int32(10) <= v5 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v22)+uint32(_consts[1088]))) = int32(0)
		*(*int32)(unsafe.Add(mBase, uint32(v22)+uint32(_consts[1089]))) = l0
		*(*int32)(unsafe.Add(mBase, _consts[1087])) = v5 + int32(1)
		return
	}
}
func F_CacheRegisterSyscacheCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if base.Ui32(v1) < base.Ui32(int32(85)) {
		v15 = *(*int32)(unsafe.Add(mBase, _consts[1080]))
		if int32(64) <= v15 {
			F_errstart_cold(m, int32(22), int32(0))
			mBase = m.M
			v90 = m.ExcPending
			...
			v22 = int32(*(*int16)(unsafe.Add(mBase, uint32(v19)+uint32(_consts[1081]))))
			if v22 == int32(0) {
				v26 = v15 + int32(1)
				*(*uint16)(unsafe.Add(mBase, uint32(v19)+uint32(_consts[1081]))) = uint16(v26)
			} else {
				v31 = v22
				for {
					v36 = v31 * int32(12)
					v39 = int32(*(*int16)(unsafe.Add(mBase, uint32(v36)+uint32(_consts[1082]))))
					if int32(0) < v39 {
						v31 = v39
						continue
					} else {
				...
				v43 = v15 + int32(1)
				*(*uint16)(unsafe.Add(mBase, uint32(v36)+uint32(_consts[1082]))) = uint16(v43)
			}
			v53 = v15 * int32(12)
			*(*int32)(unsafe.Add(mBase, uint32(v53)+uint32(_consts[1083]))) = l2
			*(*int32)(unsafe.Add(mBase, uint32(v53)+uint32(_consts[1084]))) = l1
			v62 = int32(0)
			*(*uint16)(unsafe.Add(mBase, uint32(v53)+uint32(_consts[1085]))) = uint16(v62)
			*(*uint16)(unsafe.Add(mBase, uint32(v53)+uint32(_consts[1086]))) = uint16(v1)
			*(*int32)(unsafe.Add(mBase, _consts[1080])) = v15 + int32(1)
			m.G0 = v10 + int32(16)
			return
		}
	} else {
