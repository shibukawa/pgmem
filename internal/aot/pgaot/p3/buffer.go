...
L7:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _c_F_allocNewBuffer[0]))
...
L9:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _c_F_allocNewBuffer[1]))
...
L10:
	...
	v100 = v57 + v99
	v101 = int32(_a_F_allocNewBuffer_0)
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v57)+10)) = int32(_a_F_allocNewBuffer_1)
	v90 = int32(_a_F_allocNewBuffer_2)
	*(*uint16)(unsafe.Add(mBase, uint32(v57)+18)) = uint16(v90)
	v96 = int32(_a_F_allocNewBuffer_3)
	*(*uint16)(unsafe.Add(mBase, uint32(v57)+16)) = uint16(v96)
	*(*uint16)(unsafe.Add(mBase, uint32(v57)+14)) = uint16(v96)
	goto L10
L12:
	;
	v84 = F___memset(m, v57, int32(0), int32(_a_F_allocNewBuffer_4))
	mBase = m.M
	goto L11
L13:
	;
...
L23:
	;
	v107 = *(*int32)(unsafe.Add(mBase, _c_F_allocNewBuffer[2]))
...
L25:
	;
	v115 = *(*int32)(unsafe.Add(mBase, _c_F_allocNewBuffer[3]))
...
L31:
	;
	v136 = *(*int32)(unsafe.Add(mBase, _c_F_allocNewBuffer[0]))
...
L33:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _c_F_allocNewBuffer[1]))
