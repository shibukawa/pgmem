...
func F_RegisterTwoPhaseRecord(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if base.Ui32(int32(8)) <= base.Ui32(v10) {
		v14 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[1]))
		...
		*(*int32)(unsafe.Add(mBase, uint32(v43)+4)) = v54
		v58 = v45 - v53
		*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[0])) = v58
		v60 = int32(_a_F_RegisterTwoPhaseRecord_0)
		v62 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[2]))
		v64 = v62 + v53
		*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[2])) = v64
		if l2 != 0 {
			...
			if base.Ui32(v69) <= base.Ui32(v58) {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[0])) = v106 - v69
				...
				if v74 != 0 {
					...
					v75 = int32(_a_F_RegisterTwoPhaseRecord_1)
					v76 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[1]))
					*(*int32)(unsafe.Add(mBase, uint32(v76)+8)) = v73
					*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[1])) = v73
					...
					*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[0])) = v86
					v88 = int32(_a_F_RegisterTwoPhaseRecord_2)
					v90 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[3]))
					*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[3])) = v90 + int32(1)
					v94 = F_palloc(m, v86)
					mBase = m.M
					v95 = m.ExcPending
					if v95 != 0 {
						...
						v97 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[1]))
		...
		if v18 != 0 {
			...
			v19 = int32(_a_F_RegisterTwoPhaseRecord_1)
			v20 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[1]))
			*(*int32)(unsafe.Add(mBase, uint32(v20)+8)) = v17
			*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[1])) = v17
			*(*int64)(unsafe.Add(mBase, uint32(v17)+4)) = int64(0)
			v27 = int32(512)
			*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[0])) = v27
			v29 = int32(_a_F_RegisterTwoPhaseRecord_2)
			v31 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[3]))
			*(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[3])) = v31 + int32(1)
			v36 = F_palloc(m, v27)
			mBase = m.M
			v37 = m.ExcPending
			if v37 != 0 {
				...
				v39 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[1]))
				*(*int32)(unsafe.Add(mBase, uint32(v39))) = v36
				v42 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTwoPhaseRecord[0]))
				v43 = v39
				v44 = v36
				v45 = v42
				v46 = *(*int32)(unsafe.Add(mBase, uint32(v43)+4))
