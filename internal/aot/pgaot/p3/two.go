		...
		*(*int32)(unsafe.Add(mBase, _consts[158])) = v64
		if l2 != 0 {
			...
			if base.Ui32(v69) <= base.Ui32(v58) {
				...
				*(*int32)(unsafe.Add(mBase, _consts[158])) = v104 + v69
				*(*int32)(unsafe.Add(mBase, _consts[156])) = v106 - v69
				return
			} else {
				...
				if v74 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _consts[159])) = v90 + int32(1)
					...
					if v95 != 0 {
						...
						v97 = *(*int32)(unsafe.Add(mBase, _consts[157]))
		...
		if v18 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[159])) = v31 + int32(1)
			...
			if v37 != 0 {
				...
				v39 = *(*int32)(unsafe.Add(mBase, _consts[157]))
...
func F_TwoPhaseGetDummyProc(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v6 != 0 {
		...
		v8 = *(*int32)(unsafe.Add(mBase, _consts[141]))
