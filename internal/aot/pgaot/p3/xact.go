...
func F_start_xact_command(m *base.Module) {
	...
	var v80 int32
	_ = v80
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_start_xact_command[0])))
	if v3 == int32(0) {
		...
		if v7 != 0 {
			...
			v9 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _c_F_start_xact_command[0])) = uint8(v9)
			v26 = *(*int32)(unsafe.Add(mBase, _c_F_start_xact_command[1]))
			if v26 <= int32(0) {
				v51 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_start_xact_command[2])))
				if v51 == int32(0) {
					v59 = *(*int32)(unsafe.Add(mBase, _c_F_start_xact_command[3]))
					if v59 <= int32(0) {
						return
					} else {
						v63 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_start_xact_command[4])))
						if v63 != int32(1) {
							return
						} else {
							v67 = *(*int32)(unsafe.Add(mBase, _c_F_start_xact_command[5]))
							if v67 == int32(0) {
								return
							} else {
								v75 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_start_xact_command[6])))
								if v75 != 0 {
									return
								} else {
									v78 = *(*int32)(unsafe.Add(mBase, _c_F_start_xact_command[3]))
				...
				v30 = *(*int32)(unsafe.Add(mBase, _c_F_start_xact_command[7]))
				if v30 != 0 {
				...
				if v33 != 0 {
					...
					v39 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_start_xact_command[2])))
					if v39 != 0 {
						v59 = *(*int32)(unsafe.Add(mBase, _c_F_start_xact_command[3]))
						if v59 <= int32(0) {
							return
						...
						v42 = *(*int32)(unsafe.Add(mBase, _c_F_start_xact_command[1]))
		...
		v12 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_start_xact_command[8])))
		if v12&int32(8) == int32(0) {
		} else {
			v19 = *(*int32)(unsafe.Add(mBase, _c_F_start_xact_command[9]))
...
func F_xact_identify(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v8 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(2))%32))&int32(28))+uint32(_c_F_xact_identify[0])))
	return v8
}
...
L4:
	;
	v421 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[0]))
	if v421 == int32(0) {
		goto L1
	} else {
		goto L82
...
L5:
	;
	v401 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[1]))
...
L32:
	;
	v145 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[1]))
...
L34:
	;
	v156 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[1]))
...
L75:
	;
	v384 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[1]))
...
L80:
	;
	v415 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[1]))
...
L117:
	;
	v533 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[0]))
	if v533 != int32(1) {
		goto L122
	} else {
		goto L123
...
L122:
	;
	v537 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[1]))
...
L126:
	;
	v547 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[2]))
...
L131:
	;
	v562 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[2]))
...
L133:
	;
	v565 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo[1]))
...
func F_xact_redo_commit(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) {
	...
	if v86 != 0 {
		...
		if v99 != 0 {
			...
			v101 = *(*int32)(unsafe.Add(mBase, _c_F_xact_redo_commit[0]))
			if v101 == int32(0) {
													...
													if v165 < int32(0) {
														...
														if v169 != 0 {
															...
															if v171&int32(536870912) != 0 {
																v175 = int32(1)
																*(*uint8)(unsafe.Add(mBase, _c_F_xact_redo_commit[1])) = uint8(v175)
															} else {
															}
															return
														}
