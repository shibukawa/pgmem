...
func F_start_xact_command(m *base.Module) {
	...
	var v80 int32
	_ = v80
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _consts[910])))
	if v3 == int32(0) {
		...
		if v7 != 0 {
			...
			v9 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _consts[910])) = uint8(v9)
			v26 = *(*int32)(unsafe.Add(mBase, _consts[911]))
			if v26 <= int32(0) {
				v51 = int32(*(*uint8)(unsafe.Add(mBase, _consts[912])))
				if v51 == int32(0) {
					v59 = *(*int32)(unsafe.Add(mBase, _consts[913]))
					if v59 <= int32(0) {
						return
					} else {
						v63 = int32(*(*uint8)(unsafe.Add(mBase, _consts[104])))
						if v63 != int32(1) {
							return
						} else {
							v67 = *(*int32)(unsafe.Add(mBase, _consts[585]))
							if v67 == int32(0) {
								return
							} else {
								v75 = int32(*(*uint8)(unsafe.Add(mBase, _consts[914])))
								if v75 != 0 {
									return
								} else {
									v78 = *(*int32)(unsafe.Add(mBase, _consts[913]))
				...
				v30 = *(*int32)(unsafe.Add(mBase, _consts[915]))
				if v30 != 0 {
				...
				if v33 != 0 {
					...
					v39 = int32(*(*uint8)(unsafe.Add(mBase, _consts[912])))
					if v39 != 0 {
						v59 = *(*int32)(unsafe.Add(mBase, _consts[913]))
						if v59 <= int32(0) {
							return
						...
						v42 = *(*int32)(unsafe.Add(mBase, _consts[911]))
		...
		v12 = int32(*(*uint8)(unsafe.Add(mBase, _consts[432])))
...
func F_xact_identify(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v8 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(2))%32))&int32(28))+uint32(_consts[82])))
	return v8
}
...
L4:
	;
	v421 = *(*int32)(unsafe.Add(mBase, _consts[36]))
	if v421 == int32(0) {
		goto L1
	} else {
		goto L82
...
L5:
	;
	v401 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L32:
	;
	v145 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L34:
	;
	v156 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L75:
	;
	v384 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L77:
	;
	v395 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L80:
	;
	v415 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L117:
	;
	v533 = *(*int32)(unsafe.Add(mBase, _consts[36]))
	if v533 != int32(1) {
		goto L122
	} else {
		goto L123
...
L122:
	;
	v537 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L126:
	;
	v547 = *(*int32)(unsafe.Add(mBase, _consts[187]))
...
L131:
	;
	v562 = *(*int32)(unsafe.Add(mBase, _consts[187]))
...
L133:
	;
	v565 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v14
	F_errmsg_internal(m, int32(57383), v9)
	mBase = m.M
	v577 = m.ExcPending
	if v577 != 0 {
		goto L31
...
L136:
	;
	F_errfinish(m, int32(518151), int32(6445), int32(255544))
	mBase = m.M
	v582 = m.ExcPending
	if v582 != 0 {
		goto L31
...
func F_xact_redo_commit(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) {
	...
	if v86 != 0 {
		...
		if v99 != 0 {
			...
			v101 = *(*int32)(unsafe.Add(mBase, _consts[36]))
			if v101 == int32(0) {
													...
													if v165 < int32(0) {
														...
														if v169 != 0 {
															...
															if v171&int32(536870912) != 0 {
																v175 = int32(1)
																*(*uint8)(unsafe.Add(mBase, _consts[188])) = uint8(v175)
															} else {
															}
															return
														}
