...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v56
	v68 = F_pg_snprintf(m, v12+int32(48), int32(1024), int32(466506), v12+int32(32))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L19
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v75
	v84 = F_pg_snprintf(m, v12+int32(48), int32(1024), int32(466506), v12+int32(16))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L19
...
L45:
	;
	F_errfinish(m, int32(498819), int32(546), int32(226394))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L19
