...
L25:
	;
	v97 = int32(_a_F_expanded_record_set_field_internal_3)
	v98 = *(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_field_internal[0]))
	v100 = *(*int32)(unsafe.Add(mBase, uint32(l0)+96))
	*(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_field_internal[0])) = v100
...
L27:
	...
	if v86 != int32(_a_F_expanded_record_set_field_internal_4) {
		goto L25
	} else {
		goto L28
	}
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = l1
	F_errmsg_internal(m, int32(_a_F_expanded_record_set_field_internal_0), v23)
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L4
...
L45:
	;
	v194 = int32(_a_F_expanded_record_set_field_internal_3)
	v195 = *(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_field_internal[0]))
	v197 = *(*int32)(unsafe.Add(mBase, uint32(l0)+8))
	*(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_field_internal[0])) = v197
...
L46:
	...
	if v159 != int32(_a_F_expanded_record_set_field_internal_4) {
		v190 = l2
		v193 = int32(0)
		goto L45
	} else {
...
L49:
	;
	v181 = int32(_a_F_expanded_record_set_field_internal_3)
	v182 = *(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_field_internal[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_field_internal[0])) = v180
...
L50:
	...
	v174 = F_AllocSetContextCreateInternal(m, v169, int32(_a_F_expanded_record_set_field_internal_5), int32(0), int32(1024), int32(_a_F_expanded_record_set_field_internal_6))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L4
...
L56:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_field_internal[0])) = v195
	if v193 != 0 {
		goto L57
	} else {
		goto L58
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+28)) = v208 | int32(8)
	...
	if v212 != int32(_a_F_expanded_record_set_field_internal_4) {
		v221 = v201
		goto L42
	} else {
		goto L61
