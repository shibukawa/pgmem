...
L13:
	;
	v76 = *(*int32)(unsafe.Add(mBase, _c_F_LaunchParallelWorkers[5]))
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v76
	v82 = F_pg_snprintf(m, v11+int32(12), int32(96), int32(_a_F_LaunchParallelWorkers_2), v11)
	mBase = m.M
	v83 = m.ExcPending
	if v83 != 0 {
		goto L7
...
L14:
	;
	v89 = F_pg_snprintf(m, v11+int32(108), int32(96), int32(_a_F_LaunchParallelWorkers_3), int32(0))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L7
...
L15:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11)+204)) = int64(4294967315)
	v99 = F_pg_sprintf(m, v11+int32(216), int32(_a_F_LaunchParallelWorkers_4), int32(0))
	mBase = m.M
	v100 = m.ExcPending
	if v100 != 0 {
		goto L7
...
L16:
	;
	v105 = F_pg_sprintf(m, v11+int32(1240), int32(_a_F_LaunchParallelWorkers_5), int32(0))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L7
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+1336)) = v108
	v111 = *(*int32)(unsafe.Add(mBase, _c_F_LaunchParallelWorkers[5]))
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+272)) = l3
	v46 = F_pg_snprintf(m, v15+int32(304), int32(1024), int32(_a_F_ListenServerPort_0), v15+int32(272))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L6
...
func F_latin2_to_win1250(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(9), int32(29), int32(_a_F_latin2_to_win1250_0), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_lock_twophase_postcommit(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v11 != 0 {
		...
		if base.Ui32((v12-int32(3))&int32(255)) <= base.Ui32(int32(253)) {
			...
			v36 = *(*int32)(unsafe.Add(mBase, uint32(v12<<(uint(int32(2))%32))+uint32(_c_F_lock_twophase_postcommit[0])))
	...
	if v18 == v3 {
		...
		if v147 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v18
			F_errmsg_internal(m, int32(_a_F_logicalmsg_decode_0), v12)
			mBase = m.M
			v151 = m.ExcPending
			if v151 != 0 {
				return
		...
		if v19 != 0 {
			...
			if v22 == int32(0) {
				...
				if base.Ui32(v32) < base.Ui32(int32(2)) {
					...
					v45 = v9 + int32(8) + (v30+int32(9))&int32(_a_F_ltree2text_0)
					v46 = v31
					v48 = int32(1)
					for {
						v50 = int32(46)
						*(*uint8)(unsafe.Add(mBase, uint32(v46))) = uint8(v50)
						...
						if base.Ui32(v67) < base.Ui32(v68) {
							v45 = v45 + (v59+int32(9))&int32(_a_F_ltree2text_0)
							v46 = v60
							v48 = v67
							continue
						} else {
...
func F_ltrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(_a_F_ltrim1_0), v47, v47, int32(0))
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
...
func F_ltsWriteBlock(m *base.Module, l0 int32, l1 int64, l2 int32) {
	...
	_ = v70
	v7 = m.G0
	v11 = (v7 - int32(_a_F_ltsWriteBlock_0)) & int32(-4096)
	m.G0 = v11
...
L4:
	;
	v26 = F__emscripten_memset_bulkmem(m, v11+int32(_a_F_ltsWriteBlock_1), base.I32_extend8_s(int32(0)), int32(_a_F_ltsWriteBlock_2))
	mBase = m.M
	goto L6
L5:
	;
...
L6:
	;
	F_ltsWriteBlock(m, l0, v20, v11+int32(_a_F_ltsWriteBlock_1))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L7
...
L19:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11)+4080)) = l1
	F_errmsg(m, int32(_a_F_ltsWriteBlock_3), v11+int32(4080))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L7
