	...
	if v18 != 0 {
				...
				if v47 < v48 {
					...
					if v145 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v146
						F_errmsg_internal(m, int32(89279), v12+int32(16))
						mBase = m.M
						v152 = m.ExcPending
						if v152 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(520440), int32(188), int32(92052))
							mBase = m.M
							v157 = m.ExcPending
							if v157 != 0 {
								return int32(0)
					...
					if v50+v48 <= v47 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(4457456)
						...
						*(*int32)(unsafe.Add(mBase, _consts[654])) = v19
						...
						if v76 != 0 {
							...
							if v82 != 0 {
								...
								F_errmsg_internal(m, int32(375088), int32(0))
								mBase = m.M
								v86 = m.ExcPending
								if v86 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(517994), int32(236), int32(470740))
									mBase = m.M
									v91 = m.ExcPending
									if v91 != 0 {
										return int32(0)
							...
							if v97 != 0 {
								...
								if v96 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v100
									F_errmsg_internal(m, int32(190595), v12+int32(32))
									mBase = m.M
									v112 = m.ExcPending
									if v112 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(520440), int32(197), int32(92052))
										mBase = m.M
										v117 = m.ExcPending
										if v117 != 0 {
											return int32(0)
		...
		if v132 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = l0
			F_errmsg_internal(m, int32(494956), v12)
			mBase = m.M
			v136 = m.ExcPending
			if v136 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(520440), int32(168), int32(92052))
				mBase = m.M
				v141 = m.ExcPending
				if v141 != 0 {
					return int32(0)
