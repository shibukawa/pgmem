...
func F_xidout(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8
		v17 = F_pg_snprintf(m, v10, int32(16), int32(38353), v6)
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(497070), int32(4555), int32(115503))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
...
func F_xmlvalidate(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			F_errmsg(m, int32(445412), int32(0))
			v14 = m.ExcPending
			if v14 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(497070), int32(1123), int32(356401))
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(497070), int32(4533), int32(321032))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
