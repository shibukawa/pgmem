		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(497177), int32(4555), int32(115549))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				F_errfinish(m, int32(497177), int32(1123), int32(356497))
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(497177), int32(4533), int32(321092))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
