...
L83:
	;
	F_errmsg_internal(m, int32(73267), int32(0))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L20
...
L84:
	;
	F_errfinish(m, int32(481163), int32(526), int32(225252))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L20
...
L286:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v31
	F_errmsg_internal(m, int32(51128), v18+int32(-32))
	mBase = m.M
	v1158 = m.ExcPending
	if v1158 != 0 {
		goto L20
...
L287:
	;
	F_errfinish(m, int32(481163), int32(1070), int32(233693))
	mBase = m.M
	v1163 = m.ExcPending
	if v1163 != 0 {
		goto L20
...
L292:
	;
	F_errfinish(m, int32(481163), int32(508), int32(225252))
	mBase = m.M
	v1207 = m.ExcPending
	if v1207 != 0 {
		goto L20
...
L294:
	;
	F_errmsg_internal(m, int32(394055), int32(0))
	mBase = m.M
	v1215 = m.ExcPending
	if v1215 != 0 {
		goto L20
...
L295:
	;
	F_errfinish(m, int32(481163), int32(793), int32(448460))
	mBase = m.M
	v1220 = m.ExcPending
	if v1220 != 0 {
		goto L20
...
L298:
	;
	F_errfinish(m, int32(481163), int32(928), int32(392907))
	mBase = m.M
	v1233 = m.ExcPending
	if v1233 != 0 {
		goto L20
...
L41:
	;
	F_errmsg_internal(m, int32(280325), int32(0))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L3
...
L42:
	;
	F_errfinish(m, int32(481163), int32(191), int32(78641))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L3
...
L61:
	;
	F_errmsg_internal(m, int32(280288), int32(0))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L3
...
L62:
	;
	F_errfinish(m, int32(481163), int32(230), int32(78641))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L3
...
func F_btree_xlog_startup(m *base.Module) {
	...
	v8 = F_AllocSetContextCreateInternal(m, v3, int32(57960), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
