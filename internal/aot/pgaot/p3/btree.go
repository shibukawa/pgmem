...
func F_btree_redo(m *base.Module, l0 int32) {
	...
	v20 = v18 + int32(-64)
	m.G0 = v20
	v22 = int32(_a_F_btree_redo_0)
	v23 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[0]))
	v24 = *(*int32)(unsafe.Add(mBase, uint32(l0)+96))
	v25 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v24)+48)))
	v28 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_btree_redo[0])) = v28
	v31 = v25 & int32(240)
...
L4:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_btree_redo[0])) = v23
	v1189 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[1]))
...
L8:
	;
	v1132 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[2]))
...
L12:
	...
	v535 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[2]))
...
L42:
	;
	v100 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L44:
	;
	v108 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L48:
	...
	v151 = F_PageAddItemExtended(m, v140, v114+v143&int32(_a_F_btree_redo_1), int32(base.Ui32(v143)>>(uint(int32(17))%32)), int32(1), int32(0))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L20
...
L56:
	;
	v166 = int32(base.Ui32(v137+int32(_a_F_btree_redo_2)) >> (uint(int32(2)) % 32))
	goto L58
L57:
	;
	v166 = int32(0)
...
L58:
	;
	v168 = v166 & int32(_a_F_btree_redo_3)
...
L64:
	;
	v370 = v172 + int32(1)
	if base.Ui32(v370&int32(_a_F_btree_redo_3)) <= base.Ui32(v168) {
		v172 = v370
		goto L62
	} else {
		goto L94
...
L67:
	;
	v309 = v307 & int32(_a_F_btree_redo_3)
...
L74:
	...
	if v223&int32(_a_F_btree_redo_4) == int32(0) {
		v236 = v217
		v238 = v199
		goto L73
	} else {
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v117)+28)) = v268 + v236
	...
	v281 = int32(36)
	v282 = (v272&int32(_a_F_btree_redo_5)+int32(7))&int32(_a_F_btree_redo_6) | int32(4)
	goto L77
L81:
	;
	v281 = int32(4)
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v117)+36)) = (v353&int32(_a_F_btree_redo_5)+int32(7))&int32(_a_F_btree_redo_6) | int32(4)
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v117)+28)) = int32(1)
	...
	v347 = v325 & int32(_a_F_btree_redo_5)
	goto L88
L93:
	;
	goto L92
...
L119:
	;
	v478 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L121:
	;
	v486 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L128:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v508)+14)) = uint16(v509)
	...
	v513 = v511 & int32(_a_F_btree_redo_10)
...
L154:
	;
	v596 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L156:
	;
	v604 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L163:
	...
	v629 = v627 & int32(_a_F_btree_redo_10)
...
L172:
	...
	v685 = int32(_a_F_btree_redo_1)
	v691 = (v678 + int32(1)) & int32(_a_F_btree_redo_3)
...
L173:
	;
	v661 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L175:
	;
	v669 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L183:
	;
	F_PageInit(m, v738, int32(_a_F_btree_redo_4), int32(16))
	mBase = m.M
	goto L187
L184:
	;
	v724 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L186:
	;
	v732 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L199:
	;
	v790 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L201:
	;
	v798 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L203:
	;
	F_PageInit(m, v838, int32(_a_F_btree_redo_4), int32(16))
	mBase = m.M
	goto L208
L204:
	;
...
L205:
	;
	v824 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L207:
	;
	v832 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L208:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v843))) = v780
	...
	v853 = v849&int32(_a_F_btree_redo_11) | int32(260)
...
L218:
	;
	v887 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L220:
	;
	v895 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L234:
	;
	F_PageInit(m, v946, int32(_a_F_btree_redo_4), int32(16))
	mBase = m.M
	goto L239
L235:
	;
...
L236:
	;
	v932 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L238:
	;
	v940 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L246:
	;
	F_PageInit(m, v1016, int32(_a_F_btree_redo_4), int32(16))
	mBase = m.M
	goto L251
L247:
	;
...
L248:
	;
	v1002 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L250:
	;
	v1010 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L273:
	...
	v1102 = v1100 & int32(_a_F_btree_redo_12)
...
L274:
	;
	v1083 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[3]))
...
L276:
	;
	v1091 = *(*int32)(unsafe.Add(mBase, _c_F_btree_redo[4]))
...
L286:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v31
	F_errmsg_internal(m, int32(_a_F_btree_redo_13), v18+int32(-32))
	mBase = m.M
	v1158 = m.ExcPending
	if v1158 != 0 {
		goto L20
...
L8:
	...
	v47 = v45 & int32(_a_F_btree_xlog_insert_8)
...
L9:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _c_F_btree_xlog_insert[0]))
...
L11:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_btree_xlog_insert[1]))
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+4)) = v143 - v144
	...
	v155 = *(*int32)(unsafe.Add(mBase, uint32((v147-int32(1))&int32(_a_F_btree_xlog_insert_3)<<(uint(v144)%32)+v121)+20))
	v158 = v121 + v155&int32(_a_F_btree_xlog_insert_4)
