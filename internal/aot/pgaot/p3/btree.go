...
L83:
	;
	F_errmsg_internal(m, int32(75086), int32(0))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L20
...
L286:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v31
	F_errmsg_internal(m, int32(52561), v18+int32(-32))
	mBase = m.M
	v1158 = m.ExcPending
	if v1158 != 0 {
		goto L20
...
L41:
	;
	F_errmsg_internal(m, int32(289143), int32(0))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L3
...
L61:
	;
	F_errmsg_internal(m, int32(289106), int32(0))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L3
...
func F_btree_xlog_startup(m *base.Module) {
	...
	v8 = F_AllocSetContextCreateInternal(m, v3, int32(59430), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
