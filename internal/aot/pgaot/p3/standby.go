...
L8:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+16)) = v20
	F_errmsg_internal(m, int32(51263), v8+int32(16))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L6
...
L11:
	;
	F_errfinish(m, int32(514574), int32(1046), int32(163804))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L6
...
L17:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8))) = v53
	F_errmsg_internal(m, int32(49684), v8)
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L6
...
L18:
	;
	F_errfinish(m, int32(514574), int32(1053), int32(163804))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L6
...
L46:
	;
	F_s_lock(m, v89, int32(515479), int32(2976), int32(243526))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L9
...
L60:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+36)) = int32(126125)
...
L62:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = int32(126125)
...
L63:
	;
	F_errfinish(m, int32(515479), v201, int32(243526))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L9
