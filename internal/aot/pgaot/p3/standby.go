...
L11:
	;
	F_errfinish(m, int32(489342), int32(1046), int32(153590))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L6
...
L18:
	;
	F_errfinish(m, int32(489342), int32(1053), int32(153590))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L6
...
L46:
	;
	F_s_lock(m, v89, int32(489948), int32(2976), int32(231013))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L9
...
L63:
	;
	F_errfinish(m, int32(489948), v201, int32(231013))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L9
