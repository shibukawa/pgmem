...
L8:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8)+16)) = v20
	F_errmsg_internal(m, int32(47168), v8+int32(16))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L6
...
L11:
	;
	F_errfinish(m, int32(489292), int32(1046), int32(153590))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L6
...
L17:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8))) = v53
	F_errmsg_internal(m, int32(45877), v8)
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L6
...
L18:
	;
	F_errfinish(m, int32(489292), int32(1053), int32(153590))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L6
...
L46:
	;
	F_s_lock(m, v89, int32(489898), int32(2976), int32(231013))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L9
...
L60:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+36)) = int32(117753)
...
L62:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = int32(117753)
...
L63:
	;
	F_errfinish(m, int32(489898), v201, int32(231013))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L9
...
L67:
	...
	v240 = int32(1)
	v243 = v66 + v240
	v245 = *(*int32)(unsafe.Add(mBase, _consts[703]))
...
L69:
	;
	v267 = *(*int32)(unsafe.Add(mBase, _consts[703]))
...
L70:
	;
	*(*int64)(unsafe.Add(mBase, _consts[704])) = v257
	v275 = int32(1)
	goto L1
}
