	...
	if v10 != 0 {
		...
		if v7 == int32(0) {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v13)
			...
			case 0, 2:
				if base.Ui32(v6) < base.Ui32(int32(_a_F_pg_relation_is_publishable_0)) {
					v32 = v17
				} else {
					v26 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v20)+118)))
					v32 = base.B2i32(v26 == int32(112)) & base.B2i32(base.Ui32(int32(_a_F_pg_relation_is_publishable_1)) < base.Ui32(v6))
				}
			default:
				v32 = v17
			}
