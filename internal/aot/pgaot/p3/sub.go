...
L12:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[2]))
	if v39 != int32(2) {
		v50 = v35
		goto L2
	} else {
...
L13:
	;
	v43 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CommitSubTransaction[3])))
	if v43 != 0 {
		v50 = v35
		goto L2
	} else {
...
L14:
	;
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[4]))
	v50 = int32(0) | base.B2i32(v47 <= v16)
	goto L2
L15:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[0]))
	F_ShowTransactionStateRec(m, int32(_a_F_CommitSubTransaction_0), v54)
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L18
...
L20:
	...
	v91 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[5]))
	if v91 != 0 {
		goto L29
	} else {
		goto L30
...
L24:
	;
	v73 = *(*int32)(unsafe.Add(mBase, uint32(v66<<(uint(int32(2))%32))+uint32(_c_F_CommitSubTransaction[6])))
	v75 = v73
	goto L26
L25:
	;
	v75 = int32(_a_F_CommitSubTransaction_1)
	goto L26
L26:
	;
...
L48:
	;
	v147 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[0]))
...
L59:
	;
	v167 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[7]))
...
L75:
	...
	v231 = v229 - int32(32)
	m.G0 = v231
	v236 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[8]))
...
L104:
	;
	v318 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[0]))
	v319 = *(*int32)(unsafe.Add(mBase, uint32(v318)+28))
	goto L105
L105:
	;
	v321 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[9]))
	if v321 == int32(0) {
		goto L106
	} else {
		goto L107
...
L106:
	;
	v348 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[10]))
	if v348 == int32(0) {
		goto L116
	} else {
		goto L117
...
L109:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[9])) = v326
...
L114:
	;
	v341 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[9]))
...
L116:
	;
	v415 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[5]))
	if v415 != 0 {
		goto L136
	} else {
		goto L137
...
L119:
	;
	v361 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[10])) = v353
...
L146:
	;
	v461 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[0]))
	v462 = *(*int32)(unsafe.Add(mBase, uint32(v461)+28))
	goto L147
L147:
	;
	v464 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[11]))
	if v464 != 0 {
		goto L148
	} else {
		goto L149
...
L150:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[12])) = v490
...
L165:
	...
	v542 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[13]))
	if v538 == v542 {
		goto L167
	} else {
		goto L168
...
L170:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[13])) = v540
	goto L166
L173:
	;
...
L175:
	...
	v581 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[14]))
	if v581 == int32(0) {
		goto L176
	} else {
		goto L177
...
L176:
	...
	*(*uint8)(unsafe.Add(mBase, _c_F_CommitSubTransaction[15])) = uint8(v609)
	v612 = *(*int32)(unsafe.Add(mBase, uint32(v15)+80))
	v613 = *(*int32)(unsafe.Add(mBase, uint32(v612)+40))
	*(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[16])) = v613
	*(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[12])) = v613
...
L182:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+40)) = int32(0)
	v624 = *(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[0]))
	v625 = *(*int32)(unsafe.Add(mBase, uint32(v624)+80))
	v626 = *(*int32)(unsafe.Add(mBase, uint32(v625)+36))
	*(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[17])) = v626
	*(*int32)(unsafe.Add(mBase, _c_F_CommitSubTransaction[18])) = v626
