...
L27:
	;
	F_errfinish(m, int32(490316), int32(5112), int32(256821))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L18
...
L44:
	;
	F_errfinish(m, int32(490316), int32(5127), int32(256821))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L18
...
L194:
	;
	F_errfinish(m, int32(490316), int32(1696), int32(172642))
	mBase = m.M
	v666 = m.ExcPending
	if v666 != 0 {
		goto L18
