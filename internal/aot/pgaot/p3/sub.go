...
func F_CommitSubTransaction(m *base.Module) {
	...
	v12 = v10 - int32(48)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[75]))
	v16 = int32(10)
	goto L3
L1:
	;
...
L3:
	;
	v23 = *(*int32)(unsafe.Add(mBase, _consts[172]))
	goto L6
L4:
	;
	v35 = int32(0)
...
L13:
	;
	v43 = int32(*(*uint8)(unsafe.Add(mBase, _consts[174])))
	if v43 != 0 {
		v50 = v35
		goto L2
	} else {
...
L15:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _consts[75]))
	F_ShowTransactionStateRec(m, int32(270073), v54)
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L18
...
L20:
	...
	v91 = *(*int32)(unsafe.Add(mBase, _consts[176]))
	if v91 != 0 {
		goto L29
	} else {
		goto L30
...
L24:
	;
	v73 = *(*int32)(unsafe.Add(mBase, uint32(v66<<(uint(int32(2))%32))+uint32(_consts[177])))
	v75 = v73
	goto L26
L25:
	;
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v75
	F_errmsg_internal(m, int32(368747), v12+int32(32))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L18
...
L27:
	;
	F_errfinish(m, int32(515210), int32(5112), int32(270073))
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L18
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v127
	F_errmsg_internal(m, int32(267533), v12+int32(16))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L18
...
L44:
	;
	F_errfinish(m, int32(515210), int32(5127), int32(270073))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L18
...
L48:
	;
	v147 = *(*int32)(unsafe.Add(mBase, _consts[75]))
...
L59:
	;
	v167 = *(*int32)(unsafe.Add(mBase, _consts[116]))
...
L75:
	...
	v231 = v229 - int32(32)
	m.G0 = v231
	v236 = *(*int32)(unsafe.Add(mBase, _consts[178]))
...
L104:
	;
	v318 = *(*int32)(unsafe.Add(mBase, _consts[75]))
	v319 = *(*int32)(unsafe.Add(mBase, uint32(v318)+28))
	goto L105
L105:
	;
	v321 = *(*int32)(unsafe.Add(mBase, _consts[179]))
	if v321 == int32(0) {
		goto L106
	} else {
		goto L107
...
L106:
	;
	v348 = *(*int32)(unsafe.Add(mBase, _consts[180]))
	if v348 == int32(0) {
		goto L116
	} else {
		goto L117
...
L109:
	;
	*(*int32)(unsafe.Add(mBase, _consts[179])) = v326
...
L114:
	;
	v341 = *(*int32)(unsafe.Add(mBase, _consts[179]))
...
L116:
	;
	v415 = *(*int32)(unsafe.Add(mBase, _consts[176]))
	if v415 != 0 {
		goto L136
	} else {
		goto L137
...
L119:
	;
	v361 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[180])) = v353
...
L146:
	;
	v461 = *(*int32)(unsafe.Add(mBase, _consts[75]))
	v462 = *(*int32)(unsafe.Add(mBase, uint32(v461)+28))
	goto L147
L147:
	;
	v464 = *(*int32)(unsafe.Add(mBase, _consts[149]))
	if v464 != 0 {
		goto L148
	} else {
		goto L149
...
L150:
	...
	*(*int32)(unsafe.Add(mBase, _consts[181])) = v490
...
L165:
	...
	v542 = *(*int32)(unsafe.Add(mBase, _consts[182]))
	if v538 == v542 {
		goto L167
	} else {
		goto L168
...
L170:
	;
	*(*int32)(unsafe.Add(mBase, _consts[182])) = v540
	goto L166
L173:
	;
...
L176:
	...
	*(*uint8)(unsafe.Add(mBase, _consts[183])) = uint8(v609)
	v612 = *(*int32)(unsafe.Add(mBase, uint32(v15)+80))
	v613 = *(*int32)(unsafe.Add(mBase, uint32(v612)+40))
	*(*int32)(unsafe.Add(mBase, _consts[184])) = v613
	*(*int32)(unsafe.Add(mBase, _consts[181])) = v613
...
L194:
	;
	F_errfinish(m, int32(515210), int32(1696), int32(183278))
	mBase = m.M
	v666 = m.ExcPending
	if v666 != 0 {
		goto L18
