...
L28:
	;
	switch v95 - int32(_a_F_internal_get_result_type_0) {
	case 0, 2:
		goto L36
	case 1:
		goto L35
...
L37:
	;
	switch v95 - int32(_a_F_internal_get_result_type_1) {
	case 0:
		goto L38
	case 1:
		goto L33
...
L46:
	;
	switch v137 - int32(_a_F_internal_get_result_type_0) {
	case 0, 2:
		goto L52
	case 1:
		goto L53
...
L55:
	;
	switch v137 - int32(_a_F_internal_get_result_type_1) {
	case 0:
		goto L51
	case 1:
		goto L56
...
L66:
	;
	switch v215 - int32(_a_F_internal_get_result_type_0) {
	case 0, 2:
		goto L72
	case 1:
		goto L73
...
L75:
	;
	switch v215 - int32(_a_F_internal_get_result_type_1) {
	case 0:
		goto L71
	case 1:
		goto L76
...
L95:
	;
	switch v312 - int32(_a_F_internal_get_result_type_0) {
	case 0, 2:
		goto L90
	case 1:
		goto L89
...
L103:
	;
	switch v312 - int32(_a_F_internal_get_result_type_1) {
	case 0:
		goto L91
	case 1:
		goto L87
...
L203:
	;
	switch v566 - int32(_a_F_internal_get_result_type_0) {
	case 0, 2:
		goto L197
	case 1:
		goto L196
...
L210:
	;
	switch v566 - int32(_a_F_internal_get_result_type_1) {
	case 0:
		goto L198
	case 1:
		goto L194
...
L236:
	;
	if base.Ui32(v39-int32(_a_F_internal_get_result_type_0)) < base.Ui32(int32(4)) {
		goto L233
	} else {
		goto L240
	}
...
L240:
	;
	if base.Ui32(v39-int32(_a_F_internal_get_result_type_1)) < base.Ui32(int32(2)) {
		goto L233
	} else {
		goto L241
	}
...
func F_internal_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_internal_in_0)
			F_errmsg(m, int32(_a_F_internal_in_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_internal_in_2), int32(373), int32(_a_F_internal_in_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
