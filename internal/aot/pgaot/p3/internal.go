...
func F_apply_handle_commit_internal(m *base.Module, l0 int32) {
	...
	var v129 int32
	_ = v129
	v6 = *(*int64)(unsafe.Add(mBase, _consts[684]))
	if v6 == int64(0) {
		goto L1
	} else {
		goto L2
...
L2:
	...
	v11 = v9 - int32(16)
	m.G0 = v11
	v14 = *(*int64)(unsafe.Add(mBase, _consts[684]))
	if v14 != int64(0) {
		goto L3
	} else {
		goto L4
...
L8:
	;
	v22 = *(*int64)(unsafe.Add(mBase, _consts[684]))
...
L10:
	;
	*(*int64)(unsafe.Add(mBase, _consts[684])) = int64(0)
	goto L5
L11:
	;
...
L16:
	;
	v129 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[688])) = uint8(v129)
	return
L17:
	;
	if v54 == int32(2) {
...
L21:
	...
	*(*int64)(unsafe.Add(mBase, _consts[685])) = v61
	v64 = *(*int64)(unsafe.Add(mBase, uint32(l0)+16))
	*(*int64)(unsafe.Add(mBase, _consts[686])) = v64
...
L29:
	;
	v82 = *(*int64)(unsafe.Add(mBase, _consts[687]))
	v83 = *(*int64)(unsafe.Add(mBase, uint32(l0)+8))
	v85 = *(*int32)(unsafe.Add(mBase, _consts[589]))
...
L32:
	;
	v94 = *(*int32)(unsafe.Add(mBase, _consts[689]))
...
L34:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v97)+8)) = v82
	v102 = *(*int32)(unsafe.Add(mBase, _consts[690]))
	if v102 != 0 {
		goto L36
	} else {
		goto L37
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, _consts[691])) = v97
	v118 = *(*int32)(unsafe.Add(mBase, _consts[692]))
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v118
	goto L16
L36:
	;
	v104 = *(*int32)(unsafe.Add(mBase, _consts[691]))
	v109 = v104
	goto L35
L37:
	;
...
L38:
	;
	v106 = int32(4121560)
	*(*int32)(unsafe.Add(mBase, _consts[690])) = v106
	v109 = v106
	goto L35
L39:
	;
...
func F_apply_handle_prepare_internal(m *base.Module, l0 int32) {
	...
	v5 = v3 - int32(208)
	m.G0 = v5
	v8 = *(*int32)(unsafe.Add(mBase, _consts[676]))
		...
		if base.B2i32(base.Ui32(int32(1)) < base.Ui32(v15)) == int32(0) {
			...
			if v21 != 0 {
				...
				if v23 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, _consts[685])) = v25
			...
			if v33 == int32(0) {
				...
				if v39 != 0 {
					...
					if v42 != 0 {
						...
						F_errmsg(m, int32(507045), int32(0))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(499935), int32(1364), int32(311898))
							mBase = m.M
							v51 = m.ExcPending
							if v51 != 0 {
								return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1))) = v53
	v58 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[582])) = v58
	*(*int32)(unsafe.Add(mBase, _consts[8])) = v58
	return int32(-1)
L16:
	;
	*(*int32)(unsafe.Add(mBase, _consts[581])) = v26
...
L19:
	;
	F_errmsg(m, int32(292518), int32(0))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L8
...
L20:
	;
	F_errfinish(m, int32(496962), int32(1405), int32(225408))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L8
...
L228:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = l0
	F_errmsg_internal(m, int32(44676), v29)
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L5
...
L229:
	;
	F_errfinish(m, int32(497556), int32(446), int32(366190))
	mBase = m.M
	v737 = m.ExcPending
	if v737 != 0 {
		goto L5
...
L265:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = v38 + int32(4)
	F_errmsg(m, int32(191369), v27+int32(-48))
	mBase = m.M
	v809 = m.ExcPending
	if v809 != 0 {
		goto L5
...
L266:
	;
	F_errfinish(m, int32(497556), int32(498), int32(366190))
	mBase = m.M
	v814 = m.ExcPending
	if v814 != 0 {
		goto L5
...
func F_internal_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(312351)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(493972), int32(373), int32(279471))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
