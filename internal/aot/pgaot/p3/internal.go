			...
			if v33 == int32(0) {
				...
				if v39 != 0 {
					...
					if v42 != 0 {
						...
						F_errmsg(m, int32(507506), int32(0))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(500396), int32(1364), int32(312231))
							mBase = m.M
							v51 = m.ExcPending
							if v51 != 0 {
								return int32(0)
...
L19:
	;
	F_errmsg(m, int32(292851), int32(0))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L8
...
L20:
	;
	F_errfinish(m, int32(497423), int32(1405), int32(225622))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L8
...
L229:
	;
	F_errfinish(m, int32(498017), int32(446), int32(366597))
	mBase = m.M
	v737 = m.ExcPending
	if v737 != 0 {
		goto L5
...
L266:
	;
	F_errfinish(m, int32(498017), int32(498), int32(366597))
	mBase = m.M
	v814 = m.ExcPending
	if v814 != 0 {
		goto L5
...
func F_internal_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(312684)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(494416), int32(373), int32(279776))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
