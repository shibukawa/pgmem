			...
			if v33 == int32(0) {
				...
				if v39 != 0 {
					...
					if v42 != 0 {
						...
						F_errmsg(m, int32(531766), int32(0))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(524307), int32(1364), int32(326505))
							mBase = m.M
							v51 = m.ExcPending
							if v51 != 0 {
								return int32(0)
...
L20:
	;
	F_errfinish(m, int32(520610), int32(1405), int32(236454))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L8
...
L229:
	;
	F_errfinish(m, int32(521211), int32(446), int32(383718))
	mBase = m.M
	v737 = m.ExcPending
	if v737 != 0 {
		goto L5
...
L266:
	;
	F_errfinish(m, int32(521211), int32(498), int32(383718))
	mBase = m.M
	v814 = m.ExcPending
	if v814 != 0 {
		goto L5
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(327003)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(516941), int32(373), int32(292364))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
