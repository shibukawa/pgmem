			...
			if v33 == int32(0) {
				...
				if v39 != 0 {
					...
					if v42 != 0 {
						...
						F_errmsg(m, int32(498424), int32(0))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(491521), int32(1364), int32(306833))
							mBase = m.M
							v51 = m.ExcPending
							if v51 != 0 {
								return int32(0)
...
L19:
	;
	F_errmsg(m, int32(287792), int32(0))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L8
...
L20:
	;
	F_errfinish(m, int32(488634), int32(1405), int32(222104))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L8
...
L229:
	;
	F_errfinish(m, int32(489211), int32(446), int32(360172))
	mBase = m.M
	v737 = m.ExcPending
	if v737 != 0 {
		goto L5
...
L265:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = v38 + int32(4)
	F_errmsg(m, int32(188544), v27+int32(-48))
	mBase = m.M
	v809 = m.ExcPending
	if v809 != 0 {
		goto L5
...
L266:
	;
	F_errfinish(m, int32(489211), int32(498), int32(360172))
	mBase = m.M
	v814 = m.ExcPending
	if v814 != 0 {
		goto L5
...
func F_internal_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(307286)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(485687), int32(373), int32(275059))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
