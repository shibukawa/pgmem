...
func F_OpenTemporaryFile(m *base.Module, l0 int32) int32 {
	...
	_ = v93
	if l0 != 0 {
		v50 = *(*int32)(unsafe.Add(mBase, _c_F_OpenTemporaryFile[0]))
		if v50 != 0 {
			v52 = v50
		} else {
			v52 = int32(1663)
		...
		if v55 != 0 {
			...
			v57 = *(*int32)(unsafe.Add(mBase, _c_F_OpenTemporaryFile[1]))
			...
			*(*uint16)(unsafe.Add(mBase, uint32(v62))) = uint16(v65)
			if l0 != 0 {
				...
				v68 = v54
				v71 = *(*int32)(unsafe.Add(mBase, _c_F_OpenTemporaryFile[2]))
				F_ResourceOwnerRemember(m, v71, v68, int32(_a_F_OpenTemporaryFile_0))
				mBase = m.M
				v74 = m.ExcPending
				if v74 != 0 {
					return int32(0)
				} else {
					v76 = *(*int32)(unsafe.Add(mBase, _c_F_OpenTemporaryFile[1]))
					v79 = v76 + v68*int32(48)
					v81 = *(*int32)(unsafe.Add(mBase, _c_F_OpenTemporaryFile[2]))
					...
					*(*uint16)(unsafe.Add(mBase, uint32(v84))) = uint16(v87)
					v90 = int32(1)
					*(*uint8)(unsafe.Add(mBase, _c_F_OpenTemporaryFile[3])) = uint8(v90)
					v93 = v68
					return v93
				}
			}
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v47
	v50 = F_pg_sprintf(m, v43, int32(_a_F_oidvectorout_0), v9)
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L5
		...
		if v34 != int32(1) {
			...
			if v47 != 0 {
				...
				if v50 != 0 {
					...
					F_errmsg(m, int32(_a_F_oidvectorrecv_0), int32(0))
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(_a_F_oidvectorrecv_1), int32(245), int32(_a_F_oidvectorrecv_2))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
