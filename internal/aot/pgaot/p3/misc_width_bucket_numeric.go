				...
				if int32(0) < v27 {
							...
							if v42&int32(65535) == int32(49152) {
								...
								if v1000 != 0 {
									...
									if v1003 != 0 {
										...
										F_errmsg(m, int32(527452), int32(0))
										mBase = m.M
										v1007 = m.ExcPending
										if v1007 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(499737), int32(1991), int32(490328))
											mBase = m.M
											v1012 = m.ExcPending
											if v1012 != 0 {
												return int32(0)
									...
									if v47&int32(57343) == int32(53248) {
										...
										if v1016 != 0 {
											...
											if v1019 != 0 {
												...
												F_errmsg(m, int32(350155), int32(0))
												mBase = m.M
												v1023 = m.ExcPending
												if v1023 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(499737), int32(1996), int32(490328))
													mBase = m.M
													v1028 = m.ExcPending
													if v1028 != 0 {
														return int32(0)
												...
												case 0:
													...
													if v262 != 0 {
														...
														if v265 != 0 {
															...
															F_errmsg(m, int32(424309), int32(0))
															mBase = m.M
															v269 = m.ExcPending
															if v269 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(499737), int32(2010), int32(490328))
																mBase = m.M
																v274 = m.ExcPending
																if v274 != 0 {
																	return int32(0)
																	...
																	if v1033 != 0 {
																		...
																		if v1036 != 0 {
																			...
																			if v1040 != 0 {
																				...
																				F_errfinish(m, int32(499737), int32(2040), int32(490328))
																				mBase = m.M
																				v1045 = m.ExcPending
																				if v1045 != 0 {
																					return int32(0)
					...
					if v982 != 0 {
						...
						if v985 != 0 {
							...
							F_errmsg(m, int32(239651), int32(0))
							mBase = m.M
							v989 = m.ExcPending
							if v989 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(499737), int32(1980), int32(490328))
								mBase = m.M
								v994 = m.ExcPending
								if v994 != 0 {
									return int32(0)
