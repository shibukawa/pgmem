				...
				if int32(0) < v27 {
							...
							if v42&int32(65535) == int32(49152) {
								...
								if v1000 != 0 {
									...
									if v1003 != 0 {
										...
										F_errmsg(m, int32(507870), int32(0))
										mBase = m.M
										v1007 = m.ExcPending
										if v1007 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(480706), int32(1991), int32(471766))
											mBase = m.M
											v1012 = m.ExcPending
											if v1012 != 0 {
												return int32(0)
									...
									if v47&int32(57343) == int32(53248) {
										...
										if v1016 != 0 {
											...
											if v1019 != 0 {
												...
												F_errmsg(m, int32(336344), int32(0))
												mBase = m.M
												v1023 = m.ExcPending
												if v1023 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(480706), int32(1996), int32(471766))
													mBase = m.M
													v1028 = m.ExcPending
													if v1028 != 0 {
														return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v14)+52)) = v91
													...
													if v262 != 0 {
														...
														if v265 != 0 {
															...
															if v269 != 0 {
																...
																F_errfinish(m, int32(480706), int32(2010), int32(471766))
																mBase = m.M
																v274 = m.ExcPending
																if v274 != 0 {
																	return int32(0)
												...
												case 1:
													...
													if int32(0) < v768 {
																	...
																	if v1033 != 0 {
																		...
																		if v1036 != 0 {
																			...
																			if v1040 != 0 {
																				...
																				F_errfinish(m, int32(480706), int32(2040), int32(471766))
																				mBase = m.M
																				v1045 = m.ExcPending
																				if v1045 != 0 {
																					return int32(0)
														...
														if v939 <= int32(0) {
															F_add_var(m, v12+int32(-32), int32(1700968), v12+int32(-56))
															mBase = m.M
															v948 = m.ExcPending
															if v948 != 0 {
																return int32(0)
					...
					if v982 != 0 {
						...
						if v985 != 0 {
							...
							F_errmsg(m, int32(229556), int32(0))
							mBase = m.M
							v989 = m.ExcPending
							if v989 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(480706), int32(1980), int32(471766))
								mBase = m.M
								v994 = m.ExcPending
								if v994 != 0 {
									return int32(0)
