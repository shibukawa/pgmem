...
func F_TypeCacheOpcCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v11 = *(*int32)(unsafe.Add(mBase, _consts[1101]))
...
L13:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _consts[1102]))
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	F_errmsg_internal(m, int32(54949), v11)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L2
...
L11:
	;
	F_errfinish(m, int32(522397), int32(1067), int32(70168))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
L15:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _consts[439]))
	v45 = int32(0)
	if v44 == v45 {
		goto L19
	} else {
...
L17:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _consts[439]))
	if v87 == int32(0) {
		v126 = v3
		goto L14
	} else {
					...
					if v55 != 0 {
						...
						if v57 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v56
							F_errmsg(m, int32(317731), v9+int32(32))
							mBase = m.M
							v63 = m.ExcPending
							if v63 != 0 {
								return
							} else {
								F_errfinish(m, int32(522036), int32(3094), int32(253606))
								mBase = m.M
								v68 = m.ExcPending
								if v68 != 0 {
									return
							...
							if v77 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v76
								...
								if v83 != 0 {
									...
									F_errfinish(m, int32(522036), int32(3099), int32(253606))
									mBase = m.M
									v88 = m.ExcPending
									if v88 != 0 {
										return
			...
			if v39 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
				...
				if v43 != 0 {
					...
					F_errfinish(m, int32(522036), int32(3087), int32(253606))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return
			...
			if v45 != 0 {
				...
				if v48 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
					F_errmsg(m, int32(196444), v7)
					mBase = m.M
					v52 = m.ExcPending
					if v52 != 0 {
						return
					} else {
						F_errhint(m, int32(604464), int32(0))
						mBase = m.M
						v56 = m.ExcPending
						if v56 != 0 {
							return
						} else {
							F_errfinish(m, int32(516846), int32(3677), int32(15972))
							mBase = m.M
							v61 = m.ExcPending
							if v61 != 0 {
								return
			...
			if v23 != 0 {
				...
				if v25 != 0 {
					...
					if v24 == int32(0) {
						...
						if v31 != 0 {
							...
							if v34 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = v22
								F_errmsg(m, int32(78001), v8)
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(520326), int32(4575), int32(396366))
									mBase = m.M
									v43 = m.ExcPending
									if v43 != 0 {
										return int32(0)
						...
						v46 = F_convert_any_priv_string(m, v16, int32(1690144))
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return int32(0)
...
L14:
	;
	F_errfinish(m, int32(521639), int32(699), int32(454558))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L2
