...
L40:
	;
	F_errfinish(m, int32(516399), int32(1296), int32(294496))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L4
...
L42:
	;
	F_errmsg_internal(m, int32(293879), int32(0))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L4
...
L43:
	;
	F_errfinish(m, int32(516399), int32(1292), int32(294496))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L46:
	;
	F_errfinish(m, int32(516399), int32(1294), int32(294496))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L4
...
L117:
	;
	F_errmsg_internal(m, int32(462833), int32(0))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L4
...
L118:
	;
	F_errfinish(m, int32(519199), int32(5281), int32(412612))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L4
...
L859:
	;
	F_errfinish(m, int32(517829), int32(302), int32(296468))
	mBase = m.M
	v2768 = m.ExcPending
	if v2768 != 0 {
		goto L4
...
func F_ReThrowError(m *base.Module, l0 int32) {
	...
	var v114 int32
	_ = v114
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1098]))
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v6
	v8 = int32(4541692)
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1099]))
	v11 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[1099])) = v10 + v11
	v14 = int32(4155252)
	v16 = *(*int32)(unsafe.Add(mBase, _consts[1096]))
	v18 = v16 + v11
	*(*int32)(unsafe.Add(mBase, _consts[1096])) = v18
	if v18 < int32(5) {
		goto L1
	} else {
		goto L2
...
L1:
	...
	v22 = int32(100)
	v23 = v18 * v22
	v29 = F__emscripten_memset_bulkmem(m, v23+int32(4541696), base.I32_extend8_s(int32(0)), v22)
	mBase = m.M
	goto L4
L2:
	;
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+uint32(_consts[1104]))) = v33
	goto L6
L5:
	;
	v40 = *(*int32)(unsafe.Add(mBase, uint32(v23)+uint32(_consts[1108])))
	if v40 != 0 {
		goto L9
	} else {
		goto L10
...
L56:
	;
	v89 = *(*int32)(unsafe.Add(mBase, _consts[1098]))
	*(*int32)(unsafe.Add(mBase, uint32(v36)+96)) = v89
	v91 = int32(4541692)
	v93 = *(*int32)(unsafe.Add(mBase, _consts[1099]))
	*(*int32)(unsafe.Add(mBase, _consts[1099])) = v93 - int32(1)
	F_pg_re_throw(m)
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
...
L33:
	;
	F_errfinish(m, int32(515252), int32(446), int32(165096))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L29
