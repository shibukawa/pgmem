...
L40:
	;
	F_errfinish(m, int32(493547), int32(1296), int32(281784))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L4
...
L42:
	;
	F_errmsg_internal(m, int32(281167), int32(0))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L4
...
L43:
	;
	F_errfinish(m, int32(493547), int32(1292), int32(281784))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L46:
	;
	F_errfinish(m, int32(493547), int32(1294), int32(281784))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L4
...
L117:
	;
	F_errmsg_internal(m, int32(443071), int32(0))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L4
...
L118:
	;
	F_errfinish(m, int32(495877), int32(5281), int32(394607))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L4
...
L859:
	;
	F_errfinish(m, int32(494573), int32(302), int32(283515))
	mBase = m.M
	v2768 = m.ExcPending
	if v2768 != 0 {
		goto L4
...
L1:
	...
	v22 = int32(100)
	v23 = v18 * v22
	v29 = F__emscripten_memset_bulkmem(m, v23+int32(4479856), base.I32_extend8_s(int32(0)), v22)
	mBase = m.M
	goto L4
L2:
	;
...
L33:
	;
	F_errfinish(m, int32(492464), int32(446), int32(156015))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L29
