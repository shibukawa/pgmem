...
L40:
	;
	F_errfinish(m, int32(508307), int32(1296), int32(289173))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L4
...
L42:
	;
	F_errmsg_internal(m, int32(288556), int32(0))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L4
...
L43:
	;
	F_errfinish(m, int32(508307), int32(1292), int32(289173))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L46:
	;
	F_errfinish(m, int32(508307), int32(1294), int32(289173))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L4
...
L117:
	;
	F_errmsg_internal(m, int32(455512), int32(0))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L4
...
L118:
	;
	F_errfinish(m, int32(511100), int32(5281), int32(405624))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L4
...
L859:
	;
	F_errfinish(m, int32(509730), int32(302), int32(291145))
	mBase = m.M
	v2768 = m.ExcPending
	if v2768 != 0 {
		goto L4
...
func F_ReThrowError(m *base.Module, l0 int32) {
	...
	var v114 int32
	_ = v114
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1096]))
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v6
	v8 = int32(4529196)
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1097]))
	v11 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[1097])) = v10 + v11
	v14 = int32(4142820)
	v16 = *(*int32)(unsafe.Add(mBase, _consts[1094]))
	v18 = v16 + v11
	*(*int32)(unsafe.Add(mBase, _consts[1094])) = v18
	if v18 < int32(5) {
		goto L1
	} else {
		goto L2
...
L1:
	...
	v22 = int32(100)
	v23 = v18 * v22
	v29 = F__emscripten_memset_bulkmem(m, v23+int32(4529200), base.I32_extend8_s(int32(0)), v22)
	mBase = m.M
	goto L4
L2:
	;
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+uint32(_consts[1102]))) = v33
	goto L6
L5:
	;
	v40 = *(*int32)(unsafe.Add(mBase, uint32(v23)+uint32(_consts[1106])))
	if v40 != 0 {
		goto L9
	} else {
		goto L10
...
L56:
	;
	v89 = *(*int32)(unsafe.Add(mBase, _consts[1096]))
	*(*int32)(unsafe.Add(mBase, uint32(v36)+96)) = v89
	v91 = int32(4529196)
	v93 = *(*int32)(unsafe.Add(mBase, _consts[1097]))
	*(*int32)(unsafe.Add(mBase, _consts[1097])) = v93 - int32(1)
	F_pg_re_throw(m)
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
...
L33:
	;
	F_errfinish(m, int32(507189), int32(446), int32(160432))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L29
