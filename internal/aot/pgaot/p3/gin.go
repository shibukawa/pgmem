...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v4
	F_errmsg_internal(m, int32(654019), v17)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L41
...
L43:
	;
	F_errfinish(m, int32(484541), int32(2270), int32(377230))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L41
...
L51:
	;
	v164 = F_ginCompressPostingList(m, l5+v148*int32(6), l6-v148, int32(65535), v17+int32(4))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L41
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v155)+8)) = v164
	...
	v176 = v153 + (v169+int32(1))&int32(131070) + int32(8)
...
L84:
	...
	v267 = (v261+int32(1))&int32(131070) + int32(8)
	if v267 != 0 {
		goto L87
	} else {
		goto L88
...
L91:
	...
	if v259 != v17+v287 {
		v253 = v259
		v257 = v269 + (v271+int32(1))&int32(131070) + v287
		goto L84
	} else {
		goto L92
	}
...
func F_ginInitBA(m *base.Module, l0 int32) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+4)) = int64(0)
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(4088424)
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v235
	F_errmsg_internal(m, int32(57394), v23)
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L7
...
L67:
	;
	F_errfinish(m, int32(489516), int32(298), int32(124458))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L7
...
L5:
	...
	v25 = F_DirectFunctionCall2Coll(m, int32(5452), int32(0), v24, v18)
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L6
...
L54:
	;
	F_errfinish(m, int32(488076), int32(141), int32(15848))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L6
		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v17))) = v26
			...
			if v30 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v24)+12)) = int32(6189)
...
func F_gin_extract_query_bytea(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(1), int32(6649), int32(2862))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gin_extract_trgm(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		if v13 != 0 {
			...
			F_errmsg_internal(m, int32(284345), int32(0))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(488065), int32(30), int32(284379))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return int32(0)
...
func F_gin_identify(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v4) <= base.Ui32(int32(143)) {
		v13 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(v4)>>(uint(int32(2))%32))&int32(1073741820))+uint32(_consts[74])))
		v14 = v13
	} else {
		v14 = int32(0)
	}
...
func F_gin_redo(m *base.Module, l0 int32) {
	...
	v23 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v18
	v1529 = *(*int32)(unsafe.Add(mBase, _consts[17]))
...
L99:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v15)+20)) = v332
	F_errmsg_internal(m, int32(38151), v13+int32(-48))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L19
...
L100:
	;
	F_errfinish(m, int32(489516), int32(104), int32(12431))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L19
...
L369:
	;
	F_errmsg_internal(m, int32(401069), int32(0))
	mBase = m.M
	v1542 = m.ExcPending
	if v1542 != 0 {
		goto L19
...
L370:
	;
	F_errfinish(m, int32(489516), int32(419), int32(100952))
	mBase = m.M
	v1547 = m.ExcPending
	if v1547 != 0 {
		goto L19
...
L372:
	;
	F_errmsg_internal(m, int32(401004), int32(0))
	mBase = m.M
	v1555 = m.ExcPending
	if v1555 != 0 {
		goto L19
...
L373:
	;
	F_errfinish(m, int32(489516), int32(422), int32(100952))
	mBase = m.M
	v1560 = m.ExcPending
	if v1560 != 0 {
		goto L19
...
L375:
	;
	F_errmsg_internal(m, int32(400940), int32(0))
	mBase = m.M
	v1568 = m.ExcPending
	if v1568 != 0 {
		goto L19
...
L376:
	;
	F_errfinish(m, int32(489516), int32(427), int32(100952))
	mBase = m.M
	v1573 = m.ExcPending
	if v1573 != 0 {
		goto L19
...
L378:
	;
	F_errmsg_internal(m, int32(401499), int32(0))
	mBase = m.M
	v1581 = m.ExcPending
	if v1581 != 0 {
		goto L19
...
L379:
	;
	F_errfinish(m, int32(489516), int32(446), int32(402288))
	mBase = m.M
	v1586 = m.ExcPending
	if v1586 != 0 {
		goto L19
...
L381:
	;
	F_errmsg_internal(m, int32(400591), int32(0))
	mBase = m.M
	v1594 = m.ExcPending
	if v1594 != 0 {
		goto L19
...
L382:
	;
	F_errfinish(m, int32(489516), int32(579), int32(400346))
	mBase = m.M
	v1599 = m.ExcPending
	if v1599 != 0 {
		goto L19
...
L385:
	;
	F_errfinish(m, int32(489516), int32(661), int32(402201))
	mBase = m.M
	v1612 = m.ExcPending
	if v1612 != 0 {
		goto L19
...
L387:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v26
	F_errmsg_internal(m, int32(51893), v15)
	mBase = m.M
	v1620 = m.ExcPending
	if v1620 != 0 {
		goto L19
...
L388:
	;
	F_errfinish(m, int32(489516), int32(768), int32(238748))
	mBase = m.M
	v1625 = m.ExcPending
	if v1625 != 0 {
		goto L19
...
L85:
	;
	F_errfinish(m, int32(488065), int32(352), int32(90309))
	mBase = m.M
	v480 = m.ExcPending
	if v480 != 0 {
		goto L13
	...
	if int32(7) < v12 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v18))) = uint8(v19)
		...
		if v51 != 0 {
			...
			F_errmsg_internal(m, int32(118943), int32(0))
			mBase = m.M
			v55 = m.ExcPending
			if v55 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(484089), int32(331), int32(152894))
				mBase = m.M
				v60 = m.ExcPending
				if v60 != 0 {
					return int32(0)
...
func F_gin_xlog_startup(m *base.Module) {
	...
	v8 = F_AllocSetContextCreateInternal(m, v3, int32(58943), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
	} else {
		*(*int32)(unsafe.Add(mBase, _consts[17])) = v8
		return
	}
}
