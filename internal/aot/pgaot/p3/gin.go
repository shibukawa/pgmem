...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v4
	F_errmsg_internal(m, int32(653604), v17)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L41
...
L43:
	;
	F_errfinish(m, int32(484137), int32(2270), int32(376884))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L41
...
func F_ginInitBA(m *base.Module, l0 int32) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+4)) = int64(0)
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(4088328)
...
L67:
	;
	F_errfinish(m, int32(489101), int32(298), int32(124348))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L7
...
L54:
	;
	F_errfinish(m, int32(487661), int32(141), int32(15848))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L6
...
func F_gin_extract_query_bytea(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(1), int32(6642), int32(2862))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gin_extract_trgm(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		if v13 != 0 {
			...
			F_errmsg_internal(m, int32(284175), int32(0))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(487650), int32(30), int32(284209))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return int32(0)
...
L100:
	;
	F_errfinish(m, int32(489101), int32(104), int32(12431))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L19
...
L369:
	;
	F_errmsg_internal(m, int32(400714), int32(0))
	mBase = m.M
	v1542 = m.ExcPending
	if v1542 != 0 {
		goto L19
...
L370:
	;
	F_errfinish(m, int32(489101), int32(419), int32(100860))
	mBase = m.M
	v1547 = m.ExcPending
	if v1547 != 0 {
		goto L19
...
L372:
	;
	F_errmsg_internal(m, int32(400649), int32(0))
	mBase = m.M
	v1555 = m.ExcPending
	if v1555 != 0 {
		goto L19
...
L373:
	;
	F_errfinish(m, int32(489101), int32(422), int32(100860))
	mBase = m.M
	v1560 = m.ExcPending
	if v1560 != 0 {
		goto L19
...
L375:
	;
	F_errmsg_internal(m, int32(400585), int32(0))
	mBase = m.M
	v1568 = m.ExcPending
	if v1568 != 0 {
		goto L19
...
L376:
	;
	F_errfinish(m, int32(489101), int32(427), int32(100860))
	mBase = m.M
	v1573 = m.ExcPending
	if v1573 != 0 {
		goto L19
...
L378:
	;
	F_errmsg_internal(m, int32(401144), int32(0))
	mBase = m.M
	v1581 = m.ExcPending
	if v1581 != 0 {
		goto L19
...
L379:
	;
	F_errfinish(m, int32(489101), int32(446), int32(401933))
	mBase = m.M
	v1586 = m.ExcPending
	if v1586 != 0 {
		goto L19
...
L381:
	;
	F_errmsg_internal(m, int32(400236), int32(0))
	mBase = m.M
	v1594 = m.ExcPending
	if v1594 != 0 {
		goto L19
...
L382:
	;
	F_errfinish(m, int32(489101), int32(579), int32(399991))
	mBase = m.M
	v1599 = m.ExcPending
	if v1599 != 0 {
		goto L19
...
L385:
	;
	F_errfinish(m, int32(489101), int32(661), int32(401846))
	mBase = m.M
	v1612 = m.ExcPending
	if v1612 != 0 {
		goto L19
...
L388:
	;
	F_errfinish(m, int32(489101), int32(768), int32(238578))
	mBase = m.M
	v1625 = m.ExcPending
	if v1625 != 0 {
		goto L19
...
L85:
	;
	F_errfinish(m, int32(487650), int32(352), int32(90263))
	mBase = m.M
	v480 = m.ExcPending
	if v480 != 0 {
		goto L13
	...
	if int32(7) < v12 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v18))) = uint8(v19)
		...
		if v51 != 0 {
			...
			F_errmsg_internal(m, int32(118833), int32(0))
			mBase = m.M
			v55 = m.ExcPending
			if v55 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(483685), int32(331), int32(152758))
				mBase = m.M
				v60 = m.ExcPending
				if v60 != 0 {
					return int32(0)
