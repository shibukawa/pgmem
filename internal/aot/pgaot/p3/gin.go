...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v4
	F_errmsg_internal(m, int32(679319), v17)
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L24
...
L26:
	;
	F_errfinish(m, int32(492909), int32(2270), int32(383716))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L24
...
func F_ginInitBA(m *base.Module, l0 int32) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+4)) = int64(0)
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(4121336)
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v235
	F_errmsg_internal(m, int32(57997), v23)
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L7
...
L67:
	;
	F_errfinish(m, int32(498004), int32(298), int32(126673))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L7
...
L54:
	;
	F_errfinish(m, int32(496531), int32(141), int32(15956))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L6
...
func F_gin_extract_query_bytea(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(1), int32(7103), int32(2863))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gin_extract_trgm(m *base.Module, l0 int32) int32 {
	...
	default:
		...
		if v13 != 0 {
			...
			F_errmsg_internal(m, int32(289028), int32(0))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(496520), int32(30), int32(289062))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return int32(0)
...
L99:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v15)+20)) = v332
	F_errmsg_internal(m, int32(38754), v13+int32(-48))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L19
...
L100:
	;
	F_errfinish(m, int32(498004), int32(104), int32(12539))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L19
...
L369:
	;
	F_errmsg_internal(m, int32(407733), int32(0))
	mBase = m.M
	v1542 = m.ExcPending
	if v1542 != 0 {
		goto L19
...
L370:
	;
	F_errfinish(m, int32(498004), int32(419), int32(102671))
	mBase = m.M
	v1547 = m.ExcPending
	if v1547 != 0 {
		goto L19
...
L373:
	;
	F_errfinish(m, int32(498004), int32(422), int32(102671))
	mBase = m.M
	v1560 = m.ExcPending
	if v1560 != 0 {
		goto L19
...
L375:
	;
	F_errmsg_internal(m, int32(407604), int32(0))
	mBase = m.M
	v1568 = m.ExcPending
	if v1568 != 0 {
		goto L19
...
L376:
	;
	F_errfinish(m, int32(498004), int32(427), int32(102671))
	mBase = m.M
	v1573 = m.ExcPending
	if v1573 != 0 {
		goto L19
...
L379:
	;
	F_errfinish(m, int32(498004), int32(446), int32(408966))
	mBase = m.M
	v1586 = m.ExcPending
	if v1586 != 0 {
		goto L19
...
L381:
	;
	F_errmsg_internal(m, int32(407255), int32(0))
	mBase = m.M
	v1594 = m.ExcPending
	if v1594 != 0 {
		goto L19
...
L382:
	;
	F_errfinish(m, int32(498004), int32(579), int32(406966))
	mBase = m.M
	v1599 = m.ExcPending
	if v1599 != 0 {
		goto L19
...
L385:
	;
	F_errfinish(m, int32(498004), int32(661), int32(408865))
	mBase = m.M
	v1612 = m.ExcPending
	if v1612 != 0 {
		goto L19
...
L387:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v26
	F_errmsg_internal(m, int32(52496), v15)
	mBase = m.M
	v1620 = m.ExcPending
	if v1620 != 0 {
		goto L19
...
L388:
	;
	F_errfinish(m, int32(498004), int32(768), int32(242580))
	mBase = m.M
	v1625 = m.ExcPending
	if v1625 != 0 {
		goto L19
...
L85:
	;
	F_errfinish(m, int32(496520), int32(352), int32(91492))
	mBase = m.M
	v480 = m.ExcPending
	if v480 != 0 {
		goto L13
	...
	if int32(7) < v12 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v18))) = uint8(v19)
		...
		if v51 != 0 {
			...
			F_errmsg_internal(m, int32(121004), int32(0))
			mBase = m.M
			v55 = m.ExcPending
			if v55 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(492430), int32(331), int32(155389))
				mBase = m.M
				v60 = m.ExcPending
				if v60 != 0 {
					return int32(0)
...
func F_gin_xlog_startup(m *base.Module) {
	...
	v8 = F_AllocSetContextCreateInternal(m, v3, int32(59583), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
