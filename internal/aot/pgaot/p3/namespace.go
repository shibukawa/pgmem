...
L77:
	;
	F_errmsg(m, int32(527807), int32(0))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L4
...
L78:
	;
	F_errfinish(m, int32(520004), int32(3474), int32(435340))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L4
...
L82:
	;
	F_errmsg(m, int32(183178), int32(0))
	mBase = m.M
	v244 = m.ExcPending
	if v244 != 0 {
		goto L4
...
L83:
	;
	F_errfinish(m, int32(520004), int32(3468), int32(435340))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L4
		...
		if l0 != int32(2607) {
			if l0 != int32(3381) {
				...
				if v49 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
					F_errmsg_internal(m, int32(62593), v7)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return
					} else {
						F_errfinish(m, int32(515218), int32(144), int32(116026))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return
						...
						if v34 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l1
							...
							if v40 != 0 {
								...
								F_errfinish(m, int32(515218), int32(150), int32(116026))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
