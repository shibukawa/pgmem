...
func F_show_grouping_set_keys(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32) {
	...
	F_ExplainOpenGroup(m, int32(115756), v8, int32(1), l6)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L1
...
L7:
	...
	F_show_sort_group_keys(m, l0, int32(23103), v40, int32(0), v42, v43, v44, v45, l5, l6)
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v115
	F_errmsg_internal(m, int32(488174), v19)
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L1
...
L48:
	;
	F_errfinish(m, int32(519731), int32(2722), int32(120422))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L1
...
L51:
	;
	F_ExplainPropertyText(m, v63, int32(714648), l6)
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L1
...
L70:
	...
	F_appendStringInfoString(m, v286, int32(778892))
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L1
...
L76:
	...
	F_appendStringInfoString(m, v338, int32(532499))
	mBase = m.M
	v341 = m.ExcPending
	if v341 != 0 {
		goto L1
...
L88:
	...
	F_appendStringInfoString(m, v373, int32(778892))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L1
...
L97:
	;
	F_ExplainCloseGroup(m, int32(115756), int32(1), l6)
	mBase = m.M
	v475 = m.ExcPending
	if v475 != 0 {
		goto L1
