...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v23
	v27 = F_psprintf(m, int32(187547), v10)
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L1
...
L47:
	;
	F_GUC_flex_fatal(m, int32(717976))
	mBase = m.M
	v1354 = m.ExcPending
	if v1354 != 0 {
		goto L19
...
L52:
	;
	F_GUC_flex_fatal(m, int32(476982))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L19
...
L53:
	;
	F_GUC_flex_fatal(m, int32(472602))
	mBase = m.M
	v875 = m.ExcPending
	if v875 != 0 {
		goto L19
...
L60:
	;
	F_GUC_flex_fatal(m, int32(445860))
	mBase = m.M
	v861 = m.ExcPending
	if v861 != 0 {
		goto L19
...
L65:
	;
	F_GUC_flex_fatal(m, int32(476334))
	mBase = m.M
	v273 = m.ExcPending
	if v273 != 0 {
		goto L19
