...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v23
	v27 = F_psprintf(m, int32(166818), v10)
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L1
...
L46:
	;
	F_GUC_flex_fatal(m, int32(29209))
	mBase = m.M
	v1359 = m.ExcPending
	if v1359 != 0 {
		goto L19
...
L47:
	;
	F_GUC_flex_fatal(m, int32(643760))
	mBase = m.M
	v1354 = m.ExcPending
	if v1354 != 0 {
		goto L19
...
L52:
	;
	F_GUC_flex_fatal(m, int32(434516))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L19
...
L53:
	;
	F_GUC_flex_fatal(m, int32(430470))
	mBase = m.M
	v875 = m.ExcPending
	if v875 != 0 {
		goto L19
...
L60:
	;
	F_GUC_flex_fatal(m, int32(405195))
	mBase = m.M
	v861 = m.ExcPending
	if v861 != 0 {
		goto L19
...
L65:
	;
	F_GUC_flex_fatal(m, int32(433868))
	mBase = m.M
	v273 = m.ExcPending
	if v273 != 0 {
		goto L19
