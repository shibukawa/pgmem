...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	v112 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[0]))
	v113 = int64(0)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_parse_subscription_options(m, l1, v125, int32(_a_F_CreateSubscription_0), v84)
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		v2085 = v90
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	v195 = F_has_privs_of_role(m, v112, int32(_a_F_CreateSubscription_2))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		v2085 = v90
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+132)) = v81
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	v336 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	*(*int32)(unsafe.Add(mBase, uint32(v36)+48)) = int32(_a_F_CreateSubscription_4)
	F_errdetail(m, int32(_a_F_CreateSubscription_5), v36+int32(48))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		v2085 = v90
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_errfinish(m, int32(_a_F_CreateSubscription_6), int32(588), int32(_a_F_CreateSubscription_7))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		v2085 = v90
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+132)) = v81
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	v361 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	v546 = F_table_open(m, int32(_a_F_CreateSubscription_8), int32(3))
	mBase = m.M
	v547 = m.ExcPending
	if v547 != 0 {
		v2085 = v90
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_errfinish(m, int32(_a_F_CreateSubscription_6), int32(609), int32(_a_F_CreateSubscription_7))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		v2085 = v90
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+124)) = v87
	*(*int32)(unsafe.Add(mBase, uint32(v36)+128)) = v84
	v568 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+132)) = v81
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	v573 = int32(0)
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+32)) = v622
	F_errmsg(m, int32(_a_F_CreateSubscription_12), v36+int32(32))
	mBase = m.M
	v647 = m.ExcPending
	if v647 != 0 {
		v2085 = v90
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_errfinish(m, int32(_a_F_CreateSubscription_6), int32(630), int32(_a_F_CreateSubscription_7))
	mBase = m.M
	v671 = m.ExcPending
	if v671 != 0 {
		v2085 = v90
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v84)+8)) = int32(_a_F_CreateSubscription_13)
	goto L57
L56:
	;
	goto L57
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_load_file(m, int32(_a_F_CreateSubscription_14), int32(0))
	mBase = m.M
	v709 = m.ExcPending
	if v709 != 0 {
		v2085 = v90
...
L58:
	;
	v712 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[2]))
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	v797 = F_GetNewOidWithIndex(m, v546, int32(_a_F_CreateSubscription_15), int32(1))
	mBase = m.M
	v798 = m.ExcPending
	if v798 != 0 {
		v2085 = v90
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v78))) = v797
	v801 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[1]))
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_recordDependencyOnOwner(m, int32(_a_F_CreateSubscription_8), v797, v112)
	mBase = m.M
	v1079 = m.ExcPending
	if v1079 != 0 {
		v2085 = v90
...
L86:
	...
	v1149 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[2]))
...
L90:
	;
	v1279 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[3]))
	v1281 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[4]))
	goto L95
L91:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v36)+72)) = v54
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+16)) = v1225
	F_errmsg(m, int32(_a_F_CreateSubscription_16), v36+int32(16))
	mBase = m.M
	v1252 = m.ExcPending
	if v1252 != 0 {
		v2085 = v90
...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_errfinish(m, int32(_a_F_CreateSubscription_6), int32(719), int32(_a_F_CreateSubscription_7))
	mBase = m.M
	v1276 = m.ExcPending
	if v1276 != 0 {
		v2085 = v90
...
L99:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[4])) = v1291
...
L101:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[3])) = v1298
	*(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[4])) = v1297
	v1765 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[2]))
...
L118:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[3])) = v1298
	*(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[4])) = v1297
	v1733 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[2]))
...
L119:
	...
	v1567 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[2]))
...
L129:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36))) = v1677
	F_errmsg(m, int32(_a_F_CreateSubscription_17), v36)
	mBase = m.M
	v1700 = m.ExcPending
	if v1700 != 0 {
		v2085 = v1311
...
L130:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v1288
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v1292
	F_errfinish(m, int32(_a_F_CreateSubscription_6), int32(791), int32(_a_F_CreateSubscription_7))
	mBase = m.M
	v1724 = m.ExcPending
	if v1724 != 0 {
		v2085 = v1311
...
L136:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_errmsg(m, int32(_a_F_CreateSubscription_18), int32(0))
	mBase = m.M
	v1856 = m.ExcPending
	if v1856 != 0 {
		v2085 = v90
...
L137:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_errhint(m, int32(_a_F_CreateSubscription_19), int32(0))
	mBase = m.M
	v1879 = m.ExcPending
	if v1879 != 0 {
		v2085 = v90
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v78
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v75
	F_errfinish(m, int32(_a_F_CreateSubscription_6), int32(803), int32(_a_F_CreateSubscription_7))
	mBase = m.M
	v1903 = m.ExcPending
	if v1903 != 0 {
		v2085 = v90
...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+136)) = v1910
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v1914
	v2017 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_CreateSubscription[5])))
	if v2017 == int32(0) {
		goto L148
	} else {
		goto L149
...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(_a_F_CreateSubscription_8)
	v2029 = *(*int32)(unsafe.Add(mBase, _c_F_CreateSubscription[6]))
	if v2029 == v2023 {
		goto L4
	} else {
		goto L151
...
L148:
	;
	v2021 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_CreateSubscription[5])) = uint8(v2021)
	goto L150
L149:
	;
	goto L150
...
L151:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+140)) = v1914
	v2052 = int32(0)
	F_RunObjectPostCreateHook(m, int32(_a_F_CreateSubscription_8), v1912, v2052, v2052)
	mBase = m.M
	v2055 = m.ExcPending
	if v2055 != 0 {
		v2085 = v1933
