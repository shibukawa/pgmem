...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v177
	F_errmsg_internal(m, int32(484944), v13)
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L1
...
L49:
	;
	F_errfinish(m, int32(516329), int32(2974), int32(119696))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L1
				...
				if v27 == int32(0) {
					...
					if base.Ui32(int32(9)) < base.Ui32(v32) {
						...
						if int32(base.Ui32(int32(977))>>(uint(v32)%32))&int32(1) == int32(0) {
							...
							v47 = *(*int32)(unsafe.Add(mBase, uint32(v32<<(uint(int32(2))%32))+uint32(_consts[1060])))
			...
			if v14 <= int32(0) {
				...
				if v96 != 0 {
					...
					if v99 != 0 {
						...
						F_errmsg(m, int32(249870), int32(0))
						mBase = m.M
						v103 = m.ExcPending
						if v103 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(514048), int32(707), int32(359494))
							mBase = m.M
							v108 = m.ExcPending
							if v108 != 0 {
								return int32(0)
