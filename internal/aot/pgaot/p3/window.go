...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v177
	F_errmsg_internal(m, int32(459176), v13)
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L1
...
L49:
	;
	F_errfinish(m, int32(487737), int32(2974), int32(110787))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L1
				...
				if v27 == int32(0) {
					...
					if base.Ui32(int32(9)) < base.Ui32(v32) {
						...
						if int32(base.Ui32(int32(977))>>(uint(v32)%32))&int32(1) == int32(0) {
							...
							v47 = *(*int32)(unsafe.Add(mBase, uint32(v32<<(uint(int32(2))%32))+uint32(_consts[1050])))
				...
				if v96 != 0 {
					...
					if v99 != 0 {
						...
						if v103 != 0 {
							...
							F_errfinish(m, int32(485687), int32(707), int32(339016))
							mBase = m.M
							v108 = m.ExcPending
							if v108 != 0 {
								return int32(0)
