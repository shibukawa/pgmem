...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v177
	F_errmsg_internal(m, int32(462375), v13)
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L1
...
L49:
	;
	F_errfinish(m, int32(491213), int32(2974), int32(111732))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L1
			...
			if v14 <= int32(0) {
				...
				if v96 != 0 {
					...
					if v99 != 0 {
						...
						F_errmsg(m, int32(237514), int32(0))
						mBase = m.M
						v103 = m.ExcPending
						if v103 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(489126), int32(707), int32(341355))
							mBase = m.M
							v108 = m.ExcPending
							if v108 != 0 {
								return int32(0)
