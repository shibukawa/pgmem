...
L43:
	;
	v187 = *(*int32)(unsafe.Add(mBase, _consts[14]))
...
func F_RollbackAndReleaseCurrentSubTransaction(m *base.Module) {
	...
	v6 = v4 - int32(16)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[75]))
			...
			if int32(1)<<(uint(v10)%32)&int32(1011711) == int32(0) {
				...
				if v24 != 0 {
					...
					if base.Ui32(v25) <= base.Ui32(int32(19)) {
						v34 = *(*int32)(unsafe.Add(mBase, uint32(v25<<(uint(int32(2))%32))+uint32(_consts[186])))
						v35 = v34
					} else {
						v35 = int32(568037)
					}
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v35
					F_errmsg_internal(m, int32(197032), v6)
					mBase = m.M
					v39 = m.ExcPending
					if v39 != 0 {
						return
					} else {
						F_errfinish(m, int32(515210), int32(4833), int32(270033))
						mBase = m.M
						v44 = m.ExcPending
						if v44 != 0 {
							return
