			...
			if int32(1)<<(uint(v10)%32)&int32(_a_F_RollbackAndReleaseCurrentSubTransaction_0) == int32(0) {
				...
				if v24 != 0 {
					...
					if base.Ui32(v25) <= base.Ui32(int32(19)) {
						v34 = *(*int32)(unsafe.Add(mBase, uint32(v25<<(uint(int32(2))%32))+uint32(_c_F_RollbackAndReleaseCurrentSubTransaction[1])))
						v35 = v34
					} else {
						v35 = int32(_a_F_RollbackAndReleaseCurrentSubTransaction_1)
					}
