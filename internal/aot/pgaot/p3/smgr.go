...
L4:
	;
	F_pg_qsort(m, v27, v25, int32(12), int32(1119))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L7
...
L30:
	;
	v201 = *(*int32)(unsafe.Add(mBase, _c_F_smgr_bulk_flush[0]))
	v202 = int32(0)
	if v202 < v201 {
		goto L31
	} else {
...
L33:
	;
	v207 = *(*int32)(unsafe.Add(mBase, _c_F_smgr_bulk_flush[1]))
	v209 = *(*int32)(unsafe.Add(mBase, _c_F_smgr_bulk_flush[2]))
	v212 = v179
	v213 = int32(0)
	v221 = v209
	goto L36
...
L38:
	;
	v240 = v213 + int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_smgr_bulk_flush[2])) = v240
	v242 = v240
	goto L40
L39:
	;
...
L41:
	;
	v246 = v207 + v213*int32(_a_F_smgr_bulk_flush_0)
...
L54:
	;
	F_errmsg_internal(m, int32(_a_F_smgr_bulk_flush_1), int32(0))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L7
...
L55:
	;
	F_errfinish(m, int32(_a_F_smgr_bulk_flush_2), int32(320), int32(_a_F_smgr_bulk_flush_3))
	mBase = m.M
	v321 = m.ExcPending
	if v321 != 0 {
		goto L7
...
L74:
	...
	F_smgrextend(m, v442, v443, v423, int32(_a_F_smgr_bulk_flush_4), int32(1))
	mBase = m.M
	v447 = m.ExcPending
	if v447 != 0 {
		goto L7
	...
	case 16:
		...
		if v37 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(16)
			F_appendStringInfo(m, l0, int32(_a_F_smgr_desc_0), v7)
			mBase = m.M
			v47 = m.ExcPending
			if v47 != 0 {
				return
