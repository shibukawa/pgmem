...
L41:
	;
	v205 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SearchCatCacheInternal[0])))
	if v205 != int32(1) {
		v209 = v198
		goto L39
	} else {
...
L42:
	;
	v203 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SearchCatCacheInternal[1])))
	if v203 != 0 {
		goto L40
	} else {
		goto L43
...
L52:
	;
	v224 = *(*int32)(unsafe.Add(mBase, _c_F_SearchCatCacheInternal[2]))
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v219)+32)) = v227 + int32(1)
	v232 = *(*int32)(unsafe.Add(mBase, _c_F_SearchCatCacheInternal[2]))
	F_ResourceOwnerRemember(m, v232, v219+int32(40), int32(_a_F_SearchCatCacheInternal_0))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L4
...
L58:
	;
	v246 = int32(0)
	v248 = *(*int32)(unsafe.Add(mBase, _c_F_SearchCatCacheInternal[3]))
	if v248 == v246 {
		v256 = v246
		goto L57
	} else {
...
L70:
	;
	v282 = *(*int32)(unsafe.Add(mBase, _c_F_SearchCatCacheInternal[2]))
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v286))) = v287 + int32(1)
	v292 = *(*int32)(unsafe.Add(mBase, _c_F_SearchCatCacheInternal[2]))
	v294 = v78 + int32(16)
	F_ResourceOwnerRemember(m, v292, v294, int32(_a_F_SearchCatCacheInternal_0))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L4
