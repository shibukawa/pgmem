...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v219)+32)) = v227 + int32(1)
	...
	F_ResourceOwnerRemember(m, v232, v219+int32(40), int32(1714564))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L4
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v286))) = v287 + int32(1)
	...
	v294 = v78 + int32(16)
	F_ResourceOwnerRemember(m, v292, v294, int32(1714564))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L4
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = l1
	F_errmsg_internal(m, int32(474423), v18)
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L4
...
L74:
	;
	F_errfinish(m, int32(491482), int32(373), int32(342080))
	mBase = m.M
	v329 = m.ExcPending
	if v329 != 0 {
		goto L4
