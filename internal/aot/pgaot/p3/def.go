...
L68:
	;
	F_errfinish(m, int32(487642), int32(141), int32(278008))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L8
			...
			if v17 != 0 {
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v21
					F_errmsg(m, int32(337941), v6+int32(16))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(487642), int32(164), int32(540767))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return int32(0)
		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v40
				F_errmsg(m, int32(337941), v6)
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(487642), int32(155), int32(540767))
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
