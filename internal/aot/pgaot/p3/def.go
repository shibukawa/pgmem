...
L9:
	;
	v25 = v18
	v26 = int32(_a_F_defGetBoolean_0)
	goto L11
L10:
	;
	if v63 == int32(0) {
...
L23:
	;
	v70 = v18
	v71 = int32(_a_F_defGetBoolean_1)
	goto L25
L24:
	;
	if v108 == int32(0) {
...
L37:
	;
	v115 = v18
	v116 = int32(_a_F_defGetBoolean_2)
	goto L39
L38:
	;
	if v153 == int32(0) {
...
L51:
	;
	v160 = v18
	v161 = int32(_a_F_defGetBoolean_3)
	goto L53
L52:
	;
	if v198 == int32(0) {
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v210
	F_errmsg(m, int32(_a_F_defGetBoolean_4), v7)
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L8
			...
			if v17 != 0 {
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v21
					F_errmsg(m, int32(_a_F_defGetInt32_0), v6+int32(16))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v40
				F_errmsg(m, int32(_a_F_defGetInt32_0), v6)
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return int32(0)
