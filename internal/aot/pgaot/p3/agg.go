...
L2:
	...
	F_resolve_special_varno(m, v26, l1, int32(1502), l2)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L5
...
L7:
	;
	F_appendStringInfoString(m, v17, int32(_a_F_get_agg_expr_helper_0))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L5
...
L25:
	;
	v89 = int32(_a_F_get_agg_expr_helper_1)
	goto L27
L26:
	;
	v89 = int32(_a_F_get_agg_expr_helper_2)
	goto L27
L27:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v15)+4)) = v89
	F_appendStringInfo(m, v17, int32(_a_F_get_agg_expr_helper_3), v15)
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L5
...
L34:
	;
	F_appendStringInfoString(m, v17, int32(_a_F_get_agg_expr_helper_4))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L5
...
L52:
	;
	v146 = int32(_a_F_get_agg_expr_helper_5)
	goto L53
L53:
	;
...
L54:
	;
	v146 = int32(_a_F_get_agg_expr_helper_6)
	goto L53
L55:
	;
	goto L50
...
L58:
	;
	F_appendStringInfoString(m, v17, int32(_a_F_get_agg_expr_helper_7))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L5
...
L62:
	;
	F_appendStringInfoString(m, v17, int32(_a_F_get_agg_expr_helper_8))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L5
...
L69:
	;
	F_appendStringInfoString(m, v17, int32(_a_F_get_agg_expr_helper_9))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L5
