			...
			if int32(106751983) <= v7 {
				...
				if v29 != 0 {
					...
					if v32 != 0 {
						...
						F_errmsg(m, int32(_a_F_date_mi_interval_0), int32(0))
						mBase = m.M
						v36 = m.ExcPending
						if v36 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_date_mi_interval_1), int32(658), int32(_a_F_date_mi_interval_2))
							mBase = m.M
							v41 = m.ExcPending
							if v41 != 0 {
								return int32(0)
...
func F_date_recv(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		if base.Ui32(v4-int32(2147483647)) < base.Ui32(int32(2)) {
			...
			if base.Ui32(v4+int32(_a_F_date_recv_0)) < base.Ui32(int32(2147483494)) {
				return v4
			} else {
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
					...
					*(*int32)(unsafe.Add(mBase, uint32(v33)+20)) = int32(1) - v38
					...
					if base.Ui32(int32(-12)) <= base.Ui32(v150-int32(13)) {
						...
						if base.Ui32(int32(-31)) <= base.Ui32(v160-int32(32)) {
							...
							v191 = *(*int32)(unsafe.Add(mBase, uint32(v182*int32(52)+v185<<(uint(int32(2))%32))+uint32(_c_F_make_date[0])))
							if v170 <= v191 {
								v201 = int32(0)
							} else {
								v201 = int32(-2)
				...
				if v203 <= int32(-4713) {
					if v203 != int32(-4713) {
						...
						if int32(10) < v202 {
							...
							if int32(2) < v202 {
								v222 = int32(_a_F_make_date_4)
							} else {
								v222 = int32(_a_F_make_date_5)
							}
							v223 = v222 + v203
							...
							v243 = base.I32_div_s((v238+v202)*int32(_a_F_make_date_6), int32(256))
							v246 = v216 + v223*int32(365) + v228 + v231 + v234 + v243 - int32(_a_F_make_date_7)
							if base.Ui32(int32(2147483494)) <= base.Ui32(v246) {
								...
								m.G0 = v8 + int32(112)
								return v246 - int32(_a_F_make_date_8)
							}
						} else {
							F_errstart_cold(m, int32(21), int32(0))
							mBase = m.M
