...
func F_assign_recovery_target_lsn(m *base.Module, l0 int32, l1 int32) {
	...
	var v24 int32
	_ = v24
	v4 = *(*int32)(unsafe.Add(mBase, _consts[234]))
		...
		if l0 == int32(0) {
			*(*int32)(unsafe.Add(mBase, _consts[234])) = int32(0)
			...
			if v11 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, _consts[234])) = int32(4)
				v18 = *(*int64)(unsafe.Add(mBase, uint32(l1)))
				*(*int64)(unsafe.Add(mBase, _consts[259])) = v18
				return
			}
		}
	} else {
...
func F_assign_recovery_target_time(m *base.Module, l0 int32, l1 int32) {
	...
	if v4&int32(-3) == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, _consts[234])) = v13
		return
	} else {
		F_error_multiple_recovery_targets(m)
		mBase = m.M
...
func F_assign_recovery_target_timeline(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[237])) = v5
	if v5 == int32(2) {
		v11 = int32(0)
	...
	*(*int32)(unsafe.Add(mBase, _consts[239])) = v16
	return
}
