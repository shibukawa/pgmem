...
L2:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = v12
	v18 = *(*int32)(unsafe.Add(mBase, _consts[715]))
	if v18 == int32(0) {
		v115 = v2
		goto L3
	} else {
...
L4:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[310]))
	if v22 <= int32(0) {
		goto L6
	} else {
		goto L7
...
L10:
	;
	v93 = *(*int32)(unsafe.Add(mBase, _consts[715]))
	v95 = v93
	v97 = v86
	goto L5
L11:
	;
	F_s_lock(m, v38, int32(518284), int32(779), int32(120485))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L1
...
L15:
	;
	v88 = v29 + int32(1)
	v90 = *(*int32)(unsafe.Add(mBase, _consts[310]))
	if v88 < v90 {
		v28 = v86
		v29 = v88
		goto L9
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v45)+36)) = v29
	v81 = *(*int32)(unsafe.Add(mBase, _consts[716]))
...
L23:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[715]))
