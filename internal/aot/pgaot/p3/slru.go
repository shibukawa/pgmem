...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v390
	v400 = F_pg_snprintf(m, v23+int32(48), int32(1024), int32(510201), v23)
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L8
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v390
	v410 = F_pg_snprintf(m, v23+int32(48), int32(1024), int32(510588), v23+int32(16))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L8
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v12
	v21 = F_pg_snprintf(m, l2, int32(1024), int32(510201), v9)
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L5
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v12
	v31 = F_pg_snprintf(m, l2, int32(1024), int32(510588), v9+int32(16))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L5
