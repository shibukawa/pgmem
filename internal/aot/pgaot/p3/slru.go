...
L15:
	...
	v128 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[0])) = uint8(v128)
	*(*uint8)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[1])) = uint8(v128)
	v134 = v126 << (uint(int32(6)) % 32)
	v137 = *(*int64)(unsafe.Add(mBase, uint32(v134)+uint32(_c_F_SlruInternalWritePage[2])))
	*(*int64)(unsafe.Add(mBase, uint32(v134)+uint32(_c_F_SlruInternalWritePage[2]))) = v137 + int64(1)
...
L45:
	;
	v292 = int32(_a_F_SlruInternalWritePage_0)
	v294 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[3])) = v294 + int32(1)
	F_XLogFlush(m, v286)
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
...
L46:
	;
	v300 = int32(_a_F_SlruInternalWritePage_0)
	v302 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[3])) = v302 - int32(1)
	goto L16
L47:
	;
	if l2 == int32(0) {
...
L50:
	;
	v467 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[4])) = v467
	v469 = int32(_a_F_SlruInternalWritePage_1)
	v470 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[5]))
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v390
	v400 = F_pg_snprintf(m, v23+int32(48), int32(1024), int32(_a_F_SlruInternalWritePage_3), v23)
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L8
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v390
	v410 = F_pg_snprintf(m, v23+int32(48), int32(1024), int32(_a_F_SlruInternalWritePage_4), v23+int32(16))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L8
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[6])) = int32(0)
	v424 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[7])) = v424
	goto L49
L69:
	;
	goto L70
...
L73:
	;
	v495 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[4]))
	if v495 != 0 {
		goto L76
	} else {
		goto L77
...
L77:
	;
	v497 = int32(51)
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[4])) = v497
	v500 = v497
	goto L78
L78:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[7])) = v500
...
L84:
	;
	v525 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[5]))
	*(*int32)(unsafe.Add(mBase, uint32(v525))) = int32(167772212)
	v530 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[8])))
	if v530 != int32(1) {
		v544 = int32(0)
		goto L86
	} else {
...
L85:
	;
	v546 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[5]))
	v547 = int32(0)
...
L90:
	;
	v539 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[4]))
	if v539 == int32(27) {
		goto L88
	} else {
		goto L91
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[6])) = int32(4)
	v556 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[7])) = v556
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[6])) = int32(5)
	v572 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[7])) = v572
	goto L49
L97:
	;
...
L109:
	;
	v719 = int32(_a_F_SlruInternalWritePage_5)
	v721 = *(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[9]))
	*(*int32)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[9])) = v721 + int32(1)
	v725 = int32(_a_F_SlruInternalWritePage_6)
	v727 = *(*int64)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[10]))
	*(*int64)(unsafe.Add(mBase, _c_F_SlruInternalWritePage[10])) = v727 + int64(1)
	goto L1
}
