...
L7:
	...
	F_s_lock(m, v22, int32(478352), int32(1834), int32(254817))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L10
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v70
	F_errmsg_internal(m, int32(55355), v8)
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L10
...
L30:
	;
	F_errfinish(m, int32(478352), int32(1906), int32(254817))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L10
...
L33:
	...
	F_s_lock(m, v100, int32(478352), int32(1917), int32(254817))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L10
...
L39:
	...
	F_s_lock(m, v121, int32(478352), int32(1927), int32(254817))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L10
