...
L7:
	...
	F_s_lock(m, v22, int32(494462), int32(1834), int32(263858))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L10
...
L30:
	;
	F_errfinish(m, int32(494462), int32(1906), int32(263858))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L10
...
L33:
	...
	F_s_lock(m, v100, int32(494462), int32(1917), int32(263858))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L10
...
L39:
	...
	F_s_lock(m, v121, int32(494462), int32(1927), int32(263858))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L10
