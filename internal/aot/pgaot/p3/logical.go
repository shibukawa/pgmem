...
func F_LogicalConfirmReceivedLocation(m *base.Module, l0 int64) {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[673]))
...
L7:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[673]))
	F_s_lock(m, v22, int32(498011), int32(1834), int32(265505))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L10
...
L9:
	;
	v29 = *(*int32)(unsafe.Add(mBase, _consts[673]))
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v70
	F_errmsg_internal(m, int32(57337), v8)
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L10
...
L30:
	;
	F_errfinish(m, int32(498011), int32(1906), int32(265505))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L10
...
L32:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[673]))
...
L33:
	;
	v100 = *(*int32)(unsafe.Add(mBase, _consts[673]))
	F_s_lock(m, v100, int32(498011), int32(1917), int32(265505))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L10
...
L35:
	;
	v107 = *(*int32)(unsafe.Add(mBase, _consts[673]))
	v108 = int32(0)
...
L39:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _consts[673]))
	F_s_lock(m, v121, int32(498011), int32(1927), int32(265505))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L10
...
L41:
	;
	v128 = *(*int32)(unsafe.Add(mBase, _consts[673]))
