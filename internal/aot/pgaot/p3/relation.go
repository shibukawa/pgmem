...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33))) = v604 + int32(4)
	F_errmsg_internal(m, int32(686187), v33)
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		goto L1
...
L86:
	;
	F_errfinish(m, int32(492334), int32(1946), int32(134147))
	mBase = m.M
	v615 = m.ExcPending
	if v615 != 0 {
		goto L1
								...
								if v58 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6))) = v62
									...
									if v66 != 0 {
										...
										F_errfinish(m, int32(496016), int32(2563), int32(262696))
										mBase = m.M
										v71 = m.ExcPending
										if v71 != 0 {
											return
	...
	default:
		...
		if v21 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
			F_errmsg_internal(m, int32(499258), v10)
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(496085), int32(146), int32(404420))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
...
L63:
	;
	F_errfinish(m, int32(493175), int32(101), int32(21230))
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L1
...
L213:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v612))) = v614
	F_errmsg_internal(m, int32(484004), v612)
	mBase = m.M
	v661 = m.ExcPending
	if v661 != 0 {
		goto L33
...
L214:
	;
	F_errfinish(m, int32(494492), int32(4834), int32(87456))
	mBase = m.M
	v666 = m.ExcPending
	if v666 != 0 {
		goto L33
...
L275:
	;
	F_errfinish(m, int32(492922), int32(361), int32(153166))
	mBase = m.M
	v918 = m.ExcPending
	if v918 != 0 {
		goto L33
...
L381:
	;
	F_errfinish(m, int32(492922), int32(536), int32(382474))
	mBase = m.M
	v1288 = m.ExcPending
	if v1288 != 0 {
		goto L33
...
L384:
	;
	F_errfinish(m, int32(492922), int32(870), int32(382474))
	mBase = m.M
	v1305 = m.ExcPending
	if v1305 != 0 {
		goto L33
...
L74:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+48)) = base.I32_extend16_s(v234)
	F_errmsg_internal(m, int32(480197), v29+int32(48))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L17
...
L195:
	;
	F_errmsg_internal(m, int32(488530), int32(0))
	mBase = m.M
	v1265 = m.ExcPending
	if v1265 != 0 {
		goto L17
...
L196:
	;
	F_errfinish(m, int32(491059), int32(493), int32(171350))
	mBase = m.M
	v1270 = m.ExcPending
	if v1270 != 0 {
		goto L17
...
L199:
	;
	F_errfinish(m, int32(491059), int32(523), int32(171350))
	mBase = m.M
	v1283 = m.ExcPending
	if v1283 != 0 {
		goto L17
...
L203:
	;
	F_errfinish(m, int32(491059), int32(372), int32(171415))
	mBase = m.M
	v1302 = m.ExcPending
	if v1302 != 0 {
		goto L17
...
L273:
	;
	F_errfinish(m, int32(491059), int32(713), int32(171478))
	mBase = m.M
	v1843 = m.ExcPending
	if v1843 != 0 {
		goto L17
...
L470:
	;
	F_errfinish(m, int32(496569), int32(280), int32(485443))
	mBase = m.M
	v2953 = m.ExcPending
	if v2953 != 0 {
		goto L17
...
L473:
	;
	F_errfinish(m, int32(496569), int32(282), int32(485443))
	mBase = m.M
	v2968 = m.ExcPending
	if v2968 != 0 {
		goto L17
...
L476:
	;
	F_errfinish(m, int32(496569), int32(296), int32(485443))
	mBase = m.M
	v2984 = m.ExcPending
	if v2984 != 0 {
		goto L17
					...
					if v62 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v52))) = v49
						...
						if v66 != 0 {
							...
							F_errfinish(m, int32(494540), int32(38), int32(370981))
							mBase = m.M
							v71 = m.ExcPending
							if v71 != 0 {
								return
					...
					if v32 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v34
						...
						if v38 != 0 {
							...
							F_errfinish(m, int32(496016), int32(1863), int32(420453))
							mBase = m.M
							v43 = m.ExcPending
							if v43 != 0 {
								return
			...
			*(*uint16)(unsafe.Add(mBase, uint32(l1)+4)) = uint16(v52)
			...
			if v74 != 0 {
				...
				if v78 != 0 {
					...
					F_errfinish(m, int32(492922), int32(65), int32(382518))
					mBase = m.M
					v83 = m.ExcPending
					if v83 != 0 {
						return
