...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v97 | int32(-2147483648)
	v102 = *(*int32)(unsafe.Add(mBase, _consts[139]))
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = int32(334014)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+24)) = int32(888)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(523935)
...
L13:
	;
	v64 = int32(4164732)
	v65 = *(*int32)(unsafe.Add(mBase, _consts[335]))
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[335])) = v82
	goto L20
L22:
	;
	if int32(999) < v65 {
...
L32:
	;
	v109 = l0 + int32(8)
	v111 = *(*int32)(unsafe.Add(mBase, _consts[152]))
	v112 = *(*int32)(unsafe.Add(mBase, uint32(v111)))
	v114 = *(*int32)(unsafe.Add(mBase, _consts[112]))
...
L34:
	;
	v139 = *(*int32)(unsafe.Add(mBase, _consts[152]))
	v140 = *(*int32)(unsafe.Add(mBase, uint32(v139)))
	v142 = *(*int32)(unsafe.Add(mBase, _consts[112]))
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v147)+4)) = v148
	v156 = *(*int32)(unsafe.Add(mBase, _consts[152]))
...
L43:
	;
	F_errmsg_internal(m, int32(382023), int32(0))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L16
...
L44:
	;
	F_errfinish(m, int32(523935), int32(1056), int32(357017))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L16
...
L46:
	;
	F_errmsg_internal(m, int32(392465), int32(0))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L16
...
L47:
	;
	F_errfinish(m, int32(523935), int32(1059), int32(357017))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L16
