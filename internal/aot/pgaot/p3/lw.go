...
L9:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = int32(333111)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+24)) = int32(888)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(522607)
...
L43:
	;
	F_errmsg_internal(m, int32(380901), int32(0))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L16
...
L44:
	;
	F_errfinish(m, int32(522607), int32(1056), int32(355994))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L16
...
L46:
	;
	F_errmsg_internal(m, int32(391320), int32(0))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L16
...
L47:
	;
	F_errfinish(m, int32(522607), int32(1059), int32(355994))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L16
