...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v97 | int32(-2147483648)
	v102 = *(*int32)(unsafe.Add(mBase, _consts[128]))
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[324])) = v82
	goto L20
L22:
	;
	if int32(999) < v65 {
...
L32:
	;
	v109 = l0 + int32(8)
	v111 = *(*int32)(unsafe.Add(mBase, _consts[141]))
	v112 = *(*int32)(unsafe.Add(mBase, uint32(v111)))
	v114 = *(*int32)(unsafe.Add(mBase, _consts[100]))
...
L34:
	;
	v139 = *(*int32)(unsafe.Add(mBase, _consts[141]))
	v140 = *(*int32)(unsafe.Add(mBase, uint32(v139)))
	v142 = *(*int32)(unsafe.Add(mBase, _consts[100]))
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v147)+4)) = v148
	v156 = *(*int32)(unsafe.Add(mBase, _consts[141]))
...
L43:
	;
	F_errmsg_internal(m, int32(356690), int32(0))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L16
...
L44:
	;
	F_errfinish(m, int32(489128), int32(1056), int32(333162))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L16
...
L46:
	;
	F_errmsg_internal(m, int32(366569), int32(0))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L16
...
L47:
	;
	F_errfinish(m, int32(489128), int32(1059), int32(333162))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L16
