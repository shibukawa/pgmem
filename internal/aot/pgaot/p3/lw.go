...
func F_LWLockQueueSelf(m *base.Module, l0 int32, l1 int32) {
	...
	v10 = v8 - int32(32)
	m.G0 = v10
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[0]))
	if v13 != 0 {
		goto L2
	} else {
		goto L3
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v97 | int32(-2147483648)
	v102 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[0]))
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = int32(_a_F_LWLockQueueSelf_0)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+24)) = int32(888)
	*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(_a_F_LWLockQueueSelf_1)
...
L13:
	;
	v64 = int32(_a_F_LWLockQueueSelf_2)
	v65 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[1]))
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[1])) = v82
	goto L20
L22:
	;
	if int32(999) < v65 {
...
L32:
	;
	v109 = l0 + int32(8)
	v111 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[2]))
	v112 = *(*int32)(unsafe.Add(mBase, uint32(v111)))
	v114 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[3]))
...
L34:
	;
	v139 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[2]))
	v140 = *(*int32)(unsafe.Add(mBase, uint32(v139)))
	v142 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[3]))
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v119))) = v121
	v128 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[2]))
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v147)+4)) = v148
	v156 = *(*int32)(unsafe.Add(mBase, _c_F_LWLockQueueSelf[2]))
