			...
			*(*int32)(unsafe.Add(mBase, uint32(l1))) = v25 + v15
			...
			case 0:
				...
				*(*int32)(unsafe.Add(mBase, uint32(l1)+24)) = v41 + int32(2)
				...
				if v45 != 0 {
					F_ExplainPropertyInteger(m, int32(228419), int32(0), base.I64_extend_i32_s(l0), l1)
					mBase = m.M
					v50 = m.ExcPending
					if v50 != 0 {
						return
							...
							if v77 == int32(0) {
								...
								if v81 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
									F_appendStringInfo(m, v82, int32(746110), v9)
									mBase = m.M
									v86 = m.ExcPending
									if v86 != 0 {
										return
...
func F_ExplainPropertyUInteger(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8))) = l2
	v15 = F_pg_snprintf(m, v8+int32(16), int32(32), int32(38314), v8)
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		return
