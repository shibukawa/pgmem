...
L27:
	;
	v60 = *(*int64)(unsafe.Add(mBase, _c_F_ATExecDropColumn[0]))
	*(*int64)(unsafe.Add(mBase, uint32(l0))) = v60
	v63 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecDropColumn[1]))
...
L24:
	;
	v372 = *(*int64)(unsafe.Add(mBase, _c_F_ATExecValidateConstraint[0]))
	*(*int64)(unsafe.Add(mBase, uint32(l0))) = v372
	v375 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecValidateConstraint[1]))
...
L59:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v225)+84)) = uint8(v239)
	v241 = int32(_a_F_ATExecValidateConstraint_0)
...
L64:
	;
	v281 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecValidateConstraint[2]))
	if v281 != 0 {
		goto L65
	} else {
		goto L66
...
L129:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v560)+84)) = uint8(v574)
	v576 = int32(_a_F_ATExecValidateConstraint_0)
...
L133:
	;
	v614 = *(*int32)(unsafe.Add(mBase, _c_F_ATExecValidateConstraint[2]))
	if v614 != 0 {
		goto L134
	} else {
		goto L135
...
func F_ATSimplePermissions(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if l2&v24 == int32(0) {
		if base.Ui32(l0) <= base.Ui32(int32(64)) {
			v34 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_c_F_ATSimplePermissions[0])))
			v36 = v34
		} else {
			v36 = int32(0)
		}
		...
		v56 = *(*int32)(unsafe.Add(mBase, _c_F_ATSimplePermissions[1]))
		...
		if v58 != 0 {
			...
			if v57 == int32(0) {
				...
				if v80 != 0 {
					...
					v82 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ATSimplePermissions[2])))
					if v82 == int32(0) {
						v86 = int32(1)
						v87 = *(*int32)(unsafe.Add(mBase, uint32(l1)+56))
						if base.Ui32(v87) < base.Ui32(int32(_a_F_ATSimplePermissions_6)) {
							v96 = v86
						} else {
