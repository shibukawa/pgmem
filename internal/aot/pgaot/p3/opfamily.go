...
L10:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_get_opfamily_oid[0]))
	if v36 == int32(0) {
		v79 = int32(0)
		goto L11
	} else {
...
L16:
	...
	v56 = *(*int32)(unsafe.Add(mBase, _c_F_get_opfamily_oid[1]))
	if v54 != v56 {
		goto L18
	} else {
		goto L19
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	F_errmsg_internal(m, int32(_a_F_get_opfamily_oid_0), v11)
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L1
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = v114 + v113 + int32(4)
	F_errmsg(m, int32(_a_F_get_opfamily_oid_1), v11+int32(16))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L1
