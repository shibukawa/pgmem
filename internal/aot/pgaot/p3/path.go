...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v139))) = v138 << (uint(int32(2)) % 32)
	v153 = F_path_decode(m, v106, int32(1), v54, v139+int32(16), v12+int32(47), v12+int32(40), int32(_a_F_path_in_3), v15, v14)
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L35
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+32)) = l5 + int32(1)
	F_errmsg(m, int32(_a_F_setPath_0), v29+int32(32))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L1
...
L269:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = l5 + int32(1)
	F_errmsg(m, int32(_a_F_setPath_4), v29)
	mBase = m.M
	v1150 = m.ExcPending
	if v1150 != 0 {
		goto L1
...
L278:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+48)) = l5 + int32(1)
	F_errmsg(m, int32(_a_F_setPath_10), v29+int32(48))
	mBase = m.M
	v1191 = m.ExcPending
	if v1191 != 0 {
		goto L1
...
L291:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = v42
	F_errmsg_internal(m, int32(_a_F_setPath_16), v29+int32(16))
	mBase = m.M
	v1246 = m.ExcPending
	if v1246 != 0 {
		goto L1
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l2
	v197 = F_psprintf(m, int32(_a_F_substitute_path_macro_0), v9)
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L6
