					...
					if base.Ui32(int32(268435455)) < base.Ui32(v29) {
						...
						if v137 != 0 {
							...
							if v140 != 0 {
								...
								F_errmsg(m, int32(423853), int32(0))
								mBase = m.M
								v144 = m.ExcPending
								if v144 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(474716), int32(4368), int32(445770))
									mBase = m.M
									v149 = m.ExcPending
									if v149 != 0 {
										return int32(0)
...
L39:
	;
	F_errsave_finish(m, v14, int32(474716), int32(1438), int32(267929))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L35
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v139))) = v138 << (uint(int32(2)) % 32)
	v153 = F_path_decode(m, v106, int32(1), v54, v139+int32(16), v12+int32(47), v12+int32(40), int32(309041), v15, v14)
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L35
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = int32(309041)
...
L59:
	;
	F_errsave_finish(m, v14, int32(474716), int32(1455), int32(267929))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L35
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = int32(309041)
...
L67:
	;
	F_errsave_finish(m, v14, int32(474716), int32(1463), int32(267929))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L35
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(309041)
...
L72:
	;
	F_errsave_finish(m, v14, int32(474716), int32(1418), int32(267929))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L35
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+32)) = l5 + int32(1)
	F_errmsg(m, int32(467845), v29+int32(32))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(475576), int32(5463), int32(24854))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L1
...
L270:
	;
	F_errfinish(m, int32(475576), int32(5218), int32(309059))
	mBase = m.M
	v1155 = m.ExcPending
	if v1155 != 0 {
		goto L1
...
L273:
	;
	F_errmsg(m, int32(20954), int32(0))
	mBase = m.M
	v1166 = m.ExcPending
	if v1166 != 0 {
		goto L1
...
L275:
	;
	F_errfinish(m, int32(475576), int32(5238), int32(309059))
	mBase = m.M
	v1175 = m.ExcPending
	if v1175 != 0 {
		goto L1
...
L278:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+48)) = l5 + int32(1)
	F_errmsg(m, int32(688282), v29+int32(48))
	mBase = m.M
	v1191 = m.ExcPending
	if v1191 != 0 {
		goto L1
...
L279:
	;
	F_errfinish(m, int32(475576), int32(5446), int32(24854))
	mBase = m.M
	v1196 = m.ExcPending
	if v1196 != 0 {
		goto L1
...
L283:
	;
	F_errhint(m, int32(591898), int32(0))
	mBase = m.M
	v1211 = m.ExcPending
	if v1211 != 0 {
		goto L1
...
L284:
	;
	F_errfinish(m, int32(475576), int32(5342), int32(104958))
	mBase = m.M
	v1216 = m.ExcPending
	if v1216 != 0 {
		goto L1
...
L289:
	;
	F_errfinish(m, int32(475576), int32(5269), int32(309059))
	mBase = m.M
	v1236 = m.ExcPending
	if v1236 != 0 {
		goto L1
...
L291:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = v42
	F_errmsg_internal(m, int32(462894), v29+int32(16))
	mBase = m.M
	v1246 = m.ExcPending
	if v1246 != 0 {
		goto L1
...
L292:
	;
	F_errfinish(m, int32(475576), int32(5274), int32(309059))
	mBase = m.M
	v1251 = m.ExcPending
	if v1251 != 0 {
		goto L1
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l2
	v197 = F_psprintf(m, int32(167299), v9)
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L6
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
	F_errmsg(m, int32(193988), v9+int32(16))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		goto L6
...
L72:
	;
	F_errfinish(m, int32(476042), int32(555), int32(230080))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L6
