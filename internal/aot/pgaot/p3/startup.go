...
func F_StartupSUBTRANS(m *base.Module, l0 int32) {
	...
	var v48 int32
	_ = v48
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_StartupSUBTRANS[0]))
...
L1:
	;
	v21 = *(*int32)(unsafe.Add(mBase, _c_F_StartupSUBTRANS[1]))
	v22 = *(*int32)(unsafe.Add(mBase, uint32(v21)+28))
	v25 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_StartupSUBTRANS[2])))
...
L5:
	;
	v38 = F_SimpleLruZeroPage(m, int32(_a_F_StartupSUBTRANS_0), v17)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L9
