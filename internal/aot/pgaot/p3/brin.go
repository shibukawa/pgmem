									...
									if v62 != 0 {
										...
										if v66 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(l1)+44)) = int32(1)
											if v70 != 0 {
												F_s_lock(m, l1+int32(44), int32(487603), int32(2847), int32(423088))
												mBase = m.M
												v79 = m.ExcPending
												if v79 != 0 {
													return
...
L78:
	;
	F_errmsg_internal(m, int32(234631), int32(0))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L13
...
L79:
	;
	F_errfinish(m, int32(487060), int32(259), int32(311569))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L13
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(17653)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(488206), int32(826), int32(35571))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v266 + int32(4)
	F_errmsg(m, int32(667113), v16+int32(16))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L13
...
L107:
	;
	F_errfinish(m, int32(484924), int32(852), int32(221863))
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L13
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v109
	F_errmsg_internal(m, int32(463128), v19)
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L3
...
L29:
	;
	F_errfinish(m, int32(488757), int32(2650), int32(91106))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L3
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v270
	F_errmsg_internal(m, int32(463128), v19+int32(16))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L3
...
L60:
	;
	F_errfinish(m, int32(488757), int32(2709), int32(91106))
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L3
			...
			if v191 != 0 {
				...
				if v194 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v12))) = v15
					F_errmsg(m, int32(422988), v12)
					mBase = m.M
					v198 = m.ExcPending
					if v198 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(487603), int32(1403), int32(394724))
						mBase = m.M
						v203 = m.ExcPending
						if v203 != 0 {
							return int32(0)
										...
										if v210 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v211 + int32(4)
											...
											if v219 != 0 {
												...
												F_errfinish(m, int32(487603), int32(1448), int32(394724))
												mBase = m.M
												v224 = m.ExcPending
												if v224 != 0 {
													return int32(0)
											...
											if v228 != 0 {
												...
												if v231 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v232 + int32(4)
													F_errmsg(m, int32(670347), v12+int32(16))
													mBase = m.M
													v240 = m.ExcPending
													if v240 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(487603), int32(1464), int32(394724))
														mBase = m.M
														v245 = m.ExcPending
														if v245 != 0 {
															return int32(0)
																		...
																		if v121 == int32(0) {
																			...
																			if v127 != 0 {
																				...
																				*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v128 + int32(4)
																				F_errmsg(m, int32(428407), v12+int32(32))
																				mBase = m.M
																				v136 = m.ExcPending
																				if v136 != 0 {
																					return int32(0)
																				} else {
																					F_errfinish(m, int32(487603), int32(1473), int32(394724))
																					mBase = m.M
																					v141 = m.ExcPending
																					if v141 != 0 {
																						return int32(0)
		...
		if v171 != 0 {
			...
			if v174 != 0 {
				...
				if v178 != 0 {
					...
					F_errhint(m, int32(548125), int32(0))
					mBase = m.M
					v182 = m.ExcPending
					if v182 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(487603), int32(1398), int32(394724))
						mBase = m.M
						v187 = m.ExcPending
						if v187 != 0 {
							return int32(0)
