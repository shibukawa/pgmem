									...
									if v62 != 0 {
										...
										if v66 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(l1)+44)) = int32(1)
											if v70 != 0 {
												F_s_lock(m, l1+int32(44), int32(473259), int32(2847), int32(409883))
												mBase = m.M
												v79 = m.ExcPending
												if v79 != 0 {
													return
...
L78:
	;
	F_errmsg_internal(m, int32(226228), int32(0))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L13
...
L79:
	;
	F_errfinish(m, int32(472754), int32(259), int32(301455))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L13
		...
		if v16 != 0 {
			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v22
				F_appendStringInfo(m, v6+int32(16), int32(55035), v6)
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
...
func F_brin_bloom_summary_recv(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(16551)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(473808), int32(826), int32(33791))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
func F_brin_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = v17
		F_appendStringInfo(m, l0, int32(49497), v8)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
	...
	case 1:
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8)+16)) = v24
		F_appendStringInfo(m, l0, int32(44678), v8+int32(16))
		mBase = m.M
		v32 = m.ExcPending
		if v32 != 0 {
			return
	...
	case 2:
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8)+32)) = v33
		F_appendStringInfo(m, l0, int32(44621), v8+int32(32))
		mBase = m.M
		v43 = m.ExcPending
		if v43 != 0 {
			return
	...
	case 3:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v44
		F_appendStringInfo(m, l0, int32(44706), v8+int32(48))
		mBase = m.M
		v50 = m.ExcPending
		if v50 != 0 {
			return
	...
	case 4:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v51
		F_appendStringInfo(m, l0, int32(45099), v8-int32(-64))
		mBase = m.M
		v57 = m.ExcPending
		if v57 != 0 {
			return
	...
	case 5:
		...
		*(*int64)(unsafe.Add(mBase, uint32(v8)+80)) = v58
		F_appendStringInfo(m, l0, int32(38891), v8+int32(80))
		mBase = m.M
		v66 = m.ExcPending
		if v66 != 0 {
			return
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+24)) = v266 + int32(4)
	F_errmsg(m, int32(651158), v16+int32(16))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L13
...
L107:
	;
	F_errfinish(m, int32(470683), int32(852), int32(214517))
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L13
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v109
	F_errmsg_internal(m, int32(449477), v19)
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L3
...
L29:
	;
	F_errfinish(m, int32(474359), int32(2650), int32(87434))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L3
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v270
	F_errmsg_internal(m, int32(449477), v19+int32(16))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L3
...
L60:
	;
	F_errfinish(m, int32(474359), int32(2709), int32(87434))
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L3
...
L8:
	...
	v44 = F_AllocSetContextCreateInternal(m, v39, int32(58343), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L6
			...
			if v191 != 0 {
				...
				if v194 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v12))) = v15
					F_errmsg(m, int32(409783), v12)
					mBase = m.M
					v198 = m.ExcPending
					if v198 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(473259), int32(1403), int32(382460))
						mBase = m.M
						v203 = m.ExcPending
						if v203 != 0 {
							return int32(0)
									...
									if v207 != 0 {
										...
										if v210 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v211 + int32(4)
											F_errmsg(m, int32(26845), v12+int32(48))
											mBase = m.M
											v219 = m.ExcPending
											if v219 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(473259), int32(1448), int32(382460))
												mBase = m.M
												v224 = m.ExcPending
												if v224 != 0 {
													return int32(0)
											...
											if v228 != 0 {
												...
												if v231 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v232 + int32(4)
													F_errmsg(m, int32(654392), v12+int32(16))
													mBase = m.M
													v240 = m.ExcPending
													if v240 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(473259), int32(1464), int32(382460))
														mBase = m.M
														v245 = m.ExcPending
														if v245 != 0 {
															return int32(0)
																		...
																		if v121 == int32(0) {
																			...
																			if v127 != 0 {
																				...
																				*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v128 + int32(4)
																				F_errmsg(m, int32(415011), v12+int32(32))
																				mBase = m.M
																				v136 = m.ExcPending
																				if v136 != 0 {
																					return int32(0)
																				} else {
																					F_errfinish(m, int32(473259), int32(1473), int32(382460))
																					mBase = m.M
																					v141 = m.ExcPending
																					if v141 != 0 {
																						return int32(0)
		...
		if v171 != 0 {
			...
			if v174 != 0 {
				...
				if v178 != 0 {
					...
					F_errhint(m, int32(532868), int32(0))
					mBase = m.M
					v182 = m.ExcPending
					if v182 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(473259), int32(1398), int32(382460))
						mBase = m.M
						v187 = m.ExcPending
						if v187 != 0 {
							return int32(0)
