...
L45:
	;
	F_errfinish(m, int32(524313), int32(3537), int32(82275))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L2
...
L49:
	;
	F_errfinish(m, int32(524313), int32(3542), int32(82275))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L2
	...
	if l2 != 0 {
		...
		if v74 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l3))) = v73
			...
			v85 = *(*int32)(unsafe.Add(mBase, uint32(v80*int32(28))+uint32(_consts[989])))
			if v85 == int32(1) {
				v88 = int32(0)
...
L68:
	;
	F_errfinish(m, int32(524313), int32(923), int32(345793))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L22
...
L72:
	;
	F_errfinish(m, int32(524313), int32(987), int32(345793))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L22
...
L74:
	;
	F_errmsg_internal(m, int32(588615), int32(0))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L22
...
L75:
	;
	F_errfinish(m, int32(524313), int32(1101), int32(345793))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L22
