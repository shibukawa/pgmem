...
func F_pgl_getpwuid(m *base.Module, l0 int32) int32 {
	...
	var v18 int32
	_ = v18
	*(*int32)(unsafe.Add(mBase, _consts[1247])) = int32(4212114)
	*(*int32)(unsafe.Add(mBase, _consts[1248])) = int32(4212099)
	*(*int32)(unsafe.Add(mBase, _consts[1249])) = int32(4212087)
	*(*int32)(unsafe.Add(mBase, _consts[1250])) = l0
	*(*int32)(unsafe.Add(mBase, _consts[1251])) = l0
	*(*int32)(unsafe.Add(mBase, _consts[1252])) = int32(4212085)
	v18 = int32(4638152)
	*(*int32)(unsafe.Add(mBase, _consts[1253])) = int32(4212076)
	return v18
}
func F_pgl_longjmp(m *base.Module, l0 int32, l1 int32) {
	...
	var v76 int32
	_ = v76
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1245]))
	if v4 == int32(0) {
		goto L1
	} else {
		goto L2
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1246])) = int32(100)
...
func F_pgl_setPGliteActive(m *base.Module, l0 int32) int32 {
	...
	m.G0 = v6
	v8 = int32(4637968)
	v9 = *(*int32)(unsafe.Add(mBase, _consts[1245]))
	*(*int32)(unsafe.Add(mBase, _consts[1245])) = l0
	if l0 == int32(0) {
		v14 = int64(0)
...
func F_pgl_shmat(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v13 int32
	_ = v13
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1128]))
	if v5 != 0 {
		goto L1
	} else {
		goto L2
