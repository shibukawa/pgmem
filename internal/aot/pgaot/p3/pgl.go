...
func F_pgl_getpwuid(m *base.Module, l0 int32) int32 {
	...
	var v18 int32
	_ = v18
	*(*int32)(unsafe.Add(mBase, _consts[1247])) = int32(4212290)
	*(*int32)(unsafe.Add(mBase, _consts[1248])) = int32(4212275)
	*(*int32)(unsafe.Add(mBase, _consts[1249])) = int32(4212263)
	*(*int32)(unsafe.Add(mBase, _consts[1250])) = l0
	*(*int32)(unsafe.Add(mBase, _consts[1251])) = l0
	*(*int32)(unsafe.Add(mBase, _consts[1252])) = int32(4212261)
	v18 = int32(4638392)
	*(*int32)(unsafe.Add(mBase, _consts[1253])) = int32(4212252)
	return v18
}
