...
func F_pgl_getpwuid(m *base.Module, l0 int32) int32 {
	...
	var v18 int32
	_ = v18
	*(*int32)(unsafe.Add(mBase, _consts[1239])) = int32(4207154)
	*(*int32)(unsafe.Add(mBase, _consts[1240])) = int32(4207139)
	*(*int32)(unsafe.Add(mBase, _consts[1241])) = int32(4207127)
	*(*int32)(unsafe.Add(mBase, _consts[1242])) = l0
	*(*int32)(unsafe.Add(mBase, _consts[1243])) = l0
	*(*int32)(unsafe.Add(mBase, _consts[1244])) = int32(4207125)
	v18 = int32(4633032)
	*(*int32)(unsafe.Add(mBase, _consts[1245])) = int32(4207116)
	return v18
}
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1238])) = int32(100)
...
func F_pgl_setPGliteActive(m *base.Module, l0 int32) int32 {
	...
	m.G0 = v6
	v8 = int32(4632848)
	v9 = *(*int32)(unsafe.Add(mBase, _consts[1237]))
...
func F_pgl_shmat(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v13 int32
	_ = v13
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1119]))
	if v5 != 0 {
		goto L1
	} else {
		goto L2
