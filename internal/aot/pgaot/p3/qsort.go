...
L3:
	;
	v75 = *(*int32)(unsafe.Add(mBase, _c_F_qsort_interruptible[0]))
	if v75 != 0 {
		goto L5
	} else {
		goto L6
...
L38:
	;
	v331 = *(*int32)(unsafe.Add(mBase, _c_F_qsort_interruptible[0]))
	if v331 != 0 {
		goto L40
	} else {
		goto L41
...
L82:
	;
	v747 = *(*int32)(unsafe.Add(mBase, _c_F_qsort_interruptible[0]))
	if v747 != 0 {
		goto L95
	} else {
		goto L96
...
L111:
	;
	v970 = *(*int32)(unsafe.Add(mBase, _c_F_qsort_interruptible[0]))
	if v970 != 0 {
		goto L124
	} else {
		goto L125
...
L3:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _c_F_qsort_tuple_int32[0]))
	if v59 != 0 {
		goto L5
	} else {
		goto L6
...
L44:
	;
	v203 = *(*int32)(unsafe.Add(mBase, _c_F_qsort_tuple_int32[0]))
	if v203 != 0 {
		goto L46
	} else {
		goto L47
...
L89:
	;
	v410 = *(*int32)(unsafe.Add(mBase, _c_F_qsort_tuple_int32[0]))
	if v410 != 0 {
		goto L111
	} else {
		goto L112
...
L122:
	;
	v508 = *(*int32)(unsafe.Add(mBase, _c_F_qsort_tuple_int32[0]))
	if v508 != 0 {
		goto L144
	} else {
		goto L145
