...
func F_JsonTableDestroyOpaque(m *base.Module, l0 int32) {
	...
	var v5 int32
	_ = v5
	v3 = F_GetJsonTableExecContext(m, l0, int32(362290))
	mBase = m.M
	v4 = m.ExcPending
	if v4 != 0 {
		return
...
func F_JsonTableGetValue(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	var v42 int32
	_ = v42
	v8 = F_GetJsonTableExecContext(m, l0, int32(364931))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_json_manifest_scalar(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	case 0:
		*(*int32)(unsafe.Add(mBase, uint32(l0)+56)) = l1
		...
		if v21 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = int32(236237)
			m.T0[v86].(func(*base.Module, int32, int32, int32))(m, v85, int32(210125), v6+int32(-32))
			mBase = m.M
			v93 = m.ExcPending
			if v93 != 0 {
				return int32(0)
			...
			if base.Ui32(v22-int32(3)) <= base.Ui32(int32(-3)) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = int32(284403)
				m.T0[v95].(func(*base.Module, int32, int32, int32))(m, v94, int32(210125), v6+int32(-48))
				mBase = m.M
				v102 = m.ExcPending
				if v102 != 0 {
					return int32(0)
	...
	case 1:
		*(*int32)(unsafe.Add(mBase, uint32(l0)+60)) = l1
		...
		if v42 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = int32(236137)
			m.T0[v104].(func(*base.Module, int32, int32, int32))(m, v103, int32(210125), v6+int32(-16))
			mBase = m.M
			v111 = m.ExcPending
			if v111 != 0 {
				return int32(0)
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(241514)
		m.T0[v68].(func(*base.Module, int32, int32, int32))(m, v67, int32(210125), v8)
		mBase = m.M
		v73 = m.ExcPending
		if v73 != 0 {
			return int32(0)
...
L25:
	...
	v104 = *(*int32)(unsafe.Add(mBase, uint32(v101)+uint32(_consts[1239])))
	if v104 == int32(0) {
		goto L24
	} else {
		goto L26
...
L26:
	;
	v109 = *(*int32)(unsafe.Add(mBase, uint32(v101)+uint32(_consts[1240])))
	if v109 != 0 {
		goto L28
	} else {
		goto L29
...
L118:
	;
	v341 = *(*int32)(unsafe.Add(mBase, uint32(v329<<(uint(int32(2))%32))+uint32(_consts[1241])))
	v433 = v341
	goto L1
L119:
	;
...
L132:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = int32(20879)
	m.T0[v440].(func(*base.Module, int32, int32, int32))(m, v24, int32(210125), v21)
	mBase = m.M
	v445 = m.ExcPending
	if v445 != 0 {
		goto L6
...
L134:
	...
	m.T0[v452].(func(*base.Module, int32, int32, int32))(m, v24, int32(83684), int32(0))
	mBase = m.M
	v454 = m.ExcPending
	if v454 != 0 {
		goto L6
...
L137:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v459)+32)) = int32(469321)
	m.T0[v830].(func(*base.Module, int32, int32, int32))(m, v461, int32(210125), v459+int32(32))
	mBase = m.M
	v837 = m.ExcPending
	if v837 != 0 {
		goto L6
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v459))) = int32(173094)
	m.T0[v824].(func(*base.Module, int32, int32, int32))(m, v461, int32(210125), v459)
	mBase = m.M
	v829 = m.ExcPending
	if v829 != 0 {
		goto L6
...
L172:
	...
	m.T0[v552].(func(*base.Module, int32, int32, int32))(m, v461, int32(14053), int32(0))
	mBase = m.M
	v554 = m.ExcPending
	if v554 != 0 {
		goto L6
...
L176:
	...
	m.T0[v560].(func(*base.Module, int32, int32, int32))(m, v461, int32(83642), int32(0))
	mBase = m.M
	v562 = m.ExcPending
	if v562 != 0 {
		goto L6
...
L178:
	...
	m.T0[v569].(func(*base.Module, int32, int32, int32))(m, v461, int32(83684), int32(0))
	mBase = m.M
	v571 = m.ExcPending
	if v571 != 0 {
		goto L6
...
L182:
	...
	m.T0[v580].(func(*base.Module, int32, int32, int32))(m, v461, int32(83602), int32(0))
	mBase = m.M
	v582 = m.ExcPending
	if v582 != 0 {
		goto L6
...
L186:
	...
	m.T0[v589].(func(*base.Module, int32, int32, int32))(m, v586, int32(300386), int32(0))
	mBase = m.M
	v591 = m.ExcPending
	if v591 != 0 {
		goto L6
...
L191:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v459)+16)) = v593
	m.T0[v704].(func(*base.Module, int32, int32, int32))(m, v461, int32(760654), v459+int32(16))
	mBase = m.M
	v710 = m.ExcPending
	if v710 != 0 {
		goto L6
...
L233:
	...
	m.T0[v798].(func(*base.Module, int32, int32, int32))(m, v461, int32(340887), int32(0))
	mBase = m.M
	v800 = m.ExcPending
	if v800 != 0 {
		goto L6
...
L240:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v859
	m.T0[v861].(func(*base.Module, int32, int32, int32))(m, v24, int32(210125), v21+int32(16))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		goto L6
...
func F_json_populate_record(m *base.Module, l0 int32) int32 {
	...
	_ = v9
	v3 = int32(1)
	v6 = F_populate_record_worker(m, l0, int32(441111), v3, v3, int32(0))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
L8:
	;
	F_appendStringInfoString(m, l0, int32(318184))
	mBase = m.M
	v723 = m.ExcPending
	if v723 != 0 {
		goto L1
...
L10:
	;
	F_appendStringInfoString(m, l0, int32(717034))
	mBase = m.M
	v691 = m.ExcPending
	if v691 != 0 {
		goto L1
...
L12:
	;
	F_appendStringInfoString(m, l0, int32(717049))
	mBase = m.M
	v655 = m.ExcPending
	if v655 != 0 {
		goto L1
...
L13:
	;
	F_appendStringInfoString(m, l0, int32(717164))
	mBase = m.M
	v637 = m.ExcPending
	if v637 != 0 {
		goto L1
...
L14:
	;
	F_appendStringInfoString(m, l0, int32(715783))
	mBase = m.M
	v634 = m.ExcPending
	if v634 != 0 {
		goto L1
...
L15:
	;
	F_appendStringInfoString(m, l0, int32(715486))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L1
...
L17:
	;
	F_appendStringInfoString(m, l0, int32(717143))
	mBase = m.M
	v594 = m.ExcPending
	if v594 != 0 {
		goto L1
...
L18:
	;
	F_appendStringInfoString(m, l0, int32(715846))
	mBase = m.M
	v591 = m.ExcPending
	if v591 != 0 {
		goto L1
...
L19:
	;
	F_appendStringInfoString(m, l0, int32(715677))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L1
...
L20:
	;
	F_appendStringInfoString(m, l0, int32(714816))
	mBase = m.M
	v585 = m.ExcPending
	if v585 != 0 {
		goto L1
...
L22:
	;
	F_appendStringInfoString(m, l0, int32(84065))
	mBase = m.M
	v487 = m.ExcPending
	if v487 != 0 {
		goto L1
...
L23:
	;
	F_appendStringInfoString(m, l0, int32(715812))
	mBase = m.M
	v484 = m.ExcPending
	if v484 != 0 {
		goto L1
...
L25:
	;
	F_appendStringInfoString(m, l0, int32(715939))
	mBase = m.M
	v463 = m.ExcPending
	if v463 != 0 {
		goto L1
...
L26:
	;
	F_appendStringInfoString(m, l0, int32(715793))
	mBase = m.M
	v460 = m.ExcPending
	if v460 != 0 {
		goto L1
...
L27:
	;
	F_appendStringInfoString(m, l0, int32(715318))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L1
...
L28:
	;
	F_appendStringInfoString(m, l0, int32(715102))
	mBase = m.M
	v454 = m.ExcPending
	if v454 != 0 {
		goto L1
...
L29:
	;
	F_appendStringInfoString(m, l0, int32(715804))
	mBase = m.M
	v451 = m.ExcPending
	if v451 != 0 {
		goto L1
...
L30:
	;
	F_appendStringInfoString(m, l0, int32(715890))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L1
...
L32:
	;
	F_appendStringInfoString(m, l0, int32(717490))
	mBase = m.M
	v412 = m.ExcPending
	if v412 != 0 {
		goto L1
...
L43:
	;
	F_appendStringInfoString(m, l0, int32(717526))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L1
...
L57:
	;
	F_appendStringInfoString(m, l0, int32(361949))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L1
...
L59:
	;
	F_appendStringInfoString(m, l0, int32(379468))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L67:
	;
	v70 = *(*int32)(unsafe.Add(mBase, uint32(v63<<(uint(int32(2))%32))+uint32(_consts[989])))
	v71 = v70
	goto L69
L68:
	;
...
L70:
	;
	v84 = *(*int32)(unsafe.Add(mBase, uint32(v77<<(uint(int32(2))%32))+uint32(_consts[989])))
	v85 = v84
	goto L72
L71:
	;
...
L79:
	;
	v116 = *(*int32)(unsafe.Add(mBase, uint32(v109<<(uint(int32(2))%32))+uint32(_consts[989])))
	v117 = v116
	goto L81
L80:
	;
...
L82:
	;
	v130 = *(*int32)(unsafe.Add(mBase, uint32(v123<<(uint(int32(2))%32))+uint32(_consts[989])))
	v131 = v130
	goto L84
L83:
	;
...
L94:
	;
	F_appendStringInfoString(m, l0, int32(256238))
	mBase = m.M
	v175 = m.ExcPending
	if v175 != 0 {
		goto L1
...
L105:
	;
	v205 = *(*int32)(unsafe.Add(mBase, uint32(v198<<(uint(int32(2))%32))+uint32(_consts[989])))
	v206 = v205
	goto L107
L106:
	;
...
L108:
	;
	v219 = *(*int32)(unsafe.Add(mBase, uint32(v212<<(uint(int32(2))%32))+uint32(_consts[989])))
	v220 = v219
	goto L110
L109:
	;
...
L128:
	;
	F_appendStringInfoString(m, l0, int32(773549))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L1
...
L157:
	;
	F_appendStringInfoString(m, l0, int32(700704))
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
		goto L1
...
L208:
	;
	v511 = *(*int32)(unsafe.Add(mBase, uint32(v504<<(uint(int32(2))%32))+uint32(_consts[989])))
	v512 = v511
	goto L210
L209:
	;
...
L212:
	;
	v524 = *(*int32)(unsafe.Add(mBase, uint32(v517<<(uint(int32(2))%32))+uint32(_consts[989])))
	v525 = v524
	goto L214
L213:
	;
...
L215:
	;
	F_appendStringInfoString(m, l0, int32(765641))
	mBase = m.M
	v531 = m.ExcPending
	if v531 != 0 {
		goto L1
...
L218:
	;
	F_appendStringInfoString(m, l0, int32(765217))
	mBase = m.M
	v539 = m.ExcPending
	if v539 != 0 {
		goto L1
...
L292:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v711
	F_errmsg_internal(m, int32(508307), v10)
	mBase = m.M
	v715 = m.ExcPending
	if v715 != 0 {
		goto L1
...
L293:
	;
	F_errfinish(m, int32(522796), int32(835), int32(305612))
	mBase = m.M
	v720 = m.ExcPending
	if v720 != 0 {
		goto L1
