									...
									if v131 != 0 {
										...
										if v134 != 0 {
											...
											if v140 != 0 {
												...
												F_errfinish(m, int32(524313), int32(176), int32(327640))
												mBase = m.M
												v147 = m.ExcPending
												if v147 != 0 {
													return int32(0)
											...
											if v151 != 0 {
												...
												if v154 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = v155 + int32(4)
													F_errmsg(m, int32(738895), v8+int32(16))
													mBase = m.M
													v166 = m.ExcPending
													if v166 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(524313), int32(182), int32(327640))
														mBase = m.M
														v173 = m.ExcPending
														if v173 != 0 {
															return int32(0)
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v32 + int32(4)
									...
									if v40 != 0 {
										...
										if v44 != 0 {
											...
											F_errfinish(m, int32(524313), int32(166), int32(327640))
											mBase = m.M
											v51 = m.ExcPending
											if v51 != 0 {
												return int32(0)
			...
			if v111 != 0 {
				...
				if v114 != 0 {
					...
					if v120 != 0 {
						...
						F_errfinish(m, int32(524313), int32(156), int32(327640))
						mBase = m.M
						v127 = m.ExcPending
						if v127 != 0 {
							return int32(0)
