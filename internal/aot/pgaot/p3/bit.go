					...
					if v78 != 0 {
						...
						if v81 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v82
							F_errmsg(m, int32(_a_F_bit_0), v9)
							mBase = m.M
							v87 = m.ExcPending
							if v87 != 0 {
								return int32(0)
			...
			if v17 == int32(0) {
				...
				if base.Ui32(v15-int32(9)) < base.Ui32(v26) {
					...
					for {
						...
						v43 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v40)+uint32(_c_F_bit_bit_count[0]))))
						v44 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v35)+2)))
						v47 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v44)+uint32(_c_F_bit_bit_count[0]))))
						v48 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v35)+1)))
						v51 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v48)+uint32(_c_F_bit_bit_count[0]))))
						v52 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v35))))
						v55 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v52)+uint32(_c_F_bit_bit_count[0]))))
				...
				if v27 != 0 {
					...
					for {
						...
						v79 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v76)+uint32(_c_F_bit_bit_count[0]))))
						v80 = v75 + v79
						v81 = int32(1)
						v84 = v72 + v81
						if v84 != v27 {
			...
			if v178 == int32(0) {
				...
				if v187 == int32(0) {
					...
					for {
						...
						v203 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v200)+uint32(_c_F_bit_bit_count[0]))))
						v204 = v197 + v203
						v206 = v194 + v198
						v208 = v195 + v198
						if v208 != v187 {
				...
				if base.Ui32(v178) < base.Ui32(int32(4)) {
					...
					for {
						...
						v229 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v226)+uint32(_c_F_bit_bit_count[0]))))
						v230 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v219)+2)))
						v233 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v230)+uint32(_c_F_bit_bit_count[0]))))
						v234 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v219)+1)))
						v237 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v234)+uint32(_c_F_bit_bit_count[0]))))
						v238 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v219))))
						v241 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v238)+uint32(_c_F_bit_bit_count[0]))))
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = int32(2147483640)
	F_errmsg(m, int32(_a_F_bit_in_0), v9+int32(-16))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L46
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v171
	F_errmsg(m, int32(_a_F_bit_in_3), v9+int32(-32))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L46
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v261
	F_errmsg(m, int32(_a_F_bit_in_4), v9+int32(-48))
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L46
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v320
	F_errmsg(m, int32(_a_F_bit_in_5), v11)
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L46
