						...
						if v81 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v82
							...
							if v87 != 0 {
								...
								F_errfinish(m, int32(512333), int32(407), int32(109687))
								mBase = m.M
								v92 = m.ExcPending
								if v92 != 0 {
									return int32(0)
			...
			if v17 == int32(0) {
				...
				if base.Ui32(v15-int32(9)) < base.Ui32(v26) {
					...
					for {
						...
						v43 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v40)+uint32(_consts[1055]))))
						v44 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v35)+2)))
						v47 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1055]))))
						v48 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v35)+1)))
						v51 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v48)+uint32(_consts[1055]))))
						v52 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v35))))
						v55 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v52)+uint32(_consts[1055]))))
				...
				if v27 != 0 {
					...
					for {
						...
						v79 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v76)+uint32(_consts[1055]))))
						v80 = v75 + v79
						v81 = int32(1)
						v84 = v72 + v81
						if v84 != v27 {
			...
			if v178 == int32(0) {
				...
				if v187 == int32(0) {
					...
					for {
						...
						v203 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v200)+uint32(_consts[1055]))))
						v204 = v197 + v203
						v206 = v194 + v198
						v208 = v195 + v198
						if v208 != v187 {
				...
				if base.Ui32(v178) < base.Ui32(int32(4)) {
					...
					for {
						...
						v229 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v226)+uint32(_consts[1055]))))
						...
						v237 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v234)+uint32(_consts[1055]))))
						v238 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v219))))
						v241 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v238)+uint32(_consts[1055]))))
...
L16:
	;
	F_errsave_finish(m, v14, int32(512333), int32(199), int32(290061))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L12
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v59
	F_errmsg(m, int32(703821), v9+int32(-32))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L12
...
L30:
	;
	F_errsave_finish(m, v14, int32(512333), int32(213), int32(290061))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L12
...
L49:
	;
	F_errsave_finish(m, v14, int32(512333), int32(260), int32(290061))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L12
...
L65:
	;
	F_errsave_finish(m, v14, int32(512333), int32(235), int32(290061))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L12
