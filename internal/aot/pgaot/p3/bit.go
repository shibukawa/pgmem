					...
					if v78 != 0 {
						...
						if v81 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v82
							F_errmsg(m, int32(678784), v9)
							mBase = m.M
							v87 = m.ExcPending
							if v87 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(493514), int32(407), int32(103616))
								mBase = m.M
								v92 = m.ExcPending
								if v92 != 0 {
									return int32(0)
...
L16:
	;
	F_errsave_finish(m, v14, int32(493514), int32(199), int32(279361))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L12
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v59
	F_errmsg(m, int32(678784), v9+int32(-32))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L12
...
L30:
	;
	F_errsave_finish(m, v14, int32(493514), int32(213), int32(279361))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L12
...
L49:
	;
	F_errsave_finish(m, v14, int32(493514), int32(260), int32(279361))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L12
...
L65:
	;
	F_errsave_finish(m, v14, int32(493514), int32(235), int32(279361))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L12
