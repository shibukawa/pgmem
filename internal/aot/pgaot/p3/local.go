...
func F_local_buffer_write_error_callback(m *base.Module, l0 int32) {
	...
	if l0 != 0 {
		...
		if v10 != 0 {
			...
			v18 = *(*int32)(unsafe.Add(mBase, _consts[109]))
...
L15:
	;
	v61 = *(*int64)(unsafe.Add(mBase, _consts[187]))
	goto L12
L16:
	;
	return int32(0)
...
func F_update_local_synced_slot(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	v12 = v10 - int32(144)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[673]))
	if l2 != 0 {
		goto L1
	} else {
		goto L2
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v51
	F_errmsg(m, int32(682360), v12+int32(32))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L21
...
L26:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v12))) = uint32(v70)
	F_errdetail(m, int32(561929), v12)
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L21
...
L27:
	;
	F_errfinish(m, int32(499316), int32(220), int32(85009))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L21
...
L31:
	...
	m.G0 = v114
	*(*int32)(unsafe.Add(mBase, uint32(v114)+16)) = int32(118870)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v114)+20)) = uint32(v120)
	v127 = F_pg_sprintf(m, v114+int32(128), int32(237853), v114+int32(16))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L21
...
L48:
	;
	F_errfinish(m, int32(499077), int32(2073), int32(117357))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L21
...
L53:
	;
	F_s_lock(m, v15, int32(499316), int32(259), int32(85009))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L21
...
L77:
	;
	F_s_lock(m, v15, int32(499316), int32(297), int32(85009))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L21
...
L87:
	;
	F_s_lock(m, v15, int32(499316), int32(333), int32(85009))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L21
...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v322
	F_errmsg_internal(m, int32(85789), v12-int32(-64))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L21
...
L94:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v12)+48)) = uint32(v337)
	F_errdetail_internal(m, int32(641193), v12+int32(48))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L21
...
L95:
	;
	F_errfinish(m, int32(499316), int32(280), int32(85009))
	mBase = m.M
	v348 = m.ExcPending
	if v348 != 0 {
		goto L21
