...
func F_local_buffer_write_error_callback(m *base.Module, l0 int32) {
	...
	if l0 != 0 {
		...
		if v10 != 0 {
			...
			v18 = *(*int32)(unsafe.Add(mBase, _c_F_local_buffer_write_error_callback[0]))
			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v6 + int32(8)
				F_errcontext_msg(m, int32(_a_F_local_buffer_write_error_callback_0), v6)
				mBase = m.M
				v28 = m.ExcPending
				if v28 != 0 {
					return
...
func F_update_local_synced_slot(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	v12 = v10 - int32(144)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_update_local_synced_slot[0]))
	if l2 != 0 {
		goto L1
	} else {
		goto L2
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v51
	F_errmsg(m, int32(_a_F_update_local_synced_slot_0), v12+int32(32))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L21
...
L26:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v12))) = uint32(v70)
	F_errdetail(m, int32(_a_F_update_local_synced_slot_1), v12)
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L21
...
L31:
	...
	m.G0 = v114
	*(*int32)(unsafe.Add(mBase, uint32(v114)+16)) = int32(_a_F_update_local_synced_slot_4)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v114)+20)) = uint32(v120)
	v127 = F_pg_sprintf(m, v114+int32(128), int32(_a_F_update_local_synced_slot_5), v114+int32(16))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L21
...
L44:
	;
	v139 = *(*int32)(unsafe.Add(mBase, _c_F_update_local_synced_slot[1]))
	if v139 == int32(44) {
		goto L42
	} else {
		goto L45
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v114))) = v114 + int32(128)
	F_errmsg(m, int32(_a_F_update_local_synced_slot_6), v114)
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L21
...
L53:
	;
	F_s_lock(m, v15, int32(_a_F_update_local_synced_slot_2), int32(259), int32(_a_F_update_local_synced_slot_3))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L21
...
L77:
	;
	F_s_lock(m, v15, int32(_a_F_update_local_synced_slot_2), int32(297), int32(_a_F_update_local_synced_slot_3))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L21
...
L87:
	;
	F_s_lock(m, v15, int32(_a_F_update_local_synced_slot_2), int32(333), int32(_a_F_update_local_synced_slot_3))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L21
...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v322
	F_errmsg_internal(m, int32(_a_F_update_local_synced_slot_9), v12-int32(-64))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L21
...
L94:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v12)+48)) = uint32(v337)
	F_errdetail_internal(m, int32(_a_F_update_local_synced_slot_10), v12+int32(48))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L21
