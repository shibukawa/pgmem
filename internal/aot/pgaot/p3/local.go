...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v51
	F_errmsg(m, int32(697812), v12+int32(32))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L21
...
L26:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v12))) = uint32(v70)
	F_errdetail(m, int32(577322), v12)
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L21
...
L27:
	;
	F_errfinish(m, int32(499644), int32(220), int32(85072))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L21
...
L31:
	...
	m.G0 = v114
	*(*int32)(unsafe.Add(mBase, uint32(v114)+16)) = int32(118960)
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v114)+20)) = uint32(v120)
	v127 = F_pg_sprintf(m, v114+int32(128), int32(237943), v114+int32(16))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L21
...
L48:
	;
	F_errfinish(m, int32(499405), int32(2073), int32(117447))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L21
...
L53:
	;
	F_s_lock(m, v15, int32(499644), int32(259), int32(85072))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L21
...
L77:
	;
	F_s_lock(m, v15, int32(499644), int32(297), int32(85072))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L21
...
L87:
	;
	F_s_lock(m, v15, int32(499644), int32(333), int32(85072))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L21
...
L94:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v12)+48)) = uint32(v337)
	F_errdetail_internal(m, int32(656630), v12+int32(48))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L21
...
L95:
	;
	F_errfinish(m, int32(499644), int32(280), int32(85072))
	mBase = m.M
	v348 = m.ExcPending
	if v348 != 0 {
		goto L21
