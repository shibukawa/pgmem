...
func F__PG_init_plpgsql(m *base.Module) {
	...
	if v4 == int32(0) {
		...
		if v15 != 0 {
			...
			F_DefineCustomBoolVariable(m, int32(_a_F__PG_init_plpgsql_4), int32(_a_F__PG_init_plpgsql_5), int32(_a_F__PG_init_plpgsql_6), int32(0), int32(6))
			mBase = m.M
			v22 = m.ExcPending
			if v22 != 0 {
				return
			} else {
				F_DefineCustomBoolVariable(m, int32(_a_F__PG_init_plpgsql_7), int32(_a_F__PG_init_plpgsql_8), int32(_a_F__PG_init_plpgsql_9), int32(1), int32(6))
				mBase = m.M
				v29 = m.ExcPending
				if v29 != 0 {
					return
					...
					if v37 != 0 {
						...
						if v45 != 0 {
							...
							if v48 != 0 {
								...
								v50 = *(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[1]))
								...
								if v53 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v52)+4)) = int32(_a_F__PG_init_plpgsql_21)
									v58 = int32(_a_F__PG_init_plpgsql_22)
									v59 = *(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[2]))
									*(*int32)(unsafe.Add(mBase, uint32(v52))) = v59
									*(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[2])) = v52
									v64 = *(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[1]))
									...
									if v67 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v66)+4)) = int32(_a_F__PG_init_plpgsql_23)
										v72 = int32(_a_F__PG_init_plpgsql_24)
										v73 = *(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[3]))
										*(*int32)(unsafe.Add(mBase, uint32(v66))) = v73
										*(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[3])) = v66
										v77 = m.G0
										v79 = v77 - int32(48)
										m.G0 = v79
										v82 = *(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[4]))
										if v82 == v68 {
											*(*int64)(unsafe.Add(mBase, uint32(v79)+16)) = int64(292057776192)
											v91 = F_hash_create(m, int32(_a_F__PG_init_plpgsql_25), int32(16), v79, int32(24))
											mBase = m.M
											v92 = m.ExcPending
											if v92 != 0 {
												return
											} else {
												*(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[4])) = v91
												v94 = v91
												v97 = F_hash_search(m, v94, int32(_a_F__PG_init_plpgsql_26), int32(1), v79)
												mBase = m.M
												v98 = m.ExcPending
												if v98 != 0 {
													return
													...
													m.G0 = v79 + int32(48)
													v110 = int32(1)
													*(*uint8)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[0])) = uint8(v110)
													*(*int32)(unsafe.Add(mBase, _c_F__PG_init_plpgsql[5])) = v97 - int32(-64)
													return
												}
											}
										} else {
...
L56:
	;
	v347 = F_ReadDir(m, v178, int32(_a_F_do_pg_backup_stop_6))
	mBase = m.M
	v348 = m.ExcPending
	if v348 != 0 {
		goto L13
...
L57:
	;
	v198 = int32(_a_F_do_pg_backup_stop_7)
	v202 = m.G0
	v204 = v202 - int32(32)
	v205 = int64(0)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v204))) = v205
	v213 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[7])))
	if v213 == int32(0) {
		goto L59
	} else {
		goto L60
...
L61:
	;
	v217 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[8])))
	if v217 == int32(0) {
		goto L62
	} else {
		goto L63
...
L79:
	...
	v287 = int32(_a_F_do_pg_backup_stop_8)
	v290 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[9])))
...
L94:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+64)) = v194
	v339 = F_pg_snprintf(m, v13+int32(1232), int32(1031), int32(_a_F_do_pg_backup_stop_10), v13-int32(-64))
	mBase = m.M
	v340 = m.ExcPending
	if v340 != 0 {
		goto L13
...
L103:
	;
	v374 = *(*int32)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[10]))
	if v26 != 0 {
		goto L105
	} else {
		goto L106
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v383
	v388 = int64(*(*int32)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[6])))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v13)+40)) = uint32(v395)
	v403 = F_pg_snprintf(m, v13+int32(1232), int32(64), int32(_a_F_do_pg_backup_stop_13), v13+int32(32))
	mBase = m.M
	v404 = m.ExcPending
	if v404 != 0 {
		goto L13
...
L111:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v406
	v410 = *(*int32)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[6]))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v13)+24)) = uint32(v422)
	v430 = F_pg_snprintf(m, v13+int32(144), int32(64), int32(_a_F_do_pg_backup_stop_14), v13+int32(16))
	mBase = m.M
	v431 = m.ExcPending
	if v431 != 0 {
		goto L13
...
L119:
	;
	v458 = *(*int32)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[11]))
	if v458 != 0 {
		goto L122
	} else {
		goto L123
...
L126:
	;
	v484 = *(*int32)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[12]))
...
L132:
	;
	v491 = *(*int32)(unsafe.Add(mBase, _c_F_do_pg_backup_stop[12]))
...
L141:
	;
	v538 = int32(_a_F_do_pg_backup_stop_20)
	v544 = int32(_a_F_do_pg_backup_stop_21)
	goto L104
L142:
	;
	if v528 == int32(0) {
...
L143:
	...
	v544 = int32(_a_F_do_pg_backup_stop_23)
	goto L104
L144:
	;
	F_errfinish(m, int32(_a_F_do_pg_backup_stop_0), v544, int32(_a_F_do_pg_backup_stop_2))
	mBase = m.M
	v551 = m.ExcPending
	if v551 != 0 {
		goto L13
...
L4:
	;
	v16 = int32(_a_F_pg_buffercache_pages_0)
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_pg_buffercache_pages[0])) = v22
...
L11:
	;
	F_TupleDescInitEntry(m, v40, int32(1), int32(_a_F_pg_buffercache_pages_1), int32(23), int32(-1), int32(0))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L5
...
L12:
	;
	F_TupleDescInitEntry(m, v40, int32(2), int32(_a_F_pg_buffercache_pages_2), int32(26), int32(-1), int32(0))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L5
...
L13:
	;
	F_TupleDescInitEntry(m, v40, int32(3), int32(_a_F_pg_buffercache_pages_3), int32(26), int32(-1), int32(0))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L5
...
L14:
	;
	F_TupleDescInitEntry(m, v40, int32(4), int32(_a_F_pg_buffercache_pages_4), int32(26), int32(-1), int32(0))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L5
...
L15:
	;
	F_TupleDescInitEntry(m, v40, int32(5), int32(_a_F_pg_buffercache_pages_5), int32(21), int32(-1), int32(0))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L5
...
L16:
	;
	F_TupleDescInitEntry(m, v40, int32(6), int32(_a_F_pg_buffercache_pages_6), int32(20), int32(-1), int32(0))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L5
...
L17:
	;
	F_TupleDescInitEntry(m, v40, int32(7), int32(_a_F_pg_buffercache_pages_7), int32(16), int32(-1), int32(0))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L5
...
L18:
	;
	F_TupleDescInitEntry(m, v40, int32(8), int32(_a_F_pg_buffercache_pages_8), int32(21), int32(-1), int32(0))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L5
...
L20:
	;
	F_TupleDescInitEntry(m, v40, int32(9), int32(_a_F_pg_buffercache_pages_9), int32(23), int32(-1), int32(0))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L5
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25))) = v117
	v120 = int32(_a_F_pg_buffercache_pages_0)
	v121 = *(*int32)(unsafe.Add(mBase, _c_F_pg_buffercache_pages[0]))
	v122 = int32(_a_F_pg_buffercache_pages_10)
	v123 = *(*int32)(unsafe.Add(mBase, _c_F_pg_buffercache_pages[1]))
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+4)) = v126
	v129 = int64(*(*int32)(unsafe.Add(mBase, _c_F_pg_buffercache_pages[1])))
...
L27:
	;
	v145 = *(*int32)(unsafe.Add(mBase, _c_F_pg_buffercache_pages[2]))
	if v145 != 0 {
		goto L29
	} else {
		goto L30
...
L31:
	;
	v149 = *(*int32)(unsafe.Add(mBase, _c_F_pg_buffercache_pages[3]))
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v158)+28)) = v153 & int32(_a_F_pg_buffercache_pages_11)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v152)+24)) = v153 & int32(-4194305)
	v195 = v140 + v160
	v197 = *(*int32)(unsafe.Add(mBase, _c_F_pg_buffercache_pages[1]))
	if v195 < v197 {
		v140 = v195
		goto L27
	} else {
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v25
	v40 = F_pg_snprintf(m, v30, v16-v24, int32(_a_F_pg_clean_ascii_0), v10)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
...
L42:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12))) = v174*v165 + v164
	v182 = F_pg_snprintf(m, v12+int32(48), int32(256), int32(_a_F_pg_split_walfile_name_2), v12)
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L20:
	;
	v91 = *(*int32)(unsafe.Add(mBase, _c_F_pg_strtitle[0]))
	v92 = *(*int32)(unsafe.Add(mBase, uint32(v91)+4))
	v97 = *(*int32)(unsafe.Add(mBase, uint32(v92*int32(28))+uint32(_c_F_pg_strtitle[1])))
	goto L34
L21:
	;
	if v50 != 0 {
...
L40:
	...
	v287 = *(*int32)(unsafe.Add(mBase, _c_F_pg_strtitle[2]))
	if v284 != 0 {
		goto L85
	} else {
		goto L86
...
L87:
	;
	if v287 == int32(_a_F_pg_strtitle_0) {
		goto L91
	} else {
		goto L92
	}
...
L90:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pg_strtitle[2])) = v292
	goto L87
L91:
	;
	v297 = int32(-1)
...
L143:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pg_strtitle[2])) = v482
	goto L140
L144:
	;
	goto L146
...
L31:
	...
	v271 = *(*int32)(unsafe.Add(mBase, _c_F_pg_strupper[2]))
	if v268 != 0 {
		goto L76
	} else {
		goto L77
...
L78:
	;
	if v271 == int32(_a_F_pg_strupper_0) {
		goto L82
	} else {
		goto L83
	}
...
L81:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pg_strupper[2])) = v276
	goto L78
L82:
	;
	v281 = int32(-1)
...
L134:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pg_strupper[2])) = v466
	goto L131
L135:
	;
	goto L137
