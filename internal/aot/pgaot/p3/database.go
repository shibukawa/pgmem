...
func F_SetDatabaseHasLoginEventTriggers(m *base.Module) {
	...
	if v12 != 0 {
		...
		v15 = *(*int32)(unsafe.Add(mBase, _c_F_SetDatabaseHasLoginEventTriggers[0]))
				...
				if v22 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = v26
					...
					if v58 != 0 {
						...
						v60 = *(*int32)(unsafe.Add(mBase, _c_F_SetDatabaseHasLoginEventTriggers[0]))
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v60
						F_errmsg_internal(m, int32(_a_F_SetDatabaseHasLoginEventTriggers_0), v7)
						mBase = m.M
						v64 = m.ExcPending
						if v64 != 0 {
							return
