...
func F_InvalidateConstraintCacheCallBack(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(0) {
		...
		if v5 == int32(4502264) {
			...
			v12 = *(*int32)(unsafe.Add(mBase, _consts[1039]))
			...
			for {
				...
				if v15 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, _consts[1039])) = v40 - int32(1)
				} else {
...
L15:
	;
	v128 = int32(*(*uint8)(unsafe.Add(mBase, _consts[709])))
	if v128 != 0 {
		v551 = v92
		v557 = v98
		v562 = v103
...
L27:
	;
	F_s_lock(m, v122, int32(493435), int32(1875), int32(86286))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L3
...
L61:
	;
	v257 = *(*int32)(unsafe.Add(mBase, _consts[710]))
	if v257 == int32(0) {
		goto L34
	} else {
		goto L62
...
L71:
	;
	v281 = *(*int32)(unsafe.Add(mBase, _consts[710]))
...
L82:
	;
	*(*int32)(unsafe.Add(mBase, _consts[673])) = v122
...
L104:
	;
	v440 = *(*int32)(unsafe.Add(mBase, _consts[673]))
...
L105:
	;
	F_s_lock(m, v440, int32(493435), int32(1107), int32(8422))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L3
...
L107:
	;
	v449 = int32(4425956)
	v450 = *(*int32)(unsafe.Add(mBase, _consts[673]))
	v451 = int32(257)
	*(*uint16)(unsafe.Add(mBase, uint32(v450)+12)) = uint16(v451)
	*(*int32)(unsafe.Add(mBase, uint32(v440))) = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = int32(84710)
	v458 = *(*int32)(unsafe.Add(mBase, _consts[673]))
	*(*int32)(unsafe.Add(mBase, uint32(v31)+68)) = v458 + int32(24)
	v467 = F_pg_sprintf(m, v31+int32(208), int32(177111), v31-int32(-64))
	mBase = m.M
	v468 = m.ExcPending
	if v468 != 0 {
		goto L3
...
L109:
	;
	v470 = *(*int32)(unsafe.Add(mBase, _consts[673]))
...
L11:
	;
	F_errfinish(m, int32(495711), int32(1051), int32(319746))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
...
func F_InvalidateOprProofCacheCallBack(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v11 = *(*int32)(unsafe.Add(mBase, _consts[612]))
	F_hash_seq_init(m, v6+int32(12), v11)
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
