...
L27:
	;
	F_s_lock(m, v122, int32(489948), int32(1875), int32(85890))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L3
...
L105:
	;
	F_s_lock(m, v440, int32(489948), int32(1107), int32(8422))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L3
...
L11:
	;
	F_errfinish(m, int32(492185), int32(1051), int32(317629))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
