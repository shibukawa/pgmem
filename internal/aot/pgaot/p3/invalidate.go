...
func F_InvalidateConstraintCacheCallBack(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(0) {
		...
		if v5 == int32(_a_F_InvalidateConstraintCacheCallBack_0) {
		} else {
			v12 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateConstraintCacheCallBack[1]))
			...
			for {
				...
				if v15 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v19))) = v36
					v38 = int32(_a_F_InvalidateConstraintCacheCallBack_1)
					v40 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateConstraintCacheCallBack[1]))
					*(*int32)(unsafe.Add(mBase, _c_F_InvalidateConstraintCacheCallBack[1])) = v40 - int32(1)
				} else {
				...
				if v19 != int32(_a_F_InvalidateConstraintCacheCallBack_0) {
					v16 = v19
					continue
				} else {
					break
...
func F_InvalidateObsoleteReplicationSlots(m *base.Module, l0 int32, l1 int64, l2 int32, l3 int32) int32 {
	...
	v31 = v29 - int32(1232)
	m.G0 = v31
	v34 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[0]))
	if v34 == v5 {
		v638 = v5
		goto L1
	} else {
...
L2:
	;
	v38 = int64(*(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[1])))
	v40 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
...
L4:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[0]))
	if int32(0) < v49 {
		goto L5
	} else {
		goto L6
...
L7:
	;
	v628 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
	F_LWLockRelease(m, v628+int32(_a_F_InvalidateObsoleteReplicationSlots_0))
	mBase = m.M
	v632 = m.ExcPending
	if v632 != 0 {
		goto L3
...
L8:
	;
	v90 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[3]))
	v92 = v90
	v98 = v67
	v101 = int32(0)
	v103 = v72
...
L9:
	;
	v612 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
	F_LWLockRelease(m, v612+int32(_a_F_InvalidateObsoleteReplicationSlots_0))
	mBase = m.M
	v616 = m.ExcPending
	if v616 != 0 {
		goto L3
...
L15:
	;
	v128 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[4])))
	if v128 != 0 {
		v551 = v92
		v557 = v98
		v562 = v103
...
L20:
	;
	v541 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
	v545 = F_LWLockAcquire(m, v541+int32(_a_F_InvalidateObsoleteReplicationSlots_0), int32(1))
	mBase = m.M
	v546 = m.ExcPending
	if v546 != 0 {
		goto L3
...
L22:
	;
	v518 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
	F_LWLockRelease(m, v518+int32(_a_F_InvalidateObsoleteReplicationSlots_0))
	mBase = m.M
	v522 = m.ExcPending
	if v522 != 0 {
		goto L3
...
L27:
	;
	F_s_lock(m, v122, int32(_a_F_InvalidateObsoleteReplicationSlots_1), int32(1875), int32(_a_F_InvalidateObsoleteReplicationSlots_2))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L3
...
L61:
	;
	v257 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[5]))
	if v257 == int32(0) {
		goto L34
	} else {
		goto L62
...
L64:
	;
	v268 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[6])))
	if v268 == int32(1) {
		goto L66
	} else {
		goto L67
...
L66:
	;
	v273 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[7]))
	v274 = *(*int32)(unsafe.Add(mBase, uint32(v273)+316))
	v276 = base.B2i32(v274 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[6])) = uint8(v276)
	v278 = v276
	goto L68
L67:
	;
...
L71:
	;
	v281 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[5]))
...
L77:
	;
	v305 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[0]))
	v307 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[3]))
	v551 = v307
	v557 = v305
	v562 = v152
	goto L13
...
L79:
	;
	v309 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
	F_LWLockRelease(m, v309+int32(_a_F_InvalidateObsoleteReplicationSlots_0))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L3
...
L82:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[8])) = v122
	v359 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[9]))
...
L97:
	;
	v434 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
	F_LWLockRelease(m, v434+int32(_a_F_InvalidateObsoleteReplicationSlots_0))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L3
...
L98:
	;
	v397 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
	F_LWLockRelease(m, v397+int32(_a_F_InvalidateObsoleteReplicationSlots_0))
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L3
...
L101:
	;
	v426 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[10]))
	if v426 != int32(13) {
		goto L94
	} else {
		goto L102
...
L105:
	;
	F_s_lock(m, v440, int32(_a_F_InvalidateObsoleteReplicationSlots_1), int32(1107), int32(_a_F_InvalidateObsoleteReplicationSlots_3))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L3
...
L107:
	;
	v449 = int32(_a_F_InvalidateObsoleteReplicationSlots_4)
	v450 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[8]))
	v451 = int32(257)
	*(*uint16)(unsafe.Add(mBase, uint32(v450)+12)) = uint16(v451)
	*(*int32)(unsafe.Add(mBase, uint32(v440))) = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = int32(_a_F_InvalidateObsoleteReplicationSlots_5)
	v458 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[8]))
	*(*int32)(unsafe.Add(mBase, uint32(v31)+68)) = v458 + int32(24)
	v467 = F_pg_sprintf(m, v31+int32(208), int32(_a_F_InvalidateObsoleteReplicationSlots_6), v31-int32(-64))
	mBase = m.M
	v468 = m.ExcPending
	if v468 != 0 {
		goto L3
...
L109:
	;
	v470 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[8]))
...
L114:
	;
	v506 = int32(1)
	v508 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[2]))
	v512 = F_LWLockAcquire(m, v508+int32(_a_F_InvalidateObsoleteReplicationSlots_0), v506)
	mBase = m.M
	v513 = m.ExcPending
	if v513 != 0 {
		goto L3
...
L118:
	;
	v548 = *(*int32)(unsafe.Add(mBase, _c_F_InvalidateObsoleteReplicationSlots[0]))
	if int32(0) < v548 {
		v67 = v548
		v72 = v529
		goto L8
