...
L27:
	;
	F_s_lock(m, v122, int32(473983), int32(1875), int32(82599))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L3
...
L105:
	;
	F_s_lock(m, v440, int32(473983), int32(1107), int32(8157))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L3
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = int32(81023)
	v458 = *(*int32)(unsafe.Add(mBase, _consts[664]))
	*(*int32)(unsafe.Add(mBase, uint32(v31)+68)) = v458 + int32(24)
	v467 = F_pg_sprintf(m, v31+int32(208), int32(168545), v31-int32(-64))
	mBase = m.M
	v468 = m.ExcPending
	if v468 != 0 {
		goto L3
...
L11:
	;
	F_errfinish(m, int32(476193), int32(1051), int32(306630))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
