...
L27:
	;
	F_s_lock(m, v122, int32(492989), int32(1875), int32(86229))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L3
...
L105:
	;
	F_s_lock(m, v440, int32(492989), int32(1107), int32(8422))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L3
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = int32(84653)
	v458 = *(*int32)(unsafe.Add(mBase, _consts[673]))
	*(*int32)(unsafe.Add(mBase, uint32(v31)+68)) = v458 + int32(24)
	v467 = F_pg_sprintf(m, v31+int32(208), int32(177024), v31-int32(-64))
	mBase = m.M
	v468 = m.ExcPending
	if v468 != 0 {
		goto L3
...
L11:
	;
	F_errfinish(m, int32(495247), int32(1051), int32(319426))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
