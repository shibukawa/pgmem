...
L27:
	;
	F_s_lock(m, v122, int32(515427), int32(1875), int32(92513))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L3
...
L105:
	;
	F_s_lock(m, v440, int32(515427), int32(1107), int32(8439))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L3
...
L11:
	;
	F_errfinish(m, int32(518325), int32(1051), int32(334557))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
