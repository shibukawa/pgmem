...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v756 & int32(3)
	F_errmsg_internal(m, int32(484283), v23)
	mBase = m.M
	v762 = m.ExcPending
	if v762 != 0 {
		goto L6
...
L145:
	;
	F_errfinish(m, int32(497297), int32(911), int32(316211))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L6
...
L147:
	;
	F_errmsg_internal(m, int32(384270), int32(0))
	mBase = m.M
	v775 = m.ExcPending
	if v775 != 0 {
		goto L6
...
L148:
	;
	F_errfinish(m, int32(497297), int32(700), int32(77885))
	mBase = m.M
	v780 = m.ExcPending
	if v780 != 0 {
		goto L6
