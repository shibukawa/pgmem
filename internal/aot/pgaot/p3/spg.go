...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v756 & int32(3)
	F_errmsg_internal(m, int32(508200), v23)
	mBase = m.M
	v762 = m.ExcPending
	if v762 != 0 {
		goto L6
...
L145:
	;
	F_errfinish(m, int32(522864), int32(911), int32(332450))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L6
...
L147:
	;
	F_errmsg_internal(m, int32(403887), int32(0))
	mBase = m.M
	v775 = m.ExcPending
	if v775 != 0 {
		goto L6
...
L148:
	;
	F_errfinish(m, int32(522864), int32(700), int32(83979))
	mBase = m.M
	v780 = m.ExcPending
	if v780 != 0 {
		goto L6
...
func F_spg_identify(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v4) <= base.Ui32(int32(127)) {
		v13 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(v4)>>(uint(int32(2))%32))&int32(1073741820))+uint32(_consts[81])))
		v14 = v13
	} else {
		v14 = int32(0)
	}
