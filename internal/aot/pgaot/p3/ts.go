						...
						if l2&v29 != 0 {
							...
							if v35 != 0 {
								...
								if base.Ui32(v34) < base.Ui32(int32(3)) {
									v86 = *(*int32)(unsafe.Add(mBase, uint32(v34<<(uint(int32(2))%32))+uint32(_c_F_TS_execute_recurse[1])))
									v92 = v86
								} else {
									v92 = int32(0)
								}
...
func F_TS_phrase_execute(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = *(*int32)(unsafe.Add(mBase, _c_F_TS_phrase_execute[0]))
		if v18 != 0 {
			F_ProcessInterrupts(m)
			mBase = m.M
			v20 = m.ExcPending
					...
					default:
						...
						if v263 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v264
							F_errmsg_internal(m, int32(_a_F_TS_phrase_execute_0), v11)
							mBase = m.M
							v268 = m.ExcPending
							if v268 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(_a_F_TS_phrase_execute_1), int32(1837), int32(_a_F_TS_phrase_execute_2))
								mBase = m.M
								v273 = m.ExcPending
								if v273 != 0 {
									return int32(0)
							...
							if v52 != 0 {
								...
								if v54 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v51
									F_errmsg(m, int32(_a_F_get_ts_parser_func_0), v8)
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
...
func F_ts_rank_tt(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank(m, int32(_a_F_ts_rank_tt_0), v8, v14, int32(0))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
...
func F_ts_rank_ttf(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank(m, int32(_a_F_ts_rank_ttf_0), v8, v14, v15)
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
