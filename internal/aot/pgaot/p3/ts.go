							...
							if v48 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v50)+44)) = v51
								...
								if v62 != 0 {
									...
									v64 = F_SimpleLruDoesPhysicalPageExist(m, int32(4448740), v33)
									mBase = m.M
									v65 = m.ExcPending
									if v65 != 0 {
										return
						...
						if l2&v29 != 0 {
							...
							if v35 != 0 {
								...
								if base.Ui32(v34) < base.Ui32(int32(3)) {
									v86 = *(*int32)(unsafe.Add(mBase, uint32(v34<<(uint(int32(2))%32))+uint32(_consts[1067])))
									v92 = v86
								} else {
									v92 = int32(0)
								}
					...
					default:
						...
						if v71 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v72
							F_errmsg_internal(m, int32(503630), v10)
							mBase = m.M
							v76 = m.ExcPending
							if v76 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(518832), int32(1969), int32(377723))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return int32(0)
					...
					default:
						...
						if v263 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v264
							F_errmsg_internal(m, int32(503630), v11)
							mBase = m.M
							v268 = m.ExcPending
							if v268 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(518832), int32(1837), int32(365468))
								mBase = m.M
								v273 = m.ExcPending
								if v273 != 0 {
									return int32(0)
...
func F_error_commit_ts_disabled(m *base.Module) {
	...
	if v10 != 0 {
		...
		if v13 != 0 {
			...
			F_errmsg(m, int32(528913), int32(0))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(248153)
				if v30 != 0 {
					v35 = int32(634635)
				} else {
					v35 = int32(608596)
				...
				if v37 != 0 {
					...
					F_errfinish(m, int32(516100), int32(390), int32(475472))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return
							...
							if v52 != 0 {
								...
								if v54 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v51
									F_errmsg(m, int32(201803), v8)
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(517270), int32(126), int32(511509))
										mBase = m.M
										v64 = m.ExcPending
										if v64 != 0 {
											return int32(0)
...
func F_ts_rank_tt(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank(m, int32(1771824), v8, v14, int32(0))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
...
func F_ts_rank_ttf(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank(m, int32(1771824), v8, v14, v15)
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
