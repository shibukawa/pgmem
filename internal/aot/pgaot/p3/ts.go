							...
							if v48 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v50)+44)) = v51
								...
								if v62 != 0 {
									...
									v64 = F_SimpleLruDoesPhysicalPageExist(m, int32(4410100), v33)
									mBase = m.M
									v65 = m.ExcPending
									if v65 != 0 {
										return
					...
					default:
						...
						if v71 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v72
							F_errmsg_internal(m, int32(482161), v10)
							mBase = m.M
							v76 = m.ExcPending
							if v76 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(495929), int32(1969), int32(360652))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return int32(0)
					...
					default:
						...
						if v263 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v264
							F_errmsg_internal(m, int32(482161), v11)
							mBase = m.M
							v268 = m.ExcPending
							if v268 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(495929), int32(1837), int32(348817))
								mBase = m.M
								v273 = m.ExcPending
								if v273 != 0 {
									return int32(0)
...
func F_error_commit_ts_disabled(m *base.Module) {
	...
	if v10 != 0 {
		...
		if v13 != 0 {
			...
			F_errmsg(m, int32(504677), int32(0))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(236672)
				if v30 != 0 {
					v35 = int32(607841)
				} else {
					v35 = int32(581979)
				...
				if v37 != 0 {
					...
					F_errfinish(m, int32(493831), int32(390), int32(455033))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return
							...
							if v52 != 0 {
								...
								if v54 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v51
									F_errmsg(m, int32(191564), v8)
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(494580), int32(126), int32(490008))
										mBase = m.M
										v64 = m.ExcPending
										if v64 != 0 {
											return int32(0)
