							...
							if v48 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v50)+44)) = v51
								...
								if v62 != 0 {
									...
									v64 = F_SimpleLruDoesPhysicalPageExist(m, int32(4344132), v33)
									mBase = m.M
									v65 = m.ExcPending
									if v65 != 0 {
										return
					...
					default:
						...
						if v71 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v72
							F_errmsg_internal(m, int32(463555), v10)
							mBase = m.M
							v76 = m.ExcPending
							if v76 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(476666), int32(1969), int32(346215))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return int32(0)
					...
					default:
						...
						if v263 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v264
							F_errmsg_internal(m, int32(463555), v11)
							mBase = m.M
							v268 = m.ExcPending
							if v268 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(476666), int32(1837), int32(334641))
								mBase = m.M
								v273 = m.ExcPending
								if v273 != 0 {
									return int32(0)
...
func F_error_commit_ts_disabled(m *base.Module) {
	...
	if v10 != 0 {
		...
		if v13 != 0 {
			...
			F_errmsg(m, int32(485090), int32(0))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(226528)
				if v30 != 0 {
					v35 = int32(571152)
				} else {
					v35 = int32(545844)
				...
				if v37 != 0 {
					...
					F_errfinish(m, int32(474616), int32(390), int32(437434))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return
							...
							if v52 != 0 {
								...
								if v54 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v51
									F_errmsg(m, int32(182954), v8)
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(475355), int32(126), int32(471119))
										mBase = m.M
										v64 = m.ExcPending
										if v64 != 0 {
											return int32(0)
...
func F_ts_rank_tt(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank(m, int32(1702192), v8, v14, int32(0))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
...
func F_ts_rank_ttf(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank(m, int32(1702192), v8, v14, v15)
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
