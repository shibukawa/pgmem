...
func F_ActivateCommitTs(m *base.Module) {
	...
	if v7 == int32(0) {
		...
		v11 = *(*int32)(unsafe.Add(mBase, _consts[47]))
		...
		if v16 != 0 {
			...
			v18 = *(*int32)(unsafe.Add(mBase, _consts[88]))
			...
			if v25 != 0 {
				...
				if v19 != 0 {
					...
					v27 = *(*int32)(unsafe.Add(mBase, _consts[89]))
					v29 = *(*int32)(unsafe.Add(mBase, _consts[90]))
							...
							if v48 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v50)+44)) = v51
								...
								if v62 != 0 {
									...
									v64 = F_SimpleLruDoesPhysicalPageExist(m, int32(4456676), v33)
									mBase = m.M
									v65 = m.ExcPending
									if v65 != 0 {
										return
										...
										if v64 == int32(0) {
											v69 = *(*int32)(unsafe.Add(mBase, _consts[89]))
											v70 = *(*int32)(unsafe.Add(mBase, uint32(v69)+28))
											v72 = int32(*(*uint16)(unsafe.Add(mBase, _consts[91])))
												...
												if v83 != 0 {
													...
													if v85 != 0 {
														...
														if v87 != 0 {
															...
															v90 = *(*int32)(unsafe.Add(mBase, _consts[47]))
															...
															if v95 != 0 {
																...
																v97 = *(*int32)(unsafe.Add(mBase, _consts[88]))
																v98 = int32(1)
																*(*uint8)(unsafe.Add(mBase, uint32(v97)+24)) = uint8(v98)
																v101 = *(*int32)(unsafe.Add(mBase, _consts[47]))
					...
					default:
						...
						if v71 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v72
							F_errmsg_internal(m, int32(506337), v10)
							mBase = m.M
							v76 = m.ExcPending
							if v76 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(521589), int32(1969), int32(379718))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return int32(0)
						...
						if v263 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v264
							...
							if v268 != 0 {
								...
								F_errfinish(m, int32(521589), int32(1837), int32(367438))
								mBase = m.M
								v273 = m.ExcPending
								if v273 != 0 {
									return int32(0)
...
func F_error_commit_ts_disabled(m *base.Module) {
	...
	if v10 != 0 {
		...
		if v13 != 0 {
			...
			F_errmsg(m, int32(531720), int32(0))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(249276)
				if v30 != 0 {
					v35 = int32(638318)
				} else {
					v35 = int32(611719)
				...
				if v37 != 0 {
					...
					F_errfinish(m, int32(518857), int32(390), int32(477845))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return
							...
							if v52 != 0 {
								...
								if v54 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v51
									F_errmsg(m, int32(202721), v8)
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(520027), int32(126), int32(514230))
										mBase = m.M
										v64 = m.ExcPending
										if v64 != 0 {
											return int32(0)
...
func F_ts_headline_json(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		v10 = F_DirectFunctionCall3Coll(m, int32(1193), int32(0), v4, v8, v9)
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return int32(0)
...
func F_ts_headline_jsonb(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		v8 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
		v9 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
		v10 = F_DirectFunctionCall3Coll(m, int32(1192), int32(0), v4, v8, v9)
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return int32(0)
...
func F_ts_match_tq(m *base.Module, l0 int32) int32 {
	...
	v13 = F_DirectFunctionCall1Coll(m, int32(1544), v2, v12)
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		return int32(0)
		...
		if v18 != 0 {
			...
			v19 = F_DirectFunctionCall2Coll(m, int32(1542), v2, v17, v7)
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return int32(0)
...
func F_ts_rank_tt(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank(m, int32(1775920), v8, v14, int32(0))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
...
func F_ts_rank_ttf(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		v16 = F_calc_rank(m, int32(1775920), v8, v14, v15)
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
