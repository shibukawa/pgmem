							...
							if v48 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v50)+44)) = v51
								...
								if v62 != 0 {
									...
									v64 = F_SimpleLruDoesPhysicalPageExist(m, int32(4365012), v33)
									mBase = m.M
									v65 = m.ExcPending
									if v65 != 0 {
										return
					...
					default:
						...
						if v71 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v72
							F_errmsg_internal(m, int32(473515), v10)
							mBase = m.M
							v76 = m.ExcPending
							if v76 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(486901), int32(1969), int32(354227))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return int32(0)
					...
					default:
						...
						if v263 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v264
							F_errmsg_internal(m, int32(473515), v11)
							mBase = m.M
							v268 = m.ExcPending
							if v268 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(486901), int32(1837), int32(342542))
								mBase = m.M
								v273 = m.ExcPending
								if v273 != 0 {
									return int32(0)
...
func F_error_commit_ts_disabled(m *base.Module) {
	...
	if v10 != 0 {
		...
		if v13 != 0 {
			...
			F_errmsg(m, int32(495431), int32(0))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(232754)
				if v30 != 0 {
					v35 = int32(582285)
				} else {
					v35 = int32(556977)
				...
				if v37 != 0 {
					...
					F_errfinish(m, int32(484839), int32(390), int32(447086))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return
							...
							if v52 != 0 {
								...
								if v54 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v51
									F_errmsg(m, int32(188492), v8)
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(485578), int32(126), int32(481096))
										mBase = m.M
										v64 = m.ExcPending
										if v64 != 0 {
											return int32(0)
