...
func F_GetAttributeStorage(m *base.Module, l0 int32, l1 int32) int32 {
	...
	m.G0 = v7
	v12 = l1
	v13 = int32(_a_F_GetAttributeStorage_0)
	goto L5
L1:
	;
...
L19:
	;
	v57 = l1
	v58 = int32(_a_F_GetAttributeStorage_1)
	goto L22
L20:
	;
...
L36:
	;
	v102 = l1
	v103 = int32(_a_F_GetAttributeStorage_2)
	goto L38
L37:
	;
	if v140 == int32(0) {
...
L52:
	;
	v147 = l1
	v148 = int32(_a_F_GetAttributeStorage_3)
	goto L54
L53:
	;
	if v185 == int32(0) {
...
L68:
	;
	v192 = l1
	v193 = int32(_a_F_GetAttributeStorage_4)
	goto L70
L69:
	;
	if v230 != 0 {
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l1
	F_errmsg(m, int32(_a_F_GetAttributeStorage_5), v7+int32(16))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L83
...
L90:
	;
	F_errfinish(m, int32(_a_F_GetAttributeStorage_6), int32(_a_F_GetAttributeStorage_7), int32(_a_F_GetAttributeStorage_8))
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L83
...
L94:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v275
	F_errmsg(m, int32(_a_F_GetAttributeStorage_9), v7)
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L83
...
L95:
	;
	F_errfinish(m, int32(_a_F_GetAttributeStorage_6), int32(_a_F_GetAttributeStorage_10), int32(_a_F_GetAttributeStorage_8))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L83
