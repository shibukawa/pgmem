...
L7:
	;
	v12 = int32(0)
	v14 = F_afterTriggerMarkEvents(m, int32(4412468), v12, v12)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		goto L4
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, _consts[513])) = v18 + v19
	v25 = F_afterTriggerInvokeEvents(m, int32(4412468), v18, int32(0), v19)
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L4
...
L12:
	...
	v44 = F_AllocSetContextCreateInternal(m, v39, int32(120411), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L15
