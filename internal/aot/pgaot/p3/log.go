...
func F_assign_log_destination(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[1108])) = v4
	return
}
		...
		if v11 == int32(0) {
			...
			if v18 != 0 {
				...
				if v17 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, _consts[506])) = v22
					v25 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v25
					v29 = F_format_elog_string(m, int32(172559), v8)
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
					} else {
						*(*int32)(unsafe.Add(mBase, _consts[525])) = v29
						v33 = *(*int32)(unsafe.Add(mBase, _consts[40]))
						*(*int32)(unsafe.Add(mBase, _consts[506])) = v33
						v39 = F_format_elog_string(m, int32(602224), int32(0))
						mBase = m.M
						v40 = m.ExcPending
						if v40 != 0 {
							return int32(0)
						} else {
							*(*int32)(unsafe.Add(mBase, _consts[507])) = v39
							v51 = v4
							m.G0 = v8 + int32(16)
							return v51
						}
