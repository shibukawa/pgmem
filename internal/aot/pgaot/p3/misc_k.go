...
func F_KeepFileRestoredFromArchive(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l1
	v17 = F_pg_snprintf(m, v8+int32(1152), int32(1024), int32(188259), v8+int32(16))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L56:
	;
	F_s_lock(m, v181, int32(521307), int32(3596), int32(486593))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
...
L67:
	;
	F_errfinish(m, int32(524713), int32(400), int32(362635))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L1
...
func F_koi8r_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(22), int32(25), int32(2270768), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
