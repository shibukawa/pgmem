...
func F_KeepFileRestoredFromArchive(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l1
	v17 = F_pg_snprintf(m, v8+int32(1152), int32(1024), int32(188095), v8+int32(16))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L41:
	;
	v156 = *(*int32)(unsafe.Add(mBase, _consts[204]))
	if v156 != int32(2) {
		goto L43
	} else {
		goto L44
...
L48:
	;
	v165 = int32(0)
	v167 = *(*int32)(unsafe.Add(mBase, _consts[310]))
	if v165 < v167 {
		goto L51
	} else {
		goto L52
...
L54:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[363]))
...
L56:
	;
	F_s_lock(m, v181, int32(520866), int32(3596), int32(486152))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v181))) = int32(0)
	v198 = v173 + int32(1)
	v200 = *(*int32)(unsafe.Add(mBase, _consts[310]))
	if v198 < v200 {
		v173 = v198
		goto L54
	} else {
...
L67:
	;
	F_errfinish(m, int32(524267), int32(400), int32(362264))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L1
...
func F_KnownAssignedXidsCompress(m *base.Module, l0 int32, l1 int32) {
	...
	if v16 == v17 {
			...
			if l1 == int32(0) {
				...
				if v73 != 0 {
					...
					if v14 <= v15 {
						...
						v76 = int32(1)
						v79 = *(*int32)(unsafe.Add(mBase, _consts[845]))
						v81 = *(*int32)(unsafe.Add(mBase, _consts[846]))
						if v15+v76 != v14 {
							v88 = v74
							v90 = v15
							v93 = int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v184
					if l1 == v184 {
						v189 = *(*int32)(unsafe.Add(mBase, _consts[47]))
						...
						if v193 != 0 {
							...
							m.G0 = v200 + v199
							*(*int64)(unsafe.Add(mBase, _consts[847])) = v204 + v203*int64(1000000) - int64(946684800000000)
							return
						}
					} else {
						v198 = m.G0
		...
		if l0 == int32(2) {
			v23 = int32(4478848)
			v25 = *(*int32)(unsafe.Add(mBase, _consts[848]))
			v26 = int32(1)
			*(*int32)(unsafe.Add(mBase, _consts[848])) = v25 + v26
			...
			if l0 != int32(3) {
				...
				v39 = *(*int64)(unsafe.Add(mBase, _consts[847]))
				if v39 == int64(0) {
					if l1 == int32(0) {
						v68 = *(*int32)(unsafe.Add(mBase, _consts[47]))
						v72 = F_LWLockAcquire(m, v68+int32(512), int32(0))
...
func F_koi8r_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(22), int32(25), int32(2270736), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
