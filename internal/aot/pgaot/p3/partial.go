...
L24:
	;
	v119 = *(*int32)(unsafe.Add(mBase, _c_F_findPartialMatch[0]))
	if v119 != 0 {
		goto L26
	} else {
		goto L27
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_findPartialMatch[1])) = v135
	v264 = int32(1)
	goto L10
L26:
	;
...
L32:
	;
	v134 = int32(_a_F_findPartialMatch_0)
	v135 = *(*int32)(unsafe.Add(mBase, _c_F_findPartialMatch[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_findPartialMatch[1])) = v131
	if v103 < int32(0) {
		goto L33
	} else {
		goto L34
