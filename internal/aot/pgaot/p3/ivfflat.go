		...
		if v16 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v40+v41))) = v39
				...
				v70 = F___memset(m, v19, int32(0), int32(_a_F_IvfflatAppendPage_0))
				mBase = m.M
				*(*int32)(unsafe.Add(mBase, uint32(v19)+10)) = int32(_a_F_IvfflatAppendPage_1)
				v76 = int32(_a_F_IvfflatAppendPage_2)
				*(*uint16)(unsafe.Add(mBase, uint32(v19)+18)) = uint16(v76)
				v82 = int32(_a_F_IvfflatAppendPage_3)
				...
				*(*uint16)(unsafe.Add(mBase, uint32(v19)+14)) = uint16(v82)
				...
				v86 = v19 + v85
				v87 = int32(_a_F_IvfflatAppendPage_4)
										...
										if v114 != 0 {
											...
											if v113 != 0 {
												...
												*(*int64)(unsafe.Add(mBase, uint32(v14))) = v120
												if l5 != 0 {
													v124 = int32(_a_F_IvfflatParallelScanAndSort_3)
												} else {
													v124 = int32(_a_F_IvfflatParallelScanAndSort_4)
												}
												F_errmsg(m, v124, v14)
												mBase = m.M
												v126 = m.ExcPending
												if v126 != 0 {
													...
													F_errfinish(m, int32(_a_F_IvfflatParallelScanAndSort_1), v130, int32(_a_F_IvfflatParallelScanAndSort_2))
													mBase = m.M
													v133 = m.ExcPending
													if v133 != 0 {
														return
