...
L4:
	;
	v14 = *(*int32)(unsafe.Add(mBase, _consts[578]))
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _consts[579])) = v30 + v16
	v37 = v10 - v30
	if v37 != 0 {
		v9 = v32 + v30
		v10 = v37
...
L16:
	;
	v31 = F__emscripten_memcpy_bulkmem(m, v9, v16+int32(4414064), v30)
	mBase = m.M
	v32 = v31
	goto L18
L17:
		...
		if v14 != 0 {
			...
			if v17 != 0 {
				...
				if v21 != 0 {
					...
					F_errfinish(m, int32(493252), int32(533), int32(158571))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return float64(0)
