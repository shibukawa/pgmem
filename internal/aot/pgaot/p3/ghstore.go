...
L32:
	...
	v135 = int32(255)
	v137 = int32(2)
	v140 = *(*int32)(unsafe.Add(mBase, uint32((v133^v119)&v135<<(uint(v137)%32))+uint32(_consts[1066])))
	v141 = int32(8)
	v143 = v140 ^ int32(base.Ui32(v119)>>(uint(v141)%32))
	v144 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v118)+1)))
	v151 = *(*int32)(unsafe.Add(mBase, uint32((v143^v144)&v135<<(uint(v137)%32))+uint32(_consts[1066])))
...
L35:
	...
	v182 = *(*int32)(unsafe.Add(mBase, uint32((v161^v174)&int32(255)<<(uint(int32(2))%32))+uint32(_consts[1066])))
...
L51:
	...
	v265 = int32(255)
	v267 = int32(2)
	v270 = *(*int32)(unsafe.Add(mBase, uint32((v263^v249)&v265<<(uint(v267)%32))+uint32(_consts[1066])))
	v271 = int32(8)
	v273 = v270 ^ int32(base.Ui32(v249)>>(uint(v271)%32))
	v274 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v248)+1)))
	v281 = *(*int32)(unsafe.Add(mBase, uint32((v273^v274)&v265<<(uint(v267)%32))+uint32(_consts[1066])))
...
L54:
	...
	v312 = *(*int32)(unsafe.Add(mBase, uint32((v291^v304)&int32(255)<<(uint(int32(2))%32))+uint32(_consts[1066])))
...
func F_ghstore_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_int_reloption(m, v2, int32(293222), int32(167616), int32(16), int32(1), int32(2024))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		return int32(0)
