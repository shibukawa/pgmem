...
L6:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l1))) = v29
	F_parse_format(m, v23, v13, int32(1624240), v27, int32(1623856), int32(2), l1)
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L25:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v703)+988)) = v715
	F_parse_format(m, v703, v13, int32(1624240), v717, int32(1623856), int32(2), v703+int32(980))
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L1
...
L815:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49))) = v2662
	v2776 = F_pg_sprintf(m, v535, int32(165056), v49)
	mBase = m.M
	v2777 = m.ExcPending
	if v2777 != 0 {
		goto L88
...
L933:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+16)) = v3195
	v3205 = F_pg_sprintf(m, v540, int32(465664), v49+int32(16))
	mBase = m.M
	v3206 = m.ExcPending
	if v3206 != 0 {
		goto L88
...
L1068:
	;
	F_errmsg(m, int32(295112), int32(0))
	mBase = m.M
	v3823 = m.ExcPending
	if v3823 != 0 {
		goto L88
...
L1069:
	;
	F_errfinish(m, int32(474808), int32(6113), int32(199473))
	mBase = m.M
	v3828 = m.ExcPending
	if v3828 != 0 {
		goto L88
...
L1072:
	;
	F_errmsg(m, int32(61832), int32(0))
	mBase = m.M
	v3839 = m.ExcPending
	if v3839 != 0 {
		goto L88
...
L1073:
	;
	F_errfinish(m, int32(474808), int32(5836), int32(199473))
	mBase = m.M
	v3844 = m.ExcPending
	if v3844 != 0 {
		goto L88
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v99))) = int32(0)
	v106 = F_FindWord(m, l0, l1, int32(715212), l2)
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L22
...
func F_nameconcatoid(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v10
	v16 = F_pg_snprintf(m, v7+int32(16), int32(20), int32(36116), v7)
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		goto L1
...
L26:
	;
	v84 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v51+v20)+uint32(_consts[1219]))))
	if v84 == int32(47) {
		v843 = v69
		goto L22
	} else {
...
L261:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = l0
	F_errmsg_internal(m, int32(279242), v16)
	mBase = m.M
	v943 = m.ExcPending
	if v943 != 0 {
		goto L258
...
L262:
	;
	F_errfinish(m, int32(476640), int32(253), int32(305968))
	mBase = m.M
	v948 = m.ExcPending
	if v948 != 0 {
		goto L258
			...
			default:
				...
				if v27 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l1
					F_errmsg_internal(m, int32(461397), v8+int32(-48))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return float64(0)
					} else {
						F_errfinish(m, int32(471673), int32(1741), int32(291665))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return float64(0)
				...
				default:
					...
					if v56 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
						F_errmsg_internal(m, int32(461397), v10)
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return float64(0)
						} else {
							F_errfinish(m, int32(471673), int32(1769), int32(291665))
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return float64(0)
