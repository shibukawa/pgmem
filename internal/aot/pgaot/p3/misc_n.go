...
L815:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49))) = v2662
	v2776 = F_pg_sprintf(m, v535, int32(165641), v49)
	mBase = m.M
	v2777 = m.ExcPending
	if v2777 != 0 {
		goto L88
...
L933:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v49)+16)) = v3195
	v3205 = F_pg_sprintf(m, v540, int32(467292), v49+int32(16))
	mBase = m.M
	v3206 = m.ExcPending
	if v3206 != 0 {
		goto L88
...
L1068:
	;
	F_errmsg(m, int32(296448), int32(0))
	mBase = m.M
	v3823 = m.ExcPending
	if v3823 != 0 {
		goto L88
...
L1069:
	;
	F_errfinish(m, int32(476474), int32(6113), int32(200058))
	mBase = m.M
	v3828 = m.ExcPending
	if v3828 != 0 {
		goto L88
...
L1072:
	;
	F_errmsg(m, int32(62045), int32(0))
	mBase = m.M
	v3839 = m.ExcPending
	if v3839 != 0 {
		goto L88
...
L1073:
	;
	F_errfinish(m, int32(476474), int32(5836), int32(200058))
	mBase = m.M
	v3844 = m.ExcPending
	if v3844 != 0 {
		goto L88
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v99))) = int32(0)
	v106 = F_FindWord(m, l0, l1, int32(717063), l2)
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L22
...
func F_nameconcatoid(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v10
	v16 = F_pg_snprintf(m, v7+int32(16), int32(20), int32(36276), v7)
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		goto L1
...
L261:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = l0
	F_errmsg_internal(m, int32(280570), v16)
	mBase = m.M
	v943 = m.ExcPending
	if v943 != 0 {
		goto L258
...
L262:
	;
	F_errfinish(m, int32(478306), int32(253), int32(307304))
	mBase = m.M
	v948 = m.ExcPending
	if v948 != 0 {
		goto L258
			...
			default:
				...
				if v27 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l1
					F_errmsg_internal(m, int32(463025), v8+int32(-48))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return float64(0)
					} else {
						F_errfinish(m, int32(473313), int32(1741), int32(293001))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return float64(0)
				...
				default:
					...
					if v56 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
						F_errmsg_internal(m, int32(463025), v10)
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return float64(0)
						} else {
							F_errfinish(m, int32(473313), int32(1769), int32(293001))
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return float64(0)
