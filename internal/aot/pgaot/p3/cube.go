		...
		if v11 != 0 {
			...
			if v15 != 0 {
				...
				if v20 != 0 {
					...
					if v17 == int32(0) {
						F_yy_fatal_error_6(m, int32(683419))
						mBase = m.M
						v82 = m.ExcPending
						if v82 != 0 {
							return int32(0)
...
L8:
	;
	F_cube_yyerror(m, l0, l1, l2, l3, int32(440648))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L16
...
L55:
	;
	F_cube_yyerror(m, l0, l1, l2, l3, int32(212002))
	mBase = m.M
	v872 = m.ExcPending
	if v872 != 0 {
		goto L16
...
L97:
	;
	F_errmsg(m, int32(419598), int32(0))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L16
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+16)) = v353
	F_errdetail(m, int32(660862), v25+int32(16))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L16
...
L99:
	;
	F_errsave_finish(m, l2, int32(27008), int32(58), int32(360592))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L16
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25))) = int32(100)
	F_errdetail(m, int32(591730), v25)
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L16
...
L108:
	;
	F_errsave_finish(m, l2, int32(27008), int32(67), int32(360592))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L16
...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+48)) = v563
	F_errdetail(m, int32(660862), v25+int32(48))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L16
...
L147:
	;
	F_errsave_finish(m, l2, int32(27008), int32(88), int32(360592))
	mBase = m.M
	v579 = m.ExcPending
	if v579 != 0 {
		goto L16
...
L155:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+32)) = int32(100)
	F_errdetail(m, int32(591730), v25+int32(32))
	mBase = m.M
	v603 = m.ExcPending
	if v603 != 0 {
		goto L16
...
L156:
	;
	F_errsave_finish(m, l2, int32(27008), int32(97), int32(360592))
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		goto L16
...
L179:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+64)) = int32(100)
	F_errdetail(m, int32(591730), v25-int32(-64))
	mBase = m.M
	v687 = m.ExcPending
	if v687 != 0 {
		goto L16
...
L180:
	;
	F_errsave_finish(m, l2, int32(27008), int32(116), int32(360592))
	mBase = m.M
	v694 = m.ExcPending
	if v694 != 0 {
		goto L16
...
L201:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+80)) = int32(100)
	F_errdetail(m, int32(591730), v25+int32(80))
	mBase = m.M
	v768 = m.ExcPending
	if v768 != 0 {
		goto L16
...
L202:
	;
	F_errsave_finish(m, l2, int32(27008), int32(135), int32(360592))
	mBase = m.M
	v775 = m.ExcPending
	if v775 != 0 {
		goto L16
	...
	if v4 != 0 {
		...
		if v9 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = l0
			...
			F_yy_fatal_error_6(m, int32(225583))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return
