		...
		if v11 != 0 {
			...
			if v15 != 0 {
				...
				if v20 != 0 {
					...
					if v17 == int32(0) {
						F_yy_fatal_error_6(m, int32(665362))
						mBase = m.M
						v82 = m.ExcPending
						if v82 != 0 {
							return int32(0)
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v954)+4)) = v946
	...
	v968 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v179)+uint32(_consts[1312]))))
	v970 = v968 - int32(9)
	v972 = int32(*(*int8)(unsafe.Add(mBase, uint32(v970)+uint32(_consts[1313]))))
	v973 = v961 + v972
...
L8:
	;
	F_cube_yyerror(m, l0, l1, l2, l3, int32(438326))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L16
...
L35:
	;
	v127 = int32(*(*int8)(unsafe.Add(mBase, uint32(v39)+uint32(_consts[1314]))))
	if v49 == int32(-2) {
		goto L37
	} else {
		goto L38
...
L44:
	;
	v144 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v134)+uint32(_consts[1315]))))
	v145 = v134
	v146 = v144
	goto L36
L45:
	;
	v152 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v147)+uint32(_consts[1316]))))
	if v146 != v152 {
		v169 = v145
		goto L34
	} else {
...
L52:
	;
	v165 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v147)+uint32(_consts[1317]))))
	v991 = v111
	v993 = v113 + int32(4)
	v1000 = v160
	v1008 = v165
...
L53:
	;
	v179 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v39)+uint32(_consts[1318]))))
	v182 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v179)+uint32(_consts[1319]))))
	v184 = int32(2)
...
L55:
	;
	F_cube_yyerror(m, l0, l1, l2, l3, int32(211201))
	mBase = m.M
	v872 = m.ExcPending
	if v872 != 0 {
		goto L16
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+16)) = v353
	F_errdetail(m, int32(642820), v25+int32(16))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L16
...
L99:
	;
	F_errsave_finish(m, l2, int32(26944), int32(58), int32(358623))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L16
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25))) = int32(100)
	F_errdetail(m, int32(573688), v25)
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L16
...
L108:
	;
	F_errsave_finish(m, l2, int32(26944), int32(67), int32(358623))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L16
...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+48)) = v563
	F_errdetail(m, int32(642820), v25+int32(48))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L16
...
L147:
	;
	F_errsave_finish(m, l2, int32(26944), int32(88), int32(358623))
	mBase = m.M
	v579 = m.ExcPending
	if v579 != 0 {
		goto L16
...
L155:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+32)) = int32(100)
	F_errdetail(m, int32(573688), v25+int32(32))
	mBase = m.M
	v603 = m.ExcPending
	if v603 != 0 {
		goto L16
...
L156:
	;
	F_errsave_finish(m, l2, int32(26944), int32(97), int32(358623))
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		goto L16
...
L179:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+64)) = int32(100)
	F_errdetail(m, int32(573688), v25-int32(-64))
	mBase = m.M
	v687 = m.ExcPending
	if v687 != 0 {
		goto L16
...
L180:
	;
	F_errsave_finish(m, l2, int32(26944), int32(116), int32(358623))
	mBase = m.M
	v694 = m.ExcPending
	if v694 != 0 {
		goto L16
...
L201:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+80)) = int32(100)
	F_errdetail(m, int32(573688), v25+int32(80))
	mBase = m.M
	v768 = m.ExcPending
	if v768 != 0 {
		goto L16
...
L202:
	;
	F_errsave_finish(m, l2, int32(26944), int32(135), int32(358623))
	mBase = m.M
	v775 = m.ExcPending
	if v775 != 0 {
		goto L16
...
L234:
	;
	v985 = int32(*(*int8)(unsafe.Add(mBase, uint32(v970)+uint32(_consts[1320]))))
	v991 = v960
	v993 = v957
	v1000 = v169
	v1008 = v985
...
L235:
	;
	v978 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v973)+uint32(_consts[1316]))))
	if v978 != v961 {
		goto L234
	} else {
		goto L236
...
L236:
	;
	v982 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v973)+uint32(_consts[1317]))))
	v991 = v960
	v993 = v957
	v1000 = v169
	v1008 = v982
	...
	if v4 != 0 {
		...
		if v9 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = l0
			...
			F_yy_fatal_error_6(m, int32(224581))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return
