...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v954)+4)) = v946
	...
	v968 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v179)+uint32(_c_F_cube_yyparse[0]))))
	v970 = v968 - int32(9)
	v972 = int32(*(*int8)(unsafe.Add(mBase, uint32(v970)+uint32(_c_F_cube_yyparse[1]))))
	v973 = v961 + v972
...
L9:
	;
	if base.Ui32(int32(_a_F_cube_yyparse_1)) < base.Ui32(v50) {
		goto L8
	} else {
		goto L12
	}
...
L11:
	...
	if v121&int32(_a_F_cube_yyparse_2) != 0 {
		v169 = v49
		goto L34
	} else {
		goto L35
...
L34:
	;
	if v121&int32(_a_F_cube_yyparse_4) == int32(0) {
		goto L53
	} else {
		goto L54
	}
L35:
	;
	v127 = int32(*(*int8)(unsafe.Add(mBase, uint32(v39)+uint32(_c_F_cube_yyparse[2]))))
	if v49 == int32(-2) {
		goto L37
	} else {
		goto L38
...
L44:
	;
	v144 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v134)+uint32(_c_F_cube_yyparse[3]))))
	v145 = v134
	v146 = v144
	goto L36
L45:
	;
	v152 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v147)+uint32(_c_F_cube_yyparse[4]))))
	if v146 != v152 {
		v169 = v145
		goto L34
	} else {
...
L52:
	;
	v165 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v147)+uint32(_c_F_cube_yyparse[5]))))
	v991 = v111
	v993 = v113 + int32(4)
	v1000 = v160
	v1008 = v165
...
L53:
	;
	v179 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v39)+uint32(_c_F_cube_yyparse[6]))))
	v182 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v179)+uint32(_c_F_cube_yyparse[7]))))
	v184 = int32(2)
...
L58:
	;
	v780 = F_pstrdup(m, int32(_a_F_cube_yyparse_6))
	mBase = m.M
	v781 = m.ExcPending
	if v781 != 0 {
		goto L16
...
L234:
	;
	v985 = int32(*(*int8)(unsafe.Add(mBase, uint32(v970)+uint32(_c_F_cube_yyparse[8]))))
	v991 = v960
	v993 = v957
	v1000 = v169
	v1008 = v985
...
L235:
	;
	v978 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v973)+uint32(_c_F_cube_yyparse[4]))))
	if v978 != v961 {
		goto L234
	} else {
		goto L236
...
L236:
	;
	v982 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v973)+uint32(_c_F_cube_yyparse[5]))))
	v991 = v960
	v993 = v957
	v1000 = v169
	v1008 = v982
