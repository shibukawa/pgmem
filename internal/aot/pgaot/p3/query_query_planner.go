...
L12:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _consts[608]))
	if v87 == int32(0) {
		goto L10
	} else {
		goto L15
...
L268:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1133))) = v1349
	F_errmsg_internal(m, int32(510299), v1133)
	mBase = m.M
	v1353 = m.ExcPending
	if v1353 != 0 {
		goto L1
...
L269:
	;
	F_errfinish(m, int32(522556), int32(1598), int32(367884))
	mBase = m.M
	v1358 = m.ExcPending
	if v1358 != 0 {
		goto L1
...
L275:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1133)+16)) = v1404
	F_errmsg(m, int32(289910), v1133+int32(16))
	mBase = m.M
	v1410 = m.ExcPending
	if v1410 != 0 {
		goto L1
...
L276:
	;
	v1403 = *(*int32)(unsafe.Add(mBase, uint32(v1396<<(uint(int32(2))%32))+uint32(_consts[609])))
	v1404 = v1403
	goto L278
L277:
	;
...
L279:
	;
	F_errfinish(m, int32(522556), int32(1756), int32(254205))
	mBase = m.M
	v1415 = m.ExcPending
	if v1415 != 0 {
		goto L1
...
L290:
	;
	v1466 = int32(0)
	v1468 = int32(*(*uint8)(unsafe.Add(mBase, _consts[610])))
	v1477 = v1468
	v1481 = v1466
	v1490 = int32(1)
	v1492 = v1466
...
L1539:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6267))) = v7351
	F_errmsg_internal(m, int32(79745), v6267)
	mBase = m.M
	v7556 = m.ExcPending
	if v7556 != 0 {
		goto L1
...
L1540:
	;
	F_errfinish(m, int32(518992), int32(122), int32(158645))
	mBase = m.M
	v7561 = m.ExcPending
	if v7561 != 0 {
		goto L1
...
L1607:
	;
	v7888 = int32(*(*uint8)(unsafe.Add(mBase, _consts[611])))
...
L1643:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7883))) = v7968
	F_errmsg_internal(m, int32(79745), v7883)
	mBase = m.M
	v8104 = m.ExcPending
	if v8104 != 0 {
		goto L1
...
L1644:
	;
	F_errfinish(m, int32(518992), int32(2512), int32(158685))
	mBase = m.M
	v8109 = m.ExcPending
	if v8109 != 0 {
		goto L1
...
L2113:
	;
	F_errmsg_internal(m, int32(277409), int32(0))
	mBase = m.M
	v11133 = m.ExcPending
	if v11133 != 0 {
		goto L1
...
L2114:
	;
	F_errfinish(m, int32(522483), int32(293), int32(230455))
	mBase = m.M
	v11138 = m.ExcPending
	if v11138 != 0 {
		goto L1
