...
func F_pg_get_wal_summarizer_state(m *base.Module, l0 int32) int32 {
	...
	if v30 != 0 {
			...
			*(*int64)(unsafe.Add(mBase, uint32(v17))) = v46
			...
			if v43 == v48 {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v19))) = v52
				v56 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_wal_summarizer_state[2]))
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12+int32(4)))) = v65
		v71 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_wal_summarizer_state[0]))
		F_LWLockRelease(m, v71+int32(_a_F_pg_get_wal_summarizer_state_0))
		mBase = m.M
		v75 = m.ExcPending
		if v75 != 0 {
			return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v12)+28)) = int32(0)
					...
					if v118 != 0 {
						...
						if v122 != 0 {
							...
							F_errfinish(m, int32(_a_F_pg_get_wal_summarizer_state_2), int32(192), int32(_a_F_pg_get_wal_summarizer_state_3))
							mBase = m.M
							v127 = m.ExcPending
							if v127 != 0 {
								return int32(0)
