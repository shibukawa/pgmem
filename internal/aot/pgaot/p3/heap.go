...
func F_HeapTupleSetHintBits(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if l3 == int32(0) {
		...
		*(*uint16)(unsafe.Add(mBase, uint32(l0)+20)) = uint16(v56)
		...
		v11 = v9 - int32(16)
		m.G0 = v11
		v14 = *(*int32)(unsafe.Add(mBase, _consts[30]))
		if v14 == l3 {
			v17 = *(*int64)(unsafe.Add(mBase, _consts[31]))
			v26 = v17
			m.G0 = v11 + int32(16)
			if int32(0) <= l1 {
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = base.I32_extend16_s(v137)
	F_errmsg_internal(m, int32(460988), v19)
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L36
					...
					default:
						...
						if v49 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v38
							F_errmsg_internal(m, int32(460988), v8)
							mBase = m.M
							v53 = m.ExcPending
							if v53 != 0 {
								return int32(0)
...
func F_heap_identify(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(207)) {
		v11 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(2))%32))&int32(60))+uint32(_consts[76])))
		v12 = v11
	} else {
		v12 = int32(0)
	}
...
L7:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v22)+32)) = uint16(v106)
	v122 = F_heap_fetch(m, l0, int32(4114688), v22+int32(28), v22+int32(24), v103)
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L5
...
L104:
	;
	F_errmsg_internal(m, int32(365421), int32(0))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L5
...
L105:
	;
	F_errfinish(m, int32(474192), int32(5904), int32(468953))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L5
...
L129:
	;
	v514 = *(*int32)(unsafe.Add(mBase, _consts[15]))
	if v514 <= int32(0) {
		goto L130
	} else {
		goto L131
...
L174:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v22)+32)) = uint16(v754)
	v776 = F_heap_fetch(m, l0, int32(4114688), v22+int32(28), v22+int32(24), v759)
	mBase = m.M
	v777 = m.ExcPending
	if v777 != 0 {
		goto L5
...
L11:
	...
	mBase = m.M
	v50 = *(*int32)(unsafe.Add(mBase, uint32(v45<<(uint(int32(2))%32))+uint32(_consts[45])))
	goto L12
L12:
	;
