...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = base.I32_extend16_s(v137)
	F_errmsg_internal(m, int32(504907), v19)
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L36
					...
					default:
						...
						if v49 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v38
							F_errmsg_internal(m, int32(504907), v8)
							mBase = m.M
							v53 = m.ExcPending
							if v53 != 0 {
								return int32(0)
...
L7:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v22)+32)) = uint16(v106)
	v122 = F_heap_fetch(m, l0, int32(4211984), v22+int32(28), v22+int32(24), v103)
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L5
...
L104:
	;
	F_errmsg_internal(m, int32(402189), int32(0))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L5
...
L105:
	;
	F_errfinish(m, int32(520720), int32(5904), int32(513716))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L5
...
L174:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v22)+32)) = uint16(v754)
	v776 = F_heap_fetch(m, l0, int32(4211984), v22+int32(28), v22+int32(24), v759)
	mBase = m.M
	v777 = m.ExcPending
	if v777 != 0 {
		goto L5
