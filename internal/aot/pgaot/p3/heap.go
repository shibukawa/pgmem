...
L57:
	;
	v252 = int32(base.Ui32(v167) >> (uint(int32(1)) % 32))
	goto L40
L58:
	;
	goto L59
L59:
	...
	v252 = int32(base.Ui32(v190) >> (uint(int32(2)) % 32))
	goto L40
L60:
	;
	v252 = v249 + int32(1)
...
L63:
	;
	v200 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v130))))
	if v200 == int32(0) {
		goto L64
	} else {
		goto L65
...
L71:
	;
	v226 = *(*int32)(unsafe.Add(mBase, uint32(v220)))
...
L81:
	;
	v302 = v288 + int32(1)
	v303 = F_getmissingattr(m, l1, v302, l3+v288)
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L36
...
L83:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l2+v288<<(uint(int32(2))%32)))) = v303
	if v302 != v21 {
		v288 = v302
		goto L81
	} else {
			...
			if v28&v25 == v23 {
				...
				if int32(0) <= v38 {
					...
					if v44 != int32(1) {
						...
						switch v47&int32(_a_F_heap_getattr_2_0) - int32(1) {
						case 0:
						...
						default:
							...
							if v58 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10))) = v47
								F_errmsg_internal(m, int32(_a_F_heap_getattr_2_1), v10)
								mBase = m.M
								v62 = m.ExcPending
								if v62 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_heap_getattr_2_2), int32(70), int32(_a_F_heap_getattr_2_3))
									mBase = m.M
									v67 = m.ExcPending
									if v67 != 0 {
										return int32(0)
...
func F_heap_identify(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(207)) {
		v11 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(2))%32))&int32(60))+uint32(_c_F_heap_identify[0])))
		v12 = v11
	} else {
		v12 = int32(0)
	}
...
func F_heap_lock_updated_tuple(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) int32 {
	...
	if v24 != int32(_a_F_heap_lock_updated_tuple_0) {
		goto L2
	} else {
		goto L3
	}
...
L3:
	...
	if v27&v28 != int32(_a_F_heap_lock_updated_tuple_1) {
		goto L2
	} else {
		goto L4
	}
...
L7:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v22)+32)) = uint16(v106)
	v122 = F_heap_fetch(m, l0, int32(_a_F_heap_lock_updated_tuple_3), v22+int32(28), v22+int32(24), v103)
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L5
...
L28:
	;
	v177 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[0]))
	if v177 != 0 {
		goto L30
	} else {
		goto L31
...
L36:
	;
	v185 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[1]))
...
L38:
	;
	v189 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[2]))
...
L44:
	;
	v205 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[1]))
...
L46:
	;
	v209 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[2]))
...
L65:
	;
	if v250&int32(_a_F_heap_lock_updated_tuple_2) != 0 {
		goto L69
	} else {
		goto L70
	}
...
L67:
	;
	F_compute_new_xmax_infomask(m, v248, v250, v429&int32(_a_F_heap_lock_updated_tuple_1), l4, l5, int32(0), v22+int32(16), v22+int32(22), v22+int32(20))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L5
...
L69:
	;
	v267 = F_GetMultiXactIdMembers(m, v248, v22, int32(base.Ui32(v250&int32(128))>>(uint(int32(7))%32))|base.B2i32(v250&int32(_a_F_heap_lock_updated_tuple_4) == int32(64)))
	mBase = m.M
	v268 = m.ExcPending
	if v268 != 0 {
		goto L5
...
L97:
	;
	if v249&int32(_a_F_heap_lock_updated_tuple_5) != 0 {
		goto L107
	} else {
		goto L108
	}
...
L104:
	;
	F_errmsg_internal(m, int32(_a_F_heap_lock_updated_tuple_6), int32(0))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L5
...
L105:
	;
	F_errfinish(m, int32(_a_F_heap_lock_updated_tuple_7), int32(_a_F_heap_lock_updated_tuple_8), int32(_a_F_heap_lock_updated_tuple_9))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L5
...
L120:
	;
	v461 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[1]))
...
L122:
	;
	v465 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[2]))
...
L125:
	;
	v480 = int32(_a_F_heap_lock_updated_tuple_10)
	v482 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[3])) = v482 + int32(1)
...
L128:
	;
	v579 = int32(_a_F_heap_lock_updated_tuple_10)
	v581 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[3])) = v581 - int32(1)
	v622 = v478
	goto L27
L129:
	;
	v514 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[4]))
	if v514 <= int32(0) {
		goto L130
	} else {
		goto L131
...
L136:
	;
	v522 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[1]))
...
L138:
	;
	v526 = *(*int32)(unsafe.Add(mBase, _c_F_heap_lock_updated_tuple[2]))
...
L145:
	...
	if v635 == int32(_a_F_heap_lock_updated_tuple_0) {
		goto L146
	} else {
		goto L147
	}
L146:
	...
	if v638&v639 == int32(_a_F_heap_lock_updated_tuple_1) {
		goto L26
	} else {
		goto L149
	}
...
L158:
	...
	if v668&int32(_a_F_heap_lock_updated_tuple_13) != int32(_a_F_heap_lock_updated_tuple_2) {
		goto L160
	} else {
		goto L161
	}
...
L174:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v22)+32)) = uint16(v754)
	v776 = F_heap_fetch(m, l0, int32(_a_F_heap_lock_updated_tuple_3), v22+int32(28), v22+int32(24), v759)
	mBase = m.M
	v777 = m.ExcPending
	if v777 != 0 {
		goto L5
	...
	*(*uint16)(unsafe.Add(mBase, uint32(l0)+10)) = uint16(v17)
	...
	if v20 != 0 {
		...
		if base.Ui32(v21) < base.Ui32(int32(25)) {
			...
			if (v21+int32(_a_F_heap_mask_1))&int32(_a_F_heap_mask_2) == int32(0) {
			} else {
				v31 = int32(base.Ui32(v2) >> (uint(int32(16)) % 32))
				v39 = int32(1)
				for {
					v49 = v39&int32(_a_F_heap_mask_3)<<(uint(int32(2))%32) + (l0 + int32(24)) - int32(4)
					v50 = *(*int32)(unsafe.Add(mBase, uint32(v49)))
					v53 = l0 + v50&int32(_a_F_heap_mask_4)
					if v50&int32(_a_F_heap_mask_5) == int32(_a_F_heap_mask_6) {
					...
					if base.Ui32(v77) < base.Ui32(int32(_a_F_heap_mask_8)) {
					} else {
						v81 = int32(base.Ui32(v77) >> (uint(int32(17)) % 32))
						v86 = (v81+int32(7))&int32(_a_F_heap_mask_0) - v81
						if v86 <= int32(0) {
						} else {
					...
					if base.Ui32(int32(25)) <= base.Ui32(v99) {
						v107 = int32(base.Ui32(v99+int32(_a_F_heap_mask_1)) >> (uint(int32(2)) % 32))
					} else {
						v107 = int32(0)
					}
					if base.Ui32(v96&int32(_a_F_heap_mask_3)) <= base.Ui32(v107&int32(_a_F_heap_mask_3)) {
						v39 = v96
						continue
					} else {
						break
...
L11:
	...
	mBase = m.M
	v50 = *(*int32)(unsafe.Add(mBase, uint32(v45<<(uint(int32(2))%32))+uint32(_c_F_heap_page_prune_opt[4])))
	goto L12
L12:
	;
...
L33:
	;
	v96 = int32(base.Ui32(v79+int32(_a_F_heap_page_prune_opt_1)) >> (uint(int32(2)) % 32))
	goto L35
L34:
	;
	v96 = int32(0)
...
L35:
	;
	if base.Ui32(v96&int32(_a_F_heap_page_prune_opt_2)) < base.Ui32(int32(291)) {
		goto L32
	} else {
		goto L36
	}
...
L40:
	;
	v121 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v110&int32(_a_F_heap_page_prune_opt_2)<<(uint(int32(2))%32)+(v28+int32(24))-int32(3)))))
...
L42:
	;
	v127 = v110 + int32(1)
	v128 = int32(_a_F_heap_page_prune_opt_2)
...
L59:
	;
	v175 = int32(base.Ui32(v158+int32(_a_F_heap_page_prune_opt_1)) >> (uint(int32(2)) % 32))
	goto L61
L60:
	;
	v175 = int32(0)
...
L61:
	;
	if base.Ui32(v175&int32(_a_F_heap_page_prune_opt_2)) < base.Ui32(int32(291)) {
		goto L58
	} else {
		goto L62
	}
...
L66:
	;
	v200 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v189&int32(_a_F_heap_page_prune_opt_2)<<(uint(int32(2))%32)+(v28+int32(24))-int32(3)))))
...
L68:
	;
	v206 = v189 + int32(1)
	v207 = int32(_a_F_heap_page_prune_opt_2)
