...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v52
	F_errmsg_internal(m, int32(31555), v15)
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L23
...
L25:
	;
	F_errfinish(m, int32(485230), int32(3148), int32(205742))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L23
...
L40:
	;
	F_errmsg_internal(m, int32(115405), int32(0))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L23
...
L41:
	;
	F_errfinish(m, int32(485230), int32(3186), int32(205742))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L23
...
L85:
	;
	F_errfinish(m, int32(485230), int32(3145), int32(205742))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L23
...
L39:
	;
	v184 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1))))
...
L50:
	...
	v163 = int32(-2139062144)
	if (int32(16843008)-v160|v160)&v163 == v163 {
		v154 = v154 + int32(4)
		goto L50
	} else {
		goto L52
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v188
	v194 = F_pg_snprintf(m, l0+v183, int32(1024)-v183, int32(172837), v8)
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L59
