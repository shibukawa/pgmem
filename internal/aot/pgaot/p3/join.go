...
L39:
	;
	v132 = int32(_a_F_join_path_components_0)
	goto L41
L40:
	;
	v132 = int32(_a_F_join_path_components_1)
	goto L41
L41:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v132
	v138 = F_pg_snprintf(m, l0+v127, int32(1024)-v127, int32(_a_F_join_path_components_2), v8)
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L42
