...
L56:
	;
	v188 = int32(_a_F_join_path_components_0)
	goto L58
L57:
	;
	v188 = int32(_a_F_join_path_components_1)
	goto L58
L58:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v188
	v194 = F_pg_snprintf(m, l0+v183, int32(1024)-v183, int32(_a_F_join_path_components_2), v8)
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L59
