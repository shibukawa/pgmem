...
func F_ltree_gist_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_int_reloption(m, v2, int32(282743), int32(159725), int32(8), int32(4), int32(2024))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
		...
		v18 = F_lappend(m, v16, int32(7001))
		mBase = m.M
		v19 = m.ExcPending
		if v19 != 0 {
			return int32(0)
		...
		if v17 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(4)
				F_errmsg(m, int32(476076), v6)
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return
				} else {
					F_errfinish(m, int32(494159), int32(731), int32(210030))
					mBase = m.M
					v34 = m.ExcPending
					if v34 != 0 {
						return
		...
		if v10 != int32(1) {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v10
				F_errmsg_internal(m, int32(473240), v6)
				mBase = m.M
				v25 = m.ExcPending
				if v25 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(497613), int32(238), int32(36965))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
