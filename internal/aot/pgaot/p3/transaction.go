...
func F_GetNewTransactionId(m *base.Module, l0 int32) int64 {
	...
	v13 = v11 + int32(-64)
	m.G0 = v13
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[0]))
...
L2:
	...
	v270 = v268 - int32(16)
	m.G0 = v270
	if v261&int32(_a_F_GetNewTransactionId_3) != 0 {
		goto L76
	} else {
		goto L77
	}
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v131
	F_errmsg(m, int32(_a_F_GetNewTransactionId_9), v11+int32(-48))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L21
...
L10:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[1]))
	if v28 == int32(0) {
		goto L13
	} else {
		goto L14
...
L13:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[2]))
	v33 = int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(v32)+36)) = v33
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[3]))
...
L15:
	;
	v47 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_GetNewTransactionId[4])))
	if v47 == int32(1) {
		goto L17
	} else {
		goto L18
...
L17:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[5]))
	v53 = *(*int32)(unsafe.Add(mBase, uint32(v52)+316))
	v55 = base.B2i32(v53 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _c_F_GetNewTransactionId[4])) = uint8(v55)
	v57 = v55
	goto L19
L18:
	;
...
L20:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[6]))
...
L22:
	;
	v68 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[7]))
...
L27:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[7]))
	...
	v93 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[6]))
...
L28:
	;
	v99 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_GetNewTransactionId[14])))
	if v70&int32(_a_F_GetNewTransactionId_6) != 0 {
		goto L30
	} else {
		goto L31
	}
...
L33:
	;
	v110 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_GetNewTransactionId[14])))
	if v110&int32(1) != 0 {
		goto L29
	} else {
		goto L34
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v88
	F_errmsg(m, int32(_a_F_GetNewTransactionId_10), v13)
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L21
...
L45:
	;
	F_errhint(m, int32(_a_F_GetNewTransactionId_11), int32(0))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L21
...
L46:
	;
	F_errfinish(m, int32(_a_F_GetNewTransactionId_1), int32(166), int32(_a_F_GetNewTransactionId_2))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L21
...
L48:
	;
	F_errmsg_internal(m, int32(_a_F_GetNewTransactionId_12), int32(0))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L21
...
L49:
	;
	F_errfinish(m, int32(_a_F_GetNewTransactionId_1), int32(87), int32(_a_F_GetNewTransactionId_2))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L21
...
L52:
	;
	F_errfinish(m, int32(_a_F_GetNewTransactionId_1), int32(103), int32(_a_F_GetNewTransactionId_2))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L21
...
L55:
	;
	F_errfinish(m, int32(_a_F_GetNewTransactionId_1), int32(159), int32(_a_F_GetNewTransactionId_2))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L21
...
L57:
	;
	v251 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[6]))
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+52)) = v89 - v70
	F_errmsg(m, int32(_a_F_GetNewTransactionId_7), v11+int32(-16))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L21
...
L70:
	;
	v238 = int32(_a_F_GetNewTransactionId_8)
	v239 = int32(179)
	goto L65
L71:
	;
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+36)) = v89 - v70
	F_errmsg(m, int32(_a_F_GetNewTransactionId_13), v11+int32(-32))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L21
...
L72:
	;
	v238 = int32(_a_F_GetNewTransactionId_14)
	v239 = int32(186)
	goto L65
L73:
	;
...
L75:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[7]))
...
L79:
	;
	v281 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[8]))
	v282 = *(*int32)(unsafe.Add(mBase, uint32(v281)+28))
	v284 = int32(base.Ui32(v261) >> (uint(int32(15)) % 32))
	v286 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_GetNewTransactionId[9])))
...
L81:
	...
	v320 = v318 - v315
	m.G0 = v320
	v323 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[10]))
...
L82:
	...
	v296 = F_SimpleLruZeroPage(m, int32(_a_F_GetNewTransactionId_4), v295)
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L21
...
L93:
	;
	v337 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[11]))
	v338 = *(*int32)(unsafe.Add(mBase, uint32(v337)+28))
	v340 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_GetNewTransactionId[12])))
...
L94:
	;
	v349 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_GetNewTransactionId[13])))
	v351 = base.I64_extend_i32_u(v331)
	v352 = F_SimpleLruZeroPage(m, int32(_a_F_GetNewTransactionId_5), v351)
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L21
...
L103:
	;
	v380 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[7]))
...
L110:
	;
	v445 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[6]))
...
L111:
	;
	v402 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[2]))
	*(*int32)(unsafe.Add(mBase, uint32(v402)+36)) = v261
	v405 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[3]))
...
L113:
	;
	v413 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[3]))
	v414 = *(*int32)(unsafe.Add(mBase, uint32(v413)+8))
	v416 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[2]))
...
L114:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v420))) = uint8(v429)
	v432 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[2]))
...
L116:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v420)+1)) = uint8(v434)
	v437 = *(*int32)(unsafe.Add(mBase, _c_F_GetNewTransactionId[2]))
...
func F_TransactionIdGetStatus(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v15 != 0 {
		...
		v36 = *(*int64)(unsafe.Add(mBase, uint32(v29+(v19&int32(_a_F_TransactionIdGetStatus_2)|v12<<(uint(int32(13))%32)))))
...
func F_TransactionIdSetPageStatusInternal(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int64, l5 int64) {
	...
	if v19 != 0 {
		...
		if l0 == int32(0) {
			...
			if l3 != int32(1) {
				...
				if l1 <= int32(0) {
					...
					v35 = int32(0)
					for {
						v43 = *(*int32)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[0]))
						...
						v54 = v52 & int32(_a_F_TransactionIdSetPageStatusInternal_1)
						v57 = v48 + int32(base.Ui32(v54)>>(uint(v45)%32))
						v58 = int32(*(*int8)(unsafe.Add(mBase, uint32(v57))))
						v59 = int32(1)
						v62 = v52 << (uint(v59) % 32) & int32(6)
						v64 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[1])))
						if v64 == v59 {
							if v58>>(uint(v62)%32)&int32(3) == int32(1) {
								...
								*(*uint8)(unsafe.Add(mBase, uint32(v57))) = uint8(v74)
								if l4 == int64(0) {
									...
									v77 = *(*int32)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[0]))
			...
			v107 = *(*int32)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[0]))
			v108 = *(*int32)(unsafe.Add(mBase, uint32(v107)+4))
			v109 = int32(2)
			v112 = *(*int32)(unsafe.Add(mBase, uint32(v108+v18<<(uint(v109)%32))))
			v114 = l0 & int32(_a_F_TransactionIdSetPageStatusInternal_1)
			...
			if l3 != int32(3) {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v117))) = uint8(v142)
				if l4 == int64(0) {
					...
					v145 = *(*int32)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[0]))
					v146 = *(*int32)(unsafe.Add(mBase, uint32(v145)+36))
					v154 = v146 + (int32(base.Ui32(v114)>>(uint(int32(2))%32))&int32(_a_F_TransactionIdSetPageStatusInternal_2) | v18<<(uint(int32(13))%32))
				...
				v126 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[1])))
		...
		if int32(0) < l1 {
			v184 = int32(0)
			for {
				v192 = *(*int32)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[0]))
				...
				v203 = v201 & int32(_a_F_TransactionIdSetPageStatusInternal_1)
				...
				if l3 != int32(3) {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(v206))) = uint8(v231)
					if l4 == int64(0) {
						...
						v234 = *(*int32)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[0]))
					...
					v215 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[1])))
		...
		v264 = *(*int32)(unsafe.Add(mBase, _c_F_TransactionIdSetPageStatusInternal[0]))
...
func F_check_transaction_read_only(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v5 != 0 {
		...
		if v7 != int32(1) {
			...
			v11 = *(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[1]))
			v12 = *(*int32)(unsafe.Add(mBase, uint32(v11)+20))
			if base.B2i32(v12 == int32(2)) == int32(0) {
				v63 = v4
				return v63
			} else {
				v18 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_check_transaction_read_only[2])))
				if v18 != 0 {
					v63 = v4
					return v63
				} else {
					v19 = int32(16777538)
					v22 = *(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[1]))
					v23 = *(*int32)(unsafe.Add(mBase, uint32(v22)+28))
					if int32(1) < v23 {
						v46 = v19
						v47 = int32(_a_F_check_transaction_read_only_0)
						*(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[3])) = v46
						v52 = *(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[4]))
						*(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[5])) = v52
						...
						if v60 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[6])) = v57
							v63 = int32(0)
							return v63
						}
					} else {
						v28 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_check_transaction_read_only[7])))
						if v28 != 0 {
							v46 = v19
							v47 = int32(_a_F_check_transaction_read_only_1)
							*(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[3])) = v46
							v52 = *(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[4]))
							*(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[5])) = v52
							v57 = F_format_elog_string(m, v47, int32(0))
							...
							v31 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_check_transaction_read_only[8])))
							if v31 == int32(1) {
								v36 = *(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[9]))
								v37 = *(*int32)(unsafe.Add(mBase, uint32(v36)+316))
								v39 = base.B2i32(v37 != int32(2))
								*(*uint8)(unsafe.Add(mBase, _c_F_check_transaction_read_only[8])) = uint8(v39)
								v41 = v39
							} else {
								v41 = int32(0)
							}
							if v41 == int32(0) {
								...
								v46 = int32(1088)
								v47 = int32(_a_F_check_transaction_read_only_2)
								*(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[3])) = v46
								v52 = *(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[4]))
								*(*int32)(unsafe.Add(mBase, _c_F_check_transaction_read_only[5])) = v52
								v57 = F_format_elog_string(m, v47, int32(0))
