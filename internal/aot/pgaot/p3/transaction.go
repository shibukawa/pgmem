...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v131
	F_errmsg(m, int32(746107), v11+int32(-48))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L21
...
L46:
	;
	F_errfinish(m, int32(518744), int32(166), int32(486233))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L21
...
L48:
	;
	F_errmsg_internal(m, int32(272914), int32(0))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L21
...
L49:
	;
	F_errfinish(m, int32(518744), int32(87), int32(486233))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L21
...
L52:
	;
	F_errfinish(m, int32(518744), int32(103), int32(486233))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L21
...
L55:
	;
	F_errfinish(m, int32(518744), int32(159), int32(486233))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L21
...
L73:
	;
	F_errfinish(m, int32(518744), v239, int32(486233))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L21
...
L82:
	...
	v296 = F_SimpleLruZeroPage(m, int32(4448768), v295)
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L21
...
L94:
	...
	v352 = F_SimpleLruZeroPage(m, int32(4448852), v351)
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L21
...
func F_TransactionIdGetStatus(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v12 = F_SimpleLruReadPage_ReadOnly(m, int32(4448768), base.I64_extend_i32_u(v10), l0)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
...
func F_TransactionIdSetPageStatusInternal(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int64, l5 int64) {
	...
	v18 = F_SimpleLruReadPage(m, int32(4448768), l5, v17, l0)
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		return
