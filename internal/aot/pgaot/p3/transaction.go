...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v131
	F_errmsg(m, int32(687593), v11+int32(-48))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L21
...
L13:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[128]))
	v33 = int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(v32)+36)) = v33
	v36 = *(*int32)(unsafe.Add(mBase, _consts[141]))
...
L28:
	;
	v99 = int32(*(*uint8)(unsafe.Add(mBase, _consts[92])))
...
L33:
	;
	v110 = int32(*(*uint8)(unsafe.Add(mBase, _consts[92])))
	if v110&int32(1) != 0 {
		goto L29
	} else {
		goto L34
...
L46:
	;
	F_errfinish(m, int32(486783), int32(166), int32(457187))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L21
...
L48:
	;
	F_errmsg_internal(m, int32(256328), int32(0))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L21
...
L49:
	;
	F_errfinish(m, int32(486783), int32(87), int32(457187))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L21
...
L51:
	;
	F_errmsg_internal(m, int32(14501), int32(0))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L21
...
L52:
	;
	F_errfinish(m, int32(486783), int32(103), int32(457187))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L21
...
L55:
	;
	F_errfinish(m, int32(486783), int32(159), int32(457187))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L21
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+52)) = v89 - v70
	F_errmsg(m, int32(139480), v11+int32(-16))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L21
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+36)) = v89 - v70
	F_errmsg(m, int32(139419), v11+int32(-32))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L21
...
L73:
	;
	F_errfinish(m, int32(486783), v239, int32(457187))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L21
...
L82:
	...
	v296 = F_SimpleLruZeroPage(m, int32(4364928), v295)
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L21
...
L94:
	...
	v352 = F_SimpleLruZeroPage(m, int32(4365012), v351)
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L21
...
L111:
	;
	v402 = *(*int32)(unsafe.Add(mBase, _consts[128]))
	*(*int32)(unsafe.Add(mBase, uint32(v402)+36)) = v261
	v405 = *(*int32)(unsafe.Add(mBase, _consts[141]))
...
L113:
	;
	v413 = *(*int32)(unsafe.Add(mBase, _consts[141]))
	v414 = *(*int32)(unsafe.Add(mBase, uint32(v413)+8))
	v416 = *(*int32)(unsafe.Add(mBase, _consts[128]))
...
L114:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v420))) = uint8(v429)
	v432 = *(*int32)(unsafe.Add(mBase, _consts[128]))
...
L116:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v420)+1)) = uint8(v434)
	v437 = *(*int32)(unsafe.Add(mBase, _consts[128]))
...
func F_TransactionIdGetStatus(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v12 = F_SimpleLruReadPage_ReadOnly(m, int32(4364928), base.I64_extend_i32_u(v10), l0)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
...
L10:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[137]))
	v97 = int32(0)
	v99 = v18 - int32(1)
	goto L34
L11:
...
func F_TransactionIdSetPageStatusInternal(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int64, l5 int64) {
	...
	v18 = F_SimpleLruReadPage(m, int32(4364928), l5, v17, l0)
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		return
...
func F_check_transaction_read_only(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v5 != 0 {
		...
		v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[172])))
		if v7 != int32(1) {
			v63 = v4
			return v63
		} else {
			...
			if base.B2i32(v12 == int32(2)) == int32(0) {
				...
				v18 = int32(*(*uint8)(unsafe.Add(mBase, _consts[517])))
				if v18 != 0 {
					v63 = v4
					return v63
				} else {
					...
					if int32(1) < v23 {
						v46 = v19
						v47 = int32(252491)
						*(*int32)(unsafe.Add(mBase, _consts[518])) = v46
						v52 = *(*int32)(unsafe.Add(mBase, _consts[40]))
						*(*int32)(unsafe.Add(mBase, _consts[497])) = v52
						...
						if v60 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[516])) = v57
							v63 = int32(0)
							return v63
						}
					} else {
						v28 = int32(*(*uint8)(unsafe.Add(mBase, _consts[519])))
						if v28 != 0 {
							v46 = v19
							v47 = int32(15915)
							*(*int32)(unsafe.Add(mBase, _consts[518])) = v46
