...
func F_GetNewTransactionId(m *base.Module, l0 int32) int64 {
	...
	v13 = v11 + int32(-64)
	m.G0 = v13
	v19 = *(*int32)(unsafe.Add(mBase, _consts[75]))
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v131
	F_errmsg(m, int32(746037), v11+int32(-48))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L21
...
L10:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _consts[87]))
	if v28 == int32(0) {
		goto L13
	} else {
		goto L14
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v32)+36)) = v33
	v36 = *(*int32)(unsafe.Add(mBase, _consts[152]))
...
L20:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L22:
	;
	v68 = *(*int32)(unsafe.Add(mBase, _consts[90]))
...
L27:
	...
	v93 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L28:
	;
	v99 = int32(*(*uint8)(unsafe.Add(mBase, _consts[104])))
...
L33:
	;
	v110 = int32(*(*uint8)(unsafe.Add(mBase, _consts[104])))
	if v110&int32(1) != 0 {
		goto L29
	} else {
		goto L34
...
L46:
	;
	F_errfinish(m, int32(518692), int32(166), int32(486181))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L21
...
L48:
	;
	F_errmsg_internal(m, int32(272884), int32(0))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L21
...
L49:
	;
	F_errfinish(m, int32(518692), int32(87), int32(486181))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L21
...
L51:
	;
	F_errmsg_internal(m, int32(14744), int32(0))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L21
...
L52:
	;
	F_errfinish(m, int32(518692), int32(103), int32(486181))
	mBase = m.M
	v178 = m.ExcPending
	if v178 != 0 {
		goto L21
...
L55:
	;
	F_errfinish(m, int32(518692), int32(159), int32(486181))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L21
...
L57:
	;
	v251 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+52)) = v89 - v70
	F_errmsg(m, int32(150521), v11+int32(-16))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L21
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+36)) = v89 - v70
	F_errmsg(m, int32(150460), v11+int32(-32))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L21
...
L73:
	;
	F_errfinish(m, int32(518692), v239, int32(486181))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L21
...
L75:
	;
	v258 = *(*int32)(unsafe.Add(mBase, _consts[90]))
...
L81:
	...
	v320 = v318 - v315
	m.G0 = v320
	v323 = *(*int32)(unsafe.Add(mBase, _consts[88]))
...
L82:
	...
	v296 = F_SimpleLruZeroPage(m, int32(4448656), v295)
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L21
...
L93:
	;
	v337 = *(*int32)(unsafe.Add(mBase, _consts[89]))
	v338 = *(*int32)(unsafe.Add(mBase, uint32(v337)+28))
	v340 = int32(*(*uint16)(unsafe.Add(mBase, _consts[91])))
...
L94:
	;
	v349 = int32(*(*uint8)(unsafe.Add(mBase, _consts[85])))
	v351 = base.I64_extend_i32_u(v331)
	v352 = F_SimpleLruZeroPage(m, int32(4448740), v351)
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L21
...
L103:
	;
	v380 = *(*int32)(unsafe.Add(mBase, _consts[90]))
...
L110:
	;
	v445 = *(*int32)(unsafe.Add(mBase, _consts[47]))
...
L111:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v402)+36)) = v261
	v405 = *(*int32)(unsafe.Add(mBase, _consts[152]))
...
L113:
	;
	v413 = *(*int32)(unsafe.Add(mBase, _consts[152]))
	v414 = *(*int32)(unsafe.Add(mBase, uint32(v413)+8))
	v416 = *(*int32)(unsafe.Add(mBase, _consts[139]))
...
L114:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v420))) = uint8(v429)
	v432 = *(*int32)(unsafe.Add(mBase, _consts[139]))
...
L116:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v420)+1)) = uint8(v434)
	v437 = *(*int32)(unsafe.Add(mBase, _consts[139]))
...
func F_TransactionIdGetStatus(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v12 = F_SimpleLruReadPage_ReadOnly(m, int32(4448656), base.I64_extend_i32_u(v10), l0)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
		...
		*(*int64)(unsafe.Add(mBase, uint32(l1))) = v36
		v39 = *(*int32)(unsafe.Add(mBase, _consts[84]))
		v40 = *(*int32)(unsafe.Add(mBase, uint32(v39)+28))
		v42 = int32(*(*uint16)(unsafe.Add(mBase, _consts[86])))
...
L3:
	;
	v13 = *(*int32)(unsafe.Add(mBase, _consts[83]))
	if v13 == l0 {
		goto L4
	} else {
		goto L5
...
L6:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[147]))
	if v18 <= int32(0) {
		goto L8
	} else {
		goto L9
...
L8:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[75]))
	if v22 == int32(0) {
		v126 = int32(0)
		goto L7
	} else {
...
L10:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[148]))
	v97 = int32(0)
	v99 = v18 - int32(1)
	goto L34
L11:
...
func F_TransactionIdSetPageStatusInternal(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int64, l5 int64) {
	...
	v18 = F_SimpleLruReadPage(m, int32(4448656), l5, v17, l0)
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		return
		...
		if l0 == int32(0) {
			...
			if l3 != int32(1) {
				...
				if l1 <= int32(0) {
					...
					v35 = int32(0)
					for {
						v43 = *(*int32)(unsafe.Add(mBase, _consts[84]))
						...
						v64 = int32(*(*uint8)(unsafe.Add(mBase, _consts[85])))
						if v64 == v59 {
							if v58>>(uint(v62)%32)&int32(3) == int32(1) {
								...
								*(*uint8)(unsafe.Add(mBase, uint32(v57))) = uint8(v74)
								if l4 == int64(0) {
									...
									v77 = *(*int32)(unsafe.Add(mBase, _consts[84]))
			...
			if l3 != int32(3) {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v117))) = uint8(v142)
				...
				v126 = int32(*(*uint8)(unsafe.Add(mBase, _consts[85])))
		...
		if int32(0) < l1 {
			v184 = int32(0)
			for {
				v192 = *(*int32)(unsafe.Add(mBase, _consts[84]))
				...
				if l3 != int32(3) {
					...
					*(*uint8)(unsafe.Add(mBase, uint32(v206))) = uint8(v231)
					if l4 == int64(0) {
						...
						v234 = *(*int32)(unsafe.Add(mBase, _consts[84]))
					...
					v215 = int32(*(*uint8)(unsafe.Add(mBase, _consts[85])))
		...
		v264 = *(*int32)(unsafe.Add(mBase, _consts[84]))
...
func F_TransactionTimeoutHandler(m *base.Module) {
	...
	_ = v10
	v2 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[1134])) = v2
...
func F_check_transaction_read_only(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v5 != 0 {
		...
		v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[183])))
		if v7 != int32(1) {
			v63 = v4
			return v63
		} else {
