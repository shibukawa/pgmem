...
func F_numeric_accum_inv(m *base.Module, l0 int32) int32 {
	...
	if v3 != 0 {
		...
		if v24 != 0 {
			...
			F_errmsg_internal(m, int32(353417), int32(0))
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(500163), int32(5558), int32(32748))
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return int32(0)
		...
		*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v45
		...
		if v355 != 0 {
			...
			if v359 != 0 {
				...
				F_errfinish(m, int32(500163), int32(5332), int32(342317))
				mBase = m.M
				v364 = m.ExcPending
				if v364 != 0 {
					return int32(0)
	...
	if v40 != 0 {
		...
		if v169 != 0 {
			...
			if v173 != 0 {
				...
				F_errfinish(m, int32(500163), int32(5497), int32(342166))
				mBase = m.M
				v178 = m.ExcPending
				if v178 != 0 {
					return int32(0)
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+36)) = (v20<<(uint(v292)%32) - int32(8388608)) >> (uint(v292) % 32)
	F_errdetail(m, int32(629007), v18+int32(32))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		goto L34
...
L88:
	;
	F_errsave_finish(m, v21, int32(500163), int32(8138), int32(314116))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L34
...
L92:
	;
	F_errsave_finish(m, v21, int32(500163), v1354, int32(206503))
	mBase = m.M
	v1357 = m.ExcPending
	if v1357 != 0 {
		goto L34
...
L252:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = int32(491022)
	F_errmsg(m, int32(725181), v18+int32(16))
	mBase = m.M
	v1245 = m.ExcPending
	if v1245 != 0 {
		goto L34
...
L285:
	;
	F_errsave_finish(m, v21, int32(500163), int32(795), int32(280100))
	mBase = m.M
	v1445 = m.ExcPending
	if v1445 != 0 {
		goto L34
...
L292:
	;
	F_errsave_finish(m, v21, int32(500163), int32(806), int32(280100))
	mBase = m.M
	v1487 = m.ExcPending
	if v1487 != 0 {
		goto L34
				...
				if v26 != 0 {
					...
					if v17 == int32(-16384) {
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(89162)
						F_errmsg(m, int32(183236), v9)
						mBase = m.M
						v114 = m.ExcPending
						if v114 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(500163), int32(4684), int32(560453))
							mBase = m.M
							v119 = m.ExcPending
							if v119 != 0 {
								return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(89162)
						F_errmsg(m, int32(182559), v7+int32(-48))
						mBase = m.M
						v35 = m.ExcPending
						if v35 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(500163), int32(4688), int32(560453))
							mBase = m.M
							v40 = m.ExcPending
							if v40 != 0 {
								return int32(0)
					...
					if v123 != 0 {
						...
						if v126 != 0 {
							...
							if v130 != 0 {
								...
								F_errfinish(m, int32(500163), int32(4697), int32(560453))
								mBase = m.M
								v135 = m.ExcPending
								if v135 != 0 {
									return int32(0)
						...
						if v139 != 0 {
							...
							if v142 != 0 {
								...
								if v146 != 0 {
									...
									F_errfinish(m, int32(500163), int32(4702), int32(560453))
									mBase = m.M
									v151 = m.ExcPending
									if v151 != 0 {
										return int32(0)
