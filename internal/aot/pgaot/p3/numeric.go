		...
		if v92 == int32(1) {
			...
			*(*int64)(unsafe.Add(mBase, uint32(v9))) = v95
			...
			if v108 != 0 {
				...
				v109 = int32(_a_F_do_numeric_accum_6)
				v110 = *(*int32)(unsafe.Add(mBase, _c_F_do_numeric_accum[0]))
				v112 = *(*int32)(unsafe.Add(mBase, uint32(l0)+4))
				*(*int32)(unsafe.Add(mBase, _c_F_do_numeric_accum[0])) = v112
				...
				if v123 != 0 {
					...
					if v124 == int32(1) {
						...
						if v130 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _c_F_do_numeric_accum[0])) = v110
							m.G0 = v9 + int32(48)
							return
						}
					} else {
	...
	if v41 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = v45
				...
				if v110 != 0 {
					...
					if v116 != 0 {
						...
						if v122 != 0 {
							...
							v126 = int32(24)
							v128 = int32(_a_F_numeric_avg_serialize_0)
							v130 = int32(8)
		...
		if v355 != 0 {
			...
			F_errmsg_internal(m, int32(_a_F_numeric_avg_serialize_1), int32(0))
			mBase = m.M
			v359 = m.ExcPending
			if v359 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_numeric_avg_serialize_2), int32(_a_F_numeric_avg_serialize_3), int32(_a_F_numeric_avg_serialize_4))
				mBase = m.M
				v364 = m.ExcPending
				if v364 != 0 {
					return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v90
			...
			if v94 != 0 {
				...
				*(*uint8)(unsafe.Add(mBase, uint32(v93))) = uint8(v95)
				v98 = *(*int32)(unsafe.Add(mBase, _c_F_numeric_deserialize[0]))
...
L2:
	;
	v56 = v27 + int32(1)
	v57 = int32(_a_F_numeric_in_0)
	v58 = int32(_a_F_numeric_in_1)
	goto L1
L3:
	;
...
L31:
	;
	v127 = F_make_result_opt_error(m, int32(_a_F_numeric_in_4), int32(0))
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L34
...
L80:
	...
	if v274 == int32(_a_F_numeric_in_7) {
		v1505 = v18
		v1507 = v248
		goto L8
	} else {
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+32)) = int32(base.Ui32(v20-int32(4)) >> (uint(int32(16)) % 32))
	v292 = int32(21)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+36)) = (v20<<(uint(v292)%32) - int32(_a_F_numeric_in_9)) >> (uint(v292) % 32)
	F_errdetail(m, int32(_a_F_numeric_in_10), v18+int32(32))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		goto L34
...
L92:
	;
	F_errsave_finish(m, v21, int32(_a_F_numeric_in_11), v1354, int32(_a_F_numeric_in_14))
	mBase = m.M
	v1357 = m.ExcPending
	if v1357 != 0 {
		goto L34
...
L140:
	...
	if int32(_a_F_numeric_in_15) < v525 {
		goto L93
	} else {
		goto L141
	}
...
L179:
	...
	if int32(_a_F_numeric_in_15) < v779 {
		goto L93
	} else {
		goto L180
	}
...
L222:
	...
	if int32(_a_F_numeric_in_15) < v1042 {
		goto L93
	} else {
		goto L223
	}
...
L252:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = int32(_a_F_numeric_in_16)
	F_errmsg(m, int32(_a_F_numeric_in_17), v18+int32(16))
	mBase = m.M
	v1245 = m.ExcPending
	if v1245 != 0 {
		goto L34
...
L253:
	;
	v1354 = int32(_a_F_numeric_in_18)
	goto L92
L254:
	;
	v1267 = v1254 - int32(2)
...
L257:
	...
	if int32(_a_F_numeric_in_15) < v1304 {
		goto L93
	} else {
		goto L258
	}
...
L266:
	;
	v1354 = int32(_a_F_numeric_in_20)
	goto L92
L267:
	;
	v1359 = v18
...
L291:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = int32(_a_F_numeric_in_16)
	F_errmsg(m, int32(_a_F_numeric_in_17), v18)
	mBase = m.M
	v1482 = m.ExcPending
	if v1482 != 0 {
		goto L34
			...
			if v26 == v25 {
				if v24 != int32(_a_F_numeric_larger_1) {
					if v24 != int32(_a_F_numeric_larger_0) {
						...
						v164 = base.B2i32(v23 != int32(_a_F_numeric_larger_0))
					}
				} else {
					if v23 == int32(_a_F_numeric_larger_0) {
						v40 = int32(-1)
					} else {
						v40 = base.B2i32(v23 != int32(_a_F_numeric_larger_1))
					}
					v164 = v40
				}
			} else {
				if base.Ui32(int32(_a_F_numeric_larger_0)) <= base.Ui32(v23) {
					if v23 == int32(_a_F_numeric_larger_2) {
						v52 = int32(1)
					} else {
						v52 = int32(-1)
					...
					v104 = v23 & int32(_a_F_numeric_larger_0)
					if v104 == int32(_a_F_numeric_larger_3) {
						v107 = v23 << (uint(int32(1)) % 32) & int32(_a_F_numeric_larger_4)
					} else {
						v107 = v104
					}
					if base.Ui32(v75) <= base.Ui32(int32(1)) {
						if base.Ui32(v98) < base.Ui32(int32(2)) {
							...
							if v107 == int32(_a_F_numeric_larger_4) {
								v117 = int32(1)
							} else {
								v117 = int32(-1)
							}
						...
						if v26 == int32(_a_F_numeric_larger_3) {
							v124 = v24 << (uint(int32(1)) % 32) & int32(_a_F_numeric_larger_4)
						} else {
							v124 = v26
						}
...
L2:
	...
	if base.Ui32(int32(_a_F_numeric_min_scale_0)) <= base.Ui32(v12) {
		goto L3
	} else {
		goto L4
	}
		...
		if v13 == int32(0) {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v29)
			...
			if v16+(v17+v18) != int64(0)-v22 {
				if int64(0) < v17 {
					v36 = F_make_result_opt_error(m, int32(_a_F_numeric_sum_0), int32(0))
					mBase = m.M
					v39 = m.ExcPending
					if v39 != 0 {
						return int32(0)
					...
					if v16 <= int64(0) {
						if int64(0) < v16 {
							v52 = F_make_result_opt_error(m, int32(_a_F_numeric_sum_1), int32(0))
							mBase = m.M
							v53 = m.ExcPending
							if v53 != 0 {
								return int32(0)
							...
							if int64(0) < v22 {
								v58 = F_make_result_opt_error(m, int32(_a_F_numeric_sum_2), int32(0))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return int32(0)
						...
						if v22 <= int64(0) {
							...
							v46 = F_make_result_opt_error(m, int32(_a_F_numeric_sum_0), int32(0))
							mBase = m.M
							v47 = m.ExcPending
							if v47 != 0 {
								return int32(0)
