				...
				if v208 == int32(0) {
					...
					if base.Ui32(v208) < base.Ui32(int32(4)) {
						...
						for {
							...
							v259 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v256)+uint32(_consts[1069]))))
							v260 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v249)+2)))
							v263 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v260)+uint32(_consts[1069]))))
							v264 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v249)+1)))
							v267 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v264)+uint32(_consts[1069]))))
							v268 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v249))))
							v271 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v268)+uint32(_consts[1069]))))
					...
					if v42 == int32(0) {
						...
						if base.Ui32(v42) < base.Ui32(int32(4)) {
							...
							for {
								...
								v70 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v67)+uint32(_consts[1069]))))
								v71 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v61)+2)))
								v74 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v71)+uint32(_consts[1069]))))
								v75 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v61)+1)))
								v78 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v75)+uint32(_consts[1069]))))
								v79 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v61))))
								v82 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v79)+uint32(_consts[1069]))))
						...
						if v55 == int32(0) {
							...
							for {
								...
								v110 = int64(*(*uint8)(unsafe.Add(mBase, uint32(v107)+uint32(_consts[1069]))))
								v111 = v106 + v110
								v112 = int32(1)
								v115 = v102 + v112
								if v115 != v55 {
