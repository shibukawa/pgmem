...
func F_win1250_to_latin2(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(29), int32(9), int32(2276160), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(23), int32(25), int32(2271632), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_koi8r(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(23), int32(22), int32(2270864), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_mic(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_latin2mic_with_table(m, v6, v5, v10, int32(139), int32(23), int32(2270864), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = int32(107193)
	v18 = *(*int32)(unsafe.Add(mBase, _consts[140]))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+36)) = v18
	v26 = F_pg_snprintf(m, v11+int32(1136), int32(1024), int32(489446), v11+int32(32))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L9
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+68)) = int32(107193)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+72)) = v44
	v52 = F_pg_snprintf(m, v11+int32(1136), int32(1024), int32(489437), v11-int32(-64))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L9
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(107193)
	v36 = F_pg_snprintf(m, v11+int32(112), int32(1024), int32(188105), v11+int32(16))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L9
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+52)) = int32(107193)
	v57 = *(*int32)(unsafe.Add(mBase, _consts[1101]))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v57
	v65 = F_pg_snprintf(m, v11+int32(112), int32(1024), int32(188074), v11+int32(48))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L9
...
L21:
	;
	F_errdetail(m, int32(656215), int32(0))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L9
...
L22:
	;
	F_errfinish(m, int32(525101), int32(6635), int32(406082))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L9
...
L96:
	;
	F_errfinish(m, int32(525101), int32(6647), int32(406082))
	mBase = m.M
	v383 = m.ExcPending
	if v383 != 0 {
		goto L9
...
L100:
	;
	F_errfinish(m, int32(525101), int32(6750), int32(406082))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L9
