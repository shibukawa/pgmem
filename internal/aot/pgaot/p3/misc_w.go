...
func F_WaitLatch(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[844]))
	v13 = int32(1)
	...
	if v22 != 0 {
		...
		if v24 == int32(1) {
			v28 = *(*int32)(unsafe.Add(mBase, _consts[844]))
			...
			if v34 != 0 {
				...
				v36 = *(*int32)(unsafe.Add(mBase, _consts[844]))
				if l1&int32(8) != 0 {
					v40 = l2
				} else {
					v40 = int32(-1)
...
func F_win1250_to_latin2(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(29), int32(9), int32(2276192), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_iso(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(23), int32(25), int32(2271664), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_koi8r(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(23), int32(22), int32(2270896), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win1251_to_mic(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_latin2mic_with_table(m, v6, v5, v10, int32(139), int32(23), int32(2270896), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_write_relcache_init_file(m *base.Module, l0 int32) {
	...
	v11 = v9 - int32(2160)
	m.G0 = v11
	v14 = *(*int32)(unsafe.Add(mBase, _consts[1100]))
	if v14 != 0 {
		goto L3
	} else {
		goto L4
...
L5:
	...
	v69 = F_unlink(m, v68)
	mBase = m.M
	v73 = F_AllocateFile(m, v68, int32(34101))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L9
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = int32(107204)
	v18 = *(*int32)(unsafe.Add(mBase, _consts[140]))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+36)) = v18
	v26 = F_pg_snprintf(m, v11+int32(1136), int32(1024), int32(489887), v11+int32(32))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L9
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+68)) = int32(107204)
	v41 = *(*int32)(unsafe.Add(mBase, _consts[1101]))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+64)) = v41
	v44 = *(*int32)(unsafe.Add(mBase, _consts[140]))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+72)) = v44
	v52 = F_pg_snprintf(m, v11+int32(1136), int32(1024), int32(489878), v11-int32(-64))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L9
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = int32(107204)
	v36 = F_pg_snprintf(m, v11+int32(112), int32(1024), int32(188269), v11+int32(16))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L9
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+52)) = int32(107204)
	v57 = *(*int32)(unsafe.Add(mBase, _consts[1101]))
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v57
	v65 = F_pg_snprintf(m, v11+int32(112), int32(1024), int32(188238), v11+int32(48))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L9
...
L21:
	;
	F_errdetail(m, int32(656978), int32(0))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L9
...
L22:
	;
	F_errfinish(m, int32(525547), int32(6635), int32(406503))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L9
...
L25:
	;
	v113 = *(*int32)(unsafe.Add(mBase, _consts[1096]))
...
L39:
	;
	v141 = int32(0)
	v147 = *(*int32)(unsafe.Add(mBase, _consts[1102]))
	v149 = v147 - int32(1)
	if v149 < v141 {
		v180 = v141
		goto L41
...
L43:
	...
	v161 = v160 + v153
	v166 = *(*int32)(unsafe.Add(mBase, uint32(v161<<(uint(v159)%32))+uint32(_consts[1103])))
...
L87:
	;
	v339 = *(*int32)(unsafe.Add(mBase, _consts[1100]))
	if v339 == int32(0) {
		goto L89
	} else {
		goto L90
...
L96:
	;
	F_errfinish(m, int32(525547), int32(6647), int32(406503))
	mBase = m.M
	v383 = m.ExcPending
	if v383 != 0 {
		goto L9
...
L100:
	;
	F_errfinish(m, int32(525547), int32(6750), int32(406503))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L9
