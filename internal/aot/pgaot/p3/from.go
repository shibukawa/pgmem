...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+80)) = v98
	F_errmsg(m, int32(_a_F_CopyFromCSVOneRow_0), v23+int32(80))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L11
...
L96:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v23)+32)) = v357
	F_errmsg(m, int32(_a_F_CopyFromCSVOneRow_3), v23+int32(32))
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L11
...
L103:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v23)+16)) = v382
	F_errmsg(m, int32(_a_F_CopyFromCSVOneRow_5), v23+int32(16))
	mBase = m.M
	v390 = m.ExcPending
	if v390 != 0 {
		goto L11
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v248 + int32(4)
	F_errmsg(m, int32(_a_F_CopyFromCSVOneRow_6), v23)
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L11
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+48)) = v51
	F_errmsg(m, int32(_a_F_CopyFromCSVOneRow_9), v23+int32(48))
	mBase = m.M
	v531 = m.ExcPending
	if v531 != 0 {
		goto L11
...
L93:
	;
	v310 = int32(_a_F_get_from_clause_item_10)
	goto L95
L94:
	;
	v310 = int32(_a_F_get_from_clause_item_11)
	goto L95
L95:
	;
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v363
	F_appendStringInfo(m, v352, int32(_a_F_get_from_clause_item_13), v15+int32(32))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L8
...
L108:
	...
	F_appendStringInfoString(m, v352, int32(_a_F_get_from_clause_item_4))
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L8
...
L114:
	;
	F_appendStringInfoString(m, v352, int32(_a_F_get_from_clause_item_14))
	mBase = m.M
	v433 = m.ExcPending
	if v433 != 0 {
		goto L8
...
L127:
	...
	case 0:
		goto L129
	case 1:
		v500 = int32(_a_F_get_from_clause_item_15)
		goto L128
	case 2:
		goto L132
	case 3:
...
L131:
	;
	v500 = int32(_a_F_get_from_clause_item_16)
	goto L128
L132:
	;
	v500 = int32(_a_F_get_from_clause_item_17)
	goto L128
L133:
	;
...
L136:
	;
	v499 = int32(_a_F_get_from_clause_item_20)
	goto L138
L137:
	;
	v499 = int32(_a_F_get_from_clause_item_21)
	goto L138
L138:
	;
	v500 = v499
...
L41:
	...
	if v131 == v107&int32(_a_F_prepare_sort_from_pathkeys_4) {
		v145 = v130
		goto L33
	} else {
		goto L43
