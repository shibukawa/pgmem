...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v163))) = v157
	v169 = F_open(m, int32(275211), v157, v163)
	mBase = m.M
	if v169 != int32(-1) {
		goto L50
	} else {
...
L99:
	;
	v372 = F_pushf_create(m, v11+int32(8), int32(4336412), l0, v356)
	mBase = m.M
	v373 = m.ExcPending
	if v373 != 0 {
		goto L6
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+12)) = v376
	v381 = F_pushf_create(m, v11+int32(8), int32(4336428), l0, v376)
	mBase = m.M
	v382 = m.ExcPending
	if v382 != 0 {
		goto L6
...
L104:
	;
	v393 = F_pushf_create(m, v11+int32(8), int32(4336444), l0, v385)
	mBase = m.M
	v394 = m.ExcPending
	if v394 != 0 {
		goto L6
...
L109:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v427))) = v421
	v433 = F_open(m, int32(275211), v421, v427)
	mBase = m.M
	if v433 != int32(-1) {
		goto L114
	} else {
...
L139:
	;
	v521 = F_pushf_create(m, v505+int32(8), int32(4336412), l0, v497)
	mBase = m.M
	v522 = m.ExcPending
	if v522 != 0 {
		goto L6
...
L157:
	;
	v587 = F_pushf_create(m, v11+int32(276), int32(4336412), l0, v551)
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L6
...
L167:
	;
	v613 = F_pushf_create(m, v11+int32(8), int32(4336460), l0, v597)
	mBase = m.M
	v614 = m.ExcPending
	if v614 != 0 {
		goto L6
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v123
	F_px_debug(m, int32(446129), v20+int32(16))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L2
...
L62:
	...
	v183 = F_pullf_create(m, v20+int32(108), int32(4336364), v182, v91)
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L2
...
L65:
	;
	F_px_debug(m, int32(354053), int32(0))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L2
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v215
	F_px_debug(m, int32(461897), v20+int32(32))
	mBase = m.M
	v759 = m.ExcPending
	if v759 != 0 {
		goto L2
...
L117:
	;
	F_px_debug(m, int32(434663), int32(0))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L2
...
L182:
	;
	F_px_debug(m, int32(434640), int32(0))
	mBase = m.M
	v744 = m.ExcPending
	if v744 != 0 {
		goto L2
...
func F_pgp_write_pubenc_sesskey(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = v3
	if v10 == v3 {
		F_px_debug(m, int32(712258), int32(0))
		mBase = m.M
		v22 = m.ExcPending
		if v22 != 0 {
			return int32(0)
