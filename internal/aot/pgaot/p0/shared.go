...
L28:
	;
	v108 = *(*int32)(unsafe.Add(mBase, _consts[223]))
	if v104 == v108 {
		goto L27
	} else {
		goto L29
...
L37:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v132)+12)) = uint8(v137)
	...
	v141 = *(*int32)(unsafe.Add(mBase, _consts[223]))
...
L69:
	;
	F_errfinish(m, int32(523155), int32(704), int32(178522))
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L9
