...
L21:
	;
	F_appendStringInfoString(m, v10, int32(715136))
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
		goto L1
...
L18:
	;
	F_errmsg(m, int32(418103), int32(0))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L1
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(100)
	F_errdetail(m, int32(618157), v10)
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L1
...
L20:
	;
	F_errfinish(m, int32(522434), int32(371), int32(37979))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L1
...
func F_cube_yy_scan_bytes(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.Ui32(l1) < base.Ui32(int32(-2)) {
		...
		if v18 != 0 {
			...
			if v15 == int32(0) {
				F_yy_fatal_error_6(m, int32(712635))
				mBase = m.M
				v122 = m.ExcPending
				if v122 != 0 {
					return int32(0)
				...
				*(*uint16)(unsafe.Add(mBase, uint32(l1+v15))) = uint16(v108)
				...
				if v111 != 0 {
					...
					if v110 == int32(0) {
						F_yy_fatal_error_6(m, int32(712676))
						mBase = m.M
						v125 = m.ExcPending
						if v125 != 0 {
							return int32(0)
		...
		F_yy_fatal_error_6(m, int32(712706))
		mBase = m.M
		v119 = m.ExcPending
		if v119 != 0 {
			return int32(0)
	...
	if v4 == int32(0) {
		...
		if v9 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v8
			if v8 == int32(0) {
				F_yy_fatal_error_6(m, int32(713355))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
