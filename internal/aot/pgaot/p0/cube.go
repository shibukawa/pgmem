...
L10:
	;
	F_appendStringInfoString(m, v10, int32(_a_F_cube_out_0))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L1
...
L21:
	;
	F_appendStringInfoString(m, v10, int32(_a_F_cube_out_1))
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
		goto L1
...
func F_cube_yy_scan_bytes(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.Ui32(l1) < base.Ui32(int32(-2)) {
		...
		F_yy_fatal_error_6(m, int32(_a_F_cube_yy_scan_bytes_2))
		mBase = m.M
		v119 = m.ExcPending
		if v119 != 0 {
			return int32(0)
