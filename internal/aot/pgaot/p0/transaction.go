	...
	case 0, 2, 6, 8, 9, 10, 11, 13, 14, 16, 17, 18, 19:
		...
		if v33 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = v44
			F_errmsg_internal(m, int32(183497), v5)
			mBase = m.M
			v48 = m.ExcPending
			if v48 != 0 {
				return
			} else {
				F_errfinish(m, int32(482378), int32(3974), int32(309973))
				mBase = m.M
				v53 = m.ExcPending
				if v53 != 0 {
					return
		...
		if v15 != 0 {
			...
			if v14 == int32(0) {
				...
				if v20 != 0 {
					...
					F_errmsg(m, int32(124972), int32(0))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
					} else {
						F_errfinish(m, int32(482378), int32(3956), int32(309973))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v42
	F_errmsg_internal(m, int32(183626), v10)
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L19
...
L25:
	;
	F_errfinish(m, int32(482378), int32(3194), int32(305886))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L19
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v190
	F_errmsg_internal(m, int32(183626), v10+int32(16))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L19
...
L60:
	;
	F_errfinish(m, int32(482378), int32(3360), int32(305886))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L19
...
L9:
	;
	F_pairingheap_remove(m, int32(4135160), v16+int32(52))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L10
...
L29:
	;
	v374 = F_GetSnapshotData(m, int32(4464624))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L10
...
L33:
	;
	v265 = F_GetSnapshotData(m, int32(4464624))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L10
...
L43:
	;
	v225 = F_GetSerializableTransactionSnapshotInt(m, int32(4464624), int32(0), int32(-1))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L10
...
L45:
	;
	v107 = F_GetSerializableTransactionSnapshotInt(m, int32(4464624), int32(0), int32(-1))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L10
...
L73:
	;
	F_errmsg_internal(m, int32(364543), int32(0))
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L10
...
L74:
	;
	F_errfinish(m, int32(487437), int32(1605), int32(85528))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L10
...
L76:
	;
	v218 = F_GetSerializableTransactionSnapshotInt(m, int32(4464624), int32(0), int32(-1))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L10
...
L81:
	;
	F_errmsg(m, int32(22821), int32(0))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L10
...
L82:
	;
	F_errdetail(m, int32(640014), int32(0))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L10
...
L83:
	;
	F_errhint(m, int32(553267), int32(0))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L10
...
L84:
	;
	F_errfinish(m, int32(487437), int32(1697), int32(85443))
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L10
...
L99:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v295)+48)) = v359
	F_pairingheap_add(m, int32(4135160), v295+int32(52))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L10
...
L115:
	;
	v443 = F_GetSnapshotData(m, int32(4464624))
	mBase = m.M
	v444 = m.ExcPending
	if v444 != 0 {
		goto L10
...
L116:
	;
	F_pairingheap_remove(m, int32(4135160), v395+int32(52))
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L10
...
L128:
	;
	F_errmsg_internal(m, int32(254176), int32(0))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L10
...
L129:
	;
	F_errfinish(m, int32(484011), int32(306), int32(85385))
	mBase = m.M
	v460 = m.ExcPending
	if v460 != 0 {
		goto L10
			...
			if v72 != 0 {
				...
				if v76 != 0 {
					...
					if v79 != 0 {
						...
						F_errmsg(m, int32(252123), int32(0))
						mBase = m.M
						v83 = m.ExcPending
						if v83 != 0 {
							return
						} else {
							F_errfinish(m, int32(482378), int32(5438), int32(252609))
							mBase = m.M
							v88 = m.ExcPending
							if v88 != 0 {
								return
...
func F_SetTransactionSnapshot(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v13 == int32(0) {
		v61 = F_GetSnapshotData(m, int32(4464624))
		mBase = m.M
		v62 = m.ExcPending
		if v62 != 0 {
			return
											...
											if v194 == int32(1) {
												...
												if v202 != 0 {
													...
													if v205 != 0 {
														...
														F_errmsg(m, int32(529152), int32(0))
														mBase = m.M
														v209 = m.ExcPending
														if v209 != 0 {
															return
														} else {
															F_errfinish(m, int32(487437), int32(1748), int32(85408))
															mBase = m.M
															v214 = m.ExcPending
															if v214 != 0 {
																return
												...
												if v198 != 0 {
													...
													if v239 != 0 {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v238)+48)) = v302
														F_pairingheap_add(m, int32(4135160), v238+int32(52))
														mBase = m.M
														v312 = m.ExcPending
														if v312 != 0 {
															return
							...
							if v153 != 0 {
								...
								if v156 != 0 {
									...
									if v160 != 0 {
										...
										F_errdetail(m, int32(604654), int32(0))
										mBase = m.M
										v164 = m.ExcPending
										if v164 != 0 {
											return
										} else {
											F_errfinish(m, int32(484011), int32(568), int32(85362))
											mBase = m.M
											v169 = m.ExcPending
											if v169 != 0 {
												return
							...
							if v331 != 0 {
								...
								if v335 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = l2
									F_errdetail(m, int32(604701), v10)
									mBase = m.M
									v339 = m.ExcPending
									if v339 != 0 {
										return
									} else {
										F_errfinish(m, int32(484011), int32(575), int32(85362))
										mBase = m.M
										v344 = m.ExcPending
										if v344 != 0 {
											return
		...
		F_pairingheap_remove(m, int32(4135160), v13+int32(52))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return
							...
							if v55 != 0 {
								...
								if v54 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
									F_errmsg_internal(m, int32(54755), v7)
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(486038), int32(217), int32(79718))
										mBase = m.M
										v66 = m.ExcPending
										if v66 != 0 {
											return int32(0)
