...
L29:
	;
	v374 = F_GetSnapshotData(m, int32(4562224))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L10
...
L33:
	;
	v265 = F_GetSnapshotData(m, int32(4562224))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L10
...
L43:
	;
	v225 = F_GetSerializableTransactionSnapshotInt(m, int32(4562224), int32(0), int32(-1))
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L10
...
L45:
	;
	v107 = F_GetSerializableTransactionSnapshotInt(m, int32(4562224), int32(0), int32(-1))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L10
...
L76:
	;
	v218 = F_GetSerializableTransactionSnapshotInt(m, int32(4562224), int32(0), int32(-1))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L10
...
L81:
	;
	F_errmsg(m, int32(23992), int32(0))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L10
...
L115:
	;
	v443 = F_GetSnapshotData(m, int32(4562224))
	mBase = m.M
	v444 = m.ExcPending
	if v444 != 0 {
		goto L10
...
func F_SetTransactionSnapshot(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v13 == int32(0) {
		v61 = F_GetSnapshotData(m, int32(4562224))
		mBase = m.M
		v62 = m.ExcPending
		if v62 != 0 {
			return
							...
							if v55 != 0 {
								...
								if v54 == int32(0) {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
									F_errmsg_internal(m, int32(61128), v7)
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return int32(0)
