...
L8:
	;
	v61 = int32(4164444)
	v62 = *(*int32)(unsafe.Add(mBase, _consts[570]))
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _consts[570])) = v79
	goto L15
L17:
	;
	if int32(999) < v62 {
...
L26:
	...
	v103 = *(*int32)(unsafe.Add(mBase, _consts[245]))
...
L8:
	;
	v90 = int32(4164444)
	v91 = *(*int32)(unsafe.Add(mBase, _consts[570]))
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _consts[570])) = v108
	goto L15
L17:
	;
	if int32(999) < v91 {
