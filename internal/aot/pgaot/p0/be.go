...
func F_be_lo_from_bytea(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		if v15 != 0 {
			...
			v17 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _c_F_be_lo_from_bytea[0])) = uint8(v17)
			v20 = v9 + v17
			...
			if v22 != 0 {
				...
				v25 = *(*int32)(unsafe.Add(mBase, _c_F_be_lo_from_bytea[1]))
				v26 = F_inv_open(m, v21, int32(_a_F_be_lo_from_bytea_1), v25)
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return int32(0)
