...
func F_be_lo_create(m *base.Module, l0 int32) int32 {
	...
	F_PreventCommandIfReadOnly(m, int32(658755))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_be_lo_from_bytea(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		F_PreventCommandIfReadOnly(m, int32(659008))
		mBase = m.M
		v15 = m.ExcPending
		if v15 != 0 {
			return int32(0)
		...
		if v43 != 0 {
			...
			if v46 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = v10
				F_errmsg(m, int32(473839), v8)
				mBase = m.M
				v50 = m.ExcPending
				if v50 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(486514), int32(216), int32(310708))
					mBase = m.M
					v55 = m.ExcPending
					if v55 != 0 {
						return int32(0)
						...
						if v59 != 0 {
							...
							if v62 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v10
								F_errmsg(m, int32(462837), v8+int32(16))
								mBase = m.M
								v68 = m.ExcPending
								if v68 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(486514), int32(225), int32(310708))
									mBase = m.M
									v73 = m.ExcPending
									if v73 != 0 {
										return int32(0)
...
func F_be_lo_truncate(m *base.Module, l0 int32) int32 {
	...
	F_PreventCommandIfReadOnly(m, int32(658775))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
...
func F_be_lo_truncate64(m *base.Module, l0 int32) int32 {
	...
	F_PreventCommandIfReadOnly(m, int32(659177))
	mBase = m.M
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
