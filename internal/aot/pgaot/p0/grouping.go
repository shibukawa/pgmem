...
L49:
	...
	v162 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_gather_grouping_paths[0])))
	if v162 == int32(1) {
		goto L63
	} else {
		goto L64
...
L55:
	;
	v134 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_gather_grouping_paths[1])))
	if v134 == int32(0) {
		goto L15
	} else {
		goto L56
...
L58:
	;
	v142 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_gather_grouping_paths[1])))
	if v142&int32(1) != 0 {
		goto L50
	} else {
		goto L59
