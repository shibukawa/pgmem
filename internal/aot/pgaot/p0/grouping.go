...
L60:
	;
	F_errmsg(m, int32(321564), int32(0))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L26
...
L62:
	;
	F_errfinish(m, int32(524089), int32(1727), int32(233153))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L26
...
L49:
	...
	v162 = int32(*(*uint8)(unsafe.Add(mBase, _consts[378])))
	if v162 == int32(1) {
		goto L63
	} else {
		goto L64
...
L55:
	;
	v134 = int32(*(*uint8)(unsafe.Add(mBase, _consts[391])))
	if v134 == int32(0) {
		goto L15
	} else {
		goto L56
...
L58:
	;
	v142 = int32(*(*uint8)(unsafe.Add(mBase, _consts[391])))
	if v142&int32(1) != 0 {
		goto L50
	} else {
		goto L59
