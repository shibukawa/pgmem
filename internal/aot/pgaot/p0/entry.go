...
L9:
	;
	v53 = int32(base.Ui32(v43+int32(262120))>>(uint(int32(2))%32)) & int32(65535)
	goto L11
L10:
	;
	v53 = int32(0)
...
L14:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(l1)+8)) = uint16(v153)
	v167 = *(*int32)(unsafe.Add(mBase, uint32(v153&int32(65535)<<(uint(int32(2))%32)+v35)+20))
	v170 = v35 + v167&int32(32767)
...
L15:
	;
	v67 = int32(base.Ui32(v61+int32(262120)) >> (uint(int32(2)) % 32))
	v69 = v67 & int32(65535)
	if v69 == int32(0) {
		v153 = v36
		goto L14
...
L17:
	;
	v94 = int32(base.Ui32((v81-v79)&int32(65534))>>(uint(int32(1))%32)) + v79
	v96 = v94 & int32(65535)
	if v69 == v96 {
		goto L20
	} else {
...
L33:
	;
	if base.Ui32(v145&int32(65535)) < base.Ui32(v140&int32(65535)) {
		v79 = v145
		v81 = v140
		goto L17
	} else {
