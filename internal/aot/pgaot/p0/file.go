...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v44
	F_errmsg_internal(m, int32(284605), v11+int32(48))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L16:
	;
	F_errfinish(m, int32(476343), int32(2010), int32(343794))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L4
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v122
	F_errmsg(m, int32(284477), v11+int32(32))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L4
...
L32:
	;
	F_errfinish(m, int32(476343), int32(2055), int32(343794))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L4
...
L42:
	;
	F_errfinish(m, int32(476343), int32(1546), int32(386217))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v174
	F_errmsg(m, int32(282964), v11+int32(16))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L4
...
L47:
	;
	F_errfinish(m, int32(476343), int32(2065), int32(343794))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L4
...
L49:
	;
	F_ResourceOwnerForget(m, v190, l0, int32(1586192))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L4
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = int32(223358)
	*(*int64)(unsafe.Add(mBase, uint32(v10)+8)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v10 + int32(1040)
	v43 = F_pg_snprintf(m, v10+int32(16), int32(1024), int32(98479), v10)
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L6
...
L13:
	;
	F_errmsg_internal(m, int32(370943), int32(0))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L9
...
L16:
	;
	F_errfinish(m, int32(476343), int32(2864), int32(371059))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L9
...
L34:
	;
	F_errfinish(m, int32(472560), int32(2133), int32(367720))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L27
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = l1
	F_errmsg(m, int32(492130), v19+int32(32))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L27
...
L45:
	;
	F_errfinish(m, int32(472560), int32(1924), int32(214571))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L27
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = l1
	F_errmsg(m, int32(423302), v19+int32(16))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L27
...
L50:
	;
	F_errfinish(m, int32(472560), int32(1929), int32(214571))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L27
