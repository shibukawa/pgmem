...
L6:
	;
	v56 = int32(_a_F_FileClose_0)
	v58 = *(*int32)(unsafe.Add(mBase, _c_F_FileClose[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_FileClose[1])) = v58 - int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = int32(-1)
	v65 = *(*int32)(unsafe.Add(mBase, _c_F_FileClose[0]))
	v66 = int32(48)
	v68 = v65 + l0*v66
...
L18:
	;
	v85 = int32(_a_F_FileClose_1)
	v87 = *(*int64)(unsafe.Add(mBase, _c_F_FileClose[2]))
	v88 = *(*int64)(unsafe.Add(mBase, uint32(v17)+24))
	*(*int64)(unsafe.Add(mBase, _c_F_FileClose[2])) = v87 - v88
...
L22:
	;
	v98 = v82 & int32(_a_F_FileClose_3)
...
L24:
	;
	v107 = *(*int32)(unsafe.Add(mBase, _c_F_FileClose[3]))
	v109 = v107
	goto L26
L25:
	;
...
L36:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_FileClose[3])) = v109
...
L37:
	...
	v144 = int64(*(*int32)(unsafe.Add(mBase, _c_F_FileClose[4])))
	if v144 < int64(0) {
		goto L21
	} else {
		goto L38
...
L49:
	;
	F_ResourceOwnerForget(m, v190, l0, int32(_a_F_FileClose_2))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L4
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v10 + int32(1040)
	v43 = F_pg_snprintf(m, v10+int32(16), int32(1024), int32(_a_F_FileSetDeleteAll_1), v10)
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L6
...
L11:
	;
	v55 = *(*int32)(unsafe.Add(mBase, _c_F_FileSetDeleteAll[0]))
	if v55 == int32(44) {
		goto L9
	} else {
		goto L14
...
L13:
	;
	v55 = int32(_a_F_FileTruncate_0)
	v57 = *(*int64)(unsafe.Add(mBase, _c_F_FileTruncate[3]))
	*(*int64)(unsafe.Add(mBase, _c_F_FileTruncate[3])) = v57 + (l1 - v53)
...
L17:
	...
	v87 = v85 - int32(32)
	m.G0 = v87
	v89 = int32(_a_F_read_file_data_into_buffer_0)
	v90 = *(*int32)(unsafe.Add(mBase, _c_F_read_file_data_into_buffer[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v90))) = int32(167772163)
	v94 = base.I64_extend_i32_s(v65)
	v96 = F_pread(m, l2, v83+v65, int32(_a_F_read_file_data_into_buffer_1), l3+v94)
	mBase = m.M
	v98 = *(*int32)(unsafe.Add(mBase, _c_F_read_file_data_into_buffer[0]))
	v99 = int32(0)
...
L23:
	;
	v106 = base.B2i32(v96 != int32(_a_F_read_file_data_into_buffer_1))
	goto L25
L24:
	;
	v106 = int32(0)
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v87))) = l1
	F_errmsg(m, int32(_a_F_read_file_data_into_buffer_2), v87)
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L27
...
L30:
	;
	F_errfinish(m, int32(_a_F_read_file_data_into_buffer_3), int32(2128), int32(_a_F_read_file_data_into_buffer_4))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L27
...
L33:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v87)+24)) = int32(_a_F_read_file_data_into_buffer_1)
	*(*int32)(unsafe.Add(mBase, uint32(v87)+20)) = v96
	*(*int32)(unsafe.Add(mBase, uint32(v87)+16)) = l1
	F_errmsg(m, int32(_a_F_read_file_data_into_buffer_5), v87+int32(16))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L27
...
L34:
	;
	F_errfinish(m, int32(_a_F_read_file_data_into_buffer_3), int32(2133), int32(_a_F_read_file_data_into_buffer_4))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L27
...
L45:
	;
	F_errfinish(m, int32(_a_F_read_file_data_into_buffer_3), int32(1924), int32(_a_F_read_file_data_into_buffer_7))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L27
...
L50:
	;
	F_errfinish(m, int32(_a_F_read_file_data_into_buffer_3), int32(1929), int32(_a_F_read_file_data_into_buffer_7))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L27
