...
func F_FileAccess(m *base.Module, l0 int32) int32 {
	...
	var v115 int32
	_ = v115
	v7 = *(*int32)(unsafe.Add(mBase, _consts[194]))
	v10 = v7 + l0*int32(48)
...
L10:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _consts[588]))
	if v40 <= int32(0) {
		goto L4
	} else {
		goto L11
...
L11:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _consts[591]))
...
func F_FileClose(m *base.Module, l0 int32) {
	...
	v11 = v9 - int32(160)
	m.G0 = v11
	v14 = *(*int32)(unsafe.Add(mBase, _consts[194]))
	v17 = v14 + l0*int32(48)
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = int32(-1)
	v65 = *(*int32)(unsafe.Add(mBase, _consts[194]))
	v66 = int32(48)
	v68 = v65 + l0*v66
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v44
	F_errmsg_internal(m, int32(299662), v11+int32(48))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L16:
	;
	F_errfinish(m, int32(500178), int32(2010), int32(361577))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L4
...
L24:
	;
	v107 = *(*int32)(unsafe.Add(mBase, _consts[166]))
	v109 = v107
	goto L26
L25:
	;
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v122
	F_errmsg(m, int32(299534), v11+int32(32))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L4
...
L32:
	;
	F_errfinish(m, int32(500178), int32(2055), int32(361577))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L4
...
L36:
	;
	*(*int32)(unsafe.Add(mBase, _consts[166])) = v109
...
L37:
	...
	v144 = int64(*(*int32)(unsafe.Add(mBase, _consts[590])))
	if v144 < int64(0) {
		goto L21
	} else {
		goto L38
...
L42:
	;
	F_errfinish(m, int32(500178), int32(1546), int32(405847))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v174
	F_errmsg(m, int32(298021), v11+int32(16))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L4
...
L47:
	;
	F_errfinish(m, int32(500178), int32(2065), int32(361577))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L4
...
L49:
	;
	F_ResourceOwnerForget(m, v190, l0, int32(1628736))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L4
...
L51:
	;
	v195 = *(*int32)(unsafe.Add(mBase, _consts[194]))
...
func F_FilePathName(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v3 = *(*int32)(unsafe.Add(mBase, _consts[194]))
...
L5:
	;
	v17 = *(*int32)(unsafe.Add(mBase, _consts[194]))
	goto L6
L6:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[165]))
...
L8:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[165]))
	v43 = int32(0)
...
L12:
	;
	v48 = *(*int32)(unsafe.Add(mBase, _consts[166]))
	if v48 == int32(27) {
		goto L6
	} else {
		goto L15
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = int32(235497)
	*(*int64)(unsafe.Add(mBase, uint32(v10)+8)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v10 + int32(1040)
	v43 = F_pg_snprintf(m, v10+int32(16), int32(1024), int32(106036), v10)
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L6
...
L5:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[165]))
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = l2
	v18 = *(*int32)(unsafe.Add(mBase, _consts[194]))
...
L8:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _consts[165]))
	*(*int32)(unsafe.Add(mBase, uint32(v36))) = int32(0)
	return int32(-1)
L9:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[166]))
	if v32 == int32(27) {
		goto L7
	} else {
		goto L10
...
L12:
	;
	v45 = int32(0)
	v47 = *(*int32)(unsafe.Add(mBase, _consts[194]))
...
L13:
	;
	F_errmsg_internal(m, int32(390378), int32(0))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L9
...
L16:
	;
	F_errfinish(m, int32(500178), int32(2864), int32(390494))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L9
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v90))) = int32(167772163)
	...
	mBase = m.M
	v98 = *(*int32)(unsafe.Add(mBase, _consts[165]))
	v99 = int32(0)
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v87)+16)) = l1
	F_errmsg(m, int32(37134), v87+int32(16))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L27
...
L34:
	;
	F_errfinish(m, int32(496115), int32(2133), int32(387155))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L27
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = l1
	F_errmsg(m, int32(516397), v19+int32(32))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L27
...
L45:
	;
	F_errfinish(m, int32(496115), int32(1924), int32(225499))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L27
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = l1
	F_errmsg(m, int32(444603), v19+int32(16))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L27
...
L50:
	;
	F_errfinish(m, int32(496115), int32(1929), int32(225499))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L27
