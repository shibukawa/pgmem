...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v44
	F_errmsg_internal(m, int32(297611), v11+int32(48))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v122
	F_errmsg(m, int32(297483), v11+int32(32))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L4
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v174
	F_errmsg(m, int32(295970), v11+int32(16))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L4
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = int32(234164)
	*(*int64)(unsafe.Add(mBase, uint32(v10)+8)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v10 + int32(1040)
	v43 = F_pg_snprintf(m, v10+int32(16), int32(1024), int32(105354), v10)
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L6
...
L13:
	;
	F_errmsg_internal(m, int32(387620), int32(0))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L9
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v87)+16)) = l1
	F_errmsg(m, int32(36988), v87+int32(16))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L27
