...
L24:
	;
	F_errfinish(m, int32(493096), int32(1311), int32(100503))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L1
					...
					if v127 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v14)+8)) = v129 + int32(4)
						...
						if v138 != 0 {
							...
							F_errfinish(m, int32(499451), int32(111), int32(385118))
							mBase = m.M
							v143 = m.ExcPending
							if v143 != 0 {
								return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13)+8)) = v20
		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v22
			...
			v116 = int32(8)
			v123 = F_execute(m, v20+v27<<(uint(int32(3))%32)-v116, v13+v116, int32(0), int32(1), int32(7111))
			mBase = m.M
			v124 = m.ExcPending
			if v124 != 0 {
				return int32(0)
...
L18:
	;
	F_errfinish(m, int32(496748), int32(1266), int32(321844))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L15
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v337 ^ v329 - base.I32_rotl(v337, int32(24))
	v349 = F_pg_snprintf(m, v13+int32(-10), int32(10), int32(29625), v13+int32(-32))
	mBase = m.M
	v350 = m.ExcPending
	if v350 != 0 {
		goto L6
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v716 ^ v708 - base.I32_rotl(v716, int32(24))
	v726 = F_pg_snprintf(m, v13+int32(-10), int32(10), int32(29625), v15)
	mBase = m.M
	v727 = m.ExcPending
	if v727 != 0 {
		goto L6
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v19
	F_errmsg_internal(m, int32(482516), v13+int32(-48))
	mBase = m.M
	v821 = m.ExcPending
	if v821 != 0 {
		goto L6
...
L160:
	;
	F_errfinish(m, int32(496748), int32(921), int32(15999))
	mBase = m.M
	v826 = m.ExcPending
	if v826 != 0 {
		goto L6
...
func F_gin_extract_query_varbit(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(1), int32(7108), int32(2661))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
