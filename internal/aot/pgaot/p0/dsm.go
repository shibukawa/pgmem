...
func F_dsm_attach(m *base.Module, l0 int32) int32 {
	...
	var v195 int32
	_ = v195
	v11 = int32(*(*uint8)(unsafe.Add(mBase, _consts[593])))
	if v11 == int32(0) {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v15 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[593])) = uint8(v15)
	goto L3
L2:
	;
	goto L3
...
L5:
	;
	v47 = *(*int32)(unsafe.Add(mBase, _consts[578]))
	if v47 != 0 {
		goto L12
	} else {
		goto L13
...
L14:
	;
	v53 = *(*int32)(unsafe.Add(mBase, _consts[84]))
...
L17:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[594]))
	if v58 == int32(0) {
		goto L18
	} else {
		goto L19
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v55))) = int32(4164404)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v55)+16)) = int64(4294967295)
	v77 = *(*int32)(unsafe.Add(mBase, _consts[578]))
...
L21:
	;
	F_ResourceOwnerRemember(m, v77, v55, int32(1662908))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L15
...
L25:
	;
	v97 = *(*int32)(unsafe.Add(mBase, _consts[596]))
...
L33:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _consts[597]))
...
L44:
	;
	F_errmsg_internal(m, int32(434688), int32(0))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L15
...
L45:
	;
	F_errfinish(m, int32(522019), int32(692), int32(342312))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L15
...
func F_dsm_detach(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[80])) = v8 + int32(1)
...
L3:
	;
	v36 = int32(4556732)
	v38 = *(*int32)(unsafe.Add(mBase, _consts[80]))
	*(*int32)(unsafe.Add(mBase, _consts[80])) = v38 - int32(1)
	v43 = l0 + int32(24)
...
L19:
	;
	v75 = v64 * int32(24)
	v77 = *(*int32)(unsafe.Add(mBase, _consts[596]))
...
L28:
	;
	v122 = *(*int32)(unsafe.Add(mBase, _consts[597]))
	v124 = *(*int32)(unsafe.Add(mBase, _consts[596]))
...
L30:
	;
	v134 = *(*int32)(unsafe.Add(mBase, _consts[596]))
...
L33:
	;
	F_ResourceOwnerForget(m, v147, l0, int32(1662908))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L6
...
func F_dsm_pin_segment(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = v2
	...
	if v17 != 0 {
		...
		v19 = *(*int32)(unsafe.Add(mBase, _consts[596]))
		...
		if v24 != int32(1) {
			...
			if v27&int32(1) == int32(0) {
				...
				v37 = *(*int32)(unsafe.Add(mBase, _consts[596]))
				v38 = v37
				v39 = v33 * int32(24)
			} else {
				v38 = v19
			...
			*(*int32)(unsafe.Add(mBase, uint32(v38+v53*v44)+28)) = v57
			...
			if v71 != 0 {
				...
				F_errmsg_internal(m, int32(473840), int32(0))
				mBase = m.M
				v75 = m.ExcPending
				if v75 != 0 {
					return
				} else {
					F_errfinish(m, int32(522019), int32(967), int32(101518))
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return
