...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v55))) = int32(4126868)
...
L21:
	;
	F_ResourceOwnerRemember(m, v77, v55, int32(1630476))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L15
...
L44:
	;
	F_errmsg_internal(m, int32(415853), int32(0))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L15
...
L45:
	;
	F_errfinish(m, int32(498565), int32(692), int32(327047))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L15
...
L33:
	;
	F_ResourceOwnerForget(m, v147, l0, int32(1630476))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L6
			...
			*(*int32)(unsafe.Add(mBase, uint32(v38+v53*v44)+28)) = v57
			...
			if v71 != 0 {
				...
				if v75 != 0 {
					...
					F_errfinish(m, int32(498565), int32(967), int32(95477))
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return
