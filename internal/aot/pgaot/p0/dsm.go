...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v55))) = int32(4104660)
...
L21:
	;
	F_ResourceOwnerRemember(m, v77, v55, int32(1612348))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L15
...
L44:
	;
	F_errmsg_internal(m, int32(414092), int32(0))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L15
...
L45:
	;
	F_errfinish(m, int32(496484), int32(692), int32(325646))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L15
...
L33:
	;
	F_ResourceOwnerForget(m, v147, l0, int32(1612348))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L6
		...
		if v24 != int32(1) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v38+v53*v44)+28)) = v57
			...
			if v71 != 0 {
				...
				F_errmsg_internal(m, int32(451745), int32(0))
				mBase = m.M
				v75 = m.ExcPending
				if v75 != 0 {
					return
				} else {
					F_errfinish(m, int32(496484), int32(967), int32(94969))
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return
