...
L5:
	;
	v47 = *(*int32)(unsafe.Add(mBase, _consts[579]))
	if v47 != 0 {
		goto L12
	} else {
		goto L13
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v55))) = int32(4155204)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v55)+16)) = int64(4294967295)
	v77 = *(*int32)(unsafe.Add(mBase, _consts[579]))
...
L21:
	;
	F_ResourceOwnerRemember(m, v77, v55, int32(1656700))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L15
...
L44:
	;
	F_errmsg_internal(m, int32(431015), int32(0))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L15
...
L45:
	;
	F_errfinish(m, int32(517515), int32(692), int32(339473))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L15
...
L33:
	;
	F_ResourceOwnerForget(m, v147, l0, int32(1656700))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L6
		...
		if v24 != int32(1) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v38+v53*v44)+28)) = v57
			...
			if v71 != 0 {
				...
				F_errmsg_internal(m, int32(469907), int32(0))
				mBase = m.M
				v75 = m.ExcPending
				if v75 != 0 {
					return
				} else {
					F_errfinish(m, int32(517515), int32(967), int32(100938))
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return
