...
func F_dsm_attach(m *base.Module, l0 int32) int32 {
	...
	var v195 int32
	_ = v195
	v11 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_dsm_attach[0])))
	if v11 == int32(0) {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v15 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_dsm_attach[0])) = uint8(v15)
	goto L3
L2:
	;
	goto L3
L3:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[1]))
	if v18 == int32(0) {
		goto L5
	} else {
		goto L6
...
L5:
	;
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[2]))
	if v47 != 0 {
		goto L12
	} else {
		goto L13
...
L6:
	;
	if v18 == int32(_a_F_dsm_attach_0) {
		goto L5
	} else {
		goto L7
	}
...
L10:
	...
	if v34 != int32(_a_F_dsm_attach_0) {
		v24 = v34
		goto L8
	} else {
		goto L11
...
L14:
	;
	v53 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[3]))
...
L17:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[1]))
	if v58 == int32(0) {
		goto L18
	} else {
		goto L19
...
L18:
	;
	v61 = int32(_a_F_dsm_attach_0)
	*(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[4])) = v61
	v65 = v61
	goto L20
L19:
	;
...
L21:
	;
	F_ResourceOwnerRemember(m, v77, v55, int32(_a_F_dsm_attach_1))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L15
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v55)+32)) = v87
	v90 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[5]))
	v94 = F_LWLockAcquire(m, v90+int32(_a_F_dsm_attach_2), v87)
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L15
...
L25:
	;
	v97 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[6]))
...
L26:
	;
	v158 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[5]))
	F_LWLockRelease(m, v158+int32(_a_F_dsm_attach_2))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L15
...
L33:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_attach[7]))
...
L19:
	;
	v75 = v64 * int32(24)
	v77 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_detach[2]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = int32(-1)
	v88 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_detach[1]))
	F_LWLockRelease(m, v88+int32(_a_F_dsm_detach_1))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L6
...
L24:
	;
	v112 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_detach[1]))
	v116 = F_LWLockAcquire(m, v112+int32(_a_F_dsm_detach_1), int32(0))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L6
...
L28:
	;
	v122 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_detach[3]))
	v124 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_detach[2]))
...
L30:
	;
	v134 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_detach[2]))
...
L33:
	;
	F_ResourceOwnerForget(m, v147, l0, int32(_a_F_dsm_detach_2))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L6
	...
	if v17 != 0 {
		...
		if v24 != int32(1) {
			...
			if v27&int32(1) == int32(0) {
				...
				v37 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_pin_segment[1]))
				v38 = v37
				v39 = v33 * int32(24)
			} else {
				v38 = v19
			...
			*(*int32)(unsafe.Add(mBase, uint32(v38+v53*v44)+28)) = v57
			v60 = *(*int32)(unsafe.Add(mBase, _c_F_dsm_pin_segment[0]))
			F_LWLockRelease(m, v60+int32(_a_F_dsm_pin_segment_0))
			mBase = m.M
			v64 = m.ExcPending
			if v64 != 0 {
				return
