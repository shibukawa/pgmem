...
func F_EventCacheLookup(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+24)) = l0
	v18 = *(*int32)(unsafe.Add(mBase, _consts[867]))
	if v18 == int32(2) {
		goto L3
	} else {
		goto L4
...
L3:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[868]))
	v522 = v22
	goto L2
L4:
	;
...
L5:
	;
	v24 = *(*int32)(unsafe.Add(mBase, _consts[869]))
	if v24 != 0 {
		goto L7
	} else {
		goto L8
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, _consts[867])) = int32(1)
	v53 = int32(4549024)
	v54 = *(*int32)(unsafe.Add(mBase, _consts[0]))
	v57 = *(*int32)(unsafe.Add(mBase, _consts[869]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v57
	v67 = F_hash_create(m, int32(336987), int32(32), v14+int32(40), int32(1064))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L10
...
L9:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[204]))
	if v31 != 0 {
		goto L12
	} else {
		goto L13
...
L14:
	;
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(415926), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L10
...
L15:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _consts[204]))
	v36 = v35
	goto L14
L16:
	;
	*(*int32)(unsafe.Add(mBase, _consts[869])) = v41
...
L29:
	...
	v104 = v98 + int32(68)
	v105 = int32(88302)
	v108 = int32(*(*uint8)(unsafe.Add(mBase, _consts[870])))
...
L39:
	;
	v134 = int32(444205)
	v137 = int32(*(*uint8)(unsafe.Add(mBase, _consts[871])))
...
L48:
	;
	v163 = int32(244338)
	v166 = int32(*(*uint8)(unsafe.Add(mBase, _consts[872])))
...
L57:
	;
	v192 = int32(364055)
	v195 = int32(*(*uint8)(unsafe.Add(mBase, _consts[873])))
...
L66:
	;
	v220 = int32(287475)
	v223 = int32(*(*uint8)(unsafe.Add(mBase, _consts[874])))
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = base.I32_extend16_s(v284)
	F_errmsg_internal(m, int32(501949), v14+int32(16))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L10
...
L117:
	;
	v416 = (v386 - int32(1667408)) >> (uint(int32(3)) % 32)
	goto L111
L118:
	;
	goto L119
...
L141:
	;
	*(*int32)(unsafe.Add(mBase, _consts[868])) = v67
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v54
	v511 = *(*int32)(unsafe.Add(mBase, _consts[867]))
	if v511 != int32(1) {
		v522 = v67
		goto L2
	} else {
...
L142:
	;
	*(*int32)(unsafe.Add(mBase, _consts[867])) = int32(2)
	v522 = v67
	goto L2
L143:
	;
...
L147:
	;
	F_errmsg_internal(m, int32(25153), int32(0))
	mBase = m.M
	v548 = m.ExcPending
	if v548 != 0 {
		goto L10
...
L148:
	;
	F_errfinish(m, int32(519605), int32(231), int32(111863))
	mBase = m.M
	v553 = m.ExcPending
	if v553 != 0 {
		goto L10
...
L2:
	...
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(65884), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v32
	F_errmsg_internal(m, int32(56312), v12+int32(16))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L10:
	;
	F_errfinish(m, int32(515466), int32(1095), int32(414439))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L16:
	...
	mBase = m.M
	v93 = int32(4528800)
	v94 = *(*int64)(unsafe.Add(mBase, _consts[262]))
	...
	*(*int64)(unsafe.Add(mBase, _consts[262])) = v96 + v103
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v145
	F_errmsg_internal(m, int32(56312), v12)
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L37:
	...
	mBase = m.M
	v203 = int32(4528800)
	v204 = *(*int64)(unsafe.Add(mBase, _consts[262]))
	...
	*(*int64)(unsafe.Add(mBase, _consts[262])) = v206 + v213
...
L2:
	;
	v21 = *(*int32)(unsafe.Add(mBase, _consts[765]))
...
L7:
	;
	v98 = *(*int32)(unsafe.Add(mBase, _consts[765]))
...
func F_InitializeWaitEventSupport(m *base.Module) {
	...
	v4 = v2 + int32(-64)
	m.G0 = v4
	v7 = int32(*(*uint8)(unsafe.Add(mBase, _consts[120])))
	if v7 != int32(1) {
	} else {
		v11 = *(*int32)(unsafe.Add(mBase, _consts[624]))
		if v11 == int32(0) {
		} else {
			v14 = int32(4155232)
			v15 = *(*int32)(unsafe.Add(mBase, _consts[625]))
			v16 = F_close(m, v15)
			mBase = m.M
			v17 = int32(4155236)
			v18 = *(*int32)(unsafe.Add(mBase, _consts[626]))
			v19 = F_close(m, v18)
			mBase = m.M
			v21 = int32(-1)
			*(*int32)(unsafe.Add(mBase, _consts[625])) = v21
			*(*int32)(unsafe.Add(mBase, _consts[626])) = v21
			*(*int32)(unsafe.Add(mBase, _consts[624])) = int32(0)
			v29 = int32(4465020)
			v31 = *(*int32)(unsafe.Add(mBase, _consts[590]))
			*(*int32)(unsafe.Add(mBase, _consts[590])) = v31 - int32(1)
			v35 = int32(4465020)
			v37 = *(*int32)(unsafe.Add(mBase, _consts[590]))
			*(*int32)(unsafe.Add(mBase, _consts[590])) = v37 - int32(1)
		}
	}
	...
	if int32(0) <= v43 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[625])) = v48
		v62 = *(*int32)(unsafe.Add(mBase, uint32(v4)+60))
		*(*int32)(unsafe.Add(mBase, _consts[626])) = v62
		v66 = *(*int32)(unsafe.Add(mBase, _consts[520]))
		*(*int32)(unsafe.Add(mBase, _consts[624])) = v66
		...
		if v69 != 0 {
			...
			if v71 != 0 {
				...
				case 0, 2:
					v87 = v73
				default:
					*(*int32)(unsafe.Add(mBase, _consts[627])) = v73
					v87 = int32(4730)
				}
				...
				*(*int32)(unsafe.Add(mBase, uint32(v77)+136)) = int32(268435456)
				v99 = v77 + int32(4)
				if v99 != 0 {
					v110 = F___memcpy(m, int32(4717812), v99, int32(140))
					mBase = m.M
				} else {
				}
				m.G0 = v77 + int32(144)
		...
		if v120 != 0 {
			...
			F_errmsg_internal(m, int32(307514), int32(0))
			mBase = m.M
			v124 = m.ExcPending
			if v124 != 0 {
				return
			} else {
				F_errfinish(m, int32(512692), int32(296), int32(86360))
				mBase = m.M
				v129 = m.ExcPending
				if v129 != 0 {
					return
