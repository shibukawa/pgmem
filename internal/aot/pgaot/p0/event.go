...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v57
	v67 = F_hash_create(m, int32(318875), int32(32), v14+int32(40), int32(1064))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L10
...
L14:
	;
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(394009), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L10
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = base.I32_extend16_s(v284)
	F_errmsg_internal(m, int32(475879), v14+int32(16))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L10
...
L147:
	;
	F_errmsg_internal(m, int32(24586), int32(0))
	mBase = m.M
	v548 = m.ExcPending
	if v548 != 0 {
		goto L10
...
L148:
	;
	F_errfinish(m, int32(491445), int32(231), int32(103935))
	mBase = m.M
	v553 = m.ExcPending
	if v553 != 0 {
		goto L10
...
L2:
	...
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(60145), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v32
	F_errmsg_internal(m, int32(51492), v12+int32(16))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L10:
	;
	F_errfinish(m, int32(487894), int32(1095), int32(392542))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v145
	F_errmsg_internal(m, int32(51492), v12)
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
	...
	if int32(0) <= v43 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[625])) = v66
		...
		if v69 != 0 {
			...
			if v71 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v77)+136)) = int32(268435456)
				v99 = v77 + int32(4)
				if v99 != 0 {
					v110 = F___memcpy(m, int32(4638884), v99, int32(140))
					mBase = m.M
				} else {
				}
				m.G0 = v77 + int32(144)
		...
		if v120 != 0 {
			...
			F_errmsg_internal(m, int32(291247), int32(0))
			mBase = m.M
			v124 = m.ExcPending
			if v124 != 0 {
				return
			} else {
				F_errfinish(m, int32(485692), int32(296), int32(79920))
				mBase = m.M
				v129 = m.ExcPending
				if v129 != 0 {
					return
