...
L29:
	...
	v108 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_EventCacheLookup[5])))
...
L39:
	;
	v134 = int32(_a_F_EventCacheLookup_6)
	v137 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_EventCacheLookup[6])))
...
L48:
	;
	v163 = int32(_a_F_EventCacheLookup_7)
	v166 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_EventCacheLookup[7])))
...
L57:
	;
	v192 = int32(_a_F_EventCacheLookup_8)
	v195 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_EventCacheLookup[8])))
...
L66:
	;
	v220 = int32(_a_F_EventCacheLookup_9)
	v223 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_EventCacheLookup[9])))
...
L114:
	;
	v376 = int32(_a_F_EventCacheLookup_13)
	v377 = int32(_a_F_EventCacheLookup_14)
	goto L115
L115:
	;
...
L117:
	;
	v416 = (v386 - int32(_a_F_EventCacheLookup_13)) >> (uint(int32(3)) % 32)
	goto L111
L118:
	;
	goto L119
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_EventCacheLookup[3])) = v54
	v511 = *(*int32)(unsafe.Add(mBase, _c_F_EventCacheLookup[0]))
	if v511 != int32(1) {
		v522 = v67
		goto L2
	} else {
...
L16:
	...
	mBase = m.M
	v93 = int32(_a_F_EventTriggerInvoke_7)
	v94 = *(*int64)(unsafe.Add(mBase, _c_F_EventTriggerInvoke[1]))
	...
	*(*int64)(unsafe.Add(mBase, _c_F_EventTriggerInvoke[1])) = v96 + v103
...
L37:
	...
	mBase = m.M
	v203 = int32(_a_F_EventTriggerInvoke_7)
	v204 = *(*int64)(unsafe.Add(mBase, _c_F_EventTriggerInvoke[1]))
	...
	*(*int64)(unsafe.Add(mBase, _c_F_EventTriggerInvoke[1])) = v206 + v213
	...
	if int32(0) <= v43 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_InitializeWaitEventSupport[1])) = v66
		...
		if v69 != 0 {
			...
			if v71 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v77)+136)) = int32(268435456)
				v99 = v77 + int32(4)
				if v99 != 0 {
					v110 = F___memcpy(m, int32(_a_F_InitializeWaitEventSupport_4), v99, int32(140))
					mBase = m.M
				} else {
				}
				m.G0 = v77 + int32(144)
		...
		if v120 != 0 {
			...
			F_errmsg_internal(m, int32(_a_F_InitializeWaitEventSupport_5), int32(0))
			mBase = m.M
			v124 = m.ExcPending
			if v124 != 0 {
				return
			} else {
				F_errfinish(m, int32(_a_F_InitializeWaitEventSupport_6), int32(296), int32(_a_F_InitializeWaitEventSupport_7))
				mBase = m.M
				v129 = m.ExcPending
				if v129 != 0 {
					return
