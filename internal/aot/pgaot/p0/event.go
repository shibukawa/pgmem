...
func F_EventCacheLookup(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+24)) = l0
	v18 = *(*int32)(unsafe.Add(mBase, _consts[866]))
	if v18 == int32(2) {
		goto L3
	} else {
		goto L4
...
L3:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[867]))
	v522 = v22
	goto L2
L4:
	;
...
L5:
	;
	v24 = *(*int32)(unsafe.Add(mBase, _consts[868]))
	if v24 != 0 {
		goto L7
	} else {
		goto L8
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, _consts[866])) = int32(1)
	...
	v57 = *(*int32)(unsafe.Add(mBase, _consts[868]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v57
	v67 = F_hash_create(m, int32(338382), int32(32), v14+int32(40), int32(1064))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L10
...
L14:
	;
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(417524), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L10
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _consts[868])) = v41
...
L29:
	...
	v104 = v98 + int32(68)
	v105 = int32(88619)
	v108 = int32(*(*uint8)(unsafe.Add(mBase, _consts[869])))
...
L39:
	;
	v134 = int32(446336)
	v137 = int32(*(*uint8)(unsafe.Add(mBase, _consts[870])))
...
L48:
	;
	v163 = int32(245371)
	v166 = int32(*(*uint8)(unsafe.Add(mBase, _consts[871])))
...
L57:
	;
	v192 = int32(365581)
	v195 = int32(*(*uint8)(unsafe.Add(mBase, _consts[872])))
...
L66:
	;
	v220 = int32(288703)
	v223 = int32(*(*uint8)(unsafe.Add(mBase, _consts[873])))
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = base.I32_extend16_s(v284)
	F_errmsg_internal(m, int32(504261), v14+int32(16))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L10
...
L141:
	;
	*(*int32)(unsafe.Add(mBase, _consts[867])) = v67
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v54
	v511 = *(*int32)(unsafe.Add(mBase, _consts[866]))
	if v511 != int32(1) {
		v522 = v67
		goto L2
	} else {
...
L142:
	;
	*(*int32)(unsafe.Add(mBase, _consts[866])) = int32(2)
	v522 = v67
	goto L2
L143:
	;
...
L148:
	;
	F_errfinish(m, int32(521988), int32(231), int32(112236))
	mBase = m.M
	v553 = m.ExcPending
	if v553 != 0 {
		goto L10
...
L2:
	...
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(66201), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v32
	F_errmsg_internal(m, int32(56587), v12+int32(16))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L10:
	;
	F_errfinish(m, int32(517849), int32(1095), int32(416037))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v145
	F_errmsg_internal(m, int32(56587), v12)
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
	...
	if int32(0) <= v43 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[624])) = v66
		...
		if v69 != 0 {
			...
			if v71 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v77)+136)) = int32(268435456)
				v99 = v77 + int32(4)
				if v99 != 0 {
					v110 = F___memcpy(m, int32(4722676), v99, int32(140))
					mBase = m.M
				} else {
				}
				m.G0 = v77 + int32(144)
		...
		if v120 != 0 {
			...
			F_errmsg_internal(m, int32(308765), int32(0))
			mBase = m.M
			v124 = m.ExcPending
			if v124 != 0 {
				return
			} else {
				F_errfinish(m, int32(515004), int32(296), int32(86677))
				mBase = m.M
				v129 = m.ExcPending
				if v129 != 0 {
					return
