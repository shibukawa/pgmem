...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v57
	v67 = F_hash_create(m, int32(310711), int32(32), v14+int32(40), int32(1064))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L10
...
L14:
	;
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(384137), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L10
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = base.I32_extend16_s(v284)
	F_errmsg_internal(m, int32(464696), v14+int32(16))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L10
...
L117:
	;
	v416 = (v386 - int32(1601872)) >> (uint(int32(3)) % 32)
	goto L111
L118:
	;
	goto L119
...
L147:
	;
	F_errmsg_internal(m, int32(23398), int32(0))
	mBase = m.M
	v548 = m.ExcPending
	if v548 != 0 {
		goto L10
...
L148:
	;
	F_errfinish(m, int32(479851), int32(231), int32(99150))
	mBase = m.M
	v553 = m.ExcPending
	if v553 != 0 {
		goto L10
...
L2:
	...
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(58603), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v32
	F_errmsg_internal(m, int32(49950), v12+int32(16))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L10:
	;
	F_errfinish(m, int32(476386), int32(1095), int32(382679))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v145
	F_errmsg_internal(m, int32(49950), v12)
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
	...
	if int32(0) <= v43 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[625])) = v66
		...
		if v69 != 0 {
			...
			if v71 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v77)+136)) = int32(268435456)
				v99 = v77 + int32(4)
				if v99 != 0 {
					v110 = F___memcpy(m, int32(4617652), v99, int32(140))
					mBase = m.M
				} else {
				}
				m.G0 = v77 + int32(144)
		...
		if v120 != 0 {
			...
			F_errmsg_internal(m, int32(283546), int32(0))
			mBase = m.M
			v124 = m.ExcPending
			if v124 != 0 {
				return
			} else {
				F_errfinish(m, int32(474184), int32(296), int32(77170))
				mBase = m.M
				v129 = m.ExcPending
				if v129 != 0 {
					return
