...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v57
	v67 = F_hash_create(m, int32(324722), int32(32), v14+int32(40), int32(1064))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L10
...
L14:
	;
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(401107), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L10
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = base.I32_extend16_s(v284)
	F_errmsg_internal(m, int32(484686), v14+int32(16))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L10
...
L117:
	;
	v416 = (v386 - int32(1642832)) >> (uint(int32(3)) % 32)
	goto L111
L118:
	;
	goto L119
...
L148:
	;
	F_errfinish(m, int32(500648), int32(231), int32(105994))
	mBase = m.M
	v553 = m.ExcPending
	if v553 != 0 {
		goto L10
...
L2:
	...
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(61066), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L1
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v32
	F_errmsg_internal(m, int32(52281), v12+int32(16))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L10:
	;
	F_errfinish(m, int32(496942), int32(1095), int32(399640))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v145
	F_errmsg_internal(m, int32(52281), v12)
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L2:
	;
	v21 = *(*int32)(unsafe.Add(mBase, _consts[767]))
...
L7:
	;
	v98 = *(*int32)(unsafe.Add(mBase, _consts[767]))
...
func F_InitializeWaitEventSupport(m *base.Module) {
	...
	if v7 != int32(1) {
		...
		v11 = *(*int32)(unsafe.Add(mBase, _consts[626]))
		if v11 == int32(0) {
		} else {
			v14 = int32(4126896)
			...
			mBase = m.M
			v17 = int32(4126900)
			v18 = *(*int32)(unsafe.Add(mBase, _consts[628]))
			v19 = F_close(m, v18)
			mBase = m.M
			v21 = int32(-1)
			*(*int32)(unsafe.Add(mBase, _consts[627])) = v21
			*(*int32)(unsafe.Add(mBase, _consts[628])) = v21
			*(*int32)(unsafe.Add(mBase, _consts[626])) = int32(0)
			v29 = int32(4436556)
	...
	if int32(0) <= v43 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[627])) = v48
		v62 = *(*int32)(unsafe.Add(mBase, uint32(v4)+60))
		*(*int32)(unsafe.Add(mBase, _consts[628])) = v62
		v66 = *(*int32)(unsafe.Add(mBase, _consts[522]))
		*(*int32)(unsafe.Add(mBase, _consts[626])) = v66
		...
		if v69 != 0 {
			...
			if v71 != 0 {
				...
				case 0, 2:
					v87 = v73
				default:
					*(*int32)(unsafe.Add(mBase, _consts[629])) = v73
					v87 = int32(4730)
				}
				...
				*(*int32)(unsafe.Add(mBase, uint32(v77)+136)) = int32(268435456)
				v99 = v77 + int32(4)
				if v99 != 0 {
					v110 = F___memcpy(m, int32(4689284), v99, int32(140))
					mBase = m.M
				} else {
				}
				m.G0 = v77 + int32(144)
		...
		if v120 != 0 {
			...
			F_errmsg_internal(m, int32(296520), int32(0))
			mBase = m.M
			v124 = m.ExcPending
			if v124 != 0 {
				return
			} else {
				F_errfinish(m, int32(494696), int32(296), int32(81152))
				mBase = m.M
				v129 = m.ExcPending
				if v129 != 0 {
					return
