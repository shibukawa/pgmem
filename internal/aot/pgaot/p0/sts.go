...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v48 + int32(12)
	v60 = F_pg_snprintf(m, v9+int32(32), int32(1024), int32(465807), v9+int32(16))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L7
...
L40:
	;
	F_errfinish(m, int32(498716), int32(550), int32(63479))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L7
...
L75:
	;
	F_errmsg(m, int32(387146), int32(0))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L7
...
L76:
	;
	F_errdetail_internal(m, int32(623466), int32(0))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L7
...
L77:
	;
	F_errfinish(m, int32(498716), int32(468), int32(383733))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L7
