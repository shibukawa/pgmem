...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v48 + int32(12)
	v60 = F_pg_snprintf(m, v9+int32(32), int32(1024), int32(487792), v9+int32(16))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L7
...
L40:
	;
	F_errfinish(m, int32(523723), int32(550), int32(69369))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L7
...
L75:
	;
	F_errmsg(m, int32(406123), int32(0))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L7
...
L76:
	;
	F_errdetail_internal(m, int32(652221), int32(0))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L7
...
L77:
	;
	F_errfinish(m, int32(523723), int32(468), int32(402388))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L7
