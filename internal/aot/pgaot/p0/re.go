...
L93:
	...
	v367 = F_AllocSetContextCreateInternal(m, v362, int32(60835), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L96
...
L99:
	...
	v386 = F_AllocSetContextCreateInternal(m, v381, int32(60798), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L96
...
L183:
	;
	F_errfinish(m, int32(484510), int32(223), int32(390172))
	mBase = m.M
	v682 = m.ExcPending
	if v682 != 0 {
		goto L96
