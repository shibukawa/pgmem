...
L93:
	...
	v367 = F_AllocSetContextCreateInternal(m, v362, int32(62240), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L96
...
L99:
	...
	v386 = F_AllocSetContextCreateInternal(m, v381, int32(62203), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L96
...
L183:
	;
	F_errfinish(m, int32(496790), int32(223), int32(400007))
	mBase = m.M
	v682 = m.ExcPending
	if v682 != 0 {
		goto L96
