...
func F_RegisterTimeout(m *base.Module, l0 int32, l1 int32) {
	...
	if base.Ui32(l0) < base.Ui32(int32(13)) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
		...
		v7 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[1]))
		if v7 == int32(0) {
			v53 = int32(13)
			*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
			return
		} else {
			v11 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[2]))
			if v11 == int32(0) {
				v53 = int32(14)
				*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
				return
			} else {
				v16 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[3]))
				if v16 == int32(0) {
					v53 = int32(15)
					*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
					return
				} else {
					v21 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[4]))
					if v21 == int32(0) {
						v53 = int32(16)
						*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
						return
					} else {
						v26 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[5]))
						if v26 == int32(0) {
							v53 = int32(17)
							*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
							return
						} else {
							v31 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[6]))
							if v31 == int32(0) {
								v53 = int32(18)
								*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
								return
							} else {
								v36 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[7]))
								if v36 == int32(0) {
									v53 = int32(19)
									*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
									return
								} else {
									v41 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[8]))
									if v41 == int32(0) {
										v53 = int32(20)
										*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
										return
									} else {
										v46 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[9]))
										if v46 == int32(0) {
											v53 = int32(21)
											*(*int32)(unsafe.Add(mBase, uint32(v53*int32(40))+uint32(_c_F_RegisterTimeout[0]))) = l1
											return
										} else {
											v51 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterTimeout[10]))
											if v51 != 0 {
...
func F_enable_timeout_after(m *base.Module, l0 int32, l1 int32) {
	...
	var v33 int32
	_ = v33
	*(*int32)(unsafe.Add(mBase, _c_F_enable_timeout_after[0])) = int32(0)
	v10 = m.G0
	v11 = int32(16)
	v12 = v10 - v11
	m.G0 = v12
