		...
		if v16 != 0 {
			...
			if l0 == int32(0) {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v10))) = v61
										...
										if v66 != 0 {
											...
											if v68 != 0 {
												...
												F_errfinish(m, int32(522308), int32(570), int32(275217))
												mBase = m.M
												v73 = m.ExcPending
												if v73 != 0 {
													return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v25)+16)) = v25
				v31 = int32(4547032)
				v32 = *(*int32)(unsafe.Add(mBase, _consts[74]))
				*(*int32)(unsafe.Add(mBase, uint32(v25)+8)) = v32
				*(*int32)(unsafe.Add(mBase, _consts[74])) = v10 + int32(20)
