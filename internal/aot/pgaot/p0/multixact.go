...
func F_find_multixact_start(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v12 != 0 {
		...
		if v15 != 0 {
			...
			v20 = F_SimpleLruDoesPhysicalPageExist(m, int32(4338564), v19)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return int32(0)
				...
				if v20 != 0 {
					v23 = F_SimpleLruReadPage_ReadOnly(m, int32(4338564), v19, l0)
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return int32(0)
					} else {
						v26 = *(*int32)(unsafe.Add(mBase, _consts[68]))
						...
						v40 = int32(*(*uint16)(unsafe.Add(mBase, _consts[69])))
