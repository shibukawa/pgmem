			...
			*(*int32)(unsafe.Add(mBase, _consts[117])) = v123
			...
			if v11 != 0 {
				...
				if v18 != 0 {
					...
					F_read_relmap_file(m, int32(4432652), int32(300162), int32(1), int32(22))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
					} else {
						v29 = F__emscripten_memcpy_bulkmem(m, v6+int32(4), int32(4432652), int32(524))
						mBase = m.M
						v35 = int32(*(*uint8)(unsafe.Add(mBase, _consts[273])))
						F_merge_map_updates(m, v6+int32(4), int32(4432128), v35)
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return
							...
							v40 = int32(1)
							F_write_relmap_file(m, v6+int32(4), v40, v40, v40, int32(0), int32(1664), int32(300162))
							mBase = m.M
							v47 = m.ExcPending
							if v47 != 0 {
								return
							} else {
								v52 = F__emscripten_memcpy_bulkmem(m, int32(4432652), v6+int32(4), int32(524))
								mBase = m.M
									...
									*(*int32)(unsafe.Add(mBase, _consts[114])) = int32(0)
									...
									if v64 == int32(0) {
										...
										if v73 != 0 {
											...
											F_read_relmap_file(m, int32(4433700), v76, int32(1), int32(22))
											mBase = m.M
											v80 = m.ExcPending
											if v80 != 0 {
												return
											} else {
												v85 = F__emscripten_memcpy_bulkmem(m, v6+int32(4), int32(4433700), int32(524))
												mBase = m.M
												v91 = int32(*(*uint8)(unsafe.Add(mBase, _consts[273])))
												F_merge_map_updates(m, v6+int32(4), int32(4433176), v91)
												mBase = m.M
												v93 = m.ExcPending
												if v93 != 0 {
													return
													...
													if v106 != 0 {
														...
														v111 = F__emscripten_memcpy_bulkmem(m, int32(4433700), v6+int32(4), int32(524))
														mBase = m.M
...
L20:
	;
	F_errmsg(m, int32(304209), int32(0))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L17
...
L22:
	;
	F_errfinish(m, int32(476045), int32(472), int32(511783))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L17
