								...
								if v61 == int32(0) {
									...
									if v101 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v34
										F_errmsg_internal(m, int32(45709), v7+int32(16))
										mBase = m.M
										v107 = m.ExcPending
										if v107 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(497445), int32(649), int32(336248))
											mBase = m.M
											v112 = m.ExcPending
											if v112 != 0 {
												return int32(0)
									...
									if v41 == int32(0) {
										...
										if v47 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v7))) = v48
											F_errmsg(m, int32(71128), v7)
											mBase = m.M
											v52 = m.ExcPending
											if v52 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(497445), int32(635), int32(336248))
												mBase = m.M
												v57 = m.ExcPending
												if v57 != 0 {
													return int32(0)
