...
func F_check_default_text_search_config(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.B2i32(v11 == int32(2)) == int32(0) {
		...
		if v17 == int32(0) {
			...
			v21 = *(*int32)(unsafe.Add(mBase, _consts[888]))
			*(*int32)(unsafe.Add(mBase, uint32(v7)+40)) = v21
			v24 = *(*int64)(unsafe.Add(mBase, _consts[889]))
								...
								if v61 == int32(0) {
									...
									if v101 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v34
										F_errmsg_internal(m, int32(45518), v7+int32(16))
										mBase = m.M
										v107 = m.ExcPending
										if v107 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(493770), int32(649), int32(333601))
											mBase = m.M
											v112 = m.ExcPending
											if v112 != 0 {
												return int32(0)
									...
									if v41 == int32(0) {
										...
										if v47 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v7))) = v48
											F_errmsg(m, int32(70767), v7)
											mBase = m.M
											v52 = m.ExcPending
											if v52 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(493770), int32(635), int32(333601))
												mBase = m.M
												v57 = m.ExcPending
												if v57 != 0 {
													return int32(0)
