...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v280
	F_errmsg_internal(m, int32(492355), v18)
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(520667), int32(644), int32(98615))
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L1
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(18064)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(520667), int32(784), int32(291712))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L116:
	;
	F_errmsg(m, int32(250160), int32(0))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L12
...
L117:
	;
	F_errfinish(m, int32(519043), int32(383), int32(421643))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L12
...
L121:
	;
	F_errfinish(m, int32(519043), int32(389), int32(421643))
	mBase = m.M
	v419 = m.ExcPending
	if v419 != 0 {
		goto L12
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v431 + int32(4)
	F_errmsg(m, int32(456145), v15+int32(-32))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		goto L12
...
L127:
	;
	F_errfinish(m, int32(519643), int32(1569), int32(420022))
	mBase = m.M
	v444 = m.ExcPending
	if v444 != 0 {
		goto L12
...
L133:
	;
	F_errhint(m, int32(599328), int32(0))
	mBase = m.M
	v484 = m.ExcPending
	if v484 != 0 {
		goto L12
...
L134:
	;
	F_errfinish(m, int32(519643), int32(1505), int32(420022))
	mBase = m.M
	v489 = m.ExcPending
	if v489 != 0 {
		goto L12
...
L138:
	;
	F_errfinish(m, int32(519643), int32(1511), int32(420022))
	mBase = m.M
	v505 = m.ExcPending
	if v505 != 0 {
		goto L12
...
L142:
	;
	F_errfinish(m, int32(519643), int32(1537), int32(420022))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L12
...
L145:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v534 + int32(4)
	F_errmsg(m, int32(728535), v15+int32(-48))
	mBase = m.M
	v542 = m.ExcPending
	if v542 != 0 {
		goto L12
...
L146:
	;
	F_errfinish(m, int32(519643), int32(1553), int32(420022))
	mBase = m.M
	v547 = m.ExcPending
	if v547 != 0 {
		goto L12
...
L199:
	;
	F_errfinish(m, int32(516237), int32(76), int32(372954))
	mBase = m.M
	v618 = m.ExcPending
	if v618 != 0 {
		goto L6
...
L201:
	;
	F_errmsg_internal(m, int32(402702), int32(0))
	mBase = m.M
	v626 = m.ExcPending
	if v626 != 0 {
		goto L6
...
L202:
	;
	F_errfinish(m, int32(516237), int32(180), int32(372954))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L6
...
L204:
	;
	F_errmsg_internal(m, int32(426165), int32(0))
	mBase = m.M
	v639 = m.ExcPending
	if v639 != 0 {
		goto L6
...
L205:
	;
	F_errfinish(m, int32(516237), int32(256), int32(372954))
	mBase = m.M
	v644 = m.ExcPending
	if v644 != 0 {
		goto L6
						...
						if (v24<<(uint(v25)%32)-v27)&int32(65535) != v25 {
							...
							if v85 != 0 {
								...
								if v88 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(554977)
									F_errmsg(m, int32(426493), v7+int32(32))
									mBase = m.M
									v98 = m.ExcPending
									if v98 != 0 {
										return int32(0)
										...
										*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = (v100<<(uint(v101)%32) - v99) & int32(65535)
										F_errdetail(m, int32(680593), v7+int32(16))
										mBase = m.M
										v114 = m.ExcPending
										if v114 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(517596), int32(67), int32(384089))
											mBase = m.M
											v121 = m.ExcPending
											if v121 != 0 {
												return int32(0)
							...
							if base.Ui32(int32(3)) <= base.Ui32(v36&int32(65535)) {
								*(*int32)(unsafe.Add(mBase, uint32(v7))) = v34
								v43 = F_psprintf(m, int32(699778), v7)
								mBase = m.M
								v44 = m.ExcPending
								if v44 != 0 {
									return int32(0)
								...
								v51 = *(*int32)(unsafe.Add(mBase, uint32(v36&int32(65535)<<(uint(int32(2))%32))+uint32(_consts[1138])))
								v52 = v51
								v53 = F_cstring_to_text(m, v52)
								mBase = m.M
								v54 = m.ExcPending
				...
				if v65 != 0 {
					...
					if v68 != 0 {
						...
						if v74 != 0 {
							...
							F_errfinish(m, int32(517596), int32(53), int32(384089))
							mBase = m.M
							v81 = m.ExcPending
							if v81 != 0 {
								return int32(0)
