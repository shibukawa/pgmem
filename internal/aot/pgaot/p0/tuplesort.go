...
L7:
	;
	F_errfinish(m, int32(489752), int32(1369), int32(77973))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L3
...
L27:
	;
	F_s_lock(m, v74, int32(489752), int32(3034), int32(369587))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L3
...
L31:
	;
	F_s_lock(m, v56, int32(489752), int32(3079), int32(161886))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L3
...
L74:
	;
	F_errfinish(m, int32(495832), int32(912), int32(424245))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L3
...
L114:
	;
	F_errfinish(m, int32(489752), int32(1444), int32(77973))
	mBase = m.M
	v671 = m.ExcPending
	if v671 != 0 {
		goto L3
...
L121:
	;
	F_errfinish(m, int32(489752), v746, int32(77973))
	mBase = m.M
	v749 = m.ExcPending
	if v749 != 0 {
		goto L3
...
L133:
	;
	F_errfinish(m, int32(489752), int32(3084), int32(161886))
	mBase = m.M
	v769 = m.ExcPending
	if v769 != 0 {
		goto L3
