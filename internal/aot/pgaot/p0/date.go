		...
		if l0&int32(2) == int32(0) {
			if l0&int32(8) == int32(0) {
				...
				if l0&v143 != v143 {
					...
					v168 = *(*int32)(unsafe.Add(mBase, uint32(v159*int32(52)+v162<<(uint(int32(2))%32))+uint32(_consts[787])))
					if v147 <= v168 {
						return int32(0)
					} else {
						return int32(-2)
		...
		if l0 == int32(2147483647) {
			...
			if l0 <= int32(106751982) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = int32(0)
				v101 = *(*int32)(unsafe.Add(mBase, _consts[775]))
				v103 = m.G0
				v104 = int32(16)
				v105 = v103 - v104
				m.G0 = v105
					...
					if v24 != 0 {
						...
						if v27 != 0 {
							...
							if v31 != 0 {
								...
								F_errfinish(m, int32(510641), int32(609), int32(326703))
								mBase = m.M
								v36 = m.ExcPending
								if v36 != 0 {
									return int32(0)
