...
L7:
	;
	v169 = F_path_decode(m, v28, int32(1), int32(2), v16+int32(16), v16+int32(15), int32(0), int32(367384), v19, v18)
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v48
	v53 = F_float8in_internal(m, v48, v16+int32(16), int32(367384), v19, v18)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L18:
	;
	v72 = F_float8in_internal(m, v64, v16+int32(16), int32(367384), v19, v18)
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L1
...
L24:
	;
	v91 = F_float8in_internal(m, v83, v16+int32(16), int32(367384), v19, v18)
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L1
...
L42:
	;
	F_errsave_finish(m, v18, int32(485354), int32(998), int32(275168))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L79:
	;
	F_errsave_finish(m, v18, int32(485354), int32(1008), int32(275168))
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L1
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = int32(367384)
	F_errmsg(m, int32(699626), v16)
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L1
...
L86:
	;
	F_errsave_finish(m, v18, int32(485354), int32(975), int32(407000))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L1
