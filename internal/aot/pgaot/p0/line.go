...
L42:
	;
	F_errsave_finish(m, v18, int32(490692), int32(998), int32(278094))
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L79:
	;
	F_errsave_finish(m, v18, int32(490692), int32(1008), int32(278094))
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L1
...
L86:
	;
	F_errsave_finish(m, v18, int32(490692), int32(975), int32(411285))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L1
