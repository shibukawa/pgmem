...
func F_InvalidateAttoptCacheCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[865]))
	if l2 == int32(0) {
		goto L2
	} else {
		goto L3
...
L15:
	;
	v33 = *(*int32)(unsafe.Add(mBase, _consts[865]))
...
L20:
	;
	F_errfinish(m, int32(522680), int32(76), int32(334369))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L5
...
func F_InvalidateEventCacheCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v11 int32
	_ = v11
	v5 = *(*int32)(unsafe.Add(mBase, _consts[866]))
	if v5 == int32(2) {
		v9 = *(*int32)(unsafe.Add(mBase, _consts[868]))
...
func F_InvalidateTableSpaceCacheCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v11 = *(*int32)(unsafe.Add(mBase, _consts[884]))
...
L10:
	;
	v27 = *(*int32)(unsafe.Add(mBase, _consts[884]))
...
L15:
	;
	F_errfinish(m, int32(522751), int32(69), int32(334399))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
