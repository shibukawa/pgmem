...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+44)) = int32(0)
	v119 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[0]))
...
L40:
	;
	v146 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[3]))
	if int32(0) <= v146 {
		v158 = v146
		goto L38
	} else {
...
L42:
	;
	v157 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[4]))
	v158 = v157
	goto L38
L43:
	;
	v150 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[5]))
...
L49:
	;
	v173 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[6]))
...
L50:
	;
	v180 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[2]))
	v185 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[7]))
...
L59:
	;
	v326 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[7]))
...
L75:
	;
	v243 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[1]))
...
L76:
	;
	v249 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[6]))
	v256 = v249 + v246&int32(15)<<(uint(int32(7))%32) + int32(_a_F_PredicateLockAcquire_0)
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v270))) = v272
	v275 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[8]))
...
L82:
	;
	v295 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[1]))
...
L95:
	;
	v337 = *(*int32)(unsafe.Add(mBase, _c_F_PredicateLockAcquire[6]))
...
L86:
	;
	v298 = *(*int32)(unsafe.Add(mBase, _c_F_predicate_implied_by_recurse[0]))
	if v298 != 0 {
		goto L109
	} else {
		goto L110
