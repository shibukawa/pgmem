...
L270:
	;
	F_errfinish(m, int32(474383), int32(88), int32(228585))
	mBase = m.M
	v1435 = m.ExcPending
	if v1435 != 0 {
		goto L3
...
L417:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1180))) = v1441
	F_errmsg_internal(m, int32(41531), v1180)
	mBase = m.M
	v1972 = m.ExcPending
	if v1972 != 0 {
		goto L3
...
L418:
	;
	F_errfinish(m, int32(474383), int32(562), int32(387862))
	mBase = m.M
	v1977 = m.ExcPending
	if v1977 != 0 {
		goto L3
...
func F_hashoptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v10
	v3 = int32(8)
	v7 = F_build_reloptions(m, l0, l1, v3, v3, int32(716272), int32(1))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
								...
								if base.Ui32(v405) < base.Ui32(v411) {
									...
									if v768 != 0 {
										...
										if v772 != 0 {
											...
											F_errfinish(m, int32(476855), int32(361), int32(439293))
											mBase = m.M
											v777 = m.ExcPending
											if v777 != 0 {
												return int32(0)
				...
				if v751 != 0 {
					...
					if v755 != 0 {
						...
						if v759 != 0 {
							...
							F_errfinish(m, int32(476855), int32(336), int32(439293))
							mBase = m.M
							v764 = m.ExcPending
							if v764 != 0 {
								return int32(0)
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+196)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+192)) = v29
	F_errmsg(m, int32(152145), v17+int32(192))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L2
...
L19:
	;
	F_errfinish(m, int32(475503), int32(91), int32(339607))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L2
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+132)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+128)) = v29
	F_errmsg(m, int32(449907), v17+int32(128))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L2
...
L34:
	;
	F_errfinish(m, int32(475503), int32(115), int32(339607))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L2
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+148)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+144)) = v29
	F_errmsg(m, int32(449802), v17+int32(144))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L2
...
L46:
	;
	F_errfinish(m, int32(475503), int32(127), int32(339607))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L2
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = l0
	F_errmsg_internal(m, int32(39938), v17)
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L2
...
L50:
	;
	F_errfinish(m, int32(475503), int32(60), int32(339607))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L2
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+116)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+112)) = v29
	F_errmsg(m, int32(449678), v17+int32(112))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L2
...
L63:
	;
	F_errfinish(m, int32(475503), int32(153), int32(339607))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L2
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+100)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+96)) = v29
	F_errmsg(m, int32(170768), v17+int32(96))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L2
...
L74:
	;
	F_errfinish(m, int32(475503), int32(165), int32(339607))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L2
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+84)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+80)) = v29
	F_errmsg(m, int32(345695), v17+int32(80))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L2
...
L83:
	;
	F_errfinish(m, int32(475503), int32(178), int32(339607))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L2
...
L119:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+68)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+64)) = v29
	F_errmsg(m, int32(170580), v17-int32(-64))
	mBase = m.M
	v472 = m.ExcPending
	if v472 != 0 {
		goto L2
...
L120:
	;
	F_errfinish(m, int32(475503), int32(190), int32(339607))
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L2
...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+52)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+48)) = v29
	F_errmsg(m, int32(186300), v17+int32(48))
	mBase = m.M
	v558 = m.ExcPending
	if v558 != 0 {
		goto L2
...
L147:
	;
	F_errfinish(m, int32(475503), int32(219), int32(339607))
	mBase = m.M
	v563 = m.ExcPending
	if v563 != 0 {
		goto L2
...
L155:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v17)+36)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v26 + int32(8)
	F_errmsg(m, int32(633088), v17+int32(32))
	mBase = m.M
	v620 = m.ExcPending
	if v620 != 0 {
		goto L2
...
L156:
	;
	F_errfinish(m, int32(475503), int32(231), int32(339607))
	mBase = m.M
	v625 = m.ExcPending
	if v625 != 0 {
		goto L2
...
L166:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v17)+20)) = int32(307806)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v29
	F_errmsg(m, int32(633151), v17+int32(16))
	mBase = m.M
	v681 = m.ExcPending
	if v681 != 0 {
		goto L2
...
L167:
	;
	F_errfinish(m, int32(475503), int32(247), int32(339607))
	mBase = m.M
	v686 = m.ExcPending
	if v686 != 0 {
		goto L2
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v58
	F_errmsg(m, int32(648659), v13+int32(16))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L15
...
L20:
	;
	F_errsave_finish(m, l3, int32(476360), int32(239), int32(390433))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L15
...
L27:
	;
	F_errmsg(m, int32(115663), int32(0))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L15
...
L28:
	;
	F_errsave_finish(m, l3, int32(476360), int32(244), int32(390433))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L15
...
L39:
	;
	F_errsave_finish(m, l3, int32(476360), int32(249), int32(390433))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L15
