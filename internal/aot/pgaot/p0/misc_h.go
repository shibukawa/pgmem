...
L396:
	;
	F_errfinish(m, int32(523289), int32(562), int32(426966))
	mBase = m.M
	v1768 = m.ExcPending
	if v1768 != 0 {
		goto L3
...
func F_hashoptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v10
	v3 = int32(8)
	v7 = F_build_reloptions(m, l0, l1, v3, v3, int32(794336), int32(1))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
								...
								if base.Ui32(v405) < base.Ui32(v411) {
									...
									if v768 != 0 {
										...
										if v772 != 0 {
											...
											F_errfinish(m, int32(526147), int32(361), int32(482882))
											mBase = m.M
											v777 = m.ExcPending
											if v777 != 0 {
												return int32(0)
				...
				if v751 != 0 {
					...
					if v755 != 0 {
						...
						if v759 != 0 {
							...
							F_errfinish(m, int32(526147), int32(336), int32(482882))
							mBase = m.M
							v764 = m.ExcPending
							if v764 != 0 {
								return int32(0)
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+196)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+192)) = v29
	F_errmsg(m, int32(172408), v17+int32(192))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L2
...
L19:
	;
	F_errfinish(m, int32(524465), int32(91), int32(375410))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L2
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+132)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+128)) = v29
	F_errmsg(m, int32(494573), v17+int32(128))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L2
...
L34:
	;
	F_errfinish(m, int32(524465), int32(115), int32(375410))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L2
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+148)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+144)) = v29
	F_errmsg(m, int32(494398), v17+int32(144))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L2
...
L46:
	;
	F_errfinish(m, int32(524465), int32(127), int32(375410))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L2
...
L50:
	;
	F_errfinish(m, int32(524465), int32(60), int32(375410))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L2
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+116)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+112)) = v29
	F_errmsg(m, int32(494192), v17+int32(112))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L2
...
L63:
	;
	F_errfinish(m, int32(524465), int32(153), int32(375410))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L2
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+100)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+96)) = v29
	F_errmsg(m, int32(191927), v17+int32(96))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L2
...
L74:
	;
	F_errfinish(m, int32(524465), int32(165), int32(375410))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L2
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+84)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+80)) = v29
	F_errmsg(m, int32(381829), v17+int32(80))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L2
...
L83:
	;
	F_errfinish(m, int32(524465), int32(178), int32(375410))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L2
...
L119:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+68)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+64)) = v29
	F_errmsg(m, int32(191665), v17-int32(-64))
	mBase = m.M
	v472 = m.ExcPending
	if v472 != 0 {
		goto L2
...
L120:
	;
	F_errfinish(m, int32(524465), int32(190), int32(375410))
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L2
...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+52)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+48)) = v29
	F_errmsg(m, int32(207459), v17+int32(48))
	mBase = m.M
	v558 = m.ExcPending
	if v558 != 0 {
		goto L2
...
L147:
	;
	F_errfinish(m, int32(524465), int32(219), int32(375410))
	mBase = m.M
	v563 = m.ExcPending
	if v563 != 0 {
		goto L2
...
L155:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v17)+36)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v26 + int32(8)
	F_errmsg(m, int32(707364), v17+int32(32))
	mBase = m.M
	v620 = m.ExcPending
	if v620 != 0 {
		goto L2
...
L156:
	;
	F_errfinish(m, int32(524465), int32(231), int32(375410))
	mBase = m.M
	v625 = m.ExcPending
	if v625 != 0 {
		goto L2
...
L166:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v17)+20)) = int32(340209)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v29
	F_errmsg(m, int32(707427), v17+int32(16))
	mBase = m.M
	v681 = m.ExcPending
	if v681 != 0 {
		goto L2
...
L167:
	;
	F_errfinish(m, int32(524465), int32(247), int32(375410))
	mBase = m.M
	v686 = m.ExcPending
	if v686 != 0 {
		goto L2
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v58
	F_errmsg(m, int32(723527), v13+int32(16))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L15
...
L20:
	;
	F_errsave_finish(m, l3, int32(525380), int32(239), int32(430378))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L15
...
L27:
	;
	F_errmsg(m, int32(132047), int32(0))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L15
...
L28:
	;
	F_errsave_finish(m, l3, int32(525380), int32(244), int32(430378))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L15
...
L39:
	;
	F_errsave_finish(m, l3, int32(525380), int32(249), int32(430378))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L15
...
func F_hnswhandler(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v3)+108)) = int32(7126)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+104)) = v7
		*(*int32)(unsafe.Add(mBase, uint32(v3)+100)) = int32(7127)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+96)) = int32(7130)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+92)) = int32(7122)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+88)) = v7
		*(*int32)(unsafe.Add(mBase, uint32(v3)+84)) = int32(7708)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+80)) = int32(7709)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+76)) = v7
		*(*int32)(unsafe.Add(mBase, uint32(v3)+72)) = int32(7710)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+68)) = v7
		*(*int32)(unsafe.Add(mBase, uint32(v3)+64)) = int32(7711)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+60)) = v7
		*(*int32)(unsafe.Add(mBase, uint32(v3)+56)) = int32(7131)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+52)) = int32(7125)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+48)) = v7
		*(*int32)(unsafe.Add(mBase, uint32(v3)+44)) = int32(7129)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+40)) = int32(7124)
		*(*int32)(unsafe.Add(mBase, uint32(v3)+36)) = int32(7123)
...
func F_hnswoptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v11 int32
	_ = v11
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1156]))
	v8 = F_build_reloptions(m, l0, l1, v4, int32(12), int32(4120816), int32(2))
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
