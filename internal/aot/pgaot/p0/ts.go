...
func F_commit_ts_redo(m *base.Module, l0 int32) {
	...
	case 0:
		...
		if v86 != 0 {
			...
			v87 = int32(_a_F_commit_ts_redo_0)
	...
	default:
		...
		if v62 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v13
			F_errmsg_internal(m, int32(_a_F_commit_ts_redo_1), v8)
			mBase = m.M
			v66 = m.ExcPending
			if v66 != 0 {
				return
			} else {
				F_errfinish(m, int32(_a_F_commit_ts_redo_2), int32(1063), int32(_a_F_commit_ts_redo_3))
				mBase = m.M
				v71 = m.ExcPending
				if v71 != 0 {
					return
	...
	case 16:
		...
		v17 = *(*int32)(unsafe.Add(mBase, _c_F_commit_ts_redo[2]))
		v21 = F_LWLockAcquire(m, v17+int32(_a_F_commit_ts_redo_4), int32(0))
		mBase = m.M
		v22 = m.ExcPending
		if v22 != 0 {
			return
		} else {
			v24 = *(*int32)(unsafe.Add(mBase, _c_F_commit_ts_redo[3]))
			...
			if v25 == int32(0) {
				...
				if v39 == int32(0) {
					...
					v43 = *(*int32)(unsafe.Add(mBase, _c_F_commit_ts_redo[3]))
					*(*int32)(unsafe.Add(mBase, uint32(v43)+40)) = v15
				}
			}
			v46 = *(*int32)(unsafe.Add(mBase, _c_F_commit_ts_redo[2]))
			F_LWLockRelease(m, v46+int32(_a_F_commit_ts_redo_4))
			mBase = m.M
			v50 = m.ExcPending
			if v50 != 0 {
				return
			} else {
				v51 = int32(_a_F_commit_ts_redo_0)
				v52 = *(*int32)(unsafe.Add(mBase, _c_F_commit_ts_redo[0]))
...
L15:
	;
	v33 = int32(0)
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_get_ts_config_oid[0]))
	if v35 == v33 {
		v83 = v33
		goto L4
	} else {
...
L18:
	...
	v56 = *(*int32)(unsafe.Add(mBase, _c_F_get_ts_config_oid[1]))
	if v54 != v56 {
		goto L20
	} else {
		goto L21
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v91
	F_errmsg(m, int32(_a_F_get_ts_config_oid_0), v10)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(_a_F_get_ts_config_oid_1), int32(3201), int32(_a_F_get_ts_config_oid_2))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L15:
	;
	v33 = int32(0)
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_get_ts_template_oid[0]))
	if v35 == v33 {
		v83 = v33
		goto L4
	} else {
...
L18:
	...
	v50 = *(*int32)(unsafe.Add(mBase, uint32(v35)+12))
	v54 = *(*int32)(unsafe.Add(mBase, uint32(v50+v46<<(uint(int32(2))%32))))
	v56 = *(*int32)(unsafe.Add(mBase, _c_F_get_ts_template_oid[1]))
	if v54 != v56 {
		goto L20
	} else {
		goto L21
...
L30:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v91
	F_errmsg(m, int32(_a_F_get_ts_template_oid_0), v10)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(_a_F_get_ts_template_oid_1), int32(3056), int32(_a_F_get_ts_template_oid_2))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L19:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_lookup_ts_config_cache[1])) = v324
	v335 = v324
	goto L14
L20:
	;
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v229))) = v204
	v232 = *(*int32)(unsafe.Add(mBase, _c_F_lookup_ts_config_cache[2]))
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v287))) = v264
	v290 = *(*int32)(unsafe.Add(mBase, _c_F_lookup_ts_config_cache[2]))
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v128)+12)) = v301
	v304 = *(*int32)(unsafe.Add(mBase, _c_F_lookup_ts_config_cache[2]))
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v103
	v110 = F_pg_sprintf(m, v13+int32(48), int32(_a_F_ts_process_call_0), v13+int32(16))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L14
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v115
	v120 = F_pg_sprintf(m, v13+int32(32), int32(_a_F_ts_process_call_0), v13)
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L14
