	...
	default:
		...
		if v62 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v13
			F_errmsg_internal(m, int32(57413), v8)
			mBase = m.M
			v66 = m.ExcPending
			if v66 != 0 {
				return
			} else {
				F_errfinish(m, int32(518416), int32(1063), int32(255554))
				mBase = m.M
				v71 = m.ExcPending
				if v71 != 0 {
					return
		...
		if v22 != 0 {
			...
			if v25 == int32(0) {
				...
				if v39 == int32(0) {
					...
					v43 = *(*int32)(unsafe.Add(mBase, _consts[64]))
			...
			if v50 != 0 {
				...
				v51 = int32(4456676)
				v52 = *(*int32)(unsafe.Add(mBase, _consts[62]))
...
L15:
	;
	v33 = int32(0)
	v35 = *(*int32)(unsafe.Add(mBase, _consts[213]))
	if v35 == v33 {
		v83 = v33
		goto L4
	} else {
...
L18:
	...
	v56 = *(*int32)(unsafe.Add(mBase, _consts[122]))
	if v54 != v56 {
		goto L20
	} else {
		goto L21
...
L31:
	;
	F_errfinish(m, int32(525427), int32(3201), int32(456302))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(525427), int32(3056), int32(456446))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
func F_lookup_ts_config_cache(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+2556)) = l0
	v16 = *(*int32)(unsafe.Add(mBase, _consts[885]))
	if v16 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v46 = *(*int32)(unsafe.Add(mBase, _consts[886]))
	if v46 == int32(0) {
		goto L15
	} else {
		goto L16
...
L2:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+464)) = int64(85899345924)
	v25 = F_hash_create(m, int32(419296), int32(16), v12+int32(448), int32(40))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L3
...
L4:
	;
	*(*int32)(unsafe.Add(mBase, _consts[885])) = v25
	F_CacheRegisterSyscacheCallback(m, int32(74), int32(1616), v25)
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L3
...
L5:
	;
	v37 = *(*int32)(unsafe.Add(mBase, _consts[885]))
	F_CacheRegisterSyscacheCallback(m, int32(72), int32(1616), v37)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L3
...
L15:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _consts[885]))
	v57 = int32(0)
...
L19:
	;
	*(*int32)(unsafe.Add(mBase, _consts[886])) = v324
	v335 = v324
	goto L14
L20:
	;
...
L29:
	;
	v77 = *(*int32)(unsafe.Add(mBase, _consts[885]))
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v229))) = v204
	v232 = *(*int32)(unsafe.Add(mBase, _consts[204]))
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v287))) = v264
	v290 = *(*int32)(unsafe.Add(mBase, _consts[204]))
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v128)+12)) = v301
	v304 = *(*int32)(unsafe.Add(mBase, _consts[204]))
...
L100:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v350
	F_errmsg_internal(m, int32(49639), v12)
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
		goto L3
...
L101:
	;
	F_errfinish(m, int32(525135), int32(426), int32(418942))
	mBase = m.M
	v359 = m.ExcPending
	if v359 != 0 {
		goto L3
...
L103:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v364
	F_errmsg_internal(m, int32(229248), v12+int32(16))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L3
...
L104:
	;
	F_errfinish(m, int32(525135), int32(433), int32(418942))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L3
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v216
	F_errmsg_internal(m, int32(422331), v12+int32(32))
	mBase = m.M
	v385 = m.ExcPending
	if v385 != 0 {
		goto L3
...
L107:
	;
	F_errfinish(m, int32(525135), int32(491), int32(418942))
	mBase = m.M
	v390 = m.ExcPending
	if v390 != 0 {
		goto L3
...
L109:
	;
	F_errmsg_internal(m, int32(239225), int32(0))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L3
...
L110:
	;
	F_errfinish(m, int32(525135), int32(493), int32(418942))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L3
...
L112:
	;
	F_errmsg_internal(m, int32(388059), int32(0))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L3
...
L113:
	;
	F_errfinish(m, int32(525135), int32(514), int32(418942))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L3
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v103
	v110 = F_pg_sprintf(m, v13+int32(48), int32(512117), v13+int32(16))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L14
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v115
	v120 = F_pg_sprintf(m, v13+int32(32), int32(512117), v13)
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L14
				...
				*(*int32)(unsafe.Add(mBase, uint32(l1)+28)) = v71
				...
				if v84 != 0 {
					...
					if v88 != 0 {
						...
						F_errfinish(m, int32(521148), int32(2481), int32(319964))
						mBase = m.M
						v93 = m.ExcPending
						if v93 != 0 {
							return
