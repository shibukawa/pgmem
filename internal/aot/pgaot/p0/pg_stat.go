	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = v2
	...
	if v25 != 0 {
		...
		if v32 != 0 {
			...
			F_TupleDescInitEntry(m, v22, int32(2), int32(308723), int32(25), int32(-1), int32(0))
			mBase = m.M
			v39 = m.ExcPending
			if v39 != 0 {
				return int32(0)
			} else {
				F_TupleDescInitEntry(m, v22, int32(3), int32(375704), int32(1184), int32(-1), int32(0))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return int32(0)
					...
					if v53 != 0 {
						...
						F_TupleDescInitEntry(m, v22, int32(5), int32(308741), int32(25), int32(-1), int32(0))
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
							F_TupleDescInitEntry(m, v22, int32(6), int32(375723), int32(1184), int32(-1), int32(0))
							mBase = m.M
							v67 = m.ExcPending
							if v67 != 0 {
								return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v82
												...
												if v85 == int32(0) {
													...
													*(*uint8)(unsafe.Add(mBase, uint32(v7)+9)) = uint8(v88)
															...
															*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = v104
															...
															if v107 == int32(0) {
																...
																*(*uint8)(unsafe.Add(mBase, uint32(v7)+12)) = uint8(v110)
																...
																v114 = F_cstring_to_text(m, int32(4439496))
																mBase = m.M
																v115 = m.ExcPending
																if v115 != 0 {
																	return int32(0)
													...
													v92 = F_cstring_to_text(m, int32(4439432))
													mBase = m.M
													v93 = m.ExcPending
													if v93 != 0 {
														return int32(0)
...
L93:
	;
	F_errhint(m, int32(668363), int32(0))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L6
...
L94:
	;
	F_errfinish(m, int32(494750), int32(1922), int32(451467))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L6
