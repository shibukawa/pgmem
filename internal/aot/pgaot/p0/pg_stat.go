...
func F_pg_stat_get_archiver(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = v2
	...
	if v25 != 0 {
		...
		F_TupleDescInitEntry(m, v22, int32(1), int32(_a_F_pg_stat_get_archiver_0), int32(20), int32(-1), int32(0))
		mBase = m.M
		v32 = m.ExcPending
		if v32 != 0 {
			return int32(0)
		} else {
			F_TupleDescInitEntry(m, v22, int32(2), int32(_a_F_pg_stat_get_archiver_1), int32(25), int32(-1), int32(0))
			mBase = m.M
			v39 = m.ExcPending
			if v39 != 0 {
				return int32(0)
			} else {
				F_TupleDescInitEntry(m, v22, int32(3), int32(_a_F_pg_stat_get_archiver_2), int32(1184), int32(-1), int32(0))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return int32(0)
				} else {
					F_TupleDescInitEntry(m, v22, int32(4), int32(_a_F_pg_stat_get_archiver_3), int32(20), int32(-1), int32(0))
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return int32(0)
					} else {
						F_TupleDescInitEntry(m, v22, int32(5), int32(_a_F_pg_stat_get_archiver_4), int32(25), int32(-1), int32(0))
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
							F_TupleDescInitEntry(m, v22, int32(6), int32(_a_F_pg_stat_get_archiver_5), int32(1184), int32(-1), int32(0))
							mBase = m.M
							v67 = m.ExcPending
							if v67 != 0 {
								return int32(0)
							} else {
								F_TupleDescInitEntry(m, v22, int32(7), int32(_a_F_pg_stat_get_archiver_6), int32(1184), int32(-1), int32(0))
								mBase = m.M
								v74 = m.ExcPending
								if v74 != 0 {
									return int32(0)
									...
									if v76 != 0 {
										...
										if v79 != 0 {
											...
											v80 = int32(_a_F_pg_stat_get_archiver_7)
											v81 = *(*int64)(unsafe.Add(mBase, _c_F_pg_stat_get_archiver[0]))
													...
													*(*uint8)(unsafe.Add(mBase, uint32(v7)+9)) = uint8(v88)
													...
													if v95 == int64(0) {
														...
														*(*uint8)(unsafe.Add(mBase, uint32(v7)+10)) = uint8(v98)
														v103 = *(*int64)(unsafe.Add(mBase, _c_F_pg_stat_get_archiver[3]))
														...
														if v105 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = v104
															v107 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_stat_get_archiver[4])))
															if v107 == int32(0) {
																v110 = int32(1)
																*(*uint8)(unsafe.Add(mBase, uint32(v7)+12)) = uint8(v110)
																v117 = *(*int64)(unsafe.Add(mBase, _c_F_pg_stat_get_archiver[5]))
																if v117 == int64(0) {
																	v120 = int32(1)
																	*(*uint8)(unsafe.Add(mBase, uint32(v7)+13)) = uint8(v120)
																	v125 = *(*int64)(unsafe.Add(mBase, _c_F_pg_stat_get_archiver[6]))
																	if v125 == int64(0) {
																		v128 = int32(1)
																...
																v114 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_archiver_8))
																mBase = m.M
																v115 = m.ExcPending
																if v115 != 0 {
																	return int32(0)
													...
													v92 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_archiver_9))
													mBase = m.M
													v93 = m.ExcPending
													if v93 != 0 {
														return int32(0)
...
L4:
	;
	v94 = int32(_a_F_pg_stat_get_backend_wait_event_type_0)
	goto L1
L5:
	;
	goto L6
...
L21:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_backend_wait_event_type[1]))
	v41 = v32
	goto L23
L22:
	;
...
L33:
	;
	v87 = int32(_a_F_pg_stat_get_backend_wait_event_type_2)
	goto L29
L34:
	;
	goto L35
L35:
	;
	v85 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(v75)>>(uint(int32(22))%32))&int32(1020))+uint32(_c_F_pg_stat_get_backend_wait_event_type[2])))
	v87 = v85
	goto L29
L36:
	;
...
L15:
	...
	v66 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_stat_reset_shared[1])))
...
L26:
	;
	v94 = int32(_a_F_pg_stat_reset_shared_2)
	v97 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_stat_reset_shared[2])))
...
L38:
	;
	v125 = int32(_a_F_pg_stat_reset_shared_3)
	v128 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_stat_reset_shared[3])))
...
L52:
	;
	v166 = int32(_a_F_pg_stat_reset_shared_4)
	v169 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_stat_reset_shared[4])))
...
L65:
	;
	v194 = int32(_a_F_pg_stat_reset_shared_0)
	v195 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_reset_shared[0]))
...
L67:
	;
	v222 = int32(_a_F_pg_stat_reset_shared_5)
	v225 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_stat_reset_shared[5])))
...
L79:
	;
	v253 = int32(_a_F_pg_stat_reset_shared_6)
	v256 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_stat_reset_shared[6])))
