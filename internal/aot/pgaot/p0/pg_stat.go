...
func F_pg_stat_get_archiver(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = v2
	...
	if v25 != 0 {
		...
		F_TupleDescInitEntry(m, v22, int32(1), int32(82336), int32(20), int32(-1), int32(0))
		mBase = m.M
		v32 = m.ExcPending
		if v32 != 0 {
			return int32(0)
		} else {
			F_TupleDescInitEntry(m, v22, int32(2), int32(289645), int32(25), int32(-1), int32(0))
			mBase = m.M
			v39 = m.ExcPending
			if v39 != 0 {
				return int32(0)
			} else {
				F_TupleDescInitEntry(m, v22, int32(3), int32(352868), int32(1184), int32(-1), int32(0))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return int32(0)
				} else {
					F_TupleDescInitEntry(m, v22, int32(4), int32(82351), int32(20), int32(-1), int32(0))
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return int32(0)
					} else {
						F_TupleDescInitEntry(m, v22, int32(5), int32(289663), int32(25), int32(-1), int32(0))
						mBase = m.M
						v60 = m.ExcPending
						if v60 != 0 {
							return int32(0)
						} else {
							F_TupleDescInitEntry(m, v22, int32(6), int32(352887), int32(1184), int32(-1), int32(0))
							mBase = m.M
							v67 = m.ExcPending
							if v67 != 0 {
								return int32(0)
							} else {
								F_TupleDescInitEntry(m, v22, int32(7), int32(97269), int32(1184), int32(-1), int32(0))
								mBase = m.M
								v74 = m.ExcPending
								if v74 != 0 {
									return int32(0)
									...
									if v76 != 0 {
										...
										if v79 != 0 {
											...
											v80 = int32(4349216)
											v81 = *(*int64)(unsafe.Add(mBase, _consts[822]))
											...
											if v83 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v82
												v85 = int32(*(*uint8)(unsafe.Add(mBase, _consts[823])))
												if v85 == int32(0) {
													v88 = int32(1)
													*(*uint8)(unsafe.Add(mBase, uint32(v7)+9)) = uint8(v88)
													v95 = *(*int64)(unsafe.Add(mBase, _consts[824]))
													if v95 == int64(0) {
														v98 = int32(1)
														*(*uint8)(unsafe.Add(mBase, uint32(v7)+10)) = uint8(v98)
														v103 = *(*int64)(unsafe.Add(mBase, _consts[825]))
														...
														if v105 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = v104
															v107 = int32(*(*uint8)(unsafe.Add(mBase, _consts[826])))
															if v107 == int32(0) {
																v110 = int32(1)
																*(*uint8)(unsafe.Add(mBase, uint32(v7)+12)) = uint8(v110)
																v117 = *(*int64)(unsafe.Add(mBase, _consts[827]))
																if v117 == int64(0) {
																	v120 = int32(1)
																	*(*uint8)(unsafe.Add(mBase, uint32(v7)+13)) = uint8(v120)
																	v125 = *(*int64)(unsafe.Add(mBase, _consts[828]))
																	if v125 == int64(0) {
																		v128 = int32(1)
																...
																v114 = F_cstring_to_text(m, int32(4349288))
																mBase = m.M
																v115 = m.ExcPending
																if v115 != 0 {
																	return int32(0)
													...
													v92 = F_cstring_to_text(m, int32(4349224))
													mBase = m.M
													v93 = m.ExcPending
													if v93 != 0 {
														return int32(0)
...
L35:
	;
	v85 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(v75)>>(uint(int32(22))%32))&int32(1020))+uint32(_consts[814])))
	v87 = v85
	goto L29
L36:
	;
...
L10:
	;
	v24 = int32(4321148)
	v25 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	v26 = F_GetCurrentTimestamp(m)
	mBase = m.M
	*(*int64)(unsafe.Add(mBase, uint32(v25))) = v26
	v29 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	v30 = int64(0)
	*(*int64)(unsafe.Add(mBase, uint32(v29)+8)) = v30
	v33 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	*(*int64)(unsafe.Add(mBase, uint32(v33)+16)) = v30
	v37 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	*(*int64)(unsafe.Add(mBase, uint32(v37)+24)) = v30
	v41 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	*(*int64)(unsafe.Add(mBase, uint32(v41)+32)) = v30
	v45 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	*(*int64)(unsafe.Add(mBase, uint32(v45)+40)) = v30
	v49 = *(*int32)(unsafe.Add(mBase, _consts[815]))
...
L15:
	;
	v63 = int32(202320)
	v66 = int32(*(*uint8)(unsafe.Add(mBase, _consts[816])))
...
L26:
	;
	v94 = int32(203167)
	v97 = int32(*(*uint8)(unsafe.Add(mBase, _consts[817])))
...
L38:
	;
	v125 = int32(202631)
	v128 = int32(*(*uint8)(unsafe.Add(mBase, _consts[818])))
...
L52:
	;
	v166 = int32(304199)
	v169 = int32(*(*uint8)(unsafe.Add(mBase, _consts[819])))
...
L65:
	;
	v194 = int32(4321148)
	v195 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	v196 = F_GetCurrentTimestamp(m)
	mBase = m.M
	*(*int64)(unsafe.Add(mBase, uint32(v195))) = v196
	v199 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	v200 = int64(0)
	*(*int64)(unsafe.Add(mBase, uint32(v199)+8)) = v200
	v203 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v207)+24)) = v200
	v211 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	*(*int64)(unsafe.Add(mBase, uint32(v211)+32)) = v200
	v215 = *(*int32)(unsafe.Add(mBase, _consts[815]))
	*(*int64)(unsafe.Add(mBase, uint32(v215)+40)) = v200
	v219 = *(*int32)(unsafe.Add(mBase, _consts[815]))
...
L67:
	;
	v222 = int32(34818)
	v225 = int32(*(*uint8)(unsafe.Add(mBase, _consts[820])))
...
L79:
	;
	v253 = int32(289680)
	v256 = int32(*(*uint8)(unsafe.Add(mBase, _consts[821])))
...
L93:
	;
	F_errhint(m, int32(618505), int32(0))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L6
...
L94:
	;
	F_errfinish(m, int32(464284), int32(1922), int32(424486))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L6
