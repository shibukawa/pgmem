...
L10:
	;
	v21 = int32(_a_F_ShutdownSQLFunction_0)
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_ShutdownSQLFunction[0]))
	v24 = *(*int32)(unsafe.Add(mBase, uint32(l0)+68))
	*(*int32)(unsafe.Add(mBase, _c_F_ShutdownSQLFunction[0])) = v24
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ShutdownSQLFunction[0])) = v22
