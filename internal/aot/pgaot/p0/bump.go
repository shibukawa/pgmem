...
func F_BumpGetChunkContext(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_BumpGetChunkContext_0)
		F_errmsg_internal(m, int32(_a_F_BumpGetChunkContext_1), v4)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_BumpRealloc(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(_a_F_BumpRealloc_0)
		F_errmsg_internal(m, int32(_a_F_BumpRealloc_1), v6)
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
