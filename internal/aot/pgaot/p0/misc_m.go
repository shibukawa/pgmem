...
L108:
	;
	v328 = *(*int32)(unsafe.Add(mBase, _c_F_MB_MatchText[0]))
	if v328 != 0 {
		goto L110
	} else {
		goto L111
...
L230:
	;
	F_errfinish(m, int32(_a_F_manifest_process_file_1), int32(327), int32(_a_F_manifest_process_file_2))
	mBase = m.M
	v1215 = m.ExcPending
	if v1215 != 0 {
		goto L80
...
L332:
	;
	F_errfinish(m, int32(_a_F_manifest_process_file_1), int32(630), int32(_a_F_manifest_process_file_4))
	mBase = m.M
	v1764 = m.ExcPending
	if v1764 != 0 {
		goto L80
...
L3:
	;
	if v25 == int32(_a_F_maybe_start_bgworkers_0) {
		goto L1
	} else {
		goto L4
	}
...
L6:
	;
	v239 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_maybe_start_bgworkers[0])) = uint8(v239)
	goto L1
L7:
	;
	goto L6
L8:
	;
	if v41 != int32(_a_F_maybe_start_bgworkers_0) {
		v33 = v41
		v38 = v230
		v39 = v231
		goto L5
			...
			if v20 == int32(0) {
				...
				if base.Ui32(int32(50)) < base.Ui32(v32) {
					*(*int32)(unsafe.Add(mBase, _c_F_mbtowc[1])) = int32(25)
					...
					v44 = *(*int32)(unsafe.Add(mBase, uint32(v32<<(uint(int32(2))%32))+uint32(_c_F_mbtowc[2])))
			...
			if v57 == int32(0) {
				...
				if v64 != 0 {
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(_a_F_md5_bytea_0)
						v70 = *(*int32)(unsafe.Add(mBase, uint32(v7)+12))
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						F_errmsg(m, int32(_a_F_md5_bytea_1), v7)
						mBase = m.M
						v74 = m.ExcPending
						if v74 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_md5_bytea_2), int32(71), int32(_a_F_md5_bytea_3))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
...
L5:
	;
	v33 = l2 & int32(_a_F_mdwritev_0)
	v34 = int32(_a_F_mdwritev_1) - v33
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+20)) = int32(_a_F_mdwritev_2)
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v72)+12)) = int32(_a_F_mdwritev_2)
	v99 = v72 + int32(8)
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v103)+12)) = int32(_a_F_mdwritev_2)
	v114 = v103 + int32(8)
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v135)+12)) = int32(_a_F_mdwritev_2)
...
L38:
	;
	v282 = *(*int32)(unsafe.Add(mBase, _c_F_mdwritev[0]))
	F_errstart_cold(m, int32(21), int32(0))
	mBase = m.M
	v286 = m.ExcPending
	if v286 != 0 {
...
L54:
	...
	v291 = *(*int32)(unsafe.Add(mBase, _c_F_mdwritev[1]))
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+4)) = l2 + l4 - int32(1)
	F_errmsg(m, int32(_a_F_mdwritev_3), v23)
	mBase = m.M
	v304 = m.ExcPending
	if v304 != 0 {
		goto L4
...
L57:
	;
	F_errhint(m, int32(_a_F_mdwritev_4), int32(0))
	mBase = m.M
	v310 = m.ExcPending
	if v310 != 0 {
		goto L4
...
L59:
	;
	F_errfinish(m, int32(_a_F_mdwritev_5), int32(1134), int32(_a_F_mdwritev_6))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L4
...
L65:
	;
	F_errmsg_internal(m, int32(_a_F_mdwritev_7), int32(0))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L4
...
L66:
	;
	F_errfinish(m, int32(_a_F_mdwritev_5), int32(1092), int32(_a_F_mdwritev_6))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L4
		...
		if v35 == int32(0) {
			...
			if v67 != 0 {
				...
				if v70 != 0 {
					...
					F_errmsg_internal(m, int32(_a_F_minmax_multi_get_procinfo_0), int32(0))
					mBase = m.M
					v74 = m.ExcPending
					if v74 != 0 {
						return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(11)
						F_errdetail_internal(m, int32(_a_F_minmax_multi_get_procinfo_1), v8)
						mBase = m.M
						v80 = m.ExcPending
						if v80 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_minmax_multi_get_procinfo_2), int32(2886), int32(_a_F_minmax_multi_get_procinfo_3))
							mBase = m.M
							v85 = m.ExcPending
							if v85 != 0 {
								return int32(0)
		...
		if v19 <= v15 {
			...
			if v33 != 0 {
				...
				for {
					...
					v122 = v104 + base.B2i32(v117&int32(_a_F_mkVoidAffix_0) == int32(0))
					v123 = int32(1)
					v126 = v107 + v123
					if v126 != v33 {
						v102 = v102 + v123
						...
						*(*int32)(unsafe.Add(mBase, uint32(v22)+4)) = v170 | v131<<(uint(int32(8))%32)
						if v38 == int32(0) {
							...
							for {
								...
								if v201&int32(_a_F_mkVoidAffix_0) == int32(0) {
								...
								if v216&int32(_a_F_mkVoidAffix_0) == int32(0) {
						...
						if v31&int32(1) == int32(0) {
							...
							if v255&int32(_a_F_mkVoidAffix_0) != 0 {
							} else {
...
L19:
	;
	v141 = *(*int32)(unsafe.Add(mBase, _c_F_mode_final[0]))
	if v141 == int32(0) {
		v55 = v134
		v56 = v135
		v58 = v136
...
L4:
	;
	v40 = float64(0.01)
	if v19 <= int32(_a_F_multirangesel_0) {
		goto L12
	} else {
		goto L13
	}
...
L14:
	;
	if base.Ui32(v19-int32(_a_F_multirangesel_1)) < base.Ui32(int32(6)) {
		goto L9
	} else {
		goto L19
	}
...
L16:
	;
	if v48&int32(_a_F_multirangesel_3) != 0 {
		goto L11
	} else {
		goto L17
	}
...
L19:
	;
	if base.Ui32(v19-int32(_a_F_multirangesel_4)) < base.Ui32(int32(2)) {
		goto L11
	} else {
		goto L20
	}
L20:
	;
	if v19 != int32(_a_F_multirangesel_5) {
		v80 = v40
		goto L8
	} else {
		goto L21
...
L39:
	...
	if v106&int32(_a_F_multirangesel_2) != 0 {
		goto L33
	} else {
		goto L40
	}
L40:
	;
	if v106&int32(_a_F_multirangesel_3) != 0 {
		goto L35
	} else {
		goto L41
	}
...
L60:
	;
	v762 = float64(0.01)
	if v164 <= int32(_a_F_multirangesel_0) {
		goto L233
	} else {
		goto L234
	}
...
L67:
	;
	switch v164 - int32(_a_F_multirangesel_1) {
	case 0, 3:
		goto L60
	case 1, 4:
		goto L64
...
L76:
	;
	switch v164 - int32(_a_F_multirangesel_4) {
	case 0:
		goto L60
	case 1:
		goto L64
...
L90:
	;
	if v164 == int32(_a_F_multirangesel_5) {
		v740 = v10
		goto L88
	} else {
		goto L221
...
L91:
	;
	if base.B2i32(v164 != int32(_a_F_multirangesel_6))&base.B2i32(v164 != int32(2874)) == int32(0) {
		goto L218
	} else {
		goto L219
	}
...
L116:
	;
	v306 = v164 - int32(_a_F_multirangesel_7)
...
L165:
	;
	switch v164 - int32(_a_F_multirangesel_7) {
	case 0, 1:
		goto L158
	case 2:
		goto L151
...
L167:
	;
	if v164 != int32(_a_F_multirangesel_6) {
		goto L151
	} else {
		goto L168
	}
...
L186:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v164
	F_errmsg_internal(m, int32(_a_F_multirangesel_8), v17+int32(16))
	mBase = m.M
	v544 = m.ExcPending
	if v544 != 0 {
		goto L2
...
L208:
	;
	if base.Ui32(v164-int32(_a_F_multirangesel_1)) < base.Ui32(int32(6)) {
		goto L203
	} else {
		goto L213
	}
L209:
	...
	if v645&int32(_a_F_multirangesel_2) != 0 {
		goto L203
	} else {
		goto L210
	}
L210:
	;
	if v645&int32(_a_F_multirangesel_3) != 0 {
		goto L205
	} else {
		goto L211
	}
...
L213:
	;
	if base.Ui32(v164-int32(_a_F_multirangesel_4)) < base.Ui32(int32(2)) {
		goto L205
	} else {
		goto L214
	}
...
L223:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v164
	F_errmsg_internal(m, int32(_a_F_multirangesel_14), v17)
	mBase = m.M
	v725 = m.ExcPending
	if v725 != 0 {
		goto L2
...
L236:
	...
	if v770&int32(_a_F_multirangesel_2) != 0 {
		goto L230
	} else {
		goto L237
	}
L237:
	;
	if v770&int32(_a_F_multirangesel_3) != 0 {
		goto L232
	} else {
		goto L238
	}
