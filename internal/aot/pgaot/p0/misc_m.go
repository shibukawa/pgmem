...
L130:
	;
	F_errfinish(m, int32(467344), int32(107), int32(60409))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L4
...
L134:
	;
	F_errfinish(m, int32(467344), int32(169), int32(60409))
	mBase = m.M
	v393 = m.ExcPending
	if v393 != 0 {
		goto L4
...
L138:
	;
	F_errfinish(m, int32(467344), int32(237), int32(60409))
	mBase = m.M
	v409 = m.ExcPending
	if v409 != 0 {
		goto L4
...
L55:
	;
	F_errmsg_internal(m, int32(149514), int32(0))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L42
...
L56:
	;
	F_errfinish(m, int32(463258), int32(1897), int32(376078))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L42
...
L59:
	;
	F_errfinish(m, int32(463258), int32(1902), int32(376078))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L42
...
L230:
	;
	F_errfinish(m, int32(306380), int32(327), int32(319912))
	mBase = m.M
	v1215 = m.ExcPending
	if v1215 != 0 {
		goto L80
...
L332:
	;
	F_errfinish(m, int32(306380), int32(630), int32(292634))
	mBase = m.M
	v1764 = m.ExcPending
	if v1764 != 0 {
		goto L80
...
L44:
	;
	F_errmsg(m, int32(118788), int32(0))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L13
...
L45:
	;
	F_errfinish(m, int32(464843), int32(4145), int32(208216))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L13
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v46
	F_errmsg_internal(m, int32(649257), v14)
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L13
...
L51:
	;
	F_errfinish(m, int32(464843), int32(4155), int32(208216))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L13
...
L56:
	;
	F_errmsg(m, int32(274884), int32(0))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L13
...
L59:
	;
	F_errfinish(m, int32(464843), int32(4163), int32(208216))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L13
...
func F_mbtowc(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l1 == int32(0) {
		...
		if int32(0) <= v11 {
			...
			v19 = *(*int32)(unsafe.Add(mBase, _consts[1094]))
			...
			if v20 == int32(0) {
				...
				if base.Ui32(int32(50)) < base.Ui32(v32) {
					*(*int32)(unsafe.Add(mBase, _consts[166])) = int32(25)
					...
					v44 = *(*int32)(unsafe.Add(mBase, uint32(v32<<(uint(int32(2))%32))+uint32(_consts[1095])))
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v63
	F_errmsg_internal(m, int32(317384), v14)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L14
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						...
						if v74 != 0 {
							...
							F_errfinish(m, int32(464503), int32(71), int32(475392))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
...
L59:
	;
	F_errfinish(m, int32(468999), int32(1134), int32(32902))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L4
...
L66:
	;
	F_errfinish(m, int32(468999), int32(1092), int32(32902))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L4
				...
				if v90 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = l3
					...
					if v98 != 0 {
						...
						F_errfinish(m, int32(462329), int32(301), int32(226380))
						mBase = m.M
						v103 = m.ExcPending
						if v103 != 0 {
							return int32(0)
					...
					if v74 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(11)
						...
						if v80 != 0 {
							...
							F_errfinish(m, int32(467101), int32(2886), int32(226518))
							mBase = m.M
							v85 = m.ExcPending
							if v85 != 0 {
								return int32(0)
				...
				if v24 != 0 {
					...
					if v27 != 0 {
						...
						if v31 != 0 {
							...
							F_errfinish(m, int32(466623), int32(521), int32(319626))
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
							} else {
...
L186:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v164
	F_errmsg_internal(m, int32(40461), v17+int32(16))
	mBase = m.M
	v544 = m.ExcPending
	if v544 != 0 {
		goto L2
...
L187:
	;
	F_errfinish(m, int32(464415), int32(690), int32(8825))
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L2
...
L192:
	;
	F_errfinish(m, int32(464415), int32(318), int32(288386))
	mBase = m.M
	v585 = m.ExcPending
	if v585 != 0 {
		goto L2
...
L195:
	;
	F_errfinish(m, int32(464415), int32(509), int32(8825))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L2
...
L223:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v164
	F_errmsg_internal(m, int32(40567), v17)
	mBase = m.M
	v725 = m.ExcPending
	if v725 != 0 {
		goto L2
...
L224:
	;
	F_errfinish(m, int32(464415), int32(402), int32(288386))
	mBase = m.M
	v730 = m.ExcPending
	if v730 != 0 {
		goto L2
...
func F_multixactoffsetssyncfiletag(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_SlruSyncFileTag(m, int32(4319988), l0, l1)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
