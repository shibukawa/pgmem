...
L130:
	;
	F_errfinish(m, int32(497364), int32(107), int32(63945))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L4
...
L134:
	;
	F_errfinish(m, int32(497364), int32(169), int32(63945))
	mBase = m.M
	v393 = m.ExcPending
	if v393 != 0 {
		goto L4
...
L138:
	;
	F_errfinish(m, int32(497364), int32(237), int32(63945))
	mBase = m.M
	v409 = m.ExcPending
	if v409 != 0 {
		goto L4
...
L179:
	;
	F_errfinish(m, int32(326242), int32(327), int32(340723))
	mBase = m.M
	v1047 = m.ExcPending
	if v1047 != 0 {
		goto L63
...
L264:
	;
	F_errfinish(m, int32(326242), int32(630), int32(311451))
	mBase = m.M
	v1540 = m.ExcPending
	if v1540 != 0 {
		goto L63
...
L44:
	;
	F_errmsg(m, int32(129118), int32(0))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L13
...
L45:
	;
	F_errfinish(m, int32(494620), int32(4145), int32(220938))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L13
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v46
	F_errmsg_internal(m, int32(683822), v14)
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L13
...
L51:
	;
	F_errfinish(m, int32(494620), int32(4155), int32(220938))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L13
...
L56:
	;
	F_errmsg(m, int32(292605), int32(0))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L13
...
L59:
	;
	F_errfinish(m, int32(494620), int32(4163), int32(220938))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L13
			...
			if v20 == int32(0) {
				...
				if base.Ui32(int32(50)) < base.Ui32(v32) {
					*(*int32)(unsafe.Add(mBase, _consts[166])) = int32(25)
					...
					v44 = *(*int32)(unsafe.Add(mBase, uint32(v32<<(uint(int32(2))%32))+uint32(_consts[1126])))
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v63
	F_errmsg_internal(m, int32(337936), v14)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L14
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						...
						if v74 != 0 {
							...
							F_errfinish(m, int32(494254), int32(71), int32(506332))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
...
L59:
	;
	F_errfinish(m, int32(499060), int32(1134), int32(35670))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L4
...
L66:
	;
	F_errfinish(m, int32(499060), int32(1092), int32(35670))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L4
				...
				if v90 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = l3
					...
					if v98 != 0 {
						...
						F_errfinish(m, int32(491908), int32(301), int32(241237))
						mBase = m.M
						v103 = m.ExcPending
						if v103 != 0 {
							return int32(0)
					...
					if v74 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(11)
						...
						if v80 != 0 {
							...
							F_errfinish(m, int32(497082), int32(2886), int32(241375))
							mBase = m.M
							v85 = m.ExcPending
							if v85 != 0 {
								return int32(0)
				...
				if v24 != 0 {
					...
					if v27 != 0 {
						...
						if v31 != 0 {
							...
							F_errfinish(m, int32(496575), int32(521), int32(340369))
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
							} else {
...
L187:
	;
	F_errfinish(m, int32(494166), int32(690), int32(9862))
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L2
...
L192:
	;
	F_errfinish(m, int32(494166), int32(318), int32(306854))
	mBase = m.M
	v585 = m.ExcPending
	if v585 != 0 {
		goto L2
...
L195:
	;
	F_errfinish(m, int32(494166), int32(509), int32(9862))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L2
...
L224:
	;
	F_errfinish(m, int32(494166), int32(402), int32(306854))
	mBase = m.M
	v730 = m.ExcPending
	if v730 != 0 {
		goto L2
...
func F_multixactoffsetssyncfiletag(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_SlruSyncFileTag(m, int32(4384148), l0, l1)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
