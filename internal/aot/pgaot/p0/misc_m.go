...
L130:
	;
	F_errfinish(m, int32(524261), int32(107), int32(69959))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L4
...
L134:
	;
	F_errfinish(m, int32(524261), int32(169), int32(69959))
	mBase = m.M
	v393 = m.ExcPending
	if v393 != 0 {
		goto L4
...
L138:
	;
	F_errfinish(m, int32(524261), int32(237), int32(69959))
	mBase = m.M
	v409 = m.ExcPending
	if v409 != 0 {
		goto L4
...
L179:
	;
	F_errfinish(m, int32(344435), int32(327), int32(359705))
	mBase = m.M
	v1047 = m.ExcPending
	if v1047 != 0 {
		goto L63
...
L264:
	;
	F_errfinish(m, int32(344435), int32(630), int32(327990))
	mBase = m.M
	v1540 = m.ExcPending
	if v1540 != 0 {
		goto L63
...
func F_materialize_finished_plan(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		*(*float64)(unsafe.Add(mBase, uint32(l0)+16)) = v145
		...
		v155 = *(*int32)(unsafe.Add(mBase, _consts[323]))
		*(*float64)(unsafe.Add(mBase, uint32(v148)+32)) = v150
		v158 = *(*float64)(unsafe.Add(mBase, _consts[381]))
...
func F_maybe_start_bgworkers(m *base.Module) {
	...
	m.G0 = v14
	v17 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[453])) = uint8(v17)
	*(*uint8)(unsafe.Add(mBase, _consts[454])) = uint8(v1)
	v23 = int32(*(*uint8)(unsafe.Add(mBase, _consts[455])))
	if v23 != 0 {
		goto L1
	} else {
		goto L2
...
L6:
	;
	v239 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[453])) = uint8(v239)
	goto L1
L7:
	;
	goto L6
...
L15:
	...
	v116 = *(*int32)(unsafe.Add(mBase, _consts[457]))
	switch v116 {
	case 0, 1, 2:
		goto L30
	case 3:
...
L28:
	;
	v107 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[454])) = uint8(v107)
	v230 = v38
	v231 = v97
	goto L8
L29:
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v124))) = v168
	v210 = *(*int32)(unsafe.Add(mBase, _consts[79]))
...
L45:
	;
	F_errfinish(m, int32(520999), int32(4145), int32(233104))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L13
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v46
	F_errmsg_internal(m, int32(736279), v14)
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L13
...
L51:
	;
	F_errfinish(m, int32(520999), int32(4155), int32(233104))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L13
...
L56:
	;
	F_errmsg(m, int32(308080), int32(0))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L13
...
L59:
	;
	F_errfinish(m, int32(520999), int32(4163), int32(233104))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L13
...
func F_mbtowc(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l1 == int32(0) {
		...
		if int32(0) <= v11 {
			...
			v19 = *(*int32)(unsafe.Add(mBase, _consts[1178]))
			...
			if v20 == int32(0) {
				...
				if base.Ui32(int32(50)) < base.Ui32(v32) {
					*(*int32)(unsafe.Add(mBase, _consts[163])) = int32(25)
					...
					v44 = *(*int32)(unsafe.Add(mBase, uint32(v32<<(uint(int32(2))%32))+uint32(_consts[1179])))
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v63
	F_errmsg_internal(m, int32(356531), v14)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L14
					...
					if v67 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70
						...
						if v74 != 0 {
							...
							F_errfinish(m, int32(520490), int32(71), int32(534349))
							mBase = m.M
							v79 = m.ExcPending
							if v79 != 0 {
								return int32(0)
...
L38:
	;
	v282 = *(*int32)(unsafe.Add(mBase, _consts[163]))
	F_errstart_cold(m, int32(21), int32(0))
	mBase = m.M
	v286 = m.ExcPending
	if v286 != 0 {
...
L54:
	...
	v291 = *(*int32)(unsafe.Add(mBase, _consts[191]))
...
L59:
	;
	F_errfinish(m, int32(526015), int32(1134), int32(37213))
	mBase = m.M
	v315 = m.ExcPending
	if v315 != 0 {
		goto L4
...
L65:
	;
	F_errmsg_internal(m, int32(18484), int32(0))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L4
...
L66:
	;
	F_errfinish(m, int32(526015), int32(1092), int32(37213))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L4
				...
				if v90 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = l3
					...
					if v98 != 0 {
						...
						F_errfinish(m, int32(517348), int32(301), int32(254330))
						mBase = m.M
						v103 = m.ExcPending
						if v103 != 0 {
							return int32(0)
					...
					if v74 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(11)
						...
						if v80 != 0 {
							...
							F_errfinish(m, int32(523979), int32(2886), int32(254468))
							mBase = m.M
							v85 = m.ExcPending
							if v85 != 0 {
								return int32(0)
				...
				if v24 != 0 {
					...
					if v27 != 0 {
						...
						if v31 != 0 {
							...
							F_errfinish(m, int32(523465), int32(521), int32(359281))
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
							} else {
...
L186:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v164
	F_errmsg_internal(m, int32(47223), v17+int32(16))
	mBase = m.M
	v544 = m.ExcPending
	if v544 != 0 {
		goto L2
...
L187:
	;
	F_errfinish(m, int32(520402), int32(690), int32(9945))
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L2
...
L192:
	;
	F_errfinish(m, int32(520402), int32(318), int32(322947))
	mBase = m.M
	v585 = m.ExcPending
	if v585 != 0 {
		goto L2
...
L195:
	;
	F_errfinish(m, int32(520402), int32(509), int32(9945))
	mBase = m.M
	v598 = m.ExcPending
	if v598 != 0 {
		goto L2
...
L223:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v164
	F_errmsg_internal(m, int32(47329), v17)
	mBase = m.M
	v725 = m.ExcPending
	if v725 != 0 {
		goto L2
...
L224:
	;
	F_errfinish(m, int32(520402), int32(402), int32(322947))
	mBase = m.M
	v730 = m.ExcPending
	if v730 != 0 {
		goto L2
...
func F_multixactoffsetssyncfiletag(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = F_SlruSyncFileTag(m, int32(4456772), l0, l1)
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
