...
func F_md5_bytea(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v4 = Fn13966(m, l0, int32(_a_F_md5_bytea_0), int32(71))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
...
func F_minmax_multi_get_procinfo(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = Fn13872(m, l0, l1, int32(_a_F_minmax_multi_get_procinfo_0), int32(2886), int32(_a_F_minmax_multi_get_procinfo_1))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
