...
L51:
	;
	v167 = *(*int32)(unsafe.Add(mBase, _c_F_wcstombs[0]))
...
L53:
	;
	if v152&int32(-128) == int32(_a_F_wcstombs_0) {
		goto L47
	} else {
		goto L56
	}
...
L59:
	;
	if base.B2i32(v152&int32(-8192) != int32(_a_F_wcstombs_1))&base.B2i32(base.Ui32(int32(_a_F_wcstombs_2)) <= base.Ui32(v152)) == int32(0) {
		goto L60
	} else {
		goto L61
	}
...
L62:
	;
	if base.Ui32(v152-int32(_a_F_wcstombs_3)) <= base.Ui32(int32(_a_F_wcstombs_4)) {
		goto L63
	} else {
		goto L64
	}
...
L85:
	;
	v311 = *(*int32)(unsafe.Add(mBase, _c_F_wcstombs[0]))
...
L87:
	;
	if v294&int32(-128) == int32(_a_F_wcstombs_0) {
		goto L81
	} else {
		goto L90
	}
...
L93:
	;
	if base.B2i32(v294&int32(-8192) != int32(_a_F_wcstombs_1))&base.B2i32(base.Ui32(int32(_a_F_wcstombs_2)) <= base.Ui32(v294)) == int32(0) {
		goto L94
	} else {
		goto L95
	}
...
L96:
	;
	if base.Ui32(v294-int32(_a_F_wcstombs_3)) <= base.Ui32(int32(_a_F_wcstombs_4)) {
		goto L97
	} else {
		goto L98
	}
...
L107:
	;
	v407 = *(*int32)(unsafe.Add(mBase, _c_F_wcstombs[0]))
...
L109:
	;
	if v403&int32(-128) == int32(_a_F_wcstombs_0) {
		goto L103
	} else {
		goto L112
	}
...
L115:
	;
	if base.B2i32(v403&int32(-8192) != int32(_a_F_wcstombs_1))&base.B2i32(base.Ui32(int32(_a_F_wcstombs_2)) <= base.Ui32(v403)) == int32(0) {
		goto L116
	} else {
		goto L117
	}
...
L118:
	;
	if base.Ui32(v403-int32(_a_F_wcstombs_3)) <= base.Ui32(int32(_a_F_wcstombs_4)) {
		goto L119
	} else {
		goto L120
	}
...
func F_websearch_to_tsquery(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		if v10 != 0 {
			...
			v11 = F_DirectFunctionCall2Coll(m, int32(1181), int32(0), v9, v3)
			mBase = m.M
			v12 = m.ExcPending
			if v12 != 0 {
				return int32(0)
...
func F_win866_to_koi8r(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(20), int32(22), int32(_a_F_win866_to_koi8r_0), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win866_to_mic(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_latin2mic_with_table(m, v6, v5, v10, int32(139), int32(20), int32(_a_F_win866_to_mic_0), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
