...
L20:
	;
	v45 = *(*int32)(unsafe.Add(mBase, _consts[1178]))
...
L51:
	;
	v167 = *(*int32)(unsafe.Add(mBase, _consts[1178]))
...
L85:
	;
	v311 = *(*int32)(unsafe.Add(mBase, _consts[1178]))
...
L107:
	;
	v407 = *(*int32)(unsafe.Add(mBase, _consts[1178]))
			...
			if v175 != 0 {
				...
				if v178 != 0 {
					...
					if v182 != 0 {
						...
						F_errfinish(m, int32(518640), int32(4090), int32(583154))
						mBase = m.M
						v187 = m.ExcPending
						if v187 != 0 {
							return int32(0)
						...
						if v191 != 0 {
							...
							if v194 != 0 {
								...
								if v198 != 0 {
									...
									F_errfinish(m, int32(518640), int32(4096), int32(583154))
									mBase = m.M
									v203 = m.ExcPending
									if v203 != 0 {
										return int32(0)
											...
											if v51 != 0 {
												...
												if v54 != 0 {
													...
													if v58 != 0 {
														...
														F_errfinish(m, int32(518640), int32(4107), int32(583154))
														mBase = m.M
														v63 = m.ExcPending
														if v63 != 0 {
															return int32(0)
									...
									if v207 != 0 {
										...
										if v210 != 0 {
											...
											if v214 != 0 {
												...
												F_errfinish(m, int32(518640), int32(4162), int32(583154))
												mBase = m.M
												v219 = m.ExcPending
												if v219 != 0 {
													return int32(0)
												...
												if v107 != 0 {
													...
													if v110 != 0 {
														...
														if v114 != 0 {
															...
															F_errfinish(m, int32(518640), int32(4145), int32(583154))
															mBase = m.M
															v119 = m.ExcPending
															if v119 != 0 {
																return int32(0)
		...
		if v157 != 0 {
			...
			if v160 != 0 {
				...
				if v164 != 0 {
					...
					F_errfinish(m, int32(518640), int32(4085), int32(583154))
					mBase = m.M
					v169 = m.ExcPending
					if v169 != 0 {
						return int32(0)
...
func F_win866_to_koi8r(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_local2local(m, v6, v5, v10, int32(20), int32(22), int32(2271152), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_win866_to_mic(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v22 = F_latin2mic_with_table(m, v6, v5, v10, int32(139), int32(20), int32(2271152), base.B2i32(v7 != int32(0)))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
