...
func F_pgl_send(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v10 int32
	_ = v10
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_pgl_send[0]))
...
func F_pgl_set_pclose_fn(m *base.Module, l0 int32) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _c_F_pgl_set_pclose_fn[0])) = l0
	return
}
func F_pgl_set_popen_fn(m *base.Module, l0 int32) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _c_F_pgl_set_popen_fn[0])) = l0
	return
}
func F_pgl_shmget(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v68 int32
	_ = v68
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_pgl_shmget[0]))
	if v8 != 0 {
		goto L1
	} else {
		goto L2
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pgl_shmget[1])) = int32(44)
	return int32(-1)
L13:
	;
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pgl_shmget[1])) = int32(48)
	return int32(-1)
L17:
	;
	goto L18
...
L21:
	;
	v56 = int32(_a_F_pgl_shmget_1)
	v58 = *(*int32)(unsafe.Add(mBase, _c_F_pgl_shmget[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_pgl_shmget[2])) = v58 + int32(1)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v47))) = v58
	v67 = int32(_a_F_pgl_shmget_2)
	v68 = *(*int32)(unsafe.Add(mBase, _c_F_pgl_shmget[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v47)+20)) = v68
	*(*int32)(unsafe.Add(mBase, _c_F_pgl_shmget[0])) = v47
	return v58
}
