...
func F_pgl_exit(m *base.Module, l0 int32) {
	...
	var v17 int32
	_ = v17
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1037]))
	if v4 != 0 {
		v5 = F_fclose(m, v4)
		mBase = m.M
		v6 = m.ExcPending
		if v6 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[1037])) = int32(0)
			v11 = *(*int32)(unsafe.Add(mBase, _consts[1038]))
			if v11 != 0 {
				v12 = F_fflush(m, v11)
				mBase = m.M
				v13 = m.ExcPending
				if v13 != 0 {
					...
					v15 = *(*int32)(unsafe.Add(mBase, _consts[1038]))
					v16 = F_fclose(m, v15)
					mBase = m.M
					v17 = m.ExcPending
					if v17 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _consts[1038])) = int32(0)
						*(*int32)(unsafe.Add(mBase, _consts[1039])) = int32(-1)
...
func F_pgl_popen(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v9 int32
	_ = v9
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1035]))
	if v5 != 0 {
...
func F_pgl_send(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v10 int32
	_ = v10
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1042]))
...
func F_pgl_set_pclose_fn(m *base.Module, l0 int32) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _consts[1036])) = l0
	return
}
...
func F_pgl_shmget(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v68 int32
	_ = v68
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1040]))
	if v8 != 0 {
		goto L1
	} else {
		goto L2
...
L21:
	;
	v56 = int32(4099356)
	v58 = *(*int32)(unsafe.Add(mBase, _consts[1041]))
	*(*int32)(unsafe.Add(mBase, _consts[1041])) = v58 + int32(1)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v47))) = v58
	v67 = int32(4509720)
	v68 = *(*int32)(unsafe.Add(mBase, _consts[1040]))
	*(*int32)(unsafe.Add(mBase, uint32(v47)+20)) = v68
	*(*int32)(unsafe.Add(mBase, _consts[1040])) = v47
	return v58
}
