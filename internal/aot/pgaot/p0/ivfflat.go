...
L35:
	;
	F_errfinish(m, int32(_a_F_IvfflatNormVectors_2), int32(326), int32(_a_F_IvfflatNormVectors_3))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L11
...
L38:
	;
	F_errfinish(m, int32(_a_F_IvfflatNormVectors_2), int32(337), int32(_a_F_IvfflatNormVectors_4))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L11
