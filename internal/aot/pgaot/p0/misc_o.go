			...
			if v157 != 0 {
				...
				if v156 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v17))) = v158
					F_errmsg_internal(m, int32(_a_F_offsethash_stat_0), v17)
					mBase = m.M
					v171 = m.ExcPending
					if v171 != 0 {
						return
					} else {
						F_errfinish(m, int32(_a_F_offsethash_stat_1), int32(1144), int32(_a_F_offsethash_stat_2))
						mBase = m.M
						v176 = m.ExcPending
						if v176 != 0 {
							return
...
L14:
	;
	v56 = F_uint32in_subr(m, v48, v11+int32(12), int32(_a_F_oidvectorin_0), v15)
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L1
...
L64:
	;
	v147 = *(*int32)(unsafe.Add(mBase, _c_F_oper[0]))
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ordered_set_startup[0])) = v418
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v83)+16)) = v379
	v388 = F_MakeSingleTupleTableSlot(m, v379, int32(_a_F_ordered_set_startup_0))
	mBase = m.M
	v389 = m.ExcPending
	if v389 != 0 {
		goto L37
...
L79:
	;
	F_TupleDescInitEntry(m, v260, base.I32_extend16_s(v259), int32(_a_F_ordered_set_startup_2), int32(23), int32(-1), int32(0))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L37
...
L103:
	...
	v434 = *(*int32)(unsafe.Add(mBase, _c_F_ordered_set_startup[1]))
...
L105:
	...
	v443 = *(*int32)(unsafe.Add(mBase, _c_F_ordered_set_startup[1]))
...
L108:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ordered_set_startup[0])) = v415
	m.G0 = v15 + int32(16)
	return v421
L109:
	;
