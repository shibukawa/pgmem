	...
	if v8 != 0 {
		...
		if v12 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8
			F_errmsg_internal(m, int32(503733), v6)
			mBase = m.M
			v16 = m.ExcPending
			if v16 != 0 {
				return
			} else {
				F_errfinish(m, int32(524276), int32(135), int32(342910))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return
		...
		v23 = *(*int32)(unsafe.Add(mBase, _consts[519]))
...
func F___openlog(m *base.Module) {
	...
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, _consts[1195])) = v6
	if v1 <= v6 {
		v10 = F_connect(m, v6)
		mBase = m.M
	} else {
				...
				if v156 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v17))) = v158
					...
					if v171 != 0 {
						...
						F_errfinish(m, int32(344283), int32(1144), int32(119611))
						mBase = m.M
						v176 = m.ExcPending
						if v176 != 0 {
							return
...
L14:
	;
	v56 = F_uint32in_subr(m, v48, v11+int32(12), int32(457395), v15)
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L1
...
L5:
	;
	v26 = *(*int32)(unsafe.Add(mBase, _consts[238]))
	if v26 != 0 {
		goto L6
	} else {
		goto L7
...
L7:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v15)+156)) = int64(601295421576)
	v35 = F_hash_create(m, int32(419586), int32(256), v15+int32(140), int32(40))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L3
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, _consts[238])) = v35
...
L11:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[238]))
	v50 = v49
	goto L8
L12:
	;
...
L64:
	;
	v147 = *(*int32)(unsafe.Add(mBase, _consts[238]))
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v83)+16)) = v379
	v388 = F_MakeSingleTupleTableSlot(m, v379, int32(1655164))
	mBase = m.M
	v389 = m.ExcPending
	if v389 != 0 {
		goto L37
...
L79:
	;
	F_TupleDescInitEntry(m, v260, base.I32_extend16_s(v259), int32(355971), int32(23), int32(-1), int32(0))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L37
...
L90:
	;
	F_errmsg_internal(m, int32(67637), int32(0))
	mBase = m.M
	v340 = m.ExcPending
	if v340 != 0 {
		goto L37
...
L91:
	;
	F_errfinish(m, int32(519639), int32(127), int32(244088))
	mBase = m.M
	v345 = m.ExcPending
	if v345 != 0 {
		goto L37
...
L94:
	;
	F_errfinish(m, int32(519639), int32(144), int32(244088))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L37
...
L96:
	;
	F_errmsg_internal(m, int32(373982), int32(0))
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L37
...
L97:
	;
	F_errfinish(m, int32(519639), int32(146), int32(244088))
	mBase = m.M
	v371 = m.ExcPending
	if v371 != 0 {
		goto L37
...
L102:
	;
	v447 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v421)+24)) = uint8(v447)
	*(*int64)(unsafe.Add(mBase, uint32(v421)+16)) = int64(0)
	*(*int32)(unsafe.Add(mBase, uint32(v421)+8)) = v446
...
L103:
	...
	v434 = *(*int32)(unsafe.Add(mBase, _consts[323]))
	v436 = F_tuplesort_begin_heap(m, v427, v428, v429, v430, v431, v432, v434, int32(0), v426)
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L37
...
L105:
	;
	v438 = *(*int32)(unsafe.Add(mBase, uint32(v407)+52))
	v439 = *(*int32)(unsafe.Add(mBase, uint32(v407)+60))
	v440 = *(*int32)(unsafe.Add(mBase, uint32(v407)+68))
	v441 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v407)+72)))
	v443 = *(*int32)(unsafe.Add(mBase, _consts[323]))
	v444 = F_tuplesort_begin_datum(m, v438, v439, v440, v441, v443, v426)
	mBase = m.M
	v445 = m.ExcPending
	if v445 != 0 {
		goto L37
...
L110:
	;
	v455 = *(*int32)(unsafe.Add(mBase, uint32(v452)))
	if v455 != int32(429) {
		goto L109
	} else {
		goto L111
...
L113:
	;
	F_errmsg_internal(m, int32(66127), int32(0))
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L37
...
L114:
	;
	F_errfinish(m, int32(524563), int32(4770), int32(336054))
	mBase = m.M
	v474 = m.ExcPending
	if v474 != 0 {
		goto L37
...
L116:
	;
	F_errmsg_internal(m, int32(157814), int32(0))
	mBase = m.M
	v489 = m.ExcPending
	if v489 != 0 {
		goto L37
...
L117:
	;
	F_errfinish(m, int32(519639), int32(251), int32(244088))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L37
	...
	if v14 != 0 {
		...
		if v11 != int64(0) {
			...
			*(*uint32)(unsafe.Add(mBase, uint32(v9)+28)) = uint32(v30)
			F_errcontext_msg(m, int32(543181), v9+int32(16))
			mBase = m.M
			v36 = m.ExcPending
			if v36 != 0 {
				return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = v20
			F_errcontext_msg(m, int32(335608), v9)
			mBase = m.M
			v42 = m.ExcPending
			if v42 != 0 {
				return
