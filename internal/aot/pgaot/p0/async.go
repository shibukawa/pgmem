...
L10:
	;
	v364 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueReadAllNotifications[0]))
	v368 = F_LWLockAcquire(m, v364+int32(3456), int32(1))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L1
...
L36:
	;
	v354 = *(*int64)(unsafe.Add(mBase, uint32(v19)+8))
	if v41 == v354 {
		goto L78
	} else {
		goto L79
...
L39:
	;
	v335 = *(*int32)(unsafe.Add(mBase, uint32(v184)))
	v336 = v184 + v335
	if base.Ui32(v336) < base.Ui32(v158) {
		v183 = v322
		v184 = v336
		goto L37
	} else {
...
L58:
	;
	v314 = *(*int32)(unsafe.Add(mBase, uint32(v184)+12))
	F_NotifyMyFrontEnd(m, v203, v310+v203+int32(1), v314)
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L1
...
L75:
	;
	v318 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueReadAllNotifications[7]))
	v322 = v318
	goto L39
L76:
	;
...
L78:
	;
	v356 = *(*int32)(unsafe.Add(mBase, uint32(v19)))
	if v159|base.B2i32(v356 == v40) == int32(0) {
		v75 = v354
		goto L9
	} else {
		goto L81
...
L83:
	;
	v371 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueReadAllNotifications[1]))
	v373 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueReadAllNotifications[2]))
	v376 = v371 + v373<<(uint(int32(5))%32)
	v377 = *(*int64)(unsafe.Add(mBase, uint32(v19)+8))
	*(*int64)(unsafe.Add(mBase, uint32(v376)+72)) = v377
	v379 = *(*int32)(unsafe.Add(mBase, uint32(v19)))
	*(*int32)(unsafe.Add(mBase, uint32(v376)+84)) = v39
	*(*int32)(unsafe.Add(mBase, uint32(v376)+80)) = v379
	v383 = *(*int32)(unsafe.Add(mBase, _c_F_asyncQueueReadAllNotifications[0]))
	F_LWLockRelease(m, v383+int32(3456))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L1
