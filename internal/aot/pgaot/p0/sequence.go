...
func F_has_sequence_privilege_id(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v17)
		...
		v22 = F_convert_any_priv_string(m, v13, int32(1636176))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
								...
								if v43 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9))) = v42
									...
									if v47 != 0 {
										...
										F_errfinish(m, int32(492525), int32(2222), int32(432568))
										mBase = m.M
										v52 = m.ExcPending
										if v52 != 0 {
											return int32(0)
...
func F_has_sequence_privilege_id_name(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		if v18 != 0 {
			...
			v20 = F_convert_any_priv_string(m, v17, int32(1636176))
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return int32(0)
											...
											if v44 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v8))) = v43
												...
												if v48 != 0 {
													...
													F_errfinish(m, int32(492525), int32(2253), int32(377034))
													mBase = m.M
													v53 = m.ExcPending
													if v53 != 0 {
														return int32(0)
