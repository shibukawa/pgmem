...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+80)) = v98
	F_errmsg(m, int32(_a_F_CopyFromTextOneRow_0), v23+int32(80))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L11
...
L81:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v23)+32)) = v303
	F_errmsg(m, int32(_a_F_CopyFromTextOneRow_3), v23+int32(32))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L11
...
L88:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v23)+16)) = v328
	F_errmsg(m, int32(_a_F_CopyFromTextOneRow_5), v23+int32(16))
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L11
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v246 + int32(4)
	F_errmsg(m, int32(_a_F_CopyFromTextOneRow_6), v23)
	mBase = m.M
	v359 = m.ExcPending
	if v359 != 0 {
		goto L11
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+48)) = v51
	F_errmsg(m, int32(_a_F_CopyFromTextOneRow_9), v23+int32(48))
	mBase = m.M
	v463 = m.ExcPending
	if v463 != 0 {
		goto L11
