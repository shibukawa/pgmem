...
func F_has_server_privilege_id(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v8)+15)) = uint8(v16)
		...
		v22 = F_convert_any_priv_string(m, v12, int32(1657280))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
...
func F_has_server_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v22 = F_convert_any_priv_string(m, v14, int32(1657280))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					v20 = F_convert_any_priv_string(m, v11, int32(1657280))
					mBase = m.M
					v21 = m.ExcPending
					if v21 != 0 {
						return int32(0)
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v22 != 0 {
			...
			v24 = F_convert_any_priv_string(m, v14, int32(1657280))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = int32(759604)
...
L73:
	;
	F_errfinish(m, int32(495005), int32(102), int32(32030))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L2
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = l1
	F_errmsg(m, int32(8588), v10+int32(-32))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L2
...
L77:
	;
	F_errfinish(m, int32(495005), int32(116), int32(32030))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L2
...
L81:
	;
	F_errfinish(m, int32(495005), int32(124), int32(32030))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L2
...
L84:
	;
	F_errmsg(m, int32(214320), int32(0))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L2
...
L85:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = int32(164812)
	F_errdetail(m, int32(608507), v10+int32(-16))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L2
...
L86:
	;
	F_errfinish(m, int32(495005), int32(75), int32(32030))
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L2
...
L89:
	;
	F_errmsg(m, int32(214266), int32(0))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L2
...
L90:
	;
	F_errfinish(m, int32(495005), int32(89), int32(32030))
	mBase = m.M
	v252 = m.ExcPending
	if v252 != 0 {
		goto L2
