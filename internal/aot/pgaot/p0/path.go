...
L2:
	;
	v15 = *(*int64)(unsafe.Add(mBase, _c_F_SearchPathMatchesCurrentEnvironment[0]))
...
L4:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_SearchPathMatchesCurrentEnvironment[1]))
	if v19 != 0 {
		goto L10
	} else {
		goto L11
...
L6:
	;
	v72 = int32(0)
	v74 = *(*int32)(unsafe.Add(mBase, _c_F_SearchPathMatchesCurrentEnvironment[2]))
	if v70 == v72 {
		v79 = v72
		v82 = v74
		v83 = v72
...
L7:
	;
	v66 = int32(0)
	v68 = *(*int32)(unsafe.Add(mBase, _c_F_SearchPathMatchesCurrentEnvironment[2]))
	v79 = v66
	v82 = v68
	v83 = v66
	goto L5
...
L9:
	...
	v34 = *(*int32)(unsafe.Add(mBase, _c_F_SearchPathMatchesCurrentEnvironment[3]))
	if v32 != v34 {
		v144 = int32(0)
		goto L3
	} else {
...
L19:
	...
	v284 = *(*float64)(unsafe.Add(mBase, _c_F_create_merge_append_path[0]))
	v286 = *(*float64)(unsafe.Add(mBase, _c_F_create_merge_append_path[1]))
...
L52:
	...
	v204 = *(*int32)(unsafe.Add(mBase, _c_F_create_merge_append_path[2]))
	...
	*(*float64)(unsafe.Add(mBase, uint32(v196)+32)) = v199
	v217 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_create_merge_append_path[3])))
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v39
	F_appendStringInfo(m, v11+int32(32), int32(_a_F_path_encode_0), v11+int32(16))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v85
	F_appendStringInfo(m, v11+int32(32), int32(_a_F_path_encode_0), v11)
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
