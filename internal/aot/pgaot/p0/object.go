...
func F_GetNewObjectId(m *base.Module) int32 {
	...
	if v15 == int32(0) {
		...
		if v97 != 0 {
			...
			F_errmsg_internal(m, int32(14595), int32(0))
			mBase = m.M
			v101 = m.ExcPending
			if v101 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(490690), int32(561), int32(460708))
				mBase = m.M
				v106 = m.ExcPending
				if v106 != 0 {
					return int32(0)
			...
			if v207 != 0 {
				...
				if v212 != 0 {
					...
					if v215 != 0 {
						...
						F_errmsg(m, int32(215907), int32(0))
						mBase = m.M
						v219 = m.ExcPending
						if v219 != 0 {
							return
						} else {
							F_errfinish(m, int32(488742), int32(2551), int32(235562))
							mBase = m.M
							v224 = m.ExcPending
							if v224 != 0 {
								return
	...
	case 2, 3, 10, 11, 31, 32, 50:
		...
		if v228 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9)+96)) = l1
			F_errmsg_internal(m, int32(479938), v9+int32(96))
			mBase = m.M
			v234 = m.ExcPending
			if v234 != 0 {
				return
			} else {
				F_errfinish(m, int32(488742), int32(2561), int32(235562))
				mBase = m.M
				v239 = m.ExcPending
				if v239 != 0 {
					return
										...
										if v120 != 0 {
											...
											if v122 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v119
												F_errmsg(m, int32(188785), v9+int32(32))
												mBase = m.M
												v129 = m.ExcPending
												if v129 != 0 {
													return
												} else {
													F_errfinish(m, int32(488742), int32(2496), int32(235562))
													mBase = m.M
													v134 = m.ExcPending
													if v134 != 0 {
														return
			...
			if v30 == int32(0) {
				...
				if v243 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v29
					F_errmsg_internal(m, int32(68431), v9)
					mBase = m.M
					v247 = m.ExcPending
					if v247 != 0 {
						return
					} else {
						F_errfinish(m, int32(488742), int32(2426), int32(235562))
						mBase = m.M
						v252 = m.ExcPending
						if v252 != 0 {
							return
					...
					if v82 != 0 {
						...
						if v85 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v76
							F_errmsg(m, int32(41836), v9+int32(16))
							mBase = m.M
							v91 = m.ExcPending
							if v91 != 0 {
								return
							} else {
								F_errfinish(m, int32(488742), int32(2480), int32(235562))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return
					...
					if v149 != 0 {
						...
						if v154 != 0 {
							...
							if v157 != 0 {
								...
								F_errmsg(m, int32(451864), int32(0))
								mBase = m.M
								v161 = m.ExcPending
								if v161 != 0 {
									return
								} else {
									*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = int32(520195)
									F_errdetail(m, int32(609407), v9+int32(48))
									mBase = m.M
									v168 = m.ExcPending
									if v168 != 0 {
										return
									} else {
										F_errfinish(m, int32(488742), int32(2523), int32(235562))
										mBase = m.M
										v173 = m.ExcPending
										if v173 != 0 {
											return
						...
						if v256 != 0 {
							...
							if v259 != 0 {
								...
								if v263 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9)+80)) = int32(534922)
									F_errdetail(m, int32(609407), v9+int32(80))
									mBase = m.M
									v270 = m.ExcPending
									if v270 != 0 {
										return
									} else {
										F_errfinish(m, int32(488742), int32(2532), int32(235562))
										mBase = m.M
										v275 = m.ExcPending
										if v275 != 0 {
											return
									...
									if v186 != 0 {
										...
										if v190 != 0 {
											...
											if v193 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = int32(525102)
												F_errdetail(m, int32(646336), v9-int32(-64))
												mBase = m.M
												v201 = m.ExcPending
												if v201 != 0 {
													return
												} else {
													F_errfinish(m, int32(488742), int32(2540), int32(235562))
													mBase = m.M
													v206 = m.ExcPending
													if v206 != 0 {
														return
					...
					if v26 != 0 {
						...
						if v28 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v27
							F_errmsg(m, int32(71745), v9)
							mBase = m.M
							v32 = m.ExcPending
							if v32 != 0 {
								return
							} else {
								F_errfinish(m, int32(488742), int32(1624), int32(362813))
								mBase = m.M
								v37 = m.ExcPending
								if v37 != 0 {
									return
							...
							if v62 != 0 {
								...
								if v64 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v63
									F_errmsg(m, int32(275302), v9+int32(16))
									mBase = m.M
									v70 = m.ExcPending
									if v70 != 0 {
										return
									} else {
										F_errfinish(m, int32(488742), int32(1635), int32(362813))
										mBase = m.M
										v75 = m.ExcPending
										if v75 != 0 {
											return
