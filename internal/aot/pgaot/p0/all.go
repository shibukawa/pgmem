...
func F_ExecGetAllUpdatedCols(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v5 == int32(0) {
		...
		if v11 != 0 {
			...
			v12 = v8
			v13 = int32(_a_F_ExecGetAllUpdatedCols_0)
			v14 = *(*int32)(unsafe.Add(mBase, _c_F_ExecGetAllUpdatedCols[0]))
			v16 = *(*int32)(unsafe.Add(mBase, uint32(v12)+20))
			*(*int32)(unsafe.Add(mBase, _c_F_ExecGetAllUpdatedCols[0])) = v16
				...
				if v20 == int32(0) {
					...
					if v25 != 0 {
						...
						if v28 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _c_F_ExecGetAllUpdatedCols[0])) = v14
							return v27
						}
					}
				} else {
...
L13:
	;
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_all_rows_selectable[0]))
	v48 = v47
	goto L15
L14:
	;
...
L99:
	...
	v395 = v386 - int32(7)
	if v395&int32(_a_F_all_rows_selectable_0) == int32(0) {
		goto L102
	} else {
		goto L103
	}
