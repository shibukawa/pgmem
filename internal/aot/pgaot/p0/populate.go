			...
			if v25 != 0 {
				...
				if v22 == int32(0) {
					...
					if v30 != 0 {
						...
						F_errmsg(m, int32(25736), int32(0))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return int32(0)
							...
							if v38 != 0 {
								...
								F_errsave_finish(m, v21, int32(485799), int32(2601), int32(267475))
								mBase = m.M
								v43 = m.ExcPending
								if v43 != 0 {
									return int32(0)
...
L11:
	;
	F_errmsg(m, int32(25716), int32(0))
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L5
...
L13:
	;
	F_errsave_finish(m, v13, int32(485799), int32(2518), int32(24290))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L5
...
L17:
	;
	F_errsave_finish(m, v13, int32(485799), int32(2522), int32(24290))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L5
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v62
	F_appendStringInfo(m, v8-int32(-64), int32(498446), v8+int32(48))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L5
...
L25:
	;
	F_errsave_finish(m, v75, int32(485799), v116, int32(24290))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L5
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+36)) = v88
	F_errhint(m, int32(638835), v8+int32(32))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L5
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v107
	F_errhint(m, int32(577989), v8+int32(16))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L5
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+56)) = v126
	v133 = F_hash_create(m, int32(384980), int32(100), v14+int32(-48), int32(1048))
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L8
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v136)+4)) = int32(343071)
...
L72:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = int32(343071)
	F_errmsg(m, v200, v16)
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
...
L73:
	;
	F_errsave_finish(m, l6, int32(485799), int32(3020), int32(109493))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L8
