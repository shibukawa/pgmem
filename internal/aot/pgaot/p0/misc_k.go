...
func F_KnownAssignedXidsAdd(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v73 < v72 {
		v76 = *(*int32)(unsafe.Add(mBase, _consts[603]))
		v77 = int32(2)
		...
		if v94 != 0 {
			...
			if v198 != 0 {
				...
				if v202 != 0 {
					...
					F_errmsg_internal(m, int32(184636), int32(0))
					mBase = m.M
					v206 = m.ExcPending
					if v206 != 0 {
						return
					} else {
						F_errfinish(m, int32(517268), int32(4831), int32(486456))
						mBase = m.M
						v211 = m.ExcPending
						if v211 != 0 {
							return
				...
				if v100 != 0 {
					...
					if v101 < v102+v66 {
						...
						if v215 != 0 {
							...
							F_errmsg_internal(m, int32(184609), int32(0))
							mBase = m.M
							v219 = m.ExcPending
							if v219 != 0 {
								return
							} else {
								F_errfinish(m, int32(517268), int32(4848), int32(486456))
								mBase = m.M
								v224 = m.ExcPending
								if v224 != 0 {
									return
						...
						if v66 <= int32(0) {
							...
							v109 = *(*int32)(unsafe.Add(mBase, _consts[604]))
							v111 = *(*int32)(unsafe.Add(mBase, _consts[603]))
							if v66 != int32(1) {
								v116 = l0
								v119 = v105
								v123 = int32(0)
...
func F_kill(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 == int32(42) {
		...
		*(*int32)(unsafe.Add(mBase, _consts[163])) = int32(63)
		return int32(-1)
	}
}
