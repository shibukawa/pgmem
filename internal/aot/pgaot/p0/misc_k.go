		...
		if v94 != 0 {
			...
			if v198 != 0 {
				...
				if v202 != 0 {
					...
					F_errmsg_internal(m, int32(172691), int32(0))
					mBase = m.M
					v206 = m.ExcPending
					if v206 != 0 {
						return
					} else {
						F_errfinish(m, int32(489352), int32(4831), int32(460729))
						mBase = m.M
						v211 = m.ExcPending
						if v211 != 0 {
							return
				...
				if v100 != 0 {
					...
					if v101 < v102+v66 {
						...
						if v215 != 0 {
							...
							F_errmsg_internal(m, int32(172664), int32(0))
							mBase = m.M
							v219 = m.ExcPending
							if v219 != 0 {
								return
							} else {
								F_errfinish(m, int32(489352), int32(4848), int32(460729))
								mBase = m.M
								v224 = m.ExcPending
								if v224 != 0 {
									return
