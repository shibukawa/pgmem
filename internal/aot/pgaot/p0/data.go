...
L3:
	;
	v9 = int32(4418204)
	v11 = *(*int32)(unsafe.Add(mBase, _consts[906]))
	*(*int32)(unsafe.Add(mBase, _consts[906])) = v11 + int32(1)
	v15 = int32(4425280)
	v16 = *(*int32)(unsafe.Add(mBase, _consts[0]))
	v19 = *(*int32)(unsafe.Add(mBase, _consts[903]))
	v21 = v19 * int32(100)
	v24 = *(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[907])))
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[905]))) = v28
	goto L8
L7:
	;
	goto L8
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[909]))) = v31
	goto L11
L13:
	;
	v35 = F_pstrdup(m, v34)
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[910]))) = v35
	goto L15
L17:
	;
	v39 = F_pstrdup(m, v38)
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[913]))) = v39
	goto L19
L21:
	;
	v43 = F_pstrdup(m, v42)
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[911]))) = v43
	goto L23
L25:
	;
	v47 = F_pstrdup(m, v46)
...
L28:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[914]))) = v47
	goto L27
L29:
	;
	v51 = F_pstrdup(m, v50)
...
L32:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[915]))) = v51
	goto L31
L33:
	;
	v55 = F_pstrdup(m, v54)
...
L36:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[916]))) = v55
	goto L35
L37:
	;
	v59 = F_pstrdup(m, v58)
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[917]))) = v59
	goto L39
L41:
	;
	v63 = F_pstrdup(m, v62)
...
L44:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[918]))) = v63
	goto L43
L45:
	;
	v67 = F_pstrdup(m, v66)
...
L48:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[919]))) = v67
	goto L47
L49:
	;
	v71 = F_pstrdup(m, v70)
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[921]))) = v74
	v76 = *(*int32)(unsafe.Add(mBase, uint32(l0)+84))
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[922]))) = v76
...
L52:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[920]))) = v71
	goto L51
L53:
	;
	v79 = F_pstrdup(m, v78)
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v16
	v84 = int32(4418204)
	v86 = *(*int32)(unsafe.Add(mBase, _consts[906]))
	*(*int32)(unsafe.Add(mBase, _consts[906])) = v86 - int32(1)
...
L56:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[923]))) = v79
	goto L55
L57:
	;
	goto L5
...
L215:
	;
	F_errfinish(m, int32(468710), v1699, int32(318702))
	mBase = m.M
	v1702 = m.ExcPending
	if v1702 != 0 {
		goto L29
...
L235:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+76)) = v1279 - (v1221 + v1280)
	F_errmsg_internal(m, int32(626042), v26-int32(-64))
	mBase = m.M
	v1292 = m.ExcPending
	if v1292 != 0 {
		goto L29
...
L243:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+92)) = v1317 - (v1221 + v1318)
	F_errmsg_internal(m, int32(625987), v26+int32(80))
	mBase = m.M
	v1330 = m.ExcPending
	if v1330 != 0 {
		goto L29
...
L297:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+8)) = v1624
	F_errmsg_internal(m, int32(626151), v26)
	mBase = m.M
	v1635 = m.ExcPending
	if v1635 != 0 {
		goto L29
...
L305:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+40)) = v1660
	F_errmsg_internal(m, int32(626097), v26+int32(32))
	mBase = m.M
	v1673 = m.ExcPending
	if v1673 != 0 {
		goto L29
...
L311:
	;
	F_errmsg_internal(m, int32(94759), int32(0))
	mBase = m.M
	v1763 = m.ExcPending
	if v1763 != 0 {
		goto L29
...
L312:
	;
	F_errfinish(m, int32(468710), int32(580), int32(318702))
	mBase = m.M
	v1768 = m.ExcPending
	if v1768 != 0 {
		goto L29
...
L314:
	;
	F_errmsg_internal(m, int32(94810), int32(0))
	mBase = m.M
	v1799 = m.ExcPending
	if v1799 != 0 {
		goto L29
...
L315:
	;
	F_errfinish(m, int32(468710), int32(589), int32(318702))
	mBase = m.M
	v1804 = m.ExcPending
	if v1804 != 0 {
		goto L29
...
func F_show_data_directory_mode(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v7
	v12 = F_pg_snprintf(m, int32(4322505), int32(12), int32(227652), v4)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
