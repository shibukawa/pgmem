...
L215:
	;
	F_errfinish(m, int32(490389), v1699, int32(333890))
	mBase = m.M
	v1702 = m.ExcPending
	if v1702 != 0 {
		goto L29
...
L235:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+76)) = v1279 - (v1221 + v1280)
	F_errmsg_internal(m, int32(650008), v26-int32(-64))
	mBase = m.M
	v1292 = m.ExcPending
	if v1292 != 0 {
		goto L29
...
L243:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+92)) = v1317 - (v1221 + v1318)
	F_errmsg_internal(m, int32(649953), v26+int32(80))
	mBase = m.M
	v1330 = m.ExcPending
	if v1330 != 0 {
		goto L29
...
L297:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+8)) = v1624
	F_errmsg_internal(m, int32(650117), v26)
	mBase = m.M
	v1635 = m.ExcPending
	if v1635 != 0 {
		goto L29
...
L305:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v26)+40)) = v1660
	F_errmsg_internal(m, int32(650063), v26+int32(32))
	mBase = m.M
	v1673 = m.ExcPending
	if v1673 != 0 {
		goto L29
...
L311:
	;
	F_errmsg_internal(m, int32(101117), int32(0))
	mBase = m.M
	v1763 = m.ExcPending
	if v1763 != 0 {
		goto L29
...
L312:
	;
	F_errfinish(m, int32(490389), int32(580), int32(333890))
	mBase = m.M
	v1768 = m.ExcPending
	if v1768 != 0 {
		goto L29
...
L314:
	;
	F_errmsg_internal(m, int32(101168), int32(0))
	mBase = m.M
	v1799 = m.ExcPending
	if v1799 != 0 {
		goto L29
...
L315:
	;
	F_errfinish(m, int32(490389), int32(589), int32(333890))
	mBase = m.M
	v1804 = m.ExcPending
	if v1804 != 0 {
		goto L29
...
func F_show_data_directory_mode(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v7
	v12 = F_pg_snprintf(m, int32(4367625), int32(12), int32(238711), v4)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
