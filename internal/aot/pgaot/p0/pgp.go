...
func F_pgp_create_pkt_reader(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v10 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = l3
		v14 = F_pullf_create(m, l0, int32(4341936), v7, l1)
		mBase = m.M
		v15 = m.ExcPending
		if v15 != 0 {
			return int32(0)
...
func F_pgp_set_s2k_digest_algo(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v63 int32
	_ = v63
	v8 = F_pg_strcasecmp(m, int32(530098), l1)
	mBase = m.M
	if v8 == int32(0) {
		v61 = int32(4342064)
		...
		v16 = F_pg_strcasecmp(m, int32(533030), l1)
		mBase = m.M
		if v16 == int32(0) {
			v61 = int32(4342072)
			v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
			...
			v24 = F_pg_strcasecmp(m, int32(533353), l1)
			mBase = m.M
			if v24 == int32(0) {
				v61 = int32(4342080)
				v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
				...
				v32 = F_pg_strcasecmp(m, int32(533794), l1)
				mBase = m.M
				if v32 == int32(0) {
					v61 = int32(4342088)
					v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
					...
					v40 = F_pg_strcasecmp(m, int32(529732), l1)
					mBase = m.M
					if v40 == int32(0) {
						v61 = int32(4342096)
						v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
						...
						v48 = F_pg_strcasecmp(m, int32(531100), l1)
						mBase = m.M
						if v48 == int32(0) {
							v61 = int32(4342104)
							v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
							...
							v57 = F_pg_strcasecmp(m, int32(532708), l1)
							mBase = m.M
							if v57 != 0 {
								v63 = int32(-104)
							} else {
