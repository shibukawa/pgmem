...
func F_pgp_create_pkt_reader(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if v10 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = l3
		v14 = F_pullf_create(m, l0, int32(4367296), v7, l1)
		mBase = m.M
		v15 = m.ExcPending
		if v15 != 0 {
			return int32(0)
...
func F_pgp_set_s2k_digest_algo(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v63 int32
	_ = v63
	v8 = F_pg_strcasecmp(m, int32(544409), l1)
	mBase = m.M
	if v8 == int32(0) {
		v61 = int32(4367424)
		...
		v16 = F_pg_strcasecmp(m, int32(547663), l1)
		mBase = m.M
		if v16 == int32(0) {
			v61 = int32(4367432)
			v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
			...
			v24 = F_pg_strcasecmp(m, int32(547986), l1)
			mBase = m.M
			if v24 == int32(0) {
				v61 = int32(4367440)
				v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
				...
				v32 = F_pg_strcasecmp(m, int32(548427), l1)
				mBase = m.M
				if v32 == int32(0) {
					v61 = int32(4367448)
					v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
					...
					v40 = F_pg_strcasecmp(m, int32(544043), l1)
					mBase = m.M
					if v40 == int32(0) {
						v61 = int32(4367456)
						v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
						...
						v48 = F_pg_strcasecmp(m, int32(545611), l1)
						mBase = m.M
						if v48 == int32(0) {
							v61 = int32(4367464)
							v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
							...
							v57 = F_pg_strcasecmp(m, int32(547341), l1)
							mBase = m.M
							if v57 != 0 {
								v63 = int32(-104)
							} else {
