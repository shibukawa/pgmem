...
L4:
	;
	v36 = *(*int32)(unsafe.Add(mBase, uint32(v23<<(uint(int32(2))%32))+uint32(_c_F_pgp_s2k_process[0])))
...
func F_pgp_set_s2k_digest_algo(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v63 int32
	_ = v63
	v8 = F_pg_strcasecmp(m, int32(_a_F_pgp_set_s2k_digest_algo_0), l1)
	mBase = m.M
	if v8 == int32(0) {
		v61 = int32(_a_F_pgp_set_s2k_digest_algo_1)
		v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
		v63 = v62
	} else {
		v16 = F_pg_strcasecmp(m, int32(_a_F_pgp_set_s2k_digest_algo_2), l1)
		mBase = m.M
		if v16 == int32(0) {
			v61 = int32(_a_F_pgp_set_s2k_digest_algo_3)
			v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
			v63 = v62
		} else {
			v24 = F_pg_strcasecmp(m, int32(_a_F_pgp_set_s2k_digest_algo_4), l1)
			mBase = m.M
			if v24 == int32(0) {
				v61 = int32(_a_F_pgp_set_s2k_digest_algo_5)
				v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
				v63 = v62
			} else {
				v32 = F_pg_strcasecmp(m, int32(_a_F_pgp_set_s2k_digest_algo_6), l1)
				mBase = m.M
				if v32 == int32(0) {
					v61 = int32(_a_F_pgp_set_s2k_digest_algo_7)
					v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
					v63 = v62
				} else {
					v40 = F_pg_strcasecmp(m, int32(_a_F_pgp_set_s2k_digest_algo_8), l1)
					mBase = m.M
					if v40 == int32(0) {
						v61 = int32(_a_F_pgp_set_s2k_digest_algo_9)
						v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
						v63 = v62
					} else {
						v48 = F_pg_strcasecmp(m, int32(_a_F_pgp_set_s2k_digest_algo_10), l1)
						mBase = m.M
						if v48 == int32(0) {
							v61 = int32(_a_F_pgp_set_s2k_digest_algo_11)
							v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
							v63 = v62
						} else {
							v57 = F_pg_strcasecmp(m, int32(_a_F_pgp_set_s2k_digest_algo_12), l1)
							mBase = m.M
							if v57 != 0 {
								v63 = int32(-104)
							} else {
								v61 = int32(_a_F_pgp_set_s2k_digest_algo_13)
								v62 = *(*int32)(unsafe.Add(mBase, uint32(v61)+4))
								v63 = v62
							}
						}
