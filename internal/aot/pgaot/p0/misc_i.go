...
L4:
	...
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_infix[0]))
	v33 = *(*int32)(unsafe.Add(mBase, uint32(v32)+4))
	v38 = *(*int32)(unsafe.Add(mBase, uint32(v33*int32(28))+uint32(_c_F_infix[1])))
	goto L7
L5:
	;
	goto L6
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+8)) = v67 + v70
	...
	v75 = *(*int32)(unsafe.Add(mBase, _c_F_infix[0]))
	v76 = *(*int32)(unsafe.Add(mBase, uint32(v75)+4))
	v81 = *(*int32)(unsafe.Add(mBase, uint32(v76*int32(28))+uint32(_c_F_infix[1])))
	goto L14
L14:
	;
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = v519
	...
	v528 = *(*int32)(unsafe.Add(mBase, uint32(v222<<(uint(int32(2))%32))+uint32(_c_F_infix[2])))
...
L55:
	;
	v275 = F_pg_sprintf(m, v264, int32(_a_F_infix_0), int32(0))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L1
...
L89:
	;
	v455 = F_pg_sprintf(m, v444, int32(_a_F_infix_1), int32(0))
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L1
...
L117:
	;
	v576 = F_pg_sprintf(m, v565, int32(_a_F_infix_0), int32(0))
	mBase = m.M
	v577 = m.ExcPending
	if v577 != 0 {
		goto L1
...
L151:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v717
	v765 = F_pg_sprintf(m, v716, int32(_a_F_infix_2), v16+int32(16))
	mBase = m.M
	v766 = m.ExcPending
	if v766 != 0 {
		goto L1
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v717
	v731 = F_pg_sprintf(m, v716, int32(_a_F_infix_3), v16+int32(32))
	mBase = m.M
	v732 = m.ExcPending
	if v732 != 0 {
		goto L1
...
L156:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v517
	v740 = F_pg_sprintf(m, v716, int32(_a_F_infix_4), v16-int32(-64))
	mBase = m.M
	v741 = m.ExcPending
	if v741 != 0 {
		goto L1
...
L158:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v717
	v746 = F_pg_sprintf(m, v716, int32(_a_F_infix_5), v16+int32(48))
	mBase = m.M
	v747 = m.ExcPending
	if v747 != 0 {
		goto L1
...
L161:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v222
	F_errmsg_internal(m, int32(_a_F_infix_6), v16)
	mBase = m.M
	v755 = m.ExcPending
	if v755 != 0 {
		goto L1
...
L162:
	;
	F_errfinish(m, int32(_a_F_infix_7), int32(1130), int32(_a_F_infix_8))
	mBase = m.M
	v760 = m.ExcPending
	if v760 != 0 {
		goto L1
...
L186:
	;
	v877 = F_pg_sprintf(m, v866, int32(_a_F_infix_1), int32(0))
	mBase = m.M
	v878 = m.ExcPending
	if v878 != 0 {
		goto L1
						...
						*(*int32)(unsafe.Add(mBase, uint32(v47+v48<<(uint(int32(2))%32)))) = v46
						...
						if v54 == int32(1) {
							...
							*(*uint8)(unsafe.Add(mBase, uint32(l2)+4)) = uint8(v74)
							...
							v59 = int32(_a_F_initialize_aggregate_0)
							v60 = *(*int32)(unsafe.Add(mBase, _c_F_initialize_aggregate[1]))
							v62 = *(*int32)(unsafe.Add(mBase, uint32(l0)+168))
							v63 = *(*int32)(unsafe.Add(mBase, uint32(v62)+20))
							*(*int32)(unsafe.Add(mBase, _c_F_initialize_aggregate[1])) = v63
							...
							if v69 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, _c_F_initialize_aggregate[1])) = v60
								v74 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l1)+180)))
								*(*uint8)(unsafe.Add(mBase, uint32(l2)+5)) = uint8(v74)
								*(*uint8)(unsafe.Add(mBase, uint32(l2)+4)) = uint8(v74)
								return
