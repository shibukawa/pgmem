	...
	if v6 == int32(0) {
		...
		if v14 != 0 {
			...
			if v17 != 0 {
				...
				F_errmsg(m, int32(_a_F_tts_buffer_heap_getsysattr_0), int32(0))
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_tts_buffer_heap_getsysattr_1), int32(774), int32(_a_F_tts_buffer_heap_getsysattr_2))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return int32(0)
...
L14:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(l0)+6)) = uint16(v27)
	...
	v453 = v451 & int32(_a_F_tts_minimal_getsomeattrs_0)
...
L24:
	...
	if v83 == int32(_a_F_tts_minimal_getsomeattrs_1) {
		goto L26
	} else {
		goto L27
	}
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = base.I32_extend16_s(v104)
	F_errmsg_internal(m, int32(_a_F_tts_minimal_getsomeattrs_2), v19)
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L43
...
L45:
	;
	F_errfinish(m, int32(_a_F_tts_minimal_getsomeattrs_3), int32(70), int32(_a_F_tts_minimal_getsomeattrs_4))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L43
...
L95:
	...
	if v294 == int32(_a_F_tts_minimal_getsomeattrs_1) {
		goto L96
	} else {
		goto L97
	}
...
L113:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = base.I32_extend16_s(v314)
	F_errmsg_internal(m, int32(_a_F_tts_minimal_getsomeattrs_2), v19+int32(32))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L43
...
L160:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v494+v491))) = uint8(v529)
	...
	v535 = int32(_a_F_tts_minimal_getsomeattrs_1)
	v536 = v534 & v535
	if v536 == v535 {
		goto L164
	} else {
...
L176:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v534
	F_errmsg_internal(m, int32(_a_F_tts_minimal_getsomeattrs_2), v19+int32(16))
	mBase = m.M
	v571 = m.ExcPending
	if v571 != 0 {
		goto L43
