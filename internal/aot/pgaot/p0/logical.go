	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = v15
	...
	if v19 != 0 {
		...
		if v23 != 0 {
			...
			v31 = *(*int32)(unsafe.Add(mBase, uint32(v28)+uint32(_c_F_LogicalDecodingProcessRecord[0])))
			if v31 == int32(0) {
				...
				if v35 != 0 {
					...
					v36 = *(*int32)(unsafe.Add(mBase, uint32(v28)+uint32(_c_F_LogicalDecodingProcessRecord[1])))
					if v36 != 0 {
...
L13:
	;
	v41 = *(*int64)(unsafe.Add(mBase, uint32(v34)+uint32(_c_F_LogicalTapeBackspace[0])))
	if v41 == int64(-1) {
		goto L15
	} else {
		goto L16
...
L23:
	...
	F_BufFileReadExact(m, v65, v34, int32(_a_F_LogicalTapeBackspace_3))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L4
...
L24:
	...
	v72 = *(*int64)(unsafe.Add(mBase, uint32(v69)+uint32(_c_F_LogicalTapeBackspace[1])))
...
L25:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l0)+16)) = v41
	v76 = int32(_a_F_LogicalTapeBackspace_4)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+56)) = v76
	v78 = *(*int64)(unsafe.Add(mBase, uint32(v69)+uint32(_c_F_LogicalTapeBackspace[1])))
...
L31:
	...
	v129 = *(*int64)(unsafe.Add(mBase, uint32(v126)+uint32(_c_F_LogicalTapeBackspace[1])))
...
func F_LogicalTapeFreeze(m *base.Module, l0 int32, l1 int32) {
	...
	if v13 == int32(1) {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v16)+uint32(_c_F_LogicalTapeFreeze[0]))) = base.I64_extend_i32_s(int32(0) - v20)
		...
		if v28 != 0 {
			...
			*(*uint16)(unsafe.Add(mBase, uint32(l0)+4)) = uint16(v29)
			...
			if v31 != 0 {
				...
				if v32 == int32(_a_F_LogicalTapeFreeze_0) {
					v43 = v31
					*(*int64)(unsafe.Add(mBase, uint32(l0)+52)) = int64(0)
					v46 = *(*int64)(unsafe.Add(mBase, uint32(l0)+8))
					*(*int64)(unsafe.Add(mBase, uint32(l0)+16)) = v46
					...
					if v55 != 0 {
						...
						if v54 == int32(0) {
							...
							F_BufFileReadExact(m, v58, v43, int32(_a_F_LogicalTapeFreeze_0))
							mBase = m.M
							v61 = m.ExcPending
							if v61 != 0 {
								return
								...
								v66 = *(*int64)(unsafe.Add(mBase, uint32(v63)+uint32(_c_F_LogicalTapeFreeze[0])))
								if v66 < int64(0) {
									v69 = int64(-1)
								} else {
									v69 = v66
								...
								*(*int64)(unsafe.Add(mBase, uint32(l0)+24)) = v69
								v73 = *(*int64)(unsafe.Add(mBase, uint32(v63)+uint32(_c_F_LogicalTapeFreeze[0])))
								if int64(0) <= v73 {
									v78 = int32(_a_F_LogicalTapeFreeze_1)
								} else {
					...
					if v36 != 0 {
						...
						v38 = F_palloc(m, int32(_a_F_LogicalTapeFreeze_0))
						mBase = m.M
						v39 = m.ExcPending
						if v39 != 0 {
							return
