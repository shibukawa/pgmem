...
L13:
	;
	v41 = *(*int64)(unsafe.Add(mBase, uint32(v34)+uint32(_consts[989])))
	if v41 == int64(-1) {
		goto L15
	} else {
		goto L16
...
L20:
	;
	F_errfinish(m, int32(468177), int32(1095), int32(392890))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L4
...
L24:
	...
	v72 = *(*int64)(unsafe.Add(mBase, uint32(v69)+uint32(_consts[988])))
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+56)) = v76
	v78 = *(*int64)(unsafe.Add(mBase, uint32(v69)+uint32(_consts[988])))
...
L28:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11)+32)) = v41
	F_errmsg(m, int32(363325), v11+int32(32))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L4
...
L31:
	...
	v129 = *(*int64)(unsafe.Add(mBase, uint32(v126)+uint32(_consts[988])))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11))) = v41
	F_errmsg_internal(m, int32(404090), v11)
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L4
...
L32:
	;
	F_errfinish(m, int32(468177), int32(1106), int32(392890))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L4
...
func F_LogicalTapeFreeze(m *base.Module, l0 int32, l1 int32) {
	...
	if v13 == int32(1) {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v16)+uint32(_consts[988]))) = base.I64_extend_i32_s(int32(0) - v20)
					...
					if v55 != 0 {
						...
						if v54 == int32(0) {
							...
							if v61 != 0 {
								...
								v66 = *(*int64)(unsafe.Add(mBase, uint32(v63)+uint32(_consts[988])))
								if v66 < int64(0) {
									v69 = int64(-1)
								} else {
									v69 = v66
								...
								*(*int64)(unsafe.Add(mBase, uint32(l0)+24)) = v69
								v73 = *(*int64)(unsafe.Add(mBase, uint32(v63)+uint32(_consts[988])))
								if int64(0) <= v73 {
									v78 = int32(8176)
								} else {
