...
L23:
	;
	F_errfinish(m, int32(493866), int32(1173), int32(153210))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L12
...
L26:
	;
	F_errfinish(m, int32(493866), int32(1184), int32(153210))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L12
...
func F_spg_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = v19
		F_appendStringInfo(m, l0, int32(59169), v10)
		mBase = m.M
		v29 = m.ExcPending
		if v29 != 0 {
			return
			...
			if v30 == int32(1) {
				F_appendStringInfoString(m, l0, int32(676945))
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return
					...
					if v36 != int32(1) {
						...
						F_appendStringInfoString(m, l0, int32(673429))
						mBase = m.M
						v41 = m.ExcPending
						if v41 != 0 {
							return
	...
	case 1:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v42
		F_appendStringInfo(m, l0, int32(59067), v10+int32(16))
		mBase = m.M
		v52 = m.ExcPending
		if v52 != 0 {
			return
			...
			if v53 == int32(1) {
				...
				if v58 != 0 {
					...
					if v59 == int32(1) {
						F_appendStringInfoString(m, l0, int32(677951))
						mBase = m.M
						v64 = m.ExcPending
						if v64 != 0 {
							return
	...
	case 2:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v71
		F_appendStringInfo(m, l0, int32(59216), v10+int32(32))
		mBase = m.M
		v85 = m.ExcPending
		if v85 != 0 {
			return
	...
	case 3:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = v92
		F_appendStringInfo(m, l0, int32(58421), v10-int32(-64))
		mBase = m.M
		v100 = m.ExcPending
		if v100 != 0 {
			return
			...
			if v101 == int32(1) {
				...
				if v106 != 0 {
					...
					if v107 != int32(1) {
						...
						F_appendStringInfoString(m, l0, int32(676772))
						mBase = m.M
						v112 = m.ExcPending
						if v112 != 0 {
							return
	...
	case 4:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+80)) = v113
		F_appendStringInfo(m, l0, int32(59104), v10+int32(80))
		mBase = m.M
		v127 = m.ExcPending
		if v127 != 0 {
			return
			...
			if v128 == int32(1) {
				F_appendStringInfoString(m, l0, int32(672272))
				mBase = m.M
				v133 = m.ExcPending
				if v133 != 0 {
					return
					...
					if v134 == int32(1) {
						...
						if v139 != 0 {
							...
							if v140 != int32(1) {
								...
								F_appendStringInfoString(m, l0, int32(672321))
								mBase = m.M
								v145 = m.ExcPending
								if v145 != 0 {
									return
	...
	case 5:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+112)) = v146
		F_appendStringInfo(m, l0, int32(58084), v10+int32(112))
		mBase = m.M
		v158 = m.ExcPending
		if v158 != 0 {
			return
	...
	case 6:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+128)) = v159
		F_appendStringInfo(m, l0, int32(58494), v10+int32(128))
		mBase = m.M
		v165 = m.ExcPending
		if v165 != 0 {
			return
	...
	case 7:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+156)) = v175
		F_appendStringInfo(m, l0, int32(502250), v10+int32(144))
		mBase = m.M
		v181 = m.ExcPending
		if v181 != 0 {
			return
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v218
	F_errmsg_internal(m, int32(482329), v14)
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L3
...
L52:
	;
	F_errfinish(m, int32(499836), int32(363), int32(92062))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L3
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v88
	F_errmsg_internal(m, int32(480583), v18+int32(16))
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L5
...
L38:
	;
	F_errfinish(m, int32(492555), int32(401), int32(92088))
	mBase = m.M
	v137 = m.ExcPending
	if v137 != 0 {
		goto L5
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v190
	F_errmsg_internal(m, int32(480583), v18)
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L5
...
L107:
	;
	F_errfinish(m, int32(492555), int32(651), int32(92088))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L5
