...
L9:
	;
	v38 = *(*int32)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[0]))
	v40 = *(*int32)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[1]))
	goto L10
L10:
	;
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[1])) = v46
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[0])) = v49
	*(*int32)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[1])) = v48
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v49
	*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = v48
	*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = v47
	*(*int32)(unsafe.Add(mBase, uint32(v12)+28)) = v46
...
L20:
	;
	v83 = *(*int32)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[2]))
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = v47
	*(*int32)(unsafe.Add(mBase, uint32(v12)+28)) = v46
	v92 = *(*int32)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[2]))
	F_s_lock(m, v92+int32(16), int32(_a_F_SyncReplicationSlots_0), int32(1339), int32(_a_F_SyncReplicationSlots_1))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		v151 = v51
...
L23:
	;
	v101 = *(*int32)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[2]))
	v102 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v101)+16)) = v102
	*(*uint8)(unsafe.Add(mBase, uint32(v101)+5)) = uint8(v102)
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v49
	*(*uint8)(unsafe.Add(mBase, _c_F_SyncReplicationSlots[3])) = uint8(v102)
	*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = v48
	*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = v47
	*(*int32)(unsafe.Add(mBase, uint32(v12)+28)) = v46
	F_cancel_before_shmem_exit(m, int32(1022), v47)
