...
func F_SearchSysCache1(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v11 int32
	_ = v11
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[884])))
...
func F_SearchSysCacheCopy(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v22 int32
	_ = v22
	v8 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[884])))
	v9 = int32(0)
...
func F_SearchSysCacheLocked1(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v15 = *(*int32)(unsafe.Add(mBase, uint32(v12)+uint32(_consts[884])))
...
L28:
	;
	v108 = *(*int32)(unsafe.Add(mBase, uint32(v12)+uint32(_consts[884])))
	v22 = v108
	goto L1
}
func F_SysCacheGetAttr(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	if base.Ui32(int32(84)) < base.Ui32(l0) {
		...
		if v41 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
			...
			if v45 != 0 {
				...
				F_errfinish(m, int32(499480), int32(612), int32(206421))
				mBase = m.M
				v50 = m.ExcPending
				if v50 != 0 {
					return int32(0)
		...
		v18 = *(*int32)(unsafe.Add(mBase, uint32(v15)+uint32(_consts[884])))
		if v18 == int32(0) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v41 = m.ExcPending
			...
			if v21 != 0 {
				...
				if v26 != 0 {
					...
					v27 = *(*int32)(unsafe.Add(mBase, uint32(v15)+uint32(_consts[884])))
