...
func F_SearchSysCacheLocked1(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v15 = *(*int32)(unsafe.Add(mBase, uint32(v12)+uint32(_c_F_SearchSysCacheLocked1[0])))
...
L23:
	;
	v83 = *(*int32)(unsafe.Add(mBase, _c_F_SearchSysCacheLocked1[1]))
...
L28:
	;
	v108 = *(*int32)(unsafe.Add(mBase, uint32(v12)+uint32(_c_F_SearchSysCacheLocked1[0])))
	v22 = v108
	goto L1
}
func F_SysCacheGetAttr(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	if base.Ui32(int32(84)) < base.Ui32(l0) {
		...
		v18 = *(*int32)(unsafe.Add(mBase, uint32(v15)+uint32(_c_F_SysCacheGetAttr[0])))
		if v18 == int32(0) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v41 = m.ExcPending
