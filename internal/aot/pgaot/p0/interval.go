									...
									if v90 != 0 {
										...
										if v93 != 0 {
											...
											if v97 != 0 {
												...
												F_errfinish(m, int32(497032), int32(3596), int32(320588))
												mBase = m.M
												v102 = m.ExcPending
												if v102 != 0 {
													return int32(0)
								...
								if v106 != 0 {
									...
									if v109 != 0 {
										...
										if v113 != 0 {
											...
											F_errfinish(m, int32(497032), int32(3605), int32(320588))
											mBase = m.M
											v118 = m.ExcPending
											if v118 != 0 {
												return int32(0)
...
L25:
	;
	v181 = F_pg_sprintf(m, v20, int32(572034), int32(0))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L28
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+160)) = v232
	v237 = F_pg_sprintf(m, v20, int32(548575), v88+int32(160))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L28
...
L86:
	;
	v365 = F_pg_sprintf(m, v20, int32(525463), int32(0))
	mBase = m.M
	v366 = m.ExcPending
	if v366 != 0 {
		goto L28
...
L88:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v88)+272)) = base.I64_extend_i32_s(v97)
	v378 = F_pg_sprintf(m, v370, int32(501464), v88+int32(272))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L28
...
L92:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v88)+256)) = base.I64_extend_i32_s(v96)
	v390 = F_pg_sprintf(m, v382, int32(501464), v88+int32(256))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L28
...
L96:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v88)+240)) = v99
	v401 = F_pg_sprintf(m, v394, int32(501464), v88+int32(240))
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L28
...
L106:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v88)+224)) = v95
	v422 = F_pg_sprintf(m, v413, int32(501464), v88+int32(224))
	mBase = m.M
	v423 = m.ExcPending
	if v423 != 0 {
		goto L28
...
L110:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v88)+208)) = base.I64_extend_i32_s(v94)
	v436 = F_pg_sprintf(m, v426, int32(501464), v88+int32(208))
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L28
...
L154:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v88)+400)) = int32(230928)
	if v97 == int32(1) {
		goto L155
	} else {
		goto L156
...
L157:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v88)+392)) = base.I64_extend_i32_s(v97)
	v592 = F_pg_sprintf(m, v20, int32(176149), v88+int32(384))
	mBase = m.M
	v593 = m.ExcPending
	if v593 != 0 {
		goto L28
...
L162:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v88)+368)) = int32(246581)
	if v96 == int32(1) {
		goto L163
	} else {
		goto L164
...
L174:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+356)) = v625
	v630 = F_pg_sprintf(m, v598, int32(176149), v88+int32(352))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L28
...
L190:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+324)) = v659
	v664 = F_pg_sprintf(m, v636, int32(176149), v88+int32(320))
	mBase = m.M
	v665 = m.ExcPending
	if v665 != 0 {
		goto L28
...
L209:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+292)) = v703
	v708 = F_pg_sprintf(m, v670, int32(548558), v88+int32(288))
	mBase = m.M
	v709 = m.ExcPending
	if v709 != 0 {
		goto L28
...
L251:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v88)+72)) = int32(246581)
...
L255:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v88)+88)) = int32(230928)
...
L259:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+92)) = v851
	v856 = F_pg_sprintf(m, v835, int32(176163), v88+int32(80))
	mBase = m.M
	v857 = m.ExcPending
	if v857 != 0 {
		goto L28
...
L267:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+76)) = v889
	v894 = F_pg_sprintf(m, v877, int32(176163), v88-int32(-64))
	mBase = m.M
	v895 = m.ExcPending
	if v895 != 0 {
		goto L28
...
L277:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+60)) = v931
	v936 = F_pg_sprintf(m, v919, int32(176163), v88+int32(48))
	mBase = m.M
	v937 = m.ExcPending
	if v937 != 0 {
		goto L28
...
L281:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v88)+24)) = int32(276969)
...
L283:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v88)+40)) = int32(206655)
...
L296:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+44)) = v989
	v994 = F_pg_sprintf(m, v947, int32(176163), v88+int32(32))
	mBase = m.M
	v995 = m.ExcPending
	if v995 != 0 {
		goto L28
...
L304:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+28)) = v1020
	v1025 = F_pg_sprintf(m, v1008, int32(176163), v88+int32(16))
	mBase = m.M
	v1026 = m.ExcPending
	if v1026 != 0 {
		goto L28
...
L360:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88))) = v1197
	v1200 = F_pg_sprintf(m, v1186, int32(176279), v88)
	mBase = m.M
	v1201 = m.ExcPending
	if v1201 != 0 {
		goto L28
...
L367:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v88)+96)) = v1228
	v1239 = F_pg_sprintf(m, v1227, int32(467975), v88+int32(96))
	mBase = m.M
	v1240 = m.ExcPending
	if v1240 != 0 {
		goto L28
...
L371:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v88)+112)) = v1233
	v1247 = F_pg_sprintf(m, v1227, int32(548603), v88+int32(112))
	mBase = m.M
	v1248 = m.ExcPending
	if v1248 != 0 {
		goto L28
...
L373:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v88)+144)) = v1232
	v1376 = F_pg_sprintf(m, v1227, int32(548608), v88+int32(144))
	mBase = m.M
	v1377 = m.ExcPending
	if v1377 != 0 {
		goto L28
									...
									if v82 != 0 {
										...
										if v85 != 0 {
											...
											if v89 != 0 {
												...
												F_errfinish(m, int32(497032), int32(3540), int32(301958))
												mBase = m.M
												v94 = m.ExcPending
												if v94 != 0 {
													return int32(0)
								...
								if v98 != 0 {
									...
									if v101 != 0 {
										...
										if v105 != 0 {
											...
											F_errfinish(m, int32(497032), int32(3549), int32(301958))
											mBase = m.M
											v110 = m.ExcPending
											if v110 != 0 {
												return int32(0)
		...
		if v126 != 0 {
			...
			if v129 != 0 {
				...
				if v133 != 0 {
					...
					F_errfinish(m, int32(497032), int32(1578), int32(310175))
					mBase = m.M
					v138 = m.ExcPending
					if v138 != 0 {
						return int32(0)
