...
func F_AddToDataDirLockFile(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+112)) = v3
	v22 = F_open(m, int32(433113), int32(2), v14+int32(112))
	mBase = m.M
	if v22 < v3 {
		goto L2
	} else {
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(433113)
	F_errmsg(m, int32(298472), v14)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L5
...
L9:
	;
	F_errfinish(m, int32(492929), int32(1587), int32(389601))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L5
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(433113)
	F_errmsg(m, int32(298538), v14+int32(16))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L5
...
L19:
	;
	F_errfinish(m, int32(492929), int32(1598), int32(389601))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L5
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+96)) = l1
	v242 = v14 + int32(8320)
	v247 = F_pg_snprintf(m, v231, v242-v231, int32(747854), v14+int32(96))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L5
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v256 + int32(1)
	v261 = v231 + v257
	v266 = F_pg_snprintf(m, v261, v242-v261, int32(206013), v14+int32(80))
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L5
...
L86:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+64)) = int32(433113)
	F_errmsg(m, int32(298155), v14-int32(-64))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L5
...
L87:
	;
	F_errfinish(m, int32(492929), int32(1662), int32(389601))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L5
...
L100:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = int32(433113)
	F_errmsg(m, int32(298155), v14+int32(48))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L5
...
L101:
	;
	F_errfinish(m, int32(492929), int32(1673), int32(389601))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L5
...
L106:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(433113)
	F_errmsg(m, int32(298155), v14+int32(32))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L5
...
L107:
	;
	F_errfinish(m, int32(492929), int32(1681), int32(389601))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L5
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l2
							...
							if v69 != 0 {
								...
								if v72 != 0 {
									...
									F_errfinish(m, int32(499217), int32(1190), int32(283728))
									mBase = m.M
									v77 = m.ExcPending
									if v77 != 0 {
										return int32(0)
					...
					if v36 != 0 {
						...
						if v39 != 0 {
							...
							if v41 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(283974)
								*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l2
								F_errmsg(m, int32(188580), v9+int32(16))
								mBase = m.M
								v50 = m.ExcPending
								if v50 != 0 {
									return int32(0)
									...
									if v53 != 0 {
										...
										F_errfinish(m, int32(499217), int32(1180), int32(283728))
										mBase = m.M
										v58 = m.ExcPending
										if v58 != 0 {
											return int32(0)
		...
		if v27 != 0 {
			...
			if v30 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12))) = v40
				F_errmsg(m, int32(443639), v12)
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(497491), int32(78), int32(319877))
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
