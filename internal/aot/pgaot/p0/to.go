...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v256 + int32(1)
	v317 = v231 + v313
	v322 = F_pg_snprintf(m, v317, v242-v317, int32(_a_F_AddToDataDirLockFile_10), v14+int32(80))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L5
...
L93:
	;
	v386 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_AddToDataDirLockFile[1])) = v386
	v388 = int32(_a_F_AddToDataDirLockFile_2)
	v389 = *(*int32)(unsafe.Add(mBase, _c_F_AddToDataDirLockFile[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v389))) = int32(167772189)
	v395 = F_pwrite(m, v22, v14+int32(128), v384, int64(0))
	mBase = m.M
	v397 = *(*int32)(unsafe.Add(mBase, _c_F_AddToDataDirLockFile[0]))
...
L110:
	;
	v402 = *(*int32)(unsafe.Add(mBase, _c_F_AddToDataDirLockFile[1]))
	if v402 == int32(0) {
		goto L113
	} else {
		goto L114
...
L112:
	;
	v428 = *(*int32)(unsafe.Add(mBase, _c_F_AddToDataDirLockFile[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v428))) = int32(167772188)
	v433 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_AddToDataDirLockFile[2])))
	if v433 != int32(1) {
		v447 = int32(0)
		goto L125
	} else {
...
L123:
	;
	v471 = *(*int32)(unsafe.Add(mBase, _c_F_AddToDataDirLockFile[0]))
	v472 = int32(0)
...
L129:
	;
	v442 = *(*int32)(unsafe.Add(mBase, _c_F_AddToDataDirLockFile[1]))
	if v442 == int32(27) {
		goto L127
	} else {
		goto L130
