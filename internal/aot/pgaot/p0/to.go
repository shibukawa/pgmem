...
func F_AddToDataDirLockFile(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+112)) = v3
	v22 = F_open(m, int32(426258), int32(2), v14+int32(112))
	mBase = m.M
	if v22 < v3 {
		goto L2
	} else {
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(426258)
	F_errmsg(m, int32(293799), v14)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L5
...
L9:
	;
	F_errfinish(m, int32(484761), int32(1587), int32(383311))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L5
...
L18:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(426258)
	F_errmsg(m, int32(293865), v14+int32(16))
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L5
...
L19:
	;
	F_errfinish(m, int32(484761), int32(1598), int32(383311))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L5
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+96)) = l1
	v242 = v14 + int32(8320)
	v247 = F_pg_snprintf(m, v231, v242-v231, int32(722538), v14+int32(96))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L5
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+80)) = v256 + int32(1)
	v317 = v231 + v313
	v322 = F_pg_snprintf(m, v317, v242-v317, int32(203086), v14+int32(80))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L5
...
L120:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+64)) = int32(426258)
	F_errmsg(m, int32(293482), v14-int32(-64))
	mBase = m.M
	v420 = m.ExcPending
	if v420 != 0 {
		goto L5
...
L121:
	;
	F_errfinish(m, int32(484761), int32(1662), int32(383311))
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L5
...
L134:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = int32(426258)
	F_errmsg(m, int32(293482), v14+int32(48))
	mBase = m.M
	v464 = m.ExcPending
	if v464 != 0 {
		goto L5
...
L135:
	;
	F_errfinish(m, int32(484761), int32(1673), int32(383311))
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L5
...
L140:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(426258)
	F_errmsg(m, int32(293482), v14+int32(32))
	mBase = m.M
	v491 = m.ExcPending
	if v491 != 0 {
		goto L5
...
L141:
	;
	F_errfinish(m, int32(484761), int32(1681), int32(383311))
	mBase = m.M
	v496 = m.ExcPending
	if v496 != 0 {
		goto L5
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l2
							...
							if v69 != 0 {
								...
								if v72 != 0 {
									...
									F_errfinish(m, int32(490929), int32(1190), int32(279267))
									mBase = m.M
									v77 = m.ExcPending
									if v77 != 0 {
										return int32(0)
					...
					if v36 != 0 {
						...
						if v39 != 0 {
							...
							if v41 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(279513)
								*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l2
								F_errmsg(m, int32(185801), v9+int32(16))
								mBase = m.M
								v50 = m.ExcPending
								if v50 != 0 {
									return int32(0)
									...
									if v53 != 0 {
										...
										F_errfinish(m, int32(490929), int32(1180), int32(279267))
										mBase = m.M
										v58 = m.ExcPending
										if v58 != 0 {
											return int32(0)
		...
		if v27 != 0 {
			...
			if v30 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12))) = v40
				F_errmsg(m, int32(436746), v12)
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(489253), int32(78), int32(314792))
					mBase = m.M
					v49 = m.ExcPending
					if v49 != 0 {
						return int32(0)
