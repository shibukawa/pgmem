...
func F_show_tcp_keepalives_idle(m *base.Module) int32 {
	mBase := m.M
	_ = mBase
	var v1 int32
	_ = v1
	...
	v4 = v2 - v3
	m.G0 = v4
	v7 = *(*int32)(unsafe.Add(mBase, _consts[357]))
	v10 = m.G0
	v12 = v10 - v3
	m.G0 = v12
	if v7 == v1 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v28
	v36 = F_pg_snprintf(m, int32(4469200), int32(16), int32(511270), v4)
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		return int32(0)
