...
func F_shm_mq_set_sender(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v4 != 0 {
		F_s_lock(m, l0, int32(515588), int32(228), int32(237025))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return
...
L12:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11))) = l1
	F_errmsg_internal(m, int32(249211), v11)
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L11
...
L13:
	;
	F_errfinish(m, int32(520549), int32(254), int32(243004))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L11
			...
			*(*int32)(unsafe.Add(mBase, _consts[163])) = int32(28)
			...
			if int32(2) < v22 {
				if base.Ui32(v22) < base.Ui32(int32(256)) {
					v45 = int32(9)
					v46 = F___memcpy(m, v5, int32(593078), v45)
					mBase = m.M
