...
func F_LocalBufferAlloc(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = v15
	v20 = *(*int32)(unsafe.Add(mBase, _consts[583]))
	if v20 == int32(0) {
		...
		if v26 != 0 {
			...
			if v30 != 0 {
				...
				v32 = *(*int32)(unsafe.Add(mBase, _consts[583]))
				v35 = int32(0)
				...
				if v38 != 0 {
					...
					if v37 != 0 {
						...
						v47 = *(*int32)(unsafe.Add(mBase, _consts[582]))
						...
						*(*int32)(unsafe.Add(mBase, uint32(v53))) = v75 + v76
						...
						F_ResourceOwnerRemember(m, v80, v81+v76, int32(1628384))
						mBase = m.M
						v86 = m.ExcPending
						if v86 != 0 {
							return int32(0)
						...
						if v93 != 0 {
							...
							v97 = *(*int32)(unsafe.Add(mBase, _consts[583]))
								...
								if v105 == int32(1) {
									...
									if v138 != 0 {
										...
										if v142 != 0 {
											...
											F_errfinish(m, int32(498436), int32(159), int32(489227))
											mBase = m.M
											v147 = m.ExcPending
											if v147 != 0 {
												return int32(0)
