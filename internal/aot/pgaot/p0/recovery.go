...
func F_HandleRecoveryConflictInterrupt(m *base.Module, l0 int32) {
	...
	_ = v6
	v6 = int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[665]))) = v6
...
func F_recoveryPausesHere(m *base.Module, l0 int32) {
	...
	var v87 int32
	_ = v87
	v4 = int32(*(*uint8)(unsafe.Add(mBase, _consts[184])))
	if v4 != int32(1) {
		goto L1
	} else {
		goto L2
...
L2:
	;
	v8 = int32(*(*uint8)(unsafe.Add(mBase, _consts[181])))
	if v8 != 0 {
		goto L1
	} else {
		goto L3
...
L19:
	;
	F_errfinish(m, int32(514487), v28, int32(382571))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L4
...
L21:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _consts[183]))
...
L23:
	;
	v40 = *(*int32)(unsafe.Add(mBase, _consts[183]))
	F_s_lock(m, v40+int32(96), int32(514487), int32(3096), int32(370953))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L25:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[183]))
...
L32:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[183]))
...
L33:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _consts[183]))
	F_s_lock(m, v63+int32(96), int32(514487), int32(3135), int32(469384))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L4
...
L35:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _consts[183]))
