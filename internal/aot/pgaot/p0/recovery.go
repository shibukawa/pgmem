...
L19:
	;
	F_errfinish(m, int32(462178), v28, int32(342950))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L4
...
L23:
	...
	F_s_lock(m, v40+int32(96), int32(462178), int32(3096), int32(332341))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L33:
	...
	F_s_lock(m, v63+int32(96), int32(462178), int32(3135), int32(422113))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L4
