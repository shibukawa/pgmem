...
L19:
	;
	F_errfinish(m, int32(483540), v28, int32(358762))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L4
...
L23:
	...
	F_s_lock(m, v40+int32(96), int32(483540), int32(3096), int32(347763))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L4
...
L33:
	...
	F_s_lock(m, v63+int32(96), int32(483540), int32(3135), int32(441336))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L4
