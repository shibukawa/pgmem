...
func F_GUC_flex_fatal(m *base.Module, l0 int32) {
	...
	var v8 int32
	_ = v8
	*(*int32)(unsafe.Add(mBase, _consts[963])) = l0
	v5 = *(*int32)(unsafe.Add(mBase, _consts[964]))
...
func F_GUC_yy_create_buffer(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v13
		if v13 == int32(0) {
			F_GUC_flex_fatal(m, int32(641997))
			mBase = m.M
			v67 = m.ExcPending
			if v67 != 0 {
				return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, _consts[166])) = v20
			return v9
		}
	} else {
		F_GUC_flex_fatal(m, int32(641997))
...
func F_get_guc_variables(m *base.Module, l0 int32) int32 {
	...
	v8 = v6 - int32(32)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[956]))
...
L6:
	;
	v91 = *(*int32)(unsafe.Add(mBase, _consts[956]))
...
L11:
	...
	F_pg_qsort(m, v84, v119, int32(4), int32(1655))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L5
...
func F_guc_malloc(m *base.Module, l0 int32) int32 {
	...
	var v26 int32
	_ = v26
	v3 = *(*int32)(unsafe.Add(mBase, _consts[955]))
	...
	if v5 == int32(0) {
		if l1 == int32(0) {
			*(*int32)(unsafe.Add(mBase, uint32(l0)+32)) = l1
			...
			if v13 != 0 {
				v15 = *(*int32)(unsafe.Add(mBase, _consts[954]))
				v20 = v15
			} else {
				v17 = int32(4440604)
				*(*int32)(unsafe.Add(mBase, _consts[121])) = v17
				v20 = v17
			}
			...
			*(*int32)(unsafe.Add(mBase, _consts[954])) = v11
			*(*int32)(unsafe.Add(mBase, uint32(l0)+32)) = l1
			return
		}
	} else {
