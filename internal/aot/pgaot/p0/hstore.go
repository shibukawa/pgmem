...
L61:
	;
	F_errfinish(m, int32(_a_F_hstore_from_array_1), int32(413), int32(_a_F_hstore_from_array_8))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L12
...
L69:
	;
	F_errfinish(m, int32(_a_F_hstore_from_array_1), int32(433), int32(_a_F_hstore_from_array_10))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L12
