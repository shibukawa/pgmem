	...
	case 2:
		...
		if v34 == int32(0) {
			*(*int32)(unsafe.Add(mBase, uint32(v33))) = int32(1)
			...
			F_appendStringInfoString(m, v49, int32(783061))
			mBase = m.M
			v52 = m.ExcPending
			if v52 != 0 {
				return
			...
			if v19 != int32(10) {
				...
				if l1 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
					F_appendStringInfo(m, v27, int32(785159), v10+int32(16))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
					F_appendStringInfo(m, v27, int32(785353), v10)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
				...
				if v76 != 0 {
					...
					if v82 != 0 {
						...
						if v85 != 0 {
							...
							F_appendStringInfoString(m, v86, int32(783047))
							mBase = m.M
							v89 = m.ExcPending
							if v89 != 0 {
								return
	...
	case 3:
		...
		if v97 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l0
			F_appendStringInfo(m, v112, int32(782690), v10+int32(32))
			mBase = m.M
			v118 = m.ExcPending
			if v118 != 0 {
				return
...
func F_ExplainPropertyFloat(m *base.Module, l0 int32, l1 int32, l2 float64, l3 int32, l4 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l3
	v14 = F_psprintf(m, int32(358230), v9)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
	F_appendStringInfo(m, v27, int32(782690), v9)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L11
...
L19:
	...
	F_appendStringInfoString(m, v53, int32(783295))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L11
...
L31:
	...
	F_appendStringInfoString(m, v101, int32(574290))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L11
...
L35:
	...
	F_appendStringInfoString(m, v116, int32(790840))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L11
...
L46:
	...
	F_appendStringInfoString(m, v155, int32(535302))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L11
...
L53:
	...
	F_appendStringInfoString(m, v180, int32(783295))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L11
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
	F_appendStringInfo(m, v222, int32(782690), v9+int32(16))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L11
...
L71:
	...
	F_appendStringInfoString(m, v254, int32(783061))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L11
...
L1:
	;
	v280 = *(*int32)(unsafe.Add(mBase, _consts[1149]))
	if v280 != 0 {
		goto L60
	} else {
		goto L61
...
L2:
	;
	v17 = *(*int32)(unsafe.Add(mBase, _consts[1150]))
	if v17 < int32(0) {
		goto L1
	} else {
		goto L3
...
L3:
	;
	v21 = *(*int32)(unsafe.Add(mBase, _consts[1146]))
	if v21 != 0 {
		goto L4
	} else {
		goto L5
...
L4:
	;
	v23 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1151])))
	if v23 != int32(1) {
		goto L1
	} else {
		goto L7
...
L6:
	;
	v27 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1152])))
	if v27 != int32(1) {
		goto L1
	} else {
		goto L8
...
L10:
	...
	v43 = *(*int32)(unsafe.Add(mBase, _consts[1150]))
...
L15:
	;
	F_ExplainPropertyText(m, int32(70018), v81, v48)
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L9
...
L17:
	;
	v86 = *(*int32)(unsafe.Add(mBase, _consts[1160]))
...
L25:
	;
	F_ExplainPropertyText(m, int32(142243), v96, v48)
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L9
...
L29:
	;
	v113 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1162])))
	if v113 != int32(1) {
		goto L28
	} else {
		goto L30
...
L48:
	;
	v230 = *(*int32)(unsafe.Add(mBase, _consts[1158]))
	if v230 == int32(2) {
		goto L51
	} else {
		goto L52
...
L53:
	;
	v247 = *(*int32)(unsafe.Add(mBase, _consts[1161]))
...
L57:
	;
	F_errfinish(m, int32(522506), int32(437), int32(451316))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L9
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, _consts[74])) = v48
	v98 = int32(4735060)
	v99 = *(*int32)(unsafe.Add(mBase, _consts[1146]))
	*(*int32)(unsafe.Add(mBase, _consts[1146])) = v99 - int32(1)
	m.G0 = v12 + int32(16)
	return
L3:
	;
	...
	m.G0 = v27
	v29 = int32(4735060)
	v30 = *(*int32)(unsafe.Add(mBase, _consts[1146]))
	v31 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[1146])) = v30 + v31
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, _consts[291])) = v46
	v54 = *(*int32)(unsafe.Add(mBase, _consts[1148]))
	if v54 == int32(0) {
		goto L11
	} else {
		goto L15
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, _consts[291])) = v47
	v63 = int32(4735060)
	v64 = *(*int32)(unsafe.Add(mBase, _consts[1146]))
	*(*int32)(unsafe.Add(mBase, _consts[1146])) = v64 - int32(1)
	F_pg_re_throw(m)
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _consts[291])) = v51
	*(*int32)(unsafe.Add(mBase, _consts[74])) = v52
	v102 = int32(4735060)
	v103 = *(*int32)(unsafe.Add(mBase, _consts[1146]))
	*(*int32)(unsafe.Add(mBase, _consts[1146])) = v103 - int32(1)
	m.G0 = v14 + int32(16)
	return
L3:
	;
	...
	m.G0 = v31
	v33 = int32(4735060)
	v34 = *(*int32)(unsafe.Add(mBase, _consts[1146]))
	v35 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[1146])) = v34 + v35
	v39 = *(*int32)(unsafe.Add(mBase, _consts[291]))
	v41 = *(*int32)(unsafe.Add(mBase, _consts[74]))
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, _consts[291])) = v50
	v58 = *(*int32)(unsafe.Add(mBase, _consts[1147]))
	if v58 == int32(0) {
		goto L11
	} else {
		goto L15
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, _consts[291])) = v51
	v67 = int32(4735060)
	v68 = *(*int32)(unsafe.Add(mBase, _consts[1146]))
	*(*int32)(unsafe.Add(mBase, _consts[1146])) = v68 - int32(1)
	F_pg_re_throw(m)
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
