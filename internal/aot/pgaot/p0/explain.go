	...
	case 2:
		...
		if v34 == int32(0) {
			*(*int32)(unsafe.Add(mBase, uint32(v33))) = int32(1)
			...
			F_appendStringInfoString(m, v49, int32(728653))
			mBase = m.M
			v52 = m.ExcPending
			if v52 != 0 {
				return
			...
			if v19 != int32(10) {
				...
				if l1 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
					F_appendStringInfo(m, v27, int32(730735), v10+int32(16))
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
					F_appendStringInfo(m, v27, int32(730929), v10)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
				...
				if v76 != 0 {
					...
					if v82 != 0 {
						...
						if v85 != 0 {
							...
							F_appendStringInfoString(m, v86, int32(728644))
							mBase = m.M
							v89 = m.ExcPending
							if v89 != 0 {
								return
	...
	case 3:
		...
		if v97 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l0
			F_appendStringInfo(m, v112, int32(728287), v10+int32(32))
			mBase = m.M
			v118 = m.ExcPending
			if v118 != 0 {
				return
...
func F_ExplainPropertyFloat(m *base.Module, l0 int32, l1 int32, l2 float64, l3 int32, l4 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l3
	v14 = F_psprintf(m, int32(339073), v9)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
	F_appendStringInfo(m, v27, int32(728287), v9)
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L11
...
L19:
	...
	F_appendStringInfoString(m, v53, int32(728887))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L11
...
L31:
	...
	F_appendStringInfoString(m, v101, int32(544230))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L11
...
L35:
	...
	F_appendStringInfoString(m, v116, int32(736390))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L11
...
L46:
	...
	F_appendStringInfoString(m, v155, int32(506074))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L11
...
L53:
	...
	F_appendStringInfoString(m, v180, int32(728887))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L11
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
	F_appendStringInfo(m, v222, int32(728287), v9+int32(16))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L11
...
L71:
	...
	F_appendStringInfoString(m, v254, int32(728653))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L11
