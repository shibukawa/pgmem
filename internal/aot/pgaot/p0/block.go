...
L13:
	;
	v32 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[2])))
	v33 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[1])))
	v35 = m.Env.Pgmem_crc32c(m, v32, v15+v33, v29)
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[2]))) = v35
	v37 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[1])))
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[1]))) = v37 + v29
	v75 = v31 + v29
	v76 = v18 - v29
	goto L6
L14:
...
L19:
	;
	v61 = m.T0[v43].(func(*base.Module, int32, int32, int32) int32)(m, v42, v15, int32(_a_F_BlockRefTableRead_0))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L20
...
L21:
	;
	v48 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[2])))
	v49 = m.Env.Pgmem_crc32c(m, v48, v17, v46)
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[2]))) = v49
	v51 = v18 - v46
	v52 = v17 + v46
	if v46 != 0 {
		v75 = v52
...
L22:
	;
	v53 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[3])))
	v54 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[4])))
	v55 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[5])))
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v55
	m.T0[v54].(func(*base.Module, int32, int32, int32))(m, v53, int32(_a_F_BlockRefTableRead_1), v10)
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L20
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[0]))) = v61
	if v61 != 0 {
		v75 = v17
		v76 = v18
		goto L6
...
L25:
	;
	v66 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[3])))
	v67 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[4])))
	v68 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_c_F_BlockRefTableRead[5])))
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v68
	m.T0[v67].(func(*base.Module, int32, int32, int32))(m, v66, int32(_a_F_BlockRefTableRead_1), v10+int32(16))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L20
			...
			if base.Ui32(v41) <= base.Ui32(l3) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v31)+16)) = l3
				...
				if base.Ui32(v46) <= base.Ui32(v45) {
					...
					if v87 != 0 {
						v89 = l3 & int32(_a_F_BlockRefTableSetLimitBlock_0)
						v90 = *(*int32)(unsafe.Add(mBase, uint32(v31)+36))
						v94 = *(*int32)(unsafe.Add(mBase, uint32(v90+v45<<(uint(int32(2))%32))))
						if v87 == int32(_a_F_BlockRefTableSetLimitBlock_1) {
							if l3&int32(1) != 0 {
								v149 = v94 + int32(base.Ui32(v89)>>(uint(int32(3))%32))&int32(_a_F_BlockRefTableSetLimitBlock_2)
							...
							if v89 == int32(_a_F_BlockRefTableSetLimitBlock_0) {
							} else {
								v163 = v159
								for {
									v173 = int32(3)
									...
									*(*uint16)(unsafe.Add(mBase, uint32(v191))) = uint16(v197)
									v200 = v163 + int32(2)
									if v200 != int32(_a_F_BlockRefTableSetLimitBlock_3) {
										v163 = v200
										continue
									} else {
										break
