					...
					if v77 != 0 {
						...
						if v80 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v79
							F_errmsg(m, int32(364293), v11)
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(525321), int32(2311), int32(443672))
								mBase = m.M
								v89 = m.ExcPending
								if v89 != 0 {
									return int32(0)
		...
		case 14:
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v44
				F_errmsg_internal(m, int32(508532), v11+int32(32))
				mBase = m.M
				v50 = m.ExcPending
				if v50 != 0 {
					return int32(0)
				...
				if v17&int32(1073741824) != 0 {
					...
					if v27 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v28
						F_errmsg_internal(m, int32(30679), v11+int32(16))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return int32(0)
				...
				if v14 != int32(61440) {
					if v14 != int32(53248) {
						if v47&int32(65535) == int32(53248) {
							v94 = F_make_result_opt_error(m, int32(1774596), int32(0))
							mBase = m.M
							v95 = m.ExcPending
							if v95 != 0 {
								return int32(0)
							...
							v98 = F_make_result_opt_error(m, int32(1774620), int32(0))
							mBase = m.M
							v99 = m.ExcPending
							if v99 != 0 {
								return int32(0)
	...
	if v40 != 0 {
		...
		if v157 != 0 {
			...
			if v161 != 0 {
				...
				F_errfinish(m, int32(525301), int32(5383), int32(359478))
				mBase = m.M
				v166 = m.ExcPending
				if v166 != 0 {
					return int32(0)
			...
			if base.Ui32(v21) <= base.Ui32(int32(49151)) {
				...
				if base.Ui32(int32(49151)) < base.Ui32(v25) {
					...
					if v53&int32(65535) != int32(49152) {
						if v21 != int32(61440) {
							if v21 != int32(53248) {
								v149 = F_make_result_opt_error(m, int32(1774644), int32(0))
								mBase = m.M
								v150 = m.ExcPending
								if v150 != 0 {
									return int32(0)
								...
								if base.Ui32(int32(49152)) <= base.Ui32(v53&int32(65535)) {
									v75 = F_make_result_opt_error(m, int32(1774572), int32(0))
									mBase = m.M
									v76 = m.ExcPending
									if v76 != 0 {
										return int32(0)
									...
									if base.Ui32(int32(base.Ui32(v77)>>(uint(int32(2))%32))+v85) < base.Ui32(int32(2)) {
										...
										if v274 != 0 {
											...
											if v277 != 0 {
												...
												if v281 != 0 {
													...
													F_errfinish(m, int32(525301), int32(3403), int32(512725))
													mBase = m.M
													v286 = m.ExcPending
													if v286 != 0 {
														return int32(0)
										...
										if v97 != int32(16384) {
											v102 = F_make_result_opt_error(m, int32(1774596), int32(0))
											mBase = m.M
											v103 = m.ExcPending
											if v103 != 0 {
												return int32(0)
											...
											v106 = F_make_result_opt_error(m, int32(1774620), int32(0))
											mBase = m.M
											v107 = m.ExcPending
											if v107 != 0 {
												return int32(0)
							...
							if base.Ui32(int32(49152)) <= base.Ui32(v53&int32(65535)) {
								v114 = F_make_result_opt_error(m, int32(1774572), int32(0))
								mBase = m.M
								v115 = m.ExcPending
								if v115 != 0 {
									return int32(0)
								...
								if base.Ui32(int32(base.Ui32(v116)>>(uint(int32(2))%32))+v124) < base.Ui32(int32(2)) {
									...
									if v290 != 0 {
										...
										if v293 != 0 {
											...
											if v297 != 0 {
												...
												F_errfinish(m, int32(525301), int32(3421), int32(512725))
												mBase = m.M
												v302 = m.ExcPending
												if v302 != 0 {
													return int32(0)
									...
									if v136 != int32(16384) {
										v141 = F_make_result_opt_error(m, int32(1774620), int32(0))
										mBase = m.M
										v142 = m.ExcPending
										if v142 != 0 {
											return int32(0)
										...
										v145 = F_make_result_opt_error(m, int32(1774596), int32(0))
										mBase = m.M
										v146 = m.ExcPending
										if v146 != 0 {
											return int32(0)
...
L6:
	;
	v23 = F_make_result_opt_error(m, int32(1774696), int32(0))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L9
...
L42:
	;
	F_errmsg(m, int32(474190), int32(0))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L9
...
L43:
	;
	F_errfinish(m, int32(525301), int32(3753), int32(515717))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L9
...
L47:
	;
	F_errfinish(m, int32(525301), int32(3763), int32(515717))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L9
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+52)) = l0 + v97
							...
							if v118 != 0 {
								...
								if v121 != 0 {
									...
									if v125 != 0 {
										...
										F_errfinish(m, int32(525301), int32(4558), int32(222898))
										mBase = m.M
										v130 = m.ExcPending
										if v130 != 0 {
											return int32(0)
			...
			if v22 != 0 {
				...
				if v25 != 0 {
					...
					if v14 == int32(49152) {
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(236582)
						...
						if v144 != 0 {
							...
							F_errfinish(m, int32(525301), int32(4536), int32(222898))
							mBase = m.M
							v149 = m.ExcPending
							if v149 != 0 {
								return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(236582)
						...
						if v34 != 0 {
							...
							F_errfinish(m, int32(525301), int32(4540), int32(222898))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int32(0)
				...
				if v127 != 0 {
					...
					if v130 != 0 {
						...
						if v134 != 0 {
							...
							F_errfinish(m, int32(525301), int32(3951), int32(288470))
							mBase = m.M
							v139 = m.ExcPending
							if v139 != 0 {
								return int32(0)
	...
	if v44 != 0 {
		...
		if v163 != 0 {
			...
			if v167 != 0 {
				...
				F_errfinish(m, int32(525301), int32(5743), int32(392163))
				mBase = m.M
				v172 = m.ExcPending
				if v172 != 0 {
					return int32(0)
	...
	if v40 != 0 {
		...
		if v140 != 0 {
			...
			if v144 != 0 {
				...
				F_errfinish(m, int32(525301), int32(5866), int32(359313))
				mBase = m.M
				v149 = m.ExcPending
				if v149 != 0 {
					return int32(0)
