			...
			if l1&int32(1) != 0 {
				...
				if v23 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
					F_errmsg_internal(m, int32(43837), v9)
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(497861), int32(137), int32(462444))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return int32(0)
...
func F_createForeignKeyActionTriggers(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) {
	...
	if v20 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = int32(508588)
		v37 = int32(256)
					...
					*(*int32)(unsafe.Add(mBase, uint32(l7))) = v87
					...
					if v90 != 0 {
						...
						if v93 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v92)+8)) = int32(508588)
							v110 = int32(256)
							...
							default:
								...
								if v132 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v133
									F_errmsg_internal(m, int32(486239), v16+int32(16))
									mBase = m.M
									v139 = m.ExcPending
									if v139 != 0 {
										return
									} else {
										F_errfinish(m, int32(495648), int32(13972), int32(135133))
										mBase = m.M
										v144 = m.ExcPending
										if v144 != 0 {
											return
		...
		default:
			...
			if v59 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16))) = v60
				F_errmsg_internal(m, int32(486239), v16)
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return
				} else {
					F_errfinish(m, int32(495648), int32(13912), int32(135133))
					mBase = m.M
					v69 = m.ExcPending
					if v69 != 0 {
						return
...
func F_has_foreign_data_wrapper_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v22 = F_convert_any_priv_string(m, v14, int32(1661152))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					v20 = F_convert_any_priv_string(m, v11, int32(1661152))
					mBase = m.M
					v21 = m.ExcPending
					if v21 != 0 {
						return int32(0)
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v22 != 0 {
			...
			v24 = F_convert_any_priv_string(m, v14, int32(1661152))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
