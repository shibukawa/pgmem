				...
				if v23 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
					...
					if v27 != 0 {
						...
						F_errfinish(m, int32(496976), int32(137), int32(461580))
						mBase = m.M
						v32 = m.ExcPending
						if v32 != 0 {
							return int32(0)
...
func F_createForeignKeyActionTriggers(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) {
	...
	if v20 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = int32(507671)
		v37 = int32(256)
					...
					*(*int32)(unsafe.Add(mBase, uint32(l7))) = v87
					...
					if v90 != 0 {
						...
						if v93 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v92)+8)) = int32(507671)
							v110 = int32(256)
							...
							default:
								...
								if v132 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v133
									F_errmsg_internal(m, int32(485375), v16+int32(16))
									mBase = m.M
									v139 = m.ExcPending
									if v139 != 0 {
										return
									} else {
										F_errfinish(m, int32(494763), int32(13972), int32(134816))
										mBase = m.M
										v144 = m.ExcPending
										if v144 != 0 {
											return
		...
		default:
			...
			if v59 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16))) = v60
				F_errmsg_internal(m, int32(485375), v16)
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return
				} else {
					F_errfinish(m, int32(494763), int32(13912), int32(134816))
					mBase = m.M
					v69 = m.ExcPending
					if v69 != 0 {
						return
