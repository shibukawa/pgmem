...
func F_createForeignKeyActionTriggers(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) {
	...
	if v20 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v19)+26)) = int32(_a_F_createForeignKeyActionTriggers_0)
		v29 = int32(1)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = int32(_a_F_createForeignKeyActionTriggers_1)
		v37 = int32(256)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(181)
		...
		case 0:
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+44)) = uint8(v70)
			...
			v74 = v72
			v75 = int32(_a_F_createForeignKeyActionTriggers_2)
					...
					*(*int32)(unsafe.Add(mBase, uint32(l7))) = v87
					...
					if v90 != 0 {
						...
						if v93 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v92)+26)) = int32(_a_F_createForeignKeyActionTriggers_3)
							v102 = int32(1)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v92)+8)) = int32(_a_F_createForeignKeyActionTriggers_1)
							v110 = int32(256)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v92))) = int32(181)
							...
							case 0:
								...
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+44)) = uint8(v145)
								...
								v149 = v147
								v150 = int32(_a_F_createForeignKeyActionTriggers_4)
							...
							default:
								...
								if v132 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v133
									F_errmsg_internal(m, int32(_a_F_createForeignKeyActionTriggers_5), v16+int32(16))
									mBase = m.M
									v139 = m.ExcPending
									if v139 != 0 {
										return
									} else {
										F_errfinish(m, int32(_a_F_createForeignKeyActionTriggers_6), int32(_a_F_createForeignKeyActionTriggers_7), int32(_a_F_createForeignKeyActionTriggers_8))
										mBase = m.M
										v144 = m.ExcPending
										if v144 != 0 {
											return
							...
							case 2:
								...
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+44)) = uint8(v120)
								v149 = v80
								v150 = int32(_a_F_createForeignKeyActionTriggers_9)
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+45)) = uint8(v149)
								v152 = F_SystemFuncName(m, v150)
								mBase = m.M
								v153 = m.ExcPending
							...
							case 3:
								...
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+44)) = uint8(v126)
								v149 = v80
								v150 = int32(_a_F_createForeignKeyActionTriggers_10)
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+45)) = uint8(v149)
								v152 = F_SystemFuncName(m, v150)
								mBase = m.M
								v153 = m.ExcPending
							...
							case 13:
								...
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+44)) = uint8(v123)
								v149 = v80
								v150 = int32(_a_F_createForeignKeyActionTriggers_11)
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+45)) = uint8(v149)
								v152 = F_SystemFuncName(m, v150)
								mBase = m.M
								v153 = m.ExcPending
							...
							case 17:
								...
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+44)) = uint8(v117)
								v149 = v80
								v150 = int32(_a_F_createForeignKeyActionTriggers_12)
								*(*uint8)(unsafe.Add(mBase, uint32(v92)+45)) = uint8(v149)
								v152 = F_SystemFuncName(m, v150)
								mBase = m.M
								v153 = m.ExcPending
		...
		default:
			...
			if v59 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16))) = v60
				F_errmsg_internal(m, int32(_a_F_createForeignKeyActionTriggers_5), v16)
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return
				} else {
					F_errfinish(m, int32(_a_F_createForeignKeyActionTriggers_6), int32(_a_F_createForeignKeyActionTriggers_13), int32(_a_F_createForeignKeyActionTriggers_8))
					mBase = m.M
					v69 = m.ExcPending
					if v69 != 0 {
						return
		...
		case 2:
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+44)) = uint8(v47)
			v74 = v10
			v75 = int32(_a_F_createForeignKeyActionTriggers_14)
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+45)) = uint8(v74)
			v77 = F_SystemFuncName(m, v75)
			mBase = m.M
			v78 = m.ExcPending
		...
		case 3:
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+44)) = uint8(v53)
			v74 = v10
			v75 = int32(_a_F_createForeignKeyActionTriggers_15)
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+45)) = uint8(v74)
			v77 = F_SystemFuncName(m, v75)
			mBase = m.M
			v78 = m.ExcPending
		...
		case 13:
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+44)) = uint8(v50)
			v74 = v10
			v75 = int32(_a_F_createForeignKeyActionTriggers_16)
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+45)) = uint8(v74)
			v77 = F_SystemFuncName(m, v75)
			mBase = m.M
			v78 = m.ExcPending
		...
		case 17:
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+44)) = uint8(v44)
			v74 = v10
			v75 = int32(_a_F_createForeignKeyActionTriggers_17)
			*(*uint8)(unsafe.Add(mBase, uint32(v19)+45)) = uint8(v74)
			v77 = F_SystemFuncName(m, v75)
			mBase = m.M
			v78 = m.ExcPending
