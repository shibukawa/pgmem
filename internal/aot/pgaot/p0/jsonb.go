...
func F_JsonbValueAsText(m *base.Module, l0 int32) int32 {
	...
	case 3:
		...
		if v9 != int32(1) {
			v59 = F_cstring_to_text_with_len(m, int32(_a_F_JsonbValueAsText_0), int32(5))
			mBase = m.M
			v60 = m.ExcPending
			if v60 != 0 {
				return int32(0)
...
L1:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v9)+24)) = v76
	v83 = *(*int32)(unsafe.Add(mBase, _c_F_jsonb_in[0]))
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(_a_F_jsonb_int2_0))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(_a_F_jsonb_int8_0))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_jsonb_object_agg_transfn_worker[0])) = v157
	goto L1
L3:
	;
	F_errstart_cold(m, int32(21), int32(0))
...
L25:
	;
	v49 = int32(_a_F_jsonb_object_agg_transfn_worker_0)
	v50 = *(*int32)(unsafe.Add(mBase, _c_F_jsonb_object_agg_transfn_worker[0]))
	v52 = *(*int32)(unsafe.Add(mBase, uint32(v12)+76))
	*(*int32)(unsafe.Add(mBase, _c_F_jsonb_object_agg_transfn_worker[0])) = v52
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_jsonb_object_agg_transfn_worker[0])) = v50
...
L50:
	;
	v156 = int32(_a_F_jsonb_object_agg_transfn_worker_0)
	v157 = *(*int32)(unsafe.Add(mBase, _c_F_jsonb_object_agg_transfn_worker[0]))
	v159 = *(*int32)(unsafe.Add(mBase, uint32(v12)+76))
	*(*int32)(unsafe.Add(mBase, _c_F_jsonb_object_agg_transfn_worker[0])) = v159
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v202
	...
	v210 = F_pg_snprintf(m, v200, v204+int32(1), int32(_a_F_jsonb_object_agg_transfn_worker_4), v12+int32(16))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L28
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v292
	...
	v298 = F_pg_snprintf(m, v290, v294+int32(1), int32(_a_F_jsonb_object_agg_transfn_worker_4), v12)
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
		goto L28
