			...
			if v12&int32(1073741824) == int32(0) {
				...
				if v32 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v33
					F_errmsg_internal(m, int32(30735), v6)
					mBase = m.M
					v37 = m.ExcPending
					if v37 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(526203), int32(3629), int32(390854))
						mBase = m.M
						v42 = m.ExcPending
						if v42 != 0 {
							return int32(0)
...
func F_JsonbValueAsText(m *base.Module, l0 int32) int32 {
	...
	case 3:
		...
		if v9 != int32(1) {
			v59 = F_cstring_to_text_with_len(m, int32(380169), int32(5))
			mBase = m.M
			v60 = m.ExcPending
			if v60 != 0 {
				return int32(0)
			...
			v14 = F_cstring_to_text_with_len(m, int32(362650), int32(4))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return int32(0)
	...
	default:
		...
		if v46 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v47
			F_errmsg_internal(m, int32(509970), v6)
			mBase = m.M
			v51 = m.ExcPending
			if v51 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(519831), int32(1843), int32(69860))
				mBase = m.M
				v56 = m.ExcPending
				if v56 != 0 {
					return int32(0)
...
L80:
	;
	F_errmsg_internal(m, int32(87727), int32(0))
	mBase = m.M
	v496 = m.ExcPending
	if v496 != 0 {
		goto L1
...
L81:
	;
	F_errfinish(m, int32(523276), int32(1624), int32(365997))
	mBase = m.M
	v501 = m.ExcPending
	if v501 != 0 {
		goto L1
...
L86:
	;
	F_errfinish(m, int32(523276), int32(1685), int32(26909))
	mBase = m.M
	v535 = m.ExcPending
	if v535 != 0 {
		goto L1
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = int32(268435455)
	F_errmsg(m, int32(169591), v15+int32(16))
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L1
...
L90:
	;
	F_errfinish(m, int32(523276), int32(1705), int32(26909))
	mBase = m.M
	v554 = m.ExcPending
	if v554 != 0 {
		goto L1
...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = int32(268435455)
	F_errmsg(m, int32(169658), v15+int32(32))
	mBase = m.M
	v568 = m.ExcPending
	if v568 != 0 {
		goto L1
...
L94:
	;
	F_errfinish(m, int32(523276), int32(1766), int32(119224))
	mBase = m.M
	v573 = m.ExcPending
	if v573 != 0 {
		goto L1
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+48)) = int32(268435455)
	F_errmsg(m, int32(169658), v15+int32(48))
	mBase = m.M
	v587 = m.ExcPending
	if v587 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(523276), int32(1801), int32(119224))
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L1
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+64)) = int32(268435455)
	F_errmsg(m, int32(169658), v15-int32(-64))
	mBase = m.M
	v606 = m.ExcPending
	if v606 != 0 {
		goto L1
...
L102:
	;
	F_errfinish(m, int32(523276), int32(1821), int32(119224))
	mBase = m.M
	v611 = m.ExcPending
	if v611 != 0 {
		goto L1
...
L13:
	;
	F_errmsg_internal(m, int32(387494), int32(0))
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L11
...
L14:
	;
	F_errfinish(m, int32(523276), int32(1432), int32(365688))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L11
...
L16:
	;
	F_errmsg_internal(m, int32(341656), int32(0))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L11
...
L17:
	;
	F_errfinish(m, int32(523276), int32(1435), int32(365688))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L11
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = int32(716446)
	F_errhint(m, int32(626084), v13+int32(16))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L5
...
L26:
	;
	F_errfinish(m, int32(526636), int32(1137), int32(231664))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L5
...
L30:
	;
	F_errfinish(m, int32(526636), int32(1153), int32(231664))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L5
...
L36:
	;
	F_errmsg(m, int32(241818), int32(0))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(519831), int32(4819), int32(30584))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L40:
	;
	F_errmsg(m, int32(29384), int32(0))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L41:
	;
	F_errfinish(m, int32(519831), int32(4824), int32(30584))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L1
				...
				if v22&int32(268435456) != 0 {
					...
					if v84 != 0 {
						...
						if v87 != 0 {
							...
							F_errmsg(m, int32(241789), int32(0))
							mBase = m.M
							v91 = m.ExcPending
							if v91 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(519831), int32(5003), int32(338185))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return int32(0)
				...
				if v68 != 0 {
					...
					if v71 != 0 {
						...
						if v75 != 0 {
							...
							F_errfinish(m, int32(519831), int32(4998), int32(338185))
							mBase = m.M
							v80 = m.ExcPending
							if v80 != 0 {
								return int32(0)
...
func F_jsonb_each(m *base.Module, l0 int32) int32 {
	var v7 int32
	_ = v7
	F_each_worker_jsonb(m, l0, int32(343412), int32(0))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
					...
					if v40&int32(16) != 0 {
						...
						if v99 != 0 {
							...
							if v102 != 0 {
								...
								F_errmsg(m, int32(241763), int32(0))
								mBase = m.M
								v106 = m.ExcPending
								if v106 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(519831), int32(5051), int32(88233))
									mBase = m.M
									v111 = m.ExcPending
									if v111 != 0 {
										return int32(0)
					...
					if v83 != 0 {
						...
						if v86 != 0 {
							...
							if v90 != 0 {
								...
								F_errfinish(m, int32(519831), int32(5046), int32(88233))
								mBase = m.M
								v95 = m.ExcPending
								if v95 != 0 {
									return int32(0)
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(95660))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(95845))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
L59:
	;
	F_errmsg_internal(m, int32(22007), int32(0))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L28
...
L60:
	;
	F_errfinish(m, int32(526636), int32(1791), int32(231774))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L28
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v202
	...
	v210 = F_pg_snprintf(m, v200, v204+int32(1), int32(217224), v12+int32(16))
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L28
...
L69:
	;
	F_errfinish(m, int32(526636), int32(1824), int32(231774))
	mBase = m.M
	v241 = m.ExcPending
	if v241 != 0 {
		goto L28
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v292
	...
	v298 = F_pg_snprintf(m, v290, v294+int32(1), int32(217224), v12)
	mBase = m.M
	v299 = m.ExcPending
	if v299 != 0 {
		goto L28
...
L97:
	;
	F_errfinish(m, int32(526636), int32(1883), int32(231774))
	mBase = m.M
	v331 = m.ExcPending
	if v331 != 0 {
		goto L28
...
L99:
	;
	F_errmsg_internal(m, int32(67325), int32(0))
	mBase = m.M
	v339 = m.ExcPending
	if v339 != 0 {
		goto L28
...
L100:
	;
	F_errfinish(m, int32(526636), int32(1693), int32(231774))
	mBase = m.M
	v344 = m.ExcPending
	if v344 != 0 {
		goto L28
...
L104:
	;
	F_errfinish(m, int32(526636), int32(1718), int32(231774))
	mBase = m.M
	v360 = m.ExcPending
	if v360 != 0 {
		goto L28
...
L108:
	;
	F_errfinish(m, int32(526636), int32(1728), int32(231774))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L28
...
L111:
	;
	F_errmsg(m, int32(318494), int32(0))
	mBase = m.M
	v387 = m.ExcPending
	if v387 != 0 {
		goto L28
...
L112:
	;
	F_errfinish(m, int32(526636), int32(1744), int32(231774))
	mBase = m.M
	v392 = m.ExcPending
	if v392 != 0 {
		goto L28
...
L115:
	;
	F_errmsg(m, int32(166336), int32(0))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L28
...
L116:
	;
	F_errfinish(m, int32(526636), int32(1806), int32(231774))
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L28
...
L38:
	;
	F_errfinish(m, int32(526636), int32(1401), int32(344504))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L1
...
L42:
	;
	F_errfinish(m, int32(526636), int32(1412), int32(344504))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L1
...
L46:
	;
	F_errfinish(m, int32(526636), int32(1423), int32(344504))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L1
...
L30:
	;
	F_errmsg(m, int32(469448), int32(0))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(526203), int32(489), int32(327817))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
...
L26:
	;
	F_errmsg(m, int32(318124), int32(0))
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
		goto L21
...
L27:
	;
	F_errfinish(m, int32(520219), int32(204), int32(126336))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L21
...
func F_jsonb_to_record(m *base.Module, l0 int32) int32 {
	...
	_ = v9
	v3 = int32(0)
	v6 = F_populate_record_worker(m, l0, int32(441847), v3, v3, v3)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
