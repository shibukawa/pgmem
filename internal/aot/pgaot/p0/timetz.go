					...
					if v29 != 0 {
						...
						if v32 != 0 {
							...
							if v36 != 0 {
								...
								F_errfinish(m, int32(524503), int32(2697), int32(324826))
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return int32(0)
					...
					if base.Ui32(v20-int32(57600)) <= base.Ui32(int32(-115200)) {
						...
						if v73 != 0 {
							...
							if v76 != 0 {
								...
								F_errmsg(m, int32(422097), int32(0))
								mBase = m.M
								v80 = m.ExcPending
								if v80 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(524503), int32(2425), int32(37649))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
				...
				if v57 != 0 {
					...
					if v60 != 0 {
						...
						if v64 != 0 {
							...
							F_errfinish(m, int32(524503), int32(2417), int32(37649))
							mBase = m.M
							v69 = m.ExcPending
							if v69 != 0 {
								return int32(0)
