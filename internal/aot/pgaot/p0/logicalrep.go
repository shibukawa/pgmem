...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v93
	F_appendStringInfo(m, v8+int32(16), int32(762673), v8)
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L1
...
func F_logicalrep_launcher_attach_dshmem(m *base.Module) {
	...
	var v89 int32
	_ = v89
	v4 = *(*int32)(unsafe.Add(mBase, _consts[511]))
	v5 = *(*int32)(unsafe.Add(mBase, uint32(v4)+8))
	if v5 != 0 {
		v7 = *(*int32)(unsafe.Add(mBase, _consts[512]))
		if v7 != 0 {
			return
		} else {
				...
				*(*int32)(unsafe.Add(mBase, _consts[0])) = v19
				...
				if v23 == int32(0) {
					...
					if v31 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _consts[513])) = v30
						F_dsa_pin(m, v30)
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							...
							v36 = *(*int32)(unsafe.Add(mBase, _consts[513]))
							...
							if v38 != 0 {
								...
								v41 = *(*int32)(unsafe.Add(mBase, _consts[513]))
								v44 = F_dshash_create(m, v41, int32(1655496), int32(0))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
								} else {
									*(*int32)(unsafe.Add(mBase, _consts[512])) = v44
									v48 = *(*int32)(unsafe.Add(mBase, _consts[513]))
									...
									*(*int32)(unsafe.Add(mBase, uint32(v52)+4)) = v50
									v55 = *(*int32)(unsafe.Add(mBase, _consts[512]))
									v56 = *(*int32)(unsafe.Add(mBase, uint32(v55)+32))
									v57 = *(*int32)(unsafe.Add(mBase, uint32(v56)))
									v59 = *(*int32)(unsafe.Add(mBase, _consts[511]))
					...
					if v62 != 0 {
						*(*int32)(unsafe.Add(mBase, _consts[0])) = v16
						...
						if v66 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[513])) = v65
							...
							if v69 != 0 {
								...
								v72 = *(*int32)(unsafe.Add(mBase, _consts[513]))
								v75 = *(*int32)(unsafe.Add(mBase, _consts[511]))
								v76 = *(*int32)(unsafe.Add(mBase, uint32(v75)+8))
								v78 = F_dshash_attach(m, v72, int32(1655496), v76, int32(0))
								mBase = m.M
								v79 = m.ExcPending
								if v79 != 0 {
									return
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v44
	F_errmsg_internal(m, int32(721286), v12)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L15:
	;
	F_errfinish(m, int32(520568), int32(912), int32(402403))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
func F_logicalrep_relmap_invalidate_cb(m *base.Module, l0 int32, l1 int32) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[523]))
	if v9 == int32(0) {
		goto L1
	} else {
		goto L2
...
func F_logicalrep_relmap_update(m *base.Module, l0 int32) {
	...
	v10 = v8 - int32(48)
	m.G0 = v10
	v13 = *(*int32)(unsafe.Add(mBase, _consts[523]))
	if v13 != 0 {
		goto L1
	} else {
		goto L2
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[524]))
	if v15 == int32(0) {
		goto L4
	} else {
		goto L5
...
L4:
	...
	v25 = F_AllocSetContextCreateInternal(m, v20, int32(67999), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L7
...
L6:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = int64(309237645316)
	v36 = F_hash_create(m, int32(418455), int32(128), v10, int32(1064))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L7
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _consts[524])) = v25
	v28 = v25
	goto L6
L9:
	;
	*(*int32)(unsafe.Add(mBase, _consts[523])) = v36
...
L10:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[523]))
	v45 = v43
	goto L3
L11:
	;
...
L16:
	...
	v62 = *(*int32)(unsafe.Add(mBase, _consts[524]))
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[510]))
	if v15 <= int32(0) {
		goto L3
	} else {
		goto L4
...
L4:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[511]))
	v25 = int32(0)
	goto L5
L5:
	;
...
L6:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[77]))
...
L19:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _consts[77]))
...
L22:
	;
	v74 = *(*int32)(unsafe.Add(mBase, _consts[77]))
...
L35:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _consts[77]))
...
L38:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _consts[77]))
