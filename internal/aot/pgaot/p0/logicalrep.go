...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v93
	F_appendStringInfo(m, v8+int32(16), int32(706449), v8)
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L1
						...
						*(*int32)(unsafe.Add(mBase, _consts[516])) = v30
						...
						if v34 != 0 {
							...
							if v38 != 0 {
								...
								v44 = F_dshash_create(m, v41, int32(1599192), int32(0))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
						...
						if v66 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[516])) = v65
							...
							if v69 != 0 {
								...
								v78 = F_dshash_attach(m, v72, int32(1599192), v76, int32(0))
								mBase = m.M
								v79 = m.ExcPending
								if v79 != 0 {
									return
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v44
	F_errmsg_internal(m, int32(668085), v12)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L15:
	;
	F_errfinish(m, int32(490650), int32(912), int32(379592))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
L4:
	...
	v25 = F_AllocSetContextCreateInternal(m, v20, int32(61764), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L7
...
L6:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = int64(309237645316)
	v36 = F_hash_create(m, int32(395055), int32(128), v10, int32(1064))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L7
