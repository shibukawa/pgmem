...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v93
	F_appendStringInfo(m, v8+int32(16), int32(761036), v8)
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L1
...
func F_logicalrep_launcher_attach_dshmem(m *base.Module) {
	...
	if v5 != 0 {
		v7 = *(*int32)(unsafe.Add(mBase, _consts[513]))
		if v7 != 0 {
			return
		} else {
			...
			if v14 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[0])) = v19
				...
				if v23 == int32(0) {
					...
					if v31 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, _consts[514])) = v30
						...
						if v34 != 0 {
							...
							v36 = *(*int32)(unsafe.Add(mBase, _consts[514]))
							...
							if v38 != 0 {
								...
								v44 = F_dshash_create(m, v41, int32(1653832), int32(0))
								mBase = m.M
								v45 = m.ExcPending
								if v45 != 0 {
									return
								} else {
									*(*int32)(unsafe.Add(mBase, _consts[513])) = v44
									v48 = *(*int32)(unsafe.Add(mBase, _consts[514]))
									v49 = *(*int32)(unsafe.Add(mBase, uint32(v48)))
									v50 = *(*int32)(unsafe.Add(mBase, uint32(v49)+28))
									v52 = *(*int32)(unsafe.Add(mBase, _consts[512]))
									*(*int32)(unsafe.Add(mBase, uint32(v52)+4)) = v50
									v55 = *(*int32)(unsafe.Add(mBase, _consts[513]))
									v56 = *(*int32)(unsafe.Add(mBase, uint32(v55)+32))
									v57 = *(*int32)(unsafe.Add(mBase, uint32(v56)))
									v59 = *(*int32)(unsafe.Add(mBase, _consts[512]))
					...
					v62 = *(*int32)(unsafe.Add(mBase, _consts[513]))
					if v62 != 0 {
						*(*int32)(unsafe.Add(mBase, _consts[0])) = v16
						v85 = *(*int32)(unsafe.Add(mBase, _consts[29]))
						F_LWLockRelease(m, v85+int32(5504))
						...
						if v66 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[514])) = v65
							...
							if v69 != 0 {
								...
								v78 = F_dshash_attach(m, v72, int32(1653832), v76, int32(0))
								mBase = m.M
								v79 = m.ExcPending
								if v79 != 0 {
									return
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v44
	F_errmsg_internal(m, int32(719691), v12)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L15:
	;
	F_errfinish(m, int32(519186), int32(912), int32(401514))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
...
func F_logicalrep_relmap_invalidate_cb(m *base.Module, l0 int32, l1 int32) {
	...
	v6 = v4 - int32(32)
	m.G0 = v6
	v9 = *(*int32)(unsafe.Add(mBase, _consts[524]))
	if v9 == int32(0) {
		goto L1
	} else {
		goto L2
...
func F_logicalrep_relmap_update(m *base.Module, l0 int32) {
	...
	v10 = v8 - int32(48)
	m.G0 = v10
	v13 = *(*int32)(unsafe.Add(mBase, _consts[524]))
	if v13 != 0 {
		goto L1
	} else {
		goto L2
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[525]))
	if v15 == int32(0) {
		goto L4
	} else {
		goto L5
...
L4:
	...
	v25 = F_AllocSetContextCreateInternal(m, v20, int32(67923), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L7
...
L6:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = int64(309237645316)
	v36 = F_hash_create(m, int32(417566), int32(128), v10, int32(1064))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L7
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _consts[525])) = v25
	v28 = v25
	goto L6
L9:
	;
	*(*int32)(unsafe.Add(mBase, _consts[524])) = v36
...
L10:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[524]))
	v45 = v43
	goto L3
L11:
	;
