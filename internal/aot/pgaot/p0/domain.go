...
func F_DomainHasConstraints(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v3 = F_lookup_type_cache(m, l0, int32(_a_F_DomainHasConstraints_0))
	mBase = m.M
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
...
func F_domainAddNotNullConstraint(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if v12 != 0 {
		...
		if v15 != 0 {
			...
			if v14 == int32(0) {
				...
				if v22 != 0 {
					...
					F_errcode(m, int32(_a_F_domainAddNotNullConstraint_0))
					mBase = m.M
					v25 = m.ExcPending
					if v25 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = v26
						F_errmsg(m, int32(_a_F_domainAddNotNullConstraint_1), v10)
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return
		...
		v37 = int32(0)
		v40 = F_ChooseConstraintName(m, l3, v37, int32(_a_F_domainAddNotNullConstraint_4), l1, v37)
		mBase = m.M
		v41 = m.ExcPending
		if v41 != 0 {
			return
...
func F_domain_state_setup(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v17 != 0 {
		...
		v19 = F_lookup_type_cache(m, l0, int32(_a_F_domain_state_setup_0))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int32(0)
					...
					if v59 != 0 {
						...
						if v61 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v60
							F_errmsg(m, int32(_a_F_domain_state_setup_1), v11)
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(_a_F_domain_state_setup_2), int32(96), int32(_a_F_domain_state_setup_3))
								mBase = m.M
								v70 = m.ExcPending
								if v70 != 0 {
									return int32(0)
