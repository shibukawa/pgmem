...
func F_domainAddNotNullConstraint(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if v12 != 0 {
				...
				if v22 != 0 {
					...
					if v25 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = v26
						F_errmsg(m, int32(124614), v10)
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return
						} else {
							F_errfinish(m, int32(518734), int32(3684), int32(97034))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return
		...
		v37 = int32(0)
		v40 = F_ChooseConstraintName(m, l3, v37, int32(316639), l1, v37)
		mBase = m.M
		v41 = m.ExcPending
		if v41 != 0 {
			return
					...
					if v59 != 0 {
						...
						if v61 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v60
							F_errmsg(m, int32(291208), v11)
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(517684), int32(96), int32(244251))
								mBase = m.M
								v70 = m.ExcPending
								if v70 != 0 {
									return int32(0)
