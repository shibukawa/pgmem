				...
				if v37 != 0 {
					...
					if v40 != 0 {
						...
						if v44 != 0 {
							...
							F_errfinish(m, int32(471540), int32(167), int32(406202))
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return int32(0)
			...
			if v53 != 0 {
				...
				if v56 != 0 {
					...
					if v60 != 0 {
						...
						F_errfinish(m, int32(471540), int32(174), int32(406202))
						mBase = m.M
						v65 = m.ExcPending
						if v65 != 0 {
							return int32(0)
...
L76:
	;
	F_errfinish(m, int32(471433), int32(4408), int32(347591))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L16
...
L81:
	;
	F_errfinish(m, int32(471433), int32(4426), int32(347591))
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L16
	...
	if v7 != 0 {
		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				F_errmsg(m, int32(287485), int32(0))
				mBase = m.M
				v43 = m.ExcPending
				if v43 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(471433), int32(6010), int32(162256))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
					...
					if v27 != 0 {
						...
						if v26 == int32(0) {
							...
							if v52 != 0 {
								...
								F_errmsg_internal(m, int32(62057), int32(0))
								mBase = m.M
								v56 = m.ExcPending
								if v56 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(471433), int32(6028), int32(162256))
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return int32(0)
...
L128:
	;
	F_errfinish(m, int32(471433), int32(1301), int32(33883))
	mBase = m.M
	v585 = m.ExcPending
	if v585 != 0 {
		goto L8
...
L132:
	;
	F_errfinish(m, int32(471433), int32(1306), int32(33883))
	mBase = m.M
	v605 = m.ExcPending
	if v605 != 0 {
		goto L8
...
L135:
	;
	F_errmsg(m, int32(147092), int32(0))
	mBase = m.M
	v616 = m.ExcPending
	if v616 != 0 {
		goto L8
...
L136:
	;
	F_errfinish(m, int32(471433), int32(1312), int32(33883))
	mBase = m.M
	v621 = m.ExcPending
	if v621 != 0 {
		goto L8
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+80)) = v41
	F_errmsg(m, int32(633259), v21+int32(80))
	mBase = m.M
	v645 = m.ExcPending
	if v645 != 0 {
		goto L8
...
L142:
	;
	F_errfinish(m, int32(471433), int32(1340), int32(33883))
	mBase = m.M
	v650 = m.ExcPending
	if v650 != 0 {
		goto L8
...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+32)) = v658
	F_errmsg(m, int32(179630), v21+int32(32))
	mBase = m.M
	v665 = m.ExcPending
	if v665 != 0 {
		goto L8
...
L147:
	;
	F_errfinish(m, int32(471433), int32(1379), int32(33883))
	mBase = m.M
	v670 = m.ExcPending
	if v670 != 0 {
		goto L8
...
L151:
	;
	F_errfinish(m, int32(471433), int32(1481), int32(16512))
	mBase = m.M
	v687 = m.ExcPending
	if v687 != 0 {
		goto L8
...
L154:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+64)) = v188 + int32(1)
	F_errmsg(m, int32(446402), v21-int32(-64))
	mBase = m.M
	v702 = m.ExcPending
	if v702 != 0 {
		goto L8
...
L155:
	;
	F_errfinish(m, int32(471433), int32(1510), int32(16512))
	mBase = m.M
	v707 = m.ExcPending
	if v707 != 0 {
		goto L8
...
L158:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+48)) = int32(1073741823)
	F_errmsg(m, int32(638030), v21+int32(48))
	mBase = m.M
	v721 = m.ExcPending
	if v721 != 0 {
		goto L8
...
L159:
	;
	F_errfinish(m, int32(471433), int32(1534), int32(16512))
	mBase = m.M
	v726 = m.ExcPending
	if v726 != 0 {
		goto L8
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v212
	F_errmsg(m, int32(183166), v14+int32(16))
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L9
...
L55:
	;
	F_errfinish(m, int32(471540), int32(1951), int32(295239))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L9
...
L60:
	;
	F_errfinish(m, int32(471540), int32(1964), int32(295239))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L9
...
L16:
	;
	F_errmsg(m, int32(146314), int32(0))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L1
...
L17:
	;
	F_errfinish(m, int32(472629), int32(776), int32(197731))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L1
...
L108:
	;
	F_errmsg(m, int32(142855), int32(0))
	mBase = m.M
	v464 = m.ExcPending
	if v464 != 0 {
		goto L1
...
L109:
	;
	F_errfinish(m, int32(472629), int32(771), int32(197731))
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L1
...
L27:
	;
	F_errmsg(m, int32(57755), int32(0))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L1
...
L28:
	;
	F_errfinish(m, int32(471433), int32(3669), int32(22520))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
	...
	case 1, 2, 4, 6:
		...
		if v38 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
			F_errmsg_internal(m, int32(642128), v12)
			mBase = m.M
			v42 = m.ExcPending
			if v42 != 0 {
				return
			} else {
				F_errfinish(m, int32(471433), int32(3756), int32(261575))
				mBase = m.M
				v47 = m.ExcPending
				if v47 != 0 {
					return
...
func F_expand_array(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v10 = v8 - int32(48)
	m.G0 = v10
	v16 = F_AllocSetContextCreateInternal(m, l1, int32(24195), int32(0), int32(1024), int32(8388608))
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		return int32(0)
...
func F_makeArrayTypeName(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v8 = v6 - int32(80)
	m.G0 = v8
	v13 = F_makeObjectName(m, int32(715212), l0, v3)
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		goto L1
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v29
	v35 = F_pg_snprintf(m, v8+int32(16), int32(64), int32(465664), v8)
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L1
...
L10:
	;
	v41 = F_makeObjectName(m, int32(715212), l0, v8+int32(16))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
