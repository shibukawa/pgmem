...
func F_array_agg_array_serialize(m *base.Module, l0 int32) int32 {
	...
	if v13 != 0 {
		...
		if v17 != 0 {
			...
			v21 = int32(24)
			v23 = int32(_a_F_array_agg_array_serialize_0)
			v25 = int32(8)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v18 + v37
			...
			if v43 != 0 {
				...
				v47 = int32(24)
				v49 = int32(_a_F_array_agg_array_serialize_0)
				v51 = int32(8)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v44 + v63
				...
				if v69 != 0 {
					...
					v73 = int32(24)
					v75 = int32(_a_F_array_agg_array_serialize_0)
					v77 = int32(8)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v70 + int32(4)
					...
					if v95 != 0 {
						...
						if v99 != 0 {
							...
							v103 = int32(24)
							v105 = int32(_a_F_array_agg_array_serialize_0)
							v107 = int32(8)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v100 + v119
							...
							if v125 != 0 {
								...
								v129 = int32(24)
								v131 = int32(_a_F_array_agg_array_serialize_0)
								v133 = int32(8)
								...
								if v148 != 0 {
									...
									if v155 != 0 {
										...
										if v159 != 0 {
											...
											v163 = int32(24)
											v165 = int32(_a_F_array_agg_array_serialize_0)
											v167 = int32(8)
											...
											*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v160 + v179
											...
											if v185 != 0 {
												...
												v189 = int32(24)
												v191 = int32(_a_F_array_agg_array_serialize_0)
												v193 = int32(8)
...
L75:
	;
	F_errmsg(m, int32(_a_F_array_contain_compare_0), int32(0))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L16
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v309
	F_errmsg(m, int32(_a_F_array_contain_compare_4), v16)
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L16
...
L18:
	;
	if base.Ui32(int32(_a_F_array_recv_0)) < base.Ui32(v41) {
		goto L16
	} else {
		goto L19
	}
L19:
	;
	if base.Ui32(v24) <= base.Ui32(int32(_a_F_array_recv_0)) {
		goto L5
	} else {
		goto L20
	}
...
func F_expand_array(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v10 = v8 - int32(48)
	m.G0 = v10
	v16 = F_AllocSetContextCreateInternal(m, l1, int32(_a_F_expand_array_0), int32(0), int32(1024), int32(_a_F_expand_array_1))
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		return int32(0)
		...
		if v22 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v21)+4)) = int32(_a_F_expand_array_2)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v21)+24)) = int32(689375833)
			...
			if v36 != int32(1) {
				v114 = l2
				v116 = int32(_a_F_expand_array_3)
				v117 = *(*int32)(unsafe.Add(mBase, _c_F_expand_array[0]))
				*(*int32)(unsafe.Add(mBase, _c_F_expand_array[0])) = v16
				...
				if v121 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _c_F_expand_array[0])) = v117
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v29
	v35 = F_pg_snprintf(m, v8+int32(16), int32(64), int32(_a_F_makeArrayTypeName_1), v8)
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L1
...
L10:
	;
	v41 = F_makeObjectName(m, int32(_a_F_makeArrayTypeName_0), l0, v8+int32(16))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
