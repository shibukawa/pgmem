				...
				if v37 != 0 {
					...
					if v40 != 0 {
						...
						if v44 != 0 {
							...
							F_errfinish(m, int32(517485), int32(167), int32(446465))
							mBase = m.M
							v49 = m.ExcPending
							if v49 != 0 {
								return int32(0)
			...
			if v53 != 0 {
				...
				if v56 != 0 {
					...
					if v60 != 0 {
						...
						F_errfinish(m, int32(517485), int32(174), int32(446465))
						mBase = m.M
						v65 = m.ExcPending
						if v65 != 0 {
							return int32(0)
...
L76:
	;
	F_errfinish(m, int32(517366), int32(4408), int32(382624))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L16
...
L81:
	;
	F_errfinish(m, int32(517366), int32(4426), int32(382624))
	mBase = m.M
	v319 = m.ExcPending
	if v319 != 0 {
		goto L16
	...
	if v7 != 0 {
		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				F_errmsg(m, int32(316184), int32(0))
				mBase = m.M
				v43 = m.ExcPending
				if v43 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(517366), int32(6010), int32(182348))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
						...
						if v26 == int32(0) {
							...
							if v52 != 0 {
								...
								if v56 != 0 {
									...
									F_errfinish(m, int32(517366), int32(6028), int32(182348))
									mBase = m.M
									v61 = m.ExcPending
									if v61 != 0 {
										return int32(0)
...
L29:
	;
	F_errfinish(m, int32(518868), int32(46), int32(219752))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(518868), int32(50), int32(219752))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L1
...
L111:
	;
	F_errfinish(m, int32(517366), int32(1301), int32(37642))
	mBase = m.M
	v529 = m.ExcPending
	if v529 != 0 {
		goto L8
...
L115:
	;
	F_errfinish(m, int32(517366), int32(1306), int32(37642))
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L8
...
L119:
	;
	F_errfinish(m, int32(517366), int32(1312), int32(37642))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L8
...
L124:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+80)) = v41
	F_errmsg(m, int32(704563), v21+int32(80))
	mBase = m.M
	v589 = m.ExcPending
	if v589 != 0 {
		goto L8
...
L125:
	;
	F_errfinish(m, int32(517366), int32(1340), int32(37642))
	mBase = m.M
	v594 = m.ExcPending
	if v594 != 0 {
		goto L8
...
L130:
	;
	F_errfinish(m, int32(517366), int32(1379), int32(37642))
	mBase = m.M
	v614 = m.ExcPending
	if v614 != 0 {
		goto L8
...
L134:
	;
	F_errfinish(m, int32(517366), int32(1481), int32(17990))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L8
...
L137:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+64)) = v188 + int32(1)
	F_errmsg(m, int32(489060), v21-int32(-64))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L8
...
L138:
	;
	F_errfinish(m, int32(517366), int32(1510), int32(17990))
	mBase = m.M
	v651 = m.ExcPending
	if v651 != 0 {
		goto L8
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+48)) = int32(1073741823)
	F_errmsg(m, int32(709367), v21+int32(48))
	mBase = m.M
	v665 = m.ExcPending
	if v665 != 0 {
		goto L8
...
L142:
	;
	F_errfinish(m, int32(517366), int32(1534), int32(17990))
	mBase = m.M
	v670 = m.ExcPending
	if v670 != 0 {
		goto L8
...
L55:
	;
	F_errfinish(m, int32(517485), int32(1951), int32(325024))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L9
...
L60:
	;
	F_errfinish(m, int32(517485), int32(1964), int32(325024))
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L9
...
L17:
	;
	F_errfinish(m, int32(518832), int32(776), int32(218536))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L1
...
L109:
	;
	F_errfinish(m, int32(518832), int32(771), int32(218536))
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L1
...
L28:
	;
	F_errfinish(m, int32(517366), int32(3669), int32(24654))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
	...
	case 1, 2, 4, 6:
		...
		if v38 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
			F_errmsg_internal(m, int32(713908), v12)
			mBase = m.M
			v42 = m.ExcPending
			if v42 != 0 {
				return
			} else {
				F_errfinish(m, int32(517366), int32(3756), int32(287910))
				mBase = m.M
				v47 = m.ExcPending
				if v47 != 0 {
					return
...
func F_makeArrayTypeName(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v8 = v6 - int32(80)
	m.G0 = v8
	v13 = F_makeObjectName(m, int32(790160), l0, v3)
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		goto L1
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v29
	v35 = F_pg_snprintf(m, v8+int32(16), int32(64), int32(509851), v8)
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L1
...
L10:
	;
	v41 = F_makeObjectName(m, int32(790160), l0, v8+int32(16))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
