	...
	if v2 != 0 {
		...
		if v4 <= int32(0) {
			...
			if v26 != 0 {
				...
				if v29 != 0 {
					...
					F_errmsg(m, int32(729483), int32(0))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return
					} else {
						F_errfinish(m, int32(492778), int32(1539), int32(122827))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return
		...
		if v10 != 0 {
			...
			if v13 != 0 {
				...
				F_errmsg(m, int32(570179), int32(0))
				mBase = m.M
				v17 = m.ExcPending
				if v17 != 0 {
					return
				} else {
					F_errfinish(m, int32(492778), int32(1534), int32(122827))
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return
