...
L10:
	;
	v112 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_consts[497]))))
	v119 = v112
	goto L9
L11:
	;
...
L14:
	;
	v88 = int32(1)
	v93 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(v88)%32))+uint32(_consts[498]))))
	if v93&v88 != 0 {
		v130 = v88
		goto L8
	} else {
...
L15:
	...
	v44 = *(*int32)(unsafe.Add(mBase, uint32(v41)+uint32(_consts[499])))
...
L20:
	;
	v50 = *(*int32)(unsafe.Add(mBase, uint32(v41)+uint32(_consts[500])))
...
L26:
	;
	v87 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v70)+uint32(_consts[501]))))
	v119 = v87
	goto L9
L27:
	;
	...
	v70 = v68 * int32(12)
	v73 = *(*int32)(unsafe.Add(mBase, uint32(v70)+uint32(_consts[502])))
...
L32:
	;
	v79 = *(*int32)(unsafe.Add(mBase, uint32(v70)+uint32(_consts[503])))
...
L3:
	;
	v12 = *(*int32)(unsafe.Add(mBase, _consts[495]))
...
L10:
	;
	v60 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v38)+uint32(_consts[501]))))
	v66 = v60
	goto L9
L11:
	;
...
L13:
	;
	v59 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_consts[497]))))
	v66 = v59
	goto L9
L14:
	;
	...
	v38 = v36 * int32(12)
	v41 = *(*int32)(unsafe.Add(mBase, uint32(v38)+uint32(_consts[502])))
...
L19:
	;
	v47 = *(*int32)(unsafe.Add(mBase, uint32(v38)+uint32(_consts[503])))
