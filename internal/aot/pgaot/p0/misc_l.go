...
L42:
	;
	F_errmsg_internal(m, int32(317253), int32(0))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L41
...
L43:
	;
	F_errfinish(m, int32(497495), int32(1625), int32(124954))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L41
...
L64:
	;
	F_errfinish(m, int32(494267), int32(224), int32(221631))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L12
...
L23:
	;
	F_errfinish(m, int32(499353), int32(3547), int32(434783))
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L14
...
func F_leftmostvalue_varbit(m *base.Module) int32 {
	...
	_ = v9
	v2 = int32(0)
	v6 = F_DirectFunctionCall3Coll(m, int32(2653), v2, int32(757108), v2, int32(-1))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
L103:
	;
	F_errfinish(m, int32(493786), int32(637), int32(335650))
	mBase = m.M
	v336 = m.ExcPending
	if v336 != 0 {
		goto L1
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+24)) = int32(112)
	v108 = F_chrnamed(m, l0, int32(1620116), int32(1620128), int32(27))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L32
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+24)) = int32(112)
	v34 = F_chrnamed(m, l0, int32(1620096), int32(1620116), int32(7))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L32
...
L103:
	;
	v429 = F_find_among_b(m, l0, int32(4305984), int32(11))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L104
...
L107:
	;
	v483 = F_slice_from_s(m, l0, int32(6), int32(2205912))
	mBase = m.M
	v484 = m.ExcPending
	if v484 != 0 {
		goto L104
...
L108:
	;
	v477 = F_slice_from_s(m, l0, int32(6), int32(2205906))
	mBase = m.M
	v478 = m.ExcPending
	if v478 != 0 {
		goto L104
...
L109:
	;
	v471 = F_slice_from_s(m, l0, int32(6), int32(2205900))
	mBase = m.M
	v472 = m.ExcPending
	if v472 != 0 {
		goto L104
...
L110:
	;
	v465 = F_slice_from_s(m, l0, int32(4), int32(2205896))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L104
...
L111:
	;
	v459 = F_slice_from_s(m, l0, int32(4), int32(2205892))
	mBase = m.M
	v460 = m.ExcPending
	if v460 != 0 {
		goto L104
...
L112:
	;
	v453 = F_slice_from_s(m, l0, int32(7), int32(2205885))
	mBase = m.M
	v454 = m.ExcPending
	if v454 != 0 {
		goto L104
...
L113:
	;
	v447 = F_slice_from_s(m, l0, int32(5), int32(2205880))
	mBase = m.M
	v448 = m.ExcPending
	if v448 != 0 {
		goto L104
...
L114:
	;
	v441 = F_slice_from_s(m, l0, int32(5), int32(2205875))
	mBase = m.M
	v442 = m.ExcPending
	if v442 != 0 {
		goto L104
...
L132:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v491
	v498 = F_find_among_b(m, l0, int32(4306208), int32(204))
	mBase = m.M
	v499 = m.ExcPending
	if v499 != 0 {
		goto L104
...
L144:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v524
	v531 = F_find_among_b(m, l0, int32(4310336), int32(62))
	mBase = m.M
	v532 = m.ExcPending
	if v532 != 0 {
		goto L104
...
L153:
	;
	v555 = F_find_among_b(m, l0, int32(4311584), int32(1))
	mBase = m.M
	v556 = m.ExcPending
	if v556 != 0 {
		goto L104
...
L155:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v559
	v563 = F_slice_from_s(m, l0, int32(1), int32(2206943))
	mBase = m.M
	v564 = m.ExcPending
	if v564 != 0 {
		goto L104
		...
		if base.Ui32(int32(253)) < base.Ui32((v21-int32(3))&int32(255)) {
								...
								if v328 != 0 {
									...
									if v331 != 0 {
										...
										if v335 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = int32(255817)
											F_errhint(m, int32(666515), v16+int32(16))
											mBase = m.M
											v342 = m.ExcPending
											if v342 != 0 {
												return
											} else {
												F_errfinish(m, int32(497495), int32(4374), int32(214806))
												mBase = m.M
												v347 = m.ExcPending
												if v347 != 0 {
													return
											...
											if v155 == int32(0) {
												...
												if v351 != 0 {
													...
													if v355 != 0 {
														...
														F_errfinish(m, int32(497495), int32(4433), int32(214806))
														mBase = m.M
														v360 = m.ExcPending
														if v360 != 0 {
															return
													...
													if v164 != 0 {
														...
														if v167 != 0 {
															...
															if v171 != 0 {
																...
																*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = int32(255817)
																F_errhint(m, int32(666515), v16+int32(32))
																mBase = m.M
																v178 = m.ExcPending
																if v178 != 0 {
																	return
																} else {
																	F_errfinish(m, int32(497495), int32(4439), int32(214806))
																	mBase = m.M
																	v183 = m.ExcPending
																	if v183 != 0 {
																		return
									...
									if v240&v241 != 0 {
										...
										if v364 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v367
											F_errmsg_internal(m, int32(431756), v16+int32(48))
											mBase = m.M
											v377 = m.ExcPending
											if v377 != 0 {
												return
											} else {
												F_errfinish(m, int32(497495), int32(4478), int32(214806))
												mBase = m.M
												v382 = m.ExcPending
												if v382 != 0 {
													return
													...
													if v28 < int32(5) {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v277))) = int32(1)
														if v278 != 0 {
															...
															F_s_lock(m, v284, int32(497495), int32(4495), int32(214806))
															mBase = m.M
															v289 = m.ExcPending
															if v289 != 0 {
																return
			...
			if v313 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16))) = v21
				F_errmsg_internal(m, int32(486943), v16)
				mBase = m.M
				v317 = m.ExcPending
				if v317 != 0 {
					return
				} else {
					F_errfinish(m, int32(497495), int32(4351), int32(214806))
					mBase = m.M
					v322 = m.ExcPending
					if v322 != 0 {
						return
...
L1:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v20)+28)) = int64(85899345928)
	v34 = F_hash_create(m, int32(399088), int32(256), v18+int32(-52), int32(40))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L4
					...
					if v27 != 0 {
						...
						if v29 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = v28
							F_errmsg(m, int32(349082), v10)
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(499030), int32(1842), int32(312277))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return int32(0)
		...
		if l1 < int32(0) {
			...
			if v154 != 0 {
				...
				if v157 != 0 {
					...
					F_errmsg(m, int32(450790), int32(0))
					mBase = m.M
					v161 = m.ExcPending
					if v161 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(499030), int32(1901), int32(312277))
						mBase = m.M
						v166 = m.ExcPending
						if v166 != 0 {
							return int32(0)
...
L32:
	;
	F_errmsg(m, int32(312892), int32(0))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(495605), int32(316), int32(27908))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(495605), int32(320), int32(27908))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
...
func F_lz4_decompress_datum(m *base.Module) int32 {
	...
	if v6 != 0 {
		...
		if v9 != 0 {
			...
			F_errmsg(m, int32(443786), int32(0))
			v13 = m.ExcPending
			if v13 != 0 {
				return int32(0)
			} else {
				F_errdetail(m, int32(578725), int32(0))
				v17 = m.ExcPending
				if v17 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496240), int32(185), int32(286138))
					v22 = m.ExcPending
					if v22 != 0 {
						return int32(0)
					} else {
