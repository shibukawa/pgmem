						...
						case 0:
							...
							if v50 != 0 {
								...
								if v54 != 0 {
									...
									F_errfinish(m, int32(480417), int32(306), int32(338725))
									mBase = m.M
									v59 = m.ExcPending
									if v59 != 0 {
										return
						...
						case 1:
							...
							if v63 != 0 {
								...
								if v67 != 0 {
									...
									F_errfinish(m, int32(480417), int32(314), int32(338725))
									mBase = m.M
									v72 = m.ExcPending
									if v72 != 0 {
										return
						...
						case 2:
							...
							if v76 != 0 {
								...
								if v80 != 0 {
									...
									F_errfinish(m, int32(480417), int32(318), int32(338725))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return
						...
						default:
							...
							if v89 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v31))) = v43
								F_errmsg_internal(m, int32(56094), v31)
								mBase = m.M
								v93 = m.ExcPending
								if v93 != 0 {
									return
								} else {
									F_errfinish(m, int32(480417), int32(322), int32(338725))
									mBase = m.M
									v98 = m.ExcPending
									if v98 != 0 {
										return
