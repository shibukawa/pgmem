					...
					if v43 != 0 {
						...
						case 0:
							...
							if v50 != 0 {
								...
								F_errmsg_internal(m, int32(_a_F_ExecSimpleRelationDelete_0), int32(0))
								mBase = m.M
								v54 = m.ExcPending
								if v54 != 0 {
									return
						...
						case 1:
							...
							if v63 != 0 {
								...
								F_errmsg_internal(m, int32(_a_F_ExecSimpleRelationDelete_3), int32(0))
								mBase = m.M
								v67 = m.ExcPending
								if v67 != 0 {
									return
						...
						case 2:
							...
							if v76 != 0 {
								...
								F_errmsg_internal(m, int32(_a_F_ExecSimpleRelationDelete_4), int32(0))
								mBase = m.M
								v80 = m.ExcPending
								if v80 != 0 {
									return
						...
						default:
							...
							if v89 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v31))) = v43
								F_errmsg_internal(m, int32(_a_F_ExecSimpleRelationDelete_5), v31)
								mBase = m.M
								v93 = m.ExcPending
								if v93 != 0 {
									return
