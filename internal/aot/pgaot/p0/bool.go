			...
			if v44 == int32(0) {
				...
				if v77 != 0 {
					...
					if v81 != 0 {
						...
						F_errfinish(m, int32(497766), int32(330), int32(354295))
						mBase = m.M
						v86 = m.ExcPending
						if v86 != 0 {
							return int32(0)
		...
		if l3 == int32(0) {
			...
			if int32(0) < v17 {
				...
				if v213 != 0 {
					...
					F_errmsg_internal(m, int32(291200), int32(0))
					mBase = m.M
					v217 = m.ExcPending
					if v217 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(500478), int32(1788), int32(291545))
						mBase = m.M
						v222 = m.ExcPending
						if v222 != 0 {
							return int32(0)
				...
				default:
					...
					if v180 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v181
						F_errmsg_internal(m, int32(485639), v9)
						mBase = m.M
						v185 = m.ExcPending
						if v185 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(500478), int32(1902), int32(291545))
							mBase = m.M
							v190 = m.ExcPending
							if v190 != 0 {
								return int32(0)
