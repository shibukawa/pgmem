			...
			if v44 == int32(0) {
				...
				if v77 != 0 {
					...
					if v81 != 0 {
						...
						F_errfinish(m, int32(480488), int32(330), int32(341344))
						mBase = m.M
						v86 = m.ExcPending
						if v86 != 0 {
							return int32(0)
		...
		if l3 == int32(0) {
			...
			if int32(0) < v17 {
				...
				if v213 != 0 {
					...
					F_errmsg_internal(m, int32(280348), int32(0))
					mBase = m.M
					v217 = m.ExcPending
					if v217 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(483107), int32(1788), int32(280693))
						mBase = m.M
						v222 = m.ExcPending
						if v222 != 0 {
							return int32(0)
				...
				case 4, 5, 6, 7, 8, 9:
					...
					if v86 != 0 {
						...
						if v90 != 0 {
							...
							v97 = F_executePredicate(m, l0, l1, v7+int32(-28), v7+int32(-56), l2, int32(1), int32(1438), l0)
							mBase = m.M
							v98 = m.ExcPending
							if v98 != 0 {
								return int32(0)
				...
				default:
					...
					if v180 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v181
						F_errmsg_internal(m, int32(468825), v9)
						mBase = m.M
						v185 = m.ExcPending
						if v185 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(483107), int32(1902), int32(280693))
							mBase = m.M
							v190 = m.ExcPending
							if v190 != 0 {
								return int32(0)
				...
				case 37:
					...
					if v102 != 0 {
						...
						if v106 != 0 {
							...
							v111 = int32(0)
							v114 = F_executePredicate(m, l0, l1, v7+int32(-28), v7+int32(-56), l2, v111, int32(1439), v111)
							mBase = m.M
							v115 = m.ExcPending
							if v115 != 0 {
								return int32(0)
				...
				case 38:
					*(*int64)(unsafe.Add(mBase, uint32(v9)+8)) = int64(0)
					...
					if v123 != 0 {
						...
						v126 = int32(0)
						v131 = F_executePredicate(m, l0, l1, v7+int32(-28), v126, l2, v126, int32(1440), v7+int32(-56))
						mBase = m.M
						v132 = m.ExcPending
						if v132 != 0 {
							return int32(0)
