...
func F_plpgsql_adddatum(m *base.Module, l0 int32) {
	...
	var v33 int32
	_ = v33
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_adddatum[0]))
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_adddatum[1]))
	v14 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_adddatum[2]))
	if v11 == v14 {
		*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_adddatum[2])) = v11 << (uint(int32(1)) % 32)
		...
		if v27 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_adddatum[0])) = v26
			v31 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_adddatum[1]))
			v32 = v31
			v33 = v26
			*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v32
			*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_adddatum[1])) = v32 + int32(1)
...
func F_plpgsql_compile_error_callback(m *base.Module, l0 int32) {
	...
	if v10 != 0 {
			...
			if v11 != 0 {
				...
				if v15 != 0 {
					...
					if v24 != 0 {
						...
						v27 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_error_callback[0]))
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v27
						F_errcontext_msg(m, int32(_a_F_plpgsql_compile_error_callback_1), v7)
						mBase = m.M
						v35 = m.ExcPending
						if v35 != 0 {
							return
		...
		v17 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_compile_error_callback[0]))
		if v17 == int32(0) {
			m.G0 = v7 + int32(16)
			return
		} else {
			...
			if v20 <= int32(0) {
				...
				if v127 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v129
					F_errcontext_msg(m, int32(_a_F_plpgsql_exec_error_callback_1), v6+int32(-48))
					mBase = m.M
					v138 = m.ExcPending
					if v138 != 0 {
						return
				...
				if v28 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v30
					F_errcontext_msg(m, int32(_a_F_plpgsql_exec_error_callback_2), v6+int32(-16))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
			...
			if v41 == int32(0) {
				...
				if v114 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v116
					F_errcontext_msg(m, int32(_a_F_plpgsql_exec_error_callback_3), v8)
					mBase = m.M
					v121 = m.ExcPending
					if v121 != 0 {
						return
				...
				if v20 <= int32(0) {
					...
					if v50 != 0 {
						...
						switch v56 {
						case 0:
							v96 = int32(_a_F_plpgsql_exec_error_callback_4)
							v98 = v96
						case 1:
							v98 = int32(_a_F_plpgsql_exec_error_callback_5)
						case 2:
							v98 = int32(_a_F_plpgsql_exec_error_callback_6)
						case 3:
							v98 = int32(_a_F_plpgsql_exec_error_callback_7)
						case 4:
							v98 = int32(_a_F_plpgsql_exec_error_callback_8)
						case 5:
							v98 = int32(_a_F_plpgsql_exec_error_callback_9)
						case 6:
							v98 = int32(_a_F_plpgsql_exec_error_callback_10)
						case 7:
							v98 = int32(_a_F_plpgsql_exec_error_callback_11)
						case 8:
							v98 = int32(_a_F_plpgsql_exec_error_callback_12)
						case 9:
							v98 = int32(_a_F_plpgsql_exec_error_callback_13)
						case 10:
							v68 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v53)+12)))
							if v68 != 0 {
								v69 = int32(_a_F_plpgsql_exec_error_callback_14)
							} else {
								v69 = int32(_a_F_plpgsql_exec_error_callback_15)
							}
							v98 = v69
						case 11:
							v98 = int32(_a_F_plpgsql_exec_error_callback_16)
						case 12:
							v98 = int32(_a_F_plpgsql_exec_error_callback_17)
						case 13:
							v98 = int32(_a_F_plpgsql_exec_error_callback_18)
						case 14:
							v98 = int32(_a_F_plpgsql_exec_error_callback_19)
						case 15:
							v98 = int32(_a_F_plpgsql_exec_error_callback_20)
						case 16:
							v98 = int32(_a_F_plpgsql_exec_error_callback_21)
						case 17:
							v98 = int32(_a_F_plpgsql_exec_error_callback_22)
						case 18:
							v98 = int32(_a_F_plpgsql_exec_error_callback_23)
						case 19:
							v80 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v53)+12)))
							if v80 != 0 {
								v81 = int32(_a_F_plpgsql_exec_error_callback_24)
							} else {
								v81 = int32(_a_F_plpgsql_exec_error_callback_25)
							}
							v98 = v81
						case 20:
							v98 = int32(_a_F_plpgsql_exec_error_callback_26)
						case 21:
							v85 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v53)+32)))
							if v85 != 0 {
								v86 = int32(_a_F_plpgsql_exec_error_callback_27)
							} else {
								v86 = int32(_a_F_plpgsql_exec_error_callback_28)
							}
							v98 = v86
						case 22:
							v98 = int32(_a_F_plpgsql_exec_error_callback_29)
						case 23:
							v98 = int32(_a_F_plpgsql_exec_error_callback_30)
						case 24:
							v91 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v53)+16)))
							if v91 != 0 {
								v92 = int32(_a_F_plpgsql_exec_error_callback_31)
							} else {
								v92 = int32(_a_F_plpgsql_exec_error_callback_32)
							}
							v98 = v92
						case 25:
							v98 = int32(_a_F_plpgsql_exec_error_callback_33)
						case 26:
							v98 = int32(_a_F_plpgsql_exec_error_callback_34)
						default:
							v96 = int32(_a_F_plpgsql_exec_error_callback_35)
							v98 = v96
						}
						*(*int32)(unsafe.Add(mBase, uint32(v8)+40)) = v98
						*(*int32)(unsafe.Add(mBase, uint32(v8)+36)) = v20
						*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v52
						F_errcontext_msg(m, int32(_a_F_plpgsql_exec_error_callback_36), v6+int32(-32))
						mBase = m.M
						v107 = m.ExcPending
						if v107 != 0 {
							return
...
L15:
	...
	if v83 != int32(_a_F_plpgsql_exec_function_6) {
		goto L9
	} else {
		goto L16
	}
...
L40:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[1]))
...
L41:
	;
	v242 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[2]))
	if v242 != 0 {
		goto L53
	} else {
		goto L54
...
L49:
	;
	v222 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[1]))
...
L57:
	;
	v250 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[1]))
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(_a_F_plpgsql_exec_function_11)
	v405 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[1]))
...
L74:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v275)+24)) = v288
	v290 = int32(_a_F_plpgsql_exec_function_12)
	v291 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[3]))
	v292 = *(*int32)(unsafe.Add(mBase, uint32(v12)+80))
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[3])) = v292
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[3])) = v291
	goto L76
L78:
	;
...
L106:
	;
	v417 = int32(_a_F_plpgsql_exec_function_14)
	v418 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[4]))
...
L110:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[4])) = v419
...
L112:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_exec_function[0])) = v444
...
L126:
	;
	F_errmsg(m, int32(_a_F_plpgsql_exec_function_17), int32(0))
	mBase = m.M
	v508 = m.ExcPending
	if v508 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v39))) = v42
	v96 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_inline_handler[0]))
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v42
	*(*int32)(unsafe.Add(mBase, uint32(v18)+44)) = v39
	v124 = F_ResourceOwnerCreate(m, int32(0), int32(_a_F_plpgsql_inline_handler_0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		v403 = v45
...
L14:
	;
	v127 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_inline_handler[1]))
	v129 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_inline_handler[2]))
	goto L15
L15:
	;
...
L19:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_inline_handler[2])) = v140
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_inline_handler[1])) = v144
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_inline_handler[2])) = v143
	*(*int32)(unsafe.Add(mBase, uint32(v18)+8)) = v144
	*(*int32)(unsafe.Add(mBase, uint32(v18)+12)) = v143
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v136
	*(*int32)(unsafe.Add(mBase, uint32(v18)+20)) = v141
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v137
	*(*int32)(unsafe.Add(mBase, uint32(v18)+44)) = v139
	v310 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_inline_handler[3]))
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v261
	F_errmsg_internal(m, int32(_a_F_plpgsql_inline_handler_2), v18)
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		v403 = v148
...
L2:
	;
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_subxact_cb[0]))
	if v13 == int32(0) {
		goto L1
	} else {
		goto L3
...
L8:
	;
	v28 = int32(_a_F_plpgsql_subxact_cb_0)
	v29 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_subxact_cb[0]))
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_subxact_cb[0])) = v30
	if v30 != 0 {
		v20 = v30
		goto L4
	} else {
...
L30:
	;
	v128 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_plpgsql_validator[0])))
	if v128 == int32(1) {
		goto L50
	} else {
		goto L51
...
L39:
	;
	if base.Ui32(v92-int32(_a_F_plpgsql_validator_1)) < base.Ui32(int32(4)) {
		goto L33
	} else {
		goto L45
	}
...
L45:
	;
	if base.Ui32(v92-int32(_a_F_plpgsql_validator_2)) < base.Ui32(int32(2)) {
		goto L33
	} else {
		goto L46
	}
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+100)) = v15
	v148 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_validator[1]))
...
func F_plpgsql_xact_cb(m *base.Module, l0 int32, l1 int32) {
	...
	if base.Ui32(int32(4)) < base.Ui32(l0) {
		if l0&int32(-2) != int32(2) {
			...
			v37 = int32(0)
			*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_xact_cb[0])) = v37
			*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_xact_cb[1])) = v37
		...
		if int32(1)<<(uint(l0)%32)&int32(19) == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_xact_cb[1])) = int32(0)
			v18 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_xact_cb[0]))
			if v18 != 0 {
				...
				if v20 != 0 {
					...
					v21 = int32(0)
					*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_xact_cb[0])) = v21
					v28 = *(*int32)(unsafe.Add(mBase, _c_F_plpgsql_xact_cb[2]))
					if v28 == v21 {
						*(*int32)(unsafe.Add(mBase, _c_F_plpgsql_xact_cb[2])) = int32(0)
						return
					} else {
