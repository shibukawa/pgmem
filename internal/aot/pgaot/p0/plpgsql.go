...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v60
	F_errmsg_internal(m, int32(454855), v12)
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L1
...
L15:
	;
	F_errfinish(m, int32(469346), int32(1367), int32(139327))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L1
...
func F_plpgsql_adddatum(m *base.Module, l0 int32) {
	...
	var v33 int32
	_ = v33
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1044]))
	v11 = *(*int32)(unsafe.Add(mBase, _consts[1045]))
	v14 = *(*int32)(unsafe.Add(mBase, _consts[1046]))
	if v11 == v14 {
		*(*int32)(unsafe.Add(mBase, _consts[1046])) = v11 << (uint(int32(1)) % 32)
		...
		if v27 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[1044])) = v26
			v31 = *(*int32)(unsafe.Add(mBase, _consts[1045]))
			v32 = v31
			v33 = v26
			*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v32
			*(*int32)(unsafe.Add(mBase, _consts[1045])) = v32 + int32(1)
					...
					if v46 != 0 {
						...
						if v49 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v48
							F_errmsg(m, int32(181444), v8)
							mBase = m.M
							v53 = m.ExcPending
							if v53 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(465426), int32(2102), int32(317311))
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return int32(0)
					...
					if v23 == int32(0) {
						...
						if v62 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v14
							F_errmsg_internal(m, int32(47385), v8+int32(16))
							mBase = m.M
							v68 = m.ExcPending
							if v68 != 0 {
								return int32(0)
	...
	if v10 != 0 {
		...
		if v12 != 0 {
			...
			if v11 != 0 {
				...
				v15 = *(*int32)(unsafe.Add(mBase, _consts[1043]))
				if v15 != 0 {
					F_set_errcontext_domain(m, int32(517193))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
					} else {
						v27 = *(*int32)(unsafe.Add(mBase, _consts[1043]))
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v27
						F_errcontext_msg(m, int32(447802), v7)
						mBase = m.M
						v35 = m.ExcPending
						if v35 != 0 {
							return
		...
		v17 = *(*int32)(unsafe.Add(mBase, _consts[1043]))
		if v17 == int32(0) {
			m.G0 = v7 + int32(16)
			return
		} else {
			...
			if v20 <= int32(0) {
				...
				if v127 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v129
					F_errcontext_msg(m, int32(168739), v6+int32(-48))
					mBase = m.M
					v138 = m.ExcPending
					if v138 != 0 {
						return
				...
				if v28 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v30
					F_errcontext_msg(m, int32(185293), v6+int32(-16))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
			...
			if v41 == int32(0) {
				...
				if v114 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v116
					F_errcontext_msg(m, int32(171791), v8)
					mBase = m.M
					v121 = m.ExcPending
					if v121 != 0 {
						return
				...
				if v20 <= int32(0) {
					...
					if v50 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v52
						F_errcontext_msg(m, int32(167852), v6+int32(-32))
						mBase = m.M
						v107 = m.ExcPending
						if v107 != 0 {
							return
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5175)
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(331037)
	v29 = int32(4418184)
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(155345)
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(11335)
...
L35:
	;
	F_errfinish(m, int32(469346), int32(614), int32(235945))
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L1
...
L40:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _consts[1047]))
...
L49:
	;
	v222 = *(*int32)(unsafe.Add(mBase, _consts[1047]))
...
L57:
	;
	v250 = *(*int32)(unsafe.Add(mBase, _consts[1047]))
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(346122)
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(92414)
	v405 = *(*int32)(unsafe.Add(mBase, _consts[1047]))
...
L98:
	;
	F_errfinish(m, int32(469346), int32(746), int32(235945))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L1
...
L106:
	;
	v417 = int32(4518496)
	v418 = *(*int32)(unsafe.Add(mBase, _consts[1048]))
...
L110:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1048])) = v419
...
L118:
	;
	F_errmsg(m, int32(496484), int32(0))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L1
...
L119:
	;
	F_errfinish(m, int32(469346), int32(641), int32(235945))
	mBase = m.M
	v473 = m.ExcPending
	if v473 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(469346), int32(659), int32(235945))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L1
...
L127:
	;
	F_errfinish(m, int32(469346), int32(664), int32(235945))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
func F_plpgsql_extra_errors_assign_hook(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[1057])) = v4
	return
}
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v42
	*(*int32)(unsafe.Add(mBase, uint32(v18)+44)) = v39
	v124 = F_ResourceOwnerCreate(m, int32(0), int32(135456))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		v403 = v45
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v261
	F_errmsg_internal(m, int32(191901), v18)
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		v403 = v148
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v137
	*(*int32)(unsafe.Add(mBase, uint32(v18)+44)) = v139
	F_errfinish(m, int32(464990), int32(427), int32(206671))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		v403 = v148
...
L2:
	;
	v13 = *(*int32)(unsafe.Add(mBase, _consts[1048]))
	if v13 == int32(0) {
		goto L1
	} else {
		goto L3
...
L8:
	;
	v28 = int32(4518496)
	v29 = *(*int32)(unsafe.Add(mBase, _consts[1048]))
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1048])) = v30
	if v30 != 0 {
		v20 = v30
		goto L4
	} else {
...
L30:
	;
	v128 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1058])))
	if v128 == int32(1) {
		goto L50
	} else {
		goto L51
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v15
	F_errmsg_internal(m, int32(41747), v11)
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L5
...
L65:
	;
	F_errfinish(m, int32(464990), int32(462), int32(197276))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L5
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v225
	F_errmsg_internal(m, int32(191901), v11+int32(48))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L5
...
L69:
	;
	F_errfinish(m, int32(464990), int32(544), int32(197276))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L5
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v250
	F_errmsg(m, int32(176691), v11+int32(32))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L5
...
L74:
	;
	F_errfinish(m, int32(464990), int32(497), int32(197276))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L5
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v272
	F_errmsg(m, int32(179486), v11+int32(16))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L5
...
L79:
	;
	F_errfinish(m, int32(464990), int32(481), int32(197276))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L5
...
func F_plpgsql_xact_cb(m *base.Module, l0 int32, l1 int32) {
	...
	if base.Ui32(int32(4)) < base.Ui32(l0) {
		if l0&int32(-2) != int32(2) {
			...
			v37 = int32(0)
			*(*int32)(unsafe.Add(mBase, _consts[1055])) = v37
			*(*int32)(unsafe.Add(mBase, _consts[1048])) = v37
		...
		if int32(1)<<(uint(l0)%32)&int32(19) == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, _consts[1048])) = int32(0)
			v18 = *(*int32)(unsafe.Add(mBase, _consts[1055]))
			if v18 != 0 {
				...
				if v20 != 0 {
					...
					v21 = int32(0)
					*(*int32)(unsafe.Add(mBase, _consts[1055])) = v21
					v28 = *(*int32)(unsafe.Add(mBase, _consts[1056]))
					if v28 == v21 {
						*(*int32)(unsafe.Add(mBase, _consts[1056])) = int32(0)
						return
					} else {
