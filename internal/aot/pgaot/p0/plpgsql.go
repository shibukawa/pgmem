...
L15:
	;
	F_errfinish(m, int32(476889), int32(1367), int32(140869))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L1
					...
					if v46 != 0 {
						...
						if v49 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v48
							F_errmsg(m, int32(183231), v8)
							mBase = m.M
							v53 = m.ExcPending
							if v53 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(472929), int32(2102), int32(321717))
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return int32(0)
	...
	if v10 != 0 {
		...
		if v12 != 0 {
			...
			if v11 != 0 {
				...
				if v15 != 0 {
					F_set_errcontext_domain(m, int32(525467))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v27
						F_errcontext_msg(m, int32(454853), v7)
						mBase = m.M
						v35 = m.ExcPending
						if v35 != 0 {
							return
			...
			if v20 <= int32(0) {
				...
				if v127 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v129
					F_errcontext_msg(m, int32(170526), v6+int32(-48))
					mBase = m.M
					v138 = m.ExcPending
					if v138 != 0 {
						return
				...
				if v28 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v30
					F_errcontext_msg(m, int32(187080), v6+int32(-16))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
			...
			if v41 == int32(0) {
				...
				if v114 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v116
					F_errcontext_msg(m, int32(173578), v8)
					mBase = m.M
					v121 = m.ExcPending
					if v121 != 0 {
						return
				...
				if v20 <= int32(0) {
					...
					if v50 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v52
						F_errcontext_msg(m, int32(169639), v6+int32(-32))
						mBase = m.M
						v107 = m.ExcPending
						if v107 != 0 {
							return
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+24)) = int32(5362)
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(335688)
	v29 = int32(4435896)
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(157028)
...
L35:
	;
	F_errfinish(m, int32(476889), int32(614), int32(239047))
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L1
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(350897)
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(93513)
...
L98:
	;
	F_errfinish(m, int32(476889), int32(746), int32(239047))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L1
...
L118:
	;
	F_errmsg(m, int32(504622), int32(0))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L1
...
L119:
	;
	F_errfinish(m, int32(476889), int32(641), int32(239047))
	mBase = m.M
	v473 = m.ExcPending
	if v473 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(476889), int32(659), int32(239047))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L1
...
L127:
	;
	F_errfinish(m, int32(476889), int32(664), int32(239047))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v42
	*(*int32)(unsafe.Add(mBase, uint32(v18)+44)) = v39
	v124 = F_ResourceOwnerCreate(m, int32(0), int32(136998))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		v403 = v45
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v261
	F_errmsg_internal(m, int32(193787), v18)
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		v403 = v148
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v137
	*(*int32)(unsafe.Add(mBase, uint32(v18)+44)) = v139
	F_errfinish(m, int32(472493), int32(427), int32(208935))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		v403 = v148
...
L65:
	;
	F_errfinish(m, int32(472493), int32(462), int32(199182))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L5
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v225
	F_errmsg_internal(m, int32(193787), v11+int32(48))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L5
...
L69:
	;
	F_errfinish(m, int32(472493), int32(544), int32(199182))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L5
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v250
	F_errmsg(m, int32(178478), v11+int32(32))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L5
...
L74:
	;
	F_errfinish(m, int32(472493), int32(497), int32(199182))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L5
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v272
	F_errmsg(m, int32(181273), v11+int32(16))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L5
...
L79:
	;
	F_errfinish(m, int32(472493), int32(481), int32(199182))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L5
