...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v60
	F_errmsg_internal(m, int32(476032), v12)
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L1
...
L15:
	;
	F_errfinish(m, int32(491440), int32(1367), int32(147957))
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L1
...
func F_plpgsql_adddatum(m *base.Module, l0 int32) {
	...
	var v33 int32
	_ = v33
	v8 = *(*int32)(unsafe.Add(mBase, _consts[1041]))
	v11 = *(*int32)(unsafe.Add(mBase, _consts[1042]))
	v14 = *(*int32)(unsafe.Add(mBase, _consts[1043]))
	if v11 == v14 {
		*(*int32)(unsafe.Add(mBase, _consts[1043])) = v11 << (uint(int32(1)) % 32)
		...
		if v27 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _consts[1041])) = v26
			v31 = *(*int32)(unsafe.Add(mBase, _consts[1042]))
			v32 = v31
			v33 = v26
			*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v32
			*(*int32)(unsafe.Add(mBase, _consts[1042])) = v32 + int32(1)
					...
					if v46 != 0 {
						...
						if v49 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8))) = v48
							F_errmsg(m, int32(190461), v8)
							mBase = m.M
							v53 = m.ExcPending
							if v53 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(487382), int32(2102), int32(332603))
								mBase = m.M
								v58 = m.ExcPending
								if v58 != 0 {
									return int32(0)
					...
					if v23 == int32(0) {
						...
						if v62 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v14
							F_errmsg_internal(m, int32(49727), v8+int32(16))
							mBase = m.M
							v68 = m.ExcPending
							if v68 != 0 {
								return int32(0)
	...
	if v10 != 0 {
		...
		if v12 != 0 {
			...
			if v11 != 0 {
				...
				v15 = *(*int32)(unsafe.Add(mBase, _consts[1040]))
				if v15 != 0 {
					...
					if v24 != 0 {
						...
						v27 = *(*int32)(unsafe.Add(mBase, _consts[1040]))
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v27
						F_errcontext_msg(m, int32(468893), v7)
						mBase = m.M
						v35 = m.ExcPending
						if v35 != 0 {
							return
		...
		v17 = *(*int32)(unsafe.Add(mBase, _consts[1040]))
		if v17 == int32(0) {
			m.G0 = v7 + int32(16)
			return
		} else {
			...
			if v20 <= int32(0) {
				...
				if v127 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v129
					F_errcontext_msg(m, int32(177756), v6+int32(-48))
					mBase = m.M
					v138 = m.ExcPending
					if v138 != 0 {
						return
				...
				if v28 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v30
					F_errcontext_msg(m, int32(194310), v6+int32(-16))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
			...
			if v41 == int32(0) {
				...
				if v114 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v116
					F_errcontext_msg(m, int32(180808), v8)
					mBase = m.M
					v121 = m.ExcPending
					if v121 != 0 {
						return
				...
				if v20 <= int32(0) {
					...
					if v50 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v52
						F_errcontext_msg(m, int32(176869), v6+int32(-32))
						mBase = m.M
						v107 = m.ExcPending
						if v107 != 0 {
							return
...
L2:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(346692)
	v29 = int32(4463464)
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(164229)
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(12341)
...
L35:
	;
	F_errfinish(m, int32(491440), int32(614), int32(247490))
	mBase = m.M
	v157 = m.ExcPending
	if v157 != 0 {
		goto L1
...
L40:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _consts[1044]))
...
L49:
	;
	v222 = *(*int32)(unsafe.Add(mBase, _consts[1044]))
...
L57:
	;
	v250 = *(*int32)(unsafe.Add(mBase, _consts[1044]))
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(362256)
...
L67:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+164)) = int32(98034)
	v405 = *(*int32)(unsafe.Add(mBase, _consts[1044]))
...
L98:
	;
	F_errfinish(m, int32(491440), int32(746), int32(247490))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L1
...
L106:
	;
	v417 = int32(4563776)
	v418 = *(*int32)(unsafe.Add(mBase, _consts[1045]))
...
L110:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1045])) = v419
...
L118:
	;
	F_errmsg(m, int32(519348), int32(0))
	mBase = m.M
	v466 = m.ExcPending
	if v466 != 0 {
		goto L1
...
L119:
	;
	F_errfinish(m, int32(491440), int32(641), int32(247490))
	mBase = m.M
	v473 = m.ExcPending
	if v473 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(491440), int32(659), int32(247490))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L1
...
L127:
	;
	F_errfinish(m, int32(491440), int32(664), int32(247490))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
func F_plpgsql_extra_errors_assign_hook(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[1054])) = v4
	return
}
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v42
	*(*int32)(unsafe.Add(mBase, uint32(v18)+44)) = v39
	v124 = F_ResourceOwnerCreate(m, int32(0), int32(144029))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		v403 = v45
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v261
	F_errmsg_internal(m, int32(201024), v18)
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		v403 = v148
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+40)) = v137
	*(*int32)(unsafe.Add(mBase, uint32(v18)+44)) = v139
	F_errfinish(m, int32(486895), int32(427), int32(216354))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		v403 = v148
...
L2:
	;
	v13 = *(*int32)(unsafe.Add(mBase, _consts[1045]))
	if v13 == int32(0) {
		goto L1
	} else {
		goto L3
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1045])) = v30
	if v30 != 0 {
		v20 = v30
		goto L4
	} else {
...
L30:
	;
	v128 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1055])))
	if v128 == int32(1) {
		goto L50
	} else {
		goto L51
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v15
	F_errmsg_internal(m, int32(44089), v11)
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L5
...
L65:
	;
	F_errfinish(m, int32(486895), int32(462), int32(206463))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L5
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+48)) = v225
	F_errmsg_internal(m, int32(201024), v11+int32(48))
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L5
...
L69:
	;
	F_errfinish(m, int32(486895), int32(544), int32(206463))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L5
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v250
	F_errmsg(m, int32(185708), v11+int32(32))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L5
...
L74:
	;
	F_errfinish(m, int32(486895), int32(497), int32(206463))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L5
...
L78:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v272
	F_errmsg(m, int32(188503), v11+int32(16))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L5
...
L79:
	;
	F_errfinish(m, int32(486895), int32(481), int32(206463))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L5
...
func F_plpgsql_xact_cb(m *base.Module, l0 int32, l1 int32) {
	...
	if base.Ui32(int32(4)) < base.Ui32(l0) {
		if l0&int32(-2) != int32(2) {
			...
			v37 = int32(0)
			*(*int32)(unsafe.Add(mBase, _consts[1052])) = v37
			*(*int32)(unsafe.Add(mBase, _consts[1045])) = v37
			*(*int32)(unsafe.Add(mBase, _consts[1053])) = int32(0)
		}
		return
	} else {
		if int32(1)<<(uint(l0)%32)&int32(19) == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, _consts[1045])) = int32(0)
			v18 = *(*int32)(unsafe.Add(mBase, _consts[1052]))
			if v18 != 0 {
				...
				if v20 != 0 {
					...
					v21 = int32(0)
					*(*int32)(unsafe.Add(mBase, _consts[1052])) = v21
					v28 = *(*int32)(unsafe.Add(mBase, _consts[1053]))
					if v28 == v21 {
						*(*int32)(unsafe.Add(mBase, _consts[1053])) = int32(0)
						return
					} else {
