...
L28:
	;
	F_errfinish(m, int32(495920), int32(4877), int32(174911))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L1
...
L27:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v22)+60)) = uint32(v143)
	v151 = F_pg_snprintf(m, v22+int32(80), int32(1024), int32(304404), v22+int32(48))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L6
...
L36:
	;
	F_errfinish(m, int32(495920), int32(4574), int32(169785))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L6
...
L137:
	;
	F_errmsg(m, int32(295024), int32(0))
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L6
...
L138:
	;
	F_errfinish(m, int32(495920), int32(4598), int32(169785))
	mBase = m.M
	v617 = m.ExcPending
	if v617 != 0 {
		goto L6
...
L142:
	;
	F_errfinish(m, int32(495920), int32(4604), int32(169785))
	mBase = m.M
	v636 = m.ExcPending
	if v636 != 0 {
		goto L6
...
L146:
	;
	F_errfinish(m, int32(495920), int32(4623), int32(169785))
	mBase = m.M
	v651 = m.ExcPending
	if v651 != 0 {
		goto L6
...
L150:
	;
	F_errfinish(m, int32(495920), int32(4629), int32(169785))
	mBase = m.M
	v672 = m.ExcPending
	if v672 != 0 {
		goto L6
