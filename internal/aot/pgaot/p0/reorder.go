...
func F_ReorderBufferCleanupSerializedTXNs(m *base.Module, l0 int32) {
	...
	v7 = v5 - int32(2208)
	m.G0 = v7
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(91132)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+36)) = l0
	v17 = F_pg_sprintf(m, v7+int32(48), int32(188238), v7+int32(32))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(91132)
	v67 = F_pg_snprintf(m, v7+int32(48), int32(2060), int32(188190), v7+int32(16))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = int32(91132)
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(48)
	F_errmsg(m, int32(311096), v7)
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L1
...
L28:
	;
	F_errfinish(m, int32(521291), int32(4877), int32(186011))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L1
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = int32(91132)
	*(*int32)(unsafe.Add(mBase, uint32(v22)+56)) = v130
	v138 = *(*int32)(unsafe.Add(mBase, _consts[509]))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v22)+60)) = uint32(v143)
	v151 = F_pg_snprintf(m, v22+int32(80), int32(1024), int32(319584), v22+int32(48))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L6
...
L36:
	;
	F_errfinish(m, int32(521291), int32(4574), int32(180604))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L6
...
L137:
	;
	F_errmsg(m, int32(309827), int32(0))
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L6
...
L138:
	;
	F_errfinish(m, int32(521291), int32(4598), int32(180604))
	mBase = m.M
	v617 = m.ExcPending
	if v617 != 0 {
		goto L6
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+32)) = v222
	F_errmsg(m, int32(169615), v22+int32(32))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L6
...
L142:
	;
	F_errfinish(m, int32(521291), int32(4604), int32(180604))
	mBase = m.M
	v636 = m.ExcPending
	if v636 != 0 {
		goto L6
...
L146:
	;
	F_errfinish(m, int32(521291), int32(4623), int32(180604))
	mBase = m.M
	v651 = m.ExcPending
	if v651 != 0 {
		goto L6
...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+20)) = v658 - int32(72)
	F_errmsg(m, int32(169615), v22+int32(16))
	mBase = m.M
	v667 = m.ExcPending
	if v667 != 0 {
		goto L6
...
L150:
	;
	F_errfinish(m, int32(521291), int32(4629), int32(180604))
	mBase = m.M
	v672 = m.ExcPending
	if v672 != 0 {
		goto L6
