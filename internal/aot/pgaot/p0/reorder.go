...
func F_ReorderBufferCleanupSerializedTXNs(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+36)) = l0
	v17 = F_pg_sprintf(m, v7+int32(48), int32(_a_F_ReorderBufferCleanupSerializedTXNs_1), v7+int32(32))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L6:
	...
	if v28&int32(_a_F_ReorderBufferCleanupSerializedTXNs_2) != int32(_a_F_ReorderBufferCleanupSerializedTXNs_3) {
		goto L4
	} else {
		goto L9
	}
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(_a_F_ReorderBufferCleanupSerializedTXNs_0)
	v67 = F_pg_snprintf(m, v7+int32(48), int32(2060), int32(_a_F_ReorderBufferCleanupSerializedTXNs_4), v7+int32(16))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L1:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l1)+120)) = int64(0)
	...
	v85 = int64(*(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferRestoreChanges[0])))
...
L15:
	;
	v111 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferRestoreChanges[1]))
	if v111 != 0 {
		goto L18
	} else {
		goto L19
...
L22:
	;
	if base.Ui32(v581) < base.Ui32(int32(_a_F_ReorderBufferRestoreChanges_0)) {
		v101 = v581
		goto L13
	} else {
		goto L135
...
L24:
	;
	v118 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferRestoreChanges[0]))
...
L25:
	...
	*(*int64)(unsafe.Add(mBase, uint32(l3))) = v124
	v127 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferRestoreChanges[0]))
	v128 = v127
	v129 = v124
	goto L27
L26:
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = int32(_a_F_ReorderBufferRestoreChanges_1)
	*(*int32)(unsafe.Add(mBase, uint32(v22)+56)) = v130
	v138 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferRestoreChanges[2]))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v22)+60)) = uint32(v143)
	v151 = F_pg_snprintf(m, v22+int32(80), int32(1024), int32(_a_F_ReorderBufferRestoreChanges_2), v22+int32(48))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L6
...
L30:
	;
	v164 = *(*int32)(unsafe.Add(mBase, _c_F_ReorderBufferRestoreChanges[3]))
	if v164 == int32(44) {
		goto L31
	} else {
		goto L32
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v22 + int32(80)
	F_errmsg(m, int32(_a_F_ReorderBufferRestoreChanges_3), v22)
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L6
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+32)) = v222
	F_errmsg(m, int32(_a_F_ReorderBufferRestoreChanges_9), v22+int32(32))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L6
...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+20)) = v658 - int32(72)
	F_errmsg(m, int32(_a_F_ReorderBufferRestoreChanges_9), v22+int32(16))
	mBase = m.M
	v667 = m.ExcPending
	if v667 != 0 {
		goto L6
