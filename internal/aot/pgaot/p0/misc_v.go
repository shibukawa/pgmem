...
func F_varstr_abbrev_abort(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 < int32(100) {
		...
		v446 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_varstr_abbrev_abort[0])))
		if v446 != int32(1) {
			...
			if base.F64_lt(base.F64_mul(v444, v477), v229) != 0 {
				...
				v485 = int32(1)
				v487 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_varstr_abbrev_abort[0])))
				if v487 != v485 {
					v510 = v485
					m.G0 = v10 + int32(80)
					return v510
...
L33:
	;
	v81 = int32(_a_F_view_query_is_auto_updatable_10)
	goto L35
L34:
	;
	v81 = int32(0)
...
L37:
	;
	v84 = int32(_a_F_view_query_is_auto_updatable_11)
...
L43:
	...
	if v109 != 0 {
		v130 = int32(_a_F_view_query_is_auto_updatable_12)
		goto L45
	} else {
		goto L46
	}
...
L46:
	;
	v110 = int32(_a_F_view_query_is_auto_updatable_13)
...
L50:
	...
	if v120 < int32(0) {
		v130 = int32(_a_F_view_query_is_auto_updatable_14)
		goto L45
	} else {
		goto L51
	}
...
L53:
	;
	v125 = int32(_a_F_view_query_is_auto_updatable_15)
	goto L54
L54:
	;
	v127 = v125
	...
	if l1 == int32(0) {
		...
		if v28 != v7 {
			...
			if v44 != 0 {
				...
				v65 = v62 + int32(base.Ui32(l0-v7*int32(_a_F_visibilitymap_clear_0))>>(uint(v38)%32)) + int32(24)
		...
		if v44 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(l2))) = v43
			if v43 == int32(0) {
				...
				v48 = v43
				if v48 < int32(0) {
					v57 = *(*int32)(unsafe.Add(mBase, _c_F_visibilitymap_get_status[0]))
					v63 = *(*int32)(unsafe.Add(mBase, uint32(v57+(v48^int32(-1))<<(uint(int32(2))%32))))
					v71 = v63
				} else {
					v65 = *(*int32)(unsafe.Add(mBase, _c_F_visibilitymap_get_status[1]))
					v71 = v65 + v48<<(uint(int32(13))%32) + int32(-8192)
				}
				v78 = int32(*(*int8)(unsafe.Add(mBase, uint32(v71+int32(base.Ui32(l1-v8*int32(_a_F_visibilitymap_get_status_0))>>(uint(int32(2))%32)))+24)))
...
func F_vsnprintf(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+36)) = int32(_a_F_vsnprintf_0)
