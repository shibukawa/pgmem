						...
						if v27 != 0 {
							...
							if v32 != 0 {
								...
								if v35 != 0 {
									...
									F_errmsg(m, int32(264941), int32(0))
									mBase = m.M
									v39 = m.ExcPending
									if v39 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(518546), int32(309), int32(220541))
										mBase = m.M
										v44 = m.ExcPending
										if v44 != 0 {
											return int32(0)
				...
				if v66 != 0 {
					...
					if v69 != 0 {
						...
						if v71 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = int32(582005)
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = v70
							F_errmsg(m, int32(201674), v7)
							mBase = m.M
							v77 = m.ExcPending
							if v77 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(518546), int32(292), int32(220541))
								mBase = m.M
								v82 = m.ExcPending
								if v82 != 0 {
									return int32(0)
		...
		if v19 != int32(23) {
			...
			if v98 != 0 {
				...
				if v101 != 0 {
					...
					F_errmsg(m, int32(386833), int32(0))
					mBase = m.M
					v107 = m.ExcPending
					if v107 != 0 {
						return
						...
						if v110 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v109
							F_errdetail(m, int32(634185), v8+int32(48))
							mBase = m.M
							v117 = m.ExcPending
							if v117 != 0 {
								return
							} else {
								F_errfinish(m, int32(525276), int32(1434), int32(511641))
								mBase = m.M
								v124 = m.ExcPending
								if v124 != 0 {
									return
							...
							if v137 != 0 {
								...
								if v140 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v139
									F_errdetail(m, int32(634230), v8+int32(16))
									mBase = m.M
									v147 = m.ExcPending
									if v147 != 0 {
										return
									} else {
										F_errfinish(m, int32(525276), int32(1442), int32(511641))
										mBase = m.M
										v154 = m.ExcPending
										if v154 != 0 {
											return
									...
									if v42 != 0 {
										...
										if v45 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8))) = v44
											F_errdetail(m, int32(634139), v8)
											mBase = m.M
											v50 = m.ExcPending
											if v50 != 0 {
												return
											} else {
												F_errfinish(m, int32(525276), int32(1451), int32(511641))
												mBase = m.M
												v57 = m.ExcPending
												if v57 != 0 {
													return
								...
								if v167 != 0 {
									...
									if v170 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v169
										F_errdetail(m, int32(634092), v8+int32(32))
										mBase = m.M
										v177 = m.ExcPending
										if v177 != 0 {
											return
										} else {
											F_errfinish(m, int32(525276), int32(1458), int32(511641))
											mBase = m.M
											v184 = m.ExcPending
											if v184 != 0 {
												return
			...
			if v72 != 0 {
				...
				if v78 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v13
					F_errdetail(m, int32(681978), v8-int32(-64))
					mBase = m.M
					v87 = m.ExcPending
					if v87 != 0 {
						return
					} else {
						F_errfinish(m, int32(525276), int32(1424), int32(511641))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return
					...
					if v493 != 0 {
						...
						if v492 == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
							F_errmsg_internal(m, int32(707892), v10)
							mBase = m.M
							v503 = m.ExcPending
							if v503 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(525792), int32(2650), int32(87274))
								mBase = m.M
								v508 = m.ExcPending
								if v508 != 0 {
									return int32(0)
			...
			if v454 != 0 {
				...
				if v451 == int32(0) {
					...
					*(*float64)(unsafe.Add(mBase, uint32(v10)+56)) = base.F64_div(v229, base.F64_convert_i32_u(l0))
					F_errmsg_internal(m, int32(707989), v10+int32(32))
					mBase = m.M
					v471 = m.ExcPending
					if v471 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(525792), int32(2584), int32(87274))
						mBase = m.M
						v476 = m.ExcPending
						if v476 != 0 {
							return int32(0)
			...
			if v15 == int32(0) {
				...
				if v63 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg_internal(m, int32(54040), v8)
					mBase = m.M
					v67 = m.ExcPending
					if v67 != 0 {
						return
					} else {
						F_errfinish(m, int32(518704), int32(361), int32(145644))
						mBase = m.M
						v72 = m.ExcPending
						if v72 != 0 {
							return
						...
						if v30 != 0 {
							...
							if v33 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v21 + int32(4)
								F_errmsg(m, int32(146184), v8+int32(16))
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return
								} else {
									F_errfinish(m, int32(518704), int32(373), int32(145644))
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return
...
func F_visibilitymap_clear(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l1 == int32(0) {
		...
		if v83 != 0 {
			...
			F_errmsg_internal(m, int32(242238), int32(0))
			mBase = m.M
			v87 = m.ExcPending
			if v87 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(520409), int32(156), int32(242261))
				mBase = m.M
				v92 = m.ExcPending
				if v92 != 0 {
					return int32(0)
...
func F_vsnprintf(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+36)) = int32(7713)
