						...
						if v27 != 0 {
							...
							if v32 != 0 {
								...
								if v35 != 0 {
									...
									F_errmsg(m, int32(248067), int32(0))
									mBase = m.M
									v39 = m.ExcPending
									if v39 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(485835), int32(309), int32(206265))
										mBase = m.M
										v44 = m.ExcPending
										if v44 != 0 {
											return int32(0)
				...
				if v66 != 0 {
					...
					if v69 != 0 {
						...
						if v71 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = int32(539523)
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = v70
							F_errmsg(m, int32(188075), v7)
							mBase = m.M
							v77 = m.ExcPending
							if v77 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(485835), int32(292), int32(206265))
								mBase = m.M
								v82 = m.ExcPending
								if v82 != 0 {
									return int32(0)
		...
		if v18 != 0 {
			...
			if v17 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = v20 + int32(4)
				F_errmsg(m, int32(144648), v8)
				mBase = m.M
				v28 = m.ExcPending
				if v28 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(488546), int32(2661), int32(27806))
					mBase = m.M
					v33 = m.ExcPending
					if v33 != 0 {
						return int32(0)
					...
					if v493 != 0 {
						...
						if v492 == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
							F_errmsg_internal(m, int32(651019), v10)
							mBase = m.M
							v503 = m.ExcPending
							if v503 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(491527), int32(2650), int32(80037))
								mBase = m.M
								v508 = m.ExcPending
								if v508 != 0 {
									return int32(0)
			...
			if v454 != 0 {
				...
				if v451 == int32(0) {
					...
					*(*float64)(unsafe.Add(mBase, uint32(v10)+56)) = base.F64_div(v229, base.F64_convert_i32_u(l0))
					F_errmsg_internal(m, int32(651116), v10+int32(32))
					mBase = m.M
					v471 = m.ExcPending
					if v471 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(491527), int32(2584), int32(80037))
						mBase = m.M
						v476 = m.ExcPending
						if v476 != 0 {
							return int32(0)
				...
				if v63 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					...
					if v67 != 0 {
						...
						F_errfinish(m, int32(485993), int32(361), int32(134660))
						mBase = m.M
						v72 = m.ExcPending
						if v72 != 0 {
							return
						...
						if v30 != 0 {
							...
							if v33 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v21 + int32(4)
								F_errmsg(m, int32(135141), v8+int32(16))
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return
								} else {
									F_errfinish(m, int32(485993), int32(373), int32(134660))
									mBase = m.M
									v46 = m.ExcPending
									if v46 != 0 {
										return
...
func F_visibilitymap_clear(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l1 == int32(0) {
		...
		if v83 != 0 {
			...
			F_errmsg_internal(m, int32(226828), int32(0))
			mBase = m.M
			v87 = m.ExcPending
			if v87 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(487459), int32(156), int32(226851))
				mBase = m.M
				v92 = m.ExcPending
				if v92 != 0 {
					return int32(0)
...
func F_vsnprintf(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+36)) = int32(6663)
