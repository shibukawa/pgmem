		...
		if v7 != 0 {
			...
			if v64 != 0 {
				...
				if v67 != 0 {
					...
					F_errmsg(m, int32(273881), int32(0))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return
					} else {
						F_errfinish(m, int32(518151), int32(1118), int32(102621))
						mBase = m.M
						v76 = m.ExcPending
						if v76 != 0 {
							return
						...
						*(*int32)(unsafe.Add(mBase, _consts[109])) = v15
						...
						if v82 != 0 {
							...
							if v85 != 0 {
								...
								F_errmsg(m, int32(271007), int32(0))
								mBase = m.M
								v89 = m.ExcPending
								if v89 != 0 {
									return
								} else {
									F_errfinish(m, int32(518151), int32(1126), int32(102621))
									mBase = m.M
									v94 = m.ExcPending
									if v94 != 0 {
										return
