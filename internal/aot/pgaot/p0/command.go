		...
		if v7 != 0 {
			...
			if v64 != 0 {
				...
				if v67 != 0 {
					...
					F_errmsg(m, int32(250015), int32(0))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return
					} else {
						F_errfinish(m, int32(474390), int32(1118), int32(90912))
						mBase = m.M
						v76 = m.ExcPending
						if v76 != 0 {
							return
					...
					*(*int32)(unsafe.Add(mBase, _consts[112])) = v17
					if v17 == int32(-1) {
						*(*int32)(unsafe.Add(mBase, _consts[112])) = v15
						...
						if v82 != 0 {
							...
							if v85 != 0 {
								...
								F_errmsg(m, int32(247241), int32(0))
								mBase = m.M
								v89 = m.ExcPending
								if v89 != 0 {
									return
								} else {
									F_errfinish(m, int32(474390), int32(1126), int32(90912))
									mBase = m.M
									v94 = m.ExcPending
									if v94 != 0 {
										return
						...
						*(*uint8)(unsafe.Add(mBase, _consts[152])) = uint8(v22)
						...
						if v38 != 0 {
							F_merge_map_updates(m, int32(4437792), int32(4439888), int32(1))
							mBase = m.M
							v43 = m.ExcPending
							if v43 != 0 {
								return
								...
								*(*int32)(unsafe.Add(mBase, _consts[116])) = int32(0)
								...
								if v48 != 0 {
									F_merge_map_updates(m, int32(4438840), int32(4440412), int32(1))
									mBase = m.M
									v53 = m.ExcPending
									if v53 != 0 {
										return
