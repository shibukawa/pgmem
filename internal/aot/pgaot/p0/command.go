		...
		if v7 != 0 {
			...
			if v64 != 0 {
				...
				if v67 != 0 {
					...
					F_errmsg(m, int32(244874), int32(0))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return
					} else {
						F_errfinish(m, int32(463177), int32(1118), int32(89061))
						mBase = m.M
						v76 = m.ExcPending
						if v76 != 0 {
							return
					...
					*(*int32)(unsafe.Add(mBase, _consts[112])) = v17
					if v17 == int32(-1) {
						*(*int32)(unsafe.Add(mBase, _consts[112])) = v15
						...
						if v82 != 0 {
							...
							if v85 != 0 {
								...
								F_errmsg(m, int32(242100), int32(0))
								mBase = m.M
								v89 = m.ExcPending
								if v89 != 0 {
									return
								} else {
									F_errfinish(m, int32(463177), int32(1126), int32(89061))
									mBase = m.M
									v94 = m.ExcPending
									if v94 != 0 {
										return
						...
						*(*uint8)(unsafe.Add(mBase, _consts[152])) = uint8(v22)
						...
						if v38 != 0 {
							F_merge_map_updates(m, int32(4413552), int32(4415648), int32(1))
							mBase = m.M
							v43 = m.ExcPending
							if v43 != 0 {
								return
								...
								*(*int32)(unsafe.Add(mBase, _consts[116])) = int32(0)
								...
								if v48 != 0 {
									F_merge_map_updates(m, int32(4414600), int32(4416172), int32(1))
									mBase = m.M
									v53 = m.ExcPending
									if v53 != 0 {
										return
...
func F_CommandEndInvalidationMessages(m *base.Module) {
	...
	var v55 int32
	_ = v55
	v5 = *(*int32)(unsafe.Add(mBase, _consts[878]))
	if v5 != 0 {
		goto L1
	} else {
		goto L2
...
L15:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _consts[880]))
...
L21:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _consts[878]))
