...
L4:
	...
	v35 = *(*float64)(unsafe.Add(mBase, _consts[381]))
	if l4 != 0 {
		goto L7
	} else {
		goto L8
...
L9:
	...
	v45 = float64(0)
	v48 = *(*float64)(unsafe.Add(mBase, _consts[377]))
...
L10:
	...
	v58 = int32(*(*uint8)(unsafe.Add(mBase, _consts[378])))
	if v58 == int32(1) {
		goto L13
	} else {
		goto L14
...
L12:
	...
	v78 = int32(*(*uint8)(unsafe.Add(mBase, _consts[388])))
...
L19:
	;
	v96 = *(*float64)(unsafe.Add(mBase, _consts[383]))
