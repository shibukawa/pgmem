...
L11:
	;
	F_errfinish(m, int32(518558), int32(1490), int32(404379))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L7
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+128)) = v67
	v80 = F_pg_fprintf(m, v50, int32(780858), v6+int32(128))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L7
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+112)) = int32(246912)
	F_errmsg(m, int32(312851), v6+int32(112))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L7
...
L32:
	;
	F_errfinish(m, int32(518558), int32(1524), int32(404379))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L7
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = int32(246912)
	F_errmsg(m, int32(312266), v6+int32(16))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L7
...
L38:
	;
	F_errfinish(m, int32(518558), int32(1513), int32(404379))
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L7
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+96)) = v125
	v138 = F_pg_fprintf(m, v50, int32(780869), v6+int32(96))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L7
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+80)) = int32(246912)
	F_errmsg(m, int32(312851), v6+int32(80))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L7
...
L50:
	;
	F_errfinish(m, int32(518558), int32(1537), int32(404379))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L7
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+64)) = v163
	v176 = F_pg_fprintf(m, v50, int32(780880), v6-int32(-64))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L7
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = int32(246912)
	F_errmsg(m, int32(312851), v6+int32(48))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L7
...
L63:
	;
	F_errfinish(m, int32(518558), int32(1550), int32(404379))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L7
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = int32(246912)
	F_errmsg(m, int32(310977), v6+int32(32))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L7
...
L71:
	;
	F_errfinish(m, int32(518558), int32(1561), int32(404379))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L7
