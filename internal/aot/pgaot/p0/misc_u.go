...
L60:
	;
	if base.Ui32(int32(_a_F_updateAclDependenciesWorker_0)) < base.Ui32(v446) {
		v463 = int32(0)
		goto L59
	} else {
		goto L61
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+20)) = l0
	v551 = *(*int32)(unsafe.Add(mBase, _c_F_updateAclDependenciesWorker[0]))
	if v541 != 0 {
		goto L92
	} else {
		goto L93
...
L79:
	;
	v497 = l0 - int32(_a_F_updateAclDependenciesWorker_2)
...
L85:
	;
	v513 = l0 - int32(_a_F_updateAclDependenciesWorker_5)
...
L86:
	;
	if int32(1)<<(uint(v513)%32)&int32(_a_F_updateAclDependenciesWorker_6) != 0 {
		v541 = v473
		goto L65
	} else {
		goto L87
...
L108:
	;
	if base.Ui32(int32(_a_F_updateAclDependenciesWorker_0)) < base.Ui32(v618) {
		v635 = int32(0)
		goto L107
	} else {
		goto L109
...
L4:
	...
	v43 = int32(_a_F_update_metainfo_datafile_4)
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[3])) = v41
...
L13:
	;
	v50 = F_fopen(m, int32(_a_F_update_metainfo_datafile_5), int32(_a_F_update_metainfo_datafile_6))
	mBase = m.M
	v52 = int32(_a_F_update_metainfo_datafile_4)
	v53 = *(*int32)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[3])) = v47
...
L15:
	;
	v125 = *(*int32)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[5]))
	if v125 == int32(0) {
		goto L40
	} else {
		goto L41
...
L19:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[4]))
	if v67 == int32(0) {
		goto L15
	} else {
		goto L23
...
L23:
	;
	v71 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[0])))
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+128)) = v67
	v80 = F_pg_fprintf(m, v50, int32(_a_F_update_metainfo_datafile_11), v6+int32(128))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L7
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v6)+112)) = int32(_a_F_update_metainfo_datafile_5)
	F_errmsg(m, int32(_a_F_update_metainfo_datafile_9), v6+int32(112))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L7
...
L37:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = int32(_a_F_update_metainfo_datafile_5)
	F_errmsg(m, int32(_a_F_update_metainfo_datafile_12), v6+int32(16))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L7
...
L40:
	;
	v163 = *(*int32)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[6]))
	if v163 == int32(0) {
		goto L53
	} else {
		goto L54
...
L41:
	;
	v129 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[0])))
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+96)) = v125
	v138 = F_pg_fprintf(m, v50, int32(_a_F_update_metainfo_datafile_10), v6+int32(96))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L7
...
L49:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v6)+80)) = int32(_a_F_update_metainfo_datafile_5)
	F_errmsg(m, int32(_a_F_update_metainfo_datafile_9), v6+int32(80))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L7
...
L54:
	;
	v167 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_update_metainfo_datafile[0])))
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+64)) = v163
	v176 = F_pg_fprintf(m, v50, int32(_a_F_update_metainfo_datafile_8), v6-int32(-64))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L7
...
L62:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = int32(_a_F_update_metainfo_datafile_5)
	F_errmsg(m, int32(_a_F_update_metainfo_datafile_9), v6+int32(48))
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L7
...
L66:
	;
	v204 = F_rename(m, int32(_a_F_update_metainfo_datafile_5), int32(_a_F_update_metainfo_datafile_0))
	mBase = m.M
	if v204 == int32(0) {
		goto L1
	} else {
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = int32(_a_F_update_metainfo_datafile_5)
	F_errmsg(m, int32(_a_F_update_metainfo_datafile_7), v6+int32(32))
	mBase = m.M
	v223 = m.ExcPending
	if v223 != 0 {
		goto L7
