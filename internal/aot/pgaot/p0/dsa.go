	...
	if v16&base.B2i32(l1 < v4) != 0 {
		...
		if v230 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v13)+64)) = l1
			F_errmsg_internal(m, int32(34439), v13-int32(-64))
			mBase = m.M
			v236 = m.ExcPending
			if v236 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(469427), int32(683), int32(433431))
				mBase = m.M
				v241 = m.ExcPending
				if v241 != 0 {
					return int32(0)
		...
		if base.B2i32(v16 == int32(0))&base.B2i32(base.Ui32(int32(1073741824)) <= base.Ui32(l1)) != 0 {
			...
			if base.Ui32(int32(8193)) <= base.Ui32(l1) {
								...
								if v44 != 0 {
									...
									if v48 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v13))) = l1
										F_errdetail(m, int32(528837), v13)
										mBase = m.M
										v52 = m.ExcPending
										if v52 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(469427), int32(709), int32(433431))
											mBase = m.M
											v57 = m.ExcPending
											if v57 != 0 {
												return int32(0)
										...
										if v107 == int32(0) {
											...
											if v245 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v67
												F_errmsg_internal(m, int32(159272), v13+int32(32))
												mBase = m.M
												v251 = m.ExcPending
												if v251 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(469427), int32(744), int32(433431))
													mBase = m.M
													v256 = m.ExcPending
													if v256 != 0 {
														return int32(0)
															...
															if v87 != 0 {
																...
																if v91 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = l1
																	F_errdetail(m, int32(528837), v13+int32(16))
																	mBase = m.M
																	v97 = m.ExcPending
																	if v97 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(469427), int32(731), int32(433431))
																		mBase = m.M
																		v102 = m.ExcPending
																		if v102 != 0 {
																			return int32(0)
				...
				if base.Ui32(l1) <= base.Ui32(int32(1023)) {
					v263 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(l1+int32(7))>>(uint(int32(3))%32)))+uint32(_consts[982]))))
					v267 = v263
				} else {
					v198 = int32(25)
					v199 = int32(37)
					for {
						...
						v218 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v209&int32(131070))+uint32(_consts[983]))))
								...
								if v289 != 0 {
									...
									if v293 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = l1
										F_errdetail(m, int32(528837), v13+int32(48))
										mBase = m.M
										v299 = m.ExcPending
										if v299 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(469427), int32(811), int32(433431))
											mBase = m.M
											v304 = m.ExcPending
											if v304 != 0 {
												return int32(0)
