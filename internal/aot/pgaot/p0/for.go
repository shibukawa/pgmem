...
func F_CheckForStandbyTrigger(m *base.Module) int32 {
	...
	if v10 != 0 {
		...
		if v12 == int32(0) {
			...
			v16 = int32(0)
			v20 = F___fstatat(m, int32(-100), int32(335140), v6, v16)
			mBase = m.M
			if v20 != 0 {
				v75 = v16
				m.G0 = v6 + int32(96)
				...
				if v26 != 0 {
					...
					if v23 != 0 {
						F_errmsg(m, int32(74166), int32(0))
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(473344), int32(4482), int32(215272))
							mBase = m.M
							v35 = m.ExcPending
							if v35 != 0 {
								return int32(0)
							} else {
								v37 = F_unlink(m, int32(335140))
								mBase = m.M
								...
								*(*int32)(unsafe.Add(mBase, uint32(v42)+96)) = int32(1)
								if v43 != 0 {
									...
									F_s_lock(m, v47+int32(96), int32(473344), int32(4456), int32(433806))
									mBase = m.M
									v54 = m.ExcPending
									if v54 != 0 {
										return int32(0)
...
L38:
	;
	F_errmsg(m, int32(327672), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L7
...
L39:
	;
	F_errhint(m, int32(589061), int32(0))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L7
...
L40:
	;
	F_errfinish(m, int32(478227), int32(879), int32(309553))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L7
