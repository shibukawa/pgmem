...
L2:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _c_F_WaitForParallelWorkersToFinish[0]))
	if v20 != 0 {
		goto L4
	} else {
		goto L5
...
L11:
	;
	v97 = *(*int32)(unsafe.Add(mBase, _c_F_WaitForParallelWorkersToFinish[1]))
...
func F_WaitForStandbyConfirmation(m *base.Module, l0 int64) {
	...
	var v44 int32
	_ = v44
	v3 = *(*int32)(unsafe.Add(mBase, _c_F_WaitForStandbyConfirmation[0]))
...
L2:
	;
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_WaitForStandbyConfirmation[1]))
	if v8 == int32(0) {
		goto L1
	} else {
		goto L3
...
L3:
	;
	v12 = *(*int32)(unsafe.Add(mBase, _c_F_WaitForStandbyConfirmation[2]))
...
L6:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_WaitForStandbyConfirmation[3]))
	if v19 != 0 {
		goto L8
	} else {
		goto L9
...
L10:
	;
	v23 = *(*int32)(unsafe.Add(mBase, _c_F_WaitForStandbyConfirmation[4]))
	if v23 != 0 {
		goto L12
	} else {
		goto L13
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_WaitForStandbyConfirmation[4])) = int32(0)
...
L17:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _c_F_WaitForStandbyConfirmation[2]))
