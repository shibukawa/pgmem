...
func F_OpclassIsVisibleExt(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v13 = v11 - int32(16)
	m.G0 = v13
	v16 = F_SearchSysCache1(m, int32(14), l0)
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		goto L2
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = l0
	F_errmsg_internal(m, int32(45738), v13)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L2
...
L11:
	;
	F_errfinish(m, int32(522397), int32(2181), int32(69949))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L2
...
L15:
	;
	v46 = int32(0)
	v48 = *(*int32)(unsafe.Add(mBase, _consts[213]))
	if v48 == v46 {
		goto L19
	} else {
		goto L20
...
L32:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[213]))
	if v95 == int32(0) {
		v138 = v3
		goto L33
	} else {
...
L35:
	;
	v104 = *(*int32)(unsafe.Add(mBase, _consts[122]))
	v107 = int32(0)
	v109 = v104
	v113 = v98
	goto L36
...
L38:
	;
	v124 = F_GetSysCacheOid(m, int32(13), v91, v42+int32(8), v120, int32(0))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L2
...
L42:
	...
	v128 = *(*int32)(unsafe.Add(mBase, _consts[122]))
	v129 = v128
	v130 = v126
	goto L40
L43:
		...
		if v12 != 0 {
							...
							if v23 != 0 {
								...
								if v26 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v25
									F_appendStringInfo(m, l2, int32(216066), v9+int32(16))
									mBase = m.M
									v32 = m.ExcPending
									if v32 != 0 {
										return
									...
									if v37 != 0 {
										...
										if v39 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v36
											F_appendStringInfo(m, l2, int32(187098), v9+int32(32))
											mBase = m.M
											v46 = m.ExcPending
											if v46 != 0 {
												return
			...
			if v57 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
				F_errmsg_internal(m, int32(45738), v9)
				mBase = m.M
				v61 = m.ExcPending
				if v61 != 0 {
					return
				} else {
					F_errfinish(m, int32(516097), int32(12871), int32(395678))
					mBase = m.M
					v66 = m.ExcPending
					if v66 != 0 {
						return
