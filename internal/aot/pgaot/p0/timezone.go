...
L86:
	;
	v360 = *(*int32)(unsafe.Add(mBase, _c_F_check_timezone_abbreviations[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_check_timezone_abbreviations[2])) = v360
	goto L87
L87:
	;
	v366 = F_format_elog_string(m, int32(_a_F_check_timezone_abbreviations_3), int32(0))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L4
...
L88:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_check_timezone_abbreviations[3])) = v366
	v371 = int32(0)
	goto L7
L89:
	;
