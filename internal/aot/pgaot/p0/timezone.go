...
L120:
	;
	v472 = *(*int32)(unsafe.Add(mBase, _c_F_check_timezone_abbreviations[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_check_timezone_abbreviations[2])) = v472
	goto L121
L121:
	;
	v478 = F_format_elog_string(m, int32(_a_F_check_timezone_abbreviations_3), int32(0))
	mBase = m.M
	v479 = m.ExcPending
	if v479 != 0 {
		goto L4
...
L122:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_check_timezone_abbreviations[3])) = v478
	v483 = int32(0)
	goto L7
L123:
	;
