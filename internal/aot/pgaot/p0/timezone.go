...
L3:
	...
	v29 = F_AllocSetContextCreateInternal(m, v24, int32(14260), v18, int32(1024), int32(8192))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L4
...
L86:
	;
	v360 = *(*int32)(unsafe.Add(mBase, _consts[163]))
	*(*int32)(unsafe.Add(mBase, _consts[186])) = v360
	goto L87
L87:
	;
	v366 = F_format_elog_string(m, int32(14053), int32(0))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L4
...
L88:
	;
	*(*int32)(unsafe.Add(mBase, _consts[319])) = v366
	v371 = int32(0)
	goto L7
L89:
	;
