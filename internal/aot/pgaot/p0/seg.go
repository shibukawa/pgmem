												...
												if v23 == int32(126) {
													...
													if v24 == int32(126) {
														...
														if v57 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v14)+20)) = v59
															*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v58
															F_errmsg_internal(m, int32(_a_F_seg_cmp_0), v14+int32(16))
															mBase = m.M
															v66 = m.ExcPending
															if v66 != 0 {
																return int32(0)
																						...
																						if v77 == int32(126) {
																							...
																							if v112 != 0 {
																								...
																								*(*int32)(unsafe.Add(mBase, uint32(v14))) = v113
																								F_errmsg_internal(m, int32(_a_F_seg_cmp_3), v14)
																								mBase = m.M
																								v119 = m.ExcPending
																								if v119 != 0 {
																									return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = l1
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15
				if v15 == int32(0) {
					F_yy_fatal_error_7(m, int32(_a_F_seg_yy_create_buffer_0))
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return int32(0)
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = v20
					v23 = *(*int32)(unsafe.Add(mBase, _c_F_seg_yy_create_buffer[0]))
					v24 = int32(0)
					...
					*(*int32)(unsafe.Add(mBase, _c_F_seg_yy_create_buffer[0])) = v23
					return v8
				}
			}
		} else {
	...
	if v17 != 0 {
		...
		if v14 != 0 {
			...
			*(*uint16)(unsafe.Add(mBase, uint32(l1+v14))) = uint16(v109)
			v111 = F_seg_yy_scan_buffer(m, v14, v13, l2)
			mBase = m.M
			v112 = m.ExcPending
			if v112 != 0 {
				return int32(0)
				...
				if v111 == int32(0) {
					F_yy_fatal_error_7(m, int32(_a_F_seg_yy_scan_bytes_0))
					mBase = m.M
					v123 = m.ExcPending
					if v123 != 0 {
						return int32(0)
			...
			F_yy_fatal_error_7(m, int32(_a_F_seg_yy_scan_bytes_1))
			mBase = m.M
			v120 = m.ExcPending
			if v120 != 0 {
				return int32(0)
