														...
														if v24 == int32(126) {
															...
															if v56 != 0 {
																...
																*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v57
																F_errmsg_internal(m, int32(500303), v14+int32(16))
																mBase = m.M
																v67 = m.ExcPending
																if v67 != 0 {
																	return int32(0)
																} else {
																	F_errfinish(m, int32(521097), int32(787), int32(247067))
																	mBase = m.M
																	v74 = m.ExcPending
																	if v74 != 0 {
																		return int32(0)
																										...
																										if v80 == int32(126) {
																											...
																											if v112 != 0 {
																												...
																												*(*int32)(unsafe.Add(mBase, uint32(v14))) = v113
																												F_errmsg_internal(m, int32(500336), v14)
																												mBase = m.M
																												v121 = m.ExcPending
																												if v121 != 0 {
																													return int32(0)
																												} else {
																													F_errfinish(m, int32(521097), int32(845), int32(247067))
																													mBase = m.M
																													v128 = m.ExcPending
																													if v128 != 0 {
																														return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = l1
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15
				if v15 == int32(0) {
					F_yy_fatal_error_7(m, int32(713078))
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return int32(0)
...
func F_seg_yy_scan_bytes(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.Ui32(l1) < base.Ui32(int32(-2)) {
		...
		if v18 != 0 {
			...
			if v15 == int32(0) {
				F_yy_fatal_error_7(m, int32(712635))
				mBase = m.M
				v122 = m.ExcPending
				if v122 != 0 {
					return int32(0)
				...
				*(*uint16)(unsafe.Add(mBase, uint32(l1+v15))) = uint16(v108)
				...
				if v111 != 0 {
					...
					if v110 == int32(0) {
						F_yy_fatal_error_7(m, int32(712676))
						mBase = m.M
						v125 = m.ExcPending
						if v125 != 0 {
							return int32(0)
		...
		F_yy_fatal_error_7(m, int32(712706))
		mBase = m.M
		v119 = m.ExcPending
		if v119 != 0 {
			return int32(0)
