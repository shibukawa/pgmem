...
L69:
	...
	if v276&int32(_a_F_ExecWindowAgg_9) == int32(0) {
		goto L76
	} else {
		goto L77
	}
...
L86:
	;
	v313 = int32(_a_F_ExecWindowAgg_2)
	v314 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	v316 = *(*int32)(unsafe.Add(mBase, uint32(v303)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v316
...
L132:
	;
	if v666&int32(_a_F_ExecWindowAgg_10) != 0 {
		goto L130
	} else {
		goto L133
	}
...
L161:
	...
	v807 = int32(_a_F_ExecWindowAgg_2)
	v808 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	v810 = *(*int32)(unsafe.Add(mBase, uint32(v214)+372))
	v811 = *(*int32)(unsafe.Add(mBase, uint32(v810)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v811
	if v806 == int32(0) {
		goto L162
	} else {
		goto L163
...
L168:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v808
	v1122 = v787
	goto L160
L169:
	;
...
L196:
	;
	v986 = int32(_a_F_ExecWindowAgg_2)
	v987 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	v989 = *(*int32)(unsafe.Add(mBase, uint32(v797)+128))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v989
...
L197:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v987
...
L204:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1046
	v1048 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v797)+118)))
	if v1048 != int32(_a_F_ExecWindowAgg_11) {
		v1066 = v1048
		v1067 = v1044
		goto L206
	} else {
...
L207:
	;
	v1051 = int32(_a_F_ExecWindowAgg_11)
...
L209:
	...
	v1062 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	if v1060 == v1062 {
		v1073 = v1030
		goto L205
	} else {
...
L212:
	...
	if v1078 != int32(_a_F_ExecWindowAgg_11) {
		goto L213
	} else {
		goto L214
	}
...
L245:
	;
	v1224 = int32(_a_F_ExecWindowAgg_2)
	v1225 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	v1227 = *(*int32)(unsafe.Add(mBase, uint32(v1211)+128))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1227
...
L246:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1225
...
L274:
	...
	v1351 = int32(_a_F_ExecWindowAgg_2)
	v1352 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	v1354 = *(*int32)(unsafe.Add(mBase, uint32(v214)+372))
	v1355 = *(*int32)(unsafe.Add(mBase, uint32(v1354)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1355
	if v1350 == int32(0) {
		goto L276
	} else {
		goto L277
...
L282:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1352
	goto L271
L283:
	;
...
L305:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1523
...
L320:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1623
	v1625 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v1337)+118)))
	if v1625 != int32(_a_F_ExecWindowAgg_11) {
		v1643 = v1625
		v1644 = v1621
		goto L321
	} else {
...
L322:
	;
	v1628 = int32(_a_F_ExecWindowAgg_11)
...
L324:
	...
	v1639 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	if v1637 == v1639 {
		v1650 = v1588
		goto L319
	} else {
...
L327:
	...
	if v1655 != int32(_a_F_ExecWindowAgg_11) {
		goto L328
	} else {
		goto L329
	}
...
L352:
	...
	v1836 = int32(_a_F_ExecWindowAgg_2)
	v1837 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1843
	v1845 = v1835 + v1840
...
L354:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v1837
...
L360:
	...
	if v1868 == int32(_a_F_ExecWindowAgg_11) {
		goto L359
	} else {
		goto L363
	}
...
L388:
	...
	if v2083 != int32(_a_F_ExecWindowAgg_11) {
		v2096 = v2077
		goto L387
	} else {
		goto L389
...
L396:
	...
	if v2101 == int32(_a_F_ExecWindowAgg_11) {
		goto L395
	} else {
		goto L399
	}
...
L407:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v2149
...
L430:
	;
	v2327 = int32(_a_F_ExecWindowAgg_2)
	v2328 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	v2330 = *(*int32)(unsafe.Add(mBase, uint32(v2321)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v2330
...
L431:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v2328
	v2340 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v2322)+4)))
	v2342 = v2340 & int32(_a_F_ExecWindowAgg_21)
...
L433:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v2355
...
L450:
	;
	v2604 = int32(_a_F_ExecWindowAgg_2)
	v2605 = *(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1]))
	v2607 = *(*int32)(unsafe.Add(mBase, uint32(v268)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v2607
...
L451:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecWindowAgg[1])) = v2605
	if v2612 != 0 {
		v2626 = v2322
		v2629 = v219
		goto L6
				...
				if v28 == int32(0) {
					...
					if base.Ui32(int32(9)) < base.Ui32(v33) {
						...
						if int32(base.Ui32(int32(977))>>(uint(v33)%32))&int32(1) == int32(0) {
							...
							v48 = *(*int32)(unsafe.Add(mBase, uint32(v33<<(uint(int32(2))%32))+uint32(_c_F_window_lag_with_offset_and_default[0])))
				...
				if v26 == int32(0) {
					...
					if base.Ui32(int32(9)) < base.Ui32(v31) {
						...
						if int32(base.Ui32(int32(977))>>(uint(v31)%32))&int32(1) == int32(0) {
							...
							v46 = *(*int32)(unsafe.Add(mBase, uint32(v31<<(uint(int32(2))%32))+uint32(_c_F_window_lead_with_offset[0])))
				...
				if v26 == int32(0) {
					...
					if base.Ui32(int32(9)) < base.Ui32(v31) {
						...
						if int32(base.Ui32(int32(977))>>(uint(v31)%32))&int32(1) == int32(0) {
							...
							v46 = *(*int32)(unsafe.Add(mBase, uint32(v31<<(uint(int32(2))%32))+uint32(_c_F_window_lead_with_offset_and_default[0])))
							v48 = *(*int32)(unsafe.Add(mBase, uint32(v26+v46)))
							if v48 == int32(0) {
								v67 = v22
							} else {
