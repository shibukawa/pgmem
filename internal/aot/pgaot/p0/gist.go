					...
					if v57 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = v11
						...
						if v61 != 0 {
							...
							F_errfinish(m, int32(520238), int32(939), int32(98316))
							mBase = m.M
							v66 = m.ExcPending
							if v66 != 0 {
								return int32(0)
...
func F_gist_identify(m *base.Module, l0 int32) int32 {
	...
	if v2 <= base.I32_extend8_s(l0) {
		v12 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(2))%32))&int32(60))+uint32(_consts[54])))
		v13 = v12
	} else {
		v13 = v2
	}
		...
		if v34 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v9
			...
			if v38 != 0 {
				...
				F_errfinish(m, int32(520238), int32(1470), int32(433335))
				mBase = m.M
				v43 = m.ExcPending
				if v43 != 0 {
					return int32(0)
