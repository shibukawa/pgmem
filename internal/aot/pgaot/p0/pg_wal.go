	...
	if v15 != 0 {
		...
		if v20 != 0 {
			...
			if base.Ui32(v17) <= base.Ui32(int32(2)) {
				v27 = *(*int32)(unsafe.Add(mBase, uint32(v17<<(uint(int32(2))%32))+uint32(_consts[181])))
				v28 = v27
			} else {
				v28 = int32(0)
			}
			...
			if v38 != 0 {
				...
				if v42 != 0 {
					...
					if v46 != 0 {
						...
						F_errfinish(m, int32(496030), int32(601), int32(352753))
						mBase = m.M
						v51 = m.ExcPending
						if v51 != 0 {
							return int32(0)
			...
			if v25 != 0 {
				...
				if v29 != 0 {
					...
					if v33 != 0 {
						...
						F_errfinish(m, int32(496030), int32(578), int32(449978))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
