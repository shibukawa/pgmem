...
func F_pg_get_wal_replay_pause_state(m *base.Module, l0 int32) int32 {
	...
	var v51 int32
	_ = v51
	v5 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_pg_get_wal_replay_pause_state[0])))
	if v5 == int32(1) {
		v10 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_wal_replay_pause_state[1]))
		v11 = *(*int32)(unsafe.Add(mBase, uint32(v10)+316))
		v13 = base.B2i32(v11 != int32(2))
		*(*uint8)(unsafe.Add(mBase, _c_F_pg_get_wal_replay_pause_state[0])) = uint8(v13)
		v15 = v13
	} else {
		v15 = int32(0)
	}
	if v15 != 0 {
		...
		if v20 != 0 {
			...
			if base.Ui32(v17) <= base.Ui32(int32(2)) {
				v27 = *(*int32)(unsafe.Add(mBase, uint32(v17<<(uint(int32(2))%32))+uint32(_c_F_pg_get_wal_replay_pause_state[2])))
				v28 = v27
			} else {
				v28 = int32(0)
			}
