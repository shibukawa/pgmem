...
func F_text_concat(m *base.Module, l0 int32) int32 {
	...
	var v11 int32
	_ = v11
	v5 = F_concat_internal(m, int32(756936), int32(0), l0)
	mBase = m.M
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
				...
				if v42 != 0 {
					...
					if v45 != 0 {
						...
						if v49 != 0 {
							...
							F_errfinish(m, int32(499834), int32(6372), int32(329830))
							v54 = m.ExcPending
							if v54 != 0 {
								return
							} else {
...
L61:
	;
	F_errmsg(m, int32(168954), int32(0))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L5
...
L62:
	;
	F_errfinish(m, int32(499834), int32(1920), int32(320289))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L5
