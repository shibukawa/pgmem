...
L70:
	;
	F_s_lock(m, v121, int32(515479), int32(476), int32(372723))
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L1
...
L86:
	;
	F_errfinish(m, int32(515479), int32(377), int32(372723))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L1
...
L90:
	;
	F_errfinish(m, int32(515479), int32(389), int32(372723))
	mBase = m.M
	v349 = m.ExcPending
	if v349 != 0 {
		goto L1
...
L94:
	;
	F_errfinish(m, int32(515479), int32(414), int32(372723))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L1
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v16 + int32(1200)
	F_errmsg(m, int32(310259), v16+int32(16))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(515479), int32(2288), int32(329387))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L1
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v16 + int32(1200)
	F_errmsg(m, int32(310977), v16+int32(32))
	mBase = m.M
	v401 = m.ExcPending
	if v401 != 0 {
		goto L1
...
L102:
	;
	F_errfinish(m, int32(515479), int32(2300), int32(329387))
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L1
...
L105:
	;
	F_errmsg(m, int32(377459), int32(0))
	mBase = m.M
	v430 = m.ExcPending
	if v430 != 0 {
		goto L1
...
L106:
	;
	F_errhint(m, int32(692342), int32(0))
	mBase = m.M
	v434 = m.ExcPending
	if v434 != 0 {
		goto L1
...
L107:
	;
	F_errfinish(m, int32(515479), int32(425), int32(372723))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		goto L1
