...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v59
	F_errmsg(m, int32(333283), v22-int32(-64))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L6
...
L41:
	;
	F_errfinish(m, int32(494331), int32(135), int32(429089))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L6
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v172
	F_appendStringInfo(m, v22+int32(92), int32(205996), v22+int32(48))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L6
...
L59:
	...
	F_set_config_option(m, int32(321439), v204, int32(6), int32(13), int32(2), int32(1))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L6
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v236))) = v278
	F_errmsg_internal(m, int32(485821), v236)
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L6
...
L85:
	;
	F_errfinish(m, int32(499484), int32(4185), int32(123189))
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L6
...
L160:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v236)+16)) = v479
	F_errmsg(m, int32(675259), v236+int32(16))
	mBase = m.M
	v486 = m.ExcPending
	if v486 != 0 {
		goto L6
...
L161:
	;
	F_errfinish(m, int32(499484), int32(4214), int32(382199))
	mBase = m.M
	v491 = m.ExcPending
	if v491 != 0 {
		goto L6
...
L164:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v236)+32)) = v499
	F_errmsg(m, int32(675259), v236+int32(32))
	mBase = m.M
	v506 = m.ExcPending
	if v506 != 0 {
		goto L6
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v236)+48)) = v519
	F_errmsg(m, int32(675259), v236+int32(48))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L6
...
L172:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v236)+64)) = v539
	F_errmsg(m, int32(675259), v236-int32(-64))
	mBase = m.M
	v546 = m.ExcPending
	if v546 != 0 {
		goto L6
...
L176:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v236)+80)) = v559
	F_errmsg(m, int32(675259), v236+int32(80))
	mBase = m.M
	v566 = m.ExcPending
	if v566 != 0 {
		goto L6
...
L196:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v42
	F_errmsg_internal(m, int32(51757), v22)
	mBase = m.M
	v718 = m.ExcPending
	if v718 != 0 {
		goto L6
...
L197:
	;
	F_errfinish(m, int32(494331), int32(85), int32(429089))
	mBase = m.M
	v723 = m.ExcPending
	if v723 != 0 {
		goto L6
...
L200:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+80)) = v59
	F_errmsg(m, int32(714715), v22+int32(80))
	mBase = m.M
	v736 = m.ExcPending
	if v736 != 0 {
		goto L6
...
L202:
	;
	F_errfinish(m, int32(494331), int32(110), int32(429089))
	mBase = m.M
	v745 = m.ExcPending
	if v745 != 0 {
		goto L6
...
func F_has_schema_privilege_id(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v8)+15)) = uint8(v16)
		...
		v22 = F_convert_any_priv_string(m, v12, int32(1657200))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		...
		if v11 != 0 {
			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					v21 = F_convert_any_priv_string(m, v10, int32(1657200))
					mBase = m.M
					v22 = m.ExcPending
					if v22 != 0 {
						return int32(0)
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		...
		if v22 != 0 {
			...
			v24 = F_convert_any_priv_string(m, v14, int32(1657200))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
			...
			if v14 != 0 {
				...
				if v17 != 0 {
					...
					if v20 != 0 {
						...
						v22 = F_convert_any_priv_string(m, v11, int32(1657200))
						mBase = m.M
						v23 = m.ExcPending
						if v23 != 0 {
							return int32(0)
...
L3:
	;
	F_appendStringInfoString(m, v11, int32(729594))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
	F_appendStringInfo(m, v11, int32(729182), v9+int32(16))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L7:
	;
	F_appendStringInfoString(m, v11, int32(756899))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v14
	F_appendStringInfo(m, v9+int32(32), int32(546357), v9)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
