...
func F_SPI_execute_extended(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if l1 == int32(0) {
			...
			v16 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_extended[0]))
			if v16 == int32(0) {
				v74 = int32(-4)
				m.G0 = v8 + int32(48)
				return v74
			} else {
				v21 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_extended[1]))
				v22 = *(*int32)(unsafe.Add(mBase, uint32(v21)+8))
				v24 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_extended[0]))
				*(*int32)(unsafe.Add(mBase, uint32(v24)+12)) = v22
				v26 = *(*int32)(unsafe.Add(mBase, uint32(v24)+24))
				v28 = v8 + int32(28)
				v29 = int64(0)
				*(*int64)(unsafe.Add(mBase, uint32(v28))) = v29
				*(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_extended[2])) = v26
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = int32(569278163)
				...
				if v55 != 0 {
					...
					if v62 != 0 {
						...
						v65 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_extended[0]))
						v66 = *(*int32)(unsafe.Add(mBase, uint32(v65)+20))
						*(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_extended[2])) = v66
	...
	if l0 == int32(0) {
		...
		if l1 == int32(0) {
			...
			if v10 != int32(569278163) {
				...
				v14 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_plan_extended[0]))
				if v14 == int32(0) {
					return int32(-4)
				} else {
					v20 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_plan_extended[1]))
					v21 = *(*int32)(unsafe.Add(mBase, uint32(v20)+8))
					v23 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_plan_extended[0]))
					*(*int32)(unsafe.Add(mBase, uint32(v23)+12)) = v21
					v26 = *(*int32)(unsafe.Add(mBase, uint32(v23)+24))
					*(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_plan_extended[2])) = v26
					v28 = int32(0)
					...
					if v34 != 0 {
						...
						v37 = *(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_plan_extended[0]))
						v38 = *(*int32)(unsafe.Add(mBase, uint32(v37)+20))
						*(*int32)(unsafe.Add(mBase, _c_F_SPI_execute_plan_extended[2])) = v38
...
func F_SPI_gettypeid(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v36 int32
	_ = v36
	*(*int32)(unsafe.Add(mBase, _c_F_SPI_gettypeid[0])) = int32(0)
	if l1 < int32(-6) {
...
L7:
	...
	v32 = v29 - int32(160)
	m.G0 = v32
	v35 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[0]))
	v37 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[1]))
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	v83 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[2]))
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	v129 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = v129
	v132 = int32(*(*uint8)(unsafe.Add(mBase, _c_F__SPI_rollback[4])))
	*(*uint8)(unsafe.Add(mBase, uint32(v29)+4)) = uint8(v132)
	v135 = int32(*(*uint8)(unsafe.Add(mBase, _c_F__SPI_rollback[5])))
...
L27:
	;
	v139 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[6]))
	v141 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[7]))
	goto L29
L28:
	;
	goto L27
...
L33:
	;
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[7])) = v147
	v159 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[1]))
	v160 = int32(1)
...
L35:
	;
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[6])) = v151
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[7])) = v150
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[0])) = v149
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v151
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v150
	*(*int32)(unsafe.Add(mBase, uint32(v13)+20)) = v149
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v147
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[3])) = v196
	v199 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v148)+4)))
	*(*uint8)(unsafe.Add(mBase, _c_F__SPI_rollback[4])) = uint8(v199)
	v202 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v148)+5)))
	*(*uint8)(unsafe.Add(mBase, _c_F__SPI_rollback[5])) = uint8(v202)
	goto L43
L41:
	;
	goto L42
L42:
	;
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[0])) = v149
	v207 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[1]))
	v208 = int32(0)
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[3])) = v257
	v260 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v148)+4)))
	*(*uint8)(unsafe.Add(mBase, _c_F__SPI_rollback[4])) = uint8(v260)
	v263 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v148)+5)))
	*(*uint8)(unsafe.Add(mBase, _c_F__SPI_rollback[5])) = uint8(v263)
	goto L51
L49:
	;
	goto L50
L50:
	;
	*(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[0])) = v149
	v268 = *(*int32)(unsafe.Add(mBase, _c_F__SPI_rollback[1]))
	v269 = int32(0)
