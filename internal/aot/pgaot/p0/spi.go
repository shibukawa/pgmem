...
func F_SPI_copytuple(m *base.Module, l0 int32) int32 {
	...
	_ = v28
	if l0 == int32(0) {
		*(*int32)(unsafe.Add(mBase, _consts[348])) = int32(-6)
		return int32(0)
	} else {
		v12 = *(*int32)(unsafe.Add(mBase, _consts[343]))
		if v12 == int32(0) {
			*(*int32)(unsafe.Add(mBase, _consts[348])) = int32(-4)
			return int32(0)
		} else {
			v20 = int32(4562096)
...
func F_SPI_execute_extended(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if l1 == int32(0) {
			...
			v16 = *(*int32)(unsafe.Add(mBase, _consts[343]))
			if v16 == int32(0) {
				v74 = int32(-4)
				m.G0 = v8 + int32(48)
				return v74
				...
				v24 = *(*int32)(unsafe.Add(mBase, _consts[343]))
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = int32(569278163)
				...
				if v55 != 0 {
					...
					if v62 != 0 {
						...
						v65 = *(*int32)(unsafe.Add(mBase, _consts[343]))
	...
	if l0 == int32(0) {
		...
		if l1 == int32(0) {
			...
			if v10 != int32(569278163) {
				...
				v14 = *(*int32)(unsafe.Add(mBase, _consts[343]))
				if v14 == int32(0) {
					return int32(-4)
				} else {
					v20 = *(*int32)(unsafe.Add(mBase, _consts[37]))
					v21 = *(*int32)(unsafe.Add(mBase, uint32(v20)+8))
					v23 = *(*int32)(unsafe.Add(mBase, _consts[343]))
					...
					*(*int32)(unsafe.Add(mBase, _consts[0])) = v26
					...
					if v34 != 0 {
						...
						v37 = *(*int32)(unsafe.Add(mBase, _consts[343]))
...
func F_SPI_gettypeid(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, _consts[348])) = int32(0)
	if l1 < int32(-6) {
		*(*int32)(unsafe.Add(mBase, _consts[348])) = int32(-9)
		return int32(0)
	} else {
		if l1 == int32(0) {
			*(*int32)(unsafe.Add(mBase, _consts[348])) = int32(-9)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errfinish(m, int32(523553), int32(341), int32(335066))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		v284 = v32
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errmsg(m, int32(361176), int32(0))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		v284 = v32
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errfinish(m, int32(523553), int32(347), int32(335066))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		v284 = v32
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	v129 = *(*int32)(unsafe.Add(mBase, _consts[107]))
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = v129
	v132 = int32(*(*uint8)(unsafe.Add(mBase, _consts[153])))
	*(*uint8)(unsafe.Add(mBase, uint32(v29)+4)) = uint8(v132)
	v135 = int32(*(*uint8)(unsafe.Add(mBase, _consts[108])))
...
L27:
	...
	v141 = *(*int32)(unsafe.Add(mBase, _consts[291]))
	goto L29
L28:
	;
	goto L27
...
L33:
	;
	*(*int32)(unsafe.Add(mBase, _consts[291])) = v147
	v159 = *(*int32)(unsafe.Add(mBase, _consts[343]))
	v160 = int32(1)
...
L35:
	;
	*(*int32)(unsafe.Add(mBase, _consts[74])) = v151
	*(*int32)(unsafe.Add(mBase, _consts[291])) = v150
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, _consts[107])) = v196
	v199 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v148)+4)))
	*(*uint8)(unsafe.Add(mBase, _consts[153])) = uint8(v199)
	v202 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v148)+5)))
	*(*uint8)(unsafe.Add(mBase, _consts[108])) = uint8(v202)
	goto L43
L41:
	;
	goto L42
L42:
	;
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v149
	v207 = *(*int32)(unsafe.Add(mBase, _consts[343]))
	v208 = int32(0)
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, _consts[107])) = v257
	v260 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v148)+4)))
	*(*uint8)(unsafe.Add(mBase, _consts[153])) = uint8(v260)
	v263 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v148)+5)))
	*(*uint8)(unsafe.Add(mBase, _consts[108])) = uint8(v263)
	goto L51
L49:
	;
	goto L50
L50:
	;
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v149
	v268 = *(*int32)(unsafe.Add(mBase, _consts[343]))
	v269 = int32(0)
