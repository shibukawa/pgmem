...
func F_GetMaxSnapshotXidCount(m *base.Module) int32 {
	...
	var v3 int32
	_ = v3
	v2 = *(*int32)(unsafe.Add(mBase, _consts[30]))
...
L4:
	;
	v13 = int32(1)
	v15 = F_check_functions_in_node(m, v9, int32(863), l1)
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L8
...
L11:
	;
	v126 = F_expression_tree_walker_impl(m, v9, int32(864), l1)
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L8
...
L49:
	;
	v118 = F_query_tree_walker_impl(m, v9, int32(864), l1, int32(0))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L8
