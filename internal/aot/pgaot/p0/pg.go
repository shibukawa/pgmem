...
L156:
	;
	v1400 = int32(0)
	v1403 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[20]))
	if v1403 != 0 {
		goto L155
	} else {
		goto L380
...
L222:
	;
	v780 = int32(_a_F_PgArchiverMain_23)
	v784 = m.G0
	v786 = v784 - int32(32)
	v787 = int64(0)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v786))) = v787
	v795 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_PgArchiverMain[23])))
	if v795 == int32(0) {
		goto L224
	} else {
		goto L225
...
L226:
	;
	v799 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_PgArchiverMain[24])))
	if v799 == int32(0) {
		goto L227
	} else {
		goto L228
...
L244:
	;
	v867 = v718 + v865
	v868 = int32(_a_F_PgArchiverMain_20)
	v871 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_PgArchiverMain[25])))
...
L254:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v485+int32(1344)+v865))) = uint8(v901)
	v904 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[11]))
...
L282:
	;
	v994 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[11]))
...
L287:
	;
	v1009 = F_strspn(m, v1001, int32(_a_F_PgArchiverMain_24))
	mBase = m.M
	if v1009 != int32(8) {
		v1018 = v1004
		goto L286
...
L288:
	;
	v1015 = F_strcmp(m, v1001+int32(8), int32(_a_F_PgArchiverMain_25))
	mBase = m.M
...
L291:
	;
	v1029 = F_strcmp(m, v485+int32(1352), int32(_a_F_PgArchiverMain_25))
	mBase = m.M
...
L292:
	;
	v1023 = F_strspn(m, v1003, int32(_a_F_PgArchiverMain_24))
	mBase = m.M
	if v1023 == int32(8) {
		goto L291
	} else {
...
L301:
	;
	v1041 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[11]))
...
L303:
	;
	v1122 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[11]))
...
L344:
	;
	v1232 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[11]))
...
L349:
	;
	v1243 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[11]))
...
L357:
	;
	v1286 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[11]))
...
L385:
	;
	v1422 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[26])) = v1422
	v1426 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[16]))
...
L387:
	;
	F_errfinish(m, int32(_a_F_PgArchiverMain_16), v1739, int32(_a_F_PgArchiverMain_32))
	mBase = m.M
	v1742 = m.ExcPending
	if v1742 != 0 {
		goto L1
...
L388:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v485)+112)) = v485 + int32(1296)
	v1469 = F_pg_snprintf(m, v485+int32(176), int32(1024), int32(_a_F_PgArchiverMain_33), v485+int32(112))
	mBase = m.M
	v1470 = m.ExcPending
	if v1470 != 0 {
		goto L1
...
L389:
	;
	v1431 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[17]))
...
L394:
	;
	v1446 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[26]))
	if v1446 == int32(0) {
		v1739 = int32(431)
		goto L387
	} else {
...
L401:
	;
	v1481 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[22]))
	if v1481 != int32(44) {
		goto L399
	} else {
		goto L402
...
L402:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v485)+96)) = v485 + int32(1296)
	v1495 = F_pg_snprintf(m, v485+int32(2368), int32(1024), int32(_a_F_PgArchiverMain_21), v485+int32(96))
	mBase = m.M
	v1496 = m.ExcPending
	if v1496 != 0 {
		goto L1
...
L417:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v485)+32)) = v485 + int32(1296)
	v1559 = F_pg_snprintf(m, v485+int32(2368), int32(1024), int32(_a_F_PgArchiverMain_21), v485+int32(32))
	mBase = m.M
	v1560 = m.ExcPending
	if v1560 != 0 {
		goto L1
...
L419:
	...
	v1663 = int32(1)
	v1668 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[27]))
	v1669 = F_GetCurrentTimestamp(m)
	mBase = m.M
	v1670 = int32(_a_F_PgArchiverMain_38)
	v1672 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[28]))
	*(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[28])) = v1672 + v1663
...
L420:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v485)+16)) = v485 + int32(1296)
	v1572 = F_pg_snprintf(m, v485+int32(1344), int32(1024), int32(_a_F_PgArchiverMain_21), v485+int32(16))
	mBase = m.M
	v1573 = m.ExcPending
	if v1573 != 0 {
		goto L1
...
L422:
	...
	v1610 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[27]))
	v1611 = F_GetCurrentTimestamp(m)
	mBase = m.M
	v1612 = int32(_a_F_PgArchiverMain_38)
	v1614 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[28]))
	v1615 = int32(1)
	*(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[28])) = v1614 + v1615
...
L438:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1610)+40)) = v1651 + v1652
	v1655 = int32(_a_F_PgArchiverMain_38)
	v1657 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[28]))
	*(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[28])) = v1657 - v1652
	goto L429
L439:
	;
	v1720 = v1406 + int32(1)
...
L448:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1668)+40)) = v1709 + v1710
	v1713 = int32(_a_F_PgArchiverMain_38)
	v1715 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[28]))
	*(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[28])) = v1715 - v1710
	goto L439
L449:
	;
...
L454:
	;
	v1749 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[20]))
	if v1749 == int32(0) {
		v1406 = v1743
		v1407 = v1744
		goto L381
...
L456:
	;
	v1764 = *(*int32)(unsafe.Add(mBase, _c_F_PgArchiverMain[18]))
	v1768 = F_WaitLatch(m, v1764, int32(25), int32(_a_F_PgArchiverMain_43), int32(83886080))
	mBase = m.M
	v1769 = m.ExcPending
	if v1769 != 0 {
		goto L1
...
L23:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v111))) = uint8(v115)
	...
	v120 = int32(_a_F_pg_char_to_encoding_private_0)
	v121 = int32(_a_F_pg_char_to_encoding_private_1)
	goto L32
L24:
	;
...
L73:
	;
	v231 = v16 + int32(224)
	v233 = *(*int32)(unsafe.Add(mBase, _c_F_pg_import_system_collations[0]))
	v234 = int32(99)
	v240 = int32(0)
...
L110:
	...
	v398 = *(*int32)(unsafe.Add(mBase, _c_F_pg_import_system_collations[0]))
	v399 = int32(99)
...
L87:
	...
	v273 = v221<<(uint(int32(12))%32)&int32(_a_F_pg_saslprep_0) | v244&int32(63)<<(uint(int32(6))%32)
	v274 = int32(2)
	goto L83
L88:
	;
...
L90:
	...
	v273 = v221<<(uint(int32(18))%32)&int32(_a_F_pg_saslprep_1) | v260&v261<<(uint(int32(12))%32) | v266&v261<<(uint(int32(6))%32)
	v274 = int32(3)
	goto L83
L91:
	;
...
L105:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v332
	if base.Ui32(int32(-12130)) < base.Ui32(v332-int32(_a_F_pg_saslprep_2)) {
		goto L109
	} else {
		goto L110
	}
...
L109:
	;
	v345 = F_bsearch(m, v13+int32(12), int32(_a_F_pg_saslprep_3), int32(6), int32(8), int32(_a_F_pg_saslprep_4))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L12
...
L111:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v332
	if base.Ui32(v332-int32(_a_F_pg_saslprep_5)) <= base.Ui32(int32(-65108)) {
		goto L114
	} else {
		goto L115
	}
...
L116:
	;
	v356 = int32(8)
	v359 = F_bsearch(m, v13+int32(12), int32(_a_F_pg_saslprep_6), v356, v356, int32(_a_F_pg_saslprep_4))
	mBase = m.M
	v360 = m.ExcPending
	if v360 != 0 {
		goto L12
...
L130:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v404
	if base.Ui32(int32(_a_F_pg_saslprep_7)) <= base.Ui32(v404) {
		goto L132
	} else {
		goto L133
	}
...
L133:
	;
	v414 = F_bsearch(m, v13+int32(12), int32(_a_F_pg_saslprep_8), int32(36), int32(8), int32(_a_F_pg_saslprep_4))
	mBase = m.M
	v415 = m.ExcPending
	if v415 != 0 {
		goto L12
...
L135:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v404
	if base.Ui32(v404-int32(_a_F_pg_saslprep_9)) <= base.Ui32(int32(-982494)) {
		goto L132
	} else {
		goto L136
	}
L136:
	;
	v427 = F_bsearch(m, v13+int32(12), int32(_a_F_pg_saslprep_10), int32(396), int32(8), int32(_a_F_pg_saslprep_4))
	mBase = m.M
	v428 = m.ExcPending
	if v428 != 0 {
		goto L12
...
L140:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v446
	if base.Ui32(int32(-63808)) < base.Ui32(v446-int32(_a_F_pg_saslprep_11)) {
		goto L143
	} else {
		goto L144
	}
...
L143:
	;
	v458 = F_bsearch(m, v13+int32(12), int32(_a_F_pg_saslprep_12), int32(34), int32(8), int32(_a_F_pg_saslprep_4))
	mBase = m.M
	v459 = m.ExcPending
	if v459 != 0 {
		goto L12
...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v481
	if base.Ui32(int32(-1114046)) < base.Ui32(v481-int32(_a_F_pg_saslprep_13)) {
		goto L151
	} else {
		goto L152
	}
...
L151:
	;
	v493 = F_bsearch(m, v13+int32(12), int32(_a_F_pg_saslprep_14), int32(360), int32(8), int32(_a_F_pg_saslprep_4))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L12
...
L172:
	;
	if base.Ui32(v518) <= base.Ui32(int32(_a_F_pg_saslprep_15)) {
		goto L173
	} else {
		goto L174
	}
...
L203:
	;
	if base.Ui32(v639) <= base.Ui32(int32(_a_F_pg_saslprep_15)) {
		goto L204
	} else {
		goto L205
	}
...
L6:
	;
	v215 = F_pstrdup(m, int32(_a_F_pg_timezone_names_1))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L1
...
L8:
	;
	v92 = v85 + int32(_a_F_pg_timezone_names_1)
	v93 = int32(_a_F_pg_timezone_names_2)
	v95 = int32(1024) - v85
	if v95 == int32(0) {
		goto L27
	} else {
...
L25:
	;
	v211 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_pg_timezone_names[0])) = uint8(v211)
	goto L6
L26:
	;
...
L115:
	;
	v390 = int32(_a_F_pg_timezone_names_6)
	goto L116
L116:
	;
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = base.I32_extend16_s(v93)
	v104 = F_pg_snprintf(m, v90+(v8+int32(192)), int32(64)-v90, int32(_a_F_pg_tzset_offset_1), v8+int32(32))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L1
...
L22:
	...
	if v108&int32(_a_F_pg_tzset_offset_2) == int32(0) {
		goto L3
	} else {
		goto L23
	}
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = base.I32_extend16_s(v108)
	v182 = F_pg_snprintf(m, v171+(v8+int32(192)), int32(64)-v171, int32(_a_F_pg_tzset_offset_1), v8+int32(16))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L42:
	;
	v200 = int32(_a_F_pg_tzset_offset_3)
	goto L44
L43:
	;
	v200 = int32(_a_F_pg_tzset_offset_4)
	goto L44
L44:
	;
