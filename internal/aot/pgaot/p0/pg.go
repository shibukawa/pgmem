...
L13:
	;
	v55 = F___memcpy(m, int32(4681324), v44, int32(140))
	mBase = m.M
	goto L15
L14:
	;
...
L26:
	;
	v97 = F___memcpy(m, int32(4681464), v86, int32(140))
	mBase = m.M
	goto L28
L27:
	;
...
L39:
	;
	v139 = F___memcpy(m, int32(4683284), v128, int32(140))
	mBase = m.M
	goto L41
L40:
	;
...
L52:
	;
	v181 = F___memcpy(m, int32(4683144), v170, int32(140))
	mBase = m.M
	goto L54
L53:
	;
...
L65:
	;
	v223 = F___memcpy(m, int32(4683004), v212, int32(140))
	mBase = m.M
	goto L67
L66:
	;
...
L78:
	;
	v265 = F___memcpy(m, int32(4682584), v254, int32(140))
	mBase = m.M
	goto L80
L79:
	;
...
L91:
	;
	v307 = F___memcpy(m, int32(4682864), v296, int32(140))
	mBase = m.M
	goto L93
L92:
	;
...
L104:
	;
	v349 = F___memcpy(m, int32(4683564), v338, int32(140))
	mBase = m.M
	goto L106
L105:
	;
...
L134:
	;
	F_errfinish(m, int32(498418), int32(921), int32(17628))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L1
...
L137:
	;
	F_errfinish(m, int32(498418), int32(936), int32(17628))
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L1
...
L139:
	;
	F_errmsg(m, int32(319343), int32(0))
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L1
...
L140:
	;
	F_errfinish(m, int32(498418), int32(942), int32(17628))
	mBase = m.M
	v482 = m.ExcPending
	if v482 != 0 {
		goto L1
...
L270:
	;
	v953 = F_strspn(m, v945, int32(537590))
	mBase = m.M
	if v953 != int32(8) {
		v962 = v948
		goto L269
...
L275:
	;
	v967 = F_strspn(m, v947, int32(537590))
	mBase = m.M
	if v967 == int32(8) {
		goto L274
	} else {
...
L323:
	;
	F_errfinish(m, int32(496419), int32(161), int32(463772))
	mBase = m.M
	v1146 = m.ExcPending
	if v1146 != 0 {
		goto L1
...
L335:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v485)+144)) = v485 + int32(1344)
	F_errmsg(m, int32(298021), v485+int32(144))
	mBase = m.M
	v1206 = m.ExcPending
	if v1206 != 0 {
		goto L1
...
L336:
	;
	F_errfinish(m, int32(498418), int32(682), int32(327663))
	mBase = m.M
	v1211 = m.ExcPending
	if v1211 != 0 {
		goto L1
...
L370:
	;
	F_errfinish(m, int32(498418), v1683, int32(234842))
	mBase = m.M
	v1686 = m.ExcPending
	if v1686 != 0 {
		goto L1
...
L376:
	;
	F_errmsg(m, int32(450473), int32(0))
	mBase = m.M
	v1387 = m.ExcPending
	if v1387 != 0 {
		goto L1
...
L379:
	;
	F_errfinish(m, int32(498418), int32(431), int32(234842))
	mBase = m.M
	v1403 = m.ExcPending
	if v1403 != 0 {
		goto L1
...
L391:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v485)+64)) = v485 + int32(2368)
	F_errmsg(m, int32(715987), v485-int32(-64))
	mBase = m.M
	v1459 = m.ExcPending
	if v1459 != 0 {
		goto L1
...
L392:
	;
	F_errfinish(m, int32(498418), int32(454), int32(234842))
	mBase = m.M
	v1464 = m.ExcPending
	if v1464 != 0 {
		goto L1
...
L397:
	;
	F_errfinish(m, int32(498418), int32(464), int32(234842))
	mBase = m.M
	v1487 = m.ExcPending
	if v1487 != 0 {
		goto L1
...
L403:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v485)+20)) = int32(373087)
...
L410:
	;
	F_errfinish(m, int32(498418), int32(837), int32(373145))
	mBase = m.M
	v1546 = m.ExcPending
	if v1546 != 0 {
		goto L1
...
L55:
	;
	F_errfinish(m, int32(500178), v151, int32(213484))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L3
...
func F__PG_init_pg_trgm(m *base.Module) {
	...
	_ = v36
	v8 = int32(660718)
	F_DefineCustomRealVariable(m, int32(429960), int32(607272), v8, int32(4396120), float64(0.30000001192092896))
	v14 = m.ExcPending
	if v14 != 0 {
		return
	} else {
		F_DefineCustomRealVariable(m, int32(429926), int32(607228), v8, int32(4396128), float64(0.6000000238418579))
		v23 = m.ExcPending
		if v23 != 0 {
			return
		} else {
			F_DefineCustomRealVariable(m, int32(429885), int32(607183), v8, int32(4396136), float64(0.5))
			v32 = m.ExcPending
			if v32 != 0 {
				return
			} else {
				F_MarkGUCPrefixReserved(m, int32(289430))
				v36 = m.ExcPending
				if v36 != 0 {
					return
				} else {
...
func F__PG_init_pgcrypto(m *base.Module) {
	...
	var v18 int32
	_ = v18
	F_DefineCustomEnumVariable(m, int32(455583), int32(650406), int32(413833), int32(4679728), int32(4394784))
	v14 = m.ExcPending
	if v14 != 0 {
		return
	} else {
		F_MarkGUCPrefixReserved(m, int32(239424))
		v18 = m.ExcPending
		if v18 != 0 {
			return
		} else {
...
L33:
	;
	F_errfinish(m, int32(500555), int32(5289), int32(341072))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L6
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+24)) = v192
	F_make_relative_path(m, v18, int32(411095), int32(4511568))
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L1
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+32)) = v203
	F_make_relative_path(m, v18, int32(300692), int32(4511568))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L1
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+40)) = v214
	F_make_relative_path(m, v18, int32(213972), int32(4511568))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L1
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+48)) = v225
	F_make_relative_path(m, v18, int32(503397), int32(4511568))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23-int32(-64)))) = v247
	F_make_relative_path(m, v18, int32(398168), int32(4511568))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L1
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+72)) = v258
	F_make_relative_path(m, v18, int32(282952), int32(4511568))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L1
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+88)) = v278
	F_get_etc_path(m, int32(4511568), v18)
	mBase = m.M
	v283 = m.ExcPending
	if v283 != 0 {
		goto L1
		...
		if v14 == int32(1) {
						...
						if v39 == int32(0) {
							...
							if v187 != 0 {
								...
								if v191 != 0 {
									...
									F_errfinish(m, int32(500532), int32(90), int32(88117))
									mBase = m.M
									v196 = m.ExcPending
									if v196 != 0 {
										return int32(0)
							...
							*(*uint32)(unsafe.Add(mBase, uint32(v9)+24)) = uint32(v53)
							v61 = F_pg_snprintf(m, v9+int32(32), int32(64), int32(510531), v9+int32(16))
							mBase = m.M
							v62 = m.ExcPending
							if v62 != 0 {
								return int32(0)
			...
			if v174 != 0 {
				...
				if v178 != 0 {
					...
					F_errfinish(m, int32(500532), int32(82), int32(88117))
					mBase = m.M
					v183 = m.ExcPending
					if v183 != 0 {
						return int32(0)
									...
									if v24 != 0 {
										...
										if v46 != 0 {
											...
											if v49 != 0 {
												...
												F_errmsg(m, int32(532988), int32(0))
												mBase = m.M
												v55 = m.ExcPending
												if v55 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(496479), int32(236), int32(83427))
													mBase = m.M
													v62 = m.ExcPending
													if v62 != 0 {
														return int32(0)
		...
		if v9 != 0 {
			...
			if v16 != 0 {
				...
				if v19 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(684301)
					...
					if v24 != 0 {
						...
						F_errfinish(m, int32(495904), int32(1651), int32(245669))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return int32(0)
							...
							if v37 != int32(1) {
								...
								if v141 != 0 {
									...
									if v145 != 0 {
										...
										F_errfinish(m, int32(493845), int32(3645), int32(135840))
										mBase = m.M
										v150 = m.ExcPending
										if v150 != 0 {
											return int32(0)
											...
											if base.Ui32(int32(6)) <= base.Ui32(v76) {
												...
												if v154 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v76
													F_errmsg_internal(m, int32(469255), v9+int32(16))
													mBase = m.M
													v160 = m.ExcPending
													if v160 != 0 {
														return int32(0)
			...
			if v127 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(0)
				...
				if v132 != 0 {
					...
					F_errfinish(m, int32(493845), int32(3628), int32(135840))
					mBase = m.M
					v137 = m.ExcPending
					if v137 != 0 {
						return int32(0)
...
L7:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+52)) = int64(81604378650)
	v33 = F_SPI_prepare(m, int32(561677), int32(2), v10+int32(-12))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+52)) = l0
	v46 = F_DirectFunctionCall1Coll(m, int32(500), int32(0), int32(528765))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L116:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(561677)
	F_errmsg_internal(m, int32(700738), v12)
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L1
...
L117:
	;
	F_errfinish(m, int32(494353), int32(822), int32(220373))
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L1
...
L120:
	;
	F_errfinish(m, int32(494353), int32(836), int32(220373))
	mBase = m.M
	v426 = m.ExcPending
	if v426 != 0 {
		goto L1
...
L123:
	;
	F_errfinish(m, int32(494353), int32(858), int32(220373))
	mBase = m.M
	v439 = m.ExcPending
	if v439 != 0 {
		goto L1
...
L14:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v10)+20)) = uint16(v83)
	v92 = F_cstring_to_text(m, int32(271923))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L1
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v106
	F_appendStringInfo(m, v8+int32(-24), int32(383353), v8+int32(-48))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L1
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v179
	F_appendStringInfo(m, v8+int32(-24), int32(698926), v10)
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L1
		...
		if v18 == int32(1) {
			...
			if v89 != 0 {
				...
				if v93 != 0 {
					...
					F_errfinish(m, int32(494120), int32(4384), int32(128406))
					mBase = m.M
					v98 = m.ExcPending
					if v98 != 0 {
						return int32(0)
...
L13:
	;
	v36 = F_OpenPipeStream(m, int32(507867), int32(230977))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L6
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v16 + int32(224)
	F_errmsg_internal(m, int32(727440), v16+int32(16))
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L6
...
L28:
	;
	F_errfinish(m, int32(494759), int32(885), int32(143074))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L6
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v16 + int32(224)
	F_errmsg_internal(m, int32(727616), v16-int32(-64))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L6
...
L39:
	;
	F_errfinish(m, int32(494759), int32(710), int32(398037))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L6
...
L46:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v16 + int32(224)
	F_errmsg_internal(m, int32(726949), v16+int32(32))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L6
...
L47:
	;
	F_errfinish(m, int32(494759), int32(717), int32(398037))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L6
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v16 + int32(224)
	F_errmsg_internal(m, int32(726901), v16+int32(48))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L6
...
L54:
	;
	F_errfinish(m, int32(494759), int32(722), int32(398037))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L6
...
L105:
	;
	F_errfinish(m, int32(494759), int32(844), int32(143074))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L6
...
L109:
	;
	F_errfinish(m, int32(494759), int32(849), int32(143074))
	mBase = m.M
	v409 = m.ExcPending
	if v409 != 0 {
		goto L6
...
L112:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = int32(507867)
	F_errmsg(m, int32(300091), v16)
	mBase = m.M
	v420 = m.ExcPending
	if v420 != 0 {
		goto L6
...
L113:
	;
	F_errfinish(m, int32(494759), int32(873), int32(143074))
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L6
...
L117:
	;
	F_errmsg(m, int32(424525), int32(0))
	mBase = m.M
	v450 = m.ExcPending
	if v450 != 0 {
		goto L6
...
L118:
	;
	F_errfinish(m, int32(494759), int32(964), int32(143074))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L6
					...
					if v34 != int32(1) {
						...
						if v72 != 0 {
							...
							if v76 != 0 {
								...
								F_errfinish(m, int32(494108), int32(434), int32(111731))
								mBase = m.M
								v81 = m.ExcPending
								if v81 != 0 {
									return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(73876)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(492918), int32(1511), int32(36293))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
			...
			if v16 != 0 {
				...
				if v15 == int32(0) {
					...
					if v22 != 0 {
						...
						F_errfinish(m, int32(495233), int32(293), int32(338891))
						mBase = m.M
						v27 = m.ExcPending
						if v27 != 0 {
							return int32(0)
	...
	if v4 == v2 {
		...
		if v12 != 0 {
			...
			if v9 == int32(0) {
				...
				F_errmsg(m, int32(343146), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(495233), int32(313), int32(386681))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
...
L34:
	;
	F_errsave_finish(m, v15, int32(495370), int32(324), int32(86606))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L10
		...
		if v8 == int32(0) {
			...
			if v17 != 0 {
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(125153)
					F_errmsg(m, int32(683969), v6)
					mBase = m.M
					v25 = m.ExcPending
					if v25 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(498574), int32(730), int32(125153))
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return int32(0)
			...
			if v36 != int32(1) {
						...
						if v82 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v33)+4)) = v85
							...
							if v91 != 0 {
								...
								F_errfinish(m, int32(496078), int32(634), int32(465636))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return int32(0)
				...
				if v69 != 0 {
					...
					F_errmsg_internal(m, int32(364917), int32(0))
					mBase = m.M
					v73 = m.ExcPending
					if v73 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496078), int32(627), int32(465636))
						mBase = m.M
						v78 = m.ExcPending
						if v78 != 0 {
							return int32(0)
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
	v209 = F_pg_snprintf(m, l1, int32(256), int32(471090), v7)
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L105
		...
		if v21 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(213851)
			...
			if v28 != 0 {
				...
				F_errfinish(m, int32(499565), int32(1284), int32(213851))
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return int32(0)
						...
						if v40 == int32(0) {
							...
							if v47 != 0 {
								...
								if v50 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v33)+4)) = int32(241465)
									*(*int32)(unsafe.Add(mBase, uint32(v33))) = int32(378563)
									F_errmsg(m, int32(712543), v33)
									mBase = m.M
									v57 = m.ExcPending
									if v57 != 0 {
										return int32(0)
							...
							if v69 != 0 {
								...
								if v72 != 0 {
									*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v71
									F_appendStringInfo(m, v5+int32(28), int32(489514), v5+int32(16))
									mBase = m.M
									v80 = m.ExcPending
									if v80 != 0 {
										return int32(0)
													...
													if v138 != 0 {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v5)+4)) = v141
														...
														if v145 != 0 {
															...
															F_errfinish(m, int32(495003), int32(929), int32(118590))
															mBase = m.M
															v150 = m.ExcPending
															if v150 != 0 {
																return int32(0)
									...
									F_appendStringInfoString(m, v5+int32(28), int32(489517))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
			...
			if v119 != 0 {
				...
				if v122 != 0 {
					...
					if v126 != 0 {
						...
						F_errfinish(m, int32(495003), int32(906), int32(118590))
						mBase = m.M
						v131 = m.ExcPending
						if v131 != 0 {
							return int32(0)
...
func F_pg_tablespace_location(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(v10-int32(1663)) <= base.Ui32(int32(1)) {
		v16 = F_cstring_to_text(m, int32(757756))
		mBase = m.M
		v19 = m.ExcPending
		if v19 != 0 {
			return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v5)+48)) = int32(489145)
				...
				if v77 != 0 {
					...
					if v79 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v5))) = v5 + int32(1184)
						F_errmsg(m, int32(298021), v5)
						mBase = m.M
						v85 = m.ExcPending
						if v85 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(500213), int32(341), int32(265341))
							mBase = m.M
							v90 = m.ExcPending
							if v90 != 0 {
								return int32(0)
						...
						if v94 != 0 {
							...
							if v96 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v5 + int32(1184)
								F_errmsg(m, int32(297749), v5+int32(16))
								mBase = m.M
								v104 = m.ExcPending
								if v104 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(500213), int32(355), int32(265341))
									mBase = m.M
									v109 = m.ExcPending
									if v109 != 0 {
										return int32(0)
							...
							if v113 != 0 {
								...
								if v116 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v5)+32)) = v5 + int32(1184)
									F_errmsg(m, int32(327990), v5+int32(32))
									mBase = m.M
									v124 = m.ExcPending
									if v124 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(500213), int32(360), int32(265341))
										mBase = m.M
										v129 = m.ExcPending
										if v129 != 0 {
											return int32(0)
...
L4:
	;
	F_get_share_path(m, int32(4516128))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L1
...
L6:
	;
	v159 = F_pstrdup(m, int32(4516128))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
...
L47:
	;
	F_errfinish(m, int32(492687), int32(409), int32(82541))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L1
...
func F_pg_tzset_offset(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v15
	v23 = F_pg_snprintf(m, v8+int32(192), int32(64), int32(432428), v8+int32(48))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		return int32(0)
		...
		if v29 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = base.I32_extend16_s(v37)
			v48 = F_pg_snprintf(m, v34+v33, int32(64)-v34, int32(432427), v8+int32(32))
			mBase = m.M
			v49 = m.ExcPending
			if v49 != 0 {
				return int32(0)
				...
				if v52&int32(65535) == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = base.I32_extend16_s(v52)
					v70 = F_pg_snprintf(m, v59+v58, int32(64)-v59, int32(432427), v8+int32(16))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return int32(0)
