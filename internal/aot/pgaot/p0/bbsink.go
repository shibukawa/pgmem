		...
		if v9 < int32(0) {
			...
			if v16 != 0 {
				...
				if v18 != 0 {
					...
					v21 = *(*int32)(unsafe.Add(mBase, _c_F_bbsink_server_end_archive[0]))
					v25 = *(*int32)(unsafe.Add(mBase, uint32(v21+v19*int32(48))+32))
					*(*int32)(unsafe.Add(mBase, uint32(v5))) = v25
					F_errmsg(m, int32(_a_F_bbsink_server_end_archive_0), v5)
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return
					} else {
						F_errfinish(m, int32(_a_F_bbsink_server_end_archive_1), int32(208), int32(_a_F_bbsink_server_end_archive_2))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return
