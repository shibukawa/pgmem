...
L1:
	...
	v57 = *(*int32)(unsafe.Add(mBase, _consts[519]))
...
L25:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v12)+8)) = v146
	F_errmsg_internal(m, int32(40325), v12)
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L12
...
L26:
	;
	v145 = v116*int32(72) + int32(1687904)
	goto L25
L27:
	;
	goto L28
...
L32:
	;
	F_errfinish(m, int32(523447), int32(908), int32(326545))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L12
...
func F_pgstat_get_kind_info(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(l0-int32(1)) <= base.Ui32(int32(11)) {
		return l0*int32(72) + int32(1687904)
	} else {
...
L14:
	...
	v53 = m.T0[v52].(func(*base.Module, int32, int32, int32, int32, int32, int32) int32)(m, l0, int32(4216528), v45, v45, v45, int32(321))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L16
...
L84:
	;
	F_errfinish(m, int32(525235), int32(335), int32(251579))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L16
...
L88:
	;
	F_errfinish(m, int32(525235), int32(255), int32(276651))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L16
...
L93:
	;
	F_errfinish(m, int32(525235), int32(306), int32(276651))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L16
...
L96:
	;
	v425 = F_pgstat_index(m, l0, int32(7682), l1)
	mBase = m.M
	v426 = m.ExcPending
	if v426 != 0 {
		goto L16
...
L100:
	;
	v393 = F_pgstat_index(m, l0, int32(7681), l1)
	mBase = m.M
	v394 = m.ExcPending
	if v394 != 0 {
		goto L16
...
L107:
	;
	v381 = F_pgstat_index(m, l0, int32(7680), l1)
	mBase = m.M
	v382 = m.ExcPending
	if v382 != 0 {
		goto L16
...
L114:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v405 + int32(4)
	F_errmsg(m, int32(465327), v18+int32(16))
	mBase = m.M
	v416 = m.ExcPending
	if v416 != 0 {
		goto L16
...
L115:
	;
	F_errfinish(m, int32(525235), int32(298), int32(276651))
	mBase = m.M
	v423 = m.ExcPending
	if v423 != 0 {
		goto L16
...
L119:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+32)) = v454 + int32(4)
	F_errmsg(m, int32(458382), v18+int32(32))
	mBase = m.M
	v464 = m.ExcPending
	if v464 != 0 {
		goto L16
...
L120:
	;
	F_errfinish(m, int32(525235), int32(269), int32(276651))
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L16
...
L10:
	;
	v39 = v22*int32(72) + int32(1687904)
	goto L9
L11:
	;
	goto L12
...
L67:
	;
	F_errmsg_internal(m, int32(264371), int32(0))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L16
...
L68:
	;
	F_errfinish(m, int32(523447), int32(667), int32(357436))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L16
...
L70:
	;
	F_errmsg_internal(m, int32(12487), int32(0))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L16
...
L71:
	;
	F_errfinish(m, int32(523447), int32(640), int32(357436))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L16
...
L73:
	;
	F_errmsg_internal(m, int32(532136), int32(0))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L16
...
L74:
	;
	F_errfinish(m, int32(523447), int32(611), int32(357436))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L16
...
func F_pgstat_replslot_to_serialized_name_cb(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v12 = *(*int32)(unsafe.Add(mBase, _consts[541]))
			...
			if v23 == int32(0) {
				...
				if v43 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v8))) = v44
					F_errmsg_internal(m, int32(39659), v8)
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return
					} else {
						F_errfinish(m, int32(518152), int32(198), int32(530587))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return
...
func F_pgstat_request_entry_refs_gc(m *base.Module) {
	...
	var v4 int64
	_ = v4
	v3 = *(*int32)(unsafe.Add(mBase, _consts[451]))
...
func F_pgstat_reset_wait_event_storage(m *base.Module) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _consts[162])) = int32(4545332)
	return
}
func F_pgstat_slru_reset_all_cb(m *base.Module, l0 int64) {
	...
	var v319 int32
	_ = v319
	v5 = *(*int32)(unsafe.Add(mBase, _consts[451]))
	v7 = v5 + int32(52744)
	...
	if v10 != 0 {
		...
		*(*int64)(unsafe.Add(mBase, uint32(v5)+uint32(_consts[707]))) = l0
		...
		if v39 != 0 {
			...
			v41 = *(*int32)(unsafe.Add(mBase, _consts[451]))
			v43 = v41 + int32(52744)
			...
			if v46 != 0 {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+uint32(_consts[715]))) = l0
				...
				if v79 != 0 {
					...
					v81 = *(*int32)(unsafe.Add(mBase, _consts[451]))
					v83 = v81 + int32(52744)
					...
					if v86 != 0 {
						...
						*(*int64)(unsafe.Add(mBase, uint32(v81)+uint32(_consts[723]))) = l0
						...
						if v119 != 0 {
							...
							v121 = *(*int32)(unsafe.Add(mBase, _consts[451]))
							...
							if v126 != 0 {
								...
								*(*int64)(unsafe.Add(mBase, uint32(v121)+uint32(_consts[731]))) = l0
								...
								if v159 != 0 {
									...
									v161 = *(*int32)(unsafe.Add(mBase, _consts[451]))
									...
									if v166 != 0 {
										...
										*(*int64)(unsafe.Add(mBase, uint32(v161)+uint32(_consts[739]))) = l0
										...
										if v199 != 0 {
											...
											v201 = *(*int32)(unsafe.Add(mBase, _consts[451]))
											...
											if v206 != 0 {
												...
												*(*int64)(unsafe.Add(mBase, uint32(v201)+uint32(_consts[747]))) = l0
												...
												if v239 != 0 {
													...
													v241 = *(*int32)(unsafe.Add(mBase, _consts[451]))
													...
													if v246 != 0 {
														...
														*(*int64)(unsafe.Add(mBase, uint32(v241)+uint32(_consts[755]))) = l0
														...
														if v279 != 0 {
															...
															v281 = *(*int32)(unsafe.Add(mBase, _consts[451]))
