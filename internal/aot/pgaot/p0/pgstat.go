...
L32:
	;
	F_errfinish(m, int32(496557), int32(908), int32(310295))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L12
...
L67:
	;
	F_errmsg_internal(m, int32(250599), int32(0))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L16
...
L68:
	;
	F_errfinish(m, int32(496557), int32(667), int32(338828))
	mBase = m.M
	v323 = m.ExcPending
	if v323 != 0 {
		goto L16
...
L71:
	;
	F_errfinish(m, int32(496557), int32(640), int32(338828))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L16
...
L73:
	;
	F_errmsg_internal(m, int32(504247), int32(0))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L16
...
L74:
	;
	F_errfinish(m, int32(496557), int32(611), int32(338828))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L16
				...
				if v43 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v8))) = v44
					...
					if v48 != 0 {
						...
						F_errfinish(m, int32(492445), int32(198), int32(502878))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return
...
func F_pgstat_reset_wait_event_storage(m *base.Module) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _consts[165])) = int32(4472676)
	return
}
