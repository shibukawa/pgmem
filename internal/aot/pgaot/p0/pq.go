...
func F_pq_buffer_remaining_data(m *base.Module) int32 {
	...
	var v4 int32
	_ = v4
	v2 = *(*int32)(unsafe.Add(mBase, _c_F_pq_buffer_remaining_data[0]))
	v4 = *(*int32)(unsafe.Add(mBase, _c_F_pq_buffer_remaining_data[1]))
	return v2 - v4
}
func F_pq_endmessage(m *base.Module, l0 int32) {
	...
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_pq_endmessage[0]))
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_pq_getbyte[0])) = v4 + int32(1)
	v22 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v4)+uint32(_c_F_pq_getbyte[1]))))
	return v22
L2:
	;
	v4 = *(*int32)(unsafe.Add(mBase, _c_F_pq_getbyte[0]))
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_pq_getbyte[2]))
	if v4 < v6 {
		goto L1
	} else {
		goto L4
	...
	if v2 != v3 {
		...
		if v8 != 0 {
			...
			if v11 != 0 {
				...
				F_errmsg(m, int32(_a_F_pq_getmsgend_0), int32(0))
				mBase = m.M
				v15 = m.ExcPending
				if v15 != 0 {
					return
				} else {
					F_errfinish(m, int32(_a_F_pq_getmsgend_1), int32(640), int32(_a_F_pq_getmsgend_2))
					mBase = m.M
					v20 = m.ExcPending
					if v20 != 0 {
						return
	...
	if v9 <= v8 {
		...
		if v16 != 0 {
			...
			if v19 != 0 {
				...
				F_errmsg(m, int32(_a_F_pq_getmsgrawstring_0), int32(0))
				mBase = m.M
				v23 = m.ExcPending
				if v23 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_pq_getmsgrawstring_1), int32(624), int32(_a_F_pq_getmsgrawstring_2))
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
...
func F_pq_set_parallel_leader(m *base.Module, l0 int32, l1 int32) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _c_F_pq_set_parallel_leader[0])) = l1
	*(*int32)(unsafe.Add(mBase, _c_F_pq_set_parallel_leader[1])) = l0
	return
}
