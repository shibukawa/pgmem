...
func F_pg_encoding_mblen(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(41)) {
		v11 = *(*int32)(unsafe.Add(mBase, uint32(l0*int32(28))+uint32(_c_F_pg_encoding_mblen[0])))
...
func F_pg_encoding_to_char_private(m *base.Module, l0 int32) int32 {
	...
	_ = v11
	if base.Ui32(l0) <= base.Ui32(int32(41)) {
		v10 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(3))%32))+uint32(_c_F_pg_encoding_to_char_private[0])))
		v11 = v10
	} else {
		v11 = int32(_a_F_pg_encoding_to_char_private_0)
	}
	return v11
}
