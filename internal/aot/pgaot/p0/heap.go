...
L79:
	;
	v368 = F_CreateTupleDesc(m, int32(6), int32(744480))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L1
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = v515
	F_errmsg_internal(m, int32(479567), v29)
	mBase = m.M
	v519 = m.ExcPending
	if v519 != 0 {
		goto L1
...
L121:
	;
	F_errfinish(m, int32(491063), int32(2346), int32(119247))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+32)) = l0
	F_errmsg(m, int32(115592), v29+int32(32))
	mBase = m.M
	v619 = m.ExcPending
	if v619 != 0 {
		goto L1
...
L140:
	;
	F_errfinish(m, int32(491063), int32(1179), int32(324118))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L1
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = l0
	F_errmsg(m, int32(115869), v29+int32(16))
	mBase = m.M
	v637 = m.ExcPending
	if v637 != 0 {
		goto L1
...
L144:
	;
	F_errhint(m, int32(613043), int32(0))
	mBase = m.M
	v641 = m.ExcPending
	if v641 != 0 {
		goto L1
...
L145:
	;
	F_errfinish(m, int32(491063), int32(1198), int32(324118))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L1
...
L148:
	;
	F_errfinish(m, int32(491063), int32(1205), int32(324118))
	mBase = m.M
	v659 = m.ExcPending
	if v659 != 0 {
		goto L1
...
L151:
	;
	F_errmsg(m, int32(408584), int32(0))
	mBase = m.M
	v670 = m.ExcPending
	if v670 != 0 {
		goto L1
...
L152:
	;
	F_errfinish(m, int32(491063), int32(1236), int32(324118))
	mBase = m.M
	v675 = m.ExcPending
	if v675 != 0 {
		goto L1
...
L155:
	;
	F_errmsg(m, int32(408899), int32(0))
	mBase = m.M
	v686 = m.ExcPending
	if v686 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(491063), int32(1247), int32(324118))
	mBase = m.M
	v691 = m.ExcPending
	if v691 != 0 {
		goto L1
...
L159:
	;
	F_errmsg(m, int32(408651), int32(0))
	mBase = m.M
	v702 = m.ExcPending
	if v702 != 0 {
		goto L1
...
L160:
	;
	F_errfinish(m, int32(491063), int32(1257), int32(324118))
	mBase = m.M
	v707 = m.ExcPending
	if v707 != 0 {
		goto L1
...
func F_heap_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v26
		F_appendStringInfo(m, l0, int32(725128), v8+int32(32))
		mBase = m.M
		v34 = m.ExcPending
		if v34 != 0 {
			return
			...
			F_infobits_desc(m, l0, v35, int32(122698))
			mBase = m.M
			v38 = m.ExcPending
			if v38 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v39
				F_appendStringInfo(m, l0, int32(505200), v8+int32(16))
				mBase = m.M
				v45 = m.ExcPending
				if v45 != 0 {
					return
	...
	case 1:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v46
		F_appendStringInfo(m, l0, int32(725100), v8-int32(-64))
		mBase = m.M
		v54 = m.ExcPending
		if v54 != 0 {
			return
			...
			F_infobits_desc(m, l0, v55, int32(122694))
			mBase = m.M
			v58 = m.ExcPending
			if v58 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v59
				F_appendStringInfo(m, l0, int32(58218), v8+int32(48))
				mBase = m.M
				v69 = m.ExcPending
				if v69 != 0 {
					return
	...
	case 2:
		...
		F_appendStringInfoString(m, l0, int32(502588))
		mBase = m.M
		v97 = m.ExcPending
		if v97 != 0 {
			return
			...
			if v94&int32(1) != 0 {
				F_appendStringInfoString(m, l0, int32(725212))
				mBase = m.M
				v102 = m.ExcPending
				if v102 != 0 {
					return
					...
					if v94&int32(2) != 0 {
						F_appendStringInfoString(m, l0, int32(725160))
						mBase = m.M
						v107 = m.ExcPending
						if v107 != 0 {
							return
							...
							if v125 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+112)) = v126
								F_appendStringInfo(m, l0, int32(57663), v8+int32(112))
								mBase = m.M
								v132 = m.ExcPending
								if v132 != 0 {
									return
								} else {
									F_appendStringInfoString(m, l0, int32(541940))
									mBase = m.M
									v135 = m.ExcPending
									if v135 != 0 {
										return
	...
	case 3:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+96)) = v70
		F_appendStringInfo(m, l0, int32(725100), v8+int32(96))
		mBase = m.M
		v78 = m.ExcPending
		if v78 != 0 {
			return
			...
			F_infobits_desc(m, l0, v79, int32(122694))
			mBase = m.M
			v82 = m.ExcPending
			if v82 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+80)) = v83
				F_appendStringInfo(m, l0, int32(58218), v8+int32(80))
				mBase = m.M
				v93 = m.ExcPending
				if v93 != 0 {
					return
	...
	case 4:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+128)) = v144
		F_appendStringInfo(m, l0, int32(58253), v8+int32(128))
		mBase = m.M
		v150 = m.ExcPending
		if v150 != 0 {
			return
	...
	case 5:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+160)) = v151
		F_appendStringInfo(m, l0, int32(725128), v8+int32(160))
		mBase = m.M
		v159 = m.ExcPending
		if v159 != 0 {
			return
			...
			F_infobits_desc(m, l0, v160, int32(122698))
			mBase = m.M
			v163 = m.ExcPending
			if v163 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+144)) = v164
				F_appendStringInfo(m, l0, int32(505200), v8+int32(144))
				mBase = m.M
				v170 = m.ExcPending
				if v170 != 0 {
					return
	...
	case 6:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+176)) = v171
		F_appendStringInfo(m, l0, int32(58253), v8+int32(176))
		mBase = m.M
		v177 = m.ExcPending
		if v177 != 0 {
			return
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = v19
		F_appendStringInfo(m, l0, int32(505166), v8)
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return
...
L28:
	;
	v119 = F_systable_beginscan_ordered(m, l0, v82, int32(4147752), v77, v21+int32(112))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L29:
	;
	F_errmsg_internal(m, int32(86190), int32(0))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L1
...
L30:
	;
	F_errfinish(m, int32(489067), int32(653), int32(85806))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+100)) = v368 + int32(4)
	F_errmsg_internal(m, int32(183258), v21+int32(96))
	mBase = m.M
	v377 = m.ExcPending
	if v377 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(487838), int32(729), int32(414013))
	mBase = m.M
	v382 = m.ExcPending
	if v382 != 0 {
		goto L1
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v390
	F_errmsg_internal(m, int32(183440), v21+int32(16))
	mBase = m.M
	v420 = m.ExcPending
	if v420 != 0 {
		goto L1
...
L102:
	;
	F_errfinish(m, int32(487838), int32(749), int32(414013))
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L1
...
L105:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+8)) = v433 + int32(4)
	F_errmsg_internal(m, int32(183309), v21)
	mBase = m.M
	v441 = m.ExcPending
	if v441 != 0 {
		goto L1
...
L106:
	;
	F_errfinish(m, int32(487838), int32(786), int32(414013))
	mBase = m.M
	v446 = m.ExcPending
	if v446 != 0 {
		goto L1
...
L109:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+48)) = v451
	F_errmsg_internal(m, int32(183358), v21+int32(48))
	mBase = m.M
	v489 = m.ExcPending
	if v489 != 0 {
		goto L1
...
L110:
	;
	F_errfinish(m, int32(487838), int32(758), int32(414013))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L1
...
L113:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+92)) = v520 + int32(4)
	F_errmsg_internal(m, int32(183514), v21+int32(80))
	mBase = m.M
	v531 = m.ExcPending
	if v531 != 0 {
		goto L1
...
L114:
	;
	F_errfinish(m, int32(487838), int32(742), int32(414013))
	mBase = m.M
	v536 = m.ExcPending
	if v536 != 0 {
		goto L1
...
L39:
	;
	F_errfinish(m, int32(493906), int32(1134), int32(379865))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L12
	...
	if v6 == int32(737428) {
		...
		if v10 != 0 {
			...
			if v12&int32(1) == int32(0) {
				...
				if v74 != 0 {
					...
					F_errmsg_internal(m, int32(332851), int32(0))
					mBase = m.M
					v78 = m.ExcPending
					if v78 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(492250), int32(1362), int32(63102))
						mBase = m.M
						v83 = m.ExcPending
						if v83 != 0 {
							return int32(0)
		...
		if v58 != 0 {
			...
			if v61 != 0 {
				...
				F_errmsg_internal(m, int32(439656), int32(0))
				mBase = m.M
				v65 = m.ExcPending
				if v65 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(492250), int32(1352), int32(63102))
					mBase = m.M
					v70 = m.ExcPending
					if v70 != 0 {
						return int32(0)
...
func F_heap_reloptions(m *base.Module, l0 int32, l1 int32) {
	...
	case 0, 5:
		v20 = int32(1)
		v25 = F_build_reloptions(m, l1, v20, v20, int32(128), int32(736544), int32(24))
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
	...
	default:
		return
	case 7:
		v10 = F_build_reloptions(m, l1, int32(1), int32(2), int32(128), int32(736544), int32(24))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return
		...
		if v26 != 0 {
			...
			if v25 != 0 {
				...
				if v32 != 0 {
					...
					if l3 == int32(116) {
						v37 = F_LookupCreationNamespace(m, int32(233532))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = l0
							v51 = F_pg_snprintf(m, v17+int32(48), int32(64), int32(38273), v17+int32(32))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
													...
													if v85 == int32(0) {
														...
														if v136 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v83
															F_errmsg_internal(m, int32(46032), v17+int32(16))
															mBase = m.M
															v142 = m.ExcPending
															if v142 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(490230), int32(806), int32(236652))
																mBase = m.M
																v147 = m.ExcPending
																if v147 != 0 {
																	return int32(0)
				...
				if v123 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v17))) = l0
					F_errmsg_internal(m, int32(46032), v17)
					mBase = m.M
					v127 = m.ExcPending
					if v127 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(490230), int32(733), int32(236652))
						mBase = m.M
						v132 = m.ExcPending
						if v132 != 0 {
							return int32(0)
