...
L79:
	;
	v368 = F_CreateTupleDesc(m, int32(6), int32(798208))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L1
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = v515
	F_errmsg_internal(m, int32(506121), v29)
	mBase = m.M
	v519 = m.ExcPending
	if v519 != 0 {
		goto L1
...
L121:
	;
	F_errfinish(m, int32(519147), int32(2346), int32(128063))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
...
L140:
	;
	F_errfinish(m, int32(519147), int32(1179), int32(343256))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L1
...
L144:
	;
	F_errhint(m, int32(661167), int32(0))
	mBase = m.M
	v641 = m.ExcPending
	if v641 != 0 {
		goto L1
...
L145:
	;
	F_errfinish(m, int32(519147), int32(1198), int32(343256))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L1
...
L148:
	;
	F_errfinish(m, int32(519147), int32(1205), int32(343256))
	mBase = m.M
	v659 = m.ExcPending
	if v659 != 0 {
		goto L1
...
L151:
	;
	F_errmsg(m, int32(431768), int32(0))
	mBase = m.M
	v670 = m.ExcPending
	if v670 != 0 {
		goto L1
...
L152:
	;
	F_errfinish(m, int32(519147), int32(1236), int32(343256))
	mBase = m.M
	v675 = m.ExcPending
	if v675 != 0 {
		goto L1
...
L155:
	;
	F_errmsg(m, int32(432083), int32(0))
	mBase = m.M
	v686 = m.ExcPending
	if v686 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(519147), int32(1247), int32(343256))
	mBase = m.M
	v691 = m.ExcPending
	if v691 != 0 {
		goto L1
...
L159:
	;
	F_errmsg(m, int32(431835), int32(0))
	mBase = m.M
	v702 = m.ExcPending
	if v702 != 0 {
		goto L1
...
L160:
	;
	F_errfinish(m, int32(519147), int32(1257), int32(343256))
	mBase = m.M
	v707 = m.ExcPending
	if v707 != 0 {
		goto L1
...
func F_heap_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v26
		F_appendStringInfo(m, l0, int32(778822), v8+int32(32))
		mBase = m.M
		v34 = m.ExcPending
		if v34 != 0 {
			return
			...
			if v38 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v39
				F_appendStringInfo(m, l0, int32(535093), v8+int32(16))
				mBase = m.M
				v45 = m.ExcPending
				if v45 != 0 {
					return
	...
	case 1:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v46
		F_appendStringInfo(m, l0, int32(778794), v8-int32(-64))
		mBase = m.M
		v54 = m.ExcPending
		if v54 != 0 {
			return
	...
	case 2:
		...
		F_appendStringInfoString(m, l0, int32(532428))
		mBase = m.M
		v97 = m.ExcPending
		if v97 != 0 {
			return
			...
			if v94&int32(1) != 0 {
				F_appendStringInfoString(m, l0, int32(778906))
				mBase = m.M
				v102 = m.ExcPending
				if v102 != 0 {
					return
					...
					if v94&int32(2) != 0 {
						F_appendStringInfoString(m, l0, int32(778854))
						mBase = m.M
						v107 = m.ExcPending
						if v107 != 0 {
							return
							...
							if v125 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+112)) = v126
								...
								if v132 != 0 {
									...
									F_appendStringInfoString(m, l0, int32(572612))
									mBase = m.M
									v135 = m.ExcPending
									if v135 != 0 {
										return
	...
	case 3:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+96)) = v70
		F_appendStringInfo(m, l0, int32(778794), v8+int32(96))
		mBase = m.M
		v78 = m.ExcPending
		if v78 != 0 {
			return
	...
	case 5:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+160)) = v151
		F_appendStringInfo(m, l0, int32(778822), v8+int32(160))
		mBase = m.M
		v159 = m.ExcPending
		if v159 != 0 {
			return
			...
			if v163 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+144)) = v164
				F_appendStringInfo(m, l0, int32(535093), v8+int32(144))
				mBase = m.M
				v170 = m.ExcPending
				if v170 != 0 {
					return
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = v19
		F_appendStringInfo(m, l0, int32(535059), v8)
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return
...
L78:
	;
	F_errfinish(m, int32(514953), int32(729), int32(437785))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L82:
	;
	F_errfinish(m, int32(514953), int32(749), int32(437785))
	mBase = m.M
	v344 = m.ExcPending
	if v344 != 0 {
		goto L1
...
L86:
	;
	F_errfinish(m, int32(514953), int32(786), int32(437785))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L1
...
L90:
	;
	F_errfinish(m, int32(514953), int32(758), int32(437785))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L1
...
L94:
	;
	F_errfinish(m, int32(514953), int32(742), int32(437785))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L1
...
L39:
	;
	F_errfinish(m, int32(522512), int32(1134), int32(401336))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L12
	...
	if v6 == int32(791156) {
		...
		if v10 != 0 {
			...
			if v12&int32(1) == int32(0) {
				...
				if v74 != 0 {
					...
					F_errmsg_internal(m, int32(352304), int32(0))
					mBase = m.M
					v78 = m.ExcPending
					if v78 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(520790), int32(1362), int32(69241))
						mBase = m.M
						v83 = m.ExcPending
						if v83 != 0 {
							return int32(0)
		...
		if v58 != 0 {
			...
			if v61 != 0 {
				...
				F_errmsg_internal(m, int32(464306), int32(0))
				mBase = m.M
				v65 = m.ExcPending
				if v65 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(520790), int32(1352), int32(69241))
					mBase = m.M
					v70 = m.ExcPending
					if v70 != 0 {
						return int32(0)
...
func F_heap_reloptions(m *base.Module, l0 int32, l1 int32) {
	...
	case 0, 5:
		v20 = int32(1)
		v25 = F_build_reloptions(m, l1, v20, v20, int32(128), int32(790272), int32(24))
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
	...
	default:
		return
	case 7:
		v10 = F_build_reloptions(m, l1, int32(1), int32(2), int32(128), int32(790272), int32(24))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return
														...
														if v136 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v83
															...
															if v142 != 0 {
																...
																F_errfinish(m, int32(518284), int32(806), int32(250442))
																mBase = m.M
																v147 = m.ExcPending
																if v147 != 0 {
																	return int32(0)
				...
				if v123 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v17))) = l0
					...
					if v127 != 0 {
						...
						F_errfinish(m, int32(518284), int32(733), int32(250442))
						mBase = m.M
						v132 = m.ExcPending
						if v132 != 0 {
							return int32(0)
