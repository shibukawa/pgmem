...
L24:
	;
	v58 = int32(*(*uint8)(unsafe.Add(mBase, _consts[197])))
	if v58 != int32(1) {
		goto L25
	} else {
		goto L26
...
L29:
	;
	v78 = *(*int32)(unsafe.Add(mBase, _consts[199]))
	if v78 == int32(0) {
		goto L5
	} else {
		goto L32
...
L30:
	;
	v68 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[198])) = v68
	v71 = *(*int32)(unsafe.Add(mBase, _consts[200]))
	if v71 == v68 {
		goto L6
	} else {
		goto L31
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, _consts[200])) = int32(0)
	v104 = v64
	v105 = v71
	goto L23
L32:
	;
	*(*int32)(unsafe.Add(mBase, _consts[199])) = int32(0)
	v85 = l10 - int32(83)
...
L34:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[201]))
	if v95 == int32(0) {
		goto L4
	} else {
		goto L35
...
L35:
	;
	*(*int32)(unsafe.Add(mBase, _consts[201])) = int32(0)
	v104 = v78
	v105 = v95
	goto L23
L36:
...
L79:
	;
	v368 = F_CreateTupleDesc(m, int32(6), int32(798144))
	mBase = m.M
	v369 = m.ExcPending
	if v369 != 0 {
		goto L1
...
L84:
	;
	v382 = *(*int32)(unsafe.Add(mBase, _consts[202]))
	if v382 == int32(0) {
		goto L85
	} else {
		goto L86
...
L85:
	;
	v447 = *(*int32)(unsafe.Add(mBase, _consts[203]))
	if v447 != 0 {
		goto L105
	} else {
		goto L106
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = v515
	F_errmsg_internal(m, int32(506069), v29)
	mBase = m.M
	v519 = m.ExcPending
	if v519 != 0 {
		goto L1
...
L121:
	;
	F_errfinish(m, int32(519077), int32(2346), int32(128063))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
...
L130:
	...
	v573 = *(*int32)(unsafe.Add(mBase, _consts[204]))
...
L134:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v576)+8)) = v582
	v587 = *(*int32)(unsafe.Add(mBase, _consts[205]))
...
L135:
	...
	*(*int32)(unsafe.Add(mBase, _consts[205])) = v588
	goto L132
L136:
	;
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+32)) = l0
	F_errmsg(m, int32(124330), v29+int32(32))
	mBase = m.M
	v619 = m.ExcPending
	if v619 != 0 {
		goto L1
...
L140:
	;
	F_errfinish(m, int32(519077), int32(1179), int32(343226))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L1
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = l0
	F_errmsg(m, int32(124607), v29+int32(16))
	mBase = m.M
	v637 = m.ExcPending
	if v637 != 0 {
		goto L1
...
L144:
	;
	F_errhint(m, int32(661097), int32(0))
	mBase = m.M
	v641 = m.ExcPending
	if v641 != 0 {
		goto L1
...
L145:
	;
	F_errfinish(m, int32(519077), int32(1198), int32(343226))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L1
...
L148:
	;
	F_errfinish(m, int32(519077), int32(1205), int32(343226))
	mBase = m.M
	v659 = m.ExcPending
	if v659 != 0 {
		goto L1
...
L151:
	;
	F_errmsg(m, int32(431738), int32(0))
	mBase = m.M
	v670 = m.ExcPending
	if v670 != 0 {
		goto L1
...
L152:
	;
	F_errfinish(m, int32(519077), int32(1236), int32(343226))
	mBase = m.M
	v675 = m.ExcPending
	if v675 != 0 {
		goto L1
...
L155:
	;
	F_errmsg(m, int32(432053), int32(0))
	mBase = m.M
	v686 = m.ExcPending
	if v686 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(519077), int32(1247), int32(343226))
	mBase = m.M
	v691 = m.ExcPending
	if v691 != 0 {
		goto L1
...
L159:
	;
	F_errmsg(m, int32(431805), int32(0))
	mBase = m.M
	v702 = m.ExcPending
	if v702 != 0 {
		goto L1
...
L160:
	;
	F_errfinish(m, int32(519077), int32(1257), int32(343226))
	mBase = m.M
	v707 = m.ExcPending
	if v707 != 0 {
		goto L1
...
func F_heap_desc(m *base.Module, l0 int32, l1 int32) {
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v26
		F_appendStringInfo(m, l0, int32(778752), v8+int32(32))
		mBase = m.M
		v34 = m.ExcPending
		if v34 != 0 {
			return
			...
			F_infobits_desc(m, l0, v35, int32(131714))
			mBase = m.M
			v38 = m.ExcPending
			if v38 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v39
				F_appendStringInfo(m, l0, int32(535023), v8+int32(16))
				mBase = m.M
				v45 = m.ExcPending
				if v45 != 0 {
					return
	...
	case 1:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v46
		F_appendStringInfo(m, l0, int32(778724), v8-int32(-64))
		mBase = m.M
		v54 = m.ExcPending
		if v54 != 0 {
			return
			...
			F_infobits_desc(m, l0, v55, int32(131710))
			mBase = m.M
			v58 = m.ExcPending
			if v58 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v59
				F_appendStringInfo(m, l0, int32(63859), v8+int32(48))
				mBase = m.M
				v69 = m.ExcPending
				if v69 != 0 {
					return
	...
	case 2:
		...
		F_appendStringInfoString(m, l0, int32(532358))
		mBase = m.M
		v97 = m.ExcPending
		if v97 != 0 {
			return
			...
			if v94&int32(1) != 0 {
				F_appendStringInfoString(m, l0, int32(778836))
				mBase = m.M
				v102 = m.ExcPending
				if v102 != 0 {
					return
					...
					if v94&int32(2) != 0 {
						F_appendStringInfoString(m, l0, int32(778784))
						mBase = m.M
						v107 = m.ExcPending
						if v107 != 0 {
							return
							...
							if v125 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+112)) = v126
								F_appendStringInfo(m, l0, int32(63212), v8+int32(112))
								mBase = m.M
								v132 = m.ExcPending
								if v132 != 0 {
									return
								} else {
									F_appendStringInfoString(m, l0, int32(572542))
									mBase = m.M
									v135 = m.ExcPending
									if v135 != 0 {
										return
	...
	case 3:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+96)) = v70
		F_appendStringInfo(m, l0, int32(778724), v8+int32(96))
		mBase = m.M
		v78 = m.ExcPending
		if v78 != 0 {
			return
			...
			F_infobits_desc(m, l0, v79, int32(131710))
			mBase = m.M
			v82 = m.ExcPending
			if v82 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+80)) = v83
				F_appendStringInfo(m, l0, int32(63859), v8+int32(80))
				mBase = m.M
				v93 = m.ExcPending
				if v93 != 0 {
					return
	...
	case 4:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+128)) = v144
		F_appendStringInfo(m, l0, int32(63894), v8+int32(128))
		mBase = m.M
		v150 = m.ExcPending
		if v150 != 0 {
			return
	...
	case 5:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+160)) = v151
		F_appendStringInfo(m, l0, int32(778752), v8+int32(160))
		mBase = m.M
		v159 = m.ExcPending
		if v159 != 0 {
			return
			...
			F_infobits_desc(m, l0, v160, int32(131714))
			mBase = m.M
			v163 = m.ExcPending
			if v163 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+144)) = v164
				F_appendStringInfo(m, l0, int32(535023), v8+int32(144))
				mBase = m.M
				v170 = m.ExcPending
				if v170 != 0 {
					return
	...
	case 6:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8)+176)) = v171
		F_appendStringInfo(m, l0, int32(63894), v8+int32(176))
		mBase = m.M
		v177 = m.ExcPending
		if v177 != 0 {
			return
	...
	default:
		...
		*(*int32)(unsafe.Add(mBase, uint32(v8))) = v19
		F_appendStringInfo(m, l0, int32(534989), v8)
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+100)) = v287 + int32(4)
	F_errmsg_internal(m, int32(195036), v21+int32(96))
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L1
...
L78:
	;
	F_errfinish(m, int32(514901), int32(729), int32(437755))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = v309
	F_errmsg_internal(m, int32(195218), v21+int32(16))
	mBase = m.M
	v339 = m.ExcPending
	if v339 != 0 {
		goto L1
...
L82:
	;
	F_errfinish(m, int32(514901), int32(749), int32(437755))
	mBase = m.M
	v344 = m.ExcPending
	if v344 != 0 {
		goto L1
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+8)) = v352 + int32(4)
	F_errmsg_internal(m, int32(195087), v21)
	mBase = m.M
	v360 = m.ExcPending
	if v360 != 0 {
		goto L1
...
L86:
	;
	F_errfinish(m, int32(514901), int32(786), int32(437755))
	mBase = m.M
	v365 = m.ExcPending
	if v365 != 0 {
		goto L1
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+48)) = v370
	F_errmsg_internal(m, int32(195136), v21+int32(48))
	mBase = m.M
	v408 = m.ExcPending
	if v408 != 0 {
		goto L1
...
L90:
	;
	F_errfinish(m, int32(514901), int32(758), int32(437755))
	mBase = m.M
	v413 = m.ExcPending
	if v413 != 0 {
		goto L1
...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+92)) = v439 + int32(4)
	F_errmsg_internal(m, int32(195292), v21+int32(80))
	mBase = m.M
	v450 = m.ExcPending
	if v450 != 0 {
		goto L1
...
L94:
	;
	F_errfinish(m, int32(514901), int32(742), int32(437755))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L1
...
L39:
	;
	F_errfinish(m, int32(522442), int32(1134), int32(401306))
	mBase = m.M
	v193 = m.ExcPending
	if v193 != 0 {
		goto L12
	...
	if v6 == int32(791092) {
		...
		if v10 != 0 {
			...
			if v12&int32(1) == int32(0) {
				...
				if v74 != 0 {
					...
					F_errmsg_internal(m, int32(352274), int32(0))
					mBase = m.M
					v78 = m.ExcPending
					if v78 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(520720), int32(1362), int32(69241))
						mBase = m.M
						v83 = m.ExcPending
						if v83 != 0 {
							return int32(0)
		...
		if v58 != 0 {
			...
			if v61 != 0 {
				...
				F_errmsg_internal(m, int32(464254), int32(0))
				mBase = m.M
				v65 = m.ExcPending
				if v65 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(520720), int32(1352), int32(69241))
					mBase = m.M
					v70 = m.ExcPending
					if v70 != 0 {
						return int32(0)
...
func F_heap_reloptions(m *base.Module, l0 int32, l1 int32) {
	...
	case 0, 5:
		v20 = int32(1)
		v25 = F_build_reloptions(m, l1, v20, v20, int32(128), int32(790208), int32(24))
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
	...
	default:
		return
	case 7:
		v10 = F_build_reloptions(m, l1, int32(1), int32(2), int32(128), int32(790208), int32(24))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return
		...
		if v26 != 0 {
			...
			if v25 != 0 {
				...
				if v32 != 0 {
					...
					if l3 == int32(116) {
						v37 = F_LookupCreationNamespace(m, int32(247034))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = l0
							v51 = F_pg_snprintf(m, v17+int32(48), int32(64), int32(40076), v17+int32(32))
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return int32(0)
													...
													if v85 == int32(0) {
														...
														if v136 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v83
															F_errmsg_internal(m, int32(49952), v17+int32(16))
															mBase = m.M
															v142 = m.ExcPending
															if v142 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(518232), int32(806), int32(250412))
																mBase = m.M
																v147 = m.ExcPending
																if v147 != 0 {
																	return int32(0)
				...
				if v123 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v17))) = l0
					F_errmsg_internal(m, int32(49952), v17)
					mBase = m.M
					v127 = m.ExcPending
					if v127 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(518232), int32(733), int32(250412))
						mBase = m.M
						v132 = m.ExcPending
						if v132 != 0 {
							return int32(0)
