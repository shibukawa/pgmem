...
func F_deconstruct_expanded_array(m *base.Module, l0 int32) {
	...
	if v15 == int32(0) {
		v18 = int32(_a_F_deconstruct_expanded_array_0)
		v19 = *(*int32)(unsafe.Add(mBase, _c_F_deconstruct_expanded_array[0]))
		v21 = *(*int32)(unsafe.Add(mBase, uint32(l0)+8))
		*(*int32)(unsafe.Add(mBase, _c_F_deconstruct_expanded_array[0])) = v21
		v23 = int32(0)
		*(*int32)(unsafe.Add(mBase, uint32(v13)+8)) = v23
		...
		if v40 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _c_F_deconstruct_expanded_array[0])) = v19
			m.G0 = v13 + int32(16)
			return
		}
	} else {
			...
			if v19 == int32(0) {
				...
				if v35 != 0 {
					...
					if v42 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v46)+4)) = int32(_a_F_make_expanded_record_from_tupdesc_6)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v46)+40)) = v73
						...
						if int32(0) <= v76 {
							*(*int32)(unsafe.Add(mBase, uint32(v46)+108)) = int32(1311)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v27)+12)) = v91 + int32(1)
							...
							v95 = int32(_a_F_make_expanded_record_from_tupdesc_7)
							v96 = *(*int32)(unsafe.Add(mBase, _c_F_make_expanded_record_from_tupdesc[0]))
							*(*int32)(unsafe.Add(mBase, _c_F_make_expanded_record_from_tupdesc[0])) = v34
							...
							if v100 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, _c_F_make_expanded_record_from_tupdesc[0])) = v96
								m.G0 = v9 + int32(16)
								return v46
							}
						}
