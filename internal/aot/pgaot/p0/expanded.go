	...
	if v11 != int32(2249) {
		...
		if v18 != 0 {
			...
			if v19 == int32(0) {
					...
					if v119 != 0 {
						...
						if v122 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v121
							F_errmsg(m, int32(366914), v9)
							mBase = m.M
							v126 = m.ExcPending
							if v126 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(524607), int32(232), int32(511349))
								mBase = m.M
								v131 = m.ExcPending
								if v131 != 0 {
									return int32(0)
				...
				v27 = v19
				v29 = v22
				v34 = F_AllocSetContextCreateInternal(m, l1, int32(442002), int32(0), int32(8192), int32(8388608))
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return int32(0)
					...
					if v42 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v46)+4)) = int32(1698416)
