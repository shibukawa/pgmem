...
L17:
	;
	v44 = F_getenv(m, v14*int32(12)+int32(4097008))
	mBase = m.M
	if v44 != 0 {
		goto L19
	} else {
...
L37:
	;
	v83 = F_strcmp(m, v81, int32(556070))
	mBase = m.M
	if v83 == int32(0) {
		v88 = v81
		goto L36
...
L43:
	;
	v87 = F_strcmp(m, v81, int32(509771))
	mBase = m.M
	if v87 != 0 {
		goto L35
	} else {
...
L64:
	;
	if base.B2i32(l2 != int32(0))&base.B2i32(l2 != int32(4096952))&base.B2i32(l2 != int32(4096976))&base.B2i32(l2 != int32(4680036))&base.B2i32(l2 != int32(4680060)) == int32(0) {
		goto L65
	} else {
		goto L66
	}
...
L116:
	;
	v335 = F_getenv(m, v316*int32(12)+int32(4097008))
	mBase = m.M
	if v335 != 0 {
		goto L118
	} else {
...
L136:
	;
	v374 = F_strcmp(m, v372, int32(556070))
	mBase = m.M
	if v374 == int32(0) {
		v379 = v372
		goto L135
...
L142:
	;
	v378 = F_strcmp(m, v372, int32(509771))
	mBase = m.M
	if v378 != 0 {
		goto L134
	} else {
