...
L14:
	;
	v38 = F_getenv(m, int32(_a_F___newlocale_1))
	mBase = m.M
	if v38 != 0 {
		goto L15
	} else {
...
L17:
	;
	v44 = F_getenv(m, v14*int32(12)+int32(_a_F___newlocale_2))
	mBase = m.M
	if v44 != 0 {
		goto L19
	} else {
...
L21:
	;
	v47 = F_getenv(m, int32(_a_F___newlocale_3))
	mBase = m.M
	if v47 != 0 {
		goto L23
	} else {
...
L35:
	;
	v98 = *(*int32)(unsafe.Add(mBase, _c_F___newlocale[0]))
	if v98 != 0 {
		goto L49
	} else {
		goto L50
...
L37:
	;
	v83 = F_strcmp(m, v81, int32(_a_F___newlocale_4))
	mBase = m.M
	if v83 == int32(0) {
		v88 = v81
		goto L36
...
L43:
	;
	v87 = F_strcmp(m, v81, int32(_a_F___newlocale_5))
	mBase = m.M
	if v87 != 0 {
		goto L35
	} else {
...
L56:
	;
	v118 = *(*int64)(unsafe.Add(mBase, _c_F___newlocale[1]))
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v121+v68))) = uint8(v124)
	v126 = int32(_a_F___newlocale_7)
	v127 = *(*int32)(unsafe.Add(mBase, _c_F___newlocale[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v116)+32)) = v127
	*(*int32)(unsafe.Add(mBase, _c_F___newlocale[0])) = v116
	goto L58
L57:
	;
	goto L58
...
L105:
	;
	v308 = int32(0)
	v310 = int32(*(*uint8)(unsafe.Add(mBase, _c_F___newlocale[2])))
	if v310 == v308 {
		goto L106
	} else {
		goto L107
...
L108:
	;
	v455 = int32(_a_F___newlocale_10)
	v457 = v9 + int32(8)
	v459 = int32(24)
	goto L165
L109:
	;
	v323 = int32(_a_F___newlocale_0)
	v327 = int32(*(*uint8)(unsafe.Add(mBase, _c_F___newlocale[3])))
	if v327 != 0 {
		v341 = v323
		goto L112
	} else {
...
L110:
	;
	v443 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F___newlocale[2])) = uint8(v443)
	v447 = *(*int32)(unsafe.Add(mBase, _c_F___newlocale[4]))
	*(*int32)(unsafe.Add(mBase, _c_F___newlocale[5])) = v447
	goto L108
L111:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v316<<(uint(int32(2))%32))+uint32(_c_F___newlocale[4]))) = v436
	v439 = v316 + int32(1)
	if v439 != int32(6) {
		v316 = v439
		goto L109
...
L113:
	;
	v329 = F_getenv(m, int32(_a_F___newlocale_1))
	mBase = m.M
	if v329 != 0 {
		goto L114
	} else {
...
L116:
	;
	v335 = F_getenv(m, v316*int32(12)+int32(_a_F___newlocale_2))
	mBase = m.M
	if v335 != 0 {
		goto L118
	} else {
...
L120:
	;
	v338 = F_getenv(m, int32(_a_F___newlocale_3))
	mBase = m.M
	if v338 != 0 {
		goto L122
	} else {
...
L134:
	;
	v389 = *(*int32)(unsafe.Add(mBase, _c_F___newlocale[0]))
	if v389 != 0 {
		goto L148
	} else {
		goto L149
...
L136:
	;
	v374 = F_strcmp(m, v372, int32(_a_F___newlocale_4))
	mBase = m.M
	if v374 == int32(0) {
		v379 = v372
		goto L135
...
L142:
	;
	v378 = F_strcmp(m, v372, int32(_a_F___newlocale_5))
	mBase = m.M
	if v378 != 0 {
		goto L134
	} else {
...
L155:
	;
	v409 = *(*int64)(unsafe.Add(mBase, _c_F___newlocale[1]))
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v412+v359))) = uint8(v415)
	v417 = int32(_a_F___newlocale_7)
	v418 = *(*int32)(unsafe.Add(mBase, _c_F___newlocale[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v407)+32)) = v418
	*(*int32)(unsafe.Add(mBase, _c_F___newlocale[0])) = v407
	goto L157
L156:
	;
	goto L157
...
L180:
	;
	v524 = int32(_a_F___newlocale_11)
	v526 = v9 + int32(8)
	v528 = int32(24)
	goto L184
L181:
...
L49:
	;
	v147 = F_varstr_cmp(m, v8, v14, v10+v145, v45, v46)
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L1
...
func F_nameicregexeq(m *base.Module, l0 int32) int32 {
	...
	if v10 != 0 {
		...
		v14 = F_RE_compile_and_cache(m, v7, int32(27), v13)
		mBase = m.M
		v15 = m.ExcPending
		if v15 != 0 {
			return int32(0)
...
func F_namein(m *base.Module, l0 int32) int32 {
	...
	mBase = m.M
	if int32(64) <= v4 {
		v8 = F_pg_mbcliplen(m, v3, v4, int32(63))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			return int32(0)
			...
			if v15 != 0 {
				...
				if v12 != 0 {
					v16 = F__emscripten_memcpy_bulkmem(m, v14, v3, v12)
					mBase = m.M
					v17 = v16
				} else {
					v17 = v14
