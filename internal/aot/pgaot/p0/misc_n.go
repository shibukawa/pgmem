...
L17:
	;
	v44 = F_getenv(m, v14*int32(12)+int32(4097088))
	mBase = m.M
	if v44 != 0 {
		goto L19
	} else {
...
L35:
	;
	v98 = *(*int32)(unsafe.Add(mBase, _consts[1133]))
	if v98 != 0 {
		goto L49
	} else {
		goto L50
...
L37:
	;
	v83 = F_strcmp(m, v81, int32(556197))
	mBase = m.M
	if v83 == int32(0) {
		v88 = v81
		goto L36
...
L43:
	;
	v87 = F_strcmp(m, v81, int32(509898))
	mBase = m.M
	if v87 != 0 {
		goto L35
	} else {
...
L56:
	;
	v118 = *(*int64)(unsafe.Add(mBase, _consts[1134]))
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v121+v68))) = uint8(v124)
	v126 = int32(4680176)
	v127 = *(*int32)(unsafe.Add(mBase, _consts[1133]))
	*(*int32)(unsafe.Add(mBase, uint32(v116)+32)) = v127
	*(*int32)(unsafe.Add(mBase, _consts[1133])) = v116
	goto L58
L57:
	;
	goto L58
...
L64:
	;
	if base.B2i32(l2 != int32(0))&base.B2i32(l2 != int32(4097032))&base.B2i32(l2 != int32(4097056))&base.B2i32(l2 != int32(4680180))&base.B2i32(l2 != int32(4680204)) == int32(0) {
		goto L65
	} else {
		goto L66
	}
...
L105:
	;
	v308 = int32(0)
	v310 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1135])))
	if v310 == v308 {
		goto L106
	} else {
		goto L107
...
L109:
	;
	v323 = int32(757269)
	v327 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1136])))
	if v327 != 0 {
		v341 = v323
		goto L112
	} else {
...
L110:
	;
	v443 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1135])) = uint8(v443)
	v447 = *(*int32)(unsafe.Add(mBase, _consts[1137]))
	*(*int32)(unsafe.Add(mBase, _consts[1138])) = v447
	goto L108
L111:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v316<<(uint(int32(2))%32))+uint32(_consts[1137]))) = v436
	v439 = v316 + int32(1)
	if v439 != int32(6) {
		v316 = v439
		goto L109
...
L116:
	;
	v335 = F_getenv(m, v316*int32(12)+int32(4097088))
	mBase = m.M
	if v335 != 0 {
		goto L118
	} else {
...
L134:
	;
	v389 = *(*int32)(unsafe.Add(mBase, _consts[1133]))
	if v389 != 0 {
		goto L148
	} else {
		goto L149
...
L136:
	;
	v374 = F_strcmp(m, v372, int32(556197))
	mBase = m.M
	if v374 == int32(0) {
		v379 = v372
		goto L135
...
L142:
	;
	v378 = F_strcmp(m, v372, int32(509898))
	mBase = m.M
	if v378 != 0 {
		goto L134
	} else {
...
L155:
	;
	v409 = *(*int64)(unsafe.Add(mBase, _consts[1134]))
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v412+v359))) = uint8(v415)
	v417 = int32(4680176)
	v418 = *(*int32)(unsafe.Add(mBase, _consts[1133]))
	*(*int32)(unsafe.Add(mBase, uint32(v407)+32)) = v418
	*(*int32)(unsafe.Add(mBase, _consts[1133])) = v407
	goto L157
L156:
	;
	goto L157
