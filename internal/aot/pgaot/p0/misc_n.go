...
L17:
	;
	v44 = F_getenv(m, v14*int32(12)+int32(4117648))
	mBase = m.M
	if v44 != 0 {
		goto L19
	} else {
...
L35:
	;
	v98 = *(*int32)(unsafe.Add(mBase, _consts[1151]))
	if v98 != 0 {
		goto L49
	} else {
		goto L50
...
L37:
	;
	v83 = F_strcmp(m, v81, int32(569231))
	mBase = m.M
	if v83 == int32(0) {
		v88 = v81
		goto L36
...
L43:
	;
	v87 = F_strcmp(m, v81, int32(522700))
	mBase = m.M
	if v87 != 0 {
		goto L35
	} else {
...
L56:
	;
	v118 = *(*int64)(unsafe.Add(mBase, _consts[1152]))
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v121+v68))) = uint8(v124)
	v126 = int32(4701152)
	v127 = *(*int32)(unsafe.Add(mBase, _consts[1151]))
	*(*int32)(unsafe.Add(mBase, uint32(v116)+32)) = v127
	*(*int32)(unsafe.Add(mBase, _consts[1151])) = v116
	goto L58
L57:
	;
	goto L58
...
L64:
	;
	if base.B2i32(l2 != int32(0))&base.B2i32(l2 != int32(4117592))&base.B2i32(l2 != int32(4117616))&base.B2i32(l2 != int32(4701156))&base.B2i32(l2 != int32(4701180)) == int32(0) {
		goto L65
	} else {
		goto L66
	}
...
L105:
	;
	v308 = int32(0)
	v310 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1153])))
	if v310 == v308 {
		goto L106
	} else {
		goto L107
...
L109:
	;
	v323 = int32(771673)
	v327 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1154])))
	if v327 != 0 {
		v341 = v323
		goto L112
	} else {
...
L110:
	;
	v443 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1153])) = uint8(v443)
	v447 = *(*int32)(unsafe.Add(mBase, _consts[1155]))
	*(*int32)(unsafe.Add(mBase, _consts[1156])) = v447
	goto L108
L111:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v316<<(uint(int32(2))%32))+uint32(_consts[1155]))) = v436
	v439 = v316 + int32(1)
	if v439 != int32(6) {
		v316 = v439
		goto L109
...
L116:
	;
	v335 = F_getenv(m, v316*int32(12)+int32(4117648))
	mBase = m.M
	if v335 != 0 {
		goto L118
	} else {
...
L134:
	;
	v389 = *(*int32)(unsafe.Add(mBase, _consts[1151]))
	if v389 != 0 {
		goto L148
	} else {
		goto L149
...
L136:
	;
	v374 = F_strcmp(m, v372, int32(569231))
	mBase = m.M
	if v374 == int32(0) {
		v379 = v372
		goto L135
...
L142:
	;
	v378 = F_strcmp(m, v372, int32(522700))
	mBase = m.M
	if v378 != 0 {
		goto L134
	} else {
...
L155:
	;
	v409 = *(*int64)(unsafe.Add(mBase, _consts[1152]))
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v412+v359))) = uint8(v415)
	v417 = int32(4701152)
	v418 = *(*int32)(unsafe.Add(mBase, _consts[1151]))
	*(*int32)(unsafe.Add(mBase, uint32(v407)+32)) = v418
	*(*int32)(unsafe.Add(mBase, _consts[1151])) = v407
	goto L157
L156:
	;
	goto L157
