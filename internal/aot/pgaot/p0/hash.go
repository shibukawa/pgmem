...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v625 + int32(4)
	F_errmsg_internal(m, int32(730021), v22+int32(16))
	mBase = m.M
	v633 = m.ExcPending
	if v633 != 0 {
		goto L2
...
L147:
	;
	F_errfinish(m, int32(525225), int32(345), int32(107074))
	mBase = m.M
	v638 = m.ExcPending
	if v638 != 0 {
		goto L2
...
L151:
	;
	F_errfinish(m, int32(525225), int32(455), int32(107074))
	mBase = m.M
	v657 = m.ExcPending
	if v657 != 0 {
		goto L2
...
func F_hash_agg_set_limits(m *base.Module, l0 float64, l1 float64, l2 int32, l3 int32, l4 int32, l5 int32) {
	...
	var v171 int64
	_ = v171
	v14 = *(*float64)(unsafe.Add(mBase, _consts[342]))
	v16 = *(*int32)(unsafe.Add(mBase, _consts[323]))
	...
	if base.F64_ge(v33, base.F64_mul(l0, l1)) != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l3))) = v32
		...
		v51 = float64(1024)
		v55 = *(*float64)(unsafe.Add(mBase, _consts[342]))
...
L56:
	;
	F_errfinish(m, int32(519682), int32(4196), int32(25030))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L1
...
L53:
	;
	F_errfinish(m, int32(519682), int32(4324), int32(483164))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L54:
	;
	F_errfinish(m, int32(519246), int32(2015), int32(483617))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L1
