		...
		if v28 == v27 {
			...
			if v37 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v36)+4)) = l2
				...
				v48 = v46 & int32(_a_F_ExecHashTableInsert_0)
...
func F__hash_binsearch_last(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if base.Ui32(v8) < base.Ui32(int32(25)) {
		...
		if v14&int32(_a_F__hash_binsearch_last_1) == int32(0) {
			...
			for {
				...
				v47 = l0 + v44&int32(_a_F__hash_binsearch_last_2)
				...
				if base.Ui32(v60&int32(_a_F__hash_binsearch_last_1)) < base.Ui32(v57&int32(_a_F__hash_binsearch_last_1)) {
					v23 = v60
					v24 = v57
					continue
				} else {
	...
	return v66 & int32(_a_F__hash_binsearch_last_1)
}
...
L9:
	;
	v34 = int32(1)
	v36 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[0]))
	if int32(0) < v36 {
		v46 = v34
		goto L7
	} else {
...
L20:
	;
	v80 = v78 & int32(_a_F__hash_init_0)
...
L30:
	;
	v107 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L32:
	;
	v115 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v121)+56)) = int32(base.Ui32(v158) >> (uint(v160) % 32))
	v167 = base.I32_clz(v146&int32(_a_F__hash_init_1)) ^ int32(31)
	v168 = int32(3)
	v169 = v167 + v168
...
L39:
	;
	v203 = int32(0)
	v205 = F___memset(m, v121+int32(468), v203, int32(_a_F__hash_init_2))
	mBase = m.M
...
L49:
	;
	v223 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L51:
	;
	v231 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L60:
	;
	v261 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L62:
	;
	v269 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L65:
	;
	v289 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[3]))
	if v289 != 0 {
		goto L66
	} else {
		goto L67
...
L72:
	;
	v299 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L74:
	;
	v306 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L80:
	;
	v327 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L82:
	;
	v334 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L86:
	;
	v374 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[3]))
	if v374 != 0 {
		goto L88
	} else {
		goto L89
...
L101:
	;
	v417 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L103:
	;
	v425 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L109:
	;
	v445 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L111:
	;
	v453 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L119:
	;
	v497 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L121:
	;
	v505 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L137:
	;
	v567 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L139:
	;
	v575 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L141:
	;
	v592 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[1]))
...
L143:
	;
	v600 = *(*int32)(unsafe.Add(mBase, _c_F__hash_init[2]))
...
L146:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v625 + int32(4)
	F_errmsg_internal(m, int32(_a_F__hash_init_4), v22+int32(16))
	mBase = m.M
	v633 = m.ExcPending
	if v633 != 0 {
		goto L2
...
L150:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v646 + int32(4)
	F_errmsg(m, int32(_a_F__hash_init_7), v22)
	mBase = m.M
	v652 = m.ExcPending
	if v652 != 0 {
		goto L2
...
L15:
	;
	v72 = *(*int32)(unsafe.Add(mBase, uint32(v56&int32(_a_F__hash_load_qualified_items_1)<<(uint(int32(2))%32)+(l1+int32(24))-int32(4))))
	v75 = l1 + v72&int32(_a_F__hash_load_qualified_items_2)
...
L18:
	;
	v90 = v56 + int32(1)
	if base.Ui32(v90&int32(_a_F__hash_load_qualified_items_1)) <= base.Ui32(v34) {
		v56 = v90
		goto L15
	} else {
		goto L25
...
L23:
	;
	v85 = int32(_a_F__hash_load_qualified_items_3)
	if v72&v85 != v85 {
		goto L17
	} else {
		goto L24
...
L30:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v106)+4)) = uint16(v109)
	...
	v113 = v46 + v112
	v115 = v56 + v112
	if base.Ui32(v115&int32(_a_F__hash_load_qualified_items_1)) <= base.Ui32(v34) {
		v42 = v115
		v46 = v113
		goto L13
	} else {
...
L34:
	;
	v151 = *(*int32)(unsafe.Add(mBase, uint32(v135&int32(_a_F__hash_load_qualified_items_1)<<(uint(int32(2))%32)+(l1+int32(24))-int32(4))))
	v154 = l1 + v151&int32(_a_F__hash_load_qualified_items_2)
...
L37:
	;
	v169 = v135 - int32(1)
	if v169&int32(_a_F__hash_load_qualified_items_1) != 0 {
		v135 = v169
		goto L34
	} else {
		goto L44
...
L42:
	;
	v164 = int32(_a_F__hash_load_qualified_items_3)
	if v151&v164 != v164 {
		goto L36
	} else {
		goto L43
...
L49:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v186)+4)) = uint16(v189)
	v193 = v135 - v182
	if v193&int32(_a_F__hash_load_qualified_items_1) != 0 {
		v121 = v193
		v125 = v183
		goto L32
	} else {
...
L21:
	;
	v674 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[1]))
...
L25:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v29)+12)) = uint8(v177)
	...
	v185 = int32(_a_F__hash_splitbucket_2)
	if v184&v185 == v185 {
		v443 = v162
		v446 = v165
		v450 = v169
...
L28:
	;
	v191 = v126 + v184&int32(_a_F__hash_splitbucket_4)
	if l6 != 0 {
		goto L29
	} else {
		goto L30
...
L43:
	...
	v218 = v216 | int32(_a_F__hash_splitbucket_5)
	*(*uint16)(unsafe.Add(mBase, uint32(v214)+6)) = uint16(v218)
	v221 = v165 & int32(_a_F__hash_splitbucket_3)
...
L44:
	;
	v238 = (v216&int32(_a_F__hash_splitbucket_6) + int32(7)) & int32(_a_F__hash_splitbucket_7)
...
L48:
	;
	v241 = int32(_a_F__hash_splitbucket_8)
	v243 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4]))
	*(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4])) = v243 + int32(1)
...
L50:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29+int32(16)+v409&int32(_a_F__hash_splitbucket_3)<<(uint(int32(2))%32)))) = v214
	v443 = v406
	v446 = v409 + int32(1)
	v450 = v413 + v238
	v451 = v414
...
L53:
	;
	v297 = int32(0)
	v298 = int32(_a_F__hash_splitbucket_8)
	v300 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4]))
	*(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4])) = v300 - int32(1)
...
L54:
	;
	v260 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[5]))
	if v260 <= int32(0) {
		goto L55
	} else {
		goto L56
...
L64:
	;
	v278 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[0]))
...
L66:
	;
	v286 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[1]))
...
L77:
	;
	v376 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[0]))
...
L79:
	;
	v385 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[1]))
...
L88:
	;
	v496 = int32(_a_F__hash_splitbucket_8)
	v498 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4]))
	*(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4])) = v498 + int32(1)
	F__hash_pgaddmultitup(m, l0, v472, v29+int32(16), v29+int32(1648), v475&int32(_a_F__hash_splitbucket_3))
	mBase = m.M
	v509 = m.ExcPending
	if v509 != 0 {
		goto L17
...
L93:
	;
	v554 = int32(_a_F__hash_splitbucket_8)
	v556 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4]))
	*(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4])) = v556 - int32(1)
	if l5 == v472 {
		goto L108
	} else {
		goto L109
...
L94:
	;
	v517 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[5]))
	if v517 <= int32(0) {
		goto L95
	} else {
		goto L96
...
L104:
	;
	v535 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[0]))
...
L106:
	;
	v543 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[1]))
	v549 = v543 + v472<<(uint(int32(13))%32) + int32(-8192)
	goto L103
L107:
	;
	v567 = v475 & int32(_a_F__hash_splitbucket_3)
	if v567 != 0 {
		goto L113
	} else {
		goto L114
...
L121:
	;
	v638 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[0]))
...
L126:
	;
	v656 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[0]))
...
L128:
	;
	v664 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[1]))
...
L130:
	...
	v705 = int32(_a_F__hash_splitbucket_8)
	v707 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4]))
	*(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4])) = v707 + int32(1)
	v711 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v685)+12)))
	v713 = v711 & int32(_a_F__hash_splitbucket_9)
	*(*uint16)(unsafe.Add(mBase, uint32(v685)+12)) = uint16(v713)
	v715 = v703 + v704
	v716 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v715)+12)))
	v718 = v716 & int32(_a_F__hash_splitbucket_10)
...
L131:
	;
	v689 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[0]))
...
L133:
	;
	v697 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[1]))
...
L136:
	;
	v810 = int32(_a_F__hash_splitbucket_8)
	v812 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4]))
	*(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[4])) = v812 - int32(1)
...
L137:
	;
	v733 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[5]))
	if v733 <= int32(0) {
		goto L138
	} else {
		goto L139
...
L149:
	;
	v764 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[0]))
...
L151:
	;
	v772 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[1]))
...
L153:
	;
	v789 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[0]))
...
L155:
	;
	v797 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[1]))
...
L163:
	;
	v824 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[2]))
...
L165:
	;
	v832 = *(*int32)(unsafe.Add(mBase, _c_F__hash_splitbucket[3]))
...
func F_hash_agg_set_limits(m *base.Module, l0 float64, l1 float64, l2 int32, l3 int32, l4 int32, l5 int32) {
	...
	if base.F64_ge(v33, base.F64_mul(l0, l1)) != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(l3))) = v32
		...
		v51 = float64(1024)
		v55 = *(*float64)(unsafe.Add(mBase, _c_F_hash_agg_set_limits[0]))
		v57 = *(*int32)(unsafe.Add(mBase, _c_F_hash_agg_set_limits[1]))
		...
		v124 = int32(_a_F_hash_agg_set_limits_0)<<(uint(v117)%32) - int32(-8192)
...
L21:
	;
	v55 = int32(_a_F_hash_array_0)
	v56 = *(*int32)(unsafe.Add(mBase, _c_F_hash_array[0]))
	v58 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v59 = *(*int32)(unsafe.Add(mBase, uint32(v58)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_hash_array[0])) = v59
...
L22:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v62)+11)) = uint8(v70)
	F_fmgr_info(m, int32(_a_F_hash_array_1), v62+int32(132))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L1
...
L14:
	;
	v49 = F_lookup_type_cache(m, v43, int32(_a_F_hash_array_extended_0))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L1
...
L38:
	;
	v169 = F_lookup_type_cache(m, v167, int32(_a_F_hash_record_extended_0))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L1
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = v229
	F_errmsg(m, int32(_a_F_hash_record_extended_1), v21)
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L1
