...
L155:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v319))) = v538 & int32(3)
	F_errmsg_internal(m, int32(486047), v319)
	mBase = m.M
	v544 = m.ExcPending
	if v544 != 0 {
		goto L106
...
L156:
	;
	F_errfinish(m, int32(494338), int32(245), int32(348973))
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L106
...
L194:
	;
	F_errfinish(m, int32(494763), int32(12118), int32(134788))
	mBase = m.M
	v1263 = m.ExcPending
	if v1263 != 0 {
		goto L5
...
L197:
	;
	F_errfinish(m, int32(494763), int32(12121), int32(134788))
	mBase = m.M
	v1278 = m.ExcPending
	if v1278 != 0 {
		goto L5
...
L200:
	;
	F_errfinish(m, int32(494763), int32(11387), int32(463416))
	mBase = m.M
	v1297 = m.ExcPending
	if v1297 != 0 {
		goto L5
...
L203:
	;
	F_errfinish(m, int32(494763), int32(11319), int32(463416))
	mBase = m.M
	v1310 = m.ExcPending
	if v1310 != 0 {
		goto L5
...
L212:
	;
	F_errfinish(m, int32(494763), int32(11537), int32(337133))
	mBase = m.M
	v1443 = m.ExcPending
	if v1443 != 0 {
		goto L5
...
L216:
	;
	F_errfinish(m, int32(494763), int32(11490), int32(337133))
	mBase = m.M
	v1459 = m.ExcPending
	if v1459 != 0 {
		goto L5
...
L220:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+64)) = v1467 + int32(4)
	F_errmsg(m, int32(693069), v24-int32(-64))
	mBase = m.M
	v1479 = m.ExcPending
	if v1479 != 0 {
		goto L5
...
L221:
	;
	F_errfinish(m, int32(494763), int32(11475), int32(337133))
	mBase = m.M
	v1484 = m.ExcPending
	if v1484 != 0 {
		goto L5
...
L13:
	;
	F_errmsg_internal(m, int32(389893), int32(0))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L9
...
L16:
	;
	F_errfinish(m, int32(500025), int32(2892), int32(389965))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L9
...
L4:
	;
	F_s_lock(m, v11, int32(499354), int32(238), int32(237914))
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		goto L7
...
L21:
	;
	F_s_lock(m, l0, int32(499354), int32(317), int32(78124))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L7
...
L52:
	;
	F_s_lock(m, l0, int32(499354), int32(351), int32(78124))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L7
		...
		*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
		if v12 != 0 {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
				if v70 != 0 {
					F_s_lock(m, l0, int32(499354), int32(75), int32(237882))
					mBase = m.M
					v77 = m.ExcPending
					if v77 != 0 {
						return
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v77
	F_errmsg_internal(m, int32(335113), v9)
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L14
...
L23:
	;
	F_errfinish(m, int32(495493), int32(3942), int32(281696))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L14
...
L25:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v15)+32)) = uint32(v68)
	F_errmsg_internal(m, int32(514917), v15+int32(32))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L23
...
L28:
	;
	F_errfinish(m, int32(497876), int32(574), int32(62412))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L23
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+84)) = int32(232220)
...
L41:
	;
	F_s_lock(m, v18, int32(497876), int32(601), int32(62412))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L23
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v23
	F_errmsg(m, int32(697974), v15+int32(16))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L23
...
L52:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v15))) = uint32(v178)
	F_errdetail(m, int32(656944), v15)
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L23
...
L53:
	;
	F_errfinish(m, int32(497876), int32(617), int32(62412))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L23
...
L56:
	;
	F_errfinish(m, int32(497876), int32(517), int32(62412))
	mBase = m.M
	v206 = m.ExcPending
	if v206 != 0 {
		goto L23
...
L60:
	;
	F_errfinish(m, int32(497876), int32(523), int32(62412))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L23
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+64)) = v23
	F_errmsg(m, int32(362054), v15-int32(-64))
	mBase = m.M
	v235 = m.ExcPending
	if v235 != 0 {
		goto L23
...
L64:
	;
	F_errfinish(m, int32(497876), int32(534), int32(62412))
	mBase = m.M
	v240 = m.ExcPending
	if v240 != 0 {
		goto L23
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+48)) = v23
	F_errmsg(m, int32(336214), v15+int32(48))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L23
...
L69:
	;
	F_errhint(m, int32(579713), int32(0))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L23
...
L70:
	;
	F_errfinish(m, int32(497876), int32(547), int32(62412))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L23
...
func F_CreateDirAndVersionFile(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	v9 = v7 - int32(1136)
	m.G0 = v9
	*(*int32)(unsafe.Add(mBase, uint32(v9)+80)) = int32(556516)
	v18 = F_pg_sprintf(m, v9+int32(96), int32(748521), v9+int32(80))
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		goto L1
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v9)+52)) = int32(530153)
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v9 + int32(112)
	F_errmsg(m, int32(298541), v9+int32(32))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L28:
	;
	F_errfinish(m, int32(494513), int32(507), int32(390008))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v9 + int32(112)
	F_errmsg(m, int32(299806), v9+int32(16))
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L1
...
L46:
	;
	F_errfinish(m, int32(494513), int32(515), int32(390008))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = l0
	F_errmsg(m, int32(296851), v9-int32(-64))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L1
...
L58:
	;
	F_errfinish(m, int32(494513), int32(478), int32(390008))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(494513), int32(495), int32(390008))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L1
...
L174:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30))) = v32
	F_errmsg_internal(m, int32(485442), v30)
	mBase = m.M
	v745 = m.ExcPending
	if v745 != 0 {
		goto L13
...
L175:
	;
	F_errfinish(m, int32(498662), int32(5627), int32(354869))
	mBase = m.M
	v750 = m.ExcPending
	if v750 != 0 {
		goto L13
...
L247:
	;
	F_errfinish(m, int32(497906), int32(876), int32(463778))
	mBase = m.M
	v1681 = m.ExcPending
	if v1681 != 0 {
		goto L20
																...
																if v65 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v64
																	...
																	if v69 != 0 {
																		...
																		if v40 != 0 {
																			F_errhint(m, int32(656014), int32(0))
																			mBase = m.M
																			v73 = m.ExcPending
																			if v73 != 0 {
																				return int32(0)
																			} else {
																				F_errfinish(m, int32(494144), int32(129), int32(151789))
																				mBase = m.M
																				v78 = m.ExcPending
																				if v78 != 0 {
																					return int32(0)
...
func F_check_io_max_concurrency(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v4 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, _consts[189])) = v8
		v14 = F_format_elog_string(m, int32(646601), int32(0))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return int32(0)
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
	F_errmsg(m, int32(712549), v9+int32(16))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L16
...
L2:
	;
	F_appendStringInfoString(m, v11, int32(686436))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		goto L1
...
L11:
	...
	v40 = F_MakeSingleTupleTableSlot(m, v38, int32(1618188))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v111
	F_errmsg_plural(m, int32(223167), int32(223214), v110, v7)
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L1
...
L51:
	;
	F_errfinish(m, int32(494590), int32(501), int32(143573))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
...
L54:
	;
	F_errfinish(m, int32(494590), int32(467), int32(143573))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L1
				...
				if v27 != 0 {
					...
					if v30 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v31
						F_errmsg(m, int32(440415), v5+int32(16))
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return
						} else {
							*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(599660)
							...
							if v45 != 0 {
								...
								F_errfinish(m, int32(497801), int32(5709), int32(381230))
								mBase = m.M
								v50 = m.ExcPending
								if v50 != 0 {
									return
...
L19:
	;
	F_errfinish(m, int32(500434), int32(2988), int32(238399))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L16
...
L56:
	;
	F_errfinish(m, int32(500434), int32(2861), int32(238379))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L16
...
L63:
	...
	v195 = F_strstr(m, v193, int32(561855))
	mBase = m.M
	if v195 == int32(0) {
		v277 = v181
		v278 = v191
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v213 + int32(1)
	F_errmsg(m, int32(712306), v16+int32(48))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L16
...
L71:
	;
	F_errfinish(m, int32(500434), int32(2885), int32(238379))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L16
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = l0
	F_errmsg(m, int32(700114), v16+int32(16))
	mBase = m.M
	v388 = m.ExcPending
	if v388 != 0 {
		goto L16
...
L111:
	;
	F_errfinish(m, int32(500434), int32(3008), int32(238399))
	mBase = m.M
	v393 = m.ExcPending
	if v393 != 0 {
		goto L16
...
L72:
	;
	F_errfinish(m, int32(495483), int32(425), int32(307722))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L4
...
L121:
	;
	F_errfinish(m, int32(495483), v700, int32(504464))
	mBase = m.M
	v721 = m.ExcPending
	if v721 != 0 {
		goto L4
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+100)) = v642 + v645
	F_errmsg(m, int32(710029), v26+int32(96))
	mBase = m.M
	v655 = m.ExcPending
	if v655 != 0 {
		goto L4
...
L165:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+68)) = v682 + int32(4)
	F_errmsg(m, int32(692004), v26-int32(-64))
	mBase = m.M
	v691 = m.ExcPending
	if v691 != 0 {
		goto L4
...
L176:
	...
	*(*float64)(unsafe.Add(mBase, uint32(v26)+16)) = v788
	F_errdetail(m, int32(606834), v26+int32(16))
	mBase = m.M
	v799 = m.ExcPending
	if v799 != 0 {
		goto L4
...
L177:
	;
	F_errfinish(m, int32(495483), int32(1007), int32(504464))
	mBase = m.M
	v804 = m.ExcPending
	if v804 != 0 {
		goto L4
...
L206:
	;
	F_errmsg(m, int32(327536), int32(0))
	mBase = m.M
	v936 = m.ExcPending
	if v936 != 0 {
		goto L4
...
L207:
	;
	F_errfinish(m, int32(495483), int32(410), int32(307722))
	mBase = m.M
	v941 = m.ExcPending
	if v941 != 0 {
		goto L4
...
L209:
	;
	F_errfinish(m, int32(495483), int32(421), int32(307722))
	mBase = m.M
	v950 = m.ExcPending
	if v950 != 0 {
		goto L4
...
L212:
	;
	F_errfinish(m, int32(495483), int32(1016), int32(504464))
	mBase = m.M
	v964 = m.ExcPending
	if v964 != 0 {
		goto L4
												...
												if v134 != 0 {
													...
													if v137 != 0 {
														...
														if v141 != 0 {
															...
															F_errfinish(m, int32(500280), int32(1076), int32(314175))
															mBase = m.M
															v146 = m.ExcPending
															if v146 != 0 {
																return int32(0)
														...
														if v150 != 0 {
															...
															if v153 != 0 {
																...
																if v157 != 0 {
																	...
																	F_errfinish(m, int32(500280), int32(1081), int32(314175))
																	mBase = m.M
																	v162 = m.ExcPending
																	if v162 != 0 {
																		return int32(0)
...
L22:
	;
	F_errfinish(m, int32(496998), int32(372), int32(283390))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L1
