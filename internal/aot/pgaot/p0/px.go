...
L220:
	;
	F_errfinish(m, int32(491097), int32(697), int32(170493))
	mBase = m.M
	v935 = m.ExcPending
	if v935 != 0 {
		goto L111
...
L224:
	;
	F_errfinish(m, int32(491097), int32(745), int32(170493))
	mBase = m.M
	v955 = m.ExcPending
	if v955 != 0 {
		goto L111
						...
						if v31 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v28)+32)) = v30
							...
							if v34 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v28)+24)) = int32(6736)
								*(*int32)(unsafe.Add(mBase, uint32(v28)+20)) = int32(6737)
								*(*int32)(unsafe.Add(mBase, uint32(v28)+16)) = int32(6738)
								*(*int32)(unsafe.Add(mBase, uint32(v28)+12)) = int32(6739)
								*(*int32)(unsafe.Add(mBase, uint32(v28)+8)) = int32(6740)
								*(*int32)(unsafe.Add(mBase, uint32(v28)+4)) = int32(6741)
								*(*int32)(unsafe.Add(mBase, uint32(v28))) = int32(6742)
