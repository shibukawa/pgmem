...
L55:
	;
	F_errmsg_internal(m, int32(170997), int32(0))
	mBase = m.M
	v209 = m.ExcPending
	if v209 != 0 {
		goto L42
...
L56:
	;
	F_errfinish(m, int32(517387), int32(1897), int32(419188))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L42
...
L58:
	;
	F_errmsg_internal(m, int32(375930), int32(0))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L42
...
L59:
	;
	F_errfinish(m, int32(517387), int32(1902), int32(419188))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L42
