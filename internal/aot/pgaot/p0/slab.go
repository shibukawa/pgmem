	...
	if v18 == int32(0) {
		...
		if v48 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v11
			F_errmsg_internal(m, int32(239241), v8)
			mBase = m.M
			v52 = m.ExcPending
			if v52 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(500525), int32(847), int32(489376))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return int32(0)
			...
			if v24 != int32(476) {
				...
				if l1 == v27 {
					...
					if v34 != 0 {
						...
						F_errmsg_internal(m, int32(684813), int32(0))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(500525), int32(854), int32(489376))
							mBase = m.M
							v43 = m.ExcPending
							if v43 != 0 {
								return int32(0)
