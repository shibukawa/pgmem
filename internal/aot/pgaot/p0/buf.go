...
func F_BufFileDeleteFileSet(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = v4
	v20 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(489453), v9+int32(32))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
	v46 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(489453), v9+int32(16))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
	F_errmsg_internal(m, int32(753170), v9)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L20:
	;
	F_errfinish(m, int32(524867), int32(387), int32(116019))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L1
...
L14:
	...
	v70 = int32(*(*uint8)(unsafe.Add(mBase, _consts[263])))
	if v70 == int32(1) {
		goto L17
	} else {
		goto L18
...
L21:
	;
	v98 = int32(*(*uint8)(unsafe.Add(mBase, _consts[263])))
	if v98 == int32(1) {
		goto L22
	} else {
		goto L23
...
L22:
	...
	mBase = m.M
	v105 = int32(4460440)
	v107 = *(*int64)(unsafe.Add(mBase, _consts[340]))
	v108 = int64(*(*int32)(unsafe.Add(mBase, uint32(v15)+56)))
	v109 = *(*int64)(unsafe.Add(mBase, uint32(v15)+48))
	*(*int64)(unsafe.Add(mBase, _consts[340])) = v107 + (v108 + (v109*int64(1000000000) + v84))
...
L25:
	;
	v120 = int32(4460392)
	v122 = *(*int64)(unsafe.Add(mBase, _consts[334]))
	*(*int64)(unsafe.Add(mBase, _consts[334])) = v122 + int64(1)
...
L40:
	;
	F_errfinish(m, int32(524867), int32(635), int32(259176))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L4
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v168
	F_errmsg(m, int32(169255), v13+int32(-48))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L4
...
L50:
	;
	F_errfinish(m, int32(524867), int32(471), int32(238586))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L4
		...
		if v17 < int64(0) {
			...
			if v26 != 0 {
				...
				if v28 != 0 {
					...
					v38 = *(*int32)(unsafe.Add(mBase, _consts[191]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = v42
					F_errmsg(m, int32(314526), v7)
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int64(0)
					} else {
						F_errfinish(m, int32(524867), int32(877), int32(360566))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return int64(0)
