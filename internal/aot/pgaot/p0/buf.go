...
func F_BufFileDeleteFileSet(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = v4
	v20 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(438200), v9+int32(32))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
	v46 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(438200), v9+int32(16))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
	F_errmsg_internal(m, int32(666832), v9)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L20:
	;
	F_errfinish(m, int32(468330), int32(387), int32(99864))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L1
...
L40:
	;
	F_errfinish(m, int32(468330), int32(635), int32(230532))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L4
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v168
	F_errmsg(m, int32(147614), v13+int32(-48))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L4
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v204
	F_errmsg(m, int32(281407), v13+int32(-32))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L4
...
L50:
	;
	F_errfinish(m, int32(468330), int32(471), int32(213395))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L4
			...
			if v26 != 0 {
				...
				if v28 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = v42
					F_errmsg(m, int32(281557), v7)
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int64(0)
					} else {
						F_errfinish(m, int32(468330), int32(877), int32(321020))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return int64(0)
