...
func F_BufFileDeleteFileSet(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = v4
	v20 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(458903), v9+int32(32))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
	v46 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(458903), v9+int32(16))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
	F_errmsg_internal(m, int32(691748), v9)
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L20:
	;
	F_errfinish(m, int32(490424), int32(387), int32(106754))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L1
...
L40:
	;
	F_errfinish(m, int32(490424), int32(635), int32(242062))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L4
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v168
	F_errmsg(m, int32(156356), v13+int32(-48))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L4
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v204
	F_errmsg(m, int32(294718), v13+int32(-32))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L4
...
L50:
	;
	F_errfinish(m, int32(490424), int32(471), int32(223150))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L4
			...
			if v26 != 0 {
				...
				if v28 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = v42
					F_errmsg(m, int32(294868), v7)
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int64(0)
					} else {
						F_errfinish(m, int32(490424), int32(877), int32(336501))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return int64(0)
