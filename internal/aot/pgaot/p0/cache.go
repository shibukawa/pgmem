...
L26:
	;
	v210 = *(*int32)(unsafe.Add(mBase, _consts[881]))
...
L27:
	...
	v128 = *(*int32)(unsafe.Add(mBase, _consts[880]))
...
L67:
	;
	v168 = *(*int32)(unsafe.Add(mBase, _consts[882]))
	if v168 <= v130 {
		goto L68
	} else {
		goto L69
...
L71:
	;
	*(*int32)(unsafe.Add(mBase, _consts[882])) = v184
	*(*int32)(unsafe.Add(mBase, _consts[880])) = v185
	v190 = v185
	goto L70
L72:
	;
...
func F_CreateCacheMemoryContext(m *base.Module) {
	...
	if v2 == int32(0) {
		...
		v12 = F_AllocSetContextCreateInternal(m, v7, int32(58787), int32(0), int32(8192), int32(8388608))
		mBase = m.M
		v13 = m.ExcPending
		if v13 != 0 {
			return
				...
				if v15 == int32(0) {
					...
					if v56 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = v57
						F_errmsg_internal(m, int32(47494), v6)
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return
