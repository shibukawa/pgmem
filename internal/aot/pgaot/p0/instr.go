...
func F_InstrAccumParallelQuery(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v120
	v3 = int32(4460328)
	v5 = *(*int64)(unsafe.Add(mBase, _consts[326]))
	v6 = *(*int64)(unsafe.Add(mBase, uint32(l0)))
	*(*int64)(unsafe.Add(mBase, _consts[326])) = v5 + v6
	v9 = int32(4460336)
	v11 = *(*int64)(unsafe.Add(mBase, _consts[327]))
	v12 = *(*int64)(unsafe.Add(mBase, uint32(l0)+8))
	*(*int64)(unsafe.Add(mBase, _consts[327])) = v11 + v12
	v15 = int32(4460344)
	v17 = *(*int64)(unsafe.Add(mBase, _consts[328]))
	v18 = *(*int64)(unsafe.Add(mBase, uint32(l0)+16))
	*(*int64)(unsafe.Add(mBase, _consts[328])) = v17 + v18
	v21 = int32(4460352)
	v23 = *(*int64)(unsafe.Add(mBase, _consts[329]))
	v24 = *(*int64)(unsafe.Add(mBase, uint32(l0)+24))
	*(*int64)(unsafe.Add(mBase, _consts[329])) = v23 + v24
	v27 = int32(4460360)
	v29 = *(*int64)(unsafe.Add(mBase, _consts[330]))
	v30 = *(*int64)(unsafe.Add(mBase, uint32(l0)+32))
	*(*int64)(unsafe.Add(mBase, _consts[330])) = v29 + v30
	v33 = int32(4460368)
	v35 = *(*int64)(unsafe.Add(mBase, _consts[331]))
	v36 = *(*int64)(unsafe.Add(mBase, uint32(l0)+40))
	*(*int64)(unsafe.Add(mBase, _consts[331])) = v35 + v36
	v39 = int32(4460376)
	v41 = *(*int64)(unsafe.Add(mBase, _consts[332]))
	v42 = *(*int64)(unsafe.Add(mBase, uint32(l0)+48))
	*(*int64)(unsafe.Add(mBase, _consts[332])) = v41 + v42
	v45 = int32(4460384)
	v47 = *(*int64)(unsafe.Add(mBase, _consts[333]))
	v48 = *(*int64)(unsafe.Add(mBase, uint32(l0)+56))
	*(*int64)(unsafe.Add(mBase, _consts[333])) = v47 + v48
	v51 = int32(4460392)
	v53 = *(*int64)(unsafe.Add(mBase, _consts[334]))
	v54 = *(*int64)(unsafe.Add(mBase, uint32(l0)+64))
	*(*int64)(unsafe.Add(mBase, _consts[334])) = v53 + v54
	v57 = int32(4460400)
	v59 = *(*int64)(unsafe.Add(mBase, _consts[335]))
	v60 = *(*int64)(unsafe.Add(mBase, uint32(l0)+72))
	*(*int64)(unsafe.Add(mBase, _consts[335])) = v59 + v60
	v63 = int32(4460408)
	v65 = *(*int64)(unsafe.Add(mBase, _consts[336]))
	v66 = *(*int64)(unsafe.Add(mBase, uint32(l0)+80))
	*(*int64)(unsafe.Add(mBase, _consts[336])) = v65 + v66
	v69 = int32(4460416)
	v71 = *(*int64)(unsafe.Add(mBase, _consts[337]))
	v72 = *(*int64)(unsafe.Add(mBase, uint32(l0)+88))
	*(*int64)(unsafe.Add(mBase, _consts[337])) = v71 + v72
	v75 = int32(4460424)
	v77 = *(*int64)(unsafe.Add(mBase, _consts[338]))
	v78 = *(*int64)(unsafe.Add(mBase, uint32(l0)+96))
	*(*int64)(unsafe.Add(mBase, _consts[338])) = v77 + v78
	v81 = int32(4460432)
	v83 = *(*int64)(unsafe.Add(mBase, _consts[339]))
	v84 = *(*int64)(unsafe.Add(mBase, uint32(l0)+104))
	*(*int64)(unsafe.Add(mBase, _consts[339])) = v83 + v84
	v87 = int32(4460440)
	v89 = *(*int64)(unsafe.Add(mBase, _consts[340]))
	v90 = *(*int64)(unsafe.Add(mBase, uint32(l0)+112))
	*(*int64)(unsafe.Add(mBase, _consts[340])) = v89 + v90
	v93 = int32(4460448)
	v95 = *(*int64)(unsafe.Add(mBase, _consts[341]))
	v96 = *(*int64)(unsafe.Add(mBase, uint32(l0)+120))
	*(*int64)(unsafe.Add(mBase, _consts[341])) = v95 + v96
	v99 = int32(4460472)
	...
	if v14 == int32(1) {
		...
		if v17 == int64(0) {
			...
			if v210 != 0 {
				...
				F_errmsg_internal(m, int32(89030), int32(0))
				mBase = m.M
				v214 = m.ExcPending
				if v214 != 0 {
					return
				} else {
					F_errfinish(m, int32(518232), int32(96), int32(435259))
					mBase = m.M
					v219 = m.ExcPending
					if v219 != 0 {
						return
			...
			*(*int64)(unsafe.Add(mBase, uint32(l0)+16)) = v27 + (v22 + v23*int64(1000000000) - v24)
			...
			if v37 == int32(1) {
				...
				v46 = *(*int64)(unsafe.Add(mBase, _consts[326]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41))) = v44 + (v46 - v47)
				...
				v53 = *(*int64)(unsafe.Add(mBase, _consts[327]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+8)) = v51 + (v53 - v54)
				...
				v60 = *(*int64)(unsafe.Add(mBase, _consts[328]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+16)) = v58 + (v60 - v61)
				...
				v67 = *(*int64)(unsafe.Add(mBase, _consts[329]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+24)) = v65 + (v67 - v68)
				...
				v74 = *(*int64)(unsafe.Add(mBase, _consts[330]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+32)) = v72 + (v74 - v75)
				...
				v81 = *(*int64)(unsafe.Add(mBase, _consts[331]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+40)) = v79 + (v81 - v82)
				...
				v88 = *(*int64)(unsafe.Add(mBase, _consts[332]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+48)) = v86 + (v88 - v89)
				...
				v95 = *(*int64)(unsafe.Add(mBase, _consts[333]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+56)) = v93 + (v95 - v96)
				...
				v102 = *(*int64)(unsafe.Add(mBase, _consts[334]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+64)) = v100 + (v102 - v103)
				...
				v109 = *(*int64)(unsafe.Add(mBase, _consts[335]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+72)) = v107 + (v109 - v110)
				...
				v116 = *(*int64)(unsafe.Add(mBase, _consts[336]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+80)) = v114 + (v116 - v117)
				...
				v123 = *(*int64)(unsafe.Add(mBase, _consts[337]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+88)) = v121 + (v123 - v124)
				...
				v130 = *(*int64)(unsafe.Add(mBase, _consts[338]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+96)) = v128 + (v130 - v131)
				...
				v137 = *(*int64)(unsafe.Add(mBase, _consts[339]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+104)) = v135 + (v137 - v138)
				...
				v144 = *(*int64)(unsafe.Add(mBase, _consts[340]))
				...
				*(*int64)(unsafe.Add(mBase, uint32(v41)+112)) = v142 + (v144 - v145)
				...
				v151 = *(*int64)(unsafe.Add(mBase, _consts[341]))
