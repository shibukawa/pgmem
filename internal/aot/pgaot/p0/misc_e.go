				...
				if v51 != 0 {
					...
					if v54 != 0 {
						...
						if v58 != 0 {
							...
							F_errfinish(m, int32(492334), int32(2817), int32(134061))
							mBase = m.M
							v63 = m.ExcPending
							if v63 != 0 {
								return
...
L35:
	;
	F_errfinish(m, int32(492334), int32(3164), int32(134103))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L19
...
L24:
	;
	F_errfinish(m, int32(492334), int32(2677), int32(134040))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L5
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+4)) = v235 + int32(4)
	F_errmsg_internal(m, int32(701195), v19)
	mBase = m.M
	v242 = m.ExcPending
	if v242 != 0 {
		goto L14
...
L60:
	;
	F_errfinish(m, int32(495877), int32(479), int32(445216))
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L14
...
func F_ExecInitNullTupleSlot(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v58 int32
	_ = v58
	v6 = F_MakeTupleTableSlot(m, l1, int32(1599156))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
		...
		if l2 == int32(4) {
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12))) = l2
				F_errmsg_internal(m, int32(483199), v12)
				mBase = m.M
				v32 = m.ExcPending
				if v32 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(495877), int32(316), int32(332619))
					mBase = m.M
					v37 = m.ExcPending
					if v37 != 0 {
						return int32(0)
...
L33:
	;
	F_errfinish(m, int32(494313), int32(160), int32(97174))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L30
...
L145:
	;
	F_errmsg(m, int32(460192), int32(0))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L30
...
L146:
	;
	F_errfinish(m, int32(494313), int32(131), int32(97174))
	mBase = m.M
	v462 = m.ExcPending
	if v462 != 0 {
		goto L30
...
L149:
	;
	F_errmsg(m, int32(460237), int32(0))
	mBase = m.M
	v473 = m.ExcPending
	if v473 != 0 {
		goto L30
...
L150:
	;
	F_errfinish(m, int32(494313), int32(135), int32(97174))
	mBase = m.M
	v478 = m.ExcPending
	if v478 != 0 {
		goto L30
...
L153:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+32)) = v494
	F_errmsg(m, int32(460086), v11+int32(32))
	mBase = m.M
	v500 = m.ExcPending
	if v500 != 0 {
		goto L30
...
L154:
	;
	F_errfinish(m, int32(494313), int32(154), int32(97174))
	mBase = m.M
	v505 = m.ExcPending
	if v505 != 0 {
		goto L30
...
L159:
	;
	F_errfinish(m, int32(494313), int32(195), int32(97174))
	mBase = m.M
	v530 = m.ExcPending
	if v530 != 0 {
		goto L30
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(491502), int32(2176), int32(81839))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		if v17 != 0 {
			...
			if v20 != 0 {
				...
				if v24 != 0 {
					...
					F_errfinish(m, int32(491502), int32(2190), int32(228407))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = v20
				...
				if v24 != 0 {
					...
					F_errfinish(m, int32(491502), int32(2427), int32(81927))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
			...
			if v27 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v28
				...
				if v32 != 0 {
					...
					F_errfinish(m, int32(491502), int32(2442), int32(228339))
					mBase = m.M
					v37 = m.ExcPending
					if v37 != 0 {
						return int32(0)
...
L305:
	;
	F_errfinish(m, int32(491633), int32(6950), int32(305656))
	mBase = m.M
	v1201 = m.ExcPending
	if v1201 != 0 {
		goto L1
...
L308:
	;
	F_errfinish(m, int32(491633), int32(2422), int32(305105))
	mBase = m.M
	v1215 = m.ExcPending
	if v1215 != 0 {
		goto L1
		...
		*(*int32)(unsafe.Add(mBase, _consts[901])) = int32(-1)
		...
		if v32 != 0 {
			...
			if v36 != 0 {
				...
				F_errfinish(m, int32(494946), int32(882), int32(129468))
				mBase = m.M
				v41 = m.ExcPending
				if v41 != 0 {
					return
...
L22:
	;
	F_errfinish(m, int32(494946), int32(1346), int32(308971))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L4
...
L22:
	;
	F_errfinish(m, int32(494946), int32(1077), int32(324991))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L4
		...
		if v9 != 0 {
			...
			if v13 != 0 {
				...
				if v16 != 0 {
					...
					F_errfinish(m, int32(495662), int32(376), int32(289834))
					mBase = m.M
					v21 = m.ExcPending
					if v21 != 0 {
						return
...
L22:
	;
	F_errfinish(m, int32(496269), int32(513), int32(411297))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L19
...
L167:
	;
	F_errfinish(m, int32(496827), int32(3756), int32(372243))
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L22
...
L180:
	;
	F_errfinish(m, int32(496827), int32(3782), int32(372243))
	mBase = m.M
	v442 = m.ExcPending
	if v442 != 0 {
		goto L22
...
L188:
	;
	F_errfinish(m, int32(496827), int32(3808), int32(372243))
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L22
...
L224:
	;
	F_errfinish(m, int32(496827), int32(3866), int32(372243))
	mBase = m.M
	v568 = m.ExcPending
	if v568 != 0 {
		goto L22
...
L228:
	;
	F_errfinish(m, int32(496827), int32(3871), int32(372243))
	mBase = m.M
	v585 = m.ExcPending
	if v585 != 0 {
		goto L22
...
L230:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v590
	F_errmsg_internal(m, int32(473212), v17)
	mBase = m.M
	v594 = m.ExcPending
	if v594 != 0 {
		goto L22
...
L231:
	;
	F_errfinish(m, int32(496827), int32(3403), int32(150018))
	mBase = m.M
	v599 = m.ExcPending
	if v599 != 0 {
		goto L22
...
L279:
	;
	F_errfinish(m, int32(496827), int32(3837), int32(372243))
	mBase = m.M
	v766 = m.ExcPending
	if v766 != 0 {
		goto L22
...
L324:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v19
	F_errmsg_internal(m, int32(479919), v17+int32(16))
	mBase = m.M
	v881 = m.ExcPending
	if v881 != 0 {
		goto L22
...
L325:
	;
	F_errfinish(m, int32(496827), int32(3427), int32(150018))
	mBase = m.M
	v886 = m.ExcPending
	if v886 != 0 {
		goto L22
