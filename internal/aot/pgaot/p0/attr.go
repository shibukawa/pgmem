...
func F_GetAttrDefaultColumnAddress(m *base.Module, l0 int32, l1 int32) {
	...
	v9 = v7 - int32(48)
	m.G0 = v9
	v12 = *(*int64)(unsafe.Add(mBase, _c_F_GetAttrDefaultColumnAddress[0]))
	*(*int64)(unsafe.Add(mBase, uint32(l0))) = v12
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_GetAttrDefaultColumnAddress[1]))
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = l0
	F_errmsg_internal(m, int32(_a_F_RemoveAttrDefault_0), v13)
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L1
