				...
				if v19 <= int32(0) {
					...
					if v47 != 0 {
						...
						if v50 != 0 {
							...
							F_errmsg(m, int32(587652), int32(0))
							mBase = m.M
							v54 = m.ExcPending
							if v54 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(523450), int32(495), int32(292288))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return int32(0)
						...
						if v63 != 0 {
							...
							if v66 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(1000000000)
								F_errmsg(m, int32(500180), v5)
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(523450), int32(500), int32(292288))
									mBase = m.M
									v76 = m.ExcPending
									if v76 != 0 {
										return int32(0)
				...
				if v31 != 0 {
					...
					if v34 != 0 {
						...
						if v38 != 0 {
							...
							F_errfinish(m, int32(523450), int32(490), int32(292288))
							mBase = m.M
							v43 = m.ExcPending
							if v43 != 0 {
								return int32(0)
