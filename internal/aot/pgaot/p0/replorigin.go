	...
	if v2 != 0 {
		...
		if v15 != 0 {
			...
			if v35 != 0 {
				...
				if v38 != 0 {
					...
					F_errmsg(m, int32(14092), int32(0))
					mBase = m.M
					v42 = m.ExcPending
					if v42 != 0 {
						return
					} else {
						F_errfinish(m, int32(485406), int32(200), int32(156360))
						mBase = m.M
						v47 = m.ExcPending
						if v47 != 0 {
							return
		...
		if v19 != 0 {
			...
			if v22 != 0 {
				...
				F_errmsg(m, int32(542420), int32(0))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return
				} else {
					F_errfinish(m, int32(485406), int32(195), int32(156360))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return
...
L46:
	;
	F_errmsg(m, int32(320399), int32(0))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L22
...
L48:
	;
	F_errfinish(m, int32(485406), int32(277), int32(347402))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L22
...
L51:
	;
	F_errmsg(m, int32(531582), int32(0))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L22
...
L52:
	;
	F_errfinish(m, int32(485406), int32(359), int32(347402))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L22
	...
	if v3 == int32(0) {
		...
		if v9 != 0 {
			...
			if v12 != 0 {
				...
				F_errmsg(m, int32(440383), int32(0))
				mBase = m.M
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
					F_errfinish(m, int32(485406), int32(1222), int32(103230))
					mBase = m.M
					v21 = m.ExcPending
					if v21 != 0 {
						return
...
L41:
	;
	F_errmsg(m, int32(227434), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L4
...
L42:
	;
	F_errfinish(m, int32(485406), int32(1137), int32(227337))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L4
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v154
	F_errmsg(m, int32(468958), v13+int32(32))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L4
...
L46:
	;
	F_errfinish(m, int32(485406), int32(1167), int32(227337))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L4
...
L50:
	;
	F_errhint(m, int32(591193), int32(0))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L4
...
L51:
	;
	F_errfinish(m, int32(485406), int32(1181), int32(227337))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L4
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v1
	F_errmsg_internal(m, int32(457089), v13+int32(16))
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L4
...
L54:
	;
	F_errfinish(m, int32(485406), int32(1198), int32(227337))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L4
