...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+72)) = int32(4)
	v78 = F_table_open(m, int32(_a_F_replorigin_create_0), int32(7))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L22
...
L26:
	;
	v88 = *(*int32)(unsafe.Add(mBase, _c_F_replorigin_create[0]))
	if v88 != 0 {
		goto L28
	} else {
		goto L29
...
L32:
	;
	v99 = int32(1)
	v105 = F_systable_beginscan(m, v78, int32(_a_F_replorigin_create_1), v99, v9+int32(72), v99, v9+int32(24))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L22
...
L36:
	;
	v114 = v81 + int32(1)
	if v114 != int32(_a_F_replorigin_create_2) {
		v81 = v114
		goto L26
	} else {
		goto L37
