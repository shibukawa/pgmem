	...
	if v2 != 0 {
		...
		if v19 != 0 {
			...
			if v22 != 0 {
				...
				F_errmsg(m, int32(546698), int32(0))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return
				} else {
					F_errfinish(m, int32(488926), int32(195), int32(157487))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return
...
L46:
	;
	F_errmsg(m, int32(322796), int32(0))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L22
...
L48:
	;
	F_errfinish(m, int32(488926), int32(277), int32(349858))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L22
...
L51:
	;
	F_errmsg(m, int32(535244), int32(0))
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L22
...
L52:
	;
	F_errfinish(m, int32(488926), int32(359), int32(349858))
	mBase = m.M
	v184 = m.ExcPending
	if v184 != 0 {
		goto L22
	...
	if v3 == int32(0) {
		...
		if v9 != 0 {
			...
			if v12 != 0 {
				...
				F_errmsg(m, int32(443648), int32(0))
				mBase = m.M
				v16 = m.ExcPending
				if v16 != 0 {
					return
				} else {
					F_errfinish(m, int32(488926), int32(1222), int32(104216))
					mBase = m.M
					v21 = m.ExcPending
					if v21 != 0 {
						return
...
L41:
	;
	F_errmsg(m, int32(229197), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L4
...
L42:
	;
	F_errfinish(m, int32(488926), int32(1137), int32(229100))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L4
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v154
	F_errmsg(m, int32(472310), v13+int32(32))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L4
...
L46:
	;
	F_errfinish(m, int32(488926), int32(1167), int32(229100))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L4
...
L50:
	;
	F_errhint(m, int32(595971), int32(0))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L4
...
L51:
	;
	F_errfinish(m, int32(488926), int32(1181), int32(229100))
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L4
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v1
	F_errmsg_internal(m, int32(460441), v13+int32(16))
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L4
...
L54:
	;
	F_errfinish(m, int32(488926), int32(1198), int32(229100))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L4
