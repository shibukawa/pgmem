		...
		if v55 != 0 {
			...
			if v58 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = v14
				F_errmsg(m, int32(334340), v9)
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(493170), int32(1654), int32(371396))
					mBase = m.M
					v69 = m.ExcPending
					if v69 != 0 {
						return int32(0)
				...
				if v20 != int64(9223372036854775807) {
					...
					if v32 != 0 {
						...
						if v35 != 0 {
							...
							F_errmsg(m, int32(371642), int32(0))
							mBase = m.M
							v39 = m.ExcPending
							if v39 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(493170), int32(2149), int32(306201))
								mBase = m.M
								v44 = m.ExcPending
								if v44 != 0 {
									return int32(0)
