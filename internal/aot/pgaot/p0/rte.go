...
L36:
	;
	F_errfinish(m, int32(493158), int32(1112), int32(35299))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L15
...
L39:
	;
	F_errfinish(m, int32(493158), int32(1144), int32(35299))
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L15
...
L42:
	;
	F_errfinish(m, int32(493158), int32(1129), int32(35299))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L15
				...
				if l5 == int32(0) {
					...
					if v56 != 0 {
						...
						if v60 != 0 {
							...
							F_errfinish(m, int32(492736), int32(1475), int32(165867))
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return int32(0)
