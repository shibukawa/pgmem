...
func F_AlterDomainAddConstraint(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	v12 = v10 - int32(32)
	m.G0 = v12
	v15 = *(*int64)(unsafe.Add(mBase, _c_F_AlterDomainAddConstraint[0]))
	*(*int64)(unsafe.Add(mBase, uint32(l0))) = v15
	v18 = *(*int32)(unsafe.Add(mBase, _c_F_AlterDomainAddConstraint[1]))
...
func F_AlterDomainNotNull(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v16 = v14 - int32(32)
	m.G0 = v16
	v19 = *(*int64)(unsafe.Add(mBase, _c_F_AlterDomainNotNull[0]))
	*(*int64)(unsafe.Add(mBase, uint32(l0))) = v19
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_AlterDomainNotNull[1]))
...
L41:
	;
	v170 = *(*int32)(unsafe.Add(mBase, _c_F_AlterDomainNotNull[2]))
	if v170 != 0 {
		goto L42
	} else {
		goto L43
...
L8:
	;
	v265 = *(*int32)(unsafe.Add(mBase, _c_F_AlterSetting[0]))
	if v265 != 0 {
		goto L70
	} else {
		goto L71
...
L6:
	;
	v55 = int32(_a_F_transformAlterTableStmt_0)
	goto L8
L7:
	;
	v55 = int32(_a_F_transformAlterTableStmt_1)
	goto L8
L8:
	;
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v145
	F_errmsg_internal(m, int32(_a_F_transformAlterTableStmt_2), v23+int32(16))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L1
...
L55:
	;
	v209 = F_makeDefElem(m, int32(_a_F_transformAlterTableStmt_5), v206, int32(-1))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L1
...
L70:
	...
	v293 = int32(_a_F_transformAlterTableStmt_6)
	v296 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformAlterTableStmt[0])))
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+96)) = v356 + int32(4)
	F_errmsg(m, int32(_a_F_transformAlterTableStmt_7), v23+int32(96))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L1
...
L102:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+112)) = v377 + int32(4)
	F_errmsg(m, int32(_a_F_transformAlterTableStmt_10), v23+int32(112))
	mBase = m.M
	v385 = m.ExcPending
	if v385 != 0 {
		goto L1
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+128)) = v398 + int32(4)
	F_errmsg(m, int32(_a_F_transformAlterTableStmt_12), v23+int32(128))
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L1
...
L109:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+80)) = v416 + int32(4)
	F_errmsg_internal(m, int32(_a_F_transformAlterTableStmt_14), v23+int32(80))
	mBase = m.M
	v424 = m.ExcPending
	if v424 != 0 {
		goto L1
...
L113:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+36)) = v437 + int32(4)
	F_errmsg(m, int32(_a_F_transformAlterTableStmt_16), v23+int32(32))
	mBase = m.M
	v447 = m.ExcPending
	if v447 != 0 {
		goto L1
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+52)) = v460 + int32(4)
	F_errmsg(m, int32(_a_F_transformAlterTableStmt_16), v23+int32(48))
	mBase = m.M
	v470 = m.ExcPending
	if v470 != 0 {
		goto L1
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+68)) = v516 + int32(4)
	F_errmsg(m, int32(_a_F_transformAlterTableStmt_16), v23-int32(-64))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L1
...
L189:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v978
	F_errmsg_internal(m, int32(_a_F_transformAlterTableStmt_17), v23)
	mBase = m.M
	v982 = m.ExcPending
	if v982 != 0 {
		goto L1
