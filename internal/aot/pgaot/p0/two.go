...
L3:
	;
	v16 = *(*int32)(unsafe.Add(mBase, _c_F_TwoPhaseGetGXact[1]))
	v76 = v16
	goto L2
L4:
	;
...
L6:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _c_F_TwoPhaseGetGXact[2]))
...
L8:
	;
	v29 = *(*int32)(unsafe.Add(mBase, _c_F_TwoPhaseGetGXact[3]))
...
L17:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _c_F_TwoPhaseGetGXact[2]))
