...
func F_gbt_bitle(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = F_DirectFunctionCall2Coll(m, int32(2662), int32(0), l0, l1)
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
...
func F_gbt_bool_sortsupport(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_bool_sortsupport_0)
	return v3
}
func F_gbt_bool_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(2)
		...
		v15 = F_gbt_num_union(m, v6, v4, int32(_a_F_gbt_bool_union_0), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_cash_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = v15
	...
	v37 = F_gbt_num_consistent(m, v7+int32(12), v7+int32(24), v7+int32(22), v32&int32(1), int32(_a_F_gbt_cash_consistent_0), v36)
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		return int32(0)
...
func F_gbt_cash_same(m *base.Module, l0 int32) int32 {
	...
	v8 = F_gbt_num_same(m, v4, v5, int32(_a_F_gbt_cash_same_0), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_date_distance(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v12
	...
	v29 = F_gbt_num_distance(m, v7+v13, v7+int32(12), v24&int32(1), int32(_a_F_gbt_date_distance_0), v28)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		return int32(0)
		...
		if v24 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v25
			...
			if v35 != 0 {
				...
				v40 = F_DirectFunctionCall2Coll(m, int32(2446), int32(0), v38, v39)
				mBase = m.M
				v41 = m.ExcPending
				if v41 != 0 {
					return int32(0)
...
func F_gbt_date_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(8)
		v14 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
		v15 = F_gbt_num_union(m, v6, v4, int32(_a_F_gbt_date_union_0), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_datekey_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v10 = F_DirectFunctionCall2Coll(m, int32(1447), int32(0), v7, v9)
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
		return int32(0)
		...
		if v10 != 0 {
			...
			v18 = F_DirectFunctionCall2Coll(m, int32(1447), int32(0), v16, v17)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
...
func F_gbt_enumgt(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v6 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l1)))
	v8 = F_CallerFInfoFunctionCall2(m, int32(3811), l2, int32(0), v6, v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_float8_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(16)
		v14 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
		v15 = F_gbt_num_union(m, v6, v4, int32(_a_F_gbt_float8_union_0), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_int2_same(m *base.Module, l0 int32) int32 {
	...
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(_a_F_gbt_int2_same_0), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_int8_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = v15
	...
	v32 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v29+v30)+12)))
	v36 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v37 = F_gbt_num_consistent(m, v7+int32(12), v7+int32(24), v7+int32(22), v32&int32(1), int32(_a_F_gbt_int8_consistent_0), v36)
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		return int32(0)
...
func F_gbt_int8_same(m *base.Module, l0 int32) int32 {
	...
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(_a_F_gbt_int8_same_0), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_intv_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v14
	...
	v34 = F_gbt_num_consistent(m, v8+int32(4), v10, v8+int32(14), v29&int32(1), int32(_a_F_gbt_intv_consistent_0), v33)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		return int32(0)
...
func F_gbt_intvgt(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F_DirectFunctionCall2Coll(m, int32(2466), int32(0), l0, l1)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_gbt_intvle(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F_DirectFunctionCall2Coll(m, int32(2464), int32(0), l0, l1)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_gbt_macad_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(16)
		v14 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
		v15 = F_gbt_num_union(m, v6, v4, int32(_a_F_gbt_macad_union_0), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_macadge(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F_DirectFunctionCall2Coll(m, int32(2283), int32(0), l0, l1)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_gbt_macadkey_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v8 = F_DirectFunctionCall2Coll(m, int32(2285), int32(0), v6, v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
		...
		if v8 != 0 {
			...
			v14 = int32(6)
			v18 = F_DirectFunctionCall2Coll(m, int32(2285), int32(0), v6+v14, v7+v14)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
...
func F_gbt_numeric_cmp(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = F_DirectFunctionCall2Coll(m, int32(1346), int32(0), l0, l1)
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
...
func F_gbt_numeric_same(m *base.Module, l0 int32) int32 {
	...
	v9 = F_gbt_var_same(m, v4, v5, v6, int32(_a_F_gbt_numeric_same_0), v8)
	mBase = m.M
	v12 = m.ExcPending
	if v12 != 0 {
		return int32(0)
...
func F_gbt_oid_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(8)
		v14 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
		v15 = F_gbt_num_union(m, v6, v4, int32(_a_F_gbt_oid_union_0), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_text_consistent(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v18))) = uint8(v42)
		v45 = *(*int32)(unsafe.Add(mBase, _c_F_gbt_text_consistent[0]))
		if v45 == v42 {
			v50 = *(*int32)(unsafe.Add(mBase, _c_F_gbt_text_consistent[1]))
			v51 = *(*int32)(unsafe.Add(mBase, uint32(v50)+4))
			v56 = *(*int32)(unsafe.Add(mBase, uint32(v51*int32(28))+uint32(_c_F_gbt_text_consistent[2])))
			*(*int32)(unsafe.Add(mBase, _c_F_gbt_text_consistent[0])) = v56
		} else {
		}
		...
		v71 = F_gbt_var_consistent(m, v9+int32(8), v13, v17&int32(_a_F_gbt_text_consistent_0), v62, v66&int32(1), int32(_a_F_gbt_text_consistent_1), v70)
		mBase = m.M
		v72 = m.ExcPending
		if v72 != 0 {
			return int32(0)
...
func F_gbt_textle(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F_DirectFunctionCall2Coll(m, int32(2248), l2, l0, l1)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_gbt_time_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = v15
	...
	v32 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v29+v30)+12)))
	v36 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v37 = F_gbt_num_consistent(m, v7+int32(12), v7+int32(24), v7+int32(22), v32&int32(1), int32(_a_F_gbt_time_consistent_0), v36)
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		return int32(0)
...
func F_gbt_time_dist(m *base.Module, l0 int32, l1 int32, l2 int32) float64 {
	...
	var v18 int64
	_ = v18
	v6 = F_DirectFunctionCall2Coll(m, int32(2724), int32(0), l0, l1)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return float64(0)
...
func F_gbt_ts_dist(m *base.Module, l0 int32, l1 int32, l2 int32) float64 {
	...
	if base.Ui64(v6-int64(9223372036854775807)) < base.Ui64(int64(2)) {
		...
		if base.Ui64(v11-int64(9223372036854775807)) < base.Ui64(int64(2)) {
			...
			v18 = F_DirectFunctionCall2Coll(m, int32(1520), int32(0), l0, l1)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return float64(0)
