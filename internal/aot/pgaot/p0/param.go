...
L6:
	...
	v38 = F_AllocSetContextCreateInternal(m, v33, int32(309948), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L5
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(706478)
	F_appendStringInfo(m, v14+int32(32), int32(694440), v14+int32(16))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L5
...
L12:
	;
	F_appendStringInfoString(m, v14+int32(32), int32(501198))
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
		goto L5
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(695311)
	v114 = v104 + int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = v114
	F_appendStringInfo(m, v14+int32(32), int32(694440), v14)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L5
...
func F_count_param_references(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if l0 == v3 {
		...
		if v6 == int32(8) {
			...
			v25 = F_expression_tree_walker_impl(m, l0, int32(5188), l1)
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return int32(0)
