...
func F_EvalPlanQualSlot(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v11 != 0 {
		...
		v12 = int32(_a_F_EvalPlanQualSlot_0)
		v13 = *(*int32)(unsafe.Add(mBase, _c_F_EvalPlanQualSlot[0]))
		v15 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
		v16 = *(*int32)(unsafe.Add(mBase, uint32(v15)+100))
		*(*int32)(unsafe.Add(mBase, _c_F_EvalPlanQualSlot[0])) = v16
		...
		if v23 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _c_F_EvalPlanQualSlot[0])) = v13
