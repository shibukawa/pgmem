...
func F_MemoryContextCreate(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = l2*int32(36) + int32(1719520)
	if l3 != 0 {
...
L26:
	;
	v109 = int32(0)
	v111 = *(*int32)(unsafe.Add(mBase, _consts[902]))
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+12)) = v142
	v151 = F_pg_fprintf(m, v111, int32(699776), v11)
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L1
...
L32:
	;
	v125 = F_pg_fprintf(m, v111, int32(695481), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L1
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+44)) = v174
	F_errmsg_internal(m, int32(422323), v11+int32(32))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L1
...
L41:
	;
	F_errfinish(m, int32(462403), int32(956), int32(293306))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L1
...
L1:
	;
	v61 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+4)) = uint8(v61)
	v64 = v60 + int32(1)
	v66 = *(*int32)(unsafe.Add(mBase, uint32(l0)+12))
	v67 = *(*int32)(unsafe.Add(mBase, uint32(v66)))
	v68 = m.T0[v67].(func(*base.Module, int32, int32, int32) int32)(m, l0, v64, v61)
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L18
...
L21:
	;
	v72 = F__emscripten_memcpy_bulkmem(m, v68, l1, v64)
	mBase = m.M
	v73 = v72
	goto L23
L22:
