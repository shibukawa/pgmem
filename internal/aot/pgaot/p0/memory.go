...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+12)) = v142
	v151 = F_pg_fprintf(m, v111, int32(750690), v11)
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L1
...
L32:
	;
	v125 = F_pg_fprintf(m, v111, int32(746395), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L1
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+44)) = v174
	F_errmsg_internal(m, int32(449255), v11+int32(32))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L1
...
L41:
	;
	F_errfinish(m, int32(492702), int32(956), int32(312650))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L1
