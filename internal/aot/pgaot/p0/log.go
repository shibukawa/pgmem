		...
		if v10 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v58
			...
			if v64 != 0 {
				...
				F_errfinish(m, int32(518546), v68, int32(88637))
				mBase = m.M
				v71 = m.ExcPending
				if v71 != 0 {
					return
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, _consts[292])) = v48
	v144 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[981])) = uint8(v144)
	F_pg_re_throw(m)
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, _consts[492])) = int32(0)
	v31 = int32(*(*uint8)(unsafe.Add(mBase, _consts[981])))
	if v31 != 0 {
		goto L7
	} else {
		goto L11
...
L11:
	;
	v34 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[981])) = uint8(v34)
...
L23:
	;
	F_errfinish(m, int32(511728), int32(1319), int32(89376))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L5
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, _consts[74])) = v49
	v127 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[981])) = uint8(v127)
	goto L7
L30:
	;
	F_errhidecontext(m)
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v75)+44)) = v105
	F_errmsg_internal(m, int32(466587), v75+int32(32))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L5
...
L32:
	;
	F_errfinish(m, int32(511728), int32(867), int32(317886))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L5
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v59
	v270 = F_format_elog_string(m, int32(692685), v10)
	mBase = m.M
	v271 = m.ExcPending
	if v271 != 0 {
		goto L2
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v161*v158 + v73
	v168 = F_pg_snprintf(m, l0, int32(32), int32(483636), v13)
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L34
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v186*v183 + v73
	v195 = F_pg_snprintf(m, l0, int32(32), int32(483636), v13+int32(16))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L34
...
func F_check_log_of_query(m *base.Module, l0 int32) int32 {
	...
	_ = v26
	v2 = int32(0)
	v6 = *(*int32)(unsafe.Add(mBase, _consts[922]))
