		...
		if v10 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v58
			...
			if v64 != 0 {
				...
				F_errfinish(m, int32(523077), v68, int32(89205))
				mBase = m.M
				v71 = m.ExcPending
				if v71 != 0 {
					return
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, _consts[74])) = v49
	*(*int32)(unsafe.Add(mBase, _consts[291])) = v48
	v144 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[980])) = uint8(v144)
	F_pg_re_throw(m)
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
...
L8:
	...
	v25 = v17 - int32(160)
	m.G0 = v25
	*(*int32)(unsafe.Add(mBase, _consts[491])) = int32(0)
	v31 = int32(*(*uint8)(unsafe.Add(mBase, _consts[980])))
	if v31 != 0 {
		goto L7
	} else {
		goto L11
...
L11:
	;
	v34 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[980])) = uint8(v34)
	v37 = *(*int32)(unsafe.Add(mBase, _consts[291]))
	v39 = *(*int32)(unsafe.Add(mBase, _consts[74]))
	goto L12
L12:
	;
...
L20:
	;
	v72 = *(*int32)(unsafe.Add(mBase, _consts[84]))
	v73 = m.G0
	v75 = v73 - int32(80)
	m.G0 = v75
	v77 = int64(0)
...
L22:
	;
	v61 = *(*int32)(unsafe.Add(mBase, _consts[519]))
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v61
	F_errmsg(m, int32(502808), v11)
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L5
...
L23:
	;
	F_errfinish(m, int32(516120), int32(1319), int32(89944))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L5
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, _consts[74])) = v49
	v127 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[980])) = uint8(v127)
	goto L7
L30:
	;
	F_errhidecontext(m)
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v75)+44)) = v105
	F_errmsg_internal(m, int32(470509), v75+int32(32))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L5
...
L32:
	;
	F_errfinish(m, int32(516120), int32(867), int32(320518))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L5
...
L5:
	;
	v26 = *(*int32)(unsafe.Add(mBase, _consts[163]))
	*(*int32)(unsafe.Add(mBase, _consts[186])) = v26
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _consts[552])) = v31
	F_pfree(m, v13)
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
...
L11:
	;
	v265 = *(*int32)(unsafe.Add(mBase, _consts[163]))
	*(*int32)(unsafe.Add(mBase, _consts[186])) = v265
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v59
	v270 = F_format_elog_string(m, int32(698432), v10)
	mBase = m.M
	v271 = m.ExcPending
	if v271 != 0 {
		goto L2
...
L79:
	;
	*(*int32)(unsafe.Add(mBase, _consts[552])) = v270
	F_pfree(m, v13)
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
...
func F_check_log_duration(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v13 = v11 - int32(32)
	m.G0 = v13
	v16 = int32(*(*uint8)(unsafe.Add(mBase, _consts[660])))
	if v16 != 0 {
		goto L2
	} else {
		goto L3
...
L2:
	;
	v30 = *(*int64)(unsafe.Add(mBase, _consts[92]))
	v34 = m.G0
	v35 = int32(16)
	v36 = v34 - v35
	m.G0 = v36
...
L3:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[662]))
	if int32(0) <= v18 {
		goto L2
	} else {
		goto L4
...
L4:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _consts[661]))
	if int32(0) <= v22 {
		goto L2
	} else {
		goto L5
...
L5:
	;
	v26 = int32(*(*uint8)(unsafe.Add(mBase, _consts[664])))
	if v26 != int32(1) {
		v209 = int32(0)
		goto L1
	} else {
...
L8:
	...
	v75 = *(*int32)(unsafe.Add(mBase, _consts[661]))
	if v75 == int32(0) {
		goto L14
	} else {
		goto L15
...
L13:
	;
	v93 = int32(0)
	v95 = *(*int32)(unsafe.Add(mBase, _consts[662]))
	if v95 == v93 {
		goto L25
	} else {
		goto L26
...
L22:
	;
	v173 = int32(0)
	v175 = int32(*(*uint8)(unsafe.Add(mBase, _consts[660])))
	if v175 == v173 {
		goto L37
	} else {
		goto L38
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v161*v158 + v73
	v168 = F_pg_snprintf(m, l0, int32(32), int32(487641), v13)
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L34
...
L25:
	;
	v110 = *(*float64)(unsafe.Add(mBase, _consts[663]))
...
L32:
	;
	v143 = *(*float64)(unsafe.Add(mBase, _consts[663]))
...
L37:
	;
	v179 = int32(*(*uint8)(unsafe.Add(mBase, _consts[664])))
	if v179 != int32(1) {
		v209 = v173
		goto L1
	} else {
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v186*v183 + v73
	v195 = F_pg_snprintf(m, l0, int32(32), int32(487641), v13+int32(16))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L34
...
L42:
	;
	v198 = int32(*(*uint8)(unsafe.Add(mBase, _consts[664])))
...
func F_check_log_of_query(m *base.Module, l0 int32) int32 {
	...
	_ = v26
	v2 = int32(0)
	v6 = *(*int32)(unsafe.Add(mBase, _consts[921]))
