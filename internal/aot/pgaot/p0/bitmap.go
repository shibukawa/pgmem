...
func F_compute_bitmap_pages(m *base.Module, l0 int32, l1 int32, l2 int32, l3 float64, l4 int32, l5 int32) float64 {
	...
	case 0:
		...
		v90 = int32(16)
		v92 = *(*int32)(unsafe.Add(mBase, _consts[323]))
		...
		if base.F64_gt(l3, float64(1)) != 0 {
			...
			if v105 != 0 {
				...
				v113 = float64(1)
				v115 = *(*int32)(unsafe.Add(mBase, _consts[382]))
	...
	default:
		...
		if v38 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v22))) = v39
			F_errmsg_internal(m, int32(509011), v22)
			mBase = m.M
			v43 = m.ExcPending
			if v43 != 0 {
				return float64(0)
...
L14:
	;
	v139 = *(*float64)(unsafe.Add(mBase, _consts[377]))
...
L25:
	...
	v188 = int32(*(*uint8)(unsafe.Add(mBase, _consts[380])))
...
L28:
	...
	v149 = int32(*(*uint8)(unsafe.Add(mBase, _consts[378])))
	if v149 == int32(1) {
		goto L29
	} else {
		goto L30
...
L19:
	;
	v96 = *(*float64)(unsafe.Add(mBase, _consts[381]))
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v82))) = v128
	F_errmsg_internal(m, int32(509011), v82)
	mBase = m.M
	v132 = m.ExcPending
	if v132 != 0 {
		goto L1
...
L206:
	;
	v1189 = *(*float64)(unsafe.Add(mBase, _consts[381]))
...
L215:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1176))) = v1239
	F_errmsg_internal(m, int32(509011), v1176)
	mBase = m.M
	v1243 = m.ExcPending
	if v1243 != 0 {
		goto L1
