...
func F_publicationListToArray(m *base.Module, l0 int32) int32 {
	...
	v12 = F_AllocSetContextCreateInternal(m, v7, int32(25087), v2, int32(8192), int32(8388608))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
								...
								if v38 != 0 {
									...
									if v40 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v10))) = v39
										F_errmsg(m, int32(692304), v10)
										mBase = m.M
										v46 = m.ExcPending
										if v46 != 0 {
											return
										} else {
											F_errfinish(m, int32(494582), int32(701), int32(504350))
											mBase = m.M
											v51 = m.ExcPending
											if v51 != 0 {
												return
							...
							if v138 != 0 {
								...
								if v140 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v139
									F_errmsg(m, int32(265955), v10+int32(16))
									mBase = m.M
									v146 = m.ExcPending
									if v146 != 0 {
										return
									} else {
										F_errdetail(m, int32(585735), int32(0))
										mBase = m.M
										v150 = m.ExcPending
										if v150 != 0 {
											return
										} else {
											F_errfinish(m, int32(494582), int32(103), int32(504344))
											mBase = m.M
											v155 = m.ExcPending
											if v155 != 0 {
												return
										...
										if v162 != 0 {
											...
											if v164 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v163
												F_errmsg(m, int32(265955), v10+int32(32))
												mBase = m.M
												v170 = m.ExcPending
												if v170 != 0 {
													return
												} else {
													F_errdetail(m, int32(631350), int32(0))
													mBase = m.M
													v174 = m.ExcPending
													if v174 != 0 {
														return
													} else {
														F_errfinish(m, int32(494582), int32(111), int32(504344))
														mBase = m.M
														v179 = m.ExcPending
														if v179 != 0 {
															return
