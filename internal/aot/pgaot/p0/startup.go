...
L14:
	...
	v56 = int32(24)
	v58 = int32(_a_F_ProcessStartupPacket_0)
	v60 = int32(8)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+44)) = v70 - int32(4)
	if base.Ui32(v70-int32(_a_F_ProcessStartupPacket_1)) <= base.Ui32(int32(-9998)) {
		goto L22
	} else {
		goto L23
	}
...
L19:
	;
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_2), int32(0))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L20:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(540), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L28:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(552), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L34:
	;
	v130 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[0])) = uint8(v130)
	goto L40
L35:
	;
	if v113 == int32(0) {
...
L38:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(568), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L1
...
L40:
	...
	v133 = int32(24)
	v135 = int32(_a_F_ProcessStartupPacket_0)
	v137 = int32(8)
...
L41:
	;
	v640 = int32(0)
	v642 = int32(_a_F_ProcessStartupPacket_6)
...
L55:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(896), int32(_a_F_ProcessStartupPacket_8))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L1
...
L62:
	...
	v205 = int32(24)
	v207 = int32(_a_F_ProcessStartupPacket_0)
	v209 = int32(8)
...
L65:
	;
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_9), int32(0))
	mBase = m.M
	v198 = m.ExcPending
	if v198 != 0 {
		goto L1
...
L66:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(904), int32(_a_F_ProcessStartupPacket_8))
	mBase = m.M
	v203 = m.ExcPending
	if v203 != 0 {
		goto L1
...
L70:
	;
	v228 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[1]))
...
L76:
	;
	v245 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[2]))
...
L81:
	;
	F_s_lock(m, v257, int32(_a_F_ProcessStartupPacket_10), int32(754), int32(_a_F_ProcessStartupPacket_11))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L1
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v257))) = int32(0)
	v268 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[1]))
	v269 = v268
	goto L80
L86:
	;
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v225)+32)) = v219
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_12), v225+int32(32))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L1
...
L89:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_10), int32(798), int32(_a_F_ProcessStartupPacket_11))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		goto L1
...
L92:
	;
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_13), int32(0))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L1
...
L93:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_10), int32(733), int32(_a_F_ProcessStartupPacket_11))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L1
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v225))) = v219
	F_errmsg_internal(m, int32(_a_F_ProcessStartupPacket_14), v225)
	mBase = m.M
	v436 = m.ExcPending
	if v436 != 0 {
		goto L1
...
L119:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_10), int32(772), int32(_a_F_ProcessStartupPacket_11))
	mBase = m.M
	v441 = m.ExcPending
	if v441 != 0 {
		goto L1
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v225)+16)) = v219
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_15), v225+int32(16))
	mBase = m.M
	v471 = m.ExcPending
	if v471 != 0 {
		goto L1
...
L124:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_10), int32(789), int32(_a_F_ProcessStartupPacket_11))
	mBase = m.M
	v476 = m.ExcPending
	if v476 != 0 {
		goto L1
...
L126:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v14)+48)) = uint8(v492)
	v495 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[3])))
	if v495 != int32(1) {
		goto L127
	} else {
		goto L128
...
L130:
	;
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_16), int32(0))
	mBase = m.M
	v507 = m.ExcPending
	if v507 != 0 {
		goto L1
...
L131:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(612), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v512 = m.ExcPending
	if v512 != 0 {
		goto L1
...
L133:
	;
	v554 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[4]))
	v556 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[5]))
	goto L144
L134:
	;
...
L137:
	;
	v532 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[6]))
	if v532 == int32(27) {
		goto L134
	} else {
		goto L138
...
L142:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(621), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v552 = m.ExcPending
	if v552 != 0 {
		goto L1
...
L147:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v14)+48)) = uint8(v566)
	v569 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[3])))
	if v569 != int32(1) {
		goto L148
	} else {
		goto L149
...
L152:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(666), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v586 = m.ExcPending
	if v586 != 0 {
		goto L1
...
L154:
	;
	v628 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[4]))
	v630 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[5]))
	goto L165
L155:
	;
...
L158:
	;
	v606 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[6]))
	if v606 == int32(27) {
		goto L155
	} else {
		goto L159
...
L162:
	;
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_19), int32(0))
	mBase = m.M
	v621 = m.ExcPending
	if v621 != 0 {
		goto L1
...
L163:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(675), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v626 = m.ExcPending
	if v626 != 0 {
		goto L1
...
L170:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[7])) = v645
	if base.Ui32(v147-int32(_a_F_ProcessStartupPacket_20)) <= base.Ui32(int32(-65537)) {
		goto L5
	} else {
		goto L171
	}
L171:
	;
	v651 = int32(_a_F_ProcessStartupPacket_21)
	v652 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[8]))
	v655 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[9]))
	*(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[8])) = v655
...
L194:
	;
	v739 = v99 + v737
	v740 = int32(_a_F_ProcessStartupPacket_22)
	v743 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[10])))
...
L206:
	;
	v771 = int32(_a_F_ProcessStartupPacket_23)
	v774 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[11])))
...
L218:
	;
	v802 = int32(_a_F_ProcessStartupPacket_24)
	v805 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[12])))
...
L230:
	;
	v833 = int32(_a_F_ProcessStartupPacket_25)
	v836 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[13])))
...
L240:
	;
	v861 = int32(_a_F_ProcessStartupPacket_22)
	v864 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[10])))
...
L242:
	;
	v922 = int32(_a_F_ProcessStartupPacket_26)
	goto L263
L243:
	;
...
L251:
	;
	v890 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[14])) = uint8(v890)
	*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[15])) = uint8(v890)
	v1015 = v665
	goto L195
L252:
	;
...
L253:
	...
	mBase = m.M
	v897 = F_parse_bool_with_len(m, v739, v896, int32(_a_F_ProcessStartupPacket_27))
	mBase = m.M
	goto L254
L254:
	;
...
L257:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(_a_F_ProcessStartupPacket_25)
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_28), v12+int32(-32))
	mBase = m.M
	v912 = m.ExcPending
	if v912 != 0 {
		goto L1
...
L258:
	;
	F_errhint(m, int32(_a_F_ProcessStartupPacket_29), int32(0))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L1
...
L259:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(784), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v921 = m.ExcPending
	if v921 != 0 {
		goto L1
...
L283:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+372)) = v982
	v985 = int32(_a_F_ProcessStartupPacket_30)
	v988 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[16])))
...
L312:
	;
	v1093 = int32(0)
	if base.B2i32(v1081 == v1093)&base.B2i32(base.Ui32(v147&int32(_a_F_ProcessStartupPacket_31)) <= base.Ui32(int32(2))) == v1093 {
		goto L313
	} else {
		goto L314
	}
...
L316:
	;
	v1109 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[7]))
...
L317:
	...
	v1118 = int32(24)
	v1120 = int32(_a_F_ProcessStartupPacket_0)
	v1122 = int32(8)
...
L321:
	...
	v1147 = int32(24)
	v1149 = int32(_a_F_ProcessStartupPacket_0)
	v1151 = int32(8)
...
L377:
	;
	v1362 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[15])))
	if v1362 != 0 {
		goto L378
	} else {
		goto L379
...
L380:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[17])) = v1363
	if v1362 == int32(0) {
		goto L381
	} else {
		goto L382
...
L381:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[8])) = v652
	v1377 = int32(0)
	goto L8
L382:
	;
	v1368 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ProcessStartupPacket[14])))
	if v1368 != 0 {
		goto L381
	} else {
		goto L383
...
L385:
	;
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_32), int32(0))
	mBase = m.M
	v1399 = m.ExcPending
	if v1399 != 0 {
		goto L1
...
L386:
	;
	F_errdetail(m, int32(_a_F_ProcessStartupPacket_33), int32(0))
	mBase = m.M
	v1403 = m.ExcPending
	if v1403 != 0 {
		goto L1
...
L387:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(640), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v1408 = m.ExcPending
	if v1408 != 0 {
		goto L1
...
L390:
	;
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_34), int32(0))
	mBase = m.M
	v1419 = m.ExcPending
	if v1419 != 0 {
		goto L1
...
L392:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(694), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v1428 = m.ExcPending
	if v1428 != 0 {
		goto L1
...
L395:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = v147 & int32(_a_F_ProcessStartupPacket_31)
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(base.Ui32(v147) >> (uint(int32(16)) % 32))
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_35), v14)
	mBase = m.M
	v1448 = m.ExcPending
	if v1448 != 0 {
		goto L1
...
L396:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(725), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v1453 = m.ExcPending
	if v1453 != 0 {
		goto L1
...
L400:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(825), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v1469 = m.ExcPending
	if v1469 != 0 {
		goto L1
...
L403:
	;
	F_errmsg(m, int32(_a_F_ProcessStartupPacket_37), int32(0))
	mBase = m.M
	v1480 = m.ExcPending
	if v1480 != 0 {
		goto L1
...
L404:
	;
	F_errfinish(m, int32(_a_F_ProcessStartupPacket_3), int32(842), int32(_a_F_ProcessStartupPacket_4))
	mBase = m.M
	v1485 = m.ExcPending
	if v1485 != 0 {
		goto L1
