...
L3:
	;
	v38 = int32(1)
	v42 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(v38)%32))+uint32(_c_F_pg_u_isalpha[0]))))
	return v42 & v38
L4:
	;
...
L3:
	;
	v56 = int32(0)
	if int32(1)<<(uint(v55)%32)&int32(_a_F_pg_u_isgraph_0) != 0 {
		v90 = v56
		goto L2
	} else {
		goto L18
...
L4:
	;
	v52 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v18)+uint32(_c_F_pg_u_isgraph[0]))))
	v55 = v52
	goto L3
L5:
	;
...
L7:
	...
	v35 = int32(1)
	v38 = l0 << (uint(v35) % 32)
	v41 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v38)+uint32(_c_F_pg_u_isgraph[1]))))
	if v35<<(uint(v41)%32)&int32(_a_F_pg_u_isgraph_0) != 0 {
		goto L1
	} else {
		goto L16
	}
...
L16:
	;
	v47 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v38)+uint32(_c_F_pg_u_isgraph[4]))))
...
L19:
	...
	v74 = *(*int32)(unsafe.Add(mBase, uint32(v71)+uint32(_c_F_pg_u_isgraph[5])))
...
L24:
	;
	v80 = *(*int32)(unsafe.Add(mBase, uint32(v71)+uint32(_c_F_pg_u_isgraph[6])))
...
L2:
	...
	v120 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v117)+uint32(_c_F_pg_u_ispunct[0]))))
	if v120&v116 != 0 {
		goto L38
	} else {
		goto L39
...
L4:
	;
	v103 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v80)+uint32(_c_F_pg_u_ispunct[1]))))
	v109 = v103
	goto L3
L5:
	;
	v102 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_c_F_pg_u_ispunct[2]))))
	v109 = v102
	goto L3
L6:
	;
...
L40:
	;
	v127 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v117)+uint32(_c_F_pg_u_ispunct[2]))))
	v133 = v127
	goto L1
}
...
L3:
	;
	v42 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_c_F_pg_u_isspace[0]))))
	return int32(base.Ui32(v42&int32(32)) >> (uint(int32(5)) % 32))
L4:
	;
	v16 = base.I32_div_s(v10+v11, int32(2))
	v18 = v16 << (uint(int32(3)) % 32)
	v21 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_c_F_pg_u_isspace[1])))
	if base.Ui32(v21) < base.Ui32(l0) {
		goto L7
	} else {
		goto L8
...
L9:
	;
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_c_F_pg_u_isspace[2])))
	if base.Ui32(v27) <= base.Ui32(l0) {
		goto L10
	} else {
		goto L11
