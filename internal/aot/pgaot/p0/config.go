				...
				if v8 != int32(16777216) {
					...
					if v76 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v5))) = v8
						F_errmsg_internal(m, int32(508021), v5)
						mBase = m.M
						v80 = m.ExcPending
						if v80 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(526378), int32(2854), int32(398258))
							mBase = m.M
							v85 = m.ExcPending
							if v85 != 0 {
								return int32(0)
			...
			if v8 == int32(33554432) {
				...
				if v39 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v41
					v43 = int32(4560144)
					v49 = F_pg_snprintf(m, v43, v41, int32(572862), v5+int32(16))
					mBase = m.M
					v52 = m.ExcPending
					if v52 != 0 {
						return int32(0)
				...
				if v8 != int32(50331648) {
					...
					if v19 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v5)+32)) = v53
						v55 = int32(4560152)
						v61 = F_pg_snprintf(m, v55, v53, int32(572862), v5+int32(32))
						mBase = m.M
						v62 = m.ExcPending
						if v62 != 0 {
							return int32(0)
