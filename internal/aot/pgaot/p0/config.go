	...
	if base.Ui32(v8) <= base.Ui32(int32(67108863)) {
		if v8 <= int32(33554431) {
				...
				if v8 != int32(16777216) {
					...
					if v76 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v5))) = v8
						F_errmsg_internal(m, int32(_a_F_get_config_unit_name_0), v5)
						mBase = m.M
						v80 = m.ExcPending
						if v80 != 0 {
							return int32(0)
					...
					v68 = int32(_a_F_get_config_unit_name_3)
					m.G0 = v5 + int32(48)
					return v68
				}
			} else {
			...
			if v8 == int32(33554432) {
				v39 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_get_config_unit_name[0])))
				if v39 != 0 {
					v68 = int32(_a_F_get_config_unit_name_4)
					m.G0 = v5 + int32(48)
					return v68
				} else {
					v41 = int32(8)
					*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v41
					v43 = int32(_a_F_get_config_unit_name_4)
					v49 = F_pg_snprintf(m, v43, v41, int32(_a_F_get_config_unit_name_5), v5+int32(16))
					mBase = m.M
					v52 = m.ExcPending
					if v52 != 0 {
						return int32(0)
				...
				if v8 != int32(50331648) {
					...
					v19 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_get_config_unit_name[1])))
					if v19 == int32(0) {
						v53 = int32(8)
						*(*int32)(unsafe.Add(mBase, uint32(v5)+32)) = v53
						v55 = int32(_a_F_get_config_unit_name_6)
						v61 = F_pg_snprintf(m, v55, v53, int32(_a_F_get_config_unit_name_5), v5+int32(32))
						mBase = m.M
						v62 = m.ExcPending
						if v62 != 0 {
							return int32(0)
						...
						v68 = int32(_a_F_get_config_unit_name_6)
						m.G0 = v5 + int32(48)
						return v68
					}
				}
		...
		if v8 <= int32(268435455) {
			if v8 == int32(67108864) {
				...
				if v8 != int32(83886080) {
					...
					v68 = int32(_a_F_get_config_unit_name_8)
					m.G0 = v5 + int32(48)
					return v68
				}
			}
			...
			if v8 == int32(268435456) {
				v68 = int32(_a_F_get_config_unit_name_9)
				m.G0 = v5 + int32(48)
				return v68
			} else {
				if v8 == int32(536870912) {
					v68 = int32(_a_F_get_config_unit_name_10)
					m.G0 = v5 + int32(48)
					return v68
				} else {
					if v8 != int32(805306368) {
						...
						v68 = int32(_a_F_get_config_unit_name_11)
						m.G0 = v5 + int32(48)
						return v68
					}
				}
