...
L3:
	;
	v402 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[0]))
...
L4:
	;
	v375 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[0]))
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+148)) = v25
	v32 = F_pg_sprintf(m, v14+int32(256), int32(_a_F_SnapBuildSerialize_1), v14+int32(144))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L9
...
L13:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[0]))
	if v42 == int32(44) {
		goto L11
	} else {
		goto L16
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+104)) = v21
	v98 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v14)+108)) = v98
	v105 = F_pg_sprintf(m, v14+int32(1280), int32(_a_F_SnapBuildSerialize_6), v14+int32(96))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L9
...
L31:
	;
	v111 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[0]))
	if v111 != int32(44) {
		goto L6
	} else {
		goto L34
...
L33:
	;
	v114 = int32(_a_F_SnapBuildSerialize_7)
	v115 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[2]))
	v117 = *(*int32)(unsafe.Add(mBase, uint32(l0)+4))
	*(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[2])) = v117
...
L67:
	;
	v264 = int32(_a_F_SnapBuildSerialize_8)
	v265 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[3]))
	v266 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v265))) = v266
	v269 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v269))) = int32(167772215)
	v274 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[4])))
	if v274 != int32(1) {
		v288 = v266
		goto L69
	} else {
...
L73:
	;
	v283 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[0]))
	if v283 == int32(27) {
		goto L71
	} else {
		goto L74
...
L75:
	;
	v290 = *(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[3]))
...
L81:
	;
	*(*int64)(unsafe.Add(mBase, uint32(l0)+48)) = l1
	*(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[2])) = v115
...
L97:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[0])) = v380
	F_errstart_cold(m, int32(21), int32(0))
	mBase = m.M
	v385 = m.ExcPending
	if v385 != 0 {
...
L102:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_SnapBuildSerialize[0])) = v402
	F_errstart_cold(m, int32(21), int32(0))
	mBase = m.M
	v410 = m.ExcPending
	if v410 != 0 {
