...
L29:
	;
	F_errfinish(m, int32(491489), int32(664), int32(307271))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L1
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = base.I32_extend16_s(v259)
	F_errmsg_internal(m, int32(475060), v17+int32(16))
	mBase = m.M
	v275 = m.ExcPending
	if v275 != 0 {
		goto L1
...
L263:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = int32(268435455)
	F_errdetail(m, int32(572607), v17)
	mBase = m.M
	v936 = m.ExcPending
	if v936 != 0 {
		goto L1
...
L264:
	;
	F_errsave_finish(m, int32(0), int32(491489), int32(284), int32(277924))
	mBase = m.M
	v942 = m.ExcPending
	if v942 != 0 {
		goto L1
...
L282:
	;
	F_errfinish(m, int32(491489), int32(851), int32(307271))
	mBase = m.M
	v1023 = m.ExcPending
	if v1023 != 0 {
		goto L1
