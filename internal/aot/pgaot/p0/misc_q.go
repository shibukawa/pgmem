		...
		if base.Ui32(v28) < base.Ui32(v23) {
			...
			if v33 != 0 {
				...
				if v36 != 0 {
					...
					F_errmsg(m, int32(376252), int32(0))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(466829), int32(376), int32(485934))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
...
L3:
	;
	v60 = int32(*(*uint8)(unsafe.Add(mBase, _consts[847])))
	if v60 != 0 {
		goto L11
	} else {
		goto L12
...
L13:
	;
	v64 = F_ScanKeywordLookup(m, l0, int32(1811740))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L14
...
L18:
	;
	v73 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v64)+uint32(_consts[848]))))
	if v73 != 0 {
		goto L11
	} else {
		goto L19
...
func F_quote_nullable(m *base.Module, l0 int32) int32 {
	...
	if v2 == int32(1) {
		v6 = F_cstring_to_text(m, int32(501198))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return int32(0)
