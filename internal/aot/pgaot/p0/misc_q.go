			...
			if v33 != 0 {
				...
				if v36 != 0 {
					...
					if v40 != 0 {
						...
						F_errfinish(m, int32(496810), int32(376), int32(516967))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
...
func F_querytree(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		F_errmsg_internal(m, int32(445895), int32(0))
		v13 = m.ExcPending
		if v13 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(496730), int32(667), int32(409281))
			v20 = m.ExcPending
			if v20 != 0 {
				return int32(0)
			} else {
...
func F_quote_nullable(m *base.Module, l0 int32) int32 {
	...
	if v2 == int32(1) {
		v6 = F_cstring_to_text(m, int32(532435))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return int32(0)
