		...
		if base.Ui32(v28) < base.Ui32(v23) {
			...
			if v33 != 0 {
				...
				if v36 != 0 {
					...
					F_errmsg(m, int32(417875), int32(0))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(520231), int32(376), int32(541565))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
...
L41:
	;
	v261 = *(*int32)(unsafe.Add(mBase, _consts[203]))
	if v261 != 0 {
		goto L42
	} else {
		goto L43
...
func F_querytree(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		F_errmsg_internal(m, int32(466098), int32(0))
		v13 = m.ExcPending
		if v13 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(520151), int32(667), int32(428319))
			v20 = m.ExcPending
			if v20 != 0 {
				return int32(0)
			} else {
...
func F_quote_identifier(m *base.Module, l0 int32) int32 {
	...
	v60 = int32(*(*uint8)(unsafe.Add(mBase, _consts[844])))
	if v60 != 0 {
		v76 = F_strlen(m, l0)
		mBase = m.M
		...
		if v57 == int32(0) {
			...
			v64 = F_ScanKeywordLookup(m, l0, int32(1893660))
			mBase = m.M
			v67 = m.ExcPending
			if v67 != 0 {
				return int32(0)
				...
				if v64 < int32(0) {
					...
					v73 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v64)+uint32(_consts[845]))))
					if v73 != 0 {
						v76 = F_strlen(m, l0)
						mBase = m.M
						v78 = F_palloc(m, v76+v58)
...
func F_quote_nullable(m *base.Module, l0 int32) int32 {
	...
	if v2 == int32(1) {
		v6 = F_cstring_to_text(m, int32(557147))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return int32(0)
