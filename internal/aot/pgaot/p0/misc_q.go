		...
		if base.Ui32(v28) < base.Ui32(v23) {
			...
			if v33 != 0 {
				...
				if v36 != 0 {
					...
					F_errmsg(m, int32(419407), int32(0))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(522379), int32(376), int32(543713))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
...
func F_querytree(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		F_errmsg_internal(m, int32(467781), int32(0))
		v13 = m.ExcPending
		if v13 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(522299), int32(667), int32(429851))
			v20 = m.ExcPending
			if v20 != 0 {
				return int32(0)
			} else {
...
func F_quote_identifier(m *base.Module, l0 int32) int32 {
	...
	if v60 != 0 {
		...
		if v57 == int32(0) {
			...
			v64 = F_ScanKeywordLookup(m, l0, int32(1897756))
			mBase = m.M
			v67 = m.ExcPending
			if v67 != 0 {
				return int32(0)
...
func F_quote_nullable(m *base.Module, l0 int32) int32 {
	...
	if v2 == int32(1) {
		v6 = F_cstring_to_text(m, int32(559295))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return int32(0)
