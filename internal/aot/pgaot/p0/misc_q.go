		...
		if base.Ui32(v28) < base.Ui32(v23) {
			...
			if v33 != 0 {
				...
				if v36 != 0 {
					...
					F_errmsg(m, int32(391362), int32(0))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(486238), int32(376), int32(506021))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
...
L13:
	;
	v64 = F_ScanKeywordLookup(m, l0, int32(1832220))
	mBase = m.M
	v67 = m.ExcPending
	if v67 != 0 {
		goto L14
...
func F_quote_nullable(m *base.Module, l0 int32) int32 {
	...
	if v2 == int32(1) {
		v6 = F_cstring_to_text(m, int32(521334))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return int32(0)
