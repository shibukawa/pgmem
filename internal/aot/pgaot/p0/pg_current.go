	...
	if v14 != 0 {
		...
		if v17 != 0 {
			...
			if v189 != 0 {
				...
				F_errmsg_internal(m, int32(99331), int32(0))
				mBase = m.M
				v193 = m.ExcPending
				if v193 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(473474), int32(380), int32(82280))
					mBase = m.M
					v198 = m.ExcPending
					if v198 != 0 {
						return int32(0)
			...
			if v23 != 0 {
				...
				if v27 != 0 {
					...
					if v31 != 0 {
						...
						F_errfinish(m, int32(473384), int32(303), int32(233074))
						mBase = m.M
						v36 = m.ExcPending
						if v36 != 0 {
							return int32(0)
...
func F_pg_current_xact_id(m *base.Module, l0 int32) int32 {
	...
	var v18 int32
	_ = v18
	F_PreventCommandDuringRecovery(m, int32(644430))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
