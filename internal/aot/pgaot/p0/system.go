	...
	if base.Ui32(l0) <= base.Ui32(int32(-7)) {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
			F_errmsg_internal(m, int32(489654), v5)
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(515675), int32(239), int32(260984))
				mBase = m.M
				v23 = m.ExcPending
				if v23 != 0 {
					return int32(0)
		...
		if v47 != 0 {
			...
			if v50 != 0 {
				...
				if v54 != 0 {
					...
					F_errfinish(m, int32(517217), int32(151), int32(295651))
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v37))) = l3
			...
			if v20 != 0 {
				...
				if v23 != 0 {
					...
					F_errmsg(m, int32(357797), int32(0))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return
					} else {
						F_errfinish(m, int32(518988), int32(201), int32(295700))
						mBase = m.M
						v36 = m.ExcPending
						if v36 != 0 {
							return
