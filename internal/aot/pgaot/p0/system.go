...
func F_SystemAttributeDefinition(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(l0) <= base.Ui32(int32(-7)) {
		...
		v30 = *(*int32)(unsafe.Add(mBase, uint32((l0^int32(-1))<<(uint(int32(2))%32))+uint32(_c_F_SystemAttributeDefinition[0])))
		m.G0 = v5 + int32(16)
		return v30
	}
}
...
L25:
	;
	v106 = *(*int32)(unsafe.Add(mBase, _c_F_system_rows_nextsampleblock[0]))
	if v106 != 0 {
		goto L27
	} else {
		goto L28
