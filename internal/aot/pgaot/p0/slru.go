...
L11:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v49))) = v50
	v58 = int32(*(*uint8)(unsafe.Add(mBase, _consts[140])))
	if v58 == int32(0) {
		goto L18
	} else {
		goto L19
...
L20:
	;
	v62 = int32(*(*uint8)(unsafe.Add(mBase, _consts[141])))
	if v62 == int32(0) {
		goto L21
	} else {
		goto L22
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v15
	F_errmsg_internal(m, int32(176644), v12)
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L2
...
L44:
	;
	F_errfinish(m, int32(490787), int32(1813), int32(13590))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L2
