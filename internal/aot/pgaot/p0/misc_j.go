...
func F_johab_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4372396), v18, v18, v18, int32(40), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
	...
	if v12 != 0 {
		...
		if v17 != 0 {
			...
			if v23 != 0 {
				...
				if int32(0) <= v24 {
					F_appendStringInfoString(m, v6+int32(32), int32(714325))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
	...
	if v11 != 0 {
		...
		if v15 != 0 {
			...
			if v22 != 0 {
				...
				if int32(0) <= v23 {
					F_appendStringInfoString(m, v5+int32(4), int32(714325))
					mBase = m.M
					v30 = m.ExcPending
					if v30 != 0 {
						return int32(0)
