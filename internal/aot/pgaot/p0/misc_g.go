...
L11:
	...
	v49 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_generateSerialExtraStmts[0])))
...
L25:
	;
	v79 = int32(_a_F_generateSerialExtraStmts_1)
	v82 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_generateSerialExtraStmts[1])))
...
L39:
	;
	v107 = int32(_a_F_generateSerialExtraStmts_2)
	v110 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_generateSerialExtraStmts[2])))
...
L70:
	...
	v206 = F_ChooseRelationName(m, v202, v203, int32(_a_F_generateSerialExtraStmts_3), v198, int32(0))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L3
...
L86:
	...
	v263 = int32(_a_F_generateSerialExtraStmts_1)
	v266 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_generateSerialExtraStmts[1])))
...
L103:
	;
	v307 = F_makeDefElem(m, int32(_a_F_generateSerialExtraStmts_7), v304, int32(-1))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L3
...
L115:
	;
	v361 = F_makeDefElem(m, int32(_a_F_generateSerialExtraStmts_8), v358, int32(-1))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L3
...
L17:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _c_F_getNextFlagFromString[0]))
	if v52 == int32(68) {
		goto L6
	} else {
		goto L18
...
L18:
	;
	if base.Ui32(int32(_a_F_getNextFlagFromString_0)) <= base.Ui32(v47) {
		goto L5
	} else {
		goto L19
	}
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+112)) = v47
	v61 = F_pg_sprintf(m, v24, int32(_a_F_getNextFlagFromString_1), v13+int32(112))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L20
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+64)) = v90
	F_errmsg(m, int32(_a_F_getNextFlagFromString_2), v13-int32(-64))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L20
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+96)) = v120
	F_errmsg(m, int32(_a_F_getNextFlagFromString_2), v13+int32(96))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L20
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+80)) = v139
	F_errmsg(m, int32(_a_F_getNextFlagFromString_5), v13+int32(80))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L20
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v21
	F_errmsg(m, int32(_a_F_getNextFlagFromString_6), v13)
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L20
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v233
	F_errmsg(m, int32(_a_F_getNextFlagFromString_2), v13+int32(32))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L20
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = v252
	F_errmsg(m, int32(_a_F_getNextFlagFromString_7), v13+int32(48))
	mBase = m.M
	v258 = m.ExcPending
	if v258 != 0 {
		goto L20
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v268
	F_errmsg_internal(m, int32(_a_F_getNextFlagFromString_8), v13+int32(16))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L20
...
L42:
	;
	v108 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_get_const_expr[0])))
	if v108 != 0 {
		goto L36
	} else {
		goto L45
...
L48:
	;
	v122 = int32(_a_F_get_const_expr_6)
	v126 = m.G0
	v128 = v126 - int32(32)
	m.G0 = v128
	v130 = int32(*(*int8)(unsafe.Add(mBase, _c_F_get_const_expr[1])))
	if v130 != 0 {
		goto L54
	} else {
		goto L55
...
L53:
	...
	mBase = m.M
	v136 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_get_const_expr[1])))
	if v136 != 0 {
		goto L58
	} else {
		goto L59
...
L54:
	;
	v131 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_get_const_expr[2])))
	if v131 != 0 {
		goto L53
	} else {
		goto L57
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v250
	F_appendStringInfo(m, v244, int32(_a_F_get_const_expr_2), v12+int32(32))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L5
...
func F_get_dirent_type(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	default:
		...
		if v29 < int32(0) {
			...
			v53 = v51 & int32(_a_F_get_dirent_type_3)
			if v53 != int32(_a_F_get_dirent_type_4) {
				if v53 == int32(_a_F_get_dirent_type_5) {
					v64 = int32(2)
				} else {
					if v53 != int32(_a_F_get_dirent_type_6) {
						v64 = int32(1)
					} else {
						v64 = int32(3)
					}
...
L41:
	;
	v182 = *(*int32)(unsafe.Add(mBase, _c_F_get_policies_for_relation[0]))
	if v182 == int32(0) {
		goto L42
	} else {
		goto L43
...
L42:
	;
	v305 = *(*int32)(unsafe.Add(mBase, _c_F_get_policies_for_relation[1]))
	if v305 == int32(0) {
		goto L64
	} else {
		goto L65
...
L38:
	;
	v87 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_get_reloptions[0])))
	if v87 != 0 {
		goto L32
	} else {
		goto L41
...
func F_get_tsearch_config_filename(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v7 = v5 - int32(1056)
	m.G0 = v7
	v9 = int32(_a_F_get_tsearch_config_filename_0)
	v13 = m.G0
	v15 = v13 - int32(32)
	v16 = int64(0)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v15))) = v16
	v24 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_get_tsearch_config_filename[0])))
	if v24 == int32(0) {
		goto L2
	} else {
		goto L3
...
L4:
	;
	v28 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_get_tsearch_config_filename[1])))
	if v28 == int32(0) {
		goto L5
	} else {
		goto L6
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l0
	F_errmsg(m, int32(_a_F_get_tsearch_config_filename_1), v7+int32(16))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L25
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(32)
	v129 = F_pg_snprintf(m, v120, int32(1024), int32(_a_F_get_tsearch_config_filename_4), v7)
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L25
...
L66:
	;
	v245 = *(*int32)(unsafe.Add(mBase, _c_F_gettoken_query_standard[0]))
	if v245 != int32(68) {
		goto L67
	} else {
		goto L68
...
L67:
	;
	if base.Ui32(v241) < base.Ui32(int32(_a_F_gettoken_query_standard_3)) {
		v279 = v242
		v281 = int32(2)
		v282 = v241
		goto L54
...
L74:
	;
	F_errsave_finish(m, v253, int32(_a_F_gettoken_query_standard_1), int32(211), int32(_a_F_gettoken_query_standard_6))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L14
				...
				*(*int32)(unsafe.Add(mBase, uint32(v22))) = v47
				...
				default:
					...
					if v58 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v13))) = v21
						F_errmsg_internal(m, int32(_a_F_ginqueryarrayextract_0), v13)
						mBase = m.M
						v62 = m.ExcPending
						if v62 != 0 {
							return int32(0)
...
L3:
	;
	m.G0 = v25 + int32(720)
	return v374 & int32(_a_F_gistchoose_0)
L4:
	;
...
L6:
	;
	v82 = v67 & int32(_a_F_gistchoose_0)
...
L12:
	...
	v127 = F_index_getattr_2(m, l1+v94&int32(_a_F_gistchoose_3), v123, v124, v25+int32(15))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L1
...
L53:
	;
	if v272&int32(_a_F_gistchoose_0) == v82 {
		v323 = v268
		v324 = v272
		goto L52
	} else {
...
L55:
	;
	v293 = int32(_a_F_gistchoose_4)
	v294 = int32(_a_F_gistchoose_5)
	v295 = *(*int64)(unsafe.Add(mBase, _c_F_gistchoose[0]))
	v297 = *(*int64)(unsafe.Add(mBase, _c_F_gistchoose[1]))
	v298 = v295 ^ v297
	*(*int64)(unsafe.Add(mBase, _c_F_gistchoose[1])) = base.I64_rotl(v298, int64(37))
	*(*int64)(unsafe.Add(mBase, _c_F_gistchoose[0])) = v298<<(uint(int64(16))%64) ^ base.I64_rotl(v295, int64(24)) ^ v298
	goto L58
L56:
	;
	v319 = v268
...
L67:
	;
	v360 = v67 + int32(1)
	if base.Ui32(v360&int32(_a_F_gistchoose_0)) <= base.Ui32(v46) {
		v65 = v358
		v67 = v360
		v69 = v324
		goto L6
...
L68:
	;
	v329 = int32(_a_F_gistchoose_4)
	v330 = int32(_a_F_gistchoose_5)
	v331 = *(*int64)(unsafe.Add(mBase, _c_F_gistchoose[0]))
	v333 = *(*int64)(unsafe.Add(mBase, _c_F_gistchoose[1]))
	v334 = v331 ^ v333
	*(*int64)(unsafe.Add(mBase, _c_F_gistchoose[1])) = base.I64_rotl(v334, int64(37))
	*(*int64)(unsafe.Add(mBase, _c_F_gistchoose[0])) = v334<<(uint(int64(16))%64) ^ base.I64_rotl(v331, int64(24)) ^ v334
	goto L71
L69:
	;
	v355 = v323
...
func F_gistcostestimate(m *base.Module, l0 int32, l1 int32, l2 float64, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32) {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v16))) = v19
	...
	if v36 != 0 {
		...
		v60 = *(*float64)(unsafe.Add(mBase, _c_F_gistcostestimate[0]))
...
func F_gtsquery_picksplit(m *base.Module, l0 int32) int32 {
	...
	v28 = (v24 + int32(_a_F_gtsquery_picksplit_0)) & int32(_a_F_gtsquery_picksplit_1)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v22))) = v33
		...
		if v39 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v22)+4)) = v40
			if base.Ui32(int32(2)) <= base.Ui32(v28) {
				...
				for {
					...
					for {
						...
						v164 = v86 + int32(1)
						v166 = v164 & int32(_a_F_gtsquery_picksplit_1)
			...
			v191 = v23 + int32(4)
			v193 = int32(_a_F_gtsquery_picksplit_1)
			v195 = int32(0)
			...
			v207 = v191 + v202&int32(_a_F_gtsquery_picksplit_1)<<(uint(int32(4))%32)
				...
				if v24&int32(_a_F_gtsquery_picksplit_1) == int32(1) {
					...
					for {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v260-int32(4)))) = v383 ^ v385 - v385
						v390 = v246 + int32(1)
						v391 = int32(_a_F_gtsquery_picksplit_1)
						v392 = v390 & v391
					...
					if v399 != 0 {
						...
						for {
							...
							if v211&int32(_a_F_gtsquery_picksplit_1) == v431 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v22)+4)) = v434 + int32(1)
								...
								if v202&int32(_a_F_gtsquery_picksplit_1) == v431 {
