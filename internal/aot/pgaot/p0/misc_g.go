...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v306
	F_appendStringInfo(m, v300, int32(_a_F_get_const_expr_2), v12+int32(32))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L5
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(32)
	v185 = F_pg_snprintf(m, v176, int32(1024), int32(_a_F_get_tsearch_config_filename_4), v7)
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L42
			...
			*(*int32)(unsafe.Add(mBase, uint32(v22)+4)) = v40
			...
			if v226 != 0 {
				...
				if v24&int32(_a_F_gtsquery_picksplit_1) == int32(1) {
					F_pg_qsort(m, v225, v222, int32(8), int32(1526))
					mBase = m.M
					v234 = m.ExcPending
					if v234 != 0 {
						return int32(0)
