...
L27:
	;
	F_errmsg_internal(m, int32(675439), int32(0))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L26
...
L28:
	;
	F_errfinish(m, int32(496161), int32(536), int32(244345))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L26
...
L15:
	...
	F_appendStringInfoString(m, l1, int32(745866))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L8
...
L54:
	;
	F_errfinish(m, int32(492530), int32(159), int32(127164))
	mBase = m.M
	v227 = m.ExcPending
	if v227 != 0 {
		goto L10
...
L95:
	;
	F_errfinish(m, int32(492530), int32(492), int32(92474))
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L1
...
L99:
	;
	F_errfinish(m, int32(492530), int32(82), int32(238602))
	mBase = m.M
	v476 = m.ExcPending
	if v476 != 0 {
		goto L1
...
func F_g_intbig_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_int_reloption(m, v2, int32(281861), int32(159130), int32(252), int32(1), int32(2024))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		return int32(0)
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					if v22 != 0 {
						...
						F_errfinish(m, int32(499534), int32(541), int32(432714))
						mBase = m.M
						v27 = m.ExcPending
						if v27 != 0 {
							return int32(0)
...
L70:
	...
	v206 = F_ChooseRelationName(m, v202, v203, int32(230841), v198, int32(0))
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L3
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = v227
	F_errmsg_internal(m, int32(691461), v17+int32(16))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L3
...
L76:
	;
	F_errfinish(m, int32(499484), int32(486), int32(123344))
	mBase = m.M
	v244 = m.ExcPending
	if v244 != 0 {
		goto L3
...
L103:
	;
	v307 = F_makeDefElem(m, int32(174380), v304, int32(-1))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L3
...
L115:
	;
	v361 = F_makeDefElem(m, int32(23944), v358, int32(-1))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L3
...
L131:
	;
	F_errmsg(m, int32(415784), int32(0))
	mBase = m.M
	v393 = m.ExcPending
	if v393 != 0 {
		goto L3
...
L133:
	;
	F_errfinish(m, int32(499484), int32(505), int32(123344))
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L3
...
L3:
	;
	v27 = v21 + int32(5)
	F_pg_qsort(m, v27, v20, int32(3), int32(6910))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+112)) = v47
	v61 = F_pg_sprintf(m, v24, int32(465668), v13+int32(112))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L20
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+64)) = v90
	F_errmsg(m, int32(712653), v13-int32(-64))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L20
...
L32:
	;
	F_errfinish(m, int32(497189), int32(402), int32(330594))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L20
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+96)) = v120
	F_errmsg(m, int32(712653), v13+int32(96))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L20
...
L41:
	;
	F_errfinish(m, int32(497189), int32(411), int32(330594))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L20
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+80)) = v139
	F_errmsg(m, int32(712616), v13+int32(80))
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L20
...
L45:
	;
	F_errfinish(m, int32(497189), int32(419), int32(330594))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L20
...
L53:
	;
	F_errfinish(m, int32(497189), int32(439), int32(330594))
	mBase = m.M
	v200 = m.ExcPending
	if v200 != 0 {
		goto L20
...
L62:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+32)) = v233
	F_errmsg(m, int32(712653), v13+int32(32))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L20
...
L63:
	;
	F_errfinish(m, int32(497189), int32(384), int32(330594))
	mBase = m.M
	v244 = m.ExcPending
	if v244 != 0 {
		goto L20
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+48)) = v252
	F_errmsg(m, int32(402161), v13+int32(48))
	mBase = m.M
	v258 = m.ExcPending
	if v258 != 0 {
		goto L20
...
L67:
	;
	F_errfinish(m, int32(497189), int32(389), int32(330594))
	mBase = m.M
	v263 = m.ExcPending
	if v263 != 0 {
		goto L20
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v268
	F_errmsg_internal(m, int32(486759), v13+int32(16))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L20
...
L70:
	;
	F_errfinish(m, int32(497189), int32(428), int32(330594))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L20
...
L2:
	;
	F_appendStringInfoString(m, v14, int32(532954))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L5
...
L8:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v25
	F_appendStringInfo(m, v14, int32(176839), v12+int32(16))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L5
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v42
	F_appendStringInfo(m, v36, int32(198193), v12)
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L5
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v57
	F_appendStringInfo(m, v14, int32(686846), v12-int32(-64))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L5
...
L27:
	;
	F_appendStringInfoString(m, v14, int32(361203))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L5
...
L29:
	;
	F_appendStringInfoString(m, v14, int32(344187))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L5
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+80)) = v57
	F_appendStringInfo(m, v14, int32(686846), v12+int32(80))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L5
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v232
	F_appendStringInfo(m, v14, int32(176839), v12+int32(48))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L5
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v250
	F_appendStringInfo(m, v244, int32(198193), v12+int32(32))
	mBase = m.M
	v257 = m.ExcPending
	if v257 != 0 {
		goto L5
					...
					if v41 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
						...
						if v45 != 0 {
							...
							F_errfinish(m, int32(493820), int32(592), int32(366174))
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return int32(0)
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = l1
	F_errmsg_internal(m, int32(476467), v16)
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L20
...
L22:
	;
	F_errfinish(m, int32(492146), int32(590), int32(262905))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L20
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v56
	F_appendStringInfo(m, l0, int32(546118), v10)
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L1
...
func F_get_share_path(m *base.Module, l0 int32) {
	var v5 int32
	_ = v5
	F_make_relative_path(m, l0, int32(300175), int32(4511104))
	v5 = m.ExcPending
	if v5 != 0 {
		return
	} else {
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l0
	F_errmsg(m, int32(714541), v7+int32(16))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L25
...
L28:
	;
	F_errfinish(m, int32(493809), int32(53), int32(377940))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L25
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(32)
	v129 = F_pg_snprintf(m, v120, int32(1024), int32(177123), v7)
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L25
...
L43:
	;
	F_errsave_finish(m, v135, int32(492185), int32(345), int32(421787))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L14
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = int32(16384)
	F_errmsg(m, int32(343457), v15+int32(16))
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L14
...
L74:
	;
	F_errsave_finish(m, v253, int32(492185), int32(211), int32(209011))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L14
...
func F_ginarrayextract_2args(m *base.Module, l0 int32) int32 {
	...
	if v13 <= int32(2) {
		...
		if v21 != 0 {
			...
			F_errmsg_internal(m, int32(121718), int32(0))
			mBase = m.M
			v25 = m.ExcPending
			if v25 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(499643), int32(71), int32(155390))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v17
	F_errmsg_internal(m, int32(481980), v11)
	mBase = m.M
	v130 = m.ExcPending
	if v130 != 0 {
		goto L37
...
L39:
	;
	F_errfinish(m, int32(499643), int32(300), int32(91419))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L37
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			*(*int64)(unsafe.Add(mBase, uint32(v9)+uint32(_consts[15]))) = int64(0)
			...
			v19 = F_AllocSetContextCreateInternal(m, v14, int32(59728), int32(0), int32(8192), int32(8388608))
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = v19
				...
				v28 = F_AllocSetContextCreateInternal(m, v23, int32(60032), int32(0), int32(8192), int32(8388608))
				mBase = m.M
				v29 = m.ExcPending
				if v29 != 0 {
					return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v22))) = v47
				...
				default:
					...
					if v58 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v13))) = v21
						F_errmsg_internal(m, int32(482126), v13)
						mBase = m.M
						v62 = m.ExcPending
						if v62 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(499643), int32(131), int32(111708))
							mBase = m.M
							v67 = m.ExcPending
							if v67 != 0 {
								return int32(0)
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v31
	F_errmsg_internal(m, int32(159697), v10)
	mBase = m.M
	v72 = m.ExcPending
	if v72 != 0 {
		goto L10
...
L15:
	;
	F_errfinish(m, int32(497213), int32(50), int32(225219))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L10
...
L5:
	;
	F_pg_qsort(m, v21, v18, int32(12), int32(7107))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L1
