...
func F__ltree_risparent(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		if v13 != 0 {
			...
			v15 = F_array_iterator(m, v6, int32(_a_F__ltree_risparent_0), v12, int32(0))
			mBase = m.M
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
...
L35:
	;
	v122 = int32(9)
	v124 = int32(_a_F_ltree_compare_0)
	v132 = int32(1)
	if v132 < v28 {
...
func F_ltree_gist_in(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		if v15 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(_a_F_ltree_gist_in_0)
			F_errmsg(m, int32(_a_F_ltree_gist_in_1), v5)
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_ltree_gist_in_2), int32(26), int32(_a_F_ltree_gist_in_3))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
