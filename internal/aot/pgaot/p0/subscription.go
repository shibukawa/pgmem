					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
					...
					if v68 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
						F_errmsg_internal(m, int32(115698), v10)
						mBase = m.M
						v73 = m.ExcPending
						if v73 != 0 {
							return
						} else {
							F_errfinish(m, int32(495962), int32(285), int32(353626))
							mBase = m.M
							v78 = m.ExcPending
							if v78 != 0 {
								return
...
L24:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_errfinish(m, int32(494039), int32(1666), int32(247322))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		v1746 = v83
...
L28:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_errfinish(m, int32(494039), int32(1670), int32(247322))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		v1746 = v83
...
L52:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_PreventInTransactionBlock(m, l1, int32(528745))
	mBase = m.M
	v574 = m.ExcPending
	if v574 != 0 {
		v1746 = v83
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = v65
	F_errmsg_internal(m, int32(698002), v31-int32(-64))
	mBase = m.M
	v1247 = m.ExcPending
	if v1247 != 0 {
		v1746 = v83
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	F_errfinish(m, int32(494039), int32(2342), int32(212377))
	mBase = m.M
	v1268 = m.ExcPending
	if v1268 != 0 {
		v1746 = v83
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+48)) = v575
	F_errmsg(m, int32(205178), v31+int32(48))
	mBase = m.M
	v1674 = m.ExcPending
	if v1674 != 0 {
		v1746 = v83
...
L142:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	*(*int32)(unsafe.Add(mBase, uint32(v31)+36)) = int32(681895)
	*(*int32)(unsafe.Add(mBase, uint32(v31)+32)) = int32(540620)
	F_errhint(m, int32(579176), v31+int32(32))
	mBase = m.M
	v1699 = m.ExcPending
	if v1699 != 0 {
		v1746 = v83
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	F_errfinish(m, int32(494039), int32(2353), int32(212377))
	mBase = m.M
	v1720 = m.ExcPending
	if v1720 != 0 {
		v1746 = v83
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l3)+8)) = v393
	v399 = int32(0)
	F_set_config_option(m, int32(100509), v393, int32(4), int32(12), v399, v399)
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L40
...
L259:
	;
	F_errfinish(m, int32(494039), int32(2509), int32(413918))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L40
...
L369:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+144)) = v1102
	F_errmsg(m, int32(726222), v29+int32(144))
	mBase = m.M
	v1108 = m.ExcPending
	if v1108 != 0 {
		goto L40
...
L370:
	;
	F_errfinish(m, int32(494039), int32(331), int32(137177))
	mBase = m.M
	v1113 = m.ExcPending
	if v1113 != 0 {
		goto L40
...
L400:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+112)) = v1198
	F_errmsg(m, int32(725052), v29+int32(112))
	mBase = m.M
	v1204 = m.ExcPending
	if v1204 != 0 {
		goto L40
...
L401:
	;
	F_errfinish(m, int32(494039), int32(363), int32(137177))
	mBase = m.M
	v1209 = m.ExcPending
	if v1209 != 0 {
		goto L40
...
L406:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+128)) = v1143
	F_errmsg(m, int32(204830), v29+int32(128))
	mBase = m.M
	v1237 = m.ExcPending
	if v1237 != 0 {
		goto L40
...
L407:
	;
	F_errfinish(m, int32(494039), int32(354), int32(137177))
	mBase = m.M
	v1242 = m.ExcPending
	if v1242 != 0 {
		goto L40
...
L409:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+52)) = int32(344045)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+48)) = int32(539460)
	F_errmsg(m, int32(137628), v29+int32(48))
	mBase = m.M
	v1443 = m.ExcPending
	if v1443 != 0 {
		goto L40
...
L410:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+20)) = int32(344064)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = int32(539460)
	F_errmsg(m, int32(137628), v29+int32(16))
	mBase = m.M
	v1429 = m.ExcPending
	if v1429 != 0 {
		goto L40
...
L420:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+100)) = int32(344064)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+96)) = int32(361081)
	F_errmsg(m, int32(137628), v29+int32(96))
	mBase = m.M
	v1297 = m.ExcPending
	if v1297 != 0 {
		goto L40
...
L421:
	;
	F_errfinish(m, int32(494039), int32(379), int32(137177))
	mBase = m.M
	v1302 = m.ExcPending
	if v1302 != 0 {
		goto L40
...
L439:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+4)) = int32(361097)
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = int32(539460)
	F_errmsg(m, int32(178919), v29)
	mBase = m.M
	v1343 = m.ExcPending
	if v1343 != 0 {
		goto L40
...
L440:
	;
	F_errfinish(m, int32(494039), int32(421), int32(137177))
	mBase = m.M
	v1348 = m.ExcPending
	if v1348 != 0 {
		goto L40
...
L445:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+36)) = int32(361061)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+32)) = int32(539460)
	F_errmsg(m, int32(178919), v29+int32(32))
	mBase = m.M
	v1369 = m.ExcPending
	if v1369 != 0 {
		goto L40
...
L446:
	;
	F_errfinish(m, int32(494039), int32(437), int32(137177))
	mBase = m.M
	v1374 = m.ExcPending
	if v1374 != 0 {
		goto L40
...
L449:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+84)) = int32(344045)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+80)) = int32(361081)
	F_errmsg(m, int32(137628), v29+int32(80))
	mBase = m.M
	v1394 = m.ExcPending
	if v1394 != 0 {
		goto L40
...
L450:
	;
	F_errfinish(m, int32(494039), int32(386), int32(137177))
	mBase = m.M
	v1399 = m.ExcPending
	if v1399 != 0 {
		goto L40
...
L453:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+68)) = int32(344079)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+64)) = int32(361081)
	F_errmsg(m, int32(137628), v29-int32(-64))
	mBase = m.M
	v1415 = m.ExcPending
	if v1415 != 0 {
		goto L40
...
L454:
	;
	F_errfinish(m, int32(494039), int32(393), int32(137177))
	mBase = m.M
	v1420 = m.ExcPending
	if v1420 != 0 {
		goto L40
...
L456:
	;
	F_errfinish(m, int32(494039), int32(415), int32(137177))
	mBase = m.M
	v1434 = m.ExcPending
	if v1434 != 0 {
		goto L40
...
L458:
	;
	F_errfinish(m, int32(494039), int32(431), int32(137177))
	mBase = m.M
	v1448 = m.ExcPending
	if v1448 != 0 {
		goto L40
