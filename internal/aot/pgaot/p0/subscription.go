					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
					...
					if v68 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
						F_errmsg_internal(m, int32(112831), v10)
						mBase = m.M
						v73 = m.ExcPending
						if v73 != 0 {
							return
						} else {
							F_errfinish(m, int32(485102), int32(285), int32(345959))
							mBase = m.M
							v78 = m.ExcPending
							if v78 != 0 {
								return
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+16)) = v196
	F_errmsg(m, int32(69723), v31+int32(16))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		v1746 = v83
...
L24:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_errfinish(m, int32(483211), int32(1666), int32(242062))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		v1746 = v83
...
L28:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_errfinish(m, int32(483211), int32(1670), int32(242062))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		v1746 = v83
...
L37:
	;
	v394 = *(*int32)(unsafe.Add(mBase, _consts[206]))
	if v394 != 0 {
		goto L39
	} else {
		goto L40
...
L52:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_PreventInTransactionBlock(m, l1, int32(517276))
	mBase = m.M
	v574 = m.ExcPending
	if v574 != 0 {
		v1746 = v83
...
L88:
	;
	v1063 = *(*int32)(unsafe.Add(mBase, _consts[293]))
...
L92:
	;
	v1276 = *(*int32)(unsafe.Add(mBase, _consts[77]))
	v1278 = *(*int32)(unsafe.Add(mBase, _consts[294]))
	goto L113
L93:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v31)+84)) = v46
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = v65
	F_errmsg_internal(m, int32(669523), v31-int32(-64))
	mBase = m.M
	v1247 = m.ExcPending
	if v1247 != 0 {
		v1746 = v83
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	F_errfinish(m, int32(483211), int32(2342), int32(208486))
	mBase = m.M
	v1268 = m.ExcPending
	if v1268 != 0 {
		v1746 = v83
...
L118:
	;
	*(*int32)(unsafe.Add(mBase, _consts[294])) = v1299
	v1317 = v1300 & int32(1)
	if v1317 != 0 {
		goto L117
	} else {
...
L120:
	;
	*(*int32)(unsafe.Add(mBase, _consts[77])) = v1297
	*(*int32)(unsafe.Add(mBase, _consts[294])) = v1296
	v1426 = *(*int32)(unsafe.Add(mBase, _consts[293]))
...
L136:
	...
	*(*int32)(unsafe.Add(mBase, _consts[77])) = v1297
	*(*int32)(unsafe.Add(mBase, _consts[294])) = v1296
	v1542 = *(*int32)(unsafe.Add(mBase, _consts[293]))
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+48)) = v575
	F_errmsg(m, int32(201337), v31+int32(48))
	mBase = m.M
	v1674 = m.ExcPending
	if v1674 != 0 {
		v1746 = v83
...
L142:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	*(*int32)(unsafe.Add(mBase, uint32(v31)+36)) = int32(653419)
	*(*int32)(unsafe.Add(mBase, uint32(v31)+32)) = int32(529020)
	F_errhint(m, int32(551665), v31+int32(32))
	mBase = m.M
	v1699 = m.ExcPending
	if v1699 != 0 {
		v1746 = v83
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	F_errfinish(m, int32(483211), int32(2353), int32(208486))
	mBase = m.M
	v1720 = m.ExcPending
	if v1720 != 0 {
		v1746 = v83
...
L52:
	...
	v142 = int32(107215)
	v145 = int32(*(*uint8)(unsafe.Add(mBase, _consts[276])))
...
L64:
	...
	v176 = int32(445923)
	v179 = int32(*(*uint8)(unsafe.Add(mBase, _consts[277])))
...
L77:
	...
	v214 = int32(83434)
	v217 = int32(*(*uint8)(unsafe.Add(mBase, _consts[278])))
...
L90:
	...
	v252 = int32(369864)
	v255 = int32(*(*uint8)(unsafe.Add(mBase, _consts[279])))
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l3)+4)) = v284
	v287 = int32(364359)
	v290 = int32(*(*uint8)(unsafe.Add(mBase, _consts[280])))
...
L115:
	...
	v323 = int32(492650)
	v326 = int32(*(*uint8)(unsafe.Add(mBase, _consts[281])))
...
L128:
	...
	v361 = int32(98392)
	v364 = int32(*(*uint8)(unsafe.Add(mBase, _consts[282])))
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l3)+8)) = v393
	v399 = int32(0)
	F_set_config_option(m, int32(98392), v393, int32(4), int32(12), v399, v399)
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L40
...
L142:
	...
	v406 = int32(315542)
	v409 = int32(*(*uint8)(unsafe.Add(mBase, _consts[283])))
...
L155:
	...
	v444 = int32(17362)
	v447 = int32(*(*uint8)(unsafe.Add(mBase, _consts[284])))
...
L168:
	...
	v482 = int32(327985)
	v485 = int32(*(*uint8)(unsafe.Add(mBase, _consts[285])))
...
L259:
	;
	F_errfinish(m, int32(483211), int32(2509), int32(405083))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L40
...
L262:
	...
	v780 = int32(353376)
	v783 = int32(*(*uint8)(unsafe.Add(mBase, _consts[286])))
...
L275:
	...
	v818 = int32(207794)
	v821 = int32(*(*uint8)(unsafe.Add(mBase, _consts[287])))
...
L288:
	...
	v856 = int32(440679)
	v859 = int32(*(*uint8)(unsafe.Add(mBase, _consts[288])))
...
L301:
	...
	v894 = int32(214129)
	v897 = int32(*(*uint8)(unsafe.Add(mBase, _consts[289])))
...
L314:
	...
	v932 = int32(210832)
	v935 = int32(*(*uint8)(unsafe.Add(mBase, _consts[290])))
...
L327:
	...
	v968 = int32(270939)
	v971 = int32(*(*uint8)(unsafe.Add(mBase, _consts[291])))
...
L369:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+144)) = v1102
	F_errmsg(m, int32(697557), v29+int32(144))
	mBase = m.M
	v1108 = m.ExcPending
	if v1108 != 0 {
		goto L40
...
L370:
	;
	F_errfinish(m, int32(483211), int32(331), int32(133998))
	mBase = m.M
	v1113 = m.ExcPending
	if v1113 != 0 {
		goto L40
...
L373:
	...
	v1117 = int32(239383)
	v1120 = int32(*(*uint8)(unsafe.Add(mBase, _consts[292])))
...
L384:
	;
	v1148 = int32(364359)
	v1151 = int32(*(*uint8)(unsafe.Add(mBase, _consts[280])))
...
L400:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+112)) = v1198
	F_errmsg(m, int32(696535), v29+int32(112))
	mBase = m.M
	v1204 = m.ExcPending
	if v1204 != 0 {
		goto L40
...
L401:
	;
	F_errfinish(m, int32(483211), int32(363), int32(133998))
	mBase = m.M
	v1209 = m.ExcPending
	if v1209 != 0 {
		goto L40
...
L406:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+128)) = v1143
	F_errmsg(m, int32(200989), v29+int32(128))
	mBase = m.M
	v1237 = m.ExcPending
	if v1237 != 0 {
		goto L40
...
L407:
	;
	F_errfinish(m, int32(483211), int32(354), int32(133998))
	mBase = m.M
	v1242 = m.ExcPending
	if v1242 != 0 {
		goto L40
...
L409:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+52)) = int32(336524)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+48)) = int32(527865)
	F_errmsg(m, int32(134423), v29+int32(48))
	mBase = m.M
	v1443 = m.ExcPending
	if v1443 != 0 {
		goto L40
...
L410:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+20)) = int32(336543)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = int32(527865)
	F_errmsg(m, int32(134423), v29+int32(16))
	mBase = m.M
	v1429 = m.ExcPending
	if v1429 != 0 {
		goto L40
...
L420:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+100)) = int32(336543)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+96)) = int32(353266)
	F_errmsg(m, int32(134423), v29+int32(96))
	mBase = m.M
	v1297 = m.ExcPending
	if v1297 != 0 {
		goto L40
...
L421:
	;
	F_errfinish(m, int32(483211), int32(379), int32(133998))
	mBase = m.M
	v1302 = m.ExcPending
	if v1302 != 0 {
		goto L40
...
L439:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+4)) = int32(353282)
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = int32(527865)
	F_errmsg(m, int32(175300), v29)
	mBase = m.M
	v1343 = m.ExcPending
	if v1343 != 0 {
		goto L40
...
L440:
	;
	F_errfinish(m, int32(483211), int32(421), int32(133998))
	mBase = m.M
	v1348 = m.ExcPending
	if v1348 != 0 {
		goto L40
...
L445:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+36)) = int32(353246)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+32)) = int32(527865)
	F_errmsg(m, int32(175300), v29+int32(32))
	mBase = m.M
	v1369 = m.ExcPending
	if v1369 != 0 {
		goto L40
...
L446:
	;
	F_errfinish(m, int32(483211), int32(437), int32(133998))
	mBase = m.M
	v1374 = m.ExcPending
	if v1374 != 0 {
		goto L40
...
L449:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+84)) = int32(336524)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+80)) = int32(353266)
	F_errmsg(m, int32(134423), v29+int32(80))
	mBase = m.M
	v1394 = m.ExcPending
	if v1394 != 0 {
		goto L40
...
L450:
	;
	F_errfinish(m, int32(483211), int32(386), int32(133998))
	mBase = m.M
	v1399 = m.ExcPending
	if v1399 != 0 {
		goto L40
...
L453:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+68)) = int32(336558)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+64)) = int32(353266)
	F_errmsg(m, int32(134423), v29-int32(-64))
	mBase = m.M
	v1415 = m.ExcPending
	if v1415 != 0 {
		goto L40
...
L454:
	;
	F_errfinish(m, int32(483211), int32(393), int32(133998))
	mBase = m.M
	v1420 = m.ExcPending
	if v1420 != 0 {
		goto L40
...
L456:
	;
	F_errfinish(m, int32(483211), int32(415), int32(133998))
	mBase = m.M
	v1434 = m.ExcPending
	if v1434 != 0 {
		goto L40
...
L458:
	;
	F_errfinish(m, int32(483211), int32(431), int32(133998))
	mBase = m.M
	v1448 = m.ExcPending
	if v1448 != 0 {
		goto L40
...
func F_subscription_change_cb(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	_ = v5
	v5 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[542])) = uint8(v5)
	return
}
