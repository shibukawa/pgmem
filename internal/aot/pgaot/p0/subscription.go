					...
					*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
					...
					if v68 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
						F_errmsg_internal(m, int32(123459), v10)
						mBase = m.M
						v73 = m.ExcPending
						if v73 != 0 {
							return
						} else {
							F_errfinish(m, int32(519377), int32(285), int32(370796))
							mBase = m.M
							v78 = m.ExcPending
							if v78 != 0 {
								return
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+16)) = v196
	F_errmsg(m, int32(77156), v31+int32(16))
	mBase = m.M
	v218 = m.ExcPending
	if v218 != 0 {
		v1746 = v83
...
L24:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_errfinish(m, int32(517190), int32(1666), int32(259668))
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		v1746 = v83
...
L28:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_errfinish(m, int32(517190), int32(1670), int32(259668))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		v1746 = v83
...
L52:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+95)) = uint8(v91)
	*(*uint8)(unsafe.Add(mBase, uint32(v31)+111)) = uint8(v97)
	F_PreventInTransactionBlock(m, l1, int32(553700))
	mBase = m.M
	v574 = m.ExcPending
	if v574 != 0 {
		v1746 = v83
...
L88:
	;
	v1063 = *(*int32)(unsafe.Add(mBase, _consts[291]))
...
L92:
	...
	v1278 = *(*int32)(unsafe.Add(mBase, _consts[292]))
	goto L113
L93:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v31)+84)) = v46
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+64)) = v65
	F_errmsg_internal(m, int32(730683), v31-int32(-64))
	mBase = m.M
	v1247 = m.ExcPending
	if v1247 != 0 {
		v1746 = v83
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	F_errfinish(m, int32(517190), int32(2342), int32(223277))
	mBase = m.M
	v1268 = m.ExcPending
	if v1268 != 0 {
		v1746 = v83
...
L118:
	;
	*(*int32)(unsafe.Add(mBase, _consts[292])) = v1299
	v1317 = v1300 & int32(1)
	if v1317 != 0 {
		goto L117
	} else {
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, _consts[292])) = v1296
	v1426 = *(*int32)(unsafe.Add(mBase, _consts[291]))
...
L136:
	...
	*(*int32)(unsafe.Add(mBase, _consts[74])) = v1297
	*(*int32)(unsafe.Add(mBase, _consts[292])) = v1296
	v1542 = *(*int32)(unsafe.Add(mBase, _consts[291]))
...
L141:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+48)) = v575
	F_errmsg(m, int32(215574), v31+int32(48))
	mBase = m.M
	v1674 = m.ExcPending
	if v1674 != 0 {
		v1746 = v83
...
L142:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	*(*int32)(unsafe.Add(mBase, uint32(v31)+36)) = int32(712135)
	*(*int32)(unsafe.Add(mBase, uint32(v31)+32)) = int32(565787)
	F_errhint(m, int32(606317), v31+int32(32))
	mBase = m.M
	v1699 = m.ExcPending
	if v1699 != 0 {
		v1746 = v83
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v31)+136)) = v71
	*(*int32)(unsafe.Add(mBase, uint32(v31)+140)) = v68
	F_errfinish(m, int32(517190), int32(2353), int32(223277))
	mBase = m.M
	v1720 = m.ExcPending
	if v1720 != 0 {
		v1746 = v83
...
L52:
	...
	v142 = int32(117331)
	v145 = int32(*(*uint8)(unsafe.Add(mBase, _consts[274])))
...
L64:
	...
	v176 = int32(476490)
	v179 = int32(*(*uint8)(unsafe.Add(mBase, _consts[275])))
...
L77:
	...
	v214 = int32(91302)
	v217 = int32(*(*uint8)(unsafe.Add(mBase, _consts[276])))
...
L90:
	...
	v252 = int32(396136)
	v255 = int32(*(*uint8)(unsafe.Add(mBase, _consts[277])))
...
L101:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l3)+4)) = v284
	v287 = int32(390159)
	v290 = int32(*(*uint8)(unsafe.Add(mBase, _consts[278])))
...
L115:
	...
	v323 = int32(528370)
	v326 = int32(*(*uint8)(unsafe.Add(mBase, _consts[279])))
...
L128:
	...
	v361 = int32(107232)
	v364 = int32(*(*uint8)(unsafe.Add(mBase, _consts[280])))
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l3)+8)) = v393
	v399 = int32(0)
	F_set_config_option(m, int32(107232), v393, int32(4), int32(12), v399, v399)
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L40
...
L142:
	...
	v406 = int32(337856)
	v409 = int32(*(*uint8)(unsafe.Add(mBase, _consts[281])))
...
L155:
	...
	v444 = int32(17983)
	v447 = int32(*(*uint8)(unsafe.Add(mBase, _consts[282])))
...
L168:
	...
	v482 = int32(351694)
	v485 = int32(*(*uint8)(unsafe.Add(mBase, _consts[283])))
...
L259:
	;
	F_errfinish(m, int32(517190), int32(2509), int32(433341))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L40
...
L262:
	...
	v780 = int32(378684)
	v783 = int32(*(*uint8)(unsafe.Add(mBase, _consts[284])))
...
L275:
	...
	v818 = int32(222585)
	v821 = int32(*(*uint8)(unsafe.Add(mBase, _consts[285])))
...
L288:
	...
	v856 = int32(470916)
	v859 = int32(*(*uint8)(unsafe.Add(mBase, _consts[286])))
...
L301:
	...
	v894 = int32(229093)
	v897 = int32(*(*uint8)(unsafe.Add(mBase, _consts[287])))
...
L314:
	...
	v932 = int32(225658)
	v935 = int32(*(*uint8)(unsafe.Add(mBase, _consts[288])))
...
L327:
	...
	v968 = int32(289534)
	v971 = int32(*(*uint8)(unsafe.Add(mBase, _consts[289])))
...
L369:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+144)) = v1102
	F_errmsg(m, int32(759395), v29+int32(144))
	mBase = m.M
	v1108 = m.ExcPending
	if v1108 != 0 {
		goto L40
...
L370:
	;
	F_errfinish(m, int32(517190), int32(331), int32(145627))
	mBase = m.M
	v1113 = m.ExcPending
	if v1113 != 0 {
		goto L40
...
L373:
	...
	v1117 = int32(256930)
	v1120 = int32(*(*uint8)(unsafe.Add(mBase, _consts[290])))
...
L384:
	;
	v1148 = int32(390159)
	v1151 = int32(*(*uint8)(unsafe.Add(mBase, _consts[278])))
...
L400:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+112)) = v1198
	F_errmsg(m, int32(758201), v29+int32(112))
	mBase = m.M
	v1204 = m.ExcPending
	if v1204 != 0 {
		goto L40
...
L401:
	;
	F_errfinish(m, int32(517190), int32(363), int32(145627))
	mBase = m.M
	v1209 = m.ExcPending
	if v1209 != 0 {
		goto L40
...
L406:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v29)+128)) = v1143
	F_errmsg(m, int32(215226), v29+int32(128))
	mBase = m.M
	v1237 = m.ExcPending
	if v1237 != 0 {
		goto L40
...
L407:
	;
	F_errfinish(m, int32(517190), int32(354), int32(145627))
	mBase = m.M
	v1242 = m.ExcPending
	if v1242 != 0 {
		goto L40
...
L409:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+52)) = int32(361035)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+48)) = int32(564611)
	F_errmsg(m, int32(146078), v29+int32(48))
	mBase = m.M
	v1443 = m.ExcPending
	if v1443 != 0 {
		goto L40
...
L410:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+20)) = int32(361054)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+16)) = int32(564611)
	F_errmsg(m, int32(146078), v29+int32(16))
	mBase = m.M
	v1429 = m.ExcPending
	if v1429 != 0 {
		goto L40
...
L420:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+100)) = int32(361054)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+96)) = int32(378574)
	F_errmsg(m, int32(146078), v29+int32(96))
	mBase = m.M
	v1297 = m.ExcPending
	if v1297 != 0 {
		goto L40
...
L421:
	;
	F_errfinish(m, int32(517190), int32(379), int32(145627))
	mBase = m.M
	v1302 = m.ExcPending
	if v1302 != 0 {
		goto L40
...
L439:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+4)) = int32(378590)
	*(*int32)(unsafe.Add(mBase, uint32(v29))) = int32(564611)
	F_errmsg(m, int32(189315), v29)
	mBase = m.M
	v1343 = m.ExcPending
	if v1343 != 0 {
		goto L40
...
L440:
	;
	F_errfinish(m, int32(517190), int32(421), int32(145627))
	mBase = m.M
	v1348 = m.ExcPending
	if v1348 != 0 {
		goto L40
...
L445:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+36)) = int32(378554)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+32)) = int32(564611)
	F_errmsg(m, int32(189315), v29+int32(32))
	mBase = m.M
	v1369 = m.ExcPending
	if v1369 != 0 {
		goto L40
...
L446:
	;
	F_errfinish(m, int32(517190), int32(437), int32(145627))
	mBase = m.M
	v1374 = m.ExcPending
	if v1374 != 0 {
		goto L40
...
L449:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+84)) = int32(361035)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+80)) = int32(378574)
	F_errmsg(m, int32(146078), v29+int32(80))
	mBase = m.M
	v1394 = m.ExcPending
	if v1394 != 0 {
		goto L40
...
L450:
	;
	F_errfinish(m, int32(517190), int32(386), int32(145627))
	mBase = m.M
	v1399 = m.ExcPending
	if v1399 != 0 {
		goto L40
...
L453:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v29)+68)) = int32(361069)
	*(*int32)(unsafe.Add(mBase, uint32(v29)+64)) = int32(378574)
	F_errmsg(m, int32(146078), v29-int32(-64))
	mBase = m.M
	v1415 = m.ExcPending
	if v1415 != 0 {
		goto L40
...
L454:
	;
	F_errfinish(m, int32(517190), int32(393), int32(145627))
	mBase = m.M
	v1420 = m.ExcPending
	if v1420 != 0 {
		goto L40
...
L456:
	;
	F_errfinish(m, int32(517190), int32(415), int32(145627))
	mBase = m.M
	v1434 = m.ExcPending
	if v1434 != 0 {
		goto L40
...
L458:
	;
	F_errfinish(m, int32(517190), int32(431), int32(145627))
	mBase = m.M
	v1448 = m.ExcPending
	if v1448 != 0 {
		goto L40
...
func F_subscription_change_cb(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	_ = v5
	v5 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[540])) = uint8(v5)
	return
}
