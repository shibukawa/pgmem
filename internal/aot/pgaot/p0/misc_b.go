...
L7:
	...
	v28 = int32(0)
	v31 = int32(10)
	v37 = F_set_config_with_handle(m, int32(23435), v28, int32(345210), v28, v31, v31, v28, int32(1), v28, v28)
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L10
...
L371:
	;
	v1678 = F_find_among_b(m, l0, int32(4243328), int32(109))
	mBase = m.M
	v1681 = m.ExcPending
	if v1681 != 0 {
		goto L372
...
L376:
	;
	v1716 = F_slice_from_s(m, l0, int32(6), int32(2190288))
	mBase = m.M
	v1717 = m.ExcPending
	if v1717 != 0 {
		goto L372
...
L377:
	;
	v1710 = F_slice_from_s(m, l0, int32(7), int32(2190281))
	mBase = m.M
	v1711 = m.ExcPending
	if v1711 != 0 {
		goto L372
...
L378:
	;
	v1704 = F_slice_from_s(m, l0, int32(7), int32(2190274))
	mBase = m.M
	v1705 = m.ExcPending
	if v1705 != 0 {
		goto L372
...
L399:
	;
	v1762 = F_find_among_b(m, l0, int32(4245520), int32(295))
	mBase = m.M
	v1763 = m.ExcPending
	if v1763 != 0 {
		goto L372
...
L403:
	;
	v1829 = F_slice_from_s(m, l0, int32(5), int32(2190788))
	mBase = m.M
	v1830 = m.ExcPending
	if v1830 != 0 {
		goto L372
...
L404:
	;
	v1823 = F_slice_from_s(m, l0, int32(5), int32(2190783))
	mBase = m.M
	v1824 = m.ExcPending
	if v1824 != 0 {
		goto L372
...
L405:
	;
	v1817 = F_slice_from_s(m, l0, int32(5), int32(2190778))
	mBase = m.M
	v1818 = m.ExcPending
	if v1818 != 0 {
		goto L372
...
L406:
	;
	v1811 = F_slice_from_s(m, l0, int32(5), int32(2190773))
	mBase = m.M
	v1812 = m.ExcPending
	if v1812 != 0 {
		goto L372
...
L407:
	;
	v1805 = F_slice_from_s(m, l0, int32(6), int32(2190767))
	mBase = m.M
	v1806 = m.ExcPending
	if v1806 != 0 {
		goto L372
...
L408:
	;
	v1799 = F_slice_from_s(m, l0, int32(3), int32(2190764))
	mBase = m.M
	v1800 = m.ExcPending
	if v1800 != 0 {
		goto L372
...
L410:
	;
	v1786 = F_slice_from_s(m, l0, int32(3), int32(2190761))
	mBase = m.M
	v1787 = m.ExcPending
	if v1787 != 0 {
		goto L372
...
L440:
	;
	v1868 = F_find_among_b(m, l0, int32(4251424), int32(19))
	mBase = m.M
	v1869 = m.ExcPending
	if v1869 != 0 {
		goto L372
...
L443:
	;
	v1885 = F_slice_from_s(m, l0, int32(1), int32(2191983))
	mBase = m.M
	v1886 = m.ExcPending
	if v1886 != 0 {
		goto L372
		...
		if v13 != 0 {
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v4))) = v18 + int32(96)
				F_errmsg(m, int32(429525), v4)
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return
				} else {
					F_errfinish(m, int32(496577), int32(711), int32(399814))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return
			...
			if v25 != 0 {
				...
				if v28 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = v15
					F_errmsg(m, int32(679732), v7)
					mBase = m.M
					v35 = m.ExcPending
					if v35 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(494399), int32(1883), int32(103369))
						mBase = m.M
						v40 = m.ExcPending
						if v40 != 0 {
							return int32(0)
			...
			if v68 != 0 {
				...
				if v71 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v18
					F_errmsg(m, int32(679732), v10)
					mBase = m.M
					v78 = m.ExcPending
					if v78 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(494399), int32(1825), int32(103359))
						mBase = m.M
						v83 = m.ExcPending
						if v83 != 0 {
							return int32(0)
					...
					if v87 != 0 {
						...
						if v90 != 0 {
							...
							if v94 != 0 {
								...
								F_errfinish(m, int32(494399), int32(1833), int32(103359))
								mBase = m.M
								v99 = m.ExcPending
								if v99 != 0 {
									return int32(0)
			...
			if v15 == v16 {
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						F_errmsg(m, int32(157455), int32(0))
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(494399), int32(1342), int32(208094))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
...
L179:
	;
	F_errfinish(m, int32(327439), int32(327), int32(342035))
	mBase = m.M
	v1051 = m.ExcPending
	if v1051 != 0 {
		goto L63
...
L274:
	;
	F_errfinish(m, int32(327439), int32(630), int32(312669))
	mBase = m.M
	v1588 = m.ExcPending
	if v1588 != 0 {
		goto L63
...
func F_bloptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v11 = F_build_reloptions(m, l0, l1, v6, int32(136), int32(4684320), int32(33))
	mBase = m.M
	v14 = m.ExcPending
	if v14 != 0 {
		return int32(0)
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+112)) = v32
	F_errmsg(m, int32(259937), v19+int32(112))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L2
...
L22:
	;
	F_errfinish(m, int32(499782), int32(84), int32(357532))
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L2
...
L41:
	;
	F_errfinish(m, int32(499782), v147, int32(357532))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L2
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = l0
	F_errmsg_internal(m, int32(42632), v19)
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L2
...
L45:
	;
	F_errfinish(m, int32(499782), int32(50), int32(357532))
	mBase = m.M
	v186 = m.ExcPending
	if v186 != 0 {
		goto L2
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+64)) = v32
	F_errmsg(m, int32(472358), v19-int32(-64))
	mBase = m.M
	v256 = m.ExcPending
	if v256 != 0 {
		goto L2
...
L58:
	;
	F_errfinish(m, int32(499782), int32(143), int32(357532))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L2
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+48)) = v32
	F_errmsg(m, int32(181266), v19+int32(48))
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L2
...
L69:
	;
	F_errfinish(m, int32(499782), int32(155), int32(357532))
	mBase = m.M
	v294 = m.ExcPending
	if v294 != 0 {
		goto L2
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = v32
	F_errmsg(m, int32(363814), v19+int32(32))
	mBase = m.M
	v321 = m.ExcPending
	if v321 != 0 {
		goto L2
...
L78:
	;
	F_errfinish(m, int32(499782), int32(168), int32(357532))
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L2
...
L118:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v28 + int32(8)
	F_errmsg(m, int32(473889), v19+int32(16))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L2
...
L119:
	;
	F_errfinish(m, int32(499782), int32(206), int32(357532))
	mBase = m.M
	v499 = m.ExcPending
	if v499 != 0 {
		goto L2
...
L60:
	;
	F_errfinish(m, int32(495959), int32(8735), int32(355409))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L11
...
L70:
	;
	F_errfinish(m, int32(495959), int32(8766), int32(355409))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L11
...
L42:
	...
	v346 = F_AllocSetContextCreateInternal(m, v341, int32(64516), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v347 = m.ExcPending
	if v347 != 0 {
		goto L6
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+132)) = int32(411129)
...
L41:
	;
	F_errfinish(m, int32(499741), v171, int32(357454))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L2
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = l0
	F_errmsg_internal(m, int32(42632), v18)
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L2
...
L45:
	;
	F_errfinish(m, int32(499741), int32(61), int32(357454))
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L2
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+116)) = int32(411129)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+112)) = v31
	F_errmsg(m, int32(472429), v18+int32(112))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L2
...
L58:
	;
	F_errfinish(m, int32(499741), int32(151), int32(357454))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L2
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+100)) = int32(411129)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+96)) = v31
	F_errmsg(m, int32(181340), v18+int32(96))
	mBase = m.M
	v325 = m.ExcPending
	if v325 != 0 {
		goto L2
...
L69:
	;
	F_errfinish(m, int32(499741), int32(163), int32(357454))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L2
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+84)) = int32(411129)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+80)) = v31
	F_errmsg(m, int32(363874), v18+int32(80))
	mBase = m.M
	v359 = m.ExcPending
	if v359 != 0 {
		goto L2
...
L78:
	;
	F_errfinish(m, int32(499741), int32(176), int32(357454))
	mBase = m.M
	v364 = m.ExcPending
	if v364 != 0 {
		goto L2
...
L112:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+68)) = int32(411129)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+64)) = v31
	F_errmsg(m, int32(196872), v18-int32(-64))
	mBase = m.M
	v464 = m.ExcPending
	if v464 != 0 {
		goto L2
...
L113:
	;
	F_errfinish(m, int32(499741), int32(235), int32(357454))
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L2
...
L120:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+52)) = int32(411129)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+48)) = v31
	F_errmsg(m, int32(196783), v18+int32(48))
	mBase = m.M
	v502 = m.ExcPending
	if v502 != 0 {
		goto L2
...
L121:
	;
	F_errfinish(m, int32(499741), int32(245), int32(357454))
	mBase = m.M
	v507 = m.ExcPending
	if v507 != 0 {
		goto L2
...
L129:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v18)+36)) = int32(411129)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+32)) = v27 + int32(8)
	F_errmsg(m, int32(675730), v18+int32(32))
	mBase = m.M
	v568 = m.ExcPending
	if v568 != 0 {
		goto L2
...
L130:
	;
	F_errfinish(m, int32(499741), int32(257), int32(357454))
	mBase = m.M
	v573 = m.ExcPending
	if v573 != 0 {
		goto L2
...
L139:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v18)+20)) = int32(411129)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v31
	F_errmsg(m, int32(675793), v18+int32(16))
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L2
...
L140:
	;
	F_errfinish(m, int32(499741), int32(273), int32(357454))
	mBase = m.M
	v617 = m.ExcPending
	if v617 != 0 {
		goto L2
...
L29:
	;
	F_errmsg_internal(m, int32(260191), int32(0))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L18
...
L30:
	;
	F_errfinish(m, int32(494886), int32(3100), int32(172029))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L18
...
L129:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v512
	F_errmsg_internal(m, int32(188579), v18+int32(16))
	mBase = m.M
	v519 = m.ExcPending
	if v519 != 0 {
		goto L1
...
L130:
	;
	F_errfinish(m, int32(494566), int32(423), int32(283603))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v610
	v615 = F_psprintf(m, int32(471614), v18)
	mBase = m.M
	v616 = m.ExcPending
	if v616 != 0 {
		goto L1
...
L26:
	;
	F_errfinish(m, int32(500329), int32(1499), int32(336569))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L23
