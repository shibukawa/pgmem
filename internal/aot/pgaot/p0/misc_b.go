...
L371:
	;
	v1678 = F_find_among_b(m, l0, int32(_a_F_basque_UTF_8_stem_2), int32(109))
	mBase = m.M
	v1681 = m.ExcPending
	if v1681 != 0 {
		goto L372
...
L376:
	;
	v1716 = F_slice_from_s(m, l0, int32(6), int32(_a_F_basque_UTF_8_stem_3))
	mBase = m.M
	v1717 = m.ExcPending
	if v1717 != 0 {
		goto L372
...
L377:
	;
	v1710 = F_slice_from_s(m, l0, int32(7), int32(_a_F_basque_UTF_8_stem_4))
	mBase = m.M
	v1711 = m.ExcPending
	if v1711 != 0 {
		goto L372
...
L378:
	;
	v1704 = F_slice_from_s(m, l0, int32(7), int32(_a_F_basque_UTF_8_stem_5))
	mBase = m.M
	v1705 = m.ExcPending
	if v1705 != 0 {
		goto L372
...
L399:
	;
	v1762 = F_find_among_b(m, l0, int32(_a_F_basque_UTF_8_stem_6), int32(295))
	mBase = m.M
	v1763 = m.ExcPending
	if v1763 != 0 {
		goto L372
...
L403:
	;
	v1829 = F_slice_from_s(m, l0, int32(5), int32(_a_F_basque_UTF_8_stem_7))
	mBase = m.M
	v1830 = m.ExcPending
	if v1830 != 0 {
		goto L372
...
L404:
	;
	v1823 = F_slice_from_s(m, l0, int32(5), int32(_a_F_basque_UTF_8_stem_8))
	mBase = m.M
	v1824 = m.ExcPending
	if v1824 != 0 {
		goto L372
...
L405:
	;
	v1817 = F_slice_from_s(m, l0, int32(5), int32(_a_F_basque_UTF_8_stem_9))
	mBase = m.M
	v1818 = m.ExcPending
	if v1818 != 0 {
		goto L372
...
L406:
	;
	v1811 = F_slice_from_s(m, l0, int32(5), int32(_a_F_basque_UTF_8_stem_10))
	mBase = m.M
	v1812 = m.ExcPending
	if v1812 != 0 {
		goto L372
...
L407:
	;
	v1805 = F_slice_from_s(m, l0, int32(6), int32(_a_F_basque_UTF_8_stem_11))
	mBase = m.M
	v1806 = m.ExcPending
	if v1806 != 0 {
		goto L372
...
L408:
	;
	v1799 = F_slice_from_s(m, l0, int32(3), int32(_a_F_basque_UTF_8_stem_12))
	mBase = m.M
	v1800 = m.ExcPending
	if v1800 != 0 {
		goto L372
...
L410:
	;
	v1786 = F_slice_from_s(m, l0, int32(3), int32(_a_F_basque_UTF_8_stem_13))
	mBase = m.M
	v1787 = m.ExcPending
	if v1787 != 0 {
		goto L372
...
L439:
	;
	if int32(1)<<(uint(v1855)%32)&int32(_a_F_basque_UTF_8_stem_14) == int32(0) {
		goto L437
	} else {
		goto L440
	}
L440:
	;
	v1868 = F_find_among_b(m, l0, int32(_a_F_basque_UTF_8_stem_15), int32(19))
	mBase = m.M
	v1869 = m.ExcPending
	if v1869 != 0 {
		goto L372
...
L443:
	;
	v1885 = F_slice_from_s(m, l0, int32(1), int32(_a_F_basque_UTF_8_stem_16))
	mBase = m.M
	v1886 = m.ExcPending
	if v1886 != 0 {
		goto L372
			...
			if v68 != 0 {
				...
				if v71 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v18
					F_errmsg(m, int32(_a_F_bitsetbit_0), v10)
					mBase = m.M
					v78 = m.ExcPending
					if v78 != 0 {
						return int32(0)
				...
				if base.Ui32(int32(2)) <= base.Ui32(v22) {
					...
					if v87 != 0 {
						...
						if v90 != 0 {
							...
							F_errmsg(m, int32(_a_F_bitsetbit_3), int32(0))
							mBase = m.M
							v94 = m.ExcPending
							if v94 != 0 {
								return int32(0)
...
L179:
	;
	F_errfinish(m, int32(_a_F_blockreftable_insert_1), int32(327), int32(_a_F_blockreftable_insert_2))
	mBase = m.M
	v1051 = m.ExcPending
	if v1051 != 0 {
		goto L63
...
L274:
	;
	F_errfinish(m, int32(_a_F_blockreftable_insert_1), int32(630), int32(_a_F_blockreftable_insert_4))
	mBase = m.M
	v1588 = m.ExcPending
	if v1588 != 0 {
		goto L63
...
func F_bloptions(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v19 int32
	_ = v19
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_bloptions[0]))
	v11 = F_build_reloptions(m, l0, l1, v6, int32(136), int32(_a_F_bloptions_0), int32(33))
	mBase = m.M
	v14 = m.ExcPending
	if v14 != 0 {
		return int32(0)
...
L41:
	;
	F_errfinish(m, int32(_a_F_blvalidate_1), v147, int32(_a_F_blvalidate_2))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L2
...
L50:
	;
	v301 = *(*int32)(unsafe.Add(mBase, _c_F_brincostestimate[2]))
	if v301 == int32(0) {
		goto L53
	} else {
		goto L54
...
L52:
	...
	v338 = *(*int32)(unsafe.Add(mBase, _c_F_brincostestimate[3]))
	if v338 == int32(0) {
		goto L63
	} else {
		goto L64
...
L99:
	...
	*(*float64)(unsafe.Add(mBase, uint32(l4))) = v479
	v482 = *(*float64)(unsafe.Add(mBase, _c_F_brincostestimate[4]))
...
L33:
	;
	v270 = *(*int32)(unsafe.Add(mBase, _c_F_bringetbitmap[0]))
	v273 = v262 + int32(16)
...
L42:
	;
	v341 = *(*int32)(unsafe.Add(mBase, _c_F_bringetbitmap[0]))
	v346 = F_AllocSetContextCreateInternal(m, v341, int32(_a_F_bringetbitmap_0), int32(0), int32(_a_F_bringetbitmap_1), int32(_a_F_bringetbitmap_2))
	mBase = m.M
	v347 = m.ExcPending
	if v347 != 0 {
		goto L6
...
L43:
	;
	v348 = int32(_a_F_bringetbitmap_3)
	v349 = *(*int32)(unsafe.Add(mBase, _c_F_bringetbitmap[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_bringetbitmap[0])) = v346
	if v72 != 0 {
		goto L44
	} else {
		goto L45
...
L46:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_bringetbitmap[0])) = v349
...
L47:
	;
	v386 = *(*int32)(unsafe.Add(mBase, _c_F_bringetbitmap[1]))
	if v386 != 0 {
		goto L49
	} else {
		goto L50
...
func F_bttextsortsupport(m *base.Module, l0 int32) int32 {
	...
	var v15 int32
	_ = v15
	v4 = int32(_a_F_bttextsortsupport_0)
	v5 = *(*int32)(unsafe.Add(mBase, _c_F_bttextsortsupport[0]))
	v6 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(v6)+4))
	v9 = *(*int32)(unsafe.Add(mBase, uint32(v6)))
	*(*int32)(unsafe.Add(mBase, _c_F_bttextsortsupport[0])) = v9
	...
	if v15 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_bttextsortsupport[0])) = v5
		return int32(0)
	}
}
...
L41:
	;
	F_errfinish(m, int32(_a_F_btvalidate_3), v171, int32(_a_F_btvalidate_4))
	mBase = m.M
	v194 = m.ExcPending
	if v194 != 0 {
		goto L2
...
L50:
	...
	if base.Ui32(int32(_a_F_btvalidate_6)) < base.Ui32((v260-int32(6))&int32(_a_F_btvalidate_7)) {
		v297 = v242
		goto L52
	} else {
		goto L53
...
L34:
	;
	v394 = *(*int32)(unsafe.Add(mBase, _c_F_build_setop_child_paths[0]))
	if v394 != 0 {
		goto L111
	} else {
		goto L112
...
L92:
	;
	v281 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_build_setop_child_paths[1])))
	if v281 == int32(0) {
		goto L51
	} else {
		goto L93
...
L95:
	;
	v289 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_build_setop_child_paths[1])))
	if v289&int32(1) != 0 {
		goto L87
	} else {
		goto L96
...
L83:
	...
	v330 = *(*float64)(unsafe.Add(mBase, _c_F_build_subplan[0]))
	v332 = *(*int32)(unsafe.Add(mBase, _c_F_build_subplan[1]))
...
L122:
	;
	v490 = int32(0)
	v492 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_build_subplan[2])))
	if v492 != int32(1) {
		v542 = l1
		v553 = v490
		goto L41
...
L124:
	;
	if base.B2i32(base.Ui32(v497) < base.Ui32(int32(15)))&int32(base.Ui32(int32(_a_F_build_subplan_0))>>(uint(v497)%32)) != 0 {
		v542 = l1
		v553 = v490
		goto L41
	} else {
...
L129:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v512
	F_errmsg_internal(m, int32(_a_F_build_subplan_1), v18+int32(16))
	mBase = m.M
	v519 = m.ExcPending
	if v519 != 0 {
		goto L1
...
L130:
	;
	F_errfinish(m, int32(_a_F_build_subplan_2), int32(423), int32(_a_F_build_subplan_3))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v610
	v615 = F_psprintf(m, int32(_a_F_build_subplan_4), v18)
	mBase = m.M
	v616 = m.ExcPending
	if v616 != 0 {
		goto L1
...
L141:
	;
	v600 = int32(_a_F_build_subplan_5)
...
L142:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+72)) = v596
	v610 = int32(_a_F_build_subplan_6)
	goto L138
L143:
	;
...
L2:
	...
	v17 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_builtin_locale_encoding[0])))
...
L13:
	;
	v42 = int32(_a_F_builtin_locale_encoding_1)
	v45 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_builtin_locale_encoding[1])))
