		...
		if l0 < int32(0) {
			...
			if v18 != 0 {
				...
				if v17 == int32(0) {
					...
					v30 = F__emscripten_memset_bulkmem(m, v26, base.I32_extend8_s(int32(0)), int32(8192))
					mBase = m.M
			...
			if v55 != 0 {
				...
				if v54 == int32(0) {
					...
					v68 = F__emscripten_memset_bulkmem(m, v59+l0<<(uint(int32(13))%32)+int32(-8192), base.I32_extend8_s(int32(0)), int32(8192))
					mBase = m.M
