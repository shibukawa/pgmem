								...
								if v83 != 0 {
									...
									if v85 != 0 {
										...
										if v84 == int32(0) {
											...
											v95 = v93 - int32(80)
											m.G0 = v95
											v101 = *(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_set_missing_value[1]))
													...
													if v130 == int32(1) {
														...
														if v136 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v95))) = v137
															F_errmsg_internal(m, int32(_a_F_binary_upgrade_set_missing_value_6), v95)
															mBase = m.M
															v141 = m.ExcPending
															if v141 != 0 {
																return int32(0)
...
func F_binary_upgrade_set_next_index_relfilenode(m *base.Module, l0 int32) int32 {
	...
	var v25 int32
	_ = v25
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_index_relfilenode[0])))
	if v3 == int32(0) {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				F_errmsg(m, int32(_a_F_binary_upgrade_set_next_index_relfilenode_0), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_binary_upgrade_set_next_index_relfilenode_1), int32(134), int32(_a_F_binary_upgrade_set_next_index_relfilenode_2))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_index_relfilenode[1])) = v25
		return int32(0)
	}
}
func F_binary_upgrade_set_next_pg_enum_oid(m *base.Module, l0 int32) int32 {
	...
	var v25 int32
	_ = v25
	v3 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_pg_enum_oid[0])))
	if v3 == int32(0) {
		F_errstart_cold(m, int32(21), int32(0))
		mBase = m.M
		v11 = m.ExcPending
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				F_errmsg(m, int32(_a_F_binary_upgrade_set_next_pg_enum_oid_0), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_binary_upgrade_set_next_pg_enum_oid_1), int32(167), int32(_a_F_binary_upgrade_set_next_pg_enum_oid_2))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		v25 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
		*(*int32)(unsafe.Add(mBase, _c_F_binary_upgrade_set_next_pg_enum_oid[1])) = v25
		return int32(0)
	}
}
