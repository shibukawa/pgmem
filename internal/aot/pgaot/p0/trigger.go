...
func F_ExecGetTriggerOldSlot(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v5 == int32(0) {
		v8 = int32(_a_F_ExecGetTriggerOldSlot_0)
		v9 = *(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerOldSlot[0]))
		v10 = *(*int32)(unsafe.Add(mBase, uint32(l1)+8))
		v12 = *(*int32)(unsafe.Add(mBase, uint32(l0)+100))
		*(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerOldSlot[0])) = v12
		...
		if v18 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerOldSlot[0])) = v9
				v24 = v19
				return v24
			}
		}
