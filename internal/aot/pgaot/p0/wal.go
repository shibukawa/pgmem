...
func F_InitializeWalConsistencyChecking(m *base.Module) {
	...
	if v3 != 0 {
		v5 = int32(0)
		v8 = F_find_option(m, int32(332005), v5, v5, int32(21))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return
			...
			*(*uint8)(unsafe.Add(mBase, _consts[179])) = uint8(v11)
			...
			F_set_config_option_ext(m, int32(332005), v15, v16, v17, v18, v11, int32(21))
			mBase = m.M
			v22 = m.ExcPending
			if v22 != 0 {
				return
					...
					if v14 == int32(0) {
						...
						if v18 != 0 {
							...
							if v22 != 0 {
								...
								if v21 != 0 {
									F_errmsg_internal(m, int32(241837), int32(0))
									mBase = m.M
									v26 = m.ExcPending
									if v26 != 0 {
										return
									} else {
										F_errfinish(m, int32(489728), int32(875), int32(116886))
										mBase = m.M
										v31 = m.ExcPending
										if v31 != 0 {
											return
...
func F_SetWalWriterSleeping(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5)+440)) = int32(1)
	if v6 != 0 {
		...
		F_s_lock(m, v10+int32(440), int32(492645), int32(9567), int32(330845))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
...
func F_WalRcvRunning(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+1456)) = int32(1)
	v11 = v6 + int32(1456)
	if v7 != 0 {
		F_s_lock(m, v11, int32(489201), int32(82), int32(331433))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
			...
			if v21 != int32(1) {
				...
				if v26-v24 < int64(11) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
					if v30 != 0 {
						F_s_lock(m, v11, int32(489201), int32(103), int32(331433))
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return int32(0)
