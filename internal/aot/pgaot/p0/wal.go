...
func F_InitializeWalConsistencyChecking(m *base.Module) {
	...
	if v3 != 0 {
		v5 = int32(0)
		v8 = F_find_option(m, int32(351796), v5, v5, int32(21))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return
			...
			v11 = int32(0)
			*(*uint8)(unsafe.Add(mBase, _consts[176])) = uint8(v11)
			...
			F_set_config_option_ext(m, int32(351796), v15, v16, v17, v18, v11, int32(21))
			mBase = m.M
			v22 = m.ExcPending
			if v22 != 0 {
				return
...
func F_ProcessWalSummarizerInterrupts(m *base.Module) {
	...
	var v38 int32
	_ = v38
	v2 = *(*int32)(unsafe.Add(mBase, _consts[490]))
	if v2 != 0 {
		...
		if v4 != 0 {
			...
			v6 = *(*int32)(unsafe.Add(mBase, _consts[303]))
			if v6 != 0 {
				*(*int32)(unsafe.Add(mBase, _consts[303])) = int32(0)
				...
				if v12 != 0 {
					...
					if v14 == int32(0) {
						v18 = int32(*(*uint8)(unsafe.Add(mBase, _consts[491])))
						if v18 != 0 {
							v36 = *(*int32)(unsafe.Add(mBase, _consts[492]))
							if v36 != 0 {
							...
							if v22 != 0 {
								...
								if v21 != 0 {
									F_errmsg_internal(m, int32(256419), int32(0))
									mBase = m.M
									v26 = m.ExcPending
									if v26 != 0 {
										return
									} else {
										F_errfinish(m, int32(518182), int32(875), int32(125809))
										mBase = m.M
										v31 = m.ExcPending
										if v31 != 0 {
											return
...
func F_SetWalWriterSleeping(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5)+440)) = int32(1)
	if v6 != 0 {
		...
		F_s_lock(m, v10+int32(440), int32(521598), int32(9567), int32(350636))
		mBase = m.M
		v17 = m.ExcPending
		if v17 != 0 {
			return
...
func F_WALInsertLockAcquireExclusive(m *base.Module) {
	...
	var v118 int32
	_ = v118
	v3 = *(*int32)(unsafe.Add(mBase, _consts[157]))
	...
	if v6 != 0 {
		...
		v8 = *(*int32)(unsafe.Add(mBase, _consts[157]))
		...
		if v13 != 0 {
			...
			v15 = *(*int32)(unsafe.Add(mBase, _consts[157]))
			...
			if v20 != 0 {
				...
				v22 = *(*int32)(unsafe.Add(mBase, _consts[157]))
				...
				if v29 != 0 {
					...
					v31 = *(*int32)(unsafe.Add(mBase, _consts[157]))
					...
					if v36 != 0 {
						...
						if v45 != 0 {
							...
							v47 = *(*int32)(unsafe.Add(mBase, _consts[157]))
							...
							if v52 != 0 {
								...
								v54 = *(*int32)(unsafe.Add(mBase, _consts[157]))
								...
								if v61 != 0 {
									...
									v63 = *(*int32)(unsafe.Add(mBase, _consts[157]))
									...
									if v68 != 0 {
										...
										v70 = *(*int32)(unsafe.Add(mBase, _consts[157]))
										...
										if v77 != 0 {
											...
											v79 = *(*int32)(unsafe.Add(mBase, _consts[157]))
											...
											if v84 != 0 {
												...
												v86 = *(*int32)(unsafe.Add(mBase, _consts[157]))
												...
												if v93 != 0 {
													...
													v95 = *(*int32)(unsafe.Add(mBase, _consts[157]))
													...
													if v100 != 0 {
														...
														if v109 != 0 {
															...
															v111 = *(*int32)(unsafe.Add(mBase, _consts[157]))
															...
															if v116 != 0 {
																...
																v118 = int32(1)
																*(*uint8)(unsafe.Add(mBase, _consts[158])) = uint8(v118)
																return
															}
														}
													}
...
func F_WalRcvRunning(m *base.Module) int32 {
	...
	var v53 int32
	_ = v53
	v6 = *(*int32)(unsafe.Add(mBase, _consts[548]))
	v7 = *(*int32)(unsafe.Add(mBase, uint32(v6)+1456))
	*(*int32)(unsafe.Add(mBase, uint32(v6)+1456)) = int32(1)
	v11 = v6 + int32(1456)
	if v7 != 0 {
		F_s_lock(m, v11, int32(517466), int32(82), int32(351224))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
			...
			if v21 != int32(1) {
				...
				if v26-v24 < int64(11) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
					if v30 != 0 {
						F_s_lock(m, v11, int32(517466), int32(103), int32(351224))
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return int32(0)
...
func F_WalSndWakeup(m *base.Module, l0 int32, l1 int32) {
	...
	_ = v14
	if l0 != 0 {
		v4 = *(*int32)(unsafe.Add(mBase, _consts[545]))
		...
		if v8 != 0 {
			...
			if l1 != 0 {
				v10 = *(*int32)(unsafe.Add(mBase, _consts[545]))
