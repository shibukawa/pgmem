...
func F_StatsShmemSize(m *base.Module) int32 {
	...
	var v404 int32
	_ = v404
	v5 = F_add_size(m, int32(53368), int32(262144))
	mBase = m.M
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
		...
		v24 = int32(0)
		v26 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v26 == v24 {
			v36 = v24
		} else {
			v30 = int32(96)
		...
		v68 = int32(0)
		v70 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v70 == v68 {
			v80 = v68
		} else {
		...
		v112 = int32(0)
		v114 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v114 == v112 {
			v124 = v112
		} else {
		...
		v156 = int32(0)
		v158 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v158 == v156 {
			v168 = v156
		} else {
		...
		v200 = int32(0)
		v202 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v202 == v200 {
			v212 = v200
		} else {
		...
		v244 = int32(0)
		v246 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v246 == v244 {
			v256 = v244
		} else {
		...
		v288 = int32(0)
		v290 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v290 == v288 {
			v300 = v288
		} else {
		...
		v332 = int32(0)
		v334 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v334 == v332 {
			v344 = v332
		} else {
		...
		v376 = int32(0)
		v378 = *(*int32)(unsafe.Add(mBase, _consts[683]))
		if v378 == v376 {
			v388 = v376
		} else {
