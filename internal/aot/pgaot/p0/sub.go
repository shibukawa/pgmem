...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v156
	F_errmsg_internal(m, int32(462606), v20+int32(16))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
...
L29:
	;
	F_errfinish(m, int32(473695), int32(936), int32(269681))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L1
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v317
	F_errmsg_internal(m, int32(417619), v20)
	mBase = m.M
	v321 = m.ExcPending
	if v321 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(473695), int32(827), int32(269681))
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L1
...
L65:
	;
	F_errfinish(m, int32(473695), int32(989), int32(269681))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L1
...
L68:
	;
	F_errfinish(m, int32(473695), int32(996), int32(269681))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L1
...
L70:
	;
	v380 = F_ExecInitExtraTupleSlot(m, v29, v377, int32(1575956))
	mBase = m.M
	v381 = m.ExcPending
	if v381 != 0 {
		goto L1
...
L73:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+28)) = v386
	v390 = F_ExecInitExtraTupleSlot(m, v29, v386, int32(1575956))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L1
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+36)) = v395
	...
	v403 = F_ExecBuildHash32FromAttrs(m, v377, int32(1575956), v198, v399, v400, v401, l1, int32(0))
	mBase = m.M
	v404 = m.ExcPending
	if v404 != 0 {
		goto L1
...
L76:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+84)) = v403
	...
	v410 = F_ExecBuildGroupingEqual(m, v377, v386, int32(1575956), int32(1576060), v177, v408, v203, v409, l1)
	mBase = m.M
	v411 = m.ExcPending
	if v411 != 0 {
		goto L1
...
func F_SubTransGetParent(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(int32(3)) <= base.Ui32(l0) {
		...
		v11 = F_SimpleLruReadPage_ReadOnly(m, int32(4337896), base.I64_extend_i32_u(v9), l0)
		mBase = m.M
		v14 = m.ExcPending
		if v14 != 0 {
			return int32(0)
