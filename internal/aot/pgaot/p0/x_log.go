...
func F_CheckXLogRemoved(m *base.Module, l0 int64, l1 int32) {
	...
	v9 = v7 - int32(80)
	m.G0 = v9
	v12 = *(*int32)(unsafe.Add(mBase, _consts[166]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+440)) = int32(1)
	if v15 != 0 {
		...
		F_s_lock(m, v19+int32(440), int32(497943), int32(3730), int32(440260))
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v28)+440)) = int32(0)
			...
			if base.Ui64(l0) <= base.Ui64(v31) {
				v36 = *(*int32)(unsafe.Add(mBase, _consts[167]))
					...
					if v44 != 0 {
						...
						if v46 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(16)
							F_errmsg(m, int32(440159), v9)
							mBase = m.M
							v52 = m.ExcPending
							if v52 != 0 {
								return
							} else {
								F_errfinish(m, int32(497943), int32(3743), int32(440260))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
...
func F_InstallXLogFileSegment(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int64, l4 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = l4
	v19 = int64(*(*int32)(unsafe.Add(mBase, _consts[167])))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v13)+24)) = uint32(v24)
	v32 = F_pg_snprintf(m, v13+int32(128), int32(1024), int32(509910), v13+int32(16))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = l4
	v73 = int64(*(*int32)(unsafe.Add(mBase, _consts[167])))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v13)+8)) = uint32(v78)
	v84 = F_pg_snprintf(m, v13+int32(128), int32(1024), int32(509910), v13)
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L1
		...
		if v9 == int32(1) {
			...
			*(*uint8)(unsafe.Add(mBase, _consts[2])) = uint8(v17)
			if v15 != int32(2) {
				...
				v22 = int32(1)
				*(*int32)(unsafe.Add(mBase, _consts[182])) = v22
				v26 = v22
			}
		} else {
			v22 = int32(1)
	...
	if v28 != 0 {
		...
		if v30 != 0 {
			...
			if v50 != 0 {
				...
				F_errmsg_internal(m, int32(453743), int32(0))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return
				} else {
					F_errfinish(m, int32(492842), int32(160), int32(81843))
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return
			...
			v32 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _consts[183])) = uint8(v32)
			return
		}
	} else {
		F_errstart_cold(m, int32(21), int32(0))
		...
		if v37 != 0 {
			...
			if v41 != 0 {
				...
				F_errfinish(m, int32(492842), int32(157), int32(81843))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return
