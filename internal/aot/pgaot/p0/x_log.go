...
func F_CheckXLogRemoved(m *base.Module, l0 int64, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+440)) = int32(1)
	if v15 != 0 {
		...
		F_s_lock(m, v19+int32(440), int32(497836), int32(3730), int32(440164))
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
						...
						if v46 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v9 + int32(16)
							...
							if v52 != 0 {
								...
								F_errfinish(m, int32(497836), int32(3743), int32(440164))
								mBase = m.M
								v57 = m.ExcPending
								if v57 != 0 {
									return
...
func F_InstallXLogFileSegment(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int64, l4 int32) int32 {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v13)+24)) = uint32(v24)
	v32 = F_pg_snprintf(m, v13+int32(128), int32(1024), int32(509803), v13+int32(16))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L14:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v13)+8)) = uint32(v78)
	v84 = F_pg_snprintf(m, v13+int32(128), int32(1024), int32(509803), v13)
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L1
	...
	if v28 != 0 {
		...
		if v30 != 0 {
			...
			if v50 != 0 {
				...
				F_errmsg_internal(m, int32(453647), int32(0))
				mBase = m.M
				v54 = m.ExcPending
				if v54 != 0 {
					return
				} else {
					F_errfinish(m, int32(492746), int32(160), int32(81843))
					mBase = m.M
					v59 = m.ExcPending
					if v59 != 0 {
						return
		...
		if v37 != 0 {
			...
			if v41 != 0 {
				...
				F_errfinish(m, int32(492746), int32(157), int32(81843))
				mBase = m.M
				v46 = m.ExcPending
				if v46 != 0 {
					return
