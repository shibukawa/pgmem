	...
	if v15 != 0 {
		...
		if v14 != 0 {
			...
			if v19 == int32(0) {
				...
				v50 = *(*float64)(unsafe.Add(mBase, _c_F_add_function_cost[0]))
...
L87:
	;
	v379 = *(*int32)(unsafe.Add(mBase, _c_F_simplify_function[0]))
...
L89:
	;
	v384 = *(*int32)(unsafe.Add(mBase, _c_F_simplify_function[1]))
	if v384 != 0 {
		goto L90
	} else {
		goto L91
...
L92:
	;
	v388 = *(*int32)(unsafe.Add(mBase, _c_F_simplify_function[2]))
	v393 = F_AllocSetContextCreateInternal(m, v388, int32(_a_F_simplify_function_3), int32(0), int32(_a_F_simplify_function_4), int32(_a_F_simplify_function_5))
	mBase = m.M
	v394 = m.ExcPending
	if v394 != 0 {
		goto L4
...
L95:
	;
	v395 = int32(_a_F_simplify_function_6)
	v396 = *(*int32)(unsafe.Add(mBase, _c_F_simplify_function[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_simplify_function[2])) = v393
...
L100:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_simplify_function[3])) = v906
	v913 = v887
	goto L60
L101:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_simplify_function[2])) = v396
...
L200:
	...
	v782 = *(*float64)(unsafe.Add(mBase, _c_F_simplify_function[4]))
