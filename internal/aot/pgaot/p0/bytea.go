			...
			if v58 != 0 {
				...
				if v61 != 0 {
					...
					*(*int64)(unsafe.Add(mBase, uint32(v10))) = v26
					F_errmsg(m, int32(414994), v10)
					mBase = m.M
					v68 = m.ExcPending
					if v68 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(483184), int32(3428), int32(98288))
						mBase = m.M
						v73 = m.ExcPending
						if v73 != 0 {
							return int32(0)
				...
				if base.Ui32(int32(2)) <= base.Ui32(v30) {
					...
					if v77 != 0 {
						...
						if v80 != 0 {
							...
							F_errmsg(m, int32(535929), int32(0))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(483184), int32(3440), int32(98288))
								mBase = m.M
								v89 = m.ExcPending
								if v89 != 0 {
									return int32(0)
