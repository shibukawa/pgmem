	...
	if v15 == int32(0) {
				...
				if v98 != 0 {
					...
					if v97 == int32(0) {
						...
						if v132 != 0 {
							...
							F_errmsg_internal(m, int32(407690), int32(0))
							mBase = m.M
							v136 = m.ExcPending
							if v136 != 0 {
								return
							} else {
								F_errfinish(m, int32(499232), int32(1930), int32(242442))
								mBase = m.M
								v141 = m.ExcPending
								if v141 != 0 {
									return
		...
		if v119 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = v15
			F_errmsg_internal(m, int32(52382), v10)
			mBase = m.M
			v123 = m.ExcPending
			if v123 != 0 {
				return
			} else {
				F_errfinish(m, int32(499232), int32(1905), int32(242442))
				mBase = m.M
				v128 = m.ExcPending
				if v128 != 0 {
					return
