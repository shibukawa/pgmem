...
func F_ExecutorRun(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	var v173 int32
	_ = v173
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorRun[0]))
	if v15 != 0 {
		goto L1
	} else {
		goto L2
...
L3:
	;
	v18 = int32(_a_F_ExecutorRun_0)
	v19 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorRun[1]))
	v21 = *(*int32)(unsafe.Add(mBase, uint32(l0)+40))
	v22 = *(*int32)(unsafe.Add(mBase, uint32(v21)+100))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorRun[1])) = v22
...
L24:
	;
	v71 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorRun[2]))
...
L58:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _c_F_ExecutorRun[2]))
...
L66:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExecutorRun[1])) = v19
	return
L67:
	;
	goto L66
