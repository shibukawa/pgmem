...
func F_CreateExecutorState(m *base.Module) int32 {
	...
	v10 = F_AllocSetContextCreateInternal(m, v5, int32(371444), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v13 = m.ExcPending
	if v13 != 0 {
		return int32(0)
...
func F_ExecutorRun(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	var v173 int32
	_ = v173
	v15 = *(*int32)(unsafe.Add(mBase, _consts[322]))
	if v15 != 0 {
		goto L1
	} else {
		goto L2
...
L22:
	;
	v54 = int32(*(*uint8)(unsafe.Add(mBase, _consts[324])))
	if v54 != 0 {
		goto L25
	} else {
		goto L26
...
L25:
	;
	v56 = *(*int32)(unsafe.Add(mBase, _consts[325]))
