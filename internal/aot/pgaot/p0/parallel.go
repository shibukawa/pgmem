		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v24
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(4060124)
...
L11:
	;
	v62 = F___memcpy(m, int32(4616532), v51, int32(140))
	mBase = m.M
	goto L13
L12:
	;
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, _consts[55])) = v71
	...
	v80 = F_AllocSetContextCreateInternal(m, v75, int32(211854), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L14
...
L172:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v596)+40)) = v622
	v628 = F_hash_create(m, int32(310325), int32(16), v596, int32(1064))
	mBase = m.M
	v629 = m.ExcPending
	if v629 != 0 {
		goto L14
...
L185:
	;
	F_errmsg_internal(m, int32(148030), int32(0))
	mBase = m.M
	v682 = m.ExcPending
	if v682 != 0 {
		goto L14
...
L186:
	;
	F_errfinish(m, int32(476181), int32(749), int32(228663))
	mBase = m.M
	v687 = m.ExcPending
	if v687 != 0 {
		goto L14
...
L189:
	;
	v690 = F__emscripten_memcpy_bulkmem(m, int32(4437792), v663, int32(524))
	mBase = m.M
	goto L191
L191:
	;
...
L193:
	;
	v696 = F__emscripten_memcpy_bulkmem(m, int32(4438840), v663+v693, v693)
	mBase = m.M
	goto L195
L195:
	;
...
L215:
	;
	F_errmsg_internal(m, int32(166534), int32(0))
	mBase = m.M
	v817 = m.ExcPending
	if v817 != 0 {
		goto L14
...
L216:
	;
	F_errfinish(m, int32(480427), int32(362), int32(340047))
	mBase = m.M
	v822 = m.ExcPending
	if v822 != 0 {
		goto L14
...
L223:
	;
	F_errmsg_internal(m, int32(90188), int32(0))
	mBase = m.M
	v861 = m.ExcPending
	if v861 != 0 {
		goto L14
...
L224:
	;
	F_errfinish(m, int32(477225), int32(169), int32(260266))
	mBase = m.M
	v866 = m.ExcPending
	if v866 != 0 {
		goto L14
...
L232:
	...
	*(*int32)(unsafe.Add(mBase, _consts[0])) = v893
	...
	v900 = F_dshash_attach(m, v897, int32(1725260), v899, v897)
	mBase = m.M
	v901 = m.ExcPending
	if v901 != 0 {
		goto L14
...
L233:
	...
	v908 = F_dshash_attach(m, v904, int32(1725284), v906, int32(0))
	mBase = m.M
	v909 = m.ExcPending
	if v909 != 0 {
		goto L14
...
L356:
	;
	F_errfinish(m, int32(480467), int32(6168), int32(16619))
	mBase = m.M
	v1265 = m.ExcPending
	if v1265 != 0 {
		goto L14
...
L369:
	;
	F_errfinish(m, int32(480467), int32(6353), int32(340068))
	mBase = m.M
	v1320 = m.ExcPending
	if v1320 != 0 {
		goto L14
...
L373:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1345)+40)) = v1351
	v1357 = F_hash_create(m, int32(154030), int32(32), v1345, int32(1064))
	mBase = m.M
	v1358 = m.ExcPending
	if v1358 != 0 {
		goto L14
...
L381:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1345)+40)) = v1407
	v1413 = F_hash_create(m, int32(149880), int32(32), v1345, int32(1064))
	mBase = m.M
	v1414 = m.ExcPending
	if v1414 != 0 {
		goto L14
...
L399:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v1495)+16)) = int64(103079215120)
	...
	v1506 = F_hash_create(m, int32(304583), v1504, v1495, int32(40))
	mBase = m.M
	v1507 = m.ExcPending
	if v1507 != 0 {
		goto L14
...
L413:
	;
	F_errfinish(m, int32(478227), int32(1355), int32(267142))
	mBase = m.M
	v1599 = m.ExcPending
	if v1599 != 0 {
		goto L14
...
L417:
	;
	F_errfinish(m, int32(478227), int32(1360), int32(267142))
	mBase = m.M
	v1615 = m.ExcPending
	if v1615 != 0 {
		goto L14
...
L419:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v247
	F_errmsg_internal(m, int32(407181), v19+int32(16))
	mBase = m.M
	v1625 = m.ExcPending
	if v1625 != 0 {
		goto L14
...
L420:
	;
	F_errfinish(m, int32(478227), int32(1666), int32(244087))
	mBase = m.M
	v1630 = m.ExcPending
	if v1630 != 0 {
		goto L14
...
L423:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v1637
	F_errmsg_internal(m, int32(437034), v19)
	mBase = m.M
	v1641 = m.ExcPending
	if v1641 != 0 {
		goto L14
...
L424:
	;
	F_errfinish(m, int32(478227), int32(1452), int32(267142))
	mBase = m.M
	v1646 = m.ExcPending
	if v1646 != 0 {
		goto L14
