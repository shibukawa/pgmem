		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v24
			...
			if v28 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(4053420)
...
L11:
	;
	v62 = F___memcpy(m, int32(4609588), v51, int32(140))
	mBase = m.M
	goto L13
L12:
	;
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, _consts[55])) = v71
	...
	v80 = F_AllocSetContextCreateInternal(m, v75, int32(210188), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L14
...
L172:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v596)+40)) = v622
	v628 = F_hash_create(m, int32(307505), int32(16), v596, int32(1064))
	mBase = m.M
	v629 = m.ExcPending
	if v629 != 0 {
		goto L14
...
L185:
	;
	F_errmsg_internal(m, int32(146464), int32(0))
	mBase = m.M
	v682 = m.ExcPending
	if v682 != 0 {
		goto L14
...
L186:
	;
	F_errfinish(m, int32(472149), int32(749), int32(226523))
	mBase = m.M
	v687 = m.ExcPending
	if v687 != 0 {
		goto L14
...
L189:
	;
	v690 = F__emscripten_memcpy_bulkmem(m, int32(4430848), v663, int32(524))
	mBase = m.M
	goto L191
L191:
	;
...
L193:
	;
	v696 = F__emscripten_memcpy_bulkmem(m, int32(4431896), v663+v693, v693)
	mBase = m.M
	goto L195
L195:
	;
...
L215:
	;
	F_errmsg_internal(m, int32(164913), int32(0))
	mBase = m.M
	v817 = m.ExcPending
	if v817 != 0 {
		goto L14
...
L216:
	;
	F_errfinish(m, int32(476332), int32(362), int32(337016))
	mBase = m.M
	v822 = m.ExcPending
	if v822 != 0 {
		goto L14
...
L223:
	;
	F_errmsg_internal(m, int32(89324), int32(0))
	mBase = m.M
	v861 = m.ExcPending
	if v861 != 0 {
		goto L14
...
L224:
	;
	F_errfinish(m, int32(473154), int32(169), int32(258102))
	mBase = m.M
	v866 = m.ExcPending
	if v866 != 0 {
		goto L14
...
L356:
	;
	F_errfinish(m, int32(476372), int32(6168), int32(16460))
	mBase = m.M
	v1265 = m.ExcPending
	if v1265 != 0 {
		goto L14
...
L369:
	;
	F_errfinish(m, int32(476372), int32(6353), int32(337037))
	mBase = m.M
	v1320 = m.ExcPending
	if v1320 != 0 {
		goto L14
...
L373:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1345)+40)) = v1351
	v1357 = F_hash_create(m, int32(152438), int32(32), v1345, int32(1064))
	mBase = m.M
	v1358 = m.ExcPending
	if v1358 != 0 {
		goto L14
...
L381:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1345)+40)) = v1407
	v1413 = F_hash_create(m, int32(148314), int32(32), v1345, int32(1064))
	mBase = m.M
	v1414 = m.ExcPending
	if v1414 != 0 {
		goto L14
...
L399:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v1495)+16)) = int64(103079215120)
	...
	v1506 = F_hash_create(m, int32(301847), v1504, v1495, int32(40))
	mBase = m.M
	v1507 = m.ExcPending
	if v1507 != 0 {
		goto L14
...
L413:
	;
	F_errfinish(m, int32(474132), int32(1355), int32(264934))
	mBase = m.M
	v1599 = m.ExcPending
	if v1599 != 0 {
		goto L14
...
L417:
	;
	F_errfinish(m, int32(474132), int32(1360), int32(264934))
	mBase = m.M
	v1615 = m.ExcPending
	if v1615 != 0 {
		goto L14
...
L419:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v247
	F_errmsg_internal(m, int32(403635), v19+int32(16))
	mBase = m.M
	v1625 = m.ExcPending
	if v1625 != 0 {
		goto L14
...
L420:
	;
	F_errfinish(m, int32(474132), int32(1666), int32(241923))
	mBase = m.M
	v1630 = m.ExcPending
	if v1630 != 0 {
		goto L14
...
L423:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v1637
	F_errmsg_internal(m, int32(433201), v19)
	mBase = m.M
	v1641 = m.ExcPending
	if v1641 != 0 {
		goto L14
...
L424:
	;
	F_errfinish(m, int32(474132), int32(1452), int32(264934))
	mBase = m.M
	v1646 = m.ExcPending
	if v1646 != 0 {
		goto L14
