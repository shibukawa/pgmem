...
L2:
	;
	F_errmsg(m, int32(_a_F_RangeVarAdjustRelationPersistence_0), int32(0))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L12
...
L4:
	;
	v161 = F_get_namespace_name(m, l1)
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L12
...
L5:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_RangeVarAdjustRelationPersistence[0]))
	if v32 == int32(0) {
		goto L19
	} else {
		goto L20
...
L6:
	;
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_RangeVarAdjustRelationPersistence[0]))
	if v8 != 0 {
		goto L7
	} else {
		goto L8
...
L10:
	;
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_RangeVarAdjustRelationPersistence[1]))
	if v11 == l1 {
		goto L3
	} else {
		goto L11
...
L16:
	;
	F_errmsg(m, int32(_a_F_RangeVarAdjustRelationPersistence_1), int32(0))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L12
...
L21:
	;
	v37 = *(*int32)(unsafe.Add(mBase, _c_F_RangeVarAdjustRelationPersistence[1]))
	if v37 != l1 {
		goto L19
	} else {
		goto L24
...
L26:
	;
	v45 = int32(_a_F_RangeVarAdjustRelationPersistence_4)
	goto L30
L27:
	;
	F_errstart_cold(m, int32(21), int32(0))
...
L36:
	...
	if base.B2i32(v56 != v58)|base.B2i32(v58 == int32(0)) != 0 {
		v74 = v54
		v76 = v56
		goto L35
	} else {
...
L39:
	...
	v67 = int32(1)
	v68 = v54 + v67
	v69 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v53)+1)))
	if v69 != 0 {
		v53 = v53 + v67
		v54 = v68
		v55 = v64
...
L43:
	;
	v96 = int32(_a_F_RangeVarAdjustRelationPersistence_5)
	goto L47
L44:
	;
	goto L27
...
L48:
	;
	v103 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v41))))
	if v103 != 0 {
		goto L49
	} else {
		goto L50
...
L53:
	...
	if base.B2i32(v107 != v109)|base.B2i32(v109 == int32(0)) != 0 {
		v125 = v105
		v127 = v107
		goto L52
	} else {
...
L56:
	...
	v118 = int32(1)
	v119 = v105 + v118
	v120 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v104)+1)))
	if v120 != 0 {
		v104 = v104 + v118
		v105 = v119
		v106 = v115
...
L65:
	;
	v165 = int32(_a_F_RangeVarAdjustRelationPersistence_4)
	goto L68
L66:
	;
...
L69:
	;
	v172 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v161))))
	if v172 != 0 {
		goto L70
	} else {
		goto L71
...
L74:
	...
	if base.B2i32(v176 != v178)|base.B2i32(v178 == int32(0)) != 0 {
		v194 = v174
		v196 = v176
		goto L73
	} else {
...
L77:
	...
	v187 = int32(1)
	v188 = v174 + v187
	v189 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v173)+1)))
	if v189 != 0 {
		v173 = v173 + v187
		v174 = v188
		v175 = v184
...
L81:
	;
	v216 = int32(_a_F_RangeVarAdjustRelationPersistence_5)
	goto L85
L82:
	;
	goto L1
...
L86:
	;
	v223 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v161))))
	if v223 != 0 {
		goto L87
	} else {
		goto L88
...
L91:
	...
	if base.B2i32(v227 != v229)|base.B2i32(v229 == int32(0)) != 0 {
		v245 = v225
		v247 = v227
		goto L90
	} else {
...
L94:
	...
	v238 = int32(1)
	v239 = v225 + v238
	v240 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v224)+1)))
	if v240 != 0 {
		v224 = v224 + v238
		v225 = v239
		v226 = v235
...
L101:
	;
	F_errmsg(m, int32(_a_F_RangeVarAdjustRelationPersistence_6), int32(0))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L12
					...
					if v26 == int32(0) {
						...
						if v90 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = l1
							F_errmsg_internal(m, int32(_a_F_get_range_io_data_0), v9)
							mBase = m.M
							v94 = m.ExcPending
							if v94 != 0 {
								return int32(0)
										...
										if v58 != 0 {
											...
											if l2 == int32(2) {
												*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v57
												F_errmsg(m, int32(_a_F_get_range_io_data_3), v9+int32(16))
												mBase = m.M
												v105 = m.ExcPending
												if v105 != 0 {
													return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v57
												F_errmsg(m, int32(_a_F_get_range_io_data_4), v9+int32(32))
												mBase = m.M
												v66 = m.ExcPending
												if v66 != 0 {
													return int32(0)
...
L8:
	...
	v23 = int32(*(*int16)(unsafe.Add(mBase, uint32(v19+v16<<(uint(int32(1))%32)))))
	if v23 != 0 {
		goto L11
	} else {
		goto L12
...
L24:
	;
	F_errmsg_internal(m, int32(_a_F_get_range_nulltest_0), int32(0))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L14
...
L25:
	;
	F_errfinish(m, int32(_a_F_get_range_nulltest_1), int32(_a_F_get_range_nulltest_2), int32(_a_F_get_range_nulltest_3))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L14
		...
		if v19 == int32(0) {
			...
			if v31 != 0 {
				...
				if v38 != 0 {
					...
					v39 = F_range_cmp_bounds(m, l0, v25, v34)
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
			...
			if v33 != 0 {
				...
				if v41 != 0 {
					...
					if v48 != 0 {
						...
						v49 = F_range_cmp_bounds(m, l0, v25, v37)
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return int32(0)
