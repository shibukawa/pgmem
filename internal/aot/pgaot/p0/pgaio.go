...
func F_pgaio_io_perform_synchronously(m *base.Module, l0 int32) {
	...
	var v82 int32
	_ = v82
	v7 = *(*int32)(unsafe.Add(mBase, _consts[553]))
	...
	*(*int32)(unsafe.Add(mBase, _consts[7])) = v12 + int32(1)
	...
	case 0:
		...
		if v49 != 0 {
			...
			F_errmsg_internal(m, int32(274031), int32(0))
			mBase = m.M
			v53 = m.ExcPending
			if v53 != 0 {
				return
			} else {
				F_errfinish(m, int32(520620), int32(141), int32(19598))
				mBase = m.M
				v58 = m.ExcPending
				if v58 != 0 {
					return
...
func F_pgaio_worker_needs_synchronous_execution(m *base.Module, l0 int32) int32 {
	...
	if v5 != v3 {
		...
		if v8&int32(2) != 0 {
			...
			v16 = *(*int32)(unsafe.Add(mBase, uint32(v11<<(uint(int32(2))%32))+uint32(_consts[554])))
...
L8:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _consts[555]))
	v43 = v41 + int32(152)
...
L14:
	...
	v89 = *(*int32)(unsafe.Add(mBase, _consts[556]))
...
L19:
	...
	v130 = *(*int32)(unsafe.Add(mBase, _consts[553]))
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v109
	F_errmsg_internal(m, int32(130997), v16)
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L7
...
L26:
	;
	F_errfinish(m, int32(519886), int32(191), int32(88007))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L7
...
L29:
	;
	v143 = *(*int32)(unsafe.Add(mBase, _consts[557]))
...
L37:
	...
	v173 = *(*int32)(unsafe.Add(mBase, _consts[553]))
...
L39:
	...
	v195 = *(*int32)(unsafe.Add(mBase, uint32(v190<<(uint(int32(2))%32))+uint32(_consts[554])))
	v196 = *(*int32)(unsafe.Add(mBase, uint32(v195)+8))
	goto L43
L40:
	;
	v187 = *(*int32)(unsafe.Add(mBase, uint32(v180<<(uint(int32(2))%32))+uint32(_consts[558])))
	v188 = v187
	goto L42
L41:
	;
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = (v171 - v174) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(493134), v16+int32(16))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L7
...
L45:
	;
	v206 = *(*int32)(unsafe.Add(mBase, uint32(v199<<(uint(int32(2))%32))+uint32(_consts[559])))
	v207 = v206
	goto L47
L46:
	;
...
L48:
	;
	F_errfinish(m, int32(519886), int32(276), int32(326083))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L7
