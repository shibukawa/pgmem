	...
	*(*int32)(unsafe.Add(mBase, _consts[7])) = v12 + int32(1)
	...
	case 0:
		...
		if v49 != 0 {
			...
			F_errmsg_internal(m, int32(260953), int32(0))
			mBase = m.M
			v53 = m.ExcPending
			if v53 != 0 {
				return
			} else {
				F_errfinish(m, int32(495958), int32(141), int32(19292))
				mBase = m.M
				v58 = m.ExcPending
				if v58 != 0 {
					return
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v109
	F_errmsg_internal(m, int32(122978), v16)
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L7
...
L26:
	;
	F_errfinish(m, int32(495259), int32(191), int32(81689))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		goto L7
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = (v171 - v174) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(470928), v16+int32(16))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L7
...
L48:
	;
	F_errfinish(m, int32(495259), int32(276), int32(310813))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L7
