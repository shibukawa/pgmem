...
func F_RemoveXlogFile(m *base.Module, l0 int32, l1 int64, l2 int32, l3 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v12
	v20 = F_pg_snprintf(m, v9+int32(48), int32(1024), int32(_a_F_RemoveXlogFile_0), v9+int32(32))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		return
	} else {
		v23 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_RemoveXlogFile[0])))
		if v23 != int32(1) {
			...
			if v76 != 0 {
				...
				if v75 != 0 {
					*(*int32)(unsafe.Add(mBase, uint32(v9))) = v12
					F_errmsg_internal(m, int32(_a_F_RemoveXlogFile_1), v9)
					mBase = m.M
					v80 = m.ExcPending
					if v80 != 0 {
						return
						...
						if v85 != 0 {
							...
							if v90 != 0 {
								...
								if v89 != 0 {
									...
									v91 = int32(_a_F_RemoveXlogFile_4)
									v93 = *(*int32)(unsafe.Add(mBase, _c_F_RemoveXlogFile[1]))
									*(*int32)(unsafe.Add(mBase, _c_F_RemoveXlogFile[1])) = v93 + int32(1)
			...
			if base.Ui64(l1) < base.Ui64(v26) {
				...
				v29 = *(*int32)(unsafe.Add(mBase, _c_F_RemoveXlogFile[2]))
									...
									if v51 != 0 {
										...
										if v50 != 0 {
											*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v12
											F_errmsg_internal(m, int32(_a_F_RemoveXlogFile_5), v9+int32(16))
											mBase = m.M
											v57 = m.ExcPending
											if v57 != 0 {
												return
												...
												if v62 != 0 {
													...
													v63 = int32(_a_F_RemoveXlogFile_6)
													v65 = *(*int32)(unsafe.Add(mBase, _c_F_RemoveXlogFile[3]))
													*(*int32)(unsafe.Add(mBase, _c_F_RemoveXlogFile[3])) = v65 + int32(1)
