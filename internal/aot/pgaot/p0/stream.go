...
func F_stream_commit_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	*(*int32)(unsafe.Add(mBase, _c_F_stream_commit_cb_wrapper[0])) = v9 + int32(4)
	...
	if v37 == int32(0) {
		...
		if v43 != 0 {
			...
			if v46 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(_a_F_stream_commit_cb_wrapper_2)
				F_errmsg(m, int32(_a_F_stream_commit_cb_wrapper_3), v9)
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return
				} else {
					F_errfinish(m, int32(_a_F_stream_commit_cb_wrapper_4), int32(1485), int32(_a_F_stream_commit_cb_wrapper_5))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return
		...
		if v58 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _c_F_stream_commit_cb_wrapper[0])) = v60
			m.G0 = v9 + int32(32)
			return
		}
	}
...
func F_stream_message_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32, l4 int32, l5 int32, l6 int32) {
	...
	if v16 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _c_F_stream_message_cb_wrapper[0])) = v44
	} else {
	}
	m.G0 = v13 + int32(32)
	return
...
func F_stream_open_and_write_change(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_stream_open_and_write_change[0]))
	if v11 == int32(0) {
		...
		if v16 != 0 {
			...
			v18 = *(*int32)(unsafe.Add(mBase, _c_F_stream_open_and_write_change[0]))
			v19 = v18
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = v21 - v22 + int32(1)
			...
			if v31 != 0 {
				...
				v33 = *(*int32)(unsafe.Add(mBase, _c_F_stream_open_and_write_change[0]))
				...
				if v38 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = v41
					v44 = *(*int32)(unsafe.Add(mBase, _c_F_stream_open_and_write_change[0]))
					...
					if v48 != 0 {
						...
						v50 = *(*int32)(unsafe.Add(mBase, _c_F_stream_open_and_write_change[1]))
						...
						if v53 != 0 {
							...
							v55 = *(*int32)(unsafe.Add(mBase, _c_F_stream_open_and_write_change[0]))
							...
							if v57 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, _c_F_stream_open_and_write_change[0])) = int32(0)
								...
								if v62 != 0 {
									...
									v64 = *(*int32)(unsafe.Add(mBase, _c_F_stream_open_and_write_change[2]))
...
func F_stream_prepare_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	*(*int32)(unsafe.Add(mBase, _c_F_stream_prepare_cb_wrapper[0])) = v9 + int32(4)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v20
	*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = v9 + int32(16)
	v29 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v11)+147)) = uint8(v29)
	...
	if v37 == int32(0) {
		...
		if v43 != 0 {
			...
			if v46 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(_a_F_stream_prepare_cb_wrapper_2)
				F_errmsg(m, int32(_a_F_stream_prepare_cb_wrapper_3), v9)
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return
				} else {
					F_errfinish(m, int32(_a_F_stream_prepare_cb_wrapper_4), int32(1444), int32(_a_F_stream_prepare_cb_wrapper_5))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return
		...
		if v58 != 0 {
			...
			v60 = *(*int32)(unsafe.Add(mBase, uint32(v9)+4))
			*(*int32)(unsafe.Add(mBase, _c_F_stream_prepare_cb_wrapper[0])) = v60
			m.G0 = v9 + int32(32)
			return
		}
	}
