...
func F_stream_commit_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(99037)
	...
	if v37 == int32(0) {
		...
		if v43 != 0 {
			...
			if v46 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(494785)
				F_errmsg(m, int32(313536), v9)
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return
				} else {
					F_errfinish(m, int32(489070), int32(1485), int32(214707))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return
...
func F_stream_message_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32, l4 int32, l5 int32, l6 int32) {
	...
	if v16 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13)+20)) = int32(397438)
...
func F_stream_prepare_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int64) {
	...
	m.G0 = v9
	v11 = *(*int32)(unsafe.Add(mBase, uint32(l0)+112))
	*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = int32(359231)
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v11
	v15 = *(*int64)(unsafe.Add(mBase, uint32(l1)+24))
	*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = int32(992)
	*(*int64)(unsafe.Add(mBase, uint32(v9)+24)) = v15
	...
	if v37 == int32(0) {
		...
		if v43 != 0 {
			...
			if v46 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(494881)
				F_errmsg(m, int32(313636), v9)
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return
				} else {
					F_errfinish(m, int32(489070), int32(1444), int32(214780))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return
