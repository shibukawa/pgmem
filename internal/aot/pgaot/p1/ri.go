...
func F_RI_FKey_check_ins(m *base.Module, l0 int32) int32 {
	...
	var v10 int32
	_ = v10
	F_ri_CheckTrigger(m, l0, int32(140250), int32(1))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_RI_FKey_noaction_del(m *base.Module, l0 int32) int32 {
	...
	var v11 int32
	_ = v11
	F_ri_CheckTrigger(m, l0, int32(292888), int32(3))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_RI_FKey_setdefault_del(m *base.Module, l0 int32) int32 {
	...
	var v12 int32
	_ = v12
	F_ri_CheckTrigger(m, l0, int32(292844), int32(3))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
L9:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v13)+128)) = int64(3023656976388)
	v27 = F_hash_create(m, int32(380205), int32(64), v13+int32(112), int32(40))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L11
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1124])) = v27
...
L13:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v13)+128)) = int64(51539607560)
	v45 = F_hash_create(m, int32(380106), int32(256), v13+int32(112), int32(40))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L11
...
L14:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1125])) = v45
	*(*int64)(unsafe.Add(mBase, uint32(v13)+128)) = int64(292057776136)
	v56 = F_hash_create(m, int32(380519), int32(256), v13+int32(112), int32(40))
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		goto L11
...
L15:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1126])) = v56
	v60 = *(*int32)(unsafe.Add(mBase, _consts[1124]))
	v61 = v60
	goto L10
L16:
	;
...
L44:
	;
	v198 = v67 + int32(696)
	v200 = *(*int32)(unsafe.Add(mBase, _consts[1127]))
	if v200 != 0 {
		goto L46
	} else {
		goto L47
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1128])) = v198
	v217 = int32(4429552)
	v219 = *(*int32)(unsafe.Add(mBase, _consts[1129]))
	v220 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[1129])) = v219 + v220
	*(*uint8)(unsafe.Add(mBase, uint32(v67)+4)) = uint8(v220)
	goto L17
L46:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _consts[1128]))
	v210 = v202
	goto L45
L47:
	;
...
L48:
	;
	v204 = int32(4429544)
	*(*int32)(unsafe.Add(mBase, _consts[1127])) = v204
	*(*int32)(unsafe.Add(mBase, _consts[1129])) = int32(0)
	v210 = v204
	goto L45
L49:
	;
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+36)) = v245 + int32(4)
	F_errmsg_internal(m, int32(677304), v13+int32(32))
	mBase = m.M
	v255 = m.ExcPending
	if v255 != 0 {
		goto L11
...
L58:
	;
	F_errfinish(m, int32(470918), int32(2240), int32(229934))
	mBase = m.M
	v260 = m.ExcPending
	if v260 != 0 {
		goto L11
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v273
	F_errmsg_internal(m, int32(461864), v13+int32(16))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L11
...
L66:
	;
	F_errfinish(m, int32(470918), int32(2254), int32(229934))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L11
...
L69:
	;
	F_errmsg(m, int32(425777), int32(0))
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L11
...
L70:
	;
	F_errfinish(m, int32(470918), int32(2259), int32(229934))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L11
...
L74:
	;
	F_errhint(m, int32(615874), int32(0))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L11
...
L75:
	;
	F_errfinish(m, int32(470918), int32(2229), int32(229934))
	mBase = m.M
	v329 = m.ExcPending
	if v329 != 0 {
		goto L11
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+64)) = v334
	F_errmsg_internal(m, int32(38585), v13-int32(-64))
	mBase = m.M
	v340 = m.ExcPending
	if v340 != 0 {
		goto L11
...
L78:
	;
	F_errfinish(m, int32(470918), int32(2297), int32(229957))
	mBase = m.M
	v345 = m.ExcPending
	if v345 != 0 {
		goto L11
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+96)) = v350
	F_errmsg_internal(m, int32(84998), v13+int32(96))
	mBase = m.M
	v356 = m.ExcPending
	if v356 != 0 {
		goto L11
...
L81:
	;
	F_errfinish(m, int32(470918), int32(2302), int32(229957))
	mBase = m.M
	v361 = m.ExcPending
	if v361 != 0 {
		goto L11
...
L83:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+80)) = v93
	F_errmsg_internal(m, int32(38585), v13+int32(80))
	mBase = m.M
	v371 = m.ExcPending
	if v371 != 0 {
		goto L11
...
L84:
	;
	F_errfinish(m, int32(470918), int32(2375), int32(80009))
	mBase = m.M
	v376 = m.ExcPending
	if v376 != 0 {
		goto L11
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+52)) = v381 + int32(4)
	F_errmsg_internal(m, int32(677304), v13+int32(48))
	mBase = m.M
	v391 = m.ExcPending
	if v391 != 0 {
		goto L11
...
L87:
	;
	F_errfinish(m, int32(470918), int32(2247), int32(229934))
	mBase = m.M
	v396 = m.ExcPending
	if v396 != 0 {
		goto L11
