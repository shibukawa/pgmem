...
L115:
	;
	F_errmsg(m, int32(273189), int32(0))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L11
...
L116:
	;
	F_errfinish(m, int32(494073), int32(5239), int32(19548))
	mBase = m.M
	v363 = m.ExcPending
	if v363 != 0 {
		goto L11
...
L120:
	;
	F_errfinish(m, int32(494073), int32(5244), int32(19548))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L11
...
L124:
	;
	F_errfinish(m, int32(494073), int32(5253), int32(19548))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L11
					...
					if base.F64_lt(v16, float64(0)) != 0 {
						...
						if v24 != 0 {
							...
							if v27 != 0 {
								...
								F_errmsg(m, int32(347390), int32(0))
								mBase = m.M
								v31 = m.ExcPending
								if v31 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(494073), int32(4718), int32(36635))
									mBase = m.M
									v36 = m.ExcPending
									if v36 != 0 {
										return int32(0)
