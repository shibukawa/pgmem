				...
				if v30 != 0 {
					...
					if v32 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v29
						F_appendStringInfo(m, v8+int32(16), int32(176426), v8)
						mBase = m.M
						v39 = m.ExcPending
						if v39 != 0 {
							return int32(0)
...
L115:
	;
	F_errmsg(m, int32(271536), int32(0))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L11
...
L116:
	;
	F_errfinish(m, int32(490692), int32(5239), int32(19479))
	mBase = m.M
	v363 = m.ExcPending
	if v363 != 0 {
		goto L11
...
L119:
	;
	F_errmsg(m, int32(118721), int32(0))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L11
...
L120:
	;
	F_errfinish(m, int32(490692), int32(5244), int32(19479))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L11
...
L124:
	;
	F_errfinish(m, int32(490692), int32(5253), int32(19479))
	mBase = m.M
	v395 = m.ExcPending
	if v395 != 0 {
		goto L11
					...
					if base.F64_lt(v16, float64(0)) != 0 {
						...
						if v24 != 0 {
							...
							if v27 != 0 {
								...
								F_errmsg(m, int32(345041), int32(0))
								mBase = m.M
								v31 = m.ExcPending
								if v31 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(490692), int32(4718), int32(36489))
									mBase = m.M
									v36 = m.ExcPending
									if v36 != 0 {
										return int32(0)
