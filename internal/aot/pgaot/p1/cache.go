...
func F_CacheInvalidateHeapTuple(m *base.Module, l0 int32, l1 int32, l2 int32) {
	var v6 int32
	_ = v6
	F_CacheInvalidateHeapTupleCommon(m, l0, l1, l2, int32(1601))
	v6 = m.ExcPending
	if v6 != 0 {
		return
	} else {
...
L1:
	;
	v254 = *(*int32)(unsafe.Add(mBase, _c_F_PlanCacheObjectCallback[1]))
	if v254 == int32(0) {
		goto L65
	} else {
		goto L66
...
L2:
	;
	if v13 == int32(_a_F_PlanCacheObjectCallback_0) {
		goto L1
	} else {
		goto L3
	}
...
L6:
	...
	if v239 != int32(_a_F_PlanCacheObjectCallback_0) {
		v22 = v239
		goto L4
	} else {
		goto L64
...
L66:
	;
	if v254 == int32(_a_F_PlanCacheObjectCallback_1) {
		goto L65
	} else {
		goto L67
	}
...
L70:
	...
	if v324 != int32(_a_F_PlanCacheObjectCallback_1) {
		v262 = v324
		goto L68
	} else {
		goto L86
...
func F_PlanCacheSysCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	if v5 == int32(0) {
		...
		if v5 == int32(_a_F_PlanCacheSysCallback_0) {
		} else {
			v10 = v5
			for {
				v14 = v10 - int32(5)
				...
				if v67 != int32(_a_F_PlanCacheSysCallback_0) {
					v10 = v67
					continue
				} else {
					break
	...
	v74 = *(*int32)(unsafe.Add(mBase, _c_F_PlanCacheSysCallback[1]))
	if v74 == int32(0) {
	} else {
		if v74 == int32(_a_F_PlanCacheSysCallback_1) {
		} else {
			v79 = v74
			for {
				v84 = int32(0)
				*(*uint8)(unsafe.Add(mBase, uint32(v79-int32(16)))) = uint8(v84)
				...
				if v86 != int32(_a_F_PlanCacheSysCallback_1) {
					v79 = v86
					continue
				} else {
					break
...
L22:
	;
	v76 = int32(_a_F_cache_locale_time_3)
	goto L23
L23:
	;
...
L26:
	;
	v89 = int32(_a_F_cache_locale_time_4)
...
L29:
	;
	v97 = int32(_a_F_cache_locale_time_5)
...
L30:
	;
	v105 = int32(0)
	v107 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_cache_locale_time[3])))
	if v107 == v105 {
		goto L31
	} else {
		goto L32
...
L33:
	;
	v140 = int32(_a_F_cache_locale_time_6)
...
L34:
	;
	v121 = F___get_locale(m, v113, int32(_a_F_cache_locale_time_3))
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, uint32(v113<<(uint(int32(2))%32))+uint32(_c_F_cache_locale_time[4]))) = v121
	v124 = v113 + int32(1)
	if v124 != int32(6) {
		v113 = v124
		goto L34
...
L37:
	;
	v148 = int32(_a_F_cache_locale_time_7)
...
L40:
	;
	v191 = *(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[1]))
...
L42:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v20)+56)) = v194
	...
	mBase = m.M
	v202 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[2])) = v202
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = v202
	v210 = F___strftime_l(m, v20-int32(-64), int32(80), int32(_a_F_cache_locale_time_8), v200, v181)
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L5
...
L44:
	;
	v216 = F___strftime_l(m, v20+int32(144), int32(80), int32(_a_F_cache_locale_time_9), v200, v181)
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L5
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(1)
	v224 = F___strftime_l(m, v20+int32(224), int32(80), int32(_a_F_cache_locale_time_8), v200, v181)
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L5
...
L46:
	;
	v230 = F___strftime_l(m, v20+int32(304), int32(80), int32(_a_F_cache_locale_time_9), v200, v181)
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L5
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(2)
	v238 = F___strftime_l(m, v20+int32(384), int32(80), int32(_a_F_cache_locale_time_8), v200, v181)
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L5
...
L48:
	;
	v244 = F___strftime_l(m, v20+int32(464), int32(80), int32(_a_F_cache_locale_time_9), v200, v181)
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L5
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(3)
	v252 = F___strftime_l(m, v20+int32(544), int32(80), int32(_a_F_cache_locale_time_8), v200, v181)
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L5
...
L50:
	;
	v258 = F___strftime_l(m, v20+int32(624), int32(80), int32(_a_F_cache_locale_time_9), v200, v181)
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L5
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(4)
	v266 = F___strftime_l(m, v20+int32(704), int32(80), int32(_a_F_cache_locale_time_8), v200, v181)
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L5
...
L52:
	;
	v272 = F___strftime_l(m, v20+int32(784), int32(80), int32(_a_F_cache_locale_time_9), v200, v181)
	mBase = m.M
	v273 = m.ExcPending
	if v273 != 0 {
		goto L5
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(5)
	v280 = F___strftime_l(m, v20+int32(864), int32(80), int32(_a_F_cache_locale_time_8), v200, v181)
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L5
...
L54:
	;
	v286 = F___strftime_l(m, v20+int32(944), int32(80), int32(_a_F_cache_locale_time_9), v200, v181)
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L5
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(6)
	v294 = F___strftime_l(m, v20+int32(1024), int32(80), int32(_a_F_cache_locale_time_8), v200, v181)
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L5
...
L56:
	;
	v296 = int32(0)
	v324 = F___strftime_l(m, v20+int32(1104), int32(80), int32(_a_F_cache_locale_time_9), v200, v181)
	mBase = m.M
	v325 = m.ExcPending
	if v325 != 0 {
		goto L5
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+16)) = v348
	v367 = F___strftime_l(m, v351, int32(80), int32(_a_F_cache_locale_time_10), v200, v181)
	mBase = m.M
	v368 = m.ExcPending
	if v368 != 0 {
		goto L5
...
L60:
	;
	v369 = int32(80)
	v373 = F___strftime_l(m, v351+v369, v369, int32(_a_F_cache_locale_time_11), v200, v181)
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L5
...
L67:
	;
	v392 = *(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[1]))
...
L73:
	;
	v463 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[6])) = v463
	*(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[7])) = v463
	v469 = v457
	v473 = v463
	goto L95
L74:
	...
	v427 = *(*int32)(unsafe.Add(mBase, uint32(v424)+uint32(_c_F_cache_locale_time[8])))
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v424)+uint32(_c_F_cache_locale_time[8]))) = v430
	if v427 != 0 {
		goto L76
	} else {
		goto L77
...
L84:
	;
	v445 = *(*int32)(unsafe.Add(mBase, uint32(v424)+uint32(_c_F_cache_locale_time[10])))
	v447 = *(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[9]))
...
L85:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v424)+uint32(_c_F_cache_locale_time[10]))) = v448
	if v445 != 0 {
		goto L86
	} else {
		goto L87
...
L96:
	;
	v529 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_cache_locale_time[0])) = uint8(v529)
	v532 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[11])) = v532
	*(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[12])) = v532
	goto L4
L97:
	;
	v490 = v473 << (uint(int32(2)) % 32)
	v493 = *(*int32)(unsafe.Add(mBase, uint32(v490)+uint32(_c_F_cache_locale_time[13])))
	v495 = *(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[9]))
...
L98:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v490)+uint32(_c_F_cache_locale_time[13]))) = v496
	if v493 != 0 {
		goto L99
	} else {
		goto L100
...
L107:
	;
	v511 = *(*int32)(unsafe.Add(mBase, uint32(v490)+uint32(_c_F_cache_locale_time[14])))
	v513 = *(*int32)(unsafe.Add(mBase, _c_F_cache_locale_time[9]))
...
L108:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v490)+uint32(_c_F_cache_locale_time[14]))) = v514
	if v511 != 0 {
		goto L109
	} else {
		goto L110
...
L46:
	;
	F_errmsg_internal(m, int32(_a_F_cache_reduce_memory_0), int32(0))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L13
...
L47:
	;
	F_errfinish(m, int32(_a_F_cache_reduce_memory_1), int32(484), int32(_a_F_cache_reduce_memory_2))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L13
