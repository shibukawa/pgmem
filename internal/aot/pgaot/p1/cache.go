...
func F_PlanCacheObjectCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v324 int32
	_ = v324
	v13 = *(*int32)(unsafe.Add(mBase, _consts[1166]))
	if v13 == int32(0) {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v254 = *(*int32)(unsafe.Add(mBase, _consts[1167]))
	if v254 == int32(0) {
		goto L65
	} else {
		goto L66
...
func F_PlanCacheSysCallback(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v86 int32
	_ = v86
	v5 = *(*int32)(unsafe.Add(mBase, _consts[1166]))
	if v5 == int32(0) {
	} else {
		if v5 == int32(4164864) {
		} else {
	...
	v74 = *(*int32)(unsafe.Add(mBase, _consts[1167]))
	if v74 == int32(0) {
	} else {
		if v74 == int32(4164872) {
		} else {
			v79 = v74
			for {
				v84 = int32(0)
...
func F_cache_locale_time(m *base.Module) {
	...
	v20 = v18 - int32(3104)
	m.G0 = v20
	v23 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1106])))
	if v23 == v1 {
		goto L2
	} else {
		goto L3
...
L7:
	;
	v31 = *(*int32)(unsafe.Add(mBase, _consts[1107]))
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v31
	F_errmsg_internal(m, int32(763297), v20)
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L5
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, _consts[137])) = int32(44)
	v46 = *(*int32)(unsafe.Add(mBase, _consts[1107]))
	v47 = int32(0)
	v51 = m.G0
	v53 = v51 - int32(32)
	m.G0 = v53
...
L10:
	;
	F_errfinish(m, int32(524999), int32(744), int32(394760))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L5
...
L30:
	;
	v105 = int32(0)
	v107 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1108])))
	if v107 == v105 {
		goto L31
	} else {
		goto L32
...
L34:
	;
	v121 = F___get_locale(m, v113, int32(793540))
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, uint32(v113<<(uint(int32(2))%32))+uint32(_consts[1109]))) = v121
	v124 = v113 + int32(1)
	if v124 != int32(6) {
		v113 = v124
		goto L34
...
L35:
	;
	v128 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1108])) = uint8(v128)
	v132 = *(*int32)(unsafe.Add(mBase, _consts[1109]))
	*(*int32)(unsafe.Add(mBase, _consts[1110])) = v132
	goto L33
L36:
	;
	goto L35
...
L40:
	;
	v191 = *(*int32)(unsafe.Add(mBase, _consts[1107]))
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = v202
	v210 = F___strftime_l(m, v20-int32(-64), int32(80), int32(534345), v200, v181)
	mBase = m.M
	v211 = m.ExcPending
	if v211 != 0 {
		goto L5
...
L44:
	;
	v216 = F___strftime_l(m, v20+int32(144), int32(80), int32(573046), v200, v181)
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L5
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(1)
	v224 = F___strftime_l(m, v20+int32(224), int32(80), int32(534345), v200, v181)
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L5
...
L46:
	;
	v230 = F___strftime_l(m, v20+int32(304), int32(80), int32(573046), v200, v181)
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L5
...
L47:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(2)
	v238 = F___strftime_l(m, v20+int32(384), int32(80), int32(534345), v200, v181)
	mBase = m.M
	v239 = m.ExcPending
	if v239 != 0 {
		goto L5
...
L48:
	;
	v244 = F___strftime_l(m, v20+int32(464), int32(80), int32(573046), v200, v181)
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L5
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(3)
	v252 = F___strftime_l(m, v20+int32(544), int32(80), int32(534345), v200, v181)
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L5
...
L50:
	;
	v258 = F___strftime_l(m, v20+int32(624), int32(80), int32(573046), v200, v181)
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L5
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(4)
	v266 = F___strftime_l(m, v20+int32(704), int32(80), int32(534345), v200, v181)
	mBase = m.M
	v267 = m.ExcPending
	if v267 != 0 {
		goto L5
...
L52:
	;
	v272 = F___strftime_l(m, v20+int32(784), int32(80), int32(573046), v200, v181)
	mBase = m.M
	v273 = m.ExcPending
	if v273 != 0 {
		goto L5
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(5)
	v280 = F___strftime_l(m, v20+int32(864), int32(80), int32(534345), v200, v181)
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L5
...
L54:
	;
	v286 = F___strftime_l(m, v20+int32(944), int32(80), int32(573046), v200, v181)
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L5
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+24)) = int32(6)
	v294 = F___strftime_l(m, v20+int32(1024), int32(80), int32(534345), v200, v181)
	mBase = m.M
	v295 = m.ExcPending
	if v295 != 0 {
		goto L5
...
L56:
	;
	v296 = int32(0)
	v324 = F___strftime_l(m, v20+int32(1104), int32(80), int32(573046), v200, v181)
	mBase = m.M
	v325 = m.ExcPending
	if v325 != 0 {
		goto L5
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v200)+16)) = v348
	v367 = F___strftime_l(m, v351, int32(80), int32(530505), v200, v181)
	mBase = m.M
	v368 = m.ExcPending
	if v368 != 0 {
		goto L5
...
L60:
	;
	v369 = int32(80)
	v373 = F___strftime_l(m, v351+v369, v369, int32(572594), v200, v181)
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L5
...
L67:
	;
	v392 = *(*int32)(unsafe.Add(mBase, _consts[1107]))
...
L73:
	;
	v463 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1111])) = v463
	*(*int32)(unsafe.Add(mBase, _consts[1112])) = v463
	v469 = v457
	v473 = v463
	goto L95
L74:
	...
	v427 = *(*int32)(unsafe.Add(mBase, uint32(v424)+uint32(_consts[1113])))
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v424)+uint32(_consts[1113]))) = v430
	if v427 != 0 {
		goto L76
	} else {
		goto L77
...
L84:
	;
	v445 = *(*int32)(unsafe.Add(mBase, uint32(v424)+uint32(_consts[1114])))
...
L85:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v424)+uint32(_consts[1114]))) = v448
	if v445 != 0 {
		goto L86
	} else {
		goto L87
...
L96:
	;
	v529 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1106])) = uint8(v529)
	v532 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1115])) = v532
	*(*int32)(unsafe.Add(mBase, _consts[1116])) = v532
	goto L4
L97:
	;
	v490 = v473 << (uint(int32(2)) % 32)
	v493 = *(*int32)(unsafe.Add(mBase, uint32(v490)+uint32(_consts[1117])))
...
L98:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v490)+uint32(_consts[1117]))) = v496
	if v493 != 0 {
		goto L99
	} else {
		goto L100
...
L107:
	;
	v511 = *(*int32)(unsafe.Add(mBase, uint32(v490)+uint32(_consts[1118])))
...
L108:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v490)+uint32(_consts[1118]))) = v514
	if v511 != 0 {
		goto L109
	} else {
		goto L110
...
L118:
	;
	F_errmsg_internal(m, int32(476998), int32(0))
	mBase = m.M
	v564 = m.ExcPending
	if v564 != 0 {
		goto L5
...
L119:
	;
	F_errfinish(m, int32(524999), int32(810), int32(394760))
	mBase = m.M
	v569 = m.ExcPending
	if v569 != 0 {
		goto L5
...
L46:
	;
	F_errmsg_internal(m, int32(12667), int32(0))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L13
...
L47:
	;
	F_errfinish(m, int32(524237), int32(484), int32(13887))
	mBase = m.M
	v285 = m.ExcPending
	if v285 != 0 {
		goto L13
