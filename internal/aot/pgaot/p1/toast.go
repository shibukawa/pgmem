...
L17:
	;
	v65 = F_systable_beginscan_ordered(m, v20, v40, int32(4216600), int32(1), v7+int32(-52))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L5
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v103
	F_errmsg_internal(m, int32(60363), v12)
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L1
...
L24:
	;
	F_errfinish(m, int32(519602), int32(609), int32(167780))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L1
