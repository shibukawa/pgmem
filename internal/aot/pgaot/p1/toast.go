...
L12:
	...
	v48 = *(*int32)(unsafe.Add(mBase, _c_F_toast_delete_datum[2]))
	if v48 == int32(0) {
		goto L13
	} else {
		goto L14
...
L17:
	;
	v65 = F_systable_beginscan_ordered(m, v20, v40, int32(_a_F_toast_delete_datum_0), int32(1), v7+int32(-52))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L5
...
func F_toast_flatten_tuple(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v159
	v11 = m.G0
	v13 = v11 - int32(_a_F_toast_flatten_tuple_0)
	m.G0 = v13
...
L10:
	...
	if v51 != int32(_a_F_toast_flatten_tuple_1) {
		goto L9
	} else {
		goto L11
	}
...
L15:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v108)+20)) = uint16(v111)
	...
	v119 = v114 | v116&int32(_a_F_toast_flatten_tuple_2)
	*(*uint16)(unsafe.Add(mBase, uint32(v113)+20)) = uint16(v119)
	...
	v124 = v122 & int32(_a_F_toast_flatten_tuple_3)
	*(*uint16)(unsafe.Add(mBase, uint32(v121)+18)) = uint16(v124)
	...
	v132 = v127 | v129&int32(_a_F_toast_flatten_tuple_4)
...
L18:
	;
	m.G0 = v26 + int32(_a_F_toast_flatten_tuple_0)
	return v88
L19:
	;
...
func F_toast_flatten_tuple_to_datum(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v4 = int32(0)
	v13 = m.G0
	v15 = v13 - int32(_a_F_toast_flatten_tuple_to_datum_0)
	m.G0 = v15
	v17 = *(*int32)(unsafe.Add(mBase, uint32(l2)))
	*(*int32)(unsafe.Add(mBase, uint32(v15)+uint32(_c_F_toast_flatten_tuple_to_datum[0]))) = l0
	*(*int32)(unsafe.Add(mBase, uint32(v15)+uint32(_c_F_toast_flatten_tuple_to_datum[1]))) = v4
	*(*uint16)(unsafe.Add(mBase, uint32(v15)+uint32(_c_F_toast_flatten_tuple_to_datum[2]))) = uint16(v4)
	*(*int32)(unsafe.Add(mBase, uint32(v15)+uint32(_c_F_toast_flatten_tuple_to_datum[3]))) = int32(-1)
	*(*int32)(unsafe.Add(mBase, uint32(v15)+uint32(_c_F_toast_flatten_tuple_to_datum[4]))) = l1
	F_heap_deform_tuple(m, v15+int32(_a_F_toast_flatten_tuple_to_datum_1), l2, v15+int32(3328), v15+int32(1664))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L9:
	...
	if v66 != int32(_a_F_toast_flatten_tuple_to_datum_2) {
		goto L12
	} else {
		goto L13
	}
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v145))) = v144 << (uint(int32(2)) % 32)
	...
	v162 = v159&int32(_a_F_toast_flatten_tuple_to_datum_3) | v17
...
L26:
	;
	m.G0 = v38 + int32(_a_F_toast_flatten_tuple_to_datum_0)
	return v145
L27:
	;
