...
L63:
	;
	v380 = F__emscripten_memcpy_bulkmem(m, v35+int32(8), int32(4038100), int32(4096))
	mBase = m.M
	goto L65
L65:
	;
...
L112:
	;
	F_errfinish(m, int32(490229), int32(639), int32(241613))
	mBase = m.M
	v5362 = m.ExcPending
	if v5362 != 0 {
		goto L77
...
L116:
	;
	F_errfinish(m, int32(490229), int32(630), int32(241613))
	mBase = m.M
	v5385 = m.ExcPending
	if v5385 != 0 {
		goto L77
...
L120:
	;
	F_errfinish(m, int32(490229), int32(617), int32(241613))
	mBase = m.M
	v5405 = m.ExcPending
	if v5405 != 0 {
		goto L77
