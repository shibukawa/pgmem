...
L46:
	;
	v324 = F__emscripten_memcpy_bulkmem(m, v35+int32(8), int32(4098452), int32(4096))
	mBase = m.M
	goto L48
L48:
	;
...
L95:
	;
	F_errfinish(m, int32(517957), int32(639), int32(255438))
	mBase = m.M
	v5306 = m.ExcPending
	if v5306 != 0 {
		goto L60
...
L99:
	;
	F_errfinish(m, int32(517957), int32(630), int32(255438))
	mBase = m.M
	v5329 = m.ExcPending
	if v5329 != 0 {
		goto L60
...
L103:
	;
	F_errfinish(m, int32(517957), int32(617), int32(255438))
	mBase = m.M
	v5349 = m.ExcPending
	if v5349 != 0 {
		goto L60
