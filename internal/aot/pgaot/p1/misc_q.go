...
L21:
	;
	v159 = *(*int32)(unsafe.Add(mBase, _consts[151]))
	if v159 != 0 {
		goto L44
	} else {
		goto L45
...
L46:
	;
	v163 = *(*int32)(unsafe.Add(mBase, _consts[190]))
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v165)+4)) = v173
	v176 = int32(4367356)
	v177 = *(*int32)(unsafe.Add(mBase, _consts[151]))
	*(*int32)(unsafe.Add(mBase, uint32(v165)+8)) = v177
	*(*int32)(unsafe.Add(mBase, _consts[151])) = v165
	goto L42
L50:
	;
	v185 = *(*int32)(unsafe.Add(mBase, _consts[151]))
...
func F_quickdie(m *base.Module, l0 int32) {
	...
	_ = v121
	v24 = int32(4377752)
	v25 = *(*int32)(unsafe.Add(mBase, _consts[841]))
	*(*int32)(unsafe.Add(mBase, _consts[841])) = v25 | int32(4)
			...
			if v71 != 0 {
				...
				if v70 == int32(0) {
					...
					if v76 != 0 {
						...
						F_errmsg(m, int32(308270), int32(0))
						mBase = m.M
						v80 = m.ExcPending
						if v80 != 0 {
							return
							...
							v118 = int32(3089)
							F_errfinish(m, int32(485250), v118, int32(391908))
							mBase = m.M
							v121 = m.ExcPending
							if v121 != 0 {
								return
			...
			if v85 != 0 {
				...
				if v84 == int32(0) {
					...
					if v90 != 0 {
						...
						F_errmsg(m, int32(126482), int32(0))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return
						} else {
							F_errdetail(m, int32(547179), int32(0))
							mBase = m.M
							v98 = m.ExcPending
							if v98 != 0 {
								return
			...
			if v107 != 0 {
				...
				if v106 == int32(0) {
					...
					if v112 != 0 {
						...
						F_errmsg(m, int32(421109), int32(0))
						mBase = m.M
						v116 = m.ExcPending
						if v116 != 0 {
							return
		...
		if l0 != 0 {
			...
			if v15 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v14
				F_appendStringInfo(m, v6+int32(16), int32(581182), v6)
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
