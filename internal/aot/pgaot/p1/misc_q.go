...
L4:
	;
	v103 = *(*int32)(unsafe.Add(mBase, _c_F_queue_listen[3]))
	if v103 != 0 {
		goto L27
	} else {
		goto L28
...
L29:
	;
	v107 = *(*int32)(unsafe.Add(mBase, _c_F_queue_listen[4]))
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v109)+4)) = v117
	v120 = int32(_a_F_queue_listen_1)
	v121 = *(*int32)(unsafe.Add(mBase, _c_F_queue_listen[3]))
	*(*int32)(unsafe.Add(mBase, uint32(v109)+8)) = v121
	*(*int32)(unsafe.Add(mBase, _c_F_queue_listen[3])) = v109
	goto L25
L33:
	;
	v129 = *(*int32)(unsafe.Add(mBase, _c_F_queue_listen[3]))
