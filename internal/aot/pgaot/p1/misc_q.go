...
func F_quickdie(m *base.Module, l0 int32) {
	...
	_ = v121
	v24 = int32(4469416)
	v25 = *(*int32)(unsafe.Add(mBase, _consts[847]))
	*(*int32)(unsafe.Add(mBase, _consts[847])) = v25 | int32(4)
	...
	if v34 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, _consts[337])) = v53
		...
		if v58 != int32(1) {
			...
			v62 = *(*int32)(unsafe.Add(mBase, _consts[569]))
			if v62 == int32(0) {
				v66 = v53
			} else {
			...
			if v71 != 0 {
				...
				if v70 == int32(0) {
					...
					if v76 != 0 {
						...
						F_errmsg(m, int32(329842), int32(0))
						mBase = m.M
						v80 = m.ExcPending
						if v80 != 0 {
							return
							...
							v118 = int32(3089)
							F_errfinish(m, int32(519676), v118, int32(419105))
							mBase = m.M
							v121 = m.ExcPending
							if v121 != 0 {
								return
			...
			if v85 != 0 {
				...
				if v84 == int32(0) {
					...
					if v90 != 0 {
						...
						F_errmsg(m, int32(137661), int32(0))
						mBase = m.M
						v94 = m.ExcPending
						if v94 != 0 {
							return
						} else {
							F_errdetail(m, int32(601435), int32(0))
							mBase = m.M
							v98 = m.ExcPending
							if v98 != 0 {
								return
		...
		if l0 != 0 {
			...
			if v15 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v14
				F_appendStringInfo(m, v6+int32(16), int32(637113), v6)
				mBase = m.M
				v21 = m.ExcPending
				if v21 != 0 {
					return int32(0)
