...
L18:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v24)+43)) = uint8(v54)
	*(*int32)(unsafe.Add(mBase, uint32(v24)+44)) = v51
	F_errmsg_internal(m, int32(232134), int32(0))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		v418 = v51
...
L21:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v24)+43)) = uint8(v54)
	*(*int32)(unsafe.Add(mBase, uint32(v24)+44)) = v51
	F_errfinish(m, int32(469661), int32(708), int32(232134))
	mBase = m.M
	v118 = m.ExcPending
	if v118 != 0 {
		v418 = v51
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24))) = v284
	F_errmsg_internal(m, int32(458423), v24)
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		v418 = v178
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+44)) = v169
	*(*uint8)(unsafe.Add(mBase, uint32(v24)+43)) = uint8(v278)
	F_errfinish(m, int32(469661), int32(800), int32(232134))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		v418 = v178
