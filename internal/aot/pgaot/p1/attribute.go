...
L9:
	...
	v40 = F_strcmp(m, int32(_a_F_CheckAttributeNamesTypes_0), v38)
	mBase = m.M
	if v40 == int32(0) {
		goto L12
	} else {
...
L12:
	;
	v69 = int32(_a_F_CheckAttributeNamesTypes_1)
	goto L11
L13:
	;
	goto L14
L14:
	;
	v45 = F_strcmp(m, int32(_a_F_CheckAttributeNamesTypes_2), v38)
	mBase = m.M
	if v45 == int32(0) {
		goto L15
	} else {
...
L15:
	;
	v69 = int32(_a_F_CheckAttributeNamesTypes_3)
	goto L11
L16:
	;
	goto L17
L17:
	;
	v50 = F_strcmp(m, int32(_a_F_CheckAttributeNamesTypes_4), v38)
	mBase = m.M
	if v50 == int32(0) {
		goto L18
	} else {
...
L18:
	;
	v69 = int32(_a_F_CheckAttributeNamesTypes_5)
	goto L11
L19:
	;
	goto L20
L20:
	;
	v55 = F_strcmp(m, int32(_a_F_CheckAttributeNamesTypes_6), v38)
	mBase = m.M
	if v55 == int32(0) {
		goto L21
	} else {
...
L21:
	;
	v69 = int32(_a_F_CheckAttributeNamesTypes_7)
	goto L11
L22:
	;
	goto L23
L23:
	;
	v60 = F_strcmp(m, int32(_a_F_CheckAttributeNamesTypes_8), v38)
	mBase = m.M
	if v60 == int32(0) {
		goto L24
	} else {
...
L24:
	;
	v69 = int32(_a_F_CheckAttributeNamesTypes_9)
	goto L11
L25:
	;
	goto L26
L26:
	;
	v67 = F_strcmp(m, int32(_a_F_CheckAttributeNamesTypes_10), v38)
	mBase = m.M
	if v67 != 0 {
		goto L27
	} else {
...
L28:
	;
	v68 = int32(_a_F_CheckAttributeNamesTypes_11)
	goto L29
L29:
	;
	v69 = v68
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v38
	F_errmsg(m, int32(_a_F_CheckAttributeNamesTypes_12), v12+int32(32))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L34
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = int32(1600)
	F_errmsg(m, int32(_a_F_CheckAttributeNamesTypes_15), v12)
	mBase = m.M
	v241 = m.ExcPending
	if v241 != 0 {
		goto L34
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = l0 + v254<<(uint(int32(4))%32) + v133 + int32(24)
	F_errmsg(m, int32(_a_F_CheckAttributeNamesTypes_16), v12+int32(16))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L34
