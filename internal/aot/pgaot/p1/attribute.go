...
L9:
	...
	v40 = F_strcmp(m, int32(739628), v38)
	mBase = m.M
	if v40 == int32(0) {
		goto L12
	} else {
...
L14:
	;
	v45 = F_strcmp(m, int32(739728), v38)
	mBase = m.M
	if v45 == int32(0) {
		goto L15
	} else {
...
L17:
	;
	v50 = F_strcmp(m, int32(739828), v38)
	mBase = m.M
	if v50 == int32(0) {
		goto L18
	} else {
...
L20:
	;
	v55 = F_strcmp(m, int32(739928), v38)
	mBase = m.M
	if v55 == int32(0) {
		goto L21
	} else {
...
L23:
	;
	v60 = F_strcmp(m, int32(740028), v38)
	mBase = m.M
	if v60 == int32(0) {
		goto L24
	} else {
...
L26:
	;
	v67 = F_strcmp(m, int32(740128), v38)
	mBase = m.M
	if v67 != 0 {
		goto L27
	} else {
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v38
	F_errmsg(m, int32(374932), v12+int32(32))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L34
...
L37:
	;
	F_errfinish(m, int32(487561), int32(482), int32(159947))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L34
...
L68:
	;
	F_errfinish(m, int32(487561), int32(464), int32(159947))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L34
...
L71:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = l0 + v254<<(uint(int32(4))%32) + v133 + int32(24)
	F_errmsg(m, int32(408753), v12+int32(16))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L34
...
L72:
	;
	F_errfinish(m, int32(487561), int32(498), int32(159947))
	mBase = m.M
	v271 = m.ExcPending
	if v271 != 0 {
		goto L34
