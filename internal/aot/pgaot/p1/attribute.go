...
L9:
	...
	v40 = F_strcmp(m, int32(746732), v38)
	mBase = m.M
	if v40 == int32(0) {
		goto L12
	} else {
...
L14:
	;
	v45 = F_strcmp(m, int32(746832), v38)
	mBase = m.M
	if v45 == int32(0) {
		goto L15
	} else {
...
L17:
	;
	v50 = F_strcmp(m, int32(746932), v38)
	mBase = m.M
	if v50 == int32(0) {
		goto L18
	} else {
...
L20:
	;
	v55 = F_strcmp(m, int32(747032), v38)
	mBase = m.M
	if v55 == int32(0) {
		goto L21
	} else {
...
L23:
	;
	v60 = F_strcmp(m, int32(747132), v38)
	mBase = m.M
	if v60 == int32(0) {
		goto L24
	} else {
...
L26:
	;
	v67 = F_strcmp(m, int32(747232), v38)
	mBase = m.M
	if v67 != 0 {
		goto L27
	} else {
...
L37:
	;
	F_errfinish(m, int32(492925), int32(482), int32(161784))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L34
...
L68:
	;
	F_errfinish(m, int32(492925), int32(464), int32(161784))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L34
...
L72:
	;
	F_errfinish(m, int32(492925), int32(498), int32(161784))
	mBase = m.M
	v271 = m.ExcPending
	if v271 != 0 {
		goto L34
