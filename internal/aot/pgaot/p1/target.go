...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v127
	F_appendStringInfo(m, v15+int32(16), int32(198087), v15)
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L1
...
L68:
	;
	F_appendContextKeyword(m, l1, int32(757756), int32(-8), int32(8), int32(4))
	mBase = m.M
	v228 = m.ExcPending
	if v228 != 0 {
		goto L1
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v274
	F_errmsg_internal(m, int32(475505), v13)
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L47
...
L81:
	;
	F_errfinish(m, int32(493756), int32(372), int32(277022))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L47
...
L83:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v290
	F_errmsg_internal(m, int32(475544), v13+int32(16))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L47
...
L84:
	;
	F_errfinish(m, int32(493756), int32(418), int32(277022))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L47
			...
			if v48 != 0 {
				...
				if v51 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v52
					F_errmsg(m, int32(95680), v10)
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(499102), int32(192), int32(397436))
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return int32(0)
