...
L3:
	;
	v356 = *(*int32)(unsafe.Add(mBase, uint32(v15)+16))
	F_pfree(m, v356)
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v127
	F_appendStringInfo(m, v15+int32(16), int32(188324), v15)
	mBase = m.M
	v134 = m.ExcPending
	if v134 != 0 {
		goto L1
...
L42:
	;
	v323 = *(*int32)(unsafe.Add(mBase, uint32(v15)+16))
	v324 = *(*int32)(unsafe.Add(mBase, uint32(v15)+20))
	F_appendBinaryStringInfo(m, v17, v323, v324)
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L1
...
L45:
	;
	v297 = *(*int32)(unsafe.Add(mBase, uint32(v15)+16))
	v301 = int32(10)
	v302 = F___strchrnul(m, v297+v289+int32(1), v301)
	mBase = m.M
...
L68:
	;
	if v39|base.B2i32(base.Ui32(v143) < base.Ui32(v273+v146)) == int32(0) {
		v289 = v187
		goto L45
	} else {
		goto L85
...
L85:
	;
	F_appendContextKeyword(m, l1, int32(717063), int32(-8), int32(8), int32(4))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L1
...
L80:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v274
	F_errmsg_internal(m, int32(454441), v13)
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L47
...
L81:
	;
	F_errfinish(m, int32(471920), int32(372), int32(264228))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L47
...
L83:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v290
	F_errmsg_internal(m, int32(454480), v13+int32(16))
	mBase = m.M
	v297 = m.ExcPending
	if v297 != 0 {
		goto L47
...
L84:
	;
	F_errfinish(m, int32(471920), int32(418), int32(264228))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L47
			...
			if v48 != 0 {
				...
				if v51 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v52
					F_errmsg(m, int32(90044), v10)
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(476958), int32(192), int32(379406))
						mBase = m.M
						v61 = m.ExcPending
						if v61 != 0 {
							return int32(0)
