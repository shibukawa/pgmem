...
L44:
	;
	v514 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_activity_0))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
L53:
	;
	v165 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_activity_1))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L1
...
L54:
	;
	v161 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_activity_2))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
...
L55:
	;
	v157 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_activity_3))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
...
L56:
	;
	v153 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_activity_4))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L1
...
L57:
	;
	v149 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_activity_5))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L1
...
L58:
	;
	v145 = F_cstring_to_text(m, int32(_a_F_pg_stat_get_activity_6))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L1
...
L80:
	;
	v197 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_activity[1]))
	v199 = v190
	goto L82
L81:
	;
...
L92:
	;
	v246 = int32(_a_F_pg_stat_get_activity_8)
	goto L88
L93:
	;
	goto L94
L94:
	;
	v244 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(v234)>>(uint(int32(22))%32))&int32(1020))+uint32(_c_F_pg_stat_get_activity[2])))
	v246 = v244
	goto L88
L95:
	;
...
L102:
	...
	v260 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_activity[3]))
	v264 = F_LWLockAcquire(m, v260+int32(_a_F_pg_stat_get_activity_9), int32(1))
	mBase = m.M
	v265 = m.ExcPending
	if v265 != 0 {
		goto L1
...
L103:
	;
	v266 = int32(-1)
	v268 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_activity[4]))
	if v268 <= int32(0) {
		v322 = v266
		goto L104
	} else {
...
L104:
	;
	v339 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_activity[3]))
	F_LWLockRelease(m, v339+int32(_a_F_pg_stat_get_activity_9))
	mBase = m.M
	v343 = m.ExcPending
	if v343 != 0 {
		goto L1
...
L105:
	;
	v272 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_activity[5]))
	v279 = int32(0)
	goto L106
L106:
	;
...
L173:
	;
	v730 = F_DirectFunctionCall1Coll(m, int32(1485), int32(0), v25+int32(32))
	mBase = m.M
	v731 = m.ExcPending
	if v731 != 0 {
		goto L1
...
L200:
	...
	v869 = int32(0)
	v871 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_activity[3]))
	v875 = F_LWLockAcquire(m, v871+int32(_a_F_pg_stat_get_activity_10), int32(1))
	mBase = m.M
	v876 = m.ExcPending
	if v876 != 0 {
		goto L1
...
L203:
	;
	v878 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_activity[6]))
...
L204:
	;
	v1018 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_activity[3]))
	F_LWLockRelease(m, v1018+int32(_a_F_pg_stat_get_activity_10))
	mBase = m.M
	v1022 = m.ExcPending
	if v1022 != 0 {
		goto L1
...
L210:
	;
	v913 = int32(_a_F_pg_stat_get_activity_11)
	v916 = v908 + int32(112)
...
L239:
	;
	v1036 = *(*int32)(unsafe.Add(mBase, uint32(v865<<(uint(int32(2))%32))+uint32(_c_F_pg_stat_get_activity[7])))
	v1037 = v1036
	goto L241
L240:
	;
	v1037 = int32(_a_F_pg_stat_get_activity_12)
	goto L241
L241:
	;
	goto L238
	...
	if v8 != 0 {
		...
		if v5 == int32(0) {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v11)
			...
			v16 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_backend_activity_start[0]))
			...
			if v19 != 0 {
				...
				if v18 != 0 {
					...
					v21 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_backend_activity_start[0]))
	...
	if v8 != 0 {
		...
		if v5 == int32(0) {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(l0)+16)) = uint8(v11)
			...
			v16 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_backend_start[0]))
			v18 = F_has_privs_of_role(m, v16, int32(3375))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				...
				if v18 != 0 {
					...
					v21 = *(*int32)(unsafe.Add(mBase, _c_F_pg_stat_get_backend_start[0]))
					v22 = *(*int32)(unsafe.Add(mBase, uint32(v5)+52))
					v23 = F_has_privs_of_role(m, v21, v22)
					mBase = m.M
					v24 = m.ExcPending
