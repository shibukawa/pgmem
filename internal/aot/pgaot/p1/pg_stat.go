...
func F_pg_stat_force_next_flush(m *base.Module, l0 int32) int32 {
	...
	_ = v3
	v3 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[915])) = uint8(v3)
	return int32(0)
}
...
L44:
	;
	v514 = F_cstring_to_text(m, int32(521957))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
L53:
	;
	v165 = F_cstring_to_text(m, int32(433874))
	mBase = m.M
	v166 = m.ExcPending
	if v166 != 0 {
		goto L1
...
L54:
	;
	v161 = F_cstring_to_text(m, int32(636393))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
...
L55:
	;
	v157 = F_cstring_to_text(m, int32(289852))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
...
L56:
	;
	v153 = F_cstring_to_text(m, int32(244427))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L1
...
L57:
	;
	v149 = F_cstring_to_text(m, int32(326086))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L1
...
L58:
	;
	v145 = F_cstring_to_text(m, int32(371505))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L1
...
L59:
	;
	v141 = F_cstring_to_text(m, int32(312419))
	mBase = m.M
	v142 = m.ExcPending
	if v142 != 0 {
		goto L1
...
L94:
	;
	v244 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(v234)>>(uint(int32(22))%32))&int32(1020))+uint32(_consts[1119])))
	v246 = v244
	goto L88
L95:
	;
