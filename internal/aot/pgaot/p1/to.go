...
L11:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v71))) = int64(21474836484)
	v85 = *(*int64)(unsafe.Add(mBase, _consts[358]))
	*(*int64)(unsafe.Add(mBase, uint32(v74)+8)) = v85
	v88 = *(*int64)(unsafe.Add(mBase, _consts[359]))
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+96)) = v127 + int32(4)
	F_errmsg(m, int32(697030), v33+int32(96))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		v2644 = v80
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errhint(m, int32(580688), int32(0))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		v2644 = v80
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(654), int32(242692))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		v2644 = v80
...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+112)) = v213 + int32(4)
	F_errmsg(m, int32(697417), v33+int32(112))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		v2644 = v80
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(662), int32(242692))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		v2644 = v80
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+128)) = v298 + int32(4)
	F_errmsg(m, int32(719183), v33+int32(128))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		v2644 = v80
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(669), int32(242692))
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		v2644 = v80
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+144)) = v383 + int32(4)
	F_errmsg(m, int32(721572), v33+int32(144))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		v2644 = v80
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(674), int32(242692))
	mBase = m.M
	v420 = m.ExcPending
	if v420 != 0 {
		v2644 = v80
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+160)) = v452 + int32(4)
	F_errmsg(m, int32(720547), v33+int32(160))
	mBase = m.M
	v472 = m.ExcPending
	if v472 != 0 {
		v2644 = v80
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(680), int32(242692))
	mBase = m.M
	v505 = m.ExcPending
	if v505 != 0 {
		v2644 = v80
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+80)) = v537 + int32(4)
	F_errmsg(m, int32(708615), v33+int32(80))
	mBase = m.M
	v557 = m.ExcPending
	if v557 != 0 {
		v2644 = v80
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(685), int32(242692))
	mBase = m.M
	v574 = m.ExcPending
	if v574 != 0 {
		v2644 = v80
...
L51:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	...
	v609 = F_AllocSetContextCreateInternal(m, v604, int32(509053), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v610 = m.ExcPending
	if v610 != 0 {
		v2644 = v80
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(508890), int32(0))
	mBase = m.M
	v710 = m.ExcPending
	if v710 != 0 {
		v2644 = v80
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(739), int32(242692))
	mBase = m.M
	v727 = m.ExcPending
	if v727 != 0 {
		v2644 = v80
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(442755), int32(0))
	mBase = m.M
	v824 = m.ExcPending
	if v824 != 0 {
		v2644 = v80
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(427677), int32(0))
	mBase = m.M
	v857 = m.ExcPending
	if v857 != 0 {
		v2644 = v80
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(772), int32(242692))
	mBase = m.M
	v841 = m.ExcPending
	if v841 != 0 {
		v2644 = v80
...
L89:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(778), int32(242692))
	mBase = m.M
	v874 = m.ExcPending
	if v874 != 0 {
		v2644 = v80
...
L95:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(359200), int32(0))
	mBase = m.M
	v925 = m.ExcPending
	if v925 != 0 {
		v2644 = v80
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(794), int32(242692))
	mBase = m.M
	v942 = m.ExcPending
	if v942 != 0 {
		v2644 = v80
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(459524), int32(0))
	mBase = m.M
	v1060 = m.ExcPending
	if v1060 != 0 {
		v2644 = v80
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(823), int32(242692))
	mBase = m.M
	v1077 = m.ExcPending
	if v1077 != 0 {
		v2644 = v80
...
L157:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(881), int32(242692))
	mBase = m.M
	v1428 = m.ExcPending
	if v1428 != 0 {
		v2644 = v80
...
L160:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	v1483 = *(*int32)(unsafe.Add(mBase, _consts[360]))
...
L162:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	v1501 = *(*int32)(unsafe.Add(mBase, _consts[357]))
...
L168:
	;
	v1525 = *(*int32)(unsafe.Add(mBase, _consts[361]))
...
L170:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	v1560 = F_OpenPipeStream(m, v1539, int32(32574))
	mBase = m.M
	v1561 = m.ExcPending
	if v1561 != 0 {
		v2644 = v80
...
L176:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+48)) = v1593
	F_errmsg(m, int32(299771), v33+int32(48))
	mBase = m.M
	v1611 = m.ExcPending
	if v1611 != 0 {
		v2644 = v80
...
L177:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(934), int32(242692))
	mBase = m.M
	v1628 = m.ExcPending
	if v1628 != 0 {
		v2644 = v80
...
L181:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	v1712 = int32(4409148)
	v1713 = *(*int32)(unsafe.Add(mBase, _consts[362]))
	*(*int32)(unsafe.Add(mBase, _consts[362])) = int32(18)
...
L183:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(387460), int32(0))
	mBase = m.M
	v1680 = m.ExcPending
	if v1680 != 0 {
		v2644 = v80
...
L184:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(950), int32(242692))
	mBase = m.M
	v1697 = m.ExcPending
	if v1697 != 0 {
		v2644 = v80
...
L186:
	;
	v1719 = *(*int32)(unsafe.Add(mBase, _consts[338]))
	v1721 = *(*int32)(unsafe.Add(mBase, _consts[363]))
	goto L187
L187:
	;
...
L192:
	;
	*(*int32)(unsafe.Add(mBase, _consts[363])) = v1740
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v1737
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v1743
	v1775 = F_AllocateFile(m, v1761, int32(32574))
	mBase = m.M
	v1776 = m.ExcPending
	if v1776 != 0 {
		v2644 = v1753
...
L194:
	;
	*(*int32)(unsafe.Add(mBase, _consts[338])) = v1742
	*(*int32)(unsafe.Add(mBase, _consts[363])) = v1741
	*(*int32)(unsafe.Add(mBase, uint32(v33)+176)) = v1742
	*(*int32)(unsafe.Add(mBase, uint32(v33)+180)) = v1741
	*(*int32)(unsafe.Add(mBase, uint32(v33)+184)) = v1744
	*(*int32)(unsafe.Add(mBase, uint32(v33)+188)) = v1738
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v1743
	v1923 = int32(4409148)
	v1924 = *(*int32)(unsafe.Add(mBase, _consts[362]))
	*(*int32)(unsafe.Add(mBase, _consts[362])) = v1744
...
L195:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v1743
	v1795 = int32(4409148)
	v1796 = *(*int32)(unsafe.Add(mBase, _consts[362]))
	*(*int32)(unsafe.Add(mBase, _consts[362])) = v1744
...
L201:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v1737
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v1743
	F_errhint(m, int32(574188), int32(0))
	mBase = m.M
	v1888 = m.ExcPending
	if v1888 != 0 {
		v2644 = v1753
...
L203:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v1737
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v1743
	F_errfinish(m, int32(496006), int32(973), int32(242692))
	mBase = m.M
	v1905 = m.ExcPending
	if v1905 != 0 {
		v2644 = v1753
...
L219:
	;
	v1985 = F___fstatat(m, v1966, int32(757269), v1739, int32(4096))
	mBase = m.M
	v1986 = v1985
	goto L216
L220:
...
L224:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+32)) = v2017
	F_errmsg(m, int32(297701), v33+int32(32))
	mBase = m.M
	v2035 = m.ExcPending
	if v2035 != 0 {
		v2644 = v1753
...
L225:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v1737
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v1743
	F_errfinish(m, int32(496006), int32(980), int32(242692))
	mBase = m.M
	v2052 = m.ExcPending
	if v2052 != 0 {
		v2644 = v1753
...
L229:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+16)) = v2089
	F_errmsg(m, int32(13583), v33+int32(16))
	mBase = m.M
	v2107 = m.ExcPending
	if v2107 != 0 {
		v2644 = v1753
...
L230:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v1737
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v1743
	F_errfinish(m, int32(496006), int32(985), int32(242692))
	mBase = m.M
	v2124 = m.ExcPending
	if v2124 != 0 {
		v2644 = v1753
...
L265:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(508849), int32(0))
	mBase = m.M
	v2472 = m.ExcPending
	if v2472 != 0 {
		v2644 = v80
...
L266:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(757), int32(242692))
	mBase = m.M
	v2489 = m.ExcPending
	if v2489 != 0 {
		v2644 = v80
...
L269:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(509002), int32(0))
	mBase = m.M
	v2536 = m.ExcPending
	if v2536 != 0 {
		v2644 = v80
...
L270:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(753), int32(242692))
	mBase = m.M
	v2553 = m.ExcPending
	if v2553 != 0 {
		v2644 = v80
...
L273:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errmsg(m, int32(508942), int32(0))
	mBase = m.M
	v2600 = m.ExcPending
	if v2600 != 0 {
		v2644 = v80
...
L274:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+216)) = v74
	*(*int32)(unsafe.Add(mBase, uint32(v33)+220)) = v71
	F_errfinish(m, int32(496006), int32(762), int32(242692))
	mBase = m.M
	v2617 = m.ExcPending
	if v2617 != 0 {
		v2644 = v80
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = l4
							...
							if v68 != 0 {
								...
								if v71 != 0 {
									...
									F_errfinish(m, int32(499451), int32(1239), int32(422129))
									mBase = m.M
									v76 = m.ExcPending
									if v76 != 0 {
										return int32(0)
							...
							if v39 != 0 {
								...
								if v41 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l4
									F_errmsg(m, int32(188680), v10+int32(16))
									mBase = m.M
									v49 = m.ExcPending
									if v49 != 0 {
										return int32(0)
										...
										if v52 != 0 {
											...
											F_errfinish(m, int32(499451), int32(1229), int32(422129))
											mBase = m.M
											v57 = m.ExcPending
											if v57 != 0 {
												return int32(0)
...
func F_to_ascii_default(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		v8 = *(*int32)(unsafe.Add(mBase, _consts[357]))
...
L1:
	...
	v21 = int32(1)
	v22 = v15 - v21
	v28 = int32(*(*uint8)(unsafe.Add(mBase, uint32(base.I32_wrap_i64(v16)&v21)+uint32(_consts[1143]))))
...
L1:
	;
	v21 = v14 - int32(1)
	v27 = int32(*(*uint8)(unsafe.Add(mBase, uint32(base.I32_wrap_i64(v15)&int32(7))+uint32(_consts[1143]))))
