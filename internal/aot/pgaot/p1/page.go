...
L17:
	;
	if base.Ui32(int32(_a_F_PageIndexMultiDelete_1)) < base.Ui32(v59) {
		goto L4
	} else {
		goto L18
	}
L18:
	;
	if (v59+int32(7))&int32(_a_F_PageIndexMultiDelete_2) != v59 {
		goto L4
	} else {
		goto L19
	}
...
L23:
	;
	v81 = int32(base.Ui32(v61+int32(_a_F_PageIndexMultiDelete_3))>>(uint(int32(2))%32)) & int32(_a_F_PageIndexMultiDelete_4)
	if v81 == int32(0) {
		v179 = v4
		v180 = v4
		v181 = v4
...
L25:
	;
	v110 = v104 & int32(_a_F_PageIndexMultiDelete_4)
	...
	v120 = v116 & int32(_a_F_PageIndexMultiDelete_5)
...
L28:
	;
	if v120 != (v120+int32(7))&int32(_a_F_PageIndexMultiDelete_6) {
		goto L3
	} else {
		goto L29
	}
...
L30:
	;
	v168 = v104 + int32(1)
	if base.Ui32(v168&int32(_a_F_PageIndexMultiDelete_4)) <= base.Ui32(v81) {
		v95 = v160
		v96 = v161
		v97 = v162
		v98 = v163
...
L31:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v95))) = uint16(v96)
	v142 = (v118 + int32(7)) & int32(_a_F_PageIndexMultiDelete_6)
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v61
	F_errmsg(m, int32(_a_F_PageIndexMultiDelete_7), v23)
	mBase = m.M
	v247 = m.ExcPending
	if v247 != 0 {
		goto L12
...
L49:
	;
	F_errfinish(m, int32(_a_F_PageIndexMultiDelete_8), int32(1208), int32(_a_F_PageIndexMultiDelete_9))
	mBase = m.M
	v252 = m.ExcPending
	if v252 != 0 {
		goto L12
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+32)) = v120
	F_errmsg(m, int32(_a_F_PageIndexMultiDelete_10), v23+int32(32))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L12
...
L53:
	;
	F_errfinish(m, int32(_a_F_PageIndexMultiDelete_8), int32(1233), int32(_a_F_PageIndexMultiDelete_9))
	mBase = m.M
	v271 = m.ExcPending
	if v271 != 0 {
		goto L12
...
L55:
	;
	F_errmsg_internal(m, int32(_a_F_PageIndexMultiDelete_11), int32(0))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L12
...
L56:
	;
	F_errfinish(m, int32(_a_F_PageIndexMultiDelete_8), int32(1260), int32(_a_F_PageIndexMultiDelete_9))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L12
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v181
	F_errmsg(m, int32(_a_F_PageIndexMultiDelete_12), v23+int32(16))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L12
...
L60:
	;
	F_errfinish(m, int32(_a_F_PageIndexMultiDelete_8), int32(1266), int32(_a_F_PageIndexMultiDelete_9))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		goto L12
...
func F_PageInit(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*uint16)(unsafe.Add(mBase, uint32(l0)+18)) = uint16(v36)
	v42 = l1 - (l2+int32(7))&int32(_a_F_PageInit_1)
...
L8:
	;
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_PageIsVerified[0]))
...
L16:
	;
	if base.Ui32(int32(_a_F_PageIsVerified_0)) < base.Ui32(v46) {
		v64 = v38
		v65 = v39
		v66 = v17
		goto L5
...
L17:
	;
	v50 = int32(1)
	v54 = (v46 + int32(7)) & int32(_a_F_PageIsVerified_1)
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v65
	F_errmsg(m, int32(_a_F_PageIsVerified_2), v13)
	mBase = m.M
	v216 = m.ExcPending
	if v216 != 0 {
		goto L54
...
L58:
	;
	F_errfinish(m, int32(_a_F_PageIsVerified_3), int32(155), int32(_a_F_PageIsVerified_4))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L54
...
L1:
	...
	v76 = v74 & int32(_a_F_PageTruncateLinePointerArray_0)
...
L5:
	;
	v35 = *(*int32)(unsafe.Add(mBase, uint32(v22&int32(_a_F_PageTruncateLinePointerArray_2)<<(uint(int32(2))%32)+(l0+int32(24))-int32(4))))
	v37 = v35 & int32(_a_F_PageTruncateLinePointerArray_3)
	if v22 == int32(1) {
		goto L8
	} else {
		goto L9
