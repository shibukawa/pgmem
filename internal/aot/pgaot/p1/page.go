	...
	if base.Ui32(int32(8161)) <= base.Ui32(l1) {
		...
		if v15 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
			F_errmsg_internal(m, int32(37644), v6)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
...
L49:
	;
	F_errfinish(m, int32(500556), int32(1208), int32(352242))
	mBase = m.M
	v252 = m.ExcPending
	if v252 != 0 {
		goto L12
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+32)) = v120
	F_errmsg(m, int32(57391), v23+int32(32))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L12
...
L53:
	;
	F_errfinish(m, int32(500556), int32(1233), int32(352242))
	mBase = m.M
	v271 = m.ExcPending
	if v271 != 0 {
		goto L12
...
L55:
	;
	F_errmsg_internal(m, int32(457417), int32(0))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L12
...
L56:
	;
	F_errfinish(m, int32(500556), int32(1260), int32(352242))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L12
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+16)) = v181
	F_errmsg(m, int32(53180), v23+int32(16))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L12
...
L60:
	;
	F_errfinish(m, int32(500556), int32(1266), int32(352242))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		goto L12
...
L58:
	;
	F_errfinish(m, int32(500556), int32(155), int32(457730))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L54
