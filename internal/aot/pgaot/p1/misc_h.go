					...
					if v10 != 0 {
						...
						if v15 != 0 {
							...
							if v18 != 0 {
								...
								F_errmsg(m, int32(273072), int32(0))
								mBase = m.M
								v22 = m.ExcPending
								if v22 != 0 {
									return
								} else {
									F_errfinish(m, int32(478028), int32(498), int32(77627))
									mBase = m.M
									v27 = m.ExcPending
									if v27 != 0 {
										return
...
L29:
	;
	F_errfinish(m, int32(474851), int32(4189), int32(315543))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L11
...
func F_has_largeobject_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		v14 = F_convert_any_priv_string(m, v9, int32(1620640))
		mBase = m.M
		v15 = m.ExcPending
		if v15 != 0 {
			return int32(0)
...
L136:
	;
	F_errfinish(m, int32(476476), int32(1057), int32(442964))
	mBase = m.M
	v760 = m.ExcPending
	if v760 != 0 {
		goto L1
...
L139:
	;
	F_errfinish(m, int32(476476), int32(1082), int32(442964))
	mBase = m.M
	v773 = m.ExcPending
	if v773 != 0 {
		goto L1
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v62
	v67 = F_find_among_b(m, l0, int32(4240816), int32(132))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L23
...
L37:
	;
	v141 = F_find_among(m, l0, int32(4170976), int32(8))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L38
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v348
	v353 = F_find_among_b(m, l0, int32(4171648), int32(44))
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
		goto L38
...
L79:
	;
	v281 = F_find_among_b(m, l0, int32(4171136), int32(2))
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L38
...
L85:
	...
	v310 = F_find_among_b(m, l0, int32(4171184), int32(23))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L38
...
L105:
	;
	v379 = F_find_among_b(m, l0, int32(4172528), int32(2))
	mBase = m.M
	v380 = m.ExcPending
	if v380 != 0 {
		goto L38
...
L109:
	;
	v398 = F_slice_from_s(m, l0, int32(1), int32(2136092))
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L38
...
L110:
	;
	v392 = F_slice_from_s(m, l0, int32(1), int32(2136091))
	mBase = m.M
	v393 = m.ExcPending
	if v393 != 0 {
		goto L38
...
L117:
	;
	v418 = F_find_among_b(m, l0, int32(4172576), int32(3))
	mBase = m.M
	v419 = m.ExcPending
	if v419 != 0 {
		goto L38
...
L121:
	;
	v437 = F_slice_from_s(m, l0, int32(1), int32(2136096))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L38
...
L122:
	;
	v431 = F_slice_from_s(m, l0, int32(1), int32(2136095))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L38
...
L129:
	;
	v459 = F_find_among_b(m, l0, int32(4172640), int32(6))
	mBase = m.M
	v460 = m.ExcPending
	if v460 != 0 {
		goto L38
...
L133:
	;
	v482 = F_slice_from_s(m, l0, int32(1), int32(2136108))
	mBase = m.M
	v483 = m.ExcPending
	if v483 != 0 {
		goto L38
...
L134:
	;
	v476 = F_slice_from_s(m, l0, int32(1), int32(2136107))
	mBase = m.M
	v477 = m.ExcPending
	if v477 != 0 {
		goto L38
...
L144:
	;
	v502 = F_find_among_b(m, l0, int32(4172768), int32(2))
	mBase = m.M
	v503 = m.ExcPending
	if v503 != 0 {
		goto L38
...
L150:
	...
	v531 = F_find_among_b(m, l0, int32(4171184), int32(23))
	mBase = m.M
	v532 = m.ExcPending
	if v532 != 0 {
		goto L38
...
L159:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v606
	v613 = F_find_among_b(m, l0, int32(4173056), int32(31))
	mBase = m.M
	v614 = m.ExcPending
	if v614 != 0 {
		goto L38
...
L161:
	;
	v577 = F_find_among_b(m, l0, int32(4172816), int32(12))
	mBase = m.M
	v578 = m.ExcPending
	if v578 != 0 {
		goto L38
...
L165:
	;
	v600 = F_slice_from_s(m, l0, int32(1), int32(2136140))
	mBase = m.M
	v601 = m.ExcPending
	if v601 != 0 {
		goto L38
...
L166:
	;
	v594 = F_slice_from_s(m, l0, int32(1), int32(2136139))
	mBase = m.M
	v595 = m.ExcPending
	if v595 != 0 {
		goto L38
...
L179:
	;
	v636 = F_slice_from_s(m, l0, int32(1), int32(2136173))
	mBase = m.M
	v637 = m.ExcPending
	if v637 != 0 {
		goto L38
...
L180:
	;
	v630 = F_slice_from_s(m, l0, int32(1), int32(2136172))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L38
...
L192:
	;
	v670 = F_find_among_b(m, l0, int32(4173680), int32(42))
	mBase = m.M
	v671 = m.ExcPending
	if v671 != 0 {
		goto L38
...
L197:
	;
	v693 = F_slice_from_s(m, l0, int32(1), int32(2136240))
	mBase = m.M
	v694 = m.ExcPending
	if v694 != 0 {
		goto L38
...
L198:
	;
	v687 = F_slice_from_s(m, l0, int32(1), int32(2136239))
	mBase = m.M
	v688 = m.ExcPending
	if v688 != 0 {
		goto L38
...
L209:
	;
	v720 = F_find_among_b(m, l0, int32(4174528), int32(7))
	mBase = m.M
	v721 = m.ExcPending
	if v721 != 0 {
		goto L38
...
L215:
	;
	v739 = F_slice_from_s(m, l0, int32(1), int32(2136388))
	mBase = m.M
	v740 = m.ExcPending
	if v740 != 0 {
		goto L38
...
L216:
	;
	v733 = F_slice_from_s(m, l0, int32(1), int32(2136387))
	mBase = m.M
	v734 = m.ExcPending
	if v734 != 0 {
		goto L38
