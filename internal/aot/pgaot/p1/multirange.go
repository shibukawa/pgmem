...
func F_multirange_constructor0(m *base.Module, l0 int32) int32 {
	...
	if v9 == int32(0) {
		...
		if v42 != 0 {
			...
			F_errmsg_internal(m, int32(121411), int32(0))
			mBase = m.M
			v46 = m.ExcPending
			if v46 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(492378), int32(1069), int32(552751))
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return int32(0)
							...
							if v14 == int32(16) {
								...
								if v51 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v14
									F_errmsg_internal(m, int32(478892), v11+int32(16))
									mBase = m.M
									v57 = m.ExcPending
									if v57 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(490909), int32(1138), int32(95920))
										mBase = m.M
										v62 = m.ExcPending
										if v62 != 0 {
											return int32(0)
							...
							if v14 != int32(16) {
								...
								if v87 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v11))) = v14
									F_errmsg_internal(m, int32(478892), v11)
									mBase = m.M
									v91 = m.ExcPending
									if v91 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(490909), int32(1049), int32(95850))
										mBase = m.M
										v96 = m.ExcPending
										if v96 != 0 {
											return int32(0)
...
L51:
	;
	F_errmsg_internal(m, int32(61113), int32(0))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L20
...
L52:
	;
	F_errfinish(m, int32(492378), int32(1479), int32(279847))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L20
...
L54:
	;
	F_errmsg_internal(m, int32(399987), int32(0))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L20
...
L55:
	;
	F_errfinish(m, int32(492378), int32(1483), int32(279847))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L20
