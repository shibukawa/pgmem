...
func F_multirange_constructor0(m *base.Module, l0 int32) int32 {
	...
	if v9 == int32(0) {
		...
		if v42 != 0 {
			...
			F_errmsg_internal(m, int32(129679), int32(0))
			mBase = m.M
			v46 = m.ExcPending
			if v46 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(518389), int32(1069), int32(590203))
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return int32(0)
...
L51:
	;
	F_errmsg_internal(m, int32(67096), int32(0))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L20
...
L52:
	;
	F_errfinish(m, int32(518389), int32(1479), int32(294227))
	mBase = m.M
	v172 = m.ExcPending
	if v172 != 0 {
		goto L20
...
L54:
	;
	F_errmsg_internal(m, int32(420385), int32(0))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L20
...
L55:
	;
	F_errfinish(m, int32(518389), int32(1483), int32(294227))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L20
