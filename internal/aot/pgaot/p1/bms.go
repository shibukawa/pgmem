	...
	if int32(0) <= l1 {
		...
		if v80 != 0 {
			...
			if v84 != 0 {
				...
				F_errfinish(m, int32(512725), int32(823), int32(238459))
				mBase = m.M
				v89 = m.ExcPending
				if v89 != 0 {
					return int32(0)
...
L19:
	;
	F_errfinish(m, int32(512725), int32(876), int32(238395))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L16
...
L17:
	;
	F_errmsg_internal(m, int32(8791), int32(0))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L16
...
L18:
	;
	F_errfinish(m, int32(512725), int32(681), int32(238374))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L16
...
L20:
	;
	F_errmsg_internal(m, int32(143476), int32(0))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L16
...
L21:
	;
	F_errfinish(m, int32(512725), int32(692), int32(238374))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L16
