...
L351:
	;
	F_errfinish(m, int32(472897), int32(1126), int32(104788))
	mBase = m.M
	v1938 = m.ExcPending
	if v1938 != 0 {
		goto L1
		...
		default:
			...
			if v34 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16))) = base.I32_extend8_s(v24)
				F_errmsg_internal(m, int32(459409), v16)
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(472897), int32(242), int32(97357))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
