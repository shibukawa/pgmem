...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+20)) = v76 - int32(1)
	F_errmsg_internal(m, int32(462196), v15+int32(16))
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L13
...
L36:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v195<<(uint(int32(2))%32))+uint32(_consts[1223]))) = v18 + int32(4479248)
	v323 = int32(4479240)
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+4)) = v338
	F_errmsg_internal(m, int32(462196), v15)
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L13
...
L50:
	;
	F_errfinish(m, int32(487630), int32(120), int32(65060))
	mBase = m.M
	v347 = m.ExcPending
	if v347 != 0 {
		goto L13
