						...
						if v26 != 0 {
							...
							if v30 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
								F_errmsg_internal(m, int32(55460), v10)
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(497113), int32(165), int32(371104))
									mBase = m.M
									v40 = m.ExcPending
									if v40 != 0 {
										return int32(0)
...
L68:
	;
	F_errmsg_internal(m, int32(149893), int32(0))
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L3
...
L69:
	;
	F_errfinish(m, int32(496129), int32(181), int32(64004))
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L3
...
L72:
	;
	F_errfinish(m, int32(496129), int32(213), int32(64004))
	mBase = m.M
	v302 = m.ExcPending
	if v302 != 0 {
		goto L3
...
L78:
	;
	F_errmsg(m, int32(149950), int32(0))
	mBase = m.M
	v321 = m.ExcPending
	if v321 != 0 {
		goto L3
...
L79:
	;
	F_errfinish(m, int32(496129), int32(240), int32(64004))
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L3
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(498583), int32(3749), int32(450240))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
...
func F_index_am_handler_out(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(219225)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(493543), int32(371), int32(66878))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = base.I32_extend16_s(v119)
	F_errmsg_internal(m, int32(482718), v17)
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L32
...
func F_index_endscan(m *base.Module, l0 int32) {
	...
	if v11 != 0 {
		...
		if v49 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(284189)
			*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v51 + int32(4)
			F_errmsg_internal(m, int32(677323), v7)
			mBase = m.M
			v59 = m.ExcPending
			if v59 != 0 {
				return
			} else {
				F_errfinish(m, int32(496583), int32(385), int32(284209))
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return
		...
		if v30 == int32(0) {
			...
			if v68 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v11)+8)) = v69 + int32(4)
				F_errmsg_internal(m, int32(680602), v11)
				mBase = m.M
				v77 = m.ExcPending
				if v77 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496583), int32(947), int32(241219))
					mBase = m.M
					v82 = m.ExcPending
					if v82 != 0 {
						return int32(0)
...
L14:
	;
	F_errfinish(m, int32(496583), int32(1076), int32(136976))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L8
...
L18:
	;
	F_errfinish(m, int32(494201), int32(7040), int32(68135))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L16
...
func F_index_restrpos(m *base.Module, l0 int32) {
	...
	if v11 != 0 {
		...
		if v34 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(136243)
			*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v36 + int32(4)
			...
			if v44 != 0 {
				...
				F_errfinish(m, int32(496583), int32(441), int32(136254))
				mBase = m.M
				v49 = m.ExcPending
				if v49 != 0 {
					return
		...
		if v18 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
			...
			if v24 != 0 {
				...
				F_errfinish(m, int32(495212), int32(267), int32(100795))
				mBase = m.M
				v31 = m.ExcPending
				if v31 != 0 {
					return float64(0)
	...
	if v20 == int32(0) {
		...
		if v24 == int32(0) {
			...
			if v57 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = int32(232326)
				*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = v58 + int32(4)
				F_errmsg_internal(m, int32(677323), v8+int32(16))
				mBase = m.M
				v68 = m.ExcPending
				if v68 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496583), int32(822), int32(232437))
					mBase = m.M
					v73 = m.ExcPending
					if v73 != 0 {
						return int32(0)
		...
		if v38 != 0 {
			...
			if v41 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8))) = v42 + int32(4)
				F_errmsg(m, int32(438018), v8)
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496583), int32(821), int32(232437))
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return int32(0)
											...
											if v534 != 0 {
												...
												if v533 != 0 {
													...
													*(*float64)(unsafe.Add(mBase, uint32(v12)+8)) = v539
													F_errmsg_internal(m, int32(164337), v12)
													mBase = m.M
													v543 = m.ExcPending
													if v543 != 0 {
														return
													} else {
														F_errfinish(m, int32(491877), int32(3466), int32(28177))
														mBase = m.M
														v548 = m.ExcPending
														if v548 != 0 {
															return
