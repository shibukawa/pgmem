...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(268435455)
	F_errmsg(m, int32(_a_F_ArrayGetNItems_0), v9)
	mBase = m.M
	v69 = m.ExcPending
	if v69 != 0 {
		goto L11
...
L24:
	;
	F_errsave_finish(m, int32(0), int32(_a_F_ArrayGetNItems_1), v61, int32(_a_F_ArrayGetNItems_2))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L11
...
L47:
	;
	v127 = int32(_a_F_array_agg_combine_0)
	v128 = *(*int32)(unsafe.Add(mBase, _c_F_array_agg_combine[0]))
	v129 = *(*int32)(unsafe.Add(mBase, uint32(v48)+16))
	v131 = *(*int32)(unsafe.Add(mBase, uint32(v48)))
	*(*int32)(unsafe.Add(mBase, _c_F_array_agg_combine[0])) = v131
	v133 = v123 + v129
...
L65:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_array_agg_combine[0])) = v128
	v214 = v48
	goto L21
L66:
	;
...
L36:
	;
	v99 = *(*int32)(unsafe.Add(mBase, _c_F_array_agg_deserialize[0]))
...
L28:
	;
	v78 = F_parse_array_element(m, v32+int32(12), int32(_a_F_get_array_start_1))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L23
