...
L24:
	;
	F_errsave_finish(m, int32(0), int32(485016), v61, int32(402591))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L11
...
L70:
	;
	F_errfinish(m, int32(485781), int32(609), int32(367319))
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L31
...
L74:
	;
	F_errfinish(m, int32(485781), int32(797), int32(335902))
	mBase = m.M
	v241 = m.ExcPending
	if v241 != 0 {
		goto L19
...
L78:
	;
	F_errfinish(m, int32(485781), int32(873), int32(335902))
	mBase = m.M
	v258 = m.ExcPending
	if v258 != 0 {
		goto L19
				...
				if v21 == int32(0) {
					...
					if v48 != 0 {
						...
						if v52 != 0 {
							...
							F_errfinish(m, int32(485674), int32(6067), int32(299109))
							mBase = m.M
							v57 = m.ExcPending
							if v57 != 0 {
								return int32(0)
		...
		if v32 != 0 {
			...
			if v35 != 0 {
				...
				if v39 != 0 {
					...
					F_errfinish(m, int32(485674), int32(6050), int32(299109))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
...
L32:
	;
	F_errmsg(m, int32(437600), int32(0))
	mBase = m.M
	v149 = m.ExcPending
	if v149 != 0 {
		goto L7
...
L33:
	;
	F_errfinish(m, int32(485674), int32(2067), int32(410896))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L7
...
L60:
	;
	F_errfinish(m, int32(485781), int32(1411), int32(241571))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L8
...
L63:
	;
	F_errmsg(m, int32(298004), int32(0))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L8
...
L64:
	;
	F_errfinish(m, int32(485781), int32(1377), int32(241571))
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L8
...
L67:
	;
	F_errmsg(m, int32(434337), int32(0))
	mBase = m.M
	v241 = m.ExcPending
	if v241 != 0 {
		goto L8
...
L68:
	;
	F_errfinish(m, int32(485781), int32(1348), int32(241571))
	mBase = m.M
	v246 = m.ExcPending
	if v246 != 0 {
		goto L8
					...
					if v40 != int32(1) {
						...
						if v46 != 0 {
							...
							if v49 != 0 {
								...
								F_errmsg(m, int32(340270), int32(0))
								mBase = m.M
								v53 = m.ExcPending
								if v53 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(491035), int32(3474), int32(28786))
									mBase = m.M
									v58 = m.ExcPending
									if v58 != 0 {
										return int32(0)
											...
											if v77 != int32(1) {
												...
												if v83 != 0 {
													...
													if v86 != 0 {
														...
														F_errmsg(m, int32(394859), int32(0))
														mBase = m.M
														v90 = m.ExcPending
														if v90 != 0 {
															return int32(0)
														} else {
															F_errfinish(m, int32(491035), int32(3486), int32(28786))
															mBase = m.M
															v95 = m.ExcPending
															if v95 != 0 {
																return int32(0)
	...
	if l1 == int32(0) {
		...
		if v16 != 0 {
			...
			if v13 == int32(0) {
					...
					if v44 != 0 {
						...
						if v46 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v45
							F_errmsg(m, int32(360545), v9)
							mBase = m.M
							v50 = m.ExcPending
							if v50 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(485674), int32(5525), int32(203595))
								mBase = m.M
								v55 = m.ExcPending
								if v55 != 0 {
									return int32(0)
				...
				v19 = v13
				if v4 != 0 {
					v24 = F_AllocSetContextCreateInternal(m, l2, int32(203614), int32(0), int32(8192), int32(8388608))
					mBase = m.M
					v25 = m.ExcPending
					if v25 != 0 {
						return int32(0)
