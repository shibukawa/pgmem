					...
					if v171 != 0 {
						...
						if v175 != 0 {
							...
							if v179 != 0 {
								...
								F_errfinish(m, int32(494796), int32(438), int32(369683))
								mBase = m.M
								v184 = m.ExcPending
								if v184 != 0 {
									return int32(0)
...
L27:
	;
	F_errfinish(m, int32(493734), int32(244), int32(99802))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L11
...
L57:
	;
	F_errfinish(m, int32(493734), int32(256), int32(99802))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L11
...
func F_SetupApplyOrSyncWorker(m *base.Module, l0 int32) {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v15)+136)) = int32(268435456)
		v37 = v15 + int32(4)
		if v37 != 0 {
			v48 = F___memcpy(m, int32(4651980), v37, int32(140))
			mBase = m.M
		} else {
		}
		m.G0 = v15 + int32(144)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v57)+136)) = int32(268435456)
		v79 = v57 + int32(4)
		if v79 != 0 {
			v90 = F___memcpy(m, int32(4653940), v79, int32(140))
			mBase = m.M
		} else {
		}
		m.G0 = v57 + int32(144)
					...
					if v128 != 0 {
						...
						if v127 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = v131
							F_errmsg_internal(m, int32(694171), v6)
							mBase = m.M
							v135 = m.ExcPending
							if v135 != 0 {
								return
							} else {
								F_errfinish(m, int32(492269), int32(4805), int32(220229))
								mBase = m.M
								v140 = m.ExcPending
								if v140 != 0 {
									return
				...
				if l0 == int32(4) {
					if v18 == int32(0) {
						...
						if v26 != 0 {
							...
							if v30 != 0 {
								...
								F_errfinish(m, int32(492052), int32(3971), int32(129416))
								mBase = m.M
								v35 = m.ExcPending
								if v35 != 0 {
									return int32(0)
					...
					if v18 == int32(0) {
						...
						if v41 != 0 {
							...
							F_errfinish(m, int32(492052), int32(3975), int32(129416))
							mBase = m.M
							v46 = m.ExcPending
							if v46 != 0 {
								return int32(0)
							...
							if v59 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7))) = v65
								...
								if v69 != 0 {
									...
									F_errfinish(m, int32(492052), int32(3986), int32(129416))
									mBase = m.M
									v74 = m.ExcPending
									if v74 != 0 {
										return int32(0)
...
func F_sanitize_char_2(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0 & v7
	...
	v21 = F_pg_snprintf(m, int32(4385680), int32(5), v20, v5)
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		return
		...
		if v22 != 0 {
			...
			if v15 == int32(0) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l0
				F_errmsg(m, int32(683539), v8+int32(16))
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return
...
L38:
	;
	F_errfinish(m, int32(494337), int32(1491), int32(109337))
	mBase = m.M
	v165 = m.ExcPending
	if v165 != 0 {
		goto L3
				...
				if v33 != 0 {
					...
					if v32 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v37
						F_errmsg(m, int32(659770), v8)
						mBase = m.M
						v52 = m.ExcPending
						if v52 != 0 {
							return
						} else {
							F_errfinish(m, int32(494616), int32(369), int32(433572))
							mBase = m.M
							v57 = m.ExcPending
							if v57 != 0 {
								return
		...
		if v67 != 0 {
			...
			if v71 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v74
				F_errdetail_log(m, int32(707213), v8+int32(16))
				mBase = m.M
				v80 = m.ExcPending
				if v80 != 0 {
					return
				} else {
					F_errfinish(m, int32(494616), int32(356), int32(433572))
					mBase = m.M
					v85 = m.ExcPending
					if v85 != 0 {
						return
...
func F_set_debug_options(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	m.G0 = v7
	if l0 <= int32(0) {
		F_SetConfigOption(m, int32(169253), int32(415482), l1, l2)
		mBase = m.M
		v14 = m.ExcPending
		if v14 != 0 {
			return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
		v19 = F_pg_sprintf(m, v7+int32(16), int32(463123), v7)
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v81
	F_errmsg_internal(m, int32(470720), v10)
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L24
...
L26:
	;
	F_errfinish(m, int32(490777), int32(5246), int32(270982))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L24
		...
		if v9 != 0 {
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
			...
			if v16 != 0 {
				...
				F_errfinish(m, int32(494101), int32(164), int32(324894))
				mBase = m.M
				v23 = m.ExcPending
				if v23 != 0 {
					return
...
func F_show_unix_socket_permissions(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v7
	v12 = F_pg_snprintf(m, int32(4384185), int32(12), int32(241489), v4)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
...
L91:
	;
	F_errfinish(m, int32(492464), int32(951), int32(310393))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L31
...
L118:
	;
	F_errfinish(m, int32(492464), int32(805), int32(310393))
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L31
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+68)) = int32(491975)
...
L367:
	;
	v1673 = F_find_among_b(m, l0, int32(4352224), int32(13))
	mBase = m.M
	v1676 = m.ExcPending
	if v1676 != 0 {
		goto L368
...
L372:
	;
	v1692 = F_find_among_b(m, l0, int32(4352496), int32(11))
	mBase = m.M
	v1693 = m.ExcPending
	if v1693 != 0 {
		goto L368
...
L378:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v1696
	v1733 = F_slice_from_s(m, l0, int32(2), int32(2205969))
	mBase = m.M
	v1734 = m.ExcPending
	if v1734 != 0 {
		goto L368
...
L379:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v1696
	v1726 = F_slice_from_s(m, l0, int32(2), int32(2205967))
	mBase = m.M
	v1727 = m.ExcPending
	if v1727 != 0 {
		goto L368
...
L380:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v1696
	v1719 = F_slice_from_s(m, l0, int32(2), int32(2205965))
	mBase = m.M
	v1720 = m.ExcPending
	if v1720 != 0 {
		goto L368
...
L381:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v1696
	v1712 = F_slice_from_s(m, l0, int32(4), int32(2205961))
	mBase = m.M
	v1713 = m.ExcPending
	if v1713 != 0 {
		goto L368
...
L382:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v1696
	v1705 = F_slice_from_s(m, l0, int32(5), int32(2205956))
	mBase = m.M
	v1706 = m.ExcPending
	if v1706 != 0 {
		goto L368
...
L399:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v2153
	v2158 = F_find_among_b(m, l0, int32(4356016), int32(8))
	mBase = m.M
	v2159 = m.ExcPending
	if v2159 != 0 {
		goto L368
...
L403:
	;
	v1783 = F_find_among_b(m, l0, int32(4352720), int32(46))
	mBase = m.M
	v1784 = m.ExcPending
	if v1784 != 0 {
		goto L368
...
L423:
	...
	v1818 = F_memcmp(m, v1815+v1805-v1807, int32(2206051), v1807)
	mBase = m.M
	if v1818 != 0 {
		v1822 = v1809
		goto L422
...
L429:
	;
	v1839 = F_slice_from_s(m, l0, int32(3), int32(2206053))
	mBase = m.M
	v1840 = m.ExcPending
	if v1840 != 0 {
		goto L368
...
L432:
	;
	v1848 = F_slice_from_s(m, l0, int32(1), int32(2206056))
	mBase = m.M
	v1849 = m.ExcPending
	if v1849 != 0 {
		goto L368
...
L435:
	;
	v1857 = F_slice_from_s(m, l0, int32(4), int32(2206057))
	mBase = m.M
	v1858 = m.ExcPending
	if v1858 != 0 {
		goto L368
...
L443:
	;
	v1889 = F_find_among_b(m, l0, int32(4353648), int32(4))
	mBase = m.M
	v1890 = m.ExcPending
	if v1890 != 0 {
		goto L368
...
L452:
	...
	v1917 = F_memcmp(m, v1914+v1904-v1906, int32(2206061), v1906)
	mBase = m.M
	if v1917 != 0 {
		v1921 = v1908
		goto L451
...
L462:
	;
	v1955 = F_find_among_b(m, l0, int32(4353728), int32(3))
	mBase = m.M
	v1956 = m.ExcPending
	if v1956 != 0 {
		goto L368
...
L473:
	;
	v1996 = F_find_among_b(m, l0, int32(4353792), int32(3))
	mBase = m.M
	v1997 = m.ExcPending
	if v1997 != 0 {
		goto L368
...
L484:
	...
	v2029 = F_memcmp(m, v2026+v2016-v2018, int32(2206063), v2018)
	mBase = m.M
	if v2029 != 0 {
		v2033 = v2020
		goto L483
...
L491:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v2050
	v2057 = F_find_among_b(m, l0, int32(4353856), int32(12))
	mBase = m.M
	v2058 = m.ExcPending
	if v2058 != 0 {
		goto L368
...
L510:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+12)) = v2101
	v2108 = F_find_among_b(m, l0, int32(4354096), int32(96))
	mBase = m.M
	v2109 = m.ExcPending
	if v2109 != 0 {
		goto L368
...
L551:
	;
	v2239 = F_find_among(m, l0, int32(4356176), int32(6))
	mBase = m.M
	v2240 = m.ExcPending
	if v2240 != 0 {
		goto L368
...
L558:
	;
	v2271 = F_slice_from_s(m, l0, int32(1), int32(2206824))
	mBase = m.M
	v2272 = m.ExcPending
	if v2272 != 0 {
		goto L368
...
L559:
	;
	v2265 = F_slice_from_s(m, l0, int32(1), int32(2206823))
	mBase = m.M
	v2266 = m.ExcPending
	if v2266 != 0 {
		goto L368
...
L560:
	;
	v2259 = F_slice_from_s(m, l0, int32(1), int32(2206822))
	mBase = m.M
	v2260 = m.ExcPending
	if v2260 != 0 {
		goto L368
...
L561:
	;
	v2253 = F_slice_from_s(m, l0, int32(1), int32(2206821))
	mBase = m.M
	v2254 = m.ExcPending
	if v2254 != 0 {
		goto L368
...
L562:
	;
	v2247 = F_slice_from_s(m, l0, int32(1), int32(2206820))
	mBase = m.M
	v2248 = m.ExcPending
	if v2248 != 0 {
		goto L368
		...
		if l2 == int32(0) {
			...
			if v79 != 0 {
				...
				if v82 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(665247)
					...
					if v87 != 0 {
						...
						if v91 != 0 {
							...
							F_errfinish(m, int32(494985), int32(1719), int32(216830))
							mBase = m.M
							v96 = m.ExcPending
							if v96 != 0 {
								return int32(0)
...
L169:
	;
	F_errfinish(m, int32(496843), int32(207), int32(499625))
	mBase = m.M
	v551 = m.ExcPending
	if v551 != 0 {
		goto L10
					...
					if v108 != 0 {
						...
						if v111 != 0 {
							...
							if v117 != 0 {
								...
								F_errfinish(m, int32(492620), int32(287), int32(24087))
								mBase = m.M
								v124 = m.ExcPending
								if v124 != 0 {
									return int32(0)
					...
					if v63 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v64
						...
						if v68 != 0 {
							...
							F_errfinish(m, int32(490943), int32(5399), int32(207791))
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return int32(0)
...
L39:
	;
	F_errfinish(m, int32(491716), int32(41), int32(222640))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L36
...
L43:
	;
	F_errfinish(m, int32(491716), int32(47), int32(222640))
	mBase = m.M
	v151 = m.ExcPending
	if v151 != 0 {
		goto L36
...
L47:
	;
	F_errfinish(m, int32(491716), int32(53), int32(222640))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L36
...
L51:
	;
	F_errfinish(m, int32(491716), int32(59), int32(222640))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L36
	...
	if v9 == int32(0) {
		...
		if v13 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l2
			v19 = F_psprintf(m, int32(683539), v7+int32(16))
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return
