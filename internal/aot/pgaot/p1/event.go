	...
	if l3 != 0 {
		...
		if v14 != v16 {
			...
			if v114 != 0 {
				...
				if v118 != 0 {
					...
					F_errfinish(m, int32(488298), int32(587), int32(107493))
					mBase = m.M
					v123 = m.ExcPending
					if v123 != 0 {
						return
			...
			if v18 != 0 {
				...
				if v127 != 0 {
					...
					F_errmsg_internal(m, int32(322637), int32(0))
					mBase = m.M
					v131 = m.ExcPending
					if v131 != 0 {
						return
					} else {
						F_errfinish(m, int32(488298), int32(589), int32(107493))
						mBase = m.M
						v136 = m.ExcPending
						if v136 != 0 {
							return
				...
				if v13&int32(1) != 0 {
					...
					if v41 != 0 {
						...
						if v153 != 0 {
							...
							F_errmsg_internal(m, int32(106521), int32(0))
							mBase = m.M
							v157 = m.ExcPending
							if v157 != 0 {
								return
							} else {
								F_errfinish(m, int32(488298), int32(601), int32(107493))
								mBase = m.M
								v162 = m.ExcPending
								if v162 != 0 {
									return
					...
					if v24 != 0 {
						...
						F_errmsg_internal(m, int32(105519), int32(0))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return
						} else {
							F_errfinish(m, int32(488298), int32(591), int32(107493))
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return
		...
		if v13&int32(1) != 0 {
			...
			if v140 != 0 {
				...
				F_errmsg_internal(m, int32(322672), int32(0))
				mBase = m.M
				v144 = m.ExcPending
				if v144 != 0 {
					return
				} else {
					F_errfinish(m, int32(488298), int32(596), int32(107493))
					mBase = m.M
					v149 = m.ExcPending
					if v149 != 0 {
						return
		...
		if v15 != 0 {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v18)+28)) = v26 + v6
				if l0 != 0 {
					F_ResourceOwnerRemember(m, l0, v18, int32(1607628))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
...
func F_EventTriggerAlterTableEnd(m *base.Module) {
	...
	var v30 int32
	_ = v30
	v6 = *(*int32)(unsafe.Add(mBase, _consts[365]))
	if v6 == int32(0) {
		return
	} else {
			...
			if v12 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[3])) = v16
				...
				if v20 != 0 {
					...
					v22 = *(*int32)(unsafe.Add(mBase, _consts[365]))
				...
				if v27 != 0 {
					...
					v29 = *(*int32)(unsafe.Add(mBase, _consts[365]))
					v30 = v29
					*(*int32)(unsafe.Add(mBase, uint32(v30)+24)) = v11
					return
				}
...
func F_EventTriggerCollectSimpleCommand(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v41 int32
	_ = v41
	v7 = *(*int32)(unsafe.Add(mBase, _consts[365]))
	if v7 == int32(0) {
		return
	} else {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v17)+32)) = v30
				...
				if v33 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v17)+8)) = v32
					v36 = *(*int32)(unsafe.Add(mBase, _consts[365]))
					...
					if v39 != 0 {
						...
						v41 = *(*int32)(unsafe.Add(mBase, _consts[365]))
...
L6:
	;
	*(*int32)(unsafe.Add(mBase, _consts[338])) = v85
	*(*int32)(unsafe.Add(mBase, _consts[363])) = v84
	v127 = *(*int32)(unsafe.Add(mBase, _consts[365]))
	v128 = int32(0)
...
L11:
	;
	v39 = int32(*(*uint8)(unsafe.Add(mBase, _consts[366])))
	if v39 != int32(1) {
		goto L7
	} else {
		goto L12
...
L12:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _consts[365]))
	if v43 == int32(0) {
		goto L7
	} else {
		goto L13
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	v56 = F_EventTriggerCommonSetup(m, l0, int32(2), int32(232295), v29)
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		v143 = v32
...
L17:
	;
	v69 = *(*int32)(unsafe.Add(mBase, _consts[365]))
	v70 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v69)+8)) = uint8(v70)
	v73 = *(*int32)(unsafe.Add(mBase, _consts[338]))
	v75 = *(*int32)(unsafe.Add(mBase, _consts[363]))
	goto L18
L18:
	;
...
L22:
	;
	*(*int32)(unsafe.Add(mBase, _consts[363])) = v82
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v85
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v84
	*(*int32)(unsafe.Add(mBase, uint32(v13)+20)) = v81
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v82
...
L23:
	;
	v98 = *(*int32)(unsafe.Add(mBase, _consts[365]))
	v99 = int32(0)
...
func F_FreeWaitEventSet(m *base.Module, l0 int32) {
	...
	if v3 != 0 {
		F_ResourceOwnerForget(m, v3, l0, int32(1607628))
		mBase = m.M
		v6 = m.ExcPending
		if v6 != 0 {
			return
