	...
	if l3 != 0 {
		...
		if v14 != v16 {
			...
			if v114 != 0 {
				...
				if v118 != 0 {
					...
					F_errfinish(m, int32(482172), int32(587), int32(105768))
					mBase = m.M
					v123 = m.ExcPending
					if v123 != 0 {
						return
			...
			if v18 != 0 {
				...
				if v127 != 0 {
					...
					F_errmsg_internal(m, int32(318411), int32(0))
					mBase = m.M
					v131 = m.ExcPending
					if v131 != 0 {
						return
					} else {
						F_errfinish(m, int32(482172), int32(589), int32(105768))
						mBase = m.M
						v136 = m.ExcPending
						if v136 != 0 {
							return
				...
				if v13&int32(1) != 0 {
					...
					if v41 != 0 {
						...
						if v153 != 0 {
							...
							F_errmsg_internal(m, int32(104796), int32(0))
							mBase = m.M
							v157 = m.ExcPending
							if v157 != 0 {
								return
							} else {
								F_errfinish(m, int32(482172), int32(601), int32(105768))
								mBase = m.M
								v162 = m.ExcPending
								if v162 != 0 {
									return
					...
					if v24 != 0 {
						...
						F_errmsg_internal(m, int32(103891), int32(0))
						mBase = m.M
						v28 = m.ExcPending
						if v28 != 0 {
							return
						} else {
							F_errfinish(m, int32(482172), int32(591), int32(105768))
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return
		...
		if v13&int32(1) != 0 {
			...
			if v140 != 0 {
				...
				F_errmsg_internal(m, int32(318446), int32(0))
				mBase = m.M
				v144 = m.ExcPending
				if v144 != 0 {
					return
				} else {
					F_errfinish(m, int32(482172), int32(596), int32(105768))
					mBase = m.M
					v149 = m.ExcPending
					if v149 != 0 {
						return
		...
		if v15 != 0 {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v18)+28)) = v26 + v6
				if l0 != 0 {
					F_ResourceOwnerRemember(m, l0, v18, int32(1599324))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	v56 = F_EventTriggerCommonSetup(m, l0, int32(2), int32(229349), v29)
	mBase = m.M
	v57 = m.ExcPending
	if v57 != 0 {
		v143 = v32
...
func F_FreeWaitEventSet(m *base.Module, l0 int32) {
	...
	if v3 != 0 {
		F_ResourceOwnerForget(m, v3, l0, int32(1599324))
		mBase = m.M
		v6 = m.ExcPending
		if v6 != 0 {
			return
