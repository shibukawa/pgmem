...
func F_AfterTriggerEndQuery(m *base.Module, l0 int32) {
	...
	var v148 int32
	_ = v148
	v9 = int32(_a_F_AfterTriggerEndQuery_0)
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[0]))
	v13 = *(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[1]))
	if v11 < v13 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v16 = *(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[2]))
	v19 = v16 + v11*int32(20)
	v22 = F_afterTriggerMarkEvents(m, v19, int32(_a_F_AfterTriggerEndQuery_1), int32(1))
	mBase = m.M
	v23 = m.ExcPending
	if v23 != 0 {
		goto L5
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[0])) = v148 - int32(1)
	return
L4:
	;
	v130 = *(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[2]))
	v132 = *(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[0]))
...
L11:
	;
	v45 = *(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[2]))
	v47 = *(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[0]))
...
L14:
	;
	v119 = F_afterTriggerMarkEvents(m, v50, int32(_a_F_AfterTriggerEndQuery_1), int32(1))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L5
...
L30:
	;
	v139 = *(*int32)(unsafe.Add(mBase, _c_F_AfterTriggerEndQuery[0]))
	v148 = v139
	goto L3
}
