					...
					if v39 != 0 {
						...
						if v42 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l0
							F_errmsg(m, int32(751464), v8+int32(16))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return int32(0)
							} else {
								*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(166033)
								F_errdetail(m, int32(639669), v8)
								mBase = m.M
								v53 = m.ExcPending
								if v53 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(526378), int32(5457), int32(401693))
									mBase = m.M
									v58 = m.ExcPending
									if v58 != 0 {
										return int32(0)
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1220])) = v114
	*(*int32)(unsafe.Add(mBase, _consts[1221])) = v115
...
L3:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v85))) = uint8(v93)
	v95 = int32(0)
	v97 = *(*int32)(unsafe.Add(mBase, _consts[1220]))
	v99 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1221])) = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[1220])) = v113
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v58
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v153 = *(*int32)(unsafe.Add(mBase, _consts[1222]))
	v155 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+48)) = v153
	F_errmsg_internal(m, int32(56618), v36+int32(48))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L9
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	...
	v191 = *(*int32)(unsafe.Add(mBase, _consts[1222]))
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v58
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	F_errfinish(m, int32(330753), int32(373), int32(251834))
	mBase = m.M
	v177 = m.ExcPending
	if v177 != 0 {
		goto L9
...
L36:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v58
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	F_errfinish(m, int32(330753), int32(388), int32(251834))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L9
...
L60:
	;
	v542 = int32(4560692)
	v544 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
	*(*int32)(unsafe.Add(mBase, _consts[1221])) = v544 + int32(1)
	goto L59
L61:
	;
	if v431 != 0 {
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v458
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v619 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
...
L150:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v458
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v971 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
...
L184:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v1143 = int32(1)
	v1145 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
...
L201:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v1257)+12)) = v1272
	v1276 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
	v1277 = int32(0)
...
L217:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v1330
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v1407 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
...
L219:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v1330
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	F_errfinish(m, int32(330753), int32(519), int32(251834))
	mBase = m.M
	v1396 = m.ExcPending
	if v1396 != 0 {
		goto L9
...
L221:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v1330
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v1423 = F_pstrdup(m, int32(223848))
	mBase = m.M
	v1424 = m.ExcPending
	if v1424 != 0 {
		goto L9
...
L233:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v1330
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v1524 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
...
L234:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v1330
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v1489 = *(*int32)(unsafe.Add(mBase, _consts[1221]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+16)) = l1
	F_errmsg(m, int32(749187), v36+int32(16))
	mBase = m.M
	v1497 = m.ExcPending
	if v1497 != 0 {
		goto L9
...
L235:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v1330
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	F_errfinish(m, int32(330753), int32(529), int32(251834))
	mBase = m.M
	v1511 = m.ExcPending
	if v1511 != 0 {
		goto L9
...
L237:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v1330
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	v1540 = F_pstrdup(m, int32(223848))
	mBase = m.M
	v1541 = m.ExcPending
	if v1541 != 0 {
		goto L9
...
L254:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v36)+104)) = v1330
	*(*int32)(unsafe.Add(mBase, uint32(v36)+108)) = v59
	F_errfinish(m, int32(330753), int32(549), int32(251834))
	mBase = m.M
	v1636 = m.ExcPending
	if v1636 != 0 {
		goto L9
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
	F_errmsg_internal(m, int32(192853), v8)
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L10
