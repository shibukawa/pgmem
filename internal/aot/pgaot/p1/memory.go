...
func F_GetMemoryChunkContext(m *base.Module, l0 int32) int32 {
	...
	v11 = *(*int32)(unsafe.Add(mBase, uint32(v4&int32(15)*int32(36))+uint32(_consts[1229])))
...
func F_MemoryContextSizeFailure(m *base.Module, l0 int32) {
	...
	if v10 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v5))) = l0
		F_errmsg_internal(m, int32(37340), v5)
		mBase = m.M
		v14 = m.ExcPending
		if v14 != 0 {
			return
		} else {
			F_errfinish(m, int32(492961), int32(1177), int32(364028))
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return
	...
	*(*int64)(unsafe.Add(mBase, uint32(v6)+32)) = v10
	...
	if v21 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6)+12)) = v30
		...
		v35 = F_pg_fprintf(m, v33, int32(750914), v6)
		mBase = m.M
		v36 = m.ExcPending
		if v36 != 0 {
			return
