...
func F_ExecGetTriggerNewSlot(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v5 == int32(0) {
		v8 = int32(_a_F_ExecGetTriggerNewSlot_0)
		v9 = *(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerNewSlot[0]))
		v10 = *(*int32)(unsafe.Add(mBase, uint32(l1)+8))
		v12 = *(*int32)(unsafe.Add(mBase, uint32(l0)+100))
		*(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerNewSlot[0])) = v12
		...
		if v18 != 0 {
			...
			if v20 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerNewSlot[0])) = v9
				v24 = v19
				return v24
			}
		}
...
L42:
	;
	v126 = int32(_a_F_ExecGetTriggerResultRel_0)
	v127 = *(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerResultRel[0]))
	v129 = *(*int32)(unsafe.Add(mBase, uint32(l0)+100))
	*(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerResultRel[0])) = v129
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ExecGetTriggerResultRel[0])) = v127
	v149 = v132
	goto L1
}
...
L18:
	...
	v38 = *(*int32)(unsafe.Add(mBase, uint32(v32+v30&int32(_a_F_FreeTriggerDesc_0)<<(uint(int32(2))%32))))
	F_pfree(m, v38)
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
...
func F_trigger_out(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_trigger_out_0)
			F_errmsg(m, int32(_a_F_trigger_out_1), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_trigger_out_2), int32(366), int32(_a_F_trigger_out_3))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
