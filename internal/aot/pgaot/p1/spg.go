...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = int32(base.Ui32(v147) >> (uint(int32(2)) % 32))
	F_errmsg_internal(m, int32(426038), v17)
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L12
...
L38:
	;
	F_errfinish(m, int32(515252), int32(171), int32(368265))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L12
...
func F_spg_xlog_startup(m *base.Module) {
	...
	v8 = F_AllocSetContextCreateInternal(m, v3, int32(65675), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return
