...
L2:
	;
	v111 = *(*float64)(unsafe.Add(mBase, _consts[599]))
...
L3:
	;
	v75 = int32(*(*uint8)(unsafe.Add(mBase, _consts[600])))
	if l3 != 0 {
		goto L17
	} else {
		goto L18
...
L5:
	;
	v48 = int32(*(*uint8)(unsafe.Add(mBase, _consts[600])))
	v52 = l7 + (v48 ^ int32(1))
	goto L4
L6:
	;
...
L7:
	...
	v44 = *(*float64)(unsafe.Add(mBase, _consts[599]))
	v350 = float64(1)
	v351 = l7
	v352 = v42
...
L13:
	;
	v58 = *(*float64)(unsafe.Add(mBase, _consts[601]))
	if l3 != 0 {
		goto L14
	} else {
		goto L15
...
L19:
	;
	v84 = *(*float64)(unsafe.Add(mBase, _consts[601]))
	if l3 != 0 {
		goto L20
	} else {
		goto L21
...
L79:
	;
	v313 = *(*float64)(unsafe.Add(mBase, _consts[599]))
...
L92:
	...
	v337 = *(*float64)(unsafe.Add(mBase, _consts[602]))
	v338 = base.F64_mul(v335, v337)
	v342 = *(*float64)(unsafe.Add(mBase, _consts[603]))
	v350 = l5
	v351 = v101
