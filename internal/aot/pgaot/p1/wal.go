...
func F_GetWalRcvFlushRecPtr(m *base.Module, l0 int32, l1 int32) int64 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+1456)) = int32(1)
	v13 = v8 + int32(1456)
	if v9 != 0 {
		F_s_lock(m, v13, int32(495041), int32(337), int32(206789))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int64(0)
...
func F_WalRcvDie(m *base.Module, l0 int32, l1 int32) {
	...
	if v8 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v4)+1456)) = int32(1)
		if v9 != 0 {
			F_s_lock(m, v4+int32(1456), int32(495604), int32(792), int32(399246))
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return
				...
				*(*int64)(unsafe.Add(mBase, uint32(v4))) = int64(4294967295)
				...
				if v30 != 0 {
					...
					v32 = *(*int32)(unsafe.Add(mBase, _consts[672]))
					if v32 != 0 {
						v34 = *(*int32)(unsafe.Add(mBase, _consts[656]))
...
func F_WalRcvStreaming(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+1456)) = int32(1)
	v11 = v6 + int32(1456)
	if v7 != 0 {
		F_s_lock(m, v11, int32(495041), int32(133), int32(335729))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
			...
			if v21 != int32(1) {
				...
				if v26-v24 < int64(11) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
					if v30 != 0 {
						F_s_lock(m, v11, int32(495041), int32(154), int32(335729))
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return int32(0)
...
func F_WalSndKeepalive(m *base.Module, l0 int32, l1 int64) {
	...
	if v8 != 0 {
		...
		if v7 != 0 {
			F_errmsg_internal(m, int32(344172), int32(0))
			mBase = m.M
			v12 = m.ExcPending
			if v12 != 0 {
				return
			} else {
				F_errfinish(m, int32(495936), int32(4087), int32(344202))
				mBase = m.M
				v17 = m.ExcPending
				if v17 != 0 {
					return
					...
					v18 = int32(4426160)
					v19 = *(*int32)(unsafe.Add(mBase, _consts[712]))
					v20 = int32(0)
					*(*uint8)(unsafe.Add(mBase, uint32(v19))) = uint8(v20)
					*(*int32)(unsafe.Add(mBase, _consts[713])) = v20
					*(*int32)(unsafe.Add(mBase, _consts[714])) = v20
					F_enlargeStringInfo(m, int32(4426160), int32(1))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return
						...
						v30 = int32(4426164)
						v31 = *(*int32)(unsafe.Add(mBase, _consts[714]))
						v32 = int32(4426160)
						v33 = *(*int32)(unsafe.Add(mBase, _consts[712]))
						v35 = int32(107)
						*(*uint8)(unsafe.Add(mBase, uint32(v31+v33))) = uint8(v35)
						*(*int32)(unsafe.Add(mBase, _consts[714])) = v31 + int32(1)
						v42 = *(*int64)(unsafe.Add(mBase, _consts[710]))
						...
						if v46 != 0 {
							...
							v48 = *(*int32)(unsafe.Add(mBase, _consts[714]))
							...
							*(*int32)(unsafe.Add(mBase, _consts[714])) = v48 + int32(8)
							v98 = m.G0
							v99 = int32(16)
							v100 = v98 - v99
							m.G0 = v100
							...
							F_enlargeStringInfo(m, int32(4426160), int32(8))
							mBase = m.M
							v116 = m.ExcPending
							if v116 != 0 {
								return
								...
								v117 = int32(4426164)
								v118 = *(*int32)(unsafe.Add(mBase, _consts[714]))
								v119 = int32(4426160)
								v120 = *(*int32)(unsafe.Add(mBase, _consts[712]))
								v122 = int64(56)
								v124 = int64(65280)
								v126 = int64(40)
								v129 = int64(16711680)
								...
								*(*int32)(unsafe.Add(mBase, _consts[714])) = v118 + int32(8)
								...
								if v165 != 0 {
									...
									v166 = int32(4426164)
									v167 = *(*int32)(unsafe.Add(mBase, _consts[714]))
									v168 = int32(4426160)
									v169 = *(*int32)(unsafe.Add(mBase, _consts[712]))
									*(*uint8)(unsafe.Add(mBase, uint32(v167+v169))) = uint8(v1)
									v174 = v167 + int32(1)
									*(*int32)(unsafe.Add(mBase, _consts[714])) = v174
									v178 = *(*int32)(unsafe.Add(mBase, _consts[712]))
									v180 = *(*int32)(unsafe.Add(mBase, _consts[701]))
									...
									if v183 != 0 {
										...
										if v1 != 0 {
											v185 = int32(1)
											*(*uint8)(unsafe.Add(mBase, _consts[702])) = uint8(v185)
										} else {
										}
										return
									}
...
L1:
	;
	*(*int64)(unsafe.Add(mBase, _consts[698])) = v24 + v23*int64(1000000) - int64(946684800000000)
	v35 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[702])) = uint8(v35)
	v46 = int64(0)
	goto L4
L2:
	;
...
L4:
	;
	v49 = *(*int32)(unsafe.Add(mBase, _consts[516]))
...
L9:
	;
	v57 = *(*int32)(unsafe.Add(mBase, _consts[703]))
	if v57 != 0 {
		goto L12
	} else {
		goto L13
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, _consts[703])) = int32(0)
...
L17:
	;
	v69 = int32(*(*uint8)(unsafe.Add(mBase, _consts[704])))
	if v69 == int32(0) {
		goto L19
	} else {
		goto L20
...
L19:
	;
	v84 = *(*int32)(unsafe.Add(mBase, _consts[701]))
...
L20:
	;
	v73 = int32(*(*uint8)(unsafe.Add(mBase, _consts[705])))
	if v73 == int32(0) {
		goto L19
	} else {
		goto L21
...
L21:
	;
	v77 = *(*int32)(unsafe.Add(mBase, _consts[701]))
...
L24:
	;
	v96 = *(*int32)(unsafe.Add(mBase, _consts[701]))
...
L28:
	;
	v93 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[706])) = uint8(v93)
	goto L24
L29:
	;
	goto L24
...
L31:
	;
	v101 = int32(*(*uint8)(unsafe.Add(mBase, _consts[706])))
	if v101 == int32(0) {
		goto L32
	} else {
		goto L33
...
L32:
	;
	v187 = *(*int64)(unsafe.Add(mBase, _consts[698]))
	if v187 <= int64(0) {
		goto L61
	} else {
		goto L62
...
L33:
	;
	v105 = *(*int32)(unsafe.Add(mBase, _consts[701]))
...
L35:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[707]))
...
L36:
	;
	v151 = *(*int32)(unsafe.Add(mBase, _consts[708]))
	if v151 == int32(0) {
		goto L32
	} else {
		goto L49
...
L39:
	;
	v119 = *(*int32)(unsafe.Add(mBase, _consts[709]))
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v119
	F_errmsg_internal(m, int32(214558), v12)
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L10
...
L41:
	;
	v130 = *(*int32)(unsafe.Add(mBase, _consts[707]))
...
L42:
	;
	F_errfinish(m, int32(495936), int32(2869), int32(234939))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L10
...
L45:
	;
	F_s_lock(m, v130+int32(76), int32(495936), int32(3869), int32(353999))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L10
...
L53:
	;
	v164 = int32(*(*uint8)(unsafe.Add(mBase, _consts[706])))
	if v164 == int32(0) {
		goto L54
	} else {
		goto L55
...
L54:
	;
	v178 = int32(*(*uint8)(unsafe.Add(mBase, _consts[702])))
	if v178 != 0 {
		goto L32
	} else {
		goto L59
...
L55:
	;
	v168 = *(*int64)(unsafe.Add(mBase, _consts[710]))
	if v168 != v162 {
		goto L54
	} else {
		goto L56
...
L56:
	;
	v171 = *(*int32)(unsafe.Add(mBase, _consts[701]))
...
L62:
	;
	v191 = *(*int32)(unsafe.Add(mBase, _consts[699]))
	if v191 <= int32(0) {
		goto L61
	} else {
		goto L63
...
L63:
	;
	v195 = *(*int64)(unsafe.Add(mBase, _consts[711]))
...
L66:
	;
	v217 = int32(*(*uint8)(unsafe.Add(mBase, _consts[702])))
	if v217 != 0 {
		goto L61
	} else {
		goto L71
...
L69:
	;
	F_errfinish(m, int32(495936), int32(2789), int32(67766))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L10
...
L71:
	;
	v219 = *(*int64)(unsafe.Add(mBase, _consts[711]))
...
L73:
	;
	v232 = *(*int32)(unsafe.Add(mBase, _consts[701]))
...
L76:
	;
	v257 = int32(*(*uint8)(unsafe.Add(mBase, _consts[704])))
	if v257 != 0 {
		goto L83
	} else {
		goto L84
...
L77:
	;
	v248 = *(*int32)(unsafe.Add(mBase, _consts[701]))
...
L78:
	;
	v238 = int32(*(*uint8)(unsafe.Add(mBase, _consts[706])))
...
L79:
	;
	v244 = int32(*(*uint8)(unsafe.Add(mBase, _consts[705])))
	if v244 == int32(0) {
		goto L76
	} else {
		goto L80
...
L86:
	;
	v277 = int32(10000)
	v279 = *(*int32)(unsafe.Add(mBase, _consts[699]))
	if v279 <= int32(0) {
		v314 = v277
		goto L87
	} else {
...
L88:
	;
	v283 = *(*int64)(unsafe.Add(mBase, _consts[698]))
	if v283 <= int64(0) {
		v314 = v277
		goto L87
	} else {
...
L89:
	;
	v287 = int32(*(*uint8)(unsafe.Add(mBase, _consts[702])))
...
L106:
	;
	v354 = *(*int32)(unsafe.Add(mBase, _consts[701]))
...
func F_WalSndUpdateProgress(m *base.Module, l0 int32, l1 int64, l2 int32, l3 int32) {
	...
	if v29 != int32(1) {
		...
		v33 = *(*int64)(unsafe.Add(mBase, _consts[685]))
		if base.B2i32(base.I64_extend_i32_s(int32(1000))*int64(1000) <= v28-v33) == int32(0) {
		} else {
			v43 = int32(*(*uint8)(unsafe.Add(mBase, _consts[686])))
			if v43 != int32(1) {
			} else {
				v47 = *(*int32)(unsafe.Add(mBase, _consts[687]))
				v48 = *(*int64)(unsafe.Add(mBase, uint32(v47)))
				if v48 == l1 {
				} else {
					*(*int64)(unsafe.Add(mBase, uint32(v47))) = l1
					v52 = v47 + int32(8)
					v53 = *(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[688])))
					v57 = base.I32_rem_s(v53+int32(1), int32(8192))
					v58 = *(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[689])))
					if v57 == v58 {
						v62 = v52 + v57<<(uint(int32(4))%32)
						v63 = *(*int64)(unsafe.Add(mBase, uint32(v62)))
						*(*int64)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[690]))) = v63
						v67 = *(*int64)(unsafe.Add(mBase, uint32(v62)+8))
						*(*int64)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[691]))) = v67
						*(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[689]))) = int32(-1)
					} else {
					}
					v74 = *(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[692])))
					if v74 == v57 {
						v80 = v52 + v57<<(uint(int32(4))%32)
						v81 = *(*int64)(unsafe.Add(mBase, uint32(v80)))
						*(*int64)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[693]))) = v81
						v85 = *(*int64)(unsafe.Add(mBase, uint32(v80)+8))
						*(*int64)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[694]))) = v85
						*(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[692]))) = int32(-1)
					} else {
					}
					v92 = *(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[695])))
					if v92 == v57 {
						v98 = v52 + v57<<(uint(int32(4))%32)
						v99 = *(*int64)(unsafe.Add(mBase, uint32(v98)))
						*(*int64)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[696]))) = v99
						v103 = *(*int64)(unsafe.Add(mBase, uint32(v98)+8))
						*(*int64)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[697]))) = v103
						*(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[695]))) = int32(-1)
					} else {
					}
					v108 = int32(4)
					*(*int64)(unsafe.Add(mBase, uint32(v52+v53<<(uint(v108)%32)))) = l1
					v112 = *(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[688])))
					*(*int64)(unsafe.Add(mBase, uint32(v47+v112<<(uint(v108)%32))+16)) = v28
					*(*int32)(unsafe.Add(mBase, uint32(v47)+uint32(_consts[688]))) = v57
				}
			}
			*(*int64)(unsafe.Add(mBase, _consts[685])) = v28
		}
	}
	if l3 == int32(0) {
		if v29 != 0 {
			...
			v163 = *(*int64)(unsafe.Add(mBase, _consts[698]))
			v165 = *(*int32)(unsafe.Add(mBase, _consts[699]))
		...
		v135 = *(*int32)(unsafe.Add(mBase, _consts[532]))
		if v135 <= int32(0) {
			if v29 != 0 {
				return
			} else {
			...
			if v139 < int32(2) {
				...
				v143 = *(*int32)(unsafe.Add(mBase, _consts[700]))
				...
				if v144&int32(2) == int32(0) {
					...
					if v151 != 0 {
						...
						v153 = *(*int32)(unsafe.Add(mBase, _consts[701]))
						...
						if v156 != 0 {
							...
							if v155 != 0 {
								...
								v158 = *(*int32)(unsafe.Add(mBase, _consts[701]))
