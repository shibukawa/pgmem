...
func F_GetWalRcvFlushRecPtr(m *base.Module, l0 int32, l1 int32) int64 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+1456)) = int32(1)
	v13 = v8 + int32(1456)
	if v9 != 0 {
		F_s_lock(m, v13, int32(514473), int32(337), int32(215752))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int64(0)
...
func F_WalRcvDie(m *base.Module, l0 int32, l1 int32) {
	...
	if v8 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v4)+1456)) = int32(1)
		if v9 != 0 {
			F_s_lock(m, v4+int32(1456), int32(515166), int32(792), int32(414865))
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return
...
func F_WalRcvStreaming(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+1456)) = int32(1)
	v11 = v6 + int32(1456)
	if v7 != 0 {
		F_s_lock(m, v11, int32(514473), int32(133), int32(349594))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
			...
			if v21 != int32(1) {
				...
				if v26-v24 < int64(11) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
					if v30 != 0 {
						F_s_lock(m, v11, int32(514473), int32(154), int32(349594))
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return int32(0)
...
func F_WalSndKeepalive(m *base.Module, l0 int32, l1 int64) {
	...
	if v8 != 0 {
		...
		if v7 != 0 {
			F_errmsg_internal(m, int32(358426), int32(0))
			mBase = m.M
			v12 = m.ExcPending
			if v12 != 0 {
				return
			} else {
				F_errfinish(m, int32(515498), int32(4087), int32(358456))
				mBase = m.M
				v17 = m.ExcPending
				if v17 != 0 {
					return
						...
						*(*int32)(unsafe.Add(mBase, _consts[717])) = v31 + int32(1)
						...
						if v46 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[717])) = v48 + int32(8)
							...
							F_enlargeStringInfo(m, int32(4459472), int32(8))
							mBase = m.M
							v116 = m.ExcPending
							if v116 != 0 {
								return
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v119
	F_errmsg_internal(m, int32(223886), v12)
	mBase = m.M
	v123 = m.ExcPending
	if v123 != 0 {
		goto L10
...
L42:
	;
	F_errfinish(m, int32(515498), int32(2869), int32(244801))
	mBase = m.M
	v128 = m.ExcPending
	if v128 != 0 {
		goto L10
...
L45:
	;
	F_s_lock(m, v130+int32(76), int32(515498), int32(3869), int32(368433))
	mBase = m.M
	v143 = m.ExcPending
	if v143 != 0 {
		goto L10
...
L68:
	;
	F_errmsg(m, int32(71333), int32(0))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L10
...
L69:
	;
	F_errfinish(m, int32(515498), int32(2789), int32(73126))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L10
