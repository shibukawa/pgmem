...
L17:
	;
	F_errfinish(m, int32(493985), int32(2098), int32(73785))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L1
...
L66:
	;
	F_errfinish(m, int32(493870), int32(212), int32(464804))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L89:
	;
	F_errmsg(m, int32(376561), int32(0))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L1
...
L90:
	;
	F_errfinish(m, int32(493870), int32(262), int32(464804))
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		goto L1
...
L109:
	;
	F_errfinish(m, int32(493870), int32(278), int32(464804))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L1
...
L112:
	;
	F_errmsg(m, int32(373970), int32(0))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L1
...
L113:
	;
	F_errfinish(m, int32(493870), int32(287), int32(464804))
	mBase = m.M
	v362 = m.ExcPending
	if v362 != 0 {
		goto L1
...
L117:
	;
	F_errfinish(m, int32(493870), int32(292), int32(464804))
	mBase = m.M
	v378 = m.ExcPending
	if v378 != 0 {
		goto L1
...
L121:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+80)) = v89
	F_errmsg(m, int32(298080), v19+int32(80))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L1
...
L122:
	;
	F_errfinish(m, int32(493870), int32(180), int32(464804))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L1
...
L126:
	;
	F_errfinish(m, int32(493870), int32(616), int32(99915))
	mBase = m.M
	v419 = m.ExcPending
	if v419 != 0 {
		goto L1
...
L146:
	;
	F_errfinish(m, int32(493870), int32(625), int32(99915))
	mBase = m.M
	v469 = m.ExcPending
	if v469 != 0 {
		goto L1
...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+96)) = v477
	F_errmsg(m, int32(725646), v19+int32(96))
	mBase = m.M
	v483 = m.ExcPending
	if v483 != 0 {
		goto L1
...
L150:
	;
	F_errfinish(m, int32(493870), int32(633), int32(99915))
	mBase = m.M
	v488 = m.ExcPending
	if v488 != 0 {
		goto L1
...
L157:
	;
	F_errfinish(m, int32(493870), int32(640), int32(99915))
	mBase = m.M
	v580 = m.ExcPending
	if v580 != 0 {
		goto L1
...
L303:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = v1242
	F_errmsg(m, int32(681339), v19+int32(32))
	mBase = m.M
	v1251 = m.ExcPending
	if v1251 != 0 {
		goto L1
...
L304:
	;
	F_errfinish(m, int32(493870), int32(568), int32(348842))
	mBase = m.M
	v1256 = m.ExcPending
	if v1256 != 0 {
		goto L1
...
L307:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v1264
	F_errmsg(m, int32(681193), v19+int32(16))
	mBase = m.M
	v1273 = m.ExcPending
	if v1273 != 0 {
		goto L1
...
L308:
	;
	F_errfinish(m, int32(493870), int32(575), int32(348842))
	mBase = m.M
	v1278 = m.ExcPending
	if v1278 != 0 {
		goto L1
...
L312:
	;
	F_errfinish(m, int32(493870), int32(644), int32(99915))
	mBase = m.M
	v1294 = m.ExcPending
	if v1294 != 0 {
		goto L1
...
L315:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+52)) = v1307 + int32(1)
	F_errmsg(m, int32(681268), v19+int32(48))
	mBase = m.M
	v1317 = m.ExcPending
	if v1317 != 0 {
		goto L1
...
L316:
	;
	F_errfinish(m, int32(493870), int32(418), int32(376594))
	mBase = m.M
	v1322 = m.ExcPending
	if v1322 != 0 {
		goto L1
...
L319:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+68)) = v1335 + int32(1)
	F_errmsg(m, int32(681395), v19-int32(-64))
	mBase = m.M
	v1345 = m.ExcPending
	if v1345 != 0 {
		goto L1
...
L320:
	;
	F_errhint(m, int32(632927), int32(0))
	mBase = m.M
	v1349 = m.ExcPending
	if v1349 != 0 {
		goto L1
...
L321:
	;
	F_errfinish(m, int32(493870), int32(425), int32(376594))
	mBase = m.M
	v1354 = m.ExcPending
	if v1354 != 0 {
		goto L1
...
L325:
	;
	F_errfinish(m, int32(493870), int32(587), int32(348842))
	mBase = m.M
	v1372 = m.ExcPending
	if v1372 != 0 {
		goto L1
...
func F_tidout(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v10 | v11<<(uint(v14)%32)
	v22 = F_pg_snprintf(m, v7+v14, int32(32), int32(671499), v7)
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		return int32(0)
...
L17:
	;
	F_errfinish(m, int32(499149), int32(590), int32(89130))
	mBase = m.M
	v62 = m.ExcPending
	if v62 != 0 {
		goto L15
...
func F_tokenize_auth_file(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v26)+40)) = v26 + int32(24)
	...
	v49 = F_AllocSetContextCreateInternal(m, v44, int32(386863), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L1
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v81))) = v76
	v297 = F_psprintf(m, int32(299777), v81)
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L1
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v81)+16)) = v76
	F_errmsg(m, int32(299777), v81+int32(16))
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L1
...
L54:
	;
	F_errfinish(m, int32(500434), int32(769), int32(386863))
	mBase = m.M
	v292 = m.ExcPending
	if v292 != 0 {
		goto L1
...
L63:
	;
	F_errdetail(m, int32(583600), int32(0))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L11
...
L65:
	;
	F_errfinish(m, int32(498534), int32(221), int32(305360))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L11
												...
												if v148 != 0 {
													...
													if v152 != 0 {
														...
														if v155 != 0 {
															...
															F_errfinish(m, int32(493621), int32(596), int32(207585))
															mBase = m.M
															v160 = m.ExcPending
															if v160 != 0 {
																return int32(0)
					...
					if l5 == int32(0) {
						...
						if v56 != 0 {
							...
							if v59 != 0 {
								...
								if v52 == int32(78) {
									F_errmsg(m, int32(520666), int32(0))
									mBase = m.M
									v116 = m.ExcPending
									if v116 != 0 {
										return int32(0)
										...
										if v118 != 0 {
											...
											F_errfinish(m, int32(493621), int32(512), int32(207585))
											mBase = m.M
											v123 = m.ExcPending
											if v123 != 0 {
												return int32(0)
									...
									F_errmsg(m, int32(520705), int32(0))
									mBase = m.M
									v65 = m.ExcPending
									if v65 != 0 {
										return int32(0)
										...
										if v67 != 0 {
											...
											F_errfinish(m, int32(493621), int32(517), int32(207585))
											mBase = m.M
											v72 = m.ExcPending
											if v72 != 0 {
												return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v15))) = l3
				...
				if v105 != 0 {
					...
					if v107 != 0 {
						...
						F_errfinish(m, int32(493621), int32(485), int32(207585))
						mBase = m.M
						v112 = m.ExcPending
						if v112 != 0 {
							return int32(0)
														...
														*(*int32)(unsafe.Add(mBase, uint32(v19))) = v75
														...
														if v83 != 0 {
															...
															if v85 != 0 {
																...
																F_errfinish(m, int32(493621), int32(1004), int32(118433))
																mBase = m.M
																v90 = m.ExcPending
																if v90 != 0 {
																	return int32(0)
...
L123:
	;
	F_errmsg(m, int32(517992), int32(0))
	mBase = m.M
	v459 = m.ExcPending
	if v459 != 0 {
		goto L1
...
L125:
	;
	F_errfinish(m, int32(498652), int32(2066), int32(410821))
	mBase = m.M
	v468 = m.ExcPending
	if v468 != 0 {
		goto L1
...
L129:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+48)) = v491
	F_errmsg(m, int32(517946), v20+int32(48))
	mBase = m.M
	v497 = m.ExcPending
	if v497 != 0 {
		goto L1
...
L133:
	;
	F_errfinish(m, int32(498652), int32(2076), int32(410821))
	mBase = m.M
	v502 = m.ExcPending
	if v502 != 0 {
		goto L1
...
L138:
	;
	F_errfinish(m, int32(498652), int32(2226), int32(410821))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
...
L161:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v605
	v611 = F_pg_snprintf(m, v20+int32(96), int32(32), int32(488497), v20)
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L1
...
L167:
	;
	F_errmsg(m, int32(306423), int32(0))
	mBase = m.M
	v660 = m.ExcPending
	if v660 != 0 {
		goto L1
...
L170:
	;
	F_errfinish(m, int32(498652), int32(2138), int32(410821))
	mBase = m.M
	v670 = m.ExcPending
	if v670 != 0 {
		goto L1
...
L63:
	;
	F_errmsg(m, int32(445661), int32(0))
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L38
...
L65:
	;
	F_errfinish(m, int32(498782), int32(883), int32(81343))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L38
...
L118:
	;
	F_errfinish(m, int32(498782), int32(936), int32(271034))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L38
...
L123:
	;
	F_errfinish(m, int32(498782), int32(944), int32(271034))
	mBase = m.M
	v538 = m.ExcPending
	if v538 != 0 {
		goto L38
...
L128:
	;
	F_errfinish(m, int32(498782), int32(979), int32(271034))
	mBase = m.M
	v559 = m.ExcPending
	if v559 != 0 {
		goto L38
...
L131:
	;
	F_errmsg(m, int32(445511), int32(0))
	mBase = m.M
	v570 = m.ExcPending
	if v570 != 0 {
		goto L38
...
L133:
	;
	F_errfinish(m, int32(498782), int32(985), int32(271034))
	mBase = m.M
	v580 = m.ExcPending
	if v580 != 0 {
		goto L38
...
L136:
	;
	F_errmsg(m, int32(445465), int32(0))
	mBase = m.M
	v591 = m.ExcPending
	if v591 != 0 {
		goto L38
...
L138:
	;
	F_errfinish(m, int32(498782), int32(991), int32(271034))
	mBase = m.M
	v601 = m.ExcPending
	if v601 != 0 {
		goto L38
...
L141:
	;
	F_errmsg(m, int32(445558), int32(0))
	mBase = m.M
	v612 = m.ExcPending
	if v612 != 0 {
		goto L38
...
L143:
	;
	F_errfinish(m, int32(498782), int32(997), int32(271034))
	mBase = m.M
	v622 = m.ExcPending
	if v622 != 0 {
		goto L38
...
L145:
	;
	F_errmsg_internal(m, int32(417071), int32(0))
	mBase = m.M
	v630 = m.ExcPending
	if v630 != 0 {
		goto L38
...
L146:
	;
	F_errfinish(m, int32(498782), int32(1019), int32(271034))
	mBase = m.M
	v635 = m.ExcPending
	if v635 != 0 {
		goto L38
...
L149:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v643
	F_errmsg(m, int32(415771), v14+int32(32))
	mBase = m.M
	v649 = m.ExcPending
	if v649 != 0 {
		goto L38
...
L151:
	;
	F_errfinish(m, int32(498782), int32(139), int32(360074))
	mBase = m.M
	v657 = m.ExcPending
	if v657 != 0 {
		goto L38
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = v16
		...
		if v24 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+28)) = int32(7121)
			*(*int32)(unsafe.Add(mBase, uint32(v10)+24)) = int32(7122)
			*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(7123)
			*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = int32(7124)
			*(*int32)(unsafe.Add(mBase, uint32(v10)+12)) = int32(7125)
			v43 = int32(256)
...
L20:
	;
	F_errsave_finish(m, v25, int32(495345), int32(215), int32(275568))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L1
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v90
	F_errmsg(m, int32(674048), v18+int32(-48))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L1
...
L28:
	;
	F_errsave_finish(m, v25, int32(495345), int32(221), int32(275568))
	mBase = m.M
	v113 = m.ExcPending
	if v113 != 0 {
		goto L1
...
L140:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v650
	F_errmsg(m, int32(674240), v18+int32(-32))
	mBase = m.M
	v680 = m.ExcPending
	if v680 != 0 {
		goto L1
...
L141:
	;
	F_errsave_finish(m, v25, int32(495345), int32(274), int32(275568))
	mBase = m.M
	v685 = m.ExcPending
	if v685 != 0 {
		goto L1
...
L161:
	;
	F_errmsg_internal(m, int32(327861), int32(0))
	mBase = m.M
	v830 = m.ExcPending
	if v830 != 0 {
		goto L1
...
L162:
	;
	F_errfinish(m, int32(495345), int32(292), int32(275568))
	mBase = m.M
	v835 = m.ExcPending
	if v835 != 0 {
		goto L1
	...
	if v11 == v2 {
		...
		if v18 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v18
			v25 = F_pg_sprintf(m, v8+int32(16), int32(488506), v8)
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return int32(0)
						...
						if v34 != int32(1) {
							...
							if v64 != 0 {
								...
								if v68 != 0 {
									...
									F_errfinish(m, int32(495536), int32(69), int32(304969))
									mBase = m.M
									v73 = m.ExcPending
									if v73 != 0 {
										return
			...
			if v51 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = l2
				...
				if v55 != 0 {
					...
					F_errfinish(m, int32(495536), int32(57), int32(304969))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return
...
L106:
	;
	F_errfinish(m, int32(326869), int32(630), int32(311966))
	mBase = m.M
	v484 = m.ExcPending
	if v484 != 0 {
		goto L23
					...
					if v53 != 0 {
						...
						if v55 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v54
							F_errmsg(m, int32(304564), v8+int32(16))
							mBase = m.M
							v61 = m.ExcPending
							if v61 != 0 {
								return int32(0)
								...
								if v64 != 0 {
									...
									F_errfinish(m, int32(499114), int32(280), int32(371930))
									mBase = m.M
									v69 = m.ExcPending
									if v69 != 0 {
										return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v33
						...
						if v38 != 0 {
							...
							if v41 != 0 {
								...
								F_errfinish(m, int32(499114), int32(274), int32(371930))
								mBase = m.M
								v46 = m.ExcPending
								if v46 != 0 {
									return int32(0)
