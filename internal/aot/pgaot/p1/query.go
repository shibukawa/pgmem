...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v15
	F_errmsg_internal(m, int32(447247), v8)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L1
...
L41:
	;
	F_errfinish(m, int32(488832), int32(3077), int32(497071))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v15
	F_errmsg_internal(m, int32(447218), v8+int32(16))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L1
...
L44:
	;
	F_errfinish(m, int32(488832), int32(3080), int32(497071))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L1
