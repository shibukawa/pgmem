...
L85:
	;
	F_errfinish(m, int32(498380), int32(3077), int32(245416))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v62
	F_errmsg(m, int32(189897), v15+int32(16))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(498380), int32(3097), int32(245416))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L1
