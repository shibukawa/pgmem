...
func F_timetz_at_local(m *base.Module, l0 int32) int32 {
	...
	if v10 != 0 {
		...
		v11 = F_DirectFunctionCall2Coll(m, int32(1293), int32(0), v7, v2)
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
...
L18:
	;
	v65 = v15 + int32(28)
	v72 = *(*int32)(unsafe.Add(mBase, _c_F_timetz_part_common[0]))
	if v72 != 0 {
		goto L21
	} else {
		goto L22
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_timetz_part_common[0])) = v116
...
L23:
	...
	v83 = int32(_a_F_timetz_part_common_0)
	v85 = int32(_a_F_timetz_part_common_1)
	goto L25
L24:
	;
	goto L23
...
L38:
	;
	v137 = v15 + int32(28)
	v144 = *(*int32)(unsafe.Add(mBase, _c_F_timetz_part_common[1]))
	if v144 != 0 {
		goto L43
	} else {
		goto L44
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_timetz_part_common[1])) = v188
...
L45:
	...
	v155 = int32(_a_F_timetz_part_common_2)
	v157 = int32(_a_F_timetz_part_common_3)
	goto L47
L46:
	;
	goto L45
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v62
	F_errmsg(m, int32(_a_F_timetz_part_common_4), v15)
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L1
...
L85:
	;
	F_errfinish(m, int32(_a_F_timetz_part_common_5), int32(3077), int32(_a_F_timetz_part_common_6))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v62
	F_errmsg(m, int32(_a_F_timetz_part_common_7), v15+int32(16))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(_a_F_timetz_part_common_5), int32(3097), int32(_a_F_timetz_part_common_6))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L1
