...
func F_timetz_at_local(m *base.Module, l0 int32) int32 {
	...
	v6 = *(*int32)(unsafe.Add(mBase, _consts[1068]))
...
L18:
	;
	v65 = v15 + int32(28)
	v72 = *(*int32)(unsafe.Add(mBase, _consts[1071]))
	if v72 != 0 {
		goto L21
	} else {
		goto L22
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1071])) = v116
...
L38:
	;
	v137 = v15 + int32(28)
	v144 = *(*int32)(unsafe.Add(mBase, _consts[1072]))
	if v144 != 0 {
		goto L43
	} else {
		goto L44
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1072])) = v188
...
L85:
	;
	F_errfinish(m, int32(524503), int32(3077), int32(258759))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v62
	F_errmsg(m, int32(201047), v15+int32(16))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(524503), int32(3097), int32(258759))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L1
