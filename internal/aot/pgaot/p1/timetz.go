...
func F_timetz_part_common(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v22 != 0 {
		...
		if v61 != 0 {
			...
			v63 = v16 + int32(28)
			v67 = Fn13825(m, v60, v63, int32(_a_F_timetz_part_common_0), int32(_a_F_timetz_part_common_1), int32(_a_F_timetz_part_common_2))
			mBase = m.M
			if v67 == int32(31) {
				v73 = Fn13825(m, v60, v63, int32(_a_F_timetz_part_common_3), int32(_a_F_timetz_part_common_4), int32(_a_F_timetz_part_common_5))
				mBase = m.M
				v74 = v73
			} else {
				v74 = v67
