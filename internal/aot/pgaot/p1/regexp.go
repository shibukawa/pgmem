	...
	if v6 <= int32(0) {
		...
		if v22 < v20 {
			...
			if v60 != 0 {
				...
				F_errmsg_internal(m, int32(262981), int32(0))
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(521411), int32(1878), int32(104544))
					mBase = m.M
					v69 = m.ExcPending
					if v69 != 0 {
						return int32(0)
			...
			if v10 != 0 {
				...
				v41 = F_DirectFunctionCall3Coll(m, int32(1496), int32(0), v38, v20+int32(1), v24)
				mBase = m.M
				v42 = m.ExcPending
				if v42 != 0 {
					return int32(0)
		...
		if v17 < int32(0) {
			...
			if v47 != 0 {
				...
				F_errmsg_internal(m, int32(263013), int32(0))
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(521411), int32(1874), int32(104544))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
						...
						if v31 != int32(1) {
							...
							if v98 != 0 {
								...
								if v101 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(718595)
									F_errmsg(m, int32(260110), v10)
									mBase = m.M
									v106 = m.ExcPending
									if v106 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(521411), int32(1344), int32(418889))
										mBase = m.M
										v111 = m.ExcPending
										if v111 != 0 {
											return int32(0)
...
L2:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _consts[356]))
	v29 = *(*int32)(unsafe.Add(mBase, uint32(v28)+4))
	v34 = *(*int32)(unsafe.Add(mBase, uint32(v29*int32(28))+uint32(_consts[355])))
	goto L3
L3:
	;
...
L26:
	;
	v92 = *(*int32)(unsafe.Add(mBase, _consts[1130]))
	if v92 == int32(0) {
		goto L25
	} else {
		goto L27
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+8)) = v92
	v97 = *(*int32)(unsafe.Add(mBase, _consts[1130]))
	v98 = int32(1)
	v106 = v97 + v98
	v107 = v98
	goto L24
...
L97:
	;
	F_errmsg(m, int32(179604), int32(0))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(521411), int32(1572), int32(179553))
	mBase = m.M
	v426 = m.ExcPending
	if v426 != 0 {
		goto L1
