	...
	if v6 <= int32(0) {
		...
		if v22 < v20 {
			...
			if v60 != 0 {
				...
				F_errmsg_internal(m, int32(238089), int32(0))
				mBase = m.M
				v64 = m.ExcPending
				if v64 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(474130), int32(1878), int32(92141))
					mBase = m.M
					v69 = m.ExcPending
					if v69 != 0 {
						return int32(0)
		...
		if v17 < int32(0) {
			...
			if v47 != 0 {
				...
				F_errmsg_internal(m, int32(238121), int32(0))
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(474130), int32(1874), int32(92141))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
						...
						if v31 != int32(1) {
							...
							if v98 != 0 {
								...
								if v101 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(644379)
									F_errmsg(m, int32(235218), v10)
									mBase = m.M
									v106 = m.ExcPending
									if v106 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(474130), int32(1344), int32(380908))
										mBase = m.M
										v111 = m.ExcPending
										if v111 != 0 {
											return int32(0)
...
L97:
	;
	F_errmsg(m, int32(159365), int32(0))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L98:
	;
	F_errfinish(m, int32(474130), int32(1572), int32(159314))
	mBase = m.M
	v426 = m.ExcPending
	if v426 != 0 {
		goto L1
