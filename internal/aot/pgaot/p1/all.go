...
L1:
	;
	v40 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[805])))
	if l0 != int32(1) {
		goto L4
	} else {
		goto L5
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28)+12)) = v68
	...
	F_LockRefindAndRelease(m, int32(1607704), v72, v28+int32(12), int32(7), int32(0))
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L6
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v267)+uint32(_consts[806]))) = v257
...
L62:
	;
	v352 = *(*int32)(unsafe.Add(mBase, uint32(v267)+uint32(_consts[806])))
	*(*int32)(unsafe.Add(mBase, uint32(v267)+uint32(_consts[806]))) = v352 + int32(1)
	goto L64
L63:
	;
	goto L64
...
L76:
	;
	F_errfinish(m, int32(492680), int32(2385), int32(302556))
	mBase = m.M
	v405 = m.ExcPending
	if v405 != 0 {
		goto L6
...
L125:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v28))) = l0
	F_errmsg_internal(m, int32(482212), v28)
	mBase = m.M
	v844 = m.ExcPending
	if v844 != 0 {
		goto L6
...
L126:
	;
	F_errfinish(m, int32(492680), int32(2287), int32(302556))
	mBase = m.M
	v849 = m.ExcPending
	if v849 != 0 {
		goto L6
