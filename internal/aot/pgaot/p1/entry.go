...
L159:
	;
	v751 = int32(_a_F_entryGetItem_1)
	v754 = *(*int64)(unsafe.Add(mBase, _c_F_entryGetItem[0]))
	v755 = *(*int64)(unsafe.Add(mBase, _c_F_entryGetItem[1]))
	v756 = v754 ^ v755
	*(*int64)(unsafe.Add(mBase, _c_F_entryGetItem[1])) = base.I64_rotl(v756, int64(37))
	*(*int64)(unsafe.Add(mBase, _c_F_entryGetItem[0])) = v756<<(uint(int64(16))%64) ^ base.I64_rotl(v754, int64(24)) ^ v756
...
L160:
	;
	v779 = *(*int32)(unsafe.Add(mBase, _c_F_entryGetItem[2]))
...
L169:
	;
	v885 = v882 & int32(_a_F_entryGetItem_0)
	if v885 < v883 {
		v808 = v882
		v809 = v885
		v812 = v883
...
L170:
	;
	v844 = int32(_a_F_entryGetItem_1)
	v847 = *(*int64)(unsafe.Add(mBase, _c_F_entryGetItem[0]))
	v848 = *(*int64)(unsafe.Add(mBase, _c_F_entryGetItem[1]))
	v849 = v847 ^ v848
	*(*int64)(unsafe.Add(mBase, _c_F_entryGetItem[1])) = base.I64_rotl(v849, int64(37))
	*(*int64)(unsafe.Add(mBase, _c_F_entryGetItem[0])) = v849<<(uint(int64(16))%64) ^ base.I64_rotl(v847, int64(24)) ^ v849
...
L171:
	;
	v872 = *(*int32)(unsafe.Add(mBase, _c_F_entryGetItem[2]))
