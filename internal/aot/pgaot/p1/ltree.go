						...
						if v223 != 0 {
							...
							if v231 != 0 {
								...
								if v55&int32(65535) == int32(1) {
									F_pg_qsort(m, v230, v227, int32(8), int32(5867))
									mBase = m.M
									v239 = m.ExcPending
									if v239 != 0 {
										return int32(0)
...
func F__ltree_r_isparent(m *base.Module, l0 int32) int32 {
	...
	v6 = F_DirectFunctionCall2Coll(m, int32(5593), int32(0), v4, v5)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
		...
		if v22 != 0 {
			...
			if v25 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = v14
				F_errmsg(m, int32(645256), v10)
				mBase = m.M
				v33 = m.ExcPending
				if v33 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(479046), int32(353), int32(106775))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return int32(0)
...
L384:
	;
	v1595 = F_DirectFunctionCall2Coll(m, int32(5616), int32(0), v1583, v1585)
	mBase = m.M
	v1596 = m.ExcPending
	if v1596 != 0 {
		goto L10
...
L454:
	;
	v1960 = F_DirectFunctionCall2Coll(m, int32(5653), int32(0), v52+int32(8), v1947)
	mBase = m.M
	v1961 = m.ExcPending
	if v1961 != 0 {
		goto L10
...
L458:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+8)) = v52 + v1968
	v1977 = F_ltree_execute(m, v1947+v1968, v19+v1968, int32(0), int32(5870))
	mBase = m.M
	v1978 = m.ExcPending
	if v1978 != 0 {
		goto L10
...
L461:
	;
	v1992 = F_DirectFunctionCall2Coll(m, int32(5614), int32(0), v52+int32(8), v1980)
	mBase = m.M
	v1993 = m.ExcPending
	if v1993 != 0 {
		goto L10
...
L549:
	;
	F_errfinish(m, int32(476024), int32(604), int32(140382))
	mBase = m.M
	v2434 = m.ExcPending
	if v2434 != 0 {
		goto L10
...
L553:
	;
	F_errfinish(m, int32(476024), int32(600), int32(140382))
	mBase = m.M
	v2454 = m.ExcPending
	if v2454 != 0 {
		goto L10
...
L581:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v22
	F_errmsg_internal(m, int32(466124), v19)
	mBase = m.M
	v2593 = m.ExcPending
	if v2593 != 0 {
		goto L10
...
L582:
	;
	F_errfinish(m, int32(476024), int32(715), int32(89101))
	mBase = m.M
	v2600 = m.ExcPending
	if v2600 != 0 {
		goto L10
...
func F_ltree_gist_out(m *base.Module, l0 int32) int32 {
	...
	if v12 != 0 {
		...
		if v15 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(73537)
			F_errmsg(m, int32(184982), v5)
			mBase = m.M
			v23 = m.ExcPending
			if v23 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(476024), int32(36), int32(64800))
				mBase = m.M
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
