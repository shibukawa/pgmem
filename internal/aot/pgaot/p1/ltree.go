...
func F__ltree_penalty(m *base.Module, l0 int32) int32 {
	...
	if v25&int32(1) != 0 {
		...
		if v32 != 0 {
			...
			v35 = v33
			v37 = Fn13925(m, v5, v7, v35, int32(2))
			mBase = m.M
					...
					if base.Ui32(int32(2)) <= base.Ui32(v59) {
						...
						for {
							...
							for {
								...
								v135 = Fn13925(m, v103, v133, v54, int32(2))
								mBase = m.M
								...
								if v55&int32(_a_F__ltree_picksplit_1) == int32(1) {
									...
									for {
										...
										*(*uint16)(unsafe.Add(mBase, uint32(v269-int32(8)))) = uint16(v244)
										...
										v280 = Fn13925(m, v204, v278, v54, int32(2))
										mBase = m.M
										v282 = Fn13925(m, v223, v278, v54, int32(2))
										mBase = m.M
										v283 = v280 - v282
												...
												*(*int32)(unsafe.Add(mBase, uint32(v25)+4)) = v345 + int32(1)
												...
												if v207&int32(_a_F__ltree_picksplit_1) == v342 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v25)+20)) = v733 + int32(1)
													...
													v360 = Fn13925(m, v204, v358, v54, int32(2))
													mBase = m.M
													v363 = Fn13925(m, v223, v358, v54, int32(2))
													mBase = m.M
...
func F_ltree_gist_out(m *base.Module, l0 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = Fn13854(m, l0, int32(_a_F_ltree_gist_out_0), int32(36), int32(_a_F_ltree_gist_out_1), int32(_a_F_ltree_gist_out_2), int32(_a_F_ltree_gist_out_3))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
