...
func F_IsPostmasterChildWalSender(m *base.Module, l0 int32) int32 {
	...
	var v7 int32
	_ = v7
	v3 = *(*int32)(unsafe.Add(mBase, _consts[569]))
...
func F_PostmasterChildName(m *base.Module, l0 int32) int32 {
	...
	var v6 int32
	_ = v6
	v6 = *(*int32)(unsafe.Add(mBase, uint32(l0*int32(12))+uint32(_consts[625])))
	return v6
}
func F_RegisterPostmasterChildActive(m *base.Module) {
	...
	var v13 int32
	_ = v13
	v2 = *(*int32)(unsafe.Add(mBase, _consts[569]))
	v4 = *(*int32)(unsafe.Add(mBase, _consts[782]))
	v5 = int32(2)
