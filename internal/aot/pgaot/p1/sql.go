...
L16:
	;
	F_appendStringInfoString(m, v8+int32(16), int32(567371))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L2
...
L21:
	;
	F_appendStringInfoString(m, v8+int32(16), int32(567381))
	mBase = m.M
	v74 = m.ExcPending
	if v74 != 0 {
		goto L2
...
L47:
	;
	v266 = *(*int32)(unsafe.Add(mBase, _consts[1064]))
...
L49:
	;
	v210 = *(*int32)(unsafe.Add(mBase, _consts[1064]))
...
L75:
	;
	v304 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1065])))
	*(*uint8)(unsafe.Add(mBase, uint32(v299)+2)) = uint8(v304)
	v307 = int32(*(*uint16)(unsafe.Add(mBase, _consts[1066])))
...
L97:
	;
	F_errfinish(m, int32(517430), int32(2582), int32(359467))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L2
...
L108:
	;
	F_errfinish(m, int32(517430), int32(2609), int32(359467))
	mBase = m.M
	v435 = m.ExcPending
	if v435 != 0 {
		goto L2
...
L112:
	;
	F_errdetail(m, int32(618549), int32(0))
	mBase = m.M
	v450 = m.ExcPending
	if v450 != 0 {
		goto L2
...
L113:
	;
	F_errfinish(m, int32(517430), int32(2554), int32(359467))
	mBase = m.M
	v455 = m.ExcPending
	if v455 != 0 {
		goto L2
...
L117:
	;
	F_errdetail(m, int32(618417), int32(0))
	mBase = m.M
	v470 = m.ExcPending
	if v470 != 0 {
		goto L2
...
L118:
	;
	F_errfinish(m, int32(517430), int32(2576), int32(359467))
	mBase = m.M
	v475 = m.ExcPending
	if v475 != 0 {
		goto L2
...
L123:
	;
	F_errfinish(m, int32(517430), int32(2603), int32(359467))
	mBase = m.M
	v495 = m.ExcPending
	if v495 != 0 {
		goto L2
			...
			if v9 <= int32(0) {
				...
				if v26 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6))) = v27
					F_errcontext_msg(m, int32(241858), v6)
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return
