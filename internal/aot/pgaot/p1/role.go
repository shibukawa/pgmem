...
L32:
	;
	F_errfinish(m, int32(482165), int32(983), int32(371380))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L21
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v95
	v101 = F_format_elog_string(m, int32(70128), v8+int32(-48))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L21
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v127
	F_errmsg(m, int32(680654), v8+int32(-32))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L21
...
L45:
	;
	F_errfinish(m, int32(482165), int32(1004), int32(371380))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L21
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = v147
	v153 = F_format_elog_string(m, int32(680619), v8+int32(-16))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L21
				...
				if v18 != 0 {
					...
					if v17 != 0 {
						...
						if v22 != 0 {
							...
							F_errmsg_internal(m, int32(124434), int32(0))
							mBase = m.M
							v26 = m.ExcPending
							if v26 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(478477), int32(2231), int32(200162))
								mBase = m.M
								v31 = m.ExcPending
								if v31 != 0 {
									return int32(0)
						...
						if v87 != 0 {
							...
							if v90 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+48)) = v89
								F_errmsg(m, int32(680697), v8+int32(48))
								mBase = m.M
								v96 = m.ExcPending
								if v96 != 0 {
									return int32(0)
									...
									if v99 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v98
										F_errdetail(m, int32(602474), v8+int32(32))
										mBase = m.M
										v105 = m.ExcPending
										if v105 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(478477), int32(2252), int32(200162))
											mBase = m.M
											v110 = m.ExcPending
											if v110 != 0 {
												return int32(0)
									...
									if v48 != 0 {
										...
										if v51 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v50
											F_errmsg(m, int32(680697), v8+int32(16))
											mBase = m.M
											v57 = m.ExcPending
											if v57 != 0 {
												return int32(0)
												...
												if v60 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v8))) = int32(512875)
													F_errdetail(m, int32(632396), v8)
													mBase = m.M
													v66 = m.ExcPending
													if v66 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(478477), int32(2261), int32(200162))
														mBase = m.M
														v71 = m.ExcPending
														if v71 != 0 {
															return int32(0)
						...
						if v117 != 0 {
							...
							if v120 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+80)) = v119
								F_errmsg(m, int32(680382), v8+int32(80))
								mBase = m.M
								v126 = m.ExcPending
								if v126 != 0 {
									return int32(0)
									...
									if v129 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v8)+64)) = v128
										F_errdetail(m, int32(602326), v8-int32(-64))
										mBase = m.M
										v135 = m.ExcPending
										if v135 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(478477), int32(2271), int32(200162))
											mBase = m.M
											v140 = m.ExcPending
											if v140 != 0 {
												return int32(0)
	...
	if v15 != 0 {
		...
		if v12 == int32(0) {
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
			v20 = F_psprintf(m, int32(544700), v9)
			mBase = m.M
			v21 = m.ExcPending
			if v21 != 0 {
				return int32(0)
				...
				if v28 == int32(1) {
					...
					if v32 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l0
						v37 = F_psprintf(m, int32(615279), v9+int32(16))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
								...
								if v54 != 0 {
									...
									if v64+v63*int64(1000000)-int64(946684800000000) <= v51 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = l0
										v78 = F_psprintf(m, int32(610102), v9+int32(32))
										mBase = m.M
										v79 = m.ExcPending
										if v79 != 0 {
											return int32(0)
