...
func F_btree_identify(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v8 = *(*int32)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(2))%32))&int32(60))+uint32(_consts[120])))
	return v8
}
	...
	if v15 != 0 {
		...
		if v18&int32(1) != 0 {
			...
			if base.Ui32(v28) < base.Ui32(int32(25)) {
				...
				v34 = int32(base.Ui32(v28+int32(262120)) >> (uint(int32(2)) % 32))
				if v34&int32(65535) == int32(0) {
				} else {
					v39 = int32(1)
					v40 = int32(2)
					v44 = (v34 + v39) & int32(65535)
