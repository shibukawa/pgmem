...
func F_BlockRefTableReaderGetBlocks(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	_ = v129
	v10 = l0 + int32(65580)
	v11 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[797])))
	v16 = int32(0)
	v17 = v11
	goto L1
L1:
...
L4:
	;
	v22 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1252])))
	v23 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1253])))
	v24 = int32(1)
	v25 = v17 - v24
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1+v40<<(uint(int32(2))%32)))) = v25<<(uint(int32(16))%32) | v50
	v53 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1252])))
	v55 = v53 + v47
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1252]))) = v55
	v58 = v40 + v47
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1+v70<<(uint(int32(2))%32)))) = v69 + v25<<(uint(int32(16))%32)
	v92 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1252])))
	v93 = v70 + int32(1)
	v94 = v92
	goto L20
L19:
...
L20:
	;
	v96 = v94 + int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1252]))) = v96
...
L24:
	;
	v110 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[797])))
	v111 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[798])))
	if v110 == v111 {
		goto L23
	} else {
		goto L25
...
L25:
	;
	v113 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1253])))
...
L28:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1252]))) = int32(0)
	v129 = v125 + int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[797]))) = v129
	v16 = v105
	v17 = v129
	goto L1
L29:
...
L30:
	;
	v124 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[797])))
	v125 = v124
	goto L28
}
...
func F_CreateBlockRefTableReader(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_consts[1251]))) = int32(0)
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_consts[796]))) = int32(433)
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_consts[800]))) = l1
		*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = l0
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(432)
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_consts[799]))) = int32(-1)
		...
		if v28 != 0 {
			...
			if v29 != int32(1697321851) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				F_ReportWalSummaryError(m, int32(0), int32(58297), v7)
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return int32(0)
