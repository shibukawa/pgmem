...
L4:
	;
	v22 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1246])))
	v23 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1247])))
	v24 = int32(1)
	v25 = v17 - v24
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1+v40<<(uint(int32(2))%32)))) = v25<<(uint(int32(16))%32) | v50
	v53 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1246])))
	v55 = v53 + v47
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1246]))) = v55
	v58 = v40 + v47
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1+v70<<(uint(int32(2))%32)))) = v69 + v25<<(uint(int32(16))%32)
	v92 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1246])))
	v93 = v70 + int32(1)
	v94 = v92
	goto L20
L19:
...
L20:
	;
	v96 = v94 + int32(1)
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1246]))) = v96
...
L25:
	;
	v113 = *(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1247])))
...
L28:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[1246]))) = int32(0)
	v129 = v125 + int32(1)
...
func F_CreateBlockRefTableReader(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v13 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_consts[1245]))) = int32(0)
		...
		if v28 != 0 {
			...
			if v29 != int32(1697321851) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				F_ReportWalSummaryError(m, int32(0), int32(50773), v7)
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return int32(0)
