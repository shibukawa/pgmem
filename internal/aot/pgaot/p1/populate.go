		...
		if v35 != 0 {
			...
			if v38 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v39
				F_errmsg(m, int32(_a_F_populate_recordset_object_start_1), v6)
				mBase = m.M
				v43 = m.ExcPending
				if v43 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_populate_recordset_object_start_2), int32(_a_F_populate_recordset_object_start_3), int32(_a_F_populate_recordset_object_start_4))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
