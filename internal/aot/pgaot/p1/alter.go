...
L32:
	;
	v128 = *(*int32)(unsafe.Add(mBase, _c_F_AlterConstraintNamespaces[0]))
	if v128 != 0 {
		goto L37
	} else {
		goto L38
...
L27:
	;
	v106 = *(*int32)(unsafe.Add(mBase, _c_F_AlterTypeRecurse[0]))
	if v106 != 0 {
		goto L28
	} else {
		goto L29
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v122
	F_errmsg_internal(m, int32(_a_F_AlterTypeRecurse_0), v10)
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L1
