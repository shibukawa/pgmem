...
L20:
	;
	v63 = int32(*(*uint8)(unsafe.Add(mBase, _consts[403])))
	if v63 == int32(0) {
		goto L21
	} else {
		goto L22
...
L26:
	...
	v75 = *(*int32)(unsafe.Add(mBase, _consts[404]))
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v222
	F_errmsg_internal(m, int32(485388), v16)
	mBase = m.M
	v226 = m.ExcPending
	if v226 != 0 {
		goto L24
...
L62:
	;
	F_errfinish(m, int32(494212), int32(4849), int32(306409))
	mBase = m.M
	v231 = m.ExcPending
	if v231 != 0 {
		goto L24
...
L65:
	;
	F_errfinish(m, int32(494201), int32(4653), int32(360420))
	mBase = m.M
	v236 = m.ExcPending
	if v236 != 0 {
		goto L1
