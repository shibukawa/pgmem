...
func F_NamespaceCreate(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if l0 != 0 {
				...
				if v113 != 0 {
					...
					if v116 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
						F_errmsg(m, int32(117213), v11)
						mBase = m.M
						v120 = m.ExcPending
						if v120 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(499350), int32(64), int32(355641))
							mBase = m.M
							v125 = m.ExcPending
							if v125 != 0 {
								return int32(0)
		...
		if v100 != 0 {
			...
			F_errmsg_internal(m, int32(456215), int32(0))
			mBase = m.M
			v104 = m.ExcPending
			if v104 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(499350), int32(58), int32(355641))
				mBase = m.M
				v109 = m.ExcPending
				if v109 != 0 {
					return int32(0)
