...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = l2
	v153 = F_pg_snprintf(m, v16+int32(128), int32(64), int32(486678), v16+int32(16))
	mBase = m.M
	v154 = m.ExcPending
	if v154 != 0 {
		goto L1
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = l2
	v295 = F_pg_snprintf(m, v16+int32(128), int32(64), int32(486678), v16)
	mBase = m.M
	v296 = m.ExcPending
	if v296 != 0 {
		goto L1
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
				...
				if v22 != 0 {
					...
					F_errfinish(m, int32(522705), int32(1242), int32(383646))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
