			...
			if v25 < int32(0) {
				...
				if v191 != 0 {
					...
					if v194 != 0 {
						...
						F_errmsg(m, int32(343293), int32(0))
						mBase = m.M
						v200 = m.ExcPending
						if v200 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(500138), int32(206), int32(427691))
							mBase = m.M
							v207 = m.ExcPending
							if v207 != 0 {
								return int32(0)
...
L43:
	;
	v158 = F_find_among_b(m, l0, int32(4212656), int32(29))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L44
...
L47:
	;
	v299 = F_slice_from_s(m, l0, int32(2), int32(2180407))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L44
...
L87:
	;
	v327 = F_find_among_b(m, l0, int32(4213248), int32(2))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L44
...
L101:
	;
	v373 = F_find_among_b(m, l0, int32(4213296), int32(11))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L44
...
L83:
	;
	v343 = F_find_among_b(m, l0, int32(4314032), int32(29))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L84
...
L87:
	;
	v641 = F_slice_from_s(m, l0, int32(2), int32(2208199))
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		goto L84
...
L149:
	;
	v668 = F_find_among_b(m, l0, int32(4314624), int32(2))
	mBase = m.M
	v669 = m.ExcPending
	if v669 != 0 {
		goto L84
...
L177:
	;
	v766 = F_find_among_b(m, l0, int32(4314672), int32(11))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L84
					...
					if v100 != 0 {
						...
						if v103 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v104
							F_errmsg(m, int32(478494), v7+int32(32))
							mBase = m.M
							v112 = m.ExcPending
							if v112 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(500163), int32(1353), int32(277450))
								mBase = m.M
								v117 = m.ExcPending
								if v117 != 0 {
									return int32(0)
					...
					if v60 != 0 {
						...
						if v63 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = v64
							F_errmsg(m, int32(478494), v7)
							mBase = m.M
							v70 = m.ExcPending
							if v70 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(500163), int32(1339), int32(277450))
								mBase = m.M
								v75 = m.ExcPending
								if v75 != 0 {
									return int32(0)
						...
						if v79 != 0 {
							...
							if v82 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v83
								F_errmsg(m, int32(478451), v7+int32(16))
								mBase = m.M
								v91 = m.ExcPending
								if v91 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(500163), int32(1344), int32(277450))
									mBase = m.M
									v96 = m.ExcPending
									if v96 != 0 {
										return int32(0)
			...
			default:
				...
				if v121 != 0 {
					...
					if v124 != 0 {
						...
						F_errmsg(m, int32(222491), int32(0))
						mBase = m.M
						v128 = m.ExcPending
						if v128 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(500163), int32(1361), int32(277450))
							mBase = m.M
							v133 = m.ExcPending
							if v133 != 0 {
								return int32(0)
			...
			if v17 != 0 {
				...
				if v21 != 0 {
					...
					if v24 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v6))) = int32(271930)
						F_errmsg(m, int32(725181), v6)
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return float64(0)
						} else {
							F_errfinish(m, int32(500163), int32(8476), int32(31309))
							mBase = m.M
							v35 = m.ExcPending
							if v35 != 0 {
								return float64(0)
