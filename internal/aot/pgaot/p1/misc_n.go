...
L1:
	;
	return int32(base.Ui32(v60^int32(-1)) >> (uint(int32(31)) % 32))
L2:
	;
	goto L7
L3:
...
func F_normal_rand(m *base.Module, l0 int32) int32 {
	...
	if v14 == int32(0) {
		...
		if v21 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, _c_F_normal_rand[0])) = v23
			...
			if v25 < int32(0) {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v18)+8)) = base.I64_extend_i32_u(v25)
				...
				if v32 != 0 {
					...
					*(*float64)(unsafe.Add(mBase, uint32(v31))) = v34
					v36 = *(*int32)(unsafe.Add(mBase, uint32(l0)+36))
					v37 = *(*float64)(unsafe.Add(mBase, uint32(v36)))
					v38 = int32(0)
					*(*uint8)(unsafe.Add(mBase, uint32(v31)+24)) = uint8(v38)
					*(*int64)(unsafe.Add(mBase, uint32(v31)+16)) = int64(0)
					*(*float64)(unsafe.Add(mBase, uint32(v31)+8)) = v37
					...
					*(*int32)(unsafe.Add(mBase, _c_F_normal_rand[0])) = v22
					...
					v53 = *(*int64)(unsafe.Add(mBase, uint32(v51)+8))
					if base.Ui64(v52) < base.Ui64(v53) {
						v55 = *(*int32)(unsafe.Add(mBase, uint32(v51)+16))
						v56 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v55)+24)))
						if v56 != 0 {
							v57 = *(*float64)(unsafe.Add(mBase, uint32(v55)+16))
							v160 = v57
							v167 = v52
							v168 = int32(0)
						} else {
							v59 = *(*float64)(unsafe.Add(mBase, uint32(v55)+8))
							v60 = *(*float64)(unsafe.Add(mBase, uint32(v55)))
							for {
								v73 = int32(_a_F_normal_rand_4)
								v76 = *(*int64)(unsafe.Add(mBase, _c_F_normal_rand[1]))
								v77 = *(*int64)(unsafe.Add(mBase, _c_F_normal_rand[2]))
								v78 = v76 ^ v77
								*(*int64)(unsafe.Add(mBase, _c_F_normal_rand[2])) = base.I64_rotl(v78, int64(37))
								*(*int64)(unsafe.Add(mBase, _c_F_normal_rand[1])) = v78<<(uint(int64(16))%64) ^ base.I64_rotl(v76, int64(24)) ^ v78
								v99 = F_ldexp(m, base.F64_convert_i64_u(int64(base.Ui64(base.I64_rotl(v76*int64(5), int64(7))*int64(9))>>(uint(int64(12))%64))), int32(-52))
								mBase = m.M
								v102 = base.F64_add(base.F64_add(v99, v99), float64(-1))
								v106 = *(*int64)(unsafe.Add(mBase, _c_F_normal_rand[1]))
								v107 = *(*int64)(unsafe.Add(mBase, _c_F_normal_rand[2]))
								v108 = v106 ^ v107
								*(*int64)(unsafe.Add(mBase, _c_F_normal_rand[2])) = base.I64_rotl(v108, int64(37))
								*(*int64)(unsafe.Add(mBase, _c_F_normal_rand[1])) = v108<<(uint(int64(16))%64) ^ base.I64_rotl(v106, int64(24)) ^ v108
								v129 = F_ldexp(m, base.F64_convert_i64_u(int64(base.Ui64(base.I64_rotl(v106*int64(5), int64(7))*int64(9))>>(uint(int64(12))%64))), int32(-52))
								mBase = m.M
								v132 = base.F64_add(base.F64_add(v129, v129), float64(-1))
								v134 = base.F64_add(base.F64_mul(v102, v102), base.F64_mul(v132, v132))
								if base.F64_ge(v134, float64(1)) != 0 {
									continue
								} else {
									break
								}
							...
							if base.F64_ne(v134, float64(0)) != 0 {
								v139 = F_log(m, v134)
								mBase = m.M
								v143 = base.F64_sqrt(base.F64_div(base.F64_mul(v139, float64(-2)), v134))
								v147 = base.F64_mul(v102, v143)
								v148 = base.F64_mul(v132, v143)
							} else {
								v147 = v5
								v148 = v5
							}
							*(*float64)(unsafe.Add(mBase, uint32(v55)+16)) = base.F64_add(base.F64_mul(v59, v148), v60)
							v154 = *(*int64)(unsafe.Add(mBase, uint32(v51)))
							v160 = base.F64_add(base.F64_mul(v59, v147), v60)
							v167 = v154
							v168 = int32(1)
						}
						*(*uint8)(unsafe.Add(mBase, uint32(v55)+24)) = uint8(v168)
						*(*int64)(unsafe.Add(mBase, uint32(v51))) = v167 + int64(1)
						v173 = *(*int32)(unsafe.Add(mBase, uint32(l0)+8))
						*(*int32)(unsafe.Add(mBase, uint32(v173)+20)) = int32(1)
						v176 = F_Float8GetDatum(m, v160)
						mBase = m.M
						v177 = m.ExcPending
						if v177 != 0 {
							return int32(0)
						...
						if v180 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v181)+20)) = int32(2)
							v184 = int32(1)
...
L15:
	;
	v44 = int32(1)
	v48 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v41)>>(uint(int32(3))%32)))+uint32(_c_F_norwegian_ISO_8859_1_stem[0]))))
...
L42:
	;
	if int32(1)<<(uint(v145)%32)&int32(_a_F_norwegian_ISO_8859_1_stem_0) == int32(0) {
		goto L40
	} else {
		goto L43
	}
L43:
	;
	v158 = F_find_among_b(m, l0, int32(_a_F_norwegian_ISO_8859_1_stem_1), int32(29))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L44
...
L47:
	;
	v299 = F_slice_from_s(m, l0, int32(2), int32(_a_F_norwegian_ISO_8859_1_stem_2))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L44
...
L60:
	;
	v208 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v202)>>(uint(int32(3))%32)))+uint32(_c_F_norwegian_ISO_8859_1_stem[1]))))
...
L77:
	;
	v271 = int32(1)
	v275 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v268)>>(uint(int32(3))%32)))+uint32(_c_F_norwegian_ISO_8859_1_stem[0]))))
...
L87:
	;
	v327 = F_find_among_b(m, l0, int32(_a_F_norwegian_ISO_8859_1_stem_3), int32(2))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L44
...
L101:
	;
	v373 = F_find_among_b(m, l0, int32(_a_F_norwegian_ISO_8859_1_stem_4), int32(11))
	mBase = m.M
	v374 = m.ExcPending
	if v374 != 0 {
		goto L44
...
L104:
	;
	if int32(1)<<(uint(v360)%32)&int32(_a_F_norwegian_ISO_8859_1_stem_5) != 0 {
		goto L101
	} else {
		goto L105
	}
...
L82:
	;
	if int32(1)<<(uint(v330)%32)&int32(_a_F_norwegian_UTF_8_stem_2) == int32(0) {
		goto L80
	} else {
		goto L83
	}
L83:
	;
	v343 = F_find_among_b(m, l0, int32(_a_F_norwegian_UTF_8_stem_3), int32(29))
	mBase = m.M
	v346 = m.ExcPending
	if v346 != 0 {
		goto L84
...
L87:
	;
	v641 = F_slice_from_s(m, l0, int32(2), int32(_a_F_norwegian_UTF_8_stem_4))
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		goto L84
...
L103:
	;
	v453 = v427<<(uint(int32(12))%32)&int32(_a_F_norwegian_UTF_8_stem_1) | v423
	v454 = int32(3)
	goto L97
L104:
	;
...
L105:
	...
	v453 = v427<<(uint(int32(12))%32)&int32(_a_F_norwegian_UTF_8_stem_5) | v445&int32(7)<<(uint(int32(18))%32) | v423
	v454 = int32(4)
	goto L97
L106:
	;
...
L111:
	;
	v464 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v458)>>(uint(int32(3))%32)))+uint32(_c_F_norwegian_UTF_8_stem[1]))))
...
L132:
	;
	v598 = v572<<(uint(int32(12))%32)&int32(_a_F_norwegian_UTF_8_stem_1) | v568
	v599 = int32(3)
	goto L126
L133:
	;
...
L134:
	...
	v598 = v572<<(uint(int32(12))%32)&int32(_a_F_norwegian_UTF_8_stem_5) | v590&int32(7)<<(uint(int32(18))%32) | v568
	v599 = int32(4)
	goto L126
L135:
	;
...
L137:
	;
	v609 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(v603)>>(uint(int32(3))%32)))+uint32(_c_F_norwegian_UTF_8_stem[0]))))
...
L177:
	;
	v766 = F_find_among_b(m, l0, int32(_a_F_norwegian_UTF_8_stem_7), int32(11))
	mBase = m.M
	v767 = m.ExcPending
	if v767 != 0 {
		goto L84
...
L180:
	;
	if int32(1)<<(uint(v753)%32)&int32(_a_F_norwegian_UTF_8_stem_8) != 0 {
		goto L177
	} else {
		goto L181
	}
