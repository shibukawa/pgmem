						...
						if v23 != 0 {
							...
							if v25 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v24
								F_errmsg(m, int32(_a_F_LookupOperName_3), v9)
								mBase = m.M
								v29 = m.ExcPending
								if v29 != 0 {
									return int32(0)
...
func F_lo_import_internal(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v127
	v6 = m.G0
	v8 = v6 - int32(_a_F_lo_import_internal_0)
	m.G0 = v8
...
L7:
	;
	v28 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _c_F_lo_import_internal[0])) = uint8(v28)
...
L10:
	;
	v34 = *(*int32)(unsafe.Add(mBase, _c_F_lo_import_internal[1]))
	v35 = F_inv_open(m, v30, int32(_a_F_lo_import_internal_2), v34)
	mBase = m.M
	v36 = m.ExcPending
	if v36 != 0 {
		goto L1
...
L11:
	;
	v40 = F_read(m, v23, v8+int32(1072), int32(_a_F_lo_import_internal_3))
	mBase = m.M
	if int32(0) < v40 {
		goto L12
	} else {
...
L17:
	;
	v55 = F_read(m, v23, v8+int32(1072), int32(_a_F_lo_import_internal_3))
	mBase = m.M
	if int32(0) < v55 {
		v43 = v55
		goto L15
...
L22:
	;
	m.G0 = v8 + int32(_a_F_lo_import_internal_0)
	return v30
L23:
	;
...
L24:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v8 + int32(48)
	F_errmsg(m, int32(_a_F_lo_import_internal_4), v8)
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v8 + int32(48)
	F_errmsg(m, int32(_a_F_lo_import_internal_7), v8+int32(16))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L1
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v8 + int32(48)
	F_errmsg(m, int32(_a_F_lo_import_internal_8), v8+int32(32))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L1
...
L30:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_load_ident[5])) = v88
		...
		if base.Ui64(int64(-4616189618054758400)) <= base.Ui64(v9) {
			...
			if base.Ui32(base.I32_wrap_i64(int64(base.Ui64(v9)>>(uint(int64(31))%64)))) < base.Ui32(int32(2034237440)) {
				...
				if base.Ui64(int64(-4624424114038243328)) <= base.Ui64(v9) {
					...
					v38 = base.I32_wrap_i64(int64(base.Ui64(v33)>>(uint(int64(32))%64))) + int32(_a_F_log1p_0)
					...
					v70 = base.F64_add(base.F64_reinterpret_i64(v33&int64(4294967295)|base.I64_extend_i32_u(v38&int32(_a_F_log1p_1)+int32(1072079006))<<(uint(int64(32))%64)), float64(-1))
					v72 = v55
...
func F_logfile_open(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v17 = int32(_a_F_logfile_open_0)
	v18 = *(*int32)(unsafe.Add(mBase, _c_F_logfile_open[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_logfile_open[1])) = (v11 ^ int32(-1)) & int32(383)
	v21 = F___syscall_ret(m, v18)
	mBase = m.M
	v22 = F_fopen(m, l0, l1)
	mBase = m.M
	v24 = int32(_a_F_logfile_open_0)
	v25 = *(*int32)(unsafe.Add(mBase, _c_F_logfile_open[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_logfile_open[1])) = v21
	...
	if v22 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v22))) = v34 | int32(64)
		...
		v39 = *(*int32)(unsafe.Add(mBase, _c_F_logfile_open[2]))
		if l2 != 0 {
			v42 = int32(15)
		} else {
			v42 = int32(22)
			...
			if v44 != 0 {
				...
				if v49 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg(m, int32(_a_F_logfile_open_1), v8)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(_a_F_logfile_open_2), int32(1248), int32(_a_F_logfile_open_3))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return int32(0)
						} else {
							*(*int32)(unsafe.Add(mBase, _c_F_logfile_open[2])) = v39
							m.G0 = v8 + int32(16)
							return v22
						}
					}
...
L35:
	;
	v102 = *(*int32)(unsafe.Add(mBase, _c_F_lpad[0]))
	v103 = *(*int32)(unsafe.Add(mBase, uint32(v102)+4))
	v108 = *(*int32)(unsafe.Add(mBase, uint32(v103*int32(28))+uint32(_c_F_lpad[1])))
	goto L37
L36:
	;
	F_errstart_cold(m, int32(21), int32(0))
