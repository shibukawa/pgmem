						...
						if v45 != 0 {
							...
							if v49 != 0 {
								...
								if v53 != 0 {
									...
									F_errfinish(m, int32(495434), int32(115), int32(382192))
									mBase = m.M
									v58 = m.ExcPending
									if v58 != 0 {
										return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v24
								...
								if v29 != 0 {
									...
									if v33 != 0 {
										...
										F_errfinish(m, int32(495434), int32(121), int32(382192))
										mBase = m.M
										v38 = m.ExcPending
										if v38 != 0 {
											return int32(0)
...
func F_latch_sigurg_handler(m *base.Module, l0 int32) {
	...
	v4 = v2 - int32(16)
	m.G0 = v4
	v7 = *(*int32)(unsafe.Add(mBase, _consts[797]))
	if v7 == int32(0) {
		goto L1
	} else {
		goto L2
...
L3:
	;
	v14 = *(*int32)(unsafe.Add(mBase, _consts[798]))
...
func F_leftmostvalue_bit(m *base.Module) int32 {
	...
	_ = v9
	v2 = int32(0)
	v6 = F_DirectFunctionCall3Coll(m, int32(490), v2, int32(757461), v2, int32(-1))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
L3:
	...
	v28 = *(*int32)(unsafe.Add(mBase, uint32(v23*int32(28))+uint32(_consts[356])))
	goto L4
L4:
	;
	if v28 == int32(1) {
...
L121:
	;
	F_errfinish(m, int32(498118), int32(438), int32(372148))
	mBase = m.M
	v516 = m.ExcPending
	if v516 != 0 {
		goto L1
...
func F_lo_import_internal(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v8 = v6 - int32(9264)
	m.G0 = v8
	F_PreventCommandIfReadOnly(m, int32(683266))
	mBase = m.M
	v14 = m.ExcPending
	if v14 != 0 {
		goto L1
...
L7:
	;
	v28 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[444])) = uint8(v28)
...
L25:
	;
	F_errfinish(m, int32(495117), int32(445), int32(310888))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v8 + int32(48)
	F_errmsg(m, int32(298414), v8+int32(16))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L1
...
L29:
	;
	F_errfinish(m, int32(495117), int32(468), int32(310888))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L1
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v8 + int32(48)
	F_errmsg(m, int32(299510), v8+int32(32))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(495117), int32(476), int32(310888))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L1
...
L5:
	...
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(60540), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L2
...
L22:
	;
	v97 = *(*int32)(unsafe.Add(mBase, _consts[445]))
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, _consts[3])) = v44
	v103 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[445])) = v103
	if v87 == v103 {
		goto L24
	} else {
		goto L25
...
L26:
	;
	v111 = *(*int32)(unsafe.Add(mBase, _consts[451]))
	if v111 != 0 {
		goto L28
	} else {
		goto L29
...
L30:
	;
	*(*int32)(unsafe.Add(mBase, _consts[452])) = v88
	*(*int32)(unsafe.Add(mBase, _consts[451])) = v41
	v119 = int32(1)
	goto L1
L31:
	;
...
func F_logfile_open(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v8 = v6 - int32(16)
	m.G0 = v8
	v11 = *(*int32)(unsafe.Add(mBase, _consts[429]))
	v17 = int32(4409244)
	v18 = *(*int32)(unsafe.Add(mBase, _consts[362]))
	*(*int32)(unsafe.Add(mBase, _consts[362])) = (v11 ^ int32(-1)) & int32(383)
	...
	*(*int32)(unsafe.Add(mBase, _consts[362])) = v21
			...
			if v44 != 0 {
				...
				if v49 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg(m, int32(299124), v8)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(495615), int32(1248), int32(281821))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return int32(0)
...
L35:
	;
	v102 = *(*int32)(unsafe.Add(mBase, _consts[357]))
	v103 = *(*int32)(unsafe.Add(mBase, uint32(v102)+4))
	v108 = *(*int32)(unsafe.Add(mBase, uint32(v103*int32(28))+uint32(_consts[356])))
	goto L37
L36:
	;
	F_errstart_cold(m, int32(21), int32(0))
...
L84:
	;
	F_errfinish(m, int32(493637), int32(206), int32(463672))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L1
		...
		if v10 != int32(1) {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v10
				F_errmsg_internal(m, int32(471955), v6)
				mBase = m.M
				v25 = m.ExcPending
				if v25 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496286), int32(808), int32(36169))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
