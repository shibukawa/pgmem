						...
						if v45 != 0 {
							...
							if v49 != 0 {
								...
								if v53 != 0 {
									...
									F_errfinish(m, int32(518377), int32(115), int32(399695))
									mBase = m.M
									v58 = m.ExcPending
									if v58 != 0 {
										return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v24
								...
								if v29 != 0 {
									...
									if v33 != 0 {
										...
										F_errfinish(m, int32(518377), int32(121), int32(399695))
										mBase = m.M
										v38 = m.ExcPending
										if v38 != 0 {
											return int32(0)
...
func F_leftmostvalue_bit(m *base.Module) int32 {
	...
	_ = v9
	v2 = int32(0)
	v6 = F_DirectFunctionCall3Coll(m, int32(490), v2, int32(790230), v2, int32(-1))
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
L121:
	;
	F_errfinish(m, int32(521524), int32(438), int32(389517))
	mBase = m.M
	v516 = m.ExcPending
	if v516 != 0 {
		goto L1
...
func F_lo_import_internal(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v8 = v6 - int32(9264)
	m.G0 = v8
	F_PreventCommandIfReadOnly(m, int32(713168))
	mBase = m.M
	v14 = m.ExcPending
	if v14 != 0 {
		goto L1
...
L25:
	;
	F_errfinish(m, int32(517930), int32(445), int32(325074))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v8 + int32(48)
	F_errmsg(m, int32(311913), v8+int32(16))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L1
...
L29:
	;
	F_errfinish(m, int32(517930), int32(468), int32(325074))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L1
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v8 + int32(48)
	F_errmsg(m, int32(313009), v8+int32(32))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(517930), int32(476), int32(325074))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L1
...
L5:
	...
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(66199), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L2
			...
			if v44 != 0 {
				...
				if v49 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg(m, int32(312623), v8)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(518558), int32(1248), int32(294663))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return int32(0)
...
L84:
	;
	F_errfinish(m, int32(515940), int32(206), int32(484204))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L1
		...
		if v10 != int32(1) {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v10
				F_errmsg_internal(m, int32(492802), v6)
				mBase = m.M
				v25 = m.ExcPending
				if v25 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(519259), int32(808), int32(37538))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
