						...
						if v45 != 0 {
							...
							if v49 != 0 {
								...
								if v53 != 0 {
									...
									F_errfinish(m, int32(473801), int32(115), int32(364570))
									mBase = m.M
									v58 = m.ExcPending
									if v58 != 0 {
										return int32(0)
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v24
								...
								if v29 != 0 {
									...
									if v33 != 0 {
										...
										F_errfinish(m, int32(473801), int32(121), int32(364570))
										mBase = m.M
										v38 = m.ExcPending
										if v38 != 0 {
											return int32(0)
...
L121:
	;
	F_errfinish(m, int32(476285), int32(438), int32(355536))
	mBase = m.M
	v516 = m.ExcPending
	if v516 != 0 {
		goto L1
...
func F_lo_import_internal(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v8 = v6 - int32(9264)
	m.G0 = v8
	F_PreventCommandIfReadOnly(m, int32(643199))
	mBase = m.M
	v14 = m.ExcPending
	if v14 != 0 {
		goto L1
...
L25:
	;
	F_errfinish(m, int32(473498), int32(445), int32(296595))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v8 + int32(48)
	F_errmsg(m, int32(284837), v8+int32(16))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L1
...
L29:
	;
	F_errfinish(m, int32(473498), int32(468), int32(296595))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L1
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v8 + int32(48)
	F_errmsg(m, int32(285933), v8+int32(32))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L1
...
L33:
	;
	F_errfinish(m, int32(473498), int32(476), int32(296595))
	mBase = m.M
	v127 = m.ExcPending
	if v127 != 0 {
		goto L1
...
L5:
	...
	v41 = F_AllocSetContextCreateInternal(m, v36, int32(58098), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v42 = m.ExcPending
	if v42 != 0 {
		goto L2
			...
			if v44 != 0 {
				...
				if v49 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg(m, int32(285547), v8)
					mBase = m.M
					v53 = m.ExcPending
					if v53 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(473982), int32(1248), int32(268678))
						mBase = m.M
						v58 = m.ExcPending
						if v58 != 0 {
							return int32(0)
...
L84:
	;
	F_errfinish(m, int32(472044), int32(206), int32(443649))
	mBase = m.M
	v237 = m.ExcPending
	if v237 != 0 {
		goto L1
