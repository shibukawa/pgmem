...
func F_ExecuteRecoveryCommand(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	if v19 != 0 {
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v12)+56)) = uint32(v31)
		v39 = F_pg_snprintf(m, v12+int32(80), int32(64), int32(502158), v12+int32(48))
		mBase = m.M
		v40 = m.ExcPending
		if v40 != 0 {
			return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v12 + int32(80)
			v47 = F_replace_percent_placeholders(m, l0, l1, int32(227660), v12+int32(32))
			mBase = m.M
			v48 = m.ExcPending
			if v48 != 0 {
				return
				...
				if v52 != 0 {
					...
					if v51 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = l1
						F_errmsg_internal(m, int32(676135), v12+int32(16))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return
						} else {
							F_errfinish(m, int32(490739), int32(323), int32(422693))
							mBase = m.M
							v64 = m.ExcPending
							if v64 != 0 {
								return
													...
													if v107 == int32(0) {
														...
														if v112 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
															F_errmsg(m, int32(202772), v12)
															mBase = m.M
															v118 = m.ExcPending
															if v118 != 0 {
																return
															} else {
																F_errfinish(m, int32(490739), int32(347), int32(422693))
																mBase = m.M
																v123 = m.ExcPending
																if v123 != 0 {
																	return
...
L12:
	;
	F_errmsg(m, int32(153413), int32(0))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L7
...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l0
	F_errdetail(m, int32(629554), v10+int32(32))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L7
...
L14:
	;
	F_errfinish(m, int32(484814), int32(4715), int32(214082))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L7
...
L18:
	;
	F_errmsg(m, int32(442403), int32(0))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L7
...
L21:
	;
	F_errdetail(m, int32(589000), int32(0))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L7
...
L22:
	;
	F_errhint(m, int32(577800), int32(0))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L7
...
L23:
	;
	F_errfinish(m, int32(484814), int32(4722), int32(214082))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L7
...
L27:
	...
	F_s_lock(m, v78+int32(96), int32(484814), int32(3096), int32(348572))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L7
...
L42:
	;
	F_errmsg(m, int32(153484), int32(0))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L7
...
L43:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
	F_errdetail(m, int32(629554), v10+int32(16))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L7
...
L45:
	;
	F_errfinish(m, int32(484814), int32(4743), int32(214082))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L7
...
L47:
	...
	F_s_lock(m, v139+int32(96), int32(484814), int32(3135), int32(442423))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L7
...
L57:
	;
	F_errmsg(m, int32(153553), int32(0))
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L7
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
	F_errdetail(m, int32(629554), v10)
	mBase = m.M
	v187 = m.ExcPending
	if v187 != 0 {
		goto L7
...
L59:
	;
	F_errhint(m, int32(577882), int32(0))
	mBase = m.M
	v191 = m.ExcPending
	if v191 != 0 {
		goto L7
...
L60:
	;
	F_errfinish(m, int32(484814), int32(4773), int32(214082))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L7
