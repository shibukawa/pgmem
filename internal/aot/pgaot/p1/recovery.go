...
L13:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l0
	F_errdetail(m, int32(_a_F_RecoveryRequiresIntParameter_1), v10+int32(32))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L7
...
L21:
	;
	F_errdetail(m, int32(_a_F_RecoveryRequiresIntParameter_6), int32(0))
	mBase = m.M
	v55 = m.ExcPending
	if v55 != 0 {
		goto L7
...
L27:
	;
	v78 = *(*int32)(unsafe.Add(mBase, _c_F_RecoveryRequiresIntParameter[1]))
	F_s_lock(m, v78+int32(96), int32(_a_F_RecoveryRequiresIntParameter_2), int32(3096), int32(_a_F_RecoveryRequiresIntParameter_9))
	mBase = m.M
	v85 = m.ExcPending
	if v85 != 0 {
		goto L7
				...
				if v15 != 0 {
					...
					if v20 != 0 {
						...
						if l1 == int32(0) {
							...
							v24 = *(*int32)(unsafe.Add(mBase, _c_F_ResolveRecoveryConflictWithSnapshotFullXid[0]))
							if v24 < int32(2) {
								return
							} else {
