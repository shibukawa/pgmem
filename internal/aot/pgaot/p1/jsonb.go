	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(_a_F_jsonb_float4_0))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(_a_F_jsonb_float8_0))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
L31:
	;
	F_errmsg(m, int32(_a_F_jsonb_in_scalar_0), int32(0))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L28
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(268435455)
	F_errdetail(m, int32(_a_F_jsonb_in_scalar_1), v7)
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L28
...
L33:
	;
	F_errsave_finish(m, v74, int32(_a_F_jsonb_in_scalar_2), int32(284), int32(_a_F_jsonb_in_scalar_3))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L28
...
L38:
	;
	F_errmsg_internal(m, int32(_a_F_jsonb_in_scalar_4), int32(0))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L28
...
L39:
	;
	F_errfinish(m, int32(_a_F_jsonb_in_scalar_2), int32(424), int32(_a_F_jsonb_in_scalar_5))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L28
...
L53:
	;
	F_errfinish(m, int32(_a_F_jsonb_in_scalar_2), int32(454), int32(_a_F_jsonb_in_scalar_5))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L28
