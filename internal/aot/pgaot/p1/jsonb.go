...
L120:
	;
	F_errmsg_internal(m, int32(367300), int32(0))
	mBase = m.M
	v570 = m.ExcPending
	if v570 != 0 {
		goto L18
...
L121:
	;
	F_errfinish(m, int32(517863), int32(1002), int32(69356))
	mBase = m.M
	v575 = m.ExcPending
	if v575 != 0 {
		goto L18
...
L123:
	;
	F_errmsg_internal(m, int32(21746), int32(0))
	mBase = m.M
	v583 = m.ExcPending
	if v583 != 0 {
		goto L18
...
L124:
	;
	F_errfinish(m, int32(517863), int32(967), int32(69356))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L18
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(326668))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(282822))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
func F_jsonb_in_scalar(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v7)+4)) = int64(4294967312)
				...
				default:
					...
					if v120 != 0 {
						...
						F_errmsg_internal(m, int32(377831), int32(0))
						mBase = m.M
						v124 = m.ExcPending
						if v124 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(521213), int32(454), int32(239360))
							mBase = m.M
							v129 = m.ExcPending
							if v129 != 0 {
								return int32(0)
			...
			if v22 != 0 {
				...
				if v19 == int32(0) {
					...
					if v27 != 0 {
						...
						F_errmsg(m, int32(344534), int32(0))
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(268435455)
							F_errdetail(m, int32(620035), v7)
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
							} else {
								F_errsave_finish(m, v18, int32(521213), int32(284), int32(293799))
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return int32(0)
	...
	default:
		...
		if v71 != 0 {
			...
			F_errmsg_internal(m, int32(384231), int32(0))
			mBase = m.M
			v75 = m.ExcPending
			if v75 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(521213), int32(424), int32(239360))
				mBase = m.M
				v80 = m.ExcPending
				if v80 != 0 {
					return int32(0)
...
func F_jsonb_populate_record(m *base.Module, l0 int32) int32 {
	...
	_ = v9
	v3 = int32(0)
	v6 = F_populate_record_worker(m, l0, int32(437455), v3, int32(1), v3)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_jsonb_populate_recordset(m *base.Module, l0 int32) int32 {
	var v8 int32
	_ = v8
	F_populate_recordset_worker(m, l0, int32(112384), int32(0), int32(1))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
L17:
	;
	F_errmsg(m, int32(180470), int32(0))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L15
...
L19:
	;
	F_errfinish(m, int32(514851), int32(68), int32(299508))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L15
...
L41:
	;
	F_errfinish(m, int32(514851), int32(149), int32(299508))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L15
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v128
	F_errmsg(m, int32(459715), v14+int32(16))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L15
...
L46:
	;
	F_errhint(m, int32(600822), int32(0))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L15
...
L48:
	;
	F_errfinish(m, int32(514851), int32(102), int32(299508))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L15
...
L60:
	;
	F_errhint(m, int32(600761), int32(0))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L15
...
L62:
	;
	F_errfinish(m, int32(514851), int32(116), int32(299508))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L15
...
L65:
	;
	F_errmsg(m, int32(382698), int32(0))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L15
...
L67:
	;
	F_errfinish(m, int32(514851), int32(137), int32(299508))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L15
...
L18:
	;
	F_errmsg_internal(m, int32(26176), int32(0))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(514510), int32(5649), int32(164865))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L123:
	;
	F_errhint(m, int32(692969), int32(0))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L1
...
L124:
	;
	F_errfinish(m, int32(514510), int32(5644), int32(164865))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L1
...
L129:
	;
	F_errmsg(m, int32(344579), int32(0))
	mBase = m.M
	v397 = m.ExcPending
	if v397 != 0 {
		goto L1
...
L131:
	;
	F_errfinish(m, int32(514510), int32(5622), int32(164865))
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L1
...
L134:
	;
	F_errfinish(m, int32(514510), int32(5654), int32(164865))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L137:
	;
	F_errmsg(m, int32(457418), int32(0))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L1
...
L138:
	;
	F_errfinish(m, int32(514510), int32(5614), int32(164865))
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L1
