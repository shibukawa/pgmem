...
L120:
	;
	F_errmsg_internal(m, int32(346278), int32(0))
	mBase = m.M
	v570 = m.ExcPending
	if v570 != 0 {
		goto L18
...
L121:
	;
	F_errfinish(m, int32(488500), int32(1002), int32(63244))
	mBase = m.M
	v575 = m.ExcPending
	if v575 != 0 {
		goto L18
...
L123:
	;
	F_errmsg_internal(m, int32(21182), int32(0))
	mBase = m.M
	v583 = m.ExcPending
	if v583 != 0 {
		goto L18
...
L124:
	;
	F_errfinish(m, int32(488500), int32(967), int32(63244))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L18
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(308621))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(267568))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
L6:
	;
	v118 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v7)+32)) = uint8(v118)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = int32(3)
	goto L2
L7:
	;
	v114 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v7)+32)) = uint8(v114)
	*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = int32(3)
	goto L2
L8:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+28)) = int32(2)
	...
	v106 = F_DirectInputFunctionCallSafe(m, int32(408), l1, int32(-1), v103, v7+int32(24))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L28
...
L10:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v69
	if base.Ui32(v69) < base.Ui32(int32(268435456)) {
		goto L3
	} else {
		goto L27
	}
...
L31:
	;
	F_errmsg(m, int32(324705), int32(0))
	mBase = m.M
	v87 = m.ExcPending
	if v87 != 0 {
		goto L28
...
L33:
	;
	F_errsave_finish(m, v74, int32(491074), int32(284), int32(277754))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L28
...
L36:
	;
	v110 = *(*int32)(unsafe.Add(mBase, uint32(v7)+24))
	v111 = F_pg_detoast_datum(m, v110)
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L28
...
L37:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v111
	goto L2
L38:
	;
	F_errmsg_internal(m, int32(362442), int32(0))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L28
...
L39:
	;
	F_errfinish(m, int32(491074), int32(424), int32(225795))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L28
...
L41:
	;
	v142 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v7)+16)) = uint8(v142)
	*(*int64)(unsafe.Add(mBase, uint32(v7)+4)) = int64(4294967312)
	v146 = int32(4)
	v149 = F_pushJsonbValue(m, l0, v146, v7+v146)
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L28
...
L43:
	;
	v164 = *(*int32)(unsafe.Add(mBase, uint32(v139)))
	switch v164 - int32(16) {
	case 0:
		goto L48
	case 1:
		goto L50
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v149
	v155 = F_pushJsonbValue(m, l0, int32(3), v7+int32(28))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L28
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v155
	v158 = int32(0)
	v161 = F_pushJsonbValue(m, l0, int32(5), v158)
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L28
...
L48:
	;
	v189 = F_pushJsonbValue(m, l0, int32(3), v7+int32(28))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L28
...
L50:
	;
	v170 = F_pushJsonbValue(m, l0, int32(2), v7+int32(28))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L28
...
L52:
	;
	F_errmsg_internal(m, int32(356419), int32(0))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L28
...
L53:
	;
	F_errfinish(m, int32(491074), int32(454), int32(225795))
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L28
...
func F_jsonb_populate_record(m *base.Module, l0 int32) int32 {
	...
	_ = v9
	v3 = int32(0)
	v6 = F_populate_record_worker(m, l0, int32(413183), v3, int32(1), v3)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_jsonb_populate_recordset(m *base.Module, l0 int32) int32 {
	var v8 int32
	_ = v8
	F_populate_recordset_worker(m, l0, int32(104102), int32(0), int32(1))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
L19:
	;
	F_errfinish(m, int32(486124), int32(68), int32(283104))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L15
...
L41:
	;
	F_errfinish(m, int32(486124), int32(149), int32(283104))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L15
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v128
	F_errmsg(m, int32(434776), v14+int32(16))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L15
...
L46:
	;
	F_errhint(m, int32(553179), int32(0))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L15
...
L48:
	;
	F_errfinish(m, int32(486124), int32(102), int32(283104))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L15
...
L60:
	;
	F_errhint(m, int32(553118), int32(0))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L15
...
L62:
	;
	F_errfinish(m, int32(486124), int32(116), int32(283104))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L15
...
L65:
	;
	F_errmsg(m, int32(361007), int32(0))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L15
...
L67:
	;
	F_errfinish(m, int32(486124), int32(137), int32(283104))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L15
...
L18:
	;
	F_errmsg_internal(m, int32(25448), int32(0))
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L1
...
L19:
	;
	F_errfinish(m, int32(485799), int32(5649), int32(153864))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L123:
	;
	F_errhint(m, int32(642400), int32(0))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L1
...
L124:
	;
	F_errfinish(m, int32(485799), int32(5644), int32(153864))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L1
...
L129:
	;
	F_errmsg(m, int32(324750), int32(0))
	mBase = m.M
	v397 = m.ExcPending
	if v397 != 0 {
		goto L1
...
L131:
	;
	F_errfinish(m, int32(485799), int32(5622), int32(153864))
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L1
...
L134:
	;
	F_errfinish(m, int32(485799), int32(5654), int32(153864))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L137:
	;
	F_errmsg(m, int32(432520), int32(0))
	mBase = m.M
	v432 = m.ExcPending
	if v432 != 0 {
		goto L1
...
L138:
	;
	F_errfinish(m, int32(485799), int32(5614), int32(153864))
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L1
