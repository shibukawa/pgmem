...
L120:
	;
	F_errmsg_internal(m, int32(368826), int32(0))
	mBase = m.M
	v570 = m.ExcPending
	if v570 != 0 {
		goto L18
...
L121:
	;
	F_errfinish(m, int32(520246), int32(1002), int32(69673))
	mBase = m.M
	v575 = m.ExcPending
	if v575 != 0 {
		goto L18
...
L124:
	;
	F_errfinish(m, int32(520246), int32(967), int32(69673))
	mBase = m.M
	v588 = m.ExcPending
	if v588 != 0 {
		goto L18
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(328036))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
	...
	if v14 != 0 {
		...
		if v20 != 0 {
			...
			if v19 != 0 {
				...
				default:
					F_cannotCastJsonbValue(m, v21, int32(284050))
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
...
func F_jsonb_in_scalar(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
				...
				*(*int64)(unsafe.Add(mBase, uint32(v7)+4)) = int64(4294967312)
				...
				default:
					...
					if v120 != 0 {
						...
						F_errmsg_internal(m, int32(379381), int32(0))
						mBase = m.M
						v124 = m.ExcPending
						if v124 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(523606), int32(454), int32(240393))
							mBase = m.M
							v129 = m.ExcPending
							if v129 != 0 {
								return int32(0)
			...
			if v22 != 0 {
				...
				if v19 == int32(0) {
					...
					if v27 != 0 {
						...
						F_errmsg(m, int32(346042), int32(0))
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return int32(0)
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(268435455)
							F_errdetail(m, int32(623342), v7)
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
							} else {
								F_errsave_finish(m, v18, int32(523606), int32(284), int32(295027))
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return int32(0)
	...
	default:
		...
		if v71 != 0 {
			...
			F_errmsg_internal(m, int32(385829), int32(0))
			mBase = m.M
			v75 = m.ExcPending
			if v75 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(523606), int32(424), int32(240393))
				mBase = m.M
				v80 = m.ExcPending
				if v80 != 0 {
					return int32(0)
...
func F_jsonb_populate_record(m *base.Module, l0 int32) int32 {
	...
	_ = v9
	v3 = int32(0)
	v6 = F_populate_record_worker(m, l0, int32(439586), v3, int32(1), v3)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_jsonb_populate_recordset(m *base.Module, l0 int32) int32 {
	var v8 int32
	_ = v8
	F_populate_recordset_worker(m, l0, int32(112757), int32(0), int32(1))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
L17:
	;
	F_errmsg(m, int32(181360), int32(0))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L15
...
L19:
	;
	F_errfinish(m, int32(517234), int32(68), int32(300759))
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L15
...
L41:
	;
	F_errfinish(m, int32(517234), int32(149), int32(300759))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L15
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v128
	F_errmsg(m, int32(461872), v14+int32(16))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L15
...
L46:
	;
	F_errhint(m, int32(604089), int32(0))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L15
...
L48:
	;
	F_errfinish(m, int32(517234), int32(102), int32(300759))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L15
...
L60:
	;
	F_errhint(m, int32(604028), int32(0))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L15
...
L62:
	;
	F_errfinish(m, int32(517234), int32(116), int32(300759))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L15
...
L65:
	;
	F_errmsg(m, int32(384296), int32(0))
	mBase = m.M
	v215 = m.ExcPending
	if v215 != 0 {
		goto L15
...
L67:
	;
	F_errfinish(m, int32(517234), int32(137), int32(300759))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L15
...
L19:
	;
	F_errfinish(m, int32(516846), int32(5649), int32(165676))
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L123:
	;
	F_errhint(m, int32(696440), int32(0))
	mBase = m.M
	v370 = m.ExcPending
	if v370 != 0 {
		goto L1
...
L124:
	;
	F_errfinish(m, int32(516846), int32(5644), int32(165676))
	mBase = m.M
	v375 = m.ExcPending
	if v375 != 0 {
		goto L1
...
L129:
	;
	F_errmsg(m, int32(346087), int32(0))
	mBase = m.M
	v397 = m.ExcPending
	if v397 != 0 {
		goto L1
...
L131:
	;
	F_errfinish(m, int32(516846), int32(5622), int32(165676))
	mBase = m.M
	v406 = m.ExcPending
	if v406 != 0 {
		goto L1
...
L134:
	;
	F_errfinish(m, int32(516846), int32(5654), int32(165676))
	mBase = m.M
	v421 = m.ExcPending
	if v421 != 0 {
		goto L1
...
L138:
	;
	F_errfinish(m, int32(516846), int32(5614), int32(165676))
	mBase = m.M
	v437 = m.ExcPending
	if v437 != 0 {
		goto L1
