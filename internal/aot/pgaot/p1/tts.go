...
L6:
	;
	F_errmsg(m, int32(_a_F_tts_heap_is_current_xact_tuple_0), int32(0))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		goto L4
...
L7:
	;
	F_errfinish(m, int32(_a_F_tts_heap_is_current_xact_tuple_1), int32(391), int32(_a_F_tts_heap_is_current_xact_tuple_2))
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L4
...
L12:
	;
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_tts_heap_is_current_xact_tuple[0]))
	if v35 == v24 {
		goto L13
	} else {
		goto L14
...
L15:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _c_F_tts_heap_is_current_xact_tuple[1]))
	if v39 <= int32(0) {
		goto L17
	} else {
		goto L18
...
L17:
	;
	v43 = *(*int32)(unsafe.Add(mBase, _c_F_tts_heap_is_current_xact_tuple[2]))
	if v43 == int32(0) {
		v136 = int32(0)
		goto L16
	} else {
...
L19:
	;
	v105 = *(*int32)(unsafe.Add(mBase, _c_F_tts_heap_is_current_xact_tuple[3]))
	v107 = int32(0)
	v109 = v39 - int32(1)
	goto L39
L20:
