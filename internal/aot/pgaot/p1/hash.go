...
L238:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = v931
	F_errmsg_internal(m, int32(504729), v18)
	mBase = m.M
	v935 = m.ExcPending
	if v935 != 0 {
		goto L1
...
L239:
	;
	F_errfinish(m, int32(518911), int32(672), int32(314478))
	mBase = m.M
	v940 = m.ExcPending
	if v940 != 0 {
		goto L1
...
L264:
	;
	F_errmsg(m, int32(404378), int32(0))
	mBase = m.M
	v1055 = m.ExcPending
	if v1055 != 0 {
		goto L1
...
L265:
	;
	F_errfinish(m, int32(518911), int32(1260), int32(340539))
	mBase = m.M
	v1060 = m.ExcPending
	if v1060 != 0 {
		goto L1
...
L269:
	;
	F_errfinish(m, int32(518911), int32(1230), int32(340539))
	mBase = m.M
	v1077 = m.ExcPending
	if v1077 != 0 {
		goto L1
...
L125:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v395)+136)) = v446
	...
	v456 = F_AllocSetContextCreateInternal(m, v451, int32(68072), v404, int32(8192), int32(8388608))
	mBase = m.M
	v457 = m.ExcPending
	if v457 != 0 {
		goto L124
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v395)+116)) = v456
	v463 = F_AllocSetContextCreateInternal(m, v456, int32(67935), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v464 = m.ExcPending
	if v464 != 0 {
		goto L124
...
L127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v395)+120)) = v463
	...
	v471 = F_AllocSetContextCreateInternal(m, v466, int32(67838), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v472 = m.ExcPending
	if v472 != 0 {
		goto L124
...
L69:
	;
	F_errmsg_internal(m, int32(110058), int32(0))
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L1
...
L70:
	;
	F_errfinish(m, int32(520259), int32(461), int32(109719))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L1
...
L101:
	;
	F_errmsg_internal(m, int32(540112), int32(0))
	mBase = m.M
	v531 = m.ExcPending
	if v531 != 0 {
		goto L1
...
L102:
	;
	F_errfinish(m, int32(522195), int32(140), int32(353841))
	mBase = m.M
	v536 = m.ExcPending
	if v536 != 0 {
		goto L1
...
L233:
	;
	F_errfinish(m, int32(520259), int32(285), int32(424665))
	mBase = m.M
	v1238 = m.ExcPending
	if v1238 != 0 {
		goto L1
			...
			if v103 != 0 {
				...
				if v106 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v9)+64)) = v107 + int32(4)
					F_errmsg(m, int32(51642), v9-int32(-64))
					mBase = m.M
					v135 = m.ExcPending
					if v135 != 0 {
						return
						...
						if v139 != 0 {
							...
							F_errfinish(m, int32(520220), int32(237), int32(424711))
							mBase = m.M
							v144 = m.ExcPending
							if v144 != 0 {
								return
					...
					if v148 != 0 {
						...
						if v151 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = v152 + int32(4)
							F_errmsg(m, int32(51642), v9+int32(16))
							mBase = m.M
							v180 = m.ExcPending
							if v180 != 0 {
								return
								...
								if v184 != 0 {
									...
									F_errfinish(m, int32(520220), int32(249), int32(424711))
									mBase = m.M
									v189 = m.ExcPending
									if v189 != 0 {
										return
							...
							if v193 != 0 {
								...
								if v196 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v9)+48)) = v197 + int32(4)
									F_errmsg(m, int32(29437), v9+int32(48))
									mBase = m.M
									v205 = m.ExcPending
									if v205 != 0 {
										return
									} else {
										F_errfinish(m, int32(520220), int32(263), int32(424711))
										mBase = m.M
										v210 = m.ExcPending
										if v210 != 0 {
											return
								...
								if v214 != 0 {
									...
									if v217 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v218 + int32(4)
										F_errmsg(m, int32(283314), v9+int32(32))
										mBase = m.M
										v226 = m.ExcPending
										if v226 != 0 {
											return
											...
											if v230 != 0 {
												...
												F_errfinish(m, int32(520220), int32(270), int32(424711))
												mBase = m.M
												v235 = m.ExcPending
												if v235 != 0 {
													return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = v64 + int32(4)
				...
				if v90 != 0 {
					...
					if v94 != 0 {
						...
						F_errfinish(m, int32(520220), int32(226), int32(424711))
						mBase = m.M
						v99 = m.ExcPending
						if v99 != 0 {
							return
	...
	if l1 != int32(-1) {
		...
		if v21 != 0 {
			...
			if v25 != 0 {
				...
				F_errfinish(m, int32(522195), int32(75), int32(353858))
				v30 = m.ExcPending
				if v30 != 0 {
					return int32(0)
				} else {
		...
		if l1 != int32(-1) {
			if base.Ui32(v10) < base.Ui32(l1) {
				...
				if v170 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v171 + int32(4)
					F_errmsg_internal(m, int32(726102), v8)
					mBase = m.M
					v177 = m.ExcPending
					if v177 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(522195), int32(207), int32(353814))
						mBase = m.M
						v182 = m.ExcPending
						if v182 != 0 {
							return int32(0)
							...
							*(*uint16)(unsafe.Add(mBase, uint32(v108)+14)) = uint16(v147)
							...
							if v54 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v73
								F_errmsg_internal(m, int32(57787), v8+int32(16))
								mBase = m.M
								v80 = m.ExcPending
								if v80 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(522195), int32(216), int32(353814))
									mBase = m.M
									v85 = m.ExcPending
									if v85 != 0 {
										return int32(0)
			...
			if v157 != 0 {
				...
				if v161 != 0 {
					...
					F_errfinish(m, int32(522195), int32(204), int32(353814))
					mBase = m.M
					v166 = m.ExcPending
					if v166 != 0 {
						return int32(0)
		...
		if v16 != 0 {
			...
			if v19 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v5))) = v20
				F_errmsg(m, int32(25838), v5)
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(516846), int32(3937), int32(88238))
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
	...
	if v7 == int32(1) {
		...
		if v13 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5))) = v14
			F_errmsg_internal(m, int32(464657), v5)
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return
			} else {
				F_errfinish(m, int32(520716), int32(1790), int32(464433))
				mBase = m.M
				v23 = m.ExcPending
				if v23 != 0 {
					return
		...
		if v27 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v28
			F_errmsg_internal(m, int32(464657), v5+int32(16))
			mBase = m.M
			v34 = m.ExcPending
			if v34 != 0 {
				return
			} else {
				F_errfinish(m, int32(520716), int32(1792), int32(464433))
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return
...
L37:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15))) = v22
	F_errmsg_internal(m, int32(387178), v15)
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L1
...
L38:
	;
	F_errfinish(m, int32(516309), int32(558), int32(416527))
	mBase = m.M
	v174 = m.ExcPending
	if v174 != 0 {
		goto L1
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v183
	F_errmsg(m, int32(199567), v15+int32(16))
	mBase = m.M
	v190 = m.ExcPending
	if v190 != 0 {
		goto L1
...
L43:
	;
	F_errfinish(m, int32(516309), int32(2807), int32(418712))
	mBase = m.M
	v195 = m.ExcPending
	if v195 != 0 {
		goto L1
									...
									if v58 != int32(1) {
										...
										if v165 != 0 {
											...
											if v171 != 0 {
												...
												F_errfinish(m, int32(517070), int32(338), int32(159709))
												mBase = m.M
												v178 = m.ExcPending
												if v178 != 0 {
													return int32(0)
				...
				if v145 != 0 {
					...
					if v148 != 0 {
						...
						if v154 != 0 {
							...
							F_errfinish(m, int32(517070), int32(316), int32(159709))
							mBase = m.M
							v161 = m.ExcPending
							if v161 != 0 {
								return int32(0)
...
func F_hash_seq_init_with_hash_value(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+12)) = uint8(v4)
	...
	if v16 == v4 {
		v20 = *(*int32)(unsafe.Add(mBase, _consts[1190]))
		if int32(100) <= v20 {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v80 = m.ExcPending
			if v80 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = v81
				F_errmsg_internal(m, int32(741648), v9)
				mBase = m.M
				v85 = m.ExcPending
				if v85 != 0 {
					return
				} else {
					F_errfinish(m, int32(520716), int32(1872), int32(297257))
					mBase = m.M
					v90 = m.ExcPending
					if v90 != 0 {
						return
			...
			*(*int32)(unsafe.Add(mBase, uint32(v20<<(uint(int32(2))%32))+uint32(_consts[1191]))) = l1
			v29 = *(*int32)(unsafe.Add(mBase, _consts[4]))
			v30 = *(*int32)(unsafe.Add(mBase, uint32(v29)+28))
			v31 = int32(4547680)
			v32 = *(*int32)(unsafe.Add(mBase, _consts[1190]))
			*(*int32)(unsafe.Add(mBase, uint32(v32<<(uint(int32(2))%32))+uint32(_consts[1192]))) = v30
			*(*int32)(unsafe.Add(mBase, _consts[1190])) = v32 + int32(1)
...
L13:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _consts[1190]))
	v46 = v44
	goto L14
L14:
	;
...
L15:
	...
	v68 = int32(2)
	v69 = v67 << (uint(v68) % 32)
	v72 = *(*int32)(unsafe.Add(mBase, uint32(v69)+uint32(_consts[1191])))
	*(*int32)(unsafe.Add(mBase, uint32(v61)+uint32(_consts[1191]))) = v72
	v80 = *(*int32)(unsafe.Add(mBase, uint32(v69)+uint32(_consts[1192])))
	*(*int32)(unsafe.Add(mBase, uint32(v57<<(uint(v68)%32))+uint32(_consts[1192]))) = v80
	*(*int32)(unsafe.Add(mBase, _consts[1190])) = v67
	v269 = int32(0)
	goto L4
L16:
	;
	v61 = v57 << (uint(int32(2)) % 32)
	v64 = *(*int32)(unsafe.Add(mBase, uint32(v61)+uint32(_consts[1191])))
	if v64 != v41 {
		v46 = v57
		goto L14
	} else {
...
L27:
	;
	v103 = *(*int32)(unsafe.Add(mBase, _consts[1190]))
	v105 = v103
	goto L28
L28:
	;
...
L29:
	...
	v131 = *(*int32)(unsafe.Add(mBase, uint32(v128)+uint32(_consts[1191])))
	*(*int32)(unsafe.Add(mBase, uint32(v120)+uint32(_consts[1191]))) = v131
	v139 = *(*int32)(unsafe.Add(mBase, uint32(v128)+uint32(_consts[1192])))
	*(*int32)(unsafe.Add(mBase, uint32(v116<<(uint(v127)%32))+uint32(_consts[1192]))) = v139
	*(*int32)(unsafe.Add(mBase, _consts[1190])) = v126
	v269 = int32(0)
	goto L4
L30:
	;
	v120 = v116 << (uint(int32(2)) % 32)
	v123 = *(*int32)(unsafe.Add(mBase, uint32(v120)+uint32(_consts[1191])))
	if v123 != v96 {
		v105 = v116
		goto L28
	} else {
...
L40:
	;
	v179 = *(*int32)(unsafe.Add(mBase, _consts[1190]))
	v181 = v179
	goto L41
L41:
	;
...
L42:
	...
	v207 = *(*int32)(unsafe.Add(mBase, uint32(v204)+uint32(_consts[1191])))
	*(*int32)(unsafe.Add(mBase, uint32(v196)+uint32(_consts[1191]))) = v207
	v215 = *(*int32)(unsafe.Add(mBase, uint32(v204)+uint32(_consts[1192])))
	*(*int32)(unsafe.Add(mBase, uint32(v192<<(uint(v203)%32))+uint32(_consts[1192]))) = v215
	*(*int32)(unsafe.Add(mBase, _consts[1190])) = v202
	v269 = int32(0)
	goto L4
L43:
	;
	v196 = v192 << (uint(int32(2)) % 32)
	v199 = *(*int32)(unsafe.Add(mBase, uint32(v196)+uint32(_consts[1191])))
	if v199 != v96 {
		v181 = v192
		goto L41
	} else {
...
L50:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v280
	F_errmsg_internal(m, int32(751388), v14)
	mBase = m.M
	v284 = m.ExcPending
	if v284 != 0 {
		goto L49
...
L51:
	;
	F_errfinish(m, int32(520716), int32(1896), int32(297255))
	mBase = m.M
	v289 = m.ExcPending
	if v289 != 0 {
		goto L49
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v294
	F_errmsg_internal(m, int32(751388), v14+int32(16))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L49
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v310
	F_errmsg_internal(m, int32(751388), v14+int32(32))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L49
...
L2:
	;
	v15 = *(*int32)(unsafe.Add(mBase, _consts[1190]))
	v16 = v15
	goto L5
L3:
	;
...
L6:
	...
	v33 = int32(2)
	v34 = v32 << (uint(v33) % 32)
	v37 = *(*int32)(unsafe.Add(mBase, uint32(v34)+uint32(_consts[1191])))
	*(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_consts[1191]))) = v37
	v45 = *(*int32)(unsafe.Add(mBase, uint32(v34)+uint32(_consts[1192])))
	*(*int32)(unsafe.Add(mBase, uint32(v22<<(uint(v33)%32))+uint32(_consts[1192]))) = v45
	*(*int32)(unsafe.Add(mBase, _consts[1190])) = v32
	goto L4
L7:
	;
	v26 = v22 << (uint(int32(2)) % 32)
	v29 = *(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_consts[1191])))
	if v29 != v10 {
		v16 = v22
		goto L5
	} else {
...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v61
	F_errmsg_internal(m, int32(751388), v8)
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L9
