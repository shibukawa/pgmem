...
func F_SPI_datumTransfer(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v6 == int32(0) {
		...
		if v14 != 0 {
			...
			F_errmsg_internal(m, int32(530875), int32(0))
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(494584), int32(1367), int32(224237))
				mBase = m.M
				v23 = m.ExcPending
				if v23 != 0 {
					return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errfinish(m, int32(494584), int32(241), int32(100209))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		v284 = v32
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errfinish(m, int32(494584), int32(256), int32(100209))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		v284 = v32
...
L62:
	;
	F_errfinish(m, int32(496054), int32(1619), int32(61832))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L1
...
L65:
	;
	F_errfinish(m, int32(496054), int32(1621), int32(61832))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L1
