...
func F_SPI_datumTransfer(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v6 == int32(0) {
		...
		if v14 != 0 {
			...
			F_errmsg_internal(m, int32(555090), int32(0))
			mBase = m.M
			v18 = m.ExcPending
			if v18 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(517790), int32(1367), int32(234739))
				mBase = m.M
				v23 = m.ExcPending
				if v23 != 0 {
					return int32(0)
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errmsg(m, int32(271883), int32(0))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		v284 = v32
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errfinish(m, int32(517790), int32(241), int32(106761))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		v284 = v32
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errmsg(m, int32(357186), int32(0))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		v284 = v32
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+24)) = v32
	*(*int32)(unsafe.Add(mBase, uint32(v13)+28)) = v29
	F_errfinish(m, int32(517790), int32(256), int32(106761))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		v284 = v32
...
func F__SPI_make_plan_non_temp(m *base.Module, l0 int32) int32 {
	...
	v16 = F_AllocSetContextCreateInternal(m, v11, int32(294790), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		goto L1
...
L61:
	;
	F_errmsg_internal(m, int32(65747), int32(0))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L1
...
L62:
	;
	F_errfinish(m, int32(519326), int32(1619), int32(67249))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L1
...
L64:
	;
	F_errmsg_internal(m, int32(65693), int32(0))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L1
...
L65:
	;
	F_errfinish(m, int32(519326), int32(1621), int32(67249))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L1
