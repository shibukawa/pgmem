...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v39 + int32(4)
	F_errmsg_internal(m, int32(688296), v11)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(488518), int32(1842), int32(72957))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
									...
									if v48 != 0 {
										...
										if v51 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
											F_errmsg(m, int32(71172), v10)
											mBase = m.M
											v55 = m.ExcPending
											if v55 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(485784), int32(3202), int32(427564))
												mBase = m.M
												v60 = m.ExcPending
												if v60 != 0 {
													return int32(0)
