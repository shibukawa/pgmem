...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v39 + int32(4)
	F_errmsg_internal(m, int32(692221), v11)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L18:
	;
	F_errfinish(m, int32(491579), int32(1842), int32(73432))
	mBase = m.M
	v59 = m.ExcPending
	if v59 != 0 {
		goto L1
									...
									if v48 != 0 {
										...
										if v51 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v10))) = l0
											F_errmsg(m, int32(71647), v10)
											mBase = m.M
											v55 = m.ExcPending
											if v55 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(488808), int32(3202), int32(429934))
												mBase = m.M
												v60 = m.ExcPending
												if v60 != 0 {
													return int32(0)
