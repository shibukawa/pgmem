...
func F_GetDatabaseEncodingName(m *base.Module) int32 {
	...
	var v3 int32
	_ = v3
	v2 = *(*int32)(unsafe.Add(mBase, _c_F_GetDatabaseEncodingName[0]))
...
func F_LockDatabaseObject(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = l0
	v16 = *(*int32)(unsafe.Add(mBase, _c_F_LockDatabaseObject[0]))
...
func F_get_database_list(m *base.Module) int32 {
	...
	v11 = v9 - int32(16)
	m.G0 = v11
	v14 = *(*int32)(unsafe.Add(mBase, _c_F_get_database_list[0]))
...
L15:
	;
	v60 = int32(_a_F_get_database_list_0)
	v61 = *(*int32)(unsafe.Add(mBase, _c_F_get_database_list[0]))
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v39 + int32(4)
	F_errmsg_internal(m, int32(_a_F_get_database_list_1), v11)
	mBase = m.M
	v54 = m.ExcPending
	if v54 != 0 {
		goto L1
...
L22:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_get_database_list[0])) = v61
	v86 = v80
	goto L11
L23:
	;
