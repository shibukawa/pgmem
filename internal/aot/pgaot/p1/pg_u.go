...
L3:
	;
	v93 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_c_F_pg_u_isalnum[0]))))
	v100 = v93
	goto L2
L4:
	;
...
L7:
	;
	v68 = int32(1)
	v73 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(v68)%32))+uint32(_c_F_pg_u_isalnum[1]))))
	if v73&v68 != 0 {
		v111 = v68
		goto L1
	} else {
...
L5:
	;
	v46 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v24)+uint32(_c_F_pg_u_isdigit[0]))))
	v52 = v46
	goto L4
L6:
	;
...
L8:
	;
	v45 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_c_F_pg_u_isdigit[1]))))
	v52 = v45
	goto L4
L9:
	;
...
L4:
	...
	v21 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_c_F_pg_u_islower[0])))
...
L9:
	;
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_c_F_pg_u_islower[1])))
	if base.Ui32(v27) <= base.Ui32(l0) {
		goto L10
	} else {
		goto L11
