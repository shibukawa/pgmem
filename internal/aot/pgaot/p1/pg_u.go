...
L3:
	;
	v93 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_consts[647]))))
	v100 = v93
	goto L2
L4:
	;
...
L7:
	;
	v68 = int32(1)
	v73 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(v68)%32))+uint32(_consts[640]))))
	if v73&v68 != 0 {
		v111 = v68
		goto L1
	} else {
...
L8:
	...
	v23 = *(*int32)(unsafe.Add(mBase, uint32(v20)+uint32(_consts[641])))
...
L13:
	;
	v29 = *(*int32)(unsafe.Add(mBase, uint32(v20)+uint32(_consts[642])))
...
L19:
	;
	v67 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v50)+uint32(_consts[646]))))
	v100 = v67
	goto L2
L20:
	;
	...
	v50 = v48 * int32(12)
	v53 = *(*int32)(unsafe.Add(mBase, uint32(v50)+uint32(_consts[648])))
...
L25:
	;
	v59 = *(*int32)(unsafe.Add(mBase, uint32(v50)+uint32(_consts[649])))
...
L5:
	;
	v46 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v24)+uint32(_consts[646]))))
	v52 = v46
	goto L4
L6:
	;
...
L8:
	;
	v45 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_consts[647]))))
	v52 = v45
	goto L4
L9:
	;
	...
	v24 = v22 * int32(12)
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v24)+uint32(_consts[648])))
...
L14:
	;
	v33 = *(*int32)(unsafe.Add(mBase, uint32(v24)+uint32(_consts[649])))
...
L4:
	...
	v21 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_consts[1262])))
...
L9:
	;
	v27 = *(*int32)(unsafe.Add(mBase, uint32(v18)+uint32(_consts[1263])))
	if base.Ui32(v27) <= base.Ui32(l0) {
		goto L10
	} else {
		goto L11
