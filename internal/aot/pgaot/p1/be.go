...
func F_be_lo_creat(m *base.Module, l0 int32) int32 {
	...
	var v12 int32
	_ = v12
	F_PreventCommandIfReadOnly(m, int32(717545))
	mBase = m.M
	v6 = m.ExcPending
	if v6 != 0 {
		return int32(0)
		...
		v8 = int32(1)
		*(*uint8)(unsafe.Add(mBase, _consts[446])) = uint8(v8)
		v11 = F_inv_create(m, int32(0))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(520635), int32(821), int32(102001))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
