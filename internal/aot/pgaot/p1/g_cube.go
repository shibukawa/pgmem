...
func F_g_cube_picksplit(m *base.Module, l0 int32) int32 {
	...
	v33 = (v29 + int32(65534)) & int32(65535)
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v27)+4)) = v446
	...
	v452 = int32(4)
	v453 = v28 + v452
	v459 = *(*int32)(unsafe.Add(mBase, uint32(v453+v436&int32(65535)<<(uint(v452)%32))))
...
L49:
	;
	v605 = *(*int32)(unsafe.Add(mBase, uint32(v453+v437&int32(65535)<<(uint(int32(4))%32))))
...
L78:
	;
	v1134 = v759 + int32(1)
	v1136 = v1134 & int32(65535)
	if base.Ui32(v1136) <= base.Ui32((v29-v750)&int32(65535)) {
		v757 = v1136
		v759 = v1134
		v761 = v1113
		v765 = v1117
