...
L66:
	;
	v331 = int32(_a_F_PostgresMainLongJmp_0)
	v333 = *(*int32)(unsafe.Add(mBase, _c_F_PostgresMainLongJmp[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_PostgresMainLongJmp[0])) = v333 - int32(1)
	return
L67:
	;
