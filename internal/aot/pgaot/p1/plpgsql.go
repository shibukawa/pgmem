...
L2:
	;
	v10 = *(*int32)(unsafe.Add(mBase, _consts[1272]))
	v13 = v6
	goto L5
L3:
	;
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v57)+12)) = v66
	v73 = *(*int32)(unsafe.Add(mBase, _consts[1272]))
	v76 = *(*int32)(unsafe.Add(mBase, _consts[1273]))
	v79 = *(*int32)(unsafe.Add(mBase, _consts[1274]))
	if v76 == v79 {
		goto L20
	} else {
		goto L21
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1274])) = v76 << (uint(int32(1)) % 32)
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, _consts[1273])) = v97 + int32(1)
...
L23:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1272])) = v91
	v96 = *(*int32)(unsafe.Add(mBase, _consts[1273]))
	v97 = v96
	v98 = v91
	goto L22
}
func F_plpgsql_compile(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v9 = F_cached_function_compile(m, l0, v4, int32(5324), int32(4751), int32(536), int32(0), l1)
	mBase = m.M
	v12 = m.ExcPending
	if v12 != 0 {
		return int32(0)
...
func F_plpgsql_create_econtext(m *base.Module, l0 int32) {
	...
	if v5 == int32(0) {
		v9 = *(*int32)(unsafe.Add(mBase, _consts[1275]))
		if v9 == int32(0) {
			v12 = int32(4442576)
			...
			*(*int32)(unsafe.Add(mBase, _consts[3])) = v15
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _consts[1275])) = v17
				v22 = v17
				*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v22
				v26 = v22
				v29 = *(*int32)(unsafe.Add(mBase, uint32(l0)+84))
				if v29 == int32(0) {
					v33 = *(*int32)(unsafe.Add(mBase, _consts[1276]))
					if v33 == int32(0) {
						v40 = *(*int32)(unsafe.Add(mBase, _consts[176]))
						v43 = F_ResourceOwnerCreate(m, v40, int32(136970))
						mBase = m.M
						v44 = m.ExcPending
						if v44 != 0 {
							return
						} else {
							*(*int32)(unsafe.Add(mBase, _consts[1276])) = v43
								...
								*(*int32)(unsafe.Add(mBase, uint32(l0)+120)) = v52
								...
								if v59 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v58)+4)) = v64
									v66 = int32(4535792)
									v67 = *(*int32)(unsafe.Add(mBase, _consts[1277]))
									*(*int32)(unsafe.Add(mBase, uint32(v58)+8)) = v67
									*(*int32)(unsafe.Add(mBase, _consts[1277])) = v58
									return
								}
							}
						}
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = int32(5329)
	*(*int32)(unsafe.Add(mBase, uint32(v8)+24)) = l1
	*(*int32)(unsafe.Add(mBase, uint32(v8)+148)) = int32(335513)
	v22 = int32(4435480)
...
L3:
	;
	v36 = *(*int32)(unsafe.Add(mBase, _consts[1280]))
...
L12:
	;
	v56 = *(*int32)(unsafe.Add(mBase, _consts[1280]))
...
L20:
	;
	v84 = *(*int32)(unsafe.Add(mBase, _consts[1280]))
...
L25:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v8)+148)) = int32(93470)
	v103 = *(*int32)(unsafe.Add(mBase, _consts[1280]))
...
L28:
	;
	v115 = int32(4535792)
	v116 = *(*int32)(unsafe.Add(mBase, _consts[1277]))
...
L32:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1277])) = v117
...
L40:
	;
	F_errmsg(m, int32(504401), int32(0))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
...
L41:
	;
	F_errfinish(m, int32(476621), int32(1217), int32(212875))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L1
...
L39:
	;
	v120 = int32(0)
	v124 = F_format_elog_string(m, int32(605174), v120)
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L33
...
L126:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v152
	v379 = F_format_elog_string(m, int32(561961), v11)
	mBase = m.M
	v380 = m.ExcPending
	if v380 != 0 {
		goto L33
...
L130:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v152
	v397 = F_format_elog_string(m, int32(626402), v11+int32(16))
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L33
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v91
	F_errmsg_internal(m, int32(463545), v9)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L13
...
L28:
	;
	F_errfinish(m, int32(471811), int32(751), int32(12559))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L13
...
func F_plpgsql_getdiag_kindname(m *base.Module, l0 int32) int32 {
	...
	if base.Ui32(int32(12)) < base.Ui32(l0) {
		...
		v10 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(2))%32))+uint32(_consts[1282])))
		return v10
	}
}
func F_plpgsql_ns_top(m *base.Module) int32 {
	...
	var v2 int32
	_ = v2
	v2 = *(*int32)(unsafe.Add(mBase, _consts[1281]))
	return v2
}
...
L15:
	;
	v55 = F_expression_tree_walker_impl(m, v37, int32(5342), v12+int32(8))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L18
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l1)+16)) = int32(5343)
...
L41:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l1)+16)) = int32(5337)
...
L54:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l1)+16)) = int32(5338)
...
func F_plpgsql_scanner_init(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v14 = F_scanner_init(m, l0, v6, int32(4116900), int32(2118272))
		mBase = m.M
		v15 = m.ExcPending
		if v15 != 0 {
			return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+60)) = l0
			v19 = int32(0)
			*(*int32)(unsafe.Add(mBase, _consts[1283])) = v19
