...
L4:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v8)+16)) = uint32(v22)
	F_errmsg_internal(m, int32(536710), v8+int32(16))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L1
...
L7:
	;
	F_errfinish(m, int32(520401), int32(643), int32(94163))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L1
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v82
	F_errmsg_internal(m, int32(209399), v8)
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(520401), int32(654), int32(94163))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L29:
	;
	F_s_lock(m, v11, int32(520401), int32(667), int32(94163))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L1
...
L36:
	;
	F_errmsg_internal(m, int32(94964), int32(0))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(520401), int32(656), int32(94163))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L1
...
L2:
	...
	v34 = F_AllocSetContextCreateInternal(m, v28, int32(65282), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L1
...
L111:
	;
	v456 = F__emscripten_memcpy_bulkmem(m, v451, int32(4112276), int32(84))
	mBase = m.M
	goto L113
L113:
	;
		...
		if base.F64_gt(v8, float64(1)) != 0 {
			...
			if v114 != 0 {
				...
				if v117 != 0 {
					...
					F_errmsg(m, int32(419833), int32(0))
					mBase = m.M
					v121 = m.ExcPending
					if v121 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(515258), int32(1803), int32(287618))
						mBase = m.M
						v126 = m.ExcPending
						if v126 != 0 {
							return int32(0)
...
L2:
	;
	F_appendStringInfoString(m, l0, int32(223701))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L6
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = base.I64_rotl(v30, int64(32))
	F_appendStringInfo(m, l0, int32(41508), v10+int32(16))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L6
...
L5:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10))) = base.I64_rotl(v19, v21)
	F_appendStringInfo(m, l0, int32(41525), v10)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L6
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v58
	F_appendStringInfo(m, l0, int32(41663), v10+int32(32))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L6
	...
	*(*int32)(unsafe.Add(mBase, _consts[1367])) = v1
	...
	for {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v88)+uint32(_consts[1373]))) = uint8(v126)
		v128 = int32(-64)
		v132 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(4107840)+v124-v128))))
		*(*uint8)(unsafe.Add(mBase, uint32(int32(4647216)+v88-v128))) = uint8(v132)
		v135 = v88 + int32(2)
		if v135 != int32(64) {
			v88 = v135
			continue
	...
	*(*int64)(unsafe.Add(mBase, _consts[1420])) = v895
	...
	for {
		...
		for {
			...
			v1092 = int32(0)
			v1096 = v1091 + (int32(4664368) + v1064)
			*(*int32)(unsafe.Add(mBase, uint32(v1096))) = v1092
			v1102 = int32(4672560) + v1064 + v1091
			*(*int32)(unsafe.Add(mBase, uint32(v1102))) = v1092
			v1108 = int32(4680752) + v1064 + v1091
			*(*int32)(unsafe.Add(mBase, uint32(v1108))) = v1092
			v1114 = int32(4688944) + v1064 + v1091
		...
		for {
			...
			v1249 = int32(0)
			v1253 = v1248 + (int32(4697136) + v1221)
			*(*int32)(unsafe.Add(mBase, uint32(v1253))) = v1249
			v1259 = int32(4701232) + v1221 + v1248
			*(*int32)(unsafe.Add(mBase, uint32(v1259))) = v1249
			...
			v1455 = int32(0)
			v1460 = int32(4705328) + v1221 + v1248
			*(*int32)(unsafe.Add(mBase, uint32(v1460))) = v1455
			v1466 = int32(4709424) + v1221 + v1248
	...
	for {
		...
		v1765 = int32(0)
		for {
			v1793 = v1730<<(uint(int32(10))%32) + int32(4713552) + v1765<<(uint(int32(2))%32)
			v1794 = int32(0)
...
L4:
	...
	v19 = v18 + l1
	v20 = l0 - v18
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1478]))
	if v20 != v22 {
		goto L8
	} else {
		goto L9
...
L14:
	;
	v29 = int32(4730696)
	v31 = *(*int32)(unsafe.Add(mBase, _consts[1479]))
	*(*int32)(unsafe.Add(mBase, _consts[1479])) = v31 & base.I32_rotl(int32(-2), int32(base.Ui32(v18)>>(uint(int32(3))%32)))
	v128 = v20
	v129 = v19
	goto L2
L15:
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1480])) = v19
...
L27:
	...
	v103 = *(*int32)(unsafe.Add(mBase, uint32(v100)+uint32(_consts[1481])))
	if v103 == v20 {
		goto L29
	} else {
		goto L30
...
L29:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v100)+uint32(_consts[1481]))) = v89
	if v89 != 0 {
		goto L28
	} else {
		goto L32
...
L32:
	;
	v106 = int32(4730700)
	v108 = *(*int32)(unsafe.Add(mBase, _consts[1482]))
	*(*int32)(unsafe.Add(mBase, _consts[1482])) = v108 & base.I32_rotl(int32(-2), v98)
	v128 = v20
	v129 = v19
	goto L2
L33:
...
L46:
	;
	v143 = *(*int32)(unsafe.Add(mBase, _consts[1483]))
	if v143 == v10 {
		goto L49
	} else {
		goto L50
...
L49:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1483])) = v128
	v147 = int32(4730708)
	v149 = *(*int32)(unsafe.Add(mBase, _consts[1484]))
	v150 = v149 + v129
	*(*int32)(unsafe.Add(mBase, _consts[1484])) = v150
	*(*int32)(unsafe.Add(mBase, uint32(v128)+4)) = v150 | int32(1)
	v156 = *(*int32)(unsafe.Add(mBase, _consts[1478]))
	if v128 != v156 {
		goto L1
	} else {
		goto L52
...
L51:
	;
	v165 = *(*int32)(unsafe.Add(mBase, _consts[1478]))
	if v165 == v10 {
		goto L53
	} else {
		goto L54
...
L52:
	;
	v159 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1480])) = v159
	*(*int32)(unsafe.Add(mBase, _consts[1478])) = v159
	return
L53:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1478])) = v128
	v169 = int32(4730704)
	v171 = *(*int32)(unsafe.Add(mBase, _consts[1480]))
	v172 = v171 + v129
	*(*int32)(unsafe.Add(mBase, _consts[1480])) = v172
...
L59:
	;
	v187 = int32(4730696)
	v189 = *(*int32)(unsafe.Add(mBase, _consts[1479]))
	*(*int32)(unsafe.Add(mBase, _consts[1479])) = v189 & base.I32_rotl(int32(-2), int32(base.Ui32(v137)>>(uint(int32(3))%32)))
	goto L43
L60:
	;
	goto L61
...
L73:
	...
	v255 = *(*int32)(unsafe.Add(mBase, uint32(v252)+uint32(_consts[1481])))
	if v255 == v10 {
		goto L75
	} else {
		goto L76
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v252)+uint32(_consts[1481]))) = v241
	if v241 != 0 {
		goto L74
	} else {
		goto L78
...
L78:
	;
	v258 = int32(4730700)
	v260 = *(*int32)(unsafe.Add(mBase, _consts[1482]))
	*(*int32)(unsafe.Add(mBase, _consts[1482])) = v260 & base.I32_rotl(int32(-2), v250)
	goto L43
L79:
	;
	if v241 == int32(0) {
...
L88:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1480])) = v181
	return
L89:
	;
	v309 = v298 & int32(-8)
	v311 = v309 + int32(4730736)
	v313 = *(*int32)(unsafe.Add(mBase, _consts[1479]))
...
L92:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v309)+uint32(_consts[1485]))) = v128
...
L93:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1479])) = v317 | v313
	v325 = v311
	goto L92
L94:
	;
...
L95:
	;
	v324 = *(*int32)(unsafe.Add(mBase, uint32(v309)+uint32(_consts[1485])))
	v325 = v324
	goto L92
L96:
	;
...
L98:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v128)+16)) = int64(0)
	...
	v355 = *(*int32)(unsafe.Add(mBase, _consts[1482]))
...
L101:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1482])) = v357 | v355
	*(*int32)(unsafe.Add(mBase, uint32(v351)+uint32(_consts[1481]))) = v128
	*(*int32)(unsafe.Add(mBase, uint32(v128)+24)) = v351 + int32(4731000)
	goto L100
L102:
	;
	goto L103
...
L106:
	;
	v375 = *(*int32)(unsafe.Add(mBase, uint32(v351)+uint32(_consts[1481])))
	...
	if base.F64_ne(v5, float64(0)) != 0 {
		if base.F64_lt(v5, float64(0)) != 0 {
			...
			if v47 != 0 {
				...
				if v50 != 0 {
					...
					F_errmsg(m, int32(239143), int32(0))
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(515258), int32(1706), int32(586798))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
		...
		if v31 != 0 {
			...
			if v34 != 0 {
				...
				F_errmsg(m, int32(251398), int32(0))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(515258), int32(1702), int32(586798))
					mBase = m.M
					v43 = m.ExcPending
					if v43 != 0 {
						return int32(0)
			...
			if v189 != 0 {
				...
				if v192 != 0 {
					...
					if v196 != 0 {
						...
						F_errfinish(m, int32(515258), int32(1739), int32(589727))
						mBase = m.M
						v201 = m.ExcPending
						if v201 != 0 {
							return int32(0)
		...
		if v173 != 0 {
			...
			if v176 != 0 {
				...
				if v180 != 0 {
					...
					F_errfinish(m, int32(515258), int32(1735), int32(589727))
					mBase = m.M
					v185 = m.ExcPending
					if v185 != 0 {
						return int32(0)
...
func F_doNegate(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v8 != int32(72) {
		v37 = int32(0)
		v40 = F_makeSimpleA_Expr(m, v37, int32(698269), v37, l0, l1)
		mBase = m.M
		v41 = m.ExcPending
		if v41 != 0 {
			return int32(0)
		...
		case 1:
			...
			if v24 == int32(45) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v23
				v32 = F_psprintf(m, int32(187136), v6)
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return int32(0)
	...
	if int32(0) <= v4 {
		if v4 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v28))) = v31
			...
			v10 = *(*int32)(unsafe.Add(mBase, _consts[1474]))
...
L7:
	...
	v47 = F_AllocSetContextCreateInternal(m, v42, int32(704844), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, _consts[617])) = v58
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _consts[618])) = v63
...
L60:
	;
	v177 = *(*int32)(unsafe.Add(mBase, _consts[619]))
	if v177 == int32(0) {
		goto L61
	} else {
		goto L62
...
L70:
	...
	v211 = *(*int32)(unsafe.Add(mBase, _consts[620]))
	goto L71
L71:
	;
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v17
	v29 = F_open(m, int32(301317), v17, v23)
	mBase = m.M
	if v29 != int32(-1) {
		goto L6
	} else {
...
L84:
	;
	F_errfinish(m, int32(520183), int32(221), int32(399923))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L1
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v272
	F_errmsg(m, int32(757588), v14+int32(16))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L1
...
L88:
	;
	F_errfinish(m, int32(520183), int32(260), int32(106541))
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L1
...
L91:
	;
	F_errmsg(m, int32(140474), int32(0))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L1
...
L92:
	;
	F_errfinish(m, int32(520183), int32(243), int32(106541))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L1
...
L95:
	;
	F_errmsg(m, int32(140606), int32(0))
	mBase = m.M
	v320 = m.ExcPending
	if v320 != 0 {
		goto L1
...
L96:
	;
	F_errfinish(m, int32(520183), int32(252), int32(106541))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L1
...
L104:
	;
	F_errmsg(m, int32(227154), int32(0))
	mBase = m.M
	v392 = m.ExcPending
	if v392 != 0 {
		goto L1
...
L105:
	;
	F_errfinish(m, int32(520183), int32(267), int32(106541))
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L1
...
L9:
	;
	F_errfinish(m, int32(522873), int32(884), int32(329803))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L5
