...
func F_DecodeUnits(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v148 int32
	_ = v148
	v9 = *(*int32)(unsafe.Add(mBase, _consts[1065]))
	if v9 != 0 {
		goto L2
	} else {
		goto L3
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1065])) = v140
...
L4:
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v8)+16)) = uint32(v22)
	F_errmsg_internal(m, int32(481093), v8+int32(16))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L1
...
L7:
	;
	F_errfinish(m, int32(466999), int32(643), int32(82624))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L1
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v82
	F_errmsg_internal(m, int32(187449), v8)
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L27:
	;
	F_errfinish(m, int32(466999), int32(654), int32(82624))
	mBase = m.M
	v91 = m.ExcPending
	if v91 != 0 {
		goto L1
...
L29:
	;
	F_s_lock(m, v11, int32(466999), int32(667), int32(82624))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L1
...
L36:
	;
	F_errmsg_internal(m, int32(83402), int32(0))
	mBase = m.M
	v121 = m.ExcPending
	if v121 != 0 {
		goto L1
...
L37:
	;
	F_errfinish(m, int32(466999), int32(656), int32(82624))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L1
...
L70:
	;
	v284 = *(*int32)(unsafe.Add(mBase, uint32(l2)+uint32(_consts[1070])))
			...
			if v114 != 0 {
				...
				if v117 != 0 {
					...
					if v121 != 0 {
						...
						F_errfinish(m, int32(463209), int32(1803), int32(258726))
						mBase = m.M
						v126 = m.ExcPending
						if v126 != 0 {
							return int32(0)
...
L2:
	;
	F_appendStringInfoString(m, l0, int32(200794))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L6
...
L3:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10)+16)) = base.I64_rotl(v30, int64(32))
	F_appendStringInfo(m, l0, int32(36012), v10+int32(16))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L6
...
L5:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10))) = base.I64_rotl(v19, v21)
	F_appendStringInfo(m, l0, int32(36029), v10)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L6
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v58
	F_appendStringInfo(m, l0, int32(36167), v10+int32(32))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L6
...
L4:
	...
	v19 = v18 + l1
	v20 = l0 - v18
	v22 = *(*int32)(unsafe.Add(mBase, _consts[1312]))
	if v20 != v22 {
		goto L8
	} else {
		goto L9
...
L14:
	;
	v29 = int32(4530680)
	v31 = *(*int32)(unsafe.Add(mBase, _consts[1313]))
	*(*int32)(unsafe.Add(mBase, _consts[1313])) = v31 & base.I32_rotl(int32(-2), int32(base.Ui32(v18)>>(uint(int32(3))%32)))
	v128 = v20
	v129 = v19
	goto L2
L15:
...
L26:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1314])) = v19
...
L27:
	...
	v103 = *(*int32)(unsafe.Add(mBase, uint32(v100)+uint32(_consts[1315])))
	if v103 == v20 {
		goto L29
	} else {
		goto L30
...
L29:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v100)+uint32(_consts[1315]))) = v89
	if v89 != 0 {
		goto L28
	} else {
		goto L32
...
L32:
	;
	v106 = int32(4530684)
	v108 = *(*int32)(unsafe.Add(mBase, _consts[1316]))
	*(*int32)(unsafe.Add(mBase, _consts[1316])) = v108 & base.I32_rotl(int32(-2), v98)
	v128 = v20
	v129 = v19
	goto L2
L33:
...
L46:
	;
	v143 = *(*int32)(unsafe.Add(mBase, _consts[1317]))
	if v143 == v10 {
		goto L49
	} else {
		goto L50
...
L49:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1317])) = v128
	v147 = int32(4530692)
	v149 = *(*int32)(unsafe.Add(mBase, _consts[1318]))
	v150 = v149 + v129
	*(*int32)(unsafe.Add(mBase, _consts[1318])) = v150
	*(*int32)(unsafe.Add(mBase, uint32(v128)+4)) = v150 | int32(1)
	v156 = *(*int32)(unsafe.Add(mBase, _consts[1312]))
	if v128 != v156 {
		goto L1
	} else {
		goto L52
...
L51:
	;
	v165 = *(*int32)(unsafe.Add(mBase, _consts[1312]))
	if v165 == v10 {
		goto L53
	} else {
		goto L54
...
L52:
	;
	v159 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[1314])) = v159
	*(*int32)(unsafe.Add(mBase, _consts[1312])) = v159
	return
L53:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1312])) = v128
	v169 = int32(4530688)
	v171 = *(*int32)(unsafe.Add(mBase, _consts[1314]))
	v172 = v171 + v129
	*(*int32)(unsafe.Add(mBase, _consts[1314])) = v172
...
L59:
	;
	v187 = int32(4530680)
	v189 = *(*int32)(unsafe.Add(mBase, _consts[1313]))
	*(*int32)(unsafe.Add(mBase, _consts[1313])) = v189 & base.I32_rotl(int32(-2), int32(base.Ui32(v137)>>(uint(int32(3))%32)))
	goto L43
L60:
	;
	goto L61
...
L73:
	...
	v255 = *(*int32)(unsafe.Add(mBase, uint32(v252)+uint32(_consts[1315])))
	if v255 == v10 {
		goto L75
	} else {
		goto L76
...
L75:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v252)+uint32(_consts[1315]))) = v241
	if v241 != 0 {
		goto L74
	} else {
		goto L78
...
L78:
	;
	v258 = int32(4530684)
	v260 = *(*int32)(unsafe.Add(mBase, _consts[1316]))
	*(*int32)(unsafe.Add(mBase, _consts[1316])) = v260 & base.I32_rotl(int32(-2), v250)
	goto L43
L79:
	;
	if v241 == int32(0) {
...
L88:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1314])) = v181
	return
L89:
	;
	v309 = v298 & int32(-8)
	v311 = v309 + int32(4530720)
	v313 = *(*int32)(unsafe.Add(mBase, _consts[1313]))
...
L92:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v309)+uint32(_consts[1319]))) = v128
...
L93:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1313])) = v317 | v313
	v325 = v311
	goto L92
L94:
	;
...
L95:
	;
	v324 = *(*int32)(unsafe.Add(mBase, uint32(v309)+uint32(_consts[1319])))
	v325 = v324
	goto L92
L96:
	;
...
L98:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v128)+16)) = int64(0)
	...
	v355 = *(*int32)(unsafe.Add(mBase, _consts[1316]))
...
L101:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1316])) = v357 | v355
	*(*int32)(unsafe.Add(mBase, uint32(v351)+uint32(_consts[1315]))) = v128
	*(*int32)(unsafe.Add(mBase, uint32(v128)+24)) = v351 + int32(4530984)
	goto L100
L102:
	;
	goto L103
...
L106:
	;
	v375 = *(*int32)(unsafe.Add(mBase, uint32(v351)+uint32(_consts[1315])))
...
func F_dlgamma(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, _consts[1074])) = int32(1)
	...
	if base.F64_ne(v5, float64(0)) != 0 {
		if base.F64_lt(v5, float64(0)) != 0 {
			...
			if v47 != 0 {
				...
				if v50 != 0 {
					...
					F_errmsg(m, int32(214919), int32(0))
					mBase = m.M
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(463209), int32(1706), int32(520718))
						mBase = m.M
						v59 = m.ExcPending
						if v59 != 0 {
							return int32(0)
		...
		if v31 != 0 {
			...
			if v34 != 0 {
				...
				F_errmsg(m, int32(225329), int32(0))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(463209), int32(1702), int32(520718))
					mBase = m.M
					v43 = m.ExcPending
					if v43 != 0 {
						return int32(0)
			...
			if v189 != 0 {
				...
				if v192 != 0 {
					...
					if v196 != 0 {
						...
						F_errfinish(m, int32(463209), int32(1739), int32(521679))
						mBase = m.M
						v201 = m.ExcPending
						if v201 != 0 {
							return int32(0)
		...
		if v173 != 0 {
			...
			if v176 != 0 {
				...
				if v180 != 0 {
					...
					F_errfinish(m, int32(463209), int32(1735), int32(521679))
					mBase = m.M
					v185 = m.ExcPending
					if v185 != 0 {
						return int32(0)
...
func F_doNegate(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v8 != int32(72) {
		v37 = int32(0)
		v40 = F_makeSimpleA_Expr(m, v37, int32(620147), v37, l0, l1)
		mBase = m.M
		v41 = m.ExcPending
		if v41 != 0 {
			return int32(0)
		...
		case 1:
			...
			if v24 == int32(45) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = v23
				v32 = F_psprintf(m, int32(165415), v6)
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return int32(0)
	...
	if int32(0) <= v4 {
		if v4 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v28))) = v31
			...
			v10 = *(*int32)(unsafe.Add(mBase, _consts[1308]))
...
L7:
	...
	v47 = F_AllocSetContextCreateInternal(m, v42, int32(625957), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
...
func F_drandom_normal(m *base.Module, l0 int32) int32 {
	...
	v9 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v10 = *(*float64)(unsafe.Add(mBase, uint32(v9)))
	v12 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1119])))
	if v12 == int32(0) {
		goto L1
	} else {
		goto L2
...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v17
	v29 = F_open(m, int32(271003), v17, v23)
	mBase = m.M
	if v29 != int32(-1) {
		goto L6
	} else {
...
L3:
	...
	v147 = int32(4410136)
	v148 = int32(4410128)
	v149 = *(*int64)(unsafe.Add(mBase, _consts[1120]))
	v150 = int64(24)
	v153 = *(*int64)(unsafe.Add(mBase, _consts[1121]))
	v154 = v153 ^ v149
	v155 = int64(16)
	v158 = base.I64_rotl(v149, v150) ^ v154<<(uint(v155)%64) ^ v154
	v159 = int64(37)
	v161 = v158 ^ base.I64_rotl(v154, v159)
	*(*int64)(unsafe.Add(mBase, _consts[1121])) = base.I64_rotl(v161, v159)
	*(*int64)(unsafe.Add(mBase, _consts[1120])) = v161<<(uint(v155)%64) ^ base.I64_rotl(v158, v150) ^ v161
...
L4:
	;
	v145 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[1119])) = uint8(v145)
	goto L3
L5:
	;
	if v62 != 0 {
...
L18:
	;
	v67 = int32(4410128)
	v68 = *(*int64)(unsafe.Add(mBase, _consts[1120]))
	if v68 != int64(0) {
		goto L22
	} else {
		goto L23
...
L23:
	;
	v71 = *(*int64)(unsafe.Add(mBase, _consts[1121]))
	if v71 != int64(0) {
		goto L22
	} else {
		goto L24
...
L24:
	;
	*(*int64)(unsafe.Add(mBase, _consts[1121])) = int64(1442695040888963407)
	*(*int64)(unsafe.Add(mBase, _consts[1120])) = int64(6364136223846793005)
	goto L22
L26:
	;
	...
	v117 = int64(31)
	*(*int64)(unsafe.Add(mBase, _consts[1121])) = int64(base.Ui64(v116)>>(uint(v117)%64)) ^ v116
	...
	*(*int64)(unsafe.Add(mBase, _consts[1120])) = int64(base.Ui64(v132)>>(uint(v117)%64)) ^ v132
...
L6:
	...
	v46 = int32(160284)
	v49 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1283])))
...
L22:
	;
	v80 = int32(379452)
	v83 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1284])))
...
L84:
	;
	F_errfinish(m, int32(466781), int32(221), int32(359225))
	mBase = m.M
	v264 = m.ExcPending
	if v264 != 0 {
		goto L1
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v272
	F_errmsg(m, int32(675153), v14+int32(16))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L1
...
L88:
	;
	F_errfinish(m, int32(466781), int32(260), int32(92879))
	mBase = m.M
	v287 = m.ExcPending
	if v287 != 0 {
		goto L1
...
L91:
	;
	F_errmsg(m, int32(121870), int32(0))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L1
...
L92:
	;
	F_errfinish(m, int32(466781), int32(243), int32(92879))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L1
...
L95:
	;
	F_errmsg(m, int32(122002), int32(0))
	mBase = m.M
	v320 = m.ExcPending
	if v320 != 0 {
		goto L1
...
L96:
	;
	F_errfinish(m, int32(466781), int32(252), int32(92879))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L1
...
L104:
	;
	F_errmsg(m, int32(203937), int32(0))
	mBase = m.M
	v392 = m.ExcPending
	if v392 != 0 {
		goto L1
...
L105:
	;
	F_errfinish(m, int32(466781), int32(267), int32(92879))
	mBase = m.M
	v399 = m.ExcPending
	if v399 != 0 {
		goto L1
...
L9:
	;
	F_errfinish(m, int32(469068), int32(884), int32(296318))
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		goto L5
