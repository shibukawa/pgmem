...
func F_AtEOXact_Files(m *base.Module, l0 int32) {
	...
	v11 = v9 - int32(32)
	m.G0 = v11
	v14 = int32(*(*uint8)(unsafe.Add(mBase, _consts[757])))
	if v14 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v16 = *(*int32)(unsafe.Add(mBase, _consts[756]))
...
L3:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[758]))
	if l0 == int32(0) {
		v119 = v95
		goto L22
	} else {
...
L4:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _consts[755]))
	v23 = int32(1)
	v26 = v16
	v27 = v20
	goto L7
...
L6:
	;
	v84 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[757])) = uint8(v84)
	goto L3
L7:
	;
	v31 = v23 * int32(48)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v52
	F_errmsg_internal(m, int32(269907), v11+int32(16))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L13
...
L18:
	;
	F_errfinish(m, int32(526349), int32(3302), int32(176015))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L13
...
L20:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[756]))
	v69 = *(*int32)(unsafe.Add(mBase, _consts[755]))
	v70 = v67
	v71 = v69
	goto L9
L21:
...
L25:
	;
	v105 = *(*int32)(unsafe.Add(mBase, _consts[758]))
	if v102 == int32(0) {
		v119 = v105
		goto L22
	} else {
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v105
	F_errmsg_internal(m, int32(269839), v11)
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L13
...
L27:
	;
	F_errfinish(m, int32(526349), int32(3314), int32(176015))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L13
...
L28:
	;
	v118 = *(*int32)(unsafe.Add(mBase, _consts[758]))
	v119 = v118
	goto L22
L29:
	;
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, _consts[764])) = int32(-1)
	*(*int32)(unsafe.Add(mBase, _consts[765])) = int32(0)
	m.G0 = v11 + int32(32)
	return
L32:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _consts[759]))
...
L34:
	;
	v136 = *(*int32)(unsafe.Add(mBase, _consts[758]))
	if int32(0) < v136 {
		goto L32
	} else {
		goto L35
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1193])) = int32(0)
	m.G0 = v5 + int32(16)
	return
L2:
	;
	v9 = int32(0)
	v11 = *(*int32)(unsafe.Add(mBase, _consts[1193]))
	if v11 <= v9 {
		goto L1
	} else {
		goto L3
...
L8:
	;
	v24 = *(*int32)(unsafe.Add(mBase, uint32(v14<<(uint(int32(2))%32))+uint32(_consts[1194])))
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = v24
	F_errmsg_internal(m, int32(251936), v5)
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L6
...
L10:
	;
	v35 = v14 + int32(1)
	v37 = *(*int32)(unsafe.Add(mBase, _consts[1193]))
	if v35 < v37 {
		v14 = v35
		goto L4
	} else {
...
L11:
	;
	F_errfinish(m, int32(524192), int32(1933), int32(178066))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L6
...
L2:
	;
	v8 = *(*int32)(unsafe.Add(mBase, _consts[669]))
	if v8 == int32(0) {
		goto L1
	} else {
		goto L3
...
L5:
	;
	v19 = *(*int32)(unsafe.Add(mBase, _consts[669]))
	if v19 == int32(0) {
		goto L6
	} else {
		goto L7
