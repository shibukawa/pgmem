...
L18:
	;
	F_errfinish(m, int32(496527), int32(3302), int32(164294))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L13
...
L27:
	;
	F_errfinish(m, int32(496527), int32(3314), int32(164294))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L13
...
L11:
	;
	F_errfinish(m, int32(494727), int32(1933), int32(166345))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L6
