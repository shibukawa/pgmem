...
L3:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Files[2]))
	if l0 == int32(0) {
		v119 = v95
		goto L22
	} else {
...
L6:
	;
	v84 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_AtEOXact_Files[0])) = uint8(v84)
	goto L3
L7:
	;
	v31 = v23 * int32(48)
...
L15:
	;
	v50 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Files[3]))
...
L20:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Files[1]))
	v69 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Files[3]))
	v70 = v67
	v71 = v69
	goto L9
L21:
...
L25:
	;
	v105 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Files[2]))
	if v102 == int32(0) {
		v119 = v105
		goto L22
	} else {
...
L28:
	;
	v118 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Files[2]))
	v119 = v118
	goto L22
L29:
	;
...
L32:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Files[6]))
...
L34:
	;
	v136 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_Files[2]))
	if int32(0) < v136 {
		goto L32
	} else {
		goto L35
...
L8:
	;
	v24 = *(*int32)(unsafe.Add(mBase, uint32(v14<<(uint(int32(2))%32))+uint32(_c_F_AtEOXact_HashTables[1])))
...
L10:
	;
	v35 = v14 + int32(1)
	v37 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOXact_HashTables[0]))
	if v35 < v37 {
		v14 = v35
		goto L4
	} else {
