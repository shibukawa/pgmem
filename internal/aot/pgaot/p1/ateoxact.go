...
func F_AtEOXact_Files(m *base.Module, l0 int32) {
	...
	v11 = v9 - int32(32)
	m.G0 = v11
	v14 = int32(*(*uint8)(unsafe.Add(mBase, _consts[752])))
	if v14 != 0 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	v16 = *(*int32)(unsafe.Add(mBase, _consts[751]))
...
L3:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[753]))
	if l0 == int32(0) {
		v119 = v95
		goto L22
	} else {
...
L4:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _consts[750]))
	v23 = int32(1)
	v26 = v16
	v27 = v20
	goto L7
...
L6:
	;
	v84 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[752])) = uint8(v84)
	goto L3
L7:
	;
	v31 = v23 * int32(48)
...
L18:
	;
	F_errfinish(m, int32(494708), int32(3302), int32(163793))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L13
...
L20:
	;
	v67 = *(*int32)(unsafe.Add(mBase, _consts[751]))
	v69 = *(*int32)(unsafe.Add(mBase, _consts[750]))
	v70 = v67
	v71 = v69
	goto L9
L21:
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v105
	F_errmsg_internal(m, int32(253998), v11)
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L13
...
L27:
	;
	F_errfinish(m, int32(494708), int32(3314), int32(163793))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L13
...
L28:
	;
	v118 = *(*int32)(unsafe.Add(mBase, _consts[753]))
	v119 = v118
	goto L22
L29:
	;
...
L31:
	;
	*(*int32)(unsafe.Add(mBase, _consts[759])) = int32(-1)
	*(*int32)(unsafe.Add(mBase, _consts[760])) = int32(0)
	m.G0 = v11 + int32(32)
	return
L32:
	;
	v132 = *(*int32)(unsafe.Add(mBase, _consts[754]))
...
L34:
	;
	v136 = *(*int32)(unsafe.Add(mBase, _consts[753]))
	if int32(0) < v136 {
		goto L32
	} else {
		goto L35
...
L2:
	;
	v9 = int32(0)
	v11 = *(*int32)(unsafe.Add(mBase, _consts[1188]))
	if v11 <= v9 {
		goto L1
	} else {
		goto L3
...
L8:
	;
	v24 = *(*int32)(unsafe.Add(mBase, uint32(v14<<(uint(int32(2))%32))+uint32(_consts[1189])))
	*(*int32)(unsafe.Add(mBase, uint32(v5))) = v24
	F_errmsg_internal(m, int32(237011), v5)
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		goto L6
...
L10:
	;
	v35 = v14 + int32(1)
	v37 = *(*int32)(unsafe.Add(mBase, _consts[1188]))
	if v35 < v37 {
		v14 = v35
		goto L4
	} else {
...
L11:
	;
	F_errfinish(m, int32(492915), int32(1933), int32(165844))
	mBase = m.M
	v33 = m.ExcPending
	if v33 != 0 {
		goto L6
