...
L29:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23)+48)) = v89
	F_errmsg_internal(m, int32(56449), v23+int32(48))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L28
...
L30:
	;
	F_errfinish(m, int32(477060), int32(396), int32(116510))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L28
...
L400:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v23))) = v132
	F_errmsg_internal(m, int32(56449), v23)
	mBase = m.M
	v2532 = m.ExcPending
	if v2532 != 0 {
		goto L28
...
L401:
	;
	F_errfinish(m, int32(477060), int32(375), int32(116510))
	mBase = m.M
	v2537 = m.ExcPending
	if v2537 != 0 {
		goto L28
