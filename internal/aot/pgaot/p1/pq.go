...
func F_pq_cleanup_redirect_to_shm_mq(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[463])) = v4
	return
}
	...
	if v4 <= v3 {
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				F_errmsg(m, int32(425020), int32(0))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(518648), int32(404), int32(367196))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
...
L1:
	;
	v8 = *(*int32)(unsafe.Add(mBase, _consts[456]))
	if v4 < v8 {
		goto L5
	} else {
		goto L6
...
L3:
	;
	v172 = *(*int32)(unsafe.Add(mBase, _consts[457]))
	if v172 != 0 {
		goto L54
	} else {
		goto L55
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, _consts[456])) = v13
	v166 = int32(4460980)
	goto L4
L9:
	;
...
L36:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v60)+uint32(_consts[458]))) = uint8(v63)
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v80)+uint32(_consts[458]))) = v83
...
L43:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v100)+uint32(_consts[458]))) = uint8(v103)
	if v100 != 0 {
		v96 = v100
		goto L43
	} else {
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, _consts[137])) = int32(0)
	v182 = *(*int32)(unsafe.Add(mBase, _consts[457]))
...
L69:
	;
	F_errfinish(m, int32(523417), int32(942), int32(356323))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L61
...
L71:
	;
	v223 = int32(4460976)
	v225 = *(*int32)(unsafe.Add(mBase, _consts[456]))
	*(*int32)(unsafe.Add(mBase, _consts[456])) = v225 + v189
	v228 = int32(0)
	goto L57
L72:
	;
