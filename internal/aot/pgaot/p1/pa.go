...
func F_pa_decr_and_wait_stream_block(m *base.Module) {
	...
	var v61 int32
	_ = v61
	v4 = *(*int32)(unsafe.Add(mBase, _consts[655]))
	v5 = *(*int32)(unsafe.Add(mBase, uint32(v4)+20))
	if v5 == int32(0) {
		v8 = *(*int32)(unsafe.Add(mBase, uint32(v4)))
		*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(1)
		if v8 != 0 {
			v12 = *(*int32)(unsafe.Add(mBase, _consts[655]))
			F_s_lock(m, v12, int32(521176), int32(1531), int32(370360))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
			} else {
				v19 = *(*int32)(unsafe.Add(mBase, _consts[655]))
				*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(0)
				...
				if v22 != 0 {
					...
					if v26 != 0 {
						...
						F_errmsg_internal(m, int32(599731), int32(0))
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return
						} else {
							F_errfinish(m, int32(521176), int32(1611), int32(332988))
							mBase = m.M
							v35 = m.ExcPending
							if v35 != 0 {
								return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v4)+20)) = v36 - v37
		if v36 != v37 {
			...
			v43 = *(*int32)(unsafe.Add(mBase, _consts[654]))
			v44 = *(*int32)(unsafe.Add(mBase, uint32(v43)+32))
			v46 = *(*int32)(unsafe.Add(mBase, _consts[655]))
			...
			if v51 != 0 {
				...
				v53 = *(*int32)(unsafe.Add(mBase, _consts[654]))
				v54 = *(*int32)(unsafe.Add(mBase, uint32(v53)+32))
				v56 = *(*int32)(unsafe.Add(mBase, _consts[655]))
...
func F_pa_send_data(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v94 int32
	_ = v94
	v8 = *(*int32)(unsafe.Add(mBase, _consts[653]))
	if v8 == int32(1) {
		v94 = int32(0)
		goto L1
	} else {
...
L5:
	;
	v42 = *(*int32)(unsafe.Add(mBase, _consts[519]))
...
L10:
	;
	F_errmsg(m, int32(366460), int32(0))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L7
...
L11:
	;
	F_errfinish(m, int32(521176), int32(1187), int32(531370))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L7
