	...
	if v5 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(1)
		if v8 != 0 {
			...
			F_s_lock(m, v12, int32(490417), int32(1531), int32(348098))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(0)
				...
				if v22 != 0 {
					...
					if v26 != 0 {
						...
						F_errmsg_internal(m, int32(549908), int32(0))
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return
						} else {
							F_errfinish(m, int32(490417), int32(1611), int32(313523))
							mBase = m.M
							v35 = m.ExcPending
							if v35 != 0 {
								return
		...
		*(*int32)(unsafe.Add(mBase, uint32(v4)+20)) = v36 - v37
		if v36 != v37 {
			...
			v43 = *(*int32)(unsafe.Add(mBase, _consts[649]))
			v44 = *(*int32)(unsafe.Add(mBase, uint32(v43)+32))
			v46 = *(*int32)(unsafe.Add(mBase, _consts[650]))
			...
			if v51 != 0 {
				...
				v53 = *(*int32)(unsafe.Add(mBase, _consts[649]))
				v54 = *(*int32)(unsafe.Add(mBase, uint32(v53)+32))
				v56 = *(*int32)(unsafe.Add(mBase, _consts[650]))
...
func F_pa_send_data(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v94 int32
	_ = v94
	v8 = *(*int32)(unsafe.Add(mBase, _consts[648]))
	if v8 == int32(1) {
		v94 = int32(0)
		goto L1
	} else {
...
L10:
	;
	F_errmsg(m, int32(344296), int32(0))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L7
...
L11:
	;
	F_errfinish(m, int32(490417), int32(1187), int32(499125))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L7
