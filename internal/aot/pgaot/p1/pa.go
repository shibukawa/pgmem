	...
	if v5 == int32(0) {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(1)
		if v8 != 0 {
			...
			F_s_lock(m, v12, int32(465020), int32(1531), int32(329944))
			mBase = m.M
			v17 = m.ExcPending
			if v17 != 0 {
				return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v19))) = int32(0)
				...
				if v22 != 0 {
					...
					if v26 != 0 {
						...
						F_errmsg_internal(m, int32(522067), int32(0))
						mBase = m.M
						v30 = m.ExcPending
						if v30 != 0 {
							return
						} else {
							F_errfinish(m, int32(465020), int32(1611), int32(297187))
							mBase = m.M
							v35 = m.ExcPending
							if v35 != 0 {
								return
...
L10:
	;
	F_errmsg(m, int32(326243), int32(0))
	mBase = m.M
	v35 = m.ExcPending
	if v35 != 0 {
		goto L7
...
L11:
	;
	F_errfinish(m, int32(465020), int32(1187), int32(473141))
	mBase = m.M
	v40 = m.ExcPending
	if v40 != 0 {
		goto L7
