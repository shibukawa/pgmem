...
L7:
	;
	v40 = F_float8in_internal(m, l1, v15+int32(12), int32(419852), l1, l4)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L1
...
L19:
	;
	v79 = v70 + int32(1)
	v83 = F_float8in_internal(m, v79, v15+int32(12), int32(419852), l1, l4)
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L1
...
L31:
	;
	v121 = v21 + int32(8)
	v128 = F_float8in_internal(m, l2, v15+int32(12), int32(419852), l2, l4)
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L1
...
L46:
	;
	v174 = v166 + int32(1)
	v178 = F_float8in_internal(m, v174, v15+int32(12), int32(419852), l2, l4)
	mBase = m.M
	v179 = m.ExcPending
	if v179 != 0 {
		goto L1
