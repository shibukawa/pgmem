...
func F_macaddr8_out(m *base.Module, l0 int32) int32 {
	...
	if v20 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v13))) = v21
		v39 = F_pg_snprintf(m, v17, int32(32), int32(_a_F_macaddr8_out_0), v13)
		mBase = m.M
		v40 = m.ExcPending
		if v40 != 0 {
			return int32(0)
