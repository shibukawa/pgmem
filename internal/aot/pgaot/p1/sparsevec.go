...
L55:
	;
	F_errfinish(m, int32(512592), int32(1129), int32(349449))
	mBase = m.M
	v314 = m.ExcPending
	if v314 != 0 {
		goto L1
...
L50:
	...
	v376 = v375 + v154
	v380 = *(*int64)(unsafe.Add(mBase, uint32(int32(1860128)-v376<<(uint(int32(3))%32))))
...
L224:
	...
	v1542 = v1541 + v1320
	v1546 = *(*int64)(unsafe.Add(mBase, uint32(int32(1860128)-v1542<<(uint(int32(3))%32))))
