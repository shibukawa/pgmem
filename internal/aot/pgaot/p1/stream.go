...
L1:
	;
	v8 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_look_ahead[0]))
...
L9:
	;
	F_errfinish(m, int32(_a_F_read_stream_look_ahead_1), int32(1084), int32(_a_F_read_stream_look_ahead_2))
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L7
...
L17:
	...
	if v39 == v35&int32(_a_F_read_stream_look_ahead_3) {
		goto L20
	} else {
		goto L21
	}
...
L34:
	...
	if v75+v70&int32(_a_F_read_stream_look_ahead_3) != v71 {
		goto L33
	} else {
		goto L35
	}
...
L48:
	...
	if v113 == v110&int32(_a_F_read_stream_look_ahead_3) {
		goto L49
	} else {
		goto L50
	}
...
L57:
	;
	v138 = *(*int32)(unsafe.Add(mBase, _c_F_read_stream_look_ahead[0]))
	v139 = int32(0)
			...
			if v47 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(_a_F_stream_change_cb_wrapper_2)
				...
				if v52 != 0 {
					...
					F_errfinish(m, int32(_a_F_stream_change_cb_wrapper_4), int32(1534), int32(_a_F_stream_change_cb_wrapper_5))
					mBase = m.M
					v57 = m.ExcPending
					if v57 != 0 {
						return
