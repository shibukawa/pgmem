...
L8:
	;
	F_errmsg_internal(m, int32(127891), int32(0))
	mBase = m.M
	v19 = m.ExcPending
	if v19 != 0 {
		goto L7
...
L9:
	;
	F_errfinish(m, int32(496040), int32(1084), int32(411368))
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L7
...
func F_stream_change_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+20)) = int32(402789)
	...
	if v38 == v5 {
		...
		if v44 != 0 {
			...
			if v47 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(503532)
				F_errmsg(m, int32(318727), v10)
				mBase = m.M
				v52 = m.ExcPending
				if v52 != 0 {
					return
				} else {
					F_errfinish(m, int32(497542), int32(1534), int32(218016))
					mBase = m.M
					v57 = m.ExcPending
					if v57 != 0 {
						return
...
func F_stream_truncate_cb_wrapper(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) {
	...
	if v15 != 0 {
		*(*int32)(unsafe.Add(mBase, uint32(v12)+20)) = int32(357411)
