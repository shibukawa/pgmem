...
L9:
	...
	v26 = F_AllocSetContextCreateInternal(m, v21, int32(60260), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L12
...
L27:
	...
	v115 = F_AllocSetContextCreateInternal(m, v110, int32(60260), int32(0), int32(1024), int32(8192))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L12
