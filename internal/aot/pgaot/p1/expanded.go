...
L8:
	;
	v33 = int32(_a_F_expanded_record_set_tuple_0)
	v34 = *(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_tuple[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_tuple[0])) = v32
...
L9:
	...
	v26 = F_AllocSetContextCreateInternal(m, v21, int32(_a_F_expanded_record_set_tuple_1), int32(0), int32(1024), int32(_a_F_expanded_record_set_tuple_2))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L12
...
L19:
	;
	v65 = int32(_a_F_expanded_record_set_tuple_0)
	v66 = *(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_tuple[0]))
	v68 = *(*int32)(unsafe.Add(mBase, uint32(l0)+96))
	*(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_tuple[0])) = v68
...
L26:
	;
	v122 = int32(_a_F_expanded_record_set_tuple_0)
	v123 = *(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_tuple[0]))
...
L27:
	...
	v115 = F_AllocSetContextCreateInternal(m, v110, int32(_a_F_expanded_record_set_tuple_1), int32(0), int32(1024), int32(_a_F_expanded_record_set_tuple_2))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L12
...
L32:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_expanded_record_set_tuple[0])) = v123
	v132 = v127
	v133 = int32(1)
	goto L22
L33:
