...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
	v46 = F_pg_snprintf(m, v9+int32(128), int32(2048), int32(188238), v9+int32(16))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L25:
	;
	F_errfinish(m, int32(525303), int32(612), int32(175756))
	mBase = m.M
	v77 = m.ExcPending
	if v77 != 0 {
		goto L1
...
func F_pg_ls_logdir(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v3 = *(*int32)(unsafe.Add(mBase, _consts[1083]))
...
func F_pg_ls_waldir(m *base.Module, l0 int32) int32 {
	var v7 int32
	_ = v7
	F_pg_ls_dir_files(m, l0, int32(324336), int32(0))
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	} else {
