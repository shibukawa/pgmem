...
L7:
	;
	v20 = *(*int32)(unsafe.Add(mBase, _c_F_pg_ls_dir_files[0]))
	if v20 == int32(44) {
		goto L4
	} else {
		goto L8
...
L16:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = l1
	v46 = F_pg_snprintf(m, v9+int32(128), int32(2048), int32(_a_F_pg_ls_dir_files_0), v9+int32(16))
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L19:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _c_F_pg_ls_dir_files[0]))
	if v58 == int32(44) {
		goto L15
	} else {
		goto L22
...
L21:
	...
	if v78&int32(_a_F_pg_ls_dir_files_1) != int32(_a_F_pg_ls_dir_files_2) {
		goto L15
	} else {
		goto L27
	}
