...
func F_GISTInitBuffer(m *base.Module, l0 int32, l1 int32) {
	...
	v47 = F___memset(m, v20, int32(0), int32(_a_F_GISTInitBuffer_0))
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, uint32(v20)+10)) = int32(_a_F_GISTInitBuffer_1)
	v53 = int32(_a_F_GISTInitBuffer_2)
	*(*uint16)(unsafe.Add(mBase, uint32(v20)+18)) = uint16(v53)
	v59 = int32(_a_F_GISTInitBuffer_3)
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v20)+14)) = uint16(v59)
	...
	v63 = v20 + v62
	v64 = int32(_a_F_GISTInitBuffer_4)
...
func F_gistGetFakeLSN(m *base.Module, l0 int32) int64 {
	...
	case 0:
		...
		if v18 != 0 {
			...
			if v20 == int64(0) {
				v51 = v15
				*(*int64)(unsafe.Add(mBase, _c_F_gistGetFakeLSN[0])) = v51
				return v51
			} else {
				if v15 != v20 {
					v51 = v15
					...
					*(*int32)(unsafe.Add(mBase, uint32(v26)+12)) = int32(0)
					...
					if v31 != 0 {
						...
						v33 = int32(_a_F_gistGetFakeLSN_0)
						v35 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_gistGetFakeLSN[1])))
						v36 = v35 | int32(2)
						*(*uint8)(unsafe.Add(mBase, _c_F_gistGetFakeLSN[1])) = uint8(v36)
	...
	default:
		v56 = *(*int32)(unsafe.Add(mBase, _c_F_gistGetFakeLSN[2]))
		...
		if l3 != int32(1) {
					...
					if v49 != 0 {
						...
						if v135 < v132 {
							...
							if v132&v142 != 0 {
								...
								v194 = v188&int32(_a_F_gistSplit_0) + v180 + int32(4)
							} else {
								v194 = v180
							}
							v203 = base.B2i32(base.Ui32(v194) < base.Ui32(int32(_a_F_gistSplit_1)))
						} else {
							v203 = int32(1)
						}
						if v203 == int32(0) {
							...
							if v208 != 0 {
								...
								if v232 < v231 {
									...
									if v231&v239 != 0 {
										...
										v291 = v285&int32(_a_F_gistSplit_0) + v277 + int32(4)
									} else {
										v291 = v277
									}
									v300 = base.B2i32(base.Ui32(v291) < base.Ui32(int32(_a_F_gistSplit_1)))
								} else {
									v300 = int32(1)
								}
								if v300 == int32(0) {
			...
			if v358 != 0 {
				...
				if v361 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v14))) = v363 & int32(_a_F_gistSplit_0)
...
L34:
	;
	v189 = *(*int32)(unsafe.Add(mBase, uint32(v178+(v124+int32(_a_F_gist_indexsortbuild_levelstate_flush_1)))))
...
L39:
	;
	v232 = int32(_a_F_gist_indexsortbuild_levelstate_flush_2)
...
L41:
	;
	v287 = *(*int32)(unsafe.Add(mBase, _c_F_gist_indexsortbuild_levelstate_flush[0]))
	if v287 != 0 {
		goto L43
	} else {
		goto L44
...
L47:
	;
	F_PageInit(m, v292, int32(_a_F_gist_indexsortbuild_levelstate_flush_3), int32(16))
	mBase = m.M
	v297 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v292)+16)))
	v298 = v292 + v297
	v299 = int32(_a_F_gist_indexsortbuild_levelstate_flush_4)
...
L51:
	...
	v329 = v313 + int32(1)
	v333 = F_PageAddItemExtended(m, v292, v310, v325&int32(_a_F_gist_indexsortbuild_levelstate_flush_5), v329&int32(_a_F_gist_indexsortbuild_levelstate_flush_2), int32(0))
	mBase = m.M
	v334 = m.ExcPending
	if v334 != 0 {
		goto L4
...
L54:
	...
	if v329 < v339 {
		v310 = v310 + v335&int32(_a_F_gist_indexsortbuild_levelstate_flush_5)
		v313 = v329
		goto L51
	} else {
		goto L57
...
L68:
	;
	v401 = F_palloc(m, int32(_a_F_gist_indexsortbuild_levelstate_flush_3))
	mBase = m.M
	v402 = m.ExcPending
	if v402 != 0 {
		goto L4
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v398)+12)) = v401
	F_PageInit(m, v401, int32(_a_F_gist_indexsortbuild_levelstate_flush_3), int32(16))
	mBase = m.M
	v410 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v401)+16)))
	v411 = v401 + v410
	v412 = int32(_a_F_gist_indexsortbuild_levelstate_flush_4)
