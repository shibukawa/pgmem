				...
				if v361 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v14))) = v363 & int32(8191)
					...
					if v375 != 0 {
						...
						F_errfinish(m, int32(487802), int32(1477), int32(101767))
						mBase = m.M
						v380 = m.ExcPending
						if v380 != 0 {
							return int32(0)
	...
	if base.Ui32(int32(20)) <= base.Ui32(v8) {
		...
		if v16 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = v8
			F_errmsg_internal(m, int32(477483), v6)
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(494816), int32(1492), int32(413154))
				mBase = m.M
				v25 = m.ExcPending
				if v25 != 0 {
					return int32(0)
...
L58:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v346 + int32(4)
	F_errmsg_internal(m, int32(691391), v20)
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L4
...
L59:
	;
	F_errfinish(m, int32(494644), int32(562), int32(319126))
	mBase = m.M
	v357 = m.ExcPending
	if v357 != 0 {
		goto L4
		...
		default:
			...
			if v108 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v33 & int32(65535)
				F_errmsg_internal(m, int32(477483), v12+int32(16))
				mBase = m.M
				v116 = m.ExcPending
				if v116 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(494816), int32(1322), int32(307922))
					mBase = m.M
					v121 = m.ExcPending
					if v121 != 0 {
						return int32(0)
	...
	default:
		...
		if v200 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v24
			F_errmsg_internal(m, int32(477483), v12)
			mBase = m.M
			v204 = m.ExcPending
			if v204 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(494816), int32(1446), int32(91226))
				mBase = m.M
				v209 = m.ExcPending
				if v209 != 0 {
					return int32(0)
