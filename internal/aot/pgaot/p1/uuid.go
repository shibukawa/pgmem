...
func F_uuid_ns_dns(m *base.Module, l0 int32) int32 {
	...
	v5 = v3 - int32(48)
	m.G0 = v5
	v7 = int32(_a_F_uuid_ns_dns_0)
	v8 = *(*int64)(unsafe.Add(mBase, _c_F_uuid_ns_dns[0]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+29)) = v8
	v10 = *(*int64)(unsafe.Add(mBase, _c_F_uuid_ns_dns[1]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+24)) = v10
	v12 = *(*int64)(unsafe.Add(mBase, _c_F_uuid_ns_dns[2]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = v12
	v14 = *(*int64)(unsafe.Add(mBase, _c_F_uuid_ns_dns[3]))
...
func F_uuid_ns_url(m *base.Module, l0 int32) int32 {
	...
	v5 = v3 - int32(48)
	m.G0 = v5
	v7 = int32(_a_F_uuid_ns_url_0)
	v8 = *(*int64)(unsafe.Add(mBase, _c_F_uuid_ns_url[0]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+29)) = v8
	v10 = *(*int64)(unsafe.Add(mBase, _c_F_uuid_ns_url[1]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+24)) = v10
	v12 = *(*int64)(unsafe.Add(mBase, _c_F_uuid_ns_url[2]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = v12
	v14 = *(*int64)(unsafe.Add(mBase, _c_F_uuid_ns_url[3]))
	*(*int64)(unsafe.Add(mBase, uint32(v5))) = v14
