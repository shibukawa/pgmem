...
func F_uuid_ns_dns(m *base.Module, l0 int32) int32 {
	...
	m.G0 = v5
	v7 = int32(584263)
	v8 = *(*int64)(unsafe.Add(mBase, _consts[1454]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+29)) = v8
	v10 = *(*int64)(unsafe.Add(mBase, _consts[1455]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+24)) = v10
	v12 = *(*int64)(unsafe.Add(mBase, _consts[1456]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = v12
	v14 = *(*int64)(unsafe.Add(mBase, _consts[1457]))
	*(*int64)(unsafe.Add(mBase, uint32(v5))) = v14
	v16 = *(*int64)(unsafe.Add(mBase, _consts[1458]))
...
func F_uuid_ns_url(m *base.Module, l0 int32) int32 {
	...
	m.G0 = v5
	v7 = int32(584226)
	v8 = *(*int64)(unsafe.Add(mBase, _consts[1459]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+29)) = v8
	v10 = *(*int64)(unsafe.Add(mBase, _consts[1460]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+24)) = v10
	v12 = *(*int64)(unsafe.Add(mBase, _consts[1461]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+16)) = v12
	v14 = *(*int64)(unsafe.Add(mBase, _consts[1462]))
	*(*int64)(unsafe.Add(mBase, uint32(v5))) = v14
	v16 = *(*int64)(unsafe.Add(mBase, _consts[1463]))
	*(*int64)(unsafe.Add(mBase, uint32(v5)+8)) = v16
	v20 = F_DirectFunctionCall1Coll(m, int32(3395), int32(0), v5)
	mBase = m.M
	v23 = m.ExcPending
