...
func F_ExecBitmapAnd(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		F_errmsg_internal(m, int32(235707), int32(0))
		v11 = m.ExcPending
		if v11 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(476247), int32(44), int32(408895))
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
			} else {
...
func F_ExecBitmapIndexScan(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		F_errmsg_internal(m, int32(235584), int32(0))
		v11 = m.ExcPending
		if v11 != 0 {
			return int32(0)
		} else {
			F_errfinish(m, int32(473461), int32(40), int32(270899))
			v16 = m.ExcPending
			if v16 != 0 {
				return int32(0)
			} else {
