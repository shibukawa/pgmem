	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+73)) = uint8(v3)
	...
	if v23&int32(14) != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(l0)+124)) = uint8(v27)
		v30 = *(*int32)(unsafe.Add(mBase, _c_F_ProcArrayEndTransactionInternal[0]))
	...
	if v36 == int32(0) {
		...
		if v39 != int32(1) {
			...
			v44 = int32(_a_F_ProcArrayEndTransactionInternal_0)
			v45 = *(*int32)(unsafe.Add(mBase, _c_F_ProcArrayEndTransactionInternal[0]))
			v46 = *(*int32)(unsafe.Add(mBase, uint32(v45)+8))
			v48 = int32(0)
			*(*uint8)(unsafe.Add(mBase, uint32(v43+v46))) = uint8(v48)
			v51 = *(*int32)(unsafe.Add(mBase, _c_F_ProcArrayEndTransactionInternal[0]))
	...
	v76 = *(*int32)(unsafe.Add(mBase, _c_F_ProcArrayEndTransactionInternal[1]))
	if v74 != 0 {
