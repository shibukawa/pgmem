...
func F_CleanupProcSignalState(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = int32(1)
	v18 = v10 + int32(96)
	if v14 != 0 {
		F_s_lock(m, v18, int32(521127), int32(243), int32(370820))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
				...
				if v33 != 0 {
					...
					if v32 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = v38
						v41 = *(*int32)(unsafe.Add(mBase, _consts[790]))
						*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = (v10 - v41 - int32(8)) >> (uint(int32(7)) % 32)
						F_errmsg_internal(m, int32(490678), v7)
						mBase = m.M
						v50 = m.ExcPending
						if v50 != 0 {
							return
						} else {
							F_errfinish(m, int32(521127), int32(253), int32(370820))
							mBase = m.M
							v55 = m.ExcPending
							if v55 != 0 {
								return
...
func F_proc_exit_prepare(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[767])) = v2
	*(*int32)(unsafe.Add(mBase, _consts[768])) = v2
	v18 = int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[163])) = v18
	*(*uint8)(unsafe.Add(mBase, _consts[769])) = uint8(v18)
	*(*int32)(unsafe.Add(mBase, _consts[338])) = v2
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
	v40 = *(*int32)(unsafe.Add(mBase, _consts[770]))
	*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = v40
	F_errmsg_internal(m, int32(416978), v6)
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L1
...
L6:
	...
	v54 = v52 - int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[770])) = v54
	if int32(0) <= v54 {
		goto L9
	} else {
		goto L10
...
L7:
	;
	F_errfinish(m, int32(523675), int32(202), int32(382704))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[770])) = int32(0)
	m.G0 = v6 + int32(16)
	return
L12:
	;
	v62 = v59 << (uint(int32(3)) % 32)
	v65 = *(*int32)(unsafe.Add(mBase, uint32(v62)+uint32(_consts[771])))
	v68 = *(*int32)(unsafe.Add(mBase, uint32(v62)+uint32(_consts[772])))
...
L14:
	;
	v71 = int32(4470672)
	v73 = *(*int32)(unsafe.Add(mBase, _consts[770]))
	v75 = v73 - int32(1)
	*(*int32)(unsafe.Add(mBase, _consts[770])) = v75
	if int32(0) <= v75 {
		v59 = v75
		goto L12
	} else {
