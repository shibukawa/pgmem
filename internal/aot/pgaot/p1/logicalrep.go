...
func F_logicalrep_message_type(m *base.Module, l0 int32) int32 {
	...
	default:
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		v30 = int32(4464128)
		v34 = F_pg_snprintf(m, v30, int32(20), int32(709863), v6)
		mBase = m.M
		v37 = m.ExcPending
		if v37 != 0 {
			return int32(0)
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+96)) = l3
	F_errmsg_internal(m, int32(735050), v21+int32(96))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L5:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _consts[654]))
	if v41 != 0 {
		goto L9
	} else {
		goto L10
...
L6:
	;
	F_errfinish(m, int32(518495), int32(338), int32(341341))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L15:
	;
	v337 = *(*int32)(unsafe.Add(mBase, _consts[655]))
	v347 = v332
	v350 = v337
	goto L13
L16:
...
L19:
	;
	v76 = *(*int32)(unsafe.Add(mBase, _consts[653]))
	v82 = int32(0)
	goto L20
L20:
	;
...
L21:
	;
	v109 = int32(0)
	v111 = *(*int32)(unsafe.Add(mBase, _consts[653]))
	v113 = v111 + int32(16)
	if v62 != int32(1) {
		goto L27
	} else {
...
L42:
	...
	v244 = int32(0)
	v247 = *(*int32)(unsafe.Add(mBase, _consts[655]))
...
L45:
	;
	v274 = *(*int32)(unsafe.Add(mBase, _consts[653]))
...
L49:
	...
	v286 = *(*int32)(unsafe.Add(mBase, _consts[656]))
	goto L50
L50:
	;
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+80)) = v300
	F_errmsg_internal(m, int32(475341), v21+int32(80))
	mBase = m.M
	v306 = m.ExcPending
	if v306 != 0 {
		goto L1
...
L56:
	;
	F_errfinish(m, int32(518495), int32(393), int32(341341))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L1
...
L65:
	...
	v369 = int32(1)
	v371 = int32(0)
	v373 = *(*int32)(unsafe.Add(mBase, _consts[653]))
	v375 = v373 + int32(16)
	if v347 != v369 {
		goto L66
	} else {
...
L82:
	;
	v485 = *(*int32)(unsafe.Add(mBase, _consts[657]))
	if v475 < v485 {
		goto L81
	} else {
		goto L83
...
L93:
	;
	F_errfinish(m, int32(518495), int32(438), int32(341341))
	mBase = m.M
	v525 = m.ExcPending
	if v525 != 0 {
		goto L1
...
L102:
	;
	v652 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(291304), int32(0))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L1
...
L104:
	;
	v615 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(291373), int32(0))
	mBase = m.M
	v616 = m.ExcPending
	if v616 != 0 {
		goto L1
...
L105:
	;
	v591 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(291296), int32(0))
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L1
...
L113:
	;
	F_errfinish(m, int32(518495), int32(506), int32(341341))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L1
...
L127:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = int32(170744)
	F_errhint(m, int32(695651), v21+int32(16))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L128:
	;
	F_errfinish(m, int32(518495), int32(524), int32(341341))
	mBase = m.M
	v738 = m.ExcPending
	if v738 != 0 {
		goto L1
...
L155:
	;
	F_errmsg(m, int32(596389), int32(0))
	mBase = m.M
	v859 = m.ExcPending
	if v859 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(518495), int32(344), int32(341341))
	mBase = m.M
	v864 = m.ExcPending
	if v864 != 0 {
		goto L1
...
L4:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[653]))
	v23 = int32(0)
	goto L5
L5:
	;
