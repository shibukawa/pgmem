...
func F_logicalrep_launcher_onexit(m *base.Module, l0 int32, l1 int32) {
	...
	var v4 int32
	_ = v4
	v4 = *(*int32)(unsafe.Add(mBase, _consts[654]))
...
func F_logicalrep_message_type(m *base.Module, l0 int32) int32 {
	...
	default:
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		v30 = int32(4464240)
		v34 = F_pg_snprintf(m, v30, int32(20), int32(709933), v6)
		mBase = m.M
		v37 = m.ExcPending
		if v37 != 0 {
			return int32(0)
...
func F_logicalrep_worker_find(m *base.Module, l0 int32, l1 int32) int32 {
	...
	_ = v40
	v3 = int32(0)
	v8 = *(*int32)(unsafe.Add(mBase, _consts[536]))
	if v8 <= v3 {
		v40 = v3
		goto L1
	} else {
...
L2:
	;
	v12 = *(*int32)(unsafe.Add(mBase, _consts[654]))
	v18 = v3
	goto L3
L3:
	;
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+96)) = l3
	F_errmsg_internal(m, int32(735120), v21+int32(96))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L5:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _consts[655]))
	if v41 != 0 {
		goto L9
	} else {
		goto L10
...
L6:
	;
	F_errfinish(m, int32(518547), int32(338), int32(341371))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L12:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _consts[536]))
	v61 = v8
	v62 = v52
	v68 = v8
	goto L14
...
L15:
	;
	v337 = *(*int32)(unsafe.Add(mBase, _consts[656]))
	v347 = v332
	v350 = v337
	goto L13
L16:
...
L19:
	;
	v76 = *(*int32)(unsafe.Add(mBase, _consts[654]))
	v82 = int32(0)
	goto L20
L20:
	;
...
L21:
	;
	v109 = int32(0)
	v111 = *(*int32)(unsafe.Add(mBase, _consts[654]))
	v113 = v111 + int32(16)
	if v62 != int32(1) {
		goto L27
	} else {
...
L42:
	;
	v243 = *(*int32)(unsafe.Add(mBase, _consts[536]))
	v244 = int32(0)
	v247 = *(*int32)(unsafe.Add(mBase, _consts[656]))
...
L45:
	;
	v274 = *(*int32)(unsafe.Add(mBase, _consts[654]))
...
L47:
	;
	v330 = v258 + int32(1)
	v332 = *(*int32)(unsafe.Add(mBase, _consts[536]))
	if v330 < v332 {
		v258 = v330
		v265 = v328
		goto L45
...
L49:
	...
	v286 = *(*int32)(unsafe.Add(mBase, _consts[657]))
	goto L50
L50:
	;
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+80)) = v300
	F_errmsg_internal(m, int32(475393), v21+int32(80))
	mBase = m.M
	v306 = m.ExcPending
	if v306 != 0 {
		goto L1
...
L56:
	;
	F_errfinish(m, int32(518547), int32(393), int32(341371))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L1
...
L65:
	...
	v369 = int32(1)
	v371 = int32(0)
	v373 = *(*int32)(unsafe.Add(mBase, _consts[654]))
	v375 = v373 + int32(16)
	if v347 != v369 {
		goto L66
	} else {
...
L82:
	;
	v485 = *(*int32)(unsafe.Add(mBase, _consts[658]))
	if v475 < v485 {
		goto L81
	} else {
		goto L83
...
L91:
	;
	F_errmsg(m, int32(126449), int32(0))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
L92:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = int32(142125)
	F_errhint(m, int32(695721), v21)
	mBase = m.M
	v520 = m.ExcPending
	if v520 != 0 {
		goto L1
...
L93:
	;
	F_errfinish(m, int32(518547), int32(438), int32(341371))
	mBase = m.M
	v525 = m.ExcPending
	if v525 != 0 {
		goto L1
...
L99:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v21)+296)) = int64(8589934595)
	v583 = F_pg_snprintf(m, v21+int32(308), int32(1024), int32(171330), int32(0))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L1
...
L102:
	;
	v652 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(291334), int32(0))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L1
...
L104:
	;
	v615 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(291403), int32(0))
	mBase = m.M
	v616 = m.ExcPending
	if v616 != 0 {
		goto L1
...
L105:
	;
	v591 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(291326), int32(0))
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L1
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+48)) = l2
	v600 = F_pg_snprintf(m, v21+int32(104), int32(96), int32(48218), v21+int32(48))
	mBase = m.M
	v601 = m.ExcPending
	if v601 != 0 {
		goto L1
...
L107:
	;
	v607 = F_pg_snprintf(m, v21+int32(200), int32(96), int32(231672), int32(0))
	mBase = m.M
	v608 = m.ExcPending
	if v608 != 0 {
		goto L1
...
L109:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+64)) = l2
	v625 = F_pg_snprintf(m, v21+int32(104), int32(96), int32(60497), v21-int32(-64))
	mBase = m.M
	v626 = m.ExcPending
	if v626 != 0 {
		goto L1
...
L110:
	;
	v632 = F_pg_snprintf(m, v21+int32(200), int32(96), int32(231916), int32(0))
	mBase = m.M
	v633 = m.ExcPending
	if v633 != 0 {
		goto L1
...
L113:
	;
	F_errfinish(m, int32(518547), int32(506), int32(341371))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L1
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+32)) = l2
	v661 = F_pg_snprintf(m, v21+int32(104), int32(96), int32(48165), v21+int32(32))
	mBase = m.M
	v662 = m.ExcPending
	if v662 != 0 {
		goto L1
...
L116:
	;
	v668 = F_pg_snprintf(m, v21+int32(200), int32(96), int32(231320), int32(0))
	mBase = m.M
	v669 = m.ExcPending
	if v669 != 0 {
		goto L1
...
L126:
	;
	F_errmsg(m, int32(126489), int32(0))
	mBase = m.M
	v726 = m.ExcPending
	if v726 != 0 {
		goto L1
...
L127:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = int32(170744)
	F_errhint(m, int32(695721), v21+int32(16))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L128:
	;
	F_errfinish(m, int32(518547), int32(524), int32(341371))
	mBase = m.M
	v738 = m.ExcPending
	if v738 != 0 {
		goto L1
...
L137:
	;
	v828 = *(*int32)(unsafe.Add(mBase, _consts[517]))
...
L147:
	;
	v824 = *(*int32)(unsafe.Add(mBase, _consts[517]))
	F_SetLatch(m, v824)
	mBase = m.M
	v826 = m.ExcPending
	if v826 != 0 {
...
L150:
	;
	v839 = *(*int32)(unsafe.Add(mBase, _consts[517]))
...
L155:
	;
	F_errmsg(m, int32(596459), int32(0))
	mBase = m.M
	v859 = m.ExcPending
	if v859 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(518547), int32(344), int32(341371))
	mBase = m.M
	v864 = m.ExcPending
	if v864 != 0 {
		goto L1
