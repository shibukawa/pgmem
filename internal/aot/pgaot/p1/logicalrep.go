...
func F_logicalrep_message_type(m *base.Module, l0 int32) int32 {
	...
	default:
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
		v30 = int32(4430272)
		v34 = F_pg_snprintf(m, v30, int32(20), int32(681436), v6)
		mBase = m.M
		v37 = m.ExcPending
		if v37 != 0 {
			return int32(0)
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+96)) = l3
	F_errmsg_internal(m, int32(704182), v21+int32(96))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L6:
	;
	F_errfinish(m, int32(496631), int32(338), int32(326741))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L1
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+80)) = v300
	F_errmsg_internal(m, int32(455890), v21+int32(80))
	mBase = m.M
	v306 = m.ExcPending
	if v306 != 0 {
		goto L1
...
L56:
	;
	F_errfinish(m, int32(496631), int32(393), int32(326741))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L1
...
L91:
	;
	F_errmsg(m, int32(119096), int32(0))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
L92:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21))) = int32(134187)
	F_errhint(m, int32(668123), v21)
	mBase = m.M
	v520 = m.ExcPending
	if v520 != 0 {
		goto L1
...
L93:
	;
	F_errfinish(m, int32(496631), int32(438), int32(326741))
	mBase = m.M
	v525 = m.ExcPending
	if v525 != 0 {
		goto L1
...
L99:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v21)+296)) = int64(8589934595)
	v583 = F_pg_snprintf(m, v21+int32(308), int32(1024), int32(162142), int32(0))
	mBase = m.M
	v584 = m.ExcPending
	if v584 != 0 {
		goto L1
...
L102:
	;
	v652 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(279235), int32(0))
	mBase = m.M
	v653 = m.ExcPending
	if v653 != 0 {
		goto L1
...
L104:
	;
	v615 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(279304), int32(0))
	mBase = m.M
	v616 = m.ExcPending
	if v616 != 0 {
		goto L1
...
L105:
	;
	v591 = F_pg_snprintf(m, v21+int32(1332), int32(96), int32(279227), int32(0))
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L1
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+48)) = l2
	v600 = F_pg_snprintf(m, v21+int32(104), int32(96), int32(44781), v21+int32(48))
	mBase = m.M
	v601 = m.ExcPending
	if v601 != 0 {
		goto L1
...
L107:
	;
	v607 = F_pg_snprintf(m, v21+int32(200), int32(96), int32(221274), int32(0))
	mBase = m.M
	v608 = m.ExcPending
	if v608 != 0 {
		goto L1
...
L109:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+64)) = l2
	v625 = F_pg_snprintf(m, v21+int32(104), int32(96), int32(55581), v21-int32(-64))
	mBase = m.M
	v626 = m.ExcPending
	if v626 != 0 {
		goto L1
...
L110:
	;
	v632 = F_pg_snprintf(m, v21+int32(200), int32(96), int32(221518), int32(0))
	mBase = m.M
	v633 = m.ExcPending
	if v633 != 0 {
		goto L1
...
L113:
	;
	F_errfinish(m, int32(496631), int32(506), int32(326741))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L1
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+32)) = l2
	v661 = F_pg_snprintf(m, v21+int32(104), int32(96), int32(44728), v21+int32(32))
	mBase = m.M
	v662 = m.ExcPending
	if v662 != 0 {
		goto L1
...
L116:
	;
	v668 = F_pg_snprintf(m, v21+int32(200), int32(96), int32(220922), int32(0))
	mBase = m.M
	v669 = m.ExcPending
	if v669 != 0 {
		goto L1
...
L127:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v21)+16)) = int32(161556)
	F_errhint(m, int32(668123), v21+int32(16))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L128:
	;
	F_errfinish(m, int32(496631), int32(524), int32(326741))
	mBase = m.M
	v738 = m.ExcPending
	if v738 != 0 {
		goto L1
...
L155:
	;
	F_errmsg(m, int32(571547), int32(0))
	mBase = m.M
	v859 = m.ExcPending
	if v859 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(496631), int32(344), int32(326741))
	mBase = m.M
	v864 = m.ExcPending
	if v864 != 0 {
		goto L1
