...
L60:
	;
	F_errfinish(m, int32(492657), int32(735), int32(232377))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L4
...
L63:
	;
	F_errfinish(m, int32(492657), int32(938), int32(463180))
	mBase = m.M
	v313 = m.ExcPending
	if v313 != 0 {
		goto L4
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v90 + int32(4)
					...
					if v118 != 0 {
						...
						if v122 != 0 {
							...
							F_errfinish(m, int32(499147), int32(824), int32(406785))
							mBase = m.M
							v127 = m.ExcPending
							if v127 != 0 {
								return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v47 + int32(4)
				...
				if v73 != 0 {
					...
					if v77 != 0 {
						...
						F_errfinish(m, int32(499147), int32(813), int32(406785))
						mBase = m.M
						v82 = m.ExcPending
						if v82 != 0 {
							return
...
L21:
	;
	F_errfinish(m, int32(493380), int32(2605), int32(96154))
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L2
...
L24:
	;
	F_errfinish(m, int32(493380), int32(2608), int32(96154))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L2
		...
		if v56 != 0 {
			...
			if v59 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v60 + int32(4)
				F_errmsg(m, int32(409967), v7)
				mBase = m.M
				v66 = m.ExcPending
				if v66 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(499147), int32(158), int32(503738))
					mBase = m.M
					v71 = m.ExcPending
					if v71 != 0 {
						return int32(0)
				...
				if v75 != 0 {
					...
					if v78 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v80 + int32(4)
						F_errmsg(m, int32(472982), v7+int32(16))
						mBase = m.M
						v91 = m.ExcPending
						if v91 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(499147), int32(167), int32(503738))
							mBase = m.M
							v96 = m.ExcPending
							if v96 != 0 {
								return int32(0)
