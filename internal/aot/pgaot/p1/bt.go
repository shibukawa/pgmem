...
L34:
	...
	v141 = v139 & int32(_a_F__bt_advance_array_keys_0)
	if v141 == int32(0) {
		goto L35
	} else {
		goto L36
...
L62:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v107))) = v191 | int32(_a_F__bt_advance_array_keys_1)
	v477 = int32(1)
	v480 = v93
	v481 = v96
	v483 = v100
...
L64:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v107))) = v191 | int32(_a_F__bt_advance_array_keys_2)
	v477 = int32(1)
	v480 = v93
	v481 = v96
	v483 = v100
...
L84:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v107))) = v252 | int32(_a_F__bt_advance_array_keys_1)
	v477 = v222
	v480 = v93
	v481 = v96
	v483 = v100
...
L86:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v107))) = v252 | int32(_a_F__bt_advance_array_keys_2)
	v477 = v222
	v480 = v93
	v481 = v96
	v483 = v100
...
L140:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v107))) = v397 | int32(_a_F__bt_advance_array_keys_1)
	goto L117
L141:
	;
	goto L142
L142:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v107))) = v397 | int32(_a_F__bt_advance_array_keys_2)
	goto L117
L143:
	;
	if v382&int32(1) != 0 {
...
L168:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v29)+8)) = uint8(v648)
	...
	if v651&int32(_a_F__bt_advance_array_keys_1) != 0 {
		v731 = v650
		goto L167
	} else {
		goto L205
...
L174:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v29)+8)) = uint8(v544)
	...
	if v547&int32(_a_F__bt_advance_array_keys_2) != 0 {
		v731 = v546
		goto L167
	} else {
		goto L175
...
L177:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v538))) = v547 | int32(_a_F__bt_advance_array_keys_3)
	v834 = v546
	goto L7
L178:
	;
...
L207:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v538))) = v651 | int32(_a_F__bt_advance_array_keys_4)
	v834 = v650
	goto L7
L208:
	;
...
L248:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v538))) = v757 | int32(_a_F__bt_advance_array_keys_1)
	goto L234
L249:
	;
	goto L250
L250:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v538))) = v757 | int32(_a_F__bt_advance_array_keys_2)
	goto L234
L251:
	;
	goto L166
...
L279:
	...
	if v951&int32(_a_F__bt_advance_array_keys_5) != 0 {
		goto L278
	} else {
		goto L280
	}
...
L288:
	...
	if v1006&int32(_a_F__bt_advance_array_keys_5) != 0 {
		goto L287
	} else {
		goto L289
	}
...
L14:
	;
	v332 = F_PageAddItemExtended(m, v321, v319, v327, v318&int32(_a_F__bt_buildadd_3), int32(0))
	mBase = m.M
	v333 = m.ExcPending
	if v333 != 0 {
		goto L4
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+16)) = v86 + int32(1)
	...
	v100 = v28 + v97&int32(_a_F__bt_buildadd_7)
	if v38 == v74 {
		goto L28
	} else {
		goto L29
...
L33:
	...
	v141 = *(*int32)(unsafe.Add(mBase, uint32((v26-v130)&int32(_a_F__bt_buildadd_3)<<(uint(int32(2))%32)+v91-int32(4))))
	v145 = *(*int32)(unsafe.Add(mBase, uint32(l0)+12))
	v146 = F__bt_truncate(m, v131, v28+v141&int32(_a_F__bt_buildadd_7), v100, v145)
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L4
...
L36:
	...
	v151 = F_PageIndexTupleOverwrite(m, v28, v130, v146, v148&int32(_a_F__bt_buildadd_0))
	mBase = m.M
	v152 = m.ExcPending
	if v152 != 0 {
		goto L4
...
L39:
	...
	v162 = v28 + v157&int32(_a_F__bt_buildadd_7)
	goto L35
L40:
	;
...
L44:
	;
	F_PageInit(m, v173, int32(_a_F__bt_buildadd_2), int32(16))
	mBase = m.M
	goto L45
L45:
	;
...
L48:
	...
	v217 = base.I32_div_s(int32(_a_F__bt_buildadd_10)-v212<<(uint(int32(13))%32), int32(100))
	v219 = v217
	goto L46
L49:
	;
...
L56:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v264)+4)) = uint16(v265)
	...
	v269 = v267 | int32(_a_F__bt_buildadd_2)
	*(*uint16)(unsafe.Add(mBase, uint32(v264)+6)) = uint16(v269)
	goto L55
L57:
	;
	v276 = int32(2)
	if v273&int32(_a_F__bt_buildadd_3) != v276 {
		goto L16
	} else {
		goto L58
	}
...
func F__bt_checkpage(m *base.Module, l0 int32, l1 int32) {
	...
	m.G0 = v7
	if l1 < int32(0) {
		v12 = *(*int32)(unsafe.Add(mBase, _c_F__bt_checkpage[0]))
		v18 = *(*int32)(unsafe.Add(mBase, uint32(v12+(l1^int32(-1))<<(uint(int32(2))%32))))
		v26 = v18
	} else {
		v20 = *(*int32)(unsafe.Add(mBase, _c_F__bt_checkpage[1]))
	...
	if v27 != 0 {
		...
		if (v28<<(uint(int32(8))%32)-v31)&int32(_a_F__bt_checkpage_0) != int32(16) {
			F_errstart_cold(m, int32(21), int32(0))
			mBase = m.M
			v86 = m.ExcPending
			if v86 != 0 {
				...
				if v89 != 0 {
					...
					if l1 < int32(0) {
						v94 = *(*int32)(unsafe.Add(mBase, _c_F__bt_checkpage[2]))
						v100 = *(*int32)(unsafe.Add(mBase, uint32(v94+(l1^int32(-1))<<(uint(int32(6))%32))+16))
						v109 = v100
					} else {
						v102 = *(*int32)(unsafe.Add(mBase, _c_F__bt_checkpage[3]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v90 + int32(4)
					F_errmsg(m, int32(_a_F__bt_checkpage_1), v7+int32(16))
					mBase = m.M
					v118 = m.ExcPending
					if v118 != 0 {
						return
					} else {
						F_errhint(m, int32(_a_F__bt_checkpage_2), int32(0))
						mBase = m.M
						v122 = m.ExcPending
						if v122 != 0 {
							return
						} else {
							F_errfinish(m, int32(_a_F__bt_checkpage_3), int32(824), int32(_a_F__bt_checkpage_4))
							mBase = m.M
							v127 = m.ExcPending
							if v127 != 0 {
								return
		...
		if v43 != 0 {
			...
			if v46 != 0 {
				...
				if l1 < int32(0) {
					v51 = *(*int32)(unsafe.Add(mBase, _c_F__bt_checkpage[2]))
					v57 = *(*int32)(unsafe.Add(mBase, uint32(v51+(l1^int32(-1))<<(uint(int32(6))%32))+16))
					v66 = v57
				} else {
					v59 = *(*int32)(unsafe.Add(mBase, _c_F__bt_checkpage[3]))
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v47 + int32(4)
				F_errmsg(m, int32(_a_F__bt_checkpage_5), v7)
				mBase = m.M
				v73 = m.ExcPending
				if v73 != 0 {
					return
					...
					if v77 != 0 {
						...
						F_errfinish(m, int32(_a_F__bt_checkpage_3), int32(813), int32(_a_F__bt_checkpage_4))
						mBase = m.M
						v82 = m.ExcPending
						if v82 != 0 {
							return
...
L3:
	;
	v63 = *(*int32)(unsafe.Add(mBase, _c_F__bt_end_vacuum_callback[0]))
...
L20:
	;
	v88 = int32(1)
	v91 = v23 & int32(_a_F__bt_getstackbuf_1)
	if v76 != 0 {
		goto L21
	} else {
		goto L22
...
L26:
	;
	v98 = v87 & int32(_a_F__bt_getstackbuf_1)
...
L29:
	;
	if base.Ui32(v100&int32(_a_F__bt_getstackbuf_1)) <= base.Ui32(v98) {
		goto L30
	} else {
		goto L31
	}
...
L33:
	;
	v127 = *(*int32)(unsafe.Add(mBase, uint32(v110&int32(_a_F__bt_getstackbuf_1)<<(uint(int32(2))%32)+(v67+int32(24))-int32(4))))
	v130 = v67 + v127&int32(_a_F__bt_getstackbuf_2)
...
L37:
	;
	v138 = v110 + int32(1)
	if base.Ui32(v138&int32(_a_F__bt_getstackbuf_1)) <= base.Ui32(v98) {
		v110 = v138
		goto L33
	} else {
		goto L38
...
L39:
	;
	v173 = v163 - int32(1)
	v175 = v173 & int32(_a_F__bt_getstackbuf_1)
...
L41:
	...
	v185 = v67 + v182&int32(_a_F__bt_getstackbuf_2)
...
func F__bt_readfirstpage(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+36)) = int32(0)
	v11 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v6)+17)))
	if v11 == int32(1) {
		v14 = int32(0)
		*(*uint8)(unsafe.Add(mBase, uint32(v6)+17)) = uint8(v14)
		v16 = int32(257)
		*(*uint16)(unsafe.Add(mBase, uint32(v6)+88)) = uint16(v16)
	} else {
		if l2 == int32(1) {
			v20 = int32(256)
			*(*uint16)(unsafe.Add(mBase, uint32(v6)+88)) = uint16(v20)
		} else {
			v22 = int32(1)
			*(*uint16)(unsafe.Add(mBase, uint32(v6)+88)) = uint16(v22)
		}
	}
	v25 = F__bt_readpage(m, l0, l2, l1, int32(1))
	mBase = m.M
	v28 = m.ExcPending
	if v28 != 0 {
		return int32(0)
		...
		if v25 != 0 {
			v30 = *(*int32)(unsafe.Add(mBase, uint32(v6)+56))
			v31 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v6)+40)))
			if v31 == int32(0) {
				F__bt_unlockbuf(m, v30)
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return int32(0)
				...
				v38 = F_BufferGetLSNAtomic(m, v30)
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return int32(0)
				} else {
					*(*int64)(unsafe.Add(mBase, uint32(v6)+72)) = v38
					v41 = *(*int32)(unsafe.Add(mBase, uint32(v6)+56))
					F__bt_relbuf(m, v41)
					mBase = m.M
					v43 = m.ExcPending
					if v43 != 0 {
			...
			v48 = *(*int32)(unsafe.Add(mBase, uint32(v6)+56))
			F__bt_unlockbuf(m, v48)
			mBase = m.M
			v50 = m.ExcPending
			if v50 != 0 {
				return int32(0)
			} else {
				v51 = F__bt_steppage(m, l0, l2)
				mBase = m.M
				v52 = m.ExcPending
				if v52 != 0 {
					return int32(0)
...
L23:
	...
	if v138&int32(_a_F__bt_set_startikey_1) == int32(0) {
		goto L29
	} else {
		goto L30
	}
