...
L36:
	;
	F_errmsg_internal(m, int32(170944), int32(0))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L31
...
L37:
	;
	F_errfinish(m, int32(512044), int32(4906), int32(404740))
	mBase = m.M
	v117 = m.ExcPending
	if v117 != 0 {
		goto L31
...
L43:
	;
	F_errmsg_internal(m, int32(236606), int32(0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L31
...
L44:
	;
	F_errfinish(m, int32(512044), int32(4897), int32(404740))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L31
