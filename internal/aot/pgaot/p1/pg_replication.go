...
L2:
	;
	v31 = int32(_a_F_pg_get_replication_slots_0)
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[0]))
	v33 = *(*int64)(unsafe.Add(mBase, uint32(v32)+280))
	*(*int64)(unsafe.Add(mBase, uint32(v32)+280)) = v33
	*(*int64)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[1])) = v33
	v38 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[0]))
	v39 = *(*int64)(unsafe.Add(mBase, uint32(v38)+272))
	*(*int64)(unsafe.Add(mBase, uint32(v38)+272)) = v39
	*(*int64)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[2])) = v39
	goto L3
L3:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[3]))
	v48 = F_LWLockAcquire(m, v44+int32(_a_F_pg_get_replication_slots_1), int32(1))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L1
...
L4:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[4]))
	if int32(0) < v51 {
		goto L5
	} else {
		goto L6
...
L7:
	;
	v523 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[3]))
	F_LWLockRelease(m, v523+int32(_a_F_pg_get_replication_slots_1))
	mBase = m.M
	v527 = m.ExcPending
	if v527 != 0 {
		goto L1
...
L13:
	;
	F_s_lock(m, v86, int32(_a_F_pg_get_replication_slots_2), int32(268), int32(_a_F_pg_get_replication_slots_3))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L1
...
L23:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v21)+1)) = uint8(v121)
	v126 = int32(_a_F_pg_get_replication_slots_4)
	goto L22
L24:
	;
	goto L25
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v21)+36)) = v21 + int32(249)
	v126 = int32(_a_F_pg_get_replication_slots_5)
	goto L22
L26:
	;
...
L55:
	;
	v327 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[6]))
	if v327 < int32(0) {
		v353 = v318
		goto L54
	} else {
...
L57:
	;
	v305 = F_cstring_to_text(m, int32(_a_F_pg_get_replication_slots_6))
	mBase = m.M
	v306 = m.ExcPending
	if v306 != 0 {
		goto L1
...
L62:
	;
	v181 = int32(_a_F_pg_get_replication_slots_0)
	...
	*(*int64)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[1])) = v183
	v188 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[0]))
	v189 = *(*int64)(unsafe.Add(mBase, uint32(v188)+272))
	*(*int64)(unsafe.Add(mBase, uint32(v188)+272)) = v189
	*(*int64)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[2])) = v189
	v194 = int64(*(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[7])))
...
L63:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[0]))
...
L64:
	;
	v207 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[0]))
	F_s_lock(m, v207+int32(440), int32(_a_F_pg_get_replication_slots_7), int32(3760), int32(_a_F_pg_get_replication_slots_8))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L1
...
L66:
	;
	v216 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v216)+440)) = int32(0)
	v220 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[7]))
...
L68:
	...
	v230 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[8]))
	v232 = base.I32_div_s(v220, int32(_a_F_pg_get_replication_slots_9))
...
L81:
	;
	v269 = F_cstring_to_text(m, int32(_a_F_pg_get_replication_slots_10))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L82:
	;
	v265 = F_cstring_to_text(m, int32(_a_F_pg_get_replication_slots_11))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L1
...
L83:
	;
	v261 = F_cstring_to_text(m, int32(_a_F_pg_get_replication_slots_12))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L1
...
L89:
	;
	F_s_lock(m, v86, int32(_a_F_pg_get_replication_slots_2), int32(364), int32(_a_F_pg_get_replication_slots_3))
	mBase = m.M
	v291 = m.ExcPending
	if v291 != 0 {
		goto L1
...
L93:
	;
	v300 = F_cstring_to_text(m, int32(_a_F_pg_get_replication_slots_10))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L96:
	...
	v332 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[7]))
	v333 = base.I64_extend_i32_s(v332)
	v334 = base.I64_div_u_s(v330, v333)
	v336 = base.I32_div_s(v332, int32(_a_F_pg_get_replication_slots_9))
	v337 = base.I32_div_s(v327, v336)
	v339 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[9]))
...
L112:
	;
	v456 = int32(_a_F_pg_get_replication_slots_13)
...
L123:
	;
	v469 = *(*int32)(unsafe.Add(mBase, uint32(v418<<(uint(int32(2))%32))+uint32(_c_F_pg_get_replication_slots[10])))
...
L125:
	;
	v489 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[4]))
	v491 = *(*int32)(unsafe.Add(mBase, _c_F_pg_get_replication_slots[5]))
	v493 = v489
	v495 = v491
	goto L12
L126:
