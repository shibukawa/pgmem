...
L4:
	;
	v51 = *(*int32)(unsafe.Add(mBase, _consts[667]))
	if int32(0) < v51 {
		goto L5
	} else {
		goto L6
...
L5:
	;
	v59 = *(*int32)(unsafe.Add(mBase, _consts[668]))
	v68 = v51
	v70 = v59
	v74 = v2
	goto L8
...
L13:
	;
	F_s_lock(m, v86, int32(514085), int32(268), int32(125428))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L1
...
L55:
	;
	v327 = *(*int32)(unsafe.Add(mBase, _consts[671]))
	if v327 < int32(0) {
		v353 = v318
		goto L54
	} else {
...
L57:
	;
	v305 = F_cstring_to_text(m, int32(73438))
	mBase = m.M
	v306 = m.ExcPending
	if v306 != 0 {
		goto L1
...
L64:
	...
	F_s_lock(m, v207+int32(440), int32(518196), int32(3760), int32(250853))
	mBase = m.M
	v214 = m.ExcPending
	if v214 != 0 {
		goto L1
...
L81:
	;
	v269 = F_cstring_to_text(m, int32(457157))
	mBase = m.M
	v270 = m.ExcPending
	if v270 != 0 {
		goto L1
...
L82:
	;
	v265 = F_cstring_to_text(m, int32(478640))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L1
...
L83:
	;
	v261 = F_cstring_to_text(m, int32(457227))
	mBase = m.M
	v262 = m.ExcPending
	if v262 != 0 {
		goto L1
...
L89:
	;
	F_s_lock(m, v86, int32(514085), int32(364), int32(125428))
	mBase = m.M
	v291 = m.ExcPending
	if v291 != 0 {
		goto L1
...
L93:
	;
	v300 = F_cstring_to_text(m, int32(457157))
	mBase = m.M
	v301 = m.ExcPending
	if v301 != 0 {
		goto L1
...
L96:
	...
	v339 = *(*int32)(unsafe.Add(mBase, _consts[672]))
...
L123:
	;
	v469 = *(*int32)(unsafe.Add(mBase, uint32(v418<<(uint(int32(2))%32))+uint32(_consts[673])))
...
L125:
	;
	v489 = *(*int32)(unsafe.Add(mBase, _consts[667]))
	v491 = *(*int32)(unsafe.Add(mBase, _consts[668]))
	v493 = v489
	v495 = v491
	goto L12
L126:
