...
func F_clear_subscription_skip_lsn(m *base.Module, l0 int64) {
	...
	v10 = v8 - int32(192)
	m.G0 = v10
	v13 = *(*int32)(unsafe.Add(mBase, _consts[665]))
	v14 = *(*int64)(unsafe.Add(mBase, uint32(v13)+8))
	if v14 == int64(0) {
		m.G0 = v10 + int32(192)
		return
	} else {
		v18 = *(*int32)(unsafe.Add(mBase, _consts[651]))
					...
					if v33 != 0 {
						...
						if v35 != 0 {
							...
							if v37 != 0 {
								...
								v40 = *(*int32)(unsafe.Add(mBase, _consts[665]))
											...
											if v54 == int32(0) {
												...
												if v155 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v10))) = v158
													F_errmsg_internal(m, int32(77232), v10)
													mBase = m.M
													v162 = m.ExcPending
													if v162 != 0 {
														return
													} else {
														F_errfinish(m, int32(519893), int32(4990), int32(257311))
														mBase = m.M
														v167 = m.ExcPending
														if v167 != 0 {
															return
																			...
																			*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v109
																			...
																			if v115 != 0 {
																				...
																				*(*uint32)(unsafe.Add(mBase, uint32(v10)+16)) = uint32(v122)
																				F_errdetail(m, int32(686932), v10+int32(16))
																				mBase = m.M
																				v128 = m.ExcPending
																				if v128 != 0 {
																					return
																				} else {
																					F_errfinish(m, int32(519893), int32(5028), int32(257311))
																					mBase = m.M
																					v133 = m.ExcPending
																					if v133 != 0 {
																						return
