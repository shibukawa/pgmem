...
func F_tuplestore_putvalues(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	var v21 int32
	_ = v21
	v6 = int32(_a_F_tuplestore_putvalues_0)
	v7 = *(*int32)(unsafe.Add(mBase, _c_F_tuplestore_putvalues[0]))
	v9 = *(*int32)(unsafe.Add(mBase, uint32(l0)+52))
	*(*int32)(unsafe.Add(mBase, _c_F_tuplestore_putvalues[0])) = v9
		...
		if v15 != 0 {
			...
			*(*int64)(unsafe.Add(mBase, uint32(l0)+24)) = v16 - base.I64_extend_i32_u(v14)
			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_tuplestore_putvalues[0])) = v7
				return
			}
		}
	}
			...
			*(*int32)(unsafe.Add(mBase, uint32(l0)+96)) = l1
			...
			if v8 == int32(2) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(l0)+96)) = l1
							...
							if v48 != 0 {
								...
								if v50 != 0 {
									...
									F_errmsg(m, int32(_a_F_tuplestore_select_read_pointer_0), int32(0))
									mBase = m.M
									v54 = m.ExcPending
									if v54 != 0 {
										return
				...
				if v85 != 0 {
					...
					F_errmsg_internal(m, int32(_a_F_tuplestore_select_read_pointer_3), int32(0))
					mBase = m.M
					v89 = m.ExcPending
					if v89 != 0 {
						return
