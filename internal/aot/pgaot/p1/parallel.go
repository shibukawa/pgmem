...
L36:
	;
	v232 = F_CreateParallelContext(m, int32(171330), int32(291124), l3)
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L4
...
L160:
	;
	F_errfinish(m, int32(521026), int32(877), int32(296575))
	mBase = m.M
	v916 = m.ExcPending
	if v916 != 0 {
		goto L4
...
L6:
	;
	F_errfinish(m, int32(521009), int32(1009), int32(290910))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+12)) = v12 + int32(24)
	v171 = F___memcpy(m, int32(4452664), int32(4452504), int32(128))
	mBase = m.M
...
L47:
	...
	mBase = m.M
	F_BufferUsageAccumDiff(m, v268, int32(4452664))
	mBase = m.M
	v272 = v263 + int32(24)
	v273 = int64(0)
