...
L36:
	;
	v231 = F_CreateParallelContext(m, int32(278509), l3)
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L4
...
L159:
	;
	F_errmsg_internal(m, int32(171239), int32(0))
	mBase = m.M
	v910 = m.ExcPending
	if v910 != 0 {
		goto L4
...
L160:
	;
	F_errfinish(m, int32(497620), int32(877), int32(283733))
	mBase = m.M
	v915 = m.ExcPending
	if v915 != 0 {
		goto L4
...
L6:
	;
	F_errfinish(m, int32(497603), int32(1009), int32(278295))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+12)) = v12 + int32(24)
	v171 = F___memcpy(m, int32(4413912), int32(4413752), int32(128))
	mBase = m.M
...
L47:
	...
	mBase = m.M
	F_BufferUsageAccumDiff(m, v268, int32(4413912))
	mBase = m.M
	v272 = v263 + int32(24)
	v273 = int64(0)
