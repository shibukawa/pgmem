...
L76:
	...
	v515 = F_add_size(m, v513, int32(_a_F_ExecInitParallelPlan_2))
	mBase = m.M
	v516 = m.ExcPending
	if v516 != 0 {
		goto L4
...
L149:
	...
	v869 = F_shm_toc_allocate(m, v867, int32(_a_F_ExecInitParallelPlan_2))
	mBase = m.M
	v870 = m.ExcPending
	if v870 != 0 {
		goto L4
...
L151:
	...
	v878 = F_dsa_create_in_place_ext(m, v869, int32(_a_F_ExecInitParallelPlan_2), int32(71), v877)
	mBase = m.M
	v879 = m.ExcPending
	if v879 != 0 {
		goto L4
