...
L160:
	;
	F_errfinish(m, int32(494298), int32(877), int32(281928))
	mBase = m.M
	v915 = m.ExcPending
	if v915 != 0 {
		goto L4
...
L6:
	;
	F_errfinish(m, int32(494281), int32(1009), int32(276624))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+12)) = v12 + int32(24)
	v171 = F___memcpy(m, int32(4385352), int32(4385192), int32(128))
	mBase = m.M
...
L47:
	...
	mBase = m.M
	F_BufferUsageAccumDiff(m, v268, int32(4385352))
	mBase = m.M
	v272 = v263 + int32(24)
	v273 = int64(0)
