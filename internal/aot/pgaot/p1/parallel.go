...
L36:
	;
	v231 = F_CreateParallelContext(m, int32(275538), l3)
	mBase = m.M
	v232 = m.ExcPending
	if v232 != 0 {
		goto L4
...
L193:
	;
	F_errmsg_internal(m, int32(169628), int32(0))
	mBase = m.M
	v1022 = m.ExcPending
	if v1022 != 0 {
		goto L4
...
L194:
	;
	F_errfinish(m, int32(492034), int32(877), int32(280583))
	mBase = m.M
	v1027 = m.ExcPending
	if v1027 != 0 {
		goto L4
...
L3:
	;
	F_errmsg_internal(m, int32(218792), int32(0))
	mBase = m.M
	v21 = m.ExcPending
	if v21 != 0 {
		goto L1
...
L6:
	;
	F_errfinish(m, int32(492017), int32(1009), int32(275324))
	mBase = m.M
	v26 = m.ExcPending
	if v26 != 0 {
		goto L1
...
L28:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+12)) = v12 + int32(24)
	v171 = F___memcpy(m, int32(4374568), int32(4374408), int32(128))
	mBase = m.M
...
L47:
	...
	mBase = m.M
	F_BufferUsageAccumDiff(m, v268, int32(4374568))
	mBase = m.M
	v272 = v263 + int32(24)
	v273 = int64(0)
