...
func F_LogicalOutputWrite(m *base.Module, l0 int32, l1 int64, l2 int32, l3 int32) {
	...
	if base.Ui32(int32(1073741820)) <= base.Ui32(v12) {
		...
		if v18 != 0 {
			...
			F_errmsg_internal(m, int32(439445), int32(0))
			mBase = m.M
			v22 = m.ExcPending
			if v22 != 0 {
				return
			} else {
				F_errfinish(m, int32(517770), int32(71), int32(366706))
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return
...
L13:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v33)+uint32(_consts[1236]))) = base.I64_extend_i32_s(int32(0) - v37)
