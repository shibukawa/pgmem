...
L1:
	;
	v15 = int32(_a_F_LogicalTapeRewindForRead_0)
...
L2:
	;
	v25 = int32(_a_F_LogicalTapeRewindForRead_0)
	goto L3
L3:
	;
...
L13:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v33)+uint32(_c_F_LogicalTapeRewindForRead[0]))) = base.I64_extend_i32_s(int32(0) - v37)
