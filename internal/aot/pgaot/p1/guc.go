...
L8:
	...
	*(*uint8)(unsafe.Add(mBase, _consts[1208])) = uint8(v38)
	v43 = int32(1)
	v44 = int32(10)
	v50 = F_set_config_with_handle(m, int32(256561), v38, int32(431198), v43, v44, v44, v38, v43, v38, v38)
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L14:
	...
	v55 = int32(1)
	v56 = int32(10)
	v62 = F_set_config_with_handle(m, int32(19063), v53, int32(235632), v55, v56, v56, v53, v55, v53, v53)
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L15:
	...
	v67 = int32(1)
	v68 = int32(10)
	v74 = F_set_config_with_handle(m, int32(386422), v65, int32(235632), v67, v68, v68, v65, v67, v65, v65)
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L1
	...
	if l0 != 0 {
		...
		if v9 != 0 {
			...
			*(*int64)(unsafe.Add(mBase, uint32(v5))) = v10
			F_errcontext_msg(m, int32(673497), v5)
			mBase = m.M
			v14 = m.ExcPending
			if v14 != 0 {
				return
