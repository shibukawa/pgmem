...
L8:
	;
	v38 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _c_F_InitializeGUCOptions[3])) = uint8(v38)
	v43 = int32(1)
	v44 = int32(10)
	v50 = F_set_config_with_handle(m, int32(_a_F_InitializeGUCOptions_1), v38, int32(_a_F_InitializeGUCOptions_2), v43, v44, v44, v38, v43, v38, v38)
	mBase = m.M
	v51 = m.ExcPending
	if v51 != 0 {
		goto L1
...
L14:
	...
	v55 = int32(1)
	v56 = int32(10)
	v62 = F_set_config_with_handle(m, int32(_a_F_InitializeGUCOptions_3), v53, int32(_a_F_InitializeGUCOptions_4), v55, v56, v56, v53, v55, v53, v53)
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L1
...
L15:
	...
	v67 = int32(1)
	v68 = int32(10)
	v74 = F_set_config_with_handle(m, int32(_a_F_InitializeGUCOptions_5), v65, int32(_a_F_InitializeGUCOptions_4), v67, v68, v68, v65, v67, v65, v65)
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L1
