...
func F_gbt_bytea_sortsupport(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_bytea_sortsupport_0)
	return v3
}
...
func F_gbt_cash_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_cash_sortsupport_0)
	return v3
}
...
func F_gbt_float4_same(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(_a_F_gbt_float4_same_0), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_int4_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(8)
		...
		v15 = F_gbt_num_union(m, v6, v4, int32(_a_F_gbt_int4_union_0), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_intv_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(32)
		v14 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
		v15 = F_gbt_num_union(m, v6, v4, int32(_a_F_gbt_intv_union_0), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_macad8_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v14
	...
	v34 = F_gbt_num_consistent(m, v8+int32(4), v10, v8+int32(14), v29&int32(1), int32(_a_F_gbt_macad8_consistent_0), v33)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		return int32(0)
...
func F_gbt_macad_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v14
	...
	v29 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v26+v27)+12)))
	v33 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v34 = F_gbt_num_consistent(m, v8+int32(4), v10, v8+int32(14), v29&int32(1), int32(_a_F_gbt_macad_consistent_0), v33)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		return int32(0)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+4)) = v39
	...
	if v46 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+28)) = v43
		...
		F_gbt_var_bin_union(m, v12+int32(28), v16, v50, int32(_a_F_gbt_numeric_penalty_0), v52)
		mBase = m.M
		v54 = m.ExcPending
		if v54 != 0 {
			return int32(0)
						...
						if v115 != 0 {
							...
							if v117 != 0 {
								...
								if v119 != 0 {
									...
									if v120 == int32(_a_F_gbt_numeric_penalty_1) {
										v124 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v114)+4)))
										if base.B2i32(v124 == int32(_a_F_gbt_numeric_penalty_1)) == int32(0) {
											v165 = float32(1)
...
func F_gbt_numeric_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_numeric_sortsupport_0)
	return v3
}
...
func F_gbt_oid_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
	...
	v29 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v26+v27)+12)))
	v33 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v34 = F_gbt_num_consistent(m, v7, v7+int32(12), v7+int32(10), v29&int32(1), int32(_a_F_gbt_oid_consistent_0), v33)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		return int32(0)
...
func F_gbt_ts_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_ts_sortsupport_0)
	return v3
}
...
func F_gbt_uuid_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(_a_F_gbt_uuid_sortsupport_0)
	return v3
}
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+4)) = l3
	v194 = int32(8)
	F_qsort_arg(m, v30+v194, v25, v194, int32(_a_F_gbt_var_picksplit_1), v19+int32(4))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+4)) = l3
	v129 = int32(8)
	F_qsort_arg(m, v30+v129, v25, v129, int32(_a_F_gbt_var_picksplit_1), v19+int32(4))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
...
L12:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30+v64<<(uint(int32(3))%32)))) = v64
	v124 = (v64 + int32(1)) & int32(_a_F_gbt_var_picksplit_0)
...
L26:
	;
	v189 = (v140 + int32(1)) & int32(_a_F_gbt_var_picksplit_0)
