...
func F_gbt_bit_penalty(m *base.Module, l0 int32) int32 {
	...
	v8 = F_gbt_var_penalty(m, v2, v3, v4, v5, int32(4357312), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_bit_union(m *base.Module, l0 int32) int32 {
	...
	v7 = F_gbt_var_union(m, v2, v3, v4, int32(4357312), v6)
	mBase = m.M
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
...
func F_gbt_bitge(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = F_DirectFunctionCall2Coll(m, int32(2656), int32(0), l0, l1)
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
...
func F_gbt_bytea_sortsupport(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6312)
	return v3
}
func F_gbt_byteaeq(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = F_DirectFunctionCall2Coll(m, int32(2856), int32(0), l0, l1)
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
...
func F_gbt_cash_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6319)
	return v3
}
func F_gbt_date_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4357472))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_float4_same(m *base.Module, l0 int32) int32 {
	...
	v7 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v8 = F_gbt_num_same(m, v4, v5, int32(4357552), v7)
	mBase = m.M
	v11 = m.ExcPending
	if v11 != 0 {
		return int32(0)
...
func F_gbt_float8_fetch(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_fetch(m, v2, int32(4357592))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v9)+7)) = uint8(v2)
	...
	if v25 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v9)+20)) = v15
		...
		v47 = F_gbt_num_consistent(m, v9+int32(20), v9+v29, v9+int32(30), v42&v27, int32(4357696), v46)
		mBase = m.M
		v48 = m.ExcPending
		if v48 != 0 {
			return int32(0)
...
func F_gbt_int2_distance(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+4)) = v12
	...
	v29 = F_gbt_num_distance(m, v7+int32(4), v7+int32(14), v24&int32(1), int32(4357736), v28)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		return int32(0)
...
func F_gbt_int2_sortsupport(m *base.Module, l0 int32) int32 {
	...
	_ = v2
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6365)
	return int32(0)
}
...
func F_gbt_int4_picksplit(m *base.Module, l0 int32) int32 {
	...
	v3 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v6 = F_gbt_num_picksplit(m, v2, v3, int32(4357776), v5)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
...
func F_gbt_int4_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(8)
		...
		v15 = F_gbt_num_union(m, v6, v4, int32(4357776), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_int8_sortsupport(m *base.Module, l0 int32) int32 {
	...
	_ = v2
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6381)
	return int32(0)
}
func F_gbt_intv_distance(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+8)) = v12
	...
	v27 = F_gbt_num_distance(m, v8+int32(8), v10, v22&int32(1), int32(4357856), v26)
	mBase = m.M
	v30 = m.ExcPending
	if v30 != 0 {
		return int32(0)
...
func F_gbt_intv_picksplit(m *base.Module, l0 int32) int32 {
	...
	v3 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v6 = F_gbt_num_picksplit(m, v2, v3, int32(4357856), v5)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
...
func F_gbt_intv_union(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v10))) = int32(32)
		v14 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
		v15 = F_gbt_num_union(m, v6, v4, int32(4357856), v14)
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
...
func F_gbt_macad8_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v14
	...
	v34 = F_gbt_num_consistent(m, v8+int32(4), v10, v8+int32(14), v29&int32(1), int32(4357936), v33)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		return int32(0)
...
func F_gbt_macad_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v14
	...
	v29 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v26+v27)+12)))
	v33 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v34 = F_gbt_num_consistent(m, v8+int32(4), v10, v8+int32(14), v29&int32(1), int32(4357896), v33)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		return int32(0)
...
func F_gbt_macaddr_ssup_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F_DirectFunctionCall2Coll(m, int32(2281), int32(0), l0, l1)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+4)) = v39
	...
	if v46 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v12)+28)) = v43
		...
		F_gbt_var_bin_union(m, v12+int32(28), v16, v50, int32(4357976), v52)
		mBase = m.M
		v54 = m.ExcPending
		if v54 != 0 {
			return int32(0)
										...
										*(*float32)(unsafe.Add(mBase, uint32(v14))) = v179
										...
										if v131 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v14))) = v132
											v136 = F_DirectFunctionCall2Coll(m, int32(2735), v132, v118, v130)
											mBase = m.M
											v137 = m.ExcPending
											if v137 != 0 {
												return int32(0)
												...
												if v136 != 0 {
													*(*float32)(unsafe.Add(mBase, uint32(v14))) = base.F32_add(v138, float32(1.1754944e-38))
													v143 = int32(0)
													v146 = F_DirectFunctionCall2Coll(m, int32(1275), v143, v118, v109)
													mBase = m.M
													v147 = m.ExcPending
													if v147 != 0 {
														return int32(0)
														...
														if v149 != 0 {
															...
															v150 = F_DirectFunctionCall1Coll(m, int32(1507), v143, v148)
															mBase = m.M
															v151 = m.ExcPending
															if v151 != 0 {
																return int32(0)
...
func F_gbt_numeric_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6411)
	return v3
}
func F_gbt_oid_compress(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_compress(m, v2, int32(4358016))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_oid_consistent(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v14
	...
	v29 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v26+v27)+12)))
	v33 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v34 = F_gbt_num_consistent(m, v7, v7+int32(12), v7+int32(10), v29&int32(1), int32(4358016), v33)
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		return int32(0)
...
func F_gbt_oid_fetch(m *base.Module, l0 int32) int32 {
	...
	_ = v7
	v2 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	v4 = F_gbt_num_fetch(m, v2, int32(4358016))
	mBase = m.M
	v7 = m.ExcPending
	if v7 != 0 {
		return int32(0)
...
func F_gbt_textlt(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F_DirectFunctionCall2Coll(m, int32(2243), l2, l0, l1)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
		...
		if v33 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v13))) = int32(0)
			...
			if base.F64_gt(v69, float64(0)) != 0 {
				v74 = F_DirectFunctionCall2Coll(m, int32(2720), int32(0), v23, v21)
				mBase = m.M
				v75 = m.ExcPending
				if v75 != 0 {
					return int32(0)
...
func F_gbt_timekey_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v11 != 0 {
		...
		if v8 != 0 {
			...
			v14 = int32(8)
			v18 = F_DirectFunctionCall2Coll(m, int32(1444), int32(0), v6+v14, v7+v14)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				return int32(0)
...
func F_gbt_timekey_ssup_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	var v9 int32
	_ = v9
	v6 = F_DirectFunctionCall2Coll(m, int32(1444), int32(0), l0, l1)
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
	} else {
...
func F_gbt_ts_picksplit(m *base.Module, l0 int32) int32 {
	...
	v3 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v5 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v6 = F_gbt_num_picksplit(m, v2, v3, int32(4358176), v5)
	mBase = m.M
	v9 = m.ExcPending
	if v9 != 0 {
		return int32(0)
...
func F_gbt_ts_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6448)
	return v3
}
func F_gbt_tstz_distance(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v8))) = v11
	...
	v24 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v21+v22)+12)))
	v28 = *(*int32)(unsafe.Add(mBase, uint32(l0)))
	v29 = F_gbt_num_distance(m, v8+v14, v8, v24&int32(1), int32(4358176), v28)
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		return int32(0)
...
func F_gbt_uuid_sortsupport(m *base.Module, l0 int32) int32 {
	...
	v3 = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v2)+12)) = v3
	*(*int32)(unsafe.Add(mBase, uint32(v2)+16)) = int32(6457)
	return v3
}
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+4)) = l3
	v194 = int32(8)
	F_qsort_arg(m, v30+v194, v25, v194, int32(6456), v19+int32(4))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L1
...
L11:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+4)) = l3
	v129 = int32(8)
	F_qsort_arg(m, v30+v129, v25, v129, int32(6456), v19+int32(4))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L1
