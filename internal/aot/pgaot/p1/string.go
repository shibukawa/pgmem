...
L6:
	;
	*(*int32)(unsafe.Add(mBase, _consts[338])) = v66
	*(*int32)(unsafe.Add(mBase, _consts[363])) = v67
...
L11:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _consts[338]))
	v56 = *(*int32)(unsafe.Add(mBase, _consts[363]))
	goto L12
L12:
	;
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, _consts[428])) = int32(50856066)
	*(*int32)(unsafe.Add(mBase, _consts[363])) = v65
	v74 = int32(0)
	*(*int32)(unsafe.Add(mBase, _consts[427])) = v74
	*(*int32)(unsafe.Add(mBase, _consts[826])) = v74
	*(*int32)(unsafe.Add(mBase, _consts[1210])) = v74
...
L22:
	;
	v91 = *(*int32)(unsafe.Add(mBase, _consts[428]))
	F_errcode(m, v91)
	mBase = m.M
	v93 = m.ExcPending
	if v93 != 0 {
...
L25:
	;
	v95 = *(*int32)(unsafe.Add(mBase, _consts[427]))
	if v95 != 0 {
		goto L27
	} else {
		goto L28
...
L26:
	;
	v116 = *(*int32)(unsafe.Add(mBase, _consts[826]))
	if v116 != 0 {
		goto L35
	} else {
		goto L36
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+48)) = v95
	F_errmsg_internal(m, int32(206170), v16+int32(-16))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L5
...
L33:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+32)) = v102
	F_errmsg(m, int32(727876), v16+int32(-32))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L5
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = v116
	F_errdetail_internal(m, int32(206170), v16+int32(-48))
	mBase = m.M
	v122 = m.ExcPending
	if v122 != 0 {
		goto L5
...
L41:
	;
	F_errfinish(m, int32(499912), int32(6947), int32(315425))
	mBase = m.M
	v133 = m.ExcPending
	if v133 != 0 {
		goto L5
...
L11:
	;
	F_errsave_finish(m, l1, int32(500002), int32(1810), int32(76400))
	mBase = m.M
	v37 = m.ExcPending
	if v37 != 0 {
		goto L2
...
L30:
	;
	F_errsave_finish(m, l1, int32(500002), int32(1815), int32(76400))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L2
				...
				if l1 == int32(25) {
					...
					if v33 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
						F_errmsg_internal(m, int32(57294), v8)
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(492995), int32(1765), int32(68448))
							mBase = m.M
							v42 = m.ExcPending
							if v42 != 0 {
								return int32(0)
...
L176:
	;
	F_errfinish(m, int32(497783), int32(2603), int32(403471))
	mBase = m.M
	v491 = m.ExcPending
	if v491 != 0 {
		goto L173
