...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v142
	F_errmsg_internal(m, int32(39884), v11+int32(16))
	mBase = m.M
	v148 = m.ExcPending
	if v148 != 0 {
		goto L1
...
L39:
	;
	F_errfinish(m, int32(489510), int32(21849), int32(29227))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v158
	F_errmsg_internal(m, int32(39884), v11)
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L1
...
L42:
	;
	F_errfinish(m, int32(489510), int32(21875), int32(29227))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L1
...
func F_varchartypmodin(m *base.Module, l0 int32) int32 {
	...
	if v6 != 0 {
		...
		v8 = F_anychar_typmodin(m, v3, int32(227883))
		mBase = m.M
		v9 = m.ExcPending
		if v9 != 0 {
			return int32(0)
...
L149:
	;
	F_errfinish(m, int32(491626), int32(135), int32(306860))
	mBase = m.M
	v1035 = m.ExcPending
	if v1035 != 0 {
		goto L1
	...
	if l2 != 0 {
		...
		if v31 != l1 {
			...
			if v248 != 0 {
				...
				F_errmsg_internal(m, int32(105100), int32(0))
				mBase = m.M
				v252 = m.ExcPending
				if v252 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(490961), int32(270), int32(105172))
					mBase = m.M
					v257 = m.ExcPending
					if v257 != 0 {
						return int32(0)
			...
			if l4 == int32(0) {
				...
				if v261 != 0 {
					...
					F_errmsg_internal(m, int32(105146), int32(0))
					mBase = m.M
					v265 = m.ExcPending
					if v265 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(490961), int32(274), int32(105172))
						mBase = m.M
						v270 = m.ExcPending
						if v270 != 0 {
							return int32(0)
