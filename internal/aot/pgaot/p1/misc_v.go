...
L39:
	;
	F_errfinish(m, int32(491372), int32(21849), int32(29293))
	mBase = m.M
	v153 = m.ExcPending
	if v153 != 0 {
		goto L1
...
L42:
	;
	F_errfinish(m, int32(491372), int32(21875), int32(29293))
	mBase = m.M
	v167 = m.ExcPending
	if v167 != 0 {
		goto L1
...
L149:
	;
	F_errfinish(m, int32(493488), int32(135), int32(307977))
	mBase = m.M
	v1035 = m.ExcPending
	if v1035 != 0 {
		goto L1
		...
		if v31 != l1 {
			...
			if v248 != 0 {
				...
				if v252 != 0 {
					...
					F_errfinish(m, int32(492823), int32(270), int32(105579))
					mBase = m.M
					v257 = m.ExcPending
					if v257 != 0 {
						return int32(0)
			...
			if l4 == int32(0) {
				...
				if v261 != 0 {
					...
					if v265 != 0 {
						...
						F_errfinish(m, int32(492823), int32(274), int32(105579))
						mBase = m.M
						v270 = m.ExcPending
						if v270 != 0 {
							return int32(0)
