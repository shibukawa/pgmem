...
func F_DecodeSpecial(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v148 int32
	_ = v148
	v9 = *(*int32)(unsafe.Add(mBase, _c_F_DecodeSpecial[0]))
	if v9 != 0 {
		goto L2
	} else {
		goto L3
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_DecodeSpecial[0])) = v140
...
L4:
	...
	v63 = int32(_a_F_DecodeSpecial_0)
	v65 = int32(_a_F_DecodeSpecial_1)
	goto L20
L5:
	;
	if v46-v47 == int32(0) {
