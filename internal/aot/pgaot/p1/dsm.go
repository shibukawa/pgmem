...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+320)) = l1
	v873 = F_pg_snprintf(m, v16+int32(464), int32(64), int32(37328), v16+int32(320))
	mBase = m.M
	v874 = m.ExcPending
	if v874 != 0 {
		goto L6
...
L4:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+192)) = l1
	v480 = F_pg_snprintf(m, v16+int32(464), int32(64), int32(57422), v16+int32(192))
	mBase = m.M
	v481 = m.ExcPending
	if v481 != 0 {
		goto L6
...
L5:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+112)) = l1
	v29 = F_pg_snprintf(m, v16+int32(464), int32(64), int32(37348), v16+int32(112))
	mBase = m.M
	v32 = m.ExcPending
	if v32 != 0 {
		goto L6
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v16 + int32(464)
	F_errmsg(m, int32(284851), v16+int32(16))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L6
...
L28:
	;
	F_errfinish(m, int32(478070), int32(242), int32(25765))
	mBase = m.M
	v94 = m.ExcPending
	if v94 != 0 {
		goto L6
...
L39:
	;
	v147 = F___memcpy(m, v107, int32(534669), int32(9))
	mBase = m.M
...
L61:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v16 + int32(464)
	F_errmsg(m, int32(284805), v16+int32(48))
	mBase = m.M
	v208 = m.ExcPending
	if v208 != 0 {
		goto L6
...
L67:
	;
	F_errfinish(m, int32(478070), int32(266), int32(25765))
	mBase = m.M
	v213 = m.ExcPending
	if v213 != 0 {
		goto L6
...
L77:
	;
	v224 = F___fstatat(m, v164, int32(719562), v16+int32(336), int32(4096))
	mBase = m.M
	v225 = v224
	goto L74
L78:
...
L82:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+80)) = v16 + int32(464)
	F_errmsg(m, int32(284667), v16+int32(80))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L6
...
L88:
	;
	F_errfinish(m, int32(478070), int32(291), int32(25765))
	mBase = m.M
	v271 = m.ExcPending
	if v271 != 0 {
		goto L6
...
L90:
	;
	F_sigprocmask(m, int32(4356872), v16+int32(336))
	mBase = m.M
	v280 = m.ExcPending
	if v280 != 0 {
		goto L6
...
L112:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+96)) = v16 + int32(464)
	F_errmsg(m, int32(281096), v16+int32(96))
	mBase = m.M
	v379 = m.ExcPending
	if v379 != 0 {
		goto L6
...
L118:
	;
	F_errfinish(m, int32(478070), int32(310), int32(25765))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L6
...
L133:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = v16 + int32(464)
	F_errmsg(m, int32(284760), v16-int32(-64))
	mBase = m.M
	v458 = m.ExcPending
	if v458 != 0 {
		goto L6
...
L139:
	;
	F_errfinish(m, int32(478070), int32(332), int32(25765))
	mBase = m.M
	v463 = m.ExcPending
	if v463 != 0 {
		goto L6
...
L149:
	;
	F_errmsg_internal(m, int32(518316), int32(0))
	mBase = m.M
	v495 = m.ExcPending
	if v495 != 0 {
		goto L6
...
L150:
	;
	F_errfinish(m, int32(478070), int32(470), int32(30728))
	mBase = m.M
	v500 = m.ExcPending
	if v500 != 0 {
		goto L6
...
L192:
	;
	F_errmsg(m, int32(280420), int32(0))
	mBase = m.M
	v631 = m.ExcPending
	if v631 != 0 {
		goto L6
...
L198:
	;
	F_errfinish(m, int32(478070), int32(519), int32(30728))
	mBase = m.M
	v636 = m.ExcPending
	if v636 != 0 {
		goto L6
...
L218:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+144)) = v16 + int32(464)
	F_errmsg(m, int32(284713), v16+int32(144))
	mBase = m.M
	v702 = m.ExcPending
	if v702 != 0 {
		goto L6
...
L224:
	;
	F_errfinish(m, int32(478070), int32(538), int32(30728))
	mBase = m.M
	v707 = m.ExcPending
	if v707 != 0 {
		goto L6
...
L233:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+128)) = v16 + int32(464)
	F_errmsg(m, int32(284851), v16+int32(128))
	mBase = m.M
	v748 = m.ExcPending
	if v748 != 0 {
		goto L6
...
L239:
	;
	F_errfinish(m, int32(478070), int32(548), int32(30728))
	mBase = m.M
	v753 = m.ExcPending
	if v753 != 0 {
		goto L6
...
L250:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+176)) = v16 + int32(464)
	F_errmsg(m, int32(284667), v16+int32(176))
	mBase = m.M
	v788 = m.ExcPending
	if v788 != 0 {
		goto L6
...
L256:
	;
	F_errfinish(m, int32(478070), int32(564), int32(30728))
	mBase = m.M
	v793 = m.ExcPending
	if v793 != 0 {
		goto L6
...
L277:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+160)) = v16 + int32(464)
	F_errmsg(m, int32(284760), v16+int32(160))
	mBase = m.M
	v857 = m.ExcPending
	if v857 != 0 {
		goto L6
...
L283:
	;
	F_errfinish(m, int32(478070), int32(585), int32(30728))
	mBase = m.M
	v862 = m.ExcPending
	if v862 != 0 {
		goto L6
...
L296:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+208)) = v16 + int32(464)
	F_errmsg(m, int32(284851), v16+int32(208))
	mBase = m.M
	v920 = m.ExcPending
	if v920 != 0 {
		goto L6
...
L302:
	;
	F_errfinish(m, int32(478070), int32(823), int32(228178))
	mBase = m.M
	v925 = m.ExcPending
	if v925 != 0 {
		goto L6
...
L317:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+240)) = v16 + int32(464)
	F_errmsg(m, int32(284805), v16+int32(240))
	mBase = m.M
	v967 = m.ExcPending
	if v967 != 0 {
		goto L6
...
L323:
	;
	F_errfinish(m, int32(478070), int32(837), int32(228178))
	mBase = m.M
	v972 = m.ExcPending
	if v972 != 0 {
		goto L6
...
L333:
	;
	v983 = F___fstatat(m, v931, int32(719562), v16+int32(336), int32(4096))
	mBase = m.M
	v984 = v983
	goto L330
L334:
...
L338:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+288)) = v16 + int32(464)
	F_errmsg(m, int32(284667), v16+int32(288))
	mBase = m.M
	v1020 = m.ExcPending
	if v1020 != 0 {
		goto L6
...
L344:
	;
	F_errfinish(m, int32(478070), int32(861), int32(228178))
	mBase = m.M
	v1025 = m.ExcPending
	if v1025 != 0 {
		goto L6
...
L368:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+304)) = v16 + int32(464)
	F_errmsg(m, int32(281096), v16+int32(304))
	mBase = m.M
	v1103 = m.ExcPending
	if v1103 != 0 {
		goto L6
...
L374:
	;
	F_errfinish(m, int32(478070), int32(912), int32(228178))
	mBase = m.M
	v1108 = m.ExcPending
	if v1108 != 0 {
		goto L6
...
L385:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+256)) = v16 + int32(464)
	F_errmsg(m, int32(284760), v16+int32(256))
	mBase = m.M
	v1166 = m.ExcPending
	if v1166 != 0 {
		goto L6
...
L391:
	;
	F_errfinish(m, int32(478070), int32(934), int32(228178))
	mBase = m.M
	v1171 = m.ExcPending
	if v1171 != 0 {
		goto L6
...
L397:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+272)) = v16 + int32(464)
	F_errmsg(m, int32(284899), v16+int32(272))
	mBase = m.M
	v1193 = m.ExcPending
	if v1193 != 0 {
		goto L6
...
L398:
	;
	F_errfinish(m, int32(478070), int32(945), int32(228178))
	mBase = m.M
	v1198 = m.ExcPending
	if v1198 != 0 {
		goto L6
...
L400:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = v1221
	F_errmsg_internal(m, int32(465783), v16)
	mBase = m.M
	v1225 = m.ExcPending
	if v1225 != 0 {
		goto L6
...
L401:
	;
	F_errfinish(m, int32(478070), int32(191), int32(225344))
	mBase = m.M
	v1230 = m.ExcPending
	if v1230 != 0 {
		goto L6
