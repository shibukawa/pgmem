...
L14:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L18:
	;
	v61 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[1]))
	v62 = *(*int64)(unsafe.Add(mBase, uint32(v15)+112))
	*(*int64)(unsafe.Add(mBase, uint32(v61)+8)) = v62
	v65 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L19:
	;
	v71 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v78))) = v79
	v82 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[1]))
	*(*int32)(unsafe.Add(mBase, uint32(v82)+4)) = int32(0)
	v86 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L24:
	;
	v104 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_xlog_redo[2])))
	if v104 != int32(1) {
		goto L25
	} else {
		goto L26
...
L25:
	;
	v117 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[3]))
	if v117 != 0 {
		goto L29
	} else {
		goto L30
...
L26:
	;
	v108 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[4]))
...
L38:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[4]))
	*(*int64)(unsafe.Add(mBase, uint32(v176)+64)) = v62
	v179 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L39:
	;
	v185 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
...
L40:
	;
	v190 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
	F_s_lock(m, v190+int32(440), int32(_a_F_xlog_redo_1), int32(_a_F_xlog_redo_2), int32(_a_F_xlog_redo_3))
	mBase = m.M
	v197 = m.ExcPending
	if v197 != 0 {
		goto L11
...
L42:
	...
	v200 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
...
L48:
	;
	v224 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L52:
	...
	v232 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[1]))
...
L55:
	;
	v237 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L56:
	...
	v245 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L57:
	;
	v252 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[6]))
...
L63:
	;
	v264 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L65:
	;
	v274 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[1]))
...
L72:
	;
	v293 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L74:
	;
	v300 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[4]))
	*(*int64)(unsafe.Add(mBase, uint32(v300)+64)) = v230
	v303 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L75:
	;
	v309 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
...
L76:
	;
	v314 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
	F_s_lock(m, v314+int32(440), int32(_a_F_xlog_redo_1), int32(_a_F_xlog_redo_4), int32(_a_F_xlog_redo_3))
	mBase = m.M
	v321 = m.ExcPending
	if v321 != 0 {
		goto L11
...
L78:
	...
	v324 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
...
L93:
	...
	v450 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_xlog_redo[7])))
	if v450 != int32(1) {
		goto L111
	} else {
		goto L112
...
L111:
	;
	v470 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L112:
	;
	v454 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[3]))
...
L114:
	;
	v460 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[8]))
	if v460 < int32(2) {
		goto L111
	} else {
		goto L115
...
L117:
	;
	v477 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[4]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v477)+172)) = v443
	v488 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_xlog_redo[9])))
	if v488 == int32(0) {
		goto L119
	} else {
		goto L120
...
L119:
	;
	v492 = *(*int64)(unsafe.Add(mBase, _c_F_xlog_redo[10]))
	v496 = v492
	goto L118
L120:
	;
...
L121:
	...
	*(*int64)(unsafe.Add(mBase, _c_F_xlog_redo[10])) = v494
	v496 = v494
	goto L118
L122:
	;
	v512 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[11]))
...
L125:
	;
	v505 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[4]))
...
L126:
	;
	v558 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[4]))
	*(*uint8)(unsafe.Add(mBase, uint32(v558)+200)) = uint8(v515)
	v561 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[12]))
...
L132:
	;
	v525 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
	v529 = F_LWLockAcquire(m, v525+int32(_a_F_xlog_redo_9), int32(0))
	mBase = m.M
	v530 = m.ExcPending
	if v530 != 0 {
		goto L11
...
L133:
	;
	v532 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[11]))
	v533 = int32(0)
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v532)+24)) = uint8(v533)
	v542 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[1]))
	*(*int64)(unsafe.Add(mBase, uint32(v542)+40)) = int64(0)
	v548 = F_SlruScanDirectory(m, int32(_a_F_xlog_redo_10), int32(290), v533)
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L11
...
L134:
	;
	v551 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
	F_LWLockRelease(m, v551+int32(_a_F_xlog_redo_9))
	mBase = m.M
	v555 = m.ExcPending
	if v555 != 0 {
		goto L11
...
L136:
	;
	v565 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[0]))
...
L140:
	;
	v581 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
...
L142:
	;
	*(*uint8)(unsafe.Add(mBase, _c_F_xlog_redo[13])) = uint8(v577)
	goto L5
L143:
	;
	v586 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
	F_s_lock(m, v586+int32(440), int32(_a_F_xlog_redo_1), int32(_a_F_xlog_redo_11), int32(_a_F_xlog_redo_3))
	mBase = m.M
	v593 = m.ExcPending
	if v593 != 0 {
		goto L11
...
L145:
	...
	v596 = *(*int32)(unsafe.Add(mBase, _c_F_xlog_redo[5]))
