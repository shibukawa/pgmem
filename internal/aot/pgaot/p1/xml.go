		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(517780), int32(4912), int32(33111))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
		...
		if v9 != 0 {
			...
			if v13 != 0 {
				...
				if v17 != 0 {
					...
					F_errfinish(m, int32(517780), int32(4837), int32(225134))
					v22 = m.ExcPending
					if v22 != 0 {
						return
					} else {
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v5 + int32(-52)
	v94 = F_sscanf(m, v28, int32(537295), v7)
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(517780), int32(4628), int32(100597))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
