	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			if v14 != 0 {
				...
				F_errdetail(m, int32(_a_F_XmlTableFetchRow_1), int32(0))
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
	...
	if v6 != 0 {
		...
		if v9 != 0 {
			...
			if v13 != 0 {
				...
				F_errdetail(m, int32(_a_F_XmlTableSetRowFilter_1), int32(0))
				v17 = m.ExcPending
				if v17 != 0 {
					return
				} else {
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = v5 + int32(-52)
	v94 = F_sscanf(m, v28, int32(_a_F_map_xml_name_to_sql_identifier_0), v7)
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
...
func F_xml_is_well_formed_document(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			F_errmsg(m, int32(_a_F_xml_is_well_formed_document_0), int32(0))
			v14 = m.ExcPending
			if v14 != 0 {
				return int32(0)
			} else {
				F_errdetail(m, int32(_a_F_xml_is_well_formed_document_1), int32(0))
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(_a_F_xml_is_well_formed_document_2), int32(_a_F_xml_is_well_formed_document_3), int32(_a_F_xml_is_well_formed_document_4))
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
					} else {
