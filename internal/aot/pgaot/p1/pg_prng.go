...
func F_pg_prng_int64_range(m *base.Module, l0 int64, l1 int64) int64 {
	...
	if l0 < l1 {
		v9 = l1 - l0
		v12 = *(*int64)(unsafe.Add(mBase, _consts[1124]))
		v14 = *(*int64)(unsafe.Add(mBase, _consts[1123]))
		v16 = v14
		v18 = v12
		for {
			v22 = v16 ^ v18
		...
		*(*int64)(unsafe.Add(mBase, _consts[1124])) = v24
		*(*int64)(unsafe.Add(mBase, _consts[1123])) = v32
		v51 = l0 + v37
	} else {
		v51 = l0
	}
