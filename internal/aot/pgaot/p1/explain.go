...
L7:
	;
	F_ExplainDummyGroup(m, int32(20785), l2)
	mBase = m.M
	v489 = m.ExcPending
	if v489 != 0 {
		goto L15
...
L61:
	...
	v158 = F_AllocSetContextCreateInternal(m, v153, int32(60373), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L15
...
L126:
	;
	F_errmsg_internal(m, int32(149084), int32(0))
	mBase = m.M
	v481 = m.ExcPending
	if v481 != 0 {
		goto L15
...
L132:
	;
	F_ExplainDummyGroup(m, int32(95542), l2)
	mBase = m.M
	v499 = m.ExcPending
	if v499 != 0 {
		goto L15
...
L35:
	...
	F_appendStringInfoString(m, v113, int32(271631))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L11
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v122
	F_appendStringInfo(m, v121, int32(205217), v10+int32(-48))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L11
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v131
	F_appendStringInfo(m, v130, int32(176384), v10+int32(-32))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L11
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v176
	F_appendStringInfo(m, v175, int32(205217), v12)
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L11
...
L68:
	;
	F_ExplainPropertyText(m, int32(173596), v30, l2)
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L11
