...
L7:
	;
	F_ExplainDummyGroup(m, int32(21192), l2)
	mBase = m.M
	v491 = m.ExcPending
	if v491 != 0 {
		goto L15
...
L14:
	...
	F_appendStringInfoString(m, v47, int32(784793))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L15
...
L22:
	;
	F_ExplainDummyGroup(m, int32(541067), l2)
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L15
...
L23:
	;
	F_ExplainDummyGroup(m, int32(548904), l2)
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L15
...
L26:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v66
	F_errmsg_internal(m, int32(506520), v19)
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L15
...
L27:
	;
	F_errfinish(m, int32(519801), int32(419), int32(11566))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L15
...
L29:
	;
	v81 = *(*int32)(unsafe.Add(mBase, _consts[335]))
	switch v81 {
	case 0:
		v88 = v76
		goto L30
...
L30:
	;
	v90 = *(*int32)(unsafe.Add(mBase, _consts[336]))
	if v90 != 0 {
		goto L35
	} else {
		goto L36
...
L32:
	;
	v83 = int32(*(*uint8)(unsafe.Add(mBase, _consts[337])))
	if v83 != int32(1) {
		v88 = v76
		goto L30
	} else {
...
L40:
	...
	v104 = *(*int32)(unsafe.Add(mBase, _consts[367]))
	if v104 != 0 {
		goto L41
	} else {
		goto L42
...
L46:
	;
	v116 = *(*int32)(unsafe.Add(mBase, _consts[335]))
	switch v116 {
	case 0:
		v123 = v111
		goto L47
...
L47:
	;
	v125 = *(*int32)(unsafe.Add(mBase, _consts[336]))
	if v125 != 0 {
		goto L52
	} else {
		goto L53
...
L49:
	;
	v118 = int32(*(*uint8)(unsafe.Add(mBase, _consts[337])))
	if v118 != int32(1) {
		v123 = v111
		goto L47
	} else {
...
L57:
	...
	v140 = *(*int32)(unsafe.Add(mBase, _consts[367]))
	if v140 != 0 {
		goto L58
	} else {
		goto L59
...
L63:
	...
	v160 = F_AllocSetContextCreateInternal(m, v155, int32(66239), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L15
...
L69:
	...
	v183 = *(*int32)(unsafe.Add(mBase, _consts[368]))
	if v183 == int32(0) {
		goto L76
	} else {
		goto L77
...
L71:
	;
	v175 = F__emscripten_memcpy_bulkmem(m, v149+int32(152), int32(4452504), int32(128))
	mBase = m.M
	goto L73
L73:
	;
...
L95:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252))) = v255 + (v257 - v258)
	...
	v264 = *(*int64)(unsafe.Add(mBase, _consts[369]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+8)) = v262 + (v264 - v265)
	...
	v271 = *(*int64)(unsafe.Add(mBase, _consts[370]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+16)) = v269 + (v271 - v272)
	...
	v278 = *(*int64)(unsafe.Add(mBase, _consts[371]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+32)) = v283 + (v285 - v286)
	...
	v292 = *(*int64)(unsafe.Add(mBase, _consts[372]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+40)) = v290 + (v292 - v293)
	...
	v299 = *(*int64)(unsafe.Add(mBase, _consts[373]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+48)) = v297 + (v299 - v300)
	...
	v306 = *(*int64)(unsafe.Add(mBase, _consts[374]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+56)) = v304 + (v306 - v307)
	...
	v313 = *(*int64)(unsafe.Add(mBase, _consts[375]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+64)) = v311 + (v313 - v314)
	...
	v320 = *(*int64)(unsafe.Add(mBase, _consts[376]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+72)) = v318 + (v320 - v321)
	...
	v327 = *(*int64)(unsafe.Add(mBase, _consts[377]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+80)) = v325 + (v327 - v328)
	...
	v334 = *(*int64)(unsafe.Add(mBase, _consts[378]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+88)) = v332 + (v334 - v335)
	...
	v341 = *(*int64)(unsafe.Add(mBase, _consts[379]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+96)) = v339 + (v341 - v342)
	...
	v348 = *(*int64)(unsafe.Add(mBase, _consts[380]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+104)) = v346 + (v348 - v349)
	...
	v355 = *(*int64)(unsafe.Add(mBase, _consts[381]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+112)) = v353 + (v355 - v356)
	...
	v362 = *(*int64)(unsafe.Add(mBase, _consts[382]))
...
L128:
	;
	F_errmsg_internal(m, int32(158679), int32(0))
	mBase = m.M
	v483 = m.ExcPending
	if v483 != 0 {
		goto L15
...
L129:
	;
	F_errfinish(m, int32(522344), int32(608), int32(17318))
	mBase = m.M
	v488 = m.ExcPending
	if v488 != 0 {
		goto L15
...
L132:
	...
	F_appendStringInfoString(m, v495, int32(782572))
	mBase = m.M
	v498 = m.ExcPending
	if v498 != 0 {
		goto L15
...
L134:
	;
	F_ExplainDummyGroup(m, int32(102323), l2)
	mBase = m.M
	v501 = m.ExcPending
	if v501 != 0 {
		goto L15
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v86
	F_errmsg_internal(m, int32(498053), v10+int32(-16))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L11
...
L32:
	;
	F_errfinish(m, int32(519801), int32(4459), int32(322610))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L11
...
L35:
	...
	F_appendStringInfoString(m, v113, int32(285836))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L11
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v122
	F_appendStringInfo(m, v121, int32(216463), v10+int32(-48))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L11
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v131
	F_appendStringInfo(m, v130, int32(187495), v10+int32(-32))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L11
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v176
	F_appendStringInfo(m, v175, int32(216463), v12)
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L11
...
L66:
	;
	F_ExplainPropertyText(m, int32(531184), v106, l2)
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L11
...
L68:
	;
	F_ExplainPropertyText(m, int32(184686), v30, l2)
	mBase = m.M
	v192 = m.ExcPending
	if v192 != 0 {
		goto L11
