...
L46:
	;
	v116 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[0]))
	switch v116 {
	case 0:
		v123 = v111
		goto L47
...
L47:
	;
	v125 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[1]))
	if v125 != 0 {
		goto L52
	} else {
		goto L53
...
L49:
	;
	v118 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ExplainOneUtility[2])))
	if v118 != int32(1) {
		v123 = v111
		goto L47
	} else {
...
L57:
	...
	v140 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[3]))
	if v140 != 0 {
		goto L58
	} else {
		goto L59
...
L63:
	;
	v155 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[4]))
	v160 = F_AllocSetContextCreateInternal(m, v155, int32(_a_F_ExplainOneUtility_7), int32(0), int32(_a_F_ExplainOneUtility_8), int32(_a_F_ExplainOneUtility_9))
	mBase = m.M
	v161 = m.ExcPending
	if v161 != 0 {
		goto L15
...
L66:
	;
	v162 = int32(_a_F_ExplainOneUtility_10)
	v163 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[4]))
	*(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[4])) = v160
	v166 = v160
	v167 = v163
	goto L65
L67:
...
L69:
	...
	v183 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[5]))
	if v183 == int32(0) {
		goto L76
	} else {
		goto L77
...
L71:
	;
	v175 = F__emscripten_memcpy_bulkmem(m, v149+int32(152), int32(_a_F_ExplainOneUtility_11), int32(128))
	mBase = m.M
	goto L73
L73:
	;
...
L83:
	;
	v217 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[6]))
...
L88:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[4])) = v167
...
L95:
	...
	v257 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[7]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252))) = v255 + (v257 - v258)
	...
	v264 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[8]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+8)) = v262 + (v264 - v265)
	...
	v271 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[9]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+16)) = v269 + (v271 - v272)
	...
	v278 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[10]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+24)) = v276 + (v278 - v279)
	...
	v285 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[11]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+32)) = v283 + (v285 - v286)
	...
	v292 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[12]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+40)) = v290 + (v292 - v293)
	...
	v299 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[13]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+48)) = v297 + (v299 - v300)
	...
	v306 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[14]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+56)) = v304 + (v306 - v307)
	...
	v313 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[15]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+64)) = v311 + (v313 - v314)
	...
	v320 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[16]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+72)) = v318 + (v320 - v321)
	...
	v327 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[17]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+80)) = v325 + (v327 - v328)
	...
	v334 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[18]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+88)) = v332 + (v334 - v335)
	...
	v341 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[19]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+96)) = v339 + (v341 - v342)
	...
	v348 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[20]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+104)) = v346 + (v348 - v349)
	...
	v355 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[21]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v252)+112)) = v353 + (v355 - v356)
	...
	v362 = *(*int64)(unsafe.Add(mBase, _c_F_ExplainOneUtility[22]))
...
L121:
	;
	v451 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainOneUtility[6]))
...
L125:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v149))) = v181
	F_errmsg(m, int32(_a_F_ExplainOneUtility_12), v149)
	mBase = m.M
	v470 = m.ExcPending
	if v470 != 0 {
		goto L15
...
L132:
	...
	F_appendStringInfoString(m, v495, int32(_a_F_ExplainOneUtility_17))
	mBase = m.M
	v498 = m.ExcPending
	if v498 != 0 {
		goto L15
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v213))) = int32(0)
	v217 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainPrintPlan[0]))
...
L45:
	;
	v292 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainPrintPlan[1]))
	if v292 == int32(0) {
		goto L46
	} else {
		goto L47
...
L47:
	;
	if v292 == int32(_a_F_ExplainPrintPlan_0) {
		goto L46
	} else {
		goto L48
	}
...
L69:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v210))) = v347
	F_errmsg_internal(m, int32(_a_F_ExplainPrintPlan_1), v210)
	mBase = m.M
	v351 = m.ExcPending
	if v351 != 0 {
		goto L1
...
L98:
	...
	F_ExplainPropertyText(m, int32(_a_F_ExplainPrintPlan_5), v564, l0)
	mBase = m.M
	v566 = m.ExcPending
	if v566 != 0 {
		goto L1
...
L102:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+48)) = v485
	F_appendStringInfo(m, v14+int32(60), int32(_a_F_ExplainPrintPlan_6), v14+int32(48))
	mBase = m.M
	v494 = m.ExcPending
	if v494 != 0 {
		goto L1
...
L108:
	...
	F_appendStringInfoString(m, v14+int32(60), int32(_a_F_ExplainPrintPlan_8))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L1
...
L113:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v532
	F_appendStringInfo(m, v14+int32(60), int32(_a_F_ExplainPrintPlan_6), v14+int32(16))
	mBase = m.M
	v541 = m.ExcPending
	if v541 != 0 {
		goto L1
...
L122:
	;
	v586 = *(*int32)(unsafe.Add(mBase, _c_F_ExplainPrintPlan[2]))
	if v586 == int32(3) {
		goto L120
	} else {
		goto L123
...
L123:
	;
	F_ExplainPropertyInteger(m, int32(_a_F_ExplainPrintPlan_9), int32(0), v582, l0)
	mBase = m.M
	v592 = m.ExcPending
	if v592 != 0 {
		goto L1
...
L6:
	...
	v102 = int32(_a_F_ExplainTargetRel_0)
	v103 = v101
	goto L5
L7:
	;
	v99 = *(*int32)(unsafe.Add(mBase, uint32(v21)+108))
	v102 = int32(_a_F_ExplainTargetRel_1)
	v103 = v99
	goto L5
L8:
	;
	v76 = int32(1)
	v78 = int32(_a_F_ExplainTargetRel_2)
	v79 = *(*int32)(unsafe.Add(mBase, uint32(l0)+80))
	v80 = *(*int32)(unsafe.Add(mBase, uint32(v79)+4))
	switch v80 {
	case 0:
		v105 = int32(_a_F_ExplainTargetRel_3)
		v106 = v4
		v108 = v76
		v109 = v78
		goto L4
...
L30:
	;
	v105 = int32(_a_F_ExplainTargetRel_6)
	v106 = v4
	v108 = v76
	v109 = v78
	goto L4
...
L35:
	...
	F_appendStringInfoString(m, v113, int32(_a_F_ExplainTargetRel_11))
	mBase = m.M
	v116 = m.ExcPending
	if v116 != 0 {
		goto L11
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v122
	F_appendStringInfo(m, v121, int32(_a_F_ExplainTargetRel_12), v10+int32(-48))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L11
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = v131
	F_appendStringInfo(m, v130, int32(_a_F_ExplainTargetRel_13), v10+int32(-32))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L11
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v176
	F_appendStringInfo(m, v175, int32(_a_F_ExplainTargetRel_12), v12)
	mBase = m.M
	v181 = m.ExcPending
	if v181 != 0 {
		goto L11
