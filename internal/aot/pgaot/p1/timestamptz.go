					...
					if base.Ui32((v152-int32(48))&int32(255)) <= base.Ui32(int32(9)) {
						...
						if v414 != 0 {
							...
							if v417 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(391719)
								*(*int32)(unsafe.Add(mBase, uint32(v14)+4)) = v14 + int32(96)
								F_errmsg(m, int32(761048), v14)
								mBase = m.M
								v425 = m.ExcPending
								if v425 != 0 {
									return int32(0)
									...
									if v429 != 0 {
										...
										F_errfinish(m, int32(521224), int32(514), int32(391401))
										mBase = m.M
										v434 = m.ExcPending
										if v434 != 0 {
											return int32(0)
								...
								if v458 != 0 {
									...
									if v461 != 0 {
										...
										if v465 != 0 {
											...
											F_errfinish(m, int32(521224), int32(716), int32(391359))
											mBase = m.M
											v470 = m.ExcPending
											if v470 != 0 {
												return int32(0)
									...
									if v438 != 0 {
										...
										if v441 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = v14 + int32(96)
											F_errmsg(m, int32(422611), v14+int32(32))
											mBase = m.M
											v449 = m.ExcPending
											if v449 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(521224), int32(526), int32(391401))
												mBase = m.M
												v454 = m.ExcPending
												if v454 != 0 {
													return int32(0)
									...
									if v279 != 0 {
										...
										if v282 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = v14 + int32(96)
											F_errmsg(m, int32(460180), v14+int32(16))
											mBase = m.M
											v290 = m.ExcPending
											if v290 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(521224), int32(530), int32(391401))
												mBase = m.M
												v295 = m.ExcPending
												if v295 != 0 {
													return int32(0)
				...
				if v398 != 0 {
					...
					if v401 != 0 {
						...
						if v405 != 0 {
							...
							F_errfinish(m, int32(521224), int32(707), int32(391359))
							mBase = m.M
							v410 = m.ExcPending
							if v410 != 0 {
								return int32(0)
					...
					if v40 != 0 {
						...
						if v43 != 0 {
							...
							if v47 != 0 {
								...
								F_errfinish(m, int32(521224), int32(827), int32(37632))
								mBase = m.M
								v52 = m.ExcPending
								if v52 != 0 {
									return int32(0)
