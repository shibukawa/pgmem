...
L343:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v38))) = v1264
	F_errmsg_internal(m, int32(482980), v38)
	mBase = m.M
	v1530 = m.ExcPending
	if v1530 != 0 {
		goto L105
...
L344:
	;
	F_errfinish(m, int32(498724), int32(1390), int32(375902))
	mBase = m.M
	v1535 = m.ExcPending
	if v1535 != 0 {
		goto L105
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v1674))) = uint8(v1675)
			...
			if l4 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(10)
				v655 = F_pg_sprintf(m, v646, int32(175270), v14+int32(16))
				mBase = m.M
				v656 = m.ExcPending
				if v656 != 0 {
					return
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v1674))) = uint8(v1675)
			...
			if l4 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(10)
				v1084 = F_pg_sprintf(m, v1075, int32(175270), v14+int32(32))
				mBase = m.M
				v1085 = m.ExcPending
				if v1085 != 0 {
					return
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v1674))) = uint8(v1675)
			...
			if l4 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(10)
				v1596 = F_pg_sprintf(m, v1589, int32(175270), v14)
				mBase = m.M
				v1597 = m.ExcPending
				if v1597 != 0 {
					return
		...
		if base.Ui32(int32(1)) < base.Ui32(v8-int32(2147483647)) {
			...
			if v19 != 0 {
				...
				if v22 != 0 {
					...
					F_errmsg(m, int32(160560), int32(0))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(498487), int32(560), int32(319708))
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return int32(0)
				...
				if v21 != 0 {
					...
					if v24 != 0 {
						...
						if v28 != 0 {
							...
							F_errfinish(m, int32(498487), int32(721), int32(31173))
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
					...
					if v141 != 0 {
						...
						if v144 != 0 {
							...
							if v148 != 0 {
								...
								F_errfinish(m, int32(498487), int32(757), int32(31173))
								mBase = m.M
								v153 = m.ExcPending
								if v153 != 0 {
									return int32(0)
