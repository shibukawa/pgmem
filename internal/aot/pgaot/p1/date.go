...
L428:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v38))) = v1544
	F_errmsg_internal(m, int32(474904), v38)
	mBase = m.M
	v1810 = m.ExcPending
	if v1810 != 0 {
		goto L122
...
L429:
	;
	F_errfinish(m, int32(490329), int32(1390), int32(369675))
	mBase = m.M
	v1815 = m.ExcPending
	if v1815 != 0 {
		goto L122
...
L174:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(10)
	v655 = F_pg_sprintf(m, v646, int32(172519), v14+int32(16))
	mBase = m.M
	v656 = m.ExcPending
	if v656 != 0 {
		goto L177
...
L306:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(10)
	v1140 = F_pg_sprintf(m, v1131, int32(172519), v14+int32(32))
	mBase = m.M
	v1141 = m.ExcPending
	if v1141 != 0 {
		goto L177
...
L450:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = int32(10)
	v1708 = F_pg_sprintf(m, v1701, int32(172519), v14)
	mBase = m.M
	v1709 = m.ExcPending
	if v1709 != 0 {
		goto L177
		...
		if base.Ui32(int32(1)) < base.Ui32(v8-int32(2147483647)) {
			...
			if v19 != 0 {
				...
				if v22 != 0 {
					...
					F_errmsg(m, int32(157962), int32(0))
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(490092), int32(560), int32(314563))
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return int32(0)
				...
				if v21 != 0 {
					...
					if v24 != 0 {
						...
						if v28 != 0 {
							...
							F_errfinish(m, int32(490092), int32(721), int32(30633))
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
					...
					if v141 != 0 {
						...
						if v144 != 0 {
							...
							if v148 != 0 {
								...
								F_errfinish(m, int32(490092), int32(757), int32(30633))
								mBase = m.M
								v153 = m.ExcPending
								if v153 != 0 {
									return int32(0)
