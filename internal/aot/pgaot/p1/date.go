...
L343:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v38))) = v1264
	F_errmsg_internal(m, int32(480091), v38)
	mBase = m.M
	v1530 = m.ExcPending
	if v1530 != 0 {
		goto L105
...
L344:
	;
	F_errfinish(m, int32(495737), int32(1390), int32(373738))
	mBase = m.M
	v1535 = m.ExcPending
	if v1535 != 0 {
		goto L105
			...
			if v19 != 0 {
				...
				if v22 != 0 {
					...
					if v26 != 0 {
						...
						F_errfinish(m, int32(495500), int32(560), int32(317976))
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return int32(0)
				...
				if v21 != 0 {
					...
					if v24 != 0 {
						...
						if v28 != 0 {
							...
							F_errfinish(m, int32(495500), int32(721), int32(31069))
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return int32(0)
					...
					if v141 != 0 {
						...
						if v144 != 0 {
							...
							if v148 != 0 {
								...
								F_errfinish(m, int32(495500), int32(757), int32(31069))
								mBase = m.M
								v153 = m.ExcPending
								if v153 != 0 {
									return int32(0)
