	...
	if base.Ui64(base.I64_reinterpret_f64(v10)&int64(9223372036854775807)) < base.Ui64(int64(9218868437227405313)) {
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						*(*float64)(unsafe.Add(mBase, uint32(v7))) = v10
						F_errmsg(m, int32(691192), v7)
						mBase = m.M
						v79 = m.ExcPending
						if v79 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(476730), int32(753), int32(7375))
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return int32(0)
						...
						if v88 != 0 {
							...
							if v91 != 0 {
								...
								*(*float64)(unsafe.Add(mBase, uint32(v7)+16)) = v93
								F_errmsg(m, int32(691192), v7+int32(16))
								mBase = m.M
								v99 = m.ExcPending
								if v99 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(476730), int32(766), int32(7375))
									mBase = m.M
									v104 = m.ExcPending
									if v104 != 0 {
										return int32(0)
		...
		if v56 != 0 {
			...
			if v59 != 0 {
				...
				F_errmsg(m, int32(507745), int32(0))
				mBase = m.M
				v63 = m.ExcPending
				if v63 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(476730), int32(735), int32(7375))
					mBase = m.M
					v68 = m.ExcPending
					if v68 != 0 {
						return int32(0)
