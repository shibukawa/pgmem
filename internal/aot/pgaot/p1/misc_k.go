...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = l0
	F_errmsg_internal(m, int32(60158), v13)
	mBase = m.M
	v22 = m.ExcPending
	if v22 != 0 {
		goto L1
...
L5:
	;
	v29 = *(*int32)(unsafe.Add(mBase, _consts[669]))
...
L6:
	;
	F_errfinish(m, int32(515966), int32(4991), int32(360037))
	mBase = m.M
	v27 = m.ExcPending
	if v27 != 0 {
		goto L1
...
L26:
	;
	v77 = *(*int32)(unsafe.Add(mBase, _consts[781]))
	v78 = v77 + v49
