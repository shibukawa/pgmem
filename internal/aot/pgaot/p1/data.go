...
func F_dataFindChildPtr(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	v12 = l3 - int32(1)
	if base.Ui32(v12&int32(65535)) < base.Ui32(v10) {
		goto L2
	} else {
		goto L3
	}
...
L13:
	;
	v76 = l1 + int32(22) + v65&int32(65535)*int32(10)
...
L7:
	...
	v52 = v50 + int32(1)
	if base.Ui32(int32(2)) <= base.Ui32(v52&int32(65535)) {
		goto L10
	} else {
		goto L11
	}
...
L12:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(l1)+8)) = uint16(v129)
	v140 = v30 + v129&int32(65535)*int32(10)
...
L13:
	;
	v76 = int32(base.Ui32((v65-v62)&int32(65534))>>(uint(int32(1))%32)) + v62
	v78 = v76 & int32(65535)
	if v50 == v78 {
		goto L16
	} else {
