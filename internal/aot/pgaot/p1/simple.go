...
L5:
	;
	v77 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_SimpleLruInit[0])))
	if v77 != 0 {
		goto L6
	} else {
		goto L7
...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v85))) = l3
	v113 = F_strcmp(m, int32(_a_F_SimpleLruInit_0), l1)
	mBase = m.M
	if v113 == int32(0) {
		goto L9
	} else {
...
L11:
	;
	v118 = F_strcmp(m, int32(_a_F_SimpleLruInit_1), l1)
	mBase = m.M
	if v118 == int32(0) {
		goto L12
	} else {
...
L14:
	;
	v123 = F_strcmp(m, int32(_a_F_SimpleLruInit_2), l1)
	mBase = m.M
	if v123 == int32(0) {
		goto L15
	} else {
...
L17:
	;
	v128 = F_strcmp(m, int32(_a_F_SimpleLruInit_3), l1)
	mBase = m.M
	if v128 == int32(0) {
		goto L18
	} else {
...
L20:
	;
	v133 = F_strcmp(m, int32(_a_F_SimpleLruInit_4), l1)
	mBase = m.M
	if v133 == int32(0) {
		goto L21
	} else {
...
L23:
	;
	v138 = F_strcmp(m, int32(_a_F_SimpleLruInit_5), l1)
	mBase = m.M
	if v138 == int32(0) {
		goto L24
	} else {
...
L26:
	;
	v145 = F_strcmp(m, int32(_a_F_SimpleLruInit_6), l1)
	mBase = m.M
	if v145 != 0 {
		goto L27
	} else {
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33))) = v203
	F_errmsg_internal(m, int32(_a_F_build_simple_rel_0), v33)
	mBase = m.M
	v207 = m.ExcPending
	if v207 != 0 {
		goto L4
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v217))) = v235 + int32(4)
	F_errmsg(m, int32(_a_F_build_simple_rel_3), v217)
	mBase = m.M
	v241 = m.ExcPending
	if v241 != 0 {
		goto L4
...
L47:
	;
	v256 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_build_simple_rel[0])))
	if v256 == int32(1) {
		goto L51
	} else {
		goto L52
...
L49:
	;
	v267 = int32(_a_F_build_simple_rel_6)
...
L51:
	;
	v261 = *(*int32)(unsafe.Add(mBase, _c_F_build_simple_rel[1]))
	v262 = *(*int32)(unsafe.Add(mBase, uint32(v261)+316))
	v264 = base.B2i32(v262 != int32(2))
	*(*uint8)(unsafe.Add(mBase, _c_F_build_simple_rel[0])) = uint8(v264)
	v266 = v264
	goto L53
L52:
	;
...
L80:
	;
	v434 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_build_simple_rel[2])))
	if v434 == int32(1) {
		goto L82
	} else {
		goto L83
...
L82:
	...
	if base.Ui32(v439) < base.Ui32(int32(_a_F_build_simple_rel_7)) {
		v448 = v438
		goto L86
	} else {
		goto L87
...
L111:
	;
	v522 = *(*int32)(unsafe.Add(mBase, _c_F_build_simple_rel[3]))
...
L158:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v865+v854))) = uint8(v870)
	...
	v873 = v810 + v872
	v875 = v814 + v872
	if v875 != v555&int32(_a_F_build_simple_rel_8) {
		v810 = v873
		v814 = v875
		goto L158
	} else {
...
L229:
	;
	F_errmsg_internal(m, int32(_a_F_build_simple_rel_9), int32(0))
	mBase = m.M
	v1355 = m.ExcPending
	if v1355 != 0 {
		goto L4
...
L230:
	;
	F_errfinish(m, int32(_a_F_build_simple_rel_4), int32(1956), int32(_a_F_build_simple_rel_10))
	mBase = m.M
	v1360 = m.ExcPending
	if v1360 != 0 {
		goto L4
...
L233:
	;
	F_errfinish(m, int32(_a_F_build_simple_rel_4), int32(1968), int32(_a_F_build_simple_rel_10))
	mBase = m.M
	v1373 = m.ExcPending
	if v1373 != 0 {
		goto L4
...
L236:
	;
	F_errmsg(m, int32(_a_F_build_simple_rel_11), int32(0))
	mBase = m.M
	v1384 = m.ExcPending
	if v1384 != 0 {
		goto L4
...
L276:
	;
	v1668 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_build_simple_rel[4])))
	if v1668&int32(2) != 0 {
		goto L242
	} else {
		goto L279
...
L319:
	;
	v1940 = *(*int32)(unsafe.Add(mBase, _c_F_build_simple_rel[5]))
...
L333:
	...
	if v1954&int32(_a_F_build_simple_rel_12) != v2006 {
		goto L332
	} else {
		goto L334
	}
...
L423:
	...
	v2317 = v2316 + v2313
	v2319 = *(*int32)(unsafe.Add(mBase, _c_F_build_simple_rel[5]))
...
L460:
	;
	v2588 = *(*int32)(unsafe.Add(mBase, _c_F_build_simple_rel[6]))
	if v2588 != 0 {
		goto L461
	} else {
		goto L462
...
L465:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v217)+16)) = v1499
	F_errmsg_internal(m, int32(_a_F_build_simple_rel_13), v217+int32(16))
	mBase = m.M
	v2603 = m.ExcPending
	if v2603 != 0 {
		goto L4
...
L466:
	;
	F_errfinish(m, int32(_a_F_build_simple_rel_4), int32(1524), int32(_a_F_build_simple_rel_14))
	mBase = m.M
	v2608 = m.ExcPending
	if v2608 != 0 {
		goto L4
...
L469:
	;
	F_errmsg(m, int32(_a_F_build_simple_rel_15), int32(0))
	mBase = m.M
	v2619 = m.ExcPending
	if v2619 != 0 {
		goto L4
...
L472:
	;
	F_errmsg_internal(m, int32(_a_F_build_simple_rel_16), int32(0))
	mBase = m.M
	v2632 = m.ExcPending
	if v2632 != 0 {
		goto L4
...
L473:
	;
	F_errfinish(m, int32(_a_F_build_simple_rel_4), int32(2629), int32(_a_F_build_simple_rel_17))
	mBase = m.M
	v2637 = m.ExcPending
	if v2637 != 0 {
		goto L4
...
L538:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+16)) = l1
	F_errmsg_internal(m, int32(_a_F_build_simple_rel_18), v33+int32(16))
	mBase = m.M
	v3158 = m.ExcPending
	if v3158 != 0 {
		goto L4
