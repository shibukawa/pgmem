...
func F_typeStringToTypeName(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v7 = v5 - int32(16)
	m.G0 = v7
	v9 = int32(_a_F_typeStringToTypeName_0)
	v13 = m.G0
	v15 = v13 - int32(32)
	v16 = int64(0)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v15))) = v16
	v24 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_typeStringToTypeName[0])))
	if v24 == int32(0) {
		goto L3
	} else {
		goto L4
...
L5:
	;
	v28 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_typeStringToTypeName[1])))
	if v28 == int32(0) {
		goto L6
	} else {
		goto L7
...
L40:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+8)) = int32(498)
	v154 = int32(_a_F_typeStringToTypeName_1)
	v155 = *(*int32)(unsafe.Add(mBase, _c_F_typeStringToTypeName[2]))
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_typeStringToTypeName[2])) = v167
...
func F_typeTypeId(m *base.Module, l0 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if v9 != 0 {
			...
			F_errmsg_internal(m, int32(_a_F_typeTypeId_0), int32(0))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(_a_F_typeTypeId_1), int32(593), int32(_a_F_typeTypeId_2))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
