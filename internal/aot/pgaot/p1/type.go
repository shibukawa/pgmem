...
func F_typeStringToTypeName(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v15))) = v16
	v24 = int32(*(*uint8)(unsafe.Add(mBase, _consts[340])))
	if v24 == int32(0) {
		goto L3
	} else {
		goto L4
...
L5:
	;
	v28 = int32(*(*uint8)(unsafe.Add(mBase, _consts[341])))
	if v28 == int32(0) {
		goto L6
	} else {
		goto L7
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, _consts[338])) = v111
	v113 = *(*int32)(unsafe.Add(mBase, uint32(v106)+12))
	v114 = *(*int32)(unsafe.Add(mBase, uint32(v113)))
	v115 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v114)+12)))
	if v115 != int32(1) {
		v136 = v114
		goto L1
	} else {
...
L32:
	;
	F_errsave_finish(m, l1, int32(498972), int32(773), int32(382290))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L26
...
func F_typeTypeId(m *base.Module, l0 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if v9 != 0 {
			...
			F_errmsg_internal(m, int32(108798), int32(0))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(498972), int32(593), int32(465690))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
