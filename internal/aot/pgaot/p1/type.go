...
L32:
	;
	F_errsave_finish(m, l1, int32(521639), int32(773), int32(399179))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L26
...
func F_typeTypeId(m *base.Module, l0 int32) int32 {
	...
	if l0 == int32(0) {
		...
		if v9 != 0 {
			...
			F_errmsg_internal(m, int32(115631), int32(0))
			mBase = m.M
			v13 = m.ExcPending
			if v13 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(521639), int32(593), int32(485733))
				mBase = m.M
				v18 = m.ExcPending
				if v18 != 0 {
					return int32(0)
