...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16))) = int32(100)
	F_errdetail(m, int32(_a_F_cube_a_f8_f8_4), v16)
	mBase = m.M
	v424 = m.ExcPending
	if v424 != 0 {
		goto L1
				...
				if v385 != 0 {
					...
					if v391 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v21))) = int32(100)
						F_errdetail(m, int32(_a_F_cube_c_f8_f8_1), v21)
						mBase = m.M
						v397 = m.ExcPending
						if v397 != 0 {
							return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(l2))) = v9
			if v9 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v34)+20)) = v35
				...
				v15 = int32(48)
				*(*int32)(unsafe.Add(mBase, _c_F_cube_scanner_init[0])) = v15
				F_errstart_cold(m, int32(21), int32(0))
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					...
					F_errmsg_internal(m, int32(_a_F_cube_scanner_init_0), int32(0))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
					} else {
						F_errfinish(m, int32(_a_F_cube_scanner_init_1), int32(108), int32(_a_F_cube_scanner_init_2))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return
