...
func F_gbtreekey_out(m *base.Module, l0 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = Fn13852(m, l0, int32(_a_F_gbtreekey_out_0), int32(45), int32(_a_F_gbtreekey_out_1), int32(_a_F_gbtreekey_out_2), int32(_a_F_gbtreekey_out_3))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
...
func F_get_statistics_object_oid(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = Fn13903(m, l0, l1, int32(_a_F_get_statistics_object_oid_0), int32(2620), int32(_a_F_get_statistics_object_oid_1), int32(63))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
