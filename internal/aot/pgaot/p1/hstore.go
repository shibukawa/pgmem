...
L31:
	;
	F_errsave_finish(m, v72, int32(_a_F_hstore_in_1), int32(423), int32(_a_F_hstore_in_2))
	mBase = m.M
	v92 = m.ExcPending
	if v92 != 0 {
		goto L1
...
L40:
	;
	F_errsave_finish(m, v99, int32(_a_F_hstore_in_1), int32(83), int32(_a_F_hstore_in_4))
	mBase = m.M
	v119 = m.ExcPending
	if v119 != 0 {
		goto L1
...
L48:
	;
	F_errsave_finish(m, v130, int32(_a_F_hstore_in_1), int32(71), int32(_a_F_hstore_in_6))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L1
...
L57:
	;
	F_errsave_finish(m, v163, int32(_a_F_hstore_in_1), int32(83), int32(_a_F_hstore_in_4))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L1
...
L63:
	;
	F_errsave_finish(m, v184, int32(_a_F_hstore_in_1), int32(71), int32(_a_F_hstore_in_6))
	mBase = m.M
	v212 = m.ExcPending
	if v212 != 0 {
		goto L1
...
L76:
	;
	F_errsave_finish(m, v222, int32(_a_F_hstore_in_1), int32(83), int32(_a_F_hstore_in_4))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L1
...
L84:
	;
	F_errsave_finish(m, v254, int32(_a_F_hstore_in_1), int32(443), int32(_a_F_hstore_in_8))
	mBase = m.M
	v274 = m.ExcPending
	if v274 != 0 {
		goto L1
...
L111:
	;
	F_errsave_finish(m, v356, int32(_a_F_hstore_in_1), int32(71), int32(_a_F_hstore_in_6))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L1
	...
	if v8 == int32(0) {
		...
		if v16 != 0 {
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, _c_F_hstore_skeys[0])) = v20
