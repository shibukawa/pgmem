	...
	if base.Ui64(v12-int64(9223372036854775807)) < base.Ui64(int64(2)) {
		...
		default:
			if base.Ui32(int32(7)) <= base.Ui32(l1) {
				...
				v43 = *(*int64)(unsafe.Add(mBase, uint32(v40)+uint32(_c_F_AdjustTimestampForTypmod[0])))
				v46 = *(*int64)(unsafe.Add(mBase, uint32(v40)+uint32(_c_F_AdjustTimestampForTypmod[1])))
				if int64(0) <= v12 {
					v49 = v12 + v46
...
L19:
	;
	v61 = v12 + int32(108)
	v68 = *(*int32)(unsafe.Add(mBase, _c_F_timestamp_trunc[0]))
	if v68 != 0 {
		goto L22
	} else {
		goto L23
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_timestamp_trunc[0])) = v112
...
L24:
	...
	v79 = int32(_a_F_timestamp_trunc_0)
	v81 = int32(_a_F_timestamp_trunc_1)
	goto L26
L25:
	;
	goto L24
...
L48:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v58
	F_errmsg(m, int32(_a_F_timestamp_trunc_2), v12)
	mBase = m.M
	v155 = m.ExcPending
	if v155 != 0 {
		goto L1
...
L49:
	;
	F_errfinish(m, int32(_a_F_timestamp_trunc_3), int32(_a_F_timestamp_trunc_4), int32(_a_F_timestamp_trunc_5))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
...
L54:
	...
	v183 = v12 + int32(80)
	v185 = v12 + int32(76)
	v189 = v177 + int32(_a_F_timestamp_trunc_6)
	v190 = int32(_a_F_timestamp_trunc_7)
	v191 = base.I32_div_u_s(v189, v190)
	v192 = int32(3)
	v198 = int32(2)
	v203 = base.I32_div_u_s((v191*int32(1073595727)+v189)<<(uint(v198)%32)|v192, v190)
	v206 = v177 + int32(_a_F_timestamp_trunc_8) + v191*v192 + v203 + int32(_a_F_timestamp_trunc_9)
	v207 = int32(1461)
...
L56:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v181))) = v226 + v208<<(uint(int32(2))%32) - int32(_a_F_timestamp_trunc_10)
	v234 = v224 + int32(123)
	v238 = int32(base.Ui32(v234*int32(2141)) >> (uint(int32(16)) % 32))
	*(*int32)(unsafe.Add(mBase, uint32(v185))) = v234 - int32(base.Ui32(v238*int32(_a_F_timestamp_trunc_11))>>(uint(int32(8))%32))
...
L99:
	;
	v362 = int32(_a_F_timestamp_trunc_12) + v351
...
L102:
	;
	v382 = base.I32_div_s(int32(_a_F_timestamp_trunc_13), int32(256))
	v385 = int32(4) + v362*int32(365) + v367 + v370 + v373 + v382 - int32(_a_F_timestamp_trunc_14)
	goto L96
L103:
	;
	v400 = v332*int32(7) + v385 - v397 - int32(7)
	v404 = v400 + int32(_a_F_timestamp_trunc_15)
	v405 = int32(_a_F_timestamp_trunc_7)
	v406 = base.I32_div_u_s(v404, v405)
	v407 = int32(3)
	v413 = int32(2)
	v418 = base.I32_div_u_s((v406*int32(1073595727)+v404)<<(uint(v413)%32)|v407, v405)
	v421 = v400 + v406*v407 + v418 + int32(_a_F_timestamp_trunc_9)
	v422 = int32(1461)
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v181))) = v441 + v423<<(uint(int32(2))%32) - int32(_a_F_timestamp_trunc_10)
	v449 = v439 + int32(123)
	v453 = int32(base.Ui32(v449*int32(2141)) >> (uint(int32(16)) % 32))
	*(*int32)(unsafe.Add(mBase, uint32(v185))) = v449 - int32(base.Ui32(v453*int32(_a_F_timestamp_trunc_11))>>(uint(int32(8))%32))
...
L123:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v58
	F_errmsg(m, int32(_a_F_timestamp_trunc_2), v12+int32(16))
	mBase = m.M
	v560 = m.ExcPending
	if v560 != 0 {
		goto L1
...
L124:
	;
	F_errfinish(m, int32(_a_F_timestamp_trunc_3), int32(_a_F_timestamp_trunc_16), int32(_a_F_timestamp_trunc_5))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L1
...
L130:
	;
	if v572 <= int32(_a_F_timestamp_trunc_17) {
		goto L133
	} else {
		goto L134
	}
...
L135:
	;
	if v572 != int32(_a_F_timestamp_trunc_18) {
		goto L126
	} else {
		goto L136
	}
...
L138:
	;
	v624 = base.I64_extend_i32_s(v591 + v598*int32(365) + v603 + v606 + v609 + v618 - int32(_a_F_timestamp_trunc_14) - int32(_a_F_timestamp_trunc_8))
	v633 = int64(32)
	v634 = int64(20)
...
L139:
	;
	v597 = int32(_a_F_timestamp_trunc_10)
	goto L141
L140:
	;
	v597 = int32(_a_F_timestamp_trunc_12)
	goto L141
L141:
	;
	v598 = v597 + v572
...
L144:
	;
	v618 = base.I32_div_s((v613+v588)*int32(_a_F_timestamp_trunc_11), int32(256))
	goto L138
L145:
	;
...
L150:
	;
	F_errmsg(m, int32(_a_F_timestamp_trunc_19), int32(0))
	mBase = m.M
	v706 = m.ExcPending
	if v706 != 0 {
		goto L1
...
L151:
	;
	F_errfinish(m, int32(_a_F_timestamp_trunc_3), int32(_a_F_timestamp_trunc_20), int32(_a_F_timestamp_trunc_5))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L1
...
L155:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v58
	F_errmsg(m, int32(_a_F_timestamp_trunc_21), v12+int32(48))
	mBase = m.M
	v728 = m.ExcPending
	if v728 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(_a_F_timestamp_trunc_3), int32(_a_F_timestamp_trunc_22), int32(_a_F_timestamp_trunc_5))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L161:
	;
	F_errfinish(m, int32(_a_F_timestamp_trunc_3), int32(_a_F_timestamp_trunc_23), int32(_a_F_timestamp_trunc_5))
	mBase = m.M
	v763 = m.ExcPending
	if v763 != 0 {
		goto L1
