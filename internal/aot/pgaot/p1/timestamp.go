					...
					if v21 == int32(0) {
						...
						if v27 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
							F_errmsg(m, int32(475227), v10)
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return
							} else {
								F_errsave_finish(m, l2, int32(492756), int32(397), int32(419748))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return
			...
			if v158 != 0 {
				...
				if v161 != 0 {
					...
					if v165 != 0 {
						...
						F_errfinish(m, int32(492756), int32(250), int32(66779))
						mBase = m.M
						v170 = m.ExcPending
						if v170 != 0 {
							return int32(0)
					...
					if v148 != 0 {
						...
						if v151 != 0 {
							...
							if v155 != 0 {
								...
								F_errfinish(m, int32(492756), int32(282), int32(36296))
								mBase = m.M
								v160 = m.ExcPending
								if v160 != 0 {
									return int32(0)
...
L49:
	;
	F_errfinish(m, int32(492756), int32(4725), int32(486620))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
...
L124:
	;
	F_errfinish(m, int32(492756), int32(4816), int32(486620))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L1
...
L151:
	;
	F_errfinish(m, int32(492756), int32(4823), int32(486620))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(492756), int32(4830), int32(486620))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L161:
	;
	F_errfinish(m, int32(492756), int32(4733), int32(486620))
	mBase = m.M
	v763 = m.ExcPending
	if v763 != 0 {
		goto L1
