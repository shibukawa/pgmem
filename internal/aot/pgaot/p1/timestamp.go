	...
	if base.Ui64(v12-int64(9223372036854775807)) < base.Ui64(int64(2)) {
		...
		default:
			if base.Ui32(int32(7)) <= base.Ui32(l1) {
					...
					if v21 == int32(0) {
						...
						if v27 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10))) = l1
							F_errmsg(m, int32(456136), v10)
							mBase = m.M
							v33 = m.ExcPending
							if v33 != 0 {
								return
							} else {
								F_errsave_finish(m, l2, int32(472939), int32(397), int32(402154))
								mBase = m.M
								v38 = m.ExcPending
								if v38 != 0 {
									return
				...
				v43 = *(*int64)(unsafe.Add(mBase, uint32(v40)+uint32(_consts[1138])))
				v46 = *(*int64)(unsafe.Add(mBase, uint32(v40)+uint32(_consts[1139])))
				if int64(0) <= v12 {
					v49 = v12 + v46
...
func F_timestamp_out(m *base.Module, l0 int32) int32 {
	...
	if base.Ui64(v10-int64(9223372036854775807)) <= base.Ui64(int64(1)) {
		if v10 != int64(-9223372036854775807-1) {
			v172 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1057])))
			*(*uint8)(unsafe.Add(mBase, uint32(v7)+8)) = uint8(v172)
			v175 = *(*int64)(unsafe.Add(mBase, _consts[1058]))
			*(*int64)(unsafe.Add(mBase, uint32(v7))) = v175
		} else {
			v18 = int32(*(*uint16)(unsafe.Add(mBase, _consts[1055])))
			*(*uint16)(unsafe.Add(mBase, uint32(v7)+8)) = uint16(v18)
			v21 = *(*int64)(unsafe.Add(mBase, _consts[1056]))
		...
		if int64(-2451545) <= v36 {
			...
			*(*uint32)(unsafe.Add(mBase, uint32(v7)+132)) = uint32(v138)
			v146 = int32(0)
			v150 = *(*int32)(unsafe.Add(mBase, _consts[1059]))
			...
			if v158 != 0 {
				...
				if v161 != 0 {
					...
					if v165 != 0 {
						...
						F_errfinish(m, int32(472939), int32(250), int32(63974))
						mBase = m.M
						v170 = m.ExcPending
						if v170 != 0 {
							return int32(0)
					...
					if v148 != 0 {
						...
						if v151 != 0 {
							...
							if v155 != 0 {
								...
								F_errfinish(m, int32(472939), int32(282), int32(34032))
								mBase = m.M
								v160 = m.ExcPending
								if v160 != 0 {
									return int32(0)
...
L19:
	;
	v61 = v12 + int32(108)
	v68 = *(*int32)(unsafe.Add(mBase, _consts[1066]))
	if v68 != 0 {
		goto L22
	} else {
		goto L23
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1066])) = v112
...
L49:
	;
	F_errfinish(m, int32(472939), int32(4725), int32(467264))
	mBase = m.M
	v160 = m.ExcPending
	if v160 != 0 {
		goto L1
...
L124:
	;
	F_errfinish(m, int32(472939), int32(4816), int32(467264))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L1
...
L151:
	;
	F_errfinish(m, int32(472939), int32(4823), int32(467264))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L1
...
L155:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+48)) = v58
	F_errmsg(m, int32(179888), v12+int32(48))
	mBase = m.M
	v728 = m.ExcPending
	if v728 != 0 {
		goto L1
...
L156:
	;
	F_errfinish(m, int32(472939), int32(4830), int32(467264))
	mBase = m.M
	v733 = m.ExcPending
	if v733 != 0 {
		goto L1
...
L161:
	;
	F_errfinish(m, int32(472939), int32(4733), int32(467264))
	mBase = m.M
	v763 = m.ExcPending
	if v763 != 0 {
		goto L1
