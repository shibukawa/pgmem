...
L4:
	...
	v29 = *(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_consts[1190])))
	if l1 <= v29 {
		goto L6
	} else {
		goto L7
...
L9:
	;
	v53 = int32(4509184)
	v54 = *(*int32)(unsafe.Add(mBase, _consts[1188]))
	v56 = v54 - int32(1)
	v58 = v56 << (uint(int32(2)) % 32)
	v61 = *(*int32)(unsafe.Add(mBase, uint32(v58)+uint32(_consts[1189])))
	*(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_consts[1189]))) = v61
	v65 = *(*int32)(unsafe.Add(mBase, uint32(v58)+uint32(_consts[1190])))
	*(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_consts[1190]))) = v65
	*(*int32)(unsafe.Add(mBase, _consts[1188])) = v56
	goto L8
L10:
	;
...
L13:
	;
	v41 = *(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_consts[1189])))
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v41
	F_errmsg_internal(m, int32(239089), v10)
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L11
...
L14:
	;
	F_errfinish(m, int32(497857), int32(1956), int32(167137))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L11
...
L57:
	;
	v238 = *(*int32)(unsafe.Add(mBase, _consts[939]))
