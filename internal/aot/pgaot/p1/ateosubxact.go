...
L4:
	...
	v29 = *(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_c_F_AtEOSubXact_HashTables[1])))
	if l1 <= v29 {
		goto L6
	} else {
		goto L7
...
L9:
	;
	v53 = int32(_a_F_AtEOSubXact_HashTables_0)
	v54 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_HashTables[0]))
	v56 = v54 - int32(1)
	v58 = v56 << (uint(int32(2)) % 32)
	v61 = *(*int32)(unsafe.Add(mBase, uint32(v58)+uint32(_c_F_AtEOSubXact_HashTables[2])))
	*(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_c_F_AtEOSubXact_HashTables[2]))) = v61
	v65 = *(*int32)(unsafe.Add(mBase, uint32(v58)+uint32(_c_F_AtEOSubXact_HashTables[1])))
	*(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_c_F_AtEOSubXact_HashTables[1]))) = v65
	*(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_HashTables[0])) = v56
	goto L8
L10:
	;
...
L13:
	;
	v41 = *(*int32)(unsafe.Add(mBase, uint32(v26)+uint32(_c_F_AtEOSubXact_HashTables[2])))
...
L33:
	;
	v136 = l1 - int32(1)
	v138 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_PgStat[0]))
	if v138 != 0 {
		goto L35
	} else {
		goto L36
...
L37:
	;
	v142 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_PgStat[1]))
...
L39:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v144)+8)) = v150
	v153 = int32(_a_F_AtEOSubXact_PgStat_0)
	v154 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_PgStat[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v144)+20)) = v146
	*(*int32)(unsafe.Add(mBase, uint32(v144)+4)) = v154
	*(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_PgStat[0])) = v144
	v161 = v144
	goto L34
L40:
	;
...
L57:
	;
	v238 = *(*int32)(unsafe.Add(mBase, _c_F_AtEOSubXact_PgStat[2]))
