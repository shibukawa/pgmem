			...
			*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v29
			...
			if v34 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = v36
				v46 = F_pg_snprintf(m, v8+int32(32), int32(1024), int32(456370), v8+int32(16))
				mBase = m.M
				v47 = m.ExcPending
				if v47 != 0 {
					return int32(0)
					...
					if v52 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v8))) = v53
						v61 = F_pg_snprintf(m, v8+int32(32), int32(1024), int32(456370), v8)
						mBase = m.M
						v62 = m.ExcPending
						if v62 != 0 {
							return int32(0)
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v50
	F_errmsg(m, int32(293219), v12+int32(16))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L9
...
L15:
	;
	F_errfinish(m, int32(487762), int32(776), int32(308909))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L9
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = l3
	F_errmsg_internal(m, int32(476219), v12)
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L9
...
L18:
	;
	F_errfinish(m, int32(487762), int32(779), int32(308909))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L9
