...
func F_BufFileCreateFileSet(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v8 = v6 - int32(1056)
	m.G0 = v8
	v11 = F_palloc(m, int32(_a_F_BufFileCreateFileSet_0))
	mBase = m.M
	v14 = m.ExcPending
	if v14 != 0 {
		return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, uint32(v11))) = int32(1)
		v20 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileCreateFileSet[0]))
		v21 = int64(0)
...
L13:
	...
	v46 = *(*int32)(unsafe.Add(mBase, _c_F_BufFileSeek[0]))
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v50
	F_errmsg(m, int32(_a_F_BufFileSeek_0), v12+int32(16))
	mBase = m.M
	v58 = m.ExcPending
	if v58 != 0 {
		goto L9
...
L15:
	;
	F_errfinish(m, int32(_a_F_BufFileSeek_1), int32(776), int32(_a_F_BufFileSeek_2))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L9
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = l3
	F_errmsg_internal(m, int32(_a_F_BufFileSeek_3), v12)
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L9
...
L18:
	;
	F_errfinish(m, int32(_a_F_BufFileSeek_1), int32(779), int32(_a_F_BufFileSeek_2))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L9
...
func F_BufTableLookup(m *base.Module, l0 int32, l1 int32) int32 {
	...
	var v15 int32
	_ = v15
	v4 = *(*int32)(unsafe.Add(mBase, _c_F_BufTableLookup[0]))
	v5 = int32(0)
