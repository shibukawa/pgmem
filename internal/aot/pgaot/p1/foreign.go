			...
			if v29 != 0 {
				...
				if v32 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
					F_errmsg(m, int32(70875), v7)
					mBase = m.M
					v36 = m.ExcPending
					if v36 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(496515), int32(714), int32(433800))
						mBase = m.M
						v41 = m.ExcPending
						if v41 != 0 {
							return int32(0)
		...
		if v9 == int32(0) {
			...
			if v18 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
				F_errmsg_internal(m, int32(51834), v6)
				mBase = m.M
				v22 = m.ExcPending
				if v22 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(496515), int32(364), int32(465349))
					mBase = m.M
					v27 = m.ExcPending
					if v27 != 0 {
						return int32(0)
