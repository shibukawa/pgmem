			...
			if l1 != 0 {
				...
				if v24 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v10))) = v25
					F_errmsg_internal(m, int32(52986), v10)
					mBase = m.M
					v29 = m.ExcPending
					if v29 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(470610), int32(2876), int32(230031))
						mBase = m.M
						v34 = m.ExcPending
						if v34 != 0 {
							return int32(0)
									...
									if l1 != 0 {
										...
										if v58 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v48
											F_errmsg_internal(m, int32(52952), v10+int32(16))
											mBase = m.M
											v64 = m.ExcPending
											if v64 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(470610), int32(2897), int32(230031))
												mBase = m.M
												v69 = m.ExcPending
												if v69 != 0 {
													return int32(0)
			...
			if l1 != 0 {
				...
				if v20 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg_internal(m, int32(44299), v8)
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(475804), int32(3796), int32(360131))
						mBase = m.M
						v29 = m.ExcPending
						if v29 != 0 {
							return int32(0)
