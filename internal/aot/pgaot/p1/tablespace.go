...
func F_get_tablespace(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = l0
	...
	v16 = *(*int32)(unsafe.Add(mBase, _consts[1168]))
	if v16 != 0 {
		v43 = v16
		v46 = int32(0)
								...
								if v67 != 0 {
									...
									if v74 != 0 {
										...
										if v83 != 0 {
											...
											v85 = v81
											v87 = *(*int32)(unsafe.Add(mBase, _consts[1168]))
		...
		*(*int64)(unsafe.Add(mBase, uint32(v7)+32)) = int64(34359738372)
		v25 = F_hash_create(m, int32(399450), int32(16), v5+int32(-48), int32(40))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return int32(0)
		} else {
			*(*int32)(unsafe.Add(mBase, _consts[1168])) = v25
...
func F_has_tablespace_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v22 = F_convert_any_priv_string(m, v14, int32(1657328))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
