...
func F_get_tablespace(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+12)) = l0
	...
	v16 = *(*int32)(unsafe.Add(mBase, _consts[1173]))
	if v16 != 0 {
		v43 = v16
		v46 = int32(0)
		...
		*(*int64)(unsafe.Add(mBase, uint32(v7)+32)) = int64(34359738372)
		v25 = F_hash_create(m, int32(419855), int32(16), v5+int32(-48), int32(40))
		mBase = m.M
		v28 = m.ExcPending
		if v28 != 0 {
			return int32(0)
		} else {
			*(*int32)(unsafe.Add(mBase, _consts[1173])) = v25
			...
			if v31 == int32(0) {
				...
				if v35 != 0 {
					...
					if v40 != 0 {
						...
						v42 = *(*int32)(unsafe.Add(mBase, _consts[1173]))
						v43 = v42
						v46 = int32(0)
						v48 = F_hash_search(m, v43, v5+int32(-52), v46, v46)
						mBase = m.M
...
func F_has_tablespace_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v22 = F_convert_any_priv_string(m, v14, int32(1694192))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
