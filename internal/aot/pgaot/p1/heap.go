...
L152:
	...
	v1107 = v1099 & int32(_a_F_heap_index_delete_tuples_0)
...
L186:
	;
	v1050 = *(*int32)(unsafe.Add(mBase, _c_F_heap_index_delete_tuples[3]))
...
L188:
	;
	v1058 = *(*int32)(unsafe.Add(mBase, _c_F_heap_index_delete_tuples[4]))
	v1064 = v1058 + v954<<(uint(int32(13))%32) + int32(-8192)
	goto L185
L189:
	;
	v1073 = int32(base.Ui32(v1065+int32(_a_F_heap_index_delete_tuples_3)) >> (uint(int32(2)) % 32))
	goto L191
L190:
	;
	v1073 = int32(0)
...
L196:
	...
	if v1116&int32(_a_F_heap_index_delete_tuples_4) == int32(0) {
		goto L195
	} else {
		goto L199
	}
...
L199:
	;
	if base.Ui32(int32(_a_F_heap_index_delete_tuples_5)) <= base.Ui32(v1116) {
		goto L200
	} else {
		goto L201
	}
L200:
	;
	v1126 = int32(*(*int16)(unsafe.Add(mBase, uint32(v1092+v1116&int32(_a_F_heap_index_delete_tuples_6))+18)))
	if v1126 < int32(0) {
		goto L194
	} else {
		goto L203
...
L206:
	;
	if base.Ui32(v1107) <= base.Ui32((v1158-int32(1))&int32(_a_F_heap_index_delete_tuples_0)) {
		goto L212
	} else {
		goto L213
	}
...
L214:
	;
	v1202 = *(*int32)(unsafe.Add(mBase, uint32(v1173&int32(_a_F_heap_index_delete_tuples_0)<<(uint(int32(2))%32)+v1110-int32(4))))
...
L216:
	;
	if base.Ui32((v1305-int32(1))&int32(_a_F_heap_index_delete_tuples_0)) < base.Ui32(v1107) {
		v1173 = v1305
		v1177 = v1309
		goto L214
	} else {
...
L217:
	;
	v1213 = v1092 + v1202&int32(_a_F_heap_index_delete_tuples_6)
	if v1177 != 0 {
		goto L219
	} else {
		goto L220
...
L218:
	;
	v1305 = v1202 & int32(_a_F_heap_index_delete_tuples_6)
	v1309 = v1177
	goto L216
L219:
	;
...
L229:
	...
	if v1233&int32(_a_F_heap_index_delete_tuples_7) != int32(_a_F_heap_index_delete_tuples_8) {
		goto L230
	} else {
		goto L231
	}
