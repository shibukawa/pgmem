...
func F_GenericMatchText(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	if l4 != 0 {
		...
		if v9 != 0 {
			...
			v11 = *(*int32)(unsafe.Add(mBase, _c_F_GenericMatchText[0]))
			v12 = *(*int32)(unsafe.Add(mBase, uint32(v11)+4))
			v17 = *(*int32)(unsafe.Add(mBase, uint32(v12*int32(28))+uint32(_c_F_GenericMatchText[1])))
			if v17 == int32(1) {
				...
				v24 = *(*int32)(unsafe.Add(mBase, _c_F_GenericMatchText[0]))
		...
		if v37 != 0 {
			...
			if v40 != 0 {
				...
				F_errmsg(m, int32(_a_F_GenericMatchText_0), int32(0))
				mBase = m.M
				v44 = m.ExcPending
				if v44 != 0 {
					return int32(0)
				} else {
					F_errhint(m, int32(_a_F_GenericMatchText_1), int32(0))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
