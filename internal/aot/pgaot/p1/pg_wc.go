...
func F_pg_wc_ispunct(m *base.Module, l0 int32) int32 {
	...
	_ = v208
	v2 = int32(0)
	v4 = *(*int32)(unsafe.Add(mBase, _consts[638]))
	switch v4 - int32(1) {
	case 0:
		goto L4
	case 1:
...
L4:
	;
	v18 = *(*int32)(unsafe.Add(mBase, _consts[645]))
...
L6:
	;
	v11 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[639]))))
...
L9:
	...
	v139 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v136)+uint32(_consts[640]))))
	if v139&v135 != 0 {
		goto L45
	} else {
		goto L46
...
L11:
	;
	v123 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v100)+uint32(_consts[646]))))
	v129 = v123
	goto L10
L12:
	;
	v122 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_consts[647]))))
	v129 = v122
	goto L10
L13:
	;
	v117 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v70)+uint32(_consts[646]))))
	v151 = v117
	goto L8
L14:
	;
...
L18:
	...
	v45 = *(*int32)(unsafe.Add(mBase, uint32(v42)+uint32(_consts[641])))
...
L23:
	;
	v51 = *(*int32)(unsafe.Add(mBase, uint32(v42)+uint32(_consts[642])))
...
L28:
	...
	v70 = v68 * int32(12)
	v73 = *(*int32)(unsafe.Add(mBase, uint32(v70)+uint32(_consts[648])))
...
L33:
	;
	v79 = *(*int32)(unsafe.Add(mBase, uint32(v70)+uint32(_consts[649])))
...
L37:
	...
	v100 = v98 * int32(12)
	v103 = *(*int32)(unsafe.Add(mBase, uint32(v100)+uint32(_consts[648])))
...
L42:
	;
	v109 = *(*int32)(unsafe.Add(mBase, uint32(v100)+uint32(_consts[649])))
...
L47:
	;
	v145 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v136)+uint32(_consts[647]))))
	v151 = v145
	goto L8
L48:
	;
...
L49:
	;
	v178 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(8))%32)))+uint32(_consts[650]))))
	v184 = int32(*(*uint8)(unsafe.Add(mBase, uint32(int32(base.Ui32(l0)>>(uint(int32(3))%32))&int32(31)|v178<<(uint(int32(5))%32))+uint32(_consts[650]))))
...
L10:
	;
	v53 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0<<(uint(int32(1))%32))+uint32(_consts[640]))))
...
L11:
	...
	v34 = *(*int32)(unsafe.Add(mBase, uint32(v31)+uint32(_consts[651])))
...
L16:
	;
	v40 = *(*int32)(unsafe.Add(mBase, uint32(v31)+uint32(_consts[652])))
