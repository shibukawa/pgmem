...
L35:
	;
	v97 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v86&int32(_a_F_raw_heap_insert_3)<<(uint(int32(2))%32)+(v49+int32(24))-int32(3)))))
...
L37:
	;
	v103 = v86 + int32(1)
	v104 = int32(_a_F_raw_heap_insert_3)
...
L43:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v134)+10)) = int32(_a_F_raw_heap_insert_4)
	v169 = int32(_a_F_raw_heap_insert_5)
	*(*uint16)(unsafe.Add(mBase, uint32(v134)+18)) = uint16(v169)
	v175 = int32(_a_F_raw_heap_insert_6)
	*(*uint16)(unsafe.Add(mBase, uint32(v134)+16)) = uint16(v175)
	*(*uint16)(unsafe.Add(mBase, uint32(v134)+14)) = uint16(v175)
	goto L42
L44:
	;
	v163 = F___memset(m, v134, int32(0), int32(_a_F_raw_heap_insert_6))
	mBase = m.M
	goto L43
L45:
	;
...
L54:
	...
	v203 = v178 + v200&int32(_a_F_raw_heap_insert_7)
	v205 = l1 + int32(4)
...
L4:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _c_F_regclassin[0]))
	if v176 == int32(0) {
		goto L1
	} else {
		goto L51
...
L3:
	;
	v170 = *(*int32)(unsafe.Add(mBase, _c_F_regoperatorin[0]))
	if v170 == int32(0) {
		goto L1
	} else {
		goto L46
...
L3:
	;
	v171 = *(*int32)(unsafe.Add(mBase, _c_F_regoperin[0]))
	if v171 == int32(0) {
		goto L1
	} else {
		goto L46
...
L3:
	;
	v175 = *(*int32)(unsafe.Add(mBase, _c_F_regprocin[0]))
	if v175 == int32(0) {
		goto L1
	} else {
		goto L50
