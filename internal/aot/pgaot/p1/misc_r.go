...
func F_RegisterBackgroundWorker(m *base.Module, l0 int32) {
	...
	if v9 == int32(0) {
		...
		if v13 != 0 {
			v35 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[2]))
			if v35 != 0 {
				...
				if v180 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+80)) = l0
					F_errmsg_internal(m, int32(_a_F_RegisterBackgroundWorker_0), v6+int32(80))
					mBase = m.M
					v186 = m.ExcPending
					if v186 != 0 {
						return
				...
				if v39 != 0 {
					...
					if v38 != 0 {
						*(*int32)(unsafe.Add(mBase, uint32(v6)+64)) = l0
						F_errmsg_internal(m, int32(_a_F_RegisterBackgroundWorker_3), v6-int32(-64))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return
								...
								if v53 != 0 {
									...
									if v52 == int32(0) {
										...
										if v56 != 0 {
												...
												if v59 == int32(0) {
													...
													if v65 != 0 {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v6)+48)) = l0
														F_errmsg(m, int32(_a_F_RegisterBackgroundWorker_4), v6+int32(48))
														mBase = m.M
														v71 = m.ExcPending
														if v71 != 0 {
															return
											...
											v77 = int32(_a_F_RegisterBackgroundWorker_5)
											v79 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[3]))
											v81 = v79 + int32(1)
											*(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[3])) = v81
											v84 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[4]))
											if v84 < v81 {
													...
													if v88 == int32(0) {
														...
														if v94 != 0 {
															...
															if v98 != 0 {
																...
																v100 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[4]))
																*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = v100
																F_errdetail_plural(m, int32(_a_F_RegisterBackgroundWorker_8), int32(_a_F_RegisterBackgroundWorker_9), v100, v6+int32(32))
																mBase = m.M
																v107 = m.ExcPending
																if v107 != 0 {
																	return
																} else {
																	*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = int32(_a_F_RegisterBackgroundWorker_10)
																	F_errhint(m, int32(_a_F_RegisterBackgroundWorker_11), v6+int32(16))
																	mBase = m.M
																	v114 = m.ExcPending
																	if v114 != 0 {
																		return
												...
												v121 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[5]))
												...
												if v125 != 0 {
													...
													if v124 == int32(0) {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v147)+1460)) = v149
														v156 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[6]))
														if v156 == v149 {
															v159 = int32(_a_F_RegisterBackgroundWorker_14)
															*(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[7])) = v159
															v163 = v159
														} else {
															v163 = v156
														}
														*(*int32)(unsafe.Add(mBase, uint32(v147)+1480)) = int32(_a_F_RegisterBackgroundWorker_14)
														*(*int32)(unsafe.Add(mBase, uint32(v147)+1484)) = v163
														v168 = v147 + int32(1480)
														*(*int32)(unsafe.Add(mBase, uint32(v163))) = v168
														*(*int32)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[6])) = v168
														m.G0 = v6 + int32(96)
														return
													}
												}
			...
			v15 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_RegisterBackgroundWorker[8])))
			if v15 != 0 {
				m.G0 = v6 + int32(96)
				return
			} else {
					...
					if v18 == int32(0) {
						...
						if v24 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
							F_errmsg(m, int32(_a_F_RegisterBackgroundWorker_15), v6)
							mBase = m.M
							v28 = m.ExcPending
							if v28 != 0 {
								return
...
func F_RegisterCatcacheInvalidation(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
	...
	v12 = v10 - int32(16)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterCatcacheInvalidation[0]))
	v16 = *(*int32)(unsafe.Add(mBase, uint32(l3)+8))
	v18 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterCatcacheInvalidation[1]))
	if v18 <= v16 {
		if v15 == int32(0) {
			v24 = *(*int32)(unsafe.Add(mBase, _c_F_RegisterCatcacheInvalidation[2]))
			...
			if v27 != 0 {
				...
				v34 = int32(32)
				v35 = v26
				*(*int32)(unsafe.Add(mBase, _c_F_RegisterCatcacheInvalidation[1])) = v34
				*(*int32)(unsafe.Add(mBase, _c_F_RegisterCatcacheInvalidation[0])) = v35
				v40 = v35
					...
					if int32(0) <= v54 {
						...
						if base.B2i32(v64 != v34)&base.B2i32(base.Ui32(v66) < base.Ui32(int32(192))) == int32(0) {
							...
							if base.B2i32(v83 != v34)&base.B2i32(base.Ui32(v85) < base.Ui32(int32(224))) == int32(0) {
								v111 = v85<<(uint(int32(12))%32)&int32(_a_F_r_VI_2_0) | v81
								v112 = int32(3)
							} else {
								v103 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v15+(v30-int32(4))))))
								v111 = v85<<(uint(int32(12))%32)&int32(_a_F_r_VI_2_1) | v103&int32(7)<<(uint(int32(18))%32) | v81
								v112 = int32(4)
							}
						}
					}
						...
						if int32(0) <= v64 {
							...
							if base.B2i32(v74 != v44)&base.B2i32(base.Ui32(v76) < base.Ui32(int32(192))) == int32(0) {
								...
								if base.B2i32(v93 != v44)&base.B2i32(base.Ui32(v95) < base.Ui32(int32(224))) == int32(0) {
									v121 = v95<<(uint(int32(12))%32)&int32(_a_F_r_e_ending_2_0) | v91
									v122 = int32(3)
								} else {
									v113 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v43+(v40-int32(4))))))
									v121 = v95<<(uint(int32(12))%32)&int32(_a_F_r_e_ending_2_1) | v113&int32(7)<<(uint(int32(18))%32) | v91
									v122 = int32(4)
								}
							}
						}
...
func F_r_remove_suffix_1(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+20)) = v4
	...
	if v4 <= v6 {
		...
		case 0, 5:
			v17 = F_find_among_b(m, l0, int32(_a_F_r_remove_suffix_1_0), int32(3))
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return int32(0)
...
L14:
	;
	v45 = F_find_among_b(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_6), int32(4))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L15
...
L23:
	;
	v79 = F_find_among_b(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_7), int32(2))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L15
...
L43:
	;
	v146 = F_find_among_b(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_7), int32(2))
	mBase = m.M
	v147 = m.ExcPending
	if v147 != 0 {
		goto L15
...
L53:
	;
	v187 = F_find_among_b(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_5), int32(4))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L15
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v209
	v214 = int32(0)
	v215 = F_in_grouping_b_U(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_3), int32(97), int32(305), v214)
	mBase = m.M
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v238
	v246 = F_in_grouping_b_U(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_3), int32(97), int32(305), int32(0))
	mBase = m.M
	if v246 != 0 {
		v261 = v236
		goto L57
...
L82:
	;
	v292 = F_find_among_b(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_4), int32(2))
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L15
...
L93:
	;
	v322 = F_in_grouping_b_U(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_2), int32(105), int32(305), int32(0))
	mBase = m.M
	if v322 != 0 {
		v386 = v308
		goto L94
...
L102:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v335
	v340 = int32(0)
	v341 = F_in_grouping_b_U(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_3), int32(97), int32(305), v340)
	mBase = m.M
...
L108:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v361
	v369 = F_in_grouping_b_U(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_3), int32(97), int32(305), int32(0))
	mBase = m.M
	if v369 != 0 {
		v386 = v308
		goto L94
...
L131:
	;
	v480 = F_find_among_b(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_1), int32(2))
	mBase = m.M
	v481 = m.ExcPending
	if v481 != 0 {
		goto L15
...
L141:
	;
	v501 = F_find_among_b(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_4), int32(2))
	mBase = m.M
	v502 = m.ExcPending
	if v502 != 0 {
		goto L15
...
L148:
	;
	v523 = F_in_grouping_b_U(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_2), int32(105), int32(305), int32(0))
	mBase = m.M
	if v523 != 0 {
		v587 = v509
		goto L149
...
L157:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v536
	v541 = int32(0)
	v542 = F_in_grouping_b_U(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_3), int32(97), int32(305), v541)
	mBase = m.M
...
L163:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+4)) = v562
	v570 = F_in_grouping_b_U(m, l0, int32(_a_F_r_stem_suffix_chain_before_ki_3), int32(97), int32(305), int32(0))
	mBase = m.M
	if v570 != 0 {
		v587 = v509
		goto L149
...
L3:
	;
	if int32(1)<<(uint(v12)%32)&int32(_a_F_r_undouble_0) == int32(0) {
		v105 = v2
		goto L1
	} else {
		goto L4
...
L4:
	...
	v26 = F_find_among_b(m, l0, int32(_a_F_r_undouble_1), int32(3))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L5
...
L45:
	;
	v174 = *(*int32)(unsafe.Add(mBase, _c_F_renameatt_internal[0]))
	if v174 != 0 {
		goto L46
	} else {
		goto L47
...
func F_rtrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(_a_F_rtrim1_0), v47, int32(0), v47)
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
