	...
	if v8 != 0 {
		...
		if v9 != 0 {
			...
			if v70 != 0 {
				...
				F_errmsg_internal(m, int32(459221), int32(0))
				mBase = m.M
				v74 = m.ExcPending
				if v74 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(514994), int32(338), int32(368661))
					mBase = m.M
					v79 = m.ExcPending
					if v79 != 0 {
						return int32(0)
		...
		if v54 != 0 {
			...
			if v57 != 0 {
				...
				if v61 != 0 {
					...
					F_errfinish(m, int32(514994), int32(334), int32(368661))
					mBase = m.M
					v66 = m.ExcPending
					if v66 != 0 {
						return int32(0)
...
L37:
	;
	F_errfinish(m, int32(514994), int32(194), int32(283941))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L9
...
L39:
	;
	F_errmsg_internal(m, int32(459151), int32(0))
	mBase = m.M
	v139 = m.ExcPending
	if v139 != 0 {
		goto L9
...
L40:
	;
	F_errfinish(m, int32(514994), int32(201), int32(283941))
	mBase = m.M
	v144 = m.ExcPending
	if v144 != 0 {
		goto L9
...
func F_binary_upgrade_set_next_array_pg_type_oid(m *base.Module, l0 int32) int32 {
	...
	if v3 == int32(0) {
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(514994), int32(68), int32(454663))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[1122])) = v25
		return int32(0)
	}
}
		...
		if v11 != 0 {
			...
			if v14 != 0 {
				...
				if v18 != 0 {
					...
					F_errfinish(m, int32(514994), int32(253), int32(122072))
					mBase = m.M
					v23 = m.ExcPending
					if v23 != 0 {
						return int32(0)
...
L18:
	;
	F_errfinish(m, int32(522496), int32(124), int32(404374))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L7
...
L58:
	;
	F_errmsg(m, int32(418850), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L7
...
L59:
	;
	F_errfinish(m, int32(522496), int32(171), int32(404374))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L7
...
L78:
	;
	F_errfinish(m, int32(522496), int32(114), int32(404374))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L7
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l0
	F_errmsg(m, int32(312204), v8+int32(-32))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L7
...
L82:
	;
	F_errfinish(m, int32(522496), int32(131), int32(404374))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L7
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
	F_errmsg(m, int32(313155), v8+int32(-48))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L7
...
L86:
	;
	F_errfinish(m, int32(522496), int32(197), int32(404374))
	mBase = m.M
	v255 = m.ExcPending
	if v255 != 0 {
		goto L7
