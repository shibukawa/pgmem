...
L3:
	;
	v15 = F_AllocateFile(m, l0, int32(229660))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L7
...
L58:
	;
	F_errmsg(m, int32(398200), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L7
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = l0
	F_errmsg(m, int32(296836), v8+int32(-32))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L7
...
L85:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = l0
	F_errmsg(m, int32(297787), v8+int32(-48))
	mBase = m.M
	v250 = m.ExcPending
	if v250 != 0 {
		goto L7
