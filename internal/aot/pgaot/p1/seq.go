				...
				*(*int32)(unsafe.Add(mBase, uint32(l2))) = int32(base.Ui32(v49) >> (uint(int32(17)) % 32))
				...
				if v53 != 0 {
					*(*int32)(unsafe.Add(mBase, uint32(v47)+4)) = int32(0)
					...
					v59 = v57 & int32(_a_F_read_seq_tuple_2)
