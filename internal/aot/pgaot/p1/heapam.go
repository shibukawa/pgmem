...
L50:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_bitmap_next_tuple[0]))
...
L52:
	;
	v222 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_bitmap_next_tuple[1]))
	v228 = v222 + v144<<(uint(int32(13))%32) + int32(-8192)
	goto L49
L53:
	;
	v233 = v229 + int32(_a_F_heapam_scan_bitmap_next_tuple_0)
	if v233&int32(_a_F_heapam_scan_bitmap_next_tuple_1) == int32(0) {
		v335 = v210
		goto L35
	} else {
		goto L54
...
L55:
	...
	if v273&int32(_a_F_heapam_scan_bitmap_next_tuple_2) == int32(_a_F_heapam_scan_bitmap_next_tuple_3) {
		goto L57
	} else {
		goto L58
	}
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v24)+20)) = v228 + v273&int32(_a_F_heapam_scan_bitmap_next_tuple_4)
...
L59:
	;
	if v252 != int32(base.Ui32(v233)>>(uint(int32(2))%32))&int32(_a_F_heapam_scan_bitmap_next_tuple_5) {
		v252 = v252 + int32(1)
		v254 = v321
		goto L55
	} else {
...
L75:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v411&int32(_a_F_heapam_scan_bitmap_next_tuple_4) + v405
...
L76:
	;
	v391 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_bitmap_next_tuple[0]))
...
L78:
	;
	v399 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_scan_bitmap_next_tuple[1]))
...
L22:
	...
	if v112 == int32(_a_F_heapam_tuple_lock_0) {
		goto L24
	} else {
		goto L25
	}
...
L24:
	...
	if v115&v116 == int32(_a_F_heapam_tuple_lock_1) {
		goto L6
	} else {
		goto L27
	}
...
L44:
	...
	v160 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_heapam_tuple_lock[0])))
...
L53:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v170 + int32(4)
	F_errmsg(m, int32(_a_F_heapam_tuple_lock_2), v20)
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L1
...
L59:
	;
	v192 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_tuple_lock[1]))
	if v192 == v106 {
		goto L60
	} else {
		goto L61
...
L62:
	;
	v196 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_tuple_lock[2]))
	if v196 <= int32(0) {
		goto L64
	} else {
		goto L65
...
L64:
	;
	v200 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_tuple_lock[3]))
	if v200 == int32(0) {
		v293 = int32(0)
		goto L63
	} else {
...
L66:
	;
	v262 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_tuple_lock[4]))
	v264 = int32(0)
	v266 = v196 - int32(1)
	goto L86
L67:
...
L98:
	;
	v311 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_tuple_lock[5]))
...
L103:
	;
	v326 = *(*int32)(unsafe.Add(mBase, _c_F_heapam_tuple_lock[5]))
...
L119:
	...
	*(*uint16)(unsafe.Add(mBase, uint32(v87))) = uint16(v368)
	...
	if v371&int32(_a_F_heapam_tuple_lock_5) == int32(_a_F_heapam_tuple_lock_6) {
		goto L121
	} else {
		goto L122
	}
...
L136:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+20)) = v444 | v445<<(uint(v454)%32)
	F_errmsg_internal(m, int32(_a_F_heapam_tuple_lock_8), v20+v454)
	mBase = m.M
	v462 = m.ExcPending
	if v462 != 0 {
		goto L1
