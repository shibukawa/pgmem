...
L2:
	;
	v232 = *(*int32)(unsafe.Add(mBase, _c_F_FlagRWConflict[0]))
...
L3:
	;
	v202 = *(*int32)(unsafe.Add(mBase, _c_F_FlagRWConflict[0]))
	...
	if v17&v14 == v5 {
		...
		if v27 < int32(0) {
			...
			if v33 != int32(1) {
				...
				switch v36&int32(_a_F_fastgetattr_3_0) - int32(1) {
				case 0:
				...
				default:
					...
					if v49 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v10))) = v36
						F_errmsg_internal(m, int32(_a_F_fastgetattr_3_1), v10)
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_fastgetattr_3_2), int32(70), int32(_a_F_fastgetattr_3_3))
							mBase = m.M
							v58 = m.ExcPending
							if v58 != 0 {
								return int32(0)
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l3))) = v240 + v242
	goto L1
L13:
	;
...
L15:
	...
	switch v73 - int32(_a_F_fill_val_0) {
	case 0:
		goto L25
	case 1:
		goto L26
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = base.I32_extend16_s(v50)
	F_errmsg_internal(m, int32(_a_F_fill_val_1), v12)
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L20
...
L22:
	;
	F_errfinish(m, int32(_a_F_fill_val_2), int32(230), int32(_a_F_fill_val_3))
	mBase = m.M
	v70 = m.ExcPending
	if v70 != 0 {
		goto L20
...
L24:
	;
	v229 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+12)))
	v235 = (v14 + v229 - int32(1)) & (int32(0) - v229)
	v236 = base.I32_extend16_s(v73)
	if v236 != 0 {
		goto L89
	} else {
		goto L90
...
L70:
	;
	v175 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v6))))
	if v175 == int32(0) {
		goto L71
	} else {
		goto L72
...
L85:
	;
	v227 = F__emscripten_memcpy_bulkmem(m, v14, v6, v226)
	mBase = m.M
	goto L87
L86:
	;
...
L89:
	;
	v237 = F__emscripten_memcpy_bulkmem(m, v235, v6, v236)
	mBase = m.M
	goto L91
L90:
	;
...
L20:
	;
	v138 = int32(_a_F_finalize_aggregates_0)
	v139 = *(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0]))
...
L28:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v139
...
L41:
	;
	v203 = int32(_a_F_finalize_aggregates_0)
	v204 = *(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v74
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v204
...
L53:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v240
...
L55:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v269
...
L87:
	;
	v551 = *(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[1]))
	if v551 != 0 {
		goto L89
	} else {
		goto L90
...
L98:
	;
	v566 = int32(_a_F_finalize_aggregates_0)
	v567 = *(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0]))
	v569 = *(*int32)(unsafe.Add(mBase, uint32(v69)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v569
...
L99:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v567
	if v574 != 0 {
		goto L94
	} else {
		goto L100
...
L134:
	;
	v902 = int32(_a_F_finalize_aggregates_0)
	v903 = *(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0]))
	...
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v907
...
L136:
	;
	v1003 = int32(0)
	v1004 = int32(_a_F_finalize_aggregates_0)
	v1005 = *(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0]))
	...
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v1009
...
L143:
	...
	if v933 == int32(_a_F_finalize_aggregates_1) {
		goto L141
	} else {
		goto L151
	}
...
L148:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v903
	goto L133
L149:
	;
	goto L150
...
L158:
	...
	if v962 != int32(_a_F_finalize_aggregates_1) {
		v975 = v958
		goto L157
	} else {
		goto L159
...
L166:
	...
	if v982 == int32(_a_F_finalize_aggregates_1) {
		goto L165
	} else {
		goto L169
	}
...
L183:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_finalize_aggregates[0])) = v1005
	goto L133
L184:
	;
...
L189:
	...
	if v1115 == int32(_a_F_finalize_aggregates_1) {
		goto L188
	} else {
		goto L192
	}
...
L216:
	...
	if v1296 != int32(_a_F_finalize_aggregates_1) {
		v1309 = v1292
		goto L215
	} else {
		goto L217
...
L224:
	...
	if v1316 == int32(_a_F_finalize_aggregates_1) {
		goto L223
	} else {
		goto L227
	}
...
func F_find_funcstat_entry(m *base.Module, l0 int32) int32 {
	...
	var v12 int32
	_ = v12
	v5 = *(*int32)(unsafe.Add(mBase, _c_F_find_funcstat_entry[0]))
...
L7:
	;
	v21 = int32(_a_F_find_header_0)
	goto L9
L8:
	;
	v21 = int32(_a_F_find_header_1)
	goto L9
L9:
	;
...
L35:
	;
	F_errsave_finish(m, l4, int32(_a_F_finish_nodeitem_1), v214, int32(_a_F_finish_nodeitem_2))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L39
...
L43:
	;
	v172 = int32(_a_F_finish_nodeitem_3)
	goto L45
L44:
	;
	v172 = int32(_a_F_finish_nodeitem_4)
	goto L45
L45:
	;
...
func F_format_elog_string(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	v11 = int32(_a_F_format_elog_string_0)
	v12 = *(*int32)(unsafe.Add(mBase, _c_F_format_elog_string[0]))
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_format_elog_string[1]))
	*(*int32)(unsafe.Add(mBase, _c_F_format_elog_string[0])) = v15
	v18 = *(*int32)(unsafe.Add(mBase, _c_F_format_elog_string[2]))
...
L2:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_format_elog_string[3])) = v18
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_format_elog_string[0])) = v12
	m.G0 = v9 + int32(32)
	return v56
}
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v39
	F_appendStringInfo(m, v11+int32(32), int32(_a_F_format_procedure_extended_0), v11+int32(16))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L2
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	v119 = F_pg_snprintf(m, v114, int32(64), int32(_a_F_format_procedure_extended_1), v11)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L2
...
L4:
	...
	v34 = v30 + v27
	if base.Ui32(v34) <= base.Ui32(int32(_a_F_fsm_set_avail_0)) {
		goto L6
	} else {
		goto L7
	}
