...
L62:
	;
	F_errmsg(m, int32(142632), int32(0))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L59
...
L63:
	;
	F_errdetail_internal(m, int32(632227), int32(0))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L59
...
L64:
	;
	F_errhint(m, int32(652484), int32(0))
	mBase = m.M
	v225 = m.ExcPending
	if v225 != 0 {
		goto L59
...
L65:
	;
	F_errfinish(m, int32(500140), int32(4668), int32(364688))
	mBase = m.M
	v230 = m.ExcPending
	if v230 != 0 {
		goto L59
...
L70:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v248
	F_errdetail_internal(m, int32(654562), v12)
	mBase = m.M
	v252 = m.ExcPending
	if v252 != 0 {
		goto L59
...
L72:
	;
	F_errfinish(m, int32(500140), int32(4680), int32(364688))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L59
...
L75:
	;
	F_errmsg(m, int32(110002), int32(0))
	mBase = m.M
	v272 = m.ExcPending
	if v272 != 0 {
		goto L59
...
L76:
	;
	F_errhint(m, int32(665782), int32(0))
	mBase = m.M
	v276 = m.ExcPending
	if v276 != 0 {
		goto L59
...
L77:
	;
	F_errfinish(m, int32(500140), int32(654), int32(110226))
	mBase = m.M
	v281 = m.ExcPending
	if v281 != 0 {
		goto L59
...
L45:
	;
	F_errmsg_internal(m, int32(145595), int32(0))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L9
...
L46:
	;
	F_errfinish(m, int32(493894), int32(2772), int32(287255))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L9
...
L49:
	;
	F_errfinish(m, int32(493894), int32(2783), int32(287255))
	mBase = m.M
	v182 = m.ExcPending
	if v182 != 0 {
		goto L9
...
L16:
	;
	F_errmsg_internal(m, int32(213991), int32(0))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L12
...
L19:
	;
	F_errfinish(m, int32(501242), int32(3050), int32(214047))
	mBase = m.M
	v49 = m.ExcPending
	if v49 != 0 {
		goto L12
...
func F_fetch_finfo_record(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = l1
	v13 = F_psprintf(m, int32(176467), v5+int32(-16))
	mBase = m.M
	v16 = m.ExcPending
	if v16 != 0 {
		return int32(0)
					...
					if v19 == int32(0) {
						...
						if v55 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v13
							F_errmsg_internal(m, int32(705678), v5+int32(-48))
							mBase = m.M
							v61 = m.ExcPending
							if v61 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(496599), int32(481), int32(421691))
								mBase = m.M
								v66 = m.ExcPending
								if v66 != 0 {
									return int32(0)
							...
							if v70 != 0 {
								...
								if v73 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v74
									F_errmsg(m, int32(705619), v5+int32(-32))
									mBase = m.M
									v81 = m.ExcPending
									if v81 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(496599), int32(491), int32(421691))
										mBase = m.M
										v86 = m.ExcPending
										if v86 != 0 {
											return int32(0)
				...
				if v35 != 0 {
					...
					if v38 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
						F_errmsg(m, int32(705565), v7)
						mBase = m.M
						v42 = m.ExcPending
						if v42 != 0 {
							return int32(0)
						} else {
							F_errhint(m, int32(663808), int32(0))
							mBase = m.M
							v46 = m.ExcPending
							if v46 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(496599), int32(472), int32(421691))
								mBase = m.M
								v51 = m.ExcPending
								if v51 != 0 {
									return int32(0)
				...
				default:
					...
					if v60 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12))) = base.I32_extend16_s(v50)
						F_errmsg_internal(m, int32(484686), v12)
						mBase = m.M
						v65 = m.ExcPending
						if v65 != 0 {
							return
...
func F_filter_by_origin_cb_wrapper(m *base.Module, l0 int32, l1 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+20)) = int32(277249)
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v21
	F_errmsg_internal(m, int32(480155), v8)
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L24:
	;
	F_errfinish(m, int32(500891), int32(4358), int32(308394))
	mBase = m.M
	v63 = m.ExcPending
	if v63 != 0 {
		goto L12
...
L35:
	;
	F_errsave_finish(m, l4, int32(497613), v214, int32(291522))
	mBase = m.M
	v221 = m.ExcPending
	if v221 != 0 {
		goto L39
...
L46:
	;
	F_errdetail(m, int32(648902), int32(0))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L39
...
L51:
	;
	F_errmsg(m, int32(328741), int32(0))
	mBase = m.M
	v199 = m.ExcPending
	if v199 != 0 {
		goto L39
...
L52:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v200
	F_errdetail(m, int32(655442), v12+int32(16))
	mBase = m.M
	v210 = m.ExcPending
	if v210 != 0 {
		goto L39
...
L33:
	;
	F_errmsg_internal(m, int32(274242), int32(0))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L9
...
L34:
	;
	F_errfinish(m, int32(498183), int32(5295), int32(428746))
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L9
...
L65:
	;
	F_errfinish(m, int32(498183), int32(5322), int32(428746))
	mBase = m.M
	v170 = m.ExcPending
	if v170 != 0 {
		goto L9
...
L72:
	;
	F_errfinish(m, int32(498183), int32(5329), int32(428746))
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L9
...
L75:
	;
	F_errfinish(m, int32(498183), int32(5305), int32(428746))
	mBase = m.M
	v217 = m.ExcPending
	if v217 != 0 {
		goto L9
				...
				*(*int32)(unsafe.Add(mBase, uint32(v9))) = v11
				...
				if v38 != 0 {
					...
					if v41 != 0 {
						...
						F_errfinish(m, int32(498697), int32(112), int32(316336))
						mBase = m.M
						v46 = m.ExcPending
						if v46 != 0 {
							return int32(0)
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = v39
	F_appendStringInfo(m, v11+int32(32), int32(687456), v11+int32(16))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L2
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	v119 = F_pg_snprintf(m, v114, int32(64), int32(59790), v11)
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L2
