...
func F_EvalPlanQualFetchRowMark(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.Ui32(int32(3)) < base.Ui32(v21) {
												...
												*(*uint8)(unsafe.Add(mBase, uint32(v11)+15)) = uint8(v74)
														...
														if v217 != 0 {
															...
															if v220 != 0 {
																...
																*(*int32)(unsafe.Add(mBase, uint32(v11))) = v222 + int32(4)
																F_errmsg(m, int32(719144), v11)
																mBase = m.M
																v228 = m.ExcPending
																if v228 != 0 {
																	return int32(0)
																} else {
																	F_errfinish(m, int32(496617), int32(2870), int32(315103))
																	mBase = m.M
																	v233 = m.ExcPending
																	if v233 != 0 {
																		return int32(0)
															...
															if l2 != 0 {
																...
																if v87&int32(2) == int32(0) {
																	...
																	if v95 != 0 {
																		...
																		F_errmsg_internal(m, int32(317733), int32(0))
																		mBase = m.M
																		v99 = m.ExcPending
																		if v99 != 0 {
																			return int32(0)
																		} else {
																			F_errfinish(m, int32(496617), int32(2878), int32(315103))
																			mBase = m.M
																			v104 = m.ExcPending
																			if v104 != 0 {
																				return int32(0)
												...
												if v106 != 0 {
													...
													if v108&int32(1) == int32(0) {
														...
														v116 = m.T0[v115].(func(*base.Module, int32, int32, int32, int32) int32)(m, v69, v68, int32(4173856), l2)
														mBase = m.M
														v117 = m.ExcPending
														if v117 != 0 {
															return int32(0)
															...
															if v116 != 0 {
																...
																if v121 != 0 {
																	...
																	if v125 != 0 {
																		...
																		F_errfinish(m, int32(496617), int32(2893), int32(315103))
																		mBase = m.M
																		v130 = m.ExcPending
																		if v130 != 0 {
																			return int32(0)
		...
		if v204 != 0 {
			...
			F_errmsg_internal(m, int32(153572), int32(0))
			mBase = m.M
			v208 = m.ExcPending
			if v208 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(496617), int32(2822), int32(315103))
				mBase = m.M
				v213 = m.ExcPending
				if v213 != 0 {
					return int32(0)
