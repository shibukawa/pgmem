...
L133:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v287)+28)) = int32(224563)
	*(*int32)(unsafe.Add(mBase, uint32(v287)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v287)+20)) = int32(484021)
...
L156:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v590))) = v597
	...
	F_ResourceOwnerRemember(m, v600, v597, int32(1599120))
	mBase = m.M
	v603 = m.ExcPending
	if v603 != 0 {
		goto L17
...
L160:
	...
	F_ResourceOwnerForget(m, v616, v617+int32(1), int32(1599120))
	mBase = m.M
	v622 = m.ExcPending
	if v622 != 0 {
		goto L17
