...
L372:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2595))) = v2591
	F_errmsg_internal(m, int32(42092), v2595)
	mBase = m.M
	v2625 = m.ExcPending
	if v2625 != 0 {
		goto L21
...
L373:
	;
	F_errfinish(m, int32(495358), int32(630), int32(464790))
	mBase = m.M
	v2630 = m.ExcPending
	if v2630 != 0 {
		goto L21
...
L375:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v2595)+16)) = int32(102)
	F_errmsg_internal(m, int32(41973), v2595+int32(16))
	mBase = m.M
	v2642 = m.ExcPending
	if v2642 != 0 {
		goto L21
...
L376:
	;
	F_errfinish(m, int32(495358), int32(637), int32(464790))
	mBase = m.M
	v2647 = m.ExcPending
	if v2647 != 0 {
		goto L21
