			...
			if l1 != 0 {
				...
				if v27 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = l0
					F_errmsg_internal(m, int32(51548), v8)
					mBase = m.M
					v31 = m.ExcPending
					if v31 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(491493), int32(1270), int32(374542))
						mBase = m.M
						v36 = m.ExcPending
						if v36 != 0 {
							return int32(0)
...
func F_has_language_privilege_id_id(m *base.Module, l0 int32) int32 {
	...
	if v17 != 0 {
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v9)+15)) = uint8(v18)
		v22 = F_convert_any_priv_string(m, v14, int32(1632576))
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return int32(0)
		...
		if v12 != 0 {
			...
			if v15 != 0 {
				...
				if v18 != 0 {
					...
					v20 = F_convert_any_priv_string(m, v11, int32(1632576))
					mBase = m.M
					v21 = m.ExcPending
					if v21 != 0 {
						return int32(0)
...
func F_language_handler_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(216789)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(486557), int32(368), int32(275299))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
