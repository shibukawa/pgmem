...
func F_StartupProcTriggerHandler(m *base.Module, l0 int32) {
	...
	var v6 int32
	_ = v6
	*(*int32)(unsafe.Add(mBase, _consts[626])) = int32(1)
	F_WakeupRecovery(m)
	mBase = m.M
	v6 = m.ExcPending
	if v6 != 0 {
...
func F_begin_startup_progress_phase(m *base.Module) {
	...
	var v69 int32
	_ = v69
	v5 = *(*int32)(unsafe.Add(mBase, _consts[627]))
	if v5 == int32(0) {
		return
	} else {
		...
		if v10 != 0 {
			...
			v12 = int32(0)
			*(*int32)(unsafe.Add(mBase, _consts[628])) = v12
			v15 = *(*int32)(unsafe.Add(mBase, _consts[627]))
			if v15 == v12 {
				return
			} else {
				v22 = m.G0
				...
				*(*int64)(unsafe.Add(mBase, _consts[629])) = v36
				v39 = *(*int32)(unsafe.Add(mBase, _consts[627]))
