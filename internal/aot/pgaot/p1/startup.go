...
func F_begin_startup_progress_phase(m *base.Module) {
	...
	var v69 int32
	_ = v69
	v5 = *(*int32)(unsafe.Add(mBase, _c_F_begin_startup_progress_phase[0]))
	if v5 == int32(0) {
		return
	} else {
		...
		if v10 != 0 {
			...
			v12 = int32(0)
			*(*int32)(unsafe.Add(mBase, _c_F_begin_startup_progress_phase[1])) = v12
			v15 = *(*int32)(unsafe.Add(mBase, _c_F_begin_startup_progress_phase[0]))
			if v15 == v12 {
				return
			} else {
				v22 = m.G0
				...
				*(*int64)(unsafe.Add(mBase, _c_F_begin_startup_progress_phase[2])) = v36
				v39 = *(*int32)(unsafe.Add(mBase, _c_F_begin_startup_progress_phase[0]))
				*(*int32)(unsafe.Add(mBase, _c_F_begin_startup_progress_phase[3])) = int32(0)
				v51 = m.G0
				v52 = int32(16)
				v53 = v51 - v52
				m.G0 = v53
