...
L1:
	...
	v60 = int32(*(*uint8)(unsafe.Add(mBase, _consts[734])))
	v62 = int32(*(*uint8)(unsafe.Add(mBase, _consts[735])))
...
L11:
	...
	v487 = *(*int32)(unsafe.Add(mBase, _consts[726]))
...
L25:
	;
	v145 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	v147 = *(*int32)(unsafe.Add(mBase, _consts[736]))
	if int32(0) < v147 {
		goto L31
	} else {
		goto L32
...
L27:
	;
	v124 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v81)+72)) = v125
	F_errmsg_internal(m, int32(185926), v81-int32(-64))
	mBase = m.M
	v135 = m.ExcPending
	if v135 != 0 {
		goto L5
...
L28:
	;
	F_errfinish(m, int32(521910), int32(768), int32(431704))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L5
...
L31:
	;
	v150 = int32(0)
	v152 = *(*int32)(unsafe.Add(mBase, _consts[722]))
	v156 = v150
	v157 = v145
	v162 = v147
	v164 = v150
...
L39:
	;
	v196 = *(*int32)(unsafe.Add(mBase, _consts[736]))
	v198 = *(*int32)(unsafe.Add(mBase, _consts[722]))
	v200 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	v201 = v200
	v202 = v196
	v203 = v164 + int32(1)
	v204 = v198
...
L45:
	;
	v240 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	v241 = v240
	goto L44
L46:
	;
...
L48:
	;
	v359 = *(*int32)(unsafe.Add(mBase, _consts[726]))
...
L55:
	;
	v265 = *(*int32)(unsafe.Add(mBase, _consts[722]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v81)+16)) = (v248 - v266) >> (uint(int32(7)) % 32)
	F_errmsg_internal(m, int32(498912), v81+int32(16))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L5
...
L56:
	;
	F_errfinish(m, int32(521910), int32(840), int32(431704))
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L5
...
L63:
	;
	v292 = int32(0)
	v294 = *(*int32)(unsafe.Add(mBase, _consts[722]))
...
L64:
	...
	v314 = *(*int32)(unsafe.Add(mBase, uint32(v309<<(uint(int32(2))%32))+uint32(_consts[724])))
	v315 = *(*int32)(unsafe.Add(mBase, uint32(v314)+8))
	goto L68
L65:
	;
	v307 = *(*int32)(unsafe.Add(mBase, uint32(v300<<(uint(int32(2))%32))+uint32(_consts[723])))
	v308 = v307
	goto L67
L66:
	;
...
L69:
	;
	v323 = *(*int32)(unsafe.Add(mBase, uint32(v316<<(uint(int32(2))%32))+uint32(_consts[725])))
	v324 = v323
	goto L71
L70:
	;
...
L71:
	;
	v326 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v81)+44)) = v324
	F_errmsg_internal(m, int32(111626), v81+int32(32))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L5
...
L72:
	;
	F_errfinish(m, int32(521910), int32(847), int32(431704))
	mBase = m.M
	v342 = m.ExcPending
	if v342 != 0 {
		goto L5
...
L79:
	;
	F_errmsg_internal(m, int32(185889), int32(0))
	mBase = m.M
	v429 = m.ExcPending
	if v429 != 0 {
		goto L5
...
L80:
	;
	v431 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v81)+8)) = v432
	F_errdetail_internal(m, int32(185951), v81)
	mBase = m.M
	v440 = m.ExcPending
	if v440 != 0 {
		goto L5
...
L81:
	;
	F_errfinish(m, int32(521910), int32(818), int32(431704))
	mBase = m.M
	v445 = m.ExcPending
	if v445 != 0 {
		goto L5
...
L83:
	;
	F_errmsg_internal(m, int32(373495), int32(0))
	mBase = m.M
	v453 = m.ExcPending
	if v453 != 0 {
		goto L5
...
L84:
	;
	F_errfinish(m, int32(521910), int32(881), int32(431704))
	mBase = m.M
	v458 = m.ExcPending
	if v458 != 0 {
		goto L5
...
L106:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l1))) = v549
	v555 = *(*int32)(unsafe.Add(mBase, _consts[726]))
...
L114:
	;
	F_errmsg_internal(m, int32(371969), int32(0))
	mBase = m.M
	v569 = m.ExcPending
	if v569 != 0 {
		goto L5
...
L115:
	;
	F_errfinish(m, int32(521910), int32(258), int32(380703))
	mBase = m.M
	v574 = m.ExcPending
	if v574 != 0 {
		goto L5
...
L122:
	...
	v625 = *(*int64)(unsafe.Add(mBase, uint32(v619)+uint32(_consts[729])))
	*(*int64)(unsafe.Add(mBase, uint32(v619)+uint32(_consts[729]))) = v625 + int64(1)
	v631 = *(*int64)(unsafe.Add(mBase, uint32(v619)+uint32(_consts[730])))
	*(*int64)(unsafe.Add(mBase, uint32(v619)+uint32(_consts[730]))) = v631
	v633 = int32(1)
	F_pgstat_count_backend_io_op(m, v56, v55, int32(2), v633, int64(0))
	mBase = m.M
	*(*uint8)(unsafe.Add(mBase, _consts[731])) = uint8(v633)
	*(*uint8)(unsafe.Add(mBase, _consts[732])) = uint8(v633)
	goto L129
L123:
	;
...
L129:
	;
	v643 = int32(*(*uint8)(unsafe.Add(mBase, _consts[411])))
	if v643 != int32(1) {
		goto L86
	} else {
		goto L130
...
L130:
	;
	v646 = int32(4556816)
	v648 = *(*int32)(unsafe.Add(mBase, _consts[412]))
	v650 = *(*int32)(unsafe.Add(mBase, _consts[733]))
	*(*int32)(unsafe.Add(mBase, _consts[412])) = v648 + v650
	goto L86
L131:
	;
	v656 = v653 | int32(4)
...
L138:
	;
	v793 = l0 + int32(36)
	v795 = *(*int32)(unsafe.Add(mBase, _consts[722]))
...
L161:
	;
	v841 = int32(4472676)
	v842 = *(*int32)(unsafe.Add(mBase, _consts[722]))
	...
	*(*int64)(unsafe.Add(mBase, uint32(v843+v844<<(uint(v845)%32)+v819<<(uint(v845)%32)))) = v854
	v857 = *(*int32)(unsafe.Add(mBase, _consts[722]))
...
L164:
	;
	v909 = *(*int32)(unsafe.Add(mBase, _consts[722]))
...
L169:
	;
	v963 = int32(*(*uint8)(unsafe.Add(mBase, _consts[737])))
	v966 = m.G0
	v968 = v966 - int32(16)
	m.G0 = v968
	if v963 != 0 {
...
L170:
	...
	*(*int32)(unsafe.Add(mBase, _consts[163])) = v984 + int32(1)
	...
	v994 = *(*int32)(unsafe.Add(mBase, uint32(v989*int32(80))+uint32(_consts[738])))
...
L178:
	...
	v1122 = *(*int64)(unsafe.Add(mBase, uint32(v1116)+uint32(_consts[739])))
	*(*int64)(unsafe.Add(mBase, uint32(v1116)+uint32(_consts[739]))) = v1122 + base.I64_extend_i32_u(v1000)
	v1128 = *(*int64)(unsafe.Add(mBase, uint32(v1116)+uint32(_consts[740])))
	*(*int64)(unsafe.Add(mBase, uint32(v1116)+uint32(_consts[740]))) = v1128 + v1007
	F_pgstat_count_backend_io_op(m, v56, v55, int32(6), v1000, v1007)
	mBase = m.M
	v1133 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[731])) = uint8(v1133)
	*(*uint8)(unsafe.Add(mBase, _consts[732])) = uint8(v1133)
	m.G0 = v1013 + int32(16)
	goto L175
L179:
	;
	v1071 = v56*int32(320) + v55<<(uint(int32(6))%32)
	v1077 = *(*int64)(unsafe.Add(mBase, uint32(v1071)+uint32(_consts[741])))
	*(*int64)(unsafe.Add(mBase, uint32(v1071)+uint32(_consts[741]))) = v1077 + v1024
	v1081 = *(*int32)(unsafe.Add(mBase, _consts[409]))
...
L186:
	;
	v1050 = int32(4541816)
	v1052 = *(*int64)(unsafe.Add(mBase, _consts[742]))
	v1054 = base.I64_div_s(v1024, int64(1000))
	*(*int64)(unsafe.Add(mBase, _consts[742])) = v1052 + v1054
	switch v56 {
	case 0:
		goto L188
	case 1:
...
L191:
	...
	v1100 = *(*int64)(unsafe.Add(mBase, uint32(v1094)+uint32(_consts[743])))
	*(*int64)(unsafe.Add(mBase, uint32(v1094)+uint32(_consts[743]))) = v1100 + v1024
	v1104 = int32(1)
	*(*uint8)(unsafe.Add(mBase, _consts[731])) = uint8(v1104)
	*(*uint8)(unsafe.Add(mBase, _consts[744])) = uint8(v1104)
	goto L189
L192:
	;
	v1155 = int32(*(*uint8)(unsafe.Add(mBase, _consts[411])))
	if v1155 == int32(1) {
		goto L196
	} else {
		goto L197
...
L196:
	;
	v1158 = int32(4556816)
	v1160 = *(*int32)(unsafe.Add(mBase, _consts[412]))
	v1162 = *(*int32)(unsafe.Add(mBase, _consts[745]))
	*(*int32)(unsafe.Add(mBase, _consts[412])) = v1160 + v1162*v772
	goto L198
L197:
	;
	goto L198
		...
		if v24 != 0 {
			...
			*(*int64)(unsafe.Add(mBase, uint32(v26)+16)) = v74
			...
			if v85 != 0 {
				...
				if v79 < v74-v87 {
					F_SimpleLruTruncate(m, int32(4458936), v74)
					mBase = m.M
					v92 = m.ExcPending
					if v92 != 0 {
						return
