			...
			if v56 != 0 {
				...
				if v59 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v15
					F_errmsg(m, int32(466545), v8)
					mBase = m.M
					v66 = m.ExcPending
					if v66 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(499834), int32(3325), int32(348326))
						mBase = m.M
						v71 = m.ExcPending
						if v71 != 0 {
							return int32(0)
				...
				if v33 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v8))) = v18
					...
					if v40 != 0 {
						...
						F_errfinish(m, int32(499834), int32(3392), int32(348313))
						mBase = m.M
						v45 = m.ExcPending
						if v45 != 0 {
							return int32(0)
				...
				if v63 != 0 {
					...
					if v66 != 0 {
						...
						if v70 != 0 {
							...
							F_errfinish(m, int32(499834), int32(4149), int32(560051))
							mBase = m.M
							v75 = m.ExcPending
							if v75 != 0 {
								return int32(0)
					...
					if v124 != 0 {
						...
						if v127 != 0 {
							...
							if v131 != 0 {
								...
								F_errfinish(m, int32(499834), int32(4174), int32(557839))
								mBase = m.M
								v136 = m.ExcPending
								if v136 != 0 {
									return int32(0)
					...
					if v99 != 0 {
						...
						if v102 != 0 {
							...
							if v106 != 0 {
								...
								F_errfinish(m, int32(499834), int32(4199), int32(554355))
								mBase = m.M
								v111 = m.ExcPending
								if v111 != 0 {
									return int32(0)
...
func F_bytea_substring(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if int32(0) <= l2 {
		...
		if base.B2i32(l2 < v13)^base.B2i32(v15 < l1) == v13 {
			if v15 <= int32(0) {
				v25 = F_DirectFunctionCall1Coll(m, int32(579), int32(0), int32(756936))
				v28 = m.ExcPending
				if v28 != 0 {
					return int32(0)
				} else {
		...
		if v42 != 0 {
			...
			if v45 != 0 {
				...
				if v49 != 0 {
					...
					F_errfinish(m, int32(499834), int32(3158), int32(329563))
					v54 = m.ExcPending
					if v54 != 0 {
						return int32(0)
					} else {
