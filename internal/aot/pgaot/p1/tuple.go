			...
			if v102 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14))) = l3
				...
				if v106 != 0 {
					...
					F_errfinish(m, int32(499936), int32(896), int32(12558))
					mBase = m.M
					v111 = m.ExcPending
					if v111 != 0 {
						return
...
L29:
	...
	v124 = F_AllocSetContextCreateInternal(m, v119, int32(62110), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L31:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v106)+32)) = int64(343597383684)
	v137 = F_hash_create(m, int32(399396), int32(64), v104+int32(-48), int32(1064))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L1
