...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v106)+12)) = v108
	...
	v112 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[1]))
	if v112 != 0 {
		goto L26
	} else {
		goto L27
...
L27:
	;
	v114 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[2]))
	if v114 == int32(0) {
		goto L29
	} else {
		goto L30
...
L29:
	;
	v119 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[3]))
	v124 = F_AllocSetContextCreateInternal(m, v119, int32(_a_F_apply_handle_tuple_routing_1), int32(0), int32(_a_F_apply_handle_tuple_routing_2), int32(_a_F_apply_handle_tuple_routing_3))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L1
...
L31:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v106)+32)) = int64(343597383684)
	v137 = F_hash_create(m, int32(_a_F_apply_handle_tuple_routing_4), int32(64), v104+int32(-48), int32(1064))
	mBase = m.M
	v138 = m.ExcPending
	if v138 != 0 {
		goto L1
...
L32:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[2])) = v124
	v127 = v124
	goto L31
L33:
	;
...
L34:
	;
	v144 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[1]))
	v146 = v144
	goto L28
L35:
	;
...
L38:
	;
	v177 = int32(_a_F_apply_handle_tuple_routing_0)
	v178 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0]))
	v181 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v181
	v184 = v152 + int32(52)
...
L41:
	;
	v163 = int32(_a_F_apply_handle_tuple_routing_0)
	v164 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0]))
	v167 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[2]))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v167
...
L70:
	;
	v379 = int32(_a_F_apply_handle_tuple_routing_5)
	goto L71
L71:
	;
...
L78:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v194
...
L105:
	...
	v557 = int32(*(*uint16)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[4])))
	if v555 == v557 {
		goto L103
	} else {
		goto L106
...
L113:
	;
	v586 = int32(_a_F_apply_handle_tuple_routing_0)
	v587 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0]))
	v589 = *(*int32)(unsafe.Add(mBase, uint32(v585)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v589
...
L115:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v587
	v597 = int32(0)
...
L138:
	;
	v648 = int32(_a_F_apply_handle_tuple_routing_0)
	v649 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0]))
	v651 = *(*int32)(unsafe.Add(mBase, uint32(v647)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v651
...
L140:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v649
...
L147:
	;
	v683 = int32(_a_F_apply_handle_tuple_routing_0)
	v684 = *(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0]))
	v686 = *(*int32)(unsafe.Add(mBase, uint32(v682)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v686
...
L153:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_apply_handle_tuple_routing[0])) = v684
