...
func F_BaseInit(m *base.Module) {
	...
	v7 = v5 + int32(-64)
	m.G0 = v7
	v10 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1193])))
	if v10 == int32(0) {
		goto L5
	} else {
		goto L6
...
L1:
	...
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, _consts[750])) = v105
	if v105 != 0 {
		goto L28
	} else {
		goto L29
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7)+48)) = int32(438)
	v19 = F_open(m, int32(4510320), int32(1089), v5+int32(-16))
	mBase = m.M
	if v19 < int32(0) {
		goto L4
	} else {
...
L7:
	...
	v28 = F_freopen(m, int32(4510320), int32(507583), v27)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L8
...
L12:
	...
	v42 = F_freopen(m, int32(4510320), int32(507583), v41)
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L8
...
L16:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = int32(4510320)
...
L17:
	;
	F_errfinish(m, int32(498283), int32(2132), int32(281952))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L8
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = int32(4510320)
	F_errmsg(m, int32(293788), v5+int32(-48))
	mBase = m.M
	v79 = m.ExcPending
	if v79 != 0 {
		goto L8
...
L21:
	;
	F_errfinish(m, int32(498283), int32(2143), int32(281952))
	mBase = m.M
	v84 = m.ExcPending
	if v84 != 0 {
		goto L8
...
L24:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = int32(4510320)
	F_errmsg(m, int32(292636), v5+int32(-32))
	mBase = m.M
	v97 = m.ExcPending
	if v97 != 0 {
		goto L8
...
L25:
	;
	F_errfinish(m, int32(498283), int32(2156), int32(281952))
	mBase = m.M
	v102 = m.ExcPending
	if v102 != 0 {
		goto L8
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, _consts[3])) = v163
	v167 = *(*int32)(unsafe.Add(mBase, _consts[939]))
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _consts[751])) = int32(1)
	goto L27
L32:
	;
...
L38:
	;
	F_errfinish(m, int32(499883), int32(917), int32(130476))
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L8
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, _consts[933])) = v170
...
L41:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _consts[933]))
	v179 = *(*int32)(unsafe.Add(mBase, _consts[939]))
	v180 = *(*int32)(unsafe.Add(mBase, uint32(v179)+4))
	v182 = F_dshash_attach(m, v176, int32(1652008), v180, int32(0))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L8
...
L42:
	...
	*(*int32)(unsafe.Add(mBase, _consts[932])) = v182
	v189 = *(*int32)(unsafe.Add(mBase, _consts[926]))
	v191 = v189
	v193 = int32(24)
	goto L43
L43:
...
L49:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v199)+uint32(_consts[1194]))) = v216
	v220 = *(*int32)(unsafe.Add(mBase, _consts[926]))
	v223 = v220
	goto L45
L50:
	;
...
L54:
	;
	v254 = v230*int32(72) + int32(1651040)
	goto L56
L55:
	;
...
L70:
	;
	v288 = *(*int32)(unsafe.Add(mBase, _consts[717]))
	v289 = *(*int32)(unsafe.Add(mBase, uint32(v288)+4))
	*(*int32)(unsafe.Add(mBase, _consts[721])) = v289 + v280*int32(164)
	v295 = *(*int32)(unsafe.Add(mBase, _consts[722]))
...
L76:
	;
	F_errmsg_internal(m, int32(544360), int32(0))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L8
...
L77:
	;
	F_errfinish(m, int32(493349), int32(227), int32(427064))
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L8
...
L82:
	...
	v337 = F_AllocSetContextCreateInternal(m, v332, int32(60216), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L8
...
L85:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1196])) = v351
...
L87:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v380)+16)) = int64(34359738372)
	v421 = F_hash_create(m, int32(87868), int32(100), v380, int32(40))
	mBase = m.M
	v422 = m.ExcPending
	if v422 != 0 {
		goto L8
...
L90:
	;
	v436 = *(*int32)(unsafe.Add(mBase, _consts[1199]))
	if v436 == int32(0) {
		goto L91
	} else {
		goto L92
...
L91:
	...
	v446 = F_AllocSetContextCreateInternal(m, v441, int32(251098), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v447 = m.ExcPending
	if v447 != 0 {
		goto L8
...
L94:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1199])) = v446
	v449 = v446
	goto L93
L95:
	;
...
L99:
	;
	v468 = *(*int32)(unsafe.Add(mBase, _consts[1199]))
...
L101:
	;
	v479 = *(*int32)(unsafe.Add(mBase, _consts[1200]))
	if v479 == int32(0) {
		goto L103
	} else {
		goto L104
...
L103:
	;
	v484 = *(*int32)(unsafe.Add(mBase, _consts[1199]))
...
L105:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v491)+16)) = int64(240518168596)
	v499 = F_hash_create(m, int32(323533), int32(16), v491, int32(40))
	mBase = m.M
	v500 = m.ExcPending
	if v500 != 0 {
		goto L8
...
L106:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1200])) = v486
	goto L105
L107:
	;
