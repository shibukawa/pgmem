...
L1:
	...
	mBase = m.M
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[1])) = v105
	if v105 != 0 {
		goto L28
	} else {
		goto L29
...
L12:
	;
	v41 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[4]))
	v42 = F_freopen(m, int32(_a_F_BaseInit_0), int32(_a_F_BaseInit_1), v41)
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L8
...
L27:
	;
	v159 = int32(_a_F_BaseInit_7)
	v160 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[5]))
	v163 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[6]))
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[5])) = v163
	v167 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[7]))
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[8])) = int32(1)
	goto L27
L32:
	;
...
L40:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[9])) = v170
...
L41:
	;
	v176 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[9]))
	v179 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[7]))
	v180 = *(*int32)(unsafe.Add(mBase, uint32(v179)+4))
	v182 = F_dshash_attach(m, v176, int32(_a_F_BaseInit_12), v180, int32(0))
	mBase = m.M
	v183 = m.ExcPending
	if v183 != 0 {
		goto L8
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[5])) = v160
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[10])) = v182
	v189 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[11]))
	v191 = v189
	v193 = int32(24)
	goto L43
L43:
...
L48:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[6]))
...
L49:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v199)+uint32(_c_F_BaseInit[12]))) = v216
	v220 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[11]))
	v223 = v220
	goto L45
L50:
	;
...
L54:
	;
	v254 = v230*int32(72) + int32(_a_F_BaseInit_13)
	goto L56
L55:
	;
...
L57:
	;
	v244 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[11]))
	if v244 == int32(0) {
		goto L53
	} else {
		goto L58
...
L63:
	;
	v272 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[13]))
	if v272 != int32(12) {
		goto L66
	} else {
		goto L67
...
L64:
	...
	v320 = v318 - int32(48)
	m.G0 = v320
	v323 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_BaseInit[3])))
	if v323 == int32(1) {
		goto L80
	} else {
		goto L81
...
L66:
	;
	v276 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[14]))
	if v276 == int32(0) {
		goto L65
	} else {
		goto L69
...
L69:
	;
	v280 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[15]))
	v282 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[16]))
...
L70:
	;
	v288 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[17]))
	v289 = *(*int32)(unsafe.Add(mBase, uint32(v288)+4))
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[18])) = v289 + v280*int32(164)
	v295 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[19]))
...
L79:
	;
	m.G0 = v320 + int32(48)
	v361 = int32(_a_F_BaseInit_17)
	v363 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[20]))
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[20])) = v363 + int32(1)
	F_mdinit(m)
	mBase = m.M
	v368 = m.ExcPending
	if v368 != 0 {
...
L80:
	;
	v327 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[13]))
	if v327 != int32(11) {
		goto L79
	} else {
		goto L83
...
L82:
	;
	v332 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[6]))
	v337 = F_AllocSetContextCreateInternal(m, v332, int32(_a_F_BaseInit_18), int32(0), int32(_a_F_BaseInit_19), int32(_a_F_BaseInit_20))
	mBase = m.M
	v338 = m.ExcPending
	if v338 != 0 {
		goto L8
...
L84:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[21])) = v337
	v340 = int32(1)
	*(*uint8)(unsafe.Add(mBase, uint32(v337)+5)) = uint8(v340)
	*(*int64)(unsafe.Add(mBase, uint32(v320)+16)) = int64(137438953496)
	v345 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[21]))
	*(*int32)(unsafe.Add(mBase, uint32(v320)+40)) = v345
	v351 = F_hash_create(m, int32(_a_F_BaseInit_21), int32(100), v320, int32(1064))
	mBase = m.M
	v352 = m.ExcPending
	if v352 != 0 {
		goto L8
...
L85:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[22])) = v351
...
L87:
	...
	m.G0 = v380
	v383 = int64(0)
	*(*int64)(unsafe.Add(mBase, _c_F_BaseInit[24])) = v383
	*(*int64)(unsafe.Add(mBase, _c_F_BaseInit[25])) = v383
	*(*int64)(unsafe.Add(mBase, _c_F_BaseInit[26])) = v383
	...
	*(*int64)(unsafe.Add(mBase, _c_F_BaseInit[31])) = v383
	v408 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[32]))
	v410 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[16]))
	v413 = base.I32_div_s(v408, v410+int32(38))
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[33])) = v413
	*(*int64)(unsafe.Add(mBase, uint32(v380)+16)) = int64(34359738372)
	v421 = F_hash_create(m, int32(_a_F_BaseInit_22), int32(100), v380, int32(40))
	mBase = m.M
	v422 = m.ExcPending
	if v422 != 0 {
		goto L8
...
L90:
	;
	v436 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[35]))
	if v436 == int32(0) {
		goto L91
	} else {
		goto L92
...
L91:
	;
	v441 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[6]))
	v446 = F_AllocSetContextCreateInternal(m, v441, int32(_a_F_BaseInit_23), int32(0), int32(_a_F_BaseInit_19), int32(_a_F_BaseInit_20))
	mBase = m.M
	v447 = m.ExcPending
	if v447 != 0 {
		goto L8
...
L93:
	;
	v451 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[36]))
	if v451 == int32(0) {
		goto L95
	} else {
		goto L96
...
L94:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[35])) = v446
	v449 = v446
	goto L93
L95:
	;
	v455 = F_MemoryContextAllocZero(m, v449, int32(_a_F_BaseInit_24))
	mBase = m.M
	v456 = m.ExcPending
	if v456 != 0 {
		goto L8
...
L97:
	;
	v464 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[37]))
	if v464 == int32(0) {
		goto L99
	} else {
		goto L100
...
L98:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[38])) = int32(5)
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[36])) = v455
	goto L97
L99:
	;
	v468 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[35]))
...
L101:
	;
	v479 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[39]))
	if v479 == int32(0) {
		goto L103
	} else {
		goto L104
...
L102:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[40])) = int32(20)
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[37])) = v470
	goto L101
L103:
	;
	v484 = *(*int32)(unsafe.Add(mBase, _c_F_BaseInit[35]))
...
L105:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v491)+16)) = int64(240518168596)
	v499 = F_hash_create(m, int32(_a_F_BaseInit_25), int32(16), v491, int32(40))
	mBase = m.M
	v500 = m.ExcPending
	if v500 != 0 {
		goto L8
...
L106:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_BaseInit[39])) = v486
	goto L105
L107:
	;
