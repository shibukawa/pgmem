...
L2:
	;
	v22 = int32(_a_F_tuplesort_begin_heap_0)
	v23 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0]))
	v25 = *(*int32)(unsafe.Add(mBase, uint32(v18)+24))
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0])) = v25
	v28 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[1])))
	if v28 != int32(1) {
		goto L3
	} else {
		goto L4
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v18)+8)) = int32(1835)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+16)) = int32(1836)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+12)) = int32(1837)
	*(*int32)(unsafe.Add(mBase, uint32(v18)+4)) = int32(1838)
	*(*int32)(unsafe.Add(mBase, uint32(v18))) = int32(1839)
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0])) = v23
	m.G0 = v15 + int32(16)
	return v18
L14:
	;
	v75 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0]))
...
L19:
	...
	v108 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0]))
...
func F_tuplesort_begin_index_brin(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v12 != 0 {
		...
		if v14 != int32(1) {
			*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = int32(1853)
			v36 = int32(1)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9)+16)) = int32(1854)
			*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = int32(1855)
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(1856)
			m.G0 = v6 + int32(16)
			return v9
		} else {
