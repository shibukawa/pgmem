...
func F_tuplesort_begin_batch(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _consts[3])) = v9
	...
	if v12&int32(2) == int32(0) {
		v19 = F_BumpContextCreate(m, v11, int32(154543), int32(8388608))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return
						...
						if v68 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _consts[3])) = v7
							...
							if v72 != 0 {
								...
								F_errmsg_internal(m, int32(74879), int32(0))
								mBase = m.M
								v76 = m.ExcPending
								if v76 != 0 {
									return
								} else {
									F_errfinish(m, int32(470053), int32(811), int32(309637))
									mBase = m.M
									v81 = m.ExcPending
									if v81 != 0 {
										return
		...
		v25 = F_AllocSetContextCreateInternal(m, v11, int32(154543), int32(0), int32(8192), int32(8388608))
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
...
L9:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+8)) = v43
	F_errmsg_internal(m, int32(478734), v15)
	mBase = m.M
	v47 = m.ExcPending
	if v47 != 0 {
		goto L1
...
L10:
	;
	F_errfinish(m, int32(470780), int32(199), int32(226576))
	mBase = m.M
	v52 = m.ExcPending
	if v52 != 0 {
		goto L1
			...
			if v20 != 0 {
				...
				if v19 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = int32(102)
					F_errmsg_internal(m, int32(478529), v6)
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(470780), int32(567), int32(261988))
						mBase = m.M
						v33 = m.ExcPending
						if v33 != 0 {
							return int32(0)
					...
					if v43 == int32(0) {
						...
						if v53 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v59
							F_errmsg_internal(m, int32(193582), v7+int32(-32))
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return
								...
								v88 = int32(923)
								F_errfinish(m, int32(470053), v88, int32(391045))
								mBase = m.M
								v91 = m.ExcPending
								if v91 != 0 {
									return
					...
					if v43 == int32(0) {
						...
						if v74 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v80
							F_errmsg_internal(m, int32(193631), v9)
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return
	...
	default:
		...
		if v22 != 0 {
			...
			if v26 != 0 {
				...
				F_errfinish(m, int32(470053), int32(2424), int32(270491))
				mBase = m.M
				v31 = m.ExcPending
				if v31 != 0 {
					return
...
L14:
	;
	F_errmsg_internal(m, int32(75161), int32(0))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L13
...
L15:
	;
	F_errfinish(m, int32(470053), int32(1739), int32(154211))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L13
...
L32:
	;
	F_errfinish(m, int32(470053), int32(1766), int32(154211))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L13
