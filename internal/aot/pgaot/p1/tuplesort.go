...
func F_tuplesort_begin_batch(m *base.Module, l0 int32) {
	...
	var v82 int32
	_ = v82
	v6 = int32(_a_F_tuplesort_begin_batch_0)
	v7 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_batch[0]))
	v9 = *(*int32)(unsafe.Add(mBase, uint32(l0)+24))
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_batch[0])) = v9
	v11 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	v12 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+52)))
	if v12&int32(2) == int32(0) {
		v19 = F_BumpContextCreate(m, v11, int32(_a_F_tuplesort_begin_batch_1), int32(_a_F_tuplesort_begin_batch_2))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return
			...
			if v42 != 0 {
				if v41 == int32(1024) {
					...
					if int64(0) <= v65 {
						...
						*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_batch[0])) = v7
						return
					} else {
						...
						if v68 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_batch[0])) = v7
							...
							if v72 != 0 {
								...
								F_errmsg_internal(m, int32(_a_F_tuplesort_begin_batch_3), int32(0))
								mBase = m.M
								v76 = m.ExcPending
								if v76 != 0 {
									return
					...
					if v46 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(l0)+132)) = int32(0)
						v54 = int32(_a_F_tuplesort_begin_batch_6)
						v55 = F_palloc(m, v54)
						mBase = m.M
						v56 = m.ExcPending
						if v56 != 0 {
		...
		v25 = F_AllocSetContextCreateInternal(m, v11, int32(_a_F_tuplesort_begin_batch_1), int32(0), int32(_a_F_tuplesort_begin_batch_7), int32(_a_F_tuplesort_begin_batch_2))
		mBase = m.M
		v26 = m.ExcPending
		if v26 != 0 {
			return
...
func F_tuplesort_begin_heap(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) int32 {
	...
	v15 = v13 - int32(16)
	m.G0 = v15
	v17 = F_tuplesort_begin_common(m, l6, l7, l8)
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		goto L1
...
L2:
	;
	v21 = int32(_a_F_tuplesort_begin_heap_0)
	v22 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0]))
	v24 = *(*int32)(unsafe.Add(mBase, uint32(v17)+24))
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0])) = v24
	v27 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[1])))
	if v27 != int32(1) {
		goto L3
	} else {
		goto L4
...
L3:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v17)+8)) = int32(1836)
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17)+16)) = int32(1837)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+12)) = int32(1838)
	*(*int32)(unsafe.Add(mBase, uint32(v17)+4)) = int32(1839)
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = int32(1840)
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v15)+8)) = v42
	F_errmsg_internal(m, int32(_a_F_tuplesort_begin_heap_1), v15)
	mBase = m.M
	v46 = m.ExcPending
	if v46 != 0 {
		goto L1
...
L12:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v17)+44)) = v68
	if l1 <= int32(0) {
		goto L13
	} else {
		goto L14
...
L13:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0])) = v22
	m.G0 = v15 + int32(16)
	return v17
L14:
	;
	v74 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v68))) = v74
	v76 = *(*int32)(unsafe.Add(mBase, uint32(l4)))
	*(*int32)(unsafe.Add(mBase, uint32(v68)+4)) = v76
	v78 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l5))))
	*(*uint8)(unsafe.Add(mBase, uint32(v68)+9)) = uint8(v78)
	v80 = int32(*(*uint16)(unsafe.Add(mBase, uint32(l2))))
	*(*uint16)(unsafe.Add(mBase, uint32(v68)+10)) = uint16(v80)
	v82 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v17)+36)))
	*(*uint8)(unsafe.Add(mBase, uint32(v68)+20)) = uint8(v82)
	v84 = *(*int32)(unsafe.Add(mBase, uint32(l3)))
	F_PrepareSortSupportFromOrderingOp(m, v84, v68)
	mBase = m.M
	v86 = m.ExcPending
	if v86 != 0 {
		goto L1
...
L19:
	;
	v102 = *(*int32)(unsafe.Add(mBase, uint32(v17)+44))
	v105 = v102 + v98*int32(36)
	v107 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_begin_heap[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v105))) = v107
	v110 = v98 << (uint(int32(2)) % 32)
	v112 = *(*int32)(unsafe.Add(mBase, uint32(l4+v110)))
	*(*int32)(unsafe.Add(mBase, uint32(v105)+4)) = v112
	v115 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l5+v98))))
	*(*uint8)(unsafe.Add(mBase, uint32(v105)+9)) = uint8(v115)
	v120 = int32(*(*uint16)(unsafe.Add(mBase, uint32(l2+v98<<(uint(int32(1))%32)))))
	v121 = int32(0)
...
L23:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v17)+48)) = v131
	goto L13
}
			...
			if v20 != 0 {
				...
				if v19 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+4)) = int32(102)
					F_errmsg_internal(m, int32(_a_F_tuplesort_begin_index_brin_0), v6)
					mBase = m.M
					v28 = m.ExcPending
					if v28 != 0 {
						return int32(0)
...
func F_tuplesort_free(m *base.Module, l0 int32) {
	...
	v9 = v7 + int32(-64)
	m.G0 = v9
	v11 = int32(_a_F_tuplesort_free_0)
	v12 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_free[0]))
	v14 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_free[0])) = v14
	...
	if v16 == int32(0) {
		...
		v35 = v25
		v37 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_tuplesort_free[1])))
		if v37 != int32(1) {
			...
			if v94 != 0 {
				...
				if v96 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_free[0])) = v12
					...
					if v43 == int32(0) {
						...
						if v53 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+36)) = v49
							if v48 != 0 {
								v59 = int32(_a_F_tuplesort_free_1)
							} else {
								v59 = int32(_a_F_tuplesort_free_2)
							}
							*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v59
							F_errmsg_internal(m, int32(_a_F_tuplesort_free_3), v7+int32(-32))
							mBase = m.M
							v65 = m.ExcPending
							if v65 != 0 {
								return
					...
					if v43 == int32(0) {
						...
						if v74 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v9)+4)) = v70
							if v69 != 0 {
								v80 = int32(_a_F_tuplesort_free_6)
							} else {
								v80 = int32(_a_F_tuplesort_free_7)
							}
							*(*int32)(unsafe.Add(mBase, uint32(v9))) = v80
							F_errmsg_internal(m, int32(_a_F_tuplesort_free_8), v9)
							mBase = m.M
							v84 = m.ExcPending
							if v84 != 0 {
								return
...
func F_tuplesort_putdatum(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_putdatum[0])) = v15
	if v3 == v4 {
...
func F_tuplesort_rescan(m *base.Module, l0 int32) {
	...
	var v36 int32
	_ = v36
	v3 = int32(_a_F_tuplesort_rescan_0)
	v4 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_rescan[0]))
	v6 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_rescan[0])) = v6
	...
	case 0:
		...
		*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_rescan[0])) = v4
		return
	case 1:
	...
	default:
		...
		if v22 != 0 {
			...
			F_errmsg_internal(m, int32(_a_F_tuplesort_rescan_1), int32(0))
			mBase = m.M
			v26 = m.ExcPending
			if v26 != 0 {
				return
...
L6:
	;
	v49 = int32(_a_F_tuplesort_skiptuples_0)
	v50 = *(*int32)(unsafe.Add(mBase, _c_F_tuplesort_skiptuples[0]))
	v52 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
	*(*int32)(unsafe.Add(mBase, _c_F_tuplesort_skiptuples[0])) = v52
	if int64(0) < l1 {
		goto L17
	} else {
		goto L18
...
L14:
	;
	F_errmsg_internal(m, int32(_a_F_tuplesort_skiptuples_1), int32(0))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L13
