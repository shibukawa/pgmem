		...
		if v23 != 0 {
			...
			if v26 == int32(1) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v25
				v37 = F_pg_snprintf(m, v7+int32(48), int32(1024), int32(510059), v7+int32(16))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return
					...
					if v52 != 0 {
						...
						if v51 != 0 {
							*(*int32)(unsafe.Add(mBase, uint32(v7))) = v7 + int32(48)
							F_errmsg_internal(m, int32(716989), v7)
							mBase = m.M
							v58 = m.ExcPending
							if v58 != 0 {
								return
							} else {
								F_errfinish(m, int32(492665), int32(1518), int32(95380))
								mBase = m.M
								v63 = m.ExcPending
								if v63 != 0 {
									return
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+32)) = v25
				v47 = F_pg_snprintf(m, v7+int32(48), int32(1024), int32(510446), v7+int32(32))
				mBase = m.M
				v48 = m.ExcPending
				if v48 != 0 {
					return
