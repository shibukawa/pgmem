...
L47:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[614]))
	if v106 == v110 {
		goto L5
	} else {
		goto L48
...
L50:
	;
	F_errmsg_internal(m, int32(295867), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L12
...
L51:
	;
	F_errfinish(m, int32(522059), int32(1292), int32(296101))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L12
...
L121:
	...
	v437 = F_AllocSetContextCreateInternal(m, v432, int32(17280), int32(0), int32(1024), int32(8388608))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L20
...
L186:
	;
	F_errfinish(m, int32(522059), int32(860), int32(17356))
	mBase = m.M
	v530 = m.ExcPending
	if v530 != 0 {
		goto L20
