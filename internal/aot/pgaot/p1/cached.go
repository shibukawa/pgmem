...
L17:
	;
	v61 = *(*int32)(unsafe.Add(mBase, _consts[1165]))
	switch v61 - int32(1) {
	case 0:
		goto L15
	case 1:
...
L47:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _consts[612]))
	if v106 == v110 {
		goto L5
	} else {
		goto L48
...
L51:
	;
	F_errfinish(m, int32(499360), int32(1292), int32(283754))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L12
...
L121:
	;
	v393 = *(*int32)(unsafe.Add(mBase, _consts[1165]))
	switch v393 - int32(1) {
	case 0:
		v502 = v355
		v503 = v353
...
L157:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v504)+28)) = v520 + int32(1)
	F_ResourceOwnerRemember(m, l2, v504, int32(1739180))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L12
...
L29:
	...
	v71 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1166])))
	if v69 != v71 {
		goto L24
	} else {
		goto L30
...
L121:
	...
	v437 = F_AllocSetContextCreateInternal(m, v432, int32(17153), int32(0), int32(1024), int32(8388608))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L20
...
L165:
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v452
	v455 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1166])))
...
L186:
	;
	F_errfinish(m, int32(499360), int32(860), int32(17229))
	mBase = m.M
	v530 = m.ExcPending
	if v530 != 0 {
		goto L20
