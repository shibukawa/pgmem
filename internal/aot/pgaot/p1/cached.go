...
L50:
	;
	F_errmsg_internal(m, int32(282593), int32(0))
	mBase = m.M
	v126 = m.ExcPending
	if v126 != 0 {
		goto L12
...
L51:
	;
	F_errfinish(m, int32(497399), int32(1292), int32(282827))
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L12
...
L121:
	...
	v437 = F_AllocSetContextCreateInternal(m, v432, int32(17140), int32(0), int32(1024), int32(8388608))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L20
...
L186:
	;
	F_errfinish(m, int32(497399), int32(860), int32(17216))
	mBase = m.M
	v530 = m.ExcPending
	if v530 != 0 {
		goto L20
