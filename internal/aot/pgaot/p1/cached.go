...
L64:
	;
	v184 = *(*int32)(unsafe.Add(mBase, _c_F_GetCachedPlan[1]))
...
L121:
	;
	v393 = *(*int32)(unsafe.Add(mBase, _c_F_GetCachedPlan[2]))
	switch v393 - int32(1) {
	case 0:
		v502 = v355
		v503 = v353
...
L143:
	;
	v435 = *(*float64)(unsafe.Add(mBase, _c_F_GetCachedPlan[0]))
...
L157:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v504)+28)) = v520 + int32(1)
	F_ResourceOwnerRemember(m, l2, v504, int32(_a_F_GetCachedPlan_3))
	mBase = m.M
	v526 = m.ExcPending
	if v526 != 0 {
		goto L12
...
L161:
	...
	v538 = *(*int32)(unsafe.Add(mBase, _c_F_GetCachedPlan[1]))
...
L28:
	;
	v66 = *(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[0]))
...
L29:
	...
	v71 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[1])))
	if v69 != v71 {
		goto L24
	} else {
		goto L30
...
L88:
	;
	v238 = *(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[2]))
...
L121:
	;
	v432 = *(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3]))
	v437 = F_AllocSetContextCreateInternal(m, v432, int32(_a_F_RevalidateCachedQuery_0), int32(0), int32(1024), int32(_a_F_RevalidateCachedQuery_1))
	mBase = m.M
	v438 = m.ExcPending
	if v438 != 0 {
		goto L20
...
L138:
	;
	v335 = int32(_a_F_RevalidateCachedQuery_2)
	v336 = *(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3]))
	v338 = *(*int32)(unsafe.Add(mBase, uint32(l0)+56))
	*(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3])) = v338
	v413 = v336
	v417 = int32(0)
	goto L122
L139:
...
L157:
	;
	v403 = int32(_a_F_RevalidateCachedQuery_2)
	v404 = *(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3]))
	v406 = *(*int32)(unsafe.Add(mBase, uint32(l0)+56))
	*(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3])) = v406
...
L161:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3])) = v413
	goto L121
L162:
	;
	goto L161
L163:
	;
	v439 = int32(_a_F_RevalidateCachedQuery_2)
	v440 = *(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3])) = v437
...
L165:
	;
	v452 = *(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[0]))
	*(*int32)(unsafe.Add(mBase, uint32(l0)+80)) = v452
	v455 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[1])))
...
L166:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_RevalidateCachedQuery[3])) = v440
