	...
	if l1 == int32(0) {
		...
		if v29 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
			F_errmsg_internal(m, int32(38670), v6)
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(479843), int32(2571), int32(303831))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return int32(0)
...
func F_add_row_identity_columns(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
				...
				if v28 != 0 {
					...
					if v22 == int32(2) {
						...
						if v45 != 0 {
							...
							F_add_row_identity_var(m, l0, v44, l1, int32(28682))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return
	...
	case 7, 10, 12:
		...
		if v17 != 0 {
			...
			F_add_row_identity_var(m, l0, v16, l1, int32(417922))
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return
...
L12:
	;
	F_errmsg(m, int32(140597), int32(0))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L10
...
L17:
	;
	F_errfinish(m, int32(481466), int32(1074), int32(30364))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L10
...
L82:
	;
	F_errhint(m, int32(527754), int32(0))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L10
...
L84:
	;
	F_errfinish(m, int32(481466), int32(1096), int32(30364))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L10
