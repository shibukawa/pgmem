	...
	if l1 == int32(0) {
		...
		if v29 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
			F_errmsg_internal(m, int32(42774), v6)
			mBase = m.M
			v33 = m.ExcPending
			if v33 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(519072), int32(2571), int32(329295))
				mBase = m.M
				v38 = m.ExcPending
				if v38 != 0 {
					return int32(0)
...
func F_add_row_identity_columns(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) {
				...
				if v28 != 0 {
					...
					if v22 == int32(2) {
						...
						if v45 != 0 {
							...
							F_add_row_identity_var(m, l0, v44, l1, int32(31363))
							mBase = m.M
							v48 = m.ExcPending
							if v48 != 0 {
								return
	...
	case 7, 10, 12:
		...
		if v17 != 0 {
			...
			F_add_row_identity_var(m, l0, v16, l1, int32(452292))
			mBase = m.M
			v20 = m.ExcPending
			if v20 != 0 {
				return
...
L12:
	;
	F_errmsg(m, int32(155959), int32(0))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L10
...
L17:
	;
	F_errfinish(m, int32(521177), int32(1074), int32(33126))
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L10
...
L29:
	;
	F_errmsg(m, int32(154326), int32(0))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L10
...
L82:
	;
	F_errhint(m, int32(570109), int32(0))
	mBase = m.M
	v222 = m.ExcPending
	if v222 != 0 {
		goto L10
...
L84:
	;
	F_errfinish(m, int32(521177), int32(1096), int32(33126))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		goto L10
