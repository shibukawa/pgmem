...
L32:
	...
	v119 = *(*int32)(unsafe.Add(mBase, _c_F_ExpandColumnRefStar[0]))
	...
	if v18 != 0 {
		...
		if v23 != 0 {
			...
			*(*uint8)(unsafe.Add(mBase, uint32(v10)+15)) = uint8(v24)
			if v12&int32(_a_F_has_column_privilege_id_attnum_1) == v24 {
				v44 = int32(1)
					...
					if v28 != 0 {
						...
						if v34 != 0 {
							...
							if v36 != 0 {
								...
								v38 = F_convert_any_priv_string(m, v23, int32(_a_F_has_column_privilege_id_name_name_0))
								mBase = m.M
								v39 = m.ExcPending
								if v39 != 0 {
									return int32(0)
	...
	if v17 != 0 {
		...
		if v20 != 0 {
			...
			if v23 != 0 {
				...
				v25 = *(*int32)(unsafe.Add(mBase, _c_F_has_column_privilege_name_name[0]))
					...
					if v29 != 0 {
						...
						if v35 != 0 {
							...
							if v37 != 0 {
								...
								v39 = F_convert_any_priv_string(m, v22, int32(_a_F_has_column_privilege_name_name_0))
								mBase = m.M
								v40 = m.ExcPending
								if v40 != 0 {
									return int32(0)
...
L47:
	...
	v40 = int32(_a_F_transformColumnDefinition_0)
	v43 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformColumnDefinition[0])))
...
L57:
	...
	v71 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformColumnDefinition[1])))
...
L66:
	;
	v96 = int32(23)
	v97 = int32(_a_F_transformColumnDefinition_2)
	v100 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformColumnDefinition[2])))
...
L75:
	;
	v125 = int32(_a_F_transformColumnDefinition_3)
	v128 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformColumnDefinition[3])))
...
L84:
	;
	v153 = int32(20)
	v154 = int32(_a_F_transformColumnDefinition_4)
	v157 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformColumnDefinition[4])))
...
L93:
	;
	v182 = int32(_a_F_transformColumnDefinition_5)
	v185 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_transformColumnDefinition[5])))
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v277))) = int32(73)
	v282 = F_SystemTypeName(m, int32(_a_F_transformColumnDefinition_6))
	mBase = m.M
	v283 = m.ExcPending
	if v283 != 0 {
		goto L1
...
L117:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v277)+8)) = v282
	v289 = F_SystemFuncName(m, int32(_a_F_transformColumnDefinition_7))
	mBase = m.M
	v290 = m.ExcPending
	if v290 != 0 {
		goto L1
...
L290:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+176)) = v892
	F_errmsg(m, int32(_a_F_transformColumnDefinition_13), v22+int32(176))
	mBase = m.M
	v901 = m.ExcPending
	if v901 != 0 {
		goto L1
...
L309:
	;
	F_errmsg_internal(m, int32(_a_F_transformColumnDefinition_15), int32(0))
	mBase = m.M
	v963 = m.ExcPending
	if v963 != 0 {
		goto L1
...
L316:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22))) = v991
	F_errmsg_internal(m, int32(_a_F_transformColumnDefinition_16), v22)
	mBase = m.M
	v995 = m.ExcPending
	if v995 != 0 {
		goto L1
...
L327:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+32)) = v1045
	F_errmsg(m, int32(_a_F_transformColumnDefinition_17), v22+int32(32))
	mBase = m.M
	v1054 = m.ExcPending
	if v1054 != 0 {
		goto L1
...
L332:
	;
	F_errmsg(m, int32(_a_F_transformColumnDefinition_18), int32(0))
	mBase = m.M
	v1074 = m.ExcPending
	if v1074 != 0 {
		goto L1
...
L338:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+240)) = v1093
	F_errmsg(m, int32(_a_F_transformColumnDefinition_19), v22+int32(240))
	mBase = m.M
	v1100 = m.ExcPending
	if v1100 != 0 {
		goto L1
...
L340:
	;
	F_errfinish(m, int32(_a_F_transformColumnDefinition_9), int32(4067), int32(_a_F_transformColumnDefinition_20))
	mBase = m.M
	v1110 = m.ExcPending
	if v1110 != 0 {
		goto L1
...
L342:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+224)) = v1115
	F_errmsg_internal(m, int32(_a_F_transformColumnDefinition_21), v22+int32(224))
	mBase = m.M
	v1121 = m.ExcPending
	if v1121 != 0 {
		goto L1
...
L346:
	;
	F_errmsg(m, int32(_a_F_transformColumnDefinition_22), int32(0))
	mBase = m.M
	v1137 = m.ExcPending
	if v1137 != 0 {
		goto L1
...
L400:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+128)) = v1356
	F_errmsg(m, int32(_a_F_transformColumnDefinition_13), v22+int32(128))
	mBase = m.M
	v1365 = m.ExcPending
	if v1365 != 0 {
		goto L1
...
L405:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+80)) = v1382
	F_errmsg(m, int32(_a_F_transformColumnDefinition_30), v22+int32(80))
	mBase = m.M
	v1388 = m.ExcPending
	if v1388 != 0 {
		goto L1
...
L408:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+112)) = v1398
	F_errmsg_internal(m, int32(_a_F_transformColumnDefinition_31), v22+int32(112))
	mBase = m.M
	v1406 = m.ExcPending
	if v1406 != 0 {
		goto L1
...
L412:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+96)) = v1419
	F_errmsg(m, int32(_a_F_transformColumnDefinition_30), v22+int32(96))
	mBase = m.M
	v1425 = m.ExcPending
	if v1425 != 0 {
		goto L1
...
L416:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+144)) = v1438
	F_errmsg(m, int32(_a_F_transformColumnDefinition_32), v22+int32(144))
	mBase = m.M
	v1447 = m.ExcPending
	if v1447 != 0 {
		goto L1
...
L421:
	;
	F_errmsg(m, int32(_a_F_transformColumnDefinition_33), int32(0))
	mBase = m.M
	v1467 = m.ExcPending
	if v1467 != 0 {
		goto L1
...
L429:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+160)) = v1496
	F_errmsg(m, int32(_a_F_transformColumnDefinition_35), v22+int32(160))
	mBase = m.M
	v1505 = m.ExcPending
	if v1505 != 0 {
		goto L1
...
L434:
	;
	F_errmsg(m, int32(_a_F_transformColumnDefinition_36), int32(0))
	mBase = m.M
	v1525 = m.ExcPending
	if v1525 != 0 {
		goto L1
...
L438:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+192)) = v1538
	F_errmsg(m, int32(_a_F_transformColumnDefinition_37), v22+int32(192))
	mBase = m.M
	v1547 = m.ExcPending
	if v1547 != 0 {
		goto L1
...
L443:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+208)) = v1564
	F_errmsg(m, int32(_a_F_transformColumnDefinition_13), v22+int32(208))
	mBase = m.M
	v1573 = m.ExcPending
	if v1573 != 0 {
		goto L1
...
L448:
	;
	F_errmsg(m, int32(_a_F_transformColumnDefinition_38), int32(0))
	mBase = m.M
	v1593 = m.ExcPending
	if v1593 != 0 {
		goto L1
...
L458:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+64)) = v1630
	F_errmsg(m, int32(_a_F_transformColumnDefinition_40), v22-int32(-64))
	mBase = m.M
	v1639 = m.ExcPending
	if v1639 != 0 {
		goto L1
...
L463:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+48)) = v1656
	F_errmsg(m, int32(_a_F_transformColumnDefinition_41), v22+int32(48))
	mBase = m.M
	v1665 = m.ExcPending
	if v1665 != 0 {
		goto L1
...
L468:
	;
	F_errmsg(m, int32(_a_F_transformColumnDefinition_42), int32(0))
	mBase = m.M
	v1687 = m.ExcPending
	if v1687 != 0 {
		goto L1
...
L473:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v22)+16)) = v1704
	F_errmsg(m, int32(_a_F_transformColumnDefinition_13), v22+int32(16))
	mBase = m.M
	v1713 = m.ExcPending
	if v1713 != 0 {
		goto L1
