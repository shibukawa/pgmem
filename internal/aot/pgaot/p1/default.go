...
L20:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+16)) = int32(523507)
	F_errmsg(m, int32(186197), v14+int32(16))
	mBase = m.M
	v66 = m.ExcPending
	if v66 != 0 {
		goto L1
...
L21:
	;
	F_errfinish(m, int32(497029), int32(1212), int32(533016))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L1
...
L27:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v14)+32)) = int32(521898)
	F_errmsg(m, int32(186197), v14+int32(32))
	mBase = m.M
	v90 = m.ExcPending
	if v90 != 0 {
		goto L1
...
L28:
	;
	F_errfinish(m, int32(497029), int32(1223), int32(533016))
	mBase = m.M
	v95 = m.ExcPending
	if v95 != 0 {
		goto L1
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14))) = v100
	F_errmsg_internal(m, int32(484222), v14)
	mBase = m.M
	v104 = m.ExcPending
	if v104 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(497029), int32(1231), int32(533016))
	mBase = m.M
	v109 = m.ExcPending
	if v109 != 0 {
		goto L1
...
func F_check_default_with_oids(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v4 == int32(1) {
		...
		*(*int32)(unsafe.Add(mBase, _consts[425])) = v11
		v17 = F_format_elog_string(m, int32(443273), int32(0))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int32(0)
