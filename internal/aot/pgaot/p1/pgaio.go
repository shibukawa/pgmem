...
func F_pgaio_closing_fd(m *base.Module, l0 int32) {
	...
	v14 = v12 - int32(48)
	m.G0 = v14
	v17 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	if v17 == int32(0) {
		goto L1
	} else {
		goto L2
...
L5:
	;
	v47 = *(*int32)(unsafe.Add(mBase, _consts[727]))
...
L12:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+36)) = l0
	F_errmsg_internal(m, int32(472683), v14+int32(32))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L6
...
L13:
	;
	F_errfinish(m, int32(521910), int32(1237), int32(460097))
	mBase = m.M
	v43 = m.ExcPending
	if v43 != 0 {
		goto L6
...
L16:
	;
	v52 = *(*int32)(unsafe.Add(mBase, _consts[726]))
...
L36:
	;
	v114 = int32(0)
	v116 = *(*int32)(unsafe.Add(mBase, _consts[722]))
...
L37:
	...
	v136 = *(*int32)(unsafe.Add(mBase, uint32(v131<<(uint(int32(2))%32))+uint32(_consts[724])))
	v137 = *(*int32)(unsafe.Add(mBase, uint32(v136)+8))
	goto L41
L38:
	;
	v129 = *(*int32)(unsafe.Add(mBase, uint32(v122<<(uint(int32(2))%32))+uint32(_consts[723])))
	v130 = v129
	goto L40
L39:
	;
...
L42:
	;
	v145 = *(*int32)(unsafe.Add(mBase, uint32(v138<<(uint(int32(2))%32))+uint32(_consts[725])))
	v146 = v145
	goto L44
L43:
	;
...
L44:
	;
	v148 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v14)+12)) = v146
	F_errmsg_internal(m, int32(185789), v14)
	mBase = m.M
	v158 = m.ExcPending
	if v158 != 0 {
		goto L6
...
L45:
	;
	F_errfinish(m, int32(521910), int32(1276), int32(460097))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L6
...
L47:
	;
	v172 = *(*int32)(unsafe.Add(mBase, _consts[726]))
		...
		if v15 != 0 {
			...
			if v18 != 0 {
				...
				if v20 != 0 {
					...
					v22 = *(*int32)(unsafe.Add(mBase, _consts[722]))
					v23 = *(*int32)(unsafe.Add(mBase, uint32(v22)+24))
					v28 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+2)))
					if base.Ui32(v28) <= base.Ui32(int32(2)) {
						v35 = *(*int32)(unsafe.Add(mBase, uint32(v28<<(uint(int32(2))%32))+uint32(_consts[723])))
						v36 = v35
					} else {
						v36 = int32(0)
					}
					v37 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+1)))
					v42 = *(*int32)(unsafe.Add(mBase, uint32(v37<<(uint(int32(2))%32))+uint32(_consts[724])))
					v43 = *(*int32)(unsafe.Add(mBase, uint32(v42)+8))
					v44 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0))))
					if base.Ui32(v44) <= base.Ui32(int32(7)) {
						v51 = *(*int32)(unsafe.Add(mBase, uint32(v44<<(uint(int32(2))%32))+uint32(_consts[725])))
						v52 = v51
					} else {
						v52 = v3
					}
					v57 = *(*int32)(unsafe.Add(mBase, uint32(v2<<(uint(int32(2))%32))+uint32(_consts[725])))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v11))) = (l0 - v23) >> (uint(int32(7)) % 32)
					F_errmsg_internal(m, int32(194296), v11)
					mBase = m.M
					v65 = m.ExcPending
					if v65 != 0 {
						return
					} else {
						F_errfinish(m, int32(521910), int32(397), int32(370697))
						mBase = m.M
						v70 = m.ExcPending
						if v70 != 0 {
							return
...
func F_pgaio_shutdown(m *base.Module, l0 int32, l1 int32) {
	...
	v12 = v10 - int32(32)
	m.G0 = v12
	v15 = *(*int32)(unsafe.Add(mBase, _consts[726]))
...
L1:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _consts[726]))
...
L11:
	;
	*(*int32)(unsafe.Add(mBase, _consts[726])) = int32(0)
	m.G0 = v12 + int32(32)
	return
L12:
	;
...
L19:
	;
	v64 = int32(0)
	v66 = *(*int32)(unsafe.Add(mBase, _consts[722]))
...
L20:
	...
	v86 = *(*int32)(unsafe.Add(mBase, uint32(v81<<(uint(int32(2))%32))+uint32(_consts[724])))
	v87 = *(*int32)(unsafe.Add(mBase, uint32(v86)+8))
	goto L24
L21:
	;
	v79 = *(*int32)(unsafe.Add(mBase, uint32(v72<<(uint(int32(2))%32))+uint32(_consts[723])))
	v80 = v79
	goto L23
L22:
	;
...
L25:
	;
	v95 = *(*int32)(unsafe.Add(mBase, uint32(v88<<(uint(int32(2))%32))+uint32(_consts[725])))
	v96 = v95
	goto L27
L26:
	;
...
L27:
	;
	v98 = *(*int32)(unsafe.Add(mBase, _consts[726]))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+12)) = v96
	F_errmsg_internal(m, int32(185686), v12)
	mBase = m.M
	v107 = m.ExcPending
	if v107 != 0 {
		goto L3
...
L28:
	;
	F_errfinish(m, int32(521910), int32(1312), int32(256885))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L3
...
L30:
	;
	v121 = *(*int32)(unsafe.Add(mBase, _consts[726]))
