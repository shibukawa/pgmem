...
L42:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v18)+8)) = v162
	v167 = *(*int32)(unsafe.Add(mBase, _c_F_JsonTableInitOpaque[0]))
		...
		if v8 != 0 {
			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v18))) = v17 << (uint(int32(2)) % 32)
				...
				v31 = int32(_a_F_json_object_agg_finalfn_0)
				...
				if v33 != 0 {
					...
					if v36 != 0 {
						...
						if v40 != 0 {
							...
							v78 = *(*int32)(unsafe.Add(mBase, _c_F_json_object_keys[1]))
									...
									if v56 == v58 {
										...
										if v69 != int32(1) {
															...
															if v127 != 0 {
																...
																if v130 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v126
																	F_errmsg(m, int32(_a_F_makeJsonConstructorExpr_0), v13+int32(16))
																	mBase = m.M
																	v137 = m.ExcPending
																	if v137 != 0 {
																		return int32(0)
																		...
																		if v139 != 0 {
																			...
																			F_errfinish(m, int32(_a_F_makeJsonConstructorExpr_1), int32(3667), int32(_a_F_makeJsonConstructorExpr_2))
																			mBase = m.M
																			v144 = m.ExcPending
																			if v144 != 0 {
																				return int32(0)
											...
											if v68 != int32(17) {
												...
												v76 = F_coerce_to_specific_type(m, l0, v30, int32(25), int32(_a_F_makeJsonConstructorExpr_3))
												mBase = m.M
												v77 = m.ExcPending
												if v77 != 0 {
													return int32(0)
...
L58:
	;
	F_appendStringInfoString(m, v17+int32(-32), int32(_a_F_transformJsonTableColumns_0))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L4
...
L95:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v415
	v424 = F_pg_snprintf(m, v17+int32(-32), int32(32), int32(_a_F_transformJsonTableColumns_5), v19)
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L4
