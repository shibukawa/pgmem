...
L7:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+4)) = v22
	v30 = F_AllocSetContextCreateInternal(m, l4, int32(67727), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v31 = m.ExcPending
	if v31 != 0 {
		goto L1
...
L79:
	;
	F_errmsg(m, int32(152738), int32(0))
	mBase = m.M
	v261 = m.ExcPending
	if v261 != 0 {
		goto L1
...
L80:
	;
	F_errsave_finish(m, l2, int32(517915), int32(389), int32(302947))
	mBase = m.M
	v266 = m.ExcPending
	if v266 != 0 {
		goto L1
...
L85:
	;
	F_errmsg(m, int32(125222), int32(0))
	mBase = m.M
	v277 = m.ExcPending
	if v277 != 0 {
		goto L1
...
L86:
	;
	F_errsave_finish(m, l2, int32(517915), int32(395), int32(302947))
	mBase = m.M
	v282 = m.ExcPending
	if v282 != 0 {
		goto L1
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v17))) = v394
	F_errmsg_internal(m, int32(503596), v17)
	mBase = m.M
	v398 = m.ExcPending
	if v398 != 0 {
		goto L1
...
L108:
	;
	F_errfinish(m, int32(517915), int32(462), int32(302947))
	mBase = m.M
	v403 = m.ExcPending
	if v403 != 0 {
		goto L1
...
func F_json_populate_recordset(m *base.Module, l0 int32) int32 {
	...
	_ = v8
	v3 = int32(1)
	F_populate_recordset_worker(m, l0, int32(112274), v3, v3)
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
									...
									if v56 == v58 {
										...
										if v69 != int32(1) {
															...
															if v127 != 0 {
																...
																if v130 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v126
																	F_errmsg(m, int32(191861), v13+int32(16))
																	mBase = m.M
																	v137 = m.ExcPending
																	if v137 != 0 {
																		return int32(0)
																		...
																		if v139 != 0 {
																			...
																			F_errfinish(m, int32(514538), int32(3667), int32(216506))
																			mBase = m.M
																			v144 = m.ExcPending
																			if v144 != 0 {
																				return int32(0)
											...
											if v68 != int32(17) {
												...
												v76 = F_coerce_to_specific_type(m, l0, v30, int32(25), int32(550047))
												mBase = m.M
												v77 = m.ExcPending
												if v77 != 0 {
													return int32(0)
...
func F_transformJsonAggConstructor(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32) int32 {
	...
	if v12 != 0 {
		v15 = F_transformWhereClause(m, l0, v12, int32(8), int32(546243))
		mBase = m.M
		v18 = m.ExcPending
		if v18 != 0 {
			return int32(0)
							...
							if v73 != 0 {
								...
								if v77 != 0 {
									...
									if v80 != 0 {
										...
										F_errfinish(m, int32(514538), int32(3880), int32(216990))
										mBase = m.M
										v85 = m.ExcPending
										if v85 != 0 {
											return int32(0)
				...
				if v40 == int32(1) {
					...
					if v116 != 0 {
						...
						if v119 != 0 {
							...
							F_errmsg(m, int32(148642), int32(0))
							mBase = m.M
							v123 = m.ExcPending
							if v123 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(514538), int32(3546), int32(69795))
								mBase = m.M
								v128 = m.ExcPending
								if v128 != 0 {
									return int32(0)
						...
						if v44 == int32(112) {
							...
							if v132 != 0 {
								...
								if v135 != 0 {
									...
									F_errmsg(m, int32(148580), int32(0))
									mBase = m.M
									v139 = m.ExcPending
									if v139 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(514538), int32(3551), int32(69795))
										mBase = m.M
										v144 = m.ExcPending
										if v144 != 0 {
											return int32(0)
												...
												if v86 != 0 {
													...
													if v89 != 0 {
														...
														if v92 != 0 {
															...
															F_errmsg(m, int32(170338), int32(0))
															mBase = m.M
															v96 = m.ExcPending
															if v96 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(514538), int32(3503), int32(118972))
																mBase = m.M
																v101 = m.ExcPending
																if v101 != 0 {
																	return int32(0)
											...
											if base.Ui32(int32(2)) <= base.Ui32(v78) {
												...
												if v167 != 0 {
													...
													if v170 != 0 {
														...
														F_errmsg(m, int32(349741), int32(0))
														mBase = m.M
														v174 = m.ExcPending
														if v174 != 0 {
															return int32(0)
														} else {
															F_errhint(m, int32(670850), int32(0))
															mBase = m.M
															v178 = m.ExcPending
															if v178 != 0 {
																return int32(0)
																...
																if v181 != 0 {
																	...
																	F_errfinish(m, int32(514538), int32(3510), int32(118972))
																	mBase = m.M
																	v186 = m.ExcPending
																	if v186 != 0 {
																		return int32(0)
														...
														if v148 != 0 {
															...
															if v151 != 0 {
																...
																if v154 != 0 {
																	...
																	F_errmsg(m, int32(170286), int32(0))
																	mBase = m.M
																	v158 = m.ExcPending
																	if v158 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(514538), int32(3490), int32(118972))
																		mBase = m.M
																		v163 = m.ExcPending
																		if v163 != 0 {
																			return int32(0)
...
L58:
	;
	F_appendStringInfoString(m, v17+int32(-32), int32(687392))
	mBase = m.M
	v188 = m.ExcPending
	if v188 != 0 {
		goto L4
...
L75:
	;
	F_errmsg(m, int32(456970), int32(0))
	mBase = m.M
	v308 = m.ExcPending
	if v308 != 0 {
		goto L4
...
L77:
	;
	F_errfinish(m, int32(519148), int32(294), int32(156794))
	mBase = m.M
	v316 = m.ExcPending
	if v316 != 0 {
		goto L4
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+16)) = v321
	F_errmsg_internal(m, int32(503460), v17+int32(-48))
	mBase = m.M
	v327 = m.ExcPending
	if v327 != 0 {
		goto L4
...
L80:
	;
	F_errfinish(m, int32(519148), int32(343), int32(156794))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L4
...
L95:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19))) = v415
	v424 = F_pg_snprintf(m, v17+int32(-32), int32(32), int32(483538), v19)
	mBase = m.M
	v425 = m.ExcPending
	if v425 != 0 {
		goto L4
