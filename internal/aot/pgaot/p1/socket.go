...
func F_socket_flush_if_writable(m *base.Module) int32 {
	...
	_ = v46
	v1 = int32(0)
	v3 = *(*int32)(unsafe.Add(mBase, _consts[459]))
	v5 = *(*int32)(unsafe.Add(mBase, _consts[460]))
	if v3 == v5 {
		v29 = v1
		return v29
	} else {
		v8 = int32(*(*uint8)(unsafe.Add(mBase, _consts[461])))
		if v8 != 0 {
			v29 = v1
			return v29
		} else {
			v10 = *(*int32)(unsafe.Add(mBase, _consts[457]))
			if v10 == int32(0) {
				...
				*(*uint8)(unsafe.Add(mBase, _consts[461])) = uint8(v13)
				...
				if v25 != 0 {
					...
					v27 = int32(0)
					*(*uint8)(unsafe.Add(mBase, _consts[461])) = uint8(v27)
					v29 = v22
					return v29
				}
			}
...
func F_socket_is_send_pending(m *base.Module) int32 {
	...
	v4 = *(*int32)(unsafe.Add(mBase, _consts[459]))
