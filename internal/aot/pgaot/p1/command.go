			...
			if v25 != 0 {
				...
				if v22 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = v28
					F_errmsg_internal(m, int32(507909), v7)
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(514409), int32(116), int32(20067))
						mBase = m.M
						v37 = m.ExcPending
						if v37 != 0 {
							return int32(0)
...
L197:
	;
	F_errfinish(m, int32(514409), int32(3158), int32(354132))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L194
...
L207:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+32)) = v326
	F_errmsg_internal(m, int32(507909), v9+int32(32))
	mBase = m.M
	v332 = m.ExcPending
	if v332 != 0 {
		goto L194
...
L208:
	;
	F_errfinish(m, int32(514409), int32(3221), int32(354132))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L194
...
L212:
	;
	F_errfinish(m, int32(514409), int32(3230), int32(354132))
	mBase = m.M
	v354 = m.ExcPending
	if v354 != 0 {
		goto L194
