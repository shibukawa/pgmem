	...
	if v6&int32(2) != 0 {
		...
		if v17 != 0 {
			...
			if v19 != int32(1) {
				...
				if v44 != 0 {
					...
					F_errmsg(m, int32(219280), int32(0))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return
					} else {
						F_errfinish(m, int32(490439), int32(913), int32(433107))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return
		...
		if v28 != 0 {
			...
			if v31 != 0 {
				...
				F_errmsg(m, int32(256973), int32(0))
				mBase = m.M
				v35 = m.ExcPending
				if v35 != 0 {
					return
				} else {
					F_errfinish(m, int32(490439), int32(903), int32(433107))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
...
func F_BarrierArriveAndDetachExceptLast(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(490466), int32(215), int32(77660))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[773])) = v6 + int32(1)
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				F_errmsg_internal(m, int32(117613), int32(0))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(494771), int32(349), int32(98659))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
L36:
	;
	F_errmsg_internal(m, int32(16748), int32(0))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L13
...
L37:
	;
	F_errfinish(m, int32(490522), int32(6591), int32(446464))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L13
...
func F_begin_cb_wrapper(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(274365)
...
func F_big5_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4362628), v18, v18, v18, int32(36), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
func F_boot_yyerror(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
		F_errmsg_internal(m, int32(472085), v6)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
		} else {
			F_errfinish(m, int32(311559), int32(137), int32(208571))
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return
...
L48:
	;
	v203 = F_CreateParallelContext(m, int32(275647), v185)
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L3
...
L119:
	;
	F_s_lock(m, v460, int32(491520), int32(2587), int32(281610))
	mBase = m.M
	v486 = m.ExcPending
	if v486 != 0 {
		goto L3
...
L129:
	...
	v515 = F_AllocSetContextCreateInternal(m, v510, int32(270464), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v516 = m.ExcPending
	if v516 != 0 {
		goto L3
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v702 + int32(4)
	F_errmsg_internal(m, int32(499342), v20+int32(16))
	mBase = m.M
	v710 = m.ExcPending
	if v710 != 0 {
		goto L3
...
L169:
	;
	F_errfinish(m, int32(491520), int32(1120), int32(426215))
	mBase = m.M
	v715 = m.ExcPending
	if v715 != 0 {
		goto L3
...
func F_btrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(725449), v47, v47, v47)
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l1
	F_errmsg(m, int32(225541), v8+int32(16))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L34
...
L39:
	;
	F_errfinish(m, int32(494102), int32(1526), int32(393978))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L34
...
L47:
	;
	F_errfinish(m, int32(494102), int32(1533), int32(393978))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L34
