			...
			if v19 != int32(1) {
				...
				if v44 != 0 {
					...
					if v48 != 0 {
						...
						F_errfinish(m, int32(518441), int32(913), int32(457631))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return
		...
		if v28 != 0 {
			...
			if v31 != 0 {
				...
				if v35 != 0 {
					...
					F_errfinish(m, int32(518441), int32(903), int32(457631))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
...
func F_BarrierArriveAndDetachExceptLast(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(518468), int32(215), int32(84109))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				if v57 != 0 {
					...
					F_errfinish(m, int32(523605), int32(349), int32(105975))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
L37:
	;
	F_errfinish(m, int32(518524), int32(6591), int32(471231))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L13
...
func F_begin_cb_wrapper(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(289643)
...
func F_big5_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4426932), v18, v18, v18, int32(36), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
L93:
	;
	F_errfinish(m, int32(515226), int32(324), int32(87723))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L1
...
func F_boot_yyerror(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
		F_errmsg_internal(m, int32(498210), v6)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
		} else {
			F_errfinish(m, int32(329022), int32(137), int32(220878))
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return
...
L48:
	;
	v204 = F_CreateParallelContext(m, int32(171330), int32(290925), v185)
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L3
...
L119:
	;
	F_s_lock(m, v461, int32(519573), int32(2587), int32(297305))
	mBase = m.M
	v487 = m.ExcPending
	if v487 != 0 {
		goto L3
...
L129:
	...
	v516 = F_AllocSetContextCreateInternal(m, v511, int32(285625), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L3
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v703 + int32(4)
	F_errmsg_internal(m, int32(528833), v20+int32(16))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L3
...
L169:
	;
	F_errfinish(m, int32(519573), int32(1120), int32(450316))
	mBase = m.M
	v716 = m.ExcPending
	if v716 != 0 {
		goto L3
...
func F_btrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(779073), v47, v47, v47)
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
...
L39:
	;
	F_errfinish(m, int32(522638), int32(1526), int32(415884))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L34
...
L47:
	;
	F_errfinish(m, int32(522638), int32(1533), int32(415884))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L34
