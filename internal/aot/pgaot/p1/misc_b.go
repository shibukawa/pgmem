...
func F_BackgroundWorkerInitializeConnectionByOid(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v53 int32
	_ = v53
	v5 = *(*int32)(unsafe.Add(mBase, _consts[622]))
			...
			if v19 != int32(1) {
				...
				if v44 != 0 {
					...
					if v48 != 0 {
						...
						F_errfinish(m, int32(518493), int32(913), int32(457683))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return
		...
		if v28 != 0 {
			...
			if v31 != 0 {
				...
				if v35 != 0 {
					...
					F_errfinish(m, int32(518493), int32(903), int32(457683))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
...
func F_BarrierArriveAndDetachExceptLast(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(518520), int32(215), int32(84109))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
...
func F_BeforeShmemExit_Files(m *base.Module, l0 int32, l1 int32) {
	...
	var v58 int32
	_ = v58
	v6 = *(*int32)(unsafe.Add(mBase, _consts[754]))
...
L3:
	;
	v43 = int32(0)
	*(*uint8)(unsafe.Add(mBase, _consts[755])) = uint8(v43)
	v46 = *(*int32)(unsafe.Add(mBase, _consts[756]))
	if v43 < v46 {
		goto L12
	} else {
		goto L13
...
L10:
	;
	v30 = *(*int32)(unsafe.Add(mBase, _consts[754]))
...
L15:
	;
	v54 = *(*int32)(unsafe.Add(mBase, _consts[757]))
...
L17:
	;
	v58 = *(*int32)(unsafe.Add(mBase, _consts[756]))
	if int32(0) < v58 {
		goto L15
	} else {
		goto L18
...
func F_before_shmem_exit(m *base.Module, l0 int32, l1 int32) {
	...
	var v62 int32
	_ = v62
	v6 = *(*int32)(unsafe.Add(mBase, _consts[776]))
	if v6 < int32(20) {
		v10 = v6 << (uint(int32(3)) % 32)
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_consts[777]))) = l1
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_consts[778]))) = l0
		*(*int32)(unsafe.Add(mBase, _consts[776])) = v6 + int32(1)
		v22 = int32(*(*uint8)(unsafe.Add(mBase, _consts[773])))
		if v22 == int32(0) {
			v30 = *(*int32)(unsafe.Add(mBase, _consts[774]))
			if v30 <= int32(31) {
				*(*int32)(unsafe.Add(mBase, _consts[774])) = v30 + int32(1)
				*(*int32)(unsafe.Add(mBase, uint32(v30<<(uint(int32(2))%32))+uint32(_consts[775]))) = int32(1100)
			} else {
			}
			v45 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _consts[773])) = uint8(v45)
		} else {
		}
		return
	} else {
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				F_errmsg_internal(m, int32(126392), int32(0))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(523675), int32(349), int32(105975))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
L36:
	;
	F_errmsg_internal(m, int32(16942), int32(0))
	mBase = m.M
	v159 = m.ExcPending
	if v159 != 0 {
		goto L13
...
L37:
	;
	F_errfinish(m, int32(518576), int32(6591), int32(471283))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L13
...
func F_begin_cb_wrapper(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(289673)
...
func F_big5_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4426980), v18, v18, v18, int32(36), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
func F_blinsert(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32) int32 {
	...
	v22 = F_AllocSetContextCreateInternal(m, v17, int32(65114), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v25 = m.ExcPending
	if v25 != 0 {
		goto L1
...
L92:
	;
	F_errmsg_internal(m, int32(425831), int32(0))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L1
...
L93:
	;
	F_errfinish(m, int32(515278), int32(324), int32(87723))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L1
...
func F_boot_yyerror(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
		F_errmsg_internal(m, int32(498262), v6)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
		} else {
			F_errfinish(m, int32(329052), int32(137), int32(220878))
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return
...
L48:
	;
	v204 = F_CreateParallelContext(m, int32(171330), int32(290955), v185)
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L3
...
L119:
	;
	F_s_lock(m, v461, int32(519643), int32(2587), int32(297335))
	mBase = m.M
	v487 = m.ExcPending
	if v487 != 0 {
		goto L3
...
L129:
	...
	v516 = F_AllocSetContextCreateInternal(m, v511, int32(285655), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L3
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v703 + int32(4)
	F_errmsg_internal(m, int32(528903), v20+int32(16))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L3
...
L169:
	;
	F_errfinish(m, int32(519643), int32(1120), int32(450368))
	mBase = m.M
	v716 = m.ExcPending
	if v716 != 0 {
		goto L3
...
func F_btrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(779143), v47, v47, v47)
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
...
L4:
	;
	v15 = int32(581949)
	v19 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1119])))
...
L15:
	;
	v44 = int32(581549)
	v47 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1120])))
...
L24:
	;
	v72 = int32(541862)
	v76 = int32(*(*uint8)(unsafe.Add(mBase, _consts[1121])))
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l1
	F_errmsg(m, int32(238688), v8+int32(16))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L34
...
L39:
	;
	F_errfinish(m, int32(522708), int32(1526), int32(415914))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L34
...
L47:
	;
	F_errfinish(m, int32(522708), int32(1533), int32(415914))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L34
