...
func F_before_shmem_exit(m *base.Module, l0 int32, l1 int32) {
	...
	var v62 int32
	_ = v62
	v6 = *(*int32)(unsafe.Add(mBase, _c_F_before_shmem_exit[0]))
	if v6 < int32(20) {
		v10 = v6 << (uint(int32(3)) % 32)
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_c_F_before_shmem_exit[1]))) = l1
		*(*int32)(unsafe.Add(mBase, uint32(v10)+uint32(_c_F_before_shmem_exit[2]))) = l0
		*(*int32)(unsafe.Add(mBase, _c_F_before_shmem_exit[0])) = v6 + int32(1)
		v22 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_before_shmem_exit[3])))
		if v22 == int32(0) {
			...
			v45 = int32(1)
			*(*uint8)(unsafe.Add(mBase, _c_F_before_shmem_exit[3])) = uint8(v45)
		} else {
		}
		return
	} else {
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				F_errmsg_internal(m, int32(_a_F_before_shmem_exit_0), int32(0))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(_a_F_before_shmem_exit_1), int32(349), int32(_a_F_before_shmem_exit_2))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
L24:
	;
	v124 = int32(_a_F_before_stmt_triggers_fired_0)
	v125 = *(*int32)(unsafe.Add(mBase, _c_F_before_stmt_triggers_fired[4]))
	v128 = *(*int32)(unsafe.Add(mBase, _c_F_before_stmt_triggers_fired[5]))
	*(*int32)(unsafe.Add(mBase, _c_F_before_stmt_triggers_fired[4])) = v128
...
L35:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_before_stmt_triggers_fired[4])) = v125
	v143 = v131
	goto L23
L36:
	;
...
func F_big5_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(_a_F_big5_to_utf8_0), v18, v18, v18, int32(36), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
L1:
	;
	v32 = *(*int32)(unsafe.Add(mBase, _c_F_bitmapheap_stream_read_next[0]))
	if v32 != 0 {
		goto L3
	} else {
		goto L4
...
L82:
	...
	v410 = *(*int32)(unsafe.Add(mBase, _c_F_bitmapheap_stream_read_next[1]))
	if v410 != int32(3) {
		goto L83
	} else {
		goto L84
				...
				*(*int32)(unsafe.Add(mBase, uint32(v33)+4)) = v39
				...
				if v39 <= v16 {
					...
					if v44 != 0 {
						...
						if base.Ui32(int32(_a_F_bitshiftright_0)) < base.Ui32(v16) {
							v105 = F__emscripten_memset_bulkmem(m, v42, base.I32_extend8_s(int32(0)), v79)
							mBase = m.M
						} else {
							if v16&int32(24) != 0 {
...
L40:
	...
	v207 = v168 + int32(24) + v201*(v192&int32(_a_F_blgetbitmap_0)-int32(1))
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v148)+48)) = v164
	v172 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[3]))
...
L48:
	;
	v203 = F_CreateParallelContext(m, int32(_a_F_brinbuild_2), v185)
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L3
...
L66:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v203)+40)) = v272
	v276 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[5]))
	if v276 != 0 {
		goto L67
	} else {
		goto L68
...
L79:
	;
	v306 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[4]))
...
L81:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v312)+12)) = v320
	v324 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[6]))
	if v324 == int32(0) {
		goto L83
	} else {
		goto L84
...
L91:
	;
	v364 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[5]))
	if v364 != 0 {
		goto L92
	} else {
		goto L93
...
L110:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v148)+64)) = v192
	...
	v420 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[7]))
...
L115:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v440)+8)) = v448
	v451 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[7]))
...
L119:
	;
	F_s_lock(m, v460, int32(_a_F_brinbuild_4), int32(2587), int32(_a_F_brinbuild_5))
	mBase = m.M
	v486 = m.ExcPending
	if v486 != 0 {
		goto L3
...
L129:
	;
	v510 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[3]))
	v515 = F_AllocSetContextCreateInternal(m, v510, int32(_a_F_brinbuild_6), int32(0), int32(_a_F_brinbuild_0), int32(_a_F_brinbuild_7))
	mBase = m.M
	v516 = m.ExcPending
	if v516 != 0 {
		goto L3
...
L130:
	;
	v517 = int32(_a_F_brinbuild_8)
	v518 = *(*int32)(unsafe.Add(mBase, _c_F_brinbuild[3]))
	*(*int32)(unsafe.Add(mBase, _c_F_brinbuild[3])) = v515
...
L165:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_brinbuild[3])) = v518
...
L169:
	;
	F_errfinish(m, int32(_a_F_brinbuild_4), int32(1120), int32(_a_F_brinbuild_10))
	mBase = m.M
	v715 = m.ExcPending
	if v715 != 0 {
		goto L3
...
func F_btrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(_a_F_btrim1_0), v47, v47, v47)
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
...
L11:
	;
	v59 = F_pstrdup(m, int32(_a_F_build_minmax_path_0))
	mBase = m.M
	v60 = m.ExcPending
	if v60 != 0 {
		goto L1
...
L4:
	...
	v19 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_builtin_validate_locale[0])))
...
L6:
	;
	v99 = int32(_a_F_builtin_validate_locale_1)
	goto L3
L7:
	;
	if v40-v39 == int32(0) {
...
L15:
	;
	v44 = int32(_a_F_builtin_validate_locale_2)
	v47 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_builtin_validate_locale[1])))
...
L24:
	;
	v72 = int32(_a_F_builtin_validate_locale_3)
	v76 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_builtin_validate_locale[2])))
...
L44:
	;
	v145 = *(*int32)(unsafe.Add(mBase, uint32(l0<<(uint(int32(3))%32))+uint32(_c_F_builtin_validate_locale[3])))
	v146 = v145
	goto L46
L45:
	;
