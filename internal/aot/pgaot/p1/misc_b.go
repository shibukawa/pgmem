			...
			if v19 != int32(1) {
				...
				if v44 != 0 {
					...
					if v48 != 0 {
						...
						F_errfinish(m, int32(472545), int32(913), int32(416772))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return
		...
		if v28 != 0 {
			...
			if v31 != 0 {
				...
				if v35 != 0 {
					...
					F_errfinish(m, int32(472545), int32(903), int32(416772))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
...
func F_BarrierArriveAndDetachExceptLast(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(472572), int32(215), int32(74553))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[772])) = v6 + int32(1)
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				F_errmsg_internal(m, int32(110731), int32(0))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(476674), int32(349), int32(93366))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
L37:
	;
	F_errfinish(m, int32(472628), int32(6591), int32(430017))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L13
...
func F_begin_cb_wrapper(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(263462)
...
func F_big5_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4329636), v18, v18, v18, int32(36), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
func F_boot_yyerror(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
		F_errmsg_internal(m, int32(454798), v6)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
		} else {
			F_errfinish(m, int32(299106), int32(137), int32(199745))
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return
...
L48:
	;
	v203 = F_CreateParallelContext(m, int32(264680), v185)
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L3
...
L136:
	;
	F_s_lock(m, v516, int32(473527), int32(2587), int32(270380))
	mBase = m.M
	v542 = m.ExcPending
	if v542 != 0 {
		goto L3
...
L146:
	...
	v571 = F_AllocSetContextCreateInternal(m, v566, int32(259561), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v572 = m.ExcPending
	if v572 != 0 {
		goto L3
...
L185:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v758 + int32(4)
	F_errmsg_internal(m, int32(481167), v20+int32(16))
	mBase = m.M
	v766 = m.ExcPending
	if v766 != 0 {
		goto L3
...
L186:
	;
	F_errfinish(m, int32(473527), int32(1120), int32(410071))
	mBase = m.M
	v771 = m.ExcPending
	if v771 != 0 {
		goto L3
...
func F_btrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(704419), v47, v47, v47)
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l1
	F_errmsg(m, int32(216541), v8+int32(16))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L34
...
L39:
	;
	F_errfinish(m, int32(476005), int32(1526), int32(378882))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L34
...
L47:
	;
	F_errfinish(m, int32(476005), int32(1533), int32(378882))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L34
