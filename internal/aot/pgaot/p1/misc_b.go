			...
			if v19 != int32(1) {
				...
				if v44 != 0 {
					...
					if v48 != 0 {
						...
						F_errfinish(m, int32(494819), int32(913), int32(436856))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return
		...
		if v28 != 0 {
			...
			if v31 != 0 {
				...
				if v35 != 0 {
					...
					F_errfinish(m, int32(494819), int32(903), int32(436856))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
...
func F_BarrierArriveAndDetachExceptLast(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(494846), int32(215), int32(78074))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[772])) = v6 + int32(1)
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				F_errmsg_internal(m, int32(118500), int32(0))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(499192), int32(349), int32(99292))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
L37:
	;
	F_errfinish(m, int32(494902), int32(6591), int32(450213))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L13
...
func F_begin_cb_wrapper(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(276641)
...
func F_big5_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4371444), v18, v18, v18, int32(36), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
L93:
	;
	F_errfinish(m, int32(492388), int32(324), int32(81470))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L1
...
func F_boot_yyerror(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
		F_errmsg_internal(m, int32(476294), v6)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
		} else {
			F_errfinish(m, int32(314085), int32(137), int32(209888))
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return
...
L48:
	;
	v203 = F_CreateParallelContext(m, int32(277923), v185)
	mBase = m.M
	v204 = m.ExcPending
	if v204 != 0 {
		goto L3
...
L119:
	;
	F_s_lock(m, v460, int32(495900), int32(2587), int32(283973))
	mBase = m.M
	v486 = m.ExcPending
	if v486 != 0 {
		goto L3
...
L129:
	...
	v515 = F_AllocSetContextCreateInternal(m, v510, int32(272623), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v516 = m.ExcPending
	if v516 != 0 {
		goto L3
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v702 + int32(4)
	F_errmsg_internal(m, int32(503789), v20+int32(16))
	mBase = m.M
	v710 = m.ExcPending
	if v710 != 0 {
		goto L3
...
L169:
	;
	F_errfinish(m, int32(495900), int32(1120), int32(429956))
	mBase = m.M
	v715 = m.ExcPending
	if v715 != 0 {
		goto L3
...
func F_btrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(730275), v47, v47, v47)
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l1
	F_errmsg(m, int32(227306), v8+int32(16))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L34
...
L39:
	;
	F_errfinish(m, int32(498516), int32(1526), int32(397222))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L34
...
L47:
	;
	F_errfinish(m, int32(498516), int32(1533), int32(397222))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L34
