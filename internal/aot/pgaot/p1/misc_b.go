...
func F_BackgroundWorkerInitializeConnectionByOid(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	var v53 int32
	_ = v53
	v5 = *(*int32)(unsafe.Add(mBase, _consts[620]))
			...
			if v19 != int32(1) {
				...
				if v44 != 0 {
					...
					if v48 != 0 {
						...
						F_errfinish(m, int32(520757), int32(913), int32(459479))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return
		...
		if v28 != 0 {
			...
			if v31 != 0 {
				...
				if v35 != 0 {
					...
					F_errfinish(m, int32(520757), int32(903), int32(459479))
					mBase = m.M
					v40 = m.ExcPending
					if v40 != 0 {
						return
...
func F_BarrierArriveAndDetachExceptLast(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(l0))) = int32(1)
	if v3 != 0 {
		F_s_lock(m, l0, int32(520784), int32(215), int32(84293))
		mBase = m.M
		v12 = m.ExcPending
		if v12 != 0 {
			return int32(0)
		...
		*(*int32)(unsafe.Add(mBase, _consts[776])) = v6 + int32(1)
		...
		if v22 == int32(0) {
			...
			if v30 <= int32(31) {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v30<<(uint(int32(2))%32))+uint32(_consts[775]))) = int32(1103)
			} else {
			}
			v45 = int32(1)
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				F_errmsg_internal(m, int32(126789), int32(0))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(525966), int32(349), int32(106245))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
...
L37:
	;
	F_errfinish(m, int32(520840), int32(6591), int32(473079))
	mBase = m.M
	v164 = m.ExcPending
	if v164 != 0 {
		goto L13
...
func F_begin_cb_wrapper(m *base.Module, l0 int32, l1 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+20)) = int32(290733)
...
func F_big5_to_utf8(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		v18 = int32(0)
		v24 = F_LocalToUtf(m, v6, v10, v5, int32(4431444), v18, v18, v18, int32(36), base.B2i32(v7 != v18))
		mBase = m.M
		v25 = m.ExcPending
		if v25 != 0 {
			return int32(0)
...
L92:
	;
	F_errmsg_internal(m, int32(427508), int32(0))
	mBase = m.M
	v367 = m.ExcPending
	if v367 != 0 {
		goto L1
...
L93:
	;
	F_errfinish(m, int32(517521), int32(324), int32(87907))
	mBase = m.M
	v372 = m.ExcPending
	if v372 != 0 {
		goto L1
...
func F_boot_yyerror(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6))) = l1
		F_errmsg_internal(m, int32(500166), v6)
		mBase = m.M
		v23 = m.ExcPending
		if v23 != 0 {
			return
		} else {
			F_errfinish(m, int32(330360), int32(137), int32(221632))
			mBase = m.M
			v28 = m.ExcPending
			if v28 != 0 {
				return
...
L48:
	;
	v204 = F_CreateParallelContext(m, int32(172078), int32(292058), v185)
	mBase = m.M
	v205 = m.ExcPending
	if v205 != 0 {
		goto L3
...
L119:
	;
	F_s_lock(m, v461, int32(521907), int32(2587), int32(298438))
	mBase = m.M
	v487 = m.ExcPending
	if v487 != 0 {
		goto L3
...
L129:
	...
	v516 = F_AllocSetContextCreateInternal(m, v511, int32(286715), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v517 = m.ExcPending
	if v517 != 0 {
		goto L3
...
L168:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v703 + int32(4)
	F_errmsg_internal(m, int32(531194), v20+int32(16))
	mBase = m.M
	v711 = m.ExcPending
	if v711 != 0 {
		goto L3
...
L169:
	;
	F_errfinish(m, int32(521907), int32(1120), int32(452164))
	mBase = m.M
	v716 = m.ExcPending
	if v716 != 0 {
		goto L3
...
func F_btrim1(m *base.Module, l0 int32) int32 {
	...
	if v9 != 0 {
		...
		v47 = int32(1)
		v50 = F_dotrim(m, v17, v45, int32(782429), v47, v47, v47)
		mBase = m.M
		v51 = m.ExcPending
		if v51 != 0 {
			return int32(0)
...
L38:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+16)) = l1
	F_errmsg(m, int32(239545), v8+int32(16))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L34
...
L39:
	;
	F_errfinish(m, int32(524999), int32(1526), int32(417543))
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L34
...
L47:
	;
	F_errfinish(m, int32(524999), int32(1533), int32(417543))
	mBase = m.M
	v156 = m.ExcPending
	if v156 != 0 {
		goto L34
