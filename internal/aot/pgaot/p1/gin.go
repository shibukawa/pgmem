...
L11:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l5)+uint32(_consts[55]))) = uint8(base.B2i32(v112 == int32(4121416)))
...
L15:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+52)) = v65 + int32(4)
	F_errmsg_internal(m, int32(693565), v14+int32(-16))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L4
...
L18:
	;
	F_errfinish(m, int32(499707), int32(783), int32(102753))
	mBase = m.M
	v80 = m.ExcPending
	if v80 != 0 {
		goto L4
...
L55:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+20)) = v224 + int32(4)
	F_errmsg_internal(m, int32(693565), v14+int32(-48))
	mBase = m.M
	v234 = m.ExcPending
	if v234 != 0 {
		goto L4
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+4)) = v318 + int32(4)
	F_errmsg_internal(m, int32(693565), v16)
	mBase = m.M
	v326 = m.ExcPending
	if v326 != 0 {
		goto L4
...
L107:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+36)) = v417 + int32(4)
	F_errmsg_internal(m, int32(693565), v14+int32(-32))
	mBase = m.M
	v427 = m.ExcPending
	if v427 != 0 {
		goto L4
...
L115:
	;
	F_errmsg_internal(m, int32(321984), int32(0))
	mBase = m.M
	v453 = m.ExcPending
	if v453 != 0 {
		goto L4
...
L116:
	;
	F_errfinish(m, int32(499707), int32(256), int32(120743))
	mBase = m.M
	v458 = m.ExcPending
	if v458 != 0 {
		goto L4
...
func F_ginFlushBuildState(m *base.Module, l0 int32, l1 int32) {
	...
	*(*uint8)(unsafe.Add(mBase, uint32(l0)+uint32(_consts[55]))) = uint8(base.B2i32(v32 == int32(4121416)))
				...
				if v146 != 0 {
					...
					if v149 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v150 + int32(4)
						F_errmsg(m, int32(29250), v7+int32(16))
						mBase = m.M
						v158 = m.ExcPending
						if v158 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(493063), int32(1049), int32(74010))
							mBase = m.M
							v163 = m.ExcPending
							if v163 != 0 {
								return int32(0)
						...
						if v40 == int32(0) {
							...
							if v167 != 0 {
								...
								if v170 != 0 {
									...
									F_errmsg(m, int32(143778), int32(0))
									mBase = m.M
									v174 = m.ExcPending
									if v174 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(493063), int32(1059), int32(74010))
										mBase = m.M
										v179 = m.ExcPending
										if v179 != 0 {
											return int32(0)
												...
												if v94 == int32(0) {
													...
													if v100 != 0 {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v7))) = v101 + int32(4)
														F_errmsg(m, int32(436177), v7)
														mBase = m.M
														v107 = m.ExcPending
														if v107 != 0 {
															return int32(0)
														} else {
															F_errfinish(m, int32(493063), int32(1086), int32(74010))
															mBase = m.M
															v112 = m.ExcPending
															if v112 != 0 {
																return int32(0)
			...
			if v126 != 0 {
				...
				if v129 != 0 {
					...
					if v133 != 0 {
						...
						F_errhint(m, int32(573149), int32(0))
						mBase = m.M
						v137 = m.ExcPending
						if v137 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(493063), int32(1041), int32(74010))
							mBase = m.M
							v142 = m.ExcPending
							if v142 != 0 {
								return int32(0)
...
L22:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = v14
	F_errmsg_internal(m, int32(482640), v9)
	mBase = m.M
	v64 = m.ExcPending
	if v64 != 0 {
		goto L21
...
L23:
	;
	F_errfinish(m, int32(496865), int32(207), int32(364325))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L21
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v54
	F_errmsg_internal(m, int32(487946), v11)
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L1
...
L35:
	;
	F_errfinish(m, int32(496890), int32(1170), int32(321961))
	mBase = m.M
	v115 = m.ExcPending
	if v115 != 0 {
		goto L1
...
func F_gin_extract_query_bit(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(1), int32(7110), int32(2661))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
					...
					default:
						...
						if v55 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v11))) = v46
							F_errmsg_internal(m, int32(482640), v11)
							mBase = m.M
							v61 = m.ExcPending
							if v61 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(496878), int32(97), int32(15733))
								mBase = m.M
								v68 = m.ExcPending
								if v68 != 0 {
									return int32(0)
...
func F_gin_extract_query_interval(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(0), int32(7107), int32(2540))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gin_extract_query_text(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(1), int32(7109), int32(2120))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gin_extract_query_timetz(m *base.Module, l0 int32) int32 {
	...
	var v8 int32
	_ = v8
	v5 = F_gin_btree_extract_query(m, l0, int32(0), int32(7106), int32(1443))
	v8 = m.ExcPending
	if v8 != 0 {
		return int32(0)
	} else {
...
func F_gin_extract_tsquery_5args(m *base.Module, l0 int32) int32 {
	...
	if v2 <= int32(6) {
		...
		if v10 != 0 {
			...
			F_errmsg_internal(m, int32(121685), int32(0))
			mBase = m.M
			v14 = m.ExcPending
			if v14 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(492741), int32(319), int32(155505))
				mBase = m.M
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
...
L27:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v12
	F_errmsg_internal(m, int32(482640), v8)
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L26
...
L28:
	;
	F_errfinish(m, int32(496890), int32(1072), int32(502959))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L26
...
L19:
	;
	F_errfinish(m, int32(496890), int32(1314), int32(321906))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L17
...
L61:
	;
	F_errfinish(m, int32(497685), int32(153), int32(354032))
	mBase = m.M
	v419 = m.ExcPending
	if v419 != 0 {
		goto L13
...
L63:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v25)+28)) = v424 + int32(4)
	F_errmsg_internal(m, int32(696775), v25+int32(16))
	mBase = m.M
	v435 = m.ExcPending
	if v435 != 0 {
		goto L13
...
L64:
	;
	F_errfinish(m, int32(497685), int32(190), int32(354032))
	mBase = m.M
	v440 = m.ExcPending
	if v440 != 0 {
		goto L13
