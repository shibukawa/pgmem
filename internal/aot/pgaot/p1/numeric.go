						...
						if v243 != 0 {
							...
							if v240 == int32(0) {
								...
								*(*float64)(unsafe.Add(mBase, uint32(v10))) = v231
								F_errmsg_internal(m, int32(656869), v10)
								mBase = m.M
								v252 = m.ExcPending
								if v252 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(499409), int32(2255), int32(81077))
									mBase = m.M
									v257 = m.ExcPending
									if v257 != 0 {
										return int32(0)
							...
							if v278 != 0 {
								...
								if v277 == int32(0) {
									...
									*(*float64)(unsafe.Add(mBase, uint32(v10)+40)) = base.F64_add(base.F64_div(base.F64_convert_i64_s(v281), float64(10000)), float64(0.5))
									F_errmsg_internal(m, int32(657486), v10+int32(32))
									mBase = m.M
									v295 = m.ExcPending
									if v295 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(499409), int32(2276), int32(81077))
										mBase = m.M
										v300 = m.ExcPending
										if v300 != 0 {
											return int32(0)
							...
							if v308 != 0 {
								...
								if v307 == int32(0) {
									...
									*(*float64)(unsafe.Add(mBase, uint32(v10)+64)) = v231
									F_errmsg_internal(m, int32(657121), v10-int32(-64))
									mBase = m.M
									v319 = m.ExcPending
									if v319 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(499409), int32(2284), int32(81077))
										mBase = m.M
										v324 = m.ExcPending
										if v324 != 0 {
											return int32(0)
...
L44:
	;
	v312 = v13 + int32(24)
	F_add_var(m, v312, int32(1721448), v312)
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L1
	...
	if v43 != 0 {
		...
		if v254 != 0 {
			...
			if v258 != 0 {
				...
				F_errfinish(m, int32(499409), int32(5167), int32(373419))
				mBase = m.M
				v263 = m.ExcPending
				if v263 != 0 {
					return int32(0)
...
func F_numeric_exp(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		if base.Ui32(int32(49152)) <= base.Ui32(v17) {
			if v18 == int32(-4096) {
				v25 = F_make_result_opt_error(m, int32(1721396), int32(0))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return int32(0)
			...
			if v48&int32(65535) != int32(49152) {
				if v17&int32(-8193) == int32(-12288) {
					if base.Ui32(int32(49151)) < base.Ui32(v48&int32(65535)) {
						v103 = F_make_result_opt_error(m, int32(1721324), int32(0))
						mBase = m.M
						v104 = m.ExcPending
						if v104 != 0 {
							return int32(0)
								...
								if v88 != 0 {
									...
									if v91 != 0 {
										...
										if v95 != 0 {
											...
											F_errfinish(m, int32(499409), int32(3517), int32(211439))
											mBase = m.M
											v100 = m.ExcPending
											if v100 != 0 {
												return int32(0)
				...
				v58 = F_make_result_opt_error(m, int32(1721324), int32(0))
				mBase = m.M
				v61 = m.ExcPending
				if v61 != 0 {
					return int32(0)
