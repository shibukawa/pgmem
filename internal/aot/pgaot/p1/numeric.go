						...
						if v243 != 0 {
							...
							if v240 == int32(0) {
								...
								*(*float64)(unsafe.Add(mBase, uint32(v10))) = v231
								F_errmsg_internal(m, int32(647283), v10)
								mBase = m.M
								v252 = m.ExcPending
								if v252 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(491430), int32(2255), int32(80117))
									mBase = m.M
									v257 = m.ExcPending
									if v257 != 0 {
										return int32(0)
							...
							if v278 != 0 {
								...
								if v277 == int32(0) {
									...
									*(*float64)(unsafe.Add(mBase, uint32(v10)+40)) = base.F64_add(base.F64_div(base.F64_convert_i64_s(v281), float64(10000)), float64(0.5))
									F_errmsg_internal(m, int32(647900), v10+int32(32))
									mBase = m.M
									v295 = m.ExcPending
									if v295 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(491430), int32(2276), int32(80117))
										mBase = m.M
										v300 = m.ExcPending
										if v300 != 0 {
											return int32(0)
							...
							if v308 != 0 {
								...
								if v307 == int32(0) {
									...
									*(*float64)(unsafe.Add(mBase, uint32(v10)+64)) = v231
									F_errmsg_internal(m, int32(647535), v10-int32(-64))
									mBase = m.M
									v319 = m.ExcPending
									if v319 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(491430), int32(2284), int32(80117))
										mBase = m.M
										v324 = m.ExcPending
										if v324 != 0 {
											return int32(0)
	...
	if v43 != 0 {
		...
		if v254 != 0 {
			...
			if v258 != 0 {
				...
				F_errfinish(m, int32(491430), int32(5167), int32(367589))
				mBase = m.M
				v263 = m.ExcPending
				if v263 != 0 {
					return int32(0)
								...
								if v88 != 0 {
									...
									if v91 != 0 {
										...
										if v95 != 0 {
											...
											F_errfinish(m, int32(491430), int32(3517), int32(208552))
											mBase = m.M
											v100 = m.ExcPending
											if v100 != 0 {
												return int32(0)
