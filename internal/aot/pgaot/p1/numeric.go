		...
		if v15 < int64(10000) {
			...
			if v18 != int32(1) {
				...
				if base.F64_gt(v231, float64(100000)) != 0 {
					v235 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_numeric_abbrev_abort[0])))
					if v235 != int32(1) {
						v259 = int32(0)
					...
					v262 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_numeric_abbrev_abort[0])))
		...
		if v12 != 0 {
			...
			if v45 == int32(0) {
				...
				if v81 != 0 {
					...
					F_errmsg_internal(m, int32(_a_F_numeric_accum_0), int32(0))
					mBase = m.M
					v85 = m.ExcPending
					if v85 != 0 {
						return int32(0)
					} else {
						F_errfinish(m, int32(_a_F_numeric_accum_1), int32(_a_F_numeric_accum_2), int32(_a_F_numeric_accum_3))
						mBase = m.M
						v90 = m.ExcPending
						if v90 != 0 {
							return int32(0)
				...
				v48 = int32(_a_F_numeric_accum_4)
				v49 = *(*int32)(unsafe.Add(mBase, _c_F_numeric_accum[0]))
				v51 = *(*int32)(unsafe.Add(mBase, uint32(v7)+12))
				*(*int32)(unsafe.Add(mBase, _c_F_numeric_accum[0])) = v51
				...
				if v57 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, _c_F_numeric_accum[0])) = v49
					v64 = v54
					v66 = int32(*(*uint8)(unsafe.Add(mBase, uint32(l0)+32)))
					if v66 == int32(0) {
						v69 = *(*int32)(unsafe.Add(mBase, uint32(l0)+28))
...
L2:
	...
	if base.Ui32(int32(_a_F_numeric_ceil_0)) <= base.Ui32(v23) {
		goto L4
	} else {
		goto L5
	}
...
L22:
	;
	v70 = v23 & int32(_a_F_numeric_ceil_1)
	goto L23
L23:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v13)+12)) = v70
	v77 = v23 & int32(_a_F_numeric_ceil_0)
...
L24:
	;
	v80 = v23 << (uint(int32(1)) % 32) & int32(_a_F_numeric_ceil_3)
	goto L26
L25:
	;
	v80 = v77
...
L44:
	;
	v312 = v13 + int32(24)
	F_add_var(m, v312, int32(_a_F_numeric_ceil_4), v312)
	mBase = m.M
	v317 = m.ExcPending
	if v317 != 0 {
		goto L1
...
L49:
	...
	if v134 == int32(_a_F_numeric_ceil_3) {
		goto L44
	} else {
		goto L50
	}
	...
	if v43 != 0 {
		...
		if v49 != 0 {
			...
			if v50 == int32(0) {
				...
				if v48 == int32(0) {
					v55 = int32(_a_F_numeric_combine_0)
					v56 = *(*int32)(unsafe.Add(mBase, _c_F_numeric_combine[0]))
					...
					*(*int32)(unsafe.Add(mBase, _c_F_numeric_combine[0])) = v58
					...
					if v64 != 0 {
						...
						*(*uint8)(unsafe.Add(mBase, uint32(v61))) = uint8(v65)
						v68 = *(*int32)(unsafe.Add(mBase, _c_F_numeric_combine[0]))
									...
									*(*int32)(unsafe.Add(mBase, uint32(v61)+64)) = v119
									...
									if v126 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v61)+52)) = v148
										v234 = v61
										v236 = v56
										*(*int32)(unsafe.Add(mBase, _c_F_numeric_combine[0])) = v236
										v242 = v234
										m.G0 = v10 + int32(32)
										return v242
									}
...
func F_numeric_exp(m *base.Module, l0 int32) int32 {
	...
	if v16 != 0 {
		...
		if base.Ui32(int32(_a_F_numeric_exp_0)) <= base.Ui32(v17) {
			if v18 == int32(-4096) {
				v25 = F_make_result_opt_error(m, int32(_a_F_numeric_exp_1), int32(0))
				mBase = m.M
				v26 = m.ExcPending
				if v26 != 0 {
					return int32(0)
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+44)) = v13 + v75
			v83 = v17 & int32(_a_F_numeric_exp_0)
			if v83 == int32(_a_F_numeric_exp_2) {
				v86 = v17 << (uint(int32(1)) % 32) & int32(_a_F_numeric_exp_3)
			} else {
				v86 = v83
			}
			*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v86
			if v18 < v67 {
				...
				v94 = v17 & int32(_a_F_numeric_exp_4)
			}
...
func F_numeric_fast_cmp(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if v9 != 0 {
		...
		if v11 != 0 {
			...
			v26 = int32(_a_F_numeric_fast_cmp_0)
			v27 = v25 & v26
			if v27 == v26 {
				if v25 != int32(_a_F_numeric_fast_cmp_1) {
					if v25 != int32(_a_F_numeric_fast_cmp_0) {
						if v24 != int32(_a_F_numeric_fast_cmp_2) {
							v46 = int32(-1)
						} else {
							v46 = int32(0)
						}
						...
						v165 = base.B2i32(v24 != int32(_a_F_numeric_fast_cmp_0))
					}
				} else {
					if v24 == int32(_a_F_numeric_fast_cmp_0) {
						v41 = int32(-1)
					} else {
						v41 = base.B2i32(v24 != int32(_a_F_numeric_fast_cmp_1))
					}
					v165 = v41
				}
			} else {
				if base.Ui32(int32(_a_F_numeric_fast_cmp_0)) <= base.Ui32(v24) {
					if v24 == int32(_a_F_numeric_fast_cmp_2) {
						v53 = int32(1)
					} else {
						v53 = int32(-1)
					...
					v105 = v24 & int32(_a_F_numeric_fast_cmp_0)
					if v105 == int32(_a_F_numeric_fast_cmp_3) {
						v108 = v24 << (uint(int32(1)) % 32) & int32(_a_F_numeric_fast_cmp_4)
					} else {
						v108 = v105
					}
					if base.Ui32(v76) <= base.Ui32(int32(1)) {
						if base.Ui32(v99) < base.Ui32(int32(2)) {
							...
							if v108 == int32(_a_F_numeric_fast_cmp_4) {
								v118 = int32(1)
							} else {
								v118 = int32(-1)
							}
						...
						if v27 == int32(_a_F_numeric_fast_cmp_3) {
							v125 = v25 << (uint(int32(1)) % 32) & int32(_a_F_numeric_fast_cmp_4)
						} else {
							v125 = v27
						}
...
func F_numeric_gt(m *base.Module, l0 int32) int32 {
	...
	if v10 != 0 {
		...
		if v15 != 0 {
			...
			v30 = int32(_a_F_numeric_gt_0)
			v31 = v29 & v30
			if v31 == v30 {
				if v29 != int32(_a_F_numeric_gt_1) {
					if v29 != int32(_a_F_numeric_gt_0) {
						if v28 != int32(_a_F_numeric_gt_2) {
							v50 = int32(-1)
						} else {
							v50 = int32(0)
						}
						...
						v169 = base.B2i32(v28 != int32(_a_F_numeric_gt_0))
					}
				} else {
					if v28 == int32(_a_F_numeric_gt_0) {
						v45 = int32(-1)
					} else {
						v45 = base.B2i32(v28 != int32(_a_F_numeric_gt_1))
					}
					v169 = v45
				}
			} else {
				if base.Ui32(int32(_a_F_numeric_gt_0)) <= base.Ui32(v28) {
					if v28 == int32(_a_F_numeric_gt_2) {
						v57 = int32(1)
					} else {
						v57 = int32(-1)
					...
					v109 = v28 & int32(_a_F_numeric_gt_0)
					if v109 == int32(_a_F_numeric_gt_3) {
						v112 = v28 << (uint(int32(1)) % 32) & int32(_a_F_numeric_gt_4)
					} else {
						v112 = v109
					}
					if base.Ui32(v80) <= base.Ui32(int32(1)) {
						...
						if v31 == int32(_a_F_numeric_gt_3) {
							v129 = v29 << (uint(int32(1)) % 32) & int32(_a_F_numeric_gt_4)
						} else {
							v129 = v31
						}
...
func F_numeric_le(m *base.Module, l0 int32) int32 {
	...
	if v10 != 0 {
		...
		if v15 != 0 {
			...
			v28 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v14)+4)))
			v29 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v7)+4)))
			v30 = int32(_a_F_numeric_le_0)
			v31 = v29 & v30
			if v31 == v30 {
				if v29 != int32(_a_F_numeric_le_1) {
					if v29 != int32(_a_F_numeric_le_0) {
						if v28 != int32(_a_F_numeric_le_2) {
							v50 = int32(-1)
						} else {
							v50 = int32(0)
						}
						...
						v169 = base.B2i32(v28 != int32(_a_F_numeric_le_0))
					}
				} else {
					if v28 == int32(_a_F_numeric_le_0) {
						v45 = int32(-1)
					} else {
						v45 = base.B2i32(v28 != int32(_a_F_numeric_le_1))
					}
					v169 = v45
				}
			} else {
				if base.Ui32(int32(_a_F_numeric_le_0)) <= base.Ui32(v28) {
					if v28 == int32(_a_F_numeric_le_2) {
						v57 = int32(1)
					} else {
						v57 = int32(-1)
					...
					v103 = v88 + int32(base.Ui32(v89)>>(uint(int32(2))%32))
					v109 = v28 & int32(_a_F_numeric_le_0)
					if v109 == int32(_a_F_numeric_le_3) {
						v112 = v28 << (uint(int32(1)) % 32) & int32(_a_F_numeric_le_4)
					} else {
						v112 = v109
					}
					if base.Ui32(v80) <= base.Ui32(int32(1)) {
						...
						if v31 == int32(_a_F_numeric_le_3) {
							v129 = v29 << (uint(int32(1)) % 32) & int32(_a_F_numeric_le_4)
						} else {
							v129 = v31
						}
						if base.Ui32(v103) <= base.Ui32(int32(1)) {
...
func F_numeric_mod_opt_error(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	if base.Ui32(v16) <= base.Ui32(int32(_a_F_numeric_mod_opt_error_0)) {
		...
		if base.Ui32(int32(_a_F_numeric_mod_opt_error_0)) < base.Ui32(v20) {
			v48 = v21
			if v48&int32(_a_F_numeric_mod_opt_error_1) != int32(_a_F_numeric_mod_opt_error_2) {
				if v17&int32(-8193) == int32(-12288) {
					if base.Ui32(int32(_a_F_numeric_mod_opt_error_0)) < base.Ui32(v48&int32(_a_F_numeric_mod_opt_error_1)) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12)+64)) = v118
			...
			if v17 < v118 {
				...
				v128 = v16 & int32(_a_F_numeric_mod_opt_error_7)
			}
			*(*int32)(unsafe.Add(mBase, uint32(v12)+60)) = v128
			v135 = v16 & int32(_a_F_numeric_mod_opt_error_2)
			if v135 == int32(_a_F_numeric_mod_opt_error_8) {
				v138 = v16 << (uint(int32(1)) % 32) & int32(_a_F_numeric_mod_opt_error_9)
			} else {
				v138 = v135
			}
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12)+40)) = v175
			...
			if v21 < v175 {
				...
				v185 = v20 & int32(_a_F_numeric_mod_opt_error_7)
			}
			*(*int32)(unsafe.Add(mBase, uint32(v12)+36)) = v185
			v192 = v20 & int32(_a_F_numeric_mod_opt_error_2)
			if v192 == int32(_a_F_numeric_mod_opt_error_8) {
				v195 = v20 << (uint(int32(1)) % 32) & int32(_a_F_numeric_mod_opt_error_9)
			} else {
				v195 = v192
			}
...
func F_numeric_ne(m *base.Module, l0 int32) int32 {
	...
	if v10 != 0 {
		...
		if v15 != 0 {
			...
			v28 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v14)+4)))
			v29 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v7)+4)))
			v30 = int32(_a_F_numeric_ne_0)
			v31 = v29 & v30
			if v31 == v30 {
				if v29 != int32(_a_F_numeric_ne_1) {
					if v29 != int32(_a_F_numeric_ne_0) {
						if v28 != int32(_a_F_numeric_ne_2) {
							v50 = int32(-1)
						} else {
							v50 = int32(0)
						}
						...
						v169 = base.B2i32(v28 != int32(_a_F_numeric_ne_0))
					}
				} else {
					if v28 == int32(_a_F_numeric_ne_0) {
						v45 = int32(-1)
					} else {
						v45 = base.B2i32(v28 != int32(_a_F_numeric_ne_1))
					}
					v169 = v45
				}
			} else {
				if base.Ui32(int32(_a_F_numeric_ne_0)) <= base.Ui32(v28) {
					if v28 == int32(_a_F_numeric_ne_2) {
						v57 = int32(1)
					} else {
						v57 = int32(-1)
					...
					v103 = v88 + int32(base.Ui32(v89)>>(uint(int32(2))%32))
					v109 = v28 & int32(_a_F_numeric_ne_0)
					if v109 == int32(_a_F_numeric_ne_3) {
						v112 = v28 << (uint(int32(1)) % 32) & int32(_a_F_numeric_ne_4)
					} else {
						v112 = v109
					}
					if base.Ui32(v80) <= base.Ui32(int32(1)) {
						...
						if v31 == int32(_a_F_numeric_ne_3) {
							v129 = v29 << (uint(int32(1)) % 32) & int32(_a_F_numeric_ne_4)
						} else {
							v129 = v31
						}
						if base.Ui32(v103) <= base.Ui32(int32(1)) {
										...
										if v133&int32(8) != 0 {
											...
											if v142 != 0 {
												...
												if v147 != 0 {
													...
													v148 = F_DirectFunctionCall2Coll(m, int32(1316), v137, v141, v146)
													mBase = m.M
													v149 = m.ExcPending
													if v149 != 0 {
														return int32(0)
														...
														if v151 != 0 {
															...
															v152 = F_DirectFunctionCall2Coll(m, int32(1281), v137, v131, v150)
															mBase = m.M
															v153 = m.ExcPending
															if v153 != 0 {
																return int32(0)
...
L2:
	...
	if base.Ui32(int32(_a_F_numeric_trim_scale_0)) <= base.Ui32(v20) {
		goto L4
	} else {
		goto L5
	}
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+12)) = v50
	v57 = v20 & int32(_a_F_numeric_trim_scale_0)
...
L18:
	;
	v60 = v20 << (uint(int32(1)) % 32) & int32(_a_F_numeric_trim_scale_2)
	goto L20
L19:
	;
	v60 = v57
