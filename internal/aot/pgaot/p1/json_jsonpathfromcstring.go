...
L9:
	;
	F_yy_fatal_error_5(m, int32(713415))
	mBase = m.M
	v324 = m.ExcPending
	if v324 != 0 {
		goto L2
...
L10:
	;
	F_yy_fatal_error_5(m, int32(713374))
	mBase = m.M
	v321 = m.ExcPending
	if v321 != 0 {
		goto L2
...
L16:
	;
	F_yy_fatal_error_5(m, int32(713445))
	mBase = m.M
	v318 = m.ExcPending
	if v318 != 0 {
		goto L2
...
L32:
	;
	F_yy_fatal_error_5(m, int32(713805))
	mBase = m.M
	v311 = m.ExcPending
	if v311 != 0 {
		goto L2
...
L51:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(461194))
	mBase = m.M
	v6091 = m.ExcPending
	if v6091 != 0 {
		goto L2
...
L53:
	;
	F_jsonpath_yyerror(m, v6024, v6026, int32(222902))
	mBase = m.M
	v6052 = m.ExcPending
	if v6052 != 0 {
		goto L2
...
L56:
	;
	v444 = int32(*(*int16)(unsafe.Add(mBase, uint32(v345<<(uint(int32(1))%32))+uint32(_consts[1082]))))
	if v444 == int32(-47) {
		v4827 = v340
		v4828 = v341
		v4829 = v342
...
L80:
	;
	v4891 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v4872)+uint32(_consts[1083]))))
...
L81:
	;
	v4857 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v4832)+uint32(_consts[1084]))))
	if v4857 == int32(0) {
		v6022 = v4827
		v6023 = v4828
		v6024 = v4829
...
L94:
	;
	v466 = *(*int32)(unsafe.Add(mBase, _consts[1085]))
...
L97:
	;
	v472 = *(*int32)(unsafe.Add(mBase, _consts[361]))
...
L107:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v547))) = uint8(v548)
	...
	v555 = *(*int32)(unsafe.Add(mBase, uint32(v550<<(uint(int32(2))%32))+uint32(_consts[1086])))
	v559 = v548
	v562 = v555
	v563 = v547
	v568 = v547
...
L121:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(435238))
	mBase = m.M
	v3721 = m.ExcPending
	if v3721 != 0 {
		goto L2
...
L122:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(435199))
	mBase = m.M
	v3717 = m.ExcPending
	if v3717 != 0 {
		goto L2
...
L125:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(337952))
	mBase = m.M
	v3597 = m.ExcPending
	if v3597 != 0 {
		goto L2
...
L126:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(346617))
	mBase = m.M
	v3593 = m.ExcPending
	if v3593 != 0 {
		goto L2
...
L131:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(101351))
	mBase = m.M
	v3476 = m.ExcPending
	if v3476 != 0 {
		goto L2
...
L146:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(324851))
	mBase = m.M
	v2563 = m.ExcPending
	if v2563 != 0 {
		goto L2
...
L147:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(324815))
	mBase = m.M
	v2559 = m.ExcPending
	if v2559 != 0 {
		goto L2
...
L155:
	;
	F_yy_fatal_error_5(m, int32(474061))
	mBase = m.M
	v2465 = m.ExcPending
	if v2465 != 0 {
		goto L2
...
L170:
	;
	F_yy_fatal_error_5(m, int32(443739))
	mBase = m.M
	v998 = m.ExcPending
	if v998 != 0 {
		goto L2
...
L244:
	;
	F_yy_fatal_error_5(m, int32(32741))
	mBase = m.M
	v2250 = m.ExcPending
	if v2250 != 0 {
		goto L2
...
L250:
	;
	F_yy_fatal_error_5(m, int32(713759))
	mBase = m.M
	v2015 = m.ExcPending
	if v2015 != 0 {
		goto L2
...
L252:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v344)+36)) = v1952
	...
	v1959 = *(*int32)(unsafe.Add(mBase, uint32(v1954<<(uint(int32(2))%32))+uint32(_consts[1086])))
...
L255:
	;
	F_yy_fatal_error_5(m, int32(474709))
	mBase = m.M
	v1590 = m.ExcPending
	if v1590 != 0 {
		goto L2
...
L256:
	;
	F_yy_fatal_error_5(m, int32(470365))
	mBase = m.M
	v1587 = m.ExcPending
	if v1587 != 0 {
		goto L2
...
L258:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v344)+36)) = v1042
	...
	v1049 = *(*int32)(unsafe.Add(mBase, uint32(v1044<<(uint(int32(2))%32))+uint32(_consts[1086])))
...
L390:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v344)+36)) = v1860
	...
	v1867 = *(*int32)(unsafe.Add(mBase, uint32(v1862<<(uint(int32(2))%32))+uint32(_consts[1086])))
...
L607:
	;
	F_jsonpath_yyerror(m, v342, v344, int32(109623))
	mBase = m.M
	v3784 = m.ExcPending
	if v3784 != 0 {
		goto L2
...
L768:
	;
	v4794 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v4763)+uint32(_consts[1087]))))
	v4795 = v4763
	v4796 = v4794
	goto L83
L769:
	...
	v4804 = int32(*(*int16)(unsafe.Add(mBase, uint32(v4801)+uint32(_consts[1088]))))
	if v4796 != v4804 {
		v4827 = v4757
		v4828 = v4758
		v4829 = v4759
...
L770:
	;
	v4808 = int32(*(*int16)(unsafe.Add(mBase, uint32(v4801)+uint32(_consts[1089]))))
	if v4808 <= int32(0) {
		goto L771
	} else {
		goto L772
...
L782:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5957))) = v5929
	...
	v5965 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v4872)+uint32(_consts[1090]))))
	v5969 = (v5965 - int32(68)) << (uint(v5959) % 32)
	v5972 = int32(*(*int16)(unsafe.Add(mBase, uint32(v5969)+uint32(_consts[1091]))))
	v5973 = v5962 + v5972
...
L1126:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v4873)+32)) = int32(336431)
	F_errmsg(m, int32(199498), v4873+int32(32))
	mBase = m.M
	v5698 = m.ExcPending
	if v5698 != 0 {
		goto L2
...
L1127:
	;
	F_errdetail(m, int32(683394), int32(0))
	mBase = m.M
	v5702 = m.ExcPending
	if v5702 != 0 {
		goto L2
...
L1128:
	;
	F_errsave_finish(m, v4862, int32(27522), int32(269), int32(378030))
	mBase = m.M
	v5707 = m.ExcPending
	if v5707 != 0 {
		goto L2
...
L1204:
	;
	v5991 = int32(*(*int16)(unsafe.Add(mBase, uint32(v5969)+uint32(_consts[1092]))))
	v5992 = v4860
	v5993 = v4861
	v5994 = v4862
	v5996 = v4864
...
L1205:
	;
	v5980 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v5973<<(uint(int32(1))%32))+uint32(_consts[1088]))))
...
L1206:
	;
	v5988 = int32(*(*int16)(unsafe.Add(mBase, uint32(v5973<<(uint(int32(1))%32))+uint32(_consts[1089]))))
	v5992 = v4860
	v5993 = v4861
	v5994 = v4862
	v5996 = v4864
...
L1214:
	;
	F_jsonpath_yyerror(m, v6128, v6130, int32(70855))
	mBase = m.M
	v6159 = m.ExcPending
	if v6159 != 0 {
		goto L2
...
L1220:
	;
	F_errfinish(m, int32(329120), int32(535), int32(336379))
	mBase = m.M
	v6181 = m.ExcPending
	if v6181 != 0 {
		goto L2
...
L1232:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6145))) = int32(336431)
	F_errmsg(m, int32(757762), v6145)
	mBase = m.M
	v6202 = m.ExcPending
	if v6202 != 0 {
		goto L2
...
L1233:
	;
	F_errsave_finish(m, v6128, int32(521387), int32(186), int32(346172))
	mBase = m.M
	v6207 = m.ExcPending
	if v6207 != 0 {
		goto L2
