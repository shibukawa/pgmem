...
func F_ReadTwoPhaseFile(m *base.Module, l0 int32, l1 int32) int32 {
	...
	if v15 != 0 {
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v10)+160)) = uint32(v36)
		v44 = F_pg_snprintf(m, v10+int32(272), int32(1024), int32(509930), v10+int32(160))
		mBase = m.M
		v45 = m.ExcPending
		if v45 != 0 {
			return int32(0)
			...
			if v50 != 0 {
				...
				if v49 < int32(0) {
							...
							if v62 != 0 {
								...
								if v64 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v10))) = v10 + int32(272)
									F_errmsg(m, int32(298525), v10)
									mBase = m.M
									v70 = m.ExcPending
									if v70 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(498548), int32(1309), int32(389935))
										mBase = m.M
										v75 = m.ExcPending
										if v75 != 0 {
											return int32(0)
					...
					if v49 < int32(0) {
						...
						v84 = F___fstatat(m, v49, int32(757108), v10+int32(176), int32(4096))
						mBase = m.M
						v85 = v84
					}
					if v85 != 0 {
						...
						if v158 != 0 {
							...
							if v160 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v10)+144)) = v10 + int32(272)
								F_errmsg(m, int32(297627), v10+int32(144))
								mBase = m.M
								v168 = m.ExcPending
								if v168 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(498548), int32(1321), int32(389935))
									mBase = m.M
									v173 = m.ExcPending
									if v173 != 0 {
										return int32(0)
							...
							if v177 != 0 {
								...
								if v180 != 0 {
									...
									*(*int64)(unsafe.Add(mBase, uint32(v10)+24)) = v86
									F_errmsg_plural(m, int32(348370), int32(159156), base.I32_wrap_i64(v86), v10+int32(16))
									mBase = m.M
									v191 = m.ExcPending
									if v191 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(498548), int32(1332), int32(389935))
										mBase = m.M
										v196 = m.ExcPending
										if v196 != 0 {
											return int32(0)
								...
								if v200 != 0 {
									...
									if v203 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v10)+128)) = v10 + int32(272)
										F_errmsg(m, int32(715701), v10+int32(128))
										mBase = m.M
										v211 = m.ExcPending
										if v211 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(498548), int32(1339), int32(389935))
											mBase = m.M
											v216 = m.ExcPending
											if v216 != 0 {
												return int32(0)
											...
											if v105 < int32(0) {
												...
												if v218 != 0 {
													...
													*(*int32)(unsafe.Add(mBase, uint32(v10)+96)) = v10 + int32(272)
													F_errmsg(m, int32(299444), v10+int32(96))
													mBase = m.M
													v226 = m.ExcPending
													if v226 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(498548), int32(1353), int32(389935))
														mBase = m.M
														v231 = m.ExcPending
														if v231 != 0 {
															return int32(0)
												...
												*(*int32)(unsafe.Add(mBase, uint32(v10)+112)) = v10 + int32(272)
												F_errmsg(m, int32(429923), v10+int32(112))
												mBase = m.M
												v123 = m.ExcPending
												if v123 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(498548), int32(1357), int32(389935))
													mBase = m.M
													v128 = m.ExcPending
													if v128 != 0 {
														return int32(0)
												...
												if v235 != 0 {
													...
													if v237 != 0 {
														...
														*(*int32)(unsafe.Add(mBase, uint32(v10)+80)) = v10 + int32(272)
														F_errmsg(m, int32(299268), v10+int32(80))
														mBase = m.M
														v245 = m.ExcPending
														if v245 != 0 {
															return int32(0)
														} else {
															F_errfinish(m, int32(498548), int32(1365), int32(389935))
															mBase = m.M
															v250 = m.ExcPending
															if v250 != 0 {
																return int32(0)
													...
													if v254 != 0 {
														...
														if v257 != 0 {
															...
															*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = v10 + int32(272)
															F_errmsg(m, int32(716005), v10-int32(-64))
															mBase = m.M
															v265 = m.ExcPending
															if v265 != 0 {
																return int32(0)
															} else {
																F_errfinish(m, int32(498548), int32(1372), int32(389935))
																mBase = m.M
																v270 = m.ExcPending
																if v270 != 0 {
																	return int32(0)
														...
														if v274 != 0 {
															...
															if v277 != 0 {
																...
																*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = v10 + int32(272)
																F_errmsg(m, int32(716046), v10+int32(48))
																mBase = m.M
																v285 = m.ExcPending
																if v285 != 0 {
																	return int32(0)
																} else {
																	F_errfinish(m, int32(498548), int32(1378), int32(389935))
																	mBase = m.M
																	v290 = m.ExcPending
																	if v290 != 0 {
																		return int32(0)
															...
															if v294 != 0 {
																...
																if v297 != 0 {
																	...
																	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v10 + int32(272)
																	F_errmsg(m, int32(716079), v10+int32(32))
																	mBase = m.M
																	v305 = m.ExcPending
																	if v305 != 0 {
																		return int32(0)
																	} else {
																		F_errfinish(m, int32(498548), int32(1390), int32(389935))
																		mBase = m.M
																		v310 = m.ExcPending
																		if v310 != 0 {
																			return int32(0)
...
func F_RemoveTwoPhaseFile(m *base.Module, l0 int32, l1 int32) {
	...
	if v11 != 0 {
		...
		*(*uint32)(unsafe.Add(mBase, uint32(v8)+16)) = uint32(v32)
		v40 = F_pg_snprintf(m, v8+int32(32), int32(1024), int32(509930), v8+int32(16))
		mBase = m.M
		v41 = m.ExcPending
		if v41 != 0 {
			return
								...
								if v60 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v8))) = v8 + int32(32)
									...
									if v66 != 0 {
										...
										F_errfinish(m, int32(498548), int32(1716), int32(389895))
										mBase = m.M
										v71 = m.ExcPending
										if v71 != 0 {
											return
			...
			if v15 == int32(0) {
				...
				if v22 != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
					F_errmsg_internal(m, int32(53939), v7)
					mBase = m.M
					v26 = m.ExcPending
					if v26 != 0 {
						return
					} else {
						F_errfinish(m, int32(499762), int32(1809), int32(353901))
						mBase = m.M
						v31 = m.ExcPending
						if v31 != 0 {
							return
