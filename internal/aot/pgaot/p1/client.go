...
func F_ProcessClientReadInterrupt(m *base.Module, l0 int32) {
	...
	v6 = int32(*(*uint8)(unsafe.Add(mBase, _consts[829])))
	if v6 != 0 {
		...
		if v8 != 0 {
			...
			if v10 != 0 {
				...
				v12 = *(*int32)(unsafe.Add(mBase, _consts[830]))
				if v12 != 0 {
		...
		v25 = *(*int32)(unsafe.Add(mBase, _consts[766]))
		if v25 == int32(0) {
			*(*int32)(unsafe.Add(mBase, _consts[137])) = v4
			return
		} else {
				...
				if v19 != 0 {
					...
					if v18 == int32(0) {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v5))) = v11
						F_errmsg_internal(m, int32(476070), v5)
						mBase = m.M
						v25 = m.ExcPending
						if v25 != 0 {
							return
						} else {
							F_errfinish(m, int32(524069), int32(799), int32(352809))
							mBase = m.M
							v30 = m.ExcPending
							if v30 != 0 {
								return
