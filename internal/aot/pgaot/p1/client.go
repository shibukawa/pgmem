	...
	if v6 != 0 {
		...
		if v8 != 0 {
			...
			if v10 != 0 {
				...
				v12 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessClientReadInterrupt[3]))
				if v12 != 0 {
					...
					if v14 != 0 {
						...
						v16 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessClientReadInterrupt[4]))
						if v16 == int32(0) {
		...
		v25 = *(*int32)(unsafe.Add(mBase, _c_F_ProcessClientReadInterrupt[5]))
		if v25 == int32(0) {
			*(*int32)(unsafe.Add(mBase, _c_F_ProcessClientReadInterrupt[0])) = v4
			return
		} else {
