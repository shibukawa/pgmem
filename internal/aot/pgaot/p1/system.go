...
func F_system_nextsampletuple(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v7 = v5 + int32(1)
	if base.Ui32(v7&int32(_a_F_system_nextsampletuple_0)) <= base.Ui32(l2) {
		v12 = v7
	} else {
		v12 = int32(0)
	}
	*(*uint16)(unsafe.Add(mBase, uint32(v4)+16)) = uint16(v12)
	return v12 & int32(_a_F_system_nextsampletuple_0)
}
func F_system_time_nextsampletuple(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v7 = v5 + int32(1)
	if base.Ui32(v7&int32(_a_F_system_time_nextsampletuple_0)) <= base.Ui32(l2) {
		v12 = v7
	} else {
		v12 = int32(0)
	}
