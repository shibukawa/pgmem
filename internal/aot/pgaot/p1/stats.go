...
func F_set_stats_slot(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32, l6 int32, l7 int32, l8 int32, l9 int32) {
	...
	v27 = l3 & int32(_a_F_set_stats_slot_0)
	if v24 == v27 {
		v68 = v25
		v69 = v11
		v71 = v11
		...
		if v27 == v31 {
			...
			v44 = l3 & int32(_a_F_set_stats_slot_0)
			if v44 == v38 {
				v68 = v42
				v69 = v36
				v71 = v11
				...
				if v48 == v44 {
					...
					v57 = int32(_a_F_set_stats_slot_0)
					v58 = v56 & v57
	...
	if v77 < int32(5) {
		...
		if v159 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v20))) = v77 + int32(1)
			F_errmsg(m, int32(_a_F_set_stats_slot_3), v20)
			mBase = m.M
			v165 = m.ExcPending
			if v165 != 0 {
				return
