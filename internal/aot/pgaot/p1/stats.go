...
func F_assign_stats_fetch_consistency(m *base.Module, l0 int32, l1 int32) {
	...
	var v7 int32
	_ = v7
	v4 = *(*int32)(unsafe.Add(mBase, _consts[926]))
	if l0 != v4 {
		v7 = int32(1)
		*(*uint8)(unsafe.Add(mBase, _consts[933])) = uint8(v7)
	} else {
	}
	return
}
	...
	if v77 < int32(5) {
		...
		if v159 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v20))) = v77 + int32(1)
			F_errmsg(m, int32(479396), v20)
			mBase = m.M
			v165 = m.ExcPending
			if v165 != 0 {
				return
			} else {
				F_errfinish(m, int32(485219), int32(782), int32(83644))
				mBase = m.M
				v170 = m.ExcPending
				if v170 != 0 {
					return
		...
		if v18 != 0 {
			...
			if v21 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = v23
				F_errmsg(m, int32(298477), v7)
				mBase = m.M
				v27 = m.ExcPending
				if v27 != 0 {
					return
				} else {
					F_errfinish(m, int32(485511), int32(48), int32(321531))
					mBase = m.M
					v32 = m.ExcPending
					if v32 != 0 {
						return
