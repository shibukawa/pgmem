	...
	if base.Ui64(int64(9218868437227405312)) < base.Ui64(base.I64_reinterpret_f64(v10)&int64(9223372036854775807)) {
		...
		if v73 != 0 {
			...
			if v76 != 0 {
				...
				F_errmsg(m, int32(247377), int32(0))
				mBase = m.M
				v80 = m.ExcPending
				if v80 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(484661), int32(1119), int32(539074))
					mBase = m.M
					v85 = m.ExcPending
					if v85 != 0 {
						return int32(0)
		...
		if v36 != 0 {
			...
			if v39 != 0 {
				...
				if v43 != 0 {
					...
					F_errfinish(m, int32(484231), int32(746), int32(541700))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
...
L10:
	;
	F_errsave_finish(m, v24, int32(485261), int32(105), int32(275153))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L1
...
L45:
	;
	F_errdetail(m, int32(569797), int32(0))
	mBase = m.M
	v163 = m.ExcPending
	if v163 != 0 {
		goto L1
...
L46:
	;
	F_errsave_finish(m, v24, int32(485261), int32(159), int32(275153))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L1
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+80)) = v25
	F_errmsg(m, int32(700348), v20+int32(80))
	mBase = m.M
	v244 = m.ExcPending
	if v244 != 0 {
		goto L1
...
L68:
	;
	F_errdetail(m, int32(567349), int32(0))
	mBase = m.M
	v248 = m.ExcPending
	if v248 != 0 {
		goto L1
...
L69:
	;
	F_errsave_finish(m, v24, int32(485261), int32(191), int32(275153))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L1
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+48)) = v25
	F_errmsg(m, int32(700348), v20+int32(48))
	mBase = m.M
	v303 = m.ExcPending
	if v303 != 0 {
		goto L1
...
L89:
	;
	F_errsave_finish(m, v24, int32(485261), int32(218), int32(275153))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L1
...
L96:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+64)) = v25
	F_errmsg(m, int32(700348), v20-int32(-64))
	mBase = m.M
	v328 = m.ExcPending
	if v328 != 0 {
		goto L1
...
L98:
	;
	F_errsave_finish(m, v24, int32(485261), int32(229), int32(275153))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L122:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+16)) = v25
	F_errmsg(m, int32(700348), v20+int32(16))
	mBase = m.M
	v493 = m.ExcPending
	if v493 != 0 {
		goto L1
...
L123:
	;
	F_errdetail(m, int32(569767), int32(0))
	mBase = m.M
	v497 = m.ExcPending
	if v497 != 0 {
		goto L1
...
L124:
	;
	F_errsave_finish(m, v24, int32(485261), int32(297), int32(275153))
	mBase = m.M
	v502 = m.ExcPending
	if v502 != 0 {
		goto L1
...
L128:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+32)) = v25
	F_errmsg(m, int32(700348), v20+int32(32))
	mBase = m.M
	v515 = m.ExcPending
	if v515 != 0 {
		goto L1
...
L129:
	;
	F_errdetail(m, int32(567236), int32(0))
	mBase = m.M
	v519 = m.ExcPending
	if v519 != 0 {
		goto L1
...
L130:
	;
	F_errsave_finish(m, v24, int32(485261), int32(286), int32(275153))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
