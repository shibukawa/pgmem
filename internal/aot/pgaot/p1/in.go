...
func F_IsInParallelMode(m *base.Module) int32 {
	...
	var v8 int32
	_ = v8
	v5 = *(*int32)(unsafe.Add(mBase, _c_F_IsInParallelMode[0]))
...
L10:
	;
	F_errsave_finish(m, v24, int32(_a_F_record_in_1), int32(105), int32(_a_F_record_in_2))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L1
...
L46:
	;
	F_errsave_finish(m, v24, int32(_a_F_record_in_1), int32(159), int32(_a_F_record_in_2))
	mBase = m.M
	v168 = m.ExcPending
	if v168 != 0 {
		goto L1
...
L69:
	;
	F_errsave_finish(m, v24, int32(_a_F_record_in_1), int32(191), int32(_a_F_record_in_2))
	mBase = m.M
	v253 = m.ExcPending
	if v253 != 0 {
		goto L1
...
L89:
	;
	F_errsave_finish(m, v24, int32(_a_F_record_in_1), int32(218), int32(_a_F_record_in_2))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L1
...
L98:
	;
	F_errsave_finish(m, v24, int32(_a_F_record_in_1), int32(229), int32(_a_F_record_in_2))
	mBase = m.M
	v337 = m.ExcPending
	if v337 != 0 {
		goto L1
...
L124:
	;
	F_errsave_finish(m, v24, int32(_a_F_record_in_1), int32(297), int32(_a_F_record_in_2))
	mBase = m.M
	v502 = m.ExcPending
	if v502 != 0 {
		goto L1
...
L130:
	;
	F_errsave_finish(m, v24, int32(_a_F_record_in_1), int32(286), int32(_a_F_record_in_2))
	mBase = m.M
	v524 = m.ExcPending
	if v524 != 0 {
		goto L1
