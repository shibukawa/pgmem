...
func F_pgl_run_atexit_funcs(m *base.Module) {
	...
	_ = v72
	v1 = int32(0)
	v7 = *(*int32)(unsafe.Add(mBase, _consts[776]))
	if v7 <= v1 {
		goto L1
	} else {
		goto L2
...
L1:
	;
	*(*int32)(unsafe.Add(mBase, _consts[776])) = int32(0)
	return
L2:
	;
	v11 = v7 & int32(3)
...
L7:
	;
	v20 = v15 - int32(1)
	v25 = *(*int32)(unsafe.Add(mBase, uint32(v20<<(uint(int32(2))%32))+uint32(_consts[777])))
	if v25 != 0 {
		goto L9
	} else {
		goto L10
...
L16:
	...
	v47 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1278])))
	if v47 != 0 {
		goto L18
	} else {
		goto L19
...
L20:
	;
	v52 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1279])))
	if v52 != 0 {
		goto L22
	} else {
		goto L23
...
L24:
	;
	v56 = v39 - int32(3)
	v61 = *(*int32)(unsafe.Add(mBase, uint32(v56<<(uint(int32(2))%32))+uint32(_consts[777])))
	if v61 != 0 {
		goto L26
	} else {
		goto L27
...
L28:
	;
	v65 = v39 - int32(4)
	v70 = *(*int32)(unsafe.Add(mBase, uint32(v65<<(uint(int32(2))%32))+uint32(_consts[777])))
	if v70 != 0 {
		goto L30
	} else {
		goto L31
...
func F_pgl_set_system_fn(m *base.Module, l0 int32) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _consts[1277])) = l0
	return
}
...
func F_pgl_shmctl(m *base.Module, l0 int32, l1 int32, l2 int32) int32 {
	...
	v11 = v9 - int32(32)
	m.G0 = v11
	v14 = *(*int32)(unsafe.Add(mBase, _consts[767]))
	if v14 == v4 {
		goto L3
	} else {
		goto L4
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	v95 = *(*int32)(unsafe.Add(mBase, _consts[466]))
	F_fiprintf(m, v95, int32(788354), v11)
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
		goto L26
...
L19:
	;
	*(*int32)(unsafe.Add(mBase, _consts[767])) = v44
	goto L16
L20:
	;
	if l1 != int32(1) {
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = l1
	v74 = *(*int32)(unsafe.Add(mBase, _consts[466]))
	F_fiprintf(m, v74, int32(788461), v11+int32(16))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L26
...
func F_pgl_system(m *base.Module, l0 int32) int32 {
	...
	var v12 int32
	_ = v12
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1277]))
	if v4 == int32(0) {
		return int32(123)
	} else {
