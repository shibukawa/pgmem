...
L16:
	...
	v47 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1277])))
	if v47 != 0 {
		goto L18
	} else {
		goto L19
...
L20:
	;
	v52 = *(*int32)(unsafe.Add(mBase, uint32(v44)+uint32(_consts[1278])))
	if v52 != 0 {
		goto L22
	} else {
		goto L23
...
func F_pgl_set_system_fn(m *base.Module, l0 int32) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _consts[1276])) = l0
	return
}
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	...
	F_fiprintf(m, v95, int32(787307), v11)
	mBase = m.M
	v98 = m.ExcPending
	if v98 != 0 {
		goto L26
...
L23:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11)+16)) = l1
	...
	F_fiprintf(m, v74, int32(787414), v11+int32(16))
	mBase = m.M
	v81 = m.ExcPending
	if v81 != 0 {
		goto L26
...
func F_pgl_system(m *base.Module, l0 int32) int32 {
	...
	var v12 int32
	_ = v12
	v4 = *(*int32)(unsafe.Add(mBase, _consts[1276]))
	if v4 == int32(0) {
		return int32(123)
	} else {
