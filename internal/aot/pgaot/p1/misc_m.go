		...
		if v19 != 0 {
				...
				if v23 == int32(0) {
					...
					if v60 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v19
						F_errmsg_internal(m, int32(46402), v16+int32(16))
						mBase = m.M
						v66 = m.ExcPending
						if v66 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(516005), int32(232), int32(252975))
							mBase = m.M
							v71 = m.ExcPending
							if v71 != 0 {
								return int32(0)
			...
			if v43 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v16))) = int32(3)
				F_errmsg_internal(m, int32(42403), v16)
				mBase = m.M
				v51 = m.ExcPending
				if v51 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(516005), int32(228), int32(252975))
					mBase = m.M
					v56 = m.ExcPending
					if v56 != 0 {
						return int32(0)
...
L4:
	;
	v30 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v21)+uint32(_consts[1273]))))
	if v30 == int32(0) {
		v50 = v24
		goto L6
	} else {
...
L98:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13))) = v353
	v359 = F_pg_snprintf(m, l0+v348, int32(1024)-v348, int32(186074), v13)
	mBase = m.M
	v360 = m.ExcPending
	if v360 != 0 {
		goto L99
	...
	case 1:
		...
		if int32(126) <= v446 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v708 ^ v700 - base.I32_rotl(v708, int32(24))
			v720 = F_pg_snprintf(m, v10+int32(38), int32(10), int32(30746), v10+int32(32))
			mBase = m.M
			v721 = m.ExcPending
			if v721 != 0 {
				return int32(0)
					...
					if v48 != 0 {
						...
						if v145 < int32(126) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v10)+16)) = v407 ^ v399 - base.I32_rotl(v407, int32(24))
							v419 = F_pg_snprintf(m, v10+int32(38), int32(10), int32(30746), v10+int32(16))
							mBase = m.M
							v420 = m.ExcPending
							if v420 != 0 {
								return int32(0)
	...
	default:
		...
		if v745 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v10))) = v746
			F_errmsg_internal(m, int32(506707), v10)
			mBase = m.M
			v750 = m.ExcPending
			if v750 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(519750), int32(1403), int32(21599))
				mBase = m.M
				v755 = m.ExcPending
				if v755 != 0 {
					return int32(0)
...
L57:
	;
	F_errmsg(m, int32(28237), int32(0))
	mBase = m.M
	v224 = m.ExcPending
	if v224 != 0 {
		goto L1
...
L58:
	;
	F_errsave_finish(m, v213, int32(520890), int32(184), int32(315360))
	mBase = m.M
	v229 = m.ExcPending
	if v229 != 0 {
		goto L1
...
L80:
	;
	F_errsave_finish(m, v333, int32(520890), int32(211), int32(315360))
	mBase = m.M
	v349 = m.ExcPending
	if v349 != 0 {
		goto L1
...
L13:
	;
	F_errfinish(m, int32(521091), int32(1043), int32(222363))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L1
...
L34:
	;
	F_errdetail(m, int32(625564), int32(0))
	mBase = m.M
	v120 = m.ExcPending
	if v120 != 0 {
		goto L27
...
L35:
	;
	F_errfinish(m, int32(518454), int32(1694), int32(163883))
	mBase = m.M
	v125 = m.ExcPending
	if v125 != 0 {
		goto L27
...
L18:
	;
	F_errmsg_internal(m, int32(91430), int32(0))
	mBase = m.M
	v48 = m.ExcPending
	if v48 != 0 {
		goto L17
...
L19:
	;
	F_errfinish(m, int32(518294), int32(4408), int32(142101))
	mBase = m.M
	v53 = m.ExcPending
	if v53 != 0 {
		goto L17
...
L68:
	;
	F_errmsg_internal(m, int32(375401), int32(0))
	mBase = m.M
	v244 = m.ExcPending
	if v244 != 0 {
		goto L1
...
L69:
	;
	F_errfinish(m, int32(514695), int32(1647), int32(249700))
	mBase = m.M
	v249 = m.ExcPending
	if v249 != 0 {
		goto L1
...
L205:
	;
	F_errfinish(m, int32(514695), int32(1735), int32(249700))
	mBase = m.M
	v939 = m.ExcPending
	if v939 != 0 {
		goto L1
...
L208:
	;
	F_errfinish(m, int32(514695), int32(1739), int32(249700))
	mBase = m.M
	v952 = m.ExcPending
	if v952 != 0 {
		goto L1
...
L11:
	;
	F_errmsg_internal(m, int32(118023), int32(0))
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		goto L8
...
L12:
	;
	F_errfinish(m, int32(514695), int32(1550), int32(281585))
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L8
...
L39:
	;
	F_errmsg_internal(m, int32(117981), int32(0))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L8
...
L40:
	;
	F_errfinish(m, int32(514695), int32(1573), int32(281585))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L8
...
L67:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20)+20)) = l2 + l4 - int32(1)
	F_errmsg(m, int32(168569), v20+int32(16))
	mBase = m.M
	v348 = m.ExcPending
	if v348 != 0 {
		goto L3
...
L68:
	;
	F_errfinish(m, int32(523278), int32(962), int32(37168))
	mBase = m.M
	v353 = m.ExcPending
	if v353 != 0 {
		goto L3
...
L85:
	;
	F_errfinish(m, int32(523278), int32(913), int32(37168))
	mBase = m.M
	v441 = m.ExcPending
	if v441 != 0 {
		goto L3
...
L87:
	;
	F_errmsg_internal(m, int32(18449), int32(0))
	mBase = m.M
	v449 = m.ExcPending
	if v449 != 0 {
		goto L3
...
L88:
	;
	F_errfinish(m, int32(523278), int32(875), int32(37168))
	mBase = m.M
	v454 = m.ExcPending
	if v454 != 0 {
		goto L3
...
L11:
	;
	F_errfinish(m, int32(523278), int32(1305), int32(374593))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L8
...
L49:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v165
	F_errmsg(m, int32(312976), v15+int32(16))
	mBase = m.M
	v171 = m.ExcPending
	if v171 != 0 {
		goto L8
...
L50:
	;
	F_errfinish(m, int32(523278), int32(1333), int32(374593))
	mBase = m.M
	v176 = m.ExcPending
	if v176 != 0 {
		goto L8
...
L54:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v189
	F_errmsg(m, int32(306806), v15+int32(32))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L8
...
L55:
	;
	F_errfinish(m, int32(523278), int32(1360), int32(374593))
	mBase = m.M
	v201 = m.ExcPending
	if v201 != 0 {
		goto L8
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v162))) = int32(1880064)
	v171 = v152 + int32(1)
	v172 = v150 - v166
...
L77:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = v329
	F_errmsg(m, int32(309747), v16+int32(16))
	mBase = m.M
	v335 = m.ExcPending
	if v335 != 0 {
		goto L11
...
L79:
	;
	F_errfinish(m, int32(523278), int32(619), int32(445360))
	mBase = m.M
	v344 = m.ExcPending
	if v344 != 0 {
		goto L11
...
L97:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v404))) = int32(1880064)
	v413 = v394 + int32(1)
	v414 = v392 - v408
...
L136:
	;
	F_errfinish(m, int32(523278), int32(566), int32(445360))
	mBase = m.M
	v601 = m.ExcPending
	if v601 != 0 {
		goto L11
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+32)) = v607
	F_errmsg_internal(m, int32(508731), v16+int32(32))
	mBase = m.M
	v613 = m.ExcPending
	if v613 != 0 {
		goto L11
...
L139:
	;
	F_errfinish(m, int32(523278), int32(611), int32(445360))
	mBase = m.M
	v618 = m.ExcPending
	if v618 != 0 {
		goto L11
...
L143:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+48)) = v631
	F_errmsg(m, int32(313154), v16+int32(48))
	mBase = m.M
	v637 = m.ExcPending
	if v637 != 0 {
		goto L11
...
L145:
	;
	F_errfinish(m, int32(523278), int32(641), int32(445360))
	mBase = m.M
	v646 = m.ExcPending
	if v646 != 0 {
		goto L11
...
L18:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+80)) = l0
	F_errmsg(m, int32(78129), v33+int32(80))
	mBase = m.M
	v243 = m.ExcPending
	if v243 != 0 {
		v2487 = v102
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errfinish(m, int32(517113), int32(2034), int32(527474))
	mBase = m.M
	v269 = m.ExcPending
	if v269 != 0 {
		v2487 = v102
...
L31:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errmsg(m, int32(379314), int32(0))
	mBase = m.M
	v444 = m.ExcPending
	if v444 != 0 {
		v2487 = v102
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errfinish(m, int32(517113), int32(2058), int32(527474))
	mBase = m.M
	v470 = m.ExcPending
	if v470 != 0 {
		v2487 = v102
...
L44:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errmsg(m, int32(438531), int32(0))
	mBase = m.M
	v642 = m.ExcPending
	if v642 != 0 {
		v2487 = v102
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errfinish(m, int32(517113), int32(2080), int32(527474))
	mBase = m.M
	v668 = m.ExcPending
	if v668 != 0 {
		v2487 = v102
...
L57:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+32)) = l0
	F_errmsg(m, int32(141942), v33+int32(32))
	mBase = m.M
	v816 = m.ExcPending
	if v816 != 0 {
		v2487 = v102
...
L59:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errfinish(m, int32(517113), int32(2104), int32(527474))
	mBase = m.M
	v867 = m.ExcPending
	if v867 != 0 {
		v2487 = v102
...
L87:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+48)) = v913
	F_errmsg_internal(m, int32(310223), v33+int32(48))
	mBase = m.M
	v1245 = m.ExcPending
	if v1245 != 0 {
		v2487 = v102
...
L88:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errfinish(m, int32(517113), int32(2177), int32(527474))
	mBase = m.M
	v1271 = m.ExcPending
	if v1271 != 0 {
		v2487 = v102
...
L91:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+64)) = l0
	F_errmsg(m, int32(754605), v33-int32(-64))
	mBase = m.M
	v1348 = m.ExcPending
	if v1348 != 0 {
		v2487 = v102
...
L92:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errhint(m, int32(673144), int32(0))
	mBase = m.M
	v1373 = m.ExcPending
	if v1373 != 0 {
		v2487 = v102
...
L93:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v69
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v72
	F_errfinish(m, int32(517113), int32(2166), int32(527474))
	mBase = m.M
	v1399 = m.ExcPending
	if v1399 != 0 {
		v2487 = v102
...
L116:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v1481
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v1482
	F_errfinish(m, int32(517113), int32(2232), int32(527474))
	mBase = m.M
	v1794 = m.ExcPending
	if v1794 != 0 {
		v2487 = v1492
...
L138:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+16)) = v1480
	F_errmsg(m, int32(722378), v33+int32(16))
	mBase = m.M
	v2192 = m.ExcPending
	if v2192 != 0 {
		v2487 = v1492
...
L139:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v33)+172)) = v1481
	*(*int32)(unsafe.Add(mBase, uint32(v33)+168)) = v1482
	F_errfinish(m, int32(517113), int32(2296), int32(527474))
	mBase = m.M
	v2218 = m.ExcPending
	if v2218 != 0 {
		v2487 = v1492
