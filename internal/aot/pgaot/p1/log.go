...
func F_LogCheckpointEnd(m *base.Module, l0 int32) {
	...
	m.G0 = v27 + v26
	*(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[0])) = v31 + v30*int64(1000000) - int64(946684800000000)
	v42 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[1]))
	v44 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[2]))
	if v44 <= v42 {
		v61 = int32(0)
	} else {
	...
	v83 = int32(_a_F_LogCheckpointEnd_0)
	v85 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[4]))
	*(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[4])) = v85 + base.I64_extend_i32_s(v61)
	v89 = int32(_a_F_LogCheckpointEnd_1)
	v91 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[5]))
	*(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[5])) = v91 + base.I64_extend_i32_s(v82)
	v96 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[6])))
	if v96 != int32(1) {
		m.G0 = v19 + int32(112)
		return
	} else {
		v100 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[7]))
		v102 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[0]))
		if v102 <= v100 {
			v119 = int32(0)
		} else {
		...
		v121 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[8]))
		v125 = base.I64_div_u_s(v121+int64(999), int64(1000))
		v127 = *(*int32)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[9]))
		if int32(0) < v127 {
			v131 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[10]))
		...
		if v143 != 0 {
			...
			if v142 == int32(0) {
				...
				v147 = *(*int32)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[11]))
				v148 = *(*int64)(unsafe.Add(mBase, uint32(v147)+40))
				v149 = *(*int64)(unsafe.Add(mBase, uint32(v147)+32))
				v151 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[12]))
				*(*int64)(unsafe.Add(mBase, uint32(v19)+16)) = v151
				v154 = *(*int64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[13]))
				...
				*(*int32)(unsafe.Add(mBase, uint32(v19)+48)) = v163
				v166 = *(*int32)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[9]))
				...
				*(*int32)(unsafe.Add(mBase, uint32(v19)+72)) = v139 - v173*v156
				v200 = *(*float64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[14]))
				...
				*(*int32)(unsafe.Add(mBase, uint32(v19)+76)) = v208
				v211 = *(*float64)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[15]))
				...
				*(*uint32)(unsafe.Add(mBase, uint32(v19)+92)) = uint32(v225)
				v228 = *(*int32)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[16]))
				*(*int32)(unsafe.Add(mBase, uint32(v19))) = v228
				v234 = *(*int32)(unsafe.Add(mBase, _c_F_LogCheckpointEnd[17]))
				*(*float64)(unsafe.Add(mBase, uint32(v19)+8)) = base.F64_div(base.F64_mul(base.F64_convert_i32_s(v228), float64(100)), base.F64_convert_i32_s(v234))
				if l0 != 0 {
					v240 = int32(_a_F_LogCheckpointEnd_2)
				} else {
					v240 = int32(_a_F_LogCheckpointEnd_3)
				}
				F_errmsg(m, v240, v19)
				mBase = m.M
				v242 = m.ExcPending
				if v242 != 0 {
					...
					if l0 != 0 {
						v246 = int32(_a_F_LogCheckpointEnd_4)
					} else {
						v246 = int32(_a_F_LogCheckpointEnd_5)
					}
					F_errfinish(m, int32(_a_F_LogCheckpointEnd_6), v246, int32(_a_F_LogCheckpointEnd_7))
					mBase = m.M
					v249 = m.ExcPending
					if v249 != 0 {
						return
...
L5:
	;
	v28 = *(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[1])) = v28
	goto L8
L6:
	;
	goto L7
...
L8:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v12)+32)) = int32(_a_F_check_log_connections_0)
	v37 = F_format_elog_string(m, int32(_a_F_check_log_connections_1), v12+int32(32))
	mBase = m.M
	v38 = m.ExcPending
	if v38 != 0 {
		goto L2
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[2])) = v37
	F_pfree(m, v15)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
...
L18:
	...
	v60 = v56
	v61 = int32(_a_F_check_log_connections_2)
	goto L21
L19:
	;
...
L33:
	;
	v679 = int32(_a_F_check_log_connections_3)
	goto L19
L34:
	;
	goto L35
L35:
	;
	v105 = v56
	v106 = int32(_a_F_check_log_connections_4)
	goto L37
L36:
	;
	if v143 == int32(0) {
...
L49:
	;
	v679 = int32(_a_F_check_log_connections_5)
	goto L19
L50:
	;
	goto L51
L51:
	;
	v150 = v56
	v151 = int32(_a_F_check_log_connections_6)
	goto L53
L52:
	;
	if v188 == int32(0) {
...
L65:
	;
	v679 = int32(_a_F_check_log_connections_7)
	goto L19
L66:
	;
	goto L67
L67:
	;
	v195 = v56
	v196 = int32(_a_F_check_log_connections_8)
	goto L69
L68:
	;
	if v233 == int32(0) {
...
L81:
	;
	v679 = int32(_a_F_check_log_connections_9)
	goto L19
L82:
	;
	goto L83
L83:
	;
	v240 = v56
	v241 = int32(_a_F_check_log_connections_10)
	goto L85
L84:
	;
	if v278 == int32(0) {
...
L97:
	;
	v679 = int32(_a_F_check_log_connections_11)
	goto L19
L98:
	;
	goto L99
L99:
	;
	v285 = v56
	v286 = int32(_a_F_check_log_connections_12)
	goto L101
L100:
	;
	if v323 == int32(0) {
...
L113:
	;
	v679 = int32(_a_F_check_log_connections_13)
	goto L19
L114:
	;
	goto L115
L115:
	;
	v330 = v56
	v331 = int32(_a_F_check_log_connections_14)
	goto L117
L116:
	;
	if v368 == int32(0) {
...
L129:
	;
	v679 = int32(_a_F_check_log_connections_15)
	goto L19
L130:
	;
	goto L131
L131:
	;
	v375 = v56
	v376 = int32(_a_F_check_log_connections_16)
	goto L133
L132:
	;
	if v413 == int32(0) {
...
L145:
	;
	v679 = int32(_a_F_check_log_connections_17)
	goto L19
L146:
	;
	goto L147
...
L149:
	...
	v440 = v436
	v441 = int32(_a_F_check_log_connections_18)
	goto L154
L150:
	;
	v668 = *(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[1])) = v668
	goto L224
L151:
	;
	goto L150
...
L153:
	;
	if v478 == int32(0) {
		v659 = int32(_a_F_check_log_connections_19)
		goto L152
	} else {
		goto L166
	}
...
L166:
	;
	v485 = v436
	v486 = int32(_a_F_check_log_connections_20)
	goto L168
L167:
	;
	if v523 == int32(0) {
		v659 = int32(_a_F_check_log_connections_21)
		goto L152
	} else {
		goto L180
	}
...
L180:
	;
	v530 = v436
	v531 = int32(_a_F_check_log_connections_22)
	goto L182
L181:
	;
	if v568 == int32(0) {
		v659 = int32(_a_F_check_log_connections_23)
		goto L152
	} else {
		goto L194
	}
...
L194:
	;
	v575 = v436
	v576 = int32(_a_F_check_log_connections_24)
	goto L196
L195:
	;
	if v613 == int32(0) {
		v659 = int32(_a_F_check_log_connections_25)
		goto L152
	} else {
		goto L208
	}
...
L208:
	;
	v619 = v436
	v620 = int32(_a_F_check_log_connections_26)
	goto L210
L209:
	;
	if v657 != 0 {
...
L222:
	;
	v659 = int32(_a_F_check_log_connections_27)
	goto L152
L223:
	;
	v698 = v661
...
L224:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v436
	v676 = F_format_elog_string(m, int32(_a_F_check_log_connections_28), v12+int32(16))
	mBase = m.M
	v677 = m.ExcPending
	if v677 != 0 {
		goto L2
...
L225:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[2])) = v676
	v698 = v424
	v704 = int32(0)
	goto L12
L226:
	;
	v685 = *(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[0]))
	*(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[1])) = v685
	goto L229
L227:
	;
	goto L228
...
L229:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12))) = v56
	v691 = F_format_elog_string(m, int32(_a_F_check_log_connections_29), v12)
	mBase = m.M
	v692 = m.ExcPending
	if v692 != 0 {
		goto L2
...
L230:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_check_log_connections[2])) = v691
	v698 = int32(0)
	v704 = int32(0)
	goto L12
L231:
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v59
				...
				if v21&int32(128) != 0 {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v59
					...
					if v21&int32(_a_F_log_heap_new_cid_0) != int32(64) {
...
func F_show_log_file_mode(m *base.Module) int32 {
	...
	v4 = v2 - int32(16)
	m.G0 = v4
	v7 = *(*int32)(unsafe.Add(mBase, _c_F_show_log_file_mode[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = v7
	v12 = F_pg_snprintf(m, int32(_a_F_show_log_file_mode_0), int32(12), int32(_a_F_show_log_file_mode_1), v4)
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
		...
		m.G0 = v4 + int32(16)
		return int32(_a_F_show_log_file_mode_0)
	}
}
