	...
	if v40 == int32(0) {
		...
		if v48 != 0 {
			...
			if v52 != 0 {
				...
				F_errfinish(m, int32(488262), int32(4135), int32(336850))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return int32(0)
...
L26:
	;
	F_errfinish(m, int32(488262), int32(3772), int32(35091))
	mBase = m.M
	v73 = m.ExcPending
	if v73 != 0 {
		goto L1
...
L73:
	;
	F_errfinish(m, int32(488262), int32(3841), int32(35091))
	mBase = m.M
	v245 = m.ExcPending
	if v245 != 0 {
		goto L1
				...
				if v17 != int64(9223372036854775807) {
					...
					if v29 != 0 {
						...
						if v32 != 0 {
							...
							F_errmsg(m, int32(369979), int32(0))
							mBase = m.M
							v36 = m.ExcPending
							if v36 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(490962), int32(2085), int32(369375))
								mBase = m.M
								v41 = m.ExcPending
								if v41 != 0 {
									return int32(0)
