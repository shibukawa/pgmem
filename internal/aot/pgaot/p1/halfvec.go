			...
			if int32(0) < v2 {
				...
				for {
					...
					if base.F32_eq(v48, math.Float32frombits(uint32(0x7f800000))) != 0 {
						v127 = v42 & int32(64512)
					} else {
						v52 = v40 & int32(8388607)
						if base.Ui32(int32(2139095041)) <= base.Ui32(base.I32_reinterpret_f32(v48)) {
							v127 = v42&int32(32768) | int32(base.Ui32(v52)>>(uint(int32(13))%32)) | int32(32256)
						} else {
							v64 = v42 & int32(32768)
							...
							if base.Ui32(v68) < base.Ui32(int32(99)) {
								...
								v108 = v107 + v68
								if int32(16) <= v108 {
									v127 = v64 | int32(31744)
								} else {
									if int32(-15) < v108 {
										v118 = v108<<(uint(int32(10))%32) + int32(15360) | v64
									} else {
										v118 = v64
									}
									if v100 == int32(1024) {
...
func F_halfvec_spherical_distance(m *base.Module, l0 int32) int32 {
	...
	if v15 != 0 {
		...
		if v18 != 0 {
			...
			if v19 == v20 {
				v24 = int32(8)
				v29 = *(*int32)(unsafe.Add(mBase, _consts[1487]))
