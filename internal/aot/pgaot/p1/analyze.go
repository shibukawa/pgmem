...
L8:
	;
	v41 = F__emscripten_memcpy_bulkmem(m, v14+int32(8), int32(4362760), int32(128))
	mBase = m.M
	goto L10
L10:
	;
...
L32:
	;
	F_errfinish(m, int32(484445), int32(94), int32(236472))
	mBase = m.M
	v111 = m.ExcPending
	if v111 != 0 {
		goto L19
...
func F_serializeAnalyzeStartup(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	v19 = F_AllocSetContextCreateInternal(m, v14, int32(336350), int32(0), int32(8192), int32(8388608))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		return
