...
L20:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8))) = v52
	F_errmsg_internal(m, int32(_a_F_NameListToString_0), v8)
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L1
...
L59:
	...
	if v137 == v91&int32(_a_F_get_name_for_var_field_0) {
		v151 = v136
		goto L51
	} else {
		goto L61
...
L81:
	...
	if v198 == v91&int32(_a_F_get_name_for_var_field_0) {
		v212 = v197
		goto L73
	} else {
		goto L83
...
L108:
	...
	if v267 == v91&int32(_a_F_get_name_for_var_field_0) {
		v281 = v266
		goto L100
	} else {
		goto L110
...
L133:
	...
	if v330 == v91&int32(_a_F_get_name_for_var_field_0) {
		v344 = v329
		goto L125
	} else {
		goto L135
...
L147:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+112)) = l1
	v383 = F_pg_snprintf(m, v376, int32(32), int32(_a_F_get_name_for_var_field_5), v16+int32(112))
	mBase = m.M
	v384 = m.ExcPending
	if v384 != 0 {
		goto L22
...
L158:
	...
	if v409 == v91&int32(_a_F_get_name_for_var_field_0) {
		v423 = v408
		goto L150
	} else {
		goto L160
...
L206:
	...
	if v558 == v91&int32(_a_F_get_name_for_var_field_0) {
		v572 = v557
		goto L198
	} else {
		goto L208
...
L220:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v16)+64)) = l1
	v623 = F_pg_snprintf(m, v616, int32(32), int32(_a_F_get_name_for_var_field_5), v16-int32(-64))
	mBase = m.M
	v624 = m.ExcPending
	if v624 != 0 {
		goto L22
...
L231:
	...
	if v649 == v91&int32(_a_F_get_name_for_var_field_0) {
		v663 = v648
		goto L223
	} else {
		goto L233
