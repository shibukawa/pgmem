...
L175:
	;
	F_errmsg_internal(m, int32(209038), int32(0))
	mBase = m.M
	v558 = m.ExcPending
	if v558 != 0 {
		goto L27
...
L176:
	;
	F_errfinish(m, int32(490126), int32(579), int32(209454))
	mBase = m.M
	v563 = m.ExcPending
	if v563 != 0 {
		goto L27
...
L215:
	;
	F_errfinish(m, int32(490126), int32(1398), int32(63213))
	mBase = m.M
	v697 = m.ExcPending
	if v697 != 0 {
		goto L27
...
L226:
	;
	F_errfinish(m, int32(490126), int32(1415), int32(63213))
	mBase = m.M
	v721 = m.ExcPending
	if v721 != 0 {
		goto L27
...
L241:
	;
	F_errfinish(m, int32(490126), int32(1431), int32(63213))
	mBase = m.M
	v753 = m.ExcPending
	if v753 != 0 {
		goto L27
...
L261:
	;
	F_errmsg(m, int32(367228), int32(0))
	mBase = m.M
	v824 = m.ExcPending
	if v824 != 0 {
		goto L27
...
L262:
	;
	F_errfinish(m, int32(490126), int32(1484), int32(63213))
	mBase = m.M
	v829 = m.ExcPending
	if v829 != 0 {
		goto L27
...
L271:
	;
	F_errfinish(m, int32(490126), int32(1500), int32(63213))
	mBase = m.M
	v864 = m.ExcPending
	if v864 != 0 {
		goto L27
...
L281:
	;
	F_errmsg(m, int32(375979), int32(0))
	mBase = m.M
	v937 = m.ExcPending
	if v937 != 0 {
		goto L27
...
L282:
	;
	F_errfinish(m, int32(490126), int32(1469), int32(63213))
	mBase = m.M
	v942 = m.ExcPending
	if v942 != 0 {
		goto L27
...
L286:
	;
	F_errfinish(m, int32(490126), int32(1473), int32(63213))
	mBase = m.M
	v958 = m.ExcPending
	if v958 != 0 {
		goto L27
...
L290:
	;
	F_errfinish(m, int32(490126), int32(1491), int32(63213))
	mBase = m.M
	v974 = m.ExcPending
	if v974 != 0 {
		goto L27
							...
							if base.Ui64(v80) <= base.Ui64(int64(9218868437227405312)) {
								...
								if v98 != 0 {
									...
									if v101 != 0 {
										...
										F_errmsg(m, int32(117166), int32(0))
										mBase = m.M
										v105 = m.ExcPending
										if v105 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(485354), int32(1124), int32(230451))
											mBase = m.M
											v110 = m.ExcPending
											if v110 != 0 {
												return int32(0)
