...
L43:
	;
	v124 = *(*int32)(unsafe.Add(mBase, uint32(v117*int32(28))+uint32(_c_F_CopyReadLine[0])))
...
L83:
	;
	v249 = *(*int32)(unsafe.Add(mBase, uint32(v240*int32(28))+uint32(_c_F_CopyReadLine[1])))
	v250 = v249
	goto L85
L84:
	;
...
L91:
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v267+v419))) = uint8(v421)
	...
	v434 = *(*int32)(unsafe.Add(mBase, _c_F_CopyReadLine[2]))
...
L140:
	...
	v437 = v429 - v428
	v438 = v426 + v427
	v442 = F_pg_do_encoding_conversion_buf(m, v431, v432, v435, v428+v430, v437, v438, int32(_a_F_CopyReadLine_0)-v426, int32(1))
	mBase = m.M
	v443 = m.ExcPending
	if v443 != 0 {
		goto L27
...
L172:
	...
	v541 = *(*int32)(unsafe.Add(mBase, _c_F_CopyReadLine[2]))
	v542 = *(*int32)(unsafe.Add(mBase, uint32(v541)+4))
	goto L173
L173:
	;
	v549 = F_pg_do_encoding_conversion_buf(m, v538, v539, v542, v536+v537, v531-v536, v523+v535, int32(_a_F_CopyReadLine_0)-v523, int32(0))
	mBase = m.M
	v550 = m.ExcPending
	if v550 != 0 {
		goto L27
...
L208:
	;
	v683 = int32(_a_F_CopyReadLine_4)
	goto L210
L209:
	;
	v683 = int32(_a_F_CopyReadLine_5)
	goto L210
L210:
	;
...
L212:
	;
	v689 = int32(_a_F_CopyReadLine_6)
	goto L214
L213:
	;
	v689 = int32(_a_F_CopyReadLine_7)
	goto L214
L214:
	;
...
L219:
	;
	v707 = int32(_a_F_CopyReadLine_4)
	goto L221
L220:
	;
	v707 = int32(_a_F_CopyReadLine_5)
	goto L221
L221:
	;
...
L223:
	;
	v713 = int32(_a_F_CopyReadLine_6)
	goto L225
L224:
	;
	v713 = int32(_a_F_CopyReadLine_7)
	goto L225
L225:
	;
...
L234:
	;
	v739 = int32(_a_F_CopyReadLine_9)
	goto L236
L235:
	;
	v739 = int32(_a_F_CopyReadLine_10)
	goto L236
L236:
	;
...
L238:
	;
	v745 = int32(_a_F_CopyReadLine_11)
	goto L240
L239:
	;
	v745 = int32(_a_F_CopyReadLine_12)
	goto L240
L240:
	;
...
L276:
	...
	v919 = F_CopyGetData(m, l0, v917, int32(_a_F_CopyReadLine_14))
	mBase = m.M
	v920 = m.ExcPending
	if v920 != 0 {
		goto L27
