...
L158:
	;
	F_errmsg_internal(m, int32(212015), int32(0))
	mBase = m.M
	v502 = m.ExcPending
	if v502 != 0 {
		goto L27
...
L159:
	;
	F_errfinish(m, int32(498414), int32(579), int32(212431))
	mBase = m.M
	v507 = m.ExcPending
	if v507 != 0 {
		goto L27
...
L198:
	;
	F_errfinish(m, int32(498414), int32(1398), int32(63987))
	mBase = m.M
	v641 = m.ExcPending
	if v641 != 0 {
		goto L27
...
L209:
	;
	F_errfinish(m, int32(498414), int32(1415), int32(63987))
	mBase = m.M
	v665 = m.ExcPending
	if v665 != 0 {
		goto L27
...
L224:
	;
	F_errfinish(m, int32(498414), int32(1431), int32(63987))
	mBase = m.M
	v697 = m.ExcPending
	if v697 != 0 {
		goto L27
...
L244:
	;
	F_errmsg(m, int32(373342), int32(0))
	mBase = m.M
	v768 = m.ExcPending
	if v768 != 0 {
		goto L27
...
L245:
	;
	F_errfinish(m, int32(498414), int32(1484), int32(63987))
	mBase = m.M
	v773 = m.ExcPending
	if v773 != 0 {
		goto L27
...
L254:
	;
	F_errfinish(m, int32(498414), int32(1500), int32(63987))
	mBase = m.M
	v808 = m.ExcPending
	if v808 != 0 {
		goto L27
...
L265:
	;
	F_errfinish(m, int32(498414), int32(1469), int32(63987))
	mBase = m.M
	v886 = m.ExcPending
	if v886 != 0 {
		goto L27
...
L269:
	;
	F_errfinish(m, int32(498414), int32(1473), int32(63987))
	mBase = m.M
	v902 = m.ExcPending
	if v902 != 0 {
		goto L27
...
L273:
	;
	F_errfinish(m, int32(498414), int32(1491), int32(63987))
	mBase = m.M
	v918 = m.ExcPending
	if v918 != 0 {
		goto L27
							...
							if base.Ui64(v80) <= base.Ui64(int64(9218868437227405312)) {
								...
								if v98 != 0 {
									...
									if v101 != 0 {
										...
										F_errmsg(m, int32(119145), int32(0))
										mBase = m.M
										v105 = m.ExcPending
										if v105 != 0 {
											return int32(0)
										} else {
											F_errfinish(m, int32(493522), int32(1124), int32(233934))
											mBase = m.M
											v110 = m.ExcPending
											if v110 != 0 {
												return int32(0)
