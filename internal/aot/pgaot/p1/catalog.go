...
func F_get_catalog_object_by_oid_extended(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32) int32 {
	...
	v15 = *(*int32)(unsafe.Add(mBase, _c_F_get_catalog_object_by_oid_extended[0]))
	if v15 != 0 {
		goto L3
	} else {
		goto L4
...
L7:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_get_catalog_object_by_oid_extended[0])) = v70
	v77 = v70
	goto L2
L8:
	;
	v28 = v23 * int32(40)
	v31 = *(*int32)(unsafe.Add(mBase, uint32(v28)+uint32(_c_F_get_catalog_object_by_oid_extended[1])))
	if v13 != v31 {
		goto L10
	} else {
		goto L11
...
L9:
	;
	v70 = v28 + int32(_a_F_get_catalog_object_by_oid_extended_0)
	goto L7
L10:
	;
	if v23 == int32(36) {
...
L13:
	...
	v41 = *(*int32)(unsafe.Add(mBase, uint32(v38)+uint32(_c_F_get_catalog_object_by_oid_extended[1])))
	if v13 == v41 {
		goto L14
	} else {
		goto L15
...
L14:
	;
	v70 = v38 + int32(_a_F_get_catalog_object_by_oid_extended_0)
	goto L7
L15:
	;
	goto L16
L16:
	...
	v51 = *(*int32)(unsafe.Add(mBase, uint32(v48)+uint32(_c_F_get_catalog_object_by_oid_extended[1])))
	if v13 == v51 {
		goto L17
	} else {
		goto L18
...
L17:
	;
	v70 = v48 + int32(_a_F_get_catalog_object_by_oid_extended_0)
	goto L7
L18:
	;
	goto L19
L19:
	...
	v61 = *(*int32)(unsafe.Add(mBase, uint32(v58)+uint32(_c_F_get_catalog_object_by_oid_extended[1])))
	if v13 == v61 {
		goto L20
	} else {
		goto L21
...
L20:
	;
	v70 = v58 + int32(_a_F_get_catalog_object_by_oid_extended_0)
	goto L7
L21:
	;
	v23 = v23 + int32(4)
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v13
	F_errmsg_internal(m, int32(_a_F_get_catalog_object_by_oid_extended_1), v11)
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L30
...
L46:
	;
	F_errfinish(m, int32(_a_F_get_catalog_object_by_oid_extended_2), int32(2777), int32(_a_F_get_catalog_object_by_oid_extended_3))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L30
