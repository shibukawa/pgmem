	...
	default:
		...
		if v98 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
			F_errmsg_internal(m, int32(482105), v12)
			mBase = m.M
			v102 = m.ExcPending
			if v102 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(499621), int32(428), int32(347804))
				mBase = m.M
				v107 = m.ExcPending
				if v107 != 0 {
					return int32(0)
