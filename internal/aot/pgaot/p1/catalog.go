	...
	default:
		...
		if v98 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = l1
			F_errmsg_internal(m, int32(503367), v12)
			mBase = m.M
			v102 = m.ExcPending
			if v102 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(522764), int32(428), int32(364256))
				mBase = m.M
				v107 = m.ExcPending
				if v107 != 0 {
					return int32(0)
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = v13
	F_errmsg_internal(m, int32(64771), v11)
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L30
