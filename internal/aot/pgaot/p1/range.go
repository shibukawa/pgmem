...
L4:
	;
	v50 = *(*int64)(unsafe.Add(mBase, _c_F_RangeVarGetAndCheckCreationNamespace[1]))
	v55 = int32(0)
	v56 = v4
	v61 = v4
	v62 = v50
...
L48:
	;
	v141 = *(*int64)(unsafe.Add(mBase, _c_F_RangeVarGetAndCheckCreationNamespace[1]))
	if v62 != v141 {
		v55 = v64
		v56 = v70
		v61 = int32(1)
...
L50:
	;
	v113 = *(*int32)(unsafe.Add(mBase, _c_F_RangeVarGetAndCheckCreationNamespace[3]))
...
L4:
	;
	v54 = l2 & int32(1)
	v58 = *(*int64)(unsafe.Add(mBase, _c_F_RangeVarGetRelidExtended[1]))
	v66 = int32(0)
	v74 = int32(0)
	v75 = v58
	goto L18
...
L17:
	;
	F_errfinish(m, int32(_a_F_RangeVarGetRelidExtended_0), v297, int32(_a_F_RangeVarGetRelidExtended_1))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L5
...
L51:
	...
	*(*float32)(unsafe.Add(mBase, uint32(l0)+48)) = base.F32_neg(base.F32_sub(float32(1), v217))
	v224 = int32(_a_F_compute_range_stats_0)
	v225 = *(*int32)(unsafe.Add(mBase, _c_F_compute_range_stats[0]))
	v227 = *(*int32)(unsafe.Add(mBase, uint32(l0)+20))
	*(*int32)(unsafe.Add(mBase, _c_F_compute_range_stats[0])) = v227
	if int32(2) <= v189 {
		goto L56
	} else {
		goto L57
...
L86:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_compute_range_stats[0])) = v225
	goto L8
L87:
	;
					...
					if v26 != 0 {
						...
						if v27 == int32(0) {
							...
							if v43 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v9))) = v19
								F_errmsg_internal(m, int32(_a_F_range_union_0), v9)
								mBase = m.M
								v47 = m.ExcPending
								if v47 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_range_union_1), int32(1776), int32(_a_F_range_union_2))
									mBase = m.M
									v52 = m.ExcPending
									if v52 != 0 {
										return int32(0)
