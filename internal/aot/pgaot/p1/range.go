								...
								if v63 != 0 {
									...
									if v66 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v9))) = v67
										F_errmsg(m, int32(28368), v9)
										mBase = m.M
										v71 = m.ExcPending
										if v71 != 0 {
											return
										} else {
											F_errfinish(m, int32(491322), int32(21618), int32(29250))
											mBase = m.M
											v76 = m.ExcPending
											if v76 != 0 {
												return
...
L73:
	;
	F_errfinish(m, int32(496316), int32(760), int32(416006))
	mBase = m.M
	v173 = m.ExcPending
	if v173 != 0 {
		goto L5
...
L17:
	;
	F_errfinish(m, int32(496316), v297, int32(458859))
	mBase = m.M
	v300 = m.ExcPending
	if v300 != 0 {
		goto L5
...
L31:
	;
	F_errmsg(m, int32(379572), int32(0))
	mBase = m.M
	v103 = m.ExcPending
	if v103 != 0 {
		goto L5
...
L32:
	;
	F_errfinish(m, int32(496316), int32(519), int32(458859))
	mBase = m.M
	v108 = m.ExcPending
	if v108 != 0 {
		goto L5
...
L81:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v19)+48)) = v232
	F_errmsg(m, int32(672818), v19+int32(48))
	mBase = m.M
	v238 = m.ExcPending
	if v238 != 0 {
		goto L5
...
L84:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v19)+32)) = v245
	F_errmsg(m, int32(687037), v19+int32(32))
	mBase = m.M
	v251 = m.ExcPending
	if v251 != 0 {
		goto L5
...
L96:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v19)+16)) = v273
	F_errmsg(m, int32(70070), v19+int32(16))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L5
...
L103:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v19)+64)) = v317
	F_errmsg(m, int32(672340), v19-int32(-64))
	mBase = m.M
	v325 = m.ExcPending
	if v325 != 0 {
		goto L5
...
L104:
	;
	F_errfinish(m, int32(496316), int32(464), int32(458859))
	mBase = m.M
	v330 = m.ExcPending
	if v330 != 0 {
		goto L5
			...
			if int32(32768) <= v25 {
				...
				if v116 != 0 {
					...
					if v119 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v16)+16)) = int32(32767)
						F_errmsg(m, int32(147897), v16+int32(16))
						mBase = m.M
						v126 = m.ExcPending
						if v126 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(493158), int32(2260), int32(274507))
							mBase = m.M
							v131 = m.ExcPending
							if v131 != 0 {
								return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v19)+4)) = l9
				if l9 != 0 {
										...
										if v67 != 0 {
											...
											if v70 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v16))) = v71
												F_errmsg(m, int32(454564), v16)
												mBase = m.M
												v79 = m.ExcPending
												if v79 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(493158), int32(2285), int32(274507))
													mBase = m.M
													v84 = m.ExcPending
													if v84 != 0 {
														return int32(0)
					...
					v43 = F_makeAlias(m, int32(274258), int32(0))
					mBase = m.M
					v44 = m.ExcPending
					if v44 != 0 {
						return int32(0)
				...
				if v118 != 0 {
					...
					if v121 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = int32(1664)
						F_errmsg(m, int32(147849), v12+int32(16))
						mBase = m.M
						v128 = m.ExcPending
						if v128 != 0 {
							return int32(0)
							...
							if v131 != 0 {
								...
								F_errfinish(m, int32(493158), int32(2086), int32(486971))
								mBase = m.M
								v136 = m.ExcPending
								if v136 != 0 {
									return int32(0)
										...
										if v73 != 0 {
											...
											if v76 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v12))) = v85
												F_errmsg(m, int32(454436), v12)
												mBase = m.M
												v89 = m.ExcPending
												if v89 != 0 {
													return int32(0)
												} else {
													F_errfinish(m, int32(493158), int32(2115), int32(486971))
													mBase = m.M
													v94 = m.ExcPending
													if v94 != 0 {
														return int32(0)
...
L10:
	;
	F_scanner_yyerror(m, int32(211201), l3)
	mBase = m.M
	v45 = m.ExcPending
	if v45 != 0 {
		goto L5
...
L26:
	;
	F_errfinish(m, int32(26925), int32(19397), int32(379953))
	mBase = m.M
	v112 = m.ExcPending
	if v112 != 0 {
		goto L5
	...
	if v10 == v11 {
		...
		if v152 != 0 {
			...
			if v156 != 0 {
				...
				F_errfinish(m, int32(490994), int32(2661), int32(309263))
				mBase = m.M
				v161 = m.ExcPending
				if v161 != 0 {
					return int32(0)
		...
		if v133 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
			...
			if v137 != 0 {
				...
				F_errfinish(m, int32(489520), int32(1030), int32(398390))
				mBase = m.M
				v142 = m.ExcPending
				if v142 != 0 {
					return int32(0)
		...
		if v33 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = l1
			...
			if v37 != 0 {
				...
				F_errfinish(m, int32(489520), int32(1084), int32(399260))
				mBase = m.M
				v42 = m.ExcPending
				if v42 != 0 {
					return int32(0)
			...
			if v19 == v20 {
				...
				if v44 != 0 {
					...
					if v48 != 0 {
						...
						F_errfinish(m, int32(490994), int32(1137), int32(109295))
						mBase = m.M
						v53 = m.ExcPending
						if v53 != 0 {
							return int32(0)
	...
	if v9 == v10 {
		...
		if v112 != 0 {
			...
			if v116 != 0 {
				...
				F_errfinish(m, int32(490994), int32(900), int32(309194))
				mBase = m.M
				v121 = m.ExcPending
				if v121 != 0 {
					return int32(0)
	...
	if v11 == v12 {
										...
										if v38 == int32(0) {
											...
											if v125 != 0 {
												...
												if v128 != 0 {
													...
													F_errmsg(m, int32(114081), int32(0))
													mBase = m.M
													v132 = m.ExcPending
													if v132 != 0 {
														return int32(0)
													} else {
														F_errfinish(m, int32(490994), int32(1084), int32(309555))
														mBase = m.M
														v137 = m.ExcPending
														if v137 != 0 {
															return int32(0)
		...
		if v112 != 0 {
			...
			if v116 != 0 {
				...
				F_errfinish(m, int32(490994), int32(1068), int32(309555))
				mBase = m.M
				v121 = m.ExcPending
				if v121 != 0 {
					return int32(0)
