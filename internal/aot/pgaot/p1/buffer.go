...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v130)+4)) = v133 + int32(1)
	...
	F_ResourceOwnerRemember(m, v138, v15, int32(1664464))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L2
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+28)) = int32(478682)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+24)) = int32(6287)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = int32(520481)
...
L95:
	;
	F_errfinish(m, int32(520481), int32(818), int32(483906))
	mBase = m.M
	v373 = m.ExcPending
	if v373 != 0 {
		goto L9
