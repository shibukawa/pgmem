...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v130)+4)) = v133 + int32(1)
	v138 = *(*int32)(unsafe.Add(mBase, _c_F_PinBuffer[0]))
	F_ResourceOwnerRemember(m, v138, v15, int32(_a_F_PinBuffer_0))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L2
...
L4:
	;
	v22 = int32(_a_F_PinBuffer_1)
	v23 = *(*int32)(unsafe.Add(mBase, _c_F_PinBuffer[1]))
	v25 = int32(0)
	*(*int32)(unsafe.Add(mBase, _c_F_PinBuffer[1])) = v25
...
L7:
	;
	if v33&int32(_a_F_PinBuffer_2) != 0 {
		goto L9
	} else {
		goto L10
	}
L9:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+28)) = int32(_a_F_PinBuffer_3)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+24)) = int32(_a_F_PinBuffer_4)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = int32(_a_F_PinBuffer_5)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v11)+8)) = int64(0)
	...
	if v51&int32(_a_F_PinBuffer_2) != 0 {
		goto L12
	} else {
		goto L13
	}
...
L11:
	;
	v111 = v102 + int32(1)
	v113 = v111 & int32(_a_F_PinBuffer_6)
	if l1 != 0 {
		goto L30
	} else {
		goto L31
...
L14:
	;
	v80 = int32(_a_F_PinBuffer_7)
	v81 = *(*int32)(unsafe.Add(mBase, _c_F_PinBuffer[2]))
...
L17:
	...
	if v66&int32(_a_F_PinBuffer_2) != 0 {
		goto L15
	} else {
		goto L18
	}
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, _c_F_PinBuffer[2])) = v98
	goto L20
L22:
	;
	if int32(999) < v81 {
...
L31:
	;
	v118 = base.B2i32(base.Ui32(v113) < base.Ui32(int32(_a_F_PinBuffer_8)))
	goto L32
L32:
	;
	if v118 != 0 {
...
L33:
	;
	v119 = v102 + int32(_a_F_PinBuffer_9)
	goto L35
L34:
	;
	v119 = v111
...
L32:
	;
	v97 = *(*int32)(unsafe.Add(mBase, _c_F_ReadBufferExtended[8]))
...
L35:
	;
	v115 = *(*int32)(unsafe.Add(mBase, _c_F_ReadBufferExtended[9]))
	v122 = v115 + v112&int32(127)<<(uint(int32(7))%32) + int32(_a_F_ReadBufferExtended_5)
...
L61:
	;
	v201 = *(*int32)(unsafe.Add(mBase, _c_F_ReadBufferExtended[10]))
...
L75:
	...
	v287 = *(*int64)(unsafe.Add(mBase, uint32(v281)+uint32(_c_F_ReadBufferExtended[1])))
	*(*int64)(unsafe.Add(mBase, uint32(v281)+uint32(_c_F_ReadBufferExtended[1]))) = v287 + int64(1)
	v293 = *(*int64)(unsafe.Add(mBase, uint32(v281)+uint32(_c_F_ReadBufferExtended[2])))
	*(*int64)(unsafe.Add(mBase, uint32(v281)+uint32(_c_F_ReadBufferExtended[2]))) = v293
	v295 = int32(1)
	F_pgstat_count_backend_io_op(m, v223, v227, int32(2), v295, int64(0))
	mBase = m.M
	*(*uint8)(unsafe.Add(mBase, _c_F_ReadBufferExtended[3])) = uint8(v295)
	*(*uint8)(unsafe.Add(mBase, _c_F_ReadBufferExtended[4])) = uint8(v295)
	goto L82
L76:
	;
...
L82:
	;
	v305 = int32(*(*uint8)(unsafe.Add(mBase, _c_F_ReadBufferExtended[5])))
	if v305 != int32(1) {
		goto L65
	} else {
		goto L83
...
L83:
	;
	v308 = int32(_a_F_ReadBufferExtended_4)
	v310 = *(*int32)(unsafe.Add(mBase, _c_F_ReadBufferExtended[6]))
	v312 = *(*int32)(unsafe.Add(mBase, _c_F_ReadBufferExtended[7]))
	*(*int32)(unsafe.Add(mBase, _c_F_ReadBufferExtended[6])) = v310 + v312
	goto L65
L84:
	;
	v345 = v320
