...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v130)+4)) = v133 + int32(1)
	...
	F_ResourceOwnerRemember(m, v138, v15, int32(1665504))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L2
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+28)) = int32(479123)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+24)) = int32(6287)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = int32(520922)
...
L75:
	...
	v287 = *(*int64)(unsafe.Add(mBase, uint32(v281)+uint32(_consts[729])))
	*(*int64)(unsafe.Add(mBase, uint32(v281)+uint32(_consts[729]))) = v287 + int64(1)
	v293 = *(*int64)(unsafe.Add(mBase, uint32(v281)+uint32(_consts[730])))
	*(*int64)(unsafe.Add(mBase, uint32(v281)+uint32(_consts[730]))) = v293
	v295 = int32(1)
	F_pgstat_count_backend_io_op(m, v223, v227, int32(2), v295, int64(0))
	mBase = m.M
	*(*uint8)(unsafe.Add(mBase, _consts[731])) = uint8(v295)
	*(*uint8)(unsafe.Add(mBase, _consts[732])) = uint8(v295)
	goto L82
L76:
	;
...
L82:
	;
	v305 = int32(*(*uint8)(unsafe.Add(mBase, _consts[411])))
	if v305 != int32(1) {
		goto L65
	} else {
		goto L83
...
L83:
	;
	v308 = int32(4556816)
	v310 = *(*int32)(unsafe.Add(mBase, _consts[412]))
	v312 = *(*int32)(unsafe.Add(mBase, _consts[733]))
	*(*int32)(unsafe.Add(mBase, _consts[412])) = v310 + v312
	goto L65
L84:
	;
	v345 = v320
...
L95:
	;
	F_errfinish(m, int32(520922), int32(818), int32(484347))
	mBase = m.M
	v373 = m.ExcPending
	if v373 != 0 {
		goto L9
