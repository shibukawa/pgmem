...
L1:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v130)+4)) = v133 + int32(1)
	...
	F_ResourceOwnerRemember(m, v138, v15, int32(1586128))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L2
...
L9:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v11)+28)) = int32(434855)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+24)) = int32(6287)
	*(*int32)(unsafe.Add(mBase, uint32(v11)+20)) = int32(472001)
...
L94:
	;
	F_errmsg(m, int32(134322), int32(0))
	mBase = m.M
	v368 = m.ExcPending
	if v368 != 0 {
		goto L9
...
L95:
	;
	F_errfinish(m, int32(472001), int32(818), int32(439990))
	mBase = m.M
	v373 = m.ExcPending
	if v373 != 0 {
		goto L9
