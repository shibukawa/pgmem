						...
						if v77 != 0 {
							...
							if v80 != 0 {
								...
								if v86 != 0 {
									...
									F_errfinish(m, int32(490356), int32(152), int32(213627))
									mBase = m.M
									v93 = m.ExcPending
									if v93 != 0 {
										return int32(0)
									...
									if v97 != 0 {
										...
										if v100 != 0 {
											...
											if v106 != 0 {
												...
												F_errfinish(m, int32(490356), int32(153), int32(213627))
												mBase = m.M
												v113 = m.ExcPending
												if v113 != 0 {
													return int32(0)
...
L46:
	;
	F_errfinish(m, int32(490356), int32(68), int32(372376))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L1
...
L50:
	;
	F_errfinish(m, int32(490356), int32(69), int32(372376))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
	...
	if v17 != 0 {
		...
		case 0:
			if l1 == int32(0) {
				...
				v24 = int32(4)
				v28 = F_bsearch(m, l0+v24, l1, l3, v24, int32(6793))
				mBase = m.M
				v29 = m.ExcPending
				if v29 != 0 {
					return float64(0)
				...
				case 1, 2, 3, 4:
					...
					if v57 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v58
						F_errmsg_internal(m, int32(476714), v12+int32(16))
						mBase = m.M
						v66 = m.ExcPending
						if v66 != 0 {
							return float64(0)
						} else {
							F_errfinish(m, int32(489304), int32(317), int32(486412))
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return float64(0)
		...
		default:
			...
			if v77 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12))) = v78
				F_errmsg_internal(m, int32(58322), v12)
				mBase = m.M
				v84 = m.ExcPending
				if v84 != 0 {
					return float64(0)
				} else {
					F_errfinish(m, int32(489304), int32(324), int32(486412))
					mBase = m.M
					v91 = m.ExcPending
					if v91 != 0 {
						return float64(0)
...
L6:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
	v33 = F_pg_snprintf(m, v9+int32(4), int32(12), int32(482897), v9)
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L1
...
L34:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v6 + int32(-4)
	v117 = v67 + v10
	v121 = F_sscanf(m, v117, int32(482897), v6+int32(-32))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L37
...
L47:
	;
	F_errfinish(m, int32(489701), int32(1314), int32(63503))
	mBase = m.M
	v162 = m.ExcPending
	if v162 != 0 {
		goto L37
...
L51:
	;
	F_errfinish(m, int32(489701), int32(1319), int32(63503))
	mBase = m.M
	v180 = m.ExcPending
	if v180 != 0 {
		goto L37
...
L55:
	;
	F_errfinish(m, int32(489701), int32(1324), int32(63503))
	mBase = m.M
	v196 = m.ExcPending
	if v196 != 0 {
		goto L37
...
L58:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l3))) = int32(620308)
	v240 = v53
	goto L16
L59:
	;
