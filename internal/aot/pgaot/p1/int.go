						...
						if v77 != 0 {
							...
							if v80 != 0 {
								...
								if v86 != 0 {
									...
									F_errfinish(m, int32(497246), int32(152), int32(215969))
									mBase = m.M
									v93 = m.ExcPending
									if v93 != 0 {
										return int32(0)
									...
									if v97 != 0 {
										...
										if v100 != 0 {
											...
											if v106 != 0 {
												...
												F_errfinish(m, int32(497246), int32(153), int32(215969))
												mBase = m.M
												v113 = m.ExcPending
												if v113 != 0 {
													return int32(0)
...
L46:
	;
	F_errfinish(m, int32(497246), int32(68), int32(377674))
	mBase = m.M
	v169 = m.ExcPending
	if v169 != 0 {
		goto L1
...
L50:
	;
	F_errfinish(m, int32(497246), int32(69), int32(377674))
	mBase = m.M
	v189 = m.ExcPending
	if v189 != 0 {
		goto L1
	...
	if v17 != 0 {
		...
		case 0:
			if l1 == int32(0) {
				...
				v24 = int32(4)
				v28 = F_bsearch(m, l0+v24, l1, l3, v24, int32(7180))
				mBase = m.M
				v29 = m.ExcPending
				if v29 != 0 {
					return float64(0)
				...
				case 1, 2, 3, 4:
					...
					if v57 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v58
						F_errmsg_internal(m, int32(483409), v12+int32(16))
						mBase = m.M
						v66 = m.ExcPending
						if v66 != 0 {
							return float64(0)
						} else {
							F_errfinish(m, int32(496182), int32(317), int32(493219))
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return float64(0)
		...
		default:
			...
			if v77 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v12))) = v78
				F_errmsg_internal(m, int32(58947), v12)
				mBase = m.M
				v84 = m.ExcPending
				if v84 != 0 {
					return float64(0)
				} else {
					F_errfinish(m, int32(496182), int32(324), int32(493219))
					mBase = m.M
					v91 = m.ExcPending
					if v91 != 0 {
						return float64(0)
		...
		*(*uint8)(unsafe.Add(mBase, uint32(v12))) = uint8(v16)
		if base.Ui32(l0-int32(4000)) <= base.Ui32(int32(-4000)) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v9))) = l0
			v33 = F_pg_snprintf(m, v9+int32(4), int32(12), int32(489630), v9)
			mBase = m.M
			v34 = m.ExcPending
			if v34 != 0 {
				return int32(0)
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v8)+32)) = v6 + int32(-4)
	v61 = v11 + v10
	v65 = F_sscanf(m, v61, int32(489630), v6+int32(-32))
	mBase = m.M
	v68 = m.ExcPending
	if v68 != 0 {
		goto L20
...
L30:
	;
	F_errfinish(m, int32(496579), int32(1314), int32(64254))
	mBase = m.M
	v106 = m.ExcPending
	if v106 != 0 {
		goto L20
...
L34:
	;
	F_errfinish(m, int32(496579), int32(1319), int32(64254))
	mBase = m.M
	v124 = m.ExcPending
	if v124 != 0 {
		goto L20
...
L38:
	;
	F_errfinish(m, int32(496579), int32(1324), int32(64254))
	mBase = m.M
	v140 = m.ExcPending
	if v140 != 0 {
		goto L20
...
L58:
	;
	*(*int32)(unsafe.Add(mBase, uint32(l3))) = int32(643784)
	v240 = v53
	goto L16
L59:
	;
