								...
								*(*int32)(unsafe.Add(mBase, uint32(v76)+36)) = v105 - v107 - int32(2)
								...
								if v115 != 0 {
									...
									if v117 != 0 {
										...
										v121 = F___memcpy(m, int32(4414024), int32(4413864), int32(128))
										mBase = m.M
										...
										if v143 != 0 {
											...
											if v147 != 0 {
												...
												if v151 != 0 {
													...
													mBase = m.M
													F_BufferUsageAccumDiff(m, v164, int32(4414024))
													mBase = m.M
													v168 = v159 + int32(24)
													v169 = int64(0)
	...
	default:
		...
		if v52 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v53
			F_errmsg_internal(m, int32(471632), v12)
			mBase = m.M
			v57 = m.ExcPending
			if v57 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(492752), int32(195), int32(91731))
				mBase = m.M
				v62 = m.ExcPending
				if v62 != 0 {
					return int32(0)
...
func F_brin_minmax_multi_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_int_reloption(m, v2, int32(401828), int32(488784), int32(32), int32(8), int32(256))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(17916)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(497978), int32(2984), int32(279135))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v48
	F_errmsg_internal(m, int32(483562), v20)
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L1
