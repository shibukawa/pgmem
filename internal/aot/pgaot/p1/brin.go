	...
	if v12 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6)+12)) = int32(0)
		...
		if v16 != 0 {
			...
			if v15 != 0 {
				v19 = F_verify_brin_page(m, v9, int32(61585), int32(427531))
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					return int32(0)
							...
							if v30 != int32(1) {
								...
								if v92 != 0 {
									...
									if v98 != 0 {
										...
										F_errfinish(m, int32(520301), int32(365), int32(254971))
										mBase = m.M
										v105 = m.ExcPending
										if v105 != 0 {
											return int32(0)
								...
								if v36 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6))) = v38
									v41 = F_psprintf(m, int32(537441), v6)
									mBase = m.M
									v42 = m.ExcPending
									if v42 != 0 {
										return int32(0)
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						if v81 != 0 {
							...
							F_errfinish(m, int32(520301), int32(356), int32(254971))
							mBase = m.M
							v88 = m.ExcPending
							if v88 != 0 {
								return int32(0)
	...
	default:
		...
		if v52 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v53
			F_errmsg_internal(m, int32(494700), v12)
			mBase = m.M
			v57 = m.ExcPending
			if v57 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(517348), int32(195), int32(98240))
				mBase = m.M
				v62 = m.ExcPending
				if v62 != 0 {
					return int32(0)
...
func F_brin_minmax_multi_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_int_reloption(m, v2, int32(421989), int32(512836), int32(32), int32(8), int32(256))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(18152)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(523979), int32(2984), int32(293102))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v48
	F_errmsg_internal(m, int32(507614), v20)
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L1
