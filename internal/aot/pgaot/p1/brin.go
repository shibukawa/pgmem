								...
								*(*int32)(unsafe.Add(mBase, uint32(v76)+36)) = v105 - v107 - int32(2)
								...
								if v115 != 0 {
									...
									if v117 != 0 {
										...
										v121 = F___memcpy(m, int32(4452552), int32(4452392), int32(128))
										mBase = m.M
										...
										if v143 != 0 {
											...
											if v147 != 0 {
												...
												if v151 != 0 {
													...
													mBase = m.M
													F_BufferUsageAccumDiff(m, v164, int32(4452552))
													mBase = m.M
													v168 = v159 + int32(24)
													v169 = int64(0)
	...
	if v12 != 0 {
		...
		*(*int32)(unsafe.Add(mBase, uint32(v6)+12)) = int32(0)
		...
		if v16 != 0 {
			...
			if v15 != 0 {
				v19 = F_verify_brin_page(m, v9, int32(61585), int32(425403))
				mBase = m.M
				v20 = m.ExcPending
				if v20 != 0 {
					return int32(0)
							...
							if v30 != int32(1) {
								...
								if v92 != 0 {
									...
									if v98 != 0 {
										...
										F_errfinish(m, int32(517544), int32(365), int32(253752))
										mBase = m.M
										v105 = m.ExcPending
										if v105 != 0 {
											return int32(0)
								...
								if v36 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v6))) = v38
									v41 = F_psprintf(m, int32(534634), v6)
									mBase = m.M
									v42 = m.ExcPending
									if v42 != 0 {
										return int32(0)
				...
				if v72 != 0 {
					...
					if v75 != 0 {
						...
						if v81 != 0 {
							...
							F_errfinish(m, int32(517544), int32(356), int32(253752))
							mBase = m.M
							v88 = m.ExcPending
							if v88 != 0 {
								return int32(0)
	...
	default:
		...
		if v52 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v53
			F_errmsg_internal(m, int32(492303), v12)
			mBase = m.M
			v57 = m.ExcPending
			if v57 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(514612), int32(195), int32(98045))
				mBase = m.M
				v62 = m.ExcPending
				if v62 != 0 {
					return int32(0)
...
func F_brin_minmax_multi_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_int_reloption(m, v2, int32(419861), int32(510129), int32(32), int32(8), int32(256))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(18086)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(521172), int32(2984), int32(291704))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v48
	F_errmsg_internal(m, int32(504907), v20)
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L1
