								...
								*(*int32)(unsafe.Add(mBase, uint32(v76)+36)) = v105 - v107 - int32(2)
								...
								if v115 != 0 {
									...
									if v117 != 0 {
										...
										v121 = F___memcpy(m, int32(4378728), int32(4378568), int32(128))
										mBase = m.M
										...
										if v143 != 0 {
											...
											if v147 != 0 {
												...
												if v151 != 0 {
													...
													mBase = m.M
													F_BufferUsageAccumDiff(m, v164, int32(4378728))
													mBase = m.M
													v168 = v159 + int32(24)
													v169 = int64(0)
	...
	default:
		...
		if v52 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v12))) = v53
			F_errmsg_internal(m, int32(466779), v12)
			mBase = m.M
			v57 = m.ExcPending
			if v57 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(487549), int32(195), int32(91097))
				mBase = m.M
				v62 = m.ExcPending
				if v62 != 0 {
					return int32(0)
...
func F_brin_minmax_multi_options(m *base.Module, l0 int32) int32 {
	...
	*(*int64)(unsafe.Add(mBase, uint32(v2))) = int64(0)
	F_add_local_int_reloption(m, v2, int32(397714), int32(483627), int32(32), int32(8), int32(256))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(17841)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(492702), int32(2984), int32(276379))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
L60:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v20))) = v48
	F_errmsg_internal(m, int32(478405), v20)
	mBase = m.M
	v219 = m.ExcPending
	if v219 != 0 {
		goto L1
