...
func F_GetXLogReplayRecPtr(m *base.Module, l0 int32) int64 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+96)) = int32(1)
	if v7 != 0 {
		...
		F_s_lock(m, v11+int32(96), int32(489255), int32(4586), int32(205743))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int64(0)
...
L6:
	;
	F_s_lock(m, v22, int32(494975), int32(1528), int32(320679))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L9
...
L25:
	;
	F_errfinish(m, int32(494975), int32(1545), int32(320679))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L9
...
L78:
	;
	F_errfinish(m, int32(494975), int32(1517), int32(320679))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L9
									...
									if v68 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v5))) = v5 + int32(160)
										...
										if v74 != 0 {
											...
											F_errfinish(m, int32(495277), int32(537), int32(370488))
											mBase = m.M
											v79 = m.ExcPending
											if v79 != 0 {
												return
											...
											if v91 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v5 + int32(160)
												...
												if v99 != 0 {
													...
													F_errfinish(m, int32(495277), int32(545), int32(370488))
													mBase = m.M
													v104 = m.ExcPending
													if v104 != 0 {
														return
...
func F_XLogEnsureRecordSpace(m *base.Module, l0 int32, l1 int32) {
	...
	if l0 < int32(33) {
		...
		if v99 != 0 {
			...
			F_errmsg_internal(m, int32(459484), int32(0))
			mBase = m.M
			v103 = m.ExcPending
			if v103 != 0 {
				return
			} else {
				F_errfinish(m, int32(489916), int32(194), int32(417112))
				mBase = m.M
				v108 = m.ExcPending
				if v108 != 0 {
					return
...
func F_XLogFileName(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v10)+8)) = uint32(v19)
	v23 = F_pg_snprintf(m, l0, int32(64), int32(506823), v10)
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		return
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = v9 + int32(24)
	v128 = F_sscanf(m, v26, int32(506823), v9)
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L1
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v30)+20)) = int32(492025)
	v145 = int32(0)
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v275))) = v282
	...
	F_ResourceOwnerRemember(m, v285, v282, int32(1609648))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L6
		...
		if v8 <= l0 {
			...
			if v81 != 0 {
				...
				if v85 != 0 {
					...
					F_errfinish(m, int32(489916), int32(267), int32(225269))
					mBase = m.M
					v90 = m.ExcPending
					if v90 != 0 {
						return
...
L1:
	;
	F_s_lock(m, v10, int32(491515), int32(190), int32(36722))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		goto L4
	...
	if base.Ui64(v16) <= base.Ui64(v14) {
		...
		if v25 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v19)+1456)) = int32(1)
			v34 = v19 + int32(1456)
			if v30 != 0 {
				F_s_lock(m, v34, int32(492078), int32(998), int32(320331))
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return
						...
						if v52 != int32(1) {
							...
							if v64 == int32(1) {
								...
								*(*uint32)(unsafe.Add(mBase, uint32(v11))) = uint32(v71)
								v77 = F_pg_snprintf(m, v11+int32(16), int32(50), int32(512127), v11)
								mBase = m.M
								v78 = m.ExcPending
								if v78 != 0 {
									return
...
L22:
	...
	F_s_lock(m, v68+int32(96), int32(489255), int32(4556), int32(340947))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L25
...
L44:
	;
	F_errfinish(m, int32(492078), int32(1233), int32(317576))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L25
