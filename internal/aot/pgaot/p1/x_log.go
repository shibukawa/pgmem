...
func F_GetXLogReplayRecPtr(m *base.Module, l0 int32) int64 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+96)) = int32(1)
	if v7 != 0 {
		...
		F_s_lock(m, v11+int32(96), int32(503064), int32(4586), int32(210746))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int64(0)
...
L6:
	;
	F_s_lock(m, v22, int32(510097), int32(1528), int32(329225))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L9
...
L25:
	;
	F_errfinish(m, int32(510097), int32(1545), int32(329225))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L9
...
L78:
	;
	F_errfinish(m, int32(510097), int32(1517), int32(329225))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L9
...
func F_XLogArchiveForceDone(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5)+52)) = int32(381088)
	v16 = F_pg_snprintf(m, v5+int32(160), int32(1024), int32(179756), v5+int32(48))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
		...
		if v24 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5)+36)) = int32(23052)
			*(*int32)(unsafe.Add(mBase, uint32(v5)+32)) = l0
			v36 = F_pg_snprintf(m, v5+int32(1184), int32(1024), int32(179756), v5+int32(32))
			mBase = m.M
			v37 = m.ExcPending
			if v37 != 0 {
				return
				...
				if v44 == int32(0) {
					...
					v57 = F_AllocateFile(m, v5+int32(160), int32(33476))
					mBase = m.M
					v58 = m.ExcPending
					if v58 != 0 {
						return
								...
								if v63 == int32(0) {
									...
									if v68 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v5))) = v5 + int32(160)
										F_errmsg(m, int32(303989), v5)
										mBase = m.M
										v74 = m.ExcPending
										if v74 != 0 {
											return
										} else {
											F_errfinish(m, int32(510405), int32(537), int32(381165))
											mBase = m.M
											v79 = m.ExcPending
											if v79 != 0 {
												return
										...
										if v86 == int32(0) {
											...
											if v91 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v5 + int32(160)
												F_errmsg(m, int32(303944), v5+int32(16))
												mBase = m.M
												v99 = m.ExcPending
												if v99 != 0 {
													return
												} else {
													F_errfinish(m, int32(510405), int32(545), int32(381165))
													mBase = m.M
													v104 = m.ExcPending
													if v104 != 0 {
														return
...
func F_XLogArchiveIsBusy(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+52)) = int32(381088)
	v17 = F_pg_snprintf(m, v6+int32(160), int32(1024), int32(179756), v6+int32(48))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		return int32(0)
		...
		if v27 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = l0
			v39 = F_pg_snprintf(m, v6+int32(160), int32(1024), int32(179756), v6+int32(32))
			mBase = m.M
			v40 = m.ExcPending
			if v40 != 0 {
				return int32(0)
				...
				if v47 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+20)) = int32(381088)
					*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = l0
					v59 = F_pg_snprintf(m, v6+int32(160), int32(1024), int32(179756), v6+int32(16))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return int32(0)
						...
						if v67 == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
							v75 = F_pg_snprintf(m, v6+int32(160), int32(1024), int32(181159), v6)
							mBase = m.M
							v76 = m.ExcPending
							if v76 != 0 {
								return int32(0)
...
func F_XLogEnsureRecordSpace(m *base.Module, l0 int32, l1 int32) {
	...
	if l0 < int32(33) {
		...
		if v99 != 0 {
			...
			F_errmsg_internal(m, int32(472090), int32(0))
			mBase = m.M
			v103 = m.ExcPending
			if v103 != 0 {
				return
			} else {
				F_errfinish(m, int32(503891), int32(194), int32(429095))
				mBase = m.M
				v108 = m.ExcPending
				if v108 != 0 {
					return
...
func F_XLogFileName(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v10)+8)) = uint32(v19)
	v23 = F_pg_snprintf(m, l0, int32(64), int32(522846), v10)
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		return
...
func F_XLogGetOldestSegno(m *base.Module, l0 int32) int64 {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	v12 = F_AllocateDir(m, int32(314940))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		goto L1
...
L2:
	;
	v17 = F_ReadDir(m, v12, int32(314940))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L9:
	;
	v145 = F_ReadDir(m, v12, int32(314940))
	mBase = m.M
	v146 = m.ExcPending
	if v146 != 0 {
		goto L1
...
L32:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = v9 + int32(24)
	v128 = F_sscanf(m, v26, int32(522846), v9)
	mBase = m.M
	v129 = m.ExcPending
	if v129 != 0 {
		goto L1
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v30)+28)) = int32(234095)
	*(*int32)(unsafe.Add(mBase, uint32(v30)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v30)+20)) = int32(506700)
	v145 = int32(0)
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v275))) = v282
	...
	F_ResourceOwnerRemember(m, v285, v282, int32(1642592))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L6
		...
		if v8 <= l0 {
			...
			if v81 != 0 {
				...
				if v85 != 0 {
					...
					F_errfinish(m, int32(503891), int32(267), int32(231099))
					mBase = m.M
					v90 = m.ExcPending
					if v90 != 0 {
						return
...
L1:
	;
	F_s_lock(m, v10, int32(506060), int32(190), int32(37811))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		goto L4
...
func F_XLogWalRcvFlush(m *base.Module, l0 int32, l1 int32) {
	...
	v16 = *(*int64)(unsafe.Add(mBase, _consts[685]))
	if base.Ui64(v16) <= base.Ui64(v14) {
		m.G0 = v11 + int32(80)
		return
	} else {
		v19 = *(*int32)(unsafe.Add(mBase, _consts[253]))
		v21 = *(*int32)(unsafe.Add(mBase, _consts[686]))
		v23 = *(*int64)(unsafe.Add(mBase, _consts[687]))
		...
		if v25 != 0 {
			...
			v28 = *(*int64)(unsafe.Add(mBase, _consts[685]))
			*(*int64)(unsafe.Add(mBase, _consts[684])) = v28
			v30 = *(*int32)(unsafe.Add(mBase, uint32(v19)+1456))
			*(*int32)(unsafe.Add(mBase, uint32(v19)+1456)) = int32(1)
			v34 = v19 + int32(1456)
			if v30 != 0 {
				F_s_lock(m, v34, int32(506753), int32(998), int32(328858))
				mBase = m.M
				v39 = m.ExcPending
				if v39 != 0 {
					return
					...
					v42 = *(*int64)(unsafe.Add(mBase, _consts[684]))
					...
					*(*int32)(unsafe.Add(mBase, uint32(v34))) = int32(0)
					...
					if v50 != 0 {
						...
						if v52 != int32(1) {
							v64 = int32(*(*uint8)(unsafe.Add(mBase, _consts[688])))
							if v64 == int32(1) {
								v68 = *(*int64)(unsafe.Add(mBase, _consts[685]))
								...
								*(*uint32)(unsafe.Add(mBase, uint32(v11))) = uint32(v71)
								v77 = F_pg_snprintf(m, v11+int32(16), int32(50), int32(528150), v11)
								mBase = m.M
								v78 = m.ExcPending
								if v78 != 0 {
									return
...
L3:
	;
	v16 = int32(*(*uint8)(unsafe.Add(mBase, _consts[678])))
	if v16 != 0 {
		goto L2
	} else {
		goto L6
...
L5:
	;
	v18 = int32(*(*uint8)(unsafe.Add(mBase, _consts[683])))
	if v18 != 0 {
		goto L1
	} else {
		goto L7
...
L9:
	;
	v40 = *(*int64)(unsafe.Add(mBase, _consts[679]))
	if v36 < v40 {
		goto L1
	} else {
		goto L12
...
L11:
	;
	v45 = int64(*(*int32)(unsafe.Add(mBase, _consts[677])))
	if v45 <= int64(0) {
		goto L13
	} else {
		goto L14
...
L15:
	;
	v54 = int32(*(*uint8)(unsafe.Add(mBase, _consts[678])))
	if v54 != 0 {
		goto L16
	} else {
		goto L17
...
L18:
	;
	*(*int64)(unsafe.Add(mBase, _consts[679])) = v55
...
L22:
	...
	F_s_lock(m, v68+int32(96), int32(503064), int32(4556), int32(350897))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L25
...
L27:
	;
	v90 = int32(*(*uint8)(unsafe.Add(mBase, _consts[678])))
	if v90 == int32(1) {
		goto L29
	} else {
		goto L30
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = v129
	F_errmsg_internal(m, int32(49121), v9)
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L25
...
L43:
	;
	v151 = int32(4446576)
	v152 = *(*int32)(unsafe.Add(mBase, _consts[680]))
	v153 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v152))) = uint8(v153)
	*(*int32)(unsafe.Add(mBase, _consts[681])) = v153
	*(*int32)(unsafe.Add(mBase, _consts[682])) = v153
	goto L46
L44:
	;
	F_errfinish(m, int32(506753), int32(1233), int32(326094))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L25
...
L47:
	;
	v164 = *(*int32)(unsafe.Add(mBase, _consts[680]))
	v165 = int32(4446580)
	v166 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v168 = int32(104)
	*(*uint8)(unsafe.Add(mBase, uint32(v164+v166))) = uint8(v168)
	v172 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	*(*int32)(unsafe.Add(mBase, _consts[682])) = v172 + int32(1)
	v179 = m.G0
	v180 = int32(16)
	v181 = v179 - v180
	m.G0 = v181
...
L49:
	;
	v198 = int32(4446576)
	v199 = *(*int32)(unsafe.Add(mBase, _consts[680]))
	v200 = int32(4446580)
	v201 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v203 = int64(56)
	v205 = int64(65280)
	v207 = int64(40)
	v210 = int64(16711680)
	...
	*(*int32)(unsafe.Add(mBase, _consts[682])) = v241 + int32(8)
...
L50:
	;
	v250 = int32(4446576)
	v251 = *(*int32)(unsafe.Add(mBase, _consts[680]))
	v252 = int32(4446580)
	v253 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v255 = int32(24)
	v257 = int32(65280)
	v259 = int32(8)
	*(*int32)(unsafe.Add(mBase, uint32(v251+v253))) = v245<<(uint(v255)%32) | v245&v257<<(uint(v259)%32) | (int32(base.Ui32(v245)>>(uint(v259)%32))&v257 | int32(base.Ui32(v245)>>(uint(v255)%32)))
	v273 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v274 = int32(4)
	*(*int32)(unsafe.Add(mBase, _consts[682])) = v273 + v274
...
L51:
	;
	v281 = int32(4446576)
	v282 = *(*int32)(unsafe.Add(mBase, _consts[680]))
	v283 = int32(4446580)
	v284 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v286 = int32(24)
	v288 = int32(65280)
	v290 = int32(8)
	*(*int32)(unsafe.Add(mBase, uint32(v282+v284))) = v132<<(uint(v286)%32) | v132&v288<<(uint(v290)%32) | (int32(base.Ui32(v132)>>(uint(v290)%32))&v288 | int32(base.Ui32(v132)>>(uint(v286)%32)))
	v304 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v305 = int32(4)
	*(*int32)(unsafe.Add(mBase, _consts[682])) = v304 + v305
...
L52:
	;
	v313 = int32(4446576)
	v314 = *(*int32)(unsafe.Add(mBase, _consts[680]))
	v315 = int32(4446580)
	v316 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v318 = int32(24)
	v320 = int32(65280)
	v322 = int32(8)
	*(*int32)(unsafe.Add(mBase, uint32(v314+v316))) = v308<<(uint(v318)%32) | v308&v320<<(uint(v322)%32) | (int32(base.Ui32(v308)>>(uint(v322)%32))&v320 | int32(base.Ui32(v308)>>(uint(v318)%32)))
	v336 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v337 = int32(4)
	*(*int32)(unsafe.Add(mBase, _consts[682])) = v336 + v337
...
L53:
	;
	v344 = int32(4446576)
	v345 = *(*int32)(unsafe.Add(mBase, _consts[680]))
	v346 = int32(4446580)
	v347 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v349 = int32(24)
	v351 = int32(65280)
	v353 = int32(8)
	*(*int32)(unsafe.Add(mBase, uint32(v345+v347))) = v129<<(uint(v349)%32) | v129&v351<<(uint(v353)%32) | (int32(base.Ui32(v129)>>(uint(v353)%32))&v351 | int32(base.Ui32(v129)>>(uint(v349)%32)))
	v367 = *(*int32)(unsafe.Add(mBase, _consts[682]))
	v369 = v367 + int32(4)
	*(*int32)(unsafe.Add(mBase, _consts[682])) = v369
	v372 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v374 = *(*int32)(unsafe.Add(mBase, _consts[680]))
	v376 = *(*int32)(unsafe.Add(mBase, _consts[660]))
...
L54:
	...
	*(*uint8)(unsafe.Add(mBase, _consts[683])) = uint8(base.B2i32(v381|v382 == int32(0)))
	goto L1
}
