...
func F_GetXLogReplayRecPtr(m *base.Module, l0 int32) int64 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+96)) = int32(1)
	if v7 != 0 {
		...
		F_s_lock(m, v11+int32(96), int32(469636), int32(4586), int32(196343))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int64(0)
...
L6:
	;
	F_s_lock(m, v22, int32(475016), int32(1528), int32(306960))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L9
...
L25:
	;
	F_errfinish(m, int32(475016), int32(1545), int32(306960))
	mBase = m.M
	v99 = m.ExcPending
	if v99 != 0 {
		goto L9
...
L78:
	;
	F_errfinish(m, int32(475016), int32(1517), int32(306960))
	mBase = m.M
	v358 = m.ExcPending
	if v358 != 0 {
		goto L9
...
func F_XLogArchiveForceDone(m *base.Module, l0 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v5)+52)) = int32(355006)
	v16 = F_pg_snprintf(m, v5+int32(160), int32(1024), int32(165607), v5+int32(48))
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
		...
		if v24 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v5)+36)) = int32(21279)
			*(*int32)(unsafe.Add(mBase, uint32(v5)+32)) = l0
			v36 = F_pg_snprintf(m, v5+int32(1184), int32(1024), int32(165607), v5+int32(32))
			mBase = m.M
			v37 = m.ExcPending
			if v37 != 0 {
				return
				...
				if v44 == int32(0) {
					...
					v57 = F_AllocateFile(m, v5+int32(160), int32(30259))
					mBase = m.M
					v58 = m.ExcPending
					if v58 != 0 {
						return
								...
								if v63 == int32(0) {
									...
									if v68 != 0 {
										...
										*(*int32)(unsafe.Add(mBase, uint32(v5))) = v5 + int32(160)
										F_errmsg(m, int32(283192), v5)
										mBase = m.M
										v74 = m.ExcPending
										if v74 != 0 {
											return
										} else {
											F_errfinish(m, int32(475318), int32(537), int32(355083))
											mBase = m.M
											v79 = m.ExcPending
											if v79 != 0 {
												return
										...
										if v86 == int32(0) {
											...
											if v91 != 0 {
												...
												*(*int32)(unsafe.Add(mBase, uint32(v5)+16)) = v5 + int32(160)
												F_errmsg(m, int32(283147), v5+int32(16))
												mBase = m.M
												v99 = m.ExcPending
												if v99 != 0 {
													return
												} else {
													F_errfinish(m, int32(475318), int32(545), int32(355083))
													mBase = m.M
													v104 = m.ExcPending
													if v104 != 0 {
														return
...
func F_XLogArchiveIsBusy(m *base.Module, l0 int32) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v6)+52)) = int32(355006)
	v17 = F_pg_snprintf(m, v6+int32(160), int32(1024), int32(165607), v6+int32(48))
	mBase = m.M
	v20 = m.ExcPending
	if v20 != 0 {
		return int32(0)
		...
		if v27 == int32(0) {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = l0
			v39 = F_pg_snprintf(m, v6+int32(160), int32(1024), int32(165607), v6+int32(32))
			mBase = m.M
			v40 = m.ExcPending
			if v40 != 0 {
				return int32(0)
				...
				if v47 == int32(0) {
					...
					*(*int32)(unsafe.Add(mBase, uint32(v6)+20)) = int32(355006)
					*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = l0
					v59 = F_pg_snprintf(m, v6+int32(160), int32(1024), int32(165607), v6+int32(16))
					mBase = m.M
					v60 = m.ExcPending
					if v60 != 0 {
						return int32(0)
						...
						if v67 == int32(0) {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
							v75 = F_pg_snprintf(m, v6+int32(160), int32(1024), int32(167010), v6)
							mBase = m.M
							v76 = m.ExcPending
							if v76 != 0 {
								return int32(0)
...
func F_XLogEnsureRecordSpace(m *base.Module, l0 int32, l1 int32) {
	...
	if l0 < int32(33) {
		...
		if v99 != 0 {
			...
			F_errmsg_internal(m, int32(440974), int32(0))
			mBase = m.M
			v103 = m.ExcPending
			if v103 != 0 {
				return
			} else {
				F_errfinish(m, int32(470217), int32(194), int32(399706))
				mBase = m.M
				v108 = m.ExcPending
				if v108 != 0 {
					return
...
func F_XLogFileName(m *base.Module, l0 int32, l1 int32, l2 int64, l3 int32) {
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v10)+8)) = uint32(v19)
	v23 = F_pg_snprintf(m, l0, int32(64), int32(486532), v10)
	mBase = m.M
	v24 = m.ExcPending
	if v24 != 0 {
		return
...
func F_XLogGetOldestSegno(m *base.Module, l0 int32) int64 {
	...
	v9 = v7 - int32(32)
	m.G0 = v9
	v12 = F_AllocateDir(m, int32(293457))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		goto L1
...
L2:
	;
	v17 = F_ReadDir(m, v12, int32(293457))
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		goto L1
...
L9:
	;
	v201 = F_ReadDir(m, v12, int32(293457))
	mBase = m.M
	v202 = m.ExcPending
	if v202 != 0 {
		goto L1
...
L27:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v92))) = v93
	v101 = int32(*(*uint8)(unsafe.Add(mBase, _consts[229])))
	if v101 == int32(0) {
		goto L29
	} else {
		goto L30
...
L31:
	;
	v105 = int32(*(*uint8)(unsafe.Add(mBase, _consts[230])))
	if v105 == int32(0) {
		goto L32
	} else {
		goto L33
...
L49:
	;
	v173 = int64(*(*int32)(unsafe.Add(mBase, _consts[138])))
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+8)) = v9 + int32(24)
	v184 = F_sscanf(m, v26, int32(486532), v9)
	mBase = m.M
	v185 = m.ExcPending
	if v185 != 0 {
		goto L1
...
L21:
	;
	*(*int32)(unsafe.Add(mBase, uint32(v30)+28)) = int32(218082)
	*(*int32)(unsafe.Add(mBase, uint32(v30)+24)) = int32(6259)
	*(*int32)(unsafe.Add(mBase, uint32(v30)+20)) = int32(472269)
	v145 = int32(0)
...
L79:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v275))) = v282
	...
	F_ResourceOwnerRemember(m, v285, v282, int32(1586400))
	mBase = m.M
	v288 = m.ExcPending
	if v288 != 0 {
		goto L6
		...
		if v8 <= l0 {
			...
			if v81 != 0 {
				...
				if v85 != 0 {
					...
					F_errfinish(m, int32(470217), int32(267), int32(215438))
					mBase = m.M
					v90 = m.ExcPending
					if v90 != 0 {
						return
...
L1:
	;
	F_s_lock(m, v10, int32(471789), int32(190), int32(34398))
	mBase = m.M
	v15 = m.ExcPending
	if v15 != 0 {
		goto L4
...
func F_XLogWalRcvFlush(m *base.Module, l0 int32, l1 int32) {
	...
	v11 = v9 - int32(80)
	m.G0 = v11
	v14 = *(*int64)(unsafe.Add(mBase, _consts[680]))
	v16 = *(*int64)(unsafe.Add(mBase, _consts[681]))
...
L2:
	...
	v23 = *(*int64)(unsafe.Add(mBase, _consts[683]))
...
L4:
	;
	v28 = *(*int64)(unsafe.Add(mBase, _consts[681]))
	*(*int64)(unsafe.Add(mBase, _consts[680])) = v28
...
L5:
	;
	F_s_lock(m, v34, int32(472322), int32(998), int32(306632))
	mBase = m.M
	v39 = m.ExcPending
	if v39 != 0 {
		goto L3
...
L7:
	...
	v42 = *(*int64)(unsafe.Add(mBase, _consts[680]))
...
L13:
	;
	v64 = int32(*(*uint8)(unsafe.Add(mBase, _consts[684])))
	if v64 == int32(1) {
		goto L17
	} else {
		goto L18
...
L17:
	;
	v68 = *(*int64)(unsafe.Add(mBase, _consts[681]))
	...
	*(*uint32)(unsafe.Add(mBase, uint32(v11))) = uint32(v71)
	v77 = F_pg_snprintf(m, v11+int32(16), int32(50), int32(491836), v11)
	mBase = m.M
	v78 = m.ExcPending
	if v78 != 0 {
		goto L3
...
L3:
	;
	v16 = int32(*(*uint8)(unsafe.Add(mBase, _consts[674])))
	if v16 != 0 {
		goto L2
	} else {
		goto L6
...
L5:
	;
	v18 = int32(*(*uint8)(unsafe.Add(mBase, _consts[679])))
	if v18 != 0 {
		goto L1
	} else {
		goto L7
...
L9:
	;
	v40 = *(*int64)(unsafe.Add(mBase, _consts[675]))
	if v36 < v40 {
		goto L1
	} else {
		goto L12
...
L11:
	;
	v45 = int64(*(*int32)(unsafe.Add(mBase, _consts[673])))
	if v45 <= int64(0) {
		goto L13
	} else {
		goto L14
...
L15:
	;
	v54 = int32(*(*uint8)(unsafe.Add(mBase, _consts[674])))
	if v54 != 0 {
		goto L16
	} else {
		goto L17
...
L18:
	;
	*(*int64)(unsafe.Add(mBase, _consts[675])) = v55
...
L22:
	...
	F_s_lock(m, v68+int32(96), int32(469636), int32(4556), int32(326268))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L25
...
L27:
	;
	v90 = int32(*(*uint8)(unsafe.Add(mBase, _consts[674])))
	if v90 == int32(1) {
		goto L29
	} else {
		goto L30
...
L41:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v9)+12)) = v129
	F_errmsg_internal(m, int32(45652), v9)
	mBase = m.M
	v145 = m.ExcPending
	if v145 != 0 {
		goto L25
...
L43:
	;
	v151 = int32(4353296)
	v152 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v153 = int32(0)
	*(*uint8)(unsafe.Add(mBase, uint32(v152))) = uint8(v153)
	*(*int32)(unsafe.Add(mBase, _consts[677])) = v153
	*(*int32)(unsafe.Add(mBase, _consts[678])) = v153
	goto L46
L44:
	;
	F_errfinish(m, int32(472322), int32(1233), int32(303995))
	mBase = m.M
	v150 = m.ExcPending
	if v150 != 0 {
		goto L25
...
L47:
	;
	v164 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v165 = int32(4353300)
	v166 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v168 = int32(104)
	*(*uint8)(unsafe.Add(mBase, uint32(v164+v166))) = uint8(v168)
	v172 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	*(*int32)(unsafe.Add(mBase, _consts[678])) = v172 + int32(1)
	v179 = m.G0
	v180 = int32(16)
	v181 = v179 - v180
	m.G0 = v181
...
L49:
	;
	v198 = int32(4353296)
	v199 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v200 = int32(4353300)
	v201 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v203 = int64(56)
	v205 = int64(65280)
	v207 = int64(40)
	v210 = int64(16711680)
	...
	*(*int64)(unsafe.Add(mBase, uint32(v199+v201))) = v193<<(uint(v203)%64) | v193&v205<<(uint(v207)%64) | (v193&v210<<(uint(v212)%64) | v193&v214<<(uint(v216)%64)) | (int64(base.Ui64(v193)>>(uint(v216)%64))&v214 | int64(base.Ui64(v193)>>(uint(v212)%64))&v210 | (int64(base.Ui64(v193)>>(uint(v207)%64))&v205 | int64(base.Ui64(v193)>>(uint(v203)%64))))
	v241 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	*(*int32)(unsafe.Add(mBase, _consts[678])) = v241 + int32(8)
...
L50:
	;
	v250 = int32(4353296)
	v251 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v252 = int32(4353300)
	v253 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v255 = int32(24)
	v257 = int32(65280)
	v259 = int32(8)
	*(*int32)(unsafe.Add(mBase, uint32(v251+v253))) = v245<<(uint(v255)%32) | v245&v257<<(uint(v259)%32) | (int32(base.Ui32(v245)>>(uint(v259)%32))&v257 | int32(base.Ui32(v245)>>(uint(v255)%32)))
	v273 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v274 = int32(4)
	*(*int32)(unsafe.Add(mBase, _consts[678])) = v273 + v274
...
L51:
	;
	v281 = int32(4353296)
	v282 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v283 = int32(4353300)
	v284 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v286 = int32(24)
	v288 = int32(65280)
	v290 = int32(8)
	*(*int32)(unsafe.Add(mBase, uint32(v282+v284))) = v132<<(uint(v286)%32) | v132&v288<<(uint(v290)%32) | (int32(base.Ui32(v132)>>(uint(v290)%32))&v288 | int32(base.Ui32(v132)>>(uint(v286)%32)))
	v304 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v305 = int32(4)
	*(*int32)(unsafe.Add(mBase, _consts[678])) = v304 + v305
...
L52:
	;
	v313 = int32(4353296)
	v314 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v315 = int32(4353300)
	v316 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v318 = int32(24)
	v320 = int32(65280)
	v322 = int32(8)
	*(*int32)(unsafe.Add(mBase, uint32(v314+v316))) = v308<<(uint(v318)%32) | v308&v320<<(uint(v322)%32) | (int32(base.Ui32(v308)>>(uint(v322)%32))&v320 | int32(base.Ui32(v308)>>(uint(v318)%32)))
	v336 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v337 = int32(4)
	*(*int32)(unsafe.Add(mBase, _consts[678])) = v336 + v337
...
L53:
	;
	v344 = int32(4353296)
	v345 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v346 = int32(4353300)
	v347 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v349 = int32(24)
	v351 = int32(65280)
	v353 = int32(8)
	*(*int32)(unsafe.Add(mBase, uint32(v345+v347))) = v129<<(uint(v349)%32) | v129&v351<<(uint(v353)%32) | (int32(base.Ui32(v129)>>(uint(v353)%32))&v351 | int32(base.Ui32(v129)>>(uint(v349)%32)))
	v367 = *(*int32)(unsafe.Add(mBase, _consts[678]))
	v369 = v367 + int32(4)
	*(*int32)(unsafe.Add(mBase, _consts[678])) = v369
	v372 = *(*int32)(unsafe.Add(mBase, _consts[672]))
	v374 = *(*int32)(unsafe.Add(mBase, _consts[676]))
	v376 = *(*int32)(unsafe.Add(mBase, _consts[656]))
...
L54:
	...
	*(*uint8)(unsafe.Add(mBase, _consts[679])) = uint8(base.B2i32(v381|v382 == int32(0)))
	goto L1
}
