...
L10:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v11))) = l0
	F_errmsg_internal(m, int32(_a_F_TSParserIsVisibleExt_0), v11)
	mBase = m.M
	v29 = m.ExcPending
	if v29 != 0 {
		goto L2
...
L11:
	;
	F_errfinish(m, int32(_a_F_TSParserIsVisibleExt_1), int32(2804), int32(_a_F_TSParserIsVisibleExt_2))
	mBase = m.M
	v34 = m.ExcPending
	if v34 != 0 {
		goto L2
...
L15:
	;
	v44 = *(*int32)(unsafe.Add(mBase, _c_F_TSParserIsVisibleExt[0]))
	v45 = int32(0)
	if v44 == v45 {
		goto L19
	} else {
...
L17:
	;
	v87 = *(*int32)(unsafe.Add(mBase, _c_F_TSParserIsVisibleExt[0]))
	if v87 == int32(0) {
		v138 = v3
		goto L14
	} else {
...
L36:
	...
	v110 = *(*int32)(unsafe.Add(mBase, _c_F_TSParserIsVisibleExt[1]))
	if v108 != v110 {
		goto L38
	} else {
		goto L39
...
L15:
	;
	v33 = int32(0)
	v35 = *(*int32)(unsafe.Add(mBase, _c_F_get_ts_parser_oid[0]))
	if v35 == v33 {
		v83 = v33
		goto L4
	} else {
...
L18:
	...
	v56 = *(*int32)(unsafe.Add(mBase, _c_F_get_ts_parser_oid[1]))
	if v54 != v56 {
		goto L20
	} else {
		goto L21
...
L30:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10))) = v91
	F_errmsg(m, int32(_a_F_get_ts_parser_oid_0), v10)
	mBase = m.M
	v96 = m.ExcPending
	if v96 != 0 {
		goto L1
...
L31:
	;
	F_errfinish(m, int32(_a_F_get_ts_parser_oid_1), int32(2765), int32(_a_F_get_ts_parser_oid_2))
	mBase = m.M
	v101 = m.ExcPending
	if v101 != 0 {
		goto L1
...
L18:
	;
	v136 = *(*int64)(unsafe.Add(mBase, _c_F_ts_stat_sql[1]))
	if v136 != int64(0) {
		goto L45
	} else {
		goto L46
...
L47:
	;
	v238 = *(*int32)(unsafe.Add(mBase, _c_F_ts_stat_sql[0]))
...
L48:
	;
	v152 = *(*int32)(unsafe.Add(mBase, _c_F_ts_stat_sql[0]))
...
L51:
	;
	v209 = v150 + int64(1)
	v211 = *(*int64)(unsafe.Add(mBase, _c_F_ts_stat_sql[1]))
...
L69:
	;
	v214 = *(*int32)(unsafe.Add(mBase, _c_F_ts_stat_sql[0]))
...
L71:
	;
	v220 = int64(0)
	v222 = *(*int64)(unsafe.Add(mBase, _c_F_ts_stat_sql[1]))
	if v222 != v220 {
		v144 = v207
		v150 = v220
		goto L48
