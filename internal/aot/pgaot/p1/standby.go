...
func F_StandbyLockTimeoutHandler(m *base.Module) {
	mBase := m.M
	_ = mBase
	*(*int32)(unsafe.Add(mBase, _c_F_StandbyLockTimeoutHandler[0])) = int32(1)
	return
}
func F_StandbyRecoverPreparedTransactions(m *base.Module) {
	...
	_ = v43
	v1 = int32(0)
	v4 = *(*int32)(unsafe.Add(mBase, _c_F_StandbyRecoverPreparedTransactions[0]))
...
L2:
	;
	v11 = *(*int32)(unsafe.Add(mBase, _c_F_StandbyRecoverPreparedTransactions[1]))
...
L5:
	;
	v39 = *(*int32)(unsafe.Add(mBase, _c_F_StandbyRecoverPreparedTransactions[0]))
...
L11:
	;
	v31 = v16 + int32(1)
	v33 = *(*int32)(unsafe.Add(mBase, _c_F_StandbyRecoverPreparedTransactions[1]))
...
L3:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+80)) = v46
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_0), v10+int32(80))
	mBase = m.M
	v56 = m.ExcPending
	if v56 != 0 {
		goto L9
...
L7:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v10))) = v35
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_1), v10)
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L9
...
L14:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+64)) = v57
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_2), v10-int32(-64))
	mBase = m.M
	v65 = m.ExcPending
	if v65 != 0 {
		goto L9
...
L17:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+48)) = v82
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_3), v10+int32(48))
	mBase = m.M
	v88 = m.ExcPending
	if v88 != 0 {
		goto L9
...
L21:
	;
	F_appendStringInfoString(m, l0, int32(_a_F_standby_desc_4))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L9
...
L25:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v10)+32)) = v106
	F_appendStringInfo(m, l0, int32(_a_F_standby_desc_5), v10+int32(32))
	mBase = m.M
	v114 = m.ExcPending
	if v114 != 0 {
		goto L9
