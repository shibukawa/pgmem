...
L19:
	...
	*(*int64)(unsafe.Add(mBase, uint32(v72))) = v73
	v81 = int32(*(*uint8)(unsafe.Add(mBase, _consts[328])))
	if v81 == int32(0) {
		goto L21
	} else {
		goto L22
...
L23:
	;
	v85 = int32(*(*uint8)(unsafe.Add(mBase, _consts[329])))
	if v85 == int32(0) {
		goto L24
	} else {
		goto L25
...
L41:
	;
	v152 = F_strstr(m, l0, int32(632793))
	mBase = m.M
	if v152 != 0 {
		v298 = v2
		goto L1
...
L42:
	;
	v154 = F_strstr(m, l0, int32(632694))
	mBase = m.M
	if v154 != 0 {
		v298 = v2
		goto L1
...
L52:
	;
	if base.B2i32(v193 != v194) == int32(0) {
		goto L50
	} else {
		goto L60
	}
...
L60:
	;
	v209 = int32(*(*uint8)(unsafe.Add(mBase, uint32(v197))))
