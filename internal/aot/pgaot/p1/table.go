...
L8:
	...
	v31 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTableNotInUse[0]))
	if v31 != 0 {
		goto L12
	} else {
		goto L13
...
L14:
	;
	v110 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTableNotInUse[1]))
	if v110 < int32(0) {
		goto L33
	} else {
		goto L34
...
L19:
	;
	v96 = *(*int32)(unsafe.Add(mBase, uint32(v35)))
	if v96 != 0 {
		v35 = v96
		goto L15
	} else {
...
L25:
	;
	v82 = v81 + v52
	if base.Ui32(v82) < base.Ui32(v46) {
		v52 = v82
		goto L20
	} else {
		goto L31
...
L34:
	;
	v114 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTableNotInUse[2]))
	if v114 <= int32(0) {
		goto L33
	} else {
		goto L35
...
L35:
	;
	v118 = *(*int32)(unsafe.Add(mBase, _c_F_CheckTableNotInUse[3]))
	v126 = int32(0)
	goto L36
L36:
	;
	v134 = *(*int32)(unsafe.Add(mBase, uint32(v118+v126*int32(20))))
	if v134 != 0 {
		goto L38
	} else {
		goto L39
...
L41:
	;
	v148 = v138 + int32(16)
	v149 = *(*int32)(unsafe.Add(mBase, uint32(v138)+4))
	if base.Ui32(v148) < base.Ui32(v149) {
		goto L43
	} else {
		goto L44
	}
...
L45:
	;
	v199 = *(*int32)(unsafe.Add(mBase, uint32(v138)))
	if v199 != 0 {
		v138 = v199
		goto L41
	} else {
...
L48:
	;
	v174 = v163 & int32(939524096)
	if v174 == int32(134217728) {
		v184 = int32(24)
		goto L51
	} else {
		goto L52
...
L49:
	;
	v169 = *(*int32)(unsafe.Add(mBase, uint32(v155+v163&int32(134217727))+8))
	if v169 != v29 {
		goto L48
	} else {
		goto L50
...
L51:
	;
	v185 = v184 + v155
	if base.Ui32(v185) < base.Ui32(v149) {
		v155 = v185
		goto L46
	} else {
		goto L57
...
L64:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+20)) = v264 + int32(4)
	F_errmsg(m, int32(_a_F_CheckTableNotInUse_0), v15+int32(16))
	mBase = m.M
	v273 = m.ExcPending
	if v273 != 0 {
		goto L62
...
L65:
	;
	F_errfinish(m, int32(_a_F_CheckTableNotInUse_1), int32(_a_F_CheckTableNotInUse_2), int32(_a_F_CheckTableNotInUse_3))
	mBase = m.M
	v278 = m.ExcPending
	if v278 != 0 {
		goto L62
...
L68:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+4)) = v286 + int32(4)
	F_errmsg(m, int32(_a_F_CheckTableNotInUse_4), v15)
	mBase = m.M
	v293 = m.ExcPending
	if v293 != 0 {
		goto L62
...
L69:
	;
	F_errfinish(m, int32(_a_F_CheckTableNotInUse_1), int32(_a_F_CheckTableNotInUse_5), int32(_a_F_CheckTableNotInUse_3))
	mBase = m.M
	v298 = m.ExcPending
	if v298 != 0 {
		goto L62
					...
					if v62 != 0 {
						...
						if v65 != 0 {
							...
							*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v67
							F_errmsg(m, int32(_a_F_CreateTableAsRelExists_0), v7+int32(16))
							mBase = m.M
							v73 = m.ExcPending
							if v73 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(_a_F_CreateTableAsRelExists_1), int32(409), int32(_a_F_CreateTableAsRelExists_2))
								mBase = m.M
								v78 = m.ExcPending
								if v78 != 0 {
									return int32(0)
							...
							if v35 == int32(0) {
								...
								if v41 != 0 {
									...
									*(*int32)(unsafe.Add(mBase, uint32(v7))) = v43
									F_errmsg(m, int32(_a_F_CreateTableAsRelExists_3), v7)
									mBase = m.M
									v47 = m.ExcPending
									if v47 != 0 {
										return int32(0)
									} else {
										F_errfinish(m, int32(_a_F_CreateTableAsRelExists_1), int32(424), int32(_a_F_CreateTableAsRelExists_2))
										mBase = m.M
										v52 = m.ExcPending
										if v52 != 0 {
											return int32(0)
...
func F_table_am_handler_out(m *base.Module, l0 int32) int32 {
	...
	var v10 int32
	_ = v10
	v7 = Fn13874(m, l0, int32(_a_F_table_am_handler_out_0), int32(370), int32(_a_F_table_am_handler_out_1), int32(_a_F_table_am_handler_out_2), int32(_a_F_table_am_handler_out_3))
	v10 = m.ExcPending
	if v10 != 0 {
		return int32(0)
	} else {
	...
	if l1 == int32(-1) {
					...
					if v74 != 0 {
						...
						if v77 != 0 {
							...
							if v104 != 0 {
								...
								v139 = base.I64_extend_i32_u(v42) + base.I64_extend_i32_u(v73) + base.I64_extend_i32_u(v103)
								m.G0 = v8 - int32(-64)
								return v139 << (uint(int64(13)) % 64)
							}
						} else {
		...
		if v107 != 0 {
			...
			if v135 != 0 {
				...
				v139 = base.I64_extend_i32_u(v134)
				m.G0 = v8 - int32(-64)
				return v139 << (uint(int64(13)) % 64)
			}
		} else {
	...
	case 0, 2, 10, 11, 12, 13, 14, 15:
		...
		if v130 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = v131
			F_errmsg_internal(m, int32(_a_F_transformTableConstraint_0), v7+int32(16))
			mBase = m.M
			v137 = m.ExcPending
			if v137 != 0 {
				return
			...
			if v84 != int32(1) {
				...
				if v90 != 0 {
					...
					if v93 != 0 {
						...
						F_errmsg(m, int32(_a_F_transformTableConstraint_3), int32(0))
						mBase = m.M
						v97 = m.ExcPending
						if v97 != 0 {
							return
	...
	default:
		...
		if v146 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v7))) = v147
			F_errmsg_internal(m, int32(_a_F_transformTableConstraint_4), v7)
			mBase = m.M
			v151 = m.ExcPending
			if v151 != 0 {
				return
		...
		if v11 != int32(1) {
			...
			if v17 != 0 {
				...
				if v20 != 0 {
					...
					F_errmsg(m, int32(_a_F_transformTableConstraint_5), int32(0))
					mBase = m.M
					v24 = m.ExcPending
					if v24 != 0 {
						return
		...
		if v34 != int32(1) {
			...
			if v40 != 0 {
				...
				if v43 != 0 {
					...
					F_errmsg(m, int32(_a_F_transformTableConstraint_6), int32(0))
					mBase = m.M
					v47 = m.ExcPending
					if v47 != 0 {
						return
		...
		if v57 != int32(1) {
			...
			if v63 != 0 {
				...
				if v66 != 0 {
					...
					F_errmsg(m, int32(_a_F_transformTableConstraint_7), int32(0))
					mBase = m.M
					v70 = m.ExcPending
					if v70 != 0 {
						return
		...
		if v103 != int32(1) {
			...
			if v110 != 0 {
				...
				if v113 != 0 {
					...
					F_errmsg(m, int32(_a_F_transformTableConstraint_8), int32(0))
					mBase = m.M
					v117 = m.ExcPending
					if v117 != 0 {
						return
