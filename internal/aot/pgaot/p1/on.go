...
func F_on_proc_exit(m *base.Module, l0 int32) {
	...
	var v62 int32
	_ = v62
	v5 = *(*int32)(unsafe.Add(mBase, _consts[772]))
	if v5 < int32(20) {
		v9 = v5 << (uint(int32(3)) % 32)
		v12 = int32(0)
		*(*int32)(unsafe.Add(mBase, uint32(v9)+uint32(_consts[773]))) = v12
		*(*int32)(unsafe.Add(mBase, uint32(v9)+uint32(_consts[774]))) = l0
		*(*int32)(unsafe.Add(mBase, _consts[772])) = v5 + int32(1)
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				F_errmsg_internal(m, int32(126855), int32(0))
				mBase = m.M
				v57 = m.ExcPending
				if v57 != 0 {
					return
				} else {
					F_errfinish(m, int32(526412), int32(321), int32(106296))
					mBase = m.M
					v62 = m.ExcPending
					if v62 != 0 {
						return
