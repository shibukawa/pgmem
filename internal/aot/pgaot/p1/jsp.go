	...
	if base.Ui32(int32(50)) <= base.Ui32(v9) {
		...
		if v34 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v6))) = l0
			F_errmsg_internal(m, int32(462969), v6)
			mBase = m.M
			v38 = m.ExcPending
			if v38 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(474772), int32(918), int32(363364))
				mBase = m.M
				v43 = m.ExcPending
				if v43 != 0 {
					return int32(0)
		...
		if base.I32_wrap_i64(int64(base.Ui64(int64(1125796693540851))>>(uint(base.I64_extend_i32_u(v9))%64)))&int32(1) == int32(0) {
			...
			v24 = *(*int32)(unsafe.Add(mBase, uint32(v9<<(uint(int32(2))%32))+uint32(_consts[1088])))
			m.G0 = v6 + int32(16)
			return v24
		}
	}
