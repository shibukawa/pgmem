...
func F_GetReplicationTransferLatency(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4)+1456)) = int32(1)
	if v5 != 0 {
		F_s_lock(m, v4+int32(1456), int32(494906), int32(401), int32(23192))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
						...
						if v42 != 0 {
							...
							if v46 != 0 {
								...
								F_errfinish(m, int32(493300), int32(858), int32(234470))
								mBase = m.M
								v51 = m.ExcPending
								if v51 != 0 {
									return
...
L15:
	;
	F_s_lock(m, v36, int32(493300), int32(1324), int32(528271))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L13:
	;
	F_s_lock(m, v30, int32(493300), int32(1188), int32(276484))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L4
...
L48:
	;
	F_errfinish(m, int32(492693), int32(3958), int32(276452))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L4
...
L17:
	;
	F_s_lock(m, v46, int32(493300), int32(1464), int32(119088))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L5
...
L30:
	;
	F_errfinish(m, int32(493300), int32(1500), int32(119088))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L5
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = int32(16384)
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15
				if v15 == int32(0) {
					F_yy_fatal_error_3(m, int32(684057))
					mBase = m.M
					v81 = m.ExcPending
					if v81 != 0 {
						return int32(0)
