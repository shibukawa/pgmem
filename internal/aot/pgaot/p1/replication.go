...
func F_ReplicationSlotSave(m *base.Module) {
	...
	v4 = v2 - int32(1040)
	m.G0 = v4
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(_a_F_ReplicationSlotSave_0)
	v9 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotSave[0]))
	*(*int32)(unsafe.Add(mBase, uint32(v4)+4)) = v9 + int32(24)
	v16 = F_pg_sprintf(m, v4+int32(16), int32(_a_F_ReplicationSlotSave_1), v4)
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
	} else {
		v19 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotSave[0]))
...
L7:
	;
	v106 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsDropDBSlots[1]))
	F_LWLockRelease(m, v106+int32(_a_F_ReplicationSlotsDropDBSlots_0))
	mBase = m.M
	v110 = m.ExcPending
	if v110 != 0 {
		goto L5
...
L21:
	...
	*(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsDropDBSlots[3])) = v46
	v66 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsDropDBSlots[4]))
	*(*int32)(unsafe.Add(mBase, uint32(v46))) = int32(0)
	*(*int32)(unsafe.Add(mBase, uint32(v46)+8)) = v66
	v71 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsDropDBSlots[1]))
	F_LWLockRelease(m, v71+int32(_a_F_ReplicationSlotsDropDBSlots_0))
	mBase = m.M
	v75 = m.ExcPending
	if v75 != 0 {
		goto L5
...
L22:
	;
	v76 = int32(_a_F_ReplicationSlotsDropDBSlots_3)
	v77 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsDropDBSlots[3]))
...
L23:
	;
	v84 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsDropDBSlots[1]))
	v88 = F_LWLockAcquire(m, v84+int32(_a_F_ReplicationSlotsDropDBSlots_0), int32(1))
	mBase = m.M
	v89 = m.ExcPending
	if v89 != 0 {
		goto L5
...
L24:
	;
	v91 = *(*int32)(unsafe.Add(mBase, _c_F_ReplicationSlotsDropDBSlots[0]))
	if int32(0) < v91 {
		v31 = v91
		goto L9
	} else {
