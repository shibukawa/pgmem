...
func F_GetReplicationTransferLatency(m *base.Module) int32 {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v4)+1456)) = int32(1)
	if v5 != 0 {
		F_s_lock(m, v4+int32(1456), int32(475539), int32(401), int32(21819))
		mBase = m.M
		v16 = m.ExcPending
		if v16 != 0 {
			return int32(0)
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
						...
						if v42 != 0 {
							...
							if v46 != 0 {
								...
								F_errfinish(m, int32(473983), int32(858), int32(224451))
								mBase = m.M
								v51 = m.ExcPending
								if v51 != 0 {
									return
...
func F_ReplicationSlotNameForTablesync(m *base.Module, l0 int32, l1 int32, l2 int32) {
	...
	*(*int32)(unsafe.Add(mBase, uint32(v7))) = l0
	v17 = F_pg_snprintf(m, l2, int32(64), int32(35780), v7)
	mBase = m.M
	v18 = m.ExcPending
	if v18 != 0 {
		return
...
func F_ReplicationSlotSave(m *base.Module) {
	...
	v4 = v2 - int32(1040)
	m.G0 = v4
	*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(81023)
	v9 = *(*int32)(unsafe.Add(mBase, _consts[667]))
	*(*int32)(unsafe.Add(mBase, uint32(v4)+4)) = v9 + int32(24)
	v16 = F_pg_sprintf(m, v4+int32(16), int32(168545), v4)
	mBase = m.M
	v17 = m.ExcPending
	if v17 != 0 {
		return
...
L15:
	;
	F_s_lock(m, v36, int32(473983), int32(1324), int32(508116))
	mBase = m.M
	v50 = m.ExcPending
	if v50 != 0 {
		goto L4
...
L13:
	;
	F_s_lock(m, v30, int32(473983), int32(1188), int32(264879))
	mBase = m.M
	v41 = m.ExcPending
	if v41 != 0 {
		goto L4
...
L45:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v97))) = v92
	F_errmsg_internal(m, int32(46224), v97)
	mBase = m.M
	v131 = m.ExcPending
	if v131 != 0 {
		goto L4
...
L48:
	;
	F_errfinish(m, int32(473441), int32(3958), int32(264847))
	mBase = m.M
	v136 = m.ExcPending
	if v136 != 0 {
		goto L4
...
L17:
	;
	F_s_lock(m, v46, int32(473983), int32(1464), int32(112240))
	mBase = m.M
	v61 = m.ExcPending
	if v61 != 0 {
		goto L5
...
L30:
	;
	F_errfinish(m, int32(473983), int32(1500), int32(112240))
	mBase = m.M
	v141 = m.ExcPending
	if v141 != 0 {
		goto L5
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8)+12)) = int32(16384)
			...
			if v16 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v8)+4)) = v15
				if v15 == int32(0) {
					F_yy_fatal_error_3(m, int32(646347))
					mBase = m.M
					v81 = m.ExcPending
					if v81 != 0 {
						return int32(0)
