		...
		if base.Ui32(int32(4)) <= base.Ui32(v11) {
			...
			for {
				...
				*(*float32)(unsafe.Add(mBase, uint32(v59))) = base.F32_add(v60, v62)
				v66 = v23 + v41
				v68 = v28 + v41
				if v68 != v11&int32(_a_F_VectorSumCenter_0) {
					v23 = v66
					v28 = v68
					continue
				} else {
			...
			if v16 == int32(1) {
				...
				if v19 <= int32(0) {
					...
					if v47 != 0 {
						...
						if v50 != 0 {
							...
							F_errmsg(m, int32(_a_F_vector_typmod_in_0), int32(0))
							mBase = m.M
							v54 = m.ExcPending
							if v54 != 0 {
								return int32(0)
							} else {
								F_errfinish(m, int32(_a_F_vector_typmod_in_1), int32(361), int32(_a_F_vector_typmod_in_2))
								mBase = m.M
								v59 = m.ExcPending
								if v59 != 0 {
									return int32(0)
					...
					if base.Ui32(int32(_a_F_vector_typmod_in_3)) <= base.Ui32(v19) {
						F_errstart_cold(m, int32(21), int32(0))
						mBase = m.M
						v63 = m.ExcPending
						if v63 != 0 {
							...
							if v66 != 0 {
								...
								*(*int32)(unsafe.Add(mBase, uint32(v5))) = int32(_a_F_vector_typmod_in_4)
								F_errmsg(m, int32(_a_F_vector_typmod_in_5), v5)
								mBase = m.M
								v71 = m.ExcPending
								if v71 != 0 {
									return int32(0)
								} else {
									F_errfinish(m, int32(_a_F_vector_typmod_in_1), int32(366), int32(_a_F_vector_typmod_in_2))
									mBase = m.M
									v76 = m.ExcPending
									if v76 != 0 {
										return int32(0)
				...
				if v31 != 0 {
					...
					if v34 != 0 {
						...
						F_errmsg(m, int32(_a_F_vector_typmod_in_6), int32(0))
						mBase = m.M
						v38 = m.ExcPending
						if v38 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(_a_F_vector_typmod_in_1), int32(356), int32(_a_F_vector_typmod_in_2))
							mBase = m.M
							v43 = m.ExcPending
							if v43 != 0 {
								return int32(0)
