	...
	if v26 == int32(0) {
		...
		if v47 != 0 {
			...
			if v44 == int32(0) {
				...
				v50 = v44
				F_DateTimeParseError(m, v50, v12+int32(8), v16, int32(393565), v15)
				mBase = m.M
				v55 = m.ExcPending
				if v55 != 0 {
					return int32(0)
...
L82:
	;
	F_errfinish(m, int32(522142), int32(2281), int32(257774))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L1
...
L95:
	;
	F_errfinish(m, int32(522142), int32(2297), int32(257774))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L1
