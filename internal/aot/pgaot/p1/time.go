...
func F_EncodeTimeOnly(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32, l5 int32) {
	...
	if base.Ui32(int32(99)) < base.Ui32(v7) {
		...
		v18 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v7<<(uint(int32(1))%32))+uint32(_consts[1074]))))
	...
	*(*uint8)(unsafe.Add(mBase, uint32(v33))) = uint8(v34)
	...
	if base.Ui32(int32(99)) < base.Ui32(v38) {
		...
		v49 = int32(*(*uint16)(unsafe.Add(mBase, uint32(v38<<(uint(int32(1))%32))+uint32(_consts[1074]))))
		...
		if v47 != 0 {
			...
			if v44 == int32(0) {
				...
				if base.Ui32(int32(6)) < base.Ui32(v14) {
					...
					v79 = *(*int64)(unsafe.Add(mBase, uint32(v76)+uint32(_consts[1066])))
					v82 = *(*int64)(unsafe.Add(mBase, uint32(v76)+uint32(_consts[1067])))
					if int64(0) <= v72 {
						v85 = v72 + v82
				...
				v50 = v44
				F_DateTimeParseError(m, v50, v12+int32(8), v16, int32(375924), v15)
				mBase = m.M
				v55 = m.ExcPending
				if v55 != 0 {
					return int32(0)
...
L18:
	;
	v62 = v13 + int32(28)
	v69 = *(*int32)(unsafe.Add(mBase, _consts[1068]))
	if v69 != 0 {
		goto L21
	} else {
		goto L22
...
L20:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1068])) = v113
...
L38:
	;
	v134 = v13 + int32(28)
	v141 = *(*int32)(unsafe.Add(mBase, _consts[1069]))
	if v141 != 0 {
		goto L43
	} else {
		goto L44
...
L42:
	;
	*(*int32)(unsafe.Add(mBase, _consts[1069])) = v185
...
L82:
	;
	F_errfinish(m, int32(498614), int32(2281), int32(245598))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L1
...
L94:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v13)+16)) = v59
	F_errmsg(m, int32(189997), v13+int32(16))
	mBase = m.M
	v307 = m.ExcPending
	if v307 != 0 {
		goto L1
...
L95:
	;
	F_errfinish(m, int32(498614), int32(2297), int32(245598))
	mBase = m.M
	v312 = m.ExcPending
	if v312 != 0 {
		goto L1
