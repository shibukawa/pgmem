		...
		if v24 == int32(0) {
			...
			if v171 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v14))) = v17
				F_errmsg_internal(m, int32(238948), v14)
				mBase = m.M
				v175 = m.ExcPending
				if v175 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(493051), int32(1198), int32(488660))
					mBase = m.M
					v180 = m.ExcPending
					if v180 != 0 {
						return int32(0)
...
func F_accumArrayResult(m *base.Module, l0 int32, l1 int32, l2 int32, l3 int32, l4 int32) int32 {
	...
	m.G0 = v9
	if l0 == int32(0) {
		v17 = F_AllocSetContextCreateInternal(m, l4, int32(98057), int32(0), int32(8192), int32(8388608))
		mBase = m.M
		v20 = m.ExcPending
		if v20 != 0 {
			return int32(0)
									...
									if v109 != 0 {
										...
										if v112 != 0 {
											...
											*(*int32)(unsafe.Add(mBase, uint32(v9))) = int32(1073741823)
											F_errmsg(m, int32(679197), v9)
											mBase = m.M
											v117 = m.ExcPending
											if v117 != 0 {
												return int32(0)
											} else {
												F_errfinish(m, int32(494267), int32(5384), int32(98057))
												mBase = m.M
												v122 = m.ExcPending
												if v122 != 0 {
													return int32(0)
	...
	if int32(0) <= v10 {
		...
		if v55 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v8))) = v10
			F_errmsg_internal(m, int32(483365), v8)
			mBase = m.M
			v59 = m.ExcPending
			if v59 != 0 {
				return int32(0)
...
func F_aclinsert(m *base.Module, l0 int32) int32 {
	...
	if v7 != 0 {
		...
		if v10 != 0 {
			...
			F_errmsg(m, int32(443753), int32(0))
			v14 = m.ExcPending
			if v14 != 0 {
				return int32(0)
			} else {
				F_errfinish(m, int32(497233), int32(1597), int32(81523))
				v19 = m.ExcPending
				if v19 != 0 {
					return int32(0)
				} else {
...
L122:
	;
	F_errfinish(m, int32(498084), int32(1352), int32(113481))
	mBase = m.M
	v1188 = m.ExcPending
	if v1188 != 0 {
		goto L1
...
L13:
	;
	F_errfinish(m, int32(497082), int32(1076), int32(347277))
	mBase = m.M
	v44 = m.ExcPending
	if v44 != 0 {
		goto L9
...
L19:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v12)+16)) = v55
	F_errmsg(m, int32(414466), v12+int32(16))
	mBase = m.M
	v71 = m.ExcPending
	if v71 != 0 {
		goto L14
...
L20:
	;
	F_errfinish(m, int32(493999), int32(1442), int32(228514))
	mBase = m.M
	v76 = m.ExcPending
	if v76 != 0 {
		goto L14
...
L24:
	;
	F_errfinish(m, int32(493999), int32(1435), int32(228514))
	mBase = m.M
	v105 = m.ExcPending
	if v105 != 0 {
		goto L14
	...
	case 0, 2:
		...
		if v52 != 0 {
			...
			if v51 != 0 {
				...
				v58 = F_ChooseConstraintName(m, l2, v53, int32(756936), v56, v53)
				mBase = m.M
				v59 = m.ExcPending
				if v59 != 0 {
					return
		...
		if v33 != 0 {
			...
			if v36 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v24))) = v37 + int32(4)
				F_errmsg(m, int32(394855), v24)
				mBase = m.M
				v43 = m.ExcPending
				if v43 != 0 {
					return
				} else {
					F_errfinish(m, int32(494212), int32(10746), int32(90689))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return
...
L43:
	;
	F_CheckTableNotInUse(m, v268, int32(540466))
	mBase = m.M
	v279 = m.ExcPending
	if v279 != 0 {
		goto L10
...
L75:
	;
	F_errfinish(m, int32(494212), int32(11057), int32(336748))
	mBase = m.M
	v664 = m.ExcPending
	if v664 != 0 {
		goto L10
...
L62:
	;
	F_errfinish(m, int32(495102), int32(3099), int32(106160))
	mBase = m.M
	v259 = m.ExcPending
	if v259 != 0 {
		goto L29
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(24060)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(493865), int32(154), int32(278850))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(24112)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(493865), int32(174), int32(278902))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(24090)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(493865), int32(377), int32(66601))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
...
func F_anycompatiblerange_in(m *base.Module, l0 int32) int32 {
	...
	if v11 != 0 {
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(401026)
			F_errmsg(m, int32(192350), v4)
			mBase = m.M
			v19 = m.ExcPending
			if v19 != 0 {
				...
				F_errfinish(m, int32(493865), int32(220), int32(279669))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
		...
		if v14 != 0 {
			...
			*(*int32)(unsafe.Add(mBase, uint32(v4))) = int32(24078)
			...
			if v19 != 0 {
				...
				F_errfinish(m, int32(493865), int32(375), int32(66585))
				mBase = m.M
				v24 = m.ExcPending
				if v24 != 0 {
					return int32(0)
				...
				if v16 == int32(0) {
					...
					if v24 != 0 {
						...
						*(*int32)(unsafe.Add(mBase, uint32(v7)+16)) = l1
						F_errmsg(m, int32(487812), v7+int32(16))
						mBase = m.M
						v36 = m.ExcPending
						if v36 != 0 {
							return int32(0)
						} else {
							F_errfinish(m, int32(495596), int32(138), int32(318001))
							mBase = m.M
							v41 = m.ExcPending
							if v41 != 0 {
								return int32(0)
		...
		if v50 != 0 {
			...
			if v53 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				F_errmsg(m, int32(343068), v7)
				mBase = m.M
				v61 = m.ExcPending
				if v61 != 0 {
					return int32(0)
				} else {
					F_errfinish(m, int32(495596), int32(131), int32(318001))
					mBase = m.M
					v66 = m.ExcPending
					if v66 != 0 {
						return int32(0)
...
L72:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+16)) = v209
	F_errmsg(m, int32(722301), v15+int32(16))
	mBase = m.M
	v220 = m.ExcPending
	if v220 != 0 {
		goto L21
...
L75:
	;
	F_errfinish(m, int32(498242), int32(480), int32(221358))
	mBase = m.M
	v233 = m.ExcPending
	if v233 != 0 {
		goto L21
...
L159:
	;
	F_errfinish(m, int32(498242), int32(1010), int32(142933))
	mBase = m.M
	v549 = m.ExcPending
	if v549 != 0 {
		goto L21
...
L161:
	...
	*(*int32)(unsafe.Add(mBase, uint32(v15)+32)) = v554
	F_errmsg_internal(m, int32(487033), v15+int32(32))
	mBase = m.M
	v560 = m.ExcPending
	if v560 != 0 {
		goto L21
...
L162:
	;
	F_errfinish(m, int32(498242), int32(616), int32(221358))
	mBase = m.M
	v565 = m.ExcPending
	if v565 != 0 {
		goto L21
			...
			if v39 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				...
				if v43 != 0 {
					...
					F_errfinish(m, int32(496054), int32(3649), int32(381799))
					mBase = m.M
					v48 = m.ExcPending
					if v48 != 0 {
						return int32(0)
			...
			if v34 != 0 {
				...
				*(*int32)(unsafe.Add(mBase, uint32(v7))) = l1
				...
				if v38 != 0 {
					...
					F_errfinish(m, int32(496054), int32(3689), int32(465134))
					mBase = m.M
					v43 = m.ExcPending
					if v43 != 0 {
						return int32(0)
