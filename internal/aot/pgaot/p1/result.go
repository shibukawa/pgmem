...
func F_wait_result_is_signal(m *base.Module, l0 int32, l1 int32) int32 {
	...
	v7 = l0 & int32(127)
	if l1 == v7 {
		if base.Ui32(l0&int32(_a_F_wait_result_is_signal_0)-int32(1)) < base.Ui32(int32(255)) {
			v25 = v5
		} else {
			if v7 == int32(0) {
		...
		if v20 == int32(0) {
			...
			if base.Ui32(l0&int32(_a_F_wait_result_to_str_4)-int32(1)) <= base.Ui32(int32(254)) {
				...
				if v75 != 0 {
					...
					v77 = int32(_a_F_wait_result_to_str_6)
				}
				*(*int32)(unsafe.Add(mBase, uint32(v6)+20)) = v77
				*(*int32)(unsafe.Add(mBase, uint32(v6)+16)) = v20
				v86 = F_pg_snprintf(m, v6+int32(48), int32(512), int32(_a_F_wait_result_to_str_7), v6+int32(16))
				mBase = m.M
				v87 = m.ExcPending
				if v87 != 0 {
					return int32(0)
				...
				*(*int32)(unsafe.Add(mBase, uint32(v6)+32)) = l0
				v95 = F_pg_snprintf(m, v6+int32(48), int32(512), int32(_a_F_wait_result_to_str_8), v6+int32(32))
				mBase = m.M
				v96 = m.ExcPending
				if v96 != 0 {
					return int32(0)
