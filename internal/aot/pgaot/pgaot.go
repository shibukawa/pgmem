...
func initData_0(m *base.Module) {
	copy(m.Memory[4096:], wasm2goData_data_bin[0:1568640])
	copy(m.Memory[1573968:], wasm2goData_data_bin[1568640:1568649])
	copy(m.Memory[1576016:], wasm2goData_data_bin[1568649:1581577])
	copy(m.Memory[1597444:], wasm2goData_data_bin[1581577:1674818])
	copy(m.Memory[1691712:], wasm2goData_data_bin[1674818:1786474])
	copy(m.Memory[1814584:], wasm2goData_data_bin[1786474:4027152])
	copy(m.Memory[4062752:], wasm2goData_data_bin[4027152:4302635])
}
