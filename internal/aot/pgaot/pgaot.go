...
func initData_0(m *base.Module) {
	copy(m.Memory[4096:], wasm2goData_data_bin[0:1578240])
	copy(m.Memory[1583568:], wasm2goData_data_bin[1578240:1578249])
	copy(m.Memory[1585616:], wasm2goData_data_bin[1578249:1591177])
	copy(m.Memory[1609732:], wasm2goData_data_bin[1591177:1684418])
	copy(m.Memory[1704000:], wasm2goData_data_bin[1684418:1796074])
	copy(m.Memory[1826872:], wasm2goData_data_bin[1796074:4044016])
	copy(m.Memory[4082304:], wasm2goData_data_bin[4044016:4320587])
}
