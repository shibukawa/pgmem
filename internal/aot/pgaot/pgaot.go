...
func initData_0(m *base.Module) {
	copy(m.Memory[4096:], wasm2goData_data_bin[0:1558048])
	copy(m.Memory[1563376:], wasm2goData_data_bin[1558048:1558057])
	copy(m.Memory[1565424:], wasm2goData_data_bin[1558057:1570985])
	copy(m.Memory[1589252:], wasm2goData_data_bin[1570985:1664226])
	copy(m.Memory[1683520:], wasm2goData_data_bin[1664226:1775882])
	copy(m.Memory[1806392:], wasm2goData_data_bin[1775882:4008336])
	copy(m.Memory[4046336:], wasm2goData_data_bin[4008336:4281659])
}
