...
func initData_0(m *base.Module) {
	copy(m.Memory[4096:], wasm2goData_data_bin[0:1567056])
	copy(m.Memory[1572384:], wasm2goData_data_bin[1567056:1567065])
	copy(m.Memory[1574432:], wasm2goData_data_bin[1567065:1579993])
	copy(m.Memory[1597444:], wasm2goData_data_bin[1579993:1673234])
	copy(m.Memory[1691712:], wasm2goData_data_bin[1673234:1784890])
	copy(m.Memory[1814584:], wasm2goData_data_bin[1784890:4024800])
	copy(m.Memory[4061984:], wasm2goData_data_bin[4024800:4300187])
}
