...
func initData_0(m *base.Module) {
	copy(m.Memory[4096:], wasm2goData_data_bin[0:1581216])
	copy(m.Memory[1586544:], wasm2goData_data_bin[1581216:1581225])
	copy(m.Memory[1588592:], wasm2goData_data_bin[1581225:1594153])
	copy(m.Memory[1609732:], wasm2goData_data_bin[1594153:1687394])
	copy(m.Memory[1704000:], wasm2goData_data_bin[1687394:1799050])
	copy(m.Memory[1826872:], wasm2goData_data_bin[1799050:4048736])
	copy(m.Memory[4084048:], wasm2goData_data_bin[4048736:4325371])
}
