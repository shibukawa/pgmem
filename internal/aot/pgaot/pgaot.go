...
func initData_0(m *base.Module) {
	copy(m.Memory[4096:], wasm2goData_data_bin[0:1608512])
	copy(m.Memory[1613840:], wasm2goData_data_bin[1608512:1608521])
	copy(m.Memory[1615888:], wasm2goData_data_bin[1608521:1621449])
	copy(m.Memory[1638404:], wasm2goData_data_bin[1621449:1714690])
	copy(m.Memory[1732672:], wasm2goData_data_bin[1714690:1826346])
	copy(m.Memory[1855544:], wasm2goData_data_bin[1826346:4084320])
	copy(m.Memory[4121008:], wasm2goData_data_bin[4084320:4372811])
}
