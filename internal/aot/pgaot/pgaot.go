...
func initData_0(m *base.Module) {
	copy(m.Memory[4096:], wasm2goData_data_bin[0:1607312])
	copy(m.Memory[1612640:], wasm2goData_data_bin[1607312:1607321])
	copy(m.Memory[1614688:], wasm2goData_data_bin[1607321:1620249])
	copy(m.Memory[1638404:], wasm2goData_data_bin[1620249:1713490])
	copy(m.Memory[1732672:], wasm2goData_data_bin[1713490:1825146])
	copy(m.Memory[1855544:], wasm2goData_data_bin[1825146:4083264])
	copy(m.Memory[4121152:], wasm2goData_data_bin[4083264:4371883])
}
