...
public final class BinaryLocator {
    ...
    public static Path locate(Path explicit) {
        ...
        throw new PgmemException("pgmem binary not found: add io.github.shibukawa.pgmem:pgmem-native with classifier "
    ...
    private static Path extractResource(String name) {
        String resource = "/io/github/shibukawa/pgmem/native/" + classifier() + "/" + name;
