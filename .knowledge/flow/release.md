...
flow:
  ...
  steps:
    ...
    - id: packages
      action: scripts/set-version.sh; scripts/package-archives.sh (tar.gz, zip for Windows, SHA256SUMS); scripts/build-npm.sh (6 tarballs); scripts/build-python-wheels.sh then twine check
    - id: github
